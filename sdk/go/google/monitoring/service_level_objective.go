...
type ServiceLevelObjective_ServiceLevelIndicator_BasicSli_Latency struct {
	// Good service is defined to be the count of requests made to this service that return in no more than threshold.
	Threshold any
}

type ServiceLevelObjective_ServiceLevelIndicator_BasicSli struct {
...
type ServiceLevelObjective_ServiceLevelIndicator_RequestBased_DistributionCut_Range struct {
	// Range maximum.
	Max any
	// Range minimum.
	Min any
...
type ServiceLevelObjective_ServiceLevelIndicator_RequestBased_DistributionCut struct {
...
type ServiceLevelObjective_ServiceLevelIndicator_RequestBased_GoodTotalRatio struct {
...
type ServiceLevelObjective_ServiceLevelIndicator_RequestBased struct {
...
type ServiceLevelObjective_ServiceLevelIndicator_WindowsBased_GoodTotalRatioThreshold struct {
...
type ServiceLevelObjective_ServiceLevelIndicator_WindowsBased_MetricMeanInRange struct {
	// Range of numerical values within min and max.
	Range any
...
type ServiceLevelObjective_ServiceLevelIndicator_WindowsBased struct {
...
type ServiceLevelObjective_ServiceLevelIndicator struct {
	// An SLI measuring performance on a well-known service type. Performance will be computed on the basis of pre-defined metrics. The type of the service_resource determines the metrics to use and the service_resource.labels and metric_labels are used to construct a monitoring filter to filter that metric down to just the data relevant to this service.
	BasicSli any
	// Service Level Indicators for which atomic units of service are counted directly.
	RequestBased any
...
type ServiceLevelObjectiveAttrs struct {
	// A calendar period, semantically "since the start of the current ". At this time, only DAY, WEEK, FORTNIGHT, and MONTH are supported.
	CalendarPeriod any
	// Name used for UI elements listing this SLO.
	DisplayName any
...
var ServiceLevelObjective = ubx.ResourceBinding{
