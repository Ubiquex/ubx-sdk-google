...
type MonitoringMetricDescriptor_Labels struct {
	Description any
	Key any
	ValueType any
}

type MonitoringMetricDescriptor_Metadata struct {
...
var MonitoringMetricDescriptor_LabelsFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Key": ubx.FieldSpec{WireName: "key"},
		"ValueType": ubx.FieldSpec{WireName: "value_type"},
	}

var MonitoringMetricDescriptor_MetadataFields = ubx.FieldMap{
...
type MonitoringMetricDescriptorAttrs struct {
	// A detailed description of the metric, which can be used in documentation.
	Description any
	// A concise name for the metric, which can be displayed in user interfaces. Use sentence case without an ending period, for example "Request count". This field is optional but it is recommended to be set for any metrics associated with user-visible concepts, such as Quota.
	DisplayName any
...
var MonitoringMetricDescriptor = ubx.ResourceBinding{
