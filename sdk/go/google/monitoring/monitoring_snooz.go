...
type MonitoringSnooz_Criteria struct {
...
type MonitoringSnooz_Interval struct {
...
var MonitoringSnooz_CriteriaFields = ubx.FieldMap{
		"Filter": ubx.FieldSpec{WireName: "filter"},
		"Policies": ubx.FieldSpec{WireName: "policies"},
	}

var MonitoringSnooz_IntervalFields = ubx.FieldMap{
		"EndTime": ubx.FieldSpec{WireName: "end_time"},
		"StartTime": ubx.FieldSpec{WireName: "start_time"},
	}

type MonitoringSnoozConfig struct {
...
type MonitoringSnoozAttrs struct {
	// Criteria specific to the AlertPolicys that this Snooze applies to. The Snooze will suppress alerts that come from one of the AlertPolicys whose names are supplied.
	Criteria any
	// Required. A display name for the Snooze. This can be, at most, 512 unicode characters.
	DisplayName any
...
var MonitoringSnooz = ubx.ResourceBinding{
