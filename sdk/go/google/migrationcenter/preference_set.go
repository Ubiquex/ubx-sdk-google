...
type PreferenceSet_VirtualMachinePreferences_ComputeEnginePreferences_MachinePreferences struct {
	// Compute Engine machine series to consider for insights and recommendations. If empty, no restriction is applied on the machine series.
	AllowedMachineSeries any
}

type PreferenceSet_VirtualMachinePreferences_ComputeEnginePreferences struct {
...
type PreferenceSet_VirtualMachinePreferences_RegionPreferences struct {
...
type PreferenceSet_VirtualMachinePreferences_SoleTenancyPreferences struct {
...
type PreferenceSet_VirtualMachinePreferences_VmwareEnginePreferences struct {
	// Commitment plan to consider when calculating costs for virtual machine insights and recommendations. If you are unsure which value to set, a 3 year commitment plan is often a good value to start with.
	CommitmentPlan any
...
type PreferenceSet_VirtualMachinePreferences struct {
	// Commitment plan to consider when calculating costs for virtual machine insights and recommendations. If you are unsure which value to set, a 3 year commitment plan is often a good value to start with.
	CommitmentPlan any
...
type PreferenceSetAttrs struct {
