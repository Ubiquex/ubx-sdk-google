...
type MigrationcenterDiscoveryClient_Errors struct {
	Code any
	Details any
	Message any
}

var MigrationcenterDiscoveryClient_ErrorsFields = ubx.FieldMap{
...
type MigrationcenterDiscoveryClientAttrs struct {
	// Output only. Time when the discovery client was first created.
	CreateTime any
	// Optional. Free text description. Maximum length is 1000 characters.
	Description any
...
var MigrationcenterDiscoveryClient = ubx.ResourceBinding{
