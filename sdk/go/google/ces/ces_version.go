...
type CesVersion_Snapshot_Agents_AfterAgentCallbacks struct {
	Description any
	Disabled any
...
type CesVersion_Snapshot_Agents_ModelSettings struct {
	Model any
	Temperature any
}

type CesVersion_Snapshot_Agents_RemoteDialogflowAgent struct {
	Agent any
	EnvironmentId any
	FlowId any
...
type CesVersion_Snapshot_Agents_Toolsets struct {
	ToolIds any
	Toolset any
}

type CesVersion_Snapshot_Agents_TransferRules_DeterministicTransfer_ExpressionCondition struct {
	Expression any
}

type CesVersion_Snapshot_Agents_TransferRules_DeterministicTransfer_PythonCodeCondition struct {
	PythonCode any
}

type CesVersion_Snapshot_Agents_TransferRules_DeterministicTransfer struct {
	ExpressionCondition any
	PythonCodeCondition any
}

type CesVersion_Snapshot_Agents_TransferRules_DisablePlannerTransfer struct {
	ExpressionCondition any
}

type CesVersion_Snapshot_Agents_TransferRules struct {
	ChildAgent any
...
type CesVersion_Snapshot_Agents struct {
...
type CesVersion_Snapshot_App_AudioProcessingConfig_AmbientSoundConfig struct {
...
type CesVersion_Snapshot_App_AudioProcessingConfig_BargeInConfig struct {
...
type CesVersion_Snapshot_App_AudioProcessingConfig_SynthesizeSpeechConfigs struct {
...
type CesVersion_Snapshot_App_AudioProcessingConfig struct {
...
type CesVersion_Snapshot_App_ClientCertificateSettings struct {
...
type CesVersion_Snapshot_App_DataStoreSettings_Engines struct {
	Name any
	Type any
}

type CesVersion_Snapshot_App_DataStoreSettings struct {
	// Output only. The engines for the app.
	Engines any
}

type CesVersion_Snapshot_App_DefaultChannelProfile_InstagramConfig struct {
...
type CesVersion_Snapshot_App_DefaultChannelProfile_PersonaProperty struct {
	// Optional. The persona of the channel.
	Persona any
}

type CesVersion_Snapshot_App_DefaultChannelProfile_WebWidgetConfig_SecuritySettings struct {
...
type CesVersion_Snapshot_App_DefaultChannelProfile_WebWidgetConfig struct {
...
type CesVersion_Snapshot_App_DefaultChannelProfile_WhatsappConfig struct {
	// Output only. The description of the Meta business page or profile.
	Description any
	// Output only. The fetched Meta business page name.
	DisplayName any
...
type CesVersion_Snapshot_App_DefaultChannelProfile struct {
...
type CesVersion_Snapshot_App_ErrorHandlingSettings_EndSessionConfig struct {
...
type CesVersion_Snapshot_App_ErrorHandlingSettings_FallbackResponseConfig struct {
...
type CesVersion_Snapshot_App_ErrorHandlingSettings struct {
...
type CesVersion_Snapshot_App_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholds struct {
...
type CesVersion_Snapshot_App_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ToolMatchingSettings struct {
	// Optional. Behavior for extra tool calls. Defaults to FAIL.
	ExtraToolCallBehavior any
}

type CesVersion_Snapshot_App_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholds struct {
...
type CesVersion_Snapshot_App_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds struct {
...
type CesVersion_Snapshot_App_EvaluationMetricsThresholds struct {
...
type CesVersion_Snapshot_App_LanguageSettings struct {
...
type CesVersion_Snapshot_App_LoggingSettings_AudioRecordingConfig struct {
...
type CesVersion_Snapshot_App_LoggingSettings_BigqueryExportSettings struct {
...
type CesVersion_Snapshot_App_LoggingSettings_CloudLoggingSettings struct {
	// Optional. Whether to enable Cloud Logging for the sessions.
	EnableCloudLogging any
}

type CesVersion_Snapshot_App_LoggingSettings_ConversationLoggingSettings struct {
...
type CesVersion_Snapshot_App_LoggingSettings_MetricAnalysisSettings struct {
...
type CesVersion_Snapshot_App_LoggingSettings_RedactionConfig struct {
...
type CesVersion_Snapshot_App_LoggingSettings struct {
...
type CesVersion_Snapshot_App_PredefinedVariableDeclarations_Schema struct {
...
type CesVersion_Snapshot_App_PredefinedVariableDeclarations struct {
	Description any
	Name any
	Schema any
}

type CesVersion_Snapshot_App_TimeZoneSettings struct {
...
type CesVersion_Snapshot_App_VpcScSettings struct {
...
type CesVersion_Snapshot_App struct {
...
type CesVersion_Snapshot_Examples_Messages_Chunks_AgentTransfer struct {
	DisplayName any
	TargetAgent any
}

type CesVersion_Snapshot_Examples_Messages_Chunks_Blob struct {
	Data any
	MimeType any
}

type CesVersion_Snapshot_Examples_Messages_Chunks_ToolCall_ToolsetTool struct {
	ToolId any
	Toolset any
}

type CesVersion_Snapshot_Examples_Messages_Chunks_ToolCall struct {
	Args any
	DisplayName any
	Id any
	Tool any
...
type CesVersion_Snapshot_Examples_Messages_Chunks_ToolResponse struct {
	DisplayName any
	Id any
	Response any
	Tool any
...
type CesVersion_Snapshot_Examples_Messages_Chunks struct {
	AgentTransfer any
	Blob any
...
type CesVersion_Snapshot_Examples_Messages struct {
	Chunks any
	EventTime any
	Role any
}

type CesVersion_Snapshot_Examples struct {
	CreateTime any
	Description any
	DisplayName any
	EntryAgent any
...
type CesVersion_Snapshot_Guardrails_Action_GenerativeAnswer struct {
	Prompt any
}

type CesVersion_Snapshot_Guardrails_Action_RespondImmediately_Responses struct {
	Disabled any
	Text any
}

type CesVersion_Snapshot_Guardrails_Action_RespondImmediately struct {
	Responses any
}

type CesVersion_Snapshot_Guardrails_Action_TransferAgent struct {
	Agent any
}

type CesVersion_Snapshot_Guardrails_Action struct {
	GenerativeAnswer any
	RespondImmediately any
	TransferAgent any
}

type CesVersion_Snapshot_Guardrails_CodeCallback struct {
...
type CesVersion_Snapshot_Guardrails_ContentFilter struct {
	BannedContents any
...
type CesVersion_Snapshot_Guardrails_LlmPolicy struct {
...
type CesVersion_Snapshot_Guardrails_LlmPromptSecurity_DefaultSettings struct {
	DefaultPromptTemplate any
}

type CesVersion_Snapshot_Guardrails_LlmPromptSecurity struct {
	CustomPolicy any
	DefaultSettings any
	FailOpen any
}

type CesVersion_Snapshot_Guardrails_ModelSafety_SafetySettings struct {
	Category any
	Threshold any
}

type CesVersion_Snapshot_Guardrails_ModelSafety struct {
	SafetySettings any
}

type CesVersion_Snapshot_Guardrails struct {
	Action any
	CodeCallback any
	ContentFilter any
	CreateTime any
...
type CesVersion_Snapshot_Tools_AgentTool struct {
	Agent any
	Description any
	Name any
}

type CesVersion_Snapshot_Tools_ClientFunction struct {
	Description any
	Name any
	Parameters any
	Response any
...
type CesVersion_Snapshot_Tools_ConnectorTool_Action_EntityOperation struct {
	EntityId any
	Operation any
}

type CesVersion_Snapshot_Tools_ConnectorTool_Action struct {
...
type CesVersion_Snapshot_Tools_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig struct {
	OauthToken any
}

type CesVersion_Snapshot_Tools_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig struct {
	ClientKey any
	Issuer any
	Subject any
}

type CesVersion_Snapshot_Tools_ConnectorTool_AuthConfig struct {
	Oauth2AuthCodeConfig any
	Oauth2JwtBearerConfig any
}

type CesVersion_Snapshot_Tools_ConnectorTool struct {
	Action any
	AuthConfig any
	Connection any
	Description any
...
type CesVersion_Snapshot_Tools_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPoints struct {
	AttributeValue any
	BoostAmount any
}

type CesVersion_Snapshot_Tools_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec struct {
	AttributeType any
	ControlPoints any
	FieldName any
...
type CesVersion_Snapshot_Tools_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs struct {
	Boost any
	BoostControlSpec any
	Condition any
}

type CesVersion_Snapshot_Tools_DataStoreTool_BoostSpecs_Spec struct {
	ConditionBoostSpecs any
}

type CesVersion_Snapshot_Tools_DataStoreTool_BoostSpecs struct {
	DataStores any
	Spec any
}

type CesVersion_Snapshot_Tools_DataStoreTool_DataStoreSource_DataStore_ConnectorConfig struct {
	Collection any
	CollectionDisplayName any
	DataSource any
}

type CesVersion_Snapshot_Tools_DataStoreTool_DataStoreSource_DataStore struct {
	ConnectorConfig any
	CreateTime any
	DisplayName any
...
type CesVersion_Snapshot_Tools_DataStoreTool_DataStoreSource struct {
	DataStore any
	Filter any
}

type CesVersion_Snapshot_Tools_DataStoreTool_EngineSource struct {
	DataStoreSources any
	Engine any
	Filter any
}

type CesVersion_Snapshot_Tools_DataStoreTool_ModalityConfigs_GroundingConfig struct {
	Disabled any
	GroundingLevel any
}

type CesVersion_Snapshot_Tools_DataStoreTool_ModalityConfigs_RewriterConfig struct {
	Disabled any
	ModelSettings any
	Prompt any
}

type CesVersion_Snapshot_Tools_DataStoreTool_ModalityConfigs_SnippetsConfig struct {
	EnableSnippets any
}

type CesVersion_Snapshot_Tools_DataStoreTool_ModalityConfigs struct {
	GroundingConfig any
	ModalityType any
	RewriterConfig any
	SnippetsConfig any
...
type CesVersion_Snapshot_Tools_DataStoreTool struct {
	BoostSpecs any
	DataStoreSource any
	Description any
	EngineSource any
...
type CesVersion_Snapshot_Tools_FileSearchTool struct {
	CorpusType any
	Description any
	FileCorpus any
	Name any
...
type CesVersion_Snapshot_Tools_GoogleSearchTool_PromptConfig struct {
	TextPrompt any
	VoicePrompt any
}

type CesVersion_Snapshot_Tools_GoogleSearchTool struct {
	ContextUrls any
	Description any
	ExcludeDomains any
	Name any
...
type CesVersion_Snapshot_Tools_McpTool_ApiAuthentication_ApiKeyConfig struct {
	ApiKeySecretVersion any
	KeyName any
	RequestLocation any
}

type CesVersion_Snapshot_Tools_McpTool_ApiAuthentication_BearerTokenConfig struct {
	Token any
}

type CesVersion_Snapshot_Tools_McpTool_ApiAuthentication_OauthConfig struct {
	ClientId any
...
type CesVersion_Snapshot_Tools_McpTool_ApiAuthentication_ServiceAccountAuthConfig struct {
	Scopes any
	ServiceAccount any
}

type CesVersion_Snapshot_Tools_McpTool_ApiAuthentication struct {
	ApiKeyConfig any
...
type CesVersion_Snapshot_Tools_McpTool_ServiceDirectoryConfig struct {
	Service any
}

type CesVersion_Snapshot_Tools_McpTool_TlsConfig_CaCerts struct {
	Cert any
	DisplayName any
}

type CesVersion_Snapshot_Tools_McpTool_TlsConfig struct {
	CaCerts any
}

type CesVersion_Snapshot_Tools_McpTool struct {
...
type CesVersion_Snapshot_Tools_OpenApiTool struct {
	ApiAuthentication any
	Description any
...
type CesVersion_Snapshot_Tools_PythonFunction struct {
	Description any
	Name any
	PythonCode any
	ServiceDirectoryConfig any
...
type CesVersion_Snapshot_Tools_RemoteAgentTool_AgentCard_Skills struct {
	Description any
	Examples any
	Id any
	InputModes any
...
type CesVersion_Snapshot_Tools_RemoteAgentTool_AgentCard_SupportedInterfaces struct {
	ProtocolBinding any
	ProtocolVersion any
	Tenant any
	Url any
...
type CesVersion_Snapshot_Tools_RemoteAgentTool_AgentCard struct {
	Description any
	Name any
	Skills any
...
type CesVersion_Snapshot_Tools_RemoteAgentTool struct {
	AgentCard any
	Description any
	Name any
}

type CesVersion_Snapshot_Tools_SystemTool struct {
	Description any
	Name any
}

type CesVersion_Snapshot_Tools_ToolFakeConfig struct {
	CodeBlock any
	EnableFakeMode any
}

type CesVersion_Snapshot_Tools_WidgetTool_DataMapping struct {
	FieldMappings any
	Mode any
	PythonFunction any
	PythonScript any
...
type CesVersion_Snapshot_Tools_WidgetTool_TextResponseConfig struct {
	StaticText any
	TextResponseInstruction any
	Type any
}

type CesVersion_Snapshot_Tools_WidgetTool struct {
	DataMapping any
	Description any
	Name any
	Parameters any
...
type CesVersion_Snapshot_Tools struct {
	AgentTool any
	ClientFunction any
	ConnectorTool any
	CreateTime any
...
type CesVersion_Snapshot_Toolsets_ConnectorToolset struct {
	AuthConfig any
	Connection any
	ConnectorActions any
}

type CesVersion_Snapshot_Toolsets_McpToolset_ToolOverrides_Snapshot struct {
	Description any
	InputSchema any
	OutputSchema any
}

type CesVersion_Snapshot_Toolsets_McpToolset_ToolOverrides struct {
...
type CesVersion_Snapshot_Toolsets_McpToolset struct {
	ApiAuthentication any
	CustomHeaders any
	ServerAddress any
	ServiceDirectoryConfig any
...
type CesVersion_Snapshot_Toolsets_OpenApiToolset struct {
	ApiAuthentication any
	IgnoreUnknownFields any
	OpenApiSchema any
	ServiceDirectoryConfig any
...
type CesVersion_Snapshot_Toolsets struct {
...
type CesVersion_Snapshot struct {
...
var CesVersion_Snapshot_Agents_AfterAgentCallbacksFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Agents_ModelSettingsFields = ubx.FieldMap{
		"Model": ubx.FieldSpec{WireName: "model"},
		"Temperature": ubx.FieldSpec{WireName: "temperature"},
	}

var CesVersion_Snapshot_Agents_RemoteDialogflowAgentFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Agents_ToolsetsFields = ubx.FieldMap{
		"ToolIds": ubx.FieldSpec{WireName: "tool_ids"},
		"Toolset": ubx.FieldSpec{WireName: "toolset"},
	}

var CesVersion_Snapshot_Agents_TransferRules_DeterministicTransfer_ExpressionConditionFields = ubx.FieldMap{
		"Expression": ubx.FieldSpec{WireName: "expression"},
	}

var CesVersion_Snapshot_Agents_TransferRules_DeterministicTransfer_PythonCodeConditionFields = ubx.FieldMap{
		"PythonCode": ubx.FieldSpec{WireName: "python_code"},
	}

var CesVersion_Snapshot_Agents_TransferRules_DeterministicTransferFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Agents_TransferRules_DisablePlannerTransferFields = ubx.FieldMap{
		"ExpressionCondition": ubx.FieldSpec{
			WireName: "expression_condition",
			Kind: "object",
			Fields: CesVersion_Snapshot_Agents_TransferRules_DeterministicTransfer_ExpressionConditionFields,
...
var CesVersion_Snapshot_Agents_TransferRulesFields = ubx.FieldMap{
...
var CesVersion_Snapshot_AgentsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_AudioProcessingConfig_AmbientSoundConfigFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_AudioProcessingConfig_BargeInConfigFields = ubx.FieldMap{
		"BargeInAwareness": ubx.FieldSpec{WireName: "barge_in_awareness"},
		"DisableBargeIn": ubx.FieldSpec{WireName: "disable_barge_in"},
	}

var CesVersion_Snapshot_App_AudioProcessingConfig_SynthesizeSpeechConfigsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_AudioProcessingConfigFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_ClientCertificateSettingsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_DataStoreSettings_EnginesFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var CesVersion_Snapshot_App_DataStoreSettingsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_DefaultChannelProfile_InstagramConfigFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
...
var CesVersion_Snapshot_App_DefaultChannelProfile_PersonaPropertyFields = ubx.FieldMap{
		"Persona": ubx.FieldSpec{WireName: "persona"},
	}

var CesVersion_Snapshot_App_DefaultChannelProfile_WebWidgetConfig_SecuritySettingsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_DefaultChannelProfile_WebWidgetConfigFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_DefaultChannelProfile_WhatsappConfigFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
...
var CesVersion_Snapshot_App_DefaultChannelProfileFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_ErrorHandlingSettings_EndSessionConfigFields = ubx.FieldMap{
		"EscalateSession": ubx.FieldSpec{WireName: "escalate_session"},
	}

var CesVersion_Snapshot_App_ErrorHandlingSettings_FallbackResponseConfigFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_ErrorHandlingSettingsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholdsFields = ubx.FieldMap{
		"ToolInvocationParameterCorrectnessThreshold": ubx.FieldSpec{WireName: "tool_invocation_parameter_correctness_threshold"},
	}

var CesVersion_Snapshot_App_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ToolMatchingSettingsFields = ubx.FieldMap{
		"ExtraToolCallBehavior": ubx.FieldSpec{WireName: "extra_tool_call_behavior"},
	}

var CesVersion_Snapshot_App_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholdsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholdsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_EvaluationMetricsThresholdsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_LanguageSettingsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_LoggingSettings_AudioRecordingConfigFields = ubx.FieldMap{
		"GcsBucket": ubx.FieldSpec{WireName: "gcs_bucket"},
		"GcsPathPrefix": ubx.FieldSpec{WireName: "gcs_path_prefix"},
	}

var CesVersion_Snapshot_App_LoggingSettings_BigqueryExportSettingsFields = ubx.FieldMap{
		"Dataset": ubx.FieldSpec{WireName: "dataset"},
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
		"Project": ubx.FieldSpec{WireName: "project"},
	}

var CesVersion_Snapshot_App_LoggingSettings_CloudLoggingSettingsFields = ubx.FieldMap{
		"EnableCloudLogging": ubx.FieldSpec{WireName: "enable_cloud_logging"},
	}

var CesVersion_Snapshot_App_LoggingSettings_ConversationLoggingSettingsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_LoggingSettings_MetricAnalysisSettingsFields = ubx.FieldMap{
		"LlmMetricsOptedOut": ubx.FieldSpec{WireName: "llm_metrics_opted_out"},
	}

var CesVersion_Snapshot_App_LoggingSettings_RedactionConfigFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_LoggingSettingsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_PredefinedVariableDeclarations_SchemaFields = ubx.FieldMap{
...
var CesVersion_Snapshot_App_PredefinedVariableDeclarationsFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Name": ubx.FieldSpec{WireName: "name"},
...
var CesVersion_Snapshot_App_TimeZoneSettingsFields = ubx.FieldMap{
		"TimeZone": ubx.FieldSpec{WireName: "time_zone"},
	}

var CesVersion_Snapshot_App_VpcScSettingsFields = ubx.FieldMap{
		"AllowedOrigins": ubx.FieldSpec{WireName: "allowed_origins"},
	}

var CesVersion_Snapshot_AppFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Examples_Messages_Chunks_AgentTransferFields = ubx.FieldMap{
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
		"TargetAgent": ubx.FieldSpec{WireName: "target_agent"},
	}

var CesVersion_Snapshot_Examples_Messages_Chunks_BlobFields = ubx.FieldMap{
		"Data": ubx.FieldSpec{WireName: "data"},
		"MimeType": ubx.FieldSpec{WireName: "mime_type"},
	}

var CesVersion_Snapshot_Examples_Messages_Chunks_ToolCall_ToolsetToolFields = ubx.FieldMap{
		"ToolId": ubx.FieldSpec{WireName: "tool_id"},
		"Toolset": ubx.FieldSpec{WireName: "toolset"},
	}

var CesVersion_Snapshot_Examples_Messages_Chunks_ToolCallFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Examples_Messages_Chunks_ToolResponseFields = ubx.FieldMap{
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
		"Id": ubx.FieldSpec{WireName: "id"},
...
var CesVersion_Snapshot_Examples_Messages_ChunksFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Examples_MessagesFields = ubx.FieldMap{
...
var CesVersion_Snapshot_ExamplesFields = ubx.FieldMap{
		"CreateTime": ubx.FieldSpec{WireName: "create_time"},
		"Description": ubx.FieldSpec{WireName: "description"},
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
...
var CesVersion_Snapshot_Guardrails_Action_GenerativeAnswerFields = ubx.FieldMap{
		"Prompt": ubx.FieldSpec{WireName: "prompt"},
	}

var CesVersion_Snapshot_Guardrails_Action_RespondImmediately_ResponsesFields = ubx.FieldMap{
		"Disabled": ubx.FieldSpec{WireName: "disabled"},
		"Text": ubx.FieldSpec{WireName: "text"},
	}

var CesVersion_Snapshot_Guardrails_Action_RespondImmediatelyFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Guardrails_Action_TransferAgentFields = ubx.FieldMap{
		"Agent": ubx.FieldSpec{WireName: "agent"},
	}

var CesVersion_Snapshot_Guardrails_ActionFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Guardrails_CodeCallbackFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Guardrails_ContentFilterFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Guardrails_LlmPolicyFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Guardrails_LlmPromptSecurity_DefaultSettingsFields = ubx.FieldMap{
		"DefaultPromptTemplate": ubx.FieldSpec{WireName: "default_prompt_template"},
	}

var CesVersion_Snapshot_Guardrails_LlmPromptSecurityFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Guardrails_ModelSafety_SafetySettingsFields = ubx.FieldMap{
		"Category": ubx.FieldSpec{WireName: "category"},
		"Threshold": ubx.FieldSpec{WireName: "threshold"},
	}

var CesVersion_Snapshot_Guardrails_ModelSafetyFields = ubx.FieldMap{
...
var CesVersion_Snapshot_GuardrailsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_AgentToolFields = ubx.FieldMap{
		"Agent": ubx.FieldSpec{WireName: "agent"},
		"Description": ubx.FieldSpec{WireName: "description"},
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var CesVersion_Snapshot_Tools_ClientFunctionFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Name": ubx.FieldSpec{WireName: "name"},
...
var CesVersion_Snapshot_Tools_ConnectorTool_Action_EntityOperationFields = ubx.FieldMap{
		"EntityId": ubx.FieldSpec{WireName: "entity_id"},
		"Operation": ubx.FieldSpec{WireName: "operation"},
	}

var CesVersion_Snapshot_Tools_ConnectorTool_ActionFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_ConnectorTool_AuthConfig_Oauth2AuthCodeConfigFields = ubx.FieldMap{
		"OauthToken": ubx.FieldSpec{WireName: "oauth_token"},
	}

var CesVersion_Snapshot_Tools_ConnectorTool_AuthConfig_Oauth2JwtBearerConfigFields = ubx.FieldMap{
		"ClientKey": ubx.FieldSpec{WireName: "client_key"},
		"Issuer": ubx.FieldSpec{WireName: "issuer"},
		"Subject": ubx.FieldSpec{WireName: "subject"},
	}

var CesVersion_Snapshot_Tools_ConnectorTool_AuthConfigFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_ConnectorToolFields = ubx.FieldMap{
		"Action": ubx.FieldSpec{
			WireName: "action",
			Kind: "object",
...
var CesVersion_Snapshot_Tools_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPointsFields = ubx.FieldMap{
		"AttributeValue": ubx.FieldSpec{WireName: "attribute_value"},
		"BoostAmount": ubx.FieldSpec{WireName: "boost_amount"},
	}

var CesVersion_Snapshot_Tools_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpecFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_DataStoreTool_BoostSpecs_SpecFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_DataStoreTool_BoostSpecsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_DataStoreTool_DataStoreSource_DataStore_ConnectorConfigFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_DataStoreTool_DataStoreSource_DataStoreFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_DataStoreTool_DataStoreSourceFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_DataStoreTool_EngineSourceFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_DataStoreTool_ModalityConfigs_GroundingConfigFields = ubx.FieldMap{
		"Disabled": ubx.FieldSpec{WireName: "disabled"},
		"GroundingLevel": ubx.FieldSpec{WireName: "grounding_level"},
	}

var CesVersion_Snapshot_Tools_DataStoreTool_ModalityConfigs_RewriterConfigFields = ubx.FieldMap{
		"Disabled": ubx.FieldSpec{WireName: "disabled"},
		"ModelSettings": ubx.FieldSpec{
			WireName: "model_settings",
			Kind: "object",
...
var CesVersion_Snapshot_Tools_DataStoreTool_ModalityConfigs_SnippetsConfigFields = ubx.FieldMap{
		"EnableSnippets": ubx.FieldSpec{WireName: "enable_snippets"},
	}

var CesVersion_Snapshot_Tools_DataStoreTool_ModalityConfigsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_DataStoreToolFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_FileSearchToolFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_GoogleSearchTool_PromptConfigFields = ubx.FieldMap{
		"TextPrompt": ubx.FieldSpec{WireName: "text_prompt"},
		"VoicePrompt": ubx.FieldSpec{WireName: "voice_prompt"},
	}

var CesVersion_Snapshot_Tools_GoogleSearchToolFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_McpTool_ApiAuthentication_ApiKeyConfigFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_McpTool_ApiAuthentication_BearerTokenConfigFields = ubx.FieldMap{
		"Token": ubx.FieldSpec{WireName: "token"},
	}

var CesVersion_Snapshot_Tools_McpTool_ApiAuthentication_OauthConfigFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_McpTool_ApiAuthentication_ServiceAccountAuthConfigFields = ubx.FieldMap{
		"Scopes": ubx.FieldSpec{WireName: "scopes"},
		"ServiceAccount": ubx.FieldSpec{WireName: "service_account"},
	}

var CesVersion_Snapshot_Tools_McpTool_ApiAuthenticationFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_McpTool_ServiceDirectoryConfigFields = ubx.FieldMap{
		"Service": ubx.FieldSpec{WireName: "service"},
	}

var CesVersion_Snapshot_Tools_McpTool_TlsConfig_CaCertsFields = ubx.FieldMap{
		"Cert": ubx.FieldSpec{WireName: "cert"},
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
	}

var CesVersion_Snapshot_Tools_McpTool_TlsConfigFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_McpToolFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_OpenApiToolFields = ubx.FieldMap{
		"ApiAuthentication": ubx.FieldSpec{
			WireName: "api_authentication",
			Kind: "object",
			Fields: CesVersion_Snapshot_Tools_McpTool_ApiAuthenticationFields,
...
var CesVersion_Snapshot_Tools_PythonFunctionFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"PythonCode": ubx.FieldSpec{WireName: "python_code"},
		"ServiceDirectoryConfig": ubx.FieldSpec{
...
var CesVersion_Snapshot_Tools_RemoteAgentTool_AgentCard_SkillsFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
...
var CesVersion_Snapshot_Tools_RemoteAgentTool_AgentCard_SupportedInterfacesFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_RemoteAgentTool_AgentCardFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Name": ubx.FieldSpec{WireName: "name"},
...
var CesVersion_Snapshot_Tools_RemoteAgentToolFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_SystemToolFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var CesVersion_Snapshot_Tools_ToolFakeConfigFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_WidgetTool_DataMappingFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Tools_WidgetTool_TextResponseConfigFields = ubx.FieldMap{
		"StaticText": ubx.FieldSpec{WireName: "static_text"},
		"TextResponseInstruction": ubx.FieldSpec{WireName: "text_response_instruction"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var CesVersion_Snapshot_Tools_WidgetToolFields = ubx.FieldMap{
...
var CesVersion_Snapshot_ToolsFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Toolsets_ConnectorToolsetFields = ubx.FieldMap{
		"AuthConfig": ubx.FieldSpec{
			WireName: "auth_config",
			Kind: "object",
			Fields: CesVersion_Snapshot_Tools_ConnectorTool_AuthConfigFields,
...
var CesVersion_Snapshot_Toolsets_McpToolset_ToolOverrides_SnapshotFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"InputSchema": ubx.FieldSpec{
			WireName: "input_schema",
			Kind: "object",
...
var CesVersion_Snapshot_Toolsets_McpToolset_ToolOverridesFields = ubx.FieldMap{
...
var CesVersion_Snapshot_Toolsets_McpToolsetFields = ubx.FieldMap{
		"ApiAuthentication": ubx.FieldSpec{
			WireName: "api_authentication",
			Kind: "object",
			Fields: CesVersion_Snapshot_Tools_McpTool_ApiAuthenticationFields,
...
var CesVersion_Snapshot_Toolsets_OpenApiToolsetFields = ubx.FieldMap{
		"ApiAuthentication": ubx.FieldSpec{
			WireName: "api_authentication",
			Kind: "object",
			Fields: CesVersion_Snapshot_Tools_McpTool_ApiAuthenticationFields,
...
var CesVersion_Snapshot_ToolsetsFields = ubx.FieldMap{
...
var CesVersion_SnapshotFields = ubx.FieldMap{
...
var CesVersion = ubx.ResourceBinding{
