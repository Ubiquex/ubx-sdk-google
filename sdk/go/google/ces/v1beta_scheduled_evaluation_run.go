...
type V1betaScheduledEvaluationRun_Request_Config_InputAudioConfig struct {
...
type V1betaScheduledEvaluationRun_Request_Config_OutputAudioConfig struct {
...
type V1betaScheduledEvaluationRun_Request_Config struct {
...
type V1betaScheduledEvaluationRun_Request_EvaluationRunCachingSettings struct {
	// Optional. The caching mode to use for the evaluation run. If not set, default to FORCE_RUN.
	RunCachingMode any
}

type V1betaScheduledEvaluationRun_Request_OptimizationConfig struct {
...
type V1betaScheduledEvaluationRun_Request struct {
...
type V1betaScheduledEvaluationRun_SchedulingConfig struct {
