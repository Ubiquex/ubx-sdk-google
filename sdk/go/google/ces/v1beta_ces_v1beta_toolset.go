...
type V1betaCesV1betaToolset_ConnectorToolset_AuthConfig_Oauth2AuthCodeConfig struct {
	// Required. Oauth token parameter name to pass through. Must be in the format `$context.variables.`.
	OauthToken any
}

type V1betaCesV1betaToolset_ConnectorToolset_AuthConfig_Oauth2JwtBearerConfig struct {
...
type V1betaCesV1betaToolset_ConnectorToolset_AuthConfig struct {
...
type V1betaCesV1betaToolset_ConnectorToolset_ConnectorActions_EntityOperation struct {
	EntityId any
	Operation any
}

type V1betaCesV1betaToolset_ConnectorToolset_ConnectorActions struct {
...
type V1betaCesV1betaToolset_ConnectorToolset struct {
...
type V1betaCesV1betaToolset_McpToolset_ApiAuthentication_ApiKeyConfig struct {
...
type V1betaCesV1betaToolset_McpToolset_ApiAuthentication_BearerTokenConfig struct {
	// Required. The bearer token. Must be in the format `$context.variables.`.
	Token any
}

type V1betaCesV1betaToolset_McpToolset_ApiAuthentication_OauthConfig struct {
...
type V1betaCesV1betaToolset_McpToolset_ApiAuthentication_ServiceAccountAuthConfig struct {
...
type V1betaCesV1betaToolset_McpToolset_ApiAuthentication struct {
...
type V1betaCesV1betaToolset_McpToolset_ServiceDirectoryConfig struct {
...
type V1betaCesV1betaToolset_McpToolset_TlsConfig_CaCerts struct {
	Cert any
	DisplayName any
}

type V1betaCesV1betaToolset_McpToolset_TlsConfig struct {
	// Required. Specifies a list of allowed custom CA certificates for HTTPS verification.
	CaCerts any
}

type V1betaCesV1betaToolset_McpToolset_ToolOverrides_Snapshot_InputSchema struct {
...
type V1betaCesV1betaToolset_McpToolset_ToolOverrides_Snapshot struct {
	Description any
	InputSchema any
	OutputSchema any
}

type V1betaCesV1betaToolset_McpToolset_ToolOverrides struct {
...
type V1betaCesV1betaToolset_McpToolset struct {
...
type V1betaCesV1betaToolset_OpenApiToolset struct {
	// Authentication information required for API calls.
	ApiAuthentication any
...
type V1betaCesV1betaToolset_ToolFakeConfig_CodeBlock struct {
...
type V1betaCesV1betaToolset_ToolFakeConfig struct {
...
var V1betaCesV1betaToolset_ConnectorToolset_AuthConfig_Oauth2AuthCodeConfigFields = ubx.FieldMap{
		"OauthToken": ubx.FieldSpec{WireName: "oauth_token"},
	}

var V1betaCesV1betaToolset_ConnectorToolset_AuthConfig_Oauth2JwtBearerConfigFields = ubx.FieldMap{
		"ClientKey": ubx.FieldSpec{WireName: "client_key"},
		"Issuer": ubx.FieldSpec{WireName: "issuer"},
		"Subject": ubx.FieldSpec{WireName: "subject"},
	}

var V1betaCesV1betaToolset_ConnectorToolset_AuthConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaToolset_ConnectorToolset_ConnectorActions_EntityOperationFields = ubx.FieldMap{
		"EntityId": ubx.FieldSpec{WireName: "entity_id"},
		"Operation": ubx.FieldSpec{WireName: "operation"},
	}

var V1betaCesV1betaToolset_ConnectorToolset_ConnectorActionsFields = ubx.FieldMap{
...
var V1betaCesV1betaToolset_ConnectorToolsetFields = ubx.FieldMap{
...
var V1betaCesV1betaToolset_McpToolset_ApiAuthentication_ApiKeyConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaToolset_McpToolset_ApiAuthentication_BearerTokenConfigFields = ubx.FieldMap{
		"Token": ubx.FieldSpec{WireName: "token"},
	}

var V1betaCesV1betaToolset_McpToolset_ApiAuthentication_OauthConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaToolset_McpToolset_ApiAuthentication_ServiceAccountAuthConfigFields = ubx.FieldMap{
		"Scopes": ubx.FieldSpec{WireName: "scopes"},
		"ServiceAccount": ubx.FieldSpec{WireName: "service_account"},
	}

var V1betaCesV1betaToolset_McpToolset_ApiAuthenticationFields = ubx.FieldMap{
...
var V1betaCesV1betaToolset_McpToolset_ServiceDirectoryConfigFields = ubx.FieldMap{
		"Service": ubx.FieldSpec{WireName: "service"},
	}

var V1betaCesV1betaToolset_McpToolset_TlsConfig_CaCertsFields = ubx.FieldMap{
		"Cert": ubx.FieldSpec{WireName: "cert"},
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
	}

var V1betaCesV1betaToolset_McpToolset_TlsConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaToolset_McpToolset_ToolOverrides_Snapshot_InputSchemaFields = ubx.FieldMap{
...
var V1betaCesV1betaToolset_McpToolset_ToolOverrides_SnapshotFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
...
var V1betaCesV1betaToolset_McpToolset_ToolOverridesFields = ubx.FieldMap{
...
var V1betaCesV1betaToolset_McpToolsetFields = ubx.FieldMap{
...
var V1betaCesV1betaToolset_OpenApiToolsetFields = ubx.FieldMap{
		"ApiAuthentication": ubx.FieldSpec{
			WireName: "api_authentication",
			Kind: "object",
			Fields: V1betaCesV1betaToolset_McpToolset_ApiAuthenticationFields,
...
var V1betaCesV1betaToolset_ToolFakeConfig_CodeBlockFields = ubx.FieldMap{
		"PythonCode": ubx.FieldSpec{WireName: "python_code"},
	}

var V1betaCesV1betaToolset_ToolFakeConfigFields = ubx.FieldMap{
...
type V1betaCesV1betaToolsetConfig struct {
...
type V1betaCesV1betaToolsetAttrs struct {
	// A toolset that generates tools from an Integration Connectors Connection.
	ConnectorToolset any
	// Output only. Timestamp when the toolset was created.
	CreateTime any
...
var V1betaCesV1betaToolset = ubx.ResourceBinding{
