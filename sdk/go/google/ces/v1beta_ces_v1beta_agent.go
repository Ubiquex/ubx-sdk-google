...
type V1betaCesV1betaAgent_AfterAgentCallbacks struct {
	Description any
	Disabled any
...
type V1betaCesV1betaAgent_ModelSettings struct {
...
type V1betaCesV1betaAgent_RemoteDialogflowAgent struct {
...
type V1betaCesV1betaAgent_Toolsets struct {
	ToolIds any
	Toolset any
}

type V1betaCesV1betaAgent_TransferRules_DeterministicTransfer_ExpressionCondition struct {
	Expression any
}

type V1betaCesV1betaAgent_TransferRules_DeterministicTransfer_PythonCodeCondition struct {
	PythonCode any
}

type V1betaCesV1betaAgent_TransferRules_DeterministicTransfer struct {
	ExpressionCondition any
	PythonCodeCondition any
}

type V1betaCesV1betaAgent_TransferRules_DisablePlannerTransfer struct {
	ExpressionCondition any
}

type V1betaCesV1betaAgent_TransferRules struct {
	ChildAgent any
...
var V1betaCesV1betaAgent_AfterAgentCallbacksFields = ubx.FieldMap{
...
var V1betaCesV1betaAgent_ModelSettingsFields = ubx.FieldMap{
		"Model": ubx.FieldSpec{WireName: "model"},
		"Temperature": ubx.FieldSpec{WireName: "temperature"},
	}

var V1betaCesV1betaAgent_RemoteDialogflowAgentFields = ubx.FieldMap{
...
var V1betaCesV1betaAgent_ToolsetsFields = ubx.FieldMap{
		"ToolIds": ubx.FieldSpec{WireName: "tool_ids"},
		"Toolset": ubx.FieldSpec{WireName: "toolset"},
	}

var V1betaCesV1betaAgent_TransferRules_DeterministicTransfer_ExpressionConditionFields = ubx.FieldMap{
		"Expression": ubx.FieldSpec{WireName: "expression"},
	}

var V1betaCesV1betaAgent_TransferRules_DeterministicTransfer_PythonCodeConditionFields = ubx.FieldMap{
		"PythonCode": ubx.FieldSpec{WireName: "python_code"},
	}

var V1betaCesV1betaAgent_TransferRules_DeterministicTransferFields = ubx.FieldMap{
...
var V1betaCesV1betaAgent_TransferRules_DisablePlannerTransferFields = ubx.FieldMap{
		"ExpressionCondition": ubx.FieldSpec{
			WireName: "expression_condition",
			Kind: "object",
			Fields: V1betaCesV1betaAgent_TransferRules_DeterministicTransfer_ExpressionConditionFields,
...
var V1betaCesV1betaAgent_TransferRulesFields = ubx.FieldMap{
...
type V1betaCesV1betaAgentConfig struct {
...
type V1betaCesV1betaAgentAttrs struct {
	// Optional. The callbacks to execute after the agent is called. The provided callbacks are executed sequentially in the exact order they are given in the list. If a callback returns an overridden response, execution stops and any remaining callbacks are skipped.
	AfterAgentCallbacks any
	// Optional. The callbacks to execute after the model is called. If there are multiple calls to the model, the callback will be executed multiple times. The provided callbacks are executed sequentially in the exact order they are given in the list. If a callback returns an overridden response, execution stops and any remaining callbacks are skipped.
	AfterModelCallbacks any
...
var V1betaCesV1betaAgent = ubx.ResourceBinding{
