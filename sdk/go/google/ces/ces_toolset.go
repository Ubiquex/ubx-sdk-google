...
type CesToolset_ConnectorToolset_AuthConfig_Oauth2AuthCodeConfig struct {
	// Required. Oauth token parameter name to pass through. Must be in the format `$context.variables.`.
	OauthToken any
}

type CesToolset_ConnectorToolset_AuthConfig_Oauth2JwtBearerConfig struct {
...
type CesToolset_ConnectorToolset_AuthConfig struct {
...
type CesToolset_ConnectorToolset_ConnectorActions_EntityOperation struct {
	EntityId any
	Operation any
}

type CesToolset_ConnectorToolset_ConnectorActions struct {
...
type CesToolset_ConnectorToolset struct {
...
type CesToolset_McpToolset_ApiAuthentication_ApiKeyConfig struct {
...
type CesToolset_McpToolset_ApiAuthentication_BearerTokenConfig struct {
	// Required. The bearer token. Must be in the format `$context.variables.`.
	Token any
}

type CesToolset_McpToolset_ApiAuthentication_OauthConfig struct {
...
type CesToolset_McpToolset_ApiAuthentication_ServiceAccountAuthConfig struct {
...
type CesToolset_McpToolset_ApiAuthentication struct {
...
type CesToolset_McpToolset_ServiceDirectoryConfig struct {
...
type CesToolset_McpToolset_TlsConfig_CaCerts struct {
	Cert any
	DisplayName any
}

type CesToolset_McpToolset_TlsConfig struct {
	// Required. Specifies a list of allowed custom CA certificates for HTTPS verification.
	CaCerts any
}

type CesToolset_McpToolset_ToolOverrides_Snapshot_InputSchema struct {
...
type CesToolset_McpToolset_ToolOverrides_Snapshot struct {
	Description any
	InputSchema any
	OutputSchema any
}

type CesToolset_McpToolset_ToolOverrides struct {
...
type CesToolset_McpToolset struct {
...
type CesToolset_OpenApiToolset struct {
	// Authentication information required for API calls.
	ApiAuthentication any
...
type CesToolset_ToolFakeConfig_CodeBlock struct {
...
type CesToolset_ToolFakeConfig struct {
...
var CesToolset_ConnectorToolset_AuthConfig_Oauth2AuthCodeConfigFields = ubx.FieldMap{
		"OauthToken": ubx.FieldSpec{WireName: "oauth_token"},
	}

var CesToolset_ConnectorToolset_AuthConfig_Oauth2JwtBearerConfigFields = ubx.FieldMap{
		"ClientKey": ubx.FieldSpec{WireName: "client_key"},
		"Issuer": ubx.FieldSpec{WireName: "issuer"},
		"Subject": ubx.FieldSpec{WireName: "subject"},
	}

var CesToolset_ConnectorToolset_AuthConfigFields = ubx.FieldMap{
...
var CesToolset_ConnectorToolset_ConnectorActions_EntityOperationFields = ubx.FieldMap{
		"EntityId": ubx.FieldSpec{WireName: "entity_id"},
		"Operation": ubx.FieldSpec{WireName: "operation"},
	}

var CesToolset_ConnectorToolset_ConnectorActionsFields = ubx.FieldMap{
...
var CesToolset_ConnectorToolsetFields = ubx.FieldMap{
...
var CesToolset_McpToolset_ApiAuthentication_ApiKeyConfigFields = ubx.FieldMap{
...
var CesToolset_McpToolset_ApiAuthentication_BearerTokenConfigFields = ubx.FieldMap{
		"Token": ubx.FieldSpec{WireName: "token"},
	}

var CesToolset_McpToolset_ApiAuthentication_OauthConfigFields = ubx.FieldMap{
...
var CesToolset_McpToolset_ApiAuthentication_ServiceAccountAuthConfigFields = ubx.FieldMap{
		"Scopes": ubx.FieldSpec{WireName: "scopes"},
		"ServiceAccount": ubx.FieldSpec{WireName: "service_account"},
	}

var CesToolset_McpToolset_ApiAuthenticationFields = ubx.FieldMap{
...
var CesToolset_McpToolset_ServiceDirectoryConfigFields = ubx.FieldMap{
		"Service": ubx.FieldSpec{WireName: "service"},
	}

var CesToolset_McpToolset_TlsConfig_CaCertsFields = ubx.FieldMap{
		"Cert": ubx.FieldSpec{WireName: "cert"},
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
	}

var CesToolset_McpToolset_TlsConfigFields = ubx.FieldMap{
...
var CesToolset_McpToolset_ToolOverrides_Snapshot_InputSchemaFields = ubx.FieldMap{
...
var CesToolset_McpToolset_ToolOverrides_SnapshotFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
...
var CesToolset_McpToolset_ToolOverridesFields = ubx.FieldMap{
...
var CesToolset_McpToolsetFields = ubx.FieldMap{
...
var CesToolset_OpenApiToolsetFields = ubx.FieldMap{
		"ApiAuthentication": ubx.FieldSpec{
			WireName: "api_authentication",
			Kind: "object",
			Fields: CesToolset_McpToolset_ApiAuthenticationFields,
...
var CesToolset_ToolFakeConfig_CodeBlockFields = ubx.FieldMap{
		"PythonCode": ubx.FieldSpec{WireName: "python_code"},
	}

var CesToolset_ToolFakeConfigFields = ubx.FieldMap{
...
var CesToolset = ubx.ResourceBinding{
