...
type V1betaCesV1betaDeployment_ChannelProfile_InstagramConfig struct {
...
type V1betaCesV1betaDeployment_ChannelProfile_PersonaProperty struct {
	// Optional. The persona of the channel.
	Persona any
}

type V1betaCesV1betaDeployment_ChannelProfile_WebWidgetConfig_SecuritySettings struct {
...
type V1betaCesV1betaDeployment_ChannelProfile_WebWidgetConfig struct {
...
type V1betaCesV1betaDeployment_ChannelProfile_WhatsappConfig struct {
	// Output only. The description of the Meta business page or profile.
	Description any
	// Output only. The fetched Meta business page name.
	DisplayName any
...
type V1betaCesV1betaDeployment_ChannelProfile struct {
...
type V1betaCesV1betaDeployment_ExperimentConfig_VersionRelease_TrafficAllocations struct {
	AppVersion any
	Id any
	TrafficPercentage any
}

type V1betaCesV1betaDeployment_ExperimentConfig_VersionRelease struct {
...
type V1betaCesV1betaDeployment_ExperimentConfig struct {
	// Version release for the experiment.
	VersionRelease any
}

type V1betaCesV1betaDeployment_InstagramCredentials struct {
...
type V1betaCesV1betaDeployment_ModelSettings struct {
...
type V1betaCesV1betaDeployment_WhatsappCredentials struct {
	// Required. The Meta auth code provided by the embedded signup flow.
	AuthCode any
...
var V1betaCesV1betaDeployment_ChannelProfile_InstagramConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaDeployment_ChannelProfile_PersonaPropertyFields = ubx.FieldMap{
		"Persona": ubx.FieldSpec{WireName: "persona"},
	}

var V1betaCesV1betaDeployment_ChannelProfile_WebWidgetConfig_SecuritySettingsFields = ubx.FieldMap{
...
var V1betaCesV1betaDeployment_ChannelProfile_WebWidgetConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaDeployment_ChannelProfile_WhatsappConfigFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
...
var V1betaCesV1betaDeployment_ChannelProfileFields = ubx.FieldMap{
...
var V1betaCesV1betaDeployment_ExperimentConfig_VersionRelease_TrafficAllocationsFields = ubx.FieldMap{
		"AppVersion": ubx.FieldSpec{WireName: "app_version"},
		"Id": ubx.FieldSpec{WireName: "id"},
		"TrafficPercentage": ubx.FieldSpec{WireName: "traffic_percentage"},
	}

var V1betaCesV1betaDeployment_ExperimentConfig_VersionReleaseFields = ubx.FieldMap{
...
var V1betaCesV1betaDeployment_ExperimentConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaDeployment_InstagramCredentialsFields = ubx.FieldMap{
		"AuthCode": ubx.FieldSpec{WireName: "auth_code"},
		"ConversationProfileId": ubx.FieldSpec{WireName: "conversation_profile_id"},
	}

var V1betaCesV1betaDeployment_ModelSettingsFields = ubx.FieldMap{
		"Model": ubx.FieldSpec{WireName: "model"},
		"Temperature": ubx.FieldSpec{WireName: "temperature"},
	}

var V1betaCesV1betaDeployment_WhatsappCredentialsFields = ubx.FieldMap{
		"AuthCode": ubx.FieldSpec{WireName: "auth_code"},
...
type V1betaCesV1betaDeploymentConfig struct {
...
type V1betaCesV1betaDeploymentAttrs struct {
	// Optional. The resource name of the app version to deploy. Format: `projects/{project}/locations/{location}/apps/{app}/versions/{version}` Use `projects/{project}/locations/{location}/apps/{app}/versions/-` to use the draft app.
	AppVersion any
	// A ChannelProfile configures the agent's behavior for a specific communication channel, such as web UI or telephony.
	ChannelProfile any
...
var V1betaCesV1betaDeployment = ubx.ResourceBinding{
