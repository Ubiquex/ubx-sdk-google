...
type V1betaTool_AgentTool struct {
...
type V1betaTool_ClientFunction_Parameters struct {
...
type V1betaTool_ClientFunction struct {
...
type V1betaTool_ConnectorTool_Action_EntityOperation struct {
...
type V1betaTool_ConnectorTool_Action struct {
...
type V1betaTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig struct {
	// Required. Oauth token parameter name to pass through. Must be in the format `$context.variables.`.
	OauthToken any
}

type V1betaTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig struct {
...
type V1betaTool_ConnectorTool_AuthConfig struct {
...
type V1betaTool_ConnectorTool struct {
...
type V1betaTool_DataStoreTool_DataStoreSource_DataStore struct {
...
type V1betaTool_DataStoreTool_DataStoreSource struct {
...
type V1betaTool_DataStoreTool_EngineSource struct {
...
type V1betaTool_DataStoreTool struct {
...
type V1betaTool_FileSearchTool struct {
...
type V1betaTool_GoogleSearchTool_PromptConfig struct {
...
type V1betaTool_GoogleSearchTool struct {
...
type V1betaTool_McpTool_ApiAuthentication_ApiKeyConfig struct {
...
type V1betaTool_McpTool_ApiAuthentication_BearerTokenConfig struct {
	// Required. The bearer token. Must be in the format `$context.variables.`.
	Token any
}

type V1betaTool_McpTool_ApiAuthentication_OauthConfig struct {
...
type V1betaTool_McpTool_ApiAuthentication_ServiceAccountAuthConfig struct {
...
type V1betaTool_McpTool_ApiAuthentication struct {
...
type V1betaTool_McpTool_ServiceDirectoryConfig struct {
...
type V1betaTool_OpenApiTool struct {
	// Authentication information required for API calls.
	ApiAuthentication any
...
type V1betaTool_PythonFunction struct {
...
type V1betaTool_RemoteAgentTool struct {
...
type V1betaTool_SystemTool struct {
...
type V1betaTool_ToolFakeConfig_CodeBlock struct {
...
type V1betaTool_ToolFakeConfig struct {
...
type V1betaTool_WidgetTool_DataMapping struct {
...
type V1betaTool_WidgetTool_TextResponseConfig struct {
...
type V1betaTool_WidgetTool struct {
...
var V1betaTool = ubx.ResourceBinding{
