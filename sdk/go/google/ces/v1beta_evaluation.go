...
type V1betaEvaluation_Golden_Turns_Steps_Expectation_AgentResponse_Chunks_Image struct {
	AltText any
	Data any
	MimeType any
}
...
var V1betaEvaluation_Golden_Turns_Steps_Expectation_AgentResponse_Chunks_ImageFields = ubx.FieldMap{
