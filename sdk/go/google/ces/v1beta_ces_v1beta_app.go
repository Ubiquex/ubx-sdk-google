...
type V1betaCesV1betaApp_AudioProcessingConfig_AmbientSoundConfig struct {
...
type V1betaCesV1betaApp_AudioProcessingConfig_BargeInConfig struct {
...
type V1betaCesV1betaApp_AudioProcessingConfig_SynthesizeSpeechConfigs struct {
...
type V1betaCesV1betaApp_AudioProcessingConfig struct {
...
type V1betaCesV1betaApp_ClientCertificateSettings struct {
...
type V1betaCesV1betaApp_DataStoreSettings_Engines struct {
	Name any
	Type any
}

type V1betaCesV1betaApp_DataStoreSettings struct {
	// Output only. The engines for the app.
	Engines any
}

type V1betaCesV1betaApp_DefaultChannelProfile_InstagramConfig struct {
...
type V1betaCesV1betaApp_DefaultChannelProfile_PersonaProperty struct {
	// Optional. The persona of the channel.
	Persona any
}

type V1betaCesV1betaApp_DefaultChannelProfile_WebWidgetConfig_SecuritySettings struct {
...
type V1betaCesV1betaApp_DefaultChannelProfile_WebWidgetConfig struct {
...
type V1betaCesV1betaApp_DefaultChannelProfile_WhatsappConfig struct {
	// Output only. The description of the Meta business page or profile.
	Description any
	// Output only. The fetched Meta business page name.
	DisplayName any
...
type V1betaCesV1betaApp_DefaultChannelProfile struct {
...
type V1betaCesV1betaApp_ErrorHandlingSettings_EndSessionConfig struct {
...
type V1betaCesV1betaApp_ErrorHandlingSettings_FallbackResponseConfig struct {
...
type V1betaCesV1betaApp_ErrorHandlingSettings struct {
...
type V1betaCesV1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholds struct {
...
type V1betaCesV1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ToolMatchingSettings struct {
	// Optional. Behavior for extra tool calls. Defaults to FAIL.
	ExtraToolCallBehavior any
}

type V1betaCesV1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholds struct {
...
type V1betaCesV1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds struct {
...
type V1betaCesV1betaApp_EvaluationMetricsThresholds struct {
...
type V1betaCesV1betaApp_EvaluationPersonas_SpeechConfig struct {
	Environment any
	SpeakingRate any
	VoiceId any
}

type V1betaCesV1betaApp_EvaluationPersonas struct {
	Description any
	DisplayName any
	Name any
	Personality any
...
type V1betaCesV1betaApp_EvaluationSettings_EvaluationRunCachingSettings struct {
	// Optional. The caching mode to use for the evaluation run. If not set, default to FORCE_RUN.
	RunCachingMode any
}

type V1betaCesV1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_SemanticSimilarityMetricsConfig struct {
	// Optional. Whether to calculate semantic similarity metrics for the evaluation.
	EnableSemanticSimilarityMetrics any
}

type V1betaCesV1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_StepToolCorrectnessMetricsConfig struct {
	// Optional. Whether to calculate tool correctness metrics for the evaluation.
	EnableToolCorrectnessMetrics any
}

type V1betaCesV1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig struct {
...
type V1betaCesV1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig_ExpectationsMetMetricsConfig struct {
	// Optional. Whether to calculate the expectation level metrics for the evaluation.
	EnableExpectationsMetMetrics any
}

type V1betaCesV1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig_UserGoalMetMetricsConfig struct {
	// Optional. Whether to calculate the user goal met metrics for the evaluation.
	EnableUserGoalMetMetrics any
}

type V1betaCesV1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig struct {
...
type V1betaCesV1betaApp_EvaluationSettings_MetricsConfig struct {
...
type V1betaCesV1betaApp_EvaluationSettings struct {
...
type V1betaCesV1betaApp_LanguageSettings struct {
...
type V1betaCesV1betaApp_LoggingSettings_AudioRecordingConfig struct {
...
type V1betaCesV1betaApp_LoggingSettings_BigqueryExportSettings struct {
...
type V1betaCesV1betaApp_LoggingSettings_CloudLoggingSettings struct {
	// Optional. Whether to enable Cloud Logging for the sessions.
	EnableCloudLogging any
}

type V1betaCesV1betaApp_LoggingSettings_ConversationLoggingSettings struct {
...
type V1betaCesV1betaApp_LoggingSettings_MetricAnalysisSettings struct {
...
type V1betaCesV1betaApp_LoggingSettings_RedactionConfig struct {
...
type V1betaCesV1betaApp_LoggingSettings struct {
...
type V1betaCesV1betaApp_ModelSettings struct {
...
type V1betaCesV1betaApp_PredefinedVariableDeclarations_Schema struct {
...
type V1betaCesV1betaApp_PredefinedVariableDeclarations struct {
	Description any
	Name any
	Schema any
}

type V1betaCesV1betaApp_TimeZoneSettings struct {
...
type V1betaCesV1betaApp_VpcScSettings struct {
...
var V1betaCesV1betaApp_AudioProcessingConfig_AmbientSoundConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_AudioProcessingConfig_BargeInConfigFields = ubx.FieldMap{
		"BargeInAwareness": ubx.FieldSpec{WireName: "barge_in_awareness"},
		"DisableBargeIn": ubx.FieldSpec{WireName: "disable_barge_in"},
	}

var V1betaCesV1betaApp_AudioProcessingConfig_SynthesizeSpeechConfigsFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_AudioProcessingConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_ClientCertificateSettingsFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_DataStoreSettings_EnginesFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var V1betaCesV1betaApp_DataStoreSettingsFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_DefaultChannelProfile_InstagramConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_DefaultChannelProfile_PersonaPropertyFields = ubx.FieldMap{
		"Persona": ubx.FieldSpec{WireName: "persona"},
	}

var V1betaCesV1betaApp_DefaultChannelProfile_WebWidgetConfig_SecuritySettingsFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_DefaultChannelProfile_WebWidgetConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_DefaultChannelProfile_WhatsappConfigFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
...
var V1betaCesV1betaApp_DefaultChannelProfileFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_ErrorHandlingSettings_EndSessionConfigFields = ubx.FieldMap{
		"EscalateSession": ubx.FieldSpec{WireName: "escalate_session"},
	}

var V1betaCesV1betaApp_ErrorHandlingSettings_FallbackResponseConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_ErrorHandlingSettingsFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholdsFields = ubx.FieldMap{
		"ToolInvocationParameterCorrectnessThreshold": ubx.FieldSpec{WireName: "tool_invocation_parameter_correctness_threshold"},
	}

var V1betaCesV1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ToolMatchingSettingsFields = ubx.FieldMap{
		"ExtraToolCallBehavior": ubx.FieldSpec{WireName: "extra_tool_call_behavior"},
	}

var V1betaCesV1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholdsFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholdsFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_EvaluationMetricsThresholdsFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_EvaluationPersonas_SpeechConfigFields = ubx.FieldMap{
		"Environment": ubx.FieldSpec{WireName: "environment"},
		"SpeakingRate": ubx.FieldSpec{WireName: "speaking_rate"},
		"VoiceId": ubx.FieldSpec{WireName: "voice_id"},
	}

var V1betaCesV1betaApp_EvaluationPersonasFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
		"Name": ubx.FieldSpec{WireName: "name"},
...
var V1betaCesV1betaApp_EvaluationSettings_EvaluationRunCachingSettingsFields = ubx.FieldMap{
		"RunCachingMode": ubx.FieldSpec{WireName: "run_caching_mode"},
	}

var V1betaCesV1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_SemanticSimilarityMetricsConfigFields = ubx.FieldMap{
		"EnableSemanticSimilarityMetrics": ubx.FieldSpec{WireName: "enable_semantic_similarity_metrics"},
	}

var V1betaCesV1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_StepToolCorrectnessMetricsConfigFields = ubx.FieldMap{
		"EnableToolCorrectnessMetrics": ubx.FieldSpec{WireName: "enable_tool_correctness_metrics"},
	}

var V1betaCesV1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig_ExpectationsMetMetricsConfigFields = ubx.FieldMap{
		"EnableExpectationsMetMetrics": ubx.FieldSpec{WireName: "enable_expectations_met_metrics"},
	}

var V1betaCesV1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig_UserGoalMetMetricsConfigFields = ubx.FieldMap{
		"EnableUserGoalMetMetrics": ubx.FieldSpec{WireName: "enable_user_goal_met_metrics"},
	}

var V1betaCesV1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_EvaluationSettings_MetricsConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_EvaluationSettingsFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_LanguageSettingsFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_LoggingSettings_AudioRecordingConfigFields = ubx.FieldMap{
		"GcsBucket": ubx.FieldSpec{WireName: "gcs_bucket"},
		"GcsPathPrefix": ubx.FieldSpec{WireName: "gcs_path_prefix"},
	}

var V1betaCesV1betaApp_LoggingSettings_BigqueryExportSettingsFields = ubx.FieldMap{
		"Dataset": ubx.FieldSpec{WireName: "dataset"},
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
		"Project": ubx.FieldSpec{WireName: "project"},
	}

var V1betaCesV1betaApp_LoggingSettings_CloudLoggingSettingsFields = ubx.FieldMap{
		"EnableCloudLogging": ubx.FieldSpec{WireName: "enable_cloud_logging"},
	}

var V1betaCesV1betaApp_LoggingSettings_ConversationLoggingSettingsFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_LoggingSettings_MetricAnalysisSettingsFields = ubx.FieldMap{
		"LlmMetricsOptedOut": ubx.FieldSpec{WireName: "llm_metrics_opted_out"},
	}

var V1betaCesV1betaApp_LoggingSettings_RedactionConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_LoggingSettingsFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_ModelSettingsFields = ubx.FieldMap{
		"Model": ubx.FieldSpec{WireName: "model"},
		"Temperature": ubx.FieldSpec{WireName: "temperature"},
	}

var V1betaCesV1betaApp_PredefinedVariableDeclarations_SchemaFields = ubx.FieldMap{
...
var V1betaCesV1betaApp_PredefinedVariableDeclarationsFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Name": ubx.FieldSpec{WireName: "name"},
...
var V1betaCesV1betaApp_TimeZoneSettingsFields = ubx.FieldMap{
		"TimeZone": ubx.FieldSpec{WireName: "time_zone"},
	}

var V1betaCesV1betaApp_VpcScSettingsFields = ubx.FieldMap{
		"AllowedOrigins": ubx.FieldSpec{WireName: "allowed_origins"},
	}

type V1betaCesV1betaAppConfig struct {
...
type V1betaCesV1betaAppAttrs struct {
	// Configuration for how the input and output audio should be processed and delivered.
	AudioProcessingConfig any
	// Settings for custom client certificates.
	ClientCertificateSettings any
...
var V1betaCesV1betaApp = ubx.ResourceBinding{
