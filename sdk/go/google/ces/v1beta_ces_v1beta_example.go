...
type V1betaCesV1betaExample_Messages_Chunks_AgentTransfer struct {
	DisplayName any
	TargetAgent any
}

type V1betaCesV1betaExample_Messages_Chunks_Blob struct {
	Data any
	MimeType any
}

type V1betaCesV1betaExample_Messages_Chunks_ToolCall_ToolsetTool struct {
	ToolId any
	Toolset any
}

type V1betaCesV1betaExample_Messages_Chunks_ToolCall struct {
	Args any
	DisplayName any
	Id any
	Tool any
...
type V1betaCesV1betaExample_Messages_Chunks_ToolResponse struct {
	DisplayName any
	Id any
	Response any
	Tool any
...
type V1betaCesV1betaExample_Messages_Chunks struct {
	AgentTransfer any
	Blob any
...
type V1betaCesV1betaExample_Messages struct {
	Chunks any
	EventTime any
	Role any
}

var V1betaCesV1betaExample_Messages_Chunks_AgentTransferFields = ubx.FieldMap{
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
		"TargetAgent": ubx.FieldSpec{WireName: "target_agent"},
	}

var V1betaCesV1betaExample_Messages_Chunks_BlobFields = ubx.FieldMap{
		"Data": ubx.FieldSpec{WireName: "data"},
		"MimeType": ubx.FieldSpec{WireName: "mime_type"},
	}

var V1betaCesV1betaExample_Messages_Chunks_ToolCall_ToolsetToolFields = ubx.FieldMap{
		"ToolId": ubx.FieldSpec{WireName: "tool_id"},
		"Toolset": ubx.FieldSpec{WireName: "toolset"},
	}

var V1betaCesV1betaExample_Messages_Chunks_ToolCallFields = ubx.FieldMap{
...
var V1betaCesV1betaExample_Messages_Chunks_ToolResponseFields = ubx.FieldMap{
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
		"Id": ubx.FieldSpec{WireName: "id"},
...
var V1betaCesV1betaExample_Messages_ChunksFields = ubx.FieldMap{
...
var V1betaCesV1betaExample_MessagesFields = ubx.FieldMap{
...
type V1betaCesV1betaExampleConfig struct {
...
type V1betaCesV1betaExampleAttrs struct {
	// Output only. Timestamp when the example was created.
	CreateTime any
	// Optional. Human-readable description of the example.
	Description any
...
var V1betaCesV1betaExample = ubx.ResourceBinding{
