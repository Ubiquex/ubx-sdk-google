...
type Agent_RemoteA2aAgent_A2aConfig_ApiAuthentication_ApiKeyConfig struct {
...
type Agent_RemoteA2aAgent_A2aConfig_ApiAuthentication_BearerTokenConfig struct {
	// Required. The bearer token. Must be in the format `$context.variables.`.
	Token any
}

type Agent_RemoteA2aAgent_A2aConfig_ApiAuthentication_OauthConfig struct {
...
type Agent_RemoteA2aAgent_A2aConfig_ApiAuthentication_ServiceAccountAuthConfig struct {
...
type Agent_RemoteA2aAgent_A2aConfig_ApiAuthentication struct {
...
type Agent_RemoteA2aAgent_A2aConfig struct {
...
type Agent_RemoteA2aAgent struct {
