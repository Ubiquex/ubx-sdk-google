...
type V1betaDeployment_AgentRegistryDeployment struct {
...
type V1betaDeployment_ChannelProfile_InstagramConfig struct {
...
type V1betaDeployment_ChannelProfile_PersonaProperty struct {
	// Optional. The persona of the channel.
	Persona any
}

type V1betaDeployment_ChannelProfile_WebWidgetConfig_SecuritySettings struct {
...
type V1betaDeployment_ChannelProfile_WebWidgetConfig struct {
...
type V1betaDeployment_ChannelProfile_WhatsappConfig struct {
	// Output only. The description of the Meta business page or profile.
	Description any
	// Output only. The fetched Meta business page name.
	DisplayName any
...
type V1betaDeployment_ChannelProfile struct {
...
type V1betaDeployment_ExperimentConfig_VersionRelease struct {
...
type V1betaDeployment_ExperimentConfig struct {
	// Version release for the experiment.
	VersionRelease any
}

type V1betaDeployment_InstagramCredentials struct {
...
type V1betaDeployment_ModelSettings struct {
...
type V1betaDeployment_WhatsappCredentials struct {
	// Required. The Meta auth code provided by the embedded signup flow.
	AuthCode any
...
var V1betaDeployment_AgentRegistryDeploymentFields = ubx.FieldMap{
...
type V1betaDeploymentAttrs struct {
	// Configuration and status for Agent Registry deployment.
	AgentRegistryDeployment any
	// Optional. The resource name of the app version to deploy. Format: `projects/{project}/locations/{location}/apps/{app}/versions/{version}` Use `projects/{project}/locations/{location}/apps/{app}/versions/-` to use the draft app.
	AppVersion any
...
var V1betaDeployment = ubx.ResourceBinding{
