...
type V1betaCesV1betaTool_AgentTool struct {
...
type V1betaCesV1betaTool_ClientFunction_Parameters struct {
...
type V1betaCesV1betaTool_ClientFunction struct {
...
type V1betaCesV1betaTool_ConnectorTool_Action_EntityOperation struct {
...
type V1betaCesV1betaTool_ConnectorTool_Action struct {
...
type V1betaCesV1betaTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig struct {
	// Required. Oauth token parameter name to pass through. Must be in the format `$context.variables.`.
	OauthToken any
}

type V1betaCesV1betaTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig struct {
...
type V1betaCesV1betaTool_ConnectorTool_AuthConfig struct {
...
type V1betaCesV1betaTool_ConnectorTool struct {
...
type V1betaCesV1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPoints struct {
	AttributeValue any
	BoostAmount any
}

type V1betaCesV1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec struct {
	AttributeType any
	ControlPoints any
	FieldName any
...
type V1betaCesV1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs struct {
	Boost any
	BoostControlSpec any
	Condition any
}

type V1betaCesV1betaTool_DataStoreTool_BoostSpecs_Spec struct {
	ConditionBoostSpecs any
}

type V1betaCesV1betaTool_DataStoreTool_BoostSpecs struct {
	DataStores any
	Spec any
}

type V1betaCesV1betaTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfig struct {
...
type V1betaCesV1betaTool_DataStoreTool_DataStoreSource_DataStore struct {
...
type V1betaCesV1betaTool_DataStoreTool_DataStoreSource struct {
...
type V1betaCesV1betaTool_DataStoreTool_EngineSource struct {
...
type V1betaCesV1betaTool_DataStoreTool_ModalityConfigs_GroundingConfig struct {
	Disabled any
	GroundingLevel any
}

type V1betaCesV1betaTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettings struct {
	Model any
	Temperature any
}

type V1betaCesV1betaTool_DataStoreTool_ModalityConfigs_RewriterConfig struct {
	Disabled any
	ModelSettings any
	Prompt any
}

type V1betaCesV1betaTool_DataStoreTool_ModalityConfigs_SnippetsConfig struct {
	EnableSnippets any
}

type V1betaCesV1betaTool_DataStoreTool_ModalityConfigs struct {
	GroundingConfig any
	ModalityType any
	RewriterConfig any
	SnippetsConfig any
...
type V1betaCesV1betaTool_DataStoreTool struct {
...
type V1betaCesV1betaTool_FileSearchTool struct {
...
type V1betaCesV1betaTool_GoogleSearchTool_PromptConfig struct {
...
type V1betaCesV1betaTool_GoogleSearchTool struct {
...
type V1betaCesV1betaTool_McpTool_ApiAuthentication_ApiKeyConfig struct {
...
type V1betaCesV1betaTool_McpTool_ApiAuthentication_BearerTokenConfig struct {
	// Required. The bearer token. Must be in the format `$context.variables.`.
	Token any
}

type V1betaCesV1betaTool_McpTool_ApiAuthentication_OauthConfig struct {
...
type V1betaCesV1betaTool_McpTool_ApiAuthentication_ServiceAccountAuthConfig struct {
...
type V1betaCesV1betaTool_McpTool_ApiAuthentication struct {
...
type V1betaCesV1betaTool_McpTool_ServiceDirectoryConfig struct {
...
type V1betaCesV1betaTool_McpTool_TlsConfig_CaCerts struct {
	Cert any
	DisplayName any
}

type V1betaCesV1betaTool_McpTool_TlsConfig struct {
	// Required. Specifies a list of allowed custom CA certificates for HTTPS verification.
	CaCerts any
}

type V1betaCesV1betaTool_McpTool struct {
...
type V1betaCesV1betaTool_OpenApiTool struct {
	// Authentication information required for API calls.
	ApiAuthentication any
...
type V1betaCesV1betaTool_PythonFunction struct {
...
type V1betaCesV1betaTool_RemoteAgentTool_AgentCard_Skills struct {
	Description any
	Examples any
	Id any
	InputModes any
...
type V1betaCesV1betaTool_RemoteAgentTool_AgentCard_SupportedInterfaces struct {
	ProtocolBinding any
	ProtocolVersion any
	Tenant any
	Url any
...
type V1betaCesV1betaTool_RemoteAgentTool_AgentCard struct {
...
type V1betaCesV1betaTool_RemoteAgentTool struct {
...
type V1betaCesV1betaTool_SystemTool struct {
...
type V1betaCesV1betaTool_ToolFakeConfig_CodeBlock struct {
...
type V1betaCesV1betaTool_ToolFakeConfig struct {
...
type V1betaCesV1betaTool_WidgetTool_DataMapping struct {
...
type V1betaCesV1betaTool_WidgetTool_TextResponseConfig struct {
...
type V1betaCesV1betaTool_WidgetTool struct {
...
var V1betaCesV1betaTool_AgentToolFields = ubx.FieldMap{
		"Agent": ubx.FieldSpec{WireName: "agent"},
		"Description": ubx.FieldSpec{WireName: "description"},
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var V1betaCesV1betaTool_ClientFunction_ParametersFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_ClientFunctionFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Name": ubx.FieldSpec{WireName: "name"},
...
var V1betaCesV1betaTool_ConnectorTool_Action_EntityOperationFields = ubx.FieldMap{
		"EntityId": ubx.FieldSpec{WireName: "entity_id"},
		"Operation": ubx.FieldSpec{WireName: "operation"},
	}

var V1betaCesV1betaTool_ConnectorTool_ActionFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfigFields = ubx.FieldMap{
		"OauthToken": ubx.FieldSpec{WireName: "oauth_token"},
	}

var V1betaCesV1betaTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfigFields = ubx.FieldMap{
		"ClientKey": ubx.FieldSpec{WireName: "client_key"},
		"Issuer": ubx.FieldSpec{WireName: "issuer"},
		"Subject": ubx.FieldSpec{WireName: "subject"},
	}

var V1betaCesV1betaTool_ConnectorTool_AuthConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_ConnectorToolFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPointsFields = ubx.FieldMap{
		"AttributeValue": ubx.FieldSpec{WireName: "attribute_value"},
		"BoostAmount": ubx.FieldSpec{WireName: "boost_amount"},
	}

var V1betaCesV1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpecFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecsFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_DataStoreTool_BoostSpecs_SpecFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_DataStoreTool_BoostSpecsFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_DataStoreTool_DataStoreSource_DataStoreFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_DataStoreTool_DataStoreSourceFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_DataStoreTool_EngineSourceFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_DataStoreTool_ModalityConfigs_GroundingConfigFields = ubx.FieldMap{
		"Disabled": ubx.FieldSpec{WireName: "disabled"},
		"GroundingLevel": ubx.FieldSpec{WireName: "grounding_level"},
	}

var V1betaCesV1betaTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettingsFields = ubx.FieldMap{
		"Model": ubx.FieldSpec{WireName: "model"},
		"Temperature": ubx.FieldSpec{WireName: "temperature"},
	}

var V1betaCesV1betaTool_DataStoreTool_ModalityConfigs_RewriterConfigFields = ubx.FieldMap{
		"Disabled": ubx.FieldSpec{WireName: "disabled"},
...
var V1betaCesV1betaTool_DataStoreTool_ModalityConfigs_SnippetsConfigFields = ubx.FieldMap{
		"EnableSnippets": ubx.FieldSpec{WireName: "enable_snippets"},
	}

var V1betaCesV1betaTool_DataStoreTool_ModalityConfigsFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_DataStoreToolFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_FileSearchToolFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_GoogleSearchTool_PromptConfigFields = ubx.FieldMap{
		"TextPrompt": ubx.FieldSpec{WireName: "text_prompt"},
		"VoicePrompt": ubx.FieldSpec{WireName: "voice_prompt"},
	}

var V1betaCesV1betaTool_GoogleSearchToolFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_McpTool_ApiAuthentication_ApiKeyConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_McpTool_ApiAuthentication_BearerTokenConfigFields = ubx.FieldMap{
		"Token": ubx.FieldSpec{WireName: "token"},
	}

var V1betaCesV1betaTool_McpTool_ApiAuthentication_OauthConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_McpTool_ApiAuthentication_ServiceAccountAuthConfigFields = ubx.FieldMap{
		"Scopes": ubx.FieldSpec{WireName: "scopes"},
		"ServiceAccount": ubx.FieldSpec{WireName: "service_account"},
	}

var V1betaCesV1betaTool_McpTool_ApiAuthenticationFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_McpTool_ServiceDirectoryConfigFields = ubx.FieldMap{
		"Service": ubx.FieldSpec{WireName: "service"},
	}

var V1betaCesV1betaTool_McpTool_TlsConfig_CaCertsFields = ubx.FieldMap{
		"Cert": ubx.FieldSpec{WireName: "cert"},
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
	}

var V1betaCesV1betaTool_McpTool_TlsConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_McpToolFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_OpenApiToolFields = ubx.FieldMap{
		"ApiAuthentication": ubx.FieldSpec{
			WireName: "api_authentication",
			Kind: "object",
			Fields: V1betaCesV1betaTool_McpTool_ApiAuthenticationFields,
...
var V1betaCesV1betaTool_PythonFunctionFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Name": ubx.FieldSpec{WireName: "name"},
...
var V1betaCesV1betaTool_RemoteAgentTool_AgentCard_SkillsFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
...
var V1betaCesV1betaTool_RemoteAgentTool_AgentCard_SupportedInterfacesFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_RemoteAgentTool_AgentCardFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Name": ubx.FieldSpec{WireName: "name"},
...
var V1betaCesV1betaTool_RemoteAgentToolFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_SystemToolFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var V1betaCesV1betaTool_ToolFakeConfig_CodeBlockFields = ubx.FieldMap{
		"PythonCode": ubx.FieldSpec{WireName: "python_code"},
	}

var V1betaCesV1betaTool_ToolFakeConfigFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_WidgetTool_DataMappingFields = ubx.FieldMap{
...
var V1betaCesV1betaTool_WidgetTool_TextResponseConfigFields = ubx.FieldMap{
		"StaticText": ubx.FieldSpec{WireName: "static_text"},
		"TextResponseInstruction": ubx.FieldSpec{WireName: "text_response_instruction"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var V1betaCesV1betaTool_WidgetToolFields = ubx.FieldMap{
...
type V1betaCesV1betaToolConfig struct {
...
type V1betaCesV1betaToolAttrs struct {
	// Represents a tool that allows the agent to call another agent.
	AgentTool any
	// Represents a client-side function that the agent can invoke. When the tool is chosen by the agent, control is handed off to the client. The client is responsible for executing the function and returning the result as a ToolResponse to continue the interaction with the agent.
	ClientFunction any
...
var V1betaCesV1betaTool = ubx.ResourceBinding{
