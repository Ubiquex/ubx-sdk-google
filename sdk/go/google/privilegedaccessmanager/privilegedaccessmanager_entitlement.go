...
type PrivilegedaccessmanagerEntitlement_AdditionalNotificationTargets struct {
...
type PrivilegedaccessmanagerEntitlement_ApprovalWorkflow_ManualApprovals_Steps_Approvers struct {
	Principals any
}

type PrivilegedaccessmanagerEntitlement_ApprovalWorkflow_ManualApprovals_Steps struct {
	ApprovalsNeeded any
	ApproverEmailRecipients any
	Approvers any
}

type PrivilegedaccessmanagerEntitlement_ApprovalWorkflow_ManualApprovals struct {
...
type PrivilegedaccessmanagerEntitlement_ApprovalWorkflow struct {
...
type PrivilegedaccessmanagerEntitlement_PrivilegedAccess_GcpIamAccess_RoleBindings struct {
	ConditionExpression any
	Role any
}

type PrivilegedaccessmanagerEntitlement_PrivilegedAccess_GcpIamAccess struct {
...
type PrivilegedaccessmanagerEntitlement_PrivilegedAccess struct {
...
type PrivilegedaccessmanagerEntitlement_RequesterJustificationConfig struct {
...
var PrivilegedaccessmanagerEntitlement_AdditionalNotificationTargetsFields = ubx.FieldMap{
...
var PrivilegedaccessmanagerEntitlement_ApprovalWorkflow_ManualApprovals_Steps_ApproversFields = ubx.FieldMap{
		"Principals": ubx.FieldSpec{WireName: "principals"},
	}

var PrivilegedaccessmanagerEntitlement_ApprovalWorkflow_ManualApprovals_StepsFields = ubx.FieldMap{
...
var PrivilegedaccessmanagerEntitlement_ApprovalWorkflow_ManualApprovalsFields = ubx.FieldMap{
...
var PrivilegedaccessmanagerEntitlement_ApprovalWorkflowFields = ubx.FieldMap{
...
var PrivilegedaccessmanagerEntitlement_PrivilegedAccess_GcpIamAccess_RoleBindingsFields = ubx.FieldMap{
		"ConditionExpression": ubx.FieldSpec{WireName: "condition_expression"},
		"Role": ubx.FieldSpec{WireName: "role"},
	}

var PrivilegedaccessmanagerEntitlement_PrivilegedAccess_GcpIamAccessFields = ubx.FieldMap{
...
var PrivilegedaccessmanagerEntitlement_PrivilegedAccessFields = ubx.FieldMap{
...
var PrivilegedaccessmanagerEntitlement_RequesterJustificationConfigFields = ubx.FieldMap{
...
type PrivilegedaccessmanagerEntitlementAttrs struct {
	// `AdditionalNotificationTargets` includes email addresses to be notified.
	AdditionalNotificationTargets any
	// Different types of approval workflows that can be used to gate privileged access granting.
	ApprovalWorkflow any
...
var PrivilegedaccessmanagerEntitlement = ubx.ResourceBinding{
