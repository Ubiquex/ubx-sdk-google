...
type V1beta1DataformV1beta1TeamFolderConfig struct {
...
type V1beta1DataformV1beta1TeamFolderAttrs struct {
	// Output only. The timestamp of when the TeamFolder was created.
	CreateTime any
	// Output only. The IAM principal identifier of the creator of the TeamFolder.
	CreatorIamPrincipal any
...
var V1beta1DataformV1beta1TeamFolder = ubx.ResourceBinding{
