...
type DataformWorkflowInvocation_DataEncryptionState struct {
	// Required. The KMS key version name with which data of a resource is encrypted.
	KmsKeyVersionName any
}

type DataformWorkflowInvocation_InvocationConfig_IncludedTargets struct {
	Database any
	Name any
	Schema any
}

type DataformWorkflowInvocation_InvocationConfig struct {
...
type DataformWorkflowInvocation_InvocationTiming struct {
...
type DataformWorkflowInvocation_PipelineConfig struct {
...
type DataformWorkflowInvocation_PrivateResourceMetadata struct {
	// Output only. If true, this resource is user-scoped, meaning it is either a workspace or sourced from a workspace.
	UserScoped any
}

var DataformWorkflowInvocation_DataEncryptionStateFields = ubx.FieldMap{
		"KmsKeyVersionName": ubx.FieldSpec{WireName: "kms_key_version_name"},
	}

var DataformWorkflowInvocation_InvocationConfig_IncludedTargetsFields = ubx.FieldMap{
		"Database": ubx.FieldSpec{WireName: "database"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"Schema": ubx.FieldSpec{WireName: "schema"},
	}

var DataformWorkflowInvocation_InvocationConfigFields = ubx.FieldMap{
...
var DataformWorkflowInvocation_InvocationTimingFields = ubx.FieldMap{
		"EndTime": ubx.FieldSpec{WireName: "end_time"},
		"StartTime": ubx.FieldSpec{WireName: "start_time"},
	}

var DataformWorkflowInvocation_PipelineConfigFields = ubx.FieldMap{
		"Path": ubx.FieldSpec{WireName: "path"},
		"PipelineType": ubx.FieldSpec{WireName: "pipeline_type"},
	}

var DataformWorkflowInvocation_PrivateResourceMetadataFields = ubx.FieldMap{
		"UserScoped": ubx.FieldSpec{WireName: "user_scoped"},
	}

type DataformWorkflowInvocationConfig struct {
...
type DataformWorkflowInvocationAttrs struct {
	// Immutable. The name of the compilation result to use for this invocation. Must be in the format `projects/*/locations/*/repositories/*/compilationResults/*`.
	CompilationResult any
	// Describes encryption state of a resource.
	DataEncryptionState any
...
var DataformWorkflowInvocation = ubx.ResourceBinding{
