...
type V1beta1WorkflowConfig_WorkflowTriggerConfig_WorkflowTriggers struct {
	TableUpdateTrigger any
}

type V1beta1WorkflowConfig_WorkflowTriggerConfig struct {
...
type V1beta1WorkflowConfigAttrs struct {
