...
type DataformWorkflowConfig_InvocationConfig_IncludedTargets struct {
	Database any
	Name any
	Schema any
}

type DataformWorkflowConfig_InvocationConfig struct {
...
type DataformWorkflowConfig_RecentScheduledExecutionRecords_ErrorStatus struct {
	Code any
	Details any
	Message any
}

type DataformWorkflowConfig_RecentScheduledExecutionRecords struct {
	ErrorStatus any
	ExecutionTime any
	WorkflowInvocation any
}

var DataformWorkflowConfig_InvocationConfig_IncludedTargetsFields = ubx.FieldMap{
		"Database": ubx.FieldSpec{WireName: "database"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"Schema": ubx.FieldSpec{WireName: "schema"},
	}

var DataformWorkflowConfig_InvocationConfigFields = ubx.FieldMap{
...
var DataformWorkflowConfig_RecentScheduledExecutionRecords_ErrorStatusFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var DataformWorkflowConfig_RecentScheduledExecutionRecordsFields = ubx.FieldMap{
...
type DataformWorkflowConfigConfig struct {
...
type DataformWorkflowConfigAttrs struct {
	// Output only. The timestamp of when the WorkflowConfig was created.
	CreateTime any
	// Optional. Optional schedule (in cron format) for automatic execution of this workflow config.
	CronSchedule any
...
var DataformWorkflowConfig = ubx.ResourceBinding{
