...
type V1beta1ReleaseConfig_CodeCompilationConfig_DefaultNotebookRuntimeOptions_GcsRepositorySnapshotDestination struct {
...
type V1beta1ReleaseConfig_CodeCompilationConfig_DefaultNotebookRuntimeOptions struct {
...
type V1beta1ReleaseConfig_CodeCompilationConfig_PipelineConfig struct {
...
type V1beta1ReleaseConfig_CodeCompilationConfig struct {
...
type V1beta1ReleaseConfig_RecentScheduledReleaseRecords_ErrorStatus struct {
	Code any
	Details any
	Message any
}

type V1beta1ReleaseConfig_RecentScheduledReleaseRecords struct {
	CompilationResult any
	ErrorStatus any
	ReleaseTime any
}

var V1beta1ReleaseConfig_CodeCompilationConfig_DefaultNotebookRuntimeOptions_GcsRepositorySnapshotDestinationFields = ubx.FieldMap{
		"RepositorySnapshotUri": ubx.FieldSpec{WireName: "repository_snapshot_uri"},
	}

var V1beta1ReleaseConfig_CodeCompilationConfig_DefaultNotebookRuntimeOptionsFields = ubx.FieldMap{
...
var V1beta1ReleaseConfig_CodeCompilationConfig_PipelineConfigFields = ubx.FieldMap{
		"Path": ubx.FieldSpec{WireName: "path"},
		"PipelineType": ubx.FieldSpec{WireName: "pipeline_type"},
	}

var V1beta1ReleaseConfig_CodeCompilationConfigFields = ubx.FieldMap{
...
var V1beta1ReleaseConfig_RecentScheduledReleaseRecords_ErrorStatusFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var V1beta1ReleaseConfig_RecentScheduledReleaseRecordsFields = ubx.FieldMap{
...
type V1beta1ReleaseConfigConfig struct {
...
type V1beta1ReleaseConfigAttrs struct {
	// Configures various aspects of Dataform code compilation.
	CodeCompilationConfig any
	// Optional. Optional schedule (in cron format) for automatic creation of compilation results.
	CronSchedule any
...
var V1beta1ReleaseConfig = ubx.ResourceBinding{
