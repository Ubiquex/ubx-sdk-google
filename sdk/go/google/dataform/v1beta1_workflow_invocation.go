...
type V1beta1WorkflowInvocation_DataEncryptionState struct {
...
type V1beta1WorkflowInvocation_InvocationTiming struct {
...
type V1beta1WorkflowInvocation_PipelineConfig struct {
...
type V1beta1WorkflowInvocation_PrivateResourceMetadata struct {
...
type V1beta1WorkflowInvocationAttrs struct {
	// Immutable. The name of the compilation result to use for this invocation. Must be in the format `projects/*/locations/*/repositories/*/compilationResults/*`.
	CompilationResult any
	// Describes encryption state of a resource.
	DataEncryptionState any
...
var V1beta1WorkflowInvocation = ubx.ResourceBinding{
