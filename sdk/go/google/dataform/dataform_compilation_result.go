...
type DataformCompilationResult_CodeCompilationConfig_DefaultNotebookRuntimeOptions_GcsRepositorySnapshotDestination struct {
...
type DataformCompilationResult_CodeCompilationConfig_DefaultNotebookRuntimeOptions struct {
...
type DataformCompilationResult_CodeCompilationConfig_PipelineConfig struct {
...
type DataformCompilationResult_CodeCompilationConfig struct {
...
type DataformCompilationResult_CompilationErrors_ActionTarget struct {
	Database any
	Name any
	Schema any
}

type DataformCompilationResult_CompilationErrors struct {
	ActionTarget any
	Message any
	Path any
	Stack any
...
type DataformCompilationResult_DataEncryptionState struct {
	// Required. The KMS key version name with which data of a resource is encrypted.
	KmsKeyVersionName any
}

type DataformCompilationResult_GcsRepositorySnapshotMetadata struct {
...
type DataformCompilationResult_PrivateResourceMetadata struct {
	// Output only. If true, this resource is user-scoped, meaning it is either a workspace or sourced from a workspace.
	UserScoped any
}

var DataformCompilationResult_CodeCompilationConfig_DefaultNotebookRuntimeOptions_GcsRepositorySnapshotDestinationFields = ubx.FieldMap{
		"RepositorySnapshotUri": ubx.FieldSpec{WireName: "repository_snapshot_uri"},
	}

var DataformCompilationResult_CodeCompilationConfig_DefaultNotebookRuntimeOptionsFields = ubx.FieldMap{
...
var DataformCompilationResult_CodeCompilationConfig_PipelineConfigFields = ubx.FieldMap{
		"Path": ubx.FieldSpec{WireName: "path"},
		"PipelineType": ubx.FieldSpec{WireName: "pipeline_type"},
	}

var DataformCompilationResult_CodeCompilationConfigFields = ubx.FieldMap{
...
var DataformCompilationResult_CompilationErrors_ActionTargetFields = ubx.FieldMap{
		"Database": ubx.FieldSpec{WireName: "database"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"Schema": ubx.FieldSpec{WireName: "schema"},
	}

var DataformCompilationResult_CompilationErrorsFields = ubx.FieldMap{
...
var DataformCompilationResult_DataEncryptionStateFields = ubx.FieldMap{
		"KmsKeyVersionName": ubx.FieldSpec{WireName: "kms_key_version_name"},
	}

var DataformCompilationResult_GcsRepositorySnapshotMetadataFields = ubx.FieldMap{
		"Crc32cChecksum": ubx.FieldSpec{WireName: "crc32c_checksum"},
		"Generation": ubx.FieldSpec{WireName: "generation"},
		"RepositorySnapshotUri": ubx.FieldSpec{WireName: "repository_snapshot_uri"},
	}

var DataformCompilationResult_PrivateResourceMetadataFields = ubx.FieldMap{
		"UserScoped": ubx.FieldSpec{WireName: "user_scoped"},
	}

type DataformCompilationResultConfig struct {
...
type DataformCompilationResultAttrs struct {
	// Configures various aspects of Dataform code compilation.
	CodeCompilationConfig any
	// Output only. Errors encountered during project compilation.
	CompilationErrors any
...
var DataformCompilationResult = ubx.ResourceBinding{
