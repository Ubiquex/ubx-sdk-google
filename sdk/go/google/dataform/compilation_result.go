...
type CompilationResult_CodeCompilationConfig_DefaultNotebookRuntimeOptions_GcsRepositorySnapshotDestination struct {
...
type CompilationResult_CodeCompilationConfig_DefaultNotebookRuntimeOptions struct {
...
type CompilationResult_CodeCompilationConfig_PipelineConfig struct {
...
type CompilationResult_GcsRepositorySnapshotMetadata struct {
...
type CompilationResult_PrivateResourceMetadata struct {
...
var CompilationResult_CompilationErrors_ActionTargetFields = ubx.FieldMap{
		"Database": ubx.FieldSpec{WireName: "database"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"Schema": ubx.FieldSpec{WireName: "schema"},
	}

var CompilationResult_CompilationErrorsFields = ubx.FieldMap{
...
type CompilationResultAttrs struct {
	// Configures various aspects of Dataform code compilation.
	CodeCompilationConfig any
	// Output only. Errors encountered during project compilation.
	CompilationErrors any
...
var CompilationResult = ubx.ResourceBinding{
