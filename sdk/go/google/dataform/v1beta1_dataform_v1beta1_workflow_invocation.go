...
type V1beta1DataformV1beta1WorkflowInvocation_DataEncryptionState struct {
	// Required. The KMS key version name with which data of a resource is encrypted.
	KmsKeyVersionName any
}

type V1beta1DataformV1beta1WorkflowInvocation_InvocationConfig_IncludedTargets struct {
	Database any
	Name any
	Schema any
}

type V1beta1DataformV1beta1WorkflowInvocation_InvocationConfig struct {
...
type V1beta1DataformV1beta1WorkflowInvocation_InvocationTiming struct {
...
type V1beta1DataformV1beta1WorkflowInvocation_PipelineConfig struct {
...
type V1beta1DataformV1beta1WorkflowInvocation_PrivateResourceMetadata struct {
	// Output only. If true, this resource is user-scoped, meaning it is either a workspace or sourced from a workspace.
	UserScoped any
}

var V1beta1DataformV1beta1WorkflowInvocation_DataEncryptionStateFields = ubx.FieldMap{
		"KmsKeyVersionName": ubx.FieldSpec{WireName: "kms_key_version_name"},
	}

var V1beta1DataformV1beta1WorkflowInvocation_InvocationConfig_IncludedTargetsFields = ubx.FieldMap{
		"Database": ubx.FieldSpec{WireName: "database"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"Schema": ubx.FieldSpec{WireName: "schema"},
	}

var V1beta1DataformV1beta1WorkflowInvocation_InvocationConfigFields = ubx.FieldMap{
...
var V1beta1DataformV1beta1WorkflowInvocation_InvocationTimingFields = ubx.FieldMap{
		"EndTime": ubx.FieldSpec{WireName: "end_time"},
		"StartTime": ubx.FieldSpec{WireName: "start_time"},
	}

var V1beta1DataformV1beta1WorkflowInvocation_PipelineConfigFields = ubx.FieldMap{
		"Path": ubx.FieldSpec{WireName: "path"},
		"PipelineType": ubx.FieldSpec{WireName: "pipeline_type"},
	}

var V1beta1DataformV1beta1WorkflowInvocation_PrivateResourceMetadataFields = ubx.FieldMap{
		"UserScoped": ubx.FieldSpec{WireName: "user_scoped"},
	}

type V1beta1DataformV1beta1WorkflowInvocationConfig struct {
...
type V1beta1DataformV1beta1WorkflowInvocationAttrs struct {
	// Immutable. The name of the compilation result to use for this invocation. Must be in the format `projects/*/locations/*/repositories/*/compilationResults/*`.
	CompilationResult any
	// Describes encryption state of a resource.
	DataEncryptionState any
...
var V1beta1DataformV1beta1WorkflowInvocation = ubx.ResourceBinding{
