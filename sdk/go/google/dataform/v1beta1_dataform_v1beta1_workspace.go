...
type V1beta1DataformV1beta1Workspace_DataEncryptionState struct {
	// Required. The KMS key version name with which data of a resource is encrypted.
	KmsKeyVersionName any
}

type V1beta1DataformV1beta1Workspace_PrivateResourceMetadata struct {
	// Output only. If true, this resource is user-scoped, meaning it is either a workspace or sourced from a workspace.
	UserScoped any
}

var V1beta1DataformV1beta1Workspace_DataEncryptionStateFields = ubx.FieldMap{
		"KmsKeyVersionName": ubx.FieldSpec{WireName: "kms_key_version_name"},
	}

var V1beta1DataformV1beta1Workspace_PrivateResourceMetadataFields = ubx.FieldMap{
		"UserScoped": ubx.FieldSpec{WireName: "user_scoped"},
	}

type V1beta1DataformV1beta1WorkspaceConfig struct {
...
type V1beta1DataformV1beta1WorkspaceAttrs struct {
	// Output only. The timestamp of when the workspace was created.
	CreateTime any
	// Describes encryption state of a resource.
	DataEncryptionState any
...
var V1beta1DataformV1beta1Workspace = ubx.ResourceBinding{
