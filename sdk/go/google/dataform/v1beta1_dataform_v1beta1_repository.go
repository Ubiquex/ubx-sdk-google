...
type V1beta1DataformV1beta1Repository_DataEncryptionState struct {
	// Required. The KMS key version name with which data of a resource is encrypted.
	KmsKeyVersionName any
}

type V1beta1DataformV1beta1Repository_GitRemoteSettings_SshAuthenticationConfig struct {
...
type V1beta1DataformV1beta1Repository_GitRemoteSettings struct {
...
type V1beta1DataformV1beta1Repository_WorkspaceCompilationOverrides struct {
...
var V1beta1DataformV1beta1Repository_DataEncryptionStateFields = ubx.FieldMap{
		"KmsKeyVersionName": ubx.FieldSpec{WireName: "kms_key_version_name"},
	}

var V1beta1DataformV1beta1Repository_GitRemoteSettings_SshAuthenticationConfigFields = ubx.FieldMap{
...
var V1beta1DataformV1beta1Repository_GitRemoteSettingsFields = ubx.FieldMap{
...
var V1beta1DataformV1beta1Repository_WorkspaceCompilationOverridesFields = ubx.FieldMap{
...
type V1beta1DataformV1beta1RepositoryConfig struct {
...
type V1beta1DataformV1beta1RepositoryAttrs struct {
	// Optional. The name of the containing folder of the repository. The field is immutable and it can be modified via a MoveRepository operation. Format: `projects/*/locations/*/folders/*`. or `projects/*/locations/*/teamFolders/*`.
	ContainingFolder any
	// Output only. The timestamp of when the repository was created.
	CreateTime any
...
var V1beta1DataformV1beta1Repository = ubx.ResourceBinding{
