...
type BetaComputeBetaRegionDisk_AsyncPrimaryDisk struct {
...
type BetaComputeBetaRegionDisk_AsyncSecondaryDisks struct {
	AsyncReplicationDisk any
}

type BetaComputeBetaRegionDisk_DiskEncryptionKey struct {
...
type BetaComputeBetaRegionDisk_GuestOsFeatures struct {
	Type any
}

type BetaComputeBetaRegionDisk_Params struct {
...
type BetaComputeBetaRegionDisk_ResourceStatus_AsyncPrimaryDisk struct {
	State any
}

type BetaComputeBetaRegionDisk_ResourceStatus struct {
	AsyncPrimaryDisk any
	// Key: disk, value: AsyncReplicationStatus message
	AsyncSecondaryDisks any
}

var BetaComputeBetaRegionDisk_AsyncPrimaryDiskFields = ubx.FieldMap{
...
var BetaComputeBetaRegionDisk_AsyncSecondaryDisksFields = ubx.FieldMap{
...
var BetaComputeBetaRegionDisk_DiskEncryptionKeyFields = ubx.FieldMap{
...
var BetaComputeBetaRegionDisk_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var BetaComputeBetaRegionDisk_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaRegionDisk_ResourceStatus_AsyncPrimaryDiskFields = ubx.FieldMap{
		"State": ubx.FieldSpec{WireName: "state"},
	}

var BetaComputeBetaRegionDisk_ResourceStatusFields = ubx.FieldMap{
...
type BetaComputeBetaRegionDiskConfig struct {
...
type BetaComputeBetaRegionDiskAttrs struct {
	// The access mode of the disk. - READ_WRITE_SINGLE: The default AccessMode, means the disk can be attached to single instance in RW mode. - READ_WRITE_MANY: The AccessMode means the disk can be attached to multiple instances in RW mode. - READ_ONLY_MANY: The AccessMode means the disk can be attached to multiple instances in RO mode. The AccessMode is only valid for Hyperdisk disk types.
	AccessMode any
	// The architecture of the disk. Valid values are ARM64 or X86_64.
	Architecture any
...
var BetaComputeBetaRegionDisk = ubx.ResourceBinding{
