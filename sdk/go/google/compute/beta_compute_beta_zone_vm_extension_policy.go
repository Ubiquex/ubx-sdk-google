...
type BetaComputeBetaZoneVmExtensionPolicy_ExtensionPolicies struct {
	PinnedVersion any
	StringConfig any
}

type BetaComputeBetaZoneVmExtensionPolicy_InstanceSelectors_LabelSelector struct {
	InclusionLabels any
}

type BetaComputeBetaZoneVmExtensionPolicy_InstanceSelectors struct {
	LabelSelector any
}

var BetaComputeBetaZoneVmExtensionPolicy_ExtensionPoliciesFields = ubx.FieldMap{
		"PinnedVersion": ubx.FieldSpec{WireName: "pinned_version"},
		"StringConfig": ubx.FieldSpec{WireName: "string_config"},
	}

var BetaComputeBetaZoneVmExtensionPolicy_InstanceSelectors_LabelSelectorFields = ubx.FieldMap{
		"InclusionLabels": ubx.FieldSpec{WireName: "inclusion_labels"},
	}

var BetaComputeBetaZoneVmExtensionPolicy_InstanceSelectorsFields = ubx.FieldMap{
...
type BetaComputeBetaZoneVmExtensionPolicyConfig struct {
...
type BetaComputeBetaZoneVmExtensionPolicyAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource.
	Description any
...
var BetaComputeBetaZoneVmExtensionPolicy = ubx.ResourceBinding{
