...
type AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_CertificatePaths struct {
...
type AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPlugin struct {
	// Plugin name.
	Name any
...
type AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials struct {
...
type AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentials struct {
...
type AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig struct {
...
type AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig struct {
	// [Deprecated] gRPC config to access the SDS server. gRPC config to access the SDS server.
	GrpcServiceConfig any
}

type AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext struct {
	// [Deprecated] The paths to the mounted TLS Certificates and private key. The paths to the mounted TLS Certificates and private key.
...
type AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_ValidationContext struct {
...
type AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext struct {
...
type AlphaComputeAlphaSslPolicy_TlsSettings struct {
...
type AlphaComputeAlphaSslPolicy_Warnings_Data struct {
	Key any
	Value any
}

type AlphaComputeAlphaSslPolicy_Warnings struct {
	Code any
	Data any
	Message any
}

var AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_CertificatePathsFields = ubx.FieldMap{
		"CertificatePath": ubx.FieldSpec{WireName: "certificate_path"},
		"PrivateKeyPath": ubx.FieldSpec{WireName: "private_key_path"},
	}

var AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPluginFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"StructConfig": ubx.FieldSpec{WireName: "struct_config"},
	}

var AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentialsFields = ubx.FieldMap{
...
var AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentialsFields = ubx.FieldMap{
...
var AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfigFields = ubx.FieldMap{
...
var AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfigFields = ubx.FieldMap{
...
var AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_CertificateContextFields = ubx.FieldMap{
...
var AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContext_ValidationContextFields = ubx.FieldMap{
		"CertificatePath": ubx.FieldSpec{WireName: "certificate_path"},
		"SdsConfig": ubx.FieldSpec{
			WireName: "sds_config",
			Kind: "object",
...
var AlphaComputeAlphaSslPolicy_TlsSettings_ProxyTlsContextFields = ubx.FieldMap{
...
var AlphaComputeAlphaSslPolicy_TlsSettingsFields = ubx.FieldMap{
...
var AlphaComputeAlphaSslPolicy_Warnings_DataFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var AlphaComputeAlphaSslPolicy_WarningsFields = ubx.FieldMap{
...
type AlphaComputeAlphaSslPolicyConfig struct {
...
type AlphaComputeAlphaSslPolicyAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// A list of features enabled when the selected profile is CUSTOM. The method returns the set of features that can be specified in this list. This field must be empty if the profile is notCUSTOM.
	CustomFeatures any
...
var AlphaComputeAlphaSslPolicy = ubx.ResourceBinding{
