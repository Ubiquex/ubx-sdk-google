...
type BetaComputeBetaLicense_MinimumRetention struct {
...
type BetaComputeBetaLicense_Params struct {
...
type BetaComputeBetaLicense_ResourceRequirements struct {
...
type BetaComputeBetaLicenseAttrs struct {
	// Specifies licenseCodes of licenses that can replace this license. Note: such replacements are allowed even if removable_from_disk is false.
	AllowedReplacementLicenses any
	// If true, this license can be appended to an existing disk's set of licenses.
	AppendableToDisk any
...
var BetaComputeBetaLicense = ubx.ResourceBinding{
