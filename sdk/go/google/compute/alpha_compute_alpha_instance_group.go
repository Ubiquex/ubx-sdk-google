...
type AlphaComputeAlphaInstanceGroup_NamedPorts struct {
	Name any
	Port any
}

var AlphaComputeAlphaInstanceGroup_NamedPortsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Port": ubx.FieldSpec{WireName: "port"},
	}

type AlphaComputeAlphaInstanceGroupConfig struct {
...
type AlphaComputeAlphaInstanceGroupAttrs struct {
	// Output only. [Output Only] The creation timestamp for this instance group inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaComputeAlphaInstanceGroup = ubx.ResourceBinding{
