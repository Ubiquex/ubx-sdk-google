...
type BetaComputeBetaWireGroup_Endpoints_Interconnects struct {
	Interconnect any
	VlanTags any
}

type BetaComputeBetaWireGroup_Endpoints struct {
	Interconnects any
}

type BetaComputeBetaWireGroup_Topology_Endpoints struct {
	City any
	Label any
}

type BetaComputeBetaWireGroup_Topology struct {
	// Output only. Topology details for all endpoints in the wire group.
	Endpoints any
}

type BetaComputeBetaWireGroup_WireGroupProperties struct {
...
type BetaComputeBetaWireGroup_WireProperties struct {
...
type BetaComputeBetaWireGroup_Wires_Endpoints struct {
	Interconnect any
	VlanTag any
}

type BetaComputeBetaWireGroup_Wires struct {
	AdminEnabled any
	Endpoints any
	Label any
	WireProperties any
...
var BetaComputeBetaWireGroup_Endpoints_InterconnectsFields = ubx.FieldMap{
		"Interconnect": ubx.FieldSpec{WireName: "interconnect"},
		"VlanTags": ubx.FieldSpec{WireName: "vlan_tags"},
	}

var BetaComputeBetaWireGroup_EndpointsFields = ubx.FieldMap{
...
var BetaComputeBetaWireGroup_Topology_EndpointsFields = ubx.FieldMap{
		"City": ubx.FieldSpec{WireName: "city"},
		"Label": ubx.FieldSpec{WireName: "label"},
	}

var BetaComputeBetaWireGroup_TopologyFields = ubx.FieldMap{
...
var BetaComputeBetaWireGroup_WireGroupPropertiesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var BetaComputeBetaWireGroup_WirePropertiesFields = ubx.FieldMap{
...
var BetaComputeBetaWireGroup_Wires_EndpointsFields = ubx.FieldMap{
		"Interconnect": ubx.FieldSpec{WireName: "interconnect"},
		"VlanTag": ubx.FieldSpec{WireName: "vlan_tag"},
	}

var BetaComputeBetaWireGroup_WiresFields = ubx.FieldMap{
...
type BetaComputeBetaWireGroupConfig struct {
...
type BetaComputeBetaWireGroupAttrs struct {
	// Indicates whether the wires in the wire group are enabled. When false, the wires in the wire group are disabled. When true and when there is simultaneously no wire-specific override of `adminEnabled` to false, a given wire is enabled. Defaults to true.
	AdminEnabled any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var BetaComputeBetaWireGroup = ubx.ResourceBinding{
