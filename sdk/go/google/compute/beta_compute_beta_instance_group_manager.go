...
type BetaComputeBetaInstanceGroupManager_AllInstancesConfig_Properties struct {
...
type BetaComputeBetaInstanceGroupManager_AllInstancesConfig struct {
	// Represents the change that you want to make to the instance properties.
	Properties any
}

type BetaComputeBetaInstanceGroupManager_AutoHealingPolicies struct {
	HealthCheck any
	InitialDelaySec any
}

type BetaComputeBetaInstanceGroupManager_CurrentActions struct {
...
type BetaComputeBetaInstanceGroupManager_DistributionPolicy_Zones struct {
	Zone any
}

type BetaComputeBetaInstanceGroupManager_DistributionPolicy struct {
...
type BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_DiskEncryptionKey struct {
	KmsKeyName any
...
type BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_GuestOsFeatures struct {
	Type any
}

type BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_InitializeParams struct {
	Architecture any
	Description any
	DiskName any
	DiskSizeGb any
...
type BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_ShieldedInstanceInitialState_Dbs struct {
	Content any
	FileType any
}

type BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_ShieldedInstanceInitialState struct {
	Dbs any
	Dbxs any
	Keks any
	Pk any
...
type BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks struct {
	Architecture any
	AutoDelete any
	Boot any
	DeviceName any
...
type BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections struct {
	Disks any
	MachineTypes any
	MinCpuPlatform any
	Rank any
...
type BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_ProvisioningModelMix struct {
...
type BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy struct {
	// Named instance selections configuring properties that the group will use when creating new VMs.
	InstanceSelections any
	ProvisioningModelMix any
}

type BetaComputeBetaInstanceGroupManager_InstanceLifecyclePolicy_OnRepair struct {
...
type BetaComputeBetaInstanceGroupManager_InstanceLifecyclePolicy struct {
...
type BetaComputeBetaInstanceGroupManager_NamedPorts struct {
	Name any
	Port any
}

type BetaComputeBetaInstanceGroupManager_Params struct {
...
type BetaComputeBetaInstanceGroupManager_ResourcePolicies struct {
...
type BetaComputeBetaInstanceGroupManager_StandbyPolicy struct {
...
type BetaComputeBetaInstanceGroupManager_StatefulPolicy_PreservedState_Disks struct {
	AutoDelete any
}

type BetaComputeBetaInstanceGroupManager_StatefulPolicy_PreservedState struct {
...
type BetaComputeBetaInstanceGroupManager_StatefulPolicy struct {
	// Configuration of preserved resources.
	PreservedState any
}

type BetaComputeBetaInstanceGroupManager_Status_AllInstancesConfig struct {
...
type BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_ErrorInfo struct {
	Domain any
	Metadatas any
	Reason any
}

type BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_Help_Links struct {
	Description any
	Url any
}

type BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_Help struct {
	Links any
}

type BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_LocalizedMessage struct {
	Locale any
	Message any
}

type BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_QuotaInfo struct {
	Dimensions any
	FutureLimit any
	Limit any
	LimitName any
...
type BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails struct {
	ErrorInfo any
	Help any
...
type BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors struct {
	Code any
	ErrorDetails any
	Location any
	Message any
...
type BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error struct {
	Errors any
}

type BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails struct {
	Error any
	Timestamp any
}

type BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies struct {
	AcceleratorTopology any
	State any
	StateDetails any
}

type BetaComputeBetaInstanceGroupManager_Status_BulkInstanceOperation struct {
	// Output only. Informs whether bulk instance operation is in progress.
	InProgress any
	LastProgressCheck any
}

type BetaComputeBetaInstanceGroupManager_Status_CurrentInstanceStatuses struct {
...
type BetaComputeBetaInstanceGroupManager_Status_Stateful_PerInstanceConfigs struct {
...
type BetaComputeBetaInstanceGroupManager_Status_Stateful struct {
...
type BetaComputeBetaInstanceGroupManager_Status_VersionTarget struct {
...
type BetaComputeBetaInstanceGroupManager_Status struct {
...
type BetaComputeBetaInstanceGroupManager_TargetSizePolicy struct {
	// The mode of target size policy based on which the MIG creates its VMs individually or all at once.
	Mode any
}

type BetaComputeBetaInstanceGroupManager_UpdatePolicy_MaxSurge struct {
...
type BetaComputeBetaInstanceGroupManager_UpdatePolicy struct {
...
type BetaComputeBetaInstanceGroupManager_Versions struct {
	InstanceTemplate any
	Name any
	TargetSize any
}

var BetaComputeBetaInstanceGroupManager_AllInstancesConfig_PropertiesFields = ubx.FieldMap{
		"Labels": ubx.FieldSpec{WireName: "labels"},
		"Metadata": ubx.FieldSpec{WireName: "metadata"},
	}

var BetaComputeBetaInstanceGroupManager_AllInstancesConfigFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_AutoHealingPoliciesFields = ubx.FieldMap{
		"HealthCheck": ubx.FieldSpec{WireName: "health_check"},
		"InitialDelaySec": ubx.FieldSpec{WireName: "initial_delay_sec"},
	}

var BetaComputeBetaInstanceGroupManager_CurrentActionsFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_DistributionPolicy_ZonesFields = ubx.FieldMap{
		"Zone": ubx.FieldSpec{WireName: "zone"},
	}

var BetaComputeBetaInstanceGroupManager_DistributionPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_DiskEncryptionKeyFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_InitializeParamsFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_ShieldedInstanceInitialState_DbsFields = ubx.FieldMap{
		"Content": ubx.FieldSpec{WireName: "content"},
		"FileType": ubx.FieldSpec{WireName: "file_type"},
	}

var BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_ShieldedInstanceInitialStateFields = ubx.FieldMap{
		"Dbs": ubx.FieldSpec{
			WireName: "dbs",
			Kind: "list",
...
var BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_DisksFields = ubx.FieldMap{
		"Architecture": ubx.FieldSpec{WireName: "architecture"},
...
var BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionsFields = ubx.FieldMap{
		"Disks": ubx.FieldSpec{
			WireName: "disks",
			Kind: "list",
...
var BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicy_ProvisioningModelMixFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_InstanceFlexibilityPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_InstanceLifecyclePolicy_OnRepairFields = ubx.FieldMap{
		"AllowChangingZone": ubx.FieldSpec{WireName: "allow_changing_zone"},
	}

var BetaComputeBetaInstanceGroupManager_InstanceLifecyclePolicyFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_NamedPortsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Port": ubx.FieldSpec{WireName: "port"},
	}

var BetaComputeBetaInstanceGroupManager_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaInstanceGroupManager_ResourcePoliciesFields = ubx.FieldMap{
		"WorkloadPolicy": ubx.FieldSpec{WireName: "workload_policy"},
	}

var BetaComputeBetaInstanceGroupManager_StandbyPolicyFields = ubx.FieldMap{
		"InitialDelaySec": ubx.FieldSpec{WireName: "initial_delay_sec"},
		"Mode": ubx.FieldSpec{WireName: "mode"},
	}

var BetaComputeBetaInstanceGroupManager_StatefulPolicy_PreservedState_DisksFields = ubx.FieldMap{
		"AutoDelete": ubx.FieldSpec{WireName: "auto_delete"},
	}

var BetaComputeBetaInstanceGroupManager_StatefulPolicy_PreservedStateFields = ubx.FieldMap{
		"Disks": ubx.FieldSpec{
			WireName: "disks",
			Kind: "map",
...
var BetaComputeBetaInstanceGroupManager_StatefulPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_Status_AllInstancesConfigFields = ubx.FieldMap{
		"CurrentRevision": ubx.FieldSpec{WireName: "current_revision"},
		"Effective": ubx.FieldSpec{WireName: "effective"},
	}

var BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_ErrorInfoFields = ubx.FieldMap{
		"Domain": ubx.FieldSpec{WireName: "domain"},
		"Metadatas": ubx.FieldSpec{WireName: "metadatas"},
		"Reason": ubx.FieldSpec{WireName: "reason"},
	}

var BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_Help_LinksFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Url": ubx.FieldSpec{WireName: "url"},
	}

var BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_HelpFields = ubx.FieldMap{
		"Links": ubx.FieldSpec{
			WireName: "links",
			Kind: "list",
...
var BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_LocalizedMessageFields = ubx.FieldMap{
		"Locale": ubx.FieldSpec{WireName: "locale"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_QuotaInfoFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetailsFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_ErrorsFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_ErrorFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetailsFields = ubx.FieldMap{
		"Error": ubx.FieldSpec{
			WireName: "error",
			Kind: "object",
...
var BetaComputeBetaInstanceGroupManager_Status_AppliedAcceleratorTopologiesFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_Status_BulkInstanceOperationFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_Status_CurrentInstanceStatusesFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_Status_Stateful_PerInstanceConfigsFields = ubx.FieldMap{
		"AllEffective": ubx.FieldSpec{WireName: "all_effective"},
	}

var BetaComputeBetaInstanceGroupManager_Status_StatefulFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_Status_VersionTargetFields = ubx.FieldMap{
		"IsReached": ubx.FieldSpec{WireName: "is_reached"},
	}

var BetaComputeBetaInstanceGroupManager_StatusFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_TargetSizePolicyFields = ubx.FieldMap{
		"Mode": ubx.FieldSpec{WireName: "mode"},
	}

var BetaComputeBetaInstanceGroupManager_UpdatePolicy_MaxSurgeFields = ubx.FieldMap{
		"Calculated": ubx.FieldSpec{WireName: "calculated"},
		"Fixed": ubx.FieldSpec{WireName: "fixed"},
		"Percent": ubx.FieldSpec{WireName: "percent"},
	}

var BetaComputeBetaInstanceGroupManager_UpdatePolicyFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceGroupManager_VersionsFields = ubx.FieldMap{
...
type BetaComputeBetaInstanceGroupManagerConfig struct {
	AllInstancesConfig any
...
type BetaComputeBetaInstanceGroupManagerAttrs struct {
	AllInstancesConfig any
	// The autohealing policy for this managed instance group. You can specify only one value.
	AutoHealingPolicies any
	// The base instance name is a prefix that you want to attach to the names of all VMs in a MIG. The maximum character length is 58 and the name must comply with RFC1035 format. When a VM is created in the group, the MIG appends a hyphen and a random four-character string to the base instance name. If you want the MIG to assign sequential numbers instead of a random string, then end the base instance name with a hyphen followed by one or more hash symbols. The hash symbols indicate the number of digits. For example, a base instance name of "vm-###" results in "vm-001" as a VM name. @pattern [a-z](([-a-z0-9]{0,57})|([-a-z0-9]{0,51}-#{1,10}(\\[[0-9]{1,10}\\])?))
...
var BetaComputeBetaInstanceGroupManager = ubx.ResourceBinding{
