...
type AlphaZoneQueuedResource_BulkInsertInstanceResource_InstanceProperties_AdvancedMachineFeatures struct {
...
type AlphaZoneQueuedResource_BulkInsertInstanceResource_InstanceProperties_DisplayDevice struct {
...
type AlphaZoneQueuedResource_BulkInsertInstanceResource_InstanceProperties_Metadata struct {
...
type AlphaZoneQueuedResource_BulkInsertInstanceResource_InstanceProperties_ReservationAffinity struct {
...
type AlphaZoneQueuedResource_BulkInsertInstanceResource_InstanceProperties_Scheduling_GracefulShutdown_MaxDuration struct {
...
type AlphaZoneQueuedResource_BulkInsertInstanceResource_InstanceProperties_Scheduling_GracefulShutdown struct {
...
type AlphaZoneQueuedResource_BulkInsertInstanceResource_InstanceProperties_Scheduling_VsockMode struct {
	Mode any
}

type AlphaZoneQueuedResource_BulkInsertInstanceResource_InstanceProperties_Scheduling struct {
...
type AlphaZoneQueuedResource_BulkInsertInstanceResource_InstanceProperties_ServiceIntegrationSpecs_BackupDr struct {
	Plan any
}

type AlphaZoneQueuedResource_BulkInsertInstanceResource_InstanceProperties_ServiceIntegrationSpecs struct {
	BackupDr any
}

type AlphaZoneQueuedResource_BulkInsertInstanceResource_InstanceProperties_ShieldedInstanceConfig struct {
...
type AlphaZoneQueuedResource_BulkInsertInstanceResource_InstanceProperties_Tags struct {
...
type AlphaZoneQueuedResource_BulkInsertInstanceResource_LocationPolicy_Locations_Constraints struct {
	MaxCount any
}
...
type AlphaZoneQueuedResource_BulkInsertInstanceResource_LocationPolicy struct {
...
type AlphaZoneQueuedResource_QueuingPolicy struct {
	// A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years.
...
type AlphaZoneQueuedResource_Status_FailedData struct {
	// The error(s) that caused the QueuedResource to enter the FAILED state.
	Error any
}

type AlphaZoneQueuedResource_Status struct {
...
var AlphaZoneQueuedResource = ubx.ResourceBinding{
