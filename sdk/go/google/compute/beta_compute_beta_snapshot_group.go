...
type BetaComputeBetaSnapshotGroup_SourceInfo struct {
	ConsistencyGroup any
	ConsistencyGroupId any
}

type BetaComputeBetaSnapshotGroup_SourceInstantSnapshotGroupInfo struct {
	InstantSnapshotGroup any
	InstantSnapshotGroupId any
}

var BetaComputeBetaSnapshotGroup_SourceInfoFields = ubx.FieldMap{
		"ConsistencyGroup": ubx.FieldSpec{WireName: "consistency_group"},
		"ConsistencyGroupId": ubx.FieldSpec{WireName: "consistency_group_id"},
	}

var BetaComputeBetaSnapshotGroup_SourceInstantSnapshotGroupInfoFields = ubx.FieldMap{
...
type BetaComputeBetaSnapshotGroupConfig struct {
...
type BetaComputeBetaSnapshotGroupAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// Optional. An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var BetaComputeBetaSnapshotGroup = ubx.ResourceBinding{
