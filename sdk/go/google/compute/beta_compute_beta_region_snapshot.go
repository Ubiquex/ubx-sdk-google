...
type BetaComputeBetaRegionSnapshot_GuestOsFeatures struct {
	Type any
}

type BetaComputeBetaRegionSnapshot_Params struct {
...
type BetaComputeBetaRegionSnapshot_SnapshotEncryptionKey struct {
...
var BetaComputeBetaRegionSnapshot_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var BetaComputeBetaRegionSnapshot_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaRegionSnapshot_SnapshotEncryptionKeyFields = ubx.FieldMap{
...
type BetaComputeBetaRegionSnapshotConfig struct {
...
type BetaComputeBetaRegionSnapshotAttrs struct {
	// Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64.
	Architecture any
	// Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk.
	AutoCreated any
...
var BetaComputeBetaRegionSnapshot = ubx.ResourceBinding{
