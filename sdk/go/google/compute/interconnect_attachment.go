...
type InterconnectAttachment_ConfigurationConstraints struct {
...
type InterconnectAttachment_PartnerMetadata struct {
...
type InterconnectAttachment_PrivateInterconnectInfo struct {
...
type InterconnectAttachmentAttrs struct {
	// Determines whether this Attachment will carry packets. Not present for PARTNER_PROVIDER.
	AdminEnabled any
	// Output only. [Output Only] URL of the AttachmentGroup that includes this Attachment.
	AttachmentGroup any
