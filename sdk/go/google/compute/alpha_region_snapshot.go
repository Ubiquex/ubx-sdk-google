...
type AlphaRegionSnapshot_GuestOsFeatures struct {
	Type any
}

type AlphaRegionSnapshot_Params struct {
...
type AlphaRegionSnapshot_ResourceStatus struct {
...
type AlphaRegionSnapshot_SnapshotEncryptionKey struct {
...
var AlphaRegionSnapshot_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var AlphaRegionSnapshot_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaRegionSnapshot_ResourceStatusFields = ubx.FieldMap{
		"ScheduledDeletionTime": ubx.FieldSpec{WireName: "scheduled_deletion_time"},
	}

var AlphaRegionSnapshot_SnapshotEncryptionKeyFields = ubx.FieldMap{
...
type AlphaRegionSnapshotConfig struct {
...
type AlphaRegionSnapshotAttrs struct {
	// Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64.
	Architecture any
	// Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk.
	AutoCreated any
...
var AlphaRegionSnapshot = ubx.ResourceBinding{
