...
type BetaComputeBetaSslPolicy_Warnings_Data struct {
	Key any
	Value any
}

type BetaComputeBetaSslPolicy_Warnings struct {
	Code any
	Data any
	Message any
}

var BetaComputeBetaSslPolicy_Warnings_DataFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var BetaComputeBetaSslPolicy_WarningsFields = ubx.FieldMap{
...
type BetaComputeBetaSslPolicyConfig struct {
...
type BetaComputeBetaSslPolicyAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// A list of features enabled when the selected profile is CUSTOM. The method returns the set of features that can be specified in this list. This field must be empty if the profile is notCUSTOM.
	CustomFeatures any
...
var BetaComputeBetaSslPolicy = ubx.ResourceBinding{
