...
type BetaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders struct {
	HeaderName any
}

type BetaRegionBackendBucket_CdnPolicy_CacheKeyPolicy struct {
...
type BetaRegionBackendBucket_CdnPolicy_NegativeCachingPolicy struct {
	Code any
	Ttl any
}

type BetaRegionBackendBucket_CdnPolicy struct {
...
type BetaRegionBackendBucket_Params struct {
...
type BetaRegionBackendBucket_UsedBy struct {
	Reference any
}

var BetaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeadersFields = ubx.FieldMap{
		"HeaderName": ubx.FieldSpec{WireName: "header_name"},
	}

var BetaRegionBackendBucket_CdnPolicy_CacheKeyPolicyFields = ubx.FieldMap{
...
var BetaRegionBackendBucket_CdnPolicy_NegativeCachingPolicyFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Ttl": ubx.FieldSpec{WireName: "ttl"},
	}

var BetaRegionBackendBucket_CdnPolicyFields = ubx.FieldMap{
...
var BetaRegionBackendBucket_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaRegionBackendBucket_UsedByFields = ubx.FieldMap{
		"Reference": ubx.FieldSpec{WireName: "reference"},
	}

type BetaRegionBackendBucketConfig struct {
...
type BetaRegionBackendBucketAttrs struct {
	// Cloud Storage bucket name.
	BucketName any
	// Message containing Cloud CDN configuration for a backend bucket.
	CdnPolicy any
...
var BetaRegionBackendBucket = ubx.ResourceBinding{
