...
type AlphaComputeAlphaSnapshot_GuestOsFeatures struct {
	Type any
}

type AlphaComputeAlphaSnapshot_Params struct {
...
type AlphaComputeAlphaSnapshot_ResourceStatus struct {
...
type AlphaComputeAlphaSnapshot_SnapshotEncryptionKey struct {
...
var AlphaComputeAlphaSnapshot_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var AlphaComputeAlphaSnapshot_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaComputeAlphaSnapshot_ResourceStatusFields = ubx.FieldMap{
		"ScheduledDeletionTime": ubx.FieldSpec{WireName: "scheduled_deletion_time"},
	}

var AlphaComputeAlphaSnapshot_SnapshotEncryptionKeyFields = ubx.FieldMap{
...
type AlphaComputeAlphaSnapshotConfig struct {
...
type AlphaComputeAlphaSnapshotAttrs struct {
	// Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64.
	Architecture any
	// Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk.
	AutoCreated any
...
var AlphaComputeAlphaSnapshot = ubx.ResourceBinding{
