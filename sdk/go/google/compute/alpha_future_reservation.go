...
type AlphaFutureReservation_AdvancedDeploymentControl struct {
...
type AlphaFutureReservation_AggregateReservation struct {
...
type AlphaFutureReservation_AutoCreatedReservationsDuration struct {
...
type AlphaFutureReservation_CommitmentInfo struct {
...
type AlphaFutureReservation_Params struct {
...
type AlphaFutureReservation_ShareSettings_FolderMap struct {
	FolderId any
}

type AlphaFutureReservation_ShareSettings_ProjectMap struct {
	ProjectId any
}

type AlphaFutureReservation_ShareSettings struct {
...
type AlphaFutureReservation_SpecificSkuProperties struct {
...
type AlphaFutureReservation_Status_ExapoolProvisionedCapacityGb struct {
...
type AlphaFutureReservation_Status_ExistingMatchingUsageInfo struct {
...
type AlphaFutureReservation_Status_SpecificSkuProperties struct {
	// ID of the instance template used to populate the Future Reservation properties.
	SourceInstanceTemplateId any
}

type AlphaFutureReservation_Status_StoragePoolProvisionedCapacity struct {
...
type AlphaFutureReservation_Status struct {
...
type AlphaFutureReservation_StoragePoolProperties struct {
	// Exapool provisioned capacities for each SKU type
...
var AlphaFutureReservation = ubx.ResourceBinding{
