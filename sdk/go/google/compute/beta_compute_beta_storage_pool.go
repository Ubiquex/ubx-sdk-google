...
type BetaComputeBetaStoragePool_ExapoolProvisionedCapacityGb struct {
...
type BetaComputeBetaStoragePool_Params struct {
...
type BetaComputeBetaStoragePool_ResourceStatus struct {
...
type BetaComputeBetaStoragePool_ShareSettings_ProjectMap struct {
	ProjectId any
}

type BetaComputeBetaStoragePool_ShareSettings struct {
	// A map of project id and project config.
	ProjectMap any
}

var BetaComputeBetaStoragePool_ExapoolProvisionedCapacityGbFields = ubx.FieldMap{
...
var BetaComputeBetaStoragePool_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaStoragePool_ResourceStatusFields = ubx.FieldMap{
...
var BetaComputeBetaStoragePool_ShareSettings_ProjectMapFields = ubx.FieldMap{
		"ProjectId": ubx.FieldSpec{WireName: "project_id"},
	}

var BetaComputeBetaStoragePool_ShareSettingsFields = ubx.FieldMap{
...
type BetaComputeBetaStoragePoolConfig struct {
...
type BetaComputeBetaStoragePoolAttrs struct {
	// Provisioning type of the byte capacity of the pool.
	CapacityProvisioningType any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var BetaComputeBetaStoragePool = ubx.ResourceBinding{
