...
type AlphaRegionNetworkFirewallPolicy_Associations struct {
...
type AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs struct {
	IpProtocol any
	Ports      any
}

type AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags struct {
	Name  any
	State any
}

type AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match struct {
...
type AlphaRegionNetworkFirewallPolicy_PacketMirroringRules struct {
	Action                any
	Description           any
	Direction             any
	Disabled              any
...
type AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutInput struct {
...
type AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_NextRollout struct {
...
type AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRollouts struct {
	Rollout     any
	RolloutPlan any
	State       any
}

type AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus struct {
	NextRollout any
...
type AlphaRegionNetworkFirewallPolicy_RolloutOperation struct {
...
var AlphaRegionNetworkFirewallPolicy_AssociationsFields = ubx.FieldMap{
...
var AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields = ubx.FieldMap{
	"IpProtocol": ubx.FieldSpec{WireName: "ip_protocol"},
	"Ports":      ubx.FieldSpec{WireName: "ports"},
}

var AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields = ubx.FieldMap{
	"Name":  ubx.FieldSpec{WireName: "name"},
	"State": ubx.FieldSpec{WireName: "state"},
}

var AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_MatchFields = ubx.FieldMap{
...
var AlphaRegionNetworkFirewallPolicy_PacketMirroringRulesFields = ubx.FieldMap{
...
var AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutInputFields = ubx.FieldMap{
	"Name":                  ubx.FieldSpec{WireName: "name"},
	"PredefinedRolloutPlan": ubx.FieldSpec{WireName: "predefined_rollout_plan"},
	"RetryUuid":             ubx.FieldSpec{WireName: "retry_uuid"},
}

var AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_NextRolloutFields = ubx.FieldMap{
	"RolloutId":   ubx.FieldSpec{WireName: "rollout_id"},
	"RolloutPlan": ubx.FieldSpec{WireName: "rollout_plan"},
}

var AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRolloutsFields = ubx.FieldMap{
	"Rollout":     ubx.FieldSpec{WireName: "rollout"},
	"RolloutPlan": ubx.FieldSpec{WireName: "rollout_plan"},
	"State":       ubx.FieldSpec{WireName: "state"},
}

var AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatusFields = ubx.FieldMap{
...
var AlphaRegionNetworkFirewallPolicy_RolloutOperationFields = ubx.FieldMap{
...
type AlphaRegionNetworkFirewallPolicyConfig struct {
...
type AlphaRegionNetworkFirewallPolicyAttrs struct {
	// Optional. If specified, it defines what should happen in case of backend issues for rules with apply_security_profile_group action. Allowed values: ALLOW, DENY. If not specified, the default behavior is ALLOW.
	ApplySecurityProfileFallbackAction any
	// A list of associations that belong to this firewall policy.
	Associations any
...
var AlphaRegionNetworkFirewallPolicy = ubx.ResourceBinding{
