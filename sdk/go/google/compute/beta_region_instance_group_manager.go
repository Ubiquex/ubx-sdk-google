...
type BetaRegionInstanceGroupManager_AllInstancesConfig_Properties struct {
...
type BetaRegionInstanceGroupManager_AllInstancesConfig struct {
...
type BetaRegionInstanceGroupManager_CurrentActions struct {
...
type BetaRegionInstanceGroupManager_DistributionPolicy_Zones struct {
	Zone any
}

type BetaRegionInstanceGroupManager_DistributionPolicy struct {
...
type BetaRegionInstanceGroupManager_InstanceLifecyclePolicy_OnRepair struct {
...
type BetaRegionInstanceGroupManager_InstanceLifecyclePolicy struct {
...
type BetaRegionInstanceGroupManager_NamedPorts struct {
	Name any
	Port any
}

type BetaRegionInstanceGroupManager_Params struct {
...
type BetaRegionInstanceGroupManager_ResourcePolicies struct {
...
type BetaRegionInstanceGroupManager_StandbyPolicy struct {
...
type BetaRegionInstanceGroupManager_StatefulPolicy_PreservedState_Disks struct {
	AutoDelete any
}

type BetaRegionInstanceGroupManager_StatefulPolicy_PreservedState struct {
...
type BetaRegionInstanceGroupManager_StatefulPolicy struct {
	// Configuration of preserved resources.
	PreservedState any
}

type BetaRegionInstanceGroupManager_Status_AllInstancesConfig struct {
...
type BetaRegionInstanceGroupManager_Status_CurrentInstanceStatuses struct {
...
type BetaRegionInstanceGroupManager_Status_Stateful_PerInstanceConfigs struct {
...
type BetaRegionInstanceGroupManager_Status_Stateful struct {
...
type BetaRegionInstanceGroupManager_Status_VersionTarget struct {
...
type BetaRegionInstanceGroupManager_Status struct {
...
type BetaRegionInstanceGroupManager_TargetSizePolicy struct {
	// The mode of target size policy based on which the MIG creates its VMs individually or all at once.
	Mode any
}

type BetaRegionInstanceGroupManager_UpdatePolicy_MaxSurge struct {
...
type BetaRegionInstanceGroupManager_UpdatePolicy struct {
...
var BetaRegionInstanceGroupManager = ubx.ResourceBinding{
