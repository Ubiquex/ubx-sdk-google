...
type BetaComputeBetaBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders struct {
	HeaderName any
}

type BetaComputeBetaBackendBucket_CdnPolicy_CacheKeyPolicy struct {
...
type BetaComputeBetaBackendBucket_CdnPolicy_NegativeCachingPolicy struct {
	Code any
	Ttl any
}

type BetaComputeBetaBackendBucket_CdnPolicy struct {
...
type BetaComputeBetaBackendBucket_Params struct {
...
type BetaComputeBetaBackendBucket_UsedBy struct {
	Reference any
}

var BetaComputeBetaBackendBucket_CdnPolicy_BypassCacheOnRequestHeadersFields = ubx.FieldMap{
		"HeaderName": ubx.FieldSpec{WireName: "header_name"},
	}

var BetaComputeBetaBackendBucket_CdnPolicy_CacheKeyPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaBackendBucket_CdnPolicy_NegativeCachingPolicyFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Ttl": ubx.FieldSpec{WireName: "ttl"},
	}

var BetaComputeBetaBackendBucket_CdnPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaBackendBucket_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaBackendBucket_UsedByFields = ubx.FieldMap{
		"Reference": ubx.FieldSpec{WireName: "reference"},
	}

type BetaComputeBetaBackendBucketConfig struct {
...
type BetaComputeBetaBackendBucketAttrs struct {
	// Cloud Storage bucket name.
	BucketName any
	// Message containing Cloud CDN configuration for a backend bucket.
	CdnPolicy any
...
var BetaComputeBetaBackendBucket = ubx.ResourceBinding{
