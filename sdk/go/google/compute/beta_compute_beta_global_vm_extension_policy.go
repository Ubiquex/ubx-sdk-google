...
type BetaComputeBetaGlobalVmExtensionPolicy_ExtensionPolicies struct {
	PinnedVersion any
	StringConfig any
}

type BetaComputeBetaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelector struct {
	InclusionLabels any
}

type BetaComputeBetaGlobalVmExtensionPolicy_InstanceSelectors struct {
	LabelSelector any
}

type BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutInput struct {
...
type BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus struct {
	State any
}

type BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts struct {
...
type BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus struct {
...
type BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation struct {
	RolloutInput any
	RolloutStatus any
}

var BetaComputeBetaGlobalVmExtensionPolicy_ExtensionPoliciesFields = ubx.FieldMap{
		"PinnedVersion": ubx.FieldSpec{WireName: "pinned_version"},
		"StringConfig": ubx.FieldSpec{WireName: "string_config"},
	}

var BetaComputeBetaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields = ubx.FieldMap{
		"InclusionLabels": ubx.FieldSpec{WireName: "inclusion_labels"},
	}

var BetaComputeBetaGlobalVmExtensionPolicy_InstanceSelectorsFields = ubx.FieldMap{
...
var BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields = ubx.FieldMap{
...
var BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields = ubx.FieldMap{
		"State": ubx.FieldSpec{WireName: "state"},
	}

var BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields = ubx.FieldMap{
...
var BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields = ubx.FieldMap{
...
var BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperationFields = ubx.FieldMap{
...
type BetaComputeBetaGlobalVmExtensionPolicyConfig struct {
...
type BetaComputeBetaGlobalVmExtensionPolicyAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var BetaComputeBetaGlobalVmExtensionPolicy = ubx.ResourceBinding{
