...
type AlphaRegionDisk_AsyncPrimaryDisk struct {
...
type AlphaRegionDisk_AsyncSecondaryDisks struct {
	AsyncReplicationDisk any
}

type AlphaRegionDisk_DiskEncryptionKey struct {
...
type AlphaRegionDisk_GuestOsFeatures struct {
	Type any
}

type AlphaRegionDisk_Params struct {
...
type AlphaRegionDisk_ResourceStatus_AsyncPrimaryDisk struct {
	State any
}

type AlphaRegionDisk_ResourceStatus struct {
...
var AlphaRegionDisk_AsyncPrimaryDiskFields = ubx.FieldMap{
...
var AlphaRegionDisk_AsyncSecondaryDisksFields = ubx.FieldMap{
...
var AlphaRegionDisk_DiskEncryptionKeyFields = ubx.FieldMap{
...
var AlphaRegionDisk_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var AlphaRegionDisk_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaRegionDisk_ResourceStatus_AsyncPrimaryDiskFields = ubx.FieldMap{
		"State": ubx.FieldSpec{WireName: "state"},
	}

var AlphaRegionDisk_ResourceStatusFields = ubx.FieldMap{
...
type AlphaRegionDiskConfig struct {
...
type AlphaRegionDiskAttrs struct {
	// The access mode of the disk. - READ_WRITE_SINGLE: The default AccessMode, means the disk can be attached to single instance in RW mode. - READ_WRITE_MANY: The AccessMode means the disk can be attached to multiple instances in RW mode. - READ_ONLY_MANY: The AccessMode means the disk can be attached to multiple instances in RO mode. The AccessMode is only valid for Hyperdisk disk types.
	AccessMode any
	// The architecture of the disk. Valid values are ARM64 or X86_64.
	Architecture any
...
var AlphaRegionDisk = ubx.ResourceBinding{
