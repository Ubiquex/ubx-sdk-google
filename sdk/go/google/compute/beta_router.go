...
type BetaRouter_BgpPeers_CustomLearnedIpRanges struct {
	Range any
}
...
type BetaRouter_Nats_LogConfig struct {
	Enable any
	Filter any
}

type BetaRouter_Nats_Nat64Subnetworks struct {
	Name any
}
...
var BetaRouter = ubx.ResourceBinding{
