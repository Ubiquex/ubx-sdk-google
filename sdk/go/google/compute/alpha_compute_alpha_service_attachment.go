...
type AlphaComputeAlphaServiceAttachment_ConnectedEndpoints struct {
	ConsumerNetwork any
	Endpoint any
	EndpointWithId any
	NatIps any
...
type AlphaComputeAlphaServiceAttachment_ConsumerAcceptLists struct {
	ConnectionLimit any
	EndpointUrl any
	NetworkUrl any
	ProjectIdOrNum any
...
type AlphaComputeAlphaServiceAttachment_PscServiceAttachmentId struct {
	High any
	Low any
}

type AlphaComputeAlphaServiceAttachment_TunnelingConfig struct {
	// Specify the encapsulation protocol and what metadata to include in incoming encapsulated packet headers.
	EncapsulationProfile any
	// How this Service Attachment will treat traffic sent to the tunnel_ip, destined for the consumer network.
	RoutingMode any
}

var AlphaComputeAlphaServiceAttachment_ConnectedEndpointsFields = ubx.FieldMap{
...
var AlphaComputeAlphaServiceAttachment_ConsumerAcceptListsFields = ubx.FieldMap{
...
var AlphaComputeAlphaServiceAttachment_PscServiceAttachmentIdFields = ubx.FieldMap{
		"High": ubx.FieldSpec{WireName: "high"},
		"Low": ubx.FieldSpec{WireName: "low"},
	}

var AlphaComputeAlphaServiceAttachment_TunnelingConfigFields = ubx.FieldMap{
		"EncapsulationProfile": ubx.FieldSpec{WireName: "encapsulation_profile"},
		"RoutingMode": ubx.FieldSpec{WireName: "routing_mode"},
	}

type AlphaComputeAlphaServiceAttachmentConfig struct {
...
type AlphaComputeAlphaServiceAttachmentAttrs struct {
	// Output only. [Output Only] An array of connections for all the consumers connected to this service attachment.
	ConnectedEndpoints any
	// The connection preference of service attachment. The value can be set to ACCEPT_AUTOMATIC. An ACCEPT_AUTOMATIC service attachment is one that always accepts the connection from consumer forwarding rules.
	ConnectionPreference any
...
var AlphaComputeAlphaServiceAttachment = ubx.ResourceBinding{
