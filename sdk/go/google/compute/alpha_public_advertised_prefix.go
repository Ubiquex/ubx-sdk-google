...
type AlphaPublicAdvertisedPrefix_PublicDelegatedPrefixs struct {
	IpRange any
	Name any
	Project any
	Region any
...
var AlphaPublicAdvertisedPrefix_PublicDelegatedPrefixsFields = ubx.FieldMap{
...
type AlphaPublicAdvertisedPrefixConfig struct {
...
type AlphaPublicAdvertisedPrefixAttrs struct {
	// Output only. [Output Only] The version of BYOIP API.
	ByoipApiVersion any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var AlphaPublicAdvertisedPrefix = ubx.ResourceBinding{
