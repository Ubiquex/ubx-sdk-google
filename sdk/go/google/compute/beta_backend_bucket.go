...
type BetaBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders struct {
	HeaderName any
}

type BetaBackendBucket_CdnPolicy_CacheKeyPolicy struct {
...
type BetaBackendBucket_Params struct {
...
type BetaBackendBucket_UsedBy struct {
	Reference any
}
...
var BetaBackendBucket_UsedByFields = ubx.FieldMap{
...
type BetaBackendBucketAttrs struct {
	// Cloud Storage bucket name.
	BucketName any
	// Message containing Cloud CDN configuration for a backend bucket.
	CdnPolicy any
...
var BetaBackendBucket = ubx.ResourceBinding{
