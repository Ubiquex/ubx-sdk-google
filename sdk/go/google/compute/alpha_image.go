...
type AlphaImage_Deprecated_StateOverride struct {
...
type AlphaImage_Deprecated struct {
...
type AlphaImage_GuestOsFeatures struct {
	Type any
}

type AlphaImage_ImageEncryptionKey struct {
...
type AlphaImage_RawDisk struct {
...
type AlphaImage_ShieldedInstanceInitialState struct {
	// The Key Database (db).
	Dbs any
