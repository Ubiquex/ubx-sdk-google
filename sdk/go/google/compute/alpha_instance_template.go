...
type AlphaInstanceTemplate_Properties_AdvancedMachineFeatures struct {
...
type AlphaInstanceTemplate_Properties_Metadata struct {
...
type AlphaInstanceTemplate_Properties_ReservationAffinity struct {
...
type AlphaInstanceTemplate_Properties_Scheduling_GracefulShutdown_MaxDuration struct {
...
type AlphaInstanceTemplate_Properties_Scheduling_GracefulShutdown struct {
...
type AlphaInstanceTemplate_Properties_Scheduling_VsockMode struct {
	Mode any
}

type AlphaInstanceTemplate_Properties_Scheduling struct {
...
type AlphaInstanceTemplate_Properties_ServiceIntegrationSpecs_BackupDr struct {
	Plan any
}

type AlphaInstanceTemplate_Properties_ServiceIntegrationSpecs struct {
	BackupDr any
}

type AlphaInstanceTemplate_Properties_ShieldedInstanceConfig struct {
...
type AlphaInstanceTemplate_Properties_Tags struct {
...
type AlphaInstanceTemplate_SourceInstanceParams struct {
...
type AlphaInstanceTemplateAttrs struct {
	// Output only. [Output Only] The creation timestamp for this instance template inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
