...
type BetaExternalVpnGateway_Interfaces struct {
	Id          any
	IpAddress   any
	Ipv6Address any
}

type BetaExternalVpnGateway_Params struct {
...
type BetaExternalVpnGatewayAttrs struct {
...
var BetaExternalVpnGateway = ubx.ResourceBinding{
