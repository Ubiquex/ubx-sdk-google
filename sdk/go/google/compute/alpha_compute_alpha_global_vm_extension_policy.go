...
type AlphaComputeAlphaGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors struct {
	AllOfSelectors any
}

type AlphaComputeAlphaGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector struct {
	AnyOfSelectors any
}

type AlphaComputeAlphaGlobalVmExtensionPolicy_ExtensionPolicies struct {
	InstalledSoftwareSelector any
	PinnedVersion any
	StringConfig any
}

type AlphaComputeAlphaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelector struct {
	InclusionLabels any
}

type AlphaComputeAlphaGlobalVmExtensionPolicy_InstanceSelectors struct {
	LabelSelector any
}

type AlphaComputeAlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutInput struct {
...
type AlphaComputeAlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus struct {
	State any
}

type AlphaComputeAlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts struct {
...
type AlphaComputeAlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus struct {
...
type AlphaComputeAlphaGlobalVmExtensionPolicy_RolloutOperation struct {
	RolloutInput any
	RolloutStatus any
}

var AlphaComputeAlphaGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectorsFields = ubx.FieldMap{
		"AllOfSelectors": ubx.FieldSpec{WireName: "all_of_selectors"},
	}

var AlphaComputeAlphaGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelectorFields = ubx.FieldMap{
...
var AlphaComputeAlphaGlobalVmExtensionPolicy_ExtensionPoliciesFields = ubx.FieldMap{
...
var AlphaComputeAlphaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields = ubx.FieldMap{
		"InclusionLabels": ubx.FieldSpec{WireName: "inclusion_labels"},
	}

var AlphaComputeAlphaGlobalVmExtensionPolicy_InstanceSelectorsFields = ubx.FieldMap{
...
var AlphaComputeAlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields = ubx.FieldMap{
...
var AlphaComputeAlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields = ubx.FieldMap{
		"State": ubx.FieldSpec{WireName: "state"},
	}

var AlphaComputeAlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields = ubx.FieldMap{
...
var AlphaComputeAlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields = ubx.FieldMap{
...
var AlphaComputeAlphaGlobalVmExtensionPolicy_RolloutOperationFields = ubx.FieldMap{
...
type AlphaComputeAlphaGlobalVmExtensionPolicyConfig struct {
...
type AlphaComputeAlphaGlobalVmExtensionPolicyAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaComputeAlphaGlobalVmExtensionPolicy = ubx.ResourceBinding{
