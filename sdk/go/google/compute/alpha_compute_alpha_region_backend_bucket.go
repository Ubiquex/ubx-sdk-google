...
type AlphaComputeAlphaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders struct {
	HeaderName any
}

type AlphaComputeAlphaRegionBackendBucket_CdnPolicy_CacheKeyPolicy struct {
...
type AlphaComputeAlphaRegionBackendBucket_CdnPolicy_NegativeCachingPolicy struct {
	Code any
	Ttl any
}

type AlphaComputeAlphaRegionBackendBucket_CdnPolicy struct {
...
type AlphaComputeAlphaRegionBackendBucket_Params struct {
...
type AlphaComputeAlphaRegionBackendBucket_UsedBy struct {
	Reference any
}

var AlphaComputeAlphaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeadersFields = ubx.FieldMap{
		"HeaderName": ubx.FieldSpec{WireName: "header_name"},
	}

var AlphaComputeAlphaRegionBackendBucket_CdnPolicy_CacheKeyPolicyFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionBackendBucket_CdnPolicy_NegativeCachingPolicyFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Ttl": ubx.FieldSpec{WireName: "ttl"},
	}

var AlphaComputeAlphaRegionBackendBucket_CdnPolicyFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionBackendBucket_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaComputeAlphaRegionBackendBucket_UsedByFields = ubx.FieldMap{
		"Reference": ubx.FieldSpec{WireName: "reference"},
	}

type AlphaComputeAlphaRegionBackendBucketConfig struct {
...
type AlphaComputeAlphaRegionBackendBucketAttrs struct {
	// Cloud Storage bucket name.
	BucketName any
	// Message containing Cloud CDN configuration for a backend bucket.
	CdnPolicy any
...
var AlphaComputeAlphaRegionBackendBucket = ubx.ResourceBinding{
