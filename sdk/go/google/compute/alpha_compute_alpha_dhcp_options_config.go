...
type AlphaComputeAlphaDhcpOptionsConfig_Associations struct {
	Network any
	NetworkId any
	State any
}

var AlphaComputeAlphaDhcpOptionsConfig_AssociationsFields = ubx.FieldMap{
		"Network": ubx.FieldSpec{WireName: "network"},
		"NetworkId": ubx.FieldSpec{WireName: "network_id"},
		"State": ubx.FieldSpec{WireName: "state"},
	}

type AlphaComputeAlphaDhcpOptionsConfigConfig struct {
...
type AlphaComputeAlphaDhcpOptionsConfigAttrs struct {
	// Mapping of user-defined keys to DhcpOptionsConfig to Network associations.
	Associations any
	// The file path and name of the boot image/file on the TFTP server that the client VM guest OS should download and execute during network boot. Used when the standard DHCP header 'file' field is overloaded. Corresponds to DHCPv4 Option 67.
	BootFileIpv4Name any
...
var AlphaComputeAlphaDhcpOptionsConfig = ubx.ResourceBinding{
