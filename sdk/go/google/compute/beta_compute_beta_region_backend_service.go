...
type BetaComputeBetaRegionBackendService_Backends_CustomMetrics struct {
	DryRun any
	MaxUtilization any
	Name any
}

type BetaComputeBetaRegionBackendService_Backends_OrchestrationInfo struct {
	ResourceUri any
}

type BetaComputeBetaRegionBackendService_Backends struct {
	BalancingMode any
	CapacityScaler any
	CustomMetrics any
	Description any
...
type BetaComputeBetaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders struct {
	HeaderName any
}

type BetaComputeBetaRegionBackendService_CdnPolicy_CacheKeyPolicy struct {
...
type BetaComputeBetaRegionBackendService_CdnPolicy_NegativeCachingPolicy struct {
	Code any
	Ttl any
}

type BetaComputeBetaRegionBackendService_CdnPolicy struct {
...
type BetaComputeBetaRegionBackendService_CircuitBreakers_ConnectTimeout struct {
...
type BetaComputeBetaRegionBackendService_CircuitBreakers struct {
...
type BetaComputeBetaRegionBackendService_ConnectionDraining struct {
...
type BetaComputeBetaRegionBackendService_ConnectionTrackingPolicy struct {
...
type BetaComputeBetaRegionBackendService_ConsistentHash_HttpCookie struct {
	// Name of the cookie.
	Name any
...
type BetaComputeBetaRegionBackendService_ConsistentHash struct {
...
type BetaComputeBetaRegionBackendService_CustomMetrics struct {
	DryRun any
	Name any
}

type BetaComputeBetaRegionBackendService_DynamicForwarding_ForwardProxy struct {
...
type BetaComputeBetaRegionBackendService_DynamicForwarding_IpPortSelection struct {
	// A boolean flag enabling IP:PORT based dynamic forwarding.
	Enabled any
}

type BetaComputeBetaRegionBackendService_DynamicForwarding struct {
...
type BetaComputeBetaRegionBackendService_FailoverPolicy struct {
...
type BetaComputeBetaRegionBackendService_HaPolicy_Leader_NetworkEndpoint struct {
...
type BetaComputeBetaRegionBackendService_HaPolicy_Leader struct {
...
type BetaComputeBetaRegionBackendService_HaPolicy struct {
...
type BetaComputeBetaRegionBackendService_Iap struct {
...
type BetaComputeBetaRegionBackendService_LocalityLbPolicies_CustomPolicy struct {
	Data any
	Name any
}

type BetaComputeBetaRegionBackendService_LocalityLbPolicies_Policy struct {
	Name any
}

type BetaComputeBetaRegionBackendService_LocalityLbPolicies struct {
	CustomPolicy any
	Policy any
}

type BetaComputeBetaRegionBackendService_LogConfig struct {
...
type BetaComputeBetaRegionBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity struct {
...
type BetaComputeBetaRegionBackendService_NetworkPassThroughLbTrafficPolicy struct {
	ZonalAffinity any
}

type BetaComputeBetaRegionBackendService_OutlierDetection struct {
	// A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years.
...
type BetaComputeBetaRegionBackendService_Params struct {
...
type BetaComputeBetaRegionBackendService_SecuritySettings_AwsV4Authentication struct {
...
type BetaComputeBetaRegionBackendService_SecuritySettings struct {
...
type BetaComputeBetaRegionBackendService_Subsetting struct {
	Policy any
...
type BetaComputeBetaRegionBackendService_TlsSettings_SubjectAltNames struct {
	DnsName any
	UniformResourceIdentifier any
}

type BetaComputeBetaRegionBackendService_TlsSettings struct {
...
type BetaComputeBetaRegionBackendService_UsedBy struct {
	Reference any
}

var BetaComputeBetaRegionBackendService_Backends_CustomMetricsFields = ubx.FieldMap{
		"DryRun": ubx.FieldSpec{WireName: "dry_run"},
		"MaxUtilization": ubx.FieldSpec{WireName: "max_utilization"},
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var BetaComputeBetaRegionBackendService_Backends_OrchestrationInfoFields = ubx.FieldMap{
		"ResourceUri": ubx.FieldSpec{WireName: "resource_uri"},
	}

var BetaComputeBetaRegionBackendService_BackendsFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeadersFields = ubx.FieldMap{
		"HeaderName": ubx.FieldSpec{WireName: "header_name"},
	}

var BetaComputeBetaRegionBackendService_CdnPolicy_CacheKeyPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_CdnPolicy_NegativeCachingPolicyFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Ttl": ubx.FieldSpec{WireName: "ttl"},
	}

var BetaComputeBetaRegionBackendService_CdnPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_CircuitBreakers_ConnectTimeoutFields = ubx.FieldMap{
		"Nanos": ubx.FieldSpec{WireName: "nanos"},
		"Seconds": ubx.FieldSpec{WireName: "seconds"},
	}

var BetaComputeBetaRegionBackendService_CircuitBreakersFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_ConnectionDrainingFields = ubx.FieldMap{
		"DrainingTimeoutSec": ubx.FieldSpec{WireName: "draining_timeout_sec"},
	}

var BetaComputeBetaRegionBackendService_ConnectionTrackingPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_ConsistentHash_HttpCookieFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
...
var BetaComputeBetaRegionBackendService_ConsistentHashFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_CustomMetricsFields = ubx.FieldMap{
		"DryRun": ubx.FieldSpec{WireName: "dry_run"},
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var BetaComputeBetaRegionBackendService_DynamicForwarding_ForwardProxyFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
		"ProxyMode": ubx.FieldSpec{WireName: "proxy_mode"},
	}

var BetaComputeBetaRegionBackendService_DynamicForwarding_IpPortSelectionFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
	}

var BetaComputeBetaRegionBackendService_DynamicForwardingFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_FailoverPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_HaPolicy_Leader_NetworkEndpointFields = ubx.FieldMap{
		"Instance": ubx.FieldSpec{WireName: "instance"},
	}

var BetaComputeBetaRegionBackendService_HaPolicy_LeaderFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_HaPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_IapFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
...
var BetaComputeBetaRegionBackendService_LocalityLbPolicies_CustomPolicyFields = ubx.FieldMap{
		"Data": ubx.FieldSpec{WireName: "data"},
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var BetaComputeBetaRegionBackendService_LocalityLbPolicies_PolicyFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var BetaComputeBetaRegionBackendService_LocalityLbPoliciesFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_LogConfigFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinityFields = ubx.FieldMap{
		"Spillover": ubx.FieldSpec{WireName: "spillover"},
		"SpilloverRatio": ubx.FieldSpec{WireName: "spillover_ratio"},
	}

var BetaComputeBetaRegionBackendService_NetworkPassThroughLbTrafficPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_OutlierDetectionFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaRegionBackendService_SecuritySettings_AwsV4AuthenticationFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_SecuritySettingsFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_SubsettingFields = ubx.FieldMap{
		"Policy": ubx.FieldSpec{WireName: "policy"},
		"SubsetSize": ubx.FieldSpec{WireName: "subset_size"},
	}

var BetaComputeBetaRegionBackendService_TlsSettings_SubjectAltNamesFields = ubx.FieldMap{
		"DnsName": ubx.FieldSpec{WireName: "dns_name"},
		"UniformResourceIdentifier": ubx.FieldSpec{WireName: "uniform_resource_identifier"},
	}

var BetaComputeBetaRegionBackendService_TlsSettingsFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendService_UsedByFields = ubx.FieldMap{
		"Reference": ubx.FieldSpec{WireName: "reference"},
	}

type BetaComputeBetaRegionBackendServiceConfig struct {
...
type BetaComputeBetaRegionBackendServiceAttrs struct {
	// Lifetime of cookies in seconds. This setting is applicable to Application Load Balancers and Traffic Director and requires GENERATED_COOKIE or HTTP_COOKIE session affinity. If set to 0, the cookie is non-persistent and lasts only until the end of the browser session (or equivalent). The maximum allowed value is two weeks (1,209,600). Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true.
	AffinityCookieTtlSec any
	// The list of backends that serve this BackendService.
	Backends any
...
var BetaComputeBetaRegionBackendService = ubx.ResourceBinding{
