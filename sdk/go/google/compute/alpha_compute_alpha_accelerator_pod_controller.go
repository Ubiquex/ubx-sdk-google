...
type AlphaComputeAlphaAcceleratorPodController_ManagementInterfaces_AuthenticationConfig struct {
	TrustConfig any
}

type AlphaComputeAlphaAcceleratorPodController_ManagementInterfaces struct {
...
var AlphaComputeAlphaAcceleratorPodController_ManagementInterfaces_AuthenticationConfigFields = ubx.FieldMap{
		"TrustConfig": ubx.FieldSpec{WireName: "trust_config"},
	}

var AlphaComputeAlphaAcceleratorPodController_ManagementInterfacesFields = ubx.FieldMap{
...
type AlphaComputeAlphaAcceleratorPodControllerConfig struct {
...
type AlphaComputeAlphaAcceleratorPodControllerAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource.
	Description any
...
var AlphaComputeAlphaAcceleratorPodController = ubx.ResourceBinding{
