...
type AlphaComputeAlphaRegionHealthSourceConfig struct {
...
type AlphaComputeAlphaRegionHealthSourceAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaComputeAlphaRegionHealthSource = ubx.ResourceBinding{
