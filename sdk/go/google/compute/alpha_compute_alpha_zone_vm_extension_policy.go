...
type AlphaComputeAlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors struct {
	AllOfSelectors any
}

type AlphaComputeAlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector struct {
	AnyOfSelectors any
}

type AlphaComputeAlphaZoneVmExtensionPolicy_ExtensionPolicies struct {
	InstalledSoftwareSelector any
	PinnedVersion any
	StringConfig any
}

type AlphaComputeAlphaZoneVmExtensionPolicy_InstanceSelectors_LabelSelector struct {
	InclusionLabels any
}

type AlphaComputeAlphaZoneVmExtensionPolicy_InstanceSelectors struct {
	LabelSelector any
}

var AlphaComputeAlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectorsFields = ubx.FieldMap{
		"AllOfSelectors": ubx.FieldSpec{WireName: "all_of_selectors"},
	}

var AlphaComputeAlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelectorFields = ubx.FieldMap{
...
var AlphaComputeAlphaZoneVmExtensionPolicy_ExtensionPoliciesFields = ubx.FieldMap{
...
var AlphaComputeAlphaZoneVmExtensionPolicy_InstanceSelectors_LabelSelectorFields = ubx.FieldMap{
		"InclusionLabels": ubx.FieldSpec{WireName: "inclusion_labels"},
	}

var AlphaComputeAlphaZoneVmExtensionPolicy_InstanceSelectorsFields = ubx.FieldMap{
...
type AlphaComputeAlphaZoneVmExtensionPolicyConfig struct {
...
type AlphaComputeAlphaZoneVmExtensionPolicyAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource.
	Description any
...
var AlphaComputeAlphaZoneVmExtensionPolicy = ubx.ResourceBinding{
