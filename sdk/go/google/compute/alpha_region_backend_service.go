...
type AlphaRegionBackendService_CdnPolicy_CacheKeyPolicy struct {
...
type AlphaRegionBackendService_CircuitBreakers_ConnectTimeout struct {
...
type AlphaRegionBackendService_CircuitBreakers struct {
...
type AlphaRegionBackendService_ConnectionDraining struct {
...
type AlphaRegionBackendService_ConnectionTrackingPolicy struct {
...
type AlphaRegionBackendService_ConsistentHash_HttpCookie struct {
	// Name of the cookie.
	Name any
...
type AlphaRegionBackendService_ConsistentHash struct {
...
type AlphaRegionBackendService_DynamicForwarding_IpPortSelection struct {
	// A boolean flag enabling IP:PORT based dynamic forwarding.
	Enabled any
}

type AlphaRegionBackendService_DynamicForwarding struct {
...
type AlphaRegionBackendService_FailoverPolicy struct {
...
type AlphaRegionBackendService_HaPolicy_Leader_NetworkEndpoint struct {
...
type AlphaRegionBackendService_Iap struct {
...
type AlphaRegionBackendService_LocalityLbPolicies_CustomPolicy struct {
	Data any
	Name any
}

type AlphaRegionBackendService_LocalityLbPolicies_Policy struct {
	Name any
}
...
type AlphaRegionBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity struct {
...
type AlphaRegionBackendService_NetworkPassThroughLbTrafficPolicy struct {
	ZonalAffinity any
}

type AlphaRegionBackendService_OutlierDetection struct {
	// A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years.
...
type AlphaRegionBackendService_Params struct {
...
type AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Peers_Mtls struct {
	Mode any
}

type AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Peers struct {
	Mtls any
}

type AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePaths struct {
...
type AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPlugin struct {
	// Plugin name.
	Name any
...
type AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials struct {
...
type AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentials struct {
...
type AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig struct {
...
type AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig struct {
	// [Deprecated] gRPC config to access the SDS server. gRPC config to access the SDS server.
	GrpcServiceConfig any
}

type AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext struct {
	// [Deprecated] The paths to the mounted TLS Certificates and private key. The paths to the mounted TLS Certificates and private key.
...
type AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_ValidationContext struct {
...
type AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext struct {
...
type AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy struct {
...
type AlphaRegionBackendService_SecuritySettings_AwsV4Authentication struct {
...
type AlphaRegionBackendService_SecuritySettings_ClientTlsSettings struct {
	// [Deprecated] The TLS settings for the client or server. The TLS settings for the client or server.
...
type AlphaRegionBackendService_SecuritySettings struct {
...
type AlphaRegionBackendService_Subsetting struct {
	Policy any
...
type AlphaRegionBackendService_TlsSettings struct {
...
type AlphaRegionBackendService_UsedBy struct {
	Reference any
}
...
var AlphaRegionBackendService = ubx.ResourceBinding{
