...
type AlphaComputeAlphaRegionUrlMap_DefaultCustomErrorResponsePolicy_ErrorResponseRules struct {
	MatchResponseCodes any
	OverrideResponseCode any
	Path any
}

type AlphaComputeAlphaRegionUrlMap_DefaultCustomErrorResponsePolicy struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_CachePolicy_CacheKeyPolicy struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_CachePolicy_ClientTtl struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_CachePolicy_NegativeCachingPolicy struct {
	Code any
	Ttl any
}

type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_CachePolicy struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_CorsPolicy struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy_Abort struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy_Delay struct {
	// A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years.
	FixedDelay any
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_ImageOptimizationPolicy struct {
	// Specifies whether to interpret query parameters for image optimization.
	QueryParameterInterpretation any
}

type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_RequestMirrorPolicy struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_RetryPolicy struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_UrlRewrite_RegexRewrite struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_UrlRewrite struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderAction_RequestHeadersToAdd struct {
	HeaderName any
	HeaderValue any
	Replace any
}

type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderAction struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServices struct {
	BackendService any
	HeaderAction any
	Weight any
}

type AlphaComputeAlphaRegionUrlMap_DefaultRouteAction struct {
...
type AlphaComputeAlphaRegionUrlMap_DefaultUrlRedirect struct {
...
type AlphaComputeAlphaRegionUrlMap_HostRules struct {
	Description any
	Hosts any
	PathMatcher any
}

type AlphaComputeAlphaRegionUrlMap_PathMatchers_PathRules struct {
...
type AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_HttpFilterConfigs struct {
	Config any
	ConfigTypeUrl any
	FilterName any
}

type AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatches_RangeMatch struct {
	RangeEnd any
	RangeStart any
}

type AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatches struct {
	ExactMatch any
	HeaderName any
	InvertMatch any
	PrefixMatch any
...
type AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFilters_FilterLabels struct {
	Name any
	Value any
}

type AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFilters struct {
	FilterLabels any
	FilterMatchCriteria any
}

type AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_QueryParameterMatches struct {
	ExactMatch any
	Name any
	PresentMatch any
	RegexMatch any
...
type AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules struct {
	FullPathMatch any
	HeaderMatches any
	IgnoreCase any
	MetadataFilters any
...
type AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules struct {
	CustomErrorResponsePolicy any
	Description any
	HeaderAction any
...
type AlphaComputeAlphaRegionUrlMap_PathMatchers struct {
...
type AlphaComputeAlphaRegionUrlMap_Status_QuotaUsage struct {
...
type AlphaComputeAlphaRegionUrlMap_Status struct {
	// Message representing the quota usage for a UrlMap.
	QuotaUsage any
}

type AlphaComputeAlphaRegionUrlMap_Tests struct {
...
var AlphaComputeAlphaRegionUrlMap_DefaultCustomErrorResponsePolicy_ErrorResponseRulesFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_DefaultCustomErrorResponsePolicyFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_CachePolicy_CacheKeyPolicyFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_CachePolicy_ClientTtlFields = ubx.FieldMap{
		"Nanos": ubx.FieldSpec{WireName: "nanos"},
		"Seconds": ubx.FieldSpec{WireName: "seconds"},
	}

var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_CachePolicy_NegativeCachingPolicyFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_CachePolicyFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_CorsPolicyFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy_AbortFields = ubx.FieldMap{
		"HttpStatus": ubx.FieldSpec{WireName: "http_status"},
		"Percentage": ubx.FieldSpec{WireName: "percentage"},
	}

var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy_DelayFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicyFields = ubx.FieldMap{
		"Abort": ubx.FieldSpec{
			WireName: "abort",
			Kind: "object",
...
var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_ImageOptimizationPolicyFields = ubx.FieldMap{
		"QueryParameterInterpretation": ubx.FieldSpec{WireName: "query_parameter_interpretation"},
	}

var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_RequestMirrorPolicyFields = ubx.FieldMap{
		"BackendService": ubx.FieldSpec{WireName: "backend_service"},
		"MirrorPercent": ubx.FieldSpec{WireName: "mirror_percent"},
	}

var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_RetryPolicyFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_UrlRewrite_RegexRewriteFields = ubx.FieldMap{
		"PathPattern": ubx.FieldSpec{WireName: "path_pattern"},
		"PathSubstitution": ubx.FieldSpec{WireName: "path_substitution"},
	}

var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_UrlRewriteFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderAction_RequestHeadersToAddFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderActionFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServicesFields = ubx.FieldMap{
		"BackendService": ubx.FieldSpec{WireName: "backend_service"},
...
var AlphaComputeAlphaRegionUrlMap_DefaultRouteActionFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_DefaultUrlRedirectFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_HostRulesFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Hosts": ubx.FieldSpec{WireName: "hosts"},
		"PathMatcher": ubx.FieldSpec{WireName: "path_matcher"},
	}

var AlphaComputeAlphaRegionUrlMap_PathMatchers_PathRulesFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_HttpFilterConfigsFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatches_RangeMatchFields = ubx.FieldMap{
		"RangeEnd": ubx.FieldSpec{WireName: "range_end"},
		"RangeStart": ubx.FieldSpec{WireName: "range_start"},
	}

var AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatchesFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFilters_FilterLabelsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFiltersFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_QueryParameterMatchesFields = ubx.FieldMap{
		"ExactMatch": ubx.FieldSpec{WireName: "exact_match"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"PresentMatch": ubx.FieldSpec{WireName: "present_match"},
		"RegexMatch": ubx.FieldSpec{WireName: "regex_match"},
...
var AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRules_MatchRulesFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_PathMatchers_RouteRulesFields = ubx.FieldMap{
		"CustomErrorResponsePolicy": ubx.FieldSpec{
			WireName: "custom_error_response_policy",
			Kind: "object",
			Fields: AlphaComputeAlphaRegionUrlMap_DefaultCustomErrorResponsePolicyFields,
...
var AlphaComputeAlphaRegionUrlMap_PathMatchersFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_Status_QuotaUsageFields = ubx.FieldMap{
		"ForwardingRules": ubx.FieldSpec{WireName: "forwarding_rules"},
		"Units": ubx.FieldSpec{WireName: "units"},
	}

var AlphaComputeAlphaRegionUrlMap_StatusFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionUrlMap_TestsFields = ubx.FieldMap{
...
type AlphaComputeAlphaRegionUrlMapConfig struct {
...
type AlphaComputeAlphaRegionUrlMapAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// Specifies the custom error response policy that must be applied when the backend service or backend bucket responds with an error.
	DefaultCustomErrorResponsePolicy any
...
var AlphaComputeAlphaRegionUrlMap = ubx.ResourceBinding{
