...
type AlphaComputeAlphaRegionTargetHttpProxyConfig struct {
...
type AlphaComputeAlphaRegionTargetHttpProxyAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaComputeAlphaRegionTargetHttpProxy = ubx.ResourceBinding{
