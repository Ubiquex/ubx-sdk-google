...
type BetaGlobalVmExtensionPolicy_InstanceSelectors struct {
	LabelSelector any
}

type BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutInput struct {
...
type BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus struct {
	State any
}
