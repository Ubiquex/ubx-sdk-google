...
type AlphaComputeAlphaRegionSnapshot_GuestOsFeatures struct {
	Type any
}

type AlphaComputeAlphaRegionSnapshot_Params struct {
...
type AlphaComputeAlphaRegionSnapshot_ResourceStatus struct {
...
type AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKey struct {
...
var AlphaComputeAlphaRegionSnapshot_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var AlphaComputeAlphaRegionSnapshot_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaComputeAlphaRegionSnapshot_ResourceStatusFields = ubx.FieldMap{
		"ScheduledDeletionTime": ubx.FieldSpec{WireName: "scheduled_deletion_time"},
	}

var AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKeyFields = ubx.FieldMap{
...
type AlphaComputeAlphaRegionSnapshotConfig struct {
...
type AlphaComputeAlphaRegionSnapshotAttrs struct {
	// Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64.
	Architecture any
	// Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk.
	AutoCreated any
...
var AlphaComputeAlphaRegionSnapshot = ubx.ResourceBinding{
