...
type AlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors struct {
	AllOfSelectors any
}

type AlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector struct {
	AnyOfSelectors any
}
...
type AlphaFolderGlobalVmExtensionPolicy_InstanceSelectors struct {
	LabelSelector any
}

type AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutInput struct {
...
type AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus struct {
	State any
}
