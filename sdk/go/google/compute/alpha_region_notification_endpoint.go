...
type AlphaRegionNotificationEndpoint_GrpcSettings_ResendInterval struct {
...
type AlphaRegionNotificationEndpoint_GrpcSettings struct {
...
var AlphaRegionNotificationEndpoint_GrpcSettings_ResendIntervalFields = ubx.FieldMap{
		"Nanos": ubx.FieldSpec{WireName: "nanos"},
		"Seconds": ubx.FieldSpec{WireName: "seconds"},
	}

var AlphaRegionNotificationEndpoint_GrpcSettingsFields = ubx.FieldMap{
...
type AlphaRegionNotificationEndpointConfig struct {
...
type AlphaRegionNotificationEndpointAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaRegionNotificationEndpoint = ubx.ResourceBinding{
