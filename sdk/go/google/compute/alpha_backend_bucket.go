...
type AlphaBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders struct {
	HeaderName any
}

type AlphaBackendBucket_CdnPolicy_CacheKeyPolicy struct {
...
type AlphaBackendBucket_CdnPolicy_NegativeCachingPolicy struct {
	Code any
	Ttl any
}

type AlphaBackendBucket_CdnPolicy struct {
...
type AlphaBackendBucket_Params struct {
...
type AlphaBackendBucket_UsedBy struct {
	Reference any
}

var AlphaBackendBucket_CdnPolicy_BypassCacheOnRequestHeadersFields = ubx.FieldMap{
		"HeaderName": ubx.FieldSpec{WireName: "header_name"},
	}

var AlphaBackendBucket_CdnPolicy_CacheKeyPolicyFields = ubx.FieldMap{
...
var AlphaBackendBucket_CdnPolicy_NegativeCachingPolicyFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Ttl": ubx.FieldSpec{WireName: "ttl"},
	}

var AlphaBackendBucket_CdnPolicyFields = ubx.FieldMap{
...
var AlphaBackendBucket_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaBackendBucket_UsedByFields = ubx.FieldMap{
		"Reference": ubx.FieldSpec{WireName: "reference"},
	}

type AlphaBackendBucketConfig struct {
...
type AlphaBackendBucketAttrs struct {
	// Cloud Storage bucket name.
	BucketName any
	// Message containing Cloud CDN configuration for a backend bucket.
	CdnPolicy any
...
var AlphaBackendBucket = ubx.ResourceBinding{
