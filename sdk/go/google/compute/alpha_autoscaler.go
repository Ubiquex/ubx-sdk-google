...
type AlphaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas struct {
...
type AlphaAutoscaler_AutoscalingPolicy_ScaleDownControl struct {
...
type AlphaAutoscaler_AutoscalingPolicy_ScaleInControl struct {
	// Encapsulates numeric value that can be either absolute or relative.
...
var AlphaAutoscaler_ScalingScheduleStatusFields = ubx.FieldMap{
...
type AlphaAutoscalerAttrs struct {
	// Cloud Autoscaler policy.
	AutoscalingPolicy any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var AlphaAutoscaler = ubx.ResourceBinding{
