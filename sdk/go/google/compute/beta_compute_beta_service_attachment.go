...
type BetaComputeBetaServiceAttachment_ConnectedEndpoints struct {
	ConsumerNetwork any
	Endpoint any
	EndpointWithId any
	NatIps any
...
type BetaComputeBetaServiceAttachment_ConsumerAcceptLists struct {
	ConnectionLimit any
	EndpointUrl any
	NetworkUrl any
	ProjectIdOrNum any
...
type BetaComputeBetaServiceAttachment_PscServiceAttachmentId struct {
	High any
	Low any
}

type BetaComputeBetaServiceAttachment_TunnelingConfig struct {
...
var BetaComputeBetaServiceAttachment_ConnectedEndpointsFields = ubx.FieldMap{
...
var BetaComputeBetaServiceAttachment_ConsumerAcceptListsFields = ubx.FieldMap{
...
var BetaComputeBetaServiceAttachment_PscServiceAttachmentIdFields = ubx.FieldMap{
		"High": ubx.FieldSpec{WireName: "high"},
		"Low": ubx.FieldSpec{WireName: "low"},
	}

var BetaComputeBetaServiceAttachment_TunnelingConfigFields = ubx.FieldMap{
		"EncapsulationProfile": ubx.FieldSpec{WireName: "encapsulation_profile"},
		"RoutingMode": ubx.FieldSpec{WireName: "routing_mode"},
	}

type BetaComputeBetaServiceAttachmentConfig struct {
...
type BetaComputeBetaServiceAttachmentAttrs struct {
	// Output only. [Output Only] An array of connections for all the consumers connected to this service attachment.
	ConnectedEndpoints any
	// The connection preference of service attachment. The value can be set to ACCEPT_AUTOMATIC. An ACCEPT_AUTOMATIC service attachment is one that always accepts the connection from consumer forwarding rules.
	ConnectionPreference any
...
var BetaComputeBetaServiceAttachment = ubx.ResourceBinding{
