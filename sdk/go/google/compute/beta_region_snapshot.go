...
type BetaRegionSnapshot_GuestOsFeatures struct {
	Type any
}

type BetaRegionSnapshot_Params struct {
...
type BetaRegionSnapshot_SnapshotEncryptionKey struct {
...
var BetaRegionSnapshot_GuestOsFeaturesFields = ubx.FieldMap{
...
type BetaRegionSnapshotAttrs struct {
	// Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64.
	Architecture any
	// Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk.
	AutoCreated any
