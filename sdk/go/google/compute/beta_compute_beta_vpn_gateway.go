...
type BetaComputeBetaVpnGateway_Params struct {
...
type BetaComputeBetaVpnGateway_VpnInterfaces struct {
	Id any
...
var BetaComputeBetaVpnGateway_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaVpnGateway_VpnInterfacesFields = ubx.FieldMap{
...
type BetaComputeBetaVpnGatewayConfig struct {
...
type BetaComputeBetaVpnGatewayAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var BetaComputeBetaVpnGateway = ubx.ResourceBinding{
