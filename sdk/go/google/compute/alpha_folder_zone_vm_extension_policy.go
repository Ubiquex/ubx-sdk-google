...
type AlphaFolderZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors struct {
	AllOfSelectors any
}

type AlphaFolderZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector struct {
	AnyOfSelectors any
}
...
type AlphaFolderZoneVmExtensionPolicy_InstanceSelectors struct {
	LabelSelector any
}
...
type AlphaFolderZoneVmExtensionPolicyAttrs struct {
...
var AlphaFolderZoneVmExtensionPolicy = ubx.ResourceBinding{
