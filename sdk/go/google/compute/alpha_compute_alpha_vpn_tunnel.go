...
type AlphaComputeAlphaVpnTunnel_CipherSuite_Phase1 struct {
	Dh any
	Encryption any
	Integrity any
	Prf any
...
type AlphaComputeAlphaVpnTunnel_CipherSuite_Phase2 struct {
	Encryption any
	Integrity any
	Pfs any
}

type AlphaComputeAlphaVpnTunnel_CipherSuite struct {
	Phase1 any
	Phase2 any
}

type AlphaComputeAlphaVpnTunnel_Params struct {
...
type AlphaComputeAlphaVpnTunnel_PqcPhase1_Keys struct {
	Ke1s any
	Ke2s any
	Ke3s any
	Ke4s any
...
type AlphaComputeAlphaVpnTunnel_PqcPhase1 struct {
	// User specified list of PQC key exchanges.
	Keys any
	Mode any
}

var AlphaComputeAlphaVpnTunnel_CipherSuite_Phase1Fields = ubx.FieldMap{
...
var AlphaComputeAlphaVpnTunnel_CipherSuite_Phase2Fields = ubx.FieldMap{
		"Encryption": ubx.FieldSpec{WireName: "encryption"},
		"Integrity": ubx.FieldSpec{WireName: "integrity"},
		"Pfs": ubx.FieldSpec{WireName: "pfs"},
	}

var AlphaComputeAlphaVpnTunnel_CipherSuiteFields = ubx.FieldMap{
...
var AlphaComputeAlphaVpnTunnel_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaComputeAlphaVpnTunnel_PqcPhase1_KeysFields = ubx.FieldMap{
...
var AlphaComputeAlphaVpnTunnel_PqcPhase1Fields = ubx.FieldMap{
		"Keys": ubx.FieldSpec{
			WireName: "keys",
			Kind: "object",
...
type AlphaComputeAlphaVpnTunnelConfig struct {
...
type AlphaComputeAlphaVpnTunnelAttrs struct {
	// Capacity tier of the VPN tunnel. This is used for IPsec over Interconnect tunnels to indicate different bandwidth limits.
	CapacityTier any
	CipherSuite any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
...
var AlphaComputeAlphaVpnTunnel = ubx.ResourceBinding{
