...
type BetaComputeBetaNodeTemplate_Accelerators struct {
	AcceleratorCount any
	AcceleratorType any
}

type BetaComputeBetaNodeTemplate_Disks struct {
	DiskCount any
	DiskSizeGb any
	DiskType any
}

type BetaComputeBetaNodeTemplate_NodeTypeFlexibility struct {
	Cpus any
	LocalSsd any
	Memory any
}

type BetaComputeBetaNodeTemplate_ServerBinding struct {
	Type any
}

var BetaComputeBetaNodeTemplate_AcceleratorsFields = ubx.FieldMap{
		"AcceleratorCount": ubx.FieldSpec{WireName: "accelerator_count"},
		"AcceleratorType": ubx.FieldSpec{WireName: "accelerator_type"},
	}

var BetaComputeBetaNodeTemplate_DisksFields = ubx.FieldMap{
...
var BetaComputeBetaNodeTemplate_NodeTypeFlexibilityFields = ubx.FieldMap{
		"Cpus": ubx.FieldSpec{WireName: "cpus"},
		"LocalSsd": ubx.FieldSpec{WireName: "local_ssd"},
		"Memory": ubx.FieldSpec{WireName: "memory"},
	}

var BetaComputeBetaNodeTemplate_ServerBindingFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

type BetaComputeBetaNodeTemplateConfig struct {
	Accelerators any
	// CPU overcommit.
...
type BetaComputeBetaNodeTemplateAttrs struct {
	Accelerators any
	// CPU overcommit.
	CpuOvercommitType any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
...
var BetaComputeBetaNodeTemplate = ubx.ResourceBinding{
