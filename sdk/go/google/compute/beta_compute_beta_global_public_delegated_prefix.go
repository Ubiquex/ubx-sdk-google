...
type BetaComputeBetaGlobalPublicDelegatedPrefix_PublicDelegatedSubPrefixs struct {
...
var BetaComputeBetaGlobalPublicDelegatedPrefix_PublicDelegatedSubPrefixsFields = ubx.FieldMap{
...
type BetaComputeBetaGlobalPublicDelegatedPrefixConfig struct {
...
type BetaComputeBetaGlobalPublicDelegatedPrefixAttrs struct {
	// The allocatable prefix length supported by this public delegated prefix. This field is optional and cannot be set for prefixes in DELEGATION mode. It cannot be set for IPv4 prefixes either, and it always defaults to 32.
	AllocatablePrefixLength any
	// Output only. [Output Only] The version of BYOIP API.
	ByoipApiVersion any
...
var BetaComputeBetaGlobalPublicDelegatedPrefix = ubx.ResourceBinding{
