...
type AlphaOrganizationGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors struct {
	AllOfSelectors any
}

type AlphaOrganizationGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector struct {
	AnyOfSelectors any
}
...
type AlphaOrganizationGlobalVmExtensionPolicy_InstanceSelectors struct {
	LabelSelector any
}

type AlphaOrganizationGlobalVmExtensionPolicy_RolloutOperation_RolloutInput struct {
...
type AlphaOrganizationGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus struct {
	State any
}
...
type AlphaOrganizationGlobalVmExtensionPolicyAttrs struct {
...
var AlphaOrganizationGlobalVmExtensionPolicy = ubx.ResourceBinding{
