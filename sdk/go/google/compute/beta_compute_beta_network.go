...
type BetaComputeBetaNetwork_Params struct {
...
type BetaComputeBetaNetwork_Peerings_ConnectionStatus_ConsensusState struct {
	DeleteStatus any
	UpdateStatus any
}

type BetaComputeBetaNetwork_Peerings_ConnectionStatus_TrafficConfiguration struct {
...
type BetaComputeBetaNetwork_Peerings_ConnectionStatus struct {
	ConsensusState any
	TrafficConfiguration any
	UpdateStrategy any
}

type BetaComputeBetaNetwork_Peerings struct {
...
type BetaComputeBetaNetwork_RoutingConfig struct {
...
var BetaComputeBetaNetwork_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaNetwork_Peerings_ConnectionStatus_ConsensusStateFields = ubx.FieldMap{
		"DeleteStatus": ubx.FieldSpec{WireName: "delete_status"},
		"UpdateStatus": ubx.FieldSpec{WireName: "update_status"},
	}

var BetaComputeBetaNetwork_Peerings_ConnectionStatus_TrafficConfigurationFields = ubx.FieldMap{
...
var BetaComputeBetaNetwork_Peerings_ConnectionStatusFields = ubx.FieldMap{
...
var BetaComputeBetaNetwork_PeeringsFields = ubx.FieldMap{
...
var BetaComputeBetaNetwork_RoutingConfigFields = ubx.FieldMap{
...
type BetaComputeBetaNetworkConfig struct {
...
type BetaComputeBetaNetworkAttrs struct {
	// Must be set to create a VPC network. If not set, a legacy network is created. When set to true, the VPC network is created in auto mode. When set to false, the VPC network is created in custom mode. An auto mode VPC network starts with one subnet per region. Each subnet has a predetermined range as described inAuto mode VPC network IP ranges. For custom mode VPC networks, you can add subnets using the subnetworksinsert method.
	AutoCreateSubnetworks any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var BetaComputeBetaNetwork = ubx.ResourceBinding{
