...
type AlphaComputeAlphaDisk_AsyncPrimaryDisk struct {
...
type AlphaComputeAlphaDisk_AsyncSecondaryDisks struct {
	AsyncReplicationDisk any
}

type AlphaComputeAlphaDisk_DiskEncryptionKey struct {
...
type AlphaComputeAlphaDisk_GuestOsFeatures struct {
	Type any
}

type AlphaComputeAlphaDisk_Params struct {
...
type AlphaComputeAlphaDisk_ResourceStatus_AsyncPrimaryDisk struct {
	State any
}

type AlphaComputeAlphaDisk_ResourceStatus struct {
...
var AlphaComputeAlphaDisk_AsyncPrimaryDiskFields = ubx.FieldMap{
...
var AlphaComputeAlphaDisk_AsyncSecondaryDisksFields = ubx.FieldMap{
...
var AlphaComputeAlphaDisk_DiskEncryptionKeyFields = ubx.FieldMap{
...
var AlphaComputeAlphaDisk_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var AlphaComputeAlphaDisk_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaComputeAlphaDisk_ResourceStatus_AsyncPrimaryDiskFields = ubx.FieldMap{
		"State": ubx.FieldSpec{WireName: "state"},
	}

var AlphaComputeAlphaDisk_ResourceStatusFields = ubx.FieldMap{
...
type AlphaComputeAlphaDiskConfig struct {
...
type AlphaComputeAlphaDiskAttrs struct {
	// The access mode of the disk. - READ_WRITE_SINGLE: The default AccessMode, means the disk can be attached to single instance in RW mode. - READ_WRITE_MANY: The AccessMode means the disk can be attached to multiple instances in RW mode. - READ_ONLY_MANY: The AccessMode means the disk can be attached to multiple instances in RO mode. The AccessMode is only valid for Hyperdisk disk types.
	AccessMode any
	// The architecture of the disk. Valid values are ARM64 or X86_64.
	Architecture any
...
var AlphaComputeAlphaDisk = ubx.ResourceBinding{
