...
type AlphaGlobalPublicDelegatedPrefix_PublicDelegatedSubPrefixs struct {
...
var AlphaGlobalPublicDelegatedPrefix_PublicDelegatedSubPrefixsFields = ubx.FieldMap{
...
type AlphaGlobalPublicDelegatedPrefixConfig struct {
...
type AlphaGlobalPublicDelegatedPrefixAttrs struct {
	// The allocatable prefix length supported by this public delegated prefix. This field is optional and cannot be set for prefixes in DELEGATION mode. It cannot be set for IPv4 prefixes either, and it always defaults to 32.
	AllocatablePrefixLength any
...
var AlphaGlobalPublicDelegatedPrefix = ubx.ResourceBinding{
