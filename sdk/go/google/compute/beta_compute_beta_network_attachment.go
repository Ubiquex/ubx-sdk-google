...
type BetaComputeBetaNetworkAttachment_ConnectionEndpoints struct {
	IpAddress any
	Ipv6Address any
	ProjectIdOrNum any
...
var BetaComputeBetaNetworkAttachment_ConnectionEndpointsFields = ubx.FieldMap{
...
type BetaComputeBetaNetworkAttachmentConfig struct {
...
type BetaComputeBetaNetworkAttachmentAttrs struct {
	// Output only. [Output Only] An array of connections for all the producers connected to this network attachment.
	ConnectionEndpoints any
	ConnectionPreference any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
...
var BetaComputeBetaNetworkAttachment = ubx.ResourceBinding{
