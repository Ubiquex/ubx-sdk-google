...
type BetaComputeBetaVpnTunnel_CipherSuite_Phase1 struct {
	Dh any
	Encryption any
	Integrity any
	Prf any
...
type BetaComputeBetaVpnTunnel_CipherSuite_Phase2 struct {
	Encryption any
	Integrity any
	Pfs any
}

type BetaComputeBetaVpnTunnel_CipherSuite struct {
	Phase1 any
	Phase2 any
}

type BetaComputeBetaVpnTunnel_Params struct {
...
var BetaComputeBetaVpnTunnel_CipherSuite_Phase1Fields = ubx.FieldMap{
...
var BetaComputeBetaVpnTunnel_CipherSuite_Phase2Fields = ubx.FieldMap{
		"Encryption": ubx.FieldSpec{WireName: "encryption"},
		"Integrity": ubx.FieldSpec{WireName: "integrity"},
		"Pfs": ubx.FieldSpec{WireName: "pfs"},
	}

var BetaComputeBetaVpnTunnel_CipherSuiteFields = ubx.FieldMap{
...
var BetaComputeBetaVpnTunnel_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

type BetaComputeBetaVpnTunnelConfig struct {
...
type BetaComputeBetaVpnTunnelAttrs struct {
	// Capacity tier of the VPN tunnel. This is used for IPsec over Interconnect tunnels to indicate different bandwidth limits.
	CapacityTier any
	CipherSuite any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
...
var BetaComputeBetaVpnTunnel = ubx.ResourceBinding{
