...
type BetaComputeBetaSnapshot_GuestOsFeatures struct {
	Type any
}

type BetaComputeBetaSnapshot_Params struct {
...
type BetaComputeBetaSnapshot_SnapshotEncryptionKey struct {
...
var BetaComputeBetaSnapshot_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var BetaComputeBetaSnapshot_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaSnapshot_SnapshotEncryptionKeyFields = ubx.FieldMap{
...
type BetaComputeBetaSnapshotConfig struct {
...
type BetaComputeBetaSnapshotAttrs struct {
	// Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64.
	Architecture any
	// Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk.
	AutoCreated any
...
var BetaComputeBetaSnapshot = ubx.ResourceBinding{
