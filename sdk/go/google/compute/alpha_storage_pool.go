...
type AlphaStoragePool_ExapoolProvisionedCapacityGb struct {
...
type AlphaStoragePool_Params struct {
...
type AlphaStoragePool_ResourceStatus struct {
...
type AlphaStoragePool_ShareSettings_ProjectMap struct {
	ProjectId any
}

type AlphaStoragePool_ShareSettings struct {
...
type AlphaStoragePoolAttrs struct {
	// Provisioning type of the byte capacity of the pool.
	CapacityProvisioningType any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var AlphaStoragePool = ubx.ResourceBinding{
