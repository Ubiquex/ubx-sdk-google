...
type NetworkFirewallPolicyRule_Match_Layer4Configs struct {
	IpProtocol any
	Ports any
}

type NetworkFirewallPolicyRule_Match_SrcSecureTags struct {
	Name any
	State any
}

type NetworkFirewallPolicyRule_Match struct {
...
type NetworkFirewallPolicyRule_Timeouts struct {
	Create any
	Delete any
	Update any
}

var NetworkFirewallPolicyRule_Match_Layer4ConfigsFields = ubx.FieldMap{
		"IpProtocol": ubx.FieldSpec{WireName: "ip_protocol"},
		"Ports": ubx.FieldSpec{WireName: "ports"},
	}

var NetworkFirewallPolicyRule_Match_SrcSecureTagsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"State": ubx.FieldSpec{WireName: "state"},
	}

var NetworkFirewallPolicyRule_MatchFields = ubx.FieldMap{
...
var NetworkFirewallPolicyRule_TimeoutsFields = ubx.FieldMap{
		"Create": ubx.FieldSpec{WireName: "create"},
		"Delete": ubx.FieldSpec{WireName: "delete"},
		"Update": ubx.FieldSpec{WireName: "update"},
	}

type NetworkFirewallPolicyRuleConfig struct {
	Action any
	DeletionPolicy any
	Description any
	Direction any
...
var NetworkFirewallPolicyRule = ubx.ResourceBinding{
