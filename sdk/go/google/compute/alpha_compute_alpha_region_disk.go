...
type AlphaComputeAlphaRegionDisk_AsyncPrimaryDisk struct {
...
type AlphaComputeAlphaRegionDisk_AsyncSecondaryDisks struct {
	AsyncReplicationDisk any
}

type AlphaComputeAlphaRegionDisk_DiskEncryptionKey struct {
...
type AlphaComputeAlphaRegionDisk_GuestOsFeatures struct {
	Type any
}

type AlphaComputeAlphaRegionDisk_Params struct {
...
type AlphaComputeAlphaRegionDisk_ResourceStatus_AsyncPrimaryDisk struct {
	State any
}

type AlphaComputeAlphaRegionDisk_ResourceStatus struct {
...
var AlphaComputeAlphaRegionDisk_AsyncPrimaryDiskFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionDisk_AsyncSecondaryDisksFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionDisk_DiskEncryptionKeyFields = ubx.FieldMap{
...
var AlphaComputeAlphaRegionDisk_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var AlphaComputeAlphaRegionDisk_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaComputeAlphaRegionDisk_ResourceStatus_AsyncPrimaryDiskFields = ubx.FieldMap{
		"State": ubx.FieldSpec{WireName: "state"},
	}

var AlphaComputeAlphaRegionDisk_ResourceStatusFields = ubx.FieldMap{
...
type AlphaComputeAlphaRegionDiskConfig struct {
...
type AlphaComputeAlphaRegionDiskAttrs struct {
	// The access mode of the disk. - READ_WRITE_SINGLE: The default AccessMode, means the disk can be attached to single instance in RW mode. - READ_WRITE_MANY: The AccessMode means the disk can be attached to multiple instances in RW mode. - READ_ONLY_MANY: The AccessMode means the disk can be attached to multiple instances in RO mode. The AccessMode is only valid for Hyperdisk disk types.
	AccessMode any
	// The architecture of the disk. Valid values are ARM64 or X86_64.
	Architecture any
...
var AlphaComputeAlphaRegionDisk = ubx.ResourceBinding{
	...
	Fields: ubx.FieldMap{
		...
		"SourceMachineImageId": ubx.FieldSpec{WireName: "source_machine_image_id"},
