...
type AlphaComputeAlphaAutoscaler_AutoscalingPolicy_CpuUtilization struct {
...
type AlphaComputeAlphaAutoscaler_AutoscalingPolicy_CustomMetricUtilizations struct {
	Filter any
	Metric any
...
type AlphaComputeAlphaAutoscaler_AutoscalingPolicy_LoadBalancingUtilization struct {
	// Fraction of backend capacity utilization (set in HTTP(S) load balancing configuration) that the autoscaler maintains. Must be a positive float value. If not defined, the default is 0.8.
	UtilizationTarget any
}

type AlphaComputeAlphaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas struct {
...
type AlphaComputeAlphaAutoscaler_AutoscalingPolicy_ScaleDownControl struct {
...
type AlphaComputeAlphaAutoscaler_AutoscalingPolicy_ScaleInControl struct {
	// Encapsulates numeric value that can be either absolute or relative.
...
type AlphaComputeAlphaAutoscaler_AutoscalingPolicy_ScalingSchedules struct {
	Description any
	Disabled any
	DurationSec any
...
type AlphaComputeAlphaAutoscaler_AutoscalingPolicy struct {
...
type AlphaComputeAlphaAutoscaler_ScalingScheduleStatus struct {
	LastStartTime any
	NextStartTime any
	State any
}

type AlphaComputeAlphaAutoscaler_StatusDetails struct {
	Message any
	Type any
}

var AlphaComputeAlphaAutoscaler_AutoscalingPolicy_CpuUtilizationFields = ubx.FieldMap{
		"PredictiveMethod": ubx.FieldSpec{WireName: "predictive_method"},
		"UtilizationTarget": ubx.FieldSpec{WireName: "utilization_target"},
	}

var AlphaComputeAlphaAutoscaler_AutoscalingPolicy_CustomMetricUtilizationsFields = ubx.FieldMap{
...
var AlphaComputeAlphaAutoscaler_AutoscalingPolicy_LoadBalancingUtilizationFields = ubx.FieldMap{
		"UtilizationTarget": ubx.FieldSpec{WireName: "utilization_target"},
	}

var AlphaComputeAlphaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicasFields = ubx.FieldMap{
		"Calculated": ubx.FieldSpec{WireName: "calculated"},
		"Fixed": ubx.FieldSpec{WireName: "fixed"},
		"Percent": ubx.FieldSpec{WireName: "percent"},
	}

var AlphaComputeAlphaAutoscaler_AutoscalingPolicy_ScaleDownControlFields = ubx.FieldMap{
...
var AlphaComputeAlphaAutoscaler_AutoscalingPolicy_ScaleInControlFields = ubx.FieldMap{
...
var AlphaComputeAlphaAutoscaler_AutoscalingPolicy_ScalingSchedulesFields = ubx.FieldMap{
...
var AlphaComputeAlphaAutoscaler_AutoscalingPolicyFields = ubx.FieldMap{
...
var AlphaComputeAlphaAutoscaler_ScalingScheduleStatusFields = ubx.FieldMap{
		"LastStartTime": ubx.FieldSpec{WireName: "last_start_time"},
		"NextStartTime": ubx.FieldSpec{WireName: "next_start_time"},
		"State": ubx.FieldSpec{WireName: "state"},
	}

var AlphaComputeAlphaAutoscaler_StatusDetailsFields = ubx.FieldMap{
		"Message": ubx.FieldSpec{WireName: "message"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

type AlphaComputeAlphaAutoscalerConfig struct {
...
type AlphaComputeAlphaAutoscalerAttrs struct {
	// Cloud Autoscaler policy.
	AutoscalingPolicy any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var AlphaComputeAlphaAutoscaler = ubx.ResourceBinding{
