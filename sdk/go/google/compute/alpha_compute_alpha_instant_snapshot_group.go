...
type AlphaComputeAlphaInstantSnapshotGroup_ResourceStatus_SourceInfo struct {
	ConsistencyGroup any
	ConsistencyGroupId any
}

type AlphaComputeAlphaInstantSnapshotGroup_ResourceStatus struct {
	// Output only. [Output Only]
	ConsistencyMembershipResolutionTime any
	SourceInfo any
}

var AlphaComputeAlphaInstantSnapshotGroup_ResourceStatus_SourceInfoFields = ubx.FieldMap{
		"ConsistencyGroup": ubx.FieldSpec{WireName: "consistency_group"},
		"ConsistencyGroupId": ubx.FieldSpec{WireName: "consistency_group_id"},
	}

var AlphaComputeAlphaInstantSnapshotGroup_ResourceStatusFields = ubx.FieldMap{
...
type AlphaComputeAlphaInstantSnapshotGroupConfig struct {
...
type AlphaComputeAlphaInstantSnapshotGroupAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// Optional. An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaComputeAlphaInstantSnapshotGroup = ubx.ResourceBinding{
