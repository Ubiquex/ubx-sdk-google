...
type AlphaExternalVpnGateway_Interfaces struct {
	Id          any
	IpAddress   any
	Ipv6Address any
}

type AlphaExternalVpnGateway_Params struct {
...
type AlphaExternalVpnGatewayAttrs struct {
...
var AlphaExternalVpnGateway = ubx.ResourceBinding{
