...
type AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors struct {
	AllOfSelectors any
}

type AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector struct {
	AnyOfSelectors any
}

type AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_ExtensionPolicies struct {
	InstalledSoftwareSelector any
	PinnedVersion any
	StringConfig any
}

type AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_InstanceSelectors_LabelSelector struct {
	InclusionLabels any
}

type AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_InstanceSelectors struct {
	LabelSelector any
}

type AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_RolloutOperation_RolloutInput struct {
...
type AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus struct {
	State any
}

type AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts struct {
...
type AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus struct {
...
type AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_RolloutOperation struct {
	RolloutInput any
	RolloutStatus any
}

var AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectorsFields = ubx.FieldMap{
		"AllOfSelectors": ubx.FieldSpec{WireName: "all_of_selectors"},
	}

var AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelectorFields = ubx.FieldMap{
...
var AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_ExtensionPoliciesFields = ubx.FieldMap{
...
var AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields = ubx.FieldMap{
		"InclusionLabels": ubx.FieldSpec{WireName: "inclusion_labels"},
	}

var AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_InstanceSelectorsFields = ubx.FieldMap{
...
var AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields = ubx.FieldMap{
...
var AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields = ubx.FieldMap{
		"State": ubx.FieldSpec{WireName: "state"},
	}

var AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields = ubx.FieldMap{
...
var AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields = ubx.FieldMap{
...
var AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy_RolloutOperationFields = ubx.FieldMap{
...
type AlphaComputeAlphaOrganizationGlobalVmExtensionPolicyConfig struct {
...
type AlphaComputeAlphaOrganizationGlobalVmExtensionPolicyAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaComputeAlphaOrganizationGlobalVmExtensionPolicy = ubx.ResourceBinding{
