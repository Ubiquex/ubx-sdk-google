...
type BetaComputeBetaInstanceTemplate_Properties_AdvancedMachineFeatures struct {
...
type BetaComputeBetaInstanceTemplate_Properties_ConfidentialInstanceConfig struct {
...
type BetaComputeBetaInstanceTemplate_Properties_Disks_DiskEncryptionKey struct {
	KmsKeyName any
...
type BetaComputeBetaInstanceTemplate_Properties_Disks_GuestOsFeatures struct {
	Type any
}

type BetaComputeBetaInstanceTemplate_Properties_Disks_InitializeParams struct {
	Architecture any
	Description any
	DiskName any
	DiskSizeGb any
...
type BetaComputeBetaInstanceTemplate_Properties_Disks_ShieldedInstanceInitialState_Dbs struct {
	Content any
	FileType any
}

type BetaComputeBetaInstanceTemplate_Properties_Disks_ShieldedInstanceInitialState struct {
	Dbs any
	Dbxs any
	Keks any
	Pk any
...
type BetaComputeBetaInstanceTemplate_Properties_Disks struct {
	Architecture any
	AutoDelete any
	Boot any
	DeviceName any
...
type BetaComputeBetaInstanceTemplate_Properties_DisplayDevice struct {
	// Defines whether the instance has Display enabled.
	EnableDisplay any
}

type BetaComputeBetaInstanceTemplate_Properties_GuestAccelerators struct {
	AcceleratorCount any
	AcceleratorType any
}

type BetaComputeBetaInstanceTemplate_Properties_Metadata_Items struct {
	Key any
	Value any
}

type BetaComputeBetaInstanceTemplate_Properties_Metadata struct {
...
type BetaComputeBetaInstanceTemplate_Properties_NetworkInterfaces_AccessConfigs struct {
	ExternalIpv6 any
...
type BetaComputeBetaInstanceTemplate_Properties_NetworkInterfaces_AliasIpRanges struct {
	IpCidrRange any
	SubnetworkRangeName any
}

type BetaComputeBetaInstanceTemplate_Properties_NetworkInterfaces struct {
	AccessConfigs any
	AliasIpRanges any
	AliasIpv6Ranges any
...
type BetaComputeBetaInstanceTemplate_Properties_NetworkPerformanceConfig struct {
	TotalEgressBandwidthTier any
}

type BetaComputeBetaInstanceTemplate_Properties_PartnerMetadata struct {
	Entries any
}

type BetaComputeBetaInstanceTemplate_Properties_ReservationAffinity struct {
...
type BetaComputeBetaInstanceTemplate_Properties_Scheduling_GracefulShutdown_MaxDuration struct {
...
type BetaComputeBetaInstanceTemplate_Properties_Scheduling_GracefulShutdown struct {
...
type BetaComputeBetaInstanceTemplate_Properties_Scheduling_NodeAffinities struct {
	Key any
	Operator any
	Values any
}

type BetaComputeBetaInstanceTemplate_Properties_Scheduling_OnInstanceStopAction struct {
...
type BetaComputeBetaInstanceTemplate_Properties_Scheduling struct {
...
type BetaComputeBetaInstanceTemplate_Properties_ServiceAccounts struct {
	Email any
	Scopes any
}

type BetaComputeBetaInstanceTemplate_Properties_ShieldedInstanceConfig struct {
...
type BetaComputeBetaInstanceTemplate_Properties_Tags struct {
...
type BetaComputeBetaInstanceTemplate_Properties_WorkloadIdentityConfig struct {
	Identity any
	IdentityCertificateEnabled any
}

type BetaComputeBetaInstanceTemplate_Properties struct {
...
type BetaComputeBetaInstanceTemplate_SourceInstanceParams_DiskConfigs struct {
	AutoDelete any
	CustomImage any
	DeviceName any
	InstantiateFrom any
...
type BetaComputeBetaInstanceTemplate_SourceInstanceParams struct {
	// Attached disks configuration. If not provided, defaults are applied: For boot disk and any other R/W disks, the source images for each disk will be used. For read-only disks, they will be attached in read-only mode. Local SSD disks will be created as blank volumes.
	DiskConfigs any
}

var BetaComputeBetaInstanceTemplate_Properties_AdvancedMachineFeaturesFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceTemplate_Properties_ConfidentialInstanceConfigFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceTemplate_Properties_Disks_DiskEncryptionKeyFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceTemplate_Properties_Disks_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var BetaComputeBetaInstanceTemplate_Properties_Disks_InitializeParamsFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceTemplate_Properties_Disks_ShieldedInstanceInitialState_DbsFields = ubx.FieldMap{
		"Content": ubx.FieldSpec{WireName: "content"},
		"FileType": ubx.FieldSpec{WireName: "file_type"},
	}

var BetaComputeBetaInstanceTemplate_Properties_Disks_ShieldedInstanceInitialStateFields = ubx.FieldMap{
		"Dbs": ubx.FieldSpec{
			WireName: "dbs",
			Kind: "list",
...
var BetaComputeBetaInstanceTemplate_Properties_DisksFields = ubx.FieldMap{
		"Architecture": ubx.FieldSpec{WireName: "architecture"},
...
var BetaComputeBetaInstanceTemplate_Properties_DisplayDeviceFields = ubx.FieldMap{
		"EnableDisplay": ubx.FieldSpec{WireName: "enable_display"},
	}

var BetaComputeBetaInstanceTemplate_Properties_GuestAcceleratorsFields = ubx.FieldMap{
		"AcceleratorCount": ubx.FieldSpec{WireName: "accelerator_count"},
		"AcceleratorType": ubx.FieldSpec{WireName: "accelerator_type"},
	}

var BetaComputeBetaInstanceTemplate_Properties_Metadata_ItemsFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var BetaComputeBetaInstanceTemplate_Properties_MetadataFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceTemplate_Properties_NetworkInterfaces_AccessConfigsFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceTemplate_Properties_NetworkInterfaces_AliasIpRangesFields = ubx.FieldMap{
		"IpCidrRange": ubx.FieldSpec{WireName: "ip_cidr_range"},
		"SubnetworkRangeName": ubx.FieldSpec{WireName: "subnetwork_range_name"},
	}

var BetaComputeBetaInstanceTemplate_Properties_NetworkInterfacesFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceTemplate_Properties_NetworkPerformanceConfigFields = ubx.FieldMap{
		"TotalEgressBandwidthTier": ubx.FieldSpec{WireName: "total_egress_bandwidth_tier"},
	}

var BetaComputeBetaInstanceTemplate_Properties_PartnerMetadataFields = ubx.FieldMap{
		"Entries": ubx.FieldSpec{WireName: "entries"},
	}

var BetaComputeBetaInstanceTemplate_Properties_ReservationAffinityFields = ubx.FieldMap{
		"ConsumeReservationType": ubx.FieldSpec{WireName: "consume_reservation_type"},
		"Key": ubx.FieldSpec{WireName: "key"},
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var BetaComputeBetaInstanceTemplate_Properties_Scheduling_GracefulShutdown_MaxDurationFields = ubx.FieldMap{
		"Nanos": ubx.FieldSpec{WireName: "nanos"},
		"Seconds": ubx.FieldSpec{WireName: "seconds"},
	}

var BetaComputeBetaInstanceTemplate_Properties_Scheduling_GracefulShutdownFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceTemplate_Properties_Scheduling_NodeAffinitiesFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Operator": ubx.FieldSpec{WireName: "operator"},
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var BetaComputeBetaInstanceTemplate_Properties_Scheduling_OnInstanceStopActionFields = ubx.FieldMap{
		"DiscardLocalSsd": ubx.FieldSpec{WireName: "discard_local_ssd"},
	}

var BetaComputeBetaInstanceTemplate_Properties_SchedulingFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceTemplate_Properties_ServiceAccountsFields = ubx.FieldMap{
		"Email": ubx.FieldSpec{WireName: "email"},
		"Scopes": ubx.FieldSpec{WireName: "scopes"},
	}

var BetaComputeBetaInstanceTemplate_Properties_ShieldedInstanceConfigFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceTemplate_Properties_TagsFields = ubx.FieldMap{
		"Fingerprint": ubx.FieldSpec{WireName: "fingerprint"},
		"Items": ubx.FieldSpec{WireName: "items"},
	}

var BetaComputeBetaInstanceTemplate_Properties_WorkloadIdentityConfigFields = ubx.FieldMap{
		"Identity": ubx.FieldSpec{WireName: "identity"},
		"IdentityCertificateEnabled": ubx.FieldSpec{WireName: "identity_certificate_enabled"},
	}

var BetaComputeBetaInstanceTemplate_PropertiesFields = ubx.FieldMap{
...
var BetaComputeBetaInstanceTemplate_SourceInstanceParams_DiskConfigsFields = ubx.FieldMap{
		"AutoDelete": ubx.FieldSpec{WireName: "auto_delete"},
...
var BetaComputeBetaInstanceTemplate_SourceInstanceParamsFields = ubx.FieldMap{
...
type BetaComputeBetaInstanceTemplateConfig struct {
...
type BetaComputeBetaInstanceTemplateAttrs struct {
	// Output only. [Output Only] The creation timestamp for this instance template inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var BetaComputeBetaInstanceTemplate = ubx.ResourceBinding{
