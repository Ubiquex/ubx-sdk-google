...
type BetaStoragePool_ExapoolProvisionedCapacityGb struct {
...
type BetaStoragePool_Params struct {
...
type BetaStoragePool_ResourceStatus struct {
...
type BetaStoragePool_ShareSettings_ProjectMap struct {
	ProjectId any
}

type BetaStoragePool_ShareSettings struct {
	// A map of project id and project config.
	ProjectMap any
}

var BetaStoragePool_ExapoolProvisionedCapacityGbFields = ubx.FieldMap{
...
var BetaStoragePool_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaStoragePool_ResourceStatusFields = ubx.FieldMap{
...
var BetaStoragePool_ShareSettings_ProjectMapFields = ubx.FieldMap{
		"ProjectId": ubx.FieldSpec{WireName: "project_id"},
	}

var BetaStoragePool_ShareSettingsFields = ubx.FieldMap{
...
type BetaStoragePoolConfig struct {
...
type BetaStoragePoolAttrs struct {
	// Provisioning type of the byte capacity of the pool.
	CapacityProvisioningType any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var BetaStoragePool = ubx.ResourceBinding{
