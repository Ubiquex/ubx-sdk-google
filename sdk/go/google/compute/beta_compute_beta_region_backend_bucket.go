...
type BetaComputeBetaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders struct {
	HeaderName any
}

type BetaComputeBetaRegionBackendBucket_CdnPolicy_CacheKeyPolicy struct {
...
type BetaComputeBetaRegionBackendBucket_CdnPolicy_NegativeCachingPolicy struct {
	Code any
	Ttl any
}

type BetaComputeBetaRegionBackendBucket_CdnPolicy struct {
...
type BetaComputeBetaRegionBackendBucket_Params struct {
...
type BetaComputeBetaRegionBackendBucket_UsedBy struct {
	Reference any
}

var BetaComputeBetaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeadersFields = ubx.FieldMap{
		"HeaderName": ubx.FieldSpec{WireName: "header_name"},
	}

var BetaComputeBetaRegionBackendBucket_CdnPolicy_CacheKeyPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendBucket_CdnPolicy_NegativeCachingPolicyFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Ttl": ubx.FieldSpec{WireName: "ttl"},
	}

var BetaComputeBetaRegionBackendBucket_CdnPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaRegionBackendBucket_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaRegionBackendBucket_UsedByFields = ubx.FieldMap{
		"Reference": ubx.FieldSpec{WireName: "reference"},
	}

type BetaComputeBetaRegionBackendBucketConfig struct {
...
type BetaComputeBetaRegionBackendBucketAttrs struct {
	// Cloud Storage bucket name.
	BucketName any
	// Message containing Cloud CDN configuration for a backend bucket.
	CdnPolicy any
...
var BetaComputeBetaRegionBackendBucket = ubx.ResourceBinding{
