...
type BetaComputeBetaRoute_AsPaths struct {
	AsLists any
	PathSegmentType any
}

type BetaComputeBetaRoute_Params struct {
...
type BetaComputeBetaRoute_Warnings_Data struct {
	Key any
	Value any
}

type BetaComputeBetaRoute_Warnings struct {
	Code any
	Data any
	Message any
}

var BetaComputeBetaRoute_AsPathsFields = ubx.FieldMap{
		"AsLists": ubx.FieldSpec{WireName: "as_lists"},
		"PathSegmentType": ubx.FieldSpec{WireName: "path_segment_type"},
	}

var BetaComputeBetaRoute_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaRoute_Warnings_DataFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var BetaComputeBetaRoute_WarningsFields = ubx.FieldMap{
...
type BetaComputeBetaRouteConfig struct {
...
type BetaComputeBetaRouteAttrs struct {
	// Output only. [Output Only] AS path.
	AsPaths any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var BetaComputeBetaRoute = ubx.ResourceBinding{
