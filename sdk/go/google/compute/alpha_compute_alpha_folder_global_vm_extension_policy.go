...
type AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors struct {
	AllOfSelectors any
}

type AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector struct {
	AnyOfSelectors any
}

type AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies struct {
	InstalledSoftwareSelector any
	PinnedVersion any
	StringConfig any
}

type AlphaComputeAlphaFolderGlobalVmExtensionPolicy_InstanceSelectors_LabelSelector struct {
	InclusionLabels any
}

type AlphaComputeAlphaFolderGlobalVmExtensionPolicy_InstanceSelectors struct {
	LabelSelector any
}

type AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutInput struct {
...
type AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus struct {
	State any
}

type AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts struct {
...
type AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus struct {
...
type AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation struct {
	RolloutInput any
	RolloutStatus any
}

var AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectorsFields = ubx.FieldMap{
		"AllOfSelectors": ubx.FieldSpec{WireName: "all_of_selectors"},
	}

var AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelectorFields = ubx.FieldMap{
...
var AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPoliciesFields = ubx.FieldMap{
...
var AlphaComputeAlphaFolderGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields = ubx.FieldMap{
		"InclusionLabels": ubx.FieldSpec{WireName: "inclusion_labels"},
	}

var AlphaComputeAlphaFolderGlobalVmExtensionPolicy_InstanceSelectorsFields = ubx.FieldMap{
...
var AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields = ubx.FieldMap{
...
var AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields = ubx.FieldMap{
		"State": ubx.FieldSpec{WireName: "state"},
	}

var AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields = ubx.FieldMap{
...
var AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields = ubx.FieldMap{
...
var AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperationFields = ubx.FieldMap{
...
type AlphaComputeAlphaFolderGlobalVmExtensionPolicyConfig struct {
...
type AlphaComputeAlphaFolderGlobalVmExtensionPolicyAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaComputeAlphaFolderGlobalVmExtensionPolicy = ubx.ResourceBinding{
