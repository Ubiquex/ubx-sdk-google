...
type BetaComputeBetaInstantSnapshotGroup_ResourceStatus_SourceInfo struct {
	ConsistencyGroup any
	ConsistencyGroupId any
}

type BetaComputeBetaInstantSnapshotGroup_ResourceStatus struct {
	// Output only. [Output Only]
	ConsistencyMembershipResolutionTime any
	SourceInfo any
}

var BetaComputeBetaInstantSnapshotGroup_ResourceStatus_SourceInfoFields = ubx.FieldMap{
		"ConsistencyGroup": ubx.FieldSpec{WireName: "consistency_group"},
		"ConsistencyGroupId": ubx.FieldSpec{WireName: "consistency_group_id"},
	}

var BetaComputeBetaInstantSnapshotGroup_ResourceStatusFields = ubx.FieldMap{
...
type BetaComputeBetaInstantSnapshotGroupConfig struct {
...
type BetaComputeBetaInstantSnapshotGroupAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// Optional. An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var BetaComputeBetaInstantSnapshotGroup = ubx.ResourceBinding{
