...
type AlphaComputeAlphaPublicAdvertisedPrefix_PublicDelegatedPrefixs struct {
	IpRange any
	Name any
	Project any
	Region any
...
var AlphaComputeAlphaPublicAdvertisedPrefix_PublicDelegatedPrefixsFields = ubx.FieldMap{
...
type AlphaComputeAlphaPublicAdvertisedPrefixConfig struct {
...
type AlphaComputeAlphaPublicAdvertisedPrefixAttrs struct {
	// Output only. [Output Only] The version of BYOIP API.
	ByoipApiVersion any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var AlphaComputeAlphaPublicAdvertisedPrefix = ubx.ResourceBinding{
