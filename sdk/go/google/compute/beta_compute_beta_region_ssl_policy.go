...
type BetaComputeBetaRegionSslPolicy_Warnings_Data struct {
	Key any
	Value any
}

type BetaComputeBetaRegionSslPolicy_Warnings struct {
	Code any
	Data any
	Message any
}

var BetaComputeBetaRegionSslPolicy_Warnings_DataFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var BetaComputeBetaRegionSslPolicy_WarningsFields = ubx.FieldMap{
...
type BetaComputeBetaRegionSslPolicyConfig struct {
...
type BetaComputeBetaRegionSslPolicyAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// A list of features enabled when the selected profile is CUSTOM. The method returns the set of features that can be specified in this list. This field must be empty if the profile is notCUSTOM.
	CustomFeatures any
...
var BetaComputeBetaRegionSslPolicy = ubx.ResourceBinding{
