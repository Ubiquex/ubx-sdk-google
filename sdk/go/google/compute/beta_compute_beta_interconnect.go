...
type BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages struct {
	Percentage any
	TrafficClass any
}

type BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy struct {
	// Specify bandwidth percentages for various traffic classes for queuing type Bandwidth Percent.
	BandwidthPercentages any
}

type BetaComputeBetaInterconnect_ApplicationAwareInterconnect struct {
...
type BetaComputeBetaInterconnect_CircuitInfos struct {
	CustomerDemarcId any
	GoogleCircuitId any
	GoogleDemarcId any
}

type BetaComputeBetaInterconnect_ExpectedOutages struct {
...
type BetaComputeBetaInterconnect_Macsec_PreSharedKeys struct {
	Name any
	StartTime any
}

type BetaComputeBetaInterconnect_Macsec struct {
...
type BetaComputeBetaInterconnect_Params struct {
...
var BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentagesFields = ubx.FieldMap{
		"Percentage": ubx.FieldSpec{WireName: "percentage"},
		"TrafficClass": ubx.FieldSpec{WireName: "traffic_class"},
	}

var BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicyFields = ubx.FieldMap{
...
var BetaComputeBetaInterconnect_ApplicationAwareInterconnectFields = ubx.FieldMap{
...
var BetaComputeBetaInterconnect_CircuitInfosFields = ubx.FieldMap{
...
var BetaComputeBetaInterconnect_ExpectedOutagesFields = ubx.FieldMap{
...
var BetaComputeBetaInterconnect_Macsec_PreSharedKeysFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"StartTime": ubx.FieldSpec{WireName: "start_time"},
	}

var BetaComputeBetaInterconnect_MacsecFields = ubx.FieldMap{
...
var BetaComputeBetaInterconnect_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

type BetaComputeBetaInterconnectConfig struct {
...
type BetaComputeBetaInterconnectAttrs struct {
	// Enable or disable the application awareness feature on this Cloud Interconnect.
	AaiEnabled any
	// Administrative status of the interconnect. When this is set to true, the Interconnect is functional and can carry traffic. When set to false, no packets can be carried over the interconnect and no BGP routes are exchanged over it. By default, the status is set to true.
	AdminEnabled any
...
var BetaComputeBetaInterconnect = ubx.ResourceBinding{
