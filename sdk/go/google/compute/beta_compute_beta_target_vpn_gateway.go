...
type BetaComputeBetaTargetVpnGateway_Params struct {
...
var BetaComputeBetaTargetVpnGateway_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

type BetaComputeBetaTargetVpnGatewayConfig struct {
...
type BetaComputeBetaTargetVpnGatewayAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var BetaComputeBetaTargetVpnGateway = ubx.ResourceBinding{
