...
type BetaComputeBetaRegionNetworkFirewallPolicy_Associations struct {
...
type BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs struct {
	IpProtocol any
	Ports any
}

type BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags struct {
	Name any
	State any
}

type BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match struct {
...
type BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules struct {
	Action any
	Description any
	Direction any
	Disabled any
...
var BetaComputeBetaRegionNetworkFirewallPolicy_AssociationsFields = ubx.FieldMap{
...
var BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields = ubx.FieldMap{
		"IpProtocol": ubx.FieldSpec{WireName: "ip_protocol"},
		"Ports": ubx.FieldSpec{WireName: "ports"},
	}

var BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"State": ubx.FieldSpec{WireName: "state"},
	}

var BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_MatchFields = ubx.FieldMap{
...
var BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRulesFields = ubx.FieldMap{
...
type BetaComputeBetaRegionNetworkFirewallPolicyConfig struct {
...
type BetaComputeBetaRegionNetworkFirewallPolicyAttrs struct {
	// A list of associations that belong to this firewall policy.
	Associations any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var BetaComputeBetaRegionNetworkFirewallPolicy = ubx.ResourceBinding{
