...
type AlphaComputeAlphaTargetVpnGateway_Params struct {
...
var AlphaComputeAlphaTargetVpnGateway_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

type AlphaComputeAlphaTargetVpnGatewayConfig struct {
...
type AlphaComputeAlphaTargetVpnGatewayAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaComputeAlphaTargetVpnGateway = ubx.ResourceBinding{
