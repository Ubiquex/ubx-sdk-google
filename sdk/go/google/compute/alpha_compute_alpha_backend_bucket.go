...
type AlphaComputeAlphaBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders struct {
	HeaderName any
}

type AlphaComputeAlphaBackendBucket_CdnPolicy_CacheKeyPolicy struct {
...
type AlphaComputeAlphaBackendBucket_CdnPolicy_NegativeCachingPolicy struct {
	Code any
	Ttl any
}

type AlphaComputeAlphaBackendBucket_CdnPolicy struct {
...
type AlphaComputeAlphaBackendBucket_Params struct {
...
type AlphaComputeAlphaBackendBucket_UsedBy struct {
	Reference any
}

var AlphaComputeAlphaBackendBucket_CdnPolicy_BypassCacheOnRequestHeadersFields = ubx.FieldMap{
		"HeaderName": ubx.FieldSpec{WireName: "header_name"},
	}

var AlphaComputeAlphaBackendBucket_CdnPolicy_CacheKeyPolicyFields = ubx.FieldMap{
...
var AlphaComputeAlphaBackendBucket_CdnPolicy_NegativeCachingPolicyFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Ttl": ubx.FieldSpec{WireName: "ttl"},
	}

var AlphaComputeAlphaBackendBucket_CdnPolicyFields = ubx.FieldMap{
...
var AlphaComputeAlphaBackendBucket_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaComputeAlphaBackendBucket_UsedByFields = ubx.FieldMap{
		"Reference": ubx.FieldSpec{WireName: "reference"},
	}

type AlphaComputeAlphaBackendBucketConfig struct {
...
type AlphaComputeAlphaBackendBucketAttrs struct {
	// Cloud Storage bucket name.
	BucketName any
	// Message containing Cloud CDN configuration for a backend bucket.
	CdnPolicy any
...
var AlphaComputeAlphaBackendBucket = ubx.ResourceBinding{
