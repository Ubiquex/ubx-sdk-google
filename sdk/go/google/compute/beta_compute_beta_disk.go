...
type BetaComputeBetaDisk_AsyncPrimaryDisk struct {
...
type BetaComputeBetaDisk_AsyncSecondaryDisks struct {
	AsyncReplicationDisk any
}

type BetaComputeBetaDisk_DiskEncryptionKey struct {
...
type BetaComputeBetaDisk_GuestOsFeatures struct {
	Type any
}

type BetaComputeBetaDisk_Params struct {
...
type BetaComputeBetaDisk_ResourceStatus_AsyncPrimaryDisk struct {
	State any
}

type BetaComputeBetaDisk_ResourceStatus struct {
	AsyncPrimaryDisk any
	// Key: disk, value: AsyncReplicationStatus message
	AsyncSecondaryDisks any
}

var BetaComputeBetaDisk_AsyncPrimaryDiskFields = ubx.FieldMap{
...
var BetaComputeBetaDisk_AsyncSecondaryDisksFields = ubx.FieldMap{
...
var BetaComputeBetaDisk_DiskEncryptionKeyFields = ubx.FieldMap{
...
var BetaComputeBetaDisk_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var BetaComputeBetaDisk_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaDisk_ResourceStatus_AsyncPrimaryDiskFields = ubx.FieldMap{
		"State": ubx.FieldSpec{WireName: "state"},
	}

var BetaComputeBetaDisk_ResourceStatusFields = ubx.FieldMap{
...
type BetaComputeBetaDiskConfig struct {
...
type BetaComputeBetaDiskAttrs struct {
	// The access mode of the disk. - READ_WRITE_SINGLE: The default AccessMode, means the disk can be attached to single instance in RW mode. - READ_WRITE_MANY: The AccessMode means the disk can be attached to multiple instances in RW mode. - READ_ONLY_MANY: The AccessMode means the disk can be attached to multiple instances in RO mode. The AccessMode is only valid for Hyperdisk disk types.
	AccessMode any
	// The architecture of the disk. Valid values are ARM64 or X86_64.
	Architecture any
...
var BetaComputeBetaDisk = ubx.ResourceBinding{
