...
type AlphaComputeAlphaGlobalAddressConfig struct {
...
type AlphaComputeAlphaGlobalAddressAttrs struct {
	// The static IP address represented by this resource.
	Address any
	// The type of address to reserve, either INTERNAL orEXTERNAL. If unspecified, defaults to EXTERNAL.
	AddressType any
...
var AlphaComputeAlphaGlobalAddress = ubx.ResourceBinding{
	...
	Fields: ubx.FieldMap{
		...
		"PtrDomainName": ubx.FieldSpec{WireName: "ptr_domain_name"},
		"PtrDomainNameTtl": ubx.FieldSpec{WireName: "ptr_domain_name_ttl"},
