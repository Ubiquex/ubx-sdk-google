...
type BetaComputeBetaSubnetwork_LogConfig struct {
...
type BetaComputeBetaSubnetwork_Params struct {
...
type BetaComputeBetaSubnetwork_SecondaryIpRanges struct {
	IpCidrRange any
	IpCollection any
	IpVersion any
	RangeName any
...
type BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp struct {
	High any
	Low any
}

type BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization struct {
	TotalAllocatedIp any
	TotalFreeIp any
}

type BetaComputeBetaSubnetwork_UtilizationDetails_Ipv4Utilizations struct {
	RangeName any
	TotalAllocatedIp any
	TotalFreeIp any
}

type BetaComputeBetaSubnetwork_UtilizationDetails struct {
...
var BetaComputeBetaSubnetwork_LogConfigFields = ubx.FieldMap{
...
var BetaComputeBetaSubnetwork_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var BetaComputeBetaSubnetwork_SecondaryIpRangesFields = ubx.FieldMap{
...
var BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIpFields = ubx.FieldMap{
		"High": ubx.FieldSpec{WireName: "high"},
		"Low": ubx.FieldSpec{WireName: "low"},
	}

var BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilizationFields = ubx.FieldMap{
...
var BetaComputeBetaSubnetwork_UtilizationDetails_Ipv4UtilizationsFields = ubx.FieldMap{
		"RangeName": ubx.FieldSpec{WireName: "range_name"},
		"TotalAllocatedIp": ubx.FieldSpec{WireName: "total_allocated_ip"},
		"TotalFreeIp": ubx.FieldSpec{WireName: "total_free_ip"},
	}

var BetaComputeBetaSubnetwork_UtilizationDetailsFields = ubx.FieldMap{
...
type BetaComputeBetaSubnetworkConfig struct {
...
type BetaComputeBetaSubnetworkAttrs struct {
	// Whether this subnetwork's ranges can conflict with existing custom routes. Setting this to true allows this subnetwork's primary and secondary ranges to overlap with (and contain) custom routes that have already been configured on the corresponding network. For example if a static route has range 10.1.0.0/16, a subnet range 10.0.0.0/8 could only be created if allow_conflicting_routes=true. Overlapping is only allowed on subnetwork operations; routes whose ranges conflict with this subnetwork's ranges won't be allowed unless route.allow_conflicting_subnetworks is set to true. Typically packets destined to IPs within the subnetwork (which may contain private/sensitive data) are prevented from leaving the virtual network. Setting this field to true will disable this feature. The default value is false and applies to all existing subnetworks and automatically created subnetworks.
	AllowSubnetCidrRoutesOverlap any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var BetaComputeBetaSubnetwork = ubx.ResourceBinding{
