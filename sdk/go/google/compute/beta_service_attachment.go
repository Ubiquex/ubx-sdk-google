...
type BetaServiceAttachment_ConnectedEndpoints struct {
	ConsumerNetwork any
	Endpoint any
	EndpointWithId any
	NatIps any
...
type BetaServiceAttachment_ConsumerAcceptLists struct {
	ConnectionLimit any
	EndpointUrl any
	NetworkUrl any
	ProjectIdOrNum any
...
type BetaServiceAttachment_PscServiceAttachmentId struct {
	High any
	Low any
}

type BetaServiceAttachment_TunnelingConfig struct {
...
var BetaServiceAttachment_ConnectedEndpointsFields = ubx.FieldMap{
...
var BetaServiceAttachment_ConsumerAcceptListsFields = ubx.FieldMap{
...
type BetaServiceAttachmentAttrs struct {
	// Output only. [Output Only] An array of connections for all the consumers connected to this service attachment.
	ConnectedEndpoints any
	// The connection preference of service attachment. The value can be set to ACCEPT_AUTOMATIC. An ACCEPT_AUTOMATIC service attachment is one that always accepts the connection from consumer forwarding rules.
	ConnectionPreference any
...
var BetaServiceAttachment = ubx.ResourceBinding{
