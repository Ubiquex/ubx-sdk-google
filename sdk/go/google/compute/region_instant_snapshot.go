...
type RegionInstantSnapshot_ResourceStatus struct {
...
var RegionInstantSnapshot_ResourceStatusFields = ubx.FieldMap{
...
type RegionInstantSnapshotAttrs struct {
	// Output only. [Output Only] The architecture of the instant snapshot. Valid values are ARM64 or X86_64.
	Architecture any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var RegionInstantSnapshot = ubx.ResourceBinding{
	...
	Fields: ubx.FieldMap{
		...
		"ResourceStatus": ubx.FieldSpec{
			...
			Kind: "object",
			Fields: RegionInstantSnapshot_ResourceStatusFields,
		},
