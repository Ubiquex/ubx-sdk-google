...
type BetaComputeBetaUrlMap_DefaultCustomErrorResponsePolicy_ErrorResponseRules struct {
	MatchResponseCodes any
	OverrideResponseCode any
	Path any
}

type BetaComputeBetaUrlMap_DefaultCustomErrorResponsePolicy struct {
...
type BetaComputeBetaUrlMap_DefaultRouteAction_CachePolicy_CacheKeyPolicy struct {
...
type BetaComputeBetaUrlMap_DefaultRouteAction_CachePolicy_ClientTtl struct {
...
type BetaComputeBetaUrlMap_DefaultRouteAction_CachePolicy_NegativeCachingPolicy struct {
	Code any
	Ttl any
}

type BetaComputeBetaUrlMap_DefaultRouteAction_CachePolicy struct {
...
type BetaComputeBetaUrlMap_DefaultRouteAction_CorsPolicy struct {
...
type BetaComputeBetaUrlMap_DefaultRouteAction_FaultInjectionPolicy_Abort struct {
...
type BetaComputeBetaUrlMap_DefaultRouteAction_FaultInjectionPolicy_Delay struct {
	// A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years.
	FixedDelay any
...
type BetaComputeBetaUrlMap_DefaultRouteAction_FaultInjectionPolicy struct {
...
type BetaComputeBetaUrlMap_DefaultRouteAction_ImageOptimizationPolicy struct {
	// Specifies whether to interpret query parameters for image optimization.
	QueryParameterInterpretation any
}

type BetaComputeBetaUrlMap_DefaultRouteAction_RequestMirrorPolicy struct {
...
type BetaComputeBetaUrlMap_DefaultRouteAction_RetryPolicy struct {
...
type BetaComputeBetaUrlMap_DefaultRouteAction_UrlRewrite_RegexRewrite struct {
...
type BetaComputeBetaUrlMap_DefaultRouteAction_UrlRewrite struct {
...
type BetaComputeBetaUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderAction_RequestHeadersToAdd struct {
	HeaderName any
	HeaderValue any
	Replace any
}

type BetaComputeBetaUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderAction struct {
...
type BetaComputeBetaUrlMap_DefaultRouteAction_WeightedBackendServices struct {
	BackendService any
	HeaderAction any
	Weight any
}

type BetaComputeBetaUrlMap_DefaultRouteAction struct {
...
type BetaComputeBetaUrlMap_DefaultUrlRedirect struct {
...
type BetaComputeBetaUrlMap_HostRules struct {
	Description any
	Hosts any
	PathMatcher any
}

type BetaComputeBetaUrlMap_PathMatchers_PathRules struct {
...
type BetaComputeBetaUrlMap_PathMatchers_RouteRules_HttpFilterConfigs struct {
	Config any
	ConfigTypeUrl any
	FilterName any
}

type BetaComputeBetaUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatches_RangeMatch struct {
	RangeEnd any
	RangeStart any
}

type BetaComputeBetaUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatches struct {
	ExactMatch any
	HeaderName any
	InvertMatch any
	PrefixMatch any
...
type BetaComputeBetaUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFilters_FilterLabels struct {
	Name any
	Value any
}

type BetaComputeBetaUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFilters struct {
	FilterLabels any
	FilterMatchCriteria any
}

type BetaComputeBetaUrlMap_PathMatchers_RouteRules_MatchRules_QueryParameterMatches struct {
	ExactMatch any
	Name any
	PresentMatch any
	RegexMatch any
...
type BetaComputeBetaUrlMap_PathMatchers_RouteRules_MatchRules struct {
	FullPathMatch any
	HeaderMatches any
	IgnoreCase any
	MetadataFilters any
...
type BetaComputeBetaUrlMap_PathMatchers_RouteRules struct {
	CustomErrorResponsePolicy any
	Description any
	HeaderAction any
...
type BetaComputeBetaUrlMap_PathMatchers struct {
...
type BetaComputeBetaUrlMap_Status_QuotaUsage struct {
...
type BetaComputeBetaUrlMap_Status struct {
	// Message representing the quota usage for a UrlMap.
	QuotaUsage any
}

type BetaComputeBetaUrlMap_Tests struct {
	Description any
...
var BetaComputeBetaUrlMap_DefaultCustomErrorResponsePolicy_ErrorResponseRulesFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_DefaultCustomErrorResponsePolicyFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_DefaultRouteAction_CachePolicy_CacheKeyPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_DefaultRouteAction_CachePolicy_ClientTtlFields = ubx.FieldMap{
		"Nanos": ubx.FieldSpec{WireName: "nanos"},
		"Seconds": ubx.FieldSpec{WireName: "seconds"},
	}

var BetaComputeBetaUrlMap_DefaultRouteAction_CachePolicy_NegativeCachingPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_DefaultRouteAction_CachePolicyFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_DefaultRouteAction_CorsPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_DefaultRouteAction_FaultInjectionPolicy_AbortFields = ubx.FieldMap{
		"HttpStatus": ubx.FieldSpec{WireName: "http_status"},
		"Percentage": ubx.FieldSpec{WireName: "percentage"},
	}

var BetaComputeBetaUrlMap_DefaultRouteAction_FaultInjectionPolicy_DelayFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_DefaultRouteAction_FaultInjectionPolicyFields = ubx.FieldMap{
		"Abort": ubx.FieldSpec{
			WireName: "abort",
			Kind: "object",
...
var BetaComputeBetaUrlMap_DefaultRouteAction_ImageOptimizationPolicyFields = ubx.FieldMap{
		"QueryParameterInterpretation": ubx.FieldSpec{WireName: "query_parameter_interpretation"},
	}

var BetaComputeBetaUrlMap_DefaultRouteAction_RequestMirrorPolicyFields = ubx.FieldMap{
		"BackendService": ubx.FieldSpec{WireName: "backend_service"},
		"MirrorPercent": ubx.FieldSpec{WireName: "mirror_percent"},
	}

var BetaComputeBetaUrlMap_DefaultRouteAction_RetryPolicyFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_DefaultRouteAction_UrlRewrite_RegexRewriteFields = ubx.FieldMap{
		"PathPattern": ubx.FieldSpec{WireName: "path_pattern"},
		"PathSubstitution": ubx.FieldSpec{WireName: "path_substitution"},
	}

var BetaComputeBetaUrlMap_DefaultRouteAction_UrlRewriteFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderAction_RequestHeadersToAddFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderActionFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_DefaultRouteAction_WeightedBackendServicesFields = ubx.FieldMap{
		"BackendService": ubx.FieldSpec{WireName: "backend_service"},
...
var BetaComputeBetaUrlMap_DefaultRouteActionFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_DefaultUrlRedirectFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_HostRulesFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Hosts": ubx.FieldSpec{WireName: "hosts"},
		"PathMatcher": ubx.FieldSpec{WireName: "path_matcher"},
	}

var BetaComputeBetaUrlMap_PathMatchers_PathRulesFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_PathMatchers_RouteRules_HttpFilterConfigsFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatches_RangeMatchFields = ubx.FieldMap{
		"RangeEnd": ubx.FieldSpec{WireName: "range_end"},
		"RangeStart": ubx.FieldSpec{WireName: "range_start"},
	}

var BetaComputeBetaUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatchesFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFilters_FilterLabelsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var BetaComputeBetaUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFiltersFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_PathMatchers_RouteRules_MatchRules_QueryParameterMatchesFields = ubx.FieldMap{
		"ExactMatch": ubx.FieldSpec{WireName: "exact_match"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"PresentMatch": ubx.FieldSpec{WireName: "present_match"},
		"RegexMatch": ubx.FieldSpec{WireName: "regex_match"},
...
var BetaComputeBetaUrlMap_PathMatchers_RouteRules_MatchRulesFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_PathMatchers_RouteRulesFields = ubx.FieldMap{
		"CustomErrorResponsePolicy": ubx.FieldSpec{
			WireName: "custom_error_response_policy",
			Kind: "object",
			Fields: BetaComputeBetaUrlMap_DefaultCustomErrorResponsePolicyFields,
...
var BetaComputeBetaUrlMap_PathMatchersFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_Status_QuotaUsageFields = ubx.FieldMap{
		"ForwardingRules": ubx.FieldSpec{WireName: "forwarding_rules"},
		"Units": ubx.FieldSpec{WireName: "units"},
	}

var BetaComputeBetaUrlMap_StatusFields = ubx.FieldMap{
...
var BetaComputeBetaUrlMap_TestsFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
...
type BetaComputeBetaUrlMapConfig struct {
...
type BetaComputeBetaUrlMapAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// Specifies the custom error response policy that must be applied when the backend service or backend bucket responds with an error.
	DefaultCustomErrorResponsePolicy any
...
var BetaComputeBetaUrlMap = ubx.ResourceBinding{
