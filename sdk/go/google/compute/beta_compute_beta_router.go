...
type BetaComputeBetaRouter_Bgp_AdvertisedIpRanges struct {
	Description any
	Range any
}

type BetaComputeBetaRouter_Bgp struct {
...
type BetaComputeBetaRouter_BgpPeers_Bfd struct {
...
type BetaComputeBetaRouter_BgpPeers_CustomLearnedIpRanges struct {
	Range any
}

type BetaComputeBetaRouter_BgpPeers struct {
	AdvertiseMode any
	AdvertisedGroups any
	AdvertisedIpRanges any
...
type BetaComputeBetaRouter_Interfaces struct {
	IpRange any
	IpVersion any
...
type BetaComputeBetaRouter_Md5AuthenticationKeys struct {
	Key any
	Name any
}

type BetaComputeBetaRouter_Nats_LogConfig struct {
	Enable any
	Filter any
}

type BetaComputeBetaRouter_Nats_Nat64Subnetworks struct {
	Name any
}

type BetaComputeBetaRouter_Nats_Rules_Action struct {
...
type BetaComputeBetaRouter_Nats_Rules struct {
	Action any
	Description any
	Match any
	RuleNumber any
...
type BetaComputeBetaRouter_Nats_Subnetworks struct {
	Name any
	SecondaryIpRangeNames any
	SourceIpRangesToNat any
}

type BetaComputeBetaRouter_Nats struct {
	AutoNetworkTier any
	DrainNatIps any
...
type BetaComputeBetaRouter_Params struct {
...
var BetaComputeBetaRouter_Bgp_AdvertisedIpRangesFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Range": ubx.FieldSpec{WireName: "range"},
	}

var BetaComputeBetaRouter_BgpFields = ubx.FieldMap{
...
var BetaComputeBetaRouter_BgpPeers_BfdFields = ubx.FieldMap{
...
var BetaComputeBetaRouter_BgpPeers_CustomLearnedIpRangesFields = ubx.FieldMap{
		"Range": ubx.FieldSpec{WireName: "range"},
	}

var BetaComputeBetaRouter_BgpPeersFields = ubx.FieldMap{
		"AdvertiseMode": ubx.FieldSpec{WireName: "advertise_mode"},
		"AdvertisedGroups": ubx.FieldSpec{WireName: "advertised_groups"},
		"AdvertisedIpRanges": ubx.FieldSpec{
			WireName: "advertised_ip_ranges",
...
var BetaComputeBetaRouter_InterfacesFields = ubx.FieldMap{
...
var BetaComputeBetaRouter_Md5AuthenticationKeysFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var BetaComputeBetaRouter_Nats_LogConfigFields = ubx.FieldMap{
		"Enable": ubx.FieldSpec{WireName: "enable"},
		"Filter": ubx.FieldSpec{WireName: "filter"},
	}

var BetaComputeBetaRouter_Nats_Nat64SubnetworksFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var BetaComputeBetaRouter_Nats_Rules_ActionFields = ubx.FieldMap{
...
var BetaComputeBetaRouter_Nats_RulesFields = ubx.FieldMap{
...
var BetaComputeBetaRouter_Nats_SubnetworksFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
...
var BetaComputeBetaRouter_NatsFields = ubx.FieldMap{
...
var BetaComputeBetaRouter_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

type BetaComputeBetaRouterConfig struct {
	Bgp any
...
type BetaComputeBetaRouterAttrs struct {
	Bgp any
	// BGP information that must be configured into the routing stack to establish BGP peering. This information must specify the peer ASN and either the interface name, IP address, or peer IP address. Please refer toRFC4273.
	BgpPeers any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
...
var BetaComputeBetaRouter = ubx.ResourceBinding{
