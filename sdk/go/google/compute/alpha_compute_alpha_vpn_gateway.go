...
type AlphaComputeAlphaVpnGateway_Params struct {
...
type AlphaComputeAlphaVpnGateway_VpnInterfaces struct {
	Id any
...
var AlphaComputeAlphaVpnGateway_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaComputeAlphaVpnGateway_VpnInterfacesFields = ubx.FieldMap{
...
type AlphaComputeAlphaVpnGatewayConfig struct {
...
type AlphaComputeAlphaVpnGatewayAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaComputeAlphaVpnGateway = ubx.ResourceBinding{
