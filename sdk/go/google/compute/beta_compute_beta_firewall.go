...
type BetaComputeBetaFirewall_Allowed struct {
	Ipprotocol any
	Ports any
}

type BetaComputeBetaFirewall_LogConfig struct {
...
type BetaComputeBetaFirewall_Params struct {
...
var BetaComputeBetaFirewall_AllowedFields = ubx.FieldMap{
		"Ipprotocol": ubx.FieldSpec{WireName: "ipprotocol"},
		"Ports": ubx.FieldSpec{WireName: "ports"},
	}

var BetaComputeBetaFirewall_LogConfigFields = ubx.FieldMap{
		"Enable": ubx.FieldSpec{WireName: "enable"},
		"Metadata": ubx.FieldSpec{WireName: "metadata"},
	}

var BetaComputeBetaFirewall_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

type BetaComputeBetaFirewallConfig struct {
...
type BetaComputeBetaFirewallAttrs struct {
	// The list of ALLOW rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a permitted connection.
	Allowed any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var BetaComputeBetaFirewall = ubx.ResourceBinding{
