...
type AlphaRegionUrlMap_DefaultRouteAction_CachePolicy_CacheKeyPolicy struct {
...
type AlphaRegionUrlMap_DefaultRouteAction_CachePolicy_ClientTtl struct {
...
type AlphaRegionUrlMap_DefaultRouteAction_CorsPolicy struct {
...
type AlphaRegionUrlMap_DefaultRouteAction_DynamicCompressionPolicy struct {
	// Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header.
	CompressionMode any
}

type AlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy_Abort struct {
...
type AlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy_Delay struct {
	// A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years.
	FixedDelay any
...
type AlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy struct {
...
type AlphaRegionUrlMap_DefaultRouteAction_ImageOptimizationPolicy struct {
	// Specifies whether to interpret query parameters for image optimization.
	QueryParameterInterpretation any
}

type AlphaRegionUrlMap_DefaultRouteAction_RequestMirrorPolicy struct {
...
type AlphaRegionUrlMap_DefaultRouteAction_RetryPolicy struct {
...
type AlphaRegionUrlMap_DefaultRouteAction_UrlRewrite_RegexRewrite struct {
...
type AlphaRegionUrlMap_DefaultRouteAction_UrlRewrite struct {
...
type AlphaRegionUrlMap_DefaultUrlRedirect struct {
...
type AlphaRegionUrlMap_Status struct {
...
var AlphaRegionUrlMap_DefaultRouteAction_DynamicCompressionPolicyFields = ubx.FieldMap{
...
type AlphaRegionUrlMapAttrs struct {
