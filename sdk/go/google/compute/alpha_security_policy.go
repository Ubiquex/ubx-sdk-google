...
type AlphaSecurityPolicy_AdaptiveProtectionConfig_AutoDeployConfig struct {
...
type AlphaSecurityPolicy_AdaptiveProtectionConfig_Layer7DdosDefenseConfig_ThresholdConfigs_TrafficGranularityConfigs struct {
	EnableEachUniqueValue any
	Type                  any
	Value                 any
}

type AlphaSecurityPolicy_AdaptiveProtectionConfig_Layer7DdosDefenseConfig_ThresholdConfigs struct {
...
type AlphaSecurityPolicy_AdaptiveProtectionConfig_Layer7DdosDefenseConfig struct {
...
type AlphaSecurityPolicy_AdaptiveProtectionConfig struct {
...
type AlphaSecurityPolicy_AdvancedOptionsConfig_JsonCustomConfig struct {
	// A list of custom Content-Type header values to apply the JSON parsing. As per RFC 1341, a Content-Type header value has the following format: Content-Type := type "/" subtype *[";" parameter] When configuring a custom Content-Type header value, only the type/subtype needs to be specified, and the parameters should be excluded.
	ContentTypes any
}

type AlphaSecurityPolicy_AdvancedOptionsConfig struct {
...
type AlphaSecurityPolicy_Associations struct {
	AttachmentId     any
	DisplayName      any
	ExcludedFolders  any
...
type AlphaSecurityPolicy_CloudArmorConfig struct {
	// If set to true, enables Cloud Armor Machine Learning.
	EnableMl any
}

type AlphaSecurityPolicy_DdosProtectionConfig struct {
...
type AlphaSecurityPolicy_RecaptchaOptionsConfig struct {
	// An optional field to supply a reCAPTCHA site key to be used for all the rules using the redirect action with the type of GOOGLE_RECAPTCHA under the security policy. The specified site key needs to be created from the reCAPTCHA API. The user is responsible for the validity of the specified site key. If not specified, a Google-managed site key is used. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
	RedirectSiteKey any
}

type AlphaSecurityPolicy_Rules_HeaderAction_RequestHeadersToAdds struct {
	HeaderName  any
	HeaderValue any
}

type AlphaSecurityPolicy_Rules_HeaderAction struct {
	RequestHeadersToAdds any
}

type AlphaSecurityPolicy_Rules_Match_Config_DestPorts struct {
	IpProtocol any
	Ports      any
}

type AlphaSecurityPolicy_Rules_Match_Config struct {
	DestIpRanges  any
	DestPorts     any
	Layer4Configs any
	SrcIpRanges   any
...
type AlphaSecurityPolicy_Rules_Match_Expr struct {
	Description any
	Expression  any
	Location    any
	Title       any
...
type AlphaSecurityPolicy_Rules_Match_ExprOptions_RecaptchaOptions struct {
	ActionTokenSiteKeys  any
	SessionTokenSiteKeys any
}

type AlphaSecurityPolicy_Rules_Match_ExprOptions struct {
	RecaptchaOptions any
}

type AlphaSecurityPolicy_Rules_Match struct {
	Config        any
	Expr          any
	ExprOptions   any
	VersionedExpr any
...
type AlphaSecurityPolicy_Rules_NetworkMatch_UserDefinedFields struct {
	Name   any
	Values any
}

type AlphaSecurityPolicy_Rules_NetworkMatch struct {
	DestIpRanges      any
	DestPorts         any
	IpProtocols       any
	SrcAsns           any
...
type AlphaSecurityPolicy_Rules_PreconfiguredWafConfig_Exclusions_RequestBodiesToExclude struct {
	Op  any
	Val any
}

type AlphaSecurityPolicy_Rules_PreconfiguredWafConfig_Exclusions struct {
...
type AlphaSecurityPolicy_Rules_PreconfiguredWafConfig struct {
	Exclusions any
}

type AlphaSecurityPolicy_Rules_RateLimitOptions_BanThreshold struct {
	Count       any
	IntervalSec any
}

type AlphaSecurityPolicy_Rules_RateLimitOptions_EnforceOnKeyConfigs struct {
	EnforceOnKeyName any
	EnforceOnKeyType any
}

type AlphaSecurityPolicy_Rules_RateLimitOptions_ExceedActionRpcStatus struct {
	Code    any
	Message any
}

type AlphaSecurityPolicy_Rules_RateLimitOptions_ExceedRedirectOptions struct {
	Target any
	Type   any
}

type AlphaSecurityPolicy_Rules_RateLimitOptions struct {
	BanDurationSec        any
	BanThreshold          any
	ConformAction         any
	EnforceOnKey          any
...
type AlphaSecurityPolicy_Rules struct {
	Action                    any
	Description               any
	Direction                 any
	EnableLogging             any
...
type AlphaSecurityPolicy_UserDefinedFields struct {
	Base   any
	Mask   any
	Name   any
	Offset any
...
var AlphaSecurityPolicy_AdaptiveProtectionConfig_AutoDeployConfigFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_AdaptiveProtectionConfig_Layer7DdosDefenseConfig_ThresholdConfigs_TrafficGranularityConfigsFields = ubx.FieldMap{
	"EnableEachUniqueValue": ubx.FieldSpec{WireName: "enable_each_unique_value"},
	"Type":                  ubx.FieldSpec{WireName: "type"},
	"Value":                 ubx.FieldSpec{WireName: "value"},
}

var AlphaSecurityPolicy_AdaptiveProtectionConfig_Layer7DdosDefenseConfig_ThresholdConfigsFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_AdaptiveProtectionConfig_Layer7DdosDefenseConfigFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_AdaptiveProtectionConfigFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_AdvancedOptionsConfig_JsonCustomConfigFields = ubx.FieldMap{
	"ContentTypes": ubx.FieldSpec{WireName: "content_types"},
}

var AlphaSecurityPolicy_AdvancedOptionsConfigFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_AssociationsFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_CloudArmorConfigFields = ubx.FieldMap{
	"EnableMl": ubx.FieldSpec{WireName: "enable_ml"},
}

var AlphaSecurityPolicy_DdosProtectionConfigFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_RecaptchaOptionsConfigFields = ubx.FieldMap{
	"RedirectSiteKey": ubx.FieldSpec{WireName: "redirect_site_key"},
}

var AlphaSecurityPolicy_Rules_HeaderAction_RequestHeadersToAddsFields = ubx.FieldMap{
	"HeaderName":  ubx.FieldSpec{WireName: "header_name"},
	"HeaderValue": ubx.FieldSpec{WireName: "header_value"},
}

var AlphaSecurityPolicy_Rules_HeaderActionFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_Rules_Match_Config_DestPortsFields = ubx.FieldMap{
	"IpProtocol": ubx.FieldSpec{WireName: "ip_protocol"},
	"Ports":      ubx.FieldSpec{WireName: "ports"},
}

var AlphaSecurityPolicy_Rules_Match_ConfigFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_Rules_Match_ExprFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_Rules_Match_ExprOptions_RecaptchaOptionsFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_Rules_Match_ExprOptionsFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_Rules_MatchFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_Rules_NetworkMatch_UserDefinedFieldsFields = ubx.FieldMap{
	"Name":   ubx.FieldSpec{WireName: "name"},
	"Values": ubx.FieldSpec{WireName: "values"},
}

var AlphaSecurityPolicy_Rules_NetworkMatchFields = ubx.FieldMap{
	"DestIpRanges":   ubx.FieldSpec{WireName: "dest_ip_ranges"},
...
var AlphaSecurityPolicy_Rules_PreconfiguredWafConfig_Exclusions_RequestBodiesToExcludeFields = ubx.FieldMap{
	"Op":  ubx.FieldSpec{WireName: "op"},
	"Val": ubx.FieldSpec{WireName: "val"},
}

var AlphaSecurityPolicy_Rules_PreconfiguredWafConfig_ExclusionsFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_Rules_PreconfiguredWafConfigFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_Rules_RateLimitOptions_BanThresholdFields = ubx.FieldMap{
	"Count":       ubx.FieldSpec{WireName: "count"},
	"IntervalSec": ubx.FieldSpec{WireName: "interval_sec"},
}

var AlphaSecurityPolicy_Rules_RateLimitOptions_EnforceOnKeyConfigsFields = ubx.FieldMap{
	"EnforceOnKeyName": ubx.FieldSpec{WireName: "enforce_on_key_name"},
	"EnforceOnKeyType": ubx.FieldSpec{WireName: "enforce_on_key_type"},
}

var AlphaSecurityPolicy_Rules_RateLimitOptions_ExceedActionRpcStatusFields = ubx.FieldMap{
	"Code":    ubx.FieldSpec{WireName: "code"},
	"Message": ubx.FieldSpec{WireName: "message"},
}

var AlphaSecurityPolicy_Rules_RateLimitOptions_ExceedRedirectOptionsFields = ubx.FieldMap{
	"Target": ubx.FieldSpec{WireName: "target"},
	"Type":   ubx.FieldSpec{WireName: "type"},
}

var AlphaSecurityPolicy_Rules_RateLimitOptionsFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_RulesFields = ubx.FieldMap{
...
var AlphaSecurityPolicy_UserDefinedFieldsFields = ubx.FieldMap{
...
type AlphaSecurityPolicyConfig struct {
...
type AlphaSecurityPolicyAttrs struct {
	// Configuration options for Cloud Armor Adaptive Protection (CAAP).
	AdaptiveProtectionConfig any
	AdvancedOptionsConfig    any
	// A list of associations that belong to this policy.
...
var AlphaSecurityPolicy = ubx.ResourceBinding{
