...
type AlphaComputeAlphaRoute_AsPaths struct {
	AsLists any
	PathSegmentType any
}

type AlphaComputeAlphaRoute_Params struct {
...
type AlphaComputeAlphaRoute_Warnings_Data struct {
	Key any
	Value any
}

type AlphaComputeAlphaRoute_Warnings struct {
	Code any
	Data any
	Message any
}

var AlphaComputeAlphaRoute_AsPathsFields = ubx.FieldMap{
		"AsLists": ubx.FieldSpec{WireName: "as_lists"},
		"PathSegmentType": ubx.FieldSpec{WireName: "path_segment_type"},
	}

var AlphaComputeAlphaRoute_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaComputeAlphaRoute_Warnings_DataFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var AlphaComputeAlphaRoute_WarningsFields = ubx.FieldMap{
...
type AlphaComputeAlphaRouteConfig struct {
...
type AlphaComputeAlphaRouteAttrs struct {
	// Whether this route can conflict with existing subnetworks. Setting this to true allows this route to conflict with subnetworks that have already been configured on the corresponding network.
	AllowConflictingSubnetworks any
	// Output only. [Output Only] AS path.
	AsPaths any
...
var AlphaComputeAlphaRoute = ubx.ResourceBinding{
