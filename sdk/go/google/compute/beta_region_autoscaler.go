...
type BetaRegionAutoscaler_AutoscalingPolicy_CpuUtilization struct {
...
type BetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas struct {
...
type BetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl struct {
...
type BetaRegionAutoscaler_AutoscalingPolicy_ScaleInControl struct {
	// Encapsulates numeric value that can be either absolute or relative.
...
var BetaRegionAutoscaler_ScalingScheduleStatusFields = ubx.FieldMap{
...
type BetaRegionAutoscalerAttrs struct {
	// Cloud Autoscaler policy.
	AutoscalingPolicy any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var BetaRegionAutoscaler = ubx.ResourceBinding{
