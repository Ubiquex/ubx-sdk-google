...
type AlphaComputeAlphaFirewall_Allowed struct {
	Ipprotocol any
	Ports any
}

type AlphaComputeAlphaFirewall_LogConfig struct {
...
type AlphaComputeAlphaFirewall_Params struct {
...
var AlphaComputeAlphaFirewall_AllowedFields = ubx.FieldMap{
		"Ipprotocol": ubx.FieldSpec{WireName: "ipprotocol"},
		"Ports": ubx.FieldSpec{WireName: "ports"},
	}

var AlphaComputeAlphaFirewall_LogConfigFields = ubx.FieldMap{
		"Enable": ubx.FieldSpec{WireName: "enable"},
		"Metadata": ubx.FieldSpec{WireName: "metadata"},
	}

var AlphaComputeAlphaFirewall_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

type AlphaComputeAlphaFirewallConfig struct {
...
type AlphaComputeAlphaFirewallAttrs struct {
	// The list of ALLOW rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a permitted connection.
	Allowed any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var AlphaComputeAlphaFirewall = ubx.ResourceBinding{
