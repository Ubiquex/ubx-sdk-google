...
type BetaComputeBetaPublicAdvertisedPrefix_PublicDelegatedPrefixs struct {
	IpRange any
	Name any
	Project any
	Region any
...
var BetaComputeBetaPublicAdvertisedPrefix_PublicDelegatedPrefixsFields = ubx.FieldMap{
...
type BetaComputeBetaPublicAdvertisedPrefixConfig struct {
...
type BetaComputeBetaPublicAdvertisedPrefixAttrs struct {
	// Output only. [Output Only] The version of BYOIP API.
	ByoipApiVersion any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var BetaComputeBetaPublicAdvertisedPrefix = ubx.ResourceBinding{
