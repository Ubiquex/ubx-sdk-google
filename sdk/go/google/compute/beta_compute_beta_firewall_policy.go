...
type BetaComputeBetaFirewallPolicy_Associations struct {
...
type BetaComputeBetaFirewallPolicy_PacketMirroringRules_Match_Layer4Configs struct {
	IpProtocol any
	Ports any
}

type BetaComputeBetaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags struct {
	Name any
	State any
}

type BetaComputeBetaFirewallPolicy_PacketMirroringRules_Match struct {
...
type BetaComputeBetaFirewallPolicy_PacketMirroringRules struct {
	Action any
	Description any
	Direction any
	Disabled any
...
var BetaComputeBetaFirewallPolicy_AssociationsFields = ubx.FieldMap{
...
var BetaComputeBetaFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields = ubx.FieldMap{
		"IpProtocol": ubx.FieldSpec{WireName: "ip_protocol"},
		"Ports": ubx.FieldSpec{WireName: "ports"},
	}

var BetaComputeBetaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"State": ubx.FieldSpec{WireName: "state"},
	}

var BetaComputeBetaFirewallPolicy_PacketMirroringRules_MatchFields = ubx.FieldMap{
...
var BetaComputeBetaFirewallPolicy_PacketMirroringRulesFields = ubx.FieldMap{
...
type BetaComputeBetaFirewallPolicyConfig struct {
...
type BetaComputeBetaFirewallPolicyAttrs struct {
	// A list of associations that belong to this firewall policy.
	Associations any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var BetaComputeBetaFirewallPolicy = ubx.ResourceBinding{
