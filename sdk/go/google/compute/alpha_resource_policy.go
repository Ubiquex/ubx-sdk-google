...
type AlphaResourcePolicy_GroupPlacementPolicy struct {
...
type AlphaResourcePolicy_InstanceSchedulePolicy_VmStartSchedule struct {
	// Specifies the frequency for the operation, using the unix-cron format.
	Schedule any
}

type AlphaResourcePolicy_InstanceSchedulePolicy struct {
...
type AlphaResourcePolicy_ResourceStatus_InstanceSchedulePolicy struct {
...
type AlphaResourcePolicy_ResourceStatus struct {
...
type AlphaResourcePolicy_SnapshotSchedulePolicy_Schedule_DailySchedule struct {
...
type AlphaResourcePolicy_SnapshotSchedulePolicy_Schedule_HourlySchedule struct {
...
type AlphaResourcePolicy_SnapshotSchedulePolicy_Schedule_WeeklySchedule struct {
	// Up to 7 intervals/windows, one for each day of the week.
	DayOfWeeks any
}

type AlphaResourcePolicy_SnapshotSchedulePolicy_Schedule struct {
...
type AlphaResourcePolicy_SnapshotSchedulePolicy_SnapshotProperties struct {
...
type AlphaResourcePolicy_SnapshotSchedulePolicy struct {
...
type AlphaResourcePolicy_VmMaintenancePolicy_ConcurrencyControlGroup struct {
	ConcurrencyLimit any
}

type AlphaResourcePolicy_VmMaintenancePolicy_MaintenanceWindow struct {
	// Time window specified for daily operations.
	DailyMaintenanceWindow any
}

type AlphaResourcePolicy_VmMaintenancePolicy struct {
...
type AlphaResourcePolicy_WorkloadPolicy struct {
