...
type AlphaComputeAlphaRegionInstantSnapshotGroup_ResourceStatus_SourceInfo struct {
	ConsistencyGroup any
	ConsistencyGroupId any
}

type AlphaComputeAlphaRegionInstantSnapshotGroup_ResourceStatus struct {
	// Output only. [Output Only]
	ConsistencyMembershipResolutionTime any
	SourceInfo any
}

var AlphaComputeAlphaRegionInstantSnapshotGroup_ResourceStatus_SourceInfoFields = ubx.FieldMap{
		"ConsistencyGroup": ubx.FieldSpec{WireName: "consistency_group"},
		"ConsistencyGroupId": ubx.FieldSpec{WireName: "consistency_group_id"},
	}

var AlphaComputeAlphaRegionInstantSnapshotGroup_ResourceStatusFields = ubx.FieldMap{
...
type AlphaComputeAlphaRegionInstantSnapshotGroupConfig struct {
...
type AlphaComputeAlphaRegionInstantSnapshotGroupAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// Optional. An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaComputeAlphaRegionInstantSnapshotGroup = ubx.ResourceBinding{
