...
type AlphaVpnGateway_Params struct {
...
type AlphaVpnGateway_VpnInterfaces struct {
	Id any
...
var AlphaVpnGateway_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaVpnGateway_VpnInterfacesFields = ubx.FieldMap{
...
type AlphaVpnGatewayConfig struct {
...
type AlphaVpnGatewayAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaVpnGateway = ubx.ResourceBinding{
