...
type AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_CertificatePaths struct {
...
type AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPlugin struct {
	// Plugin name.
	Name any
...
type AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials struct {
...
type AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentials struct {
...
type AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig struct {
...
type AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig struct {
	// [Deprecated] gRPC config to access the SDS server. gRPC config to access the SDS server.
	GrpcServiceConfig any
}

type AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext struct {
	// [Deprecated] The paths to the mounted TLS Certificates and private key. The paths to the mounted TLS Certificates and private key.
...
type AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_ValidationContext struct {
...
type AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext struct {
...
type AlphaRegionSslPolicy_TlsSettings struct {
...
var AlphaRegionSslPolicy_Warnings_DataFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var AlphaRegionSslPolicy_WarningsFields = ubx.FieldMap{
...
type AlphaRegionSslPolicyAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// A list of features enabled when the selected profile is CUSTOM. The method returns the set of features that can be specified in this list. This field must be empty if the profile is notCUSTOM.
	CustomFeatures any
