...
type AlphaNodeGroup_AutoscalingPolicy struct {
...
type AlphaNodeGroup_MaintenanceWindow_MaintenanceDuration struct {
...
type AlphaNodeGroup_MaintenanceWindow struct {
...
type AlphaNodeGroup_ShareSettings_FolderMap struct {
	FolderId any
}

type AlphaNodeGroup_ShareSettings_ProjectMap struct {
	ProjectId any
}

type AlphaNodeGroup_ShareSettings struct {
...
var AlphaNodeGroup = ubx.ResourceBinding{
