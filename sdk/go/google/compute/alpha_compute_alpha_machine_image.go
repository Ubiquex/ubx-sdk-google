...
type AlphaComputeAlphaMachineImage_InstanceProperties_AdvancedMachineFeatures struct {
...
type AlphaComputeAlphaMachineImage_InstanceProperties_ConfidentialInstanceConfig_ConfidentialParavisorConfig struct {
	ConfidentialTpmType any
	SevSnpIrqMode any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_ConfidentialInstanceConfig struct {
...
type AlphaComputeAlphaMachineImage_InstanceProperties_Disks_DiskEncryptionKey struct {
	KmsKeyName any
...
type AlphaComputeAlphaMachineImage_InstanceProperties_Disks_GuestOsFeatures struct {
	Type any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_Disks_InitializeParams struct {
	Architecture any
	Description any
	DiskName any
	DiskSizeGb any
...
type AlphaComputeAlphaMachineImage_InstanceProperties_Disks_ShieldedInstanceInitialState_Dbs struct {
	Content any
	FileType any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_Disks_ShieldedInstanceInitialState struct {
	Dbs any
	Dbxs any
	Keks any
	Pk any
...
type AlphaComputeAlphaMachineImage_InstanceProperties_Disks struct {
	Architecture any
	AutoDelete any
	Boot any
	DeviceName any
...
type AlphaComputeAlphaMachineImage_InstanceProperties_DisplayDevice struct {
	// Defines whether the instance has Display enabled.
	EnableDisplay any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_GuestAccelerators struct {
	AcceleratorCount any
	AcceleratorType any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_Metadata_Items struct {
	Key any
	Value any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_Metadata struct {
...
type AlphaComputeAlphaMachineImage_InstanceProperties_NetworkInterfaces_AccessConfigs struct {
	ExternalIpv6 any
...
type AlphaComputeAlphaMachineImage_InstanceProperties_NetworkInterfaces_AliasIpRanges struct {
...
type AlphaComputeAlphaMachineImage_InstanceProperties_NetworkInterfaces_Subinterfaces struct {
	IpAddress any
...
type AlphaComputeAlphaMachineImage_InstanceProperties_NetworkInterfaces struct {
	AccessConfigs any
	AliasIpRanges any
	AliasIpv6Ranges any
	Dns64Eligible any
...
type AlphaComputeAlphaMachineImage_InstanceProperties_NetworkPerformanceConfig struct {
	ExternalIpEgressBandwidthTier any
	TotalEgressBandwidthTier any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_PartnerMetadata struct {
	Entries any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_ReservationAffinity struct {
...
type AlphaComputeAlphaMachineImage_InstanceProperties_Scheduling_GracefulShutdown_MaxDuration struct {
...
type AlphaComputeAlphaMachineImage_InstanceProperties_Scheduling_GracefulShutdown struct {
...
type AlphaComputeAlphaMachineImage_InstanceProperties_Scheduling_NodeAffinities struct {
	Key any
	Operator any
	Values any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_Scheduling_OnInstanceStopAction struct {
...
type AlphaComputeAlphaMachineImage_InstanceProperties_Scheduling_VsockMode struct {
	Mode any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_Scheduling struct {
...
type AlphaComputeAlphaMachineImage_InstanceProperties_ServiceAccounts struct {
	Email any
	Scopes any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_ServiceIntegrationSpecs_BackupDr struct {
	Plan any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_ServiceIntegrationSpecs struct {
	BackupDr any
}

type AlphaComputeAlphaMachineImage_InstanceProperties_ShieldedInstanceConfig struct {
...
type AlphaComputeAlphaMachineImage_InstanceProperties_Tags struct {
...
type AlphaComputeAlphaMachineImage_InstanceProperties_WorkloadIdentityConfig struct {
	Identity any
	IdentityCertificateEnabled any
	IdentityType any
}

type AlphaComputeAlphaMachineImage_InstanceProperties struct {
...
type AlphaComputeAlphaMachineImage_Params struct {
...
type AlphaComputeAlphaMachineImage_SavedDisks struct {
	Architecture any
	Kind any
	SourceDisk any
	StorageBytes any
...
type AlphaComputeAlphaMachineImage_SourceDiskEncryptionKeys struct {
	DiskEncryptionKey any
	SourceDisk any
}

type AlphaComputeAlphaMachineImage_SourceInstanceProperties_Disks struct {
	AutoDelete any
	Boot any
	DeviceName any
	DiskEncryptionKey any
...
type AlphaComputeAlphaMachineImage_SourceInstanceProperties struct {
...
var AlphaComputeAlphaMachineImage_InstanceProperties_AdvancedMachineFeaturesFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_ConfidentialInstanceConfig_ConfidentialParavisorConfigFields = ubx.FieldMap{
		"ConfidentialTpmType": ubx.FieldSpec{WireName: "confidential_tpm_type"},
		"SevSnpIrqMode": ubx.FieldSpec{WireName: "sev_snp_irq_mode"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_ConfidentialInstanceConfigFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_Disks_DiskEncryptionKeyFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_Disks_GuestOsFeaturesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_Disks_InitializeParamsFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_Disks_ShieldedInstanceInitialState_DbsFields = ubx.FieldMap{
		"Content": ubx.FieldSpec{WireName: "content"},
		"FileType": ubx.FieldSpec{WireName: "file_type"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_Disks_ShieldedInstanceInitialStateFields = ubx.FieldMap{
		"Dbs": ubx.FieldSpec{
			WireName: "dbs",
			Kind: "list",
...
var AlphaComputeAlphaMachineImage_InstanceProperties_DisksFields = ubx.FieldMap{
		"Architecture": ubx.FieldSpec{WireName: "architecture"},
...
var AlphaComputeAlphaMachineImage_InstanceProperties_DisplayDeviceFields = ubx.FieldMap{
		"EnableDisplay": ubx.FieldSpec{WireName: "enable_display"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_GuestAcceleratorsFields = ubx.FieldMap{
		"AcceleratorCount": ubx.FieldSpec{WireName: "accelerator_count"},
		"AcceleratorType": ubx.FieldSpec{WireName: "accelerator_type"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_Metadata_ItemsFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_MetadataFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_NetworkInterfaces_AccessConfigsFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_NetworkInterfaces_AliasIpRangesFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_NetworkInterfaces_SubinterfacesFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_NetworkInterfacesFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_NetworkPerformanceConfigFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_PartnerMetadataFields = ubx.FieldMap{
		"Entries": ubx.FieldSpec{WireName: "entries"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_ReservationAffinityFields = ubx.FieldMap{
		"ConsumeReservationType": ubx.FieldSpec{WireName: "consume_reservation_type"},
		"Key": ubx.FieldSpec{WireName: "key"},
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_Scheduling_GracefulShutdown_MaxDurationFields = ubx.FieldMap{
		"Nanos": ubx.FieldSpec{WireName: "nanos"},
		"Seconds": ubx.FieldSpec{WireName: "seconds"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_Scheduling_GracefulShutdownFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_Scheduling_NodeAffinitiesFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Operator": ubx.FieldSpec{WireName: "operator"},
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_Scheduling_OnInstanceStopActionFields = ubx.FieldMap{
		"DiscardLocalSsd": ubx.FieldSpec{WireName: "discard_local_ssd"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_Scheduling_VsockModeFields = ubx.FieldMap{
		"Mode": ubx.FieldSpec{WireName: "mode"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_SchedulingFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_ServiceAccountsFields = ubx.FieldMap{
		"Email": ubx.FieldSpec{WireName: "email"},
		"Scopes": ubx.FieldSpec{WireName: "scopes"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_ServiceIntegrationSpecs_BackupDrFields = ubx.FieldMap{
		"Plan": ubx.FieldSpec{WireName: "plan"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_ServiceIntegrationSpecsFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_ShieldedInstanceConfigFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstanceProperties_TagsFields = ubx.FieldMap{
		"Fingerprint": ubx.FieldSpec{WireName: "fingerprint"},
		"Items": ubx.FieldSpec{WireName: "items"},
	}

var AlphaComputeAlphaMachineImage_InstanceProperties_WorkloadIdentityConfigFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_InstancePropertiesFields = ubx.FieldMap{
...
var AlphaComputeAlphaMachineImage_ParamsFields = ubx.FieldMap{
		"ExcludedDisks": ubx.FieldSpec{WireName: "excluded_disks"},
		"IncludedDisks": ubx.FieldSpec{WireName: "included_disks"},
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaComputeAlphaMachineImage_SavedDisksFields = ubx.FieldMap{
		"Architecture": ubx.FieldSpec{WireName: "architecture"},
		"Kind": ubx.FieldSpec{WireName: "kind"},
...
var AlphaComputeAlphaMachineImage_SourceDiskEncryptionKeysFields = ubx.FieldMap{
		"DiskEncryptionKey": ubx.FieldSpec{
			WireName: "disk_encryption_key",
			Kind: "object",
			Fields: AlphaComputeAlphaMachineImage_InstanceProperties_Disks_DiskEncryptionKeyFields,
...
var AlphaComputeAlphaMachineImage_SourceInstanceProperties_DisksFields = ubx.FieldMap{
		"AutoDelete": ubx.FieldSpec{WireName: "auto_delete"},
		"Boot": ubx.FieldSpec{WireName: "boot"},
		"DeviceName": ubx.FieldSpec{WireName: "device_name"},
		"DiskEncryptionKey": ubx.FieldSpec{
...
var AlphaComputeAlphaMachineImage_SourceInstancePropertiesFields = ubx.FieldMap{
		"CanIpForward": ubx.FieldSpec{WireName: "can_ip_forward"},
...
type AlphaComputeAlphaMachineImageConfig struct {
...
type AlphaComputeAlphaMachineImageAttrs struct {
	// Output only. [Output Only] The creation timestamp for this machine image inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaComputeAlphaMachineImage = ubx.ResourceBinding{
