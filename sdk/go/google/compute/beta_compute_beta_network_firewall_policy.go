...
type BetaComputeBetaNetworkFirewallPolicy_Associations struct {
...
type BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs struct {
	IpProtocol any
	Ports any
}

type BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags struct {
	Name any
	State any
}

type BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match struct {
...
type BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules struct {
	Action any
	Description any
	Direction any
	Disabled any
...
var BetaComputeBetaNetworkFirewallPolicy_AssociationsFields = ubx.FieldMap{
...
var BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields = ubx.FieldMap{
		"IpProtocol": ubx.FieldSpec{WireName: "ip_protocol"},
		"Ports": ubx.FieldSpec{WireName: "ports"},
	}

var BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"State": ubx.FieldSpec{WireName: "state"},
	}

var BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_MatchFields = ubx.FieldMap{
...
var BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRulesFields = ubx.FieldMap{
...
type BetaComputeBetaNetworkFirewallPolicyConfig struct {
...
type BetaComputeBetaNetworkFirewallPolicyAttrs struct {
	// A list of associations that belong to this firewall policy.
	Associations any
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var BetaComputeBetaNetworkFirewallPolicy = ubx.ResourceBinding{
