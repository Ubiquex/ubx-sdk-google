...
type AlphaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders struct {
	HeaderName any
}

type AlphaRegionBackendBucket_CdnPolicy_CacheKeyPolicy struct {
...
type AlphaRegionBackendBucket_CdnPolicy_NegativeCachingPolicy struct {
	Code any
	Ttl any
}

type AlphaRegionBackendBucket_CdnPolicy struct {
...
type AlphaRegionBackendBucket_Params struct {
...
type AlphaRegionBackendBucket_UsedBy struct {
	Reference any
}

var AlphaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeadersFields = ubx.FieldMap{
		"HeaderName": ubx.FieldSpec{WireName: "header_name"},
	}

var AlphaRegionBackendBucket_CdnPolicy_CacheKeyPolicyFields = ubx.FieldMap{
...
var AlphaRegionBackendBucket_CdnPolicy_NegativeCachingPolicyFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Ttl": ubx.FieldSpec{WireName: "ttl"},
	}

var AlphaRegionBackendBucket_CdnPolicyFields = ubx.FieldMap{
...
var AlphaRegionBackendBucket_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

var AlphaRegionBackendBucket_UsedByFields = ubx.FieldMap{
		"Reference": ubx.FieldSpec{WireName: "reference"},
	}

type AlphaRegionBackendBucketConfig struct {
...
type AlphaRegionBackendBucketAttrs struct {
	// Cloud Storage bucket name.
	BucketName any
	// Message containing Cloud CDN configuration for a backend bucket.
	CdnPolicy any
...
var AlphaRegionBackendBucket = ubx.ResourceBinding{
