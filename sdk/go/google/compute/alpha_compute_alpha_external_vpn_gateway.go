...
type AlphaComputeAlphaExternalVpnGateway_Interfaces struct {
	Id any
	IpAddress any
	Ipv6Address any
}

type AlphaComputeAlphaExternalVpnGateway_Params struct {
...
var AlphaComputeAlphaExternalVpnGateway_InterfacesFields = ubx.FieldMap{
		"Id": ubx.FieldSpec{WireName: "id"},
		"IpAddress": ubx.FieldSpec{WireName: "ip_address"},
		"Ipv6Address": ubx.FieldSpec{WireName: "ipv6_address"},
	}

var AlphaComputeAlphaExternalVpnGateway_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

type AlphaComputeAlphaExternalVpnGatewayConfig struct {
...
type AlphaComputeAlphaExternalVpnGatewayAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var AlphaComputeAlphaExternalVpnGateway = ubx.ResourceBinding{
