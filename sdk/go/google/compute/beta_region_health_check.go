...
type BetaRegionHealthCheck_GrpcHealthCheck struct {
...
type BetaRegionHealthCheck_GrpcTlsHealthCheck struct {
	// The gRPC service name for the health check. This field is optional. The value of grpc_service_name has the following meanings by convention: - Empty service_name means the overall status of all services at the backend. - Non-empty service_name means the health of that gRPC service, as defined by the owner of the service. The grpc_service_name can only be ASCII.
	GrpcServiceName any
	// The TCP port number to which the health check prober sends packets. Valid values are 1 through 65535.
	Port any
...
type BetaRegionHealthCheck_Http2HealthCheck struct {
...
type BetaRegionHealthCheck_LogConfig struct {
	// Indicates whether or not to export logs. This is false by default, which means no health check logging will be done.
	Enable any
}

type BetaRegionHealthCheck_SslHealthCheck struct {
	// The TCP port number to which the health check prober sends packets. The default value is 443. Valid values are 1 through65535.
	Port any
	// Not supported.
	PortName any
...
var BetaRegionHealthCheck_GrpcHealthCheckFields = ubx.FieldMap{
...
var BetaRegionHealthCheck_GrpcTlsHealthCheckFields = ubx.FieldMap{
	"GrpcServiceName":   ubx.FieldSpec{WireName: "grpc_service_name"},
	"Port":              ubx.FieldSpec{WireName: "port"},
	"PortSpecification": ubx.FieldSpec{WireName: "port_specification"},
}

var BetaRegionHealthCheck_Http2HealthCheckFields = ubx.FieldMap{
...
var BetaRegionHealthCheck_LogConfigFields = ubx.FieldMap{
	"Enable": ubx.FieldSpec{WireName: "enable"},
}

var BetaRegionHealthCheck_SslHealthCheckFields = ubx.FieldMap{
	"Port":              ubx.FieldSpec{WireName: "port"},
	"PortName":          ubx.FieldSpec{WireName: "port_name"},
	"PortSpecification": ubx.FieldSpec{WireName: "port_specification"},
	"ProxyHeader":       ubx.FieldSpec{WireName: "proxy_header"},
...
type BetaRegionHealthCheckConfig struct {
...
type BetaRegionHealthCheckAttrs struct {
	// How often (in seconds) to send a health check. The default value is 5 seconds.
	CheckIntervalSec any
...
var BetaRegionHealthCheck = ubx.ResourceBinding{
