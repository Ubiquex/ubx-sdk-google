...
type BetaComputeBetaRegionInstantSnapshotGroup_ResourceStatus_SourceInfo struct {
	ConsistencyGroup any
	ConsistencyGroupId any
}

type BetaComputeBetaRegionInstantSnapshotGroup_ResourceStatus struct {
	// Output only. [Output Only]
	ConsistencyMembershipResolutionTime any
	SourceInfo any
}

var BetaComputeBetaRegionInstantSnapshotGroup_ResourceStatus_SourceInfoFields = ubx.FieldMap{
		"ConsistencyGroup": ubx.FieldSpec{WireName: "consistency_group"},
		"ConsistencyGroupId": ubx.FieldSpec{WireName: "consistency_group_id"},
	}

var BetaComputeBetaRegionInstantSnapshotGroup_ResourceStatusFields = ubx.FieldMap{
...
type BetaComputeBetaRegionInstantSnapshotGroupConfig struct {
...
type BetaComputeBetaRegionInstantSnapshotGroupAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
	// Optional. An optional description of this resource. Provide this property when you create the resource.
	Description any
...
var BetaComputeBetaRegionInstantSnapshotGroup = ubx.ResourceBinding{
