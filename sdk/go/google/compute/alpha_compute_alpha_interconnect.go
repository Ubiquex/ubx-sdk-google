...
type AlphaComputeAlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages struct {
	Percentage any
	TrafficClass any
}

type AlphaComputeAlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy struct {
	// Specify bandwidth percentages for various traffic classes for queuing type Bandwidth Percent.
	BandwidthPercentages any
}

type AlphaComputeAlphaInterconnect_ApplicationAwareInterconnect struct {
...
type AlphaComputeAlphaInterconnect_CircuitInfos struct {
	CustomerDemarcId any
	GoogleCircuitId any
	GoogleDemarcId any
}

type AlphaComputeAlphaInterconnect_ExpectedOutages struct {
...
type AlphaComputeAlphaInterconnect_Macsec_PreSharedKeys struct {
	Name any
	StartTime any
}

type AlphaComputeAlphaInterconnect_Macsec struct {
...
type AlphaComputeAlphaInterconnect_Params struct {
...
var AlphaComputeAlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentagesFields = ubx.FieldMap{
		"Percentage": ubx.FieldSpec{WireName: "percentage"},
		"TrafficClass": ubx.FieldSpec{WireName: "traffic_class"},
	}

var AlphaComputeAlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicyFields = ubx.FieldMap{
...
var AlphaComputeAlphaInterconnect_ApplicationAwareInterconnectFields = ubx.FieldMap{
...
var AlphaComputeAlphaInterconnect_CircuitInfosFields = ubx.FieldMap{
...
var AlphaComputeAlphaInterconnect_ExpectedOutagesFields = ubx.FieldMap{
...
var AlphaComputeAlphaInterconnect_Macsec_PreSharedKeysFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"StartTime": ubx.FieldSpec{WireName: "start_time"},
	}

var AlphaComputeAlphaInterconnect_MacsecFields = ubx.FieldMap{
...
var AlphaComputeAlphaInterconnect_ParamsFields = ubx.FieldMap{
		"ResourceManagerTags": ubx.FieldSpec{WireName: "resource_manager_tags"},
	}

type AlphaComputeAlphaInterconnectConfig struct {
...
type AlphaComputeAlphaInterconnectAttrs struct {
	// Enable or disable the application awareness feature on this Cloud Interconnect.
	AaiEnabled any
	// Administrative status of the interconnect. When this is set to true, the Interconnect is functional and can carry traffic. When set to false, no packets can be carried over the interconnect and no BGP routes are exchanged over it. By default, the status is set to true.
	AdminEnabled any
...
var AlphaComputeAlphaInterconnect = ubx.ResourceBinding{
