...
type BigqueryRowAccessPolicy_RowAccessPolicyReference struct {
...
var BigqueryRowAccessPolicy_RowAccessPolicyReferenceFields = ubx.FieldMap{
...
type BigqueryRowAccessPolicyAttrs struct {
	// Output only. The time when this row access policy was created, in milliseconds since the epoch.
	CreationTime any
	// Output only. A hash of this resource.
	Etag any
...
var BigqueryRowAccessPolicy = ubx.ResourceBinding{
