...
type NetworksecurityMirroringEndpointGroupAssociation_Locations struct {
	Location any
	State any
}

var NetworksecurityMirroringEndpointGroupAssociation_LocationsFields = ubx.FieldMap{
...
type NetworksecurityMirroringEndpointGroupAssociationAttrs struct {
	// Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
	CreateTime any
	// Optional. Labels are key/value pairs that help to organize and filter resources.
	Labels any
...
var NetworksecurityMirroringEndpointGroupAssociation = ubx.ResourceBinding{
