...
type V1beta1NetworksecurityV1beta1SacAttachment_SymantecOptions struct {
...
var V1beta1NetworksecurityV1beta1SacAttachment_SymantecOptionsFields = ubx.FieldMap{
		"SymantecLocationName": ubx.FieldSpec{WireName: "symantec_location_name"},
		"SymantecSite": ubx.FieldSpec{WireName: "symantec_site"},
	}

type V1beta1NetworksecurityV1beta1SacAttachmentConfig struct {
...
type V1beta1NetworksecurityV1beta1SacAttachmentAttrs struct {
	// Optional. Case-insensitive ISO-3166 alpha-2 country code used for localization. Only valid for Symantec attachments.
	Country any
	// Output only. Timestamp when the attachment was created.
	CreateTime any
...
var V1beta1NetworksecurityV1beta1SacAttachment = ubx.ResourceBinding{
