...
type NetworksecurityInterceptEndpointGroupAssociation_Locations struct {
	Location any
	State any
}

var NetworksecurityInterceptEndpointGroupAssociation_LocationsFields = ubx.FieldMap{
...
type NetworksecurityInterceptEndpointGroupAssociationAttrs struct {
	// Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
	CreateTime any
	// Required. Immutable. The endpoint group that this association is connected to, for example: `projects/123456789/locations/global/interceptEndpointGroups/my-eg`. See https://google.aip.dev/124.
	InterceptEndpointGroup any
...
var NetworksecurityInterceptEndpointGroupAssociation = ubx.ResourceBinding{
