...
var V1beta1InterceptEndpointGroup_AssociationsFields = ubx.FieldMap{
...
type V1beta1InterceptEndpointGroupAttrs struct {
	// Output only. List of associations to this endpoint group.
	Associations any
	// The endpoint group's view of a connected deployment group.
	ConnectedDeploymentGroup any
...
var V1beta1InterceptEndpointGroup = ubx.ResourceBinding{
