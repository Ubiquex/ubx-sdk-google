...
type NetworksecurityInterceptDeploymentGroup_ConnectedEndpointGroups struct {
	Name any
}

type NetworksecurityInterceptDeploymentGroup_Locations struct {
	Location any
	State any
}

type NetworksecurityInterceptDeploymentGroup_NestedDeployments struct {
	Name any
	State any
}

var NetworksecurityInterceptDeploymentGroup_ConnectedEndpointGroupsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var NetworksecurityInterceptDeploymentGroup_LocationsFields = ubx.FieldMap{
		"Location": ubx.FieldSpec{WireName: "location"},
		"State": ubx.FieldSpec{WireName: "state"},
	}

var NetworksecurityInterceptDeploymentGroup_NestedDeploymentsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"State": ubx.FieldSpec{WireName: "state"},
	}
...
type NetworksecurityInterceptDeploymentGroupAttrs struct {
	// Output only. The list of endpoint groups that are connected to this resource.
	ConnectedEndpointGroups any
	// Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
	CreateTime any
...
var NetworksecurityInterceptDeploymentGroup = ubx.ResourceBinding{
