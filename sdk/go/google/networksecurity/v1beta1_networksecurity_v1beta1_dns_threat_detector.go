...
type V1beta1NetworksecurityV1beta1DnsThreatDetectorConfig struct {
...
type V1beta1NetworksecurityV1beta1DnsThreatDetectorAttrs struct {
	// Output only. Create time stamp.
	CreateTime any
	// Optional. A list of network resource names which aren't monitored by this DnsThreatDetector. Example: `projects/PROJECT_ID/global/networks/NETWORK_NAME`.
	ExcludedNetworks any
...
var V1beta1NetworksecurityV1beta1DnsThreatDetector = ubx.ResourceBinding{
