...
type V1beta1NetworksecurityV1beta1GatewaySecurityPolicyConfig struct {
...
type V1beta1NetworksecurityV1beta1GatewaySecurityPolicyAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. Free-text description of the resource.
	Description any
...
var V1beta1NetworksecurityV1beta1GatewaySecurityPolicy = ubx.ResourceBinding{
