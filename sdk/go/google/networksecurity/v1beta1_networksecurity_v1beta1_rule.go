...
type V1beta1NetworksecurityV1beta1RuleConfig struct {
...
type V1beta1NetworksecurityV1beta1RuleAttrs struct {
	// Optional. CEL expression for matching on L7/application level criteria.
	ApplicationMatcher any
	// Required. Profile which tells what the primitive action should be.
	BasicProfile any
...
var V1beta1NetworksecurityV1beta1Rule = ubx.ResourceBinding{
