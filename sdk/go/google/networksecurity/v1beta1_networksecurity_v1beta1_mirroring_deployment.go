...
type V1beta1NetworksecurityV1beta1MirroringDeploymentConfig struct {
...
type V1beta1NetworksecurityV1beta1MirroringDeploymentAttrs struct {
	// Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
	CreateTime any
	// Optional. User-provided description of the deployment. Used as additional context for the deployment.
	Description any
...
var V1beta1NetworksecurityV1beta1MirroringDeployment = ubx.ResourceBinding{
