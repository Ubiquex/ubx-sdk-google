...
type NetworksecurityMirroringDeploymentGroup_ConnectedEndpointGroups struct {
	Name any
}

type NetworksecurityMirroringDeploymentGroup_Locations struct {
	Location any
	State any
}

type NetworksecurityMirroringDeploymentGroup_NestedDeployments struct {
	Name any
	State any
}

var NetworksecurityMirroringDeploymentGroup_ConnectedEndpointGroupsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var NetworksecurityMirroringDeploymentGroup_LocationsFields = ubx.FieldMap{
		"Location": ubx.FieldSpec{WireName: "location"},
		"State": ubx.FieldSpec{WireName: "state"},
	}

var NetworksecurityMirroringDeploymentGroup_NestedDeploymentsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"State": ubx.FieldSpec{WireName: "state"},
	}
...
type NetworksecurityMirroringDeploymentGroupAttrs struct {
	// Output only. The list of endpoint groups that are connected to this resource.
	ConnectedEndpointGroups any
	// Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
	CreateTime any
...
var NetworksecurityMirroringDeploymentGroup = ubx.ResourceBinding{
