...
type V1beta1NetworksecurityV1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCa_CertificateProviderInstance struct {
	PluginInstance any
}

type V1beta1NetworksecurityV1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCa_GrpcEndpoint struct {
	TargetUri any
}

type V1beta1NetworksecurityV1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCa struct {
	CertificateProviderInstance any
	GrpcEndpoint any
}

type V1beta1NetworksecurityV1beta1ServerTlsPolicy_MtlsPolicy struct {
...
var V1beta1NetworksecurityV1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCa_CertificateProviderInstanceFields = ubx.FieldMap{
		"PluginInstance": ubx.FieldSpec{WireName: "plugin_instance"},
	}

var V1beta1NetworksecurityV1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCa_GrpcEndpointFields = ubx.FieldMap{
		"TargetUri": ubx.FieldSpec{WireName: "target_uri"},
	}

var V1beta1NetworksecurityV1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCaFields = ubx.FieldMap{
...
var V1beta1NetworksecurityV1beta1ServerTlsPolicy_MtlsPolicyFields = ubx.FieldMap{
...
type V1beta1NetworksecurityV1beta1ServerTlsPolicyConfig struct {
...
type V1beta1NetworksecurityV1beta1ServerTlsPolicyAttrs struct {
	// This field applies only for Traffic Director policies. It is must be set to false for Application Load Balancer policies. Determines if server allows plaintext connections. If set to true, server allows plain text connections. By default, it is set to false. This setting is not exclusive of other encryption modes. For example, if `allow_open` and `mtls_policy` are set, server allows both plain text and mTLS connections. See documentation of other encryption modes to confirm compatibility. Consider using it if you wish to upgrade in place your deployment to TLS while having mixed TLS and non-TLS traffic reaching port :80.
	AllowOpen any
	// Output only. The timestamp when the resource was created.
	CreateTime any
...
var V1beta1NetworksecurityV1beta1ServerTlsPolicy = ubx.ResourceBinding{
