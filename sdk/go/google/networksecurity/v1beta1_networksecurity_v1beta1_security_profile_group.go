...
type V1beta1NetworksecurityV1beta1SecurityProfileGroupConfig struct {
...
type V1beta1NetworksecurityV1beta1SecurityProfileGroupAttrs struct {
	// Output only. Resource creation timestamp.
	CreateTime any
	// Optional. Reference to a SecurityProfile with the CustomIntercept configuration.
	CustomInterceptProfile any
...
var V1beta1NetworksecurityV1beta1SecurityProfileGroup = ubx.ResourceBinding{
