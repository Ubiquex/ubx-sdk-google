...
type V1beta1NetworksecurityV1beta1SacRealm_PairingKey struct {
...
type V1beta1NetworksecurityV1beta1SacRealm_SymantecOptions struct {
...
var V1beta1NetworksecurityV1beta1SacRealm_PairingKeyFields = ubx.FieldMap{
		"ExpireTime": ubx.FieldSpec{WireName: "expire_time"},
		"Key": ubx.FieldSpec{WireName: "key"},
	}

var V1beta1NetworksecurityV1beta1SacRealm_SymantecOptionsFields = ubx.FieldMap{
...
type V1beta1NetworksecurityV1beta1SacRealmConfig struct {
...
type V1beta1NetworksecurityV1beta1SacRealmAttrs struct {
	// Output only. Timestamp when the realm was created.
	CreateTime any
	// Optional. Optional list of labels applied to the resource.
	Labels any
...
var V1beta1NetworksecurityV1beta1SacRealm = ubx.ResourceBinding{
