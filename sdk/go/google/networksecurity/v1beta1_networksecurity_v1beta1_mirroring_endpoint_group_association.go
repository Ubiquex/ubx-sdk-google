...
type V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation_Locations struct {
	Location any
	State any
}

var V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation_LocationsFields = ubx.FieldMap{
		"Location": ubx.FieldSpec{WireName: "location"},
		"State": ubx.FieldSpec{WireName: "state"},
	}

type V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociationConfig struct {
...
type V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociationAttrs struct {
	// Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
	CreateTime any
	// Optional. Labels are key/value pairs that help to organize and filter resources.
	Labels any
...
var V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation = ubx.ResourceBinding{
