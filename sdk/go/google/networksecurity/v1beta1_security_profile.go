...
type V1beta1SecurityProfile_CustomInterceptProfile struct {
...
type V1beta1SecurityProfile_CustomMirroringProfile struct {
...
type V1beta1SecurityProfile_WildfireAnalysisProfile_WildfireInlineCloudAnalysisRules_CustomFileTypes struct {
	FileTypes any
}
...
type V1beta1SecurityProfile_WildfireAnalysisProfile_WildfireInlineMlSetting struct {
...
type V1beta1SecurityProfile_WildfireAnalysisProfile struct {
...
type V1beta1SecurityProfileAttrs struct {
	// Output only. Resource creation timestamp.
	CreateTime any
	// CustomInterceptProfile defines in-band integration behavior (intercept). It is used by firewall rules with an APPLY_SECURITY_PROFILE_GROUP action.
	CustomInterceptProfile any
