...
type V3beta1TransitionRouteGroup_TransitionRoutes_TriggerFulfillment_AdvancedSettings_AudioExportGcsDestination struct {
	Uri any
}
...
var V3beta1TransitionRouteGroup = ubx.ResourceBinding{
