...
type DialogflowSecuritySetting_AudioExportSettings struct {
...
type DialogflowSecuritySetting_InsightsExportSettings struct {
	EnableInsightsExport any
}

var DialogflowSecuritySetting_AudioExportSettingsFields = ubx.FieldMap{
...
var DialogflowSecuritySetting_InsightsExportSettingsFields = ubx.FieldMap{
		"EnableInsightsExport": ubx.FieldSpec{WireName: "enable_insights_export"},
	}

type DialogflowSecuritySettingConfig struct {
...
type DialogflowSecuritySettingAttrs struct {
	AudioExportSettings any
	DeidentifyTemplate any
	DisplayName any
	InsightsExportSettings any
...
var DialogflowSecuritySetting = ubx.ResourceBinding{
