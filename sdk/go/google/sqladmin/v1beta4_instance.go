...
type V1beta4Instance_DiskEncryptionConfiguration struct {
...
type V1beta4Instance_DiskEncryptionStatus struct {
...
type V1beta4Instance_GeminiConfig struct {
...
type V1beta4Instance_OnPremisesConfiguration_SourceInstance struct {
...
type V1beta4Instance_OnPremisesConfiguration struct {
...
type V1beta4Instance_OutOfDiskReport struct {
...
type V1beta4Instance_ReplicaConfiguration_MysqlReplicaConfiguration struct {
	// PEM representation of the trusted CA's x509 certificate.
	CaCertificate any
	// PEM representation of the replica's x509 certificate.
	ClientCertificate any
...
type V1beta4Instance_ReplicaConfiguration struct {
...
type V1beta4Instance_ReplicationCluster struct {
...
type V1beta4Instance_ScheduledMaintenance struct {
	CanDefer any
...
type V1beta4Instance_ServerCaCert struct {
	// PEM representation.
	Cert any
...
type V1beta4Instance_Settings_ActiveDirectoryConfig struct {
...
type V1beta4Instance_Settings_AdvancedMachineFeatures struct {
	// The number of threads per physical core.
	ThreadsPerCore any
}

type V1beta4Instance_Settings_BackupConfiguration_BackupRetentionSettings struct {
...
type V1beta4Instance_Settings_BackupConfiguration struct {
...
type V1beta4Instance_Settings_ConnectionPoolConfig struct {
...
type V1beta4Instance_Settings_DataCacheConfig struct {
...
type V1beta4Instance_Settings_FinalBackupConfig struct {
...
type V1beta4Instance_Settings_InsightsConfig struct {
...
type V1beta4Instance_Settings_IpConfiguration struct {
...
type V1beta4Instance_Settings_LocationPreference struct {
...
type V1beta4Instance_Settings_MaintenanceWindow struct {
...
type V1beta4Instance_Settings_PasswordValidationPolicy struct {
...
type V1beta4Instance_Settings_PerformanceCaptureConfig struct {
...
type V1beta4Instance_Settings_ReadPoolAutoScaleConfig struct {
...
type V1beta4Instance_Settings_SqlServerAuditConfig struct {
...
type V1beta4Instance_Settings struct {
...
var V1beta4Instance_DnsNamesFields = ubx.FieldMap{
...
var V1beta4Instance_NodesFields = ubx.FieldMap{
...
var V1beta4Instance_OnPremisesConfiguration_SourceInstanceFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
...
var V1beta4Instance_UpgradableDatabaseVersionsFields = ubx.FieldMap{
...
type V1beta4InstanceAttrs struct {
	// Output only. List all maintenance versions applicable on the instance
	AvailableMaintenanceVersions any
	// The backend type. `SECOND_GEN`: Cloud SQL database instance. `EXTERNAL`: A database server that is not managed by Google. This property is read-only; use the `tier` property in the `settings` object to determine the database type.
	BackendType any
