...
type RecaptchaenterpriseKey_AndroidSettings struct {
...
type RecaptchaenterpriseKey_IosSettings_AppleDeveloperId struct {
...
type RecaptchaenterpriseKey_IosSettings struct {
...
type RecaptchaenterpriseKey_TestingOptions struct {
...
type RecaptchaenterpriseKey_WafSettings struct {
...
type RecaptchaenterpriseKey_WebSettings_ChallengeSettings_ActionSettings struct {
	ScoreThreshold any
}

type RecaptchaenterpriseKey_WebSettings_ChallengeSettings struct {
...
type RecaptchaenterpriseKey_WebSettings struct {
...
var RecaptchaenterpriseKey_AndroidSettingsFields = ubx.FieldMap{
...
var RecaptchaenterpriseKey_IosSettings_AppleDeveloperIdFields = ubx.FieldMap{
		"KeyId": ubx.FieldSpec{WireName: "key_id"},
		"PrivateKey": ubx.FieldSpec{WireName: "private_key"},
		"TeamId": ubx.FieldSpec{WireName: "team_id"},
	}

var RecaptchaenterpriseKey_IosSettingsFields = ubx.FieldMap{
...
var RecaptchaenterpriseKey_TestingOptionsFields = ubx.FieldMap{
		"TestingChallenge": ubx.FieldSpec{WireName: "testing_challenge"},
		"TestingScore": ubx.FieldSpec{WireName: "testing_score"},
	}

var RecaptchaenterpriseKey_WafSettingsFields = ubx.FieldMap{
		"WafFeature": ubx.FieldSpec{WireName: "waf_feature"},
		"WafService": ubx.FieldSpec{WireName: "waf_service"},
	}

var RecaptchaenterpriseKey_WebSettings_ChallengeSettings_ActionSettingsFields = ubx.FieldMap{
		"ScoreThreshold": ubx.FieldSpec{WireName: "score_threshold"},
	}

var RecaptchaenterpriseKey_WebSettings_ChallengeSettingsFields = ubx.FieldMap{
...
var RecaptchaenterpriseKey_WebSettingsFields = ubx.FieldMap{
...
type RecaptchaenterpriseKeyAttrs struct {
	// Settings specific to keys that can be used by Android apps.
	AndroidSettings any
	// Output only. The timestamp corresponding to the creation of this key.
	CreateTime any
...
var RecaptchaenterpriseKey = ubx.ResourceBinding{
