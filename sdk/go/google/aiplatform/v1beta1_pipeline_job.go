...
type V1beta1PipelineJob_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type V1beta1PipelineJob_Error struct {
...
type V1beta1PipelineJob_JobDetail_PipelineContext struct {
...
type V1beta1PipelineJob_PscInterfaceConfig struct {
...
type V1beta1PipelineJob_RuntimeConfig_DefaultRuntime_PersistentResourceRuntimeDetail struct {
...
type V1beta1PipelineJob_RuntimeConfig_DefaultRuntime struct {
...
type V1beta1PipelineJob_RuntimeConfig_InputArtifacts struct {
	ArtifactId any
}

type V1beta1PipelineJob_RuntimeConfig struct {
...
type V1beta1PipelineJob_TemplateMetadata struct {
...
type V1beta1PipelineJobAttrs struct {
...
var V1beta1PipelineJob = ubx.ResourceBinding{
