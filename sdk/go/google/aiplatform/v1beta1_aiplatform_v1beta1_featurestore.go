...
type V1beta1AiplatformV1beta1Featurestore_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type V1beta1AiplatformV1beta1Featurestore_OnlineServingConfig_Scaling struct {
...
type V1beta1AiplatformV1beta1Featurestore_OnlineServingConfig struct {
...
var V1beta1AiplatformV1beta1Featurestore_EncryptionSpecFields = ubx.FieldMap{
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

var V1beta1AiplatformV1beta1Featurestore_OnlineServingConfig_ScalingFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1Featurestore_OnlineServingConfigFields = ubx.FieldMap{
...
type V1beta1AiplatformV1beta1FeaturestoreConfig struct {
...
type V1beta1AiplatformV1beta1FeaturestoreAttrs struct {
	// Output only. Timestamp when this Featurestore was created.
	CreateTime any
	// Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource.
	EncryptionSpec any
...
var V1beta1AiplatformV1beta1Featurestore = ubx.ResourceBinding{
