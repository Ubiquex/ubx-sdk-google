...
type V1beta1CustomJob_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type V1beta1CustomJob_Error struct {
...
type V1beta1CustomJob_JobSpec_BaseOutputDirectory struct {
...
type V1beta1CustomJob_JobSpec_PscInterfaceConfig struct {
...
type V1beta1CustomJob_JobSpec_Scheduling struct {
