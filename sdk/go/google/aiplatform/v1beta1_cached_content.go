...
type V1beta1CachedContent_Contents_Parts_MediaResolution struct {
	Level any
}
...
type V1beta1CachedContent_ToolConfig_FunctionCallingConfig struct {
...
type V1beta1CachedContent_ToolConfig_RetrievalConfig_LatLng struct {
...
type V1beta1CachedContent_ToolConfig_RetrievalConfig struct {
...
type V1beta1CachedContent_ToolConfig struct {
...
type V1beta1CachedContent_Tools_Retrieval_ExternalApi_AuthConfig_HttpBasicAuthConfig struct {
...
type V1beta1CachedContent_Tools_Retrieval_VertexRagStore_RagRetrievalConfig_HybridSearch struct {
	Alpha any
}

type V1beta1CachedContent_Tools_Retrieval_VertexRagStore_RagRetrievalConfig_Ranking_LlmRanker struct {
	ModelName any
}
...
type V1beta1CachedContentAttrs struct {
	// Optional. Input only. Immutable. The content to cache
	Contents any
	// Output only. Creation time of the cache entry.
	CreateTime any
...
var V1beta1CachedContent = ubx.ResourceBinding{
