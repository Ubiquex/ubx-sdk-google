...
type AiplatformFeatureGroup_BigQuery_BigQuerySource struct {
...
type AiplatformFeatureGroup_BigQuery_TimeSeries struct {
...
type AiplatformFeatureGroup_BigQuery struct {
...
var AiplatformFeatureGroup_BigQuery_BigQuerySourceFields = ubx.FieldMap{
		"InputUri": ubx.FieldSpec{WireName: "input_uri"},
	}

var AiplatformFeatureGroup_BigQuery_TimeSeriesFields = ubx.FieldMap{
		"TimestampColumn": ubx.FieldSpec{WireName: "timestamp_column"},
	}

var AiplatformFeatureGroup_BigQueryFields = ubx.FieldMap{
...
type AiplatformFeatureGroupConfig struct {
...
type AiplatformFeatureGroupAttrs struct {
	// Input source type for BigQuery Tables and Views.
	BigQuery any
	// Output only. Timestamp when this FeatureGroup was created.
	CreateTime any
...
var AiplatformFeatureGroup = ubx.ResourceBinding{
