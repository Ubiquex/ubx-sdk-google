...
type V1beta1AiplatformV1beta1EvaluationMetric_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_BleuSpec struct {
	// Optional. Whether to use_effective_order to compute bleu score.
	UseEffectiveOrder any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_ComputationBasedMetricSpec struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_CustomCodeExecutionSpec struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfig_LanguageHints struct {
	// Required. Deprecated: Use top-level `language_codes` instead. BCP-47 language codes. At least one must be specified.
	LanguageCodes any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfig struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig_ImageOutputOptions struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ModelConfig struct {
	// Required. Feature selection preference.
	FeatureSelectionPreference any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_Audio struct {
	BitRate any
	Delivery any
	MimeType any
	SampleRate any
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_Image struct {
	AspectRatio any
	Delivery any
	ImageSize any
	MimeType any
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_Text struct {
	MimeType any
	Schema any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_Video struct {
	AspectRatio any
	Delivery any
	Duration any
	GcsUri any
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat struct {
	Audio any
	Image any
	Text any
	Video any
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseSchema struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_AutoMode struct {
	// The model routing preference.
	ModelRoutingPreference any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_ManualMode struct {
	// The name of the model to use. Only public LLM models are accepted.
	ModelName any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig_PrebuiltVoiceConfig struct {
	VoiceName any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig_ReplicatedVoiceConfig struct {
	MimeType any
	VoiceSampleAudio any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig struct {
	PrebuiltVoiceConfig any
	ReplicatedVoiceConfig any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs struct {
	Speaker any
	VoiceConfig any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig struct {
	// Required. A list of configurations for the voices of the speakers. Exactly two speaker voice configurations must be provided.
	SpeakerVoiceConfigs any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ThinkingConfig struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_PredefinedRubricGenerationSpec struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig_CustomCodeParserConfig struct {
	// Optional. The region to use for code execution. If set, the Code Execution Sandbox will be invoked in the specified region regardless of the request's originating region. Must be a region where the Code Execution Sandbox is available. Supported regions: us-central1, us-east1, us-east4, us-west1, us-west4, southamerica-east1, europe-west2, europe-west3, asia-east1, asia-south1, asia-southeast1. If unset, the request's originating region is used.
	CodeExecutionRegion any
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig struct {
	// Configuration for parsing the LLM response using custom code.
	CustomCodeParserConfig any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_RubricGenerationSpec struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_Metadata_ScoreRange struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_Metadata struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfig struct {
	// Optional. Whether to return raw output.
	ReturnRawOutput any
}

type V1beta1AiplatformV1beta1EvaluationMetric_Metric_PairwiseMetricSpec struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_PointwiseMetricSpec struct {
	// Spec for custom output format configuration.
	CustomOutputFormatConfig any
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric_RougeSpec struct {
...
type V1beta1AiplatformV1beta1EvaluationMetric_Metric struct {
...
var V1beta1AiplatformV1beta1EvaluationMetric_EncryptionSpecFields = ubx.FieldMap{
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_BleuSpecFields = ubx.FieldMap{
		"UseEffectiveOrder": ubx.FieldSpec{WireName: "use_effective_order"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_ComputationBasedMetricSpecFields = ubx.FieldMap{
		"Parameters": ubx.FieldSpec{WireName: "parameters"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_CustomCodeExecutionSpecFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfig_LanguageHintsFields = ubx.FieldMap{
		"LanguageCodes": ubx.FieldSpec{WireName: "language_codes"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig_ImageOutputOptionsFields = ubx.FieldMap{
		"CompressionQuality": ubx.FieldSpec{WireName: "compression_quality"},
		"MimeType": ubx.FieldSpec{WireName: "mime_type"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ModelConfigFields = ubx.FieldMap{
		"FeatureSelectionPreference": ubx.FieldSpec{WireName: "feature_selection_preference"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_AudioFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_ImageFields = ubx.FieldMap{
		"AspectRatio": ubx.FieldSpec{WireName: "aspect_ratio"},
		"Delivery": ubx.FieldSpec{WireName: "delivery"},
		"ImageSize": ubx.FieldSpec{WireName: "image_size"},
		"MimeType": ubx.FieldSpec{WireName: "mime_type"},
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_TextFields = ubx.FieldMap{
		"MimeType": ubx.FieldSpec{WireName: "mime_type"},
		"Schema": ubx.FieldSpec{WireName: "schema"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_VideoFields = ubx.FieldMap{
		"AspectRatio": ubx.FieldSpec{WireName: "aspect_ratio"},
		"Delivery": ubx.FieldSpec{WireName: "delivery"},
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormatFields = ubx.FieldMap{
		"Audio": ubx.FieldSpec{
			WireName: "audio",
			Kind: "object",
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseSchemaFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_AutoModeFields = ubx.FieldMap{
		"ModelRoutingPreference": ubx.FieldSpec{WireName: "model_routing_preference"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_ManualModeFields = ubx.FieldMap{
		"ModelName": ubx.FieldSpec{WireName: "model_name"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig_PrebuiltVoiceConfigFields = ubx.FieldMap{
		"VoiceName": ubx.FieldSpec{WireName: "voice_name"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig_ReplicatedVoiceConfigFields = ubx.FieldMap{
		"MimeType": ubx.FieldSpec{WireName: "mime_type"},
		"VoiceSampleAudio": ubx.FieldSpec{WireName: "voice_sample_audio"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigsFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ThinkingConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_PredefinedRubricGenerationSpecFields = ubx.FieldMap{
		"MetricSpecName": ubx.FieldSpec{WireName: "metric_spec_name"},
		"MetricSpecParameters": ubx.FieldSpec{WireName: "metric_spec_parameters"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig_CustomCodeParserConfigFields = ubx.FieldMap{
		"CodeExecutionRegion": ubx.FieldSpec{WireName: "code_execution_region"},
		"ParsingFunction": ubx.FieldSpec{WireName: "parsing_function"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpec_RubricGenerationSpecFields = ubx.FieldMap{
		"ModelConfig": ubx.FieldSpec{
			WireName: "model_config",
			Kind: "object",
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_LlmBasedMetricSpecFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_Metadata_ScoreRangeFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_MetadataFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfigFields = ubx.FieldMap{
		"ReturnRawOutput": ubx.FieldSpec{WireName: "return_raw_output"},
	}

var V1beta1AiplatformV1beta1EvaluationMetric_Metric_PairwiseMetricSpecFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_PointwiseMetricSpecFields = ubx.FieldMap{
		"CustomOutputFormatConfig": ubx.FieldSpec{
			WireName: "custom_output_format_config",
			Kind: "object",
			Fields: V1beta1AiplatformV1beta1EvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfigFields,
...
var V1beta1AiplatformV1beta1EvaluationMetric_Metric_RougeSpecFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1EvaluationMetric_MetricFields = ubx.FieldMap{
...
type V1beta1AiplatformV1beta1EvaluationMetricConfig struct {
...
type V1beta1AiplatformV1beta1EvaluationMetricAttrs struct {
	// Output only. The time when the EvaluationMetric was created.
	CreateTime any
	// Optional. A description of the EvaluationMetric.
	Description any
...
var V1beta1AiplatformV1beta1EvaluationMetric = ubx.ResourceBinding{
