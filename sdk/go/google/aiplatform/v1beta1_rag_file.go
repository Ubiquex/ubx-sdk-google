...
type V1beta1RagFile_FileStatus struct {
...
type V1beta1RagFile_GcsSource struct {
...
type V1beta1RagFile_GoogleDriveSource struct {
	// Required. Google Drive resource IDs.
	ResourceIds any
}

type V1beta1RagFile_ImportRagFilesConfig_ImportResultBigquerySink struct {
	// Required. BigQuery URI to a project or table, up to 2000 characters long. When only the project is specified, the Dataset and Table is created. When the full table reference is specified, the Dataset must exist and table must not exist. Accepted forms: * BigQuery path. For example: `bq://projectId` or `bq://projectId.bqDatasetId` or `bq://projectId.bqDatasetId.bqTableId`.
	OutputUri any
}

type V1beta1RagFile_ImportRagFilesConfig_ImportResultGcsSink struct {
...
type V1beta1RagFile_ImportRagFilesConfig_RagFileChunkingConfig_FixedLengthChunking struct {
...
type V1beta1RagFile_ImportRagFilesConfig_RagFileChunkingConfig struct {
	// The overlap between chunks.
	ChunkOverlap any
	// The size of the chunks.
	ChunkSize any
...
type V1beta1RagFile_ImportRagFilesConfig_RagFileMetadataConfig struct {
	// The Google Cloud Storage location for the input content.
	GcsMetadataSchemaSource any
	// The Google Cloud Storage location for the input content.
	GcsMetadataSource any
	// The Google Drive location for the input content.
	GoogleDriveMetadataSchemaSource any
	// The Google Drive location for the input content.
	GoogleDriveMetadataSource any
	// Inline metadata schema source. Must be a JSON string.
	InlineMetadataSchemaSource any
	// Inline metadata source. Must be a JSON string.
	InlineMetadataSource any
}

type V1beta1RagFile_ImportRagFilesConfig_RagFileParsingConfig_AdvancedParser struct {
	// Whether to use advanced PDF parsing.
	UseAdvancedPdfParsing any
}

type V1beta1RagFile_ImportRagFilesConfig_RagFileParsingConfig_LayoutParser struct {
...
type V1beta1RagFile_ImportRagFilesConfig_RagFileParsingConfig_LlmParser struct {
...
type V1beta1RagFile_ImportRagFilesConfig_RagFileParsingConfig struct {
...
type V1beta1RagFile_ImportRagFilesConfig_RagFileTransformationConfig struct {
...
type V1beta1RagFile_ImportRagFilesConfig struct {
	// The Google Cloud Storage location for the input content.
	GcsSource any
	...
	GlobalMaxEmbeddingRequestsPerMin any
	// The Google Drive location for the input content.
...
var V1beta1RagFile = ubx.ResourceBinding{
