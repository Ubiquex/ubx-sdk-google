...
type V1beta1AiplatformV1beta1CustomJob_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type V1beta1AiplatformV1beta1CustomJob_Error struct {
...
type V1beta1AiplatformV1beta1CustomJob_JobSpec_BaseOutputDirectory struct {
	// Required. Google Cloud Storage URI to output directory. If the uri doesn't end with '/', a '/' will be automatically appended. The directory is created if it doesn't exist.
	OutputUriPrefix any
}

type V1beta1AiplatformV1beta1CustomJob_JobSpec_PscInterfaceConfig_DnsPeeringConfigs struct {
	Domain any
	TargetNetwork any
	TargetProject any
}

type V1beta1AiplatformV1beta1CustomJob_JobSpec_PscInterfaceConfig struct {
...
type V1beta1AiplatformV1beta1CustomJob_JobSpec_Scheduling struct {
...
type V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec_Env struct {
	Name any
	Value any
}

type V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec struct {
	Args any
	Command any
	Env any
	ImageUri any
...
type V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_DiskSpec struct {
	BootDiskSizeGb any
	BootDiskType any
}

type V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_LustreMounts struct {
	Filesystem any
	InstanceIp any
	MountPoint any
	VolumeHandle any
...
type V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec_ReservationAffinity struct {
	Key any
	ReservationAffinityType any
	Values any
}

type V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec struct {
...
type V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_NfsMounts struct {
	MountPoint any
	Path any
	Server any
}

type V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_PythonPackageSpec struct {
	Args any
	Env any
...
type V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs struct {
	ContainerSpec any
	DiskSpec any
	LustreMounts any
	MachineSpec any
...
type V1beta1AiplatformV1beta1CustomJob_JobSpec struct {
...
var V1beta1AiplatformV1beta1CustomJob_EncryptionSpecFields = ubx.FieldMap{
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

var V1beta1AiplatformV1beta1CustomJob_ErrorFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var V1beta1AiplatformV1beta1CustomJob_JobSpec_BaseOutputDirectoryFields = ubx.FieldMap{
		"OutputUriPrefix": ubx.FieldSpec{WireName: "output_uri_prefix"},
	}

var V1beta1AiplatformV1beta1CustomJob_JobSpec_PscInterfaceConfig_DnsPeeringConfigsFields = ubx.FieldMap{
		"Domain": ubx.FieldSpec{WireName: "domain"},
		"TargetNetwork": ubx.FieldSpec{WireName: "target_network"},
		"TargetProject": ubx.FieldSpec{WireName: "target_project"},
	}

var V1beta1AiplatformV1beta1CustomJob_JobSpec_PscInterfaceConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1CustomJob_JobSpec_SchedulingFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec_EnvFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpecFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_DiskSpecFields = ubx.FieldMap{
		"BootDiskSizeGb": ubx.FieldSpec{WireName: "boot_disk_size_gb"},
		"BootDiskType": ubx.FieldSpec{WireName: "boot_disk_type"},
	}

var V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_LustreMountsFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec_ReservationAffinityFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"ReservationAffinityType": ubx.FieldSpec{WireName: "reservation_affinity_type"},
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_MachineSpecFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_NfsMountsFields = ubx.FieldMap{
		"MountPoint": ubx.FieldSpec{WireName: "mount_point"},
		"Path": ubx.FieldSpec{WireName: "path"},
		"Server": ubx.FieldSpec{WireName: "server"},
	}

var V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecs_PythonPackageSpecFields = ubx.FieldMap{
		"Args": ubx.FieldSpec{WireName: "args"},
		"Env": ubx.FieldSpec{
			WireName: "env",
			Kind: "list",
...
var V1beta1AiplatformV1beta1CustomJob_JobSpec_WorkerPoolSpecsFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1CustomJob_JobSpecFields = ubx.FieldMap{
...
type V1beta1AiplatformV1beta1CustomJobConfig struct {
...
type V1beta1AiplatformV1beta1CustomJobAttrs struct {
	// Output only. Time when the CustomJob was created.
	CreateTime any
	// Required. The display name of the CustomJob. The name can be up to 128 characters long and can consist of any UTF-8 characters.
	DisplayName any
...
var V1beta1AiplatformV1beta1CustomJob = ubx.ResourceBinding{
