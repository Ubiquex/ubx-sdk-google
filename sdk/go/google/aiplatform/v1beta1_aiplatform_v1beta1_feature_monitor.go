...
type V1beta1AiplatformV1beta1FeatureMonitor_FeatureSelectionConfig_FeatureConfigs struct {
	DriftThreshold any
	FeatureId any
}

type V1beta1AiplatformV1beta1FeatureMonitor_FeatureSelectionConfig struct {
	// Optional. A list of features to be monitored and each feature's drift threshold.
	FeatureConfigs any
}

type V1beta1AiplatformV1beta1FeatureMonitor_ScheduleConfig struct {
	// Cron schedule (https://en.wikipedia.org/wiki/Cron) to launch scheduled runs. To explicitly set a timezone to the cron tab, apply a prefix in the cron tab: "CRON_TZ=${IANA_TIME_ZONE}" or "TZ=${IANA_TIME_ZONE}". The ${IANA_TIME_ZONE} may only be a valid string from IANA time zone database. For example, "CRON_TZ=America/New_York 1 * * * *", or "TZ=America/New_York 1 * * * *".
	Cron any
}

var V1beta1AiplatformV1beta1FeatureMonitor_FeatureSelectionConfig_FeatureConfigsFields = ubx.FieldMap{
		"DriftThreshold": ubx.FieldSpec{WireName: "drift_threshold"},
		"FeatureId": ubx.FieldSpec{WireName: "feature_id"},
	}

var V1beta1AiplatformV1beta1FeatureMonitor_FeatureSelectionConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1FeatureMonitor_ScheduleConfigFields = ubx.FieldMap{
		"Cron": ubx.FieldSpec{WireName: "cron"},
	}

type V1beta1AiplatformV1beta1FeatureMonitorConfig struct {
...
type V1beta1AiplatformV1beta1FeatureMonitorAttrs struct {
	// Output only. Timestamp when this FeatureMonitor was created.
	CreateTime any
	// Optional. Description of the FeatureMonitor.
	Description any
...
var V1beta1AiplatformV1beta1FeatureMonitor = ubx.ResourceBinding{
