...
type V1beta1AiplatformV1beta1DatasetVersionConfig struct {
...
type V1beta1AiplatformV1beta1DatasetVersionAttrs struct {
	// Output only. Name of the associated BigQuery dataset.
	BigQueryDatasetName any
	// Output only. Timestamp when this DatasetVersion was created.
	CreateTime any
...
var V1beta1AiplatformV1beta1DatasetVersion = ubx.ResourceBinding{
	WireType: "google_aiplatform_v1beta1_aiplatform_v1beta1_dataset_version",
	Fields: ubx.FieldMap{
		"BigQueryDatasetName": ubx.FieldSpec{WireName: "big_query_dataset_name"},
