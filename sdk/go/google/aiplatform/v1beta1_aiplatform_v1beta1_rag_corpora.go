...
type V1beta1AiplatformV1beta1RagCorpora_CorpusStatus struct {
...
type V1beta1AiplatformV1beta1RagCorpora_CorpusTypeConfig_MemoryCorpus_LlmParser struct {
...
type V1beta1AiplatformV1beta1RagCorpora_CorpusTypeConfig_MemoryCorpus struct {
	// Specifies the LLM parsing for RagFiles.
	LlmParser any
}

type V1beta1AiplatformV1beta1RagCorpora_CorpusTypeConfig struct {
...
type V1beta1AiplatformV1beta1RagCorpora_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type V1beta1AiplatformV1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_DenseEmbeddingModelPredictionEndpoint struct {
...
type V1beta1AiplatformV1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_SparseEmbeddingConfig_Bm25 struct {
...
type V1beta1AiplatformV1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_SparseEmbeddingConfig struct {
	// Message for BM25 parameters.
	Bm25 any
}

type V1beta1AiplatformV1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig struct {
...
type V1beta1AiplatformV1beta1RagCorpora_RagEmbeddingModelConfig struct {
...
type V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_ApiAuth_ApiKeyConfig struct {
...
type V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_ApiAuth struct {
	// The API secret.
	ApiKeyConfig any
}

type V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_Pinecone struct {
	// Pinecone index name. This value cannot be changed after it's set.
	IndexName any
}

type V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_RagManagedDb_Ann struct {
...
type V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_RagManagedDb struct {
...
type V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_RagManagedVertexVectorSearch struct {
...
type V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_VertexFeatureStore struct {
...
type V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_VertexVectorSearch struct {
...
type V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_Weaviate struct {
...
type V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig struct {
...
type V1beta1AiplatformV1beta1RagCorpora_VertexAiSearchConfig struct {
...
var V1beta1AiplatformV1beta1RagCorpora_CorpusStatusFields = ubx.FieldMap{
		"ErrorStatus": ubx.FieldSpec{WireName: "error_status"},
		"State": ubx.FieldSpec{WireName: "state"},
	}

var V1beta1AiplatformV1beta1RagCorpora_CorpusTypeConfig_MemoryCorpus_LlmParserFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1RagCorpora_CorpusTypeConfig_MemoryCorpusFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1RagCorpora_CorpusTypeConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1RagCorpora_EncryptionSpecFields = ubx.FieldMap{
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

var V1beta1AiplatformV1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_DenseEmbeddingModelPredictionEndpointFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_SparseEmbeddingConfig_Bm25Fields = ubx.FieldMap{
		"B": ubx.FieldSpec{WireName: "b"},
		"K1": ubx.FieldSpec{WireName: "k1"},
		"Multilingual": ubx.FieldSpec{WireName: "multilingual"},
	}

var V1beta1AiplatformV1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_SparseEmbeddingConfigFields = ubx.FieldMap{
		"Bm25": ubx.FieldSpec{
			WireName: "bm25",
			Kind: "object",
...
var V1beta1AiplatformV1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1RagCorpora_RagEmbeddingModelConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_ApiAuth_ApiKeyConfigFields = ubx.FieldMap{
		"ApiKeySecretVersion": ubx.FieldSpec{WireName: "api_key_secret_version"},
		"ApiKeyString": ubx.FieldSpec{WireName: "api_key_string"},
	}

var V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_ApiAuthFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_PineconeFields = ubx.FieldMap{
		"IndexName": ubx.FieldSpec{WireName: "index_name"},
	}

var V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_RagManagedDb_AnnFields = ubx.FieldMap{
		"LeafCount": ubx.FieldSpec{WireName: "leaf_count"},
		"TreeDepth": ubx.FieldSpec{WireName: "tree_depth"},
	}

var V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_RagManagedDbFields = ubx.FieldMap{
		"Ann": ubx.FieldSpec{
			WireName: "ann",
			Kind: "object",
...
var V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_RagManagedVertexVectorSearchFields = ubx.FieldMap{
		"CollectionName": ubx.FieldSpec{WireName: "collection_name"},
	}

var V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_VertexFeatureStoreFields = ubx.FieldMap{
		"FeatureViewResourceName": ubx.FieldSpec{WireName: "feature_view_resource_name"},
	}

var V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_VertexVectorSearchFields = ubx.FieldMap{
		"Index": ubx.FieldSpec{WireName: "index"},
		"IndexEndpoint": ubx.FieldSpec{WireName: "index_endpoint"},
	}

var V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfig_WeaviateFields = ubx.FieldMap{
		"CollectionName": ubx.FieldSpec{WireName: "collection_name"},
		"HttpEndpoint": ubx.FieldSpec{WireName: "http_endpoint"},
	}

var V1beta1AiplatformV1beta1RagCorpora_RagVectorDbConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1RagCorpora_VertexAiSearchConfigFields = ubx.FieldMap{
		"ServingConfig": ubx.FieldSpec{WireName: "serving_config"},
	}

type V1beta1AiplatformV1beta1RagCorporaConfig struct {
	// RagCorpus status.
	CorpusStatus any
...
type V1beta1AiplatformV1beta1RagCorporaAttrs struct {
	// RagCorpus status.
	CorpusStatus any
	// The config for the corpus type of the RagCorpus.
	CorpusTypeConfig any
...
var V1beta1AiplatformV1beta1RagCorpora = ubx.ResourceBinding{
