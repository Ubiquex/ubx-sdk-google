...
type AiplatformRagCorpora_CorpusStatus struct {
...
type AiplatformRagCorpora_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type AiplatformRagCorpora_VectorDbConfig_ApiAuth_ApiKeyConfig struct {
...
type AiplatformRagCorpora_VectorDbConfig_ApiAuth struct {
	// The API secret.
	ApiKeyConfig any
}

type AiplatformRagCorpora_VectorDbConfig_Pinecone struct {
	// Pinecone index name. This value cannot be changed after it's set.
	IndexName any
}

type AiplatformRagCorpora_VectorDbConfig_RagEmbeddingModelConfig_VertexPredictionEndpoint struct {
...
type AiplatformRagCorpora_VectorDbConfig_RagEmbeddingModelConfig struct {
	// Config representing a model hosted on Vertex Prediction Endpoint.
	VertexPredictionEndpoint any
}

type AiplatformRagCorpora_VectorDbConfig_RagManagedDb_Ann struct {
...
type AiplatformRagCorpora_VectorDbConfig_RagManagedDb struct {
...
type AiplatformRagCorpora_VectorDbConfig_VertexVectorSearch struct {
...
type AiplatformRagCorpora_VectorDbConfig struct {
...
type AiplatformRagCorpora_VertexAiSearchConfig struct {
...
var AiplatformRagCorpora_CorpusStatusFields = ubx.FieldMap{
		"ErrorStatus": ubx.FieldSpec{WireName: "error_status"},
		"State": ubx.FieldSpec{WireName: "state"},
	}

var AiplatformRagCorpora_EncryptionSpecFields = ubx.FieldMap{
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

var AiplatformRagCorpora_VectorDbConfig_ApiAuth_ApiKeyConfigFields = ubx.FieldMap{
		"ApiKeySecretVersion": ubx.FieldSpec{WireName: "api_key_secret_version"},
		"ApiKeyString": ubx.FieldSpec{WireName: "api_key_string"},
	}

var AiplatformRagCorpora_VectorDbConfig_ApiAuthFields = ubx.FieldMap{
...
var AiplatformRagCorpora_VectorDbConfig_PineconeFields = ubx.FieldMap{
		"IndexName": ubx.FieldSpec{WireName: "index_name"},
	}

var AiplatformRagCorpora_VectorDbConfig_RagEmbeddingModelConfig_VertexPredictionEndpointFields = ubx.FieldMap{
...
var AiplatformRagCorpora_VectorDbConfig_RagEmbeddingModelConfigFields = ubx.FieldMap{
...
var AiplatformRagCorpora_VectorDbConfig_RagManagedDb_AnnFields = ubx.FieldMap{
		"LeafCount": ubx.FieldSpec{WireName: "leaf_count"},
		"TreeDepth": ubx.FieldSpec{WireName: "tree_depth"},
	}

var AiplatformRagCorpora_VectorDbConfig_RagManagedDbFields = ubx.FieldMap{
		"Ann": ubx.FieldSpec{
			WireName: "ann",
			Kind: "object",
...
var AiplatformRagCorpora_VectorDbConfig_VertexVectorSearchFields = ubx.FieldMap{
		"Index": ubx.FieldSpec{WireName: "index"},
		"IndexEndpoint": ubx.FieldSpec{WireName: "index_endpoint"},
	}

var AiplatformRagCorpora_VectorDbConfigFields = ubx.FieldMap{
...
var AiplatformRagCorpora_VertexAiSearchConfigFields = ubx.FieldMap{
		"ServingConfig": ubx.FieldSpec{WireName: "serving_config"},
	}

type AiplatformRagCorporaConfig struct {
	// RagCorpus status.
	CorpusStatus any
...
type AiplatformRagCorporaAttrs struct {
	// RagCorpus status.
	CorpusStatus any
	// Output only. Timestamp when this RagCorpus was created.
	CreateTime any
...
var AiplatformRagCorpora = ubx.ResourceBinding{
