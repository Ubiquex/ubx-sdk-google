...
type V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_CustomContainerSpec struct {
...
type V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_Ports struct {
	Port any
	Protocol any
}

type V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_Resources struct {
...
type V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment struct {
...
type V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_DefaultContainerEnvironment struct {
...
type V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_EgressControlConfig_DnsPeeringConfigs struct {
	Domain any
	TargetNetwork any
	TargetProject any
}

type V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_EgressControlConfig struct {
...
type V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_IngressControlConfig_PscAutomationConfigs struct {
	ErrorMessage any
	ForwardingRule any
	IpAddress any
	Network any
...
type V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_IngressControlConfig struct {
...
var V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_CustomContainerSpecFields = ubx.FieldMap{
		"ImageUri": ubx.FieldSpec{WireName: "image_uri"},
	}

var V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_PortsFields = ubx.FieldMap{
		"Port": ubx.FieldSpec{WireName: "port"},
		"Protocol": ubx.FieldSpec{WireName: "protocol"},
	}

var V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_ResourcesFields = ubx.FieldMap{
		"Limits": ubx.FieldSpec{WireName: "limits"},
		"Requests": ubx.FieldSpec{WireName: "requests"},
	}

var V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_CustomContainerEnvironmentFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_DefaultContainerEnvironmentFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_EgressControlConfig_DnsPeeringConfigsFields = ubx.FieldMap{
		"Domain": ubx.FieldSpec{WireName: "domain"},
		"TargetNetwork": ubx.FieldSpec{WireName: "target_network"},
		"TargetProject": ubx.FieldSpec{WireName: "target_project"},
	}

var V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_EgressControlConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_IngressControlConfig_PscAutomationConfigsFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1SandboxEnvironmentTemplate_IngressControlConfigFields = ubx.FieldMap{
...
type V1beta1AiplatformV1beta1SandboxEnvironmentTemplateConfig struct {
...
type V1beta1AiplatformV1beta1SandboxEnvironmentTemplateAttrs struct {
	// Output only. The timestamp when this SandboxEnvironmentTemplate was created.
	CreateTime any
	// The customized sandbox runtime environment for BYOC.
	CustomContainerEnvironment any
...
var V1beta1AiplatformV1beta1SandboxEnvironmentTemplate = ubx.ResourceBinding{
