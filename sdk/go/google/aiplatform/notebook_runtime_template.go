...
type NotebookRuntimeTemplate_DataPersistentDiskSpec struct {
...
type NotebookRuntimeTemplate_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type NotebookRuntimeTemplate_EucConfig struct {
...
type NotebookRuntimeTemplate_IdleShutdownConfig struct {
...
type NotebookRuntimeTemplate_MachineSpec_ReservationAffinity struct {
...
type NotebookRuntimeTemplate_MachineSpec struct {
...
type NotebookRuntimeTemplate_NetworkSpec struct {
...
type NotebookRuntimeTemplate_ReservationAffinity struct {
...
type NotebookRuntimeTemplate_ShieldedVmConfig struct {
...
type NotebookRuntimeTemplate_SoftwareConfig_ColabImage struct {
...
type NotebookRuntimeTemplate_SoftwareConfig_PostStartupScriptConfig struct {
...
type NotebookRuntimeTemplate_SoftwareConfig struct {
