...
type AiplatformStudy_StudySpec_ConvexAutomatedStoppingSpec struct {
...
type AiplatformStudy_StudySpec_DecayCurveStoppingSpec struct {
...
type AiplatformStudy_StudySpec_Metrics_SafetyConfig struct {
	DesiredMinSafeTrialsFraction any
	SafetyThreshold any
}

type AiplatformStudy_StudySpec_Metrics struct {
	Goal any
	MetricId any
	SafetyConfig any
}

type AiplatformStudy_StudySpec_Parameters_CategoricalValueSpec struct {
	DefaultValue any
	Values any
}

type AiplatformStudy_StudySpec_Parameters_ConditionalParameterSpecs_ParentCategoricalValues struct {
	Values any
}

type AiplatformStudy_StudySpec_Parameters_ConditionalParameterSpecs_ParentDiscreteValues struct {
	Values any
}

type AiplatformStudy_StudySpec_Parameters_ConditionalParameterSpecs struct {
	ParameterSpec any
...
type AiplatformStudy_StudySpec_Parameters_DiscreteValueSpec struct {
	DefaultValue any
	Values any
}

type AiplatformStudy_StudySpec_Parameters_DoubleValueSpec struct {
	DefaultValue any
	MaxValue any
	MinValue any
}

type AiplatformStudy_StudySpec_Parameters_IntegerValueSpec struct {
	DefaultValue any
	MaxValue any
	MinValue any
}

type AiplatformStudy_StudySpec_Parameters struct {
...
type AiplatformStudy_StudySpec_StudyStoppingConfig_MaximumRuntimeConstraint struct {
...
type AiplatformStudy_StudySpec_StudyStoppingConfig struct {
...
type AiplatformStudy_StudySpec struct {
...
var AiplatformStudy_StudySpec_ConvexAutomatedStoppingSpecFields = ubx.FieldMap{
...
var AiplatformStudy_StudySpec_DecayCurveStoppingSpecFields = ubx.FieldMap{
		"UseElapsedDuration": ubx.FieldSpec{WireName: "use_elapsed_duration"},
	}

var AiplatformStudy_StudySpec_Metrics_SafetyConfigFields = ubx.FieldMap{
...
var AiplatformStudy_StudySpec_MetricsFields = ubx.FieldMap{
...
var AiplatformStudy_StudySpec_Parameters_CategoricalValueSpecFields = ubx.FieldMap{
		"DefaultValue": ubx.FieldSpec{WireName: "default_value"},
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var AiplatformStudy_StudySpec_Parameters_ConditionalParameterSpecs_ParentCategoricalValuesFields = ubx.FieldMap{
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var AiplatformStudy_StudySpec_Parameters_ConditionalParameterSpecs_ParentDiscreteValuesFields = ubx.FieldMap{
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var AiplatformStudy_StudySpec_Parameters_ConditionalParameterSpecsFields = ubx.FieldMap{
...
var AiplatformStudy_StudySpec_Parameters_DiscreteValueSpecFields = ubx.FieldMap{
		"DefaultValue": ubx.FieldSpec{WireName: "default_value"},
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var AiplatformStudy_StudySpec_Parameters_DoubleValueSpecFields = ubx.FieldMap{
		"DefaultValue": ubx.FieldSpec{WireName: "default_value"},
		"MaxValue": ubx.FieldSpec{WireName: "max_value"},
		"MinValue": ubx.FieldSpec{WireName: "min_value"},
	}

var AiplatformStudy_StudySpec_Parameters_IntegerValueSpecFields = ubx.FieldMap{
		"DefaultValue": ubx.FieldSpec{WireName: "default_value"},
		"MaxValue": ubx.FieldSpec{WireName: "max_value"},
		"MinValue": ubx.FieldSpec{WireName: "min_value"},
	}

var AiplatformStudy_StudySpec_ParametersFields = ubx.FieldMap{
...
var AiplatformStudy_StudySpec_StudyStoppingConfig_MaximumRuntimeConstraintFields = ubx.FieldMap{
		"EndTime": ubx.FieldSpec{WireName: "end_time"},
		"MaxDuration": ubx.FieldSpec{WireName: "max_duration"},
	}

var AiplatformStudy_StudySpec_StudyStoppingConfigFields = ubx.FieldMap{
...
var AiplatformStudy_StudySpecFields = ubx.FieldMap{
...
type AiplatformStudyConfig struct {
...
type AiplatformStudyAttrs struct {
	// Output only. Time at which the study was created.
	CreateTime any
	// Required. Describes the Study, default value is empty string.
	DisplayName any
...
var AiplatformStudy = ubx.ResourceBinding{
