...
type V1beta1DeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinity struct {
...
type V1beta1DeploymentResourcePool_DedicatedResources_MachineSpec struct {
...
type V1beta1DeploymentResourcePool_DedicatedResources_ScaleToZeroSpec struct {
...
type V1beta1DeploymentResourcePool_DedicatedResources struct {
...
type V1beta1DeploymentResourcePool_DeploymentResourcePool_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type V1beta1DeploymentResourcePool_DeploymentResourcePool struct {
...
type V1beta1DeploymentResourcePoolAttrs struct {
	// Output only. Timestamp when this DeploymentResourcePool was created.
	CreateTime any
	// A description of resources that are dedicated to a DeployedModel or DeployedIndex, and that need a higher degree of manual configuration.
	DedicatedResources any
...
var V1beta1DeploymentResourcePool = ubx.ResourceBinding{
