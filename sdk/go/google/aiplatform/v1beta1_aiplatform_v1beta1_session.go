...
type V1beta1AiplatformV1beta1SessionConfig struct {
...
type V1beta1AiplatformV1beta1SessionAttrs struct {
	// Output only. Timestamp when the session was created.
	CreateTime any
	// Optional. The display name of the session.
	DisplayName any
...
var V1beta1AiplatformV1beta1Session = ubx.ResourceBinding{
