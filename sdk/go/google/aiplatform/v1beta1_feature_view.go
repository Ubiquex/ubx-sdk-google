...
type V1beta1FeatureView_BigQuerySource struct {
...
type V1beta1FeatureView_BigtableMetadata struct {
...
type V1beta1FeatureView_IndexConfig_TreeAhConfig struct {
	// Optional. Number of embeddings on each leaf node. The default value is 1000 if not set.
	LeafNodeEmbeddingCount any
}

type V1beta1FeatureView_IndexConfig struct {
...
type V1beta1FeatureView_OptimizedConfig_AutomaticResources struct {
...
type V1beta1FeatureView_OptimizedConfig struct {
...
type V1beta1FeatureView_SyncConfig struct {
...
type V1beta1FeatureView_VertexRagSource struct {
...
type V1beta1FeatureViewAttrs struct {
	BigQuerySource any
	// Metadata for the Cloud Bigtable that supports directly interacting Bigtable instances.
	BigtableMetadata any
...
var V1beta1FeatureView = ubx.ResourceBinding{
