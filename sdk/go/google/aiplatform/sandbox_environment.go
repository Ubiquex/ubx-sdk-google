...
type SandboxEnvironment_ConnectionInfo struct {
...
type SandboxEnvironment_Spec_CodeExecutionEnvironment struct {
...
type SandboxEnvironment_Spec struct {
...
type SandboxEnvironmentAttrs struct {
	// The connection information of the SandboxEnvironment.
	ConnectionInfo any
	// Output only. The timestamp when this SandboxEnvironment was created.
	CreateTime any
...
var SandboxEnvironment = ubx.ResourceBinding{
