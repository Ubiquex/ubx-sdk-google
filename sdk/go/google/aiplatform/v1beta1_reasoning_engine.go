...
type V1beta1ReasoningEngine_ContextSpec_MemoryBankConfig_CustomizationConfigs_ConsolidationConfig struct {
...
type V1beta1ReasoningEngine_ContextSpec_MemoryBankConfig_CustomizationConfigs_GenerateMemoriesExamples_ConversationSource_Events_Content_Parts_MediaResolution struct {
	Level any
}
...
type V1beta1ReasoningEngine_ContextSpec_MemoryBankConfig_CustomizationConfigs_GenerateMemoriesExamples_ConversationSource struct {
	Events any
}
...
type V1beta1ReasoningEngine_ContextSpec_MemoryBankConfig_GenerationConfig_GenerationTriggerConfig struct {
	// Represents the active rule that determines when to flush the buffer.
	GenerationRule any
}

type V1beta1ReasoningEngine_ContextSpec_MemoryBankConfig_GenerationConfig struct {
...
type V1beta1ReasoningEngine_ContextSpec_MemoryBankConfig_SimilaritySearchConfig struct {
...
type V1beta1ReasoningEngine_ContextSpec_MemoryBankConfig_TtlConfig struct {
...
type V1beta1ReasoningEngine_ContextSpec_MemoryBankConfig struct {
...
type V1beta1ReasoningEngine_ContextSpec struct {
	// Specification for a Memory Bank.
	MemoryBankConfig any
}

type V1beta1ReasoningEngine_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type V1beta1ReasoningEngine_Spec_BuildSpec struct {
...
type V1beta1ReasoningEngine_Spec_ContainerSpec struct {
...
type V1beta1ReasoningEngine_Spec_DeploymentSpec_AgentGatewayConfig_AgentToAnywhereConfig struct {
...
type V1beta1ReasoningEngine_Spec_DeploymentSpec_AgentGatewayConfig struct {
...
type V1beta1ReasoningEngine_Spec_DeploymentSpec_KeepAliveProbe_HttpGet struct {
...
type V1beta1ReasoningEngine_Spec_DeploymentSpec_KeepAliveProbe struct {
...
type V1beta1ReasoningEngine_Spec_DeploymentSpec_PscInterfaceConfig struct {
...
type V1beta1ReasoningEngine_Spec_DeploymentSpec struct {
...
type V1beta1ReasoningEngine_Spec_PackageSpec struct {
...
type V1beta1ReasoningEngine_Spec_SourceCodeSpec_AgentConfigSource_AdkConfig struct {
	// Required. The value of the ADK config in JSON format.
	JsonConfig any
}

type V1beta1ReasoningEngine_Spec_SourceCodeSpec_AgentConfigSource_InlineSource struct {
	// Required. Input only. The application source code archive. It must be a compressed tarball (.tar.gz) file.
	SourceArchive any
}

type V1beta1ReasoningEngine_Spec_SourceCodeSpec_AgentConfigSource struct {
...
type V1beta1ReasoningEngine_Spec_SourceCodeSpec_DeveloperConnectSource_Config struct {
...
type V1beta1ReasoningEngine_Spec_SourceCodeSpec_DeveloperConnectSource struct {
...
type V1beta1ReasoningEngine_Spec_SourceCodeSpec_ImageSpec struct {
	// Optional. Build arguments to be used. They will be passed through --build-arg flags.
	BuildArgs any
}

type V1beta1ReasoningEngine_Spec_SourceCodeSpec_PythonSpec struct {
...
type V1beta1ReasoningEngine_Spec_SourceCodeSpec struct {
...
type V1beta1ReasoningEngine_Spec struct {
...
type V1beta1ReasoningEngine_TrafficConfig_TrafficSplitManual struct {
	// A list of traffic targets for the Runtimes Revisions. The sum of percentages must equal to 100.
	Targets any
}

type V1beta1ReasoningEngine_TrafficConfig struct {
...
var V1beta1ReasoningEngine = ubx.ResourceBinding{
