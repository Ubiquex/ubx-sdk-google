...
type PersistentResource_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type PersistentResource_Error struct {
...
type PersistentResource_PscInterfaceConfig struct {
...
type PersistentResource_ResourceRuntime struct {
...
type PersistentResource_ResourceRuntimeSpec_RaySpec_RayClusterAutoscalingSpec struct {
...
type PersistentResource_ResourceRuntimeSpec_RaySpec_RayLogsSpec struct {
	// Optional. Flag to disable the export of Ray OSS logs to Cloud Logging.
	Disabled any
}

type PersistentResource_ResourceRuntimeSpec_RaySpec_RayMetricSpec struct {
...
type PersistentResource_ResourceRuntimeSpec_RaySpec struct {
...
type PersistentResource_ResourceRuntimeSpec_ServiceAccountSpec struct {
...
type PersistentResource_ResourceRuntimeSpec struct {
...
type PersistentResourceAttrs struct {
	// Output only. Time when the PersistentResource was created.
	CreateTime any
	// Optional. The display name of the PersistentResource. The name can be up to 128 characters long and can consist of any UTF-8 characters.
	DisplayName any
...
var PersistentResource = ubx.ResourceBinding{
