...
type V1beta1ModelDeploymentMonitoringJob_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type V1beta1ModelDeploymentMonitoringJob_Error struct {
...
type V1beta1ModelDeploymentMonitoringJob_LatestMonitoringPipelineMetadata struct {
...
type V1beta1ModelDeploymentMonitoringJob_LoggingSamplingStrategy_RandomSampleConfig struct {
	// Sample rate (0, 1]
	SampleRate any
}

type V1beta1ModelDeploymentMonitoringJob_LoggingSamplingStrategy struct {
	// Requests are randomly selected.
	RandomSampleConfig any
}

type V1beta1ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_ExplanationConfig_ExplanationBaseline_Bigquery struct {
	OutputUri any
}

type V1beta1ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_ExplanationConfig_ExplanationBaseline_Gcs struct {
	OutputUriPrefix any
}
...
type V1beta1ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_TrainingDataset_GcsSource struct {
	Uris any
}
...
type V1beta1ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs struct {
	DeployedModelId any
	ObjectiveConfig any
}

type V1beta1ModelDeploymentMonitoringJob_ModelDeploymentMonitoringScheduleConfig struct {
...
type V1beta1ModelDeploymentMonitoringJob_ModelMonitoringAlertConfig_EmailAlertConfig struct {
	// The email addresses to send the alert.
	UserEmails any
}

type V1beta1ModelDeploymentMonitoringJob_ModelMonitoringAlertConfig struct {
