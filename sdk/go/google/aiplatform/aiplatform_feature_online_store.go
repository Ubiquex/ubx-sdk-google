...
type AiplatformFeatureOnlineStore_Bigtable_AutoScaling struct {
...
type AiplatformFeatureOnlineStore_Bigtable_BigtableMetadata struct {
...
type AiplatformFeatureOnlineStore_Bigtable struct {
	AutoScaling any
...
type AiplatformFeatureOnlineStore_DedicatedServingEndpoint_PrivateServiceConnectConfig_PscAutomationConfigs struct {
	ErrorMessage any
	ForwardingRule any
	IpAddress any
	Network any
...
type AiplatformFeatureOnlineStore_DedicatedServingEndpoint_PrivateServiceConnectConfig struct {
...
type AiplatformFeatureOnlineStore_DedicatedServingEndpoint struct {
...
type AiplatformFeatureOnlineStore_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

var AiplatformFeatureOnlineStore_Bigtable_AutoScalingFields = ubx.FieldMap{
...
var AiplatformFeatureOnlineStore_Bigtable_BigtableMetadataFields = ubx.FieldMap{
		"InstanceId": ubx.FieldSpec{WireName: "instance_id"},
		"TableId": ubx.FieldSpec{WireName: "table_id"},
		"TenantProjectId": ubx.FieldSpec{WireName: "tenant_project_id"},
	}

var AiplatformFeatureOnlineStore_BigtableFields = ubx.FieldMap{
...
var AiplatformFeatureOnlineStore_DedicatedServingEndpoint_PrivateServiceConnectConfig_PscAutomationConfigsFields = ubx.FieldMap{
...
var AiplatformFeatureOnlineStore_DedicatedServingEndpoint_PrivateServiceConnectConfigFields = ubx.FieldMap{
...
var AiplatformFeatureOnlineStore_DedicatedServingEndpointFields = ubx.FieldMap{
...
var AiplatformFeatureOnlineStore_EncryptionSpecFields = ubx.FieldMap{
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

type AiplatformFeatureOnlineStoreConfig struct {
	Bigtable any
...
type AiplatformFeatureOnlineStoreAttrs struct {
	Bigtable any
	// Output only. Timestamp when this FeatureOnlineStore was created.
	CreateTime any
	// The dedicated serving endpoint for this FeatureOnlineStore. Only need to set when you choose Optimized storage type. Public endpoint is provisioned by default.
...
var AiplatformFeatureOnlineStore = ubx.ResourceBinding{
