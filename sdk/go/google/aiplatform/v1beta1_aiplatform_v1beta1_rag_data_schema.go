...
type V1beta1AiplatformV1beta1RagDataSchema_SchemaDetails_ListConfig struct {
	ValueSchema any
}

type V1beta1AiplatformV1beta1RagDataSchema_SchemaDetails_SearchStrategy struct {
	// The search strategy type to be applied on the metadata key.
	SearchStrategyType any
}

type V1beta1AiplatformV1beta1RagDataSchema_SchemaDetails struct {
...
var V1beta1AiplatformV1beta1RagDataSchema_SchemaDetails_ListConfigFields = ubx.FieldMap{
		"ValueSchema": ubx.FieldSpec{WireName: "value_schema"},
	}

var V1beta1AiplatformV1beta1RagDataSchema_SchemaDetails_SearchStrategyFields = ubx.FieldMap{
		"SearchStrategyType": ubx.FieldSpec{WireName: "search_strategy_type"},
	}

var V1beta1AiplatformV1beta1RagDataSchema_SchemaDetailsFields = ubx.FieldMap{
...
type V1beta1AiplatformV1beta1RagDataSchemaConfig struct {
...
type V1beta1AiplatformV1beta1RagDataSchemaAttrs struct {
	// Required. The key of this data schema. This key should be matching the key of user specified metadata and unique inside corpus. This value can be up to 63 characters, and valid characters are /a-z-/. The first character must be a letter, the last could be a letter or a number.
	Key any
	// Identifier. Resource name of the data schema in the form of: `projects/{project_number}/locations/{location}/ragCorpora/{rag_corpus}/ragDataSchemas/{rag_data_schema}` where the {rag_data_schema} part should be the same as the `key` field below.
	Name any
...
var V1beta1AiplatformV1beta1RagDataSchema = ubx.ResourceBinding{
