...
type ReasoningEngine_ContextSpec_MemoryBankConfig_CustomizationConfigs_ConsolidationConfig struct {
...
type ReasoningEngine_ContextSpec_MemoryBankConfig_CustomizationConfigs_GenerateMemoriesExamples_ConversationSource_Events_Content_Parts_MediaResolution struct {
	Level any
}
...
type ReasoningEngine_ContextSpec_MemoryBankConfig_CustomizationConfigs_GenerateMemoriesExamples_ConversationSource struct {
	Events any
}
...
type ReasoningEngine_ContextSpec_MemoryBankConfig_GenerationConfig_GenerationTriggerConfig struct {
	// Represents the active rule that determines when to flush the buffer.
	GenerationRule any
}

type ReasoningEngine_ContextSpec_MemoryBankConfig_GenerationConfig struct {
...
type ReasoningEngine_ContextSpec_MemoryBankConfig_SimilaritySearchConfig struct {
...
type ReasoningEngine_ContextSpec_MemoryBankConfig_TtlConfig_GranularTtlConfig struct {
...
type ReasoningEngine_ContextSpec_MemoryBankConfig_TtlConfig struct {
...
type ReasoningEngine_ContextSpec_MemoryBankConfig struct {
...
type ReasoningEngine_ContextSpec struct {
	// Specification for a Memory Bank.
	MemoryBankConfig any
}

type ReasoningEngine_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type ReasoningEngine_Spec_BuildSpec struct {
...
type ReasoningEngine_Spec_ContainerSpec struct {
...
type ReasoningEngine_Spec_DeploymentSpec_AgentGatewayConfig_AgentToAnywhereConfig struct {
...
type ReasoningEngine_Spec_DeploymentSpec_AgentGatewayConfig struct {
...
type ReasoningEngine_Spec_DeploymentSpec_KeepAliveProbe_HttpGet struct {
...
type ReasoningEngine_Spec_DeploymentSpec_KeepAliveProbe struct {
...
type ReasoningEngine_Spec_DeploymentSpec_PscInterfaceConfig struct {
...
type ReasoningEngine_Spec_DeploymentSpec struct {
...
type ReasoningEngine_Spec_PackageSpec struct {
...
type ReasoningEngine_Spec_SourceCodeSpec_AgentConfigSource_AdkConfig struct {
	// Required. The value of the ADK config in JSON format.
	JsonConfig any
}

type ReasoningEngine_Spec_SourceCodeSpec_AgentConfigSource_InlineSource struct {
	// Required. Input only. The application source code archive. It must be a compressed tarball (.tar.gz) file.
	SourceArchive any
}

type ReasoningEngine_Spec_SourceCodeSpec_AgentConfigSource struct {
...
type ReasoningEngine_Spec_SourceCodeSpec_DeveloperConnectSource_Config struct {
...
type ReasoningEngine_Spec_SourceCodeSpec_DeveloperConnectSource struct {
...
type ReasoningEngine_Spec_SourceCodeSpec_ImageSpec struct {
	// Optional. Build arguments to be used. They will be passed through --build-arg flags.
	BuildArgs any
}

type ReasoningEngine_Spec_SourceCodeSpec_PythonSpec struct {
...
type ReasoningEngine_Spec_SourceCodeSpec struct {
...
type ReasoningEngine_Spec struct {
...
var ReasoningEngine = ubx.ResourceBinding{
