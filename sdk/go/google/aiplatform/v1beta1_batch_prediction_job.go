...
type V1beta1BatchPredictionJob_CompletionStats struct {
...
type V1beta1BatchPredictionJob_DedicatedResources_FlexStart struct {
...
type V1beta1BatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinity struct {
...
type V1beta1BatchPredictionJob_DedicatedResources_MachineSpec struct {
...
type V1beta1BatchPredictionJob_DedicatedResources struct {
...
type V1beta1BatchPredictionJob_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type V1beta1BatchPredictionJob_Error struct {
...
type V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource struct {
	// Required. Google Cloud Storage URI(-s) to the input file(s). May contain wildcards. For more information on wildcards, see https://cloud.google.com/storage/docs/wildcards.
	Uris any
}

type V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource struct {
...
type V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples_Presets struct {
...
type V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples struct {
...
type V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig struct {
...
type V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma struct {
	// Noise sigma per feature. No noise is added to features that are not set.
	NoiseSigma any
}

type V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig struct {
...
type V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution struct {
...
type V1beta1BatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttribution struct {
...
type V1beta1BatchPredictionJob_ExplanationSpec_Parameters struct {
...
type V1beta1BatchPredictionJob_ExplanationSpec struct {
...
type V1beta1BatchPredictionJob_InputConfig_BigquerySource struct {
...
type V1beta1BatchPredictionJob_InputConfig_VertexMultimodalDatasetSource struct {
	// Required. The resource name of the Vertex Dataset. Format: `projects/{project}/locations/{location}/datasets/{dataset}`
	DatasetName any
}

type V1beta1BatchPredictionJob_InputConfig struct {
...
type V1beta1BatchPredictionJob_InstanceConfig struct {
...
type V1beta1BatchPredictionJob_ManualBatchTuningParameters struct {
	// Immutable. The number of the records (e.g. instances) of the operation given in each batch to a machine replica. Machine type, and size of a single record should be considered when setting this parameter, higher value speeds up the batch operation's execution, but too high value will result in a whole batch not fitting in a machine's memory, and the whole operation will fail. The default value is 64.
	BatchSize any
}

type V1beta1BatchPredictionJob_ModelMonitoringConfig_AlertConfig_EmailAlertConfig struct {
	// The email addresses to send the alert.
	UserEmails any
}

type V1beta1BatchPredictionJob_ModelMonitoringConfig_AlertConfig struct {
...
type V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig_ExplanationBaseline_Bigquery struct {
	OutputUri any
}

type V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig_ExplanationBaseline_Gcs struct {
	OutputUriPrefix any
}
...
type V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingDataset_LoggingSamplingStrategy struct {
...
type V1beta1BatchPredictionJob_ModelMonitoringConfig struct {
...
type V1beta1BatchPredictionJob_OutputConfig struct {
	// The BigQuery location for the output content.
	BigqueryDestination any
	// The Google Cloud Storage location where the output is to be written to.
	GcsDestination any
...
type V1beta1BatchPredictionJob_OutputInfo struct {
...
type V1beta1BatchPredictionJob_ResourcesConsumed struct {
...
type V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPorts struct {
	ContainerPort any
}

type V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Exec struct {
	// Command is the command line to execute inside the container, the working directory for the command is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.
	Command any
}

type V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Grpc struct {
...
type V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGet struct {
...
type V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocket struct {
...
type V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe struct {
...
type V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec struct {
...
type V1beta1BatchPredictionJob_UnmanagedContainerModel_PredictSchemata struct {
...
type V1beta1BatchPredictionJob_UnmanagedContainerModel struct {
...
var V1beta1BatchPredictionJob = ubx.ResourceBinding{
