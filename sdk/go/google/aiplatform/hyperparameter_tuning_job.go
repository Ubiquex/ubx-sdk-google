...
type HyperparameterTuningJob_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type HyperparameterTuningJob_Error struct {
...
type HyperparameterTuningJob_StudySpec_ConvexAutomatedStoppingSpec struct {
...
type HyperparameterTuningJob_StudySpec_DecayCurveStoppingSpec struct {
...
type HyperparameterTuningJob_StudySpec_StudyStoppingConfig struct {
...
type HyperparameterTuningJob_StudySpec struct {
...
type HyperparameterTuningJob_TrialJobSpec_BaseOutputDirectory struct {
...
type HyperparameterTuningJob_TrialJobSpec_PscInterfaceConfig struct {
...
type HyperparameterTuningJob_TrialJobSpec_Scheduling struct {
...
var HyperparameterTuningJob_Trials_FinalMeasurement_MetricsFields = ubx.FieldMap{
		"MetricId": ubx.FieldSpec{WireName: "metric_id"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var HyperparameterTuningJob_Trials_FinalMeasurementFields = ubx.FieldMap{
...
var HyperparameterTuningJob_Trials_ParametersFields = ubx.FieldMap{
		"ParameterId": ubx.FieldSpec{WireName: "parameter_id"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var HyperparameterTuningJob_TrialsFields = ubx.FieldMap{
...
type HyperparameterTuningJobAttrs struct {
	// Output only. Time when the HyperparameterTuningJob was created.
	CreateTime any
	// Required. The display name of the HyperparameterTuningJob. The name can be up to 128 characters long and can consist of any UTF-8 characters.
	DisplayName any
