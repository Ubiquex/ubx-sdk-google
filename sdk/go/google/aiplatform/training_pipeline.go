...
type TrainingPipeline_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type TrainingPipeline_Error struct {
...
type TrainingPipeline_InputDataConfig_BigqueryDestination struct {
	// Required. BigQuery URI to a project or table, up to 2000 characters long. When only the project is specified, the Dataset and Table is created. When the full table reference is specified, the Dataset must exist and table must not exist. Accepted forms: * BigQuery path. For example: `bq://projectId` or `bq://projectId.bqDatasetId` or `bq://projectId.bqDatasetId.bqTableId`.
	OutputUri any
}

type TrainingPipeline_InputDataConfig_FilterSplit struct {
...
type TrainingPipeline_InputDataConfig_FractionSplit struct {
...
type TrainingPipeline_InputDataConfig_GcsDestination struct {
	// Required. Google Cloud Storage URI to output directory. If the uri doesn't end with '/', a '/' will be automatically appended. The directory is created if it doesn't exist.
	OutputUriPrefix any
}

type TrainingPipeline_InputDataConfig_PredefinedSplit struct {
	// Required. The key is a name of one of the Dataset's data columns. The value of the key (either the label's value or value in the column) must be one of {`training`, `validation`, `test`}, and it defines to which set the given piece of data is assigned. If for a piece of data the key is not present or has an invalid value, that piece is ignored by the pipeline.
	Key any
}

type TrainingPipeline_InputDataConfig_StratifiedSplit struct {
...
type TrainingPipeline_InputDataConfig struct {
...
type TrainingPipeline_ModelToUpload_BaseModelSource_GenieSource struct {
	// Required. The public base model URI.
	BaseModelUri any
}

type TrainingPipeline_ModelToUpload_BaseModelSource_ModelGardenSource struct {
...
type TrainingPipeline_ModelToUpload_BaseModelSource struct {
...
type TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_Exec struct {
	// Command is the command line to execute inside the container, the working directory for the command is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.
	Command any
}

type TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_Grpc struct {
...
type TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_HttpGet struct {
...
type TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_TcpSocket struct {
...
type TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe struct {
...
type TrainingPipeline_ModelToUpload_ContainerSpec struct {
...
type TrainingPipeline_ModelToUpload_DataStats struct {
...
type TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource struct {
	// Required. Google Cloud Storage URI(-s) to the input file(s). May contain wildcards. For more information on wildcards, see https://cloud.google.com/storage/docs/wildcards.
	Uris any
}

type TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource struct {
...
type TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_Presets struct {
...
type TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples struct {
...
type TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig struct {
...
type TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma struct {
	// Noise sigma per feature. No noise is added to features that are not set.
	NoiseSigma any
}

type TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig struct {
...
type TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution struct {
...
type TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_SampledShapleyAttribution struct {
...
type TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters struct {
...
type TrainingPipeline_ModelToUpload_ExplanationSpec struct {
...
type TrainingPipeline_ModelToUpload_ModelSourceInfo struct {
...
type TrainingPipeline_ModelToUpload_OriginalModelInfo struct {
...
type TrainingPipeline_ModelToUpload_PredictSchemata struct {
