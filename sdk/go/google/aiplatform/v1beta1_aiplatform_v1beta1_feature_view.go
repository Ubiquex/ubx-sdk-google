...
type V1beta1AiplatformV1beta1FeatureView_BigQuerySource struct {
...
type V1beta1AiplatformV1beta1FeatureView_BigtableMetadata struct {
	// Output only. The Bigtable App Profile to use for reading from Bigtable.
	ReadAppProfile any
}

type V1beta1AiplatformV1beta1FeatureView_FeatureRegistrySource_FeatureGroups struct {
	FeatureGroupId any
	FeatureIds any
}

type V1beta1AiplatformV1beta1FeatureView_FeatureRegistrySource struct {
...
type V1beta1AiplatformV1beta1FeatureView_IndexConfig_TreeAhConfig struct {
	// Optional. Number of embeddings on each leaf node. The default value is 1000 if not set.
	LeafNodeEmbeddingCount any
}

type V1beta1AiplatformV1beta1FeatureView_IndexConfig struct {
...
type V1beta1AiplatformV1beta1FeatureView_OptimizedConfig_AutomaticResources struct {
...
type V1beta1AiplatformV1beta1FeatureView_OptimizedConfig struct {
...
type V1beta1AiplatformV1beta1FeatureView_SyncConfig struct {
...
type V1beta1AiplatformV1beta1FeatureView_VertexRagSource struct {
...
var V1beta1AiplatformV1beta1FeatureView_BigQuerySourceFields = ubx.FieldMap{
		"EntityIdColumns": ubx.FieldSpec{WireName: "entity_id_columns"},
		"Uri": ubx.FieldSpec{WireName: "uri"},
	}

var V1beta1AiplatformV1beta1FeatureView_BigtableMetadataFields = ubx.FieldMap{
		"ReadAppProfile": ubx.FieldSpec{WireName: "read_app_profile"},
	}

var V1beta1AiplatformV1beta1FeatureView_FeatureRegistrySource_FeatureGroupsFields = ubx.FieldMap{
		"FeatureGroupId": ubx.FieldSpec{WireName: "feature_group_id"},
		"FeatureIds": ubx.FieldSpec{WireName: "feature_ids"},
	}

var V1beta1AiplatformV1beta1FeatureView_FeatureRegistrySourceFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1FeatureView_IndexConfig_TreeAhConfigFields = ubx.FieldMap{
		"LeafNodeEmbeddingCount": ubx.FieldSpec{WireName: "leaf_node_embedding_count"},
	}

var V1beta1AiplatformV1beta1FeatureView_IndexConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1FeatureView_OptimizedConfig_AutomaticResourcesFields = ubx.FieldMap{
		"MaxReplicaCount": ubx.FieldSpec{WireName: "max_replica_count"},
		"MinReplicaCount": ubx.FieldSpec{WireName: "min_replica_count"},
	}

var V1beta1AiplatformV1beta1FeatureView_OptimizedConfigFields = ubx.FieldMap{
...
var V1beta1AiplatformV1beta1FeatureView_SyncConfigFields = ubx.FieldMap{
		"Continuous": ubx.FieldSpec{WireName: "continuous"},
		"Cron": ubx.FieldSpec{WireName: "cron"},
	}

var V1beta1AiplatformV1beta1FeatureView_VertexRagSourceFields = ubx.FieldMap{
		"RagCorpusId": ubx.FieldSpec{WireName: "rag_corpus_id"},
		"Uri": ubx.FieldSpec{WireName: "uri"},
	}

type V1beta1AiplatformV1beta1FeatureViewConfig struct {
	BigQuerySource any
...
type V1beta1AiplatformV1beta1FeatureViewAttrs struct {
	BigQuerySource any
	// Metadata for the Cloud Bigtable that supports directly interacting Bigtable instances.
	BigtableMetadata any
	// Output only. Timestamp when this FeatureView was created.
...
var V1beta1AiplatformV1beta1FeatureView = ubx.ResourceBinding{
