...
type AiplatformBatchPredictionJob_CompletionStats struct {
...
type AiplatformBatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinity struct {
...
type AiplatformBatchPredictionJob_DedicatedResources_MachineSpec struct {
...
type AiplatformBatchPredictionJob_DedicatedResources struct {
...
type AiplatformBatchPredictionJob_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type AiplatformBatchPredictionJob_Error struct {
...
type AiplatformBatchPredictionJob_ExplanationSpec_Metadata_Inputs_FeatureValueDomain struct {
	MaxValue any
	MinValue any
	OriginalMean any
	OriginalStddev any
...
type AiplatformBatchPredictionJob_ExplanationSpec_Metadata_Inputs_Visualization struct {
...
type AiplatformBatchPredictionJob_ExplanationSpec_Metadata_Inputs struct {
...
type AiplatformBatchPredictionJob_ExplanationSpec_Metadata_Outputs struct {
	DisplayNameMappingKey any
	IndexDisplayNameMapping any
	OutputTensorName any
}

type AiplatformBatchPredictionJob_ExplanationSpec_Metadata struct {
...
type AiplatformBatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource struct {
	// Required. Google Cloud Storage URI(-s) to the input file(s). May contain wildcards. For more information on wildcards, see https://cloud.google.com/storage/docs/wildcards.
	Uris any
}

type AiplatformBatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource struct {
...
type AiplatformBatchPredictionJob_ExplanationSpec_Parameters_Examples_Presets struct {
...
type AiplatformBatchPredictionJob_ExplanationSpec_Parameters_Examples struct {
...
type AiplatformBatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig struct {
...
type AiplatformBatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma struct {
	Name any
	Sigma any
}

type AiplatformBatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma struct {
	// Noise sigma per feature. No noise is added to features that are not set.
	NoiseSigma any
}

type AiplatformBatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig struct {
...
type AiplatformBatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution struct {
...
type AiplatformBatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttribution struct {
...
type AiplatformBatchPredictionJob_ExplanationSpec_Parameters struct {
...
type AiplatformBatchPredictionJob_ExplanationSpec struct {
...
type AiplatformBatchPredictionJob_InputConfig_BigquerySource struct {
...
type AiplatformBatchPredictionJob_InputConfig_VertexMultimodalDatasetSource struct {
	// Required. The resource name of the Vertex Dataset. Format: `projects/{project}/locations/{location}/datasets/{dataset}`
	DatasetName any
}

type AiplatformBatchPredictionJob_InputConfig struct {
...
type AiplatformBatchPredictionJob_InstanceConfig struct {
...
type AiplatformBatchPredictionJob_ManualBatchTuningParameters struct {
	// Immutable. The number of the records (e.g. instances) of the operation given in each batch to a machine replica. Machine type, and size of a single record should be considered when setting this parameter, higher value speeds up the batch operation's execution, but too high value will result in a whole batch not fitting in a machine's memory, and the whole operation will fail. The default value is 64.
	BatchSize any
}

type AiplatformBatchPredictionJob_OutputConfig_BigqueryDestination struct {
	// Required. BigQuery URI to a project or table, up to 2000 characters long. When only the project is specified, the Dataset and Table is created. When the full table reference is specified, the Dataset must exist and table must not exist. Accepted forms: * BigQuery path. For example: `bq://projectId` or `bq://projectId.bqDatasetId` or `bq://projectId.bqDatasetId.bqTableId`.
	OutputUri any
}

type AiplatformBatchPredictionJob_OutputConfig_GcsDestination struct {
	// Required. Google Cloud Storage URI to output directory. If the uri doesn't end with '/', a '/' will be automatically appended. The directory is created if it doesn't exist.
	OutputUriPrefix any
}

type AiplatformBatchPredictionJob_OutputConfig_VertexMultimodalDatasetDestination struct {
...
type AiplatformBatchPredictionJob_OutputConfig struct {
	// The BigQuery location for the output content.
	BigqueryDestination any
...
type AiplatformBatchPredictionJob_OutputInfo struct {
...
type AiplatformBatchPredictionJob_ResourcesConsumed struct {
...
type AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_Env struct {
	Name any
	Value any
}

type AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPorts struct {
	ContainerPort any
}

type AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Exec struct {
	// Command is the command line to execute inside the container, the working directory for the command is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.
	Command any
}

type AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Grpc struct {
...
type AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGet struct {
...
type AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocket struct {
...
type AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe struct {
...
type AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec struct {
...
type AiplatformBatchPredictionJob_UnmanagedContainerModel_PredictSchemata struct {
...
type AiplatformBatchPredictionJob_UnmanagedContainerModel struct {
...
var AiplatformBatchPredictionJob_CompletionStatsFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinityFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"ReservationAffinityType": ubx.FieldSpec{WireName: "reservation_affinity_type"},
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var AiplatformBatchPredictionJob_DedicatedResources_MachineSpecFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_DedicatedResourcesFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_EncryptionSpecFields = ubx.FieldMap{
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

var AiplatformBatchPredictionJob_ErrorFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var AiplatformBatchPredictionJob_ExplanationSpec_Metadata_Inputs_FeatureValueDomainFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ExplanationSpec_Metadata_Inputs_VisualizationFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ExplanationSpec_Metadata_InputsFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ExplanationSpec_Metadata_OutputsFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ExplanationSpec_MetadataFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSourceFields = ubx.FieldMap{
		"Uris": ubx.FieldSpec{WireName: "uris"},
	}

var AiplatformBatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSourceFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ExplanationSpec_Parameters_Examples_PresetsFields = ubx.FieldMap{
		"Modality": ubx.FieldSpec{WireName: "modality"},
		"Query": ubx.FieldSpec{WireName: "query"},
	}

var AiplatformBatchPredictionJob_ExplanationSpec_Parameters_ExamplesFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfigFields = ubx.FieldMap{
		"MaxBlurSigma": ubx.FieldSpec{WireName: "max_blur_sigma"},
	}

var AiplatformBatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigmaFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Sigma": ubx.FieldSpec{WireName: "sigma"},
	}

var AiplatformBatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigmaFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfigFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttributionFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttributionFields = ubx.FieldMap{
		"PathCount": ubx.FieldSpec{WireName: "path_count"},
	}

var AiplatformBatchPredictionJob_ExplanationSpec_ParametersFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ExplanationSpecFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_InputConfig_BigquerySourceFields = ubx.FieldMap{
		"InputUri": ubx.FieldSpec{WireName: "input_uri"},
	}

var AiplatformBatchPredictionJob_InputConfig_VertexMultimodalDatasetSourceFields = ubx.FieldMap{
		"DatasetName": ubx.FieldSpec{WireName: "dataset_name"},
	}

var AiplatformBatchPredictionJob_InputConfigFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_InstanceConfigFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ManualBatchTuningParametersFields = ubx.FieldMap{
		"BatchSize": ubx.FieldSpec{WireName: "batch_size"},
	}

var AiplatformBatchPredictionJob_OutputConfig_BigqueryDestinationFields = ubx.FieldMap{
		"OutputUri": ubx.FieldSpec{WireName: "output_uri"},
	}

var AiplatformBatchPredictionJob_OutputConfig_GcsDestinationFields = ubx.FieldMap{
		"OutputUriPrefix": ubx.FieldSpec{WireName: "output_uri_prefix"},
	}

var AiplatformBatchPredictionJob_OutputConfig_VertexMultimodalDatasetDestinationFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_OutputConfigFields = ubx.FieldMap{
		"BigqueryDestination": ubx.FieldSpec{
			WireName: "bigquery_destination",
			Kind: "object",
			Fields: AiplatformBatchPredictionJob_OutputConfig_BigqueryDestinationFields,
...
var AiplatformBatchPredictionJob_OutputInfoFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_ResourcesConsumedFields = ubx.FieldMap{
		"ReplicaHours": ubx.FieldSpec{WireName: "replica_hours"},
	}

var AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_EnvFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPortsFields = ubx.FieldMap{
		"ContainerPort": ubx.FieldSpec{WireName: "container_port"},
	}

var AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_ExecFields = ubx.FieldMap{
		"Command": ubx.FieldSpec{WireName: "command"},
	}

var AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_GrpcFields = ubx.FieldMap{
		"Port": ubx.FieldSpec{WireName: "port"},
		"Service": ubx.FieldSpec{WireName: "service"},
	}

var AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGetFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocketFields = ubx.FieldMap{
		"Host": ubx.FieldSpec{WireName: "host"},
		"Port": ubx.FieldSpec{WireName: "port"},
	}

var AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbeFields = ubx.FieldMap{
		"Exec": ubx.FieldSpec{
			WireName: "exec",
			Kind: "object",
...
var AiplatformBatchPredictionJob_UnmanagedContainerModel_ContainerSpecFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_UnmanagedContainerModel_PredictSchemataFields = ubx.FieldMap{
...
var AiplatformBatchPredictionJob_UnmanagedContainerModelFields = ubx.FieldMap{
...
type AiplatformBatchPredictionJobConfig struct {
...
type AiplatformBatchPredictionJobAttrs struct {
	// Success and error statistics of processing multiple entities (for example, DataItems or structured data rows) in batch.
	CompletionStats any
	// Output only. Time when the BatchPredictionJob was created.
	CreateTime any
...
var AiplatformBatchPredictionJob = ubx.ResourceBinding{
