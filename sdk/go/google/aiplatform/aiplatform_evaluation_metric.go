...
type AiplatformEvaluationMetric_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type AiplatformEvaluationMetric_Metric_BleuSpec struct {
	// Optional. Whether to use_effective_order to compute bleu score.
	UseEffectiveOrder any
}

type AiplatformEvaluationMetric_Metric_ComputationBasedMetricSpec struct {
...
type AiplatformEvaluationMetric_Metric_CustomCodeExecutionSpec struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfig_LanguageHints struct {
	// Required. Deprecated: Use top-level `language_codes` instead. BCP-47 language codes. At least one must be specified.
	LanguageCodes any
}

type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfig struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig_ImageOutputOptions struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_Audio struct {
	BitRate any
	Delivery any
	MimeType any
	SampleRate any
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_Image struct {
	AspectRatio any
	Delivery any
	ImageSize any
	MimeType any
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_Text struct {
	MimeType any
	Schema any
}

type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_Video struct {
	AspectRatio any
	Delivery any
	Duration any
	GcsUri any
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat struct {
	Audio any
	Image any
	Text any
	Video any
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseSchema struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_AutoMode struct {
	// The model routing preference.
	ModelRoutingPreference any
}

type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_ManualMode struct {
	// The name of the model to use. Only public LLM models are accepted.
	ModelName any
}

type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig_PrebuiltVoiceConfig struct {
	VoiceName any
}

type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig_ReplicatedVoiceConfig struct {
	MimeType any
	VoiceSampleAudio any
}

type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig struct {
	PrebuiltVoiceConfig any
	ReplicatedVoiceConfig any
}

type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs struct {
	Speaker any
	VoiceConfig any
}

type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig struct {
	// Required. A list of configurations for the voices of the speakers. Exactly two speaker voice configurations must be provided.
	SpeakerVoiceConfigs any
}

type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ThinkingConfig struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_PredefinedRubricGenerationSpec struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig_CustomCodeParserConfig struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig struct {
	// Configuration for parsing the LLM response using custom code.
	CustomCodeParserConfig any
}

type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_RubricGenerationSpec struct {
...
type AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec struct {
...
type AiplatformEvaluationMetric_Metric_Metadata_ScoreRange struct {
...
type AiplatformEvaluationMetric_Metric_Metadata struct {
...
type AiplatformEvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfig struct {
	// Optional. Whether to return raw output.
	ReturnRawOutput any
}

type AiplatformEvaluationMetric_Metric_PairwiseMetricSpec struct {
...
type AiplatformEvaluationMetric_Metric_PointwiseMetricSpec struct {
	// Spec for custom output format configuration.
	CustomOutputFormatConfig any
...
type AiplatformEvaluationMetric_Metric_RougeSpec struct {
...
type AiplatformEvaluationMetric_Metric struct {
...
var AiplatformEvaluationMetric_EncryptionSpecFields = ubx.FieldMap{
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

var AiplatformEvaluationMetric_Metric_BleuSpecFields = ubx.FieldMap{
		"UseEffectiveOrder": ubx.FieldSpec{WireName: "use_effective_order"},
	}

var AiplatformEvaluationMetric_Metric_ComputationBasedMetricSpecFields = ubx.FieldMap{
		"Parameters": ubx.FieldSpec{WireName: "parameters"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var AiplatformEvaluationMetric_Metric_CustomCodeExecutionSpecFields = ubx.FieldMap{
		"EvaluationFunction": ubx.FieldSpec{WireName: "evaluation_function"},
	}

var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfig_LanguageHintsFields = ubx.FieldMap{
		"LanguageCodes": ubx.FieldSpec{WireName: "language_codes"},
	}

var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfigFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig_ImageOutputOptionsFields = ubx.FieldMap{
		"CompressionQuality": ubx.FieldSpec{WireName: "compression_quality"},
		"MimeType": ubx.FieldSpec{WireName: "mime_type"},
	}

var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfigFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_AudioFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_ImageFields = ubx.FieldMap{
		"AspectRatio": ubx.FieldSpec{WireName: "aspect_ratio"},
		"Delivery": ubx.FieldSpec{WireName: "delivery"},
		"ImageSize": ubx.FieldSpec{WireName: "image_size"},
		"MimeType": ubx.FieldSpec{WireName: "mime_type"},
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_TextFields = ubx.FieldMap{
		"MimeType": ubx.FieldSpec{WireName: "mime_type"},
		"Schema": ubx.FieldSpec{WireName: "schema"},
	}

var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_VideoFields = ubx.FieldMap{
		"AspectRatio": ubx.FieldSpec{WireName: "aspect_ratio"},
		"Delivery": ubx.FieldSpec{WireName: "delivery"},
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormatFields = ubx.FieldMap{
		"Audio": ubx.FieldSpec{
			WireName: "audio",
			Kind: "object",
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseSchemaFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_AutoModeFields = ubx.FieldMap{
		"ModelRoutingPreference": ubx.FieldSpec{WireName: "model_routing_preference"},
	}

var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_ManualModeFields = ubx.FieldMap{
		"ModelName": ubx.FieldSpec{WireName: "model_name"},
	}

var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfigFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig_PrebuiltVoiceConfigFields = ubx.FieldMap{
		"VoiceName": ubx.FieldSpec{WireName: "voice_name"},
	}

var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig_ReplicatedVoiceConfigFields = ubx.FieldMap{
		"MimeType": ubx.FieldSpec{WireName: "mime_type"},
		"VoiceSampleAudio": ubx.FieldSpec{WireName: "voice_sample_audio"},
	}

var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfigFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigsFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfigFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfigFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ThinkingConfigFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfigFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfigFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_PredefinedRubricGenerationSpecFields = ubx.FieldMap{
		"MetricSpecName": ubx.FieldSpec{WireName: "metric_spec_name"},
		"MetricSpecParameters": ubx.FieldSpec{WireName: "metric_spec_parameters"},
	}

var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig_CustomCodeParserConfigFields = ubx.FieldMap{
		"ParsingFunction": ubx.FieldSpec{WireName: "parsing_function"},
	}

var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfigFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpec_RubricGenerationSpecFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_LlmBasedMetricSpecFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_Metadata_ScoreRangeFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
...
var AiplatformEvaluationMetric_Metric_MetadataFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfigFields = ubx.FieldMap{
		"ReturnRawOutput": ubx.FieldSpec{WireName: "return_raw_output"},
	}

var AiplatformEvaluationMetric_Metric_PairwiseMetricSpecFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_Metric_PointwiseMetricSpecFields = ubx.FieldMap{
		"CustomOutputFormatConfig": ubx.FieldSpec{
			WireName: "custom_output_format_config",
			Kind: "object",
			Fields: AiplatformEvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfigFields,
...
var AiplatformEvaluationMetric_Metric_RougeSpecFields = ubx.FieldMap{
...
var AiplatformEvaluationMetric_MetricFields = ubx.FieldMap{
...
type AiplatformEvaluationMetricConfig struct {
...
type AiplatformEvaluationMetricAttrs struct {
	// Output only. The time when the EvaluationMetric was created.
	CreateTime any
	// Optional. A description of the EvaluationMetric.
	Description any
...
var AiplatformEvaluationMetric = ubx.ResourceBinding{
