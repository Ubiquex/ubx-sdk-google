...
type AiplatformDataset_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type AiplatformDataset_SavedQueries struct {
...
var AiplatformDataset_EncryptionSpecFields = ubx.FieldMap{
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

var AiplatformDataset_SavedQueriesFields = ubx.FieldMap{
...
type AiplatformDatasetConfig struct {
...
type AiplatformDatasetAttrs struct {
	// Output only. Timestamp when this Dataset was created.
	CreateTime any
	// Output only. The number of DataItems in this Dataset. Only apply for non-structured Dataset.
	DataItemCount any
...
var AiplatformDataset = ubx.ResourceBinding{
