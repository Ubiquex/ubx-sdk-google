...
type AiplatformEntityType_MonitoringConfig_CategoricalThresholdConfig struct {
	// Specify a threshold value that can trigger the alert. 1. For categorical feature, the distribution distance is calculated by L-inifinity norm. 2. For numerical feature, the distribution distance is calculated by Jensen–Shannon divergence. Each feature must have a non-zero threshold if they need to be monitored. Otherwise no alert will be triggered for that feature.
	Value any
}

type AiplatformEntityType_MonitoringConfig_ImportFeaturesAnalysis struct {
...
type AiplatformEntityType_MonitoringConfig_SnapshotAnalysis struct {
...
type AiplatformEntityType_MonitoringConfig struct {
...
var AiplatformEntityType_MonitoringConfig_CategoricalThresholdConfigFields = ubx.FieldMap{
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var AiplatformEntityType_MonitoringConfig_ImportFeaturesAnalysisFields = ubx.FieldMap{
		"AnomalyDetectionBaseline": ubx.FieldSpec{WireName: "anomaly_detection_baseline"},
		"State": ubx.FieldSpec{WireName: "state"},
	}

var AiplatformEntityType_MonitoringConfig_SnapshotAnalysisFields = ubx.FieldMap{
...
var AiplatformEntityType_MonitoringConfigFields = ubx.FieldMap{
...
type AiplatformEntityTypeConfig struct {
...
type AiplatformEntityTypeAttrs struct {
	// Output only. Timestamp when this EntityType was created.
	CreateTime any
	// Optional. Description of the EntityType.
	Description any
...
var AiplatformEntityType = ubx.ResourceBinding{
