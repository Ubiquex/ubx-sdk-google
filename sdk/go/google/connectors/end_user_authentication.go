...
type EndUserAuthentication_EndUserAuthenticationConfig_Oauth2AuthCodeFlow struct {
...
type EndUserAuthentication_EndUserAuthenticationConfig_Oauth2AuthCodeFlowGoogleManaged struct {
	// Optional. Authorization code to be exchanged for access and refresh tokens.
	AuthCode any
	// pass only at create and not update using updateMask Auth Code Data
	OauthTokenData any
...
type EndUserAuthentication_EndUserAuthenticationConfig_Oauth2ClientCredentials struct {
...
type EndUserAuthentication_EndUserAuthenticationConfig_Oauth2JwtBearer_JwtClaims struct {
...
type EndUserAuthentication_EndUserAuthenticationConfig_Oauth2JwtBearer struct {
	// EUASecret provides a reference to entries in Secret Manager.
	ClientKey any
...
type EndUserAuthentication_EndUserAuthenticationConfig_SshPublicKey struct {
...
type EndUserAuthentication_EndUserAuthenticationConfig_UserPassword struct {
	// EUASecret provides a reference to entries in Secret Manager.
	Password any
	// Username.
	Username any
...
type EndUserAuthentication_EndUserAuthenticationConfig struct {
...
type EndUserAuthentication_NotifyEndpointDestination_Endpoint struct {
...
type EndUserAuthentication_NotifyEndpointDestination struct {
...
type EndUserAuthentication_Status struct {
...
type EndUserAuthenticationAttrs struct {
	// Optional. Config variables for the EndUserAuthentication.
	ConfigVariables any
	// Output only. Created time.
	CreateTime any
...
var EndUserAuthentication = ubx.ResourceBinding{
