...
type V1beta2Instance_MaintenancePolicy struct {
...
type V1beta2Instance_MaintenanceSchedule struct {
...
var V1beta2Instance_MemcacheNodesFields = ubx.FieldMap{
...
type V1beta2InstanceAttrs struct {
	// The full name of the Google Compute Engine [network](https://cloud.google.com/vpc/docs/vpc) to which the instance is connected. If left unspecified, the `default` network will be used.
	AuthorizedNetwork any
	// Output only. The available maintenance versions that can be applied to the instance.
	AvailableMaintenanceVersions any
...
var V1beta2Instance = ubx.ResourceBinding{
