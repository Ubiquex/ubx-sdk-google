...
type AssuredworkloadsWorkload_ComplianceStatus struct {
...
type AssuredworkloadsWorkload_EkmProvisioningResponse struct {
...
type AssuredworkloadsWorkload_KmsSettings struct {
...
type AssuredworkloadsWorkload_PartnerPermissions struct {
...
type AssuredworkloadsWorkload_ResourceSettings struct {
	DisplayName any
	ResourceId any
	ResourceType any
}

type AssuredworkloadsWorkload_Resources struct {
	ResourceId any
	ResourceType any
}

type AssuredworkloadsWorkload_SaaEnrollmentResponse struct {
...
type AssuredworkloadsWorkload_WorkloadOptions struct {
	// Optional. Specifies type of KAJ Enrollment if provided.
	KajEnrollmentType any
}

var AssuredworkloadsWorkload_ComplianceStatusFields = ubx.FieldMap{
...
var AssuredworkloadsWorkload_EkmProvisioningResponseFields = ubx.FieldMap{
...
var AssuredworkloadsWorkload_KmsSettingsFields = ubx.FieldMap{
		"NextRotationTime": ubx.FieldSpec{WireName: "next_rotation_time"},
		"RotationPeriod": ubx.FieldSpec{WireName: "rotation_period"},
	}

var AssuredworkloadsWorkload_PartnerPermissionsFields = ubx.FieldMap{
...
var AssuredworkloadsWorkload_ResourceSettingsFields = ubx.FieldMap{
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
		"ResourceId": ubx.FieldSpec{WireName: "resource_id"},
		"ResourceType": ubx.FieldSpec{WireName: "resource_type"},
	}

var AssuredworkloadsWorkload_ResourcesFields = ubx.FieldMap{
		"ResourceId": ubx.FieldSpec{WireName: "resource_id"},
		"ResourceType": ubx.FieldSpec{WireName: "resource_type"},
	}

var AssuredworkloadsWorkload_SaaEnrollmentResponseFields = ubx.FieldMap{
		"SetupErrors": ubx.FieldSpec{WireName: "setup_errors"},
		"SetupStatus": ubx.FieldSpec{WireName: "setup_status"},
	}

var AssuredworkloadsWorkload_WorkloadOptionsFields = ubx.FieldMap{
...
type AssuredworkloadsWorkloadAttrs struct {
	// Optional. The billing account used for the resources which are direct children of workload. This billing account is initially associated with the resources created as part of Workload creation. After the initial creation of these resources, the customer can change the assigned billing account. The resource name has the form `billingAccounts/{billing_account_id}`. For example, `billingAccounts/012345-567890-ABCDEF`.
	BillingAccount any
	// Required. Immutable. Compliance Regime associated with this workload.
	ComplianceRegime any
...
var AssuredworkloadsWorkload = ubx.ResourceBinding{
