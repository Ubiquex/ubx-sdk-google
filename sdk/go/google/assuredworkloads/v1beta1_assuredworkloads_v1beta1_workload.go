...
type V1beta1AssuredworkloadsV1beta1Workload_CjisSettings_KmsSettings struct {
...
type V1beta1AssuredworkloadsV1beta1Workload_CjisSettings struct {
	// Settings specific to the Key Management Service.
	KmsSettings any
}

type V1beta1AssuredworkloadsV1beta1Workload_ComplianceStatus struct {
...
type V1beta1AssuredworkloadsV1beta1Workload_EkmProvisioningResponse struct {
...
type V1beta1AssuredworkloadsV1beta1Workload_PartnerPermissions struct {
...
type V1beta1AssuredworkloadsV1beta1Workload_ResourceSettings struct {
	DisplayName any
	ResourceId any
	ResourceType any
}

type V1beta1AssuredworkloadsV1beta1Workload_Resources struct {
	ResourceId any
	ResourceType any
}

type V1beta1AssuredworkloadsV1beta1Workload_SaaEnrollmentResponse struct {
...
type V1beta1AssuredworkloadsV1beta1Workload_WorkloadOptions struct {
	// Optional. Specifies type of KAJ Enrollment if provided.
	KajEnrollmentType any
}

var V1beta1AssuredworkloadsV1beta1Workload_CjisSettings_KmsSettingsFields = ubx.FieldMap{
		"NextRotationTime": ubx.FieldSpec{WireName: "next_rotation_time"},
		"RotationPeriod": ubx.FieldSpec{WireName: "rotation_period"},
	}

var V1beta1AssuredworkloadsV1beta1Workload_CjisSettingsFields = ubx.FieldMap{
...
var V1beta1AssuredworkloadsV1beta1Workload_ComplianceStatusFields = ubx.FieldMap{
...
var V1beta1AssuredworkloadsV1beta1Workload_EkmProvisioningResponseFields = ubx.FieldMap{
...
var V1beta1AssuredworkloadsV1beta1Workload_PartnerPermissionsFields = ubx.FieldMap{
...
var V1beta1AssuredworkloadsV1beta1Workload_ResourceSettingsFields = ubx.FieldMap{
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
		"ResourceId": ubx.FieldSpec{WireName: "resource_id"},
		"ResourceType": ubx.FieldSpec{WireName: "resource_type"},
	}

var V1beta1AssuredworkloadsV1beta1Workload_ResourcesFields = ubx.FieldMap{
		"ResourceId": ubx.FieldSpec{WireName: "resource_id"},
		"ResourceType": ubx.FieldSpec{WireName: "resource_type"},
	}

var V1beta1AssuredworkloadsV1beta1Workload_SaaEnrollmentResponseFields = ubx.FieldMap{
		"SetupErrors": ubx.FieldSpec{WireName: "setup_errors"},
		"SetupStatus": ubx.FieldSpec{WireName: "setup_status"},
	}

var V1beta1AssuredworkloadsV1beta1Workload_WorkloadOptionsFields = ubx.FieldMap{
		"KajEnrollmentType": ubx.FieldSpec{WireName: "kaj_enrollment_type"},
	}

type V1beta1AssuredworkloadsV1beta1WorkloadConfig struct {
...
type V1beta1AssuredworkloadsV1beta1WorkloadAttrs struct {
	// Output only. The number of updates available for the workload.
	AvailableUpdates any
	// Optional. The billing account used for the resources which are direct children of workload. This billing account is initially associated with the resources created as part of Workload creation. After the initial creation of these resources, the customer can change the assigned billing account. The resource name has the form `billingAccounts/{billing_account_id}`. For example, `billingAccounts/012345-567890-ABCDEF`.
	BillingAccount any
...
var V1beta1AssuredworkloadsV1beta1Workload = ubx.ResourceBinding{
