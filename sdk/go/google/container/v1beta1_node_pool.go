...
type V1beta1NodePool_AutopilotConfig struct {
	// Denotes that nodes belonging to this node pool are Autopilot nodes.
	Enabled any
}

type V1beta1NodePool_Autoscaling struct {
...
type V1beta1NodePool_BestEffortProvisioning struct {
...
type V1beta1NodePool_Config_BootDisk struct {
...
type V1beta1NodePool_Config_ConfidentialNodes struct {
...
type V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfig_GcpSecretManagerCertificateConfig struct {
	SecretUri any
}
...
type V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig struct {
...
type V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Ca struct {
...
type V1beta1NodePool_Config_ContainerdConfig struct {
...
type V1beta1NodePool_Config_EphemeralStorageConfig struct {
...
type V1beta1NodePool_Config_EphemeralStorageLocalSsdConfig struct {
...
type V1beta1NodePool_Config_GpuDirectConfig struct {
	// The type of GPU direct strategy to enable on the node pool.
	GpuDirectStrategy any
}

type V1beta1NodePool_Config_HostMaintenancePolicy_OpportunisticMaintenanceStrategy struct {
...
type V1beta1NodePool_Config_HostMaintenancePolicy struct {
...
type V1beta1NodePool_Config_KubeletConfig_CrashLoopBackOff struct {
...
type V1beta1NodePool_Config_KubeletConfig_EvictionMinimumReclaim struct {
...
type V1beta1NodePool_Config_KubeletConfig_MemoryManager struct {
...
type V1beta1NodePool_Config_KubeletConfig_TopologyManager struct {
...
type V1beta1NodePool_Config_KubeletConfig struct {
...
type V1beta1NodePool_Config_LinuxNodeConfig_AccurateTimeConfig struct {
	// Enables enhanced time synchronization using PTP-KVM.
	EnablePtpKvmTimeSync any
}

type V1beta1NodePool_Config_LinuxNodeConfig_CustomNodeInit_InitScript struct {
...
type V1beta1NodePool_Config_LinuxNodeConfig_CustomNodeInit struct {
	// InitScript provide a simply bash script to be executed on the node.
	InitScript any
}

type V1beta1NodePool_Config_LinuxNodeConfig_DiskIoScheduler struct {
...
type V1beta1NodePool_Config_LinuxNodeConfig_Hugepages struct {
...
type V1beta1NodePool_Config_LinuxNodeConfig_NodeVfioConfig struct {
...
type V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_BootDiskProfile struct {
...
type V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_DedicatedLocalSsdProfile struct {
	// The number of physical local NVMe SSD disks to attach.
	DiskCount any
}

type V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_EncryptionConfig struct {
	// Optional. If true, swap space will not be encrypted. Defaults to false (encrypted).
	Disabled any
}

type V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig struct {
...
type V1beta1NodePool_Config_LinuxNodeConfig struct {
...
type V1beta1NodePool_Config_LoggingConfig_VariantConfig struct {
	// Logging variant deployed on nodes.
	Variant any
}

type V1beta1NodePool_Config_LoggingConfig struct {
	// LoggingVariantConfig specifies the behaviour of the logging component.
	VariantConfig any
}

type V1beta1NodePool_Config_NodeImageConfig struct {
...
type V1beta1NodePool_Config_ReservationAffinity struct {
...
type V1beta1NodePool_Config_ResourceManagerTags struct {
...
type V1beta1NodePool_Config_SandboxConfig struct {
...
type V1beta1NodePool_Config_TaintConfig struct {
...
type V1beta1NodePool_Config_WorkloadMetadataConfig struct {
...
type V1beta1NodePool_Config struct {
...
type V1beta1NodePool_KubeletCertInfo struct {
	// Output only.
...
type V1beta1NodePool_MaintenancePolicy_ExclusionUntilEndOfSupport struct {
...
type V1beta1NodePool_MaintenancePolicy struct {
	// Defines the maintenance exclusion for the node pool.
	ExclusionUntilEndOfSupport any
}

type V1beta1NodePool_Management_UpgradeOptions struct {
...
type V1beta1NodePool_Management struct {
...
type V1beta1NodePool_MaxPodsConstraint struct {
...
type V1beta1NodePool_NetworkConfig_NetworkTierConfig struct {
	// Network tier configuration.
	NetworkTier any
}

type V1beta1NodePool_NetworkConfig_PodCidrOverprovisionConfig struct {
	// Whether Pod CIDR overprovisioning is disabled. Note: Pod CIDR overprovisioning is enabled by default.
	Disable any
}

type V1beta1NodePool_NetworkConfig struct {
...
type V1beta1NodePool_NodeDrainConfig struct {
...
type V1beta1NodePool_NodePool_PlacementPolicy struct {
...
type V1beta1NodePool_NodePool_UpdateInfo_BlueGreenInfo struct {
...
type V1beta1NodePool_NodePool_UpdateInfo struct {
	// Information relevant to blue-green upgrade.
	BlueGreenInfo any
}

type V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings_AutoscaledRolloutPolicy struct {
...
type V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings_StandardRolloutPolicy struct {
...
type V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings struct {
...
type V1beta1NodePool_NodePool_UpgradeSettings struct {
...
type V1beta1NodePool_NodePool struct {
...
type V1beta1NodePoolAttrs struct {
	// AutopilotConfig contains configuration of autopilot feature for this node pool.
	AutopilotConfig any
	// NodePoolAutoscaling contains information required by cluster autoscaler to adjust the size of the node pool to the current cluster usage.
	Autoscaling any
...
var V1beta1NodePool = ubx.ResourceBinding{
