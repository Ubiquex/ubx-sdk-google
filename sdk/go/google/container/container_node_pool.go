...
type ContainerNodePool_AutopilotConfig struct {
	// Denotes that nodes belonging to this node pool are Autopilot nodes.
	Enabled any
}

type ContainerNodePool_Autoscaling struct {
...
type ContainerNodePool_BestEffortProvisioning struct {
...
type ContainerNodePool_Conditions struct {
	CanonicalCode any
	Code any
	Message any
}

type ContainerNodePool_Config_Accelerators_GpuDriverInstallationConfig struct {
	GpuDriverVersion any
}

type ContainerNodePool_Config_Accelerators_GpuSharingConfig struct {
	GpuSharingStrategy any
	MaxSharedClientsPerGpu any
}

type ContainerNodePool_Config_Accelerators struct {
...
type ContainerNodePool_Config_AdvancedMachineFeatures struct {
...
type ContainerNodePool_Config_BootDisk struct {
...
type ContainerNodePool_Config_ConfidentialNodes struct {
...
type ContainerNodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfig_GcpSecretManagerCertificateConfig struct {
	SecretUri any
}

type ContainerNodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfig struct {
	Fqdns any
	GcpSecretManagerCertificateConfig any
}

type ContainerNodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig struct {
...
type ContainerNodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Ca struct {
	GcpSecretManagerSecretUri any
}

type ContainerNodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Client struct {
	Cert any
	Key any
}

type ContainerNodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Header struct {
	Key any
	Value any
}

type ContainerNodePool_Config_ContainerdConfig_RegistryHosts_Hosts struct {
	Ca any
	Capabilities any
	Client any
	DialTimeout any
...
type ContainerNodePool_Config_ContainerdConfig_RegistryHosts struct {
	Hosts any
	Server any
}

type ContainerNodePool_Config_ContainerdConfig struct {
...
type ContainerNodePool_Config_EphemeralStorageLocalSsdConfig struct {
...
type ContainerNodePool_Config_GpuDirectConfig struct {
	// The type of GPU direct strategy to enable on the node pool.
	GpuDirectStrategy any
}

type ContainerNodePool_Config_KubeletConfig_CrashLoopBackOff struct {
...
type ContainerNodePool_Config_KubeletConfig_EvictionMinimumReclaim struct {
...
type ContainerNodePool_Config_KubeletConfig_MemoryManager struct {
...
type ContainerNodePool_Config_KubeletConfig_TopologyManager struct {
...
type ContainerNodePool_Config_KubeletConfig struct {
...
type ContainerNodePool_Config_LinuxNodeConfig_AccurateTimeConfig struct {
	// Enables enhanced time synchronization using PTP-KVM.
	EnablePtpKvmTimeSync any
}

type ContainerNodePool_Config_LinuxNodeConfig_CustomNodeInit_InitScript struct {
...
type ContainerNodePool_Config_LinuxNodeConfig_CustomNodeInit struct {
	// InitScript provide a simply bash script to be executed on the node.
	InitScript any
}

type ContainerNodePool_Config_LinuxNodeConfig_DiskIoScheduler struct {
...
type ContainerNodePool_Config_LinuxNodeConfig_Hugepages struct {
...
type ContainerNodePool_Config_LinuxNodeConfig_NodeVfioConfig struct {
...
type ContainerNodePool_Config_LinuxNodeConfig_SwapConfig_BootDiskProfile struct {
...
type ContainerNodePool_Config_LinuxNodeConfig_SwapConfig_DedicatedLocalSsdProfile struct {
	// The number of physical local NVMe SSD disks to attach.
	DiskCount any
}

type ContainerNodePool_Config_LinuxNodeConfig_SwapConfig_EncryptionConfig struct {
	// Optional. If true, swap space will not be encrypted. Defaults to false (encrypted).
	Disabled any
}

type ContainerNodePool_Config_LinuxNodeConfig_SwapConfig struct {
...
type ContainerNodePool_Config_LinuxNodeConfig struct {
...
type ContainerNodePool_Config_LocalNvmeSsdBlockConfig struct {
...
type ContainerNodePool_Config_LoggingConfig_VariantConfig struct {
	// Logging variant deployed on nodes.
	Variant any
}

type ContainerNodePool_Config_LoggingConfig struct {
	// LoggingVariantConfig specifies the behaviour of the logging component.
	VariantConfig any
}

type ContainerNodePool_Config_NodeImageConfig struct {
...
type ContainerNodePool_Config_ReservationAffinity struct {
...
type ContainerNodePool_Config_ResourceManagerTags struct {
...
type ContainerNodePool_Config_SandboxConfig struct {
	// Type of the sandbox to use for the node.
	Type any
}

type ContainerNodePool_Config_SecondaryBootDisks struct {
	DiskImage any
	Mode any
}

type ContainerNodePool_Config_ShieldedInstanceConfig struct {
...
type ContainerNodePool_Config_SoleTenantConfig_NodeAffinities struct {
	Key any
	Operator any
	Values any
}

type ContainerNodePool_Config_SoleTenantConfig struct {
...
type ContainerNodePool_Config_TaintConfig struct {
	// Optional. Controls architecture tainting behavior.
	ArchitectureTaintBehavior any
}

type ContainerNodePool_Config_Taints struct {
	Effect any
	Key any
	Value any
}

type ContainerNodePool_Config_WindowsNodeConfig struct {
	// OSVersion specifies the Windows node config to be used on the node.
	OsVersion any
}

type ContainerNodePool_Config_WorkloadMetadataConfig struct {
	// Mode is the configuration for how to expose metadata to workloads running on the node pool.
	Mode any
}

type ContainerNodePool_Config struct {
...
type ContainerNodePool_KubeletCertInfo struct {
	// Output only.
...
type ContainerNodePool_MaintenancePolicy_ExclusionUntilEndOfSupport struct {
...
type ContainerNodePool_MaintenancePolicy struct {
	// Defines the maintenance exclusion for the node pool.
	ExclusionUntilEndOfSupport any
}

type ContainerNodePool_Management_UpgradeOptions struct {
...
type ContainerNodePool_Management struct {
...
type ContainerNodePool_MaxPodsConstraint struct {
	// Constraint enforced on the max num of pods per node.
	MaxPodsPerNode any
}

type ContainerNodePool_NetworkConfig_AdditionalNodeNetworkConfigs struct {
	Network any
	Subnetwork any
}

type ContainerNodePool_NetworkConfig_AdditionalPodNetworkConfigs struct {
	MaxPodsPerNode any
...
type ContainerNodePool_NetworkConfig_NetworkPerformanceConfig struct {
	// Specifies the total network bandwidth tier for the NodePool.
	TotalEgressBandwidthTier any
}

type ContainerNodePool_NetworkConfig_NetworkTierConfig struct {
	// Network tier configuration.
	NetworkTier any
}

type ContainerNodePool_NetworkConfig_PodCidrOverprovisionConfig struct {
	// Whether Pod CIDR overprovisioning is disabled. Note: Pod CIDR overprovisioning is enabled by default.
	Disable any
}

type ContainerNodePool_NetworkConfig struct {
...
type ContainerNodePool_NodeDrainConfig struct {
...
type ContainerNodePool_NodePool_PlacementPolicy struct {
...
type ContainerNodePool_NodePool_UpdateInfo_BlueGreenInfo struct {
...
type ContainerNodePool_NodePool_UpdateInfo struct {
	// Information relevant to blue-green upgrade.
	BlueGreenInfo any
}

type ContainerNodePool_NodePool_UpgradeSettings_BlueGreenSettings_AutoscaledRolloutPolicy struct {
...
type ContainerNodePool_NodePool_UpgradeSettings_BlueGreenSettings_StandardRolloutPolicy struct {
...
type ContainerNodePool_NodePool_UpgradeSettings_BlueGreenSettings struct {
...
type ContainerNodePool_NodePool_UpgradeSettings struct {
...
type ContainerNodePool_NodePool struct {
...
var ContainerNodePool_AutopilotConfigFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
	}

var ContainerNodePool_AutoscalingFields = ubx.FieldMap{
...
var ContainerNodePool_BestEffortProvisioningFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
		"MinProvisionNodes": ubx.FieldSpec{WireName: "min_provision_nodes"},
	}

var ContainerNodePool_ConditionsFields = ubx.FieldMap{
		"CanonicalCode": ubx.FieldSpec{WireName: "canonical_code"},
		"Code": ubx.FieldSpec{WireName: "code"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var ContainerNodePool_Config_Accelerators_GpuDriverInstallationConfigFields = ubx.FieldMap{
		"GpuDriverVersion": ubx.FieldSpec{WireName: "gpu_driver_version"},
	}

var ContainerNodePool_Config_Accelerators_GpuSharingConfigFields = ubx.FieldMap{
...
var ContainerNodePool_Config_AcceleratorsFields = ubx.FieldMap{
...
var ContainerNodePool_Config_AdvancedMachineFeaturesFields = ubx.FieldMap{
...
var ContainerNodePool_Config_BootDiskFields = ubx.FieldMap{
...
var ContainerNodePool_Config_ConfidentialNodesFields = ubx.FieldMap{
		"ConfidentialInstanceType": ubx.FieldSpec{WireName: "confidential_instance_type"},
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
	}

var ContainerNodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfig_GcpSecretManagerCertificateConfigFields = ubx.FieldMap{
		"SecretUri": ubx.FieldSpec{WireName: "secret_uri"},
	}

var ContainerNodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfigFields = ubx.FieldMap{
...
var ContainerNodePool_Config_ContainerdConfig_PrivateRegistryAccessConfigFields = ubx.FieldMap{
...
var ContainerNodePool_Config_ContainerdConfig_RegistryHosts_Hosts_CaFields = ubx.FieldMap{
		"GcpSecretManagerSecretUri": ubx.FieldSpec{WireName: "gcp_secret_manager_secret_uri"},
	}

var ContainerNodePool_Config_ContainerdConfig_RegistryHosts_Hosts_ClientFields = ubx.FieldMap{
		"Cert": ubx.FieldSpec{
			WireName: "cert",
			Kind: "object",
...
var ContainerNodePool_Config_ContainerdConfig_RegistryHosts_Hosts_HeaderFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var ContainerNodePool_Config_ContainerdConfig_RegistryHosts_HostsFields = ubx.FieldMap{
		"Ca": ubx.FieldSpec{
			WireName: "ca",
			Kind: "list",
			Fields: ContainerNodePool_Config_ContainerdConfig_RegistryHosts_Hosts_CaFields,
...
var ContainerNodePool_Config_ContainerdConfig_RegistryHostsFields = ubx.FieldMap{
		"Hosts": ubx.FieldSpec{
			WireName: "hosts",
			Kind: "list",
...
var ContainerNodePool_Config_ContainerdConfigFields = ubx.FieldMap{
...
var ContainerNodePool_Config_EphemeralStorageLocalSsdConfigFields = ubx.FieldMap{
		"DataCacheCount": ubx.FieldSpec{WireName: "data_cache_count"},
		"LocalSsdCount": ubx.FieldSpec{WireName: "local_ssd_count"},
	}

var ContainerNodePool_Config_GpuDirectConfigFields = ubx.FieldMap{
		"GpuDirectStrategy": ubx.FieldSpec{WireName: "gpu_direct_strategy"},
	}

var ContainerNodePool_Config_KubeletConfig_CrashLoopBackOffFields = ubx.FieldMap{
		"MaxContainerRestartPeriod": ubx.FieldSpec{WireName: "max_container_restart_period"},
	}

var ContainerNodePool_Config_KubeletConfig_EvictionMinimumReclaimFields = ubx.FieldMap{
...
var ContainerNodePool_Config_KubeletConfig_MemoryManagerFields = ubx.FieldMap{
		"Policy": ubx.FieldSpec{WireName: "policy"},
	}

var ContainerNodePool_Config_KubeletConfig_TopologyManagerFields = ubx.FieldMap{
		"Policy": ubx.FieldSpec{WireName: "policy"},
		"Scope": ubx.FieldSpec{WireName: "scope"},
	}

var ContainerNodePool_Config_KubeletConfigFields = ubx.FieldMap{
...
var ContainerNodePool_Config_LinuxNodeConfig_AccurateTimeConfigFields = ubx.FieldMap{
		"EnablePtpKvmTimeSync": ubx.FieldSpec{WireName: "enable_ptp_kvm_time_sync"},
	}

var ContainerNodePool_Config_LinuxNodeConfig_CustomNodeInit_InitScriptFields = ubx.FieldMap{
...
var ContainerNodePool_Config_LinuxNodeConfig_CustomNodeInitFields = ubx.FieldMap{
...
var ContainerNodePool_Config_LinuxNodeConfig_DiskIoSchedulerFields = ubx.FieldMap{
...
var ContainerNodePool_Config_LinuxNodeConfig_HugepagesFields = ubx.FieldMap{
		"HugepageSize1g": ubx.FieldSpec{WireName: "hugepage_size1g"},
		"HugepageSize2m": ubx.FieldSpec{WireName: "hugepage_size2m"},
	}

var ContainerNodePool_Config_LinuxNodeConfig_NodeVfioConfigFields = ubx.FieldMap{
		"DmaEntryLimit": ubx.FieldSpec{WireName: "dma_entry_limit"},
	}

var ContainerNodePool_Config_LinuxNodeConfig_SwapConfig_BootDiskProfileFields = ubx.FieldMap{
		"SwapSizeGib": ubx.FieldSpec{WireName: "swap_size_gib"},
		"SwapSizePercent": ubx.FieldSpec{WireName: "swap_size_percent"},
	}

var ContainerNodePool_Config_LinuxNodeConfig_SwapConfig_DedicatedLocalSsdProfileFields = ubx.FieldMap{
		"DiskCount": ubx.FieldSpec{WireName: "disk_count"},
	}

var ContainerNodePool_Config_LinuxNodeConfig_SwapConfig_EncryptionConfigFields = ubx.FieldMap{
		"Disabled": ubx.FieldSpec{WireName: "disabled"},
	}

var ContainerNodePool_Config_LinuxNodeConfig_SwapConfigFields = ubx.FieldMap{
...
var ContainerNodePool_Config_LinuxNodeConfigFields = ubx.FieldMap{
...
var ContainerNodePool_Config_LocalNvmeSsdBlockConfigFields = ubx.FieldMap{
		"LocalSsdCount": ubx.FieldSpec{WireName: "local_ssd_count"},
	}

var ContainerNodePool_Config_LoggingConfig_VariantConfigFields = ubx.FieldMap{
		"Variant": ubx.FieldSpec{WireName: "variant"},
	}

var ContainerNodePool_Config_LoggingConfigFields = ubx.FieldMap{
...
var ContainerNodePool_Config_NodeImageConfigFields = ubx.FieldMap{
		"Image": ubx.FieldSpec{WireName: "image"},
		"ImageProject": ubx.FieldSpec{WireName: "image_project"},
	}

var ContainerNodePool_Config_ReservationAffinityFields = ubx.FieldMap{
		"ConsumeReservationType": ubx.FieldSpec{WireName: "consume_reservation_type"},
		"Key": ubx.FieldSpec{WireName: "key"},
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var ContainerNodePool_Config_ResourceManagerTagsFields = ubx.FieldMap{
		"Tags": ubx.FieldSpec{WireName: "tags"},
	}

var ContainerNodePool_Config_SandboxConfigFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var ContainerNodePool_Config_SecondaryBootDisksFields = ubx.FieldMap{
		"DiskImage": ubx.FieldSpec{WireName: "disk_image"},
		"Mode": ubx.FieldSpec{WireName: "mode"},
	}

var ContainerNodePool_Config_ShieldedInstanceConfigFields = ubx.FieldMap{
...
var ContainerNodePool_Config_SoleTenantConfig_NodeAffinitiesFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Operator": ubx.FieldSpec{WireName: "operator"},
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var ContainerNodePool_Config_SoleTenantConfigFields = ubx.FieldMap{
...
var ContainerNodePool_Config_TaintConfigFields = ubx.FieldMap{
		"ArchitectureTaintBehavior": ubx.FieldSpec{WireName: "architecture_taint_behavior"},
	}

var ContainerNodePool_Config_TaintsFields = ubx.FieldMap{
		"Effect": ubx.FieldSpec{WireName: "effect"},
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var ContainerNodePool_Config_WindowsNodeConfigFields = ubx.FieldMap{
		"OsVersion": ubx.FieldSpec{WireName: "os_version"},
	}

var ContainerNodePool_Config_WorkloadMetadataConfigFields = ubx.FieldMap{
		"Mode": ubx.FieldSpec{WireName: "mode"},
	}

var ContainerNodePool_ConfigFields = ubx.FieldMap{
...
var ContainerNodePool_KubeletCertInfoFields = ubx.FieldMap{
...
var ContainerNodePool_MaintenancePolicy_ExclusionUntilEndOfSupportFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
		"EndTime": ubx.FieldSpec{WireName: "end_time"},
		"StartTime": ubx.FieldSpec{WireName: "start_time"},
	}

var ContainerNodePool_MaintenancePolicyFields = ubx.FieldMap{
...
var ContainerNodePool_Management_UpgradeOptionsFields = ubx.FieldMap{
		"AutoUpgradeStartTime": ubx.FieldSpec{WireName: "auto_upgrade_start_time"},
		"Description": ubx.FieldSpec{WireName: "description"},
	}

var ContainerNodePool_ManagementFields = ubx.FieldMap{
...
var ContainerNodePool_MaxPodsConstraintFields = ubx.FieldMap{
		"MaxPodsPerNode": ubx.FieldSpec{WireName: "max_pods_per_node"},
	}

var ContainerNodePool_NetworkConfig_AdditionalNodeNetworkConfigsFields = ubx.FieldMap{
		"Network": ubx.FieldSpec{WireName: "network"},
		"Subnetwork": ubx.FieldSpec{WireName: "subnetwork"},
	}

var ContainerNodePool_NetworkConfig_AdditionalPodNetworkConfigsFields = ubx.FieldMap{
...
var ContainerNodePool_NetworkConfig_NetworkPerformanceConfigFields = ubx.FieldMap{
		"TotalEgressBandwidthTier": ubx.FieldSpec{WireName: "total_egress_bandwidth_tier"},
	}

var ContainerNodePool_NetworkConfig_NetworkTierConfigFields = ubx.FieldMap{
		"NetworkTier": ubx.FieldSpec{WireName: "network_tier"},
	}

var ContainerNodePool_NetworkConfig_PodCidrOverprovisionConfigFields = ubx.FieldMap{
		"Disable": ubx.FieldSpec{WireName: "disable"},
	}

var ContainerNodePool_NetworkConfigFields = ubx.FieldMap{
...
var ContainerNodePool_NodeDrainConfigFields = ubx.FieldMap{
...
var ContainerNodePool_NodePool_PlacementPolicyFields = ubx.FieldMap{
		"PolicyName": ubx.FieldSpec{WireName: "policy_name"},
		"TpuTopology": ubx.FieldSpec{WireName: "tpu_topology"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var ContainerNodePool_NodePool_UpdateInfo_BlueGreenInfoFields = ubx.FieldMap{
...
var ContainerNodePool_NodePool_UpdateInfoFields = ubx.FieldMap{
...
var ContainerNodePool_NodePool_UpgradeSettings_BlueGreenSettings_AutoscaledRolloutPolicyFields = ubx.FieldMap{
		"WaitForDrainDuration": ubx.FieldSpec{WireName: "wait_for_drain_duration"},
	}

var ContainerNodePool_NodePool_UpgradeSettings_BlueGreenSettings_StandardRolloutPolicyFields = ubx.FieldMap{
...
var ContainerNodePool_NodePool_UpgradeSettings_BlueGreenSettingsFields = ubx.FieldMap{
...
var ContainerNodePool_NodePool_UpgradeSettingsFields = ubx.FieldMap{
...
var ContainerNodePool_NodePoolFields = ubx.FieldMap{
...
type ContainerNodePoolAttrs struct {
	// AutopilotConfig contains configuration of autopilot feature for this node pool.
	AutopilotConfig any
	// NodePoolAutoscaling contains information required by cluster autoscaler to adjust the size of the node pool to the current cluster usage.
	Autoscaling any
...
var ContainerNodePool = ubx.ResourceBinding{
