...
type V1betaEngine_AgentGatewaySetting_DefaultEgressAgentGateway struct {
...
type V1betaEngine_AgentGatewaySetting struct {
	// Reference to an Agent Gateway resource.
	DefaultEgressAgentGateway any
}

type V1betaEngine_ChatEngineConfig_AgentCreationConfig struct {
...
type V1betaEngine_ChatEngineConfig struct {
...
type V1betaEngine_ChatEngineMetadata struct {
	// The resource name of a Dialogflow agent, that this Chat Engine refers to. Format: `projects//locations//agents/`.
	DialogflowAgent any
}

type V1betaEngine_CmekConfig_SingleRegionKeys struct {
	KmsKey any
}

type V1betaEngine_CmekConfig struct {
...
type V1betaEngine_CommonConfig struct {
	// The name of the company, business or entity that is associated with the engine. Setting this may help improve LLM related features.
	CompanyName any
}

type V1betaEngine_KnowledgeGraphConfig_FeatureConfig struct {
...
type V1betaEngine_KnowledgeGraphConfig struct {
...
type V1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfig struct {
...
type V1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfig struct {
...
type V1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig struct {
...
type V1betaEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfig struct {
...
type V1betaEngine_MediaRecommendationEngineConfig struct {
...
type V1betaEngine_ObservabilityConfig struct {
...
type V1betaEngine_SearchEngineConfig struct {
...
var V1betaEngine_AgentGatewaySetting_DefaultEgressAgentGatewayFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var V1betaEngine_AgentGatewaySettingFields = ubx.FieldMap{
...
var V1betaEngine_ChatEngineConfig_AgentCreationConfigFields = ubx.FieldMap{
...
var V1betaEngine_ChatEngineConfigFields = ubx.FieldMap{
...
var V1betaEngine_ChatEngineMetadataFields = ubx.FieldMap{
		"DialogflowAgent": ubx.FieldSpec{WireName: "dialogflow_agent"},
	}

var V1betaEngine_CmekConfig_SingleRegionKeysFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
	}

var V1betaEngine_CmekConfigFields = ubx.FieldMap{
...
var V1betaEngine_CommonConfigFields = ubx.FieldMap{
		"CompanyName": ubx.FieldSpec{WireName: "company_name"},
	}

var V1betaEngine_KnowledgeGraphConfig_FeatureConfigFields = ubx.FieldMap{
...
var V1betaEngine_KnowledgeGraphConfigFields = ubx.FieldMap{
...
var V1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfigFields = ubx.FieldMap{
		"TimeWindowDays": ubx.FieldSpec{WireName: "time_window_days"},
	}

var V1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfigFields = ubx.FieldMap{
		"ContextEventType": ubx.FieldSpec{WireName: "context_event_type"},
	}

var V1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfigFields = ubx.FieldMap{
...
var V1betaEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfigFields = ubx.FieldMap{
		"TargetField": ubx.FieldSpec{WireName: "target_field"},
		"TargetFieldValueFloat": ubx.FieldSpec{WireName: "target_field_value_float"},
	}

var V1betaEngine_MediaRecommendationEngineConfigFields = ubx.FieldMap{
...
var V1betaEngine_ObservabilityConfigFields = ubx.FieldMap{
...
var V1betaEngine_SearchEngineConfigFields = ubx.FieldMap{
...
type V1betaEngineConfig struct {
...
var V1betaEngine = ubx.ResourceBinding{
