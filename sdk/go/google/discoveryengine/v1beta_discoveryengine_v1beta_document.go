...
type V1betaDiscoveryengineV1betaDocument_AclInfo_Readers_Principals struct {
	ExternalEntityId any
	GroupId any
	UserId any
}

type V1betaDiscoveryengineV1betaDocument_AclInfo_Readers struct {
	IdpWide any
	Principals any
}

type V1betaDiscoveryengineV1betaDocument_AclInfo struct {
	// Readers of the document.
	Readers any
}

type V1betaDiscoveryengineV1betaDocument_Content struct {
...
type V1betaDiscoveryengineV1betaDocument_IndexStatus_ErrorSamples struct {
	Code any
	Details any
	Message any
}

type V1betaDiscoveryengineV1betaDocument_IndexStatus struct {
...
var V1betaDiscoveryengineV1betaDocument_AclInfo_Readers_PrincipalsFields = ubx.FieldMap{
		"ExternalEntityId": ubx.FieldSpec{WireName: "external_entity_id"},
		"GroupId": ubx.FieldSpec{WireName: "group_id"},
		"UserId": ubx.FieldSpec{WireName: "user_id"},
	}

var V1betaDiscoveryengineV1betaDocument_AclInfo_ReadersFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDocument_AclInfoFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDocument_ContentFields = ubx.FieldMap{
		"MimeType": ubx.FieldSpec{WireName: "mime_type"},
		"RawBytes": ubx.FieldSpec{WireName: "raw_bytes"},
		"Uri": ubx.FieldSpec{WireName: "uri"},
	}

var V1betaDiscoveryengineV1betaDocument_IndexStatus_ErrorSamplesFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var V1betaDiscoveryengineV1betaDocument_IndexStatusFields = ubx.FieldMap{
...
type V1betaDiscoveryengineV1betaDocumentConfig struct {
...
type V1betaDiscoveryengineV1betaDocumentAttrs struct {
	// ACL Information of the Document.
	AclInfo any
	// Unstructured data linked to this document.
	Content any
...
var V1betaDiscoveryengineV1betaDocument = ubx.ResourceBinding{
