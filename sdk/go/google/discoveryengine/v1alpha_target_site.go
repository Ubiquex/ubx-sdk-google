...
type V1alphaTargetSite_FailureReason_QuotaFailure struct {
...
type V1alphaTargetSite_FailureReason struct {
	// Failed due to insufficient quota.
	QuotaFailure any
}

type V1alphaTargetSite_SiteVerificationInfo struct {
...
var V1alphaTargetSite = ubx.ResourceBinding{
