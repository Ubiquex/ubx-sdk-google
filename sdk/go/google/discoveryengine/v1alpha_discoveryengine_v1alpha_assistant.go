...
type V1alphaDiscoveryengineV1alphaAssistant_CustomerPolicy_BannedPhrases struct {
	IgnoreDiacritics any
	MatchType any
	Phrase any
}

type V1alphaDiscoveryengineV1alphaAssistant_CustomerPolicy_DataProtectionPolicy_SensitiveDataProtectionPolicy struct {
	// Optional. Specifies the resource name of the Sensitive Data Protection content policy.
	Policy any
}

type V1alphaDiscoveryengineV1alphaAssistant_CustomerPolicy_DataProtectionPolicy struct {
...
type V1alphaDiscoveryengineV1alphaAssistant_CustomerPolicy_ModelArmorConfig struct {
...
type V1alphaDiscoveryengineV1alphaAssistant_CustomerPolicy struct {
...
type V1alphaDiscoveryengineV1alphaAssistant_EnabledTools_ToolInfo struct {
	ToolDisplayName any
	ToolName any
}

type V1alphaDiscoveryengineV1alphaAssistant_EnabledTools struct {
	ToolInfo any
}

type V1alphaDiscoveryengineV1alphaAssistant_GenerationConfig_SystemInstruction struct {
...
type V1alphaDiscoveryengineV1alphaAssistant_GenerationConfig struct {
...
var V1alphaDiscoveryengineV1alphaAssistant_CustomerPolicy_BannedPhrasesFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaAssistant_CustomerPolicy_DataProtectionPolicy_SensitiveDataProtectionPolicyFields = ubx.FieldMap{
		"Policy": ubx.FieldSpec{WireName: "policy"},
	}

var V1alphaDiscoveryengineV1alphaAssistant_CustomerPolicy_DataProtectionPolicyFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaAssistant_CustomerPolicy_ModelArmorConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaAssistant_CustomerPolicyFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaAssistant_EnabledTools_ToolInfoFields = ubx.FieldMap{
		"ToolDisplayName": ubx.FieldSpec{WireName: "tool_display_name"},
		"ToolName": ubx.FieldSpec{WireName: "tool_name"},
	}

var V1alphaDiscoveryengineV1alphaAssistant_EnabledToolsFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaAssistant_GenerationConfig_SystemInstructionFields = ubx.FieldMap{
		"AdditionalSystemInstruction": ubx.FieldSpec{WireName: "additional_system_instruction"},
	}

var V1alphaDiscoveryengineV1alphaAssistant_GenerationConfigFields = ubx.FieldMap{
...
type V1alphaDiscoveryengineV1alphaAssistantConfig struct {
...
type V1alphaDiscoveryengineV1alphaAssistantAttrs struct {
	// Output only. Represents the time when this Assistant was created.
	CreateTime any
	// Customer-defined policy for the assistant.
	CustomerPolicy any
...
var V1alphaDiscoveryengineV1alphaAssistant = ubx.ResourceBinding{
