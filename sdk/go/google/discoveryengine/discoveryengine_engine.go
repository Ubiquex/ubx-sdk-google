...
type DiscoveryengineEngine_AgentGatewaySetting_DefaultEgressAgentGateway struct {
...
type DiscoveryengineEngine_AgentGatewaySetting struct {
	// Reference to an Agent Gateway resource.
	DefaultEgressAgentGateway any
}

type DiscoveryengineEngine_ChatEngineConfig_AgentCreationConfig struct {
...
type DiscoveryengineEngine_ChatEngineConfig struct {
...
type DiscoveryengineEngine_ChatEngineMetadata struct {
	// The resource name of a Dialogflow agent, that this Chat Engine refers to. Format: `projects//locations//agents/`.
	DialogflowAgent any
}

type DiscoveryengineEngine_CmekConfig_SingleRegionKeys struct {
	KmsKey any
}

type DiscoveryengineEngine_CmekConfig struct {
...
type DiscoveryengineEngine_CommonConfig struct {
	// The name of the company, business or entity that is associated with the engine. Setting this may help improve LLM related features.
	CompanyName any
}

type DiscoveryengineEngine_KnowledgeGraphConfig_FeatureConfig struct {
...
type DiscoveryengineEngine_KnowledgeGraphConfig struct {
...
type DiscoveryengineEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfig struct {
...
type DiscoveryengineEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfig struct {
...
type DiscoveryengineEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig struct {
...
type DiscoveryengineEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfig struct {
...
type DiscoveryengineEngine_MediaRecommendationEngineConfig struct {
...
type DiscoveryengineEngine_ObservabilityConfig struct {
...
type DiscoveryengineEngine_SearchEngineConfig struct {
...
var DiscoveryengineEngine_AgentGatewaySetting_DefaultEgressAgentGatewayFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var DiscoveryengineEngine_AgentGatewaySettingFields = ubx.FieldMap{
...
var DiscoveryengineEngine_ChatEngineConfig_AgentCreationConfigFields = ubx.FieldMap{
...
var DiscoveryengineEngine_ChatEngineConfigFields = ubx.FieldMap{
...
var DiscoveryengineEngine_ChatEngineMetadataFields = ubx.FieldMap{
		"DialogflowAgent": ubx.FieldSpec{WireName: "dialogflow_agent"},
	}

var DiscoveryengineEngine_CmekConfig_SingleRegionKeysFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
	}

var DiscoveryengineEngine_CmekConfigFields = ubx.FieldMap{
...
var DiscoveryengineEngine_CommonConfigFields = ubx.FieldMap{
		"CompanyName": ubx.FieldSpec{WireName: "company_name"},
	}

var DiscoveryengineEngine_KnowledgeGraphConfig_FeatureConfigFields = ubx.FieldMap{
...
var DiscoveryengineEngine_KnowledgeGraphConfigFields = ubx.FieldMap{
...
var DiscoveryengineEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfigFields = ubx.FieldMap{
		"TimeWindowDays": ubx.FieldSpec{WireName: "time_window_days"},
	}

var DiscoveryengineEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfigFields = ubx.FieldMap{
		"ContextEventType": ubx.FieldSpec{WireName: "context_event_type"},
	}

var DiscoveryengineEngine_MediaRecommendationEngineConfig_EngineFeaturesConfigFields = ubx.FieldMap{
...
var DiscoveryengineEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfigFields = ubx.FieldMap{
		"TargetField": ubx.FieldSpec{WireName: "target_field"},
		"TargetFieldValueFloat": ubx.FieldSpec{WireName: "target_field_value_float"},
	}

var DiscoveryengineEngine_MediaRecommendationEngineConfigFields = ubx.FieldMap{
...
var DiscoveryengineEngine_ObservabilityConfigFields = ubx.FieldMap{
...
var DiscoveryengineEngine_SearchEngineConfigFields = ubx.FieldMap{
...
type DiscoveryengineEngineConfig struct {
...
type DiscoveryengineEngineAttrs struct {
	// Agent Gateway setting, which may be attached to Gemini Enterprise resources for egress control of Gemini Enterprise agents to agents and tools outside of Gemini Enterprise.
	AgentGatewaySetting any
	// Optional. Immutable. This the application type which this engine resource represents. NOTE: this is a new concept independ of existing industry vertical or solution type.
	AppType any
...
var DiscoveryengineEngine = ubx.ResourceBinding{
