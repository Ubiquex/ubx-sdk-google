...
type V1alphaAssistant_CustomerPolicy_DataProtectionPolicy struct {
...
type V1alphaAssistant_CustomerPolicy_ModelArmorConfig struct {
...
type V1alphaAssistant_CustomerPolicy struct {
...
type V1alphaAssistant_GenerationConfig_SystemInstruction struct {
...
type V1alphaAssistant_GenerationConfig struct {
...
type V1alphaAssistantAttrs struct {
...
var V1alphaAssistant = ubx.ResourceBinding{
	...
	Fields: ubx.FieldMap{
		...
		"KnowledgeCatalogEnabled": ubx.FieldSpec{WireName: "knowledge_catalog_enabled"},
