...
type V1alphaDiscoveryengineV1alphaControl_BoostAction_InterpolationBoostSpec_ControlPoints struct {
	AttributeValue any
	BoostAmount any
}

type V1alphaDiscoveryengineV1alphaControl_BoostAction_InterpolationBoostSpec struct {
...
type V1alphaDiscoveryengineV1alphaControl_BoostAction struct {
...
type V1alphaDiscoveryengineV1alphaControl_Conditions_ActiveTimeRange struct {
	EndTime any
	StartTime any
}

type V1alphaDiscoveryengineV1alphaControl_Conditions_QueryTerms struct {
	FullMatch any
	Value any
}

type V1alphaDiscoveryengineV1alphaControl_Conditions struct {
	ActiveTimeRange any
	QueryRegex any
	QueryTerms any
}

type V1alphaDiscoveryengineV1alphaControl_FilterAction struct {
...
type V1alphaDiscoveryengineV1alphaControl_PromoteAction_SearchLinkPromotion struct {
...
type V1alphaDiscoveryengineV1alphaControl_PromoteAction struct {
...
type V1alphaDiscoveryengineV1alphaControl_RedirectAction struct {
...
type V1alphaDiscoveryengineV1alphaControl_SynonymsAction struct {
...
var V1alphaDiscoveryengineV1alphaControl_BoostAction_InterpolationBoostSpec_ControlPointsFields = ubx.FieldMap{
		"AttributeValue": ubx.FieldSpec{WireName: "attribute_value"},
		"BoostAmount": ubx.FieldSpec{WireName: "boost_amount"},
	}

var V1alphaDiscoveryengineV1alphaControl_BoostAction_InterpolationBoostSpecFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaControl_BoostActionFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaControl_Conditions_ActiveTimeRangeFields = ubx.FieldMap{
		"EndTime": ubx.FieldSpec{WireName: "end_time"},
		"StartTime": ubx.FieldSpec{WireName: "start_time"},
	}

var V1alphaDiscoveryengineV1alphaControl_Conditions_QueryTermsFields = ubx.FieldMap{
		"FullMatch": ubx.FieldSpec{WireName: "full_match"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var V1alphaDiscoveryengineV1alphaControl_ConditionsFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaControl_FilterActionFields = ubx.FieldMap{
		"DataStore": ubx.FieldSpec{WireName: "data_store"},
		"Filter": ubx.FieldSpec{WireName: "filter"},
	}

var V1alphaDiscoveryengineV1alphaControl_PromoteAction_SearchLinkPromotionFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaControl_PromoteActionFields = ubx.FieldMap{
		"DataStore": ubx.FieldSpec{WireName: "data_store"},
...
var V1alphaDiscoveryengineV1alphaControl_RedirectActionFields = ubx.FieldMap{
		"RedirectUri": ubx.FieldSpec{WireName: "redirect_uri"},
	}

var V1alphaDiscoveryengineV1alphaControl_SynonymsActionFields = ubx.FieldMap{
		"Synonyms": ubx.FieldSpec{WireName: "synonyms"},
	}

type V1alphaDiscoveryengineV1alphaControlConfig struct {
...
type V1alphaDiscoveryengineV1alphaControlAttrs struct {
	// Output only. List of all ServingConfig IDs this control is attached to. May take up to 10 minutes to update after changes.
	AssociatedServingConfigIds any
	// Adjusts order of products in returned list.
	BoostAction any
...
var V1alphaDiscoveryengineV1alphaControl = ubx.ResourceBinding{
