...
type V1betaIdentityMappingStore_CmekConfig_SingleRegionKeys struct {
	KmsKey any
}

type V1betaIdentityMappingStore_CmekConfig struct {
...
var V1betaIdentityMappingStore_CmekConfig_SingleRegionKeysFields = ubx.FieldMap{
	"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
}

var V1betaIdentityMappingStore_CmekConfigFields = ubx.FieldMap{
...
type V1betaIdentityMappingStoreConfig struct {
...
type V1betaIdentityMappingStoreAttrs struct {
	// Configurations used to enable CMEK data encryption with Cloud KMS keys.
	CmekConfig any
	// Input only. The KMS key to be used to protect this Identity Mapping Store at creation time. Must be set for requests that need to comply with CMEK Org Policy protections. If this field is set and processed successfully, the Identity Mapping Store will be protected by the KMS key, as indicated in the cmek_config field.
	KmsKeyName any
...
var V1betaIdentityMappingStore = ubx.ResourceBinding{
