...
type DiscoveryengineAssistant_CustomerPolicy_BannedPhrases struct {
	IgnoreDiacritics any
	MatchType any
	Phrase any
}

type DiscoveryengineAssistant_CustomerPolicy_ModelArmorConfig struct {
...
type DiscoveryengineAssistant_CustomerPolicy struct {
...
type DiscoveryengineAssistant_EnabledTools_ToolInfo struct {
	ToolDisplayName any
	ToolName any
}

type DiscoveryengineAssistant_EnabledTools struct {
	ToolInfo any
}

type DiscoveryengineAssistant_GenerationConfig_SystemInstruction struct {
...
type DiscoveryengineAssistant_GenerationConfig struct {
...
var DiscoveryengineAssistant_CustomerPolicy_BannedPhrasesFields = ubx.FieldMap{
...
var DiscoveryengineAssistant_CustomerPolicy_ModelArmorConfigFields = ubx.FieldMap{
...
var DiscoveryengineAssistant_CustomerPolicyFields = ubx.FieldMap{
...
var DiscoveryengineAssistant_EnabledTools_ToolInfoFields = ubx.FieldMap{
		"ToolDisplayName": ubx.FieldSpec{WireName: "tool_display_name"},
		"ToolName": ubx.FieldSpec{WireName: "tool_name"},
	}

var DiscoveryengineAssistant_EnabledToolsFields = ubx.FieldMap{
...
var DiscoveryengineAssistant_GenerationConfig_SystemInstructionFields = ubx.FieldMap{
		"AdditionalSystemInstruction": ubx.FieldSpec{WireName: "additional_system_instruction"},
	}

var DiscoveryengineAssistant_GenerationConfigFields = ubx.FieldMap{
...
type DiscoveryengineAssistantAttrs struct {
	// Output only. Represents the time when this Assistant was created.
	CreateTime any
	// Customer-defined policy for the assistant.
	CustomerPolicy any
...
var DiscoveryengineAssistant = ubx.ResourceBinding{
