...
type V1alphaDiscoveryengineV1alphaIdentityMappingStore_CmekConfig_SingleRegionKeys struct {
	KmsKey any
}

type V1alphaDiscoveryengineV1alphaIdentityMappingStore_CmekConfig struct {
...
type V1alphaDiscoveryengineV1alphaIdentityMappingStore_IdpConfig_ExternalIdpConfig struct {
	// Workforce pool name. Example: "locations/global/workforcePools/pool_id"
	WorkforcePoolName any
}

type V1alphaDiscoveryengineV1alphaIdentityMappingStore_IdpConfig struct {
...
var V1alphaDiscoveryengineV1alphaIdentityMappingStore_CmekConfig_SingleRegionKeysFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
	}

var V1alphaDiscoveryengineV1alphaIdentityMappingStore_CmekConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaIdentityMappingStore_IdpConfig_ExternalIdpConfigFields = ubx.FieldMap{
		"WorkforcePoolName": ubx.FieldSpec{WireName: "workforce_pool_name"},
	}

var V1alphaDiscoveryengineV1alphaIdentityMappingStore_IdpConfigFields = ubx.FieldMap{
...
type V1alphaDiscoveryengineV1alphaIdentityMappingStoreConfig struct {
...
type V1alphaDiscoveryengineV1alphaIdentityMappingStoreAttrs struct {
	// Configurations used to enable CMEK data encryption with Cloud KMS keys.
	CmekConfig any
	// Identity Provider Config.
	IdpConfig any
...
var V1alphaDiscoveryengineV1alphaIdentityMappingStore = ubx.ResourceBinding{
