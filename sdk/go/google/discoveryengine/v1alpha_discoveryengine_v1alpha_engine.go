...
type V1alphaDiscoveryengineV1alphaEngine_AgentGatewaySetting_DefaultEgressAgentGateway struct {
...
type V1alphaDiscoveryengineV1alphaEngine_AgentGatewaySetting struct {
	// Reference to an Agent Gateway resource.
	DefaultEgressAgentGateway any
}

type V1alphaDiscoveryengineV1alphaEngine_ChatEngineConfig_AgentCreationConfig struct {
...
type V1alphaDiscoveryengineV1alphaEngine_ChatEngineConfig struct {
...
type V1alphaDiscoveryengineV1alphaEngine_ChatEngineMetadata struct {
	// The resource name of a Dialogflow agent, that this Chat Engine refers to. Format: `projects//locations//agents/`.
	DialogflowAgent any
}

type V1alphaDiscoveryengineV1alphaEngine_CmekConfig_SingleRegionKeys struct {
	KmsKey any
}

type V1alphaDiscoveryengineV1alphaEngine_CmekConfig struct {
...
type V1alphaDiscoveryengineV1alphaEngine_CommonConfig struct {
	// The name of the company, business or entity that is associated with the engine. Setting this may help improve LLM related features.
	CompanyName any
}

type V1alphaDiscoveryengineV1alphaEngine_KnowledgeGraphConfig_FeatureConfig struct {
...
type V1alphaDiscoveryengineV1alphaEngine_KnowledgeGraphConfig struct {
...
type V1alphaDiscoveryengineV1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfig struct {
...
type V1alphaDiscoveryengineV1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfig struct {
...
type V1alphaDiscoveryengineV1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig struct {
...
type V1alphaDiscoveryengineV1alphaEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfig struct {
...
type V1alphaDiscoveryengineV1alphaEngine_MediaRecommendationEngineConfig struct {
...
type V1alphaDiscoveryengineV1alphaEngine_ObservabilityConfig struct {
...
type V1alphaDiscoveryengineV1alphaEngine_RecommendationMetadata struct {
...
type V1alphaDiscoveryengineV1alphaEngine_SearchEngineConfig struct {
...
var V1alphaDiscoveryengineV1alphaEngine_AgentGatewaySetting_DefaultEgressAgentGatewayFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var V1alphaDiscoveryengineV1alphaEngine_AgentGatewaySettingFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaEngine_ChatEngineConfig_AgentCreationConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaEngine_ChatEngineConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaEngine_ChatEngineMetadataFields = ubx.FieldMap{
		"DialogflowAgent": ubx.FieldSpec{WireName: "dialogflow_agent"},
	}

var V1alphaDiscoveryengineV1alphaEngine_CmekConfig_SingleRegionKeysFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
	}

var V1alphaDiscoveryengineV1alphaEngine_CmekConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaEngine_CommonConfigFields = ubx.FieldMap{
		"CompanyName": ubx.FieldSpec{WireName: "company_name"},
	}

var V1alphaDiscoveryengineV1alphaEngine_KnowledgeGraphConfig_FeatureConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaEngine_KnowledgeGraphConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfigFields = ubx.FieldMap{
		"TimeWindowDays": ubx.FieldSpec{WireName: "time_window_days"},
	}

var V1alphaDiscoveryengineV1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfigFields = ubx.FieldMap{
		"ContextEventType": ubx.FieldSpec{WireName: "context_event_type"},
	}

var V1alphaDiscoveryengineV1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfigFields = ubx.FieldMap{
		"TargetField": ubx.FieldSpec{WireName: "target_field"},
		"TargetFieldValueFloat": ubx.FieldSpec{WireName: "target_field_value_float"},
	}

var V1alphaDiscoveryengineV1alphaEngine_MediaRecommendationEngineConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaEngine_ObservabilityConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaEngine_RecommendationMetadataFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaEngine_SearchEngineConfigFields = ubx.FieldMap{
...
type V1alphaDiscoveryengineV1alphaEngineConfig struct {
...
type V1alphaDiscoveryengineV1alphaEngineAttrs struct {
	// Agent Gateway setting, which may be attached to Gemini Enterprise resources for egress control of Gemini Enterprise agents to agents and tools outside of Gemini Enterprise.
	AgentGatewaySetting any
	// Optional. Immutable. This the application type which this engine resource represents. NOTE: this is a new concept independ of existing industry vertical or solution type.
	AppType any
...
var V1alphaDiscoveryengineV1alphaEngine = ubx.ResourceBinding{
