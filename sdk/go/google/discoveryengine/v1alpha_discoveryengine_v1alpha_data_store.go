...
type V1alphaDiscoveryengineV1alphaDataStore_AdvancedSiteSearchConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_BillingEstimation struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_CmekConfig_SingleRegionKeys struct {
	KmsKey any
}

type V1alphaDiscoveryengineV1alphaDataStore_CmekConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_DataProtectionPolicy_SensitiveDataProtectionPolicy struct {
	// Optional. Specifies the resource name of the Sensitive Data Protection content policy.
	Policy any
}

type V1alphaDiscoveryengineV1alphaDataStore_DataProtectionPolicy struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_DocumentProcessingConfig_ChunkingConfig_LayoutBasedChunkingConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_DocumentProcessingConfig_ChunkingConfig struct {
	// Configuration for the layout based chunking.
	LayoutBasedChunkingConfig any
}

type V1alphaDiscoveryengineV1alphaDataStore_DocumentProcessingConfig_DefaultParsingConfig_LayoutParsingConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_DocumentProcessingConfig_DefaultParsingConfig_OcrParsingConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_DocumentProcessingConfig_DefaultParsingConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_DocumentProcessingConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_FederatedSearchConfig_AlloyDbConfig_AlloydbAiNlConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_FederatedSearchConfig_AlloyDbConfig_AlloydbConnectionConfig struct {
	// Optional. Auth mode.
	AuthMode any
...
type V1alphaDiscoveryengineV1alphaDataStore_FederatedSearchConfig_AlloyDbConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_FederatedSearchConfig_NotebooklmConfig struct {
	// Required. Search config name. Format: projects/*/locations/global/notebookLmSearchConfigs/*
	SearchConfig any
}

type V1alphaDiscoveryengineV1alphaDataStore_FederatedSearchConfig_ThirdPartyOauthConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_FederatedSearchConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_HealthcareFhirConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_IdpConfig_ExternalIdpConfig struct {
	// Workforce pool name. Example: "locations/global/workforcePools/pool_id"
	WorkforcePoolName any
}

type V1alphaDiscoveryengineV1alphaDataStore_IdpConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_LanguageInfo struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_NaturalLanguageQueryUnderstandingConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_ServingConfigDataStore struct {
	// Optional. If set true, the DataStore will not be available for serving search requests.
	DisabledForServing any
}

type V1alphaDiscoveryengineV1alphaDataStore_StartingSchema_FieldConfigs struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_StartingSchema struct {
...
type V1alphaDiscoveryengineV1alphaDataStore_WorkspaceConfig struct {
...
var V1alphaDiscoveryengineV1alphaDataStore_AdvancedSiteSearchConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_BillingEstimationFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_CmekConfig_SingleRegionKeysFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
	}

var V1alphaDiscoveryengineV1alphaDataStore_CmekConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_DataProtectionPolicy_SensitiveDataProtectionPolicyFields = ubx.FieldMap{
		"Policy": ubx.FieldSpec{WireName: "policy"},
	}

var V1alphaDiscoveryengineV1alphaDataStore_DataProtectionPolicyFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_DocumentProcessingConfig_ChunkingConfig_LayoutBasedChunkingConfigFields = ubx.FieldMap{
		"ChunkSize": ubx.FieldSpec{WireName: "chunk_size"},
		"IncludeAncestorHeadings": ubx.FieldSpec{WireName: "include_ancestor_headings"},
	}

var V1alphaDiscoveryengineV1alphaDataStore_DocumentProcessingConfig_ChunkingConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_DocumentProcessingConfig_DefaultParsingConfig_LayoutParsingConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_DocumentProcessingConfig_DefaultParsingConfig_OcrParsingConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_DocumentProcessingConfig_DefaultParsingConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_DocumentProcessingConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_FederatedSearchConfig_AlloyDbConfig_AlloydbAiNlConfigFields = ubx.FieldMap{
		"NlConfigId": ubx.FieldSpec{WireName: "nl_config_id"},
	}

var V1alphaDiscoveryengineV1alphaDataStore_FederatedSearchConfig_AlloyDbConfig_AlloydbConnectionConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_FederatedSearchConfig_AlloyDbConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_FederatedSearchConfig_NotebooklmConfigFields = ubx.FieldMap{
		"SearchConfig": ubx.FieldSpec{WireName: "search_config"},
	}

var V1alphaDiscoveryengineV1alphaDataStore_FederatedSearchConfig_ThirdPartyOauthConfigFields = ubx.FieldMap{
		"AppName": ubx.FieldSpec{WireName: "app_name"},
		"InstanceName": ubx.FieldSpec{WireName: "instance_name"},
	}

var V1alphaDiscoveryengineV1alphaDataStore_FederatedSearchConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_HealthcareFhirConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_IdpConfig_ExternalIdpConfigFields = ubx.FieldMap{
		"WorkforcePoolName": ubx.FieldSpec{WireName: "workforce_pool_name"},
	}

var V1alphaDiscoveryengineV1alphaDataStore_IdpConfigFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_LanguageInfoFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_NaturalLanguageQueryUnderstandingConfigFields = ubx.FieldMap{
		"Mode": ubx.FieldSpec{WireName: "mode"},
	}

var V1alphaDiscoveryengineV1alphaDataStore_ServingConfigDataStoreFields = ubx.FieldMap{
		"DisabledForServing": ubx.FieldSpec{WireName: "disabled_for_serving"},
	}

var V1alphaDiscoveryengineV1alphaDataStore_StartingSchema_FieldConfigsFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_StartingSchemaFields = ubx.FieldMap{
...
var V1alphaDiscoveryengineV1alphaDataStore_WorkspaceConfigFields = ubx.FieldMap{
...
type V1alphaDiscoveryengineV1alphaDataStoreConfig struct {
...
type V1alphaDiscoveryengineV1alphaDataStoreAttrs struct {
	// Immutable. Whether data in the DataStore has ACL information. If set to `true`, the source data must have ACL. ACL will be ingested when data is ingested by DocumentService.ImportDocuments methods. When ACL is enabled for the DataStore, Document can't be accessed by calling DocumentService.GetDocument or DocumentService.ListDocuments. Currently ACL is only supported in `GENERIC` industry vertical with non-`PUBLIC_WEBSITE` content config.
	AclEnabled any
	// Configuration data for advance site search.
	AdvancedSiteSearchConfig any
...
var V1alphaDiscoveryengineV1alphaDataStore = ubx.ResourceBinding{
