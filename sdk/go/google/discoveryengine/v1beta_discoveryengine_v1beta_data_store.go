...
type V1betaDiscoveryengineV1betaDataStore_AdvancedSiteSearchConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_BillingEstimation struct {
...
type V1betaDiscoveryengineV1betaDataStore_CmekConfig_SingleRegionKeys struct {
	KmsKey any
}

type V1betaDiscoveryengineV1betaDataStore_CmekConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_DocumentProcessingConfig_ChunkingConfig_LayoutBasedChunkingConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_DocumentProcessingConfig_ChunkingConfig struct {
	// Configuration for the layout based chunking.
	LayoutBasedChunkingConfig any
}

type V1betaDiscoveryengineV1betaDataStore_DocumentProcessingConfig_DefaultParsingConfig_LayoutParsingConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_DocumentProcessingConfig_DefaultParsingConfig_OcrParsingConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_DocumentProcessingConfig_DefaultParsingConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_DocumentProcessingConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_FederatedSearchConfig_AlloyDbConfig_AlloydbAiNlConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_FederatedSearchConfig_AlloyDbConfig_AlloydbConnectionConfig struct {
	// Optional. Auth mode.
	AuthMode any
...
type V1betaDiscoveryengineV1betaDataStore_FederatedSearchConfig_AlloyDbConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_FederatedSearchConfig_NotebooklmConfig struct {
	// Required. Search config name. Format: projects/*/locations/global/notebookLmSearchConfigs/*
	SearchConfig any
}

type V1betaDiscoveryengineV1betaDataStore_FederatedSearchConfig_ThirdPartyOauthConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_FederatedSearchConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_HealthcareFhirConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_LanguageInfo struct {
...
type V1betaDiscoveryengineV1betaDataStore_NaturalLanguageQueryUnderstandingConfig struct {
...
type V1betaDiscoveryengineV1betaDataStore_ServingConfigDataStore struct {
	// Optional. If set true, the DataStore will not be available for serving search requests.
	DisabledForServing any
}

type V1betaDiscoveryengineV1betaDataStore_StartingSchema struct {
...
type V1betaDiscoveryengineV1betaDataStore_WorkspaceConfig struct {
...
var V1betaDiscoveryengineV1betaDataStore_AdvancedSiteSearchConfigFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_BillingEstimationFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_CmekConfig_SingleRegionKeysFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
	}

var V1betaDiscoveryengineV1betaDataStore_CmekConfigFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_DocumentProcessingConfig_ChunkingConfig_LayoutBasedChunkingConfigFields = ubx.FieldMap{
		"ChunkSize": ubx.FieldSpec{WireName: "chunk_size"},
		"IncludeAncestorHeadings": ubx.FieldSpec{WireName: "include_ancestor_headings"},
	}

var V1betaDiscoveryengineV1betaDataStore_DocumentProcessingConfig_ChunkingConfigFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_DocumentProcessingConfig_DefaultParsingConfig_LayoutParsingConfigFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_DocumentProcessingConfig_DefaultParsingConfig_OcrParsingConfigFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_DocumentProcessingConfig_DefaultParsingConfigFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_DocumentProcessingConfigFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_FederatedSearchConfig_AlloyDbConfig_AlloydbAiNlConfigFields = ubx.FieldMap{
		"NlConfigId": ubx.FieldSpec{WireName: "nl_config_id"},
	}

var V1betaDiscoveryengineV1betaDataStore_FederatedSearchConfig_AlloyDbConfig_AlloydbConnectionConfigFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_FederatedSearchConfig_AlloyDbConfigFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_FederatedSearchConfig_NotebooklmConfigFields = ubx.FieldMap{
		"SearchConfig": ubx.FieldSpec{WireName: "search_config"},
	}

var V1betaDiscoveryengineV1betaDataStore_FederatedSearchConfig_ThirdPartyOauthConfigFields = ubx.FieldMap{
		"AppName": ubx.FieldSpec{WireName: "app_name"},
		"InstanceName": ubx.FieldSpec{WireName: "instance_name"},
	}

var V1betaDiscoveryengineV1betaDataStore_FederatedSearchConfigFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_HealthcareFhirConfigFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_LanguageInfoFields = ubx.FieldMap{
...
var V1betaDiscoveryengineV1betaDataStore_NaturalLanguageQueryUnderstandingConfigFields = ubx.FieldMap{
		"Mode": ubx.FieldSpec{WireName: "mode"},
	}

var V1betaDiscoveryengineV1betaDataStore_ServingConfigDataStoreFields = ubx.FieldMap{
		"DisabledForServing": ubx.FieldSpec{WireName: "disabled_for_serving"},
	}

var V1betaDiscoveryengineV1betaDataStore_StartingSchemaFields = ubx.FieldMap{
		"JsonSchema": ubx.FieldSpec{WireName: "json_schema"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"StructSchema": ubx.FieldSpec{WireName: "struct_schema"},
	}

var V1betaDiscoveryengineV1betaDataStore_WorkspaceConfigFields = ubx.FieldMap{
...
type V1betaDiscoveryengineV1betaDataStoreConfig struct {
...
type V1betaDiscoveryengineV1betaDataStoreAttrs struct {
	// Immutable. Whether data in the DataStore has ACL information. If set to `true`, the source data must have ACL. ACL will be ingested when data is ingested by DocumentService.ImportDocuments methods. When ACL is enabled for the DataStore, Document can't be accessed by calling DocumentService.GetDocument or DocumentService.ListDocuments. Currently ACL is only supported in `GENERIC` industry vertical with non-`PUBLIC_WEBSITE` content config.
	AclEnabled any
	// Configuration data for advance site search.
	AdvancedSiteSearchConfig any
...
var V1betaDiscoveryengineV1betaDataStore = ubx.ResourceBinding{
