...
type V1alphaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpec struct {
...
type V1alphaServingConfig_AnswerGenerationSpec struct {
	// The specification for user defined classifier.
	UserDefinedClassifierSpec any
}

type V1alphaServingConfig_CustomFineTuningSpec struct {
	// Whether or not to enable and include custom fine tuned search adaptor model.
	EnableSearchAdaptor any
}

type V1alphaServingConfig_EmbeddingConfig struct {
	// Full field path in the schema mapped as embedding field.
	FieldPath any
}

type V1alphaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpec struct {
...
type V1alphaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpec struct {
...
type V1alphaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpec struct {
...
type V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec struct {
	// Text at the beginning of the prompt that instructs the assistant. Examples are available in the user guide.
	Preamble any
}

type V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpec struct {
...
type V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpec struct {
	// Optional. Source of image returned in the answer.
	ImageSource any
}

type V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec struct {
...
type V1alphaServingConfig_GenericConfig_ContentSearchSpec struct {
...
type V1alphaServingConfig_GenericConfig struct {
	// A specification for configuring the behavior of content search.
	ContentSearchSpec any
}

type V1alphaServingConfig_GuidedSearchSpec struct {
...
type V1alphaServingConfig_MediaConfig struct {
...
type V1alphaServingConfig_PersonalizationSpec struct {
	// The personalization mode of the search request. Defaults to Mode.AUTO.
	Mode any
}

var V1alphaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpecFields = ubx.FieldMap{
...
var V1alphaServingConfig_AnswerGenerationSpecFields = ubx.FieldMap{
...
var V1alphaServingConfig_CustomFineTuningSpecFields = ubx.FieldMap{
	"EnableSearchAdaptor": ubx.FieldSpec{WireName: "enable_search_adaptor"},
}

var V1alphaServingConfig_EmbeddingConfigFields = ubx.FieldMap{
	"FieldPath": ubx.FieldSpec{WireName: "field_path"},
}

var V1alphaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpecFields = ubx.FieldMap{
	"NumNextChunks":     ubx.FieldSpec{WireName: "num_next_chunks"},
	"NumPreviousChunks": ubx.FieldSpec{WireName: "num_previous_chunks"},
}

var V1alphaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpecFields = ubx.FieldMap{
...
var V1alphaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpecFields = ubx.FieldMap{
...
var V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpecFields = ubx.FieldMap{
	"Preamble": ubx.FieldSpec{WireName: "preamble"},
}

var V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpecFields = ubx.FieldMap{
	"Version": ubx.FieldSpec{WireName: "version"},
}

var V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpecFields = ubx.FieldMap{
	"ImageSource": ubx.FieldSpec{WireName: "image_source"},
}

var V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpecFields = ubx.FieldMap{
...
var V1alphaServingConfig_GenericConfig_ContentSearchSpecFields = ubx.FieldMap{
...
var V1alphaServingConfig_GenericConfigFields = ubx.FieldMap{
...
var V1alphaServingConfig_GuidedSearchSpecFields = ubx.FieldMap{
...
var V1alphaServingConfig_MediaConfigFields = ubx.FieldMap{
...
var V1alphaServingConfig_PersonalizationSpecFields = ubx.FieldMap{
	"Mode": ubx.FieldSpec{WireName: "mode"},
}

type V1alphaServingConfigConfig struct {
...
type V1alphaServingConfigAttrs struct {
	// The specification for answer generation.
	AnswerGenerationSpec any
	// Boost controls to use in serving path. All triggered boost controls will be applied. Boost controls must be in the same data store as the serving config. Maximum of 20 boost controls.
	BoostControlIds any
...
var V1alphaServingConfig = ubx.ResourceBinding{
