...
type V1alphaIdentityMappingStore_CmekConfig_SingleRegionKeys struct {
	KmsKey any
}

type V1alphaIdentityMappingStore_CmekConfig struct {
...
type V1alphaIdentityMappingStore_IdpConfig_ExternalIdpConfig struct {
	// Workforce pool name. Example: "locations/global/workforcePools/pool_id"
	WorkforcePoolName any
}

type V1alphaIdentityMappingStore_IdpConfig struct {
...
type V1alphaIdentityMappingStoreAttrs struct {
	// Configurations used to enable CMEK data encryption with Cloud KMS keys.
	CmekConfig any
	// Identity Provider Config.
	IdpConfig any
...
var V1alphaIdentityMappingStore = ubx.ResourceBinding{
