...
type V1alphaEngine_AgentGatewaySetting_DefaultEgressAgentGateway struct {
...
type V1alphaEngine_AgentGatewaySetting struct {
	// Reference to an Agent Gateway resource.
	DefaultEgressAgentGateway any
}

type V1alphaEngine_ChatEngineConfig_AgentCreationConfig struct {
...
type V1alphaEngine_ChatEngineConfig struct {
...
type V1alphaEngine_ChatEngineMetadata struct {
	// The resource name of a Dialogflow agent, that this Chat Engine refers to. Format: `projects//locations//agents/`.
	DialogflowAgent any
}

type V1alphaEngine_CmekConfig_SingleRegionKeys struct {
	KmsKey any
}

type V1alphaEngine_CmekConfig struct {
...
type V1alphaEngine_CommonConfig struct {
	// The name of the company, business or entity that is associated with the engine. Setting this may help improve LLM related features.
	CompanyName any
}

type V1alphaEngine_KnowledgeGraphConfig_FeatureConfig struct {
...
type V1alphaEngine_KnowledgeGraphConfig struct {
...
type V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfig struct {
...
type V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfig struct {
...
type V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig struct {
...
type V1alphaEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfig struct {
...
type V1alphaEngine_MediaRecommendationEngineConfig struct {
...
type V1alphaEngine_ObservabilityConfig struct {
...
type V1alphaEngine_RecommendationMetadata struct {
...
type V1alphaEngine_SearchEngineConfig struct {
...
type V1alphaEngineAttrs struct {
	// Agent Gateway setting, which may be attached to Gemini Enterprise resources for egress control of Gemini Enterprise agents to agents and tools outside of Gemini Enterprise.
	AgentGatewaySetting any
	// Optional. Immutable. This the application type which this engine resource represents. NOTE: this is a new concept independ of existing industry vertical or solution type.
	AppType any
...
var V1alphaEngine = ubx.ResourceBinding{
