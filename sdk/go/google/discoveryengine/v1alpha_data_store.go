...
type V1alphaDataStore_AdvancedSiteSearchConfig struct {
...
type V1alphaDataStore_BillingEstimation struct {
...
type V1alphaDataStore_CmekConfig_SingleRegionKeys struct {
	KmsKey any
}

type V1alphaDataStore_CmekConfig struct {
...
type V1alphaDataStore_DataProtectionPolicy_SensitiveDataProtectionPolicy struct {
	// Optional. Specifies the resource name of the Sensitive Data Protection content policy.
	Policy any
}

type V1alphaDataStore_DataProtectionPolicy struct {
...
type V1alphaDataStore_DocumentProcessingConfig_ChunkingConfig_LayoutBasedChunkingConfig struct {
...
type V1alphaDataStore_DocumentProcessingConfig_ChunkingConfig struct {
	// Configuration for the layout based chunking.
	LayoutBasedChunkingConfig any
}

type V1alphaDataStore_DocumentProcessingConfig_DefaultParsingConfig_LayoutParsingConfig struct {
...
type V1alphaDataStore_DocumentProcessingConfig_DefaultParsingConfig_OcrParsingConfig struct {
...
type V1alphaDataStore_DocumentProcessingConfig_DefaultParsingConfig struct {
...
type V1alphaDataStore_DocumentProcessingConfig struct {
...
type V1alphaDataStore_FederatedSearchConfig_AlloyDbConfig_AlloydbAiNlConfig struct {
...
type V1alphaDataStore_FederatedSearchConfig_AlloyDbConfig_AlloydbConnectionConfig struct {
	// Optional. Auth mode.
	AuthMode any
...
type V1alphaDataStore_FederatedSearchConfig_AlloyDbConfig struct {
...
type V1alphaDataStore_FederatedSearchConfig_NotebooklmConfig struct {
	// Required. Search config name. Format: projects/*/locations/global/notebookLmSearchConfigs/*
	SearchConfig any
}

type V1alphaDataStore_FederatedSearchConfig_ThirdPartyOauthConfig struct {
...
type V1alphaDataStore_FederatedSearchConfig struct {
...
type V1alphaDataStore_HealthcareFhirConfig struct {
...
type V1alphaDataStore_IdpConfig_ExternalIdpConfig struct {
	// Workforce pool name. Example: "locations/global/workforcePools/pool_id"
	WorkforcePoolName any
}

type V1alphaDataStore_IdpConfig struct {
...
type V1alphaDataStore_LanguageInfo struct {
...
type V1alphaDataStore_NaturalLanguageQueryUnderstandingConfig struct {
...
type V1alphaDataStore_ServingConfigDataStore struct {
...
type V1alphaDataStore_WorkspaceConfig struct {
...
type V1alphaDataStoreAttrs struct {
	// Immutable. Whether data in the DataStore has ACL information. If set to `true`, the source data must have ACL. ACL will be ingested when data is ingested by DocumentService.ImportDocuments methods. When ACL is enabled for the DataStore, Document can't be accessed by calling DocumentService.GetDocument or DocumentService.ListDocuments. Currently ACL is only supported in `GENERIC` industry vertical with non-`PUBLIC_WEBSITE` content config.
	AclEnabled any
	// Configuration data for advance site search.
	AdvancedSiteSearchConfig any
...
var V1alphaDataStore = ubx.ResourceBinding{
