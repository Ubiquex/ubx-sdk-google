...
type V1beta1NetworkmanagementV1beta1VpcFlowLogsConfigConfig struct {
...
type V1beta1NetworkmanagementV1beta1VpcFlowLogsConfigAttrs struct {
	// Optional. The aggregation interval for the logs. Default value is INTERVAL_5_SEC.
	AggregationInterval any
	// Output only. The time the config was created.
	CreateTime any
...
var V1beta1NetworkmanagementV1beta1VpcFlowLogsConfig = ubx.ResourceBinding{
