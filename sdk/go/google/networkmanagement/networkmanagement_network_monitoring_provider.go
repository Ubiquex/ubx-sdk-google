...
type NetworkmanagementNetworkMonitoringProviderConfig struct {
...
type NetworkmanagementNetworkMonitoringProviderAttrs struct {
	// Output only. The time the NetworkMonitoringProvider was created.
	CreateTime any
	// Output only. The list of error messages detected for the NetworkMonitoringProvider.
	Errors any
...
var NetworkmanagementNetworkMonitoringProvider = ubx.ResourceBinding{
