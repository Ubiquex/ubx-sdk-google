...
type V1alphaSkill_Frontmatter struct {
...
type V1alphaSkill_InitialRevision_ArchiveUploadSource struct {
	// Required. Input only. Write-only raw ZIP/TAR archive payload bytes containing the skill package.
	ArchiveContent any
}

type V1alphaSkill_InitialRevision_GcsSource struct {
...
type V1alphaSkill_InitialRevision struct {
