...
type V1alphaAgentregistryV1alphaService_AgentSpec struct {
...
type V1alphaAgentregistryV1alphaService_Interfaces struct {
	ProtocolBinding any
	Url any
}

var V1alphaAgentregistryV1alphaService_AgentSpecFields = ubx.FieldMap{
		"Content": ubx.FieldSpec{WireName: "content"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var V1alphaAgentregistryV1alphaService_InterfacesFields = ubx.FieldMap{
		"ProtocolBinding": ubx.FieldSpec{WireName: "protocol_binding"},
		"Url": ubx.FieldSpec{WireName: "url"},
	}

type V1alphaAgentregistryV1alphaServiceConfig struct {
...
type V1alphaAgentregistryV1alphaServiceAttrs struct {
	// The spec of the agent.
	AgentSpec any
	// Output only. Create time.
	CreateTime any
...
var V1alphaAgentregistryV1alphaService = ubx.ResourceBinding{
