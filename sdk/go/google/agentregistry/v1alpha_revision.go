...
type V1alphaRevision_GcsSource struct {
...
type V1alphaRevisionAttrs struct {
	// Direct write-only raw archive payload upload.
	ArchiveUploadSource any
...
var V1alphaRevision = ubx.ResourceBinding{
