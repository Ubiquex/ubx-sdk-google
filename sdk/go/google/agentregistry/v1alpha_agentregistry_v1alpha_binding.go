...
type V1alphaAgentregistryV1alphaBinding_AuthProviderBinding struct {
...
type V1alphaAgentregistryV1alphaBinding_Source struct {
	// The identifier of the source Agent. Format: * `urn:agent:{publisher}:{namespace}:{name}`
	Identifier any
}

var V1alphaAgentregistryV1alphaBinding_AuthProviderBindingFields = ubx.FieldMap{
...
var V1alphaAgentregistryV1alphaBinding_SourceFields = ubx.FieldMap{
		"Identifier": ubx.FieldSpec{WireName: "identifier"},
	}

type V1alphaAgentregistryV1alphaBindingConfig struct {
...
type V1alphaAgentregistryV1alphaBindingAttrs struct {
	// The AuthProvider of the Binding.
	AuthProviderBinding any
	// Output only. Timestamp when this binding was created.
	CreateTime any
...
var V1alphaAgentregistryV1alphaBinding = ubx.ResourceBinding{
