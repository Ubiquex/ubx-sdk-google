...
type ManagedkafkaCluster_BrokerDetails struct {
	BrokerIndex any
	NodeId any
	Rack any
}

type ManagedkafkaCluster_CapacityConfig struct {
...
type ManagedkafkaCluster_GcpConfig_AccessConfig_NetworkConfigs struct {
	Subnet any
}

type ManagedkafkaCluster_GcpConfig_AccessConfig struct {
...
type ManagedkafkaCluster_GcpConfig struct {
...
type ManagedkafkaCluster_RebalanceConfig struct {
	// Optional. The rebalance behavior for the cluster. When not specified, defaults to `NO_REBALANCE`.
	Mode any
}

type ManagedkafkaCluster_TlsConfig_TrustConfig_CasConfigs struct {
	CaPool any
}

type ManagedkafkaCluster_TlsConfig_TrustConfig struct {
	// Optional. Configuration for the Google Certificate Authority Service. Maximum 10.
	CasConfigs any
}

type ManagedkafkaCluster_TlsConfig struct {
...
type ManagedkafkaCluster_UpdateOptions struct {
...
var ManagedkafkaCluster_BrokerDetailsFields = ubx.FieldMap{
		"BrokerIndex": ubx.FieldSpec{WireName: "broker_index"},
		"NodeId": ubx.FieldSpec{WireName: "node_id"},
		"Rack": ubx.FieldSpec{WireName: "rack"},
	}

var ManagedkafkaCluster_CapacityConfigFields = ubx.FieldMap{
		"MemoryBytes": ubx.FieldSpec{WireName: "memory_bytes"},
		"VcpuCount": ubx.FieldSpec{WireName: "vcpu_count"},
	}

var ManagedkafkaCluster_GcpConfig_AccessConfig_NetworkConfigsFields = ubx.FieldMap{
		"Subnet": ubx.FieldSpec{WireName: "subnet"},
	}

var ManagedkafkaCluster_GcpConfig_AccessConfigFields = ubx.FieldMap{
...
var ManagedkafkaCluster_GcpConfigFields = ubx.FieldMap{
...
var ManagedkafkaCluster_RebalanceConfigFields = ubx.FieldMap{
		"Mode": ubx.FieldSpec{WireName: "mode"},
	}

var ManagedkafkaCluster_TlsConfig_TrustConfig_CasConfigsFields = ubx.FieldMap{
		"CaPool": ubx.FieldSpec{WireName: "ca_pool"},
	}

var ManagedkafkaCluster_TlsConfig_TrustConfigFields = ubx.FieldMap{
...
var ManagedkafkaCluster_TlsConfigFields = ubx.FieldMap{
...
var ManagedkafkaCluster_UpdateOptionsFields = ubx.FieldMap{
...
type ManagedkafkaClusterAttrs struct {
	// Output only. Only populated when FULL view is requested. Details of each broker in the cluster.
	BrokerDetails any
	// A capacity configuration of a Kafka cluster.
	CapacityConfig any
...
var ManagedkafkaCluster = ubx.ResourceBinding{
