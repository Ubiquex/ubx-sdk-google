...
type V1alphaScanConfig_Authentication_CustomAccount struct {
...
type V1alphaScanConfig_Authentication_GoogleAccount struct {
...
type V1alphaScanConfig_Authentication struct {
...
type V1alphaScanConfig_LatestRun struct {
...
type V1alphaScanConfig_Schedule struct {
...
type V1alphaScanConfigAttrs struct {
	// Scan authentication configuration.
	Authentication any
	// The excluded URL patterns as described in https://cloud.google.com/security-command-center/docs/how-to-use-web-security-scanner#excluding_urls
	BlacklistPatterns any
...
var V1alphaScanConfig = ubx.ResourceBinding{
