...
type DataplexEntryType_Authorization struct {
...
type DataplexEntryType_RequiredAspects struct {
	Type any
}

var DataplexEntryType_AuthorizationFields = ubx.FieldMap{
		"AlternateUsePermission": ubx.FieldSpec{WireName: "alternate_use_permission"},
	}

var DataplexEntryType_RequiredAspectsFields = ubx.FieldMap{
...
type DataplexEntryTypeAttrs struct {
	// Authorization for an Entry Type.
	Authorization any
	// Output only. The time when the EntryType was created.
	CreateTime any
...
var DataplexEntryType = ubx.ResourceBinding{
