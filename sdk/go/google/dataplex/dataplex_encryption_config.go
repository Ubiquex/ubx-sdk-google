...
type DataplexEncryptionConfig_FailureDetails struct {
...
var DataplexEncryptionConfig_FailureDetailsFields = ubx.FieldMap{
		"ErrorCode": ubx.FieldSpec{WireName: "error_code"},
		"ErrorMessage": ubx.FieldSpec{WireName: "error_message"},
	}

type DataplexEncryptionConfigConfig struct {
...
type DataplexEncryptionConfigAttrs struct {
	// Output only. The time when the Encryption configuration was created.
	CreateTime any
	// Optional. Represent the state of CMEK opt-in for metastore.
	EnableMetastoreEncryption any
...
var DataplexEncryptionConfig = ubx.ResourceBinding{
