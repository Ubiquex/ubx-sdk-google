...
type DataplexMetadataJob_ExportResult struct {
...
type DataplexMetadataJob_ExportSpec_Scope struct {
...
type DataplexMetadataJob_ExportSpec struct {
...
type DataplexMetadataJob_ImportResult struct {
...
type DataplexMetadataJob_ImportSpec_Scope struct {
...
type DataplexMetadataJob_ImportSpec struct {
...
type DataplexMetadataJob_Status struct {
...
var DataplexMetadataJob_ExportResultFields = ubx.FieldMap{
		"ErrorMessage": ubx.FieldSpec{WireName: "error_message"},
		"ExportedEntries": ubx.FieldSpec{WireName: "exported_entries"},
	}

var DataplexMetadataJob_ExportSpec_ScopeFields = ubx.FieldMap{
...
var DataplexMetadataJob_ExportSpecFields = ubx.FieldMap{
...
var DataplexMetadataJob_ImportResultFields = ubx.FieldMap{
...
var DataplexMetadataJob_ImportSpec_ScopeFields = ubx.FieldMap{
		"AspectTypes": ubx.FieldSpec{WireName: "aspect_types"},
		"EntryGroups": ubx.FieldSpec{WireName: "entry_groups"},
...
var DataplexMetadataJob_ImportSpecFields = ubx.FieldMap{
...
var DataplexMetadataJob_StatusFields = ubx.FieldMap{
...
type DataplexMetadataJobConfig struct {
...
type DataplexMetadataJobAttrs struct {
	// Output only. The time when the metadata job was created.
	CreateTime any
	// Summary results from a metadata export job. The results are a snapshot of the metadata at the time when the job was created. The exported entries are saved to a Cloud Storage bucket.
	ExportResult any
...
var DataplexMetadataJob = ubx.ResourceBinding{
