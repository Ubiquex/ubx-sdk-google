...
type Provider_ExtendedAttributesOauth2Client_ClientSecret_Value struct {
...
type Provider_ExtendedAttributesOauth2Client_ClientSecret struct {
	// Representation of the value of the client secret.
	Value any
}

type Provider_ExtendedAttributesOauth2Client_QueryParameters struct {
...
type Provider_ExtendedAttributesOauth2Client struct {
...
type Provider_Oidc_WebSsoConfig struct {
