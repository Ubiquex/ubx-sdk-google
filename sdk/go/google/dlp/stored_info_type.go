...
type StoredInfoType_Config_Dictionary_CloudStoragePath struct {
	// A URL representing a file or path (no wildcards) in Cloud Storage. Example: `gs://[BUCKET_NAME]/dictionary.txt`
	Path any
}

type StoredInfoType_Config_Dictionary_WordList struct {
	// Words or phrases defining the dictionary. The dictionary must contain at least one phrase and every phrase must contain at least 2 characters that are letters or digits. [required]
	Words any
}

type StoredInfoType_Config_Dictionary struct {
...
type StoredInfoType_Config_LargeCustomDictionary_BigQueryField_Field struct {
	// Name describing the field.
	Name any
}

type StoredInfoType_Config_LargeCustomDictionary_BigQueryField_Table struct {
...
type StoredInfoType_Config_LargeCustomDictionary_BigQueryField struct {
...
type StoredInfoType_Config_LargeCustomDictionary_CloudStorageFileSet struct {
	// The url, in the format `gs:///`. Trailing wildcard in the path is allowed.
	Url any
}

type StoredInfoType_Config_LargeCustomDictionary struct {
...
type StoredInfoType_Config_Regex struct {
...
type StoredInfoType_Config struct {
...
type StoredInfoType_CurrentVersion_Stats_LargeCustomDictionary struct {
	// Approximate number of distinct phrases in the dictionary.
	ApproxNumPhrases any
}

type StoredInfoType_CurrentVersion_Stats struct {
	// Summary statistics of a custom dictionary.
	LargeCustomDictionary any
}

type StoredInfoType_CurrentVersion struct {
...
type StoredInfoTypeAttrs struct {
	// Configuration for stored infoTypes. All fields and subfield are provided by the user. For more information, see https://docs.cloud.google.com/sensitive-data-protection/docs/creating-custom-infotypes.
	Config any
...
var StoredInfoType = ubx.ResourceBinding{
