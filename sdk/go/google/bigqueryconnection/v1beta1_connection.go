...
type V1beta1Connection_CloudSql_Credential struct {
...
type V1beta1Connection_CloudSql struct {
...
type V1beta1ConnectionAttrs struct {
	// Connection properties specific to the Cloud SQL.
	CloudSql any
	// Output only. The creation timestamp of the connection.
	CreationTime any
...
var V1beta1Connection = ubx.ResourceBinding{
