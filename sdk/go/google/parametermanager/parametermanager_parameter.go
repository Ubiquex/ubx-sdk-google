...
type ParametermanagerParameter_PolicyMember struct {
...
var ParametermanagerParameter_PolicyMemberFields = ubx.FieldMap{
...
type ParametermanagerParameterAttrs struct {
	// Output only. [Output only] Create time stamp
	CreateTime any
	// Optional. Specifies the format of a Parameter.
	Format any
...
var ParametermanagerParameter = ubx.ResourceBinding{
