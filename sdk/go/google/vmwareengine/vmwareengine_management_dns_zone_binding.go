...
type VmwareengineManagementDnsZoneBindingConfig struct {
...
type VmwareengineManagementDnsZoneBindingAttrs struct {
	// Output only. Creation time of this resource.
	CreateTime any
	// User-provided description for this resource.
	Description any
...
var VmwareengineManagementDnsZoneBinding = ubx.ResourceBinding{
