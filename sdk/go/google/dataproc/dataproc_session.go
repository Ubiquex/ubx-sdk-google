...
type DataprocSession_EnvironmentConfig_ExecutionConfig_AuthenticationConfig struct {
	// Optional. Authentication type for the user workload running in containers.
	UserWorkloadAuthenticationType any
}

type DataprocSession_EnvironmentConfig_ExecutionConfig struct {
...
type DataprocSession_EnvironmentConfig_PeripheralsConfig_SparkHistoryServerConfig struct {
	// Optional. Resource name of an existing Dataproc Cluster to act as a Spark History Server for the workload.Example: projects/[project_id]/regions/[region]/clusters/[cluster_name]
	DataprocCluster any
}

type DataprocSession_EnvironmentConfig_PeripheralsConfig struct {
...
type DataprocSession_EnvironmentConfig struct {
...
type DataprocSession_JupyterSession struct {
...
type DataprocSession_RuntimeConfig_AutotuningConfig struct {
	// Optional. Scenarios for which tunings are applied.
	Scenarios any
}

type DataprocSession_RuntimeConfig_RepositoryConfig_PypiRepositoryConfig struct {
	// Optional. The PyPi repository address. Note: This field is not available for batch workloads.
	PypiRepository any
}

type DataprocSession_RuntimeConfig_RepositoryConfig struct {
	// Configuration for PyPi repository
	PypiRepositoryConfig any
}

type DataprocSession_RuntimeConfig struct {
...
type DataprocSession_RuntimeInfo_ApproximateUsage struct {
...
type DataprocSession_RuntimeInfo_CohortInfo struct {
...
type DataprocSession_RuntimeInfo_CurrentUsage struct {
	// Optional. Accelerator type being used, if any Deprecated: This field is only used in runtime versions below 3.0.
	AcceleratorType any
...
type DataprocSession_RuntimeInfo_PropertiesInfo_AutotuningProperties struct {
	Annotation any
	OverriddenValue any
	Value any
}

type DataprocSession_RuntimeInfo_PropertiesInfo struct {
	// Output only. Properties set by autotuning engine.
	AutotuningProperties any
}

type DataprocSession_RuntimeInfo struct {
...
type DataprocSession_StateHistory struct {
	State any
	StateMessage any
	StateStartTime any
}

var DataprocSession_EnvironmentConfig_ExecutionConfig_AuthenticationConfigFields = ubx.FieldMap{
		"UserWorkloadAuthenticationType": ubx.FieldSpec{WireName: "user_workload_authentication_type"},
	}

var DataprocSession_EnvironmentConfig_ExecutionConfigFields = ubx.FieldMap{
...
var DataprocSession_EnvironmentConfig_PeripheralsConfig_SparkHistoryServerConfigFields = ubx.FieldMap{
		"DataprocCluster": ubx.FieldSpec{WireName: "dataproc_cluster"},
	}

var DataprocSession_EnvironmentConfig_PeripheralsConfigFields = ubx.FieldMap{
...
var DataprocSession_EnvironmentConfigFields = ubx.FieldMap{
...
var DataprocSession_JupyterSessionFields = ubx.FieldMap{
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
		"Kernel": ubx.FieldSpec{WireName: "kernel"},
	}

var DataprocSession_RuntimeConfig_AutotuningConfigFields = ubx.FieldMap{
		"Scenarios": ubx.FieldSpec{WireName: "scenarios"},
	}

var DataprocSession_RuntimeConfig_RepositoryConfig_PypiRepositoryConfigFields = ubx.FieldMap{
		"PypiRepository": ubx.FieldSpec{WireName: "pypi_repository"},
	}

var DataprocSession_RuntimeConfig_RepositoryConfigFields = ubx.FieldMap{
...
var DataprocSession_RuntimeConfigFields = ubx.FieldMap{
...
var DataprocSession_RuntimeInfo_ApproximateUsageFields = ubx.FieldMap{
...
var DataprocSession_RuntimeInfo_CohortInfoFields = ubx.FieldMap{
		"Cohort": ubx.FieldSpec{WireName: "cohort"},
		"CohortSource": ubx.FieldSpec{WireName: "cohort_source"},
	}

var DataprocSession_RuntimeInfo_CurrentUsageFields = ubx.FieldMap{
		"AcceleratorType": ubx.FieldSpec{WireName: "accelerator_type"},
...
var DataprocSession_RuntimeInfo_PropertiesInfo_AutotuningPropertiesFields = ubx.FieldMap{
		"Annotation": ubx.FieldSpec{WireName: "annotation"},
		"OverriddenValue": ubx.FieldSpec{WireName: "overridden_value"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var DataprocSession_RuntimeInfo_PropertiesInfoFields = ubx.FieldMap{
...
var DataprocSession_RuntimeInfoFields = ubx.FieldMap{
...
type DataprocSessionAttrs struct {
	// Output only. The time when the session was created.
	CreateTime any
	// Output only. The email address of the user who created the session.
	Creator any
...
var DataprocSession = ubx.ResourceBinding{
