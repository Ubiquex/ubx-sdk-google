...
type SessionTemplate_RuntimeConfig_AutotuningConfig struct {
	// Optional. Scenarios for which tunings are applied.
	Scenarios any
}

type SessionTemplate_RuntimeConfig_RepositoryConfig_PypiRepositoryConfig struct {
	// Optional. The PyPi repository address. Note: This field is not available for batch workloads.
	PypiRepository any
}

type SessionTemplate_RuntimeConfig_RepositoryConfig struct {
