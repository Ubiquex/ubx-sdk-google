...
type FirestoreDatabase_CmekConfig struct {
...
type FirestoreDatabase_SourceInfo_Backup struct {
...
type FirestoreDatabase_SourceInfo struct {
...
var FirestoreDatabase_CmekConfigFields = ubx.FieldMap{
		"ActiveKeyVersion": ubx.FieldSpec{WireName: "active_key_version"},
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

var FirestoreDatabase_SourceInfo_BackupFields = ubx.FieldMap{
		"Backup": ubx.FieldSpec{WireName: "backup"},
	}

var FirestoreDatabase_SourceInfoFields = ubx.FieldMap{
...
type FirestoreDatabaseAttrs struct {
	// The App Engine integration mode to use for this database.
	AppEngineIntegrationMode any
	// The CMEK (Customer Managed Encryption Key) configuration for a Firestore database. If not present, the database is secured by the default Google encryption key.
	CmekConfig any
...
var FirestoreDatabase = ubx.ResourceBinding{
