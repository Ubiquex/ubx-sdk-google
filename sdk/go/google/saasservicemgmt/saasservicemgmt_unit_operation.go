...
type SaasservicemgmtUnitOperation_Conditions struct {
...
type SaasservicemgmtUnitOperation_FlagUpdate struct {
	// Required. Flag release being applied by UnitOperation.
	FlagRelease any
}

type SaasservicemgmtUnitOperation_Provision_InputVariables struct {
	Type any
	Value any
	Variable any
}

type SaasservicemgmtUnitOperation_Provision struct {
...
type SaasservicemgmtUnitOperation_Schedule struct {
	// Optional. Start of operation. If not set, will be set to the start of the next window. (optional)
	StartTime any
}

var SaasservicemgmtUnitOperation_ConditionsFields = ubx.FieldMap{
...
var SaasservicemgmtUnitOperation_FlagUpdateFields = ubx.FieldMap{
		"FlagRelease": ubx.FieldSpec{WireName: "flag_release"},
	}

var SaasservicemgmtUnitOperation_Provision_InputVariablesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
		"Value": ubx.FieldSpec{WireName: "value"},
		"Variable": ubx.FieldSpec{WireName: "variable"},
	}

var SaasservicemgmtUnitOperation_ProvisionFields = ubx.FieldMap{
...
var SaasservicemgmtUnitOperation_ScheduleFields = ubx.FieldMap{
		"StartTime": ubx.FieldSpec{WireName: "start_time"},
	}

type SaasservicemgmtUnitOperationConfig struct {
...
type SaasservicemgmtUnitOperationAttrs struct {
	// Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
	Annotations any
	// Optional. When true, attempt to cancel the operation. Cancellation may fail if the operation is already executing. (Optional)
	Cancel any
...
var SaasservicemgmtUnitOperation = ubx.ResourceBinding{
