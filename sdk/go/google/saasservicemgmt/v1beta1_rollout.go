...
type V1beta1Rollout_Control_RunParams struct {
...
type V1beta1Rollout_Control struct {
...
type V1beta1Rollout_Stats_OperationsByState struct {
	Count any
	Group any
}

type V1beta1Rollout_Stats struct {
...
var V1beta1Rollout_Control_RunParamsFields = ubx.FieldMap{
		"RetryFailedOperations": ubx.FieldSpec{WireName: "retry_failed_operations"},
	}

var V1beta1Rollout_ControlFields = ubx.FieldMap{
...
var V1beta1Rollout_Stats_OperationsByStateFields = ubx.FieldMap{
		"Count": ubx.FieldSpec{WireName: "count"},
		"Group": ubx.FieldSpec{WireName: "group"},
	}

var V1beta1Rollout_StatsFields = ubx.FieldMap{
...
type V1beta1RolloutConfig struct {
...
type V1beta1RolloutAttrs struct {
	// Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
	Annotations any
	// RolloutControl provides a way to request a change to the execution of a Rollout by pausing or canceling it.
	Control any
...
var V1beta1Rollout = ubx.ResourceBinding{
