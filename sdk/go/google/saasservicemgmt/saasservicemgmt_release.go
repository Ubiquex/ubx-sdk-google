...
type SaasservicemgmtRelease_Blueprint struct {
...
type SaasservicemgmtRelease_InputVariableDefaults struct {
	Type any
	Value any
	Variable any
}

type SaasservicemgmtRelease_ReleaseRequirements struct {
...
var SaasservicemgmtRelease_BlueprintFields = ubx.FieldMap{
		"Engine": ubx.FieldSpec{WireName: "engine"},
		"Package": ubx.FieldSpec{WireName: "package"},
		"Version": ubx.FieldSpec{WireName: "version"},
	}

var SaasservicemgmtRelease_InputVariableDefaultsFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
		"Value": ubx.FieldSpec{WireName: "value"},
		"Variable": ubx.FieldSpec{WireName: "variable"},
	}

var SaasservicemgmtRelease_ReleaseRequirementsFields = ubx.FieldMap{
		"UpgradeableFromReleases": ubx.FieldSpec{WireName: "upgradeable_from_releases"},
	}

type SaasservicemgmtReleaseConfig struct {
...
type SaasservicemgmtReleaseAttrs struct {
	// Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
	Annotations any
	// Blueprints are OCI Images that contain all of the artifacts needed to provision a unit. Metadata such as, type of the engine used to actuate the blueprint (e.g. terraform, helm etc) and version will come from the image manifest. If the hostname is omitted, it will be assumed to be the regional path to Artifact Registry (eg. us-east1-docker.pkg.dev).
	Blueprint any
...
var SaasservicemgmtRelease = ubx.ResourceBinding{
