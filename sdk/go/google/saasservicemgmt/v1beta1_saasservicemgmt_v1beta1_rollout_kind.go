...
type V1beta1SaasservicemgmtV1beta1RolloutKind_ErrorBudget struct {
...
type V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent struct {
...
type V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing struct {
	...
	MaxConcurrentOperationsCount any
	...
	MaxConcurrentOperationsPercent any
}

var V1beta1SaasservicemgmtV1beta1RolloutKind_ErrorBudgetFields = ubx.FieldMap{
		"AllowedCount": ubx.FieldSpec{WireName: "allowed_count"},
		"AllowedPercentage": ubx.FieldSpec{WireName: "allowed_percentage"},
	}

var V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields = ubx.FieldMap{
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacingFields = ubx.FieldMap{
...
type V1beta1SaasservicemgmtV1beta1RolloutKindConfig struct {
	...
	UpdateUnitKindStrategy any
}

type V1beta1SaasservicemgmtV1beta1RolloutKindAttrs struct {
	// Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
	Annotations any
	// Output only. The timestamp when the resource was created.
	CreateTime any
...
var V1beta1SaasservicemgmtV1beta1RolloutKind = ubx.ResourceBinding{
