...
type SaasservicemgmtRolloutKind_ErrorBudget struct {
...
type SaasservicemgmtRolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent struct {
...
type SaasservicemgmtRolloutKind_UnitUpdatePacing struct {
...
var SaasservicemgmtRolloutKind_ErrorBudgetFields = ubx.FieldMap{
		"AllowedCount": ubx.FieldSpec{WireName: "allowed_count"},
		"AllowedPercentage": ubx.FieldSpec{WireName: "allowed_percentage"},
	}

var SaasservicemgmtRolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields = ubx.FieldMap{
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var SaasservicemgmtRolloutKind_UnitUpdatePacingFields = ubx.FieldMap{
...
type SaasservicemgmtRolloutKindConfig struct {
...
type SaasservicemgmtRolloutKindAttrs struct {
	// Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
	Annotations any
	// Output only. The timestamp when the resource was created.
	CreateTime any
...
var SaasservicemgmtRolloutKind = ubx.ResourceBinding{
