...
type SaasservicemgmtUnit_Conditions struct {
...
type SaasservicemgmtUnit_Dependencies struct {
	Alias any
	Unit any
}

type SaasservicemgmtUnit_InputVariables struct {
	Type any
	Value any
	Variable any
}

type SaasservicemgmtUnit_Maintenance struct {
...
var SaasservicemgmtUnit_ConditionsFields = ubx.FieldMap{
...
var SaasservicemgmtUnit_DependenciesFields = ubx.FieldMap{
		"Alias": ubx.FieldSpec{WireName: "alias"},
		"Unit": ubx.FieldSpec{WireName: "unit"},
	}

var SaasservicemgmtUnit_InputVariablesFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
		"Value": ubx.FieldSpec{WireName: "value"},
		"Variable": ubx.FieldSpec{WireName: "variable"},
	}

var SaasservicemgmtUnit_MaintenanceFields = ubx.FieldMap{
		"PinnedUntilTime": ubx.FieldSpec{WireName: "pinned_until_time"},
	}

type SaasservicemgmtUnitConfig struct {
...
type SaasservicemgmtUnitAttrs struct {
	// Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
	Annotations any
	// Optional. Output only. A set of conditions which indicate the various conditions this resource can have.
	Conditions any
...
var SaasservicemgmtUnit = ubx.ResourceBinding{
