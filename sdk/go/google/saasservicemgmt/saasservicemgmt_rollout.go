...
type SaasservicemgmtRollout_Control_RunParams struct {
...
type SaasservicemgmtRollout_Control struct {
...
type SaasservicemgmtRollout_Stats_OperationsByState struct {
	Count any
	Group any
}

type SaasservicemgmtRollout_Stats struct {
...
var SaasservicemgmtRollout_Control_RunParamsFields = ubx.FieldMap{
		"RetryFailedOperations": ubx.FieldSpec{WireName: "retry_failed_operations"},
	}

var SaasservicemgmtRollout_ControlFields = ubx.FieldMap{
...
var SaasservicemgmtRollout_Stats_OperationsByStateFields = ubx.FieldMap{
		"Count": ubx.FieldSpec{WireName: "count"},
		"Group": ubx.FieldSpec{WireName: "group"},
	}

var SaasservicemgmtRollout_StatsFields = ubx.FieldMap{
...
type SaasservicemgmtRolloutConfig struct {
...
type SaasservicemgmtRolloutAttrs struct {
	// Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
	Annotations any
	// RolloutControl provides a way to request a change to the execution of a Rollout by pausing or canceling it.
	Control any
...
var SaasservicemgmtRollout = ubx.ResourceBinding{
