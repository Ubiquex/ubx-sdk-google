...
type SaasservicemgmtUnitKind_Dependencies struct {
	Alias any
	UnitKind any
}

type SaasservicemgmtUnitKind_InputVariableMappings_From struct {
	Dependency any
	OutputVariable any
}

type SaasservicemgmtUnitKind_InputVariableMappings_To struct {
	Dependency any
	IgnoreForLookup any
	InputVariable any
}

type SaasservicemgmtUnitKind_InputVariableMappings struct {
	From any
	To any
	Variable any
}

var SaasservicemgmtUnitKind_DependenciesFields = ubx.FieldMap{
		"Alias": ubx.FieldSpec{WireName: "alias"},
		"UnitKind": ubx.FieldSpec{WireName: "unit_kind"},
	}

var SaasservicemgmtUnitKind_InputVariableMappings_FromFields = ubx.FieldMap{
		"Dependency": ubx.FieldSpec{WireName: "dependency"},
		"OutputVariable": ubx.FieldSpec{WireName: "output_variable"},
	}

var SaasservicemgmtUnitKind_InputVariableMappings_ToFields = ubx.FieldMap{
		"Dependency": ubx.FieldSpec{WireName: "dependency"},
		"IgnoreForLookup": ubx.FieldSpec{WireName: "ignore_for_lookup"},
		"InputVariable": ubx.FieldSpec{WireName: "input_variable"},
	}

var SaasservicemgmtUnitKind_InputVariableMappingsFields = ubx.FieldMap{
		"From": ubx.FieldSpec{
			WireName: "from",
			Kind: "object",
...
type SaasservicemgmtUnitKindConfig struct {
...
type SaasservicemgmtUnitKindAttrs struct {
	// Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
	Annotations any
	// Optional. Output only. BoundaryType describes the type of boundary the Unit Kind represents.
	BoundaryType any
...
var SaasservicemgmtUnitKind = ubx.ResourceBinding{
