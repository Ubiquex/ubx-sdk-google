...
type V1beta1CloudidentityV1beta1InboundOidcSsoProfile_IdpConfig struct {
...
type V1beta1CloudidentityV1beta1InboundOidcSsoProfile_RpConfig struct {
...
var V1beta1CloudidentityV1beta1InboundOidcSsoProfile_IdpConfigFields = ubx.FieldMap{
		"ChangePasswordUri": ubx.FieldSpec{WireName: "change_password_uri"},
		"IssuerUri": ubx.FieldSpec{WireName: "issuer_uri"},
	}

var V1beta1CloudidentityV1beta1InboundOidcSsoProfile_RpConfigFields = ubx.FieldMap{
		"ClientId": ubx.FieldSpec{WireName: "client_id"},
		"ClientSecret": ubx.FieldSpec{WireName: "client_secret"},
		"RedirectUris": ubx.FieldSpec{WireName: "redirect_uris"},
	}

type V1beta1CloudidentityV1beta1InboundOidcSsoProfileConfig struct {
...
type V1beta1CloudidentityV1beta1InboundOidcSsoProfileAttrs struct {
	// Immutable. The customer. For example: `customers/C0123abc`.
	Customer any
	// Human-readable name of the OIDC SSO profile.
	DisplayName any
...
var V1beta1CloudidentityV1beta1InboundOidcSsoProfile = ubx.ResourceBinding{
