...
type InboundSsoAssignment_OidcSsoInfo struct {
...
type InboundSsoAssignment_SamlSsoInfo struct {
...
type InboundSsoAssignment_SignInBehavior struct {
...
type InboundSsoAssignmentAttrs struct {
	// Immutable. The customer. For example: `customers/C0123abc`.
	Customer any
...
var InboundSsoAssignment = ubx.ResourceBinding{
