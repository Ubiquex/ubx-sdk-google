...
type V1beta1InboundSsoAssignment_OidcSsoInfo struct {
...
type V1beta1InboundSsoAssignment_SamlSsoInfo struct {
...
type V1beta1InboundSsoAssignment_SignInBehavior struct {
...
type V1beta1InboundSsoAssignmentAttrs struct {
	// Immutable. The customer. For example: `customers/C0123abc`.
	Customer any
...
var V1beta1InboundSsoAssignment = ubx.ResourceBinding{
