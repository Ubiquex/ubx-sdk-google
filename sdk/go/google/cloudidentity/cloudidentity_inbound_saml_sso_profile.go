...
type CloudidentityInboundSamlSsoProfile_IdpConfig struct {
...
type CloudidentityInboundSamlSsoProfile_SpConfig struct {
...
var CloudidentityInboundSamlSsoProfile_IdpConfigFields = ubx.FieldMap{
...
var CloudidentityInboundSamlSsoProfile_SpConfigFields = ubx.FieldMap{
		"AssertionConsumerServiceUri": ubx.FieldSpec{WireName: "assertion_consumer_service_uri"},
		"EntityId": ubx.FieldSpec{WireName: "entity_id"},
	}

type CloudidentityInboundSamlSsoProfileConfig struct {
...
type CloudidentityInboundSamlSsoProfileAttrs struct {
	// Immutable. The customer. For example: `customers/C0123abc`.
	Customer any
	// Human-readable name of the SAML SSO profile.
	DisplayName any
...
var CloudidentityInboundSamlSsoProfile = ubx.ResourceBinding{
