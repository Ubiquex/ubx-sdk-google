...
type CloudidentityInboundOidcSsoProfile_IdpConfig struct {
...
type CloudidentityInboundOidcSsoProfile_RpConfig struct {
...
type CloudidentityInboundOidcSsoProfileAttrs struct {
	// Immutable. The customer. For example: `customers/C0123abc`.
	Customer any
	// Human-readable name of the OIDC SSO profile.
	DisplayName any
...
var CloudidentityInboundOidcSsoProfile = ubx.ResourceBinding{
