...
type V1beta1CloudidentityV1beta1InboundSamlSsoProfile_IdpConfig struct {
...
type V1beta1CloudidentityV1beta1InboundSamlSsoProfile_SpConfig struct {
...
var V1beta1CloudidentityV1beta1InboundSamlSsoProfile_IdpConfigFields = ubx.FieldMap{
...
var V1beta1CloudidentityV1beta1InboundSamlSsoProfile_SpConfigFields = ubx.FieldMap{
		"AssertionConsumerServiceUri": ubx.FieldSpec{WireName: "assertion_consumer_service_uri"},
		"EntityId": ubx.FieldSpec{WireName: "entity_id"},
	}

type V1beta1CloudidentityV1beta1InboundSamlSsoProfileConfig struct {
...
type V1beta1CloudidentityV1beta1InboundSamlSsoProfileAttrs struct {
	// Immutable. The customer. For example: `customers/C0123abc`.
	Customer any
	// Human-readable name of the SAML SSO profile.
	DisplayName any
...
var V1beta1CloudidentityV1beta1InboundSamlSsoProfile = ubx.ResourceBinding{
