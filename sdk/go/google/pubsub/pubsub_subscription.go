...
type PubsubSubscription_AnalyticsHubSubscriptionInfo struct {
...
type PubsubSubscription_BigqueryConfig struct {
...
type PubsubSubscription_BigtableConfig struct {
...
type PubsubSubscription_CloudStorageConfig_AvroConfig struct {
...
type PubsubSubscription_CloudStorageConfig struct {
...
type PubsubSubscription_DeadLetterPolicy struct {
...
type PubsubSubscription_ExpirationPolicy struct {
...
type PubsubSubscription_MessageTransforms_AiInference_UnstructuredInference struct {
	Parameters any
}

type PubsubSubscription_MessageTransforms_AiInference struct {
	Endpoint any
	ServiceAccountEmail any
	UnstructuredInference any
}

type PubsubSubscription_MessageTransforms_Compression struct {
	CompressionAlgorithm any
	CompressionMode any
}

type PubsubSubscription_MessageTransforms_JavascriptUdf struct {
	Code any
	FunctionName any
}

type PubsubSubscription_MessageTransforms struct {
	AiInference any
	Compression any
	Disabled any
	Enabled any
...
type PubsubSubscription_PushConfig_NoWrapper struct {
...
type PubsubSubscription_PushConfig_OidcToken struct {
...
type PubsubSubscription_PushConfig struct {
...
type PubsubSubscription_RetryPolicy struct {
...
var PubsubSubscription_AnalyticsHubSubscriptionInfoFields = ubx.FieldMap{
		"Listing": ubx.FieldSpec{WireName: "listing"},
		"Subscription": ubx.FieldSpec{WireName: "subscription"},
	}

var PubsubSubscription_BigqueryConfigFields = ubx.FieldMap{
...
var PubsubSubscription_BigtableConfigFields = ubx.FieldMap{
...
var PubsubSubscription_CloudStorageConfig_AvroConfigFields = ubx.FieldMap{
		"UseTopicSchema": ubx.FieldSpec{WireName: "use_topic_schema"},
		"WriteMetadata": ubx.FieldSpec{WireName: "write_metadata"},
	}

var PubsubSubscription_CloudStorageConfigFields = ubx.FieldMap{
...
var PubsubSubscription_DeadLetterPolicyFields = ubx.FieldMap{
		"DeadLetterTopic": ubx.FieldSpec{WireName: "dead_letter_topic"},
		"MaxDeliveryAttempts": ubx.FieldSpec{WireName: "max_delivery_attempts"},
	}

var PubsubSubscription_ExpirationPolicyFields = ubx.FieldMap{
		"Ttl": ubx.FieldSpec{WireName: "ttl"},
	}

var PubsubSubscription_MessageTransforms_AiInference_UnstructuredInferenceFields = ubx.FieldMap{
		"Parameters": ubx.FieldSpec{WireName: "parameters"},
	}

var PubsubSubscription_MessageTransforms_AiInferenceFields = ubx.FieldMap{
...
var PubsubSubscription_MessageTransforms_CompressionFields = ubx.FieldMap{
		"CompressionAlgorithm": ubx.FieldSpec{WireName: "compression_algorithm"},
		"CompressionMode": ubx.FieldSpec{WireName: "compression_mode"},
	}

var PubsubSubscription_MessageTransforms_JavascriptUdfFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"FunctionName": ubx.FieldSpec{WireName: "function_name"},
	}

var PubsubSubscription_MessageTransformsFields = ubx.FieldMap{
...
var PubsubSubscription_PushConfig_NoWrapperFields = ubx.FieldMap{
		"WriteMetadata": ubx.FieldSpec{WireName: "write_metadata"},
	}

var PubsubSubscription_PushConfig_OidcTokenFields = ubx.FieldMap{
		"Audience": ubx.FieldSpec{WireName: "audience"},
		"ServiceAccountEmail": ubx.FieldSpec{WireName: "service_account_email"},
	}

var PubsubSubscription_PushConfigFields = ubx.FieldMap{
...
var PubsubSubscription_RetryPolicyFields = ubx.FieldMap{
...
type PubsubSubscriptionAttrs struct {
	// Optional. The approximate amount of time (on a best-effort basis) Pub/Sub waits for the subscriber to acknowledge receipt before resending the message. In the interval after the message is delivered and before it is acknowledged, it is considered to be _outstanding_. During that time period, the message will not be redelivered (on a best-effort basis). For pull subscriptions, this value is used as the initial value for the ack deadline. To override this value for a given message, call `ModifyAckDeadline` with the corresponding `ack_id` if using non-streaming pull or send the `ack_id` in a `StreamingModifyAckDeadlineRequest` if using streaming pull. The minimum custom deadline you can specify is 10 seconds. The maximum custom deadline you can specify is 600 seconds (10 minutes). If this parameter is 0, a default value of 10 seconds is used. For push delivery, this value is also used to set the request timeout for the call to the push endpoint. If the subscriber never acknowledges the message, the Pub/Sub system will eventually redeliver the message.
	AckDeadlineSeconds any
	// Information about an associated [Analytics Hub subscription](https://cloud.google.com/bigquery/docs/analytics-hub-manage-subscriptions).
	AnalyticsHubSubscriptionInfo any
...
var PubsubSubscription = ubx.ResourceBinding{
