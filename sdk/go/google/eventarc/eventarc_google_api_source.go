...
type EventarcGoogleApiSource_LoggingConfig struct {
...
type EventarcGoogleApiSource_OrganizationSubscription struct {
	// Required. Enable org level subscription.
	Enabled any
}

type EventarcGoogleApiSource_ProjectSubscriptions struct {
...
var EventarcGoogleApiSource_LoggingConfigFields = ubx.FieldMap{
		"LogSeverity": ubx.FieldSpec{WireName: "log_severity"},
	}

var EventarcGoogleApiSource_OrganizationSubscriptionFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
	}

var EventarcGoogleApiSource_ProjectSubscriptionsFields = ubx.FieldMap{
...
type EventarcGoogleApiSourceAttrs struct {
	// Optional. Resource annotations.
	Annotations any
	// Output only. The creation time.
	CreateTime any
...
var EventarcGoogleApiSource = ubx.ResourceBinding{
