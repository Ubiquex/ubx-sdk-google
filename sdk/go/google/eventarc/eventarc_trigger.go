...
type EventarcTrigger_Conditions struct {
	Code any
	Message any
}

type EventarcTrigger_Destination_CloudRun struct {
...
type EventarcTrigger_Destination_Gke struct {
...
type EventarcTrigger_Destination_HttpEndpoint struct {
...
type EventarcTrigger_Destination_NetworkConfig struct {
...
type EventarcTrigger_Destination struct {
...
type EventarcTrigger_EventFilters struct {
	Attribute any
	Operator any
	Value any
}

type EventarcTrigger_RetryPolicy struct {
	// Optional. The maximum number of delivery attempts for any message. The only valid value is 1.
	MaxAttempts any
}

type EventarcTrigger_Transport_Pubsub struct {
...
type EventarcTrigger_Transport struct {
	// Represents a Pub/Sub transport.
	Pubsub any
}

var EventarcTrigger_ConditionsFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var EventarcTrigger_Destination_CloudRunFields = ubx.FieldMap{
		"Path": ubx.FieldSpec{WireName: "path"},
		"Region": ubx.FieldSpec{WireName: "region"},
		"Service": ubx.FieldSpec{WireName: "service"},
	}

var EventarcTrigger_Destination_GkeFields = ubx.FieldMap{
...
var EventarcTrigger_Destination_HttpEndpointFields = ubx.FieldMap{
		"Uri": ubx.FieldSpec{WireName: "uri"},
	}

var EventarcTrigger_Destination_NetworkConfigFields = ubx.FieldMap{
		"NetworkAttachment": ubx.FieldSpec{WireName: "network_attachment"},
	}

var EventarcTrigger_DestinationFields = ubx.FieldMap{
...
var EventarcTrigger_EventFiltersFields = ubx.FieldMap{
		"Attribute": ubx.FieldSpec{WireName: "attribute"},
		"Operator": ubx.FieldSpec{WireName: "operator"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var EventarcTrigger_RetryPolicyFields = ubx.FieldMap{
		"MaxAttempts": ubx.FieldSpec{WireName: "max_attempts"},
	}

var EventarcTrigger_Transport_PubsubFields = ubx.FieldMap{
		"Subscription": ubx.FieldSpec{WireName: "subscription"},
		"Topic": ubx.FieldSpec{WireName: "topic"},
	}

var EventarcTrigger_TransportFields = ubx.FieldMap{
...
type EventarcTriggerAttrs struct {
	// Optional. The name of the channel associated with the trigger in `projects/{project}/locations/{location}/channels/{channel}` format. You must provide a channel to receive events from Eventarc SaaS partners.
	Channel any
	// Output only. The reason(s) why a trigger is in FAILED state.
	Conditions any
...
var EventarcTrigger = ubx.ResourceBinding{
