...
type V1betaAuthorizedCertificate_CertificateRawData struct {
...
type V1betaAuthorizedCertificate_ManagedCertificate struct {
...
type V1betaAuthorizedCertificateAttrs struct {
	// An SSL certificate obtained from a certificate authority.
	CertificateRawData any
	// The user-specified display name of the certificate. This is not guaranteed to be unique. Example: My Certificate.
	DisplayName any
...
var V1betaAuthorizedCertificate = ubx.ResourceBinding{
