...
type V1alphaAppengineV1alphaAuthorizedCertificate_CertificateRawData struct {
...
type V1alphaAppengineV1alphaAuthorizedCertificate_ManagedCertificate struct {
...
var V1alphaAppengineV1alphaAuthorizedCertificate_CertificateRawDataFields = ubx.FieldMap{
		"PrivateKey": ubx.FieldSpec{WireName: "private_key"},
		"PublicCertificate": ubx.FieldSpec{WireName: "public_certificate"},
	}

var V1alphaAppengineV1alphaAuthorizedCertificate_ManagedCertificateFields = ubx.FieldMap{
		"LastRenewalTime": ubx.FieldSpec{WireName: "last_renewal_time"},
		"Status": ubx.FieldSpec{WireName: "status"},
	}

type V1alphaAppengineV1alphaAuthorizedCertificateConfig struct {
...
type V1alphaAppengineV1alphaAuthorizedCertificateAttrs struct {
	// An SSL certificate obtained from a certificate authority.
	CertificateRawData any
	// The user-specified display name of the certificate. This is not guaranteed to be unique. Example: My Certificate.
	DisplayName any
...
var V1alphaAppengineV1alphaAuthorizedCertificate = ubx.ResourceBinding{
