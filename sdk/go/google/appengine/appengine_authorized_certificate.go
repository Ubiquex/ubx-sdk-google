...
type AppengineAuthorizedCertificate_CertificateRawData struct {
...
type AppengineAuthorizedCertificate_ManagedCertificate struct {
...
var AppengineAuthorizedCertificate_CertificateRawDataFields = ubx.FieldMap{
		"PrivateKey": ubx.FieldSpec{WireName: "private_key"},
		"PublicCertificate": ubx.FieldSpec{WireName: "public_certificate"},
	}

var AppengineAuthorizedCertificate_ManagedCertificateFields = ubx.FieldMap{
		"LastRenewalTime": ubx.FieldSpec{WireName: "last_renewal_time"},
		"Status": ubx.FieldSpec{WireName: "status"},
	}

type AppengineAuthorizedCertificateConfig struct {
...
type AppengineAuthorizedCertificateAttrs struct {
	// An SSL certificate obtained from a certificate authority.
	CertificateRawData any
	// The user-specified display name of the certificate. This is not guaranteed to be unique. Example: My Certificate.
	DisplayName any
...
var AppengineAuthorizedCertificate = ubx.ResourceBinding{
