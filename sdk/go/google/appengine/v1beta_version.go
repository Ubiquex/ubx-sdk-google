...
type V1betaVersion_ApiConfig struct {
...
type V1betaVersion_AutomaticScaling_CpuUtilization struct {
...
type V1betaVersion_AutomaticScaling_NetworkUtilization struct {
...
type V1betaVersion_AutomaticScaling_RequestUtilization struct {
...
type V1betaVersion_AutomaticScaling_StandardSchedulerSettings struct {
...
type V1betaVersion_AutomaticScaling struct {
...
type V1betaVersion_BasicScaling struct {
...
type V1betaVersion_Deployment_Build struct {
	// The Google Cloud Build id. Example: "f966068f-08b2-42c8-bdfe-74137dff2bf9"
	CloudBuildId any
}

type V1betaVersion_Deployment_CloudBuildOptions struct {
...
type V1betaVersion_Deployment_Container struct {
...
type V1betaVersion_Deployment_Zip struct {
...
type V1betaVersion_Deployment struct {
...
type V1betaVersion_EndpointsApiService struct {
...
type V1betaVersion_Entrypoint struct {
...
type V1betaVersion_FlexibleRuntimeSettings struct {
...
type V1betaVersion_Handlers_ApiEndpoint struct {
	ScriptPath any
}
...
type V1betaVersion_LivenessCheck struct {
	// Interval between health checks.
	CheckInterval any
...
type V1betaVersion_ManualScaling struct {
	// Number of instances to assign to the service at the start. This number can later be altered by using the Modules API (https://cloud.google.com/appengine/docs/python/modules/functions) set_num_instances() function.
	Instances any
}

type V1betaVersion_Network struct {
...
type V1betaVersion_ReadinessCheck struct {
...
type V1betaVersion_Resources struct {
...
type V1betaVersion_VpcAccessConnector struct {
