...
type V1alphaAppengineV1alphaDomainMapping_ResourceRecords struct {
	Name any
	Rrdata any
	Type any
}

type V1alphaAppengineV1alphaDomainMapping_SslSettings struct {
...
var V1alphaAppengineV1alphaDomainMapping_ResourceRecordsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Rrdata": ubx.FieldSpec{WireName: "rrdata"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var V1alphaAppengineV1alphaDomainMapping_SslSettingsFields = ubx.FieldMap{
		"CertificateId": ubx.FieldSpec{WireName: "certificate_id"},
		"IsManagedCertificate": ubx.FieldSpec{WireName: "is_managed_certificate"},
	}

type V1alphaAppengineV1alphaDomainMappingConfig struct {
...
type V1alphaAppengineV1alphaDomainMappingAttrs struct {
	// Relative name of the domain serving the application. Example: example.com.
	Id any
	// Output only. Full path to the DomainMapping resource in the API. Example: apps/myapp/domainMapping/example.com.@OutputOnly
	Name any
...
var V1alphaAppengineV1alphaDomainMapping = ubx.ResourceBinding{
