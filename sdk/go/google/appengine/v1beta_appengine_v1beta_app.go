...
type V1betaAppengineV1betaApp_DispatchRules struct {
	Domain any
	Path any
	Service any
}

type V1betaAppengineV1betaApp_FeatureSettings struct {
...
type V1betaAppengineV1betaApp_Iap struct {
...
var V1betaAppengineV1betaApp_DispatchRulesFields = ubx.FieldMap{
		"Domain": ubx.FieldSpec{WireName: "domain"},
		"Path": ubx.FieldSpec{WireName: "path"},
		"Service": ubx.FieldSpec{WireName: "service"},
	}

var V1betaAppengineV1betaApp_FeatureSettingsFields = ubx.FieldMap{
...
var V1betaAppengineV1betaApp_IapFields = ubx.FieldMap{
...
type V1betaAppengineV1betaAppConfig struct {
...
type V1betaAppengineV1betaAppAttrs struct {
	// Google Apps authentication domain that controls which users can access this application.Defaults to open access for any Google Account.
	AuthDomain any
	// Output only. Google Cloud Storage bucket that can be used for storing files associated with this application. This bucket is associated with the application and can be used by the gcloud deployment commands.@OutputOnly
	CodeBucket any
...
var V1betaAppengineV1betaApp = ubx.ResourceBinding{
