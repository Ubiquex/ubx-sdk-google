...
type AppengineDomainMapping_ResourceRecords struct {
	Name any
	Rrdata any
	Type any
}

type AppengineDomainMapping_SslSettings struct {
...
var AppengineDomainMapping_ResourceRecordsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Rrdata": ubx.FieldSpec{WireName: "rrdata"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var AppengineDomainMapping_SslSettingsFields = ubx.FieldMap{
...
type AppengineDomainMappingAttrs struct {
	// Relative name of the domain serving the application. Example: example.com.
	Id any
	// Output only. Full path to the DomainMapping resource in the API. Example: apps/myapp/domainMapping/example.com.@OutputOnly
	Name any
...
var AppengineDomainMapping = ubx.ResourceBinding{
