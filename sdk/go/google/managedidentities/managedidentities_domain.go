...
type ManagedidentitiesDomain_Trusts struct {
	CreateTime any
...
var ManagedidentitiesDomain_TrustsFields = ubx.FieldMap{
...
type ManagedidentitiesDomainConfig struct {
...
type ManagedidentitiesDomainAttrs struct {
	// Optional. The name of delegated administrator account used to perform Active Directory operations. If not specified, `setupadmin` will be used.
	Admin any
	// Optional. Configuration for audit logs. True if audit logs are enabled, else false. Default is audit logs disabled.
	AuditLogsEnabled any
...
var ManagedidentitiesDomain = ubx.ResourceBinding{
