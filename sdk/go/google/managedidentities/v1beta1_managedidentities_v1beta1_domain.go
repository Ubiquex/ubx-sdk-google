...
type V1beta1ManagedidentitiesV1beta1Domain_Trusts struct {
	CreateTime any
...
var V1beta1ManagedidentitiesV1beta1Domain_TrustsFields = ubx.FieldMap{
...
type V1beta1ManagedidentitiesV1beta1DomainConfig struct {
...
type V1beta1ManagedidentitiesV1beta1DomainAttrs struct {
	// Optional. The name of delegated administrator account used to perform Active Directory operations. If not specified, `setupadmin` will be used.
	Admin any
	// Optional. Configuration for audit logs. True if audit logs are enabled, else false. Default is audit logs disabled.
	AuditLogsEnabled any
...
var V1beta1ManagedidentitiesV1beta1Domain = ubx.ResourceBinding{
