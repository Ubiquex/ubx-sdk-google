...
type V1alphaConnector_PrincipalInfo_ServiceAccount struct {
	// Email address of the service account.
	Email any
}

type V1alphaConnector_PrincipalInfo struct {
	// ServiceAccount represents a GCP service account.
	ServiceAccount any
}

type V1alphaConnector_ResourceInfo struct {
...
type V1alphaConnectorAttrs struct {
	// Output only. Timestamp when the resource was created.
	CreateTime any
	// Optional. An arbitrary user-provided name for the connector. Cannot exceed 64 characters.
	DisplayName any
...
var V1alphaConnector = ubx.ResourceBinding{
