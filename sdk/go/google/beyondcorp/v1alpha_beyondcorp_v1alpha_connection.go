...
type V1alphaBeyondcorpV1alphaConnection_ApplicationEndpoint struct {
...
type V1alphaBeyondcorpV1alphaConnection_Gateway struct {
...
var V1alphaBeyondcorpV1alphaConnection_ApplicationEndpointFields = ubx.FieldMap{
		"Host": ubx.FieldSpec{WireName: "host"},
		"Port": ubx.FieldSpec{WireName: "port"},
	}

var V1alphaBeyondcorpV1alphaConnection_GatewayFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
		"Uri": ubx.FieldSpec{WireName: "uri"},
		"UserPort": ubx.FieldSpec{WireName: "user_port"},
	}

type V1alphaBeyondcorpV1alphaConnectionConfig struct {
...
type V1alphaBeyondcorpV1alphaConnectionAttrs struct {
	// ApplicationEndpoint represents a remote application endpoint.
	ApplicationEndpoint any
	// Optional. List of [google.cloud.beyondcorp.v1main.Connector.name] that are authorised to be associated with this Connection.
	Connectors any
...
var V1alphaBeyondcorpV1alphaConnection = ubx.ResourceBinding{
