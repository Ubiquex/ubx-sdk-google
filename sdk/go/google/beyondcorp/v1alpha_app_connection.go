...
type V1alphaAppConnection_ApplicationEndpoint struct {
...
type V1alphaAppConnection_Gateway struct {
...
var V1alphaAppConnection_ApplicationEndpointFields = ubx.FieldMap{
		"Host": ubx.FieldSpec{WireName: "host"},
		"Port": ubx.FieldSpec{WireName: "port"},
	}

var V1alphaAppConnection_GatewayFields = ubx.FieldMap{
...
type V1alphaAppConnectionConfig struct {
...
type V1alphaAppConnectionAttrs struct {
	// ApplicationEndpoint represents a remote application endpoint.
	ApplicationEndpoint any
	// Optional. List of [google.cloud.beyondcorp.v1main.Connector.name] that are authorized to be associated with this AppConnection.
	Connectors any
...
var V1alphaAppConnection = ubx.ResourceBinding{
