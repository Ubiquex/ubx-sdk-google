...
type DeveloperconnectConnection_BitbucketCloudConfig_AuthorizerCredential struct {
...
type DeveloperconnectConnection_BitbucketCloudConfig struct {
...
type DeveloperconnectConnection_BitbucketDataCenterConfig_ServiceDirectoryConfig struct {
	// Required. The Service Directory service name. Format: projects/{project}/locations/{location}/namespaces/{namespace}/services/{service}.
	Service any
}

type DeveloperconnectConnection_BitbucketDataCenterConfig struct {
	// Represents a personal access token that authorized the Connection, and associated metadata.
	AuthorizerCredential any
...
type DeveloperconnectConnection_CryptoKeyConfig struct {
...
type DeveloperconnectConnection_GitProxyConfig struct {
...
type DeveloperconnectConnection_GithubConfig_AuthorizerCredential struct {
...
type DeveloperconnectConnection_GithubConfig struct {
...
type DeveloperconnectConnection_GithubEnterpriseConfig struct {
...
type DeveloperconnectConnection_GitlabConfig struct {
	// Represents a personal access token that authorized the Connection, and associated metadata.
	AuthorizerCredential any
	// Represents a personal access token that authorized the Connection, and associated metadata.
	ReadAuthorizerCredential any
...
type DeveloperconnectConnection_HttpConfig_BasicAuthentication struct {
...
type DeveloperconnectConnection_HttpConfig_BearerTokenAuthentication struct {
	// Optional. The token SecretManager secret version to authenticate as.
	TokenSecretVersion any
}

type DeveloperconnectConnection_HttpConfig struct {
...
type DeveloperconnectConnection_InstallationState struct {
...
type DeveloperconnectConnection_SecureSourceManagerInstanceConfig struct {
	// Required. Immutable. Secure Source Manager instance resource, formatted as `projects/*/locations/*/instances/*`
	Instance any
}

var DeveloperconnectConnection_BitbucketCloudConfig_AuthorizerCredentialFields = ubx.FieldMap{
		"UserTokenSecretVersion": ubx.FieldSpec{WireName: "user_token_secret_version"},
		"Username": ubx.FieldSpec{WireName: "username"},
	}

var DeveloperconnectConnection_BitbucketCloudConfigFields = ubx.FieldMap{
...
var DeveloperconnectConnection_BitbucketDataCenterConfig_ServiceDirectoryConfigFields = ubx.FieldMap{
		"Service": ubx.FieldSpec{WireName: "service"},
	}

var DeveloperconnectConnection_BitbucketDataCenterConfigFields = ubx.FieldMap{
		"AuthorizerCredential": ubx.FieldSpec{
			WireName: "authorizer_credential",
			Kind: "object",
			Fields: DeveloperconnectConnection_BitbucketCloudConfig_AuthorizerCredentialFields,
...
var DeveloperconnectConnection_CryptoKeyConfigFields = ubx.FieldMap{
		"KeyReference": ubx.FieldSpec{WireName: "key_reference"},
	}

var DeveloperconnectConnection_GitProxyConfigFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
		"HttpProxyBaseUri": ubx.FieldSpec{WireName: "http_proxy_base_uri"},
	}

var DeveloperconnectConnection_GithubConfig_AuthorizerCredentialFields = ubx.FieldMap{
		"OauthTokenSecretVersion": ubx.FieldSpec{WireName: "oauth_token_secret_version"},
		"Username": ubx.FieldSpec{WireName: "username"},
	}

var DeveloperconnectConnection_GithubConfigFields = ubx.FieldMap{
...
var DeveloperconnectConnection_GithubEnterpriseConfigFields = ubx.FieldMap{
...
var DeveloperconnectConnection_GitlabConfigFields = ubx.FieldMap{
		"AuthorizerCredential": ubx.FieldSpec{
			WireName: "authorizer_credential",
			Kind: "object",
			Fields: DeveloperconnectConnection_BitbucketCloudConfig_AuthorizerCredentialFields,
...
var DeveloperconnectConnection_HttpConfig_BasicAuthenticationFields = ubx.FieldMap{
		"PasswordSecretVersion": ubx.FieldSpec{WireName: "password_secret_version"},
		"Username": ubx.FieldSpec{WireName: "username"},
	}

var DeveloperconnectConnection_HttpConfig_BearerTokenAuthenticationFields = ubx.FieldMap{
		"TokenSecretVersion": ubx.FieldSpec{WireName: "token_secret_version"},
	}

var DeveloperconnectConnection_HttpConfigFields = ubx.FieldMap{
...
var DeveloperconnectConnection_InstallationStateFields = ubx.FieldMap{
		"ActionUri": ubx.FieldSpec{WireName: "action_uri"},
		"Message": ubx.FieldSpec{WireName: "message"},
		"Stage": ubx.FieldSpec{WireName: "stage"},
	}

var DeveloperconnectConnection_SecureSourceManagerInstanceConfigFields = ubx.FieldMap{
...
type DeveloperconnectConnectionAttrs struct {
	// Optional. Allows clients to store small amounts of arbitrary data.
	Annotations any
	// Configuration for connections to an instance of Bitbucket Cloud.
	BitbucketCloudConfig any
...
var DeveloperconnectConnection = ubx.ResourceBinding{
