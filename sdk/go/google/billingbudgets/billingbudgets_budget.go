...
type BillingbudgetsBudget_Amount_SpecifiedAmount struct {
...
type BillingbudgetsBudget_Amount struct {
...
type BillingbudgetsBudget_BudgetFilter_CustomPeriod_EndDate struct {
...
type BillingbudgetsBudget_BudgetFilter_CustomPeriod struct {
...
type BillingbudgetsBudget_BudgetFilter struct {
...
type BillingbudgetsBudget_NotificationsRule struct {
...
type BillingbudgetsBudget_ThresholdRules struct {
	SpendBasis any
	ThresholdPercent any
}

var BillingbudgetsBudget_Amount_SpecifiedAmountFields = ubx.FieldMap{
		"CurrencyCode": ubx.FieldSpec{WireName: "currency_code"},
		"Nanos": ubx.FieldSpec{WireName: "nanos"},
		"Units": ubx.FieldSpec{WireName: "units"},
	}

var BillingbudgetsBudget_AmountFields = ubx.FieldMap{
...
var BillingbudgetsBudget_BudgetFilter_CustomPeriod_EndDateFields = ubx.FieldMap{
		"Day": ubx.FieldSpec{WireName: "day"},
		"Month": ubx.FieldSpec{WireName: "month"},
		"Year": ubx.FieldSpec{WireName: "year"},
	}

var BillingbudgetsBudget_BudgetFilter_CustomPeriodFields = ubx.FieldMap{
...
var BillingbudgetsBudget_BudgetFilterFields = ubx.FieldMap{
...
var BillingbudgetsBudget_NotificationsRuleFields = ubx.FieldMap{
...
type BillingbudgetsBudgetAttrs struct {
	// The budgeted amount for each usage period.
	Amount any
	// A filter for a budget, limiting the scope of the cost to calculate.
	BudgetFilter any
...
var BillingbudgetsBudget = ubx.ResourceBinding{
