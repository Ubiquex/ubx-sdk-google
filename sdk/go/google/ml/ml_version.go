...
type MlVersion_AcceleratorConfig struct {
...
type MlVersion_AutoScaling_Metrics struct {
	Name any
	Target any
}

type MlVersion_AutoScaling struct {
...
type MlVersion_Container_Env struct {
	Name any
	Value any
}

type MlVersion_Container_Ports struct {
	ContainerPort any
}

type MlVersion_Container struct {
...
type MlVersion_ExplanationConfig_IntegratedGradientsAttribution struct {
	// Number of steps for approximating the path integral. A good value to start is 50 and gradually increase until the sum to diff property is met within the desired error range.
	NumIntegralSteps any
}

type MlVersion_ExplanationConfig_SampledShapleyAttribution struct {
	// The number of feature permutations to consider when approximating the Shapley values.
	NumPaths any
}

type MlVersion_ExplanationConfig struct {
...
type MlVersion_ManualScaling struct {
	// The number of nodes to allocate for this model. These nodes are always up, starting from the time the model is deployed, so the cost of operating this model will be proportional to `nodes` * number of hours since last billing cycle plus the cost for each prediction performed.
	Nodes any
}

type MlVersion_RequestLoggingConfig struct {
...
var MlVersion_AcceleratorConfigFields = ubx.FieldMap{
		"Count": ubx.FieldSpec{WireName: "count"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var MlVersion_AutoScaling_MetricsFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Target": ubx.FieldSpec{WireName: "target"},
	}

var MlVersion_AutoScalingFields = ubx.FieldMap{
...
var MlVersion_Container_EnvFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var MlVersion_Container_PortsFields = ubx.FieldMap{
		"ContainerPort": ubx.FieldSpec{WireName: "container_port"},
	}

var MlVersion_ContainerFields = ubx.FieldMap{
...
var MlVersion_ExplanationConfig_IntegratedGradientsAttributionFields = ubx.FieldMap{
		"NumIntegralSteps": ubx.FieldSpec{WireName: "num_integral_steps"},
	}

var MlVersion_ExplanationConfig_SampledShapleyAttributionFields = ubx.FieldMap{
		"NumPaths": ubx.FieldSpec{WireName: "num_paths"},
	}

var MlVersion_ExplanationConfigFields = ubx.FieldMap{
...
var MlVersion_ManualScalingFields = ubx.FieldMap{
		"Nodes": ubx.FieldSpec{WireName: "nodes"},
	}

var MlVersion_RequestLoggingConfigFields = ubx.FieldMap{
...
var MlVersion = ubx.ResourceBinding{
