...
type Version_AcceleratorConfig struct {
...
type Version_AutoScaling struct {
...
type Version_Container_Ports struct {
	ContainerPort any
}

type Version_Container struct {
...
type Version_ExplanationConfig_IntegratedGradientsAttribution struct {
	// Number of steps for approximating the path integral. A good value to start is 50 and gradually increase until the sum to diff property is met within the desired error range.
	NumIntegralSteps any
}

type Version_ExplanationConfig_SampledShapleyAttribution struct {
	// The number of feature permutations to consider when approximating the Shapley values.
	NumPaths any
}

type Version_ExplanationConfig struct {
...
type Version_RequestLoggingConfig struct {
