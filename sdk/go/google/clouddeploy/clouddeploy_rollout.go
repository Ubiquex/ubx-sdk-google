...
type ClouddeployRollout_Metadata_Automation struct {
...
type ClouddeployRollout_Metadata_CloudRun struct {
...
type ClouddeployRollout_Metadata_Custom struct {
	// Output only. Key-value pairs provided by the user-defined operation.
	Values any
}

type ClouddeployRollout_Metadata struct {
...
type ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJob_CustomChecks_Task_Container struct {
	Args any
	Command any
	Env any
	Image any
...
type ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJob_CustomChecks_Task struct {
	Container any
}

type ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJob_CustomChecks struct {
	Frequency any
	Id any
	Task any
}

type ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJob_GoogleCloud_AlertPolicyChecks struct {
	AlertPolicies any
	Id any
	Labels any
}

type ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJob_GoogleCloud struct {
	AlertPolicyChecks any
}

type ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJob struct {
	CustomChecks any
	Duration any
	GoogleCloud any
}

type ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_PostdeployJob struct {
	Actions any
	Tasks any
}

type ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_VerifyJob struct {
	Tasks any
}

type ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs struct {
...
type ClouddeployRollout_Phases_ChildRolloutJobs struct {
	AdvanceRolloutJobs any
	CreateRolloutJobs any
}

type ClouddeployRollout_Phases_DeploymentJobs struct {
	AnalysisJob any
	DeployJob any
	PostdeployJob any
	PredeployJob any
...
type ClouddeployRollout_Phases struct {
...
var ClouddeployRollout_Metadata_AutomationFields = ubx.FieldMap{
...
var ClouddeployRollout_Metadata_CloudRunFields = ubx.FieldMap{
...
var ClouddeployRollout_Metadata_CustomFields = ubx.FieldMap{
		"Values": ubx.FieldSpec{WireName: "values"},
	}

var ClouddeployRollout_MetadataFields = ubx.FieldMap{
...
var ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJob_CustomChecks_Task_ContainerFields = ubx.FieldMap{
...
var ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJob_CustomChecks_TaskFields = ubx.FieldMap{
...
var ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJob_CustomChecksFields = ubx.FieldMap{
...
var ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJob_GoogleCloud_AlertPolicyChecksFields = ubx.FieldMap{
		"AlertPolicies": ubx.FieldSpec{WireName: "alert_policies"},
		"Id": ubx.FieldSpec{WireName: "id"},
		"Labels": ubx.FieldSpec{WireName: "labels"},
	}

var ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJob_GoogleCloudFields = ubx.FieldMap{
...
var ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJobFields = ubx.FieldMap{
...
var ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_PostdeployJobFields = ubx.FieldMap{
...
var ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_VerifyJobFields = ubx.FieldMap{
		"Tasks": ubx.FieldSpec{
			WireName: "tasks",
			Kind: "list",
			Fields: ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobs_AnalysisJob_CustomChecks_TaskFields,
...
var ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobsFields = ubx.FieldMap{
...
var ClouddeployRollout_Phases_ChildRolloutJobsFields = ubx.FieldMap{
...
var ClouddeployRollout_Phases_DeploymentJobsFields = ubx.FieldMap{
		"AnalysisJob": ubx.FieldSpec{
			WireName: "analysis_job",
			Kind: "object",
			Fields: ClouddeployRollout_Phases_ChildRolloutJobs_AdvanceRolloutJobsFields,
...
var ClouddeployRollout_PhasesFields = ubx.FieldMap{
...
type ClouddeployRolloutConfig struct {
...
type ClouddeployRolloutAttrs struct {
	// Output only. The AutomationRun actively repairing the rollout.
	ActiveRepairAutomationRun any
	// Optional. User annotations. These attributes can only be set and used by the user, and not by Cloud Deploy. See https://google.aip.dev/128#annotations for more details such as format and size limitations.
	Annotations any
...
var ClouddeployRollout = ubx.ResourceBinding{
