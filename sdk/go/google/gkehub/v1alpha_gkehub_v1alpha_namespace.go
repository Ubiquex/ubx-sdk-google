...
type V1alphaGkehubV1alphaNamespace_State struct {
	// Output only. The current state of the Namespace resource.
	Code any
}

var V1alphaGkehubV1alphaNamespace_StateFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
	}

type V1alphaGkehubV1alphaNamespaceConfig struct {
...
type V1alphaGkehubV1alphaNamespaceAttrs struct {
	// Output only. When the namespace was created.
	CreateTime any
	// Output only. When the namespace was deleted.
	DeleteTime any
...
var V1alphaGkehubV1alphaNamespace = ubx.ResourceBinding{
