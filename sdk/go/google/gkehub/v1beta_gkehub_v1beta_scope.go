...
type V1betaGkehubV1betaScope_State struct {
	// Output only. The current state of the scope resource.
	Code any
}

var V1betaGkehubV1betaScope_StateFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
	}

type V1betaGkehubV1betaScopeConfig struct {
...
type V1betaGkehubV1betaScopeAttrs struct {
	// Output only. When the scope was created.
	CreateTime any
	// Output only. When the scope was deleted.
	DeleteTime any
...
var V1betaGkehubV1betaScope = ubx.ResourceBinding{
