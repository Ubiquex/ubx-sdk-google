...
type V1betaRolloutSequence_AutoUpgradeConfig_RolloutCreationScope struct {
	// Optional. The list of enabled upgrade types.
	UpgradeTypes any
}

type V1betaRolloutSequence_AutoUpgradeConfig struct {
...
type V1betaRolloutSequence_IgnoredClustersSelector struct {
	// Required. A valid CEL (Common Expression Language) expression which evaluates `resource.labels`.
	LabelSelector any
}

type V1betaRolloutSequence_OperationalState struct {
...
var V1betaRolloutSequence = ubx.ResourceBinding{
