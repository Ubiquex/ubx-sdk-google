...
type V1alphaGkehubV1alphaMembership_Authority struct {
...
type V1alphaGkehubV1alphaMembership_Endpoint_ApplianceCluster struct {
...
type V1alphaGkehubV1alphaMembership_Endpoint_GkeCluster struct {
...
type V1alphaGkehubV1alphaMembership_Endpoint_KubernetesMetadata struct {
...
type V1alphaGkehubV1alphaMembership_Endpoint_KubernetesResource_ConnectResources struct {
	ClusterScoped any
	Manifest any
}

type V1alphaGkehubV1alphaMembership_Endpoint_KubernetesResource_ResourceOptions struct {
...
type V1alphaGkehubV1alphaMembership_Endpoint_KubernetesResource struct {
...
type V1alphaGkehubV1alphaMembership_Endpoint_OnPremCluster struct {
...
type V1alphaGkehubV1alphaMembership_Endpoint struct {
...
type V1alphaGkehubV1alphaMembership_MonitoringConfig struct {
...
type V1alphaGkehubV1alphaMembership_State struct {
	// Output only. The current state of the Membership resource.
	Code any
}

var V1alphaGkehubV1alphaMembership_AuthorityFields = ubx.FieldMap{
...
var V1alphaGkehubV1alphaMembership_Endpoint_ApplianceClusterFields = ubx.FieldMap{
		"ResourceLink": ubx.FieldSpec{WireName: "resource_link"},
	}

var V1alphaGkehubV1alphaMembership_Endpoint_GkeClusterFields = ubx.FieldMap{
		"ClusterMissing": ubx.FieldSpec{WireName: "cluster_missing"},
		"ResourceLink": ubx.FieldSpec{WireName: "resource_link"},
	}

var V1alphaGkehubV1alphaMembership_Endpoint_KubernetesMetadataFields = ubx.FieldMap{
...
var V1alphaGkehubV1alphaMembership_Endpoint_KubernetesResource_ConnectResourcesFields = ubx.FieldMap{
		"ClusterScoped": ubx.FieldSpec{WireName: "cluster_scoped"},
		"Manifest": ubx.FieldSpec{WireName: "manifest"},
	}

var V1alphaGkehubV1alphaMembership_Endpoint_KubernetesResource_ResourceOptionsFields = ubx.FieldMap{
...
var V1alphaGkehubV1alphaMembership_Endpoint_KubernetesResourceFields = ubx.FieldMap{
...
var V1alphaGkehubV1alphaMembership_Endpoint_OnPremClusterFields = ubx.FieldMap{
...
var V1alphaGkehubV1alphaMembership_EndpointFields = ubx.FieldMap{
...
var V1alphaGkehubV1alphaMembership_MonitoringConfigFields = ubx.FieldMap{
...
var V1alphaGkehubV1alphaMembership_StateFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
	}

type V1alphaGkehubV1alphaMembershipConfig struct {
...
type V1alphaGkehubV1alphaMembershipAttrs struct {
	// Authority encodes how Google will recognize identities from this Membership. See the workload identity documentation for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
	Authority any
	// Output only. The tier of the cluster.
	ClusterTier any
...
var V1alphaGkehubV1alphaMembership = ubx.ResourceBinding{
