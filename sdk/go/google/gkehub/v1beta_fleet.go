...
type V1betaFleet_DefaultClusterConfig_BinaryAuthorizationConfig_PolicyBindings struct {
	Name any
}

type V1betaFleet_DefaultClusterConfig_BinaryAuthorizationConfig struct {
...
type V1betaFleet_DefaultClusterConfig_CompliancePostureConfig_ComplianceStandards struct {
	Standard any
}

type V1betaFleet_DefaultClusterConfig_CompliancePostureConfig struct {
...
type V1betaFleet_DefaultClusterConfig_SecurityPostureConfig struct {
...
type V1betaFleet_DefaultClusterConfig struct {
