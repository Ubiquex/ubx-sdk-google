...
type V1betaGkehubV1betaNamespace_State struct {
	// Output only. The current state of the Namespace resource.
	Code any
}

var V1betaGkehubV1betaNamespace_StateFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
	}

type V1betaGkehubV1betaNamespaceConfig struct {
...
type V1betaGkehubV1betaNamespaceAttrs struct {
	// Output only. When the namespace was created.
	CreateTime any
	// Output only. When the namespace was deleted.
	DeleteTime any
...
var V1betaGkehubV1betaNamespace = ubx.ResourceBinding{
