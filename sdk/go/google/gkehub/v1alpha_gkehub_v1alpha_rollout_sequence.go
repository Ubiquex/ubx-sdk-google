...
type V1alphaGkehubV1alphaRolloutSequence_AutoUpgradeConfig_RolloutCreationScope struct {
	// Optional. The list of enabled upgrade types.
	UpgradeTypes any
}

type V1alphaGkehubV1alphaRolloutSequence_AutoUpgradeConfig struct {
...
type V1alphaGkehubV1alphaRolloutSequence_IgnoredClustersSelector struct {
	// Required. A valid CEL (Common Expression Language) expression which evaluates `resource.labels`.
	LabelSelector any
}

type V1alphaGkehubV1alphaRolloutSequence_OperationalState struct {
...
type V1alphaGkehubV1alphaRolloutSequence_Stages struct {
	ClusterSelector any
	FleetProjects any
	SoakDuration any
}

var V1alphaGkehubV1alphaRolloutSequence_AutoUpgradeConfig_RolloutCreationScopeFields = ubx.FieldMap{
		"UpgradeTypes": ubx.FieldSpec{WireName: "upgrade_types"},
	}

var V1alphaGkehubV1alphaRolloutSequence_AutoUpgradeConfigFields = ubx.FieldMap{
...
var V1alphaGkehubV1alphaRolloutSequence_IgnoredClustersSelectorFields = ubx.FieldMap{
		"LabelSelector": ubx.FieldSpec{WireName: "label_selector"},
	}

var V1alphaGkehubV1alphaRolloutSequence_OperationalStateFields = ubx.FieldMap{
		"Reasons": ubx.FieldSpec{WireName: "reasons"},
		"State": ubx.FieldSpec{WireName: "state"},
		"StateChangeTime": ubx.FieldSpec{WireName: "state_change_time"},
	}

var V1alphaGkehubV1alphaRolloutSequence_StagesFields = ubx.FieldMap{
...
type V1alphaGkehubV1alphaRolloutSequenceConfig struct {
...
type V1alphaGkehubV1alphaRolloutSequenceAttrs struct {
	// Configuration for automatic upgrades.
	AutoUpgradeConfig any
	// Output only. The computed release channel used for the Rollout Sequence.
	ComputedReleaseChannel any
...
var V1alphaGkehubV1alphaRolloutSequence = ubx.ResourceBinding{
