...
type V1betaGkehubV1betaRolloutSequence_AutoUpgradeConfig_RolloutCreationScope struct {
	// Optional. The list of enabled upgrade types.
	UpgradeTypes any
}

type V1betaGkehubV1betaRolloutSequence_AutoUpgradeConfig struct {
...
type V1betaGkehubV1betaRolloutSequence_IgnoredClustersSelector struct {
	// Required. A valid CEL (Common Expression Language) expression which evaluates `resource.labels`.
	LabelSelector any
}

type V1betaGkehubV1betaRolloutSequence_OperationalState struct {
...
type V1betaGkehubV1betaRolloutSequence_Stages struct {
	ClusterSelector any
	FleetProjects any
	SoakDuration any
}

var V1betaGkehubV1betaRolloutSequence_AutoUpgradeConfig_RolloutCreationScopeFields = ubx.FieldMap{
		"UpgradeTypes": ubx.FieldSpec{WireName: "upgrade_types"},
	}

var V1betaGkehubV1betaRolloutSequence_AutoUpgradeConfigFields = ubx.FieldMap{
...
var V1betaGkehubV1betaRolloutSequence_IgnoredClustersSelectorFields = ubx.FieldMap{
		"LabelSelector": ubx.FieldSpec{WireName: "label_selector"},
	}

var V1betaGkehubV1betaRolloutSequence_OperationalStateFields = ubx.FieldMap{
		"Reasons": ubx.FieldSpec{WireName: "reasons"},
		"State": ubx.FieldSpec{WireName: "state"},
		"StateChangeTime": ubx.FieldSpec{WireName: "state_change_time"},
	}

var V1betaGkehubV1betaRolloutSequence_StagesFields = ubx.FieldMap{
...
type V1betaGkehubV1betaRolloutSequenceConfig struct {
...
type V1betaGkehubV1betaRolloutSequenceAttrs struct {
	// Configuration for automatic upgrades.
	AutoUpgradeConfig any
	// Output only. The computed release channel used for the Rollout Sequence.
	ComputedReleaseChannel any
...
var V1betaGkehubV1betaRolloutSequence = ubx.ResourceBinding{
