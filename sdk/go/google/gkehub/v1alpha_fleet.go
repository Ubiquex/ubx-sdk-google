...
type V1alphaFleet_DefaultClusterConfig_BinaryAuthorizationConfig_PolicyBindings struct {
	Name any
}

type V1alphaFleet_DefaultClusterConfig_BinaryAuthorizationConfig struct {
...
type V1alphaFleet_DefaultClusterConfig_CompliancePostureConfig_ComplianceStandards struct {
	Standard any
}

type V1alphaFleet_DefaultClusterConfig_CompliancePostureConfig struct {
...
type V1alphaFleet_DefaultClusterConfig_SecurityPostureConfig struct {
...
type V1alphaFleet_DefaultClusterConfig struct {
...
type V1alphaFleet_State struct {
...
var V1alphaFleet = ubx.ResourceBinding{
