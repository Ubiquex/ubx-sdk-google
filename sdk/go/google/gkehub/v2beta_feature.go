...
type V2betaFeature_LifecycleState struct {
	// Output only. The current state of the Feature resource in the Hub API.
	State any
}

type V2betaFeature_Spec_Cloudbuild struct {
...
type V2betaFeature_Spec_Configmanagement_Binauthz struct {
	// Whether binauthz is enabled in this cluster.
	Enabled any
}

type V2betaFeature_Spec_Configmanagement_ConfigSync_DeploymentOverrides_Containers struct {
	ContainerName any
	CpuLimit      any
	CpuRequest    any
	MemoryLimit   any
...
type V2betaFeature_Spec_Configmanagement_ConfigSync_DeploymentOverrides struct {
	Containers          any
	DeploymentName      any
	DeploymentNamespace any
}

type V2betaFeature_Spec_Configmanagement_ConfigSync_Git struct {
...
type V2betaFeature_Spec_Configmanagement_ConfigSync_Oci struct {
	// Optional. The Google Cloud Service Account Email used for auth when secret_type is `gcpserviceaccount`.
	GcpServiceAccountEmail any
...
type V2betaFeature_Spec_Configmanagement_ConfigSync struct {
...
type V2betaFeature_Spec_Configmanagement_HierarchyController struct {
...
type V2betaFeature_Spec_Configmanagement_PolicyController_Monitoring struct {
	// Specifies the list of backends Policy Controller will export to. An empty list would effectively disable metrics export.
	Backends any
}

type V2betaFeature_Spec_Configmanagement_PolicyController struct {
...
type V2betaFeature_Spec_Configmanagement struct {
...
type V2betaFeature_Spec_Identityservice_AuthMethods_AzureadConfig struct {
	ClientId              any
	ClientSecret          any
...
type V2betaFeature_Spec_Identityservice_AuthMethods_GoogleConfig struct {
	Disable any
}

type V2betaFeature_Spec_Identityservice_AuthMethods_LdapConfig_Group struct {
	BaseDn      any
	Filter      any
	IdAttribute any
}

type V2betaFeature_Spec_Identityservice_AuthMethods_LdapConfig_Server struct {
	CertificateAuthorityData any
	ConnectionType           any
	Host                     any
}

type V2betaFeature_Spec_Identityservice_AuthMethods_LdapConfig_ServiceAccount_SimpleBindCredentials struct {
	Dn                any
	EncryptedPassword any
	Password          any
}

type V2betaFeature_Spec_Identityservice_AuthMethods_LdapConfig_ServiceAccount struct {
	SimpleBindCredentials any
}

type V2betaFeature_Spec_Identityservice_AuthMethods_LdapConfig_User struct {
	BaseDn         any
	Filter         any
	IdAttribute    any
	LoginAttribute any
...
type V2betaFeature_Spec_Identityservice_AuthMethods_LdapConfig struct {
	Group          any
	Server         any
	ServiceAccount any
	User           any
...
type V2betaFeature_Spec_Identityservice_AuthMethods_OidcConfig struct {
	CertificateAuthorityData any
	ClientId                 any
	ClientSecret             any
...
type V2betaFeature_Spec_Identityservice_AuthMethods_SamlConfig struct {
...
type V2betaFeature_Spec_Identityservice_AuthMethods struct {
	AzureadConfig any
	GoogleConfig  any
	LdapConfig    any
	Name          any
...
type V2betaFeature_Spec_Identityservice_IdentityServiceOptions_DiagnosticInterface struct {
...
type V2betaFeature_Spec_Identityservice_IdentityServiceOptions struct {
...
type V2betaFeature_Spec_Identityservice struct {
...
type V2betaFeature_Spec_Origin struct {
	// Type specifies which type of origin is set.
	Type any
}

type V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_DeploymentConfigs_ContainerResources_Limits struct {
	Cpu    any
	Memory any
}

type V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_DeploymentConfigs_ContainerResources struct {
	Limits   any
	Requests any
}

type V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_DeploymentConfigs_PodTolerations struct {
	Effect   any
	Key      any
	Operator any
	Value    any
...
type V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_DeploymentConfigs struct {
...
type V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_PolicyContent_Bundles struct {
	ExemptedNamespaces any
}

type V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_PolicyContent_TemplateLibrary struct {
	// Configures the manner in which the template library is installed on the cluster.
	Installation any
}

type V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_PolicyContent struct {
...
type V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig struct {
	// Sets the interval for Policy Controller Audit Scans (in seconds). When set to 0, this disables audit functionality altogether.
	AuditIntervalSeconds any
...
type V2betaFeature_Spec_Policycontroller struct {
	// Configuration for Policy Controller
...
type V2betaFeature_Spec_Servicemesh struct {
...
type V2betaFeature_State_Appdevexperience_NetworkingInstallSucceeded struct {
...
type V2betaFeature_State_Appdevexperience struct {
	// Status specifies state for the subcomponent.
	NetworkingInstallSucceeded any
}

type V2betaFeature_State_Clusterupgrade_Ignored struct {
...
type V2betaFeature_State_Clusterupgrade_Upgrades_Status struct {
	Code       any
	Reason     any
	UpdateTime any
}

type V2betaFeature_State_Clusterupgrade_Upgrades_Upgrade struct {
	Name    any
	Version any
}

type V2betaFeature_State_Clusterupgrade_Upgrades struct {
	Status  any
	Upgrade any
}

type V2betaFeature_State_Clusterupgrade struct {
...
type V2betaFeature_State_Configmanagement_BinauthzState_Version struct {
	// The version of the binauthz webhook.
	WebhookVersion any
}

type V2betaFeature_State_Configmanagement_BinauthzState struct {
...
type V2betaFeature_State_Configmanagement_ConfigSyncState_DeploymentState struct {
...
type V2betaFeature_State_Configmanagement_ConfigSyncState_Errors struct {
	ErrorMessage any
}

type V2betaFeature_State_Configmanagement_ConfigSyncState_SyncState_Errors_ErrorResources_ResourceGvk struct {
	Group   any
	Kind    any
	Version any
}

type V2betaFeature_State_Configmanagement_ConfigSyncState_SyncState_Errors_ErrorResources struct {
	ResourceGvk       any
	ResourceName      any
...
type V2betaFeature_State_Configmanagement_ConfigSyncState_SyncState_Errors struct {
	Code           any
	ErrorMessage   any
	ErrorResources any
}

type V2betaFeature_State_Configmanagement_ConfigSyncState_SyncState struct {
	// Sync status code.
	Code any
...
type V2betaFeature_State_Configmanagement_ConfigSyncState struct {
...
type V2betaFeature_State_Configmanagement_HierarchyControllerState_State struct {
...
type V2betaFeature_State_Configmanagement_HierarchyControllerState struct {
...
type V2betaFeature_State_Configmanagement_OperatorState struct {
...
type V2betaFeature_State_Configmanagement_PolicyControllerState_DeploymentState struct {
...
type V2betaFeature_State_Configmanagement_PolicyControllerState_Migration struct {
...
type V2betaFeature_State_Configmanagement_PolicyControllerState_Version struct {
	// The gatekeeper image tag that is composed of ACM version, git tag, build number.
	Version any
}

type V2betaFeature_State_Configmanagement_PolicyControllerState struct {
...
type V2betaFeature_State_Configmanagement struct {
	// State for Binauthz.
	BinauthzState any
...
type V2betaFeature_State_Identityservice struct {
...
type V2betaFeature_State_Metering struct {
...
type V2betaFeature_State_Policycontroller_ComponentStates struct {
	Details any
	State   any
}

type V2betaFeature_State_Policycontroller_PolicyContentState struct {
...
type V2betaFeature_State_Policycontroller struct {
...
type V2betaFeature_State_Rbacrolebindingactuation_RbacrolebindingStates struct {
	Description any
	State       any
	UpdateTime  any
}

type V2betaFeature_State_Rbacrolebindingactuation struct {
...
type V2betaFeature_State_Servicemesh_AnalysisMessages_MessageBase_Type struct {
	Code        any
	DisplayName any
}

type V2betaFeature_State_Servicemesh_AnalysisMessages_MessageBase struct {
	DocumentationUrl any
	Level            any
	Type             any
}

type V2betaFeature_State_Servicemesh_AnalysisMessages struct {
	Args          any
	Description   any
	MessageBase   any
	ResourcePaths any
...
type V2betaFeature_State_Servicemesh_Conditions struct {
	Code              any
	Details           any
...
type V2betaFeature_State_Servicemesh_ControlPlaneManagement_Details struct {
	Code    any
	Details any
}

type V2betaFeature_State_Servicemesh_ControlPlaneManagement struct {
...
type V2betaFeature_State_Servicemesh_DataPlaneManagement struct {
...
type V2betaFeature_State_Servicemesh struct {
...
type V2betaFeature_State_State struct {
...
type V2betaFeature_State_Workloadidentity struct {
...
type V2betaFeature_State struct {
...
var V2betaFeature_LifecycleStateFields = ubx.FieldMap{
	"State": ubx.FieldSpec{WireName: "state"},
}

var V2betaFeature_Spec_CloudbuildFields = ubx.FieldMap{
	"SecurityPolicy": ubx.FieldSpec{WireName: "security_policy"},
	"Version":        ubx.FieldSpec{WireName: "version"},
}

var V2betaFeature_Spec_Configmanagement_BinauthzFields = ubx.FieldMap{
	"Enabled": ubx.FieldSpec{WireName: "enabled"},
}

var V2betaFeature_Spec_Configmanagement_ConfigSync_DeploymentOverrides_ContainersFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Configmanagement_ConfigSync_DeploymentOverridesFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Configmanagement_ConfigSync_GitFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Configmanagement_ConfigSync_OciFields = ubx.FieldMap{
	"GcpServiceAccountEmail": ubx.FieldSpec{WireName: "gcp_service_account_email"},
	"PolicyDir":              ubx.FieldSpec{WireName: "policy_dir"},
	"SecretType":             ubx.FieldSpec{WireName: "secret_type"},
	"SyncRepo":               ubx.FieldSpec{WireName: "sync_repo"},
...
var V2betaFeature_Spec_Configmanagement_ConfigSyncFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Configmanagement_HierarchyControllerFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Configmanagement_PolicyController_MonitoringFields = ubx.FieldMap{
	"Backends": ubx.FieldSpec{WireName: "backends"},
}

var V2betaFeature_Spec_Configmanagement_PolicyControllerFields = ubx.FieldMap{
...
var V2betaFeature_Spec_ConfigmanagementFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Identityservice_AuthMethods_AzureadConfigFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Identityservice_AuthMethods_GoogleConfigFields = ubx.FieldMap{
	"Disable": ubx.FieldSpec{WireName: "disable"},
}

var V2betaFeature_Spec_Identityservice_AuthMethods_LdapConfig_GroupFields = ubx.FieldMap{
	"BaseDn":      ubx.FieldSpec{WireName: "base_dn"},
	"Filter":      ubx.FieldSpec{WireName: "filter"},
	"IdAttribute": ubx.FieldSpec{WireName: "id_attribute"},
}

var V2betaFeature_Spec_Identityservice_AuthMethods_LdapConfig_ServerFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Identityservice_AuthMethods_LdapConfig_ServiceAccount_SimpleBindCredentialsFields = ubx.FieldMap{
	"Dn":                ubx.FieldSpec{WireName: "dn"},
	"EncryptedPassword": ubx.FieldSpec{WireName: "encrypted_password"},
	"Password":          ubx.FieldSpec{WireName: "password"},
}

var V2betaFeature_Spec_Identityservice_AuthMethods_LdapConfig_ServiceAccountFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Identityservice_AuthMethods_LdapConfig_UserFields = ubx.FieldMap{
	"BaseDn":         ubx.FieldSpec{WireName: "base_dn"},
	"Filter":         ubx.FieldSpec{WireName: "filter"},
	"IdAttribute":    ubx.FieldSpec{WireName: "id_attribute"},
...
var V2betaFeature_Spec_Identityservice_AuthMethods_LdapConfigFields = ubx.FieldMap{
	"Group": ubx.FieldSpec{
		WireName: "group",
		Kind:     "object",
...
var V2betaFeature_Spec_Identityservice_AuthMethods_OidcConfigFields = ubx.FieldMap{
	"CertificateAuthorityData": ubx.FieldSpec{WireName: "certificate_authority_data"},
	"ClientId":                 ubx.FieldSpec{WireName: "client_id"},
	"ClientSecret":             ubx.FieldSpec{WireName: "client_secret"},
...
var V2betaFeature_Spec_Identityservice_AuthMethods_SamlConfigFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Identityservice_AuthMethodsFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Identityservice_IdentityServiceOptions_DiagnosticInterfaceFields = ubx.FieldMap{
	"Enabled":        ubx.FieldSpec{WireName: "enabled"},
	"ExpirationTime": ubx.FieldSpec{WireName: "expiration_time"},
}

var V2betaFeature_Spec_Identityservice_IdentityServiceOptionsFields = ubx.FieldMap{
...
var V2betaFeature_Spec_IdentityserviceFields = ubx.FieldMap{
...
var V2betaFeature_Spec_OriginFields = ubx.FieldMap{
	"Type": ubx.FieldSpec{WireName: "type"},
}

var V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_DeploymentConfigs_ContainerResources_LimitsFields = ubx.FieldMap{
	"Cpu":    ubx.FieldSpec{WireName: "cpu"},
	"Memory": ubx.FieldSpec{WireName: "memory"},
}

var V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_DeploymentConfigs_ContainerResourcesFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_DeploymentConfigs_PodTolerationsFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_DeploymentConfigsFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_PolicyContent_BundlesFields = ubx.FieldMap{
	"ExemptedNamespaces": ubx.FieldSpec{WireName: "exempted_namespaces"},
}

var V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_PolicyContent_TemplateLibraryFields = ubx.FieldMap{
	"Installation": ubx.FieldSpec{WireName: "installation"},
}

var V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfig_PolicyContentFields = ubx.FieldMap{
...
var V2betaFeature_Spec_Policycontroller_PolicyControllerHubConfigFields = ubx.FieldMap{
	"AuditIntervalSeconds":     ubx.FieldSpec{WireName: "audit_interval_seconds"},
...
var V2betaFeature_Spec_PolicycontrollerFields = ubx.FieldMap{
...
var V2betaFeature_Spec_ServicemeshFields = ubx.FieldMap{
...
var V2betaFeature_Spec_WorkloadcertificateFields = ubx.FieldMap{
	"CertificateManagement": ubx.FieldSpec{WireName: "certificate_management"},
}

var V2betaFeature_SpecFields = ubx.FieldMap{
...
var V2betaFeature_State_Appdevexperience_NetworkingInstallSucceededFields = ubx.FieldMap{
	"Code":        ubx.FieldSpec{WireName: "code"},
	"Description": ubx.FieldSpec{WireName: "description"},
}

var V2betaFeature_State_AppdevexperienceFields = ubx.FieldMap{
...
var V2betaFeature_State_Clusterupgrade_IgnoredFields = ubx.FieldMap{
	"IgnoredTime": ubx.FieldSpec{WireName: "ignored_time"},
	"Reason":      ubx.FieldSpec{WireName: "reason"},
}

var V2betaFeature_State_Clusterupgrade_Upgrades_StatusFields = ubx.FieldMap{
	"Code":       ubx.FieldSpec{WireName: "code"},
	"Reason":     ubx.FieldSpec{WireName: "reason"},
	"UpdateTime": ubx.FieldSpec{WireName: "update_time"},
}

var V2betaFeature_State_Clusterupgrade_Upgrades_UpgradeFields = ubx.FieldMap{
	"Name":    ubx.FieldSpec{WireName: "name"},
	"Version": ubx.FieldSpec{WireName: "version"},
}

var V2betaFeature_State_Clusterupgrade_UpgradesFields = ubx.FieldMap{
...
var V2betaFeature_State_ClusterupgradeFields = ubx.FieldMap{
...
var V2betaFeature_State_Configmanagement_BinauthzState_VersionFields = ubx.FieldMap{
	"WebhookVersion": ubx.FieldSpec{WireName: "webhook_version"},
}

var V2betaFeature_State_Configmanagement_BinauthzStateFields = ubx.FieldMap{
...
var V2betaFeature_State_Configmanagement_ConfigSyncState_DeploymentStateFields = ubx.FieldMap{
...
var V2betaFeature_State_Configmanagement_ConfigSyncState_ErrorsFields = ubx.FieldMap{
	"ErrorMessage": ubx.FieldSpec{WireName: "error_message"},
}

var V2betaFeature_State_Configmanagement_ConfigSyncState_SyncState_Errors_ErrorResources_ResourceGvkFields = ubx.FieldMap{
	"Group":   ubx.FieldSpec{WireName: "group"},
	"Kind":    ubx.FieldSpec{WireName: "kind"},
	"Version": ubx.FieldSpec{WireName: "version"},
}

var V2betaFeature_State_Configmanagement_ConfigSyncState_SyncState_Errors_ErrorResourcesFields = ubx.FieldMap{
...
var V2betaFeature_State_Configmanagement_ConfigSyncState_SyncState_ErrorsFields = ubx.FieldMap{
	"Code":         ubx.FieldSpec{WireName: "code"},
	"ErrorMessage": ubx.FieldSpec{WireName: "error_message"},
...
var V2betaFeature_State_Configmanagement_ConfigSyncState_SyncStateFields = ubx.FieldMap{
	"Code": ubx.FieldSpec{WireName: "code"},
...
var V2betaFeature_State_Configmanagement_ConfigSyncStateFields = ubx.FieldMap{
...
var V2betaFeature_State_Configmanagement_HierarchyControllerState_StateFields = ubx.FieldMap{
	"Extension": ubx.FieldSpec{WireName: "extension"},
	"Hnc":       ubx.FieldSpec{WireName: "hnc"},
}

var V2betaFeature_State_Configmanagement_HierarchyControllerStateFields = ubx.FieldMap{
	"State": ubx.FieldSpec{
		WireName: "state",
		Kind:     "object",
...
var V2betaFeature_State_Configmanagement_OperatorStateFields = ubx.FieldMap{
...
var V2betaFeature_State_Configmanagement_PolicyControllerState_DeploymentStateFields = ubx.FieldMap{
...
var V2betaFeature_State_Configmanagement_PolicyControllerState_MigrationFields = ubx.FieldMap{
	"CopyTime": ubx.FieldSpec{WireName: "copy_time"},
	"Stage":    ubx.FieldSpec{WireName: "stage"},
}

var V2betaFeature_State_Configmanagement_PolicyControllerState_VersionFields = ubx.FieldMap{
	"Version": ubx.FieldSpec{WireName: "version"},
}

var V2betaFeature_State_Configmanagement_PolicyControllerStateFields = ubx.FieldMap{
	"DeploymentState": ubx.FieldSpec{
		WireName: "deployment_state",
		Kind:     "object",
...
var V2betaFeature_State_ConfigmanagementFields = ubx.FieldMap{
...
var V2betaFeature_State_IdentityserviceFields = ubx.FieldMap{
...
var V2betaFeature_State_MeteringFields = ubx.FieldMap{
...
var V2betaFeature_State_Policycontroller_ComponentStatesFields = ubx.FieldMap{
	"Details": ubx.FieldSpec{WireName: "details"},
	"State":   ubx.FieldSpec{WireName: "state"},
}

var V2betaFeature_State_Policycontroller_PolicyContentStateFields = ubx.FieldMap{
...
var V2betaFeature_State_PolicycontrollerFields = ubx.FieldMap{
...
var V2betaFeature_State_Rbacrolebindingactuation_RbacrolebindingStatesFields = ubx.FieldMap{
	"Description": ubx.FieldSpec{WireName: "description"},
	"State":       ubx.FieldSpec{WireName: "state"},
	"UpdateTime":  ubx.FieldSpec{WireName: "update_time"},
}

var V2betaFeature_State_RbacrolebindingactuationFields = ubx.FieldMap{
...
var V2betaFeature_State_Servicemesh_AnalysisMessages_MessageBase_TypeFields = ubx.FieldMap{
	"Code":        ubx.FieldSpec{WireName: "code"},
	"DisplayName": ubx.FieldSpec{WireName: "display_name"},
}

var V2betaFeature_State_Servicemesh_AnalysisMessages_MessageBaseFields = ubx.FieldMap{
...
var V2betaFeature_State_Servicemesh_AnalysisMessagesFields = ubx.FieldMap{
...
var V2betaFeature_State_Servicemesh_ConditionsFields = ubx.FieldMap{
	"Code":              ubx.FieldSpec{WireName: "code"},
	"Details":           ubx.FieldSpec{WireName: "details"},
...
var V2betaFeature_State_Servicemesh_ControlPlaneManagement_DetailsFields = ubx.FieldMap{
	"Code":    ubx.FieldSpec{WireName: "code"},
	"Details": ubx.FieldSpec{WireName: "details"},
}

var V2betaFeature_State_Servicemesh_ControlPlaneManagementFields = ubx.FieldMap{
...
var V2betaFeature_State_Servicemesh_DataPlaneManagementFields = ubx.FieldMap{
	"Details": ubx.FieldSpec{
		WireName: "details",
		Kind:     "list",
		Fields:   V2betaFeature_State_Servicemesh_ControlPlaneManagement_DetailsFields,
...
var V2betaFeature_State_ServicemeshFields = ubx.FieldMap{
...
var V2betaFeature_State_StateFields = ubx.FieldMap{
	"Code":        ubx.FieldSpec{WireName: "code"},
	"Description": ubx.FieldSpec{WireName: "description"},
	"UpdateTime":  ubx.FieldSpec{WireName: "update_time"},
}

var V2betaFeature_State_WorkloadidentityFields = ubx.FieldMap{
	"Description": ubx.FieldSpec{WireName: "description"},
...
var V2betaFeature_StateFields = ubx.FieldMap{
...
type V2betaFeatureConfig struct {
...
type V2betaFeatureAttrs struct {
...
var V2betaFeature = ubx.ResourceBinding{
