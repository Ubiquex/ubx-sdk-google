...
type V1beta1ArtifactregistryV1beta1RepositoryConfig struct {
...
type V1beta1ArtifactregistryV1beta1RepositoryAttrs struct {
	// Output only. The time when the repository was created.
	CreateTime any
	// The user-provided description of the repository.
	Description any
...
var V1beta1ArtifactregistryV1beta1Repository = ubx.ResourceBinding{
