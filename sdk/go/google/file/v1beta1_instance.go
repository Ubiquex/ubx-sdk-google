...
type V1beta1Instance_DirectoryServices_Ldap struct {
...
type V1beta1Instance_DirectoryServices_ManagedActiveDirectory struct {
...
type V1beta1Instance_DirectoryServices struct {
...
type V1beta1Instance_PerformanceConfig_FixedIops struct {
	// Required. Maximum IOPS.
	MaxIops any
}

type V1beta1Instance_PerformanceConfig_IopsPerTb struct {
	// Required. Maximum IOPS per TiB.
	MaxIopsPerTb any
}

type V1beta1Instance_PerformanceConfig struct {
...
type V1beta1Instance_PerformanceLimits struct {
