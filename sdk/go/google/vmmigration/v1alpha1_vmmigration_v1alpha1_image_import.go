...
type V1alpha1VmmigrationV1alpha1ImageImport_DiskImageTargetDefaults_DataDiskImageImport struct {
...
type V1alpha1VmmigrationV1alpha1ImageImport_DiskImageTargetDefaults_Encryption struct {
	// Required. The name of the encryption key that is stored in Google Cloud KMS.
	KmsKey any
}

type V1alpha1VmmigrationV1alpha1ImageImport_DiskImageTargetDefaults_OsAdaptationParameters_AdaptationModifiers struct {
	Modifier any
	Value any
}

type V1alpha1VmmigrationV1alpha1ImageImport_DiskImageTargetDefaults_OsAdaptationParameters struct {
...
type V1alpha1VmmigrationV1alpha1ImageImport_DiskImageTargetDefaults struct {
...
type V1alpha1VmmigrationV1alpha1ImageImport_MachineImageTargetDefaults_MachineImageParametersOverrides struct {
...
type V1alpha1VmmigrationV1alpha1ImageImport_MachineImageTargetDefaults_NetworkInterfaces struct {
	ExternalIp any
	InternalIp any
	Network any
	NetworkTier any
...
type V1alpha1VmmigrationV1alpha1ImageImport_MachineImageTargetDefaults_ServiceAccount struct {
...
type V1alpha1VmmigrationV1alpha1ImageImport_MachineImageTargetDefaults_ShieldedInstanceConfig struct {
...
type V1alpha1VmmigrationV1alpha1ImageImport_MachineImageTargetDefaults struct {
...
type V1alpha1VmmigrationV1alpha1ImageImport_RecentImageImportJobs_Errors struct {
	Code any
	Details any
	Message any
}

type V1alpha1VmmigrationV1alpha1ImageImport_RecentImageImportJobs_Steps struct {
	AdaptingOs any
	CreatingImage any
	EndTime any
	Initializing any
...
type V1alpha1VmmigrationV1alpha1ImageImport_RecentImageImportJobs_Warnings_ActionItem struct {
	Locale any
	Message any
}

type V1alpha1VmmigrationV1alpha1ImageImport_RecentImageImportJobs_Warnings_HelpLinks struct {
	Description any
	Url any
}

type V1alpha1VmmigrationV1alpha1ImageImport_RecentImageImportJobs_Warnings struct {
	ActionItem any
	Code any
	HelpLinks any
	WarningMessage any
...
type V1alpha1VmmigrationV1alpha1ImageImport_RecentImageImportJobs struct {
	CloudStorageUri any
	CreateTime any
...
var V1alpha1VmmigrationV1alpha1ImageImport_DiskImageTargetDefaults_DataDiskImageImportFields = ubx.FieldMap{
		"GuestOsFeatures": ubx.FieldSpec{WireName: "guest_os_features"},
	}

var V1alpha1VmmigrationV1alpha1ImageImport_DiskImageTargetDefaults_EncryptionFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
	}

var V1alpha1VmmigrationV1alpha1ImageImport_DiskImageTargetDefaults_OsAdaptationParameters_AdaptationModifiersFields = ubx.FieldMap{
		"Modifier": ubx.FieldSpec{WireName: "modifier"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var V1alpha1VmmigrationV1alpha1ImageImport_DiskImageTargetDefaults_OsAdaptationParametersFields = ubx.FieldMap{
...
var V1alpha1VmmigrationV1alpha1ImageImport_DiskImageTargetDefaultsFields = ubx.FieldMap{
...
var V1alpha1VmmigrationV1alpha1ImageImport_MachineImageTargetDefaults_MachineImageParametersOverridesFields = ubx.FieldMap{
		"MachineType": ubx.FieldSpec{WireName: "machine_type"},
	}

var V1alpha1VmmigrationV1alpha1ImageImport_MachineImageTargetDefaults_NetworkInterfacesFields = ubx.FieldMap{
...
var V1alpha1VmmigrationV1alpha1ImageImport_MachineImageTargetDefaults_ServiceAccountFields = ubx.FieldMap{
		"Email": ubx.FieldSpec{WireName: "email"},
		"Scopes": ubx.FieldSpec{WireName: "scopes"},
	}

var V1alpha1VmmigrationV1alpha1ImageImport_MachineImageTargetDefaults_ShieldedInstanceConfigFields = ubx.FieldMap{
...
var V1alpha1VmmigrationV1alpha1ImageImport_MachineImageTargetDefaultsFields = ubx.FieldMap{
		"AdditionalLicenses": ubx.FieldSpec{WireName: "additional_licenses"},
		"Description": ubx.FieldSpec{WireName: "description"},
		"Encryption": ubx.FieldSpec{
			WireName: "encryption",
...
var V1alpha1VmmigrationV1alpha1ImageImport_RecentImageImportJobs_ErrorsFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var V1alpha1VmmigrationV1alpha1ImageImport_RecentImageImportJobs_StepsFields = ubx.FieldMap{
...
var V1alpha1VmmigrationV1alpha1ImageImport_RecentImageImportJobs_Warnings_ActionItemFields = ubx.FieldMap{
		"Locale": ubx.FieldSpec{WireName: "locale"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var V1alpha1VmmigrationV1alpha1ImageImport_RecentImageImportJobs_Warnings_HelpLinksFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Url": ubx.FieldSpec{WireName: "url"},
	}

var V1alpha1VmmigrationV1alpha1ImageImport_RecentImageImportJobs_WarningsFields = ubx.FieldMap{
...
var V1alpha1VmmigrationV1alpha1ImageImport_RecentImageImportJobsFields = ubx.FieldMap{
...
type V1alpha1VmmigrationV1alpha1ImageImportConfig struct {
...
type V1alpha1VmmigrationV1alpha1ImageImportAttrs struct {
	// Immutable. The path to the Cloud Storage file from which the image should be imported.
	CloudStorageUri any
	// Output only. The time the image import was created.
	CreateTime any
...
var V1alpha1VmmigrationV1alpha1ImageImport = ubx.ResourceBinding{
