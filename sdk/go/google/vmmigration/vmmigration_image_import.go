...
type VmmigrationImageImport_DiskImageTargetDefaults_DataDiskImageImport struct {
...
type VmmigrationImageImport_DiskImageTargetDefaults_Encryption struct {
	// Required. The name of the encryption key that is stored in Google Cloud KMS.
	KmsKey any
}

type VmmigrationImageImport_DiskImageTargetDefaults_OsAdaptationParameters_AdaptationModifiers struct {
	Modifier any
	Value any
}

type VmmigrationImageImport_DiskImageTargetDefaults_OsAdaptationParameters struct {
...
type VmmigrationImageImport_DiskImageTargetDefaults struct {
...
type VmmigrationImageImport_MachineImageTargetDefaults_MachineImageParametersOverrides struct {
...
type VmmigrationImageImport_MachineImageTargetDefaults_NetworkInterfaces struct {
	ExternalIp any
	InternalIp any
	Network any
	NetworkTier any
...
type VmmigrationImageImport_MachineImageTargetDefaults_ServiceAccount struct {
...
type VmmigrationImageImport_MachineImageTargetDefaults_ShieldedInstanceConfig struct {
...
type VmmigrationImageImport_MachineImageTargetDefaults struct {
...
type VmmigrationImageImport_RecentImageImportJobs_Errors struct {
	Code any
	Details any
	Message any
}

type VmmigrationImageImport_RecentImageImportJobs_Steps struct {
	AdaptingOs any
	CreatingImage any
	EndTime any
	Initializing any
...
type VmmigrationImageImport_RecentImageImportJobs_Warnings_ActionItem struct {
	Locale any
	Message any
}

type VmmigrationImageImport_RecentImageImportJobs_Warnings_HelpLinks struct {
	Description any
	Url any
}

type VmmigrationImageImport_RecentImageImportJobs_Warnings struct {
	ActionItem any
	Code any
	HelpLinks any
	WarningMessage any
...
type VmmigrationImageImport_RecentImageImportJobs struct {
	CloudStorageUri any
	CreateTime any
...
var VmmigrationImageImport_DiskImageTargetDefaults_DataDiskImageImportFields = ubx.FieldMap{
		"GuestOsFeatures": ubx.FieldSpec{WireName: "guest_os_features"},
	}

var VmmigrationImageImport_DiskImageTargetDefaults_EncryptionFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
	}

var VmmigrationImageImport_DiskImageTargetDefaults_OsAdaptationParameters_AdaptationModifiersFields = ubx.FieldMap{
		"Modifier": ubx.FieldSpec{WireName: "modifier"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var VmmigrationImageImport_DiskImageTargetDefaults_OsAdaptationParametersFields = ubx.FieldMap{
...
var VmmigrationImageImport_DiskImageTargetDefaultsFields = ubx.FieldMap{
...
var VmmigrationImageImport_MachineImageTargetDefaults_MachineImageParametersOverridesFields = ubx.FieldMap{
		"MachineType": ubx.FieldSpec{WireName: "machine_type"},
	}

var VmmigrationImageImport_MachineImageTargetDefaults_NetworkInterfacesFields = ubx.FieldMap{
...
var VmmigrationImageImport_MachineImageTargetDefaults_ServiceAccountFields = ubx.FieldMap{
		"Email": ubx.FieldSpec{WireName: "email"},
		"Scopes": ubx.FieldSpec{WireName: "scopes"},
	}

var VmmigrationImageImport_MachineImageTargetDefaults_ShieldedInstanceConfigFields = ubx.FieldMap{
...
var VmmigrationImageImport_MachineImageTargetDefaultsFields = ubx.FieldMap{
		"AdditionalLicenses": ubx.FieldSpec{WireName: "additional_licenses"},
		"Description": ubx.FieldSpec{WireName: "description"},
		"Encryption": ubx.FieldSpec{
			WireName: "encryption",
...
var VmmigrationImageImport_RecentImageImportJobs_ErrorsFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var VmmigrationImageImport_RecentImageImportJobs_StepsFields = ubx.FieldMap{
...
var VmmigrationImageImport_RecentImageImportJobs_Warnings_ActionItemFields = ubx.FieldMap{
		"Locale": ubx.FieldSpec{WireName: "locale"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var VmmigrationImageImport_RecentImageImportJobs_Warnings_HelpLinksFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Url": ubx.FieldSpec{WireName: "url"},
	}

var VmmigrationImageImport_RecentImageImportJobs_WarningsFields = ubx.FieldMap{
...
var VmmigrationImageImport_RecentImageImportJobsFields = ubx.FieldMap{
...
type VmmigrationImageImportConfig struct {
...
type VmmigrationImageImportAttrs struct {
	// Immutable. The path to the Cloud Storage file from which the image should be imported.
	CloudStorageUri any
	// Output only. The time the image import was created.
	CreateTime any
...
var VmmigrationImageImport = ubx.ResourceBinding{
