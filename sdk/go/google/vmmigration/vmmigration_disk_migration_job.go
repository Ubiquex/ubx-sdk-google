...
type VmmigrationDiskMigrationJob_AwsSourceDiskDetails struct {
...
type VmmigrationDiskMigrationJob_Errors struct {
	Code any
	Details any
	Message any
}

type VmmigrationDiskMigrationJob_Steps struct {
...
type VmmigrationDiskMigrationJob_TargetDetails_Encryption struct {
	// Required. The name of the encryption key that is stored in Google Cloud KMS.
	KmsKey any
}

type VmmigrationDiskMigrationJob_TargetDetails_TargetDisk struct {
...
type VmmigrationDiskMigrationJob_TargetDetails struct {
...
var VmmigrationDiskMigrationJob_AwsSourceDiskDetailsFields = ubx.FieldMap{
...
var VmmigrationDiskMigrationJob_ErrorsFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var VmmigrationDiskMigrationJob_StepsFields = ubx.FieldMap{
...
var VmmigrationDiskMigrationJob_TargetDetails_EncryptionFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
	}

var VmmigrationDiskMigrationJob_TargetDetails_TargetDiskFields = ubx.FieldMap{
...
var VmmigrationDiskMigrationJob_TargetDetailsFields = ubx.FieldMap{
...
type VmmigrationDiskMigrationJobConfig struct {
...
type VmmigrationDiskMigrationJobAttrs struct {
	// Represents the source AWS Disk details.
	AwsSourceDiskDetails any
	// Output only. The time the DiskMigrationJob resource was created.
	CreateTime any
...
var VmmigrationDiskMigrationJob = ubx.ResourceBinding{
