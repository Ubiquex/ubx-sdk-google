...
type V1alpha1CutoverJob_ComputeEngineDisksTargetDetails_VmTargetDetails struct {
	// Output only. The URI of the Compute Engine VM.
	VmUri any
}

type V1alpha1CutoverJob_ComputeEngineDisksTargetDetails struct {
...
type V1alpha1CutoverJob_ComputeEngineTargetDetails_Encryption struct {
...
type V1alpha1CutoverJob_ComputeEngineVmDetails struct {
	// AppliedLicense holds the license data returned by adaptation module report.
	AppliedLicense any
...
type V1alpha1CutoverJob_Error struct {
...
type V1alpha1CutoverJobAttrs struct {
	// ComputeEngineDisksTargetDetails is a collection of created Persistent Disks details.
	ComputeEngineDisksTargetDetails any
	// ComputeEngineTargetDetails is a collection of details for creating a VM in a target Compute Engine project.
	ComputeEngineTargetDetails any
...
var V1alpha1CutoverJob = ubx.ResourceBinding{
