...
type ModelarmorTemplate_FilterConfig_MaliciousUriFilterSettings struct {
	// Optional. Tells whether the Malicious URI filter is enabled or disabled.
	FilterEnforcement any
}

type ModelarmorTemplate_FilterConfig_PiAndJailbreakFilterSettings struct {
...
type ModelarmorTemplate_FilterConfig_RaiSettings_RaiFilters struct {
	ConfidenceLevel any
	FilterType any
}

type ModelarmorTemplate_FilterConfig_RaiSettings struct {
	// Required. List of Responsible AI filters enabled for template.
	RaiFilters any
}

type ModelarmorTemplate_FilterConfig_SdpSettings_AdvancedConfig struct {
...
type ModelarmorTemplate_FilterConfig_SdpSettings struct {
...
type ModelarmorTemplate_FilterConfig struct {
...
type ModelarmorTemplate_TemplateMetadata_FilterVersionSelector struct {
...
type ModelarmorTemplate_TemplateMetadata_MultiLanguageDetection struct {
	// Required. If true, multi language detection will be enabled.
	EnableMultiLanguageDetection any
}

type ModelarmorTemplate_TemplateMetadata struct {
...
var ModelarmorTemplate_FilterConfig_MaliciousUriFilterSettingsFields = ubx.FieldMap{
		"FilterEnforcement": ubx.FieldSpec{WireName: "filter_enforcement"},
	}

var ModelarmorTemplate_FilterConfig_PiAndJailbreakFilterSettingsFields = ubx.FieldMap{
		"ConfidenceLevel": ubx.FieldSpec{WireName: "confidence_level"},
		"FilterEnforcement": ubx.FieldSpec{WireName: "filter_enforcement"},
	}

var ModelarmorTemplate_FilterConfig_RaiSettings_RaiFiltersFields = ubx.FieldMap{
		"ConfidenceLevel": ubx.FieldSpec{WireName: "confidence_level"},
		"FilterType": ubx.FieldSpec{WireName: "filter_type"},
	}

var ModelarmorTemplate_FilterConfig_RaiSettingsFields = ubx.FieldMap{
...
var ModelarmorTemplate_FilterConfig_SdpSettings_AdvancedConfigFields = ubx.FieldMap{
		"DeidentifyTemplate": ubx.FieldSpec{WireName: "deidentify_template"},
		"InspectTemplate": ubx.FieldSpec{WireName: "inspect_template"},
	}

var ModelarmorTemplate_FilterConfig_SdpSettingsFields = ubx.FieldMap{
...
var ModelarmorTemplate_FilterConfigFields = ubx.FieldMap{
...
var ModelarmorTemplate_TemplateMetadata_FilterVersionSelectorFields = ubx.FieldMap{
		"Alias": ubx.FieldSpec{WireName: "alias"},
		"Version": ubx.FieldSpec{WireName: "version"},
	}

var ModelarmorTemplate_TemplateMetadata_MultiLanguageDetectionFields = ubx.FieldMap{
		"EnableMultiLanguageDetection": ubx.FieldSpec{WireName: "enable_multi_language_detection"},
	}

var ModelarmorTemplate_TemplateMetadataFields = ubx.FieldMap{
...
type ModelarmorTemplateAttrs struct {
	// Output only. [Output only] Create time stamp
	CreateTime any
	// Filters configuration.
	FilterConfig any
...
var ModelarmorTemplate = ubx.ResourceBinding{
