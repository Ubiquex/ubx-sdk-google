...
type Entitlement_AssociationInfo struct {
	// The name of the base entitlement, for which this entitlement is an add-on.
	BaseEntitlement any
}

type Entitlement_CommitmentSettings_RenewalSettings_PaymentCycle struct {
...
type Entitlement_CommitmentSettings_RenewalSettings struct {
...
type Entitlement_CommitmentSettings struct {
...
type Entitlement_Entitlement_TrialSettings struct {
...
type Entitlement_Entitlement struct {
