...
type CustomerRepricingConfig_RepricingConfig_Adjustment_PercentageAdjustment_Percentage struct {
...
type CustomerRepricingConfig_RepricingConfig_Adjustment_PercentageAdjustment struct {
...
type CustomerRepricingConfig_RepricingConfig_Adjustment struct {
...
type CustomerRepricingConfig_RepricingConfig_EffectiveInvoiceMonth struct {
...
type CustomerRepricingConfig_RepricingConfig_EntitlementGranularity struct {
	// Resource name of the entitlement. Format: accounts/{account_id}/customers/{customer_id}/entitlements/{entitlement_id}
	Entitlement any
}

type CustomerRepricingConfig_RepricingConfig struct {
...
type CustomerRepricingConfigAttrs struct {
...
var CustomerRepricingConfig = ubx.ResourceBinding{
