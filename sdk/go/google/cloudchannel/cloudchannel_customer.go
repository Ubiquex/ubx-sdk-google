...
type CloudchannelCustomer_CloudIdentityInfo_EduData struct {
...
type CloudchannelCustomer_CloudIdentityInfo struct {
...
type CloudchannelCustomer_OrgPostalAddress struct {
...
type CloudchannelCustomer_PrimaryContactInfo struct {
...
var CloudchannelCustomer_CloudIdentityInfo_EduDataFields = ubx.FieldMap{
...
var CloudchannelCustomer_CloudIdentityInfoFields = ubx.FieldMap{
...
var CloudchannelCustomer_OrgPostalAddressFields = ubx.FieldMap{
...
var CloudchannelCustomer_PrimaryContactInfoFields = ubx.FieldMap{
...
type CloudchannelCustomerConfig struct {
...
type CloudchannelCustomerAttrs struct {
	// Secondary contact email. You need to provide an alternate email to create different domains if a primary contact email already exists. Users will receive a notification with credentials when you create an admin.google.com account. Secondary emails are also recovery email addresses. Alternate emails are optional when you create Team customers.
	AlternateEmail any
	// Cloud Identity ID of the customer's channel partner. Populated only if a channel partner exists for this customer.
	ChannelPartnerId any
...
var CloudchannelCustomer = ubx.ResourceBinding{
