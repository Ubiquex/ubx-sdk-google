...
type ConnectionProfile_DataverseProfile_OauthClientCredentials_ClientSecret struct {
...
type ConnectionProfile_DataverseProfile_OauthClientCredentials struct {
...
type ConnectionProfile_DataverseProfile struct {
...
type ConnectionProfile_OracleProfile_OracleAsmConfig_OracleSslConfig struct {
	// Input only. PEM-encoded certificate of the CA that signed the source database server's certificate.
	CaCertificate any
...
type ConnectionProfile_OracleProfile_OracleAsmConfig struct {
...
type ConnectionProfile_SalesforceMarketingCloudProfile struct {
	// OAuth Client Credentials.
	OauthClientCredentials any
...
type ConnectionProfile_SalesforceProfile_Oauth2ClientCredentials struct {
...
type ConnectionProfile_SalesforceProfile_UserCredentials struct {
...
type ConnectionProfile_ServiceNowProfile_UserPasswordCredentials struct {
	// A confidential piece of information where the actual value is either directly specified in the message as a raw string or stored in GCP secret manager.
	Password any
...
type ConnectionProfile_ServiceNowProfile struct {
...
type ConnectionProfile_SpannerProfile struct {
...
type ConnectionProfile_SqlServerProfile_SslConfig struct {
...
type ConnectionProfile_WorkdayProfile_OauthRefreshTokenCredentials struct {
	// OAuth Client Credentials.
	OauthClientCredentials any
	// A confidential piece of information where the actual value is either directly specified in the message as a raw string or stored in GCP secret manager.
	RefreshToken any
...
type ConnectionProfile_WorkdayProfile struct {
