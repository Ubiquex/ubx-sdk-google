...
type V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ApiKey struct {
	// Optional. Input only. The API key for this auth provider.
	ApiKey any
}

type V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ThreeLeggedOauth struct {
...
type V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_TwoLeggedOauth struct {
	// Optional. The client ID of the OAuth client.
	ClientId any
	// Optional. Input only. The client secret of the OAuth client.
	ClientSecret any
...
type V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams struct {
...
var V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ApiKeyFields = ubx.FieldMap{
		"ApiKey": ubx.FieldSpec{WireName: "api_key"},
	}

var V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ThreeLeggedOauthFields = ubx.FieldMap{
...
var V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_TwoLeggedOauthFields = ubx.FieldMap{
		"ClientId": ubx.FieldSpec{WireName: "client_id"},
		"ClientSecret": ubx.FieldSpec{WireName: "client_secret"},
		"TokenUrl": ubx.FieldSpec{WireName: "token_url"},
	}

var V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParamsFields = ubx.FieldMap{
...
type V1alphaAgentidentityV1alphaAuthProviderConfig struct {
...
type V1alphaAgentidentityV1alphaAuthProviderAttrs struct {
	// Optional. List of scopes that are allowed to be requested for this auth provider. If this list is non-empty, only scopes within this list may be requested. If this list is empty, all scopes may be requested. Scopes appearing in `blocked_scopes` are disallowed even if they appear in `allowed_scopes`. The number of allowed scopes is limited to 200.
	AllowedScopes any
	// Required. Parameters specific to the auth provider type.
	AuthProviderTypeParams any
...
var V1alphaAgentidentityV1alphaAuthProvider = ubx.ResourceBinding{
