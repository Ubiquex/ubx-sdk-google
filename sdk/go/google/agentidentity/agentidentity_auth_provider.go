...
type AgentidentityAuthProvider_AuthProviderTypeParams_ApiKey struct {
	// Optional. Input only. The API key for this auth_provider.
	ApiKey any
}

type AgentidentityAuthProvider_AuthProviderTypeParams_ThreeLeggedOauth struct {
...
type AgentidentityAuthProvider_AuthProviderTypeParams_TwoLeggedOauth struct {
	// Optional. The client ID of the OAuth client.
	ClientId any
	// Optional. Input only. The client secret of the OAuth client.
	ClientSecret any
...
type AgentidentityAuthProvider_AuthProviderTypeParams struct {
...
var AgentidentityAuthProvider_AuthProviderTypeParams_ApiKeyFields = ubx.FieldMap{
		"ApiKey": ubx.FieldSpec{WireName: "api_key"},
	}

var AgentidentityAuthProvider_AuthProviderTypeParams_ThreeLeggedOauthFields = ubx.FieldMap{
...
var AgentidentityAuthProvider_AuthProviderTypeParams_TwoLeggedOauthFields = ubx.FieldMap{
		"ClientId": ubx.FieldSpec{WireName: "client_id"},
		"ClientSecret": ubx.FieldSpec{WireName: "client_secret"},
		"TokenUrl": ubx.FieldSpec{WireName: "token_url"},
	}

var AgentidentityAuthProvider_AuthProviderTypeParamsFields = ubx.FieldMap{
...
type AgentidentityAuthProviderConfig struct {
...
type AgentidentityAuthProviderAttrs struct {
	// Optional. List of scopes that are allowed to be requested for this auth_provider. If this list is non-empty, only scopes within this list may be requested. If this list is empty, all scopes may be requested. Scopes appearing in `blocked_scopes` are disallowed even if they appear in `allowed_scopes`. The number of allowed scopes is limited to 200.
	AllowedScopes any
	// AuthProvider type specific parameters. Required when creating an auth_provider.
	AuthProviderTypeParams any
...
var AgentidentityAuthProvider = ubx.ResourceBinding{
