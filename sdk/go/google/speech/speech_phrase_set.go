...
type SpeechPhraseSet_PhraseSet_Phrases struct {
	Boost any
	Value any
}

type SpeechPhraseSet_PhraseSet struct {
...
var SpeechPhraseSet_PhraseSet_PhrasesFields = ubx.FieldMap{
		"Boost": ubx.FieldSpec{WireName: "boost"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var SpeechPhraseSet_PhraseSetFields = ubx.FieldMap{
...
type SpeechPhraseSetConfig struct {
...
type SpeechPhraseSetAttrs struct {
	// Output only. Allows users to store small amounts of arbitrary data. Both the key and the value must be 63 characters or less each. At most 100 annotations. This field is not used.
	Annotations any
	// Hint Boost. Positive value will increase the probability that a specific phrase will be recognized over other similar sounding phrases. The higher the boost, the higher the chance of false positive recognition as well. Negative boost values would correspond to anti-biasing. Anti-biasing is not enabled, so negative boost will simply be ignored. Though `boost` can accept a wide range of positive values, most use cases are best served with values between 0 (exclusive) and 20. We recommend using a binary search approach to finding the optimal value for your use case as well as adding phrases both with and without boost to your requests.
	Boost any
...
var SpeechPhraseSet = ubx.ResourceBinding{
