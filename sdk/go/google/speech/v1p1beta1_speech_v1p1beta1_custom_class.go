...
type V1p1beta1SpeechV1p1beta1CustomClass_CustomClass_Items struct {
	Value any
}

type V1p1beta1SpeechV1p1beta1CustomClass_CustomClass struct {
...
var V1p1beta1SpeechV1p1beta1CustomClass_CustomClass_ItemsFields = ubx.FieldMap{
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var V1p1beta1SpeechV1p1beta1CustomClass_CustomClassFields = ubx.FieldMap{
...
type V1p1beta1SpeechV1p1beta1CustomClassConfig struct {
...
type V1p1beta1SpeechV1p1beta1CustomClassAttrs struct {
	// Output only. Allows users to store small amounts of arbitrary data. Both the key and the value must be 63 characters or less each. At most 100 annotations. This field is not used.
	Annotations any
	// A set of words or phrases that represents a common concept likely to appear in your audio, for example a list of passenger ship names. CustomClass items can be substituted into placeholders that you set in PhraseSet phrases.
	CustomClass any
...
var V1p1beta1SpeechV1p1beta1CustomClass = ubx.ResourceBinding{
