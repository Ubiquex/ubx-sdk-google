...
type V1alphaService_EncryptionConfig struct {
...
type V1alphaService_HiveMetastoreConfig_KerberosConfig struct {
...
type V1alphaService_HiveMetastoreConfig struct {
...
type V1alphaService_MaintenanceWindow struct {
...
type V1alphaService_MetadataIntegration_DataCatalogConfig struct {
	// Optional. Defines whether the metastore metadata should be synced to Data Catalog. The default value is to disable syncing metastore metadata to Data Catalog.
	Enabled any
}

type V1alphaService_MetadataIntegration_DataplexConfig_LakeResources struct {
	Name any
}

type V1alphaService_MetadataIntegration_DataplexConfig struct {
...
type V1alphaService_MetadataIntegration struct {
...
type V1alphaService_MultiRegionConfig_CustomRegionConfig struct {
...
type V1alphaService_MultiRegionConfig struct {
...
type V1alphaService_ScalingConfig_AutoscalingConfig_LimitConfig struct {
...
type V1alphaService_ScalingConfig_AutoscalingConfig struct {
...
type V1alphaService_ScalingConfig struct {
...
type V1alphaService_ScheduledBackup_LatestBackup struct {
...
type V1alphaService_ScheduledBackup struct {
...
type V1alphaService_TelemetryConfig struct {
