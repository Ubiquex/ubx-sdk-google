...
type V1betaMetastoreV1betaMetadataImport_DatabaseDump struct {
...
var V1betaMetastoreV1betaMetadataImport_DatabaseDumpFields = ubx.FieldMap{
...
type V1betaMetastoreV1betaMetadataImportConfig struct {
...
type V1betaMetastoreV1betaMetadataImportAttrs struct {
	// Output only. The time when the metadata import was started.
	CreateTime any
	// A specification of the location of and metadata about a database dump from a relational database management system.
	DatabaseDump any
...
var V1betaMetastoreV1betaMetadataImport = ubx.ResourceBinding{
