...
type V1betaService_EncryptionConfig struct {
...
type V1betaService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_Consumers struct {
	EndpointLocation any
	EndpointUri any
	Subnetwork any
}

type V1betaService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig struct {
	Consumers any
	CustomRoutesEnabled any
}

type V1betaService_HiveMetastoreConfig_AuxiliaryVersions struct {
	ConfigOverrides any
	NetworkConfig any
	Version any
}

type V1betaService_HiveMetastoreConfig_KerberosConfig_Keytab struct {
...
type V1betaService_HiveMetastoreConfig_KerberosConfig struct {
...
type V1betaService_HiveMetastoreConfig struct {
...
type V1betaService_MaintenanceWindow struct {
...
type V1betaService_MetadataIntegration_DataCatalogConfig struct {
	// Optional. Defines whether the metastore metadata should be synced to Data Catalog. The default value is to disable syncing metastore metadata to Data Catalog.
	Enabled any
}

type V1betaService_MetadataIntegration_DataplexConfig_LakeResources struct {
	Name any
}

type V1betaService_MetadataIntegration_DataplexConfig struct {
...
type V1betaService_MetadataIntegration struct {
...
type V1betaService_MetadataManagementActivity_MetadataExports struct {
...
type V1betaService_MetadataManagementActivity_Restores struct {
	Backup any
	BackupLocation any
	Details any
	EndTime any
...
type V1betaService_MetadataManagementActivity struct {
...
type V1betaService_MultiRegionConfig_Certificates struct {
	Certificate any
	ExpirationTime any
}

type V1betaService_MultiRegionConfig_CustomRegionConfig struct {
...
type V1betaService_MultiRegionConfig struct {
...
type V1betaService_ScalingConfig_AutoscalingConfig_LimitConfig struct {
...
type V1betaService_ScalingConfig_AutoscalingConfig struct {
...
type V1betaService_ScalingConfig struct {
...
type V1betaService_ScheduledBackup_LatestBackup struct {
...
type V1betaService_ScheduledBackup struct {
...
type V1betaService_TelemetryConfig struct {
	// Optional. The output format of the Dataproc Metastore service's logs.
	LogFormat any
}

var V1betaService_EncryptionConfigFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
		"KmsKeys": ubx.FieldSpec{WireName: "kms_keys"},
	}

var V1betaService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_ConsumersFields = ubx.FieldMap{
...
var V1betaService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfigFields = ubx.FieldMap{
...
var V1betaService_HiveMetastoreConfig_AuxiliaryVersionsFields = ubx.FieldMap{
...
var V1betaService_HiveMetastoreConfig_KerberosConfig_KeytabFields = ubx.FieldMap{
		"CloudSecret": ubx.FieldSpec{WireName: "cloud_secret"},
	}

var V1betaService_HiveMetastoreConfig_KerberosConfigFields = ubx.FieldMap{
...
var V1betaService_HiveMetastoreConfigFields = ubx.FieldMap{
...
var V1betaService_MaintenanceWindowFields = ubx.FieldMap{
		"DayOfWeek": ubx.FieldSpec{WireName: "day_of_week"},
		"HourOfDay": ubx.FieldSpec{WireName: "hour_of_day"},
	}

var V1betaService_MetadataIntegration_DataCatalogConfigFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
	}

var V1betaService_MetadataIntegration_DataplexConfig_LakeResourcesFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var V1betaService_MetadataIntegration_DataplexConfigFields = ubx.FieldMap{
...
var V1betaService_MetadataIntegrationFields = ubx.FieldMap{
...
var V1betaService_MetadataManagementActivity_MetadataExportsFields = ubx.FieldMap{
...
var V1betaService_MetadataManagementActivity_RestoresFields = ubx.FieldMap{
...
var V1betaService_MetadataManagementActivityFields = ubx.FieldMap{
...
var V1betaService_ScalingConfig_AutoscalingConfig_LimitConfigFields = ubx.FieldMap{
		"MaxScalingFactor": ubx.FieldSpec{WireName: "max_scaling_factor"},
		"MinScalingFactor": ubx.FieldSpec{WireName: "min_scaling_factor"},
	}

var V1betaService_ScalingConfig_AutoscalingConfigFields = ubx.FieldMap{
...
var V1betaService_ScalingConfigFields = ubx.FieldMap{
...
var V1betaService_ScheduledBackup_LatestBackupFields = ubx.FieldMap{
...
var V1betaService_ScheduledBackupFields = ubx.FieldMap{
		"BackupLocation": ubx.FieldSpec{WireName: "backup_location"},
...
var V1betaService_TelemetryConfigFields = ubx.FieldMap{
...
var V1betaService = ubx.ResourceBinding{
