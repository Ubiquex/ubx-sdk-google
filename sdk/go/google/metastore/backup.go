...
type Backup_ServiceRevision_EncryptionConfig struct {
...
type Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfig struct {
...
type Backup_ServiceRevision_HiveMetastoreConfig struct {
...
type Backup_ServiceRevision_MaintenanceWindow struct {
...
type Backup_ServiceRevision_MetadataIntegration_DataCatalogConfig struct {
	// Optional. Defines whether the metastore metadata should be synced to Data Catalog. The default value is to disable syncing metastore metadata to Data Catalog.
	Enabled any
}

type Backup_ServiceRevision_MetadataIntegration struct {
...
type Backup_ServiceRevision_ScalingConfig_AutoscalingConfig_LimitConfig struct {
...
type Backup_ServiceRevision_ScalingConfig_AutoscalingConfig struct {
...
type Backup_ServiceRevision_ScalingConfig struct {
...
type Backup_ServiceRevision_ScheduledBackup_LatestBackup struct {
...
type Backup_ServiceRevision_ScheduledBackup struct {
...
type Backup_ServiceRevision_TelemetryConfig struct {
	// Optional. The output format of the Dataproc Metastore service's logs.
	LogFormat any
}

type Backup_ServiceRevision struct {
