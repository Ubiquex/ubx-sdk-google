...
type V1alphaBackup_ServiceRevision_EncryptionConfig struct {
...
type V1alphaBackup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_Consumers struct {
	EndpointLocation any
	EndpointUri any
	Subnetwork any
}

type V1alphaBackup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig struct {
	Consumers any
	CustomRoutesEnabled any
}

type V1alphaBackup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions struct {
	ConfigOverrides any
	NetworkConfig any
	Version any
}

type V1alphaBackup_ServiceRevision_HiveMetastoreConfig_KerberosConfig_Keytab struct {
...
type V1alphaBackup_ServiceRevision_HiveMetastoreConfig_KerberosConfig struct {
...
type V1alphaBackup_ServiceRevision_HiveMetastoreConfig struct {
...
type V1alphaBackup_ServiceRevision_MaintenanceWindow struct {
...
type V1alphaBackup_ServiceRevision_MetadataIntegration_DataCatalogConfig struct {
	// Optional. Defines whether the metastore metadata should be synced to Data Catalog. The default value is to disable syncing metastore metadata to Data Catalog.
	Enabled any
}

type V1alphaBackup_ServiceRevision_MetadataIntegration_DataplexConfig_LakeResources struct {
	Name any
}

type V1alphaBackup_ServiceRevision_MetadataIntegration_DataplexConfig struct {
...
type V1alphaBackup_ServiceRevision_MetadataIntegration struct {
...
type V1alphaBackup_ServiceRevision_MetadataManagementActivity_MetadataExports struct {
...
type V1alphaBackup_ServiceRevision_MetadataManagementActivity_Restores struct {
	Backup any
	BackupLocation any
	Details any
	EndTime any
...
type V1alphaBackup_ServiceRevision_MetadataManagementActivity struct {
...
type V1alphaBackup_ServiceRevision_MultiRegionConfig_Certificates struct {
	Certificate any
	ExpirationTime any
}

type V1alphaBackup_ServiceRevision_MultiRegionConfig_CustomRegionConfig struct {
...
type V1alphaBackup_ServiceRevision_MultiRegionConfig struct {
...
type V1alphaBackup_ServiceRevision_ScalingConfig_AutoscalingConfig_LimitConfig struct {
...
type V1alphaBackup_ServiceRevision_ScalingConfig_AutoscalingConfig struct {
...
type V1alphaBackup_ServiceRevision_ScalingConfig struct {
...
type V1alphaBackup_ServiceRevision_ScheduledBackup_LatestBackup struct {
...
type V1alphaBackup_ServiceRevision_ScheduledBackup struct {
...
type V1alphaBackup_ServiceRevision_TelemetryConfig struct {
	// Optional. The output format of the Dataproc Metastore service's logs.
	LogFormat any
}

type V1alphaBackup_ServiceRevision struct {
...
var V1alphaBackup_ServiceRevision_EncryptionConfigFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
		"KmsKeys": ubx.FieldSpec{WireName: "kms_keys"},
	}

var V1alphaBackup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_ConsumersFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfigFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersionsFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_HiveMetastoreConfig_KerberosConfig_KeytabFields = ubx.FieldMap{
		"CloudSecret": ubx.FieldSpec{WireName: "cloud_secret"},
	}

var V1alphaBackup_ServiceRevision_HiveMetastoreConfig_KerberosConfigFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_HiveMetastoreConfigFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_MaintenanceWindowFields = ubx.FieldMap{
		"DayOfWeek": ubx.FieldSpec{WireName: "day_of_week"},
		"HourOfDay": ubx.FieldSpec{WireName: "hour_of_day"},
	}

var V1alphaBackup_ServiceRevision_MetadataIntegration_DataCatalogConfigFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
	}

var V1alphaBackup_ServiceRevision_MetadataIntegration_DataplexConfig_LakeResourcesFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var V1alphaBackup_ServiceRevision_MetadataIntegration_DataplexConfigFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_MetadataIntegrationFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_MetadataManagementActivity_MetadataExportsFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_MetadataManagementActivity_RestoresFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_MetadataManagementActivityFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_MultiRegionConfig_CertificatesFields = ubx.FieldMap{
		"Certificate": ubx.FieldSpec{WireName: "certificate"},
		"ExpirationTime": ubx.FieldSpec{WireName: "expiration_time"},
	}

var V1alphaBackup_ServiceRevision_MultiRegionConfig_CustomRegionConfigFields = ubx.FieldMap{
		"ReadOnlyRegions": ubx.FieldSpec{WireName: "read_only_regions"},
		"ReadWriteRegions": ubx.FieldSpec{WireName: "read_write_regions"},
	}

var V1alphaBackup_ServiceRevision_MultiRegionConfigFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_ScalingConfig_AutoscalingConfig_LimitConfigFields = ubx.FieldMap{
		"MaxScalingFactor": ubx.FieldSpec{WireName: "max_scaling_factor"},
		"MinScalingFactor": ubx.FieldSpec{WireName: "min_scaling_factor"},
	}

var V1alphaBackup_ServiceRevision_ScalingConfig_AutoscalingConfigFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_ScalingConfigFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_ScheduledBackup_LatestBackupFields = ubx.FieldMap{
...
var V1alphaBackup_ServiceRevision_ScheduledBackupFields = ubx.FieldMap{
		"BackupLocation": ubx.FieldSpec{WireName: "backup_location"},
...
var V1alphaBackup_ServiceRevision_TelemetryConfigFields = ubx.FieldMap{
		"LogFormat": ubx.FieldSpec{WireName: "log_format"},
	}

var V1alphaBackup_ServiceRevisionFields = ubx.FieldMap{
...
var V1alphaBackup = ubx.ResourceBinding{
