...
type MetastoreBackup_ServiceRevision_EncryptionConfig struct {
...
type MetastoreBackup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_Consumers struct {
	EndpointLocation any
	EndpointUri any
	Subnetwork any
}

type MetastoreBackup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig struct {
	Consumers any
}

type MetastoreBackup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions struct {
	ConfigOverrides any
	NetworkConfig any
	Version any
}

type MetastoreBackup_ServiceRevision_HiveMetastoreConfig_KerberosConfig_Keytab struct {
...
type MetastoreBackup_ServiceRevision_HiveMetastoreConfig_KerberosConfig struct {
...
type MetastoreBackup_ServiceRevision_HiveMetastoreConfig struct {
...
type MetastoreBackup_ServiceRevision_MaintenanceWindow struct {
...
type MetastoreBackup_ServiceRevision_MetadataIntegration_DataCatalogConfig struct {
	// Optional. Defines whether the metastore metadata should be synced to Data Catalog. The default value is to disable syncing metastore metadata to Data Catalog.
	Enabled any
}

type MetastoreBackup_ServiceRevision_MetadataIntegration struct {
	// Specifies how metastore metadata should be integrated with the Data Catalog service.
	DataCatalogConfig any
}

type MetastoreBackup_ServiceRevision_MetadataManagementActivity_MetadataExports struct {
...
type MetastoreBackup_ServiceRevision_MetadataManagementActivity_Restores struct {
	Backup any
	BackupLocation any
	Details any
	EndTime any
...
type MetastoreBackup_ServiceRevision_MetadataManagementActivity struct {
...
type MetastoreBackup_ServiceRevision_ScalingConfig_AutoscalingConfig_LimitConfig struct {
...
type MetastoreBackup_ServiceRevision_ScalingConfig_AutoscalingConfig struct {
...
type MetastoreBackup_ServiceRevision_ScalingConfig struct {
...
type MetastoreBackup_ServiceRevision_ScheduledBackup_LatestBackup struct {
...
type MetastoreBackup_ServiceRevision_ScheduledBackup struct {
...
type MetastoreBackup_ServiceRevision_TelemetryConfig struct {
	// Optional. The output format of the Dataproc Metastore service's logs.
	LogFormat any
}

type MetastoreBackup_ServiceRevision struct {
...
var MetastoreBackup_ServiceRevision_EncryptionConfigFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
	}

var MetastoreBackup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_ConsumersFields = ubx.FieldMap{
...
var MetastoreBackup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfigFields = ubx.FieldMap{
...
var MetastoreBackup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersionsFields = ubx.FieldMap{
...
var MetastoreBackup_ServiceRevision_HiveMetastoreConfig_KerberosConfig_KeytabFields = ubx.FieldMap{
		"CloudSecret": ubx.FieldSpec{WireName: "cloud_secret"},
	}

var MetastoreBackup_ServiceRevision_HiveMetastoreConfig_KerberosConfigFields = ubx.FieldMap{
...
var MetastoreBackup_ServiceRevision_HiveMetastoreConfigFields = ubx.FieldMap{
...
var MetastoreBackup_ServiceRevision_MaintenanceWindowFields = ubx.FieldMap{
		"DayOfWeek": ubx.FieldSpec{WireName: "day_of_week"},
		"HourOfDay": ubx.FieldSpec{WireName: "hour_of_day"},
	}

var MetastoreBackup_ServiceRevision_MetadataIntegration_DataCatalogConfigFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
	}

var MetastoreBackup_ServiceRevision_MetadataIntegrationFields = ubx.FieldMap{
...
var MetastoreBackup_ServiceRevision_MetadataManagementActivity_MetadataExportsFields = ubx.FieldMap{
...
var MetastoreBackup_ServiceRevision_MetadataManagementActivity_RestoresFields = ubx.FieldMap{
...
var MetastoreBackup_ServiceRevision_MetadataManagementActivityFields = ubx.FieldMap{
...
var MetastoreBackup_ServiceRevision_ScalingConfig_AutoscalingConfig_LimitConfigFields = ubx.FieldMap{
		"MaxScalingFactor": ubx.FieldSpec{WireName: "max_scaling_factor"},
		"MinScalingFactor": ubx.FieldSpec{WireName: "min_scaling_factor"},
	}

var MetastoreBackup_ServiceRevision_ScalingConfig_AutoscalingConfigFields = ubx.FieldMap{
...
var MetastoreBackup_ServiceRevision_ScalingConfigFields = ubx.FieldMap{
...
var MetastoreBackup_ServiceRevision_ScheduledBackup_LatestBackupFields = ubx.FieldMap{
...
var MetastoreBackup_ServiceRevision_ScheduledBackupFields = ubx.FieldMap{
		"BackupLocation": ubx.FieldSpec{WireName: "backup_location"},
...
var MetastoreBackup_ServiceRevision_TelemetryConfigFields = ubx.FieldMap{
		"LogFormat": ubx.FieldSpec{WireName: "log_format"},
	}

var MetastoreBackup_ServiceRevisionFields = ubx.FieldMap{
...
type MetastoreBackupConfig struct {
	// Output only. The time when the backup was started.
	CreateTime any
...
type MetastoreBackupAttrs struct {
	// Output only. The time when the backup was started.
	CreateTime any
	// Optional. The description of the backup.
	Description any
...
var MetastoreBackup = ubx.ResourceBinding{
