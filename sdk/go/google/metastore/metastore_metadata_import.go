...
type MetastoreMetadataImport_DatabaseDump struct {
...
var MetastoreMetadataImport_DatabaseDumpFields = ubx.FieldMap{
...
type MetastoreMetadataImportConfig struct {
...
type MetastoreMetadataImportAttrs struct {
	// Output only. The time when the metadata import was started.
	CreateTime any
	// A specification of the location of and metadata about a database dump from a relational database management system.
	DatabaseDump any
...
var MetastoreMetadataImport = ubx.ResourceBinding{
