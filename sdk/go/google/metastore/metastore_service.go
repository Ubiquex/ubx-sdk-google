...
type MetastoreService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_Consumers struct {
	EndpointLocation any
	EndpointUri any
	Subnetwork any
}

type MetastoreService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig struct {
	Consumers any
}
...
type MetastoreService_MetadataManagementActivity_MetadataExports struct {
...
type MetastoreService_MetadataManagementActivity_Restores struct {
	Backup any
	BackupLocation any
	Details any
	EndTime any
...
type MetastoreService_MetadataManagementActivity struct {
...
type MetastoreService_ScheduledBackup_LatestBackup struct {
...
var MetastoreService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_ConsumersFields = ubx.FieldMap{
...
var MetastoreService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfigFields = ubx.FieldMap{
...
var MetastoreService_MetadataManagementActivity_MetadataExportsFields = ubx.FieldMap{
...
var MetastoreService_MetadataManagementActivity_RestoresFields = ubx.FieldMap{
...
var MetastoreService_MetadataManagementActivityFields = ubx.FieldMap{
...
var MetastoreService_ScheduledBackup_LatestBackupFields = ubx.FieldMap{
...
type MetastoreServiceAttrs struct {
	// Output only. A Cloud Storage URI (starting with gs://) that specifies where artifacts related to the metastore service are stored.
	ArtifactGcsUri any
	// Output only. The time when the metastore service was created.
	CreateTime any
