...
type V1beta1CloudschedulerV1beta1Job_AppEngineHttpTarget_AppEngineRouting struct {
...
type V1beta1CloudschedulerV1beta1Job_AppEngineHttpTarget struct {
...
type V1beta1CloudschedulerV1beta1Job_HttpTarget_OauthToken struct {
...
type V1beta1CloudschedulerV1beta1Job_HttpTarget_OidcToken struct {
...
type V1beta1CloudschedulerV1beta1Job_HttpTarget struct {
...
type V1beta1CloudschedulerV1beta1Job_PubsubTarget struct {
...
type V1beta1CloudschedulerV1beta1Job_RetryConfig struct {
...
type V1beta1CloudschedulerV1beta1Job_Status struct {
...
var V1beta1CloudschedulerV1beta1Job_AppEngineHttpTarget_AppEngineRoutingFields = ubx.FieldMap{
...
var V1beta1CloudschedulerV1beta1Job_AppEngineHttpTargetFields = ubx.FieldMap{
...
var V1beta1CloudschedulerV1beta1Job_HttpTarget_OauthTokenFields = ubx.FieldMap{
		"Scope": ubx.FieldSpec{WireName: "scope"},
		"ServiceAccountEmail": ubx.FieldSpec{WireName: "service_account_email"},
	}

var V1beta1CloudschedulerV1beta1Job_HttpTarget_OidcTokenFields = ubx.FieldMap{
		"Audience": ubx.FieldSpec{WireName: "audience"},
		"ServiceAccountEmail": ubx.FieldSpec{WireName: "service_account_email"},
	}

var V1beta1CloudschedulerV1beta1Job_HttpTargetFields = ubx.FieldMap{
		"Body": ubx.FieldSpec{WireName: "body"},
		"Headers": ubx.FieldSpec{WireName: "headers"},
		"HttpMethod": ubx.FieldSpec{WireName: "http_method"},
...
var V1beta1CloudschedulerV1beta1Job_PubsubTargetFields = ubx.FieldMap{
		"Attributes": ubx.FieldSpec{WireName: "attributes"},
		"Data": ubx.FieldSpec{WireName: "data"},
		"TopicName": ubx.FieldSpec{WireName: "topic_name"},
	}

var V1beta1CloudschedulerV1beta1Job_RetryConfigFields = ubx.FieldMap{
...
var V1beta1CloudschedulerV1beta1Job_StatusFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

type V1beta1CloudschedulerV1beta1JobConfig struct {
...
type V1beta1CloudschedulerV1beta1JobAttrs struct {
	// App Engine target. The job will be pushed to a job handler by means of an HTTP request via an http_method such as HTTP POST, HTTP GET, etc. The job is acknowledged by means of an HTTP response code in the range [200 - 299]. Error 503 is considered an App Engine system error instead of an application error. Requests returning error 503 will be retried regardless of retry configuration and not counted against retry counts. Any other response code, or a failure to receive a response before the deadline, constitutes a failed attempt.
	AppEngineHttpTarget any
	// The deadline for job attempts. If the request handler does not respond by this deadline then the request is cancelled and the attempt is marked as a `DEADLINE_EXCEEDED` failure. The failed attempt can be viewed in execution logs. Cloud Scheduler will retry the job according to the RetryConfig. The default and the allowed values depend on the type of target: * For HTTP targets, the default is 3 minutes. The deadline must be in the interval [15 seconds, 30 minutes]. * For App Engine HTTP targets, 0 indicates that the request has the default deadline. The default deadline depends on the scaling type of the service: 10 minutes for standard apps with automatic scaling, 24 hours for standard apps with manual and basic scaling, and 60 minutes for flex apps. If the request deadline is set, it must be in the interval [15 seconds, 24 hours 15 seconds]. * For Pub/Sub targets, this field is ignored.
	AttemptDeadline any
...
var V1beta1CloudschedulerV1beta1Job = ubx.ResourceBinding{
	...
	Fields: ubx.FieldMap{
		...
		"UserUpdateTime": ubx.FieldSpec{WireName: "user_update_time"},
	},
}
