...
type LoggingLink_BigqueryDataset struct {
...
var LoggingLink_BigqueryDatasetFields = ubx.FieldMap{
		"DatasetId": ubx.FieldSpec{WireName: "dataset_id"},
	}

type LoggingLinkConfig struct {
...
var LoggingLink = ubx.ResourceBinding{
