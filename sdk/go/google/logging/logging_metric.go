...
type LoggingMetric_BucketOptions_ExplicitBuckets struct {
	// The values must be monotonically increasing.
	Bounds any
}

type LoggingMetric_BucketOptions_ExponentialBuckets struct {
...
type LoggingMetric_BucketOptions_LinearBuckets struct {
	// Must be greater than 0.
	NumFiniteBuckets any
...
type LoggingMetric_BucketOptions struct {
...
type LoggingMetric_MetricDescriptor_Labels struct {
	Description any
	Key any
	ValueType any
}

type LoggingMetric_MetricDescriptor_Metadata struct {
...
type LoggingMetric_MetricDescriptor struct {
...
var LoggingMetric_BucketOptions_ExplicitBucketsFields = ubx.FieldMap{
		"Bounds": ubx.FieldSpec{WireName: "bounds"},
	}

var LoggingMetric_BucketOptions_ExponentialBucketsFields = ubx.FieldMap{
...
var LoggingMetric_BucketOptions_LinearBucketsFields = ubx.FieldMap{
		"NumFiniteBuckets": ubx.FieldSpec{WireName: "num_finite_buckets"},
		"Offset": ubx.FieldSpec{WireName: "offset"},
		"Width": ubx.FieldSpec{WireName: "width"},
	}

var LoggingMetric_BucketOptionsFields = ubx.FieldMap{
...
var LoggingMetric_MetricDescriptor_LabelsFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Key": ubx.FieldSpec{WireName: "key"},
		"ValueType": ubx.FieldSpec{WireName: "value_type"},
	}

var LoggingMetric_MetricDescriptor_MetadataFields = ubx.FieldMap{
...
var LoggingMetric_MetricDescriptorFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
...
type LoggingMetricAttrs struct {
	// Optional. The resource name of the Log Bucket that owns the Log Metric. Only Log Buckets in projects are supported. The bucket has to be in the same project as the metric.For example:projects/my-project/locations/global/buckets/my-bucketIf empty, then the Log Metric is considered a non-Bucket Log Metric.
	BucketName any
	// BucketOptions describes the bucket boundaries used to create a histogram for the distribution. The buckets can be in a linear sequence, an exponential sequence, or each bucket can be specified explicitly. BucketOptions does not include the number of values in each bucket.A bucket has an inclusive lower bound and exclusive upper bound for the values that are counted for that bucket. The upper bound of a bucket must be strictly greater than the lower bound. The sequence of N buckets for a distribution consists of an underflow bucket (number 0), zero or more finite buckets (number 1 through N - 2) and an overflow bucket (number N - 1). The buckets are contiguous: the lower bound of bucket i (i > 0) is the same as the upper bound of bucket i - 1. The buckets span the whole range of finite values: lower bound of the underflow bucket is -infinity and the upper bound of the overflow bucket is +infinity. The finite buckets are so-called because both bounds are finite.
	BucketOptions any
...
var LoggingMetric = ubx.ResourceBinding{
