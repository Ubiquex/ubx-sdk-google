...
type DataflowTemplate_Environment struct {
...
type DataflowTemplate_Metadata_Parameters_EnumOptions struct {
	Description any
	Label any
	Value any
}

type DataflowTemplate_Metadata_Parameters struct {
	CustomMetadata any
	DefaultValue any
	EnumOptions any
	GroupName any
...
type DataflowTemplate_Metadata struct {
...
type DataflowTemplate_RuntimeMetadata_SdkInfo struct {
...
type DataflowTemplate_RuntimeMetadata struct {
	// The parameters for the template.
	Parameters any
	// SDK Information.
	SdkInfo any
...
type DataflowTemplate_Status struct {
...
var DataflowTemplate_EnvironmentFields = ubx.FieldMap{
...
type DataflowTemplateConfig struct {
...
type DataflowTemplateAttrs struct {
	// The environment values to set at runtime.
	Environment any
	// Required. A Cloud Storage path to the template from which to create the job. Must be a valid Cloud Storage URL, beginning with `gs://`.
	GcsPath any
...
var DataflowTemplate = ubx.ResourceBinding{
