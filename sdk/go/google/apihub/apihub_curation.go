...
type ApihubCuration_Endpoint_ApplicationIntegrationEndpointDetails struct {
...
type ApihubCuration_Endpoint struct {
...
type ApihubCuration_PluginInstanceActions struct {
	ActionId any
	PluginInstance any
}

var ApihubCuration_Endpoint_ApplicationIntegrationEndpointDetailsFields = ubx.FieldMap{
		"TriggerId": ubx.FieldSpec{WireName: "trigger_id"},
		"Uri": ubx.FieldSpec{WireName: "uri"},
	}

var ApihubCuration_EndpointFields = ubx.FieldMap{
...
var ApihubCuration_PluginInstanceActionsFields = ubx.FieldMap{
...
type ApihubCurationAttrs struct {
	// Output only. The time at which the curation was created.
	CreateTime any
	// Optional. The description of the curation.
	Description any
...
var ApihubCuration = ubx.ResourceBinding{
