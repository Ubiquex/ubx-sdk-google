...
type ApihubApiHubInstance_Config_AgentRegistrySyncConfig struct {
	// Optional. If true, the MCP data sync to the Agent Registry will be disabled. The default value is false.
	Disabled any
}

type ApihubApiHubInstance_Config struct {
...
var ApihubApiHubInstance_Config_AgentRegistrySyncConfigFields = ubx.FieldMap{
		"Disabled": ubx.FieldSpec{WireName: "disabled"},
	}

var ApihubApiHubInstance_ConfigFields = ubx.FieldMap{
...
type ApihubApiHubInstanceAttrs struct {
	// Available configurations to provision an ApiHub Instance.
	Config any
	// Output only. Creation timestamp.
	CreateTime any
...
var ApihubApiHubInstance = ubx.ResourceBinding{
