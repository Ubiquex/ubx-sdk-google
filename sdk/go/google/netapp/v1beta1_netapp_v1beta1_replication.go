...
type V1beta1NetappV1beta1Replication_DestinationVolumeParameters_TieringPolicy struct {
...
type V1beta1NetappV1beta1Replication_DestinationVolumeParameters struct {
...
type V1beta1NetappV1beta1Replication_HybridPeeringDetails struct {
...
type V1beta1NetappV1beta1Replication_HybridReplicationUserCommands struct {
	// Output only. List of commands to be executed by the customer.
	Commands any
}

type V1beta1NetappV1beta1Replication_TransferStats struct {
...
var V1beta1NetappV1beta1Replication_DestinationVolumeParameters_TieringPolicyFields = ubx.FieldMap{
...
var V1beta1NetappV1beta1Replication_DestinationVolumeParametersFields = ubx.FieldMap{
...
var V1beta1NetappV1beta1Replication_HybridPeeringDetailsFields = ubx.FieldMap{
...
var V1beta1NetappV1beta1Replication_HybridReplicationUserCommandsFields = ubx.FieldMap{
		"Commands": ubx.FieldSpec{WireName: "commands"},
	}

var V1beta1NetappV1beta1Replication_TransferStatsFields = ubx.FieldMap{
...
type V1beta1NetappV1beta1ReplicationConfig struct {
...
type V1beta1NetappV1beta1ReplicationAttrs struct {
	// Optional. Location of the user cluster.
	ClusterLocation any
	// Output only. Replication create time.
	CreateTime any
...
var V1beta1NetappV1beta1Replication = ubx.ResourceBinding{
