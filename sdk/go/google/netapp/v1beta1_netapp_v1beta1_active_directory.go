...
type V1beta1NetappV1beta1ActiveDirectoryConfig struct {
...
type V1beta1NetappV1beta1ActiveDirectoryAttrs struct {
	// Optional. Users to be added to the Built-in Admininstrators group.
	Administrators any
	// If enabled, AES encryption will be enabled for SMB communication.
	AesEncryption any
...
var V1beta1NetappV1beta1ActiveDirectory = ubx.ResourceBinding{
