...
type V1beta1Replication_DestinationVolumeParameters_TieringPolicy struct {
...
type V1beta1Replication_DestinationVolumeParameters struct {
...
type V1beta1Replication_HybridPeeringDetails struct {
...
type V1beta1Replication_HybridReplicationUserCommands struct {
	// Output only. List of commands to be executed by the customer.
	Commands any
}

type V1beta1Replication_TransferStats struct {
...
type V1beta1ReplicationAttrs struct {
	// Optional. Location of the user cluster.
	ClusterLocation any
	// Output only. Replication create time.
	CreateTime any
...
var V1beta1Replication = ubx.ResourceBinding{
