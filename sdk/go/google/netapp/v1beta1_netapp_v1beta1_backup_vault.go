...
type V1beta1NetappV1beta1BackupVault_BackupRetentionPolicy struct {
...
var V1beta1NetappV1beta1BackupVault_BackupRetentionPolicyFields = ubx.FieldMap{
...
type V1beta1NetappV1beta1BackupVaultConfig struct {
...
type V1beta1NetappV1beta1BackupVaultAttrs struct {
	// Optional. Region where the backups are stored. Format: `projects/{project_id}/locations/{location}`
	BackupRegion any
	// Retention policy for backups in the backup vault
	BackupRetentionPolicy any
...
var V1beta1NetappV1beta1BackupVault = ubx.ResourceBinding{
