...
type V1beta1Volume_BackupConfig struct {
...
type V1beta1Volume_CacheParameters_CacheConfig struct {
...
type V1beta1Volume_CacheParameters struct {
...
type V1beta1Volume_CloneDetails struct {
...
type V1beta1Volume_HybridReplicationParameters struct {
...
type V1beta1Volume_LargeCapacityConfig struct {
...
type V1beta1Volume_SnapshotPolicy_DailySchedule struct {
...
type V1beta1Volume_SnapshotPolicy_HourlySchedule struct {
	// Set the minute of the hour to start the snapshot (0-59), defaults to the top of the hour (0).
	Minute any
	// The maximum number of Snapshots to keep for the hourly schedule
	SnapshotsToKeep any
...
type V1beta1Volume_SnapshotPolicy_MonthlySchedule struct {
...
type V1beta1Volume_SnapshotPolicy_WeeklySchedule struct {
...
type V1beta1Volume_SnapshotPolicy struct {
...
type V1beta1Volume_TieringPolicy struct {
