...
type V1beta1NetappV1beta1BackupPolicyConfig struct {
...
type V1beta1NetappV1beta1BackupPolicyAttrs struct {
	// Output only. The total number of volumes assigned by this backup policy.
	AssignedVolumeCount any
	// Output only. The time when the backup policy was created.
	CreateTime any
...
var V1beta1NetappV1beta1BackupPolicy = ubx.ResourceBinding{
	WireType: "google_netapp_v1beta1_netapp_v1beta1_backup_policy",
	Fields: ubx.FieldMap{
