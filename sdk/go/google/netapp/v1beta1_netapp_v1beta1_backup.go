...
type V1beta1NetappV1beta1Backup_OntapSource struct {
...
var V1beta1NetappV1beta1Backup_OntapSourceFields = ubx.FieldMap{
...
type V1beta1NetappV1beta1BackupConfig struct {
...
type V1beta1NetappV1beta1BackupAttrs struct {
	// Output only. Region in which backup is stored. Format: `projects/{project_id}/locations/{location}`
	BackupRegion any
	// Output only. Type of backup, manually created or created by a backup policy.
	BackupType any
...
var V1beta1NetappV1beta1Backup = ubx.ResourceBinding{
	WireType: "google_netapp_v1beta1_netapp_v1beta1_backup",
	Fields: ubx.FieldMap{
		"BackupRegion": ubx.FieldSpec{WireName: "backup_region"},
		"BackupType": ubx.FieldSpec{WireName: "backup_type"},
		"ChainStorageBytes": ubx.FieldSpec{WireName: "chain_storage_bytes"},
		"CreateTime": ubx.FieldSpec{WireName: "create_time"},
		"Description": ubx.FieldSpec{WireName: "description"},
		"EnforcedRetentionEndTime": ubx.FieldSpec{WireName: "enforced_retention_end_time"},
		"Labels": ubx.FieldSpec{WireName: "labels"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"OntapSource": ubx.FieldSpec{
			WireName: "ontap_source",
			Kind: "object",
			Fields: V1beta1NetappV1beta1Backup_OntapSourceFields,
		},
		...
		"VolumeRegion": ubx.FieldSpec{WireName: "volume_region"},
		"VolumeUsageBytes": ubx.FieldSpec{WireName: "volume_usage_bytes"},
	},
}
