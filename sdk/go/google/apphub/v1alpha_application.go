...
type V1alphaApplication_Attributes_BusinessOwners_Channel struct {
	Uri any
}
...
type V1alphaApplication_Attributes_Environment struct {
...
type V1alphaApplication_Attributes struct {
...
type V1alphaApplication_Scope struct {
	// Required. Scope Type.
	Type any
}
