...
type V1alphaWorkload_Attributes_BusinessOwners_Channel struct {
	Uri any
}
...
type V1alphaWorkload_Attributes_Environment struct {
...
type V1alphaWorkload_Attributes struct {
...
type V1alphaWorkload_WorkloadProperties_ExtendedMetadata struct {
	MetadataStruct any
}

type V1alphaWorkload_WorkloadProperties_FunctionalType struct {
	// Output only. The functional type of a service or workload.
	Type any
}

type V1alphaWorkload_WorkloadProperties_Identity struct {
...
type V1alphaWorkload_WorkloadProperties struct {
...
type V1alphaWorkloadAttrs struct {
	// Consumer provided attributes.
	Attributes any
	// Output only. Create time.
	CreateTime any
...
var V1alphaWorkload = ubx.ResourceBinding{
