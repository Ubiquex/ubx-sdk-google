...
type NetworkconnectivityServiceConnectionMap_ConsumerPscConfigs struct {
...
type NetworkconnectivityServiceConnectionMap_ConsumerPscConnections_DnsAutomationStatus_Error struct {
	Code any
	Details any
	Message any
}

type NetworkconnectivityServiceConnectionMap_ConsumerPscConnections_DnsAutomationStatus struct {
	Error any
	Fqdn any
	State any
}

type NetworkconnectivityServiceConnectionMap_ConsumerPscConnections_ErrorInfo struct {
	Domain any
	Metadata any
	Reason any
}

type NetworkconnectivityServiceConnectionMap_ConsumerPscConnections struct {
...
type NetworkconnectivityServiceConnectionMap_ProducerPscConfigs_AutomatedDnsCreationSpec struct {
	DnsSuffix any
	Hostname any
	Ttl any
}

type NetworkconnectivityServiceConnectionMap_ProducerPscConfigs struct {
	AutomatedDnsCreationSpec any
	ServiceAttachmentUri any
}

var NetworkconnectivityServiceConnectionMap_ConsumerPscConfigsFields = ubx.FieldMap{
...
var NetworkconnectivityServiceConnectionMap_ConsumerPscConnections_DnsAutomationStatus_ErrorFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var NetworkconnectivityServiceConnectionMap_ConsumerPscConnections_DnsAutomationStatusFields = ubx.FieldMap{
		"Error": ubx.FieldSpec{
			WireName: "error",
			Kind: "object",
...
var NetworkconnectivityServiceConnectionMap_ConsumerPscConnections_ErrorInfoFields = ubx.FieldMap{
		"Domain": ubx.FieldSpec{WireName: "domain"},
		"Metadata": ubx.FieldSpec{WireName: "metadata"},
		"Reason": ubx.FieldSpec{WireName: "reason"},
	}

var NetworkconnectivityServiceConnectionMap_ConsumerPscConnectionsFields = ubx.FieldMap{
...
var NetworkconnectivityServiceConnectionMap_ProducerPscConfigs_AutomatedDnsCreationSpecFields = ubx.FieldMap{
		"DnsSuffix": ubx.FieldSpec{WireName: "dns_suffix"},
		"Hostname": ubx.FieldSpec{WireName: "hostname"},
		"Ttl": ubx.FieldSpec{WireName: "ttl"},
	}

var NetworkconnectivityServiceConnectionMap_ProducerPscConfigsFields = ubx.FieldMap{
...
type NetworkconnectivityServiceConnectionMapConfig struct {
...
type NetworkconnectivityServiceConnectionMapAttrs struct {
	// The PSC configurations on consumer side.
	ConsumerPscConfigs any
	// Output only. PSC connection details on consumer side.
	ConsumerPscConnections any
...
var NetworkconnectivityServiceConnectionMap = ubx.ResourceBinding{
