...
type NetworkconnectivityInternalRange_AllocationOptions struct {
...
type NetworkconnectivityInternalRange_Migration struct {
...
var NetworkconnectivityInternalRange_AllocationOptionsFields = ubx.FieldMap{
...
var NetworkconnectivityInternalRange_MigrationFields = ubx.FieldMap{
...
type NetworkconnectivityInternalRangeAttrs struct {
	// Range auto-allocation options, to be optionally used when CIDR block is not explicitly set.
	AllocationOptions any
	// Output only. Time when the internal range was created.
	CreateTime any
...
var NetworkconnectivityInternalRange = ubx.ResourceBinding{
