...
type V1alpha1NetworkconnectivityV1alpha1InternalRange_AllocationOptions struct {
...
type V1alpha1NetworkconnectivityV1alpha1InternalRange_Migration struct {
...
var V1alpha1NetworkconnectivityV1alpha1InternalRange_AllocationOptionsFields = ubx.FieldMap{
...
var V1alpha1NetworkconnectivityV1alpha1InternalRange_MigrationFields = ubx.FieldMap{
		"Source": ubx.FieldSpec{WireName: "source"},
		"Target": ubx.FieldSpec{WireName: "target"},
	}

type V1alpha1NetworkconnectivityV1alpha1InternalRangeConfig struct {
...
type V1alpha1NetworkconnectivityV1alpha1InternalRangeAttrs struct {
	// Range auto-allocation options, to be optionally used when CIDR block is not explicitly set.
	AllocationOptions any
	// Output only. Time when the internal range was created.
	CreateTime any
...
var V1alpha1NetworkconnectivityV1alpha1InternalRange = ubx.ResourceBinding{
	...
	Fields: ubx.FieldMap{
		...
		"RangeStatus": ubx.FieldSpec{WireName: "range_status"},
