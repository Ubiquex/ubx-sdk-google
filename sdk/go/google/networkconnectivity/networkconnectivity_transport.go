...
type NetworkconnectivityTransportAttrs struct {
	// Optional. List of IP Prefixes that will be advertised to the remote provider. Both IPv4 and IPv6 addresses are supported.
	AdvertisedRoutes any
	// Optional. Bandwidth of the Transport. This must be one of the supported bandwidths for the remote profile, and must be set when no activation key is being provided.
	Bandwidth any
...
var NetworkconnectivityTransport = ubx.ResourceBinding{
	WireType: "google_networkconnectivity_networkconnectivity_transport",
	Fields: ubx.FieldMap{
		"AdvertisedRoutes": ubx.FieldSpec{WireName: "advertised_routes"},
		"Bandwidth": ubx.FieldSpec{WireName: "bandwidth"},
		"CreateTime": ubx.FieldSpec{WireName: "create_time"},
		"Description": ubx.FieldSpec{WireName: "description"},
		"GeneratedActivationKey": ubx.FieldSpec{WireName: "generated_activation_key"},
		"Labels": ubx.FieldSpec{WireName: "labels"},
		"MtuLimit": ubx.FieldSpec{WireName: "mtu_limit"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"Network": ubx.FieldSpec{WireName: "network"},
		"PeeringNetwork": ubx.FieldSpec{WireName: "peering_network"},
