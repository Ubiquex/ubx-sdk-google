...
type NetworkconnectivityAutomatedDnsRecord_CurrentConfig struct {
...
var NetworkconnectivityAutomatedDnsRecord_CurrentConfigFields = ubx.FieldMap{
		"Rrdatas": ubx.FieldSpec{WireName: "rrdatas"},
		"Ttl": ubx.FieldSpec{WireName: "ttl"},
	}

type NetworkconnectivityAutomatedDnsRecordConfig struct {
...
type NetworkconnectivityAutomatedDnsRecordAttrs struct {
	// Required. Immutable. The full resource path of the consumer network this AutomatedDnsRecord is visible to. Example: "projects/{projectNumOrId}/global/networks/{networkName}".
	ConsumerNetwork any
	// Output only. The timestamp of when the record was created.
	CreateTime any
...
var NetworkconnectivityAutomatedDnsRecord = ubx.ResourceBinding{
