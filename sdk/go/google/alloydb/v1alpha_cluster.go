...
type V1alphaCluster_AutomatedBackupPolicy_EncryptionConfig struct {
	// The fully-qualified resource name of the KMS key. Each Cloud KMS key is regionalized and has the following format: projects/[PROJECT]/locations/[REGION]/keyRings/[RING]/cryptoKeys/[KEY_NAME]
	KmsKeyName any
}

type V1alphaCluster_AutomatedBackupPolicy_QuantityBasedRetention struct {
	// The number of backups to retain.
	Count any
}

type V1alphaCluster_AutomatedBackupPolicy_TimeBasedRetention struct {
	// The retention period.
	RetentionPeriod any
}

type V1alphaCluster_AutomatedBackupPolicy_WeeklySchedule_StartTimes struct {
	Hours   any
	Minutes any
	Nanos   any
	Seconds any
...
type V1alphaCluster_AutomatedBackupPolicy_WeeklySchedule struct {
...
type V1alphaCluster_AutomatedBackupPolicy struct {
...
type V1alphaCluster_BackupSource struct {
...
type V1alphaCluster_BackupdrBackupSource struct {
...
type V1alphaCluster_BackupdrInfo_CurrentWindow struct {
...
type V1alphaCluster_BackupdrInfo struct {
...
type V1alphaCluster_CloudsqlBackupRunSource struct {
...
type V1alphaCluster_ContinuousBackupConfig struct {
...
type V1alphaCluster_ContinuousBackupInfo_EncryptionInfo struct {
...
type V1alphaCluster_ContinuousBackupInfo struct {
...
type V1alphaCluster_DataplexConfig struct {
...
type V1alphaCluster_MaintenanceSchedule struct {
	// Output only. The scheduled start time for the maintenance.
	StartTime any
}

type V1alphaCluster_MaintenanceUpdatePolicy_DenyMaintenancePeriods_EndDate struct {
	Day   any
	Month any
	Year  any
}

type V1alphaCluster_MaintenanceUpdatePolicy_DenyMaintenancePeriods struct {
	EndDate   any
	StartDate any
	Time      any
}

type V1alphaCluster_MaintenanceUpdatePolicy_MaintenanceWindows struct {
	Day       any
	StartTime any
}

type V1alphaCluster_MaintenanceUpdatePolicy struct {
...
type V1alphaCluster_MigrationSource struct {
...
type V1alphaCluster_NetworkConfig struct {
...
type V1alphaCluster_SecondaryConfig struct {
	// The name of the primary cluster name with the format: * projects/{project}/locations/{region}/clusters/{cluster_id}
	PrimaryClusterName any
}

type V1alphaCluster_SslConfig struct {
...
type V1alphaCluster_TrialMetadata struct {
...
var V1alphaCluster_AutomatedBackupPolicy_EncryptionConfigFields = ubx.FieldMap{
	"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
}

var V1alphaCluster_AutomatedBackupPolicy_QuantityBasedRetentionFields = ubx.FieldMap{
	"Count": ubx.FieldSpec{WireName: "count"},
}

var V1alphaCluster_AutomatedBackupPolicy_TimeBasedRetentionFields = ubx.FieldMap{
	"RetentionPeriod": ubx.FieldSpec{WireName: "retention_period"},
}

var V1alphaCluster_AutomatedBackupPolicy_WeeklySchedule_StartTimesFields = ubx.FieldMap{
...
var V1alphaCluster_AutomatedBackupPolicy_WeeklyScheduleFields = ubx.FieldMap{
...
var V1alphaCluster_AutomatedBackupPolicyFields = ubx.FieldMap{
...
var V1alphaCluster_BackupSourceFields = ubx.FieldMap{
	"BackupName": ubx.FieldSpec{WireName: "backup_name"},
	"BackupUid":  ubx.FieldSpec{WireName: "backup_uid"},
}

var V1alphaCluster_BackupdrBackupSourceFields = ubx.FieldMap{
	"Backup": ubx.FieldSpec{WireName: "backup"},
}

var V1alphaCluster_BackupdrInfo_CurrentWindowFields = ubx.FieldMap{
...
var V1alphaCluster_BackupdrInfoFields = ubx.FieldMap{
...
var V1alphaCluster_CloudsqlBackupRunSourceFields = ubx.FieldMap{
	"BackupRunId": ubx.FieldSpec{WireName: "backup_run_id"},
	"InstanceId":  ubx.FieldSpec{WireName: "instance_id"},
	"Project":     ubx.FieldSpec{WireName: "project"},
}

var V1alphaCluster_ContinuousBackupConfigFields = ubx.FieldMap{
	"Enabled": ubx.FieldSpec{WireName: "enabled"},
	"EncryptionConfig": ubx.FieldSpec{
		WireName: "encryption_config",
		Kind:     "object",
...
var V1alphaCluster_ContinuousBackupInfo_EncryptionInfoFields = ubx.FieldMap{
	"EncryptionType": ubx.FieldSpec{WireName: "encryption_type"},
	"KmsKeyVersions": ubx.FieldSpec{WireName: "kms_key_versions"},
}

var V1alphaCluster_ContinuousBackupInfoFields = ubx.FieldMap{
...
var V1alphaCluster_DataplexConfigFields = ubx.FieldMap{
	"Enabled": ubx.FieldSpec{WireName: "enabled"},
}

var V1alphaCluster_GeminiConfigFields = ubx.FieldMap{
	"Entitled": ubx.FieldSpec{WireName: "entitled"},
}

var V1alphaCluster_InitialUserFields = ubx.FieldMap{
	"Password": ubx.FieldSpec{WireName: "password"},
	"User":     ubx.FieldSpec{WireName: "user"},
}

var V1alphaCluster_MaintenanceScheduleFields = ubx.FieldMap{
	"StartTime": ubx.FieldSpec{WireName: "start_time"},
}

var V1alphaCluster_MaintenanceUpdatePolicy_DenyMaintenancePeriods_EndDateFields = ubx.FieldMap{
	"Day":   ubx.FieldSpec{WireName: "day"},
	"Month": ubx.FieldSpec{WireName: "month"},
	"Year":  ubx.FieldSpec{WireName: "year"},
}

var V1alphaCluster_MaintenanceUpdatePolicy_DenyMaintenancePeriodsFields = ubx.FieldMap{
...
var V1alphaCluster_MaintenanceUpdatePolicy_MaintenanceWindowsFields = ubx.FieldMap{
	"Day": ubx.FieldSpec{WireName: "day"},
...
var V1alphaCluster_MaintenanceUpdatePolicyFields = ubx.FieldMap{
...
var V1alphaCluster_MigrationSourceFields = ubx.FieldMap{
...
var V1alphaCluster_NetworkConfigFields = ubx.FieldMap{
	"AllocatedIpRange": ubx.FieldSpec{WireName: "allocated_ip_range"},
	"Network":          ubx.FieldSpec{WireName: "network"},
}

var V1alphaCluster_PrimaryConfigFields = ubx.FieldMap{
	"SecondaryClusterNames": ubx.FieldSpec{WireName: "secondary_cluster_names"},
}

var V1alphaCluster_PscConfigFields = ubx.FieldMap{
...
var V1alphaCluster_SecondaryConfigFields = ubx.FieldMap{
	"PrimaryClusterName": ubx.FieldSpec{WireName: "primary_cluster_name"},
}

var V1alphaCluster_SslConfigFields = ubx.FieldMap{
	"CaSource": ubx.FieldSpec{WireName: "ca_source"},
	"SslMode":  ubx.FieldSpec{WireName: "ssl_mode"},
}

var V1alphaCluster_TrialMetadataFields = ubx.FieldMap{
...
type V1alphaClusterConfig struct {
...
type V1alphaClusterAttrs struct {
	// Annotations to allow client tools to store small amount of arbitrary data. This is distinct from labels. https://google.aip.dev/128
	Annotations any
	// Message describing the user-specified automated backup policy. All fields in the automated backup policy are optional. Defaults for each field are provided if they are not set.
	AutomatedBackupPolicy any
...
var V1alphaCluster = ubx.ResourceBinding{
