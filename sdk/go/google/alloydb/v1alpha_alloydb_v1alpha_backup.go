...
type V1alphaAlloydbV1alphaBackup_EncryptionConfig struct {
	// The fully-qualified resource name of the KMS key. Each Cloud KMS key is regionalized and has the following format: projects/[PROJECT]/locations/[REGION]/keyRings/[RING]/cryptoKeys/[KEY_NAME]
	KmsKeyName any
}

type V1alphaAlloydbV1alphaBackup_EncryptionInfo struct {
...
type V1alphaAlloydbV1alphaBackup_ExpiryQuantity struct {
...
var V1alphaAlloydbV1alphaBackup_EncryptionConfigFields = ubx.FieldMap{
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

var V1alphaAlloydbV1alphaBackup_EncryptionInfoFields = ubx.FieldMap{
		"EncryptionType": ubx.FieldSpec{WireName: "encryption_type"},
		"KmsKeyVersions": ubx.FieldSpec{WireName: "kms_key_versions"},
	}

var V1alphaAlloydbV1alphaBackup_ExpiryQuantityFields = ubx.FieldMap{
		"RetentionCount": ubx.FieldSpec{WireName: "retention_count"},
		"TotalRetentionCount": ubx.FieldSpec{WireName: "total_retention_count"},
	}

type V1alphaAlloydbV1alphaBackupConfig struct {
...
type V1alphaAlloydbV1alphaBackupAttrs struct {
	// Annotations to allow client tools to store small amount of arbitrary data. This is distinct from labels. https://google.aip.dev/128
	Annotations any
	// Output only. Set to true if the cluster corresponding to this backup is deleted. This field is only populated for when using the BACKUP_VIEW_CLUSTER_DELETED view.
	ClusterDeleted any
...
var V1alphaAlloydbV1alphaBackup = ubx.ResourceBinding{
