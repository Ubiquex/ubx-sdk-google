...
type V1betaInstance_ClientConnectionConfig_SslConfig struct {
...
type V1betaInstance_ClientConnectionConfig struct {
...
type V1betaInstance_ConnectionPoolConfig struct {
...
type V1betaInstance_NetworkConfig_AuthorizedExternalNetworks struct {
	CidrRange any
}

type V1betaInstance_NetworkConfig struct {
...
type V1betaInstance_PscInstanceConfig struct {
...
type V1betaInstance_PscInstanceInfo struct {
...
type V1betaInstance_QueryInsightsConfig struct {
...
type V1betaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilization struct {
	// Target CPU utilization as a float between 0 and 1.
	UtilizationTarget any
}

type V1betaInstance_ReadPoolConfig_AutoScalingConfig_Policy struct {
...
type V1betaInstance_ReadPoolConfig struct {
...
type V1betaInstance_UpdatePolicy struct {
...
type V1betaInstanceAttrs struct {
	// Optional. Specifies whether an instance needs to spin up. Once the instance is active, the activation policy can be updated to the `NEVER` to stop the instance. Likewise, the activation policy can be updated to `ALWAYS` to start the instance. There are restrictions around when an instance can/cannot be activated (for example, a read pool instance should be stopped before stopping primary etc.). Please refer to the API documentation for more details.
	ActivationPolicy any
	// Annotations to allow client tools to store small amount of arbitrary data. This is distinct from labels. https://google.aip.dev/128
	Annotations any
...
var V1betaInstance = ubx.ResourceBinding{
