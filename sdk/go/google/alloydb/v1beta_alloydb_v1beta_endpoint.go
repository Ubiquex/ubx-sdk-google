...
type V1betaAlloydbV1betaEndpoint_DnsConfig struct {
...
var V1betaAlloydbV1betaEndpoint_DnsConfigFields = ubx.FieldMap{
		"DnsName": ubx.FieldSpec{WireName: "dns_name"},
		"DnsRecordType": ubx.FieldSpec{WireName: "dns_record_type"},
	}

type V1betaAlloydbV1betaEndpointConfig struct {
...
type V1betaAlloydbV1betaEndpointAttrs struct {
	// Annotations to allow client tools to store small amount of arbitrary data. This is distinct from labels. https://google.aip.dev/128
	Annotations any
	// Output only. Create time stamp
	CreateTime any
...
var V1betaAlloydbV1betaEndpoint = ubx.ResourceBinding{
