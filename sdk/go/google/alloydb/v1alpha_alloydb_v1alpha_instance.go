...
type V1alphaAlloydbV1alphaInstance_ClientConnectionConfig_SslConfig struct {
...
type V1alphaAlloydbV1alphaInstance_ClientConnectionConfig struct {
...
type V1alphaAlloydbV1alphaInstance_ConnectionPoolConfig struct {
...
type V1alphaAlloydbV1alphaInstance_GcaConfig struct {
	// Output only. Represents the GCA entitlement state of the instance.
	GcaEntitlement any
}

type V1alphaAlloydbV1alphaInstance_GeminiConfig struct {
	// Output only. Deprecated and unused. This field will be removed in the near future.
	Entitled any
}

type V1alphaAlloydbV1alphaInstance_MachineConfig struct {
...
type V1alphaAlloydbV1alphaInstance_NetworkConfig_AuthorizedExternalNetworks struct {
	CidrRange any
}

type V1alphaAlloydbV1alphaInstance_NetworkConfig struct {
...
type V1alphaAlloydbV1alphaInstance_Nodes struct {
	Id any
	Ip any
	IsHotStandby any
	State any
...
type V1alphaAlloydbV1alphaInstance_ObservabilityConfig struct {
...
type V1alphaAlloydbV1alphaInstance_PscInstanceConfig_PscAutoConnections struct {
	ConsumerNetwork any
...
type V1alphaAlloydbV1alphaInstance_PscInstanceConfig_PscInterfaceConfigs struct {
	NetworkAttachmentResource any
}

type V1alphaAlloydbV1alphaInstance_PscInstanceConfig struct {
...
type V1alphaAlloydbV1alphaInstance_PscInstanceInfo struct {
...
type V1alphaAlloydbV1alphaInstance_QueryInsightsConfig struct {
...
type V1alphaAlloydbV1alphaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilization struct {
	// Target CPU utilization as a float between 0 and 1.
	UtilizationTarget any
}

type V1alphaAlloydbV1alphaInstance_ReadPoolConfig_AutoScalingConfig_Policy struct {
...
type V1alphaAlloydbV1alphaInstance_ReadPoolConfig_AutoScalingConfig_Schedules struct {
	CronExpression any
	Description any
	Disabled any
	DurationSec any
...
type V1alphaAlloydbV1alphaInstance_ReadPoolConfig_AutoScalingConfig struct {
...
type V1alphaAlloydbV1alphaInstance_ReadPoolConfig struct {
...
type V1alphaAlloydbV1alphaInstance_UpdatePolicy struct {
	// Mode for updating the instance.
	Mode any
}

var V1alphaAlloydbV1alphaInstance_ClientConnectionConfig_SslConfigFields = ubx.FieldMap{
		"CaSource": ubx.FieldSpec{WireName: "ca_source"},
		"SslMode": ubx.FieldSpec{WireName: "ssl_mode"},
	}

var V1alphaAlloydbV1alphaInstance_ClientConnectionConfigFields = ubx.FieldMap{
...
var V1alphaAlloydbV1alphaInstance_ConnectionPoolConfigFields = ubx.FieldMap{
...
var V1alphaAlloydbV1alphaInstance_GcaConfigFields = ubx.FieldMap{
		"GcaEntitlement": ubx.FieldSpec{WireName: "gca_entitlement"},
	}

var V1alphaAlloydbV1alphaInstance_GeminiConfigFields = ubx.FieldMap{
		"Entitled": ubx.FieldSpec{WireName: "entitled"},
	}

var V1alphaAlloydbV1alphaInstance_MachineConfigFields = ubx.FieldMap{
		"CpuCount": ubx.FieldSpec{WireName: "cpu_count"},
		"MachineType": ubx.FieldSpec{WireName: "machine_type"},
	}

var V1alphaAlloydbV1alphaInstance_NetworkConfig_AuthorizedExternalNetworksFields = ubx.FieldMap{
		"CidrRange": ubx.FieldSpec{WireName: "cidr_range"},
	}

var V1alphaAlloydbV1alphaInstance_NetworkConfigFields = ubx.FieldMap{
...
var V1alphaAlloydbV1alphaInstance_NodesFields = ubx.FieldMap{
...
var V1alphaAlloydbV1alphaInstance_ObservabilityConfigFields = ubx.FieldMap{
...
var V1alphaAlloydbV1alphaInstance_PscInstanceConfig_PscAutoConnectionsFields = ubx.FieldMap{
...
var V1alphaAlloydbV1alphaInstance_PscInstanceConfig_PscInterfaceConfigsFields = ubx.FieldMap{
		"NetworkAttachmentResource": ubx.FieldSpec{WireName: "network_attachment_resource"},
	}

var V1alphaAlloydbV1alphaInstance_PscInstanceConfigFields = ubx.FieldMap{
...
var V1alphaAlloydbV1alphaInstance_PscInstanceInfoFields = ubx.FieldMap{
...
var V1alphaAlloydbV1alphaInstance_QueryInsightsConfigFields = ubx.FieldMap{
		"QueryPlansPerMinute": ubx.FieldSpec{WireName: "query_plans_per_minute"},
...
var V1alphaAlloydbV1alphaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilizationFields = ubx.FieldMap{
		"UtilizationTarget": ubx.FieldSpec{WireName: "utilization_target"},
	}

var V1alphaAlloydbV1alphaInstance_ReadPoolConfig_AutoScalingConfig_PolicyFields = ubx.FieldMap{
...
var V1alphaAlloydbV1alphaInstance_ReadPoolConfig_AutoScalingConfig_SchedulesFields = ubx.FieldMap{
...
var V1alphaAlloydbV1alphaInstance_ReadPoolConfig_AutoScalingConfigFields = ubx.FieldMap{
...
var V1alphaAlloydbV1alphaInstance_ReadPoolConfigFields = ubx.FieldMap{
...
var V1alphaAlloydbV1alphaInstance_UpdatePolicyFields = ubx.FieldMap{
		"Mode": ubx.FieldSpec{WireName: "mode"},
	}

type V1alphaAlloydbV1alphaInstanceConfig struct {
...
type V1alphaAlloydbV1alphaInstanceAttrs struct {
	// Optional. Specifies whether an instance needs to spin up. Once the instance is active, the activation policy can be updated to the `NEVER` to stop the instance. Likewise, the activation policy can be updated to `ALWAYS` to start the instance. There are restrictions around when an instance can/cannot be activated (for example, a read pool instance should be stopped before stopping primary etc.). Please refer to the API documentation for more details.
	ActivationPolicy any
	// Annotations to allow client tools to store small amount of arbitrary data. This is distinct from labels. https://google.aip.dev/128
	Annotations any
...
var V1alphaAlloydbV1alphaInstance = ubx.ResourceBinding{
