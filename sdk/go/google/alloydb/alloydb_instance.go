...
type AlloydbInstance_ClientConnectionConfig_SslConfig struct {
...
type AlloydbInstance_ClientConnectionConfig struct {
...
type AlloydbInstance_ConnectionPoolConfig struct {
...
type AlloydbInstance_MachineConfig struct {
...
type AlloydbInstance_NetworkConfig_AuthorizedExternalNetworks struct {
	CidrRange any
}

type AlloydbInstance_NetworkConfig struct {
...
type AlloydbInstance_Nodes struct {
	Id any
	Ip any
	IsHotStandby any
	State any
...
type AlloydbInstance_ObservabilityConfig struct {
...
type AlloydbInstance_PscInstanceConfig_PscAutoConnections struct {
	ConsumerNetwork any
...
type AlloydbInstance_PscInstanceConfig_PscInterfaceConfigs struct {
	NetworkAttachmentResource any
}

type AlloydbInstance_PscInstanceConfig struct {
...
type AlloydbInstance_QueryInsightsConfig struct {
...
type AlloydbInstance_ReadPoolConfig struct {
	// Read capacity, i.e. number of nodes in a read pool instance.
	NodeCount any
}

var AlloydbInstance_ClientConnectionConfig_SslConfigFields = ubx.FieldMap{
		"CaSource": ubx.FieldSpec{WireName: "ca_source"},
		"SslMode": ubx.FieldSpec{WireName: "ssl_mode"},
	}

var AlloydbInstance_ClientConnectionConfigFields = ubx.FieldMap{
...
var AlloydbInstance_ConnectionPoolConfigFields = ubx.FieldMap{
...
var AlloydbInstance_MachineConfigFields = ubx.FieldMap{
		"CpuCount": ubx.FieldSpec{WireName: "cpu_count"},
		"MachineType": ubx.FieldSpec{WireName: "machine_type"},
	}

var AlloydbInstance_NetworkConfig_AuthorizedExternalNetworksFields = ubx.FieldMap{
		"CidrRange": ubx.FieldSpec{WireName: "cidr_range"},
	}

var AlloydbInstance_NetworkConfigFields = ubx.FieldMap{
...
var AlloydbInstance_NodesFields = ubx.FieldMap{
...
var AlloydbInstance_ObservabilityConfigFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
...
var AlloydbInstance_PscInstanceConfig_PscAutoConnectionsFields = ubx.FieldMap{
...
var AlloydbInstance_PscInstanceConfig_PscInterfaceConfigsFields = ubx.FieldMap{
		"NetworkAttachmentResource": ubx.FieldSpec{WireName: "network_attachment_resource"},
	}

var AlloydbInstance_PscInstanceConfigFields = ubx.FieldMap{
...
var AlloydbInstance_QueryInsightsConfigFields = ubx.FieldMap{
		"QueryPlansPerMinute": ubx.FieldSpec{WireName: "query_plans_per_minute"},
...
var AlloydbInstance_ReadPoolConfigFields = ubx.FieldMap{
...
type AlloydbInstanceAttrs struct {
	// Optional. Specifies whether an instance needs to spin up. Once the instance is active, the activation policy can be updated to the `NEVER` to stop the instance. Likewise, the activation policy can be updated to `ALWAYS` to start the instance. There are restrictions around when an instance can/cannot be activated (for example, a read pool instance should be stopped before stopping primary etc.). Please refer to the API documentation for more details.
	ActivationPolicy any
	// Annotations to allow client tools to store small amount of arbitrary data. This is distinct from labels. https://google.aip.dev/128
	Annotations any
...
var AlloydbInstance = ubx.ResourceBinding{
