...
type V1betaCluster_AutomatedBackupPolicy_EncryptionConfig struct {
	// The fully-qualified resource name of the KMS key. Each Cloud KMS key is regionalized and has the following format: projects/[PROJECT]/locations/[REGION]/keyRings/[RING]/cryptoKeys/[KEY_NAME]
	KmsKeyName any
}

type V1betaCluster_AutomatedBackupPolicy_QuantityBasedRetention struct {
	// The number of backups to retain.
	Count any
}

type V1betaCluster_AutomatedBackupPolicy_TimeBasedRetention struct {
...
type V1betaCluster_AutomatedBackupPolicy_WeeklySchedule struct {
...
type V1betaCluster_AutomatedBackupPolicy struct {
...
type V1betaCluster_BackupSource struct {
...
type V1betaCluster_BackupdrBackupSource struct {
...
type V1betaCluster_BackupdrInfo_CurrentWindow struct {
...
type V1betaCluster_BackupdrInfo struct {
...
type V1betaCluster_CloudsqlBackupRunSource struct {
...
type V1betaCluster_ContinuousBackupConfig struct {
...
type V1betaCluster_ContinuousBackupInfo_EncryptionInfo struct {
...
type V1betaCluster_ContinuousBackupInfo struct {
...
type V1betaCluster_DataplexConfig struct {
...
type V1betaCluster_MaintenanceSchedule struct {
...
type V1betaCluster_MaintenanceUpdatePolicy struct {
...
type V1betaCluster_MigrationSource struct {
...
type V1betaCluster_NetworkConfig struct {
...
type V1betaCluster_SecondaryConfig struct {
	// The name of the primary cluster name with the format: * projects/{project}/locations/{region}/clusters/{cluster_id}
	PrimaryClusterName any
}

type V1betaCluster_SslConfig struct {
...
type V1betaCluster_TrialMetadata struct {
...
var V1betaCluster = ubx.ResourceBinding{
