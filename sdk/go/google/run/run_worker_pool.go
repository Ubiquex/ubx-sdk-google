...
type RunWorkerPool_BinaryAuthorization struct {
...
type RunWorkerPool_Conditions struct {
	ExecutionReason any
	InstanceReason any
...
type RunWorkerPool_InstanceSplitStatuses struct {
	Percent any
	Revision any
	Type any
}

type RunWorkerPool_Scaling struct {
	// Optional. The total number of instances in manual scaling mode.
	ManualInstanceCount any
}

type RunWorkerPool_Template_Containers_BuildInfo struct {
	FunctionTarget any
	SourceLocation any
}

type RunWorkerPool_Template_Containers_Env_ValueSource_SecretKeyRef struct {
	Secret any
	Version any
}

type RunWorkerPool_Template_Containers_Env_ValueSource struct {
	SecretKeyRef any
}

type RunWorkerPool_Template_Containers_Env struct {
	Name any
	Value any
	ValueSource any
}

type RunWorkerPool_Template_Containers_LivenessProbe_Grpc struct {
	Port any
	Service any
}

type RunWorkerPool_Template_Containers_LivenessProbe_HttpGet_HttpHeaders struct {
	Name any
	Value any
}

type RunWorkerPool_Template_Containers_LivenessProbe_HttpGet struct {
	HttpHeaders any
	Path any
	Port any
}

type RunWorkerPool_Template_Containers_LivenessProbe_TcpSocket struct {
	Port any
}

type RunWorkerPool_Template_Containers_LivenessProbe struct {
...
type RunWorkerPool_Template_Containers_Ports struct {
	ContainerPort any
	Name any
}

type RunWorkerPool_Template_Containers_Resources struct {
	CpuIdle any
	Limits any
	StartupCpuBoost any
}

type RunWorkerPool_Template_Containers_SourceCode_CloudStorageSource struct {
	Bucket any
	Generation any
	Object any
}

type RunWorkerPool_Template_Containers_SourceCode_InlinedSource_Sources struct {
	Content any
	Filename any
}

type RunWorkerPool_Template_Containers_SourceCode_InlinedSource struct {
	Sources any
}

type RunWorkerPool_Template_Containers_SourceCode struct {
	CloudStorageSource any
	InlinedSource any
}

type RunWorkerPool_Template_Containers_VolumeMounts struct {
	MountPath any
	Name any
	SubPath any
}

type RunWorkerPool_Template_Containers struct {
	Args any
	BaseImageUri any
	BuildInfo any
	Command any
...
type RunWorkerPool_Template_NodeSelector struct {
	// Required. GPU accelerator type to attach to an instance.
	Accelerator any
}

type RunWorkerPool_Template_ServiceMesh struct {
	// The Mesh resource name. Format: `projects/{project}/locations/global/meshes/{mesh}`, where `{project}` can be project id or number.
	Mesh any
}

type RunWorkerPool_Template_Volumes_CloudSqlInstance struct {
	Instances any
}

type RunWorkerPool_Template_Volumes_EmptyDir struct {
	Medium any
	SizeLimit any
}

type RunWorkerPool_Template_Volumes_Gcs struct {
	Bucket any
	MountOptions any
	ReadOnly any
}

type RunWorkerPool_Template_Volumes_Nfs struct {
	Path any
	ReadOnly any
	Server any
}

type RunWorkerPool_Template_Volumes_Secret_Items struct {
	Mode any
	Path any
	Version any
}

type RunWorkerPool_Template_Volumes_Secret struct {
	DefaultMode any
	Items any
	Secret any
}

type RunWorkerPool_Template_Volumes struct {
...
type RunWorkerPool_Template_VpcAccess_NetworkInterfaces struct {
	Network any
	Subnetwork any
	Tags any
}

type RunWorkerPool_Template_VpcAccess struct {
...
type RunWorkerPool_Template struct {
...
var RunWorkerPool_BinaryAuthorizationFields = ubx.FieldMap{
...
var RunWorkerPool_ConditionsFields = ubx.FieldMap{
...
var RunWorkerPool_InstanceSplitStatusesFields = ubx.FieldMap{
		"Percent": ubx.FieldSpec{WireName: "percent"},
		"Revision": ubx.FieldSpec{WireName: "revision"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var RunWorkerPool_ScalingFields = ubx.FieldMap{
		"ManualInstanceCount": ubx.FieldSpec{WireName: "manual_instance_count"},
	}

var RunWorkerPool_Template_Containers_BuildInfoFields = ubx.FieldMap{
		"FunctionTarget": ubx.FieldSpec{WireName: "function_target"},
		"SourceLocation": ubx.FieldSpec{WireName: "source_location"},
	}

var RunWorkerPool_Template_Containers_Env_ValueSource_SecretKeyRefFields = ubx.FieldMap{
		"Secret": ubx.FieldSpec{WireName: "secret"},
		"Version": ubx.FieldSpec{WireName: "version"},
	}

var RunWorkerPool_Template_Containers_Env_ValueSourceFields = ubx.FieldMap{
...
var RunWorkerPool_Template_Containers_EnvFields = ubx.FieldMap{
...
var RunWorkerPool_Template_Containers_LivenessProbe_GrpcFields = ubx.FieldMap{
		"Port": ubx.FieldSpec{WireName: "port"},
		"Service": ubx.FieldSpec{WireName: "service"},
	}

var RunWorkerPool_Template_Containers_LivenessProbe_HttpGet_HttpHeadersFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var RunWorkerPool_Template_Containers_LivenessProbe_HttpGetFields = ubx.FieldMap{
...
var RunWorkerPool_Template_Containers_LivenessProbe_TcpSocketFields = ubx.FieldMap{
		"Port": ubx.FieldSpec{WireName: "port"},
	}

var RunWorkerPool_Template_Containers_LivenessProbeFields = ubx.FieldMap{
...
var RunWorkerPool_Template_Containers_PortsFields = ubx.FieldMap{
		"ContainerPort": ubx.FieldSpec{WireName: "container_port"},
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var RunWorkerPool_Template_Containers_ResourcesFields = ubx.FieldMap{
...
var RunWorkerPool_Template_Containers_SourceCode_CloudStorageSourceFields = ubx.FieldMap{
		"Bucket": ubx.FieldSpec{WireName: "bucket"},
		"Generation": ubx.FieldSpec{WireName: "generation"},
		"Object": ubx.FieldSpec{WireName: "object"},
	}

var RunWorkerPool_Template_Containers_SourceCode_InlinedSource_SourcesFields = ubx.FieldMap{
		"Content": ubx.FieldSpec{WireName: "content"},
		"Filename": ubx.FieldSpec{WireName: "filename"},
	}

var RunWorkerPool_Template_Containers_SourceCode_InlinedSourceFields = ubx.FieldMap{
...
var RunWorkerPool_Template_Containers_SourceCodeFields = ubx.FieldMap{
...
var RunWorkerPool_Template_Containers_VolumeMountsFields = ubx.FieldMap{
		"MountPath": ubx.FieldSpec{WireName: "mount_path"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"SubPath": ubx.FieldSpec{WireName: "sub_path"},
	}

var RunWorkerPool_Template_ContainersFields = ubx.FieldMap{
...
var RunWorkerPool_Template_NodeSelectorFields = ubx.FieldMap{
		"Accelerator": ubx.FieldSpec{WireName: "accelerator"},
	}

var RunWorkerPool_Template_ServiceMeshFields = ubx.FieldMap{
		"Mesh": ubx.FieldSpec{WireName: "mesh"},
	}

var RunWorkerPool_Template_Volumes_CloudSqlInstanceFields = ubx.FieldMap{
		"Instances": ubx.FieldSpec{WireName: "instances"},
	}

var RunWorkerPool_Template_Volumes_EmptyDirFields = ubx.FieldMap{
		"Medium": ubx.FieldSpec{WireName: "medium"},
		"SizeLimit": ubx.FieldSpec{WireName: "size_limit"},
	}

var RunWorkerPool_Template_Volumes_GcsFields = ubx.FieldMap{
		"Bucket": ubx.FieldSpec{WireName: "bucket"},
		"MountOptions": ubx.FieldSpec{WireName: "mount_options"},
		"ReadOnly": ubx.FieldSpec{WireName: "read_only"},
	}

var RunWorkerPool_Template_Volumes_NfsFields = ubx.FieldMap{
		"Path": ubx.FieldSpec{WireName: "path"},
		"ReadOnly": ubx.FieldSpec{WireName: "read_only"},
		"Server": ubx.FieldSpec{WireName: "server"},
	}

var RunWorkerPool_Template_Volumes_Secret_ItemsFields = ubx.FieldMap{
		"Mode": ubx.FieldSpec{WireName: "mode"},
		"Path": ubx.FieldSpec{WireName: "path"},
		"Version": ubx.FieldSpec{WireName: "version"},
	}

var RunWorkerPool_Template_Volumes_SecretFields = ubx.FieldMap{
...
var RunWorkerPool_Template_VolumesFields = ubx.FieldMap{
...
var RunWorkerPool_Template_VpcAccess_NetworkInterfacesFields = ubx.FieldMap{
		"Network": ubx.FieldSpec{WireName: "network"},
		"Subnetwork": ubx.FieldSpec{WireName: "subnetwork"},
		"Tags": ubx.FieldSpec{WireName: "tags"},
	}

var RunWorkerPool_Template_VpcAccessFields = ubx.FieldMap{
...
var RunWorkerPool_TemplateFields = ubx.FieldMap{
...
type RunWorkerPoolConfig struct {
...
type RunWorkerPoolAttrs struct {
	// Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects. Cloud Run API v2 does not support annotations with `run.googleapis.com`, `cloud.googleapis.com`, `serving.knative.dev`, or `autoscaling.knative.dev` namespaces, and they will be rejected in new resources. All system annotations in v1 now have a corresponding field in v2 WorkerPool. This field follows Kubernetes annotations' namespacing, limits, and rules.
	Annotations any
	// Settings for Binary Authorization feature.
	BinaryAuthorization any
...
var RunWorkerPool = ubx.ResourceBinding{
	...
	Fields: ubx.FieldMap{
		...
		"Generation": ubx.FieldSpec{WireName: "generation"},
		"InstanceSplitStatuses": ubx.FieldSpec{
