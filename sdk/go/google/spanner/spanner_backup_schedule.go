...
type SpannerBackupSchedule_EncryptionConfig struct {
...
type SpannerBackupSchedule_Spec_CronSpec struct {
...
var SpannerBackupSchedule_SpecFields = ubx.FieldMap{
...
type SpannerBackupScheduleAttrs struct {
	// Encryption configuration for the backup to create.
	EncryptionConfig any
	// The specification for full backups. A full backup stores the entire contents of the database at a given version time.
	FullBackupSpec any
...
var SpannerBackupSchedule = ubx.ResourceBinding{
