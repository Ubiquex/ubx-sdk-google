...
type SpannerSession_Session struct {
...
var SpannerSession_SessionFields = ubx.FieldMap{
...
type SpannerSessionConfig struct {
	// A session in the Cloud Spanner API.
	Session any
}

type SpannerSessionAttrs struct {
	// Output only. The approximate timestamp when the session is last used. It's typically earlier than the actual last use time.
	ApproximateLastUseTime any
	// Output only. The timestamp when the session is created.
	CreateTime any
...
var SpannerSession = ubx.ResourceBinding{
