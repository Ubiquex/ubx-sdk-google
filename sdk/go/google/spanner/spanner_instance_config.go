...
type SpannerInstanceConfig_InstanceConfig_OptionalReplicas struct {
	DefaultLeaderLocation any
	Location any
	Type any
}

type SpannerInstanceConfig_InstanceConfig struct {
	...
	StorageLimitPerProcessingUnit any
}

var SpannerInstanceConfig_InstanceConfig_OptionalReplicasFields = ubx.FieldMap{
		"DefaultLeaderLocation": ubx.FieldSpec{WireName: "default_leader_location"},
		"Location": ubx.FieldSpec{WireName: "location"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var SpannerInstanceConfig_InstanceConfigFields = ubx.FieldMap{
...
type SpannerInstanceConfigConfig struct {
	...
	InstanceConfigId any
	// An option to validate, but not actually execute, a request, and provide the same response.
	ValidateOnly any
}

type SpannerInstanceConfigAttrs struct {
	// Base configuration name, e.g. projects//instanceConfigs/nam3, based on which this configuration is created. Only set for user-managed configurations. `base_config` must refer to a configuration of type `GOOGLE_MANAGED` in the same project as this configuration.
	BaseConfig any
	// Output only. Whether this instance configuration is a Google-managed or user-managed configuration.
	ConfigType any
...
var SpannerInstanceConfig = ubx.ResourceBinding{
