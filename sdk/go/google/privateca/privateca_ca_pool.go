...
type PrivatecaCaPool_EncryptionSpec struct {
	// The resource name for a Cloud KMS key in the format `projects/*/locations/*/keyRings/*/cryptoKeys/*`.
	CloudKmsKey any
}

type PrivatecaCaPool_IssuancePolicy_AllowedIssuanceModes struct {
...
type PrivatecaCaPool_IssuancePolicy_AllowedKeyTypes_EllipticCurve struct {
	SignatureAlgorithm any
}

type PrivatecaCaPool_IssuancePolicy_AllowedKeyTypes_Rsa struct {
	MaxModulusSize any
	MinModulusSize any
}

type PrivatecaCaPool_IssuancePolicy_AllowedKeyTypes struct {
	EllipticCurve any
	Rsa any
}

type PrivatecaCaPool_IssuancePolicy_BaselineValues_AdditionalExtensions_ObjectId struct {
	ObjectIdPath any
}

type PrivatecaCaPool_IssuancePolicy_BaselineValues_AdditionalExtensions struct {
	Critical any
	ObjectId any
	Value any
}

type PrivatecaCaPool_IssuancePolicy_BaselineValues_CaOptions struct {
...
type PrivatecaCaPool_IssuancePolicy_BaselineValues_KeyUsage_BaseKeyUsage struct {
...
type PrivatecaCaPool_IssuancePolicy_BaselineValues_KeyUsage_ExtendedKeyUsage struct {
...
type PrivatecaCaPool_IssuancePolicy_BaselineValues_KeyUsage struct {
...
type PrivatecaCaPool_IssuancePolicy_BaselineValues_NameConstraints struct {
...
type PrivatecaCaPool_IssuancePolicy_BaselineValues struct {
...
type PrivatecaCaPool_IssuancePolicy_IdentityConstraints_CelExpression struct {
...
type PrivatecaCaPool_IssuancePolicy_IdentityConstraints struct {
...
type PrivatecaCaPool_IssuancePolicy_PassthroughExtensions struct {
...
type PrivatecaCaPool_IssuancePolicy struct {
...
type PrivatecaCaPool_PublishingOptions struct {
...
var PrivatecaCaPool_EncryptionSpecFields = ubx.FieldMap{
		"CloudKmsKey": ubx.FieldSpec{WireName: "cloud_kms_key"},
	}

var PrivatecaCaPool_IssuancePolicy_AllowedIssuanceModesFields = ubx.FieldMap{
...
var PrivatecaCaPool_IssuancePolicy_AllowedKeyTypes_EllipticCurveFields = ubx.FieldMap{
		"SignatureAlgorithm": ubx.FieldSpec{WireName: "signature_algorithm"},
	}

var PrivatecaCaPool_IssuancePolicy_AllowedKeyTypes_RsaFields = ubx.FieldMap{
		"MaxModulusSize": ubx.FieldSpec{WireName: "max_modulus_size"},
		"MinModulusSize": ubx.FieldSpec{WireName: "min_modulus_size"},
	}

var PrivatecaCaPool_IssuancePolicy_AllowedKeyTypesFields = ubx.FieldMap{
...
var PrivatecaCaPool_IssuancePolicy_BaselineValues_AdditionalExtensions_ObjectIdFields = ubx.FieldMap{
		"ObjectIdPath": ubx.FieldSpec{WireName: "object_id_path"},
	}

var PrivatecaCaPool_IssuancePolicy_BaselineValues_AdditionalExtensionsFields = ubx.FieldMap{
...
var PrivatecaCaPool_IssuancePolicy_BaselineValues_CaOptionsFields = ubx.FieldMap{
		"IsCa": ubx.FieldSpec{WireName: "is_ca"},
		"MaxIssuerPathLength": ubx.FieldSpec{WireName: "max_issuer_path_length"},
	}

var PrivatecaCaPool_IssuancePolicy_BaselineValues_KeyUsage_BaseKeyUsageFields = ubx.FieldMap{
...
var PrivatecaCaPool_IssuancePolicy_BaselineValues_KeyUsage_ExtendedKeyUsageFields = ubx.FieldMap{
...
var PrivatecaCaPool_IssuancePolicy_BaselineValues_KeyUsageFields = ubx.FieldMap{
...
var PrivatecaCaPool_IssuancePolicy_BaselineValues_NameConstraintsFields = ubx.FieldMap{
		"Critical": ubx.FieldSpec{WireName: "critical"},
...
var PrivatecaCaPool_IssuancePolicy_BaselineValuesFields = ubx.FieldMap{
...
var PrivatecaCaPool_IssuancePolicy_IdentityConstraints_CelExpressionFields = ubx.FieldMap{
...
var PrivatecaCaPool_IssuancePolicy_IdentityConstraintsFields = ubx.FieldMap{
...
var PrivatecaCaPool_IssuancePolicy_PassthroughExtensionsFields = ubx.FieldMap{
		"AdditionalExtensions": ubx.FieldSpec{
			WireName: "additional_extensions",
			Kind: "list",
			Fields: PrivatecaCaPool_IssuancePolicy_BaselineValues_AdditionalExtensions_ObjectIdFields,
...
var PrivatecaCaPool_IssuancePolicyFields = ubx.FieldMap{
...
var PrivatecaCaPool_PublishingOptionsFields = ubx.FieldMap{
...
type PrivatecaCaPoolAttrs struct {
	// The configuration used for encrypting data at rest.
	EncryptionSpec any
	// Defines controls over all certificate issuance within a CaPool.
	IssuancePolicy any
...
var PrivatecaCaPool = ubx.ResourceBinding{
