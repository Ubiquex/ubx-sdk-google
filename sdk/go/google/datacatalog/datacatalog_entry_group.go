...
type DatacatalogEntryGroup_DataCatalogTimestamps struct {
...
var DatacatalogEntryGroup_DataCatalogTimestampsFields = ubx.FieldMap{
...
type DatacatalogEntryGroupAttrs struct {
	// Timestamps associated with this resource in a particular system.
	DataCatalogTimestamps any
	// Entry group description. Can consist of several sentences or paragraphs that describe the entry group contents. Default value is an empty string.
	Description any
...
var DatacatalogEntryGroup = ubx.ResourceBinding{
