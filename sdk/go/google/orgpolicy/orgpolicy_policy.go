...
type OrgpolicyPolicy_Alternate_Spec_Rules_Condition struct {
	Description any
	Expression any
	Location any
	Title any
...
type OrgpolicyPolicy_Alternate_Spec_Rules_Values struct {
	AllowedValues any
	DeniedValues any
}

type OrgpolicyPolicy_Alternate_Spec_Rules struct {
	AllowAll any
	Condition any
	DenyAll any
	Enforce any
...
type OrgpolicyPolicy_Alternate_Spec struct {
...
type OrgpolicyPolicy_Alternate struct {
...
var OrgpolicyPolicy_Alternate_Spec_Rules_ConditionFields = ubx.FieldMap{
...
var OrgpolicyPolicy_Alternate_Spec_Rules_ValuesFields = ubx.FieldMap{
		"AllowedValues": ubx.FieldSpec{WireName: "allowed_values"},
		"DeniedValues": ubx.FieldSpec{WireName: "denied_values"},
	}

var OrgpolicyPolicy_Alternate_Spec_RulesFields = ubx.FieldMap{
...
var OrgpolicyPolicy_Alternate_SpecFields = ubx.FieldMap{
...
var OrgpolicyPolicy_AlternateFields = ubx.FieldMap{
...
type OrgpolicyPolicyAttrs struct {
	// Similar to PolicySpec but with an extra 'launch' field for launch reference. The PolicySpec here is specific for dry-run.
	Alternate any
	// Defines a Google Cloud policy specification that is used to specify constraints for configurations of Google Cloud resources.
	DryRunSpec any
...
var OrgpolicyPolicy = ubx.ResourceBinding{
