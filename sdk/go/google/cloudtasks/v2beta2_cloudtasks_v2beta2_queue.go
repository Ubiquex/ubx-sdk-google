...
type V2beta2CloudtasksV2beta2Queue_AppEngineHttpTarget_AppEngineRoutingOverride struct {
...
type V2beta2CloudtasksV2beta2Queue_AppEngineHttpTarget struct {
...
type V2beta2CloudtasksV2beta2Queue_HttpTarget_HeaderOverrides_Header struct {
	Key any
	Value any
}

type V2beta2CloudtasksV2beta2Queue_HttpTarget_HeaderOverrides struct {
	Header any
}

type V2beta2CloudtasksV2beta2Queue_HttpTarget_OauthToken struct {
...
type V2beta2CloudtasksV2beta2Queue_HttpTarget_OidcToken struct {
...
type V2beta2CloudtasksV2beta2Queue_HttpTarget_UriOverride_PathOverride struct {
	// The URI path (e.g., /users/1234). Default is an empty string.
	Path any
}

type V2beta2CloudtasksV2beta2Queue_HttpTarget_UriOverride_QueryOverride struct {
	// The query parameters (e.g., qparam1=123&qparam2=456). Default is an empty string.
	QueryParams any
}

type V2beta2CloudtasksV2beta2Queue_HttpTarget_UriOverride struct {
...
type V2beta2CloudtasksV2beta2Queue_HttpTarget struct {
...
type V2beta2CloudtasksV2beta2Queue_RateLimits struct {
...
type V2beta2CloudtasksV2beta2Queue_RetryConfig struct {
...
type V2beta2CloudtasksV2beta2Queue_Stats struct {
...
var V2beta2CloudtasksV2beta2Queue_AppEngineHttpTarget_AppEngineRoutingOverrideFields = ubx.FieldMap{
...
var V2beta2CloudtasksV2beta2Queue_AppEngineHttpTargetFields = ubx.FieldMap{
...
var V2beta2CloudtasksV2beta2Queue_HttpTarget_HeaderOverrides_HeaderFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var V2beta2CloudtasksV2beta2Queue_HttpTarget_HeaderOverridesFields = ubx.FieldMap{
...
var V2beta2CloudtasksV2beta2Queue_HttpTarget_OauthTokenFields = ubx.FieldMap{
		"Scope": ubx.FieldSpec{WireName: "scope"},
		"ServiceAccountEmail": ubx.FieldSpec{WireName: "service_account_email"},
	}

var V2beta2CloudtasksV2beta2Queue_HttpTarget_OidcTokenFields = ubx.FieldMap{
		"Audience": ubx.FieldSpec{WireName: "audience"},
		"ServiceAccountEmail": ubx.FieldSpec{WireName: "service_account_email"},
	}

var V2beta2CloudtasksV2beta2Queue_HttpTarget_UriOverride_PathOverrideFields = ubx.FieldMap{
		"Path": ubx.FieldSpec{WireName: "path"},
	}

var V2beta2CloudtasksV2beta2Queue_HttpTarget_UriOverride_QueryOverrideFields = ubx.FieldMap{
		"QueryParams": ubx.FieldSpec{WireName: "query_params"},
	}

var V2beta2CloudtasksV2beta2Queue_HttpTarget_UriOverrideFields = ubx.FieldMap{
		"Host": ubx.FieldSpec{WireName: "host"},
...
var V2beta2CloudtasksV2beta2Queue_HttpTargetFields = ubx.FieldMap{
...
var V2beta2CloudtasksV2beta2Queue_RateLimitsFields = ubx.FieldMap{
...
var V2beta2CloudtasksV2beta2Queue_RetryConfigFields = ubx.FieldMap{
...
var V2beta2CloudtasksV2beta2Queue_StatsFields = ubx.FieldMap{
...
type V2beta2CloudtasksV2beta2QueueConfig struct {
...
type V2beta2CloudtasksV2beta2QueueAttrs struct {
	// App Engine HTTP target. The task will be delivered to the App Engine application hostname specified by its AppEngineHttpTarget and AppEngineHttpRequest. The documentation for AppEngineHttpRequest explains how the task's host URL is constructed. Using AppEngineHttpTarget requires [`appengine.applications.get`](https://cloud.google.com/appengine/docs/admin-api/access-control) Google IAM permission for the project and the following scope: `https://www.googleapis.com/auth/cloud-platform`
	AppEngineHttpTarget any
	// HTTP target. When specified as a Queue, all the tasks with [HttpRequest] will be overridden according to the target.
	HttpTarget any
...
var V2beta2CloudtasksV2beta2Queue = ubx.ResourceBinding{
