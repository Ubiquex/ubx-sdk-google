...
type CloudtasksQueue_AppEngineRoutingOverride struct {
...
type CloudtasksQueue_HttpTarget_HeaderOverrides_Header struct {
	Key any
	Value any
}

type CloudtasksQueue_HttpTarget_HeaderOverrides struct {
	Header any
}

type CloudtasksQueue_HttpTarget_OauthToken struct {
...
type CloudtasksQueue_HttpTarget_OidcToken struct {
...
type CloudtasksQueue_HttpTarget_UriOverride_PathOverride struct {
	// The URI path (e.g., /users/1234). Default is an empty string.
	Path any
}

type CloudtasksQueue_HttpTarget_UriOverride_QueryOverride struct {
	// The query parameters (e.g., qparam1=123&qparam2=456). Default is an empty string.
	QueryParams any
}

type CloudtasksQueue_HttpTarget_UriOverride struct {
...
type CloudtasksQueue_HttpTarget struct {
...
type CloudtasksQueue_RateLimits struct {
...
type CloudtasksQueue_RetryConfig struct {
...
type CloudtasksQueue_StackdriverLoggingConfig struct {
...
var CloudtasksQueue_AppEngineRoutingOverrideFields = ubx.FieldMap{
...
var CloudtasksQueue_HttpTarget_HeaderOverrides_HeaderFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var CloudtasksQueue_HttpTarget_HeaderOverridesFields = ubx.FieldMap{
...
var CloudtasksQueue_HttpTarget_OauthTokenFields = ubx.FieldMap{
		"Scope": ubx.FieldSpec{WireName: "scope"},
		"ServiceAccountEmail": ubx.FieldSpec{WireName: "service_account_email"},
	}

var CloudtasksQueue_HttpTarget_OidcTokenFields = ubx.FieldMap{
		"Audience": ubx.FieldSpec{WireName: "audience"},
		"ServiceAccountEmail": ubx.FieldSpec{WireName: "service_account_email"},
	}

var CloudtasksQueue_HttpTarget_UriOverride_PathOverrideFields = ubx.FieldMap{
		"Path": ubx.FieldSpec{WireName: "path"},
	}

var CloudtasksQueue_HttpTarget_UriOverride_QueryOverrideFields = ubx.FieldMap{
		"QueryParams": ubx.FieldSpec{WireName: "query_params"},
	}

var CloudtasksQueue_HttpTarget_UriOverrideFields = ubx.FieldMap{
		"Host": ubx.FieldSpec{WireName: "host"},
...
var CloudtasksQueue_HttpTargetFields = ubx.FieldMap{
...
var CloudtasksQueue_RateLimitsFields = ubx.FieldMap{
...
var CloudtasksQueue_RetryConfigFields = ubx.FieldMap{
...
var CloudtasksQueue_StackdriverLoggingConfigFields = ubx.FieldMap{
...
type CloudtasksQueueAttrs struct {
	// App Engine Routing. Defines routing characteristics specific to App Engine - service, version, and instance. For more information about services, versions, and instances see [An Overview of App Engine](https://cloud.google.com/appengine/docs/python/an-overview-of-app-engine), [Microservices Architecture on Google App Engine](https://cloud.google.com/appengine/docs/python/microservices-on-app-engine), [App Engine Standard request routing](https://cloud.google.com/appengine/docs/standard/python/how-requests-are-routed), and [App Engine Flex request routing](https://cloud.google.com/appengine/docs/flexible/python/how-requests-are-routed). Using AppEngineRouting requires [`appengine.applications.get`](https://cloud.google.com/appengine/docs/admin-api/access-control) Google IAM permission for the project and the following scope: `https://www.googleapis.com/auth/cloud-platform`
	AppEngineRoutingOverride any
	// HTTP target. When specified as a Queue, all the tasks with [HttpRequest] will be overridden according to the target.
	HttpTarget any
...
var CloudtasksQueue = ubx.ResourceBinding{
