...
type SavedQuery_Content_IamPolicyAnalysisQuery_AccessSelector struct {
...
type SavedQuery_Content_IamPolicyAnalysisQuery_ConditionContext struct {
	// The hypothetical access timestamp to evaluate IAM conditions. Note that this value must not be earlier than the current time; otherwise, an INVALID_ARGUMENT error will be returned.
	AccessTime any
}

type SavedQuery_Content_IamPolicyAnalysisQuery_IdentitySelector struct {
...
type SavedQuery_Content_IamPolicyAnalysisQuery_Options struct {
...
type SavedQuery_Content_IamPolicyAnalysisQuery_ResourceSelector struct {
...
type SavedQuery_Content_IamPolicyAnalysisQuery struct {
...
type SavedQuery_Content struct {
