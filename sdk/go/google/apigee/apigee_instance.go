...
type ApigeeInstance_AccessLoggingConfig struct {
...
type ApigeeInstance_MaintenanceUpdatePolicy_MaintenanceWindows_StartTime struct {
	Hours any
	Minutes any
	Nanos any
	Seconds any
...
type ApigeeInstance_MaintenanceUpdatePolicy_MaintenanceWindows struct {
	Day any
	StartTime any
}

type ApigeeInstance_MaintenanceUpdatePolicy struct {
...
type ApigeeInstance_ScheduledMaintenance struct {
	// Output only. The start time (UTC) of the scheduled maintenance.
	StartTime any
}

var ApigeeInstance_AccessLoggingConfigFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
		"Filter": ubx.FieldSpec{WireName: "filter"},
	}

var ApigeeInstance_MaintenanceUpdatePolicy_MaintenanceWindows_StartTimeFields = ubx.FieldMap{
...
var ApigeeInstance_MaintenanceUpdatePolicy_MaintenanceWindowsFields = ubx.FieldMap{
...
var ApigeeInstance_MaintenanceUpdatePolicyFields = ubx.FieldMap{
...
var ApigeeInstance_ScheduledMaintenanceFields = ubx.FieldMap{
...
type ApigeeInstanceAttrs struct {
	// Access logging configuration enables customers to ship the access logs from the tenant projects to their own project's cloud logging. The feature is at the instance level ad disabled by default. It can be enabled during CreateInstance or UpdateInstance.
	AccessLoggingConfig any
	// Optional. Customer accept list represents the list of projects (id/number) on customer side that can privately connect to the service attachment. It is an optional field which the customers can provide during the instance creation. By default, the customer project associated with the Apigee organization will be included to the list.
	ConsumerAcceptList any
...
var ApigeeInstance = ubx.ResourceBinding{
