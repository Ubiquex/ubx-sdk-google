...
type ApigeeSecurityFeedback_FeedbackContexts struct {
	Attribute any
	Values any
}

var ApigeeSecurityFeedback_FeedbackContextsFields = ubx.FieldMap{
...
type ApigeeSecurityFeedbackAttrs struct {
	// Optional. Optional text the user can provide for additional, unstructured context.
	Comment any
	// Output only. The time when this specific feedback id was created.
	CreateTime any
...
var ApigeeSecurityFeedback = ubx.ResourceBinding{
