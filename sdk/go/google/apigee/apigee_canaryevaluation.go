...
type ApigeeCanaryevaluation_MetricLabels struct {
...
var ApigeeCanaryevaluation_MetricLabelsFields = ubx.FieldMap{
		"Env": ubx.FieldSpec{WireName: "env"},
		"InstanceId": ubx.FieldSpec{WireName: "instance_id"},
		"Location": ubx.FieldSpec{WireName: "location"},
	}

type ApigeeCanaryevaluationConfig struct {
...
type ApigeeCanaryevaluationAttrs struct {
	// Required. The stable version that is serving requests.
	Control any
	// Output only. Create time of the canary evaluation.
	CreateTime any
...
var ApigeeCanaryevaluation = ubx.ResourceBinding{
