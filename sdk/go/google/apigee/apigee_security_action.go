...
type ApigeeSecurityAction_ConditionConfig struct {
...
type ApigeeSecurityAction_Deny struct {
	// Optional. The HTTP response code if the Action = DENY.
	ResponseCode any
}

type ApigeeSecurityAction_Flag_Headers struct {
	Name any
	Value any
}

type ApigeeSecurityAction_Flag struct {
...
var ApigeeSecurityAction_ConditionConfigFields = ubx.FieldMap{
...
var ApigeeSecurityAction_DenyFields = ubx.FieldMap{
		"ResponseCode": ubx.FieldSpec{WireName: "response_code"},
	}

var ApigeeSecurityAction_Flag_HeadersFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var ApigeeSecurityAction_FlagFields = ubx.FieldMap{
...
type ApigeeSecurityActionAttrs struct {
	// Message that should be set in case of an Allow Action. This does not have any fields.
	Allow any
	// Optional. If unset, this would apply to all proxies in the environment. If set, this action is enforced only if at least one proxy in the repeated list is deployed at the time of enforcement. If set, several restrictions are enforced on SecurityActions. There can be at most 100 enabled actions with proxies set in an env. Several other restrictions apply on conditions and are detailed later.
	ApiProxies any
...
var ApigeeSecurityAction = ubx.ResourceBinding{
