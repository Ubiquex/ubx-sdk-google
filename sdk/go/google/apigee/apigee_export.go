...
type ApigeeExport_DateRange struct {
...
var ApigeeExport_DateRangeFields = ubx.FieldMap{
		"End": ubx.FieldSpec{WireName: "end"},
		"Start": ubx.FieldSpec{WireName: "start"},
	}

type ApigeeExportConfig struct {
...
var ApigeeExport = ubx.ResourceBinding{
