...
type ApigeeSecurityProfilesV2_ProfileAssessmentConfigs_Include struct {
	GatewayTypes any
}

type ApigeeSecurityProfilesV2_ProfileAssessmentConfigs struct {
	Include any
	Weight any
}

var ApigeeSecurityProfilesV2_ProfileAssessmentConfigs_IncludeFields = ubx.FieldMap{
		"GatewayTypes": ubx.FieldSpec{WireName: "gateway_types"},
	}

var ApigeeSecurityProfilesV2_ProfileAssessmentConfigsFields = ubx.FieldMap{
...
type ApigeeSecurityProfilesV2Config struct {
...
type ApigeeSecurityProfilesV2Attrs struct {
	// Output only. The time of the security profile creation.
	CreateTime any
	// Optional. The description of the security profile.
	Description any
...
var ApigeeSecurityProfilesV2 = ubx.ResourceBinding{
