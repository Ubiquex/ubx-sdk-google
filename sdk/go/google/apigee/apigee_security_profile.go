...
type ApigeeSecurityProfile_Environments struct {
	AttachTime any
	Environment any
}

type ApigeeSecurityProfile_ProfileConfig_Categories struct {
	Abuse any
	Authorization any
	Cors any
	Mediation any
...
type ApigeeSecurityProfile_ProfileConfig struct {
	// List of categories of profile config.
	Categories any
}

type ApigeeSecurityProfile_ScoringConfigs struct {
	Description any
	ScorePath any
	Title any
}

var ApigeeSecurityProfile_EnvironmentsFields = ubx.FieldMap{
		"AttachTime": ubx.FieldSpec{WireName: "attach_time"},
		"Environment": ubx.FieldSpec{WireName: "environment"},
	}

var ApigeeSecurityProfile_ProfileConfig_CategoriesFields = ubx.FieldMap{
...
var ApigeeSecurityProfile_ProfileConfigFields = ubx.FieldMap{
...
var ApigeeSecurityProfile_ScoringConfigsFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"ScorePath": ubx.FieldSpec{WireName: "score_path"},
		"Title": ubx.FieldSpec{WireName: "title"},
	}

type ApigeeSecurityProfileConfig struct {
...
type ApigeeSecurityProfileAttrs struct {
	// Description of the security profile.
	Description any
	// DEPRECATED: DO NOT USE Display name of the security profile.
	DisplayName any
...
var ApigeeSecurityProfile = ubx.ResourceBinding{
