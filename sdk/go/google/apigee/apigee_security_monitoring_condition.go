...
type ApigeeSecurityMonitoringCondition_Include_Resources struct {
	Name any
	Type any
}

type ApigeeSecurityMonitoringCondition_Include struct {
	// Required. The array of resources. For Apigee, the proxies are resources.
	Resources any
}

var ApigeeSecurityMonitoringCondition_Include_ResourcesFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var ApigeeSecurityMonitoringCondition_IncludeFields = ubx.FieldMap{
...
type ApigeeSecurityMonitoringConditionAttrs struct {
	// Optional. The API Hub gateway monitored by the security monitoring condition. This should only be set if risk_assessment_type is API_HUB. Format: `projects/{project}/locations/{location}/plugins/{plugin}/instances/{instance}`
	ApiHubGateway any
	// Output only. The time of the security monitoring condition creation.
	CreateTime any
...
var ApigeeSecurityMonitoringCondition = ubx.ResourceBinding{
