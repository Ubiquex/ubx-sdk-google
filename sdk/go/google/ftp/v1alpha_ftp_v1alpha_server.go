...
type V1alphaFtpV1alphaServer_ExternalConfig struct {
...
type V1alphaFtpV1alphaServer_GoogleManagedServerCredential struct {
...
type V1alphaFtpV1alphaServer_InternalConfig_ConsumerAcceptList struct {
	ConnectionLimit any
	Project any
}

type V1alphaFtpV1alphaServer_InternalConfig_ConsumerRejectList struct {
	Project any
}

type V1alphaFtpV1alphaServer_InternalConfig_PscEndpoints struct {
	Endpoint any
	Network any
	Status any
}

type V1alphaFtpV1alphaServer_InternalConfig struct {
...
var V1alphaFtpV1alphaServer_ExternalConfigFields = ubx.FieldMap{
		"AllowedCidrBlocks": ubx.FieldSpec{WireName: "allowed_cidr_blocks"},
		"IpAddress": ubx.FieldSpec{WireName: "ip_address"},
	}

var V1alphaFtpV1alphaServer_GoogleManagedServerCredentialFields = ubx.FieldMap{
		"AsymmetricAlgorithm": ubx.FieldSpec{WireName: "asymmetric_algorithm"},
		"Fingerprint": ubx.FieldSpec{WireName: "fingerprint"},
	}

var V1alphaFtpV1alphaServer_InternalConfig_ConsumerAcceptListFields = ubx.FieldMap{
		"ConnectionLimit": ubx.FieldSpec{WireName: "connection_limit"},
		"Project": ubx.FieldSpec{WireName: "project"},
	}

var V1alphaFtpV1alphaServer_InternalConfig_ConsumerRejectListFields = ubx.FieldMap{
		"Project": ubx.FieldSpec{WireName: "project"},
	}

var V1alphaFtpV1alphaServer_InternalConfig_PscEndpointsFields = ubx.FieldMap{
		"Endpoint": ubx.FieldSpec{WireName: "endpoint"},
		"Network": ubx.FieldSpec{WireName: "network"},
		"Status": ubx.FieldSpec{WireName: "status"},
	}

var V1alphaFtpV1alphaServer_InternalConfigFields = ubx.FieldMap{
...
type V1alphaFtpV1alphaServerConfig struct {
...
type V1alphaFtpV1alphaServerAttrs struct {
	// Required. The access type of the Server.
	AccessType any
	// Output only. [Output only] Create time stamp
	CreateTime any
...
var V1alphaFtpV1alphaServer = ubx.ResourceBinding{
