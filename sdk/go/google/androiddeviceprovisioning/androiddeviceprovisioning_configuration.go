...
type AndroiddeviceprovisioningConfigurationConfig struct {
...
type AndroiddeviceprovisioningConfigurationAttrs struct {
	// Required. The name of the organization. Zero-touch enrollment shows this organization name to device users during device provisioning.
	CompanyName any
	// Output only. The ID of the configuration. Assigned by the server.
	ConfigurationId any
...
var AndroiddeviceprovisioningConfiguration = ubx.ResourceBinding{
