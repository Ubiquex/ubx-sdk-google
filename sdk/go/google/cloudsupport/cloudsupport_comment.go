...
type CloudsupportComment_Creator struct {
...
var CloudsupportComment_CreatorFields = ubx.FieldMap{
...
type CloudsupportCommentConfig struct {
...
type CloudsupportCommentAttrs struct {
	// The full comment body. Maximum of 12800 characters.
	Body any
	// Output only. The time when the comment was created.
	CreateTime any
...
var CloudsupportComment = ubx.ResourceBinding{
