...
type V2betaCloudsupportV2betaCase_Classification_Product struct {
	// The product line of the Product.
	ProductLine any
}

type V2betaCloudsupportV2betaCase_Classification struct {
...
type V2betaCloudsupportV2betaCase_Creator struct {
...
var V2betaCloudsupportV2betaCase_Classification_ProductFields = ubx.FieldMap{
		"ProductLine": ubx.FieldSpec{WireName: "product_line"},
	}

var V2betaCloudsupportV2betaCase_ClassificationFields = ubx.FieldMap{
...
var V2betaCloudsupportV2betaCase_CreatorFields = ubx.FieldMap{
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
...
type V2betaCloudsupportV2betaCaseConfig struct {
...
type V2betaCloudsupportV2betaCaseAttrs struct {
	// A Case Classification represents the topic that a case is about. It's very important to use accurate classifications, because they're used to route your cases to specialists who can help you. A classification always has an ID that is its unique identifier. A valid ID is required when creating a case.
	Classification any
	// A user-supplied email address to send case update notifications for. This should only be used in BYOID flows, where we cannot infer the user's email address directly from their EUCs.
	ContactEmail any
...
var V2betaCloudsupportV2betaCase = ubx.ResourceBinding{
