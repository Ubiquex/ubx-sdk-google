...
type V2betaCloudsupportV2betaComment_Creator struct {
...
var V2betaCloudsupportV2betaComment_CreatorFields = ubx.FieldMap{
...
type V2betaCloudsupportV2betaCommentConfig struct {
...
type V2betaCloudsupportV2betaCommentAttrs struct {
	// The full comment body. Maximum of 12800 characters.
	Body any
	// Output only. The time when the comment was created.
	CreateTime any
...
var V2betaCloudsupportV2betaComment = ubx.ResourceBinding{
