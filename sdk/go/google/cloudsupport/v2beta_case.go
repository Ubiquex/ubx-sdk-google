...
type V2betaCase_Classification_Product struct {
	// The product line of the Product.
	ProductLine any
}

type V2betaCase_Classification struct {
...
type V2betaCase_Creator struct {
...
var V2betaCase = ubx.ResourceBinding{
