...
type HealthcareDataset_EncryptionSpec struct {
...
var HealthcareDataset_EncryptionSpecFields = ubx.FieldMap{
...
type HealthcareDatasetAttrs struct {
	// Represents a customer-managed encryption key spec that can be applied to a resource.
	EncryptionSpec any
	// Identifier. Resource name of the dataset, of the form `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}`.
	Name any
...
var HealthcareDataset = ubx.ResourceBinding{
