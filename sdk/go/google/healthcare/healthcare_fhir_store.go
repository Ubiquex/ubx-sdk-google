...
type HealthcareFhirStore_BulkExportGcsDestination struct {
	// Optional. URI for a Cloud Storage directory where the server writes result files, in the format `gs://{bucket-id}/{path/to/destination/dir}`. If there is no trailing slash, the service appends one when composing the object path. The user is responsible for creating the Cloud Storage bucket referenced in `uri_prefix`.
	UriPrefix any
}

type HealthcareFhirStore_ConsentConfig_AccessDeterminationLogConfig struct {
	// Optional. Controls the amount of detail to include as part of the audit logs.
	LogLevel any
}

type HealthcareFhirStore_ConsentConfig_ConsentHeaderHandling struct {
...
type HealthcareFhirStore_ConsentConfig struct {
...
type HealthcareFhirStore_NotificationConfig struct {
...
type HealthcareFhirStore_NotificationConfigs struct {
	PubsubTopic any
	SendFullResource any
	SendPreviousResourceOnDelete any
}

type HealthcareFhirStore_StreamConfigs_BigqueryDestination_SchemaConfig_LastUpdatedPartitionConfig struct {
	ExpirationMs any
	Type any
}

type HealthcareFhirStore_StreamConfigs_BigqueryDestination_SchemaConfig struct {
	LastUpdatedPartitionConfig any
	RecursiveStructureDepth any
	SchemaType any
}

type HealthcareFhirStore_StreamConfigs_BigqueryDestination struct {
	DatasetUri any
	Force any
	SchemaConfig any
...
type HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Dicom_KeepList struct {
	Tags any
}

type HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Dicom struct {
	FilterProfile any
	KeepList any
	RemoveList any
	SkipIdRedaction any
...
type HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Fhir_FieldMetadataList struct {
	Action any
	Paths any
}

type HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Fhir struct {
	DefaultKeepExtensions any
	FieldMetadataList any
}

type HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Image struct {
	TextRedactionMode any
}

type HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Text_AdditionalTransformations_CharacterMaskConfig struct {
	MaskingCharacter any
}

type HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Text_AdditionalTransformations_CryptoHashConfig_KmsWrapped struct {
	CryptoKey any
	WrappedKey any
}

type HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Text_AdditionalTransformations_CryptoHashConfig struct {
	CryptoKey any
	KmsWrapped any
}

type HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Text_AdditionalTransformations struct {
...
type HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Text struct {
	AdditionalTransformations any
	ExcludeInfoTypes any
	Transformations any
}

type HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config struct {
	Dicom any
	Fhir any
	Image any
	Text any
...
type HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination struct {
	Config any
	Store any
}

type HealthcareFhirStore_StreamConfigs struct {
	BigqueryDestination any
	DeidentifiedStoreDestination any
	ResourceTypes any
}

type HealthcareFhirStore_ValidationConfig struct {
...
var HealthcareFhirStore_BulkExportGcsDestinationFields = ubx.FieldMap{
		"UriPrefix": ubx.FieldSpec{WireName: "uri_prefix"},
	}

var HealthcareFhirStore_ConsentConfig_AccessDeterminationLogConfigFields = ubx.FieldMap{
		"LogLevel": ubx.FieldSpec{WireName: "log_level"},
	}

var HealthcareFhirStore_ConsentConfig_ConsentHeaderHandlingFields = ubx.FieldMap{
		"Profile": ubx.FieldSpec{WireName: "profile"},
	}

var HealthcareFhirStore_ConsentConfigFields = ubx.FieldMap{
...
var HealthcareFhirStore_NotificationConfigFields = ubx.FieldMap{
		"PubsubTopic": ubx.FieldSpec{WireName: "pubsub_topic"},
		"SendForBulkImport": ubx.FieldSpec{WireName: "send_for_bulk_import"},
	}

var HealthcareFhirStore_NotificationConfigsFields = ubx.FieldMap{
		"PubsubTopic": ubx.FieldSpec{WireName: "pubsub_topic"},
...
var HealthcareFhirStore_StreamConfigs_BigqueryDestination_SchemaConfig_LastUpdatedPartitionConfigFields = ubx.FieldMap{
		"ExpirationMs": ubx.FieldSpec{WireName: "expiration_ms"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var HealthcareFhirStore_StreamConfigs_BigqueryDestination_SchemaConfigFields = ubx.FieldMap{
...
var HealthcareFhirStore_StreamConfigs_BigqueryDestinationFields = ubx.FieldMap{
...
var HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Dicom_KeepListFields = ubx.FieldMap{
		"Tags": ubx.FieldSpec{WireName: "tags"},
	}

var HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_DicomFields = ubx.FieldMap{
...
var HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Fhir_FieldMetadataListFields = ubx.FieldMap{
		"Action": ubx.FieldSpec{WireName: "action"},
		"Paths": ubx.FieldSpec{WireName: "paths"},
	}

var HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_FhirFields = ubx.FieldMap{
...
var HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_ImageFields = ubx.FieldMap{
		"TextRedactionMode": ubx.FieldSpec{WireName: "text_redaction_mode"},
	}

var HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Text_AdditionalTransformations_CharacterMaskConfigFields = ubx.FieldMap{
		"MaskingCharacter": ubx.FieldSpec{WireName: "masking_character"},
	}

var HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Text_AdditionalTransformations_CryptoHashConfig_KmsWrappedFields = ubx.FieldMap{
		"CryptoKey": ubx.FieldSpec{WireName: "crypto_key"},
		"WrappedKey": ubx.FieldSpec{WireName: "wrapped_key"},
	}

var HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Text_AdditionalTransformations_CryptoHashConfigFields = ubx.FieldMap{
		"CryptoKey": ubx.FieldSpec{WireName: "crypto_key"},
...
var HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_Text_AdditionalTransformationsFields = ubx.FieldMap{
...
var HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_Config_TextFields = ubx.FieldMap{
...
var HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestination_ConfigFields = ubx.FieldMap{
		"Dicom": ubx.FieldSpec{
			WireName: "dicom",
			Kind: "object",
...
var HealthcareFhirStore_StreamConfigs_DeidentifiedStoreDestinationFields = ubx.FieldMap{
...
var HealthcareFhirStore_StreamConfigsFields = ubx.FieldMap{
...
var HealthcareFhirStore_ValidationConfigFields = ubx.FieldMap{
...
type HealthcareFhirStoreAttrs struct {
	// The configuration for exporting to Cloud Storage using the bulk export API.
	BulkExportGcsDestination any
	// Optional. Enable parsing of references within complex FHIR data types such as Extensions. If this value is set to ENABLED, then features like referential integrity and Bundle reference rewriting apply to all references. If this flag has not been specified the behavior of the FHIR store will not change, references in complex data types will not be parsed. New stores will have this value set to ENABLED after a notification period. Warning: turning on this flag causes processing existing resources to fail if they contain references to non-existent resources. Cannot be disabled in R5.
	ComplexDataTypeReferenceParsing any
...
var HealthcareFhirStore = ubx.ResourceBinding{
