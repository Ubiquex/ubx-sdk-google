...
type V1beta1HealthcareV1beta1Dataset_EncryptionSpec struct {
...
var V1beta1HealthcareV1beta1Dataset_EncryptionSpecFields = ubx.FieldMap{
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

type V1beta1HealthcareV1beta1DatasetConfig struct {
...
type V1beta1HealthcareV1beta1DatasetAttrs struct {
	// Represents a customer-managed encryption key spec that can be applied to a resource.
	EncryptionSpec any
	// Identifier. Resource name of the dataset, of the form `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}`.
	Name any
...
var V1beta1HealthcareV1beta1Dataset = ubx.ResourceBinding{
