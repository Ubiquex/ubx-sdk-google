...
type V2alphaCloudfunctionsV2alphaFunction_BuildConfig_OnDeployUpdatePolicy struct {
	// Output only. contains the runtime version which was used during latest function deployment.
	RuntimeVersion any
}

type V2alphaCloudfunctionsV2alphaFunction_BuildConfig_Source_RepoSource struct {
...
type V2alphaCloudfunctionsV2alphaFunction_BuildConfig_Source_StorageSource struct {
...
type V2alphaCloudfunctionsV2alphaFunction_BuildConfig_Source struct {
...
type V2alphaCloudfunctionsV2alphaFunction_BuildConfig_SourceProvenance struct {
...
type V2alphaCloudfunctionsV2alphaFunction_BuildConfig struct {
...
type V2alphaCloudfunctionsV2alphaFunction_EventTrigger_EventFilters struct {
	Attribute any
	Operator any
	Value any
}

type V2alphaCloudfunctionsV2alphaFunction_EventTrigger struct {
...
type V2alphaCloudfunctionsV2alphaFunction_ServiceConfig_DirectVpcNetworkInterface struct {
	Network any
	Subnetwork any
	Tags any
}

type V2alphaCloudfunctionsV2alphaFunction_ServiceConfig_SecretEnvironmentVariables struct {
	Key any
	ProjectId any
	Secret any
	Version any
...
type V2alphaCloudfunctionsV2alphaFunction_ServiceConfig_SecretVolumes_Versions struct {
	Path any
	Version any
}

type V2alphaCloudfunctionsV2alphaFunction_ServiceConfig_SecretVolumes struct {
	MountPath any
	ProjectId any
	Secret any
	Versions any
...
type V2alphaCloudfunctionsV2alphaFunction_ServiceConfig struct {
...
type V2alphaCloudfunctionsV2alphaFunction_StateMessages struct {
	Message any
	Severity any
	Type any
}

type V2alphaCloudfunctionsV2alphaFunction_UpgradeInfo struct {
...
var V2alphaCloudfunctionsV2alphaFunction_BuildConfig_OnDeployUpdatePolicyFields = ubx.FieldMap{
		"RuntimeVersion": ubx.FieldSpec{WireName: "runtime_version"},
	}

var V2alphaCloudfunctionsV2alphaFunction_BuildConfig_Source_RepoSourceFields = ubx.FieldMap{
...
var V2alphaCloudfunctionsV2alphaFunction_BuildConfig_Source_StorageSourceFields = ubx.FieldMap{
...
var V2alphaCloudfunctionsV2alphaFunction_BuildConfig_SourceFields = ubx.FieldMap{
...
var V2alphaCloudfunctionsV2alphaFunction_BuildConfig_SourceProvenanceFields = ubx.FieldMap{
		"GitUri": ubx.FieldSpec{WireName: "git_uri"},
...
var V2alphaCloudfunctionsV2alphaFunction_BuildConfigFields = ubx.FieldMap{
...
var V2alphaCloudfunctionsV2alphaFunction_EventTrigger_EventFiltersFields = ubx.FieldMap{
		"Attribute": ubx.FieldSpec{WireName: "attribute"},
		"Operator": ubx.FieldSpec{WireName: "operator"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var V2alphaCloudfunctionsV2alphaFunction_EventTriggerFields = ubx.FieldMap{
...
var V2alphaCloudfunctionsV2alphaFunction_ServiceConfig_DirectVpcNetworkInterfaceFields = ubx.FieldMap{
		"Network": ubx.FieldSpec{WireName: "network"},
		"Subnetwork": ubx.FieldSpec{WireName: "subnetwork"},
		"Tags": ubx.FieldSpec{WireName: "tags"},
	}

var V2alphaCloudfunctionsV2alphaFunction_ServiceConfig_SecretEnvironmentVariablesFields = ubx.FieldMap{
...
var V2alphaCloudfunctionsV2alphaFunction_ServiceConfig_SecretVolumes_VersionsFields = ubx.FieldMap{
		"Path": ubx.FieldSpec{WireName: "path"},
		"Version": ubx.FieldSpec{WireName: "version"},
	}

var V2alphaCloudfunctionsV2alphaFunction_ServiceConfig_SecretVolumesFields = ubx.FieldMap{
...
var V2alphaCloudfunctionsV2alphaFunction_ServiceConfigFields = ubx.FieldMap{
...
var V2alphaCloudfunctionsV2alphaFunction_StateMessagesFields = ubx.FieldMap{
		"Message": ubx.FieldSpec{WireName: "message"},
		"Severity": ubx.FieldSpec{WireName: "severity"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var V2alphaCloudfunctionsV2alphaFunction_UpgradeInfoFields = ubx.FieldMap{
...
type V2alphaCloudfunctionsV2alphaFunctionConfig struct {
	// Describes the Build step of the function that builds a container from the given source.
	BuildConfig any
...
type V2alphaCloudfunctionsV2alphaFunctionAttrs struct {
	// Describes the Build step of the function that builds a container from the given source.
	BuildConfig any
	// Output only. The create timestamp of a Cloud Function. This is only applicable to 2nd Gen functions.
	CreateTime any
...
var V2alphaCloudfunctionsV2alphaFunction = ubx.ResourceBinding{
