...
type V2betaFunction_BuildConfig_OnDeployUpdatePolicy struct {
	// Output only. contains the runtime version which was used during latest function deployment.
	RuntimeVersion any
}

type V2betaFunction_BuildConfig_Source_RepoSource struct {
...
type V2betaFunction_BuildConfig_Source_StorageSource struct {
...
type V2betaFunction_BuildConfig_Source struct {
...
type V2betaFunction_BuildConfig_SourceProvenance struct {
...
type V2betaFunction_BuildConfig struct {
...
var V2betaFunction_StateMessagesFields = ubx.FieldMap{
...
type V2betaFunctionAttrs struct {
	// Describes the Build step of the function that builds a container from the given source.
	BuildConfig any
	// Output only. The create timestamp of a Cloud Function. This is only applicable to 2nd Gen functions.
	CreateTime any
...
var V2betaFunction = ubx.ResourceBinding{
