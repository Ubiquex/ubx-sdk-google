...
type V1betaWorkstationCluster_DomainConfig struct {
	// Immutable. Domain used by Workstations for HTTP ingress.
	Domain any
}

type V1betaWorkstationCluster_GatewayConfig struct {
	// Optional. Whether HTTP/2 is enabled for this workstation cluster. Defaults to false.
	Http2Enabled any
}

type V1betaWorkstationCluster_PrivateClusterConfig struct {
...
type V1betaWorkstationClusterAttrs struct {
	// Optional. Client-specified annotations.
	Annotations any
	// Output only. Status conditions describing the workstation cluster's current state.
	Conditions any
