...
type WorkstationsWorkstationCluster_Conditions struct {
	Code any
	Details any
	Message any
}

type WorkstationsWorkstationCluster_DomainConfig struct {
	// Immutable. Domain used by Workstations for HTTP ingress.
	Domain any
}

type WorkstationsWorkstationCluster_GatewayConfig struct {
	// Optional. Whether HTTP/2 is enabled for this workstation cluster. Defaults to false.
	Http2Enabled any
}

type WorkstationsWorkstationCluster_PrivateClusterConfig struct {
...
var WorkstationsWorkstationCluster_ConditionsFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var WorkstationsWorkstationCluster_DomainConfigFields = ubx.FieldMap{
		"Domain": ubx.FieldSpec{WireName: "domain"},
	}

var WorkstationsWorkstationCluster_GatewayConfigFields = ubx.FieldMap{
		"Http2Enabled": ubx.FieldSpec{WireName: "http2_enabled"},
	}

var WorkstationsWorkstationCluster_PrivateClusterConfigFields = ubx.FieldMap{
...
type WorkstationsWorkstationClusterAttrs struct {
	// Optional. Client-specified annotations.
	Annotations any
	// Output only. Status conditions describing the workstation cluster's current state.
	Conditions any
...
var WorkstationsWorkstationCluster = ubx.ResourceBinding{
