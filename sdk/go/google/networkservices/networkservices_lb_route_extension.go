...
type NetworkservicesLbRouteExtension_ExtensionChains_Extensions struct {
	Authority any
	FailOpen any
...
type NetworkservicesLbRouteExtension_ExtensionChains_MatchCondition struct {
	CelExpression any
}

type NetworkservicesLbRouteExtension_ExtensionChains struct {
	Extensions any
	MatchCondition any
	Name any
}

var NetworkservicesLbRouteExtension_ExtensionChains_ExtensionsFields = ubx.FieldMap{
...
var NetworkservicesLbRouteExtension_ExtensionChains_MatchConditionFields = ubx.FieldMap{
		"CelExpression": ubx.FieldSpec{WireName: "cel_expression"},
	}

var NetworkservicesLbRouteExtension_ExtensionChainsFields = ubx.FieldMap{
...
type NetworkservicesLbRouteExtensionAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A human-readable description of the resource.
	Description any
...
var NetworkservicesLbRouteExtension = ubx.ResourceBinding{
