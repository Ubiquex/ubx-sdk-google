...
type NetworkservicesWasmPlugin_LogConfig struct {
...
type NetworkservicesWasmPlugin_UsedBy struct {
	Name any
}

type NetworkservicesWasmPlugin_Versions struct {
	CreateTime any
	Description any
	ImageDigest any
	ImageUri any
...
var NetworkservicesWasmPlugin_LogConfigFields = ubx.FieldMap{
...
var NetworkservicesWasmPlugin_UsedByFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var NetworkservicesWasmPlugin_VersionsFields = ubx.FieldMap{
...
type NetworkservicesWasmPluginAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A human-readable description of the resource.
	Description any
...
var NetworkservicesWasmPlugin = ubx.ResourceBinding{
