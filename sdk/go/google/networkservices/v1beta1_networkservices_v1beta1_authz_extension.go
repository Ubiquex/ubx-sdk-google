...
type V1beta1NetworkservicesV1beta1AuthzExtensionConfig struct {
...
type V1beta1NetworkservicesV1beta1AuthzExtensionAttrs struct {
	// Optional. The `:authority` header in the gRPC request sent from Envoy to the extension service. It is required when the `service` field points to a backend service.
	Authority any
	// Output only. The timestamp when the resource was created.
	CreateTime any
...
var V1beta1NetworkservicesV1beta1AuthzExtension = ubx.ResourceBinding{
