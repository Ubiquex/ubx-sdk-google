...
type V1beta1NetworkservicesV1beta1LbEdgeExtension_ExtensionChains_Extensions struct {
...
type V1beta1NetworkservicesV1beta1LbEdgeExtension_ExtensionChains_MatchCondition struct {
	CelExpression any
}

type V1beta1NetworkservicesV1beta1LbEdgeExtension_ExtensionChains struct {
	Extensions any
	MatchCondition any
	Name any
}

var V1beta1NetworkservicesV1beta1LbEdgeExtension_ExtensionChains_ExtensionsFields = ubx.FieldMap{
...
var V1beta1NetworkservicesV1beta1LbEdgeExtension_ExtensionChains_MatchConditionFields = ubx.FieldMap{
		"CelExpression": ubx.FieldSpec{WireName: "cel_expression"},
	}

var V1beta1NetworkservicesV1beta1LbEdgeExtension_ExtensionChainsFields = ubx.FieldMap{
...
type V1beta1NetworkservicesV1beta1LbEdgeExtensionConfig struct {
...
type V1beta1NetworkservicesV1beta1LbEdgeExtensionAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A human-readable description of the resource.
	Description any
...
var V1beta1NetworkservicesV1beta1LbEdgeExtension = ubx.ResourceBinding{
