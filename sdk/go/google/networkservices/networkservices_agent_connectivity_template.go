...
type NetworkservicesAgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfig struct {
...
type NetworkservicesAgentConnectivityTemplate_EgressNetworkConfig struct {
...
var NetworkservicesAgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfigFields = ubx.FieldMap{
		"Domain": ubx.FieldSpec{WireName: "domain"},
		"TargetNetwork": ubx.FieldSpec{WireName: "target_network"},
	}

var NetworkservicesAgentConnectivityTemplate_EgressNetworkConfigFields = ubx.FieldMap{
...
type NetworkservicesAgentConnectivityTemplateConfig struct {
...
type NetworkservicesAgentConnectivityTemplateAttrs struct {
	// Required. Immutable. The path of the access. Maps roughly to ingress/egress, though we keep CLIENT_TO_AGENT and AGENT_TO_ANYWHERE as carryovers from Agent Gateway's original resource model. The path is immutable once set. Exactly one path can be set.
	AccessPath any
	// Optional. The types of network access provided to the gateway. Both PUBLIC and PRIVATE can be configured.
	AccessTypes any
...
var NetworkservicesAgentConnectivityTemplate = ubx.ResourceBinding{
