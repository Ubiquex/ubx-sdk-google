...
type NetworkservicesMulticastConsumerAssociation_State struct {
	// Optional. The state of the multicast resource.
	State any
}

var NetworkservicesMulticastConsumerAssociation_StateFields = ubx.FieldMap{
...
type NetworkservicesMulticastConsumerAssociationAttrs struct {
	// Output only. [Output only] The timestamp when the multicast consumer association was created.
	CreateTime any
	// Optional. An optional text description of the multicast consumer association.
	Description any
...
var NetworkservicesMulticastConsumerAssociation = ubx.ResourceBinding{
