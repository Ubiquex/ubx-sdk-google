...
type V1beta1NetworkservicesV1beta1ExtensionBinding_MatchConditions_To_Destination_HeaderSet_Headers_Value struct {
	Contains any
	Exact any
	IgnoreCase any
	Prefix any
...
type V1beta1NetworkservicesV1beta1ExtensionBinding_MatchConditions_To_Destination_HeaderSet_Headers struct {
	Name any
	Value any
}

type V1beta1NetworkservicesV1beta1ExtensionBinding_MatchConditions_To_Destination_HeaderSet struct {
	Headers any
}

type V1beta1NetworkservicesV1beta1ExtensionBinding_MatchConditions_To_Destination struct {
	HeaderSet any
	Hosts any
	Paths any
	Resources any
...
type V1beta1NetworkservicesV1beta1ExtensionBinding_MatchConditions_To struct {
	Destination any
	NotDestination any
}

type V1beta1NetworkservicesV1beta1ExtensionBinding_MatchConditions struct {
	To any
}

type V1beta1NetworkservicesV1beta1ExtensionBinding_Target_Scope struct {
...
type V1beta1NetworkservicesV1beta1ExtensionBinding_Target struct {
...
var V1beta1NetworkservicesV1beta1ExtensionBinding_MatchConditions_To_Destination_HeaderSet_Headers_ValueFields = ubx.FieldMap{
...
var V1beta1NetworkservicesV1beta1ExtensionBinding_MatchConditions_To_Destination_HeaderSet_HeadersFields = ubx.FieldMap{
...
var V1beta1NetworkservicesV1beta1ExtensionBinding_MatchConditions_To_Destination_HeaderSetFields = ubx.FieldMap{
...
var V1beta1NetworkservicesV1beta1ExtensionBinding_MatchConditions_To_DestinationFields = ubx.FieldMap{
...
var V1beta1NetworkservicesV1beta1ExtensionBinding_MatchConditions_ToFields = ubx.FieldMap{
...
var V1beta1NetworkservicesV1beta1ExtensionBinding_MatchConditionsFields = ubx.FieldMap{
		"To": ubx.FieldSpec{
			WireName: "to",
			Kind: "object",
...
var V1beta1NetworkservicesV1beta1ExtensionBinding_Target_ScopeFields = ubx.FieldMap{
		"Parent": ubx.FieldSpec{WireName: "parent"},
		"ResourceTypes": ubx.FieldSpec{WireName: "resource_types"},
	}

var V1beta1NetworkservicesV1beta1ExtensionBinding_TargetFields = ubx.FieldMap{
...
type V1beta1NetworkservicesV1beta1ExtensionBindingConfig struct {
...
type V1beta1NetworkservicesV1beta1ExtensionBindingAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A human-readable description of the resource.
	Description any
...
var V1beta1NetworkservicesV1beta1ExtensionBinding = ubx.ResourceBinding{
