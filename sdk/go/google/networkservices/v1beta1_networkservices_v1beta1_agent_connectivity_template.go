...
type V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfig struct {
...
type V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfig struct {
...
var V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfigFields = ubx.FieldMap{
		"Domain": ubx.FieldSpec{WireName: "domain"},
		"TargetNetwork": ubx.FieldSpec{WireName: "target_network"},
	}

var V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfigFields = ubx.FieldMap{
...
type V1beta1NetworkservicesV1beta1AgentConnectivityTemplateConfig struct {
...
type V1beta1NetworkservicesV1beta1AgentConnectivityTemplateAttrs struct {
	// Required. Immutable. The path of the access. Maps roughly to ingress/egress, though we keep CLIENT_TO_AGENT and AGENT_TO_ANYWHERE as carryovers from Agent Gateway's original resource model. The path is immutable once set. Exactly one path can be set.
	AccessPath any
	// Optional. The types of network access provided to the gateway. Both PUBLIC and PRIVATE can be configured.
	AccessTypes any
...
var V1beta1NetworkservicesV1beta1AgentConnectivityTemplate = ubx.ResourceBinding{
