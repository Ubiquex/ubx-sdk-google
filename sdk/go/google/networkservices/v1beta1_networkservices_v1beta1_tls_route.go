...
type V1beta1NetworkservicesV1beta1TlsRoute_Rules_Action_Destinations struct {
	ServiceName any
	Weight any
}

type V1beta1NetworkservicesV1beta1TlsRoute_Rules_Action struct {
	Destinations any
	IdleTimeout any
}

type V1beta1NetworkservicesV1beta1TlsRoute_Rules_Matches struct {
	Alpn any
	SniHost any
}

type V1beta1NetworkservicesV1beta1TlsRoute_Rules struct {
	Action any
	Matches any
}

var V1beta1NetworkservicesV1beta1TlsRoute_Rules_Action_DestinationsFields = ubx.FieldMap{
		"ServiceName": ubx.FieldSpec{WireName: "service_name"},
		"Weight": ubx.FieldSpec{WireName: "weight"},
	}

var V1beta1NetworkservicesV1beta1TlsRoute_Rules_ActionFields = ubx.FieldMap{
...
var V1beta1NetworkservicesV1beta1TlsRoute_Rules_MatchesFields = ubx.FieldMap{
		"Alpn": ubx.FieldSpec{WireName: "alpn"},
		"SniHost": ubx.FieldSpec{WireName: "sni_host"},
	}

var V1beta1NetworkservicesV1beta1TlsRoute_RulesFields = ubx.FieldMap{
...
type V1beta1NetworkservicesV1beta1TlsRouteConfig struct {
...
type V1beta1NetworkservicesV1beta1TlsRouteAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A free-text description of the resource. Max length 1024 characters.
	Description any
...
var V1beta1NetworkservicesV1beta1TlsRoute = ubx.ResourceBinding{
