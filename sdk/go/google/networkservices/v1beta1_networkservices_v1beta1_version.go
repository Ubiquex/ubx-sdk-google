...
type V1beta1NetworkservicesV1beta1VersionConfig struct {
...
type V1beta1NetworkservicesV1beta1VersionAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A human-readable description of the resource.
	Description any
...
var V1beta1NetworkservicesV1beta1Version = ubx.ResourceBinding{
