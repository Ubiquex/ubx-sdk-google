...
type NetworkservicesTcpRoute_Rules_Action_Destinations struct {
	ServiceName any
	Weight any
}

type NetworkservicesTcpRoute_Rules_Action struct {
	Destinations any
	IdleTimeout any
	OriginalDestination any
}

type NetworkservicesTcpRoute_Rules_Matches struct {
	Address any
	Port any
}

type NetworkservicesTcpRoute_Rules struct {
	Action any
	Matches any
}

var NetworkservicesTcpRoute_Rules_Action_DestinationsFields = ubx.FieldMap{
		"ServiceName": ubx.FieldSpec{WireName: "service_name"},
		"Weight": ubx.FieldSpec{WireName: "weight"},
	}

var NetworkservicesTcpRoute_Rules_ActionFields = ubx.FieldMap{
...
var NetworkservicesTcpRoute_Rules_MatchesFields = ubx.FieldMap{
		"Address": ubx.FieldSpec{WireName: "address"},
		"Port": ubx.FieldSpec{WireName: "port"},
	}

var NetworkservicesTcpRoute_RulesFields = ubx.FieldMap{
...
type NetworkservicesTcpRouteAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A free-text description of the resource. Max length 1024 characters.
	Description any
...
var NetworkservicesTcpRoute = ubx.ResourceBinding{
