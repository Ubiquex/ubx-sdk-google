...
type V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_Extensions struct {
...
type V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_MatchCondition struct {
	CelExpression any
}

type V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains struct {
	Extensions any
	MatchCondition any
	Name any
}

var V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_ExtensionsFields = ubx.FieldMap{
...
var V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_MatchConditionFields = ubx.FieldMap{
		"CelExpression": ubx.FieldSpec{WireName: "cel_expression"},
	}

var V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChainsFields = ubx.FieldMap{
...
type V1beta1NetworkservicesV1beta1LbTrafficExtensionConfig struct {
...
type V1beta1NetworkservicesV1beta1LbTrafficExtensionAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A human-readable description of the resource.
	Description any
...
var V1beta1NetworkservicesV1beta1LbTrafficExtension = ubx.ResourceBinding{
