...
type V1beta1AgentGateway_AgentGatewayCard struct {
...
type V1beta1AgentGateway_GoogleManaged struct {
	// Optional. Operating Mode of Agent Gateway.
	GovernedAccessPath any
}

type V1beta1AgentGateway_NetworkConfig_DnsPeeringConfig struct {
...
type V1beta1AgentGateway_NetworkConfig_Egress struct {
	// Optional. The URI of the Network Attachment resource.
	NetworkAttachment any
}

type V1beta1AgentGateway_NetworkConfig struct {
...
type V1beta1AgentGateway_SelfManaged struct {
...
var V1beta1AgentGateway_AgentGatewayCardFields = ubx.FieldMap{
...
var V1beta1AgentGateway_GoogleManagedFields = ubx.FieldMap{
	"GovernedAccessPath": ubx.FieldSpec{WireName: "governed_access_path"},
}

var V1beta1AgentGateway_NetworkConfig_DnsPeeringConfigFields = ubx.FieldMap{
...
var V1beta1AgentGateway_NetworkConfig_EgressFields = ubx.FieldMap{
	"NetworkAttachment": ubx.FieldSpec{WireName: "network_attachment"},
}

var V1beta1AgentGateway_NetworkConfigFields = ubx.FieldMap{
...
type V1beta1AgentGatewayAttrs struct {
	// Optional. The resource name of the AgentConnectivityTemplate. Format: projects/{project}/locations/{location}/agentConnectivityTemplates/{template}
	AgentConnectivityTemplate any
	// AgentGatewayOutputCard contains informational output-only fields
	AgentGatewayCard any
...
var V1beta1AgentGateway = ubx.ResourceBinding{
