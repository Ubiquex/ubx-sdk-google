...
type V1beta1NetworkservicesV1beta1ServiceBindingConfig struct {
...
type V1beta1NetworkservicesV1beta1ServiceBindingAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A free-text description of the resource. Max length 1024 characters.
	Description any
...
var V1beta1NetworkservicesV1beta1ServiceBinding = ubx.ResourceBinding{
