...
type NetworkservicesServiceLbPolicy_AutoCapacityDrain struct {
...
type NetworkservicesServiceLbPolicy_FailoverConfig struct {
	// Optional. The percentage threshold that a load balancer will begin to send traffic to failover backends. If the percentage of endpoints in a MIG/NEG is smaller than this value, traffic would be sent to failover backends if possible. This field should be set to a value between 1 and 99. The default value is 50 for Global external HTTP(S) load balancer (classic) and Proxyless service mesh, and 70 for others.
	FailoverHealthThreshold any
}

type NetworkservicesServiceLbPolicy_IsolationConfig struct {
...
var NetworkservicesServiceLbPolicy_AutoCapacityDrainFields = ubx.FieldMap{
		"Enable": ubx.FieldSpec{WireName: "enable"},
	}

var NetworkservicesServiceLbPolicy_FailoverConfigFields = ubx.FieldMap{
		"FailoverHealthThreshold": ubx.FieldSpec{WireName: "failover_health_threshold"},
	}

var NetworkservicesServiceLbPolicy_IsolationConfigFields = ubx.FieldMap{
		"IsolationGranularity": ubx.FieldSpec{WireName: "isolation_granularity"},
		"IsolationMode": ubx.FieldSpec{WireName: "isolation_mode"},
	}

type NetworkservicesServiceLbPolicyConfig struct {
...
type NetworkservicesServiceLbPolicyAttrs struct {
	// Option to specify if an unhealthy IG/NEG should be considered for global load balancing and traffic routing.
	AutoCapacityDrain any
	// Output only. The timestamp when this resource was created.
	CreateTime any
...
var NetworkservicesServiceLbPolicy = ubx.ResourceBinding{
