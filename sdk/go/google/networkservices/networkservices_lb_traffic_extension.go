...
type NetworkservicesLbTrafficExtension_ExtensionChains_Extensions struct {
	Authority any
	FailOpen any
...
type NetworkservicesLbTrafficExtension_ExtensionChains_MatchCondition struct {
	CelExpression any
}

type NetworkservicesLbTrafficExtension_ExtensionChains struct {
	Extensions any
	MatchCondition any
	Name any
}

var NetworkservicesLbTrafficExtension_ExtensionChains_ExtensionsFields = ubx.FieldMap{
...
var NetworkservicesLbTrafficExtension_ExtensionChains_MatchConditionFields = ubx.FieldMap{
		"CelExpression": ubx.FieldSpec{WireName: "cel_expression"},
	}

var NetworkservicesLbTrafficExtension_ExtensionChainsFields = ubx.FieldMap{
...
type NetworkservicesLbTrafficExtensionAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A human-readable description of the resource.
	Description any
...
var NetworkservicesLbTrafficExtension = ubx.ResourceBinding{
