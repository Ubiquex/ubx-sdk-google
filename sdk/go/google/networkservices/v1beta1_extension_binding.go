...
type V1beta1ExtensionBinding_MatchConditions_To_Destination_HeaderSet struct {
	Headers any
}
...
type V1beta1ExtensionBinding_MatchConditions struct {
	To any
}

type V1beta1ExtensionBinding_Target_Scope struct {
...
type V1beta1ExtensionBinding_Target struct {
