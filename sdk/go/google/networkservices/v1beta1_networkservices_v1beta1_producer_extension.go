...
type V1beta1NetworkservicesV1beta1ProducerExtension_ExtensionSettings struct {
...
var V1beta1NetworkservicesV1beta1ProducerExtension_ExtensionSettingsFields = ubx.FieldMap{
...
type V1beta1NetworkservicesV1beta1ProducerExtensionConfig struct {
...
type V1beta1NetworkservicesV1beta1ProducerExtensionAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A human-readable description of the resource.
	Description any
...
var V1beta1NetworkservicesV1beta1ProducerExtension = ubx.ResourceBinding{
