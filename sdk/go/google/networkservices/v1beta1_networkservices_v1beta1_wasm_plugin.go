...
type V1beta1NetworkservicesV1beta1WasmPlugin_LogConfig struct {
...
type V1beta1NetworkservicesV1beta1WasmPlugin_UsedBy struct {
	Name any
}

type V1beta1NetworkservicesV1beta1WasmPlugin_Versions struct {
	CreateTime any
	Description any
	ImageDigest any
	ImageUri any
...
var V1beta1NetworkservicesV1beta1WasmPlugin_LogConfigFields = ubx.FieldMap{
...
var V1beta1NetworkservicesV1beta1WasmPlugin_UsedByFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

var V1beta1NetworkservicesV1beta1WasmPlugin_VersionsFields = ubx.FieldMap{
...
type V1beta1NetworkservicesV1beta1WasmPluginConfig struct {
...
type V1beta1NetworkservicesV1beta1WasmPluginAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A human-readable description of the resource.
	Description any
...
var V1beta1NetworkservicesV1beta1WasmPlugin = ubx.ResourceBinding{
