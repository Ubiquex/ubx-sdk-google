...
type NetworkservicesLbEdgeExtension_ExtensionChains_Extensions struct {
	Authority any
	FailOpen any
...
type NetworkservicesLbEdgeExtension_ExtensionChains_MatchCondition struct {
	CelExpression any
}

type NetworkservicesLbEdgeExtension_ExtensionChains struct {
	Extensions any
	MatchCondition any
	Name any
}

var NetworkservicesLbEdgeExtension_ExtensionChains_ExtensionsFields = ubx.FieldMap{
...
var NetworkservicesLbEdgeExtension_ExtensionChains_MatchConditionFields = ubx.FieldMap{
		"CelExpression": ubx.FieldSpec{WireName: "cel_expression"},
	}

var NetworkservicesLbEdgeExtension_ExtensionChainsFields = ubx.FieldMap{
...
type NetworkservicesLbEdgeExtensionAttrs struct {
	// Output only. The timestamp when the resource was created.
	CreateTime any
	// Optional. A human-readable description of the resource.
	Description any
...
var NetworkservicesLbEdgeExtension = ubx.ResourceBinding{
