...
type NetworkservicesMulticastGroupConsumerActivation_LogConfig struct {
	// Optional. Whether to enable logging or not.
	Enabled any
}

type NetworkservicesMulticastGroupConsumerActivation_State struct {
	// Optional. The state of the multicast resource.
	State any
}

var NetworkservicesMulticastGroupConsumerActivation_LogConfigFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
	}

var NetworkservicesMulticastGroupConsumerActivation_StateFields = ubx.FieldMap{
...
type NetworkservicesMulticastGroupConsumerActivationAttrs struct {
	// Output only. [Output only] The timestamp when the multicast group consumer activation was created.
	CreateTime any
	// Optional. An optional text description of the multicast group consumer activation.
	Description any
...
var NetworkservicesMulticastGroupConsumerActivation = ubx.ResourceBinding{
