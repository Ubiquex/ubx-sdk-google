...
type RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTime struct {
	Hours any
	Minutes any
	Nanos any
	Seconds any
...
type RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindow struct {
	Day any
	Duration any
	StartTime any
}

type RedisInstance_MaintenancePolicy struct {
...
type RedisInstance_MaintenanceSchedule struct {
...
type RedisInstance_Nodes struct {
	Id any
	Zone any
}

type RedisInstance_PersistenceConfig struct {
...
type RedisInstance_ServerCaCerts struct {
	Cert any
	CreateTime any
	ExpireTime any
	SerialNumber any
...
var RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTimeFields = ubx.FieldMap{
...
var RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindowFields = ubx.FieldMap{
...
var RedisInstance_MaintenancePolicyFields = ubx.FieldMap{
...
var RedisInstance_MaintenanceScheduleFields = ubx.FieldMap{
...
var RedisInstance_NodesFields = ubx.FieldMap{
		"Id": ubx.FieldSpec{WireName: "id"},
		"Zone": ubx.FieldSpec{WireName: "zone"},
	}

var RedisInstance_PersistenceConfigFields = ubx.FieldMap{
...
var RedisInstance_ServerCaCertsFields = ubx.FieldMap{
...
type RedisInstanceAttrs struct {
	// Optional. If specified, at least one node will be provisioned in this zone in addition to the zone specified in location_id. Only applicable to standard tier. If provided, it must be a different zone from the one provided in [location_id]. Additional nodes beyond the first 2 will be placed in zones selected by the service.
	AlternativeLocationId any
	// Optional. Indicates whether OSS Redis AUTH is enabled for the instance. If set to "true" AUTH is enabled on the instance. Default value is "false" meaning AUTH is disabled.
	AuthEnabled any
...
var RedisInstance = ubx.ResourceBinding{
