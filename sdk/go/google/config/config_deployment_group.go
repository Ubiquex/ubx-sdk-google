...
type ConfigDeploymentGroup_DeploymentUnits struct {
	Dependencies any
	Deployment any
	Id any
}

type ConfigDeploymentGroup_ProvisioningError struct {
...
var ConfigDeploymentGroup_DeploymentUnitsFields = ubx.FieldMap{
		"Dependencies": ubx.FieldSpec{WireName: "dependencies"},
		"Deployment": ubx.FieldSpec{WireName: "deployment"},
		"Id": ubx.FieldSpec{WireName: "id"},
	}

var ConfigDeploymentGroup_ProvisioningErrorFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

type ConfigDeploymentGroupConfig struct {
...
type ConfigDeploymentGroupAttrs struct {
	// Optional. Arbitrary key-value metadata storage e.g. to help client tools identify deployment group during automation. See https://google.aip.dev/148#annotations for details on format and size limitations.
	Annotations any
	// Output only. Time when the deployment group was created.
	CreateTime any
...
var ConfigDeploymentGroup = ubx.ResourceBinding{
