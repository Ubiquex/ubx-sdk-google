...
type V1beta1VpcaccessV1beta1Connector_Subnet struct {
...
var V1beta1VpcaccessV1beta1Connector_SubnetFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"ProjectId": ubx.FieldSpec{WireName: "project_id"},
	}

type V1beta1VpcaccessV1beta1ConnectorConfig struct {
...
type V1beta1VpcaccessV1beta1ConnectorAttrs struct {
	// Output only. List of projects using the connector.
	ConnectedProjects any
	// Output only. The creation time of the connector.
	CreateTime any
...
var V1beta1VpcaccessV1beta1Connector = ubx.ResourceBinding{
	...
	Fields: ubx.FieldMap{
		...
		"LastRestartTime": ubx.FieldSpec{WireName: "last_restart_time"},
