...
type VpcaccessConnector_Subnet struct {
...
var VpcaccessConnector_SubnetFields = ubx.FieldMap{
...
type VpcaccessConnectorAttrs struct {
	// Output only. List of projects using the connector.
	ConnectedProjects any
	// Optional. The range of internal addresses that follows RFC 4632 notation. Example: `10.132.0.0/28`.
	IpCidrRange any
...
var VpcaccessConnector = ubx.ResourceBinding{
