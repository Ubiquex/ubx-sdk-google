...
type V2betaTypeProvider_CollectionOverrides_Options_AsyncOptions_PollingOptions_Diagnostics struct {
	Field any
	Level any
}
...
type V2betaTypeProvider_Credential struct {
...
type V2betaTypeProvider_Operation_FirewallPolicyRuleOperationMetadata struct {
...
type V2betaTypeProvider_Operation_GetVersionOperationMetadata_InlineSbomInfo struct {
...
type V2betaTypeProvider_Operation_GetVersionOperationMetadata struct {
	InlineSbomInfo any
}
...
type V2betaTypeProvider_Operation_SetAutoscalerLinkOperationMetadata struct {
...
type V2betaTypeProvider_Operation_SetCommonInstanceMetadataOperationMetadata_PerLocationOperations struct {
	Error any
	State any
}

type V2betaTypeProvider_Operation_SetCommonInstanceMetadataOperationMetadata struct {
...
type V2betaTypeProvider_Operation struct {
...
type V2betaTypeProviderAttrs struct {
	// Allows resource handling overrides for specific collections
	CollectionOverrides any
	// The credential used by Deployment Manager and TypeProvider. Only one of the options is permitted.
	Credential any
...
var V2betaTypeProvider = ubx.ResourceBinding{
