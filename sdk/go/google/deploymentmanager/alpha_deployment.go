...
type AlphaDeployment_Credential struct {
...
type AlphaDeployment_Operation_FirewallPolicyRuleOperationMetadata struct {
...
type AlphaDeployment_Operation_GetVersionOperationMetadata_InlineSbomInfo struct {
...
type AlphaDeployment_Operation_GetVersionOperationMetadata struct {
	InlineSbomInfo any
}
...
type AlphaDeployment_Operation_SetAutoscalerLinkOperationMetadata struct {
...
type AlphaDeployment_Operation_SetCommonInstanceMetadataOperationMetadata_PerLocationOperations struct {
	Error any
	State any
}

type AlphaDeployment_Operation_SetCommonInstanceMetadataOperationMetadata struct {
...
type AlphaDeployment_Operation struct {
...
type AlphaDeployment_Target_Config struct {
...
type AlphaDeployment_Update struct {
...
type AlphaDeploymentAttrs struct {
	// The credential used by Deployment Manager and TypeProvider. Only one of the options is permitted.
	Credential any
	// An optional user-provided description of the deployment.
	Description any
...
var AlphaDeployment = ubx.ResourceBinding{
