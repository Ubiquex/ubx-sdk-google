...
type FirebasedataconnectConnector_ClientCache struct {
...
type FirebasedataconnectConnector_Source_Files struct {
	Content any
	Path any
}

type FirebasedataconnectConnector_Source struct {
	// Required. The files that comprise the source set.
	Files any
}

var FirebasedataconnectConnector_ClientCacheFields = ubx.FieldMap{
...
var FirebasedataconnectConnector_Source_FilesFields = ubx.FieldMap{
		"Content": ubx.FieldSpec{WireName: "content"},
		"Path": ubx.FieldSpec{WireName: "path"},
	}

var FirebasedataconnectConnector_SourceFields = ubx.FieldMap{
		"Files": ubx.FieldSpec{
			WireName: "files",
			Kind: "list",
...
type FirebasedataconnectConnectorConfig struct {
...
type FirebasedataconnectConnectorAttrs struct {
	// Optional. Stores small amounts of arbitrary data.
	Annotations any
	// Client caching settings of a connector.
	ClientCache any
...
var FirebasedataconnectConnector = ubx.ResourceBinding{
