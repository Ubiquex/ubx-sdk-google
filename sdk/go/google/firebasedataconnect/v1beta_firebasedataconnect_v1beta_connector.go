...
type V1betaFirebasedataconnectV1betaConnector_ClientCache struct {
...
type V1betaFirebasedataconnectV1betaConnector_Source_Files struct {
	Content any
	Path any
}

type V1betaFirebasedataconnectV1betaConnector_Source struct {
	// Required. The files that comprise the source set.
	Files any
}

var V1betaFirebasedataconnectV1betaConnector_ClientCacheFields = ubx.FieldMap{
...
var V1betaFirebasedataconnectV1betaConnector_Source_FilesFields = ubx.FieldMap{
		"Content": ubx.FieldSpec{WireName: "content"},
		"Path": ubx.FieldSpec{WireName: "path"},
	}

var V1betaFirebasedataconnectV1betaConnector_SourceFields = ubx.FieldMap{
		"Files": ubx.FieldSpec{
			WireName: "files",
			Kind: "list",
...
type V1betaFirebasedataconnectV1betaConnectorConfig struct {
...
type V1betaFirebasedataconnectV1betaConnectorAttrs struct {
	// Optional. Stores small amounts of arbitrary data.
	Annotations any
	// Client caching settings of a connector.
	ClientCache any
...
var V1betaFirebasedataconnectV1betaConnector = ubx.ResourceBinding{
