...
type GkebackupBackup_ClusterMetadata struct {
...
type GkebackupBackup_EncryptionKey struct {
	// Optional. Google Cloud KMS encryption key. Format: `projects/*/locations/*/keyRings/*/cryptoKeys/*`
	GcpKmsEncryptionKey any
}

type GkebackupBackup_SelectedApplications_NamespacedNames struct {
	Name any
	Namespace any
}

type GkebackupBackup_SelectedApplications struct {
	// Optional. A list of namespaced Kubernetes resources.
	NamespacedNames any
}

type GkebackupBackup_SelectedNamespaceLabels_ResourceLabels struct {
	Key any
	Value any
}

type GkebackupBackup_SelectedNamespaceLabels struct {
	// Optional. A list of Kubernetes label-value pairs.
	ResourceLabels any
}

type GkebackupBackup_SelectedNamespaces struct {
	// Optional. A list of Kubernetes Namespaces.
	Namespaces any
}

type GkebackupBackup_TroubleshootingInfo struct {
...
var GkebackupBackup_ClusterMetadataFields = ubx.FieldMap{
...
var GkebackupBackup_EncryptionKeyFields = ubx.FieldMap{
		"GcpKmsEncryptionKey": ubx.FieldSpec{WireName: "gcp_kms_encryption_key"},
	}

var GkebackupBackup_SelectedApplications_NamespacedNamesFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"Namespace": ubx.FieldSpec{WireName: "namespace"},
	}

var GkebackupBackup_SelectedApplicationsFields = ubx.FieldMap{
...
var GkebackupBackup_SelectedNamespaceLabels_ResourceLabelsFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var GkebackupBackup_SelectedNamespaceLabelsFields = ubx.FieldMap{
...
type GkebackupBackupAttrs struct {
	// Output only. If True, all namespaces were included in the Backup.
	AllNamespaces any
	// Information about the GKE cluster from which this Backup was created.
	ClusterMetadata any
...
var GkebackupBackup = ubx.ResourceBinding{
