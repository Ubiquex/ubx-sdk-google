...
type V1betaFirebaseapphostingV1betaBackend_Codebase struct {
...
type V1betaFirebaseapphostingV1betaBackend_ManagedResources_RunService struct {
	Service any
}

type V1betaFirebaseapphostingV1betaBackend_ManagedResources struct {
	RunService any
}

type V1betaFirebaseapphostingV1betaBackend_OverrideEnv struct {
	Availability any
	Origin any
	OriginFileName any
	Secret any
...
type V1betaFirebaseapphostingV1betaBackend_Runtime struct {
	// Optional. The value of the runtime.
	Value any
}

var V1betaFirebaseapphostingV1betaBackend_CodebaseFields = ubx.FieldMap{
		"Repository": ubx.FieldSpec{WireName: "repository"},
		"RootDirectory": ubx.FieldSpec{WireName: "root_directory"},
	}

var V1betaFirebaseapphostingV1betaBackend_ManagedResources_RunServiceFields = ubx.FieldMap{
		"Service": ubx.FieldSpec{WireName: "service"},
	}

var V1betaFirebaseapphostingV1betaBackend_ManagedResourcesFields = ubx.FieldMap{
...
var V1betaFirebaseapphostingV1betaBackend_OverrideEnvFields = ubx.FieldMap{
...
var V1betaFirebaseapphostingV1betaBackend_RuntimeFields = ubx.FieldMap{
		"Value": ubx.FieldSpec{WireName: "value"},
	}

type V1betaFirebaseapphostingV1betaBackendConfig struct {
...
type V1betaFirebaseapphostingV1betaBackendAttrs struct {
	// Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects.
	Annotations any
	// Optional. The [ID of a Web App](https://firebase.google.com/docs/reference/firebase-management/rest/v1beta1/projects.webApps#WebApp.FIELDS.app_id) associated with the backend.
	AppId any
...
var V1betaFirebaseapphostingV1betaBackend = ubx.ResourceBinding{
