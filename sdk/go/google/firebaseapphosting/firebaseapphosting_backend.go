...
type FirebaseapphostingBackend_Codebase struct {
...
type FirebaseapphostingBackend_ManagedResources_RunService struct {
	Service any
}

type FirebaseapphostingBackend_ManagedResources struct {
	RunService any
}

var FirebaseapphostingBackend_CodebaseFields = ubx.FieldMap{
		"Repository": ubx.FieldSpec{WireName: "repository"},
		"RootDirectory": ubx.FieldSpec{WireName: "root_directory"},
	}

var FirebaseapphostingBackend_ManagedResources_RunServiceFields = ubx.FieldMap{
		"Service": ubx.FieldSpec{WireName: "service"},
	}

var FirebaseapphostingBackend_ManagedResourcesFields = ubx.FieldMap{
...
type FirebaseapphostingBackendAttrs struct {
	// Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects.
	Annotations any
	// Optional. The [ID of a Web App](https://firebase.google.com/docs/reference/firebase-management/rest/v1beta1/projects.webApps#WebApp.FIELDS.app_id) associated with the backend.
	AppId any
...
var FirebaseapphostingBackend = ubx.ResourceBinding{
