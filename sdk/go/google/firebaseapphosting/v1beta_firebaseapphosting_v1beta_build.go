...
type V1betaFirebaseapphostingV1betaBuild_Config_EffectiveEnv struct {
	Availability any
	Origin any
	OriginFileName any
	Secret any
...
type V1betaFirebaseapphostingV1betaBuild_Config_RunConfig struct {
...
type V1betaFirebaseapphostingV1betaBuild_Config struct {
...
type V1betaFirebaseapphostingV1betaBuild_Error struct {
...
type V1betaFirebaseapphostingV1betaBuild_Errors struct {
	CloudResource any
	Error any
	ErrorSource any
}

type V1betaFirebaseapphostingV1betaBuild_Source_Archive_Author struct {
...
type V1betaFirebaseapphostingV1betaBuild_Source_Archive struct {
...
type V1betaFirebaseapphostingV1betaBuild_Source_Codebase struct {
...
type V1betaFirebaseapphostingV1betaBuild_Source_Container struct {
	// Required. A URI representing a container for the backend to use.
	Image any
}

type V1betaFirebaseapphostingV1betaBuild_Source_LocallyBuilt struct {
	// Optional. An optional message that describes the uploaded version of the source code.
	Description any
...
type V1betaFirebaseapphostingV1betaBuild_Source struct {
...
var V1betaFirebaseapphostingV1betaBuild_Config_EffectiveEnvFields = ubx.FieldMap{
...
var V1betaFirebaseapphostingV1betaBuild_Config_RunConfigFields = ubx.FieldMap{
...
var V1betaFirebaseapphostingV1betaBuild_ConfigFields = ubx.FieldMap{
...
var V1betaFirebaseapphostingV1betaBuild_ErrorFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var V1betaFirebaseapphostingV1betaBuild_ErrorsFields = ubx.FieldMap{
...
var V1betaFirebaseapphostingV1betaBuild_Source_Archive_AuthorFields = ubx.FieldMap{
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
		"Email": ubx.FieldSpec{WireName: "email"},
		"ImageUri": ubx.FieldSpec{WireName: "image_uri"},
	}

var V1betaFirebaseapphostingV1betaBuild_Source_ArchiveFields = ubx.FieldMap{
...
var V1betaFirebaseapphostingV1betaBuild_Source_CodebaseFields = ubx.FieldMap{
		"Author": ubx.FieldSpec{
			WireName: "author",
			Kind: "object",
			Fields: V1betaFirebaseapphostingV1betaBuild_Source_Archive_AuthorFields,
...
var V1betaFirebaseapphostingV1betaBuild_Source_ContainerFields = ubx.FieldMap{
		"Image": ubx.FieldSpec{WireName: "image"},
	}

var V1betaFirebaseapphostingV1betaBuild_Source_LocallyBuiltFields = ubx.FieldMap{
		"Description": ubx.FieldSpec{WireName: "description"},
		"Env": ubx.FieldSpec{
			WireName: "env",
			Kind: "list",
...
var V1betaFirebaseapphostingV1betaBuild_SourceFields = ubx.FieldMap{
...
type V1betaFirebaseapphostingV1betaBuildConfig struct {
...
type V1betaFirebaseapphostingV1betaBuildAttrs struct {
	// Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects.
	Annotations any
	// Output only. The location of the [Cloud Build logs](https://cloud.google.com/build/docs/view-build-results) for the build process.
	BuildLogsUri any
...
var V1betaFirebaseapphostingV1betaBuild = ubx.ResourceBinding{
