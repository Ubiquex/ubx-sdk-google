...
type V1betaFirebaseapphostingV1betaRollout_Error struct {
...
var V1betaFirebaseapphostingV1betaRollout_ErrorFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

type V1betaFirebaseapphostingV1betaRolloutConfig struct {
...
type V1betaFirebaseapphostingV1betaRolloutAttrs struct {
	// Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects.
	Annotations any
	// Required. Immutable. The name of a build that already exists. It doesn't have to be built; a rollout will wait for a build to be ready before updating traffic.
	Build any
...
var V1betaFirebaseapphostingV1betaRollout = ubx.ResourceBinding{
