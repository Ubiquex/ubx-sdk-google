...
type V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_Issues struct {
	Code any
	Details any
	Message any
}

type V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired_Records struct {
	DomainName any
	Rdata any
	RelevantState any
	RequiredAction any
...
type V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired struct {
	CheckError any
	DomainName any
	Records any
}

type V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdates struct {
	CheckTime any
	Desired any
	Discovered any
	DomainName any
...
type V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus struct {
...
type V1betaFirebaseapphostingV1betaDomain_Serve_Redirect struct {
...
type V1betaFirebaseapphostingV1betaDomain_Serve struct {
	// Specifies redirect behavior for a domain.
	Redirect any
}

var V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_IssuesFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired_RecordsFields = ubx.FieldMap{
...
var V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdates_DesiredFields = ubx.FieldMap{
...
var V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdatesFields = ubx.FieldMap{
...
var V1betaFirebaseapphostingV1betaDomain_CustomDomainStatusFields = ubx.FieldMap{
...
var V1betaFirebaseapphostingV1betaDomain_Serve_RedirectFields = ubx.FieldMap{
		"Status": ubx.FieldSpec{WireName: "status"},
		"Uri": ubx.FieldSpec{WireName: "uri"},
	}

var V1betaFirebaseapphostingV1betaDomain_ServeFields = ubx.FieldMap{
...
type V1betaFirebaseapphostingV1betaDomainConfig struct {
...
type V1betaFirebaseapphostingV1betaDomainAttrs struct {
	// Optional. Annotations as key value pairs.
	Annotations any
	// Output only. Time at which the domain was created.
	CreateTime any
...
var V1betaFirebaseapphostingV1betaDomain = ubx.ResourceBinding{
