...
type FirebaseapphostingBuild_Config_EffectiveEnv struct {
	Availability any
	Origin any
	OriginFileName any
	Secret any
...
type FirebaseapphostingBuild_Config_RunConfig struct {
...
type FirebaseapphostingBuild_Config struct {
...
type FirebaseapphostingBuild_Errors_Error struct {
	Code any
	Details any
	Message any
}

type FirebaseapphostingBuild_Errors struct {
	CloudResource any
	Error any
	ErrorSource any
}

type FirebaseapphostingBuild_Source_Archive_Author struct {
...
type FirebaseapphostingBuild_Source_Archive struct {
...
type FirebaseapphostingBuild_Source_Codebase struct {
...
type FirebaseapphostingBuild_Source_Container struct {
	// Required. A URI representing a container for the backend to use.
	Image any
}

type FirebaseapphostingBuild_Source struct {
...
var FirebaseapphostingBuild_Config_EffectiveEnvFields = ubx.FieldMap{
...
var FirebaseapphostingBuild_Config_RunConfigFields = ubx.FieldMap{
...
var FirebaseapphostingBuild_ConfigFields = ubx.FieldMap{
...
var FirebaseapphostingBuild_Errors_ErrorFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var FirebaseapphostingBuild_ErrorsFields = ubx.FieldMap{
...
var FirebaseapphostingBuild_Source_Archive_AuthorFields = ubx.FieldMap{
		"DisplayName": ubx.FieldSpec{WireName: "display_name"},
		"Email": ubx.FieldSpec{WireName: "email"},
		"ImageUri": ubx.FieldSpec{WireName: "image_uri"},
	}

var FirebaseapphostingBuild_Source_ArchiveFields = ubx.FieldMap{
...
var FirebaseapphostingBuild_Source_CodebaseFields = ubx.FieldMap{
		"Author": ubx.FieldSpec{
			WireName: "author",
			Kind: "object",
			Fields: FirebaseapphostingBuild_Source_Archive_AuthorFields,
...
var FirebaseapphostingBuild_Source_ContainerFields = ubx.FieldMap{
		"Image": ubx.FieldSpec{WireName: "image"},
	}

var FirebaseapphostingBuild_SourceFields = ubx.FieldMap{
...
type FirebaseapphostingBuildAttrs struct {
	// Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects.
	Annotations any
	// Output only. The location of the [Cloud Build logs](https://cloud.google.com/build/docs/view-build-results) for the build process.
	BuildLogsUri any
...
var FirebaseapphostingBuild = ubx.ResourceBinding{
