...
type V1betaBuild_Config struct {
...
type V1betaBuild_Source_Archive struct {
...
type V1betaBuild_Source_Codebase struct {
...
type V1betaBuild_Source_Container struct {
	// Required. A URI representing a container for the backend to use.
	Image any
}

type V1betaBuild_Source_LocallyBuilt struct {
	// Optional. An optional message that describes the uploaded version of the source code.
	Description any
...
type V1betaBuild_Source struct {
...
var V1betaBuild = ubx.ResourceBinding{
