...
type V1beta1Instance_EventPublishConfig struct {
...
type V1beta1Instance_LoggingConfig struct {
...
type V1beta1Instance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindow struct {
...
type V1beta1Instance_MaintenancePolicy_MaintenanceWindow struct {
	// Represents an arbitrary window of time that recurs.
	RecurringTimeWindow any
}

type V1beta1Instance_MaintenancePolicy struct {
	// Represents an arbitrary window of time.
...
type V1beta1Instance_MonitoringConfig struct {
...
type V1beta1Instance_NetworkConfig_PrivateServiceConnectConfig struct {
...
type V1beta1Instance_NetworkConfig struct {
...
type V1beta1InstanceAttrs struct {
