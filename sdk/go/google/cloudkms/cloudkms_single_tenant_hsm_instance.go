...
type CloudkmsSingleTenantHsmInstance_QuorumAuth struct {
...
var CloudkmsSingleTenantHsmInstance_QuorumAuthFields = ubx.FieldMap{
...
type CloudkmsSingleTenantHsmInstanceConfig struct {
...
type CloudkmsSingleTenantHsmInstanceAttrs struct {
	// Output only. The time at which the SingleTenantHsmInstance was created.
	CreateTime any
	// Output only. The time at which the SingleTenantHsmInstance was deleted.
	DeleteTime any
...
var CloudkmsSingleTenantHsmInstance = ubx.ResourceBinding{
