...
type CloudkmsProposal_AddQuorumMember struct {
...
type CloudkmsProposal_QuorumParameters_Challenges struct {
	Challenge any
	PublicKeyPem any
}

type CloudkmsProposal_QuorumParameters struct {
...
type CloudkmsProposal_RegisterTwoFactorAuthKeys struct {
...
type CloudkmsProposal_RequiredActionQuorumParameters struct {
	// Output only. The public keys associated with the 2FA keys that have already approved the SingleTenantHsmInstanceProposal by signing the challenge.
	ApprovedTwoFactorPublicKeyPems any
	// Output only. The challenges to be signed by 2FA keys for quorum auth. M of N of these challenges are required to be signed to approve the operation.
...
type CloudkmsProposal_UpgradeKeyTrust struct {
...
var CloudkmsProposal_AddQuorumMemberFields = ubx.FieldMap{
		"TwoFactorPublicKeyPem": ubx.FieldSpec{WireName: "two_factor_public_key_pem"},
	}

var CloudkmsProposal_QuorumParameters_ChallengesFields = ubx.FieldMap{
		"Challenge": ubx.FieldSpec{WireName: "challenge"},
		"PublicKeyPem": ubx.FieldSpec{WireName: "public_key_pem"},
	}

var CloudkmsProposal_QuorumParametersFields = ubx.FieldMap{
...
var CloudkmsProposal_RegisterTwoFactorAuthKeysFields = ubx.FieldMap{
		"RequiredApproverCount": ubx.FieldSpec{WireName: "required_approver_count"},
		"TwoFactorPublicKeyPems": ubx.FieldSpec{WireName: "two_factor_public_key_pems"},
	}

var CloudkmsProposal_RequiredActionQuorumParametersFields = ubx.FieldMap{
		"ApprovedTwoFactorPublicKeyPems": ubx.FieldSpec{WireName: "approved_two_factor_public_key_pems"},
...
var CloudkmsProposal_UpgradeKeyTrustFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
		"TwoFactorPublicKeyPem": ubx.FieldSpec{WireName: "two_factor_public_key_pem"},
	}

type CloudkmsProposalConfig struct {
...
type CloudkmsProposalAttrs struct {
	// Add a quorum member to the SingleTenantHsmInstance. This will increase the total_approver_count by 1. The SingleTenantHsmInstance must be in the ACTIVE state to perform this operation.
	AddQuorumMember any
	// Output only. The time at which the SingleTenantHsmInstanceProposal was created.
	CreateTime any
...
var CloudkmsProposal = ubx.ResourceBinding{
