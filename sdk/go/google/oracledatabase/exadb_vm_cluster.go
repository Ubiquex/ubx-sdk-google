...
type ExadbVmCluster_IdentityConnector struct {
...
type ExadbVmCluster_Properties_DataCollectionOptions struct {
...
type ExadbVmCluster_Properties_TimeZone struct {
...
type ExadbVmCluster_Properties_VmFileSystemStorage struct {
...
type ExadbVmCluster_Properties struct {
...
type ExadbVmClusterAttrs struct {
	// Required. Immutable. The name of the backup OdbSubnet associated with the ExadbVmCluster. Format: projects/{project}/locations/{location}/odbNetworks/{odb_network}/odbSubnets/{odb_subnet}
	BackupOdbSubnet any
	// Output only. The date and time that the ExadbVmCluster was created.
	CreateTime any
...
var ExadbVmCluster = ubx.ResourceBinding{
