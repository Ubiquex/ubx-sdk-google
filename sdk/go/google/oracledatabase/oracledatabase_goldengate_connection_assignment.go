...
type OracledatabaseGoldengateConnectionAssignment_Properties struct {
...
var OracledatabaseGoldengateConnectionAssignment_PropertiesFields = ubx.FieldMap{
...
type OracledatabaseGoldengateConnectionAssignmentAttrs struct {
	// Output only. The time when the connection assignment was created.
	CreateTime any
	// Optional. The display name for the GoldengateConnectionAssignment.
	DisplayName any
...
var OracledatabaseGoldengateConnectionAssignment = ubx.ResourceBinding{
