...
type GoldengateDeployment_Properties_BackupSchedule struct {
...
type GoldengateDeployment_Properties_DeploymentDiagnosticData struct {
	// Output only. The bucket name.
	Bucket any
...
type GoldengateDeployment_Properties_MaintenanceWindow struct {
...
type GoldengateDeployment_Properties_OggData_GroupRolesMapping struct {
...
type GoldengateDeployment_Properties_OggData struct {
...
type GoldengateDeploymentAttrs struct {
