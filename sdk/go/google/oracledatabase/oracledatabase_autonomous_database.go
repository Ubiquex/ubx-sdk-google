...
type OracledatabaseAutonomousDatabase_Properties_ApexDetails struct {
...
type OracledatabaseAutonomousDatabase_Properties_ConnectionStrings_AllConnectionStrings struct {
...
type OracledatabaseAutonomousDatabase_Properties_ConnectionStrings_Profiles struct {
	ConsumerGroup any
	DisplayName any
	HostFormat any
	IsRegional any
...
type OracledatabaseAutonomousDatabase_Properties_ConnectionStrings struct {
...
type OracledatabaseAutonomousDatabase_Properties_ConnectionUrls struct {
...
type OracledatabaseAutonomousDatabase_Properties_CustomerContacts struct {
	Email any
}

type OracledatabaseAutonomousDatabase_Properties_EncryptionKey struct {
...
type OracledatabaseAutonomousDatabase_Properties_EncryptionKeyHistoryEntries struct {
	ActivationTime any
	EncryptionKey any
}

type OracledatabaseAutonomousDatabase_Properties_LocalStandbyDb struct {
...
type OracledatabaseAutonomousDatabase_Properties_ScheduledOperationDetails_StartTime struct {
	Hours any
	Minutes any
	Nanos any
	Seconds any
...
type OracledatabaseAutonomousDatabase_Properties_ScheduledOperationDetails struct {
	DayOfWeek any
	StartTime any
	StopTime any
}

type OracledatabaseAutonomousDatabase_Properties struct {
...
type OracledatabaseAutonomousDatabase_SourceConfig struct {
...
var OracledatabaseAutonomousDatabase_Properties_ApexDetailsFields = ubx.FieldMap{
		"ApexVersion": ubx.FieldSpec{WireName: "apex_version"},
		"OrdsVersion": ubx.FieldSpec{WireName: "ords_version"},
	}

var OracledatabaseAutonomousDatabase_Properties_ConnectionStrings_AllConnectionStringsFields = ubx.FieldMap{
		"High": ubx.FieldSpec{WireName: "high"},
		"Low": ubx.FieldSpec{WireName: "low"},
		"Medium": ubx.FieldSpec{WireName: "medium"},
	}

var OracledatabaseAutonomousDatabase_Properties_ConnectionStrings_ProfilesFields = ubx.FieldMap{
...
var OracledatabaseAutonomousDatabase_Properties_ConnectionStringsFields = ubx.FieldMap{
...
var OracledatabaseAutonomousDatabase_Properties_ConnectionUrlsFields = ubx.FieldMap{
...
var OracledatabaseAutonomousDatabase_Properties_CustomerContactsFields = ubx.FieldMap{
		"Email": ubx.FieldSpec{WireName: "email"},
	}

var OracledatabaseAutonomousDatabase_Properties_EncryptionKeyFields = ubx.FieldMap{
		"KmsKey": ubx.FieldSpec{WireName: "kms_key"},
		"Provider": ubx.FieldSpec{WireName: "provider"},
	}

var OracledatabaseAutonomousDatabase_Properties_EncryptionKeyHistoryEntriesFields = ubx.FieldMap{
...
var OracledatabaseAutonomousDatabase_Properties_LocalStandbyDbFields = ubx.FieldMap{
...
var OracledatabaseAutonomousDatabase_Properties_ScheduledOperationDetails_StartTimeFields = ubx.FieldMap{
...
var OracledatabaseAutonomousDatabase_Properties_ScheduledOperationDetailsFields = ubx.FieldMap{
...
var OracledatabaseAutonomousDatabase_PropertiesFields = ubx.FieldMap{
...
var OracledatabaseAutonomousDatabase_SourceConfigFields = ubx.FieldMap{
...
type OracledatabaseAutonomousDatabaseAttrs struct {
	// Optional. Immutable. The password for the default ADMIN user. Note: Only one of `admin_password_secret_version` or `admin_password` can be populated.
	AdminPassword any
	// Optional. Immutable. The resource name of a secret version in Secret Manager which contains the database admin user's password. Format: projects/{project}/secrets/{secret}/versions/{version}. Note: Only one of `admin_password_secret_version` or `admin_password` can be populated.
	AdminPasswordSecretVersion any
...
var OracledatabaseAutonomousDatabase = ubx.ResourceBinding{
