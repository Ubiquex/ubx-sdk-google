...
type DocumentaiProcessor_ProcessorVersionAliases struct {
	Alias any
	ProcessorVersion any
}

var DocumentaiProcessor_ProcessorVersionAliasesFields = ubx.FieldMap{
...
type DocumentaiProcessorAttrs struct {
	// Optional. SchemaVersion used by the Processor. It is the same as Processor's DatasetSchema.schema_version Format is `projects/{project}/locations/{location}/schemas/{schema}/schemaVersions/{schema_version}.
	ActiveSchemaVersion any
	// Output only. The time the processor was created.
	CreateTime any
...
var DocumentaiProcessor = ubx.ResourceBinding{
