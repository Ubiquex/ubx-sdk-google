...
type V1beta3ProcessorVersion_DeprecationInfo struct {
...
type V1beta3ProcessorVersion_DocumentSchema_EntityTypes_EntityTypeMetadata struct {
	Inactive any
}

type V1beta3ProcessorVersion_DocumentSchema_EntityTypes_EnumValues struct {
	Values any
}

type V1beta3ProcessorVersion_DocumentSchema_EntityTypes_Properties_PropertyMetadata_FieldExtractionMetadata_SummaryOptions struct {
	Format any
	Length any
}

type V1beta3ProcessorVersion_DocumentSchema_EntityTypes_Properties_PropertyMetadata_FieldExtractionMetadata struct {
	SummaryOptions any
}
...
type V1beta3ProcessorVersion_DocumentSchema struct {
...
type V1beta3ProcessorVersion_ExternalProcessorVersionSource struct {
...
type V1beta3ProcessorVersion_GenAiModelInfo_CustomGenAiModelInfo struct {
...
type V1beta3ProcessorVersion_GenAiModelInfo_FoundationGenAiModelInfo struct {
...
type V1beta3ProcessorVersion_GenAiModelInfo struct {
...
type V1beta3ProcessorVersion_LatestEvaluation_AggregateMetrics struct {
...
type V1beta3ProcessorVersion_LatestEvaluation struct {
...
type V1beta3ProcessorVersionConfig struct {
	...
	ExternalProcessorVersionSource any
	...
	ProcessorVersionSource any
}

type V1beta3ProcessorVersionAttrs struct {
...
var V1beta3ProcessorVersion = ubx.ResourceBinding{
