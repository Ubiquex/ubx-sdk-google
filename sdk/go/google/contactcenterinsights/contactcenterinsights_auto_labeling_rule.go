...
type ContactcenterinsightsAutoLabelingRule_Conditions struct {
	Condition any
	Value any
}

var ContactcenterinsightsAutoLabelingRule_ConditionsFields = ubx.FieldMap{
...
type ContactcenterinsightsAutoLabelingRuleAttrs struct {
	// Whether the rule is active.
	Active any
	// Conditions to apply for auto-labeling the label_key. Representing sequential block of if .. else if .. else statements. The value of the first matching condition will be used.
	Conditions any
...
var ContactcenterinsightsAutoLabelingRule = ubx.ResourceBinding{
