...
type ContactcenterinsightsQaQuestionTagConfig struct {
...
type ContactcenterinsightsQaQuestionTagAttrs struct {
	// Output only. The time at which the question tag was created.
	CreateTime any
	// Required. A user-specified display name for the tag.
	DisplayName any
...
var ContactcenterinsightsQaQuestionTag = ubx.ResourceBinding{
