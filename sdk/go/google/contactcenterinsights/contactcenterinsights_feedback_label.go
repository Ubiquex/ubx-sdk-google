...
type ContactcenterinsightsFeedbackLabel_QaAnswerLabel struct {
	// Boolean value.
	BoolValue any
...
var ContactcenterinsightsFeedbackLabel_QaAnswerLabelFields = ubx.FieldMap{
...
type ContactcenterinsightsFeedbackLabelConfig struct {
...
type ContactcenterinsightsFeedbackLabelAttrs struct {
	// Output only. Create time of the label.
	CreateTime any
	// String label used for Topic Modeling.
	Label any
...
var ContactcenterinsightsFeedbackLabel = ubx.ResourceBinding{
