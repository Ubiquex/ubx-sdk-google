...
type ContactcenterinsightsRevision_Snapshot struct {
...
var ContactcenterinsightsRevision_SnapshotFields = ubx.FieldMap{
...
type ContactcenterinsightsRevisionConfig struct {
...
type ContactcenterinsightsRevisionAttrs struct {
	// Output only. Alternative IDs for this revision of the scorecard, e.g., `latest`.
	AlternateIds any
	// Output only. The timestamp that the revision was created.
	CreateTime any
...
var ContactcenterinsightsRevision = ubx.ResourceBinding{
