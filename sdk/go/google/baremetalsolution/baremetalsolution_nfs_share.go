...
type BaremetalsolutionNfsShare_AllowedClients struct {
	AllowDev any
	AllowSuid any
...
var BaremetalsolutionNfsShare_AllowedClientsFields = ubx.FieldMap{
...
type BaremetalsolutionNfsShareConfig struct {
...
type BaremetalsolutionNfsShareAttrs struct {
	// List of allowed access points.
	AllowedClients any
	// Output only. An identifier for the NFS share, generated by the backend. This is the same value as nfs_share_id and will replace it in the future.
	Id any
...
var BaremetalsolutionNfsShare = ubx.ResourceBinding{
	...
	Fields: ubx.FieldMap{
		...
		"NfsShareId": ubx.FieldSpec{WireName: "nfs_share_id"},
