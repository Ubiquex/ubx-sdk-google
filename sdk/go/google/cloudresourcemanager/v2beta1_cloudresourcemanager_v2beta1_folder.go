...
type V2beta1CloudresourcemanagerV2beta1FolderConfig struct {
...
type V2beta1CloudresourcemanagerV2beta1FolderAttrs struct {
	// Output only. Optional capabilities configured for this folder (via UpdateCapability API). Example: `folders/123/capabilities/app-management`.
	ConfiguredCapabilities any
	// Output only. Timestamp when the Folder was created. Assigned by the server.
	CreateTime any
...
var V2beta1CloudresourcemanagerV2beta1Folder = ubx.ResourceBinding{
