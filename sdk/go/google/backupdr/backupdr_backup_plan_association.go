...
type BackupdrBackupPlanAssociation_AlloydbClusterBackupPlanAssociationProperties struct {
	// Output only. The cluster UID of the AlloyDB cluster.
	ClusterUid any
}

type BackupdrBackupPlanAssociation_CloudSqlInstanceBackupPlanAssociationProperties struct {
	// Output only. The time when the instance was created.
	InstanceCreateTime any
}

type BackupdrBackupPlanAssociation_RulesConfigInfo_LastBackupError struct {
	Code any
	Details any
	Message any
}

type BackupdrBackupPlanAssociation_RulesConfigInfo struct {
	LastBackupError any
	LastBackupState any
...
var BackupdrBackupPlanAssociation_AlloydbClusterBackupPlanAssociationPropertiesFields = ubx.FieldMap{
		"ClusterUid": ubx.FieldSpec{WireName: "cluster_uid"},
	}

var BackupdrBackupPlanAssociation_CloudSqlInstanceBackupPlanAssociationPropertiesFields = ubx.FieldMap{
		"InstanceCreateTime": ubx.FieldSpec{WireName: "instance_create_time"},
	}

var BackupdrBackupPlanAssociation_RulesConfigInfo_LastBackupErrorFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var BackupdrBackupPlanAssociation_RulesConfigInfoFields = ubx.FieldMap{
...
type BackupdrBackupPlanAssociationAttrs struct {
	// Properties for an AlloyDB cluster backup plan association.
	AlloydbClusterBackupPlanAssociationProperties any
	// Required. Resource name of backup plan which needs to be applied on workload. Format: projects/{project}/locations/{location}/backupPlans/{backupPlanId}
	BackupPlan any
...
var BackupdrBackupPlanAssociation = ubx.ResourceBinding{
