...
type Finding_OutdatedLibrary struct {
...
type Finding_ViolatingResource struct {
...
type Finding_VulnerableHeaders struct {
...
type Finding_VulnerableParameters struct {
	// The vulnerable parameter names.
	ParameterNames any
}

type Finding_Xss struct {
	...
	StoredXssSeedingUrl any
}

type Finding_Xxe struct {
