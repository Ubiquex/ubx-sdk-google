...
type Android_AndroidAppInfo_Permissions struct {
	Type any
}

type Android_AndroidAppInfo struct {
	// Output only. Permissions requested by an Android app.
	Permissions any
}

type Android_ChromeAppInfo_Permissions struct {
	AccessUserData any
	DocumentationUri any
	Type any
}

type Android_ChromeAppInfo_SiteAccess struct {
	HostMatch any
}

type Android_ChromeAppInfo struct {
...
type Android_ServiceError struct {
...
var Android = ubx.DataSourceBinding{
