...
type V1alphaMcpServer_Interfaces struct {
	ProtocolBinding any
	Url any
}

type V1alphaMcpServer_Tools_Annotations struct {
	DestructiveHint any
	IdempotentHint any
	OpenWorldHint any
	ReadOnlyHint any
...
type V1alphaMcpServer_Tools struct {
	Annotations any
	Description any
	Name any
}

type V1alphaMcpServerConfig struct {
	Name any
}

type V1alphaMcpServerAttrs struct {
...
var V1alphaMcpServer = ubx.DataSourceBinding{
