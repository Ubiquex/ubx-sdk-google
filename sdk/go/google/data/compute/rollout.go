...
type Rollout_RolloutEntity_OrchestratedEntity struct {
...
type Rollout_RolloutEntity struct {
...
type Rollout_WaveDetails_OrchestratedWaveDetails_LocationStatus struct {
	State any
}

type Rollout_WaveDetails_OrchestratedWaveDetails struct {
...
type Rollout_WaveDetails struct {
...
var Rollout = ubx.DataSourceBinding{
