...
type BetaRegionDiskType_Deprecated_StateOverride struct {
...
type BetaRegionDiskType_Deprecated struct {
...
type BetaRegionDiskTypeConfig struct {
	DiskType any
	Project any
	Region any
}

type BetaRegionDiskTypeAttrs struct {
...
var BetaRegionDiskType = ubx.DataSourceBinding{
