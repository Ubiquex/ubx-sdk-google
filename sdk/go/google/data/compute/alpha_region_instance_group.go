...
type AlphaRegionInstanceGroup_NamedPorts struct {
	Name any
	Port any
}

type AlphaRegionInstanceGroupConfig struct {
	InstanceGroup any
	Project any
	Region any
}

type AlphaRegionInstanceGroupAttrs struct {
...
var AlphaRegionInstanceGroup = ubx.DataSourceBinding{
