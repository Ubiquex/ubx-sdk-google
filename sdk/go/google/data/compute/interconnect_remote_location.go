...
type InterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges struct {
	Max any
	Min any
}

type InterconnectRemoteLocation_AttachmentConfigurationConstraints struct {
...
type InterconnectRemoteLocation_Constraints struct {
...
type InterconnectRemoteLocation_PermittedConnections struct {
	InterconnectLocation any
}

type InterconnectRemoteLocationConfig struct {
	InterconnectRemoteLocation any
	Project any
}

type InterconnectRemoteLocationAttrs struct {
...
var InterconnectRemoteLocation = ubx.DataSourceBinding{
