...
type BetaZone_Deprecated_StateOverride struct {
...
type BetaZone_Deprecated struct {
...
type BetaZone_ResourceStatus_UpcomingMaintenances_WindowEndTime_TimeZone struct {
	Id any
	Version any
}

type BetaZone_ResourceStatus_UpcomingMaintenances_WindowEndTime struct {
	Day any
	Hours any
	Minutes any
	Month any
...
type BetaZone_ResourceStatus_UpcomingMaintenances struct {
	SubType any
	TargetResource any
	Type any
	WindowEndTime any
...
type BetaZone_ResourceStatus struct {
	// Output only. [Output Only] The upcoming maintenance schedule.
	UpcomingMaintenances any
}

type BetaZoneConfig struct {
	Project any
	Zone any
}

type BetaZoneAttrs struct {
...
var BetaZone = ubx.DataSourceBinding{
