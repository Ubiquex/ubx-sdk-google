...
type AlphaLicenseCode_LicenseAlias struct {
	Description any
	SelfLink    any
}

type AlphaLicenseCode_MinimumRetention struct {
...
type AlphaLicenseCodeConfig struct {
	LicenseCode any
	Project     any
}

type AlphaLicenseCodeAttrs struct {
...
var AlphaLicenseCode = ubx.DataSourceBinding{
