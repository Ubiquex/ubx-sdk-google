...
type AlphaOrganizationRollout_RolloutEntity_OrchestratedEntity struct {
...
type AlphaOrganizationRollout_RolloutEntity struct {
...
type AlphaOrganizationRollout_WaveDetails_OrchestratedWaveDetails_LocationStatus struct {
	State any
}

type AlphaOrganizationRollout_WaveDetails_OrchestratedWaveDetails struct {
...
type AlphaOrganizationRollout_WaveDetails struct {
	OrchestratedWaveDetails any
	WaveDisplayName any
	WaveNumber any
}

type AlphaOrganizationRolloutConfig struct {
	Organization any
	Rollout any
}

type AlphaOrganizationRolloutAttrs struct {
...
var AlphaOrganizationRollout = ubx.DataSourceBinding{
