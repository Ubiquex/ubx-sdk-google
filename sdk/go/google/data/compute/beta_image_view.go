...
type BetaImageView_Image_Deprecated_StateOverride struct {
...
type BetaImageView_Image_Deprecated struct {
...
type BetaImageView_Image_GuestOsFeatures struct {
	Type any
}

type BetaImageView_Image_ImageEncryptionKey struct {
...
type BetaImageView_Image_Params struct {
...
type BetaImageView_Image_RawDisk struct {
...
type BetaImageView_Image_ShieldedInstanceInitialState_Dbs struct {
	Content any
	FileType any
}

type BetaImageView_Image_ShieldedInstanceInitialState struct {
	// The Key Database (db).
	Dbs any
...
type BetaImageView_Image struct {
...
type BetaImageViewConfig struct {
	Project any
	Region any
	ResourceId any
}

type BetaImageViewAttrs struct {
...
var BetaImageView = ubx.DataSourceBinding{
