...
type AlphaRecoverableSnapshot_OriginalResource_GuestOsFeatures struct {
	Type any
}

type AlphaRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey struct {
...
type AlphaRecoverableSnapshot_OriginalResource struct {
...
type AlphaRecoverableSnapshotConfig struct {
	Project any
	RecoverableSnapshot any
}

type AlphaRecoverableSnapshotAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var AlphaRecoverableSnapshot = ubx.DataSourceBinding{
