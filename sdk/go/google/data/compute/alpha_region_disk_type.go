...
type AlphaRegionDiskType_Deprecated_StateOverride struct {
...
type AlphaRegionDiskType_Deprecated struct {
...
type AlphaRegionDiskTypeConfig struct {
	DiskType any
	Project any
	Region any
}

type AlphaRegionDiskTypeAttrs struct {
...
var AlphaRegionDiskType = ubx.DataSourceBinding{
