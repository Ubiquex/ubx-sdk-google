...
type BetaRegion_Deprecated_StateOverride struct {
...
type BetaRegion_Deprecated struct {
...
type BetaRegion_QuotaStatusWarning_Data struct {
	Key any
	Value any
}

type BetaRegion_QuotaStatusWarning struct {
...
type BetaRegionConfig struct {
	Project any
	Region any
}

type BetaRegionAttrs struct {
...
var BetaRegion = ubx.DataSourceBinding{
