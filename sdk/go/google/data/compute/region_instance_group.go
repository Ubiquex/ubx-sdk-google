...
type RegionInstanceGroup_NamedPorts struct {
	Name any
	Port any
}

type RegionInstanceGroupConfig struct {
	InstanceGroup any
	Project any
	Region any
}

type RegionInstanceGroupAttrs struct {
...
var RegionInstanceGroup = ubx.DataSourceBinding{
