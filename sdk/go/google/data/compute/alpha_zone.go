...
type AlphaZone_Deprecated_StateOverride struct {
...
type AlphaZone_Deprecated struct {
...
type AlphaZone_ResourceStatus_UpcomingMaintenances_WindowEndTime_TimeZone struct {
	Id any
	Version any
}

type AlphaZone_ResourceStatus_UpcomingMaintenances_WindowEndTime struct {
	Day any
	Hours any
	Minutes any
	Month any
...
type AlphaZone_ResourceStatus_UpcomingMaintenances struct {
	SubType any
	TargetResource any
	Type any
	WindowEndTime any
...
type AlphaZone_ResourceStatus struct {
	// Output only. [Output Only] The upcoming maintenance schedule.
	UpcomingMaintenances any
}

type AlphaZoneConfig struct {
	Project any
	Zone any
}

type AlphaZoneAttrs struct {
...
var AlphaZone = ubx.DataSourceBinding{
