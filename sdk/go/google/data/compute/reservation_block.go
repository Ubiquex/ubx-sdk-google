...
type ReservationBlock_Resource_HealthInfo struct {
...
type ReservationBlock_Resource_PhysicalTopology_Instances_PhysicalHostTopology struct {
	Host any
	SubBlock any
}

type ReservationBlock_Resource_PhysicalTopology_Instances struct {
	InstanceId any
	PhysicalHostTopology any
	ProjectId any
}

type ReservationBlock_Resource_PhysicalTopology struct {
...
type ReservationBlock_Resource_ReservationMaintenance_UpcomingGroupMaintenance struct {
...
type ReservationBlock_Resource_ReservationMaintenance struct {
...
type ReservationBlock_Resource struct {
...
type ReservationBlockConfig struct {
	Project any
	Reservation any
...
type ReservationBlockAttrs struct {
	Project any
	Reservation any
	ReservationBlock any
...
var ReservationBlock = ubx.DataSourceBinding{
