...
type BetaReservationBlock_Resource_HealthInfo struct {
...
type BetaReservationBlock_Resource_PhysicalTopology_Instances_PhysicalHostTopology struct {
	Host any
	SubBlock any
}

type BetaReservationBlock_Resource_PhysicalTopology_Instances struct {
	InstanceId any
	PhysicalHostTopology any
	ProjectId any
}

type BetaReservationBlock_Resource_PhysicalTopology struct {
...
type BetaReservationBlock_Resource_ReservationMaintenance_UpcomingGroupMaintenance struct {
...
type BetaReservationBlock_Resource_ReservationMaintenance struct {
...
type BetaReservationBlock_Resource struct {
...
type BetaReservationBlockConfig struct {
	Project any
	Reservation any
...
type BetaReservationBlockAttrs struct {
	Project any
	Reservation any
	ReservationBlock any
...
var BetaReservationBlock = ubx.DataSourceBinding{
