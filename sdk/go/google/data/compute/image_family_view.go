...
type ImageFamilyView_Image_Deprecated struct {
...
type ImageFamilyView_Image_GuestOsFeatures struct {
	Type any
}

type ImageFamilyView_Image_ImageEncryptionKey struct {
...
type ImageFamilyView_Image_Params struct {
...
type ImageFamilyView_Image_RawDisk struct {
...
type ImageFamilyView_Image_ShieldedInstanceInitialState_Dbs struct {
	Content  any
	FileType any
}

type ImageFamilyView_Image_ShieldedInstanceInitialState struct {
	// The Key Database (db).
	Dbs any
...
type ImageFamilyView_Image struct {
...
type ImageFamilyViewConfig struct {
	Family  any
	Project any
	Zone    any
}

type ImageFamilyViewAttrs struct {
	Family any
...
var ImageFamilyView = ubx.DataSourceBinding{
