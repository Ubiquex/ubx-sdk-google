...
type BetaRegionInstanceGroup_NamedPorts struct {
	Name any
	Port any
}

type BetaRegionInstanceGroupConfig struct {
	InstanceGroup any
	Project any
	Region any
}

type BetaRegionInstanceGroupAttrs struct {
...
var BetaRegionInstanceGroup = ubx.DataSourceBinding{
