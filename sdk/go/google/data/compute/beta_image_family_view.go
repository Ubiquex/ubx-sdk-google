...
type BetaImageFamilyView_Image_Deprecated_StateOverride struct {
...
type BetaImageFamilyView_Image_Deprecated struct {
...
type BetaImageFamilyView_Image_GuestOsFeatures struct {
	Type any
}

type BetaImageFamilyView_Image_ImageEncryptionKey struct {
...
type BetaImageFamilyView_Image_Params struct {
...
type BetaImageFamilyView_Image_RawDisk struct {
...
type BetaImageFamilyView_Image_ShieldedInstanceInitialState_Dbs struct {
	Content any
	FileType any
}

type BetaImageFamilyView_Image_ShieldedInstanceInitialState struct {
	// The Key Database (db).
	Dbs any
...
type BetaImageFamilyView_Image struct {
...
type BetaImageFamilyViewConfig struct {
	Family any
	Project any
	Zone any
}

type BetaImageFamilyViewAttrs struct {
	Family any
...
var BetaImageFamilyView = ubx.DataSourceBinding{
