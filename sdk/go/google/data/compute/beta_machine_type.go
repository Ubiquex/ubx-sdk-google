...
type BetaMachineType_Accelerators struct {
	GuestAcceleratorCount any
	GuestAcceleratorType any
}

type BetaMachineType_BundledLocalSsds struct {
...
type BetaMachineType_Deprecated_StateOverride struct {
...
type BetaMachineType_Deprecated struct {
...
type BetaMachineTypeConfig struct {
	MachineType any
	Project any
	Zone any
}

type BetaMachineTypeAttrs struct {
...
var BetaMachineType = ubx.DataSourceBinding{
