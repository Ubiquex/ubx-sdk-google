...
type AlphaNetworkProfile_Features_PredefinedSubnetworkRanges struct {
	Ipv6Range any
	NamePrefix any
}

type AlphaNetworkProfile_Features struct {
...
type AlphaNetworkProfile_Location struct {
	Name any
	Scope any
}

type AlphaNetworkProfile_ProfileType struct {
	NetworkType any
	RdmaSubtype any
	UllSubtype any
	VpcSubtype any
...
type AlphaNetworkProfileConfig struct {
	NetworkProfile any
	Project any
}

type AlphaNetworkProfileAttrs struct {
...
var AlphaNetworkProfile = ubx.DataSourceBinding{
