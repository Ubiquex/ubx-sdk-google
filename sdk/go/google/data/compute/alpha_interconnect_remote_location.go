...
type AlphaInterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges struct {
	Max any
	Min any
}

type AlphaInterconnectRemoteLocation_AttachmentConfigurationConstraints struct {
...
type AlphaInterconnectRemoteLocation_Constraints struct {
...
type AlphaInterconnectRemoteLocation_PermittedConnections struct {
	InterconnectLocation any
}

type AlphaInterconnectRemoteLocationConfig struct {
	InterconnectRemoteLocation any
	Project any
}

type AlphaInterconnectRemoteLocationAttrs struct {
...
var AlphaInterconnectRemoteLocation = ubx.DataSourceBinding{
