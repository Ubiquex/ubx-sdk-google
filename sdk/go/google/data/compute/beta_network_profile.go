...
type BetaNetworkProfile_Features_PredefinedSubnetworkRanges struct {
	Ipv6Range  any
	NamePrefix any
}

type BetaNetworkProfile_Features struct {
...
type BetaNetworkProfile_Location struct {
	Name  any
	Scope any
}

type BetaNetworkProfile_ProfileType struct {
	NetworkType any
	RdmaSubtype any
	UllSubtype  any
	VpcSubtype  any
...
type BetaNetworkProfileConfig struct {
	NetworkProfile any
	Project        any
}

type BetaNetworkProfileAttrs struct {
...
var BetaNetworkProfile = ubx.DataSourceBinding{
