...
type AlphaImageFamilyView_Image_Deprecated_StateOverride struct {
...
type AlphaImageFamilyView_Image_Deprecated struct {
...
type AlphaImageFamilyView_Image_GuestOsFeatures struct {
	Type any
}

type AlphaImageFamilyView_Image_ImageEncryptionKey struct {
...
type AlphaImageFamilyView_Image_Params struct {
...
type AlphaImageFamilyView_Image_RawDisk struct {
...
type AlphaImageFamilyView_Image_ShieldedInstanceInitialState struct {
	// The Key Database (db).
	Dbs any
