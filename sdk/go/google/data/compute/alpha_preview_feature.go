...
type AlphaPreviewFeature_RolloutOperation_RolloutInput struct {
...
type AlphaPreviewFeature_RolloutOperation struct {
	// Represents the input for the rollout operation.
	RolloutInput any
}

type AlphaPreviewFeature_Status_ReleaseStatus_UpdateDate struct {
...
type AlphaPreviewFeature_Status_ReleaseStatus struct {
...
type AlphaPreviewFeature_Status struct {
...
var AlphaPreviewFeature = ubx.DataSourceBinding{
