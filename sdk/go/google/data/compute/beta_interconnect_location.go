...
type BetaInterconnectLocation_CrossSiteInterconnectInfos struct {
	City any
	MaxDynamicPathBandwidthGbps any
	MaxFixedPathBandwidthGbps any
}

type BetaInterconnectLocation_RegionInfos struct {
	ExpectedRttMs any
...
type BetaInterconnectLocationConfig struct {
	InterconnectLocation any
	Project any
}

type BetaInterconnectLocationAttrs struct {
...
var BetaInterconnectLocation = ubx.DataSourceBinding{
