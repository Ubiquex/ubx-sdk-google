...
type BetaReservationSlot_Resource_PhysicalTopology struct {
...
type BetaReservationSlot_Resource_ShareSettings_FolderMap struct {
	FolderId any
}

type BetaReservationSlot_Resource_ShareSettings_ProjectMap struct {
	ProjectId any
}

type BetaReservationSlot_Resource_ShareSettings struct {
...
type BetaReservationSlot_Resource_Status struct {
...
type BetaReservationSlot_Resource struct {
...
type BetaReservationSlotConfig struct {
	ParentName any
	Project any
	ReservationSlot any
	Zone any
...
type BetaReservationSlotAttrs struct {
	ParentName any
	Project any
	ReservationSlot any
...
var BetaReservationSlot = ubx.DataSourceBinding{
