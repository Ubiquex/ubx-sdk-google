...
type ReservationSubBlock_Resource_AcceleratorTopologiesInfo_AcceleratorTopologyInfos_InfoPerTopologyStates struct {
	Count any
	State any
}

type ReservationSubBlock_Resource_AcceleratorTopologiesInfo_AcceleratorTopologyInfos struct {
	AcceleratorTopology any
	InfoPerTopologyStates any
}

type ReservationSubBlock_Resource_AcceleratorTopologiesInfo struct {
	// Info for each accelerator topology.
	AcceleratorTopologyInfos any
}

type ReservationSubBlock_Resource_HealthInfo struct {
...
type ReservationSubBlock_Resource_PhysicalTopology struct {
...
type ReservationSubBlock_Resource_ReservationSubBlockMaintenance_UpcomingGroupMaintenance struct {
...
type ReservationSubBlock_Resource_ReservationSubBlockMaintenance struct {
...
type ReservationSubBlock_Resource struct {
...
type ReservationSubBlockConfig struct {
	ParentName any
	Project any
...
type ReservationSubBlockAttrs struct {
	ParentName any
	Project any
	ReservationSubBlock any
...
var ReservationSubBlock = ubx.DataSourceBinding{
