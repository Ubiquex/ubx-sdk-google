...
type AlphaRegionRecoverableSnapshot_OriginalResource_GuestOsFeatures struct {
	Type any
}

type AlphaRegionRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey struct {
...
type AlphaRegionRecoverableSnapshot_OriginalResource struct {
...
type AlphaRegionRecoverableSnapshotConfig struct {
	Project any
	RecoverableSnapshot any
	Region any
}

type AlphaRegionRecoverableSnapshotAttrs struct {
	// Output only. [Output Only] Creation timestamp inRFC3339 text format.
	CreationTimestamp any
...
var AlphaRegionRecoverableSnapshot = ubx.DataSourceBinding{
