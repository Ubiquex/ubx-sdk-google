...
type InterconnectLocation_CrossSiteInterconnectInfos struct {
	City any
	MaxDynamicPathBandwidthGbps any
	MaxFixedPathBandwidthGbps any
}

type InterconnectLocation_RegionInfos struct {
	ExpectedRttMs any
...
type InterconnectLocationConfig struct {
	InterconnectLocation any
	Project any
}

type InterconnectLocationAttrs struct {
...
var InterconnectLocation = ubx.DataSourceBinding{
