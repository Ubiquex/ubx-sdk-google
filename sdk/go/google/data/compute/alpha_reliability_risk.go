...
type AlphaReliabilityRisk_Details_GlobalDnsInsight struct {
...
type AlphaReliabilityRisk_Details struct {
...
type AlphaReliabilityRisk_Recommendation struct {
...
type AlphaReliabilityRiskConfig struct {
	Project         any
	ReliabilityRisk any
}

type AlphaReliabilityRiskAttrs struct {
...
var AlphaReliabilityRisk = ubx.DataSourceBinding{
