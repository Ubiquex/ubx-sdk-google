...
type BetaLicenseCode_LicenseAlias struct {
	Description any
	SelfLink any
}

type BetaLicenseCode_MinimumRetention struct {
...
type BetaLicenseCodeConfig struct {
	LicenseCode any
	Project any
}

type BetaLicenseCodeAttrs struct {
...
var BetaLicenseCode = ubx.DataSourceBinding{
