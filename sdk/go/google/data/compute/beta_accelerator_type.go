...
type BetaAcceleratorType_Deprecated_StateOverride struct {
...
type BetaAcceleratorType_Deprecated struct {
...
type BetaAcceleratorTypeConfig struct {
	AcceleratorType any
	Project         any
	Zone            any
}

type BetaAcceleratorTypeAttrs struct {
	AcceleratorType any
...
var BetaAcceleratorType = ubx.DataSourceBinding{
