...
type DiscoveredService_ServiceProperties_ExtendedMetadata struct {
	MetadataStruct any
}

type DiscoveredService_ServiceProperties_FunctionalType struct {
	// Output only. The functional type of a service or workload.
	Type any
}

type DiscoveredService_ServiceProperties_Identity struct {
...
type DiscoveredService_ServiceProperties struct {
...
type DiscoveredService_ServiceReference struct {
	// Output only. The underlying resource URI. For example, URI of Forwarding Rule, URL Map, and Backend Service.
	Uri any
}

type DiscoveredServiceConfig struct {
	Name any
}

type DiscoveredServiceAttrs struct {
	Name any
...
var DiscoveredService = ubx.DataSourceBinding{
