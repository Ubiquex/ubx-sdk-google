...
type V1beta2Project_Quota_WhitelistedKeySpecs struct {
	Algorithm any
	KeyLength any
	KeyType   any
	Kind      any
...
type V1beta2Project_Quota struct {
...
type V1beta2ProjectConfig struct {
	ClientOperationId any
	Project           any
}

type V1beta2ProjectAttrs struct {
	ClientOperationId any
...
var V1beta2Project = ubx.DataSourceBinding{
