...
type V1alpha1Asset_AwsS3BucketDetails_ObjectsMetadata_TotalObjects struct {
	// Optional. The total number of objects in the bucket.
	Value any
}

type V1alpha1Asset_AwsS3BucketDetails_ObjectsMetadata struct {
...
type V1alpha1Asset_AwsS3BucketDetails struct {
...
type V1alpha1Asset_DatabaseDeploymentDetails_AggregatedStats struct {
...
type V1alpha1Asset_DatabaseDeploymentDetails_Mysql struct {
...
type V1alpha1Asset_DatabaseDeploymentDetails_SqlServer struct {
...
type V1alpha1Asset_DatabaseDeploymentDetails struct {
...
type V1alpha1Asset_DatabaseDetails_ParentDatabaseDeployment struct {
...
type V1alpha1Asset_DatabaseDetails_Schemas_SqlServer struct {
	ClrObjectCount any
}
...
type V1alpha1Asset_DatabaseDetails struct {
...
type V1alpha1Asset_HostingProviderDetails_Aws struct {
	// Optional. The AWS account ID owning the resource represented by this asset.
	OwningAccountId any
}

type V1alpha1Asset_HostingProviderDetails_Location struct {
	// Optional. The name of the region.
	Region any
}

type V1alpha1Asset_HostingProviderDetails struct {
...
type V1alpha1Asset_InsightList_Insights_MigrationInsight_Fit struct {
	FitLevel any
}
...
type V1alpha1Asset_MachineDetails_Architecture_Bios struct {
	// BIOS manufacturer.
...
type V1alpha1Asset_MachineDetails_Architecture struct {
...
type V1alpha1Asset_MachineDetails_DiskPartitions struct {
...
type V1alpha1Asset_MachineDetails_Disks struct {
	// VM disks.
	Disks any
...
type V1alpha1Asset_MachineDetails_GuestOs_Config_Fstab struct {
	// Fstab entries.
	Entries any
}
...
type V1alpha1Asset_MachineDetails_GuestOs_Config_Selinux struct {
	// Is SELinux enabled.
	Enabled any
...
type V1alpha1Asset_MachineDetails_GuestOs_Config struct {
	// Fstab content.
	Fstab any
	// Hosts content.
	Hosts any
...
type V1alpha1Asset_MachineDetails_GuestOs_Runtime_LastUptime struct {
...
type V1alpha1Asset_MachineDetails_GuestOs_Runtime_NetworkInfo_NetstatTime_TimeZone struct {
...
type V1alpha1Asset_MachineDetails_GuestOs_Runtime_NetworkInfo_NetstatTime struct {
...
type V1alpha1Asset_MachineDetails_GuestOs_Runtime_NetworkInfo struct {
...
type V1alpha1Asset_MachineDetails_GuestOs_Runtime struct {
...
type V1alpha1Asset_MachineDetails_GuestOs struct {
...
type V1alpha1Asset_MachineDetails_Network struct {
...
type V1alpha1Asset_MachineDetails_Platform_AwsEc2Details struct {
...
type V1alpha1Asset_MachineDetails_Platform_AzureVmDetails struct {
...
type V1alpha1Asset_MachineDetails_Platform_GenericDetails struct {
	// Whether the machine is hyperthreaded.
	Hyperthreading any
...
type V1alpha1Asset_MachineDetails_Platform_VmwareDetails struct {
...
type V1alpha1Asset_MachineDetails_Platform struct {
...
type V1alpha1Asset_MachineDetails struct {
...
type V1alpha1Asset_PerformanceData struct {
...
type V1alpha1Asset_VirtualMachineDetails_VmArchitecture struct {
	// Details about the BIOS.
	Bios any
	// CPU architecture, e.g., "x64-based PC", "x86_64", "i686" etc.
	CpuArchitecture any
...
type V1alpha1Asset_VirtualMachineDetails_VmDisks struct {
	// VM disks.
	Disks any
	// Disk total Capacity.
...
type V1alpha1Asset_VirtualMachineDetails_VmNetwork struct {
	// Default gateway address.
	DefaultGw any
	// List of network adapters.
	NetworkAdapters any
...
type V1alpha1Asset_VirtualMachineDetails struct {
...
type V1alpha1AssetAttrs struct {
