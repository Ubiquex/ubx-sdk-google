...
type V1betaPlayIntegrityConfig_AccountDetails struct {
...
type V1betaPlayIntegrityConfig_AppIntegrity struct {
...
type V1betaPlayIntegrityConfig_DeviceIntegrity struct {
...
type V1betaPlayIntegrityConfigConfig struct {
	Name any
}

type V1betaPlayIntegrityConfigAttrs struct {
...
var V1betaPlayIntegrityConfig = ubx.DataSourceBinding{
