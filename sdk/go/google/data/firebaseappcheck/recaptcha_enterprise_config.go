...
type RecaptchaEnterpriseConfig_RiskAnalysis struct {
...
type RecaptchaEnterpriseConfigConfig struct {
	Name any
}

type RecaptchaEnterpriseConfigAttrs struct {
	Name any
...
var RecaptchaEnterpriseConfig = ubx.DataSourceBinding{
