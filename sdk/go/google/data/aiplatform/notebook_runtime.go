...
type NotebookRuntime_DataPersistentDiskSpec struct {
...
type NotebookRuntime_EncryptionSpec struct {
	// Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
	KmsKeyName any
}

type NotebookRuntime_EucConfig struct {
...
type NotebookRuntime_IdleShutdownConfig struct {
...
type NotebookRuntime_MachineSpec_ReservationAffinity struct {
...
type NotebookRuntime_MachineSpec struct {
...
type NotebookRuntime_NetworkSpec struct {
...
type NotebookRuntime_NotebookRuntimeTemplateRef struct {
	// Immutable. A resource name of the NotebookRuntimeTemplate.
	NotebookRuntimeTemplate any
}

type NotebookRuntime_ReservationAffinity struct {
...
type NotebookRuntime_ShieldedVmConfig struct {
...
type NotebookRuntime_SoftwareConfig_ColabImage struct {
...
type NotebookRuntime_SoftwareConfig_Env struct {
	Name any
	Value any
}

type NotebookRuntime_SoftwareConfig_PostStartupScriptConfig struct {
...
type NotebookRuntime_SoftwareConfig struct {
...
type NotebookRuntimeAttrs struct {
...
var NotebookRuntime = ubx.DataSourceBinding{
