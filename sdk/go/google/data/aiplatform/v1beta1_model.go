...
type V1beta1Model_BaseModelSource_GenieSource struct {
	// Required. The public base model URI.
	BaseModelUri any
}

type V1beta1Model_BaseModelSource_ModelGardenSource struct {
...
type V1beta1Model_BaseModelSource struct {
...
type V1beta1Model_ContainerSpec_GrpcPorts struct {
	ContainerPort any
}

type V1beta1Model_ContainerSpec_HealthProbe_Exec struct {
	// Command is the command line to execute inside the container, the working directory for the command is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.
	Command any
}

type V1beta1Model_ContainerSpec_HealthProbe_Grpc struct {
...
type V1beta1Model_ContainerSpec_HealthProbe_HttpGet struct {
...
type V1beta1Model_ContainerSpec_HealthProbe_TcpSocket struct {
...
type V1beta1Model_ContainerSpec_HealthProbe struct {
...
type V1beta1Model_ContainerSpec struct {
...
type V1beta1Model_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource struct {
	// Required. Google Cloud Storage URI(-s) to the input file(s). May contain wildcards. For more information on wildcards, see https://cloud.google.com/storage/docs/wildcards.
	Uris any
}

type V1beta1Model_ExplanationSpec_Parameters_Examples_ExampleGcsSource struct {
...
type V1beta1Model_ExplanationSpec_Parameters_Examples_Presets struct {
...
type V1beta1Model_ExplanationSpec_Parameters_Examples struct {
...
type V1beta1Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig struct {
...
type V1beta1Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma struct {
	// Noise sigma per feature. No noise is added to features that are not set.
	NoiseSigma any
}

type V1beta1Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig struct {
...
type V1beta1Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution struct {
...
type V1beta1Model_ExplanationSpec_Parameters_SampledShapleyAttribution struct {
...
type V1beta1Model_ExplanationSpec_Parameters struct {
...
type V1beta1Model_ExplanationSpec struct {
...
type V1beta1Model_ModelSourceInfo struct {
...
type V1beta1Model_OriginalModelInfo struct {
...
type V1beta1Model_PredictSchemata struct {
...
var V1beta1Model = ubx.DataSourceBinding{
