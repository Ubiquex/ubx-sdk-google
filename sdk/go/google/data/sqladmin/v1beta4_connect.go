...
type V1beta4Connect_DnsNames struct {
	ConnectionType any
	DnsScope any
	Name any
	RecordManager any
...
type V1beta4Connect_IpAddresses struct {
	IpAddress any
	TimeToRetire any
	Type any
}

type V1beta4Connect_Nodes struct {
	DnsName any
	DnsNames any
	IpAddresses any
	Name any
...
type V1beta4Connect_ServerCaCert struct {
	// PEM representation.
	Cert any
...
type V1beta4ConnectConfig struct {
	Instance any
	Project any
	ReadTime any
}

type V1beta4ConnectAttrs struct {
...
var V1beta4Connect = ubx.DataSourceBinding{
