...
type Operation_AcquireSsrsLeaseContext struct {
...
type Operation_ApiWarning struct {
...
type Operation_BackupContext struct {
...
type Operation_ExportContext_BakExportOptions struct {
...
type Operation_ExportContext_CsvExportOptions struct {
...
type Operation_ExportContext_SqlExportOptions_MysqlExportOptions struct {
...
type Operation_ExportContext_SqlExportOptions_PostgresExportOptions struct {
...
type Operation_ExportContext_SqlExportOptions struct {
...
type Operation_ExportContext_TdeExportOptions struct {
...
type Operation_ExportContext struct {
...
type Operation_ImportContext_BakImportOptions_EncryptionOptions struct {
...
type Operation_ImportContext_BakImportOptions struct {
...
type Operation_ImportContext_CsvImportOptions struct {
...
type Operation_ImportContext_SqlImportOptions struct {
...
type Operation_ImportContext struct {
...
type Operation_PreCheckMajorVersionUpgradeContext_PreCheckResponse struct {
	ActionsRequired any
	Message any
	MessageType any
}

type Operation_PreCheckMajorVersionUpgradeContext struct {
...
type Operation_SubOperationType struct {
