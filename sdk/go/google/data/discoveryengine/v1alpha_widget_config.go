...
type V1alphaWidgetConfig_AccessSettings struct {
...
type V1alphaWidgetConfig_AssistantSettings struct {
...
type V1alphaWidgetConfig_ContentSearchSpec_ExtractiveContentSpec struct {
...
type V1alphaWidgetConfig_ContentSearchSpec_SnippetSpec struct {
...
type V1alphaWidgetConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec struct {
	// Text at the beginning of the prompt that instructs the assistant. Examples are available in the user guide.
	Preamble any
}

type V1alphaWidgetConfig_ContentSearchSpec_SummarySpec_ModelSpec struct {
...
type V1alphaWidgetConfig_ContentSearchSpec_SummarySpec_MultimodalSpec struct {
	// Optional. Source of image returned in the answer.
	ImageSource any
}

type V1alphaWidgetConfig_ContentSearchSpec_SummarySpec struct {
...
type V1alphaWidgetConfig_ContentSearchSpec struct {
...
type V1alphaWidgetConfig_UiSettings_GenerativeAnswerConfig struct {
...
type V1alphaWidgetConfig_UiSettings_SearchAddonSpec struct {
...
type V1alphaWidgetConfig_UiSettings struct {
...
var V1alphaWidgetConfig = ubx.DataSourceBinding{
