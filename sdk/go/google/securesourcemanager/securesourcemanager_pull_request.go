...
type SecuresourcemanagerPullRequest_Base struct {
...
var SecuresourcemanagerPullRequest_BaseFields = ubx.FieldMap{
		"Ref": ubx.FieldSpec{WireName: "ref"},
		"Sha": ubx.FieldSpec{WireName: "sha"},
	}

type SecuresourcemanagerPullRequestConfig struct {
...
type SecuresourcemanagerPullRequestAttrs struct {
	// Branch represents a branch involved in a pull request.
	Base any
	// Optional. The pull request body. Provides a detailed description of the changes.
	Body any
...
var SecuresourcemanagerPullRequest = ubx.ResourceBinding{
