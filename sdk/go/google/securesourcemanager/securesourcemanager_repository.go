...
type SecuresourcemanagerRepository_InitialConfig struct {
...
type SecuresourcemanagerRepository_ScanConfig_SecretScanConfig struct {
...
type SecuresourcemanagerRepository_ScanConfig struct {
	// Configuration for secret scanning.
	SecretScanConfig any
}

type SecuresourcemanagerRepository_Uris struct {
...
var SecuresourcemanagerRepository_InitialConfigFields = ubx.FieldMap{
...
var SecuresourcemanagerRepository_ScanConfig_SecretScanConfigFields = ubx.FieldMap{
		"Enabled": ubx.FieldSpec{WireName: "enabled"},
		"InspectTemplate": ubx.FieldSpec{WireName: "inspect_template"},
	}

var SecuresourcemanagerRepository_ScanConfigFields = ubx.FieldMap{
...
var SecuresourcemanagerRepository_UrisFields = ubx.FieldMap{
...
type SecuresourcemanagerRepositoryAttrs struct {
	// Output only. Create timestamp.
	CreateTime any
	// Optional. Description of the repository, which cannot exceed 500 characters.
	Description any
...
var SecuresourcemanagerRepository = ubx.ResourceBinding{
