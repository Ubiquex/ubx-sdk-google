...
type SecretmanagerSecret_CustomerManagedEncryption struct {
	// Required. The resource name of the Cloud KMS CryptoKey used to encrypt secret payloads. For secrets using the UserManaged replication policy type, Cloud KMS CryptoKeys must reside in the same location as the replica location. For secrets using the Automatic replication policy type, Cloud KMS CryptoKeys must reside in `global`. The expected format is `projects/*/locations/*/keyRings/*/cryptoKeys/*`.
	KmsKeyName any
}

type SecretmanagerSecret_PolicyMember struct {
...
type SecretmanagerSecret_Replication_Automatic struct {
	// Configuration for encrypting secret payloads using customer-managed encryption keys (CMEK).
	CustomerManagedEncryption any
}

type SecretmanagerSecret_Replication_UserManaged_Replicas struct {
	CustomerManagedEncryption any
	Location any
}

type SecretmanagerSecret_Replication_UserManaged struct {
	// Required. The list of Replicas for this Secret. Cannot be empty.
	Replicas any
}

type SecretmanagerSecret_Replication struct {
...
type SecretmanagerSecret_Rotation_ManagedRotationStatus_Error struct {
...
type SecretmanagerSecret_Rotation_ManagedRotationStatus struct {
...
type SecretmanagerSecret_Rotation struct {
...
type SecretmanagerSecret_Topics struct {
	Name any
}

var SecretmanagerSecret_CustomerManagedEncryptionFields = ubx.FieldMap{
		"KmsKeyName": ubx.FieldSpec{WireName: "kms_key_name"},
	}

var SecretmanagerSecret_PolicyMemberFields = ubx.FieldMap{
...
var SecretmanagerSecret_Replication_AutomaticFields = ubx.FieldMap{
...
var SecretmanagerSecret_Replication_UserManaged_ReplicasFields = ubx.FieldMap{
		"CustomerManagedEncryption": ubx.FieldSpec{
			WireName: "customer_managed_encryption",
			Kind: "object",
			Fields: SecretmanagerSecret_CustomerManagedEncryptionFields,
...
var SecretmanagerSecret_Replication_UserManagedFields = ubx.FieldMap{
...
var SecretmanagerSecret_ReplicationFields = ubx.FieldMap{
...
var SecretmanagerSecret_Rotation_ManagedRotationStatus_ErrorFields = ubx.FieldMap{
		"Code": ubx.FieldSpec{WireName: "code"},
		"Details": ubx.FieldSpec{WireName: "details"},
		"Message": ubx.FieldSpec{WireName: "message"},
	}

var SecretmanagerSecret_Rotation_ManagedRotationStatusFields = ubx.FieldMap{
		"Error": ubx.FieldSpec{
			WireName: "error",
			Kind: "object",
...
var SecretmanagerSecret_RotationFields = ubx.FieldMap{
...
var SecretmanagerSecret_TopicsFields = ubx.FieldMap{
...
type SecretmanagerSecretAttrs struct {
	// Optional. Custom metadata about the secret. Annotations are distinct from various forms of labels. Annotations exist to allow client tools to store their own state information without requiring a database. Annotation keys must be between 1 and 63 characters long, have a UTF-8 encoding of maximum 128 bytes, begin and end with an alphanumeric character ([a-z0-9A-Z]), and may have dashes (-), underscores (_), dots (.), and alphanumerics in between these symbols. The total size of annotation keys and values must be less than 16KiB.
	Annotations any
	// Output only. The time at which the Secret was created.
	CreateTime any
...
var SecretmanagerSecret = ubx.ResourceBinding{
