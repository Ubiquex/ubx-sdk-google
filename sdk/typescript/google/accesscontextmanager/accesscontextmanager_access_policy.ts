...
export interface AccesscontextmanagerAccessPolicyConfig {
...
export interface AccesscontextmanagerAccessPolicyAttrs {
  /** Output only. An opaque identifier for the current version of the `AccessPolicy`. This will always be a strongly validated etag, meaning that two Access Policies will be identical if and only if their etags are identical. Clients should not expect this to be in any specific format. */
  etag: string;
  /** Output only. Identifier. Resource name of the `AccessPolicy`. Format: `accessPolicies/{access_policy}` */
  name: string;
...
export const AccesscontextmanagerAccessPolicy: ResourceBinding<AccesscontextmanagerAccessPolicyConfig, AccesscontextmanagerAccessPolicyAttrs> = {
  wireType: "google_accesscontextmanager_accesscontextmanager_access_policy",
  fields: {
    etag: "etag",
    name: "name",
    parent: "parent",
