...
export interface PubsubSnapshotConfig {
...
export interface PubsubSnapshotAttrs {
...
export const PubsubSnapshot: ResourceBinding<PubsubSnapshotConfig, PubsubSnapshotAttrs> = {
  wireType: "google_pubsub_pubsub_snapshot",
  fields: {
    labels: "labels",
