...
export interface CloudnumberregistryRealm_AggregatedData {
...
export interface CloudnumberregistryRealm_DiscoveryMetadata {
...
const CloudnumberregistryRealm_AggregatedDataFields: FieldMap = {
  customRangesCount: "custom_ranges_count",
  discoveredRangesCount: "discovered_ranges_count",
};

const CloudnumberregistryRealm_DiscoveryMetadataFields: FieldMap = {
...
export interface CloudnumberregistryRealmConfig {
  /** Aggregated data for the Realm. */
  aggregatedData?: CloudnumberregistryRealm_AggregatedData | Computed<CloudnumberregistryRealm_AggregatedData>;
  ...
  discoveryMetadata?: CloudnumberregistryRealm_DiscoveryMetadata | Computed<CloudnumberregistryRealm_DiscoveryMetadata>;
...
export interface CloudnumberregistryRealmAttrs {
  /** Aggregated data for the Realm. */
  aggregatedData: CloudnumberregistryRealm_AggregatedData;
  /** Output only. The time at which the Realm was created. */
  createTime: string;
  /** Metadata about a discovered resource, tracking event times, state, and source information. */
  discoveryMetadata: CloudnumberregistryRealm_DiscoveryMetadata;
  /** Optional. IP version of the Realm. */
  ipVersion: string;
  /** Optional. User-defined labels. */
...
export const CloudnumberregistryRealm: ResourceBinding<CloudnumberregistryRealmConfig, CloudnumberregistryRealmAttrs> = {
