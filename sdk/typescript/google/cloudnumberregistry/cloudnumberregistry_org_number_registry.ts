...
export interface CloudnumberregistryOrgNumberRegistryConfig {
...
export interface CloudnumberregistryOrgNumberRegistryAttrs {
  /** Required. The project that will act as the admin project for CNR resources Format: projects/{project_number} or projects/{project_id} */
  adminProject: string;
  /** Output only. The time at which the OrgNumberRegistry was created. */
  createTime: string;
...
export const CloudnumberregistryOrgNumberRegistry: ResourceBinding<CloudnumberregistryOrgNumberRegistryConfig, CloudnumberregistryOrgNumberRegistryAttrs> = {
