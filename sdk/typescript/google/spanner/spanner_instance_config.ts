// Code generated by `ubx sdk gen` from google_spanner_spanner_instance_config. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface SpannerInstanceConfig_InstanceConfig_OptionalReplicas {
  defaultLeaderLocation?: boolean | Computed<boolean>;
  location?: string | Computed<string>;
  type?: string | Computed<string>;
}

export interface SpannerInstanceConfig_InstanceConfig {
  ...
  optionalReplicas?: SpannerInstanceConfig_InstanceConfig_OptionalReplicas[] | Computed<SpannerInstanceConfig_InstanceConfig_OptionalReplicas[]>;
  ...
  replicas?: SpannerInstanceConfig_InstanceConfig_OptionalReplicas[] | Computed<SpannerInstanceConfig_InstanceConfig_OptionalReplicas[]>;
...
const SpannerInstanceConfig_InstanceConfig_OptionalReplicasFields: FieldMap = {
  defaultLeaderLocation: "default_leader_location",
  location: "location",
  type: "type",
};

const SpannerInstanceConfig_InstanceConfigFields: FieldMap = {
  ...
  optionalReplicas: {
    ...
    kind: "list",
    fields: SpannerInstanceConfig_InstanceConfig_OptionalReplicasFields,
  },
...
export interface SpannerInstanceConfigConfig {
  /** A possible configuration for a Cloud Spanner instance. Configurations define the geographic placement of nodes and their replication. */
  instanceConfig?: SpannerInstanceConfig_InstanceConfig | Computed<SpannerInstanceConfig_InstanceConfig>;
...
export interface SpannerInstanceConfigAttrs {
  /** Base configuration name, e.g. projects//instanceConfigs/nam3, based on which this configuration is created. Only set for user-managed configurations. `base_config` must refer to a configuration of type `GOOGLE_MANAGED` in the same project as this configuration. */
  baseConfig: string;
  /** Output only. Whether this instance configuration is a Google-managed or user-managed configuration. */
  configType: string;
  ...
  /** A possible configuration for a Cloud Spanner instance. Configurations define the geographic placement of nodes and their replication. */
  instanceConfig: SpannerInstanceConfig_InstanceConfig;
  /** Required. The ID of the instance configuration to create. Valid identifiers are of the form `custom-[-a-z0-9]*[a-z0-9]` and must be between 2 and 64 characters in length. The `custom-` prefix is required to avoid name conflicts with Google-managed configurations. */
  ...
  name: string;
  /** Output only. The available optional replicas to choose from for user-managed configurations. Populated for Google-managed configurations. */
  optionalReplicas: SpannerInstanceConfig_InstanceConfig_OptionalReplicas[];
  /** Output only. The `QuorumType` of the instance configuration. */
  quorumType: string;
  /** Output only. If true, the instance configuration is being created or updated. If false, there are no ongoing operations for the instance configuration. */
  reconciling: boolean;
  /** The geographic placement of nodes in this instance configuration and their replication properties. To create user-managed configurations, input `replicas` must include all replicas in `replicas` of the `base_config` and include one or more replicas in the `optional_replicas` of the `base_config`. */
  replicas: SpannerInstanceConfig_InstanceConfig_OptionalReplicas[];
  /** Output only. The current instance configuration state. Applicable only for `USER_MANAGED` configurations. */
  state: string;
  /** Output only. The storage limit in bytes per processing unit. */
...
export const SpannerInstanceConfig: ResourceBinding<SpannerInstanceConfigConfig, SpannerInstanceConfigAttrs> = {
  wireType: "google_spanner_spanner_instance_config",
  fields: {
    instanceConfig: {
      wireName: "instance_config",
      kind: "object",
      fields: SpannerInstanceConfig_InstanceConfigFields,
    },
