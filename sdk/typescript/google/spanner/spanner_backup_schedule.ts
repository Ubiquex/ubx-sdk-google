// Code generated by `ubx sdk gen` from google_spanner_spanner_backup_schedule. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface SpannerBackupSchedule_EncryptionConfig {
...
export interface SpannerBackupSchedule_Spec_CronSpec {
...
export interface SpannerBackupSchedule_Spec {
  /** CrontabSpec can be used to specify the version time and frequency at which the backup is created. */
  cronSpec?: SpannerBackupSchedule_Spec_CronSpec | Computed<SpannerBackupSchedule_Spec_CronSpec>;
}

const SpannerBackupSchedule_EncryptionConfigFields: FieldMap = {
  encryptionType: "encryption_type",
  kmsKeyName: "kms_key_name",
  kmsKeyNames: "kms_key_names",
};

const SpannerBackupSchedule_Spec_CronSpecFields: FieldMap = {
  creationWindow: "creation_window",
  text: "text",
  timeZone: "time_zone",
};

const SpannerBackupSchedule_SpecFields: FieldMap = {
  cronSpec: {
    wireName: "cron_spec",
    kind: "object",
    fields: SpannerBackupSchedule_Spec_CronSpecFields,
  },
};

export interface SpannerBackupScheduleConfig {
  /** Encryption configuration for the backup to create. */
  encryptionConfig?: SpannerBackupSchedule_EncryptionConfig | Computed<SpannerBackupSchedule_EncryptionConfig>;
  ...
  spec?: SpannerBackupSchedule_Spec | Computed<SpannerBackupSchedule_Spec>;
...
export interface SpannerBackupScheduleAttrs {
  /** Encryption configuration for the backup to create. */
  encryptionConfig: SpannerBackupSchedule_EncryptionConfig;
  /** The specification for full backups. A full backup stores the entire contents of the database at a given version time. */
  ...
  /** Defines specifications of the backup schedule. */
  spec: SpannerBackupSchedule_Spec;
  /** Output only. The timestamp at which the schedule was last updated. If the schedule has never been updated, this field contains the timestamp when the schedule was first created. */
  updateTime: string;
}

export const SpannerBackupSchedule: ResourceBinding<SpannerBackupScheduleConfig, SpannerBackupScheduleAttrs> = {
  wireType: "google_spanner_spanner_backup_schedule",
  fields: {
    encryptionConfig: {
      wireName: "encryption_config",
      kind: "object",
      fields: SpannerBackupSchedule_EncryptionConfigFields,
    },
    ...
    spec: {
      wireName: "spec",
      kind: "object",
      fields: SpannerBackupSchedule_SpecFields,
    },
