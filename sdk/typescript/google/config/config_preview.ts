...
export interface ConfigPreview_ErrorStatus {
...
export interface ConfigPreview_PreviewArtifacts {
...
export interface ConfigPreview_ProviderConfig {
  /** Optional. ProviderSource specifies the source type of the provider. */
  sourceType?: string | Computed<string>;
}

export interface ConfigPreview_TerraformBlueprint_ExternalValues_DeploymentSource {
  deployment?: string | Computed<string>;
  outputName?: string | Computed<string>;
}

export interface ConfigPreview_TerraformBlueprint_ExternalValues {
  deploymentSource?: ConfigPreview_TerraformBlueprint_ExternalValues_DeploymentSource | Computed<ConfigPreview_TerraformBlueprint_ExternalValues_DeploymentSource>;
}

export interface ConfigPreview_TerraformBlueprint_GitSource {
...
export interface ConfigPreview_TerraformBlueprint_InputValues {
  inputValue?: unknown | Computed<unknown>;
}

export interface ConfigPreview_TerraformBlueprint {
  /** Optional. Map of input variable names in this blueprint to configurations for importing values from external sources. */
  externalValues?: Record<string, ConfigPreview_TerraformBlueprint_ExternalValues> | Computed<Record<string, ConfigPreview_TerraformBlueprint_ExternalValues>>;
  ...
  gitSource?: ConfigPreview_TerraformBlueprint_GitSource | Computed<ConfigPreview_TerraformBlueprint_GitSource>;
  /** Optional. Input variable values for the Terraform blueprint. */
  inputValues?: Record<string, ConfigPreview_TerraformBlueprint_InputValues> | Computed<Record<string, ConfigPreview_TerraformBlueprint_InputValues>>;
}

export interface ConfigPreview_TfErrors {
  error?: ConfigPreview_ErrorStatus | Computed<ConfigPreview_ErrorStatus>;
  errorDescription?: string | Computed<string>;
  httpResponseCode?: number | Computed<number>;
  resourceAddress?: string | Computed<string>;
}

const ConfigPreview_ErrorStatusFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const ConfigPreview_PreviewArtifactsFields: FieldMap = {
  artifacts: "artifacts",
  content: "content",
};

const ConfigPreview_ProviderConfigFields: FieldMap = {
  sourceType: "source_type",
};

const ConfigPreview_TerraformBlueprint_ExternalValues_DeploymentSourceFields: FieldMap = {
  deployment: "deployment",
  outputName: "output_name",
};

const ConfigPreview_TerraformBlueprint_ExternalValuesFields: FieldMap = {
  deploymentSource: {
    wireName: "deployment_source",
    kind: "object",
    fields: ConfigPreview_TerraformBlueprint_ExternalValues_DeploymentSourceFields,
  },
};

const ConfigPreview_TerraformBlueprint_GitSourceFields: FieldMap = {
  directory: "directory",
  ref: "ref",
  repo: "repo",
};

const ConfigPreview_TerraformBlueprint_InputValuesFields: FieldMap = {
  inputValue: "input_value",
};

const ConfigPreview_TerraformBlueprintFields: FieldMap = {
  externalValues: {
    wireName: "external_values",
    kind: "map",
    fields: ConfigPreview_TerraformBlueprint_ExternalValuesFields,
  },
  gcsSource: "gcs_source",
  gitSource: {
    wireName: "git_source",
    kind: "object",
    fields: ConfigPreview_TerraformBlueprint_GitSourceFields,
  },
  inputValues: {
    wireName: "input_values",
    kind: "map",
    fields: ConfigPreview_TerraformBlueprint_InputValuesFields,
  },
};

const ConfigPreview_TfErrorsFields: FieldMap = {
  error: {
    wireName: "error",
    kind: "object",
    fields: ConfigPreview_ErrorStatusFields,
  },
...
export interface ConfigPreviewConfig {
  ...
  errorStatus?: ConfigPreview_ErrorStatus | Computed<ConfigPreview_ErrorStatus>;
  ...
  previewArtifacts?: ConfigPreview_PreviewArtifacts | Computed<ConfigPreview_PreviewArtifacts>;
  /** Optional. Current mode of preview. */
  previewMode?: string | Computed<string>;
  /** ProviderConfig contains the provider configurations. */
  providerConfig?: ConfigPreview_ProviderConfig | Computed<ConfigPreview_ProviderConfig>;
  ...
  terraformBlueprint?: ConfigPreview_TerraformBlueprint | Computed<ConfigPreview_TerraformBlueprint>;
  ...
  tfErrors?: ConfigPreview_TfErrors[] | Computed<ConfigPreview_TfErrors[]>;
...
export interface ConfigPreviewAttrs {
  /** Optional. Arbitrary key-value metadata storage e.g. to help client tools identify preview during automation. See https://google.aip.dev/148#annotations for details on format and size limitations. */
  ...
  errorLogs: string;
  /** The `Status` type defines a logical error model that is suitable for different programming environments, including REST APIs and RPC APIs. It is used by [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error code, error message, and error details. You can find out more about this error model and how to work with it in the [API Design Guide](https://cloud.google.com/apis/design/errors). */
  errorStatus: ConfigPreview_ErrorStatus;
  /** Optional. User-defined labels for the preview. */
  ...
  name: string;
  /** Artifacts created by preview. */
  previewArtifacts: ConfigPreview_PreviewArtifacts;
  /** Optional. Current mode of preview. */
  previewMode: string;
  /** ProviderConfig contains the provider configurations. */
  providerConfig: ConfigPreview_ProviderConfig;
  /** Required. User-specified Service Account (SA) credentials to be used when previewing resources. Format: `projects/{projectID}/serviceAccounts/{serviceAccount}` */
  serviceAccount: string;
  /** Output only. Current state of the preview. */
  state: string;
  /** TerraformBlueprint describes the source of a Terraform root module which describes the resources and configs to be deployed. */
  terraformBlueprint: ConfigPreview_TerraformBlueprint;
  /** Output only. Summary of errors encountered during Terraform preview. It has a size limit of 10, i.e. only top 10 errors will be summarized here. */
  tfErrors: ConfigPreview_TfErrors[];
  /** Output only. The current Terraform version set on the preview. It is in the format of "Major.Minor.Patch", for example, "1.3.10". */
  tfVersion: string;
  /** The user-specified Terraform version constraint. Example: "=1.3.10". */
...
export const ConfigPreview: ResourceBinding<ConfigPreviewConfig, ConfigPreviewAttrs> = {
  wireType: "google_config_config_preview",
  fields: {
    ...
    previewArtifacts: {
      ...
      kind: "object",
      fields: ConfigPreview_PreviewArtifactsFields,
    },
    previewMode: "preview_mode",
    providerConfig: {
      wireName: "provider_config",
      kind: "object",
      fields: ConfigPreview_ProviderConfigFields,
    },
    ...
    terraformBlueprint: {
      ...
      kind: "object",
      fields: ConfigPreview_TerraformBlueprintFields,
    },
    tfErrors: {
      wireName: "tf_errors",
      kind: "list",
      fields: ConfigPreview_TfErrorsFields,
    },
