// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_global_address. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaGlobalAddressConfig {
...
export interface BetaComputeBetaGlobalAddressAttrs {
  /** The static IP address represented by this resource. */
  address: string;
  /** The type of address to reserve, either INTERNAL orEXTERNAL. If unspecified, defaults to EXTERNAL. */
  addressType: string;
...
export const BetaComputeBetaGlobalAddress: ResourceBinding<BetaComputeBetaGlobalAddressConfig, BetaComputeBetaGlobalAddressAttrs> = {
  wireType: "google_compute_beta_compute_beta_global_address",
  fields: {
    address: "address",
