// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_target_http_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaTargetHttpProxyConfig {
...
export interface AlphaComputeAlphaTargetHttpProxyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const AlphaComputeAlphaTargetHttpProxy: ResourceBinding<AlphaComputeAlphaTargetHttpProxyConfig, AlphaComputeAlphaTargetHttpProxyAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_target_http_proxy",
  fields: {
