...
export interface RegionSslCertificate_Managed {
...
export interface RegionSslCertificate_SelfManaged {
...
const RegionSslCertificate_ManagedFields: FieldMap = {
  domainStatus: "domain_status",
  domains: "domains",
  status: "status",
};

const RegionSslCertificate_SelfManagedFields: FieldMap = {
...
export interface RegionSslCertificateConfig {
  ...
  managed?: RegionSslCertificate_Managed | Computed<RegionSslCertificate_Managed>;
  ...
  selfManaged?: RegionSslCertificate_SelfManaged | Computed<RegionSslCertificate_SelfManaged>;
...
export interface RegionSslCertificateAttrs {
  ...
  kind: string;
  /** Configuration and status of a managed SSL certificate. */
  managed: RegionSslCertificate_Managed;
  /** Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and comply withRFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash. */
  name: string;
  /** A value read into memory from a write-only private key file. The private key file must be in PEM format. For security, only insert requests include this field. */
  privateKey: string;
  ...
  selfLink: string;
  /** Configuration and status of a self-managed SSL certificate. */
  selfManaged: RegionSslCertificate_SelfManaged;
  /** Output only. [Output Only] Domains associated with the certificate via Subject Alternative Name. */
...
export const RegionSslCertificate: ResourceBinding<RegionSslCertificateConfig, RegionSslCertificateAttrs> = {
  ...
  fields: {
    ...
    managed: {
      wireName: "managed",
      kind: "object",
      fields: RegionSslCertificate_ManagedFields,
    },
    name: "name",
    privateKey: "private_key",
    region: "region",
    ...
    selfManaged: {
      ...
      kind: "object",
      fields: RegionSslCertificate_SelfManagedFields,
    },
