// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_region_instant_snapshot. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaRegionInstantSnapshot_Params {
...
export interface AlphaComputeAlphaRegionInstantSnapshot_ResourceStatus {
  /** [Output Only] The storage size of this instant snapshot. */
  storageSizeBytes?: string | Computed<string>;
}

const AlphaComputeAlphaRegionInstantSnapshot_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaComputeAlphaRegionInstantSnapshot_ResourceStatusFields: FieldMap = {
  storageSizeBytes: "storage_size_bytes",
};

export interface AlphaComputeAlphaRegionInstantSnapshotConfig {
  ...
  params?: AlphaComputeAlphaRegionInstantSnapshot_Params | Computed<AlphaComputeAlphaRegionInstantSnapshot_Params>;
  ...
  resourceStatus?: AlphaComputeAlphaRegionInstantSnapshot_ResourceStatus | Computed<AlphaComputeAlphaRegionInstantSnapshot_ResourceStatus>;
...
export interface AlphaComputeAlphaRegionInstantSnapshotAttrs {
  /** Output only. [Output Only] The architecture of the instant snapshot. Valid values are ARM64 or X86_64. */
  architecture: string;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  name: string;
  /** Additional instant snapshot params. */
  params: AlphaComputeAlphaRegionInstantSnapshot_Params;
  /** Output only. [Output Only] URL of the region where the instant snapshot resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  resourceStatus: AlphaComputeAlphaRegionInstantSnapshot_ResourceStatus;
  /** Output only. Reserved for future use. */
...
export const AlphaComputeAlphaRegionInstantSnapshot: ResourceBinding<AlphaComputeAlphaRegionInstantSnapshotConfig, AlphaComputeAlphaRegionInstantSnapshotAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_region_instant_snapshot",
  fields: {
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: AlphaComputeAlphaRegionInstantSnapshot_ParamsFields,
    },
    region: "region",
    resourceStatus: {
      wireName: "resource_status",
      kind: "object",
      fields: AlphaComputeAlphaRegionInstantSnapshot_ResourceStatusFields,
    },
