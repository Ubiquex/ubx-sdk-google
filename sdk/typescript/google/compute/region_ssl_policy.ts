...
const RegionSslPolicy_Warnings_DataFields: FieldMap = {
  key: "key",
  value: "value",
};

const RegionSslPolicy_WarningsFields: FieldMap = {
  code: "code",
  data: {
    wireName: "data",
    kind: "list",
...
export interface RegionSslPolicyConfig {
  ...
  warnings?: RegionSslPolicy_Warnings[] | Computed<RegionSslPolicy_Warnings[]>;
}
