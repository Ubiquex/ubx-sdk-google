// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_route. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaRoute_AsPaths {
  asLists?: number[] | Computed<number[]>;
  pathSegmentType?: string | Computed<string>;
}

export interface AlphaComputeAlphaRoute_Params {
...
export interface AlphaComputeAlphaRoute_Warnings_Data {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface AlphaComputeAlphaRoute_Warnings {
  code?: string | Computed<string>;
  data?: AlphaComputeAlphaRoute_Warnings_Data[] | Computed<AlphaComputeAlphaRoute_Warnings_Data[]>;
  message?: string | Computed<string>;
}

const AlphaComputeAlphaRoute_AsPathsFields: FieldMap = {
  asLists: "as_lists",
  pathSegmentType: "path_segment_type",
};

const AlphaComputeAlphaRoute_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaComputeAlphaRoute_Warnings_DataFields: FieldMap = {
  key: "key",
  value: "value",
};

const AlphaComputeAlphaRoute_WarningsFields: FieldMap = {
  code: "code",
  data: {
    wireName: "data",
    kind: "list",
    fields: AlphaComputeAlphaRoute_Warnings_DataFields,
  },
  message: "message",
};

export interface AlphaComputeAlphaRouteConfig {
  ...
  asPaths?: AlphaComputeAlphaRoute_AsPaths[] | Computed<AlphaComputeAlphaRoute_AsPaths[]>;
  ...
  params?: AlphaComputeAlphaRoute_Params | Computed<AlphaComputeAlphaRoute_Params>;
  ...
  warnings?: AlphaComputeAlphaRoute_Warnings[] | Computed<AlphaComputeAlphaRoute_Warnings[]>;
}

export interface AlphaComputeAlphaRouteAttrs {
  /** Whether this route can conflict with existing subnetworks. Setting this to true allows this route to conflict with subnetworks that have already been configured on the corresponding network. */
  allowConflictingSubnetworks: boolean;
  /** Output only. [Output Only] AS path. */
  asPaths: AlphaComputeAlphaRoute_AsPaths[];
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** Additional route parameters. */
  params: AlphaComputeAlphaRoute_Params;
  /** The priority of this route. Priority is used to break ties in cases where there is more than one matching route of equal prefix length. In cases where multiple routes have equal prefix length, the one with the lowest-numbered priority value wins. The default value is `1000`. The priority value must be from `0` to `65535`, inclusive. */
  priority: number;
  /** [Output only] The status of the route. This status applies to dynamic routes learned by Cloud Routers. It is also applicable to routes undergoing migration. */
  routeStatus: string;
  ...
  tags: string[];
  /** Output only. [Output Only] If potential misconfigurations are detected for this route, this field will be populated with warning messages. */
  warnings: AlphaComputeAlphaRoute_Warnings[];
}

export const AlphaComputeAlphaRoute: ResourceBinding<AlphaComputeAlphaRouteConfig, AlphaComputeAlphaRouteAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_route",
  fields: {
    allowConflictingSubnetworks: "allow_conflicting_subnetworks",
    asPaths: {
      wireName: "as_paths",
      kind: "list",
      fields: AlphaComputeAlphaRoute_AsPathsFields,
    },
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: AlphaComputeAlphaRoute_ParamsFields,
    },
    priority: "priority",
    ...
    warnings: {
      wireName: "warnings",
      kind: "list",
      fields: AlphaComputeAlphaRoute_WarningsFields,
    },
  },
};
