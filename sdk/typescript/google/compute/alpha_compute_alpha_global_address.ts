...
export interface AlphaComputeAlphaGlobalAddressConfig {
  ...
  ptrDomainName?: string | Computed<string>;
  /** The TTL in seconds for public DNS PTR record. */
  ptrDomainNameTtl?: number | Computed<number>;
...
export interface AlphaComputeAlphaGlobalAddressAttrs {
  /** The static IP address represented by this resource. */
  address: string;
  /** The type of address to reserve, either INTERNAL orEXTERNAL. If unspecified, defaults to EXTERNAL. */
  addressType: string;
...
export const AlphaComputeAlphaGlobalAddress: ResourceBinding<AlphaComputeAlphaGlobalAddressConfig, AlphaComputeAlphaGlobalAddressAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_global_address",
  fields: {
    address: "address",
    ...
    ptrDomainName: "ptr_domain_name",
    ptrDomainNameTtl: "ptr_domain_name_ttl",
    purpose: "purpose",
    region: "region",
    selfLink: "self_link",
