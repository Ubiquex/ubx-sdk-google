// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_interconnect. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages {
  percentage?: number | Computed<number>;
  trafficClass?: string | Computed<string>;
}

export interface BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy {
  /** Specify bandwidth percentages for various traffic classes for queuing type Bandwidth Percent. */
  bandwidthPercentages?: BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[] | Computed<BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[]>;
}

export interface BetaComputeBetaInterconnect_ApplicationAwareInterconnect {
  bandwidthPercentagePolicy?: BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy | Computed<BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy>;
  ...
  shapeAveragePercentages?: BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[] | Computed<BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[]>;
  /** Specify configuration for StrictPriorityPolicy. */
  strictPriorityPolicy?: unknown | Computed<unknown>;
}

export interface BetaComputeBetaInterconnect_CircuitInfos {
  customerDemarcId?: string | Computed<string>;
  googleCircuitId?: string | Computed<string>;
  googleDemarcId?: string | Computed<string>;
}

export interface BetaComputeBetaInterconnect_ExpectedOutages {
...
export interface BetaComputeBetaInterconnect_Macsec_PreSharedKeys {
  name?: string | Computed<string>;
  startTime?: string | Computed<string>;
}

export interface BetaComputeBetaInterconnect_Macsec {
  ...
  preSharedKeys?: BetaComputeBetaInterconnect_Macsec_PreSharedKeys[] | Computed<BetaComputeBetaInterconnect_Macsec_PreSharedKeys[]>;
}

export interface BetaComputeBetaInterconnect_Params {
...
const BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentagesFields: FieldMap = {
  percentage: "percentage",
  trafficClass: "traffic_class",
};

const BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicyFields: FieldMap = {
  bandwidthPercentages: {
    wireName: "bandwidth_percentages",
    kind: "list",
    fields: BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentagesFields,
  },
};

const BetaComputeBetaInterconnect_ApplicationAwareInterconnectFields: FieldMap = {
  bandwidthPercentagePolicy: {
    wireName: "bandwidth_percentage_policy",
    kind: "object",
    fields: BetaComputeBetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicyFields,
  },
...
const BetaComputeBetaInterconnect_CircuitInfosFields: FieldMap = {
  customerDemarcId: "customer_demarc_id",
  googleCircuitId: "google_circuit_id",
  googleDemarcId: "google_demarc_id",
};

const BetaComputeBetaInterconnect_ExpectedOutagesFields: FieldMap = {
...
const BetaComputeBetaInterconnect_Macsec_PreSharedKeysFields: FieldMap = {
  name: "name",
  startTime: "start_time",
};

const BetaComputeBetaInterconnect_MacsecFields: FieldMap = {
  failOpen: "fail_open",
  preSharedKeys: {
    wireName: "pre_shared_keys",
    kind: "list",
    fields: BetaComputeBetaInterconnect_Macsec_PreSharedKeysFields,
  },
};

const BetaComputeBetaInterconnect_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

export interface BetaComputeBetaInterconnectConfig {
  ...
  applicationAwareInterconnect?: BetaComputeBetaInterconnect_ApplicationAwareInterconnect | Computed<BetaComputeBetaInterconnect_ApplicationAwareInterconnect>;
  ...
  circuitInfos?: BetaComputeBetaInterconnect_CircuitInfos[] | Computed<BetaComputeBetaInterconnect_CircuitInfos[]>;
  ...
  expectedOutages?: BetaComputeBetaInterconnect_ExpectedOutages[] | Computed<BetaComputeBetaInterconnect_ExpectedOutages[]>;
  ...
  macsec?: BetaComputeBetaInterconnect_Macsec | Computed<BetaComputeBetaInterconnect_Macsec>;
  ...
  params?: BetaComputeBetaInterconnect_Params | Computed<BetaComputeBetaInterconnect_Params>;
...
export interface BetaComputeBetaInterconnectAttrs {
  /** Enable or disable the application awareness feature on this Cloud Interconnect. */
  aaiEnabled: boolean;
  /** Administrative status of the interconnect. When this is set to true, the Interconnect is functional and can carry traffic. When set to false, no packets can be carried over the interconnect and no BGP routes are exchanged over it. By default, the status is set to true. */
  adminEnabled: boolean;
  /** Configuration information for application awareness on this Cloud Interconnect. */
  applicationAwareInterconnect: BetaComputeBetaInterconnect_ApplicationAwareInterconnect;
  /** [Output only] List of features available for this Interconnect connection, which can take one of the following values: - IF_MACSEC: If present, then the Interconnect connection is provisioned on MACsec capable hardware ports. If not present, then the Interconnect connection is provisioned on non-MACsec capable ports. Any attempt to enable MACsec will fail. - IF_CROSS_SITE_NETWORK: If present, then the Interconnect connection is provisioned exclusively for Cross-Site Networking. Any attempt to configure VLAN attachments will fail. If not present, then the Interconnect connection is not provisioned for Cross-Site Networking. Any attempt to use it for Cross-Site Networking will fail. */
  availableFeatures: string[];
  /** Output only. [Output Only] A list of CircuitInfo objects, that describe the individual circuits in this LAG. */
  circuitInfos: BetaComputeBetaInterconnect_CircuitInfos[];
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** Output only. [Output Only] A list of outages expected for this Interconnect. */
  expectedOutages: BetaComputeBetaInterconnect_ExpectedOutages[];
  /** Output only. [Output Only] IP address configured on the Google side of the Interconnect link. This can be used only for ping tests. */
  ...
  location: string;
  /** Configuration information for enabling Media Access Control security (MACsec) on this Cloud Interconnect connection between Google and your on-premises router. */
  macsec: BetaComputeBetaInterconnect_Macsec;
  /** Enable or disable MACsec on this Interconnect connection. MACsec enablement fails if the MACsec object is not specified. */
  ...
  /** Additional interconnect parameters. */
  params: BetaComputeBetaInterconnect_Params;
  /** Output only. [Output Only] IP address configured on the customer side of the Interconnect link. The customer should configure this IP address during turnup when prompted by Google NOC. This can be used only for ping tests. */
...
export const BetaComputeBetaInterconnect: ResourceBinding<BetaComputeBetaInterconnectConfig, BetaComputeBetaInterconnectAttrs> = {
  wireType: "google_compute_beta_compute_beta_interconnect",
  fields: {
    ...
    applicationAwareInterconnect: {
      ...
      kind: "object",
      fields: BetaComputeBetaInterconnect_ApplicationAwareInterconnectFields,
    },
    availableFeatures: "available_features",
    circuitInfos: {
      wireName: "circuit_infos",
      kind: "list",
      fields: BetaComputeBetaInterconnect_CircuitInfosFields,
    },
    ...
    expectedOutages: {
      ...
      kind: "list",
      fields: BetaComputeBetaInterconnect_ExpectedOutagesFields,
    },
    ...
    macsec: {
      wireName: "macsec",
      kind: "object",
      fields: BetaComputeBetaInterconnect_MacsecFields,
    },
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaComputeBetaInterconnect_ParamsFields,
    },
