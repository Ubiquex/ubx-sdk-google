// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_region_target_tcp_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaRegionTargetTcpProxyConfig {
...
export interface BetaComputeBetaRegionTargetTcpProxyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaComputeBetaRegionTargetTcpProxy: ResourceBinding<BetaComputeBetaRegionTargetTcpProxyConfig, BetaComputeBetaRegionTargetTcpProxyAttrs> = {
  wireType: "google_compute_beta_compute_beta_region_target_tcp_proxy",
  fields: {
