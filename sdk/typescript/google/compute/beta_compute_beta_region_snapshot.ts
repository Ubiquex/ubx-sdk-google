// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_region_snapshot. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaRegionSnapshot_GuestOsFeatures {
  type?: string | Computed<string>;
}

export interface BetaComputeBetaRegionSnapshot_Params {
...
export interface BetaComputeBetaRegionSnapshot_SnapshotEncryptionKey {
...
const BetaComputeBetaRegionSnapshot_GuestOsFeaturesFields: FieldMap = {
  type: "type",
};

const BetaComputeBetaRegionSnapshot_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaComputeBetaRegionSnapshot_SnapshotEncryptionKeyFields: FieldMap = {
...
export interface BetaComputeBetaRegionSnapshotConfig {
  ...
  guestOsFeatures?: BetaComputeBetaRegionSnapshot_GuestOsFeatures[] | Computed<BetaComputeBetaRegionSnapshot_GuestOsFeatures[]>;
  ...
  params?: BetaComputeBetaRegionSnapshot_Params | Computed<BetaComputeBetaRegionSnapshot_Params>;
  ...
  snapshotEncryptionKey?: BetaComputeBetaRegionSnapshot_SnapshotEncryptionKey | Computed<BetaComputeBetaRegionSnapshot_SnapshotEncryptionKey>;
  ...
  sourceDiskEncryptionKey?: BetaComputeBetaRegionSnapshot_SnapshotEncryptionKey | Computed<BetaComputeBetaRegionSnapshot_SnapshotEncryptionKey>;
  ...
  sourceInstantSnapshotEncryptionKey?: BetaComputeBetaRegionSnapshot_SnapshotEncryptionKey | Computed<BetaComputeBetaRegionSnapshot_SnapshotEncryptionKey>;
...
export interface BetaComputeBetaRegionSnapshotAttrs {
  /** Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64. */
  architecture: string;
  /** Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk. */
  autoCreated: boolean;
  ...
  guestFlush: boolean;
  /** Output only. [Output Only] A list of features to enable on the guest operating system. Applicable only for bootable images. Read Enabling guest operating system features to see a list of available options. */
  guestOsFeatures: BetaComputeBetaRegionSnapshot_GuestOsFeatures[];
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  /** Output only. [Output Only] Type of the resource. Always compute#snapshot for Snapshot resources. */
  kind: string;
  ...
  name: string;
  /** Additional snapshot params. */
  params: BetaComputeBetaRegionSnapshot_Params;
  /** Output only. [Output Only] URL of the region where the snapshot resides. Only applicable for regional snapshots. */
  region: string;
  /** Output only. Reserved for future use. */
  ...
  /** Output only. [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  snapshotEncryptionKey: BetaComputeBetaRegionSnapshot_SnapshotEncryptionKey;
  /** Output only. [Output Only] The unique ID of the snapshot group that this snapshot belongs to. The usage of snapshot group feature is restricted. */
  ...
  /** The source disk used to create this snapshot. */
  sourceDisk: string;
  sourceDiskEncryptionKey: BetaComputeBetaRegionSnapshot_SnapshotEncryptionKey;
  /** The source disk whose recovery checkpoint will be used to create this snapshot. */
  ...
  sourceInstantSnapshotEncryptionKey: BetaComputeBetaRegionSnapshot_SnapshotEncryptionKey;
  /** Output only. [Output Only] The unique ID of the instant snapshot used to create this snapshot. This value identifies the exact instant snapshot that was used to create this snapshot. For example, if you created the snapshot from an instant snapshot that was later deleted and recreated under the same name, the source instant snapshot ID would identify the exact instant snapshot that was used. */
...
export const BetaComputeBetaRegionSnapshot: ResourceBinding<BetaComputeBetaRegionSnapshotConfig, BetaComputeBetaRegionSnapshotAttrs> = {
  wireType: "google_compute_beta_compute_beta_region_snapshot",
  fields: {
    ...
    guestOsFeatures: {
      ...
      kind: "list",
      fields: BetaComputeBetaRegionSnapshot_GuestOsFeaturesFields,
    },
    id: "id",
    kind: "kind",
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaComputeBetaRegionSnapshot_ParamsFields,
    },
    region: "region",
    ...
    snapshotEncryptionKey: {
      ...
      kind: "object",
      fields: BetaComputeBetaRegionSnapshot_SnapshotEncryptionKeyFields,
    },
