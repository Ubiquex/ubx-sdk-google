// Code generated by `ubx sdk gen` from google_compute_alpha_image. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaImage_Deprecated_StateOverride {
...
export interface AlphaImage_Deprecated {
  ...
  stateOverride?: AlphaImage_Deprecated_StateOverride | Computed<AlphaImage_Deprecated_StateOverride>;
}

export interface AlphaImage_GuestOsFeatures {
  type?: string | Computed<string>;
}

export interface AlphaImage_ImageEncryptionKey {
...
export interface AlphaImage_Params {
...
export interface AlphaImage_RawDisk {
...
export interface AlphaImage_ShieldedInstanceInitialState_Dbs {
  content?: string | Computed<string>;
  fileType?: string | Computed<string>;
}

export interface AlphaImage_ShieldedInstanceInitialState {
  /** The Key Database (db). */
  dbs?: AlphaImage_ShieldedInstanceInitialState_Dbs[] | Computed<AlphaImage_ShieldedInstanceInitialState_Dbs[]>;
  /** The forbidden key database (dbx). */
  dbxs?: AlphaImage_ShieldedInstanceInitialState_Dbs[] | Computed<AlphaImage_ShieldedInstanceInitialState_Dbs[]>;
  /** The Key Exchange Key (KEK). */
  keks?: AlphaImage_ShieldedInstanceInitialState_Dbs[] | Computed<AlphaImage_ShieldedInstanceInitialState_Dbs[]>;
  pk?: AlphaImage_ShieldedInstanceInitialState_Dbs | Computed<AlphaImage_ShieldedInstanceInitialState_Dbs>;
}

const AlphaImage_Deprecated_StateOverrideFields: FieldMap = {
  defaultRolloutTime: "default_rollout_time",
  locationRolloutPolicies: "location_rollout_policies",
};

const AlphaImage_DeprecatedFields: FieldMap = {
  deleted: "deleted",
...
const AlphaImage_GuestOsFeaturesFields: FieldMap = {
  type: "type",
};

const AlphaImage_ImageEncryptionKeyFields: FieldMap = {
...
const AlphaImage_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaImage_RawDiskFields: FieldMap = {
  containerType: "container_type",
  sha1Checksum: "sha1_checksum",
  source: "source",
};

const AlphaImage_ShieldedInstanceInitialState_DbsFields: FieldMap = {
  content: "content",
  fileType: "file_type",
};

const AlphaImage_ShieldedInstanceInitialStateFields: FieldMap = {
  dbs: {
    wireName: "dbs",
    kind: "list",
...
export interface AlphaImageConfig {
  ...
  deprecated?: AlphaImage_Deprecated | Computed<AlphaImage_Deprecated>;
  ...
  guestOsFeatures?: AlphaImage_GuestOsFeatures[] | Computed<AlphaImage_GuestOsFeatures[]>;
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id?: string | Computed<string>;
  imageEncryptionKey?: AlphaImage_ImageEncryptionKey | Computed<AlphaImage_ImageEncryptionKey>;
  ...
  params?: AlphaImage_Params | Computed<AlphaImage_Params>;
  /** The parameters of the raw disk image. */
  rawDisk?: AlphaImage_RawDisk | Computed<AlphaImage_RawDisk>;
  /** A rollout policy configuration. */
  rolloutOverride?: AlphaImage_Deprecated_StateOverride | Computed<AlphaImage_Deprecated_StateOverride>;
  ...
  shieldedInstanceInitialState?: AlphaImage_ShieldedInstanceInitialState | Computed<AlphaImage_ShieldedInstanceInitialState>;
  /** URL of the source disk used to create this image. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone/disks/disk - projects/project/zones/zone/disks/disk - zones/zone/disks/disk In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceDisk?: string | Computed<string>;
  sourceDiskEncryptionKey?: AlphaImage_ImageEncryptionKey | Computed<AlphaImage_ImageEncryptionKey>;
  ...
  sourceImageEncryptionKey?: AlphaImage_ImageEncryptionKey | Computed<AlphaImage_ImageEncryptionKey>;
  ...
  sourceSnapshotEncryptionKey?: AlphaImage_ImageEncryptionKey | Computed<AlphaImage_ImageEncryptionKey>;
...
export interface AlphaImageAttrs {
  /** The architecture of the image. Valid values are ARM64 or X86_64. */
  architecture: string;
  /** Size of the image tar.gz archive stored in Google Cloud Storage (in bytes). */
  ...
  /** Deprecation status for a public resource. */
  deprecated: AlphaImage_Deprecated;
  /** An optional description of this resource. Provide this property when you create the resource. */
  description: string;
  /** Size of the image when restored onto a persistent disk (in GB). */
  diskSizeGb: string;
  ...
  family: string;
  /** A list of features to enable on the guest operating system. Applicable only for bootable images. To see a list of available options, see theguestOSfeatures[].type parameter. */
  guestOsFeatures: AlphaImage_GuestOsFeatures[];
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  imageEncryptionKey: AlphaImage_ImageEncryptionKey;
  /** Output only. [Output Only] Type of the resource. Always compute#image for images. */
  kind: string;
  /** A fingerprint for the labels being applied to this image, which is essentially a hash of the labels used for optimistic locking. The fingerprint is initially generated by Compute Engine and changes after every request to modify or update labels. You must always provide an up-to-date fingerprint hash in order to update or change labels, otherwise the request will fail with error412 conditionNotMet. To see the latest fingerprint, make a get() request to retrieve an image. */
  ...
  name: string;
  /** Additional image params. */
  params: AlphaImage_Params;
  /** The parameters of the raw disk image. */
  rawDisk: AlphaImage_RawDisk;
  /** A rollout policy configuration. */
  rolloutOverride: AlphaImage_Deprecated_StateOverride;
  /** Output only. Reserved for future use. */
  ...
  /** Initial State for shielded instance, these are public keys which are safe to store in public */
  shieldedInstanceInitialState: AlphaImage_ShieldedInstanceInitialState;
  /** URL of the source disk used to create this image. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone/disks/disk - projects/project/zones/zone/disks/disk - zones/zone/disks/disk In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceDisk: string;
  sourceDiskEncryptionKey: AlphaImage_ImageEncryptionKey;
  /** Output only. [Output Only] The ID value of the disk used to create this image. This value may be used to determine whether the image was taken from the current or a previous instance of a given disk name. */
  sourceDiskId: string;
  /** URL of the source image used to create this image. The following are valid formats for the URL: - https://www.googleapis.com/compute/v1/projects/project_id/global/ images/image_name - projects/project_id/global/images/image_name In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceImage: string;
  sourceImageEncryptionKey: AlphaImage_ImageEncryptionKey;
  /** Output only. [Output Only] The ID value of the image used to create this image. This value may be used to determine whether the image was taken from the current or a previous instance of a given image name. */
  sourceImageId: string;
  /** URL of the source snapshot used to create this image. The following are valid formats for the URL: - https://www.googleapis.com/compute/v1/projects/project_id/global/ snapshots/snapshot_name - projects/project_id/global/snapshots/snapshot_name In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceSnapshot: string;
  sourceSnapshotEncryptionKey: AlphaImage_ImageEncryptionKey;
  /** Output only. [Output Only] The ID value of the snapshot used to create this image. This value may be used to determine whether the snapshot was taken from the current or a previous instance of a given snapshot name. */
...
export const AlphaImage: ResourceBinding<AlphaImageConfig, AlphaImageAttrs> = {
