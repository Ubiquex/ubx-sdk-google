...
export interface BetaComputeBetaVpnTunnel_CipherSuite_Phase1 {
...
export interface BetaComputeBetaVpnTunnel_CipherSuite_Phase2 {
  encryption?: string[] | Computed<string[]>;
  integrity?: string[] | Computed<string[]>;
  pfs?: string[] | Computed<string[]>;
}

export interface BetaComputeBetaVpnTunnel_CipherSuite {
  phase1?: BetaComputeBetaVpnTunnel_CipherSuite_Phase1 | Computed<BetaComputeBetaVpnTunnel_CipherSuite_Phase1>;
  phase2?: BetaComputeBetaVpnTunnel_CipherSuite_Phase2 | Computed<BetaComputeBetaVpnTunnel_CipherSuite_Phase2>;
}

export interface BetaComputeBetaVpnTunnel_Params {
...
const BetaComputeBetaVpnTunnel_CipherSuite_Phase1Fields: FieldMap = {
  dh: "dh",
...
const BetaComputeBetaVpnTunnel_CipherSuite_Phase2Fields: FieldMap = {
  encryption: "encryption",
  integrity: "integrity",
  pfs: "pfs",
};

const BetaComputeBetaVpnTunnel_CipherSuiteFields: FieldMap = {
  phase1: {
    wireName: "phase1",
    kind: "object",
    fields: BetaComputeBetaVpnTunnel_CipherSuite_Phase1Fields,
  },
  phase2: {
    wireName: "phase2",
    kind: "object",
    fields: BetaComputeBetaVpnTunnel_CipherSuite_Phase2Fields,
  },
};

const BetaComputeBetaVpnTunnel_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

export interface BetaComputeBetaVpnTunnelConfig {
  ...
  cipherSuite?: BetaComputeBetaVpnTunnel_CipherSuite | Computed<BetaComputeBetaVpnTunnel_CipherSuite>;
  ...
  params?: BetaComputeBetaVpnTunnel_Params | Computed<BetaComputeBetaVpnTunnel_Params>;
...
export interface BetaComputeBetaVpnTunnelAttrs {
  /** Capacity tier of the VPN tunnel. This is used for IPsec over Interconnect tunnels to indicate different bandwidth limits. */
  capacityTier: string;
  cipherSuite: BetaComputeBetaVpnTunnel_CipherSuite;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and comply withRFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash. */
  name: string;
  params: BetaComputeBetaVpnTunnel_Params;
  /** URL of the peer side external VPN gateway to which this VPN tunnel is connected. Provided by the client when the VPN tunnel is created. This field is exclusive with the field peerGcpGateway. */
...
export const BetaComputeBetaVpnTunnel: ResourceBinding<BetaComputeBetaVpnTunnelConfig, BetaComputeBetaVpnTunnelAttrs> = {
  wireType: "google_compute_beta_compute_beta_vpn_tunnel",
  fields: {
    capacityTier: "capacity_tier",
    cipherSuite: {
      wireName: "cipher_suite",
      kind: "object",
      fields: BetaComputeBetaVpnTunnel_CipherSuiteFields,
    },
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaComputeBetaVpnTunnel_ParamsFields,
    },
