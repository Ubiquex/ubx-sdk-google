...
export interface BetaComputeBetaNetworkAttachment_ConnectionEndpoints {
...
const BetaComputeBetaNetworkAttachment_ConnectionEndpointsFields: FieldMap = {
...
export interface BetaComputeBetaNetworkAttachmentConfig {
  /** Output only. [Output Only] An array of connections for all the producers connected to this network attachment. */
  connectionEndpoints?: BetaComputeBetaNetworkAttachment_ConnectionEndpoints[] | Computed<BetaComputeBetaNetworkAttachment_ConnectionEndpoints[]>;
...
export interface BetaComputeBetaNetworkAttachmentAttrs {
  /** Output only. [Output Only] An array of connections for all the producers connected to this network attachment. */
  connectionEndpoints: BetaComputeBetaNetworkAttachment_ConnectionEndpoints[];
...
export const BetaComputeBetaNetworkAttachment: ResourceBinding<BetaComputeBetaNetworkAttachmentConfig, BetaComputeBetaNetworkAttachmentAttrs> = {
  wireType: "google_compute_beta_compute_beta_network_attachment",
  fields: {
    connectionEndpoints: {
      wireName: "connection_endpoints",
      kind: "list",
      fields: BetaComputeBetaNetworkAttachment_ConnectionEndpointsFields,
    },
