// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_target_instance. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaTargetInstanceConfig {
...
export interface AlphaComputeAlphaTargetInstanceAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const AlphaComputeAlphaTargetInstance: ResourceBinding<AlphaComputeAlphaTargetInstanceConfig, AlphaComputeAlphaTargetInstanceAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_target_instance",
  fields: {
