// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_subnetwork. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaSubnetwork_LogConfig {
...
export interface BetaComputeBetaSubnetwork_Params {
...
export interface BetaComputeBetaSubnetwork_SecondaryIpRanges {
...
export interface BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp {
  high?: string | Computed<string>;
  low?: string | Computed<string>;
}

export interface BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization {
  totalAllocatedIp?: BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp | Computed<BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp>;
  totalFreeIp?: BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp | Computed<BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp>;
}

export interface BetaComputeBetaSubnetwork_UtilizationDetails_Ipv4Utilizations {
  rangeName?: string | Computed<string>;
  totalAllocatedIp?: string | Computed<string>;
  totalFreeIp?: string | Computed<string>;
}

export interface BetaComputeBetaSubnetwork_UtilizationDetails {
  /** The IPV6 utilization of a single IP range. */
  externalIpv6InstanceUtilization?: BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization | Computed<BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization>;
  /** The IPV6 utilization of a single IP range. */
  externalIpv6LbUtilization?: BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization | Computed<BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization>;
  /** The IPV6 utilization of a single IP range. */
  internalIpv6Utilization?: BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization | Computed<BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization>;
  /** Utilizations of all IPV4 IP ranges. For primary ranges, the range name will be empty. */
  ipv4Utilizations?: BetaComputeBetaSubnetwork_UtilizationDetails_Ipv4Utilizations[] | Computed<BetaComputeBetaSubnetwork_UtilizationDetails_Ipv4Utilizations[]>;
}

const BetaComputeBetaSubnetwork_LogConfigFields: FieldMap = {
...
const BetaComputeBetaSubnetwork_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaComputeBetaSubnetwork_SecondaryIpRangesFields: FieldMap = {
...
const BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIpFields: FieldMap = {
  high: "high",
  low: "low",
};

const BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilizationFields: FieldMap = {
  totalAllocatedIp: {
    wireName: "total_allocated_ip",
    kind: "object",
    fields: BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIpFields,
  },
  totalFreeIp: {
...
const BetaComputeBetaSubnetwork_UtilizationDetails_Ipv4UtilizationsFields: FieldMap = {
  rangeName: "range_name",
  totalAllocatedIp: "total_allocated_ip",
  totalFreeIp: "total_free_ip",
};

const BetaComputeBetaSubnetwork_UtilizationDetailsFields: FieldMap = {
  externalIpv6InstanceUtilization: {
    wireName: "external_ipv6_instance_utilization",
    kind: "object",
    fields: BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilizationFields,
  },
  ...
  ipv4Utilizations: {
    ...
    kind: "list",
    fields: BetaComputeBetaSubnetwork_UtilizationDetails_Ipv4UtilizationsFields,
  },
};

export interface BetaComputeBetaSubnetworkConfig {
  ...
  logConfig?: BetaComputeBetaSubnetwork_LogConfig | Computed<BetaComputeBetaSubnetwork_LogConfig>;
  ...
  params?: BetaComputeBetaSubnetwork_Params | Computed<BetaComputeBetaSubnetwork_Params>;
  ...
  secondaryIpRanges?: BetaComputeBetaSubnetwork_SecondaryIpRanges[] | Computed<BetaComputeBetaSubnetwork_SecondaryIpRanges[]>;
  ...
  utilizationDetails?: BetaComputeBetaSubnetwork_UtilizationDetails | Computed<BetaComputeBetaSubnetwork_UtilizationDetails>;
}

export interface BetaComputeBetaSubnetworkAttrs {
  /** Whether this subnetwork's ranges can conflict with existing custom routes. Setting this to true allows this subnetwork's primary and secondary ranges to overlap with (and contain) custom routes that have already been configured on the corresponding network. For example if a static route has range 10.1.0.0/16, a subnet range 10.0.0.0/8 could only be created if allow_conflicting_routes=true. Overlapping is only allowed on subnetwork operations; routes whose ranges conflict with this subnetwork's ranges won't be allowed unless route.allow_conflicting_subnetworks is set to true. Typically packets destined to IPs within the subnetwork (which may contain private/sensitive data) are prevented from leaving the virtual network. Setting this field to true will disable this feature. The default value is false and applies to all existing subnetworks and automatically created subnetworks. */
  ...
  kind: string;
  /** The available logging options for this subnetwork. */
  logConfig: BetaComputeBetaSubnetwork_LogConfig;
  /** The name of the resource, provided by the client when initially creating the resource. The name must be 1-63 characters long, and comply withRFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash. */
  name: string;
  /** The URL of the network to which this subnetwork belongs, provided by the client when initially creating the subnetwork. This field can be set only at resource creation time. */
  network: string;
  /** Additional subnetwork parameters. */
  params: BetaComputeBetaSubnetwork_Params;
  /** Whether the VMs in this subnet can access Google services without assigned external IP addresses. This field can be both set at resource creation time and updated using setPrivateIpGoogleAccess. */
  ...
  role: string;
  /** An array of configurations for secondary IP ranges for VM instances contained in this subnetwork. The primary IP of such VM must belong to the primary ipCidrRange of the subnetwork. The alias IPs may belong to either primary or secondary ranges. This field can be updated with apatch request. Supports both IPv4 and IPv6 ranges. */
  secondaryIpRanges: BetaComputeBetaSubnetwork_SecondaryIpRanges[];
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** The stack type for the subnet. If set to IPV4_ONLY, new VMs in the subnet are assigned IPv4 addresses only. If set toIPV4_IPV6, new VMs in the subnet can be assigned both IPv4 and IPv6 addresses. If not specified, IPV4_ONLY is used. This field can be both set at resource creation time and updated usingpatch. */
  stackType: string;
  ...
  /** The current IP utilization of all subnetwork ranges. Contains the total number of allocated and free IPs in each range. */
  utilizationDetails: BetaComputeBetaSubnetwork_UtilizationDetails;
}

export const BetaComputeBetaSubnetwork: ResourceBinding<BetaComputeBetaSubnetworkConfig, BetaComputeBetaSubnetworkAttrs> = {
  wireType: "google_compute_beta_compute_beta_subnetwork",
  fields: {
    ...
    logConfig: {
      wireName: "log_config",
      kind: "object",
      fields: BetaComputeBetaSubnetwork_LogConfigFields,
    },
    name: "name",
    network: "network",
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaComputeBetaSubnetwork_ParamsFields,
    },
    ...
    secondaryIpRanges: {
      ...
      kind: "list",
      fields: BetaComputeBetaSubnetwork_SecondaryIpRangesFields,
    },
    selfLink: "self_link",
    ...
    utilizationDetails: {
      ...
      kind: "object",
      fields: BetaComputeBetaSubnetwork_UtilizationDetailsFields,
    },
  },
};
