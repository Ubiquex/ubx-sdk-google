...
export interface AlphaComputeAlphaSubnetwork_LogConfig {
...
export interface AlphaComputeAlphaSubnetwork_Params {
...
export interface AlphaComputeAlphaSubnetwork_SecondaryIpRanges {
...
export interface AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp {
  high?: string | Computed<string>;
  low?: string | Computed<string>;
}

export interface AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization {
  totalAllocatedIp?: AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp | Computed<AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp>;
  totalFreeIp?: AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp | Computed<AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp>;
}

export interface AlphaComputeAlphaSubnetwork_UtilizationDetails_Ipv4Utilizations {
  rangeName?: string | Computed<string>;
  totalAllocatedIp?: string | Computed<string>;
  totalFreeIp?: string | Computed<string>;
}

export interface AlphaComputeAlphaSubnetwork_UtilizationDetails {
  /** The IPV6 utilization of a single IP range. */
  externalIpv6InstanceUtilization?: AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization | Computed<AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization>;
  /** The IPV6 utilization of a single IP range. */
  externalIpv6LbUtilization?: AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization | Computed<AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization>;
  /** The IPV6 utilization of a single IP range. */
  internalIpv6Utilization?: AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization | Computed<AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization>;
  /** Utilizations of all IPV4 IP ranges. For primary ranges, the range name will be empty. */
  ipv4Utilizations?: AlphaComputeAlphaSubnetwork_UtilizationDetails_Ipv4Utilizations[] | Computed<AlphaComputeAlphaSubnetwork_UtilizationDetails_Ipv4Utilizations[]>;
}

const AlphaComputeAlphaSubnetwork_LogConfigFields: FieldMap = {
...
const AlphaComputeAlphaSubnetwork_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaComputeAlphaSubnetwork_SecondaryIpRangesFields: FieldMap = {
...
const AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIpFields: FieldMap = {
  high: "high",
  low: "low",
};

const AlphaComputeAlphaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilizationFields: FieldMap = {
  totalAllocatedIp: {
...
const AlphaComputeAlphaSubnetwork_UtilizationDetails_Ipv4UtilizationsFields: FieldMap = {
  rangeName: "range_name",
  totalAllocatedIp: "total_allocated_ip",
  totalFreeIp: "total_free_ip",
};

const AlphaComputeAlphaSubnetwork_UtilizationDetailsFields: FieldMap = {
...
export interface AlphaComputeAlphaSubnetworkConfig {
  ...
  logConfig?: AlphaComputeAlphaSubnetwork_LogConfig | Computed<AlphaComputeAlphaSubnetwork_LogConfig>;
  ...
  params?: AlphaComputeAlphaSubnetwork_Params | Computed<AlphaComputeAlphaSubnetwork_Params>;
  ...
  secondaryIpRanges?: AlphaComputeAlphaSubnetwork_SecondaryIpRanges[] | Computed<AlphaComputeAlphaSubnetwork_SecondaryIpRanges[]>;
  ...
  utilizationDetails?: AlphaComputeAlphaSubnetwork_UtilizationDetails | Computed<AlphaComputeAlphaSubnetwork_UtilizationDetails>;
...
export interface AlphaComputeAlphaSubnetworkAttrs {
  /** Can only be specified if VPC flow logging for this subnetwork is enabled. Sets the aggregation interval for collecting flow logs. Increasing the interval time reduces the amount of generated flow logs for long-lasting connections. Default is an interval of 5 seconds per connection. Valid values: INTERVAL_5_SEC, INTERVAL_30_SEC,INTERVAL_1_MIN, INTERVAL_5_MIN,INTERVAL_10_MIN, INTERVAL_15_MIN. */
  ...
  kind: string;
  /** The available logging options for this subnetwork. */
  logConfig: AlphaComputeAlphaSubnetwork_LogConfig;
  /** Can only be specified if VPC flow logging for this subnetwork is enabled. Configures whether metadata fields should be added to the reported VPC flow logs. Options are INCLUDE_ALL_METADATA,EXCLUDE_ALL_METADATA, and CUSTOM_METADATA. Default is EXCLUDE_ALL_METADATA. */
  metadata: string;
  /** The name of the resource, provided by the client when initially creating the resource. The name must be 1-63 characters long, and comply withRFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash. */
  name: string;
  ...
  network: string;
  /** Additional subnetwork parameters. */
  params: AlphaComputeAlphaSubnetwork_Params;
  /** Whether the VMs in this subnet can access Google services without assigned external IP addresses. This field can be both set at resource creation time and updated using setPrivateIpGoogleAccess. */
  ...
  role: string;
  /** An array of configurations for secondary IP ranges for VM instances contained in this subnetwork. The primary IP of such VM must belong to the primary ipCidrRange of the subnetwork. The alias IPs may belong to either primary or secondary ranges. This field can be updated with apatch request. Supports both IPv4 and IPv6 ranges. */
  secondaryIpRanges: AlphaComputeAlphaSubnetwork_SecondaryIpRanges[];
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource with the resource id. */
  ...
  /** The current IP utilization of all subnetwork ranges. Contains the total number of allocated and free IPs in each range. */
  utilizationDetails: AlphaComputeAlphaSubnetwork_UtilizationDetails;
  /** A repeated field indicating the VLAN IDs supported on this subnetwork. During Subnet creation, specifying vlan is valid only if enable_l2 is true. During Subnet Update, specifying vlan is allowed only for l2 enabled subnets. Restricted to only one VLAN. */
  vlans: number[];
}

export const AlphaComputeAlphaSubnetwork: ResourceBinding<AlphaComputeAlphaSubnetworkConfig, AlphaComputeAlphaSubnetworkAttrs> = {
