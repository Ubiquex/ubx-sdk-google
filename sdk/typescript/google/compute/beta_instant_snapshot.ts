...
export interface BetaInstantSnapshot_Params {
...
export interface BetaInstantSnapshot_ResourceStatus {
  /** [Output Only] The storage size of this instant snapshot. */
  storageSizeBytes?: string | Computed<string>;
}

const BetaInstantSnapshot_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaInstantSnapshot_ResourceStatusFields: FieldMap = {
  storageSizeBytes: "storage_size_bytes",
};

export interface BetaInstantSnapshotConfig {
  ...
  params?: BetaInstantSnapshot_Params | Computed<BetaInstantSnapshot_Params>;
  ...
  resourceStatus?: BetaInstantSnapshot_ResourceStatus | Computed<BetaInstantSnapshot_ResourceStatus>;
...
export interface BetaInstantSnapshotAttrs {
  /** Output only. [Output Only] The architecture of the instant snapshot. Valid values are ARM64 or X86_64. */
  architecture: string;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  name: string;
  /** Additional instant snapshot params. */
  params: BetaInstantSnapshot_Params;
  /** Output only. [Output Only] URL of the region where the instant snapshot resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  resourceStatus: BetaInstantSnapshot_ResourceStatus;
  /** Output only. Reserved for future use. */
...
export const BetaInstantSnapshot: ResourceBinding<BetaInstantSnapshotConfig, BetaInstantSnapshotAttrs> = {
