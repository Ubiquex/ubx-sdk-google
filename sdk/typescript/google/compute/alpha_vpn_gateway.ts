// Code generated by `ubx sdk gen` from google_compute_alpha_vpn_gateway. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaVpnGateway_Params {
...
export interface AlphaVpnGateway_VpnInterfaces {
...
const AlphaVpnGateway_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaVpnGateway_VpnInterfacesFields: FieldMap = {
  id: "id",
...
export interface AlphaVpnGatewayConfig {
  ...
  params?: AlphaVpnGateway_Params | Computed<AlphaVpnGateway_Params>;
  ...
  vpnInterfaces?: AlphaVpnGateway_VpnInterfaces[] | Computed<AlphaVpnGateway_VpnInterfaces[]>;
}

export interface AlphaVpnGatewayAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  stackType: string;
  /** The list of VPN interfaces associated with this VPN gateway. */
  vpnInterfaces: AlphaVpnGateway_VpnInterfaces[];
}

export const AlphaVpnGateway: ResourceBinding<AlphaVpnGatewayConfig, AlphaVpnGatewayAttrs> = {
  wireType: "google_compute_alpha_vpn_gateway",
  fields: {
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: AlphaVpnGateway_ParamsFields,
    },
    region: "region",
    selfLink: "self_link",
    ...
    vpnInterfaces: {
      ...
      kind: "list",
      fields: AlphaVpnGateway_VpnInterfacesFields,
    },
  },
};
