...
const RegionInstantSnapshot_ResourceStatusFields: FieldMap = {
...
export interface RegionInstantSnapshotConfig {
  ...
  resourceStatus?: RegionInstantSnapshot_ResourceStatus | Computed<RegionInstantSnapshot_ResourceStatus>;
