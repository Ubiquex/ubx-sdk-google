// Code generated by `ubx sdk gen` from google_compute_alpha_service_attachment. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaServiceAttachment_ConnectedEndpoints {
...
export interface AlphaServiceAttachment_ConsumerAcceptLists {
...
export interface AlphaServiceAttachment_PscServiceAttachmentId {
  high?: string | Computed<string>;
  low?: string | Computed<string>;
}

export interface AlphaServiceAttachment_TunnelingConfig {
...
const AlphaServiceAttachment_ConnectedEndpointsFields: FieldMap = {
...
const AlphaServiceAttachment_ConsumerAcceptListsFields: FieldMap = {
...
const AlphaServiceAttachment_PscServiceAttachmentIdFields: FieldMap = {
  high: "high",
  low: "low",
};

const AlphaServiceAttachment_TunnelingConfigFields: FieldMap = {
  encapsulationProfile: "encapsulation_profile",
  routingMode: "routing_mode",
};

export interface AlphaServiceAttachmentConfig {
  /** Output only. [Output Only] An array of connections for all the consumers connected to this service attachment. */
  connectedEndpoints?: AlphaServiceAttachment_ConnectedEndpoints[] | Computed<AlphaServiceAttachment_ConnectedEndpoints[]>;
  ...
  consumerAcceptLists?: AlphaServiceAttachment_ConsumerAcceptLists[] | Computed<AlphaServiceAttachment_ConsumerAcceptLists[]>;
  ...
  pscServiceAttachmentId?: AlphaServiceAttachment_PscServiceAttachmentId | Computed<AlphaServiceAttachment_PscServiceAttachmentId>;
  ...
  tunnelingConfig?: AlphaServiceAttachment_TunnelingConfig | Computed<AlphaServiceAttachment_TunnelingConfig>;
}

export interface AlphaServiceAttachmentAttrs {
  /** Output only. [Output Only] An array of connections for all the consumers connected to this service attachment. */
  connectedEndpoints: AlphaServiceAttachment_ConnectedEndpoints[];
  /** The connection preference of service attachment. The value can be set to ACCEPT_AUTOMATIC. An ACCEPT_AUTOMATIC service attachment is one that always accepts the connection from consumer forwarding rules. */
  connectionPreference: string;
  /** Specifies which consumer projects or networks are allowed to connect to the service attachment. Each project or network has a connection limit. A given service attachment can manage connections at either the project or network level. Therefore, both the accept and reject lists for a given service attachment must contain either only projects or only networks or only endpoints. */
  consumerAcceptLists: AlphaServiceAttachment_ConsumerAcceptLists[];
  /** Specifies a list of projects or networks that are not allowed to connect to this service attachment. The project can be specified using its project ID or project number and the network can be specified using its URL. A given service attachment can manage connections at either the project or network level. Therefore, both the reject and accept lists for a given service attachment must contain either only projects or only networks. */
  ...
  pscServiceAttachmentId: AlphaServiceAttachment_PscServiceAttachmentId;
  /** This flag determines whether a consumer accept/reject list change can reconcile the statuses of existing ACCEPTED or REJECTED PSC endpoints. - If false, connection policy update will only affect existing PENDING PSC endpoints. Existing ACCEPTED/REJECTED endpoints will remain untouched regardless how the connection policy is modified . - If true, update will affect both PENDING and ACCEPTED/REJECTED PSC endpoints. For example, an ACCEPTED PSC endpoint will be moved to REJECTED if its project is added to the reject list. For newly created service attachment, this boolean defaults to false. */
  ...
  /** Use to configure this PSC connection in tunneling mode. In tunneling mode traffic from consumer to producer will be encapsulated as it crosses the VPC boundary and traffic from producer to consumer will be decapsulated in the same manner. */
  tunnelingConfig: AlphaServiceAttachment_TunnelingConfig;
}

export const AlphaServiceAttachment: ResourceBinding<AlphaServiceAttachmentConfig, AlphaServiceAttachmentAttrs> = {
  wireType: "google_compute_alpha_service_attachment",
  fields: {
    connectedEndpoints: {
      wireName: "connected_endpoints",
      kind: "list",
      fields: AlphaServiceAttachment_ConnectedEndpointsFields,
    },
