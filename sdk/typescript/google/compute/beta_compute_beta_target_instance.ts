// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_target_instance. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaTargetInstanceConfig {
...
export interface BetaComputeBetaTargetInstanceAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaComputeBetaTargetInstance: ResourceBinding<BetaComputeBetaTargetInstanceConfig, BetaComputeBetaTargetInstanceAttrs> = {
  wireType: "google_compute_beta_compute_beta_target_instance",
  fields: {
