// Code generated by `ubx sdk gen` from google_compute_alpha_region_target_https_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaRegionTargetHttpsProxyConfig {
...
export interface AlphaRegionTargetHttpsProxyAttrs {
  /** [Deprecated] Use serverTlsPolicy instead. */
...
export const AlphaRegionTargetHttpsProxy: ResourceBinding<AlphaRegionTargetHttpsProxyConfig, AlphaRegionTargetHttpsProxyAttrs> = {
  wireType: "google_compute_alpha_region_target_https_proxy",
  fields: {
