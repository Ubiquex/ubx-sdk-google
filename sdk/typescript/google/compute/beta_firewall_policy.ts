// Code generated by `ubx sdk gen` from google_compute_beta_firewall_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaFirewallPolicy_Associations {
...
export interface BetaFirewallPolicy_PacketMirroringRules_Match_Layer4Configs {
  ipProtocol?: string | Computed<string>;
  ports?: string[] | Computed<string[]>;
}

export interface BetaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags {
  name?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface BetaFirewallPolicy_PacketMirroringRules_Match {
  ...
  layer4Configs?: BetaFirewallPolicy_PacketMirroringRules_Match_Layer4Configs[] | Computed<BetaFirewallPolicy_PacketMirroringRules_Match_Layer4Configs[]>;
  ...
  srcSecureTags?: BetaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[] | Computed<BetaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[]>;
  srcThreatIntelligences?: string[] | Computed<string[]>;
}

export interface BetaFirewallPolicy_PacketMirroringRules {
  ...
  match?: BetaFirewallPolicy_PacketMirroringRules_Match | Computed<BetaFirewallPolicy_PacketMirroringRules_Match>;
  priority?: number | Computed<number>;
  ...
  targetSecureTags?: BetaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[] | Computed<BetaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[]>;
  targetServiceAccounts?: string[] | Computed<string[]>;
  targetType?: string | Computed<string>;
  tlsInspect?: boolean | Computed<boolean>;
}

const BetaFirewallPolicy_AssociationsFields: FieldMap = {
...
const BetaFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields: FieldMap = {
  ipProtocol: "ip_protocol",
  ports: "ports",
};

const BetaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields: FieldMap = {
  name: "name",
  state: "state",
};

const BetaFirewallPolicy_PacketMirroringRules_MatchFields: FieldMap = {
  ...
  layer4Configs: {
    ...
    kind: "list",
    fields: BetaFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields,
  },
  ...
  srcSecureTags: {
    ...
    kind: "list",
    fields: BetaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields,
  },
  srcThreatIntelligences: "src_threat_intelligences",
};

const BetaFirewallPolicy_PacketMirroringRulesFields: FieldMap = {
  action: "action",
  ...
  match: {
    wireName: "match",
    kind: "object",
    fields: BetaFirewallPolicy_PacketMirroringRules_MatchFields,
  },
  priority: "priority",
  ruleName: "rule_name",
...
export interface BetaFirewallPolicyConfig {
  /** A list of associations that belong to this firewall policy. */
  associations?: BetaFirewallPolicy_Associations[] | Computed<BetaFirewallPolicy_Associations[]>;
  ...
  packetMirroringRules?: BetaFirewallPolicy_PacketMirroringRules[] | Computed<BetaFirewallPolicy_PacketMirroringRules[]>;
  ...
  rules?: BetaFirewallPolicy_PacketMirroringRules[] | Computed<BetaFirewallPolicy_PacketMirroringRules[]>;
...
export interface BetaFirewallPolicyAttrs {
  /** A list of associations that belong to this firewall policy. */
  associations: BetaFirewallPolicy_Associations[];
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  name: string;
  /** A list of packet mirroring rules that belong to this policy. */
  packetMirroringRules: BetaFirewallPolicy_PacketMirroringRules[];
  /** Output only. [Output Only] The parent of the firewall policy. This field is not applicable to network firewall policies. */
  parent: string;
  /** Indicates the source of this Firewall Policy. This field is optional on creation and defaults to USER_DEFINED. The USER_DEFINED value indicates a regular firewall policy. The SYSTEM value indicates a system-level policy managed by an internal service like GKE. This SYSTEM value is reserved for internal services and cannot be set by users during policy creation. Policies with a SYSTEM source cannot be modified or deleted by users. */
  policySource: string;
  ...
  /** A list of rules that belong to this policy. There must always be a default rule (rule with priority 2147483647 and match "*"). If no rules are provided when creating a firewall policy, a default rule with action "allow" will be added. */
  rules: BetaFirewallPolicy_PacketMirroringRules[];
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource with the resource id. */
...
export const BetaFirewallPolicy: ResourceBinding<BetaFirewallPolicyConfig, BetaFirewallPolicyAttrs> = {
  wireType: "google_compute_beta_firewall_policy",
  fields: {
    associations: {
      wireName: "associations",
      kind: "list",
      fields: BetaFirewallPolicy_AssociationsFields,
    },
    ...
    packetMirroringRules: {
      ...
      kind: "list",
      fields: BetaFirewallPolicy_PacketMirroringRulesFields,
    },
    parent: "parent",
