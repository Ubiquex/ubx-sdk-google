...
const BetaRegionSnapshot_GuestOsFeaturesFields: FieldMap = {
  type: "type",
};
...
export interface BetaRegionSnapshotConfig {
  ...
  guestOsFeatures?: BetaRegionSnapshot_GuestOsFeatures[] | Computed<BetaRegionSnapshot_GuestOsFeatures[]>;
...
export const BetaRegionSnapshot: ResourceBinding<BetaRegionSnapshotConfig, BetaRegionSnapshotAttrs> = {
  ...
  fields: {
    ...
    guestOsFeatures: {
      ...
      kind: "list",
      fields: BetaRegionSnapshot_GuestOsFeaturesFields,
    },
    id: "id",
    kind: "kind",
