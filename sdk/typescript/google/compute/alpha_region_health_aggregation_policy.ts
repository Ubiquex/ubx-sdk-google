...
export interface AlphaRegionHealthAggregationPolicyConfig {
...
export interface AlphaRegionHealthAggregationPolicyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const AlphaRegionHealthAggregationPolicy: ResourceBinding<AlphaRegionHealthAggregationPolicyConfig, AlphaRegionHealthAggregationPolicyAttrs> = {
