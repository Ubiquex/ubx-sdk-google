// Code generated by `ubx sdk gen` from google_compute_alpha_region_instant_snapshot. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaRegionInstantSnapshot_Params {
...
export interface AlphaRegionInstantSnapshot_ResourceStatus {
  /** [Output Only] The storage size of this instant snapshot. */
  storageSizeBytes?: string | Computed<string>;
}

const AlphaRegionInstantSnapshot_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaRegionInstantSnapshot_ResourceStatusFields: FieldMap = {
  storageSizeBytes: "storage_size_bytes",
};

export interface AlphaRegionInstantSnapshotConfig {
  ...
  params?: AlphaRegionInstantSnapshot_Params | Computed<AlphaRegionInstantSnapshot_Params>;
  ...
  resourceStatus?: AlphaRegionInstantSnapshot_ResourceStatus | Computed<AlphaRegionInstantSnapshot_ResourceStatus>;
...
export interface AlphaRegionInstantSnapshotAttrs {
  /** Output only. [Output Only] The architecture of the instant snapshot. Valid values are ARM64 or X86_64. */
  architecture: string;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  name: string;
  /** Additional instant snapshot params. */
  params: AlphaRegionInstantSnapshot_Params;
  /** Output only. [Output Only] URL of the region where the instant snapshot resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  resourceStatus: AlphaRegionInstantSnapshot_ResourceStatus;
  /** Output only. Reserved for future use. */
...
export const AlphaRegionInstantSnapshot: ResourceBinding<AlphaRegionInstantSnapshotConfig, AlphaRegionInstantSnapshotAttrs> = {
  wireType: "google_compute_alpha_region_instant_snapshot",
  fields: {
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: AlphaRegionInstantSnapshot_ParamsFields,
    },
    region: "region",
    resourceStatus: {
      wireName: "resource_status",
      kind: "object",
      fields: AlphaRegionInstantSnapshot_ResourceStatusFields,
    },
