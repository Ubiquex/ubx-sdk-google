// Code generated by `ubx sdk gen` from google_compute_alpha_target_http_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaTargetHttpProxyConfig {
...
export interface AlphaTargetHttpProxyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const AlphaTargetHttpProxy: ResourceBinding<AlphaTargetHttpProxyConfig, AlphaTargetHttpProxyAttrs> = {
  wireType: "google_compute_alpha_target_http_proxy",
  fields: {
