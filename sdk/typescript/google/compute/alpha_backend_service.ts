...
export interface AlphaBackendService_Backends_CustomMetrics {
  dryRun?: boolean | Computed<boolean>;
  maxUtilization?: number | Computed<number>;
  name?: string | Computed<string>;
}

export interface AlphaBackendService_Backends_OrchestrationInfo {
  resourceUri?: string | Computed<string>;
}

export interface AlphaBackendService_Backends {
  balancingMode?: string | Computed<string>;
  capacityScaler?: number | Computed<number>;
  customMetrics?: AlphaBackendService_Backends_CustomMetrics[] | Computed<AlphaBackendService_Backends_CustomMetrics[]>;
...
export interface AlphaBackendService_CdnPolicy_BypassCacheOnRequestHeaders {
  headerName?: string | Computed<string>;
}

export interface AlphaBackendService_CdnPolicy_CacheKeyPolicy {
...
export interface AlphaBackendService_CdnPolicy_NegativeCachingPolicy {
  code?: number | Computed<number>;
  ttl?: number | Computed<number>;
}

export interface AlphaBackendService_CdnPolicy {
  /** Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings. */
  bypassCacheOnRequestHeaders?: AlphaBackendService_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<AlphaBackendService_CdnPolicy_BypassCacheOnRequestHeaders[]>;
  /** Message containing what to include in the cache key for a request for Cloud CDN. */
  cacheKeyPolicy?: AlphaBackendService_CdnPolicy_CacheKeyPolicy | Computed<AlphaBackendService_CdnPolicy_CacheKeyPolicy>;
  ...
  negativeCachingPolicy?: AlphaBackendService_CdnPolicy_NegativeCachingPolicy[] | Computed<AlphaBackendService_CdnPolicy_NegativeCachingPolicy[]>;
...
export interface AlphaBackendService_CircuitBreakers_ConnectTimeout {
...
export interface AlphaBackendService_CircuitBreakers {
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  connectTimeout?: AlphaBackendService_CircuitBreakers_ConnectTimeout | Computed<AlphaBackendService_CircuitBreakers_ConnectTimeout>;
...
export interface AlphaBackendService_ConnectionDraining {
...
export interface AlphaBackendService_ConnectionTrackingPolicy {
...
export interface AlphaBackendService_ConsistentHash_HttpCookie {
  /** Name of the cookie. */
  name?: string | Computed<string>;
  /** Path to set for the cookie. */
  path?: string | Computed<string>;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  ttl?: AlphaBackendService_CircuitBreakers_ConnectTimeout | Computed<AlphaBackendService_CircuitBreakers_ConnectTimeout>;
}

export interface AlphaBackendService_ConsistentHash {
  /** The information about the HTTP Cookie on which the hash function is based for load balancing policies that use a consistent hash. */
  httpCookie?: AlphaBackendService_ConsistentHash_HttpCookie | Computed<AlphaBackendService_ConsistentHash_HttpCookie>;
...
export interface AlphaBackendService_CustomMetrics {
  dryRun?: boolean | Computed<boolean>;
  name?: string | Computed<string>;
}

export interface AlphaBackendService_DynamicForwarding_ForwardProxy {
...
export interface AlphaBackendService_DynamicForwarding_IpPortSelection {
  /** A boolean flag enabling IP:PORT based dynamic forwarding. */
  enabled?: boolean | Computed<boolean>;
}

export interface AlphaBackendService_DynamicForwarding {
  /** Defines Dynamic Forwarding Proxy configuration. */
  forwardProxy?: AlphaBackendService_DynamicForwarding_ForwardProxy | Computed<AlphaBackendService_DynamicForwarding_ForwardProxy>;
  ...
  ipPortSelection?: AlphaBackendService_DynamicForwarding_IpPortSelection | Computed<AlphaBackendService_DynamicForwarding_IpPortSelection>;
}

export interface AlphaBackendService_FailoverPolicy {
...
export interface AlphaBackendService_HaPolicy_Leader {
  ...
  networkEndpoint?: AlphaBackendService_HaPolicy_Leader_NetworkEndpoint | Computed<AlphaBackendService_HaPolicy_Leader_NetworkEndpoint>;
}

export interface AlphaBackendService_HaPolicy {
  ...
  leader?: AlphaBackendService_HaPolicy_Leader | Computed<AlphaBackendService_HaPolicy_Leader>;
}

export interface AlphaBackendService_Iap_Oauth2ClientInfo {
...
export interface AlphaBackendService_Iap {
  /** Whether the serving infrastructure will authenticate and authorize all incoming requests. */
  enabled?: boolean | Computed<boolean>;
  /** OAuth2 client ID to use for the authentication flow. */
  oauth2ClientId?: string | Computed<string>;
  oauth2ClientInfo?: AlphaBackendService_Iap_Oauth2ClientInfo | Computed<AlphaBackendService_Iap_Oauth2ClientInfo>;
...
export interface AlphaBackendService_LocalityLbPolicies_CustomPolicy {
  data?: string | Computed<string>;
  name?: string | Computed<string>;
}

export interface AlphaBackendService_LocalityLbPolicies_Policy {
  name?: string | Computed<string>;
}

export interface AlphaBackendService_LocalityLbPolicies {
  customPolicy?: AlphaBackendService_LocalityLbPolicies_CustomPolicy | Computed<AlphaBackendService_LocalityLbPolicies_CustomPolicy>;
  policy?: AlphaBackendService_LocalityLbPolicies_Policy | Computed<AlphaBackendService_LocalityLbPolicies_Policy>;
}

export interface AlphaBackendService_LogConfig {
  /** Denotes whether to enable logging for the load balancer traffic served by this backend service. The default value is false. */
  enable?: boolean | Computed<boolean>;
  /** The list of request headers that will be logged to Stackdriver. */
  loggingHttpRequestHeaders?: AlphaBackendService_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<AlphaBackendService_CdnPolicy_BypassCacheOnRequestHeaders[]>;
  /** The list of response headers that will be logged to Stackdriver. */
  loggingHttpResponseHeaders?: AlphaBackendService_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<AlphaBackendService_CdnPolicy_BypassCacheOnRequestHeaders[]>;
...
export interface AlphaBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity {
...
export interface AlphaBackendService_NetworkPassThroughLbTrafficPolicy {
  zonalAffinity?: AlphaBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity | Computed<AlphaBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity>;
}

export interface AlphaBackendService_OutlierDetection {
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  baseEjectionTime?: AlphaBackendService_CircuitBreakers_ConnectTimeout | Computed<AlphaBackendService_CircuitBreakers_ConnectTimeout>;
  ...
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  interval?: AlphaBackendService_CircuitBreakers_ConnectTimeout | Computed<AlphaBackendService_CircuitBreakers_ConnectTimeout>;
...
export interface AlphaBackendService_Params {
...
export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt_JwtHeaders {
  name?: string | Computed<string>;
  valuePrefix?: string | Computed<string>;
}

export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt {
  audiences?: string[] | Computed<string[]>;
  issuer?: string | Computed<string>;
  jwksPublicKeys?: string | Computed<string>;
  jwtHeaders?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt_JwtHeaders[] | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt_JwtHeaders[]>;
  jwtParams?: string[] | Computed<string[]>;
}

export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_Origins {
  jwt?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt>;
}

export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_Peers_Mtls {
  mode?: string | Computed<string>;
}

export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_Peers {
  mtls?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_Peers_Mtls | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_Peers_Mtls>;
}

export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePaths {
...
export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPlugin {
  /** Plugin name. */
  name?: string | Computed<string>;
...
export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials {
  ...
  fromPlugin?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPlugin | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPlugin>;
}

export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentials {
  ...
  certificates?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePaths | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePaths>;
...
export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig {
  /** [Deprecated] gRPC call credentials to access the SDS server. gRPC call credentials to access the SDS server. */
  callCredentials?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials>;
  /** [Deprecated] gRPC channel credentials to access the SDS server. gRPC channel credentials to access the SDS server. */
  channelCredentials?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentials | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentials>;
  /** The target URI of the SDS server. */
  targetUri?: string | Computed<string>;
}

export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig {
  /** [Deprecated] gRPC config to access the SDS server. gRPC config to access the SDS server. */
  grpcServiceConfig?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig>;
}

export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext {
  /** [Deprecated] The paths to the mounted TLS Certificates and private key. The paths to the mounted TLS Certificates and private key. */
  certificatePaths?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePaths | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePaths>;
  ...
  sdsConfig?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig>;
}

export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_ValidationContext {
...
export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext {
  ...
  certificateContext?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext>;
  ...
  validationContext?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_ValidationContext | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_ValidationContext>;
}

export interface AlphaBackendService_SecuritySettings_AuthenticationPolicy {
  ...
  origins?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_Origins[] | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_Origins[]>;
  ...
  peers?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_Peers[] | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_Peers[]>;
  ...
  serverTlsContext?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext>;
}

export interface AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions_Constraints {
  key?: string | Computed<string>;
  values?: string[] | Computed<string[]>;
}

export interface AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions {
  constraints?: AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions_Constraints[] | Computed<AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions_Constraints[]>;
...
export interface AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies_Principals {
...
export interface AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies {
  name?: string | Computed<string>;
  permissions?: AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions[] | Computed<AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions[]>;
  principals?: AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies_Principals[] | Computed<AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies_Principals[]>;
}

export interface AlphaBackendService_SecuritySettings_AuthorizationConfig {
  /** List of RbacPolicies. */
  policies?: AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies[] | Computed<AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies[]>;
}

export interface AlphaBackendService_SecuritySettings_AwsV4Authentication {
...
export interface AlphaBackendService_SecuritySettings_ClientTlsSettings {
  /** [Deprecated] The TLS settings for the client or server. The TLS settings for the client or server. */
  clientTlsContext?: AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext>;
...
export interface AlphaBackendService_SecuritySettings {
  ...
  authenticationPolicy?: AlphaBackendService_SecuritySettings_AuthenticationPolicy | Computed<AlphaBackendService_SecuritySettings_AuthenticationPolicy>;
  ...
  authorizationConfig?: AlphaBackendService_SecuritySettings_AuthorizationConfig | Computed<AlphaBackendService_SecuritySettings_AuthorizationConfig>;
  /** Contains the configurations necessary to generate a signature for access to private storage buckets that support Signature Version 4 for authentication. The service name for generating the authentication header will always default to 's3'. */
  awsV4Authentication?: AlphaBackendService_SecuritySettings_AwsV4Authentication | Computed<AlphaBackendService_SecuritySettings_AwsV4Authentication>;
  ...
  clientTlsSettings?: AlphaBackendService_SecuritySettings_ClientTlsSettings | Computed<AlphaBackendService_SecuritySettings_ClientTlsSettings>;
...
export interface AlphaBackendService_Subsetting {
...
export interface AlphaBackendService_TlsSettings_SubjectAltNames {
  dnsName?: string | Computed<string>;
  uniformResourceIdentifier?: string | Computed<string>;
}

export interface AlphaBackendService_TlsSettings {
  ...
  subjectAltNames?: AlphaBackendService_TlsSettings_SubjectAltNames[] | Computed<AlphaBackendService_TlsSettings_SubjectAltNames[]>;
}

export interface AlphaBackendService_UsedBy {
  reference?: string | Computed<string>;
}

const AlphaBackendService_Backends_CustomMetricsFields: FieldMap = {
  dryRun: "dry_run",
  maxUtilization: "max_utilization",
  name: "name",
};

const AlphaBackendService_Backends_OrchestrationInfoFields: FieldMap = {
  resourceUri: "resource_uri",
};

const AlphaBackendService_BackendsFields: FieldMap = {
...
const AlphaBackendService_CdnPolicy_BypassCacheOnRequestHeadersFields: FieldMap = {
  headerName: "header_name",
};

const AlphaBackendService_CdnPolicy_CacheKeyPolicyFields: FieldMap = {
...
const AlphaBackendService_CdnPolicy_NegativeCachingPolicyFields: FieldMap = {
  code: "code",
  ttl: "ttl",
};

const AlphaBackendService_CdnPolicyFields: FieldMap = {
...
const AlphaBackendService_CircuitBreakers_ConnectTimeoutFields: FieldMap = {
  nanos: "nanos",
  seconds: "seconds",
};

const AlphaBackendService_CircuitBreakersFields: FieldMap = {
  connectTimeout: {
...
const AlphaBackendService_ConnectionDrainingFields: FieldMap = {
  drainingTimeoutSec: "draining_timeout_sec",
};

const AlphaBackendService_ConnectionTrackingPolicyFields: FieldMap = {
...
const AlphaBackendService_ConsistentHash_HttpCookieFields: FieldMap = {
  name: "name",
  path: "path",
  ttl: {
    wireName: "ttl",
...
const AlphaBackendService_ConsistentHashFields: FieldMap = {
  httpCookie: {
...
const AlphaBackendService_CustomMetricsFields: FieldMap = {
  dryRun: "dry_run",
  name: "name",
};

const AlphaBackendService_DynamicForwarding_ForwardProxyFields: FieldMap = {
  enabled: "enabled",
  proxyMode: "proxy_mode",
};

const AlphaBackendService_DynamicForwarding_IpPortSelectionFields: FieldMap = {
  enabled: "enabled",
};

const AlphaBackendService_DynamicForwardingFields: FieldMap = {
  forwardProxy: {
...
const AlphaBackendService_FailoverPolicyFields: FieldMap = {
...
const AlphaBackendService_HaPolicy_Leader_NetworkEndpointFields: FieldMap = {
  instance: "instance",
};

const AlphaBackendService_HaPolicy_LeaderFields: FieldMap = {
...
const AlphaBackendService_HaPolicyFields: FieldMap = {
...
const AlphaBackendService_Iap_Oauth2ClientInfoFields: FieldMap = {
  applicationName: "application_name",
  clientName: "client_name",
  developerEmailAddress: "developer_email_address",
};

const AlphaBackendService_IapFields: FieldMap = {
  enabled: "enabled",
...
const AlphaBackendService_LocalityLbPolicies_CustomPolicyFields: FieldMap = {
  data: "data",
  name: "name",
};

const AlphaBackendService_LocalityLbPolicies_PolicyFields: FieldMap = {
  name: "name",
};

const AlphaBackendService_LocalityLbPoliciesFields: FieldMap = {
  customPolicy: {
...
const AlphaBackendService_LogConfigFields: FieldMap = {
  enable: "enable",
...
const AlphaBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinityFields: FieldMap = {
  spillover: "spillover",
  spilloverRatio: "spillover_ratio",
};

const AlphaBackendService_NetworkPassThroughLbTrafficPolicyFields: FieldMap = {
  zonalAffinity: {
...
const AlphaBackendService_OutlierDetectionFields: FieldMap = {
  baseEjectionTime: {
...
const AlphaBackendService_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt_JwtHeadersFields: FieldMap = {
  name: "name",
  valuePrefix: "value_prefix",
};

const AlphaBackendService_SecuritySettings_AuthenticationPolicy_Origins_JwtFields: FieldMap = {
  audiences: "audiences",
  issuer: "issuer",
...
const AlphaBackendService_SecuritySettings_AuthenticationPolicy_OriginsFields: FieldMap = {
  jwt: {
    wireName: "jwt",
    kind: "object",
...
const AlphaBackendService_SecuritySettings_AuthenticationPolicy_Peers_MtlsFields: FieldMap = {
  mode: "mode",
};

const AlphaBackendService_SecuritySettings_AuthenticationPolicy_PeersFields: FieldMap = {
  mtls: {
    wireName: "mtls",
    kind: "object",
...
const AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePathsFields: FieldMap = {
  certificatePath: "certificate_path",
  privateKeyPath: "private_key_path",
};

const AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPluginFields: FieldMap = {
  name: "name",
  structConfig: "struct_config",
};

const AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentialsFields: FieldMap = {
...
const AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentialsFields: FieldMap = {
  certificates: {
...
const AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfigFields: FieldMap = {
  callCredentials: {
...
const AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfigFields: FieldMap = {
  grpcServiceConfig: {
...
const AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContextFields: FieldMap = {
  certificatePaths: {
...
const AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_ValidationContextFields: FieldMap = {
  certificatePath: "certificate_path",
  sdsConfig: {
    wireName: "sds_config",
    kind: "object",
...
const AlphaBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContextFields: FieldMap = {
  certificateContext: {
...
const AlphaBackendService_SecuritySettings_AuthenticationPolicyFields: FieldMap = {
  origins: {
    wireName: "origins",
    kind: "list",
...
const AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions_ConstraintsFields: FieldMap = {
  key: "key",
  values: "values",
};

const AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies_PermissionsFields: FieldMap = {
  constraints: {
...
const AlphaBackendService_SecuritySettings_AuthorizationConfig_Policies_PrincipalsFields: FieldMap = {
  condition: "condition",
  groups: "groups",
  ips: "ips",
...
const AlphaBackendService_SecuritySettings_AuthorizationConfig_PoliciesFields: FieldMap = {
  name: "name",
  permissions: {
...
const AlphaBackendService_SecuritySettings_AuthorizationConfigFields: FieldMap = {
  policies: {
    wireName: "policies",
    kind: "list",
...
const AlphaBackendService_SecuritySettings_AwsV4AuthenticationFields: FieldMap = {
...
const AlphaBackendService_SecuritySettings_ClientTlsSettingsFields: FieldMap = {
  clientTlsContext: {
...
const AlphaBackendService_SecuritySettingsFields: FieldMap = {
...
const AlphaBackendService_SubsettingFields: FieldMap = {
  policy: "policy",
  subsetSize: "subset_size",
};

const AlphaBackendService_TlsSettings_SubjectAltNamesFields: FieldMap = {
  dnsName: "dns_name",
  uniformResourceIdentifier: "uniform_resource_identifier",
};

const AlphaBackendService_TlsSettingsFields: FieldMap = {
...
export interface AlphaBackendServiceConfig {
  ...
  backends?: AlphaBackendService_Backends[] | Computed<AlphaBackendService_Backends[]>;
  /** Message containing Cloud CDN configuration for a backend service. */
  cdnPolicy?: AlphaBackendService_CdnPolicy | Computed<AlphaBackendService_CdnPolicy>;
  /** Settings controlling the volume of requests, connections and retries to this backend service. */
  circuitBreakers?: AlphaBackendService_CircuitBreakers | Computed<AlphaBackendService_CircuitBreakers>;
  /** Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header. */
  compressionMode?: string | Computed<string>;
  /** Message containing connection draining configuration. */
  connectionDraining?: AlphaBackendService_ConnectionDraining | Computed<AlphaBackendService_ConnectionDraining>;
  ...
  dynamicForwarding?: AlphaBackendService_DynamicForwarding | Computed<AlphaBackendService_DynamicForwarding>;
  ...
  failoverPolicy?: AlphaBackendService_FailoverPolicy | Computed<AlphaBackendService_FailoverPolicy>;
  /** Fingerprint of this resource. A hash of the contents stored in this object. This field is used in optimistic locking. This field will be ignored when inserting a BackendService. An up-to-date fingerprint must be provided in order to update the BackendService, otherwise the request will fail with error 412 conditionNotMet. To see the latest fingerprint, make a get() request to retrieve a BackendService. */
  fingerprint?: string | Computed<string>;
  haPolicy?: AlphaBackendService_HaPolicy | Computed<AlphaBackendService_HaPolicy>;
  ...
  iap?: AlphaBackendService_Iap | Computed<AlphaBackendService_Iap>;
  ...
  localityLbPolicies?: AlphaBackendService_LocalityLbPolicies[] | Computed<AlphaBackendService_LocalityLbPolicies[]>;
  ...
  logConfig?: AlphaBackendService_LogConfig | Computed<AlphaBackendService_LogConfig>;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  maxStreamDuration?: AlphaBackendService_CircuitBreakers_ConnectTimeout | Computed<AlphaBackendService_CircuitBreakers_ConnectTimeout>;
  ...
  outlierDetection?: AlphaBackendService_OutlierDetection | Computed<AlphaBackendService_OutlierDetection>;
  /** Additional Backend Service parameters. */
  params?: AlphaBackendService_Params | Computed<AlphaBackendService_Params>;
  ...
  strongSessionAffinityCookie?: AlphaBackendService_ConsistentHash_HttpCookie | Computed<AlphaBackendService_ConsistentHash_HttpCookie>;
  /** Subsetting configuration for this BackendService. Currently this is applicable only for Internal TCP/UDP load balancing, Internal HTTP(S) load balancing and Traffic Director. */
  subsetting?: AlphaBackendService_Subsetting | Computed<AlphaBackendService_Subsetting>;
...
export interface AlphaBackendServiceAttrs {
  ...
  /** The list of backends that serve this BackendService. */
  backends: AlphaBackendService_Backends[];
  /** Message containing Cloud CDN configuration for a backend service. */
  cdnPolicy: AlphaBackendService_CdnPolicy;
  /** Settings controlling the volume of requests, connections and retries to this backend service. */
  circuitBreakers: AlphaBackendService_CircuitBreakers;
  /** Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header. */
  compressionMode: string;
  /** Message containing connection draining configuration. */
  connectionDraining: AlphaBackendService_ConnectionDraining;
  /** Connection Tracking configuration for this BackendService. */
  connectionTrackingPolicy: AlphaBackendService_ConnectionTrackingPolicy;
  /** This message defines settings for a consistent hash style load balancer. */
  consistentHash: AlphaBackendService_ConsistentHash;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp: string;
  /** List of custom metrics that are used for theWEIGHTED_ROUND_ROBIN locality_lb_policy. */
  customMetrics: AlphaBackendService_CustomMetrics[];
  /** Headers that the load balancer adds to proxied requests. See [Creating custom headers](https://cloud.google.com/load-balancing/docs/custom-headers). */
  ...
  description: string;
  /** Defines a dynamic forwarding configuration for the backend service. */
  dynamicForwarding: AlphaBackendService_DynamicForwarding;
  /** [Output Only] The resource URL for the edge security policy associated with this backend service. */
  ...
  /** For load balancers that have configurable failover: [Internal passthrough Network Load Balancers](https://cloud.google.com/load-balancing/docs/internal/failover-overview) and [external passthrough Network Load Balancers](https://cloud.google.com/load-balancing/docs/network/networklb-failover-overview). On failover or failback, this field indicates whether connection draining will be honored. Google Cloud has a fixed connection draining timeout of 10 minutes. A setting of true terminates existing TCP connections to the active pool during failover and failback, immediately draining traffic. A setting of false allows existing TCP connections to persist, even on VMs no longer in the active pool, for up to the duration of the connection draining timeout (10 minutes). */
  failoverPolicy: AlphaBackendService_FailoverPolicy;
  /** Fingerprint of this resource. A hash of the contents stored in this object. This field is used in optimistic locking. This field will be ignored when inserting a BackendService. An up-to-date fingerprint must be provided in order to update the BackendService, otherwise the request will fail with error 412 conditionNotMet. To see the latest fingerprint, make a get() request to retrieve a BackendService. */
  fingerprint: string;
  haPolicy: AlphaBackendService_HaPolicy;
  /** The list of URLs to the healthChecks, httpHealthChecks (legacy), or httpsHealthChecks (legacy) resource for health checking this backend service. Not all backend services support legacy health checks. See Load balancer guide. Currently, at most one health check can be specified for each backend service. Backend services with instance group or zonal NEG backends must have a health check unless haPolicy is specified. Backend services with internet or serverless NEG backends must not have a health check. healthChecks[] cannot be specified with haPolicy. */
  healthChecks: string[];
  /** Identity-Aware Proxy */
  iap: AlphaBackendService_Iap;
  /** [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  /** Specifies a preference for traffic sent from the proxy to the backend (or from the client to the backend for proxyless gRPC). The possible values are: - IPV4_ONLY: Only send IPv4 traffic to the backends of the backend service (Instance Group, Managed Instance Group, Network Endpoint Group), regardless of traffic from the client to the proxy. Only IPv4 health checks are used to check the health of the backends. This is the default setting. - PREFER_IPV6: Prioritize the connection to the endpoint's IPv6 address over its IPv4 address (provided there is a healthy IPv6 address). - IPV6_ONLY: Only send IPv6 traffic to the backends of the backend service (Instance Group, Managed Instance Group, Network Endpoint Group), regardless of traffic from the client to the proxy. Only IPv6 health checks are used to check the health of the backends. This field is applicable to either: - Advanced global external Application Load Balancer (load balancing scheme EXTERNAL_MANAGED), - Regional external Application Load Balancer, - Internal proxy Network Load Balancer (load balancing scheme INTERNAL_MANAGED), - Regional internal Application Load Balancer (load balancing scheme INTERNAL_MANAGED), - Traffic Director with Envoy proxies and proxyless gRPC (load balancing scheme INTERNAL_SELF_MANAGED). */
  ...
  /** A list of locality load-balancing policies to be used in order of preference. When you use localityLbPolicies, you must set at least one value for either the localityLbPolicies[].policy or the localityLbPolicies[].customPolicy field. localityLbPolicies overrides any value set in the localityLbPolicy field. For an example of how to use this field, seeDefine a list of preferred policies. Caution: This field and its children are intended for use in a service mesh that includes gRPC clients only. Envoy proxies can't use backend services that have this configuration. */
  localityLbPolicies: AlphaBackendService_LocalityLbPolicies[];
  /** The load balancing algorithm used within the scope of the locality. The possible values are: - ROUND_ROBIN: This is a simple policy in which each healthy backend is selected in round robin order. This is the default. - LEAST_REQUEST: An O(1) algorithm which selects two random healthy hosts and picks the host which has fewer active requests. - RING_HASH: The ring/modulo hash load balancer implements consistent hashing to backends. The algorithm has the property that the addition/removal of a host from a set of N hosts only affects 1/N of the requests. - RANDOM: The load balancer selects a random healthy host. - ORIGINAL_DESTINATION: Backend host is selected based on the client connection metadata, i.e., connections are opened to the same address as the destination address of the incoming connection before the connection was redirected to the load balancer. - MAGLEV: used as a drop in replacement for the ring hash load balancer. Maglev is not as stable as ring hash but has faster table lookup build times and host selection times. For more information about Maglev, see Maglev: A Fast and Reliable Software Network Load Balancer. - WEIGHTED_ROUND_ROBIN: Per-endpoint Weighted Round Robin Load Balancing using weights computed from Backend reported Custom Metrics. If set, the Backend Service responses are expected to contain non-standard HTTP response header field Endpoint-Load-Metrics. The reported metrics to use for computing the weights are specified via thecustomMetrics field. - WEIGHTED_MAGLEV: Per-endpoint weighted load balancing via health check reported weights. If set, the backend service must configure an HTTP-based Health Check, and health check replies are expected to contain the non-standard HTTP response header fieldX-Load-Balancing-Endpoint-Weight to specify the per-endpoint weights. If set, load balancing is weighted based on the per-endpoint weights reported in the last processed health check replies, as long as every instance either reported a valid weight or had UNAVAILABLE_WEIGHT. Otherwise, load balancing remains equal-weight. This field is applicable to either: - A regional backend service with the service protocol set to HTTP, HTTPS, HTTP2 or H2C, and load_balancing_scheme set to INTERNAL_MANAGED. - A global backend service with the load_balancing_scheme set to INTERNAL_SELF_MANAGED, INTERNAL_MANAGED, or EXTERNAL_MANAGED. If sessionAffinity is not configured—that is, if session affinity remains at the default value of NONE—then the default value for localityLbPolicy is ROUND_ROBIN. If session affinity is set to a value other than NONE, then the default value for localityLbPolicy isMAGLEV. Only ROUND_ROBIN and RING_HASH are supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. localityLbPolicy cannot be specified with haPolicy. */
  localityLbPolicy: string;
  /** The available logging options for the load balancer traffic served by this backend service. */
  logConfig: AlphaBackendService_LogConfig;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  maxStreamDuration: AlphaBackendService_CircuitBreakers_ConnectTimeout;
  /** Deployment metadata associated with the resource to be set by a GKE hub controller and read by the backend RCTH */
  ...
  /** Settings controlling the eviction of unhealthy hosts from the load balancing pool for the backend service. */
  outlierDetection: AlphaBackendService_OutlierDetection;
  /** Additional Backend Service parameters. */
  params: AlphaBackendService_Params;
  /** Deprecated in favor of portName. The TCP port to connect on the backend. The default value is 80. For internal passthrough Network Load Balancers and external passthrough Network Load Balancers, omit port. */
  port: number;
  /** A named port on a backend instance group representing the port for communication to the backend VMs in that group. The named port must be [defined on each backend instance group](https://cloud.google.com/load-balancing/docs/backend-service#named_ports). This parameter has no meaning if the backends are NEGs. For internal passthrough Network Load Balancers and external passthrough Network Load Balancers, omit port_name. */
  portName: string;
  ...
  /** The authentication and authorization settings for a BackendService. */
  securitySettings: AlphaBackendService_SecuritySettings;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  ...
  /** The HTTP cookie used for stateful session affinity. */
  strongSessionAffinityCookie: AlphaBackendService_ConsistentHash_HttpCookie;
  /** Subsetting configuration for this BackendService. Currently this is applicable only for Internal TCP/UDP load balancing, Internal HTTP(S) load balancing and Traffic Director. */
  subsetting: AlphaBackendService_Subsetting;
  /** The backend service timeout has a different meaning depending on the type of load balancer. For more information see, Backend service settings. The default is 30 seconds. The full range of timeout values allowed goes from 1 through 2,147,483,647 seconds. This value can be overridden in the PathMatcher configuration of the UrlMap that references this backend service. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. Instead, use maxStreamDuration. */
  timeoutSec: number;
  tlsSettings: AlphaBackendService_TlsSettings;
  /** Output only. [Output Only] List of resources referencing given backend service. */
  usedBy: AlphaBackendService_UsedBy[];
}

export const AlphaBackendService: ResourceBinding<AlphaBackendServiceConfig, AlphaBackendServiceAttrs> = {
