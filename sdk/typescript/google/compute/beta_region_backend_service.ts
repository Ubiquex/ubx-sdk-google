// Code generated by `ubx sdk gen` from google_compute_beta_region_backend_service. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaRegionBackendService_Backends_CustomMetrics {
  dryRun?: boolean | Computed<boolean>;
  maxUtilization?: number | Computed<number>;
  name?: string | Computed<string>;
}

export interface BetaRegionBackendService_Backends_OrchestrationInfo {
  resourceUri?: string | Computed<string>;
}

export interface BetaRegionBackendService_Backends {
  balancingMode?: string | Computed<string>;
  capacityScaler?: number | Computed<number>;
  customMetrics?: BetaRegionBackendService_Backends_CustomMetrics[] | Computed<BetaRegionBackendService_Backends_CustomMetrics[]>;
  ...
  maxUtilization?: number | Computed<number>;
  orchestrationInfo?: BetaRegionBackendService_Backends_OrchestrationInfo | Computed<BetaRegionBackendService_Backends_OrchestrationInfo>;
  preference?: string | Computed<string>;
  service?: string | Computed<string>;
  trafficDuration?: string | Computed<string>;
}

export interface BetaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders {
  headerName?: string | Computed<string>;
}

export interface BetaRegionBackendService_CdnPolicy_CacheKeyPolicy {
...
export interface BetaRegionBackendService_CdnPolicy_NegativeCachingPolicy {
  code?: number | Computed<number>;
  ttl?: number | Computed<number>;
}

export interface BetaRegionBackendService_CdnPolicy {
  /** Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings. */
  bypassCacheOnRequestHeaders?: BetaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<BetaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders[]>;
  /** Message containing what to include in the cache key for a request for Cloud CDN. */
  cacheKeyPolicy?: BetaRegionBackendService_CdnPolicy_CacheKeyPolicy | Computed<BetaRegionBackendService_CdnPolicy_CacheKeyPolicy>;
  ...
  negativeCachingPolicy?: BetaRegionBackendService_CdnPolicy_NegativeCachingPolicy[] | Computed<BetaRegionBackendService_CdnPolicy_NegativeCachingPolicy[]>;
...
export interface BetaRegionBackendService_CircuitBreakers_ConnectTimeout {
...
export interface BetaRegionBackendService_CircuitBreakers {
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  connectTimeout?: BetaRegionBackendService_CircuitBreakers_ConnectTimeout | Computed<BetaRegionBackendService_CircuitBreakers_ConnectTimeout>;
...
export interface BetaRegionBackendService_ConnectionDraining {
...
export interface BetaRegionBackendService_ConnectionTrackingPolicy {
...
export interface BetaRegionBackendService_ConsistentHash_HttpCookie {
  /** Name of the cookie. */
  name?: string | Computed<string>;
  /** Path to set for the cookie. */
  path?: string | Computed<string>;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  ttl?: BetaRegionBackendService_CircuitBreakers_ConnectTimeout | Computed<BetaRegionBackendService_CircuitBreakers_ConnectTimeout>;
}

export interface BetaRegionBackendService_ConsistentHash {
  /** The information about the HTTP Cookie on which the hash function is based for load balancing policies that use a consistent hash. */
  httpCookie?: BetaRegionBackendService_ConsistentHash_HttpCookie | Computed<BetaRegionBackendService_ConsistentHash_HttpCookie>;
...
export interface BetaRegionBackendService_CustomMetrics {
  dryRun?: boolean | Computed<boolean>;
  name?: string | Computed<string>;
}

export interface BetaRegionBackendService_DynamicForwarding_ForwardProxy {
...
export interface BetaRegionBackendService_DynamicForwarding_IpPortSelection {
  /** A boolean flag enabling IP:PORT based dynamic forwarding. */
  enabled?: boolean | Computed<boolean>;
}

export interface BetaRegionBackendService_DynamicForwarding {
  /** Defines Dynamic Forwarding Proxy configuration. */
  forwardProxy?: BetaRegionBackendService_DynamicForwarding_ForwardProxy | Computed<BetaRegionBackendService_DynamicForwarding_ForwardProxy>;
  ...
  ipPortSelection?: BetaRegionBackendService_DynamicForwarding_IpPortSelection | Computed<BetaRegionBackendService_DynamicForwarding_IpPortSelection>;
}

export interface BetaRegionBackendService_FailoverPolicy {
...
export interface BetaRegionBackendService_HaPolicy_Leader_NetworkEndpoint {
...
export interface BetaRegionBackendService_HaPolicy_Leader {
  ...
  networkEndpoint?: BetaRegionBackendService_HaPolicy_Leader_NetworkEndpoint | Computed<BetaRegionBackendService_HaPolicy_Leader_NetworkEndpoint>;
}

export interface BetaRegionBackendService_HaPolicy {
  ...
  leader?: BetaRegionBackendService_HaPolicy_Leader | Computed<BetaRegionBackendService_HaPolicy_Leader>;
}

export interface BetaRegionBackendService_Iap {
...
export interface BetaRegionBackendService_LocalityLbPolicies_CustomPolicy {
  data?: string | Computed<string>;
  name?: string | Computed<string>;
}

export interface BetaRegionBackendService_LocalityLbPolicies_Policy {
  name?: string | Computed<string>;
}

export interface BetaRegionBackendService_LocalityLbPolicies {
  customPolicy?: BetaRegionBackendService_LocalityLbPolicies_CustomPolicy | Computed<BetaRegionBackendService_LocalityLbPolicies_CustomPolicy>;
  policy?: BetaRegionBackendService_LocalityLbPolicies_Policy | Computed<BetaRegionBackendService_LocalityLbPolicies_Policy>;
}

export interface BetaRegionBackendService_LogConfig {
  /** Denotes whether to enable logging for the load balancer traffic served by this backend service. The default value is false. */
  enable?: boolean | Computed<boolean>;
  /** The list of request headers that will be logged to Stackdriver. */
  loggingHttpRequestHeaders?: BetaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<BetaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders[]>;
  /** The list of response headers that will be logged to Stackdriver. */
  loggingHttpResponseHeaders?: BetaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<BetaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders[]>;
...
export interface BetaRegionBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity {
...
export interface BetaRegionBackendService_NetworkPassThroughLbTrafficPolicy {
  zonalAffinity?: BetaRegionBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity | Computed<BetaRegionBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity>;
}

export interface BetaRegionBackendService_OutlierDetection {
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  baseEjectionTime?: BetaRegionBackendService_CircuitBreakers_ConnectTimeout | Computed<BetaRegionBackendService_CircuitBreakers_ConnectTimeout>;
  ...
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  interval?: BetaRegionBackendService_CircuitBreakers_ConnectTimeout | Computed<BetaRegionBackendService_CircuitBreakers_ConnectTimeout>;
...
export interface BetaRegionBackendService_Params {
...
export interface BetaRegionBackendService_SecuritySettings_AwsV4Authentication {
...
export interface BetaRegionBackendService_SecuritySettings {
  /** [Deprecated] Use clientTlsPolicy instead. */
  authentication?: string | Computed<string>;
  /** Contains the configurations necessary to generate a signature for access to private storage buckets that support Signature Version 4 for authentication. The service name for generating the authentication header will always default to 's3'. */
  awsV4Authentication?: BetaRegionBackendService_SecuritySettings_AwsV4Authentication | Computed<BetaRegionBackendService_SecuritySettings_AwsV4Authentication>;
...
export interface BetaRegionBackendService_Subsetting {
...
export interface BetaRegionBackendService_TlsSettings_SubjectAltNames {
  dnsName?: string | Computed<string>;
  uniformResourceIdentifier?: string | Computed<string>;
}

export interface BetaRegionBackendService_TlsSettings {
  ...
  subjectAltNames?: BetaRegionBackendService_TlsSettings_SubjectAltNames[] | Computed<BetaRegionBackendService_TlsSettings_SubjectAltNames[]>;
}

export interface BetaRegionBackendService_UsedBy {
  reference?: string | Computed<string>;
}

const BetaRegionBackendService_Backends_CustomMetricsFields: FieldMap = {
  dryRun: "dry_run",
  maxUtilization: "max_utilization",
  name: "name",
};

const BetaRegionBackendService_Backends_OrchestrationInfoFields: FieldMap = {
  resourceUri: "resource_uri",
};

const BetaRegionBackendService_BackendsFields: FieldMap = {
  balancingMode: "balancing_mode",
  capacityScaler: "capacity_scaler",
  customMetrics: {
    wireName: "custom_metrics",
    kind: "list",
    fields: BetaRegionBackendService_Backends_CustomMetricsFields,
  },
  ...
  orchestrationInfo: {
    ...
    kind: "object",
    fields: BetaRegionBackendService_Backends_OrchestrationInfoFields,
  },
...
const BetaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeadersFields: FieldMap = {
  headerName: "header_name",
};

const BetaRegionBackendService_CdnPolicy_CacheKeyPolicyFields: FieldMap = {
...
const BetaRegionBackendService_CdnPolicy_NegativeCachingPolicyFields: FieldMap = {
  code: "code",
  ttl: "ttl",
};

const BetaRegionBackendService_CdnPolicyFields: FieldMap = {
  bypassCacheOnRequestHeaders: {
    wireName: "bypass_cache_on_request_headers",
    kind: "list",
    fields: BetaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeadersFields,
  },
  cacheKeyPolicy: {
    wireName: "cache_key_policy",
    kind: "object",
    fields: BetaRegionBackendService_CdnPolicy_CacheKeyPolicyFields,
  },
  ...
  negativeCachingPolicy: {
    ...
    kind: "list",
    fields: BetaRegionBackendService_CdnPolicy_NegativeCachingPolicyFields,
  },
...
const BetaRegionBackendService_CircuitBreakers_ConnectTimeoutFields: FieldMap = {
  nanos: "nanos",
  seconds: "seconds",
};

const BetaRegionBackendService_CircuitBreakersFields: FieldMap = {
  connectTimeout: {
    wireName: "connect_timeout",
    kind: "object",
    fields: BetaRegionBackendService_CircuitBreakers_ConnectTimeoutFields,
  },
  maxConnections: "max_connections",
...
const BetaRegionBackendService_ConnectionDrainingFields: FieldMap = {
  drainingTimeoutSec: "draining_timeout_sec",
};

const BetaRegionBackendService_ConnectionTrackingPolicyFields: FieldMap = {
...
const BetaRegionBackendService_ConsistentHash_HttpCookieFields: FieldMap = {
  name: "name",
  path: "path",
  ttl: {
    wireName: "ttl",
...
const BetaRegionBackendService_ConsistentHashFields: FieldMap = {
  httpCookie: {
    wireName: "http_cookie",
    kind: "object",
    fields: BetaRegionBackendService_ConsistentHash_HttpCookieFields,
  },
  httpHeaderName: "http_header_name",
  minimumRingSize: "minimum_ring_size",
};

const BetaRegionBackendService_CustomMetricsFields: FieldMap = {
  dryRun: "dry_run",
  name: "name",
};

const BetaRegionBackendService_DynamicForwarding_ForwardProxyFields: FieldMap = {
  enabled: "enabled",
  proxyMode: "proxy_mode",
};

const BetaRegionBackendService_DynamicForwarding_IpPortSelectionFields: FieldMap = {
  enabled: "enabled",
};

const BetaRegionBackendService_DynamicForwardingFields: FieldMap = {
  forwardProxy: {
    wireName: "forward_proxy",
    kind: "object",
    fields: BetaRegionBackendService_DynamicForwarding_ForwardProxyFields,
  },
  ipPortSelection: {
    wireName: "ip_port_selection",
    kind: "object",
    fields: BetaRegionBackendService_DynamicForwarding_IpPortSelectionFields,
  },
};

const BetaRegionBackendService_FailoverPolicyFields: FieldMap = {
...
const BetaRegionBackendService_HaPolicy_Leader_NetworkEndpointFields: FieldMap = {
  instance: "instance",
};

const BetaRegionBackendService_HaPolicy_LeaderFields: FieldMap = {
  backendGroup: "backend_group",
  networkEndpoint: {
    wireName: "network_endpoint",
    kind: "object",
    fields: BetaRegionBackendService_HaPolicy_Leader_NetworkEndpointFields,
  },
};

const BetaRegionBackendService_HaPolicyFields: FieldMap = {
  fastIpmove: "fast_ipmove",
  leader: {
    wireName: "leader",
    kind: "object",
    fields: BetaRegionBackendService_HaPolicy_LeaderFields,
  },
};

const BetaRegionBackendService_IapFields: FieldMap = {
  enabled: "enabled",
...
const BetaRegionBackendService_LocalityLbPolicies_CustomPolicyFields: FieldMap = {
  data: "data",
  name: "name",
};

const BetaRegionBackendService_LocalityLbPolicies_PolicyFields: FieldMap = {
  name: "name",
};

const BetaRegionBackendService_LocalityLbPoliciesFields: FieldMap = {
  customPolicy: {
    wireName: "custom_policy",
    kind: "object",
    fields: BetaRegionBackendService_LocalityLbPolicies_CustomPolicyFields,
  },
  policy: {
    wireName: "policy",
    kind: "object",
    fields: BetaRegionBackendService_LocalityLbPolicies_PolicyFields,
  },
};

const BetaRegionBackendService_LogConfigFields: FieldMap = {
  enable: "enable",
...
const BetaRegionBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinityFields: FieldMap = {
  spillover: "spillover",
  spilloverRatio: "spillover_ratio",
};

const BetaRegionBackendService_NetworkPassThroughLbTrafficPolicyFields: FieldMap = {
  zonalAffinity: {
    wireName: "zonal_affinity",
    kind: "object",
    fields: BetaRegionBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinityFields,
  },
};

const BetaRegionBackendService_OutlierDetectionFields: FieldMap = {
  baseEjectionTime: {
...
const BetaRegionBackendService_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaRegionBackendService_SecuritySettings_AwsV4AuthenticationFields: FieldMap = {
...
const BetaRegionBackendService_SecuritySettingsFields: FieldMap = {
  authentication: "authentication",
  awsV4Authentication: {
    wireName: "aws_v4_authentication",
    kind: "object",
    fields: BetaRegionBackendService_SecuritySettings_AwsV4AuthenticationFields,
  },
  clientTlsPolicy: "client_tls_policy",
  subjectAltNames: "subject_alt_names",
};

const BetaRegionBackendService_SubsettingFields: FieldMap = {
  policy: "policy",
  subsetSize: "subset_size",
};

const BetaRegionBackendService_TlsSettings_SubjectAltNamesFields: FieldMap = {
  dnsName: "dns_name",
  uniformResourceIdentifier: "uniform_resource_identifier",
};

const BetaRegionBackendService_TlsSettingsFields: FieldMap = {
  ...
  subjectAltNames: {
    ...
    kind: "list",
    fields: BetaRegionBackendService_TlsSettings_SubjectAltNamesFields,
  },
};

const BetaRegionBackendService_UsedByFields: FieldMap = {
  reference: "reference",
};

export interface BetaRegionBackendServiceConfig {
  ...
  backends?: BetaRegionBackendService_Backends[] | Computed<BetaRegionBackendService_Backends[]>;
  /** Message containing Cloud CDN configuration for a backend service. */
  cdnPolicy?: BetaRegionBackendService_CdnPolicy | Computed<BetaRegionBackendService_CdnPolicy>;
  /** Settings controlling the volume of requests, connections and retries to this backend service. */
  circuitBreakers?: BetaRegionBackendService_CircuitBreakers | Computed<BetaRegionBackendService_CircuitBreakers>;
  /** Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header. */
  compressionMode?: string | Computed<string>;
  /** Message containing connection draining configuration. */
  connectionDraining?: BetaRegionBackendService_ConnectionDraining | Computed<BetaRegionBackendService_ConnectionDraining>;
  /** Connection Tracking configuration for this BackendService. */
  connectionTrackingPolicy?: BetaRegionBackendService_ConnectionTrackingPolicy | Computed<BetaRegionBackendService_ConnectionTrackingPolicy>;
  /** This message defines settings for a consistent hash style load balancer. */
  consistentHash?: BetaRegionBackendService_ConsistentHash | Computed<BetaRegionBackendService_ConsistentHash>;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp?: string | Computed<string>;
  /** List of custom metrics that are used for theWEIGHTED_ROUND_ROBIN locality_lb_policy. */
  customMetrics?: BetaRegionBackendService_CustomMetrics[] | Computed<BetaRegionBackendService_CustomMetrics[]>;
  ...
  dynamicForwarding?: BetaRegionBackendService_DynamicForwarding | Computed<BetaRegionBackendService_DynamicForwarding>;
  ...
  failoverPolicy?: BetaRegionBackendService_FailoverPolicy | Computed<BetaRegionBackendService_FailoverPolicy>;
  /** Fingerprint of this resource. A hash of the contents stored in this object. This field is used in optimistic locking. This field will be ignored when inserting a BackendService. An up-to-date fingerprint must be provided in order to update the BackendService, otherwise the request will fail with error 412 conditionNotMet. To see the latest fingerprint, make a get() request to retrieve a BackendService. */
  fingerprint?: string | Computed<string>;
  haPolicy?: BetaRegionBackendService_HaPolicy | Computed<BetaRegionBackendService_HaPolicy>;
  ...
  iap?: BetaRegionBackendService_Iap | Computed<BetaRegionBackendService_Iap>;
  ...
  localityLbPolicies?: BetaRegionBackendService_LocalityLbPolicies[] | Computed<BetaRegionBackendService_LocalityLbPolicies[]>;
  ...
  logConfig?: BetaRegionBackendService_LogConfig | Computed<BetaRegionBackendService_LogConfig>;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  maxStreamDuration?: BetaRegionBackendService_CircuitBreakers_ConnectTimeout | Computed<BetaRegionBackendService_CircuitBreakers_ConnectTimeout>;
  ...
  networkPassThroughLbTrafficPolicy?: BetaRegionBackendService_NetworkPassThroughLbTrafficPolicy | Computed<BetaRegionBackendService_NetworkPassThroughLbTrafficPolicy>;
  /** A message containing information about the resource or system that manages the backend service. */
  orchestrationInfo?: BetaRegionBackendService_Backends_OrchestrationInfo | Computed<BetaRegionBackendService_Backends_OrchestrationInfo>;
  /** Settings controlling the eviction of unhealthy hosts from the load balancing pool for the backend service. */
  outlierDetection?: BetaRegionBackendService_OutlierDetection | Computed<BetaRegionBackendService_OutlierDetection>;
  /** Additional Backend Service parameters. */
  params?: BetaRegionBackendService_Params | Computed<BetaRegionBackendService_Params>;
  ...
  securitySettings?: BetaRegionBackendService_SecuritySettings | Computed<BetaRegionBackendService_SecuritySettings>;
  ...
  strongSessionAffinityCookie?: BetaRegionBackendService_ConsistentHash_HttpCookie | Computed<BetaRegionBackendService_ConsistentHash_HttpCookie>;
  /** Subsetting configuration for this BackendService. Currently this is applicable only for Internal TCP/UDP load balancing, Internal HTTP(S) load balancing and Traffic Director. */
  subsetting?: BetaRegionBackendService_Subsetting | Computed<BetaRegionBackendService_Subsetting>;
  ...
  tlsSettings?: BetaRegionBackendService_TlsSettings | Computed<BetaRegionBackendService_TlsSettings>;
  /** Output only. [Output Only] List of resources referencing given backend service. */
  usedBy?: BetaRegionBackendService_UsedBy[] | Computed<BetaRegionBackendService_UsedBy[]>;
}

export interface BetaRegionBackendServiceAttrs {
  /** Lifetime of cookies in seconds. This setting is applicable to Application Load Balancers and Traffic Director and requires GENERATED_COOKIE or HTTP_COOKIE session affinity. If set to 0, the cookie is non-persistent and lasts only until the end of the browser session (or equivalent). The maximum allowed value is two weeks (1,209,600). Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. */
  affinityCookieTtlSec: number;
  /** The list of backends that serve this BackendService. */
  backends: BetaRegionBackendService_Backends[];
  /** Message containing Cloud CDN configuration for a backend service. */
  cdnPolicy: BetaRegionBackendService_CdnPolicy;
  /** Settings controlling the volume of requests, connections and retries to this backend service. */
  circuitBreakers: BetaRegionBackendService_CircuitBreakers;
  /** Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header. */
  compressionMode: string;
  /** Message containing connection draining configuration. */
  connectionDraining: BetaRegionBackendService_ConnectionDraining;
  /** Connection Tracking configuration for this BackendService. */
  connectionTrackingPolicy: BetaRegionBackendService_ConnectionTrackingPolicy;
  /** This message defines settings for a consistent hash style load balancer. */
  consistentHash: BetaRegionBackendService_ConsistentHash;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp: string;
  /** List of custom metrics that are used for theWEIGHTED_ROUND_ROBIN locality_lb_policy. */
  customMetrics: BetaRegionBackendService_CustomMetrics[];
  /** Headers that the load balancer adds to proxied requests. See [Creating custom headers](https://cloud.google.com/load-balancing/docs/custom-headers). */
  ...
  description: string;
  /** Defines a dynamic forwarding configuration for the backend service. */
  dynamicForwarding: BetaRegionBackendService_DynamicForwarding;
  /** [Output Only] The resource URL for the edge security policy associated with this backend service. */
  ...
  /** For load balancers that have configurable failover: [Internal passthrough Network Load Balancers](https://cloud.google.com/load-balancing/docs/internal/failover-overview) and [external passthrough Network Load Balancers](https://cloud.google.com/load-balancing/docs/network/networklb-failover-overview). On failover or failback, this field indicates whether connection draining will be honored. Google Cloud has a fixed connection draining timeout of 10 minutes. A setting of true terminates existing TCP connections to the active pool during failover and failback, immediately draining traffic. A setting of false allows existing TCP connections to persist, even on VMs no longer in the active pool, for up to the duration of the connection draining timeout (10 minutes). */
  failoverPolicy: BetaRegionBackendService_FailoverPolicy;
  /** Fingerprint of this resource. A hash of the contents stored in this object. This field is used in optimistic locking. This field will be ignored when inserting a BackendService. An up-to-date fingerprint must be provided in order to update the BackendService, otherwise the request will fail with error 412 conditionNotMet. To see the latest fingerprint, make a get() request to retrieve a BackendService. */
  fingerprint: string;
  haPolicy: BetaRegionBackendService_HaPolicy;
  /** The list of URLs to the healthChecks, httpHealthChecks (legacy), or httpsHealthChecks (legacy) resource for health checking this backend service. Not all backend services support legacy health checks. See Load balancer guide. Currently, at most one health check can be specified for each backend service. Backend services with instance group or zonal NEG backends must have a health check unless haPolicy is specified. Backend services with internet or serverless NEG backends must not have a health check. healthChecks[] cannot be specified with haPolicy. */
  healthChecks: string[];
  /** Identity-Aware Proxy */
  iap: BetaRegionBackendService_Iap;
  /** [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  /** Specifies a preference for traffic sent from the proxy to the backend (or from the client to the backend for proxyless gRPC). The possible values are: - IPV4_ONLY: Only send IPv4 traffic to the backends of the backend service (Instance Group, Managed Instance Group, Network Endpoint Group), regardless of traffic from the client to the proxy. Only IPv4 health checks are used to check the health of the backends. This is the default setting. - PREFER_IPV6: Prioritize the connection to the endpoint's IPv6 address over its IPv4 address (provided there is a healthy IPv6 address). - IPV6_ONLY: Only send IPv6 traffic to the backends of the backend service (Instance Group, Managed Instance Group, Network Endpoint Group), regardless of traffic from the client to the proxy. Only IPv6 health checks are used to check the health of the backends. This field is applicable to either: - Advanced global external Application Load Balancer (load balancing scheme EXTERNAL_MANAGED), - Regional external Application Load Balancer, - Internal proxy Network Load Balancer (load balancing scheme INTERNAL_MANAGED), - Regional internal Application Load Balancer (load balancing scheme INTERNAL_MANAGED), - Traffic Director with Envoy proxies and proxyless gRPC (load balancing scheme INTERNAL_SELF_MANAGED). */
  ...
  /** A list of locality load-balancing policies to be used in order of preference. When you use localityLbPolicies, you must set at least one value for either the localityLbPolicies[].policy or the localityLbPolicies[].customPolicy field. localityLbPolicies overrides any value set in the localityLbPolicy field. For an example of how to use this field, seeDefine a list of preferred policies. Caution: This field and its children are intended for use in a service mesh that includes gRPC clients only. Envoy proxies can't use backend services that have this configuration. */
  localityLbPolicies: BetaRegionBackendService_LocalityLbPolicies[];
  /** The load balancing algorithm used within the scope of the locality. The possible values are: - ROUND_ROBIN: This is a simple policy in which each healthy backend is selected in round robin order. This is the default. - LEAST_REQUEST: An O(1) algorithm which selects two random healthy hosts and picks the host which has fewer active requests. - RING_HASH: The ring/modulo hash load balancer implements consistent hashing to backends. The algorithm has the property that the addition/removal of a host from a set of N hosts only affects 1/N of the requests. - RANDOM: The load balancer selects a random healthy host. - ORIGINAL_DESTINATION: Backend host is selected based on the client connection metadata, i.e., connections are opened to the same address as the destination address of the incoming connection before the connection was redirected to the load balancer. - MAGLEV: used as a drop in replacement for the ring hash load balancer. Maglev is not as stable as ring hash but has faster table lookup build times and host selection times. For more information about Maglev, see Maglev: A Fast and Reliable Software Network Load Balancer. - WEIGHTED_ROUND_ROBIN: Per-endpoint Weighted Round Robin Load Balancing using weights computed from Backend reported Custom Metrics. If set, the Backend Service responses are expected to contain non-standard HTTP response header field Endpoint-Load-Metrics. The reported metrics to use for computing the weights are specified via thecustomMetrics field. - WEIGHTED_MAGLEV: Per-endpoint weighted load balancing via health check reported weights. If set, the backend service must configure an HTTP-based Health Check, and health check replies are expected to contain the non-standard HTTP response header fieldX-Load-Balancing-Endpoint-Weight to specify the per-endpoint weights. If set, load balancing is weighted based on the per-endpoint weights reported in the last processed health check replies, as long as every instance either reported a valid weight or had UNAVAILABLE_WEIGHT. Otherwise, load balancing remains equal-weight. This field is applicable to either: - A regional backend service with the service protocol set to HTTP, HTTPS, HTTP2 or H2C, and load_balancing_scheme set to INTERNAL_MANAGED. - A global backend service with the load_balancing_scheme set to INTERNAL_SELF_MANAGED, INTERNAL_MANAGED, or EXTERNAL_MANAGED. If sessionAffinity is not configured—that is, if session affinity remains at the default value of NONE—then the default value for localityLbPolicy is ROUND_ROBIN. If session affinity is set to a value other than NONE, then the default value for localityLbPolicy isMAGLEV. Only ROUND_ROBIN and RING_HASH are supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. localityLbPolicy cannot be specified with haPolicy. */
  localityLbPolicy: string;
  /** The available logging options for the load balancer traffic served by this backend service. */
  logConfig: BetaRegionBackendService_LogConfig;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  maxStreamDuration: BetaRegionBackendService_CircuitBreakers_ConnectTimeout;
  /** Deployment metadata associated with the resource to be set by a GKE hub controller and read by the backend RCTH */
  ...
  /** The URL of the network to which this backend service belongs. This field must be set for Internal Passthrough Network Load Balancers when the haPolicy is enabled, and for External Passthrough Network Load Balancers when the haPolicy fastIpMove is enabled. This field can only be specified when the load balancing scheme is set toINTERNAL, or when the load balancing scheme is set toEXTERNAL and haPolicy fastIpMove is enabled. */
  network: string;
  networkPassThroughLbTrafficPolicy: BetaRegionBackendService_NetworkPassThroughLbTrafficPolicy;
  /** A message containing information about the resource or system that manages the backend service. */
  orchestrationInfo: BetaRegionBackendService_Backends_OrchestrationInfo;
  /** Settings controlling the eviction of unhealthy hosts from the load balancing pool for the backend service. */
  outlierDetection: BetaRegionBackendService_OutlierDetection;
  /** Additional Backend Service parameters. */
  params: BetaRegionBackendService_Params;
  /** Deprecated in favor of portName. The TCP port to connect on the backend. The default value is 80. For internal passthrough Network Load Balancers and external passthrough Network Load Balancers, omit port. */
  port: number;
  /** A named port on a backend instance group representing the port for communication to the backend VMs in that group. The named port must be [defined on each backend instance group](https://cloud.google.com/load-balancing/docs/backend-service#named_ports). This parameter has no meaning if the backends are NEGs. For internal passthrough Network Load Balancers and external passthrough Network Load Balancers, omit port_name. */
  portName: string;
  ...
  /** The authentication and authorization settings for a BackendService. */
  securitySettings: BetaRegionBackendService_SecuritySettings;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** URLs of networkservices.ServiceBinding resources. Can only be set if load balancing scheme is INTERNAL_SELF_MANAGED. If set, lists of backends and health checks must be both empty. */
  ...
  /** The HTTP cookie used for stateful session affinity. */
  strongSessionAffinityCookie: BetaRegionBackendService_ConsistentHash_HttpCookie;
  /** Subsetting configuration for this BackendService. Currently this is applicable only for Internal TCP/UDP load balancing, Internal HTTP(S) load balancing and Traffic Director. */
  subsetting: BetaRegionBackendService_Subsetting;
  /** The backend service timeout has a different meaning depending on the type of load balancer. For more information see, Backend service settings. The default is 30 seconds. The full range of timeout values allowed goes from 1 through 2,147,483,647 seconds. This value can be overridden in the PathMatcher configuration of the UrlMap that references this backend service. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. Instead, use maxStreamDuration. */
  timeoutSec: number;
  tlsSettings: BetaRegionBackendService_TlsSettings;
  /** Output only. [Output Only] List of resources referencing given backend service. */
  usedBy: BetaRegionBackendService_UsedBy[];
}

export const BetaRegionBackendService: ResourceBinding<BetaRegionBackendServiceConfig, BetaRegionBackendServiceAttrs> = {
  wireType: "google_compute_beta_region_backend_service",
  fields: {
    affinityCookieTtlSec: "affinity_cookie_ttl_sec",
    backends: {
      wireName: "backends",
      kind: "list",
      fields: BetaRegionBackendService_BackendsFields,
    },
    cdnPolicy: {
      wireName: "cdn_policy",
      kind: "object",
      fields: BetaRegionBackendService_CdnPolicyFields,
    },
    circuitBreakers: {
      wireName: "circuit_breakers",
      kind: "object",
      fields: BetaRegionBackendService_CircuitBreakersFields,
    },
    compressionMode: "compression_mode",
    connectionDraining: {
      wireName: "connection_draining",
      kind: "object",
      fields: BetaRegionBackendService_ConnectionDrainingFields,
    },
    connectionTrackingPolicy: {
      wireName: "connection_tracking_policy",
      kind: "object",
      fields: BetaRegionBackendService_ConnectionTrackingPolicyFields,
    },
    consistentHash: {
      wireName: "consistent_hash",
      kind: "object",
      fields: BetaRegionBackendService_ConsistentHashFields,
    },
    creationTimestamp: "creation_timestamp",
    customMetrics: {
      wireName: "custom_metrics",
      kind: "list",
      fields: BetaRegionBackendService_CustomMetricsFields,
    },
    ...
    dynamicForwarding: {
      ...
      kind: "object",
      fields: BetaRegionBackendService_DynamicForwardingFields,
    },
    ...
    failoverPolicy: {
      ...
      kind: "object",
      fields: BetaRegionBackendService_FailoverPolicyFields,
    },
    fingerprint: "fingerprint",
    haPolicy: {
      wireName: "ha_policy",
      kind: "object",
      fields: BetaRegionBackendService_HaPolicyFields,
    },
    healthChecks: "health_checks",
    iap: {
      wireName: "iap",
      kind: "object",
      fields: BetaRegionBackendService_IapFields,
    },
    id: "id",
    ...
    localityLbPolicies: {
      ...
      kind: "list",
      fields: BetaRegionBackendService_LocalityLbPoliciesFields,
    },
    localityLbPolicy: "locality_lb_policy",
    logConfig: {
      wireName: "log_config",
      kind: "object",
      fields: BetaRegionBackendService_LogConfigFields,
    },
    maxStreamDuration: {
    ...
    networkPassThroughLbTrafficPolicy: {
      ...
      kind: "object",
      fields: BetaRegionBackendService_NetworkPassThroughLbTrafficPolicyFields,
    },
    orchestrationInfo: {
      wireName: "orchestration_info",
      kind: "object",
    ...
    outlierDetection: {
      ...
      kind: "object",
      fields: BetaRegionBackendService_OutlierDetectionFields,
    },
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaRegionBackendService_ParamsFields,
    },
    port: "port",
    portName: "port_name",
    protocol: "protocol",
    ...
    securitySettings: {
      ...
      kind: "object",
      fields: BetaRegionBackendService_SecuritySettingsFields,
    },
    selfLink: "self_link",
    ...
    subsetting: {
      wireName: "subsetting",
      kind: "object",
      fields: BetaRegionBackendService_SubsettingFields,
    },
    timeoutSec: "timeout_sec",
    tlsSettings: {
      wireName: "tls_settings",
      kind: "object",
      fields: BetaRegionBackendService_TlsSettingsFields,
    },
    usedBy: {
      wireName: "used_by",
      kind: "list",
      fields: BetaRegionBackendService_UsedByFields,
    },
  },
};
