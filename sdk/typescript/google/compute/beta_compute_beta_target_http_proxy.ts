// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_target_http_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaTargetHttpProxyConfig {
...
export interface BetaComputeBetaTargetHttpProxyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaComputeBetaTargetHttpProxy: ResourceBinding<BetaComputeBetaTargetHttpProxyConfig, BetaComputeBetaTargetHttpProxyAttrs> = {
  wireType: "google_compute_beta_compute_beta_target_http_proxy",
  fields: {
