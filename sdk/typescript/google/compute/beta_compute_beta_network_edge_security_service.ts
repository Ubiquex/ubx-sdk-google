// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_network_edge_security_service. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaNetworkEdgeSecurityServiceConfig {
...
export interface BetaComputeBetaNetworkEdgeSecurityServiceAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaComputeBetaNetworkEdgeSecurityService: ResourceBinding<BetaComputeBetaNetworkEdgeSecurityServiceConfig, BetaComputeBetaNetworkEdgeSecurityServiceAttrs> = {
  wireType: "google_compute_beta_compute_beta_network_edge_security_service",
  fields: {
