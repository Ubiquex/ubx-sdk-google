...
export interface BetaRegionTargetTcpProxyConfig {
...
export interface BetaRegionTargetTcpProxyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaRegionTargetTcpProxy: ResourceBinding<BetaRegionTargetTcpProxyConfig, BetaRegionTargetTcpProxyAttrs> = {
