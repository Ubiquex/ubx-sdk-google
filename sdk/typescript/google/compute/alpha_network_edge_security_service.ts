...
export interface AlphaNetworkEdgeSecurityServiceConfig {
...
export interface AlphaNetworkEdgeSecurityServiceAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const AlphaNetworkEdgeSecurityService: ResourceBinding<AlphaNetworkEdgeSecurityServiceConfig, AlphaNetworkEdgeSecurityServiceAttrs> = {
