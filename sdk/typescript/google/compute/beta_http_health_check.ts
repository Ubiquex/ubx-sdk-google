...
export interface BetaHttpHealthCheckConfig {
...
export interface BetaHttpHealthCheckAttrs {
  /** How often (in seconds) to send a health check. The default value is5 seconds. */
...
export const BetaHttpHealthCheck: ResourceBinding<BetaHttpHealthCheckConfig, BetaHttpHealthCheckAttrs> = {
  wireType: "google_compute_beta_http_health_check",
  fields: {
