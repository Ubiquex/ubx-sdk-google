// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_region_health_source. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaRegionHealthSourceConfig {
...
export interface AlphaComputeAlphaRegionHealthSourceAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const AlphaComputeAlphaRegionHealthSource: ResourceBinding<AlphaComputeAlphaRegionHealthSourceConfig, AlphaComputeAlphaRegionHealthSourceAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_region_health_source",
  fields: {
