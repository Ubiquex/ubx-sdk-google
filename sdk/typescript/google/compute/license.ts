...
export interface License_MinimumRetention {
...
export interface License_Params {
...
export interface License_ResourceRequirements {
...
const License_MinimumRetentionFields: FieldMap = {
  nanos: "nanos",
  seconds: "seconds",
};

const License_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const License_ResourceRequirementsFields: FieldMap = {
...
export interface LicenseConfig {
  ...
  minimumRetention?: License_MinimumRetention | Computed<License_MinimumRetention>;
  ...
  params?: License_Params | Computed<License_Params>;
...
export interface LicenseAttrs {
  ...
  licenseCode: string;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  minimumRetention: License_MinimumRetention;
  /** If true, this license can only be used on VMs on multi tenant nodes. */
