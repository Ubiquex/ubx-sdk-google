...
export interface AlphaComputeAlphaRegionHealthCheckServiceConfig {
...
export interface AlphaComputeAlphaRegionHealthCheckServiceAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const AlphaComputeAlphaRegionHealthCheckService: ResourceBinding<AlphaComputeAlphaRegionHealthCheckServiceConfig, AlphaComputeAlphaRegionHealthCheckServiceAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_region_health_check_service",
  fields: {
