// Code generated by `ubx sdk gen` from google_compute_beta_global_vm_extension_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaGlobalVmExtensionPolicy_ExtensionPolicies {
  pinnedVersion?: string | Computed<string>;
  stringConfig?: string | Computed<string>;
}

export interface BetaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelector {
  inclusionLabels?: Record<string, string> | Computed<Record<string, string>>;
}

export interface BetaGlobalVmExtensionPolicy_InstanceSelectors {
  labelSelector?: BetaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelector | Computed<BetaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelector>;
}

export interface BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutInput {
...
export interface BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus {
  state?: string | Computed<string>;
}

export interface BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts {
  locationRolloutStatus?: Record<string, BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus> | Computed<Record<string, BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus>>;
  rollout?: string | Computed<string>;
  rolloutPlan?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus {
  ...
  currentRollouts?: BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts[] | Computed<BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts[]>;
  previousRollout?: BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts | Computed<BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts>;
}

export interface BetaGlobalVmExtensionPolicy_RolloutOperation {
  rolloutInput?: BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutInput | Computed<BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutInput>;
  rolloutStatus?: BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus | Computed<BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus>;
}

const BetaGlobalVmExtensionPolicy_ExtensionPoliciesFields: FieldMap = {
  pinnedVersion: "pinned_version",
  stringConfig: "string_config",
};

const BetaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields: FieldMap = {
  inclusionLabels: "inclusion_labels",
};

const BetaGlobalVmExtensionPolicy_InstanceSelectorsFields: FieldMap = {
  labelSelector: {
...
const BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields: FieldMap = {
...
const BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields: FieldMap = {
  state: "state",
};

const BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields: FieldMap = {
...
const BetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields: FieldMap = {
  currentRollouts: {
...
const BetaGlobalVmExtensionPolicy_RolloutOperationFields: FieldMap = {
  rolloutInput: {
...
export interface BetaGlobalVmExtensionPolicyAttrs {
  ...
  description: string;
  /** Required. Map from extension (eg: "cloudops") to its policy configuration. The key is the name of the extension. */
  extensionPolicies: Record<string, BetaGlobalVmExtensionPolicy_ExtensionPolicies>;
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  /** Optional. Selector to target VMs for a policy. There is a logical "AND" between instance_selectors. */
  instanceSelectors: BetaGlobalVmExtensionPolicy_InstanceSelectors[];
  /** Output only. [Output Only] Type of the resource. Alwayscompute#globalVmExtensionPolicy for globalVmExtensionPolicies. */
  kind: string;
  /** Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and comply withRFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash. */
  name: string;
  ...
  priority: number;
  /** Represents the rollout operation */
  rolloutOperation: BetaGlobalVmExtensionPolicy_RolloutOperation;
  /** Output only. [Output Only] The scoped resource status. It's only for tracking the purging status of the policy. */
