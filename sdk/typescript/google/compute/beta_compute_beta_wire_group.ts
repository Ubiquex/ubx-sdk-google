// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_wire_group. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaWireGroup_Endpoints_Interconnects {
  interconnect?: string | Computed<string>;
  vlanTags?: number[] | Computed<number[]>;
}

export interface BetaComputeBetaWireGroup_Endpoints {
  interconnects?: Record<string, BetaComputeBetaWireGroup_Endpoints_Interconnects> | Computed<Record<string, BetaComputeBetaWireGroup_Endpoints_Interconnects>>;
}

export interface BetaComputeBetaWireGroup_Topology_Endpoints {
  city?: string | Computed<string>;
  label?: string | Computed<string>;
}

export interface BetaComputeBetaWireGroup_Topology {
  /** Output only. Topology details for all endpoints in the wire group. */
  endpoints?: BetaComputeBetaWireGroup_Topology_Endpoints[] | Computed<BetaComputeBetaWireGroup_Topology_Endpoints[]>;
}

export interface BetaComputeBetaWireGroup_WireGroupProperties {
...
export interface BetaComputeBetaWireGroup_WireProperties {
...
export interface BetaComputeBetaWireGroup_Wires_Endpoints {
  interconnect?: string | Computed<string>;
  vlanTag?: number | Computed<number>;
}

export interface BetaComputeBetaWireGroup_Wires {
  adminEnabled?: boolean | Computed<boolean>;
  endpoints?: BetaComputeBetaWireGroup_Wires_Endpoints[] | Computed<BetaComputeBetaWireGroup_Wires_Endpoints[]>;
  label?: string | Computed<string>;
  wireProperties?: BetaComputeBetaWireGroup_WireProperties | Computed<BetaComputeBetaWireGroup_WireProperties>;
}

const BetaComputeBetaWireGroup_Endpoints_InterconnectsFields: FieldMap = {
  interconnect: "interconnect",
  vlanTags: "vlan_tags",
};

const BetaComputeBetaWireGroup_EndpointsFields: FieldMap = {
  interconnects: {
    wireName: "interconnects",
    kind: "map",
    fields: BetaComputeBetaWireGroup_Endpoints_InterconnectsFields,
  },
};

const BetaComputeBetaWireGroup_Topology_EndpointsFields: FieldMap = {
  city: "city",
  label: "label",
};

const BetaComputeBetaWireGroup_TopologyFields: FieldMap = {
  endpoints: {
    wireName: "endpoints",
    kind: "list",
    fields: BetaComputeBetaWireGroup_Topology_EndpointsFields,
  },
};

const BetaComputeBetaWireGroup_WireGroupPropertiesFields: FieldMap = {
  type: "type",
};

const BetaComputeBetaWireGroup_WirePropertiesFields: FieldMap = {
  bandwidthAllocation: "bandwidth_allocation",
  bandwidthUnmetered: "bandwidth_unmetered",
  faultResponse: "fault_response",
};

const BetaComputeBetaWireGroup_Wires_EndpointsFields: FieldMap = {
  interconnect: "interconnect",
  vlanTag: "vlan_tag",
};

const BetaComputeBetaWireGroup_WiresFields: FieldMap = {
  adminEnabled: "admin_enabled",
  endpoints: {
    wireName: "endpoints",
    kind: "list",
    fields: BetaComputeBetaWireGroup_Wires_EndpointsFields,
  },
  label: "label",
  wireProperties: {
    wireName: "wire_properties",
    kind: "object",
    fields: BetaComputeBetaWireGroup_WirePropertiesFields,
  },
};

export interface BetaComputeBetaWireGroupConfig {
  ...
  endpoints?: Record<string, BetaComputeBetaWireGroup_Endpoints> | Computed<Record<string, BetaComputeBetaWireGroup_Endpoints>>;
  ...
  topology?: BetaComputeBetaWireGroup_Topology | Computed<BetaComputeBetaWireGroup_Topology>;
  /** The properties of a wire group. These properties determine how a group of redundant wires are created and managed. */
  wireGroupProperties?: BetaComputeBetaWireGroup_WireGroupProperties | Computed<BetaComputeBetaWireGroup_WireGroupProperties>;
  /** The properties of a wire. */
  wireProperties?: BetaComputeBetaWireGroup_WireProperties | Computed<BetaComputeBetaWireGroup_WireProperties>;
  /** Output only. The single/redundant wire(s) managed by the wire group. */
  wires?: BetaComputeBetaWireGroup_Wires[] | Computed<BetaComputeBetaWireGroup_Wires[]>;
}

export interface BetaComputeBetaWireGroupAttrs {
  /** Indicates whether the wires in the wire group are enabled. When false, the wires in the wire group are disabled. When true and when there is simultaneously no wire-specific override of `adminEnabled` to false, a given wire is enabled. Defaults to true. */
  ...
  description: string;
  /** A map that contains the logical endpoints of the wire group. Specify key-value pairs for the map as follows: - Key: an RFC1035 user-specified label. - Value: an Endpoint object. */
  endpoints: Record<string, BetaComputeBetaWireGroup_Endpoints>;
  /** Output only. [Output Only] The unique identifier for the resource type. The server generates this identifier. */
  id: string;
  /** Output only. [Output Only] Type of the resource. Alwayscompute#wireGroups for wire groups. */
  kind: string;
  ...
  selfLink: string;
  /** Topology details for the wire group. */
  topology: BetaComputeBetaWireGroup_Topology;
  /** The properties of a wire group. These properties determine how a group of redundant wires are created and managed. */
  wireGroupProperties: BetaComputeBetaWireGroup_WireGroupProperties;
  /** The properties of a wire. */
  wireProperties: BetaComputeBetaWireGroup_WireProperties;
  /** Output only. The single/redundant wire(s) managed by the wire group. */
  wires: BetaComputeBetaWireGroup_Wires[];
}

export const BetaComputeBetaWireGroup: ResourceBinding<BetaComputeBetaWireGroupConfig, BetaComputeBetaWireGroupAttrs> = {
  wireType: "google_compute_beta_compute_beta_wire_group",
  fields: {
    adminEnabled: "admin_enabled",
    ...
    endpoints: {
      wireName: "endpoints",
      kind: "map",
      fields: BetaComputeBetaWireGroup_EndpointsFields,
    },
    id: "id",
    kind: "kind",
    name: "name",
    ...
    topology: {
      wireName: "topology",
      kind: "object",
      fields: BetaComputeBetaWireGroup_TopologyFields,
    },
    wireGroupProperties: {
      wireName: "wire_group_properties",
      kind: "object",
      fields: BetaComputeBetaWireGroup_WireGroupPropertiesFields,
    },
    wireProperties: {
      wireName: "wire_properties",
      kind: "object",
    ...
    wires: {
      wireName: "wires",
      kind: "list",
      fields: BetaComputeBetaWireGroup_WiresFields,
    },
  },
};
