...
export interface AlphaAutoscaler_AutoscalingPolicy_CpuUtilization_SignalAggregation {
...
export interface AlphaAutoscaler_AutoscalingPolicy_CpuUtilization_TimeAggregation {
  /** If statistic is PERCENTILE, percentile must be defined. This value is used only when statistic is PERCENTILE. */
  percentile?: number | Computed<number>;
...
export interface AlphaAutoscaler_AutoscalingPolicy_CpuUtilization_UtilizationRange {
...
export interface AlphaAutoscaler_AutoscalingPolicy_CpuUtilization {
  ...
  signalAggregation?: AlphaAutoscaler_AutoscalingPolicy_CpuUtilization_SignalAggregation | Computed<AlphaAutoscaler_AutoscalingPolicy_CpuUtilization_SignalAggregation>;
  ...
  timeAggregation?: AlphaAutoscaler_AutoscalingPolicy_CpuUtilization_TimeAggregation | Computed<AlphaAutoscaler_AutoscalingPolicy_CpuUtilization_TimeAggregation>;
  ...
  utilizationRange?: AlphaAutoscaler_AutoscalingPolicy_CpuUtilization_UtilizationRange | Computed<AlphaAutoscaler_AutoscalingPolicy_CpuUtilization_UtilizationRange>;
...
export interface AlphaAutoscaler_AutoscalingPolicy_CustomMetricUtilizations {
...
export interface AlphaAutoscaler_AutoscalingPolicy_LoadBalancingUtilization {
  /** Fraction of backend capacity utilization (set in HTTP(S) load balancing configuration) that the autoscaler maintains. Must be a positive float value. If not defined, the default is 0.8. */
  utilizationTarget?: number | Computed<number>;
}

export interface AlphaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas {
...
export interface AlphaAutoscaler_AutoscalingPolicy_ScaleDownControl {
  /** Encapsulates numeric value that can be either absolute or relative. */
  maxScaledDownReplicas?: AlphaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas | Computed<AlphaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas>;
  /** How far back autoscaling looks when computing recommendations to include directives regarding slower scale in, as described above. */
  timeWindowSec?: number | Computed<number>;
}

export interface AlphaAutoscaler_AutoscalingPolicy_ScaleInControl {
  /** Encapsulates numeric value that can be either absolute or relative. */
  maxScaledInReplicas?: AlphaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas | Computed<AlphaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas>;
  /** How far back autoscaling looks when computing recommendations to include directives regarding slower scale in, as described above. */
  timeWindowSec?: number | Computed<number>;
}

export interface AlphaAutoscaler_AutoscalingPolicy_ScalingSchedules {
...
export interface AlphaAutoscaler_AutoscalingPolicy {
  ...
  cpuUtilization?: AlphaAutoscaler_AutoscalingPolicy_CpuUtilization | Computed<AlphaAutoscaler_AutoscalingPolicy_CpuUtilization>;
  /** Configuration parameters of autoscaling based on a custom metric. */
  customMetricUtilizations?: AlphaAutoscaler_AutoscalingPolicy_CustomMetricUtilizations[] | Computed<AlphaAutoscaler_AutoscalingPolicy_CustomMetricUtilizations[]>;
  /** Configuration parameters of autoscaling based on load balancing. */
  loadBalancingUtilization?: AlphaAutoscaler_AutoscalingPolicy_LoadBalancingUtilization | Computed<AlphaAutoscaler_AutoscalingPolicy_LoadBalancingUtilization>;
  ...
  scaleDownControl?: AlphaAutoscaler_AutoscalingPolicy_ScaleDownControl | Computed<AlphaAutoscaler_AutoscalingPolicy_ScaleDownControl>;
  /** Configuration that allows for slower scale in so that even if Autoscaler recommends an abrupt scale in of a MIG, it will be throttled as specified by the parameters below. */
  scaleInControl?: AlphaAutoscaler_AutoscalingPolicy_ScaleInControl | Computed<AlphaAutoscaler_AutoscalingPolicy_ScaleInControl>;
  /** Scaling schedules defined for an autoscaler. Multiple schedules can be set on an autoscaler, and they can overlap. During overlapping periods the greatest min_required_replicas of all scaling schedules is applied. Up to 128 scaling schedules are allowed. */
  scalingSchedules?: Record<string, AlphaAutoscaler_AutoscalingPolicy_ScalingSchedules> | Computed<Record<string, AlphaAutoscaler_AutoscalingPolicy_ScalingSchedules>>;
...
export interface AlphaAutoscaler_ScalingScheduleStatus {
  lastStartTime?: string | Computed<string>;
  nextStartTime?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface AlphaAutoscaler_StatusDetails {
  message?: string | Computed<string>;
  type?: string | Computed<string>;
}

const AlphaAutoscaler_AutoscalingPolicy_CpuUtilization_SignalAggregationFields: FieldMap = {
  percentile: "percentile",
  statistic: "statistic",
};

const AlphaAutoscaler_AutoscalingPolicy_CpuUtilization_TimeAggregationFields: FieldMap = {
  percentile: "percentile",
  statistic: "statistic",
  timeWindowSec: "time_window_sec",
};

const AlphaAutoscaler_AutoscalingPolicy_CpuUtilization_UtilizationRangeFields: FieldMap = {
  maxUtilization: "max_utilization",
  minUtilization: "min_utilization",
  utilizationTarget: "utilization_target",
};

const AlphaAutoscaler_AutoscalingPolicy_CpuUtilizationFields: FieldMap = {
...
const AlphaAutoscaler_AutoscalingPolicy_CustomMetricUtilizationsFields: FieldMap = {
  filter: "filter",
  metric: "metric",
...
const AlphaAutoscaler_AutoscalingPolicy_LoadBalancingUtilizationFields: FieldMap = {
  utilizationTarget: "utilization_target",
};

const AlphaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicasFields: FieldMap = {
  calculated: "calculated",
  fixed: "fixed",
  percent: "percent",
};

const AlphaAutoscaler_AutoscalingPolicy_ScaleDownControlFields: FieldMap = {
...
const AlphaAutoscaler_AutoscalingPolicy_ScaleInControlFields: FieldMap = {
  maxScaledInReplicas: {
...
const AlphaAutoscaler_AutoscalingPolicy_ScalingSchedulesFields: FieldMap = {
...
const AlphaAutoscaler_AutoscalingPolicyFields: FieldMap = {
...
const AlphaAutoscaler_ScalingScheduleStatusFields: FieldMap = {
  lastStartTime: "last_start_time",
  nextStartTime: "next_start_time",
  state: "state",
};

const AlphaAutoscaler_StatusDetailsFields: FieldMap = {
  message: "message",
  type: "type",
};

export interface AlphaAutoscalerConfig {
  /** Cloud Autoscaler policy. */
  autoscalingPolicy?: AlphaAutoscaler_AutoscalingPolicy | Computed<AlphaAutoscaler_AutoscalingPolicy>;
  ...
  scalingScheduleStatus?: Record<string, AlphaAutoscaler_ScalingScheduleStatus> | Computed<Record<string, AlphaAutoscaler_ScalingScheduleStatus>>;
  ...
  statusDetails?: AlphaAutoscaler_StatusDetails[] | Computed<AlphaAutoscaler_StatusDetails[]>;
...
export interface AlphaAutoscalerAttrs {
  /** Cloud Autoscaler policy. */
  autoscalingPolicy: AlphaAutoscaler_AutoscalingPolicy;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  region: string;
  /** Output only. [Output Only] Status information of existing scaling schedules. */
  scalingScheduleStatus: Record<string, AlphaAutoscaler_ScalingScheduleStatus>;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource with the resource id. */
  ...
  status: string;
  /** [Output Only] Human-readable details about the current state of the autoscaler. Read the documentation forCommonly returned status messages for examples of status messages you might encounter. */
  statusDetails: AlphaAutoscaler_StatusDetails[];
  /** URL of the managed instance group that this autoscaler will scale. This field is required when creating an autoscaler. */
  target: string;
  /** Output only. [Output Only] URL of thezone where the instance group resides (for autoscalers living in zonal scope). */
  zone: string;
...
export const AlphaAutoscaler: ResourceBinding<AlphaAutoscalerConfig, AlphaAutoscalerAttrs> = {
  wireType: "google_compute_alpha_autoscaler",
  fields: {
    autoscalingPolicy: {
    ...
    scalingScheduleStatus: {
      ...
      kind: "map",
      fields: AlphaAutoscaler_ScalingScheduleStatusFields,
    },
    selfLink: "self_link",
