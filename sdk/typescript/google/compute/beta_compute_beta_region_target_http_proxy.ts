// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_region_target_http_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaRegionTargetHttpProxyConfig {
...
export interface BetaComputeBetaRegionTargetHttpProxyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaComputeBetaRegionTargetHttpProxy: ResourceBinding<BetaComputeBetaRegionTargetHttpProxyConfig, BetaComputeBetaRegionTargetHttpProxyAttrs> = {
  wireType: "google_compute_beta_compute_beta_region_target_http_proxy",
  fields: {
