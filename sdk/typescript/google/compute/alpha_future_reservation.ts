// Code generated by `ubx sdk gen` from google_compute_alpha_future_reservation. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaFutureReservation_AdvancedDeploymentControl {
  /** Indicates chosen reservation operational mode for the reservation. */
  reservationOperationalMode?: string | Computed<string>;
}

export interface AlphaFutureReservation_AggregateReservation_InUseResources_Accelerator {
  acceleratorCount?: number | Computed<number>;
  acceleratorType?: string | Computed<string>;
}

export interface AlphaFutureReservation_AggregateReservation_InUseResources {
  accelerator?: AlphaFutureReservation_AggregateReservation_InUseResources_Accelerator | Computed<AlphaFutureReservation_AggregateReservation_InUseResources_Accelerator>;
}

export interface AlphaFutureReservation_AggregateReservation {
  ...
  inUseResources?: AlphaFutureReservation_AggregateReservation_InUseResources[] | Computed<AlphaFutureReservation_AggregateReservation_InUseResources[]>;
  /** List of reserved resources (CPUs, memory, accelerators). */
  reservedResources?: AlphaFutureReservation_AggregateReservation_InUseResources[] | Computed<AlphaFutureReservation_AggregateReservation_InUseResources[]>;
...
export interface AlphaFutureReservation_AutoCreatedReservationsDuration {
...
export interface AlphaFutureReservation_CommitmentInfo {
...
export interface AlphaFutureReservation_Params {
...
export interface AlphaFutureReservation_ShareSettings_FolderMap {
  folderId?: string | Computed<string>;
}

export interface AlphaFutureReservation_ShareSettings_ProjectMap {
  projectId?: string | Computed<string>;
}

export interface AlphaFutureReservation_ShareSettings {
  ...
  folderMap?: Record<string, AlphaFutureReservation_ShareSettings_FolderMap> | Computed<Record<string, AlphaFutureReservation_ShareSettings_FolderMap>>;
  /** A map of project id and project config. This is only valid when share_type's value is SPECIFIC_PROJECTS. */
  projectMap?: Record<string, AlphaFutureReservation_ShareSettings_ProjectMap> | Computed<Record<string, AlphaFutureReservation_ShareSettings_ProjectMap>>;
...
export interface AlphaFutureReservation_SpecificSkuProperties_InstanceProperties_LocalSsds {
  diskSizeGb?: string | Computed<string>;
  interface?: string | Computed<string>;
}

export interface AlphaFutureReservation_SpecificSkuProperties_InstanceProperties {
  /** Specifies accelerator type and count. */
  guestAccelerators?: AlphaFutureReservation_AggregateReservation_InUseResources_Accelerator[] | Computed<AlphaFutureReservation_AggregateReservation_InUseResources_Accelerator[]>;
  /** Specifies amount of local ssd to reserve with each instance. The type of disk is local-ssd. */
  localSsds?: AlphaFutureReservation_SpecificSkuProperties_InstanceProperties_LocalSsds[] | Computed<AlphaFutureReservation_SpecificSkuProperties_InstanceProperties_LocalSsds[]>;
...
export interface AlphaFutureReservation_SpecificSkuProperties {
  /** Properties of the SKU instances being reserved. Next ID: 10 */
  instanceProperties?: AlphaFutureReservation_SpecificSkuProperties_InstanceProperties | Computed<AlphaFutureReservation_SpecificSkuProperties_InstanceProperties>;
...
export interface AlphaFutureReservation_Status_ExapoolProvisionedCapacityGb {
...
export interface AlphaFutureReservation_Status_ExistingMatchingUsageInfo {
...
export interface AlphaFutureReservation_Status_LastKnownGoodState_FutureReservationSpecs_TimeWindow {
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  duration?: AlphaFutureReservation_AutoCreatedReservationsDuration | Computed<AlphaFutureReservation_AutoCreatedReservationsDuration>;
  endTime?: string | Computed<string>;
  /** Start time of the Future Reservation. The start_time is an RFC3339 string. */
  startTime?: string | Computed<string>;
}

export interface AlphaFutureReservation_Status_LastKnownGoodState_FutureReservationSpecs {
  /** The share setting for reservations and sole tenancy node groups. */
  shareSettings?: AlphaFutureReservation_ShareSettings | Computed<AlphaFutureReservation_ShareSettings>;
  specificSkuProperties?: AlphaFutureReservation_SpecificSkuProperties | Computed<AlphaFutureReservation_SpecificSkuProperties>;
...
export interface AlphaFutureReservation_Status_LastKnownGoodState {
  ...
  existingMatchingUsageInfo?: AlphaFutureReservation_Status_ExistingMatchingUsageInfo | Computed<AlphaFutureReservation_Status_ExistingMatchingUsageInfo>;
  /** The properties of the last known good state for the Future Reservation. */
  futureReservationSpecs?: AlphaFutureReservation_Status_LastKnownGoodState_FutureReservationSpecs | Computed<AlphaFutureReservation_Status_LastKnownGoodState_FutureReservationSpecs>;
...
export interface AlphaFutureReservation_Status_SpecificSkuProperties {
  /** ID of the instance template used to populate the Future Reservation properties. */
  sourceInstanceTemplateId?: string | Computed<string>;
}

export interface AlphaFutureReservation_Status_StoragePoolProvisionedCapacity {
...
export interface AlphaFutureReservation_Status {
  ...
  exapoolProvisionedCapacityGb?: AlphaFutureReservation_Status_ExapoolProvisionedCapacityGb | Computed<AlphaFutureReservation_Status_ExapoolProvisionedCapacityGb>;
  /** [Output Only] Represents the existing matching usage for the future reservation. */
  existingMatchingUsageInfo?: AlphaFutureReservation_Status_ExistingMatchingUsageInfo | Computed<AlphaFutureReservation_Status_ExistingMatchingUsageInfo>;
  ...
  lastKnownGoodState?: AlphaFutureReservation_Status_LastKnownGoodState | Computed<AlphaFutureReservation_Status_LastKnownGoodState>;
  ...
  specificSkuProperties?: AlphaFutureReservation_Status_SpecificSkuProperties | Computed<AlphaFutureReservation_Status_SpecificSkuProperties>;
  /** Storage pool provisioned capacities for each SKU type. */
  storagePoolProvisionedCapacity?: AlphaFutureReservation_Status_StoragePoolProvisionedCapacity | Computed<AlphaFutureReservation_Status_StoragePoolProvisionedCapacity>;
}

export interface AlphaFutureReservation_StoragePoolProperties {
  /** Exapool provisioned capacities for each SKU type */
  requestedExapoolProvisionedCapacityGb?: AlphaFutureReservation_Status_ExapoolProvisionedCapacityGb | Computed<AlphaFutureReservation_Status_ExapoolProvisionedCapacityGb>;
  /** Storage pool provisioned capacities for each SKU type. */
  requestedStoragePoolProvisionedCapacity?: AlphaFutureReservation_Status_StoragePoolProvisionedCapacity | Computed<AlphaFutureReservation_Status_StoragePoolProvisionedCapacity>;
  /** Type of the storage pool. */
  storagePoolType?: string | Computed<string>;
}

const AlphaFutureReservation_AdvancedDeploymentControlFields: FieldMap = {
  reservationOperationalMode: "reservation_operational_mode",
};

const AlphaFutureReservation_AggregateReservation_InUseResources_AcceleratorFields: FieldMap = {
  acceleratorCount: "accelerator_count",
  acceleratorType: "accelerator_type",
};

const AlphaFutureReservation_AggregateReservation_InUseResourcesFields: FieldMap = {
  accelerator: {
...
const AlphaFutureReservation_AggregateReservationFields: FieldMap = {
...
const AlphaFutureReservation_AutoCreatedReservationsDurationFields: FieldMap = {
  nanos: "nanos",
  seconds: "seconds",
};

const AlphaFutureReservation_CommitmentInfoFields: FieldMap = {
  commitmentName: "commitment_name",
  commitmentPlan: "commitment_plan",
  previousCommitmentTerms: "previous_commitment_terms",
};

const AlphaFutureReservation_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaFutureReservation_ShareSettings_FolderMapFields: FieldMap = {
  folderId: "folder_id",
};

const AlphaFutureReservation_ShareSettings_ProjectMapFields: FieldMap = {
  projectId: "project_id",
};

const AlphaFutureReservation_ShareSettingsFields: FieldMap = {
  folderMap: {
    wireName: "folder_map",
    kind: "map",
...
const AlphaFutureReservation_SpecificSkuProperties_InstanceProperties_LocalSsdsFields: FieldMap = {
  diskSizeGb: "disk_size_gb",
  interface: "interface",
};

const AlphaFutureReservation_SpecificSkuProperties_InstancePropertiesFields: FieldMap = {
  guestAccelerators: {
...
const AlphaFutureReservation_SpecificSkuPropertiesFields: FieldMap = {
  instanceProperties: {
...
const AlphaFutureReservation_Status_ExapoolProvisionedCapacityGbFields: FieldMap = {
  capacityOptimized: "capacity_optimized",
  readOptimized: "read_optimized",
  writeOptimized: "write_optimized",
};

const AlphaFutureReservation_Status_ExistingMatchingUsageInfoFields: FieldMap = {
  count: "count",
  timestamp: "timestamp",
};

const AlphaFutureReservation_Status_LastKnownGoodState_FutureReservationSpecs_TimeWindowFields: FieldMap = {
  duration: {
    wireName: "duration",
    kind: "object",
...
const AlphaFutureReservation_Status_LastKnownGoodState_FutureReservationSpecsFields: FieldMap = {
  shareSettings: {
...
const AlphaFutureReservation_Status_LastKnownGoodStateFields: FieldMap = {
...
const AlphaFutureReservation_Status_SpecificSkuPropertiesFields: FieldMap = {
  sourceInstanceTemplateId: "source_instance_template_id",
};

const AlphaFutureReservation_Status_StoragePoolProvisionedCapacityFields: FieldMap = {
...
const AlphaFutureReservation_StatusFields: FieldMap = {
...
const AlphaFutureReservation_StoragePoolPropertiesFields: FieldMap = {
...
export interface AlphaFutureReservationConfig {
  /** Advance control for cluster management, applicable only to DENSE deployment type reservations. */
  advancedDeploymentControl?: AlphaFutureReservation_AdvancedDeploymentControl | Computed<AlphaFutureReservation_AdvancedDeploymentControl>;
  /** This reservation type is specified by total resource amounts (e.g. total count of CPUs) and can account for multiple instance SKUs. In other words, one can create instances of varying shapes against this reservation. */
  aggregateReservation?: AlphaFutureReservation_AggregateReservation | Computed<AlphaFutureReservation_AggregateReservation>;
  ...
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  autoCreatedReservationsDuration?: AlphaFutureReservation_AutoCreatedReservationsDuration | Computed<AlphaFutureReservation_AutoCreatedReservationsDuration>;
  ...
  params?: AlphaFutureReservation_Params | Computed<AlphaFutureReservation_Params>;
...
export interface AlphaFutureReservationAttrs {
  /** Advance control for cluster management, applicable only to DENSE deployment type reservations. */
  advancedDeploymentControl: AlphaFutureReservation_AdvancedDeploymentControl;
  /** This reservation type is specified by total resource amounts (e.g. total count of CPUs) and can account for multiple instance SKUs. In other words, one can create instances of varying shapes against this reservation. */
  aggregateReservation: AlphaFutureReservation_AggregateReservation;
  /** Future timestamp when the FR auto-created reservations will be deleted by Compute Engine. Format of this field must be a valid href="https://www.ietf.org/rfc/rfc3339.txt">RFC3339 value. */
  autoCreatedReservationsDeleteTime: string;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  autoCreatedReservationsDuration: AlphaFutureReservation_AutoCreatedReservationsDuration;
  /** Setting for enabling or disabling automatic deletion for auto-created reservation. If set to true, auto-created reservations will be deleted at Future Reservation's end time (default) or at user's defined timestamp if any of the [auto_created_reservations_delete_time, auto_created_reservations_duration] values is specified. For keeping auto-created reservation indefinitely, this value should be set to false. */
  ...
  namePrefix: string;
  /** Additional future reservation params. */
  params: AlphaFutureReservation_Params;
  /** Planning state before being submitted for evaluation */
  ...
  /** The share setting for reservations and sole tenancy node groups. */
  shareSettings: AlphaFutureReservation_ShareSettings;
  /** Indicates whether the auto-created reservation can be consumed by VMs with affinity for "any" reservation. If the field is set, then only VMs that target the reservation by name can consume from the delivered reservation. */
  specificReservationRequired: boolean;
  specificSkuProperties: AlphaFutureReservation_SpecificSkuProperties;
  /** [Output only] Represents status related to the future reservation. */
...
export const AlphaFutureReservation: ResourceBinding<AlphaFutureReservationConfig, AlphaFutureReservationAttrs> = {
  wireType: "google_compute_alpha_future_reservation",
  fields: {
