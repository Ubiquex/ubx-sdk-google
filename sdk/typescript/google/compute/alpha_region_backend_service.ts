// Code generated by `ubx sdk gen` from google_compute_alpha_region_backend_service. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaRegionBackendService_Backends_CustomMetrics {
  dryRun?: boolean | Computed<boolean>;
  maxUtilization?: number | Computed<number>;
  name?: string | Computed<string>;
}

export interface AlphaRegionBackendService_Backends_OrchestrationInfo {
  resourceUri?: string | Computed<string>;
}

export interface AlphaRegionBackendService_Backends {
  balancingMode?: string | Computed<string>;
  capacityScaler?: number | Computed<number>;
  customMetrics?: AlphaRegionBackendService_Backends_CustomMetrics[] | Computed<AlphaRegionBackendService_Backends_CustomMetrics[]>;
  ...
  maxUtilization?: number | Computed<number>;
  orchestrationInfo?: AlphaRegionBackendService_Backends_OrchestrationInfo | Computed<AlphaRegionBackendService_Backends_OrchestrationInfo>;
  preference?: string | Computed<string>;
  service?: string | Computed<string>;
  trafficDuration?: string | Computed<string>;
}

export interface AlphaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders {
  headerName?: string | Computed<string>;
}

export interface AlphaRegionBackendService_CdnPolicy_CacheKeyPolicy {
...
export interface AlphaRegionBackendService_CdnPolicy_NegativeCachingPolicy {
  code?: number | Computed<number>;
  ttl?: number | Computed<number>;
}

export interface AlphaRegionBackendService_CdnPolicy {
  /** Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings. */
  bypassCacheOnRequestHeaders?: AlphaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<AlphaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders[]>;
  /** Message containing what to include in the cache key for a request for Cloud CDN. */
  cacheKeyPolicy?: AlphaRegionBackendService_CdnPolicy_CacheKeyPolicy | Computed<AlphaRegionBackendService_CdnPolicy_CacheKeyPolicy>;
  ...
  negativeCachingPolicy?: AlphaRegionBackendService_CdnPolicy_NegativeCachingPolicy[] | Computed<AlphaRegionBackendService_CdnPolicy_NegativeCachingPolicy[]>;
...
export interface AlphaRegionBackendService_CircuitBreakers_ConnectTimeout {
...
export interface AlphaRegionBackendService_CircuitBreakers {
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  connectTimeout?: AlphaRegionBackendService_CircuitBreakers_ConnectTimeout | Computed<AlphaRegionBackendService_CircuitBreakers_ConnectTimeout>;
...
export interface AlphaRegionBackendService_ConnectionDraining {
...
export interface AlphaRegionBackendService_ConnectionTrackingPolicy {
...
export interface AlphaRegionBackendService_ConsistentHash_HttpCookie {
  /** Name of the cookie. */
  name?: string | Computed<string>;
  /** Path to set for the cookie. */
  path?: string | Computed<string>;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  ttl?: AlphaRegionBackendService_CircuitBreakers_ConnectTimeout | Computed<AlphaRegionBackendService_CircuitBreakers_ConnectTimeout>;
}

export interface AlphaRegionBackendService_ConsistentHash {
  /** The information about the HTTP Cookie on which the hash function is based for load balancing policies that use a consistent hash. */
  httpCookie?: AlphaRegionBackendService_ConsistentHash_HttpCookie | Computed<AlphaRegionBackendService_ConsistentHash_HttpCookie>;
...
export interface AlphaRegionBackendService_CustomMetrics {
  dryRun?: boolean | Computed<boolean>;
  name?: string | Computed<string>;
}

export interface AlphaRegionBackendService_DynamicForwarding_ForwardProxy {
...
export interface AlphaRegionBackendService_DynamicForwarding_IpPortSelection {
  /** A boolean flag enabling IP:PORT based dynamic forwarding. */
  enabled?: boolean | Computed<boolean>;
}

export interface AlphaRegionBackendService_DynamicForwarding {
  /** Defines Dynamic Forwarding Proxy configuration. */
  forwardProxy?: AlphaRegionBackendService_DynamicForwarding_ForwardProxy | Computed<AlphaRegionBackendService_DynamicForwarding_ForwardProxy>;
  ...
  ipPortSelection?: AlphaRegionBackendService_DynamicForwarding_IpPortSelection | Computed<AlphaRegionBackendService_DynamicForwarding_IpPortSelection>;
}

export interface AlphaRegionBackendService_FailoverPolicy {
...
export interface AlphaRegionBackendService_HaPolicy_Leader_NetworkEndpoint {
...
export interface AlphaRegionBackendService_HaPolicy_Leader {
  ...
  networkEndpoint?: AlphaRegionBackendService_HaPolicy_Leader_NetworkEndpoint | Computed<AlphaRegionBackendService_HaPolicy_Leader_NetworkEndpoint>;
}

export interface AlphaRegionBackendService_HaPolicy {
  ...
  leader?: AlphaRegionBackendService_HaPolicy_Leader | Computed<AlphaRegionBackendService_HaPolicy_Leader>;
}

export interface AlphaRegionBackendService_Iap_Oauth2ClientInfo {
...
export interface AlphaRegionBackendService_Iap {
  /** Whether the serving infrastructure will authenticate and authorize all incoming requests. */
  enabled?: boolean | Computed<boolean>;
  /** OAuth2 client ID to use for the authentication flow. */
  oauth2ClientId?: string | Computed<string>;
  oauth2ClientInfo?: AlphaRegionBackendService_Iap_Oauth2ClientInfo | Computed<AlphaRegionBackendService_Iap_Oauth2ClientInfo>;
...
export interface AlphaRegionBackendService_LocalityLbPolicies_CustomPolicy {
  data?: string | Computed<string>;
  name?: string | Computed<string>;
}

export interface AlphaRegionBackendService_LocalityLbPolicies_Policy {
  name?: string | Computed<string>;
}

export interface AlphaRegionBackendService_LocalityLbPolicies {
  customPolicy?: AlphaRegionBackendService_LocalityLbPolicies_CustomPolicy | Computed<AlphaRegionBackendService_LocalityLbPolicies_CustomPolicy>;
  policy?: AlphaRegionBackendService_LocalityLbPolicies_Policy | Computed<AlphaRegionBackendService_LocalityLbPolicies_Policy>;
}

export interface AlphaRegionBackendService_LogConfig {
  /** Denotes whether to enable logging for the load balancer traffic served by this backend service. The default value is false. */
  enable?: boolean | Computed<boolean>;
  /** The list of request headers that will be logged to Stackdriver. */
  loggingHttpRequestHeaders?: AlphaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<AlphaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders[]>;
  /** The list of response headers that will be logged to Stackdriver. */
  loggingHttpResponseHeaders?: AlphaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<AlphaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders[]>;
...
export interface AlphaRegionBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity {
...
export interface AlphaRegionBackendService_NetworkPassThroughLbTrafficPolicy {
  zonalAffinity?: AlphaRegionBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity | Computed<AlphaRegionBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity>;
}

export interface AlphaRegionBackendService_OutlierDetection {
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  baseEjectionTime?: AlphaRegionBackendService_CircuitBreakers_ConnectTimeout | Computed<AlphaRegionBackendService_CircuitBreakers_ConnectTimeout>;
  ...
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  interval?: AlphaRegionBackendService_CircuitBreakers_ConnectTimeout | Computed<AlphaRegionBackendService_CircuitBreakers_ConnectTimeout>;
...
export interface AlphaRegionBackendService_Params {
...
export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt_JwtHeaders {
  name?: string | Computed<string>;
  valuePrefix?: string | Computed<string>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt {
  audiences?: string[] | Computed<string[]>;
  issuer?: string | Computed<string>;
  jwksPublicKeys?: string | Computed<string>;
  jwtHeaders?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt_JwtHeaders[] | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt_JwtHeaders[]>;
  jwtParams?: string[] | Computed<string[]>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Origins {
  jwt?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Peers_Mtls {
  mode?: string | Computed<string>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Peers {
  mtls?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Peers_Mtls | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Peers_Mtls>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePaths {
...
export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPlugin {
  /** Plugin name. */
  name?: string | Computed<string>;
...
export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials {
  ...
  fromPlugin?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPlugin | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPlugin>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentials {
  ...
  certificates?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePaths | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePaths>;
...
export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig {
  /** [Deprecated] gRPC call credentials to access the SDS server. gRPC call credentials to access the SDS server. */
  callCredentials?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials>;
  /** [Deprecated] gRPC channel credentials to access the SDS server. gRPC channel credentials to access the SDS server. */
  channelCredentials?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentials | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentials>;
  /** The target URI of the SDS server. */
  targetUri?: string | Computed<string>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig {
  /** [Deprecated] gRPC config to access the SDS server. gRPC config to access the SDS server. */
  grpcServiceConfig?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext {
  /** [Deprecated] The paths to the mounted TLS Certificates and private key. The paths to the mounted TLS Certificates and private key. */
  certificatePaths?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePaths | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePaths>;
  ...
  sdsConfig?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_ValidationContext {
...
export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext {
  ...
  certificateContext?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext>;
  ...
  validationContext?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_ValidationContext | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_ValidationContext>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy {
  ...
  origins?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Origins[] | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Origins[]>;
  ...
  peers?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Peers[] | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Peers[]>;
  ...
  serverTlsContext?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions_Constraints {
  key?: string | Computed<string>;
  values?: string[] | Computed<string[]>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions {
  constraints?: AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions_Constraints[] | Computed<AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions_Constraints[]>;
...
export interface AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies_Principals {
...
export interface AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies {
  name?: string | Computed<string>;
  permissions?: AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions[] | Computed<AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions[]>;
  principals?: AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies_Principals[] | Computed<AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies_Principals[]>;
}

export interface AlphaRegionBackendService_SecuritySettings_AuthorizationConfig {
  /** List of RbacPolicies. */
  policies?: AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies[] | Computed<AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies[]>;
}

export interface AlphaRegionBackendService_SecuritySettings_AwsV4Authentication {
...
export interface AlphaRegionBackendService_SecuritySettings_ClientTlsSettings {
  /** [Deprecated] The TLS settings for the client or server. The TLS settings for the client or server. */
  clientTlsContext?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext>;
...
export interface AlphaRegionBackendService_SecuritySettings {
  ...
  authenticationPolicy?: AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy | Computed<AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy>;
  ...
  authorizationConfig?: AlphaRegionBackendService_SecuritySettings_AuthorizationConfig | Computed<AlphaRegionBackendService_SecuritySettings_AuthorizationConfig>;
  /** Contains the configurations necessary to generate a signature for access to private storage buckets that support Signature Version 4 for authentication. The service name for generating the authentication header will always default to 's3'. */
  awsV4Authentication?: AlphaRegionBackendService_SecuritySettings_AwsV4Authentication | Computed<AlphaRegionBackendService_SecuritySettings_AwsV4Authentication>;
  ...
  clientTlsSettings?: AlphaRegionBackendService_SecuritySettings_ClientTlsSettings | Computed<AlphaRegionBackendService_SecuritySettings_ClientTlsSettings>;
...
export interface AlphaRegionBackendService_Subsetting {
...
export interface AlphaRegionBackendService_TlsSettings_SubjectAltNames {
  dnsName?: string | Computed<string>;
  uniformResourceIdentifier?: string | Computed<string>;
}

export interface AlphaRegionBackendService_TlsSettings {
  ...
  subjectAltNames?: AlphaRegionBackendService_TlsSettings_SubjectAltNames[] | Computed<AlphaRegionBackendService_TlsSettings_SubjectAltNames[]>;
}

export interface AlphaRegionBackendService_UsedBy {
  reference?: string | Computed<string>;
}

const AlphaRegionBackendService_Backends_CustomMetricsFields: FieldMap = {
  dryRun: "dry_run",
  maxUtilization: "max_utilization",
  name: "name",
};

const AlphaRegionBackendService_Backends_OrchestrationInfoFields: FieldMap = {
  resourceUri: "resource_uri",
};

const AlphaRegionBackendService_BackendsFields: FieldMap = {
...
const AlphaRegionBackendService_CdnPolicy_BypassCacheOnRequestHeadersFields: FieldMap = {
  headerName: "header_name",
};

const AlphaRegionBackendService_CdnPolicy_CacheKeyPolicyFields: FieldMap = {
...
const AlphaRegionBackendService_CdnPolicy_NegativeCachingPolicyFields: FieldMap = {
  code: "code",
  ttl: "ttl",
};

const AlphaRegionBackendService_CdnPolicyFields: FieldMap = {
...
const AlphaRegionBackendService_CircuitBreakers_ConnectTimeoutFields: FieldMap = {
  nanos: "nanos",
  seconds: "seconds",
};

const AlphaRegionBackendService_CircuitBreakersFields: FieldMap = {
  connectTimeout: {
...
const AlphaRegionBackendService_ConnectionDrainingFields: FieldMap = {
  drainingTimeoutSec: "draining_timeout_sec",
};

const AlphaRegionBackendService_ConnectionTrackingPolicyFields: FieldMap = {
...
const AlphaRegionBackendService_ConsistentHash_HttpCookieFields: FieldMap = {
  name: "name",
  path: "path",
  ttl: {
    wireName: "ttl",
...
const AlphaRegionBackendService_ConsistentHashFields: FieldMap = {
  httpCookie: {
...
const AlphaRegionBackendService_CustomMetricsFields: FieldMap = {
  dryRun: "dry_run",
  name: "name",
};

const AlphaRegionBackendService_DynamicForwarding_ForwardProxyFields: FieldMap = {
  enabled: "enabled",
  proxyMode: "proxy_mode",
};

const AlphaRegionBackendService_DynamicForwarding_IpPortSelectionFields: FieldMap = {
  enabled: "enabled",
};

const AlphaRegionBackendService_DynamicForwardingFields: FieldMap = {
  forwardProxy: {
...
const AlphaRegionBackendService_FailoverPolicyFields: FieldMap = {
...
const AlphaRegionBackendService_HaPolicy_Leader_NetworkEndpointFields: FieldMap = {
  instance: "instance",
};

const AlphaRegionBackendService_HaPolicy_LeaderFields: FieldMap = {
...
const AlphaRegionBackendService_HaPolicyFields: FieldMap = {
...
const AlphaRegionBackendService_Iap_Oauth2ClientInfoFields: FieldMap = {
  applicationName: "application_name",
  clientName: "client_name",
  developerEmailAddress: "developer_email_address",
};

const AlphaRegionBackendService_IapFields: FieldMap = {
  enabled: "enabled",
...
const AlphaRegionBackendService_LocalityLbPolicies_CustomPolicyFields: FieldMap = {
  data: "data",
  name: "name",
};

const AlphaRegionBackendService_LocalityLbPolicies_PolicyFields: FieldMap = {
  name: "name",
};

const AlphaRegionBackendService_LocalityLbPoliciesFields: FieldMap = {
  customPolicy: {
...
const AlphaRegionBackendService_LogConfigFields: FieldMap = {
  enable: "enable",
...
const AlphaRegionBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinityFields: FieldMap = {
  spillover: "spillover",
  spilloverRatio: "spillover_ratio",
};

const AlphaRegionBackendService_NetworkPassThroughLbTrafficPolicyFields: FieldMap = {
  zonalAffinity: {
...
const AlphaRegionBackendService_OutlierDetectionFields: FieldMap = {
  baseEjectionTime: {
...
const AlphaRegionBackendService_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Origins_Jwt_JwtHeadersFields: FieldMap = {
  name: "name",
  valuePrefix: "value_prefix",
};

const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Origins_JwtFields: FieldMap = {
  audiences: "audiences",
  issuer: "issuer",
...
const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_OriginsFields: FieldMap = {
  jwt: {
    wireName: "jwt",
    kind: "object",
...
const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_Peers_MtlsFields: FieldMap = {
  mode: "mode",
};

const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_PeersFields: FieldMap = {
  mtls: {
    wireName: "mtls",
    kind: "object",
...
const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_CertificatePathsFields: FieldMap = {
  certificatePath: "certificate_path",
  privateKeyPath: "private_key_path",
};

const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPluginFields: FieldMap = {
  name: "name",
  structConfig: "struct_config",
};

const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentialsFields: FieldMap = {
...
const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentialsFields: FieldMap = {
  certificates: {
...
const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfig_GrpcServiceConfigFields: FieldMap = {
  callCredentials: {
...
const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContext_SdsConfigFields: FieldMap = {
  grpcServiceConfig: {
...
const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_CertificateContextFields: FieldMap = {
  certificatePaths: {
...
const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContext_ValidationContextFields: FieldMap = {
  certificatePath: "certificate_path",
  sdsConfig: {
    wireName: "sds_config",
    kind: "object",
...
const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicy_ServerTlsContextFields: FieldMap = {
  certificateContext: {
...
const AlphaRegionBackendService_SecuritySettings_AuthenticationPolicyFields: FieldMap = {
  origins: {
    wireName: "origins",
    kind: "list",
...
const AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies_Permissions_ConstraintsFields: FieldMap = {
  key: "key",
  values: "values",
};

const AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies_PermissionsFields: FieldMap = {
  constraints: {
...
const AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_Policies_PrincipalsFields: FieldMap = {
  condition: "condition",
  groups: "groups",
  ips: "ips",
...
const AlphaRegionBackendService_SecuritySettings_AuthorizationConfig_PoliciesFields: FieldMap = {
  name: "name",
  permissions: {
...
const AlphaRegionBackendService_SecuritySettings_AuthorizationConfigFields: FieldMap = {
  policies: {
    wireName: "policies",
    kind: "list",
...
const AlphaRegionBackendService_SecuritySettings_AwsV4AuthenticationFields: FieldMap = {
...
const AlphaRegionBackendService_SecuritySettings_ClientTlsSettingsFields: FieldMap = {
  clientTlsContext: {
...
const AlphaRegionBackendService_SecuritySettingsFields: FieldMap = {
...
const AlphaRegionBackendService_SubsettingFields: FieldMap = {
  policy: "policy",
  subsetSize: "subset_size",
};

const AlphaRegionBackendService_TlsSettings_SubjectAltNamesFields: FieldMap = {
  dnsName: "dns_name",
  uniformResourceIdentifier: "uniform_resource_identifier",
};

const AlphaRegionBackendService_TlsSettingsFields: FieldMap = {
...
const AlphaRegionBackendService_UsedByFields: FieldMap = {
  reference: "reference",
};

export interface AlphaRegionBackendServiceConfig {
  ...
  backends?: AlphaRegionBackendService_Backends[] | Computed<AlphaRegionBackendService_Backends[]>;
  /** Message containing Cloud CDN configuration for a backend service. */
  cdnPolicy?: AlphaRegionBackendService_CdnPolicy | Computed<AlphaRegionBackendService_CdnPolicy>;
  /** Settings controlling the volume of requests, connections and retries to this backend service. */
  circuitBreakers?: AlphaRegionBackendService_CircuitBreakers | Computed<AlphaRegionBackendService_CircuitBreakers>;
  /** Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header. */
  compressionMode?: string | Computed<string>;
  /** Message containing connection draining configuration. */
  connectionDraining?: AlphaRegionBackendService_ConnectionDraining | Computed<AlphaRegionBackendService_ConnectionDraining>;
  /** Connection Tracking configuration for this BackendService. */
  connectionTrackingPolicy?: AlphaRegionBackendService_ConnectionTrackingPolicy | Computed<AlphaRegionBackendService_ConnectionTrackingPolicy>;
  /** This message defines settings for a consistent hash style load balancer. */
  consistentHash?: AlphaRegionBackendService_ConsistentHash | Computed<AlphaRegionBackendService_ConsistentHash>;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp?: string | Computed<string>;
  /** List of custom metrics that are used for theWEIGHTED_ROUND_ROBIN locality_lb_policy. */
  customMetrics?: AlphaRegionBackendService_CustomMetrics[] | Computed<AlphaRegionBackendService_CustomMetrics[]>;
  ...
  dynamicForwarding?: AlphaRegionBackendService_DynamicForwarding | Computed<AlphaRegionBackendService_DynamicForwarding>;
  ...
  failoverPolicy?: AlphaRegionBackendService_FailoverPolicy | Computed<AlphaRegionBackendService_FailoverPolicy>;
  /** Fingerprint of this resource. A hash of the contents stored in this object. This field is used in optimistic locking. This field will be ignored when inserting a BackendService. An up-to-date fingerprint must be provided in order to update the BackendService, otherwise the request will fail with error 412 conditionNotMet. To see the latest fingerprint, make a get() request to retrieve a BackendService. */
  fingerprint?: string | Computed<string>;
  haPolicy?: AlphaRegionBackendService_HaPolicy | Computed<AlphaRegionBackendService_HaPolicy>;
  ...
  iap?: AlphaRegionBackendService_Iap | Computed<AlphaRegionBackendService_Iap>;
  ...
  localityLbPolicies?: AlphaRegionBackendService_LocalityLbPolicies[] | Computed<AlphaRegionBackendService_LocalityLbPolicies[]>;
  ...
  logConfig?: AlphaRegionBackendService_LogConfig | Computed<AlphaRegionBackendService_LogConfig>;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  maxStreamDuration?: AlphaRegionBackendService_CircuitBreakers_ConnectTimeout | Computed<AlphaRegionBackendService_CircuitBreakers_ConnectTimeout>;
  ...
  networkPassThroughLbTrafficPolicy?: AlphaRegionBackendService_NetworkPassThroughLbTrafficPolicy | Computed<AlphaRegionBackendService_NetworkPassThroughLbTrafficPolicy>;
  /** A message containing information about the resource or system that manages the backend service. */
  orchestrationInfo?: AlphaRegionBackendService_Backends_OrchestrationInfo | Computed<AlphaRegionBackendService_Backends_OrchestrationInfo>;
  /** Settings controlling the eviction of unhealthy hosts from the load balancing pool for the backend service. */
  outlierDetection?: AlphaRegionBackendService_OutlierDetection | Computed<AlphaRegionBackendService_OutlierDetection>;
  /** Additional Backend Service parameters. */
  params?: AlphaRegionBackendService_Params | Computed<AlphaRegionBackendService_Params>;
  ...
  securitySettings?: AlphaRegionBackendService_SecuritySettings | Computed<AlphaRegionBackendService_SecuritySettings>;
  ...
  strongSessionAffinityCookie?: AlphaRegionBackendService_ConsistentHash_HttpCookie | Computed<AlphaRegionBackendService_ConsistentHash_HttpCookie>;
  /** Subsetting configuration for this BackendService. Currently this is applicable only for Internal TCP/UDP load balancing, Internal HTTP(S) load balancing and Traffic Director. */
  subsetting?: AlphaRegionBackendService_Subsetting | Computed<AlphaRegionBackendService_Subsetting>;
  ...
  tlsSettings?: AlphaRegionBackendService_TlsSettings | Computed<AlphaRegionBackendService_TlsSettings>;
  /** Output only. [Output Only] List of resources referencing given backend service. */
  usedBy?: AlphaRegionBackendService_UsedBy[] | Computed<AlphaRegionBackendService_UsedBy[]>;
}

export interface AlphaRegionBackendServiceAttrs {
  /** Lifetime of cookies in seconds. This setting is applicable to Application Load Balancers and Traffic Director and requires GENERATED_COOKIE or HTTP_COOKIE session affinity. If set to 0, the cookie is non-persistent and lasts only until the end of the browser session (or equivalent). The maximum allowed value is two weeks (1,209,600). Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. */
  affinityCookieTtlSec: number;
  /** A boolean flag enabling multi-network mesh. This field is only allowed with load balancing scheme set to INTERNAL_SELF_MANAGED. */
  allowMultinetwork: boolean;
  /** The list of backends that serve this BackendService. */
  backends: AlphaRegionBackendService_Backends[];
  /** Message containing Cloud CDN configuration for a backend service. */
  cdnPolicy: AlphaRegionBackendService_CdnPolicy;
  /** Settings controlling the volume of requests, connections and retries to this backend service. */
  circuitBreakers: AlphaRegionBackendService_CircuitBreakers;
  /** Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header. */
  compressionMode: string;
  /** Message containing connection draining configuration. */
  connectionDraining: AlphaRegionBackendService_ConnectionDraining;
  /** Connection Tracking configuration for this BackendService. */
  connectionTrackingPolicy: AlphaRegionBackendService_ConnectionTrackingPolicy;
  /** This message defines settings for a consistent hash style load balancer. */
  consistentHash: AlphaRegionBackendService_ConsistentHash;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp: string;
  /** List of custom metrics that are used for theWEIGHTED_ROUND_ROBIN locality_lb_policy. */
  customMetrics: AlphaRegionBackendService_CustomMetrics[];
  /** Headers that the load balancer adds to proxied requests. See [Creating custom headers](https://cloud.google.com/load-balancing/docs/custom-headers). */
  ...
  description: string;
  /** Defines a dynamic forwarding configuration for the backend service. */
  dynamicForwarding: AlphaRegionBackendService_DynamicForwarding;
  /** [Output Only] The resource URL for the edge security policy associated with this backend service. */
  ...
  /** For load balancers that have configurable failover: [Internal passthrough Network Load Balancers](https://cloud.google.com/load-balancing/docs/internal/failover-overview) and [external passthrough Network Load Balancers](https://cloud.google.com/load-balancing/docs/network/networklb-failover-overview). On failover or failback, this field indicates whether connection draining will be honored. Google Cloud has a fixed connection draining timeout of 10 minutes. A setting of true terminates existing TCP connections to the active pool during failover and failback, immediately draining traffic. A setting of false allows existing TCP connections to persist, even on VMs no longer in the active pool, for up to the duration of the connection draining timeout (10 minutes). */
  failoverPolicy: AlphaRegionBackendService_FailoverPolicy;
  /** Fingerprint of this resource. A hash of the contents stored in this object. This field is used in optimistic locking. This field will be ignored when inserting a BackendService. An up-to-date fingerprint must be provided in order to update the BackendService, otherwise the request will fail with error 412 conditionNotMet. To see the latest fingerprint, make a get() request to retrieve a BackendService. */
  fingerprint: string;
  haPolicy: AlphaRegionBackendService_HaPolicy;
  /** The list of URLs to the healthChecks, httpHealthChecks (legacy), or httpsHealthChecks (legacy) resource for health checking this backend service. Not all backend services support legacy health checks. See Load balancer guide. Currently, at most one health check can be specified for each backend service. Backend services with instance group or zonal NEG backends must have a health check unless haPolicy is specified. Backend services with internet or serverless NEG backends must not have a health check. healthChecks[] cannot be specified with haPolicy. */
  healthChecks: string[];
  /** Identity-Aware Proxy */
  iap: AlphaRegionBackendService_Iap;
  /** [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  /** Specifies a preference for traffic sent from the proxy to the backend (or from the client to the backend for proxyless gRPC). The possible values are: - IPV4_ONLY: Only send IPv4 traffic to the backends of the backend service (Instance Group, Managed Instance Group, Network Endpoint Group), regardless of traffic from the client to the proxy. Only IPv4 health checks are used to check the health of the backends. This is the default setting. - PREFER_IPV6: Prioritize the connection to the endpoint's IPv6 address over its IPv4 address (provided there is a healthy IPv6 address). - IPV6_ONLY: Only send IPv6 traffic to the backends of the backend service (Instance Group, Managed Instance Group, Network Endpoint Group), regardless of traffic from the client to the proxy. Only IPv6 health checks are used to check the health of the backends. This field is applicable to either: - Advanced global external Application Load Balancer (load balancing scheme EXTERNAL_MANAGED), - Regional external Application Load Balancer, - Internal proxy Network Load Balancer (load balancing scheme INTERNAL_MANAGED), - Regional internal Application Load Balancer (load balancing scheme INTERNAL_MANAGED), - Traffic Director with Envoy proxies and proxyless gRPC (load balancing scheme INTERNAL_SELF_MANAGED). */
  ...
  /** A list of locality load-balancing policies to be used in order of preference. When you use localityLbPolicies, you must set at least one value for either the localityLbPolicies[].policy or the localityLbPolicies[].customPolicy field. localityLbPolicies overrides any value set in the localityLbPolicy field. For an example of how to use this field, seeDefine a list of preferred policies. Caution: This field and its children are intended for use in a service mesh that includes gRPC clients only. Envoy proxies can't use backend services that have this configuration. */
  localityLbPolicies: AlphaRegionBackendService_LocalityLbPolicies[];
  /** The load balancing algorithm used within the scope of the locality. The possible values are: - ROUND_ROBIN: This is a simple policy in which each healthy backend is selected in round robin order. This is the default. - LEAST_REQUEST: An O(1) algorithm which selects two random healthy hosts and picks the host which has fewer active requests. - RING_HASH: The ring/modulo hash load balancer implements consistent hashing to backends. The algorithm has the property that the addition/removal of a host from a set of N hosts only affects 1/N of the requests. - RANDOM: The load balancer selects a random healthy host. - ORIGINAL_DESTINATION: Backend host is selected based on the client connection metadata, i.e., connections are opened to the same address as the destination address of the incoming connection before the connection was redirected to the load balancer. - MAGLEV: used as a drop in replacement for the ring hash load balancer. Maglev is not as stable as ring hash but has faster table lookup build times and host selection times. For more information about Maglev, see Maglev: A Fast and Reliable Software Network Load Balancer. - WEIGHTED_ROUND_ROBIN: Per-endpoint Weighted Round Robin Load Balancing using weights computed from Backend reported Custom Metrics. If set, the Backend Service responses are expected to contain non-standard HTTP response header field Endpoint-Load-Metrics. The reported metrics to use for computing the weights are specified via thecustomMetrics field. - WEIGHTED_MAGLEV: Per-endpoint weighted load balancing via health check reported weights. If set, the backend service must configure an HTTP-based Health Check, and health check replies are expected to contain the non-standard HTTP response header fieldX-Load-Balancing-Endpoint-Weight to specify the per-endpoint weights. If set, load balancing is weighted based on the per-endpoint weights reported in the last processed health check replies, as long as every instance either reported a valid weight or had UNAVAILABLE_WEIGHT. Otherwise, load balancing remains equal-weight. This field is applicable to either: - A regional backend service with the service protocol set to HTTP, HTTPS, HTTP2 or H2C, and load_balancing_scheme set to INTERNAL_MANAGED. - A global backend service with the load_balancing_scheme set to INTERNAL_SELF_MANAGED, INTERNAL_MANAGED, or EXTERNAL_MANAGED. If sessionAffinity is not configured—that is, if session affinity remains at the default value of NONE—then the default value for localityLbPolicy is ROUND_ROBIN. If session affinity is set to a value other than NONE, then the default value for localityLbPolicy isMAGLEV. Only ROUND_ROBIN and RING_HASH are supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. localityLbPolicy cannot be specified with haPolicy. */
  localityLbPolicy: string;
  /** The available logging options for the load balancer traffic served by this backend service. */
  logConfig: AlphaRegionBackendService_LogConfig;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  maxStreamDuration: AlphaRegionBackendService_CircuitBreakers_ConnectTimeout;
  /** Deployment metadata associated with the resource to be set by a GKE hub controller and read by the backend RCTH */
  ...
  /** The URL of the network to which this backend service belongs. This field must be set for Internal Passthrough Network Load Balancers when the haPolicy is enabled, and for External Passthrough Network Load Balancers when the haPolicy fastIpMove is enabled. This field can only be specified when the load balancing scheme is set toINTERNAL, or when the load balancing scheme is set toEXTERNAL and haPolicy fastIpMove is enabled. */
  network: string;
  networkPassThroughLbTrafficPolicy: AlphaRegionBackendService_NetworkPassThroughLbTrafficPolicy;
  /** A message containing information about the resource or system that manages the backend service. */
  orchestrationInfo: AlphaRegionBackendService_Backends_OrchestrationInfo;
  /** Settings controlling the eviction of unhealthy hosts from the load balancing pool for the backend service. */
  outlierDetection: AlphaRegionBackendService_OutlierDetection;
  /** Additional Backend Service parameters. */
  params: AlphaRegionBackendService_Params;
  /** Deprecated in favor of portName. The TCP port to connect on the backend. The default value is 80. For internal passthrough Network Load Balancers and external passthrough Network Load Balancers, omit port. */
  port: number;
  /** A named port on a backend instance group representing the port for communication to the backend VMs in that group. The named port must be [defined on each backend instance group](https://cloud.google.com/load-balancing/docs/backend-service#named_ports). This parameter has no meaning if the backends are NEGs. For internal passthrough Network Load Balancers and external passthrough Network Load Balancers, omit port_name. */
  portName: string;
  ...
  /** The authentication and authorization settings for a BackendService. */
  securitySettings: AlphaRegionBackendService_SecuritySettings;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource with the resource id. */
  ...
  /** The HTTP cookie used for stateful session affinity. */
  strongSessionAffinityCookie: AlphaRegionBackendService_ConsistentHash_HttpCookie;
  /** Subsetting configuration for this BackendService. Currently this is applicable only for Internal TCP/UDP load balancing, Internal HTTP(S) load balancing and Traffic Director. */
  subsetting: AlphaRegionBackendService_Subsetting;
  /** The backend service timeout has a different meaning depending on the type of load balancer. For more information see, Backend service settings. The default is 30 seconds. The full range of timeout values allowed goes from 1 through 2,147,483,647 seconds. This value can be overridden in the PathMatcher configuration of the UrlMap that references this backend service. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. Instead, use maxStreamDuration. */
  timeoutSec: number;
  tlsSettings: AlphaRegionBackendService_TlsSettings;
  /** Output only. [Output Only] List of resources referencing given backend service. */
  usedBy: AlphaRegionBackendService_UsedBy[];
}

export const AlphaRegionBackendService: ResourceBinding<AlphaRegionBackendServiceConfig, AlphaRegionBackendServiceAttrs> = {
