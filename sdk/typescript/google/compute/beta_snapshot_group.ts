...
export interface BetaSnapshotGroupAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaSnapshotGroup: ResourceBinding<BetaSnapshotGroupConfig, BetaSnapshotGroupAttrs> = {
