...
export interface AlphaRegionHealthCheckServiceConfig {
...
export interface AlphaRegionHealthCheckServiceAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const AlphaRegionHealthCheckService: ResourceBinding<AlphaRegionHealthCheckServiceConfig, AlphaRegionHealthCheckServiceAttrs> = {
