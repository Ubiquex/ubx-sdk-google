...
export interface AlphaRegionNotificationEndpoint_GrpcSettings_ResendInterval {
...
export interface AlphaRegionNotificationEndpoint_GrpcSettings {
  ...
  resendInterval?: AlphaRegionNotificationEndpoint_GrpcSettings_ResendInterval | Computed<AlphaRegionNotificationEndpoint_GrpcSettings_ResendInterval>;
  /** How much time (in seconds) is spent attempting notification retries until a successful response is received. Default is 30s. Limit is 20m (1200s). Must be a positive number. */
  retryDurationSec?: number | Computed<number>;
}

const AlphaRegionNotificationEndpoint_GrpcSettings_ResendIntervalFields: FieldMap = {
  nanos: "nanos",
  seconds: "seconds",
};

const AlphaRegionNotificationEndpoint_GrpcSettingsFields: FieldMap = {
  authority: "authority",
  endpoint: "endpoint",
  ...
  resendInterval: {
    ...
    kind: "object",
    fields: AlphaRegionNotificationEndpoint_GrpcSettings_ResendIntervalFields,
  },
...
export interface AlphaRegionNotificationEndpointAttrs {
  ...
  description: string;
  /** Represents a gRPC setting that describes one gRPC notification endpoint and the retry duration attempting to send notification to this endpoint. */
  grpcSettings: AlphaRegionNotificationEndpoint_GrpcSettings;
  /** Output only. [Output Only] A unique identifier for this resource type. The server generates this identifier. */
  id: string;
  /** Output only. [Output Only] Type of the resource. Alwayscompute#notificationEndpoint for notification endpoints. */
  kind: string;
