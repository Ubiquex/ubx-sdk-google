...
export interface Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp {
  high?: string | Computed<string>;
  low?: string | Computed<string>;
}

export interface Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization {
  totalAllocatedIp?: Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp | Computed<Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp>;
  totalFreeIp?: Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp | Computed<Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp>;
}
...
export interface Subnetwork_UtilizationDetails {
  /** The IPV6 utilization of a single IP range. */
  externalIpv6InstanceUtilization?: Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization | Computed<Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization>;
  /** The IPV6 utilization of a single IP range. */
  externalIpv6LbUtilization?: Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization | Computed<Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization>;
  /** The IPV6 utilization of a single IP range. */
  internalIpv6Utilization?: Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization | Computed<Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization>;
  /** Utilizations of all IPV4 IP ranges. For primary ranges, the range name will be empty. */
  ipv4Utilizations?: Subnetwork_UtilizationDetails_Ipv4Utilizations[] | Computed<Subnetwork_UtilizationDetails_Ipv4Utilizations[]>;
}
...
const Subnetwork_SecondaryIpRangesFields: FieldMap = {
...
const Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIpFields: FieldMap = {
  high: "high",
  low: "low",
};

const Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilizationFields: FieldMap = {
  totalAllocatedIp: {
    wireName: "total_allocated_ip",
    kind: "object",
    fields: Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIpFields,
  },
  totalFreeIp: {
...
const Subnetwork_UtilizationDetails_Ipv4UtilizationsFields: FieldMap = {
  rangeName: "range_name",
  totalAllocatedIp: "total_allocated_ip",
  totalFreeIp: "total_free_ip",
};

const Subnetwork_UtilizationDetailsFields: FieldMap = {
  externalIpv6InstanceUtilization: {
    wireName: "external_ipv6_instance_utilization",
    kind: "object",
    fields: Subnetwork_UtilizationDetails_ExternalIpv6InstanceUtilizationFields,
  },
  ...
  ipv4Utilizations: {
    ...
    kind: "list",
    fields: Subnetwork_UtilizationDetails_Ipv4UtilizationsFields,
  },
};
...
export interface SubnetworkConfig {
  ...
  secondaryIpRanges?: Subnetwork_SecondaryIpRanges[] | Computed<Subnetwork_SecondaryIpRanges[]>;
...
export interface SubnetworkAttrs {
  ...
  role: string;
  /** An array of configurations for secondary IP ranges for VM instances contained in this subnetwork. The primary IP of such VM must belong to the primary ipCidrRange of the subnetwork. The alias IPs may belong to either primary or secondary ranges. This field can be updated with apatch request. Supports both IPv4 and IPv6 ranges. */
  secondaryIpRanges: Subnetwork_SecondaryIpRanges[];
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** The stack type for the subnet. If set to IPV4_ONLY, new VMs in the subnet are assigned IPv4 addresses only. If set toIPV4_IPV6, new VMs in the subnet can be assigned both IPv4 and IPv6 addresses. If not specified, IPV4_ONLY is used. This field can be both set at resource creation time and updated usingpatch. */
  stackType: string;
  ...
  /** The current IP utilization of all subnetwork ranges. Contains the total number of allocated and free IPs in each range. */
  utilizationDetails: Subnetwork_UtilizationDetails;
}
...
export const Subnetwork: ResourceBinding<SubnetworkConfig, SubnetworkAttrs> = {
  ...
  fields: {
    ...
    secondaryIpRanges: {
      ...
      kind: "list",
      fields: Subnetwork_SecondaryIpRangesFields,
    },
    selfLink: "self_link",
    ...
    utilizationDetails: {
      ...
      kind: "object",
      fields: Subnetwork_UtilizationDetailsFields,
    },
  },
};
