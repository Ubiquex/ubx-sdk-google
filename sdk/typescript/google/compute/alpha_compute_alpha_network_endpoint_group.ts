// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_network_endpoint_group. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaNetworkEndpointGroup_AppEngine {
...
export interface AlphaComputeAlphaNetworkEndpointGroup_CloudFunction {
...
export interface AlphaComputeAlphaNetworkEndpointGroup_CloudRun {
...
export interface AlphaComputeAlphaNetworkEndpointGroup_LoadBalancer {
...
export interface AlphaComputeAlphaNetworkEndpointGroup_PscData {
...
export interface AlphaComputeAlphaNetworkEndpointGroup_ServerlessDeployment {
...
const AlphaComputeAlphaNetworkEndpointGroup_AppEngineFields: FieldMap = {
  service: "service",
  urlMask: "url_mask",
  version: "version",
};

const AlphaComputeAlphaNetworkEndpointGroup_CloudFunctionFields: FieldMap = {
  function: "function",
  urlMask: "url_mask",
};

const AlphaComputeAlphaNetworkEndpointGroup_CloudRunFields: FieldMap = {
  service: "service",
  tag: "tag",
  urlMask: "url_mask",
};

const AlphaComputeAlphaNetworkEndpointGroup_LoadBalancerFields: FieldMap = {
...
const AlphaComputeAlphaNetworkEndpointGroup_PscDataFields: FieldMap = {
...
const AlphaComputeAlphaNetworkEndpointGroup_ServerlessDeploymentFields: FieldMap = {
  platform: "platform",
  resource: "resource",
  urlMask: "url_mask",
  version: "version",
...
export interface AlphaComputeAlphaNetworkEndpointGroupConfig {
  ...
  appEngine?: AlphaComputeAlphaNetworkEndpointGroup_AppEngine | Computed<AlphaComputeAlphaNetworkEndpointGroup_AppEngine>;
  /** Configuration for a Cloud Function network endpoint group (NEG). The function must be provided explicitly or in the URL mask. Note: Cloud Function must be in the same project and located in the same region as the Serverless NEG. */
  cloudFunction?: AlphaComputeAlphaNetworkEndpointGroup_CloudFunction | Computed<AlphaComputeAlphaNetworkEndpointGroup_CloudFunction>;
  /** Configuration for a Cloud Run network endpoint group (NEG). The service must be provided explicitly or in the URL mask. The tag is optional, may be provided explicitly or in the URL mask. Note: Cloud Run service must be in the same project and located in the same region as the Serverless NEG. */
  cloudRun?: AlphaComputeAlphaNetworkEndpointGroup_CloudRun | Computed<AlphaComputeAlphaNetworkEndpointGroup_CloudRun>;
  ...
  loadBalancer?: AlphaComputeAlphaNetworkEndpointGroup_LoadBalancer | Computed<AlphaComputeAlphaNetworkEndpointGroup_LoadBalancer>;
  ...
  pscData?: AlphaComputeAlphaNetworkEndpointGroup_PscData | Computed<AlphaComputeAlphaNetworkEndpointGroup_PscData>;
  ...
  serverlessDeployment?: AlphaComputeAlphaNetworkEndpointGroup_ServerlessDeployment | Computed<AlphaComputeAlphaNetworkEndpointGroup_ServerlessDeployment>;
...
export interface AlphaComputeAlphaNetworkEndpointGroupAttrs {
  /** Optional. Metadata defined as annotations on the network endpoint group. */
  annotations: Record<string, string>;
  /** Configuration for an App Engine network endpoint group (NEG). The service is optional, may be provided explicitly or in the URL mask. The version is optional and can only be provided explicitly or in the URL mask when service is present. Note: App Engine service must be in the same project and located in the same region as the Serverless NEG. */
  appEngine: AlphaComputeAlphaNetworkEndpointGroup_AppEngine;
  /** Configuration for a Cloud Function network endpoint group (NEG). The function must be provided explicitly or in the URL mask. Note: Cloud Function must be in the same project and located in the same region as the Serverless NEG. */
  cloudFunction: AlphaComputeAlphaNetworkEndpointGroup_CloudFunction;
  /** Configuration for a Cloud Run network endpoint group (NEG). The service must be provided explicitly or in the URL mask. The tag is optional, may be provided explicitly or in the URL mask. Note: Cloud Run service must be in the same project and located in the same region as the Serverless NEG. */
  cloudRun: AlphaComputeAlphaNetworkEndpointGroup_CloudRun;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  kind: string;
  /** Load balancing specific fields for network endpoint group. */
  loadBalancer: AlphaComputeAlphaNetworkEndpointGroup_LoadBalancer;
  /** Name of the resource; provided by the client when the resource is created. The name must be 1-63 characters long, and comply withRFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash. */
  name: string;
  /** The URL of the network to which all network endpoints in the NEG belong. For networkEndpointType GCE_VM_IP_PORT,GCE_VM_IP_PORTMAP or NON_GCP_PRIVATE_IP_PORT, if this field is not specified, a default network will be used. This field cannot be set for NEGs with networkEndpointType set toSERVERLESS or PRIVATE_SERVICE_CONNECT and for global NEGs. For all other network endpoint types, this field is required. */
  network: string;
  ...
  /** All data that is specifically relevant to only network endpoint groups of type PRIVATE_SERVICE_CONNECT. */
  pscData: AlphaComputeAlphaNetworkEndpointGroup_PscData;
  /** The target service url used to set up private service connection to a Google API or a PSC Producer Service Attachment. An example value is: asia-northeast3-cloudkms.googleapis.com. Optional. Only valid when networkEndpointType isPRIVATE_SERVICE_CONNECT. */
  ...
  /** Configuration for a serverless network endpoint group (NEG). Theplatform must be provided. Note: The target backend service must be in the same project and located in the same region as the Serverless NEG. */
  serverlessDeployment: AlphaComputeAlphaNetworkEndpointGroup_ServerlessDeployment;
  /** Output only. [Output only] Number of network endpoints in the network endpoint group. */
  size: number;
  /** Optional URL of the subnetwork to which all network endpoints in the NEG belong. */
  subnetwork: string;
...
export const AlphaComputeAlphaNetworkEndpointGroup: ResourceBinding<AlphaComputeAlphaNetworkEndpointGroupConfig, AlphaComputeAlphaNetworkEndpointGroupAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_network_endpoint_group",
  fields: {
    annotations: "annotations",
    appEngine: {
      wireName: "app_engine",
      kind: "object",
      fields: AlphaComputeAlphaNetworkEndpointGroup_AppEngineFields,
    },
    cloudFunction: {
      wireName: "cloud_function",
      kind: "object",
      fields: AlphaComputeAlphaNetworkEndpointGroup_CloudFunctionFields,
    },
    cloudRun: {
      wireName: "cloud_run",
      kind: "object",
      fields: AlphaComputeAlphaNetworkEndpointGroup_CloudRunFields,
    },
    ...
    loadBalancer: {
      ...
      kind: "object",
      fields: AlphaComputeAlphaNetworkEndpointGroup_LoadBalancerFields,
    },
    name: "name",
    network: "network",
    ...
    pscData: {
      wireName: "psc_data",
      kind: "object",
      fields: AlphaComputeAlphaNetworkEndpointGroup_PscDataFields,
    },
    ...
    serverlessDeployment: {
      ...
      kind: "object",
      fields: AlphaComputeAlphaNetworkEndpointGroup_ServerlessDeploymentFields,
    },
    size: "size",
    subnetwork: "subnetwork",
    type: "type",
