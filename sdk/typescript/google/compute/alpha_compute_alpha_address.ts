...
export interface AlphaComputeAlphaAddressConfig {
...
export interface AlphaComputeAlphaAddressAttrs {
  /** The static IP address represented by this resource. */
  address: string;
  /** The type of address to reserve, either INTERNAL orEXTERNAL. If unspecified, defaults to EXTERNAL. */
  addressType: string;
...
export const AlphaComputeAlphaAddress: ResourceBinding<AlphaComputeAlphaAddressConfig, AlphaComputeAlphaAddressAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_address",
  fields: {
    address: "address",
