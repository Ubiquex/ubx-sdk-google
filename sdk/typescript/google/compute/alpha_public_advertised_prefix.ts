// Code generated by `ubx sdk gen` from google_compute_alpha_public_advertised_prefix. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaPublicAdvertisedPrefix_PublicDelegatedPrefixs {
...
const AlphaPublicAdvertisedPrefix_PublicDelegatedPrefixsFields: FieldMap = {
  ipRange: "ip_range",
  name: "name",
  project: "project",
  region: "region",
...
export interface AlphaPublicAdvertisedPrefixConfig {
  ...
  publicDelegatedPrefixs?: AlphaPublicAdvertisedPrefix_PublicDelegatedPrefixs[] | Computed<AlphaPublicAdvertisedPrefix_PublicDelegatedPrefixs[]>;
...
export interface AlphaPublicAdvertisedPrefixAttrs {
  /** Output only. [Output Only] The version of BYOIP API. */
  ...
  pdpScope: string;
  /** Output only. [Output Only] The list of public delegated prefixes that exist for this public advertised prefix. */
  publicDelegatedPrefixs: AlphaPublicAdvertisedPrefix_PublicDelegatedPrefixs[];
  /** Output only. [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL with id for the resource. */
...
export const AlphaPublicAdvertisedPrefix: ResourceBinding<AlphaPublicAdvertisedPrefixConfig, AlphaPublicAdvertisedPrefixAttrs> = {
  wireType: "google_compute_alpha_public_advertised_prefix",
  fields: {
    ...
    publicDelegatedPrefixs: {
      ...
      kind: "list",
      fields: AlphaPublicAdvertisedPrefix_PublicDelegatedPrefixsFields,
    },
    selfLink: "self_link",
