...
export interface GlobalNetworkEndpointGroup_AppEngine {
...
export interface GlobalNetworkEndpointGroup_CloudFunction {
...
export interface GlobalNetworkEndpointGroup_CloudRun {
...
export interface GlobalNetworkEndpointGroup_PscData {
...
const GlobalNetworkEndpointGroup_AppEngineFields: FieldMap = {
  service: "service",
  urlMask: "url_mask",
  version: "version",
};

const GlobalNetworkEndpointGroup_CloudFunctionFields: FieldMap = {
  function: "function",
  urlMask: "url_mask",
};

const GlobalNetworkEndpointGroup_CloudRunFields: FieldMap = {
  service: "service",
  tag: "tag",
  urlMask: "url_mask",
};

const GlobalNetworkEndpointGroup_PscDataFields: FieldMap = {
...
export interface GlobalNetworkEndpointGroupConfig {
  ...
  appEngine?: GlobalNetworkEndpointGroup_AppEngine | Computed<GlobalNetworkEndpointGroup_AppEngine>;
  /** Configuration for a Cloud Function network endpoint group (NEG). The function must be provided explicitly or in the URL mask. Note: Cloud Function must be in the same project and located in the same region as the Serverless NEG. */
  cloudFunction?: GlobalNetworkEndpointGroup_CloudFunction | Computed<GlobalNetworkEndpointGroup_CloudFunction>;
  /** Configuration for a Cloud Run network endpoint group (NEG). The service must be provided explicitly or in the URL mask. The tag is optional, may be provided explicitly or in the URL mask. Note: Cloud Run service must be in the same project and located in the same region as the Serverless NEG. */
  cloudRun?: GlobalNetworkEndpointGroup_CloudRun | Computed<GlobalNetworkEndpointGroup_CloudRun>;
  ...
  pscData?: GlobalNetworkEndpointGroup_PscData | Computed<GlobalNetworkEndpointGroup_PscData>;
...
export interface GlobalNetworkEndpointGroupAttrs {
  ...
  /** Configuration for an App Engine network endpoint group (NEG). The service is optional, may be provided explicitly or in the URL mask. The version is optional and can only be provided explicitly or in the URL mask when service is present. Note: App Engine service must be in the same project and located in the same region as the Serverless NEG. */
  appEngine: GlobalNetworkEndpointGroup_AppEngine;
  /** Configuration for a Cloud Function network endpoint group (NEG). The function must be provided explicitly or in the URL mask. Note: Cloud Function must be in the same project and located in the same region as the Serverless NEG. */
  cloudFunction: GlobalNetworkEndpointGroup_CloudFunction;
  /** Configuration for a Cloud Run network endpoint group (NEG). The service must be provided explicitly or in the URL mask. The tag is optional, may be provided explicitly or in the URL mask. Note: Cloud Run service must be in the same project and located in the same region as the Serverless NEG. */
  cloudRun: GlobalNetworkEndpointGroup_CloudRun;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** All data that is specifically relevant to only network endpoint groups of type PRIVATE_SERVICE_CONNECT. */
  pscData: GlobalNetworkEndpointGroup_PscData;
  /** The target service url used to set up private service connection to a Google API or a PSC Producer Service Attachment. An example value is: asia-northeast3-cloudkms.googleapis.com. Optional. Only valid when networkEndpointType isPRIVATE_SERVICE_CONNECT. */
...
export const GlobalNetworkEndpointGroup: ResourceBinding<GlobalNetworkEndpointGroupConfig, GlobalNetworkEndpointGroupAttrs> = {
  ...
  fields: {
    ...
    appEngine: {
      wireName: "app_engine",
      kind: "object",
      fields: GlobalNetworkEndpointGroup_AppEngineFields,
    },
    cloudFunction: {
      wireName: "cloud_function",
      kind: "object",
      fields: GlobalNetworkEndpointGroup_CloudFunctionFields,
    },
    cloudRun: {
      wireName: "cloud_run",
      kind: "object",
      fields: GlobalNetworkEndpointGroup_CloudRunFields,
    },
    ...
    pscData: {
      wireName: "psc_data",
      kind: "object",
      fields: GlobalNetworkEndpointGroup_PscDataFields,
    },
