// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_region_instant_snapshot. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaRegionInstantSnapshot_Params {
...
export interface BetaComputeBetaRegionInstantSnapshot_ResourceStatus {
  /** [Output Only] The storage size of this instant snapshot. */
  storageSizeBytes?: string | Computed<string>;
}

const BetaComputeBetaRegionInstantSnapshot_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaComputeBetaRegionInstantSnapshot_ResourceStatusFields: FieldMap = {
  storageSizeBytes: "storage_size_bytes",
};

export interface BetaComputeBetaRegionInstantSnapshotConfig {
  ...
  params?: BetaComputeBetaRegionInstantSnapshot_Params | Computed<BetaComputeBetaRegionInstantSnapshot_Params>;
  ...
  resourceStatus?: BetaComputeBetaRegionInstantSnapshot_ResourceStatus | Computed<BetaComputeBetaRegionInstantSnapshot_ResourceStatus>;
...
export interface BetaComputeBetaRegionInstantSnapshotAttrs {
  /** Output only. [Output Only] The architecture of the instant snapshot. Valid values are ARM64 or X86_64. */
  architecture: string;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  name: string;
  /** Additional instant snapshot params. */
  params: BetaComputeBetaRegionInstantSnapshot_Params;
  /** Output only. [Output Only] URL of the region where the instant snapshot resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  resourceStatus: BetaComputeBetaRegionInstantSnapshot_ResourceStatus;
  /** Output only. Reserved for future use. */
...
export const BetaComputeBetaRegionInstantSnapshot: ResourceBinding<BetaComputeBetaRegionInstantSnapshotConfig, BetaComputeBetaRegionInstantSnapshotAttrs> = {
  wireType: "google_compute_beta_compute_beta_region_instant_snapshot",
  fields: {
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaComputeBetaRegionInstantSnapshot_ParamsFields,
    },
    region: "region",
    resourceStatus: {
      wireName: "resource_status",
      kind: "object",
      fields: BetaComputeBetaRegionInstantSnapshot_ResourceStatusFields,
    },
