...
export interface BetaRegionInstantSnapshotGroup_ResourceStatus_SourceInfo {
  consistencyGroup?: string | Computed<string>;
  consistencyGroupId?: string | Computed<string>;
}

export interface BetaRegionInstantSnapshotGroup_ResourceStatus {
  /** Output only. [Output Only] */
  consistencyMembershipResolutionTime?: string | Computed<string>;
  sourceInfo?: BetaRegionInstantSnapshotGroup_ResourceStatus_SourceInfo | Computed<BetaRegionInstantSnapshotGroup_ResourceStatus_SourceInfo>;
}

const BetaRegionInstantSnapshotGroup_ResourceStatus_SourceInfoFields: FieldMap = {
  consistencyGroup: "consistency_group",
  consistencyGroupId: "consistency_group_id",
};

const BetaRegionInstantSnapshotGroup_ResourceStatusFields: FieldMap = {
  consistencyMembershipResolutionTime: "consistency_membership_resolution_time",
  sourceInfo: {
    wireName: "source_info",
    kind: "object",
    fields: BetaRegionInstantSnapshotGroup_ResourceStatus_SourceInfoFields,
  },
};
...
export interface BetaRegionInstantSnapshotGroupAttrs {
  ...
  region: string;
  /** Read-only, Google-populated runtime state for this resource, such as its own current physical host, not something a caller sets. (AI-inferred) */
  resourceStatus: BetaRegionInstantSnapshotGroup_ResourceStatus;
