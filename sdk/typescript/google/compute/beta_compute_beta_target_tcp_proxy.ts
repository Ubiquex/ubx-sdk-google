// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_target_tcp_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaTargetTcpProxyConfig {
...
export interface BetaComputeBetaTargetTcpProxyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaComputeBetaTargetTcpProxy: ResourceBinding<BetaComputeBetaTargetTcpProxyConfig, BetaComputeBetaTargetTcpProxyAttrs> = {
  wireType: "google_compute_beta_compute_beta_target_tcp_proxy",
  fields: {
