...
export interface AlphaAddressConfig {
...
export interface AlphaAddressAttrs {
  /** The static IP address represented by this resource. */
  address: string;
  /** The type of address to reserve, either INTERNAL orEXTERNAL. If unspecified, defaults to EXTERNAL. */
  addressType: string;
...
export const AlphaAddress: ResourceBinding<AlphaAddressConfig, AlphaAddressAttrs> = {
  wireType: "google_compute_alpha_address",
  fields: {
    address: "address",
