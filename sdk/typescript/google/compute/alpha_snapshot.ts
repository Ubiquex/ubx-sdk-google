...
export interface AlphaSnapshot_GuestOsFeatures {
  type?: string | Computed<string>;
}

export interface AlphaSnapshot_Params {
...
export interface AlphaSnapshot_ResourceStatus {
...
export interface AlphaSnapshot_SnapshotEncryptionKey {
...
const AlphaSnapshot_GuestOsFeaturesFields: FieldMap = {
  type: "type",
};

const AlphaSnapshot_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaSnapshot_ResourceStatusFields: FieldMap = {
  scheduledDeletionTime: "scheduled_deletion_time",
};

const AlphaSnapshot_SnapshotEncryptionKeyFields: FieldMap = {
...
export interface AlphaSnapshotConfig {
  ...
  guestOsFeatures?: AlphaSnapshot_GuestOsFeatures[] | Computed<AlphaSnapshot_GuestOsFeatures[]>;
  ...
  params?: AlphaSnapshot_Params | Computed<AlphaSnapshot_Params>;
  /** Output only. [Output Only] URL of the region where the snapshot resides. Only applicable for regional snapshots. */
  region?: string | Computed<string>;
  resourceStatus?: AlphaSnapshot_ResourceStatus | Computed<AlphaSnapshot_ResourceStatus>;
  ...
  snapshotEncryptionKey?: AlphaSnapshot_SnapshotEncryptionKey | Computed<AlphaSnapshot_SnapshotEncryptionKey>;
  ...
  sourceDiskEncryptionKey?: AlphaSnapshot_SnapshotEncryptionKey | Computed<AlphaSnapshot_SnapshotEncryptionKey>;
  ...
  sourceInstantSnapshotEncryptionKey?: AlphaSnapshot_SnapshotEncryptionKey | Computed<AlphaSnapshot_SnapshotEncryptionKey>;
...
export interface AlphaSnapshotAttrs {
  /** Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64. */
  architecture: string;
  /** Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk. */
  autoCreated: boolean;
  ...
  guestFlush: boolean;
  /** Output only. [Output Only] A list of features to enable on the guest operating system. Applicable only for bootable images. Read Enabling guest operating system features to see a list of available options. */
  guestOsFeatures: AlphaSnapshot_GuestOsFeatures[];
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  /** Output only. [Output Only] Type of the resource. Always compute#snapshot for Snapshot resources. */
  kind: string;
  ...
  name: string;
  /** Additional snapshot params. */
  params: AlphaSnapshot_Params;
  /** Output only. [Output Only] URL of the region where the snapshot resides. Only applicable for regional snapshots. */
  region: string;
  resourceStatus: AlphaSnapshot_ResourceStatus;
  /** Output only. Reserved for future use. */
  ...
  snapshotEncryptionKey: AlphaSnapshot_SnapshotEncryptionKey;
  /** Output only. [Output Only] The unique ID of the snapshot group that this snapshot belongs to. The usage of snapshot group feature is restricted. */
  ...
  /** The source disk used to create this snapshot. */
  sourceDisk: string;
  sourceDiskEncryptionKey: AlphaSnapshot_SnapshotEncryptionKey;
  /** The source disk whose recovery checkpoint will be used to create this snapshot. */
  ...
  sourceInstantSnapshotEncryptionKey: AlphaSnapshot_SnapshotEncryptionKey;
  /** Output only. [Output Only] The unique ID of the instant snapshot used to create this snapshot. This value identifies the exact instant snapshot that was used to create this snapshot. For example, if you created the snapshot from an instant snapshot that was later deleted and recreated under the same name, the source instant snapshot ID would identify the exact instant snapshot that was used. */
...
export const AlphaSnapshot: ResourceBinding<AlphaSnapshotConfig, AlphaSnapshotAttrs> = {
  ...
  fields: {
    ...
    guestOsFeatures: {
      ...
      kind: "list",
      fields: AlphaSnapshot_GuestOsFeaturesFields,
    },
    id: "id",
    kind: "kind",
