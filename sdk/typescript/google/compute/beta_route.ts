...
const BetaRoute_AsPathsFields: FieldMap = {
  asLists: "as_lists",
...
const BetaRoute_Warnings_DataFields: FieldMap = {
  key: "key",
  value: "value",
};

const BetaRoute_WarningsFields: FieldMap = {
  code: "code",
  data: {
    wireName: "data",
    kind: "list",
    fields: BetaRoute_Warnings_DataFields,
  },
  message: "message",
};
...
export interface BetaRouteConfig {
  ...
  asPaths?: BetaRoute_AsPaths[] | Computed<BetaRoute_AsPaths[]>;
  ...
  warnings?: BetaRoute_Warnings[] | Computed<BetaRoute_Warnings[]>;
}
...
export const BetaRoute: ResourceBinding<BetaRouteConfig, BetaRouteAttrs> = {
  ...
  fields: {
    asPaths: {
      wireName: "as_paths",
      kind: "list",
      fields: BetaRoute_AsPathsFields,
    },
    ...
    warnings: {
      wireName: "warnings",
      kind: "list",
      fields: BetaRoute_WarningsFields,
    },
  },
};
