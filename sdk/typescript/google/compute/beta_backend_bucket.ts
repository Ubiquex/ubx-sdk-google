...
export interface BetaBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders {
  headerName?: string | Computed<string>;
}

export interface BetaBackendBucket_CdnPolicy_CacheKeyPolicy {
...
export interface BetaBackendBucket_CdnPolicy_NegativeCachingPolicy {
  code?: number | Computed<number>;
  ttl?: number | Computed<number>;
}

export interface BetaBackendBucket_CdnPolicy {
  /** Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings. */
  bypassCacheOnRequestHeaders?: BetaBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<BetaBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders[]>;
  /** Message containing what to include in the cache key for a request for Cloud CDN. */
  cacheKeyPolicy?: BetaBackendBucket_CdnPolicy_CacheKeyPolicy | Computed<BetaBackendBucket_CdnPolicy_CacheKeyPolicy>;
  ...
  negativeCachingPolicy?: BetaBackendBucket_CdnPolicy_NegativeCachingPolicy[] | Computed<BetaBackendBucket_CdnPolicy_NegativeCachingPolicy[]>;
...
export interface BetaBackendBucket_Params {
...
export interface BetaBackendBucket_UsedBy {
  reference?: string | Computed<string>;
}

const BetaBackendBucket_CdnPolicy_BypassCacheOnRequestHeadersFields: FieldMap = {
  headerName: "header_name",
};

const BetaBackendBucket_CdnPolicy_CacheKeyPolicyFields: FieldMap = {
  includeHttpHeaders: "include_http_headers",
  queryStringWhitelist: "query_string_whitelist",
};

const BetaBackendBucket_CdnPolicy_NegativeCachingPolicyFields: FieldMap = {
  code: "code",
  ttl: "ttl",
};

const BetaBackendBucket_CdnPolicyFields: FieldMap = {
...
const BetaBackendBucket_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaBackendBucket_UsedByFields: FieldMap = {
  reference: "reference",
};

export interface BetaBackendBucketConfig {
  /** Cloud Storage bucket name. */
  bucketName?: string | Computed<string>;
  /** Message containing Cloud CDN configuration for a backend bucket. */
  cdnPolicy?: BetaBackendBucket_CdnPolicy | Computed<BetaBackendBucket_CdnPolicy>;
  ...
  params?: BetaBackendBucket_Params | Computed<BetaBackendBucket_Params>;
  ...
  usedBy?: BetaBackendBucket_UsedBy[] | Computed<BetaBackendBucket_UsedBy[]>;
}

export interface BetaBackendBucketAttrs {
  /** Cloud Storage bucket name. */
  bucketName: string;
  /** Message containing Cloud CDN configuration for a backend bucket. */
  cdnPolicy: BetaBackendBucket_CdnPolicy;
  /** Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header. */
  ...
  name: string;
  /** Additional Backend Bucket parameters. */
  params: BetaBackendBucket_Params;
  /** Output only. [Output Only] URL of the region where the regional backend bucket resides. This field is not applicable to global backend buckets. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] List of resources referencing that backend bucket. */
  usedBy: BetaBackendBucket_UsedBy[];
}

export const BetaBackendBucket: ResourceBinding<BetaBackendBucketConfig, BetaBackendBucketAttrs> = {
  wireType: "google_compute_beta_backend_bucket",
  fields: {
    ...
    usedBy: {
      wireName: "used_by",
      kind: "list",
      fields: BetaBackendBucket_UsedByFields,
    },
  },
};
