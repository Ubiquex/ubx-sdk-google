// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_network. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaNetwork_Params {
...
export interface BetaComputeBetaNetwork_Peerings_ConnectionStatus_ConsensusState {
  deleteStatus?: string | Computed<string>;
  updateStatus?: string | Computed<string>;
}

export interface BetaComputeBetaNetwork_Peerings_ConnectionStatus_TrafficConfiguration {
...
export interface BetaComputeBetaNetwork_Peerings_ConnectionStatus {
  consensusState?: BetaComputeBetaNetwork_Peerings_ConnectionStatus_ConsensusState | Computed<BetaComputeBetaNetwork_Peerings_ConnectionStatus_ConsensusState>;
  trafficConfiguration?: BetaComputeBetaNetwork_Peerings_ConnectionStatus_TrafficConfiguration | Computed<BetaComputeBetaNetwork_Peerings_ConnectionStatus_TrafficConfiguration>;
  updateStrategy?: string | Computed<string>;
}

export interface BetaComputeBetaNetwork_Peerings {
  autoCreateRoutes?: boolean | Computed<boolean>;
  connectionStatus?: BetaComputeBetaNetwork_Peerings_ConnectionStatus | Computed<BetaComputeBetaNetwork_Peerings_ConnectionStatus>;
...
export interface BetaComputeBetaNetwork_RoutingConfig {
...
const BetaComputeBetaNetwork_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaComputeBetaNetwork_Peerings_ConnectionStatus_ConsensusStateFields: FieldMap = {
  deleteStatus: "delete_status",
  updateStatus: "update_status",
};

const BetaComputeBetaNetwork_Peerings_ConnectionStatus_TrafficConfigurationFields: FieldMap = {
...
const BetaComputeBetaNetwork_Peerings_ConnectionStatusFields: FieldMap = {
  consensusState: {
    wireName: "consensus_state",
    kind: "object",
    fields: BetaComputeBetaNetwork_Peerings_ConnectionStatus_ConsensusStateFields,
  },
  trafficConfiguration: {
    wireName: "traffic_configuration",
    kind: "object",
    fields: BetaComputeBetaNetwork_Peerings_ConnectionStatus_TrafficConfigurationFields,
  },
  updateStrategy: "update_strategy",
};

const BetaComputeBetaNetwork_PeeringsFields: FieldMap = {
  autoCreateRoutes: "auto_create_routes",
  connectionStatus: {
    wireName: "connection_status",
    kind: "object",
    fields: BetaComputeBetaNetwork_Peerings_ConnectionStatusFields,
  },
...
const BetaComputeBetaNetwork_RoutingConfigFields: FieldMap = {
...
export interface BetaComputeBetaNetworkConfig {
  ...
  params?: BetaComputeBetaNetwork_Params | Computed<BetaComputeBetaNetwork_Params>;
  /** Output only. [Output Only] A list of network peerings for the resource. */
  peerings?: BetaComputeBetaNetwork_Peerings[] | Computed<BetaComputeBetaNetwork_Peerings[]>;
  /** A routing configuration attached to a network resource. The message includes the list of routers associated with the network, and a flag indicating the type of routing behavior to enforce network-wide. */
  routingConfig?: BetaComputeBetaNetwork_RoutingConfig | Computed<BetaComputeBetaNetwork_RoutingConfig>;
...
export interface BetaComputeBetaNetworkAttrs {
  /** Must be set to create a VPC network. If not set, a legacy network is created. When set to true, the VPC network is created in auto mode. When set to false, the VPC network is created in custom mode. An auto mode VPC network starts with one subnet per region. Each subnet has a predetermined range as described inAuto mode VPC network IP ranges. For custom mode VPC networks, you can add subnets using the subnetworksinsert method. */
  ...
  /** Additional network parameters. */
  params: BetaComputeBetaNetwork_Params;
  /** Output only. [Output Only] A list of network peerings for the resource. */
  peerings: BetaComputeBetaNetwork_Peerings[];
  /** A routing configuration attached to a network resource. The message includes the list of routers associated with the network, and a flag indicating the type of routing behavior to enforce network-wide. */
  routingConfig: BetaComputeBetaNetwork_RoutingConfig;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource with the resource id. */
...
export const BetaComputeBetaNetwork: ResourceBinding<BetaComputeBetaNetworkConfig, BetaComputeBetaNetworkAttrs> = {
  wireType: "google_compute_beta_compute_beta_network",
  fields: {
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaComputeBetaNetwork_ParamsFields,
    },
    peerings: {
      wireName: "peerings",
      kind: "list",
      fields: BetaComputeBetaNetwork_PeeringsFields,
    },
    routingConfig: {
      wireName: "routing_config",
      kind: "object",
      fields: BetaComputeBetaNetwork_RoutingConfigFields,
    },
    selfLink: "self_link",
