...
export interface BetaTargetVpnGateway_Params {
...
const BetaTargetVpnGateway_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

export interface BetaTargetVpnGatewayConfig {
  ...
  params?: BetaTargetVpnGateway_Params | Computed<BetaTargetVpnGateway_Params>;
...
export interface BetaTargetVpnGatewayAttrs {
  ...
  /** URL of the network to which this VPN gateway is attached. Provided by the client when the VPN gateway is created. */
  network: string;
  params: BetaTargetVpnGateway_Params;
  /** [Output Only] URL of the region where the target VPN gateway resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
...
export const BetaTargetVpnGateway: ResourceBinding<BetaTargetVpnGatewayConfig, BetaTargetVpnGatewayAttrs> = {
