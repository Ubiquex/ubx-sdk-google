...
export interface BetaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders {
  headerName?: string | Computed<string>;
}

export interface BetaRegionBackendBucket_CdnPolicy_CacheKeyPolicy {
...
export interface BetaRegionBackendBucket_CdnPolicy_NegativeCachingPolicy {
  code?: number | Computed<number>;
  ttl?: number | Computed<number>;
}

export interface BetaRegionBackendBucket_CdnPolicy {
  /** Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings. */
  bypassCacheOnRequestHeaders?: BetaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<BetaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeaders[]>;
  /** Message containing what to include in the cache key for a request for Cloud CDN. */
  cacheKeyPolicy?: BetaRegionBackendBucket_CdnPolicy_CacheKeyPolicy | Computed<BetaRegionBackendBucket_CdnPolicy_CacheKeyPolicy>;
  ...
  negativeCachingPolicy?: BetaRegionBackendBucket_CdnPolicy_NegativeCachingPolicy[] | Computed<BetaRegionBackendBucket_CdnPolicy_NegativeCachingPolicy[]>;
...
export interface BetaRegionBackendBucket_Params {
...
export interface BetaRegionBackendBucket_UsedBy {
  reference?: string | Computed<string>;
}

const BetaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeadersFields: FieldMap = {
  headerName: "header_name",
};

const BetaRegionBackendBucket_CdnPolicy_CacheKeyPolicyFields: FieldMap = {
  includeHttpHeaders: "include_http_headers",
  queryStringWhitelist: "query_string_whitelist",
};

const BetaRegionBackendBucket_CdnPolicy_NegativeCachingPolicyFields: FieldMap = {
  code: "code",
  ttl: "ttl",
};

const BetaRegionBackendBucket_CdnPolicyFields: FieldMap = {
  bypassCacheOnRequestHeaders: {
    wireName: "bypass_cache_on_request_headers",
    kind: "list",
    fields: BetaRegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeadersFields,
  },
  cacheKeyPolicy: {
    wireName: "cache_key_policy",
    kind: "object",
    fields: BetaRegionBackendBucket_CdnPolicy_CacheKeyPolicyFields,
  },
  ...
  negativeCachingPolicy: {
    ...
    kind: "list",
    fields: BetaRegionBackendBucket_CdnPolicy_NegativeCachingPolicyFields,
  },
...
const BetaRegionBackendBucket_ParamsFields: FieldMap = {
...
export interface BetaRegionBackendBucketConfig {
  ...
  cdnPolicy?: BetaRegionBackendBucket_CdnPolicy | Computed<BetaRegionBackendBucket_CdnPolicy>;
...
export interface BetaRegionBackendBucketAttrs {
  ...
  bucketName: string;
  /** Message containing Cloud CDN configuration for a backend bucket. */
  cdnPolicy: BetaRegionBackendBucket_CdnPolicy;
  /** Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header. */
  ...
  name: string;
  /** Additional Backend Bucket parameters. */
  params: BetaRegionBackendBucket_Params;
  ...
  usedBy: BetaRegionBackendBucket_UsedBy[];
}

export const BetaRegionBackendBucket: ResourceBinding<BetaRegionBackendBucketConfig, BetaRegionBackendBucketAttrs> = {
  wireType: "google_compute_beta_region_backend_bucket",
  fields: {
    bucketName: "bucket_name",
    cdnPolicy: {
      wireName: "cdn_policy",
      kind: "object",
      fields: BetaRegionBackendBucket_CdnPolicyFields,
    },
