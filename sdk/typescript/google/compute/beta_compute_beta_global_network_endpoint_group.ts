// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_global_network_endpoint_group. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaGlobalNetworkEndpointGroup_AppEngine {
...
export interface BetaComputeBetaGlobalNetworkEndpointGroup_CloudFunction {
...
export interface BetaComputeBetaGlobalNetworkEndpointGroup_CloudRun {
...
export interface BetaComputeBetaGlobalNetworkEndpointGroup_LoadBalancer {
...
export interface BetaComputeBetaGlobalNetworkEndpointGroup_PscData {
...
export interface BetaComputeBetaGlobalNetworkEndpointGroup_ServerlessDeployment {
...
const BetaComputeBetaGlobalNetworkEndpointGroup_AppEngineFields: FieldMap = {
  service: "service",
  urlMask: "url_mask",
  version: "version",
};

const BetaComputeBetaGlobalNetworkEndpointGroup_CloudFunctionFields: FieldMap = {
  function: "function",
  urlMask: "url_mask",
};

const BetaComputeBetaGlobalNetworkEndpointGroup_CloudRunFields: FieldMap = {
  service: "service",
  tag: "tag",
  urlMask: "url_mask",
};

const BetaComputeBetaGlobalNetworkEndpointGroup_LoadBalancerFields: FieldMap = {
...
const BetaComputeBetaGlobalNetworkEndpointGroup_PscDataFields: FieldMap = {
...
const BetaComputeBetaGlobalNetworkEndpointGroup_ServerlessDeploymentFields: FieldMap = {
  platform: "platform",
  resource: "resource",
  urlMask: "url_mask",
  version: "version",
...
export interface BetaComputeBetaGlobalNetworkEndpointGroupConfig {
  ...
  appEngine?: BetaComputeBetaGlobalNetworkEndpointGroup_AppEngine | Computed<BetaComputeBetaGlobalNetworkEndpointGroup_AppEngine>;
  /** Configuration for a Cloud Function network endpoint group (NEG). The function must be provided explicitly or in the URL mask. Note: Cloud Function must be in the same project and located in the same region as the Serverless NEG. */
  cloudFunction?: BetaComputeBetaGlobalNetworkEndpointGroup_CloudFunction | Computed<BetaComputeBetaGlobalNetworkEndpointGroup_CloudFunction>;
  /** Configuration for a Cloud Run network endpoint group (NEG). The service must be provided explicitly or in the URL mask. The tag is optional, may be provided explicitly or in the URL mask. Note: Cloud Run service must be in the same project and located in the same region as the Serverless NEG. */
  cloudRun?: BetaComputeBetaGlobalNetworkEndpointGroup_CloudRun | Computed<BetaComputeBetaGlobalNetworkEndpointGroup_CloudRun>;
  ...
  loadBalancer?: BetaComputeBetaGlobalNetworkEndpointGroup_LoadBalancer | Computed<BetaComputeBetaGlobalNetworkEndpointGroup_LoadBalancer>;
  ...
  pscData?: BetaComputeBetaGlobalNetworkEndpointGroup_PscData | Computed<BetaComputeBetaGlobalNetworkEndpointGroup_PscData>;
  ...
  serverlessDeployment?: BetaComputeBetaGlobalNetworkEndpointGroup_ServerlessDeployment | Computed<BetaComputeBetaGlobalNetworkEndpointGroup_ServerlessDeployment>;
...
export interface BetaComputeBetaGlobalNetworkEndpointGroupAttrs {
  /** Optional. Metadata defined as annotations on the network endpoint group. */
  annotations: Record<string, string>;
  /** Configuration for an App Engine network endpoint group (NEG). The service is optional, may be provided explicitly or in the URL mask. The version is optional and can only be provided explicitly or in the URL mask when service is present. Note: App Engine service must be in the same project and located in the same region as the Serverless NEG. */
  appEngine: BetaComputeBetaGlobalNetworkEndpointGroup_AppEngine;
  /** Configuration for a Cloud Function network endpoint group (NEG). The function must be provided explicitly or in the URL mask. Note: Cloud Function must be in the same project and located in the same region as the Serverless NEG. */
  cloudFunction: BetaComputeBetaGlobalNetworkEndpointGroup_CloudFunction;
  /** Configuration for a Cloud Run network endpoint group (NEG). The service must be provided explicitly or in the URL mask. The tag is optional, may be provided explicitly or in the URL mask. Note: Cloud Run service must be in the same project and located in the same region as the Serverless NEG. */
  cloudRun: BetaComputeBetaGlobalNetworkEndpointGroup_CloudRun;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  kind: string;
  /** Load balancing specific fields for network endpoint group. */
  loadBalancer: BetaComputeBetaGlobalNetworkEndpointGroup_LoadBalancer;
  /** Name of the resource; provided by the client when the resource is created. The name must be 1-63 characters long, and comply withRFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash. */
  name: string;
  /** The URL of the network to which all network endpoints in the NEG belong. For networkEndpointType GCE_VM_IP_PORT,GCE_VM_IP_PORTMAP or NON_GCP_PRIVATE_IP_PORT, if this field is not specified, a default network will be used. This field cannot be set for NEGs with networkEndpointType set toSERVERLESS or PRIVATE_SERVICE_CONNECT and for global NEGs. For all other network endpoint types, this field is required. */
  network: string;
  ...
  /** All data that is specifically relevant to only network endpoint groups of type PRIVATE_SERVICE_CONNECT. */
  pscData: BetaComputeBetaGlobalNetworkEndpointGroup_PscData;
  /** The target service url used to set up private service connection to a Google API or a PSC Producer Service Attachment. An example value is: asia-northeast3-cloudkms.googleapis.com. Optional. Only valid when networkEndpointType isPRIVATE_SERVICE_CONNECT. */
  ...
  selfLink: string;
  /** Configuration for a serverless network endpoint group (NEG). Theplatform must be provided. Note: The target backend service must be in the same project and located in the same region as the Serverless NEG. */
  serverlessDeployment: BetaComputeBetaGlobalNetworkEndpointGroup_ServerlessDeployment;
  /** Output only. [Output only] Number of network endpoints in the network endpoint group. */
  size: number;
  /** Optional URL of the subnetwork to which all network endpoints in the NEG belong. */
  subnetwork: string;
...
export const BetaComputeBetaGlobalNetworkEndpointGroup: ResourceBinding<BetaComputeBetaGlobalNetworkEndpointGroupConfig, BetaComputeBetaGlobalNetworkEndpointGroupAttrs> = {
  wireType: "google_compute_beta_compute_beta_global_network_endpoint_group",
  fields: {
    annotations: "annotations",
    appEngine: {
      wireName: "app_engine",
      kind: "object",
      fields: BetaComputeBetaGlobalNetworkEndpointGroup_AppEngineFields,
    },
    cloudFunction: {
      wireName: "cloud_function",
      kind: "object",
      fields: BetaComputeBetaGlobalNetworkEndpointGroup_CloudFunctionFields,
    },
    cloudRun: {
      wireName: "cloud_run",
      kind: "object",
      fields: BetaComputeBetaGlobalNetworkEndpointGroup_CloudRunFields,
    },
    ...
    loadBalancer: {
      ...
      kind: "object",
      fields: BetaComputeBetaGlobalNetworkEndpointGroup_LoadBalancerFields,
    },
    name: "name",
    network: "network",
    ...
    pscData: {
      wireName: "psc_data",
      kind: "object",
      fields: BetaComputeBetaGlobalNetworkEndpointGroup_PscDataFields,
    },
    ...
    serverlessDeployment: {
      ...
      kind: "object",
      fields: BetaComputeBetaGlobalNetworkEndpointGroup_ServerlessDeploymentFields,
    },
    size: "size",
    subnetwork: "subnetwork",
    zone: "zone",
