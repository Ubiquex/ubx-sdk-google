// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_region_health_aggregation_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaRegionHealthAggregationPolicyConfig {
...
export interface BetaComputeBetaRegionHealthAggregationPolicyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaComputeBetaRegionHealthAggregationPolicy: ResourceBinding<BetaComputeBetaRegionHealthAggregationPolicyConfig, BetaComputeBetaRegionHealthAggregationPolicyAttrs> = {
  wireType: "google_compute_beta_compute_beta_region_health_aggregation_policy",
  fields: {
