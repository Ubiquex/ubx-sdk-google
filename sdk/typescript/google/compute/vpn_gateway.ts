...
const VpnGateway_VpnInterfacesFields: FieldMap = {
  id: "id",
...
export interface VpnGatewayConfig {
  ...
  vpnInterfaces?: VpnGateway_VpnInterfaces[] | Computed<VpnGateway_VpnInterfaces[]>;
}
...
export interface VpnGatewayAttrs {
  ...
  stackType: string;
  /** The list of VPN interfaces associated with this VPN gateway. */
  vpnInterfaces: VpnGateway_VpnInterfaces[];
}
