...
export interface BetaComputeBetaRegionHealthCheckServiceConfig {
...
export interface BetaComputeBetaRegionHealthCheckServiceAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaComputeBetaRegionHealthCheckService: ResourceBinding<BetaComputeBetaRegionHealthCheckServiceConfig, BetaComputeBetaRegionHealthCheckServiceAttrs> = {
  wireType: "google_compute_beta_compute_beta_region_health_check_service",
  fields: {
