// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_instance_group. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaInstanceGroup_NamedPorts {
  name?: string | Computed<string>;
  port?: number | Computed<number>;
}

const BetaComputeBetaInstanceGroup_NamedPortsFields: FieldMap = {
  name: "name",
  port: "port",
};

export interface BetaComputeBetaInstanceGroupConfig {
  ...
  namedPorts?: BetaComputeBetaInstanceGroup_NamedPorts[] | Computed<BetaComputeBetaInstanceGroup_NamedPorts[]>;
...
export interface BetaComputeBetaInstanceGroupAttrs {
  /** Output only. [Output Only] The creation timestamp for this instance group inRFC3339 text format. */
  ...
  name: string;
  /** Optional. Assigns a name to a port number. For example:{name: "http", port: 80} This allows the system to reference ports by the assigned name instead of a port number. Named ports can also contain multiple ports. For example:[{name: "app1", port: 8080}, {name: "app1", port: 8081}, {name: "app2", port: 8082}] Named ports apply to all instances in this instance group. */
  namedPorts: BetaComputeBetaInstanceGroup_NamedPorts[];
  /** [Output Only] The URL of the network to which all instances in the instance group belong. If your instance has multiple network interfaces, then the network and subnetwork fields only refer to the network and subnet used by your primary interface (nic0). */
  network: string;
  /** Output only. [Output Only] The URL of theregion where the instance group is located (for regional resources). */
  region: string;
...
export const BetaComputeBetaInstanceGroup: ResourceBinding<BetaComputeBetaInstanceGroupConfig, BetaComputeBetaInstanceGroupAttrs> = {
  wireType: "google_compute_beta_compute_beta_instance_group",
  fields: {
    ...
    namedPorts: {
      ...
      kind: "list",
      fields: BetaComputeBetaInstanceGroup_NamedPortsFields,
    },
    network: "network",
    region: "region",
    selfLink: "self_link",
