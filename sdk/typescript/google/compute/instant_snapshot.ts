...
export interface InstantSnapshot_ResourceStatus {
...
const InstantSnapshot_ResourceStatusFields: FieldMap = {
...
export interface InstantSnapshotConfig {
  ...
  resourceStatus?: InstantSnapshot_ResourceStatus | Computed<InstantSnapshot_ResourceStatus>;
...
export interface InstantSnapshotAttrs {
  ...
  /** Output only. [Output Only] URL of the region where the instant snapshot resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  resourceStatus: InstantSnapshot_ResourceStatus;
  /** Output only. Reserved for future use. */
...
export const InstantSnapshot: ResourceBinding<InstantSnapshotConfig, InstantSnapshotAttrs> = {
  ...
  fields: {
    ...
    resourceStatus: {
      ...
      kind: "object",
      fields: InstantSnapshot_ResourceStatusFields,
    },
