...
export interface BetaComputeBetaPublicAdvertisedPrefix_PublicDelegatedPrefixs {
...
const BetaComputeBetaPublicAdvertisedPrefix_PublicDelegatedPrefixsFields: FieldMap = {
  ipRange: "ip_range",
  name: "name",
  project: "project",
  region: "region",
...
export interface BetaComputeBetaPublicAdvertisedPrefixConfig {
  ...
  publicDelegatedPrefixs?: BetaComputeBetaPublicAdvertisedPrefix_PublicDelegatedPrefixs[] | Computed<BetaComputeBetaPublicAdvertisedPrefix_PublicDelegatedPrefixs[]>;
...
export interface BetaComputeBetaPublicAdvertisedPrefixAttrs {
  /** Output only. [Output Only] The version of BYOIP API. */
  ...
  pdpScope: string;
  /** Output only. [Output Only] The list of public delegated prefixes that exist for this public advertised prefix. */
  publicDelegatedPrefixs: BetaComputeBetaPublicAdvertisedPrefix_PublicDelegatedPrefixs[];
  /** Output only. [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** [Output Only] The shared secret to be used for reverse DNS verification. */
  sharedSecret: string;
...
export const BetaComputeBetaPublicAdvertisedPrefix: ResourceBinding<BetaComputeBetaPublicAdvertisedPrefixConfig, BetaComputeBetaPublicAdvertisedPrefixAttrs> = {
  wireType: "google_compute_beta_compute_beta_public_advertised_prefix",
  fields: {
    ...
    publicDelegatedPrefixs: {
      ...
      kind: "list",
      fields: BetaComputeBetaPublicAdvertisedPrefix_PublicDelegatedPrefixsFields,
    },
    selfLink: "self_link",
