// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_vpn_gateway. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaVpnGateway_Params {
...
export interface AlphaComputeAlphaVpnGateway_VpnInterfaces {
...
const AlphaComputeAlphaVpnGateway_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaComputeAlphaVpnGateway_VpnInterfacesFields: FieldMap = {
  id: "id",
...
export interface AlphaComputeAlphaVpnGatewayConfig {
  ...
  params?: AlphaComputeAlphaVpnGateway_Params | Computed<AlphaComputeAlphaVpnGateway_Params>;
  ...
  vpnInterfaces?: AlphaComputeAlphaVpnGateway_VpnInterfaces[] | Computed<AlphaComputeAlphaVpnGateway_VpnInterfaces[]>;
}

export interface AlphaComputeAlphaVpnGatewayAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** URL of the network to which this VPN gateway is attached. Provided by the client when the VPN gateway is created. */
  network: string;
  params: AlphaComputeAlphaVpnGateway_Params;
  /** Output only. [Output Only] URL of the region where the VPN gateway resides. */
  region: string;
  /** Output only. [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  ...
  stackType: string;
  /** The list of VPN interfaces associated with this VPN gateway. */
  vpnInterfaces: AlphaComputeAlphaVpnGateway_VpnInterfaces[];
}

export const AlphaComputeAlphaVpnGateway: ResourceBinding<AlphaComputeAlphaVpnGatewayConfig, AlphaComputeAlphaVpnGatewayAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_vpn_gateway",
  fields: {
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: AlphaComputeAlphaVpnGateway_ParamsFields,
    },
    region: "region",
    selfLink: "self_link",
    ...
    vpnInterfaces: {
      ...
      kind: "list",
      fields: AlphaComputeAlphaVpnGateway_VpnInterfacesFields,
    },
  },
};
