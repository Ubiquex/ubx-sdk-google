...
export interface BetaInterconnectAttachment_ConfigurationConstraints_BgpPeerAsnRanges {
  max?: number | Computed<number>;
  min?: number | Computed<number>;
}

export interface BetaInterconnectAttachment_ConfigurationConstraints {
  ...
  bgpPeerAsnRanges?: BetaInterconnectAttachment_ConfigurationConstraints_BgpPeerAsnRanges[] | Computed<BetaInterconnectAttachment_ConfigurationConstraints_BgpPeerAsnRanges[]>;
}

export interface BetaInterconnectAttachment_L2Forwarding_ApplianceMappings_InnerVlanToApplianceMappings {
  innerApplianceIpAddress?: string | Computed<string>;
  innerVlanTags?: string[] | Computed<string[]>;
}

export interface BetaInterconnectAttachment_L2Forwarding_ApplianceMappings {
  applianceIpAddress?: string | Computed<string>;
  innerVlanToApplianceMappings?: BetaInterconnectAttachment_L2Forwarding_ApplianceMappings_InnerVlanToApplianceMappings[] | Computed<BetaInterconnectAttachment_L2Forwarding_ApplianceMappings_InnerVlanToApplianceMappings[]>;
  name?: string | Computed<string>;
}

export interface BetaInterconnectAttachment_L2Forwarding_GeneveHeader {
  /** Optional. VNI is a 24-bit unique virtual network identifier, from 0 to 16,777,215. */
  vni?: number | Computed<number>;
}

export interface BetaInterconnectAttachment_L2Forwarding {
  ...
  applianceMappings?: Record<string, BetaInterconnectAttachment_L2Forwarding_ApplianceMappings> | Computed<Record<string, BetaInterconnectAttachment_L2Forwarding_ApplianceMappings>>;
  ...
  geneveHeader?: BetaInterconnectAttachment_L2Forwarding_GeneveHeader | Computed<BetaInterconnectAttachment_L2Forwarding_GeneveHeader>;
...
export interface BetaInterconnectAttachment_Params {
...
export interface BetaInterconnectAttachment_PartnerMetadata {
...
export interface BetaInterconnectAttachment_PrivateInterconnectInfo {
  /** [Output Only] 802.1q encapsulation tag to be used for traffic between Google and the customer, going to and from this network and region. */
  tag8021q?: number | Computed<number>;
}

const BetaInterconnectAttachment_ConfigurationConstraints_BgpPeerAsnRangesFields: FieldMap = {
  max: "max",
  min: "min",
};

const BetaInterconnectAttachment_ConfigurationConstraintsFields: FieldMap = {
  bgpMd5: "bgp_md5",
  bgpPeerAsnRanges: {
    wireName: "bgp_peer_asn_ranges",
    kind: "list",
    fields: BetaInterconnectAttachment_ConfigurationConstraints_BgpPeerAsnRangesFields,
  },
};

const BetaInterconnectAttachment_L2Forwarding_ApplianceMappings_InnerVlanToApplianceMappingsFields: FieldMap = {
  innerApplianceIpAddress: "inner_appliance_ip_address",
  innerVlanTags: "inner_vlan_tags",
};

const BetaInterconnectAttachment_L2Forwarding_ApplianceMappingsFields: FieldMap = {
  applianceIpAddress: "appliance_ip_address",
  innerVlanToApplianceMappings: {
    wireName: "inner_vlan_to_appliance_mappings",
    kind: "list",
    fields: BetaInterconnectAttachment_L2Forwarding_ApplianceMappings_InnerVlanToApplianceMappingsFields,
  },
  name: "name",
};

const BetaInterconnectAttachment_L2Forwarding_GeneveHeaderFields: FieldMap = {
  vni: "vni",
};

const BetaInterconnectAttachment_L2ForwardingFields: FieldMap = {
  applianceMappings: {
    wireName: "appliance_mappings",
    kind: "map",
    fields: BetaInterconnectAttachment_L2Forwarding_ApplianceMappingsFields,
  },
  defaultApplianceIpAddress: "default_appliance_ip_address",
  geneveHeader: {
    wireName: "geneve_header",
    kind: "object",
    fields: BetaInterconnectAttachment_L2Forwarding_GeneveHeaderFields,
  },
  network: "network",
  tunnelEndpointIpAddress: "tunnel_endpoint_ip_address",
};

const BetaInterconnectAttachment_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaInterconnectAttachment_PartnerMetadataFields: FieldMap = {
  interconnectName: "interconnect_name",
  partnerName: "partner_name",
  portalUrl: "portal_url",
};

const BetaInterconnectAttachment_PrivateInterconnectInfoFields: FieldMap = {
  tag8021q: "tag8021q",
};

export interface BetaInterconnectAttachmentConfig {
  ...
  configurationConstraints?: BetaInterconnectAttachment_ConfigurationConstraints | Computed<BetaInterconnectAttachment_ConfigurationConstraints>;
  ...
  l2Forwarding?: BetaInterconnectAttachment_L2Forwarding | Computed<BetaInterconnectAttachment_L2Forwarding>;
  ...
  params?: BetaInterconnectAttachment_Params | Computed<BetaInterconnectAttachment_Params>;
  /** Optional BGP ASN for the router supplied by a Layer 3 Partner if they configured BGP on behalf of the customer. Output only for PARTNER type, input only for PARTNER_PROVIDER, not available for DEDICATED. */
  partnerAsn?: string | Computed<string>;
  /** Informational metadata about Partner attachments from Partners to display to customers. These fields are propagated from PARTNER_PROVIDER attachments to their corresponding PARTNER attachments. */
  partnerMetadata?: BetaInterconnectAttachment_PartnerMetadata | Computed<BetaInterconnectAttachment_PartnerMetadata>;
  /** Information for an interconnect attachment when this belongs to an interconnect of type DEDICATED. */
  privateInterconnectInfo?: BetaInterconnectAttachment_PrivateInterconnectInfo | Computed<BetaInterconnectAttachment_PrivateInterconnectInfo>;
...
export interface BetaInterconnectAttachmentAttrs {
  /** Determines whether this Attachment will carry packets. Not present for PARTNER_PROVIDER. */
  ...
  configurationConstraints: BetaInterconnectAttachment_ConfigurationConstraints;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  kind: string;
  /** L2 Interconnect Attachment related configuration. */
  l2Forwarding: BetaInterconnectAttachment_L2Forwarding;
  /** A fingerprint for the labels being applied to this InterconnectAttachment, which is essentially a hash of the labels set used for optimistic locking. The fingerprint is initially generated by Compute Engine and changes after every request to modify or update labels. You must always provide an up-to-date fingerprint hash in order to update or change labels, otherwise the request will fail with error412 conditionNotMet. To see the latest fingerprint, make a get() request to retrieve an InterconnectAttachment. */
  ...
  pairingKey: string;
  /** Additional interconnect attachment parameters. */
  params: BetaInterconnectAttachment_Params;
  /** Optional BGP ASN for the router supplied by a Layer 3 Partner if they configured BGP on behalf of the customer. Output only for PARTNER type, input only for PARTNER_PROVIDER, not available for DEDICATED. */
  partnerAsn: string;
  /** Informational metadata about Partner attachments from Partners to display to customers. These fields are propagated from PARTNER_PROVIDER attachments to their corresponding PARTNER attachments. */
  partnerMetadata: BetaInterconnectAttachment_PartnerMetadata;
  /** Information for an interconnect attachment when this belongs to an interconnect of type DEDICATED. */
  privateInterconnectInfo: BetaInterconnectAttachment_PrivateInterconnectInfo;
  /** Output only. [Output Only] URL of the region where the regional interconnect attachment resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  /** Output only. [Output Only] If the attachment is on a Cross-Cloud Interconnect connection, this field contains the interconnect's remote location service provider. Example values: "Amazon Web Services" "Microsoft Azure". The field is set only for attachments on Cross-Cloud Interconnect connections. Its value is copied from the InterconnectRemoteLocation remoteService field. */
...
export const BetaInterconnectAttachment: ResourceBinding<BetaInterconnectAttachmentConfig, BetaInterconnectAttachmentAttrs> = {
  wireType: "google_compute_beta_interconnect_attachment",
  fields: {
    ...
    configurationConstraints: {
      ...
      kind: "object",
      fields: BetaInterconnectAttachment_ConfigurationConstraintsFields,
    },
    ...
    l2Forwarding: {
      ...
      kind: "object",
      fields: BetaInterconnectAttachment_L2ForwardingFields,
    },
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaInterconnectAttachment_ParamsFields,
    },
    partnerAsn: "partner_asn",
    partnerMetadata: {
      wireName: "partner_metadata",
      kind: "object",
      fields: BetaInterconnectAttachment_PartnerMetadataFields,
    },
    privateInterconnectInfo: {
      wireName: "private_interconnect_info",
      kind: "object",
      fields: BetaInterconnectAttachment_PrivateInterconnectInfoFields,
    },
    region: "region",
