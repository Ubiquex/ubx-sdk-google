...
export interface BetaRouter_Bgp_AdvertisedIpRanges {
  description?: string | Computed<string>;
  range?: string | Computed<string>;
}

export interface BetaRouter_Bgp {
  ...
  advertisedIpRanges?: BetaRouter_Bgp_AdvertisedIpRanges[] | Computed<BetaRouter_Bgp_AdvertisedIpRanges[]>;
...
export interface BetaRouter_BgpPeers_Bfd {
...
export interface BetaRouter_BgpPeers_CustomLearnedIpRanges {
  range?: string | Computed<string>;
}

export interface BetaRouter_BgpPeers {
  advertiseMode?: string | Computed<string>;
  advertisedGroups?: string[] | Computed<string[]>;
  advertisedIpRanges?: BetaRouter_Bgp_AdvertisedIpRanges[] | Computed<BetaRouter_Bgp_AdvertisedIpRanges[]>;
  advertisedRoutePriority?: number | Computed<number>;
  bfd?: BetaRouter_BgpPeers_Bfd | Computed<BetaRouter_BgpPeers_Bfd>;
  customLearnedIpRanges?: BetaRouter_BgpPeers_CustomLearnedIpRanges[] | Computed<BetaRouter_BgpPeers_CustomLearnedIpRanges[]>;
...
export interface BetaRouter_Interfaces {
...
export interface BetaRouter_Md5AuthenticationKeys {
  key?: string | Computed<string>;
  name?: string | Computed<string>;
}

export interface BetaRouter_Nats_LogConfig {
  enable?: boolean | Computed<boolean>;
  filter?: string | Computed<string>;
}

export interface BetaRouter_Nats_Nat64Subnetworks {
  name?: string | Computed<string>;
}

export interface BetaRouter_Nats_Rules_Action {
...
export interface BetaRouter_Nats_Rules {
  action?: BetaRouter_Nats_Rules_Action | Computed<BetaRouter_Nats_Rules_Action>;
  description?: string | Computed<string>;
  match?: string | Computed<string>;
  ruleNumber?: number | Computed<number>;
}

export interface BetaRouter_Nats_Subnetworks {
  name?: string | Computed<string>;
  secondaryIpRangeNames?: string[] | Computed<string[]>;
  sourceIpRangesToNat?: string[] | Computed<string[]>;
}

export interface BetaRouter_Nats {
  ...
  logConfig?: BetaRouter_Nats_LogConfig | Computed<BetaRouter_Nats_LogConfig>;
  maxPortsPerVm?: number | Computed<number>;
  minPortsPerVm?: number | Computed<number>;
  name?: string | Computed<string>;
  nat64Subnetworks?: BetaRouter_Nats_Nat64Subnetworks[] | Computed<BetaRouter_Nats_Nat64Subnetworks[]>;
  natIpAllocateOption?: string | Computed<string>;
  natIps?: string[] | Computed<string[]>;
  rules?: BetaRouter_Nats_Rules[] | Computed<BetaRouter_Nats_Rules[]>;
  sourceSubnetworkIpRangesToNat?: string | Computed<string>;
  sourceSubnetworkIpRangesToNat64?: string | Computed<string>;
  subnetworks?: BetaRouter_Nats_Subnetworks[] | Computed<BetaRouter_Nats_Subnetworks[]>;
...
export interface BetaRouter_Params {
...
const BetaRouter_Bgp_AdvertisedIpRangesFields: FieldMap = {
  description: "description",
  range: "range",
};

const BetaRouter_BgpFields: FieldMap = {
...
const BetaRouter_BgpPeers_BfdFields: FieldMap = {
...
const BetaRouter_BgpPeers_CustomLearnedIpRangesFields: FieldMap = {
  range: "range",
};

const BetaRouter_BgpPeersFields: FieldMap = {
  advertiseMode: "advertise_mode",
  advertisedGroups: "advertised_groups",
  advertisedIpRanges: {
    wireName: "advertised_ip_ranges",
...
const BetaRouter_InterfacesFields: FieldMap = {
  ipRange: "ip_range",
...
const BetaRouter_Md5AuthenticationKeysFields: FieldMap = {
  key: "key",
  name: "name",
};

const BetaRouter_Nats_LogConfigFields: FieldMap = {
  enable: "enable",
  filter: "filter",
};

const BetaRouter_Nats_Nat64SubnetworksFields: FieldMap = {
  name: "name",
};

const BetaRouter_Nats_Rules_ActionFields: FieldMap = {
...
const BetaRouter_Nats_RulesFields: FieldMap = {
  action: {
    wireName: "action",
    kind: "object",
...
const BetaRouter_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

export interface BetaRouterConfig {
  ...
  nats?: BetaRouter_Nats[] | Computed<BetaRouter_Nats[]>;
  ...
  params?: BetaRouter_Params | Computed<BetaRouter_Params>;
...
export interface BetaRouterAttrs {
  bgp: BetaRouter_Bgp;
  /** BGP information that must be configured into the routing stack to establish BGP peering. This information must specify the peer ASN and either the interface name, IP address, or peer IP address. Please refer toRFC4273. */
  bgpPeers: BetaRouter_BgpPeers[];
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  id: string;
  /** Router interfaces. To create a BGP peer that uses a router interface, the interface must have one of the following fields specified: - linkedVpnTunnel - linkedInterconnectAttachment - subnetwork You can create a router interface without any of these fields specified. However, you cannot create a BGP peer that uses that interface. */
  interfaces: BetaRouter_Interfaces[];
  /** Output only. [Output Only] Type of resource. Always compute#router for routers. */
  kind: string;
  /** Keys used for MD5 authentication. */
  md5AuthenticationKeys: BetaRouter_Md5AuthenticationKeys[];
  /** Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and comply withRFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash. */
  name: string;
  /** A list of NAT services created in this router. */
  nats: BetaRouter_Nats[];
  /** URI of the ncc_gateway to which this router associated. */
  nccGateway: string;
  /** URI of the network to which this router belongs. */
  network: string;
  /** Additional router parameters. */
  params: BetaRouter_Params;
  /** [Output Only] URI of the region where the router resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
...
export const BetaRouter: ResourceBinding<BetaRouterConfig, BetaRouterAttrs> = {
  wireType: "google_compute_beta_router",
  fields: {
    bgp: {
      wireName: "bgp",
      kind: "object",
