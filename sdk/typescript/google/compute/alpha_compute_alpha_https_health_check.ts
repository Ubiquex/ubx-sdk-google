// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_https_health_check. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaHttpsHealthCheckConfig {
...
export interface AlphaComputeAlphaHttpsHealthCheckAttrs {
  /** How often (in seconds) to send a health check. The default value is 5 seconds. */
...
export const AlphaComputeAlphaHttpsHealthCheck: ResourceBinding<AlphaComputeAlphaHttpsHealthCheckConfig, AlphaComputeAlphaHttpsHealthCheckAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_https_health_check",
  fields: {
