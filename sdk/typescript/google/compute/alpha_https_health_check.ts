// Code generated by `ubx sdk gen` from google_compute_alpha_https_health_check. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaHttpsHealthCheckConfig {
...
export interface AlphaHttpsHealthCheckAttrs {
  /** How often (in seconds) to send a health check. The default value is 5 seconds. */
...
export const AlphaHttpsHealthCheck: ResourceBinding<AlphaHttpsHealthCheckConfig, AlphaHttpsHealthCheckAttrs> = {
  wireType: "google_compute_alpha_https_health_check",
  fields: {
