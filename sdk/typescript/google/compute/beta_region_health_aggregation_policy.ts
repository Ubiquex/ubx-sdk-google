// Code generated by `ubx sdk gen` from google_compute_beta_region_health_aggregation_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaRegionHealthAggregationPolicyConfig {
...
export interface BetaRegionHealthAggregationPolicyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaRegionHealthAggregationPolicy: ResourceBinding<BetaRegionHealthAggregationPolicyConfig, BetaRegionHealthAggregationPolicyAttrs> = {
  wireType: "google_compute_beta_region_health_aggregation_policy",
  fields: {
