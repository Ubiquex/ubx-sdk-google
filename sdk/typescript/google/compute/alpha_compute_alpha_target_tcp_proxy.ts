// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_target_tcp_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaTargetTcpProxyConfig {
...
export interface AlphaComputeAlphaTargetTcpProxyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const AlphaComputeAlphaTargetTcpProxy: ResourceBinding<AlphaComputeAlphaTargetTcpProxyConfig, AlphaComputeAlphaTargetTcpProxyAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_target_tcp_proxy",
  fields: {
