// Code generated by `ubx sdk gen` from google_compute_beta_health_check. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaHealthCheck_GrpcHealthCheck {
...
export interface BetaHealthCheck_GrpcTlsHealthCheck {
  /** The gRPC service name for the health check. This field is optional. The value of grpc_service_name has the following meanings by convention: - Empty service_name means the overall status of all services at the backend. - Non-empty service_name means the health of that gRPC service, as defined by the owner of the service. The grpc_service_name can only be ASCII. */
  grpcServiceName?: string | Computed<string>;
  /** The TCP port number to which the health check prober sends packets. Valid values are 1 through 65535. */
  port?: number | Computed<number>;
...
export interface BetaHealthCheck_Http2HealthCheck {
...
export interface BetaHealthCheck_LogConfig {
  /** Indicates whether or not to export logs. This is false by default, which means no health check logging will be done. */
  enable?: boolean | Computed<boolean>;
}

export interface BetaHealthCheck_SslHealthCheck {
  /** The TCP port number to which the health check prober sends packets. The default value is 443. Valid values are 1 through65535. */
  port?: number | Computed<number>;
  /** Not supported. */
  portName?: string | Computed<string>;
...
const BetaHealthCheck_GrpcHealthCheckFields: FieldMap = {
...
const BetaHealthCheck_GrpcTlsHealthCheckFields: FieldMap = {
  grpcServiceName: "grpc_service_name",
  port: "port",
  portSpecification: "port_specification",
};

const BetaHealthCheck_Http2HealthCheckFields: FieldMap = {
  host: "host",
  port: "port",
  portName: "port_name",
  portSpecification: "port_specification",
...
const BetaHealthCheck_LogConfigFields: FieldMap = {
  enable: "enable",
};

const BetaHealthCheck_SslHealthCheckFields: FieldMap = {
  port: "port",
  portName: "port_name",
  portSpecification: "port_specification",
  proxyHeader: "proxy_header",
...
export interface BetaHealthCheckConfig {
  ...
  grpcHealthCheck?: BetaHealthCheck_GrpcHealthCheck | Computed<BetaHealthCheck_GrpcHealthCheck>;
  grpcTlsHealthCheck?: BetaHealthCheck_GrpcTlsHealthCheck | Computed<BetaHealthCheck_GrpcTlsHealthCheck>;
  /** A so-far unhealthy instance will be marked healthy after this many consecutive successes. The default value is 2. */
  healthyThreshold?: number | Computed<number>;
  http2HealthCheck?: BetaHealthCheck_Http2HealthCheck | Computed<BetaHealthCheck_Http2HealthCheck>;
  httpHealthCheck?: BetaHealthCheck_Http2HealthCheck | Computed<BetaHealthCheck_Http2HealthCheck>;
  httpsHealthCheck?: BetaHealthCheck_Http2HealthCheck | Computed<BetaHealthCheck_Http2HealthCheck>;
  /** [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id?: string | Computed<string>;
  /** Output only. Type of the resource. */
  kind?: string | Computed<string>;
  /** Configuration of logging on a health check. If logging is enabled, logs will be exported to Stackdriver. */
  logConfig?: BetaHealthCheck_LogConfig | Computed<BetaHealthCheck_LogConfig>;
  ...
  sslHealthCheck?: BetaHealthCheck_SslHealthCheck | Computed<BetaHealthCheck_SslHealthCheck>;
  tcpHealthCheck?: BetaHealthCheck_SslHealthCheck | Computed<BetaHealthCheck_SslHealthCheck>;
...
export interface BetaHealthCheckAttrs {
  /** How often (in seconds) to send a health check. The default value is 5 seconds. */
  ...
  /** An optional description of this resource. Provide this property when you create the resource. */
  description: string;
  grpcHealthCheck: BetaHealthCheck_GrpcHealthCheck;
  grpcTlsHealthCheck: BetaHealthCheck_GrpcTlsHealthCheck;
  /** A so-far unhealthy instance will be marked healthy after this many consecutive successes. The default value is 2. */
  healthyThreshold: number;
  http2HealthCheck: BetaHealthCheck_Http2HealthCheck;
  httpHealthCheck: BetaHealthCheck_Http2HealthCheck;
  httpsHealthCheck: BetaHealthCheck_Http2HealthCheck;
  /** [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  /** Output only. Type of the resource. */
  kind: string;
  /** Configuration of logging on a health check. If logging is enabled, logs will be exported to Stackdriver. */
  logConfig: BetaHealthCheck_LogConfig;
  /** Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and comply withRFC1035. For example, a name that is 1-63 characters long, matches the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?`, and otherwise complies with RFC1035. This regular expression describes a name where the first character is a lowercase letter, and all following characters are a dash, lowercase letter, or digit, except the last character, which isn't a dash. */
  name: string;
  /** Output only. [Output Only] Region where the health check resides. Not applicable to global health checks. */
  region: string;
  ...
  sslHealthCheck: BetaHealthCheck_SslHealthCheck;
  tcpHealthCheck: BetaHealthCheck_SslHealthCheck;
  /** How long (in seconds) to wait before claiming failure. The default value is 5 seconds. It is invalid for timeoutSec to have greater value than checkIntervalSec. */
  timeoutSec: number;
  /** Specifies the type of the healthCheck, either TCP,SSL, HTTP, HTTPS,HTTP2, GRPC or GRPC_WITH_TLS. Exactly one of the protocol-specific health check fields must be specified, which must match type field. */
  type: string;
...
export const BetaHealthCheck: ResourceBinding<BetaHealthCheckConfig, BetaHealthCheckAttrs> = {
  wireType: "google_compute_beta_health_check",
  fields: {
    ...
    grpcHealthCheck: {
      ...
      kind: "object",
      fields: BetaHealthCheck_GrpcHealthCheckFields,
    },
    grpcTlsHealthCheck: {
      wireName: "grpc_tls_health_check",
      kind: "object",
      fields: BetaHealthCheck_GrpcTlsHealthCheckFields,
    },
    healthyThreshold: "healthy_threshold",
    http2HealthCheck: {
      wireName: "http2_health_check",
      kind: "object",
      fields: BetaHealthCheck_Http2HealthCheckFields,
    },
    httpHealthCheck: {
    ...
    logConfig: {
      wireName: "log_config",
      kind: "object",
      fields: BetaHealthCheck_LogConfigFields,
    },
    name: "name",
    region: "region",
    selfLink: "self_link",
    ...
    sslHealthCheck: {
      ...
      kind: "object",
      fields: BetaHealthCheck_SslHealthCheckFields,
    },
    tcpHealthCheck: {
