...
export interface AlphaDhcpOptionsConfig_Associations {
  network?: string | Computed<string>;
  networkId?: string | Computed<string>;
  state?: string | Computed<string>;
}

const AlphaDhcpOptionsConfig_AssociationsFields: FieldMap = {
  network: "network",
  networkId: "network_id",
  state: "state",
};

export interface AlphaDhcpOptionsConfigConfig {
  /** Mapping of user-defined keys to DhcpOptionsConfig to Network associations. */
  associations?: Record<string, AlphaDhcpOptionsConfig_Associations> | Computed<Record<string, AlphaDhcpOptionsConfig_Associations>>;
...
export interface AlphaDhcpOptionsConfigAttrs {
  /** Mapping of user-defined keys to DhcpOptionsConfig to Network associations. */
  associations: Record<string, AlphaDhcpOptionsConfig_Associations>;
  /** The file path and name of the boot image/file on the TFTP server that the client VM guest OS should download and execute during network boot. Used when the standard DHCP header 'file' field is overloaded. Corresponds to DHCPv4 Option 67. */
...
export const AlphaDhcpOptionsConfig: ResourceBinding<AlphaDhcpOptionsConfigConfig, AlphaDhcpOptionsConfigAttrs> = {
  wireType: "google_compute_alpha_dhcp_options_config",
  fields: {
    associations: {
