// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_http_health_check. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaHttpHealthCheckConfig {
...
export interface BetaComputeBetaHttpHealthCheckAttrs {
  /** How often (in seconds) to send a health check. The default value is5 seconds. */
...
export const BetaComputeBetaHttpHealthCheck: ResourceBinding<BetaComputeBetaHttpHealthCheckConfig, BetaComputeBetaHttpHealthCheckAttrs> = {
  wireType: "google_compute_beta_compute_beta_http_health_check",
  fields: {
