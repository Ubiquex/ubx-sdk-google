// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_region_target_tcp_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaRegionTargetTcpProxyConfig {
...
export interface AlphaComputeAlphaRegionTargetTcpProxyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const AlphaComputeAlphaRegionTargetTcpProxy: ResourceBinding<AlphaComputeAlphaRegionTargetTcpProxyConfig, AlphaComputeAlphaRegionTargetTcpProxyAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_region_target_tcp_proxy",
  fields: {
