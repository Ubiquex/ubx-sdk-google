// Code generated by `ubx sdk gen` from google_compute_alpha_http_health_check. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaHttpHealthCheckConfig {
...
export interface AlphaHttpHealthCheckAttrs {
  /** How often (in seconds) to send a health check. The default value is5 seconds. */
...
export const AlphaHttpHealthCheck: ResourceBinding<AlphaHttpHealthCheckConfig, AlphaHttpHealthCheckAttrs> = {
  wireType: "google_compute_alpha_http_health_check",
  fields: {
