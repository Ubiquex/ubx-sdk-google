...
export interface AlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages {
  percentage?: number | Computed<number>;
  trafficClass?: string | Computed<string>;
}

export interface AlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy {
  /** Specify bandwidth percentages for various traffic classes for queuing type Bandwidth Percent. */
  bandwidthPercentages?: AlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[] | Computed<AlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[]>;
}

export interface AlphaInterconnect_ApplicationAwareInterconnect {
  bandwidthPercentagePolicy?: AlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy | Computed<AlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy>;
  ...
  shapeAveragePercentages?: AlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[] | Computed<AlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[]>;
  /** Specify configuration for StrictPriorityPolicy. */
  strictPriorityPolicy?: unknown | Computed<unknown>;
}

export interface AlphaInterconnect_CircuitInfos {
  customerDemarcId?: string | Computed<string>;
  googleCircuitId?: string | Computed<string>;
  googleDemarcId?: string | Computed<string>;
}

export interface AlphaInterconnect_ExpectedOutages {
...
export interface AlphaInterconnect_Macsec_PreSharedKeys {
  name?: string | Computed<string>;
  startTime?: string | Computed<string>;
}

export interface AlphaInterconnect_Macsec {
  ...
  preSharedKeys?: AlphaInterconnect_Macsec_PreSharedKeys[] | Computed<AlphaInterconnect_Macsec_PreSharedKeys[]>;
}

export interface AlphaInterconnect_Params {
...
const AlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentagesFields: FieldMap = {
  percentage: "percentage",
  trafficClass: "traffic_class",
};

const AlphaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicyFields: FieldMap = {
...
const AlphaInterconnect_ApplicationAwareInterconnectFields: FieldMap = {
...
const AlphaInterconnect_CircuitInfosFields: FieldMap = {
  customerDemarcId: "customer_demarc_id",
  googleCircuitId: "google_circuit_id",
  googleDemarcId: "google_demarc_id",
};

const AlphaInterconnect_ExpectedOutagesFields: FieldMap = {
...
const AlphaInterconnect_Macsec_PreSharedKeysFields: FieldMap = {
  name: "name",
  startTime: "start_time",
};

const AlphaInterconnect_MacsecFields: FieldMap = {
  failOpen: "fail_open",
...
const AlphaInterconnect_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

export interface AlphaInterconnectConfig {
  ...
  applicationAwareInterconnect?: AlphaInterconnect_ApplicationAwareInterconnect | Computed<AlphaInterconnect_ApplicationAwareInterconnect>;
  ...
  circuitInfos?: AlphaInterconnect_CircuitInfos[] | Computed<AlphaInterconnect_CircuitInfos[]>;
  ...
  expectedOutages?: AlphaInterconnect_ExpectedOutages[] | Computed<AlphaInterconnect_ExpectedOutages[]>;
  ...
  macsec?: AlphaInterconnect_Macsec | Computed<AlphaInterconnect_Macsec>;
  ...
  params?: AlphaInterconnect_Params | Computed<AlphaInterconnect_Params>;
...
export interface AlphaInterconnectAttrs {
  /** Enable or disable the application awareness feature on this Cloud Interconnect. */
  aaiEnabled: boolean;
  /** Administrative status of the interconnect. When this is set to true, the Interconnect is functional and can carry traffic. When set to false, no packets can be carried over the interconnect and no BGP routes are exchanged over it. By default, the status is set to true. */
  adminEnabled: boolean;
  /** Configuration information for application awareness on this Cloud Interconnect. */
  applicationAwareInterconnect: AlphaInterconnect_ApplicationAwareInterconnect;
  /** [Output only] List of features available for this Interconnect connection, which can take one of the following values: - IF_MACSEC: If present, then the Interconnect connection is provisioned on MACsec capable hardware ports. If not present, then the Interconnect connection is provisioned on non-MACsec capable ports. Any attempt to enable MACsec will fail. - IF_CROSS_SITE_NETWORK: If present, then the Interconnect connection is provisioned exclusively for Cross-Site Networking. Any attempt to configure VLAN attachments will fail. If not present, then the Interconnect connection is not provisioned for Cross-Site Networking. Any attempt to use it for Cross-Site Networking will fail. */
  availableFeatures: string[];
  /** Output only. [Output Only] A list of CircuitInfo objects, that describe the individual circuits in this LAG. */
  circuitInfos: AlphaInterconnect_CircuitInfos[];
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** Output only. [Output Only] A list of outages expected for this Interconnect. */
  expectedOutages: AlphaInterconnect_ExpectedOutages[];
  /** Output only. [Output Only] IP address configured on the Google side of the Interconnect link. This can be used only for ping tests. */
  ...
  location: string;
  /** Configuration information for enabling Media Access Control security (MACsec) on this Cloud Interconnect connection between Google and your on-premises router. */
  macsec: AlphaInterconnect_Macsec;
  /** Enable or disable MACsec on this Interconnect connection. MACsec enablement fails if the MACsec object is not specified. */
  ...
  /** Additional interconnect parameters. */
  params: AlphaInterconnect_Params;
  /** Output only. [Output Only] IP address configured on the customer side of the Interconnect link. The customer should configure this IP address during turnup when prompted by Google NOC. This can be used only for ping tests. */
...
export const AlphaInterconnect: ResourceBinding<AlphaInterconnectConfig, AlphaInterconnectAttrs> = {
