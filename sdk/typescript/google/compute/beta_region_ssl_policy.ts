...
export interface BetaRegionSslPolicy_Warnings_Data {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface BetaRegionSslPolicy_Warnings {
  code?: string | Computed<string>;
  data?: BetaRegionSslPolicy_Warnings_Data[] | Computed<BetaRegionSslPolicy_Warnings_Data[]>;
  message?: string | Computed<string>;
}

const BetaRegionSslPolicy_Warnings_DataFields: FieldMap = {
  key: "key",
  value: "value",
};

const BetaRegionSslPolicy_WarningsFields: FieldMap = {
  code: "code",
  data: {
    wireName: "data",
    kind: "list",
    fields: BetaRegionSslPolicy_Warnings_DataFields,
  },
  message: "message",
};

export interface BetaRegionSslPolicyConfig {
  ...
  warnings?: BetaRegionSslPolicy_Warnings[] | Computed<BetaRegionSslPolicy_Warnings[]>;
}

export interface BetaRegionSslPolicyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  selfLink: string;
  /** Output only. [Output Only] If potential misconfigurations are detected for this SSL policy, this field will be populated with warning messages. */
  warnings: BetaRegionSslPolicy_Warnings[];
}

export const BetaRegionSslPolicy: ResourceBinding<BetaRegionSslPolicyConfig, BetaRegionSslPolicyAttrs> = {
  ...
  fields: {
    ...
    warnings: {
      wireName: "warnings",
      kind: "list",
      fields: BetaRegionSslPolicy_WarningsFields,
    },
  },
};
