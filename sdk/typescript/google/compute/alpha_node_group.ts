// Code generated by `ubx sdk gen` from google_compute_alpha_node_group. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaNodeGroup_AutoscalingPolicy {
...
export interface AlphaNodeGroup_MaintenanceWindow_MaintenanceDuration {
...
export interface AlphaNodeGroup_MaintenanceWindow {
  ...
  maintenanceDuration?: AlphaNodeGroup_MaintenanceWindow_MaintenanceDuration | Computed<AlphaNodeGroup_MaintenanceWindow_MaintenanceDuration>;
  /** Start time of the window. This must be in UTC format that resolves to one of 00:00, 04:00, 08:00,12:00, 16:00, or 20:00. For example, both 13:00-5 and 08:00 are valid. */
  startTime?: string | Computed<string>;
}

export interface AlphaNodeGroup_ShareSettings_FolderMap {
  folderId?: string | Computed<string>;
}

export interface AlphaNodeGroup_ShareSettings_ProjectMap {
  projectId?: string | Computed<string>;
}

export interface AlphaNodeGroup_ShareSettings {
  ...
  folderMap?: Record<string, AlphaNodeGroup_ShareSettings_FolderMap> | Computed<Record<string, AlphaNodeGroup_ShareSettings_FolderMap>>;
  /** A map of project id and project config. This is only valid when share_type's value is SPECIFIC_PROJECTS. */
  projectMap?: Record<string, AlphaNodeGroup_ShareSettings_ProjectMap> | Computed<Record<string, AlphaNodeGroup_ShareSettings_ProjectMap>>;
...
const AlphaNodeGroup_AutoscalingPolicyFields: FieldMap = {
  maxNodes: "max_nodes",
  minNodes: "min_nodes",
  mode: "mode",
};

const AlphaNodeGroup_MaintenanceWindow_MaintenanceDurationFields: FieldMap = {
  nanos: "nanos",
  seconds: "seconds",
};

const AlphaNodeGroup_MaintenanceWindowFields: FieldMap = {
  duration: "duration",
  maintenanceDuration: {
...
const AlphaNodeGroup_ShareSettings_FolderMapFields: FieldMap = {
  folderId: "folder_id",
};

const AlphaNodeGroup_ShareSettings_ProjectMapFields: FieldMap = {
  projectId: "project_id",
};

const AlphaNodeGroup_ShareSettingsFields: FieldMap = {
  folderMap: {
    wireName: "folder_map",
    kind: "map",
...
export interface AlphaNodeGroupConfig {
  ...
  maintenanceWindow?: AlphaNodeGroup_MaintenanceWindow | Computed<AlphaNodeGroup_MaintenanceWindow>;
...
export interface AlphaNodeGroupAttrs {
  autoscalingPolicy: AlphaNodeGroup_AutoscalingPolicy;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** Time window specified for daily maintenance operations. GCE's internal maintenance will be performed within this window. */
  maintenanceWindow: AlphaNodeGroup_MaintenanceWindow;
  /** The name of the resource, provided by the client when initially creating the resource. The resource name must be 1-63 characters long, and comply withRFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash. */
  name: string;
  /** URL of the node template to create the node group from. */
  nodeTemplate: string;
  ...
  /** The share setting for reservations and sole tenancy node groups. */
  shareSettings: AlphaNodeGroup_ShareSettings;
  /** Output only. [Output Only] The total number of nodes in the node group. */
  size: number;
  status: string;
  /** Output only. [Output Only] The name of the zone where the node group resides, such as us-central1-a. */
...
export const AlphaNodeGroup: ResourceBinding<AlphaNodeGroupConfig, AlphaNodeGroupAttrs> = {
  wireType: "google_compute_alpha_node_group",
  fields: {
    autoscalingPolicy: {
