...
export interface BetaDhcpOptionsConfig_Associations {
  network?: string | Computed<string>;
  networkId?: string | Computed<string>;
  state?: string | Computed<string>;
}

const BetaDhcpOptionsConfig_AssociationsFields: FieldMap = {
  network: "network",
  networkId: "network_id",
  state: "state",
};

export interface BetaDhcpOptionsConfigConfig {
  /** Mapping of user-defined keys to DhcpOptionsConfig to Network associations. */
  associations?: Record<string, BetaDhcpOptionsConfig_Associations> | Computed<Record<string, BetaDhcpOptionsConfig_Associations>>;
...
export interface BetaDhcpOptionsConfigAttrs {
  /** Mapping of user-defined keys to DhcpOptionsConfig to Network associations. */
  associations: Record<string, BetaDhcpOptionsConfig_Associations>;
  /** The file path and name of the boot image/file on the TFTP server that the client VM guest OS should download and execute during network boot. Used when the standard DHCP header 'file' field is overloaded. Corresponds to DHCPv4 Option 67. */
...
export const BetaDhcpOptionsConfig: ResourceBinding<BetaDhcpOptionsConfigConfig, BetaDhcpOptionsConfigAttrs> = {
