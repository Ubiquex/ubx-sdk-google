...
export interface BetaComputeBetaStoragePool_ExapoolProvisionedCapacityGb {
...
export interface BetaComputeBetaStoragePool_Params {
...
export interface BetaComputeBetaStoragePool_ResourceStatus {
...
export interface BetaComputeBetaStoragePool_ShareSettings_ProjectMap {
  projectId?: string | Computed<string>;
}

export interface BetaComputeBetaStoragePool_ShareSettings {
  /** A map of project id and project config. */
  projectMap?: Record<string, BetaComputeBetaStoragePool_ShareSettings_ProjectMap> | Computed<Record<string, BetaComputeBetaStoragePool_ShareSettings_ProjectMap>>;
}

const BetaComputeBetaStoragePool_ExapoolProvisionedCapacityGbFields: FieldMap = {
  capacityOptimized: "capacity_optimized",
  readOptimized: "read_optimized",
  writeOptimized: "write_optimized",
};

const BetaComputeBetaStoragePool_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaComputeBetaStoragePool_ResourceStatusFields: FieldMap = {
...
const BetaComputeBetaStoragePool_ShareSettings_ProjectMapFields: FieldMap = {
  projectId: "project_id",
};

const BetaComputeBetaStoragePool_ShareSettingsFields: FieldMap = {
  projectMap: {
    wireName: "project_map",
    kind: "map",
    fields: BetaComputeBetaStoragePool_ShareSettings_ProjectMapFields,
  },
};

export interface BetaComputeBetaStoragePoolConfig {
  ...
  exapoolProvisionedCapacityGb?: BetaComputeBetaStoragePool_ExapoolProvisionedCapacityGb | Computed<BetaComputeBetaStoragePool_ExapoolProvisionedCapacityGb>;
  ...
  params?: BetaComputeBetaStoragePool_Params | Computed<BetaComputeBetaStoragePool_Params>;
  ...
  resourceStatus?: BetaComputeBetaStoragePool_ResourceStatus | Computed<BetaComputeBetaStoragePool_ResourceStatus>;
  /** Output only. [Output Only] Server-defined fully-qualified URL for this resource. */
  selfLink?: string | Computed<string>;
  /** Output only. [Output Only] Server-defined URL for this resource's resource id. */
  selfLinkWithId?: string | Computed<string>;
  /** Share settings for the storage pool. */
  shareSettings?: BetaComputeBetaStoragePool_ShareSettings | Computed<BetaComputeBetaStoragePool_ShareSettings>;
  ...
  /** [Output Only] Contains output only fields. */
  status?: BetaComputeBetaStoragePool_ResourceStatus | Computed<BetaComputeBetaStoragePool_ResourceStatus>;
...
export interface BetaComputeBetaStoragePoolAttrs {
  /** Provisioning type of the byte capacity of the pool. */
  ...
  description: string;
  /** Exapool provisioned capacities for each SKU type */
  exapoolProvisionedCapacityGb: BetaComputeBetaStoragePool_ExapoolProvisionedCapacityGb;
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  /** Output only. [Output Only] Type of the resource. Always compute#storagePool for storage pools. */
  kind: string;
  ...
  name: string;
  /** Additional storage pool params. */
  params: BetaComputeBetaStoragePool_Params;
  /** Provisioning type of the performance-related parameters of the pool, such as throughput and IOPS. */
  ...
  /** [Output Only] Contains output only fields. */
  resourceStatus: BetaComputeBetaStoragePool_ResourceStatus;
  /** Output only. [Output Only] Server-defined fully-qualified URL for this resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource's resource id. */
  selfLinkWithId: string;
  /** Share settings for the storage pool. */
  shareSettings: BetaComputeBetaStoragePool_ShareSettings;
  /** Output only. [Output Only] The status of storage pool creation. - CREATING: Storage pool is provisioning. storagePool. - FAILED: Storage pool creation failed. - READY: Storage pool is ready for use. - DELETING: Storage pool is deleting. */
  state: string;
  /** [Output Only] Contains output only fields. */
  status: BetaComputeBetaStoragePool_ResourceStatus;
  /** Type of the storage pool. */
...
export const BetaComputeBetaStoragePool: ResourceBinding<BetaComputeBetaStoragePoolConfig, BetaComputeBetaStoragePoolAttrs> = {
  wireType: "google_compute_beta_compute_beta_storage_pool",
  fields: {
    ...
    exapoolProvisionedCapacityGb: {
      ...
      kind: "object",
      fields: BetaComputeBetaStoragePool_ExapoolProvisionedCapacityGbFields,
    },
    id: "id",
    kind: "kind",
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaComputeBetaStoragePool_ParamsFields,
    },
    ...
    resourceStatus: {
      ...
      kind: "object",
      fields: BetaComputeBetaStoragePool_ResourceStatusFields,
    },
    selfLink: "self_link",
    ...
    shareSettings: {
      ...
      kind: "object",
      fields: BetaComputeBetaStoragePool_ShareSettingsFields,
    },
    state: "state",
    status: {
      wireName: "status",
