...
export interface BetaComputeBetaNetworkFirewallPolicy_Associations {
...
export interface BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs {
  ipProtocol?: string | Computed<string>;
  ports?: string[] | Computed<string[]>;
}

export interface BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags {
  name?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match {
  ...
  layer4Configs?: BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs[] | Computed<BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs[]>;
  ...
  srcSecureTags?: BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[] | Computed<BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[]>;
  srcThreatIntelligences?: string[] | Computed<string[]>;
}

export interface BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules {
  ...
  match?: BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match | Computed<BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match>;
  priority?: number | Computed<number>;
  ...
  targetSecureTags?: BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[] | Computed<BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[]>;
  targetServiceAccounts?: string[] | Computed<string[]>;
  targetType?: string | Computed<string>;
  tlsInspect?: boolean | Computed<boolean>;
}

const BetaComputeBetaNetworkFirewallPolicy_AssociationsFields: FieldMap = {
...
const BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields: FieldMap = {
  ipProtocol: "ip_protocol",
  ports: "ports",
};

const BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields: FieldMap = {
  name: "name",
  state: "state",
};

const BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_MatchFields: FieldMap = {
  ...
  layer4Configs: {
    ...
    kind: "list",
    fields: BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields,
  },
  ...
  srcSecureTags: {
    ...
    kind: "list",
    fields: BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields,
  },
  srcThreatIntelligences: "src_threat_intelligences",
};

const BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRulesFields: FieldMap = {
  action: "action",
  ...
  match: {
    wireName: "match",
    kind: "object",
    fields: BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules_MatchFields,
  },
  priority: "priority",
  ruleName: "rule_name",
...
export interface BetaComputeBetaNetworkFirewallPolicyConfig {
  /** A list of associations that belong to this firewall policy. */
  associations?: BetaComputeBetaNetworkFirewallPolicy_Associations[] | Computed<BetaComputeBetaNetworkFirewallPolicy_Associations[]>;
  ...
  packetMirroringRules?: BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules[] | Computed<BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules[]>;
  ...
  rules?: BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules[] | Computed<BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules[]>;
...
export interface BetaComputeBetaNetworkFirewallPolicyAttrs {
  /** A list of associations that belong to this firewall policy. */
  associations: BetaComputeBetaNetworkFirewallPolicy_Associations[];
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  name: string;
  /** A list of packet mirroring rules that belong to this policy. */
  packetMirroringRules: BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules[];
  /** Output only. [Output Only] The parent of the firewall policy. This field is not applicable to network firewall policies. */
  parent: string;
  /** Indicates the source of this Firewall Policy. This field is optional on creation and defaults to USER_DEFINED. The USER_DEFINED value indicates a regular firewall policy. The SYSTEM value indicates a system-level policy managed by an internal service like GKE. This SYSTEM value is reserved for internal services and cannot be set by users during policy creation. Policies with a SYSTEM source cannot be modified or deleted by users. */
  policySource: string;
  ...
  /** A list of rules that belong to this policy. There must always be a default rule (rule with priority 2147483647 and match "*"). If no rules are provided when creating a firewall policy, a default rule with action "allow" will be added. */
  rules: BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRules[];
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource with the resource id. */
...
export const BetaComputeBetaNetworkFirewallPolicy: ResourceBinding<BetaComputeBetaNetworkFirewallPolicyConfig, BetaComputeBetaNetworkFirewallPolicyAttrs> = {
  wireType: "google_compute_beta_compute_beta_network_firewall_policy",
  fields: {
    associations: {
      wireName: "associations",
      kind: "list",
      fields: BetaComputeBetaNetworkFirewallPolicy_AssociationsFields,
    },
    ...
    packetMirroringRules: {
      ...
      kind: "list",
      fields: BetaComputeBetaNetworkFirewallPolicy_PacketMirroringRulesFields,
    },
    parent: "parent",
