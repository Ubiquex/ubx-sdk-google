// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_region_target_http_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaRegionTargetHttpProxyConfig {
...
export interface AlphaComputeAlphaRegionTargetHttpProxyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const AlphaComputeAlphaRegionTargetHttpProxy: ResourceBinding<AlphaComputeAlphaRegionTargetHttpProxyConfig, AlphaComputeAlphaRegionTargetHttpProxyAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_region_target_http_proxy",
  fields: {
