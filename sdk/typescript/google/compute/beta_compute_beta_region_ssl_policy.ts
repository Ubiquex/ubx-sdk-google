// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_region_ssl_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaRegionSslPolicy_Warnings_Data {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface BetaComputeBetaRegionSslPolicy_Warnings {
  code?: string | Computed<string>;
  data?: BetaComputeBetaRegionSslPolicy_Warnings_Data[] | Computed<BetaComputeBetaRegionSslPolicy_Warnings_Data[]>;
  message?: string | Computed<string>;
}

const BetaComputeBetaRegionSslPolicy_Warnings_DataFields: FieldMap = {
  key: "key",
  value: "value",
};

const BetaComputeBetaRegionSslPolicy_WarningsFields: FieldMap = {
  code: "code",
  data: {
    wireName: "data",
    kind: "list",
    fields: BetaComputeBetaRegionSslPolicy_Warnings_DataFields,
  },
  message: "message",
};

export interface BetaComputeBetaRegionSslPolicyConfig {
  ...
  warnings?: BetaComputeBetaRegionSslPolicy_Warnings[] | Computed<BetaComputeBetaRegionSslPolicy_Warnings[]>;
}

export interface BetaComputeBetaRegionSslPolicyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  selfLink: string;
  /** Output only. [Output Only] If potential misconfigurations are detected for this SSL policy, this field will be populated with warning messages. */
  warnings: BetaComputeBetaRegionSslPolicy_Warnings[];
}

export const BetaComputeBetaRegionSslPolicy: ResourceBinding<BetaComputeBetaRegionSslPolicyConfig, BetaComputeBetaRegionSslPolicyAttrs> = {
  wireType: "google_compute_beta_compute_beta_region_ssl_policy",
  fields: {
    ...
    warnings: {
      wireName: "warnings",
      kind: "list",
      fields: BetaComputeBetaRegionSslPolicy_WarningsFields,
    },
  },
};
