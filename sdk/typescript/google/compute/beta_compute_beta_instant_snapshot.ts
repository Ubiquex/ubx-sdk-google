// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_instant_snapshot. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaInstantSnapshot_Params {
...
export interface BetaComputeBetaInstantSnapshot_ResourceStatus {
  /** [Output Only] The storage size of this instant snapshot. */
  storageSizeBytes?: string | Computed<string>;
}

const BetaComputeBetaInstantSnapshot_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaComputeBetaInstantSnapshot_ResourceStatusFields: FieldMap = {
  storageSizeBytes: "storage_size_bytes",
};

export interface BetaComputeBetaInstantSnapshotConfig {
  ...
  params?: BetaComputeBetaInstantSnapshot_Params | Computed<BetaComputeBetaInstantSnapshot_Params>;
  ...
  resourceStatus?: BetaComputeBetaInstantSnapshot_ResourceStatus | Computed<BetaComputeBetaInstantSnapshot_ResourceStatus>;
...
export interface BetaComputeBetaInstantSnapshotAttrs {
  /** Output only. [Output Only] The architecture of the instant snapshot. Valid values are ARM64 or X86_64. */
  architecture: string;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  name: string;
  /** Additional instant snapshot params. */
  params: BetaComputeBetaInstantSnapshot_Params;
  /** Output only. [Output Only] URL of the region where the instant snapshot resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  resourceStatus: BetaComputeBetaInstantSnapshot_ResourceStatus;
  /** Output only. Reserved for future use. */
...
export const BetaComputeBetaInstantSnapshot: ResourceBinding<BetaComputeBetaInstantSnapshotConfig, BetaComputeBetaInstantSnapshotAttrs> = {
  wireType: "google_compute_beta_compute_beta_instant_snapshot",
  fields: {
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaComputeBetaInstantSnapshot_ParamsFields,
    },
    region: "region",
    resourceStatus: {
      wireName: "resource_status",
      kind: "object",
      fields: BetaComputeBetaInstantSnapshot_ResourceStatusFields,
    },
