// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_route. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaRoute_AsPaths {
  asLists?: number[] | Computed<number[]>;
  pathSegmentType?: string | Computed<string>;
}

export interface BetaComputeBetaRoute_Params {
...
export interface BetaComputeBetaRoute_Warnings_Data {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface BetaComputeBetaRoute_Warnings {
  code?: string | Computed<string>;
  data?: BetaComputeBetaRoute_Warnings_Data[] | Computed<BetaComputeBetaRoute_Warnings_Data[]>;
  message?: string | Computed<string>;
}

const BetaComputeBetaRoute_AsPathsFields: FieldMap = {
  asLists: "as_lists",
  pathSegmentType: "path_segment_type",
};

const BetaComputeBetaRoute_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaComputeBetaRoute_Warnings_DataFields: FieldMap = {
  key: "key",
  value: "value",
};

const BetaComputeBetaRoute_WarningsFields: FieldMap = {
  code: "code",
  data: {
    wireName: "data",
    kind: "list",
    fields: BetaComputeBetaRoute_Warnings_DataFields,
  },
  message: "message",
};

export interface BetaComputeBetaRouteConfig {
  /** Output only. [Output Only] AS path. */
  asPaths?: BetaComputeBetaRoute_AsPaths[] | Computed<BetaComputeBetaRoute_AsPaths[]>;
  ...
  params?: BetaComputeBetaRoute_Params | Computed<BetaComputeBetaRoute_Params>;
  ...
  warnings?: BetaComputeBetaRoute_Warnings[] | Computed<BetaComputeBetaRoute_Warnings[]>;
}

export interface BetaComputeBetaRouteAttrs {
  /** Output only. [Output Only] AS path. */
  asPaths: BetaComputeBetaRoute_AsPaths[];
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** Additional route parameters. */
  params: BetaComputeBetaRoute_Params;
  /** The priority of this route. Priority is used to break ties in cases where there is more than one matching route of equal prefix length. In cases where multiple routes have equal prefix length, the one with the lowest-numbered priority value wins. The default value is `1000`. The priority value must be from `0` to `65535`, inclusive. */
  priority: number;
  /** [Output only] The status of the route. This status applies to dynamic routes learned by Cloud Routers. It is also applicable to routes undergoing migration. */
  routeStatus: string;
  ...
  tags: string[];
  /** Output only. [Output Only] If potential misconfigurations are detected for this route, this field will be populated with warning messages. */
  warnings: BetaComputeBetaRoute_Warnings[];
}

export const BetaComputeBetaRoute: ResourceBinding<BetaComputeBetaRouteConfig, BetaComputeBetaRouteAttrs> = {
  wireType: "google_compute_beta_compute_beta_route",
  fields: {
    asPaths: {
      wireName: "as_paths",
      kind: "list",
      fields: BetaComputeBetaRoute_AsPathsFields,
    },
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaComputeBetaRoute_ParamsFields,
    },
    priority: "priority",
    ...
    warnings: {
      wireName: "warnings",
      kind: "list",
      fields: BetaComputeBetaRoute_WarningsFields,
    },
  },
};
