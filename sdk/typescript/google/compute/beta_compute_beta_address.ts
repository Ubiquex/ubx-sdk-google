// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_address. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaAddressConfig {
...
export interface BetaComputeBetaAddressAttrs {
  /** The static IP address represented by this resource. */
  address: string;
  /** The type of address to reserve, either INTERNAL orEXTERNAL. If unspecified, defaults to EXTERNAL. */
  addressType: string;
...
export const BetaComputeBetaAddress: ResourceBinding<BetaComputeBetaAddressConfig, BetaComputeBetaAddressAttrs> = {
  wireType: "google_compute_beta_compute_beta_address",
  fields: {
    address: "address",
