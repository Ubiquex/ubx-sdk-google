...
export interface AlphaComputeAlphaNetworkAttachment_ConnectionEndpoints {
...
const AlphaComputeAlphaNetworkAttachment_ConnectionEndpointsFields: FieldMap = {
...
export interface AlphaComputeAlphaNetworkAttachmentConfig {
  /** Output only. [Output Only] An array of connections for all the producers connected to this network attachment. */
  connectionEndpoints?: AlphaComputeAlphaNetworkAttachment_ConnectionEndpoints[] | Computed<AlphaComputeAlphaNetworkAttachment_ConnectionEndpoints[]>;
...
export interface AlphaComputeAlphaNetworkAttachmentAttrs {
  /** Output only. [Output Only] An array of connections for all the producers connected to this network attachment. */
  connectionEndpoints: AlphaComputeAlphaNetworkAttachment_ConnectionEndpoints[];
...
export const AlphaComputeAlphaNetworkAttachment: ResourceBinding<AlphaComputeAlphaNetworkAttachmentConfig, AlphaComputeAlphaNetworkAttachmentAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_network_attachment",
  fields: {
    connectionEndpoints: {
      wireName: "connection_endpoints",
      kind: "list",
      fields: AlphaComputeAlphaNetworkAttachment_ConnectionEndpointsFields,
    },
