// Code generated by `ubx sdk gen` from google_compute_beta_license. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaLicense_MinimumRetention {
...
export interface BetaLicense_Params {
...
export interface BetaLicense_ResourceRequirements {
...
const BetaLicense_MinimumRetentionFields: FieldMap = {
  nanos: "nanos",
  seconds: "seconds",
};

const BetaLicense_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaLicense_ResourceRequirementsFields: FieldMap = {
  minGuestCpuCount: "min_guest_cpu_count",
  minMemoryMb: "min_memory_mb",
};

export interface BetaLicenseConfig {
  ...
  minimumRetention?: BetaLicense_MinimumRetention | Computed<BetaLicense_MinimumRetention>;
  ...
  params?: BetaLicense_Params | Computed<BetaLicense_Params>;
  ...
  resourceRequirements?: BetaLicense_ResourceRequirements | Computed<BetaLicense_ResourceRequirements>;
...
export interface BetaLicenseAttrs {
  /** Specifies licenseCodes of licenses that can replace this license. Note: such replacements are allowed even if removable_from_disk is false. */
  ...
  licenseCode: string;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  minimumRetention: BetaLicense_MinimumRetention;
  /** If true, this license can only be used on VMs on multi tenant nodes. */
  ...
  osLicense: boolean;
  /** Additional license params. */
  params: BetaLicense_Params;
  /** If true, this license can be removed from a disk's set of licenses, with no replacement license needed. */
  removableFromDisk: boolean;
  /** Specifies the set of permissible coattached licenseCodes of licenses that satisfy the coattachment requirement of this license. At least one license from the set must be attached to the same disk or image as this license. */
  requiredCoattachedLicenses: string[];
  resourceRequirements: BetaLicense_ResourceRequirements;
  /** Output only. [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource with the resource id. */
...
export const BetaLicense: ResourceBinding<BetaLicenseConfig, BetaLicenseAttrs> = {
  wireType: "google_compute_beta_license",
  fields: {
    ...
    minimumRetention: {
      ...
      kind: "object",
      fields: BetaLicense_MinimumRetentionFields,
    },
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaLicense_ParamsFields,
    },
    ...
    resourceRequirements: {
      ...
      kind: "object",
      fields: BetaLicense_ResourceRequirementsFields,
    },
    selfLink: "self_link",
