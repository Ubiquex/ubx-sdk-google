...
export interface BetaComputeBetaRegionCompositeHealthCheckConfig {
...
export interface BetaComputeBetaRegionCompositeHealthCheckAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaComputeBetaRegionCompositeHealthCheck: ResourceBinding<BetaComputeBetaRegionCompositeHealthCheckConfig, BetaComputeBetaRegionCompositeHealthCheckAttrs> = {
  wireType: "google_compute_beta_compute_beta_region_composite_health_check",
  fields: {
