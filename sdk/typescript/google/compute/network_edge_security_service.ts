...
export interface NetworkEdgeSecurityServiceConfig {
...
export interface NetworkEdgeSecurityServiceAttrs {
...
export const NetworkEdgeSecurityService: ResourceBinding<NetworkEdgeSecurityServiceConfig, NetworkEdgeSecurityServiceAttrs> = {
