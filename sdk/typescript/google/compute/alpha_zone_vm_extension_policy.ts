// Code generated by `ubx sdk gen` from google_compute_alpha_zone_vm_extension_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors {
  allOfSelectors?: string[] | Computed<string[]>;
}

export interface AlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector {
  anyOfSelectors?: Record<string, AlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors> | Computed<Record<string, AlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors>>;
}

export interface AlphaZoneVmExtensionPolicy_ExtensionPolicies {
  installedSoftwareSelector?: AlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector | Computed<AlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector>;
  pinnedVersion?: string | Computed<string>;
  stringConfig?: string | Computed<string>;
}

export interface AlphaZoneVmExtensionPolicy_InstanceSelectors_LabelSelector {
  inclusionLabels?: Record<string, string> | Computed<Record<string, string>>;
}

export interface AlphaZoneVmExtensionPolicy_InstanceSelectors {
  labelSelector?: AlphaZoneVmExtensionPolicy_InstanceSelectors_LabelSelector | Computed<AlphaZoneVmExtensionPolicy_InstanceSelectors_LabelSelector>;
}

const AlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectorsFields: FieldMap = {
  allOfSelectors: "all_of_selectors",
};

const AlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelectorFields: FieldMap = {
  anyOfSelectors: {
    wireName: "any_of_selectors",
    kind: "map",
    fields: AlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectorsFields,
  },
};

const AlphaZoneVmExtensionPolicy_ExtensionPoliciesFields: FieldMap = {
  installedSoftwareSelector: {
    wireName: "installed_software_selector",
    kind: "object",
    fields: AlphaZoneVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelectorFields,
  },
  pinnedVersion: "pinned_version",
  stringConfig: "string_config",
};

const AlphaZoneVmExtensionPolicy_InstanceSelectors_LabelSelectorFields: FieldMap = {
  inclusionLabels: "inclusion_labels",
};

const AlphaZoneVmExtensionPolicy_InstanceSelectorsFields: FieldMap = {
  labelSelector: {
    wireName: "label_selector",
    kind: "object",
    fields: AlphaZoneVmExtensionPolicy_InstanceSelectors_LabelSelectorFields,
  },
};
...
export interface AlphaZoneVmExtensionPolicyAttrs {
  ...
  description: string;
  /** Required. A map of extension names (for example, "ops-agent") to their corresponding policy configurations. */
  extensionPolicies: Record<string, AlphaZoneVmExtensionPolicy_ExtensionPolicies>;
  /** Optional. Output only. [Output Only] Link to the global policy that manages this zone policy, if applicable. */
  globalResourceLink: string;
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  /** Optional. Selectors to target VMs for this policy. VMs are selected if they match *any* of the provided selectors (logical OR). If this list is empty, the policy applies to all VMs. */
  instanceSelectors: AlphaZoneVmExtensionPolicy_InstanceSelectors[];
  /** Output only. [Output Only] Type of the resource. Alwayscompute#vmExtensionPolicy. */
  kind: string;
  /** Optional. Output only. [Output Only] Indicates if this policy is managed by a global policy. */
