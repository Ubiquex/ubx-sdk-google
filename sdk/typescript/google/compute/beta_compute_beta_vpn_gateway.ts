// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_vpn_gateway. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaVpnGateway_Params {
...
export interface BetaComputeBetaVpnGateway_VpnInterfaces {
...
const BetaComputeBetaVpnGateway_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaComputeBetaVpnGateway_VpnInterfacesFields: FieldMap = {
  id: "id",
...
export interface BetaComputeBetaVpnGatewayConfig {
  ...
  params?: BetaComputeBetaVpnGateway_Params | Computed<BetaComputeBetaVpnGateway_Params>;
  ...
  vpnInterfaces?: BetaComputeBetaVpnGateway_VpnInterfaces[] | Computed<BetaComputeBetaVpnGateway_VpnInterfaces[]>;
}

export interface BetaComputeBetaVpnGatewayAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** URL of the network to which this VPN gateway is attached. Provided by the client when the VPN gateway is created. */
  network: string;
  params: BetaComputeBetaVpnGateway_Params;
  /** Output only. [Output Only] URL of the region where the VPN gateway resides. */
  region: string;
  /** Output only. [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  ...
  stackType: string;
  /** The list of VPN interfaces associated with this VPN gateway. */
  vpnInterfaces: BetaComputeBetaVpnGateway_VpnInterfaces[];
}

export const BetaComputeBetaVpnGateway: ResourceBinding<BetaComputeBetaVpnGatewayConfig, BetaComputeBetaVpnGatewayAttrs> = {
  wireType: "google_compute_beta_compute_beta_vpn_gateway",
  fields: {
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaComputeBetaVpnGateway_ParamsFields,
    },
    region: "region",
    selfLink: "self_link",
    ...
    vpnInterfaces: {
      ...
      kind: "list",
      fields: BetaComputeBetaVpnGateway_VpnInterfacesFields,
    },
  },
};
