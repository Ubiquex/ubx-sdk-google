// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_region_snapshot. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaRegionSnapshot_GuestOsFeatures {
  type?: string | Computed<string>;
}

export interface AlphaComputeAlphaRegionSnapshot_Params {
...
export interface AlphaComputeAlphaRegionSnapshot_ResourceStatus {
  ...
  scheduledDeletionTime?: string | Computed<string>;
}

export interface AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKey {
...
const AlphaComputeAlphaRegionSnapshot_GuestOsFeaturesFields: FieldMap = {
  type: "type",
};

const AlphaComputeAlphaRegionSnapshot_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaComputeAlphaRegionSnapshot_ResourceStatusFields: FieldMap = {
  scheduledDeletionTime: "scheduled_deletion_time",
};

const AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKeyFields: FieldMap = {
...
export interface AlphaComputeAlphaRegionSnapshotConfig {
  ...
  guestOsFeatures?: AlphaComputeAlphaRegionSnapshot_GuestOsFeatures[] | Computed<AlphaComputeAlphaRegionSnapshot_GuestOsFeatures[]>;
  ...
  params?: AlphaComputeAlphaRegionSnapshot_Params | Computed<AlphaComputeAlphaRegionSnapshot_Params>;
  /** Output only. [Output Only] URL of the region where the snapshot resides. Only applicable for regional snapshots. */
  region?: string | Computed<string>;
  resourceStatus?: AlphaComputeAlphaRegionSnapshot_ResourceStatus | Computed<AlphaComputeAlphaRegionSnapshot_ResourceStatus>;
  ...
  snapshotEncryptionKey?: AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKey | Computed<AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKey>;
  ...
  sourceDiskEncryptionKey?: AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKey | Computed<AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKey>;
  ...
  sourceInstantSnapshotEncryptionKey?: AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKey | Computed<AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKey>;
...
export interface AlphaComputeAlphaRegionSnapshotAttrs {
  /** Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64. */
  architecture: string;
  /** Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk. */
  autoCreated: boolean;
  ...
  guestFlush: boolean;
  /** Output only. [Output Only] A list of features to enable on the guest operating system. Applicable only for bootable images. Read Enabling guest operating system features to see a list of available options. */
  guestOsFeatures: AlphaComputeAlphaRegionSnapshot_GuestOsFeatures[];
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  /** Output only. [Output Only] Type of the resource. Always compute#snapshot for Snapshot resources. */
  kind: string;
  ...
  name: string;
  /** Additional snapshot params. */
  params: AlphaComputeAlphaRegionSnapshot_Params;
  /** Output only. [Output Only] URL of the region where the snapshot resides. Only applicable for regional snapshots. */
  region: string;
  resourceStatus: AlphaComputeAlphaRegionSnapshot_ResourceStatus;
  /** Output only. Reserved for future use. */
  ...
  snapshotEncryptionKey: AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKey;
  /** Output only. [Output Only] The unique ID of the snapshot group that this snapshot belongs to. The usage of snapshot group feature is restricted. */
  ...
  /** The source disk used to create this snapshot. */
  sourceDisk: string;
  sourceDiskEncryptionKey: AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKey;
  /** The source disk whose recovery checkpoint will be used to create this snapshot. */
  ...
  sourceInstantSnapshotEncryptionKey: AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKey;
  /** Output only. [Output Only] The unique ID of the instant snapshot used to create this snapshot. This value identifies the exact instant snapshot that was used to create this snapshot. For example, if you created the snapshot from an instant snapshot that was later deleted and recreated under the same name, the source instant snapshot ID would identify the exact instant snapshot that was used. */
...
export const AlphaComputeAlphaRegionSnapshot: ResourceBinding<AlphaComputeAlphaRegionSnapshotConfig, AlphaComputeAlphaRegionSnapshotAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_region_snapshot",
  fields: {
    ...
    guestOsFeatures: {
      ...
      kind: "list",
      fields: AlphaComputeAlphaRegionSnapshot_GuestOsFeaturesFields,
    },
    id: "id",
    kind: "kind",
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: AlphaComputeAlphaRegionSnapshot_ParamsFields,
    },
    region: "region",
    resourceStatus: {
      wireName: "resource_status",
      kind: "object",
      fields: AlphaComputeAlphaRegionSnapshot_ResourceStatusFields,
    },
    ...
    snapshotEncryptionKey: {
      ...
      kind: "object",
      fields: AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKeyFields,
    },
