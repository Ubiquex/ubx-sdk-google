...
export interface BetaAddressConfig {
...
export interface BetaAddressAttrs {
  /** The static IP address represented by this resource. */
  address: string;
  /** The type of address to reserve, either INTERNAL orEXTERNAL. If unspecified, defaults to EXTERNAL. */
  addressType: string;
...
export const BetaAddress: ResourceBinding<BetaAddressConfig, BetaAddressAttrs> = {
  wireType: "google_compute_beta_address",
  fields: {
    address: "address",
