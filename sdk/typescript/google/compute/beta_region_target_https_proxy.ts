// Code generated by `ubx sdk gen` from google_compute_beta_region_target_https_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaRegionTargetHttpsProxyConfig {
...
export interface BetaRegionTargetHttpsProxyAttrs {
  /** [Deprecated] Use serverTlsPolicy instead. */
...
export const BetaRegionTargetHttpsProxy: ResourceBinding<BetaRegionTargetHttpsProxyConfig, BetaRegionTargetHttpsProxyAttrs> = {
  wireType: "google_compute_beta_region_target_https_proxy",
  fields: {
