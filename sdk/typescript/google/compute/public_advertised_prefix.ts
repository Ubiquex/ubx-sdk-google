...
const PublicAdvertisedPrefix_PublicDelegatedPrefixsFields: FieldMap = {
  ipRange: "ip_range",
  name: "name",
  project: "project",
  region: "region",
...
export interface PublicAdvertisedPrefixConfig {
  ...
  publicDelegatedPrefixs?: PublicAdvertisedPrefix_PublicDelegatedPrefixs[] | Computed<PublicAdvertisedPrefix_PublicDelegatedPrefixs[]>;
...
export interface PublicAdvertisedPrefixAttrs {
  ...
  pdpScope: string;
  /** Output only. [Output Only] The list of public delegated prefixes that exist for this public advertised prefix. */
  publicDelegatedPrefixs: PublicAdvertisedPrefix_PublicDelegatedPrefixs[];
  /** Output only. [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** [Output Only] The shared secret to be used for reverse DNS verification. */
  sharedSecret: string;
