...
export interface BetaRegionHealthSourceConfig {
...
export interface BetaRegionHealthSourceAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaRegionHealthSource: ResourceBinding<BetaRegionHealthSourceConfig, BetaRegionHealthSourceAttrs> = {
  wireType: "google_compute_beta_region_health_source",
  fields: {
