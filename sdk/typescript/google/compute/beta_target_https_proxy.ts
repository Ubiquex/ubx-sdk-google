...
export interface BetaTargetHttpsProxyConfig {
...
export interface BetaTargetHttpsProxyAttrs {
  /** [Deprecated] Use serverTlsPolicy instead. */
...
export const BetaTargetHttpsProxy: ResourceBinding<BetaTargetHttpsProxyConfig, BetaTargetHttpsProxyAttrs> = {
  wireType: "google_compute_beta_target_https_proxy",
  fields: {
