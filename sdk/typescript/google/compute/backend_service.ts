...
export interface BackendService_CdnPolicy {
  ...
  bypassCacheOnRequestHeaders?: BackendService_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<BackendService_CdnPolicy_BypassCacheOnRequestHeaders[]>;
  /** Message containing what to include in the cache key for a request for Cloud CDN. */
  cacheKeyPolicy?: BackendService_CdnPolicy_CacheKeyPolicy | Computed<BackendService_CdnPolicy_CacheKeyPolicy>;
  ...
  negativeCachingPolicy?: BackendService_CdnPolicy_NegativeCachingPolicy[] | Computed<BackendService_CdnPolicy_NegativeCachingPolicy[]>;
...
export interface BackendService_ConnectionDraining {
...
export interface BackendService_ConnectionTrackingPolicy {
...
export interface BackendService_ConsistentHash_HttpCookie {
  ...
  ttl?: BackendService_ConsistentHash_HttpCookie_Ttl | Computed<BackendService_ConsistentHash_HttpCookie_Ttl>;
}

export interface BackendService_ConsistentHash {
  /** The information about the HTTP Cookie on which the hash function is based for load balancing policies that use a consistent hash. */
  httpCookie?: BackendService_ConsistentHash_HttpCookie | Computed<BackendService_ConsistentHash_HttpCookie>;
...
export interface BackendService_FailoverPolicy {
...
export interface BackendService_HaPolicy_Leader_NetworkEndpoint {
...
export interface BackendService_HaPolicy {
  ...
  leader?: BackendService_HaPolicy_Leader | Computed<BackendService_HaPolicy_Leader>;
}
...
export interface BackendService_LogConfig {
  ...
  loggingHttpRequestHeaders?: BackendService_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<BackendService_CdnPolicy_BypassCacheOnRequestHeaders[]>;
  /** The list of response headers that will be logged to Stackdriver. */
  loggingHttpResponseHeaders?: BackendService_CdnPolicy_BypassCacheOnRequestHeaders[] | Computed<BackendService_CdnPolicy_BypassCacheOnRequestHeaders[]>;
...
export interface BackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity {
...
export interface BackendService_OutlierDetection {
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  baseEjectionTime?: BackendService_ConsistentHash_HttpCookie_Ttl | Computed<BackendService_ConsistentHash_HttpCookie_Ttl>;
  ...
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  interval?: BackendService_ConsistentHash_HttpCookie_Ttl | Computed<BackendService_ConsistentHash_HttpCookie_Ttl>;
...
export interface BackendService_SecuritySettings {
  ...
  awsV4Authentication?: BackendService_SecuritySettings_AwsV4Authentication | Computed<BackendService_SecuritySettings_AwsV4Authentication>;
...
export interface BackendService_TlsSettings {
  ...
  subjectAltNames?: BackendService_TlsSettings_SubjectAltNames[] | Computed<BackendService_TlsSettings_SubjectAltNames[]>;
}
...
const BackendService_Backends_CustomMetricsFields: FieldMap = {
  dryRun: "dry_run",
  maxUtilization: "max_utilization",
  name: "name",
};

const BackendService_Backends_OrchestrationInfoFields: FieldMap = {
  resourceUri: "resource_uri",
};

const BackendService_BackendsFields: FieldMap = {
...
const BackendService_ConnectionDrainingFields: FieldMap = {
  drainingTimeoutSec: "draining_timeout_sec",
};

const BackendService_ConnectionTrackingPolicyFields: FieldMap = {
...
const BackendService_FailoverPolicyFields: FieldMap = {
...
const BackendService_HaPolicy_Leader_NetworkEndpointFields: FieldMap = {
  instance: "instance",
};

const BackendService_HaPolicy_LeaderFields: FieldMap = {
...
const BackendService_HaPolicyFields: FieldMap = {
...
const BackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinityFields: FieldMap = {
  spillover: "spillover",
  spilloverRatio: "spillover_ratio",
};

const BackendService_NetworkPassThroughLbTrafficPolicyFields: FieldMap = {
  zonalAffinity: {
...
const BackendService_SubsettingFields: FieldMap = {
  policy: "policy",
};
...
const BackendService_UsedByFields: FieldMap = {
  reference: "reference",
};
...
export interface BackendServiceConfig {
  ...
  backends?: BackendService_Backends[] | Computed<BackendService_Backends[]>;
  ...
  connectionDraining?: BackendService_ConnectionDraining | Computed<BackendService_ConnectionDraining>;
  /** Connection Tracking configuration for this BackendService. */
  connectionTrackingPolicy?: BackendService_ConnectionTrackingPolicy | Computed<BackendService_ConnectionTrackingPolicy>;
  ...
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  maxStreamDuration?: BackendService_ConsistentHash_HttpCookie_Ttl | Computed<BackendService_ConsistentHash_HttpCookie_Ttl>;
  ...
  usedBy?: BackendService_UsedBy[] | Computed<BackendService_UsedBy[]>;
}
...
export interface BackendServiceAttrs {
  ...
  /** The list of backends that serve this BackendService. */
  backends: BackendService_Backends[];
  /** Message containing Cloud CDN configuration for a backend service. */
  ...
  /** Message containing connection draining configuration. */
  connectionDraining: BackendService_ConnectionDraining;
  /** Connection Tracking configuration for this BackendService. */
  connectionTrackingPolicy: BackendService_ConnectionTrackingPolicy;
  /** This message defines settings for a consistent hash style load balancer. */
  ...
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  maxStreamDuration: BackendService_ConsistentHash_HttpCookie_Ttl;
  /** Deployment metadata associated with the resource to be set by a GKE hub controller and read by the backend RCTH */
...
export const BackendService: ResourceBinding<BackendServiceConfig, BackendServiceAttrs> = {
  ...
  fields: {
    ...
    usedBy: {
      wireName: "used_by",
      kind: "list",
      fields: BackendService_UsedByFields,
    },
  },
};
