...
export interface AlphaRouter_Bgp_AdvertisedIpRanges {
  description?: string | Computed<string>;
  range?: string | Computed<string>;
}

export interface AlphaRouter_Bgp {
  ...
  advertisedIpRanges?: AlphaRouter_Bgp_AdvertisedIpRanges[] | Computed<AlphaRouter_Bgp_AdvertisedIpRanges[]>;
...
export interface AlphaRouter_BgpPeers_Bfd {
...
export interface AlphaRouter_BgpPeers_CustomLearnedIpRanges {
  range?: string | Computed<string>;
}

export interface AlphaRouter_BgpPeers {
  advertiseMode?: string | Computed<string>;
  advertisedGroups?: string[] | Computed<string[]>;
  advertisedIpRanges?: AlphaRouter_Bgp_AdvertisedIpRanges[] | Computed<AlphaRouter_Bgp_AdvertisedIpRanges[]>;
  advertisedRoutePriority?: number | Computed<number>;
  bfd?: AlphaRouter_BgpPeers_Bfd | Computed<AlphaRouter_BgpPeers_Bfd>;
  customLearnedIpRanges?: AlphaRouter_BgpPeers_CustomLearnedIpRanges[] | Computed<AlphaRouter_BgpPeers_CustomLearnedIpRanges[]>;
...
export interface AlphaRouter_Interfaces {
...
export interface AlphaRouter_Md5AuthenticationKeys {
  key?: string | Computed<string>;
  name?: string | Computed<string>;
}

export interface AlphaRouter_Nats_LogConfig {
  enable?: boolean | Computed<boolean>;
  filter?: string | Computed<string>;
}

export interface AlphaRouter_Nats_Nat64Subnetworks {
  name?: string | Computed<string>;
}

export interface AlphaRouter_Nats_Rules_Action {
...
export interface AlphaRouter_Nats_Rules {
  action?: AlphaRouter_Nats_Rules_Action | Computed<AlphaRouter_Nats_Rules_Action>;
  description?: string | Computed<string>;
...
export interface AlphaRouter_Nats {
  ...
  logConfig?: AlphaRouter_Nats_LogConfig | Computed<AlphaRouter_Nats_LogConfig>;
  maxPortsPerVm?: number | Computed<number>;
  minPortsPerVm?: number | Computed<number>;
  name?: string | Computed<string>;
  nat64Subnetworks?: AlphaRouter_Nats_Nat64Subnetworks[] | Computed<AlphaRouter_Nats_Nat64Subnetworks[]>;
  natIpAllocateOption?: string | Computed<string>;
  natIps?: string[] | Computed<string[]>;
  rules?: AlphaRouter_Nats_Rules[] | Computed<AlphaRouter_Nats_Rules[]>;
  sourceSubnetworkIpRangesToNat?: string | Computed<string>;
  sourceSubnetworkIpRangesToNat64?: string | Computed<string>;
  subnetworks?: AlphaRouter_Nats_Subnetworks[] | Computed<AlphaRouter_Nats_Subnetworks[]>;
...
export interface AlphaRouter_Params {
...
const AlphaRouter_Bgp_AdvertisedIpRangesFields: FieldMap = {
  description: "description",
  range: "range",
};

const AlphaRouter_BgpFields: FieldMap = {
  advertiseMode: "advertise_mode",
  advertisedGroups: "advertised_groups",
  advertisedIpRanges: {
    wireName: "advertised_ip_ranges",
    kind: "list",
    fields: AlphaRouter_Bgp_AdvertisedIpRangesFields,
  },
  asn: "asn",
...
const AlphaRouter_BgpPeers_BfdFields: FieldMap = {
...
const AlphaRouter_BgpPeers_CustomLearnedIpRangesFields: FieldMap = {
  range: "range",
};

const AlphaRouter_BgpPeersFields: FieldMap = {
  advertiseMode: "advertise_mode",
  advertisedGroups: "advertised_groups",
  advertisedIpRanges: {
    wireName: "advertised_ip_ranges",
  ...
  bfd: {
    wireName: "bfd",
    kind: "object",
    fields: AlphaRouter_BgpPeers_BfdFields,
  },
  customLearnedIpRanges: {
    wireName: "custom_learned_ip_ranges",
    kind: "list",
    fields: AlphaRouter_BgpPeers_CustomLearnedIpRangesFields,
  },
...
const AlphaRouter_InterfacesFields: FieldMap = {
  ipRange: "ip_range",
...
const AlphaRouter_Md5AuthenticationKeysFields: FieldMap = {
  key: "key",
  name: "name",
};

const AlphaRouter_Nats_LogConfigFields: FieldMap = {
  enable: "enable",
  filter: "filter",
};

const AlphaRouter_Nats_Nat64SubnetworksFields: FieldMap = {
  name: "name",
};

const AlphaRouter_Nats_Rules_ActionFields: FieldMap = {
...
const AlphaRouter_Nats_RulesFields: FieldMap = {
  action: {
    wireName: "action",
    kind: "object",
    fields: AlphaRouter_Nats_Rules_ActionFields,
  },
  description: "description",
  match: "match",
...
const AlphaRouter_NatsFields: FieldMap = {
  ...
  logConfig: {
    wireName: "log_config",
    kind: "object",
    fields: AlphaRouter_Nats_LogConfigFields,
  },
  ...
  nat64Subnetworks: {
    ...
    kind: "list",
    fields: AlphaRouter_Nats_Nat64SubnetworksFields,
  },
  ...
  rules: {
    wireName: "rules",
    kind: "list",
    fields: AlphaRouter_Nats_RulesFields,
  },
  ...
  subnetworks: {
    ...
    kind: "list",
    fields: AlphaRouter_Nats_SubnetworksFields,
  },
...
const AlphaRouter_ParamsFields: FieldMap = {
...
export interface AlphaRouterConfig {
  ...
  nats?: AlphaRouter_Nats[] | Computed<AlphaRouter_Nats[]>;
  ...
  params?: AlphaRouter_Params | Computed<AlphaRouter_Params>;
...
export interface AlphaRouterAttrs {
  ...
  id: string;
  /** Router interfaces. To create a BGP peer that uses a router interface, the interface must have one of the following fields specified: - linkedVpnTunnel - linkedInterconnectAttachment - subnetwork You can create a router interface without any of these fields specified. However, you cannot create a BGP peer that uses that interface. */
  interfaces: AlphaRouter_Interfaces[];
  /** Output only. [Output Only] Type of resource. Always compute#router for routers. */
  kind: string;
  /** Keys used for MD5 authentication. */
  md5AuthenticationKeys: AlphaRouter_Md5AuthenticationKeys[];
  /** Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and comply withRFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash. */
  name: string;
  /** A list of NAT services created in this router. */
  nats: AlphaRouter_Nats[];
  /** URI of the ncc_gateway to which this router associated. */
  nccGateway: string;
  /** URI of the network to which this router belongs. */
  network: string;
  /** Additional router parameters. */
  params: AlphaRouter_Params;
  /** [Output Only] URI of the region where the router resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
...
export const AlphaRouter: ResourceBinding<AlphaRouterConfig, AlphaRouterAttrs> = {
  wireType: "google_compute_alpha_router",
  fields: {
    bgp: {
      wireName: "bgp",
      kind: "object",
      fields: AlphaRouter_BgpFields,
    },
    bgpPeers: {
      wireName: "bgp_peers",
      kind: "list",
    ...
    md5AuthenticationKeys: {
      ...
      kind: "list",
      fields: AlphaRouter_Md5AuthenticationKeysFields,
    },
    name: "name",
    nats: {
      wireName: "nats",
      kind: "list",
      fields: AlphaRouter_NatsFields,
    },
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: AlphaRouter_ParamsFields,
    },
    region: "region",
    selfLink: "self_link",
  },
