...
export interface BetaSslPolicy_Warnings_Data {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface BetaSslPolicy_Warnings {
  code?: string | Computed<string>;
  data?: BetaSslPolicy_Warnings_Data[] | Computed<BetaSslPolicy_Warnings_Data[]>;
...
export interface BetaSslPolicyAttrs {
  ...
  warnings: BetaSslPolicy_Warnings[];
}
