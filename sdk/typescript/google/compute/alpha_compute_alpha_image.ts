// Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_image. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaComputeAlphaImage_Deprecated_StateOverride {
...
export interface AlphaComputeAlphaImage_Deprecated {
  ...
  stateOverride?: AlphaComputeAlphaImage_Deprecated_StateOverride | Computed<AlphaComputeAlphaImage_Deprecated_StateOverride>;
}

export interface AlphaComputeAlphaImage_GuestOsFeatures {
  type?: string | Computed<string>;
}

export interface AlphaComputeAlphaImage_ImageEncryptionKey {
...
export interface AlphaComputeAlphaImage_Params {
...
export interface AlphaComputeAlphaImage_RawDisk {
...
export interface AlphaComputeAlphaImage_ShieldedInstanceInitialState_Dbs {
  content?: string | Computed<string>;
  fileType?: string | Computed<string>;
}

export interface AlphaComputeAlphaImage_ShieldedInstanceInitialState {
  /** The Key Database (db). */
  dbs?: AlphaComputeAlphaImage_ShieldedInstanceInitialState_Dbs[] | Computed<AlphaComputeAlphaImage_ShieldedInstanceInitialState_Dbs[]>;
  /** The forbidden key database (dbx). */
  dbxs?: AlphaComputeAlphaImage_ShieldedInstanceInitialState_Dbs[] | Computed<AlphaComputeAlphaImage_ShieldedInstanceInitialState_Dbs[]>;
  /** The Key Exchange Key (KEK). */
  keks?: AlphaComputeAlphaImage_ShieldedInstanceInitialState_Dbs[] | Computed<AlphaComputeAlphaImage_ShieldedInstanceInitialState_Dbs[]>;
  pk?: AlphaComputeAlphaImage_ShieldedInstanceInitialState_Dbs | Computed<AlphaComputeAlphaImage_ShieldedInstanceInitialState_Dbs>;
}

const AlphaComputeAlphaImage_Deprecated_StateOverrideFields: FieldMap = {
  defaultRolloutTime: "default_rollout_time",
  locationRolloutPolicies: "location_rollout_policies",
};

const AlphaComputeAlphaImage_DeprecatedFields: FieldMap = {
  deleted: "deleted",
  ...
  stateOverride: {
    ...
    kind: "object",
    fields: AlphaComputeAlphaImage_Deprecated_StateOverrideFields,
  },
};

const AlphaComputeAlphaImage_GuestOsFeaturesFields: FieldMap = {
  type: "type",
};

const AlphaComputeAlphaImage_ImageEncryptionKeyFields: FieldMap = {
...
const AlphaComputeAlphaImage_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaComputeAlphaImage_RawDiskFields: FieldMap = {
  containerType: "container_type",
  sha1Checksum: "sha1_checksum",
  source: "source",
};

const AlphaComputeAlphaImage_ShieldedInstanceInitialState_DbsFields: FieldMap = {
  content: "content",
  fileType: "file_type",
};

const AlphaComputeAlphaImage_ShieldedInstanceInitialStateFields: FieldMap = {
  dbs: {
    wireName: "dbs",
    kind: "list",
    fields: AlphaComputeAlphaImage_ShieldedInstanceInitialState_DbsFields,
  },
  dbxs: {
    wireName: "dbxs",
    kind: "list",
...
export interface AlphaComputeAlphaImageConfig {
  ...
  deprecated?: AlphaComputeAlphaImage_Deprecated | Computed<AlphaComputeAlphaImage_Deprecated>;
  ...
  guestOsFeatures?: AlphaComputeAlphaImage_GuestOsFeatures[] | Computed<AlphaComputeAlphaImage_GuestOsFeatures[]>;
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id?: string | Computed<string>;
  imageEncryptionKey?: AlphaComputeAlphaImage_ImageEncryptionKey | Computed<AlphaComputeAlphaImage_ImageEncryptionKey>;
  ...
  params?: AlphaComputeAlphaImage_Params | Computed<AlphaComputeAlphaImage_Params>;
  /** The parameters of the raw disk image. */
  rawDisk?: AlphaComputeAlphaImage_RawDisk | Computed<AlphaComputeAlphaImage_RawDisk>;
  /** A rollout policy configuration. */
  rolloutOverride?: AlphaComputeAlphaImage_Deprecated_StateOverride | Computed<AlphaComputeAlphaImage_Deprecated_StateOverride>;
  ...
  shieldedInstanceInitialState?: AlphaComputeAlphaImage_ShieldedInstanceInitialState | Computed<AlphaComputeAlphaImage_ShieldedInstanceInitialState>;
  /** URL of the source disk used to create this image. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone/disks/disk - projects/project/zones/zone/disks/disk - zones/zone/disks/disk In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceDisk?: string | Computed<string>;
  sourceDiskEncryptionKey?: AlphaComputeAlphaImage_ImageEncryptionKey | Computed<AlphaComputeAlphaImage_ImageEncryptionKey>;
  ...
  sourceImageEncryptionKey?: AlphaComputeAlphaImage_ImageEncryptionKey | Computed<AlphaComputeAlphaImage_ImageEncryptionKey>;
  ...
  sourceSnapshotEncryptionKey?: AlphaComputeAlphaImage_ImageEncryptionKey | Computed<AlphaComputeAlphaImage_ImageEncryptionKey>;
...
export interface AlphaComputeAlphaImageAttrs {
  /** The architecture of the image. Valid values are ARM64 or X86_64. */
  architecture: string;
  /** Size of the image tar.gz archive stored in Google Cloud Storage (in bytes). */
  ...
  /** Deprecation status for a public resource. */
  deprecated: AlphaComputeAlphaImage_Deprecated;
  /** An optional description of this resource. Provide this property when you create the resource. */
  description: string;
  /** Size of the image when restored onto a persistent disk (in GB). */
  diskSizeGb: string;
  ...
  family: string;
  /** A list of features to enable on the guest operating system. Applicable only for bootable images. To see a list of available options, see theguestOSfeatures[].type parameter. */
  guestOsFeatures: AlphaComputeAlphaImage_GuestOsFeatures[];
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  imageEncryptionKey: AlphaComputeAlphaImage_ImageEncryptionKey;
  /** Output only. [Output Only] Type of the resource. Always compute#image for images. */
  kind: string;
  /** A fingerprint for the labels being applied to this image, which is essentially a hash of the labels used for optimistic locking. The fingerprint is initially generated by Compute Engine and changes after every request to modify or update labels. You must always provide an up-to-date fingerprint hash in order to update or change labels, otherwise the request will fail with error412 conditionNotMet. To see the latest fingerprint, make a get() request to retrieve an image. */
  ...
  name: string;
  /** Additional image params. */
  params: AlphaComputeAlphaImage_Params;
  /** The parameters of the raw disk image. */
  rawDisk: AlphaComputeAlphaImage_RawDisk;
  /** A rollout policy configuration. */
  rolloutOverride: AlphaComputeAlphaImage_Deprecated_StateOverride;
  /** Output only. Reserved for future use. */
  ...
  /** Initial State for shielded instance, these are public keys which are safe to store in public */
  shieldedInstanceInitialState: AlphaComputeAlphaImage_ShieldedInstanceInitialState;
  /** URL of the source disk used to create this image. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone/disks/disk - projects/project/zones/zone/disks/disk - zones/zone/disks/disk In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceDisk: string;
  sourceDiskEncryptionKey: AlphaComputeAlphaImage_ImageEncryptionKey;
  /** Output only. [Output Only] The ID value of the disk used to create this image. This value may be used to determine whether the image was taken from the current or a previous instance of a given disk name. */
  sourceDiskId: string;
  /** URL of the source image used to create this image. The following are valid formats for the URL: - https://www.googleapis.com/compute/v1/projects/project_id/global/ images/image_name - projects/project_id/global/images/image_name In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceImage: string;
  sourceImageEncryptionKey: AlphaComputeAlphaImage_ImageEncryptionKey;
  /** Output only. [Output Only] The ID value of the image used to create this image. This value may be used to determine whether the image was taken from the current or a previous instance of a given image name. */
  sourceImageId: string;
  /** URL of the source snapshot used to create this image. The following are valid formats for the URL: - https://www.googleapis.com/compute/v1/projects/project_id/global/ snapshots/snapshot_name - projects/project_id/global/snapshots/snapshot_name In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceSnapshot: string;
  sourceSnapshotEncryptionKey: AlphaComputeAlphaImage_ImageEncryptionKey;
  /** Output only. [Output Only] The ID value of the snapshot used to create this image. This value may be used to determine whether the snapshot was taken from the current or a previous instance of a given snapshot name. */
...
export const AlphaComputeAlphaImage: ResourceBinding<AlphaComputeAlphaImageConfig, AlphaComputeAlphaImageAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_image",
  fields: {
    ...
    deprecated: {
      wireName: "deprecated",
      kind: "object",
      fields: AlphaComputeAlphaImage_DeprecatedFields,
    },
    ...
    guestOsFeatures: {
      ...
      kind: "list",
      fields: AlphaComputeAlphaImage_GuestOsFeaturesFields,
    },
    id: "id",
    imageEncryptionKey: {
      wireName: "image_encryption_key",
      kind: "object",
      fields: AlphaComputeAlphaImage_ImageEncryptionKeyFields,
    },
    kind: "kind",
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: AlphaComputeAlphaImage_ParamsFields,
    },
    rawDisk: {
      wireName: "raw_disk",
      kind: "object",
      fields: AlphaComputeAlphaImage_RawDiskFields,
    },
    rolloutOverride: {
    ...
    shieldedInstanceInitialState: {
      ...
      kind: "object",
      fields: AlphaComputeAlphaImage_ShieldedInstanceInitialStateFields,
    },
