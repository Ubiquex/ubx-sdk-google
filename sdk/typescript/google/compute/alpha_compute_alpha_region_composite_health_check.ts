...
export interface AlphaComputeAlphaRegionCompositeHealthCheckConfig {
...
export interface AlphaComputeAlphaRegionCompositeHealthCheckAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const AlphaComputeAlphaRegionCompositeHealthCheck: ResourceBinding<AlphaComputeAlphaRegionCompositeHealthCheckConfig, AlphaComputeAlphaRegionCompositeHealthCheckAttrs> = {
  wireType: "google_compute_alpha_compute_alpha_region_composite_health_check",
  fields: {
