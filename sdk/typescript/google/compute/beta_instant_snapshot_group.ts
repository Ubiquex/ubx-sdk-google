...
export interface BetaInstantSnapshotGroup_ResourceStatus_SourceInfo {
  consistencyGroup?: string | Computed<string>;
  consistencyGroupId?: string | Computed<string>;
}

export interface BetaInstantSnapshotGroup_ResourceStatus {
  /** Output only. [Output Only] */
  consistencyMembershipResolutionTime?: string | Computed<string>;
  sourceInfo?: BetaInstantSnapshotGroup_ResourceStatus_SourceInfo | Computed<BetaInstantSnapshotGroup_ResourceStatus_SourceInfo>;
}

const BetaInstantSnapshotGroup_ResourceStatus_SourceInfoFields: FieldMap = {
  consistencyGroup: "consistency_group",
  consistencyGroupId: "consistency_group_id",
};

const BetaInstantSnapshotGroup_ResourceStatusFields: FieldMap = {
...
export interface BetaInstantSnapshotGroupConfig {
  ...
  resourceStatus?: BetaInstantSnapshotGroup_ResourceStatus | Computed<BetaInstantSnapshotGroup_ResourceStatus>;
...
export interface BetaInstantSnapshotGroupAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** Output only. [Output Only] URL of the region where the instant snapshot group resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  resourceStatus: BetaInstantSnapshotGroup_ResourceStatus;
  /** Output only. [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource's resource id. */
...
export const BetaInstantSnapshotGroup: ResourceBinding<BetaInstantSnapshotGroupConfig, BetaInstantSnapshotGroupAttrs> = {
