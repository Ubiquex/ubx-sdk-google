...
export interface Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy {
  /** Specify bandwidth percentages for various traffic classes for queuing type Bandwidth Percent. */
  bandwidthPercentages?: Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[] | Computed<Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[]>;
}
...
export interface Interconnect_ApplicationAwareInterconnect {
  ...
  shapeAveragePercentages?: Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[] | Computed<Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[]>;
...
export interface Interconnect_Macsec {
  ...
  preSharedKeys?: Interconnect_Macsec_PreSharedKeys[] | Computed<Interconnect_Macsec_PreSharedKeys[]>;
}
...
const Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentagesFields: FieldMap = {
  percentage: "percentage",
  trafficClass: "traffic_class",
};

const Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicyFields: FieldMap = {
  bandwidthPercentages: {
    wireName: "bandwidth_percentages",
    kind: "list",
    fields: Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentagesFields,
  },
};

const Interconnect_ApplicationAwareInterconnectFields: FieldMap = {
  bandwidthPercentagePolicy: {
    wireName: "bandwidth_percentage_policy",
    kind: "object",
    fields: Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicyFields,
  },
...
export interface InterconnectAttrs {
  ...
  /** Configuration information for application awareness on this Cloud Interconnect. */
  applicationAwareInterconnect: Interconnect_ApplicationAwareInterconnect;
  /** [Output only] List of features available for this Interconnect connection, which can take one of the following values: - IF_MACSEC: If present, then the Interconnect connection is provisioned on MACsec capable hardware ports. If not present, then the Interconnect connection is provisioned on non-MACsec capable ports. Any attempt to enable MACsec will fail. - IF_CROSS_SITE_NETWORK: If present, then the Interconnect connection is provisioned exclusively for Cross-Site Networking. Any attempt to configure VLAN attachments will fail. If not present, then the Interconnect connection is not provisioned for Cross-Site Networking. Any attempt to use it for Cross-Site Networking will fail. */
