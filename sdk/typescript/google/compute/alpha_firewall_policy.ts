// Code generated by `ubx sdk gen` from google_compute_alpha_firewall_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaFirewallPolicy_Associations {
...
export interface AlphaFirewallPolicy_PacketMirroringRules_Match_Layer4Configs {
  ipProtocol?: string | Computed<string>;
  ports?: string[] | Computed<string[]>;
}

export interface AlphaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags {
  name?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface AlphaFirewallPolicy_PacketMirroringRules_Match {
  ...
  layer4Configs?: AlphaFirewallPolicy_PacketMirroringRules_Match_Layer4Configs[] | Computed<AlphaFirewallPolicy_PacketMirroringRules_Match_Layer4Configs[]>;
  ...
  srcSecureTags?: AlphaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[] | Computed<AlphaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[]>;
  srcThreatIntelligences?: string[] | Computed<string[]>;
}

export interface AlphaFirewallPolicy_PacketMirroringRules {
  ...
  match?: AlphaFirewallPolicy_PacketMirroringRules_Match | Computed<AlphaFirewallPolicy_PacketMirroringRules_Match>;
  priority?: number | Computed<number>;
  ...
  targetSecureTags?: AlphaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[] | Computed<AlphaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[]>;
  targetServiceAccounts?: string[] | Computed<string[]>;
  targetType?: string | Computed<string>;
  tlsInspect?: boolean | Computed<boolean>;
}

export interface AlphaFirewallPolicy_RolloutOperation_RolloutInput {
...
export interface AlphaFirewallPolicy_RolloutOperation_RolloutStatus_NextRollout {
...
export interface AlphaFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRollouts {
  rollout?: string | Computed<string>;
  rolloutPlan?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface AlphaFirewallPolicy_RolloutOperation_RolloutStatus {
  nextRollout?: AlphaFirewallPolicy_RolloutOperation_RolloutStatus_NextRollout | Computed<AlphaFirewallPolicy_RolloutOperation_RolloutStatus_NextRollout>;
  /** [Output only] The ongoing rollout. */
  ongoingRollouts?: AlphaFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRollouts[] | Computed<AlphaFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRollouts[]>;
  /** Represents the status of the progressive rollout instance, either completed or ongoing. */
  previousRollout?: AlphaFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRollouts | Computed<AlphaFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRollouts>;
}

export interface AlphaFirewallPolicy_RolloutOperation {
  /** Represents progressive rollout input parameters. */
  rolloutInput?: AlphaFirewallPolicy_RolloutOperation_RolloutInput | Computed<AlphaFirewallPolicy_RolloutOperation_RolloutInput>;
  /** Represents progressive rollout current status. */
  rolloutStatus?: AlphaFirewallPolicy_RolloutOperation_RolloutStatus | Computed<AlphaFirewallPolicy_RolloutOperation_RolloutStatus>;
}

const AlphaFirewallPolicy_AssociationsFields: FieldMap = {
...
const AlphaFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields: FieldMap = {
  ipProtocol: "ip_protocol",
  ports: "ports",
};

const AlphaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields: FieldMap = {
  name: "name",
  state: "state",
};

const AlphaFirewallPolicy_PacketMirroringRules_MatchFields: FieldMap = {
  ...
  layer4Configs: {
    ...
    kind: "list",
    fields: AlphaFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields,
  },
  ...
  srcSecureTags: {
    ...
    kind: "list",
    fields: AlphaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields,
  },
  srcThreatIntelligences: "src_threat_intelligences",
};

const AlphaFirewallPolicy_PacketMirroringRulesFields: FieldMap = {
  action: "action",
  ...
  match: {
    wireName: "match",
    kind: "object",
    fields: AlphaFirewallPolicy_PacketMirroringRules_MatchFields,
  },
  priority: "priority",
  ruleName: "rule_name",
...
const AlphaFirewallPolicy_RolloutOperation_RolloutInputFields: FieldMap = {
  name: "name",
  predefinedRolloutPlan: "predefined_rollout_plan",
  retryUuid: "retry_uuid",
};

const AlphaFirewallPolicy_RolloutOperation_RolloutStatus_NextRolloutFields: FieldMap = {
  rolloutId: "rollout_id",
  rolloutPlan: "rollout_plan",
};

const AlphaFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRolloutsFields: FieldMap = {
  rollout: "rollout",
  rolloutPlan: "rollout_plan",
  state: "state",
};

const AlphaFirewallPolicy_RolloutOperation_RolloutStatusFields: FieldMap = {
  nextRollout: {
    wireName: "next_rollout",
    kind: "object",
    fields: AlphaFirewallPolicy_RolloutOperation_RolloutStatus_NextRolloutFields,
  },
  ongoingRollouts: {
    wireName: "ongoing_rollouts",
    kind: "list",
    fields: AlphaFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRolloutsFields,
  },
  previousRollout: {
...
const AlphaFirewallPolicy_RolloutOperationFields: FieldMap = {
  rolloutInput: {
    wireName: "rollout_input",
    kind: "object",
    fields: AlphaFirewallPolicy_RolloutOperation_RolloutInputFields,
  },
  rolloutStatus: {
    wireName: "rollout_status",
    kind: "object",
    fields: AlphaFirewallPolicy_RolloutOperation_RolloutStatusFields,
  },
};
...
export interface AlphaFirewallPolicyConfig {
  ...
  packetMirroringRules?: AlphaFirewallPolicy_PacketMirroringRules[] | Computed<AlphaFirewallPolicy_PacketMirroringRules[]>;
  ...
  rolloutOperation?: AlphaFirewallPolicy_RolloutOperation | Computed<AlphaFirewallPolicy_RolloutOperation>;
  ...
  rules?: AlphaFirewallPolicy_PacketMirroringRules[] | Computed<AlphaFirewallPolicy_PacketMirroringRules[]>;
...
export interface AlphaFirewallPolicyAttrs {
  ...
  name: string;
  /** A list of packet mirroring rules that belong to this policy. */
  packetMirroringRules: AlphaFirewallPolicy_PacketMirroringRules[];
  /** Output only. [Output Only] The parent of the firewall policy. This field is not applicable to network firewall policies. */
  parent: string;
  /** Indicates the source of this Firewall Policy. This field is optional on creation and defaults to USER_DEFINED. The USER_DEFINED value indicates a regular firewall policy. The SYSTEM value indicates a system-level policy managed by an internal service like GKE. This SYSTEM value is reserved for internal services and cannot be set by users during policy creation. Policies with a SYSTEM source cannot be modified or deleted by users. */
  policySource: string;
  ...
  region: string;
  /** Represents progressive rollout input parameters and current status. */
  rolloutOperation: AlphaFirewallPolicy_RolloutOperation;
  /** Output only. [Output Only] Total count of all firewall policy rule tuples. A firewall policy can not exceed a set number of tuples. */
  ruleTupleCount: number;
  /** A list of rules that belong to this policy. There must always be a default rule (rule with priority 2147483647 and match "*"). If no rules are provided when creating a firewall policy, a default rule with action "allow" will be added. */
  rules: AlphaFirewallPolicy_PacketMirroringRules[];
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource with the resource id. */
...
export const AlphaFirewallPolicy: ResourceBinding<AlphaFirewallPolicyConfig, AlphaFirewallPolicyAttrs> = {
  ...
  fields: {
    associations: {
      ...
      kind: "list",
      fields: AlphaFirewallPolicy_AssociationsFields,
    },
    ...
    packetMirroringRules: {
      ...
      kind: "list",
      fields: AlphaFirewallPolicy_PacketMirroringRulesFields,
    },
    parent: "parent",
    ...
    rolloutOperation: {
      ...
      kind: "object",
      fields: AlphaFirewallPolicy_RolloutOperationFields,
    },
    ruleTupleCount: "rule_tuple_count",
    rules: {
      wireName: "rules",
