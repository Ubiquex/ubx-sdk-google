// Code generated by `ubx sdk gen` from google_compute_beta_image. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaImage_Deprecated_StateOverride {
...
export interface BetaImage_Deprecated {
  ...
  stateOverride?: BetaImage_Deprecated_StateOverride | Computed<BetaImage_Deprecated_StateOverride>;
}

export interface BetaImage_GuestOsFeatures {
  type?: string | Computed<string>;
}

export interface BetaImage_ImageEncryptionKey {
...
export interface BetaImage_Params {
...
export interface BetaImage_RawDisk {
...
export interface BetaImage_ShieldedInstanceInitialState_Dbs {
  content?: string | Computed<string>;
  fileType?: string | Computed<string>;
}

export interface BetaImage_ShieldedInstanceInitialState {
  /** The Key Database (db). */
  dbs?: BetaImage_ShieldedInstanceInitialState_Dbs[] | Computed<BetaImage_ShieldedInstanceInitialState_Dbs[]>;
  /** The forbidden key database (dbx). */
  dbxs?: BetaImage_ShieldedInstanceInitialState_Dbs[] | Computed<BetaImage_ShieldedInstanceInitialState_Dbs[]>;
  /** The Key Exchange Key (KEK). */
  keks?: BetaImage_ShieldedInstanceInitialState_Dbs[] | Computed<BetaImage_ShieldedInstanceInitialState_Dbs[]>;
  pk?: BetaImage_ShieldedInstanceInitialState_Dbs | Computed<BetaImage_ShieldedInstanceInitialState_Dbs>;
}

const BetaImage_Deprecated_StateOverrideFields: FieldMap = {
  defaultRolloutTime: "default_rollout_time",
  locationRolloutPolicies: "location_rollout_policies",
};

const BetaImage_DeprecatedFields: FieldMap = {
  deleted: "deleted",
  ...
  stateOverride: {
    ...
    kind: "object",
    fields: BetaImage_Deprecated_StateOverrideFields,
  },
};

const BetaImage_GuestOsFeaturesFields: FieldMap = {
  type: "type",
};

const BetaImage_ImageEncryptionKeyFields: FieldMap = {
...
const BetaImage_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaImage_RawDiskFields: FieldMap = {
  containerType: "container_type",
  sha1Checksum: "sha1_checksum",
  source: "source",
};

const BetaImage_ShieldedInstanceInitialState_DbsFields: FieldMap = {
  content: "content",
  fileType: "file_type",
};

const BetaImage_ShieldedInstanceInitialStateFields: FieldMap = {
  dbs: {
    wireName: "dbs",
    kind: "list",
    fields: BetaImage_ShieldedInstanceInitialState_DbsFields,
  },
  dbxs: {
    wireName: "dbxs",
    kind: "list",
...
export interface BetaImageConfig {
  ...
  guestOsFeatures?: BetaImage_GuestOsFeatures[] | Computed<BetaImage_GuestOsFeatures[]>;
  imageEncryptionKey?: BetaImage_ImageEncryptionKey | Computed<BetaImage_ImageEncryptionKey>;
  ...
  params?: BetaImage_Params | Computed<BetaImage_Params>;
  /** The parameters of the raw disk image. */
  rawDisk?: BetaImage_RawDisk | Computed<BetaImage_RawDisk>;
  /** A rollout policy configuration. */
  rolloutOverride?: BetaImage_Deprecated_StateOverride | Computed<BetaImage_Deprecated_StateOverride>;
  /** Initial State for shielded instance, these are public keys which are safe to store in public */
  shieldedInstanceInitialState?: BetaImage_ShieldedInstanceInitialState | Computed<BetaImage_ShieldedInstanceInitialState>;
  /** URL of the source disk used to create this image. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone/disks/disk - projects/project/zones/zone/disks/disk - zones/zone/disks/disk In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceDisk?: string | Computed<string>;
  sourceDiskEncryptionKey?: BetaImage_ImageEncryptionKey | Computed<BetaImage_ImageEncryptionKey>;
  /** URL of the source image used to create this image. The following are valid formats for the URL: - https://www.googleapis.com/compute/v1/projects/project_id/global/ images/image_name - projects/project_id/global/images/image_name In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceImage?: string | Computed<string>;
  sourceImageEncryptionKey?: BetaImage_ImageEncryptionKey | Computed<BetaImage_ImageEncryptionKey>;
  /** URL of the source snapshot used to create this image. The following are valid formats for the URL: - https://www.googleapis.com/compute/v1/projects/project_id/global/ snapshots/snapshot_name - projects/project_id/global/snapshots/snapshot_name In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceSnapshot?: string | Computed<string>;
  sourceSnapshotEncryptionKey?: BetaImage_ImageEncryptionKey | Computed<BetaImage_ImageEncryptionKey>;
...
export interface BetaImageAttrs {
  /** The architecture of the image. Valid values are ARM64 or X86_64. */
  architecture: string;
  /** Size of the image tar.gz archive stored in Google Cloud Storage (in bytes). */
  ...
  /** Deprecation status for a public resource. */
  deprecated: BetaImage_Deprecated;
  /** An optional description of this resource. Provide this property when you create the resource. */
  description: string;
  /** Size of the image when restored onto a persistent disk (in GB). */
  diskSizeGb: string;
  ...
  family: string;
  /** A list of features to enable on the guest operating system. Applicable only for bootable images. To see a list of available options, see theguestOSfeatures[].type parameter. */
  guestOsFeatures: BetaImage_GuestOsFeatures[];
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id: string;
  imageEncryptionKey: BetaImage_ImageEncryptionKey;
  ...
  name: string;
  /** Additional image params. */
  params: BetaImage_Params;
  /** The parameters of the raw disk image. */
  rawDisk: BetaImage_RawDisk;
  /** A rollout policy configuration. */
  rolloutOverride: BetaImage_Deprecated_StateOverride;
  ...
  selfLink: string;
  /** Initial State for shielded instance, these are public keys which are safe to store in public */
  shieldedInstanceInitialState: BetaImage_ShieldedInstanceInitialState;
  /** URL of the source disk used to create this image. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone/disks/disk - projects/project/zones/zone/disks/disk - zones/zone/disks/disk In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceDisk: string;
  sourceDiskEncryptionKey: BetaImage_ImageEncryptionKey;
  ...
  /** URL of the source image used to create this image. The following are valid formats for the URL: - https://www.googleapis.com/compute/v1/projects/project_id/global/ images/image_name - projects/project_id/global/images/image_name In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceImage: string;
  sourceImageEncryptionKey: BetaImage_ImageEncryptionKey;
  ...
  sourceSnapshotEncryptionKey: BetaImage_ImageEncryptionKey;
...
export const BetaImage: ResourceBinding<BetaImageConfig, BetaImageAttrs> = {
  wireType: "google_compute_beta_image",
  fields: {
    ...
    deprecated: {
      wireName: "deprecated",
      kind: "object",
      fields: BetaImage_DeprecatedFields,
    },
    ...
    guestOsFeatures: {
      ...
      kind: "list",
      fields: BetaImage_GuestOsFeaturesFields,
    },
    imageEncryptionKey: {
      wireName: "image_encryption_key",
      kind: "object",
      fields: BetaImage_ImageEncryptionKeyFields,
    },
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaImage_ParamsFields,
    },
    rawDisk: {
      wireName: "raw_disk",
      kind: "object",
      fields: BetaImage_RawDiskFields,
    },
    rolloutOverride: {
    ...
    shieldedInstanceInitialState: {
      ...
      kind: "object",
      fields: BetaImage_ShieldedInstanceInitialStateFields,
    },
