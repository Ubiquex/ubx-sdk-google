// Code generated by `ubx sdk gen` from google_compute_beta_region_instant_snapshot. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaRegionInstantSnapshot_Params {
...
export interface BetaRegionInstantSnapshot_ResourceStatus {
  /** [Output Only] The storage size of this instant snapshot. */
  storageSizeBytes?: string | Computed<string>;
}

const BetaRegionInstantSnapshot_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaRegionInstantSnapshot_ResourceStatusFields: FieldMap = {
  storageSizeBytes: "storage_size_bytes",
};

export interface BetaRegionInstantSnapshotConfig {
  ...
  params?: BetaRegionInstantSnapshot_Params | Computed<BetaRegionInstantSnapshot_Params>;
  ...
  resourceStatus?: BetaRegionInstantSnapshot_ResourceStatus | Computed<BetaRegionInstantSnapshot_ResourceStatus>;
...
export interface BetaRegionInstantSnapshotAttrs {
  /** Output only. [Output Only] The architecture of the instant snapshot. Valid values are ARM64 or X86_64. */
  architecture: string;
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  name: string;
  /** Additional instant snapshot params. */
  params: BetaRegionInstantSnapshot_Params;
  /** Output only. [Output Only] URL of the region where the instant snapshot resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  resourceStatus: BetaRegionInstantSnapshot_ResourceStatus;
  /** Output only. Reserved for future use. */
...
export const BetaRegionInstantSnapshot: ResourceBinding<BetaRegionInstantSnapshotConfig, BetaRegionInstantSnapshotAttrs> = {
  wireType: "google_compute_beta_region_instant_snapshot",
  fields: {
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaRegionInstantSnapshot_ParamsFields,
    },
    region: "region",
    resourceStatus: {
      wireName: "resource_status",
      kind: "object",
      fields: BetaRegionInstantSnapshot_ResourceStatusFields,
    },
