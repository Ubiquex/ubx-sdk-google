...
export interface BetaPublicAdvertisedPrefix_PublicDelegatedPrefixs {
...
const BetaPublicAdvertisedPrefix_PublicDelegatedPrefixsFields: FieldMap = {
  ipRange: "ip_range",
  name: "name",
  project: "project",
  region: "region",
...
export interface BetaPublicAdvertisedPrefixConfig {
  ...
  publicDelegatedPrefixs?: BetaPublicAdvertisedPrefix_PublicDelegatedPrefixs[] | Computed<BetaPublicAdvertisedPrefix_PublicDelegatedPrefixs[]>;
...
export interface BetaPublicAdvertisedPrefixAttrs {
  /** Output only. [Output Only] The version of BYOIP API. */
  ...
  pdpScope: string;
  /** Output only. [Output Only] The list of public delegated prefixes that exist for this public advertised prefix. */
  publicDelegatedPrefixs: BetaPublicAdvertisedPrefix_PublicDelegatedPrefixs[];
  /** Output only. [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** [Output Only] The shared secret to be used for reverse DNS verification. */
  sharedSecret: string;
...
export const BetaPublicAdvertisedPrefix: ResourceBinding<BetaPublicAdvertisedPrefixConfig, BetaPublicAdvertisedPrefixAttrs> = {
