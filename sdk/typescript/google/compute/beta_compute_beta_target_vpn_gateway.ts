// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_target_vpn_gateway. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaTargetVpnGateway_Params {
...
const BetaComputeBetaTargetVpnGateway_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

export interface BetaComputeBetaTargetVpnGatewayConfig {
  ...
  params?: BetaComputeBetaTargetVpnGateway_Params | Computed<BetaComputeBetaTargetVpnGateway_Params>;
...
export interface BetaComputeBetaTargetVpnGatewayAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** URL of the network to which this VPN gateway is attached. Provided by the client when the VPN gateway is created. */
  network: string;
  params: BetaComputeBetaTargetVpnGateway_Params;
  /** [Output Only] URL of the region where the target VPN gateway resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
...
export const BetaComputeBetaTargetVpnGateway: ResourceBinding<BetaComputeBetaTargetVpnGatewayConfig, BetaComputeBetaTargetVpnGatewayAttrs> = {
  wireType: "google_compute_beta_compute_beta_target_vpn_gateway",
  fields: {
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaComputeBetaTargetVpnGateway_ParamsFields,
    },
    region: "region",
    selfLink: "self_link",
    status: "status",
