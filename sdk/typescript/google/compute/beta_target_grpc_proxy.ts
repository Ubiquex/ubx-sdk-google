// Code generated by `ubx sdk gen` from google_compute_beta_target_grpc_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaTargetGrpcProxyConfig {
...
export interface BetaTargetGrpcProxyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaTargetGrpcProxy: ResourceBinding<BetaTargetGrpcProxyConfig, BetaTargetGrpcProxyAttrs> = {
  wireType: "google_compute_beta_target_grpc_proxy",
  fields: {
