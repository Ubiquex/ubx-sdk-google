// Code generated by `ubx sdk gen` from google_compute_alpha_network. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlphaNetwork_Params {
...
export interface AlphaNetwork_Peerings_ConnectionStatus_ConsensusState {
  deleteStatus?: string | Computed<string>;
  updateStatus?: string | Computed<string>;
}

export interface AlphaNetwork_Peerings_ConnectionStatus_TrafficConfiguration {
...
export interface AlphaNetwork_Peerings_ConnectionStatus {
  consensusState?: AlphaNetwork_Peerings_ConnectionStatus_ConsensusState | Computed<AlphaNetwork_Peerings_ConnectionStatus_ConsensusState>;
  trafficConfiguration?: AlphaNetwork_Peerings_ConnectionStatus_TrafficConfiguration | Computed<AlphaNetwork_Peerings_ConnectionStatus_TrafficConfiguration>;
  updateStrategy?: string | Computed<string>;
}

export interface AlphaNetwork_Peerings {
  advertisePeerSubnetsViaRouters?: boolean | Computed<boolean>;
  autoCreateRoutes?: boolean | Computed<boolean>;
  connectionStatus?: AlphaNetwork_Peerings_ConnectionStatus | Computed<AlphaNetwork_Peerings_ConnectionStatus>;
...
export interface AlphaNetwork_RoutingConfig {
...
const AlphaNetwork_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const AlphaNetwork_Peerings_ConnectionStatus_ConsensusStateFields: FieldMap = {
  deleteStatus: "delete_status",
  updateStatus: "update_status",
};

const AlphaNetwork_Peerings_ConnectionStatus_TrafficConfigurationFields: FieldMap = {
...
const AlphaNetwork_Peerings_ConnectionStatusFields: FieldMap = {
  consensusState: {
...
const AlphaNetwork_PeeringsFields: FieldMap = {
...
const AlphaNetwork_RoutingConfigFields: FieldMap = {
...
export interface AlphaNetworkConfig {
  ...
  params?: AlphaNetwork_Params | Computed<AlphaNetwork_Params>;
  /** Output only. [Output Only] A list of network peerings for the resource. */
  peerings?: AlphaNetwork_Peerings[] | Computed<AlphaNetwork_Peerings[]>;
  ...
  routingConfig?: AlphaNetwork_RoutingConfig | Computed<AlphaNetwork_RoutingConfig>;
...
export interface AlphaNetworkAttrs {
  /** Must be set to create a VPC network. If not set, a legacy network is created. When set to true, the VPC network is created in auto mode. When set to false, the VPC network is created in custom mode. An auto mode VPC network starts with one subnet per region. Each subnet has a predetermined range as described inAuto mode VPC network IP ranges. For custom mode VPC networks, you can add subnets using the subnetworksinsert method. */
  ...
  /** Additional network parameters. */
  params: AlphaNetwork_Params;
  /** Output only. [Output Only] A list of network peerings for the resource. */
  peerings: AlphaNetwork_Peerings[];
  /** Output only. [Output Only] URL of the region where the regional network resides. This field is not applicable to global network. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  /** A routing configuration attached to a network resource. The message includes the list of routers associated with the network, and a flag indicating the type of routing behavior to enforce network-wide. */
  routingConfig: AlphaNetwork_RoutingConfig;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource with the resource id. */
...
export const AlphaNetwork: ResourceBinding<AlphaNetworkConfig, AlphaNetworkAttrs> = {
