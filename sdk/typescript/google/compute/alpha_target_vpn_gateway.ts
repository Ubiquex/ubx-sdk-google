...
export interface AlphaTargetVpnGateway_Params {
...
const AlphaTargetVpnGateway_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

export interface AlphaTargetVpnGatewayConfig {
  ...
  params?: AlphaTargetVpnGateway_Params | Computed<AlphaTargetVpnGateway_Params>;
...
export interface AlphaTargetVpnGatewayAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** URL of the network to which this VPN gateway is attached. Provided by the client when the VPN gateway is created. */
  network: string;
  params: AlphaTargetVpnGateway_Params;
  /** [Output Only] URL of the region where the target VPN gateway resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
...
export const AlphaTargetVpnGateway: ResourceBinding<AlphaTargetVpnGatewayConfig, AlphaTargetVpnGatewayAttrs> = {
