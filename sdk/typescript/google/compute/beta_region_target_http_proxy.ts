// Code generated by `ubx sdk gen` from google_compute_beta_region_target_http_proxy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaRegionTargetHttpProxyConfig {
...
export interface BetaRegionTargetHttpProxyAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
...
export const BetaRegionTargetHttpProxy: ResourceBinding<BetaRegionTargetHttpProxyConfig, BetaRegionTargetHttpProxyAttrs> = {
  wireType: "google_compute_beta_region_target_http_proxy",
  fields: {
