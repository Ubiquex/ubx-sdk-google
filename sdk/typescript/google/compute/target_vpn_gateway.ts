// Code generated by `ubx sdk gen` from google_compute_target_vpn_gateway. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface TargetVpnGateway_Params {
...
const TargetVpnGateway_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

export interface TargetVpnGatewayConfig {
  ...
  params?: TargetVpnGateway_Params | Computed<TargetVpnGateway_Params>;
...
export interface TargetVpnGatewayAttrs {
  ...
  /** URL of the network to which this VPN gateway is attached. Provided by the client when the VPN gateway is created. */
  network: string;
  params: TargetVpnGateway_Params;
  /** [Output Only] URL of the region where the target VPN gateway resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. */
  region: string;
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
...
export const TargetVpnGateway: ResourceBinding<TargetVpnGatewayConfig, TargetVpnGatewayAttrs> = {
  wireType: "google_compute_target_vpn_gateway",
  fields: {
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: TargetVpnGateway_ParamsFields,
    },
    region: "region",
    selfLink: "self_link",
    status: "status",
