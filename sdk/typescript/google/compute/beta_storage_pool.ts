// Code generated by `ubx sdk gen` from google_compute_beta_storage_pool. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaStoragePool_ExapoolProvisionedCapacityGb {
...
export interface BetaStoragePool_Params {
...
export interface BetaStoragePool_ResourceStatus {
...
export interface BetaStoragePool_ShareSettings_ProjectMap {
  projectId?: string | Computed<string>;
}

export interface BetaStoragePool_ShareSettings {
  /** A map of project id and project config. */
  projectMap?: Record<string, BetaStoragePool_ShareSettings_ProjectMap> | Computed<Record<string, BetaStoragePool_ShareSettings_ProjectMap>>;
}

const BetaStoragePool_ExapoolProvisionedCapacityGbFields: FieldMap = {
  capacityOptimized: "capacity_optimized",
  readOptimized: "read_optimized",
  writeOptimized: "write_optimized",
};

const BetaStoragePool_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

const BetaStoragePool_ResourceStatusFields: FieldMap = {
...
const BetaStoragePool_ShareSettings_ProjectMapFields: FieldMap = {
  projectId: "project_id",
};

const BetaStoragePool_ShareSettingsFields: FieldMap = {
  projectMap: {
    wireName: "project_map",
    kind: "map",
    fields: BetaStoragePool_ShareSettings_ProjectMapFields,
  },
};

export interface BetaStoragePoolConfig {
  ...
  exapoolProvisionedCapacityGb?: BetaStoragePool_ExapoolProvisionedCapacityGb | Computed<BetaStoragePool_ExapoolProvisionedCapacityGb>;
  ...
  params?: BetaStoragePool_Params | Computed<BetaStoragePool_Params>;
  ...
  resourceStatus?: BetaStoragePool_ResourceStatus | Computed<BetaStoragePool_ResourceStatus>;
  /** Share settings for the storage pool. */
  shareSettings?: BetaStoragePool_ShareSettings | Computed<BetaStoragePool_ShareSettings>;
  /** [Output Only] Contains output only fields. */
  status?: BetaStoragePool_ResourceStatus | Computed<BetaStoragePool_ResourceStatus>;
  /** Type of the storage pool. */
  storagePoolType?: string | Computed<string>;
}

export interface BetaStoragePoolAttrs {
  /** Provisioning type of the byte capacity of the pool. */
  ...
  description: string;
  /** Exapool provisioned capacities for each SKU type */
  exapoolProvisionedCapacityGb: BetaStoragePool_ExapoolProvisionedCapacityGb;
  ...
  /** [Output Only] Contains output only fields. */
  resourceStatus: BetaStoragePool_ResourceStatus;
  /** Output only. [Output Only] Server-defined fully-qualified URL for this resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource's resource id. */
  selfLinkWithId: string;
  /** Share settings for the storage pool. */
  shareSettings: BetaStoragePool_ShareSettings;
  ...
  state: string;
  /** [Output Only] Contains output only fields. */
  status: BetaStoragePool_ResourceStatus;
  /** Type of the storage pool. */
...
export const BetaStoragePool: ResourceBinding<BetaStoragePoolConfig, BetaStoragePoolAttrs> = {
  wireType: "google_compute_beta_storage_pool",
  fields: {
    ...
    exapoolProvisionedCapacityGb: {
      ...
      kind: "object",
      fields: BetaStoragePool_ExapoolProvisionedCapacityGbFields,
    },
    ...
    params: {
      wireName: "params",
      kind: "object",
      fields: BetaStoragePool_ParamsFields,
    },
    ...
    resourceStatus: {
      ...
      kind: "object",
      fields: BetaStoragePool_ResourceStatusFields,
    },
    shareSettings: {
      wireName: "share_settings",
      kind: "object",
      fields: BetaStoragePool_ShareSettingsFields,
    },
    status: {
      wireName: "status",
      kind: "object",
