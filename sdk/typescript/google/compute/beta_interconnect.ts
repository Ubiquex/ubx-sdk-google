// Code generated by `ubx sdk gen` from google_compute_beta_interconnect. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages {
  percentage?: number | Computed<number>;
  trafficClass?: string | Computed<string>;
}

export interface BetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy {
  /** Specify bandwidth percentages for various traffic classes for queuing type Bandwidth Percent. */
  bandwidthPercentages?: BetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[] | Computed<BetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[]>;
}

export interface BetaInterconnect_ApplicationAwareInterconnect {
  bandwidthPercentagePolicy?: BetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy | Computed<BetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy>;
  ...
  shapeAveragePercentages?: BetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[] | Computed<BetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentages[]>;
  /** Specify configuration for StrictPriorityPolicy. */
  strictPriorityPolicy?: unknown | Computed<unknown>;
}

export interface BetaInterconnect_CircuitInfos {
  customerDemarcId?: string | Computed<string>;
  googleCircuitId?: string | Computed<string>;
  googleDemarcId?: string | Computed<string>;
}

export interface BetaInterconnect_ExpectedOutages {
...
export interface BetaInterconnect_Macsec_PreSharedKeys {
  name?: string | Computed<string>;
  startTime?: string | Computed<string>;
}

export interface BetaInterconnect_Macsec {
  ...
  preSharedKeys?: BetaInterconnect_Macsec_PreSharedKeys[] | Computed<BetaInterconnect_Macsec_PreSharedKeys[]>;
}

export interface BetaInterconnect_Params {
...
const BetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentagesFields: FieldMap = {
  percentage: "percentage",
  trafficClass: "traffic_class",
};

const BetaInterconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicyFields: FieldMap = {
...
const BetaInterconnect_ApplicationAwareInterconnectFields: FieldMap = {
...
const BetaInterconnect_CircuitInfosFields: FieldMap = {
  customerDemarcId: "customer_demarc_id",
  googleCircuitId: "google_circuit_id",
  googleDemarcId: "google_demarc_id",
};

const BetaInterconnect_ExpectedOutagesFields: FieldMap = {
...
const BetaInterconnect_Macsec_PreSharedKeysFields: FieldMap = {
  name: "name",
  startTime: "start_time",
};

const BetaInterconnect_MacsecFields: FieldMap = {
  failOpen: "fail_open",
  preSharedKeys: {
...
const BetaInterconnect_ParamsFields: FieldMap = {
  resourceManagerTags: "resource_manager_tags",
};

export interface BetaInterconnectConfig {
  ...
  applicationAwareInterconnect?: BetaInterconnect_ApplicationAwareInterconnect | Computed<BetaInterconnect_ApplicationAwareInterconnect>;
  ...
  circuitInfos?: BetaInterconnect_CircuitInfos[] | Computed<BetaInterconnect_CircuitInfos[]>;
  ...
  expectedOutages?: BetaInterconnect_ExpectedOutages[] | Computed<BetaInterconnect_ExpectedOutages[]>;
  ...
  macsec?: BetaInterconnect_Macsec | Computed<BetaInterconnect_Macsec>;
  ...
  params?: BetaInterconnect_Params | Computed<BetaInterconnect_Params>;
...
export interface BetaInterconnectAttrs {
  /** Enable or disable the application awareness feature on this Cloud Interconnect. */
  aaiEnabled: boolean;
  /** Administrative status of the interconnect. When this is set to true, the Interconnect is functional and can carry traffic. When set to false, no packets can be carried over the interconnect and no BGP routes are exchanged over it. By default, the status is set to true. */
  adminEnabled: boolean;
  /** Configuration information for application awareness on this Cloud Interconnect. */
  applicationAwareInterconnect: BetaInterconnect_ApplicationAwareInterconnect;
  /** [Output only] List of features available for this Interconnect connection, which can take one of the following values: - IF_MACSEC: If present, then the Interconnect connection is provisioned on MACsec capable hardware ports. If not present, then the Interconnect connection is provisioned on non-MACsec capable ports. Any attempt to enable MACsec will fail. - IF_CROSS_SITE_NETWORK: If present, then the Interconnect connection is provisioned exclusively for Cross-Site Networking. Any attempt to configure VLAN attachments will fail. If not present, then the Interconnect connection is not provisioned for Cross-Site Networking. Any attempt to use it for Cross-Site Networking will fail. */
  availableFeatures: string[];
  /** Output only. [Output Only] A list of CircuitInfo objects, that describe the individual circuits in this LAG. */
  circuitInfos: BetaInterconnect_CircuitInfos[];
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  /** Output only. [Output Only] A list of outages expected for this Interconnect. */
  expectedOutages: BetaInterconnect_ExpectedOutages[];
  /** Output only. [Output Only] IP address configured on the Google side of the Interconnect link. This can be used only for ping tests. */
  ...
  location: string;
  /** Configuration information for enabling Media Access Control security (MACsec) on this Cloud Interconnect connection between Google and your on-premises router. */
  macsec: BetaInterconnect_Macsec;
  /** Enable or disable MACsec on this Interconnect connection. MACsec enablement fails if the MACsec object is not specified. */
  ...
  /** Additional interconnect parameters. */
  params: BetaInterconnect_Params;
  /** Output only. [Output Only] IP address configured on the customer side of the Interconnect link. The customer should configure this IP address during turnup when prompted by Google NOC. This can be used only for ping tests. */
...
export const BetaInterconnect: ResourceBinding<BetaInterconnectConfig, BetaInterconnectAttrs> = {
  ...
  fields: {
    ...
    circuitInfos: {
      ...
      kind: "list",
      fields: BetaInterconnect_CircuitInfosFields,
    },
    ...
    expectedOutages: {
      ...
      kind: "list",
      fields: BetaInterconnect_ExpectedOutagesFields,
    },
