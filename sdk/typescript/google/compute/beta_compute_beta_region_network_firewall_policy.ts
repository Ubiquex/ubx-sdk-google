// Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_region_network_firewall_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BetaComputeBetaRegionNetworkFirewallPolicy_Associations {
...
export interface BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs {
  ipProtocol?: string | Computed<string>;
  ports?: string[] | Computed<string[]>;
}

export interface BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags {
  name?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match {
  ...
  layer4Configs?: BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs[] | Computed<BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs[]>;
  ...
  srcSecureTags?: BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[] | Computed<BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[]>;
  srcThreatIntelligences?: string[] | Computed<string[]>;
}

export interface BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules {
  ...
  match?: BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match | Computed<BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match>;
  priority?: number | Computed<number>;
  ...
  targetSecureTags?: BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[] | Computed<BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[]>;
  targetServiceAccounts?: string[] | Computed<string[]>;
  targetType?: string | Computed<string>;
  tlsInspect?: boolean | Computed<boolean>;
}

const BetaComputeBetaRegionNetworkFirewallPolicy_AssociationsFields: FieldMap = {
...
const BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields: FieldMap = {
  ipProtocol: "ip_protocol",
  ports: "ports",
};

const BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields: FieldMap = {
  name: "name",
  state: "state",
};

const BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_MatchFields: FieldMap = {
  ...
  layer4Configs: {
    ...
    kind: "list",
    fields: BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields,
  },
  ...
  srcSecureTags: {
    ...
    kind: "list",
    fields: BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields,
  },
  srcThreatIntelligences: "src_threat_intelligences",
};

const BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRulesFields: FieldMap = {
  action: "action",
  ...
  match: {
    wireName: "match",
    kind: "object",
    fields: BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_MatchFields,
  },
  priority: "priority",
  ruleName: "rule_name",
...
export interface BetaComputeBetaRegionNetworkFirewallPolicyConfig {
  /** A list of associations that belong to this firewall policy. */
  associations?: BetaComputeBetaRegionNetworkFirewallPolicy_Associations[] | Computed<BetaComputeBetaRegionNetworkFirewallPolicy_Associations[]>;
  ...
  packetMirroringRules?: BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules[] | Computed<BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules[]>;
  ...
  rules?: BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules[] | Computed<BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules[]>;
...
export interface BetaComputeBetaRegionNetworkFirewallPolicyAttrs {
  /** A list of associations that belong to this firewall policy. */
  associations: BetaComputeBetaRegionNetworkFirewallPolicy_Associations[];
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  name: string;
  /** A list of packet mirroring rules that belong to this policy. */
  packetMirroringRules: BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules[];
  /** Output only. [Output Only] The parent of the firewall policy. This field is not applicable to network firewall policies. */
  parent: string;
  /** Indicates the source of this Firewall Policy. This field is optional on creation and defaults to USER_DEFINED. The USER_DEFINED value indicates a regular firewall policy. The SYSTEM value indicates a system-level policy managed by an internal service like GKE. This SYSTEM value is reserved for internal services and cannot be set by users during policy creation. Policies with a SYSTEM source cannot be modified or deleted by users. */
  policySource: string;
  ...
  /** A list of rules that belong to this policy. There must always be a default rule (rule with priority 2147483647 and match "*"). If no rules are provided when creating a firewall policy, a default rule with action "allow" will be added. */
  rules: BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules[];
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. [Output Only] Server-defined URL for this resource with the resource id. */
...
export const BetaComputeBetaRegionNetworkFirewallPolicy: ResourceBinding<BetaComputeBetaRegionNetworkFirewallPolicyConfig, BetaComputeBetaRegionNetworkFirewallPolicyAttrs> = {
  wireType: "google_compute_beta_compute_beta_region_network_firewall_policy",
  fields: {
    associations: {
      wireName: "associations",
      kind: "list",
      fields: BetaComputeBetaRegionNetworkFirewallPolicy_AssociationsFields,
    },
    ...
    packetMirroringRules: {
      ...
      kind: "list",
      fields: BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRulesFields,
    },
    parent: "parent",
