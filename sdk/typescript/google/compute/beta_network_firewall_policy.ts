...
export interface BetaNetworkFirewallPolicy_Associations {
...
export interface BetaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs {
  ipProtocol?: string | Computed<string>;
  ports?: string[] | Computed<string[]>;
}

export interface BetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags {
  name?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface BetaNetworkFirewallPolicy_PacketMirroringRules_Match {
  ...
  layer4Configs?: BetaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs[] | Computed<BetaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs[]>;
  ...
  srcSecureTags?: BetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[] | Computed<BetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[]>;
  srcThreatIntelligences?: string[] | Computed<string[]>;
}

export interface BetaNetworkFirewallPolicy_PacketMirroringRules {
  ...
  match?: BetaNetworkFirewallPolicy_PacketMirroringRules_Match | Computed<BetaNetworkFirewallPolicy_PacketMirroringRules_Match>;
  priority?: number | Computed<number>;
  ...
  targetSecureTags?: BetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[] | Computed<BetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags[]>;
  targetServiceAccounts?: string[] | Computed<string[]>;
  targetType?: string | Computed<string>;
  tlsInspect?: boolean | Computed<boolean>;
}

const BetaNetworkFirewallPolicy_AssociationsFields: FieldMap = {
...
const BetaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields: FieldMap = {
  ipProtocol: "ip_protocol",
  ports: "ports",
};

const BetaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields: FieldMap = {
  name: "name",
  state: "state",
};

const BetaNetworkFirewallPolicy_PacketMirroringRules_MatchFields: FieldMap = {
...
const BetaNetworkFirewallPolicy_PacketMirroringRulesFields: FieldMap = {
  action: "action",
...
export interface BetaNetworkFirewallPolicyConfig {
  /** A list of associations that belong to this firewall policy. */
  associations?: BetaNetworkFirewallPolicy_Associations[] | Computed<BetaNetworkFirewallPolicy_Associations[]>;
  ...
  packetMirroringRules?: BetaNetworkFirewallPolicy_PacketMirroringRules[] | Computed<BetaNetworkFirewallPolicy_PacketMirroringRules[]>;
  ...
  rules?: BetaNetworkFirewallPolicy_PacketMirroringRules[] | Computed<BetaNetworkFirewallPolicy_PacketMirroringRules[]>;
...
export interface BetaNetworkFirewallPolicyAttrs {
  /** A list of associations that belong to this firewall policy. */
  associations: BetaNetworkFirewallPolicy_Associations[];
  ...
  name: string;
  /** A list of packet mirroring rules that belong to this policy. */
  packetMirroringRules: BetaNetworkFirewallPolicy_PacketMirroringRules[];
  ...
  /** A list of rules that belong to this policy. There must always be a default rule (rule with priority 2147483647 and match "*"). If no rules are provided when creating a firewall policy, a default rule with action "allow" will be added. */
  rules: BetaNetworkFirewallPolicy_PacketMirroringRules[];
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
...
export const BetaNetworkFirewallPolicy: ResourceBinding<BetaNetworkFirewallPolicyConfig, BetaNetworkFirewallPolicyAttrs> = {
