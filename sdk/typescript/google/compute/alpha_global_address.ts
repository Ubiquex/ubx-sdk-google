...
export interface AlphaGlobalAddressConfig {
...
export interface AlphaGlobalAddressAttrs {
  /** The static IP address represented by this resource. */
  address: string;
  /** The type of address to reserve, either INTERNAL orEXTERNAL. If unspecified, defaults to EXTERNAL. */
  addressType: string;
...
export const AlphaGlobalAddress: ResourceBinding<AlphaGlobalAddressConfig, AlphaGlobalAddressAttrs> = {
  wireType: "google_compute_alpha_global_address",
  fields: {
    address: "address",
