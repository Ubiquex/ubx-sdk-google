...
export interface Tool_ClientFunction {
  ...
  parameters?: Tool_ClientFunction_Parameters | Computed<Tool_ClientFunction_Parameters>;
  /** Represents a select subset of an OpenAPI 3.0 schema object. */
  response?: Tool_ClientFunction_Parameters | Computed<Tool_ClientFunction_Parameters>;
}
...
export interface Tool_ConnectorTool_Action {
  ...
  entityOperation?: Tool_ConnectorTool_Action_EntityOperation | Computed<Tool_ConnectorTool_Action_EntityOperation>;
...
export interface Tool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig {
...
export interface Tool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig {
...
export interface Tool_ConnectorTool_AuthConfig {
  /** Oauth 2.0 Authorization Code authentication configuration. */
  oauth2AuthCodeConfig?: Tool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig | Computed<Tool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig>;
  /** JWT Profile Oauth 2.0 Authorization Grant authentication configuration. */
  oauth2JwtBearerConfig?: Tool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig | Computed<Tool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig>;
}
...
export interface Tool_ConnectorTool {
  ...
  action?: Tool_ConnectorTool_Action | Computed<Tool_ConnectorTool_Action>;
  ...
  authConfig?: Tool_ConnectorTool_AuthConfig | Computed<Tool_ConnectorTool_AuthConfig>;
...
export interface Tool_DataStoreTool_DataStoreSource_DataStore {
  ...
  connectorConfig?: Tool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfig | Computed<Tool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfig>;
...
export interface Tool_DataStoreTool_DataStoreSource {
  ...
  dataStore?: Tool_DataStoreTool_DataStoreSource_DataStore | Computed<Tool_DataStoreTool_DataStoreSource_DataStore>;
...
export interface Tool_DataStoreTool_EngineSource {
  ...
  dataStoreSources?: Tool_DataStoreTool_DataStoreSource[] | Computed<Tool_DataStoreTool_DataStoreSource[]>;
...
export interface Tool_DataStoreTool {
  ...
  boostSpecs?: Tool_DataStoreTool_BoostSpecs[] | Computed<Tool_DataStoreTool_BoostSpecs[]>;
  /** Configuration for searching within a specific DataStore. */
  dataStoreSource?: Tool_DataStoreTool_DataStoreSource | Computed<Tool_DataStoreTool_DataStoreSource>;
  /** Optional. The tool description. */
  description?: string | Computed<string>;
  /** Configuration for searching within an Engine, potentially targeting specific DataStores. */
  engineSource?: Tool_DataStoreTool_EngineSource | Computed<Tool_DataStoreTool_EngineSource>;
  /** Optional. The filter parameter behavior. */
  filterParameterBehavior?: string | Computed<string>;
  /** Optional. The modality configs for the data store. */
  modalityConfigs?: Tool_DataStoreTool_ModalityConfigs[] | Computed<Tool_DataStoreTool_ModalityConfigs[]>;
...
export interface Tool_GoogleSearchTool {
  ...
  promptConfig?: Tool_GoogleSearchTool_PromptConfig | Computed<Tool_GoogleSearchTool_PromptConfig>;
}
...
export interface Tool_McpTool_ApiAuthentication {
  ...
  apiKeyConfig?: Tool_McpTool_ApiAuthentication_ApiKeyConfig | Computed<Tool_McpTool_ApiAuthentication_ApiKeyConfig>;
  /** Configurations for authentication with a bearer token. */
  bearerTokenConfig?: Tool_McpTool_ApiAuthentication_BearerTokenConfig | Computed<Tool_McpTool_ApiAuthentication_BearerTokenConfig>;
  /** Configurations for authentication with OAuth. */
  oauthConfig?: Tool_McpTool_ApiAuthentication_OauthConfig | Computed<Tool_McpTool_ApiAuthentication_OauthConfig>;
  /** Configurations for authentication using a custom service account. */
  serviceAccountAuthConfig?: Tool_McpTool_ApiAuthentication_ServiceAccountAuthConfig | Computed<Tool_McpTool_ApiAuthentication_ServiceAccountAuthConfig>;
...
export interface Tool_McpTool_TlsConfig {
  ...
  caCerts?: Tool_McpTool_TlsConfig_CaCerts[] | Computed<Tool_McpTool_TlsConfig_CaCerts[]>;
}
...
export interface Tool_McpTool {
  ...
  description?: string | Computed<string>;
  /** Represents a select subset of an OpenAPI 3.0 schema object. */
  inputSchema?: Tool_ClientFunction_Parameters | Computed<Tool_ClientFunction_Parameters>;
  ...
  /** Represents a select subset of an OpenAPI 3.0 schema object. */
  outputSchema?: Tool_ClientFunction_Parameters | Computed<Tool_ClientFunction_Parameters>;
  ...
  serviceDirectoryConfig?: Tool_McpTool_ServiceDirectoryConfig | Computed<Tool_McpTool_ServiceDirectoryConfig>;
  /** Output only. The dynamic availability state of the tool on the external server. */
  state?: string | Computed<string>;
  /** The TLS configuration. */
  tlsConfig?: Tool_McpTool_TlsConfig | Computed<Tool_McpTool_TlsConfig>;
}
...
export interface Tool_RemoteAgentTool_AgentCard {
  ...
  skills?: Tool_RemoteAgentTool_AgentCard_Skills[] | Computed<Tool_RemoteAgentTool_AgentCard_Skills[]>;
  /** Required. Ordered list of supported interfaces. The first entry is preferred. */
  supportedInterfaces?: Tool_RemoteAgentTool_AgentCard_SupportedInterfaces[] | Computed<Tool_RemoteAgentTool_AgentCard_SupportedInterfaces[]>;
...
export interface Tool_ToolFakeConfig {
  ...
  codeBlock?: Tool_ToolFakeConfig_CodeBlock | Computed<Tool_ToolFakeConfig_CodeBlock>;
...
export interface Tool_WidgetTool {
  ...
  dataMapping?: Tool_WidgetTool_DataMapping | Computed<Tool_WidgetTool_DataMapping>;
  ...
  textResponseConfig?: Tool_WidgetTool_TextResponseConfig | Computed<Tool_WidgetTool_TextResponseConfig>;
...
const Tool_ConnectorTool_Action_EntityOperationFields: FieldMap = {
  entityId: "entity_id",
  operation: "operation",
};

const Tool_ConnectorTool_ActionFields: FieldMap = {
  connectionActionId: "connection_action_id",
  entityOperation: {
    wireName: "entity_operation",
    kind: "object",
    fields: Tool_ConnectorTool_Action_EntityOperationFields,
  },
  inputFields: "input_fields",
  outputFields: "output_fields",
};

const Tool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfigFields: FieldMap = {
  oauthToken: "oauth_token",
};

const Tool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfigFields: FieldMap = {
  clientKey: "client_key",
  issuer: "issuer",
  subject: "subject",
};

const Tool_ConnectorTool_AuthConfigFields: FieldMap = {
  oauth2AuthCodeConfig: {
    wireName: "oauth2_auth_code_config",
    kind: "object",
    fields: Tool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfigFields,
  },
  oauth2JwtBearerConfig: {
    wireName: "oauth2_jwt_bearer_config",
    kind: "object",
    fields: Tool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfigFields,
  },
};

const Tool_ConnectorToolFields: FieldMap = {
  action: {
    wireName: "action",
    kind: "object",
    fields: Tool_ConnectorTool_ActionFields,
  },
  authConfig: {
    wireName: "auth_config",
    kind: "object",
    fields: Tool_ConnectorTool_AuthConfigFields,
  },
...
const Tool_DataStoreTool_ModalityConfigsFields: FieldMap = {
  ...
  snippetsConfig: {
    ...
    kind: "object",
    fields: Tool_DataStoreTool_ModalityConfigs_SnippetsConfigFields,
  },
  summarizationConfig: {
...
const Tool_McpTool_ApiAuthentication_ApiKeyConfigFields: FieldMap = {
  apiKeySecretVersion: "api_key_secret_version",
  keyName: "key_name",
  requestLocation: "request_location",
};

const Tool_McpTool_ApiAuthentication_BearerTokenConfigFields: FieldMap = {
  token: "token",
};

const Tool_McpTool_ApiAuthentication_OauthConfigFields: FieldMap = {
  clientId: "client_id",
...
const Tool_McpTool_ApiAuthentication_ServiceAccountAuthConfigFields: FieldMap = {
  scopes: "scopes",
  serviceAccount: "service_account",
};

const Tool_McpTool_ApiAuthenticationFields: FieldMap = {
  apiKeyConfig: {
    wireName: "api_key_config",
    kind: "object",
    fields: Tool_McpTool_ApiAuthentication_ApiKeyConfigFields,
  },
  bearerTokenConfig: {
    wireName: "bearer_token_config",
    kind: "object",
    fields: Tool_McpTool_ApiAuthentication_BearerTokenConfigFields,
  },
  oauthConfig: {
    wireName: "oauth_config",
    kind: "object",
    fields: Tool_McpTool_ApiAuthentication_OauthConfigFields,
  },
  serviceAccountAuthConfig: {
    wireName: "service_account_auth_config",
    kind: "object",
    fields: Tool_McpTool_ApiAuthentication_ServiceAccountAuthConfigFields,
  },
  serviceAgentIdTokenAuthConfig: "service_agent_id_token_auth_config",
};

const Tool_McpTool_ServiceDirectoryConfigFields: FieldMap = {
  service: "service",
};

const Tool_McpTool_TlsConfig_CaCertsFields: FieldMap = {
  cert: "cert",
  displayName: "display_name",
};

const Tool_McpTool_TlsConfigFields: FieldMap = {
  caCerts: {
    wireName: "ca_certs",
    kind: "list",
    fields: Tool_McpTool_TlsConfig_CaCertsFields,
  },
};

const Tool_McpToolFields: FieldMap = {
  apiAuthentication: {
  ...
  serviceDirectoryConfig: {
    ...
    kind: "object",
    fields: Tool_McpTool_ServiceDirectoryConfigFields,
  },
  state: "state",
  tlsConfig: {
    wireName: "tls_config",
    kind: "object",
    fields: Tool_McpTool_TlsConfigFields,
  },
};

const Tool_OpenApiToolFields: FieldMap = {
  apiAuthentication: {
    wireName: "api_authentication",
    kind: "object",
    fields: Tool_McpTool_ApiAuthenticationFields,
...
const Tool_RemoteAgentTool_AgentCard_SkillsFields: FieldMap = {
  description: "description",
  examples: "examples",
  id: "id",
...
const Tool_RemoteAgentTool_AgentCard_SupportedInterfacesFields: FieldMap = {
...
const Tool_RemoteAgentTool_AgentCardFields: FieldMap = {
  description: "description",
  name: "name",
  skills: {
    wireName: "skills",
    kind: "list",
    fields: Tool_RemoteAgentTool_AgentCard_SkillsFields,
  },
  supportedInterfaces: {
    wireName: "supported_interfaces",
    kind: "list",
    fields: Tool_RemoteAgentTool_AgentCard_SupportedInterfacesFields,
  },
  version: "version",
};

const Tool_RemoteAgentToolFields: FieldMap = {
  agentCard: {
    wireName: "agent_card",
    kind: "object",
...
const Tool_SystemToolFields: FieldMap = {
  description: "description",
  name: "name",
};
...
export interface ToolConfig {
  ...
  connectorTool?: Tool_ConnectorTool | Computed<Tool_ConnectorTool>;
  ...
  mcpTool?: Tool_McpTool | Computed<Tool_McpTool>;
  ...
  openApiTool?: Tool_OpenApiTool | Computed<Tool_OpenApiTool>;
  /** A Python function tool. */
  pythonFunction?: Tool_PythonFunction | Computed<Tool_PythonFunction>;
  /** Represents a tool that allows the agent to call another remote agent. */
  remoteAgentTool?: Tool_RemoteAgentTool | Computed<Tool_RemoteAgentTool>;
  /** Pre-defined system tool. */
  systemTool?: Tool_SystemTool | Computed<Tool_SystemTool>;
...
export const Tool: ResourceBinding<ToolConfig, ToolAttrs> = {
  ...
  fields: {
    ...
    connectorTool: {
      ...
      kind: "object",
      fields: Tool_ConnectorToolFields,
    },
    dataStoreTool: {
    ...
    mcpTool: {
      wireName: "mcp_tool",
      kind: "object",
      fields: Tool_McpToolFields,
    },
    name: "name",
    openApiTool: {
      wireName: "open_api_tool",
      kind: "object",
      fields: Tool_OpenApiToolFields,
    },
    pythonFunction: {
      wireName: "python_function",
      kind: "object",
    ...
    remoteAgentTool: {
      ...
      kind: "object",
      fields: Tool_RemoteAgentToolFields,
    },
    systemTool: {
      wireName: "system_tool",
      kind: "object",
      fields: Tool_SystemToolFields,
    },
    timeout: "timeout",
    toolFakeConfig: {
