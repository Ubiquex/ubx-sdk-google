...
export interface V1betaCesV1betaScheduledEvaluationRun_Request_Config_InputAudioConfig {
...
export interface V1betaCesV1betaScheduledEvaluationRun_Request_Config_OutputAudioConfig {
...
export interface V1betaCesV1betaScheduledEvaluationRun_Request_Config {
  ...
  inputAudioConfig?: V1betaCesV1betaScheduledEvaluationRun_Request_Config_InputAudioConfig | Computed<V1betaCesV1betaScheduledEvaluationRun_Request_Config_InputAudioConfig>;
  /** OutputAudioConfig configures how the CES agent should synthesize outgoing audio responses. */
  outputAudioConfig?: V1betaCesV1betaScheduledEvaluationRun_Request_Config_OutputAudioConfig | Computed<V1betaCesV1betaScheduledEvaluationRun_Request_Config_OutputAudioConfig>;
...
export interface V1betaCesV1betaScheduledEvaluationRun_Request_EvaluationRunCachingSettings {
...
export interface V1betaCesV1betaScheduledEvaluationRun_Request_OptimizationConfig {
...
export interface V1betaCesV1betaScheduledEvaluationRun_Request_PersonaRunConfigs {
  persona?: string | Computed<string>;
  taskCount?: number | Computed<number>;
}

export interface V1betaCesV1betaScheduledEvaluationRun_Request {
  ...
  config?: V1betaCesV1betaScheduledEvaluationRun_Request_Config | Computed<V1betaCesV1betaScheduledEvaluationRun_Request_Config>;
  ...
  evaluationRunCachingSettings?: V1betaCesV1betaScheduledEvaluationRun_Request_EvaluationRunCachingSettings | Computed<V1betaCesV1betaScheduledEvaluationRun_Request_EvaluationRunCachingSettings>;
  ...
  optimizationConfig?: V1betaCesV1betaScheduledEvaluationRun_Request_OptimizationConfig | Computed<V1betaCesV1betaScheduledEvaluationRun_Request_OptimizationConfig>;
  /** Optional. The configuration to use for the run per persona. */
  personaRunConfigs?: V1betaCesV1betaScheduledEvaluationRun_Request_PersonaRunConfigs[] | Computed<V1betaCesV1betaScheduledEvaluationRun_Request_PersonaRunConfigs[]>;
...
export interface V1betaCesV1betaScheduledEvaluationRun_SchedulingConfig {
...
const V1betaCesV1betaScheduledEvaluationRun_Request_Config_InputAudioConfigFields: FieldMap = {
  audioEncoding: "audio_encoding",
  noiseSuppressionLevel: "noise_suppression_level",
  sampleRateHertz: "sample_rate_hertz",
};

const V1betaCesV1betaScheduledEvaluationRun_Request_Config_OutputAudioConfigFields: FieldMap = {
  audioEncoding: "audio_encoding",
  sampleRateHertz: "sample_rate_hertz",
};

const V1betaCesV1betaScheduledEvaluationRun_Request_ConfigFields: FieldMap = {
...
const V1betaCesV1betaScheduledEvaluationRun_Request_EvaluationRunCachingSettingsFields: FieldMap = {
  runCachingMode: "run_caching_mode",
};

const V1betaCesV1betaScheduledEvaluationRun_Request_OptimizationConfigFields: FieldMap = {
...
const V1betaCesV1betaScheduledEvaluationRun_Request_PersonaRunConfigsFields: FieldMap = {
  persona: "persona",
  taskCount: "task_count",
};

const V1betaCesV1betaScheduledEvaluationRun_RequestFields: FieldMap = {
  app: "app",
...
const V1betaCesV1betaScheduledEvaluationRun_SchedulingConfigFields: FieldMap = {
  daysOfWeek: "days_of_week",
  frequency: "frequency",
  startTime: "start_time",
};

export interface V1betaCesV1betaScheduledEvaluationRunConfig {
  ...
  request?: V1betaCesV1betaScheduledEvaluationRun_Request | Computed<V1betaCesV1betaScheduledEvaluationRun_Request>;
  /** Eval scheduling configuration details */
  schedulingConfig?: V1betaCesV1betaScheduledEvaluationRun_SchedulingConfig | Computed<V1betaCesV1betaScheduledEvaluationRun_SchedulingConfig>;
...
export interface V1betaCesV1betaScheduledEvaluationRunAttrs {
  /** Optional. Whether this config is active */
  active: boolean;
  /** Output only. Timestamp when the scheduled evaluation run was created. */
  createTime: string;
  ...
  /** Request message for EvaluationService.RunEvaluation. */
  request: V1betaCesV1betaScheduledEvaluationRun_Request;
  /** Eval scheduling configuration details */
  schedulingConfig: V1betaCesV1betaScheduledEvaluationRun_SchedulingConfig;
  /** Output only. The total number of times this run has been executed */
...
export const V1betaCesV1betaScheduledEvaluationRun: ResourceBinding<V1betaCesV1betaScheduledEvaluationRunConfig, V1betaCesV1betaScheduledEvaluationRunAttrs> = {
