...
export interface V1betaAgent_AfterAgentCallbacks {
...
export interface V1betaAgent_ModelSettings {
...
export interface V1betaAgent_Toolsets {
  toolIds?: string[] | Computed<string[]>;
  toolset?: string | Computed<string>;
}

export interface V1betaAgent_TransferRules_DeterministicTransfer_ExpressionCondition {
  expression?: string | Computed<string>;
}

export interface V1betaAgent_TransferRules_DeterministicTransfer_PythonCodeCondition {
  pythonCode?: string | Computed<string>;
}

export interface V1betaAgent_TransferRules_DeterministicTransfer {
  expressionCondition?: V1betaAgent_TransferRules_DeterministicTransfer_ExpressionCondition | Computed<V1betaAgent_TransferRules_DeterministicTransfer_ExpressionCondition>;
  pythonCodeCondition?: V1betaAgent_TransferRules_DeterministicTransfer_PythonCodeCondition | Computed<V1betaAgent_TransferRules_DeterministicTransfer_PythonCodeCondition>;
}

export interface V1betaAgent_TransferRules_DisablePlannerTransfer {
  expressionCondition?: V1betaAgent_TransferRules_DeterministicTransfer_ExpressionCondition | Computed<V1betaAgent_TransferRules_DeterministicTransfer_ExpressionCondition>;
}

export interface V1betaAgent_TransferRules {
  childAgent?: string | Computed<string>;
  deterministicTransfer?: V1betaAgent_TransferRules_DeterministicTransfer | Computed<V1betaAgent_TransferRules_DeterministicTransfer>;
  direction?: string | Computed<string>;
  disablePlannerTransfer?: V1betaAgent_TransferRules_DisablePlannerTransfer | Computed<V1betaAgent_TransferRules_DisablePlannerTransfer>;
}

const V1betaAgent_AfterAgentCallbacksFields: FieldMap = {
...
const V1betaAgent_ToolsetsFields: FieldMap = {
  toolIds: "tool_ids",
  toolset: "toolset",
};

const V1betaAgent_TransferRules_DeterministicTransfer_ExpressionConditionFields: FieldMap = {
  expression: "expression",
};

const V1betaAgent_TransferRules_DeterministicTransfer_PythonCodeConditionFields: FieldMap = {
  pythonCode: "python_code",
};

const V1betaAgent_TransferRules_DeterministicTransferFields: FieldMap = {
  expressionCondition: {
...
const V1betaAgent_TransferRules_DisablePlannerTransferFields: FieldMap = {
  expressionCondition: {
    wireName: "expression_condition",
    kind: "object",
    fields: V1betaAgent_TransferRules_DeterministicTransfer_ExpressionConditionFields,
...
const V1betaAgent_TransferRulesFields: FieldMap = {
...
export interface V1betaAgentConfig {
  ...
  afterAgentCallbacks?: V1betaAgent_AfterAgentCallbacks[] | Computed<V1betaAgent_AfterAgentCallbacks[]>;
  /** Optional. The callbacks to execute after the model is called. If there are multiple calls to the model, the callback will be executed multiple times. The provided callbacks are executed sequentially in the exact order they are given in the list. If a callback returns an overridden response, execution stops and any remaining callbacks are skipped. */
  afterModelCallbacks?: V1betaAgent_AfterAgentCallbacks[] | Computed<V1betaAgent_AfterAgentCallbacks[]>;
  ...
  afterToolCallbacks?: V1betaAgent_AfterAgentCallbacks[] | Computed<V1betaAgent_AfterAgentCallbacks[]>;
  ...
  beforeAgentCallbacks?: V1betaAgent_AfterAgentCallbacks[] | Computed<V1betaAgent_AfterAgentCallbacks[]>;
  /** Optional. The callbacks to execute before the model is called. If there are multiple calls to the model, the callback will be executed multiple times. The provided callbacks are executed sequentially in the exact order they are given in the list. If a callback returns an overridden response, execution stops and any remaining callbacks are skipped. */
  beforeModelCallbacks?: V1betaAgent_AfterAgentCallbacks[] | Computed<V1betaAgent_AfterAgentCallbacks[]>;
  ...
  beforeToolCallbacks?: V1betaAgent_AfterAgentCallbacks[] | Computed<V1betaAgent_AfterAgentCallbacks[]>;
  ...
  toolsets?: V1betaAgent_Toolsets[] | Computed<V1betaAgent_Toolsets[]>;
  /** Optional. Agent transfer rules. If multiple rules match, the first one in the list will be used. */
  transferRules?: V1betaAgent_TransferRules[] | Computed<V1betaAgent_TransferRules[]>;
}

export interface V1betaAgentAttrs {
  /** Optional. The callbacks to execute after the agent is called. The provided callbacks are executed sequentially in the exact order they are given in the list. If a callback returns an overridden response, execution stops and any remaining callbacks are skipped. */
  afterAgentCallbacks: V1betaAgent_AfterAgentCallbacks[];
  /** Optional. The callbacks to execute after the model is called. If there are multiple calls to the model, the callback will be executed multiple times. The provided callbacks are executed sequentially in the exact order they are given in the list. If a callback returns an overridden response, execution stops and any remaining callbacks are skipped. */
  afterModelCallbacks: V1betaAgent_AfterAgentCallbacks[];
  /** Optional. The callbacks to execute after the tool is invoked. If there are multiple tool invocations, the callback will be executed multiple times. The provided callbacks are executed sequentially in the exact order they are given in the list. If a callback returns an overridden response, execution stops and any remaining callbacks are skipped. */
  afterToolCallbacks: V1betaAgent_AfterAgentCallbacks[];
  /** Optional. The callbacks to execute before the agent is called. The provided callbacks are executed sequentially in the exact order they are given in the list. If a callback returns an overridden response, execution stops and any remaining callbacks are skipped. */
  beforeAgentCallbacks: V1betaAgent_AfterAgentCallbacks[];
  /** Optional. The callbacks to execute before the model is called. If there are multiple calls to the model, the callback will be executed multiple times. The provided callbacks are executed sequentially in the exact order they are given in the list. If a callback returns an overridden response, execution stops and any remaining callbacks are skipped. */
  beforeModelCallbacks: V1betaAgent_AfterAgentCallbacks[];
  /** Optional. The callbacks to execute before the tool is invoked. If there are multiple tool invocations, the callback will be executed multiple times. The provided callbacks are executed sequentially in the exact order they are given in the list. If a callback returns an overridden response, execution stops and any remaining callbacks are skipped. */
  beforeToolCallbacks: V1betaAgent_AfterAgentCallbacks[];
  /** Optional. List of child agents in the agent tree. Format: `projects/{project}/locations/{location}/apps/{app}/agents/{agent}` */
  childAgents: string[];
  ...
  tools: string[];
  /** Optional. List of toolsets for the agent. */
  toolsets: V1betaAgent_Toolsets[];
  /** Optional. Agent transfer rules. If multiple rules match, the first one in the list will be used. */
  transferRules: V1betaAgent_TransferRules[];
...
export const V1betaAgent: ResourceBinding<V1betaAgentConfig, V1betaAgentAttrs> = {
