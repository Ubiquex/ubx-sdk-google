...
export interface V1betaApp_AudioProcessingConfig_AmbientSoundConfig {
...
export interface V1betaApp_AudioProcessingConfig_BargeInConfig {
...
export interface V1betaApp_AudioProcessingConfig {
  ...
  synthesizeSpeechConfigs?: Record<string, V1betaApp_AudioProcessingConfig_SynthesizeSpeechConfigs> | Computed<Record<string, V1betaApp_AudioProcessingConfig_SynthesizeSpeechConfigs>>;
}

export interface V1betaApp_ClientCertificateSettings {
...
export interface V1betaApp_DataStoreSettings {
  /** Output only. The engines for the app. */
  engines?: V1betaApp_DataStoreSettings_Engines[] | Computed<V1betaApp_DataStoreSettings_Engines[]>;
}

export interface V1betaApp_DefaultChannelProfile_InstagramConfig {
...
export interface V1betaApp_DefaultChannelProfile_PersonaProperty {
  /** Optional. The persona of the channel. */
  persona?: string | Computed<string>;
}

export interface V1betaApp_DefaultChannelProfile_WebWidgetConfig_SecuritySettings {
...
export interface V1betaApp_DefaultChannelProfile_WebWidgetConfig {
  /** Optional. The modality of the web widget. */
  modality?: string | Computed<string>;
  /** Security settings for the web widget. */
  securitySettings?: V1betaApp_DefaultChannelProfile_WebWidgetConfig_SecuritySettings | Computed<V1betaApp_DefaultChannelProfile_WebWidgetConfig_SecuritySettings>;
...
export interface V1betaApp_DefaultChannelProfile_WhatsappConfig {
  /** Output only. The description of the Meta business page or profile. */
  description?: string | Computed<string>;
  /** Output only. The fetched Meta business page name. */
  displayName?: string | Computed<string>;
...
export interface V1betaApp_DefaultChannelProfile {
  ...
  instagramConfig?: V1betaApp_DefaultChannelProfile_InstagramConfig | Computed<V1betaApp_DefaultChannelProfile_InstagramConfig>;
  ...
  personaProperty?: V1betaApp_DefaultChannelProfile_PersonaProperty | Computed<V1betaApp_DefaultChannelProfile_PersonaProperty>;
  /** Optional. The unique identifier of the channel profile. */
  profileId?: string | Computed<string>;
  /** Message for configuration for the web widget. */
  webWidgetConfig?: V1betaApp_DefaultChannelProfile_WebWidgetConfig | Computed<V1betaApp_DefaultChannelProfile_WebWidgetConfig>;
  /** Configuration specific to WhatsApp deployments. */
  whatsappConfig?: V1betaApp_DefaultChannelProfile_WhatsappConfig | Computed<V1betaApp_DefaultChannelProfile_WhatsappConfig>;
}

export interface V1betaApp_ErrorHandlingSettings_EndSessionConfig {
...
export interface V1betaApp_ErrorHandlingSettings_FallbackResponseConfig {
...
export interface V1betaApp_ErrorHandlingSettings {
  /** Configuration for ending the session in case of system errors (e.g. LLM errors). */
  endSessionConfig?: V1betaApp_ErrorHandlingSettings_EndSessionConfig | Computed<V1betaApp_ErrorHandlingSettings_EndSessionConfig>;
  /** Optional. The strategy to use for error handling. */
  errorHandlingStrategy?: string | Computed<string>;
  /** Configuration for handling fallback responses. */
  fallbackResponseConfig?: V1betaApp_ErrorHandlingSettings_FallbackResponseConfig | Computed<V1betaApp_ErrorHandlingSettings_FallbackResponseConfig>;
}

export interface V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholds {
...
export interface V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ToolMatchingSettings {
  /** Optional. Behavior for extra tool calls. Defaults to FAIL. */
  extraToolCallBehavior?: string | Computed<string>;
}

export interface V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholds {
...
export interface V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds {
  /** Expectation level metrics thresholds. */
  expectationLevelMetricsThresholds?: V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholds | Computed<V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholds>;
  /** Settings for matching tool calls. */
  toolMatchingSettings?: V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ToolMatchingSettings | Computed<V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ToolMatchingSettings>;
  /** Turn level metrics thresholds. */
  turnLevelMetricsThresholds?: V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholds | Computed<V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholds>;
}

export interface V1betaApp_EvaluationMetricsThresholds {
  /** Settings for golden evaluations. */
  goldenEvaluationMetricsThresholds?: V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds | Computed<V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds>;
...
export interface V1betaApp_EvaluationPersonas_SpeechConfig {
  environment?: string | Computed<string>;
  speakingRate?: number | Computed<number>;
  voiceId?: string | Computed<string>;
}

export interface V1betaApp_EvaluationPersonas {
  description?: string | Computed<string>;
  displayName?: string | Computed<string>;
  name?: string | Computed<string>;
  personality?: string | Computed<string>;
  speechConfig?: V1betaApp_EvaluationPersonas_SpeechConfig | Computed<V1betaApp_EvaluationPersonas_SpeechConfig>;
}

export interface V1betaApp_EvaluationSettings_EvaluationRunCachingSettings {
...
export interface V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_SemanticSimilarityMetricsConfig {
...
export interface V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_StepToolCorrectnessMetricsConfig {
...
export interface V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig {
  ...
  semanticSimilarityMetricsConfig?: V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_SemanticSimilarityMetricsConfig | Computed<V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_SemanticSimilarityMetricsConfig>;
  ...
  stepToolCorrectnessMetricsConfig?: V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_StepToolCorrectnessMetricsConfig | Computed<V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_StepToolCorrectnessMetricsConfig>;
  /** Configuration for correctness metrics for the evaluation. To disable the metric, set the message but do not set the `enable_tool_correctness_metrics` field to true (or explicitly set it to false). To unset the configuration and fallback to the default behavior, omit the message entirely. */
  toolCorrectnessMetricsConfig?: V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_StepToolCorrectnessMetricsConfig | Computed<V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_StepToolCorrectnessMetricsConfig>;
}

export interface V1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig_ExpectationsMetMetricsConfig {
...
export interface V1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig_UserGoalMetMetricsConfig {
...
export interface V1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig {
  ...
  expectationsMetMetricsConfig?: V1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig_ExpectationsMetMetricsConfig | Computed<V1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig_ExpectationsMetMetricsConfig>;
  ...
  userGoalMetMetricsConfig?: V1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig_UserGoalMetMetricsConfig | Computed<V1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig_UserGoalMetMetricsConfig>;
}

export interface V1betaApp_EvaluationSettings_MetricsConfig {
  /** Configuration for the golden metrics for the evaluation. */
  goldenMetricsConfig?: V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig | Computed<V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig>;
  /** Configuration for the scenario metrics for the evaluation. */
  scenarioMetricsConfig?: V1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig | Computed<V1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig>;
}

export interface V1betaApp_EvaluationSettings {
  /** Settings for evaluation run caching. */
  evaluationRunCachingSettings?: V1betaApp_EvaluationSettings_EvaluationRunCachingSettings | Computed<V1betaApp_EvaluationSettings_EvaluationRunCachingSettings>;
  ...
  metricsConfig?: V1betaApp_EvaluationSettings_MetricsConfig | Computed<V1betaApp_EvaluationSettings_MetricsConfig>;
...
export interface V1betaApp_LanguageSettings {
...
export interface V1betaApp_LoggingSettings_AudioRecordingConfig {
...
export interface V1betaApp_LoggingSettings_BigqueryExportSettings {
...
export interface V1betaApp_LoggingSettings_CloudLoggingSettings {
  /** Optional. Whether to enable Cloud Logging for the sessions. */
  enableCloudLogging?: boolean | Computed<boolean>;
}

export interface V1betaApp_LoggingSettings_ConversationLoggingSettings {
...
export interface V1betaApp_LoggingSettings_MetricAnalysisSettings {
...
export interface V1betaApp_LoggingSettings_RedactionConfig {
...
export interface V1betaApp_LoggingSettings {
  /** Configuration for how the audio interactions should be recorded. */
  audioRecordingConfig?: V1betaApp_LoggingSettings_AudioRecordingConfig | Computed<V1betaApp_LoggingSettings_AudioRecordingConfig>;
  /** Settings to describe the BigQuery export behaviors for the app. */
  bigqueryExportSettings?: V1betaApp_LoggingSettings_BigqueryExportSettings | Computed<V1betaApp_LoggingSettings_BigqueryExportSettings>;
  /** Settings to describe the Cloud Logging behaviors for the app. */
  cloudLoggingSettings?: V1betaApp_LoggingSettings_CloudLoggingSettings | Computed<V1betaApp_LoggingSettings_CloudLoggingSettings>;
  /** Settings to describe the conversation logging behaviors for the app. */
  conversationLoggingSettings?: V1betaApp_LoggingSettings_ConversationLoggingSettings | Computed<V1betaApp_LoggingSettings_ConversationLoggingSettings>;
  /** Configuration for how the audio interactions should be recorded. */
  evaluationAudioRecordingConfig?: V1betaApp_LoggingSettings_AudioRecordingConfig | Computed<V1betaApp_LoggingSettings_AudioRecordingConfig>;
  /** Settings to describe the conversation data collection behaviors for LLM analysis metrics pipeline. */
  metricAnalysisSettings?: V1betaApp_LoggingSettings_MetricAnalysisSettings | Computed<V1betaApp_LoggingSettings_MetricAnalysisSettings>;
  /** Configuration to instruct how sensitive data should be handled. */
  redactionConfig?: V1betaApp_LoggingSettings_RedactionConfig | Computed<V1betaApp_LoggingSettings_RedactionConfig>;
  /** Configuration for how the audio interactions should be recorded. */
  unredactedAudioRecordingConfig?: V1betaApp_LoggingSettings_AudioRecordingConfig | Computed<V1betaApp_LoggingSettings_AudioRecordingConfig>;
  /** Settings to describe the BigQuery export behaviors for the app. */
  unredactedBigqueryExportSettings?: V1betaApp_LoggingSettings_BigqueryExportSettings | Computed<V1betaApp_LoggingSettings_BigqueryExportSettings>;
}

export interface V1betaApp_ModelSettings {
...
export interface V1betaApp_PredefinedVariableDeclarations_Schema {
...
export interface V1betaApp_PredefinedVariableDeclarations {
  description?: string | Computed<string>;
  name?: string | Computed<string>;
  schema?: V1betaApp_PredefinedVariableDeclarations_Schema | Computed<V1betaApp_PredefinedVariableDeclarations_Schema>;
}

export interface V1betaApp_TimeZoneSettings {
...
export interface V1betaApp_VpcScSettings {
...
const V1betaApp_AudioProcessingConfig_AmbientSoundConfigFields: FieldMap = {
  gcsUri: "gcs_uri",
...
const V1betaApp_AudioProcessingConfig_BargeInConfigFields: FieldMap = {
...
const V1betaApp_AudioProcessingConfigFields: FieldMap = {
  ambientSoundConfig: {
...
const V1betaApp_ClientCertificateSettingsFields: FieldMap = {
...
const V1betaApp_DataStoreSettingsFields: FieldMap = {
  engines: {
    wireName: "engines",
    kind: "list",
...
const V1betaApp_DefaultChannelProfile_InstagramConfigFields: FieldMap = {
...
const V1betaApp_DefaultChannelProfile_PersonaPropertyFields: FieldMap = {
  persona: "persona",
};

const V1betaApp_DefaultChannelProfile_WebWidgetConfig_SecuritySettingsFields: FieldMap = {
...
const V1betaApp_DefaultChannelProfile_WebWidgetConfigFields: FieldMap = {
  modality: "modality",
  securitySettings: {
...
const V1betaApp_DefaultChannelProfile_WhatsappConfigFields: FieldMap = {
  description: "description",
  displayName: "display_name",
...
const V1betaApp_DefaultChannelProfileFields: FieldMap = {
...
const V1betaApp_ErrorHandlingSettings_EndSessionConfigFields: FieldMap = {
  escalateSession: "escalate_session",
};

const V1betaApp_ErrorHandlingSettings_FallbackResponseConfigFields: FieldMap = {
  customFallbackMessages: "custom_fallback_messages",
  maxFallbackAttempts: "max_fallback_attempts",
};

const V1betaApp_ErrorHandlingSettingsFields: FieldMap = {
  endSessionConfig: {
...
const V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholdsFields: FieldMap = {
  toolInvocationParameterCorrectnessThreshold: "tool_invocation_parameter_correctness_threshold",
};

const V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ToolMatchingSettingsFields: FieldMap = {
  extraToolCallBehavior: "extra_tool_call_behavior",
};

const V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholdsFields: FieldMap = {
...
const V1betaApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholdsFields: FieldMap = {
...
const V1betaApp_EvaluationMetricsThresholdsFields: FieldMap = {
...
const V1betaApp_EvaluationPersonas_SpeechConfigFields: FieldMap = {
  environment: "environment",
  speakingRate: "speaking_rate",
  voiceId: "voice_id",
};

const V1betaApp_EvaluationPersonasFields: FieldMap = {
  description: "description",
  displayName: "display_name",
  name: "name",
...
const V1betaApp_EvaluationSettings_EvaluationRunCachingSettingsFields: FieldMap = {
  runCachingMode: "run_caching_mode",
};

const V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_SemanticSimilarityMetricsConfigFields: FieldMap = {
  enableSemanticSimilarityMetrics: "enable_semantic_similarity_metrics",
};

const V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfig_StepToolCorrectnessMetricsConfigFields: FieldMap = {
  enableToolCorrectnessMetrics: "enable_tool_correctness_metrics",
};

const V1betaApp_EvaluationSettings_MetricsConfig_GoldenMetricsConfigFields: FieldMap = {
...
const V1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig_ExpectationsMetMetricsConfigFields: FieldMap = {
  enableExpectationsMetMetrics: "enable_expectations_met_metrics",
};

const V1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfig_UserGoalMetMetricsConfigFields: FieldMap = {
  enableUserGoalMetMetrics: "enable_user_goal_met_metrics",
};

const V1betaApp_EvaluationSettings_MetricsConfig_ScenarioMetricsConfigFields: FieldMap = {
...
const V1betaApp_EvaluationSettings_MetricsConfigFields: FieldMap = {
  goldenMetricsConfig: {
...
const V1betaApp_EvaluationSettingsFields: FieldMap = {
...
const V1betaApp_LanguageSettingsFields: FieldMap = {
...
const V1betaApp_LoggingSettings_AudioRecordingConfigFields: FieldMap = {
  gcsBucket: "gcs_bucket",
  gcsPathPrefix: "gcs_path_prefix",
};

const V1betaApp_LoggingSettings_BigqueryExportSettingsFields: FieldMap = {
  dataset: "dataset",
  enabled: "enabled",
  project: "project",
};

const V1betaApp_LoggingSettings_CloudLoggingSettingsFields: FieldMap = {
  enableCloudLogging: "enable_cloud_logging",
};

const V1betaApp_LoggingSettings_ConversationLoggingSettingsFields: FieldMap = {
  disableConversationLogging: "disable_conversation_logging",
  retentionWindow: "retention_window",
};

const V1betaApp_LoggingSettings_MetricAnalysisSettingsFields: FieldMap = {
  llmMetricsOptedOut: "llm_metrics_opted_out",
};

const V1betaApp_LoggingSettings_RedactionConfigFields: FieldMap = {
  deidentifyTemplate: "deidentify_template",
  enableRedaction: "enable_redaction",
  inspectTemplate: "inspect_template",
};

const V1betaApp_LoggingSettingsFields: FieldMap = {
...
const V1betaApp_ModelSettingsFields: FieldMap = {
  model: "model",
...
const V1betaApp_PredefinedVariableDeclarationsFields: FieldMap = {
  description: "description",
  name: "name",
  schema: {
    wireName: "schema",
...
export interface V1betaAppConfig {
  ...
  evaluationPersonas?: V1betaApp_EvaluationPersonas[] | Computed<V1betaApp_EvaluationPersonas[]>;
  /** Settings for evaluation. */
  evaluationSettings?: V1betaApp_EvaluationSettings | Computed<V1betaApp_EvaluationSettings>;
  ...
  languageSettings?: V1betaApp_LanguageSettings | Computed<V1betaApp_LanguageSettings>;
  ...
  loggingSettings?: V1betaApp_LoggingSettings | Computed<V1betaApp_LoggingSettings>;
  ...
  modelSettings?: V1betaApp_ModelSettings | Computed<V1betaApp_ModelSettings>;
  ...
  vpcScSettings?: V1betaApp_VpcScSettings | Computed<V1betaApp_VpcScSettings>;
}

export interface V1betaAppAttrs {
  /** Configuration for how the input and output audio should be processed and delivered. */
  audioProcessingConfig: V1betaApp_AudioProcessingConfig;
  /** Settings for custom client certificates. */
  ...
  /** A ChannelProfile configures the agent's behavior for a specific communication channel, such as web UI or telephony. */
  defaultChannelProfile: V1betaApp_DefaultChannelProfile;
  /** Output only. Number of deployments in the app. */
  ...
  displayName: string;
  /** Settings to describe how errors should be handled in the app. */
  errorHandlingSettings: V1betaApp_ErrorHandlingSettings;
  /** Output only. Etag used to ensure the object hasn't changed during a read-modify-write operation. If the etag is empty, the update will overwrite any concurrent changes. */
  etag: string;
  /** Threshold settings for metrics in an Evaluation. */
  evaluationMetricsThresholds: V1betaApp_EvaluationMetricsThresholds;
  /** Optional. The evaluation personas for the app. This field is used to define the personas that can be used for evaluation. Maximum of 30 personas can be defined. */
  evaluationPersonas: V1betaApp_EvaluationPersonas[];
  /** Settings for evaluation. */
  evaluationSettings: V1betaApp_EvaluationSettings;
  /** Optional. Instructions for all the agents in the app. You can use this instruction to set up a stable identity or personality across all the agents. */
  globalInstruction: string;
  /** Optional. List of guardrails for the app. Format: `projects/{project}/locations/{location}/apps/{app}/guardrails/{guardrail}` */
  guardrails: string[];
  /** Language settings of the app. */
  languageSettings: V1betaApp_LanguageSettings;
  /** Optional. Indicates whether the app is locked for changes. If the app is locked, modifications to the app resources will be rejected. */
  locked: boolean;
  /** Settings to describe the logging behaviors for the app. */
  loggingSettings: V1betaApp_LoggingSettings;
  /** Optional. Metadata about the app. This field can be used to store additional information relevant to the app's details or intended usages. */
  metadata: Record<string, string>;
  /** Model settings contains various configurations for the LLM model. */
  modelSettings: V1betaApp_ModelSettings;
  /** Identifier. The unique identifier of the app. Format: `projects/{project}/locations/{location}/apps/{app}` */
  name: string;
  /** Optional. Whether the app is pinned in the app list. */
  pinned: boolean;
  /** Output only. The declarations of predefined variables for the app. */
  predefinedVariableDeclarations: V1betaApp_PredefinedVariableDeclarations[];
  /** Optional. The root agent is the entry point of the app. Format: `projects/{project}/locations/{location}/apps/{app}/agents/{agent}` */
  rootAgent: string;
  /** TimeZone settings of the app. */
  timeZoneSettings: V1betaApp_TimeZoneSettings;
  /** Optional. The tool execution mode for the app. If not provided, will default to PARALLEL. */
  ...
  /** Optional. The declarations of the variables. */
  variableDeclarations: V1betaApp_PredefinedVariableDeclarations[];
  /** VPC-SC settings for the app. */
  vpcScSettings: V1betaApp_VpcScSettings;
}

export const V1betaApp: ResourceBinding<V1betaAppConfig, V1betaAppAttrs> = {
