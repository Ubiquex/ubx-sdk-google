// Code generated by `ubx sdk gen` from google_ces_v1beta_tool. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1betaTool_AgentTool {
...
export interface V1betaTool_ClientFunction_Parameters {
...
export interface V1betaTool_ClientFunction {
  /** Optional. The function description. */
  description?: string | Computed<string>;
  /** Required. The function name. */
  name?: string | Computed<string>;
  /** Represents a select subset of an OpenAPI 3.0 schema object. */
  parameters?: V1betaTool_ClientFunction_Parameters | Computed<V1betaTool_ClientFunction_Parameters>;
  /** Represents a select subset of an OpenAPI 3.0 schema object. */
  response?: V1betaTool_ClientFunction_Parameters | Computed<V1betaTool_ClientFunction_Parameters>;
}

export interface V1betaTool_ConnectorTool_Action_EntityOperation {
...
export interface V1betaTool_ConnectorTool_Action {
  /** ID of a Connection action for the tool to use. */
  connectionActionId?: string | Computed<string>;
  /** Entity CRUD operation specification. */
  entityOperation?: V1betaTool_ConnectorTool_Action_EntityOperation | Computed<V1betaTool_ConnectorTool_Action_EntityOperation>;
...
export interface V1betaTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig {
...
export interface V1betaTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig {
...
export interface V1betaTool_ConnectorTool_AuthConfig {
  /** Oauth 2.0 Authorization Code authentication configuration. */
  oauth2AuthCodeConfig?: V1betaTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig | Computed<V1betaTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig>;
  /** JWT Profile Oauth 2.0 Authorization Grant authentication configuration. */
  oauth2JwtBearerConfig?: V1betaTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig | Computed<V1betaTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig>;
}

export interface V1betaTool_ConnectorTool {
  ...
  action?: V1betaTool_ConnectorTool_Action | Computed<V1betaTool_ConnectorTool_Action>;
  ...
  authConfig?: V1betaTool_ConnectorTool_AuthConfig | Computed<V1betaTool_ConnectorTool_AuthConfig>;
...
export interface V1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPoints {
  attributeValue?: string | Computed<string>;
  boostAmount?: number | Computed<number>;
}

export interface V1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec {
  attributeType?: string | Computed<string>;
  controlPoints?: V1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPoints[] | Computed<V1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPoints[]>;
  fieldName?: string | Computed<string>;
  interpolationType?: string | Computed<string>;
}

export interface V1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs {
  boost?: number | Computed<number>;
  boostControlSpec?: V1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec | Computed<V1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec>;
  condition?: string | Computed<string>;
}

export interface V1betaTool_DataStoreTool_BoostSpecs_Spec {
  conditionBoostSpecs?: V1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs[] | Computed<V1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs[]>;
}

export interface V1betaTool_DataStoreTool_BoostSpecs {
  dataStores?: string[] | Computed<string[]>;
  spec?: V1betaTool_DataStoreTool_BoostSpecs_Spec[] | Computed<V1betaTool_DataStoreTool_BoostSpecs_Spec[]>;
}

export interface V1betaTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfig {
...
export interface V1betaTool_DataStoreTool_DataStoreSource_DataStore {
  /** The connector config for the data store connection. */
  connectorConfig?: V1betaTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfig | Computed<V1betaTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfig>;
...
export interface V1betaTool_DataStoreTool_DataStoreSource {
  /** A DataStore resource in Vertex AI Search. */
  dataStore?: V1betaTool_DataStoreTool_DataStoreSource_DataStore | Computed<V1betaTool_DataStoreTool_DataStoreSource_DataStore>;
...
export interface V1betaTool_DataStoreTool_EngineSource {
  ...
  dataStoreSources?: V1betaTool_DataStoreTool_DataStoreSource[] | Computed<V1betaTool_DataStoreTool_DataStoreSource[]>;
...
export interface V1betaTool_DataStoreTool_ModalityConfigs_GroundingConfig {
  disabled?: boolean | Computed<boolean>;
  groundingLevel?: number | Computed<number>;
}

export interface V1betaTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettings {
  model?: string | Computed<string>;
  temperature?: number | Computed<number>;
}

export interface V1betaTool_DataStoreTool_ModalityConfigs_RewriterConfig {
  disabled?: boolean | Computed<boolean>;
  modelSettings?: V1betaTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettings | Computed<V1betaTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettings>;
  prompt?: string | Computed<string>;
}

export interface V1betaTool_DataStoreTool_ModalityConfigs_SnippetsConfig {
  enableSnippets?: boolean | Computed<boolean>;
}

export interface V1betaTool_DataStoreTool_ModalityConfigs {
  groundingConfig?: V1betaTool_DataStoreTool_ModalityConfigs_GroundingConfig | Computed<V1betaTool_DataStoreTool_ModalityConfigs_GroundingConfig>;
  modalityType?: string | Computed<string>;
  rewriterConfig?: V1betaTool_DataStoreTool_ModalityConfigs_RewriterConfig | Computed<V1betaTool_DataStoreTool_ModalityConfigs_RewriterConfig>;
  snippetsConfig?: V1betaTool_DataStoreTool_ModalityConfigs_SnippetsConfig | Computed<V1betaTool_DataStoreTool_ModalityConfigs_SnippetsConfig>;
  summarizationConfig?: V1betaTool_DataStoreTool_ModalityConfigs_RewriterConfig | Computed<V1betaTool_DataStoreTool_ModalityConfigs_RewriterConfig>;
}

export interface V1betaTool_DataStoreTool {
  /** Optional. Boost specification to boost certain documents. */
  boostSpecs?: V1betaTool_DataStoreTool_BoostSpecs[] | Computed<V1betaTool_DataStoreTool_BoostSpecs[]>;
  /** Configuration for searching within a specific DataStore. */
  dataStoreSource?: V1betaTool_DataStoreTool_DataStoreSource | Computed<V1betaTool_DataStoreTool_DataStoreSource>;
  /** Optional. The tool description. */
  description?: string | Computed<string>;
  /** Configuration for searching within an Engine, potentially targeting specific DataStores. */
  engineSource?: V1betaTool_DataStoreTool_EngineSource | Computed<V1betaTool_DataStoreTool_EngineSource>;
  /** Optional. The filter parameter behavior. */
  filterParameterBehavior?: string | Computed<string>;
  /** Optional. The modality configs for the data store. */
  modalityConfigs?: V1betaTool_DataStoreTool_ModalityConfigs[] | Computed<V1betaTool_DataStoreTool_ModalityConfigs[]>;
  /** Required. The data store tool name. */
  name?: string | Computed<string>;
}

export interface V1betaTool_FileSearchTool {
...
export interface V1betaTool_GoogleSearchTool_PromptConfig {
...
export interface V1betaTool_GoogleSearchTool {
  ...
  promptConfig?: V1betaTool_GoogleSearchTool_PromptConfig | Computed<V1betaTool_GoogleSearchTool_PromptConfig>;
}

export interface V1betaTool_McpTool_ApiAuthentication_ApiKeyConfig {
...
export interface V1betaTool_McpTool_ApiAuthentication_BearerTokenConfig {
  /** Required. The bearer token. Must be in the format `$context.variables.`. */
  token?: string | Computed<string>;
}

export interface V1betaTool_McpTool_ApiAuthentication_OauthConfig {
...
export interface V1betaTool_McpTool_ApiAuthentication_ServiceAccountAuthConfig {
...
export interface V1betaTool_McpTool_ApiAuthentication {
  /** Configurations for authentication with API key. */
  apiKeyConfig?: V1betaTool_McpTool_ApiAuthentication_ApiKeyConfig | Computed<V1betaTool_McpTool_ApiAuthentication_ApiKeyConfig>;
  /** Configurations for authentication with a bearer token. */
  bearerTokenConfig?: V1betaTool_McpTool_ApiAuthentication_BearerTokenConfig | Computed<V1betaTool_McpTool_ApiAuthentication_BearerTokenConfig>;
  /** Configurations for authentication with OAuth. */
  oauthConfig?: V1betaTool_McpTool_ApiAuthentication_OauthConfig | Computed<V1betaTool_McpTool_ApiAuthentication_OauthConfig>;
  /** Configurations for authentication using a custom service account. */
  serviceAccountAuthConfig?: V1betaTool_McpTool_ApiAuthentication_ServiceAccountAuthConfig | Computed<V1betaTool_McpTool_ApiAuthentication_ServiceAccountAuthConfig>;
...
export interface V1betaTool_McpTool_ServiceDirectoryConfig {
...
export interface V1betaTool_McpTool_TlsConfig_CaCerts {
  cert?: string | Computed<string>;
  displayName?: string | Computed<string>;
}

export interface V1betaTool_McpTool_TlsConfig {
  /** Required. Specifies a list of allowed custom CA certificates for HTTPS verification. */
  caCerts?: V1betaTool_McpTool_TlsConfig_CaCerts[] | Computed<V1betaTool_McpTool_TlsConfig_CaCerts[]>;
}

export interface V1betaTool_McpTool {
  /** Authentication information required for API calls. */
  apiAuthentication?: V1betaTool_McpTool_ApiAuthentication | Computed<V1betaTool_McpTool_ApiAuthentication>;
  ...
  description?: string | Computed<string>;
  /** Represents a select subset of an OpenAPI 3.0 schema object. */
  inputSchema?: V1betaTool_ClientFunction_Parameters | Computed<V1betaTool_ClientFunction_Parameters>;
  ...
  /** Represents a select subset of an OpenAPI 3.0 schema object. */
  outputSchema?: V1betaTool_ClientFunction_Parameters | Computed<V1betaTool_ClientFunction_Parameters>;
  ...
  serviceDirectoryConfig?: V1betaTool_McpTool_ServiceDirectoryConfig | Computed<V1betaTool_McpTool_ServiceDirectoryConfig>;
  /** Output only. The dynamic availability state of the tool on the external server. */
  state?: string | Computed<string>;
  /** The TLS configuration. */
  tlsConfig?: V1betaTool_McpTool_TlsConfig | Computed<V1betaTool_McpTool_TlsConfig>;
}

export interface V1betaTool_OpenApiTool {
  /** Authentication information required for API calls. */
  apiAuthentication?: V1betaTool_McpTool_ApiAuthentication | Computed<V1betaTool_McpTool_ApiAuthentication>;
...
export interface V1betaTool_PythonFunction {
...
export interface V1betaTool_RemoteAgentTool_AgentCard_Skills {
  description?: string | Computed<string>;
...
export interface V1betaTool_RemoteAgentTool_AgentCard_SupportedInterfaces {
...
export interface V1betaTool_RemoteAgentTool_AgentCard {
  ...
  skills?: V1betaTool_RemoteAgentTool_AgentCard_Skills[] | Computed<V1betaTool_RemoteAgentTool_AgentCard_Skills[]>;
  /** Required. Ordered list of supported interfaces. The first entry is preferred. */
  supportedInterfaces?: V1betaTool_RemoteAgentTool_AgentCard_SupportedInterfaces[] | Computed<V1betaTool_RemoteAgentTool_AgentCard_SupportedInterfaces[]>;
  /** Required. The version of the agent. */
  version?: string | Computed<string>;
}

export interface V1betaTool_RemoteAgentTool {
  ...
  agentCard?: V1betaTool_RemoteAgentTool_AgentCard | Computed<V1betaTool_RemoteAgentTool_AgentCard>;
...
export interface V1betaTool_SystemTool {
...
export interface V1betaTool_ToolFakeConfig_CodeBlock {
...
export interface V1betaTool_ToolFakeConfig {
  /** A code block to be executed instead of a real tool call. */
  codeBlock?: V1betaTool_ToolFakeConfig_CodeBlock | Computed<V1betaTool_ToolFakeConfig_CodeBlock>;
  /** Optional. Whether the tool is using fake mode. */
  enableFakeMode?: boolean | Computed<boolean>;
}

export interface V1betaTool_WidgetTool_DataMapping {
  ...
  pythonFunction?: V1betaTool_PythonFunction | Computed<V1betaTool_PythonFunction>;
...
export interface V1betaTool_WidgetTool_TextResponseConfig {
...
export interface V1betaTool_WidgetTool {
  /** Configuration for mapping data from a source tool to the widget's input parameters. */
  dataMapping?: V1betaTool_WidgetTool_DataMapping | Computed<V1betaTool_WidgetTool_DataMapping>;
  ...
  textResponseConfig?: V1betaTool_WidgetTool_TextResponseConfig | Computed<V1betaTool_WidgetTool_TextResponseConfig>;
...
const V1betaTool_AgentToolFields: FieldMap = {
  agent: "agent",
  description: "description",
  name: "name",
};

const V1betaTool_ClientFunction_ParametersFields: FieldMap = {
...
const V1betaTool_ClientFunctionFields: FieldMap = {
  description: "description",
  name: "name",
  parameters: {
    wireName: "parameters",
...
const V1betaTool_ConnectorTool_Action_EntityOperationFields: FieldMap = {
  entityId: "entity_id",
  operation: "operation",
};

const V1betaTool_ConnectorTool_ActionFields: FieldMap = {
...
const V1betaTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfigFields: FieldMap = {
  oauthToken: "oauth_token",
};

const V1betaTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfigFields: FieldMap = {
  clientKey: "client_key",
  issuer: "issuer",
  subject: "subject",
};

const V1betaTool_ConnectorTool_AuthConfigFields: FieldMap = {
...
const V1betaTool_ConnectorToolFields: FieldMap = {
  action: {
    wireName: "action",
    kind: "object",
...
const V1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPointsFields: FieldMap = {
  attributeValue: "attribute_value",
  boostAmount: "boost_amount",
};

const V1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpecFields: FieldMap = {
...
const V1betaTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecsFields: FieldMap = {
  boost: "boost",
  boostControlSpec: {
...
const V1betaTool_DataStoreTool_BoostSpecs_SpecFields: FieldMap = {
  conditionBoostSpecs: {
...
const V1betaTool_DataStoreTool_BoostSpecsFields: FieldMap = {
...
const V1betaTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfigFields: FieldMap = {
  collection: "collection",
  collectionDisplayName: "collection_display_name",
  dataSource: "data_source",
};

const V1betaTool_DataStoreTool_DataStoreSource_DataStoreFields: FieldMap = {
  connectorConfig: {
...
const V1betaTool_DataStoreTool_DataStoreSourceFields: FieldMap = {
  dataStore: {
    wireName: "data_store",
    kind: "object",
...
const V1betaTool_DataStoreTool_EngineSourceFields: FieldMap = {
  dataStoreSources: {
...
const V1betaTool_DataStoreTool_ModalityConfigs_GroundingConfigFields: FieldMap = {
  disabled: "disabled",
  groundingLevel: "grounding_level",
};

const V1betaTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettingsFields: FieldMap = {
  model: "model",
  temperature: "temperature",
};

const V1betaTool_DataStoreTool_ModalityConfigs_RewriterConfigFields: FieldMap = {
  disabled: "disabled",
  modelSettings: {
...
const V1betaTool_DataStoreTool_ModalityConfigs_SnippetsConfigFields: FieldMap = {
  enableSnippets: "enable_snippets",
};

const V1betaTool_DataStoreTool_ModalityConfigsFields: FieldMap = {
  groundingConfig: {
...
const V1betaTool_DataStoreToolFields: FieldMap = {
  boostSpecs: {
...
const V1betaTool_FileSearchToolFields: FieldMap = {
...
const V1betaTool_GoogleSearchTool_PromptConfigFields: FieldMap = {
  textPrompt: "text_prompt",
  voicePrompt: "voice_prompt",
};

const V1betaTool_GoogleSearchToolFields: FieldMap = {
...
const V1betaTool_McpTool_ApiAuthentication_ApiKeyConfigFields: FieldMap = {
  apiKeySecretVersion: "api_key_secret_version",
  keyName: "key_name",
  requestLocation: "request_location",
};

const V1betaTool_McpTool_ApiAuthentication_BearerTokenConfigFields: FieldMap = {
  token: "token",
};

const V1betaTool_McpTool_ApiAuthentication_OauthConfigFields: FieldMap = {
  clientId: "client_id",
...
const V1betaTool_McpTool_ApiAuthentication_ServiceAccountAuthConfigFields: FieldMap = {
  scopes: "scopes",
  serviceAccount: "service_account",
};

const V1betaTool_McpTool_ApiAuthenticationFields: FieldMap = {
  apiKeyConfig: {
...
const V1betaTool_McpTool_ServiceDirectoryConfigFields: FieldMap = {
  service: "service",
};

const V1betaTool_McpTool_TlsConfig_CaCertsFields: FieldMap = {
  cert: "cert",
  displayName: "display_name",
};

const V1betaTool_McpTool_TlsConfigFields: FieldMap = {
  caCerts: {
    wireName: "ca_certs",
    kind: "list",
...
const V1betaTool_McpToolFields: FieldMap = {
  apiAuthentication: {
...
const V1betaTool_OpenApiToolFields: FieldMap = {
  apiAuthentication: {
    wireName: "api_authentication",
    kind: "object",
    fields: V1betaTool_McpTool_ApiAuthenticationFields,
...
const V1betaTool_PythonFunctionFields: FieldMap = {
  description: "description",
  name: "name",
...
const V1betaTool_RemoteAgentTool_AgentCard_SkillsFields: FieldMap = {
  description: "description",
  examples: "examples",
  id: "id",
...
const V1betaTool_RemoteAgentTool_AgentCard_SupportedInterfacesFields: FieldMap = {
...
const V1betaTool_RemoteAgentTool_AgentCardFields: FieldMap = {
  description: "description",
  name: "name",
  skills: {
    wireName: "skills",
...
const V1betaTool_RemoteAgentToolFields: FieldMap = {
  agentCard: {
    wireName: "agent_card",
    kind: "object",
...
const V1betaTool_SystemToolFields: FieldMap = {
  description: "description",
  name: "name",
};

const V1betaTool_ToolFakeConfig_CodeBlockFields: FieldMap = {
  pythonCode: "python_code",
};

const V1betaTool_ToolFakeConfigFields: FieldMap = {
  codeBlock: {
    wireName: "code_block",
    kind: "object",
...
const V1betaTool_WidgetTool_DataMappingFields: FieldMap = {
...
const V1betaTool_WidgetTool_TextResponseConfigFields: FieldMap = {
  staticText: "static_text",
  textResponseInstruction: "text_response_instruction",
  type: "type",
};

const V1betaTool_WidgetToolFields: FieldMap = {
  dataMapping: {
...
export interface V1betaToolConfig {
  /** Represents a tool that allows the agent to call another agent. */
  agentTool?: V1betaTool_AgentTool | Computed<V1betaTool_AgentTool>;
  ...
  clientFunction?: V1betaTool_ClientFunction | Computed<V1betaTool_ClientFunction>;
  ...
  connectorTool?: V1betaTool_ConnectorTool | Computed<V1betaTool_ConnectorTool>;
  ...
  dataStoreTool?: V1betaTool_DataStoreTool | Computed<V1betaTool_DataStoreTool>;
  ...
  fileSearchTool?: V1betaTool_FileSearchTool | Computed<V1betaTool_FileSearchTool>;
  ...
  googleSearchTool?: V1betaTool_GoogleSearchTool | Computed<V1betaTool_GoogleSearchTool>;
  /** An MCP tool. See https://modelcontextprotocol.io/specification/2025-06-18/server/tools for more details. */
  mcpTool?: V1betaTool_McpTool | Computed<V1betaTool_McpTool>;
  ...
  openApiTool?: V1betaTool_OpenApiTool | Computed<V1betaTool_OpenApiTool>;
  /** A Python function tool. */
  pythonFunction?: V1betaTool_PythonFunction | Computed<V1betaTool_PythonFunction>;
  /** Represents a tool that allows the agent to call another remote agent. */
  remoteAgentTool?: V1betaTool_RemoteAgentTool | Computed<V1betaTool_RemoteAgentTool>;
  /** Pre-defined system tool. */
  systemTool?: V1betaTool_SystemTool | Computed<V1betaTool_SystemTool>;
  ...
  toolFakeConfig?: V1betaTool_ToolFakeConfig | Computed<V1betaTool_ToolFakeConfig>;
  ...
  widgetTool?: V1betaTool_WidgetTool | Computed<V1betaTool_WidgetTool>;
}

export interface V1betaToolAttrs {
  /** Represents a tool that allows the agent to call another agent. */
  agentTool: V1betaTool_AgentTool;
  /** Represents a client-side function that the agent can invoke. When the tool is chosen by the agent, control is handed off to the client. The client is responsible for executing the function and returning the result as a ToolResponse to continue the interaction with the agent. */
  clientFunction: V1betaTool_ClientFunction;
  /** A ConnectorTool allows connections to different integrations. See: https://cloud.google.com/integration-connectors/docs/overview. */
  connectorTool: V1betaTool_ConnectorTool;
  /** Output only. Timestamp when the tool was created. */
  createTime: string;
  /** Tool to retrieve from Vertex AI Search datastore or engine for grounding. Accepts either a datastore or an engine, but not both. See Vertex AI Search: https://cloud.google.com/generative-ai-app-builder/docs/enterprise-search-introduction. */
  dataStoreTool: V1betaTool_DataStoreTool;
  ...
  /** The file search tool allows the agent to search across the files uploaded by the app/agent developer. It has presets to give relatively good quality search over the uploaded files and summarization of the retrieved results. */
  fileSearchTool: V1betaTool_FileSearchTool;
  ...
  /** Represents a tool to perform Google web searches for grounding. See https://cloud.google.com/customer-engagement-ai/conversational-agents/ps/tool#google-search. */
  googleSearchTool: V1betaTool_GoogleSearchTool;
  /** An MCP tool. See https://modelcontextprotocol.io/specification/2025-06-18/server/tools for more details. */
  mcpTool: V1betaTool_McpTool;
  /** Identifier. The resource name of the tool. Format: * `projects/{project}/locations/{location}/apps/{app}/tools/{tool}` for standalone tools. * `projects/{project}/locations/{location}/apps/{app}/toolsets/{toolset}/tools/{tool}` for tools retrieved from a toolset. These tools are dynamic and output-only; they cannot be referenced directly where a tool is expected. */
  name: string;
  /** A remote API tool defined by an OpenAPI schema. */
  openApiTool: V1betaTool_OpenApiTool;
  /** A Python function tool. */
  pythonFunction: V1betaTool_PythonFunction;
  /** Represents a tool that allows the agent to call another remote agent. */
  remoteAgentTool: V1betaTool_RemoteAgentTool;
  /** Pre-defined system tool. */
  systemTool: V1betaTool_SystemTool;
  /** Optional. The timeout for the tool execution. If not set, the default timeout is 30 seconds for `SYNCHRONOUS` tools and 60 seconds for `ASYNCHRONOUS` tools. */
  timeout: string;
  /** Configuration for tool behavior in fake mode. */
  toolFakeConfig: V1betaTool_ToolFakeConfig;
  /** Output only. Timestamp when the tool was last updated. */
  updateTime: string;
  /** Represents a widget tool that the agent can invoke. When the tool is chosen by the agent, agent will return the widget to the client. The client is responsible for processing the widget and generating the next user query to continue the interaction with the agent. */
  widgetTool: V1betaTool_WidgetTool;
}

export const V1betaTool: ResourceBinding<V1betaToolConfig, V1betaToolAttrs> = {
  wireType: "google_ces_v1beta_tool",
  fields: {
    agentTool: {
      wireName: "agent_tool",
      kind: "object",
