...
export interface CesTool_AgentTool {
...
export interface CesTool_ClientFunction_Parameters {
...
export interface CesTool_ClientFunction {
  /** Optional. The function description. */
  description?: string | Computed<string>;
  /** Required. The function name. */
  name?: string | Computed<string>;
  /** Represents a select subset of an OpenAPI 3.0 schema object. */
  parameters?: CesTool_ClientFunction_Parameters | Computed<CesTool_ClientFunction_Parameters>;
  /** Represents a select subset of an OpenAPI 3.0 schema object. */
  response?: CesTool_ClientFunction_Parameters | Computed<CesTool_ClientFunction_Parameters>;
}

export interface CesTool_ConnectorTool_Action_EntityOperation {
...
export interface CesTool_ConnectorTool_Action {
  /** ID of a Connection action for the tool to use. */
  connectionActionId?: string | Computed<string>;
  /** Entity CRUD operation specification. */
  entityOperation?: CesTool_ConnectorTool_Action_EntityOperation | Computed<CesTool_ConnectorTool_Action_EntityOperation>;
...
export interface CesTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig {
...
export interface CesTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig {
...
export interface CesTool_ConnectorTool_AuthConfig {
  /** Oauth 2.0 Authorization Code authentication configuration. */
  oauth2AuthCodeConfig?: CesTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig | Computed<CesTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig>;
  /** JWT Profile Oauth 2.0 Authorization Grant authentication configuration. */
  oauth2JwtBearerConfig?: CesTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig | Computed<CesTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig>;
}

export interface CesTool_ConnectorTool {
  ...
  action?: CesTool_ConnectorTool_Action | Computed<CesTool_ConnectorTool_Action>;
  ...
  authConfig?: CesTool_ConnectorTool_AuthConfig | Computed<CesTool_ConnectorTool_AuthConfig>;
...
export interface CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPoints {
  attributeValue?: string | Computed<string>;
  boostAmount?: number | Computed<number>;
}

export interface CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec {
  attributeType?: string | Computed<string>;
  controlPoints?: CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPoints[] | Computed<CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPoints[]>;
  fieldName?: string | Computed<string>;
  interpolationType?: string | Computed<string>;
}

export interface CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs {
  boost?: number | Computed<number>;
  boostControlSpec?: CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec | Computed<CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec>;
  condition?: string | Computed<string>;
}

export interface CesTool_DataStoreTool_BoostSpecs_Spec {
  conditionBoostSpecs?: CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs[] | Computed<CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs[]>;
}

export interface CesTool_DataStoreTool_BoostSpecs {
  dataStores?: string[] | Computed<string[]>;
  spec?: CesTool_DataStoreTool_BoostSpecs_Spec[] | Computed<CesTool_DataStoreTool_BoostSpecs_Spec[]>;
}

export interface CesTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfig {
...
export interface CesTool_DataStoreTool_DataStoreSource_DataStore {
  /** The connector config for the data store connection. */
  connectorConfig?: CesTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfig | Computed<CesTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfig>;
...
export interface CesTool_DataStoreTool_DataStoreSource {
  /** A DataStore resource in Vertex AI Search. */
  dataStore?: CesTool_DataStoreTool_DataStoreSource_DataStore | Computed<CesTool_DataStoreTool_DataStoreSource_DataStore>;
...
export interface CesTool_DataStoreTool_EngineSource {
  ...
  dataStoreSources?: CesTool_DataStoreTool_DataStoreSource[] | Computed<CesTool_DataStoreTool_DataStoreSource[]>;
...
export interface CesTool_DataStoreTool_ModalityConfigs_GroundingConfig {
  disabled?: boolean | Computed<boolean>;
  groundingLevel?: number | Computed<number>;
}

export interface CesTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettings {
  model?: string | Computed<string>;
  temperature?: number | Computed<number>;
}

export interface CesTool_DataStoreTool_ModalityConfigs_RewriterConfig {
  disabled?: boolean | Computed<boolean>;
  modelSettings?: CesTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettings | Computed<CesTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettings>;
  prompt?: string | Computed<string>;
}

export interface CesTool_DataStoreTool_ModalityConfigs_SnippetsConfig {
  enableSnippets?: boolean | Computed<boolean>;
}

export interface CesTool_DataStoreTool_ModalityConfigs {
  groundingConfig?: CesTool_DataStoreTool_ModalityConfigs_GroundingConfig | Computed<CesTool_DataStoreTool_ModalityConfigs_GroundingConfig>;
  modalityType?: string | Computed<string>;
  rewriterConfig?: CesTool_DataStoreTool_ModalityConfigs_RewriterConfig | Computed<CesTool_DataStoreTool_ModalityConfigs_RewriterConfig>;
  snippetsConfig?: CesTool_DataStoreTool_ModalityConfigs_SnippetsConfig | Computed<CesTool_DataStoreTool_ModalityConfigs_SnippetsConfig>;
  summarizationConfig?: CesTool_DataStoreTool_ModalityConfigs_RewriterConfig | Computed<CesTool_DataStoreTool_ModalityConfigs_RewriterConfig>;
}

export interface CesTool_DataStoreTool {
  /** Optional. Boost specification to boost certain documents. */
  boostSpecs?: CesTool_DataStoreTool_BoostSpecs[] | Computed<CesTool_DataStoreTool_BoostSpecs[]>;
  /** Configuration for searching within a specific DataStore. */
  dataStoreSource?: CesTool_DataStoreTool_DataStoreSource | Computed<CesTool_DataStoreTool_DataStoreSource>;
  /** Optional. The tool description. */
  description?: string | Computed<string>;
  /** Configuration for searching within an Engine, potentially targeting specific DataStores. */
  engineSource?: CesTool_DataStoreTool_EngineSource | Computed<CesTool_DataStoreTool_EngineSource>;
  /** Optional. The filter parameter behavior. */
  filterParameterBehavior?: string | Computed<string>;
  /** Optional. The modality configs for the data store. */
  modalityConfigs?: CesTool_DataStoreTool_ModalityConfigs[] | Computed<CesTool_DataStoreTool_ModalityConfigs[]>;
  /** Required. The data store tool name. */
  name?: string | Computed<string>;
}

export interface CesTool_FileSearchTool {
...
export interface CesTool_GoogleSearchTool_PromptConfig {
...
export interface CesTool_GoogleSearchTool {
  ...
  promptConfig?: CesTool_GoogleSearchTool_PromptConfig | Computed<CesTool_GoogleSearchTool_PromptConfig>;
}

export interface CesTool_McpTool_ApiAuthentication_ApiKeyConfig {
...
export interface CesTool_McpTool_ApiAuthentication_BearerTokenConfig {
  /** Required. The bearer token. Must be in the format `$context.variables.`. */
  token?: string | Computed<string>;
}

export interface CesTool_McpTool_ApiAuthentication_OauthConfig {
...
export interface CesTool_McpTool_ApiAuthentication_ServiceAccountAuthConfig {
...
export interface CesTool_McpTool_ApiAuthentication {
  /** Configurations for authentication with API key. */
  apiKeyConfig?: CesTool_McpTool_ApiAuthentication_ApiKeyConfig | Computed<CesTool_McpTool_ApiAuthentication_ApiKeyConfig>;
  /** Configurations for authentication with a bearer token. */
  bearerTokenConfig?: CesTool_McpTool_ApiAuthentication_BearerTokenConfig | Computed<CesTool_McpTool_ApiAuthentication_BearerTokenConfig>;
  /** Configurations for authentication with OAuth. */
  oauthConfig?: CesTool_McpTool_ApiAuthentication_OauthConfig | Computed<CesTool_McpTool_ApiAuthentication_OauthConfig>;
  /** Configurations for authentication using a custom service account. */
  serviceAccountAuthConfig?: CesTool_McpTool_ApiAuthentication_ServiceAccountAuthConfig | Computed<CesTool_McpTool_ApiAuthentication_ServiceAccountAuthConfig>;
...
export interface CesTool_McpTool_ServiceDirectoryConfig {
...
export interface CesTool_McpTool_TlsConfig_CaCerts {
  cert?: string | Computed<string>;
  displayName?: string | Computed<string>;
}

export interface CesTool_McpTool_TlsConfig {
  /** Required. Specifies a list of allowed custom CA certificates for HTTPS verification. */
  caCerts?: CesTool_McpTool_TlsConfig_CaCerts[] | Computed<CesTool_McpTool_TlsConfig_CaCerts[]>;
}

export interface CesTool_McpTool {
  /** Authentication information required for API calls. */
  apiAuthentication?: CesTool_McpTool_ApiAuthentication | Computed<CesTool_McpTool_ApiAuthentication>;
  ...
  description?: string | Computed<string>;
  /** Represents a select subset of an OpenAPI 3.0 schema object. */
  inputSchema?: CesTool_ClientFunction_Parameters | Computed<CesTool_ClientFunction_Parameters>;
  ...
  /** Represents a select subset of an OpenAPI 3.0 schema object. */
  outputSchema?: CesTool_ClientFunction_Parameters | Computed<CesTool_ClientFunction_Parameters>;
  ...
  serviceDirectoryConfig?: CesTool_McpTool_ServiceDirectoryConfig | Computed<CesTool_McpTool_ServiceDirectoryConfig>;
  /** Output only. The dynamic availability state of the tool on the external server. */
  state?: string | Computed<string>;
  /** The TLS configuration. */
  tlsConfig?: CesTool_McpTool_TlsConfig | Computed<CesTool_McpTool_TlsConfig>;
}

export interface CesTool_OpenApiTool {
  /** Authentication information required for API calls. */
  apiAuthentication?: CesTool_McpTool_ApiAuthentication | Computed<CesTool_McpTool_ApiAuthentication>;
...
export interface CesTool_PythonFunction {
...
export interface CesTool_RemoteAgentTool_AgentCard_Skills {
  description?: string | Computed<string>;
...
export interface CesTool_RemoteAgentTool_AgentCard_SupportedInterfaces {
...
export interface CesTool_RemoteAgentTool_AgentCard {
  ...
  skills?: CesTool_RemoteAgentTool_AgentCard_Skills[] | Computed<CesTool_RemoteAgentTool_AgentCard_Skills[]>;
  /** Required. Ordered list of supported interfaces. The first entry is preferred. */
  supportedInterfaces?: CesTool_RemoteAgentTool_AgentCard_SupportedInterfaces[] | Computed<CesTool_RemoteAgentTool_AgentCard_SupportedInterfaces[]>;
  /** Required. The version of the agent. */
  version?: string | Computed<string>;
}

export interface CesTool_RemoteAgentTool {
  ...
  agentCard?: CesTool_RemoteAgentTool_AgentCard | Computed<CesTool_RemoteAgentTool_AgentCard>;
...
export interface CesTool_SystemTool {
...
export interface CesTool_ToolFakeConfig_CodeBlock {
...
export interface CesTool_ToolFakeConfig {
  /** A code block to be executed instead of a real tool call. */
  codeBlock?: CesTool_ToolFakeConfig_CodeBlock | Computed<CesTool_ToolFakeConfig_CodeBlock>;
  /** Optional. Whether the tool is using fake mode. */
  enableFakeMode?: boolean | Computed<boolean>;
}

export interface CesTool_WidgetTool_DataMapping {
  ...
  pythonFunction?: CesTool_PythonFunction | Computed<CesTool_PythonFunction>;
...
export interface CesTool_WidgetTool_TextResponseConfig {
...
export interface CesTool_WidgetTool {
  /** Configuration for mapping data from a source tool to the widget's input parameters. */
  dataMapping?: CesTool_WidgetTool_DataMapping | Computed<CesTool_WidgetTool_DataMapping>;
  ...
  textResponseConfig?: CesTool_WidgetTool_TextResponseConfig | Computed<CesTool_WidgetTool_TextResponseConfig>;
...
const CesTool_AgentToolFields: FieldMap = {
  agent: "agent",
  description: "description",
  name: "name",
};

const CesTool_ClientFunction_ParametersFields: FieldMap = {
...
const CesTool_ClientFunctionFields: FieldMap = {
  description: "description",
  name: "name",
  parameters: {
    wireName: "parameters",
...
const CesTool_ConnectorTool_Action_EntityOperationFields: FieldMap = {
  entityId: "entity_id",
  operation: "operation",
};

const CesTool_ConnectorTool_ActionFields: FieldMap = {
...
const CesTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfigFields: FieldMap = {
  oauthToken: "oauth_token",
};

const CesTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfigFields: FieldMap = {
  clientKey: "client_key",
  issuer: "issuer",
  subject: "subject",
};

const CesTool_ConnectorTool_AuthConfigFields: FieldMap = {
...
const CesTool_ConnectorToolFields: FieldMap = {
  action: {
    wireName: "action",
    kind: "object",
...
const CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPointsFields: FieldMap = {
  attributeValue: "attribute_value",
  boostAmount: "boost_amount",
};

const CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpecFields: FieldMap = {
...
const CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecsFields: FieldMap = {
  boost: "boost",
  boostControlSpec: {
...
const CesTool_DataStoreTool_BoostSpecs_SpecFields: FieldMap = {
  conditionBoostSpecs: {
...
const CesTool_DataStoreTool_BoostSpecsFields: FieldMap = {
...
const CesTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfigFields: FieldMap = {
  collection: "collection",
  collectionDisplayName: "collection_display_name",
  dataSource: "data_source",
};

const CesTool_DataStoreTool_DataStoreSource_DataStoreFields: FieldMap = {
  connectorConfig: {
...
const CesTool_DataStoreTool_DataStoreSourceFields: FieldMap = {
  dataStore: {
    wireName: "data_store",
    kind: "object",
...
const CesTool_DataStoreTool_EngineSourceFields: FieldMap = {
  dataStoreSources: {
...
const CesTool_DataStoreTool_ModalityConfigs_GroundingConfigFields: FieldMap = {
  disabled: "disabled",
  groundingLevel: "grounding_level",
};

const CesTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettingsFields: FieldMap = {
  model: "model",
  temperature: "temperature",
};

const CesTool_DataStoreTool_ModalityConfigs_RewriterConfigFields: FieldMap = {
  disabled: "disabled",
  modelSettings: {
...
const CesTool_DataStoreTool_ModalityConfigs_SnippetsConfigFields: FieldMap = {
  enableSnippets: "enable_snippets",
};

const CesTool_DataStoreTool_ModalityConfigsFields: FieldMap = {
  groundingConfig: {
...
const CesTool_DataStoreToolFields: FieldMap = {
  boostSpecs: {
...
const CesTool_FileSearchToolFields: FieldMap = {
...
const CesTool_GoogleSearchTool_PromptConfigFields: FieldMap = {
  textPrompt: "text_prompt",
  voicePrompt: "voice_prompt",
};

const CesTool_GoogleSearchToolFields: FieldMap = {
...
const CesTool_McpTool_ApiAuthentication_ApiKeyConfigFields: FieldMap = {
  apiKeySecretVersion: "api_key_secret_version",
  keyName: "key_name",
  requestLocation: "request_location",
};

const CesTool_McpTool_ApiAuthentication_BearerTokenConfigFields: FieldMap = {
  token: "token",
};

const CesTool_McpTool_ApiAuthentication_OauthConfigFields: FieldMap = {
  clientId: "client_id",
...
const CesTool_McpTool_ApiAuthentication_ServiceAccountAuthConfigFields: FieldMap = {
  scopes: "scopes",
  serviceAccount: "service_account",
};

const CesTool_McpTool_ApiAuthenticationFields: FieldMap = {
  apiKeyConfig: {
...
const CesTool_McpTool_ServiceDirectoryConfigFields: FieldMap = {
  service: "service",
};

const CesTool_McpTool_TlsConfig_CaCertsFields: FieldMap = {
  cert: "cert",
  displayName: "display_name",
};

const CesTool_McpTool_TlsConfigFields: FieldMap = {
  caCerts: {
    wireName: "ca_certs",
    kind: "list",
...
const CesTool_McpToolFields: FieldMap = {
  apiAuthentication: {
...
const CesTool_OpenApiToolFields: FieldMap = {
  apiAuthentication: {
    wireName: "api_authentication",
    kind: "object",
    fields: CesTool_McpTool_ApiAuthenticationFields,
...
const CesTool_PythonFunctionFields: FieldMap = {
  description: "description",
  name: "name",
...
const CesTool_RemoteAgentTool_AgentCard_SkillsFields: FieldMap = {
  description: "description",
  examples: "examples",
  id: "id",
...
const CesTool_RemoteAgentTool_AgentCard_SupportedInterfacesFields: FieldMap = {
...
const CesTool_RemoteAgentTool_AgentCardFields: FieldMap = {
  description: "description",
  name: "name",
  skills: {
    wireName: "skills",
...
const CesTool_RemoteAgentToolFields: FieldMap = {
  agentCard: {
    wireName: "agent_card",
    kind: "object",
...
const CesTool_SystemToolFields: FieldMap = {
  description: "description",
  name: "name",
};

const CesTool_ToolFakeConfig_CodeBlockFields: FieldMap = {
  pythonCode: "python_code",
};

const CesTool_ToolFakeConfigFields: FieldMap = {
  codeBlock: {
    wireName: "code_block",
    kind: "object",
...
const CesTool_WidgetTool_DataMappingFields: FieldMap = {
...
const CesTool_WidgetTool_TextResponseConfigFields: FieldMap = {
  staticText: "static_text",
  textResponseInstruction: "text_response_instruction",
  type: "type",
};

const CesTool_WidgetToolFields: FieldMap = {
  dataMapping: {
...
export interface CesToolConfig {
  /** Represents a tool that allows the agent to call another agent. */
  agentTool?: CesTool_AgentTool | Computed<CesTool_AgentTool>;
  ...
  clientFunction?: CesTool_ClientFunction | Computed<CesTool_ClientFunction>;
  ...
  connectorTool?: CesTool_ConnectorTool | Computed<CesTool_ConnectorTool>;
  ...
  dataStoreTool?: CesTool_DataStoreTool | Computed<CesTool_DataStoreTool>;
  ...
  fileSearchTool?: CesTool_FileSearchTool | Computed<CesTool_FileSearchTool>;
  ...
  googleSearchTool?: CesTool_GoogleSearchTool | Computed<CesTool_GoogleSearchTool>;
  /** An MCP tool. See https://modelcontextprotocol.io/specification/2025-06-18/server/tools for more details. */
  mcpTool?: CesTool_McpTool | Computed<CesTool_McpTool>;
  ...
  openApiTool?: CesTool_OpenApiTool | Computed<CesTool_OpenApiTool>;
  /** A Python function tool. */
  pythonFunction?: CesTool_PythonFunction | Computed<CesTool_PythonFunction>;
  /** Represents a tool that allows the agent to call another remote agent. */
  remoteAgentTool?: CesTool_RemoteAgentTool | Computed<CesTool_RemoteAgentTool>;
  /** Pre-defined system tool. */
  systemTool?: CesTool_SystemTool | Computed<CesTool_SystemTool>;
  ...
  toolFakeConfig?: CesTool_ToolFakeConfig | Computed<CesTool_ToolFakeConfig>;
  ...
  widgetTool?: CesTool_WidgetTool | Computed<CesTool_WidgetTool>;
}

export interface CesToolAttrs {
  /** Represents a tool that allows the agent to call another agent. */
  agentTool: CesTool_AgentTool;
  /** Represents a client-side function that the agent can invoke. When the tool is chosen by the agent, control is handed off to the client. The client is responsible for executing the function and returning the result as a ToolResponse to continue the interaction with the agent. */
  clientFunction: CesTool_ClientFunction;
  /** A ConnectorTool allows connections to different integrations. See: https://cloud.google.com/integration-connectors/docs/overview. */
  connectorTool: CesTool_ConnectorTool;
  /** Output only. Timestamp when the tool was created. */
  createTime: string;
  /** Tool to retrieve from Vertex AI Search datastore or engine for grounding. Accepts either a datastore or an engine, but not both. See Vertex AI Search: https://cloud.google.com/generative-ai-app-builder/docs/enterprise-search-introduction. */
  dataStoreTool: CesTool_DataStoreTool;
  /** Output only. The display name of the tool, derived based on the tool's type. For example, display name of a ClientFunction is derived from its `name` property. */
  displayName: string;
  /** Etag used to ensure the object hasn't changed during a read-modify-write operation. If the etag is empty, the update will overwrite any concurrent changes. */
  etag: string;
  ...
  /** The file search tool allows the agent to search across the files uploaded by the app/agent developer. It has presets to give relatively good quality search over the uploaded files and summarization of the retrieved results. */
  fileSearchTool: CesTool_FileSearchTool;
  /** Output only. If the tool is generated by the LLM assistant, this field contains a descriptive summary of the generation. */
  generatedSummary: string;
  /** Represents a tool to perform Google web searches for grounding. See https://cloud.google.com/customer-engagement-ai/conversational-agents/ps/tool#google-search. */
  googleSearchTool: CesTool_GoogleSearchTool;
  /** An MCP tool. See https://modelcontextprotocol.io/specification/2025-06-18/server/tools for more details. */
  mcpTool: CesTool_McpTool;
  /** Identifier. The resource name of the tool. Format: * `projects/{project}/locations/{location}/apps/{app}/tools/{tool}` for standalone tools. * `projects/{project}/locations/{location}/apps/{app}/toolsets/{toolset}/tools/{tool}` for tools retrieved from a toolset. These tools are dynamic and output-only; they cannot be referenced directly where a tool is expected. */
  name: string;
  /** A remote API tool defined by an OpenAPI schema. */
  openApiTool: CesTool_OpenApiTool;
  /** A Python function tool. */
  pythonFunction: CesTool_PythonFunction;
  /** Represents a tool that allows the agent to call another remote agent. */
  remoteAgentTool: CesTool_RemoteAgentTool;
  /** Pre-defined system tool. */
  systemTool: CesTool_SystemTool;
  /** Optional. The timeout for the tool execution. If not set, the default timeout is 30 seconds for `SYNCHRONOUS` tools and 60 seconds for `ASYNCHRONOUS` tools. */
  timeout: string;
  /** Configuration for tool behavior in fake mode. */
  toolFakeConfig: CesTool_ToolFakeConfig;
  /** Output only. Timestamp when the tool was last updated. */
  updateTime: string;
  /** Represents a widget tool that the agent can invoke. When the tool is chosen by the agent, agent will return the widget to the client. The client is responsible for processing the widget and generating the next user query to continue the interaction with the agent. */
  widgetTool: CesTool_WidgetTool;
}

export const CesTool: ResourceBinding<CesToolConfig, CesToolAttrs> = {
