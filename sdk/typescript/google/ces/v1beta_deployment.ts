// Code generated by `ubx sdk gen` from google_ces_v1beta_deployment. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1betaDeployment_AgentRegistryDeployment {
  ...
  agentRegistryServiceName?: string | Computed<string>;
}

export interface V1betaDeployment_ChannelProfile_InstagramConfig {
...
export interface V1betaDeployment_ChannelProfile_PersonaProperty {
  /** Optional. The persona of the channel. */
  persona?: string | Computed<string>;
}

export interface V1betaDeployment_ChannelProfile_WebWidgetConfig_SecuritySettings {
...
export interface V1betaDeployment_ChannelProfile_WebWidgetConfig {
  /** Optional. The modality of the web widget. */
  modality?: string | Computed<string>;
  /** Security settings for the web widget. */
  securitySettings?: V1betaDeployment_ChannelProfile_WebWidgetConfig_SecuritySettings | Computed<V1betaDeployment_ChannelProfile_WebWidgetConfig_SecuritySettings>;
...
export interface V1betaDeployment_ChannelProfile_WhatsappConfig {
  /** Output only. The description of the Meta business page or profile. */
  description?: string | Computed<string>;
  /** Output only. The fetched Meta business page name. */
  displayName?: string | Computed<string>;
...
export interface V1betaDeployment_ChannelProfile {
  ...
  instagramConfig?: V1betaDeployment_ChannelProfile_InstagramConfig | Computed<V1betaDeployment_ChannelProfile_InstagramConfig>;
  ...
  personaProperty?: V1betaDeployment_ChannelProfile_PersonaProperty | Computed<V1betaDeployment_ChannelProfile_PersonaProperty>;
  /** Optional. The unique identifier of the channel profile. */
  profileId?: string | Computed<string>;
  /** Message for configuration for the web widget. */
  webWidgetConfig?: V1betaDeployment_ChannelProfile_WebWidgetConfig | Computed<V1betaDeployment_ChannelProfile_WebWidgetConfig>;
  /** Configuration specific to WhatsApp deployments. */
  whatsappConfig?: V1betaDeployment_ChannelProfile_WhatsappConfig | Computed<V1betaDeployment_ChannelProfile_WhatsappConfig>;
}

export interface V1betaDeployment_ExperimentConfig_VersionRelease_TrafficAllocations {
  appVersion?: string | Computed<string>;
  id?: string | Computed<string>;
  trafficPercentage?: number | Computed<number>;
}

export interface V1betaDeployment_ExperimentConfig_VersionRelease {
  /** Optional. State of the version release. */
  state?: string | Computed<string>;
  /** Optional. Traffic allocations for the version release. */
  trafficAllocations?: V1betaDeployment_ExperimentConfig_VersionRelease_TrafficAllocations[] | Computed<V1betaDeployment_ExperimentConfig_VersionRelease_TrafficAllocations[]>;
}

export interface V1betaDeployment_ExperimentConfig {
  /** Version release for the experiment. */
  versionRelease?: V1betaDeployment_ExperimentConfig_VersionRelease | Computed<V1betaDeployment_ExperimentConfig_VersionRelease>;
}

export interface V1betaDeployment_InstagramCredentials {
...
export interface V1betaDeployment_ModelSettings {
...
export interface V1betaDeployment_WhatsappCredentials {
  /** Required. The Meta auth code provided by the embedded signup flow. */
  authCode?: string | Computed<string>;
...
const V1betaDeployment_AgentRegistryDeploymentFields: FieldMap = {
  agentRegistryServiceName: "agent_registry_service_name",
};

const V1betaDeployment_ChannelProfile_InstagramConfigFields: FieldMap = {
...
const V1betaDeployment_ChannelProfile_PersonaPropertyFields: FieldMap = {
  persona: "persona",
};

const V1betaDeployment_ChannelProfile_WebWidgetConfig_SecuritySettingsFields: FieldMap = {
...
const V1betaDeployment_ChannelProfile_WebWidgetConfigFields: FieldMap = {
  modality: "modality",
  securitySettings: {
...
const V1betaDeployment_ChannelProfile_WhatsappConfigFields: FieldMap = {
  description: "description",
  displayName: "display_name",
...
const V1betaDeployment_ChannelProfileFields: FieldMap = {
...
const V1betaDeployment_ExperimentConfig_VersionRelease_TrafficAllocationsFields: FieldMap = {
  appVersion: "app_version",
  id: "id",
  trafficPercentage: "traffic_percentage",
};

const V1betaDeployment_ExperimentConfig_VersionReleaseFields: FieldMap = {
  state: "state",
  trafficAllocations: {
...
const V1betaDeployment_ExperimentConfigFields: FieldMap = {
  versionRelease: {
...
const V1betaDeployment_InstagramCredentialsFields: FieldMap = {
  authCode: "auth_code",
  conversationProfileId: "conversation_profile_id",
};

const V1betaDeployment_ModelSettingsFields: FieldMap = {
  model: "model",
  temperature: "temperature",
};

const V1betaDeployment_WhatsappCredentialsFields: FieldMap = {
  authCode: "auth_code",
...
export interface V1betaDeploymentConfig {
  /** Configuration and status for Agent Registry deployment. */
  agentRegistryDeployment?: V1betaDeployment_AgentRegistryDeployment | Computed<V1betaDeployment_AgentRegistryDeployment>;
  ...
  instagramCredentials?: V1betaDeployment_InstagramCredentials | Computed<V1betaDeployment_InstagramCredentials>;
...
export interface V1betaDeploymentAttrs {
  /** Configuration and status for Agent Registry deployment. */
  agentRegistryDeployment: V1betaDeployment_AgentRegistryDeployment;
  /** Optional. The resource name of the app version to deploy. Format: `projects/{project}/locations/{location}/apps/{app}/versions/{version}` Use `projects/{project}/locations/{location}/apps/{app}/versions/-` to use the draft app. */
  appVersion: string;
  /** A ChannelProfile configures the agent's behavior for a specific communication channel, such as web UI or telephony. */
  channelProfile: V1betaDeployment_ChannelProfile;
  ...
  etag: string;
  /** Experiment for the deployment. */
  experimentConfig: V1betaDeployment_ExperimentConfig;
  /** Ephemeral Meta credentials for Instagram native integration. */
  instagramCredentials: V1betaDeployment_InstagramCredentials;
  /** Optional. The modality of the deployment. Note: Deployment-level modality override is gated behind an allowlist. Contact the CXAS team to enable this field. */
  modality: string;
  /** Model settings contains various configurations for the LLM model. */
  modelSettings: V1betaDeployment_ModelSettings;
  /** Identifier. The resource name of the deployment. Format: `projects/{project}/locations/{location}/apps/{app}/deployments/{deployment}` */
  name: string;
  /** Output only. Timestamp when this deployment was last updated. */
  updateTime: string;
  /** Ephemeral Meta credentials for WhatsApp native integration. */
  whatsappCredentials: V1betaDeployment_WhatsappCredentials;
}

export const V1betaDeployment: ResourceBinding<V1betaDeploymentConfig, V1betaDeploymentAttrs> = {
  wireType: "google_ces_v1beta_deployment",
  fields: {
    agentRegistryDeployment: {
      wireName: "agent_registry_deployment",
      kind: "object",
      fields: V1betaDeployment_AgentRegistryDeploymentFields,
    },
    appVersion: "app_version",
    channelProfile: {
