...
export interface Deployment_AgentRegistryDeployment {
...
export interface Deployment_ChannelProfile_InstagramConfig {
...
export interface Deployment_ChannelProfile_WebWidgetConfig {
  ...
  securitySettings?: Deployment_ChannelProfile_WebWidgetConfig_SecuritySettings | Computed<Deployment_ChannelProfile_WebWidgetConfig_SecuritySettings>;
...
export interface Deployment_ChannelProfile_WhatsappConfig {
  /** Output only. The description of the Meta business page or profile. */
  description?: string | Computed<string>;
  /** Output only. The fetched Meta business page name. */
  displayName?: string | Computed<string>;
...
export interface Deployment_ChannelProfile {
  ...
  instagramConfig?: Deployment_ChannelProfile_InstagramConfig | Computed<Deployment_ChannelProfile_InstagramConfig>;
  ...
  personaProperty?: Deployment_ChannelProfile_PersonaProperty | Computed<Deployment_ChannelProfile_PersonaProperty>;
  /** Optional. The unique identifier of the channel profile. */
  profileId?: string | Computed<string>;
  /** Message for configuration for the web widget. */
  webWidgetConfig?: Deployment_ChannelProfile_WebWidgetConfig | Computed<Deployment_ChannelProfile_WebWidgetConfig>;
  /** Configuration specific to WhatsApp deployments. */
  whatsappConfig?: Deployment_ChannelProfile_WhatsappConfig | Computed<Deployment_ChannelProfile_WhatsappConfig>;
}
...
export interface Deployment_ExperimentConfig_VersionRelease {
  /** Optional. State of the version release. */
  state?: string | Computed<string>;
  /** Optional. Traffic allocations for the version release. */
  trafficAllocations?: Deployment_ExperimentConfig_VersionRelease_TrafficAllocations[] | Computed<Deployment_ExperimentConfig_VersionRelease_TrafficAllocations[]>;
}

export interface Deployment_ExperimentConfig {
  /** Version release for the experiment. */
  versionRelease?: Deployment_ExperimentConfig_VersionRelease | Computed<Deployment_ExperimentConfig_VersionRelease>;
}

export interface Deployment_InstagramCredentials {
...
export interface Deployment_ModelSettings {
...
export interface Deployment_WhatsappCredentials {
  /** Required. The Meta auth code provided by the embedded signup flow. */
  authCode?: string | Computed<string>;
...
const Deployment_AgentRegistryDeploymentFields: FieldMap = {
  agentRegistryServiceName: "agent_registry_service_name",
};

const Deployment_ChannelProfile_InstagramConfigFields: FieldMap = {
...
const Deployment_ChannelProfile_WhatsappConfigFields: FieldMap = {
  description: "description",
  displayName: "display_name",
...
const Deployment_ChannelProfileFields: FieldMap = {
  ...
  instagramConfig: {
    ...
    kind: "object",
    fields: Deployment_ChannelProfile_InstagramConfigFields,
  },
  ...
  whatsappConfig: {
    ...
    kind: "object",
    fields: Deployment_ChannelProfile_WhatsappConfigFields,
  },
};

const Deployment_ExperimentConfig_VersionRelease_TrafficAllocationsFields: FieldMap = {
  appVersion: "app_version",
  id: "id",
  trafficPercentage: "traffic_percentage",
};

const Deployment_ExperimentConfig_VersionReleaseFields: FieldMap = {
  state: "state",
  trafficAllocations: {
    wireName: "traffic_allocations",
    kind: "list",
    fields: Deployment_ExperimentConfig_VersionRelease_TrafficAllocationsFields,
  },
};

const Deployment_ExperimentConfigFields: FieldMap = {
  versionRelease: {
    wireName: "version_release",
    kind: "object",
    fields: Deployment_ExperimentConfig_VersionReleaseFields,
  },
};

const Deployment_InstagramCredentialsFields: FieldMap = {
  authCode: "auth_code",
  conversationProfileId: "conversation_profile_id",
};

const Deployment_ModelSettingsFields: FieldMap = {
  model: "model",
  temperature: "temperature",
};

const Deployment_WhatsappCredentialsFields: FieldMap = {
  authCode: "auth_code",
...
export interface DeploymentConfig {
  ...
  agentRegistryDeployment?: Deployment_AgentRegistryDeployment | Computed<Deployment_AgentRegistryDeployment>;
  ...
  instagramCredentials?: Deployment_InstagramCredentials | Computed<Deployment_InstagramCredentials>;
...
export interface DeploymentAttrs {
  /** Configuration and status for Agent Registry deployment. */
  agentRegistryDeployment: Deployment_AgentRegistryDeployment;
  /** Optional. The resource name of the app version to deploy. Format: `projects/{project}/locations/{location}/apps/{app}/versions/{version}` Use `projects/{project}/locations/{location}/apps/{app}/versions/-` to use the draft app. */
  appVersion: string;
  /** A ChannelProfile configures the agent's behavior for a specific communication channel, such as web UI or telephony. */
  ...
  etag: string;
  /** Experiment for the deployment. */
  experimentConfig: Deployment_ExperimentConfig;
  /** Ephemeral Meta credentials for Instagram native integration. */
  instagramCredentials: Deployment_InstagramCredentials;
  /** Optional. The modality of the deployment. Note: Deployment-level modality override is gated behind an allowlist. Contact the CXAS team to enable this field. */
  modality: string;
  /** Model settings contains various configurations for the LLM model. */
  modelSettings: Deployment_ModelSettings;
  /** Identifier. The resource name of the deployment. Format: `projects/{project}/locations/{location}/apps/{app}/deployments/{deployment}` */
  name: string;
  /** Output only. Timestamp when this deployment was last updated. */
  updateTime: string;
  /** Ephemeral Meta credentials for WhatsApp native integration. */
  whatsappCredentials: Deployment_WhatsappCredentials;
}
...
export const Deployment: ResourceBinding<DeploymentConfig, DeploymentAttrs> = {
  ...
  fields: {
    agentRegistryDeployment: {
      ...
      kind: "object",
      fields: Deployment_AgentRegistryDeploymentFields,
    },
    appVersion: "app_version",
    channelProfile: {
    ...
    experimentConfig: {
      ...
      kind: "object",
      fields: Deployment_ExperimentConfigFields,
    },
    instagramCredentials: {
      wireName: "instagram_credentials",
      kind: "object",
      fields: Deployment_InstagramCredentialsFields,
    },
    modality: "modality",
    modelSettings: {
    ...
    whatsappCredentials: {
      ...
      kind: "object",
      fields: Deployment_WhatsappCredentialsFields,
    },
  },
};
