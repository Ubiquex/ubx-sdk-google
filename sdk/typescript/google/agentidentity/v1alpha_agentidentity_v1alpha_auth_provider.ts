...
export interface V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ApiKey {
  /** Optional. Input only. The API key for this auth_provider. */
  apiKey?: string | Computed<string>;
}

export interface V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ThreeLeggedOauth {
...
export interface V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_TwoLeggedOauth {
  /** Optional. The client ID of the OAuth client. */
  clientId?: string | Computed<string>;
  /** Optional. Input only. The client secret of the OAuth client. */
  clientSecret?: string | Computed<string>;
...
export interface V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams {
  /** Message describing ApiKeyParams object. */
  apiKey?: V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ApiKey | Computed<V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ApiKey>;
  ...
  threeLeggedOauth?: V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ThreeLeggedOauth | Computed<V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ThreeLeggedOauth>;
  /** Message describing TwoLeggedOAuth object. */
  twoLeggedOauth?: V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_TwoLeggedOauth | Computed<V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_TwoLeggedOauth>;
}

const V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ApiKeyFields: FieldMap = {
  apiKey: "api_key",
};

const V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ThreeLeggedOauthFields: FieldMap = {
...
const V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_TwoLeggedOauthFields: FieldMap = {
  clientId: "client_id",
  clientSecret: "client_secret",
  tokenUrl: "token_url",
};

const V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParamsFields: FieldMap = {
  apiKey: {
    wireName: "api_key",
    kind: "object",
    fields: V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ApiKeyFields,
  },
  geAuthProvider: "ge_auth_provider",
  threeLeggedOauth: {
    wireName: "three_legged_oauth",
    kind: "object",
    fields: V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_ThreeLeggedOauthFields,
  },
  twoLeggedOauth: {
    wireName: "two_legged_oauth",
    kind: "object",
    fields: V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams_TwoLeggedOauthFields,
  },
};

export interface V1alphaAgentidentityV1alphaAuthProviderConfig {
  ...
  authProviderTypeParams?: V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams | Computed<V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams>;
...
export interface V1alphaAgentidentityV1alphaAuthProviderAttrs {
  /** Optional. List of scopes that are allowed to be requested for this auth_provider. If this list is non-empty, only scopes within this list may be requested. If this list is empty, all scopes may be requested. Scopes appearing in `blocked_scopes` are disallowed even if they appear in `allowed_scopes`. The number of allowed scopes is limited to 200. */
  allowedScopes: string[];
  /** AuthProvider type specific parameters. Required when creating an auth_provider. */
  authProviderTypeParams: V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParams;
  /** Optional. List of scopes that are blocked from being requested for this auth_provider. If a scope appears in this list, it will not be requested, even if it also appears in `allowed_scopes`. `blocked_scopes` takes precedence over `allowed_scopes`. The number of blocked scopes is limited to 200. */
...
export const V1alphaAgentidentityV1alphaAuthProvider: ResourceBinding<V1alphaAgentidentityV1alphaAuthProviderConfig, V1alphaAgentidentityV1alphaAuthProviderAttrs> = {
  wireType: "google_agentidentity_v1alpha_agentidentity_v1alpha_auth_provider",
  fields: {
    allowedScopes: "allowed_scopes",
    authProviderTypeParams: {
      wireName: "auth_provider_type_params",
      kind: "object",
      fields: V1alphaAgentidentityV1alphaAuthProvider_AuthProviderTypeParamsFields,
    },
