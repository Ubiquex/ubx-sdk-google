...
export interface AuthProvider_AuthProviderTypeParams_ApiKey {
  /** Optional. Input only. The API key for this auth provider. */
  apiKey?: string | Computed<string>;
}

export interface AuthProvider_AuthProviderTypeParams_ThreeLeggedOauth {
...
export interface AuthProvider_AuthProviderTypeParams_TwoLeggedOauth {
  /** Optional. The client ID of the OAuth client. */
  clientId?: string | Computed<string>;
  /** Optional. Input only. The client secret of the OAuth client. */
  clientSecret?: string | Computed<string>;
...
export interface AuthProvider_AuthProviderTypeParams {
  /** Configuration for API key authentication. */
  apiKey?: AuthProvider_AuthProviderTypeParams_ApiKey | Computed<AuthProvider_AuthProviderTypeParams_ApiKey>;
  ...
  threeLeggedOauth?: AuthProvider_AuthProviderTypeParams_ThreeLeggedOauth | Computed<AuthProvider_AuthProviderTypeParams_ThreeLeggedOauth>;
  /** Configuration for 2-legged OAuth (2LO) authentication. */
  twoLeggedOauth?: AuthProvider_AuthProviderTypeParams_TwoLeggedOauth | Computed<AuthProvider_AuthProviderTypeParams_TwoLeggedOauth>;
}

const AuthProvider_AuthProviderTypeParams_ApiKeyFields: FieldMap = {
  apiKey: "api_key",
};

const AuthProvider_AuthProviderTypeParams_ThreeLeggedOauthFields: FieldMap = {
...
const AuthProvider_AuthProviderTypeParams_TwoLeggedOauthFields: FieldMap = {
  clientId: "client_id",
  clientSecret: "client_secret",
  tokenUrl: "token_url",
};

const AuthProvider_AuthProviderTypeParamsFields: FieldMap = {
  apiKey: {
    wireName: "api_key",
    kind: "object",
...
export interface AuthProviderConfig {
  ...
  authProviderTypeParams?: AuthProvider_AuthProviderTypeParams | Computed<AuthProvider_AuthProviderTypeParams>;
...
export interface AuthProviderAttrs {
  /** Optional. List of scopes that are allowed to be requested for this auth provider. If this list is non-empty, only scopes within this list may be requested. If this list is empty, all scopes may be requested. Scopes appearing in `blocked_scopes` are disallowed even if they appear in `allowed_scopes`. The number of allowed scopes is limited to 200. */
  allowedScopes: string[];
  /** Required. Parameters specific to the auth provider type. */
  authProviderTypeParams: AuthProvider_AuthProviderTypeParams;
  /** Optional. List of scopes that are blocked from being requested for this auth provider. If a scope appears in this list, it will not be requested, even if it also appears in `allowed_scopes`. `blocked_scopes` takes precedence over `allowed_scopes`. The number of blocked scopes is limited to 200. */
...
export const AuthProvider: ResourceBinding<AuthProviderConfig, AuthProviderAttrs> = {
  wireType: "google_agentidentity_auth_provider",
  fields: {
