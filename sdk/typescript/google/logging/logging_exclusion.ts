...
export interface LoggingExclusionConfig {
...
export interface LoggingExclusionAttrs {
  /** Output only. The creation timestamp of the exclusion.This field may not be present for older exclusions. */
  createTime: string;
  /** Optional. A description of this exclusion. */
  description: string;
...
export const LoggingExclusion: ResourceBinding<LoggingExclusionConfig, LoggingExclusionAttrs> = {
