// Code generated by `ubx sdk gen` from google_logging_logging_sink. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface LoggingSink_BigqueryOptions {
...
export interface LoggingSink_Exclusions {
...
export interface LoggingSinkConfig {
  ...
  bigqueryOptions?: LoggingSink_BigqueryOptions | Computed<LoggingSink_BigqueryOptions>;
  ...
  exclusions?: LoggingSink_Exclusions[] | Computed<LoggingSink_Exclusions[]>;
  ...
  writerIdentity?: string | Computed<string>;
}

export interface LoggingSinkAttrs {
  /** Options that change functionality of a sink exporting data to BigQuery. */
  bigqueryOptions: LoggingSink_BigqueryOptions;
  /** Output only. The creation timestamp of the sink.This field may not be present for older sinks. */
  createTime: string;
  /** Optional. A description of this sink.The maximum length of the description is 8000 characters. */
  description: string;
  ...
  disabled: boolean;
  /** Optional. Log entries that match any of these exclusion filters will not be exported.If a log entry is matched by both filter and one of exclusions it will not be exported. */
  exclusions: LoggingSink_Exclusions[];
  /** Optional. An advanced logs filter (https://docs.cloud.google.com/logging/docs/view/building-queries#queries-by-expression). The only exported log entries are those that are in the resource owning the sink and that match the filter.For example:logName="projects/[PROJECT_ID]/logs/[LOG_ID]" AND severity>=ERROR */
  filter: string;
  /** Optional. This field applies only to sinks owned by organizations and folders. If the field is false, the default, only the logs owned by the sink's parent resource are available for export. If the field is true, then log entries from all the projects, folders, and billing accounts contained in the sink's parent resource are also available for export. Whether a particular log entry from the children is exported depends on the sink's filter expression.For example, if this field is true, then the filter resource.type=gce_instance would export all Compute Engine VM instance log entries from all projects in the sink's parent.To only export entries from certain child projects, filter on the project part of the log name:logName:("projects/test-project1/" OR "projects/test-project2/") AND resource.type=gce_instance */
...
export const LoggingSink: ResourceBinding<LoggingSinkConfig, LoggingSinkAttrs> = {
  wireType: "google_logging_logging_sink",
  fields: {
    bigqueryOptions: {
      wireName: "bigquery_options",
      kind: "object",
      fields: LoggingSink_BigqueryOptionsFields,
    },
    createTime: "create_time",
    description: "description",
    ...
    exclusions: {
      wireName: "exclusions",
      kind: "list",
      fields: LoggingSink_ExclusionsFields,
    },
    filter: "filter",
