...
export interface Metric_BucketOptions {
  ...
  explicitBuckets?: Metric_BucketOptions_ExplicitBuckets | Computed<Metric_BucketOptions_ExplicitBuckets>;
  /** Specifies an exponential sequence of buckets that have a width that is proportional to the value of the lower bound. Each bucket represents a constant relative uncertainty on a specific value in the bucket.There are num_finite_buckets + 2 (= N) buckets. Bucket i has the following boundaries:Upper bound (0 <= i < N-1): scale * (growth_factor ^ i).Lower bound (1 <= i < N): scale * (growth_factor ^ (i - 1)). */
  exponentialBuckets?: Metric_BucketOptions_ExponentialBuckets | Computed<Metric_BucketOptions_ExponentialBuckets>;
  /** Specifies a linear sequence of buckets that all have the same width (except overflow and underflow). Each bucket represents a constant absolute uncertainty on the specific value in the bucket.There are num_finite_buckets + 2 (= N) buckets. Bucket i has the following boundaries:Upper bound (0 <= i < N-1): offset + (width * i).Lower bound (1 <= i < N): offset + (width * (i - 1)). */
  linearBuckets?: Metric_BucketOptions_LinearBuckets | Computed<Metric_BucketOptions_LinearBuckets>;
}
...
export interface Metric_MetricDescriptor_Metadata {
...
export interface Metric_MetricDescriptor {
  ...
  labels?: Metric_MetricDescriptor_Labels[] | Computed<Metric_MetricDescriptor_Labels[]>;
  /** Optional. The launch stage of the metric definition. */
  launchStage?: string | Computed<string>;
  /** Additional annotations that can be used to guide the usage of a metric. */
  metadata?: Metric_MetricDescriptor_Metadata | Computed<Metric_MetricDescriptor_Metadata>;
...
const Metric_MetricDescriptor_MetadataFields: FieldMap = {
