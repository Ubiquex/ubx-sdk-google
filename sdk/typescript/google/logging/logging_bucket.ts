...
export interface LoggingBucket_CmekSettings {
...
export interface LoggingBucket_IndexConfigs {
  createTime?: string | Computed<string>;
  fieldPath?: string | Computed<string>;
  type?: string | Computed<string>;
}

const LoggingBucket_CmekSettingsFields: FieldMap = {
...
const LoggingBucket_IndexConfigsFields: FieldMap = {
  createTime: "create_time",
  fieldPath: "field_path",
  type: "type",
};

export interface LoggingBucketConfig {
  ...
  cmekSettings?: LoggingBucket_CmekSettings | Computed<LoggingBucket_CmekSettings>;
  /** Output only. The creation timestamp of the bucket. This is not set for any of the default buckets. */
  createTime?: string | Computed<string>;
  /** Optional. Describes this bucket. */
  description?: string | Computed<string>;
  /** Optional. A list of indexed fields and related configuration data. */
  indexConfigs?: LoggingBucket_IndexConfigs[] | Computed<LoggingBucket_IndexConfigs[]>;
...
export interface LoggingBucketAttrs {
  /** Optional. Whether log analytics is enabled for this bucket.Once enabled, log analytics features cannot be disabled. */
  analyticsEnabled: boolean;
  /** Describes the customer-managed encryption key (CMEK) settings associated with a project, folder, organization, billing account, or flexible resource.Note: CMEK for the Log Router can currently only be configured for Google Cloud organizations. Once configured, it applies to all projects and folders in the Google Cloud organization.See Configure CMEK for Cloud Logging (https://docs.cloud.google.com/logging/docs/routing/managed-encryption) for more information. */
  cmekSettings: LoggingBucket_CmekSettings;
  /** Output only. The creation timestamp of the bucket. This is not set for any of the default buckets. */
  createTime: string;
  /** Optional. Describes this bucket. */
  description: string;
  /** Optional. A list of indexed fields and related configuration data. */
  indexConfigs: LoggingBucket_IndexConfigs[];
  /** Output only. The bucket lifecycle state. */
...
export const LoggingBucket: ResourceBinding<LoggingBucketConfig, LoggingBucketAttrs> = {
