// Code generated by `ubx sdk gen` from google_logging_logging_view. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface LoggingViewConfig {
...
export interface LoggingViewAttrs {
  /** Output only. The creation timestamp of the view. */
  createTime: string;
  /** Optional. Describes this view. */
  description: string;
...
export const LoggingView: ResourceBinding<LoggingViewConfig, LoggingViewAttrs> = {
  wireType: "google_logging_logging_view",
  fields: {
