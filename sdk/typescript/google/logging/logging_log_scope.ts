// Code generated by `ubx sdk gen` from google_logging_logging_log_scope. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface LoggingLogScopeConfig {
...
export interface LoggingLogScopeAttrs {
  /** Output only. The creation timestamp of the log scope. */
  createTime: string;
  /** Optional. Describes this log scope.The maximum length of the description is 8000 characters. */
  description: string;
...
export const LoggingLogScope: ResourceBinding<LoggingLogScopeConfig, LoggingLogScopeAttrs> = {
  wireType: "google_logging_logging_log_scope",
  fields: {
