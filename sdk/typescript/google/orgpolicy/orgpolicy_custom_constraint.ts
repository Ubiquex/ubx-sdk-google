// Code generated by `ubx sdk gen` from google_orgpolicy_orgpolicy_custom_constraint. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface OrgpolicyCustomConstraintConfig {
  /** Allow or deny type. */
...
export interface OrgpolicyCustomConstraintAttrs {
  /** Allow or deny type. */
  actionType: string;
  /** A Common Expression Language (CEL) condition which is used in the evaluation of the constraint. For example: `resource.instanceName.matches("(production|test)_(.+_)?[\d]+")` or, `resource.management.auto_upgrade == true` The max length of the condition is 1000 characters. */
  condition: string;
...
export const OrgpolicyCustomConstraint: ResourceBinding<OrgpolicyCustomConstraintConfig, OrgpolicyCustomConstraintAttrs> = {
  wireType: "google_orgpolicy_orgpolicy_custom_constraint",
  fields: {
