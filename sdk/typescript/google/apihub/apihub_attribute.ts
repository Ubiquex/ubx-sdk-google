// Code generated by `ubx sdk gen` from google_apihub_apihub_attribute. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface ApihubAttribute_AllowedValues {
...
const ApihubAttribute_AllowedValuesFields: FieldMap = {
...
export interface ApihubAttributeConfig {
  ...
  allowedValues?: ApihubAttribute_AllowedValues[] | Computed<ApihubAttribute_AllowedValues[]>;
...
export interface ApihubAttributeAttrs {
  /** Optional. The list of allowed values when the attribute value is of type enum. This is required when the data_type of the attribute is ENUM. The maximum number of allowed values of an attribute will be 1000. */
  allowedValues: ApihubAttribute_AllowedValues[];
  /** Optional. The maximum number of values that the attribute can have when associated with an API Hub resource. Cardinality 1 would represent a single-valued attribute. It must not be less than 1 or greater than 20. If not specified, the cardinality would be set to 1 by default and represent a single-valued attribute. */
  cardinality: number;
  /** Output only. The time at which the attribute was created. */
  createTime: string;
...
export const ApihubAttribute: ResourceBinding<ApihubAttributeConfig, ApihubAttributeAttrs> = {
  wireType: "google_apihub_apihub_attribute",
  fields: {
    allowedValues: {
      wireName: "allowed_values",
      kind: "list",
      fields: ApihubAttribute_AllowedValuesFields,
    },
