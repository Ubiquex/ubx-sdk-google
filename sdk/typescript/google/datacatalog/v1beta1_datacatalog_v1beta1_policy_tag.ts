...
export interface V1beta1DatacatalogV1beta1PolicyTagConfig {
...
export interface V1beta1DatacatalogV1beta1PolicyTagAttrs {
  /** Output only. Resource names of child policy tags of this policy tag. */
...
export const V1beta1DatacatalogV1beta1PolicyTag: ResourceBinding<V1beta1DatacatalogV1beta1PolicyTagConfig, V1beta1DatacatalogV1beta1PolicyTagAttrs> = {
  wireType: "google_datacatalog_v1beta1_datacatalog_v1beta1_policy_tag",
  fields: {
