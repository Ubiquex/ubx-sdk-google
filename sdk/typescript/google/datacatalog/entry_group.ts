...
export interface EntryGroup_DataCatalogTimestamps {
...
const EntryGroup_DataCatalogTimestampsFields: FieldMap = {
...
export interface EntryGroupConfig {
  ...
  dataCatalogTimestamps?: EntryGroup_DataCatalogTimestamps | Computed<EntryGroup_DataCatalogTimestamps>;
...
export interface EntryGroupAttrs {
  /** Timestamps associated with this resource in a particular system. */
  dataCatalogTimestamps: EntryGroup_DataCatalogTimestamps;
  /** Entry group description. Can consist of several sentences or paragraphs that describe the entry group contents. Default value is an empty string. */
  description: string;
  /** A short name to identify the entry group, for example, "analytics data - jan 2011". Default value is an empty string. */
  displayName: string;
