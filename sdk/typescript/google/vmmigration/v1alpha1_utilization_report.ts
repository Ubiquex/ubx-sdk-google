...
export interface V1alpha1UtilizationReport_Error {
...
export interface V1alpha1UtilizationReport_Vms_Utilization {
...
export interface V1alpha1UtilizationReport_Vms_VmwareVmDetails {
...
export interface V1alpha1UtilizationReport_Vms {
  utilization?: V1alpha1UtilizationReport_Vms_Utilization | Computed<V1alpha1UtilizationReport_Vms_Utilization>;
  vmId?: string | Computed<string>;
  vmwareVmDetails?: V1alpha1UtilizationReport_Vms_VmwareVmDetails | Computed<V1alpha1UtilizationReport_Vms_VmwareVmDetails>;
}

const V1alpha1UtilizationReport_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const V1alpha1UtilizationReport_Vms_UtilizationFields: FieldMap = {
...
const V1alpha1UtilizationReport_Vms_VmwareVmDetailsFields: FieldMap = {
...
const V1alpha1UtilizationReport_VmsFields: FieldMap = {
  utilization: {
...
export interface V1alpha1UtilizationReportAttrs {
  ...
  displayName: string;
  /** The `Status` type defines a logical error model that is suitable for different programming environments, including REST APIs and RPC APIs. It is used by [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error code, error message, and error details. You can find out more about this error model and how to work with it in the [API Design Guide](https://cloud.google.com/apis/design/errors). */
  error: V1alpha1UtilizationReport_Error;
  ...
  vmCount: number;
  /** List of utilization information per VM. When sent as part of the request, the "vm_id" field is used in order to specify which VMs to include in the report. In that case all other fields are ignored. */
  vms: V1alpha1UtilizationReport_Vms[];
  /** Output only. Total number of VMs included in the report. */
  vmsCount: number;
}
