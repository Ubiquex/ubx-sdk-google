...
const CutoverJob_Steps_FinalSync_Steps_ReplicatingFields: FieldMap = {
...
const CutoverJob_Steps_FinalSync_StepsFields: FieldMap = {
  endTime: "end_time",
  ...
  replicating: {
    ...
    kind: "object",
    fields: CutoverJob_Steps_FinalSync_Steps_ReplicatingFields,
  },
  startTime: "start_time",
};

const CutoverJob_Steps_FinalSync_Warnings_ActionItemFields: FieldMap = {
  locale: "locale",
  message: "message",
};

const CutoverJob_Steps_FinalSync_Warnings_HelpLinksFields: FieldMap = {
  description: "description",
  url: "url",
};

const CutoverJob_Steps_FinalSync_WarningsFields: FieldMap = {
  actionItem: {
    wireName: "action_item",
    kind: "object",
    fields: CutoverJob_Steps_FinalSync_Warnings_ActionItemFields,
  },
  code: "code",
  helpLinks: {
    wireName: "help_links",
    kind: "list",
    fields: CutoverJob_Steps_FinalSync_Warnings_HelpLinksFields,
  },
  warningMessage: {
...
const CutoverJob_Steps_FinalSyncFields: FieldMap = {
  ...
  steps: {
    wireName: "steps",
    kind: "list",
    fields: CutoverJob_Steps_FinalSync_StepsFields,
  },
  totalPauseDuration: "total_pause_duration",
  warnings: {
    wireName: "warnings",
    kind: "list",
    fields: CutoverJob_Steps_FinalSync_WarningsFields,
  },
};

const CutoverJob_StepsFields: FieldMap = {
  endTime: "end_time",
  finalSync: {
    wireName: "final_sync",
    kind: "object",
    fields: CutoverJob_Steps_FinalSyncFields,
  },
...
export interface CutoverJobConfig {
  ...
  steps?: CutoverJob_Steps[] | Computed<CutoverJob_Steps[]>;
}
