...
export interface V1beta1Repository_DataEncryptionState {
  /** Required. The KMS key version name with which data of a resource is encrypted. */
  kmsKeyVersionName?: string | Computed<string>;
}

export interface V1beta1Repository_GitRemoteSettings_SshAuthenticationConfig {
...
export interface V1beta1Repository_GitRemoteSettings {
  ...
  sshAuthenticationConfig?: V1beta1Repository_GitRemoteSettings_SshAuthenticationConfig | Computed<V1beta1Repository_GitRemoteSettings_SshAuthenticationConfig>;
...
export interface V1beta1Repository_WorkspaceCompilationOverrides {
...
const V1beta1Repository_DataEncryptionStateFields: FieldMap = {
  kmsKeyVersionName: "kms_key_version_name",
};

const V1beta1Repository_GitRemoteSettings_SshAuthenticationConfigFields: FieldMap = {
  hostPublicKey: "host_public_key",
  userPrivateKeySecretVersion: "user_private_key_secret_version",
};

const V1beta1Repository_GitRemoteSettingsFields: FieldMap = {
...
const V1beta1Repository_WorkspaceCompilationOverridesFields: FieldMap = {
...
export interface V1beta1RepositoryAttrs {
  ...
  createTime: string;
  /** Describes encryption state of a resource. */
  dataEncryptionState: V1beta1Repository_DataEncryptionState;
  /** Optional. The repository's user-friendly name. */
  displayName: string;
  /** Controls Git remote configuration for a repository. */
  gitRemoteSettings: V1beta1Repository_GitRemoteSettings;
  ...
  /** Configures workspace compilation overrides for a repository. Primarily used by the UI (`console.cloud.google.com`). `schema_suffix` and `table_prefix` can have a special expression - `${workspaceName}`, which refers to the workspace name from which the compilation results will be created. API callers are expected to resolve the expression in these overrides and provide them explicitly in `code_compilation_config` (https://cloud.google.com/dataform/reference/rest/v1beta1/projects.locations.repositories.compilationResults#codecompilationconfig) when creating workspace-scoped compilation results. */
  workspaceCompilationOverrides: V1beta1Repository_WorkspaceCompilationOverrides;
}
