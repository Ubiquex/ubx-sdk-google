// Code generated by `ubx sdk gen` from google_dataform_v1beta1_dataform_v1beta1_folder. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1DataformV1beta1FolderConfig {
...
export interface V1beta1DataformV1beta1FolderAttrs {
  /** Optional. The containing Folder resource name. This should take the format: projects/{project}/locations/{location}/folders/{folder}, projects/{project}/locations/{location}/teamFolders/{teamFolder}, or just "" if this is a root Folder. This field can only be updated through MoveFolder. */
...
export const V1beta1DataformV1beta1Folder: ResourceBinding<V1beta1DataformV1beta1FolderConfig, V1beta1DataformV1beta1FolderAttrs> = {
  wireType: "google_dataform_v1beta1_dataform_v1beta1_folder",
  fields: {
