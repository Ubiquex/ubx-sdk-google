// Code generated by `ubx sdk gen` from google_apigateway_apigateway_gateway. DO NOT EDIT.
...
export interface ApigatewayGatewayAttrs {
  /** Required. Resource name of the API Config for this Gateway. Format: projects/{project}/locations/global/apis/{api}/configs/{apiConfig} */
  apiConfig: string;
  /** Output only. Created time. */
  createTime: string;
...
export const ApigatewayGateway: ResourceBinding<ApigatewayGatewayConfig, ApigatewayGatewayAttrs> = {
  wireType: "google_apigateway_apigateway_gateway",
  fields: {
