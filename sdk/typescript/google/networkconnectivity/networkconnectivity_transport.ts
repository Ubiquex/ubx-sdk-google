...
export interface NetworkconnectivityTransportConfig {
...
export interface NetworkconnectivityTransportAttrs {
  /** Optional. List of IP Prefixes that will be advertised to the remote provider. Both IPv4 and IPv6 addresses are supported. */
...
export const NetworkconnectivityTransport: ResourceBinding<NetworkconnectivityTransportConfig, NetworkconnectivityTransportAttrs> = {
