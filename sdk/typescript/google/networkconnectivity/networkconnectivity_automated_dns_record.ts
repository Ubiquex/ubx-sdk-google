// Code generated by `ubx sdk gen` from google_networkconnectivity_networkconnectivity_automated_dns_record. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetworkconnectivityAutomatedDnsRecord_CurrentConfig {
...
const NetworkconnectivityAutomatedDnsRecord_CurrentConfigFields: FieldMap = {
  rrdatas: "rrdatas",
  ttl: "ttl",
};

export interface NetworkconnectivityAutomatedDnsRecordConfig {
  ...
  currentConfig?: NetworkconnectivityAutomatedDnsRecord_CurrentConfig | Computed<NetworkconnectivityAutomatedDnsRecord_CurrentConfig>;
  ...
  /** Defines the configuration of a DNS record. */
  originalConfig?: NetworkconnectivityAutomatedDnsRecord_CurrentConfig | Computed<NetworkconnectivityAutomatedDnsRecord_CurrentConfig>;
...
export interface NetworkconnectivityAutomatedDnsRecordAttrs {
  /** Required. Immutable. The full resource path of the consumer network this AutomatedDnsRecord is visible to. Example: "projects/{projectNumOrId}/global/networks/{networkName}". */
  ...
  creationMode: string;
  /** Defines the configuration of a DNS record. */
  currentConfig: NetworkconnectivityAutomatedDnsRecord_CurrentConfig;
  /** A human-readable description of the record. */
  description: string;
  /** Required. Immutable. The dns suffix for this record to use in longest-suffix matching. Requires a trailing dot. Example: "example.com." */
  dnsSuffix: string;
  ...
  name: string;
  /** Defines the configuration of a DNS record. */
  originalConfig: NetworkconnectivityAutomatedDnsRecord_CurrentConfig;
  /** Required. Immutable. The identifier of a supported record type. */
  recordType: string;
  /** Required. Immutable. The service class identifier which authorizes this AutomatedDnsRecord. Any API calls targeting this AutomatedDnsRecord must have `networkconnectivity.serviceClasses.use` IAM permission for the provided service class. */
  serviceClass: string;
...
export const NetworkconnectivityAutomatedDnsRecord: ResourceBinding<NetworkconnectivityAutomatedDnsRecordConfig, NetworkconnectivityAutomatedDnsRecordAttrs> = {
  wireType: "google_networkconnectivity_networkconnectivity_automated_dns_record",
  fields: {
    ...
    currentConfig: {
      ...
      kind: "object",
      fields: NetworkconnectivityAutomatedDnsRecord_CurrentConfigFields,
    },
