...
export interface NetworkconnectivityGatewayAdvertisedRouteConfig {
...
export interface NetworkconnectivityGatewayAdvertisedRouteAttrs {
  /** Output only. The time the gateway advertised route was created. */
  createTime: string;
  /** An optional description of the gateway advertised route. */
  description: string;
...
export const NetworkconnectivityGatewayAdvertisedRoute: ResourceBinding<NetworkconnectivityGatewayAdvertisedRouteConfig, NetworkconnectivityGatewayAdvertisedRouteAttrs> = {
  wireType: "google_networkconnectivity_networkconnectivity_gateway_advertised_route",
  fields: {
