// Code generated by `ubx sdk gen` from google_networkconnectivity_internal_range. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface InternalRange_AllocationOptions {
...
export interface InternalRange_Migration {
...
const InternalRange_AllocationOptionsFields: FieldMap = {
  allocationStrategy: "allocation_strategy",
  firstAvailableRangesLookupSize: "first_available_ranges_lookup_size",
};

const InternalRange_MigrationFields: FieldMap = {
  source: "source",
  target: "target",
};
...
export interface InternalRangeConfig {
  ...
  migration?: InternalRange_Migration | Computed<InternalRange_Migration>;
...
export interface InternalRangeAttrs {
  /** Range auto-allocation options, to be optionally used when CIDR block is not explicitly set. */
  allocationOptions: InternalRange_AllocationOptions;
  ...
  /** Specification for migration with source and target resource names. */
  migration: InternalRange_Migration;
  /** Identifier. The name of an internal range. Format: projects/{project}/locations/{location}/internalRanges/{internal_range} See: https://google.aip.dev/122#fields-representing-resource-names */
  name: string;
  /** Immutable. The URL or resource ID of the network in which to reserve the internal range. The network cannot be deleted if there are any reserved internal ranges referring to it. Legacy networks are not supported. For example: https://www.googleapis.com/compute/v1/projects/{project}/locations/global/networks/{network} projects/{project}/locations/global/networks/{network} {network} */
  network: string;
...
export const InternalRange: ResourceBinding<InternalRangeConfig, InternalRangeAttrs> = {
  wireType: "google_networkconnectivity_internal_range",
  fields: {
    allocationOptions: {
