...
export interface NetworkconnectivityServiceConnectionTokenConfig {
...
export interface NetworkconnectivityServiceConnectionTokenAttrs {
  /** Output only. Time when the ServiceConnectionToken was created. */
  createTime: string;
  /** A description of this resource. */
  description: string;
...
export const NetworkconnectivityServiceConnectionToken: ResourceBinding<NetworkconnectivityServiceConnectionTokenConfig, NetworkconnectivityServiceConnectionTokenAttrs> = {
