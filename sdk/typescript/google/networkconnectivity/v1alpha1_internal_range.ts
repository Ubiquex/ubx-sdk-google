// Code generated by `ubx sdk gen` from google_networkconnectivity_v1alpha1_internal_range. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1alpha1InternalRange_AllocationOptions {
...
export interface V1alpha1InternalRange_Migration {
...
const V1alpha1InternalRange_AllocationOptionsFields: FieldMap = {
  allocationStrategy: "allocation_strategy",
  firstAvailableRangesLookupSize: "first_available_ranges_lookup_size",
};

const V1alpha1InternalRange_MigrationFields: FieldMap = {
  source: "source",
  target: "target",
};

export interface V1alpha1InternalRangeConfig {
  /** Range auto-allocation options, to be optionally used when CIDR block is not explicitly set. */
  allocationOptions?: V1alpha1InternalRange_AllocationOptions | Computed<V1alpha1InternalRange_AllocationOptions>;
  ...
  migration?: V1alpha1InternalRange_Migration | Computed<V1alpha1InternalRange_Migration>;
...
export interface V1alpha1InternalRangeAttrs {
  /** Range auto-allocation options, to be optionally used when CIDR block is not explicitly set. */
  allocationOptions: V1alpha1InternalRange_AllocationOptions;
  /** Output only. Time when the internal range was created. */
  createTime: string;
  /** Optional. A description of this resource. */
  description: string;
  ...
  /** Specification for migration with source and target resource names. */
  migration: V1alpha1InternalRange_Migration;
  /** Identifier. The name of an internal range. Format: projects/{project}/locations/{location}/internalRanges/{internal_range} See: https://google.aip.dev/122#fields-representing-resource-names */
  name: string;
  /** Optional. The URL or resource ID of the network in which to reserve the internal range. The network cannot be deleted if there are any reserved internal ranges referring to it. Legacy networks are not supported. For example: https://www.googleapis.com/compute/v1/projects/{project}/locations/global/networks/{network} projects/{project}/locations/global/networks/{network} {network} */
  network: string;
...
export const V1alpha1InternalRange: ResourceBinding<V1alpha1InternalRangeConfig, V1alpha1InternalRangeAttrs> = {
  wireType: "google_networkconnectivity_v1alpha1_internal_range",
  fields: {
    allocationOptions: {
      wireName: "allocation_options",
      kind: "object",
      fields: V1alpha1InternalRange_AllocationOptionsFields,
    },
    ...
    migration: {
      wireName: "migration",
      kind: "object",
      fields: V1alpha1InternalRange_MigrationFields,
    },
    name: "name",
    network: "network",
    overlaps: "overlaps",
