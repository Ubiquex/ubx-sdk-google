...
export interface PscAuthorizationPolicyConfig {
...
export const PscAuthorizationPolicy: ResourceBinding<PscAuthorizationPolicyConfig, PscAuthorizationPolicyAttrs> = {
