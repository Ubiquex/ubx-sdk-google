...
export interface V1alphaSecurityGateway_Hubs_InternetGateway {
  assignedIps?: string[] | Computed<string[]>;
}

export interface V1alphaSecurityGateway_Hubs {
  internetGateway?: V1alphaSecurityGateway_Hubs_InternetGateway | Computed<V1alphaSecurityGateway_Hubs_InternetGateway>;
}

export interface V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders_DeviceInfo {
  /** Optional. The output type details for the delegated device. */
  outputType?: string | Computed<string>;
}

export interface V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders {
  /** The delegated device information configuration. */
  deviceInfo?: V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders_DeviceInfo | Computed<V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders_DeviceInfo>;
  /** The delegated dispatch information configuration. */
  dispatchInfo?: V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders_DeviceInfo | Computed<V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders_DeviceInfo>;
  /** The delegated group configuration details. */
  groupInfo?: V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders_DeviceInfo | Computed<V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders_DeviceInfo>;
  /** Optional. Default output type for all enabled headers. */
  outputType?: string | Computed<string>;
  /** The configuration information for the delegated user. */
  userInfo?: V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders_DeviceInfo | Computed<V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders_DeviceInfo>;
}

export interface V1alphaSecurityGateway_ProxyProtocolConfig {
  ...
  contextualHeaders?: V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders | Computed<V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders>;
...
export interface V1alphaSecurityGateway_ServiceDiscovery_ApiGateway_ResourceOverride {
  /** Optional. Contains the URI path fragment where HTTP request is sent. */
  path?: string | Computed<string>;
}

export interface V1alphaSecurityGateway_ServiceDiscovery_ApiGateway {
  /** API operation descriptor. */
  resourceOverride?: V1alphaSecurityGateway_ServiceDiscovery_ApiGateway_ResourceOverride | Computed<V1alphaSecurityGateway_ServiceDiscovery_ApiGateway_ResourceOverride>;
}

export interface V1alphaSecurityGateway_ServiceDiscovery {
  /** If Service Discovery is done through API, defines its settings. */
  apiGateway?: V1alphaSecurityGateway_ServiceDiscovery_ApiGateway | Computed<V1alphaSecurityGateway_ServiceDiscovery_ApiGateway>;
}

const V1alphaSecurityGateway_Hubs_InternetGatewayFields: FieldMap = {
  assignedIps: "assigned_ips",
};

const V1alphaSecurityGateway_HubsFields: FieldMap = {
  internetGateway: {
...
const V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeaders_DeviceInfoFields: FieldMap = {
  outputType: "output_type",
};

const V1alphaSecurityGateway_ProxyProtocolConfig_ContextualHeadersFields: FieldMap = {
  deviceInfo: {
...
const V1alphaSecurityGateway_ProxyProtocolConfigFields: FieldMap = {
...
const V1alphaSecurityGateway_ServiceDiscovery_ApiGateway_ResourceOverrideFields: FieldMap = {
  path: "path",
};

const V1alphaSecurityGateway_ServiceDiscovery_ApiGatewayFields: FieldMap = {
  resourceOverride: {
...
const V1alphaSecurityGateway_ServiceDiscoveryFields: FieldMap = {
  apiGateway: {
...
export interface V1alphaSecurityGatewayAttrs {
  ...
  externalIps: string[];
  /** Optional. Map of Hubs that represents regional data path deployment with GCP region as a key. */
  hubs: Record<string, V1alphaSecurityGateway_Hubs>;
  /** Configuration for Cloud Logging. */
  logging: unknown;
  /** Identifier. Name of the resource. */
  name: string;
  /** The configuration for the proxy. */
  proxyProtocolConfig: V1alphaSecurityGateway_ProxyProtocolConfig;
  /** Settings related to the Service Discovery. */
  serviceDiscovery: V1alphaSecurityGateway_ServiceDiscovery;
