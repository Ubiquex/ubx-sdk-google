...
export interface V1beta1MigrationJob_DestinationDatabase {
  /** The database engine. */
...
export interface V1beta1MigrationJob_Error {
...
export interface V1beta1MigrationJob_ReverseSshConnectivity {
...
export interface V1beta1MigrationJob_VpcPeeringConnectivity {
  /** The name of the VPC network to peer with the Cloud SQL private network. */
  vpc?: string | Computed<string>;
}

const V1beta1MigrationJob_DestinationDatabaseFields: FieldMap = {
  engine: "engine",
  provider: "provider",
};

const V1beta1MigrationJob_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const V1beta1MigrationJob_ReverseSshConnectivityFields: FieldMap = {
  vm: "vm",
  vmIp: "vm_ip",
  vmPort: "vm_port",
  vpc: "vpc",
...
const V1beta1MigrationJob_VpcPeeringConnectivityFields: FieldMap = {
  vpc: "vpc",
};
...
export interface V1beta1MigrationJobConfig {
  ...
  destinationDatabase?: V1beta1MigrationJob_DestinationDatabase | Computed<V1beta1MigrationJob_DestinationDatabase>;
  ...
  /** A message defining the database engine and provider. */
  sourceDatabase?: V1beta1MigrationJob_DestinationDatabase | Computed<V1beta1MigrationJob_DestinationDatabase>;
...
export interface V1beta1MigrationJobAttrs {
  /** Output only. The timestamp when the migration job resource was created. A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z". */
  createTime: string;
  /** Required. The resource name (URI) of the destination connection profile. */
  destination: string;
  /** A message defining the database engine and provider. */
  destinationDatabase: V1beta1MigrationJob_DestinationDatabase;
  /** The migration job display name. */
  displayName: string;
  /** The path to the dump file in Google Cloud Storage, in the format: (gs://[BUCKET_NAME]/[OBJECT_NAME]). */
  dumpPath: string;
  ...
  endTime: string;
  /** The `Status` type defines a logical error model that is suitable for different programming environments, including REST APIs and RPC APIs. It is used by [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error code, error message, and error details. You can find out more about this error model and how to work with it in the [API Design Guide](https://cloud.google.com/apis/design/errors). */
  error: V1beta1MigrationJob_Error;
  /** The resource labels for migration job to use to annotate any related underlying resources such as Compute Engine VMs. An object containing a list of "key": "value" pairs. Example: `{ "name": "wrench", "mass": "1.3kg", "count": "3" }`. */
  ...
  phase: string;
  /** The details needed to configure a reverse SSH tunnel between the source and destination databases. These details will be used when calling the generateSshScript method (see https://cloud.google.com/database-migration/docs/reference/rest/v1beta1/projects.locations.migrationJobs/generateSshScript) to produce the script that will help set up the reverse SSH tunnel, and to set up the VPC peering between the Cloud SQL private network and the VPC. */
  reverseSshConnectivity: V1beta1MigrationJob_ReverseSshConnectivity;
  /** Required. The resource name (URI) of the source connection profile. */
  source: string;
  /** A message defining the database engine and provider. */
  sourceDatabase: V1beta1MigrationJob_DestinationDatabase;
  /** The current migration job state. */
  state: string;
  /** The source database will allow incoming connections from the destination database's public IP. You can retrieve the Cloud SQL instance's public IP from the Cloud SQL console or using Cloud SQL APIs. No additional configuration is required. */
  ...
  updateTime: string;
  /** The details of the VPC where the source database is located in Google Cloud. We will use this information to set up the VPC peering connection between Cloud SQL and this VPC. */
  vpcPeeringConnectivity: V1beta1MigrationJob_VpcPeeringConnectivity;
}
