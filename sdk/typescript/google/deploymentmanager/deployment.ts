...
export interface Deployment_Operation_Error {
  /** [Output Only] The array of errors encountered while processing this operation. */
  errors?: Deployment_Operation_Error_Errors[] | Computed<Deployment_Operation_Error_Errors[]>;
}

export interface Deployment_Operation_FirewallPolicyRuleOperationMetadata {
...
export interface Deployment_Operation_GetVersionOperationMetadata_InlineSbomInfo {
...
export interface Deployment_Operation_InstancesBulkInsertOperationMetadata {
  ...
  perLocationStatus?: Record<string, Deployment_Operation_InstancesBulkInsertOperationMetadata_PerLocationStatus> | Computed<Record<string, Deployment_Operation_InstancesBulkInsertOperationMetadata_PerLocationStatus>>;
}

export interface Deployment_Operation_SetAutoscalerLinkOperationMetadata {
...
export interface Deployment_Operation_SetCommonInstanceMetadataOperationMetadata {
  /** [Output Only] The client operation id. */
  clientOperationId?: string | Computed<string>;
  /** [Output Only] Status information per location (location name is key). Example key: zones/us-central1-a */
  perLocationOperations?: Record<string, Deployment_Operation_SetCommonInstanceMetadataOperationMetadata_PerLocationOperations> | Computed<Record<string, Deployment_Operation_SetCommonInstanceMetadataOperationMetadata_PerLocationOperations>>;
}
...
export interface Deployment_Operation {
  ...
  warnings?: Deployment_Operation_Warnings[] | Computed<Deployment_Operation_Warnings[]>;
  /** [Output Only] The URL of the zone where the operation resides. Only applicable when performing per-zone operations. */
  zone?: string | Computed<string>;
}

export interface Deployment_Target_Config {
...
export interface Deployment_Update {
  /** Output only. An optional user-provided description of the deployment after the current update has been applied. */
  description?: string | Computed<string>;
  /** Map of One Platform labels; provided by the client when the resource is created or updated. Specifically: Label keys must be between 1 and 63 characters long and must conform to the following regular expression: `[a-z]([-a-z0-9]*[a-z0-9])?` Label values must be between 0 and 63 characters long and must conform to the regular expression `([a-z]([-a-z0-9]*[a-z0-9])?)?`. */
  labels?: Deployment_Labels[] | Computed<Deployment_Labels[]>;
  /** Output only. URL of the manifest representing the update configuration of this deployment. */
  manifest?: string | Computed<string>;
}

const Deployment_LabelsFields: FieldMap = {
  key: "key",
  value: "value",
};

const Deployment_Operation_Error_Errors_DebugInfoFields: FieldMap = {
  detail: "detail",
  stackEntries: "stack_entries",
};

const Deployment_Operation_Error_Errors_ErrorDetails_ErrorInfoFields: FieldMap = {
  domain: "domain",
  metadatas: "metadatas",
  reason: "reason",
};

const Deployment_Operation_Error_Errors_ErrorDetails_Help_LinksFields: FieldMap = {
  description: "description",
  url: "url",
};

const Deployment_Operation_Error_Errors_ErrorDetails_HelpFields: FieldMap = {
  links: {
    wireName: "links",
    kind: "list",
...
const Deployment_Operation_Error_Errors_ErrorDetails_LocalizedMessageFields: FieldMap = {
  locale: "locale",
  message: "message",
};

const Deployment_Operation_Error_Errors_ErrorDetails_QuotaInfoFields: FieldMap = {
...
const Deployment_Operation_Error_Errors_ErrorDetailsFields: FieldMap = {
  errorInfo: {
    wireName: "error_info",
    kind: "object",
...
const Deployment_Operation_Error_ErrorsFields: FieldMap = {
  arguments: "arguments",
  code: "code",
  debugInfo: {
    wireName: "debug_info",
...
const Deployment_Operation_ErrorFields: FieldMap = {
  errors: {
    wireName: "errors",
    kind: "list",
...
const Deployment_Operation_FirewallPolicyRuleOperationMetadataFields: FieldMap = {
  allocatedPriority: "allocated_priority",
};

const Deployment_Operation_GetVersionOperationMetadata_InlineSbomInfoFields: FieldMap = {
  currentComponentVersions: "current_component_versions",
  targetComponentVersions: "target_component_versions",
};

const Deployment_Operation_GetVersionOperationMetadataFields: FieldMap = {
  inlineSbomInfo: {
...
const Deployment_Operation_InstancesBulkInsertOperationMetadata_PerLocationStatusFields: FieldMap = {
...
const Deployment_Operation_InstancesBulkInsertOperationMetadataFields: FieldMap = {
...
const Deployment_Operation_SetAutoscalerLinkOperationMetadataFields: FieldMap = {
  zonalIgmIds: "zonal_igm_ids",
  zoneToIgmIds: "zone_to_igm_ids",
};

const Deployment_Operation_SetCommonInstanceMetadataOperationMetadata_PerLocationOperations_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const Deployment_Operation_SetCommonInstanceMetadataOperationMetadata_PerLocationOperationsFields: FieldMap = {
  error: {
    wireName: "error",
    kind: "object",
...
const Deployment_Operation_SetCommonInstanceMetadataOperationMetadataFields: FieldMap = {
...
const Deployment_Operation_WarningsFields: FieldMap = {
  code: "code",
  data: {
    wireName: "data",
    kind: "list",
...
const Deployment_OperationFields: FieldMap = {
  clientOperationId: "client_operation_id",
...
const Deployment_Target_ConfigFields: FieldMap = {
  content: "content",
};

const Deployment_Target_ImportsFields: FieldMap = {
  content: "content",
  name: "name",
};

const Deployment_TargetFields: FieldMap = {
  config: {
    wireName: "config",
    kind: "object",
...
const Deployment_UpdateFields: FieldMap = {
  description: "description",
  labels: {
    wireName: "labels",
    kind: "list",
