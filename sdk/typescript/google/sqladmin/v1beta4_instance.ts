...
export interface V1beta4Instance_DeploymentInfo_Source_TargetId {
...
export interface V1beta4Instance_DeploymentInfo_Source {
  /** Reference to another Cloud SQL instance. */
  targetId?: V1beta4Instance_DeploymentInfo_Source_TargetId | Computed<V1beta4Instance_DeploymentInfo_Source_TargetId>;
}

export interface V1beta4Instance_DeploymentInfo_Target {
  /** Reference to another Cloud SQL instance. */
  sourceId?: V1beta4Instance_DeploymentInfo_Source_TargetId | Computed<V1beta4Instance_DeploymentInfo_Source_TargetId>;
}

export interface V1beta4Instance_DeploymentInfo {
  ...
  source?: V1beta4Instance_DeploymentInfo_Source | Computed<V1beta4Instance_DeploymentInfo_Source>;
  /** Output only. The current state of blue-green-deployment for UI tags */
  state?: string | Computed<string>;
  /** The target instance for the Blue-Green deployment. */
  target?: V1beta4Instance_DeploymentInfo_Target | Computed<V1beta4Instance_DeploymentInfo_Target>;
}
...
export interface V1beta4Instance_OnPremisesConfiguration {
  ...
  /** Reference to another Cloud SQL instance. */
  sourceInstance?: V1beta4Instance_DeploymentInfo_Source_TargetId | Computed<V1beta4Instance_DeploymentInfo_Source_TargetId>;
...
const V1beta4Instance_DeploymentInfo_Source_TargetIdFields: FieldMap = {
  name: "name",
  project: "project",
  region: "region",
};

const V1beta4Instance_DeploymentInfo_SourceFields: FieldMap = {
  targetId: {
    wireName: "target_id",
    kind: "object",
...
const V1beta4Instance_DeploymentInfo_TargetFields: FieldMap = {
  sourceId: {
    wireName: "source_id",
    kind: "object",
    fields: V1beta4Instance_DeploymentInfo_Source_TargetIdFields,
...
const V1beta4Instance_DeploymentInfoFields: FieldMap = {
...
export interface V1beta4InstanceConfig {
  ...
  deploymentInfo?: V1beta4Instance_DeploymentInfo | Computed<V1beta4Instance_DeploymentInfo>;
...
export interface V1beta4InstanceAttrs {
  ...
  /** Blue-green deployment metadata for a database instance. In a blue-green deployment, we maintain two environments, one of which is live. This message contains details about the blue-green deployment. */
  deploymentInfo: V1beta4Instance_DeploymentInfo;
  /** Disk encryption configuration for an instance. */
