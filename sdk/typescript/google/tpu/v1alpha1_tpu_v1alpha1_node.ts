...
export interface V1alpha1TpuV1alpha1Node_NetworkEndpoints {
  ipAddress?: string | Computed<string>;
  port?: number | Computed<number>;
}

export interface V1alpha1TpuV1alpha1Node_SchedulingConfig {
...
export interface V1alpha1TpuV1alpha1Node_Symptoms {
...
const V1alpha1TpuV1alpha1Node_NetworkEndpointsFields: FieldMap = {
  ipAddress: "ip_address",
  port: "port",
};

const V1alpha1TpuV1alpha1Node_SchedulingConfigFields: FieldMap = {
  preemptible: "preemptible",
  reserved: "reserved",
};

const V1alpha1TpuV1alpha1Node_SymptomsFields: FieldMap = {
...
export interface V1alpha1TpuV1alpha1NodeConfig {
  ...
  networkEndpoints?: V1alpha1TpuV1alpha1Node_NetworkEndpoints[] | Computed<V1alpha1TpuV1alpha1Node_NetworkEndpoints[]>;
  ...
  schedulingConfig?: V1alpha1TpuV1alpha1Node_SchedulingConfig | Computed<V1alpha1TpuV1alpha1Node_SchedulingConfig>;
  ...
  symptoms?: V1alpha1TpuV1alpha1Node_Symptoms[] | Computed<V1alpha1TpuV1alpha1Node_Symptoms[]>;
...
export interface V1alpha1TpuV1alpha1NodeAttrs {
  /** Required. The type of hardware accelerators associated with this node. */
  ...
  network: string;
  /** Output only. The network endpoints where TPU workers can be accessed and sent work. It is recommended that Tensorflow clients of the node reach out to the 0th entry in this map first. */
  networkEndpoints: V1alpha1TpuV1alpha1Node_NetworkEndpoints[];
  /** Output only. DEPRECATED! Use network_endpoints instead. The network port for the TPU Node as visible to Compute Engine instances. */
  port: string;
  /** DEPRECATED: Please use TPU API v2alpha1 instead. Sets the scheduling options for this node. */
  schedulingConfig: V1alpha1TpuV1alpha1Node_SchedulingConfig;
  /** Output only. The service account used to run the tensor flow services within the node. To share resources, including Google Cloud Storage data, with the Tensorflow job running in the Node, this account must have permissions to that data. */
  serviceAccount: string;
  /** Output only. The current state for the TPU Node. */
  state: string;
  /** Output only. The Symptoms that have occurred to the TPU Node. */
  symptoms: V1alpha1TpuV1alpha1Node_Symptoms[];
  /** Required. The version of Tensorflow running in the Node. */
...
export const V1alpha1TpuV1alpha1Node: ResourceBinding<V1alpha1TpuV1alpha1NodeConfig, V1alpha1TpuV1alpha1NodeAttrs> = {
