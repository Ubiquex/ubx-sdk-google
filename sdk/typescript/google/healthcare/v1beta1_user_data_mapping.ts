...
export interface V1beta1UserDataMapping_ResourceAttributes {
  attributeDefinitionId?: string | Computed<string>;
  values?: string[] | Computed<string[]>;
}

const V1beta1UserDataMapping_ResourceAttributesFields: FieldMap = {
...
export interface V1beta1UserDataMappingConfig {
  ...
  resourceAttributes?: V1beta1UserDataMapping_ResourceAttributes[] | Computed<V1beta1UserDataMapping_ResourceAttributes[]>;
  /** Required. User's UUID provided by the client. */
  userId?: string | Computed<string>;
}

export interface V1beta1UserDataMappingAttrs {
  ...
  name: string;
  /** Attributes of the resource. Only explicitly set attributes are displayed here. Attribute definitions with defaults set implicitly apply to these User data mappings. Attributes listed here must be single valued, that is, exactly one value is specified for the field "values" in each Attribute. */
  resourceAttributes: V1beta1UserDataMapping_ResourceAttributes[];
  /** Required. User's UUID provided by the client. */
  userId: string;
}
