...
export interface NetappActiveDirectoryConfig {
...
export interface NetappActiveDirectoryAttrs {
  /** Optional. Users to be added to the Built-in Admininstrators group. */
...
export const NetappActiveDirectory: ResourceBinding<NetappActiveDirectoryConfig, NetappActiveDirectoryAttrs> = {
  wireType: "google_netapp_netapp_active_directory",
  fields: {
