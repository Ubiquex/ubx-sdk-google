...
export interface Replication_DestinationVolumeParameters_TieringPolicy {
...
export interface Replication_DestinationVolumeParameters {
  ...
  tieringPolicy?: Replication_DestinationVolumeParameters_TieringPolicy | Computed<Replication_DestinationVolumeParameters_TieringPolicy>;
...
export interface Replication_HybridPeeringDetails {
...
export interface Replication_HybridReplicationUserCommands {
  /** Output only. List of commands to be executed by the customer. */
  commands?: string[] | Computed<string[]>;
}

export interface Replication_TransferStats {
...
const Replication_DestinationVolumeParameters_TieringPolicyFields: FieldMap = {
  coolingThresholdDays: "cooling_threshold_days",
  hotTierBypassModeEnabled: "hot_tier_bypass_mode_enabled",
  tierAction: "tier_action",
};

const Replication_DestinationVolumeParametersFields: FieldMap = {
...
const Replication_HybridPeeringDetailsFields: FieldMap = {
  command: "command",
...
const Replication_HybridReplicationUserCommandsFields: FieldMap = {
  commands: "commands",
};

const Replication_TransferStatsFields: FieldMap = {
...
export interface ReplicationAttrs {
  /** Optional. Location of the user cluster. */
  ...
  /** DestinationVolumeParameters specify input parameters used for creating destination volume. */
  destinationVolumeParameters: Replication_DestinationVolumeParameters;
  ...
  healthy: boolean;
  /** HybridPeeringDetails contains details about the hybrid peering. */
  hybridPeeringDetails: Replication_HybridPeeringDetails;
  /** Output only. Type of the hybrid replication. */
  hybridReplicationType: string;
  /** UserCommands contains the commands to be executed by the customer. */
  hybridReplicationUserCommands: Replication_HybridReplicationUserCommands;
  /** Resource labels to represent user provided metadata. */
  ...
  stateDetails: string;
  /** TransferStats reports all statistics related to replication transfer. */
  transferStats: Replication_TransferStats;
}

export const Replication: ResourceBinding<ReplicationConfig, ReplicationAttrs> = {
