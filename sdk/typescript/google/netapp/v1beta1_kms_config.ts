...
export interface V1beta1KmsConfigConfig {
...
export interface V1beta1KmsConfigAttrs {
...
export const V1beta1KmsConfig: ResourceBinding<V1beta1KmsConfigConfig, V1beta1KmsConfigAttrs> = {
