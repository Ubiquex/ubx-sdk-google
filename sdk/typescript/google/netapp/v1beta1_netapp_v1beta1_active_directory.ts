...
export interface V1beta1NetappV1beta1ActiveDirectoryConfig {
...
export interface V1beta1NetappV1beta1ActiveDirectoryAttrs {
  /** Optional. Users to be added to the Built-in Admininstrators group. */
...
export const V1beta1NetappV1beta1ActiveDirectory: ResourceBinding<V1beta1NetappV1beta1ActiveDirectoryConfig, V1beta1NetappV1beta1ActiveDirectoryAttrs> = {
  wireType: "google_netapp_v1beta1_netapp_v1beta1_active_directory",
  fields: {
