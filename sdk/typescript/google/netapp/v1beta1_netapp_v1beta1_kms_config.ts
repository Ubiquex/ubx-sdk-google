// Code generated by `ubx sdk gen` from google_netapp_v1beta1_netapp_v1beta1_kms_config. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1NetappV1beta1KmsConfigConfig {
...
export interface V1beta1NetappV1beta1KmsConfigAttrs {
  /** Output only. Create time of the KmsConfig. */
  createTime: string;
  /** Required. Customer-managed crypto key resource full name. Format: `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}` */
...
export const V1beta1NetappV1beta1KmsConfig: ResourceBinding<V1beta1NetappV1beta1KmsConfigConfig, V1beta1NetappV1beta1KmsConfigAttrs> = {
  wireType: "google_netapp_v1beta1_netapp_v1beta1_kms_config",
  fields: {
