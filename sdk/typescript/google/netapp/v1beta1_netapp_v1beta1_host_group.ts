// Code generated by `ubx sdk gen` from google_netapp_v1beta1_netapp_v1beta1_host_group. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1NetappV1beta1HostGroupConfig {
...
export interface V1beta1NetappV1beta1HostGroupAttrs {
  /** Output only. Create time of the host group. */
  createTime: string;
  /** Optional. Description of the host group. */
  description: string;
...
export const V1beta1NetappV1beta1HostGroup: ResourceBinding<V1beta1NetappV1beta1HostGroupConfig, V1beta1NetappV1beta1HostGroupAttrs> = {
  wireType: "google_netapp_v1beta1_netapp_v1beta1_host_group",
  fields: {
