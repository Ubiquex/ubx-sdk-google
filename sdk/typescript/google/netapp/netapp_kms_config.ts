// Code generated by `ubx sdk gen` from google_netapp_netapp_kms_config. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetappKmsConfigConfig {
...
export interface NetappKmsConfigAttrs {
  /** Output only. Create time of the KmsConfig. */
  createTime: string;
  /** Required. Customer-managed crypto key resource full name. Format: `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}` */
...
export const NetappKmsConfig: ResourceBinding<NetappKmsConfigConfig, NetappKmsConfigAttrs> = {
  wireType: "google_netapp_netapp_kms_config",
  fields: {
