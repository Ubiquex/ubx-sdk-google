...
export interface V1beta1StoragePoolConfig {
...
export interface V1beta1StoragePoolAttrs {
  /** Optional. Specifies the Active Directory to be used for creating a SMB volume. */
...
export const V1beta1StoragePool: ResourceBinding<V1beta1StoragePoolConfig, V1beta1StoragePoolAttrs> = {
  wireType: "google_netapp_v1beta1_storage_pool",
  fields: {
