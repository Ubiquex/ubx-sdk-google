// Code generated by `ubx sdk gen` from google_netapp_netapp_replication. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetappReplication_DestinationVolumeParameters_TieringPolicy {
...
export interface NetappReplication_DestinationVolumeParameters {
  ...
  tieringPolicy?: NetappReplication_DestinationVolumeParameters_TieringPolicy | Computed<NetappReplication_DestinationVolumeParameters_TieringPolicy>;
...
export interface NetappReplication_HybridPeeringDetails {
...
export interface NetappReplication_HybridReplicationUserCommands {
  /** Output only. List of commands to be executed by the customer. */
  commands?: string[] | Computed<string[]>;
}

export interface NetappReplication_TransferStats {
...
const NetappReplication_DestinationVolumeParameters_TieringPolicyFields: FieldMap = {
  coolingThresholdDays: "cooling_threshold_days",
  hotTierBypassModeEnabled: "hot_tier_bypass_mode_enabled",
  tierAction: "tier_action",
};

const NetappReplication_DestinationVolumeParametersFields: FieldMap = {
  ...
  tieringPolicy: {
    ...
    kind: "object",
    fields: NetappReplication_DestinationVolumeParameters_TieringPolicyFields,
  },
  volumeId: "volume_id",
};

const NetappReplication_HybridPeeringDetailsFields: FieldMap = {
  command: "command",
...
const NetappReplication_HybridReplicationUserCommandsFields: FieldMap = {
  commands: "commands",
};

const NetappReplication_TransferStatsFields: FieldMap = {
...
export interface NetappReplicationConfig {
  ...
  destinationVolumeParameters?: NetappReplication_DestinationVolumeParameters | Computed<NetappReplication_DestinationVolumeParameters>;
  ...
  hybridPeeringDetails?: NetappReplication_HybridPeeringDetails | Computed<NetappReplication_HybridPeeringDetails>;
  /** Output only. Type of the hybrid replication. */
  hybridReplicationType?: string | Computed<string>;
  /** UserCommands contains the commands to be executed by the customer. */
  hybridReplicationUserCommands?: NetappReplication_HybridReplicationUserCommands | Computed<NetappReplication_HybridReplicationUserCommands>;
  ...
  transferStats?: NetappReplication_TransferStats | Computed<NetappReplication_TransferStats>;
}

export interface NetappReplicationAttrs {
  /** Optional. Location of the user cluster. */
  ...
  /** DestinationVolumeParameters specify input parameters used for creating destination volume. */
  destinationVolumeParameters: NetappReplication_DestinationVolumeParameters;
  /** Output only. Condition of the relationship. Can be one of the following: - true: The replication relationship is healthy. It has not missed the most recent scheduled transfer. - false: The replication relationship is not healthy. It has missed the most recent scheduled transfer. */
  healthy: boolean;
  /** HybridPeeringDetails contains details about the hybrid peering. */
  hybridPeeringDetails: NetappReplication_HybridPeeringDetails;
  /** Output only. Type of the hybrid replication. */
  hybridReplicationType: string;
  /** UserCommands contains the commands to be executed by the customer. */
  hybridReplicationUserCommands: NetappReplication_HybridReplicationUserCommands;
  /** Resource labels to represent user provided metadata. */
  ...
  stateDetails: string;
  /** TransferStats reports all statistics related to replication transfer. */
  transferStats: NetappReplication_TransferStats;
}

export const NetappReplication: ResourceBinding<NetappReplicationConfig, NetappReplicationAttrs> = {
  wireType: "google_netapp_netapp_replication",
  fields: {
    ...
    destinationVolumeParameters: {
      ...
      kind: "object",
      fields: NetappReplication_DestinationVolumeParametersFields,
    },
    healthy: "healthy",
    hybridPeeringDetails: {
      wireName: "hybrid_peering_details",
      kind: "object",
      fields: NetappReplication_HybridPeeringDetailsFields,
    },
    hybridReplicationType: "hybrid_replication_type",
    hybridReplicationUserCommands: {
      wireName: "hybrid_replication_user_commands",
      kind: "object",
      fields: NetappReplication_HybridReplicationUserCommandsFields,
    },
    labels: "labels",
    ...
    transferStats: {
      ...
      kind: "object",
      fields: NetappReplication_TransferStatsFields,
    },
  },
};
