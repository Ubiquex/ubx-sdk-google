...
export interface NetappStoragePoolConfig {
...
export interface NetappStoragePoolAttrs {
  /** Optional. Specifies the Active Directory to be used for creating a SMB volume. */
...
export const NetappStoragePool: ResourceBinding<NetappStoragePoolConfig, NetappStoragePoolAttrs> = {
  wireType: "google_netapp_netapp_storage_pool",
  fields: {
