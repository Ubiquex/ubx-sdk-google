...
export interface V1beta1NetappV1beta1Backup_OntapSource {
...
const V1beta1NetappV1beta1Backup_OntapSourceFields: FieldMap = {
  snapshotUuid: "snapshot_uuid",
  storagePool: "storage_pool",
  volumeUuid: "volume_uuid",
};

export interface V1beta1NetappV1beta1BackupConfig {
  ...
  ontapSource?: V1beta1NetappV1beta1Backup_OntapSource | Computed<V1beta1NetappV1beta1Backup_OntapSource>;
...
export interface V1beta1NetappV1beta1BackupAttrs {
  /** Output only. Region in which backup is stored. Format: `projects/{project_id}/locations/{location}` */
  backupRegion: string;
  /** Output only. Type of backup, manually created or created by a backup policy. */
  backupType: string;
  ...
  name: string;
  /** Represents ONTAP source details. */
  ontapSource: V1beta1NetappV1beta1Backup_OntapSource;
  /** Output only. Reserved for future use */
...
export const V1beta1NetappV1beta1Backup: ResourceBinding<V1beta1NetappV1beta1BackupConfig, V1beta1NetappV1beta1BackupAttrs> = {
