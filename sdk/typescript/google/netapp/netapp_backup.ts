...
export interface NetappBackup_OntapSource {
...
const NetappBackup_OntapSourceFields: FieldMap = {
...
export interface NetappBackupConfig {
  ...
  ontapSource?: NetappBackup_OntapSource | Computed<NetappBackup_OntapSource>;
...
export interface NetappBackupAttrs {
  ...
  name: string;
  /** Represents ONTAP source details. */
  ontapSource: NetappBackup_OntapSource;
  /** Output only. Reserved for future use */
