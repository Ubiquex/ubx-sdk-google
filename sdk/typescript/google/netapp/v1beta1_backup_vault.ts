...
export interface V1beta1BackupVault_BackupRetentionPolicy {
...
const V1beta1BackupVault_BackupRetentionPolicyFields: FieldMap = {
...
export interface V1beta1BackupVaultConfig {
...
export interface V1beta1BackupVaultAttrs {
  ...
  backupRegion: string;
  /** Retention policy for backups in the backup vault */
  backupRetentionPolicy: V1beta1BackupVault_BackupRetentionPolicy;
  /** Optional. Type of backup vault to be created. Default is IN_REGION. */
...
export const V1beta1BackupVault: ResourceBinding<V1beta1BackupVaultConfig, V1beta1BackupVaultAttrs> = {
