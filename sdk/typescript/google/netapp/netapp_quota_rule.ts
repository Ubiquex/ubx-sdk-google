...
export interface NetappQuotaRuleConfig {
...
export interface NetappQuotaRuleAttrs {
  /** Output only. Create time of the quota rule */
  createTime: string;
  /** Optional. Description of the quota rule */
  description: string;
...
export const NetappQuotaRule: ResourceBinding<NetappQuotaRuleConfig, NetappQuotaRuleAttrs> = {
  wireType: "google_netapp_netapp_quota_rule",
  fields: {
