...
export interface V1beta1Volume_BackupConfig {
...
export interface V1beta1Volume_BlockDevices {
...
export interface V1beta1Volume_CacheParameters_CacheConfig_CachePrePopulate {
...
export interface V1beta1Volume_CacheParameters_CacheConfig {
  /** Pre-populate cache volume with data from the origin volume. */
  cachePrePopulate?: V1beta1Volume_CacheParameters_CacheConfig_CachePrePopulate | Computed<V1beta1Volume_CacheParameters_CacheConfig_CachePrePopulate>;
...
export interface V1beta1Volume_CacheParameters {
  /** Configuration of the cache volume. */
  cacheConfig?: V1beta1Volume_CacheParameters_CacheConfig | Computed<V1beta1Volume_CacheParameters_CacheConfig>;
...
export interface V1beta1Volume_CloneDetails {
...
export interface V1beta1Volume_ExportPolicy_Rules {
...
export interface V1beta1Volume_ExportPolicy {
  /** Required. List of export policy rules */
  rules?: V1beta1Volume_ExportPolicy_Rules[] | Computed<V1beta1Volume_ExportPolicy_Rules[]>;
}

export interface V1beta1Volume_HybridReplicationParameters {
...
export interface V1beta1Volume_LargeCapacityConfig {
...
export interface V1beta1Volume_MountOptions {
...
export interface V1beta1Volume_RestoreParameters {
...
export interface V1beta1Volume_SnapshotPolicy_DailySchedule {
...
export interface V1beta1Volume_SnapshotPolicy_HourlySchedule {
  /** Set the minute of the hour to start the snapshot (0-59), defaults to the top of the hour (0). */
  minute?: number | Computed<number>;
  /** The maximum number of Snapshots to keep for the hourly schedule */
  snapshotsToKeep?: number | Computed<number>;
...
export interface V1beta1Volume_SnapshotPolicy_MonthlySchedule {
...
export interface V1beta1Volume_SnapshotPolicy_WeeklySchedule {
...
export interface V1beta1Volume_SnapshotPolicy {
  /** Make a snapshot every day e.g. at 04:00, 05:20, 23:50 */
  dailySchedule?: V1beta1Volume_SnapshotPolicy_DailySchedule | Computed<V1beta1Volume_SnapshotPolicy_DailySchedule>;
  /** If enabled, make snapshots automatically according to the schedules. Default is false. */
  enabled?: boolean | Computed<boolean>;
  /** Make a snapshot every hour e.g. at 04:00, 05:00, 06:00. */
  hourlySchedule?: V1beta1Volume_SnapshotPolicy_HourlySchedule | Computed<V1beta1Volume_SnapshotPolicy_HourlySchedule>;
  /** Make a snapshot once a month e.g. at 2nd 04:00, 7th 05:20, 24th 23:50 */
  monthlySchedule?: V1beta1Volume_SnapshotPolicy_MonthlySchedule | Computed<V1beta1Volume_SnapshotPolicy_MonthlySchedule>;
  /** Make a snapshot every week e.g. at Monday 04:00, Wednesday 05:20, Sunday 23:50 */
  weeklySchedule?: V1beta1Volume_SnapshotPolicy_WeeklySchedule | Computed<V1beta1Volume_SnapshotPolicy_WeeklySchedule>;
}

export interface V1beta1Volume_TieringPolicy {
...
const V1beta1Volume_BackupConfigFields: FieldMap = {
...
const V1beta1Volume_BlockDevicesFields: FieldMap = {
...
const V1beta1Volume_CacheParameters_CacheConfig_CachePrePopulateFields: FieldMap = {
  excludePathList: "exclude_path_list",
  pathList: "path_list",
  recursion: "recursion",
};

const V1beta1Volume_CacheParameters_CacheConfigFields: FieldMap = {
  cachePrePopulate: {
...
const V1beta1Volume_CacheParametersFields: FieldMap = {
  cacheConfig: {
...
const V1beta1Volume_CloneDetailsFields: FieldMap = {
...
const V1beta1Volume_ExportPolicy_RulesFields: FieldMap = {
...
const V1beta1Volume_ExportPolicyFields: FieldMap = {
  rules: {
    wireName: "rules",
    kind: "list",
...
const V1beta1Volume_HybridReplicationParametersFields: FieldMap = {
...
const V1beta1Volume_LargeCapacityConfigFields: FieldMap = {
...
const V1beta1Volume_SnapshotPolicy_DailyScheduleFields: FieldMap = {
  hour: "hour",
  minute: "minute",
  snapshotsToKeep: "snapshots_to_keep",
};

const V1beta1Volume_SnapshotPolicy_HourlyScheduleFields: FieldMap = {
  minute: "minute",
  snapshotsToKeep: "snapshots_to_keep",
};

const V1beta1Volume_SnapshotPolicy_MonthlyScheduleFields: FieldMap = {
...
const V1beta1Volume_SnapshotPolicy_WeeklyScheduleFields: FieldMap = {
  day: "day",
  hour: "hour",
  minute: "minute",
  snapshotsToKeep: "snapshots_to_keep",
...
const V1beta1Volume_SnapshotPolicyFields: FieldMap = {
  dailySchedule: {
...
const V1beta1Volume_TieringPolicyFields: FieldMap = {
...
export interface V1beta1VolumeConfig {
  ...
  blockDevices?: V1beta1Volume_BlockDevices[] | Computed<V1beta1Volume_BlockDevices[]>;
  /** Cache Parameters for the volume. */
  cacheParameters?: V1beta1Volume_CacheParameters | Computed<V1beta1Volume_CacheParameters>;
...
export interface V1beta1VolumeAttrs {
  ...
  /** BackupConfig contains backup related config on a volume. */
  backupConfig: V1beta1Volume_BackupConfig;
  /** Optional. Block devices for the volume. Currently, only one block device is permitted per Volume. */
  blockDevices: V1beta1Volume_BlockDevices[];
  /** Cache Parameters for the volume. */
  cacheParameters: V1beta1Volume_CacheParameters;
  /** Required. Capacity in GIB of the volume */
  capacityGib: string;
  /** Details about a clone volume. */
  cloneDetails: V1beta1Volume_CloneDetails;
  ...
  /** Defines the export policy for the volume. */
  exportPolicy: V1beta1Volume_ExportPolicy;
  ...
  /** The Hybrid Replication parameters for the volume. */
  hybridReplicationParameters: V1beta1Volume_HybridReplicationParameters;
  /** Optional. Flag indicating if the volume is a kerberos volume or not, export policy rules control kerberos security modes (krb5, krb5i, krb5p). */
  ...
  /** Configuration for a Large Capacity Volume. A Large Capacity Volume supports sizes ranging from 4.8 TiB to 20 PiB; it is composed of multiple internal constituents, and must be created in a large capacity pool. */
  largeCapacityConfig: V1beta1Volume_LargeCapacityConfig;
  /** Output only. Flag indicating if the volume is NFS LDAP enabled or not. */
  ldapEnabled: boolean;
  /** Output only. Mount options of this volume */
  mountOptions: V1beta1Volume_MountOptions[];
  /** Optional. Flag indicating if the volume will have an IP address per node for volumes supporting multiple IP endpoints. Only the volume with large_capacity will be allowed to have multiple endpoints. */
  ...
  replicaZone: string;
  /** The RestoreParameters if volume is created from a snapshot or backup. */
  restoreParameters: V1beta1Volume_RestoreParameters;
  /** Optional. List of actions that are restricted on this volume. */
  ...
  /** Snapshot Policy for a volume. */
  snapshotPolicy: V1beta1Volume_SnapshotPolicy;
  ...
  /** Defines tiering policy for the volume. */
  tieringPolicy: V1beta1Volume_TieringPolicy;
  /** Optional. Default unix style permission (e.g. 777) the mount point will be created with. Applicable for NFS protocol types only. */
