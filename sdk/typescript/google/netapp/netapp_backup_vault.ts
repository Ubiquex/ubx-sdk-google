// Code generated by `ubx sdk gen` from google_netapp_netapp_backup_vault. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetappBackupVault_BackupRetentionPolicy {
...
const NetappBackupVault_BackupRetentionPolicyFields: FieldMap = {
...
export interface NetappBackupVaultConfig {
  ...
  backupRetentionPolicy?: NetappBackupVault_BackupRetentionPolicy | Computed<NetappBackupVault_BackupRetentionPolicy>;
...
export interface NetappBackupVaultAttrs {
  ...
  backupRegion: string;
  /** Retention policy for backups in the backup vault */
  backupRetentionPolicy: NetappBackupVault_BackupRetentionPolicy;
  /** Optional. Type of backup vault to be created. Default is IN_REGION. */
...
export const NetappBackupVault: ResourceBinding<NetappBackupVaultConfig, NetappBackupVaultAttrs> = {
  wireType: "google_netapp_netapp_backup_vault",
  fields: {
    backupRegion: "backup_region",
    backupRetentionPolicy: {
      wireName: "backup_retention_policy",
      kind: "object",
      fields: NetappBackupVault_BackupRetentionPolicyFields,
    },
