...
export interface DataprocNodeGroup_NodeGroupConfig_Accelerators {
  acceleratorCount?: number | Computed<number>;
  acceleratorTypeUri?: string | Computed<string>;
}

export interface DataprocNodeGroup_NodeGroupConfig_DiskConfig_AttachedDiskConfigs {
...
export interface DataprocNodeGroup_NodeGroupConfig_DiskConfig {
  /** Optional. A list of attached disk configs for a group of VM instances. */
  attachedDiskConfigs?: DataprocNodeGroup_NodeGroupConfig_DiskConfig_AttachedDiskConfigs[] | Computed<DataprocNodeGroup_NodeGroupConfig_DiskConfig_AttachedDiskConfigs[]>;
...
export interface DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_InstanceSelectionList {
  diskConfig?: DataprocNodeGroup_NodeGroupConfig_DiskConfig | Computed<DataprocNodeGroup_NodeGroupConfig_DiskConfig>;
  machineTypes?: string[] | Computed<string[]>;
  rank?: number | Computed<number>;
}

export interface DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_InstanceSelectionResults {
  machineType?: string | Computed<string>;
  vmCount?: number | Computed<number>;
}

export interface DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_ProvisioningModelMix {
...
export interface DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy {
  ...
  instanceSelectionList?: DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_InstanceSelectionList[] | Computed<DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_InstanceSelectionList[]>;
  /** Output only. A list of instance selection results in the group. */
  instanceSelectionResults?: DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_InstanceSelectionResults[] | Computed<DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_InstanceSelectionResults[]>;
  /** Defines how to create VMs with a mixture of provisioning models. */
  provisioningModelMix?: DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_ProvisioningModelMix | Computed<DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_ProvisioningModelMix>;
}

export interface DataprocNodeGroup_NodeGroupConfig_InstanceReferences {
...
export interface DataprocNodeGroup_NodeGroupConfig_ManagedGroupConfig {
...
export interface DataprocNodeGroup_NodeGroupConfig_StartupConfig {
...
export interface DataprocNodeGroup_NodeGroupConfig {
  /** Optional. The Compute Engine accelerator configuration for these instances. */
  accelerators?: DataprocNodeGroup_NodeGroupConfig_Accelerators[] | Computed<DataprocNodeGroup_NodeGroupConfig_Accelerators[]>;
  ...
  instanceFlexibilityPolicy?: DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy | Computed<DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy>;
  ...
  instanceReferences?: DataprocNodeGroup_NodeGroupConfig_InstanceReferences[] | Computed<DataprocNodeGroup_NodeGroupConfig_InstanceReferences[]>;
  ...
  managedGroupConfig?: DataprocNodeGroup_NodeGroupConfig_ManagedGroupConfig | Computed<DataprocNodeGroup_NodeGroupConfig_ManagedGroupConfig>;
  ...
  startupConfig?: DataprocNodeGroup_NodeGroupConfig_StartupConfig | Computed<DataprocNodeGroup_NodeGroupConfig_StartupConfig>;
}

const DataprocNodeGroup_NodeGroupConfig_AcceleratorsFields: FieldMap = {
  acceleratorCount: "accelerator_count",
  acceleratorTypeUri: "accelerator_type_uri",
};

const DataprocNodeGroup_NodeGroupConfig_DiskConfig_AttachedDiskConfigsFields: FieldMap = {
...
const DataprocNodeGroup_NodeGroupConfig_DiskConfigFields: FieldMap = {
  attachedDiskConfigs: {
    wireName: "attached_disk_configs",
    kind: "list",
    fields: DataprocNodeGroup_NodeGroupConfig_DiskConfig_AttachedDiskConfigsFields,
  },
...
const DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_InstanceSelectionListFields: FieldMap = {
  diskConfig: {
    wireName: "disk_config",
    kind: "object",
    fields: DataprocNodeGroup_NodeGroupConfig_DiskConfigFields,
  },
  machineTypes: "machine_types",
  rank: "rank",
};

const DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_InstanceSelectionResultsFields: FieldMap = {
  machineType: "machine_type",
  vmCount: "vm_count",
};

const DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_ProvisioningModelMixFields: FieldMap = {
  standardCapacityBase: "standard_capacity_base",
  standardCapacityPercentAboveBase: "standard_capacity_percent_above_base",
};

const DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicyFields: FieldMap = {
  instanceMachineTypes: "instance_machine_types",
  instanceSelectionList: {
    wireName: "instance_selection_list",
    kind: "list",
    fields: DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_InstanceSelectionListFields,
  },
  instanceSelectionResults: {
    wireName: "instance_selection_results",
    kind: "list",
    fields: DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_InstanceSelectionResultsFields,
  },
  provisioningModelMix: {
    wireName: "provisioning_model_mix",
    kind: "object",
    fields: DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_ProvisioningModelMixFields,
  },
};

const DataprocNodeGroup_NodeGroupConfig_InstanceReferencesFields: FieldMap = {
...
const DataprocNodeGroup_NodeGroupConfig_ManagedGroupConfigFields: FieldMap = {
...
const DataprocNodeGroup_NodeGroupConfig_StartupConfigFields: FieldMap = {
  requiredRegistrationFraction: "required_registration_fraction",
};

const DataprocNodeGroup_NodeGroupConfigFields: FieldMap = {
  accelerators: {
    wireName: "accelerators",
    kind: "list",
    fields: DataprocNodeGroup_NodeGroupConfig_AcceleratorsFields,
  },
  diskConfig: {
    wireName: "disk_config",
    kind: "object",
  ...
  instanceFlexibilityPolicy: {
    ...
    kind: "object",
    fields: DataprocNodeGroup_NodeGroupConfig_InstanceFlexibilityPolicyFields,
  },
  instanceNames: "instance_names",
  instanceReferences: {
    wireName: "instance_references",
    kind: "list",
    fields: DataprocNodeGroup_NodeGroupConfig_InstanceReferencesFields,
  },
  ...
  managedGroupConfig: {
    ...
    kind: "object",
    fields: DataprocNodeGroup_NodeGroupConfig_ManagedGroupConfigFields,
  },
  ...
  startupConfig: {
    ...
    kind: "object",
    fields: DataprocNodeGroup_NodeGroupConfig_StartupConfigFields,
  },
};

export interface DataprocNodeGroupConfig {
  ...
  nodeGroupConfig?: DataprocNodeGroup_NodeGroupConfig | Computed<DataprocNodeGroup_NodeGroupConfig>;
  /** Required. Node group roles. */
  roles?: string[] | Computed<string[]>;
}

export interface DataprocNodeGroupAttrs {
  /** Optional. Node group labels. Label keys must consist of from 1 to 63 characters and conform to RFC 1035 (https://www.ietf.org/rfc/rfc1035.txt). Label values can be empty. If specified, they must consist of from 1 to 63 characters and conform to RFC 1035 (https://www.ietf.org/rfc/rfc1035.txt). The node group must have no more than 32 labels. */
  labels: Record<string, string>;
  /** The Node group resource name (https://aip.dev/122). */
  name: string;
  /** The config settings for Compute Engine resources in an instance group, such as a master or worker group. */
  nodeGroupConfig: DataprocNodeGroup_NodeGroupConfig;
  /** Required. Node group roles. */
  roles: string[];
}

export const DataprocNodeGroup: ResourceBinding<DataprocNodeGroupConfig, DataprocNodeGroupAttrs> = {
  wireType: "google_dataproc_dataproc_node_group",
  fields: {
    labels: "labels",
    name: "name",
    nodeGroupConfig: {
      ...
      kind: "object",
      fields: DataprocNodeGroup_NodeGroupConfigFields,
    },
    roles: "roles",
  },
};
