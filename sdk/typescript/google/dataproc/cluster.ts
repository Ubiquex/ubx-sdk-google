...
export interface Cluster_Config_AutoscalingConfig {
...
export interface Cluster_Config_DataprocMetricConfig {
  /** Required. Metrics sources to enable. */
  metrics?: Cluster_Config_DataprocMetricConfig_Metrics[] | Computed<Cluster_Config_DataprocMetricConfig_Metrics[]>;
}

export interface Cluster_Config_EncryptionConfig {
...
export interface Cluster_Config_EndpointConfig {
...
export interface Cluster_Config_GceClusterConfig_ConfidentialInstanceConfig {
...
export interface Cluster_Config_GceClusterConfig_NodeGroupAffinity {
  /** Required. The URI of a sole-tenant node group resource (https://cloud.google.com/compute/docs/reference/rest/v1/nodeGroups) that the cluster will be created on.A full URL, partial URI, or node group name are valid. Examples: https://www.googleapis.com/compute/v1/projects/[project_id]/zones/[zone]/nodeGroups/node-group-1 projects/[project_id]/zones/[zone]/nodeGroups/node-group-1 node-group-1 */
  nodeGroupUri?: string | Computed<string>;
}

export interface Cluster_Config_GceClusterConfig_ReservationAffinity {
...
export interface Cluster_Config_GceClusterConfig_ShieldedInstanceConfig {
...
export interface Cluster_Config_GceClusterConfig {
  ...
  confidentialInstanceConfig?: Cluster_Config_GceClusterConfig_ConfidentialInstanceConfig | Computed<Cluster_Config_GceClusterConfig_ConfidentialInstanceConfig>;
  ...
  nodeGroupAffinity?: Cluster_Config_GceClusterConfig_NodeGroupAffinity | Computed<Cluster_Config_GceClusterConfig_NodeGroupAffinity>;
  /** Optional. The type of IPv6 access for a cluster. */
  privateIpv6GoogleAccess?: string | Computed<string>;
  /** Reservation Affinity for consuming Zonal reservation. */
  reservationAffinity?: Cluster_Config_GceClusterConfig_ReservationAffinity | Computed<Cluster_Config_GceClusterConfig_ReservationAffinity>;
  ...
  shieldedInstanceConfig?: Cluster_Config_GceClusterConfig_ShieldedInstanceConfig | Computed<Cluster_Config_GceClusterConfig_ShieldedInstanceConfig>;
...
export interface Cluster_Config_GkeClusterConfig_NamespacedGkeDeploymentTarget {
...
export interface Cluster_Config_GkeClusterConfig {
  /** Optional. A target GKE cluster to deploy to. It must be in the same project and region as the Dataproc cluster (the GKE cluster can be zonal or regional). Format: 'projects/{project}/locations/{location}/clusters/{cluster_id}' */
  gkeClusterTarget?: string | Computed<string>;
  /** Deprecated. Used only for the deprecated beta. A full, namespace-isolated deployment target for an existing GKE cluster. */
  namespacedGkeDeploymentTarget?: Cluster_Config_GkeClusterConfig_NamespacedGkeDeploymentTarget | Computed<Cluster_Config_GkeClusterConfig_NamespacedGkeDeploymentTarget>;
  /** Optional. GKE node pools where workloads will be scheduled. At least one node pool must be assigned the DEFAULT GkeNodePoolTarget.Role. If a GkeNodePoolTarget is not specified, Dataproc constructs a DEFAULT GkeNodePoolTarget. Each role can be given to only one GkeNodePoolTarget. All node pools must have the same location settings. */
  nodePoolTarget?: Cluster_Config_GkeClusterConfig_NodePoolTarget[] | Computed<Cluster_Config_GkeClusterConfig_NodePoolTarget[]>;
}
...
export interface Cluster_Config_LifecycleConfig {
...
export interface Cluster_Config_MetastoreConfig {
...
export interface Cluster_Config_SecurityConfig_IdentityConfig {
...
export interface Cluster_Config_SecurityConfig_KerberosConfig {
...
export interface Cluster_Config_SecurityConfig {
  /** Identity related configuration, including service account based secure multi-tenancy user mappings. */
  identityConfig?: Cluster_Config_SecurityConfig_IdentityConfig | Computed<Cluster_Config_SecurityConfig_IdentityConfig>;
  /** Specifies Kerberos related configuration. */
  kerberosConfig?: Cluster_Config_SecurityConfig_KerberosConfig | Computed<Cluster_Config_SecurityConfig_KerberosConfig>;
}

export interface Cluster_Config_SoftwareConfig {
...
export interface Cluster_Config {
  ...
  autoscalingConfig?: Cluster_Config_AutoscalingConfig | Computed<Cluster_Config_AutoscalingConfig>;
  /** Optional. The node group settings. */
  auxiliaryNodeGroups?: Cluster_Config_AuxiliaryNodeGroups[] | Computed<Cluster_Config_AuxiliaryNodeGroups[]>;
  ...
  /** Metric config. */
  dataprocMetricConfig?: Cluster_Config_DataprocMetricConfig | Computed<Cluster_Config_DataprocMetricConfig>;
  ...
  encryptionConfig?: Cluster_Config_EncryptionConfig | Computed<Cluster_Config_EncryptionConfig>;
  /** Endpoint config for this cluster */
  endpointConfig?: Cluster_Config_EndpointConfig | Computed<Cluster_Config_EndpointConfig>;
  /** Optional. The cluster engine. */
  engine?: string | Computed<string>;
  /** Common config settings for resources of Compute Engine cluster instances, applicable to all instances in the cluster. */
  gceClusterConfig?: Cluster_Config_GceClusterConfig | Computed<Cluster_Config_GceClusterConfig>;
  /** The cluster's GKE config. */
  gkeClusterConfig?: Cluster_Config_GkeClusterConfig | Computed<Cluster_Config_GkeClusterConfig>;
  /** Optional. Commands to execute on each node after config is completed. By default, executables are run on master and all worker nodes. You can test a node's role metadata to run an executable on a master or worker node, as shown below using curl (you can also use wget): ROLE=$(curl -H Metadata-Flavor:Google http://metadata/computeMetadata/v1/instance/attributes/dataproc-role) if [[ "${ROLE}" == 'Master' ]]; then ... master specific actions ... else ... worker specific actions ... fi */
  initializationActions?: Cluster_Config_InitializationActions[] | Computed<Cluster_Config_InitializationActions[]>;
  /** Specifies the cluster auto-delete schedule configuration. */
  lifecycleConfig?: Cluster_Config_LifecycleConfig | Computed<Cluster_Config_LifecycleConfig>;
  /** The config settings for Compute Engine resources in an instance group, such as a master or worker group. */
  masterConfig?: Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig | Computed<Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig>;
  /** Specifies a Metastore configuration. */
  metastoreConfig?: Cluster_Config_MetastoreConfig | Computed<Cluster_Config_MetastoreConfig>;
  /** The config settings for Compute Engine resources in an instance group, such as a master or worker group. */
  secondaryWorkerConfig?: Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig | Computed<Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig>;
  /** Security related configuration, including encryption, Kerberos, etc. */
  securityConfig?: Cluster_Config_SecurityConfig | Computed<Cluster_Config_SecurityConfig>;
  /** Specifies the selection and config of software inside the cluster. */
  softwareConfig?: Cluster_Config_SoftwareConfig | Computed<Cluster_Config_SoftwareConfig>;
  ...
  /** The config settings for Compute Engine resources in an instance group, such as a master or worker group. */
  workerConfig?: Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig | Computed<Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig>;
}

export interface Cluster_Metrics {
  /** The HDFS metrics. */
...
export interface Cluster_Status {
...
export interface Cluster_VirtualClusterConfig_AuxiliaryServicesConfig {
  ...
  sparkHistoryServerConfig?: Cluster_VirtualClusterConfig_AuxiliaryServicesConfig_SparkHistoryServerConfig | Computed<Cluster_VirtualClusterConfig_AuxiliaryServicesConfig_SparkHistoryServerConfig>;
}
...
export interface Cluster_VirtualClusterConfig_KubernetesClusterConfig {
  ...
  kubernetesSoftwareConfig?: Cluster_VirtualClusterConfig_KubernetesClusterConfig_KubernetesSoftwareConfig | Computed<Cluster_VirtualClusterConfig_KubernetesClusterConfig_KubernetesSoftwareConfig>;
}

export interface Cluster_VirtualClusterConfig {
  /** Auxiliary services configuration for a Cluster. */
  auxiliaryServicesConfig?: Cluster_VirtualClusterConfig_AuxiliaryServicesConfig | Computed<Cluster_VirtualClusterConfig_AuxiliaryServicesConfig>;
  /** The configuration for running the Dataproc cluster on Kubernetes. */
  kubernetesClusterConfig?: Cluster_VirtualClusterConfig_KubernetesClusterConfig | Computed<Cluster_VirtualClusterConfig_KubernetesClusterConfig>;
  /** Optional. A Cloud Storage bucket used to stage job dependencies, config files, and job driver console output. If you do not specify a staging bucket, the service will determine a Cloud Storage location (US, ASIA, or EU) for your cluster's staging bucket according to the Compute Engine zone where your cluster is deployed, and then create and manage this project-level, per-location bucket (see staging and temp buckets (https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/staging-bucket)). This field requires a Cloud Storage bucket name, not a gs://... URI to a Cloud Storage bucket. */
  stagingBucket?: string | Computed<string>;
}

const Cluster_Config_AutoscalingConfigFields: FieldMap = {
  policyUri: "policy_uri",
};

const Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig_AcceleratorsFields: FieldMap = {
  acceleratorCount: "accelerator_count",
  acceleratorTypeUri: "accelerator_type_uri",
};

const Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig_DiskConfig_AttachedDiskConfigsFields: FieldMap = {
...
const Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig_DiskConfigFields: FieldMap = {
  attachedDiskConfigs: {
...
const Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_InstanceSelectionListFields: FieldMap = {
  diskConfig: {
...
const Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_InstanceSelectionResultsFields: FieldMap = {
  machineType: "machine_type",
  vmCount: "vm_count",
};

const Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig_InstanceFlexibilityPolicy_ProvisioningModelMixFields: FieldMap = {
  standardCapacityBase: "standard_capacity_base",
  standardCapacityPercentAboveBase: "standard_capacity_percent_above_base",
};

const Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig_InstanceFlexibilityPolicyFields: FieldMap = {
...
const Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig_InstanceReferencesFields: FieldMap = {
...
const Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig_ManagedGroupConfigFields: FieldMap = {
...
const Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfig_StartupConfigFields: FieldMap = {
  requiredRegistrationFraction: "required_registration_fraction",
};

const Cluster_Config_AuxiliaryNodeGroups_NodeGroup_NodeGroupConfigFields: FieldMap = {
  accelerators: {
...
const Cluster_Config_AuxiliaryNodeGroups_NodeGroupFields: FieldMap = {
  labels: "labels",
  name: "name",
  nodeGroupConfig: {
...
const Cluster_Config_AuxiliaryNodeGroupsFields: FieldMap = {
  nodeGroup: {
    wireName: "node_group",
    kind: "object",
...
const Cluster_Config_DataprocMetricConfig_MetricsFields: FieldMap = {
  metricOverrides: "metric_overrides",
  metricSource: "metric_source",
};

const Cluster_Config_DataprocMetricConfigFields: FieldMap = {
  metrics: {
    wireName: "metrics",
    kind: "list",
...
const Cluster_Config_EncryptionConfigFields: FieldMap = {
  gcePdKmsKeyName: "gce_pd_kms_key_name",
  kmsKey: "kms_key",
};

const Cluster_Config_EndpointConfigFields: FieldMap = {
  enableHttpPortAccess: "enable_http_port_access",
  httpPorts: "http_ports",
};

const Cluster_Config_GceClusterConfig_ConfidentialInstanceConfigFields: FieldMap = {
  confidentialInstanceType: "confidential_instance_type",
  enableConfidentialCompute: "enable_confidential_compute",
};

const Cluster_Config_GceClusterConfig_NodeGroupAffinityFields: FieldMap = {
  nodeGroupUri: "node_group_uri",
};

const Cluster_Config_GceClusterConfig_ReservationAffinityFields: FieldMap = {
  consumeReservationType: "consume_reservation_type",
  key: "key",
  values: "values",
};

const Cluster_Config_GceClusterConfig_ShieldedInstanceConfigFields: FieldMap = {
  enableIntegrityMonitoring: "enable_integrity_monitoring",
  enableSecureBoot: "enable_secure_boot",
  enableVtpm: "enable_vtpm",
};

const Cluster_Config_GceClusterConfigFields: FieldMap = {
...
const Cluster_Config_GkeClusterConfig_NamespacedGkeDeploymentTargetFields: FieldMap = {
  clusterNamespace: "cluster_namespace",
  targetGkeCluster: "target_gke_cluster",
};

const Cluster_Config_GkeClusterConfig_NodePoolTarget_NodePoolConfig_AutoscalingFields: FieldMap = {
  maxNodeCount: "max_node_count",
  minNodeCount: "min_node_count",
};

const Cluster_Config_GkeClusterConfig_NodePoolTarget_NodePoolConfig_Config_AcceleratorsFields: FieldMap = {
  acceleratorCount: "accelerator_count",
  acceleratorType: "accelerator_type",
  gpuPartitionSize: "gpu_partition_size",
};

const Cluster_Config_GkeClusterConfig_NodePoolTarget_NodePoolConfig_ConfigFields: FieldMap = {
  accelerators: {
    wireName: "accelerators",
    kind: "list",
...
const Cluster_Config_GkeClusterConfig_NodePoolTarget_NodePoolConfigFields: FieldMap = {
  autoscaling: {
...
const Cluster_Config_GkeClusterConfig_NodePoolTargetFields: FieldMap = {
  nodePool: "node_pool",
  nodePoolConfig: {
...
const Cluster_Config_GkeClusterConfigFields: FieldMap = {
...
const Cluster_Config_InitializationActionsFields: FieldMap = {
  executableFile: "executable_file",
  executionTimeout: "execution_timeout",
};

const Cluster_Config_LifecycleConfigFields: FieldMap = {
...
const Cluster_Config_MetastoreConfigFields: FieldMap = {
  dataprocMetastoreService: "dataproc_metastore_service",
};

const Cluster_Config_SecurityConfig_IdentityConfigFields: FieldMap = {
  enableSsh: "enable_ssh",
  userServiceAccountMapping: "user_service_account_mapping",
};

const Cluster_Config_SecurityConfig_KerberosConfigFields: FieldMap = {
...
const Cluster_Config_SecurityConfigFields: FieldMap = {
  identityConfig: {
...
const Cluster_Config_SoftwareConfigFields: FieldMap = {
  imageVersion: "image_version",
  optionalComponents: "optional_components",
  properties: "properties",
};

const Cluster_ConfigFields: FieldMap = {
  autoscalingConfig: {
...
const Cluster_MetricsFields: FieldMap = {
  hdfsMetrics: "hdfs_metrics",
  yarnMetrics: "yarn_metrics",
};

const Cluster_StatusFields: FieldMap = {
  detail: "detail",
  state: "state",
...
export interface ClusterConfig {
  ...
  metrics?: Cluster_Metrics | Computed<Cluster_Metrics>;
