...
export interface V1beta1Environment_Config_DataRetentionConfig_AirflowMetadataRetentionConfig {
...
export interface V1beta1Environment_Config_DataRetentionConfig_TaskLogsRetentionConfig {
  /** Optional. The mode of storage for Airflow workers task logs. */
  storageMode?: string | Computed<string>;
}

export interface V1beta1Environment_Config_DataRetentionConfig {
  ...
  airflowMetadataRetentionConfig?: V1beta1Environment_Config_DataRetentionConfig_AirflowMetadataRetentionConfig | Computed<V1beta1Environment_Config_DataRetentionConfig_AirflowMetadataRetentionConfig>;
  /** The configuration setting for Task Logs. */
  taskLogsRetentionConfig?: V1beta1Environment_Config_DataRetentionConfig_TaskLogsRetentionConfig | Computed<V1beta1Environment_Config_DataRetentionConfig_TaskLogsRetentionConfig>;
}

export interface V1beta1Environment_Config_DatabaseConfig {
...
export interface V1beta1Environment_Config_EncryptionConfig {
  /** Optional. Customer-managed Encryption Key available through Google's Key Management Service. Cannot be updated. If not specified, Google-managed key will be used. */
  kmsKeyName?: string | Computed<string>;
}

export interface V1beta1Environment_Config_MaintenanceWindow {
...
export interface V1beta1Environment_Config_MasterAuthorizedNetworksConfig_CidrBlocks {
  cidrBlock?: string | Computed<string>;
  displayName?: string | Computed<string>;
}

export interface V1beta1Environment_Config_MasterAuthorizedNetworksConfig {
  /** Up to 50 external networks that could access Kubernetes master through HTTPS. */
  cidrBlocks?: V1beta1Environment_Config_MasterAuthorizedNetworksConfig_CidrBlocks[] | Computed<V1beta1Environment_Config_MasterAuthorizedNetworksConfig_CidrBlocks[]>;
  /** Optional. Whether or not master authorized networks feature is enabled. */
  enabled?: boolean | Computed<boolean>;
}

export interface V1beta1Environment_Config_NodeConfig_IpAllocationPolicy {
...
export interface V1beta1Environment_Config_NodeConfig_TrafficRoutingConfig {
  /** Optional. Controls how network traffic to Cloud Run functions is routed. */
  cloudRunFunctionsRouting?: string | Computed<string>;
}

export interface V1beta1Environment_Config_NodeConfig {
  ...
  ipAllocationPolicy?: V1beta1Environment_Config_NodeConfig_IpAllocationPolicy | Computed<V1beta1Environment_Config_NodeConfig_IpAllocationPolicy>;
  ...
  trafficRoutingConfig?: V1beta1Environment_Config_NodeConfig_TrafficRoutingConfig | Computed<V1beta1Environment_Config_NodeConfig_TrafficRoutingConfig>;
}

export interface V1beta1Environment_Config_PrivateEnvironmentConfig_NetworkingConfig {
...
export interface V1beta1Environment_Config_PrivateEnvironmentConfig_PrivateClusterConfig {
...
export interface V1beta1Environment_Config_PrivateEnvironmentConfig {
  ...
  networkingConfig?: V1beta1Environment_Config_PrivateEnvironmentConfig_NetworkingConfig | Computed<V1beta1Environment_Config_PrivateEnvironmentConfig_NetworkingConfig>;
  ...
  privateClusterConfig?: V1beta1Environment_Config_PrivateEnvironmentConfig_PrivateClusterConfig | Computed<V1beta1Environment_Config_PrivateEnvironmentConfig_PrivateClusterConfig>;
...
export interface V1beta1Environment_Config_RecoveryConfig_ScheduledSnapshotsConfig {
...
export interface V1beta1Environment_Config_RecoveryConfig {
  /** The configuration for scheduled snapshot creation mechanism. */
  scheduledSnapshotsConfig?: V1beta1Environment_Config_RecoveryConfig_ScheduledSnapshotsConfig | Computed<V1beta1Environment_Config_RecoveryConfig_ScheduledSnapshotsConfig>;
}

export interface V1beta1Environment_Config_SoftwareConfig_CloudDataLineageIntegration {
  /** Optional. Whether or not Cloud Data Lineage integration is enabled. */
  enabled?: boolean | Computed<boolean>;
}

export interface V1beta1Environment_Config_SoftwareConfig {
  ...
  cloudDataLineageIntegration?: V1beta1Environment_Config_SoftwareConfig_CloudDataLineageIntegration | Computed<V1beta1Environment_Config_SoftwareConfig_CloudDataLineageIntegration>;
...
export interface V1beta1Environment_Config_WebServerConfig {
  /** Optional. Machine type on which Airflow web server is running. It has to be one of: composer-n1-webserver-2, composer-n1-webserver-4 or composer-n1-webserver-8. If not specified, composer-n1-webserver-2 will be used. Value custom is returned only in response, if Airflow web server parameters were manually changed to a non-standard values. */
  machineType?: string | Computed<string>;
}

export interface V1beta1Environment_Config_WebServerNetworkAccessControl_AllowedIpRanges {
  description?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface V1beta1Environment_Config_WebServerNetworkAccessControl {
  /** A collection of allowed IP ranges with descriptions. */
  allowedIpRanges?: V1beta1Environment_Config_WebServerNetworkAccessControl_AllowedIpRanges[] | Computed<V1beta1Environment_Config_WebServerNetworkAccessControl_AllowedIpRanges[]>;
}

export interface V1beta1Environment_Config_WorkloadsConfig_DagProcessor {
...
export interface V1beta1Environment_Config_WorkloadsConfig_Triggerer {
...
export interface V1beta1Environment_Config_WorkloadsConfig_WebServer {
...
export interface V1beta1Environment_Config_WorkloadsConfig_Worker {
...
export interface V1beta1Environment_Config_WorkloadsConfig {
  ...
  dagProcessor?: V1beta1Environment_Config_WorkloadsConfig_DagProcessor | Computed<V1beta1Environment_Config_WorkloadsConfig_DagProcessor>;
  /** Configuration for resources used by Airflow schedulers. */
  scheduler?: V1beta1Environment_Config_WorkloadsConfig_DagProcessor | Computed<V1beta1Environment_Config_WorkloadsConfig_DagProcessor>;
  /** Configuration for resources used by Airflow triggerers. */
  triggerer?: V1beta1Environment_Config_WorkloadsConfig_Triggerer | Computed<V1beta1Environment_Config_WorkloadsConfig_Triggerer>;
  /** Configuration for resources used by Airflow web server. */
  webServer?: V1beta1Environment_Config_WorkloadsConfig_WebServer | Computed<V1beta1Environment_Config_WorkloadsConfig_WebServer>;
  /** Configuration for resources used by Airflow workers. */
  worker?: V1beta1Environment_Config_WorkloadsConfig_Worker | Computed<V1beta1Environment_Config_WorkloadsConfig_Worker>;
}

export interface V1beta1Environment_Config {
  ...
  dataRetentionConfig?: V1beta1Environment_Config_DataRetentionConfig | Computed<V1beta1Environment_Config_DataRetentionConfig>;
  /** The configuration of Cloud SQL instance that is used by the Apache Airflow software. */
  databaseConfig?: V1beta1Environment_Config_DatabaseConfig | Computed<V1beta1Environment_Config_DatabaseConfig>;
  /** The encryption options for the Cloud Composer environment and its dependencies. Supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*. */
  encryptionConfig?: V1beta1Environment_Config_EncryptionConfig | Computed<V1beta1Environment_Config_EncryptionConfig>;
  ...
  maintenanceWindow?: V1beta1Environment_Config_MaintenanceWindow | Computed<V1beta1Environment_Config_MaintenanceWindow>;
  /** Configuration options for the master authorized networks feature. Enabled master authorized networks will disallow all external traffic to access Kubernetes master through HTTPS except traffic from the given CIDR blocks, Google Compute Engine Public IPs and Google Prod IPs. */
  masterAuthorizedNetworksConfig?: V1beta1Environment_Config_MasterAuthorizedNetworksConfig | Computed<V1beta1Environment_Config_MasterAuthorizedNetworksConfig>;
  /** The configuration information for the Kubernetes Engine nodes running the Apache Airflow software. */
  nodeConfig?: V1beta1Environment_Config_NodeConfig | Computed<V1beta1Environment_Config_NodeConfig>;
  /** The number of nodes in the Kubernetes Engine cluster that will be used to run this environment. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*. */
  nodeCount?: number | Computed<number>;
  /** The configuration information for configuring a Private IP Cloud Composer environment. */
  privateEnvironmentConfig?: V1beta1Environment_Config_PrivateEnvironmentConfig | Computed<V1beta1Environment_Config_PrivateEnvironmentConfig>;
  /** The Recovery settings of an environment. */
  recoveryConfig?: V1beta1Environment_Config_RecoveryConfig | Computed<V1beta1Environment_Config_RecoveryConfig>;
  /** Optional. Resilience mode of the Cloud Composer Environment. This field is supported for Cloud Composer environments in versions composer-2.2.0-airflow-*.*.* and newer. */
  resilienceMode?: string | Computed<string>;
  /** Specifies the selection and configuration of software inside the environment. */
  softwareConfig?: V1beta1Environment_Config_SoftwareConfig | Computed<V1beta1Environment_Config_SoftwareConfig>;
  /** The configuration settings for the Airflow web server App Engine instance. Supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*. */
  webServerConfig?: V1beta1Environment_Config_WebServerConfig | Computed<V1beta1Environment_Config_WebServerConfig>;
  /** Network-level access control policy for the Airflow web server. */
  webServerNetworkAccessControl?: V1beta1Environment_Config_WebServerNetworkAccessControl | Computed<V1beta1Environment_Config_WebServerNetworkAccessControl>;
  /** The Kubernetes workloads configuration for GKE cluster associated with the Cloud Composer environment. Supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer. */
  workloadsConfig?: V1beta1Environment_Config_WorkloadsConfig | Computed<V1beta1Environment_Config_WorkloadsConfig>;
}

export interface V1beta1Environment_StorageConfig {
  /** Optional. The name of the Cloud Storage bucket used by the environment. No `gs://` prefix. */
  bucket?: string | Computed<string>;
}

const V1beta1Environment_Config_DataRetentionConfig_AirflowMetadataRetentionConfigFields: FieldMap = {
  retentionDays: "retention_days",
  retentionMode: "retention_mode",
};

const V1beta1Environment_Config_DataRetentionConfig_TaskLogsRetentionConfigFields: FieldMap = {
  storageMode: "storage_mode",
};

const V1beta1Environment_Config_DataRetentionConfigFields: FieldMap = {
...
const V1beta1Environment_Config_DatabaseConfigFields: FieldMap = {
  machineType: "machine_type",
  zone: "zone",
};

const V1beta1Environment_Config_EncryptionConfigFields: FieldMap = {
  kmsKeyName: "kms_key_name",
};

const V1beta1Environment_Config_MaintenanceWindowFields: FieldMap = {
  endTime: "end_time",
  recurrence: "recurrence",
  startTime: "start_time",
};

const V1beta1Environment_Config_MasterAuthorizedNetworksConfig_CidrBlocksFields: FieldMap = {
  cidrBlock: "cidr_block",
  displayName: "display_name",
};

const V1beta1Environment_Config_MasterAuthorizedNetworksConfigFields: FieldMap = {
  cidrBlocks: {
...
const V1beta1Environment_Config_NodeConfig_IpAllocationPolicyFields: FieldMap = {
...
const V1beta1Environment_Config_NodeConfig_TrafficRoutingConfigFields: FieldMap = {
  cloudRunFunctionsRouting: "cloud_run_functions_routing",
};

const V1beta1Environment_Config_NodeConfigFields: FieldMap = {
...
const V1beta1Environment_Config_PrivateEnvironmentConfig_NetworkingConfigFields: FieldMap = {
  connectionType: "connection_type",
};

const V1beta1Environment_Config_PrivateEnvironmentConfig_PrivateClusterConfigFields: FieldMap = {
  enablePrivateEndpoint: "enable_private_endpoint",
  masterIpv4CidrBlock: "master_ipv4_cidr_block",
  masterIpv4ReservedRange: "master_ipv4_reserved_range",
};

const V1beta1Environment_Config_PrivateEnvironmentConfigFields: FieldMap = {
...
const V1beta1Environment_Config_RecoveryConfig_ScheduledSnapshotsConfigFields: FieldMap = {
  enabled: "enabled",
...
const V1beta1Environment_Config_RecoveryConfigFields: FieldMap = {
...
const V1beta1Environment_Config_SoftwareConfig_CloudDataLineageIntegrationFields: FieldMap = {
  enabled: "enabled",
};

const V1beta1Environment_Config_SoftwareConfigFields: FieldMap = {
...
const V1beta1Environment_Config_WebServerConfigFields: FieldMap = {
  machineType: "machine_type",
};

const V1beta1Environment_Config_WebServerNetworkAccessControl_AllowedIpRangesFields: FieldMap = {
  description: "description",
  value: "value",
};

const V1beta1Environment_Config_WebServerNetworkAccessControlFields: FieldMap = {
  allowedIpRanges: {
...
const V1beta1Environment_Config_WorkloadsConfig_DagProcessorFields: FieldMap = {
  count: "count",
  cpu: "cpu",
  memoryGb: "memory_gb",
...
const V1beta1Environment_Config_WorkloadsConfig_TriggererFields: FieldMap = {
  count: "count",
  cpu: "cpu",
  memoryGb: "memory_gb",
};

const V1beta1Environment_Config_WorkloadsConfig_WebServerFields: FieldMap = {
  cpu: "cpu",
  memoryGb: "memory_gb",
  storageGb: "storage_gb",
};

const V1beta1Environment_Config_WorkloadsConfig_WorkerFields: FieldMap = {
  cpu: "cpu",
  maxCount: "max_count",
  memoryGb: "memory_gb",
  minCount: "min_count",
...
const V1beta1Environment_Config_WorkloadsConfigFields: FieldMap = {
  dagProcessor: {
...
const V1beta1Environment_ConfigFields: FieldMap = {
...
const V1beta1Environment_StorageConfigFields: FieldMap = {
  bucket: "bucket",
};
...
export interface V1beta1EnvironmentAttrs {
  /** Configuration information for an environment. */
  config: V1beta1Environment_Config;
  /** Output only. The time at which this environment was created. */
  createTime: string;
  /** Optional. User-defined labels for this environment. The labels map can contain no more than 64 entries. Entries of the labels map are UTF8 strings that comply with the following restrictions: * Keys must conform to regexp: \p{Ll}\p{Lo}{0,62} * Values must conform to regexp: [\p{Ll}\p{Lo}\p{N}_-]{0,63} * Both keys and values are additionally constrained to be <= 128 bytes in size. */
  ...
  state: string;
  /** The configuration for data storage in the environment. */
  storageConfig: V1beta1Environment_StorageConfig;
  /** Output only. The time at which this environment was last modified. */
  updateTime: string;
  /** Output only. The UUID (Universally Unique IDentifier) associated with this environment. This value is generated when the environment is created. */
  uuid: string;
...
export const V1beta1Environment: ResourceBinding<V1beta1EnvironmentConfig, V1beta1EnvironmentAttrs> = {
