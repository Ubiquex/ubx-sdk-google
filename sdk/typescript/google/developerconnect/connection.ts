...
export interface Connection_CryptoKeyConfig {
...
export interface Connection_GitProxyConfig {
...
export interface Connection_GitlabConfig {
  /** Represents a personal access token that authorized the Connection, and associated metadata. */
  authorizerCredential?: Connection_BitbucketCloudConfig_AuthorizerCredential | Computed<Connection_BitbucketCloudConfig_AuthorizerCredential>;
  /** Represents a personal access token that authorized the Connection, and associated metadata. */
  readAuthorizerCredential?: Connection_BitbucketCloudConfig_AuthorizerCredential | Computed<Connection_BitbucketCloudConfig_AuthorizerCredential>;
...
export interface Connection_HttpConfig_BasicAuthentication {
...
export interface Connection_HttpConfig_BearerTokenAuthentication {
  /** Optional. The token SecretManager secret version to authenticate as. */
  tokenSecretVersion?: string | Computed<string>;
}

export interface Connection_HttpConfig {
  /** Basic authentication with username and password. */
  basicAuthentication?: Connection_HttpConfig_BasicAuthentication | Computed<Connection_HttpConfig_BasicAuthentication>;
  /** Bearer token authentication with a token. */
  bearerTokenAuthentication?: Connection_HttpConfig_BearerTokenAuthentication | Computed<Connection_HttpConfig_BearerTokenAuthentication>;
...
export interface Connection_SecureSourceManagerInstanceConfig {
...
const Connection_CryptoKeyConfigFields: FieldMap = {
  keyReference: "key_reference",
};

const Connection_GitProxyConfigFields: FieldMap = {
  enabled: "enabled",
...
const Connection_GitlabConfigFields: FieldMap = {
  authorizerCredential: {
    wireName: "authorizer_credential",
    kind: "object",
    fields: Connection_BitbucketCloudConfig_AuthorizerCredentialFields,
...
const Connection_HttpConfig_BasicAuthenticationFields: FieldMap = {
  passwordSecretVersion: "password_secret_version",
  username: "username",
};

const Connection_HttpConfig_BearerTokenAuthenticationFields: FieldMap = {
  tokenSecretVersion: "token_secret_version",
};

const Connection_HttpConfigFields: FieldMap = {
  basicAuthentication: {
...
const Connection_SecureSourceManagerInstanceConfigFields: FieldMap = {
  instance: "instance",
};
...
export interface ConnectionConfig {
  ...
  gitProxyConfig?: Connection_GitProxyConfig | Computed<Connection_GitProxyConfig>;
  ...
  gitlabConfig?: Connection_GitlabConfig | Computed<Connection_GitlabConfig>;
  /** Configuration for connections to an instance of GitLab Enterprise. */
  gitlabEnterpriseConfig?: Connection_BitbucketDataCenterConfig | Computed<Connection_BitbucketDataCenterConfig>;
  /** Defines the configuration for connections to an HTTP service provider. */
  httpConfig?: Connection_HttpConfig | Computed<Connection_HttpConfig>;
...
export interface ConnectionAttrs {
  ...
  createTime: string;
  /** The crypto key configuration. This field is used by the Customer-managed encryption keys (CMEK) feature. */
  cryptoKeyConfig: Connection_CryptoKeyConfig;
  /** Output only. [Output only] Delete timestamp */
  deleteTime: string;
  /** Optional. If disabled is set to true, functionality is disabled for this connection. Repository based API methods and webhooks processing for repositories in this connection will be disabled. */
  disabled: boolean;
  ...
  etag: string;
  /** The git proxy configuration. */
  gitProxyConfig: Connection_GitProxyConfig;
  /** Configuration for connections to github.com. */
  githubConfig: Connection_GithubConfig;
  /** Configuration for connections to an instance of GitHub Enterprise. */
  githubEnterpriseConfig: Connection_GithubEnterpriseConfig;
  /** Configuration for connections to gitlab.com. */
  gitlabConfig: Connection_GitlabConfig;
  /** Configuration for connections to an instance of GitLab Enterprise. */
  gitlabEnterpriseConfig: Connection_BitbucketDataCenterConfig;
  /** Defines the configuration for connections to an HTTP service provider. */
  httpConfig: Connection_HttpConfig;
  /** Describes stage and necessary actions to be taken by the user to complete the installation. Used for GitHub and GitHub Enterprise based connections. */
  ...
  reconciling: boolean;
  /** Configuration for connections to Secure Source Manager instance */
  secureSourceManagerInstanceConfig: Connection_SecureSourceManagerInstanceConfig;
  /** Output only. A system-assigned unique identifier for the Connection. */
  uid: string;
  /** Output only. [Output only] Update timestamp */
  updateTime: string;
