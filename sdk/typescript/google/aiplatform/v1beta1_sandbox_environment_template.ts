...
export interface V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_CustomContainerSpec {
...
export interface V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_Ports {
  port?: number | Computed<number>;
  protocol?: string | Computed<string>;
}

export interface V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_Resources {
...
export interface V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment {
  /** Specification for deploying from a custom container image. */
  customContainerSpec?: V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_CustomContainerSpec | Computed<V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_CustomContainerSpec>;
  /** Ports to expose from the container. */
  ports?: V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_Ports[] | Computed<V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_Ports[]>;
  /** Message to define resource requests and limits (mirroring Kubernetes) for each sandbox instance created from this template. */
  resources?: V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_Resources | Computed<V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_Resources>;
}

export interface V1beta1SandboxEnvironmentTemplate_DefaultContainerEnvironment {
...
export interface V1beta1SandboxEnvironmentTemplate_EgressControlConfig_DnsPeeringConfigs {
...
export interface V1beta1SandboxEnvironmentTemplate_IngressControlConfig_PscAutomationConfigs {
...
export interface V1beta1SandboxEnvironmentTemplate_IngressControlConfig {
  ...
  pscAutomationConfigs?: V1beta1SandboxEnvironmentTemplate_IngressControlConfig_PscAutomationConfigs[] | Computed<V1beta1SandboxEnvironmentTemplate_IngressControlConfig_PscAutomationConfigs[]>;
  /** Output only. The name of the generated service attachment resource. This is only populated if the endpoint is deployed with PrivateServiceConnect. */
  serviceAttachment?: string | Computed<string>;
}

const V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_CustomContainerSpecFields: FieldMap = {
  imageUri: "image_uri",
};

const V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_PortsFields: FieldMap = {
  port: "port",
  protocol: "protocol",
};

const V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment_ResourcesFields: FieldMap = {
  limits: "limits",
  requests: "requests",
};

const V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironmentFields: FieldMap = {
  customContainerSpec: {
...
const V1beta1SandboxEnvironmentTemplate_DefaultContainerEnvironmentFields: FieldMap = {
...
const V1beta1SandboxEnvironmentTemplate_EgressControlConfig_DnsPeeringConfigsFields: FieldMap = {
  domain: "domain",
...
const V1beta1SandboxEnvironmentTemplate_IngressControlConfig_PscAutomationConfigsFields: FieldMap = {
...
const V1beta1SandboxEnvironmentTemplate_IngressControlConfigFields: FieldMap = {
...
export interface V1beta1SandboxEnvironmentTemplateConfig {
  ...
  defaultContainerEnvironment?: V1beta1SandboxEnvironmentTemplate_DefaultContainerEnvironment | Computed<V1beta1SandboxEnvironmentTemplate_DefaultContainerEnvironment>;
  /** Required. The display name of the SandboxEnvironmentTemplate. */
  displayName?: string | Computed<string>;
  /** Configuration for egress control of sandbox instances. */
  egressControlConfig?: V1beta1SandboxEnvironmentTemplate_EgressControlConfig | Computed<V1beta1SandboxEnvironmentTemplate_EgressControlConfig>;
...
export interface V1beta1SandboxEnvironmentTemplateAttrs {
  ...
  createTime: string;
  /** The customized sandbox runtime environment for BYOC. */
  customContainerEnvironment: V1beta1SandboxEnvironmentTemplate_CustomContainerEnvironment;
  /** The default sandbox runtime environment for default container workloads. */
  defaultContainerEnvironment: V1beta1SandboxEnvironmentTemplate_DefaultContainerEnvironment;
  /** Required. The display name of the SandboxEnvironmentTemplate. */
  displayName: string;
  /** Configuration for egress control of sandbox instances. */
  egressControlConfig: V1beta1SandboxEnvironmentTemplate_EgressControlConfig;
  /** Represents configuration for private service connect. */
  ingressControlConfig: V1beta1SandboxEnvironmentTemplate_IngressControlConfig;
  /** Identifier. The resource name of the SandboxEnvironmentTemplate. Format: `projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine}/sandboxEnvironmentTemplates/{sandbox_environment_template}` */
  name: string;
  /** Output only. The state of the sandbox environment template. */
  state: string;
