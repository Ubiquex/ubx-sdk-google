...
export interface NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec_ReservationAffinity {
...
export interface NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec {
  ...
  reservationAffinity?: NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec_ReservationAffinity | Computed<NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec_ReservationAffinity>;
  /** Immutable. The topology of the TPUs. Corresponds to the TPU topologies available from GKE. (Example: tpu_topology: "2x2x1"). */
  tpuTopology?: string | Computed<string>;
}

export interface NotebookExecutionJob_CustomEnvironmentSpec_NetworkSpec {
...
export interface NotebookExecutionJob_CustomEnvironmentSpec_PersistentDiskSpec {
...
export interface NotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfig {
...
export interface NotebookExecutionJob_CustomEnvironmentSpec {
  /** Specification of a single machine. */
  machineSpec?: NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec | Computed<NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec>;
  /** Network spec. */
  networkSpec?: NotebookExecutionJob_CustomEnvironmentSpec_NetworkSpec | Computed<NotebookExecutionJob_CustomEnvironmentSpec_NetworkSpec>;
  /** Represents the spec of persistent disk and hyperdisk options. */
  persistentDiskSpec?: NotebookExecutionJob_CustomEnvironmentSpec_PersistentDiskSpec | Computed<NotebookExecutionJob_CustomEnvironmentSpec_PersistentDiskSpec>;
  ...
  shieldedInstanceConfig?: NotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfig | Computed<NotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfig>;
}
...
export interface NotebookExecutionJob_EncryptionSpec {
...
export interface NotebookExecutionJob_Status {
...
export interface NotebookExecutionJob_WorkbenchRuntime_CustomContainerImage {
...
export interface NotebookExecutionJob_WorkbenchRuntime_VmImage {
...
export interface NotebookExecutionJob_WorkbenchRuntime {
  ...
  customContainerImage?: NotebookExecutionJob_WorkbenchRuntime_CustomContainerImage | Computed<NotebookExecutionJob_WorkbenchRuntime_CustomContainerImage>;
  /** The definition of a Compute Engine VM image to run the notebook execution on. Mirrors `google.cloud.notebooks.v2.VmImage`. */
  vmImage?: NotebookExecutionJob_WorkbenchRuntime_VmImage | Computed<NotebookExecutionJob_WorkbenchRuntime_VmImage>;
}

const NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec_ReservationAffinityFields: FieldMap = {
  key: "key",
  reservationAffinityType: "reservation_affinity_type",
  values: "values",
};

const NotebookExecutionJob_CustomEnvironmentSpec_MachineSpecFields: FieldMap = {
...
const NotebookExecutionJob_CustomEnvironmentSpec_NetworkSpecFields: FieldMap = {
  enableInternetAccess: "enable_internet_access",
  network: "network",
  subnetwork: "subnetwork",
};

const NotebookExecutionJob_CustomEnvironmentSpec_PersistentDiskSpecFields: FieldMap = {
  diskSizeGb: "disk_size_gb",
  diskType: "disk_type",
};

const NotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfigFields: FieldMap = {
  enableIntegrityMonitoring: "enable_integrity_monitoring",
  enableSecureBoot: "enable_secure_boot",
  enableVtpm: "enable_vtpm",
};

const NotebookExecutionJob_CustomEnvironmentSpecFields: FieldMap = {
  machineSpec: {
...
const NotebookExecutionJob_DataformRepositorySourceFields: FieldMap = {
  commitSha: "commit_sha",
  dataformRepositoryResourceName: "dataform_repository_resource_name",
};

const NotebookExecutionJob_DirectNotebookSourceFields: FieldMap = {
  content: "content",
};

const NotebookExecutionJob_EncryptionSpecFields: FieldMap = {
  kmsKeyName: "kms_key_name",
};

const NotebookExecutionJob_GcsNotebookSourceFields: FieldMap = {
  generation: "generation",
  uri: "uri",
};

const NotebookExecutionJob_StatusFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const NotebookExecutionJob_WorkbenchRuntime_CustomContainerImageFields: FieldMap = {
  repository: "repository",
  tag: "tag",
};

const NotebookExecutionJob_WorkbenchRuntime_VmImageFields: FieldMap = {
  family: "family",
  name: "name",
  project: "project",
};

const NotebookExecutionJob_WorkbenchRuntimeFields: FieldMap = {
...
export interface NotebookExecutionJobConfig {
  ...
  dataformRepositorySource?: NotebookExecutionJob_DataformRepositorySource | Computed<NotebookExecutionJob_DataformRepositorySource>;
  /** The content of the input notebook in ipynb format. */
  directNotebookSource?: NotebookExecutionJob_DirectNotebookSource | Computed<NotebookExecutionJob_DirectNotebookSource>;
  /** The display name of the NotebookExecutionJob. The name can be up to 128 characters long and can consist of any UTF-8 characters. */
  displayName?: string | Computed<string>;
  /** Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource. */
  encryptionSpec?: NotebookExecutionJob_EncryptionSpec | Computed<NotebookExecutionJob_EncryptionSpec>;
...
export interface NotebookExecutionJobAttrs {
  /** Output only. Timestamp when this NotebookExecutionJob was created. */
  createTime: string;
  /** Compute configuration to use for an execution job. */
  ...
  displayName: string;
  /** Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource. */
  encryptionSpec: NotebookExecutionJob_EncryptionSpec;
  /** Max running time of the execution job in seconds (default 86400s / 24 hrs). */
  ...
  /** The `Status` type defines a logical error model that is suitable for different programming environments, including REST APIs and RPC APIs. It is used by [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error code, error message, and error details. You can find out more about this error model and how to work with it in the [API Design Guide](https://cloud.google.com/apis/design/errors). */
  status: NotebookExecutionJob_Status;
  /** Output only. Timestamp when this NotebookExecutionJob was most recently updated. */
  updateTime: string;
  /** Configuration for a Workbench Instances-based environment. */
