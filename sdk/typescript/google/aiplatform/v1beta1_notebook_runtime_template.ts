// Code generated by `ubx sdk gen` from google_aiplatform_v1beta1_notebook_runtime_template. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1NotebookRuntimeTemplate_DataPersistentDiskSpec {
...
export interface V1beta1NotebookRuntimeTemplate_EncryptionSpec {
  /** Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`. */
  kmsKeyName?: string | Computed<string>;
}

export interface V1beta1NotebookRuntimeTemplate_EucConfig {
...
export interface V1beta1NotebookRuntimeTemplate_IdleShutdownConfig {
...
export interface V1beta1NotebookRuntimeTemplate_MachineSpec_ReservationAffinity {
...
export interface V1beta1NotebookRuntimeTemplate_MachineSpec {
  ...
  reservationAffinity?: V1beta1NotebookRuntimeTemplate_MachineSpec_ReservationAffinity | Computed<V1beta1NotebookRuntimeTemplate_MachineSpec_ReservationAffinity>;
  /** Immutable. The topology of the TPUs. Corresponds to the TPU topologies available from GKE. (Example: tpu_topology: "2x2x1"). */
  tpuTopology?: string | Computed<string>;
}

export interface V1beta1NotebookRuntimeTemplate_NetworkSpec {
...
export interface V1beta1NotebookRuntimeTemplate_ReservationAffinity {
...
export interface V1beta1NotebookRuntimeTemplate_ShieldedVmConfig {
...
export interface V1beta1NotebookRuntimeTemplate_SoftwareConfig_ColabImage {
...
export interface V1beta1NotebookRuntimeTemplate_SoftwareConfig_Env {
  name?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface V1beta1NotebookRuntimeTemplate_SoftwareConfig_PostStartupScriptConfig {
...
export interface V1beta1NotebookRuntimeTemplate_SoftwareConfig {
  /** Colab image of the runtime. */
  colabImage?: V1beta1NotebookRuntimeTemplate_SoftwareConfig_ColabImage | Computed<V1beta1NotebookRuntimeTemplate_SoftwareConfig_ColabImage>;
  /** Optional. Environment variables to be passed to the container. Maximum limit is 100. */
  env?: V1beta1NotebookRuntimeTemplate_SoftwareConfig_Env[] | Computed<V1beta1NotebookRuntimeTemplate_SoftwareConfig_Env[]>;
  /** Post startup script config. */
  postStartupScriptConfig?: V1beta1NotebookRuntimeTemplate_SoftwareConfig_PostStartupScriptConfig | Computed<V1beta1NotebookRuntimeTemplate_SoftwareConfig_PostStartupScriptConfig>;
}

const V1beta1NotebookRuntimeTemplate_DataPersistentDiskSpecFields: FieldMap = {
  diskSizeGb: "disk_size_gb",
  diskType: "disk_type",
};

const V1beta1NotebookRuntimeTemplate_EncryptionSpecFields: FieldMap = {
  kmsKeyName: "kms_key_name",
};

const V1beta1NotebookRuntimeTemplate_EucConfigFields: FieldMap = {
  bypassActasCheck: "bypass_actas_check",
  eucDisabled: "euc_disabled",
};

const V1beta1NotebookRuntimeTemplate_IdleShutdownConfigFields: FieldMap = {
  idleShutdownDisabled: "idle_shutdown_disabled",
  idleTimeout: "idle_timeout",
};

const V1beta1NotebookRuntimeTemplate_MachineSpec_ReservationAffinityFields: FieldMap = {
  key: "key",
  reservationAffinityType: "reservation_affinity_type",
  values: "values",
};

const V1beta1NotebookRuntimeTemplate_MachineSpecFields: FieldMap = {
  ...
  reservationAffinity: {
    ...
    kind: "object",
    fields: V1beta1NotebookRuntimeTemplate_MachineSpec_ReservationAffinityFields,
  },
  tpuTopology: "tpu_topology",
};

const V1beta1NotebookRuntimeTemplate_NetworkSpecFields: FieldMap = {
  enableInternetAccess: "enable_internet_access",
  network: "network",
  subnetwork: "subnetwork",
};

const V1beta1NotebookRuntimeTemplate_ReservationAffinityFields: FieldMap = {
  consumeReservationType: "consume_reservation_type",
  key: "key",
  values: "values",
};

const V1beta1NotebookRuntimeTemplate_ShieldedVmConfigFields: FieldMap = {
  enableSecureBoot: "enable_secure_boot",
};

const V1beta1NotebookRuntimeTemplate_SoftwareConfig_ColabImageFields: FieldMap = {
  description: "description",
  releaseName: "release_name",
};

const V1beta1NotebookRuntimeTemplate_SoftwareConfig_EnvFields: FieldMap = {
  name: "name",
  value: "value",
};

const V1beta1NotebookRuntimeTemplate_SoftwareConfig_PostStartupScriptConfigFields: FieldMap = {
...
const V1beta1NotebookRuntimeTemplate_SoftwareConfigFields: FieldMap = {
  colabImage: {
    wireName: "colab_image",
    kind: "object",
    fields: V1beta1NotebookRuntimeTemplate_SoftwareConfig_ColabImageFields,
  },
  env: {
    wireName: "env",
    kind: "list",
    fields: V1beta1NotebookRuntimeTemplate_SoftwareConfig_EnvFields,
  },
  postStartupScriptConfig: {
    wireName: "post_startup_script_config",
    kind: "object",
    fields: V1beta1NotebookRuntimeTemplate_SoftwareConfig_PostStartupScriptConfigFields,
  },
};
...
export interface V1beta1NotebookRuntimeTemplateConfig {
  ...
  encryptionSpec?: V1beta1NotebookRuntimeTemplate_EncryptionSpec | Computed<V1beta1NotebookRuntimeTemplate_EncryptionSpec>;
  ...
  machineSpec?: V1beta1NotebookRuntimeTemplate_MachineSpec | Computed<V1beta1NotebookRuntimeTemplate_MachineSpec>;
  /** The resource name of the NotebookRuntimeTemplate. */
  name?: string | Computed<string>;
  /** Network spec. */
  networkSpec?: V1beta1NotebookRuntimeTemplate_NetworkSpec | Computed<V1beta1NotebookRuntimeTemplate_NetworkSpec>;
  ...
  reservationAffinity?: V1beta1NotebookRuntimeTemplate_ReservationAffinity | Computed<V1beta1NotebookRuntimeTemplate_ReservationAffinity>;
...
export interface V1beta1NotebookRuntimeTemplateAttrs {
  ...
  createTime: string;
  /** Represents the spec of persistent disk and hyperdisk options. */
  dataPersistentDiskSpec: V1beta1NotebookRuntimeTemplate_DataPersistentDiskSpec;
  /** The description of the NotebookRuntimeTemplate. */
  description: string;
  /** Required. The display name of the NotebookRuntimeTemplate. The name can be up to 128 characters long and can consist of any UTF-8 characters. */
  displayName: string;
  /** Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource. */
  encryptionSpec: V1beta1NotebookRuntimeTemplate_EncryptionSpec;
  /** Used to perform consistent read-modify-write updates. If not set, a blind "overwrite" update happens. */
  etag: string;
  /** The euc configuration of NotebookRuntimeTemplate. */
  eucConfig: V1beta1NotebookRuntimeTemplate_EucConfig;
  /** The idle shutdown configuration of NotebookRuntimeTemplate, which contains the idle_timeout as required field. */
  idleShutdownConfig: V1beta1NotebookRuntimeTemplate_IdleShutdownConfig;
  /** Output only. Deprecated: This field has no behavior. Use notebook_runtime_type = 'ONE_CLICK' instead. The default template to use if not specified. */
  isDefault: boolean;
  /** The labels with user-defined metadata to organize the NotebookRuntimeTemplates. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels. */
  labels: Record<string, string>;
  /** Specification of a single machine. */
  machineSpec: V1beta1NotebookRuntimeTemplate_MachineSpec;
  /** The resource name of the NotebookRuntimeTemplate. */
  name: string;
  /** Network spec. */
  networkSpec: V1beta1NotebookRuntimeTemplate_NetworkSpec;
  /** Optional. The Compute Engine tags to add to runtime (see [Tagging instances](https://cloud.google.com/vpc/docs/add-remove-network-tags)). */
  networkTags: string[];
  /** Optional. Immutable. The type of the notebook runtime template. */
  notebookRuntimeType: string;
  /** Notebook Reservation Affinity for consuming Zonal reservation. */
  reservationAffinity: V1beta1NotebookRuntimeTemplate_ReservationAffinity;
  /** Deprecated: This field is ignored and the "Vertex AI Notebook Service Account" (service-PROJECT_NUMBER@gcp-sa-aiplatform-vm.iam.gserviceaccount.com) is used for the runtime workload identity. See https://cloud.google.com/iam/docs/service-agents#vertex-ai-notebook-service-account for more details. For NotebookExecutionJob, use NotebookExecutionJob.service_account instead. The service account that the runtime workload runs as. You can use any service account within the same project, but you must have the service account user permission to use the instance. If not specified, the [Compute Engine default service account](https://cloud.google.com/compute/docs/access/service-accounts#default_service_account) is used. */
  serviceAccount: string;
  /** A set of Shielded Instance options. See [Images using supported Shielded VM features](https://cloud.google.com/compute/docs/instances/modifying-shielded-vm). */
  shieldedVmConfig: V1beta1NotebookRuntimeTemplate_ShieldedVmConfig;
  /** Notebook Software Config. This is passed to the backend when user makes software configurations in UI. */
  softwareConfig: V1beta1NotebookRuntimeTemplate_SoftwareConfig;
  /** Output only. Timestamp when this NotebookRuntimeTemplate was most recently updated. */
  updateTime: string;
}
...
export const V1beta1NotebookRuntimeTemplate: ResourceBinding<V1beta1NotebookRuntimeTemplateConfig, V1beta1NotebookRuntimeTemplateAttrs> = {
  ...
  fields: {
    ...
    dataPersistentDiskSpec: {
      ...
      kind: "object",
      fields: V1beta1NotebookRuntimeTemplate_DataPersistentDiskSpecFields,
    },
    description: "description",
    ...
    encryptionSpec: {
      ...
      kind: "object",
      fields: V1beta1NotebookRuntimeTemplate_EncryptionSpecFields,
    },
    etag: "etag",
    eucConfig: {
      wireName: "euc_config",
      kind: "object",
      fields: V1beta1NotebookRuntimeTemplate_EucConfigFields,
    },
    idleShutdownConfig: {
    ...
    machineSpec: {
      ...
      kind: "object",
      fields: V1beta1NotebookRuntimeTemplate_MachineSpecFields,
    },
    name: "name",
    networkSpec: {
      wireName: "network_spec",
      kind: "object",
      fields: V1beta1NotebookRuntimeTemplate_NetworkSpecFields,
    },
    ...
    reservationAffinity: {
      wireName: "reservation_affinity",
      kind: "object",
      fields: V1beta1NotebookRuntimeTemplate_ReservationAffinityFields,
    },
    serviceAccount: "service_account",
    shieldedVmConfig: {
      wireName: "shielded_vm_config",
      kind: "object",
      fields: V1beta1NotebookRuntimeTemplate_ShieldedVmConfigFields,
    },
    softwareConfig: {
