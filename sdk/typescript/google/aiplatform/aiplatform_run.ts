...
export interface AiplatformRunConfig {
...
export interface AiplatformRunAttrs {
  /** Output only. Timestamp when this TensorboardRun was created. */
  createTime: string;
  /** Description of this TensorboardRun. */
  description: string;
...
export const AiplatformRun: ResourceBinding<AiplatformRunConfig, AiplatformRunAttrs> = {
