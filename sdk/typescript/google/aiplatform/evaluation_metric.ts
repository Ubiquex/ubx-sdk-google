...
export interface EvaluationMetric_EncryptionSpec {
  /** Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`. */
  kmsKeyName?: string | Computed<string>;
}

export interface EvaluationMetric_Metric_BleuSpec {
  /** Optional. Whether to use_effective_order to compute bleu score. */
  useEffectiveOrder?: boolean | Computed<boolean>;
}

export interface EvaluationMetric_Metric_ComputationBasedMetricSpec {
...
export interface EvaluationMetric_Metric_CustomCodeExecutionSpec {
...
export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfig_LanguageHints {
...
export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfig {
...
export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig_ImageOutputOptions {
...
export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig {
  ...
  imageOutputOptions?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig_ImageOutputOptions | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig_ImageOutputOptions>;
...
export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseSchema {
...
export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_AutoMode {
  /** The model routing preference. */
  modelRoutingPreference?: string | Computed<string>;
}

export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_ManualMode {
  /** The name of the model to use. Only public LLM models are accepted. */
  modelName?: string | Computed<string>;
}

export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig {
  ...
  autoMode?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_AutoMode | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_AutoMode>;
  ...
  manualMode?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_ManualMode | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_ManualMode>;
}
...
export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig {
  /** Required. A list of configurations for the voices of the speakers. Exactly two speaker voice configurations must be provided. */
  speakerVoiceConfigs?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs[] | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs[]>;
}

export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig {
  /** Optional. The language code (ISO 639-1) for the speech synthesis. */
  languageCode?: string | Computed<string>;
  /** Configuration for a multi-speaker text-to-speech request. */
  multiSpeakerVoiceConfig?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig>;
  /** Configuration for a voice. */
  voiceConfig?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig>;
}

export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ThinkingConfig {
...
export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig {
  ...
  audioTranscriptionConfig?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfig | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfig>;
  ...
  imageConfig?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig>;
  ...
  responseFormat?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat[] | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat[]>;
  ...
  responseSchema?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseSchema | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseSchema>;
  ...
  routingConfig?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig>;
  ...
  speechConfig?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig>;
  ...
  thinkingConfig?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ThinkingConfig | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ThinkingConfig>;
...
export interface EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig {
  ...
  generationConfig?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig>;
  /** Optional. Number of samples for each instance in the dataset. If not specified, the default is 4. Minimum value is 1, maximum value is 32. */
  samplingCount?: number | Computed<number>;
}

export interface EvaluationMetric_Metric_LlmBasedMetricSpec_PredefinedRubricGenerationSpec {
...
export interface EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig_CustomCodeParserConfig {
...
export interface EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig {
  /** Configuration for parsing the LLM response using custom code. */
  customCodeParserConfig?: EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig_CustomCodeParserConfig | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig_CustomCodeParserConfig>;
}

export interface EvaluationMetric_Metric_LlmBasedMetricSpec_RubricGenerationSpec {
  /** The configs for autorater. This is applicable to both EvaluateInstances and EvaluateDataset. */
  modelConfig?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig>;
...
export interface EvaluationMetric_Metric_LlmBasedMetricSpec {
  /** Optional. Optional additional configuration for the metric. */
  additionalConfig?: Record<string, unknown> | Computed<Record<string, unknown>>;
  /** The configs for autorater. This is applicable to both EvaluateInstances and EvaluateDataset. */
  judgeAutoraterConfig?: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig>;
  /** Required. Template for the prompt sent to the judge model. */
  metricPromptTemplate?: string | Computed<string>;
  /** The spec for a pre-defined metric. */
  predefinedRubricGenerationSpec?: EvaluationMetric_Metric_LlmBasedMetricSpec_PredefinedRubricGenerationSpec | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_PredefinedRubricGenerationSpec>;
  ...
  resultParserConfig?: EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig>;
  /** Specification for how rubrics should be generated. */
  rubricGenerationSpec?: EvaluationMetric_Metric_LlmBasedMetricSpec_RubricGenerationSpec | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_RubricGenerationSpec>;
...
export interface EvaluationMetric_Metric_Metadata_ScoreRange {
...
export interface EvaluationMetric_Metric_Metadata {
  ...
  scoreRange?: EvaluationMetric_Metric_Metadata_ScoreRange | Computed<EvaluationMetric_Metric_Metadata_ScoreRange>;
...
export interface EvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfig {
  /** Optional. Whether to return raw output. */
  returnRawOutput?: boolean | Computed<boolean>;
}

export interface EvaluationMetric_Metric_PairwiseMetricSpec {
  ...
  customOutputFormatConfig?: EvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfig | Computed<EvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfig>;
...
export interface EvaluationMetric_Metric_PointwiseMetricSpec {
  /** Spec for custom output format configuration. */
  customOutputFormatConfig?: EvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfig | Computed<EvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfig>;
...
export interface EvaluationMetric_Metric_RougeSpec {
...
export interface EvaluationMetric_Metric {
  /** Optional. The aggregation metrics to use. */
  aggregationMetrics?: string[] | Computed<string[]>;
  /** Spec for bleu score metric - calculates the precision of n-grams in the prediction as compared to reference - returns a score ranging between 0 to 1. */
  bleuSpec?: EvaluationMetric_Metric_BleuSpec | Computed<EvaluationMetric_Metric_BleuSpec>;
  /** Specification for a computation based metric. */
  computationBasedMetricSpec?: EvaluationMetric_Metric_ComputationBasedMetricSpec | Computed<EvaluationMetric_Metric_ComputationBasedMetricSpec>;
  /** Specificies a metric that is populated by evaluating user-defined Python code. */
  customCodeExecutionSpec?: EvaluationMetric_Metric_CustomCodeExecutionSpec | Computed<EvaluationMetric_Metric_CustomCodeExecutionSpec>;
  /** Spec for exact match metric - returns 1 if prediction and reference exactly matches, otherwise 0. */
  exactMatchSpec?: unknown | Computed<unknown>;
  /** Specification for an LLM based metric. */
  llmBasedMetricSpec?: EvaluationMetric_Metric_LlmBasedMetricSpec | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec>;
  /** Metadata about the metric, used for visualization and organization. */
  metadata?: EvaluationMetric_Metric_Metadata | Computed<EvaluationMetric_Metric_Metadata>;
  /** Spec for pairwise metric. */
  pairwiseMetricSpec?: EvaluationMetric_Metric_PairwiseMetricSpec | Computed<EvaluationMetric_Metric_PairwiseMetricSpec>;
  /** Spec for pointwise metric. */
  pointwiseMetricSpec?: EvaluationMetric_Metric_PointwiseMetricSpec | Computed<EvaluationMetric_Metric_PointwiseMetricSpec>;
  /** The spec for a pre-defined metric. */
  predefinedMetricSpec?: EvaluationMetric_Metric_LlmBasedMetricSpec_PredefinedRubricGenerationSpec | Computed<EvaluationMetric_Metric_LlmBasedMetricSpec_PredefinedRubricGenerationSpec>;
  /** Spec for rouge score metric - calculates the recall of n-grams in prediction as compared to reference - returns a score ranging between 0 and 1. */
  rougeSpec?: EvaluationMetric_Metric_RougeSpec | Computed<EvaluationMetric_Metric_RougeSpec>;
}

const EvaluationMetric_EncryptionSpecFields: FieldMap = {
  kmsKeyName: "kms_key_name",
};

const EvaluationMetric_Metric_BleuSpecFields: FieldMap = {
  useEffectiveOrder: "use_effective_order",
};

const EvaluationMetric_Metric_ComputationBasedMetricSpecFields: FieldMap = {
  parameters: "parameters",
  type: "type",
};

const EvaluationMetric_Metric_CustomCodeExecutionSpecFields: FieldMap = {
  evaluationFunction: "evaluation_function",
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfig_LanguageHintsFields: FieldMap = {
  languageCodes: "language_codes",
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfigFields: FieldMap = {
...
const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig_ImageOutputOptionsFields: FieldMap = {
  compressionQuality: "compression_quality",
  mimeType: "mime_type",
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfigFields: FieldMap = {
  aspectRatio: "aspect_ratio",
  imageOutputOptions: {
    wireName: "image_output_options",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfig_ImageOutputOptionsFields,
  },
...
const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_AudioFields: FieldMap = {
  bitRate: "bit_rate",
  delivery: "delivery",
  mimeType: "mime_type",
...
const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_ImageFields: FieldMap = {
  aspectRatio: "aspect_ratio",
  delivery: "delivery",
  imageSize: "image_size",
  mimeType: "mime_type",
...
const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_TextFields: FieldMap = {
  mimeType: "mime_type",
  schema: "schema",
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_VideoFields: FieldMap = {
  aspectRatio: "aspect_ratio",
  delivery: "delivery",
  duration: "duration",
  gcsUri: "gcs_uri",
...
const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormatFields: FieldMap = {
  audio: {
    wireName: "audio",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_AudioFields,
  },
  image: {
    wireName: "image",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_ImageFields,
  },
  text: {
    wireName: "text",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_TextFields,
  },
  video: {
    wireName: "video",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormat_VideoFields,
  },
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseSchemaFields: FieldMap = {
...
const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_AutoModeFields: FieldMap = {
  modelRoutingPreference: "model_routing_preference",
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_ManualModeFields: FieldMap = {
  modelName: "model_name",
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfigFields: FieldMap = {
  autoMode: {
    wireName: "auto_mode",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_AutoModeFields,
  },
  manualMode: {
    wireName: "manual_mode",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfig_ManualModeFields,
  },
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig_PrebuiltVoiceConfigFields: FieldMap = {
  voiceName: "voice_name",
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig_ReplicatedVoiceConfigFields: FieldMap = {
  mimeType: "mime_type",
  voiceSampleAudio: "voice_sample_audio",
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfigFields: FieldMap = {
  prebuiltVoiceConfig: {
    wireName: "prebuilt_voice_config",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig_PrebuiltVoiceConfigFields,
  },
  replicatedVoiceConfig: {
    wireName: "replicated_voice_config",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfig_ReplicatedVoiceConfigFields,
  },
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigsFields: FieldMap = {
  speaker: "speaker",
  voiceConfig: {
    wireName: "voice_config",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigs_VoiceConfigFields,
  },
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfigFields: FieldMap = {
  speakerVoiceConfigs: {
    wireName: "speaker_voice_configs",
    kind: "list",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfig_SpeakerVoiceConfigsFields,
  },
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfigFields: FieldMap = {
  languageCode: "language_code",
  multiSpeakerVoiceConfig: {
    wireName: "multi_speaker_voice_config",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfig_MultiSpeakerVoiceConfigFields,
  },
  voiceConfig: {
    wireName: "voice_config",
    kind: "object",
...
const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ThinkingConfigFields: FieldMap = {
...
const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfigFields: FieldMap = {
  ...
  audioTranscriptionConfig: {
    ...
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_AudioTranscriptionConfigFields,
  },
  ...
  imageConfig: {
    ...
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ImageConfigFields,
  },
  logprobs: "logprobs",
  ...
  responseFormat: {
    ...
    kind: "list",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseFormatFields,
  },
  ...
  responseSchema: {
    ...
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ResponseSchemaFields,
  },
  routingConfig: {
    wireName: "routing_config",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_RoutingConfigFields,
  },
  seed: "seed",
  speechConfig: {
    wireName: "speech_config",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_SpeechConfigFields,
  },
  ...
  thinkingConfig: {
    ...
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfig_ThinkingConfigFields,
  },
  topK: "top_k",
  topP: "top_p",
};
...
const EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfigFields: FieldMap = {
  ...
  generationConfig: {
    ...
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfig_GenerationConfigFields,
  },
  samplingCount: "sampling_count",
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_PredefinedRubricGenerationSpecFields: FieldMap = {
  metricSpecName: "metric_spec_name",
  metricSpecParameters: "metric_spec_parameters",
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig_CustomCodeParserConfigFields: FieldMap = {
  parsingFunction: "parsing_function",
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfigFields: FieldMap = {
  customCodeParserConfig: {
    wireName: "custom_code_parser_config",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfig_CustomCodeParserConfigFields,
  },
};

const EvaluationMetric_Metric_LlmBasedMetricSpec_RubricGenerationSpecFields: FieldMap = {
  modelConfig: {
    wireName: "model_config",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_JudgeAutoraterConfigFields,
  },
...
const EvaluationMetric_Metric_LlmBasedMetricSpecFields: FieldMap = {
  ...
  predefinedRubricGenerationSpec: {
    ...
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_PredefinedRubricGenerationSpecFields,
  },
  resultParserConfig: {
    wireName: "result_parser_config",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_ResultParserConfigFields,
  },
  rubricGenerationSpec: {
    wireName: "rubric_generation_spec",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpec_RubricGenerationSpecFields,
  },
  rubricGroupKey: "rubric_group_key",
  systemInstruction: "system_instruction",
};

const EvaluationMetric_Metric_Metadata_ScoreRangeFields: FieldMap = {
  description: "description",
  max: "max",
  min: "min",
  step: "step",
...
const EvaluationMetric_Metric_MetadataFields: FieldMap = {
  otherMetadata: "other_metadata",
  scoreRange: {
    wireName: "score_range",
    kind: "object",
    fields: EvaluationMetric_Metric_Metadata_ScoreRangeFields,
  },
  title: "title",
};

const EvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfigFields: FieldMap = {
  returnRawOutput: "return_raw_output",
};

const EvaluationMetric_Metric_PairwiseMetricSpecFields: FieldMap = {
  ...
  customOutputFormatConfig: {
    ...
    kind: "object",
    fields: EvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfigFields,
  },
  metricPromptTemplate: "metric_prompt_template",
  systemInstruction: "system_instruction",
};

const EvaluationMetric_Metric_PointwiseMetricSpecFields: FieldMap = {
  customOutputFormatConfig: {
    wireName: "custom_output_format_config",
    kind: "object",
    fields: EvaluationMetric_Metric_PairwiseMetricSpec_CustomOutputFormatConfigFields,
...
const EvaluationMetric_Metric_RougeSpecFields: FieldMap = {
  rougeType: "rouge_type",
  splitSummaries: "split_summaries",
  useStemmer: "use_stemmer",
};

const EvaluationMetric_MetricFields: FieldMap = {
  aggregationMetrics: "aggregation_metrics",
  bleuSpec: {
    wireName: "bleu_spec",
    kind: "object",
    fields: EvaluationMetric_Metric_BleuSpecFields,
  },
  computationBasedMetricSpec: {
    wireName: "computation_based_metric_spec",
    kind: "object",
    fields: EvaluationMetric_Metric_ComputationBasedMetricSpecFields,
  },
  customCodeExecutionSpec: {
    wireName: "custom_code_execution_spec",
    kind: "object",
    fields: EvaluationMetric_Metric_CustomCodeExecutionSpecFields,
  },
  exactMatchSpec: "exact_match_spec",
  llmBasedMetricSpec: {
    wireName: "llm_based_metric_spec",
    kind: "object",
    fields: EvaluationMetric_Metric_LlmBasedMetricSpecFields,
  },
  metadata: {
    wireName: "metadata",
    kind: "object",
    fields: EvaluationMetric_Metric_MetadataFields,
  },
  pairwiseMetricSpec: {
    wireName: "pairwise_metric_spec",
    kind: "object",
    fields: EvaluationMetric_Metric_PairwiseMetricSpecFields,
  },
  pointwiseMetricSpec: {
    wireName: "pointwise_metric_spec",
    kind: "object",
    fields: EvaluationMetric_Metric_PointwiseMetricSpecFields,
  },
  ...
  rougeSpec: {
    wireName: "rouge_spec",
    kind: "object",
    fields: EvaluationMetric_Metric_RougeSpecFields,
  },
};
...
export interface EvaluationMetricConfig {
  ...
  encryptionSpec?: EvaluationMetric_EncryptionSpec | Computed<EvaluationMetric_EncryptionSpec>;
...
export interface EvaluationMetricAttrs {
  ...
  displayName: string;
  /** Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource. */
  encryptionSpec: EvaluationMetric_EncryptionSpec;
  /** Optional. The Google Cloud Storage URI that stores the metric specification.. */
  gcsUri: string;
  /** Optional. Labels for the evaluation metric. */
  labels: Record<string, string>;
  /** The metric used for running evaluations. */
  metric: EvaluationMetric_Metric;
  /** Identifier. The resource name of the EvaluationMetric. Format: `projects/{project}/locations/{location}/evaluationMetrics/{evaluation_metric}` */
  name: string;
...
export const EvaluationMetric: ResourceBinding<EvaluationMetricConfig, EvaluationMetricAttrs> = {
  ...
  fields: {
    ...
    encryptionSpec: {
      ...
      kind: "object",
      fields: EvaluationMetric_EncryptionSpecFields,
    },
    gcsUri: "gcs_uri",
    labels: "labels",
    metric: {
