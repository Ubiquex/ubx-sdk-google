// Code generated by `ubx sdk gen` from google_aiplatform_training_pipeline. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface TrainingPipeline_EncryptionSpec {
  /** Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`. */
  kmsKeyName?: string | Computed<string>;
}

export interface TrainingPipeline_Error {
...
export interface TrainingPipeline_InputDataConfig_BigqueryDestination {
  /** Required. BigQuery URI to a project or table, up to 2000 characters long. When only the project is specified, the Dataset and Table is created. When the full table reference is specified, the Dataset must exist and table must not exist. Accepted forms: * BigQuery path. For example: `bq://projectId` or `bq://projectId.bqDatasetId` or `bq://projectId.bqDatasetId.bqTableId`. */
  outputUri?: string | Computed<string>;
}

export interface TrainingPipeline_InputDataConfig_FilterSplit {
...
export interface TrainingPipeline_InputDataConfig_FractionSplit {
...
export interface TrainingPipeline_InputDataConfig_GcsDestination {
  /** Required. Google Cloud Storage URI to output directory. If the uri doesn't end with '/', a '/' will be automatically appended. The directory is created if it doesn't exist. */
  outputUriPrefix?: string | Computed<string>;
}

export interface TrainingPipeline_InputDataConfig_PredefinedSplit {
  /** Required. The key is a name of one of the Dataset's data columns. The value of the key (either the label's value or value in the column) must be one of {`training`, `validation`, `test`}, and it defines to which set the given piece of data is assigned. If for a piece of data the key is not present or has an invalid value, that piece is ignored by the pipeline. */
  key?: string | Computed<string>;
}

export interface TrainingPipeline_InputDataConfig_StratifiedSplit {
...
export interface TrainingPipeline_InputDataConfig {
  ...
  bigqueryDestination?: TrainingPipeline_InputDataConfig_BigqueryDestination | Computed<TrainingPipeline_InputDataConfig_BigqueryDestination>;
  ...
  filterSplit?: TrainingPipeline_InputDataConfig_FilterSplit | Computed<TrainingPipeline_InputDataConfig_FilterSplit>;
  /** Assigns the input data to training, validation, and test sets as per the given fractions. Any of `training_fraction`, `validation_fraction` and `test_fraction` may optionally be provided, they must sum to up to 1. If the provided ones sum to less than 1, the remainder is assigned to sets as decided by Vertex AI. If none of the fractions are set, by default roughly 80% of data is used for training, 10% for validation, and 10% for test. */
  fractionSplit?: TrainingPipeline_InputDataConfig_FractionSplit | Computed<TrainingPipeline_InputDataConfig_FractionSplit>;
  /** The Google Cloud Storage location where the output is to be written to. */
  gcsDestination?: TrainingPipeline_InputDataConfig_GcsDestination | Computed<TrainingPipeline_InputDataConfig_GcsDestination>;
  ...
  predefinedSplit?: TrainingPipeline_InputDataConfig_PredefinedSplit | Computed<TrainingPipeline_InputDataConfig_PredefinedSplit>;
  ...
  stratifiedSplit?: TrainingPipeline_InputDataConfig_StratifiedSplit | Computed<TrainingPipeline_InputDataConfig_StratifiedSplit>;
  ...
  timestampSplit?: TrainingPipeline_InputDataConfig_StratifiedSplit | Computed<TrainingPipeline_InputDataConfig_StratifiedSplit>;
}

export interface TrainingPipeline_ModelToUpload_BaseModelSource_GenieSource {
  /** Required. The public base model URI. */
  baseModelUri?: string | Computed<string>;
}

export interface TrainingPipeline_ModelToUpload_BaseModelSource_ModelGardenSource {
...
export interface TrainingPipeline_ModelToUpload_BaseModelSource {
  /** Contains information about the source of the models generated from Generative AI Studio. */
  genieSource?: TrainingPipeline_ModelToUpload_BaseModelSource_GenieSource | Computed<TrainingPipeline_ModelToUpload_BaseModelSource_GenieSource>;
  /** Contains information about the source of the models generated from Model Garden. */
  modelGardenSource?: TrainingPipeline_ModelToUpload_BaseModelSource_ModelGardenSource | Computed<TrainingPipeline_ModelToUpload_BaseModelSource_ModelGardenSource>;
}

export interface TrainingPipeline_ModelToUpload_Checkpoints {
...
export interface TrainingPipeline_ModelToUpload_ContainerSpec_Env {
...
export interface TrainingPipeline_ModelToUpload_ContainerSpec_GrpcPorts {
  /** The port number the container listens on. (AI-inferred) */
  containerPort?: number | Computed<number>;
}

export interface TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_Exec {
  /** Command is the command line to execute inside the container, the working directory for the command is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy. */
  command?: string[] | Computed<string[]>;
}

export interface TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_Grpc {
...
export interface TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_HttpGet {
  ...
  httpHeaders?: TrainingPipeline_ModelToUpload_ContainerSpec_Env[] | Computed<TrainingPipeline_ModelToUpload_ContainerSpec_Env[]>;
...
export interface TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_TcpSocket {
...
export interface TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe {
  /** ExecAction specifies a command to execute. */
  exec?: TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_Exec | Computed<TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_Exec>;
  ...
  grpc?: TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_Grpc | Computed<TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_Grpc>;
  /** HttpGetAction describes an action based on HTTP Get requests. */
  httpGet?: TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_HttpGet | Computed<TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_HttpGet>;
  ...
  tcpSocket?: TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_TcpSocket | Computed<TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_TcpSocket>;
  /** Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. Must be greater or equal to period_seconds. Maps to Kubernetes probe argument 'timeoutSeconds'. */
  timeoutSeconds?: number | Computed<number>;
}

export interface TrainingPipeline_ModelToUpload_ContainerSpec {
  ...
  env?: TrainingPipeline_ModelToUpload_ContainerSpec_Env[] | Computed<TrainingPipeline_ModelToUpload_ContainerSpec_Env[]>;
  ...
  grpcPorts?: TrainingPipeline_ModelToUpload_ContainerSpec_GrpcPorts[] | Computed<TrainingPipeline_ModelToUpload_ContainerSpec_GrpcPorts[]>;
  /** Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic. */
  healthProbe?: TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe | Computed<TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe>;
  ...
  /** Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic. */
  livenessProbe?: TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe | Computed<TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe>;
  /** Immutable. List of ports to expose from the container. Vertex AI sends any prediction requests that it receives to the first port on this list. Vertex AI also sends [liveness and health checks](https://cloud.google.com/vertex-ai/docs/predictions/custom-container-requirements#liveness) to this port. If you do not specify this field, it defaults to following value: ```json [ { "containerPort": 8080 } ] ``` Vertex AI does not use ports other than the first one listed. This field corresponds to the `ports` field of the Kubernetes Containers [v1 core API](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#container-v1-core). */
  ports?: TrainingPipeline_ModelToUpload_ContainerSpec_GrpcPorts[] | Computed<TrainingPipeline_ModelToUpload_ContainerSpec_GrpcPorts[]>;
  ...
  /** Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic. */
  startupProbe?: TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe | Computed<TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe>;
}

export interface TrainingPipeline_ModelToUpload_DataStats {
...
export interface TrainingPipeline_ModelToUpload_DeployedModels {
  /** An identifier for this specific training checkpoint. (AI-inferred) */
  checkpointId?: string | Computed<string>;
...
export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs_FeatureValueDomain {
...
export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs_Visualization {
...
export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs {
  ...
  featureValueDomain?: TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs_FeatureValueDomain | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs_FeatureValueDomain>;
  ...
  visualization?: TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs_Visualization | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs_Visualization>;
}

export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Outputs {
...
export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata {
  ...
  inputs?: Record<string, TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs> | Computed<Record<string, TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs>>;
  ...
  outputs?: Record<string, TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Outputs> | Computed<Record<string, TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Outputs>>;
}

export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource {
  /** Required. Google Cloud Storage URI(-s) to the input file(s). May contain wildcards. For more information on wildcards, see https://cloud.google.com/storage/docs/wildcards. */
  uris?: string[] | Computed<string[]>;
}

export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource {
  /** The format in which instances are given, if not specified, assume it's JSONL format. Currently only JSONL format is supported. */
  dataFormat?: string | Computed<string>;
  /** The Google Cloud Storage location for the input content. */
  gcsSource?: TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource>;
}

export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_Presets {
...
export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples {
  /** The Cloud Storage input instances. */
  exampleGcsSource?: TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource>;
  ...
  presets?: TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_Presets | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_Presets>;
}

export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig {
...
export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma {
  /** The resource name or identifier of this object. (AI-inferred) */
  name?: string | Computed<string>;
...
export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma {
  /** Noise sigma per feature. No noise is added to features that are not set. */
  noiseSigma?: TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma[] | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma[]>;
}

export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig {
  /** Noise sigma by features. Noise sigma represents the standard deviation of the gaussian kernel that will be used to add noise to interpolated inputs prior to computing gradients. */
  featureNoiseSigma?: TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma>;
...
export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution {
  ...
  blurBaselineConfig?: TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig>;
  /** Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf */
  smoothGradConfig?: TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig>;
...
export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_SampledShapleyAttribution {
...
export interface TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters {
  /** Example-based explainability that returns the nearest neighbors from the provided dataset. */
  examples?: TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples>;
  /** An attribution method that computes the Aumann-Shapley value taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1703.01365 */
  integratedGradientsAttribution?: TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution>;
  ...
  sampledShapleyAttribution?: TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_SampledShapleyAttribution | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_SampledShapleyAttribution>;
  ...
  xraiAttribution?: TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution>;
}

export interface TrainingPipeline_ModelToUpload_ExplanationSpec {
  /** Metadata describing the Model's input and output for explanation. */
  metadata?: TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata>;
  /** Parameters to configure explaining for Model's predictions. */
  parameters?: TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters>;
}

export interface TrainingPipeline_ModelToUpload_ModelSourceInfo {
...
export interface TrainingPipeline_ModelToUpload_OriginalModelInfo {
...
export interface TrainingPipeline_ModelToUpload_PredictSchemata {
...
export interface TrainingPipeline_ModelToUpload_SupportedExportFormats {
...
export interface TrainingPipeline_ModelToUpload {
  ...
  baseModelSource?: TrainingPipeline_ModelToUpload_BaseModelSource | Computed<TrainingPipeline_ModelToUpload_BaseModelSource>;
  /** Optional. Output only. The checkpoints of the model. */
  checkpoints?: TrainingPipeline_ModelToUpload_Checkpoints[] | Computed<TrainingPipeline_ModelToUpload_Checkpoints[]>;
  ...
  containerSpec?: TrainingPipeline_ModelToUpload_ContainerSpec | Computed<TrainingPipeline_ModelToUpload_ContainerSpec>;
  /** Output only. Timestamp when this Model was uploaded into Vertex AI. */
  createTime?: string | Computed<string>;
  /** Stats of data used for train or evaluate the Model. */
  dataStats?: TrainingPipeline_ModelToUpload_DataStats | Computed<TrainingPipeline_ModelToUpload_DataStats>;
  /** The default checkpoint id of a model version. */
  defaultCheckpointId?: string | Computed<string>;
  /** Output only. The pointers to DeployedModels created from this Model. Note that Model could have been deployed to Endpoints in different Locations. */
  deployedModels?: TrainingPipeline_ModelToUpload_DeployedModels[] | Computed<TrainingPipeline_ModelToUpload_DeployedModels[]>;
  ...
  encryptionSpec?: TrainingPipeline_EncryptionSpec | Computed<TrainingPipeline_EncryptionSpec>;
  /** Used to perform consistent read-modify-write updates. If not set, a blind "overwrite" update happens. */
  etag?: string | Computed<string>;
  /** Specification of Model explanation. */
  explanationSpec?: TrainingPipeline_ModelToUpload_ExplanationSpec | Computed<TrainingPipeline_ModelToUpload_ExplanationSpec>;
  ...
  modelSourceInfo?: TrainingPipeline_ModelToUpload_ModelSourceInfo | Computed<TrainingPipeline_ModelToUpload_ModelSourceInfo>;
  /** Identifier. The resource name of the Model. */
  name?: string | Computed<string>;
  /** Contains information about the original Model if this Model is a copy. */
  originalModelInfo?: TrainingPipeline_ModelToUpload_OriginalModelInfo | Computed<TrainingPipeline_ModelToUpload_OriginalModelInfo>;
  ...
  predictSchemata?: TrainingPipeline_ModelToUpload_PredictSchemata | Computed<TrainingPipeline_ModelToUpload_PredictSchemata>;
  ...
  supportedExportFormats?: TrainingPipeline_ModelToUpload_SupportedExportFormats[] | Computed<TrainingPipeline_ModelToUpload_SupportedExportFormats[]>;
...
const TrainingPipeline_EncryptionSpecFields: FieldMap = {
  kmsKeyName: "kms_key_name",
};

const TrainingPipeline_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const TrainingPipeline_InputDataConfig_BigqueryDestinationFields: FieldMap = {
  outputUri: "output_uri",
};

const TrainingPipeline_InputDataConfig_FilterSplitFields: FieldMap = {
  testFilter: "test_filter",
  trainingFilter: "training_filter",
  validationFilter: "validation_filter",
};

const TrainingPipeline_InputDataConfig_FractionSplitFields: FieldMap = {
  testFraction: "test_fraction",
  trainingFraction: "training_fraction",
  validationFraction: "validation_fraction",
};

const TrainingPipeline_InputDataConfig_GcsDestinationFields: FieldMap = {
  outputUriPrefix: "output_uri_prefix",
};

const TrainingPipeline_InputDataConfig_PredefinedSplitFields: FieldMap = {
  key: "key",
};

const TrainingPipeline_InputDataConfig_StratifiedSplitFields: FieldMap = {
  key: "key",
  testFraction: "test_fraction",
  trainingFraction: "training_fraction",
  validationFraction: "validation_fraction",
...
const TrainingPipeline_InputDataConfigFields: FieldMap = {
...
const TrainingPipeline_ModelToUpload_BaseModelSource_GenieSourceFields: FieldMap = {
  baseModelUri: "base_model_uri",
};

const TrainingPipeline_ModelToUpload_BaseModelSource_ModelGardenSourceFields: FieldMap = {
  publicModelName: "public_model_name",
  skipHfModelCache: "skip_hf_model_cache",
  versionId: "version_id",
};

const TrainingPipeline_ModelToUpload_BaseModelSourceFields: FieldMap = {
  genieSource: {
...
const TrainingPipeline_ModelToUpload_CheckpointsFields: FieldMap = {
  checkpointId: "checkpoint_id",
  epoch: "epoch",
  step: "step",
};

const TrainingPipeline_ModelToUpload_ContainerSpec_EnvFields: FieldMap = {
  name: "name",
  value: "value",
};

const TrainingPipeline_ModelToUpload_ContainerSpec_GrpcPortsFields: FieldMap = {
  containerPort: "container_port",
};

const TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_ExecFields: FieldMap = {
  command: "command",
};

const TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_GrpcFields: FieldMap = {
  port: "port",
  service: "service",
};

const TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_HttpGetFields: FieldMap = {
  host: "host",
  httpHeaders: {
...
const TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_TcpSocketFields: FieldMap = {
  host: "host",
  port: "port",
};

const TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbeFields: FieldMap = {
  exec: {
    wireName: "exec",
    kind: "object",
...
const TrainingPipeline_ModelToUpload_ContainerSpecFields: FieldMap = {
  args: "args",
  command: "command",
...
const TrainingPipeline_ModelToUpload_DataStatsFields: FieldMap = {
...
const TrainingPipeline_ModelToUpload_DeployedModelsFields: FieldMap = {
  checkpointId: "checkpoint_id",
  deployedModelId: "deployed_model_id",
  endpoint: "endpoint",
};

const TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs_FeatureValueDomainFields: FieldMap = {
  maxValue: "max_value",
  minValue: "min_value",
...
const TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs_VisualizationFields: FieldMap = {
...
const TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_InputsFields: FieldMap = {
...
const TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_OutputsFields: FieldMap = {
...
const TrainingPipeline_ModelToUpload_ExplanationSpec_MetadataFields: FieldMap = {
...
const TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSourceFields: FieldMap = {
  uris: "uris",
};

const TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSourceFields: FieldMap = {
...
const TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_PresetsFields: FieldMap = {
  modality: "modality",
  query: "query",
};

const TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_ExamplesFields: FieldMap = {
  exampleGcsSource: {
...
const TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfigFields: FieldMap = {
  maxBlurSigma: "max_blur_sigma",
};

const TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigmaFields: FieldMap = {
  name: "name",
  sigma: "sigma",
};

const TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigmaFields: FieldMap = {
  noiseSigma: {
...
const TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfigFields: FieldMap = {
  featureNoiseSigma: {
...
const TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttributionFields: FieldMap = {
  blurBaselineConfig: {
...
const TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_SampledShapleyAttributionFields: FieldMap = {
  pathCount: "path_count",
};

const TrainingPipeline_ModelToUpload_ExplanationSpec_ParametersFields: FieldMap = {
  examples: {
    wireName: "examples",
    kind: "object",
...
const TrainingPipeline_ModelToUpload_ExplanationSpecFields: FieldMap = {
  metadata: {
    wireName: "metadata",
    kind: "object",
...
const TrainingPipeline_ModelToUpload_ModelSourceInfoFields: FieldMap = {
  copy: "copy",
  sourceType: "source_type",
};

const TrainingPipeline_ModelToUpload_OriginalModelInfoFields: FieldMap = {
  model: "model",
};

const TrainingPipeline_ModelToUpload_PredictSchemataFields: FieldMap = {
  instanceSchemaUri: "instance_schema_uri",
  parametersSchemaUri: "parameters_schema_uri",
  predictionSchemaUri: "prediction_schema_uri",
};

const TrainingPipeline_ModelToUpload_SupportedExportFormatsFields: FieldMap = {
  exportableContents: "exportable_contents",
  id: "id",
};

const TrainingPipeline_ModelToUploadFields: FieldMap = {
...
export interface TrainingPipelineConfig {
  ...
  error?: TrainingPipeline_Error | Computed<TrainingPipeline_Error>;
  /** Specifies Vertex AI owned input data to be used for training, and possibly evaluating, the Model. */
  inputDataConfig?: TrainingPipeline_InputDataConfig | Computed<TrainingPipeline_InputDataConfig>;
  ...
  modelToUpload?: TrainingPipeline_ModelToUpload | Computed<TrainingPipeline_ModelToUpload>;
...
export interface TrainingPipelineAttrs {
  /** Output only. Time when the TrainingPipeline was created. */
  createTime: string;
  /** Required. The user-defined name of this TrainingPipeline. */
  displayName: string;
  /** Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource. */
  encryptionSpec: TrainingPipeline_EncryptionSpec;
  ...
  endTime: string;
  /** The `Status` type defines a logical error model that is suitable for different programming environments, including REST APIs and RPC APIs. It is used by [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error code, error message, and error details. You can find out more about this error model and how to work with it in the [API Design Guide](https://cloud.google.com/apis/design/errors). */
  error: TrainingPipeline_Error;
  /** Specifies Vertex AI owned input data to be used for training, and possibly evaluating, the Model. */
  inputDataConfig: TrainingPipeline_InputDataConfig;
  /** The labels with user-defined metadata to organize TrainingPipelines. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels. */
  labels: Record<string, string>;
  /** Optional. The ID to use for the uploaded Model, which will become the final component of the model resource name. This value may be up to 63 characters, and valid characters are `[a-z0-9_-]`. The first character cannot be a number or hyphen. */
  modelId: string;
  /** A trained machine learning Model. */
  modelToUpload: TrainingPipeline_ModelToUpload;
...
export const TrainingPipeline: ResourceBinding<TrainingPipelineConfig, TrainingPipelineAttrs> = {
