...
export interface V1beta1ServingProfile_CmekConfig_EncryptionSpec {
  /** Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`. */
  kmsKeyName?: string | Computed<string>;
}

export interface V1beta1ServingProfile_CmekConfig {
  /** Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource. */
  encryptionSpec?: V1beta1ServingProfile_CmekConfig_EncryptionSpec | Computed<V1beta1ServingProfile_CmekConfig_EncryptionSpec>;
}

const V1beta1ServingProfile_CmekConfig_EncryptionSpecFields: FieldMap = {
  kmsKeyName: "kms_key_name",
};

const V1beta1ServingProfile_CmekConfigFields: FieldMap = {
  encryptionSpec: {
...
export interface V1beta1ServingProfileAttrs {
  /** Configuration for Customer-Managed Encryption Keys (CMEK). */
  cmekConfig: V1beta1ServingProfile_CmekConfig;
  /** Output only. Timestamp when the ServingProfile was created. */
  createTime: string;
  /** Optional. The description of the ServingProfile. */
  description: string;
...
export const V1beta1ServingProfile: ResourceBinding<V1beta1ServingProfileConfig, V1beta1ServingProfileAttrs> = {
  wireType: "google_aiplatform_v1beta1_serving_profile",
  fields: {
    cmekConfig: {
