// Code generated by `ubx sdk gen` from google_aiplatform_v1beta1_agent. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1Agent_Tools {
...
const V1beta1Agent_ToolsFields: FieldMap = {
  headers: "headers",
  name: "name",
  type: "type",
  url: "url",
...
export interface V1beta1AgentConfig {
...
export interface V1beta1AgentAttrs {
  ...
  /** Optional. The tools available to the agent. */
  tools: V1beta1Agent_Tools[];
  /** Output only. The time the agent was last updated. */
  updated: string;
}

export const V1beta1Agent: ResourceBinding<V1beta1AgentConfig, V1beta1AgentAttrs> = {
