...
export interface BatchPredictionJob_CompletionStats {
...
export interface BatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinity {
...
export interface BatchPredictionJob_DedicatedResources_MachineSpec {
  ...
  reservationAffinity?: BatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinity | Computed<BatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinity>;
  /** Immutable. The topology of the TPUs. Corresponds to the TPU topologies available from GKE. (Example: tpu_topology: "2x2x1"). */
  tpuTopology?: string | Computed<string>;
}

export interface BatchPredictionJob_DedicatedResources {
  /** Specification of a single machine. */
  machineSpec?: BatchPredictionJob_DedicatedResources_MachineSpec | Computed<BatchPredictionJob_DedicatedResources_MachineSpec>;
...
export interface BatchPredictionJob_EncryptionSpec {
  /** Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`. */
  kmsKeyName?: string | Computed<string>;
}

export interface BatchPredictionJob_Error {
...
export interface BatchPredictionJob_ExplanationSpec_Metadata {
  ...
  inputs?: Record<string, BatchPredictionJob_ExplanationSpec_Metadata_Inputs> | Computed<Record<string, BatchPredictionJob_ExplanationSpec_Metadata_Inputs>>;
  ...
  outputs?: Record<string, BatchPredictionJob_ExplanationSpec_Metadata_Outputs> | Computed<Record<string, BatchPredictionJob_ExplanationSpec_Metadata_Outputs>>;
}

export interface BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource {
  /** Required. Google Cloud Storage URI(-s) to the input file(s). May contain wildcards. For more information on wildcards, see https://cloud.google.com/storage/docs/wildcards. */
  uris?: string[] | Computed<string[]>;
}

export interface BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource {
  /** The format in which instances are given, if not specified, assume it's JSONL format. Currently only JSONL format is supported. */
  dataFormat?: string | Computed<string>;
  /** The Google Cloud Storage location for the input content. */
  gcsSource?: BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource | Computed<BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource>;
}

export interface BatchPredictionJob_ExplanationSpec_Parameters_Examples_Presets {
...
export interface BatchPredictionJob_ExplanationSpec_Parameters_Examples {
  /** The Cloud Storage input instances. */
  exampleGcsSource?: BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource | Computed<BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource>;
  ...
  presets?: BatchPredictionJob_ExplanationSpec_Parameters_Examples_Presets | Computed<BatchPredictionJob_ExplanationSpec_Parameters_Examples_Presets>;
}

export interface BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig {
...
export interface BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma {
  /** Noise sigma per feature. No noise is added to features that are not set. */
  noiseSigma?: BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma[] | Computed<BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma[]>;
}

export interface BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig {
  /** Noise sigma by features. Noise sigma represents the standard deviation of the gaussian kernel that will be used to add noise to interpolated inputs prior to computing gradients. */
  featureNoiseSigma?: BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma | Computed<BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma>;
...
export interface BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution {
  ...
  blurBaselineConfig?: BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig | Computed<BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig>;
  /** Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf */
  smoothGradConfig?: BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig | Computed<BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig>;
...
export interface BatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttribution {
...
export interface BatchPredictionJob_ExplanationSpec_Parameters {
  /** Example-based explainability that returns the nearest neighbors from the provided dataset. */
  examples?: BatchPredictionJob_ExplanationSpec_Parameters_Examples | Computed<BatchPredictionJob_ExplanationSpec_Parameters_Examples>;
  /** An attribution method that computes the Aumann-Shapley value taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1703.01365 */
  integratedGradientsAttribution?: BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution | Computed<BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution>;
  ...
  sampledShapleyAttribution?: BatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttribution | Computed<BatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttribution>;
  ...
  xraiAttribution?: BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution | Computed<BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution>;
}

export interface BatchPredictionJob_ExplanationSpec {
  /** Metadata describing the Model's input and output for explanation. */
  metadata?: BatchPredictionJob_ExplanationSpec_Metadata | Computed<BatchPredictionJob_ExplanationSpec_Metadata>;
  /** Parameters to configure explaining for Model's predictions. */
  parameters?: BatchPredictionJob_ExplanationSpec_Parameters | Computed<BatchPredictionJob_ExplanationSpec_Parameters>;
}

export interface BatchPredictionJob_InputConfig_BigquerySource {
...
export interface BatchPredictionJob_InputConfig_VertexMultimodalDatasetSource {
...
export interface BatchPredictionJob_InputConfig {
  ...
  bigquerySource?: BatchPredictionJob_InputConfig_BigquerySource | Computed<BatchPredictionJob_InputConfig_BigquerySource>;
  /** The Google Cloud Storage location for the input content. */
  gcsSource?: BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource | Computed<BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource>;
  ...
  vertexMultimodalDatasetSource?: BatchPredictionJob_InputConfig_VertexMultimodalDatasetSource | Computed<BatchPredictionJob_InputConfig_VertexMultimodalDatasetSource>;
}
...
export interface BatchPredictionJob_ManualBatchTuningParameters {
  /** Immutable. The number of the records (e.g. instances) of the operation given in each batch to a machine replica. Machine type, and size of a single record should be considered when setting this parameter, higher value speeds up the batch operation's execution, but too high value will result in a whole batch not fitting in a machine's memory, and the whole operation will fail. The default value is 64. */
  batchSize?: number | Computed<number>;
}

export interface BatchPredictionJob_OutputConfig_BigqueryDestination {
  /** Required. BigQuery URI to a project or table, up to 2000 characters long. When only the project is specified, the Dataset and Table is created. When the full table reference is specified, the Dataset must exist and table must not exist. Accepted forms: * BigQuery path. For example: `bq://projectId` or `bq://projectId.bqDatasetId` or `bq://projectId.bqDatasetId.bqTableId`. */
  outputUri?: string | Computed<string>;
}

export interface BatchPredictionJob_OutputConfig_GcsDestination {
  /** Required. Google Cloud Storage URI to output directory. If the uri doesn't end with '/', a '/' will be automatically appended. The directory is created if it doesn't exist. */
  outputUriPrefix?: string | Computed<string>;
}

export interface BatchPredictionJob_OutputConfig_VertexMultimodalDatasetDestination {
  /** The BigQuery location for the output content. */
  bigqueryDestination?: BatchPredictionJob_OutputConfig_BigqueryDestination | Computed<BatchPredictionJob_OutputConfig_BigqueryDestination>;
...
export interface BatchPredictionJob_OutputConfig {
  ...
  gcsDestination?: BatchPredictionJob_OutputConfig_GcsDestination | Computed<BatchPredictionJob_OutputConfig_GcsDestination>;
  ...
  vertexMultimodalDatasetDestination?: BatchPredictionJob_OutputConfig_VertexMultimodalDatasetDestination | Computed<BatchPredictionJob_OutputConfig_VertexMultimodalDatasetDestination>;
}
...
export interface BatchPredictionJob_ResourcesConsumed {
...
export interface BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Exec {
  /** Command is the command line to execute inside the container, the working directory for the command is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy. */
  command?: string[] | Computed<string[]>;
}

export interface BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Grpc {
...
export interface BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGet {
  ...
  httpHeaders?: BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_Env[] | Computed<BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_Env[]>;
...
export interface BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocket {
...
export interface BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe {
  /** ExecAction specifies a command to execute. */
  exec?: BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Exec | Computed<BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Exec>;
  ...
  grpc?: BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Grpc | Computed<BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Grpc>;
  /** HttpGetAction describes an action based on HTTP Get requests. */
  httpGet?: BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGet | Computed<BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGet>;
  ...
  tcpSocket?: BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocket | Computed<BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocket>;
  /** Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. Must be greater or equal to period_seconds. Maps to Kubernetes probe argument 'timeoutSeconds'. */
  timeoutSeconds?: number | Computed<number>;
}

export interface BatchPredictionJob_UnmanagedContainerModel_ContainerSpec {
  ...
  env?: BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_Env[] | Computed<BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_Env[]>;
  ...
  grpcPorts?: BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPorts[] | Computed<BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPorts[]>;
  /** Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic. */
  healthProbe?: BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe | Computed<BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe>;
  ...
  /** Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic. */
  livenessProbe?: BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe | Computed<BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe>;
  /** Immutable. List of ports to expose from the container. Vertex AI sends any prediction requests that it receives to the first port on this list. Vertex AI also sends [liveness and health checks](https://cloud.google.com/vertex-ai/docs/predictions/custom-container-requirements#liveness) to this port. If you do not specify this field, it defaults to following value: ```json [ { "containerPort": 8080 } ] ``` Vertex AI does not use ports other than the first one listed. This field corresponds to the `ports` field of the Kubernetes Containers [v1 core API](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#container-v1-core). */
  ports?: BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPorts[] | Computed<BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPorts[]>;
  ...
  /** Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic. */
  startupProbe?: BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe | Computed<BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe>;
}

export interface BatchPredictionJob_UnmanagedContainerModel_PredictSchemata {
...
export interface BatchPredictionJob_UnmanagedContainerModel {
  ...
  containerSpec?: BatchPredictionJob_UnmanagedContainerModel_ContainerSpec | Computed<BatchPredictionJob_UnmanagedContainerModel_ContainerSpec>;
  /** Contains the schemata used in Model's predictions and explanations via PredictionService.Predict, PredictionService.Explain and BatchPredictionJob. */
  predictSchemata?: BatchPredictionJob_UnmanagedContainerModel_PredictSchemata | Computed<BatchPredictionJob_UnmanagedContainerModel_PredictSchemata>;
}

const BatchPredictionJob_CompletionStatsFields: FieldMap = {
...
const BatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinityFields: FieldMap = {
  key: "key",
  reservationAffinityType: "reservation_affinity_type",
  values: "values",
};

const BatchPredictionJob_DedicatedResources_MachineSpecFields: FieldMap = {
...
const BatchPredictionJob_DedicatedResourcesFields: FieldMap = {
  machineSpec: {
...
const BatchPredictionJob_EncryptionSpecFields: FieldMap = {
  kmsKeyName: "kms_key_name",
};

const BatchPredictionJob_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const BatchPredictionJob_ExplanationSpec_Metadata_Inputs_FeatureValueDomainFields: FieldMap = {
  maxValue: "max_value",
  minValue: "min_value",
...
const BatchPredictionJob_ExplanationSpec_Metadata_Inputs_VisualizationFields: FieldMap = {
...
const BatchPredictionJob_ExplanationSpec_Metadata_InputsFields: FieldMap = {
...
const BatchPredictionJob_ExplanationSpec_Metadata_OutputsFields: FieldMap = {
...
const BatchPredictionJob_ExplanationSpec_MetadataFields: FieldMap = {
...
const BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSourceFields: FieldMap = {
  uris: "uris",
};

const BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSourceFields: FieldMap = {
...
const BatchPredictionJob_ExplanationSpec_Parameters_Examples_PresetsFields: FieldMap = {
  modality: "modality",
  query: "query",
};

const BatchPredictionJob_ExplanationSpec_Parameters_ExamplesFields: FieldMap = {
  exampleGcsSource: {
...
const BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfigFields: FieldMap = {
  maxBlurSigma: "max_blur_sigma",
};

const BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigmaFields: FieldMap = {
  name: "name",
  sigma: "sigma",
};

const BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigmaFields: FieldMap = {
  noiseSigma: {
...
const BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfigFields: FieldMap = {
  featureNoiseSigma: {
...
const BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttributionFields: FieldMap = {
  blurBaselineConfig: {
...
const BatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttributionFields: FieldMap = {
  pathCount: "path_count",
};

const BatchPredictionJob_ExplanationSpec_ParametersFields: FieldMap = {
  examples: {
    wireName: "examples",
    kind: "object",
...
const BatchPredictionJob_ExplanationSpecFields: FieldMap = {
  metadata: {
    wireName: "metadata",
    kind: "object",
...
const BatchPredictionJob_InputConfig_BigquerySourceFields: FieldMap = {
  inputUri: "input_uri",
};

const BatchPredictionJob_InputConfig_VertexMultimodalDatasetSourceFields: FieldMap = {
  datasetName: "dataset_name",
};

const BatchPredictionJob_InputConfigFields: FieldMap = {
  bigquerySource: {
...
const BatchPredictionJob_InstanceConfigFields: FieldMap = {
...
const BatchPredictionJob_ManualBatchTuningParametersFields: FieldMap = {
  batchSize: "batch_size",
};

const BatchPredictionJob_OutputConfig_BigqueryDestinationFields: FieldMap = {
  outputUri: "output_uri",
};

const BatchPredictionJob_OutputConfig_GcsDestinationFields: FieldMap = {
  outputUriPrefix: "output_uri_prefix",
};

const BatchPredictionJob_OutputConfig_VertexMultimodalDatasetDestinationFields: FieldMap = {
  bigqueryDestination: {
...
const BatchPredictionJob_OutputConfigFields: FieldMap = {
  bigqueryDestination: {
    wireName: "bigquery_destination",
    kind: "object",
    fields: BatchPredictionJob_OutputConfig_BigqueryDestinationFields,
...
const BatchPredictionJob_OutputInfoFields: FieldMap = {
...
const BatchPredictionJob_ResourcesConsumedFields: FieldMap = {
  replicaHours: "replica_hours",
};

const BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_EnvFields: FieldMap = {
  name: "name",
  value: "value",
};

const BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPortsFields: FieldMap = {
  containerPort: "container_port",
};

const BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_ExecFields: FieldMap = {
  command: "command",
};

const BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_GrpcFields: FieldMap = {
  port: "port",
  service: "service",
};

const BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGetFields: FieldMap = {
  host: "host",
  httpHeaders: {
...
const BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocketFields: FieldMap = {
  host: "host",
  port: "port",
};

const BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbeFields: FieldMap = {
  exec: {
    wireName: "exec",
    kind: "object",
...
const BatchPredictionJob_UnmanagedContainerModel_ContainerSpecFields: FieldMap = {
  args: "args",
  command: "command",
...
const BatchPredictionJob_UnmanagedContainerModel_PredictSchemataFields: FieldMap = {
  instanceSchemaUri: "instance_schema_uri",
  parametersSchemaUri: "parameters_schema_uri",
  predictionSchemaUri: "prediction_schema_uri",
};

const BatchPredictionJob_UnmanagedContainerModelFields: FieldMap = {
...
export interface BatchPredictionJobConfig {
  /** Success and error statistics of processing multiple entities (for example, DataItems or structured data rows) in batch. */
  completionStats?: BatchPredictionJob_CompletionStats | Computed<BatchPredictionJob_CompletionStats>;
  /** Output only. Time when the BatchPredictionJob was created. */
  createTime?: string | Computed<string>;
  /** A description of resources that are used for performing batch operations, are dedicated to a Model, and need manual configuration. */
  dedicatedResources?: BatchPredictionJob_DedicatedResources | Computed<BatchPredictionJob_DedicatedResources>;
  ...
  encryptionSpec?: BatchPredictionJob_EncryptionSpec | Computed<BatchPredictionJob_EncryptionSpec>;
  ...
  error?: BatchPredictionJob_Error | Computed<BatchPredictionJob_Error>;
  /** Specification of Model explanation. */
  explanationSpec?: BatchPredictionJob_ExplanationSpec | Computed<BatchPredictionJob_ExplanationSpec>;
  ...
  inputConfig?: BatchPredictionJob_InputConfig | Computed<BatchPredictionJob_InputConfig>;
  /** Configuration defining how to transform batch prediction input instances to the instances that the Model accepts. */
  instanceConfig?: BatchPredictionJob_InstanceConfig | Computed<BatchPredictionJob_InstanceConfig>;
  /** The labels with user-defined metadata to organize BatchPredictionJobs. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels. */
  labels?: Record<string, string> | Computed<Record<string, string>>;
  /** Manual batch tuning parameters. */
  manualBatchTuningParameters?: BatchPredictionJob_ManualBatchTuningParameters | Computed<BatchPredictionJob_ManualBatchTuningParameters>;
  ...
  outputConfig?: BatchPredictionJob_OutputConfig | Computed<BatchPredictionJob_OutputConfig>;
  /** Further describes this job's output. Supplements output_config. */
  outputInfo?: BatchPredictionJob_OutputInfo | Computed<BatchPredictionJob_OutputInfo>;
  ...
  partialFailures?: BatchPredictionJob_Error[] | Computed<BatchPredictionJob_Error[]>;
  /** Statistics information about resource consumption. */
  resourcesConsumed?: BatchPredictionJob_ResourcesConsumed | Computed<BatchPredictionJob_ResourcesConsumed>;
  ...
  unmanagedContainerModel?: BatchPredictionJob_UnmanagedContainerModel | Computed<BatchPredictionJob_UnmanagedContainerModel>;
  /** Output only. Time when the BatchPredictionJob was most recently updated. */
  updateTime?: string | Computed<string>;
}

export interface BatchPredictionJobAttrs {
  /** Success and error statistics of processing multiple entities (for example, DataItems or structured data rows) in batch. */
  completionStats: BatchPredictionJob_CompletionStats;
  /** Output only. Time when the BatchPredictionJob was created. */
  createTime: string;
  /** A description of resources that are used for performing batch operations, are dedicated to a Model, and need manual configuration. */
  dedicatedResources: BatchPredictionJob_DedicatedResources;
  /** For custom-trained Models and AutoML Tabular Models, the container of the DeployedModel instances will send `stderr` and `stdout` streams to Cloud Logging by default. Please note that the logs incur cost, which are subject to [Cloud Logging pricing](https://cloud.google.com/logging/pricing). User can disable container logging by setting this flag to true. */
  disableContainerLogging: boolean;
  /** Required. The user-defined name of this BatchPredictionJob. */
  displayName: string;
  /** Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource. */
  encryptionSpec: BatchPredictionJob_EncryptionSpec;
  /** Output only. Time when the BatchPredictionJob entered any of the following states: `JOB_STATE_SUCCEEDED`, `JOB_STATE_FAILED`, `JOB_STATE_CANCELLED`. */
  endTime: string;
  /** The `Status` type defines a logical error model that is suitable for different programming environments, including REST APIs and RPC APIs. It is used by [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error code, error message, and error details. You can find out more about this error model and how to work with it in the [API Design Guide](https://cloud.google.com/apis/design/errors). */
  error: BatchPredictionJob_Error;
  /** Specification of Model explanation. */
  explanationSpec: BatchPredictionJob_ExplanationSpec;
  /** Generate explanation with the batch prediction results. When set to `true`, the batch prediction output changes based on the `predictions_format` field of the BatchPredictionJob.output_config object: * `bigquery`: output includes a column named `explanation`. The value is a struct that conforms to the Explanation object. * `jsonl`: The JSON objects on each line include an additional entry keyed `explanation`. The value of the entry is a JSON object that conforms to the Explanation object. * `csv`: Generating explanations for CSV format is not supported. If this field is set to true, either the Model.explanation_spec or explanation_spec must be populated. */
  ...
  /** Manual batch tuning parameters. */
  manualBatchTuningParameters: BatchPredictionJob_ManualBatchTuningParameters;
  /** The name of the Model resource that produces the predictions via this job, must share the same ancestor Location. Starting this job has no impact on any existing deployments of the Model and their resources. Exactly one of model, unmanaged_container_model, or endpoint must be set. The model resource name may contain version id or version alias to specify the version. Example: `projects/{project}/locations/{location}/models/{model}@2` or `projects/{project}/locations/{location}/models/{model}@golden` if no version is specified, the default version will be deployed. The model resource could also be a publisher model. Example: `publishers/{publisher}/models/{model}` or `projects/{project}/locations/{location}/publishers/{publisher}/models/{model}` */
  model: string;
  /** The parameters that govern the predictions. The schema of the parameters may be specified via the Model's PredictSchemata's parameters_schema_uri. */
  ...
  /** Output only. Partial failures encountered. For example, single files that can't be read. This field never exceeds 20 entries. Status details fields contain standard Google Cloud error details. */
  partialFailures: BatchPredictionJob_Error[];
  /** Statistics information about resource consumption. */
  resourcesConsumed: BatchPredictionJob_ResourcesConsumed;
  /** Output only. Reserved for future use. */
  ...
  state: string;
  /** Contains model information necessary to perform batch prediction without requiring a full model import. */
  unmanagedContainerModel: BatchPredictionJob_UnmanagedContainerModel;
  /** Output only. Time when the BatchPredictionJob was most recently updated. */
  updateTime: string;
}

export const BatchPredictionJob: ResourceBinding<BatchPredictionJobConfig, BatchPredictionJobAttrs> = {
