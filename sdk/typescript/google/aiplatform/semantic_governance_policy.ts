...
export interface SemanticGovernancePolicy_AgentResponseCustomization {
...
const SemanticGovernancePolicy_AgentResponseCustomizationFields: FieldMap = {
...
export interface SemanticGovernancePolicyConfig {
  ...
  agentResponseCustomization?: SemanticGovernancePolicy_AgentResponseCustomization | Computed<SemanticGovernancePolicy_AgentResponseCustomization>;
...
export interface SemanticGovernancePolicyAttrs {
  ...
  /** Customizes the agent's response to the end user when a `SemanticGovernancePolicy` is evaluated (for example, with a custom message shown on denial). */
  agentResponseCustomization: SemanticGovernancePolicy_AgentResponseCustomization;
...
export const SemanticGovernancePolicy: ResourceBinding<SemanticGovernancePolicyConfig, SemanticGovernancePolicyAttrs> = {
  ...
  fields: {
    ...
    agentResponseCustomization: {
      ...
      kind: "object",
      fields: SemanticGovernancePolicy_AgentResponseCustomizationFields,
    },
