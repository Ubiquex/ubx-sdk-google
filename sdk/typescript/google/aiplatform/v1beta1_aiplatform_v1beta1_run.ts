// Code generated by `ubx sdk gen` from google_aiplatform_v1beta1_aiplatform_v1beta1_run. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1AiplatformV1beta1RunConfig {
...
export interface V1beta1AiplatformV1beta1RunAttrs {
  /** Output only. Timestamp when this TensorboardRun was created. */
  createTime: string;
  /** Description of this TensorboardRun. */
  description: string;
...
export const V1beta1AiplatformV1beta1Run: ResourceBinding<V1beta1AiplatformV1beta1RunConfig, V1beta1AiplatformV1beta1RunAttrs> = {
  wireType: "google_aiplatform_v1beta1_aiplatform_v1beta1_run",
  fields: {
