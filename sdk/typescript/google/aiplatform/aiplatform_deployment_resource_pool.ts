// Code generated by `ubx sdk gen` from google_aiplatform_aiplatform_deployment_resource_pool. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AiplatformDeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecs {
  metricName?: string | Computed<string>;
  target?: number | Computed<number>;
}

export interface AiplatformDeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinity {
...
export interface AiplatformDeploymentResourcePool_DedicatedResources_MachineSpec {
  ...
  reservationAffinity?: AiplatformDeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinity | Computed<AiplatformDeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinity>;
  /** Immutable. The topology of the TPUs. Corresponds to the TPU topologies available from GKE. (Example: tpu_topology: "2x2x1"). */
  tpuTopology?: string | Computed<string>;
}

export interface AiplatformDeploymentResourcePool_DedicatedResources {
  ...
  autoscalingMetricSpecs?: AiplatformDeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecs[] | Computed<AiplatformDeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecs[]>;
  /** Specification of a single machine. */
  machineSpec?: AiplatformDeploymentResourcePool_DedicatedResources_MachineSpec | Computed<AiplatformDeploymentResourcePool_DedicatedResources_MachineSpec>;
...
export interface AiplatformDeploymentResourcePool_DeploymentResourcePool_EncryptionSpec {
  /** Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`. */
  kmsKeyName?: string | Computed<string>;
}

export interface AiplatformDeploymentResourcePool_DeploymentResourcePool {
  ...
  dedicatedResources?: AiplatformDeploymentResourcePool_DedicatedResources | Computed<AiplatformDeploymentResourcePool_DedicatedResources>;
  ...
  encryptionSpec?: AiplatformDeploymentResourcePool_DeploymentResourcePool_EncryptionSpec | Computed<AiplatformDeploymentResourcePool_DeploymentResourcePool_EncryptionSpec>;
...
const AiplatformDeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecsFields: FieldMap = {
  metricName: "metric_name",
  target: "target",
};

const AiplatformDeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinityFields: FieldMap = {
  key: "key",
  reservationAffinityType: "reservation_affinity_type",
  values: "values",
};

const AiplatformDeploymentResourcePool_DedicatedResources_MachineSpecFields: FieldMap = {
  ...
  reservationAffinity: {
    ...
    kind: "object",
    fields: AiplatformDeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinityFields,
  },
  tpuTopology: "tpu_topology",
};

const AiplatformDeploymentResourcePool_DedicatedResourcesFields: FieldMap = {
  autoscalingMetricSpecs: {
    wireName: "autoscaling_metric_specs",
    kind: "list",
    fields: AiplatformDeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecsFields,
  },
  machineSpec: {
    wireName: "machine_spec",
    kind: "object",
    fields: AiplatformDeploymentResourcePool_DedicatedResources_MachineSpecFields,
  },
...
const AiplatformDeploymentResourcePool_DeploymentResourcePool_EncryptionSpecFields: FieldMap = {
  kmsKeyName: "kms_key_name",
};

const AiplatformDeploymentResourcePool_DeploymentResourcePoolFields: FieldMap = {
  createTime: "create_time",
  dedicatedResources: {
    wireName: "dedicated_resources",
    kind: "object",
    fields: AiplatformDeploymentResourcePool_DedicatedResourcesFields,
  },
  disableContainerLogging: "disable_container_logging",
  encryptionSpec: {
    wireName: "encryption_spec",
    kind: "object",
    fields: AiplatformDeploymentResourcePool_DeploymentResourcePool_EncryptionSpecFields,
  },
  name: "name",
...
export interface AiplatformDeploymentResourcePoolConfig {
  /** A description of resources that can be shared by multiple DeployedModels, whose underlying specification consists of a DedicatedResources. */
  deploymentResourcePool?: AiplatformDeploymentResourcePool_DeploymentResourcePool | Computed<AiplatformDeploymentResourcePool_DeploymentResourcePool>;
...
export interface AiplatformDeploymentResourcePoolAttrs {
  /** Output only. Timestamp when this DeploymentResourcePool was created. */
  createTime: string;
  /** A description of resources that are dedicated to a DeployedModel or DeployedIndex, and that need a higher degree of manual configuration. */
  dedicatedResources: AiplatformDeploymentResourcePool_DedicatedResources;
  /** A description of resources that can be shared by multiple DeployedModels, whose underlying specification consists of a DedicatedResources. */
  deploymentResourcePool: AiplatformDeploymentResourcePool_DeploymentResourcePool;
  /** Required. The ID to use for the DeploymentResourcePool, which will become the final component of the DeploymentResourcePool's resource name. The maximum length is 63 characters, and valid characters are `/^[a-z]([a-z0-9-]{0,61}[a-z0-9])?$/`. */
  deploymentResourcePoolId: string;
  /** If the DeploymentResourcePool is deployed with custom-trained Models or AutoML Tabular Models, the container(s) of the DeploymentResourcePool will send `stderr` and `stdout` streams to Cloud Logging by default. Please note that the logs incur cost, which are subject to [Cloud Logging pricing](https://cloud.google.com/logging/pricing). User can disable container logging by setting this flag to true. */
  disableContainerLogging: boolean;
  /** Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource. */
  encryptionSpec: AiplatformDeploymentResourcePool_DeploymentResourcePool_EncryptionSpec;
  /** Immutable. The resource name of the DeploymentResourcePool. Format: `projects/{project}/locations/{location}/deploymentResourcePools/{deployment_resource_pool}` */
  name: string;
  /** Output only. Reserved for future use. */
...
export const AiplatformDeploymentResourcePool: ResourceBinding<AiplatformDeploymentResourcePoolConfig, AiplatformDeploymentResourcePoolAttrs> = {
  wireType: "google_aiplatform_aiplatform_deployment_resource_pool",
  fields: {
    deploymentResourcePool: {
      wireName: "deployment_resource_pool",
      kind: "object",
      fields: AiplatformDeploymentResourcePool_DeploymentResourcePoolFields,
    },
