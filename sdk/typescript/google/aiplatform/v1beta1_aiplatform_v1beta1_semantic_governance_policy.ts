// Code generated by `ubx sdk gen` from google_aiplatform_v1beta1_aiplatform_v1beta1_semantic_governance_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1AiplatformV1beta1SemanticGovernancePolicy_McpTools {
  mcpServer?: string | Computed<string>;
  tools?: string[] | Computed<string[]>;
}

const V1beta1AiplatformV1beta1SemanticGovernancePolicy_McpToolsFields: FieldMap = {
  mcpServer: "mcp_server",
  tools: "tools",
};

export interface V1beta1AiplatformV1beta1SemanticGovernancePolicyConfig {
  ...
  mcpTools?: V1beta1AiplatformV1beta1SemanticGovernancePolicy_McpTools[] | Computed<V1beta1AiplatformV1beta1SemanticGovernancePolicy_McpTools[]>;
...
export interface V1beta1AiplatformV1beta1SemanticGovernancePolicyAttrs {
  /** Required. The name of the agent in Agent Registry that is affected by this policy. */
  agent: string;
  /** Output only. Represents the principal of the agent, used by the Policy Decision Point (PDP) for governance checks. For more information, see https://docs.cloud.google.com/agent-builder/agent-engine/agent-identity Format: `principal://TRUST_DOMAIN/NAMESPACE/AGENT_NAME` Example: `principal://agents.global.org-ORGANIZATION_ID.system.id.goog/resources/aiplatform/projects/PROJECT_NUMBER/locations/LOCATION/reasoningEngines/AGENT_ENGINE_ID` */
  ...
  etag: string;
  /** Optional. The McpTools that are affected by this policy. */
  mcpTools: V1beta1AiplatformV1beta1SemanticGovernancePolicy_McpTools[];
  /** Identifier. Resource name of the SemanticGovernancePolicy. */
  name: string;
  /** Required. The natural language constraint of the SemanticGovernancePolicy. */
...
export const V1beta1AiplatformV1beta1SemanticGovernancePolicy: ResourceBinding<V1beta1AiplatformV1beta1SemanticGovernancePolicyConfig, V1beta1AiplatformV1beta1SemanticGovernancePolicyAttrs> = {
  wireType: "google_aiplatform_v1beta1_aiplatform_v1beta1_semantic_governance_policy",
  fields: {
    agent: "agent",
    ...
    mcpTools: {
      wireName: "mcp_tools",
      kind: "list",
      fields: V1beta1AiplatformV1beta1SemanticGovernancePolicy_McpToolsFields,
    },
    name: "name",
