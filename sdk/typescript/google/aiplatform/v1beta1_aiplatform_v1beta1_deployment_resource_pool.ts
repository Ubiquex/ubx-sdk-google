...
export interface V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecs {
...
export interface V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_FlexStart {
...
export interface V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinity {
...
export interface V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpec {
  ...
  reservationAffinity?: V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinity | Computed<V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinity>;
  /** Immutable. The topology of the TPUs. Corresponds to the TPU topologies available from GKE. (Example: tpu_topology: "2x2x1"). */
  tpuTopology?: string | Computed<string>;
}

export interface V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_ScaleToZeroSpec {
...
export interface V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources {
  ...
  autoscalingMetricSpecs?: V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecs[] | Computed<V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecs[]>;
  /** FlexStart is used to schedule the deployment workload on DWS resource. It contains the max duration of the deployment. */
  flexStart?: V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_FlexStart | Computed<V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_FlexStart>;
  ...
  machineSpec?: V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpec | Computed<V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpec>;
  ...
  scaleToZeroSpec?: V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_ScaleToZeroSpec | Computed<V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_ScaleToZeroSpec>;
...
export interface V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool_EncryptionSpec {
  /** Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`. */
  kmsKeyName?: string | Computed<string>;
}

export interface V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool {
  ...
  dedicatedResources?: V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources | Computed<V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources>;
  ...
  encryptionSpec?: V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool_EncryptionSpec | Computed<V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool_EncryptionSpec>;
...
const V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecsFields: FieldMap = {
  metricName: "metric_name",
  monitoredResourceLabels: "monitored_resource_labels",
  target: "target",
};

const V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_FlexStartFields: FieldMap = {
  maxRuntimeDuration: "max_runtime_duration",
};

const V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinityFields: FieldMap = {
  key: "key",
  reservationAffinityType: "reservation_affinity_type",
  values: "values",
};

const V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpecFields: FieldMap = {
...
const V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_ScaleToZeroSpecFields: FieldMap = {
  idleScaledownPeriod: "idle_scaledown_period",
  minScaleupPeriod: "min_scaleup_period",
};

const V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResourcesFields: FieldMap = {
...
const V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool_EncryptionSpecFields: FieldMap = {
  kmsKeyName: "kms_key_name",
};

const V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePoolFields: FieldMap = {
...
export interface V1beta1AiplatformV1beta1DeploymentResourcePoolConfig {
  /** A description of resources that can be shared by multiple DeployedModels, whose underlying specification consists of a DedicatedResources. */
  deploymentResourcePool?: V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool | Computed<V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool>;
...
export interface V1beta1AiplatformV1beta1DeploymentResourcePoolAttrs {
  /** Output only. Timestamp when this DeploymentResourcePool was created. */
  createTime: string;
  /** A description of resources that are dedicated to a DeployedModel or DeployedIndex, and that need a higher degree of manual configuration. */
  dedicatedResources: V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources;
  /** A description of resources that can be shared by multiple DeployedModels, whose underlying specification consists of a DedicatedResources. */
  deploymentResourcePool: V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool;
  /** Required. The ID to use for the DeploymentResourcePool, which will become the final component of the DeploymentResourcePool's resource name. The maximum length is 63 characters, and valid characters are `/^[a-z]([a-z0-9-]{0,61}[a-z0-9])?$/`. */
  deploymentResourcePoolId: string;
  /** If the DeploymentResourcePool is deployed with custom-trained Models or AutoML Tabular Models, the container(s) of the DeploymentResourcePool will send `stderr` and `stdout` streams to Cloud Logging by default. Please note that the logs incur cost, which are subject to [Cloud Logging pricing](https://cloud.google.com/logging/pricing). User can disable container logging by setting this flag to true. */
  disableContainerLogging: boolean;
  /** Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource. */
  encryptionSpec: V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool_EncryptionSpec;
  /** Immutable. The resource name of the DeploymentResourcePool. Format: `projects/{project}/locations/{location}/deploymentResourcePools/{deployment_resource_pool}` */
  name: string;
  /** Output only. Reserved for future use. */
...
export const V1beta1AiplatformV1beta1DeploymentResourcePool: ResourceBinding<V1beta1AiplatformV1beta1DeploymentResourcePoolConfig, V1beta1AiplatformV1beta1DeploymentResourcePoolAttrs> = {
