...
export interface V1beta1SessionConfig {
...
export interface V1beta1SessionAttrs {
...
export const V1beta1Session: ResourceBinding<V1beta1SessionConfig, V1beta1SessionAttrs> = {
