...
export interface V1beta1RagCorpora_CorpusStatus {
...
export interface V1beta1RagCorpora_CorpusTypeConfig_MemoryCorpus_LlmParser {
...
export interface V1beta1RagCorpora_CorpusTypeConfig_MemoryCorpus {
  /** Specifies the LLM parsing for RagFiles. */
  llmParser?: V1beta1RagCorpora_CorpusTypeConfig_MemoryCorpus_LlmParser | Computed<V1beta1RagCorpora_CorpusTypeConfig_MemoryCorpus_LlmParser>;
}

export interface V1beta1RagCorpora_CorpusTypeConfig {
  /** Config for the document corpus. */
  documentCorpus?: unknown | Computed<unknown>;
  /** Config for the memory corpus. */
  memoryCorpus?: V1beta1RagCorpora_CorpusTypeConfig_MemoryCorpus | Computed<V1beta1RagCorpora_CorpusTypeConfig_MemoryCorpus>;
}

export interface V1beta1RagCorpora_EncryptionSpec {
  /** Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`. */
  kmsKeyName?: string | Computed<string>;
}

export interface V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_DenseEmbeddingModelPredictionEndpoint {
...
export interface V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_SparseEmbeddingConfig_Bm25 {
...
export interface V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_SparseEmbeddingConfig {
  /** Message for BM25 parameters. */
  bm25?: V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_SparseEmbeddingConfig_Bm25 | Computed<V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_SparseEmbeddingConfig_Bm25>;
}

export interface V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig {
  /** Config representing a model hosted on Vertex Prediction Endpoint. */
  denseEmbeddingModelPredictionEndpoint?: V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_DenseEmbeddingModelPredictionEndpoint | Computed<V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_DenseEmbeddingModelPredictionEndpoint>;
  /** Configuration for sparse emebdding generation. */
  sparseEmbeddingConfig?: V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_SparseEmbeddingConfig | Computed<V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_SparseEmbeddingConfig>;
}

export interface V1beta1RagCorpora_RagEmbeddingModelConfig {
  /** Config for hybrid search. */
  hybridSearchConfig?: V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig | Computed<V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig>;
  /** Config representing a model hosted on Vertex Prediction Endpoint. */
  vertexPredictionEndpoint?: V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_DenseEmbeddingModelPredictionEndpoint | Computed<V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_DenseEmbeddingModelPredictionEndpoint>;
}

export interface V1beta1RagCorpora_RagVectorDbConfig_ApiAuth_ApiKeyConfig {
...
export interface V1beta1RagCorpora_RagVectorDbConfig_ApiAuth {
  /** The API secret. */
  apiKeyConfig?: V1beta1RagCorpora_RagVectorDbConfig_ApiAuth_ApiKeyConfig | Computed<V1beta1RagCorpora_RagVectorDbConfig_ApiAuth_ApiKeyConfig>;
}

export interface V1beta1RagCorpora_RagVectorDbConfig_Pinecone {
  /** Pinecone index name. This value cannot be changed after it's set. */
  indexName?: string | Computed<string>;
}

export interface V1beta1RagCorpora_RagVectorDbConfig_RagManagedDb_Ann {
...
export interface V1beta1RagCorpora_RagVectorDbConfig_RagManagedDb {
  ...
  ann?: V1beta1RagCorpora_RagVectorDbConfig_RagManagedDb_Ann | Computed<V1beta1RagCorpora_RagVectorDbConfig_RagManagedDb_Ann>;
  /** Config for KNN search. */
  knn?: unknown | Computed<unknown>;
}

export interface V1beta1RagCorpora_RagVectorDbConfig_RagManagedVertexVectorSearch {
...
export interface V1beta1RagCorpora_RagVectorDbConfig_VertexFeatureStore {
...
export interface V1beta1RagCorpora_RagVectorDbConfig_VertexVectorSearch {
...
export interface V1beta1RagCorpora_RagVectorDbConfig_Weaviate {
...
export interface V1beta1RagCorpora_RagVectorDbConfig {
  /** The generic reusable api auth config. Deprecated. Please use AuthConfig (google/cloud/aiplatform/master/auth.proto) instead. */
  apiAuth?: V1beta1RagCorpora_RagVectorDbConfig_ApiAuth | Computed<V1beta1RagCorpora_RagVectorDbConfig_ApiAuth>;
  /** The config for the Pinecone. */
  pinecone?: V1beta1RagCorpora_RagVectorDbConfig_Pinecone | Computed<V1beta1RagCorpora_RagVectorDbConfig_Pinecone>;
  ...
  ragManagedDb?: V1beta1RagCorpora_RagVectorDbConfig_RagManagedDb | Computed<V1beta1RagCorpora_RagVectorDbConfig_RagManagedDb>;
  /** The config for the RAG-managed Vertex Vector Search 2.0. */
  ragManagedVertexVectorSearch?: V1beta1RagCorpora_RagVectorDbConfig_RagManagedVertexVectorSearch | Computed<V1beta1RagCorpora_RagVectorDbConfig_RagManagedVertexVectorSearch>;
  /** The config for the Vertex Feature Store. */
  vertexFeatureStore?: V1beta1RagCorpora_RagVectorDbConfig_VertexFeatureStore | Computed<V1beta1RagCorpora_RagVectorDbConfig_VertexFeatureStore>;
  /** The config for the Vertex Vector Search. */
  vertexVectorSearch?: V1beta1RagCorpora_RagVectorDbConfig_VertexVectorSearch | Computed<V1beta1RagCorpora_RagVectorDbConfig_VertexVectorSearch>;
  /** The config for the Weaviate. */
  weaviate?: V1beta1RagCorpora_RagVectorDbConfig_Weaviate | Computed<V1beta1RagCorpora_RagVectorDbConfig_Weaviate>;
}

export interface V1beta1RagCorpora_VertexAiSearchConfig {
...
const V1beta1RagCorpora_CorpusStatusFields: FieldMap = {
  errorStatus: "error_status",
  state: "state",
};

const V1beta1RagCorpora_CorpusTypeConfig_MemoryCorpus_LlmParserFields: FieldMap = {
...
const V1beta1RagCorpora_CorpusTypeConfig_MemoryCorpusFields: FieldMap = {
  llmParser: {
    wireName: "llm_parser",
    kind: "object",
...
const V1beta1RagCorpora_CorpusTypeConfigFields: FieldMap = {
...
const V1beta1RagCorpora_EncryptionSpecFields: FieldMap = {
  kmsKeyName: "kms_key_name",
};

const V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_DenseEmbeddingModelPredictionEndpointFields: FieldMap = {
  endpoint: "endpoint",
  model: "model",
  modelVersionId: "model_version_id",
};

const V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_SparseEmbeddingConfig_Bm25Fields: FieldMap = {
  b: "b",
  k1: "k1",
  multilingual: "multilingual",
};

const V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfig_SparseEmbeddingConfigFields: FieldMap = {
  bm25: {
    wireName: "bm25",
    kind: "object",
...
const V1beta1RagCorpora_RagEmbeddingModelConfig_HybridSearchConfigFields: FieldMap = {
...
const V1beta1RagCorpora_RagEmbeddingModelConfigFields: FieldMap = {
  hybridSearchConfig: {
...
const V1beta1RagCorpora_RagVectorDbConfig_ApiAuth_ApiKeyConfigFields: FieldMap = {
  apiKeySecretVersion: "api_key_secret_version",
  apiKeyString: "api_key_string",
};

const V1beta1RagCorpora_RagVectorDbConfig_ApiAuthFields: FieldMap = {
  apiKeyConfig: {
...
const V1beta1RagCorpora_RagVectorDbConfig_PineconeFields: FieldMap = {
  indexName: "index_name",
};

const V1beta1RagCorpora_RagVectorDbConfig_RagManagedDb_AnnFields: FieldMap = {
  leafCount: "leaf_count",
  treeDepth: "tree_depth",
};

const V1beta1RagCorpora_RagVectorDbConfig_RagManagedDbFields: FieldMap = {
  ann: {
    wireName: "ann",
    kind: "object",
...
const V1beta1RagCorpora_RagVectorDbConfig_RagManagedVertexVectorSearchFields: FieldMap = {
  collectionName: "collection_name",
};

const V1beta1RagCorpora_RagVectorDbConfig_VertexFeatureStoreFields: FieldMap = {
  featureViewResourceName: "feature_view_resource_name",
};

const V1beta1RagCorpora_RagVectorDbConfig_VertexVectorSearchFields: FieldMap = {
  index: "index",
  indexEndpoint: "index_endpoint",
};

const V1beta1RagCorpora_RagVectorDbConfig_WeaviateFields: FieldMap = {
  collectionName: "collection_name",
  httpEndpoint: "http_endpoint",
};

const V1beta1RagCorpora_RagVectorDbConfigFields: FieldMap = {
  apiAuth: {
    wireName: "api_auth",
    kind: "object",
...
const V1beta1RagCorpora_VertexAiSearchConfigFields: FieldMap = {
  servingConfig: "serving_config",
};

export interface V1beta1RagCorporaConfig {
  /** RagCorpus status. */
  ...
  vertexAiSearchConfig?: V1beta1RagCorpora_VertexAiSearchConfig | Computed<V1beta1RagCorpora_VertexAiSearchConfig>;
}

export interface V1beta1RagCorporaAttrs {
  /** RagCorpus status. */
  corpusStatus: V1beta1RagCorpora_CorpusStatus;
  /** The config for the corpus type of the RagCorpus. */
  corpusTypeConfig: V1beta1RagCorpora_CorpusTypeConfig;
  /** Output only. Timestamp when this RagCorpus was created. */
  createTime: string;
  /** Optional. The description of the RagCorpus. */
  description: string;
  ...
  displayName: string;
  /** Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource. */
  encryptionSpec: V1beta1RagCorpora_EncryptionSpec;
  /** Output only. The resource name of the RagCorpus. */
  name: string;
  /** Config for the embedding model to use for RAG. */
  ragEmbeddingModelConfig: V1beta1RagCorpora_RagEmbeddingModelConfig;
  /** Output only. Number of RagFiles in the RagCorpus. NOTE: This field is not populated in the response of VertexRagDataService.ListRagCorpora. */
  ragFilesCount: number;
  /** Config for the Vector DB to use for RAG. */
  ragVectorDbConfig: V1beta1RagCorpora_RagVectorDbConfig;
  /** Output only. Reserved for future use. */
  ...
  updateTime: string;
  /** Config for the Vector DB to use for RAG. */
  vectorDbConfig: V1beta1RagCorpora_RagVectorDbConfig;
  /** Config for the Vertex AI Search. */
  vertexAiSearchConfig: V1beta1RagCorpora_VertexAiSearchConfig;
}

export const V1beta1RagCorpora: ResourceBinding<V1beta1RagCorporaConfig, V1beta1RagCorporaAttrs> = {
