...
export interface V1beta1SandboxEnvironment_ConnectionInfo {
...
export interface V1beta1SandboxEnvironment_Spec_CodeExecutionEnvironment {
...
export interface V1beta1SandboxEnvironment_Spec {
  /** The code execution environment with customized settings. */
  codeExecutionEnvironment?: V1beta1SandboxEnvironment_Spec_CodeExecutionEnvironment | Computed<V1beta1SandboxEnvironment_Spec_CodeExecutionEnvironment>;
...
const V1beta1SandboxEnvironment_Spec_CodeExecutionEnvironmentFields: FieldMap = {
  codeLanguage: "code_language",
  machineConfig: "machine_config",
};

const V1beta1SandboxEnvironment_SpecFields: FieldMap = {
...
export interface V1beta1SandboxEnvironmentAttrs {
  /** The connection information of the SandboxEnvironment. */
  connectionInfo: V1beta1SandboxEnvironment_ConnectionInfo;
  /** Output only. The timestamp when this SandboxEnvironment was created. */
  createTime: string;
  /** Required. The display name of the SandboxEnvironment. */
  displayName: string;
  ...
  /** The specification of a SandboxEnvironment. */
  spec: V1beta1SandboxEnvironment_Spec;
  /** Output only. The runtime state of the SandboxEnvironment. */
  state: string;
  /** Optional. Input only. The TTL for the sandbox environment. The expiration time is computed: now + TTL. */
  ttl: string;
...
export const V1beta1SandboxEnvironment: ResourceBinding<V1beta1SandboxEnvironmentConfig, V1beta1SandboxEnvironmentAttrs> = {
