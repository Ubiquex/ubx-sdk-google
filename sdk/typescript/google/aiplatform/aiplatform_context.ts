...
export interface AiplatformContextConfig {
...
export interface AiplatformContextAttrs {
  /** Output only. Timestamp when this Context was created. */
  createTime: string;
  /** Description of the Context */
  description: string;
...
export const AiplatformContext: ResourceBinding<AiplatformContextConfig, AiplatformContextAttrs> = {
  wireType: "google_aiplatform_aiplatform_context",
  fields: {
