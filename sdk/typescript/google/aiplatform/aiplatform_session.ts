// Code generated by `ubx sdk gen` from google_aiplatform_aiplatform_session. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AiplatformSessionConfig {
...
export interface AiplatformSessionAttrs {
  /** Output only. Timestamp when the session was created. */
  createTime: string;
  /** Optional. The display name of the session. */
  displayName: string;
...
export const AiplatformSession: ResourceBinding<AiplatformSessionConfig, AiplatformSessionAttrs> = {
  wireType: "google_aiplatform_aiplatform_session",
  fields: {
