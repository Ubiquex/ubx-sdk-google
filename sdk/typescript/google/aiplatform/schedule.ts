...
export interface Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec {
  ...
  reservationAffinity?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec_ReservationAffinity | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec_ReservationAffinity>;
...
export interface Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfig {
...
export interface Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec {
  ...
  machineSpec?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec>;
  /** Network spec. */
  networkSpec?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_NetworkSpec | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_NetworkSpec>;
  /** Represents the spec of persistent disk and hyperdisk options. */
  persistentDiskSpec?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_PersistentDiskSpec | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_PersistentDiskSpec>;
  ...
  shieldedInstanceConfig?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfig | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfig>;
}
...
export interface Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_DirectNotebookSource {
...
export interface Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_Status {
...
export interface Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_WorkbenchRuntime_CustomContainerImage {
...
export interface Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_WorkbenchRuntime_VmImage {
...
export interface Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_WorkbenchRuntime {
  ...
  customContainerImage?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_WorkbenchRuntime_CustomContainerImage | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_WorkbenchRuntime_CustomContainerImage>;
  /** The definition of a Compute Engine VM image to run the notebook execution on. Mirrors `google.cloud.notebooks.v2.VmImage`. */
  vmImage?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_WorkbenchRuntime_VmImage | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_WorkbenchRuntime_VmImage>;
}
...
export interface Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob {
  ...
  customEnvironmentSpec?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec>;
  /** The Dataform Repository containing the input notebook. */
  dataformRepositorySource?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_DataformRepositorySource | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_DataformRepositorySource>;
  /** The content of the input notebook in ipynb format. */
  directNotebookSource?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_DirectNotebookSource | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_DirectNotebookSource>;
  /** The display name of the NotebookExecutionJob. The name can be up to 128 characters long and can consist of any UTF-8 characters. */
  displayName?: string | Computed<string>;
  /** Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource. */
  encryptionSpec?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_EncryptionSpec | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_EncryptionSpec>;
  /** Max running time of the execution job in seconds (default 86400s / 24 hrs). */
  executionTimeout?: string | Computed<string>;
  /** The user email to run the execution as. Only supported by Colab runtimes. */
  executionUser?: string | Computed<string>;
  /** The Cloud Storage uri for the input notebook. */
  gcsNotebookSource?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_GcsNotebookSource | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_GcsNotebookSource>;
  ...
  status?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_Status | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_Status>;
  /** Output only. Timestamp when this NotebookExecutionJob was most recently updated. */
  updateTime?: string | Computed<string>;
  /** Configuration for a Workbench Instances-based environment. */
  workbenchRuntime?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_WorkbenchRuntime | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_WorkbenchRuntime>;
}

export interface Schedule_CreateNotebookExecutionJobRequest {
  /** NotebookExecutionJob represents an instance of a notebook execution. */
  notebookExecutionJob?: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob | Computed<Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob>;
...
export interface Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_PipelineContext {
...
export interface Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail {
  /** Instance of a general context. */
  pipelineContext?: Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_PipelineContext | Computed<Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_PipelineContext>;
  /** Instance of a general context. */
  pipelineRunContext?: Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_PipelineContext | Computed<Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_PipelineContext>;
  /** Output only. The runtime details of the tasks under the pipeline. */
  taskDetails?: Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_TaskDetails[] | Computed<Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_TaskDetails[]>;
}
...
export interface Schedule_CreatePipelineJobRequest_PipelineJob_PscInterfaceConfig {
  ...
  dnsPeeringConfigs?: Schedule_CreatePipelineJobRequest_PipelineJob_PscInterfaceConfig_DnsPeeringConfigs[] | Computed<Schedule_CreatePipelineJobRequest_PipelineJob_PscInterfaceConfig_DnsPeeringConfigs[]>;
...
export interface Schedule_CreatePipelineJobRequest_PipelineJob_RuntimeConfig {
  ...
  inputArtifacts?: Record<string, Schedule_CreatePipelineJobRequest_PipelineJob_RuntimeConfig_InputArtifacts> | Computed<Record<string, Schedule_CreatePipelineJobRequest_PipelineJob_RuntimeConfig_InputArtifacts>>;
  ...
  parameters?: Record<string, Schedule_CreatePipelineJobRequest_PipelineJob_RuntimeConfig_Parameters> | Computed<Record<string, Schedule_CreatePipelineJobRequest_PipelineJob_RuntimeConfig_Parameters>>;
}
...
export interface Schedule_CreatePipelineJobRequest_PipelineJob {
  ...
  jobDetail?: Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail | Computed<Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail>;
  ...
  pscInterfaceConfig?: Schedule_CreatePipelineJobRequest_PipelineJob_PscInterfaceConfig | Computed<Schedule_CreatePipelineJobRequest_PipelineJob_PscInterfaceConfig>;
  /** A list of names for the reserved ip ranges under the VPC network that can be used for this Pipeline Job's workload. If set, we will deploy the Pipeline Job's workload within the provided ip ranges. Otherwise, the job will be deployed to any ip ranges under the provided VPC network. Example: ['vertex-ai-ip-range']. */
  reservedIpRanges?: string[] | Computed<string[]>;
  /** The runtime config of a PipelineJob. */
  runtimeConfig?: Schedule_CreatePipelineJobRequest_PipelineJob_RuntimeConfig | Computed<Schedule_CreatePipelineJobRequest_PipelineJob_RuntimeConfig>;
  ...
  templateMetadata?: Schedule_CreatePipelineJobRequest_PipelineJob_TemplateMetadata | Computed<Schedule_CreatePipelineJobRequest_PipelineJob_TemplateMetadata>;
...
export interface Schedule_CreatePipelineJobRequest {
  ...
  pipelineJob?: Schedule_CreatePipelineJobRequest_PipelineJob | Computed<Schedule_CreatePipelineJobRequest_PipelineJob>;
...
const Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfigFields: FieldMap = {
...
const Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_DirectNotebookSourceFields: FieldMap = {
  content: "content",
};
...
const Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_StatusFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_WorkbenchRuntime_CustomContainerImageFields: FieldMap = {
  repository: "repository",
  tag: "tag",
};

const Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_WorkbenchRuntime_VmImageFields: FieldMap = {
  family: "family",
  name: "name",
  project: "project",
};
...
const Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_PipelineContextFields: FieldMap = {
  createTime: "create_time",
...
const Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_TaskDetails_ExecutionFields: FieldMap = {
  createTime: "create_time",
  description: "description",
  displayName: "display_name",
  etag: "etag",
...
const Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_TaskDetails_ExecutorDetail_ContainerDetailFields: FieldMap = {
...
const Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_TaskDetails_ExecutorDetail_CustomJobDetailFields: FieldMap = {
  failedJobs: "failed_jobs",
  job: "job",
};

const Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_TaskDetails_ExecutorDetailFields: FieldMap = {
  containerDetail: {
...
const Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_TaskDetails_Inputs_ArtifactsFields: FieldMap = {
  createTime: "create_time",
  description: "description",
  displayName: "display_name",
  etag: "etag",
...
const Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_TaskDetails_InputsFields: FieldMap = {
  artifacts: {
    wireName: "artifacts",
    kind: "list",
...
const Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_TaskDetails_PipelineTaskStatusFields: FieldMap = {
  error: {
    wireName: "error",
    kind: "object",
    fields: Schedule_CreateNotebookExecutionJobRequest_NotebookExecutionJob_StatusFields,
...
const Schedule_CreatePipelineJobRequest_PipelineJob_JobDetail_TaskDetailsFields: FieldMap = {
  createTime: "create_time",
  endTime: "end_time",
  error: {
    wireName: "error",
...
const Schedule_CreatePipelineJobRequest_PipelineJob_JobDetailFields: FieldMap = {
  pipelineContext: {
...
const Schedule_CreatePipelineJobRequest_PipelineJob_RuntimeConfig_InputArtifactsFields: FieldMap = {
  artifactId: "artifact_id",
};

const Schedule_CreatePipelineJobRequest_PipelineJob_RuntimeConfig_ParametersFields: FieldMap = {
...
const Schedule_LastScheduledRunResponseFields: FieldMap = {
