...
export interface V1beta1AiplatformV1beta1FeedbackEntryConfig {
...
export interface V1beta1AiplatformV1beta1FeedbackEntryAttrs {
  /** Output only. The time at which the entry was created. */
  createTime: string;
  /** Optional. Additional key-value metadata associated with the feedback. */
...
export const V1beta1AiplatformV1beta1FeedbackEntry: ResourceBinding<V1beta1AiplatformV1beta1FeedbackEntryConfig, V1beta1AiplatformV1beta1FeedbackEntryAttrs> = {
