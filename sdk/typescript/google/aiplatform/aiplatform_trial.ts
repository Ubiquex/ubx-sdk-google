// Code generated by `ubx sdk gen` from google_aiplatform_aiplatform_trial. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AiplatformTrial_FinalMeasurement_Metrics {
  metricId?: string | Computed<string>;
  value?: number | Computed<number>;
}

export interface AiplatformTrial_FinalMeasurement {
  ...
  metrics?: AiplatformTrial_FinalMeasurement_Metrics[] | Computed<AiplatformTrial_FinalMeasurement_Metrics[]>;
...
export interface AiplatformTrial_Parameters {
  parameterId?: string | Computed<string>;
  value?: unknown | Computed<unknown>;
}

const AiplatformTrial_FinalMeasurement_MetricsFields: FieldMap = {
  metricId: "metric_id",
  value: "value",
};

const AiplatformTrial_FinalMeasurementFields: FieldMap = {
  elapsedDuration: "elapsed_duration",
  metrics: {
    wireName: "metrics",
    kind: "list",
    fields: AiplatformTrial_FinalMeasurement_MetricsFields,
  },
  stepCount: "step_count",
};

const AiplatformTrial_ParametersFields: FieldMap = {
  parameterId: "parameter_id",
  value: "value",
};

export interface AiplatformTrialConfig {
  ...
  finalMeasurement?: AiplatformTrial_FinalMeasurement | Computed<AiplatformTrial_FinalMeasurement>;
  ...
  measurements?: AiplatformTrial_FinalMeasurement[] | Computed<AiplatformTrial_FinalMeasurement[]>;
  /** Output only. Resource name of the Trial assigned by the service. */
  name?: string | Computed<string>;
  /** Output only. The parameters of the Trial. */
  parameters?: AiplatformTrial_Parameters[] | Computed<AiplatformTrial_Parameters[]>;
...
export interface AiplatformTrialAttrs {
  /** Output only. The identifier of the client that originally requested this Trial. Each client is identified by a unique client_id. When a client asks for a suggestion, Vertex AI Vizier will assign it a Trial. The client should evaluate the Trial, complete it, and report back to Vertex AI Vizier. If suggestion is asked again by same client_id before the Trial is completed, the same Trial will be returned. Multiple clients with different client_ids can ask for suggestions simultaneously, each of them will get their own Trial. */
  clientId: string;
  /** Output only. The CustomJob name linked to the Trial. It's set for a HyperparameterTuningJob's Trial. */
  customJob: string;
  ...
  endTime: string;
  /** A message representing a Measurement of a Trial. A Measurement contains the Metrics got by executing a Trial using suggested hyperparameter values. */
  finalMeasurement: AiplatformTrial_FinalMeasurement;
  /** Output only. The identifier of the Trial assigned by the service. */
  id: string;
  /** Output only. A human readable string describing why the Trial is infeasible. This is set only if Trial state is `INFEASIBLE`. */
  infeasibleReason: string;
  /** Output only. A list of measurements that are strictly lexicographically ordered by their induced tuples (steps, elapsed_duration). These are used for early stopping computations. */
  measurements: AiplatformTrial_FinalMeasurement[];
  /** Output only. Resource name of the Trial assigned by the service. */
  name: string;
  /** Output only. The parameters of the Trial. */
  parameters: AiplatformTrial_Parameters[];
  /** Output only. Time when the Trial was started. */
  startTime: string;
  /** Output only. The detailed state of the Trial. */
  state: string;
...
export const AiplatformTrial: ResourceBinding<AiplatformTrialConfig, AiplatformTrialAttrs> = {
  wireType: "google_aiplatform_aiplatform_trial",
  fields: {
    clientId: "client_id",
    ...
    finalMeasurement: {
      ...
      kind: "object",
      fields: AiplatformTrial_FinalMeasurementFields,
    },
    id: "id",
    ...
    parameters: {
      wireName: "parameters",
      kind: "list",
      fields: AiplatformTrial_ParametersFields,
    },
