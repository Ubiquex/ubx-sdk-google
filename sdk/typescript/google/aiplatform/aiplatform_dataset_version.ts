// Code generated by `ubx sdk gen` from google_aiplatform_aiplatform_dataset_version. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AiplatformDatasetVersionConfig {
...
export interface AiplatformDatasetVersionAttrs {
  /** Output only. Name of the associated BigQuery dataset. */
...
export const AiplatformDatasetVersion: ResourceBinding<AiplatformDatasetVersionConfig, AiplatformDatasetVersionAttrs> = {
  wireType: "google_aiplatform_aiplatform_dataset_version",
  fields: {
