// Code generated by `ubx sdk gen` from google_aiplatform_v1beta1_feature_view. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1FeatureView_BigQuerySource {
...
export interface V1beta1FeatureView_BigtableMetadata {
  /** Output only. The Bigtable App Profile to use for reading from Bigtable. */
  readAppProfile?: string | Computed<string>;
}

export interface V1beta1FeatureView_FeatureRegistrySource_FeatureGroups {
  featureGroupId?: string | Computed<string>;
  featureIds?: string[] | Computed<string[]>;
}

export interface V1beta1FeatureView_FeatureRegistrySource {
  /** Required. List of features that need to be synced to Online Store. */
  featureGroups?: V1beta1FeatureView_FeatureRegistrySource_FeatureGroups[] | Computed<V1beta1FeatureView_FeatureRegistrySource_FeatureGroups[]>;
  /** Optional. The project number of the parent project of the Feature Groups. */
  projectNumber?: string | Computed<string>;
}

export interface V1beta1FeatureView_IndexConfig_TreeAhConfig {
  /** Optional. Number of embeddings on each leaf node. The default value is 1000 if not set. */
  leafNodeEmbeddingCount?: string | Computed<string>;
}

export interface V1beta1FeatureView_IndexConfig {
  ...
  treeAhConfig?: V1beta1FeatureView_IndexConfig_TreeAhConfig | Computed<V1beta1FeatureView_IndexConfig_TreeAhConfig>;
}

export interface V1beta1FeatureView_OptimizedConfig_AutomaticResources {
...
export interface V1beta1FeatureView_OptimizedConfig {
  ...
  automaticResources?: V1beta1FeatureView_OptimizedConfig_AutomaticResources | Computed<V1beta1FeatureView_OptimizedConfig_AutomaticResources>;
}

export interface V1beta1FeatureView_SyncConfig {
...
export interface V1beta1FeatureView_VertexRagSource {
...
const V1beta1FeatureView_BigQuerySourceFields: FieldMap = {
  entityIdColumns: "entity_id_columns",
  uri: "uri",
};

const V1beta1FeatureView_BigtableMetadataFields: FieldMap = {
  readAppProfile: "read_app_profile",
};

const V1beta1FeatureView_FeatureRegistrySource_FeatureGroupsFields: FieldMap = {
  featureGroupId: "feature_group_id",
  featureIds: "feature_ids",
};

const V1beta1FeatureView_FeatureRegistrySourceFields: FieldMap = {
  featureGroups: {
...
const V1beta1FeatureView_IndexConfig_TreeAhConfigFields: FieldMap = {
  leafNodeEmbeddingCount: "leaf_node_embedding_count",
};

const V1beta1FeatureView_IndexConfigFields: FieldMap = {
...
const V1beta1FeatureView_OptimizedConfig_AutomaticResourcesFields: FieldMap = {
  maxReplicaCount: "max_replica_count",
  minReplicaCount: "min_replica_count",
};

const V1beta1FeatureView_OptimizedConfigFields: FieldMap = {
  automaticResources: {
...
const V1beta1FeatureView_SyncConfigFields: FieldMap = {
  continuous: "continuous",
  cron: "cron",
};

const V1beta1FeatureView_VertexRagSourceFields: FieldMap = {
  ragCorpusId: "rag_corpus_id",
  uri: "uri",
};

export interface V1beta1FeatureViewConfig {
  ...
  featureRegistrySource?: V1beta1FeatureView_FeatureRegistrySource | Computed<V1beta1FeatureView_FeatureRegistrySource>;
  /** Configuration for vector indexing. */
  indexConfig?: V1beta1FeatureView_IndexConfig | Computed<V1beta1FeatureView_IndexConfig>;
  ...
  vertexRagSource?: V1beta1FeatureView_VertexRagSource | Computed<V1beta1FeatureView_VertexRagSource>;
}

export interface V1beta1FeatureViewAttrs {
  bigQuerySource: V1beta1FeatureView_BigQuerySource;
  /** Metadata for the Cloud Bigtable that supports directly interacting Bigtable instances. */
  bigtableMetadata: V1beta1FeatureView_BigtableMetadata;
  /** Output only. Timestamp when this FeatureView was created. */
  createTime: string;
  /** Optional. Used to perform consistent read-modify-write updates. If not set, a blind "overwrite" update happens. */
  etag: string;
  /** A Feature Registry source for features that need to be synced to Online Store. */
  featureRegistrySource: V1beta1FeatureView_FeatureRegistrySource;
  /** Configuration for vector indexing. */
  indexConfig: V1beta1FeatureView_IndexConfig;
  /** Optional. The labels with user-defined metadata to organize your FeatureViews. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information on and examples of labels. No more than 64 user labels can be associated with one FeatureOnlineStore(System labels are excluded)." System reserved label keys are prefixed with "aiplatform.googleapis.com/" and are immutable. */
  labels: Record<string, string>;
  /** Identifier. Name of the FeatureView. Format: `projects/{project}/locations/{location}/featureOnlineStores/{feature_online_store}/featureViews/{feature_view}` */
  name: string;
  /** Configuration for FeatureViews created in Optimized FeatureOnlineStore. */
  optimizedConfig: V1beta1FeatureView_OptimizedConfig;
  /** Output only. Reserved for future use. */
  ...
  /** Configuration for Sync. Only one option is set. */
  syncConfig: V1beta1FeatureView_SyncConfig;
  /** Output only. Timestamp when this FeatureView was last updated. */
  updateTime: string;
  /** Deprecated. Use IndexConfig instead. */
  vectorSearchConfig: V1beta1FeatureView_IndexConfig;
  /** A Vertex Rag source for features that need to be synced to Online Store. */
  vertexRagSource: V1beta1FeatureView_VertexRagSource;
}

export const V1beta1FeatureView: ResourceBinding<V1beta1FeatureViewConfig, V1beta1FeatureViewAttrs> = {
  wireType: "google_aiplatform_v1beta1_feature_view",
  fields: {
    bigQuerySource: {
