// Code generated by `ubx sdk gen` from google_aiplatform_aiplatform_feature_group. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AiplatformFeatureGroup_BigQuery_BigQuerySource {
...
export interface AiplatformFeatureGroup_BigQuery_TimeSeries {
...
export interface AiplatformFeatureGroup_BigQuery {
  /** The BigQuery location for the input content. */
  bigQuerySource?: AiplatformFeatureGroup_BigQuery_BigQuerySource | Computed<AiplatformFeatureGroup_BigQuery_BigQuerySource>;
  ...
  timeSeries?: AiplatformFeatureGroup_BigQuery_TimeSeries | Computed<AiplatformFeatureGroup_BigQuery_TimeSeries>;
}

const AiplatformFeatureGroup_BigQuery_BigQuerySourceFields: FieldMap = {
  inputUri: "input_uri",
};

const AiplatformFeatureGroup_BigQuery_TimeSeriesFields: FieldMap = {
  timestampColumn: "timestamp_column",
};

const AiplatformFeatureGroup_BigQueryFields: FieldMap = {
  bigQuerySource: {
    wireName: "big_query_source",
    kind: "object",
    fields: AiplatformFeatureGroup_BigQuery_BigQuerySourceFields,
  },
  dense: "dense",
  ...
  timeSeries: {
    ...
    kind: "object",
    fields: AiplatformFeatureGroup_BigQuery_TimeSeriesFields,
  },
};

export interface AiplatformFeatureGroupConfig {
  /** Input source type for BigQuery Tables and Views. */
  bigQuery?: AiplatformFeatureGroup_BigQuery | Computed<AiplatformFeatureGroup_BigQuery>;
...
export interface AiplatformFeatureGroupAttrs {
  /** Input source type for BigQuery Tables and Views. */
  bigQuery: AiplatformFeatureGroup_BigQuery;
  /** Output only. Timestamp when this FeatureGroup was created. */
  createTime: string;
  /** Optional. Description of the FeatureGroup. */
  description: string;
...
export const AiplatformFeatureGroup: ResourceBinding<AiplatformFeatureGroupConfig, AiplatformFeatureGroupAttrs> = {
  wireType: "google_aiplatform_aiplatform_feature_group",
  fields: {
    bigQuery: {
      wireName: "big_query",
      kind: "object",
      fields: AiplatformFeatureGroup_BigQueryFields,
    },
