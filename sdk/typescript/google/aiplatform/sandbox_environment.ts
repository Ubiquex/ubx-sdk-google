...
export interface SandboxEnvironment_ConnectionInfo {
...
export interface SandboxEnvironment_Spec_CodeExecutionEnvironment {
...
export interface SandboxEnvironment_Spec {
  /** The code execution environment with customized settings. */
  codeExecutionEnvironment?: SandboxEnvironment_Spec_CodeExecutionEnvironment | Computed<SandboxEnvironment_Spec_CodeExecutionEnvironment>;
  /** The shell environment. */
  shellEnvironment?: unknown | Computed<unknown>;
}

const SandboxEnvironment_ConnectionInfoFields: FieldMap = {
...
const SandboxEnvironment_Spec_CodeExecutionEnvironmentFields: FieldMap = {
  codeLanguage: "code_language",
  machineConfig: "machine_config",
};

const SandboxEnvironment_SpecFields: FieldMap = {
...
export interface SandboxEnvironmentAttrs {
  /** The connection information of the SandboxEnvironment. */
  connectionInfo: SandboxEnvironment_ConnectionInfo;
  /** Output only. The timestamp when this SandboxEnvironment was created. */
  createTime: string;
  /** Required. The display name of the SandboxEnvironment. */
  displayName: string;
...
export const SandboxEnvironment: ResourceBinding<SandboxEnvironmentConfig, SandboxEnvironmentAttrs> = {
  wireType: "google_aiplatform_sandbox_environment",
  fields: {
    connectionInfo: {
