...
export interface AiplatformMetadataSchemaConfig {
...
export interface AiplatformMetadataSchemaAttrs {
  /** Output only. Timestamp when this MetadataSchema was created. */
  createTime: string;
  /** Description of the Metadata Schema */
  description: string;
...
export const AiplatformMetadataSchema: ResourceBinding<AiplatformMetadataSchemaConfig, AiplatformMetadataSchemaAttrs> = {
