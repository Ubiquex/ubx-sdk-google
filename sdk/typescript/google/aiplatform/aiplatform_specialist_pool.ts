// Code generated by `ubx sdk gen` from google_aiplatform_aiplatform_specialist_pool. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AiplatformSpecialistPoolConfig {
...
export interface AiplatformSpecialistPoolAttrs {
  /** Required. The user-defined name of the SpecialistPool. The name can be up to 128 characters long and can consist of any UTF-8 characters. This field should be unique on project-level. */
  displayName: string;
  /** Required. The resource name of the SpecialistPool. */
  name: string;
...
export const AiplatformSpecialistPool: ResourceBinding<AiplatformSpecialistPoolConfig, AiplatformSpecialistPoolAttrs> = {
  wireType: "google_aiplatform_aiplatform_specialist_pool",
  fields: {
