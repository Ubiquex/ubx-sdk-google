...
export interface V1beta1CustomJob_EncryptionSpec {
  /** Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`. */
  kmsKeyName?: string | Computed<string>;
}

export interface V1beta1CustomJob_Error {
...
export interface V1beta1CustomJob_JobSpec_BaseOutputDirectory {
  /** Required. Google Cloud Storage URI to output directory. If the uri doesn't end with '/', a '/' will be automatically appended. The directory is created if it doesn't exist. */
  outputUriPrefix?: string | Computed<string>;
}

export interface V1beta1CustomJob_JobSpec_PscInterfaceConfig_DnsPeeringConfigs {
  domain?: string | Computed<string>;
  targetNetwork?: string | Computed<string>;
  targetProject?: string | Computed<string>;
}

export interface V1beta1CustomJob_JobSpec_PscInterfaceConfig {
  ...
  dnsPeeringConfigs?: V1beta1CustomJob_JobSpec_PscInterfaceConfig_DnsPeeringConfigs[] | Computed<V1beta1CustomJob_JobSpec_PscInterfaceConfig_DnsPeeringConfigs[]>;
  /** Optional. The name of the Compute Engine [network attachment](https://cloud.google.com/vpc/docs/about-network-attachments) to attach to the resource within the region and user project. To specify this field, you must have already [created a network attachment] (https://cloud.google.com/vpc/docs/create-manage-network-attachments#create-network-attachments). This field is only used for resources using PSC-I. */
  networkAttachment?: string | Computed<string>;
}

export interface V1beta1CustomJob_JobSpec_Scheduling {
...
export interface V1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec_Env {
  name?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface V1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec {
  args?: string[] | Computed<string[]>;
  command?: string[] | Computed<string[]>;
  env?: V1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec_Env[] | Computed<V1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec_Env[]>;
  imageUri?: string | Computed<string>;
}

export interface V1beta1CustomJob_JobSpec_WorkerPoolSpecs_DiskSpec {
  bootDiskSizeGb?: number | Computed<number>;
  bootDiskType?: string | Computed<string>;
}

export interface V1beta1CustomJob_JobSpec_WorkerPoolSpecs_LustreMounts {
...
export interface V1beta1CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec_ReservationAffinity {
  key?: string | Computed<string>;
  reservationAffinityType?: string | Computed<string>;
  values?: string[] | Computed<string[]>;
}

export interface V1beta1CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec {
  ...
  reservationAffinity?: V1beta1CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec_ReservationAffinity | Computed<V1beta1CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec_ReservationAffinity>;
  tpuTopology?: string | Computed<string>;
}

export interface V1beta1CustomJob_JobSpec_WorkerPoolSpecs_NfsMounts {
  mountPoint?: string | Computed<string>;
  path?: string | Computed<string>;
  server?: string | Computed<string>;
}

export interface V1beta1CustomJob_JobSpec_WorkerPoolSpecs_PythonPackageSpec {
  args?: string[] | Computed<string[]>;
  env?: V1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec_Env[] | Computed<V1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec_Env[]>;
...
export interface V1beta1CustomJob_JobSpec_WorkerPoolSpecs {
  containerSpec?: V1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec | Computed<V1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec>;
  diskSpec?: V1beta1CustomJob_JobSpec_WorkerPoolSpecs_DiskSpec | Computed<V1beta1CustomJob_JobSpec_WorkerPoolSpecs_DiskSpec>;
  lustreMounts?: V1beta1CustomJob_JobSpec_WorkerPoolSpecs_LustreMounts[] | Computed<V1beta1CustomJob_JobSpec_WorkerPoolSpecs_LustreMounts[]>;
  machineSpec?: V1beta1CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec | Computed<V1beta1CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec>;
  nfsMounts?: V1beta1CustomJob_JobSpec_WorkerPoolSpecs_NfsMounts[] | Computed<V1beta1CustomJob_JobSpec_WorkerPoolSpecs_NfsMounts[]>;
  pythonPackageSpec?: V1beta1CustomJob_JobSpec_WorkerPoolSpecs_PythonPackageSpec | Computed<V1beta1CustomJob_JobSpec_WorkerPoolSpecs_PythonPackageSpec>;
  replicaCount?: string | Computed<string>;
}

export interface V1beta1CustomJob_JobSpec {
  /** The Google Cloud Storage location where the output is to be written to. */
  baseOutputDirectory?: V1beta1CustomJob_JobSpec_BaseOutputDirectory | Computed<V1beta1CustomJob_JobSpec_BaseOutputDirectory>;
  ...
  pscInterfaceConfig?: V1beta1CustomJob_JobSpec_PscInterfaceConfig | Computed<V1beta1CustomJob_JobSpec_PscInterfaceConfig>;
  /** Optional. A list of names for the reserved ip ranges under the VPC network that can be used for this job. If set, we will deploy the job within the provided ip ranges. Otherwise, the job will be deployed to any ip ranges under the provided VPC network. Example: ['vertex-ai-ip-range']. */
  reservedIpRanges?: string[] | Computed<string[]>;
  /** All parameters related to queuing and scheduling of custom jobs. */
  scheduling?: V1beta1CustomJob_JobSpec_Scheduling | Computed<V1beta1CustomJob_JobSpec_Scheduling>;
  ...
  workerPoolSpecs?: V1beta1CustomJob_JobSpec_WorkerPoolSpecs[] | Computed<V1beta1CustomJob_JobSpec_WorkerPoolSpecs[]>;
}

const V1beta1CustomJob_EncryptionSpecFields: FieldMap = {
  kmsKeyName: "kms_key_name",
};

const V1beta1CustomJob_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const V1beta1CustomJob_JobSpec_BaseOutputDirectoryFields: FieldMap = {
  outputUriPrefix: "output_uri_prefix",
};

const V1beta1CustomJob_JobSpec_PscInterfaceConfig_DnsPeeringConfigsFields: FieldMap = {
  domain: "domain",
  targetNetwork: "target_network",
  targetProject: "target_project",
};

const V1beta1CustomJob_JobSpec_PscInterfaceConfigFields: FieldMap = {
  dnsPeeringConfigs: {
...
const V1beta1CustomJob_JobSpec_SchedulingFields: FieldMap = {
...
const V1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec_EnvFields: FieldMap = {
  name: "name",
  value: "value",
};

const V1beta1CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpecFields: FieldMap = {
  args: "args",
  command: "command",
  env: {
    wireName: "env",
...
const V1beta1CustomJob_JobSpec_WorkerPoolSpecs_DiskSpecFields: FieldMap = {
  bootDiskSizeGb: "boot_disk_size_gb",
  bootDiskType: "boot_disk_type",
};

const V1beta1CustomJob_JobSpec_WorkerPoolSpecs_LustreMountsFields: FieldMap = {
...
const V1beta1CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec_ReservationAffinityFields: FieldMap = {
  key: "key",
  reservationAffinityType: "reservation_affinity_type",
  values: "values",
};

const V1beta1CustomJob_JobSpec_WorkerPoolSpecs_MachineSpecFields: FieldMap = {
...
const V1beta1CustomJob_JobSpec_WorkerPoolSpecs_NfsMountsFields: FieldMap = {
  mountPoint: "mount_point",
  path: "path",
  server: "server",
};

const V1beta1CustomJob_JobSpec_WorkerPoolSpecs_PythonPackageSpecFields: FieldMap = {
  args: "args",
  env: {
    wireName: "env",
    kind: "list",
...
const V1beta1CustomJob_JobSpec_WorkerPoolSpecsFields: FieldMap = {
  containerSpec: {
...
const V1beta1CustomJob_JobSpecFields: FieldMap = {
  baseOutputDirectory: {
...
export interface V1beta1CustomJobAttrs {
  ...
  displayName: string;
  /** Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource. */
  encryptionSpec: V1beta1CustomJob_EncryptionSpec;
  ...
  endTime: string;
  /** The `Status` type defines a logical error model that is suitable for different programming environments, including REST APIs and RPC APIs. It is used by [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error code, error message, and error details. You can find out more about this error model and how to work with it in the [API Design Guide](https://cloud.google.com/apis/design/errors). */
  error: V1beta1CustomJob_Error;
  /** Represents the spec of a CustomJob. */
  jobSpec: V1beta1CustomJob_JobSpec;
  /** The labels with user-defined metadata to organize CustomJobs. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels. */
