// Code generated by `ubx sdk gen` from google_aiplatform_aiplatform_execution. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AiplatformExecutionConfig {
...
export interface AiplatformExecutionAttrs {
  /** Output only. Timestamp when this Execution was created. */
  createTime: string;
  /** Description of the Execution */
  description: string;
...
export const AiplatformExecution: ResourceBinding<AiplatformExecutionConfig, AiplatformExecutionAttrs> = {
  wireType: "google_aiplatform_aiplatform_execution",
  fields: {
