...
export interface Reservation_ReplicationStatus {
  ...
  error?: Reservation_ReplicationStatus_Error | Computed<Reservation_ReplicationStatus_Error>;
...
export interface Reservation_SchedulingPolicy {
...
const Reservation_ReplicationStatus_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const Reservation_ReplicationStatusFields: FieldMap = {
  error: {
    wireName: "error",
    kind: "object",
...
const Reservation_SchedulingPolicyFields: FieldMap = {
...
export interface ReservationConfig {
  ...
  schedulingPolicy?: Reservation_SchedulingPolicy | Computed<Reservation_SchedulingPolicy>;
...
export interface ReservationAttrs {
  ...
  scalingMode: string;
  /** The scheduling policy controls how a reservation's resources are distributed. */
  schedulingPolicy: Reservation_SchedulingPolicy;
  /** Optional. The current location of the reservation's secondary replica. This field is only set for reservations using the managed disaster recovery feature. Users can set this in create reservation calls to create a failover reservation or in update reservation calls to convert a non-failover reservation to a failover reservation(or vice versa). */
...
export const Reservation: ResourceBinding<ReservationConfig, ReservationAttrs> = {
  wireType: "google_bigqueryreservation_reservation",
  fields: {
    autoscale: {
      wireName: "autoscale",
      kind: "object",
