...
export interface Process_Origin {
...
const Process_OriginFields: FieldMap = {
  name: "name",
...
export interface ProcessConfig {
  ...
  name?: string | Computed<string>;
  /** Origin of a process. */
  origin?: Process_Origin | Computed<Process_Origin>;
}
...
export const Process: ResourceBinding<ProcessConfig, ProcessAttrs> = {
