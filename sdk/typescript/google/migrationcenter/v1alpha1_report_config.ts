...
export interface V1alpha1ReportConfig_GroupPreferencesetAssignments {
  group?: string | Computed<string>;
  preferenceSet?: string | Computed<string>;
}

const V1alpha1ReportConfig_GroupPreferencesetAssignmentsFields: FieldMap = {
  group: "group",
...
export interface V1alpha1ReportConfigAttrs {
  ...
  displayName: string;
  /** Required. Collection of combinations of groups and preference sets. */
  groupPreferencesetAssignments: V1alpha1ReportConfig_GroupPreferencesetAssignments[];
