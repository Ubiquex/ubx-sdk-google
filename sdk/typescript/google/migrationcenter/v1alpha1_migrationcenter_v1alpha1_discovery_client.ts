// Code generated by `ubx sdk gen` from google_migrationcenter_v1alpha1_migrationcenter_v1alpha1_discovery_client. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1alpha1MigrationcenterV1alpha1DiscoveryClient_Errors {
  code?: number | Computed<number>;
  details?: Record<string, unknown>[] | Computed<Record<string, unknown>[]>;
  message?: string | Computed<string>;
}

export interface V1alpha1MigrationcenterV1alpha1DiscoveryClient_RecommendedVersions {
  uri?: string | Computed<string>;
  version?: string | Computed<string>;
}

const V1alpha1MigrationcenterV1alpha1DiscoveryClient_ErrorsFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const V1alpha1MigrationcenterV1alpha1DiscoveryClient_RecommendedVersionsFields: FieldMap = {
  uri: "uri",
  version: "version",
};

export interface V1alpha1MigrationcenterV1alpha1DiscoveryClientConfig {
  ...
  errors?: V1alpha1MigrationcenterV1alpha1DiscoveryClient_Errors[] | Computed<V1alpha1MigrationcenterV1alpha1DiscoveryClient_Errors[]>;
  ...
  recommendedVersions?: V1alpha1MigrationcenterV1alpha1DiscoveryClient_RecommendedVersions[] | Computed<V1alpha1MigrationcenterV1alpha1DiscoveryClient_RecommendedVersions[]>;
...
export interface V1alpha1MigrationcenterV1alpha1DiscoveryClientAttrs {
  /** Output only. Time when the discovery client was first created. */
  createTime: string;
  /** Optional. Free text description. Maximum length is 1000 characters. */
  description: string;
  ...
  displayName: string;
  /** Output only. Errors affecting client functionality. */
  errors: V1alpha1MigrationcenterV1alpha1DiscoveryClient_Errors[];
  /** Optional. Client expiration time in UTC. If specified, the backend will not accept new frames after this time. */
  expireTime: string;
  /** Output only. Last heartbeat time. Healthy clients are expected to send heartbeats regularly (normally every few minutes). */
  ...
  name: string;
  /** Output only. The recommended versions of the discovery client. */
  recommendedVersions: V1alpha1MigrationcenterV1alpha1DiscoveryClient_RecommendedVersions[];
  /** Required. Service account used by the discovery client for various operation. */
...
export const V1alpha1MigrationcenterV1alpha1DiscoveryClient: ResourceBinding<V1alpha1MigrationcenterV1alpha1DiscoveryClientConfig, V1alpha1MigrationcenterV1alpha1DiscoveryClientAttrs> = {
  wireType: "google_migrationcenter_v1alpha1_migrationcenter_v1alpha1_discovery_client",
  fields: {
    ...
    errors: {
      wireName: "errors",
      kind: "list",
      fields: V1alpha1MigrationcenterV1alpha1DiscoveryClient_ErrorsFields,
    },
    ...
    recommendedVersions: {
      ...
      kind: "list",
      fields: V1alpha1MigrationcenterV1alpha1DiscoveryClient_RecommendedVersionsFields,
    },
