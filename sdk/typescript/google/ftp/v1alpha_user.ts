// Code generated by `ubx sdk gen` from google_ftp_v1alpha_user. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1alphaUser_StorageDirectoryMappings {
...
const V1alphaUser_UserCredentialsFields: FieldMap = {
...
export interface V1alphaUserAttrs {
  ...
  state: string;
  /** Required. Mapping of Cloud Storage buckets to directories where the user will land in the SFTP server. */
  storageDirectoryMappings: V1alphaUser_StorageDirectoryMappings[];
  /** Output only. [Output only] Update time stamp */
  updateTime: string;
  /** Required. User credential for the user. The maximum number of user credentials is 10. */
  userCredentials: V1alphaUser_UserCredentials[];
  /** Output only. [Output only] The username of the user. */
  username: string;
}
