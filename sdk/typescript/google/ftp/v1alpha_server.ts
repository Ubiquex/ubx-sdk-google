// Code generated by `ubx sdk gen` from google_ftp_v1alpha_server. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1alphaServer_ExternalConfig {
...
export interface V1alphaServer_GoogleManagedServerCredential {
...
export interface V1alphaServer_InternalConfig_ConsumerAcceptList {
  connectionLimit?: string | Computed<string>;
  project?: string | Computed<string>;
}

export interface V1alphaServer_InternalConfig_ConsumerRejectList {
  project?: string | Computed<string>;
}

export interface V1alphaServer_InternalConfig_PscEndpoints {
  endpoint?: string | Computed<string>;
  network?: string | Computed<string>;
  status?: string | Computed<string>;
}

export interface V1alphaServer_InternalConfig {
  /** Required. A list of projects that are permitted to connect. At least one project is required in the allow list. */
  consumerAcceptList?: V1alphaServer_InternalConfig_ConsumerAcceptList[] | Computed<V1alphaServer_InternalConfig_ConsumerAcceptList[]>;
  ...
  consumerRejectList?: V1alphaServer_InternalConfig_ConsumerRejectList[] | Computed<V1alphaServer_InternalConfig_ConsumerRejectList[]>;
  /** Output only. Details of endpoints created by the customer. */
  pscEndpoints?: V1alphaServer_InternalConfig_PscEndpoints[] | Computed<V1alphaServer_InternalConfig_PscEndpoints[]>;
...
const V1alphaServer_ExternalConfigFields: FieldMap = {
  allowedCidrBlocks: "allowed_cidr_blocks",
  ipAddress: "ip_address",
};

const V1alphaServer_GoogleManagedServerCredentialFields: FieldMap = {
  asymmetricAlgorithm: "asymmetric_algorithm",
  fingerprint: "fingerprint",
};

const V1alphaServer_InternalConfig_ConsumerAcceptListFields: FieldMap = {
  connectionLimit: "connection_limit",
  project: "project",
};

const V1alphaServer_InternalConfig_ConsumerRejectListFields: FieldMap = {
  project: "project",
};

const V1alphaServer_InternalConfig_PscEndpointsFields: FieldMap = {
  endpoint: "endpoint",
  network: "network",
  status: "status",
};

const V1alphaServer_InternalConfigFields: FieldMap = {
  consumerAcceptList: {
...
export interface V1alphaServerConfig {
  ...
  externalConfig?: V1alphaServer_ExternalConfig | Computed<V1alphaServer_ExternalConfig>;
  /** Represents credentials of an FTP Server. */
  googleManagedServerCredential?: V1alphaServer_GoogleManagedServerCredential | Computed<V1alphaServer_GoogleManagedServerCredential>;
  /** Configuration for private server accessible via PSC. */
  internalConfig?: V1alphaServer_InternalConfig | Computed<V1alphaServer_InternalConfig>;
...
export interface V1alphaServerAttrs {
  ...
  displayName: string;
  /** Configuration for external server. */
  externalConfig: V1alphaServer_ExternalConfig;
  /** Represents credentials of an FTP Server. */
  googleManagedServerCredential: V1alphaServer_GoogleManagedServerCredential;
  /** Configuration for private server accessible via PSC. */
  internalConfig: V1alphaServer_InternalConfig;
  /** Optional. Labels as key value pairs */
...
export const V1alphaServer: ResourceBinding<V1alphaServerConfig, V1alphaServerAttrs> = {
