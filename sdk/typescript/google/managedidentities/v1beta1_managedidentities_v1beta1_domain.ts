// Code generated by `ubx sdk gen` from google_managedidentities_v1beta1_managedidentities_v1beta1_domain. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1ManagedidentitiesV1beta1Domain_Trusts {
...
const V1beta1ManagedidentitiesV1beta1Domain_TrustsFields: FieldMap = {
...
export interface V1beta1ManagedidentitiesV1beta1DomainConfig {
  ...
  trusts?: V1beta1ManagedidentitiesV1beta1Domain_Trusts[] | Computed<V1beta1ManagedidentitiesV1beta1Domain_Trusts[]>;
  /** Output only. The last update time. */
  updateTime?: string | Computed<string>;
}

export interface V1beta1ManagedidentitiesV1beta1DomainAttrs {
  /** Optional. The name of delegated administrator account used to perform Active Directory operations. If not specified, `setupadmin` will be used. */
  admin: string;
  /** Optional. Configuration for audit logs. True if audit logs are enabled, else false. Default is audit logs disabled. */
  ...
  /** Output only. The current trusts associated with the domain. */
  trusts: V1beta1ManagedidentitiesV1beta1Domain_Trusts[];
  /** Output only. The last update time. */
  updateTime: string;
}

export const V1beta1ManagedidentitiesV1beta1Domain: ResourceBinding<V1beta1ManagedidentitiesV1beta1DomainConfig, V1beta1ManagedidentitiesV1beta1DomainAttrs> = {
  wireType: "google_managedidentities_v1beta1_managedidentities_v1beta1_domain",
  fields: {
    admin: "admin",
    ...
    trusts: {
      wireName: "trusts",
      kind: "list",
      fields: V1beta1ManagedidentitiesV1beta1Domain_TrustsFields,
    },
    updateTime: "update_time",
  },
};
