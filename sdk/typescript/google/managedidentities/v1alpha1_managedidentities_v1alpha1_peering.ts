// Code generated by `ubx sdk gen` from google_managedidentities_v1alpha1_managedidentities_v1alpha1_peering. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1alpha1ManagedidentitiesV1alpha1PeeringConfig {
...
export interface V1alpha1ManagedidentitiesV1alpha1PeeringAttrs {
  /** Required. The full names of the Google Compute Engine [networks](/compute/docs/networks-and-firewalls#networks) to which the instance is connected. Caller needs to make sure that CIDR subnets do not overlap between networks, else peering creation will fail. */
...
export const V1alpha1ManagedidentitiesV1alpha1Peering: ResourceBinding<V1alpha1ManagedidentitiesV1alpha1PeeringConfig, V1alpha1ManagedidentitiesV1alpha1PeeringAttrs> = {
  wireType: "google_managedidentities_v1alpha1_managedidentities_v1alpha1_peering",
  fields: {
