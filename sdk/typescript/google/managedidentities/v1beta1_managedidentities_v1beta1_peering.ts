// Code generated by `ubx sdk gen` from google_managedidentities_v1beta1_managedidentities_v1beta1_peering. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1ManagedidentitiesV1beta1PeeringConfig {
...
export interface V1beta1ManagedidentitiesV1beta1PeeringAttrs {
  /** Required. The full names of the Google Compute Engine [networks](/compute/docs/networks-and-firewalls#networks) to which the instance is connected. Caller needs to make sure that CIDR subnets do not overlap between networks, else peering creation will fail. */
...
export const V1beta1ManagedidentitiesV1beta1Peering: ResourceBinding<V1beta1ManagedidentitiesV1beta1PeeringConfig, V1beta1ManagedidentitiesV1beta1PeeringAttrs> = {
  wireType: "google_managedidentities_v1beta1_managedidentities_v1beta1_peering",
  fields: {
