// Code generated by `ubx sdk gen` from google_managedidentities_v1alpha1_managedidentities_v1alpha1_domain. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1alpha1ManagedidentitiesV1alpha1Domain_Trusts {
...
const V1alpha1ManagedidentitiesV1alpha1Domain_TrustsFields: FieldMap = {
...
export interface V1alpha1ManagedidentitiesV1alpha1DomainConfig {
  ...
  trusts?: V1alpha1ManagedidentitiesV1alpha1Domain_Trusts[] | Computed<V1alpha1ManagedidentitiesV1alpha1Domain_Trusts[]>;
  /** Output only. Last update time. Synthetic field is populated automatically by CCFE. */
  updateTime?: string | Computed<string>;
}

export interface V1alpha1ManagedidentitiesV1alpha1DomainAttrs {
  /** Optional. Configuration for audit logs. True if audit logs are enabled, else false. Default is audit logs disabled. */
  ...
  /** Output only. The current trusts associated with the domain. */
  trusts: V1alpha1ManagedidentitiesV1alpha1Domain_Trusts[];
  /** Output only. Last update time. Synthetic field is populated automatically by CCFE. */
  updateTime: string;
}

export const V1alpha1ManagedidentitiesV1alpha1Domain: ResourceBinding<V1alpha1ManagedidentitiesV1alpha1DomainConfig, V1alpha1ManagedidentitiesV1alpha1DomainAttrs> = {
  wireType: "google_managedidentities_v1alpha1_managedidentities_v1alpha1_domain",
  fields: {
    ...
    trusts: {
      wireName: "trusts",
      kind: "list",
      fields: V1alpha1ManagedidentitiesV1alpha1Domain_TrustsFields,
    },
    updateTime: "update_time",
  },
};
