// Code generated by `ubx sdk gen` from google_firestore_firestore_database. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface FirestoreDatabase_CmekConfig {
...
export interface FirestoreDatabase_SourceInfo_Backup {
...
export interface FirestoreDatabase_SourceInfo {
  /** Information about a backup that was used to restore a database. */
  backup?: FirestoreDatabase_SourceInfo_Backup | Computed<FirestoreDatabase_SourceInfo_Backup>;
...
const FirestoreDatabase_CmekConfigFields: FieldMap = {
  activeKeyVersion: "active_key_version",
  kmsKeyName: "kms_key_name",
};

const FirestoreDatabase_SourceInfo_BackupFields: FieldMap = {
  backup: "backup",
};

const FirestoreDatabase_SourceInfoFields: FieldMap = {
  backup: {
    wireName: "backup",
    kind: "object",
    fields: FirestoreDatabase_SourceInfo_BackupFields,
  },
  operation: "operation",
};
...
export interface FirestoreDatabaseConfig {
  ...
  cmekConfig?: FirestoreDatabase_CmekConfig | Computed<FirestoreDatabase_CmekConfig>;
  ...
  sourceInfo?: FirestoreDatabase_SourceInfo | Computed<FirestoreDatabase_SourceInfo>;
...
export interface FirestoreDatabaseAttrs {
  /** The App Engine integration mode to use for this database. */
  appEngineIntegrationMode: string;
  /** The CMEK (Customer Managed Encryption Key) configuration for a Firestore database. If not present, the database is secured by the default Google encryption key. */
  cmekConfig: FirestoreDatabase_CmekConfig;
  /** The default concurrency control mode to use for this database. If unspecified in a CreateDatabase request, this will default based on the database edition: Optimistic for Enterprise and Pessimistic for all other databases. While transactions can explicitly specify their own concurrency mode, this setting defines the default behavior when left unspecified. Important: This database-level setting is not respected for Firestore with MongoDB compatibility. All transactions through the MongoDB compatibility layer will use optimistic concurrency control, regardless of this setting. */
  ...
  /** Information about the provenance of this database. */
  sourceInfo: FirestoreDatabase_SourceInfo;
  /** Optional. Input only. Immutable. Tag keys/values directly bound to this resource. For example: "123/environment": "production", "123/costCenter": "marketing" */
...
export const FirestoreDatabase: ResourceBinding<FirestoreDatabaseConfig, FirestoreDatabaseAttrs> = {
  wireType: "google_firestore_firestore_database",
  fields: {
    appEngineIntegrationMode: "app_engine_integration_mode",
    cmekConfig: {
      wireName: "cmek_config",
      kind: "object",
      fields: FirestoreDatabase_CmekConfigFields,
    },
    ...
    sourceInfo: {
      ...
      kind: "object",
      fields: FirestoreDatabase_SourceInfoFields,
    },
    tags: "tags",
    type: "type",
    uid: "uid",
