...
export interface ParallelstoreInstanceConfig {
...
export interface ParallelstoreInstanceAttrs {
  /** Output only. A list of IPv4 addresses used for client side configuration. */
  accessPoints: string[];
  /** Required. Immutable. The instance's storage capacity in Gibibytes (GiB). Allowed values are between 12000 and 100000, in multiples of 4000; e.g., 12000, 16000, 20000, ... */
  capacityGib: string;
...
export const ParallelstoreInstance: ResourceBinding<ParallelstoreInstanceConfig, ParallelstoreInstanceAttrs> = {
