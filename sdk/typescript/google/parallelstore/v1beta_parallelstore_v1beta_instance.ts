// Code generated by `ubx sdk gen` from google_parallelstore_v1beta_parallelstore_v1beta_instance. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1betaParallelstoreV1betaInstanceConfig {
  /** Output only. A list of IPv4 addresses used for client side configuration. */
  accessPoints?: string[] | Computed<string[]>;
  ...
  daosVersion?: string | Computed<string>;
  ...
  effectiveReservedIpRange?: string | Computed<string>;
...
export interface V1betaParallelstoreV1betaInstanceAttrs {
  /** Output only. A list of IPv4 addresses used for client side configuration. */
  accessPoints: string[];
  /** Required. Immutable. The instance's storage capacity in Gibibytes (GiB). Allowed values are between 12000 and 100000, in multiples of 4000; e.g., 12000, 16000, 20000, ... */
  capacityGib: string;
...
export const V1betaParallelstoreV1betaInstance: ResourceBinding<V1betaParallelstoreV1betaInstanceConfig, V1betaParallelstoreV1betaInstanceAttrs> = {
  wireType: "google_parallelstore_v1beta_parallelstore_v1beta_instance",
  fields: {
    accessPoints: "access_points",
    capacityGib: "capacity_gib",
    createTime: "create_time",
    daosVersion: "daos_version",
    deploymentType: "deployment_type",
    description: "description",
    directoryStripeLevel: "directory_stripe_level",
    effectiveReservedIpRange: "effective_reserved_ip_range",
