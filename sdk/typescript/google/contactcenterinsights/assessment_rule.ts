...
export interface AssessmentRule_SampleRule {
...
export interface AssessmentRule_ScheduleInfo {
...
const AssessmentRule_SampleRuleFields: FieldMap = {
...
const AssessmentRule_ScheduleInfoFields: FieldMap = {
  endTime: "end_time",
  schedule: "schedule",
...
export interface AssessmentRuleAttrs {
  ...
  name: string;
  /** Message for sampling conversations. */
  sampleRule: AssessmentRule_SampleRule;
  /** Message for schedule info. */
  scheduleInfo: AssessmentRule_ScheduleInfo;
  /** Output only. The most recent time at which this assessment rule was updated. */
  updateTime: string;
}

export const AssessmentRule: ResourceBinding<AssessmentRuleConfig, AssessmentRuleAttrs> = {
