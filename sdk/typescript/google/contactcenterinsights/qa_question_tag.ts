...
export interface QaQuestionTagConfig {
...
export interface QaQuestionTagAttrs {
...
export const QaQuestionTag: ResourceBinding<QaQuestionTagConfig, QaQuestionTagAttrs> = {
