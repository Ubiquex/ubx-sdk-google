...
const AutoLabelingRule_ConditionsFields: FieldMap = {
  condition: "condition",
  value: "value",
};

export interface AutoLabelingRuleConfig {
...
export interface AutoLabelingRuleAttrs {
  ...
  active: boolean;
  /** Conditions to apply for auto-labeling the label_key. Representing sequential block of if .. else if .. else statements. The value of the first matching condition will be used. */
  conditions: AutoLabelingRule_Conditions[];
  /** Output only. The time at which this rule was created. */
  createTime: string;
  /** The description of the rule. */
  description: string;
...
export const AutoLabelingRule: ResourceBinding<AutoLabelingRuleConfig, AutoLabelingRuleAttrs> = {
