// Code generated by `ubx sdk gen` from google_eventarc_eventarc_channel. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface EventarcChannelConfig {
...
export interface EventarcChannelAttrs {
  /** Output only. The activation token for the channel. The token must be used by the provider to register the channel for publishing. */
...
export const EventarcChannel: ResourceBinding<EventarcChannelConfig, EventarcChannelAttrs> = {
  wireType: "google_eventarc_eventarc_channel",
  fields: {
