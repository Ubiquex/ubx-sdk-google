// Code generated by `ubx sdk gen` from google_eventarc_eventarc_enrollment. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface EventarcEnrollmentConfig {
...
export interface EventarcEnrollmentAttrs {
  /** Optional. Resource annotations. */
...
export const EventarcEnrollment: ResourceBinding<EventarcEnrollmentConfig, EventarcEnrollmentAttrs> = {
  wireType: "google_eventarc_eventarc_enrollment",
  fields: {
