// Code generated by `ubx sdk gen` from google_oracledatabase_exascale_db_storage_vault. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface ExascaleDbStorageVault_Properties_ExascaleDbStorageDetails {
...
export interface ExascaleDbStorageVault_Properties_TimeZone {
...
export interface ExascaleDbStorageVault_Properties {
  ...
  exascaleDbStorageDetails?: ExascaleDbStorageVault_Properties_ExascaleDbStorageDetails | Computed<ExascaleDbStorageVault_Properties_ExascaleDbStorageDetails>;
  ...
  timeZone?: ExascaleDbStorageVault_Properties_TimeZone | Computed<ExascaleDbStorageVault_Properties_TimeZone>;
...
const ExascaleDbStorageVault_Properties_ExascaleDbStorageDetailsFields: FieldMap = {
  availableSizeGbs: "available_size_gbs",
  totalSizeGbs: "total_size_gbs",
};

const ExascaleDbStorageVault_Properties_TimeZoneFields: FieldMap = {
  id: "id",
  version: "version",
};

const ExascaleDbStorageVault_PropertiesFields: FieldMap = {
...
export interface ExascaleDbStorageVaultConfig {
  ...
  properties?: ExascaleDbStorageVault_Properties | Computed<ExascaleDbStorageVault_Properties>;
}

export interface ExascaleDbStorageVaultAttrs {
  /** Output only. The date and time when the ExascaleDbStorageVault was created. */
  createTime: string;
  /** Required. The display name for the ExascaleDbStorageVault. The name does not have to be unique within your project. The name must be 1-255 characters long and can only contain alphanumeric characters. */
  displayName: string;
  ...
  name: string;
  /** The properties of the ExascaleDbStorageVault. next ID: 12 */
  properties: ExascaleDbStorageVault_Properties;
}
