// Code generated by `ubx sdk gen` from google_oracledatabase_oracledatabase_cloud_exadata_infrastructure. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface OracledatabaseCloudExadataInfrastructure_Properties_CustomerContacts {
  email?: string | Computed<string>;
}

export interface OracledatabaseCloudExadataInfrastructure_Properties_ExascaleConfig {
...
export interface OracledatabaseCloudExadataInfrastructure_Properties_MaintenanceWindow {
...
export interface OracledatabaseCloudExadataInfrastructure_Properties {
  ...
  customerContacts?: OracledatabaseCloudExadataInfrastructure_Properties_CustomerContacts[] | Computed<OracledatabaseCloudExadataInfrastructure_Properties_CustomerContacts[]>;
  ...
  exascaleConfig?: OracledatabaseCloudExadataInfrastructure_Properties_ExascaleConfig | Computed<OracledatabaseCloudExadataInfrastructure_Properties_ExascaleConfig>;
  ...
  maintenanceWindow?: OracledatabaseCloudExadataInfrastructure_Properties_MaintenanceWindow | Computed<OracledatabaseCloudExadataInfrastructure_Properties_MaintenanceWindow>;
...
const OracledatabaseCloudExadataInfrastructure_Properties_CustomerContactsFields: FieldMap = {
  email: "email",
};

const OracledatabaseCloudExadataInfrastructure_Properties_ExascaleConfigFields: FieldMap = {
...
const OracledatabaseCloudExadataInfrastructure_Properties_MaintenanceWindowFields: FieldMap = {
...
const OracledatabaseCloudExadataInfrastructure_PropertiesFields: FieldMap = {
  ...
  customerContacts: {
    ...
    kind: "list",
    fields: OracledatabaseCloudExadataInfrastructure_Properties_CustomerContactsFields,
  },
  ...
  exascaleConfig: {
    ...
    kind: "object",
    fields: OracledatabaseCloudExadataInfrastructure_Properties_ExascaleConfigFields,
  },
  maintenanceWindow: {
    wireName: "maintenance_window",
    kind: "object",
    fields: OracledatabaseCloudExadataInfrastructure_Properties_MaintenanceWindowFields,
  },
...
export interface OracledatabaseCloudExadataInfrastructureConfig {
  ...
  properties?: OracledatabaseCloudExadataInfrastructure_Properties | Computed<OracledatabaseCloudExadataInfrastructure_Properties>;
}

export interface OracledatabaseCloudExadataInfrastructureAttrs {
  /** Output only. The date and time that the Exadata Infrastructure was created. */
  createTime: string;
  /** Optional. User friendly name for this resource. */
  displayName: string;
  ...
  name: string;
  /** Various properties of Exadata Infrastructure. */
  properties: OracledatabaseCloudExadataInfrastructure_Properties;
}

export const OracledatabaseCloudExadataInfrastructure: ResourceBinding<OracledatabaseCloudExadataInfrastructureConfig, OracledatabaseCloudExadataInfrastructureAttrs> = {
  wireType: "google_oracledatabase_oracledatabase_cloud_exadata_infrastructure",
  fields: {
    ...
    properties: {
      wireName: "properties",
      kind: "object",
      fields: OracledatabaseCloudExadataInfrastructure_PropertiesFields,
    },
  },
};
