...
export interface CloudVmCluster_IdentityConnector {
...
export interface CloudVmCluster_Properties_DiagnosticsDataCollectionOptions {
...
export interface CloudVmCluster_Properties_TimeZone {
...
export interface CloudVmCluster_Properties {
  ...
  diagnosticsDataCollectionOptions?: CloudVmCluster_Properties_DiagnosticsDataCollectionOptions | Computed<CloudVmCluster_Properties_DiagnosticsDataCollectionOptions>;
  ...
  timeZone?: CloudVmCluster_Properties_TimeZone | Computed<CloudVmCluster_Properties_TimeZone>;
...
const CloudVmCluster_IdentityConnectorFields: FieldMap = {
  connectionState: "connection_state",
  serviceAgentEmail: "service_agent_email",
};

const CloudVmCluster_Properties_DiagnosticsDataCollectionOptionsFields: FieldMap = {
...
const CloudVmCluster_Properties_TimeZoneFields: FieldMap = {
  id: "id",
  version: "version",
};

const CloudVmCluster_PropertiesFields: FieldMap = {
...
export interface CloudVmClusterConfig {
  ...
  properties?: CloudVmCluster_Properties | Computed<CloudVmCluster_Properties>;
}
...
export interface CloudVmClusterAttrs {
  ...
  /** The identity connector details which will allow OCI to securely access the resources in the customer project. */
  identityConnector: CloudVmCluster_IdentityConnector;
  /** Optional. Labels or tags associated with the VM Cluster. */
  ...
  odbSubnet: string;
  /** Various properties and settings associated with Exadata VM cluster. */
  properties: CloudVmCluster_Properties;
}
