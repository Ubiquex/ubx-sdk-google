...
export interface GoldengateConnection_Properties_AmazonKinesisConnectionProperties {
...
export interface GoldengateConnection_Properties_AmazonRedshiftConnectionProperties {
...
export interface GoldengateConnection_Properties_AmazonS3ConnectionProperties {
...
export interface GoldengateConnection_Properties_AzureDataLakeStorageConnectionProperties {
...
export interface GoldengateConnection_Properties_AzureSynapseAnalyticsConnectionProperties {
...
export interface GoldengateConnection_Properties_DatabricksConnectionProperties {
...
export interface GoldengateConnection_Properties_Db2ConnectionProperties {
  /** Optional. An array of name-value pair attribute entries. Used as additional parameters in connection string. */
  additionalAttributes?: GoldengateConnection_Properties_Db2ConnectionProperties_AdditionalAttributes[] | Computed<GoldengateConnection_Properties_Db2ConnectionProperties_AdditionalAttributes[]>;
...
export interface GoldengateConnection_Properties_ElasticsearchConnectionProperties {
...
export interface GoldengateConnection_Properties_GenericConnectionProperties {
...
export interface GoldengateConnection_Properties_GoldengateConnectionProperties {
...
export interface GoldengateConnection_Properties_GoogleBigQueryConnectionProperties {
...
export interface GoldengateConnection_Properties_HdfsConnectionProperties {
...
export interface GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_GlueIcebergCatalog {
  /** Required. The catalog ID of Glue. */
  glueId?: string | Computed<string>;
}

export interface GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_NessieIcebergCatalog {
...
export interface GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_PolarisIcebergCatalog {
...
export interface GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_RestIcebergCatalog {
...
export interface GoldengateConnection_Properties_IcebergConnectionProperties_Catalog {
  /** Required. The type of Iceberg catalog. */
  catalogType?: string | Computed<string>;
  /** The Glue Iceberg catalog. */
  glueIcebergCatalog?: GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_GlueIcebergCatalog | Computed<GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_GlueIcebergCatalog>;
  /** The Nessie Iceberg catalog. */
  nessieIcebergCatalog?: GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_NessieIcebergCatalog | Computed<GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_NessieIcebergCatalog>;
  /** The Polaris Iceberg catalog. */
  polarisIcebergCatalog?: GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_PolarisIcebergCatalog | Computed<GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_PolarisIcebergCatalog>;
  /** The REST Iceberg catalog. */
  restIcebergCatalog?: GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_RestIcebergCatalog | Computed<GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_RestIcebergCatalog>;
}

export interface GoldengateConnection_Properties_IcebergConnectionProperties_Storage_AmazonS3IcebergStorage {
...
export interface GoldengateConnection_Properties_IcebergConnectionProperties_Storage_AzureDataLakeStorageIcebergStorage {
...
export interface GoldengateConnection_Properties_IcebergConnectionProperties_Storage_GoogleCloudStorageIcebergStorage {
...
export interface GoldengateConnection_Properties_IcebergConnectionProperties_Storage {
  /** The Amazon S3 Iceberg storage. */
  amazonS3IcebergStorage?: GoldengateConnection_Properties_IcebergConnectionProperties_Storage_AmazonS3IcebergStorage | Computed<GoldengateConnection_Properties_IcebergConnectionProperties_Storage_AmazonS3IcebergStorage>;
  /** The Azure Data Lake Storage Iceberg storage. */
  azureDataLakeStorageIcebergStorage?: GoldengateConnection_Properties_IcebergConnectionProperties_Storage_AzureDataLakeStorageIcebergStorage | Computed<GoldengateConnection_Properties_IcebergConnectionProperties_Storage_AzureDataLakeStorageIcebergStorage>;
  /** The Google Cloud Storage Iceberg storage. */
  googleCloudStorageIcebergStorage?: GoldengateConnection_Properties_IcebergConnectionProperties_Storage_GoogleCloudStorageIcebergStorage | Computed<GoldengateConnection_Properties_IcebergConnectionProperties_Storage_GoogleCloudStorageIcebergStorage>;
  /** Required. The type of Iceberg storage. */
  storageType?: string | Computed<string>;
}

export interface GoldengateConnection_Properties_IcebergConnectionProperties {
  /** The Iceberg catalog details. */
  catalog?: GoldengateConnection_Properties_IcebergConnectionProperties_Catalog | Computed<GoldengateConnection_Properties_IcebergConnectionProperties_Catalog>;
  /** The Iceberg storage details. */
  storage?: GoldengateConnection_Properties_IcebergConnectionProperties_Storage | Computed<GoldengateConnection_Properties_IcebergConnectionProperties_Storage>;
  /** Required. The technology type of Iceberg connection. */
  technologyType?: string | Computed<string>;
}

export interface GoldengateConnection_Properties_JavaMessageServiceConnectionProperties {
...
export interface GoldengateConnection_Properties_KafkaConnectionProperties {
  ...
  bootstrapServers?: GoldengateConnection_Properties_KafkaConnectionProperties_BootstrapServers[] | Computed<GoldengateConnection_Properties_KafkaConnectionProperties_BootstrapServers[]>;
...
export interface GoldengateConnection_Properties_KafkaSchemaRegistryConnectionProperties {
...
export interface GoldengateConnection_Properties_MicrosoftFabricConnectionProperties {
...
export interface GoldengateConnection_Properties_MicrosoftSqlserverConnectionProperties {
  /** Optional. An array of name-value pair attribute entries. Used as additional parameters in connection string. */
  additionalAttributes?: GoldengateConnection_Properties_Db2ConnectionProperties_AdditionalAttributes[] | Computed<GoldengateConnection_Properties_Db2ConnectionProperties_AdditionalAttributes[]>;
  /** Optional. The name of the database. */
  database?: string | Computed<string>;
...
export interface GoldengateConnection_Properties_MongodbConnectionProperties {
...
export interface GoldengateConnection_Properties_MysqlConnectionProperties {
  /** Optional. An array of name-value pair attribute entries. Used as additional parameters in connection string. */
  additionalAttributes?: GoldengateConnection_Properties_Db2ConnectionProperties_AdditionalAttributes[] | Computed<GoldengateConnection_Properties_Db2ConnectionProperties_AdditionalAttributes[]>;
  /** Optional. The name of the database. */
  database?: string | Computed<string>;
...
export interface GoldengateConnection_Properties_OciObjectStorageConnectionProperties {
...
export interface GoldengateConnection_Properties_OracleAiDataPlatformConnectionProperties {
...
export interface GoldengateConnection_Properties_OracleConnectionProperties {
...
export interface GoldengateConnection_Properties_RedisConnectionProperties {
...
export interface GoldengateConnection_Properties_SnowflakeConnectionProperties {
...
export interface GoldengateConnection_Properties {
  /** The properties of GoldengateAmazonKinesisConnection. */
  amazonKinesisConnectionProperties?: GoldengateConnection_Properties_AmazonKinesisConnectionProperties | Computed<GoldengateConnection_Properties_AmazonKinesisConnectionProperties>;
  /** The properties of GoldengateAmazonRedshiftConnection. */
  amazonRedshiftConnectionProperties?: GoldengateConnection_Properties_AmazonRedshiftConnectionProperties | Computed<GoldengateConnection_Properties_AmazonRedshiftConnectionProperties>;
  /** The properties of GoldengateAmazonS3Connection. */
  amazonS3ConnectionProperties?: GoldengateConnection_Properties_AmazonS3ConnectionProperties | Computed<GoldengateConnection_Properties_AmazonS3ConnectionProperties>;
  /** The properties of GoldengateAzureDataLakeStorageConnection. */
  azureDataLakeStorageConnectionProperties?: GoldengateConnection_Properties_AzureDataLakeStorageConnectionProperties | Computed<GoldengateConnection_Properties_AzureDataLakeStorageConnectionProperties>;
  /** The properties of GoldengateAzureSynapseAnalyticsConnection. */
  azureSynapseAnalyticsConnectionProperties?: GoldengateConnection_Properties_AzureSynapseAnalyticsConnectionProperties | Computed<GoldengateConnection_Properties_AzureSynapseAnalyticsConnectionProperties>;
  /** Required. The connection type. */
  connectionType?: string | Computed<string>;
  /** The properties of GoldengateDatabricksConnection. */
  databricksConnectionProperties?: GoldengateConnection_Properties_DatabricksConnectionProperties | Computed<GoldengateConnection_Properties_DatabricksConnectionProperties>;
  /** The properties of GoldengateDb2Connection. */
  db2ConnectionProperties?: GoldengateConnection_Properties_Db2ConnectionProperties | Computed<GoldengateConnection_Properties_Db2ConnectionProperties>;
  ...
  elasticsearchConnectionProperties?: GoldengateConnection_Properties_ElasticsearchConnectionProperties | Computed<GoldengateConnection_Properties_ElasticsearchConnectionProperties>;
  /** The properties of GoldengateGenericConnectionProperties. */
  genericConnectionProperties?: GoldengateConnection_Properties_GenericConnectionProperties | Computed<GoldengateConnection_Properties_GenericConnectionProperties>;
  /** The properties of GoldengateGoldengateConnectionProperties. */
  goldengateConnectionProperties?: GoldengateConnection_Properties_GoldengateConnectionProperties | Computed<GoldengateConnection_Properties_GoldengateConnectionProperties>;
  /** The properties of GoldengateGoogleBigQueryConnectionProperties. */
  googleBigQueryConnectionProperties?: GoldengateConnection_Properties_GoogleBigQueryConnectionProperties | Computed<GoldengateConnection_Properties_GoogleBigQueryConnectionProperties>;
  /** The properties of GoldengateGoogleCloudStorageConnectionProperties. */
  googleCloudStorageConnectionProperties?: GoldengateConnection_Properties_GoogleBigQueryConnectionProperties | Computed<GoldengateConnection_Properties_GoogleBigQueryConnectionProperties>;
  /** The properties of GoldengateGooglePubsubConnection. */
  googlePubsubConnectionProperties?: GoldengateConnection_Properties_GoogleBigQueryConnectionProperties | Computed<GoldengateConnection_Properties_GoogleBigQueryConnectionProperties>;
  /** The properties of GoldengateHdfsConnection. */
  hdfsConnectionProperties?: GoldengateConnection_Properties_HdfsConnectionProperties | Computed<GoldengateConnection_Properties_HdfsConnectionProperties>;
  /** The properties of GoldengateIcebergConnection. */
  icebergConnectionProperties?: GoldengateConnection_Properties_IcebergConnectionProperties | Computed<GoldengateConnection_Properties_IcebergConnectionProperties>;
  ...
  javaMessageServiceConnectionProperties?: GoldengateConnection_Properties_JavaMessageServiceConnectionProperties | Computed<GoldengateConnection_Properties_JavaMessageServiceConnectionProperties>;
  /** The properties of GoldengateKafkaConnection. */
  kafkaConnectionProperties?: GoldengateConnection_Properties_KafkaConnectionProperties | Computed<GoldengateConnection_Properties_KafkaConnectionProperties>;
  /** The properties of GoldengateKafkaSchemaRegistryConnection. */
  kafkaSchemaRegistryConnectionProperties?: GoldengateConnection_Properties_KafkaSchemaRegistryConnectionProperties | Computed<GoldengateConnection_Properties_KafkaSchemaRegistryConnectionProperties>;
  ...
  microsoftFabricConnectionProperties?: GoldengateConnection_Properties_MicrosoftFabricConnectionProperties | Computed<GoldengateConnection_Properties_MicrosoftFabricConnectionProperties>;
  /** The properties of GoldengateMicrosoftSqlserverConnection. */
  microsoftSqlserverConnectionProperties?: GoldengateConnection_Properties_MicrosoftSqlserverConnectionProperties | Computed<GoldengateConnection_Properties_MicrosoftSqlserverConnectionProperties>;
  /** The properties of GoldengateMongodbConnection. */
  mongodbConnectionProperties?: GoldengateConnection_Properties_MongodbConnectionProperties | Computed<GoldengateConnection_Properties_MongodbConnectionProperties>;
  /** Properties of GoldengateMysqlConnection. */
  mysqlConnectionProperties?: GoldengateConnection_Properties_MysqlConnectionProperties | Computed<GoldengateConnection_Properties_MysqlConnectionProperties>;
  /** The properties of GoldengateOciObjectStorageConnection. */
  ociObjectStorageConnectionProperties?: GoldengateConnection_Properties_OciObjectStorageConnectionProperties | Computed<GoldengateConnection_Properties_OciObjectStorageConnectionProperties>;
  ...
  oracleAiDataPlatformConnectionProperties?: GoldengateConnection_Properties_OracleAiDataPlatformConnectionProperties | Computed<GoldengateConnection_Properties_OracleAiDataPlatformConnectionProperties>;
  /** The properties of Goldengate Oracle Database Connection. */
  oracleConnectionProperties?: GoldengateConnection_Properties_OracleConnectionProperties | Computed<GoldengateConnection_Properties_OracleConnectionProperties>;
  /** The properties of GoldengateOracleNosqlConnection. */
  oracleNosqlConnectionProperties?: GoldengateConnection_Properties_OciObjectStorageConnectionProperties | Computed<GoldengateConnection_Properties_OciObjectStorageConnectionProperties>;
  /** The properties of GoldengatePostgresqlConnection. */
  postgresqlConnectionProperties?: GoldengateConnection_Properties_MysqlConnectionProperties | Computed<GoldengateConnection_Properties_MysqlConnectionProperties>;
  /** The properties of GoldengateRedisConnection. */
  redisConnectionProperties?: GoldengateConnection_Properties_RedisConnectionProperties | Computed<GoldengateConnection_Properties_RedisConnectionProperties>;
  ...
  snowflakeConnectionProperties?: GoldengateConnection_Properties_SnowflakeConnectionProperties | Computed<GoldengateConnection_Properties_SnowflakeConnectionProperties>;
  /** Output only. The time the resource was last updated. */
  updateTime?: string | Computed<string>;
}

const GoldengateConnection_Properties_AmazonKinesisConnectionPropertiesFields: FieldMap = {
...
const GoldengateConnection_Properties_AmazonRedshiftConnectionPropertiesFields: FieldMap = {
...
const GoldengateConnection_Properties_AmazonS3ConnectionPropertiesFields: FieldMap = {
  accessKeyId: "access_key_id",
  endpoint: "endpoint",
  region: "region",
  secretAccessKeySecret: "secret_access_key_secret",
...
const GoldengateConnection_Properties_AzureDataLakeStorageConnectionPropertiesFields: FieldMap = {
  account: "account",
...
const GoldengateConnection_Properties_AzureSynapseAnalyticsConnectionPropertiesFields: FieldMap = {
...
const GoldengateConnection_Properties_DatabricksConnectionPropertiesFields: FieldMap = {
  authenticationType: "authentication_type",
  clientId: "client_id",
  clientSecret: "client_secret",
  connectionUrl: "connection_url",
...
const GoldengateConnection_Properties_Db2ConnectionProperties_AdditionalAttributesFields: FieldMap = {
  key: "key",
  value: "value",
};

const GoldengateConnection_Properties_Db2ConnectionPropertiesFields: FieldMap = {
...
const GoldengateConnection_Properties_ElasticsearchConnectionPropertiesFields: FieldMap = {
  authenticationType: "authentication_type",
...
const GoldengateConnection_Properties_GenericConnectionPropertiesFields: FieldMap = {
  host: "host",
  technologyType: "technology_type",
};

const GoldengateConnection_Properties_GoldengateConnectionPropertiesFields: FieldMap = {
...
const GoldengateConnection_Properties_GoogleBigQueryConnectionPropertiesFields: FieldMap = {
  serviceAccountKeyFile: "service_account_key_file",
  technologyType: "technology_type",
};

const GoldengateConnection_Properties_HdfsConnectionPropertiesFields: FieldMap = {
  coreSiteXml: "core_site_xml",
  technologyType: "technology_type",
};

const GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_GlueIcebergCatalogFields: FieldMap = {
  glueId: "glue_id",
};

const GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_NessieIcebergCatalogFields: FieldMap = {
  branch: "branch",
  uri: "uri",
};

const GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_PolarisIcebergCatalogFields: FieldMap = {
  clientId: "client_id",
  clientSecret: "client_secret",
...
const GoldengateConnection_Properties_IcebergConnectionProperties_Catalog_RestIcebergCatalogFields: FieldMap = {
  properties: "properties",
  uri: "uri",
};

const GoldengateConnection_Properties_IcebergConnectionProperties_CatalogFields: FieldMap = {
...
const GoldengateConnection_Properties_IcebergConnectionProperties_Storage_AmazonS3IcebergStorageFields: FieldMap = {
  accessKeyId: "access_key_id",
  bucket: "bucket",
  endpoint: "endpoint",
  region: "region",
...
const GoldengateConnection_Properties_IcebergConnectionProperties_Storage_AzureDataLakeStorageIcebergStorageFields: FieldMap = {
  accountKeySecret: "account_key_secret",
...
const GoldengateConnection_Properties_IcebergConnectionProperties_Storage_GoogleCloudStorageIcebergStorageFields: FieldMap = {
  bucket: "bucket",
  projectId: "project_id",
  serviceAccountKeyFile: "service_account_key_file",
};

const GoldengateConnection_Properties_IcebergConnectionProperties_StorageFields: FieldMap = {
...
const GoldengateConnection_Properties_IcebergConnectionPropertiesFields: FieldMap = {
  catalog: {
    wireName: "catalog",
    kind: "object",
...
const GoldengateConnection_Properties_JavaMessageServiceConnectionPropertiesFields: FieldMap = {
  authenticationType: "authentication_type",
...
const GoldengateConnection_Properties_KafkaConnectionProperties_BootstrapServersFields: FieldMap = {
  host: "host",
  port: "port",
  privateIpAddress: "private_ip_address",
};

const GoldengateConnection_Properties_KafkaConnectionPropertiesFields: FieldMap = {
  bootstrapServers: {
...
const GoldengateConnection_Properties_KafkaSchemaRegistryConnectionPropertiesFields: FieldMap = {
  authenticationType: "authentication_type",
  keyStoreFile: "key_store_file",
  keyStorePassword: "key_store_password",
  keyStorePasswordSecretVersion: "key_store_password_secret_version",
...
const GoldengateConnection_Properties_MicrosoftFabricConnectionPropertiesFields: FieldMap = {
  clientId: "client_id",
  clientSecret: "client_secret",
  endpoint: "endpoint",
  technologyType: "technology_type",
...
const GoldengateConnection_Properties_MicrosoftSqlserverConnectionPropertiesFields: FieldMap = {
  additionalAttributes: {
    wireName: "additional_attributes",
    kind: "list",
    fields: GoldengateConnection_Properties_Db2ConnectionProperties_AdditionalAttributesFields,
...
const GoldengateConnection_Properties_MongodbConnectionPropertiesFields: FieldMap = {
  connectionString: "connection_string",
...
const GoldengateConnection_Properties_MysqlConnectionPropertiesFields: FieldMap = {
  additionalAttributes: {
    wireName: "additional_attributes",
    kind: "list",
    fields: GoldengateConnection_Properties_Db2ConnectionProperties_AdditionalAttributesFields,
...
const GoldengateConnection_Properties_OciObjectStorageConnectionPropertiesFields: FieldMap = {
...
const GoldengateConnection_Properties_OracleAiDataPlatformConnectionPropertiesFields: FieldMap = {
  connectionUrl: "connection_url",
  privateKeyFile: "private_key_file",
  privateKeyPassphraseSecret: "private_key_passphrase_secret",
  publicKeyFingerprint: "public_key_fingerprint",
...
const GoldengateConnection_Properties_OracleConnectionPropertiesFields: FieldMap = {
...
const GoldengateConnection_Properties_RedisConnectionPropertiesFields: FieldMap = {
  authenticationType: "authentication_type",
  keyStoreFile: "key_store_file",
  keyStorePassword: "key_store_password",
  keyStorePasswordSecretVersion: "key_store_password_secret_version",
...
const GoldengateConnection_Properties_SnowflakeConnectionPropertiesFields: FieldMap = {
  authenticationType: "authentication_type",
  connectionUrl: "connection_url",
  password: "password",
  passwordSecretVersion: "password_secret_version",
...
const GoldengateConnection_PropertiesFields: FieldMap = {
...
export interface GoldengateConnectionConfig {
  ...
  properties?: GoldengateConnection_Properties | Computed<GoldengateConnection_Properties>;
}

export interface GoldengateConnectionAttrs {
  /** Output only. The date and time that the GoldengateConnection was created. */
  createTime: string;
  /** Output only. The ID of the subscription entitlement associated with the GoldengateConnection. */
  ...
  odbSubnet: string;
  /** The properties of a GoldengateConnection. */
  properties: GoldengateConnection_Properties;
}
