...
export interface OracledatabaseExadbVmCluster_IdentityConnector {
...
export interface OracledatabaseExadbVmCluster_Properties_DataCollectionOptions {
...
export interface OracledatabaseExadbVmCluster_Properties_TimeZone {
...
export interface OracledatabaseExadbVmCluster_Properties_VmFileSystemStorage {
...
export interface OracledatabaseExadbVmCluster_Properties {
  ...
  dataCollectionOptions?: OracledatabaseExadbVmCluster_Properties_DataCollectionOptions | Computed<OracledatabaseExadbVmCluster_Properties_DataCollectionOptions>;
  ...
  timeZone?: OracledatabaseExadbVmCluster_Properties_TimeZone | Computed<OracledatabaseExadbVmCluster_Properties_TimeZone>;
  /** The storage allocation for the exadbvmcluster, in gigabytes (GB). */
  vmFileSystemStorage?: OracledatabaseExadbVmCluster_Properties_VmFileSystemStorage | Computed<OracledatabaseExadbVmCluster_Properties_VmFileSystemStorage>;
}

const OracledatabaseExadbVmCluster_IdentityConnectorFields: FieldMap = {
  connectionState: "connection_state",
  serviceAgentEmail: "service_agent_email",
};

const OracledatabaseExadbVmCluster_Properties_DataCollectionOptionsFields: FieldMap = {
...
const OracledatabaseExadbVmCluster_Properties_TimeZoneFields: FieldMap = {
  id: "id",
  version: "version",
};

const OracledatabaseExadbVmCluster_Properties_VmFileSystemStorageFields: FieldMap = {
  sizeInGbsPerNode: "size_in_gbs_per_node",
};

const OracledatabaseExadbVmCluster_PropertiesFields: FieldMap = {
...
export interface OracledatabaseExadbVmClusterConfig {
  ...
  identityConnector?: OracledatabaseExadbVmCluster_IdentityConnector | Computed<OracledatabaseExadbVmCluster_IdentityConnector>;
  ...
  properties?: OracledatabaseExadbVmCluster_Properties | Computed<OracledatabaseExadbVmCluster_Properties>;
}

export interface OracledatabaseExadbVmClusterAttrs {
  /** Required. Immutable. The name of the backup OdbSubnet associated with the ExadbVmCluster. Format: projects/{project}/locations/{location}/odbNetworks/{odb_network}/odbSubnets/{odb_subnet} */
  ...
  /** The identity connector details which will allow OCI to securely access the resources in the customer project. */
  identityConnector: OracledatabaseExadbVmCluster_IdentityConnector;
  /** Optional. The labels or tags associated with the ExadbVmCluster. */
  ...
  odbSubnet: string;
  /** The properties of an ExadbVmCluster. */
  properties: OracledatabaseExadbVmCluster_Properties;
}

export const OracledatabaseExadbVmCluster: ResourceBinding<OracledatabaseExadbVmClusterConfig, OracledatabaseExadbVmClusterAttrs> = {
