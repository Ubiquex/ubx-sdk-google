...
export interface GoldengateDeployment_Properties_BackupSchedule {
...
export interface GoldengateDeployment_Properties_DeploymentDiagnosticData {
  /** Output only. The bucket name. */
  bucket?: string | Computed<string>;
...
export interface GoldengateDeployment_Properties_MaintenanceConfig {
...
export interface GoldengateDeployment_Properties_MaintenanceWindow {
...
export interface GoldengateDeployment_Properties_OggData_GroupRolesMapping {
...
export interface GoldengateDeployment_Properties_OggData {
  ...
  groupRolesMapping?: GoldengateDeployment_Properties_OggData_GroupRolesMapping | Computed<GoldengateDeployment_Properties_OggData_GroupRolesMapping>;
...
export interface GoldengateDeployment_Properties {
  /** The backup schedule of the GoldengateDeployment. */
  backupSchedule?: GoldengateDeployment_Properties_BackupSchedule | Computed<GoldengateDeployment_Properties_BackupSchedule>;
  ...
  deploymentDiagnosticData?: GoldengateDeployment_Properties_DeploymentDiagnosticData | Computed<GoldengateDeployment_Properties_DeploymentDiagnosticData>;
  ...
  ingressIps?: GoldengateDeployment_Properties_IngressIps[] | Computed<GoldengateDeployment_Properties_IngressIps[]>;
  ...
  locks?: GoldengateDeployment_Properties_Locks[] | Computed<GoldengateDeployment_Properties_Locks[]>;
  /** The maintenance configuration of the GoldengateDeployment. */
  maintenanceConfig?: GoldengateDeployment_Properties_MaintenanceConfig | Computed<GoldengateDeployment_Properties_MaintenanceConfig>;
  /** The maintenance window of the GoldengateDeployment. */
  maintenanceWindow?: GoldengateDeployment_Properties_MaintenanceWindow | Computed<GoldengateDeployment_Properties_MaintenanceWindow>;
  ...
  oggData?: GoldengateDeployment_Properties_OggData | Computed<GoldengateDeployment_Properties_OggData>;
  ...
  placements?: GoldengateDeployment_Properties_Placements[] | Computed<GoldengateDeployment_Properties_Placements[]>;
...
const GoldengateDeployment_Properties_BackupScheduleFields: FieldMap = {
...
const GoldengateDeployment_Properties_DeploymentDiagnosticDataFields: FieldMap = {
  bucket: "bucket",
...
const GoldengateDeployment_Properties_IngressIpsFields: FieldMap = {
  ingressIpAddress: "ingress_ip_address",
};

const GoldengateDeployment_Properties_LocksFields: FieldMap = {
  compartmentId: "compartment_id",
...
const GoldengateDeployment_Properties_MaintenanceConfigFields: FieldMap = {
...
const GoldengateDeployment_Properties_MaintenanceWindowFields: FieldMap = {
  day: "day",
  startHour: "start_hour",
};

const GoldengateDeployment_Properties_OggData_GroupRolesMappingFields: FieldMap = {
...
const GoldengateDeployment_Properties_OggDataFields: FieldMap = {
...
const GoldengateDeployment_Properties_PlacementsFields: FieldMap = {
  availabilityDomain: "availability_domain",
  faultDomain: "fault_domain",
};

const GoldengateDeployment_PropertiesFields: FieldMap = {
  backupSchedule: {
...
export interface GoldengateDeploymentConfig {
  ...
  properties?: GoldengateDeployment_Properties | Computed<GoldengateDeployment_Properties>;
}

export interface GoldengateDeploymentAttrs {
  ...
  odbSubnet: string;
  /** Properties of GoldengateDeployment. */
  properties: GoldengateDeployment_Properties;
}
