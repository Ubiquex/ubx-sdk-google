// Code generated by `ubx sdk gen` from google_oracledatabase_oracledatabase_db_system. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface OracledatabaseDbSystem_Properties_DataCollectionOptions {
...
export interface OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DatabaseManagementConfig {
...
export interface OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfig_BackupDestinationDetails {
  type?: string | Computed<string>;
}

export interface OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfig {
  ...
  backupDestinationDetails?: OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfig_BackupDestinationDetails[] | Computed<OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfig_BackupDestinationDetails[]>;
...
export interface OracledatabaseDbSystem_Properties_DbHome_Database_Properties {
  /** The configuration of the Database Management service. */
  databaseManagementConfig?: OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DatabaseManagementConfig | Computed<OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DatabaseManagementConfig>;
  /** Backup Options for the Database. */
  dbBackupConfig?: OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfig | Computed<OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfig>;
...
export interface OracledatabaseDbSystem_Properties_DbHome_Database {
  ...
  properties?: OracledatabaseDbSystem_Properties_DbHome_Database_Properties | Computed<OracledatabaseDbSystem_Properties_DbHome_Database_Properties>;
...
export interface OracledatabaseDbSystem_Properties_DbHome {
  /** Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ */
  database?: OracledatabaseDbSystem_Properties_DbHome_Database | Computed<OracledatabaseDbSystem_Properties_DbHome_Database>;
...
export interface OracledatabaseDbSystem_Properties_DbSystemOptions {
  /** Optional. The storage option used in DB system. */
  storageManagement?: string | Computed<string>;
}

export interface OracledatabaseDbSystem_Properties_TimeZone {
...
export interface OracledatabaseDbSystem_Properties {
  ...
  dataCollectionOptions?: OracledatabaseDbSystem_Properties_DataCollectionOptions | Computed<OracledatabaseDbSystem_Properties_DataCollectionOptions>;
  ...
  dbHome?: OracledatabaseDbSystem_Properties_DbHome | Computed<OracledatabaseDbSystem_Properties_DbHome>;
  /** Details of the DbSystem Options. */
  dbSystemOptions?: OracledatabaseDbSystem_Properties_DbSystemOptions | Computed<OracledatabaseDbSystem_Properties_DbSystemOptions>;
  ...
  timeZone?: OracledatabaseDbSystem_Properties_TimeZone | Computed<OracledatabaseDbSystem_Properties_TimeZone>;
}

const OracledatabaseDbSystem_Properties_DataCollectionOptionsFields: FieldMap = {
  isDiagnosticsEventsEnabled: "is_diagnostics_events_enabled",
  isIncidentLogsEnabled: "is_incident_logs_enabled",
};

const OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DatabaseManagementConfigFields: FieldMap = {
  managementState: "management_state",
  managementType: "management_type",
};

const OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfig_BackupDestinationDetailsFields: FieldMap = {
  type: "type",
};

const OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfigFields: FieldMap = {
  ...
  backupDestinationDetails: {
    ...
    kind: "list",
    fields: OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfig_BackupDestinationDetailsFields,
  },
  retentionPeriodDays: "retention_period_days",
};

const OracledatabaseDbSystem_Properties_DbHome_Database_PropertiesFields: FieldMap = {
  databaseManagementConfig: {
    wireName: "database_management_config",
    kind: "object",
    fields: OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DatabaseManagementConfigFields,
  },
  dbBackupConfig: {
    wireName: "db_backup_config",
    kind: "object",
    fields: OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfigFields,
  },
  dbVersion: "db_version",
  state: "state",
};

const OracledatabaseDbSystem_Properties_DbHome_DatabaseFields: FieldMap = {
  ...
  properties: {
    wireName: "properties",
    kind: "object",
    fields: OracledatabaseDbSystem_Properties_DbHome_Database_PropertiesFields,
  },
  tdeWalletPassword: "tde_wallet_password",
  tdeWalletPasswordSecretVersion: "tde_wallet_password_secret_version",
};

const OracledatabaseDbSystem_Properties_DbHomeFields: FieldMap = {
  database: {
    wireName: "database",
    kind: "object",
    fields: OracledatabaseDbSystem_Properties_DbHome_DatabaseFields,
  },
  dbVersion: "db_version",
...
const OracledatabaseDbSystem_Properties_DbSystemOptionsFields: FieldMap = {
  storageManagement: "storage_management",
};

const OracledatabaseDbSystem_Properties_TimeZoneFields: FieldMap = {
  id: "id",
  version: "version",
};

const OracledatabaseDbSystem_PropertiesFields: FieldMap = {
  computeCount: "compute_count",
  computeModel: "compute_model",
  dataCollectionOptions: {
    wireName: "data_collection_options",
    kind: "object",
    fields: OracledatabaseDbSystem_Properties_DataCollectionOptionsFields,
  },
  ...
  dbHome: {
    wireName: "db_home",
    kind: "object",
    fields: OracledatabaseDbSystem_Properties_DbHomeFields,
  },
  dbSystemOptions: {
    wireName: "db_system_options",
    kind: "object",
    fields: OracledatabaseDbSystem_Properties_DbSystemOptionsFields,
  },
  domain: "domain",
  hostname: "hostname",
  ...
  timeZone: {
    wireName: "time_zone",
    kind: "object",
    fields: OracledatabaseDbSystem_Properties_TimeZoneFields,
  },
};

export interface OracledatabaseDbSystemConfig {
  ...
  properties?: OracledatabaseDbSystem_Properties | Computed<OracledatabaseDbSystem_Properties>;
}

export interface OracledatabaseDbSystemAttrs {
  /** Output only. The date and time that the DbSystem was created. */
  createTime: string;
  /** Required. The display name for the System db. The name does not have to be unique within your project. */
  displayName: string;
  ...
  odbSubnet: string;
  /** The properties of a DbSystem. */
  properties: OracledatabaseDbSystem_Properties;
}

export const OracledatabaseDbSystem: ResourceBinding<OracledatabaseDbSystemConfig, OracledatabaseDbSystemAttrs> = {
  wireType: "google_oracledatabase_oracledatabase_db_system",
  fields: {
    createTime: "create_time",
    displayName: "display_name",
    ...
    properties: {
      wireName: "properties",
      kind: "object",
      fields: OracledatabaseDbSystem_PropertiesFields,
    },
  },
};
