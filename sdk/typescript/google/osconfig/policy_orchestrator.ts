...
export interface PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_InstanceFilter {
  /** Target all VMs in the project. If true, no other criteria is permitted. */
  all?: boolean | Computed<boolean>;
  /** List of label sets used for VM exclusion. If the list has more than one label set, the VM is excluded if any of the label sets are applicable for the VM. */
  exclusionLabels?: PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_InstanceFilter_ExclusionLabels[] | Computed<PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_InstanceFilter_ExclusionLabels[]>;
  /** List of label sets used for VM inclusion. If the list has more than one `LabelSet`, the VM is included if any of the label sets are applicable for the VM. */
  inclusionLabels?: PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_InstanceFilter_ExclusionLabels[] | Computed<PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_InstanceFilter_ExclusionLabels[]>;
  /** List of inventories to select VMs. A VM is selected if its inventory data matches at least one of the following inventories. */
  inventories?: PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_InstanceFilter_Inventories[] | Computed<PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_InstanceFilter_Inventories[]>;
}
...
export interface PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_Rollout_DisruptionBudget {
...
export interface PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_Rollout {
  /** Message encapsulating a value that can be either absolute ("fixed") or relative ("percent") to a value. */
  disruptionBudget?: PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_Rollout_DisruptionBudget | Computed<PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_Rollout_DisruptionBudget>;
  /** Required. This determines the minimum duration of time to wait after the configuration changes are applied through the current rollout. A VM continues to count towards the `disruption_budget` at least until this duration of time has passed after configuration changes are applied. */
  minWaitDuration?: string | Computed<string>;
}

export interface PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload {
  ...
  instanceFilter?: PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_InstanceFilter | Computed<PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_InstanceFilter>;
  /** Resource name. Format: `projects/{project_number}/locations/{location}/osPolicyAssignments/{os_policy_assignment_id}` This field is ignored when you create an OS policy assignment. */
  name?: string | Computed<string>;
  /** Required. List of OS policies to be applied to the VMs. */
  osPolicies?: PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies[] | Computed<PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies[]>;
  ...
  rollout?: PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_Rollout | Computed<PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_Rollout>;
...
export interface PolicyOrchestrator_OrchestratedResource {
  ...
  osPolicyAssignmentV1Payload?: PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload | Computed<PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload>;
}
...
export interface PolicyOrchestrator_OrchestrationScope {
  ...
  selectors?: PolicyOrchestrator_OrchestrationScope_Selectors[] | Computed<PolicyOrchestrator_OrchestrationScope_Selectors[]>;
}

export interface PolicyOrchestrator_OrchestrationState_CurrentIterationState_Error {
...
export interface PolicyOrchestrator_OrchestrationState_CurrentIterationState {
  /** The `Status` type defines a logical error model that is suitable for different programming environments, including REST APIs and RPC APIs. It is used by [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error code, error message, and error details. You can find out more about this error model and how to work with it in the [API Design Guide](https://cloud.google.com/apis/design/errors). */
  error?: PolicyOrchestrator_OrchestrationState_CurrentIterationState_Error | Computed<PolicyOrchestrator_OrchestrationState_CurrentIterationState_Error>;
...
export interface PolicyOrchestrator_OrchestrationState {
  /** Describes the state of a single iteration of the orchestrator. */
  currentIterationState?: PolicyOrchestrator_OrchestrationState_CurrentIterationState | Computed<PolicyOrchestrator_OrchestrationState_CurrentIterationState>;
  /** Describes the state of a single iteration of the orchestrator. */
  previousIterationState?: PolicyOrchestrator_OrchestrationState_CurrentIterationState | Computed<PolicyOrchestrator_OrchestrationState_CurrentIterationState>;
}

const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_InstanceFilter_ExclusionLabelsFields: FieldMap = {
  labels: "labels",
};

const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_InstanceFilter_InventoriesFields: FieldMap = {
  osShortName: "os_short_name",
  osVersion: "os_version",
};

const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_InstanceFilterFields: FieldMap = {
  all: "all",
  exclusionLabels: {
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_Exec_Enforce_File_GcsFields: FieldMap = {
  bucket: "bucket",
  generation: "generation",
  object: "object",
};

const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_Exec_Enforce_File_RemoteFields: FieldMap = {
  sha256Checksum: "sha256_checksum",
  uri: "uri",
};

const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_Exec_Enforce_FileFields: FieldMap = {
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_Exec_EnforceFields: FieldMap = {
  args: "args",
  file: {
    wireName: "file",
    kind: "object",
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_ExecFields: FieldMap = {
  enforce: {
    wireName: "enforce",
    kind: "object",
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_FileFields: FieldMap = {
  content: "content",
  file: {
    wireName: "file",
    kind: "object",
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_Pkg_AptFields: FieldMap = {
  name: "name",
};

const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_Pkg_DebFields: FieldMap = {
  pullDeps: "pull_deps",
  source: {
    wireName: "source",
    kind: "object",
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_Pkg_MsiFields: FieldMap = {
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_PkgFields: FieldMap = {
  apt: {
    wireName: "apt",
    kind: "object",
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_Repository_AptFields: FieldMap = {
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_Repository_GooFields: FieldMap = {
  name: "name",
  url: "url",
};

const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_Repository_YumFields: FieldMap = {
  baseUrl: "base_url",
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_Resources_RepositoryFields: FieldMap = {
  apt: {
    wireName: "apt",
    kind: "object",
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroups_ResourcesFields: FieldMap = {
  exec: {
    wireName: "exec",
    kind: "object",
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPolicies_ResourceGroupsFields: FieldMap = {
  inventoryFilters: {
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_OsPoliciesFields: FieldMap = {
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_Rollout_DisruptionBudgetFields: FieldMap = {
  fixed: "fixed",
  percent: "percent",
};

const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1Payload_RolloutFields: FieldMap = {
  disruptionBudget: {
...
const PolicyOrchestrator_OrchestratedResource_OsPolicyAssignmentV1PayloadFields: FieldMap = {
  baseline: "baseline",
  deleted: "deleted",
  description: "description",
  etag: "etag",
...
const PolicyOrchestrator_OrchestratedResourceFields: FieldMap = {
  id: "id",
...
const PolicyOrchestrator_OrchestrationScope_Selectors_LocationSelectorFields: FieldMap = {
  includedLocations: "included_locations",
};

const PolicyOrchestrator_OrchestrationScope_Selectors_ResourceHierarchySelectorFields: FieldMap = {
  includedFolders: "included_folders",
  includedProjects: "included_projects",
};

const PolicyOrchestrator_OrchestrationScope_SelectorsFields: FieldMap = {
  locationSelector: {
...
const PolicyOrchestrator_OrchestrationScopeFields: FieldMap = {
  selectors: {
    wireName: "selectors",
    kind: "list",
...
const PolicyOrchestrator_OrchestrationState_CurrentIterationState_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const PolicyOrchestrator_OrchestrationState_CurrentIterationStateFields: FieldMap = {
  error: {
    wireName: "error",
    kind: "object",
...
const PolicyOrchestrator_OrchestrationStateFields: FieldMap = {
...
export interface PolicyOrchestratorConfig {
  ...
  orchestratedResource?: PolicyOrchestrator_OrchestratedResource | Computed<PolicyOrchestrator_OrchestratedResource>;
  /** Defines a set of selectors which drive which resources are in scope of policy orchestration. */
  orchestrationScope?: PolicyOrchestrator_OrchestrationScope | Computed<PolicyOrchestrator_OrchestrationScope>;
  /** Describes the state of the orchestration process. */
  orchestrationState?: PolicyOrchestrator_OrchestrationState | Computed<PolicyOrchestrator_OrchestrationState>;
...
export interface PolicyOrchestratorAttrs {
  /** Required. Action to be done by the orchestrator in `projects/{project_id}/zones/{zone_id}` locations defined by the `orchestration_scope`. Allowed values: - `UPSERT` - Orchestrator will create or update target resources. - `DELETE` - Orchestrator will delete target resources, if they exist */
  action: string;
  /** Output only. Timestamp when the policy orchestrator resource was created. */
  createTime: string;
  ...
  name: string;
  /** Represents a resource that is being orchestrated by the policy orchestrator. */
  orchestratedResource: PolicyOrchestrator_OrchestratedResource;
  /** Defines a set of selectors which drive which resources are in scope of policy orchestration. */
  orchestrationScope: PolicyOrchestrator_OrchestrationScope;
  /** Describes the state of the orchestration process. */
  orchestrationState: PolicyOrchestrator_OrchestrationState;
  /** Output only. Set to true, if there are ongoing changes being applied by the orchestrator. */
  reconciling: boolean;
  /** Optional. State of the orchestrator. Can be updated to change orchestrator behaviour. Allowed values: - `ACTIVE` - orchestrator is actively looking for actions to be taken. - `STOPPED` - orchestrator won't make any changes. Note: There might be more states added in the future. We use string here instead of an enum, to avoid the need of propagating new states to all the client code. */
  state: string;
...
export const PolicyOrchestrator: ResourceBinding<PolicyOrchestratorConfig, PolicyOrchestratorAttrs> = {
