// Code generated by `ubx sdk gen` from google_androiddeviceprovisioning_androiddeviceprovisioning_configuration. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AndroiddeviceprovisioningConfigurationConfig {
...
export interface AndroiddeviceprovisioningConfigurationAttrs {
  /** Required. The name of the organization. Zero-touch enrollment shows this organization name to device users during device provisioning. */
  companyName: string;
  /** Output only. The ID of the configuration. Assigned by the server. */
...
export const AndroiddeviceprovisioningConfiguration: ResourceBinding<AndroiddeviceprovisioningConfigurationConfig, AndroiddeviceprovisioningConfigurationAttrs> = {
  wireType: "google_androiddeviceprovisioning_androiddeviceprovisioning_configuration",
  fields: {
