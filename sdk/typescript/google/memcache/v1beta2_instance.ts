// Code generated by `ubx sdk gen` from google_memcache_v1beta2_instance. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta2Instance_InstanceMessages {
  code?: string | Computed<string>;
  message?: string | Computed<string>;
}

export interface V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTime {
...
export interface V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindow {
  day?: string | Computed<string>;
  duration?: string | Computed<string>;
  startTime?: V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTime | Computed<V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTime>;
}

export interface V1beta2Instance_MaintenancePolicy {
  ...
  weeklyMaintenanceWindow?: V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindow[] | Computed<V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindow[]>;
}

export interface V1beta2Instance_MaintenanceSchedule {
...
export interface V1beta2Instance_MemcacheNodes_Parameters {
  id?: string | Computed<string>;
  params?: Record<string, string> | Computed<Record<string, string>>;
}

export interface V1beta2Instance_MemcacheNodes {
...
export interface V1beta2Instance_NodeConfig {
...
const V1beta2Instance_InstanceMessagesFields: FieldMap = {
  code: "code",
  message: "message",
};

const V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTimeFields: FieldMap = {
  hours: "hours",
  minutes: "minutes",
  nanos: "nanos",
  seconds: "seconds",
...
const V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindowFields: FieldMap = {
  day: "day",
  duration: "duration",
  startTime: {
    wireName: "start_time",
...
const V1beta2Instance_MaintenancePolicyFields: FieldMap = {
...
const V1beta2Instance_MaintenanceScheduleFields: FieldMap = {
  endTime: "end_time",
...
export interface V1beta2InstanceConfig {
  ...
  maintenancePolicy?: V1beta2Instance_MaintenancePolicy | Computed<V1beta2Instance_MaintenancePolicy>;
  ...
  nodeConfig?: V1beta2Instance_NodeConfig | Computed<V1beta2Instance_NodeConfig>;
...
export interface V1beta2InstanceAttrs {
  /** The full name of the Google Compute Engine [network](https://cloud.google.com/vpc/docs/vpc) to which the instance is connected. If left unspecified, the `default` network will be used. */
  ...
  /** List of messages that describe the current state of the Memcached instance. */
  instanceMessages: V1beta2Instance_InstanceMessages[];
  /** Resource labels to represent user-provided metadata. Refer to cloud documentation on labels for more details. https://cloud.google.com/compute/docs/labeling-resources */
  labels: Record<string, string>;
  /** Maintenance policy per instance. */
  maintenancePolicy: V1beta2Instance_MaintenancePolicy;
  /** Upcoming maintenance schedule. */
  maintenanceSchedule: V1beta2Instance_MaintenanceSchedule;
  /** Optional. Last self service update maintenance version triggered by the customer. If it is empty, it means that the maintenance version is not set by the user. */
  maintenanceVersion: string;
  /** Output only. The full version of memcached server running on this instance. System automatically determines the full memcached version for an instance based on the input MemcacheVersion. The full version format will be "memcached-1.5.16". */
  memcacheFullVersion: string;
  /** Output only. List of Memcached nodes. Refer to Node message for more details. */
  memcacheNodes: V1beta2Instance_MemcacheNodes[];
  /** The major version of Memcached software. If not provided, latest supported version will be used. Currently the latest supported major version is `MEMCACHE_1_5`. The minor version will be automatically determined by our system based on the latest supported minor version. */
  memcacheVersion: string;
  /** Required. Unique name of the resource in this scope including project and location using the form: `projects/{project_id}/locations/{location_id}/instances/{instance_id}` Note: Memcached instances are managed and addressed at the regional level so `location_id` here refers to a Google Cloud region; however, users may choose which zones Memcached nodes should be provisioned in within an instance. Refer to zones field for more details. */
  name: string;
  /** Configuration for a Memcached Node. */
  nodeConfig: V1beta2Instance_NodeConfig;
  /** Required. Number of nodes in the Memcached instance. */
  nodeCount: number;
  parameters: V1beta2Instance_MemcacheNodes_Parameters;
  /** Optional. Contains the id of allocated IP address ranges associated with the private service access connection for example, "test-default" associated with IP range 10.0.0.0/29. */
...
export const V1beta2Instance: ResourceBinding<V1beta2InstanceConfig, V1beta2InstanceAttrs> = {
