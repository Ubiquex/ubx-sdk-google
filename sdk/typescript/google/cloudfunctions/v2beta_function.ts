// Code generated by `ubx sdk gen` from google_cloudfunctions_v2beta_function. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V2betaFunction_BuildConfig_OnDeployUpdatePolicy {
...
export interface V2betaFunction_BuildConfig_Source_RepoSource {
...
export interface V2betaFunction_BuildConfig_Source_StorageSource {
...
export interface V2betaFunction_BuildConfig_Source {
  ...
  repoSource?: V2betaFunction_BuildConfig_Source_RepoSource | Computed<V2betaFunction_BuildConfig_Source_RepoSource>;
  /** Location of the source in an archive file in Google Cloud Storage. */
  storageSource?: V2betaFunction_BuildConfig_Source_StorageSource | Computed<V2betaFunction_BuildConfig_Source_StorageSource>;
}

export interface V2betaFunction_BuildConfig_SourceProvenance {
  /** A copy of the build's `source.git_uri`, if exists, with any commits resolved. */
  gitUri?: string | Computed<string>;
  /** Location of the source in a Google Cloud Source Repository. */
  resolvedRepoSource?: V2betaFunction_BuildConfig_Source_RepoSource | Computed<V2betaFunction_BuildConfig_Source_RepoSource>;
  /** Location of the source in an archive file in Google Cloud Storage. */
  resolvedStorageSource?: V2betaFunction_BuildConfig_Source_StorageSource | Computed<V2betaFunction_BuildConfig_Source_StorageSource>;
}

export interface V2betaFunction_BuildConfig {
  ...
  onDeployUpdatePolicy?: V2betaFunction_BuildConfig_OnDeployUpdatePolicy | Computed<V2betaFunction_BuildConfig_OnDeployUpdatePolicy>;
  ...
  source?: V2betaFunction_BuildConfig_Source | Computed<V2betaFunction_BuildConfig_Source>;
  /** Provenance of the source. Ways to find the original source, or verify that some source was used for this build. */
  sourceProvenance?: V2betaFunction_BuildConfig_SourceProvenance | Computed<V2betaFunction_BuildConfig_SourceProvenance>;
...
export interface V2betaFunction_EventTrigger_EventFilters {
  attribute?: string | Computed<string>;
  operator?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface V2betaFunction_EventTrigger {
  /** Optional. The name of the channel associated with the trigger in `projects/{project}/locations/{location}/channels/{channel}` format. You must provide a channel to receive events from Eventarc SaaS partners. */
  channel?: string | Computed<string>;
  /** Criteria used to filter events. */
  eventFilters?: V2betaFunction_EventTrigger_EventFilters[] | Computed<V2betaFunction_EventTrigger_EventFilters[]>;
...
export interface V2betaFunction_ServiceConfig_DirectVpcNetworkInterface {
  network?: string | Computed<string>;
  subnetwork?: string | Computed<string>;
  tags?: string[] | Computed<string[]>;
}

export interface V2betaFunction_ServiceConfig_SecretEnvironmentVariables {
...
export interface V2betaFunction_ServiceConfig_SecretVolumes_Versions {
  path?: string | Computed<string>;
  version?: string | Computed<string>;
}

export interface V2betaFunction_ServiceConfig_SecretVolumes {
  mountPath?: string | Computed<string>;
  projectId?: string | Computed<string>;
  secret?: string | Computed<string>;
  versions?: V2betaFunction_ServiceConfig_SecretVolumes_Versions[] | Computed<V2betaFunction_ServiceConfig_SecretVolumes_Versions[]>;
}

export interface V2betaFunction_ServiceConfig {
  ...
  directVpcNetworkInterface?: V2betaFunction_ServiceConfig_DirectVpcNetworkInterface[] | Computed<V2betaFunction_ServiceConfig_DirectVpcNetworkInterface[]>;
  ...
  secretEnvironmentVariables?: V2betaFunction_ServiceConfig_SecretEnvironmentVariables[] | Computed<V2betaFunction_ServiceConfig_SecretEnvironmentVariables[]>;
  /** Secret volumes configuration. */
  secretVolumes?: V2betaFunction_ServiceConfig_SecretVolumes[] | Computed<V2betaFunction_ServiceConfig_SecretVolumes[]>;
...
export interface V2betaFunction_StateMessages {
  message?: string | Computed<string>;
  severity?: string | Computed<string>;
  type?: string | Computed<string>;
}

export interface V2betaFunction_UpgradeInfo {
  /** Describes the Build step of the function that builds a container from the given source. */
  buildConfig?: V2betaFunction_BuildConfig | Computed<V2betaFunction_BuildConfig>;
  /** Describes EventTrigger, used to request events to be sent from another service. */
  eventTrigger?: V2betaFunction_EventTrigger | Computed<V2betaFunction_EventTrigger>;
  /** Describes the Service being deployed. Currently Supported : Cloud Run (fully managed). */
  serviceConfig?: V2betaFunction_ServiceConfig | Computed<V2betaFunction_ServiceConfig>;
  /** UpgradeState of the function */
  upgradeState?: string | Computed<string>;
}

const V2betaFunction_BuildConfig_OnDeployUpdatePolicyFields: FieldMap = {
  runtimeVersion: "runtime_version",
};

const V2betaFunction_BuildConfig_Source_RepoSourceFields: FieldMap = {
...
const V2betaFunction_BuildConfig_Source_StorageSourceFields: FieldMap = {
  bucket: "bucket",
...
const V2betaFunction_BuildConfig_SourceFields: FieldMap = {
  gitUri: "git_uri",
  repoSource: {
...
const V2betaFunction_BuildConfig_SourceProvenanceFields: FieldMap = {
  gitUri: "git_uri",
  resolvedRepoSource: {
...
const V2betaFunction_BuildConfigFields: FieldMap = {
...
const V2betaFunction_EventTrigger_EventFiltersFields: FieldMap = {
  attribute: "attribute",
  operator: "operator",
  value: "value",
};

const V2betaFunction_EventTriggerFields: FieldMap = {
  channel: "channel",
  eventFilters: {
...
const V2betaFunction_ServiceConfig_DirectVpcNetworkInterfaceFields: FieldMap = {
  network: "network",
  subnetwork: "subnetwork",
  tags: "tags",
};

const V2betaFunction_ServiceConfig_SecretEnvironmentVariablesFields: FieldMap = {
  key: "key",
  projectId: "project_id",
  secret: "secret",
  version: "version",
...
const V2betaFunction_ServiceConfig_SecretVolumes_VersionsFields: FieldMap = {
  path: "path",
  version: "version",
};

const V2betaFunction_ServiceConfig_SecretVolumesFields: FieldMap = {
...
const V2betaFunction_ServiceConfigFields: FieldMap = {
...
const V2betaFunction_StateMessagesFields: FieldMap = {
  message: "message",
  severity: "severity",
  type: "type",
};

const V2betaFunction_UpgradeInfoFields: FieldMap = {
  buildConfig: {
...
export interface V2betaFunctionConfig {
  /** Describes the Build step of the function that builds a container from the given source. */
  buildConfig?: V2betaFunction_BuildConfig | Computed<V2betaFunction_BuildConfig>;
  ...
  stateMessages?: V2betaFunction_StateMessages[] | Computed<V2betaFunction_StateMessages[]>;
  ...
  upgradeInfo?: V2betaFunction_UpgradeInfo | Computed<V2betaFunction_UpgradeInfo>;
  /** Output only. The deployed url for the function. */
  url?: string | Computed<string>;
}

export interface V2betaFunctionAttrs {
  /** Describes the Build step of the function that builds a container from the given source. */
  buildConfig: V2betaFunction_BuildConfig;
  /** Output only. The create timestamp of a Cloud Function. This is only applicable to 2nd Gen functions. */
  createTime: string;
  /** User-provided description of a function. */
  description: string;
  ...
  environment: string;
  /** Describes EventTrigger, used to request events to be sent from another service. */
  eventTrigger: V2betaFunction_EventTrigger;
  /** Resource name of a KMS crypto key (managed by the user) used to encrypt/decrypt function resources. It must match the pattern `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`. */
  kmsKeyName: string;
  /** Labels associated with this Cloud Function. */
  ...
  /** Describes the Service being deployed. Currently Supported : Cloud Run (fully managed). */
  serviceConfig: V2betaFunction_ServiceConfig;
  /** Output only. State of the function. */
  state: string;
  /** Output only. State Messages for this Cloud Function. */
  stateMessages: V2betaFunction_StateMessages[];
  /** Output only. The last update timestamp of a Cloud Function. */
  updateTime: string;
  /** Information related to: * A function's eligibility for 1st Gen to 2nd Gen migration. * Current state of migration for function undergoing migration. */
  upgradeInfo: V2betaFunction_UpgradeInfo;
  /** Output only. The deployed url for the function. */
  url: string;
}

export const V2betaFunction: ResourceBinding<V2betaFunctionConfig, V2betaFunctionAttrs> = {
  wireType: "google_cloudfunctions_v2beta_function",
  fields: {
    buildConfig: {
      wireName: "build_config",
      kind: "object",
    ...
    stateMessages: {
      ...
      kind: "list",
      fields: V2betaFunction_StateMessagesFields,
    },
