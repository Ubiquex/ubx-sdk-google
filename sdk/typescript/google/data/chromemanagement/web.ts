// Code generated by `ubx sdk gen` from google_chromemanagement_web. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface Web_AndroidAppInfo_Permissions {
  type?: string | Computed<string>;
}

export interface Web_AndroidAppInfo {
  /** Output only. Permissions requested by an Android app. */
  permissions?: Web_AndroidAppInfo_Permissions[] | Computed<Web_AndroidAppInfo_Permissions[]>;
}

export interface Web_ChromeAppInfo_Permissions {
  accessUserData?: boolean | Computed<boolean>;
  documentationUri?: string | Computed<string>;
  type?: string | Computed<string>;
}

export interface Web_ChromeAppInfo_SiteAccess {
  hostMatch?: string | Computed<string>;
}

export interface Web_ChromeAppInfo {
  ...
  permissions?: Web_ChromeAppInfo_Permissions[] | Computed<Web_ChromeAppInfo_Permissions[]>;
  ...
  siteAccess?: Web_ChromeAppInfo_SiteAccess[] | Computed<Web_ChromeAppInfo_SiteAccess[]>;
...
export interface Web_ServiceError {
...
export interface WebAttrs {
  ...
  androidAppInfo: Web_AndroidAppInfo;
  ...
  chromeAppInfo: Web_ChromeAppInfo;
