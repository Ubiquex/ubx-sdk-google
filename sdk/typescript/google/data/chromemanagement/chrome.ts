...
export interface Chrome_AndroidAppInfo_Permissions {
  type?: string | Computed<string>;
}

export interface Chrome_AndroidAppInfo {
  /** Output only. Permissions requested by an Android app. */
  permissions?: Chrome_AndroidAppInfo_Permissions[] | Computed<Chrome_AndroidAppInfo_Permissions[]>;
}

export interface Chrome_ChromeAppInfo_Permissions {
  accessUserData?: boolean | Computed<boolean>;
  documentationUri?: string | Computed<string>;
  type?: string | Computed<string>;
}

export interface Chrome_ChromeAppInfo_SiteAccess {
  hostMatch?: string | Computed<string>;
}

export interface Chrome_ChromeAppInfo {
  ...
  permissions?: Chrome_ChromeAppInfo_Permissions[] | Computed<Chrome_ChromeAppInfo_Permissions[]>;
  ...
  siteAccess?: Chrome_ChromeAppInfo_SiteAccess[] | Computed<Chrome_ChromeAppInfo_SiteAccess[]>;
...
export interface Chrome_ServiceError {
...
export interface ChromeAttrs {
  ...
  androidAppInfo: Chrome_AndroidAppInfo;
  ...
  chromeAppInfo: Chrome_ChromeAppInfo;
  ...
  serviceError: Chrome_ServiceError;
