...
export interface V1beta4Operation_AcquireSsrsLeaseContext {
...
export interface V1beta4Operation_ApiWarning {
...
export interface V1beta4Operation_BackupContext {
...
export interface V1beta4Operation_Error_Errors {
  code?: string | Computed<string>;
  kind?: string | Computed<string>;
  message?: string | Computed<string>;
}

export interface V1beta4Operation_Error {
  /** The list of errors encountered while processing this operation. */
  errors?: V1beta4Operation_Error_Errors[] | Computed<V1beta4Operation_Error_Errors[]>;
  /** This is always `sql#operationErrors`. */
  kind?: string | Computed<string>;
}

export interface V1beta4Operation_ExportContext_BakExportOptions {
...
export interface V1beta4Operation_ExportContext_CsvExportOptions {
...
export interface V1beta4Operation_ExportContext_SqlExportOptions_MysqlExportOptions {
...
export interface V1beta4Operation_ExportContext_SqlExportOptions_PostgresExportOptions {
...
export interface V1beta4Operation_ExportContext_SqlExportOptions {
  /** Options for exporting from MySQL. */
  mysqlExportOptions?: V1beta4Operation_ExportContext_SqlExportOptions_MysqlExportOptions | Computed<V1beta4Operation_ExportContext_SqlExportOptions_MysqlExportOptions>;
  /** Optional. Whether or not the export should be parallel. */
  parallel?: boolean | Computed<boolean>;
  /** Options for exporting from a Cloud SQL for PostgreSQL instance. */
  postgresExportOptions?: V1beta4Operation_ExportContext_SqlExportOptions_PostgresExportOptions | Computed<V1beta4Operation_ExportContext_SqlExportOptions_PostgresExportOptions>;
  /** Export only schemas. */
...
export interface V1beta4Operation_ExportContext_TdeExportOptions {
...
export interface V1beta4Operation_ExportContext {
  /** Options for exporting BAK files (SQL Server-only) */
  bakExportOptions?: V1beta4Operation_ExportContext_BakExportOptions | Computed<V1beta4Operation_ExportContext_BakExportOptions>;
  /** Options for exporting data as CSV. `MySQL` and `PostgreSQL` instances only. */
  csvExportOptions?: V1beta4Operation_ExportContext_CsvExportOptions | Computed<V1beta4Operation_ExportContext_CsvExportOptions>;
  ...
  sqlExportOptions?: V1beta4Operation_ExportContext_SqlExportOptions | Computed<V1beta4Operation_ExportContext_SqlExportOptions>;
  /** Optional. Export parameters specific to SQL Server TDE certificates */
  tdeExportOptions?: V1beta4Operation_ExportContext_TdeExportOptions | Computed<V1beta4Operation_ExportContext_TdeExportOptions>;
  /** The path to the file in Google Cloud Storage where the export will be stored. The URI is in the form `gs://bucketName/fileName`. If the file already exists, the request succeeds, but the operation fails. If `fileType` is `SQL` and the filename ends with .gz, the contents are compressed. */
  uri?: string | Computed<string>;
}

export interface V1beta4Operation_ImportContext_BakImportOptions_EncryptionOptions {
...
export interface V1beta4Operation_ImportContext_BakImportOptions {
  /** Type of the bak content, FULL or DIFF. */
  bakType?: string | Computed<string>;
  encryptionOptions?: V1beta4Operation_ImportContext_BakImportOptions_EncryptionOptions | Computed<V1beta4Operation_ImportContext_BakImportOptions_EncryptionOptions>;
...
export interface V1beta4Operation_ImportContext_CsvImportOptions {
...
export interface V1beta4Operation_ImportContext_SqlImportOptions {
  /** Optional. Whether or not the import should be parallel. */
  parallel?: boolean | Computed<boolean>;
  /** Optional. Options for importing from a Cloud SQL for PostgreSQL instance. */
  postgresImportOptions?: V1beta4Operation_ExportContext_SqlExportOptions_PostgresExportOptions | Computed<V1beta4Operation_ExportContext_SqlExportOptions_PostgresExportOptions>;
  /** Optional. The number of threads to use for parallel import. */
  threads?: number | Computed<number>;
}

export interface V1beta4Operation_ImportContext {
  /** Import parameters specific to SQL Server .BAK files */
  bakImportOptions?: V1beta4Operation_ImportContext_BakImportOptions | Computed<V1beta4Operation_ImportContext_BakImportOptions>;
  /** Options for importing data as CSV. */
  csvImportOptions?: V1beta4Operation_ImportContext_CsvImportOptions | Computed<V1beta4Operation_ImportContext_CsvImportOptions>;
  ...
  sqlImportOptions?: V1beta4Operation_ImportContext_SqlImportOptions | Computed<V1beta4Operation_ImportContext_SqlImportOptions>;
  /** Optional. Import parameters specific to SQL Server .TDE files Import parameters specific to SQL Server TDE certificates */
  tdeImportOptions?: V1beta4Operation_ExportContext_TdeExportOptions | Computed<V1beta4Operation_ExportContext_TdeExportOptions>;
  /** Path to the import file in Cloud Storage, in the form `gs://bucketName/fileName`. Compressed gzip files (.gz) are supported when `fileType` is `SQL`. The instance must have write permissions to the bucket and read access to the file. */
  uri?: string | Computed<string>;
}

export interface V1beta4Operation_PreCheckMajorVersionUpgradeContext_PreCheckResponse {
  actionsRequired?: string[] | Computed<string[]>;
  message?: string | Computed<string>;
  messageType?: string | Computed<string>;
}

export interface V1beta4Operation_PreCheckMajorVersionUpgradeContext {
  /** Optional. This is always `sql#preCheckMajorVersionUpgradeContext`. */
  kind?: string | Computed<string>;
  /** Output only. The responses from the precheck operation. */
  preCheckResponse?: V1beta4Operation_PreCheckMajorVersionUpgradeContext_PreCheckResponse[] | Computed<V1beta4Operation_PreCheckMajorVersionUpgradeContext_PreCheckResponse[]>;
  /** Required. The target database version to upgrade to. */
  targetDatabaseVersion?: string | Computed<string>;
}

export interface V1beta4Operation_SubOperationType {
  /** The type of maintenance to be performed on the instance. */
  maintenanceType?: string | Computed<string>;
}

export interface V1beta4OperationConfig {
  location?: string | Computed<string>;
  operation: string | Computed<string>;
  project: string | Computed<string>;
}

export interface V1beta4OperationAttrs {
  /** Acquire SSRS lease context. */
  acquireSsrsLeaseContext: V1beta4Operation_AcquireSsrsLeaseContext;
  /** An Admin API warning message. */
  apiWarning: V1beta4Operation_ApiWarning;
  /** Backup context. */
  backupContext: V1beta4Operation_BackupContext;
  ...
  error: V1beta4Operation_Error;
  /** Database instance export context. */
  exportContext: V1beta4Operation_ExportContext;
  /** Database instance import context. */
  importContext: V1beta4Operation_ImportContext;
  ...
  preCheckMajorVersionUpgradeContext: V1beta4Operation_PreCheckMajorVersionUpgradeContext;
  project: string;
  ...
  subOperationType: V1beta4Operation_SubOperationType;
...
export const V1beta4Operation: DataSourceBinding<V1beta4OperationConfig, V1beta4OperationAttrs> = {
