// Code generated by `ubx sdk gen` from google_sqladmin_v1beta4_connect. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface V1beta4Connect_DnsNames {
...
export interface V1beta4Connect_IpAddresses {
  ipAddress?: string | Computed<string>;
  timeToRetire?: string | Computed<string>;
  type?: string | Computed<string>;
}

export interface V1beta4Connect_Nodes {
  dnsName?: string | Computed<string>;
  dnsNames?: V1beta4Connect_DnsNames[] | Computed<V1beta4Connect_DnsNames[]>;
  ipAddresses?: V1beta4Connect_IpAddresses[] | Computed<V1beta4Connect_IpAddresses[]>;
  name?: string | Computed<string>;
}

export interface V1beta4Connect_ServerCaCert {
  /** PEM representation. */
...
export interface V1beta4ConnectConfig {
  instance: string | Computed<string>;
  project: string | Computed<string>;
  readTime?: string | Computed<string>;
}

export interface V1beta4ConnectAttrs {
  ...
  dnsNames: V1beta4Connect_DnsNames[];
  instance: string;
  /** The assigned IP addresses for the instance. */
  ipAddresses: V1beta4Connect_IpAddresses[];
  ...
  region: string;
  /** SslCerts Resource */
  serverCaCert: V1beta4Connect_ServerCaCert;
  /** Specify what type of CA is used for the server certificate. */
  serverCaMode: string;
}

export const V1beta4Connect: DataSourceBinding<V1beta4ConnectConfig, V1beta4ConnectAttrs> = {
  wireType: "google_sqladmin_v1beta4_connect",
  fields: {
    instance: "instance",
    project: "project",
    readTime: "read_time",
