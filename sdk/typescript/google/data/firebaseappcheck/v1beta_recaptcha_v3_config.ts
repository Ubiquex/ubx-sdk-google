...
export interface V1betaRecaptchaV3ConfigConfig {
  name: string | Computed<string>;
}

export interface V1betaRecaptchaV3ConfigAttrs {
...
export const V1betaRecaptchaV3Config: DataSourceBinding<V1betaRecaptchaV3ConfigConfig, V1betaRecaptchaV3ConfigAttrs> = {
