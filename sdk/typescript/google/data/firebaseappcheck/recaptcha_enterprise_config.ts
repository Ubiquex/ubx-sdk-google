...
export interface RecaptchaEnterpriseConfig_RiskAnalysis {
...
export interface RecaptchaEnterpriseConfigConfig {
  name: string | Computed<string>;
}

export interface RecaptchaEnterpriseConfigAttrs {
  name: string;
  ...
  riskAnalysis: RecaptchaEnterpriseConfig_RiskAnalysis;
...
export const RecaptchaEnterpriseConfig: DataSourceBinding<RecaptchaEnterpriseConfigConfig, RecaptchaEnterpriseConfigAttrs> = {
  wireType: "google_firebaseappcheck_recaptcha_enterprise_config",
  fields: {
    name: "name",
  },
};
