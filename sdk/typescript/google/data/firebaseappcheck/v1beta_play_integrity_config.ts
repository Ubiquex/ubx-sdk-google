// Code generated by `ubx sdk gen` from google_firebaseappcheck_v1beta_play_integrity_config. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface V1betaPlayIntegrityConfig_AccountDetails {
...
export interface V1betaPlayIntegrityConfig_AppIntegrity {
...
export interface V1betaPlayIntegrityConfig_DeviceIntegrity {
...
export interface V1betaPlayIntegrityConfigConfig {
  name: string | Computed<string>;
}

export interface V1betaPlayIntegrityConfigAttrs {
  ...
  accountDetails: V1betaPlayIntegrityConfig_AccountDetails;
  ...
  appIntegrity: V1betaPlayIntegrityConfig_AppIntegrity;
  ...
  deviceIntegrity: V1betaPlayIntegrityConfig_DeviceIntegrity;
  name: string;
...
export const V1betaPlayIntegrityConfig: DataSourceBinding<V1betaPlayIntegrityConfigConfig, V1betaPlayIntegrityConfigAttrs> = {
  wireType: "google_firebaseappcheck_v1beta_play_integrity_config",
  fields: {
    name: "name",
  },
};
