// Code generated by `ubx sdk gen` from google_firebaseappcheck_v1beta_recaptcha_config. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface V1betaRecaptchaConfigConfig {
  name: string | Computed<string>;
}

export interface V1betaRecaptchaConfigAttrs {
...
export const V1betaRecaptchaConfig: DataSourceBinding<V1betaRecaptchaConfigConfig, V1betaRecaptchaConfigAttrs> = {
  wireType: "google_firebaseappcheck_v1beta_recaptcha_config",
  fields: {
    name: "name",
  },
};
