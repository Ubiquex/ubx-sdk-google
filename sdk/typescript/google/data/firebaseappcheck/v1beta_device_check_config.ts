...
export interface V1betaDeviceCheckConfigConfig {
  name: string | Computed<string>;
}

export interface V1betaDeviceCheckConfigAttrs {
...
export const V1betaDeviceCheckConfig: DataSourceBinding<V1betaDeviceCheckConfigConfig, V1betaDeviceCheckConfigAttrs> = {
