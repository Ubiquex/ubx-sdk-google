// Code generated by `ubx sdk gen` from google_appengine_service. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface Service_NetworkSettings {
  /** The ingress settings for version or service. */
  ingressTrafficAllowed?: string | Computed<string>;
}

export interface Service_Split {
...
export interface ServiceAttrs {
  ...
  networkSettings: Service_NetworkSettings;
  servicesId: string;
