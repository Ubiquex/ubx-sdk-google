...
export interface V1betaAccessSummaryConfig {
}

export interface V1betaAccessSummaryAttrs {
...
export const V1betaAccessSummary: DataSourceBinding<V1betaAccessSummaryConfig, V1betaAccessSummaryAttrs> = {
