// Code generated by `ubx sdk gen` from google_gkehub_v1beta_rollout. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface V1betaRollout_MembershipStates_Targets {
...
export interface V1betaRollout_MembershipStates {
  lastUpdateTime?: string | Computed<string>;
  stageAssignment?: number | Computed<number>;
  targets?: V1betaRollout_MembershipStates_Targets[] | Computed<V1betaRollout_MembershipStates_Targets[]>;
}

export interface V1betaRollout_Stages_ClusterSelector {
  labelSelector?: string | Computed<string>;
}

export interface V1betaRollout_Stages {
  clusterSelector?: V1betaRollout_Stages_ClusterSelector | Computed<V1betaRollout_Stages_ClusterSelector>;
...
export interface V1betaRollout_VersionUpgrade {
...
export interface V1betaRolloutConfig {
...
export interface V1betaRolloutAttrs {
  ...
  membershipStates: Record<string, V1betaRollout_MembershipStates>;
  name: string;
  ...
  versionUpgrade: V1betaRollout_VersionUpgrade;
}

export const V1betaRollout: DataSourceBinding<V1betaRolloutConfig, V1betaRolloutAttrs> = {
  wireType: "google_gkehub_v1beta_rollout",
  fields: {
    name: "name",
  },
};
