...
export interface V1alphaWidgetConfig_AccessSettings {
...
export interface V1alphaWidgetConfig_AssistantSettings {
...
export interface V1alphaWidgetConfig_BatchAuthStatuses_ConnectorAuthState {
  authState?: string | Computed<string>;
  authorizationUri?: string | Computed<string>;
  updateTime?: string | Computed<string>;
}

export interface V1alphaWidgetConfig_BatchAuthStatuses {
  batchAuthorizationGroup?: string | Computed<string>;
  connectorAuthState?: V1alphaWidgetConfig_BatchAuthStatuses_ConnectorAuthState | Computed<V1alphaWidgetConfig_BatchAuthStatuses_ConnectorAuthState>;
  placeholder?: string | Computed<string>;
}

export interface V1alphaWidgetConfig_CollectionComponents_DataStoreComponents {
...
export interface V1alphaWidgetConfig_CollectionComponents_Metadata {
...
export interface V1alphaWidgetConfig_CollectionComponents {
  connectorAuthState?: V1alphaWidgetConfig_BatchAuthStatuses_ConnectorAuthState | Computed<V1alphaWidgetConfig_BatchAuthStatuses_ConnectorAuthState>;
  ...
  dataStoreComponents?: V1alphaWidgetConfig_CollectionComponents_DataStoreComponents[] | Computed<V1alphaWidgetConfig_CollectionComponents_DataStoreComponents[]>;
  displayName?: string | Computed<string>;
  id?: string | Computed<string>;
  isFirstParty?: boolean | Computed<boolean>;
  metadata?: V1alphaWidgetConfig_CollectionComponents_Metadata | Computed<V1alphaWidgetConfig_CollectionComponents_Metadata>;
  name?: string | Computed<string>;
}

export interface V1alphaWidgetConfig_ContentSearchSpec_ChunkSpec {
...
export interface V1alphaWidgetConfig_ContentSearchSpec_ExtractiveContentSpec {
...
export interface V1alphaWidgetConfig_ContentSearchSpec_SnippetSpec {
...
export interface V1alphaWidgetConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec {
...
export interface V1alphaWidgetConfig_ContentSearchSpec_SummarySpec_ModelSpec {
...
export interface V1alphaWidgetConfig_ContentSearchSpec_SummarySpec_MultimodalSpec {
  /** Optional. Source of image returned in the answer. */
  imageSource?: string | Computed<string>;
}

export interface V1alphaWidgetConfig_ContentSearchSpec_SummarySpec {
  ...
  modelPromptSpec?: V1alphaWidgetConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec | Computed<V1alphaWidgetConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec>;
  /** Specification of the model. */
  modelSpec?: V1alphaWidgetConfig_ContentSearchSpec_SummarySpec_ModelSpec | Computed<V1alphaWidgetConfig_ContentSearchSpec_SummarySpec_ModelSpec>;
  ...
  multimodalSpec?: V1alphaWidgetConfig_ContentSearchSpec_SummarySpec_MultimodalSpec | Computed<V1alphaWidgetConfig_ContentSearchSpec_SummarySpec_MultimodalSpec>;
...
export interface V1alphaWidgetConfig_ContentSearchSpec {
  ...
  chunkSpec?: V1alphaWidgetConfig_ContentSearchSpec_ChunkSpec | Computed<V1alphaWidgetConfig_ContentSearchSpec_ChunkSpec>;
  /** A specification for configuring the extractive content in a search response. */
  extractiveContentSpec?: V1alphaWidgetConfig_ContentSearchSpec_ExtractiveContentSpec | Computed<V1alphaWidgetConfig_ContentSearchSpec_ExtractiveContentSpec>;
  ...
  snippetSpec?: V1alphaWidgetConfig_ContentSearchSpec_SnippetSpec | Computed<V1alphaWidgetConfig_ContentSearchSpec_SnippetSpec>;
  /** A specification for configuring a summary returned in a search response. */
  summarySpec?: V1alphaWidgetConfig_ContentSearchSpec_SummarySpec | Computed<V1alphaWidgetConfig_ContentSearchSpec_SummarySpec>;
}
...
export interface V1alphaWidgetConfig_DataStoreUiConfigs_FacetField {
  displayName?: string | Computed<string>;
  field?: string | Computed<string>;
}

export interface V1alphaWidgetConfig_DataStoreUiConfigs_FieldsUiComponentsMap {
  deviceVisibility?: string[] | Computed<string[]>;
  displayTemplate?: string | Computed<string>;
  field?: string | Computed<string>;
}

export interface V1alphaWidgetConfig_DataStoreUiConfigs {
  facetField?: V1alphaWidgetConfig_DataStoreUiConfigs_FacetField[] | Computed<V1alphaWidgetConfig_DataStoreUiConfigs_FacetField[]>;
  fieldsUiComponentsMap?: Record<string, V1alphaWidgetConfig_DataStoreUiConfigs_FieldsUiComponentsMap> | Computed<Record<string, V1alphaWidgetConfig_DataStoreUiConfigs_FieldsUiComponentsMap>>;
  id?: string | Computed<string>;
  name?: string | Computed<string>;
}

export interface V1alphaWidgetConfig_HomepageSetting_Shortcuts_Icon {
  url?: string | Computed<string>;
}

export interface V1alphaWidgetConfig_HomepageSetting_Shortcuts {
  destinationUri?: string | Computed<string>;
  icon?: V1alphaWidgetConfig_HomepageSetting_Shortcuts_Icon | Computed<V1alphaWidgetConfig_HomepageSetting_Shortcuts_Icon>;
  title?: string | Computed<string>;
}

export interface V1alphaWidgetConfig_HomepageSetting {
  /** Optional. The shortcuts to display on the homepage. */
  shortcuts?: V1alphaWidgetConfig_HomepageSetting_Shortcuts[] | Computed<V1alphaWidgetConfig_HomepageSetting_Shortcuts[]>;
}

export interface V1alphaWidgetConfig_Nodes {
  description?: string | Computed<string>;
  displayName?: string | Computed<string>;
...
export interface V1alphaWidgetConfig_UiBranding {
  /** Options to store an image. */
  logo?: V1alphaWidgetConfig_HomepageSetting_Shortcuts_Icon | Computed<V1alphaWidgetConfig_HomepageSetting_Shortcuts_Icon>;
}

export interface V1alphaWidgetConfig_UiSettings_GenerativeAnswerConfig {
...
export interface V1alphaWidgetConfig_UiSettings_ModelConfigInfo_ResolvedModels_AdminView {
  adminOverridable?: boolean | Computed<boolean>;
  enabledByDefault?: boolean | Computed<boolean>;
  regions?: string[] | Computed<string[]>;
}

export interface V1alphaWidgetConfig_UiSettings_ModelConfigInfo_ResolvedModels {
  adminView?: V1alphaWidgetConfig_UiSettings_ModelConfigInfo_ResolvedModels_AdminView | Computed<V1alphaWidgetConfig_UiSettings_ModelConfigInfo_ResolvedModels_AdminView>;
  description?: string | Computed<string>;
  displayName?: string | Computed<string>;
...
export interface V1alphaWidgetConfig_UiSettings_ModelConfigInfo {
  ...
  resolvedModels?: V1alphaWidgetConfig_UiSettings_ModelConfigInfo_ResolvedModels[] | Computed<V1alphaWidgetConfig_UiSettings_ModelConfigInfo_ResolvedModels[]>;
}

export interface V1alphaWidgetConfig_UiSettings_SearchAddonSpec {
...
export interface V1alphaWidgetConfig_UiSettings {
  /** Per data store configuration. */
  dataStoreUiConfigs?: V1alphaWidgetConfig_DataStoreUiConfigs[] | Computed<V1alphaWidgetConfig_DataStoreUiConfigs[]>;
  ...
  modelConfigInfo?: V1alphaWidgetConfig_UiSettings_ModelConfigInfo | Computed<V1alphaWidgetConfig_UiSettings_ModelConfigInfo>;
  ...
  searchAddonSpec?: V1alphaWidgetConfig_UiSettings_SearchAddonSpec | Computed<V1alphaWidgetConfig_UiSettings_SearchAddonSpec>;
...
export interface V1alphaWidgetConfigConfig {
...
export interface V1alphaWidgetConfigAttrs {
  acceptCache: boolean;
  /** Describes widget access settings. */
  accessSettings: V1alphaWidgetConfig_AccessSettings;
  ...
  assistantSettings: V1alphaWidgetConfig_AssistantSettings;
  /** Output only. The batch authorization statuses for the widget's connectors. */
  batchAuthStatuses: V1alphaWidgetConfig_BatchAuthStatuses[];
  ...
  collectionComponents: V1alphaWidgetConfig_CollectionComponents[];
  /** Output only. Unique obfuscated identifier of a WidgetConfig. */
  configId: string;
  /** A specification for configuring the behavior of content search. */
  contentSearchSpec: V1alphaWidgetConfig_ContentSearchSpec;
  /** Output only. Timestamp the WidgetConfig was created. */
  createTime: string;
  /** Customer provided configurations. */
  customerProvidedConfig: V1alphaWidgetConfig_CustomerProvidedConfig;
  /** Output only. The type of the parent data store. */
  dataStoreType: string;
  /** Configurable UI configurations per data store. */
  dataStoreUiConfigs: V1alphaWidgetConfig_DataStoreUiConfigs[];
  /** The default ordering for search results if specified. Used to set SearchRequest#order_by on applicable requests. https://cloud.google.com/generative-ai-app-builder/docs/reference/rest/v1alpha/projects.locations.dataStores.servingConfigs/search#request-body */
  ...
  facetField: V1alphaWidgetConfig_DataStoreUiConfigs_FacetField[];
  ...
  fieldsUiComponentsMap: Record<string, V1alphaWidgetConfig_DataStoreUiConfigs_FieldsUiComponentsMap>;
  ...
  homepageSetting: V1alphaWidgetConfig_HomepageSetting;
  ...
  nodes: V1alphaWidgetConfig_Nodes[];
  ...
  uiBranding: V1alphaWidgetConfig_UiBranding;
  /** Describes general widget (or web app) UI settings as seen in the cloud console UI configuration page. */
  uiSettings: V1alphaWidgetConfig_UiSettings;
  /** Output only. Timestamp the WidgetConfig was updated. */
  updateTime: string;
}

export const V1alphaWidgetConfig: DataSourceBinding<V1alphaWidgetConfigConfig, V1alphaWidgetConfigAttrs> = {
  wireType: "google_discoveryengine_v1alpha_widget_config",
  fields: {
