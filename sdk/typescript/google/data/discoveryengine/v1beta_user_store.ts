...
export interface V1betaUserStoreConfig {
  name: string | Computed<string>;
}

export interface V1betaUserStoreAttrs {
...
export const V1betaUserStore: DataSourceBinding<V1betaUserStoreConfig, V1betaUserStoreAttrs> = {
  wireType: "google_discoveryengine_v1beta_user_store",
  fields: {
    name: "name",
  },
};
