...
export interface Job_DriverSchedulingConfig {
...
export interface Job_FlinkJob_LoggingConfig {
...
export interface Job_FlinkJob {
  ...
  loggingConfig?: Job_FlinkJob_LoggingConfig | Computed<Job_FlinkJob_LoggingConfig>;
...
export interface Job_HadoopJob {
...
export interface Job_HiveJob {
  ...
  queryList?: Job_HiveJob_QueryList | Computed<Job_HiveJob_QueryList>;
  /** Optional. Mapping of query variable names to values (equivalent to the Hive command: SET name="value";). */
  scriptVariables?: Record<string, string> | Computed<Record<string, string>>;
}

export interface Job_PigJob {
  /** Optional. Whether to continue executing queries if a query fails. The default value is false. Setting to true can be useful when executing independent parallel queries. */
  continueOnFailure?: boolean | Computed<boolean>;
...
export interface Job_PrestoJob {
...
export interface Job_PysparkJob {
...
export interface Job_SparkRjob {
...
export interface Job_SparkSqlJob {
...
export interface Job_YarnApplications {
  memoryMbSeconds?: string | Computed<string>;
  name?: string | Computed<string>;
  progress?: number | Computed<number>;
  state?: string | Computed<string>;
  trackingUrl?: string | Computed<string>;
  vcoreSeconds?: string | Computed<string>;
}
...
export interface JobAttrs {
  ...
  driverSchedulingConfig: Job_DriverSchedulingConfig;
  /** A Dataproc job for running Apache Flink applications on YARN. */
  flinkJob: Job_FlinkJob;
  /** A Dataproc job for running Apache Hadoop MapReduce (https://hadoop.apache.org/docs/current/hadoop-mapreduce-client/hadoop-mapreduce-client-core/MapReduceTutorial.html) jobs on Apache Hadoop YARN (https://hadoop.apache.org/docs/r2.7.1/hadoop-yarn/hadoop-yarn-site/YARN.html). */
  hadoopJob: Job_HadoopJob;
  ...
  sparkJob: Job_HadoopJob;
  /** A Dataproc job for running Apache SparkR (https://spark.apache.org/docs/latest/sparkr.html) applications on YARN. */
  sparkRjob: Job_SparkRjob;
  /** A Dataproc job for running Apache Spark SQL (https://spark.apache.org/sql/) queries. */
  sparkSqlJob: Job_SparkSqlJob;
  /** Dataproc job status. */
  status: Job_Status;
  /** Output only. The previous job status. */
  statusHistory: Job_Status[];
  /** A Dataproc job for running Trino (https://trino.io/) queries. IMPORTANT: The Dataproc Trino Optional Component (https://cloud.google.com/dataproc/docs/concepts/components/trino) must be enabled when the cluster is created to submit a Trino job to the cluster. */
  trinoJob: Job_PrestoJob;
  ...
  yarnApplications: Job_YarnApplications[];
}
