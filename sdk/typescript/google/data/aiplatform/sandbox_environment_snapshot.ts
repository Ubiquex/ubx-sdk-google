...
export interface SandboxEnvironmentSnapshotConfig {
  name: string | Computed<string>;
}

export interface SandboxEnvironmentSnapshotAttrs {
...
export const SandboxEnvironmentSnapshot: DataSourceBinding<SandboxEnvironmentSnapshotConfig, SandboxEnvironmentSnapshotAttrs> = {
  wireType: "google_aiplatform_sandbox_environment_snapshot",
  fields: {
    name: "name",
  },
};
