...
export interface NotebookRuntime_DataPersistentDiskSpec {
...
export interface NotebookRuntime_EncryptionSpec {
  /** Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`. */
  kmsKeyName?: string | Computed<string>;
}

export interface NotebookRuntime_EucConfig {
...
export interface NotebookRuntime_IdleShutdownConfig {
...
export interface NotebookRuntime_MachineSpec_ReservationAffinity {
...
export interface NotebookRuntime_MachineSpec {
  ...
  reservationAffinity?: NotebookRuntime_MachineSpec_ReservationAffinity | Computed<NotebookRuntime_MachineSpec_ReservationAffinity>;
  /** Immutable. The topology of the TPUs. Corresponds to the TPU topologies available from GKE. (Example: tpu_topology: "2x2x1"). */
  tpuTopology?: string | Computed<string>;
}

export interface NotebookRuntime_NetworkSpec {
...
export interface NotebookRuntime_NotebookRuntimeTemplateRef {
  /** Immutable. A resource name of the NotebookRuntimeTemplate. */
  notebookRuntimeTemplate?: string | Computed<string>;
}

export interface NotebookRuntime_ReservationAffinity {
...
export interface NotebookRuntime_ShieldedVmConfig {
...
export interface NotebookRuntime_SoftwareConfig_ColabImage {
...
export interface NotebookRuntime_SoftwareConfig_Env {
  name?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface NotebookRuntime_SoftwareConfig_PostStartupScriptConfig {
...
export interface NotebookRuntime_SoftwareConfig {
  /** Colab image of the runtime. */
  colabImage?: NotebookRuntime_SoftwareConfig_ColabImage | Computed<NotebookRuntime_SoftwareConfig_ColabImage>;
  /** Optional. Environment variables to be passed to the container. Maximum limit is 100. */
  env?: NotebookRuntime_SoftwareConfig_Env[] | Computed<NotebookRuntime_SoftwareConfig_Env[]>;
  /** Post startup script config. */
  postStartupScriptConfig?: NotebookRuntime_SoftwareConfig_PostStartupScriptConfig | Computed<NotebookRuntime_SoftwareConfig_PostStartupScriptConfig>;
}
...
export interface NotebookRuntimeAttrs {
  ...
  dataPersistentDiskSpec: NotebookRuntime_DataPersistentDiskSpec;
  ...
  encryptionSpec: NotebookRuntime_EncryptionSpec;
  /** The euc configuration of NotebookRuntimeTemplate. */
  eucConfig: NotebookRuntime_EucConfig;
  /** Output only. Timestamp when this NotebookRuntime will be expired: 1. System Predefined NotebookRuntime: 24 hours after creation. After expiration, system predifined runtime will be deleted. 2. User created NotebookRuntime: 6 months after last upgrade. After expiration, user created runtime will be stopped and allowed for upgrade. */
  expirationTime: string;
  /** Output only. The health state of the NotebookRuntime. */
  healthState: string;
  /** The idle shutdown configuration of NotebookRuntimeTemplate, which contains the idle_timeout as required field. */
  idleShutdownConfig: NotebookRuntime_IdleShutdownConfig;
  ...
  machineSpec: NotebookRuntime_MachineSpec;
  name: string;
  /** Network spec. */
  networkSpec: NotebookRuntime_NetworkSpec;
  ...
  notebookRuntimeTemplateRef: NotebookRuntime_NotebookRuntimeTemplateRef;
  /** Output only. The type of the notebook runtime. */
  notebookRuntimeType: string;
  /** Output only. The proxy endpoint used to access the NotebookRuntime. */
  proxyUri: string;
  /** Notebook Reservation Affinity for consuming Zonal reservation. */
  reservationAffinity: NotebookRuntime_ReservationAffinity;
