...
export interface Model_BaseModelSource_GenieSource {
  /** Required. The public base model URI. */
  baseModelUri?: string | Computed<string>;
}

export interface Model_BaseModelSource_ModelGardenSource {
...
export interface Model_BaseModelSource {
  ...
  genieSource?: Model_BaseModelSource_GenieSource | Computed<Model_BaseModelSource_GenieSource>;
  /** Contains information about the source of the models generated from Model Garden. */
  modelGardenSource?: Model_BaseModelSource_ModelGardenSource | Computed<Model_BaseModelSource_ModelGardenSource>;
}

export interface Model_Checkpoints {
  checkpointId?: string | Computed<string>;
  epoch?: string | Computed<string>;
  step?: string | Computed<string>;
}

export interface Model_ContainerSpec_Env {
  name?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface Model_ContainerSpec_GrpcPorts {
  containerPort?: number | Computed<number>;
}

export interface Model_ContainerSpec_HealthProbe_Exec {
  /** Command is the command line to execute inside the container, the working directory for the command is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy. */
  command?: string[] | Computed<string[]>;
}

export interface Model_ContainerSpec_HealthProbe_Grpc {
...
export interface Model_ContainerSpec_HealthProbe_HttpGet {
  ...
  httpHeaders?: Model_ContainerSpec_Env[] | Computed<Model_ContainerSpec_Env[]>;
...
export interface Model_ContainerSpec_HealthProbe_TcpSocket {
...
export interface Model_ContainerSpec_HealthProbe {
  /** ExecAction specifies a command to execute. */
  exec?: Model_ContainerSpec_HealthProbe_Exec | Computed<Model_ContainerSpec_HealthProbe_Exec>;
  ...
  grpc?: Model_ContainerSpec_HealthProbe_Grpc | Computed<Model_ContainerSpec_HealthProbe_Grpc>;
  /** HttpGetAction describes an action based on HTTP Get requests. */
  httpGet?: Model_ContainerSpec_HealthProbe_HttpGet | Computed<Model_ContainerSpec_HealthProbe_HttpGet>;
  ...
  tcpSocket?: Model_ContainerSpec_HealthProbe_TcpSocket | Computed<Model_ContainerSpec_HealthProbe_TcpSocket>;
  /** Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. Must be greater or equal to period_seconds. Maps to Kubernetes probe argument 'timeoutSeconds'. */
  timeoutSeconds?: number | Computed<number>;
}

export interface Model_ContainerSpec {
  ...
  env?: Model_ContainerSpec_Env[] | Computed<Model_ContainerSpec_Env[]>;
  ...
  grpcPorts?: Model_ContainerSpec_GrpcPorts[] | Computed<Model_ContainerSpec_GrpcPorts[]>;
  /** Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic. */
  healthProbe?: Model_ContainerSpec_HealthProbe | Computed<Model_ContainerSpec_HealthProbe>;
  ...
  /** Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic. */
  livenessProbe?: Model_ContainerSpec_HealthProbe | Computed<Model_ContainerSpec_HealthProbe>;
  /** Immutable. List of ports to expose from the container. Vertex AI sends any prediction requests that it receives to the first port on this list. Vertex AI also sends [liveness and health checks](https://cloud.google.com/vertex-ai/docs/predictions/custom-container-requirements#liveness) to this port. If you do not specify this field, it defaults to following value: ```json [ { "containerPort": 8080 } ] ``` Vertex AI does not use ports other than the first one listed. This field corresponds to the `ports` field of the Kubernetes Containers [v1 core API](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#container-v1-core). */
  ports?: Model_ContainerSpec_GrpcPorts[] | Computed<Model_ContainerSpec_GrpcPorts[]>;
  ...
  /** Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic. */
  startupProbe?: Model_ContainerSpec_HealthProbe | Computed<Model_ContainerSpec_HealthProbe>;
}
...
export interface Model_ExplanationSpec_Metadata_Inputs_Visualization {
...
export interface Model_ExplanationSpec_Metadata_Inputs {
  ...
  featureValueDomain?: Model_ExplanationSpec_Metadata_Inputs_FeatureValueDomain | Computed<Model_ExplanationSpec_Metadata_Inputs_FeatureValueDomain>;
  ...
  visualization?: Model_ExplanationSpec_Metadata_Inputs_Visualization | Computed<Model_ExplanationSpec_Metadata_Inputs_Visualization>;
}

export interface Model_ExplanationSpec_Metadata_Outputs {
...
export interface Model_ExplanationSpec_Metadata {
  ...
  inputs?: Record<string, Model_ExplanationSpec_Metadata_Inputs> | Computed<Record<string, Model_ExplanationSpec_Metadata_Inputs>>;
  ...
  outputs?: Record<string, Model_ExplanationSpec_Metadata_Outputs> | Computed<Record<string, Model_ExplanationSpec_Metadata_Outputs>>;
}

export interface Model_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource {
  /** Required. Google Cloud Storage URI(-s) to the input file(s). May contain wildcards. For more information on wildcards, see https://cloud.google.com/storage/docs/wildcards. */
  uris?: string[] | Computed<string[]>;
}

export interface Model_ExplanationSpec_Parameters_Examples_ExampleGcsSource {
  /** The format in which instances are given, if not specified, assume it's JSONL format. Currently only JSONL format is supported. */
  dataFormat?: string | Computed<string>;
  /** The Google Cloud Storage location for the input content. */
  gcsSource?: Model_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource | Computed<Model_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource>;
}

export interface Model_ExplanationSpec_Parameters_Examples_Presets {
...
export interface Model_ExplanationSpec_Parameters_Examples {
  /** The Cloud Storage input instances. */
  exampleGcsSource?: Model_ExplanationSpec_Parameters_Examples_ExampleGcsSource | Computed<Model_ExplanationSpec_Parameters_Examples_ExampleGcsSource>;
  ...
  presets?: Model_ExplanationSpec_Parameters_Examples_Presets | Computed<Model_ExplanationSpec_Parameters_Examples_Presets>;
}

export interface Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig {
...
export interface Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma {
  name?: string | Computed<string>;
  sigma?: number | Computed<number>;
}

export interface Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma {
  /** Noise sigma per feature. No noise is added to features that are not set. */
  noiseSigma?: Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma[] | Computed<Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma[]>;
}

export interface Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig {
  /** Noise sigma by features. Noise sigma represents the standard deviation of the gaussian kernel that will be used to add noise to interpolated inputs prior to computing gradients. */
  featureNoiseSigma?: Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma | Computed<Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma>;
...
export interface Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution {
  ...
  blurBaselineConfig?: Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig | Computed<Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig>;
  /** Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf */
  smoothGradConfig?: Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig | Computed<Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig>;
...
export interface Model_ExplanationSpec_Parameters_SampledShapleyAttribution {
...
export interface Model_ExplanationSpec_Parameters {
  /** Example-based explainability that returns the nearest neighbors from the provided dataset. */
  examples?: Model_ExplanationSpec_Parameters_Examples | Computed<Model_ExplanationSpec_Parameters_Examples>;
  /** An attribution method that computes the Aumann-Shapley value taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1703.01365 */
  integratedGradientsAttribution?: Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution | Computed<Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution>;
  ...
  sampledShapleyAttribution?: Model_ExplanationSpec_Parameters_SampledShapleyAttribution | Computed<Model_ExplanationSpec_Parameters_SampledShapleyAttribution>;
  ...
  xraiAttribution?: Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution | Computed<Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution>;
}

export interface Model_ExplanationSpec {
  /** Metadata describing the Model's input and output for explanation. */
  metadata?: Model_ExplanationSpec_Metadata | Computed<Model_ExplanationSpec_Metadata>;
  /** Parameters to configure explaining for Model's predictions. */
  parameters?: Model_ExplanationSpec_Parameters | Computed<Model_ExplanationSpec_Parameters>;
}

export interface Model_ModelSourceInfo {
...
export interface Model_PredictSchemata {
...
export interface Model_SupportedExportFormats {
...
export interface ModelAttrs {
  ...
  containerSpec: Model_ContainerSpec;
  ...
  deployedModels: Model_DeployedModels[];
  ...
  encryptionSpec: Model_EncryptionSpec;
  /** Used to perform consistent read-modify-write updates. If not set, a blind "overwrite" update happens. */
  etag: string;
  /** Specification of Model explanation. */
  explanationSpec: Model_ExplanationSpec;
  ...
  modelSourceInfo: Model_ModelSourceInfo;
  name: string;
  ...
  predictSchemata: Model_PredictSchemata;
  ...
  supportedExportFormats: Model_SupportedExportFormats[];
