// Code generated by `ubx sdk gen` from google_aiplatform_feature_view_sync. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface FeatureViewSync_FinalStatus {
...
export interface FeatureViewSync_RunTime {
...
export interface FeatureViewSyncConfig {
  name: string | Computed<string>;
}

export interface FeatureViewSyncAttrs {
  ...
  finalStatus: FeatureViewSync_FinalStatus;
  name: string;
  /** Represents a time interval, encoded as a Timestamp start (inclusive) and a Timestamp end (exclusive). The start must be less than or equal to the end. When the start equals the end, the interval is empty (matches no time). When both start and end are unspecified, the interval matches any time. */
  runTime: FeatureViewSync_RunTime;
...
export const FeatureViewSync: DataSourceBinding<FeatureViewSyncConfig, FeatureViewSyncAttrs> = {
  wireType: "google_aiplatform_feature_view_sync",
  fields: {
    name: "name",
  },
};
