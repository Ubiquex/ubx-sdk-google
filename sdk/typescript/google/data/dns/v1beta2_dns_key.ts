...
export interface V1beta2DnsKey_Digests {
  digest?: string | Computed<string>;
  type?: string | Computed<string>;
}

export interface V1beta2DnsKeyConfig {
...
export interface V1beta2DnsKeyAttrs {
...
export const V1beta2DnsKey: DataSourceBinding<V1beta2DnsKeyConfig, V1beta2DnsKeyAttrs> = {
  wireType: "google_dns_v1beta2_dns_key",
  fields: {
