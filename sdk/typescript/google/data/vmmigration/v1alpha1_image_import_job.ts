...
export interface V1alpha1ImageImportJob_DiskImageTargetDetails_DataDiskImageImport {
...
export interface V1alpha1ImageImportJob_DiskImageTargetDetails_Encryption {
  /** Required. The name of the encryption key that is stored in Google Cloud KMS. */
  kmsKey?: string | Computed<string>;
}

export interface V1alpha1ImageImportJob_DiskImageTargetDetails_OsAdaptationParameters_AdaptationModifiers {
  modifier?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface V1alpha1ImageImportJob_DiskImageTargetDetails_OsAdaptationParameters {
  /** Optional. Modifiers to be used as configuration of the OS adaptation process. */
  adaptationModifiers?: V1alpha1ImageImportJob_DiskImageTargetDetails_OsAdaptationParameters_AdaptationModifiers[] | Computed<V1alpha1ImageImportJob_DiskImageTargetDetails_OsAdaptationParameters_AdaptationModifiers[]>;
...
export interface V1alpha1ImageImportJob_DiskImageTargetDetails {
  ...
  dataDiskImageImport?: V1alpha1ImageImportJob_DiskImageTargetDetails_DataDiskImageImport | Computed<V1alpha1ImageImportJob_DiskImageTargetDetails_DataDiskImageImport>;
  /** Optional. An optional description of the image. */
  description?: string | Computed<string>;
  /** Encryption message describes the details of the applied encryption. */
  encryption?: V1alpha1ImageImportJob_DiskImageTargetDetails_Encryption | Computed<V1alpha1ImageImportJob_DiskImageTargetDetails_Encryption>;
  ...
  osAdaptationParameters?: V1alpha1ImageImportJob_DiskImageTargetDetails_OsAdaptationParameters | Computed<V1alpha1ImageImportJob_DiskImageTargetDetails_OsAdaptationParameters>;
...
export interface V1alpha1ImageImportJob_Errors {
  code?: number | Computed<number>;
  details?: Record<string, unknown>[] | Computed<Record<string, unknown>[]>;
  message?: string | Computed<string>;
}

export interface V1alpha1ImageImportJob_MachineImageTargetDetails_MachineImageParametersOverrides {
...
export interface V1alpha1ImageImportJob_MachineImageTargetDetails_NetworkInterfaces {
...
export interface V1alpha1ImageImportJob_MachineImageTargetDetails_ServiceAccount {
...
export interface V1alpha1ImageImportJob_MachineImageTargetDetails_ShieldedInstanceConfig {
...
export interface V1alpha1ImageImportJob_MachineImageTargetDetails {
  ...
  machineImageParametersOverrides?: V1alpha1ImageImportJob_MachineImageTargetDetails_MachineImageParametersOverrides | Computed<V1alpha1ImageImportJob_MachineImageTargetDetails_MachineImageParametersOverrides>;
  ...
  networkInterfaces?: V1alpha1ImageImportJob_MachineImageTargetDetails_NetworkInterfaces[] | Computed<V1alpha1ImageImportJob_MachineImageTargetDetails_NetworkInterfaces[]>;
  /** Parameters affecting the OS adaptation process. */
  osAdaptationParameters?: V1alpha1ImageImportJob_DiskImageTargetDetails_OsAdaptationParameters | Computed<V1alpha1ImageImportJob_DiskImageTargetDetails_OsAdaptationParameters>;
  /** Service account to assign to the instance created by the machine image. */
  serviceAccount?: V1alpha1ImageImportJob_MachineImageTargetDetails_ServiceAccount | Computed<V1alpha1ImageImportJob_MachineImageTargetDetails_ServiceAccount>;
  /** Shielded instance configuration. */
  shieldedInstanceConfig?: V1alpha1ImageImportJob_MachineImageTargetDetails_ShieldedInstanceConfig | Computed<V1alpha1ImageImportJob_MachineImageTargetDetails_ShieldedInstanceConfig>;
...
export interface V1alpha1ImageImportJob_Steps {
...
export interface V1alpha1ImageImportJob_Warnings_ActionItem {
  locale?: string | Computed<string>;
  message?: string | Computed<string>;
}

export interface V1alpha1ImageImportJob_Warnings_HelpLinks {
  description?: string | Computed<string>;
  url?: string | Computed<string>;
}

export interface V1alpha1ImageImportJob_Warnings {
  actionItem?: V1alpha1ImageImportJob_Warnings_ActionItem | Computed<V1alpha1ImageImportJob_Warnings_ActionItem>;
  code?: string | Computed<string>;
  helpLinks?: V1alpha1ImageImportJob_Warnings_HelpLinks[] | Computed<V1alpha1ImageImportJob_Warnings_HelpLinks[]>;
  warningMessage?: V1alpha1ImageImportJob_Warnings_ActionItem | Computed<V1alpha1ImageImportJob_Warnings_ActionItem>;
  warningTime?: string | Computed<string>;
}

export interface V1alpha1ImageImportJobConfig {
  name: string | Computed<string>;
}

export interface V1alpha1ImageImportJobAttrs {
  ...
  diskImageTargetDetails: V1alpha1ImageImportJob_DiskImageTargetDetails;
  ...
  errors: V1alpha1ImageImportJob_Errors[];
  /** The target details of the machine image resource that will be created by the image import job. */
  machineImageTargetDetails: V1alpha1ImageImportJob_MachineImageTargetDetails;
  name: string;
  /** Output only. The state of the image import. */
  state: string;
  /** Output only. The image import steps list representing its progress. */
  steps: V1alpha1ImageImportJob_Steps[];
  /** Output only. Warnings that occurred during the image import. */
  warnings: V1alpha1ImageImportJob_Warnings[];
}

export const V1alpha1ImageImportJob: DataSourceBinding<V1alpha1ImageImportJobConfig, V1alpha1ImageImportJobAttrs> = {
