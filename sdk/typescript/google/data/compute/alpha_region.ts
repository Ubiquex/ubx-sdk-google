...
export interface AlphaRegion_Deprecated_StateOverride {
...
export interface AlphaRegion_Deprecated {
  ...
  stateOverride?: AlphaRegion_Deprecated_StateOverride | Computed<AlphaRegion_Deprecated_StateOverride>;
}

export interface AlphaRegion_QuotaStatusWarning_Data {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface AlphaRegion_QuotaStatusWarning {
  /** [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response. */
  code?: string | Computed<string>;
  /** [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }] */
  data?: AlphaRegion_QuotaStatusWarning_Data[] | Computed<AlphaRegion_QuotaStatusWarning_Data[]>;
  /** [Output Only] A human-readable description of the warning code. */
  message?: string | Computed<string>;
}

export interface AlphaRegion_Quotas {
...
export interface AlphaRegionConfig {
  project: string | Computed<string>;
  region: string | Computed<string>;
}

export interface AlphaRegionAttrs {
  /** [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp: string;
  /** Deprecation status for a public resource. */
  deprecated: AlphaRegion_Deprecated;
  ...
  quotaStatusWarning: AlphaRegion_QuotaStatusWarning;
  /** [Output Only] Quotas assigned to this region. */
  quotas: AlphaRegion_Quotas[];
  region: string;
...
export const AlphaRegion: DataSourceBinding<AlphaRegionConfig, AlphaRegionAttrs> = {
