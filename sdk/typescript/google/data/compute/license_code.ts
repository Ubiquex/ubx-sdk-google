...
export interface LicenseCode_LicenseAlias {
  description?: string | Computed<string>;
  selfLink?: string | Computed<string>;
}

export interface LicenseCode_MinimumRetention {
...
export interface LicenseCodeConfig {
  licenseCode: string | Computed<string>;
  project: string | Computed<string>;
}

export interface LicenseCodeAttrs {
  ...
  licenseAlias: LicenseCode_LicenseAlias[];
  licenseCode: string;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  minimumRetention: LicenseCode_MinimumRetention;
...
export const LicenseCode: DataSourceBinding<LicenseCodeConfig, LicenseCodeAttrs> = {
