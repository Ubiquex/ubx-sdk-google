// Code generated by `ubx sdk gen` from google_compute_alpha_rollout. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface AlphaRollout_RolloutEntity_OrchestratedEntity {
...
export interface AlphaRollout_RolloutEntity {
  /** This message is used if the resource type follows the Orchestrated integration model with ProgressiveRollout. */
  orchestratedEntity?: AlphaRollout_RolloutEntity_OrchestratedEntity | Computed<AlphaRollout_RolloutEntity_OrchestratedEntity>;
}

export interface AlphaRollout_WaveDetails_OrchestratedWaveDetails_LocationStatus {
  state?: string | Computed<string>;
}

export interface AlphaRollout_WaveDetails_OrchestratedWaveDetails {
  ...
  locationStatus?: Record<string, AlphaRollout_WaveDetails_OrchestratedWaveDetails_LocationStatus> | Computed<Record<string, AlphaRollout_WaveDetails_OrchestratedWaveDetails_LocationStatus>>;
}

export interface AlphaRollout_WaveDetails {
  orchestratedWaveDetails?: AlphaRollout_WaveDetails_OrchestratedWaveDetails | Computed<AlphaRollout_WaveDetails_OrchestratedWaveDetails>;
  waveDisplayName?: string | Computed<string>;
  waveNumber?: string | Computed<string>;
}

export interface AlphaRolloutConfig {
  project: string | Computed<string>;
  rollout: string | Computed<string>;
}

export interface AlphaRolloutAttrs {
  ...
  rolloutEntity: AlphaRollout_RolloutEntity;
  ...
  waveDetails: AlphaRollout_WaveDetails[];
}

export const AlphaRollout: DataSourceBinding<AlphaRolloutConfig, AlphaRolloutAttrs> = {
  wireType: "google_compute_alpha_rollout",
  fields: {
    project: "project",
    rollout: "rollout",
  },
