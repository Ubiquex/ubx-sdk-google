...
export interface AlphaDiskType_Deprecated_StateOverride {
...
export interface AlphaDiskType_Deprecated {
  ...
  stateOverride?: AlphaDiskType_Deprecated_StateOverride | Computed<AlphaDiskType_Deprecated_StateOverride>;
}

export interface AlphaDiskTypeConfig {
  diskType: string | Computed<string>;
  project: string | Computed<string>;
  zone: string | Computed<string>;
}

export interface AlphaDiskTypeAttrs {
  /** [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp: string;
  /** [Output Only] Server-defined default disk size in GB. */
  defaultDiskSizeGb: string;
  /** Deprecation status for a public resource. */
  deprecated: AlphaDiskType_Deprecated;
...
export const AlphaDiskType: DataSourceBinding<AlphaDiskTypeConfig, AlphaDiskTypeAttrs> = {
