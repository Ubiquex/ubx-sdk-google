...
export interface RegionInstanceGroup_NamedPorts {
  name?: string | Computed<string>;
  port?: number | Computed<number>;
}

export interface RegionInstanceGroupConfig {
  instanceGroup: string | Computed<string>;
  project: string | Computed<string>;
  region: string | Computed<string>;
}

export interface RegionInstanceGroupAttrs {
  ...
  namedPorts: RegionInstanceGroup_NamedPorts[];
...
export const RegionInstanceGroup: DataSourceBinding<RegionInstanceGroupConfig, RegionInstanceGroupAttrs> = {
  wireType: "google_compute_region_instance_group",
  fields: {
