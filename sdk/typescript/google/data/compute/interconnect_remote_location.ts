// Code generated by `ubx sdk gen` from google_compute_interconnect_remote_location. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface InterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges {
  max?: number | Computed<number>;
  min?: number | Computed<number>;
}

export interface InterconnectRemoteLocation_AttachmentConfigurationConstraints {
  ...
  bgpPeerAsnRanges?: InterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges[] | Computed<InterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges[]>;
}

export interface InterconnectRemoteLocation_Constraints {
  ...
  subnetLengthRange?: InterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges | Computed<InterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges>;
}

export interface InterconnectRemoteLocation_PermittedConnections {
  interconnectLocation?: string | Computed<string>;
}

export interface InterconnectRemoteLocationConfig {
  interconnectRemoteLocation: string | Computed<string>;
  project: string | Computed<string>;
}

export interface InterconnectRemoteLocationAttrs {
  ...
  address: string;
  attachmentConfigurationConstraints: InterconnectRemoteLocation_AttachmentConfigurationConstraints;
  ...
  city: string;
  constraints: InterconnectRemoteLocation_Constraints;
  ...
  permittedConnections: InterconnectRemoteLocation_PermittedConnections[];
  project: string;
...
export const InterconnectRemoteLocation: DataSourceBinding<InterconnectRemoteLocationConfig, InterconnectRemoteLocationAttrs> = {
  wireType: "google_compute_interconnect_remote_location",
  fields: {
