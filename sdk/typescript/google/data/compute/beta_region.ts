// Code generated by `ubx sdk gen` from google_compute_beta_region. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface BetaRegion_Deprecated_StateOverride {
...
export interface BetaRegion_Deprecated {
  ...
  stateOverride?: BetaRegion_Deprecated_StateOverride | Computed<BetaRegion_Deprecated_StateOverride>;
}

export interface BetaRegion_QuotaStatusWarning_Data {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface BetaRegion_QuotaStatusWarning {
  /** [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response. */
  code?: string | Computed<string>;
  /** [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }] */
  data?: BetaRegion_QuotaStatusWarning_Data[] | Computed<BetaRegion_QuotaStatusWarning_Data[]>;
  /** [Output Only] A human-readable description of the warning code. */
  message?: string | Computed<string>;
}

export interface BetaRegion_Quotas {
...
export interface BetaRegionConfig {
  project: string | Computed<string>;
  region: string | Computed<string>;
}

export interface BetaRegionAttrs {
  /** [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp: string;
  /** Deprecation status for a public resource. */
  deprecated: BetaRegion_Deprecated;
  ...
  quotaStatusWarning: BetaRegion_QuotaStatusWarning;
  /** [Output Only] Quotas assigned to this region. */
  quotas: BetaRegion_Quotas[];
  region: string;
...
export const BetaRegion: DataSourceBinding<BetaRegionConfig, BetaRegionAttrs> = {
  wireType: "google_compute_beta_region",
  fields: {
    project: "project",
    region: "region",
  },
