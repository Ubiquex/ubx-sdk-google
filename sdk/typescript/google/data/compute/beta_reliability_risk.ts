...
export interface BetaReliabilityRisk_Details_GlobalDnsInsight {
...
export interface BetaReliabilityRisk_Details {
  ...
  globalDnsInsight?: BetaReliabilityRisk_Details_GlobalDnsInsight | Computed<BetaReliabilityRisk_Details_GlobalDnsInsight>;
...
export interface BetaReliabilityRisk_Recommendation {
...
export interface BetaReliabilityRiskConfig {
  project: string | Computed<string>;
  reliabilityRisk: string | Computed<string>;
}

export interface BetaReliabilityRiskAttrs {
  ...
  details: BetaReliabilityRisk_Details;
  ...
  recommendation: BetaReliabilityRisk_Recommendation;
...
export const BetaReliabilityRisk: DataSourceBinding<BetaReliabilityRiskConfig, BetaReliabilityRiskAttrs> = {
