// Code generated by `ubx sdk gen` from google_compute_beta_disk_type. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface BetaDiskType_Deprecated_StateOverride {
...
export interface BetaDiskType_Deprecated {
  ...
  stateOverride?: BetaDiskType_Deprecated_StateOverride | Computed<BetaDiskType_Deprecated_StateOverride>;
}

export interface BetaDiskTypeConfig {
  diskType: string | Computed<string>;
  project: string | Computed<string>;
  zone: string | Computed<string>;
}

export interface BetaDiskTypeAttrs {
  /** [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp: string;
  /** [Output Only] Server-defined default disk size in GB. */
  defaultDiskSizeGb: string;
  /** Deprecation status for a public resource. */
  deprecated: BetaDiskType_Deprecated;
...
export const BetaDiskType: DataSourceBinding<BetaDiskTypeConfig, BetaDiskTypeAttrs> = {
  wireType: "google_compute_beta_disk_type",
  fields: {
    diskType: "disk_type",
    project: "project",
    zone: "zone",
