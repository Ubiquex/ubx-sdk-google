...
export interface AlphaLicenseCode_LicenseAlias {
  description?: string | Computed<string>;
  selfLink?: string | Computed<string>;
}

export interface AlphaLicenseCode_MinimumRetention {
...
export interface AlphaLicenseCodeConfig {
  licenseCode: string | Computed<string>;
  project: string | Computed<string>;
}

export interface AlphaLicenseCodeAttrs {
  ...
  licenseAlias: AlphaLicenseCode_LicenseAlias[];
  licenseCode: string;
  /** A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years. */
  minimumRetention: AlphaLicenseCode_MinimumRetention;
...
export const AlphaLicenseCode: DataSourceBinding<AlphaLicenseCodeConfig, AlphaLicenseCodeAttrs> = {
  wireType: "google_compute_alpha_license_code",
  fields: {
