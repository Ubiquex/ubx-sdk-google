// Code generated by `ubx sdk gen` from google_compute_project. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface Project_CommonInstanceMetadata_Items {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface Project_CommonInstanceMetadata {
  ...
  items?: Project_CommonInstanceMetadata_Items[] | Computed<Project_CommonInstanceMetadata_Items[]>;
  /** Output only. [Output Only] Type of the resource. Always compute#metadata for metadata. */
  kind?: string | Computed<string>;
}

export interface Project_Quotas {
...
export interface Project_UsageExportLocation {
...
export interface ProjectAttrs {
  ...
  commonInstanceMetadata: Project_CommonInstanceMetadata;
  ...
  usageExportLocation: Project_UsageExportLocation;
...
export const Project: DataSourceBinding<ProjectConfig, ProjectAttrs> = {
  wireType: "google_compute_project",
  fields: {
    project: "project",
  },
};
