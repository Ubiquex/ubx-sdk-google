// Code generated by `ubx sdk gen` from google_compute_reliability_risk. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface ReliabilityRisk_Details_GlobalDnsInsight {
...
export interface ReliabilityRisk_Details {
  ...
  globalDnsInsight?: ReliabilityRisk_Details_GlobalDnsInsight | Computed<ReliabilityRisk_Details_GlobalDnsInsight>;
...
export interface ReliabilityRisk_Recommendation {
...
export interface ReliabilityRiskConfig {
  project: string | Computed<string>;
  reliabilityRisk: string | Computed<string>;
}

export interface ReliabilityRiskAttrs {
  ...
  details: ReliabilityRisk_Details;
  ...
  recommendation: ReliabilityRisk_Recommendation;
...
export const ReliabilityRisk: DataSourceBinding<ReliabilityRiskConfig, ReliabilityRiskAttrs> = {
