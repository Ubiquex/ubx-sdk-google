// Code generated by `ubx sdk gen` from google_compute_alpha_organization_rollout. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface AlphaOrganizationRollout_RolloutEntity_OrchestratedEntity {
...
export interface AlphaOrganizationRollout_RolloutEntity {
  /** This message is used if the resource type follows the Orchestrated integration model with ProgressiveRollout. */
  orchestratedEntity?: AlphaOrganizationRollout_RolloutEntity_OrchestratedEntity | Computed<AlphaOrganizationRollout_RolloutEntity_OrchestratedEntity>;
}

export interface AlphaOrganizationRollout_WaveDetails_OrchestratedWaveDetails_LocationStatus {
  state?: string | Computed<string>;
}

export interface AlphaOrganizationRollout_WaveDetails_OrchestratedWaveDetails {
  ...
  locationStatus?: Record<string, AlphaOrganizationRollout_WaveDetails_OrchestratedWaveDetails_LocationStatus> | Computed<Record<string, AlphaOrganizationRollout_WaveDetails_OrchestratedWaveDetails_LocationStatus>>;
}

export interface AlphaOrganizationRollout_WaveDetails {
  orchestratedWaveDetails?: AlphaOrganizationRollout_WaveDetails_OrchestratedWaveDetails | Computed<AlphaOrganizationRollout_WaveDetails_OrchestratedWaveDetails>;
  waveDisplayName?: string | Computed<string>;
  waveNumber?: string | Computed<string>;
}

export interface AlphaOrganizationRolloutConfig {
  organization: string | Computed<string>;
  rollout: string | Computed<string>;
}

export interface AlphaOrganizationRolloutAttrs {
  ...
  rolloutEntity: AlphaOrganizationRollout_RolloutEntity;
  ...
  waveDetails: AlphaOrganizationRollout_WaveDetails[];
}

export const AlphaOrganizationRollout: DataSourceBinding<AlphaOrganizationRolloutConfig, AlphaOrganizationRolloutAttrs> = {
  wireType: "google_compute_alpha_organization_rollout",
  fields: {
