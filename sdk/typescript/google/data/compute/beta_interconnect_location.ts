// Code generated by `ubx sdk gen` from google_compute_beta_interconnect_location. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface BetaInterconnectLocation_CrossSiteInterconnectInfos {
...
export interface BetaInterconnectLocation_RegionInfos {
...
export interface BetaInterconnectLocationConfig {
  interconnectLocation: string | Computed<string>;
  project: string | Computed<string>;
}

export interface BetaInterconnectLocationAttrs {
  ...
  crossSiteInterconnectInfos: BetaInterconnectLocation_CrossSiteInterconnectInfos[];
  ...
  regionInfos: BetaInterconnectLocation_RegionInfos[];
...
export const BetaInterconnectLocation: DataSourceBinding<BetaInterconnectLocationConfig, BetaInterconnectLocationAttrs> = {
  wireType: "google_compute_beta_interconnect_location",
  fields: {
