// Code generated by `ubx sdk gen` from google_compute_alpha_instance_setting. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface AlphaInstanceSetting_Metadata {
...
export interface AlphaInstanceSettingAttrs {
  ...
  kind: string;
  metadata: AlphaInstanceSetting_Metadata;
  project: string;
  zone: string;
}

export const AlphaInstanceSetting: DataSourceBinding<AlphaInstanceSettingConfig, AlphaInstanceSettingAttrs> = {
