// Code generated by `ubx sdk gen` from google_compute_beta_image_family_view. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface BetaImageFamilyView_Image_Deprecated_StateOverride {
...
export interface BetaImageFamilyView_Image_Deprecated {
  ...
  stateOverride?: BetaImageFamilyView_Image_Deprecated_StateOverride | Computed<BetaImageFamilyView_Image_Deprecated_StateOverride>;
}

export interface BetaImageFamilyView_Image_GuestOsFeatures {
  type?: string | Computed<string>;
}

export interface BetaImageFamilyView_Image_ImageEncryptionKey {
...
export interface BetaImageFamilyView_Image_Params {
...
export interface BetaImageFamilyView_Image_RawDisk {
...
export interface BetaImageFamilyView_Image_ShieldedInstanceInitialState_Dbs {
  content?: string | Computed<string>;
  fileType?: string | Computed<string>;
}

export interface BetaImageFamilyView_Image_ShieldedInstanceInitialState {
  /** The Key Database (db). */
  dbs?: BetaImageFamilyView_Image_ShieldedInstanceInitialState_Dbs[] | Computed<BetaImageFamilyView_Image_ShieldedInstanceInitialState_Dbs[]>;
  /** The forbidden key database (dbx). */
  dbxs?: BetaImageFamilyView_Image_ShieldedInstanceInitialState_Dbs[] | Computed<BetaImageFamilyView_Image_ShieldedInstanceInitialState_Dbs[]>;
  /** The Key Exchange Key (KEK). */
  keks?: BetaImageFamilyView_Image_ShieldedInstanceInitialState_Dbs[] | Computed<BetaImageFamilyView_Image_ShieldedInstanceInitialState_Dbs[]>;
  pk?: BetaImageFamilyView_Image_ShieldedInstanceInitialState_Dbs | Computed<BetaImageFamilyView_Image_ShieldedInstanceInitialState_Dbs>;
}

export interface BetaImageFamilyView_Image {
  ...
  deprecated?: BetaImageFamilyView_Image_Deprecated | Computed<BetaImageFamilyView_Image_Deprecated>;
  ...
  guestOsFeatures?: BetaImageFamilyView_Image_GuestOsFeatures[] | Computed<BetaImageFamilyView_Image_GuestOsFeatures[]>;
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id?: string | Computed<string>;
  imageEncryptionKey?: BetaImageFamilyView_Image_ImageEncryptionKey | Computed<BetaImageFamilyView_Image_ImageEncryptionKey>;
  ...
  params?: BetaImageFamilyView_Image_Params | Computed<BetaImageFamilyView_Image_Params>;
  /** The parameters of the raw disk image. */
  rawDisk?: BetaImageFamilyView_Image_RawDisk | Computed<BetaImageFamilyView_Image_RawDisk>;
  /** A rollout policy configuration. */
  rolloutOverride?: BetaImageFamilyView_Image_Deprecated_StateOverride | Computed<BetaImageFamilyView_Image_Deprecated_StateOverride>;
  ...
  shieldedInstanceInitialState?: BetaImageFamilyView_Image_ShieldedInstanceInitialState | Computed<BetaImageFamilyView_Image_ShieldedInstanceInitialState>;
  /** URL of the source disk used to create this image. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone/disks/disk - projects/project/zones/zone/disks/disk - zones/zone/disks/disk In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceDisk?: string | Computed<string>;
  sourceDiskEncryptionKey?: BetaImageFamilyView_Image_ImageEncryptionKey | Computed<BetaImageFamilyView_Image_ImageEncryptionKey>;
  ...
  sourceImageEncryptionKey?: BetaImageFamilyView_Image_ImageEncryptionKey | Computed<BetaImageFamilyView_Image_ImageEncryptionKey>;
  ...
  sourceSnapshotEncryptionKey?: BetaImageFamilyView_Image_ImageEncryptionKey | Computed<BetaImageFamilyView_Image_ImageEncryptionKey>;
...
export interface BetaImageFamilyViewConfig {
  family: string | Computed<string>;
  project: string | Computed<string>;
  zone: string | Computed<string>;
}

export interface BetaImageFamilyViewAttrs {
  family: string;
  /** Represents an Image resource. You can use images to create boot disks for your VM instances. For more information, read Images. */
  image: BetaImageFamilyView_Image;
  project: string;
  zone: string;
}

export const BetaImageFamilyView: DataSourceBinding<BetaImageFamilyViewConfig, BetaImageFamilyViewAttrs> = {
  wireType: "google_compute_beta_image_family_view",
  fields: {
    family: "family",
    project: "project",
    zone: "zone",
