// Code generated by `ubx sdk gen` from google_compute_alpha_region_instance_group. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface AlphaRegionInstanceGroup_NamedPorts {
  name?: string | Computed<string>;
  port?: number | Computed<number>;
}

export interface AlphaRegionInstanceGroupConfig {
  instanceGroup: string | Computed<string>;
  project: string | Computed<string>;
  region: string | Computed<string>;
}

export interface AlphaRegionInstanceGroupAttrs {
  ...
  namedPorts: AlphaRegionInstanceGroup_NamedPorts[];
...
export const AlphaRegionInstanceGroup: DataSourceBinding<AlphaRegionInstanceGroupConfig, AlphaRegionInstanceGroupAttrs> = {
  wireType: "google_compute_alpha_region_instance_group",
  fields: {
