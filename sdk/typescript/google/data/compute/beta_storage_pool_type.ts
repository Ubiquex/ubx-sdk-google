...
export interface BetaStoragePoolType_Deprecated_StateOverride {
...
export interface BetaStoragePoolType_Deprecated {
  ...
  stateOverride?: BetaStoragePoolType_Deprecated_StateOverride | Computed<BetaStoragePoolType_Deprecated_StateOverride>;
}

export interface BetaStoragePoolTypeConfig {
  project: string | Computed<string>;
  storagePoolType: string | Computed<string>;
  zone: string | Computed<string>;
}

export interface BetaStoragePoolTypeAttrs {
  /** [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp: string;
  /** Deprecation status for a public resource. */
  deprecated: BetaStoragePoolType_Deprecated;
...
export const BetaStoragePoolType: DataSourceBinding<BetaStoragePoolTypeConfig, BetaStoragePoolTypeAttrs> = {
