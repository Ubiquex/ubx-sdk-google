...
export interface InterconnectLocation_CrossSiteInterconnectInfos {
...
export interface InterconnectLocation_RegionInfos {
...
export interface InterconnectLocationConfig {
  interconnectLocation: string | Computed<string>;
  project: string | Computed<string>;
}

export interface InterconnectLocationAttrs {
  ...
  crossSiteInterconnectInfos: InterconnectLocation_CrossSiteInterconnectInfos[];
  ...
  regionInfos: InterconnectLocation_RegionInfos[];
...
export const InterconnectLocation: DataSourceBinding<InterconnectLocationConfig, InterconnectLocationAttrs> = {
  wireType: "google_compute_interconnect_location",
  fields: {
