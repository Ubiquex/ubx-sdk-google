...
export interface BetaManagedRulesetConfig {
  managedRuleset: string | Computed<string>;
  project: string | Computed<string>;
}

export interface BetaManagedRulesetAttrs {
...
export const BetaManagedRuleset: DataSourceBinding<BetaManagedRulesetConfig, BetaManagedRulesetAttrs> = {
