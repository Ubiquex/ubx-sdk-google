// Code generated by `ubx sdk gen` from google_compute_rollout. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface Rollout_RolloutEntity_OrchestratedEntity {
...
export interface Rollout_RolloutEntity {
  /** This message is used if the resource type follows the Orchestrated integration model with ProgressiveRollout. */
  orchestratedEntity?: Rollout_RolloutEntity_OrchestratedEntity | Computed<Rollout_RolloutEntity_OrchestratedEntity>;
}

export interface Rollout_WaveDetails_OrchestratedWaveDetails_LocationStatus {
  state?: string | Computed<string>;
}

export interface Rollout_WaveDetails_OrchestratedWaveDetails {
  ...
  locationStatus?: Record<string, Rollout_WaveDetails_OrchestratedWaveDetails_LocationStatus> | Computed<Record<string, Rollout_WaveDetails_OrchestratedWaveDetails_LocationStatus>>;
}

export interface Rollout_WaveDetails {
  orchestratedWaveDetails?: Rollout_WaveDetails_OrchestratedWaveDetails | Computed<Rollout_WaveDetails_OrchestratedWaveDetails>;
...
export interface RolloutAttrs {
  ...
  rolloutEntity: Rollout_RolloutEntity;
  ...
  waveDetails: Rollout_WaveDetails[];
}

export const Rollout: DataSourceBinding<RolloutConfig, RolloutAttrs> = {
  wireType: "google_compute_rollout",
  fields: {
    project: "project",
    rollout: "rollout",
  },
