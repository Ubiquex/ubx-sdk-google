// Code generated by `ubx sdk gen` from google_compute_beta_accelerator_type. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface BetaAcceleratorType_Deprecated_StateOverride {
...
export interface BetaAcceleratorType_Deprecated {
  ...
  stateOverride?: BetaAcceleratorType_Deprecated_StateOverride | Computed<BetaAcceleratorType_Deprecated_StateOverride>;
}

export interface BetaAcceleratorTypeConfig {
  acceleratorType: string | Computed<string>;
  project: string | Computed<string>;
  zone: string | Computed<string>;
}

export interface BetaAcceleratorTypeAttrs {
  acceleratorType: string;
  /** [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp: string;
  /** Deprecation status for a public resource. */
  deprecated: BetaAcceleratorType_Deprecated;
...
export const BetaAcceleratorType: DataSourceBinding<BetaAcceleratorTypeConfig, BetaAcceleratorTypeAttrs> = {
  wireType: "google_compute_beta_accelerator_type",
  fields: {
