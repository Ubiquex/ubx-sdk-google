// Code generated by `ubx sdk gen` from google_compute_alpha_region_recoverable_snapshot. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface AlphaRegionRecoverableSnapshot_OriginalResource_GuestOsFeatures {
  type?: string | Computed<string>;
}

export interface AlphaRegionRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey {
...
export interface AlphaRegionRecoverableSnapshot_OriginalResource {
  ...
  guestOsFeatures?: AlphaRegionRecoverableSnapshot_OriginalResource_GuestOsFeatures[] | Computed<AlphaRegionRecoverableSnapshot_OriginalResource_GuestOsFeatures[]>;
  ...
  snapshotEncryptionKey?: AlphaRegionRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey | Computed<AlphaRegionRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey>;
  ...
  sourceDiskEncryptionKey?: AlphaRegionRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey | Computed<AlphaRegionRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey>;
  ...
  sourceInstantSnapshotEncryptionKey?: AlphaRegionRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey | Computed<AlphaRegionRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey>;
...
export interface AlphaRegionRecoverableSnapshotConfig {
  project: string | Computed<string>;
  recoverableSnapshot: string | Computed<string>;
  region: string | Computed<string>;
}

export interface AlphaRegionRecoverableSnapshotAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  name: string;
  originalResource: AlphaRegionRecoverableSnapshot_OriginalResource;
  project: string;
...
export const AlphaRegionRecoverableSnapshot: DataSourceBinding<AlphaRegionRecoverableSnapshotConfig, AlphaRegionRecoverableSnapshotAttrs> = {
  wireType: "google_compute_alpha_region_recoverable_snapshot",
  fields: {
    project: "project",
