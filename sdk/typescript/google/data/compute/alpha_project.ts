...
export interface AlphaProject_CommonInstanceMetadata_Items {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface AlphaProject_CommonInstanceMetadata {
  ...
  items?: AlphaProject_CommonInstanceMetadata_Items[] | Computed<AlphaProject_CommonInstanceMetadata_Items[]>;
  /** Output only. [Output Only] Type of the resource. Always compute#metadata for metadata. */
  kind?: string | Computed<string>;
}

export interface AlphaProject_Quotas {
...
export interface AlphaProject_UsageExportLocation {
...
export interface AlphaProjectConfig {
  project: string | Computed<string>;
}

export interface AlphaProjectAttrs {
  ...
  commonInstanceMetadata: AlphaProject_CommonInstanceMetadata;
  ...
  quotas: AlphaProject_Quotas[];
  /** [Output Only] Server-defined URL for the resource. */
  selfLink: string;
  /** The location in Cloud Storage and naming method of the daily usage report. Contains bucket_name and report_name prefix. */
  usageExportLocation: AlphaProject_UsageExportLocation;
...
export const AlphaProject: DataSourceBinding<AlphaProjectConfig, AlphaProjectAttrs> = {
