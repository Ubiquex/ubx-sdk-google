...
export interface BetaMachineType_Accelerators {
  guestAcceleratorCount?: number | Computed<number>;
  guestAcceleratorType?: string | Computed<string>;
}

export interface BetaMachineType_BundledLocalSsds {
...
export interface BetaMachineType_Deprecated_StateOverride {
...
export interface BetaMachineType_Deprecated {
  ...
  stateOverride?: BetaMachineType_Deprecated_StateOverride | Computed<BetaMachineType_Deprecated_StateOverride>;
}

export interface BetaMachineTypeConfig {
  machineType: string | Computed<string>;
  project: string | Computed<string>;
  zone: string | Computed<string>;
}

export interface BetaMachineTypeAttrs {
  /** [Output Only] A list of accelerator configurations assigned to this machine type. */
  accelerators: BetaMachineType_Accelerators[];
  /** [Output Only] The architecture of the machine type. */
  architecture: string;
  bundledLocalSsds: BetaMachineType_BundledLocalSsds;
  /** [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp: string;
  /** Deprecation status for a public resource. */
  deprecated: BetaMachineType_Deprecated;
...
export const BetaMachineType: DataSourceBinding<BetaMachineTypeConfig, BetaMachineTypeAttrs> = {
  wireType: "google_compute_beta_machine_type",
  fields: {
