...
export interface BetaReservationSlot_Resource_PhysicalTopology {
...
export interface BetaReservationSlot_Resource_ShareSettings_FolderMap {
  folderId?: string | Computed<string>;
}

export interface BetaReservationSlot_Resource_ShareSettings_ProjectMap {
  projectId?: string | Computed<string>;
}

export interface BetaReservationSlot_Resource_ShareSettings {
  ...
  folderMap?: Record<string, BetaReservationSlot_Resource_ShareSettings_FolderMap> | Computed<Record<string, BetaReservationSlot_Resource_ShareSettings_FolderMap>>;
  /** A map of project id and project config. This is only valid when share_type's value is SPECIFIC_PROJECTS. */
  projectMap?: Record<string, BetaReservationSlot_Resource_ShareSettings_ProjectMap> | Computed<Record<string, BetaReservationSlot_Resource_ShareSettings_ProjectMap>>;
...
export interface BetaReservationSlot_Resource_Status {
  physicalTopology?: BetaReservationSlot_Resource_PhysicalTopology | Computed<BetaReservationSlot_Resource_PhysicalTopology>;
...
export interface BetaReservationSlot_Resource {
  ...
  shareSettings?: BetaReservationSlot_Resource_ShareSettings | Computed<BetaReservationSlot_Resource_ShareSettings>;
  /** Output only. [Output Only] The state of the reservation slot. */
  state?: string | Computed<string>;
  status?: BetaReservationSlot_Resource_Status | Computed<BetaReservationSlot_Resource_Status>;
  /** Output only. [Output Only] The zone in which the reservation slot resides. */
  zone?: string | Computed<string>;
}

export interface BetaReservationSlotConfig {
...
export interface BetaReservationSlotAttrs {
  parentName: string;
  project: string;
  reservationSlot: string;
  /** Represents a reservation slot resource. */
  resource: BetaReservationSlot_Resource;
  zone: string;
}

export const BetaReservationSlot: DataSourceBinding<BetaReservationSlotConfig, BetaReservationSlotAttrs> = {
  wireType: "google_compute_beta_reservation_slot",
  fields: {
