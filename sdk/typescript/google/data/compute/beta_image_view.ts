// Code generated by `ubx sdk gen` from google_compute_beta_image_view. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface BetaImageView_Image_Deprecated_StateOverride {
...
export interface BetaImageView_Image_Deprecated {
  ...
  stateOverride?: BetaImageView_Image_Deprecated_StateOverride | Computed<BetaImageView_Image_Deprecated_StateOverride>;
}

export interface BetaImageView_Image_GuestOsFeatures {
  type?: string | Computed<string>;
}

export interface BetaImageView_Image_ImageEncryptionKey {
...
export interface BetaImageView_Image_Params {
...
export interface BetaImageView_Image_RawDisk {
...
export interface BetaImageView_Image_ShieldedInstanceInitialState_Dbs {
  content?: string | Computed<string>;
  fileType?: string | Computed<string>;
}

export interface BetaImageView_Image_ShieldedInstanceInitialState {
  /** The Key Database (db). */
  dbs?: BetaImageView_Image_ShieldedInstanceInitialState_Dbs[] | Computed<BetaImageView_Image_ShieldedInstanceInitialState_Dbs[]>;
  /** The forbidden key database (dbx). */
  dbxs?: BetaImageView_Image_ShieldedInstanceInitialState_Dbs[] | Computed<BetaImageView_Image_ShieldedInstanceInitialState_Dbs[]>;
  /** The Key Exchange Key (KEK). */
  keks?: BetaImageView_Image_ShieldedInstanceInitialState_Dbs[] | Computed<BetaImageView_Image_ShieldedInstanceInitialState_Dbs[]>;
  pk?: BetaImageView_Image_ShieldedInstanceInitialState_Dbs | Computed<BetaImageView_Image_ShieldedInstanceInitialState_Dbs>;
}

export interface BetaImageView_Image {
  ...
  deprecated?: BetaImageView_Image_Deprecated | Computed<BetaImageView_Image_Deprecated>;
  ...
  guestOsFeatures?: BetaImageView_Image_GuestOsFeatures[] | Computed<BetaImageView_Image_GuestOsFeatures[]>;
  /** Output only. [Output Only] The unique identifier for the resource. This identifier is defined by the server. */
  id?: string | Computed<string>;
  imageEncryptionKey?: BetaImageView_Image_ImageEncryptionKey | Computed<BetaImageView_Image_ImageEncryptionKey>;
  ...
  params?: BetaImageView_Image_Params | Computed<BetaImageView_Image_Params>;
  /** The parameters of the raw disk image. */
  rawDisk?: BetaImageView_Image_RawDisk | Computed<BetaImageView_Image_RawDisk>;
  /** A rollout policy configuration. */
  rolloutOverride?: BetaImageView_Image_Deprecated_StateOverride | Computed<BetaImageView_Image_Deprecated_StateOverride>;
  ...
  shieldedInstanceInitialState?: BetaImageView_Image_ShieldedInstanceInitialState | Computed<BetaImageView_Image_ShieldedInstanceInitialState>;
  /** URL of the source disk used to create this image. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone/disks/disk - projects/project/zones/zone/disks/disk - zones/zone/disks/disk In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL */
  sourceDisk?: string | Computed<string>;
  sourceDiskEncryptionKey?: BetaImageView_Image_ImageEncryptionKey | Computed<BetaImageView_Image_ImageEncryptionKey>;
  ...
  sourceImageEncryptionKey?: BetaImageView_Image_ImageEncryptionKey | Computed<BetaImageView_Image_ImageEncryptionKey>;
  ...
  sourceSnapshotEncryptionKey?: BetaImageView_Image_ImageEncryptionKey | Computed<BetaImageView_Image_ImageEncryptionKey>;
...
export interface BetaImageViewConfig {
  project: string | Computed<string>;
  region: string | Computed<string>;
  resourceId: string | Computed<string>;
}

export interface BetaImageViewAttrs {
  /** Represents an Image resource. You can use images to create boot disks for your VM instances. For more information, read Images. */
  image: BetaImageView_Image;
  project: string;
  region: string;
  resourceId: string;
}

export const BetaImageView: DataSourceBinding<BetaImageViewConfig, BetaImageViewAttrs> = {
  wireType: "google_compute_beta_image_view",
  fields: {
    project: "project",
    region: "region",
