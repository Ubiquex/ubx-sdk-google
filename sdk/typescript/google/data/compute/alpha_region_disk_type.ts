// Code generated by `ubx sdk gen` from google_compute_alpha_region_disk_type. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface AlphaRegionDiskType_Deprecated_StateOverride {
...
export interface AlphaRegionDiskType_Deprecated {
  ...
  stateOverride?: AlphaRegionDiskType_Deprecated_StateOverride | Computed<AlphaRegionDiskType_Deprecated_StateOverride>;
}

export interface AlphaRegionDiskTypeConfig {
  diskType: string | Computed<string>;
  project: string | Computed<string>;
  region: string | Computed<string>;
}

export interface AlphaRegionDiskTypeAttrs {
  /** [Output Only] Creation timestamp inRFC3339 text format. */
  creationTimestamp: string;
  /** [Output Only] Server-defined default disk size in GB. */
  defaultDiskSizeGb: string;
  /** Deprecation status for a public resource. */
  deprecated: AlphaRegionDiskType_Deprecated;
...
export const AlphaRegionDiskType: DataSourceBinding<AlphaRegionDiskTypeConfig, AlphaRegionDiskTypeAttrs> = {
  wireType: "google_compute_alpha_region_disk_type",
  fields: {
    diskType: "disk_type",
    project: "project",
    region: "region",
