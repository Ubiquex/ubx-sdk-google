...
export interface Host_Status_PhysicalTopology {
...
export interface Host_Status {
  physicalTopology?: Host_Status_PhysicalTopology | Computed<Host_Status_PhysicalTopology>;
