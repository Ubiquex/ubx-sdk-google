...
export interface BetaInterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges {
  max?: number | Computed<number>;
  min?: number | Computed<number>;
}

export interface BetaInterconnectRemoteLocation_AttachmentConfigurationConstraints {
  ...
  bgpPeerAsnRanges?: BetaInterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges[] | Computed<BetaInterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges[]>;
}

export interface BetaInterconnectRemoteLocation_Constraints {
  ...
  subnetLengthRange?: BetaInterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges | Computed<BetaInterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges>;
}

export interface BetaInterconnectRemoteLocation_PermittedConnections {
  interconnectLocation?: string | Computed<string>;
}

export interface BetaInterconnectRemoteLocationConfig {
  interconnectRemoteLocation: string | Computed<string>;
  project: string | Computed<string>;
}

export interface BetaInterconnectRemoteLocationAttrs {
  ...
  address: string;
  attachmentConfigurationConstraints: BetaInterconnectRemoteLocation_AttachmentConfigurationConstraints;
  ...
  city: string;
  constraints: BetaInterconnectRemoteLocation_Constraints;
  ...
  permittedConnections: BetaInterconnectRemoteLocation_PermittedConnections[];
  project: string;
...
export const BetaInterconnectRemoteLocation: DataSourceBinding<BetaInterconnectRemoteLocationConfig, BetaInterconnectRemoteLocationAttrs> = {
