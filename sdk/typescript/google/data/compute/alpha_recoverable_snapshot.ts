...
export interface AlphaRecoverableSnapshot_OriginalResource_GuestOsFeatures {
  type?: string | Computed<string>;
}

export interface AlphaRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey {
...
export interface AlphaRecoverableSnapshot_OriginalResource {
  ...
  guestOsFeatures?: AlphaRecoverableSnapshot_OriginalResource_GuestOsFeatures[] | Computed<AlphaRecoverableSnapshot_OriginalResource_GuestOsFeatures[]>;
  ...
  snapshotEncryptionKey?: AlphaRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey | Computed<AlphaRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey>;
  ...
  sourceDiskEncryptionKey?: AlphaRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey | Computed<AlphaRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey>;
  ...
  sourceInstantSnapshotEncryptionKey?: AlphaRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey | Computed<AlphaRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey>;
...
export interface AlphaRecoverableSnapshotConfig {
  project: string | Computed<string>;
  recoverableSnapshot: string | Computed<string>;
}

export interface AlphaRecoverableSnapshotAttrs {
  /** Output only. [Output Only] Creation timestamp inRFC3339 text format. */
  ...
  name: string;
  originalResource: AlphaRecoverableSnapshot_OriginalResource;
  project: string;
...
export const AlphaRecoverableSnapshot: DataSourceBinding<AlphaRecoverableSnapshotConfig, AlphaRecoverableSnapshotAttrs> = {
  wireType: "google_compute_alpha_recoverable_snapshot",
  fields: {
    project: "project",
