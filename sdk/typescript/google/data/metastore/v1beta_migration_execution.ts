// Code generated by `ubx sdk gen` from google_metastore_v1beta_migration_execution. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary_CatalogSummaries_DatabaseSummaries_TableSummary {
...
export interface V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary_CatalogSummaries_DatabaseSummaries {
  database?: string | Computed<string>;
  planAction?: string | Computed<string>;
  resultStatus?: string | Computed<string>;
  tableSummary?: V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary_CatalogSummaries_DatabaseSummaries_TableSummary | Computed<V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary_CatalogSummaries_DatabaseSummaries_TableSummary>;
}

export interface V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary_CatalogSummaries {
  catalog?: string | Computed<string>;
  catalogType?: string | Computed<string>;
  databaseSummaries?: V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary_CatalogSummaries_DatabaseSummaries[] | Computed<V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary_CatalogSummaries_DatabaseSummaries[]>;
}

export interface V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary {
  /** Output only. Summary of results for each catalog involved in the migration. */
  catalogSummaries?: V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary_CatalogSummaries[] | Computed<V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary_CatalogSummaries[]>;
...
export interface V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus {
  /** Summary of the migration results. */
  migrationSummary?: V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary | Computed<V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary>;
...
export interface V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_HiveConfig {
...
export interface V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_IcebergConfig {
...
export interface V1betaMigrationExecution_BiglakeMetastoreMigrationConfig {
  /** Backfill status for the migration execution. */
  backfillStatus?: V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus | Computed<V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus>;
  ...
  hiveConfig?: V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_HiveConfig | Computed<V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_HiveConfig>;
  /** Configuration for migrating Iceberg metadata. */
  icebergConfig?: V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_IcebergConfig | Computed<V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_IcebergConfig>;
...
export interface V1betaMigrationExecution_CloudSqlMigrationConfig_CdcConfig {
...
export interface V1betaMigrationExecution_CloudSqlMigrationConfig_CloudSqlConnectionConfig {
...
export interface V1betaMigrationExecution_CloudSqlMigrationConfig {
  ...
  cdcConfig?: V1betaMigrationExecution_CloudSqlMigrationConfig_CdcConfig | Computed<V1betaMigrationExecution_CloudSqlMigrationConfig_CdcConfig>;
  /** Configuration information to establish customer database connection before the cutover phase of migration */
  cloudSqlConnectionConfig?: V1betaMigrationExecution_CloudSqlMigrationConfig_CloudSqlConnectionConfig | Computed<V1betaMigrationExecution_CloudSqlMigrationConfig_CloudSqlConnectionConfig>;
}

export interface V1betaMigrationExecutionConfig {
  name: string | Computed<string>;
}

export interface V1betaMigrationExecutionAttrs {
  /** Defines the configuration required to migrate metadata from a Dataproc Metastore service to BigLake Metastore. */
  biglakeMetastoreMigrationConfig: V1betaMigrationExecution_BiglakeMetastoreMigrationConfig;
  ...
  cloudSqlMigrationConfig: V1betaMigrationExecution_CloudSqlMigrationConfig;
...
export const V1betaMigrationExecution: DataSourceBinding<V1betaMigrationExecutionConfig, V1betaMigrationExecutionAttrs> = {
  wireType: "google_metastore_v1beta_migration_execution",
  fields: {
    name: "name",
  },
};
