...
export interface BackupCollectionAttrs {
...
export const BackupCollection: DataSourceBinding<BackupCollectionConfig, BackupCollectionAttrs> = {
  wireType: "google_redis_backup_collection",
  fields: {
    name: "name",
  },
};
