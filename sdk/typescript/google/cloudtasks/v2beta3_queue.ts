// Code generated by `ubx sdk gen` from google_cloudtasks_v2beta3_queue. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V2beta3Queue_AppEngineHttpQueue_AppEngineRoutingOverride {
...
export interface V2beta3Queue_AppEngineHttpQueue {
  ...
  appEngineRoutingOverride?: V2beta3Queue_AppEngineHttpQueue_AppEngineRoutingOverride | Computed<V2beta3Queue_AppEngineHttpQueue_AppEngineRoutingOverride>;
}

export interface V2beta3Queue_HttpTarget_HeaderOverrides_Header {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface V2beta3Queue_HttpTarget_HeaderOverrides {
  header?: V2beta3Queue_HttpTarget_HeaderOverrides_Header | Computed<V2beta3Queue_HttpTarget_HeaderOverrides_Header>;
}

export interface V2beta3Queue_HttpTarget_OauthToken {
...
export interface V2beta3Queue_HttpTarget_OidcToken {
...
export interface V2beta3Queue_HttpTarget_UriOverride_PathOverride {
  /** The URI path (e.g., /users/1234). Default is an empty string. */
  path?: string | Computed<string>;
}

export interface V2beta3Queue_HttpTarget_UriOverride_QueryOverride {
  /** The query parameters (e.g., qparam1=123&qparam2=456). Default is an empty string. */
  queryParams?: string | Computed<string>;
}

export interface V2beta3Queue_HttpTarget_UriOverride {
  /** Host override. When specified, replaces the host part of the task URL. For example, if the task URL is "https://www.google.com," and host value is set to "example.net", the overridden URI will be changed to "https://example.net." Host value cannot be an empty string (INVALID_ARGUMENT). */
  host?: string | Computed<string>;
  /** PathOverride. Path message defines path override for HTTP targets. */
  pathOverride?: V2beta3Queue_HttpTarget_UriOverride_PathOverride | Computed<V2beta3Queue_HttpTarget_UriOverride_PathOverride>;
  ...
  queryOverride?: V2beta3Queue_HttpTarget_UriOverride_QueryOverride | Computed<V2beta3Queue_HttpTarget_UriOverride_QueryOverride>;
...
export interface V2beta3Queue_HttpTarget {
  ...
  headerOverrides?: V2beta3Queue_HttpTarget_HeaderOverrides[] | Computed<V2beta3Queue_HttpTarget_HeaderOverrides[]>;
  ...
  oauthToken?: V2beta3Queue_HttpTarget_OauthToken | Computed<V2beta3Queue_HttpTarget_OauthToken>;
  /** Contains information needed for generating an [OpenID Connect token](https://developers.google.com/identity/protocols/OpenIDConnect). This type of authorization can be used for many scenarios, including calling Cloud Run, or endpoints where you intend to validate the token yourself. */
  oidcToken?: V2beta3Queue_HttpTarget_OidcToken | Computed<V2beta3Queue_HttpTarget_OidcToken>;
  /** URI Override. When specified, all the HTTP tasks inside the queue will be partially or fully overridden depending on the configured values. */
  uriOverride?: V2beta3Queue_HttpTarget_UriOverride | Computed<V2beta3Queue_HttpTarget_UriOverride>;
}

export interface V2beta3Queue_RateLimits {
...
export interface V2beta3Queue_RetryConfig {
...
export interface V2beta3Queue_StackdriverLoggingConfig {
...
export interface V2beta3Queue_Stats {
...
const V2beta3Queue_AppEngineHttpQueue_AppEngineRoutingOverrideFields: FieldMap = {
  host: "host",
  instance: "instance",
  service: "service",
  version: "version",
...
const V2beta3Queue_AppEngineHttpQueueFields: FieldMap = {
  appEngineRoutingOverride: {
    wireName: "app_engine_routing_override",
    kind: "object",
    fields: V2beta3Queue_AppEngineHttpQueue_AppEngineRoutingOverrideFields,
  },
};

const V2beta3Queue_HttpTarget_HeaderOverrides_HeaderFields: FieldMap = {
  key: "key",
  value: "value",
};

const V2beta3Queue_HttpTarget_HeaderOverridesFields: FieldMap = {
  header: {
    wireName: "header",
    kind: "object",
    fields: V2beta3Queue_HttpTarget_HeaderOverrides_HeaderFields,
  },
};

const V2beta3Queue_HttpTarget_OauthTokenFields: FieldMap = {
  scope: "scope",
  serviceAccountEmail: "service_account_email",
};

const V2beta3Queue_HttpTarget_OidcTokenFields: FieldMap = {
  audience: "audience",
  serviceAccountEmail: "service_account_email",
};

const V2beta3Queue_HttpTarget_UriOverride_PathOverrideFields: FieldMap = {
  path: "path",
};

const V2beta3Queue_HttpTarget_UriOverride_QueryOverrideFields: FieldMap = {
  queryParams: "query_params",
};

const V2beta3Queue_HttpTarget_UriOverrideFields: FieldMap = {
  host: "host",
  pathOverride: {
    wireName: "path_override",
    kind: "object",
    fields: V2beta3Queue_HttpTarget_UriOverride_PathOverrideFields,
  },
  port: "port",
  queryOverride: {
    wireName: "query_override",
    kind: "object",
    fields: V2beta3Queue_HttpTarget_UriOverride_QueryOverrideFields,
  },
  scheme: "scheme",
  uriOverrideEnforceMode: "uri_override_enforce_mode",
};

const V2beta3Queue_HttpTargetFields: FieldMap = {
  headerOverrides: {
    wireName: "header_overrides",
    kind: "list",
    fields: V2beta3Queue_HttpTarget_HeaderOverridesFields,
  },
  httpMethod: "http_method",
  oauthToken: {
    wireName: "oauth_token",
    kind: "object",
    fields: V2beta3Queue_HttpTarget_OauthTokenFields,
  },
  oidcToken: {
    wireName: "oidc_token",
    kind: "object",
    fields: V2beta3Queue_HttpTarget_OidcTokenFields,
  },
  uriOverride: {
    wireName: "uri_override",
    kind: "object",
    fields: V2beta3Queue_HttpTarget_UriOverrideFields,
  },
};

const V2beta3Queue_RateLimitsFields: FieldMap = {
...
const V2beta3Queue_RetryConfigFields: FieldMap = {
...
const V2beta3Queue_StackdriverLoggingConfigFields: FieldMap = {
  samplingRatio: "sampling_ratio",
};

const V2beta3Queue_StatsFields: FieldMap = {
...
export interface V2beta3QueueConfig {
  ...
  rateLimits?: V2beta3Queue_RateLimits | Computed<V2beta3Queue_RateLimits>;
  /** Retry config. These settings determine when a failed task attempt is retried. */
  retryConfig?: V2beta3Queue_RetryConfig | Computed<V2beta3Queue_RetryConfig>;
  /** Configuration options for writing logs to [Stackdriver Logging](https://cloud.google.com/logging/docs/). */
  stackdriverLoggingConfig?: V2beta3Queue_StackdriverLoggingConfig | Computed<V2beta3Queue_StackdriverLoggingConfig>;
  ...
  stats?: V2beta3Queue_Stats | Computed<V2beta3Queue_Stats>;
...
export interface V2beta3QueueAttrs {
  ...
  purgeTime: string;
  /** Rate limits. This message determines the maximum rate that tasks can be dispatched by a queue, regardless of whether the dispatch is a first task attempt or a retry. Note: The debugging command, RunTask, will run a task even if the queue has reached its RateLimits. */
  rateLimits: V2beta3Queue_RateLimits;
  /** Retry config. These settings determine when a failed task attempt is retried. */
  retryConfig: V2beta3Queue_RetryConfig;
  /** Configuration options for writing logs to [Stackdriver Logging](https://cloud.google.com/logging/docs/). */
  stackdriverLoggingConfig: V2beta3Queue_StackdriverLoggingConfig;
  /** Output only. The state of the queue. `state` can only be changed by called PauseQueue, ResumeQueue, or uploading [queue.yaml/xml](https://cloud.google.com/appengine/docs/python/config/queueref). UpdateQueue cannot be used to change `state`. */
  state: string;
  /** Statistics for a queue. */
  stats: V2beta3Queue_Stats;
  /** The maximum amount of time that a task will be retained in this queue. After a task has lived for `task_ttl`, the task will be deleted regardless of whether it was dispatched or not. The minimum value is 10 days. The maximum value is 10 years. The value must be given as a string that indicates the length of time (in seconds) followed by `s` (for "seconds"). For more information on the format, see the documentation for [Duration](https://protobuf.dev/reference/protobuf/google.protobuf/#duration). Queues created by Cloud Tasks have a default `task_ttl` of 31 days. . Queues created by queue.yaml/xml have a fixed `task_ttl` of the maximum duration, because there is a [storage quota](https://docs.cloud.google.com/appengine/docs/standard/quotas#Task_Queue) for these queues. */
  taskTtl: string;
  /** The task tombstone time to live (TTL). After a task is deleted or executed, the task's tombstone is retained for the length of time specified by `tombstone_ttl`. The tombstone is used by task de-duplication; another task with the same name can't be created until the tombstone has expired. For more information about task de-duplication, see the documentation for CreateTaskRequest. The minimum value is 1 hour. The maximum value is 9 days. The value must be given as a string that indicates the length of time (in seconds) followed by `s` (for "seconds"). For more information on the format, see the documentation for [Duration](https://protobuf.dev/reference/protobuf/google.protobuf/#duration). Queues created by Cloud Tasks have a default `tombstone_ttl` of 1 hour. */
  tombstoneTtl: string;
...
export const V2beta3Queue: ResourceBinding<V2beta3QueueConfig, V2beta3QueueAttrs> = {
  wireType: "google_cloudtasks_v2beta3_queue",
  fields: {
    appEngineHttpQueue: {
      wireName: "app_engine_http_queue",
      kind: "object",
      fields: V2beta3Queue_AppEngineHttpQueueFields,
    },
    httpTarget: {
      wireName: "http_target",
      kind: "object",
      fields: V2beta3Queue_HttpTargetFields,
    },
    name: "name",
    ...
    rateLimits: {
      ...
      kind: "object",
      fields: V2beta3Queue_RateLimitsFields,
    },
    retryConfig: {
      wireName: "retry_config",
      kind: "object",
      fields: V2beta3Queue_RetryConfigFields,
    },
    stackdriverLoggingConfig: {
      wireName: "stackdriver_logging_config",
      kind: "object",
      fields: V2beta3Queue_StackdriverLoggingConfigFields,
    },
    state: "state",
    stats: {
      wireName: "stats",
      kind: "object",
      fields: V2beta3Queue_StatsFields,
    },
    taskTtl: "task_ttl",
