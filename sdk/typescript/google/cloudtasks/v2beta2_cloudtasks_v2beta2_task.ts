// Code generated by `ubx sdk gen` from google_cloudtasks_v2beta2_cloudtasks_v2beta2_task. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest_AppEngineRouting {
...
export interface V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest {
  ...
  appEngineRouting?: V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest_AppEngineRouting | Computed<V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest_AppEngineRouting>;
...
export interface V2beta2CloudtasksV2beta2Task_HttpRequest_OauthToken {
...
export interface V2beta2CloudtasksV2beta2Task_HttpRequest_OidcToken {
...
export interface V2beta2CloudtasksV2beta2Task_HttpRequest {
  ...
  oauthToken?: V2beta2CloudtasksV2beta2Task_HttpRequest_OauthToken | Computed<V2beta2CloudtasksV2beta2Task_HttpRequest_OauthToken>;
  /** Contains information needed for generating an [OpenID Connect token](https://developers.google.com/identity/protocols/OpenIDConnect). This type of authorization can be used for many scenarios, including calling Cloud Run, or endpoints where you intend to validate the token yourself. */
  oidcToken?: V2beta2CloudtasksV2beta2Task_HttpRequest_OidcToken | Computed<V2beta2CloudtasksV2beta2Task_HttpRequest_OidcToken>;
  /** Required. The full url path that the request will be sent to. This string must begin with either "http://" or "https://". Some examples are: `http://acme.com` and `https://acme.com/sales:8080`. Cloud Tasks will encode some characters for safety and compatibility. The maximum allowed URL length is 2083 characters after encoding. The `Location` header response from a redirect response [`300` - `399`] may be followed. The redirect is not counted as a separate attempt. */
  url?: string | Computed<string>;
}

export interface V2beta2CloudtasksV2beta2Task_PullMessage {
...
export interface V2beta2CloudtasksV2beta2Task_RetryConfig {
...
export interface V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus_ResponseStatus {
...
export interface V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus {
  ...
  responseStatus?: V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus_ResponseStatus | Computed<V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus_ResponseStatus>;
...
export interface V2beta2CloudtasksV2beta2Task_Status {
  ...
  firstAttemptStatus?: V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus | Computed<V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus>;
  /** The status of a task attempt. */
  lastAttemptStatus?: V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus | Computed<V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus>;
}

export interface V2beta2CloudtasksV2beta2Task_Task {
  ...
  appEngineHttpRequest?: V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest | Computed<V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest>;
  ...
  httpRequest?: V2beta2CloudtasksV2beta2Task_HttpRequest | Computed<V2beta2CloudtasksV2beta2Task_HttpRequest>;
  ...
  pullMessage?: V2beta2CloudtasksV2beta2Task_PullMessage | Computed<V2beta2CloudtasksV2beta2Task_PullMessage>;
  /** Retry config. These settings determine how a failed task attempt is retried. */
  retryConfig?: V2beta2CloudtasksV2beta2Task_RetryConfig | Computed<V2beta2CloudtasksV2beta2Task_RetryConfig>;
  ...
  scheduleTime?: string | Computed<string>;
  /** Status of the task. */
  status?: V2beta2CloudtasksV2beta2Task_Status | Computed<V2beta2CloudtasksV2beta2Task_Status>;
  /** Output only. The view specifies which subset of the Task has been returned. */
  view?: string | Computed<string>;
}

const V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest_AppEngineRoutingFields: FieldMap = {
  host: "host",
  instance: "instance",
  service: "service",
  version: "version",
...
const V2beta2CloudtasksV2beta2Task_AppEngineHttpRequestFields: FieldMap = {
  appEngineRouting: {
    wireName: "app_engine_routing",
    kind: "object",
    fields: V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest_AppEngineRoutingFields,
  },
  headers: "headers",
...
const V2beta2CloudtasksV2beta2Task_HttpRequest_OauthTokenFields: FieldMap = {
  scope: "scope",
  serviceAccountEmail: "service_account_email",
};

const V2beta2CloudtasksV2beta2Task_HttpRequest_OidcTokenFields: FieldMap = {
  audience: "audience",
  serviceAccountEmail: "service_account_email",
};

const V2beta2CloudtasksV2beta2Task_HttpRequestFields: FieldMap = {
  body: "body",
  headers: "headers",
  httpMethod: "http_method",
  oauthToken: {
    ...
    kind: "object",
    fields: V2beta2CloudtasksV2beta2Task_HttpRequest_OauthTokenFields,
  },
  oidcToken: {
    wireName: "oidc_token",
    kind: "object",
    fields: V2beta2CloudtasksV2beta2Task_HttpRequest_OidcTokenFields,
  },
  url: "url",
};

const V2beta2CloudtasksV2beta2Task_PullMessageFields: FieldMap = {
  payload: "payload",
  tag: "tag",
};

const V2beta2CloudtasksV2beta2Task_RetryConfigFields: FieldMap = {
...
const V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus_ResponseStatusFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatusFields: FieldMap = {
  dispatchTime: "dispatch_time",
  responseStatus: {
    wireName: "response_status",
    kind: "object",
    fields: V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus_ResponseStatusFields,
  },
  responseTime: "response_time",
  scheduleTime: "schedule_time",
};

const V2beta2CloudtasksV2beta2Task_StatusFields: FieldMap = {
  attemptDispatchCount: "attempt_dispatch_count",
  attemptResponseCount: "attempt_response_count",
  firstAttemptStatus: {
    wireName: "first_attempt_status",
    kind: "object",
    fields: V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatusFields,
  },
  lastAttemptStatus: {
...
const V2beta2CloudtasksV2beta2Task_TaskFields: FieldMap = {
  appEngineHttpRequest: {
    wireName: "app_engine_http_request",
    kind: "object",
    fields: V2beta2CloudtasksV2beta2Task_AppEngineHttpRequestFields,
  },
  createTime: "create_time",
  httpRequest: {
    wireName: "http_request",
    kind: "object",
    fields: V2beta2CloudtasksV2beta2Task_HttpRequestFields,
  },
  name: "name",
  pullMessage: {
    wireName: "pull_message",
    kind: "object",
    fields: V2beta2CloudtasksV2beta2Task_PullMessageFields,
  },
  retryConfig: {
    wireName: "retry_config",
    kind: "object",
    fields: V2beta2CloudtasksV2beta2Task_RetryConfigFields,
  },
  scheduleTime: "schedule_time",
  status: {
    wireName: "status",
    kind: "object",
    fields: V2beta2CloudtasksV2beta2Task_StatusFields,
  },
  view: "view",
};

export interface V2beta2CloudtasksV2beta2TaskConfig {
  ...
  task?: V2beta2CloudtasksV2beta2Task_Task | Computed<V2beta2CloudtasksV2beta2Task_Task>;
}

export interface V2beta2CloudtasksV2beta2TaskAttrs {
  /** App Engine HTTP request. The message defines the HTTP request that is sent to an App Engine app when the task is dispatched. This proto can only be used for tasks in a queue which has app_engine_http_target set. Using AppEngineHttpRequest requires [`appengine.applications.get`](https://cloud.google.com/appengine/docs/admin-api/access-control) Google IAM permission for the project and the following scope: `https://www.googleapis.com/auth/cloud-platform` The task will be delivered to the App Engine app which belongs to the same project as the queue. For more information, see [How Requests are Routed](https://cloud.google.com/appengine/docs/standard/python/how-requests-are-routed) and how routing is affected by [dispatch files](https://cloud.google.com/appengine/docs/python/config/dispatchref). Traffic is encrypted during transport and never leaves Google datacenters. Because this traffic is carried over a communication mechanism internal to Google, you cannot explicitly set the protocol (for example, HTTP or HTTPS). The request to the handler, however, will appear to have used the HTTP protocol. The AppEngineRouting used to construct the URL that the task is delivered to can be set at the queue-level or task-level: * If set, app_engine_routing_override is used for all tasks in the queue, no matter what the setting is for the task-level app_engine_routing. The `url` that the task will be sent to is: * `url =` host `+` relative_url Tasks can be dispatched to secure app handlers, unsecure app handlers, and URIs restricted with [`login: admin`](https://cloud.google.com/appengine/docs/standard/python/config/appref). Because tasks are not run as any user, they cannot be dispatched to URIs restricted with [`login: required`](https://cloud.google.com/appengine/docs/standard/python/config/appref) Task dispatches also do not follow redirects. The task attempt has succeeded if the app's request handler returns an HTTP response code in the range [`200` - `299`]. The task attempt has failed if the app's handler returns a non-2xx response code or Cloud Tasks does not receive response before the deadline. Failed tasks will be retried according to the retry configuration. `503` (Service Unavailable) is considered an App Engine system error instead of an application error and will cause Cloud Tasks' traffic congestion control to temporarily throttle the queue's dispatches. Unlike other types of task targets, a `429` (Too Many Requests) response from an app handler does not cause traffic congestion control to throttle the queue. */
  appEngineHttpRequest: V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest;
  /** Output only. The time that the task was created. `create_time` will be truncated to the nearest second. */
  createTime: string;
  /** HTTP request. The task will be pushed to the worker as an HTTP request. An HTTP request embodies a url, an http method, headers, body and authorization for the http task. */
  httpRequest: V2beta2CloudtasksV2beta2Task_HttpRequest;
  /** Optionally caller-specified in CreateTask. The task name. The task name must have the following format: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID` * `PROJECT_ID` can contain letters ([A-Za-z]), numbers ([0-9]), hyphens (-), colons (:), or periods (.). For more information, see [Identifying projects](https://cloud.google.com/resource-manager/docs/creating-managing-projects#identifying_projects) * `LOCATION_ID` is the canonical ID for the task's location. The list of available locations can be obtained by calling ListLocations. For more information, see https://cloud.google.com/about/locations/. * `QUEUE_ID` can contain letters ([A-Za-z]), numbers ([0-9]), or hyphens (-). The maximum length is 100 characters. * `TASK_ID` can contain only letters ([A-Za-z]), numbers ([0-9]), hyphens (-), or underscores (_). The maximum length is 500 characters. */
  name: string;
  /** Required. The queue name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID` The queue must already exist. */
  parent: string;
  /** The pull message contains data that can be used by the caller of LeaseTasks to process the task. This proto can only be used for tasks in a queue which has pull_target set. */
  pullMessage: V2beta2CloudtasksV2beta2Task_PullMessage;
  /** The response_view specifies which subset of the Task will be returned. By default response_view is BASIC; not all information is retrieved by default because some data, such as payloads, might be desirable to return only when needed because of its large size or because of the sensitivity of data that it contains. Authorization for FULL requires `cloudtasks.tasks.fullView` [Google IAM](https://cloud.google.com/iam/) permission on the Task resource. */
  responseView: string;
  /** Retry config. These settings determine how a failed task attempt is retried. */
  retryConfig: V2beta2CloudtasksV2beta2Task_RetryConfig;
  /** The time when the task is scheduled to be attempted. For App Engine queues, this is when the task will be attempted or retried. For pull queues, this is the time when the task is available to be leased; if a task is currently leased, this is the time when the current lease expires, that is, the time that the task was leased plus the lease_duration. `schedule_time` will be truncated to the nearest microsecond. */
  scheduleTime: string;
  /** Status of the task. */
  status: V2beta2CloudtasksV2beta2Task_Status;
  /** A unit of scheduled work. */
  task: V2beta2CloudtasksV2beta2Task_Task;
  /** Output only. The view specifies which subset of the Task has been returned. */
  view: string;
}

export const V2beta2CloudtasksV2beta2Task: ResourceBinding<V2beta2CloudtasksV2beta2TaskConfig, V2beta2CloudtasksV2beta2TaskAttrs> = {
  wireType: "google_cloudtasks_v2beta2_cloudtasks_v2beta2_task",
  fields: {
    parent: "parent",
    ...
    task: {
      wireName: "task",
      kind: "object",
      fields: V2beta2CloudtasksV2beta2Task_TaskFields,
    },
  },
};
