...
export interface V2beta2Queue_AppEngineHttpTarget_AppEngineRoutingOverride {
...
export interface V2beta2Queue_AppEngineHttpTarget {
  ...
  appEngineRoutingOverride?: V2beta2Queue_AppEngineHttpTarget_AppEngineRoutingOverride | Computed<V2beta2Queue_AppEngineHttpTarget_AppEngineRoutingOverride>;
}

export interface V2beta2Queue_HttpTarget_HeaderOverrides_Header {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface V2beta2Queue_HttpTarget_HeaderOverrides {
  header?: V2beta2Queue_HttpTarget_HeaderOverrides_Header | Computed<V2beta2Queue_HttpTarget_HeaderOverrides_Header>;
}

export interface V2beta2Queue_HttpTarget_OauthToken {
...
export interface V2beta2Queue_HttpTarget_OidcToken {
...
export interface V2beta2Queue_HttpTarget_UriOverride_PathOverride {
  /** The URI path (e.g., /users/1234). Default is an empty string. */
  path?: string | Computed<string>;
}

export interface V2beta2Queue_HttpTarget_UriOverride_QueryOverride {
  /** The query parameters (e.g., qparam1=123&qparam2=456). Default is an empty string. */
  queryParams?: string | Computed<string>;
}

export interface V2beta2Queue_HttpTarget_UriOverride {
  /** Host override. When specified, replaces the host part of the task URL. For example, if the task URL is "https://www.google.com," and host value is set to "example.net", the overridden URI will be changed to "https://example.net." Host value cannot be an empty string (INVALID_ARGUMENT). */
  host?: string | Computed<string>;
  /** PathOverride. Path message defines path override for HTTP targets. */
  pathOverride?: V2beta2Queue_HttpTarget_UriOverride_PathOverride | Computed<V2beta2Queue_HttpTarget_UriOverride_PathOverride>;
  ...
  queryOverride?: V2beta2Queue_HttpTarget_UriOverride_QueryOverride | Computed<V2beta2Queue_HttpTarget_UriOverride_QueryOverride>;
...
export interface V2beta2Queue_HttpTarget {
  ...
  headerOverrides?: V2beta2Queue_HttpTarget_HeaderOverrides[] | Computed<V2beta2Queue_HttpTarget_HeaderOverrides[]>;
  /** The HTTP method to use for the request. When specified, it overrides HttpRequest for the task. Note that if the value is set to HttpMethod the HttpRequest of the task will be ignored at execution time. */
  httpMethod?: string | Computed<string>;
  /** Contains information needed for generating an [OAuth token](https://developers.google.com/identity/protocols/OAuth2). This type of authorization should generally only be used when calling Google APIs hosted on *.googleapis.com. */
  oauthToken?: V2beta2Queue_HttpTarget_OauthToken | Computed<V2beta2Queue_HttpTarget_OauthToken>;
  /** Contains information needed for generating an [OpenID Connect token](https://developers.google.com/identity/protocols/OpenIDConnect). This type of authorization can be used for many scenarios, including calling Cloud Run, or endpoints where you intend to validate the token yourself. */
  oidcToken?: V2beta2Queue_HttpTarget_OidcToken | Computed<V2beta2Queue_HttpTarget_OidcToken>;
  /** Uri Override. When specified, all the HTTP tasks inside the queue will be partially or fully overridden depending on the configured values. */
  uriOverride?: V2beta2Queue_HttpTarget_UriOverride | Computed<V2beta2Queue_HttpTarget_UriOverride>;
}

export interface V2beta2Queue_RateLimits {
...
export interface V2beta2Queue_RetryConfig {
...
export interface V2beta2Queue_Stats {
...
const V2beta2Queue_AppEngineHttpTarget_AppEngineRoutingOverrideFields: FieldMap = {
  host: "host",
  instance: "instance",
  service: "service",
  version: "version",
...
const V2beta2Queue_AppEngineHttpTargetFields: FieldMap = {
...
const V2beta2Queue_HttpTarget_HeaderOverrides_HeaderFields: FieldMap = {
  key: "key",
  value: "value",
};

const V2beta2Queue_HttpTarget_HeaderOverridesFields: FieldMap = {
  header: {
    wireName: "header",
    kind: "object",
...
const V2beta2Queue_HttpTarget_OauthTokenFields: FieldMap = {
  scope: "scope",
  serviceAccountEmail: "service_account_email",
};

const V2beta2Queue_HttpTarget_OidcTokenFields: FieldMap = {
  audience: "audience",
  serviceAccountEmail: "service_account_email",
};

const V2beta2Queue_HttpTarget_UriOverride_PathOverrideFields: FieldMap = {
  path: "path",
};

const V2beta2Queue_HttpTarget_UriOverride_QueryOverrideFields: FieldMap = {
  queryParams: "query_params",
};

const V2beta2Queue_HttpTarget_UriOverrideFields: FieldMap = {
  host: "host",
  pathOverride: {
...
const V2beta2Queue_HttpTargetFields: FieldMap = {
  headerOverrides: {
...
const V2beta2Queue_StatsFields: FieldMap = {
...
export interface V2beta2QueueConfig {
  ...
  appEngineHttpTarget?: V2beta2Queue_AppEngineHttpTarget | Computed<V2beta2Queue_AppEngineHttpTarget>;
  /** HTTP target. When specified as a Queue, all the tasks with [HttpRequest] will be overridden according to the target. */
  httpTarget?: V2beta2Queue_HttpTarget | Computed<V2beta2Queue_HttpTarget>;
  ...
  rateLimits?: V2beta2Queue_RateLimits | Computed<V2beta2Queue_RateLimits>;
  /** Retry config. These settings determine how a failed task attempt is retried. */
  retryConfig?: V2beta2Queue_RetryConfig | Computed<V2beta2Queue_RetryConfig>;
  ...
  stats?: V2beta2Queue_Stats | Computed<V2beta2Queue_Stats>;
...
export interface V2beta2QueueAttrs {
  /** App Engine HTTP target. The task will be delivered to the App Engine application hostname specified by its AppEngineHttpTarget and AppEngineHttpRequest. The documentation for AppEngineHttpRequest explains how the task's host URL is constructed. Using AppEngineHttpTarget requires [`appengine.applications.get`](https://cloud.google.com/appengine/docs/admin-api/access-control) Google IAM permission for the project and the following scope: `https://www.googleapis.com/auth/cloud-platform` */
  appEngineHttpTarget: V2beta2Queue_AppEngineHttpTarget;
  /** HTTP target. When specified as a Queue, all the tasks with [HttpRequest] will be overridden according to the target. */
  httpTarget: V2beta2Queue_HttpTarget;
  /** Caller-specified and required in CreateQueue, after which it becomes output only. The queue name. The queue name must have the following format: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID` * `PROJECT_ID` can contain letters ([A-Za-z]), numbers ([0-9]), hyphens (-), colons (:), or periods (.). For more information, see [Identifying projects](https://cloud.google.com/resource-manager/docs/creating-managing-projects#identifying_projects) * `LOCATION_ID` is the canonical ID for the queue's location. The list of available locations can be obtained by calling ListLocations. For more information, see https://cloud.google.com/about/locations/. * `QUEUE_ID` can contain letters ([A-Za-z]), numbers ([0-9]), or hyphens (-). The maximum length is 100 characters. */
  name: string;
  /** Pull target. */
  pullTarget: unknown;
  ...
  purgeTime: string;
  /** Rate limits. This message determines the maximum rate that tasks can be dispatched by a queue, regardless of whether the dispatch is a first task attempt or a retry. Note: The debugging command, RunTask, will run a task even if the queue has reached its RateLimits. */
  rateLimits: V2beta2Queue_RateLimits;
  /** Retry config. These settings determine how a failed task attempt is retried. */
  retryConfig: V2beta2Queue_RetryConfig;
  /** Output only. The state of the queue. `state` can only be changed by called PauseQueue, ResumeQueue, or uploading [queue.yaml/xml](https://cloud.google.com/appengine/docs/python/config/queueref). UpdateQueue cannot be used to change `state`. */
  state: string;
  /** Statistics for a queue. */
  stats: V2beta2Queue_Stats;
  /** The maximum amount of time that a task will be retained in this queue. Queues created by Cloud Tasks have a default `task_ttl` of 31 days. After a task has lived for `task_ttl`, the task will be deleted regardless of whether it was dispatched or not. The `task_ttl` for queues created via queue.yaml/xml is equal to the maximum duration because there is a [storage quota](https://cloud.google.com/appengine/quotas#Task_Queue) for these queues. To view the maximum valid duration, see the documentation for Duration. */
  taskTtl: string;
  /** The task tombstone time to live (TTL). After a task is deleted or completed, the task's tombstone is retained for the length of time specified by `tombstone_ttl`. The tombstone is used by task de-duplication; another task with the same name can't be created until the tombstone has expired. For more information about task de-duplication, see the documentation for CreateTaskRequest. Queues created by Cloud Tasks have a default `tombstone_ttl` of 1 hour. */
  tombstoneTtl: string;
...
export const V2beta2Queue: ResourceBinding<V2beta2QueueConfig, V2beta2QueueAttrs> = {
