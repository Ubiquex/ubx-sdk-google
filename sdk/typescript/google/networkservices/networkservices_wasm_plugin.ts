// Code generated by `ubx sdk gen` from google_networkservices_networkservices_wasm_plugin. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetworkservicesWasmPlugin_LogConfig {
...
export interface NetworkservicesWasmPlugin_UsedBy {
  name?: string | Computed<string>;
}

export interface NetworkservicesWasmPlugin_Versions {
...
const NetworkservicesWasmPlugin_LogConfigFields: FieldMap = {
  enable: "enable",
  minLogLevel: "min_log_level",
  sampleRate: "sample_rate",
};

const NetworkservicesWasmPlugin_UsedByFields: FieldMap = {
  name: "name",
};

const NetworkservicesWasmPlugin_VersionsFields: FieldMap = {
...
export interface NetworkservicesWasmPluginConfig {
  ...
  logConfig?: NetworkservicesWasmPlugin_LogConfig | Computed<NetworkservicesWasmPlugin_LogConfig>;
  ...
  usedBy?: NetworkservicesWasmPlugin_UsedBy[] | Computed<NetworkservicesWasmPlugin_UsedBy[]>;
  ...
  versions?: Record<string, NetworkservicesWasmPlugin_Versions> | Computed<Record<string, NetworkservicesWasmPlugin_Versions>>;
}

export interface NetworkservicesWasmPluginAttrs {
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Optional. A human-readable description of the resource. */
  description: string;
  ...
  /** Specifies the logging options for the activity performed by this plugin. If logging is enabled, plugin logs are exported to Cloud Logging. */
  logConfig: NetworkservicesWasmPlugin_LogConfig;
  /** Optional. The ID of the `WasmPluginVersion` resource that is the currently serving one. The version referred to must be a child of this `WasmPlugin` resource. */
  ...
  updateTime: string;
  /** Output only. List of all [extensions](https://cloud.google.com/service-extensions/docs/overview) that use this `WasmPlugin` resource. */
  usedBy: NetworkservicesWasmPlugin_UsedBy[];
  /** Optional. All versions of this `WasmPlugin` resource in the key-value format. The key is the resource ID, and the value is the `VersionDetails` object. Lets you create or update a `WasmPlugin` resource and its versions in a single request. When the `main_version_id` field is not empty, it must point to one of the `VersionDetails` objects in the map. If provided in a `PATCH` request, the new versions replace the previous set. Any version omitted from the `versions` field is removed. Because the `WasmPluginVersion` resource is immutable, if a `WasmPluginVersion` resource with the same name already exists and differs, the request fails. Note: In a `GET` request, this field is populated only if the field `GetWasmPluginRequest.view` is set to `WASM_PLUGIN_VIEW_FULL`. */
  versions: Record<string, NetworkservicesWasmPlugin_Versions>;
}

export const NetworkservicesWasmPlugin: ResourceBinding<NetworkservicesWasmPluginConfig, NetworkservicesWasmPluginAttrs> = {
  wireType: "google_networkservices_networkservices_wasm_plugin",
  fields: {
    createTime: "create_time",
    description: "description",
    labels: "labels",
    logConfig: {
      wireName: "log_config",
      kind: "object",
      fields: NetworkservicesWasmPlugin_LogConfigFields,
    },
    ...
    usedBy: {
      wireName: "used_by",
      kind: "list",
      fields: NetworkservicesWasmPlugin_UsedByFields,
    },
    versions: {
      wireName: "versions",
      kind: "map",
      fields: NetworkservicesWasmPlugin_VersionsFields,
    },
  },
};
