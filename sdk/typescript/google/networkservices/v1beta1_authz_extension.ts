...
export interface V1beta1AuthzExtensionConfig {
...
export interface V1beta1AuthzExtensionAttrs {
  /** Optional. The `:authority` header in the gRPC request sent from Envoy to the extension service. It is required when the `service` field points to a backend service. */
  authority: string;
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
...
export const V1beta1AuthzExtension: ResourceBinding<V1beta1AuthzExtensionConfig, V1beta1AuthzExtensionAttrs> = {
