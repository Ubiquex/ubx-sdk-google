// Code generated by `ubx sdk gen` from google_networkservices_producer_extension. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface ProducerExtension_ExtensionSettings {
...
const ProducerExtension_ExtensionSettingsFields: FieldMap = {
  authority: "authority",
...
export interface ProducerExtensionConfig {
  ...
  extensionSettings?: ProducerExtension_ExtensionSettings | Computed<ProducerExtension_ExtensionSettings>;
...
export interface ProducerExtensionAttrs {
  ...
  etag: string;
  /** The configuration for the service that this `ProducerExtension` offers. */
  extensionSettings: ProducerExtension_ExtensionSettings;
  /** Optional. Set of labels associated with the `ProducerExtension` resource. The format must comply with [the following requirements](https://cloud.google.com/compute/docs/labeling-resources#requirements). */
...
export const ProducerExtension: ResourceBinding<ProducerExtensionConfig, ProducerExtensionAttrs> = {
  ...
  fields: {
    ...
    extensionSettings: {
      ...
      kind: "object",
      fields: ProducerExtension_ExtensionSettingsFields,
    },
    labels: "labels",
    name: "name",
    phase: "phase",
