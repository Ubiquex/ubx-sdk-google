// Code generated by `ubx sdk gen` from google_networkservices_networkservices_service_binding. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetworkservicesServiceBindingConfig {
...
export interface NetworkservicesServiceBindingAttrs {
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Optional. A free-text description of the resource. Max length 1024 characters. */
  description: string;
...
export const NetworkservicesServiceBinding: ResourceBinding<NetworkservicesServiceBindingConfig, NetworkservicesServiceBindingAttrs> = {
  wireType: "google_networkservices_networkservices_service_binding",
  fields: {
