// Code generated by `ubx sdk gen` from google_networkservices_v1beta1_networkservices_v1beta1_agent_connectivity_template. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfig {
...
export interface V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfig {
  /** DNS Peering configuration. */
  dnsPeeringConfig?: V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfig | Computed<V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfig>;
...
const V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfigFields: FieldMap = {
  domain: "domain",
  targetNetwork: "target_network",
};

const V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfigFields: FieldMap = {
  dnsPeeringConfig: {
    wireName: "dns_peering_config",
    kind: "object",
    fields: V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfigFields,
  },
...
export interface V1beta1NetworkservicesV1beta1AgentConnectivityTemplateConfig {
  ...
  egressNetworkConfig?: V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfig | Computed<V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfig>;
...
export interface V1beta1NetworkservicesV1beta1AgentConnectivityTemplateAttrs {
  /** Required. Immutable. The path of the access. Maps roughly to ingress/egress, though we keep CLIENT_TO_AGENT and AGENT_TO_ANYWHERE as carryovers from Agent Gateway's original resource model. The path is immutable once set. Exactly one path can be set. */
  accessPath: string;
  /** Optional. The types of network access provided to the gateway. Both PUBLIC and PRIVATE can be configured. */
  accessTypes: string[];
  ...
  /** Optional. A free-text description of the resource. Max length 1024 characters. */
  description: string;
  egressNetworkConfig: V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfig;
  /** Optional. Etag of the resource. If this is provided, it must match the server's etag. If the provided etag does not match the server's etag, the request will fail with a 409 ABORTED error. */
  etag: string;
  /** Optional. Set of label tags associated with the AgentConnectivityTemplate resource. */
...
export const V1beta1NetworkservicesV1beta1AgentConnectivityTemplate: ResourceBinding<V1beta1NetworkservicesV1beta1AgentConnectivityTemplateConfig, V1beta1NetworkservicesV1beta1AgentConnectivityTemplateAttrs> = {
  wireType: "google_networkservices_v1beta1_networkservices_v1beta1_agent_connectivity_template",
  fields: {
    ...
    egressNetworkConfig: {
      ...
      kind: "object",
      fields: V1beta1NetworkservicesV1beta1AgentConnectivityTemplate_EgressNetworkConfigFields,
    },
    etag: "etag",
    labels: "labels",
    name: "name",
