// Code generated by `ubx sdk gen` from google_networkservices_networkservices_multicast_consumer_association. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetworkservicesMulticastConsumerAssociation_State {
  /** Optional. The state of the multicast resource. */
  state?: string | Computed<string>;
}

const NetworkservicesMulticastConsumerAssociation_StateFields: FieldMap = {
  state: "state",
};

export interface NetworkservicesMulticastConsumerAssociationConfig {
  ...
  state?: NetworkservicesMulticastConsumerAssociation_State | Computed<NetworkservicesMulticastConsumerAssociation_State>;
...
export interface NetworkservicesMulticastConsumerAssociationAttrs {
  /** Output only. [Output only] The timestamp when the multicast consumer association was created. */
  createTime: string;
  /** Optional. An optional text description of the multicast consumer association. */
  description: string;
  ...
  /** The multicast resource's state. */
  state: NetworkservicesMulticastConsumerAssociation_State;
  /** Output only. [Output only] The Google-generated UUID for the resource. This value is unique across all multicast consumer association resources. If a consumer association is deleted and another with the same name is created, the new consumer association is assigned a different unique_id. */
  uniqueId: string;
  /** Output only. [Output only] The timestamp when the Multicast Consumer Association was most recently updated. */
  updateTime: string;
...
export const NetworkservicesMulticastConsumerAssociation: ResourceBinding<NetworkservicesMulticastConsumerAssociationConfig, NetworkservicesMulticastConsumerAssociationAttrs> = {
  wireType: "google_networkservices_networkservices_multicast_consumer_association",
  fields: {
    ...
    state: {
      wireName: "state",
      kind: "object",
      fields: NetworkservicesMulticastConsumerAssociation_StateFields,
    },
    uniqueId: "unique_id",
