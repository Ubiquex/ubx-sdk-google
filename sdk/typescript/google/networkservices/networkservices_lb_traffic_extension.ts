// Code generated by `ubx sdk gen` from google_networkservices_networkservices_lb_traffic_extension. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetworkservicesLbTrafficExtension_ExtensionChains_Extensions {
...
export interface NetworkservicesLbTrafficExtension_ExtensionChains_MatchCondition {
  celExpression?: string | Computed<string>;
}

export interface NetworkservicesLbTrafficExtension_ExtensionChains {
  extensions?: NetworkservicesLbTrafficExtension_ExtensionChains_Extensions[] | Computed<NetworkservicesLbTrafficExtension_ExtensionChains_Extensions[]>;
  matchCondition?: NetworkservicesLbTrafficExtension_ExtensionChains_MatchCondition | Computed<NetworkservicesLbTrafficExtension_ExtensionChains_MatchCondition>;
  name?: string | Computed<string>;
}

const NetworkservicesLbTrafficExtension_ExtensionChains_ExtensionsFields: FieldMap = {
  authority: "authority",
  failOpen: "fail_open",
...
const NetworkservicesLbTrafficExtension_ExtensionChains_MatchConditionFields: FieldMap = {
  celExpression: "cel_expression",
};

const NetworkservicesLbTrafficExtension_ExtensionChainsFields: FieldMap = {
  extensions: {
    wireName: "extensions",
    kind: "list",
    fields: NetworkservicesLbTrafficExtension_ExtensionChains_ExtensionsFields,
  },
  matchCondition: {
    wireName: "match_condition",
    kind: "object",
    fields: NetworkservicesLbTrafficExtension_ExtensionChains_MatchConditionFields,
  },
  name: "name",
};

export interface NetworkservicesLbTrafficExtensionConfig {
  /** Output only. The timestamp when the resource was created. */
  createTime?: string | Computed<string>;
  /** Optional. A human-readable description of the resource. */
  description?: string | Computed<string>;
  /** Required. A set of ordered extension chains that contain the match conditions and extensions to execute. Match conditions for each extension chain are evaluated in sequence for a given request. The first extension chain that has a condition that matches the request is executed. Any subsequent extension chains do not execute. Limited to 5 extension chains per resource. */
  extensionChains?: NetworkservicesLbTrafficExtension_ExtensionChains[] | Computed<NetworkservicesLbTrafficExtension_ExtensionChains[]>;
...
export interface NetworkservicesLbTrafficExtensionAttrs {
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Optional. A human-readable description of the resource. */
  description: string;
  /** Required. A set of ordered extension chains that contain the match conditions and extensions to execute. Match conditions for each extension chain are evaluated in sequence for a given request. The first extension chain that has a condition that matches the request is executed. Any subsequent extension chains do not execute. Limited to 5 extension chains per resource. */
  extensionChains: NetworkservicesLbTrafficExtension_ExtensionChains[];
  /** Optional. A list of references to the forwarding rules to which this service extension is attached. At least one forwarding rule is required. Only one `LbTrafficExtension` resource can be associated with a forwarding rule. */
...
export const NetworkservicesLbTrafficExtension: ResourceBinding<NetworkservicesLbTrafficExtensionConfig, NetworkservicesLbTrafficExtensionAttrs> = {
  wireType: "google_networkservices_networkservices_lb_traffic_extension",
  fields: {
    ...
    extensionChains: {
      ...
      kind: "list",
      fields: NetworkservicesLbTrafficExtension_ExtensionChainsFields,
    },
