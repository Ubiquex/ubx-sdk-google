...
export interface NetworkservicesLbRouteExtension_ExtensionChains_Extensions {
...
export interface NetworkservicesLbRouteExtension_ExtensionChains_MatchCondition {
  celExpression?: string | Computed<string>;
}

export interface NetworkservicesLbRouteExtension_ExtensionChains {
  extensions?: NetworkservicesLbRouteExtension_ExtensionChains_Extensions[] | Computed<NetworkservicesLbRouteExtension_ExtensionChains_Extensions[]>;
  matchCondition?: NetworkservicesLbRouteExtension_ExtensionChains_MatchCondition | Computed<NetworkservicesLbRouteExtension_ExtensionChains_MatchCondition>;
  name?: string | Computed<string>;
}

const NetworkservicesLbRouteExtension_ExtensionChains_ExtensionsFields: FieldMap = {
  authority: "authority",
  failOpen: "fail_open",
...
const NetworkservicesLbRouteExtension_ExtensionChains_MatchConditionFields: FieldMap = {
  celExpression: "cel_expression",
};

const NetworkservicesLbRouteExtension_ExtensionChainsFields: FieldMap = {
  extensions: {
    wireName: "extensions",
    kind: "list",
    fields: NetworkservicesLbRouteExtension_ExtensionChains_ExtensionsFields,
  },
  matchCondition: {
    wireName: "match_condition",
    kind: "object",
    fields: NetworkservicesLbRouteExtension_ExtensionChains_MatchConditionFields,
  },
  name: "name",
};

export interface NetworkservicesLbRouteExtensionConfig {
  /** Output only. The timestamp when the resource was created. */
  createTime?: string | Computed<string>;
  /** Optional. A human-readable description of the resource. */
  description?: string | Computed<string>;
  /** Required. A set of ordered extension chains that contain the match conditions and extensions to execute. Match conditions for each extension chain are evaluated in sequence for a given request. The first extension chain that has a condition that matches the request is executed. Any subsequent extension chains do not execute. Limited to 5 extension chains per resource. */
  extensionChains?: NetworkservicesLbRouteExtension_ExtensionChains[] | Computed<NetworkservicesLbRouteExtension_ExtensionChains[]>;
...
export interface NetworkservicesLbRouteExtensionAttrs {
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Optional. A human-readable description of the resource. */
  description: string;
  /** Required. A set of ordered extension chains that contain the match conditions and extensions to execute. Match conditions for each extension chain are evaluated in sequence for a given request. The first extension chain that has a condition that matches the request is executed. Any subsequent extension chains do not execute. Limited to 5 extension chains per resource. */
  extensionChains: NetworkservicesLbRouteExtension_ExtensionChains[];
  /** Required. A list of references to the forwarding rules to which this service extension is attached. At least one forwarding rule is required. Only one `LbRouteExtension` resource can be associated with a forwarding rule. */
...
export const NetworkservicesLbRouteExtension: ResourceBinding<NetworkservicesLbRouteExtensionConfig, NetworkservicesLbRouteExtensionAttrs> = {
  wireType: "google_networkservices_networkservices_lb_route_extension",
  fields: {
    ...
    extensionChains: {
      ...
      kind: "list",
      fields: NetworkservicesLbRouteExtension_ExtensionChainsFields,
    },
