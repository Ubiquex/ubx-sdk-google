// Code generated by `ubx sdk gen` from google_networkservices_v1beta1_lb_route_extension. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1LbRouteExtension_ExtensionChains_Extensions {
...
export interface V1beta1LbRouteExtension_ExtensionChains_MatchCondition {
  celExpression?: string | Computed<string>;
}

export interface V1beta1LbRouteExtension_ExtensionChains {
  extensions?: V1beta1LbRouteExtension_ExtensionChains_Extensions[] | Computed<V1beta1LbRouteExtension_ExtensionChains_Extensions[]>;
  matchCondition?: V1beta1LbRouteExtension_ExtensionChains_MatchCondition | Computed<V1beta1LbRouteExtension_ExtensionChains_MatchCondition>;
  name?: string | Computed<string>;
}

const V1beta1LbRouteExtension_ExtensionChains_ExtensionsFields: FieldMap = {
...
const V1beta1LbRouteExtension_ExtensionChains_MatchConditionFields: FieldMap = {
  celExpression: "cel_expression",
};

const V1beta1LbRouteExtension_ExtensionChainsFields: FieldMap = {
  extensions: {
    wireName: "extensions",
    kind: "list",
    fields: V1beta1LbRouteExtension_ExtensionChains_ExtensionsFields,
  },
  matchCondition: {
    wireName: "match_condition",
    kind: "object",
    fields: V1beta1LbRouteExtension_ExtensionChains_MatchConditionFields,
  },
  name: "name",
};

export interface V1beta1LbRouteExtensionConfig {
  /** Optional. A human-readable description of the resource. */
  description?: string | Computed<string>;
  /** Required. A set of ordered extension chains that contain the match conditions and extensions to execute. Match conditions for each extension chain are evaluated in sequence for a given request. The first extension chain that has a condition that matches the request is executed. Any subsequent extension chains do not execute. Limited to 5 extension chains per resource. */
  extensionChains?: V1beta1LbRouteExtension_ExtensionChains[] | Computed<V1beta1LbRouteExtension_ExtensionChains[]>;
...
export interface V1beta1LbRouteExtensionAttrs {
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Optional. A human-readable description of the resource. */
  description: string;
  /** Required. A set of ordered extension chains that contain the match conditions and extensions to execute. Match conditions for each extension chain are evaluated in sequence for a given request. The first extension chain that has a condition that matches the request is executed. Any subsequent extension chains do not execute. Limited to 5 extension chains per resource. */
  extensionChains: V1beta1LbRouteExtension_ExtensionChains[];
  /** Required. A list of references to the forwarding rules to which this service extension is attached. At least one forwarding rule is required. Only one `LbRouteExtension` resource can be associated with a forwarding rule. */
...
export const V1beta1LbRouteExtension: ResourceBinding<V1beta1LbRouteExtensionConfig, V1beta1LbRouteExtensionAttrs> = {
  wireType: "google_networkservices_v1beta1_lb_route_extension",
  fields: {
    description: "description",
    extensionChains: {
      wireName: "extension_chains",
      kind: "list",
      fields: V1beta1LbRouteExtension_ExtensionChainsFields,
    },
