...
export interface V1beta1ProducerExtension_ExtensionSettings {
...
const V1beta1ProducerExtension_ExtensionSettingsFields: FieldMap = {
  authority: "authority",
...
export interface V1beta1ProducerExtensionConfig {
  ...
  extensionSettings?: V1beta1ProducerExtension_ExtensionSettings | Computed<V1beta1ProducerExtension_ExtensionSettings>;
...
export interface V1beta1ProducerExtensionAttrs {
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Optional. A human-readable description of the resource. */
  description: string;
  ...
  etag: string;
  /** The configuration for the service that this `ProducerExtension` offers. */
  extensionSettings: V1beta1ProducerExtension_ExtensionSettings;
  /** Optional. Set of labels associated with the `ProducerExtension` resource. The format must comply with [the following requirements](https://cloud.google.com/compute/docs/labeling-resources#requirements). */
...
export const V1beta1ProducerExtension: ResourceBinding<V1beta1ProducerExtensionConfig, V1beta1ProducerExtensionAttrs> = {
