...
export interface EndpointPolicy_EndpointMatcher_MetadataLabelMatcher {
  ...
  metadataLabels?: EndpointPolicy_EndpointMatcher_MetadataLabelMatcher_MetadataLabels[] | Computed<EndpointPolicy_EndpointMatcher_MetadataLabelMatcher_MetadataLabels[]>;
}

export interface EndpointPolicy_EndpointMatcher {
  /** The matcher that is based on node metadata presented by xDS clients. */
  metadataLabelMatcher?: EndpointPolicy_EndpointMatcher_MetadataLabelMatcher | Computed<EndpointPolicy_EndpointMatcher_MetadataLabelMatcher>;
}

export interface EndpointPolicy_TrafficPortSelector {
  /** Optional. A list of ports. Can be port numbers or port range (example, [80-90] specifies all ports from 80 to 90, including 80 and 90) or named ports or * to specify all ports. If the list is empty, all ports are selected. */
  ports?: string[] | Computed<string[]>;
}

const EndpointPolicy_EndpointMatcher_MetadataLabelMatcher_MetadataLabelsFields: FieldMap = {
  labelName: "label_name",
  labelValue: "label_value",
};

const EndpointPolicy_EndpointMatcher_MetadataLabelMatcherFields: FieldMap = {
...
const EndpointPolicy_EndpointMatcherFields: FieldMap = {
...
const EndpointPolicy_TrafficPortSelectorFields: FieldMap = {
  ports: "ports",
};
...
export interface EndpointPolicyConfig {
  ...
  endpointMatcher?: EndpointPolicy_EndpointMatcher | Computed<EndpointPolicy_EndpointMatcher>;
...
export interface EndpointPolicyAttrs {
  ...
  description: string;
  /** A definition of a matcher that selects endpoints to which the policies should be applied. */
  endpointMatcher: EndpointPolicy_EndpointMatcher;
  /** Optional. Set of label tags associated with the EndpointPolicy resource. */
  ...
  /** Specification of a port-based selector. */
  trafficPortSelector: EndpointPolicy_TrafficPortSelector;
  /** Required. The type of endpoint policy. This is primarily used to validate the configuration. */
  type: string;
  /** Output only. The timestamp when the resource was updated. */
  updateTime: string;
