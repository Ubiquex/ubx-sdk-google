...
export interface AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfig {
...
export interface AgentConnectivityTemplate_EgressNetworkConfig {
  /** DNS Peering configuration. */
  dnsPeeringConfig?: AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfig | Computed<AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfig>;
...
const AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfigFields: FieldMap = {
  domain: "domain",
  targetNetwork: "target_network",
};

const AgentConnectivityTemplate_EgressNetworkConfigFields: FieldMap = {
  dnsPeeringConfig: {
...
export interface AgentConnectivityTemplateConfig {
...
export interface AgentConnectivityTemplateAttrs {
  /** Required. Immutable. The path of the access. Maps roughly to ingress/egress, though we keep CLIENT_TO_AGENT and AGENT_TO_ANYWHERE as carryovers from Agent Gateway's original resource model. The path is immutable once set. Exactly one path can be set. */
  accessPath: string;
  /** Optional. The types of network access provided to the gateway. Both PUBLIC and PRIVATE can be configured. */
  accessTypes: string[];
...
export const AgentConnectivityTemplate: ResourceBinding<AgentConnectivityTemplateConfig, AgentConnectivityTemplateAttrs> = {
