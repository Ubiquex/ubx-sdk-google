// Code generated by `ubx sdk gen` from google_networkservices_v1beta1_service_lb_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1ServiceLbPolicy_AutoCapacityDrain {
...
export interface V1beta1ServiceLbPolicy_FailoverConfig {
...
export interface V1beta1ServiceLbPolicy_IsolationConfig {
...
const V1beta1ServiceLbPolicy_AutoCapacityDrainFields: FieldMap = {
  enable: "enable",
};

const V1beta1ServiceLbPolicy_FailoverConfigFields: FieldMap = {
  failoverHealthThreshold: "failover_health_threshold",
};

const V1beta1ServiceLbPolicy_IsolationConfigFields: FieldMap = {
...
export interface V1beta1ServiceLbPolicyConfig {
  ...
  failoverConfig?: V1beta1ServiceLbPolicy_FailoverConfig | Computed<V1beta1ServiceLbPolicy_FailoverConfig>;
  /** Configuration to provide isolation support for the associated Backend Service. */
  isolationConfig?: V1beta1ServiceLbPolicy_IsolationConfig | Computed<V1beta1ServiceLbPolicy_IsolationConfig>;
...
export interface V1beta1ServiceLbPolicyAttrs {
  /** Option to specify if an unhealthy IG/NEG should be considered for global load balancing and traffic routing. */
  autoCapacityDrain: V1beta1ServiceLbPolicy_AutoCapacityDrain;
  /** Output only. The timestamp when this resource was created. */
  createTime: string;
  /** Optional. A free-text description of the resource. Max length 1024 characters. */
  description: string;
  /** Option to specify health based failover behavior. This is not related to Network load balancer FailoverPolicy. */
  failoverConfig: V1beta1ServiceLbPolicy_FailoverConfig;
  /** Configuration to provide isolation support for the associated Backend Service. */
  isolationConfig: V1beta1ServiceLbPolicy_IsolationConfig;
  /** Optional. Set of label tags associated with the ServiceLbPolicy resource. */
...
export const V1beta1ServiceLbPolicy: ResourceBinding<V1beta1ServiceLbPolicyConfig, V1beta1ServiceLbPolicyAttrs> = {
  wireType: "google_networkservices_v1beta1_service_lb_policy",
  fields: {
    autoCapacityDrain: {
    ...
    failoverConfig: {
      ...
      kind: "object",
      fields: V1beta1ServiceLbPolicy_FailoverConfigFields,
    },
    isolationConfig: {
      wireName: "isolation_config",
      kind: "object",
      fields: V1beta1ServiceLbPolicy_IsolationConfigFields,
    },
    labels: "labels",
