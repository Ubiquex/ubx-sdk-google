...
export interface NetworkservicesVersionConfig {
...
export interface NetworkservicesVersionAttrs {
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Optional. A human-readable description of the resource. */
  description: string;
...
export const NetworkservicesVersion: ResourceBinding<NetworkservicesVersionConfig, NetworkservicesVersionAttrs> = {
  wireType: "google_networkservices_networkservices_version",
  fields: {
