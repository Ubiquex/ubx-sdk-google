// Code generated by `ubx sdk gen` from google_networkservices_v1beta1_tcp_route. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1TcpRoute_Rules_Action_Destinations {
  serviceName?: string | Computed<string>;
  weight?: number | Computed<number>;
}

export interface V1beta1TcpRoute_Rules_Action {
  destinations?: V1beta1TcpRoute_Rules_Action_Destinations[] | Computed<V1beta1TcpRoute_Rules_Action_Destinations[]>;
  idleTimeout?: string | Computed<string>;
  originalDestination?: boolean | Computed<boolean>;
}

export interface V1beta1TcpRoute_Rules_Matches {
  address?: string | Computed<string>;
  port?: string | Computed<string>;
}

export interface V1beta1TcpRoute_Rules {
  action?: V1beta1TcpRoute_Rules_Action | Computed<V1beta1TcpRoute_Rules_Action>;
  matches?: V1beta1TcpRoute_Rules_Matches[] | Computed<V1beta1TcpRoute_Rules_Matches[]>;
}

const V1beta1TcpRoute_Rules_Action_DestinationsFields: FieldMap = {
  serviceName: "service_name",
  weight: "weight",
};

const V1beta1TcpRoute_Rules_ActionFields: FieldMap = {
  destinations: {
    wireName: "destinations",
    kind: "list",
    fields: V1beta1TcpRoute_Rules_Action_DestinationsFields,
  },
  idleTimeout: "idle_timeout",
  originalDestination: "original_destination",
};

const V1beta1TcpRoute_Rules_MatchesFields: FieldMap = {
  address: "address",
  port: "port",
};

const V1beta1TcpRoute_RulesFields: FieldMap = {
  action: {
    wireName: "action",
    kind: "object",
    fields: V1beta1TcpRoute_Rules_ActionFields,
  },
  matches: {
    wireName: "matches",
    kind: "list",
    fields: V1beta1TcpRoute_Rules_MatchesFields,
  },
};
