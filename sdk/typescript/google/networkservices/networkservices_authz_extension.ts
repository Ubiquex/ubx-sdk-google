// Code generated by `ubx sdk gen` from google_networkservices_networkservices_authz_extension. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetworkservicesAuthzExtensionConfig {
...
export interface NetworkservicesAuthzExtensionAttrs {
  /** Optional. The `:authority` header in the gRPC request sent from Envoy to the extension service. It is required when the `service` field points to a backend service. */
  authority: string;
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
...
export const NetworkservicesAuthzExtension: ResourceBinding<NetworkservicesAuthzExtensionConfig, NetworkservicesAuthzExtensionAttrs> = {
  wireType: "google_networkservices_networkservices_authz_extension",
  fields: {
    authority: "authority",
