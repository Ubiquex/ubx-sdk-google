...
export interface V1beta1NetworkservicesV1beta1VersionConfig {
...
export interface V1beta1NetworkservicesV1beta1VersionAttrs {
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Optional. A human-readable description of the resource. */
  description: string;
...
export const V1beta1NetworkservicesV1beta1Version: ResourceBinding<V1beta1NetworkservicesV1beta1VersionConfig, V1beta1NetworkservicesV1beta1VersionAttrs> = {
  wireType: "google_networkservices_v1beta1_networkservices_v1beta1_version",
  fields: {
