// Code generated by `ubx sdk gen` from google_networkservices_v1beta1_networkservices_v1beta1_service_binding. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1NetworkservicesV1beta1ServiceBindingConfig {
...
export interface V1beta1NetworkservicesV1beta1ServiceBindingAttrs {
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Optional. A free-text description of the resource. Max length 1024 characters. */
  description: string;
...
export const V1beta1NetworkservicesV1beta1ServiceBinding: ResourceBinding<V1beta1NetworkservicesV1beta1ServiceBindingConfig, V1beta1NetworkservicesV1beta1ServiceBindingAttrs> = {
  wireType: "google_networkservices_v1beta1_networkservices_v1beta1_service_binding",
  fields: {
