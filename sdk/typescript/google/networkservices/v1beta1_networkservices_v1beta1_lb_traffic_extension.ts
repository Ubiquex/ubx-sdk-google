// Code generated by `ubx sdk gen` from google_networkservices_v1beta1_networkservices_v1beta1_lb_traffic_extension. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_Extensions {
...
export interface V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_MatchCondition {
  celExpression?: string | Computed<string>;
}

export interface V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains {
  extensions?: V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_Extensions[] | Computed<V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_Extensions[]>;
  matchCondition?: V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_MatchCondition | Computed<V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_MatchCondition>;
  name?: string | Computed<string>;
}

const V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_ExtensionsFields: FieldMap = {
...
const V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_MatchConditionFields: FieldMap = {
  celExpression: "cel_expression",
};

const V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChainsFields: FieldMap = {
  extensions: {
    wireName: "extensions",
    kind: "list",
    fields: V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_ExtensionsFields,
  },
  matchCondition: {
    wireName: "match_condition",
    kind: "object",
    fields: V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_MatchConditionFields,
  },
  name: "name",
};

export interface V1beta1NetworkservicesV1beta1LbTrafficExtensionConfig {
  /** Output only. The timestamp when the resource was created. */
  createTime?: string | Computed<string>;
  /** Optional. A human-readable description of the resource. */
  description?: string | Computed<string>;
  /** Required. A set of ordered extension chains that contain the match conditions and extensions to execute. Match conditions for each extension chain are evaluated in sequence for a given request. The first extension chain that has a condition that matches the request is executed. Any subsequent extension chains do not execute. Limited to 5 extension chains per resource. */
  extensionChains?: V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains[] | Computed<V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains[]>;
...
export interface V1beta1NetworkservicesV1beta1LbTrafficExtensionAttrs {
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Optional. A human-readable description of the resource. */
  description: string;
  /** Required. A set of ordered extension chains that contain the match conditions and extensions to execute. Match conditions for each extension chain are evaluated in sequence for a given request. The first extension chain that has a condition that matches the request is executed. Any subsequent extension chains do not execute. Limited to 5 extension chains per resource. */
  extensionChains: V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains[];
  /** Optional. A list of references to the forwarding rules to which this service extension is attached. At least one forwarding rule is required. Only one `LbTrafficExtension` resource can be associated with a forwarding rule. */
...
export const V1beta1NetworkservicesV1beta1LbTrafficExtension: ResourceBinding<V1beta1NetworkservicesV1beta1LbTrafficExtensionConfig, V1beta1NetworkservicesV1beta1LbTrafficExtensionAttrs> = {
  wireType: "google_networkservices_v1beta1_networkservices_v1beta1_lb_traffic_extension",
  fields: {
    ...
    extensionChains: {
      ...
      kind: "list",
      fields: V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChainsFields,
    },
