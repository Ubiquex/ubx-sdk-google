// Code generated by `ubx sdk gen` from google_networkservices_lb_route_extension. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface LbRouteExtension_ExtensionChains_Extensions {
...
export interface LbRouteExtension_ExtensionChains_MatchCondition {
  celExpression?: string | Computed<string>;
}

export interface LbRouteExtension_ExtensionChains {
  extensions?: LbRouteExtension_ExtensionChains_Extensions[] | Computed<LbRouteExtension_ExtensionChains_Extensions[]>;
  matchCondition?: LbRouteExtension_ExtensionChains_MatchCondition | Computed<LbRouteExtension_ExtensionChains_MatchCondition>;
  name?: string | Computed<string>;
}

const LbRouteExtension_ExtensionChains_ExtensionsFields: FieldMap = {
  authority: "authority",
  failOpen: "fail_open",
...
const LbRouteExtension_ExtensionChains_MatchConditionFields: FieldMap = {
  celExpression: "cel_expression",
};

const LbRouteExtension_ExtensionChainsFields: FieldMap = {
  extensions: {
    wireName: "extensions",
    kind: "list",
    fields: LbRouteExtension_ExtensionChains_ExtensionsFields,
  },
  matchCondition: {
    wireName: "match_condition",
    kind: "object",
    fields: LbRouteExtension_ExtensionChains_MatchConditionFields,
  },
  name: "name",
};
...
export interface LbRouteExtensionConfig {
  ...
  extensionChains?: LbRouteExtension_ExtensionChains[] | Computed<LbRouteExtension_ExtensionChains[]>;
...
export interface LbRouteExtensionAttrs {
  ...
  description: string;
  /** Required. A set of ordered extension chains that contain the match conditions and extensions to execute. Match conditions for each extension chain are evaluated in sequence for a given request. The first extension chain that has a condition that matches the request is executed. Any subsequent extension chains do not execute. Limited to 5 extension chains per resource. */
  extensionChains: LbRouteExtension_ExtensionChains[];
  /** Required. A list of references to the forwarding rules to which this service extension is attached. At least one forwarding rule is required. Only one `LbRouteExtension` resource can be associated with a forwarding rule. */
...
export const LbRouteExtension: ResourceBinding<LbRouteExtensionConfig, LbRouteExtensionAttrs> = {
  ...
  fields: {
    ...
    extensionChains: {
      ...
      kind: "list",
      fields: LbRouteExtension_ExtensionChainsFields,
    },
