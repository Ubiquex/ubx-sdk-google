// Code generated by `ubx sdk gen` from google_networkservices_v1beta1_agent_gateway. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1AgentGateway_AgentGatewayCard {
...
export interface V1beta1AgentGateway_GoogleManaged {
  /** Optional. Operating Mode of Agent Gateway. */
  governedAccessPath?: string | Computed<string>;
}

export interface V1beta1AgentGateway_NetworkConfig_DnsPeeringConfig {
...
export interface V1beta1AgentGateway_NetworkConfig_Egress {
  /** Optional. The URI of the Network Attachment resource. */
  networkAttachment?: string | Computed<string>;
}

export interface V1beta1AgentGateway_NetworkConfig {
  /** DNS peering config for the user VPC network. */
  dnsPeeringConfig?: V1beta1AgentGateway_NetworkConfig_DnsPeeringConfig | Computed<V1beta1AgentGateway_NetworkConfig_DnsPeeringConfig>;
  /** Configuration for Egress */
  egress?: V1beta1AgentGateway_NetworkConfig_Egress | Computed<V1beta1AgentGateway_NetworkConfig_Egress>;
}

export interface V1beta1AgentGateway_SelfManaged {
...
const V1beta1AgentGateway_AgentGatewayCardFields: FieldMap = {
...
const V1beta1AgentGateway_GoogleManagedFields: FieldMap = {
  governedAccessPath: "governed_access_path",
};

const V1beta1AgentGateway_NetworkConfig_DnsPeeringConfigFields: FieldMap = {
  domains: "domains",
  targetNetwork: "target_network",
  targetProject: "target_project",
};

const V1beta1AgentGateway_NetworkConfig_EgressFields: FieldMap = {
  networkAttachment: "network_attachment",
};

const V1beta1AgentGateway_NetworkConfigFields: FieldMap = {
  dnsPeeringConfig: {
    wireName: "dns_peering_config",
    kind: "object",
    fields: V1beta1AgentGateway_NetworkConfig_DnsPeeringConfigFields,
  },
  egress: {
    wireName: "egress",
    kind: "object",
    fields: V1beta1AgentGateway_NetworkConfig_EgressFields,
  },
};

const V1beta1AgentGateway_SelfManagedFields: FieldMap = {
  resourceUri: "resource_uri",
  resourceUris: "resource_uris",
};

export interface V1beta1AgentGatewayConfig {
  ...
  agentGatewayCard?: V1beta1AgentGateway_AgentGatewayCard | Computed<V1beta1AgentGateway_AgentGatewayCard>;
  ...
  googleManaged?: V1beta1AgentGateway_GoogleManaged | Computed<V1beta1AgentGateway_GoogleManaged>;
  ...
  networkConfig?: V1beta1AgentGateway_NetworkConfig | Computed<V1beta1AgentGateway_NetworkConfig>;
  /** Optional. Deprecated. */
  ...
  selfManaged?: V1beta1AgentGateway_SelfManaged | Computed<V1beta1AgentGateway_SelfManaged>;
}

export interface V1beta1AgentGatewayAttrs {
  /** Optional. The resource name of the AgentConnectivityTemplate. Format: projects/{project}/locations/{location}/agentConnectivityTemplates/{template} */
  agentConnectivityTemplate: string;
  /** AgentGatewayOutputCard contains informational output-only fields */
  agentGatewayCard: V1beta1AgentGateway_AgentGatewayCard;
  ...
  etag: string;
  /** Configuration for Google Managed deployment mode. Proxy is orchestrated and managed by GoogleCloud in a tenant project. */
  googleManaged: V1beta1AgentGateway_GoogleManaged;
  /** Optional. Set of label tags associated with the AgentGateway resource. */
  labels: Record<string, string>;
  /** Identifier. Name of the AgentGateway resource. It matches pattern `projects/* /locations/* /agentGateways/`. */
  name: string;
  /** NetworkConfig contains network configurations for the AgentGateway. */
  networkConfig: V1beta1AgentGateway_NetworkConfig;
  /** Optional. Deprecated. */
  protocols: string[];
  /** Optional. A list of Agent registries containing the agents, MCP servers and tools governed by the Agent Gateway. Note: Currently limited to project-scoped registries Must be of format `//agentregistry.googleapis.com/projects/{project}/locations/{location}/` */
  registries: string[];
  /** Configuration for Self Managed deployment mode. Attach to existing Application Load Balancers or Secure Web Proxies. */
  selfManaged: V1beta1AgentGateway_SelfManaged;
  /** Output only. The timestamp when the resource was updated. */
  updateTime: string;
}

export const V1beta1AgentGateway: ResourceBinding<V1beta1AgentGatewayConfig, V1beta1AgentGatewayAttrs> = {
  wireType: "google_networkservices_v1beta1_agent_gateway",
  fields: {
    agentConnectivityTemplate: "agent_connectivity_template",
    agentGatewayCard: {
      wireName: "agent_gateway_card",
      kind: "object",
      fields: V1beta1AgentGateway_AgentGatewayCardFields,
    },
    ...
    googleManaged: {
      ...
      kind: "object",
      fields: V1beta1AgentGateway_GoogleManagedFields,
    },
    labels: "labels",
    name: "name",
    networkConfig: {
      ...
      kind: "object",
      fields: V1beta1AgentGateway_NetworkConfigFields,
    },
    protocols: "protocols",
    ...
    selfManaged: {
      ...
      kind: "object",
      fields: V1beta1AgentGateway_SelfManagedFields,
    },
  },
};
