...
export interface BiglakeCatalogConfig {
...
export interface BiglakeCatalogAttrs {
  /** Output only. The creation time of the catalog. */
  createTime: string;
  /** Output only. The deletion time of the catalog. Only set after the catalog is deleted. */
  deleteTime: string;
...
export const BiglakeCatalog: ResourceBinding<BiglakeCatalogConfig, BiglakeCatalogAttrs> = {
