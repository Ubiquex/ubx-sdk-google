// Code generated by `ubx sdk gen` from google_cloudscheduler_cloudscheduler_job. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface CloudschedulerJob_AppEngineHttpTarget_AppEngineRouting {
...
export interface CloudschedulerJob_AppEngineHttpTarget {
  ...
  appEngineRouting?: CloudschedulerJob_AppEngineHttpTarget_AppEngineRouting | Computed<CloudschedulerJob_AppEngineHttpTarget_AppEngineRouting>;
...
export interface CloudschedulerJob_HttpTarget_OauthToken {
...
export interface CloudschedulerJob_HttpTarget_OidcToken {
...
export interface CloudschedulerJob_HttpTarget {
  ...
  oauthToken?: CloudschedulerJob_HttpTarget_OauthToken | Computed<CloudschedulerJob_HttpTarget_OauthToken>;
  /** Contains information needed for generating an [OpenID Connect token](https://developers.google.com/identity/protocols/OpenIDConnect). This type of authorization can be used for many scenarios, including calling Cloud Run, or endpoints where you intend to validate the token yourself. */
  oidcToken?: CloudschedulerJob_HttpTarget_OidcToken | Computed<CloudschedulerJob_HttpTarget_OidcToken>;
  /** Required. The full URI path that the request will be sent to. This string must begin with either "http://" or "https://". Some examples of valid values for uri are: `http://acme.com` and `https://acme.com/sales:8080`. Cloud Scheduler will encode some characters for safety and compatibility. The maximum allowed URL length is 2083 characters after encoding. */
  uri?: string | Computed<string>;
}

export interface CloudschedulerJob_PubsubTarget {
...
export interface CloudschedulerJob_RetryConfig {
...
export interface CloudschedulerJob_Status {
...
const CloudschedulerJob_AppEngineHttpTarget_AppEngineRoutingFields: FieldMap = {
  host: "host",
  instance: "instance",
  service: "service",
  version: "version",
...
const CloudschedulerJob_AppEngineHttpTargetFields: FieldMap = {
  appEngineRouting: {
    wireName: "app_engine_routing",
    kind: "object",
    fields: CloudschedulerJob_AppEngineHttpTarget_AppEngineRoutingFields,
  },
  body: "body",
  headers: "headers",
...
const CloudschedulerJob_HttpTarget_OauthTokenFields: FieldMap = {
  scope: "scope",
  serviceAccountEmail: "service_account_email",
};

const CloudschedulerJob_HttpTarget_OidcTokenFields: FieldMap = {
  audience: "audience",
  serviceAccountEmail: "service_account_email",
};

const CloudschedulerJob_HttpTargetFields: FieldMap = {
  body: "body",
  headers: "headers",
  httpMethod: "http_method",
  oauthToken: {
    ...
    kind: "object",
    fields: CloudschedulerJob_HttpTarget_OauthTokenFields,
  },
  oidcToken: {
    wireName: "oidc_token",
    kind: "object",
    fields: CloudschedulerJob_HttpTarget_OidcTokenFields,
  },
  uri: "uri",
};

const CloudschedulerJob_PubsubTargetFields: FieldMap = {
  attributes: "attributes",
  data: "data",
  topicName: "topic_name",
};

const CloudschedulerJob_RetryConfigFields: FieldMap = {
...
const CloudschedulerJob_StatusFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

export interface CloudschedulerJobConfig {
  /** App Engine target. The job will be pushed to a job handler by means of an HTTP request via an http_method such as HTTP POST, HTTP GET, etc. The job is acknowledged by means of an HTTP response code in the range [200 - 299]. Error 503 is considered an App Engine system error instead of an application error. Requests returning error 503 will be retried regardless of retry configuration and not counted against retry counts. Any other response code, or a failure to receive a response before the deadline, constitutes a failed attempt. */
  appEngineHttpTarget?: CloudschedulerJob_AppEngineHttpTarget | Computed<CloudschedulerJob_AppEngineHttpTarget>;
  ...
  httpTarget?: CloudschedulerJob_HttpTarget | Computed<CloudschedulerJob_HttpTarget>;
  ...
  pubsubTarget?: CloudschedulerJob_PubsubTarget | Computed<CloudschedulerJob_PubsubTarget>;
  ...
  retryConfig?: CloudschedulerJob_RetryConfig | Computed<CloudschedulerJob_RetryConfig>;
  ...
  status?: CloudschedulerJob_Status | Computed<CloudschedulerJob_Status>;
...
export interface CloudschedulerJobAttrs {
  /** App Engine target. The job will be pushed to a job handler by means of an HTTP request via an http_method such as HTTP POST, HTTP GET, etc. The job is acknowledged by means of an HTTP response code in the range [200 - 299]. Error 503 is considered an App Engine system error instead of an application error. Requests returning error 503 will be retried regardless of retry configuration and not counted against retry counts. Any other response code, or a failure to receive a response before the deadline, constitutes a failed attempt. */
  appEngineHttpTarget: CloudschedulerJob_AppEngineHttpTarget;
  /** The deadline for job attempts. If the request handler does not respond by this deadline then the request is cancelled and the attempt is marked as a `DEADLINE_EXCEEDED` failure. The failed attempt can be viewed in execution logs. Cloud Scheduler will retry the job according to the RetryConfig. The default and the allowed values depend on the type of target: * For HTTP targets, the default is 3 minutes. The deadline must be in the interval [15 seconds, 30 minutes]. * For App Engine HTTP targets, 0 indicates that the request has the default deadline. The default deadline depends on the scaling type of the service: 10 minutes for standard apps with automatic scaling, 24 hours for standard apps with manual and basic scaling, and 60 minutes for flex apps. If the request deadline is set, it must be in the interval [15 seconds, 24 hours 15 seconds]. * For Pub/Sub targets, this field is ignored. */
  attemptDeadline: string;
  /** Optionally caller-specified in CreateJob or UpdateJob. A human-readable description for the job. This string must not contain more than 500 characters. */
  description: string;
  /** Http target. The job will be pushed to the job handler by means of an HTTP request via an http_method such as HTTP POST, HTTP GET, etc. The job is acknowledged by means of an HTTP response code in the range [200 - 299]. A failure to receive a response constitutes a failed execution. For a redirected request, the response returned by the redirected request is considered. */
  httpTarget: CloudschedulerJob_HttpTarget;
  /** Output only. The time the last job attempt started. */
  lastAttemptTime: string;
  /** Optionally caller-specified in CreateJob, after which it becomes output only. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`. * `PROJECT_ID` can contain letters ([A-Za-z]), numbers ([0-9]), hyphens (-), colons (:), or periods (.). For more information, see [Identifying projects](/resource-manager/docs/creating-managing-projects#identifying_projects) * `LOCATION_ID` is the canonical ID for the job's location. The list of available locations can be obtained by calling [locations.list](/scheduler/docs/reference/rest/v1/projects.locations/list). For more information, see [Cloud Scheduler locations](/scheduler/docs/locations). * `JOB_ID` can contain only letters ([A-Za-z]), numbers ([0-9]), hyphens (-), or underscores (_). The maximum length is 500 characters. */
  name: string;
  /** Pub/Sub target. The job will be delivered by publishing a message to the given Pub/Sub topic. */
  pubsubTarget: CloudschedulerJob_PubsubTarget;
  /** Settings that determine the retry behavior. For more information, see [Retry jobs](/scheduler/docs/configuring/retry-jobs). By default, if a job does not complete successfully (meaning that an acknowledgement is not received from the handler, then it will be retried with exponential backoff according to the settings in RetryConfig. */
  retryConfig: CloudschedulerJob_RetryConfig;
  /** Output only. Whether or not this Job satisfies the requirements of physical zone separation */
  ...
  state: string;
  /** The `Status` type defines a logical error model that is suitable for different programming environments, including REST APIs and RPC APIs. It is used by [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error code, error message, and error details. You can find out more about this error model and how to work with it in the [API Design Guide](https://cloud.google.com/apis/design/errors). */
  status: CloudschedulerJob_Status;
  /** Specifies the time zone to be used in interpreting schedule. The value of this field must be a time zone name from the [tz database](http://en.wikipedia.org/wiki/Tz_database). Note that some time zones include a provision for daylight savings time. The rules for daylight saving time are determined by the chosen tz. For UTC use the string "utc". If a time zone is not specified, the default will be in UTC (also known as GMT). */
  timeZone: string;
  /** Output only. The creation time of the job. */
...
export const CloudschedulerJob: ResourceBinding<CloudschedulerJobConfig, CloudschedulerJobAttrs> = {
  wireType: "google_cloudscheduler_cloudscheduler_job",
  fields: {
    appEngineHttpTarget: {
      wireName: "app_engine_http_target",
      kind: "object",
      fields: CloudschedulerJob_AppEngineHttpTargetFields,
    },
    ...
    httpTarget: {
      ...
      kind: "object",
      fields: CloudschedulerJob_HttpTargetFields,
    },
    ...
    pubsubTarget: {
      ...
      kind: "object",
      fields: CloudschedulerJob_PubsubTargetFields,
    },
    retryConfig: {
      wireName: "retry_config",
      kind: "object",
      fields: CloudschedulerJob_RetryConfigFields,
    },
    ...
    status: {
      wireName: "status",
      kind: "object",
      fields: CloudschedulerJob_StatusFields,
    },
    timeZone: "time_zone",
