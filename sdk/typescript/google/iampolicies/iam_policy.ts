...
const IamPolicy_Rules_DenyRule_DenialConditionFields: FieldMap = {
...
const IamPolicy_Rules_DenyRuleFields: FieldMap = {
  denialCondition: {
...
const IamPolicy_RulesFields: FieldMap = {
  denyRule: {
    wireName: "deny_rule",
    kind: "object",
