// Code generated by `ubx sdk gen` from google_ml_ml_model. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface MlModel_DefaultVersion_AcceleratorConfig {
...
export interface MlModel_DefaultVersion_AutoScaling_Metrics {
  name?: string | Computed<string>;
  target?: number | Computed<number>;
}

export interface MlModel_DefaultVersion_AutoScaling {
  ...
  metrics?: MlModel_DefaultVersion_AutoScaling_Metrics[] | Computed<MlModel_DefaultVersion_AutoScaling_Metrics[]>;
...
export interface MlModel_DefaultVersion_Container_Env {
  name?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface MlModel_DefaultVersion_Container_Ports {
  containerPort?: number | Computed<number>;
}

export interface MlModel_DefaultVersion_Container {
  ...
  env?: MlModel_DefaultVersion_Container_Env[] | Computed<MlModel_DefaultVersion_Container_Env[]>;
  ...
  ports?: MlModel_DefaultVersion_Container_Ports[] | Computed<MlModel_DefaultVersion_Container_Ports[]>;
}

export interface MlModel_DefaultVersion_ExplanationConfig_IntegratedGradientsAttribution {
  /** Number of steps for approximating the path integral. A good value to start is 50 and gradually increase until the sum to diff property is met within the desired error range. */
  numIntegralSteps?: number | Computed<number>;
}

export interface MlModel_DefaultVersion_ExplanationConfig_SampledShapleyAttribution {
  /** The number of feature permutations to consider when approximating the Shapley values. */
  numPaths?: number | Computed<number>;
}

export interface MlModel_DefaultVersion_ExplanationConfig {
  /** Attributes credit by computing the Aumann-Shapley value taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1703.01365 */
  integratedGradientsAttribution?: MlModel_DefaultVersion_ExplanationConfig_IntegratedGradientsAttribution | Computed<MlModel_DefaultVersion_ExplanationConfig_IntegratedGradientsAttribution>;
  /** An attribution method that approximates Shapley values for features that contribute to the label being predicted. A sampling strategy is used to approximate the value rather than considering all subsets of features. */
  sampledShapleyAttribution?: MlModel_DefaultVersion_ExplanationConfig_SampledShapleyAttribution | Computed<MlModel_DefaultVersion_ExplanationConfig_SampledShapleyAttribution>;
  /** Attributes credit by computing the XRAI taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1906.02825 Currently only implemented for models with natural image inputs. */
  xraiAttribution?: MlModel_DefaultVersion_ExplanationConfig_IntegratedGradientsAttribution | Computed<MlModel_DefaultVersion_ExplanationConfig_IntegratedGradientsAttribution>;
}

export interface MlModel_DefaultVersion_ManualScaling {
  /** The number of nodes to allocate for this model. These nodes are always up, starting from the time the model is deployed, so the cost of operating this model will be proportional to `nodes` * number of hours since last billing cycle plus the cost for each prediction performed. */
  nodes?: number | Computed<number>;
}

export interface MlModel_DefaultVersion_RequestLoggingConfig {
  ...
  bigqueryTableName?: string | Computed<string>;
...
export interface MlModel_DefaultVersion_Routes {
  ...
  predict?: string | Computed<string>;
}

export interface MlModel_DefaultVersion {
  ...
  acceleratorConfig?: MlModel_DefaultVersion_AcceleratorConfig | Computed<MlModel_DefaultVersion_AcceleratorConfig>;
  /** Options for automatically scaling a model. */
  autoScaling?: MlModel_DefaultVersion_AutoScaling | Computed<MlModel_DefaultVersion_AutoScaling>;
  ...
  container?: MlModel_DefaultVersion_Container | Computed<MlModel_DefaultVersion_Container>;
  ...
  deploymentUri?: string | Computed<string>;
  ...
  explanationConfig?: MlModel_DefaultVersion_ExplanationConfig | Computed<MlModel_DefaultVersion_ExplanationConfig>;
  ...
  lastMigrationModelId?: string | Computed<string>;
  ...
  lastUseTime?: string | Computed<string>;
  ...
  manualScaling?: MlModel_DefaultVersion_ManualScaling | Computed<MlModel_DefaultVersion_ManualScaling>;
  ...
  predictionClass?: string | Computed<string>;
  ...
  requestLoggingConfig?: MlModel_DefaultVersion_RequestLoggingConfig | Computed<MlModel_DefaultVersion_RequestLoggingConfig>;
  ...
  routes?: MlModel_DefaultVersion_Routes | Computed<MlModel_DefaultVersion_Routes>;
...
const MlModel_DefaultVersion_AcceleratorConfigFields: FieldMap = {
  count: "count",
  type: "type",
};

const MlModel_DefaultVersion_AutoScaling_MetricsFields: FieldMap = {
  name: "name",
  target: "target",
};

const MlModel_DefaultVersion_AutoScalingFields: FieldMap = {
  maxNodes: "max_nodes",
  metrics: {
    wireName: "metrics",
    kind: "list",
    fields: MlModel_DefaultVersion_AutoScaling_MetricsFields,
  },
  minNodes: "min_nodes",
};

const MlModel_DefaultVersion_Container_EnvFields: FieldMap = {
  name: "name",
  value: "value",
};

const MlModel_DefaultVersion_Container_PortsFields: FieldMap = {
  containerPort: "container_port",
};

const MlModel_DefaultVersion_ContainerFields: FieldMap = {
  args: "args",
  command: "command",
  env: {
    wireName: "env",
    kind: "list",
    fields: MlModel_DefaultVersion_Container_EnvFields,
  },
  image: "image",
  ports: {
    wireName: "ports",
    kind: "list",
    fields: MlModel_DefaultVersion_Container_PortsFields,
  },
};

const MlModel_DefaultVersion_ExplanationConfig_IntegratedGradientsAttributionFields: FieldMap = {
  numIntegralSteps: "num_integral_steps",
};

const MlModel_DefaultVersion_ExplanationConfig_SampledShapleyAttributionFields: FieldMap = {
  numPaths: "num_paths",
};

const MlModel_DefaultVersion_ExplanationConfigFields: FieldMap = {
  integratedGradientsAttribution: {
    wireName: "integrated_gradients_attribution",
    kind: "object",
    fields: MlModel_DefaultVersion_ExplanationConfig_IntegratedGradientsAttributionFields,
  },
  sampledShapleyAttribution: {
    wireName: "sampled_shapley_attribution",
    kind: "object",
    fields: MlModel_DefaultVersion_ExplanationConfig_SampledShapleyAttributionFields,
  },
  xraiAttribution: {
...
const MlModel_DefaultVersion_ManualScalingFields: FieldMap = {
  nodes: "nodes",
};

const MlModel_DefaultVersion_RequestLoggingConfigFields: FieldMap = {
  bigqueryTableName: "bigquery_table_name",
  samplingPercentage: "sampling_percentage",
};

const MlModel_DefaultVersion_RoutesFields: FieldMap = {
  health: "health",
  predict: "predict",
};

const MlModel_DefaultVersionFields: FieldMap = {
  acceleratorConfig: {
    wireName: "accelerator_config",
    kind: "object",
    fields: MlModel_DefaultVersion_AcceleratorConfigFields,
  },
  autoScaling: {
    wireName: "auto_scaling",
    kind: "object",
    fields: MlModel_DefaultVersion_AutoScalingFields,
  },
  container: {
    wireName: "container",
    kind: "object",
    fields: MlModel_DefaultVersion_ContainerFields,
  },
  ...
  explanationConfig: {
    ...
    kind: "object",
    fields: MlModel_DefaultVersion_ExplanationConfigFields,
  },
  framework: "framework",
  ...
  manualScaling: {
    ...
    kind: "object",
    fields: MlModel_DefaultVersion_ManualScalingFields,
  },
  name: "name",
  ...
  requestLoggingConfig: {
    ...
    kind: "object",
    fields: MlModel_DefaultVersion_RequestLoggingConfigFields,
  },
  routes: {
    wireName: "routes",
    kind: "object",
    fields: MlModel_DefaultVersion_RoutesFields,
  },
...
export interface MlModelConfig {
  ...
  defaultVersion?: MlModel_DefaultVersion | Computed<MlModel_DefaultVersion>;
...
export interface MlModelAttrs {
  /** Represents a version of the model. Each version is a trained model deployed in the cloud, ready to handle prediction requests. A model can have multiple versions. You can get information about all of the versions of a given model by calling projects.models.versions.list. */
  defaultVersion: MlModel_DefaultVersion;
  /** Optional. The description specified for the model when it was created. */
  description: string;
  /** `etag` is used for optimistic concurrency control as a way to help prevent simultaneous updates of a model from overwriting each other. It is strongly suggested that systems make use of the `etag` in the read-modify-write cycle to perform model updates in order to avoid race conditions: An `etag` is returned in the response to `GetModel`, and systems are expected to put that etag in the request to `UpdateModel` to ensure that their change will be applied to the model as intended. */
  etag: string;
...
export const MlModel: ResourceBinding<MlModelConfig, MlModelAttrs> = {
  wireType: "google_ml_ml_model",
  fields: {
    defaultVersion: {
      wireName: "default_version",
      kind: "object",
      fields: MlModel_DefaultVersionFields,
    },
    description: "description",
    etag: "etag",
    labels: "labels",
