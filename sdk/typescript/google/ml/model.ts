// Code generated by `ubx sdk gen` from google_ml_model. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface Model_DefaultVersion_AcceleratorConfig {
...
export interface Model_DefaultVersion_AutoScaling {
  ...
  metrics?: Model_DefaultVersion_AutoScaling_Metrics[] | Computed<Model_DefaultVersion_AutoScaling_Metrics[]>;
...
export interface Model_DefaultVersion_Container {
  ...
  env?: Model_DefaultVersion_Container_Env[] | Computed<Model_DefaultVersion_Container_Env[]>;
  ...
  ports?: Model_DefaultVersion_Container_Ports[] | Computed<Model_DefaultVersion_Container_Ports[]>;
}

export interface Model_DefaultVersion_ExplanationConfig_IntegratedGradientsAttribution {
  /** Number of steps for approximating the path integral. A good value to start is 50 and gradually increase until the sum to diff property is met within the desired error range. */
  numIntegralSteps?: number | Computed<number>;
}

export interface Model_DefaultVersion_ExplanationConfig_SampledShapleyAttribution {
  /** The number of feature permutations to consider when approximating the Shapley values. */
  numPaths?: number | Computed<number>;
}

export interface Model_DefaultVersion_ExplanationConfig {
  /** Attributes credit by computing the Aumann-Shapley value taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1703.01365 */
  integratedGradientsAttribution?: Model_DefaultVersion_ExplanationConfig_IntegratedGradientsAttribution | Computed<Model_DefaultVersion_ExplanationConfig_IntegratedGradientsAttribution>;
  /** An attribution method that approximates Shapley values for features that contribute to the label being predicted. A sampling strategy is used to approximate the value rather than considering all subsets of features. */
  sampledShapleyAttribution?: Model_DefaultVersion_ExplanationConfig_SampledShapleyAttribution | Computed<Model_DefaultVersion_ExplanationConfig_SampledShapleyAttribution>;
  /** Attributes credit by computing the XRAI taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1906.02825 Currently only implemented for models with natural image inputs. */
  xraiAttribution?: Model_DefaultVersion_ExplanationConfig_IntegratedGradientsAttribution | Computed<Model_DefaultVersion_ExplanationConfig_IntegratedGradientsAttribution>;
}

export interface Model_DefaultVersion_ManualScaling {
  /** The number of nodes to allocate for this model. These nodes are always up, starting from the time the model is deployed, so the cost of operating this model will be proportional to `nodes` * number of hours since last billing cycle plus the cost for each prediction performed. */
  nodes?: number | Computed<number>;
}

export interface Model_DefaultVersion_RequestLoggingConfig {
...
export interface Model_DefaultVersion_Routes {
...
export interface Model_DefaultVersion {
  ...
  acceleratorConfig?: Model_DefaultVersion_AcceleratorConfig | Computed<Model_DefaultVersion_AcceleratorConfig>;
  /** Options for automatically scaling a model. */
  autoScaling?: Model_DefaultVersion_AutoScaling | Computed<Model_DefaultVersion_AutoScaling>;
  ...
  container?: Model_DefaultVersion_Container | Computed<Model_DefaultVersion_Container>;
  ...
  explanationConfig?: Model_DefaultVersion_ExplanationConfig | Computed<Model_DefaultVersion_ExplanationConfig>;
  ...
  manualScaling?: Model_DefaultVersion_ManualScaling | Computed<Model_DefaultVersion_ManualScaling>;
  ...
  requestLoggingConfig?: Model_DefaultVersion_RequestLoggingConfig | Computed<Model_DefaultVersion_RequestLoggingConfig>;
  ...
  routes?: Model_DefaultVersion_Routes | Computed<Model_DefaultVersion_Routes>;
...
const Model_DefaultVersion_AcceleratorConfigFields: FieldMap = {
  count: "count",
  type: "type",
};

const Model_DefaultVersion_AutoScaling_MetricsFields: FieldMap = {
  name: "name",
  target: "target",
};

const Model_DefaultVersion_AutoScalingFields: FieldMap = {
  maxNodes: "max_nodes",
  metrics: {
    wireName: "metrics",
    kind: "list",
    fields: Model_DefaultVersion_AutoScaling_MetricsFields,
  },
  minNodes: "min_nodes",
};

const Model_DefaultVersion_Container_EnvFields: FieldMap = {
  name: "name",
  value: "value",
};

const Model_DefaultVersion_Container_PortsFields: FieldMap = {
  containerPort: "container_port",
};

const Model_DefaultVersion_ContainerFields: FieldMap = {
  args: "args",
  command: "command",
  env: {
    wireName: "env",
    kind: "list",
    fields: Model_DefaultVersion_Container_EnvFields,
  },
  image: "image",
  ports: {
    wireName: "ports",
    kind: "list",
    fields: Model_DefaultVersion_Container_PortsFields,
  },
};

const Model_DefaultVersion_ExplanationConfig_IntegratedGradientsAttributionFields: FieldMap = {
  numIntegralSteps: "num_integral_steps",
};

const Model_DefaultVersion_ExplanationConfig_SampledShapleyAttributionFields: FieldMap = {
  numPaths: "num_paths",
};

const Model_DefaultVersion_ExplanationConfigFields: FieldMap = {
  integratedGradientsAttribution: {
    wireName: "integrated_gradients_attribution",
    kind: "object",
    fields: Model_DefaultVersion_ExplanationConfig_IntegratedGradientsAttributionFields,
  },
  sampledShapleyAttribution: {
    wireName: "sampled_shapley_attribution",
    kind: "object",
    fields: Model_DefaultVersion_ExplanationConfig_SampledShapleyAttributionFields,
  },
  xraiAttribution: {
...
const Model_DefaultVersion_ManualScalingFields: FieldMap = {
  nodes: "nodes",
};

const Model_DefaultVersion_RequestLoggingConfigFields: FieldMap = {
  bigqueryTableName: "bigquery_table_name",
  samplingPercentage: "sampling_percentage",
};

const Model_DefaultVersion_RoutesFields: FieldMap = {
  health: "health",
  predict: "predict",
};

const Model_DefaultVersionFields: FieldMap = {
  acceleratorConfig: {
    wireName: "accelerator_config",
    kind: "object",
    fields: Model_DefaultVersion_AcceleratorConfigFields,
  },
  autoScaling: {
    wireName: "auto_scaling",
    kind: "object",
    fields: Model_DefaultVersion_AutoScalingFields,
  },
  container: {
    wireName: "container",
    kind: "object",
    fields: Model_DefaultVersion_ContainerFields,
  },
  ...
  explanationConfig: {
    ...
    kind: "object",
    fields: Model_DefaultVersion_ExplanationConfigFields,
  },
  framework: "framework",
  ...
  manualScaling: {
    ...
    kind: "object",
    fields: Model_DefaultVersion_ManualScalingFields,
  },
  name: "name",
  ...
  requestLoggingConfig: {
    ...
    kind: "object",
    fields: Model_DefaultVersion_RequestLoggingConfigFields,
  },
  routes: {
    wireName: "routes",
    kind: "object",
    fields: Model_DefaultVersion_RoutesFields,
  },
...
export interface ModelConfig {
  ...
  defaultVersion?: Model_DefaultVersion | Computed<Model_DefaultVersion>;
...
export interface ModelAttrs {
  /** Represents a version of the model. Each version is a trained model deployed in the cloud, ready to handle prediction requests. A model can have multiple versions. You can get information about all of the versions of a given model by calling projects.models.versions.list. */
  defaultVersion: Model_DefaultVersion;
  /** Optional. The description specified for the model when it was created. */
  description: string;
  /** `etag` is used for optimistic concurrency control as a way to help prevent simultaneous updates of a model from overwriting each other. It is strongly suggested that systems make use of the `etag` in the read-modify-write cycle to perform model updates in order to avoid race conditions: An `etag` is returned in the response to `GetModel`, and systems are expected to put that etag in the request to `UpdateModel` to ensure that their change will be applied to the model as intended. */
  etag: string;
...
export const Model: ResourceBinding<ModelConfig, ModelAttrs> = {
  wireType: "google_ml_model",
  fields: {
    defaultVersion: {
      wireName: "default_version",
      kind: "object",
      fields: Model_DefaultVersionFields,
    },
    description: "description",
    etag: "etag",
    labels: "labels",
