...
export interface V1beta1NodePool_AutopilotConfig {
  /** Denotes that nodes belonging to this node pool are Autopilot nodes. */
  enabled?: boolean | Computed<boolean>;
}

export interface V1beta1NodePool_Autoscaling {
...
export interface V1beta1NodePool_BestEffortProvisioning {
...
export interface V1beta1NodePool_Conditions {
  canonicalCode?: string | Computed<string>;
  code?: string | Computed<string>;
  message?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_Accelerators_GpuDriverInstallationConfig {
  gpuDriverVersion?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_Accelerators_GpuSharingConfig {
  gpuSharingStrategy?: string | Computed<string>;
  maxSharedClientsPerGpu?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_Accelerators {
  acceleratorCount?: string | Computed<string>;
  acceleratorType?: string | Computed<string>;
  gpuDriverInstallationConfig?: V1beta1NodePool_Config_Accelerators_GpuDriverInstallationConfig | Computed<V1beta1NodePool_Config_Accelerators_GpuDriverInstallationConfig>;
  gpuPartitionSize?: string | Computed<string>;
  gpuSharingConfig?: V1beta1NodePool_Config_Accelerators_GpuSharingConfig | Computed<V1beta1NodePool_Config_Accelerators_GpuSharingConfig>;
  maxTimeSharedClientsPerGpu?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_AdvancedMachineFeatures {
...
export interface V1beta1NodePool_Config_BootDisk {
...
export interface V1beta1NodePool_Config_ConfidentialNodes {
...
export interface V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfig_GcpSecretManagerCertificateConfig {
  secretUri?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfig {
  fqdns?: string[] | Computed<string[]>;
  gcpSecretManagerCertificateConfig?: V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfig_GcpSecretManagerCertificateConfig | Computed<V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfig_GcpSecretManagerCertificateConfig>;
}

export interface V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig {
  /** Private registry access configuration. */
  certificateAuthorityDomainConfig?: V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfig[] | Computed<V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfig[]>;
  /** Private registry access is enabled. */
  enabled?: boolean | Computed<boolean>;
}

export interface V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Ca {
  gcpSecretManagerSecretUri?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Client {
  cert?: V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Ca | Computed<V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Ca>;
  key?: V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Ca | Computed<V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Ca>;
}

export interface V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Header {
  key?: string | Computed<string>;
  value?: string[] | Computed<string[]>;
}

export interface V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts {
  ca?: V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Ca[] | Computed<V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Ca[]>;
  capabilities?: string[] | Computed<string[]>;
  client?: V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Client[] | Computed<V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Client[]>;
  dialTimeout?: string | Computed<string>;
  header?: V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Header[] | Computed<V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_Header[]>;
  host?: string | Computed<string>;
  overridePath?: boolean | Computed<boolean>;
}

export interface V1beta1NodePool_Config_ContainerdConfig_RegistryHosts {
  hosts?: V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts[] | Computed<V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts[]>;
  server?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_ContainerdConfig {
  /** PrivateRegistryAccessConfig contains access configuration for private container registries. */
  privateRegistryAccessConfig?: V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig | Computed<V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig>;
  ...
  registryHosts?: V1beta1NodePool_Config_ContainerdConfig_RegistryHosts[] | Computed<V1beta1NodePool_Config_ContainerdConfig_RegistryHosts[]>;
  /** Defines writable cgroups configuration. */
  writableCgroups?: V1beta1NodePool_AutopilotConfig | Computed<V1beta1NodePool_AutopilotConfig>;
}

export interface V1beta1NodePool_Config_EphemeralStorageConfig {
...
export interface V1beta1NodePool_Config_EphemeralStorageLocalSsdConfig {
...
export interface V1beta1NodePool_Config_GpuDirectConfig {
  /** The type of GPU direct strategy to enable on the node pool. */
  gpuDirectStrategy?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_HostMaintenancePolicy_OpportunisticMaintenanceStrategy {
...
export interface V1beta1NodePool_Config_HostMaintenancePolicy {
  /** Specifies the frequency of planned maintenance events. */
  maintenanceInterval?: string | Computed<string>;
  /** Strategy that will trigger maintenance on behalf of the customer. */
  opportunisticMaintenanceStrategy?: V1beta1NodePool_Config_HostMaintenancePolicy_OpportunisticMaintenanceStrategy | Computed<V1beta1NodePool_Config_HostMaintenancePolicy_OpportunisticMaintenanceStrategy>;
}

export interface V1beta1NodePool_Config_KubeletConfig_CrashLoopBackOff {
...
export interface V1beta1NodePool_Config_KubeletConfig_EvictionMinimumReclaim {
...
export interface V1beta1NodePool_Config_KubeletConfig_MemoryManager {
...
export interface V1beta1NodePool_Config_KubeletConfig_TopologyManager {
...
export interface V1beta1NodePool_Config_KubeletConfig {
  ...
  crashLoopBackOff?: V1beta1NodePool_Config_KubeletConfig_CrashLoopBackOff | Computed<V1beta1NodePool_Config_KubeletConfig_CrashLoopBackOff>;
  ...
  evictionMinimumReclaim?: V1beta1NodePool_Config_KubeletConfig_EvictionMinimumReclaim | Computed<V1beta1NodePool_Config_KubeletConfig_EvictionMinimumReclaim>;
  ...
  evictionSoft?: V1beta1NodePool_Config_KubeletConfig_EvictionMinimumReclaim | Computed<V1beta1NodePool_Config_KubeletConfig_EvictionMinimumReclaim>;
  /** Eviction grace periods are grace periods for each eviction signal. */
  evictionSoftGracePeriod?: V1beta1NodePool_Config_KubeletConfig_EvictionMinimumReclaim | Computed<V1beta1NodePool_Config_KubeletConfig_EvictionMinimumReclaim>;
  ...
  memoryManager?: V1beta1NodePool_Config_KubeletConfig_MemoryManager | Computed<V1beta1NodePool_Config_KubeletConfig_MemoryManager>;
  ...
  topologyManager?: V1beta1NodePool_Config_KubeletConfig_TopologyManager | Computed<V1beta1NodePool_Config_KubeletConfig_TopologyManager>;
}

export interface V1beta1NodePool_Config_LinuxNodeConfig_AccurateTimeConfig {
  /** Enables enhanced time synchronization using PTP-KVM. */
  enablePtpKvmTimeSync?: boolean | Computed<boolean>;
}

export interface V1beta1NodePool_Config_LinuxNodeConfig_CustomNodeInit_InitScript {
...
export interface V1beta1NodePool_Config_LinuxNodeConfig_CustomNodeInit {
  /** InitScript provide a simply bash script to be executed on the node. */
  initScript?: V1beta1NodePool_Config_LinuxNodeConfig_CustomNodeInit_InitScript | Computed<V1beta1NodePool_Config_LinuxNodeConfig_CustomNodeInit_InitScript>;
}

export interface V1beta1NodePool_Config_LinuxNodeConfig_DiskIoScheduler {
...
export interface V1beta1NodePool_Config_LinuxNodeConfig_Hugepages {
...
export interface V1beta1NodePool_Config_LinuxNodeConfig_NodeVfioConfig {
...
export interface V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_BootDiskProfile {
...
export interface V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_DedicatedLocalSsdProfile {
  /** The number of physical local NVMe SSD disks to attach. */
  diskCount?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_EncryptionConfig {
  /** Optional. If true, swap space will not be encrypted. Defaults to false (encrypted). */
  disabled?: boolean | Computed<boolean>;
}

export interface V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig {
  /** Swap on the node's boot disk. */
  bootDiskProfile?: V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_BootDiskProfile | Computed<V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_BootDiskProfile>;
  /** Provisions a new, separate local NVMe SSD exclusively for swap. */
  dedicatedLocalSsdProfile?: V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_DedicatedLocalSsdProfile | Computed<V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_DedicatedLocalSsdProfile>;
  /** Optional. Enables or disables swap for the node pool. */
  enabled?: boolean | Computed<boolean>;
  /** Defines encryption settings for the swap space. */
  encryptionConfig?: V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_EncryptionConfig | Computed<V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_EncryptionConfig>;
  /** Swap on the local SSD shared with pod ephemeral storage. */
  ephemeralLocalSsdProfile?: V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_BootDiskProfile | Computed<V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_BootDiskProfile>;
}

export interface V1beta1NodePool_Config_LinuxNodeConfig {
  /** AccurateTimeConfig contains configuration for the accurate time synchronization feature. */
  accurateTimeConfig?: V1beta1NodePool_Config_LinuxNodeConfig_AccurateTimeConfig | Computed<V1beta1NodePool_Config_LinuxNodeConfig_AccurateTimeConfig>;
  /** cgroup_mode specifies the cgroup mode to be used on the node. */
  cgroupMode?: string | Computed<string>;
  /** Support for running custom init code while bootstrapping nodes. */
  customNodeInit?: V1beta1NodePool_Config_LinuxNodeConfig_CustomNodeInit | Computed<V1beta1NodePool_Config_LinuxNodeConfig_CustomNodeInit>;
  /** DiskIoScheduler contains the configuration for the disk IO scheduler. */
  diskIoScheduler?: V1beta1NodePool_Config_LinuxNodeConfig_DiskIoScheduler | Computed<V1beta1NodePool_Config_LinuxNodeConfig_DiskIoScheduler>;
  /** Hugepages amount in both 2m and 1g size */
  hugepages?: V1beta1NodePool_Config_LinuxNodeConfig_Hugepages | Computed<V1beta1NodePool_Config_LinuxNodeConfig_Hugepages>;
  /** Configuration for kernel module loading on nodes. */
  nodeKernelModuleLoading?: V1beta1NodePool_Config_KubeletConfig_MemoryManager | Computed<V1beta1NodePool_Config_KubeletConfig_MemoryManager>;
  ...
  nodeVfioConfig?: V1beta1NodePool_Config_LinuxNodeConfig_NodeVfioConfig | Computed<V1beta1NodePool_Config_LinuxNodeConfig_NodeVfioConfig>;
  /** Configuration for swap memory on a node pool. */
  swapConfig?: V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig | Computed<V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig>;
...
export interface V1beta1NodePool_Config_LoggingConfig_VariantConfig {
  /** Logging variant deployed on nodes. */
  variant?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_LoggingConfig {
  /** LoggingVariantConfig specifies the behaviour of the logging component. */
  variantConfig?: V1beta1NodePool_Config_LoggingConfig_VariantConfig | Computed<V1beta1NodePool_Config_LoggingConfig_VariantConfig>;
}

export interface V1beta1NodePool_Config_NodeImageConfig {
...
export interface V1beta1NodePool_Config_ReservationAffinity {
...
export interface V1beta1NodePool_Config_ResourceManagerTags {
...
export interface V1beta1NodePool_Config_SandboxConfig {
...
export interface V1beta1NodePool_Config_SecondaryBootDisks {
  diskImage?: string | Computed<string>;
  mode?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_ShieldedInstanceConfig {
...
export interface V1beta1NodePool_Config_SoleTenantConfig_NodeAffinities {
  key?: string | Computed<string>;
  operator?: string | Computed<string>;
  values?: string[] | Computed<string[]>;
}

export interface V1beta1NodePool_Config_SoleTenantConfig {
  ...
  nodeAffinities?: V1beta1NodePool_Config_SoleTenantConfig_NodeAffinities[] | Computed<V1beta1NodePool_Config_SoleTenantConfig_NodeAffinities[]>;
}

export interface V1beta1NodePool_Config_TaintConfig {
  /** Optional. Controls architecture tainting behavior. */
  architectureTaintBehavior?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_Taints {
  effect?: string | Computed<string>;
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_WindowsNodeConfig {
  /** OSVersion specifies the Windows node config to be used on the node. */
  osVersion?: string | Computed<string>;
}

export interface V1beta1NodePool_Config_WorkloadMetadataConfig {
...
export interface V1beta1NodePool_Config {
  /** A list of hardware accelerators to be attached to each node. See https://cloud.google.com/compute/docs/gpus for more information about support for GPUs. */
  accelerators?: V1beta1NodePool_Config_Accelerators[] | Computed<V1beta1NodePool_Config_Accelerators[]>;
  /** Specifies options for controlling advanced machine features. */
  advancedMachineFeatures?: V1beta1NodePool_Config_AdvancedMachineFeatures | Computed<V1beta1NodePool_Config_AdvancedMachineFeatures>;
  /** BootDisk specifies the boot disk configuration for node pools. */
  bootDisk?: V1beta1NodePool_Config_BootDisk | Computed<V1beta1NodePool_Config_BootDisk>;
  ...
  confidentialNodes?: V1beta1NodePool_Config_ConfidentialNodes | Computed<V1beta1NodePool_Config_ConfidentialNodes>;
  ...
  containerdConfig?: V1beta1NodePool_Config_ContainerdConfig | Computed<V1beta1NodePool_Config_ContainerdConfig>;
  ...
  ephemeralStorageConfig?: V1beta1NodePool_Config_EphemeralStorageConfig | Computed<V1beta1NodePool_Config_EphemeralStorageConfig>;
  /** EphemeralStorageLocalSsdConfig contains configuration for the node ephemeral storage using Local SSDs. */
  ephemeralStorageLocalSsdConfig?: V1beta1NodePool_Config_EphemeralStorageLocalSsdConfig | Computed<V1beta1NodePool_Config_EphemeralStorageLocalSsdConfig>;
  /** Configuration of Fast Socket feature. */
  fastSocket?: V1beta1NodePool_AutopilotConfig | Computed<V1beta1NodePool_AutopilotConfig>;
  /** Flex Start flag for enabling Flex Start VM. */
  flexStart?: boolean | Computed<boolean>;
  /** GcfsConfig contains configurations of Google Container File System. */
  gcfsConfig?: V1beta1NodePool_AutopilotConfig | Computed<V1beta1NodePool_AutopilotConfig>;
  /** GPUDirectConfig specifies the GPU direct strategy on the node pool. */
  gpuDirectConfig?: V1beta1NodePool_Config_GpuDirectConfig | Computed<V1beta1NodePool_Config_GpuDirectConfig>;
  /** Configuration of gVNIC feature. */
  gvnic?: V1beta1NodePool_AutopilotConfig | Computed<V1beta1NodePool_AutopilotConfig>;
  /** HostMaintenancePolicy contains the maintenance policy for the hosts on which the GKE VMs run on. */
  hostMaintenancePolicy?: V1beta1NodePool_Config_HostMaintenancePolicy | Computed<V1beta1NodePool_Config_HostMaintenancePolicy>;
  /** The image type to use for this node. Note that for a given image type, the latest version of it will be used. Please see https://cloud.google.com/kubernetes-engine/docs/concepts/node-images for available image types. */
  imageType?: string | Computed<string>;
  /** Node kubelet configs. */
  kubeletConfig?: V1beta1NodePool_Config_KubeletConfig | Computed<V1beta1NodePool_Config_KubeletConfig>;
  ...
  linuxNodeConfig?: V1beta1NodePool_Config_LinuxNodeConfig | Computed<V1beta1NodePool_Config_LinuxNodeConfig>;
  /** LocalNvmeSsdBlockConfig contains configuration for using raw-block local NVMe SSDs */
  localNvmeSsdBlockConfig?: V1beta1NodePool_Config_EphemeralStorageConfig | Computed<V1beta1NodePool_Config_EphemeralStorageConfig>;
  ...
  loggingConfig?: V1beta1NodePool_Config_LoggingConfig | Computed<V1beta1NodePool_Config_LoggingConfig>;
  ...
  nodeImageConfig?: V1beta1NodePool_Config_NodeImageConfig | Computed<V1beta1NodePool_Config_NodeImageConfig>;
  ...
  reservationAffinity?: V1beta1NodePool_Config_ReservationAffinity | Computed<V1beta1NodePool_Config_ReservationAffinity>;
  ...
  resourceManagerTags?: V1beta1NodePool_Config_ResourceManagerTags | Computed<V1beta1NodePool_Config_ResourceManagerTags>;
  /** SandboxConfig contains configurations of the sandbox to use for the node. */
  sandboxConfig?: V1beta1NodePool_Config_SandboxConfig | Computed<V1beta1NodePool_Config_SandboxConfig>;
  ...
  secondaryBootDisks?: V1beta1NodePool_Config_SecondaryBootDisks[] | Computed<V1beta1NodePool_Config_SecondaryBootDisks[]>;
  /** The Google Cloud Platform Service Account to be used by the node VMs. Specify the email address of the Service Account; otherwise, if no Service Account is specified, the "default" service account is used. */
  serviceAccount?: string | Computed<string>;
  /** A set of Shielded Instance options. */
  shieldedInstanceConfig?: V1beta1NodePool_Config_ShieldedInstanceConfig | Computed<V1beta1NodePool_Config_ShieldedInstanceConfig>;
  /** SoleTenantConfig contains the NodeAffinities to specify what shared sole tenant node groups should back the node pool. */
  soleTenantConfig?: V1beta1NodePool_Config_SoleTenantConfig | Computed<V1beta1NodePool_Config_SoleTenantConfig>;
  ...
  taintConfig?: V1beta1NodePool_Config_TaintConfig | Computed<V1beta1NodePool_Config_TaintConfig>;
  /** List of kubernetes taints to be applied to each node. For more information, including usage and the valid values, see: https://kubernetes.io/docs/concepts/configuration/taint-and-toleration/ */
  taints?: V1beta1NodePool_Config_Taints[] | Computed<V1beta1NodePool_Config_Taints[]>;
  /** Parameters that can be configured on Windows nodes. Windows Node Config that define the parameters that will be used to configure the Windows node pool settings. */
  windowsNodeConfig?: V1beta1NodePool_Config_WindowsNodeConfig | Computed<V1beta1NodePool_Config_WindowsNodeConfig>;
  /** WorkloadMetadataConfig defines the metadata configuration to expose to workloads on the node pool. */
  workloadMetadataConfig?: V1beta1NodePool_Config_WorkloadMetadataConfig | Computed<V1beta1NodePool_Config_WorkloadMetadataConfig>;
}

export interface V1beta1NodePool_KubeletCertInfo {
  /** Output only. */
...
export interface V1beta1NodePool_MaintenancePolicy_ExclusionUntilEndOfSupport {
...
export interface V1beta1NodePool_MaintenancePolicy {
  /** Defines the maintenance exclusion for the node pool. */
  exclusionUntilEndOfSupport?: V1beta1NodePool_MaintenancePolicy_ExclusionUntilEndOfSupport | Computed<V1beta1NodePool_MaintenancePolicy_ExclusionUntilEndOfSupport>;
}

export interface V1beta1NodePool_Management_UpgradeOptions {
...
export interface V1beta1NodePool_Management {
  /** Whether the nodes will be automatically repaired. */
  autoRepair?: boolean | Computed<boolean>;
  /** Whether the nodes will be automatically upgraded. */
  autoUpgrade?: boolean | Computed<boolean>;
  /** AutoUpgradeOptions defines the set of options for the user to control how the Auto Upgrades will proceed. */
  upgradeOptions?: V1beta1NodePool_Management_UpgradeOptions | Computed<V1beta1NodePool_Management_UpgradeOptions>;
}

export interface V1beta1NodePool_MaxPodsConstraint {
  /** Constraint enforced on the max num of pods per node. */
  maxPodsPerNode?: string | Computed<string>;
}

export interface V1beta1NodePool_NetworkConfig_AdditionalNodeNetworkConfigs {
  network?: string | Computed<string>;
  subnetwork?: string | Computed<string>;
}

export interface V1beta1NodePool_NetworkConfig_AdditionalPodNetworkConfigs {
  maxPodsPerNode?: V1beta1NodePool_MaxPodsConstraint | Computed<V1beta1NodePool_MaxPodsConstraint>;
  networkAttachment?: string | Computed<string>;
  secondaryPodRange?: string | Computed<string>;
  subnetwork?: string | Computed<string>;
}

export interface V1beta1NodePool_NetworkConfig_NetworkPerformanceConfig {
...
export interface V1beta1NodePool_NetworkConfig_NetworkTierConfig {
  /** Network tier configuration. */
  networkTier?: string | Computed<string>;
}

export interface V1beta1NodePool_NetworkConfig_PodCidrOverprovisionConfig {
  /** Whether Pod CIDR overprovisioning is disabled. Note: Pod CIDR overprovisioning is enabled by default. */
  disable?: boolean | Computed<boolean>;
}

export interface V1beta1NodePool_NetworkConfig {
  ...
  additionalNodeNetworkConfigs?: V1beta1NodePool_NetworkConfig_AdditionalNodeNetworkConfigs[] | Computed<V1beta1NodePool_NetworkConfig_AdditionalNodeNetworkConfigs[]>;
  /** We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node */
  additionalPodNetworkConfigs?: V1beta1NodePool_NetworkConfig_AdditionalPodNetworkConfigs[] | Computed<V1beta1NodePool_NetworkConfig_AdditionalPodNetworkConfigs[]>;
  ...
  networkPerformanceConfig?: V1beta1NodePool_NetworkConfig_NetworkPerformanceConfig | Computed<V1beta1NodePool_NetworkConfig_NetworkPerformanceConfig>;
  /** NetworkTierConfig contains network tier information. */
  networkTierConfig?: V1beta1NodePool_NetworkConfig_NetworkTierConfig | Computed<V1beta1NodePool_NetworkConfig_NetworkTierConfig>;
  /** [PRIVATE FIELD] Config for pod CIDR size overprovisioning. */
  podCidrOverprovisionConfig?: V1beta1NodePool_NetworkConfig_PodCidrOverprovisionConfig | Computed<V1beta1NodePool_NetworkConfig_PodCidrOverprovisionConfig>;
...
export interface V1beta1NodePool_NodeDrainConfig {
...
export interface V1beta1NodePool_NodePool_PlacementPolicy {
...
export interface V1beta1NodePool_NodePool_UpdateInfo_BlueGreenInfo {
...
export interface V1beta1NodePool_NodePool_UpdateInfo {
  /** Information relevant to blue-green upgrade. */
  blueGreenInfo?: V1beta1NodePool_NodePool_UpdateInfo_BlueGreenInfo | Computed<V1beta1NodePool_NodePool_UpdateInfo_BlueGreenInfo>;
}

export interface V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings_AutoscaledRolloutPolicy {
...
export interface V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings_StandardRolloutPolicy {
...
export interface V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings {
  ...
  autoscaledRolloutPolicy?: V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings_AutoscaledRolloutPolicy | Computed<V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings_AutoscaledRolloutPolicy>;
  /** Time needed after draining entire blue pool. After this period, blue pool will be cleaned up. */
  nodePoolSoakDuration?: string | Computed<string>;
  /** Standard rollout policy is the default policy for blue-green. */
  standardRolloutPolicy?: V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings_StandardRolloutPolicy | Computed<V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings_StandardRolloutPolicy>;
}

export interface V1beta1NodePool_NodePool_UpgradeSettings {
  /** Settings for blue-green upgrade. */
  blueGreenSettings?: V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings | Computed<V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings>;
...
export interface V1beta1NodePool_NodePool {
  /** AutopilotConfig contains configuration of autopilot feature for this node pool. */
  autopilotConfig?: V1beta1NodePool_AutopilotConfig | Computed<V1beta1NodePool_AutopilotConfig>;
  /** NodePoolAutoscaling contains information required by cluster autoscaler to adjust the size of the node pool to the current cluster usage. */
  autoscaling?: V1beta1NodePool_Autoscaling | Computed<V1beta1NodePool_Autoscaling>;
  /** Best effort provisioning. */
  bestEffortProvisioning?: V1beta1NodePool_BestEffortProvisioning | Computed<V1beta1NodePool_BestEffortProvisioning>;
  /** Which conditions caused the current node pool state. */
  conditions?: V1beta1NodePool_Conditions[] | Computed<V1beta1NodePool_Conditions[]>;
  /** Parameters that describe the nodes in a cluster. GKE Autopilot clusters do not recognize parameters in `NodeConfig`. Use AutoprovisioningNodePoolDefaults instead. */
  config?: V1beta1NodePool_Config | Computed<V1beta1NodePool_Config>;
  ...
  kubeletCertInfo?: V1beta1NodePool_KubeletCertInfo | Computed<V1beta1NodePool_KubeletCertInfo>;
  ...
  maintenancePolicy?: V1beta1NodePool_MaintenancePolicy | Computed<V1beta1NodePool_MaintenancePolicy>;
  /** NodeManagement defines the set of node management services turned on for the node pool. */
  management?: V1beta1NodePool_Management | Computed<V1beta1NodePool_Management>;
  /** Constraints applied to pods. */
  maxPodsConstraint?: V1beta1NodePool_MaxPodsConstraint | Computed<V1beta1NodePool_MaxPodsConstraint>;
  /** The name of the node pool. */
  name?: string | Computed<string>;
  /** Parameters for node pool-level network config. */
  networkConfig?: V1beta1NodePool_NetworkConfig | Computed<V1beta1NodePool_NetworkConfig>;
  /** NodeDrainConfig contains the node drain related configurations for this node pool. */
  nodeDrainConfig?: V1beta1NodePool_NodeDrainConfig | Computed<V1beta1NodePool_NodeDrainConfig>;
  /** PlacementPolicy defines the placement policy used by the node pool. */
  placementPolicy?: V1beta1NodePool_NodePool_PlacementPolicy | Computed<V1beta1NodePool_NodePool_PlacementPolicy>;
  /** Output only. The pod CIDR block size per node in this node pool. */
  podIpv4CidrSize?: number | Computed<number>;
  /** QueuedProvisioning defines the queued provisioning used by the node pool. */
  queuedProvisioning?: V1beta1NodePool_AutopilotConfig | Computed<V1beta1NodePool_AutopilotConfig>;
  ...
  updateInfo?: V1beta1NodePool_NodePool_UpdateInfo | Computed<V1beta1NodePool_NodePool_UpdateInfo>;
  ...
  upgradeSettings?: V1beta1NodePool_NodePool_UpgradeSettings | Computed<V1beta1NodePool_NodePool_UpgradeSettings>;
  /** The version of Kubernetes running on this NodePool's nodes. If unspecified, it defaults as described [here](https://cloud.google.com/kubernetes-engine/versioning#specifying_node_version). */
  version?: string | Computed<string>;
}

const V1beta1NodePool_AutopilotConfigFields: FieldMap = {
  enabled: "enabled",
};

const V1beta1NodePool_AutoscalingFields: FieldMap = {
...
const V1beta1NodePool_BestEffortProvisioningFields: FieldMap = {
  enabled: "enabled",
  minProvisionNodes: "min_provision_nodes",
};

const V1beta1NodePool_ConditionsFields: FieldMap = {
  canonicalCode: "canonical_code",
  code: "code",
  message: "message",
};

const V1beta1NodePool_Config_Accelerators_GpuDriverInstallationConfigFields: FieldMap = {
  gpuDriverVersion: "gpu_driver_version",
};

const V1beta1NodePool_Config_Accelerators_GpuSharingConfigFields: FieldMap = {
  gpuSharingStrategy: "gpu_sharing_strategy",
  maxSharedClientsPerGpu: "max_shared_clients_per_gpu",
};

const V1beta1NodePool_Config_AcceleratorsFields: FieldMap = {
...
const V1beta1NodePool_Config_AdvancedMachineFeaturesFields: FieldMap = {
  enableNestedVirtualization: "enable_nested_virtualization",
  performanceMonitoringUnit: "performance_monitoring_unit",
  threadsPerCore: "threads_per_core",
};

const V1beta1NodePool_Config_BootDiskFields: FieldMap = {
  diskType: "disk_type",
...
const V1beta1NodePool_Config_ConfidentialNodesFields: FieldMap = {
  confidentialInstanceType: "confidential_instance_type",
  enabled: "enabled",
};

const V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfig_GcpSecretManagerCertificateConfigFields: FieldMap = {
  secretUri: "secret_uri",
};

const V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfig_CertificateAuthorityDomainConfigFields: FieldMap = {
  fqdns: "fqdns",
...
const V1beta1NodePool_Config_ContainerdConfig_PrivateRegistryAccessConfigFields: FieldMap = {
...
const V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_CaFields: FieldMap = {
  gcpSecretManagerSecretUri: "gcp_secret_manager_secret_uri",
};

const V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_ClientFields: FieldMap = {
  cert: {
    wireName: "cert",
    kind: "object",
...
const V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_HeaderFields: FieldMap = {
  key: "key",
  value: "value",
};

const V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_HostsFields: FieldMap = {
  ca: {
    wireName: "ca",
    kind: "list",
    fields: V1beta1NodePool_Config_ContainerdConfig_RegistryHosts_Hosts_CaFields,
...
const V1beta1NodePool_Config_ContainerdConfig_RegistryHostsFields: FieldMap = {
  hosts: {
    wireName: "hosts",
    kind: "list",
...
const V1beta1NodePool_Config_ContainerdConfigFields: FieldMap = {
...
const V1beta1NodePool_Config_EphemeralStorageConfigFields: FieldMap = {
  localSsdCount: "local_ssd_count",
};

const V1beta1NodePool_Config_EphemeralStorageLocalSsdConfigFields: FieldMap = {
  dataCacheCount: "data_cache_count",
  localSsdCount: "local_ssd_count",
};

const V1beta1NodePool_Config_GpuDirectConfigFields: FieldMap = {
  gpuDirectStrategy: "gpu_direct_strategy",
};

const V1beta1NodePool_Config_HostMaintenancePolicy_OpportunisticMaintenanceStrategyFields: FieldMap = {
...
const V1beta1NodePool_Config_HostMaintenancePolicyFields: FieldMap = {
...
const V1beta1NodePool_Config_KubeletConfig_CrashLoopBackOffFields: FieldMap = {
  maxContainerRestartPeriod: "max_container_restart_period",
};

const V1beta1NodePool_Config_KubeletConfig_EvictionMinimumReclaimFields: FieldMap = {
...
const V1beta1NodePool_Config_KubeletConfig_MemoryManagerFields: FieldMap = {
  policy: "policy",
};

const V1beta1NodePool_Config_KubeletConfig_TopologyManagerFields: FieldMap = {
  policy: "policy",
  scope: "scope",
};

const V1beta1NodePool_Config_KubeletConfigFields: FieldMap = {
...
const V1beta1NodePool_Config_LinuxNodeConfig_AccurateTimeConfigFields: FieldMap = {
  enablePtpKvmTimeSync: "enable_ptp_kvm_time_sync",
};

const V1beta1NodePool_Config_LinuxNodeConfig_CustomNodeInit_InitScriptFields: FieldMap = {
  args: "args",
  gcpSecretManagerSecretUri: "gcp_secret_manager_secret_uri",
...
const V1beta1NodePool_Config_LinuxNodeConfig_CustomNodeInitFields: FieldMap = {
  initScript: {
...
const V1beta1NodePool_Config_LinuxNodeConfig_DiskIoSchedulerFields: FieldMap = {
  nodeAttachedDiskIoScheduler: "node_attached_disk_io_scheduler",
  nodeSystemIoScheduler: "node_system_io_scheduler",
};

const V1beta1NodePool_Config_LinuxNodeConfig_HugepagesFields: FieldMap = {
  hugepageSize1g: "hugepage_size1g",
  hugepageSize2m: "hugepage_size2m",
};

const V1beta1NodePool_Config_LinuxNodeConfig_NodeVfioConfigFields: FieldMap = {
  dmaEntryLimit: "dma_entry_limit",
};

const V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_BootDiskProfileFields: FieldMap = {
  swapSizeGib: "swap_size_gib",
  swapSizePercent: "swap_size_percent",
};

const V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_DedicatedLocalSsdProfileFields: FieldMap = {
  diskCount: "disk_count",
};

const V1beta1NodePool_Config_LinuxNodeConfig_SwapConfig_EncryptionConfigFields: FieldMap = {
  disabled: "disabled",
};

const V1beta1NodePool_Config_LinuxNodeConfig_SwapConfigFields: FieldMap = {
  bootDiskProfile: {
...
const V1beta1NodePool_Config_LinuxNodeConfigFields: FieldMap = {
  accurateTimeConfig: {
...
const V1beta1NodePool_Config_LoggingConfig_VariantConfigFields: FieldMap = {
  variant: "variant",
};

const V1beta1NodePool_Config_LoggingConfigFields: FieldMap = {
  variantConfig: {
...
const V1beta1NodePool_Config_NodeImageConfigFields: FieldMap = {
  image: "image",
  imageProject: "image_project",
};

const V1beta1NodePool_Config_ReservationAffinityFields: FieldMap = {
  consumeReservationType: "consume_reservation_type",
  key: "key",
  values: "values",
};

const V1beta1NodePool_Config_ResourceManagerTagsFields: FieldMap = {
  tags: "tags",
};

const V1beta1NodePool_Config_SandboxConfigFields: FieldMap = {
  sandboxType: "sandbox_type",
  type: "type",
};

const V1beta1NodePool_Config_SecondaryBootDisksFields: FieldMap = {
  diskImage: "disk_image",
  mode: "mode",
};

const V1beta1NodePool_Config_ShieldedInstanceConfigFields: FieldMap = {
  enableIntegrityMonitoring: "enable_integrity_monitoring",
  enableSecureBoot: "enable_secure_boot",
};

const V1beta1NodePool_Config_SoleTenantConfig_NodeAffinitiesFields: FieldMap = {
  key: "key",
  operator: "operator",
  values: "values",
};

const V1beta1NodePool_Config_SoleTenantConfigFields: FieldMap = {
...
const V1beta1NodePool_Config_TaintConfigFields: FieldMap = {
  architectureTaintBehavior: "architecture_taint_behavior",
};

const V1beta1NodePool_Config_TaintsFields: FieldMap = {
  effect: "effect",
  key: "key",
  value: "value",
};

const V1beta1NodePool_Config_WindowsNodeConfigFields: FieldMap = {
  osVersion: "os_version",
};

const V1beta1NodePool_Config_WorkloadMetadataConfigFields: FieldMap = {
  mode: "mode",
  nodeMetadata: "node_metadata",
};

const V1beta1NodePool_ConfigFields: FieldMap = {
  accelerators: {
...
const V1beta1NodePool_KubeletCertInfoFields: FieldMap = {
...
const V1beta1NodePool_MaintenancePolicy_ExclusionUntilEndOfSupportFields: FieldMap = {
  enabled: "enabled",
  endTime: "end_time",
  startTime: "start_time",
};

const V1beta1NodePool_MaintenancePolicyFields: FieldMap = {
...
const V1beta1NodePool_Management_UpgradeOptionsFields: FieldMap = {
  autoUpgradeStartTime: "auto_upgrade_start_time",
  description: "description",
};

const V1beta1NodePool_ManagementFields: FieldMap = {
...
const V1beta1NodePool_MaxPodsConstraintFields: FieldMap = {
  maxPodsPerNode: "max_pods_per_node",
};

const V1beta1NodePool_NetworkConfig_AdditionalNodeNetworkConfigsFields: FieldMap = {
  network: "network",
  subnetwork: "subnetwork",
};

const V1beta1NodePool_NetworkConfig_AdditionalPodNetworkConfigsFields: FieldMap = {
  maxPodsPerNode: {
...
const V1beta1NodePool_NetworkConfig_NetworkPerformanceConfigFields: FieldMap = {
  externalIpEgressBandwidthTier: "external_ip_egress_bandwidth_tier",
  totalEgressBandwidthTier: "total_egress_bandwidth_tier",
};

const V1beta1NodePool_NetworkConfig_NetworkTierConfigFields: FieldMap = {
  networkTier: "network_tier",
};

const V1beta1NodePool_NetworkConfig_PodCidrOverprovisionConfigFields: FieldMap = {
  disable: "disable",
};

const V1beta1NodePool_NetworkConfigFields: FieldMap = {
...
const V1beta1NodePool_NodeDrainConfigFields: FieldMap = {
...
const V1beta1NodePool_NodePool_PlacementPolicyFields: FieldMap = {
  policyName: "policy_name",
  tpuTopology: "tpu_topology",
  type: "type",
};

const V1beta1NodePool_NodePool_UpdateInfo_BlueGreenInfoFields: FieldMap = {
...
const V1beta1NodePool_NodePool_UpdateInfoFields: FieldMap = {
  blueGreenInfo: {
...
const V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings_AutoscaledRolloutPolicyFields: FieldMap = {
  waitForDrainDuration: "wait_for_drain_duration",
};

const V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettings_StandardRolloutPolicyFields: FieldMap = {
  batchNodeCount: "batch_node_count",
  batchPercentage: "batch_percentage",
  batchSoakDuration: "batch_soak_duration",
};

const V1beta1NodePool_NodePool_UpgradeSettings_BlueGreenSettingsFields: FieldMap = {
...
const V1beta1NodePool_NodePool_UpgradeSettingsFields: FieldMap = {
  blueGreenSettings: {
...
const V1beta1NodePool_NodePoolFields: FieldMap = {
  autopilotConfig: {
...
export interface V1beta1NodePoolConfig {
  ...
  nodePool?: V1beta1NodePool_NodePool | Computed<V1beta1NodePool_NodePool>;
...
export interface V1beta1NodePoolAttrs {
  /** AutopilotConfig contains configuration of autopilot feature for this node pool. */
  autopilotConfig: V1beta1NodePool_AutopilotConfig;
  /** NodePoolAutoscaling contains information required by cluster autoscaler to adjust the size of the node pool to the current cluster usage. */
  autoscaling: V1beta1NodePool_Autoscaling;
  /** Best effort provisioning. */
  bestEffortProvisioning: V1beta1NodePool_BestEffortProvisioning;
  /** Deprecated. The name of the cluster. This field has been deprecated and replaced by the parent field. */
  clusterId: string;
  /** Which conditions caused the current node pool state. */
  conditions: V1beta1NodePool_Conditions[];
  /** Parameters that describe the nodes in a cluster. GKE Autopilot clusters do not recognize parameters in `NodeConfig`. Use AutoprovisioningNodePoolDefaults instead. */
  config: V1beta1NodePool_Config;
  /** This checksum is computed by the server based on the value of node pool fields, and may be sent on update requests to ensure the client has an up-to-date value before proceeding. */
  etag: string;
  /** The initial node count for the pool. You must ensure that your Compute Engine [resource quota](https://cloud.google.com/compute/quotas) is sufficient for this number of instances. You must also have available firewall and routes quota. */
  ...
  /** Contains expiry information about the kubelet certificate. */
  kubeletCertInfo: V1beta1NodePool_KubeletCertInfo;
  /** The list of Google Compute Engine [zones](https://cloud.google.com/compute/docs/zones#available) in which the NodePool's nodes should be located. If this value is unspecified during node pool creation, the [Cluster.Locations](https://cloud.google.com/kubernetes-engine/docs/reference/rest/v1/projects.locations.clusters#Cluster.FIELDS.locations) value will be used, instead. Warning: changing node pool locations will result in nodes being added and/or removed. */
  locations: string[];
  /** Defines the maintenance policy for the node pool. */
  maintenancePolicy: V1beta1NodePool_MaintenancePolicy;
  /** NodeManagement defines the set of node management services turned on for the node pool. */
  management: V1beta1NodePool_Management;
  /** Constraints applied to pods. */
  maxPodsConstraint: V1beta1NodePool_MaxPodsConstraint;
  /** The name of the node pool. */
  name: string;
  /** Parameters for node pool-level network config. */
  networkConfig: V1beta1NodePool_NetworkConfig;
  /** NodeDrainConfig contains the node drain related configurations for this node pool. */
  nodeDrainConfig: V1beta1NodePool_NodeDrainConfig;
  /** NodePool contains the name and configuration for a cluster's node pool. Node pools are a set of nodes (i.e. VM's), with a common configuration and specification, under the control of the cluster master. They may have a set of Kubernetes labels applied to them, which may be used to reference them during pod scheduling. They may also be resized up or down, to accommodate the workload. */
  nodePool: V1beta1NodePool_NodePool;
  /** The parent (project, location, cluster name) where the node pool will be created. Specified in the format `projects/* /locations/* /clusters/*`. */
  parent: string;
  /** PlacementPolicy defines the placement policy used by the node pool. */
  placementPolicy: V1beta1NodePool_NodePool_PlacementPolicy;
  /** Output only. The pod CIDR block size per node in this node pool. */
  podIpv4CidrSize: number;
  /** Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the parent field. */
  projectId: string;
  /** QueuedProvisioning defines the queued provisioning used by the node pool. */
  queuedProvisioning: V1beta1NodePool_AutopilotConfig;
  /** Output only. Server-defined URL for the resource. */
  selfLink: string;
  /** Output only. The status of the nodes in this pool instance. */
  status: string;
  ...
  /** UpdateInfo contains resource (instance groups, etc), status and other intermediate information relevant to a node pool upgrade. */
  updateInfo: V1beta1NodePool_NodePool_UpdateInfo;
  /** These upgrade settings control the level of parallelism and the level of disruption caused by an upgrade. maxUnavailable controls the number of nodes that can be simultaneously unavailable. maxSurge controls the number of additional nodes that can be added to the node pool temporarily for the time of the upgrade to increase the number of available nodes. (maxUnavailable + maxSurge) determines the level of parallelism (how many nodes are being upgraded at the same time). Note: upgrades inevitably introduce some disruption since workloads need to be moved from old nodes to new, upgraded ones. Even if maxUnavailable=0, this holds true. (Disruption stays within the limits of PodDisruptionBudget, if it is configured.) Consider a hypothetical node pool with 5 nodes having maxSurge=2, maxUnavailable=1. This means the upgrade process upgrades 3 nodes simultaneously. It creates 2 additional (upgraded) nodes, then it brings down 3 old (not yet upgraded) nodes at the same time. This ensures that there are always at least 4 nodes available. These upgrade settings configure the upgrade strategy for the node pool. Use strategy to switch between the strategies applied to the node pool. If the strategy is SURGE, use max_surge and max_unavailable to control the level of parallelism and the level of disruption caused by upgrade. 1. maxSurge controls the number of additional nodes that can be added to the node pool temporarily for the time of the upgrade to increase the number of available nodes. 2. maxUnavailable controls the number of nodes that can be simultaneously unavailable. 3. (maxUnavailable + maxSurge) determines the level of parallelism (how many nodes are being upgraded at the same time). If the strategy is BLUE_GREEN, use blue_green_settings to configure the blue-green upgrade related settings. 1. standard_rollout_policy is the default policy. The policy is used to control the way blue pool gets drained. The draining is executed in the batch mode. The batch size could be specified as either percentage of the node pool size or the number of nodes. batch_soak_duration is the soak time after each batch gets drained. 2. node_pool_soak_duration is the soak time after all blue nodes are drained. After this period, the blue pool nodes will be deleted. */
  upgradeSettings: V1beta1NodePool_NodePool_UpgradeSettings;
  /** The version of Kubernetes running on this NodePool's nodes. If unspecified, it defaults as described [here](https://cloud.google.com/kubernetes-engine/versioning#specifying_node_version). */
  version: string;
  /** Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the parent field. */
  zone: string;
...
export const V1beta1NodePool: ResourceBinding<V1beta1NodePoolConfig, V1beta1NodePoolAttrs> = {
  wireType: "google_container_v1beta1_node_pool",
  fields: {
