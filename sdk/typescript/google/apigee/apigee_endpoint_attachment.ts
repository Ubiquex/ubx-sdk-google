// Code generated by `ubx sdk gen` from google_apigee_apigee_endpoint_attachment. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface ApigeeEndpointAttachmentConfig {
...
export interface ApigeeEndpointAttachmentAttrs {
  /** Output only. State of the endpoint attachment connection to the service attachment. */
...
export const ApigeeEndpointAttachment: ResourceBinding<ApigeeEndpointAttachmentConfig, ApigeeEndpointAttachmentAttrs> = {
  wireType: "google_apigee_apigee_endpoint_attachment",
  fields: {
