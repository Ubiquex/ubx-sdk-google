...
export interface ApigeeQuery_Metrics {
...
export interface ApigeeQuery_QueryParams {
...
export interface ApigeeQuery_Result {
...
const ApigeeQuery_MetricsFields: FieldMap = {
  alias: "alias",
  function: "function",
  name: "name",
  operator: "operator",
...
export interface ApigeeQueryConfig {
  ...
  /** A list of Metrics. */
  metrics?: ApigeeQuery_Metrics[] | Computed<ApigeeQuery_Metrics[]>;
...
export interface ApigeeQueryAttrs {
  ...
  limit: number;
  /** A list of Metrics. */
  metrics: ApigeeQuery_Metrics[];
  /** Asynchronous Query Name. */
  name: string;
  /** Valid values include: `csv` or `json`. Defaults to `json`. Note: Configure the delimiter for CSV output using the csvDelimiter property. */
  outputFormat: string;
  queryParams: ApigeeQuery_QueryParams;
  /** Asynchronous Report ID. */
  reportDefinitionId: string;
  result: ApigeeQuery_Result;
...
export const ApigeeQuery: ResourceBinding<ApigeeQueryConfig, ApigeeQueryAttrs> = {
