// Code generated by `ubx sdk gen` from google_apigee_apigee_apim_service_extension. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface ApigeeApimServiceExtension_Extensions {
...
export interface ApigeeApimServiceExtension_NetworkConfigs {
  region?: string | Computed<string>;
  subnet?: string | Computed<string>;
}

const ApigeeApimServiceExtension_ExtensionsFields: FieldMap = {
  failOpen: "fail_open",
  hostname: "hostname",
...
const ApigeeApimServiceExtension_NetworkConfigsFields: FieldMap = {
  region: "region",
  subnet: "subnet",
};

export interface ApigeeApimServiceExtensionConfig {
  ...
  extensions?: ApigeeApimServiceExtension_Extensions[] | Computed<ApigeeApimServiceExtension_Extensions[]>;
  ...
  networkConfigs?: ApigeeApimServiceExtension_NetworkConfigs[] | Computed<ApigeeApimServiceExtension_NetworkConfigs[]>;
...
export interface ApigeeApimServiceExtensionAttrs {
  /** Output only. The time that this resource was created on the server. */
  createTime: string;
  /** Required. Name of the proxy deployed in the Apigee X instance. */
  extensionProcessor: string;
  /** Optional. List of extensions that are part of the service extension. Refer to https://cloud.google.com/service-extensions/docs/quotas#limits for any limits. */
  extensions: ApigeeApimServiceExtension_Extensions[];
  /** Required. Name of the Google Cloud LB forwarding rule. Format: projects/{project}/regions/{region}/forwardingRules/{forwarding_rule} projects/{project}/global/forwardingRules/{forwarding_rule} */
  ...
  network: string;
  /** Required. List of network configurations for the APIM service extension. */
  networkConfigs: ApigeeApimServiceExtension_NetworkConfigs[];
  /** Output only. State of the APIM service extension. Values other than `ACTIVE` mean the resource is not ready to use. */
  state: string;
  /** Output only. The time that this resource was updated on the server. */
  updateTime: string;
...
export const ApigeeApimServiceExtension: ResourceBinding<ApigeeApimServiceExtensionConfig, ApigeeApimServiceExtensionAttrs> = {
  wireType: "google_apigee_apigee_apim_service_extension",
  fields: {
    ...
    extensions: {
      wireName: "extensions",
      kind: "list",
      fields: ApigeeApimServiceExtension_ExtensionsFields,
    },
    ...
    networkConfigs: {
      ...
      kind: "list",
      fields: ApigeeApimServiceExtension_NetworkConfigsFields,
    },
    state: "state",
