...
export interface ApigeeSecurityReport_Metrics {
...
export interface ApigeeSecurityReport_QueryParams {
...
export interface ApigeeSecurityReport_Result {
...
const ApigeeSecurityReport_MetricsFields: FieldMap = {
...
export interface ApigeeSecurityReportConfig {
  ...
  /** A list of Metrics. */
  metrics?: ApigeeSecurityReport_Metrics[] | Computed<ApigeeSecurityReport_Metrics[]>;
...
export interface ApigeeSecurityReportAttrs {
  ...
  limit: number;
  /** A list of Metrics. */
  metrics: ApigeeSecurityReport_Metrics[];
  /** Valid values include: `csv` or `json`. Defaults to `json`. Note: Configure the delimiter for CSV output using the csvDelimiter property. */
  mimeType: string;
  /** Metadata for the security report. */
  queryParams: ApigeeSecurityReport_QueryParams;
  /** Report Definition ID. */
  reportDefinitionId: string;
  /** Contains informations about the security report results. */
  result: ApigeeSecurityReport_Result;
...
export const ApigeeSecurityReport: ResourceBinding<ApigeeSecurityReportConfig, ApigeeSecurityReportAttrs> = {
  wireType: "google_apigee_apigee_security_report",
  fields: {
    ...
    metrics: {
      wireName: "metrics",
      kind: "list",
      fields: ApigeeSecurityReport_MetricsFields,
    },
    mimeType: "mime_type",
