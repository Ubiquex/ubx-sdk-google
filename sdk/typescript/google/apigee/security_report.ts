// Code generated by `ubx sdk gen` from google_apigee_security_report. DO NOT EDIT.
...
export interface SecurityReport_QueryParams {
...
export interface SecurityReport_Result {
...
const SecurityReport_MetricsFields: FieldMap = {
...
export interface SecurityReportConfig {
  ...
  /** A list of Metrics. */
  metrics?: SecurityReport_Metrics[] | Computed<SecurityReport_Metrics[]>;
...
export interface SecurityReportAttrs {
  ...
  limit: number;
  /** A list of Metrics. */
  metrics: SecurityReport_Metrics[];
  /** Valid values include: `csv` or `json`. Defaults to `json`. Note: Configure the delimiter for CSV output using the csvDelimiter property. */
  mimeType: string;
  /** Metadata for the security report. */
  queryParams: SecurityReport_QueryParams;
  /** Report Definition ID. */
  reportDefinitionId: string;
  /** Contains informations about the security report results. */
  result: SecurityReport_Result;
...
export const SecurityReport: ResourceBinding<SecurityReportConfig, SecurityReportAttrs> = {
