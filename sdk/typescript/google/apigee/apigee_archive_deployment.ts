...
export interface ApigeeArchiveDeploymentConfig {
...
export interface ApigeeArchiveDeploymentAttrs {
  /** Output only. The time at which the Archive Deployment was created in milliseconds since the epoch. */
  createdAt: string;
  /** Input only. The Google Cloud Storage signed URL returned from GenerateUploadUrl and used to upload the Archive zip file. */
  gcsUri: string;
...
export const ApigeeArchiveDeployment: ResourceBinding<ApigeeArchiveDeploymentConfig, ApigeeArchiveDeploymentAttrs> = {
  wireType: "google_apigee_apigee_archive_deployment",
  fields: {
