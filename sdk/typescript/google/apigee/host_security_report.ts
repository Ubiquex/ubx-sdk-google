...
export interface HostSecurityReport_Metrics {
...
export interface HostSecurityReport_QueryParams {
...
export interface HostSecurityReport_Result {
...
const HostSecurityReport_MetricsFields: FieldMap = {
...
export interface HostSecurityReportConfig {
  ...
  /** A list of Metrics. */
  metrics?: HostSecurityReport_Metrics[] | Computed<HostSecurityReport_Metrics[]>;
...
export interface HostSecurityReportAttrs {
  ...
  limit: number;
  /** A list of Metrics. */
  metrics: HostSecurityReport_Metrics[];
  /** Valid values include: `csv` or `json`. Defaults to `json`. Note: Configure the delimiter for CSV output using the csvDelimiter property. */
  mimeType: string;
  /** Metadata for the security report. */
  queryParams: HostSecurityReport_QueryParams;
  /** Report Definition ID. */
  reportDefinitionId: string;
  /** Contains informations about the security report results. */
  result: HostSecurityReport_Result;
...
export const HostSecurityReport: ResourceBinding<HostSecurityReportConfig, HostSecurityReportAttrs> = {
