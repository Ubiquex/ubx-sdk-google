// Code generated by `ubx sdk gen` from google_apigee_apigee_host_query. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface ApigeeHostQuery_Metrics {
...
export interface ApigeeHostQuery_QueryParams {
...
export interface ApigeeHostQuery_Result {
...
const ApigeeHostQuery_MetricsFields: FieldMap = {
  alias: "alias",
  function: "function",
  name: "name",
  operator: "operator",
...
export interface ApigeeHostQueryConfig {
  ...
  /** A list of Metrics. */
  metrics?: ApigeeHostQuery_Metrics[] | Computed<ApigeeHostQuery_Metrics[]>;
...
export interface ApigeeHostQueryAttrs {
  ...
  limit: number;
  /** A list of Metrics. */
  metrics: ApigeeHostQuery_Metrics[];
  /** Asynchronous Query Name. */
  name: string;
  /** Valid values include: `csv` or `json`. Defaults to `json`. Note: Configure the delimiter for CSV output using the csvDelimiter property. */
  outputFormat: string;
  queryParams: ApigeeHostQuery_QueryParams;
  /** Asynchronous Report ID. */
  reportDefinitionId: string;
  result: ApigeeHostQuery_Result;
...
export const ApigeeHostQuery: ResourceBinding<ApigeeHostQueryConfig, ApigeeHostQueryAttrs> = {
  wireType: "google_apigee_apigee_host_query",
  fields: {
    ...
    metrics: {
      wireName: "metrics",
      kind: "list",
      fields: ApigeeHostQuery_MetricsFields,
    },
    name: "name",
