// Code generated by `ubx sdk gen` from google_gkehub_v1beta1_membership. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1Membership_Authority {
...
export interface V1beta1Membership_Endpoint_ApplianceCluster {
...
export interface V1beta1Membership_Endpoint_GkeCluster {
...
export interface V1beta1Membership_Endpoint_KubernetesMetadata {
...
export interface V1beta1Membership_Endpoint_KubernetesResource_ConnectResources {
  clusterScoped?: boolean | Computed<boolean>;
  manifest?: string | Computed<string>;
}

export interface V1beta1Membership_Endpoint_KubernetesResource_ResourceOptions {
...
export interface V1beta1Membership_Endpoint_KubernetesResource {
  /** Output only. The Kubernetes resources for installing the GKE Connect agent This field is only populated in the Membership returned from a successful long-running operation from CreateMembership or UpdateMembership. It is not populated during normal GetMembership or ListMemberships requests. To get the resource manifest after the initial registration, the caller should make a UpdateMembership call with an empty field mask. */
  connectResources?: V1beta1Membership_Endpoint_KubernetesResource_ConnectResources[] | Computed<V1beta1Membership_Endpoint_KubernetesResource_ConnectResources[]>;
  ...
  membershipResources?: V1beta1Membership_Endpoint_KubernetesResource_ConnectResources[] | Computed<V1beta1Membership_Endpoint_KubernetesResource_ConnectResources[]>;
  /** ResourceOptions represent options for Kubernetes resource generation. */
  resourceOptions?: V1beta1Membership_Endpoint_KubernetesResource_ResourceOptions | Computed<V1beta1Membership_Endpoint_KubernetesResource_ResourceOptions>;
}

export interface V1beta1Membership_Endpoint_OnPremCluster {
...
export interface V1beta1Membership_Endpoint {
  /** ApplianceCluster contains information specific to GDC Edge Appliance Clusters. */
  applianceCluster?: V1beta1Membership_Endpoint_ApplianceCluster | Computed<V1beta1Membership_Endpoint_ApplianceCluster>;
  /** EdgeCluster contains information specific to Google Edge Clusters. */
  edgeCluster?: V1beta1Membership_Endpoint_ApplianceCluster | Computed<V1beta1Membership_Endpoint_ApplianceCluster>;
  /** GkeCluster contains information specific to GKE clusters. */
  gkeCluster?: V1beta1Membership_Endpoint_GkeCluster | Computed<V1beta1Membership_Endpoint_GkeCluster>;
  /** KubernetesMetadata provides informational metadata for Memberships representing Kubernetes clusters. */
  kubernetesMetadata?: V1beta1Membership_Endpoint_KubernetesMetadata | Computed<V1beta1Membership_Endpoint_KubernetesMetadata>;
  /** KubernetesResource contains the YAML manifests and configuration for Membership Kubernetes resources in the cluster. After CreateMembership or UpdateMembership, these resources should be re-applied in the cluster. */
  kubernetesResource?: V1beta1Membership_Endpoint_KubernetesResource | Computed<V1beta1Membership_Endpoint_KubernetesResource>;
  /** MultiCloudCluster contains information specific to GKE Multi-Cloud clusters. */
  multiCloudCluster?: V1beta1Membership_Endpoint_GkeCluster | Computed<V1beta1Membership_Endpoint_GkeCluster>;
  /** OnPremCluster contains information specific to GKE On-Prem clusters. */
  onPremCluster?: V1beta1Membership_Endpoint_OnPremCluster | Computed<V1beta1Membership_Endpoint_OnPremCluster>;
}

export interface V1beta1Membership_MonitoringConfig {
...
export interface V1beta1Membership_State {
...
const V1beta1Membership_AuthorityFields: FieldMap = {
...
const V1beta1Membership_Endpoint_ApplianceClusterFields: FieldMap = {
  resourceLink: "resource_link",
};

const V1beta1Membership_Endpoint_GkeClusterFields: FieldMap = {
  clusterMissing: "cluster_missing",
  resourceLink: "resource_link",
};

const V1beta1Membership_Endpoint_KubernetesMetadataFields: FieldMap = {
...
const V1beta1Membership_Endpoint_KubernetesResource_ConnectResourcesFields: FieldMap = {
  clusterScoped: "cluster_scoped",
  manifest: "manifest",
};

const V1beta1Membership_Endpoint_KubernetesResource_ResourceOptionsFields: FieldMap = {
...
const V1beta1Membership_Endpoint_KubernetesResourceFields: FieldMap = {
  connectResources: {
    wireName: "connect_resources",
    kind: "list",
    fields: V1beta1Membership_Endpoint_KubernetesResource_ConnectResourcesFields,
  },
  ...
  resourceOptions: {
    ...
    kind: "object",
    fields: V1beta1Membership_Endpoint_KubernetesResource_ResourceOptionsFields,
  },
};

const V1beta1Membership_Endpoint_OnPremClusterFields: FieldMap = {
...
const V1beta1Membership_EndpointFields: FieldMap = {
  applianceCluster: {
    wireName: "appliance_cluster",
    kind: "object",
    fields: V1beta1Membership_Endpoint_ApplianceClusterFields,
  },
  edgeCluster: {
  ...
  gkeCluster: {
    ...
    kind: "object",
    fields: V1beta1Membership_Endpoint_GkeClusterFields,
  },
  kubernetesMetadata: {
    wireName: "kubernetes_metadata",
    kind: "object",
    fields: V1beta1Membership_Endpoint_KubernetesMetadataFields,
  },
  kubernetesResource: {
    wireName: "kubernetes_resource",
    kind: "object",
    fields: V1beta1Membership_Endpoint_KubernetesResourceFields,
  },
  multiCloudCluster: {
  ...
  onPremCluster: {
    ...
    kind: "object",
    fields: V1beta1Membership_Endpoint_OnPremClusterFields,
  },
};

const V1beta1Membership_MonitoringConfigFields: FieldMap = {
  cluster: "cluster",
...
const V1beta1Membership_StateFields: FieldMap = {
  code: "code",
...
export interface V1beta1MembershipConfig {
  ...
  endpoint?: V1beta1Membership_Endpoint | Computed<V1beta1Membership_Endpoint>;
...
export interface V1beta1MembershipAttrs {
  /** Authority encodes how Google will recognize identities from this Membership. See the workload identity documentation for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity */
  authority: V1beta1Membership_Authority;
  ...
  description: string;
  /** MembershipEndpoint contains information needed to contact a Kubernetes API, endpoint and any additional Kubernetes metadata. */
  endpoint: V1beta1Membership_Endpoint;
  /** Optional. An externally-generated and managed ID for this Membership. This ID may be modified after creation, but this is not recommended. For GKE clusters, external_id is managed by the Hub API and updates will be ignored. The ID must match the regex: `a-zA-Z0-9*` If this Membership represents a Kubernetes cluster, this value should be set to the UID of the `kube-system` namespace object. */
  externalId: string;
  /** Optional. The infrastructure type this Membership is running on. */
...
export const V1beta1Membership: ResourceBinding<V1beta1MembershipConfig, V1beta1MembershipAttrs> = {
  wireType: "google_gkehub_v1beta1_membership",
  fields: {
    authority: {
      wireName: "authority",
      kind: "object",
    ...
    endpoint: {
      wireName: "endpoint",
      kind: "object",
      fields: V1beta1Membership_EndpointFields,
    },
