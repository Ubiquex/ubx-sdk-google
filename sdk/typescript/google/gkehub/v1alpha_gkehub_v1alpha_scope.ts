// Code generated by `ubx sdk gen` from google_gkehub_v1alpha_gkehub_v1alpha_scope. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1alphaGkehubV1alphaScope_State {
  /** Output only. The current state of the scope resource. */
  code?: string | Computed<string>;
}

const V1alphaGkehubV1alphaScope_StateFields: FieldMap = {
  code: "code",
};

export interface V1alphaGkehubV1alphaScopeConfig {
  ...
  state?: V1alphaGkehubV1alphaScope_State | Computed<V1alphaGkehubV1alphaScope_State>;
...
export interface V1alphaGkehubV1alphaScopeAttrs {
  /** Output only. When the scope was created. */
  createTime: string;
  /** Output only. When the scope was deleted. */
  deleteTime: string;
  ...
  /** ScopeLifecycleState describes the state of a Scope resource. */
  state: V1alphaGkehubV1alphaScope_State;
  /** Output only. Google-generated UUID for this resource. This is unique across all scope resources. If a scope resource is deleted and another resource with the same name is created, it gets a different uid. */
  uid: string;
  /** Output only. When the scope was last updated. */
  updateTime: string;
...
export const V1alphaGkehubV1alphaScope: ResourceBinding<V1alphaGkehubV1alphaScopeConfig, V1alphaGkehubV1alphaScopeAttrs> = {
  wireType: "google_gkehub_v1alpha_gkehub_v1alpha_scope",
  fields: {
    ...
    state: {
      wireName: "state",
      kind: "object",
      fields: V1alphaGkehubV1alphaScope_StateFields,
    },
    uid: "uid",
