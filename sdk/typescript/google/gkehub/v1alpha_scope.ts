...
export interface V1alphaScope_State {
  /** Output only. The current state of the scope resource. */
  code?: string | Computed<string>;
}

const V1alphaScope_StateFields: FieldMap = {
  code: "code",
};

export interface V1alphaScopeConfig {
  ...
  state?: V1alphaScope_State | Computed<V1alphaScope_State>;
...
export interface V1alphaScopeAttrs {
  /** Output only. When the scope was created. */
  createTime: string;
  /** Output only. When the scope was deleted. */
  deleteTime: string;
...
export const V1alphaScope: ResourceBinding<V1alphaScopeConfig, V1alphaScopeAttrs> = {
