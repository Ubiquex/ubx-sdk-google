...
export interface V1alphaRolloutSequence_AutoUpgradeConfig_RolloutCreationScope {
  /** Optional. The list of enabled upgrade types. */
  upgradeTypes?: string[] | Computed<string[]>;
}

export interface V1alphaRolloutSequence_AutoUpgradeConfig {
  ...
  rolloutCreationScope?: V1alphaRolloutSequence_AutoUpgradeConfig_RolloutCreationScope | Computed<V1alphaRolloutSequence_AutoUpgradeConfig_RolloutCreationScope>;
}

export interface V1alphaRolloutSequence_IgnoredClustersSelector {
...
export interface V1alphaRolloutSequence_OperationalState {
...
export interface V1alphaRolloutSequence_Stages {
  clusterSelector?: V1alphaRolloutSequence_IgnoredClustersSelector | Computed<V1alphaRolloutSequence_IgnoredClustersSelector>;
  fleetProjects?: string[] | Computed<string[]>;
  soakDuration?: string | Computed<string>;
}

const V1alphaRolloutSequence_AutoUpgradeConfig_RolloutCreationScopeFields: FieldMap = {
  upgradeTypes: "upgrade_types",
};

const V1alphaRolloutSequence_AutoUpgradeConfigFields: FieldMap = {
...
const V1alphaRolloutSequence_IgnoredClustersSelectorFields: FieldMap = {
  labelSelector: "label_selector",
};

const V1alphaRolloutSequence_OperationalStateFields: FieldMap = {
  reasons: "reasons",
  state: "state",
  stateChangeTime: "state_change_time",
};

const V1alphaRolloutSequence_StagesFields: FieldMap = {
  clusterSelector: {
...
export interface V1alphaRolloutSequenceAttrs {
  /** Configuration for automatic upgrades. */
  autoUpgradeConfig: V1alphaRolloutSequence_AutoUpgradeConfig;
  ...
  displayName: string;
  /** Configuration for automatic upgrades. */
  effectiveAutoUpgradeConfig: V1alphaRolloutSequence_AutoUpgradeConfig;
  /** Output only. etag of the Rollout Sequence Ex. abc1234 */
  etag: string;
  /** Selector for clusters. */
  ignoredClustersSelector: V1alphaRolloutSequence_IgnoredClustersSelector;
  /** Optional. Labels for this Rollout Sequence. */
  ...
  name: string;
  /** Operational state of the Rollout Sequence. */
  operationalState: V1alphaRolloutSequence_OperationalState;
  /** Required. Ordered list of stages that constitutes this Rollout. */
  stages: V1alphaRolloutSequence_Stages[];
...
export const V1alphaRolloutSequence: ResourceBinding<V1alphaRolloutSequenceConfig, V1alphaRolloutSequenceAttrs> = {
