...
export interface V1alphaGkehubV1alphaNamespace_State {
  /** Output only. The current state of the Namespace resource. */
  code?: string | Computed<string>;
}

const V1alphaGkehubV1alphaNamespace_StateFields: FieldMap = {
  code: "code",
};

export interface V1alphaGkehubV1alphaNamespaceConfig {
  ...
  state?: V1alphaGkehubV1alphaNamespace_State | Computed<V1alphaGkehubV1alphaNamespace_State>;
...
export interface V1alphaGkehubV1alphaNamespaceAttrs {
  /** Output only. When the namespace was created. */
  createTime: string;
  /** Output only. When the namespace was deleted. */
  deleteTime: string;
  ...
  scope: string;
  /** NamespaceLifecycleState describes the state of a Namespace resource. */
  state: V1alphaGkehubV1alphaNamespace_State;
  /** Output only. Google-generated UUID for this resource. This is unique across all namespace resources. If a namespace resource is deleted and another resource with the same name is created, it gets a different uid. */
  uid: string;
  /** Output only. When the namespace was last updated. */
  updateTime: string;
...
export const V1alphaGkehubV1alphaNamespace: ResourceBinding<V1alphaGkehubV1alphaNamespaceConfig, V1alphaGkehubV1alphaNamespaceAttrs> = {
  wireType: "google_gkehub_v1alpha_gkehub_v1alpha_namespace",
  fields: {
    ...
    state: {
      wireName: "state",
      kind: "object",
      fields: V1alphaGkehubV1alphaNamespace_StateFields,
    },
    uid: "uid",
