...
const V1beta1Service_EndpointsFields: FieldMap = {
  address: "address",
...
export interface V1beta1ServiceConfig {
  ...
  endpoints?: V1beta1Service_Endpoints[] | Computed<V1beta1Service_Endpoints[]>;
...
export const V1beta1Service: ResourceBinding<V1beta1ServiceConfig, V1beta1ServiceAttrs> = {
  ...
  fields: {
    ...
    endpoints: {
      wireName: "endpoints",
      kind: "list",
      fields: V1beta1Service_EndpointsFields,
    },
    metadata: "metadata",
    name: "name",
    uid: "uid",
