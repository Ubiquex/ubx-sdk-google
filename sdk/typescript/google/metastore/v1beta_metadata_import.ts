// Code generated by `ubx sdk gen` from google_metastore_v1beta_metadata_import. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1betaMetadataImport_DatabaseDump {
...
const V1betaMetadataImport_DatabaseDumpFields: FieldMap = {
...
export interface V1betaMetadataImportConfig {
  /** A specification of the location of and metadata about a database dump from a relational database management system. */
  databaseDump?: V1betaMetadataImport_DatabaseDump | Computed<V1betaMetadataImport_DatabaseDump>;
...
export interface V1betaMetadataImportAttrs {
  /** Output only. The time when the metadata import was started. */
  createTime: string;
  /** A specification of the location of and metadata about a database dump from a relational database management system. */
  databaseDump: V1betaMetadataImport_DatabaseDump;
  /** Optional. The description of the metadata import. */
  description: string;
...
export const V1betaMetadataImport: ResourceBinding<V1betaMetadataImportConfig, V1betaMetadataImportAttrs> = {
  wireType: "google_metastore_v1beta_metadata_import",
  fields: {
    databaseDump: {
