...
export interface Backup_ServiceRevision_EncryptionConfig {
...
export interface Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfig_Keytab {
...
export interface Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfig {
  /** A securely stored value. */
  keytab?: Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfig_Keytab | Computed<Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfig_Keytab>;
...
export interface Backup_ServiceRevision_HiveMetastoreConfig {
  ...
  auxiliaryVersions?: Record<string, Backup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions> | Computed<Record<string, Backup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions>>;
  ...
  kerberosConfig?: Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfig | Computed<Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfig>;
  /** Immutable. The Hive metastore schema version. */
  version?: string | Computed<string>;
}

export interface Backup_ServiceRevision_MaintenanceWindow {
...
export interface Backup_ServiceRevision_MetadataIntegration_DataCatalogConfig {
  /** Optional. Defines whether the metastore metadata should be synced to Data Catalog. The default value is to disable syncing metastore metadata to Data Catalog. */
  enabled?: boolean | Computed<boolean>;
}

export interface Backup_ServiceRevision_MetadataIntegration {
  /** Specifies how metastore metadata should be integrated with the Data Catalog service. */
  dataCatalogConfig?: Backup_ServiceRevision_MetadataIntegration_DataCatalogConfig | Computed<Backup_ServiceRevision_MetadataIntegration_DataCatalogConfig>;
}
...
export interface Backup_ServiceRevision_MetadataManagementActivity {
  /** Output only. The latest metadata exports of the metastore service. */
  metadataExports?: Backup_ServiceRevision_MetadataManagementActivity_MetadataExports[] | Computed<Backup_ServiceRevision_MetadataManagementActivity_MetadataExports[]>;
  /** Output only. The latest restores of the metastore service. */
  restores?: Backup_ServiceRevision_MetadataManagementActivity_Restores[] | Computed<Backup_ServiceRevision_MetadataManagementActivity_Restores[]>;
}

export interface Backup_ServiceRevision_ScalingConfig_AutoscalingConfig_LimitConfig {
...
export interface Backup_ServiceRevision_ScalingConfig_AutoscalingConfig {
  ...
  limitConfig?: Backup_ServiceRevision_ScalingConfig_AutoscalingConfig_LimitConfig | Computed<Backup_ServiceRevision_ScalingConfig_AutoscalingConfig_LimitConfig>;
}

export interface Backup_ServiceRevision_ScalingConfig {
  /** Represents the autoscaling configuration of a metastore service. */
  autoscalingConfig?: Backup_ServiceRevision_ScalingConfig_AutoscalingConfig | Computed<Backup_ServiceRevision_ScalingConfig_AutoscalingConfig>;
...
export interface Backup_ServiceRevision_ScheduledBackup_LatestBackup {
...
export interface Backup_ServiceRevision_ScheduledBackup {
  ...
  latestBackup?: Backup_ServiceRevision_ScheduledBackup_LatestBackup | Computed<Backup_ServiceRevision_ScheduledBackup_LatestBackup>;
...
export interface Backup_ServiceRevision {
  ...
  encryptionConfig?: Backup_ServiceRevision_EncryptionConfig | Computed<Backup_ServiceRevision_EncryptionConfig>;
  /** Output only. The URI of the endpoint used to access the metastore service. */
  endpointUri?: string | Computed<string>;
  /** Specifies configuration information specific to running Hive metastore software as the metastore service. */
  hiveMetastoreConfig?: Backup_ServiceRevision_HiveMetastoreConfig | Computed<Backup_ServiceRevision_HiveMetastoreConfig>;
  /** User-defined labels for the metastore service. */
  labels?: Record<string, string> | Computed<Record<string, string>>;
  /** Maintenance window. This specifies when Dataproc Metastore may perform system maintenance operation to the service. */
  maintenanceWindow?: Backup_ServiceRevision_MaintenanceWindow | Computed<Backup_ServiceRevision_MaintenanceWindow>;
  /** Specifies how metastore metadata should be integrated with external services. */
  metadataIntegration?: Backup_ServiceRevision_MetadataIntegration | Computed<Backup_ServiceRevision_MetadataIntegration>;
  /** The metadata management activities of the metastore service. */
  metadataManagementActivity?: Backup_ServiceRevision_MetadataManagementActivity | Computed<Backup_ServiceRevision_MetadataManagementActivity>;
  ...
  scalingConfig?: Backup_ServiceRevision_ScalingConfig | Computed<Backup_ServiceRevision_ScalingConfig>;
  /** This specifies the configuration of scheduled backup. */
  scheduledBackup?: Backup_ServiceRevision_ScheduledBackup | Computed<Backup_ServiceRevision_ScheduledBackup>;
  ...
  telemetryConfig?: Backup_ServiceRevision_TelemetryConfig | Computed<Backup_ServiceRevision_TelemetryConfig>;
...
const Backup_ServiceRevision_EncryptionConfigFields: FieldMap = {
  kmsKey: "kms_key",
};

const Backup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_ConsumersFields: FieldMap = {
  endpointLocation: "endpoint_location",
  endpointUri: "endpoint_uri",
  subnetwork: "subnetwork",
};

const Backup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfigFields: FieldMap = {
  consumers: {
    wireName: "consumers",
    kind: "list",
...
const Backup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersionsFields: FieldMap = {
...
const Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfig_KeytabFields: FieldMap = {
  cloudSecret: "cloud_secret",
};

const Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfigFields: FieldMap = {
  keytab: {
    wireName: "keytab",
    kind: "object",
...
const Backup_ServiceRevision_HiveMetastoreConfigFields: FieldMap = {
  auxiliaryVersions: {
...
const Backup_ServiceRevision_MaintenanceWindowFields: FieldMap = {
  dayOfWeek: "day_of_week",
  hourOfDay: "hour_of_day",
};

const Backup_ServiceRevision_MetadataIntegration_DataCatalogConfigFields: FieldMap = {
  enabled: "enabled",
};

const Backup_ServiceRevision_MetadataIntegrationFields: FieldMap = {
  dataCatalogConfig: {
...
const Backup_ServiceRevision_MetadataManagementActivity_MetadataExportsFields: FieldMap = {
...
const Backup_ServiceRevision_MetadataManagementActivity_RestoresFields: FieldMap = {
  backup: "backup",
...
const Backup_ServiceRevision_MetadataManagementActivityFields: FieldMap = {
  metadataExports: {
...
const Backup_ServiceRevision_ScalingConfig_AutoscalingConfig_LimitConfigFields: FieldMap = {
  maxScalingFactor: "max_scaling_factor",
  minScalingFactor: "min_scaling_factor",
};

const Backup_ServiceRevision_ScalingConfig_AutoscalingConfigFields: FieldMap = {
...
const Backup_ServiceRevision_ScalingConfigFields: FieldMap = {
  autoscalingConfig: {
...
const Backup_ServiceRevision_ScheduledBackup_LatestBackupFields: FieldMap = {
  backupId: "backup_id",
  duration: "duration",
  startTime: "start_time",
  state: "state",
...
const Backup_ServiceRevision_ScheduledBackupFields: FieldMap = {
  backupLocation: "backup_location",
...
const Backup_ServiceRevision_TelemetryConfigFields: FieldMap = {
  logFormat: "log_format",
};

const Backup_ServiceRevisionFields: FieldMap = {
...
export interface BackupAttrs {
  ...
  /** A managed metastore service that serves metadata queries. */
  serviceRevision: Backup_ServiceRevision;
  /** Output only. The current state of the backup. */
  state: string;
}
