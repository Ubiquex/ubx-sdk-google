...
export interface CloudkmsCryptoKeyVersion_Attestation_CertChains {
...
export interface CloudkmsCryptoKeyVersion_Attestation {
  /** Certificate chains needed to verify the attestation. Certificates in chains are PEM-encoded and are ordered based on https://tools.ietf.org/html/rfc5246#section-7.4.2. */
  certChains?: CloudkmsCryptoKeyVersion_Attestation_CertChains | Computed<CloudkmsCryptoKeyVersion_Attestation_CertChains>;
...
export interface CloudkmsCryptoKeyVersion_ExternalProtectionLevelOptions {
...
const CloudkmsCryptoKeyVersion_Attestation_CertChainsFields: FieldMap = {
  caviumCerts: "cavium_certs",
  googleCardCerts: "google_card_certs",
  googlePartitionCerts: "google_partition_certs",
};

const CloudkmsCryptoKeyVersion_AttestationFields: FieldMap = {
  certChains: {
...
const CloudkmsCryptoKeyVersion_ExternalProtectionLevelOptionsFields: FieldMap = {
...
export interface CloudkmsCryptoKeyVersionConfig {
  /** Output only. The CryptoKeyVersionAlgorithm that this CryptoKeyVersion supports. */
  algorithm?: string | Computed<string>;
  /** Contains an HSM-generated attestation about a key operation. For more information, see [Verifying attestations] (https://cloud.google.com/kms/docs/attest-key). */
  attestation?: CloudkmsCryptoKeyVersion_Attestation | Computed<CloudkmsCryptoKeyVersion_Attestation>;
  ...
  externalProtectionLevelOptions?: CloudkmsCryptoKeyVersion_ExternalProtectionLevelOptions | Computed<CloudkmsCryptoKeyVersion_ExternalProtectionLevelOptions>;
...
export interface CloudkmsCryptoKeyVersionAttrs {
  /** Output only. The CryptoKeyVersionAlgorithm that this CryptoKeyVersion supports. */
  algorithm: string;
  /** Contains an HSM-generated attestation about a key operation. For more information, see [Verifying attestations] (https://cloud.google.com/kms/docs/attest-key). */
  attestation: CloudkmsCryptoKeyVersion_Attestation;
  /** Output only. The time at which this CryptoKeyVersion was created. */
  createTime: string;
  /** Output only. The time this CryptoKeyVersion's key material was destroyed. Only present if state is DESTROYED. */
  ...
  /** ExternalProtectionLevelOptions stores a group of additional fields for configuring a CryptoKeyVersion that are specific to the EXTERNAL protection level and EXTERNAL_VPC protection levels. */
  externalProtectionLevelOptions: CloudkmsCryptoKeyVersion_ExternalProtectionLevelOptions;
  /** Output only. The time this CryptoKeyVersion's key material was generated. */
  generateTime: string;
  /** Output only. The root cause of the most recent generation failure. Only present if state is GENERATION_FAILED. */
...
export const CloudkmsCryptoKeyVersion: ResourceBinding<CloudkmsCryptoKeyVersionConfig, CloudkmsCryptoKeyVersionAttrs> = {
