// Code generated by `ubx sdk gen` from google_alloydb_alloydb_instance. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface AlloydbInstance_ClientConnectionConfig_SslConfig {
...
export interface AlloydbInstance_ClientConnectionConfig {
  /** Optional. Configuration to enforce connectors only (ex: AuthProxy) connections to the database. */
  requireConnectors?: boolean | Computed<boolean>;
  /** SSL configuration. */
  sslConfig?: AlloydbInstance_ClientConnectionConfig_SslConfig | Computed<AlloydbInstance_ClientConnectionConfig_SslConfig>;
}

export interface AlloydbInstance_ConnectionPoolConfig {
...
export interface AlloydbInstance_MachineConfig {
...
export interface AlloydbInstance_NetworkConfig_AuthorizedExternalNetworks {
  cidrRange?: string | Computed<string>;
}

export interface AlloydbInstance_NetworkConfig {
  ...
  authorizedExternalNetworks?: AlloydbInstance_NetworkConfig_AuthorizedExternalNetworks[] | Computed<AlloydbInstance_NetworkConfig_AuthorizedExternalNetworks[]>;
...
export interface AlloydbInstance_Nodes {
...
export interface AlloydbInstance_ObservabilityConfig {
...
export interface AlloydbInstance_PscInstanceConfig_PscAutoConnections {
...
export interface AlloydbInstance_PscInstanceConfig_PscInterfaceConfigs {
  networkAttachmentResource?: string | Computed<string>;
}

export interface AlloydbInstance_PscInstanceConfig {
  /** Optional. List of consumer projects that are allowed to create PSC endpoints to service-attachments to this instance. */
  allowedConsumerProjects?: string[] | Computed<string[]>;
  /** Optional. Configurations for setting up PSC service automation. */
  pscAutoConnections?: AlloydbInstance_PscInstanceConfig_PscAutoConnections[] | Computed<AlloydbInstance_PscInstanceConfig_PscAutoConnections[]>;
  ...
  pscInterfaceConfigs?: AlloydbInstance_PscInstanceConfig_PscInterfaceConfigs[] | Computed<AlloydbInstance_PscInstanceConfig_PscInterfaceConfigs[]>;
...
export interface AlloydbInstance_QueryInsightsConfig {
...
export interface AlloydbInstance_ReadPoolConfig {
  /** Read capacity, i.e. number of nodes in a read pool instance. */
  nodeCount?: number | Computed<number>;
}

const AlloydbInstance_ClientConnectionConfig_SslConfigFields: FieldMap = {
  caSource: "ca_source",
  sslMode: "ssl_mode",
};

const AlloydbInstance_ClientConnectionConfigFields: FieldMap = {
  requireConnectors: "require_connectors",
  sslConfig: {
    wireName: "ssl_config",
    kind: "object",
    fields: AlloydbInstance_ClientConnectionConfig_SslConfigFields,
  },
};

const AlloydbInstance_ConnectionPoolConfigFields: FieldMap = {
...
const AlloydbInstance_MachineConfigFields: FieldMap = {
  cpuCount: "cpu_count",
  machineType: "machine_type",
};

const AlloydbInstance_NetworkConfig_AuthorizedExternalNetworksFields: FieldMap = {
  cidrRange: "cidr_range",
};

const AlloydbInstance_NetworkConfigFields: FieldMap = {
  allocatedIpRangeOverride: "allocated_ip_range_override",
  authorizedExternalNetworks: {
    wireName: "authorized_external_networks",
    kind: "list",
    fields: AlloydbInstance_NetworkConfig_AuthorizedExternalNetworksFields,
  },
...
const AlloydbInstance_NodesFields: FieldMap = {
  id: "id",
  ip: "ip",
...
const AlloydbInstance_ObservabilityConfigFields: FieldMap = {
  enabled: "enabled",
...
const AlloydbInstance_PscInstanceConfig_PscAutoConnectionsFields: FieldMap = {
...
const AlloydbInstance_PscInstanceConfig_PscInterfaceConfigsFields: FieldMap = {
  networkAttachmentResource: "network_attachment_resource",
};

const AlloydbInstance_PscInstanceConfigFields: FieldMap = {
  allowedConsumerProjects: "allowed_consumer_projects",
  pscAutoConnections: {
    wireName: "psc_auto_connections",
    kind: "list",
    fields: AlloydbInstance_PscInstanceConfig_PscAutoConnectionsFields,
  },
  pscDnsName: "psc_dns_name",
  pscInterfaceConfigs: {
    wireName: "psc_interface_configs",
    kind: "list",
    fields: AlloydbInstance_PscInstanceConfig_PscInterfaceConfigsFields,
  },
  serviceAttachmentLink: "service_attachment_link",
};

const AlloydbInstance_QueryInsightsConfigFields: FieldMap = {
  queryPlansPerMinute: "query_plans_per_minute",
...
const AlloydbInstance_ReadPoolConfigFields: FieldMap = {
  nodeCount: "node_count",
};

export interface AlloydbInstanceConfig {
  ...
  clientConnectionConfig?: AlloydbInstance_ClientConnectionConfig | Computed<AlloydbInstance_ClientConnectionConfig>;
  /** Configuration for Managed Connection Pool (MCP). */
  connectionPoolConfig?: AlloydbInstance_ConnectionPoolConfig | Computed<AlloydbInstance_ConnectionPoolConfig>;
  ...
  machineConfig?: AlloydbInstance_MachineConfig | Computed<AlloydbInstance_MachineConfig>;
  ...
  networkConfig?: AlloydbInstance_NetworkConfig | Computed<AlloydbInstance_NetworkConfig>;
  /** Output only. List of available read-only VMs in this instance, including the standby for a PRIMARY instance. */
  nodes?: AlloydbInstance_Nodes[] | Computed<AlloydbInstance_Nodes[]>;
  /** Observability Instance specific configuration. */
  observabilityConfig?: AlloydbInstance_ObservabilityConfig | Computed<AlloydbInstance_ObservabilityConfig>;
  /** Output only. All outbound public IP addresses configured for the instance. */
  outboundPublicIpAddresses?: string[] | Computed<string[]>;
  /** PscInstanceConfig contains PSC related configuration at an instance level. */
  pscInstanceConfig?: AlloydbInstance_PscInstanceConfig | Computed<AlloydbInstance_PscInstanceConfig>;
  /** Output only. The public IP addresses for the Instance. This is available ONLY when enable_public_ip is set. This is the connection endpoint for an end-user application. */
  publicIpAddress?: string | Computed<string>;
  /** QueryInsights Instance specific configuration. */
  queryInsightsConfig?: AlloydbInstance_QueryInsightsConfig | Computed<AlloydbInstance_QueryInsightsConfig>;
  /** Configuration for a read pool instance. */
  readPoolConfig?: AlloydbInstance_ReadPoolConfig | Computed<AlloydbInstance_ReadPoolConfig>;
  ...
  writableNode?: AlloydbInstance_Nodes | Computed<AlloydbInstance_Nodes>;
}

export interface AlloydbInstanceAttrs {
  /** Optional. Specifies whether an instance needs to spin up. Once the instance is active, the activation policy can be updated to the `NEVER` to stop the instance. Likewise, the activation policy can be updated to `ALWAYS` to start the instance. There are restrictions around when an instance can/cannot be activated (for example, a read pool instance should be stopped before stopping primary etc.). Please refer to the API documentation for more details. */
  ...
  /** Client connection configuration */
  clientConnectionConfig: AlloydbInstance_ClientConnectionConfig;
  /** Configuration for Managed Connection Pool (MCP). */
  connectionPoolConfig: AlloydbInstance_ConnectionPoolConfig;
  /** Output only. Create time stamp */
  createTime: string;
  /** Optional. Controls whether the Data API is enabled for this instance. When enabled, this allows authorized users to connect to the instance from the public internet using the `executeSql` API, even for private IP instances. If this is not specified, the data API is enabled by default for Google internal services like AlloyDB Studio. Disable it explicitly to disallow Google internal services as well. */
  ...
  /** MachineConfig describes the configuration of a machine. */
  machineConfig: AlloydbInstance_MachineConfig;
  /** Output only. Maintenance version of the instance, for example: POSTGRES_15.2025_07_15.04_00. Output only. Update this field via the parent cluster's maintenance_version field(s). */
  maintenanceVersionName: string;
  /** Output only. The name of the instance resource with the format: * projects/{project}/locations/{region}/clusters/{cluster_id}/instances/{instance_id} where the cluster and instance ID segments should satisfy the regex expression `[a-z]([a-z0-9-]{0,61}[a-z0-9])?`, e.g. 1-63 characters of lowercase letters, numbers, and dashes, starting with a letter, and ending with a letter or number. For more details see https://google.aip.dev/122. The prefix of the instance resource name is the name of the parent resource: * projects/{project}/locations/{region}/clusters/{cluster_id} */
  name: string;
  /** Metadata related to instance-level network configuration. */
  networkConfig: AlloydbInstance_NetworkConfig;
  /** Output only. List of available read-only VMs in this instance, including the standby for a PRIMARY instance. */
  nodes: AlloydbInstance_Nodes[];
  /** Observability Instance specific configuration. */
  observabilityConfig: AlloydbInstance_ObservabilityConfig;
  /** Output only. All outbound public IP addresses configured for the instance. */
  outboundPublicIpAddresses: string[];
  /** PscInstanceConfig contains PSC related configuration at an instance level. */
  pscInstanceConfig: AlloydbInstance_PscInstanceConfig;
  /** Output only. The public IP addresses for the Instance. This is available ONLY when enable_public_ip is set. This is the connection endpoint for an end-user application. */
  publicIpAddress: string;
  /** QueryInsights Instance specific configuration. */
  queryInsightsConfig: AlloydbInstance_QueryInsightsConfig;
  /** Configuration for a read pool instance. */
  readPoolConfig: AlloydbInstance_ReadPoolConfig;
  /** Output only. Reconciling (https://google.aip.dev/128#reconciliation). Set to true if the current state of Instance does not match the user's intended state, and the service is actively updating the resource to reconcile them. This can happen due to user-triggered updates or system actions like failover or maintenance. */
  reconciling: boolean;
  /** Output only. Reserved for future use. */
  ...
  updateTime: string;
  /** Details of a single node in the instance. Nodes in an AlloyDB instance are ephemeral, they can change during update, failover, autohealing and resize operations. */
  writableNode: AlloydbInstance_Nodes;
}

export const AlloydbInstance: ResourceBinding<AlloydbInstanceConfig, AlloydbInstanceAttrs> = {
  wireType: "google_alloydb_alloydb_instance",
  fields: {
    ...
    clientConnectionConfig: {
      ...
      kind: "object",
      fields: AlloydbInstance_ClientConnectionConfigFields,
    },
    connectionPoolConfig: {
      wireName: "connection_pool_config",
      kind: "object",
      fields: AlloydbInstance_ConnectionPoolConfigFields,
    },
    ...
    machineConfig: {
      ...
      kind: "object",
      fields: AlloydbInstance_MachineConfigFields,
    },
    ...
    networkConfig: {
      ...
      kind: "object",
      fields: AlloydbInstance_NetworkConfigFields,
    },
    nodes: {
      wireName: "nodes",
      kind: "list",
      fields: AlloydbInstance_NodesFields,
    },
    observabilityConfig: {
      wireName: "observability_config",
      kind: "object",
      fields: AlloydbInstance_ObservabilityConfigFields,
    },
    outboundPublicIpAddresses: "outbound_public_ip_addresses",
    pscInstanceConfig: {
      wireName: "psc_instance_config",
      kind: "object",
      fields: AlloydbInstance_PscInstanceConfigFields,
    },
    publicIpAddress: "public_ip_address",
    queryInsightsConfig: {
      wireName: "query_insights_config",
      kind: "object",
      fields: AlloydbInstance_QueryInsightsConfigFields,
    },
    readPoolConfig: {
      wireName: "read_pool_config",
      kind: "object",
      fields: AlloydbInstance_ReadPoolConfigFields,
    },
