// Code generated by `ubx sdk gen` from google_alloydb_v1beta_alloydb_v1beta_endpoint. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1betaAlloydbV1betaEndpoint_DnsConfig {
...
const V1betaAlloydbV1betaEndpoint_DnsConfigFields: FieldMap = {
  dnsName: "dns_name",
  dnsRecordType: "dns_record_type",
};

export interface V1betaAlloydbV1betaEndpointConfig {
  ...
  dnsConfig?: V1betaAlloydbV1betaEndpoint_DnsConfig | Computed<V1betaAlloydbV1betaEndpoint_DnsConfig>;
...
export interface V1betaAlloydbV1betaEndpointAttrs {
  /** Annotations to allow client tools to store small amount of arbitrary data. This is distinct from labels. https://google.aip.dev/128 */
  ...
  displayName: string;
  /** The DNS config for the endpoint, containing the DNS record name, type and targets. */
  dnsConfig: V1betaAlloydbV1betaEndpoint_DnsConfig;
  /** Output only. The effective target instances that the endpoint is associated with. This is a list of target instance names, e.g. projects/{project_number}/locations/{location}/clusters/{cluster_id}/instances/{instance_id} For write endpoint, there is only one effective target instance which has to be a primary instance. Effective target instances are only different from target instances after a switchover or cross-region failover operation. Otherwise, effective_target_instances are the same as target_instances. Note that after a cross-region failover operation, the effective_target_instances can be stale until the operation to update the endpoint is complete. */
...
export const V1betaAlloydbV1betaEndpoint: ResourceBinding<V1betaAlloydbV1betaEndpointConfig, V1betaAlloydbV1betaEndpointAttrs> = {
  wireType: "google_alloydb_v1beta_alloydb_v1beta_endpoint",
  fields: {
    ...
    dnsConfig: {
      wireName: "dns_config",
      kind: "object",
      fields: V1betaAlloydbV1betaEndpoint_DnsConfigFields,
    },
