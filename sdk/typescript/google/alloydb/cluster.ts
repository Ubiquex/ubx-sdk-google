...
export interface Cluster_AutomatedBackupPolicy_WeeklySchedule {
  ...
  startTimes?: Cluster_AutomatedBackupPolicy_WeeklySchedule_StartTimes[] | Computed<Cluster_AutomatedBackupPolicy_WeeklySchedule_StartTimes[]>;
}
...
export interface Cluster_AutomatedBackupPolicy {
  ...
  quantityBasedRetention?: Cluster_AutomatedBackupPolicy_QuantityBasedRetention | Computed<Cluster_AutomatedBackupPolicy_QuantityBasedRetention>;
  /** A time based retention policy specifies that all backups within a certain time period should be retained. */
  timeBasedRetention?: Cluster_AutomatedBackupPolicy_TimeBasedRetention | Computed<Cluster_AutomatedBackupPolicy_TimeBasedRetention>;
  ...
  weeklySchedule?: Cluster_AutomatedBackupPolicy_WeeklySchedule | Computed<Cluster_AutomatedBackupPolicy_WeeklySchedule>;
}
...
export interface Cluster_BackupdrInfo_CurrentWindow {
...
export interface Cluster_BackupdrInfo {
  /** Information about a single window when BackupDR was enabled for this cluster. */
  currentWindow?: Cluster_BackupdrInfo_CurrentWindow | Computed<Cluster_BackupdrInfo_CurrentWindow>;
  ...
  previousWindows?: Cluster_BackupdrInfo_CurrentWindow[] | Computed<Cluster_BackupdrInfo_CurrentWindow[]>;
}

export interface Cluster_CloudsqlBackupRunSource {
...
export interface Cluster_ContinuousBackupInfo {
  ...
  encryptionInfo?: Cluster_ContinuousBackupInfo_EncryptionInfo | Computed<Cluster_ContinuousBackupInfo_EncryptionInfo>;
...
export interface Cluster_MaintenanceUpdatePolicy {
  ...
  denyMaintenancePeriods?: Cluster_MaintenanceUpdatePolicy_DenyMaintenancePeriods[] | Computed<Cluster_MaintenanceUpdatePolicy_DenyMaintenancePeriods[]>;
  /** Preferred windows to perform maintenance. Currently limited to 1. */
  maintenanceWindows?: Cluster_MaintenanceUpdatePolicy_MaintenanceWindows[] | Computed<Cluster_MaintenanceUpdatePolicy_MaintenanceWindows[]>;
}
...
export interface Cluster_SslConfig {
...
const Cluster_BackupdrInfo_CurrentWindowFields: FieldMap = {
...
const Cluster_BackupdrInfoFields: FieldMap = {
  currentWindow: {
    wireName: "current_window",
    kind: "object",
    fields: Cluster_BackupdrInfo_CurrentWindowFields,
  },
  previousWindows: {
...
const Cluster_CloudsqlBackupRunSourceFields: FieldMap = {
...
const Cluster_ContinuousBackupInfo_EncryptionInfoFields: FieldMap = {
  encryptionType: "encryption_type",
  kmsKeyVersions: "kms_key_versions",
};

const Cluster_ContinuousBackupInfoFields: FieldMap = {
  earliestRestorableTime: "earliest_restorable_time",
  enabledTime: "enabled_time",
  encryptionInfo: {
    wireName: "encryption_info",
    kind: "object",
    fields: Cluster_ContinuousBackupInfo_EncryptionInfoFields,
  },
  schedule: "schedule",
};
...
const Cluster_MaintenanceUpdatePolicy_DenyMaintenancePeriods_EndDateFields: FieldMap = {
  day: "day",
  month: "month",
  year: "year",
};

const Cluster_MaintenanceUpdatePolicy_DenyMaintenancePeriodsFields: FieldMap = {
  endDate: {
    wireName: "end_date",
    kind: "object",
    fields: Cluster_MaintenanceUpdatePolicy_DenyMaintenancePeriods_EndDateFields,
  },
  startDate: {
    wireName: "start_date",
    kind: "object",
...
const Cluster_MaintenanceUpdatePolicyFields: FieldMap = {
  denyMaintenancePeriods: {
    ...
    kind: "list",
    fields: Cluster_MaintenanceUpdatePolicy_DenyMaintenancePeriodsFields,
  },
  maintenanceWindows: {
...
const Cluster_MigrationSourceFields: FieldMap = {
  hostPort: "host_port",
...
const Cluster_PrimaryConfigFields: FieldMap = {
...
const Cluster_SslConfigFields: FieldMap = {
  caSource: "ca_source",
  sslMode: "ssl_mode",
};

const Cluster_TrialMetadataFields: FieldMap = {
  endTime: "end_time",
...
export interface ClusterConfig {
  ...
  backupSource?: Cluster_BackupSource | Computed<Cluster_BackupSource>;
  /** Message describing a BackupDrBackupSource. */
  backupdrBackupSource?: Cluster_BackupdrBackupSource | Computed<Cluster_BackupdrBackupSource>;
...
export interface ClusterAttrs {
  ...
  /** Information about BackupDR protection for this cluster. */
  backupdrInfo: Cluster_BackupdrInfo;
  /** The source CloudSQL backup resource. */
  cloudsqlBackupRunSource: Cluster_CloudsqlBackupRunSource;
...
export const Cluster: ResourceBinding<ClusterConfig, ClusterAttrs> = {
  ...
  fields: {
    ...
    backupdrInfo: {
      ...
      kind: "object",
      fields: Cluster_BackupdrInfoFields,
    },
    ...
    primaryConfig: {
      ...
      kind: "object",
      fields: Cluster_PrimaryConfigFields,
    },
    pscConfig: {
      wireName: "psc_config",
      kind: "object",
