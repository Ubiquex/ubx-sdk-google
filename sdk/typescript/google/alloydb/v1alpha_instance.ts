// Code generated by `ubx sdk gen` from google_alloydb_v1alpha_instance. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1alphaInstance_ClientConnectionConfig_SslConfig {
...
export interface V1alphaInstance_ClientConnectionConfig {
  /** Optional. Configuration to enforce connectors only (ex: AuthProxy) connections to the database. */
  requireConnectors?: boolean | Computed<boolean>;
  /** SSL configuration. */
  sslConfig?: V1alphaInstance_ClientConnectionConfig_SslConfig | Computed<V1alphaInstance_ClientConnectionConfig_SslConfig>;
}

export interface V1alphaInstance_ConnectionPoolConfig {
...
export interface V1alphaInstance_NetworkConfig_AuthorizedExternalNetworks {
  cidrRange?: string | Computed<string>;
}

export interface V1alphaInstance_NetworkConfig {
  ...
  authorizedExternalNetworks?: V1alphaInstance_NetworkConfig_AuthorizedExternalNetworks[] | Computed<V1alphaInstance_NetworkConfig_AuthorizedExternalNetworks[]>;
...
export interface V1alphaInstance_Nodes {
...
export interface V1alphaInstance_ObservabilityConfig {
...
export interface V1alphaInstance_PscInstanceConfig_PscAutoConnections_DnsAutomationInfos {
  fullyQualifiedDomainName?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface V1alphaInstance_PscInstanceConfig_PscAutoConnections {
  consumerNetwork?: string | Computed<string>;
  consumerNetworkStatus?: string | Computed<string>;
  consumerProject?: string | Computed<string>;
  dnsAutomationInfos?: V1alphaInstance_PscInstanceConfig_PscAutoConnections_DnsAutomationInfos[] | Computed<V1alphaInstance_PscInstanceConfig_PscAutoConnections_DnsAutomationInfos[]>;
...
export interface V1alphaInstance_PscInstanceConfig_PscInterfaceConfigs {
  networkAttachmentResource?: string | Computed<string>;
}

export interface V1alphaInstance_PscInstanceConfig {
  ...
  pscAutoConnections?: V1alphaInstance_PscInstanceConfig_PscAutoConnections[] | Computed<V1alphaInstance_PscInstanceConfig_PscAutoConnections[]>;
  ...
  pscInterfaceConfigs?: V1alphaInstance_PscInstanceConfig_PscInterfaceConfigs[] | Computed<V1alphaInstance_PscInstanceConfig_PscInterfaceConfigs[]>;
...
export interface V1alphaInstance_PscInstanceInfo {
...
export interface V1alphaInstance_QueryInsightsConfig {
...
export interface V1alphaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilization {
  /** Target CPU utilization as a float between 0 and 1. */
  utilizationTarget?: number | Computed<number>;
}

export interface V1alphaInstance_ReadPoolConfig_AutoScalingConfig_Policy {
  ...
  cpuUtilization?: V1alphaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilization | Computed<V1alphaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilization>;
...
export interface V1alphaInstance_ReadPoolConfig_AutoScalingConfig_Schedules {
...
export interface V1alphaInstance_ReadPoolConfig_AutoScalingConfig {
  /** Policy for the autoscaler. */
  policy?: V1alphaInstance_ReadPoolConfig_AutoScalingConfig_Policy | Computed<V1alphaInstance_ReadPoolConfig_AutoScalingConfig_Policy>;
  /** Optional list of schedules for the MIG autoscaler. If not set, no schedules are created. */
  schedules?: V1alphaInstance_ReadPoolConfig_AutoScalingConfig_Schedules[] | Computed<V1alphaInstance_ReadPoolConfig_AutoScalingConfig_Schedules[]>;
}

export interface V1alphaInstance_ReadPoolConfig {
  /** Configuration for autoscaling. */
  autoScalingConfig?: V1alphaInstance_ReadPoolConfig_AutoScalingConfig | Computed<V1alphaInstance_ReadPoolConfig_AutoScalingConfig>;
  /** Read capacity, i.e. number of nodes in a read pool instance. */
  nodeCount?: number | Computed<number>;
}

export interface V1alphaInstance_UpdatePolicy {
  /** Mode for updating the instance. */
  mode?: string | Computed<string>;
}

const V1alphaInstance_ClientConnectionConfig_SslConfigFields: FieldMap = {
  caSource: "ca_source",
  sslMode: "ssl_mode",
};

const V1alphaInstance_ClientConnectionConfigFields: FieldMap = {
  requireConnectors: "require_connectors",
  sslConfig: {
    wireName: "ssl_config",
    kind: "object",
    fields: V1alphaInstance_ClientConnectionConfig_SslConfigFields,
  },
};

const V1alphaInstance_ConnectionPoolConfigFields: FieldMap = {
...
const V1alphaInstance_GcaConfigFields: FieldMap = {
  gcaEntitlement: "gca_entitlement",
};

const V1alphaInstance_GeminiConfigFields: FieldMap = {
  entitled: "entitled",
};

const V1alphaInstance_MachineConfigFields: FieldMap = {
  cpuCount: "cpu_count",
  machineType: "machine_type",
};

const V1alphaInstance_NetworkConfig_AuthorizedExternalNetworksFields: FieldMap = {
  cidrRange: "cidr_range",
};

const V1alphaInstance_NetworkConfigFields: FieldMap = {
  allocatedIpRangeOverride: "allocated_ip_range_override",
  authorizedExternalNetworks: {
    wireName: "authorized_external_networks",
    kind: "list",
    fields: V1alphaInstance_NetworkConfig_AuthorizedExternalNetworksFields,
  },
...
const V1alphaInstance_PscInstanceConfig_PscAutoConnections_DnsAutomationInfosFields: FieldMap = {
  fullyQualifiedDomainName: "fully_qualified_domain_name",
  state: "state",
};

const V1alphaInstance_PscInstanceConfig_PscAutoConnectionsFields: FieldMap = {
  ...
  dnsAutomationInfos: {
    ...
    kind: "list",
    fields: V1alphaInstance_PscInstanceConfig_PscAutoConnections_DnsAutomationInfosFields,
  },
...
const V1alphaInstance_PscInstanceConfig_PscInterfaceConfigsFields: FieldMap = {
  networkAttachmentResource: "network_attachment_resource",
};

const V1alphaInstance_PscInstanceConfigFields: FieldMap = {
  ...
  pscAutoConnections: {
    ...
    kind: "list",
    fields: V1alphaInstance_PscInstanceConfig_PscAutoConnectionsFields,
  },
  ...
  pscInterfaceConfigs: {
    ...
    kind: "list",
    fields: V1alphaInstance_PscInstanceConfig_PscInterfaceConfigsFields,
  },
  serviceAttachmentLink: "service_attachment_link",
};

const V1alphaInstance_PscInstanceInfoFields: FieldMap = {
...
const V1alphaInstance_QueryInsightsConfigFields: FieldMap = {
  queryPlansPerMinute: "query_plans_per_minute",
...
const V1alphaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilizationFields: FieldMap = {
  utilizationTarget: "utilization_target",
};

const V1alphaInstance_ReadPoolConfig_AutoScalingConfig_PolicyFields: FieldMap = {
  coolDownPeriodSec: "cool_down_period_sec",
  cpuUtilization: {
    wireName: "cpu_utilization",
    kind: "object",
    fields: V1alphaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilizationFields,
  },
  enabled: "enabled",
  maxNodeCount: "max_node_count",
};

const V1alphaInstance_ReadPoolConfig_AutoScalingConfig_SchedulesFields: FieldMap = {
...
const V1alphaInstance_ReadPoolConfig_AutoScalingConfigFields: FieldMap = {
  policy: {
    wireName: "policy",
    kind: "object",
    fields: V1alphaInstance_ReadPoolConfig_AutoScalingConfig_PolicyFields,
  },
  schedules: {
    wireName: "schedules",
    kind: "list",
    fields: V1alphaInstance_ReadPoolConfig_AutoScalingConfig_SchedulesFields,
  },
};

const V1alphaInstance_ReadPoolConfigFields: FieldMap = {
  autoScalingConfig: {
    wireName: "auto_scaling_config",
    kind: "object",
    fields: V1alphaInstance_ReadPoolConfig_AutoScalingConfigFields,
  },
  nodeCount: "node_count",
};

const V1alphaInstance_UpdatePolicyFields: FieldMap = {
  mode: "mode",
};
...
export interface V1alphaInstanceConfig {
  ...
  gcaConfig?: V1alphaInstance_GcaConfig | Computed<V1alphaInstance_GcaConfig>;
...
export interface V1alphaInstanceAttrs {
  /** Optional. Specifies whether an instance needs to spin up. Once the instance is active, the activation policy can be updated to the `NEVER` to stop the instance. Likewise, the activation policy can be updated to `ALWAYS` to start the instance. There are restrictions around when an instance can/cannot be activated (for example, a read pool instance should be stopped before stopping primary etc.). Please refer to the API documentation for more details. */
  ...
  /** Client connection configuration */
  clientConnectionConfig: V1alphaInstance_ClientConnectionConfig;
  /** Configuration for Managed Connection Pool (MCP). */
  connectionPoolConfig: V1alphaInstance_ConnectionPoolConfig;
  ...
  etag: string;
  /** Instance level configuration parameters related to the Gemini Cloud Assist product. */
  gcaConfig: V1alphaInstance_GcaConfig;
  /** The Compute Engine zone that the instance should serve from, per https://cloud.google.com/compute/docs/regions-zones This can ONLY be specified for ZONAL instances. If present for a REGIONAL instance, an error will be thrown. If this is absent for a ZONAL instance, instance is created in a random zone with available capacity. */
  gceZone: string;
  /** Deprecated and unused. This message will be removed in the near future. */
  geminiConfig: V1alphaInstance_GeminiConfig;
  /** Required. The type of the instance. Specified at creation time. */
  instanceType: string;
  ...
  /** MachineConfig describes the configuration of a machine. */
  machineConfig: V1alphaInstance_MachineConfig;
  ...
  name: string;
  /** Metadata related to instance-level network configuration. */
  networkConfig: V1alphaInstance_NetworkConfig;
  /** Output only. List of available read-only VMs in this instance, including the standby for a PRIMARY instance. */
  nodes: V1alphaInstance_Nodes[];
  /** Observability Instance specific configuration. */
  observabilityConfig: V1alphaInstance_ObservabilityConfig;
  /** Output only. All outbound public IP addresses configured for the instance. */
  outboundPublicIpAddresses: string[];
  /** PscInstanceConfig contains PSC related configuration at an instance level. */
  pscInstanceConfig: V1alphaInstance_PscInstanceConfig;
  /** Information about the Private Service Connect (PSC) for the instance. */
  pscInstanceInfo: V1alphaInstance_PscInstanceInfo;
  /** Output only. The public IP addresses for the Instance. This is available ONLY when enable_public_ip is set. This is the connection endpoint for an end-user application. */
  publicIpAddress: string;
  /** QueryInsights Instance specific configuration. */
  queryInsightsConfig: V1alphaInstance_QueryInsightsConfig;
  /** Configuration for a read pool instance. */
  readPoolConfig: V1alphaInstance_ReadPoolConfig;
  ...
  uid: string;
  /** Policy to be used while updating the instance. */
  updatePolicy: V1alphaInstance_UpdatePolicy;
  /** Output only. Update time stamp */
  updateTime: string;
  /** Details of a single node in the instance. Nodes in an AlloyDB instance are ephemeral, they can change during update, failover, autohealing and resize operations. */
  writableNode: V1alphaInstance_Nodes;
}

export const V1alphaInstance: ResourceBinding<V1alphaInstanceConfig, V1alphaInstanceAttrs> = {
  wireType: "google_alloydb_v1alpha_instance",
  fields: {
    ...
    clientConnectionConfig: {
      ...
      kind: "object",
      fields: V1alphaInstance_ClientConnectionConfigFields,
    },
    ...
    gcaConfig: {
      wireName: "gca_config",
      kind: "object",
      fields: V1alphaInstance_GcaConfigFields,
    },
    gceZone: "gce_zone",
    geminiConfig: {
    ...
    pscInstanceConfig: {
      ...
      kind: "object",
      fields: V1alphaInstance_PscInstanceConfigFields,
    },
    pscInstanceInfo: {
    ...
    queryInsightsConfig: {
      ...
      kind: "object",
      fields: V1alphaInstance_QueryInsightsConfigFields,
    },
    readPoolConfig: {
