...
export interface V1betaApp_DispatchRules {
  domain?: string | Computed<string>;
  path?: string | Computed<string>;
  service?: string | Computed<string>;
}

export interface V1betaApp_FeatureSettings {
...
export interface V1betaApp_Iap {
...
const V1betaApp_DispatchRulesFields: FieldMap = {
  domain: "domain",
  path: "path",
  service: "service",
};

const V1betaApp_FeatureSettingsFields: FieldMap = {
  splitHealthChecks: "split_health_checks",
  useContainerOptimizedOs: "use_container_optimized_os",
};

const V1betaApp_IapFields: FieldMap = {
  enabled: "enabled",
...
export interface V1betaAppConfig {
  ...
  dispatchRules?: V1betaApp_DispatchRules[] | Computed<V1betaApp_DispatchRules[]>;
  /** The feature specific settings to be used in the application. These define behaviors that are user configurable. */
  featureSettings?: V1betaApp_FeatureSettings | Computed<V1betaApp_FeatureSettings>;
  /** Additional Google Generated Customer Metadata, this field won't be provided by default and can be requested by setting the IncludeExtraData field in GetApplicationRequest */
  generatedCustomerMetadata?: Record<string, unknown> | Computed<Record<string, unknown>>;
  /** Identity-Aware Proxy */
  iap?: V1betaApp_Iap | Computed<V1betaApp_Iap>;
...
export interface V1betaAppAttrs {
  ...
  /** HTTP path dispatch rules for requests to the application that do not explicitly target a service or version. Rules are order-dependent. Up to 20 dispatch rules can be supported. */
  dispatchRules: V1betaApp_DispatchRules[];
  /** The feature specific settings to be used in the application. These define behaviors that are user configurable. */
  featureSettings: V1betaApp_FeatureSettings;
