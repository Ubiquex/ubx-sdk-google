...
export interface AndroidmanagementMigrationTokenConfig {
...
export interface AndroidmanagementMigrationTokenAttrs {
  /** Immutable. Optional EMM-specified additional data. Once the device is migrated this will be populated in the migrationAdditionalData field of the Device resource. This must be at most 1024 characters. */
...
export const AndroidmanagementMigrationToken: ResourceBinding<AndroidmanagementMigrationTokenConfig, AndroidmanagementMigrationTokenAttrs> = {
