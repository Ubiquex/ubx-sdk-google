...
export interface RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTime {
...
export interface RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindow {
  day?: string | Computed<string>;
  duration?: string | Computed<string>;
  startTime?: RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTime | Computed<RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTime>;
}

export interface RedisInstance_MaintenancePolicy {
  ...
  weeklyMaintenanceWindow?: RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindow[] | Computed<RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindow[]>;
}

export interface RedisInstance_MaintenanceSchedule {
...
export interface RedisInstance_Nodes {
  id?: string | Computed<string>;
  zone?: string | Computed<string>;
}

export interface RedisInstance_PersistenceConfig {
...
export interface RedisInstance_ServerCaCerts {
...
const RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTimeFields: FieldMap = {
  hours: "hours",
  minutes: "minutes",
  nanos: "nanos",
  seconds: "seconds",
...
const RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindowFields: FieldMap = {
  day: "day",
  duration: "duration",
  startTime: {
    wireName: "start_time",
    kind: "object",
    fields: RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTimeFields,
  },
};

const RedisInstance_MaintenancePolicyFields: FieldMap = {
  ...
  weeklyMaintenanceWindow: {
    ...
    kind: "list",
    fields: RedisInstance_MaintenancePolicy_WeeklyMaintenanceWindowFields,
  },
};

const RedisInstance_MaintenanceScheduleFields: FieldMap = {
...
const RedisInstance_NodesFields: FieldMap = {
  id: "id",
  zone: "zone",
};

const RedisInstance_PersistenceConfigFields: FieldMap = {
...
const RedisInstance_ServerCaCertsFields: FieldMap = {
  cert: "cert",
  createTime: "create_time",
...
export interface RedisInstanceConfig {
  ...
  maintenancePolicy?: RedisInstance_MaintenancePolicy | Computed<RedisInstance_MaintenancePolicy>;
  /** Upcoming maintenance schedule. If no maintenance is scheduled, fields are not populated. */
  maintenanceSchedule?: RedisInstance_MaintenanceSchedule | Computed<RedisInstance_MaintenanceSchedule>;
  ...
  nodes?: RedisInstance_Nodes[] | Computed<RedisInstance_Nodes[]>;
  /** Configuration of the persistence functionality. */
  persistenceConfig?: RedisInstance_PersistenceConfig | Computed<RedisInstance_PersistenceConfig>;
  ...
  serverCaCerts?: RedisInstance_ServerCaCerts[] | Computed<RedisInstance_ServerCaCerts[]>;
...
export interface RedisInstanceAttrs {
  /** Optional. If specified, at least one node will be provisioned in this zone in addition to the zone specified in location_id. Only applicable to standard tier. If provided, it must be a different zone from the one provided in [location_id]. Additional nodes beyond the first 2 will be placed in zones selected by the service. */
  ...
  locationId: string;
  /** Maintenance policy for an instance. */
  maintenancePolicy: RedisInstance_MaintenancePolicy;
  /** Upcoming maintenance schedule. If no maintenance is scheduled, fields are not populated. */
  maintenanceSchedule: RedisInstance_MaintenanceSchedule;
  /** Optional. The self service update maintenance version. The version is date based such as "20210712_00_00". */
  ...
  name: string;
  /** Output only. Info per node. */
  nodes: RedisInstance_Nodes[];
  /** Configuration of the persistence functionality. */
  persistenceConfig: RedisInstance_PersistenceConfig;
  /** Output only. Cloud IAM identity used by import / export operations to transfer data to/from Cloud Storage. Format is "serviceAccount:". The value may change over time for a given instance so should be checked before each import/export operation. */
  ...
  /** Output only. List of server CA certificates for the instance. */
  serverCaCerts: RedisInstance_ServerCaCerts[];
  /** Output only. The current state of this instance. */
  state: string;
  /** Output only. Additional information about the current status of this instance, if available. */
...
export const RedisInstance: ResourceBinding<RedisInstanceConfig, RedisInstanceAttrs> = {
  wireType: "google_redis_redis_instance",
  fields: {
    ...
    maintenancePolicy: {
      ...
      kind: "object",
      fields: RedisInstance_MaintenancePolicyFields,
    },
    maintenanceSchedule: {
      wireName: "maintenance_schedule",
      kind: "object",
      fields: RedisInstance_MaintenanceScheduleFields,
    },
    ...
    nodes: {
      wireName: "nodes",
      kind: "list",
      fields: RedisInstance_NodesFields,
    },
    persistenceConfig: {
      wireName: "persistence_config",
      kind: "object",
      fields: RedisInstance_PersistenceConfigFields,
    },
    ...
    serverCaCerts: {
      ...
      kind: "list",
      fields: RedisInstance_ServerCaCertsFields,
    },
    state: "state",
