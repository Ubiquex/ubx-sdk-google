...
export interface V1beta1AclPolicy_ClusterAclPolicyAttachments_AclPolicyRevisionStatuses {
...
export interface V1beta1AclPolicy_ClusterAclPolicyAttachments {
  aclPolicyRevisionStatuses?: V1beta1AclPolicy_ClusterAclPolicyAttachments_AclPolicyRevisionStatuses[] | Computed<V1beta1AclPolicy_ClusterAclPolicyAttachments_AclPolicyRevisionStatuses[]>;
  cluster?: string | Computed<string>;
}

export interface V1beta1AclPolicy_Rules {
...
export interface V1beta1AclPolicyAttrs {
  /** Output only. The ACL policy attachment status for each attached cluster. */
  clusterAclPolicyAttachments: V1beta1AclPolicy_ClusterAclPolicyAttachments[];
  /** Output only. The timestamp that the ACL policy was created. */
  createTime: string;
  /** Output only. Etag for the ACL policy. */
  etag: string;
