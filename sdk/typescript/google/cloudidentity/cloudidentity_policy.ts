// Code generated by `ubx sdk gen` from google_cloudidentity_cloudidentity_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface CloudidentityPolicy_PolicyQuery {
...
export interface CloudidentityPolicy_Setting {
...
const CloudidentityPolicy_PolicyQueryFields: FieldMap = {
  group: "group",
  orgUnit: "org_unit",
  query: "query",
...
const CloudidentityPolicy_SettingFields: FieldMap = {
  type: "type",
  value: "value",
};

export interface CloudidentityPolicyConfig {
  ...
  /** PolicyQuery */
  policyQuery?: CloudidentityPolicy_PolicyQuery | Computed<CloudidentityPolicy_PolicyQuery>;
  /** Setting */
  setting?: CloudidentityPolicy_Setting | Computed<CloudidentityPolicy_Setting>;
  /** Output only. The type of the policy. */
  type?: string | Computed<string>;
}

export interface CloudidentityPolicyAttrs {
  /** Immutable. Customer that the Policy belongs to. The value is in the format 'customers/{customerId}'. The `customerId` must begin with "C" To find your customer ID in Admin Console see https://support.google.com/a/answer/10070793. */
  customer: string;
  /** Output only. Identifier. The [resource name](https://cloud.google.com/apis/design/resource_names) of the Policy. Format: policies/{policy}. */
  name: string;
  /** PolicyQuery */
  policyQuery: CloudidentityPolicy_PolicyQuery;
  /** Setting */
  setting: CloudidentityPolicy_Setting;
  /** Output only. The type of the policy. */
  type: string;
}

export const CloudidentityPolicy: ResourceBinding<CloudidentityPolicyConfig, CloudidentityPolicyAttrs> = {
  wireType: "google_cloudidentity_cloudidentity_policy",
  fields: {
    customer: "customer",
    name: "name",
    policyQuery: {
      ...
      kind: "object",
      fields: CloudidentityPolicy_PolicyQueryFields,
    },
    setting: {
      wireName: "setting",
      kind: "object",
      fields: CloudidentityPolicy_SettingFields,
    },
    type: "type",
  },
};
