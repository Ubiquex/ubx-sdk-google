...
export interface V1beta1InboundSamlSsoProfile_IdpConfig {
...
export interface V1beta1InboundSamlSsoProfile_SpConfig {
...
const V1beta1InboundSamlSsoProfile_IdpConfigFields: FieldMap = {
...
const V1beta1InboundSamlSsoProfile_SpConfigFields: FieldMap = {
  assertionConsumerServiceUri: "assertion_consumer_service_uri",
  entityId: "entity_id",
};

export interface V1beta1InboundSamlSsoProfileConfig {
...
export interface V1beta1InboundSamlSsoProfileAttrs {
  /** Immutable. The customer. For example: `customers/C0123abc`. */
  customer: string;
  /** Human-readable name of the SAML SSO profile. */
  displayName: string;
  /** SAML IDP (identity provider) configuration. */
  idpConfig: V1beta1InboundSamlSsoProfile_IdpConfig;
  /** Output only. [Resource name](https://cloud.google.com/apis/design/resource_names) of the SAML SSO profile. */
  name: string;
  /** SAML SP (service provider) configuration. */
  spConfig: V1beta1InboundSamlSsoProfile_SpConfig;
}

export const V1beta1InboundSamlSsoProfile: ResourceBinding<V1beta1InboundSamlSsoProfileConfig, V1beta1InboundSamlSsoProfileAttrs> = {
