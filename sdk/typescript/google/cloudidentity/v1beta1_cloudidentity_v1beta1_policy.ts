...
export interface V1beta1CloudidentityV1beta1Policy_PolicyQuery {
...
export interface V1beta1CloudidentityV1beta1Policy_Setting {
...
const V1beta1CloudidentityV1beta1Policy_PolicyQueryFields: FieldMap = {
  group: "group",
  orgUnit: "org_unit",
  query: "query",
...
const V1beta1CloudidentityV1beta1Policy_SettingFields: FieldMap = {
  type: "type",
  value: "value",
};

export interface V1beta1CloudidentityV1beta1PolicyConfig {
  ...
  /** PolicyQuery */
  policyQuery?: V1beta1CloudidentityV1beta1Policy_PolicyQuery | Computed<V1beta1CloudidentityV1beta1Policy_PolicyQuery>;
  /** Setting */
  setting?: V1beta1CloudidentityV1beta1Policy_Setting | Computed<V1beta1CloudidentityV1beta1Policy_Setting>;
  /** Output only. The type of the policy. */
  type?: string | Computed<string>;
}

export interface V1beta1CloudidentityV1beta1PolicyAttrs {
  /** Immutable. Customer that the Policy belongs to. The value is in the format 'customers/{customerId}'. The `customerId` must begin with "C" To find your customer ID in Admin Console see https://support.google.com/a/answer/10070793. */
  customer: string;
  /** Output only. Identifier. The [resource name](https://cloud.google.com/apis/design/resource_names) of the Policy. Format: policies/{policy}. */
  name: string;
  /** PolicyQuery */
  policyQuery: V1beta1CloudidentityV1beta1Policy_PolicyQuery;
  /** Setting */
  setting: V1beta1CloudidentityV1beta1Policy_Setting;
  /** Output only. The type of the policy. */
  type: string;
}

export const V1beta1CloudidentityV1beta1Policy: ResourceBinding<V1beta1CloudidentityV1beta1PolicyConfig, V1beta1CloudidentityV1beta1PolicyAttrs> = {
