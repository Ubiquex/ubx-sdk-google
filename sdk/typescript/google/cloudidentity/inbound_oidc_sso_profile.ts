...
export interface InboundOidcSsoProfile_IdpConfig {
...
export interface InboundOidcSsoProfile_RpConfig {
...
const InboundOidcSsoProfile_IdpConfigFields: FieldMap = {
  changePasswordUri: "change_password_uri",
  issuerUri: "issuer_uri",
};

const InboundOidcSsoProfile_RpConfigFields: FieldMap = {
  clientId: "client_id",
  clientSecret: "client_secret",
  redirectUris: "redirect_uris",
};

export interface InboundOidcSsoProfileConfig {
...
export interface InboundOidcSsoProfileAttrs {
  /** Immutable. The customer. For example: `customers/C0123abc`. */
  customer: string;
  /** Human-readable name of the OIDC SSO profile. */
  displayName: string;
  /** OIDC IDP (identity provider) configuration. */
  idpConfig: InboundOidcSsoProfile_IdpConfig;
  /** Output only. [Resource name](https://cloud.google.com/apis/design/resource_names) of the OIDC SSO profile. */
  name: string;
  /** OIDC RP (relying party) configuration. */
  rpConfig: InboundOidcSsoProfile_RpConfig;
}

export const InboundOidcSsoProfile: ResourceBinding<InboundOidcSsoProfileConfig, InboundOidcSsoProfileAttrs> = {
