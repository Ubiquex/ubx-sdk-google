...
export interface Policy_PolicyQuery {
...
export interface Policy_Setting {
...
const Policy_PolicyQueryFields: FieldMap = {
  group: "group",
  orgUnit: "org_unit",
  query: "query",
...
const Policy_SettingFields: FieldMap = {
  type: "type",
  value: "value",
};
...
export interface PolicyConfig {
  ...
  /** PolicyQuery */
  policyQuery?: Policy_PolicyQuery | Computed<Policy_PolicyQuery>;
  /** Setting */
  setting?: Policy_Setting | Computed<Policy_Setting>;
...
export interface PolicyAttrs {
  ...
  name: string;
  /** PolicyQuery */
  policyQuery: Policy_PolicyQuery;
  /** Setting */
...
export const Policy: ResourceBinding<PolicyConfig, PolicyAttrs> = {
  wireType: "google_cloudidentity_policy",
  fields: {
    customer: "customer",
    name: "name",
    policyQuery: {
