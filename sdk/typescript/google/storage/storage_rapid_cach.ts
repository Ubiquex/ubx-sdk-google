...
export interface StorageRapidCachConfig {
...
export interface StorageRapidCachAttrs {
  /** The cache-level entry admission policy. */
...
export const StorageRapidCach: ResourceBinding<StorageRapidCachConfig, StorageRapidCachAttrs> = {
  wireType: "google_storage_storage_rapid_cach",
  fields: {
