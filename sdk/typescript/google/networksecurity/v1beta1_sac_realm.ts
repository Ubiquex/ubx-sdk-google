...
export interface V1beta1SacRealm_PairingKey {
...
export interface V1beta1SacRealm_SymantecOptions {
...
const V1beta1SacRealm_PairingKeyFields: FieldMap = {
  expireTime: "expire_time",
  key: "key",
};

const V1beta1SacRealm_SymantecOptionsFields: FieldMap = {
...
export interface V1beta1SacRealmAttrs {
  ...
  name: string;
  /** Key to be shared with SSE service provider to establish global handshake. */
  pairingKey: V1beta1SacRealm_PairingKey;
  /** Immutable. SSE service provider associated with the realm. */
  securityService: string;
  /** Output only. State of the realm. */
  state: string;
  /** Fields specific to realms using Symantec Cloud SWG. */
  symantecOptions: V1beta1SacRealm_SymantecOptions;
  /** Output only. Timestamp when the realm was last updated. */
  updateTime: string;
}
