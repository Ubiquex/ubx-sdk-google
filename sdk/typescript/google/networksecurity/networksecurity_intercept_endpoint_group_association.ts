// Code generated by `ubx sdk gen` from google_networksecurity_networksecurity_intercept_endpoint_group_association. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetworksecurityInterceptEndpointGroupAssociation_Locations {
  location?: string | Computed<string>;
  state?: string | Computed<string>;
}

const NetworksecurityInterceptEndpointGroupAssociation_LocationsFields: FieldMap = {
  location: "location",
  state: "state",
};

export interface NetworksecurityInterceptEndpointGroupAssociationConfig {
  ...
  locations?: NetworksecurityInterceptEndpointGroupAssociation_Locations[] | Computed<NetworksecurityInterceptEndpointGroupAssociation_Locations[]>;
  ...
  locationsDetails?: NetworksecurityInterceptEndpointGroupAssociation_Locations[] | Computed<NetworksecurityInterceptEndpointGroupAssociation_Locations[]>;
...
export interface NetworksecurityInterceptEndpointGroupAssociationAttrs {
  /** Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps. */
  createTime: string;
  /** Required. Immutable. The endpoint group that this association is connected to, for example: `projects/123456789/locations/global/interceptEndpointGroups/my-eg`. See https://google.aip.dev/124. */
  ...
  /** Output only. The list of locations where the association is configured. This information is retrieved from the linked endpoint group. */
  locations: NetworksecurityInterceptEndpointGroupAssociation_Locations[];
  /** Output only. The list of locations where the association is present. This information is retrieved from the linked endpoint group, and not configured as part of the association itself. */
  locationsDetails: NetworksecurityInterceptEndpointGroupAssociation_Locations[];
  /** Immutable. Identifier. The resource name of this endpoint group association, for example: `projects/123456789/locations/global/interceptEndpointGroupAssociations/my-eg-association`. See https://google.aip.dev/122 for more details. */
  name: string;
  /** Required. Immutable. The VPC network that is associated. for example: `projects/123456789/global/networks/my-network`. See https://google.aip.dev/124. */
  network: string;
...
export const NetworksecurityInterceptEndpointGroupAssociation: ResourceBinding<NetworksecurityInterceptEndpointGroupAssociationConfig, NetworksecurityInterceptEndpointGroupAssociationAttrs> = {
  wireType: "google_networksecurity_networksecurity_intercept_endpoint_group_association",
  fields: {
    ...
    locations: {
      wireName: "locations",
      kind: "list",
      fields: NetworksecurityInterceptEndpointGroupAssociation_LocationsFields,
    },
    locationsDetails: {
