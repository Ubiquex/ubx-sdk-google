// Code generated by `ubx sdk gen` from google_networksecurity_networksecurity_backend_authentication_config. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetworksecurityBackendAuthenticationConfigConfig {
...
export interface NetworksecurityBackendAuthenticationConfigAttrs {
  /** Optional. A reference to a certificatemanager.googleapis.com.Certificate resource. This is a relative resource path following the form "projects/{project}/locations/{location}/certificates/{certificate}". Used by a BackendService to negotiate mTLS when the backend connection uses TLS and the backend requests a client certificate. Must have a CLIENT_AUTH scope. */
...
export const NetworksecurityBackendAuthenticationConfig: ResourceBinding<NetworksecurityBackendAuthenticationConfigConfig, NetworksecurityBackendAuthenticationConfigAttrs> = {
  wireType: "google_networksecurity_networksecurity_backend_authentication_config",
  fields: {
