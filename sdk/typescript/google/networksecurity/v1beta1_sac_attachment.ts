...
export interface V1beta1SacAttachment_SymantecOptions {
...
const V1beta1SacAttachment_SymantecOptionsFields: FieldMap = {
...
export interface V1beta1SacAttachmentAttrs {
  ...
  state: string;
  /** Fields specific to attachments associated with Symantec Cloud SWG. */
  symantecOptions: V1beta1SacAttachment_SymantecOptions;
  /** Optional. Case-sensitive tzinfo identifier used for localization. Only valid for Symantec attachments. */
  timeZone: string;
  /** Output only. Timestamp when the attachment was last updated. */
  updateTime: string;
...
export const V1beta1SacAttachment: ResourceBinding<V1beta1SacAttachmentConfig, V1beta1SacAttachmentAttrs> = {
