// Code generated by `ubx sdk gen` from google_networksecurity_intercept_deployment. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface InterceptDeploymentConfig {
...
export interface InterceptDeploymentAttrs {
  /** Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps. */
  createTime: string;
  /** Optional. User-provided description of the deployment. Used as additional context for the deployment. */
  description: string;
...
export const InterceptDeployment: ResourceBinding<InterceptDeploymentConfig, InterceptDeploymentAttrs> = {
