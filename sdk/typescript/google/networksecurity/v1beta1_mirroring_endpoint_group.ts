...
const V1beta1MirroringEndpointGroup_AssociationsFields: FieldMap = {
  name: "name",
  network: "network",
  state: "state",
};

const V1beta1MirroringEndpointGroup_ConnectedDeploymentGroups_LocationsFields: FieldMap = {
  location: "location",
  state: "state",
};

const V1beta1MirroringEndpointGroup_ConnectedDeploymentGroupsFields: FieldMap = {
  locations: {
    wireName: "locations",
    kind: "list",
...
export interface V1beta1MirroringEndpointGroupConfig {
  ...
  associations?: V1beta1MirroringEndpointGroup_Associations[] | Computed<V1beta1MirroringEndpointGroup_Associations[]>;
  /** Output only. List of details about the connected deployment groups to this endpoint group. */
  connectedDeploymentGroups?: V1beta1MirroringEndpointGroup_ConnectedDeploymentGroups[] | Computed<V1beta1MirroringEndpointGroup_ConnectedDeploymentGroups[]>;
