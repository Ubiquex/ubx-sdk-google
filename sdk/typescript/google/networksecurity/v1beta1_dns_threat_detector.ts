...
export interface V1beta1DnsThreatDetectorConfig {
...
export interface V1beta1DnsThreatDetectorAttrs {
...
export const V1beta1DnsThreatDetector: ResourceBinding<V1beta1DnsThreatDetectorConfig, V1beta1DnsThreatDetectorAttrs> = {
