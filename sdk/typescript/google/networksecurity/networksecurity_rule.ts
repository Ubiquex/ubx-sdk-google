...
export interface NetworksecurityRuleConfig {
...
export interface NetworksecurityRuleAttrs {
  /** Optional. CEL expression for matching on L7/application level criteria. */
...
export const NetworksecurityRule: ResourceBinding<NetworksecurityRuleConfig, NetworksecurityRuleAttrs> = {
