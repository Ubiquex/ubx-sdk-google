// Code generated by `ubx sdk gen` from google_networksecurity_v1beta1_networksecurity_v1beta1_intercept_deployment. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1NetworksecurityV1beta1InterceptDeploymentConfig {
...
export interface V1beta1NetworksecurityV1beta1InterceptDeploymentAttrs {
  /** Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps. */
  createTime: string;
  /** Optional. User-provided description of the deployment. Used as additional context for the deployment. */
  description: string;
...
export const V1beta1NetworksecurityV1beta1InterceptDeployment: ResourceBinding<V1beta1NetworksecurityV1beta1InterceptDeploymentConfig, V1beta1NetworksecurityV1beta1InterceptDeploymentAttrs> = {
  wireType: "google_networksecurity_v1beta1_networksecurity_v1beta1_intercept_deployment",
  fields: {
