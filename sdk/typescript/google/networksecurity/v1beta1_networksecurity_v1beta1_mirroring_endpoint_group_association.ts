// Code generated by `ubx sdk gen` from google_networksecurity_v1beta1_networksecurity_v1beta1_mirroring_endpoint_group_association. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation_Locations {
  location?: string | Computed<string>;
  state?: string | Computed<string>;
}

const V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation_LocationsFields: FieldMap = {
  location: "location",
  state: "state",
};

export interface V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociationConfig {
  ...
  locations?: V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation_Locations[] | Computed<V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation_Locations[]>;
  ...
  locationsDetails?: V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation_Locations[] | Computed<V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation_Locations[]>;
...
export interface V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociationAttrs {
  /** Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps. */
  createTime: string;
  /** Optional. Labels are key/value pairs that help to organize and filter resources. */
  labels: Record<string, string>;
  /** Output only. The list of locations where the association is configured. This information is retrieved from the linked endpoint group. */
  locations: V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation_Locations[];
  /** Output only. The list of locations where the association is present. This information is retrieved from the linked endpoint group, and not configured as part of the association itself. */
  locationsDetails: V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation_Locations[];
  /** Immutable. The endpoint group that this association is connected to, for example: `projects/123456789/locations/global/mirroringEndpointGroups/my-eg`. See https://google.aip.dev/124. */
...
export const V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation: ResourceBinding<V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociationConfig, V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociationAttrs> = {
  wireType: "google_networksecurity_v1beta1_networksecurity_v1beta1_mirroring_endpoint_group_association",
  fields: {
    ...
    locations: {
      wireName: "locations",
      kind: "list",
      fields: V1beta1NetworksecurityV1beta1MirroringEndpointGroupAssociation_LocationsFields,
    },
    locationsDetails: {
