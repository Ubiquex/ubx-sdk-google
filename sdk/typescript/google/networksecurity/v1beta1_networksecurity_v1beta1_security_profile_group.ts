// Code generated by `ubx sdk gen` from google_networksecurity_v1beta1_networksecurity_v1beta1_security_profile_group. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1NetworksecurityV1beta1SecurityProfileGroupConfig {
  ...
  wildfireAnalysisProfile?: string | Computed<string>;
}

export interface V1beta1NetworksecurityV1beta1SecurityProfileGroupAttrs {
  /** Output only. Resource creation timestamp. */
  createTime: string;
  /** Optional. Reference to a SecurityProfile with the CustomIntercept configuration. */
...
export const V1beta1NetworksecurityV1beta1SecurityProfileGroup: ResourceBinding<V1beta1NetworksecurityV1beta1SecurityProfileGroupConfig, V1beta1NetworksecurityV1beta1SecurityProfileGroupAttrs> = {
  wireType: "google_networksecurity_v1beta1_networksecurity_v1beta1_security_profile_group",
  fields: {
    ...
    wildfireAnalysisProfile: "wildfire_analysis_profile",
  },
};
