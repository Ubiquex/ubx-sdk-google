...
export interface MirroringDeploymentConfig {
...
export interface MirroringDeploymentAttrs {
...
export const MirroringDeployment: ResourceBinding<MirroringDeploymentConfig, MirroringDeploymentAttrs> = {
