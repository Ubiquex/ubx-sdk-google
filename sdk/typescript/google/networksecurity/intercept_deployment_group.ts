...
const InterceptDeploymentGroup_ConnectedEndpointGroupsFields: FieldMap = {
  name: "name",
};

const InterceptDeploymentGroup_LocationsFields: FieldMap = {
  location: "location",
  state: "state",
};

const InterceptDeploymentGroup_NestedDeploymentsFields: FieldMap = {
  name: "name",
  state: "state",
};
...
export interface InterceptDeploymentGroupConfig {
  ...
  connectedEndpointGroups?: InterceptDeploymentGroup_ConnectedEndpointGroups[] | Computed<InterceptDeploymentGroup_ConnectedEndpointGroups[]>;
  ...
  locations?: InterceptDeploymentGroup_Locations[] | Computed<InterceptDeploymentGroup_Locations[]>;
  ...
  nestedDeployments?: InterceptDeploymentGroup_NestedDeployments[] | Computed<InterceptDeploymentGroup_NestedDeployments[]>;
