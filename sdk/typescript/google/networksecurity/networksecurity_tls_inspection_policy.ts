// Code generated by `ubx sdk gen` from google_networksecurity_networksecurity_tls_inspection_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetworksecurityTlsInspectionPolicyConfig {
...
export interface NetworksecurityTlsInspectionPolicyAttrs {
  /** Required. A CA pool resource used to issue interception certificates. The CA pool string has a relative resource path following the form "projects/{project}/locations/{location}/caPools/{ca_pool}". */
  caPool: string;
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
...
export const NetworksecurityTlsInspectionPolicy: ResourceBinding<NetworksecurityTlsInspectionPolicyConfig, NetworksecurityTlsInspectionPolicyAttrs> = {
  wireType: "google_networksecurity_networksecurity_tls_inspection_policy",
  fields: {
    caPool: "ca_pool",
