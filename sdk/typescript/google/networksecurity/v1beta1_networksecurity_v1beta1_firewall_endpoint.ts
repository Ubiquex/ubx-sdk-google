// Code generated by `ubx sdk gen` from google_networksecurity_v1beta1_networksecurity_v1beta1_firewall_endpoint. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1NetworksecurityV1beta1FirewallEndpoint_Associations {
  name?: string | Computed<string>;
  network?: string | Computed<string>;
}

export interface V1beta1NetworksecurityV1beta1FirewallEndpoint_EndpointSettings {
...
export interface V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings_WildfireInlineCloudAnalysisSettings {
...
export interface V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings {
  ...
  wildfireInlineCloudAnalysisSettings?: V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings_WildfireInlineCloudAnalysisSettings | Computed<V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings_WildfireInlineCloudAnalysisSettings>;
...
const V1beta1NetworksecurityV1beta1FirewallEndpoint_AssociationsFields: FieldMap = {
  name: "name",
  network: "network",
};

const V1beta1NetworksecurityV1beta1FirewallEndpoint_EndpointSettingsFields: FieldMap = {
...
const V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings_WildfireInlineCloudAnalysisSettingsFields: FieldMap = {
...
const V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettingsFields: FieldMap = {
  enabled: "enabled",
  wildfireInlineCloudAnalysisSettings: {
    wireName: "wildfire_inline_cloud_analysis_settings",
    kind: "object",
    fields: V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings_WildfireInlineCloudAnalysisSettingsFields,
  },
...
export interface V1beta1NetworksecurityV1beta1FirewallEndpointConfig {
  ...
  associations?: V1beta1NetworksecurityV1beta1FirewallEndpoint_Associations[] | Computed<V1beta1NetworksecurityV1beta1FirewallEndpoint_Associations[]>;
  ...
  endpointSettings?: V1beta1NetworksecurityV1beta1FirewallEndpoint_EndpointSettings | Computed<V1beta1NetworksecurityV1beta1FirewallEndpoint_EndpointSettings>;
  ...
  wildfireSettings?: V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings | Computed<V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings>;
}

export interface V1beta1NetworksecurityV1beta1FirewallEndpointAttrs {
  /** Output only. Deprecated: List of networks that are associated with this endpoint in the local zone. This is a projection of the FirewallEndpointAssociations pointing at this endpoint. A network will only appear in this list after traffic routing is fully configured. Format: projects/{project}/global/networks/{name}. */
  associatedNetworks: string[];
  /** Output only. List of FirewallEndpointAssociations that are associated to this endpoint. An association will only appear in this list after traffic routing is fully configured. */
  associations: V1beta1NetworksecurityV1beta1FirewallEndpoint_Associations[];
  /** Optional. Project to charge for the deployed firewall endpoint. This field must be specified when creating the endpoint in the organization scope, and should be omitted otherwise. */
  ...
  description: string;
  /** Settings for the endpoint. */
  endpointSettings: V1beta1NetworksecurityV1beta1FirewallEndpoint_EndpointSettings;
  /** Optional. Labels as key value pairs */
  ...
  updateTime: string;
  /** Settings for WildFire analysis. */
  wildfireSettings: V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings;
}

export const V1beta1NetworksecurityV1beta1FirewallEndpoint: ResourceBinding<V1beta1NetworksecurityV1beta1FirewallEndpointConfig, V1beta1NetworksecurityV1beta1FirewallEndpointAttrs> = {
  wireType: "google_networksecurity_v1beta1_networksecurity_v1beta1_firewall_endpoint",
  fields: {
    associatedNetworks: "associated_networks",
    associations: {
      wireName: "associations",
      kind: "list",
      fields: V1beta1NetworksecurityV1beta1FirewallEndpoint_AssociationsFields,
    },
    ...
    endpointSettings: {
      ...
      kind: "object",
      fields: V1beta1NetworksecurityV1beta1FirewallEndpoint_EndpointSettingsFields,
    },
    labels: "labels",
    name: "name",
    ...
    wildfireSettings: {
      ...
      kind: "object",
      fields: V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettingsFields,
    },
  },
};
