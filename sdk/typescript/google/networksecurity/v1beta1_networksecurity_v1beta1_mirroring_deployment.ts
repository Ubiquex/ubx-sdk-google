// Code generated by `ubx sdk gen` from google_networksecurity_v1beta1_networksecurity_v1beta1_mirroring_deployment. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1NetworksecurityV1beta1MirroringDeploymentConfig {
...
export interface V1beta1NetworksecurityV1beta1MirroringDeploymentAttrs {
  /** Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps. */
  createTime: string;
  /** Optional. User-provided description of the deployment. Used as additional context for the deployment. */
  description: string;
...
export const V1beta1NetworksecurityV1beta1MirroringDeployment: ResourceBinding<V1beta1NetworksecurityV1beta1MirroringDeploymentConfig, V1beta1NetworksecurityV1beta1MirroringDeploymentAttrs> = {
  wireType: "google_networksecurity_v1beta1_networksecurity_v1beta1_mirroring_deployment",
  fields: {
