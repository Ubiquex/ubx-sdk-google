// Code generated by `ubx sdk gen` from google_networksecurity_networksecurity_security_profile_group. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetworksecuritySecurityProfileGroupConfig {
...
export interface NetworksecuritySecurityProfileGroupAttrs {
  /** Output only. Resource creation timestamp. */
  createTime: string;
  /** Optional. Reference to a SecurityProfile with the CustomIntercept configuration. */
...
export const NetworksecuritySecurityProfileGroup: ResourceBinding<NetworksecuritySecurityProfileGroupConfig, NetworksecuritySecurityProfileGroupAttrs> = {
  wireType: "google_networksecurity_networksecurity_security_profile_group",
  fields: {
