...
export interface ArtifactregistryAttachmentConfig {
...
export interface ArtifactregistryAttachmentAttrs {
  /** Optional. User annotations. These attributes can only be set and used by the user, and not by Artifact Registry. See https://google.aip.dev/128#annotations for more details such as format and size limitations. */
...
export const ArtifactregistryAttachment: ResourceBinding<ArtifactregistryAttachmentConfig, ArtifactregistryAttachmentAttrs> = {
