// Code generated by `ubx sdk gen` from google_networkmanagement_networkmanagement_vpc_flow_logs_config. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface NetworkmanagementVpcFlowLogsConfigConfig {
...
export interface NetworkmanagementVpcFlowLogsConfigAttrs {
  /** Optional. The aggregation interval for the logs. Default value is INTERVAL_5_SEC. */
...
export const NetworkmanagementVpcFlowLogsConfig: ResourceBinding<NetworkmanagementVpcFlowLogsConfigConfig, NetworkmanagementVpcFlowLogsConfigAttrs> = {
  wireType: "google_networkmanagement_networkmanagement_vpc_flow_logs_config",
  fields: {
