// Code generated by `ubx sdk gen` from google_networkmanagement_vpc_flow_logs_config. DO NOT EDIT.
...
export interface VpcFlowLogsConfigAttrs {
  /** Optional. The aggregation interval for the logs. Default value is INTERVAL_5_SEC. */
...
export const VpcFlowLogsConfig: ResourceBinding<VpcFlowLogsConfigConfig, VpcFlowLogsConfigAttrs> = {
