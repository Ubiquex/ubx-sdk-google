...
const V1betaWorkstationCluster_GatewayConfigFields: FieldMap = {
  http2Enabled: "http2_enabled",
};

const V1betaWorkstationCluster_PrivateClusterConfigFields: FieldMap = {
...
export interface V1betaWorkstationClusterConfig {
  ...
  domainConfig?: V1betaWorkstationCluster_DomainConfig | Computed<V1betaWorkstationCluster_DomainConfig>;
  /** Optional. Checksum computed by the server. May be sent on update and delete requests to make sure that the client has an up-to-date value before proceeding. */
  etag?: string | Computed<string>;
  /** Configuration options for Cluster HTTP Gateway. */
  gatewayConfig?: V1betaWorkstationCluster_GatewayConfig | Computed<V1betaWorkstationCluster_GatewayConfig>;
...
export interface V1betaWorkstationClusterAttrs {
  /** Optional. Client-specified annotations. */
  ...
  displayName: string;
  /** Configuration options for a custom domain. */
  domainConfig: V1betaWorkstationCluster_DomainConfig;
  /** Optional. Checksum computed by the server. May be sent on update and delete requests to make sure that the client has an up-to-date value before proceeding. */
  etag: string;
  /** Configuration options for Cluster HTTP Gateway. */
  gatewayConfig: V1betaWorkstationCluster_GatewayConfig;
  /** Optional. [Labels](https://cloud.google.com/workstations/docs/label-resources) that are applied to the workstation cluster and that are also propagated to the underlying Compute Engine resources. */
  ...
  network: string;
  /** Configuration options for private workstation clusters. */
  privateClusterConfig: V1betaWorkstationCluster_PrivateClusterConfig;
...
export const V1betaWorkstationCluster: ResourceBinding<V1betaWorkstationClusterConfig, V1betaWorkstationClusterAttrs> = {
