...
const V1betaWorkstationConfig_ConditionsFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};
...
export interface V1betaWorkstationConfigConfig {
  ...
  conditions?: V1betaWorkstationConfig_Conditions[] | Computed<V1betaWorkstationConfig_Conditions[]>;
  /** A Docker container. */
...
export const V1betaWorkstationConfig: ResourceBinding<V1betaWorkstationConfigConfig, V1betaWorkstationConfigAttrs> = {
  ...
  fields: {
    ...
    conditions: {
      wireName: "conditions",
      kind: "list",
      fields: V1betaWorkstationConfig_ConditionsFields,
    },
    container: {
      wireName: "container",
      kind: "object",
