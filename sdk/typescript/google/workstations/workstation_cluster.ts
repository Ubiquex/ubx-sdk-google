...
const WorkstationCluster_ConditionsFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};
...
export interface WorkstationClusterConfig {
  ...
  conditions?: WorkstationCluster_Conditions[] | Computed<WorkstationCluster_Conditions[]>;
...
export const WorkstationCluster: ResourceBinding<WorkstationClusterConfig, WorkstationClusterAttrs> = {
  ...
  fields: {
    ...
    conditions: {
      wireName: "conditions",
      kind: "list",
      fields: WorkstationCluster_ConditionsFields,
    },
