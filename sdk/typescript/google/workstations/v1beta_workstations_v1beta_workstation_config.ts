...
export interface V1betaWorkstationsV1betaWorkstationConfig_AllowedPorts {
  first?: number | Computed<number>;
  last?: number | Computed<number>;
}

export interface V1betaWorkstationsV1betaWorkstationConfig_Conditions {
  code?: number | Computed<number>;
  details?: Record<string, unknown>[] | Computed<Record<string, unknown>[]>;
  message?: string | Computed<string>;
}

export interface V1betaWorkstationsV1betaWorkstationConfig_Container {
...
export interface V1betaWorkstationsV1betaWorkstationConfig_EncryptionKey {
...
export interface V1betaWorkstationsV1betaWorkstationConfig_EphemeralDirectories_GcePd {
...
export interface V1betaWorkstationsV1betaWorkstationConfig_EphemeralDirectories {
  gcePd?: V1betaWorkstationsV1betaWorkstationConfig_EphemeralDirectories_GcePd | Computed<V1betaWorkstationsV1betaWorkstationConfig_EphemeralDirectories_GcePd>;
  mountPath?: string | Computed<string>;
}

export interface V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_Accelerators {
  count?: number | Computed<number>;
  type?: string | Computed<string>;
}

export interface V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_BoostConfigs_ReservationAffinity {
  consumeReservationType?: string | Computed<string>;
  key?: string | Computed<string>;
  values?: string[] | Computed<string[]>;
}

export interface V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_BoostConfigs {
  accelerators?: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_Accelerators[] | Computed<V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_Accelerators[]>;
  ...
  reservationAffinity?: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_BoostConfigs_ReservationAffinity | Computed<V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_BoostConfigs_ReservationAffinity>;
}

export interface V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_ConfidentialInstanceConfig {
  /** Optional. Whether the instance has confidential compute enabled. */
  enableConfidentialCompute?: boolean | Computed<boolean>;
}

export interface V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_ShieldedInstanceConfig {
...
export interface V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance {
  ...
  boostConfigs?: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_BoostConfigs[] | Computed<V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_BoostConfigs[]>;
  ...
  confidentialInstanceConfig?: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_ConfidentialInstanceConfig | Computed<V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_ConfidentialInstanceConfig>;
  ...
  shieldedInstanceConfig?: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_ShieldedInstanceConfig | Computed<V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_ShieldedInstanceConfig>;
...
export interface V1betaWorkstationsV1betaWorkstationConfig_Host {
  /** A runtime using a Compute Engine instance. */
  gceInstance?: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance | Computed<V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance>;
}

export interface V1betaWorkstationsV1betaWorkstationConfig_HttpOptions {
...
export interface V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories_GceHd {
...
export interface V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories_GcePd {
  archiveTimeout?: string | Computed<string>;
  diskType?: string | Computed<string>;
...
export interface V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories {
  gceHd?: V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories_GceHd | Computed<V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories_GceHd>;
  gcePd?: V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories_GcePd | Computed<V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories_GcePd>;
  mountPath?: string | Computed<string>;
}

export interface V1betaWorkstationsV1betaWorkstationConfig_ReadinessChecks {
  path?: string | Computed<string>;
  port?: number | Computed<number>;
}

const V1betaWorkstationsV1betaWorkstationConfig_AllowedPortsFields: FieldMap = {
  first: "first",
  last: "last",
};

const V1betaWorkstationsV1betaWorkstationConfig_ConditionsFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const V1betaWorkstationsV1betaWorkstationConfig_ContainerFields: FieldMap = {
  args: "args",
  command: "command",
  env: "env",
  image: "image",
...
const V1betaWorkstationsV1betaWorkstationConfig_EncryptionKeyFields: FieldMap = {
  kmsKey: "kms_key",
  kmsKeyServiceAccount: "kms_key_service_account",
};

const V1betaWorkstationsV1betaWorkstationConfig_EphemeralDirectories_GcePdFields: FieldMap = {
  diskType: "disk_type",
  readOnly: "read_only",
...
const V1betaWorkstationsV1betaWorkstationConfig_EphemeralDirectoriesFields: FieldMap = {
  gcePd: {
    wireName: "gce_pd",
    kind: "object",
    fields: V1betaWorkstationsV1betaWorkstationConfig_EphemeralDirectories_GcePdFields,
  },
  mountPath: "mount_path",
};

const V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_AcceleratorsFields: FieldMap = {
  count: "count",
  type: "type",
};

const V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_BoostConfigs_ReservationAffinityFields: FieldMap = {
  consumeReservationType: "consume_reservation_type",
  key: "key",
  values: "values",
};

const V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_BoostConfigsFields: FieldMap = {
  accelerators: {
    wireName: "accelerators",
    kind: "list",
    fields: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_AcceleratorsFields,
  },
  ...
  reservationAffinity: {
    ...
    kind: "object",
    fields: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_BoostConfigs_ReservationAffinityFields,
  },
};

const V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_ConfidentialInstanceConfigFields: FieldMap = {
  enableConfidentialCompute: "enable_confidential_compute",
};

const V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_ShieldedInstanceConfigFields: FieldMap = {
  enableIntegrityMonitoring: "enable_integrity_monitoring",
  enableSecureBoot: "enable_secure_boot",
  enableVtpm: "enable_vtpm",
};

const V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstanceFields: FieldMap = {
  accelerators: {
    wireName: "accelerators",
    kind: "list",
    fields: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_AcceleratorsFields,
  ...
  boostConfigs: {
    ...
    kind: "list",
    fields: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_BoostConfigsFields,
  },
  bootDiskSizeGb: "boot_disk_size_gb",
  confidentialInstanceConfig: {
    wireName: "confidential_instance_config",
    kind: "object",
    fields: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_ConfidentialInstanceConfigFields,
  },
  ...
  shieldedInstanceConfig: {
    ...
    kind: "object",
    fields: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstance_ShieldedInstanceConfigFields,
  },
...
const V1betaWorkstationsV1betaWorkstationConfig_HostFields: FieldMap = {
  gceInstance: {
    wireName: "gce_instance",
    kind: "object",
    fields: V1betaWorkstationsV1betaWorkstationConfig_Host_GceInstanceFields,
  },
};

const V1betaWorkstationsV1betaWorkstationConfig_HttpOptionsFields: FieldMap = {
...
const V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories_GceHdFields: FieldMap = {
...
const V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories_GcePdFields: FieldMap = {
  archiveTimeout: "archive_timeout",
  diskType: "disk_type",
  fsType: "fs_type",
  maxSizeGb: "max_size_gb",
...
const V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectoriesFields: FieldMap = {
  gceHd: {
    wireName: "gce_hd",
    kind: "object",
    fields: V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories_GceHdFields,
  },
  gcePd: {
    wireName: "gce_pd",
    kind: "object",
    fields: V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories_GcePdFields,
  },
  mountPath: "mount_path",
};

const V1betaWorkstationsV1betaWorkstationConfig_ReadinessChecksFields: FieldMap = {
  path: "path",
  port: "port",
};

export interface V1betaWorkstationsV1betaWorkstationConfigConfig {
  ...
  allowedPorts?: V1betaWorkstationsV1betaWorkstationConfig_AllowedPorts[] | Computed<V1betaWorkstationsV1betaWorkstationConfig_AllowedPorts[]>;
  /** Optional. Client-specified annotations. */
  annotations?: Record<string, string> | Computed<Record<string, string>>;
  /** Output only. Status conditions describing the workstation configuration's current state. */
  conditions?: V1betaWorkstationsV1betaWorkstationConfig_Conditions[] | Computed<V1betaWorkstationsV1betaWorkstationConfig_Conditions[]>;
  /** A Docker container. */
  container?: V1betaWorkstationsV1betaWorkstationConfig_Container | Computed<V1betaWorkstationsV1betaWorkstationConfig_Container>;
  ...
  encryptionKey?: V1betaWorkstationsV1betaWorkstationConfig_EncryptionKey | Computed<V1betaWorkstationsV1betaWorkstationConfig_EncryptionKey>;
  /** Optional. Ephemeral directories which won't persist across workstation sessions. */
  ephemeralDirectories?: V1betaWorkstationsV1betaWorkstationConfig_EphemeralDirectories[] | Computed<V1betaWorkstationsV1betaWorkstationConfig_EphemeralDirectories[]>;
  ...
  host?: V1betaWorkstationsV1betaWorkstationConfig_Host | Computed<V1betaWorkstationsV1betaWorkstationConfig_Host>;
  /** HTTP options for the running workstations. */
  httpOptions?: V1betaWorkstationsV1betaWorkstationConfig_HttpOptions | Computed<V1betaWorkstationsV1betaWorkstationConfig_HttpOptions>;
  ...
  persistentDirectories?: V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories[] | Computed<V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories[]>;
  /** Optional. Readiness checks to perform when starting a workstation using this workstation configuration. Mark a workstation as running only after all specified readiness checks return 200 status codes. */
  readinessChecks?: V1betaWorkstationsV1betaWorkstationConfig_ReadinessChecks[] | Computed<V1betaWorkstationsV1betaWorkstationConfig_ReadinessChecks[]>;
...
export interface V1betaWorkstationsV1betaWorkstationConfigAttrs {
  /** Optional. A list of PortRanges specifying single ports or ranges of ports that are externally accessible in the workstation. Allowed ports must be one of 22, 80, or within range 1024-65535. If not specified defaults to ports 22, 80, and ports 1024-65535. */
  allowedPorts: V1betaWorkstationsV1betaWorkstationConfig_AllowedPorts[];
  /** Optional. Client-specified annotations. */
  annotations: Record<string, string>;
  /** Output only. Status conditions describing the workstation configuration's current state. */
  conditions: V1betaWorkstationsV1betaWorkstationConfig_Conditions[];
  /** A Docker container. */
  container: V1betaWorkstationsV1betaWorkstationConfig_Container;
  /** Output only. Time when this workstation configuration was created. */
  createTime: string;
  /** Output only. Whether this workstation configuration is in degraded mode, in which case it may require user action to restore full functionality. The conditions field contains detailed information about the status of the configuration. */
  degraded: boolean;
  ...
  /** A customer-managed encryption key (CMEK) for the Compute Engine resources of the associated workstation configuration. Specify the name of your Cloud KMS encryption key and the default service account. We recommend that you use a separate service account and follow [Cloud KMS best practices](https://cloud.google.com/kms/docs/separation-of-duties). */
  encryptionKey: V1betaWorkstationsV1betaWorkstationConfig_EncryptionKey;
  /** Optional. Ephemeral directories which won't persist across workstation sessions. */
  ephemeralDirectories: V1betaWorkstationsV1betaWorkstationConfig_EphemeralDirectories[];
  /** Optional. Checksum computed by the server. May be sent on update and delete requests to make sure that the client has an up-to-date value before proceeding. */
  etag: string;
  /** Optional. Grant creator of a workstation `roles/workstations.policyAdmin` role along with `roles/workstations.user` role on the workstation created by them. This allows workstation users to share access to either their entire workstation, or individual ports. Defaults to false. */
  grantWorkstationAdminRoleOnCreate: boolean;
  /** Runtime host for a workstation. */
  host: V1betaWorkstationsV1betaWorkstationConfig_Host;
  /** HTTP options for the running workstations. */
  httpOptions: V1betaWorkstationsV1betaWorkstationConfig_HttpOptions;
  /** Optional. The action to take when the workstation has been idle for the duration specified in idle_timeout. Defaults to STOP. */
  idleAction: string;
  /** Optional. Number of seconds to wait before automatically stopping a workstation after it last received user traffic. A value of `"0s"` indicates that Cloud Workstations VMs created with this configuration should never time out due to idleness. Provide [duration](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#duration) terminated by `s` for seconds—for example, `"7200s"` (2 hours). The default is `"1200s"` (20 minutes). */
  idleTimeout: string;
  ...
  name: string;
  /** Optional. Directories to persist across workstation sessions. */
  persistentDirectories: V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectories[];
  /** Optional. Readiness checks to perform when starting a workstation using this workstation configuration. Mark a workstation as running only after all specified readiness checks return 200 status codes. */
  readinessChecks: V1betaWorkstationsV1betaWorkstationConfig_ReadinessChecks[];
  /** Output only. Indicates whether this workstation configuration is currently being updated to match its intended state. */
  reconciling: boolean;
  /** Optional. Immutable. Specifies the zones used to replicate the VM and disk resources within the region. If set, exactly two zones within the workstation cluster's region must be specified—for example, `['us-central1-a', 'us-central1-f']`. If this field is empty, two default zones within the region are used. Immutable after the workstation configuration is created. */
  replicaZones: string[];
...
export const V1betaWorkstationsV1betaWorkstationConfig: ResourceBinding<V1betaWorkstationsV1betaWorkstationConfigConfig, V1betaWorkstationsV1betaWorkstationConfigAttrs> = {
  wireType: "google_workstations_v1beta_workstations_v1beta_workstation_config",
  fields: {
    allowedPorts: {
      wireName: "allowed_ports",
      kind: "list",
      fields: V1betaWorkstationsV1betaWorkstationConfig_AllowedPortsFields,
    },
    annotations: "annotations",
    conditions: {
      wireName: "conditions",
      kind: "list",
      fields: V1betaWorkstationsV1betaWorkstationConfig_ConditionsFields,
    },
    container: {
      wireName: "container",
      kind: "object",
      fields: V1betaWorkstationsV1betaWorkstationConfig_ContainerFields,
    },
    ...
    encryptionKey: {
      ...
      kind: "object",
      fields: V1betaWorkstationsV1betaWorkstationConfig_EncryptionKeyFields,
    },
    ephemeralDirectories: {
      wireName: "ephemeral_directories",
      kind: "list",
      fields: V1betaWorkstationsV1betaWorkstationConfig_EphemeralDirectoriesFields,
    },
    etag: "etag",
    ...
    host: {
      wireName: "host",
      kind: "object",
      fields: V1betaWorkstationsV1betaWorkstationConfig_HostFields,
    },
    httpOptions: {
      wireName: "http_options",
      kind: "object",
      fields: V1betaWorkstationsV1betaWorkstationConfig_HttpOptionsFields,
    },
    ...
    persistentDirectories: {
      ...
      kind: "list",
      fields: V1betaWorkstationsV1betaWorkstationConfig_PersistentDirectoriesFields,
    },
    readinessChecks: {
      wireName: "readiness_checks",
      kind: "list",
      fields: V1betaWorkstationsV1betaWorkstationConfig_ReadinessChecksFields,
    },
