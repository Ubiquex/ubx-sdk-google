// Code generated by `ubx sdk gen` from google_workstations_workstations_workstation_cluster. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface WorkstationsWorkstationCluster_Conditions {
  code?: number | Computed<number>;
  details?: Record<string, unknown>[] | Computed<Record<string, unknown>[]>;
  message?: string | Computed<string>;
}

export interface WorkstationsWorkstationCluster_DomainConfig {
  /** Immutable. Domain used by Workstations for HTTP ingress. */
  domain?: string | Computed<string>;
}

export interface WorkstationsWorkstationCluster_GatewayConfig {
  /** Optional. Whether HTTP/2 is enabled for this workstation cluster. Defaults to false. */
  http2Enabled?: boolean | Computed<boolean>;
}

export interface WorkstationsWorkstationCluster_PrivateClusterConfig {
...
const WorkstationsWorkstationCluster_ConditionsFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const WorkstationsWorkstationCluster_DomainConfigFields: FieldMap = {
  domain: "domain",
};

const WorkstationsWorkstationCluster_GatewayConfigFields: FieldMap = {
  http2Enabled: "http2_enabled",
};

const WorkstationsWorkstationCluster_PrivateClusterConfigFields: FieldMap = {
...
export interface WorkstationsWorkstationClusterConfig {
  /** Optional. Client-specified annotations. */
  annotations?: Record<string, string> | Computed<Record<string, string>>;
  /** Output only. Status conditions describing the workstation cluster's current state. */
  conditions?: WorkstationsWorkstationCluster_Conditions[] | Computed<WorkstationsWorkstationCluster_Conditions[]>;
  ...
  domainConfig?: WorkstationsWorkstationCluster_DomainConfig | Computed<WorkstationsWorkstationCluster_DomainConfig>;
  /** Optional. Checksum computed by the server. May be sent on update and delete requests to make sure that the client has an up-to-date value before proceeding. */
  etag?: string | Computed<string>;
  /** Configuration options for Cluster HTTP Gateway. */
  gatewayConfig?: WorkstationsWorkstationCluster_GatewayConfig | Computed<WorkstationsWorkstationCluster_GatewayConfig>;
  ...
  privateClusterConfig?: WorkstationsWorkstationCluster_PrivateClusterConfig | Computed<WorkstationsWorkstationCluster_PrivateClusterConfig>;
...
export interface WorkstationsWorkstationClusterAttrs {
  /** Optional. Client-specified annotations. */
  annotations: Record<string, string>;
  /** Output only. Status conditions describing the workstation cluster's current state. */
  conditions: WorkstationsWorkstationCluster_Conditions[];
  /** Output only. The private IP address of the control plane for this workstation cluster. Workstation VMs need access to this IP address to work with the service, so make sure that your firewall rules allow egress from the workstation VMs to this address. */
  ...
  displayName: string;
  /** Configuration options for a custom domain. */
  domainConfig: WorkstationsWorkstationCluster_DomainConfig;
  /** Optional. Checksum computed by the server. May be sent on update and delete requests to make sure that the client has an up-to-date value before proceeding. */
  etag: string;
  /** Configuration options for Cluster HTTP Gateway. */
  gatewayConfig: WorkstationsWorkstationCluster_GatewayConfig;
  /** Optional. [Labels](https://cloud.google.com/workstations/docs/label-resources) that are applied to the workstation cluster and that are also propagated to the underlying Compute Engine resources. */
  ...
  network: string;
  /** Configuration options for private workstation clusters. */
  privateClusterConfig: WorkstationsWorkstationCluster_PrivateClusterConfig;
  /** Output only. Indicates whether this workstation cluster is currently being updated to match its intended state. */
  reconciling: boolean;
  /** Immutable. Name of the Compute Engine subnetwork in which instances associated with this workstation cluster will be created. Must be part of the subnetwork specified for this workstation cluster. */
  subnetwork: string;
...
export const WorkstationsWorkstationCluster: ResourceBinding<WorkstationsWorkstationClusterConfig, WorkstationsWorkstationClusterAttrs> = {
  wireType: "google_workstations_workstations_workstation_cluster",
  fields: {
    annotations: "annotations",
    conditions: {
      wireName: "conditions",
      kind: "list",
      fields: WorkstationsWorkstationCluster_ConditionsFields,
    },
    ...
    domainConfig: {
      ...
      kind: "object",
      fields: WorkstationsWorkstationCluster_DomainConfigFields,
    },
    etag: "etag",
    gatewayConfig: {
      wireName: "gateway_config",
      kind: "object",
      fields: WorkstationsWorkstationCluster_GatewayConfigFields,
    },
    labels: "labels",
    name: "name",
    network: "network",
    privateClusterConfig: {
      ...
      kind: "object",
      fields: WorkstationsWorkstationCluster_PrivateClusterConfigFields,
    },
