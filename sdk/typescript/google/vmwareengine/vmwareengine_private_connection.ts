...
export interface VmwareenginePrivateConnectionConfig {
...
export interface VmwareenginePrivateConnectionAttrs {
  /** Output only. Creation time of this resource. */
  createTime: string;
  /** Optional. User-provided description for this private connection. */
  description: string;
...
export const VmwareenginePrivateConnection: ResourceBinding<VmwareenginePrivateConnectionConfig, VmwareenginePrivateConnectionAttrs> = {
