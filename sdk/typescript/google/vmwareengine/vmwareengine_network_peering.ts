...
export interface VmwareengineNetworkPeeringConfig {
...
export interface VmwareengineNetworkPeeringAttrs {
  /** Output only. Creation time of this resource. */
  createTime: string;
  /** Optional. User-provided description for this network peering. */
  description: string;
...
export const VmwareengineNetworkPeering: ResourceBinding<VmwareengineNetworkPeeringConfig, VmwareengineNetworkPeeringAttrs> = {
  wireType: "google_vmwareengine_vmwareengine_network_peering",
  fields: {
