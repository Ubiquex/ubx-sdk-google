// Code generated by `ubx sdk gen` from google_vmwareengine_vmwareengine_management_dns_zone_binding. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface VmwareengineManagementDnsZoneBindingConfig {
...
export interface VmwareengineManagementDnsZoneBindingAttrs {
  /** Output only. Creation time of this resource. */
  createTime: string;
  /** User-provided description for this resource. */
  description: string;
...
export const VmwareengineManagementDnsZoneBinding: ResourceBinding<VmwareengineManagementDnsZoneBindingConfig, VmwareengineManagementDnsZoneBindingAttrs> = {
  wireType: "google_vmwareengine_vmwareengine_management_dns_zone_binding",
  fields: {
