...
export interface V1beta1Share_NfsExportOptions {
...
const V1beta1Share_NfsExportOptionsFields: FieldMap = {
...
export interface V1beta1ShareAttrs {
  ...
  name: string;
  /** Nfs Export Options. There is a limit of 10 export options per file share. */
  nfsExportOptions: V1beta1Share_NfsExportOptions[];
  /** Output only. The share state. */
  state: string;
}

export const V1beta1Share: ResourceBinding<V1beta1ShareConfig, V1beta1ShareAttrs> = {
