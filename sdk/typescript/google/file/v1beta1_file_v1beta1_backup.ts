...
export interface V1beta1FileV1beta1BackupConfig {
...
export interface V1beta1FileV1beta1BackupAttrs {
  /** Output only. Capacity of the source file share when the backup was created. */
  capacityGb: string;
  /** Output only. The time when the backup was created. */
  createTime: string;
...
export const V1beta1FileV1beta1Backup: ResourceBinding<V1beta1FileV1beta1BackupConfig, V1beta1FileV1beta1BackupAttrs> = {
