...
export interface V1beta1Instance_DirectoryServices_Ldap {
...
export interface V1beta1Instance_DirectoryServices_ManagedActiveDirectory {
...
export interface V1beta1Instance_DirectoryServices {
  /** LdapConfig contains all the parameters for connecting to LDAP servers. */
  ldap?: V1beta1Instance_DirectoryServices_Ldap | Computed<V1beta1Instance_DirectoryServices_Ldap>;
  ...
  managedActiveDirectory?: V1beta1Instance_DirectoryServices_ManagedActiveDirectory | Computed<V1beta1Instance_DirectoryServices_ManagedActiveDirectory>;
}

export interface V1beta1Instance_FileShares_NfsExportOptions {
...
export interface V1beta1Instance_FileShares_RestoreConfig {
  pathPatterns?: string[] | Computed<string[]>;
}

export interface V1beta1Instance_FileShares {
  capacityGb?: string | Computed<string>;
  name?: string | Computed<string>;
  nfsExportOptions?: V1beta1Instance_FileShares_NfsExportOptions[] | Computed<V1beta1Instance_FileShares_NfsExportOptions[]>;
  restoreConfig?: V1beta1Instance_FileShares_RestoreConfig | Computed<V1beta1Instance_FileShares_RestoreConfig>;
...
export interface V1beta1Instance_Networks {
  ...
  network?: string | Computed<string>;
  pscConfig?: V1beta1Instance_Networks_PscConfig | Computed<V1beta1Instance_Networks_PscConfig>;
  reservedIpRange?: string | Computed<string>;
}

export interface V1beta1Instance_PerformanceConfig_FixedIops {
  /** Required. Maximum IOPS. */
  maxIops?: string | Computed<string>;
}

export interface V1beta1Instance_PerformanceConfig_IopsPerTb {
  /** Required. Maximum IOPS per TiB. */
  maxIopsPerTb?: string | Computed<string>;
}

export interface V1beta1Instance_PerformanceConfig {
  /** Fixed IOPS (input/output operations per second) parameters. */
  fixedIops?: V1beta1Instance_PerformanceConfig_FixedIops | Computed<V1beta1Instance_PerformanceConfig_FixedIops>;
  /** IOPS per TB. Filestore defines TB as 1024^4 bytes (TiB). */
  iopsPerTb?: V1beta1Instance_PerformanceConfig_IopsPerTb | Computed<V1beta1Instance_PerformanceConfig_IopsPerTb>;
}

export interface V1beta1Instance_PerformanceLimits {
...
export interface V1beta1Instance_Replication_Replicas {
...
export interface V1beta1Instance_Replication {
  /** Replication configuration for the replica instance associated with this instance. Only a single replica is supported. */
  replicas?: V1beta1Instance_Replication_Replicas[] | Computed<V1beta1Instance_Replication_Replicas[]>;
...
const V1beta1Instance_DirectoryServices_LdapFields: FieldMap = {
  domain: "domain",
  groupsOu: "groups_ou",
  servers: "servers",
  usersOu: "users_ou",
...
const V1beta1Instance_DirectoryServices_ManagedActiveDirectoryFields: FieldMap = {
  computer: "computer",
  domain: "domain",
};

const V1beta1Instance_DirectoryServicesFields: FieldMap = {
  ldap: {
    wireName: "ldap",
    kind: "object",
...
const V1beta1Instance_FileShares_NfsExportOptionsFields: FieldMap = {
...
const V1beta1Instance_FileShares_RestoreConfigFields: FieldMap = {
  pathPatterns: "path_patterns",
};

const V1beta1Instance_FileSharesFields: FieldMap = {
...
const V1beta1Instance_PerformanceConfig_FixedIopsFields: FieldMap = {
  maxIops: "max_iops",
};

const V1beta1Instance_PerformanceConfig_IopsPerTbFields: FieldMap = {
  maxIopsPerTb: "max_iops_per_tb",
};

const V1beta1Instance_PerformanceConfigFields: FieldMap = {
  fixedIops: {
    wireName: "fixed_iops",
    kind: "object",
...
const V1beta1Instance_PerformanceLimitsFields: FieldMap = {
  maxIops: "max_iops",
...
const V1beta1Instance_Replication_ReplicasFields: FieldMap = {
...
const V1beta1Instance_ReplicationFields: FieldMap = {
  replicas: {
    wireName: "replicas",
    kind: "list",
...
export interface V1beta1InstanceConfig {
  ...
  directoryServices?: V1beta1Instance_DirectoryServices | Computed<V1beta1Instance_DirectoryServices>;
  /** Server-specified ETag for the instance resource to prevent simultaneous updates from overwriting each other. */
  etag?: string | Computed<string>;
  /** File system shares on the instance. For this version, only a single file share is supported. */
  fileShares?: V1beta1Instance_FileShares[] | Computed<V1beta1Instance_FileShares[]>;
  ...
  performanceConfig?: V1beta1Instance_PerformanceConfig | Computed<V1beta1Instance_PerformanceConfig>;
  /** The enforced performance limits, calculated from the instance's performance configuration. */
  performanceLimits?: V1beta1Instance_PerformanceLimits | Computed<V1beta1Instance_PerformanceLimits>;
...
export interface V1beta1InstanceAttrs {
  ...
  description: string;
  /** Directory Services configuration. */
  directoryServices: V1beta1Instance_DirectoryServices;
  /** Server-specified ETag for the instance resource to prevent simultaneous updates from overwriting each other. */
  etag: string;
  /** File system shares on the instance. For this version, only a single file share is supported. */
  fileShares: V1beta1Instance_FileShares[];
  /** KMS key name used for data encryption. */
  kmsKeyName: string;
  /** Resource labels to represent user provided metadata. */
  ...
  name: string;
  /** VPC networks to which the instance is connected. For this version, only a single network is supported. */
  networks: V1beta1Instance_Networks[];
  /** Used for setting the performance configuration. If the user doesn't specify PerformanceConfig, automatically provision the default performance settings as described in https://cloud.google.com/filestore/docs/performance. Larger instances will be linearly set to more IOPS. If the instance's capacity is increased or decreased, its performance will be automatically adjusted upwards or downwards accordingly (respectively). */
  performanceConfig: V1beta1Instance_PerformanceConfig;
  /** The enforced performance limits, calculated from the instance's performance configuration. */
  performanceLimits: V1beta1Instance_PerformanceLimits;
  /** Immutable. The protocol indicates the access protocol for all shares in the instance. This field is immutable and it cannot be changed after the instance has been created. Default value: `NFS_V3`. */
  protocol: string;
  /** Optional. The configuration used to replicate an instance. */
  replication: V1beta1Instance_Replication;
  /** Output only. Reserved for future use. */
