...
export interface CloudquotasQuotaPreference_QuotaConfig {
...
const CloudquotasQuotaPreference_QuotaConfigFields: FieldMap = {
...
export interface CloudquotasQuotaPreferenceConfig {
  ...
  quotaConfig?: CloudquotasQuotaPreference_QuotaConfig | Computed<CloudquotasQuotaPreference_QuotaConfig>;
...
export interface CloudquotasQuotaPreferenceAttrs {
  /** Input only. An email address that can be used to contact the user, in case Google Cloud needs more information to make a decision before additional quota can be granted. When requesting a quota increase, the email address is required. When requesting a quota decrease, the email address is optional. For example, the email address is optional when the `QuotaConfig.preferred_value` is smaller than the `QuotaDetails.reset_value`. */
  contactEmail: string;
  /** Output only. Create time stamp */
  createTime: string;
  ...
  name: string;
  /** The preferred quota configuration. */
  quotaConfig: CloudquotasQuotaPreference_QuotaConfig;
  /** Required. The id of the quota to which the quota preference is applied. A quota name is unique in the service. For example, `CpusPerProjectPerRegion` */
  quotaId: string;
  /** Output only. Is the quota preference pending Google Cloud approval and fulfillment. */
  reconciling: boolean;
...
export const CloudquotasQuotaPreference: ResourceBinding<CloudquotasQuotaPreferenceConfig, CloudquotasQuotaPreferenceAttrs> = {
  wireType: "google_cloudquotas_cloudquotas_quota_preference",
  fields: {
    ...
    quotaConfig: {
      ...
      kind: "object",
      fields: CloudquotasQuotaPreference_QuotaConfigFields,
    },
    quotaId: "quota_id",
