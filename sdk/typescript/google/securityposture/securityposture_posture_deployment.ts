...
export interface SecurityposturePostureDeploymentConfig {
...
export interface SecurityposturePostureDeploymentAttrs {
  /** Optional. The user-specified annotations for the posture deployment. For details about the values you can use in an annotation, see [AIP-148: Standard fields](https://google.aip.dev/148#annotations). */
...
export const SecurityposturePostureDeployment: ResourceBinding<SecurityposturePostureDeploymentConfig, SecurityposturePostureDeploymentAttrs> = {
