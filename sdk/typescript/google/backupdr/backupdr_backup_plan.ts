// Code generated by `ubx sdk gen` from google_backupdr_backupdr_backup_plan. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface BackupdrBackupPlan_BackupRules_StandardSchedule_BackupWindow {
  endHourOfDay?: number | Computed<number>;
  startHourOfDay?: number | Computed<number>;
}

export interface BackupdrBackupPlan_BackupRules_StandardSchedule_WeekDayOfMonth {
  dayOfWeek?: string | Computed<string>;
  weekOfMonth?: string | Computed<string>;
}

export interface BackupdrBackupPlan_BackupRules_StandardSchedule {
  backupWindow?: BackupdrBackupPlan_BackupRules_StandardSchedule_BackupWindow | Computed<BackupdrBackupPlan_BackupRules_StandardSchedule_BackupWindow>;
  ...
  weekDayOfMonth?: BackupdrBackupPlan_BackupRules_StandardSchedule_WeekDayOfMonth | Computed<BackupdrBackupPlan_BackupRules_StandardSchedule_WeekDayOfMonth>;
}

export interface BackupdrBackupPlan_BackupRules {
  backupRetentionDays?: number | Computed<number>;
  ruleId?: string | Computed<string>;
  standardSchedule?: BackupdrBackupPlan_BackupRules_StandardSchedule | Computed<BackupdrBackupPlan_BackupRules_StandardSchedule>;
}

export interface BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabels_Labels {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabels {
  ...
  labels?: BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabels_Labels[] | Computed<BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabels_Labels[]>;
}

export interface BackupdrBackupPlan_ComputeInstanceBackupPlanProperties {
  ...
  diskExclusionLabels?: BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabels | Computed<BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabels>;
...
export interface BackupdrBackupPlan_DiskBackupPlanProperties {
...
const BackupdrBackupPlan_BackupRules_StandardSchedule_BackupWindowFields: FieldMap = {
  endHourOfDay: "end_hour_of_day",
  startHourOfDay: "start_hour_of_day",
};

const BackupdrBackupPlan_BackupRules_StandardSchedule_WeekDayOfMonthFields: FieldMap = {
  dayOfWeek: "day_of_week",
  weekOfMonth: "week_of_month",
};

const BackupdrBackupPlan_BackupRules_StandardScheduleFields: FieldMap = {
  backupWindow: {
    wireName: "backup_window",
    kind: "object",
    fields: BackupdrBackupPlan_BackupRules_StandardSchedule_BackupWindowFields,
  },
  ...
  weekDayOfMonth: {
    ...
    kind: "object",
    fields: BackupdrBackupPlan_BackupRules_StandardSchedule_WeekDayOfMonthFields,
  },
};

const BackupdrBackupPlan_BackupRulesFields: FieldMap = {
  backupRetentionDays: "backup_retention_days",
  ruleId: "rule_id",
  standardSchedule: {
    wireName: "standard_schedule",
    kind: "object",
    fields: BackupdrBackupPlan_BackupRules_StandardScheduleFields,
  },
};

const BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabels_LabelsFields: FieldMap = {
  key: "key",
  value: "value",
};

const BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabelsFields: FieldMap = {
  labels: {
    wireName: "labels",
    kind: "list",
    fields: BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabels_LabelsFields,
  },
};

const BackupdrBackupPlan_ComputeInstanceBackupPlanPropertiesFields: FieldMap = {
  bootDiskOnly: "boot_disk_only",
  diskExclusionLabels: {
    wireName: "disk_exclusion_labels",
    kind: "object",
    fields: BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabelsFields,
  },
  guestFlush: "guest_flush",
};

const BackupdrBackupPlan_DiskBackupPlanPropertiesFields: FieldMap = {
  guestFlush: "guest_flush",
};

export interface BackupdrBackupPlanConfig {
  /** Optional. The backup rules for this `BackupPlan`. */
  backupRules?: BackupdrBackupPlan_BackupRules[] | Computed<BackupdrBackupPlan_BackupRules[]>;
  ...
  computeInstanceBackupPlanProperties?: BackupdrBackupPlan_ComputeInstanceBackupPlanProperties | Computed<BackupdrBackupPlan_ComputeInstanceBackupPlanProperties>;
  ...
  diskBackupPlanProperties?: BackupdrBackupPlan_DiskBackupPlanProperties | Computed<BackupdrBackupPlan_DiskBackupPlanProperties>;
...
export interface BackupdrBackupPlanAttrs {
  /** Optional. The backup rules for this `BackupPlan`. */
  backupRules: BackupdrBackupPlan_BackupRules[];
  /** Required. Resource name of backup vault which will be used as storage location for backups. Format: projects/{project}/locations/{location}/backupVaults/{backupvault} */
  backupVault: string;
  /** Output only. The Google Cloud service account to be used by the BackupVault for taking backups. Specify the email address of the Backup Vault Service Account. */
  backupVaultServiceAccount: string;
  /** Properties for a compute instance backup plan. */
  computeInstanceBackupPlanProperties: BackupdrBackupPlan_ComputeInstanceBackupPlanProperties;
  /** Output only. When the `BackupPlan` was created. */
  createTime: string;
  /** Optional. The description of the `BackupPlan` resource. The description allows for additional details about `BackupPlan` and its use cases to be provided. An example description is the following: "This is a backup plan that performs a daily backup at 6pm and retains data for 3 months". The description must be at most 2048 characters. */
  description: string;
  /** Properties for a disk backup plan. */
  diskBackupPlanProperties: BackupdrBackupPlan_DiskBackupPlanProperties;
  /** Optional. `etag` is returned from the service in the response. As a user of the service, you may provide an etag value in this field to prevent stale resources. */
  etag: string;
  /** Optional. This collection of key/value pairs allows for custom labels to be supplied by the user. Example, {"tag": "Weekly"}. */
...
export const BackupdrBackupPlan: ResourceBinding<BackupdrBackupPlanConfig, BackupdrBackupPlanAttrs> = {
  wireType: "google_backupdr_backupdr_backup_plan",
  fields: {
    backupRules: {
      wireName: "backup_rules",
      kind: "list",
      fields: BackupdrBackupPlan_BackupRulesFields,
    },
    ...
    computeInstanceBackupPlanProperties: {
      ...
      kind: "object",
      fields: BackupdrBackupPlan_ComputeInstanceBackupPlanPropertiesFields,
    },
    ...
    diskBackupPlanProperties: {
      ...
      kind: "object",
      fields: BackupdrBackupPlan_DiskBackupPlanPropertiesFields,
    },
    etag: "etag",
    labels: "labels",
