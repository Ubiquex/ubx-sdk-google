...
const BackupPlanAssociation_RulesConfigInfo_LastBackupErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const BackupPlanAssociation_RulesConfigInfoFields: FieldMap = {
  lastBackupError: {
...
export interface BackupPlanAssociationConfig {
  ...
  rulesConfigInfo?: BackupPlanAssociation_RulesConfigInfo[] | Computed<BackupPlanAssociation_RulesConfigInfo[]>;
