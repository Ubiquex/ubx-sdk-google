// Code generated by `ubx sdk gen` from google_securesourcemanager_securesourcemanager_instance. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface SecuresourcemanagerInstance_HostConfig {
...
export interface SecuresourcemanagerInstance_PrivateConfig {
  ...
  customHostConfig?: SecuresourcemanagerInstance_HostConfig | Computed<SecuresourcemanagerInstance_HostConfig>;
...
export interface SecuresourcemanagerInstance_WorkforceIdentityFederationConfig {
  /** Optional. Immutable. Whether Workforce Identity Federation is enabled. */
  enabled?: boolean | Computed<boolean>;
}

const SecuresourcemanagerInstance_HostConfigFields: FieldMap = {
  api: "api",
  gitHttp: "git_http",
  gitSsh: "git_ssh",
  html: "html",
...
const SecuresourcemanagerInstance_PrivateConfigFields: FieldMap = {
  caPool: "ca_pool",
  customHostConfig: {
    wireName: "custom_host_config",
    kind: "object",
    fields: SecuresourcemanagerInstance_HostConfigFields,
  },
...
const SecuresourcemanagerInstance_WorkforceIdentityFederationConfigFields: FieldMap = {
  enabled: "enabled",
};
...
export interface SecuresourcemanagerInstanceConfig {
  ...
  hostConfig?: SecuresourcemanagerInstance_HostConfig | Computed<SecuresourcemanagerInstance_HostConfig>;
  ...
  privateConfig?: SecuresourcemanagerInstance_PrivateConfig | Computed<SecuresourcemanagerInstance_PrivateConfig>;
  ...
  workforceIdentityFederationConfig?: SecuresourcemanagerInstance_WorkforceIdentityFederationConfig | Computed<SecuresourcemanagerInstance_WorkforceIdentityFederationConfig>;
}

export interface SecuresourcemanagerInstanceAttrs {
  /** Output only. Create timestamp. */
  createTime: string;
  /** HostConfig has different instance endpoints. */
  hostConfig: SecuresourcemanagerInstance_HostConfig;
  /** Optional. Immutable. Customer-managed encryption key name, in the format projects/* /locations/* /keyRings/* /cryptoKeys/*. */
  kmsKey: string;
  /** Optional. Labels as key value pairs. Keys and values can contain only lowercase letters, numeric characters, underscores, and dashes. For more information, see [Requirements for labels](https://cloud.google.com/resource-manager/docs/best-practices-labels#label_encoding). */
  ...
  name: string;
  /** PrivateConfig includes settings for private instance. */
  privateConfig: SecuresourcemanagerInstance_PrivateConfig;
  /** Output only. Reserved for future use. */
  ...
  updateTime: string;
  /** WorkforceIdentityFederationConfig allows this instance to support users from external identity providers. */
  workforceIdentityFederationConfig: SecuresourcemanagerInstance_WorkforceIdentityFederationConfig;
}

export const SecuresourcemanagerInstance: ResourceBinding<SecuresourcemanagerInstanceConfig, SecuresourcemanagerInstanceAttrs> = {
  wireType: "google_securesourcemanager_securesourcemanager_instance",
  fields: {
    ...
    privateConfig: {
      ...
      kind: "object",
      fields: SecuresourcemanagerInstance_PrivateConfigFields,
    },
    ...
    workforceIdentityFederationConfig: {
      ...
      kind: "object",
      fields: SecuresourcemanagerInstance_WorkforceIdentityFederationConfigFields,
    },
  },
};
