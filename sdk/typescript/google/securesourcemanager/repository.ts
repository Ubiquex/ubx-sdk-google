...
export interface Repository_ScanConfig_SecretScanConfig {
...
export interface Repository_ScanConfig {
  /** Configuration for secret scanning. */
  secretScanConfig?: Repository_ScanConfig_SecretScanConfig | Computed<Repository_ScanConfig_SecretScanConfig>;
}
...
const Repository_InitialConfigFields: FieldMap = {
...
const Repository_ScanConfig_SecretScanConfigFields: FieldMap = {
  enabled: "enabled",
  inspectTemplate: "inspect_template",
};

const Repository_ScanConfigFields: FieldMap = {
  secretScanConfig: {
...
const Repository_UrisFields: FieldMap = {
  api: "api",
  gitHttps: "git_https",
  html: "html",
};
...
export interface RepositoryConfig {
  ...
  initialConfig?: Repository_InitialConfig | Computed<Repository_InitialConfig>;
...
export interface RepositoryAttrs {
  ...
  name: string;
  /** Configuration for scanning. */
  scanConfig: Repository_ScanConfig;
  /** Optional. Repository level service account (BYOSA). */
