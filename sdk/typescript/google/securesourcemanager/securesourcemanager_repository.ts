// Code generated by `ubx sdk gen` from google_securesourcemanager_securesourcemanager_repository. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface SecuresourcemanagerRepository_InitialConfig {
  ...
  gitignores?: string[] | Computed<string[]>;
  ...
  readme?: string | Computed<string>;
}

export interface SecuresourcemanagerRepository_ScanConfig_SecretScanConfig {
...
export interface SecuresourcemanagerRepository_ScanConfig {
  /** Configuration for secret scanning. */
  secretScanConfig?: SecuresourcemanagerRepository_ScanConfig_SecretScanConfig | Computed<SecuresourcemanagerRepository_ScanConfig_SecretScanConfig>;
}

export interface SecuresourcemanagerRepository_Uris {
  /** Output only. API is the URI for API access. */
  api?: string | Computed<string>;
  /** Output only. git_https is the git HTTPS URI for git operations. */
  gitHttps?: string | Computed<string>;
  /** Output only. HTML is the URI for user to view the repository in a browser. */
  html?: string | Computed<string>;
}

const SecuresourcemanagerRepository_InitialConfigFields: FieldMap = {
...
const SecuresourcemanagerRepository_ScanConfig_SecretScanConfigFields: FieldMap = {
  enabled: "enabled",
  inspectTemplate: "inspect_template",
};

const SecuresourcemanagerRepository_ScanConfigFields: FieldMap = {
  secretScanConfig: {
    wireName: "secret_scan_config",
    kind: "object",
    fields: SecuresourcemanagerRepository_ScanConfig_SecretScanConfigFields,
  },
};

const SecuresourcemanagerRepository_UrisFields: FieldMap = {
  api: "api",
  gitHttps: "git_https",
  html: "html",
};

export interface SecuresourcemanagerRepositoryConfig {
  ...
  initialConfig?: SecuresourcemanagerRepository_InitialConfig | Computed<SecuresourcemanagerRepository_InitialConfig>;
  ...
  scanConfig?: SecuresourcemanagerRepository_ScanConfig | Computed<SecuresourcemanagerRepository_ScanConfig>;
  ...
  uris?: SecuresourcemanagerRepository_Uris | Computed<SecuresourcemanagerRepository_Uris>;
}

export interface SecuresourcemanagerRepositoryAttrs {
  /** Output only. Create timestamp. */
  createTime: string;
  /** Optional. Description of the repository, which cannot exceed 500 characters. */
  description: string;
  ...
  etag: string;
  /** Repository initialization configuration. */
  initialConfig: SecuresourcemanagerRepository_InitialConfig;
  /** Optional. The name of the instance in which the repository is hosted, formatted as `projects/{project_number}/locations/{location_id}/instances/{instance_id}` When creating repository via securesourcemanager.googleapis.com, this field is used as input. When creating repository via *.sourcemanager.dev, this field is output only. */
  instance: string;
  /** Identifier. A unique identifier for a repository. The name should be of the format: `projects/{project}/locations/{location_id}/repositories/{repository_id}` */
  name: string;
  /** Configuration for scanning. */
  scanConfig: SecuresourcemanagerRepository_ScanConfig;
  /** Optional. Repository level service account (BYOSA). */
  ...
  updateTime: string;
  /** URIs for the repository. */
  uris: SecuresourcemanagerRepository_Uris;
}

export const SecuresourcemanagerRepository: ResourceBinding<SecuresourcemanagerRepositoryConfig, SecuresourcemanagerRepositoryAttrs> = {
  wireType: "google_securesourcemanager_securesourcemanager_repository",
  fields: {
    ...
    initialConfig: {
      ...
      kind: "object",
      fields: SecuresourcemanagerRepository_InitialConfigFields,
    },
    instance: "instance",
    name: "name",
    scanConfig: {
      ...
      kind: "object",
      fields: SecuresourcemanagerRepository_ScanConfigFields,
    },
    ...
    uris: {
      wireName: "uris",
      kind: "object",
      fields: SecuresourcemanagerRepository_UrisFields,
    },
  },
};
