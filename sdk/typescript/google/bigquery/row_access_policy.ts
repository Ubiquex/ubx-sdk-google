...
export interface RowAccessPolicy_RowAccessPolicyReference {
...
const RowAccessPolicy_RowAccessPolicyReferenceFields: FieldMap = {
...
export interface RowAccessPolicyConfig {
  ...
  rowAccessPolicyReference?: RowAccessPolicy_RowAccessPolicyReference | Computed<RowAccessPolicy_RowAccessPolicyReference>;
}
...
export interface RowAccessPolicyAttrs {
  ...
  /** Id path of a row access policy. */
  rowAccessPolicyReference: RowAccessPolicy_RowAccessPolicyReference;
}
