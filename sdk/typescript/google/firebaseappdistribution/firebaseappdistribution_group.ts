...
export interface FirebaseappdistributionGroupConfig {
...
export interface FirebaseappdistributionGroupAttrs {
  /** Required. The display name of the group. */
  displayName: string;
  /** Output only. The number of invite links for this group. */
...
export const FirebaseappdistributionGroup: ResourceBinding<FirebaseappdistributionGroupConfig, FirebaseappdistributionGroupAttrs> = {
