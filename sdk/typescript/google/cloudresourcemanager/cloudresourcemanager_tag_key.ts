// Code generated by `ubx sdk gen` from google_cloudresourcemanager_cloudresourcemanager_tag_key. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface CloudresourcemanagerTagKeyConfig {
...
export interface CloudresourcemanagerTagKeyAttrs {
  /** Optional. Regular expression constraint for freeform tag values. If present, it implicitly allows freeform values (constrained by the regex). */
...
export const CloudresourcemanagerTagKey: ResourceBinding<CloudresourcemanagerTagKeyConfig, CloudresourcemanagerTagKeyAttrs> = {
  wireType: "google_cloudresourcemanager_cloudresourcemanager_tag_key",
  fields: {
