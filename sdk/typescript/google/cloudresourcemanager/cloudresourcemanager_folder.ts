...
export interface CloudresourcemanagerFolderConfig {
...
export interface CloudresourcemanagerFolderAttrs {
  /** Output only. Optional capabilities configured for this folder (via UpdateCapability API). Example: `folders/123/capabilities/app-management`. */
...
export const CloudresourcemanagerFolder: ResourceBinding<CloudresourcemanagerFolderConfig, CloudresourcemanagerFolderAttrs> = {
