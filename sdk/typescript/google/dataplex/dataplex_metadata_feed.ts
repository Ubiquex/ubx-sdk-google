// Code generated by `ubx sdk gen` from google_dataplex_dataplex_metadata_feed. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface DataplexMetadataFeed_Filters {
...
export interface DataplexMetadataFeed_Scope {
...
const DataplexMetadataFeed_FiltersFields: FieldMap = {
  aspectTypes: "aspect_types",
  changeTypes: "change_types",
  entryTypes: "entry_types",
};

const DataplexMetadataFeed_ScopeFields: FieldMap = {
  entryGroups: "entry_groups",
  organizationLevel: "organization_level",
  projects: "projects",
};

export interface DataplexMetadataFeedConfig {
  ...
  filters?: DataplexMetadataFeed_Filters | Computed<DataplexMetadataFeed_Filters>;
  ...
  scope?: DataplexMetadataFeed_Scope | Computed<DataplexMetadataFeed_Scope>;
...
export interface DataplexMetadataFeedAttrs {
  /** Output only. The time when the feed was created. */
  createTime: string;
  /** Filters defines the type of changes that you want to listen to. You can have multiple entry type filters and multiple aspect type filters. All of the entry type filters are OR'ed together. All of the aspect type filters are OR'ed together. All of the entry type filters and aspect type filters are AND'ed together. */
  filters: DataplexMetadataFeed_Filters;
  /** Optional. User-defined labels. */
  ...
  pubsubTopic: string;
  /** Scope defines the scope of the metadata feed. Scopes are exclusive. Only one of the scopes can be specified. */
  scope: DataplexMetadataFeed_Scope;
  /** Output only. A system-generated, globally unique ID for the metadata job. If the metadata job is deleted and then re-created with the same name, this ID is different. */
  uid: string;
  /** Output only. The time when the feed was updated. */
  updateTime: string;
...
export const DataplexMetadataFeed: ResourceBinding<DataplexMetadataFeedConfig, DataplexMetadataFeedAttrs> = {
  wireType: "google_dataplex_dataplex_metadata_feed",
  fields: {
    createTime: "create_time",
    filters: {
      wireName: "filters",
      kind: "object",
      fields: DataplexMetadataFeed_FiltersFields,
    },
    labels: "labels",
    name: "name",
    ...
    scope: {
      wireName: "scope",
      kind: "object",
      fields: DataplexMetadataFeed_ScopeFields,
    },
    uid: "uid",
