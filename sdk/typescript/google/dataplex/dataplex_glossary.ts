...
export interface DataplexGlossaryConfig {
...
export interface DataplexGlossaryAttrs {
  /** Output only. The number of GlossaryCategories in the Glossary. */
...
export const DataplexGlossary: ResourceBinding<DataplexGlossaryConfig, DataplexGlossaryAttrs> = {
