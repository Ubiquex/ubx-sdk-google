...
export interface DataplexMetadataJob_ExportResult {
...
export interface DataplexMetadataJob_ExportSpec_Scope {
...
export interface DataplexMetadataJob_ExportSpec {
  ...
  scope?: DataplexMetadataJob_ExportSpec_Scope | Computed<DataplexMetadataJob_ExportSpec_Scope>;
}

export interface DataplexMetadataJob_ImportResult {
...
export interface DataplexMetadataJob_ImportSpec_Scope {
...
export interface DataplexMetadataJob_ImportSpec {
  ...
  scope?: DataplexMetadataJob_ImportSpec_Scope | Computed<DataplexMetadataJob_ImportSpec_Scope>;
...
export interface DataplexMetadataJob_Status {
...
const DataplexMetadataJob_ExportResultFields: FieldMap = {
  errorMessage: "error_message",
  exportedEntries: "exported_entries",
};

const DataplexMetadataJob_ExportSpec_ScopeFields: FieldMap = {
...
const DataplexMetadataJob_ExportSpecFields: FieldMap = {
  outputPath: "output_path",
  scope: {
    wireName: "scope",
    kind: "object",
    fields: DataplexMetadataJob_ExportSpec_ScopeFields,
  },
};

const DataplexMetadataJob_ImportResultFields: FieldMap = {
...
const DataplexMetadataJob_ImportSpec_ScopeFields: FieldMap = {
  aspectTypes: "aspect_types",
  entryGroups: "entry_groups",
...
const DataplexMetadataJob_ImportSpecFields: FieldMap = {
  ...
  scope: {
    wireName: "scope",
    kind: "object",
    fields: DataplexMetadataJob_ImportSpec_ScopeFields,
  },
  sourceCreateTime: "source_create_time",
  sourceStorageUri: "source_storage_uri",
};

const DataplexMetadataJob_StatusFields: FieldMap = {
...
export interface DataplexMetadataJobConfig {
  ...
  exportResult?: DataplexMetadataJob_ExportResult | Computed<DataplexMetadataJob_ExportResult>;
  /** Job specification for a metadata export job. */
  exportSpec?: DataplexMetadataJob_ExportSpec | Computed<DataplexMetadataJob_ExportSpec>;
  /** Results from a metadata import job. */
  importResult?: DataplexMetadataJob_ImportResult | Computed<DataplexMetadataJob_ImportResult>;
  ...
  importSpec?: DataplexMetadataJob_ImportSpec | Computed<DataplexMetadataJob_ImportSpec>;
  ...
  /** Metadata job status. */
  status?: DataplexMetadataJob_Status | Computed<DataplexMetadataJob_Status>;
...
export interface DataplexMetadataJobAttrs {
  /** Output only. The time when the metadata job was created. */
  createTime: string;
  /** Summary results from a metadata export job. The results are a snapshot of the metadata at the time when the job was created. The exported entries are saved to a Cloud Storage bucket. */
  exportResult: DataplexMetadataJob_ExportResult;
  /** Job specification for a metadata export job. */
  exportSpec: DataplexMetadataJob_ExportSpec;
  /** Results from a metadata import job. */
  importResult: DataplexMetadataJob_ImportResult;
  /** Job specification for a metadata import job.You can run the following kinds of metadata import jobs: Full sync of entries with incremental import of their aspects. Supported for custom entries. Incremental import of aspects only. Supported for aspects that belong to custom entries and system entries. For custom entries, you can modify both optional aspects and required aspects. For system entries, you can modify optional aspects. */
  importSpec: DataplexMetadataJob_ImportSpec;
  /** Optional. User-defined labels. */
  labels: Record<string, string>;
  /** Output only. Identifier. The name of the resource that the configuration is applied to, in the format projects/{project_number}/locations/{location_id}/metadataJobs/{metadata_job_id}. */
  name: string;
  /** Metadata job status. */
  status: DataplexMetadataJob_Status;
  /** Required. Metadata job type. */
  type: string;
  /** Output only. A system-generated, globally unique ID for the metadata job. If the metadata job is deleted and then re-created with the same name, this ID is different. */
  uid: string;
...
export const DataplexMetadataJob: ResourceBinding<DataplexMetadataJobConfig, DataplexMetadataJobAttrs> = {
  wireType: "google_dataplex_dataplex_metadata_job",
  fields: {
    createTime: "create_time",
    exportResult: {
      wireName: "export_result",
      kind: "object",
      fields: DataplexMetadataJob_ExportResultFields,
    },
    exportSpec: {
      wireName: "export_spec",
      kind: "object",
      fields: DataplexMetadataJob_ExportSpecFields,
    },
    importResult: {
      wireName: "import_result",
      kind: "object",
      fields: DataplexMetadataJob_ImportResultFields,
    },
    importSpec: {
      wireName: "import_spec",
      kind: "object",
      fields: DataplexMetadataJob_ImportSpecFields,
    },
    labels: "labels",
    name: "name",
    status: {
      wireName: "status",
      kind: "object",
      fields: DataplexMetadataJob_StatusFields,
    },
    type: "type",
    uid: "uid",
    updateTime: "update_time",
