// Code generated by `ubx sdk gen` from google_dataplex_dataplex_binding. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface DataplexBindingConfig {
...
export interface DataplexBindingAttrs {
  /** Output only. The time at which the DataDomainBinding was created. */
  createTime: string;
  /** Identifier. The relative resource name of the DataDomainBinding. Format: projects/{project_id_or_number}/locations/{location}/dataDomains/{data_domain_id}/bindings/{binding_id} */
  name: string;
...
export const DataplexBinding: ResourceBinding<DataplexBindingConfig, DataplexBindingAttrs> = {
  wireType: "google_dataplex_dataplex_binding",
  fields: {
