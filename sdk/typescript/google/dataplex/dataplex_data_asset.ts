...
export interface DataplexDataAsset_AccessGroupConfigs {
  iamRoles?: string[] | Computed<string[]>;
}

const DataplexDataAsset_AccessGroupConfigsFields: FieldMap = {
  iamRoles: "iam_roles",
};

export interface DataplexDataAssetConfig {
  ...
  accessGroupConfigs?: Record<string, DataplexDataAsset_AccessGroupConfigs> | Computed<Record<string, DataplexDataAsset_AccessGroupConfigs>>;
...
export interface DataplexDataAssetAttrs {
  /** Optional. Access groups configurations for this data asset.The key is DataProduct.AccessGroup.id and the value is AccessGroupConfig.Example: { "analyst": { "iamRoles": ["roles/bigquery.dataViewer"] } } Currently, at most one IAM role is allowed per access group. For providing multiple predefined IAM roles, wrap them in a custom IAM role as per https://cloud.google.com/iam/docs/creating-custom-roles. */
  accessGroupConfigs: Record<string, DataplexDataAsset_AccessGroupConfigs>;
  /** Output only. The time at which the data asset was created. */
  createTime: string;
  /** Optional. This checksum is computed by the server based on the value of other fields, and may be sent on update and delete requests to ensure the client has an up-to-date value before proceeding. */
  etag: string;
...
export const DataplexDataAsset: ResourceBinding<DataplexDataAssetConfig, DataplexDataAssetAttrs> = {
