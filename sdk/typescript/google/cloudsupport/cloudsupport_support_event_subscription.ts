// Code generated by `ubx sdk gen` from google_cloudsupport_cloudsupport_support_event_subscription. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface CloudsupportSupportEventSubscriptionConfig {
...
export interface CloudsupportSupportEventSubscriptionAttrs {
  /** Output only. The time at which the subscription was created. */
  createTime: string;
  /** Output only. The time at which the subscription was deleted. */
  deleteTime: string;
...
export const CloudsupportSupportEventSubscription: ResourceBinding<CloudsupportSupportEventSubscriptionConfig, CloudsupportSupportEventSubscriptionAttrs> = {
  wireType: "google_cloudsupport_cloudsupport_support_event_subscription",
  fields: {
