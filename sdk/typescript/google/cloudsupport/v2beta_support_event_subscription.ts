...
export interface V2betaSupportEventSubscriptionConfig {
...
export interface V2betaSupportEventSubscriptionAttrs {
  /** Output only. The time at which the subscription was created. */
  createTime: string;
  /** Output only. The time at which the subscription was deleted. */
  deleteTime: string;
...
export const V2betaSupportEventSubscription: ResourceBinding<V2betaSupportEventSubscriptionConfig, V2betaSupportEventSubscriptionAttrs> = {
