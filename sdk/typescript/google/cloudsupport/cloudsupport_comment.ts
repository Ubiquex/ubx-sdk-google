// Code generated by `ubx sdk gen` from google_cloudsupport_cloudsupport_comment. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface CloudsupportComment_Creator {
...
const CloudsupportComment_CreatorFields: FieldMap = {
...
export interface CloudsupportCommentConfig {
  ...
  creator?: CloudsupportComment_Creator | Computed<CloudsupportComment_Creator>;
...
export interface CloudsupportCommentAttrs {
  /** The full comment body. Maximum of 12800 characters. */
  body: string;
  /** Output only. The time when the comment was created. */
  createTime: string;
  /** An Actor represents an entity that performed an action. For example, an actor could be a user who posted a comment on a support case, a user who uploaded an attachment, or a service account that created a support case. */
  creator: CloudsupportComment_Creator;
  /** Output only. Identifier. The resource name of the comment. */
  name: string;
  /** Output only. DEPRECATED. DO NOT USE. A duplicate of the `body` field. This field is only present for legacy reasons. */
...
export const CloudsupportComment: ResourceBinding<CloudsupportCommentConfig, CloudsupportCommentAttrs> = {
  wireType: "google_cloudsupport_cloudsupport_comment",
  fields: {
    body: "body",
    ...
    creator: {
      wireName: "creator",
      kind: "object",
      fields: CloudsupportComment_CreatorFields,
    },
    name: "name",
