// Code generated by `ubx sdk gen` from google_cloudsupport_case. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface Case_Classification {
...
const Case_ClassificationFields: FieldMap = {
  displayName: "display_name",
  id: "id",
};

const Case_CreatorFields: FieldMap = {
  displayName: "display_name",
  email: "email",
...
export const Case: ResourceBinding<CaseConfig, CaseAttrs> = {
  wireType: "google_cloudsupport_case",
  fields: {
    classification: {
