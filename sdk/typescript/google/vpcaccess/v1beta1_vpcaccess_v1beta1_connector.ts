// Code generated by `ubx sdk gen` from google_vpcaccess_v1beta1_vpcaccess_v1beta1_connector. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1VpcaccessV1beta1Connector_Subnet {
...
const V1beta1VpcaccessV1beta1Connector_SubnetFields: FieldMap = {
  name: "name",
  projectId: "project_id",
};

export interface V1beta1VpcaccessV1beta1ConnectorConfig {
  ...
  subnet?: V1beta1VpcaccessV1beta1Connector_Subnet | Computed<V1beta1VpcaccessV1beta1Connector_Subnet>;
}

export interface V1beta1VpcaccessV1beta1ConnectorAttrs {
  /** Output only. List of projects using the connector. */
  ...
  state: string;
  /** The subnet in which to house the connector */
  subnet: V1beta1VpcaccessV1beta1Connector_Subnet;
}

export const V1beta1VpcaccessV1beta1Connector: ResourceBinding<V1beta1VpcaccessV1beta1ConnectorConfig, V1beta1VpcaccessV1beta1ConnectorAttrs> = {
  wireType: "google_vpcaccess_v1beta1_vpcaccess_v1beta1_connector",
  fields: {
    ...
    subnet: {
      wireName: "subnet",
      kind: "object",
      fields: V1beta1VpcaccessV1beta1Connector_SubnetFields,
    },
  },
};
