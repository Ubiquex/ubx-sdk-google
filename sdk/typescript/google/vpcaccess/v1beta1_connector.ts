...
export interface V1beta1Connector_Subnet {
...
const V1beta1Connector_SubnetFields: FieldMap = {
  name: "name",
...
export interface V1beta1ConnectorAttrs {
  /** Output only. List of projects using the connector. */
  ...
  state: string;
  /** The subnet in which to house the connector */
  subnet: V1beta1Connector_Subnet;
}
