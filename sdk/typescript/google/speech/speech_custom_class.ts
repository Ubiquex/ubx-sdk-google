// Code generated by `ubx sdk gen` from google_speech_speech_custom_class. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface SpeechCustomClass_CustomClass_Items {
  value?: string | Computed<string>;
}

export interface SpeechCustomClass_CustomClass {
  ...
  items?: SpeechCustomClass_CustomClass_Items[] | Computed<SpeechCustomClass_CustomClass_Items[]>;
...
const SpeechCustomClass_CustomClass_ItemsFields: FieldMap = {
  value: "value",
};

const SpeechCustomClass_CustomClassFields: FieldMap = {
  ...
  items: {
    wireName: "items",
    kind: "list",
    fields: SpeechCustomClass_CustomClass_ItemsFields,
  },
...
export interface SpeechCustomClassConfig {
  /** A set of words or phrases that represents a common concept likely to appear in your audio, for example a list of passenger ship names. CustomClass items can be substituted into placeholders that you set in PhraseSet phrases. */
  customClass?: SpeechCustomClass_CustomClass | Computed<SpeechCustomClass_CustomClass>;
...
export interface SpeechCustomClassAttrs {
  /** Output only. Allows users to store small amounts of arbitrary data. Both the key and the value must be 63 characters or less each. At most 100 annotations. This field is not used. */
  annotations: Record<string, string>;
  /** A set of words or phrases that represents a common concept likely to appear in your audio, for example a list of passenger ship names. CustomClass items can be substituted into placeholders that you set in PhraseSet phrases. */
  customClass: SpeechCustomClass_CustomClass;
  /** Required. The ID to use for the custom class, which will become the final component of the custom class' resource name. This value should restrict to letters, numbers, and hyphens, with the first character a letter, the last a letter or a number, and be 4-63 characters. */
  ...
  expireTime: string;
  /** A collection of class items. */
  items: SpeechCustomClass_CustomClass_Items[];
  /** Output only. The [KMS key name](https://cloud.google.com/kms/docs/resource-hierarchy#keys) with which the content of the ClassItem is encrypted. The expected format is `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`. */
  kmsKeyName: string;
  /** Output only. The [KMS key version name](https://cloud.google.com/kms/docs/resource-hierarchy#key_versions) with which content of the ClassItem is encrypted. The expected format is `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}`. */
...
export const SpeechCustomClass: ResourceBinding<SpeechCustomClassConfig, SpeechCustomClassAttrs> = {
  wireType: "google_speech_speech_custom_class",
  fields: {
    customClass: {
      wireName: "custom_class",
      kind: "object",
      fields: SpeechCustomClass_CustomClassFields,
    },
    customClassId: "custom_class_id",
  },
};
