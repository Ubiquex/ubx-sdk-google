// Code generated by `ubx sdk gen` from google_speech_speech_phrase_set. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface SpeechPhraseSet_PhraseSet_Phrases {
  boost?: number | Computed<number>;
  value?: string | Computed<string>;
}

export interface SpeechPhraseSet_PhraseSet {
  ...
  phrases?: SpeechPhraseSet_PhraseSet_Phrases[] | Computed<SpeechPhraseSet_PhraseSet_Phrases[]>;
...
const SpeechPhraseSet_PhraseSet_PhrasesFields: FieldMap = {
  boost: "boost",
  value: "value",
};

const SpeechPhraseSet_PhraseSetFields: FieldMap = {
  ...
  phrases: {
    wireName: "phrases",
    kind: "list",
    fields: SpeechPhraseSet_PhraseSet_PhrasesFields,
  },
...
export interface SpeechPhraseSetConfig {
  /** Provides "hints" to the speech recognizer to favor specific words and phrases in the results. */
  phraseSet?: SpeechPhraseSet_PhraseSet | Computed<SpeechPhraseSet_PhraseSet>;
...
export interface SpeechPhraseSetAttrs {
  /** Output only. Allows users to store small amounts of arbitrary data. Both the key and the value must be 63 characters or less each. At most 100 annotations. This field is not used. */
  ...
  name: string;
  /** Provides "hints" to the speech recognizer to favor specific words and phrases in the results. */
  phraseSet: SpeechPhraseSet_PhraseSet;
  /** Required. The ID to use for the phrase set, which will become the final component of the phrase set's resource name. This value should restrict to letters, numbers, and hyphens, with the first character a letter, the last a letter or a number, and be 4-63 characters. */
  phraseSetId: string;
  /** A list of word and phrases. */
  phrases: SpeechPhraseSet_PhraseSet_Phrases[];
  /** Output only. Whether or not this PhraseSet is in the process of being updated. This field is not used. */
  reconciling: boolean;
  /** Output only. The CustomClass lifecycle state. This field is not used. */
  state: string;
...
export const SpeechPhraseSet: ResourceBinding<SpeechPhraseSetConfig, SpeechPhraseSetAttrs> = {
  wireType: "google_speech_speech_phrase_set",
  fields: {
    phraseSet: {
      wireName: "phrase_set",
      kind: "object",
      fields: SpeechPhraseSet_PhraseSetFields,
    },
