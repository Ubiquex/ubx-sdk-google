...
export interface DocumentaiSchemaConfig {
...
export interface DocumentaiSchemaAttrs {
  /** Output only. The time when the Schema was created. */
  createTime: string;
  /** Required. The user-defined name of the Schema. */
  displayName: string;
...
export const DocumentaiSchema: ResourceBinding<DocumentaiSchemaConfig, DocumentaiSchemaAttrs> = {
  wireType: "google_documentai_documentai_schema",
  fields: {
