...
export interface V1beta3Processor_ProcessorVersionAliases {
...
export interface V1beta3ProcessorAttrs {
  /** Optional. SchemaVersion used by the Processor. It is the same as Processor's DatasetSchema.schema_version Format is `projects/{project}/locations/{location}/schemas/{schema}/schemaVersions/{schema_version}. */
  ...
  /** Output only. The processor version aliases. */
  processorVersionAliases: V1beta3Processor_ProcessorVersionAliases[];
  /** Output only. Reserved for future use. */
...
export const V1beta3Processor: ResourceBinding<V1beta3ProcessorConfig, V1beta3ProcessorAttrs> = {
