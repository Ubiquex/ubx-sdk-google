...
export interface Pipeline_ScheduleInfo {
...
export interface Pipeline_Workload_DataflowFlexTemplateRequest_LaunchParameter_Environment {
...
export interface Pipeline_Workload_DataflowFlexTemplateRequest_LaunchParameter {
  /** Cloud Storage path to a file with a JSON-serialized ContainerSpec as content. */
  containerSpecGcsPath?: string | Computed<string>;
  /** The environment values to be set at runtime for a Flex Template. */
  environment?: Pipeline_Workload_DataflowFlexTemplateRequest_LaunchParameter_Environment | Computed<Pipeline_Workload_DataflowFlexTemplateRequest_LaunchParameter_Environment>;
...
export interface Pipeline_Workload_DataflowFlexTemplateRequest {
  /** Launch Flex Template parameter. */
  launchParameter?: Pipeline_Workload_DataflowFlexTemplateRequest_LaunchParameter | Computed<Pipeline_Workload_DataflowFlexTemplateRequest_LaunchParameter>;
...
export interface Pipeline_Workload_DataflowLaunchTemplateRequest_LaunchParameters_Environment {
  /** Additional experiment flags for the job. */
  additionalExperiments?: string[] | Computed<string[]>;
...
export interface Pipeline_Workload_DataflowLaunchTemplateRequest_LaunchParameters {
  /** The environment values to set at runtime. */
  environment?: Pipeline_Workload_DataflowLaunchTemplateRequest_LaunchParameters_Environment | Computed<Pipeline_Workload_DataflowLaunchTemplateRequest_LaunchParameters_Environment>;
...
export interface Pipeline_Workload_DataflowLaunchTemplateRequest {
  /** A Cloud Storage path to the template from which to create the job. Must be a valid Cloud Storage URL, beginning with 'gs://'. */
  gcsPath?: string | Computed<string>;
  /** Parameters to provide to the template being launched. */
  launchParameters?: Pipeline_Workload_DataflowLaunchTemplateRequest_LaunchParameters | Computed<Pipeline_Workload_DataflowLaunchTemplateRequest_LaunchParameters>;
...
export interface Pipeline_Workload {
  /** A request to launch a Dataflow job from a Flex Template. */
  dataflowFlexTemplateRequest?: Pipeline_Workload_DataflowFlexTemplateRequest | Computed<Pipeline_Workload_DataflowFlexTemplateRequest>;
  /** A request to launch a template. */
  dataflowLaunchTemplateRequest?: Pipeline_Workload_DataflowLaunchTemplateRequest | Computed<Pipeline_Workload_DataflowLaunchTemplateRequest>;
}

const Pipeline_ScheduleInfoFields: FieldMap = {
  nextJobTime: "next_job_time",
  schedule: "schedule",
  timeZone: "time_zone",
};

const Pipeline_Workload_DataflowFlexTemplateRequest_LaunchParameter_EnvironmentFields: FieldMap = {
...
const Pipeline_Workload_DataflowFlexTemplateRequest_LaunchParameterFields: FieldMap = {
...
const Pipeline_Workload_DataflowFlexTemplateRequestFields: FieldMap = {
  launchParameter: {
...
const Pipeline_Workload_DataflowLaunchTemplateRequest_LaunchParameters_EnvironmentFields: FieldMap = {
  additionalExperiments: "additional_experiments",
  additionalUserLabels: "additional_user_labels",
...
const Pipeline_Workload_DataflowLaunchTemplateRequest_LaunchParametersFields: FieldMap = {
  environment: {
    wireName: "environment",
    kind: "object",
...
const Pipeline_Workload_DataflowLaunchTemplateRequestFields: FieldMap = {
  gcsPath: "gcs_path",
  launchParameters: {
...
const Pipeline_WorkloadFields: FieldMap = {
...
export interface PipelineConfig {
  ...
  scheduleInfo?: Pipeline_ScheduleInfo | Computed<Pipeline_ScheduleInfo>;
  ...
  workload?: Pipeline_Workload | Computed<Pipeline_Workload>;
}
...
export interface PipelineAttrs {
  ...
  /** Details of the schedule the pipeline runs on. */
  scheduleInfo: Pipeline_ScheduleInfo;
  /** Optional. A service account email to be used with the Cloud Scheduler job. If not specified, the default compute engine service account will be used. */
