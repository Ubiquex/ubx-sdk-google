...
export interface SchemaRegistry_SchemaRegistry {
...
const SchemaRegistry_SchemaRegistryFields: FieldMap = {
  contexts: "contexts",
  name: "name",
};
...
export interface SchemaRegistryConfig {
  ...
  schemaRegistry?: SchemaRegistry_SchemaRegistry | Computed<SchemaRegistry_SchemaRegistry>;
...
export interface SchemaRegistryAttrs {
  ...
  name: string;
  /** SchemaRegistry is a schema registry instance. */
  schemaRegistry: SchemaRegistry_SchemaRegistry;
  /** Required. The schema registry instance ID to use for this schema registry. The ID must contain only letters (a-z, A-Z), numbers (0-9), and underscores (-). The maximum length is 63 characters. The ID must not start with a number. */
