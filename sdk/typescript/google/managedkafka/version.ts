...
const Version_ReferencesFields: FieldMap = {
  name: "name",
  subject: "subject",
  version: "version",
};
...
export interface VersionConfig {
  ...
  references?: Version_References[] | Computed<Version_References[]>;
...
export const Version: ResourceBinding<VersionConfig, VersionAttrs> = {
  wireType: "google_managedkafka_version",
  fields: {
    id: "id",
    normalize: "normalize",
    references: {
      wireName: "references",
      kind: "list",
      fields: Version_ReferencesFields,
    },
    schema: "schema",
