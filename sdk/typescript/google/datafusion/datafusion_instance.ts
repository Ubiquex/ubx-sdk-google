// Code generated by `ubx sdk gen` from google_datafusion_datafusion_instance. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface DatafusionInstance_Accelerators {
  acceleratorType?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface DatafusionInstance_AvailableVersion {
...
export interface DatafusionInstance_CryptoKeyConfig {
...
export interface DatafusionInstance_EventPublishConfig {
...
export interface DatafusionInstance_LoggingConfig {
...
export interface DatafusionInstance_MaintenanceEvents {
  endTime?: string | Computed<string>;
  startTime?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface DatafusionInstance_MaintenancePolicy_MaintenanceExclusionWindow {
...
export interface DatafusionInstance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindow {
  ...
  window?: DatafusionInstance_MaintenancePolicy_MaintenanceExclusionWindow | Computed<DatafusionInstance_MaintenancePolicy_MaintenanceExclusionWindow>;
}

export interface DatafusionInstance_MaintenancePolicy_MaintenanceWindow {
  /** Represents an arbitrary window of time that recurs. */
  recurringTimeWindow?: DatafusionInstance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindow | Computed<DatafusionInstance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindow>;
}

export interface DatafusionInstance_MaintenancePolicy {
  /** Represents an arbitrary window of time. */
  maintenanceExclusionWindow?: DatafusionInstance_MaintenancePolicy_MaintenanceExclusionWindow | Computed<DatafusionInstance_MaintenancePolicy_MaintenanceExclusionWindow>;
  /** Maintenance window of the instance. */
  maintenanceWindow?: DatafusionInstance_MaintenancePolicy_MaintenanceWindow | Computed<DatafusionInstance_MaintenancePolicy_MaintenanceWindow>;
}

export interface DatafusionInstance_MonitoringConfig {
...
export interface DatafusionInstance_NetworkConfig_PrivateServiceConnectConfig {
...
export interface DatafusionInstance_NetworkConfig {
  ...
  privateServiceConnectConfig?: DatafusionInstance_NetworkConfig_PrivateServiceConnectConfig | Computed<DatafusionInstance_NetworkConfig_PrivateServiceConnectConfig>;
}

const DatafusionInstance_AcceleratorsFields: FieldMap = {
  acceleratorType: "accelerator_type",
  state: "state",
};

const DatafusionInstance_AvailableVersionFields: FieldMap = {
...
const DatafusionInstance_CryptoKeyConfigFields: FieldMap = {
  keyReference: "key_reference",
};

const DatafusionInstance_EventPublishConfigFields: FieldMap = {
  enabled: "enabled",
  topic: "topic",
};

const DatafusionInstance_LoggingConfigFields: FieldMap = {
  enableInstanceV2Logs: "enable_instance_v2_logs",
  instanceCloudLoggingDisabled: "instance_cloud_logging_disabled",
};

const DatafusionInstance_MaintenanceEventsFields: FieldMap = {
  endTime: "end_time",
  startTime: "start_time",
  state: "state",
};

const DatafusionInstance_MaintenancePolicy_MaintenanceExclusionWindowFields: FieldMap = {
  endTime: "end_time",
  startTime: "start_time",
};

const DatafusionInstance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindowFields: FieldMap = {
  recurrence: "recurrence",
  window: {
    wireName: "window",
    kind: "object",
    fields: DatafusionInstance_MaintenancePolicy_MaintenanceExclusionWindowFields,
  },
};

const DatafusionInstance_MaintenancePolicy_MaintenanceWindowFields: FieldMap = {
  recurringTimeWindow: {
    wireName: "recurring_time_window",
    kind: "object",
    fields: DatafusionInstance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindowFields,
  },
};

const DatafusionInstance_MaintenancePolicyFields: FieldMap = {
  ...
  maintenanceWindow: {
    ...
    kind: "object",
    fields: DatafusionInstance_MaintenancePolicy_MaintenanceWindowFields,
  },
};

const DatafusionInstance_MonitoringConfigFields: FieldMap = {
  enableInstanceV2Metrics: "enable_instance_v2_metrics",
};

const DatafusionInstance_NetworkConfig_PrivateServiceConnectConfigFields: FieldMap = {
...
const DatafusionInstance_NetworkConfigFields: FieldMap = {
  ...
  privateServiceConnectConfig: {
    ...
    kind: "object",
    fields: DatafusionInstance_NetworkConfig_PrivateServiceConnectConfigFields,
  },
};

export interface DatafusionInstanceConfig {
  /** Output only. List of accelerators enabled for this CDF instance. */
  accelerators?: DatafusionInstance_Accelerators[] | Computed<DatafusionInstance_Accelerators[]>;
  ...
  availableVersion?: DatafusionInstance_AvailableVersion[] | Computed<DatafusionInstance_AvailableVersion[]>;
  /** Output only. The time the instance was created. */
  createTime?: string | Computed<string>;
  /** The crypto key configuration. This field is used by the Customer-managed encryption keys (CMEK) feature. */
  cryptoKeyConfig?: DatafusionInstance_CryptoKeyConfig | Computed<DatafusionInstance_CryptoKeyConfig>;
  ...
  eventPublishConfig?: DatafusionInstance_EventPublishConfig | Computed<DatafusionInstance_EventPublishConfig>;
  ...
  loggingConfig?: DatafusionInstance_LoggingConfig | Computed<DatafusionInstance_LoggingConfig>;
  /** Output only. The maintenance events for this instance. */
  maintenanceEvents?: DatafusionInstance_MaintenanceEvents[] | Computed<DatafusionInstance_MaintenanceEvents[]>;
  /** Maintenance policy of the instance. */
  maintenancePolicy?: DatafusionInstance_MaintenancePolicy | Computed<DatafusionInstance_MaintenancePolicy>;
  /** Monitoring configuration for a Data Fusion instance. */
  monitoringConfig?: DatafusionInstance_MonitoringConfig | Computed<DatafusionInstance_MonitoringConfig>;
  /** Output only. The name of this instance is in the form of projects/{project}/locations/{location}/instances/{instance}. */
  name?: string | Computed<string>;
  /** Network configuration for a Data Fusion instance. These configurations are used for peering with the customer network. Configurations are optional when a public Data Fusion instance is to be created. However, providing these configurations allows several benefits, such as reduced network latency while accessing the customer resources from managed Data Fusion instance nodes, as well as access to the customer on-prem resources. */
  networkConfig?: DatafusionInstance_NetworkConfig | Computed<DatafusionInstance_NetworkConfig>;
...
export interface DatafusionInstanceAttrs {
  /** Output only. List of accelerators enabled for this CDF instance. */
  accelerators: DatafusionInstance_Accelerators[];
  /** Output only. Endpoint on which the REST APIs is accessible. */
  apiEndpoint: string;
  /** Output only. Available versions that the instance can be upgraded to using UpdateInstanceRequest. */
  availableVersion: DatafusionInstance_AvailableVersion[];
  /** Output only. The time the instance was created. */
  createTime: string;
  /** The crypto key configuration. This field is used by the Customer-managed encryption keys (CMEK) feature. */
  cryptoKeyConfig: DatafusionInstance_CryptoKeyConfig;
  /** Optional. Option to enable the Dataplex Lineage Integration feature. */
  ...
  /** Confirguration of PubSubEventWriter. */
  eventPublishConfig: DatafusionInstance_EventPublishConfig;
  /** Output only. Cloud Storage bucket generated by Data Fusion in the customer project. */
  gcsBucket: string;
  /** The resource labels for instance to use to annotate any related underlying resources such as Compute Engine VMs. The character '=' is not allowed to be used within the labels. */
  labels: Record<string, string>;
  /** Logging configuration for a Data Fusion instance. */
  loggingConfig: DatafusionInstance_LoggingConfig;
  /** Output only. The maintenance events for this instance. */
  maintenanceEvents: DatafusionInstance_MaintenanceEvents[];
  /** Maintenance policy of the instance. */
  maintenancePolicy: DatafusionInstance_MaintenancePolicy;
  /** Monitoring configuration for a Data Fusion instance. */
  monitoringConfig: DatafusionInstance_MonitoringConfig;
  /** Output only. The name of this instance is in the form of projects/{project}/locations/{location}/instances/{instance}. */
  name: string;
  /** Network configuration for a Data Fusion instance. These configurations are used for peering with the customer network. Configurations are optional when a public Data Fusion instance is to be created. However, providing these configurations allows several benefits, such as reduced network latency while accessing the customer resources from managed Data Fusion instance nodes, as well as access to the customer on-prem resources. */
  networkConfig: DatafusionInstance_NetworkConfig;
  /** Optional. Map of additional options used to configure the behavior of Data Fusion instance. */
...
export const DatafusionInstance: ResourceBinding<DatafusionInstanceConfig, DatafusionInstanceAttrs> = {
  wireType: "google_datafusion_datafusion_instance",
  fields: {
    accelerators: {
      wireName: "accelerators",
      kind: "list",
      fields: DatafusionInstance_AcceleratorsFields,
    },
    apiEndpoint: "api_endpoint",
    availableVersion: {
      wireName: "available_version",
      kind: "list",
      fields: DatafusionInstance_AvailableVersionFields,
    },
    createTime: "create_time",
    cryptoKeyConfig: {
      wireName: "crypto_key_config",
      kind: "object",
      fields: DatafusionInstance_CryptoKeyConfigFields,
    },
    ...
    eventPublishConfig: {
      ...
      kind: "object",
      fields: DatafusionInstance_EventPublishConfigFields,
    },
    ...
    loggingConfig: {
      ...
      kind: "object",
      fields: DatafusionInstance_LoggingConfigFields,
    },
    maintenanceEvents: {
      wireName: "maintenance_events",
      kind: "list",
      fields: DatafusionInstance_MaintenanceEventsFields,
    },
    maintenancePolicy: {
      wireName: "maintenance_policy",
      kind: "object",
      fields: DatafusionInstance_MaintenancePolicyFields,
    },
    monitoringConfig: {
      wireName: "monitoring_config",
      kind: "object",
      fields: DatafusionInstance_MonitoringConfigFields,
    },
    name: "name",
    networkConfig: {
      wireName: "network_config",
      kind: "object",
      fields: DatafusionInstance_NetworkConfigFields,
    },
    options: "options",
