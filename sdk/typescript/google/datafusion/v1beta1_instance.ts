// Code generated by `ubx sdk gen` from google_datafusion_v1beta1_instance. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1Instance_Accelerators {
  acceleratorType?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface V1beta1Instance_AvailableVersion {
...
export interface V1beta1Instance_CryptoKeyConfig {
...
export interface V1beta1Instance_EventPublishConfig {
...
export interface V1beta1Instance_LoggingConfig {
...
export interface V1beta1Instance_MaintenanceEvents {
  endTime?: string | Computed<string>;
  startTime?: string | Computed<string>;
  state?: string | Computed<string>;
}

export interface V1beta1Instance_MaintenancePolicy_MaintenanceExclusionWindow {
...
export interface V1beta1Instance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindow {
  ...
  window?: V1beta1Instance_MaintenancePolicy_MaintenanceExclusionWindow | Computed<V1beta1Instance_MaintenancePolicy_MaintenanceExclusionWindow>;
}

export interface V1beta1Instance_MaintenancePolicy_MaintenanceWindow {
  /** Represents an arbitrary window of time that recurs. */
  recurringTimeWindow?: V1beta1Instance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindow | Computed<V1beta1Instance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindow>;
}

export interface V1beta1Instance_MaintenancePolicy {
  /** Represents an arbitrary window of time. */
  maintenanceExclusionWindow?: V1beta1Instance_MaintenancePolicy_MaintenanceExclusionWindow | Computed<V1beta1Instance_MaintenancePolicy_MaintenanceExclusionWindow>;
  /** Maintenance window of the instance. */
  maintenanceWindow?: V1beta1Instance_MaintenancePolicy_MaintenanceWindow | Computed<V1beta1Instance_MaintenancePolicy_MaintenanceWindow>;
}

export interface V1beta1Instance_MonitoringConfig {
...
export interface V1beta1Instance_NetworkConfig_PrivateServiceConnectConfig {
...
export interface V1beta1Instance_NetworkConfig {
  ...
  privateServiceConnectConfig?: V1beta1Instance_NetworkConfig_PrivateServiceConnectConfig | Computed<V1beta1Instance_NetworkConfig_PrivateServiceConnectConfig>;
}

const V1beta1Instance_AcceleratorsFields: FieldMap = {
  acceleratorType: "accelerator_type",
  state: "state",
};

const V1beta1Instance_AvailableVersionFields: FieldMap = {
...
const V1beta1Instance_CryptoKeyConfigFields: FieldMap = {
  keyReference: "key_reference",
};

const V1beta1Instance_EventPublishConfigFields: FieldMap = {
  enabled: "enabled",
  topic: "topic",
};

const V1beta1Instance_LoggingConfigFields: FieldMap = {
  enableInstanceV2Logs: "enable_instance_v2_logs",
  instanceCloudLoggingDisabled: "instance_cloud_logging_disabled",
};

const V1beta1Instance_MaintenanceEventsFields: FieldMap = {
  endTime: "end_time",
  startTime: "start_time",
  state: "state",
};

const V1beta1Instance_MaintenancePolicy_MaintenanceExclusionWindowFields: FieldMap = {
  endTime: "end_time",
  startTime: "start_time",
};

const V1beta1Instance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindowFields: FieldMap = {
...
const V1beta1Instance_MaintenancePolicy_MaintenanceWindowFields: FieldMap = {
  recurringTimeWindow: {
...
const V1beta1Instance_MonitoringConfigFields: FieldMap = {
  enableInstanceV2Metrics: "enable_instance_v2_metrics",
};

const V1beta1Instance_NetworkConfig_PrivateServiceConnectConfigFields: FieldMap = {
...
const V1beta1Instance_NetworkConfigFields: FieldMap = {
...
export interface V1beta1InstanceConfig {
  ...
  accelerators?: V1beta1Instance_Accelerators[] | Computed<V1beta1Instance_Accelerators[]>;
  ...
  availableVersion?: V1beta1Instance_AvailableVersion[] | Computed<V1beta1Instance_AvailableVersion[]>;
  /** Output only. The time the instance was created. */
  createTime?: string | Computed<string>;
  /** The crypto key configuration. This field is used by the Customer-managed encryption keys (CMEK) feature. */
  cryptoKeyConfig?: V1beta1Instance_CryptoKeyConfig | Computed<V1beta1Instance_CryptoKeyConfig>;
  ...
  eventPublishConfig?: V1beta1Instance_EventPublishConfig | Computed<V1beta1Instance_EventPublishConfig>;
  ...
  loggingConfig?: V1beta1Instance_LoggingConfig | Computed<V1beta1Instance_LoggingConfig>;
  /** Output only. The maintenance events for this instance. */
  maintenanceEvents?: V1beta1Instance_MaintenanceEvents[] | Computed<V1beta1Instance_MaintenanceEvents[]>;
  ...
  monitoringConfig?: V1beta1Instance_MonitoringConfig | Computed<V1beta1Instance_MonitoringConfig>;
  /** Output only. The name of this instance is in the form of projects/{project}/locations/{location}/instances/{instance}. */
  name?: string | Computed<string>;
  /** Network configuration for a Data Fusion instance. These configurations are used for peering with the customer network. Configurations are optional when a public Data Fusion instance is to be created. However, providing these configurations allows several benefits, such as reduced network latency while accessing the customer resources from managed Data Fusion instance nodes, as well as access to the customer on-prem resources. */
  networkConfig?: V1beta1Instance_NetworkConfig | Computed<V1beta1Instance_NetworkConfig>;
...
export interface V1beta1InstanceAttrs {
  /** Output only. List of accelerators enabled for this CDF instance. */
  accelerators: V1beta1Instance_Accelerators[];
  /** Output only. Endpoint on which the REST APIs is accessible. */
  apiEndpoint: string;
  /** Output only. Available versions that the instance can be upgraded to using UpdateInstanceRequest. */
  availableVersion: V1beta1Instance_AvailableVersion[];
  /** Output only. The time the instance was created. */
  createTime: string;
  /** The crypto key configuration. This field is used by the Customer-managed encryption keys (CMEK) feature. */
  cryptoKeyConfig: V1beta1Instance_CryptoKeyConfig;
  /** Optional. Option to enable the Dataplex Lineage Integration feature. */
  ...
  /** Confirguration of PubSubEventWriter. */
  eventPublishConfig: V1beta1Instance_EventPublishConfig;
  /** Output only. Cloud Storage bucket generated by Data Fusion in the customer project. */
  gcsBucket: string;
  /** The resource labels for instance to use to annotate any related underlying resources such as Compute Engine VMs. The character '=' is not allowed to be used within the labels. */
  labels: Record<string, string>;
  /** Logging configuration for a Data Fusion instance. */
  loggingConfig: V1beta1Instance_LoggingConfig;
  /** Output only. The maintenance events for this instance. */
  maintenanceEvents: V1beta1Instance_MaintenanceEvents[];
  /** Maintenance policy of the instance. */
  maintenancePolicy: V1beta1Instance_MaintenancePolicy;
  /** Monitoring configuration for a Data Fusion instance. */
  monitoringConfig: V1beta1Instance_MonitoringConfig;
  /** Output only. The name of this instance is in the form of projects/{project}/locations/{location}/instances/{instance}. */
  name: string;
  /** Network configuration for a Data Fusion instance. These configurations are used for peering with the customer network. Configurations are optional when a public Data Fusion instance is to be created. However, providing these configurations allows several benefits, such as reduced network latency while accessing the customer resources from managed Data Fusion instance nodes, as well as access to the customer on-prem resources. */
  networkConfig: V1beta1Instance_NetworkConfig;
  /** Optional. Map of additional options used to configure the behavior of Data Fusion instance. */
