...
export interface Instance_CryptoKeyConfig {
...
export interface Instance_EventPublishConfig {
...
export interface Instance_LoggingConfig {
...
export interface Instance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindow {
  ...
  window?: Instance_MaintenancePolicy_MaintenanceExclusionWindow | Computed<Instance_MaintenancePolicy_MaintenanceExclusionWindow>;
}

export interface Instance_MaintenancePolicy_MaintenanceWindow {
  /** Represents an arbitrary window of time that recurs. */
  recurringTimeWindow?: Instance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindow | Computed<Instance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindow>;
}
...
export interface Instance_MaintenancePolicy {
  ...
  maintenanceWindow?: Instance_MaintenancePolicy_MaintenanceWindow | Computed<Instance_MaintenancePolicy_MaintenanceWindow>;
}

export interface Instance_MonitoringConfig {
...
export interface Instance_NetworkConfig_PrivateServiceConnectConfig {
...
export interface Instance_NetworkConfig {
  ...
  privateServiceConnectConfig?: Instance_NetworkConfig_PrivateServiceConnectConfig | Computed<Instance_NetworkConfig_PrivateServiceConnectConfig>;
}

const Instance_AcceleratorsFields: FieldMap = {
  acceleratorType: "accelerator_type",
  state: "state",
};

const Instance_AvailableVersionFields: FieldMap = {
...
const Instance_CryptoKeyConfigFields: FieldMap = {
  keyReference: "key_reference",
};

const Instance_EventPublishConfigFields: FieldMap = {
  enabled: "enabled",
  topic: "topic",
};

const Instance_LoggingConfigFields: FieldMap = {
  enableInstanceV2Logs: "enable_instance_v2_logs",
  instanceCloudLoggingDisabled: "instance_cloud_logging_disabled",
};

const Instance_MaintenanceEventsFields: FieldMap = {
  endTime: "end_time",
...
const Instance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindowFields: FieldMap = {
...
const Instance_MaintenancePolicy_MaintenanceWindowFields: FieldMap = {
  recurringTimeWindow: {
...
const Instance_MonitoringConfigFields: FieldMap = {
  enableInstanceV2Metrics: "enable_instance_v2_metrics",
};

const Instance_NetworkConfig_PrivateServiceConnectConfigFields: FieldMap = {
...
export interface InstanceConfig {
  ...
  accelerators?: Instance_Accelerators[] | Computed<Instance_Accelerators[]>;
  ...
  availableVersion?: Instance_AvailableVersion[] | Computed<Instance_AvailableVersion[]>;
  /** Output only. The time the instance was created. */
  createTime?: string | Computed<string>;
  /** The crypto key configuration. This field is used by the Customer-managed encryption keys (CMEK) feature. */
  cryptoKeyConfig?: Instance_CryptoKeyConfig | Computed<Instance_CryptoKeyConfig>;
  ...
  eventPublishConfig?: Instance_EventPublishConfig | Computed<Instance_EventPublishConfig>;
  ...
  loggingConfig?: Instance_LoggingConfig | Computed<Instance_LoggingConfig>;
  /** Output only. The maintenance events for this instance. */
  maintenanceEvents?: Instance_MaintenanceEvents[] | Computed<Instance_MaintenanceEvents[]>;
  ...
  monitoringConfig?: Instance_MonitoringConfig | Computed<Instance_MonitoringConfig>;
...
export interface InstanceAttrs {
  /** Output only. List of accelerators enabled for this CDF instance. */
  accelerators: Instance_Accelerators[];
  /** Output only. Endpoint on which the REST APIs is accessible. */
  apiEndpoint: string;
  /** Output only. Available versions that the instance can be upgraded to using UpdateInstanceRequest. */
  availableVersion: Instance_AvailableVersion[];
  /** Output only. The time the instance was created. */
  createTime: string;
  /** The crypto key configuration. This field is used by the Customer-managed encryption keys (CMEK) feature. */
  cryptoKeyConfig: Instance_CryptoKeyConfig;
  /** Optional. Option to enable the Dataplex Lineage Integration feature. */
  ...
  /** Confirguration of PubSubEventWriter. */
  eventPublishConfig: Instance_EventPublishConfig;
  /** Output only. Cloud Storage bucket generated by Data Fusion in the customer project. */
  gcsBucket: string;
  /** The resource labels for instance to use to annotate any related underlying resources such as Compute Engine VMs. The character '=' is not allowed to be used within the labels. */
  labels: Record<string, string>;
  /** Logging configuration for a Data Fusion instance. */
  loggingConfig: Instance_LoggingConfig;
  /** Output only. The maintenance events for this instance. */
  maintenanceEvents: Instance_MaintenanceEvents[];
  /** Maintenance policy of the instance. */
  maintenancePolicy: Instance_MaintenancePolicy;
  /** Monitoring configuration for a Data Fusion instance. */
  monitoringConfig: Instance_MonitoringConfig;
  /** Output only. The name of this instance is in the form of projects/{project}/locations/{location}/instances/{instance}. */
  name: string;
  /** Network configuration for a Data Fusion instance. These configurations are used for peering with the customer network. Configurations are optional when a public Data Fusion instance is to be created. However, providing these configurations allows several benefits, such as reduced network latency while accessing the customer resources from managed Data Fusion instance nodes, as well as access to the customer on-prem resources. */
...
export const Instance: ResourceBinding<InstanceConfig, InstanceAttrs> = {
  wireType: "google_datafusion_instance",
  fields: {
    accelerators: {
      wireName: "accelerators",
      kind: "list",
      fields: Instance_AcceleratorsFields,
    },
    apiEndpoint: "api_endpoint",
    availableVersion: {
      wireName: "available_version",
      kind: "list",
      fields: Instance_AvailableVersionFields,
    },
    ...
    maintenanceEvents: {
      ...
      kind: "list",
      fields: Instance_MaintenanceEventsFields,
    },
    maintenancePolicy: {
