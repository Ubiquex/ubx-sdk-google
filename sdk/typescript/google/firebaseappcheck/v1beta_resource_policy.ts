...
export interface V1betaResourcePolicyConfig {
...
export interface V1betaResourcePolicyAttrs {
  /** Required. The baseline protection EnforcementMode for this resource. This will override the service-level baseline protection EnforcementMode. */
...
export const V1betaResourcePolicy: ResourceBinding<V1betaResourcePolicyConfig, V1betaResourcePolicyAttrs> = {
