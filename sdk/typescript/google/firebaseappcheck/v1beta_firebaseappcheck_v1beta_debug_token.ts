// Code generated by `ubx sdk gen` from google_firebaseappcheck_v1beta_firebaseappcheck_v1beta_debug_token. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1betaFirebaseappcheckV1betaDebugTokenConfig {
...
export interface V1betaFirebaseappcheckV1betaDebugTokenAttrs {
  /** Required. A human readable display name used to identify this debug token. */
  displayName: string;
  /** Optional. This checksum is computed by the server based on the value of other fields, and may be sent on update and delete requests to ensure the client has an up-to-date value before proceeding. This etag is strongly validated as defined by RFC 7232. */
  etag: string;
...
export const V1betaFirebaseappcheckV1betaDebugToken: ResourceBinding<V1betaFirebaseappcheckV1betaDebugTokenConfig, V1betaFirebaseappcheckV1betaDebugTokenAttrs> = {
  wireType: "google_firebaseappcheck_v1beta_firebaseappcheck_v1beta_debug_token",
  fields: {
