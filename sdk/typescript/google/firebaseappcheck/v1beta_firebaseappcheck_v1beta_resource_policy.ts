// Code generated by `ubx sdk gen` from google_firebaseappcheck_v1beta_firebaseappcheck_v1beta_resource_policy. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1betaFirebaseappcheckV1betaResourcePolicyConfig {
...
export interface V1betaFirebaseappcheckV1betaResourcePolicyAttrs {
  /** Required. The baseline protection EnforcementMode for this resource. This will override the service-level baseline protection EnforcementMode. */
...
export const V1betaFirebaseappcheckV1betaResourcePolicy: ResourceBinding<V1betaFirebaseappcheckV1betaResourcePolicyConfig, V1betaFirebaseappcheckV1betaResourcePolicyAttrs> = {
  wireType: "google_firebaseappcheck_v1beta_firebaseappcheck_v1beta_resource_policy",
  fields: {
