// Code generated by `ubx sdk gen` from google_firebaseapphosting_firebaseapphosting_backend. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface FirebaseapphostingBackend_Codebase {
...
export interface FirebaseapphostingBackend_ManagedResources_RunService {
  service?: string | Computed<string>;
}

export interface FirebaseapphostingBackend_ManagedResources {
  runService?: FirebaseapphostingBackend_ManagedResources_RunService | Computed<FirebaseapphostingBackend_ManagedResources_RunService>;
}

const FirebaseapphostingBackend_CodebaseFields: FieldMap = {
  repository: "repository",
  rootDirectory: "root_directory",
};

const FirebaseapphostingBackend_ManagedResources_RunServiceFields: FieldMap = {
  service: "service",
};

const FirebaseapphostingBackend_ManagedResourcesFields: FieldMap = {
  runService: {
    wireName: "run_service",
    kind: "object",
    fields: FirebaseapphostingBackend_ManagedResources_RunServiceFields,
  },
};

export interface FirebaseapphostingBackendConfig {
  ...
  codebase?: FirebaseapphostingBackend_Codebase | Computed<FirebaseapphostingBackend_Codebase>;
  ...
  managedResources?: FirebaseapphostingBackend_ManagedResources[] | Computed<FirebaseapphostingBackend_ManagedResources[]>;
...
export interface FirebaseapphostingBackendAttrs {
  /** Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects. */
  annotations: Record<string, string>;
  /** Optional. The [ID of a Web App](https://firebase.google.com/docs/reference/firebase-management/rest/v1beta1/projects.webApps#WebApp.FIELDS.app_id) associated with the backend. */
  appId: string;
  /** The connection to an external source repository to watch for event-driven updates to the backend. */
  codebase: FirebaseapphostingBackend_Codebase;
  /** Output only. Time at which the backend was created. */
  createTime: string;
  /** Output only. Time at which the backend was deleted. */
  deleteTime: string;
  ...
  /** Output only. A list of the resources managed by this backend. */
  managedResources: FirebaseapphostingBackend_ManagedResources[];
  /** Optional. Deprecated: Use `environment` instead. */
  mode: string;
  /** Identifier. The resource name of the backend. Format: `projects/{project}/locations/{locationId}/backends/{backendId}`. */
  name: string;
...
export const FirebaseapphostingBackend: ResourceBinding<FirebaseapphostingBackendConfig, FirebaseapphostingBackendAttrs> = {
  wireType: "google_firebaseapphosting_firebaseapphosting_backend",
  fields: {
    ...
    codebase: {
      wireName: "codebase",
      kind: "object",
      fields: FirebaseapphostingBackend_CodebaseFields,
    },
    ...
    managedResources: {
      ...
      kind: "list",
      fields: FirebaseapphostingBackend_ManagedResourcesFields,
    },
    mode: "mode",
    name: "name",
