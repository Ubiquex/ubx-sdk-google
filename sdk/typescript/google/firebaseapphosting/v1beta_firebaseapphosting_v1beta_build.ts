// Code generated by `ubx sdk gen` from google_firebaseapphosting_v1beta_firebaseapphosting_v1beta_build. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1betaFirebaseapphostingV1betaBuild_Config_EffectiveEnv {
...
export interface V1betaFirebaseapphostingV1betaBuild_Config_RunConfig {
...
export interface V1betaFirebaseapphostingV1betaBuild_Config {
  ...
  effectiveEnv?: V1betaFirebaseapphostingV1betaBuild_Config_EffectiveEnv[] | Computed<V1betaFirebaseapphostingV1betaBuild_Config_EffectiveEnv[]>;
  ...
  env?: V1betaFirebaseapphostingV1betaBuild_Config_EffectiveEnv[] | Computed<V1betaFirebaseapphostingV1betaBuild_Config_EffectiveEnv[]>;
  ...
  runConfig?: V1betaFirebaseapphostingV1betaBuild_Config_RunConfig | Computed<V1betaFirebaseapphostingV1betaBuild_Config_RunConfig>;
}

export interface V1betaFirebaseapphostingV1betaBuild_Error {
...
export interface V1betaFirebaseapphostingV1betaBuild_Errors {
  cloudResource?: string | Computed<string>;
  error?: V1betaFirebaseapphostingV1betaBuild_Error | Computed<V1betaFirebaseapphostingV1betaBuild_Error>;
  errorSource?: string | Computed<string>;
}

export interface V1betaFirebaseapphostingV1betaBuild_Source_Archive_Author {
...
export interface V1betaFirebaseapphostingV1betaBuild_Source_Archive {
  /** Deprecated: Not used. Metadata for the user who started the build. */
  author?: V1betaFirebaseapphostingV1betaBuild_Source_Archive_Author | Computed<V1betaFirebaseapphostingV1betaBuild_Source_Archive_Author>;
...
export interface V1betaFirebaseapphostingV1betaBuild_Source_Codebase {
...
export interface V1betaFirebaseapphostingV1betaBuild_Source_Container {
  /** Required. A URI representing a container for the backend to use. */
  image?: string | Computed<string>;
}

export interface V1betaFirebaseapphostingV1betaBuild_Source_LocallyBuilt {
  /** Optional. An optional message that describes the uploaded version of the source code. */
  description?: string | Computed<string>;
...
export interface V1betaFirebaseapphostingV1betaBuild_Source {
  /** The URI of an storage archive or a signed URL to use as the build source. */
  archive?: V1betaFirebaseapphostingV1betaBuild_Source_Archive | Computed<V1betaFirebaseapphostingV1betaBuild_Source_Archive>;
  /** A codebase source, representing the state of the codebase that the build will be created at. */
  codebase?: V1betaFirebaseapphostingV1betaBuild_Source_Codebase | Computed<V1betaFirebaseapphostingV1betaBuild_Source_Codebase>;
  ...
  container?: V1betaFirebaseapphostingV1betaBuild_Source_Container | Computed<V1betaFirebaseapphostingV1betaBuild_Source_Container>;
  /** The URI of an storage archive to use as the build source. */
  locallyBuilt?: V1betaFirebaseapphostingV1betaBuild_Source_LocallyBuilt | Computed<V1betaFirebaseapphostingV1betaBuild_Source_LocallyBuilt>;
}

const V1betaFirebaseapphostingV1betaBuild_Config_EffectiveEnvFields: FieldMap = {
...
const V1betaFirebaseapphostingV1betaBuild_Config_RunConfigFields: FieldMap = {
...
const V1betaFirebaseapphostingV1betaBuild_ConfigFields: FieldMap = {
  effectiveEnv: {
    wireName: "effective_env",
    kind: "list",
    fields: V1betaFirebaseapphostingV1betaBuild_Config_EffectiveEnvFields,
  },
  env: {
    wireName: "env",
    kind: "list",
  ...
  runConfig: {
    wireName: "run_config",
    kind: "object",
    fields: V1betaFirebaseapphostingV1betaBuild_Config_RunConfigFields,
  },
};

const V1betaFirebaseapphostingV1betaBuild_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const V1betaFirebaseapphostingV1betaBuild_ErrorsFields: FieldMap = {
  cloudResource: "cloud_resource",
  error: {
    wireName: "error",
    kind: "object",
    fields: V1betaFirebaseapphostingV1betaBuild_ErrorFields,
  },
  errorSource: "error_source",
};

const V1betaFirebaseapphostingV1betaBuild_Source_Archive_AuthorFields: FieldMap = {
  displayName: "display_name",
  email: "email",
  imageUri: "image_uri",
};

const V1betaFirebaseapphostingV1betaBuild_Source_ArchiveFields: FieldMap = {
  author: {
    wireName: "author",
    kind: "object",
    fields: V1betaFirebaseapphostingV1betaBuild_Source_Archive_AuthorFields,
  },
...
const V1betaFirebaseapphostingV1betaBuild_Source_CodebaseFields: FieldMap = {
  author: {
    wireName: "author",
    kind: "object",
    fields: V1betaFirebaseapphostingV1betaBuild_Source_Archive_AuthorFields,
...
const V1betaFirebaseapphostingV1betaBuild_Source_ContainerFields: FieldMap = {
  image: "image",
};

const V1betaFirebaseapphostingV1betaBuild_Source_LocallyBuiltFields: FieldMap = {
  description: "description",
  env: {
    wireName: "env",
    kind: "list",
...
const V1betaFirebaseapphostingV1betaBuild_SourceFields: FieldMap = {
  archive: {
    wireName: "archive",
    kind: "object",
    fields: V1betaFirebaseapphostingV1betaBuild_Source_ArchiveFields,
  },
  codebase: {
    wireName: "codebase",
    kind: "object",
    fields: V1betaFirebaseapphostingV1betaBuild_Source_CodebaseFields,
  },
  container: {
    wireName: "container",
    kind: "object",
    fields: V1betaFirebaseapphostingV1betaBuild_Source_ContainerFields,
  },
  locallyBuilt: {
    wireName: "locally_built",
    kind: "object",
    fields: V1betaFirebaseapphostingV1betaBuild_Source_LocallyBuiltFields,
  },
};

export interface V1betaFirebaseapphostingV1betaBuildConfig {
  ...
  config?: V1betaFirebaseapphostingV1betaBuild_Config | Computed<V1betaFirebaseapphostingV1betaBuild_Config>;
  ...
  errors?: V1betaFirebaseapphostingV1betaBuild_Errors[] | Computed<V1betaFirebaseapphostingV1betaBuild_Errors[]>;
  ...
  source?: V1betaFirebaseapphostingV1betaBuild_Source | Computed<V1betaFirebaseapphostingV1betaBuild_Source>;
...
export interface V1betaFirebaseapphostingV1betaBuildAttrs {
  /** Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects. */
  annotations: Record<string, string>;
  /** Output only. The location of the [Cloud Build logs](https://cloud.google.com/build/docs/view-build-results) for the build process. */
  buildLogsUri: string;
  /** Additional configuration of the backend for this build. */
  config: V1betaFirebaseapphostingV1betaBuild_Config;
  /** Output only. Time at which the build was created. */
  createTime: string;
  /** Output only. Time at which the build was deleted. */
  deleteTime: string;
  ...
  environment: string;
  /** The `Status` type defines a logical error model that is suitable for different programming environments, including REST APIs and RPC APIs. It is used by [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error code, error message, and error details. You can find out more about this error model and how to work with it in the [API Design Guide](https://cloud.google.com/apis/design/errors). */
  error: V1betaFirebaseapphostingV1betaBuild_Error;
  /** Output only. Deprecated: Use `errors` instead. The source of the error for the build, if in a `FAILED` state. */
  errorSource: string;
  /** Output only. A list of all errors that occurred during an App Hosting build. */
  errors: V1betaFirebaseapphostingV1betaBuild_Errors[];
  /** Output only. Server-computed checksum based on other values; may be sent on update or delete to ensure operation is done on expected resource. */
  etag: string;
  /** Output only. The Artifact Registry [container image](https://cloud.google.com/artifact-registry/docs/reference/rest/v1/projects.locations.repositories.dockerImages) URI, used by the Cloud Run [`revision`](https://cloud.google.com/run/docs/reference/rest/v2/projects.locations.services.revisions) for this build. */
  image: string;
  ...
  reconciling: boolean;
  /** The source for the build. */
  source: V1betaFirebaseapphostingV1betaBuild_Source;
  /** Output only. The state of the build. */
  state: string;
  /** Output only. System-assigned, unique identifier. */
  uid: string;
...
export const V1betaFirebaseapphostingV1betaBuild: ResourceBinding<V1betaFirebaseapphostingV1betaBuildConfig, V1betaFirebaseapphostingV1betaBuildAttrs> = {
  wireType: "google_firebaseapphosting_v1beta_firebaseapphosting_v1beta_build",
  fields: {
    ...
    config: {
      wireName: "config",
      kind: "object",
      fields: V1betaFirebaseapphostingV1betaBuild_ConfigFields,
    },
    ...
    errors: {
      wireName: "errors",
      kind: "list",
      fields: V1betaFirebaseapphostingV1betaBuild_ErrorsFields,
    },
    etag: "etag",
    image: "image",
    labels: "labels",
    ...
    source: {
      wireName: "source",
      kind: "object",
      fields: V1betaFirebaseapphostingV1betaBuild_SourceFields,
    },
    state: "state",
    uid: "uid",
