// Code generated by `ubx sdk gen` from google_firebaseapphosting_firebaseapphosting_build. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface FirebaseapphostingBuild_Config_EffectiveEnv {
...
export interface FirebaseapphostingBuild_Config_RunConfig {
...
export interface FirebaseapphostingBuild_Config {
  ...
  effectiveEnv?: FirebaseapphostingBuild_Config_EffectiveEnv[] | Computed<FirebaseapphostingBuild_Config_EffectiveEnv[]>;
  ...
  env?: FirebaseapphostingBuild_Config_EffectiveEnv[] | Computed<FirebaseapphostingBuild_Config_EffectiveEnv[]>;
  ...
  runConfig?: FirebaseapphostingBuild_Config_RunConfig | Computed<FirebaseapphostingBuild_Config_RunConfig>;
}

export interface FirebaseapphostingBuild_Errors_Error {
  code?: number | Computed<number>;
  details?: Record<string, unknown>[] | Computed<Record<string, unknown>[]>;
  message?: string | Computed<string>;
}

export interface FirebaseapphostingBuild_Errors {
  cloudResource?: string | Computed<string>;
  error?: FirebaseapphostingBuild_Errors_Error | Computed<FirebaseapphostingBuild_Errors_Error>;
  errorSource?: string | Computed<string>;
}

export interface FirebaseapphostingBuild_Source_Archive_Author {
...
export interface FirebaseapphostingBuild_Source_Archive {
  /** Deprecated: Not used. Metadata for the user who started the build. */
  author?: FirebaseapphostingBuild_Source_Archive_Author | Computed<FirebaseapphostingBuild_Source_Archive_Author>;
...
export interface FirebaseapphostingBuild_Source_Codebase {
...
export interface FirebaseapphostingBuild_Source_Container {
  /** Required. A URI representing a container for the backend to use. */
  image?: string | Computed<string>;
}

export interface FirebaseapphostingBuild_Source {
  /** The URI of an storage archive or a signed URL to use as the build source. */
  archive?: FirebaseapphostingBuild_Source_Archive | Computed<FirebaseapphostingBuild_Source_Archive>;
  /** A codebase source, representing the state of the codebase that the build will be created at. */
  codebase?: FirebaseapphostingBuild_Source_Codebase | Computed<FirebaseapphostingBuild_Source_Codebase>;
  ...
  container?: FirebaseapphostingBuild_Source_Container | Computed<FirebaseapphostingBuild_Source_Container>;
}

const FirebaseapphostingBuild_Config_EffectiveEnvFields: FieldMap = {
...
const FirebaseapphostingBuild_Config_RunConfigFields: FieldMap = {
...
const FirebaseapphostingBuild_ConfigFields: FieldMap = {
  effectiveEnv: {
    wireName: "effective_env",
    kind: "list",
    fields: FirebaseapphostingBuild_Config_EffectiveEnvFields,
  },
  env: {
    wireName: "env",
    kind: "list",
  ...
  runConfig: {
    wireName: "run_config",
    kind: "object",
    fields: FirebaseapphostingBuild_Config_RunConfigFields,
  },
};

const FirebaseapphostingBuild_Errors_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const FirebaseapphostingBuild_ErrorsFields: FieldMap = {
  cloudResource: "cloud_resource",
  error: {
    wireName: "error",
    kind: "object",
    fields: FirebaseapphostingBuild_Errors_ErrorFields,
  },
  errorSource: "error_source",
};

const FirebaseapphostingBuild_Source_Archive_AuthorFields: FieldMap = {
  displayName: "display_name",
  email: "email",
  imageUri: "image_uri",
};

const FirebaseapphostingBuild_Source_ArchiveFields: FieldMap = {
  author: {
    wireName: "author",
    kind: "object",
    fields: FirebaseapphostingBuild_Source_Archive_AuthorFields,
  },
...
const FirebaseapphostingBuild_Source_CodebaseFields: FieldMap = {
  author: {
    wireName: "author",
    kind: "object",
    fields: FirebaseapphostingBuild_Source_Archive_AuthorFields,
...
const FirebaseapphostingBuild_Source_ContainerFields: FieldMap = {
  image: "image",
};

const FirebaseapphostingBuild_SourceFields: FieldMap = {
  archive: {
    wireName: "archive",
    kind: "object",
    fields: FirebaseapphostingBuild_Source_ArchiveFields,
  },
  codebase: {
    wireName: "codebase",
    kind: "object",
    fields: FirebaseapphostingBuild_Source_CodebaseFields,
  },
  container: {
    wireName: "container",
    kind: "object",
    fields: FirebaseapphostingBuild_Source_ContainerFields,
  },
};

export interface FirebaseapphostingBuildConfig {
  ...
  config?: FirebaseapphostingBuild_Config | Computed<FirebaseapphostingBuild_Config>;
  ...
  errors?: FirebaseapphostingBuild_Errors[] | Computed<FirebaseapphostingBuild_Errors[]>;
  ...
  source?: FirebaseapphostingBuild_Source | Computed<FirebaseapphostingBuild_Source>;
...
export interface FirebaseapphostingBuildAttrs {
  /** Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects. */
  annotations: Record<string, string>;
  /** Output only. The location of the [Cloud Build logs](https://cloud.google.com/build/docs/view-build-results) for the build process. */
  buildLogsUri: string;
  /** Additional configuration of the backend for this build. */
  config: FirebaseapphostingBuild_Config;
  /** Output only. Time at which the build was created. */
  createTime: string;
  /** Output only. Time at which the build was deleted. */
  deleteTime: string;
  ...
  environment: string;
  /** Output only. A list of all errors that occurred during an App Hosting build. */
  errors: FirebaseapphostingBuild_Errors[];
  /** Output only. Server-computed checksum based on other values; may be sent on update or delete to ensure operation is done on expected resource. */
  etag: string;
  /** Output only. The Artifact Registry [container image](https://cloud.google.com/artifact-registry/docs/reference/rest/v1/projects.locations.repositories.dockerImages) URI, used by the Cloud Run [`revision`](https://cloud.google.com/run/docs/reference/rest/v2/projects.locations.services.revisions) for this build. */
  image: string;
  ...
  reconciling: boolean;
  /** The source for the build. */
  source: FirebaseapphostingBuild_Source;
  /** Output only. The state of the build. */
  state: string;
  /** Output only. System-assigned, unique identifier. */
  uid: string;
...
export const FirebaseapphostingBuild: ResourceBinding<FirebaseapphostingBuildConfig, FirebaseapphostingBuildAttrs> = {
  wireType: "google_firebaseapphosting_firebaseapphosting_build",
  fields: {
    ...
    config: {
      wireName: "config",
      kind: "object",
      fields: FirebaseapphostingBuild_ConfigFields,
    },
    ...
    errors: {
      wireName: "errors",
      kind: "list",
      fields: FirebaseapphostingBuild_ErrorsFields,
    },
    etag: "etag",
    image: "image",
    labels: "labels",
    ...
    source: {
      wireName: "source",
      kind: "object",
      fields: FirebaseapphostingBuild_SourceFields,
    },
    state: "state",
    uid: "uid",
