...
export interface V1betaBuild_Config_EffectiveEnv {
...
export interface V1betaBuild_Config_RunConfig {
...
export interface V1betaBuild_Config {
  ...
  effectiveEnv?: V1betaBuild_Config_EffectiveEnv[] | Computed<V1betaBuild_Config_EffectiveEnv[]>;
  ...
  env?: V1betaBuild_Config_EffectiveEnv[] | Computed<V1betaBuild_Config_EffectiveEnv[]>;
  ...
  runConfig?: V1betaBuild_Config_RunConfig | Computed<V1betaBuild_Config_RunConfig>;
}

export interface V1betaBuild_Error {
...
export interface V1betaBuild_Source_Archive {
  /** Deprecated: Not used. Metadata for the user who started the build. */
  author?: V1betaBuild_Source_Archive_Author | Computed<V1betaBuild_Source_Archive_Author>;
...
export interface V1betaBuild_Source_Codebase {
...
export interface V1betaBuild_Source_Container {
  /** Required. A URI representing a container for the backend to use. */
  image?: string | Computed<string>;
}

export interface V1betaBuild_Source_LocallyBuilt {
  /** Optional. An optional message that describes the uploaded version of the source code. */
  description?: string | Computed<string>;
...
export interface V1betaBuild_Source {
  /** The URI of an storage archive or a signed URL to use as the build source. */
  archive?: V1betaBuild_Source_Archive | Computed<V1betaBuild_Source_Archive>;
  /** A codebase source, representing the state of the codebase that the build will be created at. */
  codebase?: V1betaBuild_Source_Codebase | Computed<V1betaBuild_Source_Codebase>;
  ...
  container?: V1betaBuild_Source_Container | Computed<V1betaBuild_Source_Container>;
  /** The URI of an storage archive to use as the build source. */
  locallyBuilt?: V1betaBuild_Source_LocallyBuilt | Computed<V1betaBuild_Source_LocallyBuilt>;
}

const V1betaBuild_Config_EffectiveEnvFields: FieldMap = {
...
const V1betaBuild_Config_RunConfigFields: FieldMap = {
...
const V1betaBuild_ConfigFields: FieldMap = {
  effectiveEnv: {
...
const V1betaBuild_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};
...
const V1betaBuild_Source_ArchiveFields: FieldMap = {
  author: {
    wireName: "author",
    kind: "object",
...
const V1betaBuild_Source_CodebaseFields: FieldMap = {
  author: {
    wireName: "author",
    kind: "object",
    fields: V1betaBuild_Source_Archive_AuthorFields,
...
const V1betaBuild_Source_ContainerFields: FieldMap = {
  image: "image",
};

const V1betaBuild_Source_LocallyBuiltFields: FieldMap = {
  description: "description",
  env: {
    wireName: "env",
    kind: "list",
...
const V1betaBuild_SourceFields: FieldMap = {
  archive: {
    wireName: "archive",
    kind: "object",
...
export interface V1betaBuildAttrs {
  ...
  environment: string;
  /** The `Status` type defines a logical error model that is suitable for different programming environments, including REST APIs and RPC APIs. It is used by [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error code, error message, and error details. You can find out more about this error model and how to work with it in the [API Design Guide](https://cloud.google.com/apis/design/errors). */
  error: V1betaBuild_Error;
  /** Output only. Deprecated: Use `errors` instead. The source of the error for the build, if in a `FAILED` state. */
  errorSource: string;
  /** Output only. A list of all errors that occurred during an App Hosting build. */
  errors: V1betaBuild_Errors[];
  /** Output only. Server-computed checksum based on other values; may be sent on update or delete to ensure operation is done on expected resource. */
  etag: string;
  /** Output only. The Artifact Registry [container image](https://cloud.google.com/artifact-registry/docs/reference/rest/v1/projects.locations.repositories.dockerImages) URI, used by the Cloud Run [`revision`](https://cloud.google.com/run/docs/reference/rest/v2/projects.locations.services.revisions) for this build. */
  image: string;
...
export const V1betaBuild: ResourceBinding<V1betaBuildConfig, V1betaBuildAttrs> = {
