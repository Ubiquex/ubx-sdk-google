...
export interface V1betaBackend_Codebase {
...
export interface V1betaBackend_ManagedResources_RunService {
  service?: string | Computed<string>;
}

export interface V1betaBackend_ManagedResources {
  runService?: V1betaBackend_ManagedResources_RunService | Computed<V1betaBackend_ManagedResources_RunService>;
}

export interface V1betaBackend_OverrideEnv {
...
export interface V1betaBackend_Runtime {
  /** Optional. The value of the runtime. */
  value?: string | Computed<string>;
}

const V1betaBackend_CodebaseFields: FieldMap = {
...
const V1betaBackend_RuntimeFields: FieldMap = {
  value: "value",
};

export interface V1betaBackendConfig {
  ...
  runtime?: V1betaBackend_Runtime | Computed<V1betaBackend_Runtime>;
...
export interface V1betaBackendAttrs {
  ...
  /** The connection to an external source repository to watch for event-driven updates to the backend. */
  codebase: V1betaBackend_Codebase;
  ...
  managedResources: V1betaBackend_ManagedResources[];
  /** Optional. Deprecated: Use `environment` instead. */
  mode: string;
  /** Identifier. The resource name of the backend. Format: `projects/{project}/locations/{locationId}/backends/{backendId}`. */
  name: string;
  /** Optional. Override environment variables for this Backend. */
  overrideEnv: V1betaBackend_OverrideEnv[];
...
export const V1betaBackend: ResourceBinding<V1betaBackendConfig, V1betaBackendAttrs> = {
