// Code generated by `ubx sdk gen` from google_firebaseapphosting_v1beta_domain. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1betaDomain_CustomDomainStatus_Issues {
  code?: number | Computed<number>;
  details?: Record<string, unknown>[] | Computed<Record<string, unknown>[]>;
  message?: string | Computed<string>;
}

export interface V1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired_Records {
...
export interface V1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired {
  checkError?: V1betaDomain_CustomDomainStatus_Issues | Computed<V1betaDomain_CustomDomainStatus_Issues>;
  domainName?: string | Computed<string>;
  records?: V1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired_Records[] | Computed<V1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired_Records[]>;
}

export interface V1betaDomain_CustomDomainStatus_RequiredDnsUpdates {
  checkTime?: string | Computed<string>;
  desired?: V1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired[] | Computed<V1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired[]>;
  discovered?: V1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired[] | Computed<V1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired[]>;
  domainName?: string | Computed<string>;
}

export interface V1betaDomain_CustomDomainStatus {
  ...
  issues?: V1betaDomain_CustomDomainStatus_Issues[] | Computed<V1betaDomain_CustomDomainStatus_Issues[]>;
  ...
  requiredDnsUpdates?: V1betaDomain_CustomDomainStatus_RequiredDnsUpdates[] | Computed<V1betaDomain_CustomDomainStatus_RequiredDnsUpdates[]>;
}

export interface V1betaDomain_Serve_Redirect {
...
export interface V1betaDomain_Serve {
  /** Specifies redirect behavior for a domain. */
  redirect?: V1betaDomain_Serve_Redirect | Computed<V1betaDomain_Serve_Redirect>;
}

const V1betaDomain_CustomDomainStatus_IssuesFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const V1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired_RecordsFields: FieldMap = {
...
const V1betaDomain_CustomDomainStatus_RequiredDnsUpdates_DesiredFields: FieldMap = {
  checkError: {
...
const V1betaDomain_CustomDomainStatus_RequiredDnsUpdatesFields: FieldMap = {
...
const V1betaDomain_CustomDomainStatusFields: FieldMap = {
...
const V1betaDomain_Serve_RedirectFields: FieldMap = {
  status: "status",
  uri: "uri",
};

const V1betaDomain_ServeFields: FieldMap = {
  redirect: {
    wireName: "redirect",
    kind: "object",
...
export interface V1betaDomainAttrs {
  ...
  createTime: string;
  /** The status of a custom domain's linkage to a backend. */
  customDomainStatus: V1betaDomain_CustomDomainStatus;
  /** Output only. Time at which the domain was deleted. */
  deleteTime: string;
  /** Optional. Whether the domain is disabled. Defaults to false. */
  disabled: boolean;
...
export const V1betaDomain: ResourceBinding<V1betaDomainConfig, V1betaDomainAttrs> = {
