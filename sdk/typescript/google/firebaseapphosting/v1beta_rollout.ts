// Code generated by `ubx sdk gen` from google_firebaseapphosting_v1beta_rollout. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1betaRollout_Error {
...
const V1betaRollout_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};
...
export const V1betaRollout: ResourceBinding<V1betaRolloutConfig, V1betaRolloutAttrs> = {
