// Code generated by `ubx sdk gen` from google_firebaseapphosting_firebaseapphosting_rollout. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface FirebaseapphostingRollout_Error {
...
const FirebaseapphostingRollout_ErrorFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

export interface FirebaseapphostingRolloutConfig {
  ...
  error?: FirebaseapphostingRollout_Error | Computed<FirebaseapphostingRollout_Error>;
...
export interface FirebaseapphostingRolloutAttrs {
  /** Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects. */
  ...
  displayName: string;
  /** The `Status` type defines a logical error model that is suitable for different programming environments, including REST APIs and RPC APIs. It is used by [gRPC](https://github.com/grpc). Each `Status` message contains three pieces of data: error code, error message, and error details. You can find out more about this error model and how to work with it in the [API Design Guide](https://cloud.google.com/apis/design/errors). */
  error: FirebaseapphostingRollout_Error;
  /** Output only. Server-computed checksum based on other values; may be sent on update or delete to ensure operation is done on expected resource. */
  etag: string;
  /** Optional. Unstructured key value map that can be used to organize and categorize objects. */
...
export const FirebaseapphostingRollout: ResourceBinding<FirebaseapphostingRolloutConfig, FirebaseapphostingRolloutAttrs> = {
  wireType: "google_firebaseapphosting_firebaseapphosting_rollout",
  fields: {
    ...
    error: {
      wireName: "error",
      kind: "object",
      fields: FirebaseapphostingRollout_ErrorFields,
    },
    etag: "etag",
    labels: "labels",
    name: "name",
