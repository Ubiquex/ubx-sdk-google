...
export interface IamOauthClientConfig {
...
export interface IamOauthClientAttrs {
  /** Required. The list of OAuth grant types is allowed for the OauthClient. */
...
export const IamOauthClient: ResourceBinding<IamOauthClientConfig, IamOauthClientAttrs> = {
