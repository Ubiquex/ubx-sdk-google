...
export interface IamProvider_ExtendedAttributesOauth2Client_ClientSecret_Value {
...
export interface IamProvider_ExtendedAttributesOauth2Client_ClientSecret {
  /** Representation of the value of the client secret. */
  value?: IamProvider_ExtendedAttributesOauth2Client_ClientSecret_Value | Computed<IamProvider_ExtendedAttributesOauth2Client_ClientSecret_Value>;
}

export interface IamProvider_ExtendedAttributesOauth2Client_QueryParameters {
...
export interface IamProvider_ExtendedAttributesOauth2Client {
  ...
  clientSecret?: IamProvider_ExtendedAttributesOauth2Client_ClientSecret | Computed<IamProvider_ExtendedAttributesOauth2Client_ClientSecret>;
  ...
  queryParameters?: IamProvider_ExtendedAttributesOauth2Client_QueryParameters | Computed<IamProvider_ExtendedAttributesOauth2Client_QueryParameters>;
}

export interface IamProvider_Oidc_WebSsoConfig {
...
export interface IamProvider_Oidc {
  ...
  webSsoConfig?: IamProvider_Oidc_WebSsoConfig | Computed<IamProvider_Oidc_WebSsoConfig>;
}

export interface IamProvider_Saml {
...
const IamProvider_ExtendedAttributesOauth2Client_ClientSecret_ValueFields: FieldMap = {
  plainText: "plain_text",
  thumbprint: "thumbprint",
};

const IamProvider_ExtendedAttributesOauth2Client_ClientSecretFields: FieldMap = {
  value: {
    wireName: "value",
    kind: "object",
...
const IamProvider_ExtendedAttributesOauth2Client_QueryParametersFields: FieldMap = {
  filter: "filter",
};

const IamProvider_ExtendedAttributesOauth2ClientFields: FieldMap = {
...
const IamProvider_SamlFields: FieldMap = {
...
export interface IamProviderConfig {
  ...
  extendedAttributesOauth2Client?: IamProvider_ExtendedAttributesOauth2Client | Computed<IamProvider_ExtendedAttributesOauth2Client>;
  /** Represents the OAuth 2.0 client credential configuration for retrieving additional user attributes that are not present in the initial authentication credentials from the identity provider, for example, groups. See https://datatracker.ietf.org/doc/html/rfc6749#section-4.4 for more details on client credentials grant flow. */
  extraAttributesOauth2Client?: IamProvider_ExtendedAttributesOauth2Client | Computed<IamProvider_ExtendedAttributesOauth2Client>;
  ...
  oidc?: IamProvider_Oidc | Computed<IamProvider_Oidc>;
  /** Represents a SAML identity provider. */
  saml?: IamProvider_Saml | Computed<IamProvider_Saml>;
...
export interface IamProviderAttrs {
  /** Optional. A [Common Expression Language](https://opensource.google/projects/cel) expression, in plain text, to restrict what otherwise valid authentication credentials issued by the provider should not be accepted. The expression must output a boolean representing whether to allow the federation. The following keywords may be referenced in the expressions: * `assertion`: JSON representing the authentication credential issued by the provider. * `google`: The Google attributes mapped from the assertion in the `attribute_mappings`. `google.profile_photo`, `google.display_name` and `google.posix_username` are not supported. * `attribute`: The custom attributes mapped from the assertion in the `attribute_mappings`. The maximum length of the attribute condition expression is 4096 characters. If unspecified, all valid authentication credentials will be accepted. The following example shows how to only allow credentials with a mapped `google.groups` value of `admins`: ``` "'admins' in google.groups" ``` */
  ...
  expireTime: string;
  /** Represents the OAuth 2.0 client credential configuration for retrieving additional user attributes that are not present in the initial authentication credentials from the identity provider, for example, groups. See https://datatracker.ietf.org/doc/html/rfc6749#section-4.4 for more details on client credentials grant flow. */
  extendedAttributesOauth2Client: IamProvider_ExtendedAttributesOauth2Client;
  /** Represents the OAuth 2.0 client credential configuration for retrieving additional user attributes that are not present in the initial authentication credentials from the identity provider, for example, groups. See https://datatracker.ietf.org/doc/html/rfc6749#section-4.4 for more details on client credentials grant flow. */
  extraAttributesOauth2Client: IamProvider_ExtendedAttributesOauth2Client;
  /** Identifier. The resource name of the provider. Format: `locations/{location}/workforcePools/{workforce_pool_id}/providers/{provider_id}` */
  name: string;
  /** Represents an OpenID Connect 1.0 identity provider. */
  oidc: IamProvider_Oidc;
  /** Represents a SAML identity provider. */
  saml: IamProvider_Saml;
  /** Optional. Gemini Enterprise only. Specifies whether the workforce identity pool provider uses SCIM-managed groups instead of the `google.groups` attribute mapping for authorization checks. The `scim_usage` and `extended_attributes_oauth2_client` fields are mutually exclusive. A request that enables both fields on the same workforce identity pool provider will produce an error. */
  scimUsage: string;
  /** Output only. The state of the provider. */
  state: string;
...
export const IamProvider: ResourceBinding<IamProviderConfig, IamProviderAttrs> = {
