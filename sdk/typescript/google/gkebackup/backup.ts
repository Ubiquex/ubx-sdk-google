...
export interface Backup_EncryptionKey {
...
export interface Backup_SelectedApplications {
  /** Optional. A list of namespaced Kubernetes resources. */
  namespacedNames?: Backup_SelectedApplications_NamespacedNames[] | Computed<Backup_SelectedApplications_NamespacedNames[]>;
}
...
export interface Backup_SelectedNamespaceLabels {
  /** Optional. A list of Kubernetes label-value pairs. */
  resourceLabels?: Backup_SelectedNamespaceLabels_ResourceLabels[] | Computed<Backup_SelectedNamespaceLabels_ResourceLabels[]>;
}

export interface Backup_SelectedNamespaces {
  /** Optional. A list of Kubernetes Namespaces. */
  namespaces?: string[] | Computed<string[]>;
}

export interface Backup_TroubleshootingInfo {
...
const Backup_ClusterMetadataFields: FieldMap = {
...
const Backup_EncryptionKeyFields: FieldMap = {
  gcpKmsEncryptionKey: "gcp_kms_encryption_key",
};

const Backup_SelectedApplications_NamespacedNamesFields: FieldMap = {
  name: "name",
  namespace: "namespace",
};

const Backup_SelectedApplicationsFields: FieldMap = {
  namespacedNames: {
...
const Backup_SelectedNamespaceLabels_ResourceLabelsFields: FieldMap = {
  key: "key",
  value: "value",
};

const Backup_SelectedNamespaceLabelsFields: FieldMap = {
  resourceLabels: {
...
const Backup_SelectedNamespacesFields: FieldMap = {
  namespaces: "namespaces",
};

const Backup_TroubleshootingInfoFields: FieldMap = {
...
export interface BackupAttrs {
  ...
  description: string;
  /** Defined a customer managed encryption key that will be used to encrypt Backup artifacts. */
  encryptionKey: Backup_EncryptionKey;
  ...
  /** A list of namespaced Kubernetes resources. */
  selectedApplications: Backup_SelectedApplications;
  /** A list of Kubernetes labels. */
  selectedNamespaceLabels: Backup_SelectedNamespaceLabels;
  /** A list of Kubernetes Namespaces. */
  selectedNamespaces: Backup_SelectedNamespaces;
  ...
  stateReason: string;
  /** Stores information about troubleshooting doc for debugging a particular state of an operation (eg - backup/restore). This will be used by the end user to debug their operation failure scenario easily. */
  troubleshootingInfo: Backup_TroubleshootingInfo;
