...
export interface GkebackupBackupChannelConfig {
...
export interface GkebackupBackupChannelAttrs {
  /** Output only. The timestamp when this BackupChannel resource was created. */
  createTime: string;
  /** Optional. User specified descriptive string for this BackupChannel. */
  description: string;
...
export const GkebackupBackupChannel: ResourceBinding<GkebackupBackupChannelConfig, GkebackupBackupChannelAttrs> = {
  wireType: "google_gkebackup_gkebackup_backup_channel",
  fields: {
