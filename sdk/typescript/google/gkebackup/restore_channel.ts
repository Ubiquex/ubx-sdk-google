...
export interface RestoreChannelConfig {
...
export interface RestoreChannelAttrs {
...
export const RestoreChannel: ResourceBinding<RestoreChannelConfig, RestoreChannelAttrs> = {
