// Code generated by `ubx sdk gen` from google_discoveryengine_v1alpha_discoveryengine_v1alpha_document. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1alphaDiscoveryengineV1alphaDocument_AclInfo_Readers_Principals {
  externalEntityId?: string | Computed<string>;
  groupId?: string | Computed<string>;
  userId?: string | Computed<string>;
}

export interface V1alphaDiscoveryengineV1alphaDocument_AclInfo_Readers {
  idpWide?: boolean | Computed<boolean>;
  principals?: V1alphaDiscoveryengineV1alphaDocument_AclInfo_Readers_Principals[] | Computed<V1alphaDiscoveryengineV1alphaDocument_AclInfo_Readers_Principals[]>;
}

export interface V1alphaDiscoveryengineV1alphaDocument_AclInfo {
  /** Readers of the document. */
  readers?: V1alphaDiscoveryengineV1alphaDocument_AclInfo_Readers[] | Computed<V1alphaDiscoveryengineV1alphaDocument_AclInfo_Readers[]>;
}

export interface V1alphaDiscoveryengineV1alphaDocument_Content {
...
export interface V1alphaDiscoveryengineV1alphaDocument_IndexStatus_ErrorSamples {
  code?: number | Computed<number>;
  details?: Record<string, unknown>[] | Computed<Record<string, unknown>[]>;
  message?: string | Computed<string>;
}

export interface V1alphaDiscoveryengineV1alphaDocument_IndexStatus {
  ...
  errorSamples?: V1alphaDiscoveryengineV1alphaDocument_IndexStatus_ErrorSamples[] | Computed<V1alphaDiscoveryengineV1alphaDocument_IndexStatus_ErrorSamples[]>;
...
const V1alphaDiscoveryengineV1alphaDocument_AclInfo_Readers_PrincipalsFields: FieldMap = {
  externalEntityId: "external_entity_id",
  groupId: "group_id",
  userId: "user_id",
};

const V1alphaDiscoveryengineV1alphaDocument_AclInfo_ReadersFields: FieldMap = {
  idpWide: "idp_wide",
  principals: {
    wireName: "principals",
    kind: "list",
    fields: V1alphaDiscoveryengineV1alphaDocument_AclInfo_Readers_PrincipalsFields,
  },
};

const V1alphaDiscoveryengineV1alphaDocument_AclInfoFields: FieldMap = {
  readers: {
    wireName: "readers",
    kind: "list",
    fields: V1alphaDiscoveryengineV1alphaDocument_AclInfo_ReadersFields,
  },
};

const V1alphaDiscoveryengineV1alphaDocument_ContentFields: FieldMap = {
  mimeType: "mime_type",
  rawBytes: "raw_bytes",
  uri: "uri",
};

const V1alphaDiscoveryengineV1alphaDocument_IndexStatus_ErrorSamplesFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const V1alphaDiscoveryengineV1alphaDocument_IndexStatusFields: FieldMap = {
  errorSamples: {
    wireName: "error_samples",
    kind: "list",
    fields: V1alphaDiscoveryengineV1alphaDocument_IndexStatus_ErrorSamplesFields,
  },
  indexTime: "index_time",
  pendingMessage: "pending_message",
};

export interface V1alphaDiscoveryengineV1alphaDocumentConfig {
  /** ACL Information of the Document. */
  aclInfo?: V1alphaDiscoveryengineV1alphaDocument_AclInfo | Computed<V1alphaDiscoveryengineV1alphaDocument_AclInfo>;
  /** Unstructured data linked to this document. */
  content?: V1alphaDiscoveryengineV1alphaDocument_Content | Computed<V1alphaDiscoveryengineV1alphaDocument_Content>;
  ...
  indexStatus?: V1alphaDiscoveryengineV1alphaDocument_IndexStatus | Computed<V1alphaDiscoveryengineV1alphaDocument_IndexStatus>;
...
export interface V1alphaDiscoveryengineV1alphaDocumentAttrs {
  /** ACL Information of the Document. */
  aclInfo: V1alphaDiscoveryengineV1alphaDocument_AclInfo;
  /** Unstructured data linked to this document. */
  content: V1alphaDiscoveryengineV1alphaDocument_Content;
  /** Output only. This field is OUTPUT_ONLY. It contains derived data that are not in the original input document. */
  derivedStructData: Record<string, unknown>;
  /** Immutable. The identifier of the document. Id should conform to [RFC-1034](https://tools.ietf.org/html/rfc1034) standard with a length limit of 128 characters. */
  id: string;
  /** Index status of the document. */
  indexStatus: V1alphaDiscoveryengineV1alphaDocument_IndexStatus;
  /** Output only. The time when the document was last indexed. If this field is populated, it means the document has been indexed. While documents typically become searchable within seconds of indexing, it can sometimes take up to a few hours. If this field is not populated, it means the document has never been indexed. */
  indexTime: string;
  /** The JSON string representation of the document. It should conform to the registered Schema or an `INVALID_ARGUMENT` error is thrown. */
  jsonData: string;
...
export const V1alphaDiscoveryengineV1alphaDocument: ResourceBinding<V1alphaDiscoveryengineV1alphaDocumentConfig, V1alphaDiscoveryengineV1alphaDocumentAttrs> = {
  wireType: "google_discoveryengine_v1alpha_discoveryengine_v1alpha_document",
  fields: {
    aclInfo: {
      wireName: "acl_info",
      kind: "object",
      fields: V1alphaDiscoveryengineV1alphaDocument_AclInfoFields,
    },
    content: {
      wireName: "content",
      kind: "object",
      fields: V1alphaDiscoveryengineV1alphaDocument_ContentFields,
    },
    ...
    indexStatus: {
      ...
      kind: "object",
      fields: V1alphaDiscoveryengineV1alphaDocument_IndexStatusFields,
    },
    indexTime: "index_time",
    jsonData: "json_data",
    name: "name",
