// Code generated by `ubx sdk gen` from google_discoveryengine_discoveryengine_serving_config. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface DiscoveryengineServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpec {
...
export interface DiscoveryengineServingConfig_AnswerGenerationSpec {
  /** The specification for user defined classifier. */
  userDefinedClassifierSpec?: DiscoveryengineServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpec | Computed<DiscoveryengineServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpec>;
}

export interface DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_ChunkSpec {
...
export interface DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpec {
...
export interface DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SnippetSpec {
...
export interface DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec {
  /** Text at the beginning of the prompt that instructs the assistant. Examples are available in the user guide. */
  preamble?: string | Computed<string>;
}

export interface DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpec {
...
export interface DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec {
  ...
  modelPromptSpec?: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec | Computed<DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec>;
  /** Specification of the model. */
  modelSpec?: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpec | Computed<DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpec>;
...
export interface DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec {
  ...
  chunkSpec?: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_ChunkSpec | Computed<DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_ChunkSpec>;
  /** A specification for configuring the extractive content in a search response. */
  extractiveContentSpec?: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpec | Computed<DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpec>;
  ...
  snippetSpec?: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SnippetSpec | Computed<DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SnippetSpec>;
  /** A specification for configuring a summary returned in a search response. */
  summarySpec?: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec | Computed<DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec>;
}

export interface DiscoveryengineServingConfig_GenericConfig {
  /** A specification for configuring the behavior of content search. */
  contentSearchSpec?: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec | Computed<DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec>;
}

export interface DiscoveryengineServingConfig_MediaConfig {
...
const DiscoveryengineServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpecFields: FieldMap = {
...
const DiscoveryengineServingConfig_AnswerGenerationSpecFields: FieldMap = {
  userDefinedClassifierSpec: {
    wireName: "user_defined_classifier_spec",
    kind: "object",
    fields: DiscoveryengineServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpecFields,
  },
};

const DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_ChunkSpecFields: FieldMap = {
  numNextChunks: "num_next_chunks",
  numPreviousChunks: "num_previous_chunks",
};

const DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpecFields: FieldMap = {
...
const DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SnippetSpecFields: FieldMap = {
  maxSnippetCount: "max_snippet_count",
  referenceOnly: "reference_only",
  returnSnippet: "return_snippet",
};

const DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpecFields: FieldMap = {
  preamble: "preamble",
};

const DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpecFields: FieldMap = {
  version: "version",
};

const DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpecFields: FieldMap = {
  ...
  modelPromptSpec: {
    ...
    kind: "object",
    fields: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpecFields,
  },
  modelSpec: {
    wireName: "model_spec",
    kind: "object",
    fields: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpecFields,
  },
  summaryResultCount: "summary_result_count",
  useSemanticChunks: "use_semantic_chunks",
};

const DiscoveryengineServingConfig_GenericConfig_ContentSearchSpecFields: FieldMap = {
  chunkSpec: {
    wireName: "chunk_spec",
    kind: "object",
    fields: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_ChunkSpecFields,
  },
  extractiveContentSpec: {
    wireName: "extractive_content_spec",
    kind: "object",
    fields: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpecFields,
  },
  searchResultMode: "search_result_mode",
  snippetSpec: {
    wireName: "snippet_spec",
    kind: "object",
    fields: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SnippetSpecFields,
  },
  summarySpec: {
    wireName: "summary_spec",
    kind: "object",
    fields: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpec_SummarySpecFields,
  },
};

const DiscoveryengineServingConfig_GenericConfigFields: FieldMap = {
  contentSearchSpec: {
    wireName: "content_search_spec",
    kind: "object",
    fields: DiscoveryengineServingConfig_GenericConfig_ContentSearchSpecFields,
  },
};

const DiscoveryengineServingConfig_MediaConfigFields: FieldMap = {
...
export interface DiscoveryengineServingConfigConfig {
  /** The specification for answer generation. */
  answerGenerationSpec?: DiscoveryengineServingConfig_AnswerGenerationSpec | Computed<DiscoveryengineServingConfig_AnswerGenerationSpec>;
  ...
  genericConfig?: DiscoveryengineServingConfig_GenericConfig | Computed<DiscoveryengineServingConfig_GenericConfig>;
  ...
  mediaConfig?: DiscoveryengineServingConfig_MediaConfig | Computed<DiscoveryengineServingConfig_MediaConfig>;
...
export interface DiscoveryengineServingConfigAttrs {
  /** The specification for answer generation. */
  answerGenerationSpec: DiscoveryengineServingConfig_AnswerGenerationSpec;
  /** Boost controls to use in serving path. All triggered boost controls will be applied. Boost controls must be in the same data store as the serving config. Maximum of 20 boost controls. */
  ...
  /** Specifies the configurations needed for Generic Discovery.Currently we support: * `content_search_spec`: configuration for generic content search. */
  genericConfig: DiscoveryengineServingConfig_GenericConfig;
  /** Condition ignore specifications. If multiple ignore conditions match, all matching ignore controls in the list will execute. Order does not matter. Maximum number of specifications is 100. */
  ignoreControlIds: string[];
  /** Specifies the configurations needed for Media Discovery. Currently we support: * `demote_content_watched`: Threshold for watched content demotion. Customers can specify if using watched content demotion or use viewed detail page. Using the content watched demotion, customers need to specify the watched minutes or percentage exceeds the threshold, the content will be demoted in the recommendation result. * `promote_fresh_content`: cutoff days for fresh content promotion. Customers can specify if using content freshness promotion. If the content was published within the cutoff days, the content will be promoted in the recommendation result. Can only be set if SolutionType is SOLUTION_TYPE_RECOMMENDATION. */
  mediaConfig: DiscoveryengineServingConfig_MediaConfig;
  /** The id of the model to use at serving time. Currently only RecommendationModels are supported. Can be changed but only to a compatible model (e.g. others-you-may-like CTR to others-you-may-like CVR). Required when SolutionType is SOLUTION_TYPE_RECOMMENDATION. */
  modelId: string;
  /** Immutable. Fully qualified name `projects/{project}/locations/{location}/collections/{collection_id}/engines/{engine_id}/servingConfigs/{serving_config_id}` */
  name: string;
...
export const DiscoveryengineServingConfig: ResourceBinding<DiscoveryengineServingConfigConfig, DiscoveryengineServingConfigAttrs> = {
  wireType: "google_discoveryengine_discoveryengine_serving_config",
  fields: {
    answerGenerationSpec: {
      wireName: "answer_generation_spec",
      kind: "object",
      fields: DiscoveryengineServingConfig_AnswerGenerationSpecFields,
    },
    ...
    genericConfig: {
      ...
      kind: "object",
      fields: DiscoveryengineServingConfig_GenericConfigFields,
    },
    ignoreControlIds: "ignore_control_ids",
    mediaConfig: {
      wireName: "media_config",
      kind: "object",
      fields: DiscoveryengineServingConfig_MediaConfigFields,
    },
    modelId: "model_id",
    name: "name",
