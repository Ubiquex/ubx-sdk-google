...
export interface DiscoveryengineDocument_AclInfo_Readers_Principals {
  externalEntityId?: string | Computed<string>;
  groupId?: string | Computed<string>;
  userId?: string | Computed<string>;
}

export interface DiscoveryengineDocument_AclInfo_Readers {
  idpWide?: boolean | Computed<boolean>;
  principals?: DiscoveryengineDocument_AclInfo_Readers_Principals[] | Computed<DiscoveryengineDocument_AclInfo_Readers_Principals[]>;
}

export interface DiscoveryengineDocument_AclInfo {
  /** Readers of the document. */
  readers?: DiscoveryengineDocument_AclInfo_Readers[] | Computed<DiscoveryengineDocument_AclInfo_Readers[]>;
}

export interface DiscoveryengineDocument_Content {
...
export interface DiscoveryengineDocument_IndexStatus_ErrorSamples {
  code?: number | Computed<number>;
  details?: Record<string, unknown>[] | Computed<Record<string, unknown>[]>;
  message?: string | Computed<string>;
}

export interface DiscoveryengineDocument_IndexStatus {
  ...
  errorSamples?: DiscoveryengineDocument_IndexStatus_ErrorSamples[] | Computed<DiscoveryengineDocument_IndexStatus_ErrorSamples[]>;
...
const DiscoveryengineDocument_AclInfo_Readers_PrincipalsFields: FieldMap = {
  externalEntityId: "external_entity_id",
  groupId: "group_id",
  userId: "user_id",
};

const DiscoveryengineDocument_AclInfo_ReadersFields: FieldMap = {
  idpWide: "idp_wide",
  principals: {
    wireName: "principals",
    kind: "list",
...
const DiscoveryengineDocument_AclInfoFields: FieldMap = {
  readers: {
    wireName: "readers",
    kind: "list",
...
const DiscoveryengineDocument_ContentFields: FieldMap = {
  mimeType: "mime_type",
  rawBytes: "raw_bytes",
  uri: "uri",
};

const DiscoveryengineDocument_IndexStatus_ErrorSamplesFields: FieldMap = {
  code: "code",
  details: "details",
  message: "message",
};

const DiscoveryengineDocument_IndexStatusFields: FieldMap = {
  errorSamples: {
...
export interface DiscoveryengineDocumentConfig {
  /** ACL Information of the Document. */
  aclInfo?: DiscoveryengineDocument_AclInfo | Computed<DiscoveryengineDocument_AclInfo>;
  /** Unstructured data linked to this document. */
  content?: DiscoveryengineDocument_Content | Computed<DiscoveryengineDocument_Content>;
  ...
  indexStatus?: DiscoveryengineDocument_IndexStatus | Computed<DiscoveryengineDocument_IndexStatus>;
...
export interface DiscoveryengineDocumentAttrs {
  /** ACL Information of the Document. */
  aclInfo: DiscoveryengineDocument_AclInfo;
  /** Unstructured data linked to this document. */
  content: DiscoveryengineDocument_Content;
  /** Output only. This field is OUTPUT_ONLY. It contains derived data that are not in the original input document. */
  derivedStructData: Record<string, unknown>;
  /** Immutable. The identifier of the document. Id should conform to [RFC-1034](https://tools.ietf.org/html/rfc1034) standard with a length limit of 128 characters. */
  id: string;
  /** Index status of the document. */
  indexStatus: DiscoveryengineDocument_IndexStatus;
  /** Output only. The time when the document was last indexed. If this field is populated, it means the document has been indexed. While documents typically become searchable within seconds of indexing, it can sometimes take up to a few hours. If this field is not populated, it means the document has never been indexed. */
  indexTime: string;
  /** The JSON string representation of the document. It should conform to the registered Schema or an `INVALID_ARGUMENT` error is thrown. */
  jsonData: string;
...
export const DiscoveryengineDocument: ResourceBinding<DiscoveryengineDocumentConfig, DiscoveryengineDocumentAttrs> = {
