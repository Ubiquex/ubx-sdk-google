...
export interface V1alphaAuthorization_ServerSideOauth2 {
...
const V1alphaAuthorization_ServerSideOauth2Fields: FieldMap = {
...
export interface V1alphaAuthorizationConfig {
  ...
  serverSideOauth2?: V1alphaAuthorization_ServerSideOauth2 | Computed<V1alphaAuthorization_ServerSideOauth2>;
}

export interface V1alphaAuthorizationAttrs {
  /** Required. The display name of the authorization. It must be a UTF-8 encoded string with a length limit of 128 characters. */
  displayName: string;
  /** Identifier. Resource name of the authorization. Format: `projects/{project}/locations/{location}/authorizations/{authorization}` It must be a UTF-8 encoded string with a length limit of 1024 characters. */
  name: string;
  /** OAuth2 configuration. */
  serverSideOauth2: V1alphaAuthorization_ServerSideOauth2;
}

export const V1alphaAuthorization: ResourceBinding<V1alphaAuthorizationConfig, V1alphaAuthorizationAttrs> = {
