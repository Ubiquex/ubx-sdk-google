// Code generated by `ubx sdk gen` from google_discoveryengine_v1alpha_engine. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1alphaEngine_AgentGatewaySetting_DefaultEgressAgentGateway {
...
export interface V1alphaEngine_AgentGatewaySetting {
  /** Reference to an Agent Gateway resource. */
  defaultEgressAgentGateway?: V1alphaEngine_AgentGatewaySetting_DefaultEgressAgentGateway | Computed<V1alphaEngine_AgentGatewaySetting_DefaultEgressAgentGateway>;
}

export interface V1alphaEngine_ChatEngineConfig_AgentCreationConfig {
...
export interface V1alphaEngine_ChatEngineConfig {
  ...
  agentCreationConfig?: V1alphaEngine_ChatEngineConfig_AgentCreationConfig | Computed<V1alphaEngine_ChatEngineConfig_AgentCreationConfig>;
...
export interface V1alphaEngine_ChatEngineMetadata {
...
export interface V1alphaEngine_CmekConfig_SingleRegionKeys {
  kmsKey?: string | Computed<string>;
}

export interface V1alphaEngine_CmekConfig {
  ...
  singleRegionKeys?: V1alphaEngine_CmekConfig_SingleRegionKeys[] | Computed<V1alphaEngine_CmekConfig_SingleRegionKeys[]>;
  /** Output only. The states of the CmekConfig. */
  state?: string | Computed<string>;
}

export interface V1alphaEngine_CommonConfig {
  /** The name of the company, business or entity that is associated with the engine. Setting this may help improve LLM related features. */
  companyName?: string | Computed<string>;
}

export interface V1alphaEngine_KnowledgeGraphConfig_FeatureConfig {
...
export interface V1alphaEngine_KnowledgeGraphConfig {
  ...
  featureConfig?: V1alphaEngine_KnowledgeGraphConfig_FeatureConfig | Computed<V1alphaEngine_KnowledgeGraphConfig_FeatureConfig>;
  /** Specify entity types to support. */
  privateKnowledgeGraphTypes?: string[] | Computed<string[]>;
}

export interface V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfig {
...
export interface V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfig {
...
export interface V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig {
  /** Feature configurations that are required for creating a Most Popular engine. */
  mostPopularConfig?: V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfig | Computed<V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfig>;
  /** Additional feature configurations for creating a `recommended-for-you` engine. */
  recommendedForYouConfig?: V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfig | Computed<V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfig>;
}

export interface V1alphaEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfig {
...
export interface V1alphaEngine_MediaRecommendationEngineConfig {
  /** More feature configs of the selected engine type. */
  engineFeaturesConfig?: V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig | Computed<V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig>;
  ...
  optimizationObjectiveConfig?: V1alphaEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfig | Computed<V1alphaEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfig>;
...
export interface V1alphaEngine_ObservabilityConfig {
...
export interface V1alphaEngine_RecommendationMetadata {
...
export interface V1alphaEngine_SearchEngineConfig {
...
const V1alphaEngine_AgentGatewaySetting_DefaultEgressAgentGatewayFields: FieldMap = {
  name: "name",
};

const V1alphaEngine_AgentGatewaySettingFields: FieldMap = {
...
const V1alphaEngine_ChatEngineConfig_AgentCreationConfigFields: FieldMap = {
  business: "business",
...
const V1alphaEngine_ChatEngineConfigFields: FieldMap = {
  agentCreationConfig: {
...
const V1alphaEngine_ChatEngineMetadataFields: FieldMap = {
  dialogflowAgent: "dialogflow_agent",
};

const V1alphaEngine_CmekConfig_SingleRegionKeysFields: FieldMap = {
  kmsKey: "kms_key",
};

const V1alphaEngine_CmekConfigFields: FieldMap = {
...
const V1alphaEngine_CommonConfigFields: FieldMap = {
  companyName: "company_name",
};

const V1alphaEngine_KnowledgeGraphConfig_FeatureConfigFields: FieldMap = {
...
const V1alphaEngine_KnowledgeGraphConfigFields: FieldMap = {
...
const V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfigFields: FieldMap = {
  timeWindowDays: "time_window_days",
};

const V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfigFields: FieldMap = {
  contextEventType: "context_event_type",
};

const V1alphaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfigFields: FieldMap = {
  mostPopularConfig: {
...
const V1alphaEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfigFields: FieldMap = {
  targetField: "target_field",
  targetFieldValueFloat: "target_field_value_float",
};

const V1alphaEngine_MediaRecommendationEngineConfigFields: FieldMap = {
...
const V1alphaEngine_ObservabilityConfigFields: FieldMap = {
  observabilityEnabled: "observability_enabled",
  sensitiveLoggingEnabled: "sensitive_logging_enabled",
};

const V1alphaEngine_RecommendationMetadataFields: FieldMap = {
...
export interface V1alphaEngineConfig {
  ...
  agentGatewaySetting?: V1alphaEngine_AgentGatewaySetting | Computed<V1alphaEngine_AgentGatewaySetting>;
  ...
  chatEngineConfig?: V1alphaEngine_ChatEngineConfig | Computed<V1alphaEngine_ChatEngineConfig>;
  /** Additional information of a Chat Engine. Fields in this message are output only. */
  chatEngineMetadata?: V1alphaEngine_ChatEngineMetadata | Computed<V1alphaEngine_ChatEngineMetadata>;
  /** Configurations used to enable CMEK data encryption with Cloud KMS keys. */
  cmekConfig?: V1alphaEngine_CmekConfig | Computed<V1alphaEngine_CmekConfig>;
  /** Common configurations for an Engine. */
  commonConfig?: V1alphaEngine_CommonConfig | Computed<V1alphaEngine_CommonConfig>;
  ...
  knowledgeGraphConfig?: V1alphaEngine_KnowledgeGraphConfig | Computed<V1alphaEngine_KnowledgeGraphConfig>;
  ...
  mediaRecommendationEngineConfig?: V1alphaEngine_MediaRecommendationEngineConfig | Computed<V1alphaEngine_MediaRecommendationEngineConfig>;
  ...
  observabilityConfig?: V1alphaEngine_ObservabilityConfig | Computed<V1alphaEngine_ObservabilityConfig>;
  /** Optional. The emails of the procurement contacts. */
  procurementContactEmails?: string[] | Computed<string[]>;
  /** Additional information of a recommendation engine. */
  recommendationMetadata?: V1alphaEngine_RecommendationMetadata | Computed<V1alphaEngine_RecommendationMetadata>;
  /** Configurations for a Search Engine. */
  searchEngineConfig?: V1alphaEngine_SearchEngineConfig | Computed<V1alphaEngine_SearchEngineConfig>;
...
export interface V1alphaEngineAttrs {
  /** Agent Gateway setting, which may be attached to Gemini Enterprise resources for egress control of Gemini Enterprise agents to agents and tools outside of Gemini Enterprise. */
  agentGatewaySetting: V1alphaEngine_AgentGatewaySetting;
  /** Optional. Immutable. This the application type which this engine resource represents. NOTE: this is a new concept independ of existing industry vertical or solution type. */
  appType: string;
  /** Output only. The Agent registry containing the agents, MCP servers and tools associated with this engine. Derived server-side from the linked Agent Gateway's registry. */
  associatedAgentRegistry: string;
  /** Configurations for a Chat Engine. */
  chatEngineConfig: V1alphaEngine_ChatEngineConfig;
  /** Additional information of a Chat Engine. Fields in this message are output only. */
  chatEngineMetadata: V1alphaEngine_ChatEngineMetadata;
  /** Configurations used to enable CMEK data encryption with Cloud KMS keys. */
  cmekConfig: V1alphaEngine_CmekConfig;
  /** Common configurations for an Engine. */
  commonConfig: V1alphaEngine_CommonConfig;
  /** Optional. Configuration for configurable billing approach. */
  ...
  /** Configuration message for the Knowledge Graph. */
  knowledgeGraphConfig: V1alphaEngine_KnowledgeGraphConfig;
  /** Optional. The visibility of marketplace agents in the agent gallery. */
  marketplaceAgentVisibility: string;
  /** Additional config specs for a Media Recommendation engine. */
  mediaRecommendationEngineConfig: V1alphaEngine_MediaRecommendationEngineConfig;
  /** Optional. Maps a model name to its specific configuration for this engine. This allows admin users to turn on/off individual models. This only stores models whose states are overridden by the admin. When the state is unspecified, or model_configs is empty for this model, the system will decide if this model should be available or not based on the default configuration. For example, a preview model should be disabled by default if the admin has not chosen to enable it. */
  modelConfigs: Record<string, string>;
  /** Immutable. Identifier. The fully qualified resource name of the engine. This field must be a UTF-8 encoded string with a length limit of 1024 characters. Format: `projects/{project}/locations/{location}/collections/{collection}/engines/{engine}` engine should be 1-63 characters, and valid characters are /a-z0-9* /. Otherwise, an INVALID_ARGUMENT error is returned. */
  name: string;
  /** Observability config for a resource. */
  observabilityConfig: V1alphaEngine_ObservabilityConfig;
  /** Optional. The emails of the procurement contacts. */
  procurementContactEmails: string[];
  /** Additional information of a recommendation engine. */
  recommendationMetadata: V1alphaEngine_RecommendationMetadata;
  /** Configurations for a Search Engine. */
  searchEngineConfig: V1alphaEngine_SearchEngineConfig;
  /** Additional config specs for a `similar-items` engine. */
...
export const V1alphaEngine: ResourceBinding<V1alphaEngineConfig, V1alphaEngineAttrs> = {
  wireType: "google_discoveryengine_v1alpha_engine",
  fields: {
    agentGatewaySetting: {
