...
export interface Engine_AgentGatewaySetting_DefaultEgressAgentGateway {
...
export interface Engine_AgentGatewaySetting {
  /** Reference to an Agent Gateway resource. */
  defaultEgressAgentGateway?: Engine_AgentGatewaySetting_DefaultEgressAgentGateway | Computed<Engine_AgentGatewaySetting_DefaultEgressAgentGateway>;
}
...
export interface Engine_ChatEngineConfig {
  ...
  agentCreationConfig?: Engine_ChatEngineConfig_AgentCreationConfig | Computed<Engine_ChatEngineConfig_AgentCreationConfig>;
...
export interface Engine_CmekConfig {
  ...
  singleRegionKeys?: Engine_CmekConfig_SingleRegionKeys[] | Computed<Engine_CmekConfig_SingleRegionKeys[]>;
...
export interface Engine_KnowledgeGraphConfig_FeatureConfig {
...
export interface Engine_KnowledgeGraphConfig {
  ...
  featureConfig?: Engine_KnowledgeGraphConfig_FeatureConfig | Computed<Engine_KnowledgeGraphConfig_FeatureConfig>;
  /** Specify entity types to support. */
  privateKnowledgeGraphTypes?: string[] | Computed<string[]>;
}

export interface Engine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfig {
...
export interface Engine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfig {
...
export interface Engine_MediaRecommendationEngineConfig_EngineFeaturesConfig {
  /** Feature configurations that are required for creating a Most Popular engine. */
  mostPopularConfig?: Engine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfig | Computed<Engine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfig>;
  /** Additional feature configurations for creating a `recommended-for-you` engine. */
  recommendedForYouConfig?: Engine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfig | Computed<Engine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfig>;
}
...
export interface Engine_MediaRecommendationEngineConfig {
  ...
  engineFeaturesConfig?: Engine_MediaRecommendationEngineConfig_EngineFeaturesConfig | Computed<Engine_MediaRecommendationEngineConfig_EngineFeaturesConfig>;
  ...
  optimizationObjectiveConfig?: Engine_MediaRecommendationEngineConfig_OptimizationObjectiveConfig | Computed<Engine_MediaRecommendationEngineConfig_OptimizationObjectiveConfig>;
...
export interface Engine_ObservabilityConfig {
...
const Engine_AgentGatewaySetting_DefaultEgressAgentGatewayFields: FieldMap = {
  name: "name",
};

const Engine_AgentGatewaySettingFields: FieldMap = {
...
const Engine_ChatEngineConfig_AgentCreationConfigFields: FieldMap = {
  business: "business",
...
const Engine_ChatEngineConfigFields: FieldMap = {
  agentCreationConfig: {
...
const Engine_ChatEngineMetadataFields: FieldMap = {
  dialogflowAgent: "dialogflow_agent",
};

const Engine_CmekConfig_SingleRegionKeysFields: FieldMap = {
  kmsKey: "kms_key",
};

const Engine_CmekConfigFields: FieldMap = {
...
const Engine_CommonConfigFields: FieldMap = {
  companyName: "company_name",
};

const Engine_KnowledgeGraphConfig_FeatureConfigFields: FieldMap = {
...
const Engine_KnowledgeGraphConfigFields: FieldMap = {
...
const Engine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfigFields: FieldMap = {
  timeWindowDays: "time_window_days",
};

const Engine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfigFields: FieldMap = {
  contextEventType: "context_event_type",
};

const Engine_MediaRecommendationEngineConfig_EngineFeaturesConfigFields: FieldMap = {
  mostPopularConfig: {
...
const Engine_MediaRecommendationEngineConfig_OptimizationObjectiveConfigFields: FieldMap = {
  targetField: "target_field",
  targetFieldValueFloat: "target_field_value_float",
};

const Engine_MediaRecommendationEngineConfigFields: FieldMap = {
...
const Engine_ObservabilityConfigFields: FieldMap = {
  observabilityEnabled: "observability_enabled",
  sensitiveLoggingEnabled: "sensitive_logging_enabled",
};

const Engine_SearchEngineConfigFields: FieldMap = {
...
export interface EngineConfig {
  ...
  agentGatewaySetting?: Engine_AgentGatewaySetting | Computed<Engine_AgentGatewaySetting>;
  ...
  chatEngineConfig?: Engine_ChatEngineConfig | Computed<Engine_ChatEngineConfig>;
  /** Additional information of a Chat Engine. Fields in this message are output only. */
  chatEngineMetadata?: Engine_ChatEngineMetadata | Computed<Engine_ChatEngineMetadata>;
  /** Configurations used to enable CMEK data encryption with Cloud KMS keys. */
  cmekConfig?: Engine_CmekConfig | Computed<Engine_CmekConfig>;
  /** Common configurations for an Engine. */
  commonConfig?: Engine_CommonConfig | Computed<Engine_CommonConfig>;
  ...
  knowledgeGraphConfig?: Engine_KnowledgeGraphConfig | Computed<Engine_KnowledgeGraphConfig>;
  ...
  mediaRecommendationEngineConfig?: Engine_MediaRecommendationEngineConfig | Computed<Engine_MediaRecommendationEngineConfig>;
  ...
  observabilityConfig?: Engine_ObservabilityConfig | Computed<Engine_ObservabilityConfig>;
  /** Optional. The emails of the procurement contacts. */
  procurementContactEmails?: string[] | Computed<string[]>;
  /** Configurations for a Search Engine. */
  searchEngineConfig?: Engine_SearchEngineConfig | Computed<Engine_SearchEngineConfig>;
...
export interface EngineAttrs {
  /** Agent Gateway setting, which may be attached to Gemini Enterprise resources for egress control of Gemini Enterprise agents to agents and tools outside of Gemini Enterprise. */
  agentGatewaySetting: Engine_AgentGatewaySetting;
  /** Optional. Immutable. This the application type which this engine resource represents. NOTE: this is a new concept independ of existing industry vertical or solution type. */
  appType: string;
  /** Output only. The Agent registry containing the agents, MCP servers and tools associated with this engine. Derived server-side from the linked Agent Gateway's registry. */
  associatedAgentRegistry: string;
  /** Configurations for a Chat Engine. */
  chatEngineConfig: Engine_ChatEngineConfig;
  /** Additional information of a Chat Engine. Fields in this message are output only. */
  chatEngineMetadata: Engine_ChatEngineMetadata;
  /** Configurations used to enable CMEK data encryption with Cloud KMS keys. */
  cmekConfig: Engine_CmekConfig;
  /** Common configurations for an Engine. */
  ...
  /** Configuration message for the Knowledge Graph. */
  knowledgeGraphConfig: Engine_KnowledgeGraphConfig;
  /** Optional. The visibility of marketplace agents in the agent gallery. */
  marketplaceAgentVisibility: string;
  /** Additional config specs for a Media Recommendation engine. */
  mediaRecommendationEngineConfig: Engine_MediaRecommendationEngineConfig;
  /** Optional. Maps a model name to its specific configuration for this engine. This allows admin users to turn on/off individual models. This only stores models whose states are overridden by the admin. When the state is unspecified, or model_configs is empty for this model, the system will decide if this model should be available or not based on the default configuration. For example, a preview model should be disabled by default if the admin has not chosen to enable it. */
  modelConfigs: Record<string, string>;
  /** Immutable. Identifier. The fully qualified resource name of the engine. This field must be a UTF-8 encoded string with a length limit of 1024 characters. Format: `projects/{project}/locations/{location}/collections/{collection}/engines/{engine}` engine should be 1-63 characters, and valid characters are /a-z0-9* /. Otherwise, an INVALID_ARGUMENT error is returned. */
  name: string;
  /** Observability config for a resource. */
  observabilityConfig: Engine_ObservabilityConfig;
  /** Optional. The emails of the procurement contacts. */
  procurementContactEmails: string[];
  /** Configurations for a Search Engine. */
  searchEngineConfig: Engine_SearchEngineConfig;
  /** Required. The solutions of the engine. */
  solutionType: string;
  /** Output only. Timestamp the Recommendation Engine was last updated. */
  updateTime: string;
...
export const Engine: ResourceBinding<EngineConfig, EngineAttrs> = {
