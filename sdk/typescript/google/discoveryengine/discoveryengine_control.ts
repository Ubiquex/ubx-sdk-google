// Code generated by `ubx sdk gen` from google_discoveryengine_discoveryengine_control. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface DiscoveryengineControl_BoostAction_InterpolationBoostSpec_ControlPoints {
  attributeValue?: string | Computed<string>;
  boostAmount?: number | Computed<number>;
}

export interface DiscoveryengineControl_BoostAction_InterpolationBoostSpec {
  ...
  controlPoints?: DiscoveryengineControl_BoostAction_InterpolationBoostSpec_ControlPoints[] | Computed<DiscoveryengineControl_BoostAction_InterpolationBoostSpec_ControlPoints[]>;
...
export interface DiscoveryengineControl_BoostAction {
  ...
  interpolationBoostSpec?: DiscoveryengineControl_BoostAction_InterpolationBoostSpec | Computed<DiscoveryengineControl_BoostAction_InterpolationBoostSpec>;
}

export interface DiscoveryengineControl_Conditions_ActiveTimeRange {
  endTime?: string | Computed<string>;
  startTime?: string | Computed<string>;
}

export interface DiscoveryengineControl_Conditions_QueryTerms {
  fullMatch?: boolean | Computed<boolean>;
  value?: string | Computed<string>;
}

export interface DiscoveryengineControl_Conditions {
  activeTimeRange?: DiscoveryengineControl_Conditions_ActiveTimeRange[] | Computed<DiscoveryengineControl_Conditions_ActiveTimeRange[]>;
  queryRegex?: string | Computed<string>;
  queryTerms?: DiscoveryengineControl_Conditions_QueryTerms[] | Computed<DiscoveryengineControl_Conditions_QueryTerms[]>;
}

export interface DiscoveryengineControl_FilterAction {
...
export interface DiscoveryengineControl_PromoteAction_SearchLinkPromotion {
...
export interface DiscoveryengineControl_PromoteAction {
  /** Required. Data store with which this promotion is attached to. */
  dataStore?: string | Computed<string>;
  /** Promotion proto includes uri and other helping information to display the promotion. */
  searchLinkPromotion?: DiscoveryengineControl_PromoteAction_SearchLinkPromotion | Computed<DiscoveryengineControl_PromoteAction_SearchLinkPromotion>;
}

export interface DiscoveryengineControl_RedirectAction {
...
export interface DiscoveryengineControl_SynonymsAction {
...
const DiscoveryengineControl_BoostAction_InterpolationBoostSpec_ControlPointsFields: FieldMap = {
  attributeValue: "attribute_value",
  boostAmount: "boost_amount",
};

const DiscoveryengineControl_BoostAction_InterpolationBoostSpecFields: FieldMap = {
  attributeType: "attribute_type",
  controlPoints: {
    wireName: "control_points",
    kind: "list",
    fields: DiscoveryengineControl_BoostAction_InterpolationBoostSpec_ControlPointsFields,
  },
  fieldName: "field_name",
  interpolationType: "interpolation_type",
};

const DiscoveryengineControl_BoostActionFields: FieldMap = {
  boost: "boost",
  ...
  interpolationBoostSpec: {
    ...
    kind: "object",
    fields: DiscoveryengineControl_BoostAction_InterpolationBoostSpecFields,
  },
};

const DiscoveryengineControl_Conditions_ActiveTimeRangeFields: FieldMap = {
  endTime: "end_time",
  startTime: "start_time",
};

const DiscoveryengineControl_Conditions_QueryTermsFields: FieldMap = {
  fullMatch: "full_match",
  value: "value",
};

const DiscoveryengineControl_ConditionsFields: FieldMap = {
  activeTimeRange: {
    wireName: "active_time_range",
    kind: "list",
    fields: DiscoveryengineControl_Conditions_ActiveTimeRangeFields,
  },
  queryRegex: "query_regex",
  queryTerms: {
    wireName: "query_terms",
    kind: "list",
    fields: DiscoveryengineControl_Conditions_QueryTermsFields,
  },
};

const DiscoveryengineControl_FilterActionFields: FieldMap = {
  dataStore: "data_store",
  filter: "filter",
};

const DiscoveryengineControl_PromoteAction_SearchLinkPromotionFields: FieldMap = {
...
const DiscoveryengineControl_PromoteActionFields: FieldMap = {
  dataStore: "data_store",
  searchLinkPromotion: {
    wireName: "search_link_promotion",
    kind: "object",
    fields: DiscoveryengineControl_PromoteAction_SearchLinkPromotionFields,
  },
};

const DiscoveryengineControl_RedirectActionFields: FieldMap = {
  redirectUri: "redirect_uri",
};

const DiscoveryengineControl_SynonymsActionFields: FieldMap = {
  synonyms: "synonyms",
};

export interface DiscoveryengineControlConfig {
  ...
  boostAction?: DiscoveryengineControl_BoostAction | Computed<DiscoveryengineControl_BoostAction>;
  ...
  conditions?: DiscoveryengineControl_Conditions[] | Computed<DiscoveryengineControl_Conditions[]>;
  ...
  filterAction?: DiscoveryengineControl_FilterAction | Computed<DiscoveryengineControl_FilterAction>;
  ...
  promoteAction?: DiscoveryengineControl_PromoteAction | Computed<DiscoveryengineControl_PromoteAction>;
  /** Redirects a shopper to the provided URI. */
  redirectAction?: DiscoveryengineControl_RedirectAction | Computed<DiscoveryengineControl_RedirectAction>;
  ...
  synonymsAction?: DiscoveryengineControl_SynonymsAction | Computed<DiscoveryengineControl_SynonymsAction>;
...
export interface DiscoveryengineControlAttrs {
  /** Output only. List of all ServingConfig IDs this control is attached to. May take up to 10 minutes to update after changes. */
  associatedServingConfigIds: string[];
  /** Adjusts order of products in returned list. */
  boostAction: DiscoveryengineControl_BoostAction;
  /** Determines when the associated action will trigger. Omit to always apply the action. Currently only a single condition may be specified. Otherwise an INVALID ARGUMENT error is thrown. */
  conditions: DiscoveryengineControl_Conditions[];
  /** Required. Human readable name. The identifier used in UI views. Must be UTF-8 encoded string. Length limit is 128 characters. Otherwise an INVALID ARGUMENT error is thrown. */
  displayName: string;
  /** Specified which products may be included in results. Uses same filter as boost. */
  filterAction: DiscoveryengineControl_FilterAction;
  /** Immutable. Fully qualified name `projects/* /locations/global/dataStore/* /controls/*` */
  name: string;
  /** Promote certain links based on some trigger queries. Example: Promote shoe store link when searching for `shoe` keyword. The link can be outside of associated data store. */
  promoteAction: DiscoveryengineControl_PromoteAction;
  /** Redirects a shopper to the provided URI. */
  redirectAction: DiscoveryengineControl_RedirectAction;
  /** Required. Immutable. What solution the control belongs to. Must be compatible with vertical of resource. Otherwise an INVALID ARGUMENT error is thrown. */
  solutionType: string;
  /** Creates a set of terms that will act as synonyms of one another. Example: "happy" will also be considered as "glad", "glad" will also be considered as "happy". */
  synonymsAction: DiscoveryengineControl_SynonymsAction;
  /** Specifies the use case for the control. Affects what condition fields can be set. Only applies to SOLUTION_TYPE_SEARCH. Currently only allow one use case per control. Must be set when solution_type is SolutionType.SOLUTION_TYPE_SEARCH. */
  useCases: string[];
}

export const DiscoveryengineControl: ResourceBinding<DiscoveryengineControlConfig, DiscoveryengineControlAttrs> = {
  wireType: "google_discoveryengine_discoveryengine_control",
  fields: {
    associatedServingConfigIds: "associated_serving_config_ids",
    boostAction: {
      wireName: "boost_action",
      kind: "object",
      fields: DiscoveryengineControl_BoostActionFields,
    },
    conditions: {
      wireName: "conditions",
      kind: "list",
      fields: DiscoveryengineControl_ConditionsFields,
    },
    displayName: "display_name",
    filterAction: {
      wireName: "filter_action",
      kind: "object",
      fields: DiscoveryengineControl_FilterActionFields,
    },
    name: "name",
    promoteAction: {
      wireName: "promote_action",
      kind: "object",
      fields: DiscoveryengineControl_PromoteActionFields,
    },
    redirectAction: {
      wireName: "redirect_action",
      kind: "object",
      fields: DiscoveryengineControl_RedirectActionFields,
    },
    solutionType: "solution_type",
    synonymsAction: {
      wireName: "synonyms_action",
      kind: "object",
      fields: DiscoveryengineControl_SynonymsActionFields,
    },
    useCases: "use_cases",
  },
};
