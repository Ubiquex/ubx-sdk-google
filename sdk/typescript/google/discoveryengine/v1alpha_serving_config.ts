...
export interface V1alphaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpec {
...
export interface V1alphaServingConfig_AnswerGenerationSpec {
  /** The specification for user defined classifier. */
  userDefinedClassifierSpec?: V1alphaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpec | Computed<V1alphaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpec>;
}

export interface V1alphaServingConfig_CustomFineTuningSpec {
  /** Whether or not to enable and include custom fine tuned search adaptor model. */
  enableSearchAdaptor?: boolean | Computed<boolean>;
}

export interface V1alphaServingConfig_EmbeddingConfig {
  /** Full field path in the schema mapped as embedding field. */
  fieldPath?: string | Computed<string>;
}

export interface V1alphaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpec {
...
export interface V1alphaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpec {
...
export interface V1alphaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpec {
...
export interface V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec {
  /** Text at the beginning of the prompt that instructs the assistant. Examples are available in the user guide. */
  preamble?: string | Computed<string>;
}

export interface V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpec {
...
export interface V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpec {
  /** Optional. Source of image returned in the answer. */
  imageSource?: string | Computed<string>;
}

export interface V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec {
  ...
  modelPromptSpec?: V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec | Computed<V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec>;
  /** Specification of the model. */
  modelSpec?: V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpec | Computed<V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpec>;
  ...
  multimodalSpec?: V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpec | Computed<V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpec>;
...
export interface V1alphaServingConfig_GenericConfig_ContentSearchSpec {
  ...
  chunkSpec?: V1alphaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpec | Computed<V1alphaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpec>;
  /** A specification for configuring the extractive content in a search response. */
  extractiveContentSpec?: V1alphaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpec | Computed<V1alphaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpec>;
  ...
  snippetSpec?: V1alphaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpec | Computed<V1alphaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpec>;
  /** A specification for configuring a summary returned in a search response. */
  summarySpec?: V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec | Computed<V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec>;
}

export interface V1alphaServingConfig_GenericConfig {
  /** A specification for configuring the behavior of content search. */
  contentSearchSpec?: V1alphaServingConfig_GenericConfig_ContentSearchSpec | Computed<V1alphaServingConfig_GenericConfig_ContentSearchSpec>;
}

export interface V1alphaServingConfig_GuidedSearchSpec {
...
export interface V1alphaServingConfig_MediaConfig {
...
export interface V1alphaServingConfig_PersonalizationSpec {
  /** The personalization mode of the search request. Defaults to Mode.AUTO. */
  mode?: string | Computed<string>;
}

const V1alphaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpecFields: FieldMap = {
...
const V1alphaServingConfig_AnswerGenerationSpecFields: FieldMap = {
  userDefinedClassifierSpec: {
    wireName: "user_defined_classifier_spec",
    kind: "object",
    fields: V1alphaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpecFields,
  },
};

const V1alphaServingConfig_CustomFineTuningSpecFields: FieldMap = {
  enableSearchAdaptor: "enable_search_adaptor",
};

const V1alphaServingConfig_EmbeddingConfigFields: FieldMap = {
  fieldPath: "field_path",
};

const V1alphaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpecFields: FieldMap = {
  numNextChunks: "num_next_chunks",
  numPreviousChunks: "num_previous_chunks",
};

const V1alphaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpecFields: FieldMap = {
...
const V1alphaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpecFields: FieldMap = {
  maxSnippetCount: "max_snippet_count",
  referenceOnly: "reference_only",
  returnSnippet: "return_snippet",
};

const V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpecFields: FieldMap = {
  preamble: "preamble",
};

const V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpecFields: FieldMap = {
  version: "version",
};

const V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpecFields: FieldMap = {
  imageSource: "image_source",
};

const V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpecFields: FieldMap = {
  ...
  modelPromptSpec: {
    ...
    kind: "object",
    fields: V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpecFields,
  },
  modelSpec: {
    wireName: "model_spec",
    kind: "object",
    fields: V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpecFields,
  },
  multimodalSpec: {
    wireName: "multimodal_spec",
    kind: "object",
    fields: V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpecFields,
  },
  summaryResultCount: "summary_result_count",
  useSemanticChunks: "use_semantic_chunks",
};

const V1alphaServingConfig_GenericConfig_ContentSearchSpecFields: FieldMap = {
  chunkSpec: {
    wireName: "chunk_spec",
    kind: "object",
    fields: V1alphaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpecFields,
  },
  extractiveContentSpec: {
    wireName: "extractive_content_spec",
    kind: "object",
    fields: V1alphaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpecFields,
  },
  searchResultMode: "search_result_mode",
  snippetSpec: {
    wireName: "snippet_spec",
    kind: "object",
    fields: V1alphaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpecFields,
  },
  summarySpec: {
    wireName: "summary_spec",
    kind: "object",
    fields: V1alphaServingConfig_GenericConfig_ContentSearchSpec_SummarySpecFields,
  },
};

const V1alphaServingConfig_GenericConfigFields: FieldMap = {
  contentSearchSpec: {
    wireName: "content_search_spec",
    kind: "object",
    fields: V1alphaServingConfig_GenericConfig_ContentSearchSpecFields,
  },
};

const V1alphaServingConfig_GuidedSearchSpecFields: FieldMap = {
...
const V1alphaServingConfig_MediaConfigFields: FieldMap = {
...
const V1alphaServingConfig_PersonalizationSpecFields: FieldMap = {
  mode: "mode",
};

export interface V1alphaServingConfigConfig {
  ...
  embeddingConfig?: V1alphaServingConfig_EmbeddingConfig | Computed<V1alphaServingConfig_EmbeddingConfig>;
  ...
  genericConfig?: V1alphaServingConfig_GenericConfig | Computed<V1alphaServingConfig_GenericConfig>;
  /** Defines guided search spec. */
  guidedSearchSpec?: V1alphaServingConfig_GuidedSearchSpec | Computed<V1alphaServingConfig_GuidedSearchSpec>;
  ...
  mediaConfig?: V1alphaServingConfig_MediaConfig | Computed<V1alphaServingConfig_MediaConfig>;
  ...
  personalizationSpec?: V1alphaServingConfig_PersonalizationSpec | Computed<V1alphaServingConfig_PersonalizationSpec>;
...
export interface V1alphaServingConfigAttrs {
  /** The specification for answer generation. */
  answerGenerationSpec: V1alphaServingConfig_AnswerGenerationSpec;
  /** Boost controls to use in serving path. All triggered boost controls will be applied. Boost controls must be in the same data store as the serving config. Maximum of 20 boost controls. */
  boostControlIds: string[];
  /** Output only. ServingConfig created timestamp. */
  createTime: string;
  /** Defines custom fine tuning spec. */
  customFineTuningSpec: V1alphaServingConfig_CustomFineTuningSpec;
  /** Required. The human readable serving config display name. Used in Discovery UI. This field must be a UTF-8 encoded string with a length limit of 128 characters. Otherwise, an INVALID_ARGUMENT error is returned. */
  displayName: string;
  /** Condition do not associate specifications. If multiple do not associate conditions match, all matching do not associate controls in the list will execute. Order does not matter. Maximum number of specifications is 100. Can only be set if SolutionType is SOLUTION_TYPE_SEARCH. */
  ...
  /** Defines embedding config, used for bring your own embeddings feature. */
  embeddingConfig: V1alphaServingConfig_EmbeddingConfig;
  /** Filter controls to use in serving path. All triggered filter controls will be applied. Filter controls must be in the same data store as the serving config. Maximum of 20 filter controls. */
  filterControlIds: string[];
  /** Specifies the configurations needed for Generic Discovery.Currently we support: * `content_search_spec`: configuration for generic content search. */
  genericConfig: V1alphaServingConfig_GenericConfig;
  /** Defines guided search spec. */
  guidedSearchSpec: V1alphaServingConfig_GuidedSearchSpec;
  /** Condition ignore specifications. If multiple ignore conditions match, all matching ignore controls in the list will execute. Order does not matter. Maximum number of specifications is 100. */
  ignoreControlIds: string[];
  /** Specifies the configurations needed for Media Discovery. Currently we support: * `demote_content_watched`: Threshold for watched content demotion. Customers can specify if using watched content demotion or use viewed detail page. Using the content watched demotion, customers need to specify the watched minutes or percentage exceeds the threshold, the content will be demoted in the recommendation result. * `promote_fresh_content`: cutoff days for fresh content promotion. Customers can specify if using content freshness promotion. If the content was published within the cutoff days, the content will be promoted in the recommendation result. Can only be set if SolutionType is SOLUTION_TYPE_RECOMMENDATION. */
  mediaConfig: V1alphaServingConfig_MediaConfig;
  /** The id of the model to use at serving time. Currently only RecommendationModels are supported. Can be changed but only to a compatible model (e.g. others-you-may-like CTR to others-you-may-like CVR). Required when SolutionType is SOLUTION_TYPE_RECOMMENDATION. */
  modelId: string;
  /** Immutable. Fully qualified name `projects/{project}/locations/{location}/collections/{collection_id}/engines/{engine_id}/servingConfigs/{serving_config_id}` */
  name: string;
  ...
  /** The specification for personalization. */
  personalizationSpec: V1alphaServingConfig_PersonalizationSpec;
  /** Condition promote specifications. Maximum number of specifications is 100. */
...
export const V1alphaServingConfig: ResourceBinding<V1alphaServingConfigConfig, V1alphaServingConfigAttrs> = {
  wireType: "google_discoveryengine_v1alpha_serving_config",
  fields: {
    ...
    customFineTuningSpec: {
      ...
      kind: "object",
      fields: V1alphaServingConfig_CustomFineTuningSpecFields,
    },
    ...
    embeddingConfig: {
      ...
      kind: "object",
      fields: V1alphaServingConfig_EmbeddingConfigFields,
    },
    filterControlIds: "filter_control_ids",
    genericConfig: {
      wireName: "generic_config",
      kind: "object",
      fields: V1alphaServingConfig_GenericConfigFields,
    },
    guidedSearchSpec: {
      wireName: "guided_search_spec",
      kind: "object",
      fields: V1alphaServingConfig_GuidedSearchSpecFields,
    },
    ignoreControlIds: "ignore_control_ids",
    mediaConfig: {
      wireName: "media_config",
      kind: "object",
      fields: V1alphaServingConfig_MediaConfigFields,
    },
    modelId: "model_id",
    name: "name",
    ...
    personalizationSpec: {
      ...
      kind: "object",
      fields: V1alphaServingConfig_PersonalizationSpecFields,
    },
