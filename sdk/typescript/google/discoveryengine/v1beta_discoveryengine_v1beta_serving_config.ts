// Code generated by `ubx sdk gen` from google_discoveryengine_v1beta_discoveryengine_v1beta_serving_config. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1betaDiscoveryengineV1betaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpec {
...
export interface V1betaDiscoveryengineV1betaServingConfig_AnswerGenerationSpec {
  /** The specification for user defined classifier. */
  userDefinedClassifierSpec?: V1betaDiscoveryengineV1betaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpec | Computed<V1betaDiscoveryengineV1betaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpec>;
}

export interface V1betaDiscoveryengineV1betaServingConfig_EmbeddingConfig {
  /** Full field path in the schema mapped as embedding field. */
  fieldPath?: string | Computed<string>;
}

export interface V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpec {
...
export interface V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpec {
...
export interface V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpec {
...
export interface V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec {
  /** Text at the beginning of the prompt that instructs the assistant. Examples are available in the user guide. */
  preamble?: string | Computed<string>;
}

export interface V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpec {
...
export interface V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpec {
  /** Optional. Source of image returned in the answer. */
  imageSource?: string | Computed<string>;
}

export interface V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec {
  ...
  modelPromptSpec?: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec | Computed<V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec>;
  /** Specification of the model. */
  modelSpec?: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpec | Computed<V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpec>;
  ...
  multimodalSpec?: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpec | Computed<V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpec>;
...
export interface V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec {
  ...
  chunkSpec?: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpec | Computed<V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpec>;
  /** A specification for configuring the extractive content in a search response. */
  extractiveContentSpec?: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpec | Computed<V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpec>;
  ...
  snippetSpec?: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpec | Computed<V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpec>;
  /** A specification for configuring a summary returned in a search response. */
  summarySpec?: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec | Computed<V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec>;
}

export interface V1betaDiscoveryengineV1betaServingConfig_GenericConfig {
  /** A specification for configuring the behavior of content search. */
  contentSearchSpec?: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec | Computed<V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec>;
}

export interface V1betaDiscoveryengineV1betaServingConfig_MediaConfig {
...
export interface V1betaDiscoveryengineV1betaServingConfig_PersonalizationSpec {
  /** The personalization mode of the search request. Defaults to Mode.AUTO. */
  mode?: string | Computed<string>;
}

const V1betaDiscoveryengineV1betaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpecFields: FieldMap = {
...
const V1betaDiscoveryengineV1betaServingConfig_AnswerGenerationSpecFields: FieldMap = {
  userDefinedClassifierSpec: {
    wireName: "user_defined_classifier_spec",
    kind: "object",
    fields: V1betaDiscoveryengineV1betaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpecFields,
  },
};

const V1betaDiscoveryengineV1betaServingConfig_EmbeddingConfigFields: FieldMap = {
  fieldPath: "field_path",
};

const V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpecFields: FieldMap = {
  numNextChunks: "num_next_chunks",
  numPreviousChunks: "num_previous_chunks",
};

const V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpecFields: FieldMap = {
...
const V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpecFields: FieldMap = {
  maxSnippetCount: "max_snippet_count",
  referenceOnly: "reference_only",
  returnSnippet: "return_snippet",
};

const V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpecFields: FieldMap = {
  preamble: "preamble",
};

const V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpecFields: FieldMap = {
  version: "version",
};

const V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpecFields: FieldMap = {
  imageSource: "image_source",
};

const V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpecFields: FieldMap = {
  ...
  modelPromptSpec: {
    ...
    kind: "object",
    fields: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpecFields,
  },
  modelSpec: {
    wireName: "model_spec",
    kind: "object",
    fields: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpecFields,
  },
  multimodalSpec: {
    wireName: "multimodal_spec",
    kind: "object",
    fields: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpecFields,
  },
  summaryResultCount: "summary_result_count",
  useSemanticChunks: "use_semantic_chunks",
};

const V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpecFields: FieldMap = {
  chunkSpec: {
    wireName: "chunk_spec",
    kind: "object",
    fields: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpecFields,
  },
  extractiveContentSpec: {
    wireName: "extractive_content_spec",
    kind: "object",
    fields: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpecFields,
  },
  searchResultMode: "search_result_mode",
  snippetSpec: {
    wireName: "snippet_spec",
    kind: "object",
    fields: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpecFields,
  },
  summarySpec: {
    wireName: "summary_spec",
    kind: "object",
    fields: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpecFields,
  },
};

const V1betaDiscoveryengineV1betaServingConfig_GenericConfigFields: FieldMap = {
  contentSearchSpec: {
    wireName: "content_search_spec",
    kind: "object",
    fields: V1betaDiscoveryengineV1betaServingConfig_GenericConfig_ContentSearchSpecFields,
  },
};

const V1betaDiscoveryengineV1betaServingConfig_MediaConfigFields: FieldMap = {
...
const V1betaDiscoveryengineV1betaServingConfig_PersonalizationSpecFields: FieldMap = {
  mode: "mode",
};

export interface V1betaDiscoveryengineV1betaServingConfigConfig {
  /** The specification for answer generation. */
  answerGenerationSpec?: V1betaDiscoveryengineV1betaServingConfig_AnswerGenerationSpec | Computed<V1betaDiscoveryengineV1betaServingConfig_AnswerGenerationSpec>;
  ...
  embeddingConfig?: V1betaDiscoveryengineV1betaServingConfig_EmbeddingConfig | Computed<V1betaDiscoveryengineV1betaServingConfig_EmbeddingConfig>;
  ...
  genericConfig?: V1betaDiscoveryengineV1betaServingConfig_GenericConfig | Computed<V1betaDiscoveryengineV1betaServingConfig_GenericConfig>;
  ...
  mediaConfig?: V1betaDiscoveryengineV1betaServingConfig_MediaConfig | Computed<V1betaDiscoveryengineV1betaServingConfig_MediaConfig>;
  ...
  personalizationSpec?: V1betaDiscoveryengineV1betaServingConfig_PersonalizationSpec | Computed<V1betaDiscoveryengineV1betaServingConfig_PersonalizationSpec>;
...
export interface V1betaDiscoveryengineV1betaServingConfigAttrs {
  /** The specification for answer generation. */
  answerGenerationSpec: V1betaDiscoveryengineV1betaServingConfig_AnswerGenerationSpec;
  /** Boost controls to use in serving path. All triggered boost controls will be applied. Boost controls must be in the same data store as the serving config. Maximum of 20 boost controls. */
  ...
  /** Defines embedding config, used for bring your own embeddings feature. */
  embeddingConfig: V1betaDiscoveryengineV1betaServingConfig_EmbeddingConfig;
  /** Filter controls to use in serving path. All triggered filter controls will be applied. Filter controls must be in the same data store as the serving config. Maximum of 20 filter controls. */
  filterControlIds: string[];
  /** Specifies the configurations needed for Generic Discovery.Currently we support: * `content_search_spec`: configuration for generic content search. */
  genericConfig: V1betaDiscoveryengineV1betaServingConfig_GenericConfig;
  /** Condition ignore specifications. If multiple ignore conditions match, all matching ignore controls in the list will execute. Order does not matter. Maximum number of specifications is 100. */
  ignoreControlIds: string[];
  /** Specifies the configurations needed for Media Discovery. Currently we support: * `demote_content_watched`: Threshold for watched content demotion. Customers can specify if using watched content demotion or use viewed detail page. Using the content watched demotion, customers need to specify the watched minutes or percentage exceeds the threshold, the content will be demoted in the recommendation result. * `promote_fresh_content`: cutoff days for fresh content promotion. Customers can specify if using content freshness promotion. If the content was published within the cutoff days, the content will be promoted in the recommendation result. Can only be set if SolutionType is SOLUTION_TYPE_RECOMMENDATION. */
  mediaConfig: V1betaDiscoveryengineV1betaServingConfig_MediaConfig;
  /** The id of the model to use at serving time. Currently only RecommendationModels are supported. Can be changed but only to a compatible model (e.g. others-you-may-like CTR to others-you-may-like CVR). Required when SolutionType is SOLUTION_TYPE_RECOMMENDATION. */
  modelId: string;
  /** Immutable. Fully qualified name `projects/{project}/locations/{location}/collections/{collection_id}/engines/{engine_id}/servingConfigs/{serving_config_id}` */
  name: string;
  ...
  /** The specification for personalization. */
  personalizationSpec: V1betaDiscoveryengineV1betaServingConfig_PersonalizationSpec;
  /** Condition promote specifications. Maximum number of specifications is 100. */
...
export const V1betaDiscoveryengineV1betaServingConfig: ResourceBinding<V1betaDiscoveryengineV1betaServingConfigConfig, V1betaDiscoveryengineV1betaServingConfigAttrs> = {
  wireType: "google_discoveryengine_v1beta_discoveryengine_v1beta_serving_config",
  fields: {
    answerGenerationSpec: {
      wireName: "answer_generation_spec",
      kind: "object",
      fields: V1betaDiscoveryengineV1betaServingConfig_AnswerGenerationSpecFields,
    },
    ...
    embeddingConfig: {
      ...
      kind: "object",
      fields: V1betaDiscoveryengineV1betaServingConfig_EmbeddingConfigFields,
    },
    filterControlIds: "filter_control_ids",
    genericConfig: {
      wireName: "generic_config",
      kind: "object",
      fields: V1betaDiscoveryengineV1betaServingConfig_GenericConfigFields,
    },
    ignoreControlIds: "ignore_control_ids",
    mediaConfig: {
      wireName: "media_config",
      kind: "object",
      fields: V1betaDiscoveryengineV1betaServingConfig_MediaConfigFields,
    },
    modelId: "model_id",
    name: "name",
    ...
    personalizationSpec: {
      ...
      kind: "object",
      fields: V1betaDiscoveryengineV1betaServingConfig_PersonalizationSpecFields,
    },
