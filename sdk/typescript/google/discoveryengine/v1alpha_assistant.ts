...
export interface V1alphaAssistant_CustomerPolicy_BannedPhrases {
  ignoreDiacritics?: boolean | Computed<boolean>;
  matchType?: string | Computed<string>;
  phrase?: string | Computed<string>;
}

export interface V1alphaAssistant_CustomerPolicy_DataProtectionPolicy_SensitiveDataProtectionPolicy {
  /** Optional. Specifies the resource name of the Sensitive Data Protection content policy. */
  policy?: string | Computed<string>;
}

export interface V1alphaAssistant_CustomerPolicy_DataProtectionPolicy {
  ...
  sensitiveDataProtectionPolicy?: V1alphaAssistant_CustomerPolicy_DataProtectionPolicy_SensitiveDataProtectionPolicy | Computed<V1alphaAssistant_CustomerPolicy_DataProtectionPolicy_SensitiveDataProtectionPolicy>;
}

export interface V1alphaAssistant_CustomerPolicy_ModelArmorConfig {
...
export interface V1alphaAssistant_CustomerPolicy {
  /** Optional. List of banned phrases. */
  bannedPhrases?: V1alphaAssistant_CustomerPolicy_BannedPhrases[] | Computed<V1alphaAssistant_CustomerPolicy_BannedPhrases[]>;
  /** Contains the data protection policy config for a DataStore or a connector. */
  dataProtectionPolicy?: V1alphaAssistant_CustomerPolicy_DataProtectionPolicy | Computed<V1alphaAssistant_CustomerPolicy_DataProtectionPolicy>;
  /** Configuration for customer defined Model Armor templates to be used for sanitizing user prompts and assistant responses. */
  modelArmorConfig?: V1alphaAssistant_CustomerPolicy_ModelArmorConfig | Computed<V1alphaAssistant_CustomerPolicy_ModelArmorConfig>;
}

export interface V1alphaAssistant_EnabledTools_ToolInfo {
  toolDisplayName?: string | Computed<string>;
  toolName?: string | Computed<string>;
}

export interface V1alphaAssistant_EnabledTools {
  toolInfo?: V1alphaAssistant_EnabledTools_ToolInfo[] | Computed<V1alphaAssistant_EnabledTools_ToolInfo[]>;
}

export interface V1alphaAssistant_GenerationConfig_SystemInstruction {
...
export interface V1alphaAssistant_GenerationConfig {
  ...
  systemInstruction?: V1alphaAssistant_GenerationConfig_SystemInstruction | Computed<V1alphaAssistant_GenerationConfig_SystemInstruction>;
}

const V1alphaAssistant_CustomerPolicy_BannedPhrasesFields: FieldMap = {
  ignoreDiacritics: "ignore_diacritics",
  matchType: "match_type",
  phrase: "phrase",
};

const V1alphaAssistant_CustomerPolicy_DataProtectionPolicy_SensitiveDataProtectionPolicyFields: FieldMap = {
  policy: "policy",
};

const V1alphaAssistant_CustomerPolicy_DataProtectionPolicyFields: FieldMap = {
...
const V1alphaAssistant_CustomerPolicy_ModelArmorConfigFields: FieldMap = {
  failureMode: "failure_mode",
  responseTemplate: "response_template",
  userPromptTemplate: "user_prompt_template",
};

const V1alphaAssistant_CustomerPolicyFields: FieldMap = {
  bannedPhrases: {
...
const V1alphaAssistant_EnabledTools_ToolInfoFields: FieldMap = {
  toolDisplayName: "tool_display_name",
  toolName: "tool_name",
};

const V1alphaAssistant_EnabledToolsFields: FieldMap = {
  toolInfo: {
    wireName: "tool_info",
    kind: "list",
...
const V1alphaAssistant_GenerationConfig_SystemInstructionFields: FieldMap = {
  additionalSystemInstruction: "additional_system_instruction",
};

const V1alphaAssistant_GenerationConfigFields: FieldMap = {
...
export interface V1alphaAssistantAttrs {
  /** Output only. Represents the time when this Assistant was created. */
  createTime: string;
  /** Customer-defined policy for the assistant. */
  customerPolicy: V1alphaAssistant_CustomerPolicy;
  /** Optional. This field controls the default web grounding toggle for end users if `web_grounding_type` is set to `WEB_GROUNDING_TYPE_GOOGLE_SEARCH` or `WEB_GROUNDING_TYPE_ENTERPRISE_WEB_SEARCH`. By default, this field is set to false. If `web_grounding_type` is `WEB_GROUNDING_TYPE_GOOGLE_SEARCH` or `WEB_GROUNDING_TYPE_ENTERPRISE_WEB_SEARCH`, end users will have web grounding enabled by default on UI. If true, grounding toggle will be disabled by default on UI. End users can still enable web grounding in the UI if web grounding is enabled. */
