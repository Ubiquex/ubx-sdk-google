...
export interface V1alphaControl_BoostAction_InterpolationBoostSpec_ControlPoints {
  attributeValue?: string | Computed<string>;
  boostAmount?: number | Computed<number>;
}

export interface V1alphaControl_BoostAction_InterpolationBoostSpec {
  ...
  controlPoints?: V1alphaControl_BoostAction_InterpolationBoostSpec_ControlPoints[] | Computed<V1alphaControl_BoostAction_InterpolationBoostSpec_ControlPoints[]>;
...
export interface V1alphaControl_BoostAction {
  ...
  interpolationBoostSpec?: V1alphaControl_BoostAction_InterpolationBoostSpec | Computed<V1alphaControl_BoostAction_InterpolationBoostSpec>;
}

export interface V1alphaControl_Conditions_ActiveTimeRange {
  endTime?: string | Computed<string>;
  startTime?: string | Computed<string>;
}

export interface V1alphaControl_Conditions_QueryTerms {
  fullMatch?: boolean | Computed<boolean>;
  value?: string | Computed<string>;
}

export interface V1alphaControl_Conditions {
  activeTimeRange?: V1alphaControl_Conditions_ActiveTimeRange[] | Computed<V1alphaControl_Conditions_ActiveTimeRange[]>;
  queryRegex?: string | Computed<string>;
  queryTerms?: V1alphaControl_Conditions_QueryTerms[] | Computed<V1alphaControl_Conditions_QueryTerms[]>;
}

export interface V1alphaControl_FilterAction {
...
export interface V1alphaControl_PromoteAction_SearchLinkPromotion {
...
export interface V1alphaControl_PromoteAction {
  /** Required. Data store with which this promotion is attached to. */
  dataStore?: string | Computed<string>;
  /** Promotion proto includes uri and other helping information to display the promotion. */
  searchLinkPromotion?: V1alphaControl_PromoteAction_SearchLinkPromotion | Computed<V1alphaControl_PromoteAction_SearchLinkPromotion>;
}

export interface V1alphaControl_RedirectAction {
...
export interface V1alphaControl_SynonymsAction {
...
const V1alphaControl_BoostAction_InterpolationBoostSpec_ControlPointsFields: FieldMap = {
  attributeValue: "attribute_value",
  boostAmount: "boost_amount",
};

const V1alphaControl_BoostAction_InterpolationBoostSpecFields: FieldMap = {
...
const V1alphaControl_BoostActionFields: FieldMap = {
  boost: "boost",
...
const V1alphaControl_Conditions_ActiveTimeRangeFields: FieldMap = {
  endTime: "end_time",
  startTime: "start_time",
};

const V1alphaControl_Conditions_QueryTermsFields: FieldMap = {
  fullMatch: "full_match",
  value: "value",
};

const V1alphaControl_ConditionsFields: FieldMap = {
  activeTimeRange: {
...
const V1alphaControl_FilterActionFields: FieldMap = {
  dataStore: "data_store",
  filter: "filter",
};

const V1alphaControl_PromoteAction_SearchLinkPromotionFields: FieldMap = {
...
const V1alphaControl_PromoteActionFields: FieldMap = {
  dataStore: "data_store",
  searchLinkPromotion: {
...
const V1alphaControl_RedirectActionFields: FieldMap = {
  redirectUri: "redirect_uri",
};

const V1alphaControl_SynonymsActionFields: FieldMap = {
  synonyms: "synonyms",
};
...
export interface V1alphaControlConfig {
  ...
  conditions?: V1alphaControl_Conditions[] | Computed<V1alphaControl_Conditions[]>;
  ...
  filterAction?: V1alphaControl_FilterAction | Computed<V1alphaControl_FilterAction>;
  ...
  promoteAction?: V1alphaControl_PromoteAction | Computed<V1alphaControl_PromoteAction>;
  /** Redirects a shopper to the provided URI. */
  redirectAction?: V1alphaControl_RedirectAction | Computed<V1alphaControl_RedirectAction>;
  ...
  synonymsAction?: V1alphaControl_SynonymsAction | Computed<V1alphaControl_SynonymsAction>;
...
export interface V1alphaControlAttrs {
  ...
  /** Adjusts order of products in returned list. */
  boostAction: V1alphaControl_BoostAction;
  /** Determines when the associated action will trigger. Omit to always apply the action. Currently only a single condition may be specified. Otherwise an INVALID ARGUMENT error is thrown. */
  conditions: V1alphaControl_Conditions[];
  /** Required. Human readable name. The identifier used in UI views. Must be UTF-8 encoded string. Length limit is 128 characters. Otherwise an INVALID ARGUMENT error is thrown. */
  displayName: string;
  /** Specified which products may be included in results. Uses same filter as boost. */
  filterAction: V1alphaControl_FilterAction;
  /** Immutable. Fully qualified name `projects/* /locations/global/dataStore/* /controls/*` */
  name: string;
  /** Promote certain links based on some trigger queries. Example: Promote shoe store link when searching for `shoe` keyword. The link can be outside of associated data store. */
  promoteAction: V1alphaControl_PromoteAction;
  /** Redirects a shopper to the provided URI. */
  redirectAction: V1alphaControl_RedirectAction;
  /** Required. Immutable. What solution the control belongs to. Must be compatible with vertical of resource. Otherwise an INVALID ARGUMENT error is thrown. */
  solutionType: string;
  /** Creates a set of terms that will act as synonyms of one another. Example: "happy" will also be considered as "glad", "glad" will also be considered as "happy". */
  synonymsAction: V1alphaControl_SynonymsAction;
  /** Specifies the use case for the control. Affects what condition fields can be set. Only applies to SOLUTION_TYPE_SEARCH. Currently only allow one use case per control. Must be set when solution_type is SolutionType.SOLUTION_TYPE_SEARCH. */
  useCases: string[];
}
