...
export interface SasportalDevice_ActiveConfig_AirInterface {
...
export interface SasportalDevice_ActiveConfig_InstallationParams {
...
export interface SasportalDevice_ActiveConfig_Model {
...
export interface SasportalDevice_ActiveConfig {
  /** Information about the device's air interface. */
  airInterface?: SasportalDevice_ActiveConfig_AirInterface | Computed<SasportalDevice_ActiveConfig_AirInterface>;
  /** The call sign of the device operator. */
  callSign?: string | Computed<string>;
  /** FCC category of the device. */
  category?: string | Computed<string>;
  /** Information about the device installation parameters. */
  installationParams?: SasportalDevice_ActiveConfig_InstallationParams | Computed<SasportalDevice_ActiveConfig_InstallationParams>;
  /** Output only. Whether the configuration has been signed by a CPI. */
  isSigned?: boolean | Computed<boolean>;
  /** Measurement reporting capabilities of the device. */
  measurementCapabilities?: string[] | Computed<string[]>;
  /** Information about the model of the device. */
  model?: SasportalDevice_ActiveConfig_Model | Computed<SasportalDevice_ActiveConfig_Model>;
...
export interface SasportalDevice_CurrentChannels_FrequencyRange {
  highFrequencyMhz?: number | Computed<number>;
  lowFrequencyMhz?: number | Computed<number>;
}

export interface SasportalDevice_CurrentChannels {
  frequencyRange?: SasportalDevice_CurrentChannels_FrequencyRange | Computed<SasportalDevice_CurrentChannels_FrequencyRange>;
  score?: number | Computed<number>;
}

export interface SasportalDevice_DeviceMetadata_NrqzValidation {
  /** Validation case ID. */
...
export interface SasportalDevice_DeviceMetadata {
  ...
  nrqzValidation?: SasportalDevice_DeviceMetadata_NrqzValidation | Computed<SasportalDevice_DeviceMetadata_NrqzValidation>;
}

export interface SasportalDevice_Grants_MoveList {
  dpaId?: string | Computed<string>;
  frequencyRange?: SasportalDevice_CurrentChannels_FrequencyRange | Computed<SasportalDevice_CurrentChannels_FrequencyRange>;
}

export interface SasportalDevice_Grants {
  ...
  moveList?: SasportalDevice_Grants_MoveList[] | Computed<SasportalDevice_Grants_MoveList[]>;
  state?: string | Computed<string>;
  suspensionReason?: string[] | Computed<string[]>;
}

const SasportalDevice_ActiveConfig_AirInterfaceFields: FieldMap = {
  radioTechnology: "radio_technology",
  supportedSpec: "supported_spec",
};

const SasportalDevice_ActiveConfig_InstallationParamsFields: FieldMap = {
...
const SasportalDevice_ActiveConfig_ModelFields: FieldMap = {
...
const SasportalDevice_ActiveConfigFields: FieldMap = {
  airInterface: {
...
const SasportalDevice_CurrentChannels_FrequencyRangeFields: FieldMap = {
  highFrequencyMhz: "high_frequency_mhz",
  lowFrequencyMhz: "low_frequency_mhz",
};

const SasportalDevice_CurrentChannelsFields: FieldMap = {
  frequencyRange: {
...
const SasportalDevice_DeviceMetadata_NrqzValidationFields: FieldMap = {
  caseId: "case_id",
  cpiId: "cpi_id",
  latitude: "latitude",
  longitude: "longitude",
...
const SasportalDevice_DeviceMetadataFields: FieldMap = {
  antennaModel: "antenna_model",
...
const SasportalDevice_Grants_MoveListFields: FieldMap = {
  dpaId: "dpa_id",
  frequencyRange: {
    wireName: "frequency_range",
    kind: "object",
...
const SasportalDevice_GrantsFields: FieldMap = {
...
export interface SasportalDeviceConfig {
  ...
  activeConfig?: SasportalDevice_ActiveConfig | Computed<SasportalDevice_ActiveConfig>;
  /** Output only. Current channels with scores. */
  currentChannels?: SasportalDevice_CurrentChannels[] | Computed<SasportalDevice_CurrentChannels[]>;
  /** Device data overridable by both SAS Portal and registration requests. */
  deviceMetadata?: SasportalDevice_DeviceMetadata | Computed<SasportalDevice_DeviceMetadata>;
  /** Device display name. */
  ...
  grantRangeAllowlists?: SasportalDevice_CurrentChannels_FrequencyRange[] | Computed<SasportalDevice_CurrentChannels_FrequencyRange[]>;
  /** Output only. Grants held by the device. */
  grants?: SasportalDevice_Grants[] | Computed<SasportalDevice_Grants[]>;
  /** Output only. The resource path name. */
  name?: string | Computed<string>;
  /** Information about the device configuration. */
  preloadedConfig?: SasportalDevice_ActiveConfig | Computed<SasportalDevice_ActiveConfig>;
...
export interface SasportalDeviceAttrs {
  /** Information about the device configuration. */
  activeConfig: SasportalDevice_ActiveConfig;
  /** Output only. Current channels with scores. */
  currentChannels: SasportalDevice_CurrentChannels[];
  /** Device data overridable by both SAS Portal and registration requests. */
  deviceMetadata: SasportalDevice_DeviceMetadata;
  /** Device display name. */
  displayName: string;
  /** The FCC identifier of the device. Refer to https://www.fcc.gov/oet/ea/fccid for FccID format. Accept underscores and periods because some test-SAS customers use them. */
  fccId: string;
  /** Only ranges that are within the allowlists are available for new grants. */
  grantRangeAllowlists: SasportalDevice_CurrentChannels_FrequencyRange[];
  /** Output only. Grants held by the device. */
  grants: SasportalDevice_Grants[];
  /** Output only. The resource path name. */
  name: string;
  /** Information about the device configuration. */
  preloadedConfig: SasportalDevice_ActiveConfig;
  /** A serial number assigned to the device by the device manufacturer. */
  serialNumber: string;
  /** Output only. Device state. */
  state: string;
...
export const SasportalDevice: ResourceBinding<SasportalDeviceConfig, SasportalDeviceAttrs> = {
