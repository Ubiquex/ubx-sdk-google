...
const UnitOperation_ConditionsFields: FieldMap = {
...
export interface UnitOperationConfig {
  ...
  conditions?: UnitOperation_Conditions[] | Computed<UnitOperation_Conditions[]>;
...
export const UnitOperation: ResourceBinding<UnitOperationConfig, UnitOperationAttrs> = {
  ...
  fields: {
    ...
    conditions: {
      wireName: "conditions",
      kind: "list",
      fields: UnitOperation_ConditionsFields,
    },
