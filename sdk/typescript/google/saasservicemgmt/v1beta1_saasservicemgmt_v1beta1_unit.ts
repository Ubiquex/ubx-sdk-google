...
export interface V1beta1SaasservicemgmtV1beta1Unit_Conditions {
...
export interface V1beta1SaasservicemgmtV1beta1Unit_Dependencies {
  alias?: string | Computed<string>;
  unit?: string | Computed<string>;
}

export interface V1beta1SaasservicemgmtV1beta1Unit_InputVariables {
  type?: string | Computed<string>;
  value?: string | Computed<string>;
  variable?: string | Computed<string>;
}

export interface V1beta1SaasservicemgmtV1beta1Unit_Maintenance {
...
const V1beta1SaasservicemgmtV1beta1Unit_ConditionsFields: FieldMap = {
...
const V1beta1SaasservicemgmtV1beta1Unit_DependenciesFields: FieldMap = {
  alias: "alias",
  unit: "unit",
};

const V1beta1SaasservicemgmtV1beta1Unit_InputVariablesFields: FieldMap = {
  type: "type",
  value: "value",
  variable: "variable",
};

const V1beta1SaasservicemgmtV1beta1Unit_MaintenanceFields: FieldMap = {
  pinnedUntilTime: "pinned_until_time",
};

export interface V1beta1SaasservicemgmtV1beta1UnitConfig {
  ...
  conditions?: V1beta1SaasservicemgmtV1beta1Unit_Conditions[] | Computed<V1beta1SaasservicemgmtV1beta1Unit_Conditions[]>;
  /** Output only. The timestamp when the resource was created. */
  createTime?: string | Computed<string>;
  /** Optional. Output only. Set of dependencies for this unit. Maximum 10. */
  dependencies?: V1beta1SaasservicemgmtV1beta1Unit_Dependencies[] | Computed<V1beta1SaasservicemgmtV1beta1Unit_Dependencies[]>;
  ...
  dependents?: V1beta1SaasservicemgmtV1beta1Unit_Dependencies[] | Computed<V1beta1SaasservicemgmtV1beta1Unit_Dependencies[]>;
  ...
  inputVariables?: V1beta1SaasservicemgmtV1beta1Unit_InputVariables[] | Computed<V1beta1SaasservicemgmtV1beta1Unit_InputVariables[]>;
  ...
  maintenance?: V1beta1SaasservicemgmtV1beta1Unit_Maintenance | Computed<V1beta1SaasservicemgmtV1beta1Unit_Maintenance>;
  ...
  outputVariables?: V1beta1SaasservicemgmtV1beta1Unit_InputVariables[] | Computed<V1beta1SaasservicemgmtV1beta1Unit_InputVariables[]>;
...
export interface V1beta1SaasservicemgmtV1beta1UnitAttrs {
  /** Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations */
  annotations: Record<string, string>;
  /** Optional. Reference to the AppHub Application this unit belongs to. All resources deployed in this Unit will be associated with the specified Application. */
  application: string;
  /** Optional. Output only. A set of conditions which indicate the various conditions this resource can have. */
  conditions: V1beta1SaasservicemgmtV1beta1Unit_Conditions[];
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Optional. Output only. Set of dependencies for this unit. Maximum 10. */
  dependencies: V1beta1SaasservicemgmtV1beta1Unit_Dependencies[];
  /** Optional. Output only. List of Units that depend on this unit. Unit can only be deprovisioned if this list is empty. Maximum 1000. */
  dependents: V1beta1SaasservicemgmtV1beta1Unit_Dependencies[];
  /** Output only. An opaque value that uniquely identifies a version or generation of a resource. It can be used to confirm that the client and server agree on the ordering of a resource being written. */
  etag: string;
  /** Output only. This field stores the unique identifier for the flag configuration to be used by this Unit. */
  ...
  /** Optional. Output only. Indicates the current input variables deployed by the unit */
  inputVariables: V1beta1SaasservicemgmtV1beta1Unit_InputVariables[];
  /** Optional. The labels on the resource, which can be used for categorization. similar to Kubernetes resource labels. */
  labels: Record<string, string>;
  /** Captures requested directives for performing future maintenance on the unit. This includes a request for the unit to skip maintenance for a period of time and remain pinned to its current release as well as controls for postponing maintenance scheduled in future. */
  maintenance: V1beta1SaasservicemgmtV1beta1Unit_Maintenance;
  /** Optional. Immutable. Indicates whether the Unit life cycle is controlled by the user or by the system. Immutable once created. */
  ...
  /** Optional. Output only. Set of key/value pairs corresponding to output variables from execution of actuation templates. The variables are declared in actuation configs (e.g in helm chart or terraform) and the values are fetched and returned by the actuation engine upon completion of execution. */
  outputVariables: V1beta1SaasservicemgmtV1beta1Unit_InputVariables[];
  /** Optional. Output only. List of pending (wait to be executed) UnitOperations for this unit. */
...
export const V1beta1SaasservicemgmtV1beta1Unit: ResourceBinding<V1beta1SaasservicemgmtV1beta1UnitConfig, V1beta1SaasservicemgmtV1beta1UnitAttrs> = {
  wireType: "google_saasservicemgmt_v1beta1_saasservicemgmt_v1beta1_unit",
  fields: {
    ...
    conditions: {
      wireName: "conditions",
      kind: "list",
      fields: V1beta1SaasservicemgmtV1beta1Unit_ConditionsFields,
    },
    createTime: "create_time",
    dependencies: {
      wireName: "dependencies",
      kind: "list",
      fields: V1beta1SaasservicemgmtV1beta1Unit_DependenciesFields,
    },
    dependents: {
      wireName: "dependents",
      kind: "list",
    ...
    inputVariables: {
      ...
      kind: "list",
      fields: V1beta1SaasservicemgmtV1beta1Unit_InputVariablesFields,
    },
    labels: "labels",
    maintenance: {
      wireName: "maintenance",
      kind: "object",
      fields: V1beta1SaasservicemgmtV1beta1Unit_MaintenanceFields,
    },
