// Code generated by `ubx sdk gen` from google_saasservicemgmt_rollout_kind. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface RolloutKind_ErrorBudget {
...
export interface RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent {
...
export interface RolloutKind_UnitUpdatePacing {
  ...
  maxConcurrentOperationsPercent?: RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent | Computed<RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent>;
}

const RolloutKind_ErrorBudgetFields: FieldMap = {
  allowedCount: "allowed_count",
  allowedPercentage: "allowed_percentage",
};

const RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields: FieldMap = {
  value: "value",
};

const RolloutKind_UnitUpdatePacingFields: FieldMap = {
  ...
  maxConcurrentOperationsPercent: {
    ...
    kind: "object",
    fields: RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields,
  },
};

export interface RolloutKindConfig {
  ...
  errorBudget?: RolloutKind_ErrorBudget | Computed<RolloutKind_ErrorBudget>;
  ...
  unitUpdatePacing?: RolloutKind_UnitUpdatePacing | Computed<RolloutKind_UnitUpdatePacing>;
...
export interface RolloutKindAttrs {
  /** Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations */
  annotations: Record<string, string>;
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** The configuration for error budget. If the number of failed units exceeds max(allowed_count, allowed_ratio * total_units), the rollout will be paused. */
  errorBudget: RolloutKind_ErrorBudget;
  ...
  unitKind: string;
  /** UnitUpdatePacing defines the policy for the maximum number of unit operations that can run for a rollout in parallel in a single region. */
  unitUpdatePacing: RolloutKind_UnitUpdatePacing;
...
export const RolloutKind: ResourceBinding<RolloutKindConfig, RolloutKindAttrs> = {
  wireType: "google_saasservicemgmt_rollout_kind",
  fields: {
    annotations: "annotations",
    errorBudget: {
      wireName: "error_budget",
      kind: "object",
      fields: RolloutKind_ErrorBudgetFields,
    },
    labels: "labels",
    name: "name",
    ...
    unitUpdatePacing: {
      ...
      kind: "object",
      fields: RolloutKind_UnitUpdatePacingFields,
    },
