// Code generated by `ubx sdk gen` from google_saasservicemgmt_saasservicemgmt_rollout_kind. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface SaasservicemgmtRolloutKind_ErrorBudget {
...
export interface SaasservicemgmtRolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent {
...
export interface SaasservicemgmtRolloutKind_UnitUpdatePacing {
  ...
  maxConcurrentOperationsPercent?: SaasservicemgmtRolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent | Computed<SaasservicemgmtRolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent>;
}

const SaasservicemgmtRolloutKind_ErrorBudgetFields: FieldMap = {
  allowedCount: "allowed_count",
  allowedPercentage: "allowed_percentage",
};

const SaasservicemgmtRolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields: FieldMap = {
  value: "value",
};

const SaasservicemgmtRolloutKind_UnitUpdatePacingFields: FieldMap = {
  ...
  maxConcurrentOperationsPercent: {
    ...
    kind: "object",
    fields: SaasservicemgmtRolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields,
  },
};

export interface SaasservicemgmtRolloutKindConfig {
  ...
  errorBudget?: SaasservicemgmtRolloutKind_ErrorBudget | Computed<SaasservicemgmtRolloutKind_ErrorBudget>;
  ...
  unitUpdatePacing?: SaasservicemgmtRolloutKind_UnitUpdatePacing | Computed<SaasservicemgmtRolloutKind_UnitUpdatePacing>;
...
export interface SaasservicemgmtRolloutKindAttrs {
  /** Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations */
  annotations: Record<string, string>;
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** The configuration for error budget. If the number of failed units exceeds max(allowed_count, allowed_ratio * total_units), the rollout will be paused. */
  errorBudget: SaasservicemgmtRolloutKind_ErrorBudget;
  /** Output only. An opaque value that uniquely identifies a version or generation of a resource. It can be used to confirm that the client and server agree on the ordering of a resource being written. */
  etag: string;
  /** Optional. The labels on the resource, which can be used for categorization. similar to Kubernetes resource labels. */
  ...
  unitKind: string;
  /** UnitUpdatePacing defines the policy for the maximum number of unit operations that can run for a rollout in parallel in a single region. */
  unitUpdatePacing: SaasservicemgmtRolloutKind_UnitUpdatePacing;
  /** Output only. The timestamp when the resource was last updated. Any change to the resource made by users must refresh this value. Changes to a resource made by the service should refresh this value. */
  updateTime: string;
  /** Optional. The config for updating the unit kind. By default, the unit kind will be updated on the rollout start. */
...
export const SaasservicemgmtRolloutKind: ResourceBinding<SaasservicemgmtRolloutKindConfig, SaasservicemgmtRolloutKindAttrs> = {
  wireType: "google_saasservicemgmt_saasservicemgmt_rollout_kind",
  fields: {
    ...
    errorBudget: {
      ...
      kind: "object",
      fields: SaasservicemgmtRolloutKind_ErrorBudgetFields,
    },
    etag: "etag",
    labels: "labels",
    name: "name",
    ...
    unitUpdatePacing: {
      ...
      kind: "object",
      fields: SaasservicemgmtRolloutKind_UnitUpdatePacingFields,
    },
