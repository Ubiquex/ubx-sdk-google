// Code generated by `ubx sdk gen` from google_saasservicemgmt_v1beta1_saasservicemgmt_v1beta1_rollout_kind. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1SaasservicemgmtV1beta1RolloutKind_ErrorBudget {
  /** Optional. The maximum number of failed units allowed in a location without pausing the rollout. */
  allowedCount?: number | Computed<number>;
  /** Optional. The maximum percentage of units allowed to fail (0, 100] within a location without pausing the rollout. */
  allowedPercentage?: number | Computed<number>;
}

export interface V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent {
...
export interface V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing {
  ...
  maxConcurrentOperationsCount?: number | Computed<number>;
  ...
  maxConcurrentOperationsPercent?: V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent | Computed<V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent>;
}

const V1beta1SaasservicemgmtV1beta1RolloutKind_ErrorBudgetFields: FieldMap = {
  allowedCount: "allowed_count",
  allowedPercentage: "allowed_percentage",
};

const V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields: FieldMap = {
  value: "value",
};

const V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacingFields: FieldMap = {
  maxConcurrentOperationsCount: "max_concurrent_operations_count",
  maxConcurrentOperationsPercent: {
    wireName: "max_concurrent_operations_percent",
    kind: "object",
    fields: V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields,
  },
};

export interface V1beta1SaasservicemgmtV1beta1RolloutKindConfig {
  ...
  errorBudget?: V1beta1SaasservicemgmtV1beta1RolloutKind_ErrorBudget | Computed<V1beta1SaasservicemgmtV1beta1RolloutKind_ErrorBudget>;
  ...
  unitUpdatePacing?: V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing | Computed<V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing>;
  ...
  updateUnitKindStrategy?: string | Computed<string>;
}

export interface V1beta1SaasservicemgmtV1beta1RolloutKindAttrs {
  /** Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations */
  annotations: Record<string, string>;
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** The configuration for error budget. If the number of failed units exceeds max(allowed_count, allowed_ratio * total_units), the rollout will be paused. */
  errorBudget: V1beta1SaasservicemgmtV1beta1RolloutKind_ErrorBudget;
  /** Output only. An opaque value that uniquely identifies a version or generation of a resource. It can be used to confirm that the client and server agree on the ordering of a resource being written. */
  etag: string;
  /** Optional. The labels on the resource, which can be used for categorization. similar to Kubernetes resource labels. */
  ...
  unitKind: string;
  /** UnitUpdatePacing defines the policy for the maximum number of unit operations that can run for a rollout in parallel in a single region. */
  unitUpdatePacing: V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing;
  /** Output only. The timestamp when the resource was last updated. Any change to the resource made by users must refresh this value. Changes to a resource made by the service should refresh this value. */
  updateTime: string;
  /** Optional. The config for updating the unit kind. By default, the unit kind will be updated on the rollout start. */
...
export const V1beta1SaasservicemgmtV1beta1RolloutKind: ResourceBinding<V1beta1SaasservicemgmtV1beta1RolloutKindConfig, V1beta1SaasservicemgmtV1beta1RolloutKindAttrs> = {
  wireType: "google_saasservicemgmt_v1beta1_saasservicemgmt_v1beta1_rollout_kind",
  fields: {
    ...
    errorBudget: {
      ...
      kind: "object",
      fields: V1beta1SaasservicemgmtV1beta1RolloutKind_ErrorBudgetFields,
    },
    etag: "etag",
    labels: "labels",
    name: "name",
    ...
    unitUpdatePacing: {
      ...
      kind: "object",
      fields: V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacingFields,
    },
    updateTime: "update_time",
    updateUnitKindStrategy: "update_unit_kind_strategy",
  },
};
