// Code generated by `ubx sdk gen` from google_saasservicemgmt_v1beta1_rollout. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1Rollout_Control_RunParams {
...
export interface V1beta1Rollout_Control {
  ...
  runParams?: V1beta1Rollout_Control_RunParams | Computed<V1beta1Rollout_Control_RunParams>;
}

export interface V1beta1Rollout_Stats_OperationsByState {
  count?: number | Computed<number>;
  group?: string | Computed<string>;
}

export interface V1beta1Rollout_Stats {
  ...
  operationsByState?: V1beta1Rollout_Stats_OperationsByState[] | Computed<V1beta1Rollout_Stats_OperationsByState[]>;
}

const V1beta1Rollout_Control_RunParamsFields: FieldMap = {
  retryFailedOperations: "retry_failed_operations",
};

const V1beta1Rollout_ControlFields: FieldMap = {
  action: "action",
  runParams: {
    wireName: "run_params",
    kind: "object",
    fields: V1beta1Rollout_Control_RunParamsFields,
  },
};

const V1beta1Rollout_Stats_OperationsByStateFields: FieldMap = {
  count: "count",
  group: "group",
};

const V1beta1Rollout_StatsFields: FieldMap = {
  estimatedTotalUnitCount: "estimated_total_unit_count",
  operationsByState: {
    wireName: "operations_by_state",
    kind: "list",
    fields: V1beta1Rollout_Stats_OperationsByStateFields,
  },
};

export interface V1beta1RolloutConfig {
  ...
  control?: V1beta1Rollout_Control | Computed<V1beta1Rollout_Control>;
  ...
  stats?: V1beta1Rollout_Stats | Computed<V1beta1Rollout_Stats>;
...
export interface V1beta1RolloutAttrs {
  /** Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations */
  annotations: Record<string, string>;
  /** RolloutControl provides a way to request a change to the execution of a Rollout by pausing or canceling it. */
  control: V1beta1Rollout_Control;
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Output only. The timestamp when the resource was marked for deletion (deletion is an asynchronous operation). */
  deleteTime: string;
...
export const V1beta1Rollout: ResourceBinding<V1beta1RolloutConfig, V1beta1RolloutAttrs> = {
  wireType: "google_saasservicemgmt_v1beta1_rollout",
  fields: {
    annotations: "annotations",
    control: {
      wireName: "control",
      kind: "object",
      fields: V1beta1Rollout_ControlFields,
    },
    ...
    stats: {
      wireName: "stats",
      kind: "object",
      fields: V1beta1Rollout_StatsFields,
    },
    uid: "uid",
