// Code generated by `ubx sdk gen` from google_saasservicemgmt_saasservicemgmt_unit. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface SaasservicemgmtUnit_Conditions {
...
export interface SaasservicemgmtUnit_Dependencies {
  alias?: string | Computed<string>;
  unit?: string | Computed<string>;
}

export interface SaasservicemgmtUnit_InputVariables {
  type?: string | Computed<string>;
  value?: string | Computed<string>;
  variable?: string | Computed<string>;
}

export interface SaasservicemgmtUnit_Maintenance {
...
const SaasservicemgmtUnit_ConditionsFields: FieldMap = {
...
const SaasservicemgmtUnit_DependenciesFields: FieldMap = {
  alias: "alias",
  unit: "unit",
};

const SaasservicemgmtUnit_InputVariablesFields: FieldMap = {
  type: "type",
  value: "value",
  variable: "variable",
};

const SaasservicemgmtUnit_MaintenanceFields: FieldMap = {
  pinnedUntilTime: "pinned_until_time",
};

export interface SaasservicemgmtUnitConfig {
  ...
  conditions?: SaasservicemgmtUnit_Conditions[] | Computed<SaasservicemgmtUnit_Conditions[]>;
  /** Output only. The timestamp when the resource was created. */
  createTime?: string | Computed<string>;
  /** Optional. Output only. Set of dependencies for this unit. Maximum 10. */
  dependencies?: SaasservicemgmtUnit_Dependencies[] | Computed<SaasservicemgmtUnit_Dependencies[]>;
  ...
  dependents?: SaasservicemgmtUnit_Dependencies[] | Computed<SaasservicemgmtUnit_Dependencies[]>;
  ...
  inputVariables?: SaasservicemgmtUnit_InputVariables[] | Computed<SaasservicemgmtUnit_InputVariables[]>;
  ...
  maintenance?: SaasservicemgmtUnit_Maintenance | Computed<SaasservicemgmtUnit_Maintenance>;
  ...
  outputVariables?: SaasservicemgmtUnit_InputVariables[] | Computed<SaasservicemgmtUnit_InputVariables[]>;
...
export interface SaasservicemgmtUnitAttrs {
  /** Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations */
  annotations: Record<string, string>;
  /** Optional. Output only. A set of conditions which indicate the various conditions this resource can have. */
  conditions: SaasservicemgmtUnit_Conditions[];
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Optional. Output only. Set of dependencies for this unit. Maximum 10. */
  dependencies: SaasservicemgmtUnit_Dependencies[];
  /** Optional. Output only. List of Units that depend on this unit. Unit can only be deprovisioned if this list is empty. Maximum 1000. */
  dependents: SaasservicemgmtUnit_Dependencies[];
  /** Output only. An opaque value that uniquely identifies a version or generation of a resource. It can be used to confirm that the client and server agree on the ordering of a resource being written. */
  etag: string;
  /** Optional. Output only. Flag revisions used by this Unit. */
  flagRevisions: string[];
  /** Optional. Output only. Indicates the current input variables deployed by the unit */
  inputVariables: SaasservicemgmtUnit_InputVariables[];
  /** Optional. The labels on the resource, which can be used for categorization. similar to Kubernetes resource labels. */
  labels: Record<string, string>;
  /** Captures requested directives for performing future maintenance on the unit. This includes a request for the unit to skip maintenance for a period of time and remain pinned to its current release as well as controls for postponing maintenance scheduled in future. */
  maintenance: SaasservicemgmtUnit_Maintenance;
  /** Optional. Immutable. Indicates whether the Unit life cycle is controlled by the user or by the system. Immutable once created. */
  ...
  /** Optional. Output only. Set of key/value pairs corresponding to output variables from execution of actuation templates. The variables are declared in actuation configs (e.g in helm chart or terraform) and the values are fetched and returned by the actuation engine upon completion of execution. */
  outputVariables: SaasservicemgmtUnit_InputVariables[];
  /** Optional. Output only. List of pending (wait to be executed) UnitOperations for this unit. */
...
export const SaasservicemgmtUnit: ResourceBinding<SaasservicemgmtUnitConfig, SaasservicemgmtUnitAttrs> = {
  wireType: "google_saasservicemgmt_saasservicemgmt_unit",
  fields: {
    annotations: "annotations",
    conditions: {
      wireName: "conditions",
      kind: "list",
      fields: SaasservicemgmtUnit_ConditionsFields,
    },
    createTime: "create_time",
    dependencies: {
      wireName: "dependencies",
      kind: "list",
      fields: SaasservicemgmtUnit_DependenciesFields,
    },
    dependents: {
      wireName: "dependents",
      kind: "list",
    ...
    inputVariables: {
      ...
      kind: "list",
      fields: SaasservicemgmtUnit_InputVariablesFields,
    },
    labels: "labels",
    maintenance: {
      wireName: "maintenance",
      kind: "object",
      fields: SaasservicemgmtUnit_MaintenanceFields,
    },
