// Code generated by `ubx sdk gen` from google_saasservicemgmt_v1beta1_flag. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1Flag_EvaluationSpec_Allocations_Slots {
  variant?: string | Computed<string>;
  weight?: number | Computed<number>;
}

export interface V1beta1Flag_EvaluationSpec_Allocations {
  description?: string | Computed<string>;
  id?: string | Computed<string>;
  randomizedOn?: string | Computed<string>;
  slots?: V1beta1Flag_EvaluationSpec_Allocations_Slots[] | Computed<V1beta1Flag_EvaluationSpec_Allocations_Slots[]>;
}

export interface V1beta1Flag_EvaluationSpec_Rules {
...
export interface V1beta1Flag_EvaluationSpec_Variants {
...
export interface V1beta1Flag_EvaluationSpec {
  /** Optional. A list of allocations. */
  allocations?: V1beta1Flag_EvaluationSpec_Allocations[] | Computed<V1beta1Flag_EvaluationSpec_Allocations[]>;
  ...
  rules?: V1beta1Flag_EvaluationSpec_Rules[] | Computed<V1beta1Flag_EvaluationSpec_Rules[]>;
  /** Optional. A list of variants. */
  variants?: V1beta1Flag_EvaluationSpec_Variants[] | Computed<V1beta1Flag_EvaluationSpec_Variants[]>;
}

export interface V1beta1Flag_Variants {
...
const V1beta1Flag_EvaluationSpec_Allocations_SlotsFields: FieldMap = {
  variant: "variant",
  weight: "weight",
};

const V1beta1Flag_EvaluationSpec_AllocationsFields: FieldMap = {
...
const V1beta1Flag_EvaluationSpec_RulesFields: FieldMap = {
...
const V1beta1Flag_EvaluationSpec_VariantsFields: FieldMap = {
...
const V1beta1Flag_EvaluationSpecFields: FieldMap = {
  allocations: {
...
const V1beta1Flag_VariantsFields: FieldMap = {
...
export interface V1beta1FlagConfig {
  ...
  evaluationSpec?: V1beta1Flag_EvaluationSpec | Computed<V1beta1Flag_EvaluationSpec>;
  ...
  /** Optional. A list of variants. */
  variants?: V1beta1Flag_Variants[] | Computed<V1beta1Flag_Variants[]>;
}

export interface V1beta1FlagAttrs {
  /** Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations */
  ...
  etag: string;
  /** EvaluationSpec holds rules for evaluating the value of a flag. */
  evaluationSpec: V1beta1Flag_EvaluationSpec;
  /** Optional. Flag set this flag belongs to. */
  flagSet: string;
  /** Optional. Immutable. Flag value type. */
  ...
  valueType: string;
  /** Optional. A list of variants. */
  variants: V1beta1Flag_Variants[];
}

export const V1beta1Flag: ResourceBinding<V1beta1FlagConfig, V1beta1FlagAttrs> = {
