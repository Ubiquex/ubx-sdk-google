...
export interface V1beta1SaasservicemgmtV1beta1FlagAttributeConfig {
...
export interface V1beta1SaasservicemgmtV1beta1FlagAttributeAttrs {
  /** Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations */
...
export const V1beta1SaasservicemgmtV1beta1FlagAttribute: ResourceBinding<V1beta1SaasservicemgmtV1beta1FlagAttributeConfig, V1beta1SaasservicemgmtV1beta1FlagAttributeAttrs> = {
  wireType: "google_saasservicemgmt_v1beta1_saasservicemgmt_v1beta1_flag_attribute",
  fields: {
