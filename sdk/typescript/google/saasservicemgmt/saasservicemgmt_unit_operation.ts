// Code generated by `ubx sdk gen` from google_saasservicemgmt_saasservicemgmt_unit_operation. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface SaasservicemgmtUnitOperation_Conditions {
...
export interface SaasservicemgmtUnitOperation_FlagUpdate {
  /** Required. Flag release being applied by UnitOperation. */
  flagRelease?: string | Computed<string>;
}

export interface SaasservicemgmtUnitOperation_Provision_InputVariables {
  type?: string | Computed<string>;
  value?: string | Computed<string>;
  variable?: string | Computed<string>;
}

export interface SaasservicemgmtUnitOperation_Provision {
  /** Optional. Set of input variables. Maximum 100. (optional) */
  inputVariables?: SaasservicemgmtUnitOperation_Provision_InputVariables[] | Computed<SaasservicemgmtUnitOperation_Provision_InputVariables[]>;
  /** Optional. Reference to the Release object to use for the Unit. (optional). */
  release?: string | Computed<string>;
}

export interface SaasservicemgmtUnitOperation_Schedule {
  /** Optional. Start of operation. If not set, will be set to the start of the next window. (optional) */
  startTime?: string | Computed<string>;
}

const SaasservicemgmtUnitOperation_ConditionsFields: FieldMap = {
...
const SaasservicemgmtUnitOperation_FlagUpdateFields: FieldMap = {
  flagRelease: "flag_release",
};

const SaasservicemgmtUnitOperation_Provision_InputVariablesFields: FieldMap = {
  type: "type",
  value: "value",
  variable: "variable",
};

const SaasservicemgmtUnitOperation_ProvisionFields: FieldMap = {
  inputVariables: {
    wireName: "input_variables",
    kind: "list",
    fields: SaasservicemgmtUnitOperation_Provision_InputVariablesFields,
  },
  release: "release",
};

const SaasservicemgmtUnitOperation_ScheduleFields: FieldMap = {
  startTime: "start_time",
};

export interface SaasservicemgmtUnitOperationConfig {
  ...
  conditions?: SaasservicemgmtUnitOperation_Conditions[] | Computed<SaasservicemgmtUnitOperation_Conditions[]>;
  ...
  flagUpdate?: SaasservicemgmtUnitOperation_FlagUpdate | Computed<SaasservicemgmtUnitOperation_FlagUpdate>;
  ...
  provision?: SaasservicemgmtUnitOperation_Provision | Computed<SaasservicemgmtUnitOperation_Provision>;
  ...
  schedule?: SaasservicemgmtUnitOperation_Schedule | Computed<SaasservicemgmtUnitOperation_Schedule>;
  ...
  upgrade?: SaasservicemgmtUnitOperation_Provision | Computed<SaasservicemgmtUnitOperation_Provision>;
}

export interface SaasservicemgmtUnitOperationAttrs {
  /** Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations */
  annotations: Record<string, string>;
  /** Optional. When true, attempt to cancel the operation. Cancellation may fail if the operation is already executing. (Optional) */
  cancel: boolean;
  /** Optional. Output only. A set of conditions which indicate the various conditions this resource can have. */
  conditions: SaasservicemgmtUnitOperation_Conditions[];
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Output only. The timestamp when the resource was marked for deletion (deletion is an asynchronous operation). */
  deleteTime: string;
  ...
  etag: string;
  /** FlagUpdate is a UnitOperation that pushes new flag values to Units. */
  flagUpdate: SaasservicemgmtUnitOperation_FlagUpdate;
  /** Optional. The labels on the resource, which can be used for categorization. similar to Kubernetes resource labels. */
  ...
  /** Provision is the unit operation that provision the underlying resources represented by a Unit. Can only execute if the Unit is not currently provisioned. */
  provision: SaasservicemgmtUnitOperation_Provision;
  /** Optional. Specifies which rollout created this Unit Operation. This cannot be modified and is used for filtering purposes only. If a dependent unit and unit operation are created as part of another unit operation, they will use the same rolloutId. */
  rollout: string;
  /** A time specification to schedule the maintenance. */
  schedule: SaasservicemgmtUnitOperation_Schedule;
  /** Optional. Output only. UnitOperationState describes the current state of the unit operation. */
  state: string;
  /** Output only. The unique identifier of the resource. UID is unique in the time and space for this resource within the scope of the service. It is typically generated by the server on successful creation of a resource and must not be changed. UID is used to uniquely identify resources with resource name reuses. This should be a UUID4. */
  uid: string;
  ...
  updateTime: string;
  /** Upgrade is the unit operation that upgrades a provisioned unit, which may also include the underlying resources represented by a Unit. Can only execute if the Unit is currently provisioned. */
  upgrade: SaasservicemgmtUnitOperation_Provision;
}

export const SaasservicemgmtUnitOperation: ResourceBinding<SaasservicemgmtUnitOperationConfig, SaasservicemgmtUnitOperationAttrs> = {
  wireType: "google_saasservicemgmt_saasservicemgmt_unit_operation",
  fields: {
    ...
    conditions: {
      wireName: "conditions",
      kind: "list",
      fields: SaasservicemgmtUnitOperation_ConditionsFields,
    },
    ...
    flagUpdate: {
      ...
      kind: "object",
      fields: SaasservicemgmtUnitOperation_FlagUpdateFields,
    },
    labels: "labels",
    name: "name",
    ...
    provision: {
      wireName: "provision",
      kind: "object",
      fields: SaasservicemgmtUnitOperation_ProvisionFields,
    },
    rollout: "rollout",
    schedule: {
      wireName: "schedule",
      kind: "object",
      fields: SaasservicemgmtUnitOperation_ScheduleFields,
    },
    state: "state",
    uid: "uid",
    unit: "unit",
