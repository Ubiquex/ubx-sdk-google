// Code generated by `ubx sdk gen` from google_saasservicemgmt_v1beta1_saasservicemgmt_v1beta1_tenant. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface V1beta1SaasservicemgmtV1beta1TenantConfig {
...
export interface V1beta1SaasservicemgmtV1beta1TenantAttrs {
  /** Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations */
...
export const V1beta1SaasservicemgmtV1beta1Tenant: ResourceBinding<V1beta1SaasservicemgmtV1beta1TenantConfig, V1beta1SaasservicemgmtV1beta1TenantAttrs> = {
  wireType: "google_saasservicemgmt_v1beta1_saasservicemgmt_v1beta1_tenant",
  fields: {
