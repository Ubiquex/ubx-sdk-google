...
export interface SaasservicemgmtRollout_Control_RunParams {
...
export interface SaasservicemgmtRollout_Control {
  ...
  runParams?: SaasservicemgmtRollout_Control_RunParams | Computed<SaasservicemgmtRollout_Control_RunParams>;
}

export interface SaasservicemgmtRollout_Stats_OperationsByState {
  count?: number | Computed<number>;
  group?: string | Computed<string>;
}

export interface SaasservicemgmtRollout_Stats {
  ...
  operationsByState?: SaasservicemgmtRollout_Stats_OperationsByState[] | Computed<SaasservicemgmtRollout_Stats_OperationsByState[]>;
}

const SaasservicemgmtRollout_Control_RunParamsFields: FieldMap = {
  retryFailedOperations: "retry_failed_operations",
};

const SaasservicemgmtRollout_ControlFields: FieldMap = {
  action: "action",
  runParams: {
    wireName: "run_params",
    kind: "object",
    fields: SaasservicemgmtRollout_Control_RunParamsFields,
  },
};

const SaasservicemgmtRollout_Stats_OperationsByStateFields: FieldMap = {
  count: "count",
  group: "group",
};

const SaasservicemgmtRollout_StatsFields: FieldMap = {
  estimatedTotalUnitCount: "estimated_total_unit_count",
  operationsByState: {
    wireName: "operations_by_state",
    kind: "list",
    fields: SaasservicemgmtRollout_Stats_OperationsByStateFields,
  },
};

export interface SaasservicemgmtRolloutConfig {
  ...
  control?: SaasservicemgmtRollout_Control | Computed<SaasservicemgmtRollout_Control>;
  ...
  stats?: SaasservicemgmtRollout_Stats | Computed<SaasservicemgmtRollout_Stats>;
...
export interface SaasservicemgmtRolloutAttrs {
  /** Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations */
  annotations: Record<string, string>;
  /** RolloutControl provides a way to request a change to the execution of a Rollout by pausing or canceling it. */
  control: SaasservicemgmtRollout_Control;
  /** Output only. The timestamp when the resource was created. */
  createTime: string;
  /** Output only. The timestamp when the resource was marked for deletion (deletion is an asynchronous operation). */
  deleteTime: string;
  ...
  /** RolloutStats contains information about the progress of a rollout. */
  stats: SaasservicemgmtRollout_Stats;
  /** Output only. The unique identifier of the resource. UID is unique in the time and space for this resource within the scope of the service. It is typically generated by the server on successful creation of a resource and must not be changed. UID is used to uniquely identify resources with resource name reuses. This should be a UUID4. */
  uid: string;
  /** Optional. CEL(https://github.com/google/cel-spec) formatted filter string against Unit. The filter will be applied to determine the eligible unit population. This filter can only reduce, but not expand the scope of the rollout. If not provided, the unit_filter from the RolloutKind will be used. */
  unitFilter: string;
...
export const SaasservicemgmtRollout: ResourceBinding<SaasservicemgmtRolloutConfig, SaasservicemgmtRolloutAttrs> = {
  wireType: "google_saasservicemgmt_saasservicemgmt_rollout",
  fields: {
    annotations: "annotations",
    control: {
      wireName: "control",
      kind: "object",
      fields: SaasservicemgmtRollout_ControlFields,
    },
    ...
    stats: {
      wireName: "stats",
      kind: "object",
      fields: SaasservicemgmtRollout_StatsFields,
    },
    uid: "uid",
