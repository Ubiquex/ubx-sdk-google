...
@dataclasses.dataclass
class EndpointPolicy_EndpointMatcher_MetadataLabelMatcher:
...
@dataclasses.dataclass
class EndpointPolicy_EndpointMatcher:
    # The matcher that is based on node metadata presented by xDS clients.
    metadata_label_matcher: Any = None

@dataclasses.dataclass
class EndpointPolicy_TrafficPortSelector:
    # Optional. A list of ports. Can be port numbers or port range (example, [80-90] specifies all ports from 80 to 90, including 80 and 90) or named ports or * to specify all ports. If the list is empty, all ports are selected.
    ports: Any = None

_EndpointPolicy_EndpointMatcher_MetadataLabelMatcher_MetadataLabelsFields = {
    "label_name": ubx.FieldSpec(wire_name="label_name"),
    "label_value": ubx.FieldSpec(wire_name="label_value"),
}

_EndpointPolicy_EndpointMatcher_MetadataLabelMatcherFields = {
    ...
    "metadata_labels": ubx.FieldSpec(
        ...
        kind="list",
        fields=_EndpointPolicy_EndpointMatcher_MetadataLabelMatcher_MetadataLabelsFields,
    ),
}

_EndpointPolicy_EndpointMatcherFields = {
    "metadata_label_matcher": ubx.FieldSpec(
        wire_name="metadata_label_matcher",
        kind="object",
        fields=_EndpointPolicy_EndpointMatcher_MetadataLabelMatcherFields,
    ),
}

_EndpointPolicy_TrafficPortSelectorFields = {
...
EndpointPolicy = ubx.ResourceBinding(
    wire_type="google_networkservices_endpoint_policy",
    fields={
        ...
        "endpoint_matcher": ubx.FieldSpec(
            ...
            kind="object",
            fields=_EndpointPolicy_EndpointMatcherFields,
        ),
