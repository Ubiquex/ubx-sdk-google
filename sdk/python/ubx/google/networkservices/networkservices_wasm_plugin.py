...
class NetworkservicesWasmPlugin_LogConfig:
...
@dataclasses.dataclass
class NetworkservicesWasmPlugin_UsedBy:
    name: Any = None

@dataclasses.dataclass
class NetworkservicesWasmPlugin_Versions:
...
_NetworkservicesWasmPlugin_LogConfigFields = {
...
_NetworkservicesWasmPlugin_UsedByFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

_NetworkservicesWasmPlugin_VersionsFields = {
...
@dataclasses.dataclass
class NetworkservicesWasmPluginConfig:
...
@dataclasses.dataclass
class NetworkservicesWasmPluginAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A human-readable description of the resource.
    description: Any = None
...
NetworkservicesWasmPlugin = ubx.ResourceBinding(
    wire_type="google_networkservices_networkservices_wasm_plugin",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "description": ubx.FieldSpec(wire_name="description"),
        "labels": ubx.FieldSpec(wire_name="labels"),
        "log_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworkservicesWasmPlugin_LogConfigFields,
        ),
        ...
        "used_by": ubx.FieldSpec(
            wire_name="used_by",
            kind="list",
            fields=_NetworkservicesWasmPlugin_UsedByFields,
        ),
        "versions": ubx.FieldSpec(
            wire_name="versions",
            kind="map",
            fields=_NetworkservicesWasmPlugin_VersionsFields,
        ),
    },
)
