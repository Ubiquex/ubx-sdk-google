...
class V1beta1LbRouteExtension_ExtensionChains_Extensions:
...
@dataclasses.dataclass
class V1beta1LbRouteExtension_ExtensionChains_MatchCondition:
    cel_expression: Any = None

@dataclasses.dataclass
class V1beta1LbRouteExtension_ExtensionChains:
    extensions: Any = None
    match_condition: Any = None
    name: Any = None

_V1beta1LbRouteExtension_ExtensionChains_ExtensionsFields = {
...
_V1beta1LbRouteExtension_ExtensionChains_MatchConditionFields = {
    "cel_expression": ubx.FieldSpec(wire_name="cel_expression"),
}

_V1beta1LbRouteExtension_ExtensionChainsFields = {
    "extensions": ubx.FieldSpec(
        wire_name="extensions",
        kind="list",
        fields=_V1beta1LbRouteExtension_ExtensionChains_ExtensionsFields,
    ),
    "match_condition": ubx.FieldSpec(
        wire_name="match_condition",
        kind="object",
        fields=_V1beta1LbRouteExtension_ExtensionChains_MatchConditionFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
}

@dataclasses.dataclass
class V1beta1LbRouteExtensionConfig:
...
@dataclasses.dataclass
class V1beta1LbRouteExtensionAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A human-readable description of the resource.
    description: Any = None
...
V1beta1LbRouteExtension = ubx.ResourceBinding(
    wire_type="google_networkservices_v1beta1_lb_route_extension",
    fields={
        ...
        "extension_chains": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1beta1LbRouteExtension_ExtensionChainsFields,
        ),
