# Code generated by `ubx sdk gen` from google_networkservices_v1beta1_wasm_plugin. DO NOT EDIT.
...
class V1beta1WasmPlugin_LogConfig:
...
@dataclasses.dataclass
class V1beta1WasmPlugin_UsedBy:
    name: Any = None

@dataclasses.dataclass
class V1beta1WasmPlugin_Versions:
...
_V1beta1WasmPlugin_LogConfigFields = {
...
V1beta1WasmPlugin = ubx.ResourceBinding(
    ...
    fields={
        ...
        "log_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1WasmPlugin_LogConfigFields,
        ),
        ...
        "versions": ubx.FieldSpec(
            wire_name="versions",
            kind="map",
            fields=_V1beta1WasmPlugin_VersionsFields,
        ),
    },
)
