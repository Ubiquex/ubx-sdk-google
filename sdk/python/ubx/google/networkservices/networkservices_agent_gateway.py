...
class NetworkservicesAgentGateway_AgentGatewayCard:
...
@dataclasses.dataclass
class NetworkservicesAgentGateway_GoogleManaged:
    # Optional. Operating Mode of Agent Gateway.
    governed_access_path: Any = None

@dataclasses.dataclass
class NetworkservicesAgentGateway_NetworkConfig_DnsPeeringConfig:
...
@dataclasses.dataclass
class NetworkservicesAgentGateway_NetworkConfig_Egress:
    # Optional. The URI of the Network Attachment resource.
    network_attachment: Any = None

@dataclasses.dataclass
class NetworkservicesAgentGateway_NetworkConfig:
...
@dataclasses.dataclass
class NetworkservicesAgentGateway_SelfManaged:
...
_NetworkservicesAgentGateway_AgentGatewayCardFields = {
...
_NetworkservicesAgentGateway_GoogleManagedFields = {
    "governed_access_path": ubx.FieldSpec(wire_name="governed_access_path"),
}

_NetworkservicesAgentGateway_NetworkConfig_DnsPeeringConfigFields = {
...
_NetworkservicesAgentGateway_NetworkConfig_EgressFields = {
    "network_attachment": ubx.FieldSpec(wire_name="network_attachment"),
}

_NetworkservicesAgentGateway_NetworkConfigFields = {
    "dns_peering_config": ubx.FieldSpec(
        wire_name="dns_peering_config",
        kind="object",
        fields=_NetworkservicesAgentGateway_NetworkConfig_DnsPeeringConfigFields,
    ),
    "egress": ubx.FieldSpec(
        wire_name="egress",
        kind="object",
        fields=_NetworkservicesAgentGateway_NetworkConfig_EgressFields,
    ),
}

_NetworkservicesAgentGateway_SelfManagedFields = {
    "resource_uri": ubx.FieldSpec(wire_name="resource_uri"),
    "resource_uris": ubx.FieldSpec(wire_name="resource_uris"),
}

@dataclasses.dataclass
class NetworkservicesAgentGatewayConfig:
...
@dataclasses.dataclass
class NetworkservicesAgentGatewayAttrs:
    # Optional. The resource name of the AgentConnectivityTemplate. Format: projects/{project}/locations/{location}/agentConnectivityTemplates/{template}
    agent_connectivity_template: Any = None
    # AgentGatewayOutputCard contains informational output-only fields
    agent_gateway_card: Any = None
...
NetworkservicesAgentGateway = ubx.ResourceBinding(
    wire_type="google_networkservices_networkservices_agent_gateway",
    fields={
        ...
        "agent_gateway_card": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworkservicesAgentGateway_AgentGatewayCardFields,
        ),
        ...
        "google_managed": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworkservicesAgentGateway_GoogleManagedFields,
        ),
        ...
        "network_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworkservicesAgentGateway_NetworkConfigFields,
        ),
        ...
        "self_managed": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworkservicesAgentGateway_SelfManagedFields,
        ),
