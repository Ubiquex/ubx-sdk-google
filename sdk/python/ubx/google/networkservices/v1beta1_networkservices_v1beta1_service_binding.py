...
class V1beta1NetworkservicesV1beta1ServiceBindingConfig:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1ServiceBindingAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A free-text description of the resource. Max length 1024 characters.
    description: Any = None
...
V1beta1NetworkservicesV1beta1ServiceBinding = ubx.ResourceBinding(
    wire_type="google_networkservices_v1beta1_networkservices_v1beta1_service_binding",
    fields={
