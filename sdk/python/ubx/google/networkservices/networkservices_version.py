# Code generated by `ubx sdk gen` from google_networkservices_networkservices_version. DO NOT EDIT.
...
class NetworkservicesVersionConfig:
...
@dataclasses.dataclass
class NetworkservicesVersionAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A human-readable description of the resource.
    description: Any = None
...
NetworkservicesVersion = ubx.ResourceBinding(
    wire_type="google_networkservices_networkservices_version",
    fields={
