...
_LbRouteExtension_ExtensionChains_MatchConditionFields = {
    "cel_expression": ubx.FieldSpec(wire_name="cel_expression"),
}

_LbRouteExtension_ExtensionChainsFields = {
    "extensions": ubx.FieldSpec(
        wire_name="extensions",
        kind="list",
        fields=_LbRouteExtension_ExtensionChains_ExtensionsFields,
    ),
    "match_condition": ubx.FieldSpec(
        wire_name="match_condition",
        kind="object",
        fields=_LbRouteExtension_ExtensionChains_MatchConditionFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
}

@dataclasses.dataclass
class LbRouteExtensionConfig:
...
LbRouteExtension = ubx.ResourceBinding(
    wire_type="google_networkservices_lb_route_extension",
    fields={
        "description": ubx.FieldSpec(wire_name="description"),
        "extension_chains": ubx.FieldSpec(
            wire_name="extension_chains",
            kind="list",
            fields=_LbRouteExtension_ExtensionChainsFields,
        ),
