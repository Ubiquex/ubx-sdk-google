...
@dataclasses.dataclass
class ExtensionBinding_Target_Scope:
...
_ExtensionBinding_MatchConditions_To_Destination_HeaderSet_Headers_ValueFields = {
...
_ExtensionBinding_MatchConditions_To_Destination_HeaderSet_HeadersFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(
        wire_name="value",
        kind="object",
        fields=_ExtensionBinding_MatchConditions_To_Destination_HeaderSet_Headers_ValueFields,
    ),
}

_ExtensionBinding_MatchConditions_To_Destination_HeaderSetFields = {
    "headers": ubx.FieldSpec(
        wire_name="headers",
        kind="list",
        fields=_ExtensionBinding_MatchConditions_To_Destination_HeaderSet_HeadersFields,
    ),
}

_ExtensionBinding_MatchConditions_To_DestinationFields = {
    "header_set": ubx.FieldSpec(
        wire_name="header_set",
        kind="object",
        fields=_ExtensionBinding_MatchConditions_To_Destination_HeaderSetFields,
    ),
    "hosts": ubx.FieldSpec(
        wire_name="hosts",
        kind="list",
...
_ExtensionBinding_MatchConditions_ToFields = {
    "destination": ubx.FieldSpec(
        wire_name="destination",
        kind="object",
        fields=_ExtensionBinding_MatchConditions_To_DestinationFields,
    ),
...
_ExtensionBinding_MatchConditionsFields = {
    "to": ubx.FieldSpec(
        wire_name="to",
        kind="object",
        fields=_ExtensionBinding_MatchConditions_ToFields,
    ),
}

_ExtensionBinding_Target_ScopeFields = {
    "parent": ubx.FieldSpec(wire_name="parent"),
    "resource_types": ubx.FieldSpec(wire_name="resource_types"),
}

_ExtensionBinding_TargetFields = {
    "resources": ubx.FieldSpec(wire_name="resources"),
    "scope": ubx.FieldSpec(
        wire_name="scope",
        kind="object",
        fields=_ExtensionBinding_Target_ScopeFields,
    ),
}
...
ExtensionBinding = ubx.ResourceBinding(
    ...
    fields={
        ...
        "match_conditions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ExtensionBinding_MatchConditionsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
