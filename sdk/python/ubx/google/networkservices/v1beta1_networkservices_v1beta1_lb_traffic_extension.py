...
class V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_Extensions:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_MatchCondition:
    cel_expression: Any = None

@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains:
    extensions: Any = None
    match_condition: Any = None
    name: Any = None

_V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_ExtensionsFields = {
...
_V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_MatchConditionFields = {
    "cel_expression": ubx.FieldSpec(wire_name="cel_expression"),
}

_V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChainsFields = {
    "extensions": ubx.FieldSpec(
        wire_name="extensions",
        kind="list",
        fields=_V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_ExtensionsFields,
    ),
    "match_condition": ubx.FieldSpec(
        wire_name="match_condition",
        kind="object",
        fields=_V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChains_MatchConditionFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
}

@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1LbTrafficExtensionConfig:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1LbTrafficExtensionAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A human-readable description of the resource.
    description: Any = None
...
V1beta1NetworkservicesV1beta1LbTrafficExtension = ubx.ResourceBinding(
    wire_type="google_networkservices_v1beta1_networkservices_v1beta1_lb_traffic_extension",
    fields={
        ...
        "extension_chains": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1beta1NetworkservicesV1beta1LbTrafficExtension_ExtensionChainsFields,
        ),
