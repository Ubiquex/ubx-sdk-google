...
class NetworkservicesLbEdgeExtension_ExtensionChains_Extensions:
    authority: Any = None
    fail_open: Any = None
...
@dataclasses.dataclass
class NetworkservicesLbEdgeExtension_ExtensionChains_MatchCondition:
    cel_expression: Any = None

@dataclasses.dataclass
class NetworkservicesLbEdgeExtension_ExtensionChains:
    extensions: Any = None
    match_condition: Any = None
    name: Any = None

_NetworkservicesLbEdgeExtension_ExtensionChains_ExtensionsFields = {
...
_NetworkservicesLbEdgeExtension_ExtensionChains_MatchConditionFields = {
    "cel_expression": ubx.FieldSpec(wire_name="cel_expression"),
}

_NetworkservicesLbEdgeExtension_ExtensionChainsFields = {
    "extensions": ubx.FieldSpec(
        wire_name="extensions",
        kind="list",
        fields=_NetworkservicesLbEdgeExtension_ExtensionChains_ExtensionsFields,
    ),
    "match_condition": ubx.FieldSpec(
        wire_name="match_condition",
        kind="object",
        fields=_NetworkservicesLbEdgeExtension_ExtensionChains_MatchConditionFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
}

@dataclasses.dataclass
class NetworkservicesLbEdgeExtensionConfig:
...
@dataclasses.dataclass
class NetworkservicesLbEdgeExtensionAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A human-readable description of the resource.
    description: Any = None
...
NetworkservicesLbEdgeExtension = ubx.ResourceBinding(
    wire_type="google_networkservices_networkservices_lb_edge_extension",
    fields={
        ...
        "extension_chains": ubx.FieldSpec(
            ...
            kind="list",
            fields=_NetworkservicesLbEdgeExtension_ExtensionChainsFields,
        ),
