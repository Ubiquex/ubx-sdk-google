...
class V1beta1NetworkservicesV1beta1AuthzExtensionConfig:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1AuthzExtensionAttrs:
    # Optional. The `:authority` header in the gRPC request sent from Envoy to the extension service. It is required when the `service` field points to a backend service.
    authority: Any = None
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
...
V1beta1NetworkservicesV1beta1AuthzExtension = ubx.ResourceBinding(
    wire_type="google_networkservices_v1beta1_networkservices_v1beta1_authz_extension",
    fields={
