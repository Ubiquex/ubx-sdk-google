...
class NetworkservicesServiceBindingConfig:
...
@dataclasses.dataclass
class NetworkservicesServiceBindingAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A free-text description of the resource. Max length 1024 characters.
    description: Any = None
...
NetworkservicesServiceBinding = ubx.ResourceBinding(
    wire_type="google_networkservices_networkservices_service_binding",
    fields={
