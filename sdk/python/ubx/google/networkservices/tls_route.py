...
_TlsRoute_Rules_ActionFields = {
    "destinations": ubx.FieldSpec(
        wire_name="destinations",
        kind="list",
        fields=_TlsRoute_Rules_Action_DestinationsFields,
    ),
    "idle_timeout": ubx.FieldSpec(wire_name="idle_timeout"),
}

_TlsRoute_Rules_MatchesFields = {
    "alpn": ubx.FieldSpec(wire_name="alpn"),
    "sni_host": ubx.FieldSpec(wire_name="sni_host"),
}

_TlsRoute_RulesFields = {
    "action": ubx.FieldSpec(
        wire_name="action",
        kind="object",
        fields=_TlsRoute_Rules_ActionFields,
    ),
    "matches": ubx.FieldSpec(
        wire_name="matches",
        kind="list",
        fields=_TlsRoute_Rules_MatchesFields,
    ),
}

@dataclasses.dataclass
class TlsRouteConfig:
...
TlsRoute = ubx.ResourceBinding(
    wire_type="google_networkservices_tls_route",
    fields={
