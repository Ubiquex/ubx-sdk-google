...
class NetworkservicesMulticastConsumerAssociation_State:
    # Optional. The state of the multicast resource.
    state: Any = None

_NetworkservicesMulticastConsumerAssociation_StateFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

@dataclasses.dataclass
class NetworkservicesMulticastConsumerAssociationConfig:
...
@dataclasses.dataclass
class NetworkservicesMulticastConsumerAssociationAttrs:
    # Output only. [Output only] The timestamp when the multicast consumer association was created.
    create_time: Any = None
    # Optional. An optional text description of the multicast consumer association.
    description: Any = None
...
NetworkservicesMulticastConsumerAssociation = ubx.ResourceBinding(
    wire_type="google_networkservices_networkservices_multicast_consumer_association",
    fields={
        ...
        "state": ubx.FieldSpec(
            wire_name="state",
            kind="object",
            fields=_NetworkservicesMulticastConsumerAssociation_StateFields,
        ),
