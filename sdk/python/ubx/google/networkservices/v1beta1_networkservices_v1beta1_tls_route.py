...
class V1beta1NetworkservicesV1beta1TlsRoute_Rules_Action_Destinations:
    service_name: Any = None
    weight: Any = None

@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1TlsRoute_Rules_Action:
    destinations: Any = None
    idle_timeout: Any = None

@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1TlsRoute_Rules_Matches:
    alpn: Any = None
    sni_host: Any = None

@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1TlsRoute_Rules:
    action: Any = None
    matches: Any = None

_V1beta1NetworkservicesV1beta1TlsRoute_Rules_Action_DestinationsFields = {
    "service_name": ubx.FieldSpec(wire_name="service_name"),
    "weight": ubx.FieldSpec(wire_name="weight"),
}

_V1beta1NetworkservicesV1beta1TlsRoute_Rules_ActionFields = {
    "destinations": ubx.FieldSpec(
        wire_name="destinations",
        kind="list",
        fields=_V1beta1NetworkservicesV1beta1TlsRoute_Rules_Action_DestinationsFields,
    ),
    "idle_timeout": ubx.FieldSpec(wire_name="idle_timeout"),
}

_V1beta1NetworkservicesV1beta1TlsRoute_Rules_MatchesFields = {
    "alpn": ubx.FieldSpec(wire_name="alpn"),
    "sni_host": ubx.FieldSpec(wire_name="sni_host"),
}

_V1beta1NetworkservicesV1beta1TlsRoute_RulesFields = {
    "action": ubx.FieldSpec(
        wire_name="action",
        kind="object",
        fields=_V1beta1NetworkservicesV1beta1TlsRoute_Rules_ActionFields,
    ),
    "matches": ubx.FieldSpec(
        wire_name="matches",
        kind="list",
        fields=_V1beta1NetworkservicesV1beta1TlsRoute_Rules_MatchesFields,
    ),
}

@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1TlsRouteConfig:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1TlsRouteAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A free-text description of the resource. Max length 1024 characters.
    description: Any = None
...
V1beta1NetworkservicesV1beta1TlsRoute = ubx.ResourceBinding(
    wire_type="google_networkservices_v1beta1_networkservices_v1beta1_tls_route",
    fields={
        ...
        "rules": ubx.FieldSpec(
            wire_name="rules",
            kind="list",
            fields=_V1beta1NetworkservicesV1beta1TlsRoute_RulesFields,
        ),
