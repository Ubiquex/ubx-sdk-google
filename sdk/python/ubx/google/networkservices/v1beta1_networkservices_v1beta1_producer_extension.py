...
class V1beta1NetworkservicesV1beta1ProducerExtension_ExtensionSettings:
...
_V1beta1NetworkservicesV1beta1ProducerExtension_ExtensionSettingsFields = {
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1ProducerExtensionConfig:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1ProducerExtensionAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A human-readable description of the resource.
    description: Any = None
...
V1beta1NetworkservicesV1beta1ProducerExtension = ubx.ResourceBinding(
    wire_type="google_networkservices_v1beta1_networkservices_v1beta1_producer_extension",
    fields={
        ...
        "extension_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetworkservicesV1beta1ProducerExtension_ExtensionSettingsFields,
        ),
