# Code generated by `ubx sdk gen` from google_networkservices_v1beta1_networkservices_v1beta1_version. DO NOT EDIT.
...
class V1beta1NetworkservicesV1beta1VersionConfig:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1VersionAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A human-readable description of the resource.
    description: Any = None
...
V1beta1NetworkservicesV1beta1Version = ubx.ResourceBinding(
    wire_type="google_networkservices_v1beta1_networkservices_v1beta1_version",
    fields={
