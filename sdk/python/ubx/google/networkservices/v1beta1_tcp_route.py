...
class V1beta1TcpRoute_Rules_Action_Destinations:
    service_name: Any = None
    weight: Any = None

@dataclasses.dataclass
class V1beta1TcpRoute_Rules_Action:
    destinations: Any = None
    idle_timeout: Any = None
    original_destination: Any = None

@dataclasses.dataclass
class V1beta1TcpRoute_Rules_Matches:
    address: Any = None
    port: Any = None

@dataclasses.dataclass
class V1beta1TcpRoute_Rules:
    action: Any = None
    matches: Any = None

_V1beta1TcpRoute_Rules_Action_DestinationsFields = {
    "service_name": ubx.FieldSpec(wire_name="service_name"),
    "weight": ubx.FieldSpec(wire_name="weight"),
}

_V1beta1TcpRoute_Rules_ActionFields = {
    "destinations": ubx.FieldSpec(
        wire_name="destinations",
        kind="list",
        fields=_V1beta1TcpRoute_Rules_Action_DestinationsFields,
    ),
    "idle_timeout": ubx.FieldSpec(wire_name="idle_timeout"),
    "original_destination": ubx.FieldSpec(wire_name="original_destination"),
}

_V1beta1TcpRoute_Rules_MatchesFields = {
    "address": ubx.FieldSpec(wire_name="address"),
    "port": ubx.FieldSpec(wire_name="port"),
}

_V1beta1TcpRoute_RulesFields = {
    "action": ubx.FieldSpec(
        wire_name="action",
        kind="object",
        fields=_V1beta1TcpRoute_Rules_ActionFields,
    ),
    "matches": ubx.FieldSpec(
        wire_name="matches",
        kind="list",
        fields=_V1beta1TcpRoute_Rules_MatchesFields,
    ),
}

@dataclasses.dataclass
class V1beta1TcpRouteConfig:
...
V1beta1TcpRoute = ubx.ResourceBinding(
    wire_type="google_networkservices_v1beta1_tcp_route",
    fields={
        ...
        "rules": ubx.FieldSpec(
            wire_name="rules",
            kind="list",
            fields=_V1beta1TcpRoute_RulesFields,
        ),
    },
)
