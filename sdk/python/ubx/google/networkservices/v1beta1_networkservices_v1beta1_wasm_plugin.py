...
class V1beta1NetworkservicesV1beta1WasmPlugin_LogConfig:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1WasmPlugin_UsedBy:
    name: Any = None

@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1WasmPlugin_Versions:
...
_V1beta1NetworkservicesV1beta1WasmPlugin_LogConfigFields = {
...
_V1beta1NetworkservicesV1beta1WasmPlugin_UsedByFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

_V1beta1NetworkservicesV1beta1WasmPlugin_VersionsFields = {
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1WasmPluginConfig:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1WasmPluginAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A human-readable description of the resource.
    description: Any = None
...
V1beta1NetworkservicesV1beta1WasmPlugin = ubx.ResourceBinding(
    wire_type="google_networkservices_v1beta1_networkservices_v1beta1_wasm_plugin",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "description": ubx.FieldSpec(wire_name="description"),
        ...
        "log_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetworkservicesV1beta1WasmPlugin_LogConfigFields,
        ),
        ...
        "used_by": ubx.FieldSpec(
            wire_name="used_by",
            kind="list",
            fields=_V1beta1NetworkservicesV1beta1WasmPlugin_UsedByFields,
        ),
        "versions": ubx.FieldSpec(
            wire_name="versions",
            kind="map",
            fields=_V1beta1NetworkservicesV1beta1WasmPlugin_VersionsFields,
        ),
    },
)
