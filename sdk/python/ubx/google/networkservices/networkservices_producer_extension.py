...
class NetworkservicesProducerExtension_ExtensionSettings:
...
_NetworkservicesProducerExtension_ExtensionSettingsFields = {
...
@dataclasses.dataclass
class NetworkservicesProducerExtensionConfig:
...
@dataclasses.dataclass
class NetworkservicesProducerExtensionAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A human-readable description of the resource.
    description: Any = None
...
NetworkservicesProducerExtension = ubx.ResourceBinding(
    wire_type="google_networkservices_networkservices_producer_extension",
    fields={
        ...
        "extension_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworkservicesProducerExtension_ExtensionSettingsFields,
        ),
