...
class NetworkservicesExtensionBinding_MatchConditions_To_Destination_HeaderSet_Headers_Value:
    contains: Any = None
    exact: Any = None
...
@dataclasses.dataclass
class NetworkservicesExtensionBinding_MatchConditions_To_Destination_HeaderSet_Headers:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class NetworkservicesExtensionBinding_MatchConditions_To_Destination_HeaderSet:
    headers: Any = None

@dataclasses.dataclass
class NetworkservicesExtensionBinding_MatchConditions_To_Destination:
    header_set: Any = None
    hosts: Any = None
    paths: Any = None
    resources: Any = None
...
@dataclasses.dataclass
class NetworkservicesExtensionBinding_MatchConditions_To:
    destination: Any = None
    not_destination: Any = None

@dataclasses.dataclass
class NetworkservicesExtensionBinding_MatchConditions:
    to: Any = None

@dataclasses.dataclass
class NetworkservicesExtensionBinding_Target_Scope:
...
_NetworkservicesExtensionBinding_MatchConditions_To_Destination_HeaderSet_Headers_ValueFields = {
...
_NetworkservicesExtensionBinding_MatchConditions_To_Destination_HeaderSet_HeadersFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(
        wire_name="value",
        kind="object",
        fields=_NetworkservicesExtensionBinding_MatchConditions_To_Destination_HeaderSet_Headers_ValueFields,
    ),
}

_NetworkservicesExtensionBinding_MatchConditions_To_Destination_HeaderSetFields = {
    "headers": ubx.FieldSpec(
        wire_name="headers",
        kind="list",
        fields=_NetworkservicesExtensionBinding_MatchConditions_To_Destination_HeaderSet_HeadersFields,
    ),
}

_NetworkservicesExtensionBinding_MatchConditions_To_DestinationFields = {
    "header_set": ubx.FieldSpec(
        wire_name="header_set",
        kind="object",
        fields=_NetworkservicesExtensionBinding_MatchConditions_To_Destination_HeaderSetFields,
    ),
    "hosts": ubx.FieldSpec(
        wire_name="hosts",
        kind="list",
...
_NetworkservicesExtensionBinding_MatchConditions_ToFields = {
    "destination": ubx.FieldSpec(
        wire_name="destination",
        kind="object",
        fields=_NetworkservicesExtensionBinding_MatchConditions_To_DestinationFields,
    ),
...
_NetworkservicesExtensionBinding_MatchConditionsFields = {
    "to": ubx.FieldSpec(
        wire_name="to",
        kind="object",
        fields=_NetworkservicesExtensionBinding_MatchConditions_ToFields,
    ),
}

_NetworkservicesExtensionBinding_Target_ScopeFields = {
    "parent": ubx.FieldSpec(wire_name="parent"),
    "resource_types": ubx.FieldSpec(wire_name="resource_types"),
}

_NetworkservicesExtensionBinding_TargetFields = {
    "resources": ubx.FieldSpec(wire_name="resources"),
    "scope": ubx.FieldSpec(
        wire_name="scope",
        kind="object",
        fields=_NetworkservicesExtensionBinding_Target_ScopeFields,
    ),
}

@dataclasses.dataclass
class NetworkservicesExtensionBindingConfig:
...
@dataclasses.dataclass
class NetworkservicesExtensionBindingAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. A human-readable description of the resource.
    description: Any = None
...
NetworkservicesExtensionBinding = ubx.ResourceBinding(
    wire_type="google_networkservices_networkservices_extension_binding",
    fields={
        ...
        "match_conditions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_NetworkservicesExtensionBinding_MatchConditionsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        ...
        "target": ubx.FieldSpec(
            wire_name="target",
            kind="object",
            fields=_NetworkservicesExtensionBinding_TargetFields,
        ),
