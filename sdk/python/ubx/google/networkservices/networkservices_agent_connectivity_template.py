...
class NetworkservicesAgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfig:
...
@dataclasses.dataclass
class NetworkservicesAgentConnectivityTemplate_EgressNetworkConfig:
...
_NetworkservicesAgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfigFields = {
    "domain": ubx.FieldSpec(wire_name="domain"),
    "target_network": ubx.FieldSpec(wire_name="target_network"),
}

_NetworkservicesAgentConnectivityTemplate_EgressNetworkConfigFields = {
    "dns_peering_config": ubx.FieldSpec(
        wire_name="dns_peering_config",
        kind="object",
        fields=_NetworkservicesAgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfigFields,
    ),
...
@dataclasses.dataclass
class NetworkservicesAgentConnectivityTemplateConfig:
...
@dataclasses.dataclass
class NetworkservicesAgentConnectivityTemplateAttrs:
    # Required. Immutable. The path of the access. Maps roughly to ingress/egress, though we keep CLIENT_TO_AGENT and AGENT_TO_ANYWHERE as carryovers from Agent Gateway's original resource model. The path is immutable once set. Exactly one path can be set.
    access_path: Any = None
    # Optional. The types of network access provided to the gateway. Both PUBLIC and PRIVATE can be configured.
    access_types: Any = None
...
NetworkservicesAgentConnectivityTemplate = ubx.ResourceBinding(
    wire_type="google_networkservices_networkservices_agent_connectivity_template",
    fields={
        ...
        "egress_network_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworkservicesAgentConnectivityTemplate_EgressNetworkConfigFields,
        ),
