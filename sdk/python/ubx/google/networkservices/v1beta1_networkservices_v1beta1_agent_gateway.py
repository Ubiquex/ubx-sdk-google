...
class V1beta1NetworkservicesV1beta1AgentGateway_AgentGatewayCard:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1AgentGateway_GoogleManaged:
    # Optional. Operating Mode of Agent Gateway.
    governed_access_path: Any = None

@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1AgentGateway_NetworkConfig_DnsPeeringConfig:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1AgentGateway_NetworkConfig_Egress:
    # Optional. The URI of the Network Attachment resource.
    network_attachment: Any = None

@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1AgentGateway_NetworkConfig:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1AgentGateway_SelfManaged:
...
_V1beta1NetworkservicesV1beta1AgentGateway_AgentGatewayCardFields = {
...
_V1beta1NetworkservicesV1beta1AgentGateway_GoogleManagedFields = {
    "governed_access_path": ubx.FieldSpec(wire_name="governed_access_path"),
}

_V1beta1NetworkservicesV1beta1AgentGateway_NetworkConfig_DnsPeeringConfigFields = {
...
_V1beta1NetworkservicesV1beta1AgentGateway_NetworkConfig_EgressFields = {
    "network_attachment": ubx.FieldSpec(wire_name="network_attachment"),
}

_V1beta1NetworkservicesV1beta1AgentGateway_NetworkConfigFields = {
    "dns_peering_config": ubx.FieldSpec(
        wire_name="dns_peering_config",
        kind="object",
        fields=_V1beta1NetworkservicesV1beta1AgentGateway_NetworkConfig_DnsPeeringConfigFields,
    ),
    "egress": ubx.FieldSpec(
        wire_name="egress",
        kind="object",
        fields=_V1beta1NetworkservicesV1beta1AgentGateway_NetworkConfig_EgressFields,
    ),
}

_V1beta1NetworkservicesV1beta1AgentGateway_SelfManagedFields = {
    "resource_uri": ubx.FieldSpec(wire_name="resource_uri"),
    "resource_uris": ubx.FieldSpec(wire_name="resource_uris"),
}

@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1AgentGatewayConfig:
...
@dataclasses.dataclass
class V1beta1NetworkservicesV1beta1AgentGatewayAttrs:
    # Optional. The resource name of the AgentConnectivityTemplate. Format: projects/{project}/locations/{location}/agentConnectivityTemplates/{template}
    agent_connectivity_template: Any = None
    # AgentGatewayOutputCard contains informational output-only fields
    agent_gateway_card: Any = None
...
V1beta1NetworkservicesV1beta1AgentGateway = ubx.ResourceBinding(
    wire_type="google_networkservices_v1beta1_networkservices_v1beta1_agent_gateway",
    fields={
        ...
        "agent_gateway_card": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetworkservicesV1beta1AgentGateway_AgentGatewayCardFields,
        ),
        ...
        "google_managed": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetworkservicesV1beta1AgentGateway_GoogleManagedFields,
        ),
        ...
        "network_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetworkservicesV1beta1AgentGateway_NetworkConfigFields,
        ),
        ...
        "self_managed": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetworkservicesV1beta1AgentGateway_SelfManagedFields,
        ),
