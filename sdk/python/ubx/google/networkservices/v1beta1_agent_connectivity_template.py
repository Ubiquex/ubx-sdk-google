...
class V1beta1AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfig:
...
@dataclasses.dataclass
class V1beta1AgentConnectivityTemplate_EgressNetworkConfig:
...
_V1beta1AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfigFields = {
    "domain": ubx.FieldSpec(wire_name="domain"),
    "target_network": ubx.FieldSpec(wire_name="target_network"),
}

_V1beta1AgentConnectivityTemplate_EgressNetworkConfigFields = {
    "dns_peering_config": ubx.FieldSpec(
        wire_name="dns_peering_config",
        kind="object",
        fields=_V1beta1AgentConnectivityTemplate_EgressNetworkConfig_DnsPeeringConfigFields,
    ),
...
@dataclasses.dataclass
class V1beta1AgentConnectivityTemplateConfig:
...
@dataclasses.dataclass
class V1beta1AgentConnectivityTemplateAttrs:
    # Required. Immutable. The path of the access. Maps roughly to ingress/egress, though we keep CLIENT_TO_AGENT and AGENT_TO_ANYWHERE as carryovers from Agent Gateway's original resource model. The path is immutable once set. Exactly one path can be set.
    access_path: Any = None
    # Optional. The types of network access provided to the gateway. Both PUBLIC and PRIVATE can be configured.
    access_types: Any = None
...
V1beta1AgentConnectivityTemplate = ubx.ResourceBinding(
    wire_type="google_networkservices_v1beta1_agent_connectivity_template",
    fields={
        ...
        "egress_network_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1AgentConnectivityTemplate_EgressNetworkConfigFields,
        ),
