...
class ServiceLbPolicy_AutoCapacityDrain:
...
_ServiceLbPolicy_AutoCapacityDrainFields = {
    "enable": ubx.FieldSpec(wire_name="enable"),
}

_ServiceLbPolicy_FailoverConfigFields = {
    "failover_health_threshold": ubx.FieldSpec(wire_name="failover_health_threshold"),
}

_ServiceLbPolicy_IsolationConfigFields = {
...
ServiceLbPolicy = ubx.ResourceBinding(
    wire_type="google_networkservices_service_lb_policy",
    fields={
        ...
        "failover_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ServiceLbPolicy_FailoverConfigFields,
        ),
        "isolation_config": ubx.FieldSpec(
            wire_name="isolation_config",
            kind="object",
            fields=_ServiceLbPolicy_IsolationConfigFields,
        ),
