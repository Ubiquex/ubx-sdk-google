...
class NetworkservicesMulticastGroupConsumerActivation_LogConfig:
    # Optional. Whether to enable logging or not.
    enabled: Any = None

@dataclasses.dataclass
class NetworkservicesMulticastGroupConsumerActivation_State:
    # Optional. The state of the multicast resource.
    state: Any = None

_NetworkservicesMulticastGroupConsumerActivation_LogConfigFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
}

_NetworkservicesMulticastGroupConsumerActivation_StateFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

@dataclasses.dataclass
class NetworkservicesMulticastGroupConsumerActivationConfig:
...
@dataclasses.dataclass
class NetworkservicesMulticastGroupConsumerActivationAttrs:
    # Output only. [Output only] The timestamp when the multicast group consumer activation was created.
    create_time: Any = None
    # Optional. An optional text description of the multicast group consumer activation.
    description: Any = None
...
NetworkservicesMulticastGroupConsumerActivation = ubx.ResourceBinding(
    wire_type="google_networkservices_networkservices_multicast_group_consumer_activation",
    fields={
        ...
        "log_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworkservicesMulticastGroupConsumerActivation_LogConfigFields,
        ),
        ...
        "state": ubx.FieldSpec(
            wire_name="state",
            kind="object",
            fields=_NetworkservicesMulticastGroupConsumerActivation_StateFields,
        ),
