...
class V1beta1ServiceLbPolicy_AutoCapacityDrain:
...
@dataclasses.dataclass
class V1beta1ServiceLbPolicyAttrs:
    # Option to specify if an unhealthy IG/NEG should be considered for global load balancing and traffic routing.
    auto_capacity_drain: Any = None
    # Output only. The timestamp when this resource was created.
    create_time: Any = None
...
V1beta1ServiceLbPolicy = ubx.ResourceBinding(
    wire_type="google_networkservices_v1beta1_service_lb_policy",
    fields={
        "auto_capacity_drain": ubx.FieldSpec(
            wire_name="auto_capacity_drain",
            kind="object",
            fields=_V1beta1ServiceLbPolicy_AutoCapacityDrainFields,
        ),
        ...
        "failover_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1ServiceLbPolicy_FailoverConfigFields,
        ),
        "isolation_config": ubx.FieldSpec(
            wire_name="isolation_config",
            kind="object",
            fields=_V1beta1ServiceLbPolicy_IsolationConfigFields,
        ),
