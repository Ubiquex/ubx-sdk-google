# Code generated by `ubx sdk gen` from google_metastore_backup. DO NOT EDIT.
...
class Backup_ServiceRevision_EncryptionConfig:
...
@dataclasses.dataclass
class Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfig_Keytab:
...
@dataclasses.dataclass
class Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfig:
...
@dataclasses.dataclass
class Backup_ServiceRevision_HiveMetastoreConfig:
...
@dataclasses.dataclass
class Backup_ServiceRevision_MaintenanceWindow:
...
@dataclasses.dataclass
class Backup_ServiceRevision_MetadataIntegration_DataCatalogConfig:
    # Optional. Defines whether the metastore metadata should be synced to Data Catalog. The default value is to disable syncing metastore metadata to Data Catalog.
    enabled: Any = None

@dataclasses.dataclass
class Backup_ServiceRevision_MetadataIntegration:
...
@dataclasses.dataclass
class Backup_ServiceRevision_MetadataManagementActivity:
...
@dataclasses.dataclass
class Backup_ServiceRevision_ScalingConfig_AutoscalingConfig_LimitConfig:
...
@dataclasses.dataclass
class Backup_ServiceRevision_ScalingConfig_AutoscalingConfig:
...
@dataclasses.dataclass
class Backup_ServiceRevision_ScalingConfig:
...
@dataclasses.dataclass
class Backup_ServiceRevision_ScheduledBackup_LatestBackup:
...
@dataclasses.dataclass
class Backup_ServiceRevision_ScheduledBackup:
...
@dataclasses.dataclass
class Backup_ServiceRevision_TelemetryConfig:
    # Optional. The output format of the Dataproc Metastore service's logs.
    log_format: Any = None

@dataclasses.dataclass
class Backup_ServiceRevision:
...
_Backup_ServiceRevision_EncryptionConfigFields = {
    "kms_key": ubx.FieldSpec(wire_name="kms_key"),
}

_Backup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_ConsumersFields = {
...
_Backup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfigFields = {
    "consumers": ubx.FieldSpec(
        wire_name="consumers",
        kind="list",
        fields=_Backup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_ConsumersFields,
    ),
}

_Backup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersionsFields = {
    "config_overrides": ubx.FieldSpec(wire_name="config_overrides"),
    "network_config": ubx.FieldSpec(
        wire_name="network_config",
        kind="object",
        fields=_Backup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfigFields,
    ),
    "version": ubx.FieldSpec(wire_name="version"),
}

_Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfig_KeytabFields = {
    "cloud_secret": ubx.FieldSpec(wire_name="cloud_secret"),
}

_Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfigFields = {
    "keytab": ubx.FieldSpec(
        wire_name="keytab",
        kind="object",
        fields=_Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfig_KeytabFields,
    ),
    "krb5_config_gcs_uri": ubx.FieldSpec(wire_name="krb5_config_gcs_uri"),
    "principal": ubx.FieldSpec(wire_name="principal"),
}

_Backup_ServiceRevision_HiveMetastoreConfigFields = {
    "auxiliary_versions": ubx.FieldSpec(
        wire_name="auxiliary_versions",
        kind="map",
        fields=_Backup_ServiceRevision_HiveMetastoreConfig_AuxiliaryVersionsFields,
    ),
    "config_overrides": ubx.FieldSpec(wire_name="config_overrides"),
    ...
    "kerberos_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Backup_ServiceRevision_HiveMetastoreConfig_KerberosConfigFields,
    ),
    "version": ubx.FieldSpec(wire_name="version"),
}

_Backup_ServiceRevision_MaintenanceWindowFields = {
    "day_of_week": ubx.FieldSpec(wire_name="day_of_week"),
    "hour_of_day": ubx.FieldSpec(wire_name="hour_of_day"),
}

_Backup_ServiceRevision_MetadataIntegration_DataCatalogConfigFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
}

_Backup_ServiceRevision_MetadataIntegrationFields = {
    "data_catalog_config": ubx.FieldSpec(
        wire_name="data_catalog_config",
        kind="object",
        fields=_Backup_ServiceRevision_MetadataIntegration_DataCatalogConfigFields,
    ),
}

_Backup_ServiceRevision_MetadataManagementActivity_MetadataExportsFields = {
...
_Backup_ServiceRevision_MetadataManagementActivity_RestoresFields = {
...
_Backup_ServiceRevision_MetadataManagementActivityFields = {
    "metadata_exports": ubx.FieldSpec(
        wire_name="metadata_exports",
        kind="list",
        fields=_Backup_ServiceRevision_MetadataManagementActivity_MetadataExportsFields,
    ),
    "restores": ubx.FieldSpec(
        wire_name="restores",
        kind="list",
        fields=_Backup_ServiceRevision_MetadataManagementActivity_RestoresFields,
    ),
}

_Backup_ServiceRevision_ScalingConfig_AutoscalingConfig_LimitConfigFields = {
...
_Backup_ServiceRevision_ScalingConfig_AutoscalingConfigFields = {
    ...
    "limit_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Backup_ServiceRevision_ScalingConfig_AutoscalingConfig_LimitConfigFields,
    ),
}

_Backup_ServiceRevision_ScalingConfigFields = {
    "autoscaling_config": ubx.FieldSpec(
        wire_name="autoscaling_config",
        kind="object",
        fields=_Backup_ServiceRevision_ScalingConfig_AutoscalingConfigFields,
    ),
    "instance_size": ubx.FieldSpec(wire_name="instance_size"),
    "scaling_factor": ubx.FieldSpec(wire_name="scaling_factor"),
}

_Backup_ServiceRevision_ScheduledBackup_LatestBackupFields = {
...
_Backup_ServiceRevision_ScheduledBackupFields = {
    "backup_location": ubx.FieldSpec(wire_name="backup_location"),
...
_Backup_ServiceRevisionFields = {
    ...
    "encryption_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Backup_ServiceRevision_EncryptionConfigFields,
    ),
    "endpoint_uri": ubx.FieldSpec(wire_name="endpoint_uri"),
    "hive_metastore_config": ubx.FieldSpec(
        wire_name="hive_metastore_config",
        kind="object",
        fields=_Backup_ServiceRevision_HiveMetastoreConfigFields,
    ),
    "labels": ubx.FieldSpec(wire_name="labels"),
    "maintenance_window": ubx.FieldSpec(
        wire_name="maintenance_window",
        kind="object",
        fields=_Backup_ServiceRevision_MaintenanceWindowFields,
    ),
    "metadata_integration": ubx.FieldSpec(
        wire_name="metadata_integration",
        kind="object",
        fields=_Backup_ServiceRevision_MetadataIntegrationFields,
    ),
    "metadata_management_activity": ubx.FieldSpec(
        wire_name="metadata_management_activity",
        kind="object",
        fields=_Backup_ServiceRevision_MetadataManagementActivityFields,
    ),
    ...
    "scaling_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Backup_ServiceRevision_ScalingConfigFields,
    ),
    "scheduled_backup": ubx.FieldSpec(
        wire_name="scheduled_backup",
        kind="object",
        fields=_Backup_ServiceRevision_ScheduledBackupFields,
    ),
    "state": ubx.FieldSpec(wire_name="state"),
    ...
    "telemetry_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Backup_ServiceRevision_TelemetryConfigFields,
    ),
...
Backup = ubx.ResourceBinding(
    wire_type="google_metastore_backup",
    fields={
        ...
        "service_revision": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Backup_ServiceRevisionFields,
        ),
    },
)
