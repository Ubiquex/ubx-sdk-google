...
class V1betaService_EncryptionConfig:
...
@dataclasses.dataclass
class V1betaService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_Consumers:
    endpoint_location: Any = None
    endpoint_uri: Any = None
    subnetwork: Any = None

@dataclasses.dataclass
class V1betaService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig:
    consumers: Any = None
    custom_routes_enabled: Any = None

@dataclasses.dataclass
class V1betaService_HiveMetastoreConfig_AuxiliaryVersions:
    config_overrides: Any = None
    network_config: Any = None
    version: Any = None

@dataclasses.dataclass
class V1betaService_HiveMetastoreConfig_KerberosConfig_Keytab:
...
@dataclasses.dataclass
class V1betaService_HiveMetastoreConfig_KerberosConfig:
...
@dataclasses.dataclass
class V1betaService_HiveMetastoreConfig:
...
@dataclasses.dataclass
class V1betaService_MaintenanceWindow:
...
@dataclasses.dataclass
class V1betaService_MetadataIntegration_DataCatalogConfig:
    # Optional. Defines whether the metastore metadata should be synced to Data Catalog. The default value is to disable syncing metastore metadata to Data Catalog.
    enabled: Any = None

@dataclasses.dataclass
class V1betaService_MetadataIntegration_DataplexConfig_LakeResources:
    name: Any = None

@dataclasses.dataclass
class V1betaService_MetadataIntegration_DataplexConfig:
...
@dataclasses.dataclass
class V1betaService_MetadataIntegration:
...
@dataclasses.dataclass
class V1betaService_MetadataManagementActivity_MetadataExports:
...
@dataclasses.dataclass
class V1betaService_MetadataManagementActivity_Restores:
    backup: Any = None
...
@dataclasses.dataclass
class V1betaService_MetadataManagementActivity:
...
@dataclasses.dataclass
class V1betaService_MultiRegionConfig_Certificates:
    certificate: Any = None
    expiration_time: Any = None

@dataclasses.dataclass
class V1betaService_MultiRegionConfig_CustomRegionConfig:
...
@dataclasses.dataclass
class V1betaService_MultiRegionConfig:
...
@dataclasses.dataclass
class V1betaService_ScalingConfig_AutoscalingConfig_LimitConfig:
...
@dataclasses.dataclass
class V1betaService_ScalingConfig_AutoscalingConfig:
...
@dataclasses.dataclass
class V1betaService_ScalingConfig:
...
@dataclasses.dataclass
class V1betaService_ScheduledBackup_LatestBackup:
...
@dataclasses.dataclass
class V1betaService_ScheduledBackup:
...
@dataclasses.dataclass
class V1betaService_TelemetryConfig:
    # Optional. The output format of the Dataproc Metastore service's logs.
    log_format: Any = None

_V1betaService_EncryptionConfigFields = {
    "kms_key": ubx.FieldSpec(wire_name="kms_key"),
    "kms_keys": ubx.FieldSpec(wire_name="kms_keys"),
}

_V1betaService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_ConsumersFields = {
...
_V1betaService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfigFields = {
    "consumers": ubx.FieldSpec(
        wire_name="consumers",
        kind="list",
        fields=_V1betaService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfig_ConsumersFields,
    ),
    "custom_routes_enabled": ubx.FieldSpec(wire_name="custom_routes_enabled"),
}

_V1betaService_HiveMetastoreConfig_AuxiliaryVersionsFields = {
    "config_overrides": ubx.FieldSpec(wire_name="config_overrides"),
    "network_config": ubx.FieldSpec(
        wire_name="network_config",
        kind="object",
        fields=_V1betaService_HiveMetastoreConfig_AuxiliaryVersions_NetworkConfigFields,
    ),
    "version": ubx.FieldSpec(wire_name="version"),
}

_V1betaService_HiveMetastoreConfig_KerberosConfig_KeytabFields = {
    "cloud_secret": ubx.FieldSpec(wire_name="cloud_secret"),
}

_V1betaService_HiveMetastoreConfig_KerberosConfigFields = {
    "keytab": ubx.FieldSpec(
        wire_name="keytab",
        kind="object",
        fields=_V1betaService_HiveMetastoreConfig_KerberosConfig_KeytabFields,
    ),
    "krb5_config_gcs_uri": ubx.FieldSpec(wire_name="krb5_config_gcs_uri"),
    "principal": ubx.FieldSpec(wire_name="principal"),
}

_V1betaService_HiveMetastoreConfigFields = {
    "auxiliary_versions": ubx.FieldSpec(
        wire_name="auxiliary_versions",
        kind="map",
        fields=_V1betaService_HiveMetastoreConfig_AuxiliaryVersionsFields,
    ),
    "config_overrides": ubx.FieldSpec(wire_name="config_overrides"),
    ...
    "kerberos_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaService_HiveMetastoreConfig_KerberosConfigFields,
    ),
    "version": ubx.FieldSpec(wire_name="version"),
}

_V1betaService_MaintenanceWindowFields = {
    "day_of_week": ubx.FieldSpec(wire_name="day_of_week"),
    "hour_of_day": ubx.FieldSpec(wire_name="hour_of_day"),
}

_V1betaService_MetadataIntegration_DataCatalogConfigFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
}

_V1betaService_MetadataIntegration_DataplexConfig_LakeResourcesFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

_V1betaService_MetadataIntegration_DataplexConfigFields = {
    "lake_resources": ubx.FieldSpec(
        wire_name="lake_resources",
        kind="map",
        fields=_V1betaService_MetadataIntegration_DataplexConfig_LakeResourcesFields,
    ),
}

_V1betaService_MetadataIntegrationFields = {
    "data_catalog_config": ubx.FieldSpec(
        wire_name="data_catalog_config",
        kind="object",
        fields=_V1betaService_MetadataIntegration_DataCatalogConfigFields,
    ),
    "dataplex_config": ubx.FieldSpec(
        wire_name="dataplex_config",
        kind="object",
        fields=_V1betaService_MetadataIntegration_DataplexConfigFields,
    ),
}

_V1betaService_MetadataManagementActivity_MetadataExportsFields = {
...
_V1betaService_MetadataManagementActivity_RestoresFields = {
...
_V1betaService_MetadataManagementActivityFields = {
    "metadata_exports": ubx.FieldSpec(
        wire_name="metadata_exports",
        kind="list",
        fields=_V1betaService_MetadataManagementActivity_MetadataExportsFields,
    ),
    "restores": ubx.FieldSpec(
        wire_name="restores",
        kind="list",
        fields=_V1betaService_MetadataManagementActivity_RestoresFields,
    ),
}

_V1betaService_MultiRegionConfig_CertificatesFields = {
    "certificate": ubx.FieldSpec(wire_name="certificate"),
    "expiration_time": ubx.FieldSpec(wire_name="expiration_time"),
}

_V1betaService_MultiRegionConfig_CustomRegionConfigFields = {
    "read_only_regions": ubx.FieldSpec(wire_name="read_only_regions"),
    "read_write_regions": ubx.FieldSpec(wire_name="read_write_regions"),
}

_V1betaService_MultiRegionConfigFields = {
    "certificates": ubx.FieldSpec(
        wire_name="certificates",
        kind="list",
        fields=_V1betaService_MultiRegionConfig_CertificatesFields,
    ),
    "custom_region_config": ubx.FieldSpec(
        wire_name="custom_region_config",
        kind="object",
        fields=_V1betaService_MultiRegionConfig_CustomRegionConfigFields,
    ),
}

_V1betaService_ScalingConfig_AutoscalingConfig_LimitConfigFields = {
...
_V1betaService_ScalingConfig_AutoscalingConfigFields = {
    ...
    "limit_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaService_ScalingConfig_AutoscalingConfig_LimitConfigFields,
    ),
}

_V1betaService_ScalingConfigFields = {
    "autoscaling_config": ubx.FieldSpec(
        wire_name="autoscaling_config",
        kind="object",
        fields=_V1betaService_ScalingConfig_AutoscalingConfigFields,
    ),
    "instance_size": ubx.FieldSpec(wire_name="instance_size"),
    "scaling_factor": ubx.FieldSpec(wire_name="scaling_factor"),
}

_V1betaService_ScheduledBackup_LatestBackupFields = {
...
_V1betaService_ScheduledBackupFields = {
    "backup_location": ubx.FieldSpec(wire_name="backup_location"),
...
V1betaService = ubx.ResourceBinding(
    wire_type="google_metastore_v1beta_service",
    fields={
        ...
        "scaling_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaService_ScalingConfigFields,
        ),
        "scheduled_backup": ubx.FieldSpec(
            wire_name="scheduled_backup",
            kind="object",
            fields=_V1betaService_ScheduledBackupFields,
        ),
        "state": ubx.FieldSpec(wire_name="state"),
        ...
        "telemetry_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaService_TelemetryConfigFields,
        ),
