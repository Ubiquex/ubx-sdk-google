...
class V1betaMetadataImport_DatabaseDump:
...
_V1betaMetadataImport_DatabaseDumpFields = {
...
@dataclasses.dataclass
class V1betaMetadataImportConfig:
...
@dataclasses.dataclass
class V1betaMetadataImportAttrs:
    # Output only. The time when the metadata import was started.
    create_time: Any = None
    # A specification of the location of and metadata about a database dump from a relational database management system.
    database_dump: Any = None
...
V1betaMetadataImport = ubx.ResourceBinding(
    wire_type="google_metastore_v1beta_metadata_import",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "database_dump": ubx.FieldSpec(
            wire_name="database_dump",
            kind="object",
            fields=_V1betaMetadataImport_DatabaseDumpFields,
        ),
