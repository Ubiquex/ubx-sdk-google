...
class V1alphaMetastoreV1alphaMetadataImport_DatabaseDump:
...
_V1alphaMetastoreV1alphaMetadataImport_DatabaseDumpFields = {
...
@dataclasses.dataclass
class V1alphaMetastoreV1alphaMetadataImportConfig:
...
@dataclasses.dataclass
class V1alphaMetastoreV1alphaMetadataImportAttrs:
    # Output only. The time when the metadata import was started.
    create_time: Any = None
    # A specification of the location of and metadata about a database dump from a relational database management system.
    database_dump: Any = None
...
V1alphaMetastoreV1alphaMetadataImport = ubx.ResourceBinding(
    wire_type="google_metastore_v1alpha_metastore_v1alpha_metadata_import",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "database_dump": ubx.FieldSpec(
            wire_name="database_dump",
            kind="object",
            fields=_V1alphaMetastoreV1alphaMetadataImport_DatabaseDumpFields,
        ),
