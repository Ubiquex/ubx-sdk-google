...
class MetastoreMetadataImport_DatabaseDump:
...
_MetastoreMetadataImport_DatabaseDumpFields = {
...
@dataclasses.dataclass
class MetastoreMetadataImportConfig:
...
@dataclasses.dataclass
class MetastoreMetadataImportAttrs:
    # Output only. The time when the metadata import was started.
    create_time: Any = None
    # A specification of the location of and metadata about a database dump from a relational database management system.
    database_dump: Any = None
...
MetastoreMetadataImport = ubx.ResourceBinding(
    wire_type="google_metastore_metastore_metadata_import",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "database_dump": ubx.FieldSpec(
            wire_name="database_dump",
            kind="object",
            fields=_MetastoreMetadataImport_DatabaseDumpFields,
        ),
