...
@dataclasses.dataclass
class Preview_PreviewArtifacts:
...
@dataclasses.dataclass
class Preview_TerraformBlueprint_GitSource:
...
@dataclasses.dataclass
class Preview_TerraformBlueprint:
...
Preview = ubx.ResourceBinding(
    wire_type="google_config_preview",
    fields={
        ...
        "preview_artifacts": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Preview_PreviewArtifactsFields,
        ),
