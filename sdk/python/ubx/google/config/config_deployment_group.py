...
class ConfigDeploymentGroup_DeploymentUnits:
    dependencies: Any = None
    deployment: Any = None
    id: Any = None

@dataclasses.dataclass
class ConfigDeploymentGroup_ProvisioningError:
...
@dataclasses.dataclass
class ConfigDeploymentGroupConfig:
...
@dataclasses.dataclass
class ConfigDeploymentGroupAttrs:
    # Optional. Arbitrary key-value metadata storage e.g. to help client tools identify deployment group during automation. See https://google.aip.dev/148#annotations for details on format and size limitations.
    annotations: Any = None
    # Output only. Time when the deployment group was created.
    create_time: Any = None
...
ConfigDeploymentGroup = ubx.ResourceBinding(
    wire_type="google_config_config_deployment_group",
    fields={
        ...
        "deployment_units": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ConfigDeploymentGroup_DeploymentUnitsFields,
        ),
        ...
        "provisioning_error": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ConfigDeploymentGroup_ProvisioningErrorFields,
        ),
