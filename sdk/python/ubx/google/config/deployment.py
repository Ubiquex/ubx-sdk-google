...
@dataclasses.dataclass
class Deployment_DeleteResults:
...
@dataclasses.dataclass
class Deployment_ProviderConfig:
...
_Deployment_DeleteResultsFields = {
    "artifacts": ubx.FieldSpec(wire_name="artifacts"),
    "content": ubx.FieldSpec(wire_name="content"),
    "outputs": ubx.FieldSpec(
        wire_name="outputs",
        kind="map",
        fields=_Deployment_DeleteResults_OutputsFields,
    ),
}

_Deployment_ProviderConfigFields = {
    "source_type": ubx.FieldSpec(wire_name="source_type"),
}

_Deployment_TerraformBlueprint_ExternalValues_DeploymentSourceFields = {
    "deployment": ubx.FieldSpec(wire_name="deployment"),
    "output_name": ubx.FieldSpec(wire_name="output_name"),
}

_Deployment_TerraformBlueprint_ExternalValuesFields = {
    "deployment_source": ubx.FieldSpec(
        wire_name="deployment_source",
        kind="object",
        fields=_Deployment_TerraformBlueprint_ExternalValues_DeploymentSourceFields,
    ),
}
...
_Deployment_TerraformBlueprintFields = {
    "external_values": ubx.FieldSpec(
        ...
        kind="map",
        fields=_Deployment_TerraformBlueprint_ExternalValuesFields,
    ),
...
Deployment = ubx.ResourceBinding(
    ...
    fields={
        ...
        "delete_results": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Deployment_DeleteResultsFields,
        ),
        ...
        "provider_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Deployment_ProviderConfigFields,
        ),
        ...
        "tf_errors": ubx.FieldSpec(
            wire_name="tf_errors",
            kind="list",
            fields=_Deployment_TfErrorsFields,
        ),
