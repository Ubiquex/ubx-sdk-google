...
class OracledatabaseDbSystem_Properties_DataCollectionOptions:
...
@dataclasses.dataclass
class OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DatabaseManagementConfig:
...
@dataclasses.dataclass
class OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfig_BackupDestinationDetails:
    type: Any = None

@dataclasses.dataclass
class OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfig:
...
@dataclasses.dataclass
class OracledatabaseDbSystem_Properties_DbHome_Database_Properties:
...
@dataclasses.dataclass
class OracledatabaseDbSystem_Properties_DbHome_Database:
...
@dataclasses.dataclass
class OracledatabaseDbSystem_Properties_DbHome:
...
@dataclasses.dataclass
class OracledatabaseDbSystem_Properties_DbSystemOptions:
    # Optional. The storage option used in DB system.
    storage_management: Any = None

@dataclasses.dataclass
class OracledatabaseDbSystem_Properties_TimeZone:
...
@dataclasses.dataclass
class OracledatabaseDbSystem_Properties:
...
_OracledatabaseDbSystem_Properties_DataCollectionOptionsFields = {
...
_OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DatabaseManagementConfigFields = {
    "management_state": ubx.FieldSpec(wire_name="management_state"),
    "management_type": ubx.FieldSpec(wire_name="management_type"),
}

_OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfig_BackupDestinationDetailsFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfigFields = {
    ...
    "backup_destination_details": ubx.FieldSpec(
        ...
        kind="list",
        fields=_OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfig_BackupDestinationDetailsFields,
    ),
    "retention_period_days": ubx.FieldSpec(wire_name="retention_period_days"),
}

_OracledatabaseDbSystem_Properties_DbHome_Database_PropertiesFields = {
    "database_management_config": ubx.FieldSpec(
        wire_name="database_management_config",
        kind="object",
        fields=_OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DatabaseManagementConfigFields,
    ),
    "db_backup_config": ubx.FieldSpec(
        wire_name="db_backup_config",
        kind="object",
        fields=_OracledatabaseDbSystem_Properties_DbHome_Database_Properties_DbBackupConfigFields,
    ),
    "db_version": ubx.FieldSpec(wire_name="db_version"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_OracledatabaseDbSystem_Properties_DbHome_DatabaseFields = {
    ...
    "properties": ubx.FieldSpec(
        ...
        kind="object",
        fields=_OracledatabaseDbSystem_Properties_DbHome_Database_PropertiesFields,
    ),
...
_OracledatabaseDbSystem_Properties_DbHomeFields = {
    "database": ubx.FieldSpec(
        wire_name="database",
        kind="object",
        fields=_OracledatabaseDbSystem_Properties_DbHome_DatabaseFields,
    ),
    "db_version": ubx.FieldSpec(wire_name="db_version"),
...
_OracledatabaseDbSystem_Properties_DbSystemOptionsFields = {
    "storage_management": ubx.FieldSpec(wire_name="storage_management"),
}

_OracledatabaseDbSystem_Properties_TimeZoneFields = {
    "id": ubx.FieldSpec(wire_name="id"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_OracledatabaseDbSystem_PropertiesFields = {
    ...
    "data_collection_options": ubx.FieldSpec(
        ...
        kind="object",
        fields=_OracledatabaseDbSystem_Properties_DataCollectionOptionsFields,
    ),
    ...
    "db_home": ubx.FieldSpec(
        wire_name="db_home",
        kind="object",
        fields=_OracledatabaseDbSystem_Properties_DbHomeFields,
    ),
    "db_system_options": ubx.FieldSpec(
        wire_name="db_system_options",
        kind="object",
        fields=_OracledatabaseDbSystem_Properties_DbSystemOptionsFields,
    ),
    ...
    "time_zone": ubx.FieldSpec(
        wire_name="time_zone",
        kind="object",
        fields=_OracledatabaseDbSystem_Properties_TimeZoneFields,
    ),
}

@dataclasses.dataclass
class OracledatabaseDbSystemConfig:
...
@dataclasses.dataclass
class OracledatabaseDbSystemAttrs:
    # Output only. The date and time that the DbSystem was created.
    create_time: Any = None
    # Required. The display name for the System db. The name does not have to be unique within your project.
    display_name: Any = None
...
OracledatabaseDbSystem = ubx.ResourceBinding(
    wire_type="google_oracledatabase_oracledatabase_db_system",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        ...
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_OracledatabaseDbSystem_PropertiesFields,
        ),
    },
)
