...
class OracledatabaseExadbVmCluster_IdentityConnector:
...
@dataclasses.dataclass
class OracledatabaseExadbVmCluster_Properties_DataCollectionOptions:
...
@dataclasses.dataclass
class OracledatabaseExadbVmCluster_Properties_TimeZone:
...
@dataclasses.dataclass
class OracledatabaseExadbVmCluster_Properties_VmFileSystemStorage:
...
@dataclasses.dataclass
class OracledatabaseExadbVmCluster_Properties:
...
_OracledatabaseExadbVmCluster_IdentityConnectorFields = {
    "connection_state": ubx.FieldSpec(wire_name="connection_state"),
    "service_agent_email": ubx.FieldSpec(wire_name="service_agent_email"),
}

_OracledatabaseExadbVmCluster_Properties_DataCollectionOptionsFields = {
...
_OracledatabaseExadbVmCluster_Properties_TimeZoneFields = {
    "id": ubx.FieldSpec(wire_name="id"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_OracledatabaseExadbVmCluster_Properties_VmFileSystemStorageFields = {
    "size_in_gbs_per_node": ubx.FieldSpec(wire_name="size_in_gbs_per_node"),
}

_OracledatabaseExadbVmCluster_PropertiesFields = {
    ...
    "data_collection_options": ubx.FieldSpec(
        ...
        kind="object",
        fields=_OracledatabaseExadbVmCluster_Properties_DataCollectionOptionsFields,
    ),
    ...
    "time_zone": ubx.FieldSpec(
        wire_name="time_zone",
        kind="object",
        fields=_OracledatabaseExadbVmCluster_Properties_TimeZoneFields,
    ),
    "vm_file_system_storage": ubx.FieldSpec(
        wire_name="vm_file_system_storage",
        kind="object",
        fields=_OracledatabaseExadbVmCluster_Properties_VmFileSystemStorageFields,
    ),
}

@dataclasses.dataclass
class OracledatabaseExadbVmClusterConfig:
...
@dataclasses.dataclass
class OracledatabaseExadbVmClusterAttrs:
    # Required. Immutable. The name of the backup OdbSubnet associated with the ExadbVmCluster. Format: projects/{project}/locations/{location}/odbNetworks/{odb_network}/odbSubnets/{odb_subnet}
    backup_odb_subnet: Any = None
    # Output only. The date and time that the ExadbVmCluster was created.
    create_time: Any = None
...
OracledatabaseExadbVmCluster = ubx.ResourceBinding(
    wire_type="google_oracledatabase_oracledatabase_exadb_vm_cluster",
    fields={
        ...
        "identity_connector": ubx.FieldSpec(
            ...
            kind="object",
            fields=_OracledatabaseExadbVmCluster_IdentityConnectorFields,
        ),
        ...
        "properties": ubx.FieldSpec(
            ...
            kind="object",
            fields=_OracledatabaseExadbVmCluster_PropertiesFields,
        ),
    },
)
