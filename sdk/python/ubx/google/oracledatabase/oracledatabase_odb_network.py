...
class OracledatabaseOdbNetworkConfig:
...
@dataclasses.dataclass
class OracledatabaseOdbNetworkAttrs:
    # Output only. The date and time that the OdbNetwork was created.
    create_time: Any = None
    # Output only. The ID of the subscription entitlement associated with the OdbNetwork.
    entitlement_id: Any = None
...
OracledatabaseOdbNetwork = ubx.ResourceBinding(
    wire_type="google_oracledatabase_oracledatabase_odb_network",
    fields={
