# Code generated by `ubx sdk gen` from google_securityposture_securityposture_posture_deployment. DO NOT EDIT.
...
class SecurityposturePostureDeploymentConfig:
...
@dataclasses.dataclass
class SecurityposturePostureDeploymentAttrs:
    # Optional. The user-specified annotations for the posture deployment. For details about the values you can use in an annotation, see [AIP-148: Standard fields](https://google.aip.dev/148#annotations).
    annotations: Any = None
    # Output only. The categories that the posture deployment belongs to, as determined by the Security Posture API.
    categories: Any = None
...
SecurityposturePostureDeployment = ubx.ResourceBinding(
    wire_type="google_securityposture_securityposture_posture_deployment",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "categories": ubx.FieldSpec(wire_name="categories"),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "description": ubx.FieldSpec(wire_name="description"),
        "desired_posture_id": ubx.FieldSpec(wire_name="desired_posture_id"),
        "desired_posture_revision_id": ubx.FieldSpec(wire_name="desired_posture_revision_id"),
