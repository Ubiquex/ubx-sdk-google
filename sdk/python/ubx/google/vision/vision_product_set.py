...
class VisionProductSet_IndexError:
...
_VisionProductSet_IndexErrorFields = {
...
VisionProductSet = ubx.ResourceBinding(
    wire_type="google_vision_vision_product_set",
    fields={
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        "index_error": ubx.FieldSpec(
            wire_name="index_error",
            kind="object",
            fields=_VisionProductSet_IndexErrorFields,
        ),
