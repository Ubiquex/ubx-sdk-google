...
@dataclasses.dataclass
class V1alphaRevision_GcsSource:
...
_V1alphaRevision_ArchiveUploadSourceFields = {
    "archive_content": ubx.FieldSpec(wire_name="archive_content"),
}

_V1alphaRevision_FrontmatterFields = {
...
_V1alphaRevision_GcsSourceFields = {
...
V1alphaRevision = ubx.ResourceBinding(
    wire_type="google_agentregistry_v1alpha_revision",
    fields={
        ...
        "frontmatter": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1alphaRevision_FrontmatterFields,
        ),
