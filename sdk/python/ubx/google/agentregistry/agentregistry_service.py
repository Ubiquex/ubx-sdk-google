...
class AgentregistryService_AgentSpec:
...
@dataclasses.dataclass
class AgentregistryService_Interfaces:
    protocol_binding: Any = None
    url: Any = None

_AgentregistryService_AgentSpecFields = {
    "content": ubx.FieldSpec(wire_name="content"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_AgentregistryService_InterfacesFields = {
...
@dataclasses.dataclass
class AgentregistryServiceAttrs:
    # The spec of the agent.
    agent_spec: Any = None
    # Output only. Create time.
    create_time: Any = None
...
AgentregistryService = ubx.ResourceBinding(
    wire_type="google_agentregistry_agentregistry_service",
    fields={
        "agent_spec": ubx.FieldSpec(
            wire_name="agent_spec",
            kind="object",
            fields=_AgentregistryService_AgentSpecFields,
        ),
        ...
        "interfaces": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AgentregistryService_InterfacesFields,
        ),
