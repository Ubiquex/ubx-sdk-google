...
class V1alphaAgentregistryV1alphaSkill_Frontmatter:
...
@dataclasses.dataclass
class V1alphaAgentregistryV1alphaSkill_InitialRevision_ArchiveUploadSource:
    # Required. Input only. Write-only raw ZIP/TAR archive payload bytes containing the skill package.
    archive_content: Any = None

@dataclasses.dataclass
class V1alphaAgentregistryV1alphaSkill_InitialRevision_GcsSource:
...
@dataclasses.dataclass
class V1alphaAgentregistryV1alphaSkill_InitialRevision:
...
_V1alphaAgentregistryV1alphaSkill_FrontmatterFields = {
...
_V1alphaAgentregistryV1alphaSkill_InitialRevision_ArchiveUploadSourceFields = {
    "archive_content": ubx.FieldSpec(wire_name="archive_content"),
}

_V1alphaAgentregistryV1alphaSkill_InitialRevision_GcsSourceFields = {
    "generation": ubx.FieldSpec(wire_name="generation"),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_V1alphaAgentregistryV1alphaSkill_InitialRevisionFields = {
    "archive_upload_source": ubx.FieldSpec(
        wire_name="archive_upload_source",
        kind="object",
        fields=_V1alphaAgentregistryV1alphaSkill_InitialRevision_ArchiveUploadSourceFields,
    ),
    "create_time": ubx.FieldSpec(wire_name="create_time"),
    "frontmatter": ubx.FieldSpec(
        wire_name="frontmatter",
        kind="object",
        fields=_V1alphaAgentregistryV1alphaSkill_FrontmatterFields,
    ),
    "gcs_source": ubx.FieldSpec(
        wire_name="gcs_source",
        kind="object",
        fields=_V1alphaAgentregistryV1alphaSkill_InitialRevision_GcsSourceFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
...
@dataclasses.dataclass
class V1alphaAgentregistryV1alphaSkillConfig:
...
@dataclasses.dataclass
class V1alphaAgentregistryV1alphaSkillAttrs:
    # Output only. Create time.
    create_time: Any = None
    # Optional. The full resource name of the revision currently served by default (floating track). Format: `projects/{project}/locations/{location}/skills/{skill}/revisions/{revision}`
    default_revision: Any = None
...
V1alphaAgentregistryV1alphaSkill = ubx.ResourceBinding(
    wire_type="google_agentregistry_v1alpha_agentregistry_v1alpha_skill",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        ...
        "initial_revision": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1alphaAgentregistryV1alphaSkill_InitialRevisionFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
