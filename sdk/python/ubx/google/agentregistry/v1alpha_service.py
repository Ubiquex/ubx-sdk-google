...
class V1alphaService_AgentSpec:
...
@dataclasses.dataclass
class V1alphaService_Interfaces:
    protocol_binding: Any = None
    url: Any = None

_V1alphaService_AgentSpecFields = {
    "content": ubx.FieldSpec(wire_name="content"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_V1alphaService_InterfacesFields = {
...
V1alphaService = ubx.ResourceBinding(
    wire_type="google_agentregistry_v1alpha_service",
    fields={
        ...
        "interfaces": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1alphaService_InterfacesFields,
        ),
