# Code generated by `ubx sdk gen` from google_bigqueryreservation_reservation. DO NOT EDIT.
...
@dataclasses.dataclass
class Reservation_ReplicationStatus_Error:
...
@dataclasses.dataclass
class Reservation_ReplicationStatus:
...
@dataclasses.dataclass
class Reservation_SchedulingPolicy:
...
_Reservation_ReplicationStatus_ErrorFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_Reservation_ReplicationStatusFields = {
    "error": ubx.FieldSpec(
        wire_name="error",
        kind="object",
        fields=_Reservation_ReplicationStatus_ErrorFields,
    ),
...
_Reservation_SchedulingPolicyFields = {
...
Reservation = ubx.ResourceBinding(
    wire_type="google_bigqueryreservation_reservation",
    fields={
        ...
        "scheduling_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Reservation_SchedulingPolicyFields,
        ),
