...
class BackupdrBackupPlan_BackupRules_StandardSchedule_BackupWindow:
    end_hour_of_day: Any = None
    start_hour_of_day: Any = None

@dataclasses.dataclass
class BackupdrBackupPlan_BackupRules_StandardSchedule_WeekDayOfMonth:
    day_of_week: Any = None
    week_of_month: Any = None

@dataclasses.dataclass
class BackupdrBackupPlan_BackupRules_StandardSchedule:
...
@dataclasses.dataclass
class BackupdrBackupPlan_BackupRules:
    backup_retention_days: Any = None
    rule_id: Any = None
    standard_schedule: Any = None

@dataclasses.dataclass
class BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabels_Labels:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabels:
...
@dataclasses.dataclass
class BackupdrBackupPlan_ComputeInstanceBackupPlanProperties:
...
@dataclasses.dataclass
class BackupdrBackupPlan_DiskBackupPlanProperties:
...
_BackupdrBackupPlan_BackupRules_StandardSchedule_BackupWindowFields = {
    "end_hour_of_day": ubx.FieldSpec(wire_name="end_hour_of_day"),
    "start_hour_of_day": ubx.FieldSpec(wire_name="start_hour_of_day"),
}

_BackupdrBackupPlan_BackupRules_StandardSchedule_WeekDayOfMonthFields = {
    "day_of_week": ubx.FieldSpec(wire_name="day_of_week"),
    "week_of_month": ubx.FieldSpec(wire_name="week_of_month"),
}

_BackupdrBackupPlan_BackupRules_StandardScheduleFields = {
    "backup_window": ubx.FieldSpec(
        wire_name="backup_window",
        kind="object",
        fields=_BackupdrBackupPlan_BackupRules_StandardSchedule_BackupWindowFields,
    ),
    ...
    "week_day_of_month": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BackupdrBackupPlan_BackupRules_StandardSchedule_WeekDayOfMonthFields,
    ),
}

_BackupdrBackupPlan_BackupRulesFields = {
    ...
    "standard_schedule": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BackupdrBackupPlan_BackupRules_StandardScheduleFields,
    ),
}

_BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabels_LabelsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabelsFields = {
    "labels": ubx.FieldSpec(
        wire_name="labels",
        kind="list",
        fields=_BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabels_LabelsFields,
    ),
}

_BackupdrBackupPlan_ComputeInstanceBackupPlanPropertiesFields = {
    "boot_disk_only": ubx.FieldSpec(wire_name="boot_disk_only"),
    "disk_exclusion_labels": ubx.FieldSpec(
        wire_name="disk_exclusion_labels",
        kind="object",
        fields=_BackupdrBackupPlan_ComputeInstanceBackupPlanProperties_DiskExclusionLabelsFields,
    ),
    "guest_flush": ubx.FieldSpec(wire_name="guest_flush"),
}

_BackupdrBackupPlan_DiskBackupPlanPropertiesFields = {
    "guest_flush": ubx.FieldSpec(wire_name="guest_flush"),
}

@dataclasses.dataclass
class BackupdrBackupPlanConfig:
...
BackupdrBackupPlan = ubx.ResourceBinding(
    wire_type="google_backupdr_backupdr_backup_plan",
    fields={
        "backup_rules": ubx.FieldSpec(
            wire_name="backup_rules",
            kind="list",
            fields=_BackupdrBackupPlan_BackupRulesFields,
        ),
        ...
        "compute_instance_backup_plan_properties": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BackupdrBackupPlan_ComputeInstanceBackupPlanPropertiesFields,
        ),
        ...
        "disk_backup_plan_properties": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BackupdrBackupPlan_DiskBackupPlanPropertiesFields,
        ),
