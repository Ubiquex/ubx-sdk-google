...
class GkeonpremBareMetalNodePool_NodePoolConfig_KubeletConfig:
...
@dataclasses.dataclass
class GkeonpremBareMetalNodePool_NodePoolConfig_NodeConfigs:
    labels: Any = None
    node_ip: Any = None

@dataclasses.dataclass
class GkeonpremBareMetalNodePool_NodePoolConfig_Taints:
    effect: Any = None
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class GkeonpremBareMetalNodePool_NodePoolConfig:
...
@dataclasses.dataclass
class GkeonpremBareMetalNodePool_Status_Conditions:
...
@dataclasses.dataclass
class GkeonpremBareMetalNodePool_Status_Versions_Versions:
    count: Any = None
    version: Any = None

@dataclasses.dataclass
class GkeonpremBareMetalNodePool_Status_Versions:
    # Shows the mapping of a given version to the number of machines under this version.
    versions: Any = None

@dataclasses.dataclass
class GkeonpremBareMetalNodePool_Status:
...
@dataclasses.dataclass
class GkeonpremBareMetalNodePool_UpgradePolicy_ParallelUpgradeConfig:
...
@dataclasses.dataclass
class GkeonpremBareMetalNodePool_UpgradePolicy:
...
_GkeonpremBareMetalNodePool_NodePoolConfig_KubeletConfigFields = {
...
_GkeonpremBareMetalNodePool_NodePoolConfig_NodeConfigsFields = {
    "labels": ubx.FieldSpec(wire_name="labels"),
    "node_ip": ubx.FieldSpec(wire_name="node_ip"),
}

_GkeonpremBareMetalNodePool_NodePoolConfig_TaintsFields = {
    "effect": ubx.FieldSpec(wire_name="effect"),
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_GkeonpremBareMetalNodePool_NodePoolConfigFields = {
    "kubelet_config": ubx.FieldSpec(
        wire_name="kubelet_config",
        kind="object",
        fields=_GkeonpremBareMetalNodePool_NodePoolConfig_KubeletConfigFields,
    ),
    "labels": ubx.FieldSpec(wire_name="labels"),
    "node_configs": ubx.FieldSpec(
        wire_name="node_configs",
        kind="list",
        fields=_GkeonpremBareMetalNodePool_NodePoolConfig_NodeConfigsFields,
    ),
    "operating_system": ubx.FieldSpec(wire_name="operating_system"),
    "taints": ubx.FieldSpec(
        wire_name="taints",
        kind="list",
        fields=_GkeonpremBareMetalNodePool_NodePoolConfig_TaintsFields,
    ),
}

_GkeonpremBareMetalNodePool_Status_ConditionsFields = {
...
_GkeonpremBareMetalNodePool_Status_Versions_VersionsFields = {
    "count": ubx.FieldSpec(wire_name="count"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_GkeonpremBareMetalNodePool_Status_VersionsFields = {
    "versions": ubx.FieldSpec(
        wire_name="versions",
        kind="list",
        fields=_GkeonpremBareMetalNodePool_Status_Versions_VersionsFields,
    ),
}

_GkeonpremBareMetalNodePool_StatusFields = {
    "conditions": ubx.FieldSpec(
        wire_name="conditions",
        kind="list",
        fields=_GkeonpremBareMetalNodePool_Status_ConditionsFields,
    ),
    ...
    "versions": ubx.FieldSpec(
        wire_name="versions",
        kind="object",
        fields=_GkeonpremBareMetalNodePool_Status_VersionsFields,
    ),
}

_GkeonpremBareMetalNodePool_UpgradePolicy_ParallelUpgradeConfigFields = {
...
_GkeonpremBareMetalNodePool_UpgradePolicyFields = {
    "parallel_upgrade_config": ubx.FieldSpec(
        wire_name="parallel_upgrade_config",
        kind="object",
        fields=_GkeonpremBareMetalNodePool_UpgradePolicy_ParallelUpgradeConfigFields,
    ),
}

@dataclasses.dataclass
class GkeonpremBareMetalNodePoolConfig:
...
@dataclasses.dataclass
class GkeonpremBareMetalNodePoolAttrs:
    # Annotations on the bare metal node pool. This field has the same restrictions as Kubernetes annotations. The total size of all keys and values combined is limited to 256k. Key can have 2 segments: prefix (optional) and name (required), separated by a slash (/). Prefix must be a DNS subdomain. Name must be 63 characters or less, begin and end with alphanumerics, with dashes (-), underscores (_), dots (.), and alphanumerics between.
    annotations: Any = None
    # Output only. The time at which this bare metal node pool was created.
    create_time: Any = None
...
GkeonpremBareMetalNodePool = ubx.ResourceBinding(
    wire_type="google_gkeonprem_gkeonprem_bare_metal_node_pool",
    fields={
        ...
        "node_pool_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_GkeonpremBareMetalNodePool_NodePoolConfigFields,
        ),
        ...
        "status": ubx.FieldSpec(
            wire_name="status",
            kind="object",
            fields=_GkeonpremBareMetalNodePool_StatusFields,
        ),
        ...
        "upgrade_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_GkeonpremBareMetalNodePool_UpgradePolicyFields,
        ),
    },
)
