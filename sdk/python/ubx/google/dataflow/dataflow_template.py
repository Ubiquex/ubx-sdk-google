...
class DataflowTemplate_Environment:
...
@dataclasses.dataclass
class DataflowTemplate_Metadata_Parameters_EnumOptions:
    description: Any = None
    label: Any = None
    value: Any = None

@dataclasses.dataclass
class DataflowTemplate_Metadata_Parameters:
...
@dataclasses.dataclass
class DataflowTemplate_Metadata:
...
@dataclasses.dataclass
class DataflowTemplate_RuntimeMetadata_SdkInfo:
...
@dataclasses.dataclass
class DataflowTemplate_RuntimeMetadata:
    # The parameters for the template.
    parameters: Any = None
    # SDK Information.
    sdk_info: Any = None
...
_DataflowTemplate_EnvironmentFields = {
...
DataflowTemplate = ubx.ResourceBinding(
    wire_type="google_dataflow_dataflow_template",
    fields={
        "environment": ubx.FieldSpec(
            wire_name="environment",
            kind="object",
            fields=_DataflowTemplate_EnvironmentFields,
        ),
