...
class V1beta1NetworksecurityV1beta1FirewallEndpoint_Associations:
    name: Any = None
    network: Any = None

@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1FirewallEndpoint_EndpointSettings:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings_WildfireInlineCloudAnalysisSettings:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings:
...
_V1beta1NetworksecurityV1beta1FirewallEndpoint_AssociationsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "network": ubx.FieldSpec(wire_name="network"),
}

_V1beta1NetworksecurityV1beta1FirewallEndpoint_EndpointSettingsFields = {
...
_V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings_WildfireInlineCloudAnalysisSettingsFields = {
...
_V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettingsFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "wildfire_inline_cloud_analysis_settings": ubx.FieldSpec(
        wire_name="wildfire_inline_cloud_analysis_settings",
        kind="object",
        fields=_V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettings_WildfireInlineCloudAnalysisSettingsFields,
    ),
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1FirewallEndpointConfig:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1FirewallEndpointAttrs:
    # Output only. Deprecated: List of networks that are associated with this endpoint in the local zone. This is a projection of the FirewallEndpointAssociations pointing at this endpoint. A network will only appear in this list after traffic routing is fully configured. Format: projects/{project}/global/networks/{name}.
    associated_networks: Any = None
    # Output only. List of FirewallEndpointAssociations that are associated to this endpoint. An association will only appear in this list after traffic routing is fully configured.
    associations: Any = None
...
V1beta1NetworksecurityV1beta1FirewallEndpoint = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_networksecurity_v1beta1_firewall_endpoint",
    fields={
        "associated_networks": ubx.FieldSpec(wire_name="associated_networks"),
        "associations": ubx.FieldSpec(
            wire_name="associations",
            kind="list",
            fields=_V1beta1NetworksecurityV1beta1FirewallEndpoint_AssociationsFields,
        ),
        ...
        "endpoint_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetworksecurityV1beta1FirewallEndpoint_EndpointSettingsFields,
        ),
        ...
        "wildfire_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetworksecurityV1beta1FirewallEndpoint_WildfireSettingsFields,
        ),
    },
)
