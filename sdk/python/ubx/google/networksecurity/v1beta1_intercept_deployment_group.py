...
_V1beta1InterceptDeploymentGroup_ConnectedEndpointGroupsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

_V1beta1InterceptDeploymentGroup_LocationsFields = {
    "location": ubx.FieldSpec(wire_name="location"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_V1beta1InterceptDeploymentGroup_NestedDeploymentsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "state": ubx.FieldSpec(wire_name="state"),
}
...
V1beta1InterceptDeploymentGroup = ubx.ResourceBinding(
    ...
    fields={
        "connected_endpoint_groups": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1beta1InterceptDeploymentGroup_ConnectedEndpointGroupsFields,
        ),
        ...
        "locations": ubx.FieldSpec(
            wire_name="locations",
            kind="list",
            fields=_V1beta1InterceptDeploymentGroup_LocationsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "nested_deployments": ubx.FieldSpec(
            wire_name="nested_deployments",
            kind="list",
            fields=_V1beta1InterceptDeploymentGroup_NestedDeploymentsFields,
        ),
