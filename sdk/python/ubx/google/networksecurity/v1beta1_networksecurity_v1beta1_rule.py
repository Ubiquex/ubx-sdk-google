...
class V1beta1NetworksecurityV1beta1RuleConfig:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1RuleAttrs:
    # Optional. CEL expression for matching on L7/application level criteria.
    application_matcher: Any = None
    # Required. Profile which tells what the primitive action should be.
    basic_profile: Any = None
...
V1beta1NetworksecurityV1beta1Rule = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_networksecurity_v1beta1_rule",
    fields={
