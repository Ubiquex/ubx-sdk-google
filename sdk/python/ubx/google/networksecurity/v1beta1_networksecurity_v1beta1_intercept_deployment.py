...
class V1beta1NetworksecurityV1beta1InterceptDeploymentConfig:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1InterceptDeploymentAttrs:
    # Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
    create_time: Any = None
    # Optional. User-provided description of the deployment. Used as additional context for the deployment.
    description: Any = None
...
V1beta1NetworksecurityV1beta1InterceptDeployment = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_networksecurity_v1beta1_intercept_deployment",
    fields={
