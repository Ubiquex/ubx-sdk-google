...
class V1beta1NetworksecurityV1beta1InterceptEndpointGroupAssociation_Locations:
    location: Any = None
    state: Any = None

_V1beta1NetworksecurityV1beta1InterceptEndpointGroupAssociation_LocationsFields = {
    "location": ubx.FieldSpec(wire_name="location"),
    "state": ubx.FieldSpec(wire_name="state"),
}

@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1InterceptEndpointGroupAssociationConfig:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1InterceptEndpointGroupAssociationAttrs:
    # Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
    create_time: Any = None
    # Required. Immutable. The endpoint group that this association is connected to, for example: `projects/123456789/locations/global/interceptEndpointGroups/my-eg`. See https://google.aip.dev/124.
    intercept_endpoint_group: Any = None
...
V1beta1NetworksecurityV1beta1InterceptEndpointGroupAssociation = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_networksecurity_v1beta1_intercept_endpoint_group_association",
    fields={
        ...
        "locations": ubx.FieldSpec(
            wire_name="locations",
            kind="list",
            fields=_V1beta1NetworksecurityV1beta1InterceptEndpointGroupAssociation_LocationsFields,
        ),
