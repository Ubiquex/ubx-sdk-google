...
@dataclasses.dataclass
class NetworksecurityGatewaySecurityPolicyAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. Free-text description of the resource.
    description: Any = None
...
NetworksecurityGatewaySecurityPolicy = ubx.ResourceBinding(
    wire_type="google_networksecurity_networksecurity_gateway_security_policy",
    fields={
