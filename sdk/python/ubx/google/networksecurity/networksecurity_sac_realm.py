...
class NetworksecuritySacRealm_PairingKey:
...
_NetworksecuritySacRealm_PairingKeyFields = {
    "expire_time": ubx.FieldSpec(wire_name="expire_time"),
    "key": ubx.FieldSpec(wire_name="key"),
}

@dataclasses.dataclass
class NetworksecuritySacRealmConfig:
...
@dataclasses.dataclass
class NetworksecuritySacRealmAttrs:
    # Output only. Timestamp when the realm was created.
    create_time: Any = None
    # Optional. Optional list of labels applied to the resource.
    labels: Any = None
...
NetworksecuritySacRealm = ubx.ResourceBinding(
    wire_type="google_networksecurity_networksecurity_sac_realm",
    fields={
        ...
        "pairing_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworksecuritySacRealm_PairingKeyFields,
        ),
