...
class V1beta1NetworksecurityV1beta1TlsInspectionPolicyConfig:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1TlsInspectionPolicyAttrs:
    # Required. A CA pool resource used to issue interception certificates. The CA pool string has a relative resource path following the form "projects/{project}/locations/{location}/caPools/{ca_pool}".
    ca_pool: Any = None
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
...
V1beta1NetworksecurityV1beta1TlsInspectionPolicy = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_networksecurity_v1beta1_tls_inspection_policy",
    fields={
