...
class V1beta1MirroringEndpointGroup_Associations:
    name: Any = None
    network: Any = None
    state: Any = None

@dataclasses.dataclass
class V1beta1MirroringEndpointGroup_ConnectedDeploymentGroups_Locations:
    location: Any = None
    state: Any = None

@dataclasses.dataclass
class V1beta1MirroringEndpointGroup_ConnectedDeploymentGroups:
    locations: Any = None
    name: Any = None
