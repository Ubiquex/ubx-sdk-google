...
class V1beta1NetworksecurityV1beta1SacRealm_PairingKey:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1SacRealm_SymantecOptions:
...
_V1beta1NetworksecurityV1beta1SacRealm_PairingKeyFields = {
    "expire_time": ubx.FieldSpec(wire_name="expire_time"),
    "key": ubx.FieldSpec(wire_name="key"),
}

_V1beta1NetworksecurityV1beta1SacRealm_SymantecOptionsFields = {
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1SacRealmConfig:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1SacRealmAttrs:
    # Output only. Timestamp when the realm was created.
    create_time: Any = None
    # Optional. Optional list of labels applied to the resource.
    labels: Any = None
...
V1beta1NetworksecurityV1beta1SacRealm = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_networksecurity_v1beta1_sac_realm",
    fields={
        ...
        "pairing_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetworksecurityV1beta1SacRealm_PairingKeyFields,
        ),
        ...
        "symantec_options": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetworksecurityV1beta1SacRealm_SymantecOptionsFields,
        ),
