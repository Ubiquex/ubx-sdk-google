...
class NetworksecurityMirroringDeploymentConfig:
...
@dataclasses.dataclass
class NetworksecurityMirroringDeploymentAttrs:
    # Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
    create_time: Any = None
    # Optional. User-provided description of the deployment. Used as additional context for the deployment.
    description: Any = None
...
NetworksecurityMirroringDeployment = ubx.ResourceBinding(
    wire_type="google_networksecurity_networksecurity_mirroring_deployment",
    fields={
