...
class V1beta1NetworksecurityV1beta1MirroringEndpointGroup_Associations:
    name: Any = None
    network: Any = None
    state: Any = None

@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1MirroringEndpointGroup_ConnectedDeploymentGroups_Locations:
    location: Any = None
    state: Any = None

@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1MirroringEndpointGroup_ConnectedDeploymentGroups:
    locations: Any = None
    name: Any = None

_V1beta1NetworksecurityV1beta1MirroringEndpointGroup_AssociationsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "network": ubx.FieldSpec(wire_name="network"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_V1beta1NetworksecurityV1beta1MirroringEndpointGroup_ConnectedDeploymentGroups_LocationsFields = {
    "location": ubx.FieldSpec(wire_name="location"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_V1beta1NetworksecurityV1beta1MirroringEndpointGroup_ConnectedDeploymentGroupsFields = {
    "locations": ubx.FieldSpec(
        wire_name="locations",
        kind="list",
        fields=_V1beta1NetworksecurityV1beta1MirroringEndpointGroup_ConnectedDeploymentGroups_LocationsFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
}

@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1MirroringEndpointGroupConfig:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1MirroringEndpointGroupAttrs:
    # Output only. List of associations to this endpoint group.
    associations: Any = None
    # Output only. List of details about the connected deployment groups to this endpoint group.
    connected_deployment_groups: Any = None
...
V1beta1NetworksecurityV1beta1MirroringEndpointGroup = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_networksecurity_v1beta1_mirroring_endpoint_group",
    fields={
        "associations": ubx.FieldSpec(
            wire_name="associations",
            kind="list",
            fields=_V1beta1NetworksecurityV1beta1MirroringEndpointGroup_AssociationsFields,
        ),
        "connected_deployment_groups": ubx.FieldSpec(
            wire_name="connected_deployment_groups",
            kind="list",
            fields=_V1beta1NetworksecurityV1beta1MirroringEndpointGroup_ConnectedDeploymentGroupsFields,
        ),
