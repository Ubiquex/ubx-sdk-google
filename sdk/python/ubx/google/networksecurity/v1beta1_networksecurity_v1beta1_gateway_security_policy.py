...
class V1beta1NetworksecurityV1beta1GatewaySecurityPolicyConfig:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1GatewaySecurityPolicyAttrs:
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
    # Optional. Free-text description of the resource.
    description: Any = None
...
V1beta1NetworksecurityV1beta1GatewaySecurityPolicy = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_networksecurity_v1beta1_gateway_security_policy",
    fields={
