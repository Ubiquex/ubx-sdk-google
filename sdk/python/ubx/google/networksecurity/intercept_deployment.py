...
class InterceptDeploymentConfig:
...
@dataclasses.dataclass
class InterceptDeploymentAttrs:
...
InterceptDeployment = ubx.ResourceBinding(
    wire_type="google_networksecurity_intercept_deployment",
    fields={
