...
class NetworksecurityMirroringEndpointGroupAssociation_Locations:
    location: Any = None
    state: Any = None

_NetworksecurityMirroringEndpointGroupAssociation_LocationsFields = {
...
@dataclasses.dataclass
class NetworksecurityMirroringEndpointGroupAssociationAttrs:
    # Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
    create_time: Any = None
    # Optional. Labels are key/value pairs that help to organize and filter resources.
    labels: Any = None
...
NetworksecurityMirroringEndpointGroupAssociation = ubx.ResourceBinding(
    wire_type="google_networksecurity_networksecurity_mirroring_endpoint_group_association",
    fields={
        ...
        "locations": ubx.FieldSpec(
            wire_name="locations",
            kind="list",
            fields=_NetworksecurityMirroringEndpointGroupAssociation_LocationsFields,
        ),
