...
_MirroringEndpointGroup_AssociationsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "network": ubx.FieldSpec(wire_name="network"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_MirroringEndpointGroup_ConnectedDeploymentGroups_LocationsFields = {
    "location": ubx.FieldSpec(wire_name="location"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_MirroringEndpointGroup_ConnectedDeploymentGroupsFields = {
    "locations": ubx.FieldSpec(
        wire_name="locations",
        kind="list",
        fields=_MirroringEndpointGroup_ConnectedDeploymentGroups_LocationsFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
}
...
MirroringEndpointGroup = ubx.ResourceBinding(
    ...
    fields={
        "associations": ubx.FieldSpec(
            ...
            kind="list",
            fields=_MirroringEndpointGroup_AssociationsFields,
        ),
        "connected_deployment_groups": ubx.FieldSpec(
            wire_name="connected_deployment_groups",
            kind="list",
            fields=_MirroringEndpointGroup_ConnectedDeploymentGroupsFields,
        ),
