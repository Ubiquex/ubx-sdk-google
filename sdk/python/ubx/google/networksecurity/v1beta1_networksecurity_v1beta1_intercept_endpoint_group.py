...
class V1beta1NetworksecurityV1beta1InterceptEndpointGroup_Associations:
    name: Any = None
    network: Any = None
    state: Any = None

@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1InterceptEndpointGroup_ConnectedDeploymentGroup_Locations:
    location: Any = None
    state: Any = None

@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1InterceptEndpointGroup_ConnectedDeploymentGroup:
...
_V1beta1NetworksecurityV1beta1InterceptEndpointGroup_AssociationsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "network": ubx.FieldSpec(wire_name="network"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_V1beta1NetworksecurityV1beta1InterceptEndpointGroup_ConnectedDeploymentGroup_LocationsFields = {
    "location": ubx.FieldSpec(wire_name="location"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_V1beta1NetworksecurityV1beta1InterceptEndpointGroup_ConnectedDeploymentGroupFields = {
    "locations": ubx.FieldSpec(
        wire_name="locations",
        kind="list",
        fields=_V1beta1NetworksecurityV1beta1InterceptEndpointGroup_ConnectedDeploymentGroup_LocationsFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
}

@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1InterceptEndpointGroupConfig:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1InterceptEndpointGroupAttrs:
    # Output only. List of associations to this endpoint group.
    associations: Any = None
    # The endpoint group's view of a connected deployment group.
    connected_deployment_group: Any = None
...
V1beta1NetworksecurityV1beta1InterceptEndpointGroup = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_networksecurity_v1beta1_intercept_endpoint_group",
    fields={
        "associations": ubx.FieldSpec(
            wire_name="associations",
            kind="list",
            fields=_V1beta1NetworksecurityV1beta1InterceptEndpointGroup_AssociationsFields,
        ),
        "connected_deployment_group": ubx.FieldSpec(
            wire_name="connected_deployment_group",
            kind="object",
            fields=_V1beta1NetworksecurityV1beta1InterceptEndpointGroup_ConnectedDeploymentGroupFields,
        ),
