...
class NetworksecurityTlsInspectionPolicyConfig:
...
@dataclasses.dataclass
class NetworksecurityTlsInspectionPolicyAttrs:
    # Required. A CA pool resource used to issue interception certificates. The CA pool string has a relative resource path following the form "projects/{project}/locations/{location}/caPools/{ca_pool}".
    ca_pool: Any = None
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
...
NetworksecurityTlsInspectionPolicy = ubx.ResourceBinding(
    wire_type="google_networksecurity_networksecurity_tls_inspection_policy",
    fields={
