...
class V1beta1SecurityProfileGroupConfig:
...
@dataclasses.dataclass
class V1beta1SecurityProfileGroupAttrs:
    # Output only. Resource creation timestamp.
    create_time: Any = None
    # Optional. Reference to a SecurityProfile with the CustomIntercept configuration.
    custom_intercept_profile: Any = None
...
V1beta1SecurityProfileGroup = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_security_profile_group",
    fields={
