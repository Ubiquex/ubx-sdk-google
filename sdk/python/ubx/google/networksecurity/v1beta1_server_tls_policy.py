...
class V1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCa_CertificateProviderInstance:
    plugin_instance: Any = None

@dataclasses.dataclass
class V1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCa_GrpcEndpoint:
    target_uri: Any = None

@dataclasses.dataclass
class V1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCa:
    certificate_provider_instance: Any = None
    grpc_endpoint: Any = None

@dataclasses.dataclass
class V1beta1ServerTlsPolicy_MtlsPolicy:
...
_V1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCa_CertificateProviderInstanceFields = {
    "plugin_instance": ubx.FieldSpec(wire_name="plugin_instance"),
}

_V1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCa_GrpcEndpointFields = {
    "target_uri": ubx.FieldSpec(wire_name="target_uri"),
}

_V1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCaFields = {
    "certificate_provider_instance": ubx.FieldSpec(
        wire_name="certificate_provider_instance",
        kind="object",
        fields=_V1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCa_CertificateProviderInstanceFields,
    ),
    "grpc_endpoint": ubx.FieldSpec(
        wire_name="grpc_endpoint",
        kind="object",
        fields=_V1beta1ServerTlsPolicy_MtlsPolicy_ClientValidationCa_GrpcEndpointFields,
    ),
}

_V1beta1ServerTlsPolicy_MtlsPolicyFields = {
...
V1beta1ServerTlsPolicy = ubx.ResourceBinding(
    ...
    fields={
        ...
        "mtls_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1ServerTlsPolicy_MtlsPolicyFields,
        ),
