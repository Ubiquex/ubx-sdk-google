...
class NetworksecurityInterceptEndpointGroupAssociation_Locations:
    location: Any = None
    state: Any = None

_NetworksecurityInterceptEndpointGroupAssociation_LocationsFields = {
...
@dataclasses.dataclass
class NetworksecurityInterceptEndpointGroupAssociationAttrs:
    # Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
    create_time: Any = None
    # Required. Immutable. The endpoint group that this association is connected to, for example: `projects/123456789/locations/global/interceptEndpointGroups/my-eg`. See https://google.aip.dev/124.
    intercept_endpoint_group: Any = None
...
NetworksecurityInterceptEndpointGroupAssociation = ubx.ResourceBinding(
    wire_type="google_networksecurity_networksecurity_intercept_endpoint_group_association",
    fields={
        ...
        "locations": ubx.FieldSpec(
            wire_name="locations",
            kind="list",
            fields=_NetworksecurityInterceptEndpointGroupAssociation_LocationsFields,
        ),
