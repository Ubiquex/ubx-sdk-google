...
class V1beta1NetworksecurityV1beta1DnsThreatDetectorConfig:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1DnsThreatDetectorAttrs:
    # Output only. Create time stamp.
    create_time: Any = None
    # Optional. A list of network resource names which aren't monitored by this DnsThreatDetector. Example: `projects/PROJECT_ID/global/networks/NETWORK_NAME`.
    excluded_networks: Any = None
...
V1beta1NetworksecurityV1beta1DnsThreatDetector = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_networksecurity_v1beta1_dns_threat_detector",
    fields={
