...
class NetworksecuritySecurityProfileGroupConfig:
...
@dataclasses.dataclass
class NetworksecuritySecurityProfileGroupAttrs:
    # Output only. Resource creation timestamp.
    create_time: Any = None
    # Optional. Reference to a SecurityProfile with the CustomIntercept configuration.
    custom_intercept_profile: Any = None
...
NetworksecuritySecurityProfileGroup = ubx.ResourceBinding(
    wire_type="google_networksecurity_networksecurity_security_profile_group",
    fields={
