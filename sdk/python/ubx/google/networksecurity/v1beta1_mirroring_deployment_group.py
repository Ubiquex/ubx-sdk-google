...
class V1beta1MirroringDeploymentGroup_ConnectedEndpointGroups:
    name: Any = None

@dataclasses.dataclass
class V1beta1MirroringDeploymentGroup_Locations:
    location: Any = None
    state: Any = None

@dataclasses.dataclass
class V1beta1MirroringDeploymentGroup_NestedDeployments:
    name: Any = None
    state: Any = None

_V1beta1MirroringDeploymentGroup_ConnectedEndpointGroupsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

_V1beta1MirroringDeploymentGroup_LocationsFields = {
    "location": ubx.FieldSpec(wire_name="location"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_V1beta1MirroringDeploymentGroup_NestedDeploymentsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "state": ubx.FieldSpec(wire_name="state"),
}

@dataclasses.dataclass
class V1beta1MirroringDeploymentGroupConfig:
...
@dataclasses.dataclass
class V1beta1MirroringDeploymentGroupAttrs:
    # Output only. The list of endpoint groups that are connected to this resource.
    connected_endpoint_groups: Any = None
    # Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
    create_time: Any = None
...
V1beta1MirroringDeploymentGroup = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_mirroring_deployment_group",
    fields={
        "connected_endpoint_groups": ubx.FieldSpec(
            wire_name="connected_endpoint_groups",
            kind="list",
            fields=_V1beta1MirroringDeploymentGroup_ConnectedEndpointGroupsFields,
        ),
        ...
        "locations": ubx.FieldSpec(
            wire_name="locations",
            kind="list",
            fields=_V1beta1MirroringDeploymentGroup_LocationsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "nested_deployments": ubx.FieldSpec(
            wire_name="nested_deployments",
            kind="list",
            fields=_V1beta1MirroringDeploymentGroup_NestedDeploymentsFields,
        ),
