...
class V1beta1NetworksecurityV1beta1SacAttachment_SymantecOptions:
...
@dataclasses.dataclass
class V1beta1NetworksecurityV1beta1SacAttachmentAttrs:
    # Optional. Case-insensitive ISO-3166 alpha-2 country code used for localization. Only valid for Symantec attachments.
    country: Any = None
    # Output only. Timestamp when the attachment was created.
    create_time: Any = None
...
V1beta1NetworksecurityV1beta1SacAttachment = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_networksecurity_v1beta1_sac_attachment",
    fields={
        ...
        "symantec_options": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetworksecurityV1beta1SacAttachment_SymantecOptionsFields,
        ),
