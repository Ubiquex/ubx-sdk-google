# Code generated by `ubx sdk gen` from google_networksecurity_v1beta1_mirroring_endpoint_group_association. DO NOT EDIT.
...
class V1beta1MirroringEndpointGroupAssociation_Locations:
    location: Any = None
    state: Any = None

_V1beta1MirroringEndpointGroupAssociation_LocationsFields = {
    "location": ubx.FieldSpec(wire_name="location"),
    "state": ubx.FieldSpec(wire_name="state"),
}

@dataclasses.dataclass
class V1beta1MirroringEndpointGroupAssociationConfig:
...
@dataclasses.dataclass
class V1beta1MirroringEndpointGroupAssociationAttrs:
    # Output only. The timestamp when the resource was created. See https://google.aip.dev/148#timestamps.
    create_time: Any = None
    # Optional. Labels are key/value pairs that help to organize and filter resources.
    labels: Any = None
...
V1beta1MirroringEndpointGroupAssociation = ubx.ResourceBinding(
    wire_type="google_networksecurity_v1beta1_mirroring_endpoint_group_association",
    fields={
        ...
        "locations": ubx.FieldSpec(
            wire_name="locations",
            kind="list",
            fields=_V1beta1MirroringEndpointGroupAssociation_LocationsFields,
        ),
