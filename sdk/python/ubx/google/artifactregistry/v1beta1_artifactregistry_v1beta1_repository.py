...
class V1beta1ArtifactregistryV1beta1RepositoryConfig:
...
@dataclasses.dataclass
class V1beta1ArtifactregistryV1beta1RepositoryAttrs:
    # Output only. The time when the repository was created.
    create_time: Any = None
    # The user-provided description of the repository.
    description: Any = None
...
V1beta1ArtifactregistryV1beta1Repository = ubx.ResourceBinding(
    wire_type="google_artifactregistry_v1beta1_artifactregistry_v1beta1_repository",
    fields={
