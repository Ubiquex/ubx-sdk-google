...
class LustreInstance_AccessRulesOptions_AccessRules:
    ip_address_ranges: Any = None
    name: Any = None
    squash_mode: Any = None

@dataclasses.dataclass
class LustreInstance_AccessRulesOptions:
...
@dataclasses.dataclass
class LustreInstance_DynamicTierOptions:
    # Required. Immutable. The dynamic tier mode of the instance.
    mode: Any = None

@dataclasses.dataclass
class LustreInstance_MaintenancePolicy_MaintenanceExclusionWindow_EndDate:
    day: Any = None
    month: Any = None
    year: Any = None

@dataclasses.dataclass
class LustreInstance_MaintenancePolicy_MaintenanceExclusionWindow_Time:
    hours: Any = None
    minutes: Any = None
    nanos: Any = None
    seconds: Any = None
...
@dataclasses.dataclass
class LustreInstance_MaintenancePolicy_MaintenanceExclusionWindow:
    end_date: Any = None
    start_date: Any = None
    time: Any = None

@dataclasses.dataclass
class LustreInstance_MaintenancePolicy_WeeklyMaintenanceWindows:
    day_of_week: Any = None
    start_time: Any = None

@dataclasses.dataclass
class LustreInstance_MaintenancePolicy:
...
_LustreInstance_DynamicTierOptionsFields = {
    "mode": ubx.FieldSpec(wire_name="mode"),
}

_LustreInstance_MaintenancePolicy_MaintenanceExclusionWindow_EndDateFields = {
    "day": ubx.FieldSpec(wire_name="day"),
    "month": ubx.FieldSpec(wire_name="month"),
    "year": ubx.FieldSpec(wire_name="year"),
}

_LustreInstance_MaintenancePolicy_MaintenanceExclusionWindow_TimeFields = {
...
_LustreInstance_MaintenancePolicy_MaintenanceExclusionWindowFields = {
    "end_date": ubx.FieldSpec(
        wire_name="end_date",
        kind="object",
        fields=_LustreInstance_MaintenancePolicy_MaintenanceExclusionWindow_EndDateFields,
    ),
    ...
    "time": ubx.FieldSpec(
        wire_name="time",
        kind="object",
        fields=_LustreInstance_MaintenancePolicy_MaintenanceExclusionWindow_TimeFields,
    ),
}

_LustreInstance_MaintenancePolicy_WeeklyMaintenanceWindowsFields = {
...
_LustreInstance_MaintenancePolicyFields = {
    "maintenance_exclusion_window": ubx.FieldSpec(
        wire_name="maintenance_exclusion_window",
        kind="list",
        fields=_LustreInstance_MaintenancePolicy_MaintenanceExclusionWindowFields,
    ),
    "weekly_maintenance_windows": ubx.FieldSpec(
        wire_name="weekly_maintenance_windows",
        kind="list",
        fields=_LustreInstance_MaintenancePolicy_WeeklyMaintenanceWindowsFields,
    ),
}

_LustreInstance_UpcomingMaintenanceScheduleFields = {
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

@dataclasses.dataclass
class LustreInstanceConfig:
...
LustreInstance = ubx.ResourceBinding(
    wire_type="google_lustre_lustre_instance",
    fields={
        "access_rules_options": ubx.FieldSpec(
            wire_name="access_rules_options",
            kind="object",
            fields=_LustreInstance_AccessRulesOptionsFields,
        ),
        ...
        "dynamic_tier_options": ubx.FieldSpec(
            ...
            kind="object",
            fields=_LustreInstance_DynamicTierOptionsFields,
        ),
        ...
        "maintenance_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_LustreInstance_MaintenancePolicyFields,
        ),
        ...
        "upcoming_maintenance_schedule": ubx.FieldSpec(
            ...
            kind="object",
            fields=_LustreInstance_UpcomingMaintenanceScheduleFields,
        ),
