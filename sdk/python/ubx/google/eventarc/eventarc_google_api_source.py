...
class EventarcGoogleApiSource_LoggingConfig:
...
@dataclasses.dataclass
class EventarcGoogleApiSource_OrganizationSubscription:
    # Required. Enable org level subscription.
    enabled: Any = None

@dataclasses.dataclass
class EventarcGoogleApiSource_ProjectSubscriptions:
...
_EventarcGoogleApiSource_LoggingConfigFields = {
    "log_severity": ubx.FieldSpec(wire_name="log_severity"),
}

_EventarcGoogleApiSource_OrganizationSubscriptionFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
}

_EventarcGoogleApiSource_ProjectSubscriptionsFields = {
    "list": ubx.FieldSpec(wire_name="list"),
}

@dataclasses.dataclass
class EventarcGoogleApiSourceConfig:
...
@dataclasses.dataclass
class EventarcGoogleApiSourceAttrs:
    # Optional. Resource annotations.
    annotations: Any = None
    # Output only. The creation time.
    create_time: Any = None
...
EventarcGoogleApiSource = ubx.ResourceBinding(
    wire_type="google_eventarc_eventarc_google_api_source",
    fields={
        ...
        "logging_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_EventarcGoogleApiSource_LoggingConfigFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "organization_subscription": ubx.FieldSpec(
            wire_name="organization_subscription",
            kind="object",
            fields=_EventarcGoogleApiSource_OrganizationSubscriptionFields,
        ),
        "project_subscriptions": ubx.FieldSpec(
            wire_name="project_subscriptions",
            kind="object",
            fields=_EventarcGoogleApiSource_ProjectSubscriptionsFields,
        ),
