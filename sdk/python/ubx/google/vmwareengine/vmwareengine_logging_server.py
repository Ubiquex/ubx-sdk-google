...
class VmwareengineLoggingServerConfig:
...
@dataclasses.dataclass
class VmwareengineLoggingServerAttrs:
    # Output only. Creation time of this resource.
    create_time: Any = None
    # Required. Fully-qualified domain name (FQDN) or IP Address of the logging server.
    hostname: Any = None
...
VmwareengineLoggingServer = ubx.ResourceBinding(
    wire_type="google_vmwareengine_vmwareengine_logging_server",
    fields={
