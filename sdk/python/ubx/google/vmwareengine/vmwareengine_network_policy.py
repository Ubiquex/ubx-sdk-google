...
class VmwareengineNetworkPolicy_ExternalIp:
    # True if the service is enabled; false otherwise.
    enabled: Any = None
    # Output only. State of the service. New values may be added to this enum when appropriate.
    state: Any = None

_VmwareengineNetworkPolicy_ExternalIpFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "state": ubx.FieldSpec(wire_name="state"),
}

@dataclasses.dataclass
class VmwareengineNetworkPolicyConfig:
...
@dataclasses.dataclass
class VmwareengineNetworkPolicyAttrs:
    # Output only. Creation time of this resource.
    create_time: Any = None
    # Optional. User-provided description for this network policy.
    description: Any = None
...
VmwareengineNetworkPolicy = ubx.ResourceBinding(
    wire_type="google_vmwareengine_vmwareengine_network_policy",
    fields={
        ...
        "external_ip": ubx.FieldSpec(
            ...
            kind="object",
            fields=_VmwareengineNetworkPolicy_ExternalIpFields,
        ),
