...
class VmwareenginePrivateConnectionConfig:
...
@dataclasses.dataclass
class VmwareenginePrivateConnectionAttrs:
    # Output only. Creation time of this resource.
    create_time: Any = None
    # Optional. User-provided description for this private connection.
    description: Any = None
...
VmwareenginePrivateConnection = ubx.ResourceBinding(
    wire_type="google_vmwareengine_vmwareengine_private_connection",
    fields={
