...
class VmwareengineCluster_AutoscalingSettings_AutoscalingPolicies_ConsumedMemoryThresholds:
    scale_in: Any = None
    scale_out: Any = None

@dataclasses.dataclass
class VmwareengineCluster_AutoscalingSettings_AutoscalingPolicies:
...
@dataclasses.dataclass
class VmwareengineCluster_AutoscalingSettings:
...
@dataclasses.dataclass
class VmwareengineCluster_DatastoreMountConfig_DatastoreNetwork:
...
@dataclasses.dataclass
class VmwareengineCluster_DatastoreMountConfig:
...
@dataclasses.dataclass
class VmwareengineCluster_NodeTypeConfigs:
    custom_core_count: Any = None
    node_count: Any = None

@dataclasses.dataclass
class VmwareengineCluster_StretchedClusterConfig:
...
_VmwareengineCluster_AutoscalingSettings_AutoscalingPolicies_ConsumedMemoryThresholdsFields = {
    "scale_in": ubx.FieldSpec(wire_name="scale_in"),
    "scale_out": ubx.FieldSpec(wire_name="scale_out"),
}

_VmwareengineCluster_AutoscalingSettings_AutoscalingPoliciesFields = {
    "consumed_memory_thresholds": ubx.FieldSpec(
        wire_name="consumed_memory_thresholds",
        kind="object",
        fields=_VmwareengineCluster_AutoscalingSettings_AutoscalingPolicies_ConsumedMemoryThresholdsFields,
    ),
...
_VmwareengineCluster_AutoscalingSettingsFields = {
    "autoscaling_policies": ubx.FieldSpec(
        wire_name="autoscaling_policies",
        kind="map",
        fields=_VmwareengineCluster_AutoscalingSettings_AutoscalingPoliciesFields,
    ),
...
_VmwareengineCluster_DatastoreMountConfig_DatastoreNetworkFields = {
...
_VmwareengineCluster_DatastoreMountConfigFields = {
    ...
    "datastore_network": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmwareengineCluster_DatastoreMountConfig_DatastoreNetworkFields,
    ),
...
@dataclasses.dataclass
class VmwareengineClusterConfig:
...
@dataclasses.dataclass
class VmwareengineClusterAttrs:
    # Autoscaling settings define the rules used by VMware Engine to automatically scale-out and scale-in the clusters in a private cloud.
    autoscaling_settings: Any = None
    # Output only. Creation time of this resource.
    create_time: Any = None
...
VmwareengineCluster = ubx.ResourceBinding(
    wire_type="google_vmwareengine_vmwareengine_cluster",
    fields={
        "autoscaling_settings": ubx.FieldSpec(
            wire_name="autoscaling_settings",
            kind="object",
            fields=_VmwareengineCluster_AutoscalingSettingsFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "datastore_mount_config": ubx.FieldSpec(
            wire_name="datastore_mount_config",
            kind="list",
            fields=_VmwareengineCluster_DatastoreMountConfigFields,
        ),
        ...
        "node_type_configs": ubx.FieldSpec(
            ...
            kind="map",
            fields=_VmwareengineCluster_NodeTypeConfigsFields,
        ),
        "state": ubx.FieldSpec(wire_name="state"),
        "stretched_cluster_config": ubx.FieldSpec(
            wire_name="stretched_cluster_config",
            kind="object",
            fields=_VmwareengineCluster_StretchedClusterConfigFields,
        ),
