...
class VmwareengineExternalAccessRule_DestinationIpRanges:
    external_address: Any = None
    ip_address: Any = None
    ip_address_range: Any = None

_VmwareengineExternalAccessRule_DestinationIpRangesFields = {
...
@dataclasses.dataclass
class VmwareengineExternalAccessRuleConfig:
...
@dataclasses.dataclass
class VmwareengineExternalAccessRuleAttrs:
    # The action that the external access rule performs.
    action: Any = None
    # Output only. Creation time of this resource.
    create_time: Any = None
...
VmwareengineExternalAccessRule = ubx.ResourceBinding(
    wire_type="google_vmwareengine_vmwareengine_external_access_rule",
    fields={
        ...
        "destination_ip_ranges": ubx.FieldSpec(
            ...
            kind="list",
            fields=_VmwareengineExternalAccessRule_DestinationIpRangesFields,
        ),
