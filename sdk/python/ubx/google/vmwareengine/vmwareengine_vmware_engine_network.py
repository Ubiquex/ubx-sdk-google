...
class VmwareengineVmwareEngineNetwork_VpcNetworks:
    network: Any = None
    type: Any = None

_VmwareengineVmwareEngineNetwork_VpcNetworksFields = {
    "network": ubx.FieldSpec(wire_name="network"),
    "type": ubx.FieldSpec(wire_name="type"),
}

@dataclasses.dataclass
class VmwareengineVmwareEngineNetworkConfig:
...
@dataclasses.dataclass
class VmwareengineVmwareEngineNetworkAttrs:
    # Output only. Creation time of this resource.
    create_time: Any = None
    # User-provided description for this VMware Engine network.
    description: Any = None
...
VmwareengineVmwareEngineNetwork = ubx.ResourceBinding(
    wire_type="google_vmwareengine_vmwareengine_vmware_engine_network",
    fields={
        ...
        "vpc_networks": ubx.FieldSpec(
            ...
            kind="list",
            fields=_VmwareengineVmwareEngineNetwork_VpcNetworksFields,
        ),
    },
)
