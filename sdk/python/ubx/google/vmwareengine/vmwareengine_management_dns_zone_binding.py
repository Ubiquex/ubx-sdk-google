...
class VmwareengineManagementDnsZoneBindingConfig:
...
@dataclasses.dataclass
class VmwareengineManagementDnsZoneBindingAttrs:
    # Output only. Creation time of this resource.
    create_time: Any = None
    # User-provided description for this resource.
    description: Any = None
...
VmwareengineManagementDnsZoneBinding = ubx.ResourceBinding(
    wire_type="google_vmwareengine_vmwareengine_management_dns_zone_binding",
    fields={
