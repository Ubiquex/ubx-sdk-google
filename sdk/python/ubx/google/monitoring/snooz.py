...
Snooz = ubx.ResourceBinding(
    wire_type="google_monitoring_snooz",
    fields={
        "criteria": ubx.FieldSpec(
            wire_name="criteria",
            kind="object",
            fields=_Snooz_CriteriaFields,
        ),
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        "interval": ubx.FieldSpec(
            wire_name="interval",
            kind="object",
            fields=_Snooz_IntervalFields,
        ),
