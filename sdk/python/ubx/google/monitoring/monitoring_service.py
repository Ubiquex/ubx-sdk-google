...
class MonitoringService_AppEngine:
    # The ID of the App Engine module underlying this service. Corresponds to the module_id resource label in the gae_app monitored resource (https://cloud.google.com/monitoring/api/resources#tag_gae_app).
    module_id: Any = None

@dataclasses.dataclass
class MonitoringService_BasicService:
...
@dataclasses.dataclass
class MonitoringService_CloudEndpoints:
    # The name of the Cloud Endpoints service underlying this service. Corresponds to the service resource label in the api monitored resource (https://cloud.google.com/monitoring/api/resources#tag_api).
    service: Any = None

@dataclasses.dataclass
class MonitoringService_CloudRun:
...
@dataclasses.dataclass
class MonitoringService_ClusterIstio:
...
@dataclasses.dataclass
class MonitoringService_GkeNamespace:
...
@dataclasses.dataclass
class MonitoringService_GkeService:
    # The name of the parent cluster.
    cluster_name: Any = None
    # The location of the parent cluster. This may be a zone or region.
    location: Any = None
...
@dataclasses.dataclass
class MonitoringService_GkeWorkload:
    # The name of the parent cluster.
    cluster_name: Any = None
    # The location of the parent cluster. This may be a zone or region.
    location: Any = None
...
@dataclasses.dataclass
class MonitoringService_IstioCanonicalService:
...
@dataclasses.dataclass
class MonitoringService_MeshIstio:
...
_MonitoringService_GkeNamespaceFields = {
    "cluster_name": ubx.FieldSpec(wire_name="cluster_name"),
    "location": ubx.FieldSpec(wire_name="location"),
...
_MonitoringService_GkeServiceFields = {
    "cluster_name": ubx.FieldSpec(wire_name="cluster_name"),
    "location": ubx.FieldSpec(wire_name="location"),
    "namespace_name": ubx.FieldSpec(wire_name="namespace_name"),
    "project_id": ubx.FieldSpec(wire_name="project_id"),
...
_MonitoringService_GkeWorkloadFields = {
    "cluster_name": ubx.FieldSpec(wire_name="cluster_name"),
    "location": ubx.FieldSpec(wire_name="location"),
    "namespace_name": ubx.FieldSpec(wire_name="namespace_name"),
    "project_id": ubx.FieldSpec(wire_name="project_id"),
...
_MonitoringService_IstioCanonicalServiceFields = {
...
_MonitoringService_MeshIstioFields = {
    "mesh_uid": ubx.FieldSpec(wire_name="mesh_uid"),
    "service_name": ubx.FieldSpec(wire_name="service_name"),
    "service_namespace": ubx.FieldSpec(wire_name="service_namespace"),
}

_MonitoringService_TelemetryFields = {
...
MonitoringService = ubx.ResourceBinding(
    wire_type="google_monitoring_monitoring_service",
    fields={
        "app_engine": ubx.FieldSpec(
            wire_name="app_engine",
            kind="object",
            fields=_MonitoringService_AppEngineFields,
        ),
        "basic_service": ubx.FieldSpec(
            wire_name="basic_service",
            kind="object",
            fields=_MonitoringService_BasicServiceFields,
        ),
        "cloud_endpoints": ubx.FieldSpec(
            wire_name="cloud_endpoints",
            kind="object",
            fields=_MonitoringService_CloudEndpointsFields,
        ),
        "cloud_run": ubx.FieldSpec(
            wire_name="cloud_run",
            kind="object",
            fields=_MonitoringService_CloudRunFields,
        ),
        "cluster_istio": ubx.FieldSpec(
            wire_name="cluster_istio",
            kind="object",
            fields=_MonitoringService_ClusterIstioFields,
        ),
        ...
        "gke_namespace": ubx.FieldSpec(
            ...
            kind="object",
            fields=_MonitoringService_GkeNamespaceFields,
        ),
        "gke_service": ubx.FieldSpec(
            wire_name="gke_service",
            kind="object",
            fields=_MonitoringService_GkeServiceFields,
        ),
        "gke_workload": ubx.FieldSpec(
            wire_name="gke_workload",
            kind="object",
            fields=_MonitoringService_GkeWorkloadFields,
        ),
        "istio_canonical_service": ubx.FieldSpec(
            wire_name="istio_canonical_service",
            kind="object",
            fields=_MonitoringService_IstioCanonicalServiceFields,
        ),
        "mesh_istio": ubx.FieldSpec(
            wire_name="mesh_istio",
            kind="object",
            fields=_MonitoringService_MeshIstioFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "telemetry": ubx.FieldSpec(
            wire_name="telemetry",
            kind="object",
            fields=_MonitoringService_TelemetryFields,
        ),
