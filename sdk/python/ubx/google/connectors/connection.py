...
@dataclasses.dataclass
class Connection_AuthConfig_Oauth2AuthCodeFlow:
...
@dataclasses.dataclass
class Connection_AuthConfig_Oauth2AuthCodeFlowGoogleManaged:
    # Optional. Authorization code to be exchanged for access and refresh tokens.
    auth_code: Any = None
    # Optional. Redirect URI to be provided during the auth code exchange.
    redirect_uri: Any = None
...
@dataclasses.dataclass
class Connection_AuthConfig_Oauth2ClientCredentials:
...
@dataclasses.dataclass
class Connection_AuthConfig_Oauth2JwtBearer_JwtClaims:
...
@dataclasses.dataclass
class Connection_AuthConfig_Oauth2JwtBearer:
    # Secret provides a reference to entries in Secret Manager.
    client_key: Any = None
...
@dataclasses.dataclass
class Connection_AuthConfig_SshPublicKey:
...
@dataclasses.dataclass
class Connection_AuthConfig_UserPassword:
    # Secret provides a reference to entries in Secret Manager.
    password: Any = None
    # Optional. Username.
    username: Any = None
...
@dataclasses.dataclass
class Connection_BillingConfig:
    # Output only. Billing category for the connector.
    billing_category: Any = None

@dataclasses.dataclass
class Connection_ConnectorVersionInfraConfig_HpaConfig:
...
@dataclasses.dataclass
class Connection_ConnectorVersionInfraConfig_ResourceLimits:
...
@dataclasses.dataclass
class Connection_ConnectorVersionInfraConfig:
...
@dataclasses.dataclass
class Connection_EventingConfig_DeadLetterConfig:
...
@dataclasses.dataclass
class Connection_EventingConfig_EnrichmentConfig:
    # Optional. Append ACL to the event.
    append_acl: Any = None

@dataclasses.dataclass
class Connection_EventingConfig_SslConfig:
...
@dataclasses.dataclass
class Connection_EventingConfig:
...
@dataclasses.dataclass
class Connection_EventingRuntimeData_Status:
...
@dataclasses.dataclass
class Connection_EventingRuntimeData_WebhookData:
...
@dataclasses.dataclass
class Connection_EventingRuntimeData_WebhookSubscriptions:
    # Output only. Webhook data.
    webhook_data: Any = None

@dataclasses.dataclass
class Connection_EventingRuntimeData:
...
_Connection_AdminFiltersFields = {
    ...
    "string_list_values": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Connection_AdminFilters_StringListValuesFields,
    ),
    "string_value": ubx.FieldSpec(wire_name="string_value"),
}

_Connection_AuthConfig_AdditionalVariables_EncryptionKeyValueFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_Connection_AuthConfig_AdditionalVariables_SecretValueFields = {
    "secret_version": ubx.FieldSpec(wire_name="secret_version"),
}

_Connection_AuthConfig_AdditionalVariablesFields = {
    "bool_value": ubx.FieldSpec(wire_name="bool_value"),
    "encryption_key_value": ubx.FieldSpec(
        wire_name="encryption_key_value",
        kind="object",
        fields=_Connection_AuthConfig_AdditionalVariables_EncryptionKeyValueFields,
    ),
    "int_value": ubx.FieldSpec(wire_name="int_value"),
    ...
    "secret_value": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Connection_AuthConfig_AdditionalVariables_SecretValueFields,
    ),
    "string_value": ubx.FieldSpec(wire_name="string_value"),
}

_Connection_AuthConfig_Oauth2AuthCodeFlowFields = {
...
_Connection_AuthConfig_Oauth2AuthCodeFlowGoogleManagedFields = {
    "auth_code": ubx.FieldSpec(wire_name="auth_code"),
    "redirect_uri": ubx.FieldSpec(wire_name="redirect_uri"),
    "scopes": ubx.FieldSpec(wire_name="scopes"),
}

_Connection_AuthConfig_Oauth2ClientCredentialsFields = {
    "client_id": ubx.FieldSpec(wire_name="client_id"),
    "client_secret": ubx.FieldSpec(
        wire_name="client_secret",
        kind="object",
...
_Connection_AuthConfig_Oauth2JwtBearerFields = {
    ...
    "jwt_claims": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Connection_AuthConfig_Oauth2JwtBearer_JwtClaimsFields,
    ),
}

_Connection_AuthConfig_SshPublicKeyFields = {
...
_Connection_AuthConfig_UserPasswordFields = {
...
_Connection_AuthConfigFields = {
    ...
    "oauth2_auth_code_flow": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Connection_AuthConfig_Oauth2AuthCodeFlowFields,
    ),
    "oauth2_auth_code_flow_google_managed": ubx.FieldSpec(
        wire_name="oauth2_auth_code_flow_google_managed",
        kind="object",
        fields=_Connection_AuthConfig_Oauth2AuthCodeFlowGoogleManagedFields,
    ),
    "oauth2_client_credentials": ubx.FieldSpec(
        wire_name="oauth2_client_credentials",
        kind="object",
        fields=_Connection_AuthConfig_Oauth2ClientCredentialsFields,
    ),
    "oauth2_jwt_bearer": ubx.FieldSpec(
        wire_name="oauth2_jwt_bearer",
        kind="object",
        fields=_Connection_AuthConfig_Oauth2JwtBearerFields,
    ),
    "ssh_public_key": ubx.FieldSpec(
        wire_name="ssh_public_key",
        kind="object",
        fields=_Connection_AuthConfig_SshPublicKeyFields,
    ),
    "user_password": ubx.FieldSpec(
        wire_name="user_password",
        kind="object",
        fields=_Connection_AuthConfig_UserPasswordFields,
    ),
}

_Connection_BillingConfigFields = {
    "billing_category": ubx.FieldSpec(wire_name="billing_category"),
}

_Connection_ConnectorVersionInfraConfig_HpaConfigFields = {
...
_Connection_ConnectorVersionInfraConfig_ResourceLimitsFields = {
    "cpu": ubx.FieldSpec(wire_name="cpu"),
    "memory": ubx.FieldSpec(wire_name="memory"),
}

_Connection_ConnectorVersionInfraConfigFields = {
    ...
    "hpa_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Connection_ConnectorVersionInfraConfig_HpaConfigFields,
    ),
    ...
    "resource_limits": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Connection_ConnectorVersionInfraConfig_ResourceLimitsFields,
    ),
...
_Connection_DestinationConfigs_DestinationsFields = {
...
_Connection_DestinationConfigsFields = {
    "destinations": ubx.FieldSpec(
        wire_name="destinations",
        kind="list",
        fields=_Connection_DestinationConfigs_DestinationsFields,
    ),
    "key": ubx.FieldSpec(wire_name="key"),
}

_Connection_EventingConfig_DeadLetterConfigFields = {
    "project_id": ubx.FieldSpec(wire_name="project_id"),
    "topic": ubx.FieldSpec(wire_name="topic"),
}

_Connection_EventingConfig_EnrichmentConfigFields = {
    "append_acl": ubx.FieldSpec(wire_name="append_acl"),
}

_Connection_EventingConfig_SslConfigFields = {
    "additional_variables": ubx.FieldSpec(
        wire_name="additional_variables",
        kind="list",
        fields=_Connection_AuthConfig_AdditionalVariablesFields,
...
_Connection_EventingConfigFields = {
    "additional_variables": ubx.FieldSpec(
        wire_name="additional_variables",
        kind="list",
        fields=_Connection_AuthConfig_AdditionalVariablesFields,
    ...
    "auth_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Connection_AuthConfigFields,
    ),
    "dead_letter_config": ubx.FieldSpec(
        wire_name="dead_letter_config",
        kind="object",
        fields=_Connection_EventingConfig_DeadLetterConfigFields,
    ),
    "enrichment_config": ubx.FieldSpec(
        wire_name="enrichment_config",
        kind="object",
        fields=_Connection_EventingConfig_EnrichmentConfigFields,
    ),
    ...
    "ssl_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Connection_EventingConfig_SslConfigFields,
    ),
}

_Connection_EventingRuntimeData_StatusFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_Connection_EventingRuntimeData_WebhookDataFields = {
    "additional_variables": ubx.FieldSpec(
        wire_name="additional_variables",
        kind="list",
        fields=_Connection_AuthConfig_AdditionalVariablesFields,
...
_Connection_EventingRuntimeData_WebhookSubscriptionsFields = {
    "webhook_data": ubx.FieldSpec(
        wire_name="webhook_data",
        kind="list",
        fields=_Connection_EventingRuntimeData_WebhookDataFields,
    ),
}

_Connection_EventingRuntimeDataFields = {
    ...
    "status": ubx.FieldSpec(
        wire_name="status",
        kind="object",
        fields=_Connection_EventingRuntimeData_StatusFields,
    ),
    "webhook_data": ubx.FieldSpec(
        wire_name="webhook_data",
        kind="object",
...
Connection = ubx.ResourceBinding(
    wire_type="google_connectors_connection",
    fields={
        "admin_filters": ubx.FieldSpec(
            wire_name="admin_filters",
            kind="list",
            fields=_Connection_AdminFiltersFields,
        ),
        ...
        "billing_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Connection_BillingConfigFields,
        ),
        ...
        "eventing_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Connection_EventingConfigFields,
        ),
        ...
        "lock_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Connection_LockConfigFields,
        ),
