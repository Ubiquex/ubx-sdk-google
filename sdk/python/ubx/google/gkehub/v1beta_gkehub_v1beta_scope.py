...
class V1betaGkehubV1betaScope_State:
    # Output only. The current state of the scope resource.
    code: Any = None

_V1betaGkehubV1betaScope_StateFields = {
    "code": ubx.FieldSpec(wire_name="code"),
}

@dataclasses.dataclass
class V1betaGkehubV1betaScopeConfig:
...
@dataclasses.dataclass
class V1betaGkehubV1betaScopeAttrs:
    # Output only. When the scope was created.
    create_time: Any = None
    # Output only. When the scope was deleted.
    delete_time: Any = None
...
V1betaGkehubV1betaScope = ubx.ResourceBinding(
    wire_type="google_gkehub_v1beta_gkehub_v1beta_scope",
    fields={
        ...
        "state": ubx.FieldSpec(
            wire_name="state",
            kind="object",
            fields=_V1betaGkehubV1betaScope_StateFields,
        ),
