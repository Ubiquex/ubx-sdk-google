...
class V1beta1Membership_Authority:
...
@dataclasses.dataclass
class V1beta1Membership_Endpoint_ApplianceCluster:
...
@dataclasses.dataclass
class V1beta1Membership_Endpoint_GkeCluster:
...
@dataclasses.dataclass
class V1beta1Membership_Endpoint_KubernetesMetadata:
...
@dataclasses.dataclass
class V1beta1Membership_Endpoint_KubernetesResource_ConnectResources:
    cluster_scoped: Any = None
    manifest: Any = None

@dataclasses.dataclass
class V1beta1Membership_Endpoint_KubernetesResource_ResourceOptions:
...
@dataclasses.dataclass
class V1beta1Membership_Endpoint_KubernetesResource:
...
@dataclasses.dataclass
class V1beta1Membership_Endpoint_OnPremCluster:
...
@dataclasses.dataclass
class V1beta1Membership_Endpoint:
...
@dataclasses.dataclass
class V1beta1Membership_MonitoringConfig:
...
_V1beta1Membership_AuthorityFields = {
...
_V1beta1Membership_Endpoint_ApplianceClusterFields = {
    "resource_link": ubx.FieldSpec(wire_name="resource_link"),
}

_V1beta1Membership_Endpoint_GkeClusterFields = {
    "cluster_missing": ubx.FieldSpec(wire_name="cluster_missing"),
    "resource_link": ubx.FieldSpec(wire_name="resource_link"),
}

_V1beta1Membership_Endpoint_KubernetesMetadataFields = {
...
_V1beta1Membership_Endpoint_KubernetesResource_ConnectResourcesFields = {
    "cluster_scoped": ubx.FieldSpec(wire_name="cluster_scoped"),
    "manifest": ubx.FieldSpec(wire_name="manifest"),
}

_V1beta1Membership_Endpoint_KubernetesResource_ResourceOptionsFields = {
...
_V1beta1Membership_Endpoint_KubernetesResourceFields = {
    "connect_resources": ubx.FieldSpec(
        wire_name="connect_resources",
        kind="list",
        fields=_V1beta1Membership_Endpoint_KubernetesResource_ConnectResourcesFields,
    ),
    ...
    "resource_options": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1Membership_Endpoint_KubernetesResource_ResourceOptionsFields,
    ),
}

_V1beta1Membership_Endpoint_OnPremClusterFields = {
...
_V1beta1Membership_EndpointFields = {
    "appliance_cluster": ubx.FieldSpec(
        wire_name="appliance_cluster",
        kind="object",
        fields=_V1beta1Membership_Endpoint_ApplianceClusterFields,
    ),
    ...
    "gke_cluster": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1Membership_Endpoint_GkeClusterFields,
    ),
    "kubernetes_metadata": ubx.FieldSpec(
        wire_name="kubernetes_metadata",
        kind="object",
        fields=_V1beta1Membership_Endpoint_KubernetesMetadataFields,
    ),
    "kubernetes_resource": ubx.FieldSpec(
        wire_name="kubernetes_resource",
        kind="object",
        fields=_V1beta1Membership_Endpoint_KubernetesResourceFields,
    ),
    ...
    "on_prem_cluster": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1Membership_Endpoint_OnPremClusterFields,
    ),
}

_V1beta1Membership_MonitoringConfigFields = {
...
_V1beta1Membership_StateFields = {
...
V1beta1Membership = ubx.ResourceBinding(
    wire_type="google_gkehub_v1beta1_membership",
    fields={
        "authority": ubx.FieldSpec(
            wire_name="authority",
            kind="object",
            fields=_V1beta1Membership_AuthorityFields,
        ),
        ...
        "endpoint": ubx.FieldSpec(
            wire_name="endpoint",
            kind="object",
            fields=_V1beta1Membership_EndpointFields,
        ),
        ...
        "monitoring_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1Membership_MonitoringConfigFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "state": ubx.FieldSpec(
            wire_name="state",
            kind="object",
            fields=_V1beta1Membership_StateFields,
        ),
