...
class V1alphaGkehubV1alphaScope_State:
    # Output only. The current state of the scope resource.
    code: Any = None

_V1alphaGkehubV1alphaScope_StateFields = {
    "code": ubx.FieldSpec(wire_name="code"),
}

@dataclasses.dataclass
class V1alphaGkehubV1alphaScopeConfig:
...
@dataclasses.dataclass
class V1alphaGkehubV1alphaScopeAttrs:
    # Output only. When the scope was created.
    create_time: Any = None
    # Output only. When the scope was deleted.
    delete_time: Any = None
...
V1alphaGkehubV1alphaScope = ubx.ResourceBinding(
    wire_type="google_gkehub_v1alpha_gkehub_v1alpha_scope",
    fields={
        ...
        "state": ubx.FieldSpec(
            wire_name="state",
            kind="object",
            fields=_V1alphaGkehubV1alphaScope_StateFields,
        ),
