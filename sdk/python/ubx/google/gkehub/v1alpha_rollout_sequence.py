...
class V1alphaRolloutSequence_AutoUpgradeConfig_RolloutCreationScope:
    # Optional. The list of enabled upgrade types.
    upgrade_types: Any = None

@dataclasses.dataclass
class V1alphaRolloutSequence_AutoUpgradeConfig:
...
@dataclasses.dataclass
class V1alphaRolloutSequence_Stages:
    cluster_selector: Any = None
    fleet_projects: Any = None
    soak_duration: Any = None

_V1alphaRolloutSequence_AutoUpgradeConfig_RolloutCreationScopeFields = {
    "upgrade_types": ubx.FieldSpec(wire_name="upgrade_types"),
}

_V1alphaRolloutSequence_AutoUpgradeConfigFields = {
    ...
    "rollout_creation_scope": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1alphaRolloutSequence_AutoUpgradeConfig_RolloutCreationScopeFields,
    ),
}

_V1alphaRolloutSequence_IgnoredClustersSelectorFields = {
    "label_selector": ubx.FieldSpec(wire_name="label_selector"),
}

_V1alphaRolloutSequence_OperationalStateFields = {
    "reasons": ubx.FieldSpec(wire_name="reasons"),
    "state": ubx.FieldSpec(wire_name="state"),
    "state_change_time": ubx.FieldSpec(wire_name="state_change_time"),
}

_V1alphaRolloutSequence_StagesFields = {
...
V1alphaRolloutSequence = ubx.ResourceBinding(
    wire_type="google_gkehub_v1alpha_rollout_sequence",
    fields={
        ...
        "operational_state": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1alphaRolloutSequence_OperationalStateFields,
        ),
