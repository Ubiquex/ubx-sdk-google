...
class V1betaGkehubV1betaNamespace_State:
    # Output only. The current state of the Namespace resource.
    code: Any = None

_V1betaGkehubV1betaNamespace_StateFields = {
    "code": ubx.FieldSpec(wire_name="code"),
}

@dataclasses.dataclass
class V1betaGkehubV1betaNamespaceConfig:
...
@dataclasses.dataclass
class V1betaGkehubV1betaNamespaceAttrs:
    # Output only. When the namespace was created.
    create_time: Any = None
    # Output only. When the namespace was deleted.
    delete_time: Any = None
...
V1betaGkehubV1betaNamespace = ubx.ResourceBinding(
    wire_type="google_gkehub_v1beta_gkehub_v1beta_namespace",
    fields={
        ...
        "state": ubx.FieldSpec(
            wire_name="state",
            kind="object",
            fields=_V1betaGkehubV1betaNamespace_StateFields,
        ),
