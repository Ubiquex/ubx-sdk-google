...
class V1betaScope_State:
    # Output only. The current state of the scope resource.
    code: Any = None

_V1betaScope_StateFields = {
    "code": ubx.FieldSpec(wire_name="code"),
}

@dataclasses.dataclass
class V1betaScopeConfig:
...
V1betaScope = ubx.ResourceBinding(
    wire_type="google_gkehub_v1beta_scope",
    fields={
        ...
        "state": ubx.FieldSpec(
            wire_name="state",
            kind="object",
            fields=_V1betaScope_StateFields,
        ),
    },
)
