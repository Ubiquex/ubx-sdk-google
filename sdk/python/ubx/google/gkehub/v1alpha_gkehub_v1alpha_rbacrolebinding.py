...
class V1alphaGkehubV1alphaRbacrolebinding_Role:
...
@dataclasses.dataclass
class V1alphaGkehubV1alphaRbacrolebindingAttrs:
    # Output only. When the rbacrolebinding was created.
    create_time: Any = None
    # Output only. When the rbacrolebinding was deleted.
    delete_time: Any = None
...
V1alphaGkehubV1alphaRbacrolebinding = ubx.ResourceBinding(
    wire_type="google_gkehub_v1alpha_gkehub_v1alpha_rbacrolebinding",
    fields={
        ...
        "role": ubx.FieldSpec(
            wire_name="role",
            kind="object",
            fields=_V1alphaGkehubV1alphaRbacrolebinding_RoleFields,
        ),
        "state": ubx.FieldSpec(
            wire_name="state",
            kind="object",
            fields=_V1alphaGkehubV1alphaRbacrolebinding_StateFields,
        ),
