...
class V1alphaGkehubV1alphaRolloutSequence_AutoUpgradeConfig_RolloutCreationScope:
    # Optional. The list of enabled upgrade types.
    upgrade_types: Any = None

@dataclasses.dataclass
class V1alphaGkehubV1alphaRolloutSequence_AutoUpgradeConfig:
...
@dataclasses.dataclass
class V1alphaGkehubV1alphaRolloutSequence_IgnoredClustersSelector:
    # Required. A valid CEL (Common Expression Language) expression which evaluates `resource.labels`.
    label_selector: Any = None

@dataclasses.dataclass
class V1alphaGkehubV1alphaRolloutSequence_OperationalState:
...
@dataclasses.dataclass
class V1alphaGkehubV1alphaRolloutSequence_Stages:
    cluster_selector: Any = None
    fleet_projects: Any = None
    soak_duration: Any = None

_V1alphaGkehubV1alphaRolloutSequence_AutoUpgradeConfig_RolloutCreationScopeFields = {
    "upgrade_types": ubx.FieldSpec(wire_name="upgrade_types"),
}

_V1alphaGkehubV1alphaRolloutSequence_AutoUpgradeConfigFields = {
    ...
    "rollout_creation_scope": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1alphaGkehubV1alphaRolloutSequence_AutoUpgradeConfig_RolloutCreationScopeFields,
    ),
}

_V1alphaGkehubV1alphaRolloutSequence_IgnoredClustersSelectorFields = {
    "label_selector": ubx.FieldSpec(wire_name="label_selector"),
}

_V1alphaGkehubV1alphaRolloutSequence_OperationalStateFields = {
    "reasons": ubx.FieldSpec(wire_name="reasons"),
    "state": ubx.FieldSpec(wire_name="state"),
    "state_change_time": ubx.FieldSpec(wire_name="state_change_time"),
}

_V1alphaGkehubV1alphaRolloutSequence_StagesFields = {
    "cluster_selector": ubx.FieldSpec(
        wire_name="cluster_selector",
        kind="object",
        fields=_V1alphaGkehubV1alphaRolloutSequence_IgnoredClustersSelectorFields,
    ),
...
@dataclasses.dataclass
class V1alphaGkehubV1alphaRolloutSequenceConfig:
...
@dataclasses.dataclass
class V1alphaGkehubV1alphaRolloutSequenceAttrs:
    # Configuration for automatic upgrades.
    auto_upgrade_config: Any = None
    # Output only. The computed release channel used for the Rollout Sequence.
    computed_release_channel: Any = None
...
V1alphaGkehubV1alphaRolloutSequence = ubx.ResourceBinding(
    wire_type="google_gkehub_v1alpha_gkehub_v1alpha_rollout_sequence",
    fields={
        "auto_upgrade_config": ubx.FieldSpec(
            wire_name="auto_upgrade_config",
            kind="object",
            fields=_V1alphaGkehubV1alphaRolloutSequence_AutoUpgradeConfigFields,
        ),
        ...
        "operational_state": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1alphaGkehubV1alphaRolloutSequence_OperationalStateFields,
        ),
        "stages": ubx.FieldSpec(
            wire_name="stages",
            kind="list",
            fields=_V1alphaGkehubV1alphaRolloutSequence_StagesFields,
        ),
