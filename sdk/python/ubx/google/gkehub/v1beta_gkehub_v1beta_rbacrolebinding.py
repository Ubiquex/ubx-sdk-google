...
class V1betaGkehubV1betaRbacrolebinding_Role:
...
@dataclasses.dataclass
class V1betaGkehubV1betaRbacrolebindingAttrs:
    # Output only. When the rbacrolebinding was created.
    create_time: Any = None
    # Output only. When the rbacrolebinding was deleted.
    delete_time: Any = None
...
V1betaGkehubV1betaRbacrolebinding = ubx.ResourceBinding(
    wire_type="google_gkehub_v1beta_gkehub_v1beta_rbacrolebinding",
    fields={
        ...
        "role": ubx.FieldSpec(
            wire_name="role",
            kind="object",
            fields=_V1betaGkehubV1betaRbacrolebinding_RoleFields,
        ),
        "state": ubx.FieldSpec(
            wire_name="state",
            kind="object",
            fields=_V1betaGkehubV1betaRbacrolebinding_StateFields,
        ),
