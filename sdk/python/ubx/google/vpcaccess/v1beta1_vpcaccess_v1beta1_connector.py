...
class V1beta1VpcaccessV1beta1Connector_Subnet:
...
_V1beta1VpcaccessV1beta1Connector_SubnetFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "project_id": ubx.FieldSpec(wire_name="project_id"),
}

@dataclasses.dataclass
class V1beta1VpcaccessV1beta1ConnectorConfig:
...
@dataclasses.dataclass
class V1beta1VpcaccessV1beta1ConnectorAttrs:
    # Output only. List of projects using the connector.
    connected_projects: Any = None
    # Output only. The creation time of the connector.
    create_time: Any = None
...
V1beta1VpcaccessV1beta1Connector = ubx.ResourceBinding(
    wire_type="google_vpcaccess_v1beta1_vpcaccess_v1beta1_connector",
    fields={
        ...
        "subnet": ubx.FieldSpec(
            wire_name="subnet",
            kind="object",
            fields=_V1beta1VpcaccessV1beta1Connector_SubnetFields,
        ),
    },
)
