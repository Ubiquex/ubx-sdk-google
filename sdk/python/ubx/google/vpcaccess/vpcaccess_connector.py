...
class VpcaccessConnector_Subnet:
...
_VpcaccessConnector_SubnetFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "project_id": ubx.FieldSpec(wire_name="project_id"),
}

@dataclasses.dataclass
class VpcaccessConnectorConfig:
...
VpcaccessConnector = ubx.ResourceBinding(
    wire_type="google_vpcaccess_vpcaccess_connector",
    fields={
        ...
        "subnet": ubx.FieldSpec(
            wire_name="subnet",
            kind="object",
            fields=_VpcaccessConnector_SubnetFields,
        ),
    },
)
