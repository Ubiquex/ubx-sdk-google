...
class CertificatemanagerDnsAuthorization_DnsResourceRecord:
...
_CertificatemanagerDnsAuthorization_DnsResourceRecordFields = {
...
@dataclasses.dataclass
class CertificatemanagerDnsAuthorizationConfig:
...
@dataclasses.dataclass
class CertificatemanagerDnsAuthorizationAttrs:
    # Output only. The creation timestamp of a DnsAuthorization.
    create_time: Any = None
    # Optional. One or more paragraphs of text description of a DnsAuthorization.
    description: Any = None
...
CertificatemanagerDnsAuthorization = ubx.ResourceBinding(
    wire_type="google_certificatemanager_certificatemanager_dns_authorization",
    fields={
        ...
        "dns_resource_record": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CertificatemanagerDnsAuthorization_DnsResourceRecordFields,
        ),
