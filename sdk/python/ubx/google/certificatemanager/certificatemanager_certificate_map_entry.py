...
@dataclasses.dataclass
class CertificatemanagerCertificateMapEntryAttrs:
    # Optional. A set of Certificates defines for the given `hostname`. There can be defined up to four certificates in each Certificate Map Entry. Each certificate must match pattern `projects/*/locations/*/certificates/*`.
    certificates: Any = None
    # Output only. The creation timestamp of a Certificate Map Entry.
    create_time: Any = None
...
CertificatemanagerCertificateMapEntry = ubx.ResourceBinding(
    wire_type="google_certificatemanager_certificatemanager_certificate_map_entry",
    fields={
