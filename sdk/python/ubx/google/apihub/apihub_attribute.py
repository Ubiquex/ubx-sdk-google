...
class ApihubAttribute_AllowedValues:
    description: Any = None
    display_name: Any = None
    id: Any = None
    immutable: Any = None

_ApihubAttribute_AllowedValuesFields = {
...
ApihubAttribute = ubx.ResourceBinding(
    wire_type="google_apihub_apihub_attribute",
    fields={
        "allowed_values": ubx.FieldSpec(
            wire_name="allowed_values",
            kind="list",
            fields=_ApihubAttribute_AllowedValuesFields,
        ),
