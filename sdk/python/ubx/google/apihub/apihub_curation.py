...
class ApihubCuration_Endpoint_ApplicationIntegrationEndpointDetails:
...
@dataclasses.dataclass
class ApihubCuration_PluginInstanceActions:
    action_id: Any = None
    plugin_instance: Any = None

_ApihubCuration_Endpoint_ApplicationIntegrationEndpointDetailsFields = {
    "trigger_id": ubx.FieldSpec(wire_name="trigger_id"),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_ApihubCuration_EndpointFields = {
    "application_integration_endpoint_details": ubx.FieldSpec(
        wire_name="application_integration_endpoint_details",
        kind="object",
        fields=_ApihubCuration_Endpoint_ApplicationIntegrationEndpointDetailsFields,
    ),
}

_ApihubCuration_PluginInstanceActionsFields = {
    "action_id": ubx.FieldSpec(wire_name="action_id"),
    "plugin_instance": ubx.FieldSpec(wire_name="plugin_instance"),
}

@dataclasses.dataclass
class ApihubCurationConfig:
...
ApihubCuration = ubx.ResourceBinding(
    wire_type="google_apihub_apihub_curation",
    fields={
        ...
        "endpoint": ubx.FieldSpec(
            wire_name="endpoint",
            kind="object",
            fields=_ApihubCuration_EndpointFields,
        ),
        ...
        "plugin_instance_actions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ApihubCuration_PluginInstanceActionsFields,
        ),
