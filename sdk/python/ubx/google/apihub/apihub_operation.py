...
class ApihubOperation_Attributes_EnumValues_Values:
...
@dataclasses.dataclass
class ApihubOperation_Attributes_EnumValues:
    values: Any = None

@dataclasses.dataclass
class ApihubOperation_Attributes_JsonValues:
    values: Any = None

@dataclasses.dataclass
class ApihubOperation_Attributes:
    attribute: Any = None
...
@dataclasses.dataclass
class ApihubOperation_Details_Documentation:
    # Optional. The uri of the externally hosted documentation.
    external_uri: Any = None

@dataclasses.dataclass
class ApihubOperation_Details_HttpOperation_Path:
...
@dataclasses.dataclass
class ApihubOperation_Details_HttpOperation:
...
@dataclasses.dataclass
class ApihubOperation_Details_McpTool_Annotations:
...
@dataclasses.dataclass
class ApihubOperation_SourceMetadata_PluginInstanceActionSource:
    action_id: Any = None
    plugin_instance: Any = None

@dataclasses.dataclass
class ApihubOperation_SourceMetadata:
...
_ApihubOperation_Attributes_EnumValues_ValuesFields = {
...
_ApihubOperation_Attributes_EnumValuesFields = {
    "values": ubx.FieldSpec(
        wire_name="values",
        kind="list",
        fields=_ApihubOperation_Attributes_EnumValues_ValuesFields,
    ),
}

_ApihubOperation_Attributes_JsonValuesFields = {
    "values": ubx.FieldSpec(wire_name="values"),
}

_ApihubOperation_AttributesFields = {
    "attribute": ubx.FieldSpec(wire_name="attribute"),
    "enum_values": ubx.FieldSpec(
        wire_name="enum_values",
        kind="object",
        fields=_ApihubOperation_Attributes_EnumValuesFields,
    ),
    "json_values": ubx.FieldSpec(
        wire_name="json_values",
        kind="object",
        fields=_ApihubOperation_Attributes_JsonValuesFields,
    ),
...
_ApihubOperation_Details_DocumentationFields = {
    "external_uri": ubx.FieldSpec(wire_name="external_uri"),
}

_ApihubOperation_Details_HttpOperation_PathFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "path": ubx.FieldSpec(wire_name="path"),
}

_ApihubOperation_Details_HttpOperationFields = {
    "method": ubx.FieldSpec(wire_name="method"),
    "path": ubx.FieldSpec(
        wire_name="path",
        kind="object",
        fields=_ApihubOperation_Details_HttpOperation_PathFields,
    ),
}

_ApihubOperation_Details_McpTool_AnnotationsFields = {
...
_ApihubOperation_Details_McpTool_InputSchemaFields = {
    "json_schema": ubx.FieldSpec(wire_name="json_schema"),
}

_ApihubOperation_Details_McpToolFields = {
    "annotations": ubx.FieldSpec(
        wire_name="annotations",
        kind="object",
        fields=_ApihubOperation_Details_McpTool_AnnotationsFields,
    ),
    "description": ubx.FieldSpec(wire_name="description"),
    "input_schema": ubx.FieldSpec(
        wire_name="input_schema",
        kind="object",
        fields=_ApihubOperation_Details_McpTool_InputSchemaFields,
    ),
...
_ApihubOperation_DetailsFields = {
    "deprecated": ubx.FieldSpec(wire_name="deprecated"),
    "description": ubx.FieldSpec(wire_name="description"),
    "documentation": ubx.FieldSpec(
        wire_name="documentation",
        kind="object",
        fields=_ApihubOperation_Details_DocumentationFields,
    ),
    "http_operation": ubx.FieldSpec(
        wire_name="http_operation",
        kind="object",
        fields=_ApihubOperation_Details_HttpOperationFields,
    ),
    "mcp_tool": ubx.FieldSpec(
        wire_name="mcp_tool",
        kind="object",
        fields=_ApihubOperation_Details_McpToolFields,
    ),
}

_ApihubOperation_SourceMetadata_PluginInstanceActionSourceFields = {
    "action_id": ubx.FieldSpec(wire_name="action_id"),
    "plugin_instance": ubx.FieldSpec(wire_name="plugin_instance"),
}

_ApihubOperation_SourceMetadataFields = {
    ...
    "plugin_instance_action_source": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ApihubOperation_SourceMetadata_PluginInstanceActionSourceFields,
    ),
    "source_type": ubx.FieldSpec(wire_name="source_type"),
}

@dataclasses.dataclass
class ApihubOperationConfig:
...
ApihubOperation = ubx.ResourceBinding(
    wire_type="google_apihub_apihub_operation",
    fields={
        "attributes": ubx.FieldSpec(
            wire_name="attributes",
            kind="map",
            fields=_ApihubOperation_AttributesFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "details": ubx.FieldSpec(
            wire_name="details",
            kind="object",
            fields=_ApihubOperation_DetailsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "source_metadata": ubx.FieldSpec(
            wire_name="source_metadata",
            kind="list",
            fields=_ApihubOperation_SourceMetadataFields,
        ),
