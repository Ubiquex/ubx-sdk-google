...
class Connection_CloudSql_UsernamePassword:
...
@dataclasses.dataclass
class Connection_Connection_Errors_Details:
...
@dataclasses.dataclass
class Connection_Connection_Errors:
    # Additional detail explaining this result. (AI-inferred)
    details: Any = None
...
_Connection_CloudSql_UsernamePasswordFields = {
...
_Connection_ConnectionFields = {
    ...
    "errors": ubx.FieldSpec(
        wire_name="errors",
        kind="list",
        fields=_Connection_Connection_ErrorsFields,
    ),
...
Connection = ubx.ResourceBinding(
    wire_type="google_dlp_connection",
    fields={
        "connection": ubx.FieldSpec(
            wire_name="connection",
            kind="object",
            fields=_Connection_ConnectionFields,
        ),
    },
)
