...
class LoggingSink_BigqueryOptions:
...
_LoggingSink_BigqueryOptionsFields = {
...
LoggingSink = ubx.ResourceBinding(
    wire_type="google_logging_logging_sink",
    fields={
        "bigquery_options": ubx.FieldSpec(
            wire_name="bigquery_options",
            kind="object",
            fields=_LoggingSink_BigqueryOptionsFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "description": ubx.FieldSpec(wire_name="description"),
        ...
        "exclusions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_LoggingSink_ExclusionsFields,
        ),
        "filter": ubx.FieldSpec(wire_name="filter"),
