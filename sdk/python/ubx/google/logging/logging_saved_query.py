...
class LoggingSavedQuery_LoggingQuery_SummaryFields:
    field: Any = None

@dataclasses.dataclass
class LoggingSavedQuery_LoggingQuery:
...
@dataclasses.dataclass
class LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSources_ProjectedField_SqlAggregationFunction:
    parameters: Any = None
    type: Any = None

@dataclasses.dataclass
class LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSources_ProjectedField_VirtualField:
    underlying_field_sources: Any = None
    virtual_field_type: Any = None

@dataclasses.dataclass
class LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSources_ProjectedField:
    alias: Any = None
    cast: Any = None
    field: Any = None
    operation: Any = None
...
@dataclasses.dataclass
class LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSources:
    alias_ref: Any = None
...
@dataclasses.dataclass
class LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_Filter_LeafPredicate:
...
@dataclasses.dataclass
class LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_Filter:
...
@dataclasses.dataclass
class LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_OrderBys:
    field_source: Any = None
    sort_order_direction: Any = None

@dataclasses.dataclass
class LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder:
...
@dataclasses.dataclass
class LoggingSavedQuery_OpsAnalyticsQuery:
...
_LoggingSavedQuery_LoggingQuery_SummaryFieldsFields = {
    "field": ubx.FieldSpec(wire_name="field"),
}

_LoggingSavedQuery_LoggingQueryFields = {
    ...
    "summary_fields": ubx.FieldSpec(
        ...
        kind="list",
        fields=_LoggingSavedQuery_LoggingQuery_SummaryFieldsFields,
    ),
}

_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSources_ProjectedField_SqlAggregationFunctionFields = {
    "parameters": ubx.FieldSpec(wire_name="parameters"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSources_ProjectedField_VirtualFieldFields = {
...
_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSources_ProjectedFieldFields = {
    ...
    "sql_aggregation_function": ubx.FieldSpec(
        ...
        kind="object",
        fields=_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSources_ProjectedField_SqlAggregationFunctionFields,
    ),
    "truncation_granularity": ubx.FieldSpec(wire_name="truncation_granularity"),
    "virtual_field": ubx.FieldSpec(
        wire_name="virtual_field",
        kind="object",
        fields=_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSources_ProjectedField_VirtualFieldFields,
    ),
}

_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSourcesFields = {
    ...
    "projected_field": ubx.FieldSpec(
        ...
        kind="object",
        fields=_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSources_ProjectedFieldFields,
    ),
}

_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_Filter_LeafPredicateFields = {
    "comparator": ubx.FieldSpec(wire_name="comparator"),
    "field_source": ubx.FieldSpec(
        wire_name="field_source",
        kind="object",
        fields=_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSourcesFields,
    ),
...
_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FilterFields = {
    "child_predicates": ubx.FieldSpec(wire_name="child_predicates"),
    "leaf_predicate": ubx.FieldSpec(
        wire_name="leaf_predicate",
        kind="object",
        fields=_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_Filter_LeafPredicateFields,
    ),
    "operator_type": ubx.FieldSpec(wire_name="operator_type"),
}

_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_OrderBysFields = {
    "field_source": ubx.FieldSpec(
        wire_name="field_source",
        kind="object",
        fields=_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FieldSourcesFields,
...
_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilderFields = {
    ...
    "filter": ubx.FieldSpec(
        wire_name="filter",
        kind="object",
        fields=_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_FilterFields,
    ),
    "limit": ubx.FieldSpec(wire_name="limit"),
    "order_bys": ubx.FieldSpec(
        wire_name="order_bys",
        kind="list",
        fields=_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilder_OrderBysFields,
    ),
    "resource_names": ubx.FieldSpec(wire_name="resource_names"),
    "search_term": ubx.FieldSpec(wire_name="search_term"),
}

_LoggingSavedQuery_OpsAnalyticsQueryFields = {
    "query_builder": ubx.FieldSpec(
        wire_name="query_builder",
        kind="object",
        fields=_LoggingSavedQuery_OpsAnalyticsQuery_QueryBuilderFields,
    ),
    "sql_query_text": ubx.FieldSpec(wire_name="sql_query_text"),
}

@dataclasses.dataclass
class LoggingSavedQueryConfig:
...
LoggingSavedQuery = ubx.ResourceBinding(
    wire_type="google_logging_logging_saved_query",
    fields={
        ...
        "logging_query": ubx.FieldSpec(
            ...
            kind="object",
            fields=_LoggingSavedQuery_LoggingQueryFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "ops_analytics_query": ubx.FieldSpec(
            wire_name="ops_analytics_query",
            kind="object",
            fields=_LoggingSavedQuery_OpsAnalyticsQueryFields,
        ),
