...
class LoggingBucket_CmekSettings:
...
@dataclasses.dataclass
class LoggingBucket_IndexConfigs:
    create_time: Any = None
    field_path: Any = None
    type: Any = None

_LoggingBucket_CmekSettingsFields = {
...
_LoggingBucket_IndexConfigsFields = {
...
LoggingBucket = ubx.ResourceBinding(
    wire_type="google_logging_logging_bucket",
    fields={
        "analytics_enabled": ubx.FieldSpec(wire_name="analytics_enabled"),
        "cmek_settings": ubx.FieldSpec(
            wire_name="cmek_settings",
            kind="object",
            fields=_LoggingBucket_CmekSettingsFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        ...
        "index_configs": ubx.FieldSpec(
            ...
            kind="list",
            fields=_LoggingBucket_IndexConfigsFields,
        ),
