...
class Entitlement_AdditionalNotificationTargets:
...
@dataclasses.dataclass
class Entitlement_ApprovalWorkflow_ManualApprovals:
...
@dataclasses.dataclass
class Entitlement_ApprovalWorkflow:
...
@dataclasses.dataclass
class Entitlement_PrivilegedAccess_GcpIamAccess:
...
@dataclasses.dataclass
class Entitlement_PrivilegedAccess:
...
@dataclasses.dataclass
class Entitlement_RequesterJustificationConfig:
...
_Entitlement_AdditionalNotificationTargetsFields = {
...
_Entitlement_ApprovalWorkflow_ManualApprovals_Steps_ApproversFields = {
    "principals": ubx.FieldSpec(wire_name="principals"),
}

_Entitlement_ApprovalWorkflow_ManualApprovals_StepsFields = {
    ...
    "approvers": ubx.FieldSpec(
        wire_name="approvers",
        kind="list",
        fields=_Entitlement_ApprovalWorkflow_ManualApprovals_Steps_ApproversFields,
    ),
}

_Entitlement_ApprovalWorkflow_ManualApprovalsFields = {
    "require_approver_justification": ubx.FieldSpec(wire_name="require_approver_justification"),
    "steps": ubx.FieldSpec(
        wire_name="steps",
        kind="list",
        fields=_Entitlement_ApprovalWorkflow_ManualApprovals_StepsFields,
    ),
}

_Entitlement_ApprovalWorkflowFields = {
    "manual_approvals": ubx.FieldSpec(
        wire_name="manual_approvals",
        kind="object",
        fields=_Entitlement_ApprovalWorkflow_ManualApprovalsFields,
    ),
}

_Entitlement_PrivilegedAccess_GcpIamAccess_RoleBindingsFields = {
    "condition_expression": ubx.FieldSpec(wire_name="condition_expression"),
    "role": ubx.FieldSpec(wire_name="role"),
}

_Entitlement_PrivilegedAccess_GcpIamAccessFields = {
    ...
    "role_bindings": ubx.FieldSpec(
        ...
        kind="list",
        fields=_Entitlement_PrivilegedAccess_GcpIamAccess_RoleBindingsFields,
    ),
}

_Entitlement_PrivilegedAccessFields = {
    "gcp_iam_access": ubx.FieldSpec(
        wire_name="gcp_iam_access",
        kind="object",
        fields=_Entitlement_PrivilegedAccess_GcpIamAccessFields,
    ),
}

_Entitlement_RequesterJustificationConfigFields = {
...
Entitlement = ubx.ResourceBinding(
    wire_type="google_privilegedaccessmanager_entitlement",
    fields={
        "additional_notification_targets": ubx.FieldSpec(
            wire_name="additional_notification_targets",
            kind="object",
            fields=_Entitlement_AdditionalNotificationTargetsFields,
        ),
        ...
        "privileged_access": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Entitlement_PrivilegedAccessFields,
        ),
