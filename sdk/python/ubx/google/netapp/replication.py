...
class Replication_DestinationVolumeParameters_TieringPolicy:
...
@dataclasses.dataclass
class Replication_DestinationVolumeParameters:
...
@dataclasses.dataclass
class Replication_HybridPeeringDetails:
...
@dataclasses.dataclass
class Replication_HybridReplicationUserCommands:
    # Output only. List of commands to be executed by the customer.
    commands: Any = None

@dataclasses.dataclass
class Replication_TransferStats:
...
_Replication_DestinationVolumeParameters_TieringPolicyFields = {
...
_Replication_DestinationVolumeParametersFields = {
    ...
    "tiering_policy": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Replication_DestinationVolumeParameters_TieringPolicyFields,
    ),
    "volume_id": ubx.FieldSpec(wire_name="volume_id"),
}

_Replication_HybridPeeringDetailsFields = {
...
_Replication_HybridReplicationUserCommandsFields = {
    "commands": ubx.FieldSpec(wire_name="commands"),
}

_Replication_TransferStatsFields = {
...
Replication = ubx.ResourceBinding(
    ...
    fields={
        ...
        "transfer_stats": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Replication_TransferStatsFields,
        ),
    },
)
