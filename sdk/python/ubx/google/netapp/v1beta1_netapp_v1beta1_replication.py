...
class V1beta1NetappV1beta1Replication_DestinationVolumeParameters_TieringPolicy:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Replication_DestinationVolumeParameters:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Replication_HybridPeeringDetails:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Replication_HybridReplicationUserCommands:
    # Output only. List of commands to be executed by the customer.
    commands: Any = None

@dataclasses.dataclass
class V1beta1NetappV1beta1Replication_TransferStats:
...
_V1beta1NetappV1beta1Replication_DestinationVolumeParameters_TieringPolicyFields = {
...
_V1beta1NetappV1beta1Replication_DestinationVolumeParametersFields = {
    ...
    "tiering_policy": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1NetappV1beta1Replication_DestinationVolumeParameters_TieringPolicyFields,
    ),
    "volume_id": ubx.FieldSpec(wire_name="volume_id"),
}

_V1beta1NetappV1beta1Replication_HybridPeeringDetailsFields = {
...
_V1beta1NetappV1beta1Replication_HybridReplicationUserCommandsFields = {
    "commands": ubx.FieldSpec(wire_name="commands"),
}

_V1beta1NetappV1beta1Replication_TransferStatsFields = {
...
@dataclasses.dataclass
class V1beta1NetappV1beta1ReplicationConfig:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1ReplicationAttrs:
    # Optional. Location of the user cluster.
    cluster_location: Any = None
    # Output only. Replication create time.
    create_time: Any = None
...
V1beta1NetappV1beta1Replication = ubx.ResourceBinding(
    wire_type="google_netapp_v1beta1_netapp_v1beta1_replication",
    fields={
        ...
        "destination_volume_parameters": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetappV1beta1Replication_DestinationVolumeParametersFields,
        ),
        "healthy": ubx.FieldSpec(wire_name="healthy"),
        "hybrid_peering_details": ubx.FieldSpec(
            wire_name="hybrid_peering_details",
            kind="object",
            fields=_V1beta1NetappV1beta1Replication_HybridPeeringDetailsFields,
        ),
        ...
        "hybrid_replication_user_commands": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetappV1beta1Replication_HybridReplicationUserCommandsFields,
        ),
        ...
        "transfer_stats": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetappV1beta1Replication_TransferStatsFields,
        ),
    },
)
