...
class NetappReplication_DestinationVolumeParameters_TieringPolicy:
...
@dataclasses.dataclass
class NetappReplication_DestinationVolumeParameters:
...
@dataclasses.dataclass
class NetappReplication_HybridPeeringDetails:
...
@dataclasses.dataclass
class NetappReplication_HybridReplicationUserCommands:
    # Output only. List of commands to be executed by the customer.
    commands: Any = None

@dataclasses.dataclass
class NetappReplication_TransferStats:
...
_NetappReplication_DestinationVolumeParameters_TieringPolicyFields = {
...
_NetappReplication_DestinationVolumeParametersFields = {
    ...
    "tiering_policy": ubx.FieldSpec(
        ...
        kind="object",
        fields=_NetappReplication_DestinationVolumeParameters_TieringPolicyFields,
    ),
    "volume_id": ubx.FieldSpec(wire_name="volume_id"),
}

_NetappReplication_HybridPeeringDetailsFields = {
...
_NetappReplication_HybridReplicationUserCommandsFields = {
    "commands": ubx.FieldSpec(wire_name="commands"),
}

_NetappReplication_TransferStatsFields = {
...
NetappReplication = ubx.ResourceBinding(
    wire_type="google_netapp_netapp_replication",
    fields={
        ...
        "destination_volume_parameters": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetappReplication_DestinationVolumeParametersFields,
        ),
        "healthy": ubx.FieldSpec(wire_name="healthy"),
        "hybrid_peering_details": ubx.FieldSpec(
            wire_name="hybrid_peering_details",
            kind="object",
            fields=_NetappReplication_HybridPeeringDetailsFields,
        ),
        ...
        "hybrid_replication_user_commands": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetappReplication_HybridReplicationUserCommandsFields,
        ),
        ...
        "transfer_stats": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetappReplication_TransferStatsFields,
        ),
    },
)
