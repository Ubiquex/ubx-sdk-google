# Code generated by `ubx sdk gen` from google_netapp_v1beta1_netapp_v1beta1_active_directory. DO NOT EDIT.
...
class V1beta1NetappV1beta1ActiveDirectoryConfig:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1ActiveDirectoryAttrs:
    # Optional. Users to be added to the Built-in Admininstrators group.
    administrators: Any = None
    # If enabled, AES encryption will be enabled for SMB communication.
    aes_encryption: Any = None
...
V1beta1NetappV1beta1ActiveDirectory = ubx.ResourceBinding(
    wire_type="google_netapp_v1beta1_netapp_v1beta1_active_directory",
    fields={
