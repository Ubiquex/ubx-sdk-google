# Code generated by `ubx sdk gen` from google_netapp_v1beta1_storage_pool. DO NOT EDIT.
...
class V1beta1StoragePoolConfig:
...
V1beta1StoragePool = ubx.ResourceBinding(
    wire_type="google_netapp_v1beta1_storage_pool",
    fields={
