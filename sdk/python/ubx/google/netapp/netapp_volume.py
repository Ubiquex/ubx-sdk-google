...
class NetappVolume_BackupConfig:
...
@dataclasses.dataclass
class NetappVolume_BlockDevices:
...
@dataclasses.dataclass
class NetappVolume_CacheParameters_CacheConfig_CachePrePopulate:
...
@dataclasses.dataclass
class NetappVolume_CacheParameters_CacheConfig:
...
@dataclasses.dataclass
class NetappVolume_CacheParameters:
...
@dataclasses.dataclass
class NetappVolume_CloneDetails:
...
@dataclasses.dataclass
class NetappVolume_ExportPolicy_Rules:
...
@dataclasses.dataclass
class NetappVolume_ExportPolicy:
    # Required. List of export policy rules
    rules: Any = None

@dataclasses.dataclass
class NetappVolume_HybridReplicationParameters:
...
@dataclasses.dataclass
class NetappVolume_LargeCapacityConfig:
...
@dataclasses.dataclass
class NetappVolume_MountOptions:
    export: Any = None
...
@dataclasses.dataclass
class NetappVolume_RestoreParameters:
...
@dataclasses.dataclass
class NetappVolume_SnapshotPolicy_DailySchedule:
...
@dataclasses.dataclass
class NetappVolume_SnapshotPolicy_HourlySchedule:
    # Set the minute of the hour to start the snapshot (0-59), defaults to the top of the hour (0).
    minute: Any = None
    # The maximum number of Snapshots to keep for the hourly schedule
    snapshots_to_keep: Any = None
...
@dataclasses.dataclass
class NetappVolume_SnapshotPolicy_MonthlySchedule:
...
@dataclasses.dataclass
class NetappVolume_SnapshotPolicy_WeeklySchedule:
...
@dataclasses.dataclass
class NetappVolume_SnapshotPolicy:
...
@dataclasses.dataclass
class NetappVolume_TieringPolicy:
...
_NetappVolume_BackupConfigFields = {
...
_NetappVolume_BlockDevicesFields = {
...
_NetappVolume_CacheParameters_CacheConfig_CachePrePopulateFields = {
...
_NetappVolume_CacheParameters_CacheConfigFields = {
    "cache_pre_populate": ubx.FieldSpec(
        wire_name="cache_pre_populate",
        kind="object",
        fields=_NetappVolume_CacheParameters_CacheConfig_CachePrePopulateFields,
    ),
...
_NetappVolume_CacheParametersFields = {
    "cache_config": ubx.FieldSpec(
        wire_name="cache_config",
        kind="object",
        fields=_NetappVolume_CacheParameters_CacheConfigFields,
    ),
...
_NetappVolume_CloneDetailsFields = {
...
_NetappVolume_ExportPolicy_RulesFields = {
...
_NetappVolume_ExportPolicyFields = {
    "rules": ubx.FieldSpec(
        wire_name="rules",
        kind="list",
        fields=_NetappVolume_ExportPolicy_RulesFields,
    ),
}

_NetappVolume_HybridReplicationParametersFields = {
...
_NetappVolume_LargeCapacityConfigFields = {
    "constituent_count": ubx.FieldSpec(wire_name="constituent_count"),
}

_NetappVolume_MountOptionsFields = {
...
_NetappVolume_RestoreParametersFields = {
    "source_backup": ubx.FieldSpec(wire_name="source_backup"),
    "source_snapshot": ubx.FieldSpec(wire_name="source_snapshot"),
}

_NetappVolume_SnapshotPolicy_DailyScheduleFields = {
...
_NetappVolume_SnapshotPolicy_HourlyScheduleFields = {
    "minute": ubx.FieldSpec(wire_name="minute"),
    "snapshots_to_keep": ubx.FieldSpec(wire_name="snapshots_to_keep"),
}

_NetappVolume_SnapshotPolicy_MonthlyScheduleFields = {
...
_NetappVolume_SnapshotPolicy_WeeklyScheduleFields = {
...
_NetappVolume_SnapshotPolicyFields = {
    "daily_schedule": ubx.FieldSpec(
        wire_name="daily_schedule",
        kind="object",
        fields=_NetappVolume_SnapshotPolicy_DailyScheduleFields,
    ),
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "hourly_schedule": ubx.FieldSpec(
        wire_name="hourly_schedule",
        kind="object",
        fields=_NetappVolume_SnapshotPolicy_HourlyScheduleFields,
    ),
    "monthly_schedule": ubx.FieldSpec(
        wire_name="monthly_schedule",
        kind="object",
        fields=_NetappVolume_SnapshotPolicy_MonthlyScheduleFields,
    ),
    "weekly_schedule": ubx.FieldSpec(
        wire_name="weekly_schedule",
        kind="object",
        fields=_NetappVolume_SnapshotPolicy_WeeklyScheduleFields,
    ),
}

_NetappVolume_TieringPolicyFields = {
...
NetappVolume = ubx.ResourceBinding(
    ...
    fields={
        ...
        "export_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetappVolume_ExportPolicyFields,
        ),
        ...
        "hybrid_replication_parameters": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetappVolume_HybridReplicationParametersFields,
        ),
        ...
        "restore_parameters": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetappVolume_RestoreParametersFields,
        ),
        ...
        "snapshot_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetappVolume_SnapshotPolicyFields,
        ),
        ...
        "tiering_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetappVolume_TieringPolicyFields,
        ),
