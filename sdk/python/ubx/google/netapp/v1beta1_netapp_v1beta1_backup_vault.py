...
class V1beta1NetappV1beta1BackupVault_BackupRetentionPolicy:
...
_V1beta1NetappV1beta1BackupVault_BackupRetentionPolicyFields = {
...
@dataclasses.dataclass
class V1beta1NetappV1beta1BackupVaultConfig:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1BackupVaultAttrs:
    # Optional. Region where the backups are stored. Format: `projects/{project_id}/locations/{location}`
    backup_region: Any = None
    # Retention policy for backups in the backup vault
    backup_retention_policy: Any = None
...
V1beta1NetappV1beta1BackupVault = ubx.ResourceBinding(
    wire_type="google_netapp_v1beta1_netapp_v1beta1_backup_vault",
    fields={
        ...
        "backup_retention_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetappV1beta1BackupVault_BackupRetentionPolicyFields,
        ),
