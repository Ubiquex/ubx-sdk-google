...
class V1beta1NetappV1beta1Volume_BackupConfig:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_BlockDevices:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_CacheParameters_CacheConfig_CachePrePopulate:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_CacheParameters_CacheConfig:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_CacheParameters:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_CloneDetails:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_ExportPolicy_Rules:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_ExportPolicy:
    # Required. List of export policy rules
    rules: Any = None

@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_HybridReplicationParameters:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_LargeCapacityConfig:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_MountOptions:
    export: Any = None
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_RestoreParameters:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_SnapshotPolicy_DailySchedule:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_SnapshotPolicy_HourlySchedule:
    # Set the minute of the hour to start the snapshot (0-59), defaults to the top of the hour (0).
    minute: Any = None
    # The maximum number of Snapshots to keep for the hourly schedule
    snapshots_to_keep: Any = None
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_SnapshotPolicy_MonthlySchedule:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_SnapshotPolicy_WeeklySchedule:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_SnapshotPolicy:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1Volume_TieringPolicy:
...
_V1beta1NetappV1beta1Volume_BackupConfigFields = {
...
_V1beta1NetappV1beta1Volume_BlockDevicesFields = {
...
_V1beta1NetappV1beta1Volume_CacheParameters_CacheConfig_CachePrePopulateFields = {
...
_V1beta1NetappV1beta1Volume_CacheParameters_CacheConfigFields = {
    "cache_pre_populate": ubx.FieldSpec(
        wire_name="cache_pre_populate",
        kind="object",
        fields=_V1beta1NetappV1beta1Volume_CacheParameters_CacheConfig_CachePrePopulateFields,
    ),
...
_V1beta1NetappV1beta1Volume_CacheParametersFields = {
    "cache_config": ubx.FieldSpec(
        wire_name="cache_config",
        kind="object",
        fields=_V1beta1NetappV1beta1Volume_CacheParameters_CacheConfigFields,
    ),
...
_V1beta1NetappV1beta1Volume_CloneDetailsFields = {
...
_V1beta1NetappV1beta1Volume_ExportPolicy_RulesFields = {
...
_V1beta1NetappV1beta1Volume_ExportPolicyFields = {
    "rules": ubx.FieldSpec(
        wire_name="rules",
        kind="list",
        fields=_V1beta1NetappV1beta1Volume_ExportPolicy_RulesFields,
    ),
}

_V1beta1NetappV1beta1Volume_HybridReplicationParametersFields = {
...
_V1beta1NetappV1beta1Volume_LargeCapacityConfigFields = {
    "constituent_count": ubx.FieldSpec(wire_name="constituent_count"),
}

_V1beta1NetappV1beta1Volume_MountOptionsFields = {
...
_V1beta1NetappV1beta1Volume_RestoreParametersFields = {
    "source_backup": ubx.FieldSpec(wire_name="source_backup"),
    "source_snapshot": ubx.FieldSpec(wire_name="source_snapshot"),
}

_V1beta1NetappV1beta1Volume_SnapshotPolicy_DailyScheduleFields = {
...
_V1beta1NetappV1beta1Volume_SnapshotPolicy_HourlyScheduleFields = {
    "minute": ubx.FieldSpec(wire_name="minute"),
    "snapshots_to_keep": ubx.FieldSpec(wire_name="snapshots_to_keep"),
}

_V1beta1NetappV1beta1Volume_SnapshotPolicy_MonthlyScheduleFields = {
...
_V1beta1NetappV1beta1Volume_SnapshotPolicy_WeeklyScheduleFields = {
...
_V1beta1NetappV1beta1Volume_SnapshotPolicyFields = {
    "daily_schedule": ubx.FieldSpec(
        wire_name="daily_schedule",
        kind="object",
        fields=_V1beta1NetappV1beta1Volume_SnapshotPolicy_DailyScheduleFields,
    ),
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "hourly_schedule": ubx.FieldSpec(
        wire_name="hourly_schedule",
        kind="object",
        fields=_V1beta1NetappV1beta1Volume_SnapshotPolicy_HourlyScheduleFields,
    ),
    "monthly_schedule": ubx.FieldSpec(
        wire_name="monthly_schedule",
        kind="object",
        fields=_V1beta1NetappV1beta1Volume_SnapshotPolicy_MonthlyScheduleFields,
    ),
    "weekly_schedule": ubx.FieldSpec(
        wire_name="weekly_schedule",
        kind="object",
        fields=_V1beta1NetappV1beta1Volume_SnapshotPolicy_WeeklyScheduleFields,
    ),
}

_V1beta1NetappV1beta1Volume_TieringPolicyFields = {
...
@dataclasses.dataclass
class V1beta1NetappV1beta1VolumeConfig:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1VolumeAttrs:
    # Output only. Specifies the ActiveDirectory name of a SMB volume.
    active_directory: Any = None
    # BackupConfig contains backup related config on a volume.
    backup_config: Any = None
...
V1beta1NetappV1beta1Volume = ubx.ResourceBinding(
    wire_type="google_netapp_v1beta1_netapp_v1beta1_volume",
    fields={
        "active_directory": ubx.FieldSpec(wire_name="active_directory"),
        "backup_config": ubx.FieldSpec(
            wire_name="backup_config",
            kind="object",
            fields=_V1beta1NetappV1beta1Volume_BackupConfigFields,
        ),
        "block_devices": ubx.FieldSpec(
            wire_name="block_devices",
            kind="list",
            fields=_V1beta1NetappV1beta1Volume_BlockDevicesFields,
        ),
        "cache_parameters": ubx.FieldSpec(
            wire_name="cache_parameters",
            kind="object",
            fields=_V1beta1NetappV1beta1Volume_CacheParametersFields,
        ),
        "capacity_gib": ubx.FieldSpec(wire_name="capacity_gib"),
        "clone_details": ubx.FieldSpec(
            wire_name="clone_details",
            kind="object",
            fields=_V1beta1NetappV1beta1Volume_CloneDetailsFields,
        ),
        ...
        "export_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetappV1beta1Volume_ExportPolicyFields,
        ),
        ...
        "hybrid_replication_parameters": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetappV1beta1Volume_HybridReplicationParametersFields,
        ),
        ...
        "large_capacity_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetappV1beta1Volume_LargeCapacityConfigFields,
        ),
        "ldap_enabled": ubx.FieldSpec(wire_name="ldap_enabled"),
        "mount_options": ubx.FieldSpec(
            wire_name="mount_options",
            kind="list",
            fields=_V1beta1NetappV1beta1Volume_MountOptionsFields,
        ),
        ...
        "restore_parameters": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetappV1beta1Volume_RestoreParametersFields,
        ),
        ...
        "snapshot_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetappV1beta1Volume_SnapshotPolicyFields,
        ),
        ...
        "tiering_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NetappV1beta1Volume_TieringPolicyFields,
        ),
