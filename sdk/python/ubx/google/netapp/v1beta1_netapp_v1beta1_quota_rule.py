...
class V1beta1NetappV1beta1QuotaRuleConfig:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1QuotaRuleAttrs:
    # Output only. Create time of the quota rule
    create_time: Any = None
    # Optional. Description of the quota rule
    description: Any = None
...
V1beta1NetappV1beta1QuotaRule = ubx.ResourceBinding(
    wire_type="google_netapp_v1beta1_netapp_v1beta1_quota_rule",
    fields={
