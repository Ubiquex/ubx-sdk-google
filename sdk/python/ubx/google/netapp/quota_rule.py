# Code generated by `ubx sdk gen` from google_netapp_quota_rule. DO NOT EDIT.
...
QuotaRule = ubx.ResourceBinding(
    wire_type="google_netapp_quota_rule",
    fields={
