...
class V1beta1NetappV1beta1KmsConfigConfig:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1KmsConfigAttrs:
    # Output only. Create time of the KmsConfig.
    create_time: Any = None
    # Required. Customer-managed crypto key resource full name. Format: `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`
    crypto_key_name: Any = None
...
V1beta1NetappV1beta1KmsConfig = ubx.ResourceBinding(
    wire_type="google_netapp_v1beta1_netapp_v1beta1_kms_config",
    fields={
