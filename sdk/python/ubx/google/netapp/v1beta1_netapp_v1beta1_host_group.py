...
class V1beta1NetappV1beta1HostGroupConfig:
...
@dataclasses.dataclass
class V1beta1NetappV1beta1HostGroupAttrs:
    # Output only. Create time of the host group.
    create_time: Any = None
    # Optional. Description of the host group.
    description: Any = None
...
V1beta1NetappV1beta1HostGroup = ubx.ResourceBinding(
    wire_type="google_netapp_v1beta1_netapp_v1beta1_host_group",
    fields={
