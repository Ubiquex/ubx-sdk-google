...
@dataclasses.dataclass
class ObjectAccessControlAttrs:
    # The name of the bucket.
    bucket: Any = None
    # The domain associated with the entity, if any.
    domain: Any = None
...
ObjectAccessControl = ubx.ResourceBinding(
    wire_type="google_storage_object_access_control",
    fields={
        ...
        "project_team": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ObjectAccessControl_ProjectTeamFields,
        ),
