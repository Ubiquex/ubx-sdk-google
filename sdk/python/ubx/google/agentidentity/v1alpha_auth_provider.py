...
class V1alphaAuthProvider_AuthProviderTypeParams_ApiKey:
    # Optional. Input only. The API key for this auth provider.
    api_key: Any = None

@dataclasses.dataclass
class V1alphaAuthProvider_AuthProviderTypeParams_ThreeLeggedOauth:
...
@dataclasses.dataclass
class V1alphaAuthProvider_AuthProviderTypeParams_TwoLeggedOauth:
    # Optional. The client ID of the OAuth client.
    client_id: Any = None
    # Optional. Input only. The client secret of the OAuth client.
    client_secret: Any = None
...
@dataclasses.dataclass
class V1alphaAuthProvider_AuthProviderTypeParams:
...
_V1alphaAuthProvider_AuthProviderTypeParams_ApiKeyFields = {
    "api_key": ubx.FieldSpec(wire_name="api_key"),
}

_V1alphaAuthProvider_AuthProviderTypeParams_ThreeLeggedOauthFields = {
...
_V1alphaAuthProvider_AuthProviderTypeParams_TwoLeggedOauthFields = {
    "client_id": ubx.FieldSpec(wire_name="client_id"),
    "client_secret": ubx.FieldSpec(wire_name="client_secret"),
    "token_url": ubx.FieldSpec(wire_name="token_url"),
}

_V1alphaAuthProvider_AuthProviderTypeParamsFields = {
    "api_key": ubx.FieldSpec(
        wire_name="api_key",
        kind="object",
        fields=_V1alphaAuthProvider_AuthProviderTypeParams_ApiKeyFields,
    ),
    "ge_auth_provider": ubx.FieldSpec(wire_name="ge_auth_provider"),
    "three_legged_oauth": ubx.FieldSpec(
        wire_name="three_legged_oauth",
        kind="object",
        fields=_V1alphaAuthProvider_AuthProviderTypeParams_ThreeLeggedOauthFields,
    ),
    "two_legged_oauth": ubx.FieldSpec(
        wire_name="two_legged_oauth",
        kind="object",
        fields=_V1alphaAuthProvider_AuthProviderTypeParams_TwoLeggedOauthFields,
    ),
}

@dataclasses.dataclass
class V1alphaAuthProviderConfig:
...
@dataclasses.dataclass
class V1alphaAuthProviderAttrs:
    # Optional. List of scopes that are allowed to be requested for this auth provider. If this list is non-empty, only scopes within this list may be requested. If this list is empty, all scopes may be requested. Scopes appearing in `blocked_scopes` are disallowed even if they appear in `allowed_scopes`. The number of allowed scopes is limited to 200.
    allowed_scopes: Any = None
    # Required. Parameters specific to the auth provider type.
    auth_provider_type_params: Any = None
...
V1alphaAuthProvider = ubx.ResourceBinding(
    wire_type="google_agentidentity_v1alpha_auth_provider",
    fields={
