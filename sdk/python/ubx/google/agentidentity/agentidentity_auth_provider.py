...
@dataclasses.dataclass
class AgentidentityAuthProvider_AuthProviderTypeParams_TwoLeggedOauth:
    # Optional. The client ID of the OAuth client.
    client_id: Any = None
    # Optional. Input only. The client secret of the OAuth client.
    client_secret: Any = None
...
_AgentidentityAuthProvider_AuthProviderTypeParams_ThreeLeggedOauthFields = {
...
_AgentidentityAuthProvider_AuthProviderTypeParams_TwoLeggedOauthFields = {
    "client_id": ubx.FieldSpec(wire_name="client_id"),
    "client_secret": ubx.FieldSpec(wire_name="client_secret"),
    "token_url": ubx.FieldSpec(wire_name="token_url"),
}

_AgentidentityAuthProvider_AuthProviderTypeParamsFields = {
    "api_key": ubx.FieldSpec(
        wire_name="api_key",
        kind="object",
        fields=_AgentidentityAuthProvider_AuthProviderTypeParams_ApiKeyFields,
    ),
    "ge_auth_provider": ubx.FieldSpec(wire_name="ge_auth_provider"),
    "three_legged_oauth": ubx.FieldSpec(
        wire_name="three_legged_oauth",
        kind="object",
        fields=_AgentidentityAuthProvider_AuthProviderTypeParams_ThreeLeggedOauthFields,
    ),
    "two_legged_oauth": ubx.FieldSpec(
        wire_name="two_legged_oauth",
        kind="object",
        fields=_AgentidentityAuthProvider_AuthProviderTypeParams_TwoLeggedOauthFields,
    ),
}
...
AgentidentityAuthProvider = ubx.ResourceBinding(
    wire_type="google_agentidentity_agentidentity_auth_provider",
    fields={
        ...
        "auth_provider_type_params": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AgentidentityAuthProvider_AuthProviderTypeParamsFields,
        ),
