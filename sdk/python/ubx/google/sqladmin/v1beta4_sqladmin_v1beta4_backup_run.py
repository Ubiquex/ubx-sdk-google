...
class V1beta4SqladminV1beta4BackupRun_DiskEncryptionConfiguration:
...
@dataclasses.dataclass
class V1beta4SqladminV1beta4BackupRun_DiskEncryptionStatus:
...
@dataclasses.dataclass
class V1beta4SqladminV1beta4BackupRun_Error:
...
_V1beta4SqladminV1beta4BackupRun_DiskEncryptionConfigurationFields = {
    "kind": ubx.FieldSpec(wire_name="kind"),
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

_V1beta4SqladminV1beta4BackupRun_DiskEncryptionStatusFields = {
    "kind": ubx.FieldSpec(wire_name="kind"),
    "kms_key_version_name": ubx.FieldSpec(wire_name="kms_key_version_name"),
}

_V1beta4SqladminV1beta4BackupRun_ErrorFields = {
...
@dataclasses.dataclass
class V1beta4SqladminV1beta4BackupRunConfig:
...
@dataclasses.dataclass
class V1beta4SqladminV1beta4BackupRunAttrs:
    # Specifies the kind of backup, PHYSICAL or DEFAULT_SNAPSHOT.
    backup_kind: Any = None
    # Output only. The instance database version at the time this backup was made.
    database_version: Any = None
...
V1beta4SqladminV1beta4BackupRun = ubx.ResourceBinding(
    wire_type="google_sqladmin_v1beta4_sqladmin_v1beta4_backup_run",
    fields={
        ...
        "disk_encryption_configuration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta4SqladminV1beta4BackupRun_DiskEncryptionConfigurationFields,
        ),
        "disk_encryption_status": ubx.FieldSpec(
            wire_name="disk_encryption_status",
            kind="object",
            fields=_V1beta4SqladminV1beta4BackupRun_DiskEncryptionStatusFields,
        ),
        ...
        "error": ubx.FieldSpec(
            wire_name="error",
            kind="object",
            fields=_V1beta4SqladminV1beta4BackupRun_ErrorFields,
        ),
