...
@dataclasses.dataclass
class V1beta4Instance_OnPremisesConfiguration_SourceInstance:
...
_V1beta4Instance_OnPremisesConfiguration_SourceInstanceFields = {
    "name": ubx.FieldSpec(wire_name="name"),
...
_V1beta4Instance_OnPremisesConfigurationFields = {
    ...
    "source_instance": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta4Instance_OnPremisesConfiguration_SourceInstanceFields,
    ),
