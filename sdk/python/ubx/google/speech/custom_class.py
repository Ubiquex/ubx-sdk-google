...
_CustomClass_CustomClass_ItemsFields = {
    "value": ubx.FieldSpec(wire_name="value"),
}

_CustomClass_CustomClassFields = {
    ...
    "items": ubx.FieldSpec(
        wire_name="items",
        kind="list",
        fields=_CustomClass_CustomClass_ItemsFields,
    ),
...
CustomClass = ubx.ResourceBinding(
    wire_type="google_speech_custom_class",
    fields={
        "custom_class": ubx.FieldSpec(
            wire_name="custom_class",
            kind="object",
            fields=_CustomClass_CustomClassFields,
        ),
        "custom_class_id": ubx.FieldSpec(wire_name="custom_class_id"),
    },
)
