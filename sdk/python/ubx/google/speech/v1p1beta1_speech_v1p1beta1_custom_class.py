...
class V1p1beta1SpeechV1p1beta1CustomClass_CustomClass_Items:
    value: Any = None

@dataclasses.dataclass
class V1p1beta1SpeechV1p1beta1CustomClass_CustomClass:
...
_V1p1beta1SpeechV1p1beta1CustomClass_CustomClass_ItemsFields = {
    "value": ubx.FieldSpec(wire_name="value"),
}

_V1p1beta1SpeechV1p1beta1CustomClass_CustomClassFields = {
    ...
    "items": ubx.FieldSpec(
        wire_name="items",
        kind="list",
        fields=_V1p1beta1SpeechV1p1beta1CustomClass_CustomClass_ItemsFields,
    ),
...
@dataclasses.dataclass
class V1p1beta1SpeechV1p1beta1CustomClassConfig:
...
@dataclasses.dataclass
class V1p1beta1SpeechV1p1beta1CustomClassAttrs:
    # Output only. Allows users to store small amounts of arbitrary data. Both the key and the value must be 63 characters or less each. At most 100 annotations. This field is not used.
    annotations: Any = None
    # A set of words or phrases that represents a common concept likely to appear in your audio, for example a list of passenger ship names. CustomClass items can be substituted into placeholders that you set in PhraseSet phrases.
    custom_class: Any = None
...
V1p1beta1SpeechV1p1beta1CustomClass = ubx.ResourceBinding(
    wire_type="google_speech_v1p1beta1_speech_v1p1beta1_custom_class",
    fields={
        "custom_class": ubx.FieldSpec(
            wire_name="custom_class",
            kind="object",
            fields=_V1p1beta1SpeechV1p1beta1CustomClass_CustomClassFields,
        ),
        "custom_class_id": ubx.FieldSpec(wire_name="custom_class_id"),
    },
)
