...
class SpeechCustomClass_CustomClass_Items:
    value: Any = None

@dataclasses.dataclass
class SpeechCustomClass_CustomClass:
...
_SpeechCustomClass_CustomClass_ItemsFields = {
    "value": ubx.FieldSpec(wire_name="value"),
}

_SpeechCustomClass_CustomClassFields = {
    ...
    "items": ubx.FieldSpec(
        wire_name="items",
        kind="list",
        fields=_SpeechCustomClass_CustomClass_ItemsFields,
    ),
...
SpeechCustomClass = ubx.ResourceBinding(
    wire_type="google_speech_speech_custom_class",
    fields={
        "custom_class": ubx.FieldSpec(
            wire_name="custom_class",
            kind="object",
            fields=_SpeechCustomClass_CustomClassFields,
        ),
        "custom_class_id": ubx.FieldSpec(wire_name="custom_class_id"),
    },
)
