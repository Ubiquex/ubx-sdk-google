...
_PhraseSet_PhraseSet_PhrasesFields = {
    "boost": ubx.FieldSpec(wire_name="boost"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_PhraseSet_PhraseSetFields = {
    ...
    "phrases": ubx.FieldSpec(
        wire_name="phrases",
        kind="list",
        fields=_PhraseSet_PhraseSet_PhrasesFields,
    ),
...
PhraseSet = ubx.ResourceBinding(
    wire_type="google_speech_phrase_set",
    fields={
        "phrase_set": ubx.FieldSpec(
            wire_name="phrase_set",
            kind="object",
            fields=_PhraseSet_PhraseSetFields,
        ),
