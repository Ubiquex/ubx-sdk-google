...
class SpeechPhraseSet_PhraseSet_Phrases:
    boost: Any = None
    value: Any = None

@dataclasses.dataclass
class SpeechPhraseSet_PhraseSet:
...
_SpeechPhraseSet_PhraseSet_PhrasesFields = {
    "boost": ubx.FieldSpec(wire_name="boost"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_SpeechPhraseSet_PhraseSetFields = {
    ...
    "phrases": ubx.FieldSpec(
        wire_name="phrases",
        kind="list",
        fields=_SpeechPhraseSet_PhraseSet_PhrasesFields,
    ),
...
SpeechPhraseSet = ubx.ResourceBinding(
    wire_type="google_speech_speech_phrase_set",
    fields={
        "phrase_set": ubx.FieldSpec(
            wire_name="phrase_set",
            kind="object",
            fields=_SpeechPhraseSet_PhraseSetFields,
        ),
