...
class Customer_CloudIdentityInfo_EduData:
...
@dataclasses.dataclass
class Customer_CloudIdentityInfo:
...
@dataclasses.dataclass
class Customer_OrgPostalAddress:
...
@dataclasses.dataclass
class Customer_PrimaryContactInfo:
...
_Customer_CloudIdentityInfo_EduDataFields = {
...
_Customer_CloudIdentityInfoFields = {
    ...
    "edu_data": ubx.FieldSpec(
        wire_name="edu_data",
        kind="object",
        fields=_Customer_CloudIdentityInfo_EduDataFields,
    ),
...
_Customer_OrgPostalAddressFields = {
...
_Customer_PrimaryContactInfoFields = {
...
Customer = ubx.ResourceBinding(
    wire_type="google_cloudchannel_customer",
    fields={
        "alternate_email": ubx.FieldSpec(wire_name="alternate_email"),
        ...
        "org_postal_address": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Customer_OrgPostalAddressFields,
        ),
