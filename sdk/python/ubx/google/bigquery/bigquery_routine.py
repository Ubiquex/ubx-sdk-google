...
class BigqueryRoutine_Arguments_DataType_StructType_Fields:
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class BigqueryRoutine_Arguments_DataType_StructType:
    fields: Any = None

@dataclasses.dataclass
class BigqueryRoutine_Arguments_DataType:
...
@dataclasses.dataclass
class BigqueryRoutine_Arguments_TableType_Columns_Type_StructType:
    fields: Any = None

@dataclasses.dataclass
class BigqueryRoutine_Arguments_TableType_Columns_Type:
    array_element_type: Any = None
    range_element_type: Any = None
    struct_type: Any = None
    type_kind: Any = None
...
@dataclasses.dataclass
class BigqueryRoutine_Arguments_TableType_Columns:
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class BigqueryRoutine_Arguments_TableType:
    columns: Any = None

@dataclasses.dataclass
class BigqueryRoutine_Arguments:
...
@dataclasses.dataclass
class BigqueryRoutine_BuildStatus_ErrorResult:
...
@dataclasses.dataclass
class BigqueryRoutine_BuildStatus:
...
@dataclasses.dataclass
class BigqueryRoutine_ExternalRuntimeOptions:
...
@dataclasses.dataclass
class BigqueryRoutine_PythonOptions:
...
@dataclasses.dataclass
class BigqueryRoutine_RemoteFunctionOptions:
...
@dataclasses.dataclass
class BigqueryRoutine_RoutineReference:
...
@dataclasses.dataclass
class BigqueryRoutine_SparkOptions:
...
_BigqueryRoutine_Arguments_DataType_StructType_FieldsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_BigqueryRoutine_Arguments_DataType_StructTypeFields = {
    "fields": ubx.FieldSpec(
        wire_name="fields",
        kind="list",
        fields=_BigqueryRoutine_Arguments_DataType_StructType_FieldsFields,
    ),
}

_BigqueryRoutine_Arguments_DataTypeFields = {
    ...
    "struct_type": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BigqueryRoutine_Arguments_DataType_StructTypeFields,
    ),
    "type_kind": ubx.FieldSpec(wire_name="type_kind"),
}

_BigqueryRoutine_Arguments_TableType_Columns_Type_StructTypeFields = {
    "fields": ubx.FieldSpec(wire_name="fields"),
}

_BigqueryRoutine_Arguments_TableType_Columns_TypeFields = {
    "array_element_type": ubx.FieldSpec(wire_name="array_element_type"),
    "range_element_type": ubx.FieldSpec(wire_name="range_element_type"),
    "struct_type": ubx.FieldSpec(
        wire_name="struct_type",
        kind="object",
        fields=_BigqueryRoutine_Arguments_TableType_Columns_Type_StructTypeFields,
    ),
    "type_kind": ubx.FieldSpec(wire_name="type_kind"),
}

_BigqueryRoutine_Arguments_TableType_ColumnsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "type": ubx.FieldSpec(
        wire_name="type",
        kind="object",
        fields=_BigqueryRoutine_Arguments_TableType_Columns_TypeFields,
    ),
}

_BigqueryRoutine_Arguments_TableTypeFields = {
    "columns": ubx.FieldSpec(
        wire_name="columns",
        kind="list",
        fields=_BigqueryRoutine_Arguments_TableType_ColumnsFields,
    ),
}

_BigqueryRoutine_ArgumentsFields = {
    "argument_kind": ubx.FieldSpec(wire_name="argument_kind"),
    "data_type": ubx.FieldSpec(
        wire_name="data_type",
        kind="object",
        fields=_BigqueryRoutine_Arguments_DataTypeFields,
    ),
    ...
    "table_type": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BigqueryRoutine_Arguments_TableTypeFields,
    ),
}

_BigqueryRoutine_BuildStatus_ErrorResultFields = {
...
_BigqueryRoutine_BuildStatusFields = {
    ...
    "error_result": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BigqueryRoutine_BuildStatus_ErrorResultFields,
    ),
    "image_size_bytes": ubx.FieldSpec(wire_name="image_size_bytes"),
}

_BigqueryRoutine_ExternalRuntimeOptionsFields = {
...
_BigqueryRoutine_RoutineReferenceFields = {
...
_BigqueryRoutine_SparkOptionsFields = {
...
BigqueryRoutine = ubx.ResourceBinding(
    wire_type="google_bigquery_bigquery_routine",
    fields={
        "arguments": ubx.FieldSpec(
            wire_name="arguments",
            kind="list",
            fields=_BigqueryRoutine_ArgumentsFields,
        ),
        "build_status": ubx.FieldSpec(
            wire_name="build_status",
            kind="object",
            fields=_BigqueryRoutine_BuildStatusFields,
        ),
        ...
        "external_runtime_options": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BigqueryRoutine_ExternalRuntimeOptionsFields,
        ),
        ...
        "python_options": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BigqueryRoutine_PythonOptionsFields,
        ),
        "remote_function_options": ubx.FieldSpec(
            wire_name="remote_function_options",
            kind="object",
            fields=_BigqueryRoutine_RemoteFunctionOptionsFields,
        ),
        ...
        "routine_reference": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BigqueryRoutine_RoutineReferenceFields,
        ),
        ...
        "spark_options": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BigqueryRoutine_SparkOptionsFields,
        ),
