...
class BigqueryRowAccessPolicy_RowAccessPolicyReference:
...
_BigqueryRowAccessPolicy_RowAccessPolicyReferenceFields = {
...
@dataclasses.dataclass
class BigqueryRowAccessPolicyConfig:
...
@dataclasses.dataclass
class BigqueryRowAccessPolicyAttrs:
    # Output only. The time when this row access policy was created, in milliseconds since the epoch.
    creation_time: Any = None
    # Output only. A hash of this resource.
    etag: Any = None
...
BigqueryRowAccessPolicy = ubx.ResourceBinding(
    wire_type="google_bigquery_bigquery_row_access_policy",
    fields={
        ...
        "row_access_policy_reference": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BigqueryRowAccessPolicy_RowAccessPolicyReferenceFields,
        ),
    },
)
