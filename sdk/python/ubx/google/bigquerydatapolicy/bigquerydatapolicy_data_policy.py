...
class BigquerydatapolicyDataPolicy_DataGovernanceTag:
...
@dataclasses.dataclass
class BigquerydatapolicyDataPolicy_DataMaskingPolicy:
...
@dataclasses.dataclass
class BigquerydatapolicyDataPolicy_DataPolicy:
...
_BigquerydatapolicyDataPolicy_DataGovernanceTagFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_BigquerydatapolicyDataPolicy_DataMaskingPolicyFields = {
    "predefined_expression": ubx.FieldSpec(wire_name="predefined_expression"),
    "routine": ubx.FieldSpec(wire_name="routine"),
}

_BigquerydatapolicyDataPolicy_DataPolicyFields = {
    "data_governance_tag": ubx.FieldSpec(
        wire_name="data_governance_tag",
        kind="object",
        fields=_BigquerydatapolicyDataPolicy_DataGovernanceTagFields,
    ),
    "data_masking_policy": ubx.FieldSpec(
        wire_name="data_masking_policy",
        kind="object",
        fields=_BigquerydatapolicyDataPolicy_DataMaskingPolicyFields,
    ),
...
@dataclasses.dataclass
class BigquerydatapolicyDataPolicyConfig:
...
@dataclasses.dataclass
class BigquerydatapolicyDataPolicyAttrs:
    # This is a namespaced name specifying the key and the value. For example: `project-id/pii/sensitive`.
    data_governance_tag: Any = None
    # The policy used to specify data masking rule.
    data_masking_policy: Any = None
...
BigquerydatapolicyDataPolicy = ubx.ResourceBinding(
    wire_type="google_bigquerydatapolicy_bigquerydatapolicy_data_policy",
    fields={
        "data_policy": ubx.FieldSpec(
            wire_name="data_policy",
            kind="object",
            fields=_BigquerydatapolicyDataPolicy_DataPolicyFields,
        ),
        "data_policy_id": ubx.FieldSpec(wire_name="data_policy_id"),
    },
)
