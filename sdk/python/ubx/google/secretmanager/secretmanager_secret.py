...
@dataclasses.dataclass
class SecretmanagerSecret_Replication_Automatic:
    # Configuration for encrypting secret payloads using customer-managed encryption keys (CMEK).
    customer_managed_encryption: Any = None

@dataclasses.dataclass
class SecretmanagerSecret_Replication_UserManaged_Replicas:
    customer_managed_encryption: Any = None
    location: Any = None

@dataclasses.dataclass
class SecretmanagerSecret_Replication_UserManaged:
    # Required. The list of Replicas for this Secret. Cannot be empty.
    replicas: Any = None

@dataclasses.dataclass
class SecretmanagerSecret_Replication:
...
@dataclasses.dataclass
class SecretmanagerSecret_Rotation_ManagedRotationStatus_Error:
...
@dataclasses.dataclass
class SecretmanagerSecret_Rotation_ManagedRotationStatus:
...
@dataclasses.dataclass
class SecretmanagerSecret_Rotation:
...
@dataclasses.dataclass
class SecretmanagerSecret_Topics:
    name: Any = None

_SecretmanagerSecret_CustomerManagedEncryptionFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

_SecretmanagerSecret_PolicyMemberFields = {
...
_SecretmanagerSecret_Replication_AutomaticFields = {
    "customer_managed_encryption": ubx.FieldSpec(
        wire_name="customer_managed_encryption",
        kind="object",
        fields=_SecretmanagerSecret_CustomerManagedEncryptionFields,
    ),
}

_SecretmanagerSecret_Replication_UserManaged_ReplicasFields = {
    "customer_managed_encryption": ubx.FieldSpec(
        wire_name="customer_managed_encryption",
        kind="object",
        fields=_SecretmanagerSecret_CustomerManagedEncryptionFields,
...
_SecretmanagerSecret_Replication_UserManagedFields = {
    "replicas": ubx.FieldSpec(
        wire_name="replicas",
        kind="list",
        fields=_SecretmanagerSecret_Replication_UserManaged_ReplicasFields,
    ),
}

_SecretmanagerSecret_ReplicationFields = {
    "automatic": ubx.FieldSpec(
        wire_name="automatic",
        kind="object",
        fields=_SecretmanagerSecret_Replication_AutomaticFields,
    ),
    "user_managed": ubx.FieldSpec(
        wire_name="user_managed",
        kind="object",
        fields=_SecretmanagerSecret_Replication_UserManagedFields,
    ),
}

_SecretmanagerSecret_Rotation_ManagedRotationStatus_ErrorFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_SecretmanagerSecret_Rotation_ManagedRotationStatusFields = {
    "error": ubx.FieldSpec(
        wire_name="error",
        kind="object",
        fields=_SecretmanagerSecret_Rotation_ManagedRotationStatus_ErrorFields,
    ),
    "state": ubx.FieldSpec(wire_name="state"),
}

_SecretmanagerSecret_RotationFields = {
    "managed_rotation_status": ubx.FieldSpec(
        wire_name="managed_rotation_status",
        kind="object",
        fields=_SecretmanagerSecret_Rotation_ManagedRotationStatusFields,
    ),
    "next_rotation_time": ubx.FieldSpec(wire_name="next_rotation_time"),
    "rotation_period": ubx.FieldSpec(wire_name="rotation_period"),
}

_SecretmanagerSecret_TopicsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

@dataclasses.dataclass
class SecretmanagerSecretConfig:
...
@dataclasses.dataclass
class SecretmanagerSecretAttrs:
    # Optional. Custom metadata about the secret. Annotations are distinct from various forms of labels. Annotations exist to allow client tools to store their own state information without requiring a database. Annotation keys must be between 1 and 63 characters long, have a UTF-8 encoding of maximum 128 bytes, begin and end with an alphanumeric character ([a-z0-9A-Z]), and may have dashes (-), underscores (_), dots (.), and alphanumerics in between these symbols. The total size of annotation keys and values must be less than 16KiB.
    annotations: Any = None
    # Output only. The time at which the Secret was created.
    create_time: Any = None
...
SecretmanagerSecret = ubx.ResourceBinding(
    wire_type="google_secretmanager_secretmanager_secret",
    fields={
        ...
        "policy_member": ubx.FieldSpec(
            ...
            kind="object",
            fields=_SecretmanagerSecret_PolicyMemberFields,
        ),
        "replication": ubx.FieldSpec(
            wire_name="replication",
            kind="object",
            fields=_SecretmanagerSecret_ReplicationFields,
        ),
        "rotation": ubx.FieldSpec(
            wire_name="rotation",
            kind="object",
            fields=_SecretmanagerSecret_RotationFields,
        ),
        ...
        "topics": ubx.FieldSpec(
            wire_name="topics",
            kind="list",
            fields=_SecretmanagerSecret_TopicsFields,
        ),
