...
class V1beta2Secret_CustomerManagedEncryption:
    # Required. The resource name of the Cloud KMS CryptoKey used to encrypt secret payloads. For secrets using the UserManaged replication policy type, Cloud KMS CryptoKeys must reside in the same location as the replica location. For secrets using the Automatic replication policy type, Cloud KMS CryptoKeys must reside in `global`. The expected format is `projects/*/locations/*/keyRings/*/cryptoKeys/*`.
    kms_key_name: Any = None

@dataclasses.dataclass
class V1beta2Secret_Replication_Automatic:
    # Configuration for encrypting secret payloads using customer-managed encryption keys (CMEK).
    customer_managed_encryption: Any = None

@dataclasses.dataclass
class V1beta2Secret_Replication_UserManaged_Replicas:
    customer_managed_encryption: Any = None
    location: Any = None

@dataclasses.dataclass
class V1beta2Secret_Replication_UserManaged:
    # Required. The list of Replicas for this Secret. Cannot be empty.
    replicas: Any = None

@dataclasses.dataclass
class V1beta2Secret_Replication:
...
@dataclasses.dataclass
class V1beta2Secret_Topics:
    name: Any = None

_V1beta2Secret_CustomerManagedEncryptionFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

_V1beta2Secret_Replication_AutomaticFields = {
    "customer_managed_encryption": ubx.FieldSpec(
        wire_name="customer_managed_encryption",
        kind="object",
        fields=_V1beta2Secret_CustomerManagedEncryptionFields,
    ),
}

_V1beta2Secret_Replication_UserManaged_ReplicasFields = {
    "customer_managed_encryption": ubx.FieldSpec(
        wire_name="customer_managed_encryption",
        kind="object",
        fields=_V1beta2Secret_CustomerManagedEncryptionFields,
...
_V1beta2Secret_Replication_UserManagedFields = {
    "replicas": ubx.FieldSpec(
        wire_name="replicas",
        kind="list",
        fields=_V1beta2Secret_Replication_UserManaged_ReplicasFields,
    ),
}

_V1beta2Secret_ReplicationFields = {
    "automatic": ubx.FieldSpec(
        wire_name="automatic",
        kind="object",
        fields=_V1beta2Secret_Replication_AutomaticFields,
    ),
    "user_managed": ubx.FieldSpec(
        wire_name="user_managed",
        kind="object",
        fields=_V1beta2Secret_Replication_UserManagedFields,
    ),
}

_V1beta2Secret_RotationFields = {
    "next_rotation_time": ubx.FieldSpec(wire_name="next_rotation_time"),
    "rotation_period": ubx.FieldSpec(wire_name="rotation_period"),
}

_V1beta2Secret_TopicsFields = {
...
V1beta2Secret = ubx.ResourceBinding(
    ...
    fields={
        ...
        "replication": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta2Secret_ReplicationFields,
        ),
        "rotation": ubx.FieldSpec(
            wire_name="rotation",
            kind="object",
            fields=_V1beta2Secret_RotationFields,
        ),
        "tags": ubx.FieldSpec(wire_name="tags"),
        "topics": ubx.FieldSpec(
            wire_name="topics",
            kind="list",
            fields=_V1beta2Secret_TopicsFields,
        ),
