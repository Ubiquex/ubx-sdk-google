...
class DatastreamPrivateConnection_Error:
...
@dataclasses.dataclass
class DatastreamPrivateConnection_PscInterfaceConfig:
...
@dataclasses.dataclass
class DatastreamPrivateConnection_VpcPeeringConfig:
...
_DatastreamPrivateConnection_ErrorFields = {
...
_DatastreamPrivateConnection_PscInterfaceConfigFields = {
    "network_attachment": ubx.FieldSpec(wire_name="network_attachment"),
}

_DatastreamPrivateConnection_VpcPeeringConfigFields = {
    "subnet": ubx.FieldSpec(wire_name="subnet"),
    "vpc": ubx.FieldSpec(wire_name="vpc"),
}

@dataclasses.dataclass
class DatastreamPrivateConnectionConfig:
...
@dataclasses.dataclass
class DatastreamPrivateConnectionAttrs:
    # Output only. The create time of the resource.
    create_time: Any = None
    # Required. Display name.
    display_name: Any = None
...
DatastreamPrivateConnection = ubx.ResourceBinding(
    wire_type="google_datastream_datastream_private_connection",
    fields={
        ...
        "error": ubx.FieldSpec(
            wire_name="error",
            kind="object",
            fields=_DatastreamPrivateConnection_ErrorFields,
        ),
        ...
        "psc_interface_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DatastreamPrivateConnection_PscInterfaceConfigFields,
        ),
        ...
        "vpc_peering_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DatastreamPrivateConnection_VpcPeeringConfigFields,
        ),
    },
)
