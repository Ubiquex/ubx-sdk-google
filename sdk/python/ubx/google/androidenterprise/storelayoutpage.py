...
Storelayoutpage = ubx.ResourceBinding(
    wire_type="google_androidenterprise_storelayoutpage",
    fields={
        ...
        "name": ubx.FieldSpec(
            wire_name="name",
            kind="list",
            fields=_Storelayoutpage_NameFields,
        ),
    },
)
