...
FirebaseWebApp = ubx.ResourceBinding(
    wire_type="google_firebase_firebase_web_app",
    fields={
        "api_key_id": ubx.FieldSpec(wire_name="api_key_id"),
        "app_id": ubx.FieldSpec(wire_name="app_id"),
        "app_urls": ubx.FieldSpec(wire_name="app_urls"),
        ...
        "web_id": ubx.FieldSpec(wire_name="web_id"),
    },
)
