...
class NetworkmanagementNetworkMonitoringProviderConfig:
...
@dataclasses.dataclass
class NetworkmanagementNetworkMonitoringProviderAttrs:
    # Output only. The time the NetworkMonitoringProvider was created.
    create_time: Any = None
    # Output only. The list of error messages detected for the NetworkMonitoringProvider.
    errors: Any = None
...
NetworkmanagementNetworkMonitoringProvider = ubx.ResourceBinding(
    wire_type="google_networkmanagement_networkmanagement_network_monitoring_provider",
    fields={
