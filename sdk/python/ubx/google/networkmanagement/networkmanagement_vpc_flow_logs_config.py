...
class NetworkmanagementVpcFlowLogsConfigConfig:
...
@dataclasses.dataclass
class NetworkmanagementVpcFlowLogsConfigAttrs:
    # Optional. The aggregation interval for the logs. Default value is INTERVAL_5_SEC.
    aggregation_interval: Any = None
    # Output only. The time the config was created.
    create_time: Any = None
...
NetworkmanagementVpcFlowLogsConfig = ubx.ResourceBinding(
    wire_type="google_networkmanagement_networkmanagement_vpc_flow_logs_config",
    fields={
