...
class V1beta1VpcFlowLogsConfigConfig:
...
@dataclasses.dataclass
class V1beta1VpcFlowLogsConfigAttrs:
    # Optional. The aggregation interval for the logs. Default value is INTERVAL_5_SEC.
    aggregation_interval: Any = None
    # Output only. The time the config was created.
    create_time: Any = None
...
V1beta1VpcFlowLogsConfig = ubx.ResourceBinding(
    wire_type="google_networkmanagement_v1beta1_vpc_flow_logs_config",
    fields={
