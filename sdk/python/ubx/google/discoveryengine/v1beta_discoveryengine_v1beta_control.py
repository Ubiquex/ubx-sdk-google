...
class V1betaDiscoveryengineV1betaControl_BoostAction_InterpolationBoostSpec_ControlPoints:
    attribute_value: Any = None
    boost_amount: Any = None

@dataclasses.dataclass
class V1betaDiscoveryengineV1betaControl_BoostAction_InterpolationBoostSpec:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaControl_BoostAction:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaControl_Conditions_ActiveTimeRange:
    end_time: Any = None
    start_time: Any = None

@dataclasses.dataclass
class V1betaDiscoveryengineV1betaControl_Conditions_QueryTerms:
    full_match: Any = None
    value: Any = None

@dataclasses.dataclass
class V1betaDiscoveryengineV1betaControl_Conditions:
    active_time_range: Any = None
    query_regex: Any = None
    query_terms: Any = None

@dataclasses.dataclass
class V1betaDiscoveryengineV1betaControl_FilterAction:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaControl_PromoteAction_SearchLinkPromotion:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaControl_PromoteAction:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaControl_RedirectAction:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaControl_SynonymsAction:
...
_V1betaDiscoveryengineV1betaControl_BoostAction_InterpolationBoostSpec_ControlPointsFields = {
    "attribute_value": ubx.FieldSpec(wire_name="attribute_value"),
    "boost_amount": ubx.FieldSpec(wire_name="boost_amount"),
}

_V1betaDiscoveryengineV1betaControl_BoostAction_InterpolationBoostSpecFields = {
    "attribute_type": ubx.FieldSpec(wire_name="attribute_type"),
    "control_points": ubx.FieldSpec(
        wire_name="control_points",
        kind="list",
        fields=_V1betaDiscoveryengineV1betaControl_BoostAction_InterpolationBoostSpec_ControlPointsFields,
    ),
    "field_name": ubx.FieldSpec(wire_name="field_name"),
    "interpolation_type": ubx.FieldSpec(wire_name="interpolation_type"),
}

_V1betaDiscoveryengineV1betaControl_BoostActionFields = {
    ...
    "interpolation_boost_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaDiscoveryengineV1betaControl_BoostAction_InterpolationBoostSpecFields,
    ),
}

_V1betaDiscoveryengineV1betaControl_Conditions_ActiveTimeRangeFields = {
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

_V1betaDiscoveryengineV1betaControl_Conditions_QueryTermsFields = {
    "full_match": ubx.FieldSpec(wire_name="full_match"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_V1betaDiscoveryengineV1betaControl_ConditionsFields = {
    "active_time_range": ubx.FieldSpec(
        wire_name="active_time_range",
        kind="list",
        fields=_V1betaDiscoveryengineV1betaControl_Conditions_ActiveTimeRangeFields,
    ),
    "query_regex": ubx.FieldSpec(wire_name="query_regex"),
    "query_terms": ubx.FieldSpec(
        wire_name="query_terms",
        kind="list",
        fields=_V1betaDiscoveryengineV1betaControl_Conditions_QueryTermsFields,
    ),
}

_V1betaDiscoveryengineV1betaControl_FilterActionFields = {
    "data_store": ubx.FieldSpec(wire_name="data_store"),
    "filter": ubx.FieldSpec(wire_name="filter"),
}

_V1betaDiscoveryengineV1betaControl_PromoteAction_SearchLinkPromotionFields = {
...
_V1betaDiscoveryengineV1betaControl_PromoteActionFields = {
    "data_store": ubx.FieldSpec(wire_name="data_store"),
    "search_link_promotion": ubx.FieldSpec(
        wire_name="search_link_promotion",
        kind="object",
        fields=_V1betaDiscoveryengineV1betaControl_PromoteAction_SearchLinkPromotionFields,
    ),
}

_V1betaDiscoveryengineV1betaControl_RedirectActionFields = {
    "redirect_uri": ubx.FieldSpec(wire_name="redirect_uri"),
}

_V1betaDiscoveryengineV1betaControl_SynonymsActionFields = {
    "synonyms": ubx.FieldSpec(wire_name="synonyms"),
}

@dataclasses.dataclass
class V1betaDiscoveryengineV1betaControlConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaControlAttrs:
    # Output only. List of all ServingConfig IDs this control is attached to. May take up to 10 minutes to update after changes.
    associated_serving_config_ids: Any = None
    # Adjusts order of products in returned list.
    boost_action: Any = None
...
V1betaDiscoveryengineV1betaControl = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1beta_discoveryengine_v1beta_control",
    fields={
        ...
        "boost_action": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaDiscoveryengineV1betaControl_BoostActionFields,
        ),
        "conditions": ubx.FieldSpec(
            wire_name="conditions",
            kind="list",
            fields=_V1betaDiscoveryengineV1betaControl_ConditionsFields,
        ),
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        "filter_action": ubx.FieldSpec(
            wire_name="filter_action",
            kind="object",
            fields=_V1betaDiscoveryengineV1betaControl_FilterActionFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "promote_action": ubx.FieldSpec(
            wire_name="promote_action",
            kind="object",
            fields=_V1betaDiscoveryengineV1betaControl_PromoteActionFields,
        ),
        "redirect_action": ubx.FieldSpec(
            wire_name="redirect_action",
            kind="object",
            fields=_V1betaDiscoveryengineV1betaControl_RedirectActionFields,
        ),
        "solution_type": ubx.FieldSpec(wire_name="solution_type"),
        "synonyms_action": ubx.FieldSpec(
            wire_name="synonyms_action",
            kind="object",
            fields=_V1betaDiscoveryengineV1betaControl_SynonymsActionFields,
        ),
