...
class V1betaDiscoveryengineV1betaEngine_AgentGatewaySetting_DefaultEgressAgentGateway:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_AgentGatewaySetting:
    # Reference to an Agent Gateway resource.
    default_egress_agent_gateway: Any = None

@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_ChatEngineConfig_AgentCreationConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_ChatEngineConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_ChatEngineMetadata:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_CmekConfig_SingleRegionKeys:
    kms_key: Any = None

@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_CmekConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_CommonConfig:
    # The name of the company, business or entity that is associated with the engine. Setting this may help improve LLM related features.
    company_name: Any = None

@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_KnowledgeGraphConfig_FeatureConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_KnowledgeGraphConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_ObservabilityConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngine_SearchEngineConfig:
...
_V1betaDiscoveryengineV1betaEngine_AgentGatewaySetting_DefaultEgressAgentGatewayFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

_V1betaDiscoveryengineV1betaEngine_AgentGatewaySettingFields = {
    "default_egress_agent_gateway": ubx.FieldSpec(
        wire_name="default_egress_agent_gateway",
        kind="object",
        fields=_V1betaDiscoveryengineV1betaEngine_AgentGatewaySetting_DefaultEgressAgentGatewayFields,
    ),
}

_V1betaDiscoveryengineV1betaEngine_ChatEngineConfig_AgentCreationConfigFields = {
...
_V1betaDiscoveryengineV1betaEngine_ChatEngineConfigFields = {
    "agent_creation_config": ubx.FieldSpec(
        wire_name="agent_creation_config",
        kind="object",
        fields=_V1betaDiscoveryengineV1betaEngine_ChatEngineConfig_AgentCreationConfigFields,
    ),
...
_V1betaDiscoveryengineV1betaEngine_ChatEngineMetadataFields = {
    "dialogflow_agent": ubx.FieldSpec(wire_name="dialogflow_agent"),
}

_V1betaDiscoveryengineV1betaEngine_CmekConfig_SingleRegionKeysFields = {
    "kms_key": ubx.FieldSpec(wire_name="kms_key"),
}

_V1betaDiscoveryengineV1betaEngine_CmekConfigFields = {
    ...
    "single_region_keys": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1betaDiscoveryengineV1betaEngine_CmekConfig_SingleRegionKeysFields,
    ),
    "state": ubx.FieldSpec(wire_name="state"),
}

_V1betaDiscoveryengineV1betaEngine_CommonConfigFields = {
    "company_name": ubx.FieldSpec(wire_name="company_name"),
}

_V1betaDiscoveryengineV1betaEngine_KnowledgeGraphConfig_FeatureConfigFields = {
...
_V1betaDiscoveryengineV1betaEngine_KnowledgeGraphConfigFields = {
    ...
    "feature_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaDiscoveryengineV1betaEngine_KnowledgeGraphConfig_FeatureConfigFields,
    ),
    "private_knowledge_graph_types": ubx.FieldSpec(wire_name="private_knowledge_graph_types"),
}

_V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfigFields = {
    "time_window_days": ubx.FieldSpec(wire_name="time_window_days"),
}

_V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfigFields = {
    "context_event_type": ubx.FieldSpec(wire_name="context_event_type"),
}

_V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfigFields = {
    "most_popular_config": ubx.FieldSpec(
        wire_name="most_popular_config",
        kind="object",
        fields=_V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_MostPopularConfigFields,
    ),
    "recommended_for_you_config": ubx.FieldSpec(
        wire_name="recommended_for_you_config",
        kind="object",
        fields=_V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfig_RecommendedForYouConfigFields,
    ),
}

_V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfigFields = {
...
_V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfigFields = {
    "engine_features_config": ubx.FieldSpec(
        wire_name="engine_features_config",
        kind="object",
        fields=_V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig_EngineFeaturesConfigFields,
    ),
    ...
    "optimization_objective_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfig_OptimizationObjectiveConfigFields,
    ),
    "training_state": ubx.FieldSpec(wire_name="training_state"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_V1betaDiscoveryengineV1betaEngine_ObservabilityConfigFields = {
...
_V1betaDiscoveryengineV1betaEngine_SearchEngineConfigFields = {
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngineConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaEngineAttrs:
    # Agent Gateway setting, which may be attached to Gemini Enterprise resources for egress control of Gemini Enterprise agents to agents and tools outside of Gemini Enterprise.
    agent_gateway_setting: Any = None
    # Optional. Immutable. This the application type which this engine resource represents. NOTE: this is a new concept independ of existing industry vertical or solution type.
    app_type: Any = None
...
V1betaDiscoveryengineV1betaEngine = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1beta_discoveryengine_v1beta_engine",
    fields={
        "agent_gateway_setting": ubx.FieldSpec(
            wire_name="agent_gateway_setting",
            kind="object",
            fields=_V1betaDiscoveryengineV1betaEngine_AgentGatewaySettingFields,
        ),
        ...
        "chat_engine_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaDiscoveryengineV1betaEngine_ChatEngineConfigFields,
        ),
        "chat_engine_metadata": ubx.FieldSpec(
            wire_name="chat_engine_metadata",
            kind="object",
            fields=_V1betaDiscoveryengineV1betaEngine_ChatEngineMetadataFields,
        ),
        "cmek_config": ubx.FieldSpec(
            wire_name="cmek_config",
            kind="object",
            fields=_V1betaDiscoveryengineV1betaEngine_CmekConfigFields,
        ),
        "common_config": ubx.FieldSpec(
            wire_name="common_config",
            kind="object",
            fields=_V1betaDiscoveryengineV1betaEngine_CommonConfigFields,
        ),
        ...
        "knowledge_graph_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaDiscoveryengineV1betaEngine_KnowledgeGraphConfigFields,
        ),
        ...
        "media_recommendation_engine_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaDiscoveryengineV1betaEngine_MediaRecommendationEngineConfigFields,
        ),
        ...
        "observability_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaDiscoveryengineV1betaEngine_ObservabilityConfigFields,
        ),
        ...
        "search_engine_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaDiscoveryengineV1betaEngine_SearchEngineConfigFields,
        ),
