...
class V1betaDiscoveryengineV1betaSampleQuerySetConfig:
...
@dataclasses.dataclass
class V1betaDiscoveryengineV1betaSampleQuerySetAttrs:
    # Output only. Timestamp the SampleQuerySet was created at.
    create_time: Any = None
    # The description of the SampleQuerySet.
    description: Any = None
...
V1betaDiscoveryengineV1betaSampleQuerySet = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1beta_discoveryengine_v1beta_sample_query_set",
    fields={
