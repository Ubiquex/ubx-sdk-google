...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_QuerySetSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpec_ConditionBoostSpecs_BoostControlSpec_ControlPoints:
    attribute_value: Any = None
    boost_amount: Any = None

@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpec_ConditionBoostSpecs_BoostControlSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpec_ConditionBoostSpecs:
    boost: Any = None
    boost_control_spec: Any = None
    condition: Any = None

@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_ChunkSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_ExtractiveContentSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SnippetSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SummarySpec_ModelPromptSpec:
    # Text at the beginning of the prompt that instructs the assistant. Examples are available in the user guide.
    preamble: Any = None

@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SummarySpec_ModelSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SummarySpec_MultimodalSpec:
    # Optional. Source of image returned in the answer.
    image_source: Any = None

@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SummarySpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_CrowdingSpecs:
    field: Any = None
    max_count: Any = None
    mode: Any = None

@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_CustomRankingParams:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_DataStoreSpecs:
    boost_spec: Any = None
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_DisplaySpec:
    # The condition under which match highlighting should occur.
    match_highlighting_condition: Any = None

@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_EmbeddingSpec_EmbeddingVectors:
    field_path: Any = None
    vector: Any = None

@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_EmbeddingSpec:
    # The embedding vector used for retrieval. Limit to 1.
    embedding_vectors: Any = None

@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_FacetSpecs_FacetKey_Intervals:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_FacetSpecs_FacetKey:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_FacetSpecs:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_ImageQuery:
    # Base64 encoded image bytes. Supported image formats: JPEG, PNG, and BMP.
    image_bytes: Any = None

@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_NaturalLanguageQueryUnderstandingSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_PersonalizationSpec:
    # The personalization mode of the search request. Defaults to Mode.AUTO.
    mode: Any = None

@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_QueryExpansionSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_RelevanceFilterSpec_KeywordSearchThreshold:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_RelevanceFilterSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_RelevanceScoreSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_SearchAddonSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_SearchAsYouTypeSpec:
    # The condition under which search as you type should occur. Default to Condition.DISABLED.
    condition: Any = None

@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_SessionSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_UserInfo_PreciseLocation_Point:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_UserInfo_PreciseLocation:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest_UserInfo:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec_SearchRequest:
...
@dataclasses.dataclass
class V1betaEvaluation_EvaluationSpec:
...
@dataclasses.dataclass
class V1betaEvaluation_QualityMetrics_DocNdcg:
    # The top-1 value.
    top1: Any = None
    # The top-10 value.
    top10: Any = None
...
@dataclasses.dataclass
class V1betaEvaluation_QualityMetrics:
...
_V1betaEvaluation_ErrorFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V1betaEvaluation_EvaluationSpec_QuerySetSpecFields = {
    "sample_query_set": ubx.FieldSpec(wire_name="sample_query_set"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpec_ConditionBoostSpecs_BoostControlSpec_ControlPointsFields = {
    "attribute_value": ubx.FieldSpec(wire_name="attribute_value"),
    "boost_amount": ubx.FieldSpec(wire_name="boost_amount"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpec_ConditionBoostSpecs_BoostControlSpecFields = {
    "attribute_type": ubx.FieldSpec(wire_name="attribute_type"),
    "control_points": ubx.FieldSpec(
        wire_name="control_points",
        kind="list",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpec_ConditionBoostSpecs_BoostControlSpec_ControlPointsFields,
    ),
    "field_name": ubx.FieldSpec(wire_name="field_name"),
    "interpolation_type": ubx.FieldSpec(wire_name="interpolation_type"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpec_ConditionBoostSpecsFields = {
    "boost": ubx.FieldSpec(wire_name="boost"),
    "boost_control_spec": ubx.FieldSpec(
        wire_name="boost_control_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpec_ConditionBoostSpecs_BoostControlSpecFields,
    ),
    "condition": ubx.FieldSpec(wire_name="condition"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpecFields = {
    "condition_boost_specs": ubx.FieldSpec(
        wire_name="condition_boost_specs",
        kind="list",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpec_ConditionBoostSpecsFields,
    ),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_ChunkSpecFields = {
    "num_next_chunks": ubx.FieldSpec(wire_name="num_next_chunks"),
    "num_previous_chunks": ubx.FieldSpec(wire_name="num_previous_chunks"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_ExtractiveContentSpecFields = {
...
_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SnippetSpecFields = {
...
_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SummarySpec_ModelPromptSpecFields = {
    "preamble": ubx.FieldSpec(wire_name="preamble"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SummarySpec_ModelSpecFields = {
    "version": ubx.FieldSpec(wire_name="version"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SummarySpec_MultimodalSpecFields = {
    "image_source": ubx.FieldSpec(wire_name="image_source"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SummarySpecFields = {
    ...
    "model_prompt_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SummarySpec_ModelPromptSpecFields,
    ),
    "model_spec": ubx.FieldSpec(
        wire_name="model_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SummarySpec_ModelSpecFields,
    ),
    "multimodal_spec": ubx.FieldSpec(
        wire_name="multimodal_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SummarySpec_MultimodalSpecFields,
    ),
...
_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpecFields = {
    "chunk_spec": ubx.FieldSpec(
        wire_name="chunk_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_ChunkSpecFields,
    ),
    "extractive_content_spec": ubx.FieldSpec(
        wire_name="extractive_content_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_ExtractiveContentSpecFields,
    ),
    "search_result_mode": ubx.FieldSpec(wire_name="search_result_mode"),
    "snippet_spec": ubx.FieldSpec(
        wire_name="snippet_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SnippetSpecFields,
    ),
    "summary_spec": ubx.FieldSpec(
        wire_name="summary_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpec_SummarySpecFields,
    ),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_CrowdingSpecsFields = {
    "field": ubx.FieldSpec(wire_name="field"),
    "max_count": ubx.FieldSpec(wire_name="max_count"),
    "mode": ubx.FieldSpec(wire_name="mode"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_CustomRankingParamsFields = {
    "expressions_to_precompute": ubx.FieldSpec(wire_name="expressions_to_precompute"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_DataStoreSpecsFields = {
    "boost_spec": ubx.FieldSpec(
        wire_name="boost_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpecFields,
    ),
...
_V1betaEvaluation_EvaluationSpec_SearchRequest_DisplaySpecFields = {
    "match_highlighting_condition": ubx.FieldSpec(wire_name="match_highlighting_condition"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_EmbeddingSpec_EmbeddingVectorsFields = {
    "field_path": ubx.FieldSpec(wire_name="field_path"),
    "vector": ubx.FieldSpec(wire_name="vector"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_EmbeddingSpecFields = {
    "embedding_vectors": ubx.FieldSpec(
        wire_name="embedding_vectors",
        kind="list",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_EmbeddingSpec_EmbeddingVectorsFields,
    ),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_FacetSpecs_FacetKey_IntervalsFields = {
...
_V1betaEvaluation_EvaluationSpec_SearchRequest_FacetSpecs_FacetKeyFields = {
    ...
    "intervals": ubx.FieldSpec(
        wire_name="intervals",
        kind="list",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_FacetSpecs_FacetKey_IntervalsFields,
    ),
...
_V1betaEvaluation_EvaluationSpec_SearchRequest_FacetSpecsFields = {
    ...
    "facet_key": ubx.FieldSpec(
        wire_name="facet_key",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_FacetSpecs_FacetKeyFields,
    ),
    "limit": ubx.FieldSpec(wire_name="limit"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_ImageQueryFields = {
    "image_bytes": ubx.FieldSpec(wire_name="image_bytes"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_NaturalLanguageQueryUnderstandingSpecFields = {
...
_V1betaEvaluation_EvaluationSpec_SearchRequest_PersonalizationSpecFields = {
    "mode": ubx.FieldSpec(wire_name="mode"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_QueryExpansionSpecFields = {
    "condition": ubx.FieldSpec(wire_name="condition"),
    "pin_unexpanded_results": ubx.FieldSpec(wire_name="pin_unexpanded_results"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_RelevanceFilterSpec_KeywordSearchThresholdFields = {
...
_V1betaEvaluation_EvaluationSpec_SearchRequest_RelevanceFilterSpecFields = {
    "keyword_search_threshold": ubx.FieldSpec(
        wire_name="keyword_search_threshold",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_RelevanceFilterSpec_KeywordSearchThresholdFields,
    ),
...
_V1betaEvaluation_EvaluationSpec_SearchRequest_RelevanceScoreSpecFields = {
    "return_relevance_score": ubx.FieldSpec(wire_name="return_relevance_score"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_SearchAddonSpecFields = {
...
_V1betaEvaluation_EvaluationSpec_SearchRequest_SearchAsYouTypeSpecFields = {
    "condition": ubx.FieldSpec(wire_name="condition"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_SessionSpecFields = {
...
_V1betaEvaluation_EvaluationSpec_SearchRequest_UserInfo_PreciseLocation_PointFields = {
    "latitude": ubx.FieldSpec(wire_name="latitude"),
    "longitude": ubx.FieldSpec(wire_name="longitude"),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_UserInfo_PreciseLocationFields = {
    "address": ubx.FieldSpec(wire_name="address"),
    "point": ubx.FieldSpec(
        wire_name="point",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_UserInfo_PreciseLocation_PointFields,
    ),
}

_V1betaEvaluation_EvaluationSpec_SearchRequest_UserInfoFields = {
    "precise_location": ubx.FieldSpec(
        wire_name="precise_location",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_UserInfo_PreciseLocationFields,
    ),
...
_V1betaEvaluation_EvaluationSpec_SearchRequestFields = {
    "boost_spec": ubx.FieldSpec(
        wire_name="boost_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_BoostSpecFields,
    ...
    "content_search_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_ContentSearchSpecFields,
    ),
    "crowding_specs": ubx.FieldSpec(
        wire_name="crowding_specs",
        kind="list",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_CrowdingSpecsFields,
    ),
    "custom_ranking_params": ubx.FieldSpec(
        wire_name="custom_ranking_params",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_CustomRankingParamsFields,
    ),
    "data_store_specs": ubx.FieldSpec(
        wire_name="data_store_specs",
        kind="list",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_DataStoreSpecsFields,
    ),
    "display_spec": ubx.FieldSpec(
        wire_name="display_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_DisplaySpecFields,
    ),
    "embedding_spec": ubx.FieldSpec(
        wire_name="embedding_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_EmbeddingSpecFields,
    ),
    "entity": ubx.FieldSpec(wire_name="entity"),
    "facet_specs": ubx.FieldSpec(
        wire_name="facet_specs",
        kind="list",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_FacetSpecsFields,
    ),
    "filter": ubx.FieldSpec(wire_name="filter"),
    "image_query": ubx.FieldSpec(
        wire_name="image_query",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_ImageQueryFields,
    ),
    "language_code": ubx.FieldSpec(wire_name="language_code"),
    "natural_language_query_understanding_spec": ubx.FieldSpec(
        wire_name="natural_language_query_understanding_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_NaturalLanguageQueryUnderstandingSpecFields,
    ),
    ...
    "personalization_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_PersonalizationSpecFields,
    ),
    "query": ubx.FieldSpec(wire_name="query"),
    "query_expansion_spec": ubx.FieldSpec(
        wire_name="query_expansion_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_QueryExpansionSpecFields,
    ),
    ...
    "relevance_filter_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_RelevanceFilterSpecFields,
    ),
    "relevance_score_spec": ubx.FieldSpec(
        wire_name="relevance_score_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_RelevanceScoreSpecFields,
    ),
    "relevance_threshold": ubx.FieldSpec(wire_name="relevance_threshold"),
    ...
    "search_addon_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_SearchAddonSpecFields,
    ),
    "search_as_you_type_spec": ubx.FieldSpec(
        wire_name="search_as_you_type_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_SearchAsYouTypeSpecFields,
    ),
    ...
    "session_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_SessionSpecFields,
    ),
    ...
    "user_info": ubx.FieldSpec(
        wire_name="user_info",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequest_UserInfoFields,
    ),
    "user_labels": ubx.FieldSpec(wire_name="user_labels"),
    "user_pseudo_id": ubx.FieldSpec(wire_name="user_pseudo_id"),
}

_V1betaEvaluation_EvaluationSpecFields = {
    "query_set_spec": ubx.FieldSpec(
        wire_name="query_set_spec",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_QuerySetSpecFields,
    ),
    "search_request": ubx.FieldSpec(
        wire_name="search_request",
        kind="object",
        fields=_V1betaEvaluation_EvaluationSpec_SearchRequestFields,
    ),
}

_V1betaEvaluation_QualityMetrics_DocNdcgFields = {
...
_V1betaEvaluation_QualityMetricsFields = {
    "doc_ndcg": ubx.FieldSpec(
        wire_name="doc_ndcg",
        kind="object",
        fields=_V1betaEvaluation_QualityMetrics_DocNdcgFields,
    ),
...
V1betaEvaluation = ubx.ResourceBinding(
    ...
    fields={
        ...
        "evaluation_spec": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaEvaluation_EvaluationSpecFields,
        ),
