...
class V1alphaDiscoveryengineV1alphaSchema_FieldConfigs:
...
_V1alphaDiscoveryengineV1alphaSchema_FieldConfigsFields = {
...
@dataclasses.dataclass
class V1alphaDiscoveryengineV1alphaSchemaConfig:
...
@dataclasses.dataclass
class V1alphaDiscoveryengineV1alphaSchemaAttrs:
    # Output only. Configurations for fields of the schema.
    field_configs: Any = None
    # The JSON representation of the schema.
    json_schema: Any = None
...
V1alphaDiscoveryengineV1alphaSchema = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1alpha_discoveryengine_v1alpha_schema",
    fields={
        "field_configs": ubx.FieldSpec(
            wire_name="field_configs",
            kind="list",
            fields=_V1alphaDiscoveryengineV1alphaSchema_FieldConfigsFields,
        ),
