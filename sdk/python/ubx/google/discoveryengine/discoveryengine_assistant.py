...
class DiscoveryengineAssistant_CustomerPolicy_BannedPhrases:
    ignore_diacritics: Any = None
    match_type: Any = None
    phrase: Any = None

@dataclasses.dataclass
class DiscoveryengineAssistant_CustomerPolicy_ModelArmorConfig:
...
@dataclasses.dataclass
class DiscoveryengineAssistant_CustomerPolicy:
...
@dataclasses.dataclass
class DiscoveryengineAssistant_EnabledTools_ToolInfo:
    tool_display_name: Any = None
    tool_name: Any = None

@dataclasses.dataclass
class DiscoveryengineAssistant_EnabledTools:
    tool_info: Any = None

@dataclasses.dataclass
class DiscoveryengineAssistant_GenerationConfig_SystemInstruction:
...
@dataclasses.dataclass
class DiscoveryengineAssistant_GenerationConfig:
...
_DiscoveryengineAssistant_CustomerPolicy_BannedPhrasesFields = {
...
_DiscoveryengineAssistant_CustomerPolicy_ModelArmorConfigFields = {
...
_DiscoveryengineAssistant_CustomerPolicyFields = {
    "banned_phrases": ubx.FieldSpec(
        wire_name="banned_phrases",
        kind="list",
        fields=_DiscoveryengineAssistant_CustomerPolicy_BannedPhrasesFields,
    ),
    "model_armor_config": ubx.FieldSpec(
        wire_name="model_armor_config",
        kind="object",
        fields=_DiscoveryengineAssistant_CustomerPolicy_ModelArmorConfigFields,
    ),
}

_DiscoveryengineAssistant_EnabledTools_ToolInfoFields = {
    "tool_display_name": ubx.FieldSpec(wire_name="tool_display_name"),
    "tool_name": ubx.FieldSpec(wire_name="tool_name"),
}

_DiscoveryengineAssistant_EnabledToolsFields = {
    "tool_info": ubx.FieldSpec(
        wire_name="tool_info",
        kind="list",
        fields=_DiscoveryengineAssistant_EnabledTools_ToolInfoFields,
    ),
}

_DiscoveryengineAssistant_GenerationConfig_SystemInstructionFields = {
    "additional_system_instruction": ubx.FieldSpec(wire_name="additional_system_instruction"),
}

_DiscoveryengineAssistant_GenerationConfigFields = {
    ...
    "system_instruction": ubx.FieldSpec(
        ...
        kind="object",
        fields=_DiscoveryengineAssistant_GenerationConfig_SystemInstructionFields,
    ),
}

@dataclasses.dataclass
class DiscoveryengineAssistantConfig:
...
@dataclasses.dataclass
class DiscoveryengineAssistantAttrs:
    # Output only. Represents the time when this Assistant was created.
    create_time: Any = None
    # Customer-defined policy for the assistant.
    customer_policy: Any = None
...
DiscoveryengineAssistant = ubx.ResourceBinding(
    wire_type="google_discoveryengine_discoveryengine_assistant",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "customer_policy": ubx.FieldSpec(
            wire_name="customer_policy",
            kind="object",
            fields=_DiscoveryengineAssistant_CustomerPolicyFields,
        ),
        ...
        "enabled_tools": ubx.FieldSpec(
            ...
            kind="map",
            fields=_DiscoveryengineAssistant_EnabledToolsFields,
        ),
        "generation_config": ubx.FieldSpec(
            wire_name="generation_config",
            kind="object",
            fields=_DiscoveryengineAssistant_GenerationConfigFields,
        ),
