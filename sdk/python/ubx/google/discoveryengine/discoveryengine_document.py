...
class DiscoveryengineDocument_AclInfo_Readers_Principals:
    external_entity_id: Any = None
    group_id: Any = None
    user_id: Any = None

@dataclasses.dataclass
class DiscoveryengineDocument_AclInfo_Readers:
    idp_wide: Any = None
    principals: Any = None

@dataclasses.dataclass
class DiscoveryengineDocument_AclInfo:
    # Readers of the document.
    readers: Any = None

@dataclasses.dataclass
class DiscoveryengineDocument_Content:
...
@dataclasses.dataclass
class DiscoveryengineDocument_IndexStatus_ErrorSamples:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class DiscoveryengineDocument_IndexStatus:
...
_DiscoveryengineDocument_AclInfo_Readers_PrincipalsFields = {
...
_DiscoveryengineDocument_AclInfo_ReadersFields = {
    "idp_wide": ubx.FieldSpec(wire_name="idp_wide"),
    "principals": ubx.FieldSpec(
        wire_name="principals",
        kind="list",
        fields=_DiscoveryengineDocument_AclInfo_Readers_PrincipalsFields,
    ),
}

_DiscoveryengineDocument_AclInfoFields = {
    "readers": ubx.FieldSpec(
        wire_name="readers",
        kind="list",
        fields=_DiscoveryengineDocument_AclInfo_ReadersFields,
    ),
}

_DiscoveryengineDocument_ContentFields = {
    "mime_type": ubx.FieldSpec(wire_name="mime_type"),
    "raw_bytes": ubx.FieldSpec(wire_name="raw_bytes"),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_DiscoveryengineDocument_IndexStatus_ErrorSamplesFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_DiscoveryengineDocument_IndexStatusFields = {
    "error_samples": ubx.FieldSpec(
        wire_name="error_samples",
        kind="list",
        fields=_DiscoveryengineDocument_IndexStatus_ErrorSamplesFields,
    ),
...
@dataclasses.dataclass
class DiscoveryengineDocumentConfig:
...
@dataclasses.dataclass
class DiscoveryengineDocumentAttrs:
    # ACL Information of the Document.
    acl_info: Any = None
    # Unstructured data linked to this document.
    content: Any = None
...
DiscoveryengineDocument = ubx.ResourceBinding(
    wire_type="google_discoveryengine_discoveryengine_document",
    fields={
        "acl_info": ubx.FieldSpec(
            wire_name="acl_info",
            kind="object",
            fields=_DiscoveryengineDocument_AclInfoFields,
        ),
        "content": ubx.FieldSpec(
            wire_name="content",
            kind="object",
            fields=_DiscoveryengineDocument_ContentFields,
        ),
        ...
        "index_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DiscoveryengineDocument_IndexStatusFields,
        ),
        "index_time": ubx.FieldSpec(wire_name="index_time"),
