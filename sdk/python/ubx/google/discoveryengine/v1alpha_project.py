...
@dataclasses.dataclass
class V1alphaProject_SaasParams:
...
_V1alphaProject_SaasParamsFields = {
    "accept_biz_qos": ubx.FieldSpec(wire_name="accept_biz_qos"),
    "is_biz": ubx.FieldSpec(wire_name="is_biz"),
}
...
class V1alphaProjectConfig:
    ...
    accept_data_use_terms: Any = None
    ...
    data_use_terms_version: Any = None
    # Parameters for Agentspace.
    saas_params: Any = None
...
V1alphaProject = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1alpha_project",
    fields={
        "accept_data_use_terms": ubx.FieldSpec(wire_name="accept_data_use_terms"),
        "data_use_terms_version": ubx.FieldSpec(wire_name="data_use_terms_version"),
        "saas_params": ubx.FieldSpec(
            wire_name="saas_params",
            kind="object",
            fields=_V1alphaProject_SaasParamsFields,
        ),
    },
)
