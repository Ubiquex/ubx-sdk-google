...
class V1alphaCannedQuery_DefaultTexts_SuggestedPrompts:
    prompt_text: Any = None

@dataclasses.dataclass
class V1alphaCannedQuery_DefaultTexts:
...
@dataclasses.dataclass
class V1alphaCannedQuery_RequiredCapabilities:
    action_name: Any = None

_V1alphaCannedQuery_DefaultTexts_SuggestedPromptsFields = {
    "prompt_text": ubx.FieldSpec(wire_name="prompt_text"),
}

_V1alphaCannedQuery_DefaultTextsFields = {
    "prefix": ubx.FieldSpec(wire_name="prefix"),
    "suggested_prompts": ubx.FieldSpec(
        wire_name="suggested_prompts",
        kind="list",
        fields=_V1alphaCannedQuery_DefaultTexts_SuggestedPromptsFields,
    ),
    "title": ubx.FieldSpec(wire_name="title"),
}

_V1alphaCannedQuery_RequiredCapabilitiesFields = {
    "action_name": ubx.FieldSpec(wire_name="action_name"),
}

@dataclasses.dataclass
class V1alphaCannedQueryConfig:
...
V1alphaCannedQuery = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1alpha_canned_query",
    fields={
        "default_texts": ubx.FieldSpec(
            wire_name="default_texts",
            kind="object",
            fields=_V1alphaCannedQuery_DefaultTextsFields,
        ),
        ...
        "required_capabilities": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1alphaCannedQuery_RequiredCapabilitiesFields,
        ),
    },
)
