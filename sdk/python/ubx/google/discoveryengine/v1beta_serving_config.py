...
class V1betaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpec:
...
@dataclasses.dataclass
class V1betaServingConfig_AnswerGenerationSpec:
    # The specification for user defined classifier.
    user_defined_classifier_spec: Any = None

@dataclasses.dataclass
class V1betaServingConfig_EmbeddingConfig:
    # Full field path in the schema mapped as embedding field.
    field_path: Any = None

@dataclasses.dataclass
class V1betaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpec:
...
@dataclasses.dataclass
class V1betaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpec:
...
@dataclasses.dataclass
class V1betaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpec:
...
@dataclasses.dataclass
class V1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec:
    # Text at the beginning of the prompt that instructs the assistant. Examples are available in the user guide.
    preamble: Any = None

@dataclasses.dataclass
class V1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpec:
...
@dataclasses.dataclass
class V1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpec:
    # Optional. Source of image returned in the answer.
    image_source: Any = None

@dataclasses.dataclass
class V1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec:
...
@dataclasses.dataclass
class V1betaServingConfig_GenericConfig_ContentSearchSpec:
...
@dataclasses.dataclass
class V1betaServingConfig_GenericConfig:
    # A specification for configuring the behavior of content search.
    content_search_spec: Any = None

@dataclasses.dataclass
class V1betaServingConfig_MediaConfig:
...
@dataclasses.dataclass
class V1betaServingConfig_PersonalizationSpec:
    # The personalization mode of the search request. Defaults to Mode.AUTO.
    mode: Any = None

_V1betaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpecFields = {
...
_V1betaServingConfig_AnswerGenerationSpecFields = {
    "user_defined_classifier_spec": ubx.FieldSpec(
        wire_name="user_defined_classifier_spec",
        kind="object",
        fields=_V1betaServingConfig_AnswerGenerationSpec_UserDefinedClassifierSpecFields,
    ),
}

_V1betaServingConfig_EmbeddingConfigFields = {
    "field_path": ubx.FieldSpec(wire_name="field_path"),
}

_V1betaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpecFields = {
    "num_next_chunks": ubx.FieldSpec(wire_name="num_next_chunks"),
    "num_previous_chunks": ubx.FieldSpec(wire_name="num_previous_chunks"),
}

_V1betaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpecFields = {
...
_V1betaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpecFields = {
...
_V1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpecFields = {
    "preamble": ubx.FieldSpec(wire_name="preamble"),
}

_V1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpecFields = {
    "version": ubx.FieldSpec(wire_name="version"),
}

_V1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpecFields = {
    "image_source": ubx.FieldSpec(wire_name="image_source"),
}

_V1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpecFields = {
    ...
    "model_prompt_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelPromptSpecFields,
    ),
    "model_spec": ubx.FieldSpec(
        wire_name="model_spec",
        kind="object",
        fields=_V1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_ModelSpecFields,
    ),
    "multimodal_spec": ubx.FieldSpec(
        wire_name="multimodal_spec",
        kind="object",
        fields=_V1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpec_MultimodalSpecFields,
    ),
...
_V1betaServingConfig_GenericConfig_ContentSearchSpecFields = {
    "chunk_spec": ubx.FieldSpec(
        wire_name="chunk_spec",
        kind="object",
        fields=_V1betaServingConfig_GenericConfig_ContentSearchSpec_ChunkSpecFields,
    ),
    "extractive_content_spec": ubx.FieldSpec(
        wire_name="extractive_content_spec",
        kind="object",
        fields=_V1betaServingConfig_GenericConfig_ContentSearchSpec_ExtractiveContentSpecFields,
    ),
    "search_result_mode": ubx.FieldSpec(wire_name="search_result_mode"),
    "snippet_spec": ubx.FieldSpec(
        wire_name="snippet_spec",
        kind="object",
        fields=_V1betaServingConfig_GenericConfig_ContentSearchSpec_SnippetSpecFields,
    ),
    "summary_spec": ubx.FieldSpec(
        wire_name="summary_spec",
        kind="object",
        fields=_V1betaServingConfig_GenericConfig_ContentSearchSpec_SummarySpecFields,
    ),
}

_V1betaServingConfig_GenericConfigFields = {
    "content_search_spec": ubx.FieldSpec(
        wire_name="content_search_spec",
        kind="object",
        fields=_V1betaServingConfig_GenericConfig_ContentSearchSpecFields,
    ),
}

_V1betaServingConfig_MediaConfigFields = {
...
_V1betaServingConfig_PersonalizationSpecFields = {
    "mode": ubx.FieldSpec(wire_name="mode"),
}

@dataclasses.dataclass
class V1betaServingConfigConfig:
...
@dataclasses.dataclass
class V1betaServingConfigAttrs:
    # The specification for answer generation.
    answer_generation_spec: Any = None
    # Boost controls to use in serving path. All triggered boost controls will be applied. Boost controls must be in the same data store as the serving config. Maximum of 20 boost controls.
    boost_control_ids: Any = None
...
V1betaServingConfig = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1beta_serving_config",
    fields={
        "answer_generation_spec": ubx.FieldSpec(
            wire_name="answer_generation_spec",
            kind="object",
            fields=_V1betaServingConfig_AnswerGenerationSpecFields,
        ),
        ...
        "personalization_spec": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaServingConfig_PersonalizationSpecFields,
        ),
