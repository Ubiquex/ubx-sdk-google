...
class V1betaSampleQuerySetConfig:
...
@dataclasses.dataclass
class V1betaSampleQuerySetAttrs:
...
V1betaSampleQuerySet = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1beta_sample_query_set",
    fields={
