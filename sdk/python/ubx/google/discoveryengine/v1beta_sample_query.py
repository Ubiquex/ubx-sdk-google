...
class V1betaSampleQuery_QueryEntry_Targets:
    page_numbers: Any = None
    score: Any = None
    uri: Any = None

@dataclasses.dataclass
class V1betaSampleQuery_QueryEntry:
    # Required. The query.
    query: Any = None
    # List of targets for the query.
    targets: Any = None

_V1betaSampleQuery_QueryEntry_TargetsFields = {
    "page_numbers": ubx.FieldSpec(wire_name="page_numbers"),
    "score": ubx.FieldSpec(wire_name="score"),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_V1betaSampleQuery_QueryEntryFields = {
    "query": ubx.FieldSpec(wire_name="query"),
    "targets": ubx.FieldSpec(
        wire_name="targets",
        kind="list",
        fields=_V1betaSampleQuery_QueryEntry_TargetsFields,
    ),
}

@dataclasses.dataclass
class V1betaSampleQueryConfig:
...
V1betaSampleQuery = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1beta_sample_query",
    fields={
        "name": ubx.FieldSpec(wire_name="name"),
        "query_entry": ubx.FieldSpec(
            wire_name="query_entry",
            kind="object",
            fields=_V1betaSampleQuery_QueryEntryFields,
        ),
    },
)
