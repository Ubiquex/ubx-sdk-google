...
class V1alphaDiscoveryengineV1alphaDocument_AclInfo_Readers_Principals:
    external_entity_id: Any = None
    group_id: Any = None
    user_id: Any = None

@dataclasses.dataclass
class V1alphaDiscoveryengineV1alphaDocument_AclInfo_Readers:
    idp_wide: Any = None
    principals: Any = None

@dataclasses.dataclass
class V1alphaDiscoveryengineV1alphaDocument_AclInfo:
    # Readers of the document.
    readers: Any = None

@dataclasses.dataclass
class V1alphaDiscoveryengineV1alphaDocument_Content:
...
@dataclasses.dataclass
class V1alphaDiscoveryengineV1alphaDocument_IndexStatus_ErrorSamples:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class V1alphaDiscoveryengineV1alphaDocument_IndexStatus:
...
_V1alphaDiscoveryengineV1alphaDocument_AclInfo_Readers_PrincipalsFields = {
...
_V1alphaDiscoveryengineV1alphaDocument_AclInfo_ReadersFields = {
    "idp_wide": ubx.FieldSpec(wire_name="idp_wide"),
    "principals": ubx.FieldSpec(
        wire_name="principals",
        kind="list",
        fields=_V1alphaDiscoveryengineV1alphaDocument_AclInfo_Readers_PrincipalsFields,
    ),
}

_V1alphaDiscoveryengineV1alphaDocument_AclInfoFields = {
    "readers": ubx.FieldSpec(
        wire_name="readers",
        kind="list",
        fields=_V1alphaDiscoveryengineV1alphaDocument_AclInfo_ReadersFields,
    ),
}

_V1alphaDiscoveryengineV1alphaDocument_ContentFields = {
    "mime_type": ubx.FieldSpec(wire_name="mime_type"),
    "raw_bytes": ubx.FieldSpec(wire_name="raw_bytes"),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_V1alphaDiscoveryengineV1alphaDocument_IndexStatus_ErrorSamplesFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V1alphaDiscoveryengineV1alphaDocument_IndexStatusFields = {
    "error_samples": ubx.FieldSpec(
        wire_name="error_samples",
        kind="list",
        fields=_V1alphaDiscoveryengineV1alphaDocument_IndexStatus_ErrorSamplesFields,
    ),
...
@dataclasses.dataclass
class V1alphaDiscoveryengineV1alphaDocumentConfig:
...
@dataclasses.dataclass
class V1alphaDiscoveryengineV1alphaDocumentAttrs:
    # ACL Information of the Document.
    acl_info: Any = None
    # Unstructured data linked to this document.
    content: Any = None
...
V1alphaDiscoveryengineV1alphaDocument = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1alpha_discoveryengine_v1alpha_document",
    fields={
        "acl_info": ubx.FieldSpec(
            wire_name="acl_info",
            kind="object",
            fields=_V1alphaDiscoveryengineV1alphaDocument_AclInfoFields,
        ),
        "content": ubx.FieldSpec(
            wire_name="content",
            kind="object",
            fields=_V1alphaDiscoveryengineV1alphaDocument_ContentFields,
        ),
        ...
        "index_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1alphaDiscoveryengineV1alphaDocument_IndexStatusFields,
        ),
        "index_time": ubx.FieldSpec(wire_name="index_time"),
