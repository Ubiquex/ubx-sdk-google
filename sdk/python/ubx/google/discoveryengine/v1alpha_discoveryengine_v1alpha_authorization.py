...
class V1alphaDiscoveryengineV1alphaAuthorization_ServerSideOauth2:
...
_V1alphaDiscoveryengineV1alphaAuthorization_ServerSideOauth2Fields = {
...
@dataclasses.dataclass
class V1alphaDiscoveryengineV1alphaAuthorizationConfig:
...
@dataclasses.dataclass
class V1alphaDiscoveryengineV1alphaAuthorizationAttrs:
    # Required. The display name of the authorization. It must be a UTF-8 encoded string with a length limit of 128 characters.
    display_name: Any = None
    # Identifier. Resource name of the authorization. Format: `projects/{project}/locations/{location}/authorizations/{authorization}` It must be a UTF-8 encoded string with a length limit of 1024 characters.
    name: Any = None
...
V1alphaDiscoveryengineV1alphaAuthorization = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1alpha_discoveryengine_v1alpha_authorization",
    fields={
        ...
        "server_side_oauth2": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1alphaDiscoveryengineV1alphaAuthorization_ServerSideOauth2Fields,
        ),
    },
)
