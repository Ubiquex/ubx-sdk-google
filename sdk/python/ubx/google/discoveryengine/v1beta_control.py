...
class V1betaControl_BoostAction_InterpolationBoostSpec_ControlPoints:
    attribute_value: Any = None
    boost_amount: Any = None

@dataclasses.dataclass
class V1betaControl_BoostAction_InterpolationBoostSpec:
...
@dataclasses.dataclass
class V1betaControl_BoostAction:
...
@dataclasses.dataclass
class V1betaControl_Conditions_ActiveTimeRange:
    end_time: Any = None
    start_time: Any = None

@dataclasses.dataclass
class V1betaControl_Conditions_QueryTerms:
    full_match: Any = None
    value: Any = None

@dataclasses.dataclass
class V1betaControl_Conditions:
    active_time_range: Any = None
    query_regex: Any = None
    query_terms: Any = None

@dataclasses.dataclass
class V1betaControl_FilterAction:
...
@dataclasses.dataclass
class V1betaControl_PromoteAction_SearchLinkPromotion:
...
@dataclasses.dataclass
class V1betaControl_PromoteAction:
...
@dataclasses.dataclass
class V1betaControl_RedirectAction:
...
@dataclasses.dataclass
class V1betaControl_SynonymsAction:
...
_V1betaControl_BoostActionFields = {
    ...
    "interpolation_boost_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaControl_BoostAction_InterpolationBoostSpecFields,
    ),
}

_V1betaControl_Conditions_ActiveTimeRangeFields = {
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

_V1betaControl_Conditions_QueryTermsFields = {
    "full_match": ubx.FieldSpec(wire_name="full_match"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_V1betaControl_ConditionsFields = {
    "active_time_range": ubx.FieldSpec(
        wire_name="active_time_range",
        kind="list",
        fields=_V1betaControl_Conditions_ActiveTimeRangeFields,
    ),
    "query_regex": ubx.FieldSpec(wire_name="query_regex"),
    "query_terms": ubx.FieldSpec(
        wire_name="query_terms",
        kind="list",
        fields=_V1betaControl_Conditions_QueryTermsFields,
    ),
}

_V1betaControl_FilterActionFields = {
    "data_store": ubx.FieldSpec(wire_name="data_store"),
    "filter": ubx.FieldSpec(wire_name="filter"),
}

_V1betaControl_PromoteAction_SearchLinkPromotionFields = {
...
_V1betaControl_PromoteActionFields = {
    "data_store": ubx.FieldSpec(wire_name="data_store"),
    "search_link_promotion": ubx.FieldSpec(
        wire_name="search_link_promotion",
        kind="object",
        fields=_V1betaControl_PromoteAction_SearchLinkPromotionFields,
    ),
}

_V1betaControl_RedirectActionFields = {
    "redirect_uri": ubx.FieldSpec(wire_name="redirect_uri"),
}

_V1betaControl_SynonymsActionFields = {
    "synonyms": ubx.FieldSpec(wire_name="synonyms"),
}

@dataclasses.dataclass
class V1betaControlConfig:
