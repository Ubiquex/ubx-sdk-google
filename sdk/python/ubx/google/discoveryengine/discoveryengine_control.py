...
class DiscoveryengineControl_BoostAction_InterpolationBoostSpec_ControlPoints:
    attribute_value: Any = None
    boost_amount: Any = None

@dataclasses.dataclass
class DiscoveryengineControl_BoostAction_InterpolationBoostSpec:
...
@dataclasses.dataclass
class DiscoveryengineControl_BoostAction:
...
@dataclasses.dataclass
class DiscoveryengineControl_Conditions_ActiveTimeRange:
    end_time: Any = None
    start_time: Any = None

@dataclasses.dataclass
class DiscoveryengineControl_Conditions_QueryTerms:
    full_match: Any = None
    value: Any = None

@dataclasses.dataclass
class DiscoveryengineControl_Conditions:
    active_time_range: Any = None
    query_regex: Any = None
    query_terms: Any = None

@dataclasses.dataclass
class DiscoveryengineControl_FilterAction:
...
@dataclasses.dataclass
class DiscoveryengineControl_PromoteAction_SearchLinkPromotion:
...
@dataclasses.dataclass
class DiscoveryengineControl_PromoteAction:
...
@dataclasses.dataclass
class DiscoveryengineControl_RedirectAction:
...
@dataclasses.dataclass
class DiscoveryengineControl_SynonymsAction:
...
_DiscoveryengineControl_BoostActionFields = {
    ...
    "interpolation_boost_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_DiscoveryengineControl_BoostAction_InterpolationBoostSpecFields,
    ),
}

_DiscoveryengineControl_Conditions_ActiveTimeRangeFields = {
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

_DiscoveryengineControl_Conditions_QueryTermsFields = {
    "full_match": ubx.FieldSpec(wire_name="full_match"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_DiscoveryengineControl_ConditionsFields = {
    "active_time_range": ubx.FieldSpec(
        wire_name="active_time_range",
        kind="list",
        fields=_DiscoveryengineControl_Conditions_ActiveTimeRangeFields,
    ),
    "query_regex": ubx.FieldSpec(wire_name="query_regex"),
    "query_terms": ubx.FieldSpec(
        wire_name="query_terms",
        kind="list",
        fields=_DiscoveryengineControl_Conditions_QueryTermsFields,
    ),
}

_DiscoveryengineControl_FilterActionFields = {
    "data_store": ubx.FieldSpec(wire_name="data_store"),
    "filter": ubx.FieldSpec(wire_name="filter"),
}

_DiscoveryengineControl_PromoteAction_SearchLinkPromotionFields = {
...
_DiscoveryengineControl_PromoteActionFields = {
    "data_store": ubx.FieldSpec(wire_name="data_store"),
    "search_link_promotion": ubx.FieldSpec(
        wire_name="search_link_promotion",
        kind="object",
        fields=_DiscoveryengineControl_PromoteAction_SearchLinkPromotionFields,
    ),
}

_DiscoveryengineControl_RedirectActionFields = {
    "redirect_uri": ubx.FieldSpec(wire_name="redirect_uri"),
}

_DiscoveryengineControl_SynonymsActionFields = {
    "synonyms": ubx.FieldSpec(wire_name="synonyms"),
}

@dataclasses.dataclass
class DiscoveryengineControlConfig:
...
@dataclasses.dataclass
class DiscoveryengineControlAttrs:
    # Output only. List of all ServingConfig IDs this control is attached to. May take up to 10 minutes to update after changes.
    associated_serving_config_ids: Any = None
    # Adjusts order of products in returned list.
    boost_action: Any = None
...
DiscoveryengineControl = ubx.ResourceBinding(
    wire_type="google_discoveryengine_discoveryengine_control",
    fields={
