...
class V1betaTargetSite_FailureReason_QuotaFailure:
...
V1betaTargetSite = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1beta_target_site",
    fields={
