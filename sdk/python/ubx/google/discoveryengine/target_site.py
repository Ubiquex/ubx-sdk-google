...
class TargetSite_FailureReason_QuotaFailure:
...
TargetSite = ubx.ResourceBinding(
    wire_type="google_discoveryengine_target_site",
    fields={
        "exact_match": ubx.FieldSpec(wire_name="exact_match"),
        "failure_reason": ubx.FieldSpec(
            wire_name="failure_reason",
            kind="object",
            fields=_TargetSite_FailureReasonFields,
        ),
        ...
        "site_verification_info": ubx.FieldSpec(
            ...
            kind="object",
            fields=_TargetSite_SiteVerificationInfoFields,
        ),
