...
class V1alphaAgent_A2aAgentDefinition_CloudMarketplaceConfig:
...
@dataclasses.dataclass
class V1alphaAgent_A2aAgentDefinition:
...
@dataclasses.dataclass
class V1alphaAgent_AdkAgentDefinition_ProvisionedReasoningEngine:
...
@dataclasses.dataclass
class V1alphaAgent_AdkAgentDefinition:
...
@dataclasses.dataclass
class V1alphaAgent_AuthorizationConfig:
...
@dataclasses.dataclass
class V1alphaAgent_DialogflowAgentDefinition:
...
@dataclasses.dataclass
class V1alphaAgent_ObservabilityConfig:
...
@dataclasses.dataclass
class V1alphaAgent_SharingConfig:
    # Optional. The sharing scope of the agent.
    scope: Any = None

@dataclasses.dataclass
class V1alphaAgent_StarterPrompts:
    text: Any = None

_V1alphaAgent_A2aAgentDefinition_CloudMarketplaceConfigFields = {
    "entitlement": ubx.FieldSpec(wire_name="entitlement"),
    "order": ubx.FieldSpec(wire_name="order"),
}

_V1alphaAgent_A2aAgentDefinitionFields = {
    "cloud_marketplace_config": ubx.FieldSpec(
        wire_name="cloud_marketplace_config",
        kind="object",
        fields=_V1alphaAgent_A2aAgentDefinition_CloudMarketplaceConfigFields,
    ),
    "json_agent_card": ubx.FieldSpec(wire_name="json_agent_card"),
}

_V1alphaAgent_AdkAgentDefinition_ProvisionedReasoningEngineFields = {
    "reasoning_engine": ubx.FieldSpec(wire_name="reasoning_engine"),
}

_V1alphaAgent_AdkAgentDefinitionFields = {
    "provisioned_reasoning_engine": ubx.FieldSpec(
        wire_name="provisioned_reasoning_engine",
        kind="object",
        fields=_V1alphaAgent_AdkAgentDefinition_ProvisionedReasoningEngineFields,
    ),
}

_V1alphaAgent_AuthorizationConfigFields = {
...
_V1alphaAgent_SharingConfigFields = {
    "scope": ubx.FieldSpec(wire_name="scope"),
}

_V1alphaAgent_StarterPromptsFields = {
...
V1alphaAgent = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1alpha_agent",
    fields={
        "a2a_agent_definition": ubx.FieldSpec(
            wire_name="a2a_agent_definition",
            kind="object",
            fields=_V1alphaAgent_A2aAgentDefinitionFields,
        ),
        "adk_agent_definition": ubx.FieldSpec(
            wire_name="adk_agent_definition",
            kind="object",
            fields=_V1alphaAgent_AdkAgentDefinitionFields,
        ),
        ...
        "dialogflow_agent_definition": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1alphaAgent_DialogflowAgentDefinitionFields,
        ),
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        "icon": ubx.FieldSpec(
            wire_name="icon",
            kind="object",
            fields=_V1alphaAgent_IconFields,
        ),
        ...
        "sharing_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1alphaAgent_SharingConfigFields,
        ),
