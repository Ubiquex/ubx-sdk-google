...
class V1alphaDocument_AclInfo_Readers_Principals:
    external_entity_id: Any = None
    group_id: Any = None
    user_id: Any = None

@dataclasses.dataclass
class V1alphaDocument_AclInfo_Readers:
    idp_wide: Any = None
    principals: Any = None

@dataclasses.dataclass
class V1alphaDocument_AclInfo:
    # Readers of the document.
    readers: Any = None

@dataclasses.dataclass
class V1alphaDocument_Content:
...
@dataclasses.dataclass
class V1alphaDocument_IndexStatus_ErrorSamples:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class V1alphaDocument_IndexStatus:
...
_V1alphaDocument_AclInfo_Readers_PrincipalsFields = {
...
V1alphaDocument = ubx.ResourceBinding(
    wire_type="google_discoveryengine_v1alpha_document",
    fields={
        "acl_info": ubx.FieldSpec(
            wire_name="acl_info",
            kind="object",
            fields=_V1alphaDocument_AclInfoFields,
        ),
        "content": ubx.FieldSpec(
            wire_name="content",
            kind="object",
            fields=_V1alphaDocument_ContentFields,
        ),
        "id": ubx.FieldSpec(wire_name="id"),
        "index_status": ubx.FieldSpec(
            wire_name="index_status",
            kind="object",
            fields=_V1alphaDocument_IndexStatusFields,
        ),
