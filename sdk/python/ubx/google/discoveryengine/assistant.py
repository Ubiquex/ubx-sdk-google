...
@dataclasses.dataclass
class Assistant_CustomerPolicy_ModelArmorConfig:
...
@dataclasses.dataclass
class Assistant_CustomerPolicy:
...
@dataclasses.dataclass
class Assistant_GenerationConfig_SystemInstruction:
...
@dataclasses.dataclass
class Assistant_GenerationConfig:
...
_Assistant_CustomerPolicy_BannedPhrasesFields = {
...
_Assistant_CustomerPolicy_ModelArmorConfigFields = {
...
_Assistant_CustomerPolicyFields = {
    "banned_phrases": ubx.FieldSpec(
        wire_name="banned_phrases",
        kind="list",
        fields=_Assistant_CustomerPolicy_BannedPhrasesFields,
    ),
    "model_armor_config": ubx.FieldSpec(
        wire_name="model_armor_config",
        kind="object",
        fields=_Assistant_CustomerPolicy_ModelArmorConfigFields,
    ),
}

_Assistant_EnabledTools_ToolInfoFields = {
    "tool_display_name": ubx.FieldSpec(wire_name="tool_display_name"),
    "tool_name": ubx.FieldSpec(wire_name="tool_name"),
}

_Assistant_EnabledToolsFields = {
    "tool_info": ubx.FieldSpec(
        wire_name="tool_info",
        kind="list",
        fields=_Assistant_EnabledTools_ToolInfoFields,
    ),
}

_Assistant_GenerationConfig_SystemInstructionFields = {
    "additional_system_instruction": ubx.FieldSpec(wire_name="additional_system_instruction"),
}

_Assistant_GenerationConfigFields = {
    ...
    "system_instruction": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Assistant_GenerationConfig_SystemInstructionFields,
    ),
}
...
Assistant = ubx.ResourceBinding(
    wire_type="google_discoveryengine_assistant",
    fields={
        "customer_policy": ubx.FieldSpec(
            wire_name="customer_policy",
            kind="object",
            fields=_Assistant_CustomerPolicyFields,
        ),
        ...
        "enabled_tools": ubx.FieldSpec(
            ...
            kind="map",
            fields=_Assistant_EnabledToolsFields,
        ),
        "generation_config": ubx.FieldSpec(
            wire_name="generation_config",
            kind="object",
            fields=_Assistant_GenerationConfigFields,
        ),
