...
class DatacatalogEntryGroup_DataCatalogTimestamps:
...
_DatacatalogEntryGroup_DataCatalogTimestampsFields = {
...
@dataclasses.dataclass
class DatacatalogEntryGroupConfig:
...
@dataclasses.dataclass
class DatacatalogEntryGroupAttrs:
    # Timestamps associated with this resource in a particular system.
    data_catalog_timestamps: Any = None
    # Entry group description. Can consist of several sentences or paragraphs that describe the entry group contents. Default value is an empty string.
    description: Any = None
...
DatacatalogEntryGroup = ubx.ResourceBinding(
    wire_type="google_datacatalog_datacatalog_entry_group",
    fields={
        "data_catalog_timestamps": ubx.FieldSpec(
            wire_name="data_catalog_timestamps",
            kind="object",
            fields=_DatacatalogEntryGroup_DataCatalogTimestampsFields,
        ),
