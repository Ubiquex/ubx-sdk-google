...
_TagTemplate_Fields_Type_EnumTypeFields = {
    "allowed_values": ubx.FieldSpec(
        wire_name="allowed_values",
        kind="list",
        fields=_TagTemplate_Fields_Type_EnumType_AllowedValuesFields,
    ),
}

_TagTemplate_Fields_TypeFields = {
    "enum_type": ubx.FieldSpec(
        wire_name="enum_type",
        kind="object",
        fields=_TagTemplate_Fields_Type_EnumTypeFields,
    ),
    "primitive_type": ubx.FieldSpec(wire_name="primitive_type"),
}

_TagTemplate_FieldsFields = {
    ...
    "type": ubx.FieldSpec(
        wire_name="type",
        kind="object",
        fields=_TagTemplate_Fields_TypeFields,
    ),
}
...
TagTemplate = ubx.ResourceBinding(
    wire_type="google_datacatalog_tag_template",
    fields={
        ...
        "fields": ubx.FieldSpec(
            wire_name="fields",
            kind="map",
            fields=_TagTemplate_FieldsFields,
        ),
