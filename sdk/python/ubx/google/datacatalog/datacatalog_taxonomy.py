...
class DatacatalogTaxonomy_Service:
...
@dataclasses.dataclass
class DatacatalogTaxonomy_TaxonomyTimestamps:
...
_DatacatalogTaxonomy_ServiceFields = {
    "identity": ubx.FieldSpec(wire_name="identity"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_DatacatalogTaxonomy_TaxonomyTimestampsFields = {
...
@dataclasses.dataclass
class DatacatalogTaxonomyConfig:
...
@dataclasses.dataclass
class DatacatalogTaxonomyAttrs:
    # Optional. A list of policy types that are activated for this taxonomy. If not set, defaults to an empty list.
    activated_policy_types: Any = None
    # Optional. Description of this taxonomy. If not set, defaults to empty. The description must contain only Unicode characters, tabs, newlines, carriage returns, and page breaks, and be at most 2000 bytes long when encoded in UTF-8.
    description: Any = None
...
DatacatalogTaxonomy = ubx.ResourceBinding(
    wire_type="google_datacatalog_datacatalog_taxonomy",
    fields={
        ...
        "service": ubx.FieldSpec(
            wire_name="service",
            kind="object",
            fields=_DatacatalogTaxonomy_ServiceFields,
        ),
        "taxonomy_timestamps": ubx.FieldSpec(
            wire_name="taxonomy_timestamps",
            kind="object",
            fields=_DatacatalogTaxonomy_TaxonomyTimestampsFields,
        ),
    },
)
