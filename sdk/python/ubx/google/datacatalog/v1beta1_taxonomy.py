...
@dataclasses.dataclass
class V1beta1Taxonomy_TaxonomyTimestamps:
...
_V1beta1Taxonomy_ServiceFields = {
    "identity": ubx.FieldSpec(wire_name="identity"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_V1beta1Taxonomy_TaxonomyTimestampsFields = {
...
V1beta1Taxonomy = ubx.ResourceBinding(
    wire_type="google_datacatalog_v1beta1_taxonomy",
    fields={
        ...
        "service": ubx.FieldSpec(
            wire_name="service",
            kind="object",
            fields=_V1beta1Taxonomy_ServiceFields,
        ),
        "taxonomy_timestamps": ubx.FieldSpec(
            wire_name="taxonomy_timestamps",
            kind="object",
            fields=_V1beta1Taxonomy_TaxonomyTimestampsFields,
        ),
    },
)
