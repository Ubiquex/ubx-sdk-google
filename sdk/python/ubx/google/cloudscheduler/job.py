...
class Job_AppEngineHttpTarget_AppEngineRouting:
...
@dataclasses.dataclass
class Job_HttpTarget_OauthToken:
...
@dataclasses.dataclass
class Job_HttpTarget_OidcToken:
...
_Job_AppEngineHttpTarget_AppEngineRoutingFields = {
...
_Job_AppEngineHttpTargetFields = {
    "app_engine_routing": ubx.FieldSpec(
        wire_name="app_engine_routing",
        kind="object",
        fields=_Job_AppEngineHttpTarget_AppEngineRoutingFields,
    ),
...
_Job_HttpTargetFields = {
    ...
    "oauth_token": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Job_HttpTarget_OauthTokenFields,
    ),
    "oidc_token": ubx.FieldSpec(
        wire_name="oidc_token",
        kind="object",
        fields=_Job_HttpTarget_OidcTokenFields,
    ),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_Job_PubsubTargetFields = {
...
Job = ubx.ResourceBinding(
    wire_type="google_cloudscheduler_job",
    fields={
        "app_engine_http_target": ubx.FieldSpec(
            wire_name="app_engine_http_target",
            kind="object",
            fields=_Job_AppEngineHttpTargetFields,
        ),
        ...
        "pubsub_target": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Job_PubsubTargetFields,
        ),
