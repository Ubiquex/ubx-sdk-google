...
class V1beta1CloudschedulerV1beta1Job_AppEngineHttpTarget_AppEngineRouting:
...
@dataclasses.dataclass
class V1beta1CloudschedulerV1beta1Job_AppEngineHttpTarget:
...
@dataclasses.dataclass
class V1beta1CloudschedulerV1beta1Job_HttpTarget_OauthToken:
...
@dataclasses.dataclass
class V1beta1CloudschedulerV1beta1Job_HttpTarget_OidcToken:
...
@dataclasses.dataclass
class V1beta1CloudschedulerV1beta1Job_HttpTarget:
...
@dataclasses.dataclass
class V1beta1CloudschedulerV1beta1Job_PubsubTarget:
...
@dataclasses.dataclass
class V1beta1CloudschedulerV1beta1Job_RetryConfig:
...
@dataclasses.dataclass
class V1beta1CloudschedulerV1beta1Job_Status:
...
_V1beta1CloudschedulerV1beta1Job_AppEngineHttpTarget_AppEngineRoutingFields = {
...
_V1beta1CloudschedulerV1beta1Job_AppEngineHttpTargetFields = {
    "app_engine_routing": ubx.FieldSpec(
        wire_name="app_engine_routing",
        kind="object",
        fields=_V1beta1CloudschedulerV1beta1Job_AppEngineHttpTarget_AppEngineRoutingFields,
    ),
...
_V1beta1CloudschedulerV1beta1Job_HttpTarget_OauthTokenFields = {
    "scope": ubx.FieldSpec(wire_name="scope"),
    "service_account_email": ubx.FieldSpec(wire_name="service_account_email"),
}

_V1beta1CloudschedulerV1beta1Job_HttpTarget_OidcTokenFields = {
    "audience": ubx.FieldSpec(wire_name="audience"),
    "service_account_email": ubx.FieldSpec(wire_name="service_account_email"),
}

_V1beta1CloudschedulerV1beta1Job_HttpTargetFields = {
    "body": ubx.FieldSpec(wire_name="body"),
    "headers": ubx.FieldSpec(wire_name="headers"),
    "http_method": ubx.FieldSpec(wire_name="http_method"),
    "oauth_token": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1CloudschedulerV1beta1Job_HttpTarget_OauthTokenFields,
    ),
    "oidc_token": ubx.FieldSpec(
        wire_name="oidc_token",
        kind="object",
        fields=_V1beta1CloudschedulerV1beta1Job_HttpTarget_OidcTokenFields,
    ),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_V1beta1CloudschedulerV1beta1Job_PubsubTargetFields = {
...
_V1beta1CloudschedulerV1beta1Job_RetryConfigFields = {
...
_V1beta1CloudschedulerV1beta1Job_StatusFields = {
...
@dataclasses.dataclass
class V1beta1CloudschedulerV1beta1JobConfig:
    ...
    legacy_app_engine_cron: Any = None
...
@dataclasses.dataclass
class V1beta1CloudschedulerV1beta1JobAttrs:
    # App Engine target. The job will be pushed to a job handler by means of an HTTP request via an http_method such as HTTP POST, HTTP GET, etc. The job is acknowledged by means of an HTTP response code in the range [200 - 299]. Error 503 is considered an App Engine system error instead of an application error. Requests returning error 503 will be retried regardless of retry configuration and not counted against retry counts. Any other response code, or a failure to receive a response before the deadline, constitutes a failed attempt.
    app_engine_http_target: Any = None
    # The deadline for job attempts. If the request handler does not respond by this deadline then the request is cancelled and the attempt is marked as a `DEADLINE_EXCEEDED` failure. The failed attempt can be viewed in execution logs. Cloud Scheduler will retry the job according to the RetryConfig. The default and the allowed values depend on the type of target: * For HTTP targets, the default is 3 minutes. The deadline must be in the interval [15 seconds, 30 minutes]. * For App Engine HTTP targets, 0 indicates that the request has the default deadline. The default deadline depends on the scaling type of the service: 10 minutes for standard apps with automatic scaling, 24 hours for standard apps with manual and basic scaling, and 60 minutes for flex apps. If the request deadline is set, it must be in the interval [15 seconds, 24 hours 15 seconds]. * For Pub/Sub targets, this field is ignored.
    attempt_deadline: Any = None
...
V1beta1CloudschedulerV1beta1Job = ubx.ResourceBinding(
    wire_type="google_cloudscheduler_v1beta1_cloudscheduler_v1beta1_job",
    fields={
        "app_engine_http_target": ubx.FieldSpec(
            wire_name="app_engine_http_target",
            kind="object",
            fields=_V1beta1CloudschedulerV1beta1Job_AppEngineHttpTargetFields,
        ),
        ...
        "http_target": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1CloudschedulerV1beta1Job_HttpTargetFields,
        ),
        "last_attempt_time": ubx.FieldSpec(wire_name="last_attempt_time"),
        "legacy_app_engine_cron": ubx.FieldSpec(wire_name="legacy_app_engine_cron"),
        "name": ubx.FieldSpec(wire_name="name"),
        "pubsub_target": ubx.FieldSpec(
            wire_name="pubsub_target",
            kind="object",
            fields=_V1beta1CloudschedulerV1beta1Job_PubsubTargetFields,
        ),
        "retry_config": ubx.FieldSpec(
            wire_name="retry_config",
            kind="object",
            fields=_V1beta1CloudschedulerV1beta1Job_RetryConfigFields,
        ),
        ...
        "status": ubx.FieldSpec(
            wire_name="status",
            kind="object",
            fields=_V1beta1CloudschedulerV1beta1Job_StatusFields,
        ),
