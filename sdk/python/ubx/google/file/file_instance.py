...
class FileInstance_DirectoryServices_Ldap:
...
@dataclasses.dataclass
class FileInstance_DirectoryServices:
    # LdapConfig contains all the parameters for connecting to LDAP servers.
    ldap: Any = None

@dataclasses.dataclass
class FileInstance_FileShares_NfsExportOptions:
...
@dataclasses.dataclass
class FileInstance_Networks_PscConfig:
    endpoint_project: Any = None

@dataclasses.dataclass
class FileInstance_Networks:
...
@dataclasses.dataclass
class FileInstance_PerformanceConfig_FixedIops:
    # Required. Maximum IOPS.
    max_iops: Any = None

@dataclasses.dataclass
class FileInstance_PerformanceConfig_IopsPerTb:
    # Required. Maximum IOPS per TiB.
    max_iops_per_tb: Any = None

@dataclasses.dataclass
class FileInstance_PerformanceConfig:
...
@dataclasses.dataclass
class FileInstance_PerformanceLimits:
...
@dataclasses.dataclass
class FileInstance_Replication_Replicas:
...
@dataclasses.dataclass
class FileInstance_Replication:
...
_FileInstance_DirectoryServices_LdapFields = {
...
_FileInstance_DirectoryServicesFields = {
    "ldap": ubx.FieldSpec(
        wire_name="ldap",
        kind="object",
        fields=_FileInstance_DirectoryServices_LdapFields,
    ),
}

_FileInstance_FileShares_NfsExportOptionsFields = {
...
_FileInstance_NetworksFields = {
    ...
    "psc_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_FileInstance_Networks_PscConfigFields,
    ),
    "reserved_ip_range": ubx.FieldSpec(wire_name="reserved_ip_range"),
}

_FileInstance_PerformanceConfig_FixedIopsFields = {
    "max_iops": ubx.FieldSpec(wire_name="max_iops"),
}

_FileInstance_PerformanceConfig_IopsPerTbFields = {
    "max_iops_per_tb": ubx.FieldSpec(wire_name="max_iops_per_tb"),
}

_FileInstance_PerformanceConfigFields = {
    "fixed_iops": ubx.FieldSpec(
        wire_name="fixed_iops",
        kind="object",
        fields=_FileInstance_PerformanceConfig_FixedIopsFields,
    ),
    "iops_per_tb": ubx.FieldSpec(
        wire_name="iops_per_tb",
        kind="object",
        fields=_FileInstance_PerformanceConfig_IopsPerTbFields,
    ),
}

_FileInstance_PerformanceLimitsFields = {
    "max_iops": ubx.FieldSpec(wire_name="max_iops"),
...
_FileInstance_Replication_ReplicasFields = {
...
_FileInstance_ReplicationFields = {
    "replicas": ubx.FieldSpec(
        wire_name="replicas",
        kind="list",
        fields=_FileInstance_Replication_ReplicasFields,
    ),
    "role": ubx.FieldSpec(wire_name="role"),
}

@dataclasses.dataclass
class FileInstanceConfig:
...
FileInstance = ubx.ResourceBinding(
    wire_type="google_file_file_instance",
    fields={
        ...
        "directory_services": ubx.FieldSpec(
            ...
            kind="object",
            fields=_FileInstance_DirectoryServicesFields,
        ),
        "etag": ubx.FieldSpec(wire_name="etag"),
        "file_shares": ubx.FieldSpec(
            wire_name="file_shares",
            kind="list",
            fields=_FileInstance_FileSharesFields,
        ),
