...
class V1beta1FileV1beta1Instance_DirectoryServices_Ldap:
...
@dataclasses.dataclass
class V1beta1FileV1beta1Instance_DirectoryServices_ManagedActiveDirectory:
...
@dataclasses.dataclass
class V1beta1FileV1beta1Instance_DirectoryServices:
...
@dataclasses.dataclass
class V1beta1FileV1beta1Instance_FileShares_NfsExportOptions:
...
@dataclasses.dataclass
class V1beta1FileV1beta1Instance_FileShares_RestoreConfig:
    path_patterns: Any = None

@dataclasses.dataclass
class V1beta1FileV1beta1Instance_FileShares:
...
@dataclasses.dataclass
class V1beta1FileV1beta1Instance_Networks_PscConfig:
    endpoint_project: Any = None

@dataclasses.dataclass
class V1beta1FileV1beta1Instance_Networks:
...
@dataclasses.dataclass
class V1beta1FileV1beta1Instance_PerformanceConfig_FixedIops:
    # Required. Maximum IOPS.
    max_iops: Any = None

@dataclasses.dataclass
class V1beta1FileV1beta1Instance_PerformanceConfig_IopsPerTb:
    # Required. Maximum IOPS per TiB.
    max_iops_per_tb: Any = None

@dataclasses.dataclass
class V1beta1FileV1beta1Instance_PerformanceConfig:
...
@dataclasses.dataclass
class V1beta1FileV1beta1Instance_PerformanceLimits:
...
@dataclasses.dataclass
class V1beta1FileV1beta1Instance_Replication_Replicas:
...
@dataclasses.dataclass
class V1beta1FileV1beta1Instance_Replication:
...
_V1beta1FileV1beta1Instance_DirectoryServices_LdapFields = {
...
_V1beta1FileV1beta1Instance_DirectoryServices_ManagedActiveDirectoryFields = {
    "computer": ubx.FieldSpec(wire_name="computer"),
    "domain": ubx.FieldSpec(wire_name="domain"),
}

_V1beta1FileV1beta1Instance_DirectoryServicesFields = {
    "ldap": ubx.FieldSpec(
        wire_name="ldap",
        kind="object",
        fields=_V1beta1FileV1beta1Instance_DirectoryServices_LdapFields,
    ),
    "managed_active_directory": ubx.FieldSpec(
        wire_name="managed_active_directory",
        kind="object",
        fields=_V1beta1FileV1beta1Instance_DirectoryServices_ManagedActiveDirectoryFields,
    ),
}

_V1beta1FileV1beta1Instance_FileShares_NfsExportOptionsFields = {
...
_V1beta1FileV1beta1Instance_NetworksFields = {
    ...
    "psc_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1FileV1beta1Instance_Networks_PscConfigFields,
    ),
    "reserved_ip_range": ubx.FieldSpec(wire_name="reserved_ip_range"),
}

_V1beta1FileV1beta1Instance_PerformanceConfig_FixedIopsFields = {
    "max_iops": ubx.FieldSpec(wire_name="max_iops"),
}

_V1beta1FileV1beta1Instance_PerformanceConfig_IopsPerTbFields = {
    "max_iops_per_tb": ubx.FieldSpec(wire_name="max_iops_per_tb"),
}

_V1beta1FileV1beta1Instance_PerformanceConfigFields = {
    "fixed_iops": ubx.FieldSpec(
        wire_name="fixed_iops",
        kind="object",
        fields=_V1beta1FileV1beta1Instance_PerformanceConfig_FixedIopsFields,
    ),
    "iops_per_tb": ubx.FieldSpec(
        wire_name="iops_per_tb",
        kind="object",
        fields=_V1beta1FileV1beta1Instance_PerformanceConfig_IopsPerTbFields,
    ),
}

_V1beta1FileV1beta1Instance_PerformanceLimitsFields = {
    "max_iops": ubx.FieldSpec(wire_name="max_iops"),
...
_V1beta1FileV1beta1Instance_Replication_ReplicasFields = {
...
_V1beta1FileV1beta1Instance_ReplicationFields = {
    "replicas": ubx.FieldSpec(
        wire_name="replicas",
        kind="list",
        fields=_V1beta1FileV1beta1Instance_Replication_ReplicasFields,
    ),
    "role": ubx.FieldSpec(wire_name="role"),
}

@dataclasses.dataclass
class V1beta1FileV1beta1InstanceConfig:
...
@dataclasses.dataclass
class V1beta1FileV1beta1InstanceAttrs:
    # Optional. Immutable. Designates the backend type of this instance. Intended to be used by internal tests and allowed customers.
    backend_type: Any = None
    # The storage capacity of the instance in gigabytes (GB = 1024^3 bytes). This capacity can be increased up to `max_capacity_gb` GB in multipliers of `capacity_step_size_gb` GB.
    capacity_gb: Any = None
...
V1beta1FileV1beta1Instance = ubx.ResourceBinding(
    wire_type="google_file_v1beta1_file_v1beta1_instance",
    fields={
        ...
        "directory_services": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1FileV1beta1Instance_DirectoryServicesFields,
        ),
        "etag": ubx.FieldSpec(wire_name="etag"),
        "file_shares": ubx.FieldSpec(
            wire_name="file_shares",
            kind="list",
            fields=_V1beta1FileV1beta1Instance_FileSharesFields,
        ),
        ...
        "networks": ubx.FieldSpec(
            wire_name="networks",
            kind="list",
            fields=_V1beta1FileV1beta1Instance_NetworksFields,
        ),
        "performance_config": ubx.FieldSpec(
            wire_name="performance_config",
            kind="object",
            fields=_V1beta1FileV1beta1Instance_PerformanceConfigFields,
        ),
        "performance_limits": ubx.FieldSpec(
            wire_name="performance_limits",
            kind="object",
            fields=_V1beta1FileV1beta1Instance_PerformanceLimitsFields,
        ),
        "protocol": ubx.FieldSpec(wire_name="protocol"),
        "replication": ubx.FieldSpec(
            wire_name="replication",
            kind="object",
            fields=_V1beta1FileV1beta1Instance_ReplicationFields,
        ),
