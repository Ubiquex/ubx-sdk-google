...
class ParallelstoreInstanceConfig:
...
@dataclasses.dataclass
class ParallelstoreInstanceAttrs:
    # Output only. A list of IPv4 addresses used for client side configuration.
    access_points: Any = None
    # Required. Immutable. The instance's storage capacity in Gibibytes (GiB). Allowed values are between 12000 and 100000, in multiples of 4000; e.g., 12000, 16000, 20000, ...
    capacity_gib: Any = None
...
ParallelstoreInstance = ubx.ResourceBinding(
    wire_type="google_parallelstore_parallelstore_instance",
    fields={
