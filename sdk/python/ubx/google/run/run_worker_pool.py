...
class RunWorkerPool_BinaryAuthorization:
...
@dataclasses.dataclass
class RunWorkerPool_Conditions:
...
@dataclasses.dataclass
class RunWorkerPool_InstanceSplitStatuses:
    percent: Any = None
    revision: Any = None
    type: Any = None

@dataclasses.dataclass
class RunWorkerPool_Scaling:
    # Optional. The total number of instances in manual scaling mode.
    manual_instance_count: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_BuildInfo:
    function_target: Any = None
    source_location: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_Env_ValueSource_SecretKeyRef:
    secret: Any = None
    version: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_Env_ValueSource:
    secret_key_ref: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_Env:
    name: Any = None
    value: Any = None
    value_source: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_LivenessProbe_Grpc:
    port: Any = None
    service: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_LivenessProbe_HttpGet_HttpHeaders:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_LivenessProbe_HttpGet:
    http_headers: Any = None
    path: Any = None
    port: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_LivenessProbe_TcpSocket:
    port: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_LivenessProbe:
...
@dataclasses.dataclass
class RunWorkerPool_Template_Containers_Ports:
    container_port: Any = None
    name: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_Resources:
    cpu_idle: Any = None
    limits: Any = None
    startup_cpu_boost: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_SourceCode_CloudStorageSource:
    bucket: Any = None
    generation: Any = None
    object: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_SourceCode_InlinedSource_Sources:
    content: Any = None
    filename: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_SourceCode_InlinedSource:
    sources: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_SourceCode:
    cloud_storage_source: Any = None
    inlined_source: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers_VolumeMounts:
    mount_path: Any = None
    name: Any = None
    sub_path: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Containers:
    args: Any = None
...
@dataclasses.dataclass
class RunWorkerPool_Template_NodeSelector:
    # Required. GPU accelerator type to attach to an instance.
    accelerator: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_ServiceMesh:
    # The Mesh resource name. Format: `projects/{project}/locations/global/meshes/{mesh}`, where `{project}` can be project id or number.
    mesh: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Volumes_CloudSqlInstance:
    instances: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Volumes_EmptyDir:
    medium: Any = None
    size_limit: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Volumes_Gcs:
    bucket: Any = None
    mount_options: Any = None
    read_only: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Volumes_Nfs:
    path: Any = None
    read_only: Any = None
    server: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Volumes_Secret_Items:
    mode: Any = None
    path: Any = None
    version: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Volumes_Secret:
    default_mode: Any = None
    items: Any = None
    secret: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_Volumes:
...
@dataclasses.dataclass
class RunWorkerPool_Template_VpcAccess_NetworkInterfaces:
    network: Any = None
    subnetwork: Any = None
    tags: Any = None

@dataclasses.dataclass
class RunWorkerPool_Template_VpcAccess:
...
_RunWorkerPool_BinaryAuthorizationFields = {
...
_RunWorkerPool_ConditionsFields = {
...
_RunWorkerPool_InstanceSplitStatusesFields = {
    "percent": ubx.FieldSpec(wire_name="percent"),
    "revision": ubx.FieldSpec(wire_name="revision"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_RunWorkerPool_ScalingFields = {
    "manual_instance_count": ubx.FieldSpec(wire_name="manual_instance_count"),
}

_RunWorkerPool_Template_Containers_BuildInfoFields = {
    "function_target": ubx.FieldSpec(wire_name="function_target"),
    "source_location": ubx.FieldSpec(wire_name="source_location"),
}

_RunWorkerPool_Template_Containers_Env_ValueSource_SecretKeyRefFields = {
    "secret": ubx.FieldSpec(wire_name="secret"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_RunWorkerPool_Template_Containers_Env_ValueSourceFields = {
    "secret_key_ref": ubx.FieldSpec(
        wire_name="secret_key_ref",
        kind="object",
        fields=_RunWorkerPool_Template_Containers_Env_ValueSource_SecretKeyRefFields,
    ),
}

_RunWorkerPool_Template_Containers_EnvFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
    "value_source": ubx.FieldSpec(
        wire_name="value_source",
        kind="object",
        fields=_RunWorkerPool_Template_Containers_Env_ValueSourceFields,
    ),
}

_RunWorkerPool_Template_Containers_LivenessProbe_GrpcFields = {
    "port": ubx.FieldSpec(wire_name="port"),
    "service": ubx.FieldSpec(wire_name="service"),
}

_RunWorkerPool_Template_Containers_LivenessProbe_HttpGet_HttpHeadersFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_RunWorkerPool_Template_Containers_LivenessProbe_HttpGetFields = {
    "http_headers": ubx.FieldSpec(
        wire_name="http_headers",
        kind="list",
        fields=_RunWorkerPool_Template_Containers_LivenessProbe_HttpGet_HttpHeadersFields,
    ),
    "path": ubx.FieldSpec(wire_name="path"),
    "port": ubx.FieldSpec(wire_name="port"),
}

_RunWorkerPool_Template_Containers_LivenessProbe_TcpSocketFields = {
    "port": ubx.FieldSpec(wire_name="port"),
}

_RunWorkerPool_Template_Containers_LivenessProbeFields = {
    "failure_threshold": ubx.FieldSpec(wire_name="failure_threshold"),
    "grpc": ubx.FieldSpec(
        wire_name="grpc",
        kind="object",
        fields=_RunWorkerPool_Template_Containers_LivenessProbe_GrpcFields,
    ),
    "http_get": ubx.FieldSpec(
        wire_name="http_get",
        kind="object",
        fields=_RunWorkerPool_Template_Containers_LivenessProbe_HttpGetFields,
    ),
    ...
    "tcp_socket": ubx.FieldSpec(
        ...
        kind="object",
        fields=_RunWorkerPool_Template_Containers_LivenessProbe_TcpSocketFields,
    ),
    "timeout_seconds": ubx.FieldSpec(wire_name="timeout_seconds"),
}

_RunWorkerPool_Template_Containers_PortsFields = {
    "container_port": ubx.FieldSpec(wire_name="container_port"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_RunWorkerPool_Template_Containers_ResourcesFields = {
...
_RunWorkerPool_Template_Containers_SourceCode_CloudStorageSourceFields = {
    "bucket": ubx.FieldSpec(wire_name="bucket"),
    "generation": ubx.FieldSpec(wire_name="generation"),
    "object": ubx.FieldSpec(wire_name="object"),
}

_RunWorkerPool_Template_Containers_SourceCode_InlinedSource_SourcesFields = {
    "content": ubx.FieldSpec(wire_name="content"),
    "filename": ubx.FieldSpec(wire_name="filename"),
}

_RunWorkerPool_Template_Containers_SourceCode_InlinedSourceFields = {
    "sources": ubx.FieldSpec(
        wire_name="sources",
        kind="list",
        fields=_RunWorkerPool_Template_Containers_SourceCode_InlinedSource_SourcesFields,
    ),
}

_RunWorkerPool_Template_Containers_SourceCodeFields = {
    "cloud_storage_source": ubx.FieldSpec(
        wire_name="cloud_storage_source",
        kind="object",
        fields=_RunWorkerPool_Template_Containers_SourceCode_CloudStorageSourceFields,
    ),
    "inlined_source": ubx.FieldSpec(
        wire_name="inlined_source",
        kind="object",
        fields=_RunWorkerPool_Template_Containers_SourceCode_InlinedSourceFields,
    ),
}

_RunWorkerPool_Template_Containers_VolumeMountsFields = {
    "mount_path": ubx.FieldSpec(wire_name="mount_path"),
    "name": ubx.FieldSpec(wire_name="name"),
    "sub_path": ubx.FieldSpec(wire_name="sub_path"),
}

_RunWorkerPool_Template_ContainersFields = {
    ...
    "build_info": ubx.FieldSpec(
        ...
        kind="object",
        fields=_RunWorkerPool_Template_Containers_BuildInfoFields,
    ),
    ...
    "env": ubx.FieldSpec(
        wire_name="env",
        kind="list",
        fields=_RunWorkerPool_Template_Containers_EnvFields,
    ),
    "image": ubx.FieldSpec(wire_name="image"),
    "liveness_probe": ubx.FieldSpec(
        wire_name="liveness_probe",
        kind="object",
        fields=_RunWorkerPool_Template_Containers_LivenessProbeFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    "ports": ubx.FieldSpec(
        wire_name="ports",
        kind="list",
        fields=_RunWorkerPool_Template_Containers_PortsFields,
    ),
    ...
    "resources": ubx.FieldSpec(
        wire_name="resources",
        kind="object",
        fields=_RunWorkerPool_Template_Containers_ResourcesFields,
    ),
    "sandbox_launcher": ubx.FieldSpec(wire_name="sandbox_launcher"),
    "source_code": ubx.FieldSpec(
        wire_name="source_code",
        kind="object",
        fields=_RunWorkerPool_Template_Containers_SourceCodeFields,
    ),
    ...
    "volume_mounts": ubx.FieldSpec(
        ...
        kind="list",
        fields=_RunWorkerPool_Template_Containers_VolumeMountsFields,
    ),
    "working_dir": ubx.FieldSpec(wire_name="working_dir"),
}

_RunWorkerPool_Template_NodeSelectorFields = {
    "accelerator": ubx.FieldSpec(wire_name="accelerator"),
}

_RunWorkerPool_Template_ServiceMeshFields = {
    "mesh": ubx.FieldSpec(wire_name="mesh"),
}

_RunWorkerPool_Template_Volumes_CloudSqlInstanceFields = {
    "instances": ubx.FieldSpec(wire_name="instances"),
}

_RunWorkerPool_Template_Volumes_EmptyDirFields = {
    "medium": ubx.FieldSpec(wire_name="medium"),
    "size_limit": ubx.FieldSpec(wire_name="size_limit"),
}

_RunWorkerPool_Template_Volumes_GcsFields = {
    "bucket": ubx.FieldSpec(wire_name="bucket"),
    "mount_options": ubx.FieldSpec(wire_name="mount_options"),
    "read_only": ubx.FieldSpec(wire_name="read_only"),
}

_RunWorkerPool_Template_Volumes_NfsFields = {
    "path": ubx.FieldSpec(wire_name="path"),
    "read_only": ubx.FieldSpec(wire_name="read_only"),
    "server": ubx.FieldSpec(wire_name="server"),
}

_RunWorkerPool_Template_Volumes_Secret_ItemsFields = {
    "mode": ubx.FieldSpec(wire_name="mode"),
    "path": ubx.FieldSpec(wire_name="path"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_RunWorkerPool_Template_Volumes_SecretFields = {
    "default_mode": ubx.FieldSpec(wire_name="default_mode"),
    "items": ubx.FieldSpec(
        wire_name="items",
        kind="list",
        fields=_RunWorkerPool_Template_Volumes_Secret_ItemsFields,
    ),
    "secret": ubx.FieldSpec(wire_name="secret"),
}

_RunWorkerPool_Template_VolumesFields = {
    "cloud_sql_instance": ubx.FieldSpec(
        wire_name="cloud_sql_instance",
        kind="object",
        fields=_RunWorkerPool_Template_Volumes_CloudSqlInstanceFields,
    ),
    "empty_dir": ubx.FieldSpec(
        wire_name="empty_dir",
        kind="object",
        fields=_RunWorkerPool_Template_Volumes_EmptyDirFields,
    ),
    "gcs": ubx.FieldSpec(
        wire_name="gcs",
        kind="object",
        fields=_RunWorkerPool_Template_Volumes_GcsFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    "nfs": ubx.FieldSpec(
        wire_name="nfs",
        kind="object",
        fields=_RunWorkerPool_Template_Volumes_NfsFields,
    ),
    "secret": ubx.FieldSpec(
        wire_name="secret",
        kind="object",
        fields=_RunWorkerPool_Template_Volumes_SecretFields,
    ),
}

_RunWorkerPool_Template_VpcAccess_NetworkInterfacesFields = {
    "network": ubx.FieldSpec(wire_name="network"),
    "subnetwork": ubx.FieldSpec(wire_name="subnetwork"),
    "tags": ubx.FieldSpec(wire_name="tags"),
}

_RunWorkerPool_Template_VpcAccessFields = {
    ...
    "network_interfaces": ubx.FieldSpec(
        ...
        kind="list",
        fields=_RunWorkerPool_Template_VpcAccess_NetworkInterfacesFields,
    ),
}

_RunWorkerPool_TemplateFields = {
    ...
    "containers": ubx.FieldSpec(
        ...
        kind="list",
        fields=_RunWorkerPool_Template_ContainersFields,
    ),
    ...
    "node_selector": ubx.FieldSpec(
        ...
        kind="object",
        fields=_RunWorkerPool_Template_NodeSelectorFields,
    ),
    "revision": ubx.FieldSpec(wire_name="revision"),
    ...
    "service_mesh": ubx.FieldSpec(
        ...
        kind="object",
        fields=_RunWorkerPool_Template_ServiceMeshFields,
    ),
    "volumes": ubx.FieldSpec(
        wire_name="volumes",
        kind="list",
        fields=_RunWorkerPool_Template_VolumesFields,
    ),
    "vpc_access": ubx.FieldSpec(
        wire_name="vpc_access",
        kind="object",
        fields=_RunWorkerPool_Template_VpcAccessFields,
    ),
}

@dataclasses.dataclass
class RunWorkerPoolConfig:
...
RunWorkerPool = ubx.ResourceBinding(
    wire_type="google_run_run_worker_pool",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "binary_authorization": ubx.FieldSpec(
            wire_name="binary_authorization",
            kind="object",
            fields=_RunWorkerPool_BinaryAuthorizationFields,
        ),
        "client": ubx.FieldSpec(wire_name="client"),
        "client_version": ubx.FieldSpec(wire_name="client_version"),
        "conditions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_RunWorkerPool_ConditionsFields,
        ),
        ...
        "instance_split_statuses": ubx.FieldSpec(
            ...
            kind="list",
            fields=_RunWorkerPool_InstanceSplitStatusesFields,
        ),
        ...
        "scaling": ubx.FieldSpec(
            wire_name="scaling",
            kind="object",
            fields=_RunWorkerPool_ScalingFields,
        ),
        "template": ubx.FieldSpec(
            wire_name="template",
            kind="object",
            fields=_RunWorkerPool_TemplateFields,
        ),
