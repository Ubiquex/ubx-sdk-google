...
class V2betaCloudsupportV2betaCase_Classification_Product:
    # The product line of the Product.
    product_line: Any = None

@dataclasses.dataclass
class V2betaCloudsupportV2betaCase_Classification:
...
@dataclasses.dataclass
class V2betaCloudsupportV2betaCase_Creator:
...
_V2betaCloudsupportV2betaCase_Classification_ProductFields = {
    "product_line": ubx.FieldSpec(wire_name="product_line"),
}

_V2betaCloudsupportV2betaCase_ClassificationFields = {
    "display_name": ubx.FieldSpec(wire_name="display_name"),
    "id": ubx.FieldSpec(wire_name="id"),
    "product": ubx.FieldSpec(
        wire_name="product",
        kind="object",
        fields=_V2betaCloudsupportV2betaCase_Classification_ProductFields,
    ),
}

_V2betaCloudsupportV2betaCase_CreatorFields = {
    "display_name": ubx.FieldSpec(wire_name="display_name"),
...
@dataclasses.dataclass
class V2betaCloudsupportV2betaCaseConfig:
...
@dataclasses.dataclass
class V2betaCloudsupportV2betaCaseAttrs:
    # A Case Classification represents the topic that a case is about. It's very important to use accurate classifications, because they're used to route your cases to specialists who can help you. A classification always has an ID that is its unique identifier. A valid ID is required when creating a case.
    classification: Any = None
    # A user-supplied email address to send case update notifications for. This should only be used in BYOID flows, where we cannot infer the user's email address directly from their EUCs.
    contact_email: Any = None
...
V2betaCloudsupportV2betaCase = ubx.ResourceBinding(
    wire_type="google_cloudsupport_v2beta_cloudsupport_v2beta_case",
    fields={
        "classification": ubx.FieldSpec(
            wire_name="classification",
            kind="object",
            fields=_V2betaCloudsupportV2betaCase_ClassificationFields,
        ),
        ...
        "creator": ubx.FieldSpec(
            wire_name="creator",
            kind="object",
            fields=_V2betaCloudsupportV2betaCase_CreatorFields,
        ),
