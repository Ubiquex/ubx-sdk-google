...
class V2betaCloudsupportV2betaSupportEventSubscriptionConfig:
...
@dataclasses.dataclass
class V2betaCloudsupportV2betaSupportEventSubscriptionAttrs:
    # Output only. The time at which the subscription was created.
    create_time: Any = None
    # Output only. The time at which the subscription was deleted.
    delete_time: Any = None
...
V2betaCloudsupportV2betaSupportEventSubscription = ubx.ResourceBinding(
    wire_type="google_cloudsupport_v2beta_cloudsupport_v2beta_support_event_subscription",
    fields={
