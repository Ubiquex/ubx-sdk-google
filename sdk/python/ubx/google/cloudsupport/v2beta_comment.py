...
V2betaComment = ubx.ResourceBinding(
    wire_type="google_cloudsupport_v2beta_comment",
    fields={
        "body": ubx.FieldSpec(wire_name="body"),
        "creator": ubx.FieldSpec(
            wire_name="creator",
            kind="object",
            fields=_V2betaComment_CreatorFields,
        ),
    },
)
