...
class CloudsupportComment_Creator:
...
_CloudsupportComment_CreatorFields = {
...
@dataclasses.dataclass
class CloudsupportCommentConfig:
...
@dataclasses.dataclass
class CloudsupportCommentAttrs:
    # The full comment body. Maximum of 12800 characters.
    body: Any = None
    # Output only. The time when the comment was created.
    create_time: Any = None
...
CloudsupportComment = ubx.ResourceBinding(
    wire_type="google_cloudsupport_cloudsupport_comment",
    fields={
        ...
        "creator": ubx.FieldSpec(
            wire_name="creator",
            kind="object",
            fields=_CloudsupportComment_CreatorFields,
        ),
