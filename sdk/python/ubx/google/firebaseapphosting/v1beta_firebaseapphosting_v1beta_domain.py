...
class V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_Issues:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired_Records:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired:
    check_error: Any = None
    domain_name: Any = None
    records: Any = None

@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdates:
    check_time: Any = None
    desired: Any = None
    discovered: Any = None
    domain_name: Any = None
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaDomain_Serve_Redirect:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaDomain_Serve:
    # Specifies redirect behavior for a domain.
    redirect: Any = None

_V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_IssuesFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired_RecordsFields = {
...
_V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdates_DesiredFields = {
    "check_error": ubx.FieldSpec(
        wire_name="check_error",
        kind="object",
        fields=_V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_IssuesFields,
    ),
    "domain_name": ubx.FieldSpec(wire_name="domain_name"),
    "records": ubx.FieldSpec(
        wire_name="records",
        kind="list",
        fields=_V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdates_Desired_RecordsFields,
    ),
}

_V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdatesFields = {
    "check_time": ubx.FieldSpec(wire_name="check_time"),
    "desired": ubx.FieldSpec(
        wire_name="desired",
        kind="list",
        fields=_V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdates_DesiredFields,
    ),
...
_V1betaFirebaseapphostingV1betaDomain_CustomDomainStatusFields = {
    ...
    "required_dns_updates": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1betaFirebaseapphostingV1betaDomain_CustomDomainStatus_RequiredDnsUpdatesFields,
    ),
}

_V1betaFirebaseapphostingV1betaDomain_Serve_RedirectFields = {
    "status": ubx.FieldSpec(wire_name="status"),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_V1betaFirebaseapphostingV1betaDomain_ServeFields = {
    "redirect": ubx.FieldSpec(
        wire_name="redirect",
        kind="object",
        fields=_V1betaFirebaseapphostingV1betaDomain_Serve_RedirectFields,
    ),
}

@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaDomainConfig:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaDomainAttrs:
    # Optional. Annotations as key value pairs.
    annotations: Any = None
    # Output only. Time at which the domain was created.
    create_time: Any = None
...
V1betaFirebaseapphostingV1betaDomain = ubx.ResourceBinding(
    wire_type="google_firebaseapphosting_v1beta_firebaseapphosting_v1beta_domain",
    fields={
        ...
        "custom_domain_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaFirebaseapphostingV1betaDomain_CustomDomainStatusFields,
        ),
        ...
        "serve": ubx.FieldSpec(
            wire_name="serve",
            kind="object",
            fields=_V1betaFirebaseapphostingV1betaDomain_ServeFields,
        ),
        "type": ubx.FieldSpec(wire_name="type"),
