...
class FirebaseapphostingBackend_Codebase:
...
@dataclasses.dataclass
class FirebaseapphostingBackend_ManagedResources_RunService:
    service: Any = None

@dataclasses.dataclass
class FirebaseapphostingBackend_ManagedResources:
    run_service: Any = None

_FirebaseapphostingBackend_CodebaseFields = {
    "repository": ubx.FieldSpec(wire_name="repository"),
    "root_directory": ubx.FieldSpec(wire_name="root_directory"),
}

_FirebaseapphostingBackend_ManagedResources_RunServiceFields = {
    "service": ubx.FieldSpec(wire_name="service"),
}

_FirebaseapphostingBackend_ManagedResourcesFields = {
    "run_service": ubx.FieldSpec(
        wire_name="run_service",
        kind="object",
        fields=_FirebaseapphostingBackend_ManagedResources_RunServiceFields,
    ),
}

@dataclasses.dataclass
class FirebaseapphostingBackendConfig:
...
@dataclasses.dataclass
class FirebaseapphostingBackendAttrs:
    # Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects.
    annotations: Any = None
    # Optional. The [ID of a Web App](https://firebase.google.com/docs/reference/firebase-management/rest/v1beta1/projects.webApps#WebApp.FIELDS.app_id) associated with the backend.
    app_id: Any = None
...
FirebaseapphostingBackend = ubx.ResourceBinding(
    wire_type="google_firebaseapphosting_firebaseapphosting_backend",
    fields={
        ...
        "codebase": ubx.FieldSpec(
            wire_name="codebase",
            kind="object",
            fields=_FirebaseapphostingBackend_CodebaseFields,
        ),
        ...
        "managed_resources": ubx.FieldSpec(
            ...
            kind="list",
            fields=_FirebaseapphostingBackend_ManagedResourcesFields,
        ),
