...
class V1betaFirebaseapphostingV1betaRollout_Error:
...
_V1betaFirebaseapphostingV1betaRollout_ErrorFields = {
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaRolloutConfig:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaRolloutAttrs:
    # Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects.
    annotations: Any = None
    # Required. Immutable. The name of a build that already exists. It doesn't have to be built; a rollout will wait for a build to be ready before updating traffic.
    build: Any = None
...
V1betaFirebaseapphostingV1betaRollout = ubx.ResourceBinding(
    wire_type="google_firebaseapphosting_v1beta_firebaseapphosting_v1beta_rollout",
    fields={
        ...
        "error": ubx.FieldSpec(
            wire_name="error",
            kind="object",
            fields=_V1betaFirebaseapphostingV1betaRollout_ErrorFields,
        ),
