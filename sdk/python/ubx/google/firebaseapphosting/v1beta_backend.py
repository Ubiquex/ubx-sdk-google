...
@dataclasses.dataclass
class V1betaBackend_ManagedResources_RunService:
    service: Any = None

@dataclasses.dataclass
class V1betaBackend_ManagedResources:
    run_service: Any = None

@dataclasses.dataclass
class V1betaBackend_OverrideEnv:
...
@dataclasses.dataclass
class V1betaBackend_Runtime:
    # Optional. The value of the runtime.
    value: Any = None

_V1betaBackend_CodebaseFields = {
...
_V1betaBackend_RuntimeFields = {
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class V1betaBackendConfig:
...
V1betaBackend = ubx.ResourceBinding(
    wire_type="google_firebaseapphosting_v1beta_backend",
    fields={
        ...
        "runtime": ubx.FieldSpec(
            wire_name="runtime",
            kind="object",
            fields=_V1betaBackend_RuntimeFields,
        ),
