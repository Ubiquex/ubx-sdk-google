...
class V1betaFirebaseapphostingV1betaBuild_Config_EffectiveEnv:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaBuild_Config_RunConfig:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaBuild_Config:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaBuild_Error:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaBuild_Errors:
    cloud_resource: Any = None
    error: Any = None
    error_source: Any = None

@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaBuild_Source_Archive_Author:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaBuild_Source_Archive:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaBuild_Source_Codebase:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaBuild_Source_Container:
    # Required. A URI representing a container for the backend to use.
    image: Any = None

@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaBuild_Source_LocallyBuilt:
    # Optional. An optional message that describes the uploaded version of the source code.
    description: Any = None
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaBuild_Source:
...
_V1betaFirebaseapphostingV1betaBuild_Config_EffectiveEnvFields = {
...
_V1betaFirebaseapphostingV1betaBuild_Config_RunConfigFields = {
...
_V1betaFirebaseapphostingV1betaBuild_ConfigFields = {
    "effective_env": ubx.FieldSpec(
        wire_name="effective_env",
        kind="list",
        fields=_V1betaFirebaseapphostingV1betaBuild_Config_EffectiveEnvFields,
    ),
    "env": ubx.FieldSpec(
        wire_name="env",
        kind="list",
    ...
    "run_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaFirebaseapphostingV1betaBuild_Config_RunConfigFields,
    ),
}

_V1betaFirebaseapphostingV1betaBuild_ErrorFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V1betaFirebaseapphostingV1betaBuild_ErrorsFields = {
    "cloud_resource": ubx.FieldSpec(wire_name="cloud_resource"),
    "error": ubx.FieldSpec(
        wire_name="error",
        kind="object",
        fields=_V1betaFirebaseapphostingV1betaBuild_ErrorFields,
    ),
    "error_source": ubx.FieldSpec(wire_name="error_source"),
}

_V1betaFirebaseapphostingV1betaBuild_Source_Archive_AuthorFields = {
    "display_name": ubx.FieldSpec(wire_name="display_name"),
    "email": ubx.FieldSpec(wire_name="email"),
    "image_uri": ubx.FieldSpec(wire_name="image_uri"),
}

_V1betaFirebaseapphostingV1betaBuild_Source_ArchiveFields = {
    "author": ubx.FieldSpec(
        wire_name="author",
        kind="object",
        fields=_V1betaFirebaseapphostingV1betaBuild_Source_Archive_AuthorFields,
    ),
...
_V1betaFirebaseapphostingV1betaBuild_Source_CodebaseFields = {
    "author": ubx.FieldSpec(
        wire_name="author",
        kind="object",
        fields=_V1betaFirebaseapphostingV1betaBuild_Source_Archive_AuthorFields,
...
_V1betaFirebaseapphostingV1betaBuild_Source_ContainerFields = {
    "image": ubx.FieldSpec(wire_name="image"),
}

_V1betaFirebaseapphostingV1betaBuild_Source_LocallyBuiltFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "env": ubx.FieldSpec(
        wire_name="env",
        kind="list",
...
_V1betaFirebaseapphostingV1betaBuild_SourceFields = {
    "archive": ubx.FieldSpec(
        wire_name="archive",
        kind="object",
        fields=_V1betaFirebaseapphostingV1betaBuild_Source_ArchiveFields,
    ),
    "codebase": ubx.FieldSpec(
        wire_name="codebase",
        kind="object",
        fields=_V1betaFirebaseapphostingV1betaBuild_Source_CodebaseFields,
    ),
    "container": ubx.FieldSpec(
        wire_name="container",
        kind="object",
        fields=_V1betaFirebaseapphostingV1betaBuild_Source_ContainerFields,
    ),
    "locally_built": ubx.FieldSpec(
        wire_name="locally_built",
        kind="object",
        fields=_V1betaFirebaseapphostingV1betaBuild_Source_LocallyBuiltFields,
    ),
}

@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaBuildConfig:
...
@dataclasses.dataclass
class V1betaFirebaseapphostingV1betaBuildAttrs:
    # Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects.
    annotations: Any = None
    # Output only. The location of the [Cloud Build logs](https://cloud.google.com/build/docs/view-build-results) for the build process.
    build_logs_uri: Any = None
...
V1betaFirebaseapphostingV1betaBuild = ubx.ResourceBinding(
    wire_type="google_firebaseapphosting_v1beta_firebaseapphosting_v1beta_build",
    fields={
        ...
        "config": ubx.FieldSpec(
            wire_name="config",
            kind="object",
            fields=_V1betaFirebaseapphostingV1betaBuild_ConfigFields,
        ),
        ...
        "errors": ubx.FieldSpec(
            wire_name="errors",
            kind="list",
            fields=_V1betaFirebaseapphostingV1betaBuild_ErrorsFields,
        ),
        ...
        "source": ubx.FieldSpec(
            wire_name="source",
            kind="object",
            fields=_V1betaFirebaseapphostingV1betaBuild_SourceFields,
        ),
