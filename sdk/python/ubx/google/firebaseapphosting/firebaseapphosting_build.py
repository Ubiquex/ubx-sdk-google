...
class FirebaseapphostingBuild_Config_EffectiveEnv:
...
@dataclasses.dataclass
class FirebaseapphostingBuild_Config_RunConfig:
...
@dataclasses.dataclass
class FirebaseapphostingBuild_Config:
...
@dataclasses.dataclass
class FirebaseapphostingBuild_Errors_Error:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class FirebaseapphostingBuild_Errors:
    cloud_resource: Any = None
    error: Any = None
    error_source: Any = None

@dataclasses.dataclass
class FirebaseapphostingBuild_Source_Archive_Author:
...
@dataclasses.dataclass
class FirebaseapphostingBuild_Source_Archive:
...
@dataclasses.dataclass
class FirebaseapphostingBuild_Source_Codebase:
...
@dataclasses.dataclass
class FirebaseapphostingBuild_Source_Container:
    # Required. A URI representing a container for the backend to use.
    image: Any = None

@dataclasses.dataclass
class FirebaseapphostingBuild_Source:
...
_FirebaseapphostingBuild_Config_EffectiveEnvFields = {
...
_FirebaseapphostingBuild_Config_RunConfigFields = {
...
_FirebaseapphostingBuild_ConfigFields = {
    "effective_env": ubx.FieldSpec(
        wire_name="effective_env",
        kind="list",
        fields=_FirebaseapphostingBuild_Config_EffectiveEnvFields,
    ),
    "env": ubx.FieldSpec(
        wire_name="env",
        kind="list",
    ...
    "run_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_FirebaseapphostingBuild_Config_RunConfigFields,
    ),
}

_FirebaseapphostingBuild_Errors_ErrorFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_FirebaseapphostingBuild_ErrorsFields = {
    "cloud_resource": ubx.FieldSpec(wire_name="cloud_resource"),
    "error": ubx.FieldSpec(
        wire_name="error",
        kind="object",
        fields=_FirebaseapphostingBuild_Errors_ErrorFields,
    ),
    "error_source": ubx.FieldSpec(wire_name="error_source"),
}

_FirebaseapphostingBuild_Source_Archive_AuthorFields = {
    "display_name": ubx.FieldSpec(wire_name="display_name"),
    "email": ubx.FieldSpec(wire_name="email"),
    "image_uri": ubx.FieldSpec(wire_name="image_uri"),
}

_FirebaseapphostingBuild_Source_ArchiveFields = {
    "author": ubx.FieldSpec(
        wire_name="author",
        kind="object",
        fields=_FirebaseapphostingBuild_Source_Archive_AuthorFields,
    ),
...
_FirebaseapphostingBuild_Source_CodebaseFields = {
    "author": ubx.FieldSpec(
        wire_name="author",
        kind="object",
        fields=_FirebaseapphostingBuild_Source_Archive_AuthorFields,
...
_FirebaseapphostingBuild_Source_ContainerFields = {
    "image": ubx.FieldSpec(wire_name="image"),
}

_FirebaseapphostingBuild_SourceFields = {
    "archive": ubx.FieldSpec(
        wire_name="archive",
        kind="object",
        fields=_FirebaseapphostingBuild_Source_ArchiveFields,
    ),
    "codebase": ubx.FieldSpec(
        wire_name="codebase",
        kind="object",
        fields=_FirebaseapphostingBuild_Source_CodebaseFields,
    ),
    "container": ubx.FieldSpec(
        wire_name="container",
        kind="object",
        fields=_FirebaseapphostingBuild_Source_ContainerFields,
    ),
}

@dataclasses.dataclass
class FirebaseapphostingBuildConfig:
...
@dataclasses.dataclass
class FirebaseapphostingBuildAttrs:
    # Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects.
    annotations: Any = None
    # Output only. The location of the [Cloud Build logs](https://cloud.google.com/build/docs/view-build-results) for the build process.
    build_logs_uri: Any = None
...
FirebaseapphostingBuild = ubx.ResourceBinding(
    wire_type="google_firebaseapphosting_firebaseapphosting_build",
    fields={
        ...
        "config": ubx.FieldSpec(
            wire_name="config",
            kind="object",
            fields=_FirebaseapphostingBuild_ConfigFields,
        ),
        ...
        "errors": ubx.FieldSpec(
            wire_name="errors",
            kind="list",
            fields=_FirebaseapphostingBuild_ErrorsFields,
        ),
        ...
        "source": ubx.FieldSpec(
            wire_name="source",
            kind="object",
            fields=_FirebaseapphostingBuild_SourceFields,
        ),
