...
@dataclasses.dataclass
class Build_Source_Archive_Author:
...
_Build_Config_EffectiveEnvFields = {
...
_Build_ConfigFields = {
    "effective_env": ubx.FieldSpec(
        ...
        kind="list",
        fields=_Build_Config_EffectiveEnvFields,
    ),
    "env": ubx.FieldSpec(
        wire_name="env",
        kind="list",
    ...
    "run_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Build_Config_RunConfigFields,
    ),
}

_Build_Errors_ErrorFields = {
...
_Build_SourceFields = {
    "archive": ubx.FieldSpec(
        wire_name="archive",
        kind="object",
        fields=_Build_Source_ArchiveFields,
    ),
    "codebase": ubx.FieldSpec(
        wire_name="codebase",
        kind="object",
        fields=_Build_Source_CodebaseFields,
    ),
    "container": ubx.FieldSpec(
        wire_name="container",
        kind="object",
        fields=_Build_Source_ContainerFields,
    ),
}
...
Build = ubx.ResourceBinding(
    wire_type="google_firebaseapphosting_build",
    fields={
