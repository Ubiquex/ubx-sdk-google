...
V1betaRollout = ubx.ResourceBinding(
    wire_type="google_firebaseapphosting_v1beta_rollout",
    fields={
        ...
        "error": ubx.FieldSpec(
            wire_name="error",
            kind="object",
            fields=_V1betaRollout_ErrorFields,
        ),
