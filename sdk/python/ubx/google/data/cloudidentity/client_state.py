...
class ClientState_KeyValuePairs:
    bool_value: Any = None
    number_value: Any = None
    string_value: Any = None

@dataclasses.dataclass
class ClientStateConfig:
    customer: Any = None

@dataclasses.dataclass
class ClientStateAttrs:
...
ClientState = ubx.DataSourceBinding(
    wire_type="google_cloudidentity_client_state",
    fields={
