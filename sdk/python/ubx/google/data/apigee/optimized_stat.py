...
class OptimizedStat_Response_MetaData:
...
@dataclasses.dataclass
class OptimizedStat_Response_Stats:
    # List of data values.
    data: Any = None

@dataclasses.dataclass
class OptimizedStat_Response:
...
OptimizedStat = ubx.DataSourceBinding(
    wire_type="google_apigee_optimized_stat",
    fields={
