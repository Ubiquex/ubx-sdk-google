...
class V1betaTraffic_Current_Splits:
    build: Any = None
    percent: Any = None

@dataclasses.dataclass
class V1betaTraffic_Current:
    # Required. The list of traffic splits.
    splits: Any = None

@dataclasses.dataclass
class V1betaTraffic_RolloutPolicy_IgnoredPaths:
    pattern: Any = None
    type: Any = None

@dataclasses.dataclass
class V1betaTraffic_RolloutPolicy:
...
@dataclasses.dataclass
class V1betaTrafficConfig:
    name: Any = None

@dataclasses.dataclass
class V1betaTrafficAttrs:
...
V1betaTraffic = ubx.DataSourceBinding(
    wire_type="google_firebaseapphosting_v1beta_traffic",
    fields={
