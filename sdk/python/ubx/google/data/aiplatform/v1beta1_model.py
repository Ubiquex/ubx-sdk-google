...
class V1beta1Model_BaseModelSource_GenieSource:
    # Required. The public base model URI.
    base_model_uri: Any = None

@dataclasses.dataclass
class V1beta1Model_BaseModelSource_ModelGardenSource:
...
@dataclasses.dataclass
class V1beta1Model_BaseModelSource:
...
@dataclasses.dataclass
class V1beta1Model_Checkpoints:
    checkpoint_id: Any = None
    epoch: Any = None
    step: Any = None

@dataclasses.dataclass
class V1beta1Model_ContainerSpec_Env:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class V1beta1Model_ContainerSpec_GrpcPorts:
    container_port: Any = None

@dataclasses.dataclass
class V1beta1Model_ContainerSpec_HealthProbe_Exec:
    # Command is the command line to execute inside the container, the working directory for the command is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.
    command: Any = None

@dataclasses.dataclass
class V1beta1Model_ContainerSpec_HealthProbe_Grpc:
...
@dataclasses.dataclass
class V1beta1Model_ContainerSpec_HealthProbe_HttpGet:
...
@dataclasses.dataclass
class V1beta1Model_ContainerSpec_HealthProbe_TcpSocket:
...
@dataclasses.dataclass
class V1beta1Model_ContainerSpec_HealthProbe:
...
@dataclasses.dataclass
class V1beta1Model_ContainerSpec:
...
@dataclasses.dataclass
class V1beta1Model_DeployedModels:
    checkpoint_id: Any = None
    deployed_model_id: Any = None
    endpoint: Any = None

@dataclasses.dataclass
class V1beta1Model_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Metadata_Inputs_FeatureValueDomain:
    max_value: Any = None
    min_value: Any = None
...
@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Metadata_Inputs_Visualization:
...
@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Metadata_Inputs:
...
@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource:
    # Required. Google Cloud Storage URI(-s) to the input file(s). May contain wildcards. For more information on wildcards, see https://cloud.google.com/storage/docs/wildcards.
    uris: Any = None

@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Parameters_Examples_ExampleGcsSource:
...
@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Parameters_Examples_Presets:
...
@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Parameters_Examples:
...
@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig:
...
@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma:
    name: Any = None
    sigma: Any = None

@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma:
    # Noise sigma per feature. No noise is added to features that are not set.
    noise_sigma: Any = None

@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig:
...
@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Parameters_IntegratedGradientsAttribution:
...
@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Parameters_SampledShapleyAttribution:
...
@dataclasses.dataclass
class V1beta1Model_ExplanationSpec_Parameters:
...
@dataclasses.dataclass
class V1beta1Model_ExplanationSpec:
...
@dataclasses.dataclass
class V1beta1Model_ModelSourceInfo:
...
@dataclasses.dataclass
class V1beta1Model_OriginalModelInfo:
...
@dataclasses.dataclass
class V1beta1Model_PredictSchemata:
...
@dataclasses.dataclass
class V1beta1Model_SupportedExportFormats:
    exportable_contents: Any = None
    id: Any = None

@dataclasses.dataclass
class V1beta1ModelConfig:
    name: Any = None

@dataclasses.dataclass
class V1beta1ModelAttrs:
...
V1beta1Model = ubx.DataSourceBinding(
    wire_type="google_aiplatform_v1beta1_model",
    fields={
