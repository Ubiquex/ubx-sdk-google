...
class FeatureViewSync_FinalStatus:
...
@dataclasses.dataclass
class FeatureViewSync_SyncSummary:
...
FeatureViewSync = ubx.DataSourceBinding(
    wire_type="google_aiplatform_feature_view_sync",
    fields={
