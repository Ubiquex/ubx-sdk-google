...
class V1beta1NotebookRuntime_DataPersistentDiskSpec:
...
@dataclasses.dataclass
class V1beta1NotebookRuntime_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class V1beta1NotebookRuntime_EucConfig:
...
@dataclasses.dataclass
class V1beta1NotebookRuntime_IdleShutdownConfig:
...
@dataclasses.dataclass
class V1beta1NotebookRuntime_MachineSpec_ReservationAffinity:
...
@dataclasses.dataclass
class V1beta1NotebookRuntime_MachineSpec:
...
@dataclasses.dataclass
class V1beta1NotebookRuntime_NetworkSpec:
...
@dataclasses.dataclass
class V1beta1NotebookRuntime_NotebookRuntimeTemplateRef:
    # Immutable. A resource name of the NotebookRuntimeTemplate.
    notebook_runtime_template: Any = None

@dataclasses.dataclass
class V1beta1NotebookRuntime_ReservationAffinity:
...
@dataclasses.dataclass
class V1beta1NotebookRuntime_ShieldedVmConfig:
...
@dataclasses.dataclass
class V1beta1NotebookRuntime_SoftwareConfig_ColabImage:
...
@dataclasses.dataclass
class V1beta1NotebookRuntime_SoftwareConfig_Env:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class V1beta1NotebookRuntime_SoftwareConfig_PostStartupScriptConfig:
...
@dataclasses.dataclass
class V1beta1NotebookRuntime_SoftwareConfig:
...
@dataclasses.dataclass
class V1beta1NotebookRuntimeConfig:
    name: Any = None

@dataclasses.dataclass
class V1beta1NotebookRuntimeAttrs:
...
V1beta1NotebookRuntime = ubx.DataSourceBinding(
    wire_type="google_aiplatform_v1beta1_notebook_runtime",
    fields={
