...
class Conversation_Messages_Chunks_AgentTransfer:
    display_name: Any = None
    target_agent: Any = None

@dataclasses.dataclass
class Conversation_Messages_Chunks_Blob:
    data: Any = None
    mime_type: Any = None
...
@dataclasses.dataclass
class Conversation_Messages_Chunks:
...
@dataclasses.dataclass
class Conversation_Turns_RootSpan:
    attributes: Any = None
