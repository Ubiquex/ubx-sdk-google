...
class V1betaDeviceCheckConfigConfig:
    name: Any = None

@dataclasses.dataclass
class V1betaDeviceCheckConfigAttrs:
...
V1betaDeviceCheckConfig = ubx.DataSourceBinding(
    wire_type="google_firebaseappcheck_v1beta_device_check_config",
    fields={
