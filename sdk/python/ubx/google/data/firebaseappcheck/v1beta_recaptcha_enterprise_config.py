...
class V1betaRecaptchaEnterpriseConfig_RiskAnalysis:
...
@dataclasses.dataclass
class V1betaRecaptchaEnterpriseConfigConfig:
    name: Any = None

@dataclasses.dataclass
class V1betaRecaptchaEnterpriseConfigAttrs:
    name: Any = None
...
V1betaRecaptchaEnterpriseConfig = ubx.DataSourceBinding(
    wire_type="google_firebaseappcheck_v1beta_recaptcha_enterprise_config",
    fields={
