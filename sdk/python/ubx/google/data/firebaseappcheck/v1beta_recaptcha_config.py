...
class V1betaRecaptchaConfigConfig:
    name: Any = None

@dataclasses.dataclass
class V1betaRecaptchaConfigAttrs:
...
V1betaRecaptchaConfig = ubx.DataSourceBinding(
    wire_type="google_firebaseappcheck_v1beta_recaptcha_config",
    fields={
