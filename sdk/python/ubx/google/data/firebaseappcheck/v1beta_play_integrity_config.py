...
class V1betaPlayIntegrityConfig_AccountDetails:
...
@dataclasses.dataclass
class V1betaPlayIntegrityConfig_AppIntegrity:
...
@dataclasses.dataclass
class V1betaPlayIntegrityConfig_DeviceIntegrity:
...
@dataclasses.dataclass
class V1betaPlayIntegrityConfigConfig:
    name: Any = None

@dataclasses.dataclass
class V1betaPlayIntegrityConfigAttrs:
...
V1betaPlayIntegrityConfig = ubx.DataSourceBinding(
    wire_type="google_firebaseappcheck_v1beta_play_integrity_config",
    fields={
