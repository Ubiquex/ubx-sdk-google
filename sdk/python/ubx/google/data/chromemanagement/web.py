...
class Web_AndroidAppInfo_Permissions:
    type: Any = None

@dataclasses.dataclass
class Web_AndroidAppInfo:
    # Output only. Permissions requested by an Android app.
    permissions: Any = None

@dataclasses.dataclass
class Web_ChromeAppInfo_Permissions:
    access_user_data: Any = None
    documentation_uri: Any = None
    type: Any = None

@dataclasses.dataclass
class Web_ChromeAppInfo_SiteAccess:
    host_match: Any = None

@dataclasses.dataclass
class Web_ChromeAppInfo:
