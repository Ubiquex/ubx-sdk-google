...
class V1betaRollout_MembershipStates_Targets:
    cluster: Any = None
    node_pool: Any = None
    operation: Any = None
    reason: Any = None
...
@dataclasses.dataclass
class V1betaRollout_MembershipStates:
    last_update_time: Any = None
    stage_assignment: Any = None
    targets: Any = None

@dataclasses.dataclass
class V1betaRollout_Stages_ClusterSelector:
    label_selector: Any = None

@dataclasses.dataclass
class V1betaRollout_Stages:
...
@dataclasses.dataclass
class V1betaRollout_VersionUpgrade:
...
@dataclasses.dataclass
class V1betaRolloutConfig:
    name: Any = None

@dataclasses.dataclass
class V1betaRolloutAttrs:
...
V1betaRollout = ubx.DataSourceBinding(
    wire_type="google_gkehub_v1beta_rollout",
    fields={
