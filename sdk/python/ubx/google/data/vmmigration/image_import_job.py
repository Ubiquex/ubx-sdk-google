...
class ImageImportJob_DiskImageTargetDetails_DataDiskImageImport:
...
@dataclasses.dataclass
class ImageImportJob_DiskImageTargetDetails_Encryption:
    # Required. The name of the encryption key that is stored in Google Cloud KMS.
    kms_key: Any = None

@dataclasses.dataclass
class ImageImportJob_DiskImageTargetDetails_OsAdaptationParameters_AdaptationModifiers:
    modifier: Any = None
    value: Any = None

@dataclasses.dataclass
class ImageImportJob_DiskImageTargetDetails_OsAdaptationParameters:
...
@dataclasses.dataclass
class ImageImportJob_DiskImageTargetDetails:
...
@dataclasses.dataclass
class ImageImportJob_Errors:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class ImageImportJob_MachineImageTargetDetails_MachineImageParametersOverrides:
...
@dataclasses.dataclass
class ImageImportJob_MachineImageTargetDetails_NetworkInterfaces:
...
@dataclasses.dataclass
class ImageImportJob_MachineImageTargetDetails_ServiceAccount:
...
@dataclasses.dataclass
class ImageImportJob_MachineImageTargetDetails_ShieldedInstanceConfig:
...
@dataclasses.dataclass
class ImageImportJob_MachineImageTargetDetails:
...
@dataclasses.dataclass
class ImageImportJob_Warnings_ActionItem:
    locale: Any = None
    message: Any = None

@dataclasses.dataclass
class ImageImportJob_Warnings_HelpLinks:
    description: Any = None
    url: Any = None

@dataclasses.dataclass
class ImageImportJob_Warnings:
...
@dataclasses.dataclass
class ImageImportJobConfig:
    pass

@dataclasses.dataclass
class ImageImportJobAttrs:
...
ImageImportJob = ubx.DataSourceBinding(
    wire_type="google_vmmigration_image_import_job",
    fields={
    },
)
