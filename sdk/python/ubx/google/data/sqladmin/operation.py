...
class Operation_AcquireSsrsLeaseContext:
...
@dataclasses.dataclass
class Operation_ExportContext_BakExportOptions:
...
@dataclasses.dataclass
class Operation_ExportContext_CsvExportOptions:
...
@dataclasses.dataclass
class Operation_ExportContext_SqlExportOptions_MysqlExportOptions:
...
@dataclasses.dataclass
class Operation_ExportContext_SqlExportOptions_PostgresExportOptions:
...
@dataclasses.dataclass
class Operation_ExportContext_SqlExportOptions:
...
@dataclasses.dataclass
class Operation_ExportContext_TdeExportOptions:
...
@dataclasses.dataclass
class Operation_ImportContext_BakImportOptions_EncryptionOptions:
...
@dataclasses.dataclass
class Operation_ImportContext_BakImportOptions:
...
@dataclasses.dataclass
class Operation_ImportContext_CsvImportOptions:
...
@dataclasses.dataclass
class Operation_ImportContext_SqlImportOptions:
...
@dataclasses.dataclass
class Operation_PreCheckMajorVersionUpgradeContext_PreCheckResponse:
    actions_required: Any = None
    message: Any = None
    message_type: Any = None

@dataclasses.dataclass
class Operation_PreCheckMajorVersionUpgradeContext:
...
@dataclasses.dataclass
class Operation_SubOperationType:
...
Operation = ubx.DataSourceBinding(
    wire_type="google_sqladmin_operation",
    fields={
