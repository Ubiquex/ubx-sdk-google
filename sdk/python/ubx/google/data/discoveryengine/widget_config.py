...
class WidgetConfig_AccessSettings:
...
@dataclasses.dataclass
class WidgetConfig_AssistantSettings:
...
@dataclasses.dataclass
class WidgetConfig_BatchAuthStatuses_ConnectorAuthState:
    auth_state: Any = None
    authorization_uri: Any = None
    update_time: Any = None

@dataclasses.dataclass
class WidgetConfig_BatchAuthStatuses:
    batch_authorization_group: Any = None
    connector_auth_state: Any = None
    placeholder: Any = None

@dataclasses.dataclass
class WidgetConfig_CollectionComponents_DataStoreComponents:
...
@dataclasses.dataclass
class WidgetConfig_CollectionComponents_Metadata:
    author: Any = None
...
@dataclasses.dataclass
class WidgetConfig_CollectionComponents:
    connector_auth_state: Any = None
...
@dataclasses.dataclass
class WidgetConfig_ContentSearchSpec_ChunkSpec:
...
@dataclasses.dataclass
class WidgetConfig_ContentSearchSpec_ExtractiveContentSpec:
...
@dataclasses.dataclass
class WidgetConfig_ContentSearchSpec_SnippetSpec:
...
@dataclasses.dataclass
class WidgetConfig_ContentSearchSpec_SummarySpec_ModelPromptSpec:
    # Text at the beginning of the prompt that instructs the assistant. Examples are available in the user guide.
    preamble: Any = None

@dataclasses.dataclass
class WidgetConfig_ContentSearchSpec_SummarySpec_ModelSpec:
...
@dataclasses.dataclass
class WidgetConfig_ContentSearchSpec_SummarySpec:
...
@dataclasses.dataclass
class WidgetConfig_ContentSearchSpec:
...
@dataclasses.dataclass
class WidgetConfig_DataStoreUiConfigs_FacetField:
    display_name: Any = None
    field: Any = None

@dataclasses.dataclass
class WidgetConfig_DataStoreUiConfigs_FieldsUiComponentsMap:
    device_visibility: Any = None
    display_template: Any = None
    field: Any = None

@dataclasses.dataclass
class WidgetConfig_DataStoreUiConfigs:
...
@dataclasses.dataclass
class WidgetConfig_HomepageSetting_Shortcuts_Icon:
    url: Any = None

@dataclasses.dataclass
class WidgetConfig_HomepageSetting_Shortcuts:
    destination_uri: Any = None
    icon: Any = None
    title: Any = None

@dataclasses.dataclass
class WidgetConfig_HomepageSetting:
    # Optional. The shortcuts to display on the homepage.
    shortcuts: Any = None

@dataclasses.dataclass
class WidgetConfig_Nodes:
    description: Any = None
    display_name: Any = None
    icon_url: Any = None
...
@dataclasses.dataclass
class WidgetConfig_UiBranding:
    # Options to store an image.
    logo: Any = None

@dataclasses.dataclass
class WidgetConfig_UiSettings_GenerativeAnswerConfig:
...
@dataclasses.dataclass
class WidgetConfig_UiSettings_ModelConfigInfo_ResolvedModels_AdminView:
    admin_overridable: Any = None
    enabled_by_default: Any = None
    regions: Any = None

@dataclasses.dataclass
class WidgetConfig_UiSettings_ModelConfigInfo_ResolvedModels:
    admin_view: Any = None
    description: Any = None
    display_name: Any = None
    icon: Any = None
...
@dataclasses.dataclass
class WidgetConfig_UiSettings_ModelConfigInfo:
...
WidgetConfig = ubx.DataSourceBinding(
    wire_type="google_discoveryengine_widget_config",
    fields={
