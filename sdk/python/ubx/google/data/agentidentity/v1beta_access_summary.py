...
class V1betaAccessSummaryConfig:
    name: Any = None

@dataclasses.dataclass
class V1betaAccessSummaryAttrs:
...
V1betaAccessSummary = ubx.DataSourceBinding(
    wire_type="google_agentidentity_v1beta_access_summary",
    fields={
