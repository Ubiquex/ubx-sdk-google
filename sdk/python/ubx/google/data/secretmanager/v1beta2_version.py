...
class V1beta2Version_CustomerManagedEncryption:
...
@dataclasses.dataclass
class V1beta2Version_ReplicationStatus_Automatic:
    # Describes the status of customer-managed encryption.
    customer_managed_encryption: Any = None

@dataclasses.dataclass
class V1beta2Version_ReplicationStatus_UserManaged_Replicas:
    customer_managed_encryption: Any = None
    location: Any = None

@dataclasses.dataclass
class V1beta2Version_ReplicationStatus_UserManaged:
    # Output only. The list of replica statuses for the SecretVersion.
    replicas: Any = None

@dataclasses.dataclass
class V1beta2Version_ReplicationStatus:
