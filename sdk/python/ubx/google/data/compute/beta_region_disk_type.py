...
class BetaRegionDiskType_Deprecated_StateOverride:
...
@dataclasses.dataclass
class BetaRegionDiskType_Deprecated:
...
@dataclasses.dataclass
class BetaRegionDiskTypeConfig:
    disk_type: Any = None
    project: Any = None
    region: Any = None

@dataclasses.dataclass
class BetaRegionDiskTypeAttrs:
...
BetaRegionDiskType = ubx.DataSourceBinding(
    wire_type="google_compute_beta_region_disk_type",
    fields={
