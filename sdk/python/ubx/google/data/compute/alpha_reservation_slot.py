...
class AlphaReservationSlot_Resource_PhysicalTopology:
...
@dataclasses.dataclass
class AlphaReservationSlot_Resource_ShareSettings_FolderMap:
    folder_id: Any = None

@dataclasses.dataclass
class AlphaReservationSlot_Resource_ShareSettings_ProjectMap:
    project_id: Any = None

@dataclasses.dataclass
class AlphaReservationSlot_Resource_ShareSettings:
...
@dataclasses.dataclass
class AlphaReservationSlot_Resource_Status:
...
@dataclasses.dataclass
class AlphaReservationSlot_Resource:
...
@dataclasses.dataclass
class AlphaReservationSlotConfig:
...
@dataclasses.dataclass
class AlphaReservationSlotAttrs:
    parent_name: Any = None
    project: Any = None
    reservation_slot: Any = None
...
AlphaReservationSlot = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_reservation_slot",
    fields={
