...
class Rollout_RolloutEntity_OrchestratedEntity:
...
@dataclasses.dataclass
class Rollout_WaveDetails_OrchestratedWaveDetails_LocationStatus:
    state: Any = None

@dataclasses.dataclass
class Rollout_WaveDetails_OrchestratedWaveDetails:
...
Rollout = ubx.DataSourceBinding(
    wire_type="google_compute_rollout",
    fields={
