...
class BetaStoragePoolType_Deprecated_StateOverride:
...
@dataclasses.dataclass
class BetaStoragePoolType_Deprecated:
...
@dataclasses.dataclass
class BetaStoragePoolTypeConfig:
    project: Any = None
    storage_pool_type: Any = None
    zone: Any = None

@dataclasses.dataclass
class BetaStoragePoolTypeAttrs:
...
BetaStoragePoolType = ubx.DataSourceBinding(
    wire_type="google_compute_beta_storage_pool_type",
    fields={
