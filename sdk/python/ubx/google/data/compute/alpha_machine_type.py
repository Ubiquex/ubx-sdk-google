...
class AlphaMachineType_Accelerators:
    guest_accelerator_count: Any = None
    guest_accelerator_type: Any = None

@dataclasses.dataclass
class AlphaMachineType_BundledLocalSsds:
...
@dataclasses.dataclass
class AlphaMachineType_Deprecated_StateOverride:
...
@dataclasses.dataclass
class AlphaMachineType_Deprecated:
...
@dataclasses.dataclass
class AlphaMachineTypeConfig:
    machine_type: Any = None
    project: Any = None
    zone: Any = None

@dataclasses.dataclass
class AlphaMachineTypeAttrs:
...
AlphaMachineType = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_machine_type",
    fields={
