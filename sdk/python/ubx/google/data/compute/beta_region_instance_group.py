...
class BetaRegionInstanceGroup_NamedPorts:
    name: Any = None
    port: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupConfig:
    instance_group: Any = None
    project: Any = None
    region: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupAttrs:
...
BetaRegionInstanceGroup = ubx.DataSourceBinding(
    wire_type="google_compute_beta_region_instance_group",
    fields={
