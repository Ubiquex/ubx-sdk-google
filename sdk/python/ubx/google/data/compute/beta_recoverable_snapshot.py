...
class BetaRecoverableSnapshot_OriginalResource_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class BetaRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey:
...
@dataclasses.dataclass
class BetaRecoverableSnapshot_OriginalResource:
...
@dataclasses.dataclass
class BetaRecoverableSnapshotConfig:
    project: Any = None
    recoverable_snapshot: Any = None

@dataclasses.dataclass
class BetaRecoverableSnapshotAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaRecoverableSnapshot = ubx.DataSourceBinding(
    wire_type="google_compute_beta_recoverable_snapshot",
    fields={
