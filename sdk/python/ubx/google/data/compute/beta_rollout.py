...
class BetaRollout_RolloutEntity_OrchestratedEntity:
...
@dataclasses.dataclass
class BetaRollout_RolloutEntity:
...
@dataclasses.dataclass
class BetaRollout_WaveDetails_OrchestratedWaveDetails_LocationStatus:
    state: Any = None

@dataclasses.dataclass
class BetaRollout_WaveDetails_OrchestratedWaveDetails:
...
BetaRollout = ubx.DataSourceBinding(
    wire_type="google_compute_beta_rollout",
    fields={
