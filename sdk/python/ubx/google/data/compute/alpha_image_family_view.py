...
class AlphaImageFamilyView_Image_Deprecated_StateOverride:
...
@dataclasses.dataclass
class AlphaImageFamilyView_Image_Deprecated:
...
@dataclasses.dataclass
class AlphaImageFamilyView_Image_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class AlphaImageFamilyView_Image_ImageEncryptionKey:
...
@dataclasses.dataclass
class AlphaImageFamilyView_Image_Params:
...
@dataclasses.dataclass
class AlphaImageFamilyView_Image_RawDisk:
...
@dataclasses.dataclass
class AlphaImageFamilyView_Image_ShieldedInstanceInitialState_Dbs:
    content: Any = None
    file_type: Any = None

@dataclasses.dataclass
class AlphaImageFamilyView_Image_ShieldedInstanceInitialState:
    # The Key Database (db).
    dbs: Any = None
...
@dataclasses.dataclass
class AlphaImageFamilyView_Image:
...
@dataclasses.dataclass
class AlphaImageFamilyViewConfig:
    family: Any = None
    project: Any = None
    zone: Any = None

@dataclasses.dataclass
class AlphaImageFamilyViewAttrs:
    family: Any = None
...
AlphaImageFamilyView = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_image_family_view",
    fields={
