...
class InterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges:
    max: Any = None
    min: Any = None

@dataclasses.dataclass
class InterconnectRemoteLocation_AttachmentConfigurationConstraints:
...
@dataclasses.dataclass
class InterconnectRemoteLocation_Constraints:
...
@dataclasses.dataclass
class InterconnectRemoteLocation_PermittedConnections:
    interconnect_location: Any = None

@dataclasses.dataclass
class InterconnectRemoteLocationConfig:
    interconnect_remote_location: Any = None
    project: Any = None

@dataclasses.dataclass
class InterconnectRemoteLocationAttrs:
...
InterconnectRemoteLocation = ubx.DataSourceBinding(
    wire_type="google_compute_interconnect_remote_location",
    fields={
