...
class AlphaRegionInstanceGroup_NamedPorts:
    name: Any = None
    port: Any = None

@dataclasses.dataclass
class AlphaRegionInstanceGroupConfig:
    instance_group: Any = None
    project: Any = None
    region: Any = None

@dataclasses.dataclass
class AlphaRegionInstanceGroupAttrs:
...
AlphaRegionInstanceGroup = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_region_instance_group",
    fields={
