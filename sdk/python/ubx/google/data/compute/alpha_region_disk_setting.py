...
class AlphaRegionDiskSetting_AccessLocation_Locations:
    region: Any = None

@dataclasses.dataclass
class AlphaRegionDiskSetting_AccessLocation:
...
@dataclasses.dataclass
class AlphaRegionDiskSetting_DefaultResourcePolicies:
    excluded_disk_types: Any = None
    resource_policy: Any = None

@dataclasses.dataclass
class AlphaRegionDiskSettingConfig:
    project: Any = None
    region: Any = None

@dataclasses.dataclass
class AlphaRegionDiskSettingAttrs:
...
AlphaRegionDiskSetting = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_region_disk_setting",
    fields={
