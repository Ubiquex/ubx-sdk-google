...
class AlphaAcceleratorType_Deprecated_StateOverride:
...
@dataclasses.dataclass
class AlphaAcceleratorType_Deprecated:
...
@dataclasses.dataclass
class AlphaAcceleratorTypeConfig:
    accelerator_type: Any = None
    project: Any = None
    zone: Any = None

@dataclasses.dataclass
class AlphaAcceleratorTypeAttrs:
    accelerator_type: Any = None
...
AlphaAcceleratorType = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_accelerator_type",
    fields={
