...
class AlphaZone_Deprecated_StateOverride:
...
@dataclasses.dataclass
class AlphaZone_ResourceStatus_UpcomingMaintenances_WindowEndTime_TimeZone:
    id: Any = None
    version: Any = None

@dataclasses.dataclass
class AlphaZone_ResourceStatus_UpcomingMaintenances_WindowEndTime:
    day: Any = None
    hours: Any = None
    minutes: Any = None
    month: Any = None
...
@dataclasses.dataclass
class AlphaZone_ResourceStatus_UpcomingMaintenances:
    sub_type: Any = None
...
AlphaZone = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_zone",
    fields={
