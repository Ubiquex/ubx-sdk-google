...
class AlphaRollout_RolloutEntity_OrchestratedEntity:
...
@dataclasses.dataclass
class AlphaRollout_RolloutEntity:
...
@dataclasses.dataclass
class AlphaRollout_WaveDetails_OrchestratedWaveDetails_LocationStatus:
    state: Any = None

@dataclasses.dataclass
class AlphaRollout_WaveDetails_OrchestratedWaveDetails:
...
AlphaRollout = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_rollout",
    fields={
