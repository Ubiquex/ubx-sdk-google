...
class BetaProject_CommonInstanceMetadata_Items:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class BetaProject_CommonInstanceMetadata:
...
@dataclasses.dataclass
class BetaProject_UsageExportLocation:
...
@dataclasses.dataclass
class BetaProjectConfig:
    project: Any = None

@dataclasses.dataclass
class BetaProjectAttrs:
...
BetaProject = ubx.DataSourceBinding(
    wire_type="google_compute_beta_project",
    fields={
