...
class AlphaRegionDiskType_Deprecated_StateOverride:
...
@dataclasses.dataclass
class AlphaRegionDiskType_Deprecated:
...
@dataclasses.dataclass
class AlphaRegionDiskTypeConfig:
    disk_type: Any = None
    project: Any = None
    region: Any = None

@dataclasses.dataclass
class AlphaRegionDiskTypeAttrs:
...
AlphaRegionDiskType = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_region_disk_type",
    fields={
