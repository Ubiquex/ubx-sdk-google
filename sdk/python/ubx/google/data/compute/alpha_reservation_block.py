...
class AlphaReservationBlock_Resource_HealthInfo:
...
@dataclasses.dataclass
class AlphaReservationBlock_Resource_PhysicalTopology_Instances_PhysicalHostTopology:
    host: Any = None
    sub_block: Any = None

@dataclasses.dataclass
class AlphaReservationBlock_Resource_PhysicalTopology_Instances:
    instance_id: Any = None
    physical_host_topology: Any = None
    project_id: Any = None

@dataclasses.dataclass
class AlphaReservationBlock_Resource_PhysicalTopology:
...
@dataclasses.dataclass
class AlphaReservationBlock_Resource_ReservationMaintenance_UpcomingGroupMaintenance_StartTimeWindow:
    earliest: Any = None
    latest: Any = None

@dataclasses.dataclass
class AlphaReservationBlock_Resource_ReservationMaintenance_UpcomingGroupMaintenance:
...
@dataclasses.dataclass
class AlphaReservationBlock_Resource_ReservationMaintenance:
...
@dataclasses.dataclass
class AlphaReservationBlock_Resource:
...
@dataclasses.dataclass
class AlphaReservationBlockConfig:
    project: Any = None
...
@dataclasses.dataclass
class AlphaReservationBlockAttrs:
    project: Any = None
    reservation: Any = None
    reservation_block: Any = None
...
AlphaReservationBlock = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_reservation_block",
    fields={
