...
class BetaImageView_Image_Deprecated_StateOverride:
...
@dataclasses.dataclass
class BetaImageView_Image_Deprecated:
...
@dataclasses.dataclass
class BetaImageView_Image_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class BetaImageView_Image_ImageEncryptionKey:
...
@dataclasses.dataclass
class BetaImageView_Image_Params:
...
@dataclasses.dataclass
class BetaImageView_Image_RawDisk:
...
@dataclasses.dataclass
class BetaImageView_Image_ShieldedInstanceInitialState_Dbs:
    content: Any = None
    file_type: Any = None

@dataclasses.dataclass
class BetaImageView_Image_ShieldedInstanceInitialState:
    # The Key Database (db).
    dbs: Any = None
...
@dataclasses.dataclass
class BetaImageViewConfig:
    project: Any = None
    region: Any = None
    resource_id: Any = None

@dataclasses.dataclass
class BetaImageViewAttrs:
...
BetaImageView = ubx.DataSourceBinding(
    wire_type="google_compute_beta_image_view",
    fields={
