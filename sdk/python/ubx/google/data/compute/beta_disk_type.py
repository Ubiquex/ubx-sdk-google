...
class BetaDiskType_Deprecated_StateOverride:
...
@dataclasses.dataclass
class BetaDiskTypeConfig:
    disk_type: Any = None
    project: Any = None
    zone: Any = None

@dataclasses.dataclass
class BetaDiskTypeAttrs:
...
BetaDiskType = ubx.DataSourceBinding(
    wire_type="google_compute_beta_disk_type",
    fields={
