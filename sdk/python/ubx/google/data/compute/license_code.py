...
class LicenseCode_LicenseAlias:
    description: Any = None
    self_link: Any = None

@dataclasses.dataclass
class LicenseCode_MinimumRetention:
...
@dataclasses.dataclass
class LicenseCodeConfig:
    license_code: Any = None
    project: Any = None

@dataclasses.dataclass
class LicenseCodeAttrs:
...
LicenseCode = ubx.DataSourceBinding(
    wire_type="google_compute_license_code",
    fields={
