...
class ReservationSubBlock_Resource_AcceleratorTopologiesInfo_AcceleratorTopologyInfos_InfoPerTopologyStates:
    count: Any = None
    state: Any = None

@dataclasses.dataclass
class ReservationSubBlock_Resource_AcceleratorTopologiesInfo_AcceleratorTopologyInfos:
    accelerator_topology: Any = None
    info_per_topology_states: Any = None

@dataclasses.dataclass
class ReservationSubBlock_Resource_AcceleratorTopologiesInfo:
    # Info for each accelerator topology.
    accelerator_topology_infos: Any = None

@dataclasses.dataclass
class ReservationSubBlock_Resource_HealthInfo:
...
@dataclasses.dataclass
class ReservationSubBlock_Resource_PhysicalTopology:
...
@dataclasses.dataclass
class ReservationSubBlock_Resource_ReservationSubBlockMaintenance_UpcomingGroupMaintenance:
...
@dataclasses.dataclass
class ReservationSubBlock_Resource_ReservationSubBlockMaintenance:
...
@dataclasses.dataclass
class ReservationSubBlock_Resource:
...
@dataclasses.dataclass
class ReservationSubBlockConfig:
...
@dataclasses.dataclass
class ReservationSubBlockAttrs:
    parent_name: Any = None
    project: Any = None
    reservation_sub_block: Any = None
...
ReservationSubBlock = ubx.DataSourceBinding(
    wire_type="google_compute_reservation_sub_block",
    fields={
