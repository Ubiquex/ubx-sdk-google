...
class AlphaInterconnectRemoteLocation_AttachmentConfigurationConstraints_BgpPeerAsnRanges:
    max: Any = None
    min: Any = None

@dataclasses.dataclass
class AlphaInterconnectRemoteLocation_AttachmentConfigurationConstraints:
...
@dataclasses.dataclass
class AlphaInterconnectRemoteLocation_Constraints:
...
@dataclasses.dataclass
class AlphaInterconnectRemoteLocation_PermittedConnections:
    interconnect_location: Any = None

@dataclasses.dataclass
class AlphaInterconnectRemoteLocationConfig:
    interconnect_remote_location: Any = None
    project: Any = None

@dataclasses.dataclass
class AlphaInterconnectRemoteLocationAttrs:
...
AlphaInterconnectRemoteLocation = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_interconnect_remote_location",
    fields={
