...
class AlphaRegion_Deprecated_StateOverride:
...
@dataclasses.dataclass
class AlphaRegion_QuotaStatusWarning_Data:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class AlphaRegion_QuotaStatusWarning:
...
@dataclasses.dataclass
class AlphaRegionConfig:
    project: Any = None
    region: Any = None

@dataclasses.dataclass
class AlphaRegionAttrs:
...
AlphaRegion = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_region",
    fields={
