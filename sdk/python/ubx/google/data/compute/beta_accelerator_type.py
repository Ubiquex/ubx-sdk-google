...
class BetaAcceleratorType_Deprecated_StateOverride:
...
@dataclasses.dataclass
class BetaAcceleratorType_Deprecated:
...
@dataclasses.dataclass
class BetaAcceleratorTypeConfig:
    accelerator_type: Any = None
    project: Any = None
    zone: Any = None

@dataclasses.dataclass
class BetaAcceleratorTypeAttrs:
    accelerator_type: Any = None
...
BetaAcceleratorType = ubx.DataSourceBinding(
    wire_type="google_compute_beta_accelerator_type",
    fields={
