...
class BetaReservationBlock_Resource_HealthInfo:
...
@dataclasses.dataclass
class BetaReservationBlock_Resource_PhysicalTopology_Instances_PhysicalHostTopology:
    host: Any = None
    sub_block: Any = None

@dataclasses.dataclass
class BetaReservationBlock_Resource_PhysicalTopology_Instances:
    instance_id: Any = None
    physical_host_topology: Any = None
    project_id: Any = None

@dataclasses.dataclass
class BetaReservationBlock_Resource_PhysicalTopology:
...
@dataclasses.dataclass
class BetaReservationBlock_Resource_ReservationMaintenance_UpcomingGroupMaintenance:
...
@dataclasses.dataclass
class BetaReservationBlock_Resource_ReservationMaintenance:
...
@dataclasses.dataclass
class BetaReservationBlock_Resource:
...
@dataclasses.dataclass
class BetaReservationBlockConfig:
    project: Any = None
...
@dataclasses.dataclass
class BetaReservationBlockAttrs:
    project: Any = None
    reservation: Any = None
    reservation_block: Any = None
...
BetaReservationBlock = ubx.DataSourceBinding(
    wire_type="google_compute_beta_reservation_block",
    fields={
