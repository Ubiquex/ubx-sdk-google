...
class BetaReliabilityRisk_Details_GlobalDnsInsight:
...
@dataclasses.dataclass
class BetaReliabilityRisk_Details:
...
@dataclasses.dataclass
class BetaReliabilityRisk_Recommendation:
...
@dataclasses.dataclass
class BetaReliabilityRiskConfig:
    project: Any = None
    reliability_risk: Any = None

@dataclasses.dataclass
class BetaReliabilityRiskAttrs:
...
BetaReliabilityRisk = ubx.DataSourceBinding(
    wire_type="google_compute_beta_reliability_risk",
    fields={
