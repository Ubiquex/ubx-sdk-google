...
class BetaLicenseCode_LicenseAlias:
    description: Any = None
    self_link: Any = None

@dataclasses.dataclass
class BetaLicenseCode_MinimumRetention:
...
@dataclasses.dataclass
class BetaLicenseCodeConfig:
    license_code: Any = None
    project: Any = None

@dataclasses.dataclass
class BetaLicenseCodeAttrs:
...
BetaLicenseCode = ubx.DataSourceBinding(
    wire_type="google_compute_beta_license_code",
    fields={
