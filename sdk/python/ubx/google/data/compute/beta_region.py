...
class BetaRegion_Deprecated_StateOverride:
...
@dataclasses.dataclass
class BetaRegion_QuotaStatusWarning_Data:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class BetaRegion_QuotaStatusWarning:
...
@dataclasses.dataclass
class BetaRegionConfig:
    project: Any = None
    region: Any = None

@dataclasses.dataclass
class BetaRegionAttrs:
...
BetaRegion = ubx.DataSourceBinding(
    wire_type="google_compute_beta_region",
    fields={
