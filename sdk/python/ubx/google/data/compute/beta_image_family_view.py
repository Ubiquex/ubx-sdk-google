...
class BetaImageFamilyView_Image_Deprecated_StateOverride:
...
@dataclasses.dataclass
class BetaImageFamilyView_Image_Deprecated:
...
@dataclasses.dataclass
class BetaImageFamilyView_Image_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class BetaImageFamilyView_Image_ImageEncryptionKey:
...
@dataclasses.dataclass
class BetaImageFamilyView_Image_Params:
...
@dataclasses.dataclass
class BetaImageFamilyView_Image_RawDisk:
...
@dataclasses.dataclass
class BetaImageFamilyView_Image_ShieldedInstanceInitialState_Dbs:
    content: Any = None
    file_type: Any = None

@dataclasses.dataclass
class BetaImageFamilyView_Image_ShieldedInstanceInitialState:
    # The Key Database (db).
    dbs: Any = None
...
@dataclasses.dataclass
class BetaImageFamilyView_Image:
...
@dataclasses.dataclass
class BetaImageFamilyViewConfig:
    family: Any = None
    project: Any = None
    zone: Any = None

@dataclasses.dataclass
class BetaImageFamilyViewAttrs:
    family: Any = None
...
BetaImageFamilyView = ubx.DataSourceBinding(
    wire_type="google_compute_beta_image_family_view",
    fields={
