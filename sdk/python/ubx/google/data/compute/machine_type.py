...
class MachineType_Accelerators:
    guest_accelerator_count: Any = None
    guest_accelerator_type: Any = None

@dataclasses.dataclass
class MachineType_BundledLocalSsds:
...
MachineType = ubx.DataSourceBinding(
    wire_type="google_compute_machine_type",
    fields={
