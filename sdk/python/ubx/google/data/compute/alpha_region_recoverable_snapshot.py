...
class AlphaRegionRecoverableSnapshot_OriginalResource_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class AlphaRegionRecoverableSnapshot_OriginalResource_SnapshotEncryptionKey:
...
@dataclasses.dataclass
class AlphaRegionRecoverableSnapshot_OriginalResource:
...
@dataclasses.dataclass
class AlphaRegionRecoverableSnapshotConfig:
    project: Any = None
    recoverable_snapshot: Any = None
    region: Any = None

@dataclasses.dataclass
class AlphaRegionRecoverableSnapshotAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
AlphaRegionRecoverableSnapshot = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_region_recoverable_snapshot",
    fields={
