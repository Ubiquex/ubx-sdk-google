...
class AlphaImageView_Image_Deprecated_StateOverride:
...
@dataclasses.dataclass
class AlphaImageView_Image_Deprecated:
...
@dataclasses.dataclass
class AlphaImageView_Image_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class AlphaImageView_Image_ImageEncryptionKey:
...
@dataclasses.dataclass
class AlphaImageView_Image_Params:
...
@dataclasses.dataclass
class AlphaImageView_Image_RawDisk:
...
@dataclasses.dataclass
class AlphaImageView_Image_ShieldedInstanceInitialState_Dbs:
    content: Any = None
    file_type: Any = None

@dataclasses.dataclass
class AlphaImageView_Image_ShieldedInstanceInitialState:
    # The Key Database (db).
    dbs: Any = None
...
@dataclasses.dataclass
class AlphaImageViewConfig:
    project: Any = None
    region: Any = None
    resource_id: Any = None

@dataclasses.dataclass
class AlphaImageViewAttrs:
...
AlphaImageView = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_image_view",
    fields={
