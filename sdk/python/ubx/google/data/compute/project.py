...
class Project_CommonInstanceMetadata_Items:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class Project_CommonInstanceMetadata:
...
@dataclasses.dataclass
class Project_UsageExportLocation:
...
Project = ubx.DataSourceBinding(
    wire_type="google_compute_project",
    fields={
