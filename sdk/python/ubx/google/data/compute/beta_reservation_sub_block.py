...
class BetaReservationSubBlock_Resource_AcceleratorTopologiesInfo_AcceleratorTopologyInfos_InfoPerTopologyStates:
    count: Any = None
    state: Any = None

@dataclasses.dataclass
class BetaReservationSubBlock_Resource_AcceleratorTopologiesInfo_AcceleratorTopologyInfos:
    accelerator_topology: Any = None
    info_per_topology_states: Any = None

@dataclasses.dataclass
class BetaReservationSubBlock_Resource_AcceleratorTopologiesInfo:
    # Info for each accelerator topology.
    accelerator_topology_infos: Any = None

@dataclasses.dataclass
class BetaReservationSubBlock_Resource_HealthInfo:
...
@dataclasses.dataclass
class BetaReservationSubBlock_Resource_PhysicalTopology:
...
@dataclasses.dataclass
class BetaReservationSubBlock_Resource_ReservationSubBlockMaintenance_UpcomingGroupMaintenance:
...
@dataclasses.dataclass
class BetaReservationSubBlock_Resource_ReservationSubBlockMaintenance:
...
@dataclasses.dataclass
class BetaReservationSubBlock_Resource:
...
@dataclasses.dataclass
class BetaReservationSubBlockConfig:
...
@dataclasses.dataclass
class BetaReservationSubBlockAttrs:
    parent_name: Any = None
    project: Any = None
    reservation_sub_block: Any = None
...
BetaReservationSubBlock = ubx.DataSourceBinding(
    wire_type="google_compute_beta_reservation_sub_block",
    fields={
