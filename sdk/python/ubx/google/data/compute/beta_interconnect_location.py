...
class BetaInterconnectLocation_CrossSiteInterconnectInfos:
    city: Any = None

@dataclasses.dataclass
class BetaInterconnectLocation_RegionInfos:
...
@dataclasses.dataclass
class BetaInterconnectLocationConfig:
    interconnect_location: Any = None
    project: Any = None

@dataclasses.dataclass
class BetaInterconnectLocationAttrs:
...
BetaInterconnectLocation = ubx.DataSourceBinding(
    wire_type="google_compute_beta_interconnect_location",
    fields={
