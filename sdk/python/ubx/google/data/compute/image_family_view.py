...
class ImageFamilyView_Image_Deprecated:
...
@dataclasses.dataclass
class ImageFamilyView_Image_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class ImageFamilyView_Image_ImageEncryptionKey:
...
@dataclasses.dataclass
class ImageFamilyView_Image_Params:
...
@dataclasses.dataclass
class ImageFamilyView_Image_RawDisk:
...
@dataclasses.dataclass
class ImageFamilyView_Image_ShieldedInstanceInitialState_Dbs:
    content: Any = None
    file_type: Any = None

@dataclasses.dataclass
class ImageFamilyView_Image_ShieldedInstanceInitialState:
    # The Key Database (db).
    dbs: Any = None
...
@dataclasses.dataclass
class ImageFamilyViewConfig:
    family: Any = None
    project: Any = None
    zone: Any = None

@dataclasses.dataclass
class ImageFamilyViewAttrs:
    family: Any = None
...
ImageFamilyView = ubx.DataSourceBinding(
    wire_type="google_compute_image_family_view",
    fields={
