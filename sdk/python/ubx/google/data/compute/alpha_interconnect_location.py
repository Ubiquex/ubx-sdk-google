...
class AlphaInterconnectLocation_CrossSiteInterconnectInfos:
    city: Any = None
    max_dynamic_path_bandwidth_gbps: Any = None
    max_fixed_path_bandwidth_gbps: Any = None
    max_single_flow_gbps: Any = None

@dataclasses.dataclass
class AlphaInterconnectLocation_RegionInfos:
...
@dataclasses.dataclass
class AlphaInterconnectLocationConfig:
    interconnect_location: Any = None
    project: Any = None

@dataclasses.dataclass
class AlphaInterconnectLocationAttrs:
...
AlphaInterconnectLocation = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_interconnect_location",
    fields={
