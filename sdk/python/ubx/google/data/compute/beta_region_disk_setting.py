...
class BetaRegionDiskSetting_AccessLocation_Locations:
    region: Any = None

@dataclasses.dataclass
class BetaRegionDiskSetting_AccessLocation:
...
@dataclasses.dataclass
class BetaRegionDiskSettingConfig:
    project: Any = None
    region: Any = None

@dataclasses.dataclass
class BetaRegionDiskSettingAttrs:
...
BetaRegionDiskSetting = ubx.DataSourceBinding(
    wire_type="google_compute_beta_region_disk_setting",
    fields={
