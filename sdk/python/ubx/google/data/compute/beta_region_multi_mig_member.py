...
@dataclasses.dataclass
class BetaRegionMultiMigMemberAttrs:
...
BetaRegionMultiMigMember = ubx.DataSourceBinding(
    wire_type="google_compute_beta_region_multi_mig_member",
    fields={
