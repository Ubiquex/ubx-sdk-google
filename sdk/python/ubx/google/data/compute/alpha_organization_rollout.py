...
class AlphaOrganizationRollout_RolloutEntity_OrchestratedEntity:
...
@dataclasses.dataclass
class AlphaOrganizationRollout_RolloutEntity:
...
@dataclasses.dataclass
class AlphaOrganizationRollout_WaveDetails_OrchestratedWaveDetails_LocationStatus:
    state: Any = None

@dataclasses.dataclass
class AlphaOrganizationRollout_WaveDetails_OrchestratedWaveDetails:
...
@dataclasses.dataclass
class AlphaOrganizationRollout_WaveDetails:
    orchestrated_wave_details: Any = None
    wave_display_name: Any = None
    wave_number: Any = None

@dataclasses.dataclass
class AlphaOrganizationRolloutConfig:
    organization: Any = None
    rollout: Any = None

@dataclasses.dataclass
class AlphaOrganizationRolloutAttrs:
...
AlphaOrganizationRollout = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_organization_rollout",
    fields={
