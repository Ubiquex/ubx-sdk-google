...
class RegionDiskType_Deprecated:
...
@dataclasses.dataclass
class RegionDiskTypeConfig:
    disk_type: Any = None
    project: Any = None
    region: Any = None

@dataclasses.dataclass
class RegionDiskTypeAttrs:
...
RegionDiskType = ubx.DataSourceBinding(
    wire_type="google_compute_region_disk_type",
    fields={
