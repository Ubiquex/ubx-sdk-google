...
class ReliabilityRisk_Details_GlobalDnsInsight:
...
@dataclasses.dataclass
class ReliabilityRisk_Recommendation:
...
@dataclasses.dataclass
class ReliabilityRiskConfig:
    project: Any = None
    reliability_risk: Any = None

@dataclasses.dataclass
class ReliabilityRiskAttrs:
...
ReliabilityRisk = ubx.DataSourceBinding(
    wire_type="google_compute_reliability_risk",
    fields={
