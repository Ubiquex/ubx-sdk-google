...
class AlphaPreviewFeature_RolloutOperation_RolloutInput:
...
@dataclasses.dataclass
class AlphaPreviewFeature_RolloutOperation:
    # Represents the input for the rollout operation.
    rollout_input: Any = None

@dataclasses.dataclass
class AlphaPreviewFeature_Status_ReleaseStatus_UpdateDate:
...
@dataclasses.dataclass
class AlphaPreviewFeature_Status_ReleaseStatus:
...
@dataclasses.dataclass
class AlphaPreviewFeature_Status:
...
@dataclasses.dataclass
class AlphaPreviewFeatureConfig:
    preview_feature: Any = None
    project: Any = None

@dataclasses.dataclass
class AlphaPreviewFeatureAttrs:
...
AlphaPreviewFeature = ubx.DataSourceBinding(
    wire_type="google_compute_alpha_preview_feature",
    fields={
