...
class V1alphaDiscoveredService_ServiceProperties_ExtendedMetadata:
    metadata_struct: Any = None

@dataclasses.dataclass
class V1alphaDiscoveredService_ServiceProperties_FunctionalType:
    # Output only. The functional type of a service or workload.
    type: Any = None

@dataclasses.dataclass
class V1alphaDiscoveredService_ServiceProperties_Identity:
...
@dataclasses.dataclass
class V1alphaDiscoveredService_ServiceProperties:
...
@dataclasses.dataclass
class V1alphaDiscoveredService_ServiceReference:
...
@dataclasses.dataclass
class V1alphaDiscoveredServiceConfig:
    name: Any = None

@dataclasses.dataclass
class V1alphaDiscoveredServiceAttrs:
    name: Any = None
...
V1alphaDiscoveredService = ubx.DataSourceBinding(
    wire_type="google_apphub_v1alpha_discovered_service",
    fields={
