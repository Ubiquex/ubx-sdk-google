...
class Violation_ExceptionContexts:
    acknowledgement_time: Any = None
    comment: Any = None
    user_name: Any = None

@dataclasses.dataclass
class Violation_Remediation_Instructions_ConsoleInstructions:
...
@dataclasses.dataclass
class Violation_Remediation_Instructions_GcloudInstructions:
    # Additional urls for more information about steps
    additional_links: Any = None
