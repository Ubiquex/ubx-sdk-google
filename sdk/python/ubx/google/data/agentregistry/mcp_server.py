...
class McpServer_Interfaces:
    protocol_binding: Any = None
    url: Any = None

@dataclasses.dataclass
class McpServer_Tools_Annotations:
...
McpServer = ubx.DataSourceBinding(
    wire_type="google_agentregistry_mcp_server",
    fields={
