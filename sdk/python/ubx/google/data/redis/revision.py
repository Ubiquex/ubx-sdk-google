...
class Revision_Snapshot_ClusterAclPolicyAttachments_AclPolicyRevisionStatuses:
...
@dataclasses.dataclass
class Revision_Snapshot_ClusterAclPolicyAttachments:
    acl_policy_revision_statuses: Any = None
    cluster: Any = None

@dataclasses.dataclass
class Revision_Snapshot_Rules:
    rule: Any = None
    username: Any = None
...
Revision = ubx.DataSourceBinding(
    wire_type="google_redis_revision",
    fields={
