...
class V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary_CatalogSummaries_DatabaseSummaries_TableSummary:
...
@dataclasses.dataclass
class V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary_CatalogSummaries_DatabaseSummaries:
    database: Any = None
...
@dataclasses.dataclass
class V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary_CatalogSummaries:
    catalog: Any = None
    catalog_type: Any = None
    database_summaries: Any = None

@dataclasses.dataclass
class V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus_MigrationSummary:
...
@dataclasses.dataclass
class V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_BackfillStatus:
...
@dataclasses.dataclass
class V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_HiveConfig:
...
@dataclasses.dataclass
class V1betaMigrationExecution_BiglakeMetastoreMigrationConfig_IcebergConfig:
...
@dataclasses.dataclass
class V1betaMigrationExecution_BiglakeMetastoreMigrationConfig:
...
@dataclasses.dataclass
class V1betaMigrationExecution_CloudSqlMigrationConfig_CdcConfig:
...
@dataclasses.dataclass
class V1betaMigrationExecution_CloudSqlMigrationConfig_CloudSqlConnectionConfig:
...
@dataclasses.dataclass
class V1betaMigrationExecution_CloudSqlMigrationConfig:
...
@dataclasses.dataclass
class V1betaMigrationExecutionConfig:
    name: Any = None

@dataclasses.dataclass
class V1betaMigrationExecutionAttrs:
...
V1betaMigrationExecution = ubx.DataSourceBinding(
    wire_type="google_metastore_v1beta_migration_execution",
    fields={
