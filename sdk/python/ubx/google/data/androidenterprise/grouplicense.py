...
class GrouplicenseConfig:
    enterprise_id: Any = None
    group_license_id: Any = None

@dataclasses.dataclass
class GrouplicenseAttrs:
...
Grouplicense = ubx.DataSourceBinding(
    wire_type="google_androidenterprise_grouplicense",
    fields={
        "enterprise_id": ubx.FieldSpec(wire_name="enterprise_id"),
        "group_license_id": ubx.FieldSpec(wire_name="group_license_id"),
    },
)
