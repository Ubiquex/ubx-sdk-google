...
class ManagedkafkaVersion_References:
    name: Any = None
    subject: Any = None
    version: Any = None

_ManagedkafkaVersion_ReferencesFields = {
...
@dataclasses.dataclass
class ManagedkafkaVersionConfig:
...
@dataclasses.dataclass
class ManagedkafkaVersionAttrs:
    # Optional. The schema ID of the schema. If not specified, the schema ID will be generated by the server. If the schema ID is specified, it must not be used by an existing schema that is different from the schema to be created.
    id: Any = None
    # Optional. If true, the schema will be normalized before being stored. The default is false.
    normalize: Any = None
...
ManagedkafkaVersion = ubx.ResourceBinding(
    wire_type="google_managedkafka_managedkafka_version",
    fields={
        ...
        "references": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ManagedkafkaVersion_ReferencesFields,
        ),
