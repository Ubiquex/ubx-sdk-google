...
class ManagedkafkaAcl_AclEntries:
    host: Any = None
    operation: Any = None
    permission_type: Any = None
    principal: Any = None

_ManagedkafkaAcl_AclEntriesFields = {
...
ManagedkafkaAcl = ubx.ResourceBinding(
    wire_type="google_managedkafka_managedkafka_acl",
    fields={
        "acl_entries": ubx.FieldSpec(
            wire_name="acl_entries",
            kind="list",
            fields=_ManagedkafkaAcl_AclEntriesFields,
        ),
