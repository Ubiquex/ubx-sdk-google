...
class ManagedkafkaConnector_TaskRestartPolicy:
...
_ManagedkafkaConnector_TaskRestartPolicyFields = {
...
@dataclasses.dataclass
class ManagedkafkaConnectorConfig:
...
@dataclasses.dataclass
class ManagedkafkaConnectorAttrs:
    # Optional. Connector config as keys/values. The keys of the map are connector property names, for example: `connector.class`, `tasks.max`, `key.converter`.
    configs: Any = None
    # Identifier. The name of the connector. Structured like: projects/{project}/locations/{location}/connectClusters/{connect_cluster}/connectors/{connector}
    name: Any = None
...
ManagedkafkaConnector = ubx.ResourceBinding(
    wire_type="google_managedkafka_managedkafka_connector",
    fields={
        ...
        "task_restart_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ManagedkafkaConnector_TaskRestartPolicyFields,
        ),
    },
)
