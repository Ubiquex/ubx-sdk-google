...
class ManagedkafkaConnectCluster_CapacityConfig:
...
@dataclasses.dataclass
class ManagedkafkaConnectCluster_GcpConfig_AccessConfig_NetworkConfigs:
    additional_subnets: Any = None
    dns_domain_names: Any = None
    primary_subnet: Any = None

@dataclasses.dataclass
class ManagedkafkaConnectCluster_GcpConfig_AccessConfig:
...
@dataclasses.dataclass
class ManagedkafkaConnectCluster_GcpConfig:
...
_ManagedkafkaConnectCluster_CapacityConfigFields = {
    "memory_bytes": ubx.FieldSpec(wire_name="memory_bytes"),
    "vcpu_count": ubx.FieldSpec(wire_name="vcpu_count"),
}

_ManagedkafkaConnectCluster_GcpConfig_AccessConfig_NetworkConfigsFields = {
...
_ManagedkafkaConnectCluster_GcpConfig_AccessConfigFields = {
    "network_configs": ubx.FieldSpec(
        wire_name="network_configs",
        kind="list",
        fields=_ManagedkafkaConnectCluster_GcpConfig_AccessConfig_NetworkConfigsFields,
    ),
}

_ManagedkafkaConnectCluster_GcpConfigFields = {
    "access_config": ubx.FieldSpec(
        wire_name="access_config",
        kind="object",
        fields=_ManagedkafkaConnectCluster_GcpConfig_AccessConfigFields,
    ),
    "secret_paths": ubx.FieldSpec(wire_name="secret_paths"),
}

@dataclasses.dataclass
class ManagedkafkaConnectClusterConfig:
...
@dataclasses.dataclass
class ManagedkafkaConnectClusterAttrs:
    # A capacity configuration of a Kafka cluster.
    capacity_config: Any = None
    # Optional. Reserved for future use. This field is meant for worker config overrides, but is unsupported for now.
    config: Any = None
...
ManagedkafkaConnectCluster = ubx.ResourceBinding(
    wire_type="google_managedkafka_managedkafka_connect_cluster",
    fields={
        "capacity_config": ubx.FieldSpec(
            wire_name="capacity_config",
            kind="object",
            fields=_ManagedkafkaConnectCluster_CapacityConfigFields,
        ),
        ...
        "gcp_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ManagedkafkaConnectCluster_GcpConfigFields,
        ),
