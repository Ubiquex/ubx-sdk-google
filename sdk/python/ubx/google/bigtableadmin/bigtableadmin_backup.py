...
class BigtableadminBackup_EncryptionInfo_EncryptionStatus:
...
@dataclasses.dataclass
class BigtableadminBackup_EncryptionInfo:
...
@dataclasses.dataclass
class BigtableadminBackupConfig:
...
@dataclasses.dataclass
class BigtableadminBackupAttrs:
    # Indicates the backup type of the backup.
    backup_type: Any = None
    # Encryption information for a given resource. If this resource is protected with customer managed encryption, the in-use Cloud Key Management Service (Cloud KMS) key version is specified along with its status.
    encryption_info: Any = None
...
BigtableadminBackup = ubx.ResourceBinding(
    wire_type="google_bigtableadmin_bigtableadmin_backup",
    fields={
        "backup_type": ubx.FieldSpec(wire_name="backup_type"),
        "encryption_info": ubx.FieldSpec(
            wire_name="encryption_info",
            kind="object",
            fields=_BigtableadminBackup_EncryptionInfoFields,
        ),
