...
class TranslateGlossary_InputConfig_GcsSource:
    # Required. Source data URI. For example, `gs://my_bucket/my_object`.
    input_uri: Any = None

@dataclasses.dataclass
class TranslateGlossary_InputConfig:
    # The Google Cloud Storage location for the input content.
    gcs_source: Any = None

@dataclasses.dataclass
class TranslateGlossary_LanguageCodesSet:
...
@dataclasses.dataclass
class TranslateGlossary_LanguagePair:
...
_TranslateGlossary_InputConfig_GcsSourceFields = {
    "input_uri": ubx.FieldSpec(wire_name="input_uri"),
}

_TranslateGlossary_InputConfigFields = {
    "gcs_source": ubx.FieldSpec(
        wire_name="gcs_source",
        kind="object",
        fields=_TranslateGlossary_InputConfig_GcsSourceFields,
    ),
}

_TranslateGlossary_LanguageCodesSetFields = {
    "language_codes": ubx.FieldSpec(wire_name="language_codes"),
}

_TranslateGlossary_LanguagePairFields = {
...
TranslateGlossary = ubx.ResourceBinding(
    wire_type="google_translate_translate_glossary",
    fields={
        ...
        "input_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_TranslateGlossary_InputConfigFields,
        ),
        "language_codes_set": ubx.FieldSpec(
            wire_name="language_codes_set",
            kind="object",
            fields=_TranslateGlossary_LanguageCodesSetFields,
        ),
        "language_pair": ubx.FieldSpec(
            wire_name="language_pair",
            kind="object",
            fields=_TranslateGlossary_LanguagePairFields,
        ),
