...
PullRequest = ubx.ResourceBinding(
    wire_type="google_securesourcemanager_pull_request",
    fields={
        "base": ubx.FieldSpec(
            wire_name="base",
            kind="object",
            fields=_PullRequest_BaseFields,
        ),
