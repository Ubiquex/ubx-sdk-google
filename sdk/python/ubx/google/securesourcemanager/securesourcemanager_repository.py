...
class SecuresourcemanagerRepository_InitialConfig:
...
@dataclasses.dataclass
class SecuresourcemanagerRepository_ScanConfig_SecretScanConfig:
...
@dataclasses.dataclass
class SecuresourcemanagerRepository_ScanConfig:
    # Configuration for secret scanning.
    secret_scan_config: Any = None

@dataclasses.dataclass
class SecuresourcemanagerRepository_Uris:
...
_SecuresourcemanagerRepository_InitialConfigFields = {
...
_SecuresourcemanagerRepository_ScanConfig_SecretScanConfigFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "inspect_template": ubx.FieldSpec(wire_name="inspect_template"),
}

_SecuresourcemanagerRepository_ScanConfigFields = {
    "secret_scan_config": ubx.FieldSpec(
        wire_name="secret_scan_config",
        kind="object",
        fields=_SecuresourcemanagerRepository_ScanConfig_SecretScanConfigFields,
    ),
}

_SecuresourcemanagerRepository_UrisFields = {
    "api": ubx.FieldSpec(wire_name="api"),
    "git_https": ubx.FieldSpec(wire_name="git_https"),
    "html": ubx.FieldSpec(wire_name="html"),
}

@dataclasses.dataclass
class SecuresourcemanagerRepositoryConfig:
...
@dataclasses.dataclass
class SecuresourcemanagerRepositoryAttrs:
    # Output only. Create timestamp.
    create_time: Any = None
    # Optional. Description of the repository, which cannot exceed 500 characters.
    description: Any = None
...
SecuresourcemanagerRepository = ubx.ResourceBinding(
    wire_type="google_securesourcemanager_securesourcemanager_repository",
    fields={
        ...
        "initial_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_SecuresourcemanagerRepository_InitialConfigFields,
        ),
        "instance": ubx.FieldSpec(wire_name="instance"),
        "name": ubx.FieldSpec(wire_name="name"),
        "scan_config": ubx.FieldSpec(
            wire_name="scan_config",
            kind="object",
            fields=_SecuresourcemanagerRepository_ScanConfigFields,
        ),
        ...
        "uris": ubx.FieldSpec(
            wire_name="uris",
            kind="object",
            fields=_SecuresourcemanagerRepository_UrisFields,
        ),
    },
)
