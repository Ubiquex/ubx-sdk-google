# Code generated by `ubx sdk gen` from google_securesourcemanager_repository. DO NOT EDIT.
...
class Repository_InitialConfig:
...
@dataclasses.dataclass
class Repository_ScanConfig_SecretScanConfig:
...
_Repository_InitialConfigFields = {
...
_Repository_ScanConfig_SecretScanConfigFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "inspect_template": ubx.FieldSpec(wire_name="inspect_template"),
}

_Repository_ScanConfigFields = {
    "secret_scan_config": ubx.FieldSpec(
        wire_name="secret_scan_config",
        kind="object",
        fields=_Repository_ScanConfig_SecretScanConfigFields,
    ),
}

_Repository_UrisFields = {
...
Repository = ubx.ResourceBinding(
    ...
    fields={
        ...
        "initial_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Repository_InitialConfigFields,
        ),
