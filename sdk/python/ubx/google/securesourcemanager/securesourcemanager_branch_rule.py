# Code generated by `ubx sdk gen` from google_securesourcemanager_securesourcemanager_branch_rule. DO NOT EDIT.
...
class SecuresourcemanagerBranchRule_RequiredStatusChecks:
    context: Any = None

_SecuresourcemanagerBranchRule_RequiredStatusChecksFields = {
    "context": ubx.FieldSpec(wire_name="context"),
}

@dataclasses.dataclass
class SecuresourcemanagerBranchRuleConfig:
...
@dataclasses.dataclass
class SecuresourcemanagerBranchRuleAttrs:
    # Optional. Determines if allow stale reviews or approvals before merging to the branch.
    allow_stale_reviews: Any = None
    # Optional. User annotations. These attributes can only be set and used by the user. See https://google.aip.dev/128#annotations for more details such as format and size limitations.
    annotations: Any = None
...
SecuresourcemanagerBranchRule = ubx.ResourceBinding(
    wire_type="google_securesourcemanager_securesourcemanager_branch_rule",
    fields={
        ...
        "required_status_checks": ubx.FieldSpec(
            ...
            kind="list",
            fields=_SecuresourcemanagerBranchRule_RequiredStatusChecksFields,
        ),
