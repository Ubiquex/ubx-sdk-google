...
class WorkloadmanagerActuation_ActuationOutput:
...
@dataclasses.dataclass
class WorkloadmanagerActuation_DeploymentOutput:
    name: Any = None
    type: Any = None

_WorkloadmanagerActuation_ActuationOutputFields = {
...
_WorkloadmanagerActuation_DeploymentOutputFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "type": ubx.FieldSpec(wire_name="type"),
}

@dataclasses.dataclass
class WorkloadmanagerActuationConfig:
...
@dataclasses.dataclass
class WorkloadmanagerActuationAttrs:
    # Message for output of actuation.
    actuation_output: Any = None
    # Output only. Deployment output.
    deployment_output: Any = None
...
WorkloadmanagerActuation = ubx.ResourceBinding(
    wire_type="google_workloadmanager_workloadmanager_actuation",
    fields={
        "actuation_output": ubx.FieldSpec(
            wire_name="actuation_output",
            kind="object",
            fields=_WorkloadmanagerActuation_ActuationOutputFields,
        ),
        "deployment_output": ubx.FieldSpec(
            wire_name="deployment_output",
            kind="list",
            fields=_WorkloadmanagerActuation_DeploymentOutputFields,
        ),
