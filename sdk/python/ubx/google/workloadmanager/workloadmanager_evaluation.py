...
class WorkloadmanagerEvaluation_BigQueryDestination:
...
@dataclasses.dataclass
class WorkloadmanagerEvaluation_ResourceFilter_GceInstanceFilter:
...
@dataclasses.dataclass
class WorkloadmanagerEvaluation_ResourceFilter:
...
@dataclasses.dataclass
class WorkloadmanagerEvaluation_ResourceStatus:
    # State of the Evaluation resource.
    state: Any = None

_WorkloadmanagerEvaluation_BigQueryDestinationFields = {
...
_WorkloadmanagerEvaluation_ResourceFilter_GceInstanceFilterFields = {
    "service_accounts": ubx.FieldSpec(wire_name="service_accounts"),
}

_WorkloadmanagerEvaluation_ResourceFilterFields = {
    "gce_instance_filter": ubx.FieldSpec(
        wire_name="gce_instance_filter",
        kind="object",
        fields=_WorkloadmanagerEvaluation_ResourceFilter_GceInstanceFilterFields,
    ),
...
_WorkloadmanagerEvaluation_ResourceStatusFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

@dataclasses.dataclass
class WorkloadmanagerEvaluationConfig:
...
@dataclasses.dataclass
class WorkloadmanagerEvaluationAttrs:
    # BigQuery destination for evaluation results.
    big_query_destination: Any = None
    # Output only. [Output only] Create time stamp.
    create_time: Any = None
...
WorkloadmanagerEvaluation = ubx.ResourceBinding(
    wire_type="google_workloadmanager_workloadmanager_evaluation",
    fields={
        "big_query_destination": ubx.FieldSpec(
            wire_name="big_query_destination",
            kind="object",
            fields=_WorkloadmanagerEvaluation_BigQueryDestinationFields,
        ),
        ...
        "resource_filter": ubx.FieldSpec(
            ...
            kind="object",
            fields=_WorkloadmanagerEvaluation_ResourceFilterFields,
        ),
        "resource_status": ubx.FieldSpec(
            wire_name="resource_status",
            kind="object",
            fields=_WorkloadmanagerEvaluation_ResourceStatusFields,
        ),
