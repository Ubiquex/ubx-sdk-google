...
class V1beta1DatamigrationV1beta1MigrationJob_DestinationDatabase:
    # The database engine.
    engine: Any = None
...
@dataclasses.dataclass
class V1beta1DatamigrationV1beta1MigrationJob_Error:
...
@dataclasses.dataclass
class V1beta1DatamigrationV1beta1MigrationJob_ReverseSshConnectivity:
...
@dataclasses.dataclass
class V1beta1DatamigrationV1beta1MigrationJob_VpcPeeringConnectivity:
    # The name of the VPC network to peer with the Cloud SQL private network.
    vpc: Any = None

_V1beta1DatamigrationV1beta1MigrationJob_DestinationDatabaseFields = {
    "engine": ubx.FieldSpec(wire_name="engine"),
    "provider": ubx.FieldSpec(wire_name="provider"),
}

_V1beta1DatamigrationV1beta1MigrationJob_ErrorFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V1beta1DatamigrationV1beta1MigrationJob_ReverseSshConnectivityFields = {
...
_V1beta1DatamigrationV1beta1MigrationJob_VpcPeeringConnectivityFields = {
    "vpc": ubx.FieldSpec(wire_name="vpc"),
}

@dataclasses.dataclass
class V1beta1DatamigrationV1beta1MigrationJobConfig:
...
@dataclasses.dataclass
class V1beta1DatamigrationV1beta1MigrationJobAttrs:
    # Output only. The timestamp when the migration job resource was created. A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".
    create_time: Any = None
    # Required. The resource name (URI) of the destination connection profile.
    destination: Any = None
...
V1beta1DatamigrationV1beta1MigrationJob = ubx.ResourceBinding(
    wire_type="google_datamigration_v1beta1_datamigration_v1beta1_migration_job",
    fields={
        ...
        "destination_database": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1DatamigrationV1beta1MigrationJob_DestinationDatabaseFields,
        ),
        ...
        "error": ubx.FieldSpec(
            wire_name="error",
            kind="object",
            fields=_V1beta1DatamigrationV1beta1MigrationJob_ErrorFields,
        ),
        ...
        "reverse_ssh_connectivity": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1DatamigrationV1beta1MigrationJob_ReverseSshConnectivityFields,
        ),
        ...
        "vpc_peering_connectivity": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1DatamigrationV1beta1MigrationJob_VpcPeeringConnectivityFields,
        ),
    },
)
