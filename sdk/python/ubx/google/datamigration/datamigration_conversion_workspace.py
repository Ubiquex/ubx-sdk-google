...
class DatamigrationConversionWorkspace_Destination:
    # Required. Engine type.
    engine: Any = None
    # Required. Engine version, for example "12.c.1".
    version: Any = None

_DatamigrationConversionWorkspace_DestinationFields = {
    "engine": ubx.FieldSpec(wire_name="engine"),
    "version": ubx.FieldSpec(wire_name="version"),
}

@dataclasses.dataclass
class DatamigrationConversionWorkspaceConfig:
...
@dataclasses.dataclass
class DatamigrationConversionWorkspaceAttrs:
    # Output only. The timestamp when the workspace resource was created.
    create_time: Any = None
    # The type and version of a source or destination database.
    destination: Any = None
...
DatamigrationConversionWorkspace = ubx.ResourceBinding(
    wire_type="google_datamigration_datamigration_conversion_workspace",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "destination": ubx.FieldSpec(
            wire_name="destination",
            kind="object",
            fields=_DatamigrationConversionWorkspace_DestinationFields,
        ),
