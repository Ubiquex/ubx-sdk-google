...
class NotebooksInstance_GceSetup_AcceleratorConfigs:
    core_count: Any = None
    type: Any = None

@dataclasses.dataclass
class NotebooksInstance_GceSetup_BootDisk:
...
@dataclasses.dataclass
class NotebooksInstance_GceSetup_DataDisks:
    disk_encryption: Any = None
    disk_size_gb: Any = None
    disk_type: Any = None
    kms_key: Any = None
...
@dataclasses.dataclass
class NotebooksInstance_GceSetup_GpuDriverConfig:
...
@dataclasses.dataclass
class NotebooksInstance_GceSetup_NetworkInterfaces_AccessConfigs:
    external_ip: Any = None

@dataclasses.dataclass
class NotebooksInstance_GceSetup_NetworkInterfaces:
...
@dataclasses.dataclass
class NotebooksInstance_GceSetup_ReservationAffinity:
...
@dataclasses.dataclass
class NotebooksInstance_GceSetup_ServiceAccounts:
    email: Any = None
    scopes: Any = None

@dataclasses.dataclass
class NotebooksInstance_GceSetup_ShieldedInstanceConfig:
...
@dataclasses.dataclass
class NotebooksInstance_GceSetup_VmImage:
...
@dataclasses.dataclass
class NotebooksInstance_GceSetup:
...
@dataclasses.dataclass
class NotebooksInstance_UpgradeHistory:
    action: Any = None
    container_image: Any = None
...
_NotebooksInstance_GceSetup_AcceleratorConfigsFields = {
    "core_count": ubx.FieldSpec(wire_name="core_count"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_NotebooksInstance_GceSetup_BootDiskFields = {
...
_NotebooksInstance_GceSetup_GpuDriverConfigFields = {
...
_NotebooksInstance_GceSetup_NetworkInterfaces_AccessConfigsFields = {
    "external_ip": ubx.FieldSpec(wire_name="external_ip"),
}

_NotebooksInstance_GceSetup_NetworkInterfacesFields = {
    "access_configs": ubx.FieldSpec(
        wire_name="access_configs",
        kind="list",
        fields=_NotebooksInstance_GceSetup_NetworkInterfaces_AccessConfigsFields,
    ),
...
_NotebooksInstance_GceSetup_VmImageFields = {
...
_NotebooksInstance_GceSetupFields = {
    "accelerator_configs": ubx.FieldSpec(
        wire_name="accelerator_configs",
        kind="list",
        fields=_NotebooksInstance_GceSetup_AcceleratorConfigsFields,
    ),
    "boot_disk": ubx.FieldSpec(
        wire_name="boot_disk",
        kind="object",
        fields=_NotebooksInstance_GceSetup_BootDiskFields,
    ),
    "confidential_instance_config": ubx.FieldSpec(
        wire_name="confidential_instance_config",
        kind="object",
        fields=_NotebooksInstance_GceSetup_ConfidentialInstanceConfigFields,
    ),
    "container_image": ubx.FieldSpec(
        wire_name="container_image",
        kind="object",
        fields=_NotebooksInstance_GceSetup_ContainerImageFields,
    ),
    "data_disks": ubx.FieldSpec(
        wire_name="data_disks",
        kind="list",
        fields=_NotebooksInstance_GceSetup_DataDisksFields,
    ),
    ...
    "gpu_driver_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_NotebooksInstance_GceSetup_GpuDriverConfigFields,
    ),
    ...
    "network_interfaces": ubx.FieldSpec(
        ...
        kind="list",
        fields=_NotebooksInstance_GceSetup_NetworkInterfacesFields,
    ),
    "reservation_affinity": ubx.FieldSpec(
        wire_name="reservation_affinity",
        kind="object",
        fields=_NotebooksInstance_GceSetup_ReservationAffinityFields,
    ),
    "service_accounts": ubx.FieldSpec(
        wire_name="service_accounts",
        kind="list",
        fields=_NotebooksInstance_GceSetup_ServiceAccountsFields,
    ),
    "shielded_instance_config": ubx.FieldSpec(
        wire_name="shielded_instance_config",
        kind="object",
        fields=_NotebooksInstance_GceSetup_ShieldedInstanceConfigFields,
    ),
    "tags": ubx.FieldSpec(wire_name="tags"),
    "vm_image": ubx.FieldSpec(
        wire_name="vm_image",
        kind="object",
        fields=_NotebooksInstance_GceSetup_VmImageFields,
    ),
}

_NotebooksInstance_UpgradeHistoryFields = {
...
NotebooksInstance = ubx.ResourceBinding(
    wire_type="google_notebooks_notebooks_instance",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        ...
        "gce_setup": ubx.FieldSpec(
            wire_name="gce_setup",
            kind="object",
            fields=_NotebooksInstance_GceSetupFields,
        ),
        ...
        "upgrade_history": ubx.FieldSpec(
            ...
            kind="list",
            fields=_NotebooksInstance_UpgradeHistoryFields,
        ),
    },
)
