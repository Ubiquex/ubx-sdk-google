...
class V1alphaServer_ExternalConfig:
...
@dataclasses.dataclass
class V1alphaServer_GoogleManagedServerCredential:
...
@dataclasses.dataclass
class V1alphaServer_InternalConfig_ConsumerAcceptList:
    connection_limit: Any = None
    project: Any = None

@dataclasses.dataclass
class V1alphaServer_InternalConfig_ConsumerRejectList:
    project: Any = None

@dataclasses.dataclass
class V1alphaServer_InternalConfig_PscEndpoints:
    endpoint: Any = None
    network: Any = None
    status: Any = None

@dataclasses.dataclass
class V1alphaServer_InternalConfig:
...
V1alphaServer = ubx.ResourceBinding(
    wire_type="google_ftp_v1alpha_server",
    fields={
