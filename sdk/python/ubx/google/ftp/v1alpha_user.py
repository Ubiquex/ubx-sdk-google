...
class V1alphaUser_StorageDirectoryMappings:
    bucket: Any = None
...
@dataclasses.dataclass
class V1alphaUser_UserCredentials:
    credential_name: Any = None
    credential_type: Any = None
    ssh_public_key_body: Any = None

_V1alphaUser_StorageDirectoryMappingsFields = {
...
_V1alphaUser_UserCredentialsFields = {
