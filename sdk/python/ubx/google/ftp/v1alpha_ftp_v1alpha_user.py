...
class V1alphaFtpV1alphaUser_StorageDirectoryMappings:
    bucket: Any = None
...
@dataclasses.dataclass
class V1alphaFtpV1alphaUser_UserCredentials:
    credential_name: Any = None
    credential_type: Any = None
    ssh_public_key_body: Any = None

_V1alphaFtpV1alphaUser_StorageDirectoryMappingsFields = {
...
_V1alphaFtpV1alphaUser_UserCredentialsFields = {
...
@dataclasses.dataclass
class V1alphaFtpV1alphaUserConfig:
...
@dataclasses.dataclass
class V1alphaFtpV1alphaUserAttrs:
    # Output only. [Output only] Create time stamp
    create_time: Any = None
    # Required. Service account in customer project attached to this SFTP User.
    customer_service_account: Any = None
...
V1alphaFtpV1alphaUser = ubx.ResourceBinding(
    wire_type="google_ftp_v1alpha_ftp_v1alpha_user",
    fields={
        ...
        "storage_directory_mappings": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1alphaFtpV1alphaUser_StorageDirectoryMappingsFields,
        ),
        "update_time": ubx.FieldSpec(wire_name="update_time"),
        "user_credentials": ubx.FieldSpec(
            wire_name="user_credentials",
            kind="list",
            fields=_V1alphaFtpV1alphaUser_UserCredentialsFields,
        ),
