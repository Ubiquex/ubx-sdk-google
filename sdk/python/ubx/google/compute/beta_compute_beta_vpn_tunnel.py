# Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_vpn_tunnel. DO NOT EDIT.
...
class BetaComputeBetaVpnTunnel_CipherSuite_Phase1:
    dh: Any = None
    encryption: Any = None
    integrity: Any = None
    prf: Any = None
...
@dataclasses.dataclass
class BetaComputeBetaVpnTunnel_CipherSuite_Phase2:
    encryption: Any = None
    integrity: Any = None
    pfs: Any = None

@dataclasses.dataclass
class BetaComputeBetaVpnTunnel_CipherSuite:
    phase1: Any = None
    phase2: Any = None

@dataclasses.dataclass
class BetaComputeBetaVpnTunnel_Params:
...
_BetaComputeBetaVpnTunnel_CipherSuite_Phase1Fields = {
...
_BetaComputeBetaVpnTunnel_CipherSuite_Phase2Fields = {
    "encryption": ubx.FieldSpec(wire_name="encryption"),
    "integrity": ubx.FieldSpec(wire_name="integrity"),
    "pfs": ubx.FieldSpec(wire_name="pfs"),
}

_BetaComputeBetaVpnTunnel_CipherSuiteFields = {
    "phase1": ubx.FieldSpec(
        wire_name="phase1",
        kind="object",
        fields=_BetaComputeBetaVpnTunnel_CipherSuite_Phase1Fields,
    ),
    "phase2": ubx.FieldSpec(
        wire_name="phase2",
        kind="object",
        fields=_BetaComputeBetaVpnTunnel_CipherSuite_Phase2Fields,
    ),
}

_BetaComputeBetaVpnTunnel_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

@dataclasses.dataclass
class BetaComputeBetaVpnTunnelConfig:
...
@dataclasses.dataclass
class BetaComputeBetaVpnTunnelAttrs:
    # Capacity tier of the VPN tunnel. This is used for IPsec over Interconnect tunnels to indicate different bandwidth limits.
    capacity_tier: Any = None
    cipher_suite: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
...
BetaComputeBetaVpnTunnel = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_vpn_tunnel",
    fields={
        "capacity_tier": ubx.FieldSpec(wire_name="capacity_tier"),
        "cipher_suite": ubx.FieldSpec(
            wire_name="cipher_suite",
            kind="object",
            fields=_BetaComputeBetaVpnTunnel_CipherSuiteFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaVpnTunnel_ParamsFields,
        ),
