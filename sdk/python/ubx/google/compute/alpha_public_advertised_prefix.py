...
class AlphaPublicAdvertisedPrefix_PublicDelegatedPrefixs:
    ip_range: Any = None
    name: Any = None
    project: Any = None
    region: Any = None
...
_AlphaPublicAdvertisedPrefix_PublicDelegatedPrefixsFields = {
...
@dataclasses.dataclass
class AlphaPublicAdvertisedPrefixConfig:
...
@dataclasses.dataclass
class AlphaPublicAdvertisedPrefixAttrs:
    # Output only. [Output Only] The version of BYOIP API.
    byoip_api_version: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
AlphaPublicAdvertisedPrefix = ubx.ResourceBinding(
    wire_type="google_compute_alpha_public_advertised_prefix",
    fields={
        ...
        "public_delegated_prefixs": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaPublicAdvertisedPrefix_PublicDelegatedPrefixsFields,
        ),
