...
class AlphaComputeAlphaStoragePool_ExapoolProvisionedCapacityGb:
...
@dataclasses.dataclass
class AlphaComputeAlphaStoragePool_Params:
...
@dataclasses.dataclass
class AlphaComputeAlphaStoragePool_ResourceStatus:
    # DEPRECATED -- use "total_provisioned_disk_iops".
    aggregate_disk_provisioned_iops: Any = None
    # DEPRECATED -- use "total provisioned disk size gb".
    aggregate_disk_size_gb: Any = None
    ...
    max_aggregate_disk_size_gb: Any = None
    ...
    used_reduced_bytes: Any = None
    # DEPRECATED -- use "pool used throughput".
    used_throughput: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaStoragePool_ShareSettings_ProjectMap:
    project_id: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaStoragePool_ShareSettings:
    # A map of project id and project config.
    project_map: Any = None

_AlphaComputeAlphaStoragePool_ExapoolProvisionedCapacityGbFields = {
...
_AlphaComputeAlphaStoragePool_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaComputeAlphaStoragePool_ResourceStatusFields = {
    "aggregate_disk_provisioned_iops": ubx.FieldSpec(wire_name="aggregate_disk_provisioned_iops"),
    "aggregate_disk_size_gb": ubx.FieldSpec(wire_name="aggregate_disk_size_gb"),
    ...
    "max_aggregate_disk_size_gb": ubx.FieldSpec(wire_name="max_aggregate_disk_size_gb"),
    ...
    "used_reduced_bytes": ubx.FieldSpec(wire_name="used_reduced_bytes"),
    "used_throughput": ubx.FieldSpec(wire_name="used_throughput"),
}

_AlphaComputeAlphaStoragePool_ShareSettings_ProjectMapFields = {
    "project_id": ubx.FieldSpec(wire_name="project_id"),
}

_AlphaComputeAlphaStoragePool_ShareSettingsFields = {
    "project_map": ubx.FieldSpec(
        wire_name="project_map",
        kind="map",
        fields=_AlphaComputeAlphaStoragePool_ShareSettings_ProjectMapFields,
    ),
}

@dataclasses.dataclass
class AlphaComputeAlphaStoragePoolConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaStoragePoolAttrs:
    # Provisioning type of the byte capacity of the pool.
    capacity_provisioning_type: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
AlphaComputeAlphaStoragePool = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_storage_pool",
    fields={
        ...
        "exapool_provisioned_capacity_gb": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaStoragePool_ExapoolProvisionedCapacityGbFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaComputeAlphaStoragePool_ParamsFields,
        ),
        ...
        "resource_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaStoragePool_ResourceStatusFields,
        ),
        ...
        "share_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaStoragePool_ShareSettingsFields,
        ),
