...
class AlphaTargetHttpsProxyConfig:
...
@dataclasses.dataclass
class AlphaTargetHttpsProxyAttrs:
    # [Deprecated] Use serverTlsPolicy instead.
    authentication: Any = None
    # [Deprecated] Use authorizationPolicy instead.
    authorization: Any = None
...
AlphaTargetHttpsProxy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_target_https_proxy",
    fields={
