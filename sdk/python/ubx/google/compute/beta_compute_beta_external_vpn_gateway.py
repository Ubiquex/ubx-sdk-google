...
class BetaComputeBetaExternalVpnGateway_Interfaces:
    id: Any = None
    ip_address: Any = None
    ipv6_address: Any = None

@dataclasses.dataclass
class BetaComputeBetaExternalVpnGateway_Params:
...
@dataclasses.dataclass
class BetaComputeBetaExternalVpnGatewayAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
BetaComputeBetaExternalVpnGateway = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_external_vpn_gateway",
    fields={
        ...
        "interfaces": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaExternalVpnGateway_InterfacesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaExternalVpnGateway_ParamsFields,
        ),
