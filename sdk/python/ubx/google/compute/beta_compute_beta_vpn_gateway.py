...
class BetaComputeBetaVpnGateway_Params:
...
@dataclasses.dataclass
class BetaComputeBetaVpnGateway_VpnInterfaces:
    id: Any = None
    interconnect_attachment: Any = None
    ip_address: Any = None
    ipv6_address: Any = None

_BetaComputeBetaVpnGateway_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaVpnGateway_VpnInterfacesFields = {
...
@dataclasses.dataclass
class BetaComputeBetaVpnGatewayConfig:
...
@dataclasses.dataclass
class BetaComputeBetaVpnGatewayAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
BetaComputeBetaVpnGateway = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_vpn_gateway",
    fields={
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaVpnGateway_ParamsFields,
        ),
        ...
        "vpn_interfaces": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaVpnGateway_VpnInterfacesFields,
        ),
    },
)
