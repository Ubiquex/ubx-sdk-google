...
class AlphaFirewall_Allowed:
    ipprotocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class AlphaFirewall_LogConfig:
...
AlphaFirewall = ubx.ResourceBinding(
    wire_type="google_compute_alpha_firewall",
    fields={
        ...
        "log_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaFirewall_LogConfigFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaFirewall_ParamsFields,
        ),
