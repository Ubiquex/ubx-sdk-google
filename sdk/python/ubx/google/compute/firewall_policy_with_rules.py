...
class FirewallPolicyWithRules_Rule_Match_Layer4Config:
    ip_protocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class FirewallPolicyWithRules_Rule_Match_SrcSecureTag:
    name: Any = None
    state: Any = None

@dataclasses.dataclass
class FirewallPolicyWithRules_Rule_Match:
...
@dataclasses.dataclass
class FirewallPolicyWithRules_Rule:
    action: Any = None
...
@dataclasses.dataclass
class FirewallPolicyWithRules_Timeouts:
    create: Any = None
    delete: Any = None
    update: Any = None

_FirewallPolicyWithRules_Rule_Match_Layer4ConfigFields = {
    "ip_protocol": ubx.FieldSpec(wire_name="ip_protocol"),
    "ports": ubx.FieldSpec(wire_name="ports"),
}

_FirewallPolicyWithRules_Rule_Match_SrcSecureTagFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_FirewallPolicyWithRules_Rule_MatchFields = {
    ...
    "layer4_config": ubx.FieldSpec(
        ...
        kind="list",
        fields=_FirewallPolicyWithRules_Rule_Match_Layer4ConfigFields,
    ),
    "src_secure_tag": ubx.FieldSpec(
        wire_name="src_secure_tag",
        kind="list",
        fields=_FirewallPolicyWithRules_Rule_Match_SrcSecureTagFields,
    ),
}

_FirewallPolicyWithRules_RuleFields = {
    ...
    "match": ubx.FieldSpec(
        wire_name="match",
        kind="list",
        fields=_FirewallPolicyWithRules_Rule_MatchFields,
    ),
...
_FirewallPolicyWithRules_TimeoutsFields = {
...
@dataclasses.dataclass
class FirewallPolicyWithRulesConfig:
...
FirewallPolicyWithRules = ubx.ResourceBinding(
    wire_type="google_compute_firewall_policy_with_rules",
    fields={
        ...
        "rule": ubx.FieldSpec(
            wire_name="rule",
            kind="list",
            fields=_FirewallPolicyWithRules_RuleFields,
        ),
        "timeouts": ubx.FieldSpec(
            wire_name="timeouts",
            kind="object",
            fields=_FirewallPolicyWithRules_TimeoutsFields,
        ),
    },
)
