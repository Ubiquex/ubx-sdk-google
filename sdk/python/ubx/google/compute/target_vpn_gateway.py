...
TargetVpnGateway = ubx.ResourceBinding(
    wire_type="google_compute_target_vpn_gateway",
    fields={
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_TargetVpnGateway_ParamsFields,
        ),
