...
_SslPolicy_Warnings_DataFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_SslPolicy_WarningsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "data": ubx.FieldSpec(
        wire_name="data",
        kind="list",
        fields=_SslPolicy_Warnings_DataFields,
    ),
...
SslPolicy = ubx.ResourceBinding(
    wire_type="google_compute_ssl_policy",
    fields={
        ...
        "warnings": ubx.FieldSpec(
            wire_name="warnings",
            kind="list",
            fields=_SslPolicy_WarningsFields,
        ),
    },
)
