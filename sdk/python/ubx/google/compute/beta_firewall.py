...
class BetaFirewall_Allowed:
    ipprotocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class BetaFirewall_LogConfig:
...
BetaFirewall = ubx.ResourceBinding(
    wire_type="google_compute_beta_firewall",
    fields={
        "allowed": ubx.FieldSpec(
            wire_name="allowed",
            kind="list",
            fields=_BetaFirewall_AllowedFields,
        ),
        ...
        "log_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaFirewall_LogConfigFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaFirewall_ParamsFields,
        ),
