...
@dataclasses.dataclass
class RegionInstantSnapshot_ResourceStatus:
...
_RegionInstantSnapshot_ResourceStatusFields = {
...
@dataclasses.dataclass
class RegionInstantSnapshotAttrs:
    # Output only. [Output Only] The architecture of the instant snapshot. Valid values are ARM64 or X86_64.
    architecture: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
RegionInstantSnapshot = ubx.ResourceBinding(
    ...
    fields={
        ...
        "resource_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RegionInstantSnapshot_ResourceStatusFields,
        ),
