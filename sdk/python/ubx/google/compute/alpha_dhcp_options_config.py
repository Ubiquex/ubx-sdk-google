# Code generated by `ubx sdk gen` from google_compute_alpha_dhcp_options_config. DO NOT EDIT.
...
class AlphaDhcpOptionsConfig_Associations:
    network: Any = None
    network_id: Any = None
    state: Any = None

_AlphaDhcpOptionsConfig_AssociationsFields = {
...
@dataclasses.dataclass
class AlphaDhcpOptionsConfigConfig:
...
@dataclasses.dataclass
class AlphaDhcpOptionsConfigAttrs:
    # Mapping of user-defined keys to DhcpOptionsConfig to Network associations.
    associations: Any = None
    # The file path and name of the boot image/file on the TFTP server that the client VM guest OS should download and execute during network boot. Used when the standard DHCP header 'file' field is overloaded. Corresponds to DHCPv4 Option 67.
    boot_file_ipv4_name: Any = None
...
AlphaDhcpOptionsConfig = ubx.ResourceBinding(
    wire_type="google_compute_alpha_dhcp_options_config",
    fields={
        "associations": ubx.FieldSpec(
            wire_name="associations",
            kind="map",
            fields=_AlphaDhcpOptionsConfig_AssociationsFields,
        ),
