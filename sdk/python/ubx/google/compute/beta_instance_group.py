...
class BetaInstanceGroup_NamedPorts:
    name: Any = None
    port: Any = None

_BetaInstanceGroup_NamedPortsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "port": ubx.FieldSpec(wire_name="port"),
}

@dataclasses.dataclass
class BetaInstanceGroupConfig:
...
BetaInstanceGroup = ubx.ResourceBinding(
    wire_type="google_compute_beta_instance_group",
    fields={
        ...
        "named_ports": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaInstanceGroup_NamedPortsFields,
        ),
