# Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_network_attachment. DO NOT EDIT.
...
class AlphaComputeAlphaNetworkAttachment_ConnectionEndpoints:
    ip_address: Any = None
...
_AlphaComputeAlphaNetworkAttachment_ConnectionEndpointsFields = {
...
@dataclasses.dataclass
class AlphaComputeAlphaNetworkAttachmentConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaNetworkAttachmentAttrs:
    # Output only. [Output Only] An array of connections for all the producers connected to this network attachment.
    connection_endpoints: Any = None
    connection_preference: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
...
AlphaComputeAlphaNetworkAttachment = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_network_attachment",
    fields={
        "connection_endpoints": ubx.FieldSpec(
            wire_name="connection_endpoints",
            kind="list",
            fields=_AlphaComputeAlphaNetworkAttachment_ConnectionEndpointsFields,
        ),
