...
class BetaRoute_AsPaths:
    as_lists: Any = None
    path_segment_type: Any = None

@dataclasses.dataclass
class BetaRoute_Params:
...
BetaRoute = ubx.ResourceBinding(
    wire_type="google_compute_beta_route",
    fields={
        "as_paths": ubx.FieldSpec(
            wire_name="as_paths",
            kind="list",
            fields=_BetaRoute_AsPathsFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaRoute_ParamsFields,
        ),
        ...
        "warnings": ubx.FieldSpec(
            wire_name="warnings",
            kind="list",
            fields=_BetaRoute_WarningsFields,
        ),
    },
)
