...
class BetaComputeBetaRegionTargetHttpsProxyConfig:
...
@dataclasses.dataclass
class BetaComputeBetaRegionTargetHttpsProxyAttrs:
    # [Deprecated] Use serverTlsPolicy instead.
    authentication: Any = None
    # [Deprecated] Use authorizationPolicy instead.
    authorization: Any = None
...
BetaComputeBetaRegionTargetHttpsProxy = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_region_target_https_proxy",
    fields={
