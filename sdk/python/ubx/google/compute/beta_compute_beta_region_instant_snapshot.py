...
class BetaComputeBetaRegionInstantSnapshot_Params:
...
@dataclasses.dataclass
class BetaComputeBetaRegionInstantSnapshot_ResourceStatus:
    # [Output Only] The storage size of this instant snapshot.
    storage_size_bytes: Any = None

_BetaComputeBetaRegionInstantSnapshot_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaRegionInstantSnapshot_ResourceStatusFields = {
    "storage_size_bytes": ubx.FieldSpec(wire_name="storage_size_bytes"),
}

@dataclasses.dataclass
class BetaComputeBetaRegionInstantSnapshotConfig:
...
@dataclasses.dataclass
class BetaComputeBetaRegionInstantSnapshotAttrs:
    # Output only. [Output Only] The architecture of the instant snapshot. Valid values are ARM64 or X86_64.
    architecture: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaComputeBetaRegionInstantSnapshot = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_region_instant_snapshot",
    fields={
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaRegionInstantSnapshot_ParamsFields,
        ),
        "region": ubx.FieldSpec(wire_name="region"),
        "resource_status": ubx.FieldSpec(
            wire_name="resource_status",
            kind="object",
            fields=_BetaComputeBetaRegionInstantSnapshot_ResourceStatusFields,
        ),
