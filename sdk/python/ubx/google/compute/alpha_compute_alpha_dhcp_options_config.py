...
class AlphaComputeAlphaDhcpOptionsConfig_Associations:
    network: Any = None
    network_id: Any = None
    state: Any = None

_AlphaComputeAlphaDhcpOptionsConfig_AssociationsFields = {
...
@dataclasses.dataclass
class AlphaComputeAlphaDhcpOptionsConfigConfig:
    ...
    dns_server_ipv4_addresses: Any = None
    ...
    dns_server_ipv6_addresses: Any = None
...
@dataclasses.dataclass
class AlphaComputeAlphaDhcpOptionsConfigAttrs:
    # Mapping of user-defined keys to DhcpOptionsConfig to Network associations.
    associations: Any = None
    # The file path and name of the boot image/file on the TFTP server that the client VM guest OS should download and execute during network boot. Used when the standard DHCP header 'file' field is overloaded. Corresponds to DHCPv4 Option 67.
    boot_file_ipv4_name: Any = None
...
AlphaComputeAlphaDhcpOptionsConfig = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_dhcp_options_config",
    fields={
        "associations": ubx.FieldSpec(
            wire_name="associations",
            kind="map",
            fields=_AlphaComputeAlphaDhcpOptionsConfig_AssociationsFields,
        ),
        ...
        "dns_server_ipv4_addresses": ubx.FieldSpec(wire_name="dns_server_ipv4_addresses"),
        "dns_server_ipv6_addresses": ubx.FieldSpec(wire_name="dns_server_ipv6_addresses"),
