# Code generated by `ubx sdk gen` from google_compute_beta_compute_beta_region_health_check_service. DO NOT EDIT.
...
class BetaComputeBetaRegionHealthCheckServiceConfig:
...
@dataclasses.dataclass
class BetaComputeBetaRegionHealthCheckServiceAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
BetaComputeBetaRegionHealthCheckService = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_region_health_check_service",
    fields={
