...
class BetaPacketMirroring_CollectorIlb:
...
@dataclasses.dataclass
class BetaPacketMirroring_Filter:
...
@dataclasses.dataclass
class BetaPacketMirroring_MirroredResources:
...
_BetaPacketMirroring_MirroredResourcesFields = {
    "instances": ubx.FieldSpec(
        wire_name="instances",
        kind="list",
        fields=_BetaPacketMirroring_CollectorIlbFields,
    ),
...
@dataclasses.dataclass
class BetaPacketMirroringConfig:
...
@dataclasses.dataclass
class BetaPacketMirroringAttrs:
    collector_ilb: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
...
BetaPacketMirroring = ubx.ResourceBinding(
    wire_type="google_compute_beta_packet_mirroring",
    fields={
        ...
        "filter": ubx.FieldSpec(
            wire_name="filter",
            kind="object",
            fields=_BetaPacketMirroring_FilterFields,
        ),
        ...
        "mirrored_resources": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaPacketMirroring_MirroredResourcesFields,
        ),
