...
class AlphaRegionAutoscaler_AutoscalingPolicy_CpuUtilization_SignalAggregation:
...
@dataclasses.dataclass
class AlphaRegionAutoscaler_AutoscalingPolicy_CpuUtilization_TimeAggregation:
    # If statistic is PERCENTILE, percentile must be defined. This value is used only when statistic is PERCENTILE.
    percentile: Any = None
...
@dataclasses.dataclass
class AlphaRegionAutoscaler_AutoscalingPolicy_CpuUtilization_UtilizationRange:
...
@dataclasses.dataclass
class AlphaRegionAutoscaler_AutoscalingPolicy_CpuUtilization:
...
@dataclasses.dataclass
class AlphaRegionAutoscaler_AutoscalingPolicy_CustomMetricUtilizations:
    filter: Any = None
    metric: Any = None
...
@dataclasses.dataclass
class AlphaRegionAutoscaler_AutoscalingPolicy_LoadBalancingUtilization:
    # Fraction of backend capacity utilization (set in HTTP(S) load balancing configuration) that the autoscaler maintains. Must be a positive float value. If not defined, the default is 0.8.
    utilization_target: Any = None

@dataclasses.dataclass
class AlphaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas:
...
@dataclasses.dataclass
class AlphaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl:
...
@dataclasses.dataclass
class AlphaRegionAutoscaler_AutoscalingPolicy_ScaleInControl:
    # Encapsulates numeric value that can be either absolute or relative.
...
@dataclasses.dataclass
class AlphaRegionAutoscaler_AutoscalingPolicy_ScalingSchedules:
...
@dataclasses.dataclass
class AlphaRegionAutoscaler_AutoscalingPolicy:
...
@dataclasses.dataclass
class AlphaRegionAutoscaler_ScalingScheduleStatus:
    last_start_time: Any = None
    next_start_time: Any = None
    state: Any = None

@dataclasses.dataclass
class AlphaRegionAutoscaler_StatusDetails:
    message: Any = None
    type: Any = None

_AlphaRegionAutoscaler_AutoscalingPolicy_CpuUtilization_SignalAggregationFields = {
    "percentile": ubx.FieldSpec(wire_name="percentile"),
    "statistic": ubx.FieldSpec(wire_name="statistic"),
}

_AlphaRegionAutoscaler_AutoscalingPolicy_CpuUtilization_TimeAggregationFields = {
    "percentile": ubx.FieldSpec(wire_name="percentile"),
    "statistic": ubx.FieldSpec(wire_name="statistic"),
    "time_window_sec": ubx.FieldSpec(wire_name="time_window_sec"),
}

_AlphaRegionAutoscaler_AutoscalingPolicy_CpuUtilization_UtilizationRangeFields = {
...
_AlphaRegionAutoscaler_AutoscalingPolicy_CpuUtilizationFields = {
    "predictive_method": ubx.FieldSpec(wire_name="predictive_method"),
    "signal_aggregation": ubx.FieldSpec(
        wire_name="signal_aggregation",
        kind="object",
        fields=_AlphaRegionAutoscaler_AutoscalingPolicy_CpuUtilization_SignalAggregationFields,
    ),
    "time_aggregation": ubx.FieldSpec(
        wire_name="time_aggregation",
        kind="object",
        fields=_AlphaRegionAutoscaler_AutoscalingPolicy_CpuUtilization_TimeAggregationFields,
    ),
    "utilization_range": ubx.FieldSpec(
        wire_name="utilization_range",
        kind="object",
        fields=_AlphaRegionAutoscaler_AutoscalingPolicy_CpuUtilization_UtilizationRangeFields,
    ),
    "utilization_target": ubx.FieldSpec(wire_name="utilization_target"),
}

_AlphaRegionAutoscaler_AutoscalingPolicy_CustomMetricUtilizationsFields = {
...
_AlphaRegionAutoscaler_AutoscalingPolicy_LoadBalancingUtilizationFields = {
    "utilization_target": ubx.FieldSpec(wire_name="utilization_target"),
}

_AlphaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicasFields = {
    "calculated": ubx.FieldSpec(wire_name="calculated"),
    "fixed": ubx.FieldSpec(wire_name="fixed"),
    "percent": ubx.FieldSpec(wire_name="percent"),
}

_AlphaRegionAutoscaler_AutoscalingPolicy_ScaleDownControlFields = {
    "max_scaled_down_replicas": ubx.FieldSpec(
        wire_name="max_scaled_down_replicas",
        kind="object",
        fields=_AlphaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicasFields,
    ),
    "time_window_sec": ubx.FieldSpec(wire_name="time_window_sec"),
}

_AlphaRegionAutoscaler_AutoscalingPolicy_ScaleInControlFields = {
...
_AlphaRegionAutoscaler_AutoscalingPolicy_ScalingSchedulesFields = {
...
_AlphaRegionAutoscaler_AutoscalingPolicyFields = {
    ...
    "scale_down_control": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaRegionAutoscaler_AutoscalingPolicy_ScaleDownControlFields,
    ),
    "scale_in_control": ubx.FieldSpec(
        wire_name="scale_in_control",
        kind="object",
        fields=_AlphaRegionAutoscaler_AutoscalingPolicy_ScaleInControlFields,
    ),
    "scaling_schedules": ubx.FieldSpec(
        wire_name="scaling_schedules",
        kind="map",
        fields=_AlphaRegionAutoscaler_AutoscalingPolicy_ScalingSchedulesFields,
    ),
...
AlphaRegionAutoscaler = ubx.ResourceBinding(
    wire_type="google_compute_alpha_region_autoscaler",
    fields={
