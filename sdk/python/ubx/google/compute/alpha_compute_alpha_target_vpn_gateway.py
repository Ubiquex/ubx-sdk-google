...
class AlphaComputeAlphaTargetVpnGateway_Params:
...
_AlphaComputeAlphaTargetVpnGateway_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

@dataclasses.dataclass
class AlphaComputeAlphaTargetVpnGatewayConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaTargetVpnGatewayAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
AlphaComputeAlphaTargetVpnGateway = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_target_vpn_gateway",
    fields={
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaComputeAlphaTargetVpnGateway_ParamsFields,
        ),
