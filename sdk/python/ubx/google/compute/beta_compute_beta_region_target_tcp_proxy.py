...
class BetaComputeBetaRegionTargetTcpProxyConfig:
...
@dataclasses.dataclass
class BetaComputeBetaRegionTargetTcpProxyAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
BetaComputeBetaRegionTargetTcpProxy = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_region_target_tcp_proxy",
    fields={
