...
class AlphaComputeAlphaNetworkFirewallPolicy_Associations:
...
@dataclasses.dataclass
class AlphaComputeAlphaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs:
    ip_protocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags:
    name: Any = None
    state: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaNetworkFirewallPolicy_PacketMirroringRules_Match:
...
@dataclasses.dataclass
class AlphaComputeAlphaNetworkFirewallPolicy_PacketMirroringRules:
    action: Any = None
...
@dataclasses.dataclass
class AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation_RolloutInput:
...
@dataclasses.dataclass
class AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation_RolloutStatus_NextRollout:
...
@dataclasses.dataclass
class AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRollouts:
    rollout: Any = None
    rollout_plan: Any = None
    state: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation_RolloutStatus:
...
@dataclasses.dataclass
class AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation:
...
_AlphaComputeAlphaNetworkFirewallPolicy_AssociationsFields = {
...
_AlphaComputeAlphaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields = {
    "ip_protocol": ubx.FieldSpec(wire_name="ip_protocol"),
    "ports": ubx.FieldSpec(wire_name="ports"),
}

_AlphaComputeAlphaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_AlphaComputeAlphaNetworkFirewallPolicy_PacketMirroringRules_MatchFields = {
    ...
    "layer4_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaComputeAlphaNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields,
    ),
    ...
    "src_secure_tags": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaComputeAlphaNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields,
    ),
    "src_threat_intelligences": ubx.FieldSpec(wire_name="src_threat_intelligences"),
}

_AlphaComputeAlphaNetworkFirewallPolicy_PacketMirroringRulesFields = {
    ...
    "match": ubx.FieldSpec(
        wire_name="match",
        kind="object",
        fields=_AlphaComputeAlphaNetworkFirewallPolicy_PacketMirroringRules_MatchFields,
    ),
    "priority": ubx.FieldSpec(wire_name="priority"),
...
_AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation_RolloutInputFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "predefined_rollout_plan": ubx.FieldSpec(wire_name="predefined_rollout_plan"),
    "retry_uuid": ubx.FieldSpec(wire_name="retry_uuid"),
}

_AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation_RolloutStatus_NextRolloutFields = {
    "rollout_id": ubx.FieldSpec(wire_name="rollout_id"),
    "rollout_plan": ubx.FieldSpec(wire_name="rollout_plan"),
}

_AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRolloutsFields = {
    "rollout": ubx.FieldSpec(wire_name="rollout"),
    "rollout_plan": ubx.FieldSpec(wire_name="rollout_plan"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation_RolloutStatusFields = {
    "next_rollout": ubx.FieldSpec(
        wire_name="next_rollout",
        kind="object",
        fields=_AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation_RolloutStatus_NextRolloutFields,
    ),
    "ongoing_rollouts": ubx.FieldSpec(
        wire_name="ongoing_rollouts",
        kind="list",
        fields=_AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRolloutsFields,
    ),
...
_AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperationFields = {
    "rollout_input": ubx.FieldSpec(
        wire_name="rollout_input",
        kind="object",
        fields=_AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation_RolloutInputFields,
    ),
    "rollout_status": ubx.FieldSpec(
        wire_name="rollout_status",
        kind="object",
        fields=_AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperation_RolloutStatusFields,
    ),
}

@dataclasses.dataclass
class AlphaComputeAlphaNetworkFirewallPolicyConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaNetworkFirewallPolicyAttrs:
    # A list of associations that belong to this firewall policy.
    associations: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
AlphaComputeAlphaNetworkFirewallPolicy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_network_firewall_policy",
    fields={
        "associations": ubx.FieldSpec(
            wire_name="associations",
            kind="list",
            fields=_AlphaComputeAlphaNetworkFirewallPolicy_AssociationsFields,
        ),
        ...
        "packet_mirroring_rules": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaComputeAlphaNetworkFirewallPolicy_PacketMirroringRulesFields,
        ),
        ...
        "rollout_operation": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaNetworkFirewallPolicy_RolloutOperationFields,
        ),
        "rule_tuple_count": ubx.FieldSpec(wire_name="rule_tuple_count"),
        "rules": ubx.FieldSpec(
            wire_name="rules",
