# Code generated by `ubx sdk gen` from google_compute_beta_region_health_source. DO NOT EDIT.
...
class BetaRegionHealthSourceConfig:
...
@dataclasses.dataclass
class BetaRegionHealthSourceAttrs:
...
BetaRegionHealthSource = ubx.ResourceBinding(
    wire_type="google_compute_beta_region_health_source",
    fields={
