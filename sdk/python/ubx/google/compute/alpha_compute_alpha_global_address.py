# Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_global_address. DO NOT EDIT.
...
class AlphaComputeAlphaGlobalAddressConfig:
    ...
    network: Any = None
    # Optional. The URL of the network attachment that this address comes from in the following format: projects/{project}/regions/{region_name}/networkAttachments/{network_attachment_name}.
    ...
    ptr_domain_name: Any = None
    # The TTL in seconds for public DNS PTR record.
    ptr_domain_name_ttl: Any = None
    ...
    # Optional. Producer Service's Service class ID for the region of this address. Can only be used with network_attachment. It is not possible to use on its own; however, network_attachment can be used without service_class_id.
...
@dataclasses.dataclass
class AlphaComputeAlphaGlobalAddressAttrs:
    # The static IP address represented by this resource.
    address: Any = None
    # The type of address to reserve, either INTERNAL orEXTERNAL. If unspecified, defaults to EXTERNAL.
    address_type: Any = None
...
AlphaComputeAlphaGlobalAddress = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_global_address",
    fields={
        ...
        "ptr_domain_name": ubx.FieldSpec(wire_name="ptr_domain_name"),
        "ptr_domain_name_ttl": ubx.FieldSpec(wire_name="ptr_domain_name_ttl"),
