...
@dataclasses.dataclass
class RegionBackendBucket_CdnPolicy_CacheKeyPolicy:
...
@dataclasses.dataclass
class RegionBackendBucket_CdnPolicy:
...
@dataclasses.dataclass
class RegionBackendBucket_Params:
...
_RegionBackendBucket_CdnPolicy_CacheKeyPolicyFields = {
...
_RegionBackendBucket_CdnPolicy_NegativeCachingPolicyFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "ttl": ubx.FieldSpec(wire_name="ttl"),
}

_RegionBackendBucket_CdnPolicyFields = {
    "bypass_cache_on_request_headers": ubx.FieldSpec(
        wire_name="bypass_cache_on_request_headers",
        kind="list",
        fields=_RegionBackendBucket_CdnPolicy_BypassCacheOnRequestHeadersFields,
    ),
    "cache_key_policy": ubx.FieldSpec(
        wire_name="cache_key_policy",
        kind="object",
        fields=_RegionBackendBucket_CdnPolicy_CacheKeyPolicyFields,
    ),
    ...
    "negative_caching_policy": ubx.FieldSpec(
        ...
        kind="list",
        fields=_RegionBackendBucket_CdnPolicy_NegativeCachingPolicyFields,
    ),
...
_RegionBackendBucket_ParamsFields = {
...
RegionBackendBucket = ubx.ResourceBinding(
    wire_type="google_compute_region_backend_bucket",
    fields={
        "bucket_name": ubx.FieldSpec(wire_name="bucket_name"),
        "cdn_policy": ubx.FieldSpec(
            wire_name="cdn_policy",
            kind="object",
            fields=_RegionBackendBucket_CdnPolicyFields,
        ),
