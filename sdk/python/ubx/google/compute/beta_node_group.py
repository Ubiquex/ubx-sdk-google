...
class BetaNodeGroup_AutoscalingPolicy:
...
@dataclasses.dataclass
class BetaNodeGroup_MaintenanceWindow_MaintenanceDuration:
...
@dataclasses.dataclass
class BetaNodeGroup_MaintenanceWindow:
...
@dataclasses.dataclass
class BetaNodeGroup_ShareSettings_FolderMap:
    folder_id: Any = None

@dataclasses.dataclass
class BetaNodeGroup_ShareSettings_ProjectMap:
    project_id: Any = None

@dataclasses.dataclass
class BetaNodeGroup_ShareSettings:
...
BetaNodeGroup = ubx.ResourceBinding(
    wire_type="google_compute_beta_node_group",
    fields={
        ...
        "maintenance_window": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaNodeGroup_MaintenanceWindowFields,
        ),
