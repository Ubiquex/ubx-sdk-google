...
class BetaComputeBetaSnapshot_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class BetaComputeBetaSnapshot_Params:
...
@dataclasses.dataclass
class BetaComputeBetaSnapshot_SnapshotEncryptionKey:
...
_BetaComputeBetaSnapshot_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_BetaComputeBetaSnapshot_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaSnapshot_SnapshotEncryptionKeyFields = {
...
@dataclasses.dataclass
class BetaComputeBetaSnapshotConfig:
...
@dataclasses.dataclass
class BetaComputeBetaSnapshotAttrs:
    # Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64.
    architecture: Any = None
    # Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk.
    auto_created: Any = None
...
BetaComputeBetaSnapshot = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_snapshot",
    fields={
        ...
        "guest_os_features": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaSnapshot_GuestOsFeaturesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaSnapshot_ParamsFields,
        ),
        ...
        "snapshot_encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaSnapshot_SnapshotEncryptionKeyFields,
        ),
