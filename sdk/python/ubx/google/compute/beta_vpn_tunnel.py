...
class BetaVpnTunnel_CipherSuite_Phase1:
    dh: Any = None
    encryption: Any = None
    integrity: Any = None
    prf: Any = None
...
@dataclasses.dataclass
class BetaVpnTunnel_CipherSuite_Phase2:
    encryption: Any = None
    integrity: Any = None
    pfs: Any = None

@dataclasses.dataclass
class BetaVpnTunnel_CipherSuite:
    phase1: Any = None
    phase2: Any = None

@dataclasses.dataclass
class BetaVpnTunnel_Params:
...
_BetaVpnTunnel_CipherSuite_Phase1Fields = {
...
_BetaVpnTunnel_CipherSuite_Phase2Fields = {
    "encryption": ubx.FieldSpec(wire_name="encryption"),
    "integrity": ubx.FieldSpec(wire_name="integrity"),
    "pfs": ubx.FieldSpec(wire_name="pfs"),
}

_BetaVpnTunnel_CipherSuiteFields = {
    "phase1": ubx.FieldSpec(
        wire_name="phase1",
        kind="object",
        fields=_BetaVpnTunnel_CipherSuite_Phase1Fields,
    ),
    "phase2": ubx.FieldSpec(
        wire_name="phase2",
        kind="object",
        fields=_BetaVpnTunnel_CipherSuite_Phase2Fields,
    ),
}

_BetaVpnTunnel_ParamsFields = {
...
BetaVpnTunnel = ubx.ResourceBinding(
    wire_type="google_compute_beta_vpn_tunnel",
    fields={
        "capacity_tier": ubx.FieldSpec(wire_name="capacity_tier"),
        "cipher_suite": ubx.FieldSpec(
            wire_name="cipher_suite",
            kind="object",
            fields=_BetaVpnTunnel_CipherSuiteFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaVpnTunnel_ParamsFields,
        ),
