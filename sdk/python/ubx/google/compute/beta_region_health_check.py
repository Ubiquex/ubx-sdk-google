...
class BetaRegionHealthCheck_GrpcHealthCheck:
...
@dataclasses.dataclass
class BetaRegionHealthCheck_GrpcTlsHealthCheck:
    # The gRPC service name for the health check. This field is optional. The value of grpc_service_name has the following meanings by convention: - Empty service_name means the overall status of all services at the backend. - Non-empty service_name means the health of that gRPC service, as defined by the owner of the service. The grpc_service_name can only be ASCII.
    grpc_service_name: Any = None
    # The TCP port number to which the health check prober sends packets. Valid values are 1 through 65535.
    port: Any = None
...
@dataclasses.dataclass
class BetaRegionHealthCheck_Http2HealthCheck:
...
@dataclasses.dataclass
class BetaRegionHealthCheck_LogConfig:
    # Indicates whether or not to export logs. This is false by default, which means no health check logging will be done.
    enable: Any = None

@dataclasses.dataclass
class BetaRegionHealthCheck_SslHealthCheck:
    # The TCP port number to which the health check prober sends packets. The default value is 443. Valid values are 1 through65535.
    port: Any = None
    # Not supported.
    port_name: Any = None
...
_BetaRegionHealthCheck_GrpcHealthCheckFields = {
...
_BetaRegionHealthCheck_GrpcTlsHealthCheckFields = {
    "grpc_service_name": ubx.FieldSpec(wire_name="grpc_service_name"),
    "port": ubx.FieldSpec(wire_name="port"),
    "port_specification": ubx.FieldSpec(wire_name="port_specification"),
}

_BetaRegionHealthCheck_Http2HealthCheckFields = {
...
_BetaRegionHealthCheck_LogConfigFields = {
    "enable": ubx.FieldSpec(wire_name="enable"),
}

_BetaRegionHealthCheck_SslHealthCheckFields = {
    "port": ubx.FieldSpec(wire_name="port"),
    "port_name": ubx.FieldSpec(wire_name="port_name"),
    "port_specification": ubx.FieldSpec(wire_name="port_specification"),
    "proxy_header": ubx.FieldSpec(wire_name="proxy_header"),
...
@dataclasses.dataclass
class BetaRegionHealthCheckAttrs:
    # How often (in seconds) to send a health check. The default value is 5 seconds.
    check_interval_sec: Any = None
    # Output only. [Output Only] Creation timestamp in3339 text format.
    creation_timestamp: Any = None
...
BetaRegionHealthCheck = ubx.ResourceBinding(
    ...
    fields={
        ...
        "grpc_health_check": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaRegionHealthCheck_GrpcHealthCheckFields,
        ),
        "grpc_tls_health_check": ubx.FieldSpec(
            wire_name="grpc_tls_health_check",
            kind="object",
            fields=_BetaRegionHealthCheck_GrpcTlsHealthCheckFields,
        ),
        ...
        "ssl_health_check": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaRegionHealthCheck_SslHealthCheckFields,
        ),
