...
class AlphaVpnTunnel_CipherSuite_Phase1:
    dh: Any = None
    encryption: Any = None
    integrity: Any = None
    prf: Any = None
...
@dataclasses.dataclass
class AlphaVpnTunnel_CipherSuite_Phase2:
    encryption: Any = None
    integrity: Any = None
    pfs: Any = None

@dataclasses.dataclass
class AlphaVpnTunnel_CipherSuite:
    phase1: Any = None
    phase2: Any = None

@dataclasses.dataclass
class AlphaVpnTunnel_Params:
...
@dataclasses.dataclass
class AlphaVpnTunnel_PqcPhase1_Keys:
    ke1s: Any = None
    ke2s: Any = None
    ke3s: Any = None
    ke4s: Any = None
...
@dataclasses.dataclass
class AlphaVpnTunnel_PqcPhase1:
    # User specified list of PQC key exchanges.
    keys: Any = None
    mode: Any = None

_AlphaVpnTunnel_CipherSuite_Phase1Fields = {
...
_AlphaVpnTunnel_CipherSuite_Phase2Fields = {
    "encryption": ubx.FieldSpec(wire_name="encryption"),
    "integrity": ubx.FieldSpec(wire_name="integrity"),
    "pfs": ubx.FieldSpec(wire_name="pfs"),
}

_AlphaVpnTunnel_CipherSuiteFields = {
    "phase1": ubx.FieldSpec(
        wire_name="phase1",
        kind="object",
        fields=_AlphaVpnTunnel_CipherSuite_Phase1Fields,
    ),
    "phase2": ubx.FieldSpec(
        wire_name="phase2",
        kind="object",
        fields=_AlphaVpnTunnel_CipherSuite_Phase2Fields,
    ),
}

_AlphaVpnTunnel_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaVpnTunnel_PqcPhase1_KeysFields = {
...
_AlphaVpnTunnel_PqcPhase1Fields = {
    "keys": ubx.FieldSpec(
        wire_name="keys",
        kind="object",
        fields=_AlphaVpnTunnel_PqcPhase1_KeysFields,
    ),
...
AlphaVpnTunnel = ubx.ResourceBinding(
    wire_type="google_compute_alpha_vpn_tunnel",
    fields={
        "capacity_tier": ubx.FieldSpec(wire_name="capacity_tier"),
        "cipher_suite": ubx.FieldSpec(
            wire_name="cipher_suite",
            kind="object",
            fields=_AlphaVpnTunnel_CipherSuiteFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaVpnTunnel_ParamsFields,
        ),
        ...
        "pqc_phase1": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaVpnTunnel_PqcPhase1Fields,
        ),
