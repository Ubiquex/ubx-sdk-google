...
class AlphaGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors:
    all_of_selectors: Any = None

@dataclasses.dataclass
class AlphaGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector:
    any_of_selectors: Any = None

@dataclasses.dataclass
class AlphaGlobalVmExtensionPolicy_ExtensionPolicies:
    installed_software_selector: Any = None
    pinned_version: Any = None
    string_config: Any = None

@dataclasses.dataclass
class AlphaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelector:
    inclusion_labels: Any = None

@dataclasses.dataclass
class AlphaGlobalVmExtensionPolicy_InstanceSelectors:
    label_selector: Any = None

@dataclasses.dataclass
class AlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutInput:
...
@dataclasses.dataclass
class AlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus:
    state: Any = None

@dataclasses.dataclass
class AlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts:
...
@dataclasses.dataclass
class AlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus:
...
@dataclasses.dataclass
class AlphaGlobalVmExtensionPolicy_RolloutOperation:
    rollout_input: Any = None
    rollout_status: Any = None

_AlphaGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectorsFields = {
    "all_of_selectors": ubx.FieldSpec(wire_name="all_of_selectors"),
}

_AlphaGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelectorFields = {
    "any_of_selectors": ubx.FieldSpec(
        wire_name="any_of_selectors",
        kind="map",
        fields=_AlphaGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectorsFields,
    ),
}

_AlphaGlobalVmExtensionPolicy_ExtensionPoliciesFields = {
    "installed_software_selector": ubx.FieldSpec(
        wire_name="installed_software_selector",
        kind="object",
        fields=_AlphaGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelectorFields,
    ),
    "pinned_version": ubx.FieldSpec(wire_name="pinned_version"),
    "string_config": ubx.FieldSpec(wire_name="string_config"),
}

_AlphaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields = {
    "inclusion_labels": ubx.FieldSpec(wire_name="inclusion_labels"),
}

_AlphaGlobalVmExtensionPolicy_InstanceSelectorsFields = {
    "label_selector": ubx.FieldSpec(
        wire_name="label_selector",
        kind="object",
        fields=_AlphaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields,
    ),
}

_AlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields = {
...
_AlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

_AlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields = {
    "location_rollout_status": ubx.FieldSpec(
        wire_name="location_rollout_status",
        kind="map",
        fields=_AlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields,
    ),
...
_AlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields = {
    "current_rollouts": ubx.FieldSpec(
        wire_name="current_rollouts",
        kind="list",
        fields=_AlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields,
    ),
...
_AlphaGlobalVmExtensionPolicy_RolloutOperationFields = {
    "rollout_input": ubx.FieldSpec(
        wire_name="rollout_input",
        kind="object",
        fields=_AlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields,
    ),
    "rollout_status": ubx.FieldSpec(
        wire_name="rollout_status",
        kind="object",
        fields=_AlphaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields,
    ),
}

@dataclasses.dataclass
class AlphaGlobalVmExtensionPolicyConfig:
...
@dataclasses.dataclass
class AlphaGlobalVmExtensionPolicyAttrs:
...
AlphaGlobalVmExtensionPolicy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_global_vm_extension_policy",
    fields={
        "description": ubx.FieldSpec(wire_name="description"),
        "extension_policies": ubx.FieldSpec(
            wire_name="extension_policies",
            kind="map",
            fields=_AlphaGlobalVmExtensionPolicy_ExtensionPoliciesFields,
        ),
        "instance_selectors": ubx.FieldSpec(
            wire_name="instance_selectors",
            kind="list",
            fields=_AlphaGlobalVmExtensionPolicy_InstanceSelectorsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        ...
        "rollout_operation": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaGlobalVmExtensionPolicy_RolloutOperationFields,
        ),
    },
)
