...
class BetaComputeBetaBackendService_Backends_CustomMetrics:
    dry_run: Any = None
    max_utilization: Any = None
    name: Any = None

@dataclasses.dataclass
class BetaComputeBetaBackendService_Backends_OrchestrationInfo:
    resource_uri: Any = None

@dataclasses.dataclass
class BetaComputeBetaBackendService_Backends:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_CdnPolicy_BypassCacheOnRequestHeaders:
    header_name: Any = None

@dataclasses.dataclass
class BetaComputeBetaBackendService_CdnPolicy_CacheKeyPolicy:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_CdnPolicy_NegativeCachingPolicy:
    code: Any = None
    ttl: Any = None

@dataclasses.dataclass
class BetaComputeBetaBackendService_CdnPolicy:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_CircuitBreakers_ConnectTimeout:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_CircuitBreakers:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_ConnectionDraining:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_ConnectionTrackingPolicy:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_ConsistentHash_HttpCookie:
    # Name of the cookie.
    name: Any = None
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_ConsistentHash:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_CustomMetrics:
    dry_run: Any = None
    name: Any = None

@dataclasses.dataclass
class BetaComputeBetaBackendService_DynamicForwarding_ForwardProxy:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_DynamicForwarding_IpPortSelection:
    # A boolean flag enabling IP:PORT based dynamic forwarding.
    enabled: Any = None

@dataclasses.dataclass
class BetaComputeBetaBackendService_DynamicForwarding:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_FailoverPolicy:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_HaPolicy_Leader_NetworkEndpoint:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_HaPolicy_Leader:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_HaPolicy:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_Iap:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_LocalityLbPolicies_CustomPolicy:
    data: Any = None
    name: Any = None

@dataclasses.dataclass
class BetaComputeBetaBackendService_LocalityLbPolicies_Policy:
    name: Any = None

@dataclasses.dataclass
class BetaComputeBetaBackendService_LocalityLbPolicies:
    custom_policy: Any = None
    policy: Any = None

@dataclasses.dataclass
class BetaComputeBetaBackendService_LogConfig:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinity:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_NetworkPassThroughLbTrafficPolicy:
    zonal_affinity: Any = None

@dataclasses.dataclass
class BetaComputeBetaBackendService_OutlierDetection:
    # A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years.
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_Params:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_SecuritySettings_AwsV4Authentication:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_SecuritySettings:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_Subsetting:
    policy: Any = None
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_TlsSettings_SubjectAltNames:
    dns_name: Any = None
    uniform_resource_identifier: Any = None

@dataclasses.dataclass
class BetaComputeBetaBackendService_TlsSettings:
...
@dataclasses.dataclass
class BetaComputeBetaBackendService_UsedBy:
    reference: Any = None

_BetaComputeBetaBackendService_Backends_CustomMetricsFields = {
    "dry_run": ubx.FieldSpec(wire_name="dry_run"),
    "max_utilization": ubx.FieldSpec(wire_name="max_utilization"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_BetaComputeBetaBackendService_Backends_OrchestrationInfoFields = {
    "resource_uri": ubx.FieldSpec(wire_name="resource_uri"),
}

_BetaComputeBetaBackendService_BackendsFields = {
    ...
    "custom_metrics": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaComputeBetaBackendService_Backends_CustomMetricsFields,
    ),
    ...
    "orchestration_info": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaComputeBetaBackendService_Backends_OrchestrationInfoFields,
    ),
...
_BetaComputeBetaBackendService_CdnPolicy_BypassCacheOnRequestHeadersFields = {
    "header_name": ubx.FieldSpec(wire_name="header_name"),
}

_BetaComputeBetaBackendService_CdnPolicy_CacheKeyPolicyFields = {
...
_BetaComputeBetaBackendService_CdnPolicy_NegativeCachingPolicyFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "ttl": ubx.FieldSpec(wire_name="ttl"),
}

_BetaComputeBetaBackendService_CdnPolicyFields = {
    "bypass_cache_on_request_headers": ubx.FieldSpec(
        wire_name="bypass_cache_on_request_headers",
        kind="list",
        fields=_BetaComputeBetaBackendService_CdnPolicy_BypassCacheOnRequestHeadersFields,
    ),
    "cache_key_policy": ubx.FieldSpec(
        wire_name="cache_key_policy",
        kind="object",
        fields=_BetaComputeBetaBackendService_CdnPolicy_CacheKeyPolicyFields,
    ),
    ...
    "negative_caching_policy": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaComputeBetaBackendService_CdnPolicy_NegativeCachingPolicyFields,
    ),
...
_BetaComputeBetaBackendService_CircuitBreakers_ConnectTimeoutFields = {
    "nanos": ubx.FieldSpec(wire_name="nanos"),
    "seconds": ubx.FieldSpec(wire_name="seconds"),
}

_BetaComputeBetaBackendService_CircuitBreakersFields = {
    "connect_timeout": ubx.FieldSpec(
        wire_name="connect_timeout",
        kind="object",
        fields=_BetaComputeBetaBackendService_CircuitBreakers_ConnectTimeoutFields,
    ),
    "max_connections": ubx.FieldSpec(wire_name="max_connections"),
...
_BetaComputeBetaBackendService_ConnectionDrainingFields = {
    "draining_timeout_sec": ubx.FieldSpec(wire_name="draining_timeout_sec"),
}

_BetaComputeBetaBackendService_ConnectionTrackingPolicyFields = {
...
_BetaComputeBetaBackendService_ConsistentHash_HttpCookieFields = {
    "name": ubx.FieldSpec(wire_name="name"),
...
_BetaComputeBetaBackendService_ConsistentHashFields = {
    "http_cookie": ubx.FieldSpec(
        wire_name="http_cookie",
        kind="object",
        fields=_BetaComputeBetaBackendService_ConsistentHash_HttpCookieFields,
    ),
    "http_header_name": ubx.FieldSpec(wire_name="http_header_name"),
    "minimum_ring_size": ubx.FieldSpec(wire_name="minimum_ring_size"),
}

_BetaComputeBetaBackendService_CustomMetricsFields = {
    "dry_run": ubx.FieldSpec(wire_name="dry_run"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_BetaComputeBetaBackendService_DynamicForwarding_ForwardProxyFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "proxy_mode": ubx.FieldSpec(wire_name="proxy_mode"),
}

_BetaComputeBetaBackendService_DynamicForwarding_IpPortSelectionFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
}

_BetaComputeBetaBackendService_DynamicForwardingFields = {
    "forward_proxy": ubx.FieldSpec(
        wire_name="forward_proxy",
        kind="object",
        fields=_BetaComputeBetaBackendService_DynamicForwarding_ForwardProxyFields,
    ),
    "ip_port_selection": ubx.FieldSpec(
        wire_name="ip_port_selection",
        kind="object",
        fields=_BetaComputeBetaBackendService_DynamicForwarding_IpPortSelectionFields,
    ),
}

_BetaComputeBetaBackendService_FailoverPolicyFields = {
...
_BetaComputeBetaBackendService_HaPolicy_Leader_NetworkEndpointFields = {
    "instance": ubx.FieldSpec(wire_name="instance"),
}

_BetaComputeBetaBackendService_HaPolicy_LeaderFields = {
    "backend_group": ubx.FieldSpec(wire_name="backend_group"),
    "network_endpoint": ubx.FieldSpec(
        wire_name="network_endpoint",
        kind="object",
        fields=_BetaComputeBetaBackendService_HaPolicy_Leader_NetworkEndpointFields,
    ),
}

_BetaComputeBetaBackendService_HaPolicyFields = {
    "fast_ipmove": ubx.FieldSpec(wire_name="fast_ipmove"),
    "leader": ubx.FieldSpec(
        wire_name="leader",
        kind="object",
        fields=_BetaComputeBetaBackendService_HaPolicy_LeaderFields,
    ),
}

_BetaComputeBetaBackendService_IapFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
...
_BetaComputeBetaBackendService_LocalityLbPolicies_CustomPolicyFields = {
    "data": ubx.FieldSpec(wire_name="data"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_BetaComputeBetaBackendService_LocalityLbPolicies_PolicyFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

_BetaComputeBetaBackendService_LocalityLbPoliciesFields = {
    "custom_policy": ubx.FieldSpec(
        wire_name="custom_policy",
        kind="object",
        fields=_BetaComputeBetaBackendService_LocalityLbPolicies_CustomPolicyFields,
    ),
    "policy": ubx.FieldSpec(
        wire_name="policy",
        kind="object",
        fields=_BetaComputeBetaBackendService_LocalityLbPolicies_PolicyFields,
    ),
}

_BetaComputeBetaBackendService_LogConfigFields = {
...
_BetaComputeBetaBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinityFields = {
    "spillover": ubx.FieldSpec(wire_name="spillover"),
    "spillover_ratio": ubx.FieldSpec(wire_name="spillover_ratio"),
}

_BetaComputeBetaBackendService_NetworkPassThroughLbTrafficPolicyFields = {
    "zonal_affinity": ubx.FieldSpec(
        wire_name="zonal_affinity",
        kind="object",
        fields=_BetaComputeBetaBackendService_NetworkPassThroughLbTrafficPolicy_ZonalAffinityFields,
    ),
}

_BetaComputeBetaBackendService_OutlierDetectionFields = {
...
_BetaComputeBetaBackendService_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaBackendService_SecuritySettings_AwsV4AuthenticationFields = {
...
_BetaComputeBetaBackendService_TlsSettingsFields = {
    ...
    "subject_alt_names": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaComputeBetaBackendService_TlsSettings_SubjectAltNamesFields,
    ),
}

_BetaComputeBetaBackendService_UsedByFields = {
    "reference": ubx.FieldSpec(wire_name="reference"),
}

@dataclasses.dataclass
class BetaComputeBetaBackendServiceConfig:
...
@dataclasses.dataclass
class BetaComputeBetaBackendServiceAttrs:
    # Lifetime of cookies in seconds. This setting is applicable to Application Load Balancers and Traffic Director and requires GENERATED_COOKIE or HTTP_COOKIE session affinity. If set to 0, the cookie is non-persistent and lasts only until the end of the browser session (or equivalent). The maximum allowed value is two weeks (1,209,600). Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true.
    affinity_cookie_ttl_sec: Any = None
    # The list of backends that serve this BackendService.
    backends: Any = None
...
BetaComputeBetaBackendService = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_backend_service",
    fields={
        "affinity_cookie_ttl_sec": ubx.FieldSpec(wire_name="affinity_cookie_ttl_sec"),
        "backends": ubx.FieldSpec(
            wire_name="backends",
            kind="list",
            fields=_BetaComputeBetaBackendService_BackendsFields,
        ),
        "cdn_policy": ubx.FieldSpec(
            wire_name="cdn_policy",
            kind="object",
            fields=_BetaComputeBetaBackendService_CdnPolicyFields,
        ),
        "circuit_breakers": ubx.FieldSpec(
            wire_name="circuit_breakers",
            kind="object",
            fields=_BetaComputeBetaBackendService_CircuitBreakersFields,
        ),
        "compression_mode": ubx.FieldSpec(wire_name="compression_mode"),
        "connection_draining": ubx.FieldSpec(
            wire_name="connection_draining",
            kind="object",
            fields=_BetaComputeBetaBackendService_ConnectionDrainingFields,
        ),
        "connection_tracking_policy": ubx.FieldSpec(
            wire_name="connection_tracking_policy",
            kind="object",
            fields=_BetaComputeBetaBackendService_ConnectionTrackingPolicyFields,
        ),
        "consistent_hash": ubx.FieldSpec(
            wire_name="consistent_hash",
            kind="object",
            fields=_BetaComputeBetaBackendService_ConsistentHashFields,
        ),
        "creation_timestamp": ubx.FieldSpec(wire_name="creation_timestamp"),
        "custom_metrics": ubx.FieldSpec(
            wire_name="custom_metrics",
            kind="list",
            fields=_BetaComputeBetaBackendService_CustomMetricsFields,
        ),
        ...
        "dynamic_forwarding": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaBackendService_DynamicForwardingFields,
        ),
        ...
        "failover_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaBackendService_FailoverPolicyFields,
        ),
        "fingerprint": ubx.FieldSpec(wire_name="fingerprint"),
        "ha_policy": ubx.FieldSpec(
            wire_name="ha_policy",
            kind="object",
            fields=_BetaComputeBetaBackendService_HaPolicyFields,
        ),
        "health_checks": ubx.FieldSpec(wire_name="health_checks"),
        "iap": ubx.FieldSpec(
            wire_name="iap",
            kind="object",
            fields=_BetaComputeBetaBackendService_IapFields,
        ),
        ...
        "locality_lb_policies": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaBackendService_LocalityLbPoliciesFields,
        ),
        "locality_lb_policy": ubx.FieldSpec(wire_name="locality_lb_policy"),
        "log_config": ubx.FieldSpec(
            wire_name="log_config",
            kind="object",
            fields=_BetaComputeBetaBackendService_LogConfigFields,
        ),
        ...
        "network_pass_through_lb_traffic_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaBackendService_NetworkPassThroughLbTrafficPolicyFields,
        ),
        "orchestration_info": ubx.FieldSpec(
            wire_name="orchestration_info",
            kind="object",
        ...
        "outlier_detection": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaBackendService_OutlierDetectionFields,
        ),
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaBackendService_ParamsFields,
        ),
        ...
        "security_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaBackendService_SecuritySettingsFields,
        ),
        ...
        "subsetting": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaBackendService_SubsettingFields,
        ),
        "timeout_sec": ubx.FieldSpec(wire_name="timeout_sec"),
        "tls_settings": ubx.FieldSpec(
            wire_name="tls_settings",
            kind="object",
            fields=_BetaComputeBetaBackendService_TlsSettingsFields,
        ),
        "used_by": ubx.FieldSpec(
            wire_name="used_by",
            kind="list",
            fields=_BetaComputeBetaBackendService_UsedByFields,
        ),
    },
)
