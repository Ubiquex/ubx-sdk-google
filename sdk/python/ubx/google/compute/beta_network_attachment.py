# Code generated by `ubx sdk gen` from google_compute_beta_network_attachment. DO NOT EDIT.
...
class BetaNetworkAttachment_ConnectionEndpoints:
    ip_address: Any = None
...
_BetaNetworkAttachment_ConnectionEndpointsFields = {
...
@dataclasses.dataclass
class BetaNetworkAttachmentConfig:
...
@dataclasses.dataclass
class BetaNetworkAttachmentAttrs:
    # Output only. [Output Only] An array of connections for all the producers connected to this network attachment.
    connection_endpoints: Any = None
    connection_preference: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
...
BetaNetworkAttachment = ubx.ResourceBinding(
    wire_type="google_compute_beta_network_attachment",
    fields={
        "connection_endpoints": ubx.FieldSpec(
            wire_name="connection_endpoints",
            kind="list",
            fields=_BetaNetworkAttachment_ConnectionEndpointsFields,
        ),
