...
class BetaRegionInstantSnapshot_Params:
...
@dataclasses.dataclass
class BetaRegionInstantSnapshotAttrs:
    # Output only. [Output Only] The architecture of the instant snapshot. Valid values are ARM64 or X86_64.
    architecture: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaRegionInstantSnapshot = ubx.ResourceBinding(
    wire_type="google_compute_beta_region_instant_snapshot",
    fields={
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaRegionInstantSnapshot_ParamsFields,
        ),
        "region": ubx.FieldSpec(wire_name="region"),
        "resource_status": ubx.FieldSpec(
            wire_name="resource_status",
            kind="object",
            fields=_BetaRegionInstantSnapshot_ResourceStatusFields,
        ),
