...
class AlphaComputeAlphaFirewall_Allowed:
    ipprotocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaFirewall_LogConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaFirewall_Params:
...
@dataclasses.dataclass
class AlphaComputeAlphaFirewallAttrs:
    # The list of ALLOW rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a permitted connection.
    allowed: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
AlphaComputeAlphaFirewall = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_firewall",
    fields={
        "allowed": ubx.FieldSpec(
            wire_name="allowed",
            kind="list",
            fields=_AlphaComputeAlphaFirewall_AllowedFields,
        ),
        ...
        "log_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaFirewall_LogConfigFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaComputeAlphaFirewall_ParamsFields,
        ),
