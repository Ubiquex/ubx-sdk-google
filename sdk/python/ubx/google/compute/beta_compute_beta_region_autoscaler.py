...
class BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_CpuUtilization:
...
@dataclasses.dataclass
class BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_CustomMetricUtilizations:
    filter: Any = None
    metric: Any = None
...
@dataclasses.dataclass
class BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_LoadBalancingUtilization:
    # Fraction of backend capacity utilization (set in HTTP(S) load balancing configuration) that the autoscaler maintains. Must be a positive float value. If not defined, the default is 0.8.
    utilization_target: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas:
...
@dataclasses.dataclass
class BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl:
...
@dataclasses.dataclass
class BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_ScaleInControl:
    # Encapsulates numeric value that can be either absolute or relative.
...
@dataclasses.dataclass
class BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_ScalingSchedules:
...
@dataclasses.dataclass
class BetaComputeBetaRegionAutoscaler_AutoscalingPolicy:
...
@dataclasses.dataclass
class BetaComputeBetaRegionAutoscaler_ScalingScheduleStatus:
    last_start_time: Any = None
    next_start_time: Any = None
    state: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionAutoscaler_StatusDetails:
    message: Any = None
    type: Any = None

_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_CpuUtilizationFields = {
    "predictive_method": ubx.FieldSpec(wire_name="predictive_method"),
    "utilization_target": ubx.FieldSpec(wire_name="utilization_target"),
}

_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_CustomMetricUtilizationsFields = {
...
_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_LoadBalancingUtilizationFields = {
    "utilization_target": ubx.FieldSpec(wire_name="utilization_target"),
}

_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicasFields = {
    "calculated": ubx.FieldSpec(wire_name="calculated"),
    "fixed": ubx.FieldSpec(wire_name="fixed"),
    "percent": ubx.FieldSpec(wire_name="percent"),
}

_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControlFields = {
    "max_scaled_down_replicas": ubx.FieldSpec(
        wire_name="max_scaled_down_replicas",
        kind="object",
        fields=_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicasFields,
    ),
    "time_window_sec": ubx.FieldSpec(wire_name="time_window_sec"),
}

_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_ScaleInControlFields = {
...
_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_ScalingSchedulesFields = {
...
_BetaComputeBetaRegionAutoscaler_AutoscalingPolicyFields = {
    "cool_down_period_sec": ubx.FieldSpec(wire_name="cool_down_period_sec"),
    "cpu_utilization": ubx.FieldSpec(
        wire_name="cpu_utilization",
        kind="object",
        fields=_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_CpuUtilizationFields,
    ),
    "custom_metric_utilizations": ubx.FieldSpec(
        wire_name="custom_metric_utilizations",
        kind="list",
        fields=_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_CustomMetricUtilizationsFields,
    ),
    "load_balancing_utilization": ubx.FieldSpec(
        wire_name="load_balancing_utilization",
        kind="object",
        fields=_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_LoadBalancingUtilizationFields,
    ),
    ...
    "scale_down_control": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControlFields,
    ),
    "scale_in_control": ubx.FieldSpec(
        wire_name="scale_in_control",
        kind="object",
        fields=_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_ScaleInControlFields,
    ),
    "scaling_schedules": ubx.FieldSpec(
        wire_name="scaling_schedules",
        kind="map",
        fields=_BetaComputeBetaRegionAutoscaler_AutoscalingPolicy_ScalingSchedulesFields,
    ),
    "stabilization_period_sec": ubx.FieldSpec(wire_name="stabilization_period_sec"),
}

_BetaComputeBetaRegionAutoscaler_ScalingScheduleStatusFields = {
    "last_start_time": ubx.FieldSpec(wire_name="last_start_time"),
    "next_start_time": ubx.FieldSpec(wire_name="next_start_time"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_BetaComputeBetaRegionAutoscaler_StatusDetailsFields = {
    "message": ubx.FieldSpec(wire_name="message"),
    "type": ubx.FieldSpec(wire_name="type"),
}

@dataclasses.dataclass
class BetaComputeBetaRegionAutoscalerConfig:
...
@dataclasses.dataclass
class BetaComputeBetaRegionAutoscalerAttrs:
    # Cloud Autoscaler policy.
    autoscaling_policy: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaComputeBetaRegionAutoscaler = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_region_autoscaler",
    fields={
        "autoscaling_policy": ubx.FieldSpec(
            wire_name="autoscaling_policy",
            kind="object",
            fields=_BetaComputeBetaRegionAutoscaler_AutoscalingPolicyFields,
        ),
        ...
        "scaling_schedule_status": ubx.FieldSpec(
            ...
            kind="map",
            fields=_BetaComputeBetaRegionAutoscaler_ScalingScheduleStatusFields,
        ),
        ...
        "status_details": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaRegionAutoscaler_StatusDetailsFields,
        ),
