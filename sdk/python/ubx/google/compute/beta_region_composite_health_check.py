# Code generated by `ubx sdk gen` from google_compute_beta_region_composite_health_check. DO NOT EDIT.
...
class BetaRegionCompositeHealthCheckConfig:
...
@dataclasses.dataclass
class BetaRegionCompositeHealthCheckAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
BetaRegionCompositeHealthCheck = ubx.ResourceBinding(
    wire_type="google_compute_beta_region_composite_health_check",
    fields={
