...
class AlphaRegionUrlMap_DefaultCustomErrorResponsePolicy_ErrorResponseRules:
    match_response_codes: Any = None
    override_response_code: Any = None
    path: Any = None

@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultCustomErrorResponsePolicy:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_CachePolicy_CacheKeyPolicy:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_CachePolicy_ClientTtl:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_CachePolicy_NegativeCachingPolicy:
    code: Any = None
    ttl: Any = None

@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_CachePolicy:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_CorsPolicy:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_DynamicCompressionPolicy:
    # Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header.
    compression_mode: Any = None

@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy_Abort:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy_Delay:
    # A Duration represents a fixed-length span of time represented as a count of seconds and fractions of seconds at nanosecond resolution. It is independent of any calendar and concepts like "day" or "month". Range is approximately 10,000 years.
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_ImageOptimizationPolicy:
    # Specifies whether to interpret query parameters for image optimization.
    query_parameter_interpretation: Any = None

@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_RequestMirrorPolicy:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_RetryPolicy:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_UrlRewrite_RegexRewrite:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_UrlRewrite:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderAction_RequestHeadersToAdd:
    header_name: Any = None
    header_value: Any = None
    replace: Any = None

@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderAction:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServices:
    backend_service: Any = None
    header_action: Any = None
    weight: Any = None

@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultRouteAction:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_DefaultUrlRedirect:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_HostRules:
    description: Any = None
    hosts: Any = None
    path_matcher: Any = None

@dataclasses.dataclass
class AlphaRegionUrlMap_PathMatchers_PathRules:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_PathMatchers_RouteRules_HttpFilterConfigs:
    config: Any = None
    config_type_url: Any = None
    filter_name: Any = None

@dataclasses.dataclass
class AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatches_RangeMatch:
    range_end: Any = None
    range_start: Any = None

@dataclasses.dataclass
class AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatches:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFilters_FilterLabels:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFilters:
    filter_labels: Any = None
    filter_match_criteria: Any = None

@dataclasses.dataclass
class AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_QueryParameterMatches:
    exact_match: Any = None
    name: Any = None
    present_match: Any = None
    regex_match: Any = None
...
@dataclasses.dataclass
class AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_PathMatchers_RouteRules:
    custom_error_response_policy: Any = None
    description: Any = None
    header_action: Any = None
...
@dataclasses.dataclass
class AlphaRegionUrlMap_PathMatchers:
...
@dataclasses.dataclass
class AlphaRegionUrlMap_Status_QuotaUsage:
...
_AlphaRegionUrlMap_DefaultCustomErrorResponsePolicy_ErrorResponseRulesFields = {
...
_AlphaRegionUrlMap_DefaultCustomErrorResponsePolicyFields = {
    "error_response_rules": ubx.FieldSpec(
        wire_name="error_response_rules",
        kind="list",
        fields=_AlphaRegionUrlMap_DefaultCustomErrorResponsePolicy_ErrorResponseRulesFields,
    ),
    "error_service": ubx.FieldSpec(wire_name="error_service"),
}

_AlphaRegionUrlMap_DefaultRouteAction_CachePolicy_CacheKeyPolicyFields = {
...
_AlphaRegionUrlMap_DefaultRouteAction_CachePolicy_ClientTtlFields = {
    "nanos": ubx.FieldSpec(wire_name="nanos"),
    "seconds": ubx.FieldSpec(wire_name="seconds"),
}

_AlphaRegionUrlMap_DefaultRouteAction_CachePolicy_NegativeCachingPolicyFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "ttl": ubx.FieldSpec(
        wire_name="ttl",
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_CachePolicy_ClientTtlFields,
    ),
}

_AlphaRegionUrlMap_DefaultRouteAction_CachePolicyFields = {
    ...
    "cache_key_policy": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_CachePolicy_CacheKeyPolicyFields,
    ),
    ...
    "negative_caching_policy": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_CachePolicy_NegativeCachingPolicyFields,
    ),
...
_AlphaRegionUrlMap_DefaultRouteAction_CorsPolicyFields = {
...
_AlphaRegionUrlMap_DefaultRouteAction_DynamicCompressionPolicyFields = {
    "compression_mode": ubx.FieldSpec(wire_name="compression_mode"),
}

_AlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy_AbortFields = {
    "http_status": ubx.FieldSpec(wire_name="http_status"),
    "percentage": ubx.FieldSpec(wire_name="percentage"),
}

_AlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy_DelayFields = {
...
_AlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicyFields = {
    "abort": ubx.FieldSpec(
        wire_name="abort",
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy_AbortFields,
    ),
    "delay": ubx.FieldSpec(
        wire_name="delay",
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicy_DelayFields,
    ),
}

_AlphaRegionUrlMap_DefaultRouteAction_ImageOptimizationPolicyFields = {
    "query_parameter_interpretation": ubx.FieldSpec(wire_name="query_parameter_interpretation"),
}

_AlphaRegionUrlMap_DefaultRouteAction_RequestMirrorPolicyFields = {
    "backend_service": ubx.FieldSpec(wire_name="backend_service"),
    "mirror_percent": ubx.FieldSpec(wire_name="mirror_percent"),
}

_AlphaRegionUrlMap_DefaultRouteAction_RetryPolicyFields = {
...
_AlphaRegionUrlMap_DefaultRouteAction_UrlRewrite_RegexRewriteFields = {
    "path_pattern": ubx.FieldSpec(wire_name="path_pattern"),
    "path_substitution": ubx.FieldSpec(wire_name="path_substitution"),
}

_AlphaRegionUrlMap_DefaultRouteAction_UrlRewriteFields = {
    ...
    "regex_rewrite": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_UrlRewrite_RegexRewriteFields,
    ),
}

_AlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderAction_RequestHeadersToAddFields = {
...
_AlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderActionFields = {
    "request_headers_to_add": ubx.FieldSpec(
        wire_name="request_headers_to_add",
        kind="list",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderAction_RequestHeadersToAddFields,
    ),
...
_AlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServicesFields = {
    "backend_service": ubx.FieldSpec(wire_name="backend_service"),
    "header_action": ubx.FieldSpec(
        wire_name="header_action",
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServices_HeaderActionFields,
    ),
    "weight": ubx.FieldSpec(wire_name="weight"),
}

_AlphaRegionUrlMap_DefaultRouteActionFields = {
    "cache_policy": ubx.FieldSpec(
        wire_name="cache_policy",
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_CachePolicyFields,
    ),
    "cors_policy": ubx.FieldSpec(
        wire_name="cors_policy",
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_CorsPolicyFields,
    ),
    "dynamic_compression_policy": ubx.FieldSpec(
        wire_name="dynamic_compression_policy",
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_DynamicCompressionPolicyFields,
    ),
    "fault_injection_policy": ubx.FieldSpec(
        wire_name="fault_injection_policy",
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_FaultInjectionPolicyFields,
    ),
    "image_optimization_policy": ubx.FieldSpec(
        wire_name="image_optimization_policy",
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_ImageOptimizationPolicyFields,
    ),
    ...
    "request_mirror_policy": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_RequestMirrorPolicyFields,
    ),
    "retry_policy": ubx.FieldSpec(
        wire_name="retry_policy",
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_RetryPolicyFields,
    ),
    ...
    "url_rewrite": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_UrlRewriteFields,
    ),
    "weighted_backend_services": ubx.FieldSpec(
        wire_name="weighted_backend_services",
        kind="list",
        fields=_AlphaRegionUrlMap_DefaultRouteAction_WeightedBackendServicesFields,
    ),
}

_AlphaRegionUrlMap_DefaultUrlRedirectFields = {
...
_AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatches_RangeMatchFields = {
    "range_end": ubx.FieldSpec(wire_name="range_end"),
    "range_start": ubx.FieldSpec(wire_name="range_start"),
}

_AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatchesFields = {
    ...
    "range_match": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatches_RangeMatchFields,
    ),
    "regex_match": ubx.FieldSpec(wire_name="regex_match"),
    "suffix_match": ubx.FieldSpec(wire_name="suffix_match"),
}

_AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFilters_FilterLabelsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFiltersFields = {
    "filter_labels": ubx.FieldSpec(
        wire_name="filter_labels",
        kind="list",
        fields=_AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFilters_FilterLabelsFields,
    ),
    "filter_match_criteria": ubx.FieldSpec(wire_name="filter_match_criteria"),
}

_AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_QueryParameterMatchesFields = {
    "exact_match": ubx.FieldSpec(wire_name="exact_match"),
    "name": ubx.FieldSpec(wire_name="name"),
    "present_match": ubx.FieldSpec(wire_name="present_match"),
    "regex_match": ubx.FieldSpec(wire_name="regex_match"),
...
_AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRulesFields = {
    "full_path_match": ubx.FieldSpec(wire_name="full_path_match"),
    "header_matches": ubx.FieldSpec(
        wire_name="header_matches",
        kind="list",
        fields=_AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_HeaderMatchesFields,
    ),
    "ignore_case": ubx.FieldSpec(wire_name="ignore_case"),
    "metadata_filters": ubx.FieldSpec(
        wire_name="metadata_filters",
        kind="list",
        fields=_AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_MetadataFiltersFields,
    ),
    ...
    "query_parameter_matches": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRules_QueryParameterMatchesFields,
    ),
    "regex_match": ubx.FieldSpec(wire_name="regex_match"),
}

_AlphaRegionUrlMap_PathMatchers_RouteRulesFields = {
    "custom_error_response_policy": ubx.FieldSpec(
        wire_name="custom_error_response_policy",
        kind="object",
        fields=_AlphaRegionUrlMap_DefaultCustomErrorResponsePolicyFields,
    ...
    "http_filter_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaRegionUrlMap_PathMatchers_RouteRules_HttpFilterConfigsFields,
    ),
    ...
    "match_rules": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaRegionUrlMap_PathMatchers_RouteRules_MatchRulesFields,
    ),
...
_AlphaRegionUrlMap_PathMatchersFields = {
    ...
    "path_rules": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaRegionUrlMap_PathMatchers_PathRulesFields,
    ),
    "route_rules": ubx.FieldSpec(
        wire_name="route_rules",
        kind="list",
        fields=_AlphaRegionUrlMap_PathMatchers_RouteRulesFields,
    ),
}

_AlphaRegionUrlMap_Status_QuotaUsageFields = {
    "forwarding_rules": ubx.FieldSpec(wire_name="forwarding_rules"),
    "units": ubx.FieldSpec(wire_name="units"),
}

_AlphaRegionUrlMap_StatusFields = {
    "quota_usage": ubx.FieldSpec(
        wire_name="quota_usage",
        kind="object",
        fields=_AlphaRegionUrlMap_Status_QuotaUsageFields,
    ),
}

_AlphaRegionUrlMap_TestsFields = {
...
AlphaRegionUrlMap = ubx.ResourceBinding(
    wire_type="google_compute_alpha_region_url_map",
    fields={
        "default_custom_error_response_policy": ubx.FieldSpec(
            wire_name="default_custom_error_response_policy",
            kind="object",
        ...
        "host_rules": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaRegionUrlMap_HostRulesFields,
        ),
        ...
        "path_matchers": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaRegionUrlMap_PathMatchersFields,
        ),
        "self_link": ubx.FieldSpec(wire_name="self_link"),
        "status": ubx.FieldSpec(
            wire_name="status",
            kind="object",
            fields=_AlphaRegionUrlMap_StatusFields,
        ),
        "tests": ubx.FieldSpec(
            wire_name="tests",
            kind="list",
            fields=_AlphaRegionUrlMap_TestsFields,
        ),
    },
)
