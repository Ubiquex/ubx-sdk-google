...
class AlphaWireGroup_Endpoints_Interconnects:
    interconnect: Any = None
    vlan_tags: Any = None

@dataclasses.dataclass
class AlphaWireGroup_Endpoints:
    interconnects: Any = None

@dataclasses.dataclass
class AlphaWireGroup_ServiceLevel:
...
@dataclasses.dataclass
class AlphaWireGroup_Topology_Endpoints:
    city: Any = None
    label: Any = None

@dataclasses.dataclass
class AlphaWireGroup_Topology:
    # Output only. Topology details for all endpoints in the wire group.
    endpoints: Any = None

@dataclasses.dataclass
class AlphaWireGroup_WireGroupProperties:
...
@dataclasses.dataclass
class AlphaWireGroup_WireInputs_WirePropertyOverrides:
...
@dataclasses.dataclass
class AlphaWireGroup_WireInputs:
    admin_enabled: Any = None
    wire_property_overrides: Any = None

@dataclasses.dataclass
class AlphaWireGroup_Wires_Endpoints:
    interconnect: Any = None
    vlan_tag: Any = None

@dataclasses.dataclass
class AlphaWireGroup_Wires:
    admin_enabled: Any = None
    endpoints: Any = None
    label: Any = None
    wire_properties: Any = None

_AlphaWireGroup_Endpoints_InterconnectsFields = {
    "interconnect": ubx.FieldSpec(wire_name="interconnect"),
    "vlan_tags": ubx.FieldSpec(wire_name="vlan_tags"),
}

_AlphaWireGroup_EndpointsFields = {
    "interconnects": ubx.FieldSpec(
        wire_name="interconnects",
        kind="map",
        fields=_AlphaWireGroup_Endpoints_InterconnectsFields,
    ),
}

_AlphaWireGroup_ServiceLevelFields = {
    "availability_class": ubx.FieldSpec(wire_name="availability_class"),
}

_AlphaWireGroup_Topology_EndpointsFields = {
    "city": ubx.FieldSpec(wire_name="city"),
    "label": ubx.FieldSpec(wire_name="label"),
}

_AlphaWireGroup_TopologyFields = {
    "endpoints": ubx.FieldSpec(
        wire_name="endpoints",
        kind="list",
        fields=_AlphaWireGroup_Topology_EndpointsFields,
    ),
}

_AlphaWireGroup_WireGroupPropertiesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_AlphaWireGroup_WireInputs_WirePropertyOverridesFields = {
...
_AlphaWireGroup_WireInputsFields = {
    ...
    "wire_property_overrides": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaWireGroup_WireInputs_WirePropertyOverridesFields,
    ),
}

_AlphaWireGroup_Wires_EndpointsFields = {
    "interconnect": ubx.FieldSpec(wire_name="interconnect"),
    "vlan_tag": ubx.FieldSpec(wire_name="vlan_tag"),
}

_AlphaWireGroup_WiresFields = {
    "admin_enabled": ubx.FieldSpec(wire_name="admin_enabled"),
    "endpoints": ubx.FieldSpec(
        wire_name="endpoints",
        kind="list",
        fields=_AlphaWireGroup_Wires_EndpointsFields,
    ),
    "label": ubx.FieldSpec(wire_name="label"),
...
AlphaWireGroup = ubx.ResourceBinding(
    wire_type="google_compute_alpha_wire_group",
    fields={
        "admin_enabled": ubx.FieldSpec(wire_name="admin_enabled"),
        ...
        "endpoints": ubx.FieldSpec(
            wire_name="endpoints",
            kind="map",
            fields=_AlphaWireGroup_EndpointsFields,
        ),
        ...
        "service_level": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaWireGroup_ServiceLevelFields,
        ),
        "topology": ubx.FieldSpec(
            wire_name="topology",
            kind="object",
            fields=_AlphaWireGroup_TopologyFields,
        ),
        "wire_group_properties": ubx.FieldSpec(
            wire_name="wire_group_properties",
            kind="object",
            fields=_AlphaWireGroup_WireGroupPropertiesFields,
        ),
        "wire_inputs": ubx.FieldSpec(
            wire_name="wire_inputs",
            kind="map",
            fields=_AlphaWireGroup_WireInputsFields,
        ),
        "wire_properties": ubx.FieldSpec(
            wire_name="wire_properties",
            kind="object",
        ...
        "wires": ubx.FieldSpec(
            wire_name="wires",
            kind="list",
            fields=_AlphaWireGroup_WiresFields,
        ),
    },
)
