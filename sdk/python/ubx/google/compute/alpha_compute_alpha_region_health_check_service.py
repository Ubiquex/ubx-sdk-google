# Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_region_health_check_service. DO NOT EDIT.
...
class AlphaComputeAlphaRegionHealthCheckServiceConfig:
    ...
    health_status_aggregation_strategy: Any = None
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionHealthCheckServiceAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
AlphaComputeAlphaRegionHealthCheckService = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_region_health_check_service",
    fields={
        ...
        "health_status_aggregation_strategy": ubx.FieldSpec(wire_name="health_status_aggregation_strategy"),
