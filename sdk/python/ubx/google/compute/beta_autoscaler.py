...
class BetaAutoscaler_AutoscalingPolicy_CpuUtilization:
...
@dataclasses.dataclass
class BetaAutoscaler_AutoscalingPolicy_CustomMetricUtilizations:
    filter: Any = None
    metric: Any = None
...
@dataclasses.dataclass
class BetaAutoscaler_AutoscalingPolicy_LoadBalancingUtilization:
    # Fraction of backend capacity utilization (set in HTTP(S) load balancing configuration) that the autoscaler maintains. Must be a positive float value. If not defined, the default is 0.8.
    utilization_target: Any = None

@dataclasses.dataclass
class BetaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas:
...
@dataclasses.dataclass
class BetaAutoscaler_AutoscalingPolicy_ScaleDownControl:
...
@dataclasses.dataclass
class BetaAutoscaler_AutoscalingPolicy_ScaleInControl:
    # Encapsulates numeric value that can be either absolute or relative.
...
@dataclasses.dataclass
class BetaAutoscaler_AutoscalingPolicy_ScalingSchedules:
...
@dataclasses.dataclass
class BetaAutoscaler_AutoscalingPolicy:
...
@dataclasses.dataclass
class BetaAutoscaler_ScalingScheduleStatus:
    last_start_time: Any = None
    next_start_time: Any = None
    state: Any = None

@dataclasses.dataclass
class BetaAutoscaler_StatusDetails:
    message: Any = None
    type: Any = None

_BetaAutoscaler_AutoscalingPolicy_CpuUtilizationFields = {
    "predictive_method": ubx.FieldSpec(wire_name="predictive_method"),
    "utilization_target": ubx.FieldSpec(wire_name="utilization_target"),
}

_BetaAutoscaler_AutoscalingPolicy_CustomMetricUtilizationsFields = {
...
_BetaAutoscaler_AutoscalingPolicy_LoadBalancingUtilizationFields = {
    "utilization_target": ubx.FieldSpec(wire_name="utilization_target"),
}

_BetaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicasFields = {
    "calculated": ubx.FieldSpec(wire_name="calculated"),
    "fixed": ubx.FieldSpec(wire_name="fixed"),
    "percent": ubx.FieldSpec(wire_name="percent"),
}

_BetaAutoscaler_AutoscalingPolicy_ScaleDownControlFields = {
    "max_scaled_down_replicas": ubx.FieldSpec(
        wire_name="max_scaled_down_replicas",
        kind="object",
        fields=_BetaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicasFields,
    ),
    "time_window_sec": ubx.FieldSpec(wire_name="time_window_sec"),
}

_BetaAutoscaler_AutoscalingPolicy_ScaleInControlFields = {
...
_BetaAutoscaler_AutoscalingPolicy_ScalingSchedulesFields = {
...
BetaAutoscaler = ubx.ResourceBinding(
    wire_type="google_compute_beta_autoscaler",
    fields={
        "autoscaling_policy": ubx.FieldSpec(
            wire_name="autoscaling_policy",
            kind="object",
            fields=_BetaAutoscaler_AutoscalingPolicyFields,
        ),
        ...
        "scaling_schedule_status": ubx.FieldSpec(
            ...
            kind="map",
            fields=_BetaAutoscaler_ScalingScheduleStatusFields,
        ),
        ...
        "status_details": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaAutoscaler_StatusDetailsFields,
        ),
