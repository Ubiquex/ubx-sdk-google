...
class BetaComputeBetaNodeTemplate_Accelerators:
    accelerator_count: Any = None
    accelerator_type: Any = None

@dataclasses.dataclass
class BetaComputeBetaNodeTemplate_Disks:
    disk_count: Any = None
    disk_size_gb: Any = None
    disk_type: Any = None

@dataclasses.dataclass
class BetaComputeBetaNodeTemplate_NodeTypeFlexibility:
    cpus: Any = None
    local_ssd: Any = None
    memory: Any = None

@dataclasses.dataclass
class BetaComputeBetaNodeTemplate_ServerBinding:
    type: Any = None

_BetaComputeBetaNodeTemplate_AcceleratorsFields = {
    "accelerator_count": ubx.FieldSpec(wire_name="accelerator_count"),
    "accelerator_type": ubx.FieldSpec(wire_name="accelerator_type"),
}

_BetaComputeBetaNodeTemplate_DisksFields = {
...
_BetaComputeBetaNodeTemplate_NodeTypeFlexibilityFields = {
    "cpus": ubx.FieldSpec(wire_name="cpus"),
    "local_ssd": ubx.FieldSpec(wire_name="local_ssd"),
    "memory": ubx.FieldSpec(wire_name="memory"),
}

_BetaComputeBetaNodeTemplate_ServerBindingFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

@dataclasses.dataclass
class BetaComputeBetaNodeTemplateConfig:
...
@dataclasses.dataclass
class BetaComputeBetaNodeTemplateAttrs:
    accelerators: Any = None
    # CPU overcommit.
    cpu_overcommit_type: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
...
BetaComputeBetaNodeTemplate = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_node_template",
    fields={
        "accelerators": ubx.FieldSpec(
            wire_name="accelerators",
            kind="list",
            fields=_BetaComputeBetaNodeTemplate_AcceleratorsFields,
        ),
        ...
        "disks": ubx.FieldSpec(
            wire_name="disks",
            kind="list",
            fields=_BetaComputeBetaNodeTemplate_DisksFields,
        ),
        ...
        "node_type_flexibility": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaNodeTemplate_NodeTypeFlexibilityFields,
        ),
        ...
        "server_binding": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaNodeTemplate_ServerBindingFields,
        ),
