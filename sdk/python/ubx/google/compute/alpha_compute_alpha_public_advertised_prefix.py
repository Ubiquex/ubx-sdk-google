...
class AlphaComputeAlphaPublicAdvertisedPrefix_PublicDelegatedPrefixs:
    ip_range: Any = None
    name: Any = None
    project: Any = None
    region: Any = None
...
_AlphaComputeAlphaPublicAdvertisedPrefix_PublicDelegatedPrefixsFields = {
...
@dataclasses.dataclass
class AlphaComputeAlphaPublicAdvertisedPrefixConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaPublicAdvertisedPrefixAttrs:
    # Output only. [Output Only] The version of BYOIP API.
    byoip_api_version: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
AlphaComputeAlphaPublicAdvertisedPrefix = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_public_advertised_prefix",
    fields={
        ...
        "public_delegated_prefixs": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaComputeAlphaPublicAdvertisedPrefix_PublicDelegatedPrefixsFields,
        ),
