...
class AlphaComputeAlphaImage_Deprecated_StateOverride:
...
@dataclasses.dataclass
class AlphaComputeAlphaImage_Deprecated:
...
@dataclasses.dataclass
class AlphaComputeAlphaImage_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaImage_ImageEncryptionKey:
...
@dataclasses.dataclass
class AlphaComputeAlphaImage_Params:
...
@dataclasses.dataclass
class AlphaComputeAlphaImage_RawDisk:
...
@dataclasses.dataclass
class AlphaComputeAlphaImage_ShieldedInstanceInitialState_Dbs:
    content: Any = None
    file_type: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaImage_ShieldedInstanceInitialState:
    # The Key Database (db).
    dbs: Any = None
...
_AlphaComputeAlphaImage_Deprecated_StateOverrideFields = {
    "default_rollout_time": ubx.FieldSpec(wire_name="default_rollout_time"),
    "location_rollout_policies": ubx.FieldSpec(wire_name="location_rollout_policies"),
}

_AlphaComputeAlphaImage_DeprecatedFields = {
    ...
    "state_override": ubx.FieldSpec(
        wire_name="state_override",
        kind="object",
        fields=_AlphaComputeAlphaImage_Deprecated_StateOverrideFields,
    ),
}

_AlphaComputeAlphaImage_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_AlphaComputeAlphaImage_ImageEncryptionKeyFields = {
...
_AlphaComputeAlphaImage_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaComputeAlphaImage_RawDiskFields = {
...
_AlphaComputeAlphaImage_ShieldedInstanceInitialState_DbsFields = {
    "content": ubx.FieldSpec(wire_name="content"),
    "file_type": ubx.FieldSpec(wire_name="file_type"),
}

_AlphaComputeAlphaImage_ShieldedInstanceInitialStateFields = {
    "dbs": ubx.FieldSpec(
        wire_name="dbs",
        kind="list",
        fields=_AlphaComputeAlphaImage_ShieldedInstanceInitialState_DbsFields,
    ),
    "dbxs": ubx.FieldSpec(
        wire_name="dbxs",
        kind="list",
...
@dataclasses.dataclass
class AlphaComputeAlphaImageConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaImageAttrs:
    # The architecture of the image. Valid values are ARM64 or X86_64.
    architecture: Any = None
    # Size of the image tar.gz archive stored in Google Cloud Storage (in bytes).
    archive_size_bytes: Any = None
...
AlphaComputeAlphaImage = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_image",
    fields={
        ...
        "deprecated": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaImage_DeprecatedFields,
        ),
        ...
        "guest_os_features": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaComputeAlphaImage_GuestOsFeaturesFields,
        ),
        "id": ubx.FieldSpec(wire_name="id"),
        "image_encryption_key": ubx.FieldSpec(
            wire_name="image_encryption_key",
            kind="object",
            fields=_AlphaComputeAlphaImage_ImageEncryptionKeyFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaComputeAlphaImage_ParamsFields,
        ),
        "raw_disk": ubx.FieldSpec(
            wire_name="raw_disk",
            kind="object",
            fields=_AlphaComputeAlphaImage_RawDiskFields,
        ),
        "rollout_override": ubx.FieldSpec(
            wire_name="rollout_override",
            kind="object",
            fields=_AlphaComputeAlphaImage_Deprecated_StateOverrideFields,
        ),
        ...
        "shielded_instance_initial_state": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaImage_ShieldedInstanceInitialStateFields,
        ),
