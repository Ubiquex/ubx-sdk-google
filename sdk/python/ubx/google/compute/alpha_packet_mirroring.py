...
class AlphaPacketMirroring_CollectorIlb:
...
@dataclasses.dataclass
class AlphaPacketMirroring_Filter:
...
@dataclasses.dataclass
class AlphaPacketMirroring_MirroredResources:
...
_AlphaPacketMirroring_MirroredResourcesFields = {
    "instances": ubx.FieldSpec(
        wire_name="instances",
        kind="list",
        fields=_AlphaPacketMirroring_CollectorIlbFields,
    ),
...
@dataclasses.dataclass
class AlphaPacketMirroringConfig:
...
@dataclasses.dataclass
class AlphaPacketMirroringAttrs:
    collector_ilb: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
...
AlphaPacketMirroring = ubx.ResourceBinding(
    wire_type="google_compute_alpha_packet_mirroring",
    fields={
        ...
        "filter": ubx.FieldSpec(
            wire_name="filter",
            kind="object",
            fields=_AlphaPacketMirroring_FilterFields,
        ),
        ...
        "mirrored_resources": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaPacketMirroring_MirroredResourcesFields,
        ),
