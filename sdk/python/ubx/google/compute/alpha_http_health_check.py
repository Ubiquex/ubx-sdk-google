...
class AlphaHttpHealthCheckConfig:
...
@dataclasses.dataclass
class AlphaHttpHealthCheckAttrs:
    # How often (in seconds) to send a health check. The default value is5 seconds.
    check_interval_sec: Any = None
    # [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
AlphaHttpHealthCheck = ubx.ResourceBinding(
    wire_type="google_compute_alpha_http_health_check",
    fields={
