...
class BetaComputeBetaImage_Deprecated_StateOverride:
...
@dataclasses.dataclass
class BetaComputeBetaImage_Deprecated:
...
@dataclasses.dataclass
class BetaComputeBetaImage_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class BetaComputeBetaImage_ImageEncryptionKey:
...
@dataclasses.dataclass
class BetaComputeBetaImage_Params:
...
@dataclasses.dataclass
class BetaComputeBetaImage_RawDisk:
...
@dataclasses.dataclass
class BetaComputeBetaImage_ShieldedInstanceInitialState_Dbs:
    content: Any = None
    file_type: Any = None

@dataclasses.dataclass
class BetaComputeBetaImage_ShieldedInstanceInitialState:
    # The Key Database (db).
    dbs: Any = None
...
_BetaComputeBetaImage_Deprecated_StateOverrideFields = {
...
_BetaComputeBetaImage_DeprecatedFields = {
    ...
    "state_override": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaComputeBetaImage_Deprecated_StateOverrideFields,
    ),
}

_BetaComputeBetaImage_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_BetaComputeBetaImage_ImageEncryptionKeyFields = {
...
_BetaComputeBetaImage_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaImage_RawDiskFields = {
...
_BetaComputeBetaImage_ShieldedInstanceInitialState_DbsFields = {
    "content": ubx.FieldSpec(wire_name="content"),
    "file_type": ubx.FieldSpec(wire_name="file_type"),
}

_BetaComputeBetaImage_ShieldedInstanceInitialStateFields = {
    "dbs": ubx.FieldSpec(
        wire_name="dbs",
        kind="list",
        fields=_BetaComputeBetaImage_ShieldedInstanceInitialState_DbsFields,
    ),
    "dbxs": ubx.FieldSpec(
        wire_name="dbxs",
        kind="list",
...
@dataclasses.dataclass
class BetaComputeBetaImageConfig:
...
@dataclasses.dataclass
class BetaComputeBetaImageAttrs:
    # The architecture of the image. Valid values are ARM64 or X86_64.
    architecture: Any = None
    # Size of the image tar.gz archive stored in Google Cloud Storage (in bytes).
    archive_size_bytes: Any = None
...
BetaComputeBetaImage = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_image",
    fields={
        ...
        "deprecated": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaImage_DeprecatedFields,
        ),
        ...
        "guest_os_features": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaImage_GuestOsFeaturesFields,
        ),
        "id": ubx.FieldSpec(wire_name="id"),
        "image_encryption_key": ubx.FieldSpec(
            wire_name="image_encryption_key",
            kind="object",
            fields=_BetaComputeBetaImage_ImageEncryptionKeyFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaImage_ParamsFields,
        ),
        "raw_disk": ubx.FieldSpec(
            wire_name="raw_disk",
            kind="object",
            fields=_BetaComputeBetaImage_RawDiskFields,
        ),
        ...
        "shielded_instance_initial_state": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaImage_ShieldedInstanceInitialStateFields,
        ),
