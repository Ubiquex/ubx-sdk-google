...
class AlphaStoragePool_ExapoolProvisionedCapacityGb:
...
@dataclasses.dataclass
class AlphaStoragePool_ResourceStatus:
...
@dataclasses.dataclass
class AlphaStoragePool_ShareSettings_ProjectMap:
    project_id: Any = None

@dataclasses.dataclass
class AlphaStoragePool_ShareSettings:
    # A map of project id and project config.
    project_map: Any = None

_AlphaStoragePool_ExapoolProvisionedCapacityGbFields = {
...
_AlphaStoragePool_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaStoragePool_ResourceStatusFields = {
...
_AlphaStoragePool_ShareSettings_ProjectMapFields = {
    "project_id": ubx.FieldSpec(wire_name="project_id"),
}

_AlphaStoragePool_ShareSettingsFields = {
    "project_map": ubx.FieldSpec(
        wire_name="project_map",
        kind="map",
        fields=_AlphaStoragePool_ShareSettings_ProjectMapFields,
    ),
}

@dataclasses.dataclass
class AlphaStoragePoolConfig:
...
AlphaStoragePool = ubx.ResourceBinding(
    wire_type="google_compute_alpha_storage_pool",
    fields={
        ...
        "exapool_provisioned_capacity_gb": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaStoragePool_ExapoolProvisionedCapacityGbFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaStoragePool_ParamsFields,
        ),
        ...
        "resource_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaStoragePool_ResourceStatusFields,
        ),
        ...
        "share_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaStoragePool_ShareSettingsFields,
        ),
