...
class AlphaRegionNetworkFirewallPolicy_Associations:
...
@dataclasses.dataclass
class AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs:
    ip_protocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags:
    name: Any = None
    state: Any = None

@dataclasses.dataclass
class AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match:
...
@dataclasses.dataclass
class AlphaRegionNetworkFirewallPolicy_PacketMirroringRules:
    action: Any = None
...
@dataclasses.dataclass
class AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutInput:
...
@dataclasses.dataclass
class AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_NextRollout:
...
@dataclasses.dataclass
class AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRollouts:
    rollout: Any = None
    rollout_plan: Any = None
    state: Any = None

@dataclasses.dataclass
class AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus:
...
@dataclasses.dataclass
class AlphaRegionNetworkFirewallPolicy_RolloutOperation:
...
_AlphaRegionNetworkFirewallPolicy_AssociationsFields = {
...
_AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields = {
    "ip_protocol": ubx.FieldSpec(wire_name="ip_protocol"),
    "ports": ubx.FieldSpec(wire_name="ports"),
}

_AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_MatchFields = {
    ...
    "layer4_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields,
    ),
    ...
    "src_secure_tags": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields,
    ),
    "src_threat_intelligences": ubx.FieldSpec(wire_name="src_threat_intelligences"),
}

_AlphaRegionNetworkFirewallPolicy_PacketMirroringRulesFields = {
    ...
    "match": ubx.FieldSpec(
        wire_name="match",
        kind="object",
        fields=_AlphaRegionNetworkFirewallPolicy_PacketMirroringRules_MatchFields,
    ),
    "priority": ubx.FieldSpec(wire_name="priority"),
...
_AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutInputFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "predefined_rollout_plan": ubx.FieldSpec(wire_name="predefined_rollout_plan"),
    "retry_uuid": ubx.FieldSpec(wire_name="retry_uuid"),
}

_AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_NextRolloutFields = {
    "rollout_id": ubx.FieldSpec(wire_name="rollout_id"),
    "rollout_plan": ubx.FieldSpec(wire_name="rollout_plan"),
}

_AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRolloutsFields = {
    "rollout": ubx.FieldSpec(wire_name="rollout"),
    "rollout_plan": ubx.FieldSpec(wire_name="rollout_plan"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatusFields = {
    "next_rollout": ubx.FieldSpec(
        wire_name="next_rollout",
        kind="object",
        fields=_AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_NextRolloutFields,
    ),
    "ongoing_rollouts": ubx.FieldSpec(
        wire_name="ongoing_rollouts",
        kind="list",
        fields=_AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRolloutsFields,
    ),
...
_AlphaRegionNetworkFirewallPolicy_RolloutOperationFields = {
    "rollout_input": ubx.FieldSpec(
        wire_name="rollout_input",
        kind="object",
        fields=_AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutInputFields,
    ),
    "rollout_status": ubx.FieldSpec(
        wire_name="rollout_status",
        kind="object",
        fields=_AlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatusFields,
    ),
}

@dataclasses.dataclass
class AlphaRegionNetworkFirewallPolicyConfig:
...
@dataclasses.dataclass
class AlphaRegionNetworkFirewallPolicyAttrs:
    # Optional. If specified, it defines what should happen in case of backend issues for rules with apply_security_profile_group action. Allowed values: ALLOW, DENY. If not specified, the default behavior is ALLOW.
    apply_security_profile_fallback_action: Any = None
    # A list of associations that belong to this firewall policy.
    associations: Any = None
...
AlphaRegionNetworkFirewallPolicy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_region_network_firewall_policy",
    fields={
        ...
        "associations": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaRegionNetworkFirewallPolicy_AssociationsFields,
        ),
        "description": ubx.FieldSpec(wire_name="description"),
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        ...
        "packet_mirroring_rules": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaRegionNetworkFirewallPolicy_PacketMirroringRulesFields,
        ),
        ...
        "rollout_operation": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaRegionNetworkFirewallPolicy_RolloutOperationFields,
        ),
        "rules": ubx.FieldSpec(
            wire_name="rules",
            kind="list",
