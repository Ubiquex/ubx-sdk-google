...
class AlphaComputeAlphaReservation_AdvancedDeploymentControl:
    # Indicates chosen reservation operational mode for the reservation.
    reservation_operational_mode: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaReservation_AggregateReservation_InUseResources_Accelerator:
    accelerator_count: Any = None
    accelerator_type: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaReservation_AggregateReservation_InUseResources:
    accelerator: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaReservation_AggregateReservation:
...
@dataclasses.dataclass
class AlphaComputeAlphaReservation_DeleteAfterDuration:
...
@dataclasses.dataclass
class AlphaComputeAlphaReservation_Params:
...
@dataclasses.dataclass
class AlphaComputeAlphaReservation_ReservationSharingPolicy:
    # Sharing config for all Google Cloud services.
    service_share_type: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaReservation_ResourceStatus_AggregateAllocation:
    # Per service utilization breakdown. The Key is the Google Cloud managed service name.
    utilizations: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaReservation_ResourceStatus_HealthInfo:
...
@dataclasses.dataclass
class AlphaComputeAlphaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenance_StartTimeWindow:
    earliest: Any = None
    latest: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenance:
...
@dataclasses.dataclass
class AlphaComputeAlphaReservation_ResourceStatus_ReservationMaintenance:
...
@dataclasses.dataclass
class AlphaComputeAlphaReservation_ResourceStatus_SpecificSkuAllocation:
...
@dataclasses.dataclass
class AlphaComputeAlphaReservation_ResourceStatus:
...
@dataclasses.dataclass
class AlphaComputeAlphaReservation_ShareSettings_FolderMap:
    folder_id: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaReservation_ShareSettings_ProjectMap:
    project_id: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaReservation_ShareSettings:
...
@dataclasses.dataclass
class AlphaComputeAlphaReservation_SpecificReservation_InstanceProperties_LocalSsds:
    disk_size_gb: Any = None
    interface: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaReservation_SpecificReservation_InstanceProperties:
...
@dataclasses.dataclass
class AlphaComputeAlphaReservation_SpecificReservation:
...
_AlphaComputeAlphaReservation_AdvancedDeploymentControlFields = {
    "reservation_operational_mode": ubx.FieldSpec(wire_name="reservation_operational_mode"),
}

_AlphaComputeAlphaReservation_AggregateReservation_InUseResources_AcceleratorFields = {
    "accelerator_count": ubx.FieldSpec(wire_name="accelerator_count"),
    "accelerator_type": ubx.FieldSpec(wire_name="accelerator_type"),
}

_AlphaComputeAlphaReservation_AggregateReservation_InUseResourcesFields = {
    "accelerator": ubx.FieldSpec(
        wire_name="accelerator",
        kind="object",
        fields=_AlphaComputeAlphaReservation_AggregateReservation_InUseResources_AcceleratorFields,
    ),
}

_AlphaComputeAlphaReservation_AggregateReservationFields = {
    ...
    "in_use_resources": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaComputeAlphaReservation_AggregateReservation_InUseResourcesFields,
    ),
...
_AlphaComputeAlphaReservation_DeleteAfterDurationFields = {
    "nanos": ubx.FieldSpec(wire_name="nanos"),
    "seconds": ubx.FieldSpec(wire_name="seconds"),
}

_AlphaComputeAlphaReservation_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaComputeAlphaReservation_ReservationSharingPolicyFields = {
    "service_share_type": ubx.FieldSpec(wire_name="service_share_type"),
}

_AlphaComputeAlphaReservation_ResourceStatus_AggregateAllocationFields = {
    "utilizations": ubx.FieldSpec(wire_name="utilizations"),
}

_AlphaComputeAlphaReservation_ResourceStatus_HealthInfoFields = {
...
_AlphaComputeAlphaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenance_StartTimeWindowFields = {
    "earliest": ubx.FieldSpec(wire_name="earliest"),
    "latest": ubx.FieldSpec(wire_name="latest"),
}

_AlphaComputeAlphaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenanceFields = {
    ...
    "start_time_window": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaComputeAlphaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenance_StartTimeWindowFields,
    ),
...
_AlphaComputeAlphaReservation_ResourceStatus_ReservationMaintenanceFields = {
    ...
    "upcoming_group_maintenance": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaComputeAlphaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenanceFields,
    ),
}

_AlphaComputeAlphaReservation_ResourceStatus_SpecificSkuAllocationFields = {
    "source_instance_template_id": ubx.FieldSpec(wire_name="source_instance_template_id"),
    "utilizations": ubx.FieldSpec(wire_name="utilizations"),
}

_AlphaComputeAlphaReservation_ResourceStatusFields = {
    "aggregate_allocation": ubx.FieldSpec(
        wire_name="aggregate_allocation",
        kind="object",
        fields=_AlphaComputeAlphaReservation_ResourceStatus_AggregateAllocationFields,
    ),
    "health_info": ubx.FieldSpec(
        wire_name="health_info",
        kind="object",
        fields=_AlphaComputeAlphaReservation_ResourceStatus_HealthInfoFields,
    ),
    ...
    "reservation_maintenance": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaComputeAlphaReservation_ResourceStatus_ReservationMaintenanceFields,
    ),
    "specific_sku_allocation": ubx.FieldSpec(
        wire_name="specific_sku_allocation",
        kind="object",
        fields=_AlphaComputeAlphaReservation_ResourceStatus_SpecificSkuAllocationFields,
    ),
}

_AlphaComputeAlphaReservation_ShareSettings_FolderMapFields = {
    "folder_id": ubx.FieldSpec(wire_name="folder_id"),
}

_AlphaComputeAlphaReservation_ShareSettings_ProjectMapFields = {
    "project_id": ubx.FieldSpec(wire_name="project_id"),
}

_AlphaComputeAlphaReservation_ShareSettingsFields = {
    "folder_map": ubx.FieldSpec(
        wire_name="folder_map",
        kind="map",
        fields=_AlphaComputeAlphaReservation_ShareSettings_FolderMapFields,
    ),
    "project_map": ubx.FieldSpec(
        wire_name="project_map",
        kind="map",
        fields=_AlphaComputeAlphaReservation_ShareSettings_ProjectMapFields,
    ),
    "projects": ubx.FieldSpec(wire_name="projects"),
    "share_type": ubx.FieldSpec(wire_name="share_type"),
}

_AlphaComputeAlphaReservation_SpecificReservation_InstanceProperties_LocalSsdsFields = {
    "disk_size_gb": ubx.FieldSpec(wire_name="disk_size_gb"),
    "interface": ubx.FieldSpec(wire_name="interface"),
}

_AlphaComputeAlphaReservation_SpecificReservation_InstancePropertiesFields = {
    ...
    "local_ssds": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaComputeAlphaReservation_SpecificReservation_InstanceProperties_LocalSsdsFields,
    ),
...
_AlphaComputeAlphaReservation_SpecificReservationFields = {
    ...
    "instance_properties": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaComputeAlphaReservation_SpecificReservation_InstancePropertiesFields,
    ),
    "source_instance_template": ubx.FieldSpec(wire_name="source_instance_template"),
}

@dataclasses.dataclass
class AlphaComputeAlphaReservationConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaReservationAttrs:
    # Advance control for cluster management, applicable only to DENSE deployment type reservations.
    advanced_deployment_control: Any = None
    # This reservation type is specified by total resource amounts (e.g. total count of CPUs) and can account for multiple instance SKUs. In other words, one can create instances of varying shapes against this reservation.
    aggregate_reservation: Any = None
...
AlphaComputeAlphaReservation = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_reservation",
    fields={
        "advanced_deployment_control": ubx.FieldSpec(
            wire_name="advanced_deployment_control",
            kind="object",
            fields=_AlphaComputeAlphaReservation_AdvancedDeploymentControlFields,
        ),
        "aggregate_reservation": ubx.FieldSpec(
            wire_name="aggregate_reservation",
            kind="object",
            fields=_AlphaComputeAlphaReservation_AggregateReservationFields,
        ),
        ...
        "delete_after_duration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaReservation_DeleteAfterDurationFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaComputeAlphaReservation_ParamsFields,
        ),
        ...
        "reservation_sharing_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaReservation_ReservationSharingPolicyFields,
        ),
        "resource_policies": ubx.FieldSpec(wire_name="resource_policies"),
        "resource_status": ubx.FieldSpec(
            wire_name="resource_status",
            kind="object",
            fields=_AlphaComputeAlphaReservation_ResourceStatusFields,
        ),
        ...
        "share_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaReservation_ShareSettingsFields,
        ),
        "specific_reservation": ubx.FieldSpec(
            wire_name="specific_reservation",
            kind="object",
            fields=_AlphaComputeAlphaReservation_SpecificReservationFields,
        ),
