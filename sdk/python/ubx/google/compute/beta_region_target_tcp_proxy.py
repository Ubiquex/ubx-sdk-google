...
class BetaRegionTargetTcpProxyConfig:
...
@dataclasses.dataclass
class BetaRegionTargetTcpProxyAttrs:
...
BetaRegionTargetTcpProxy = ubx.ResourceBinding(
    wire_type="google_compute_beta_region_target_tcp_proxy",
    fields={
