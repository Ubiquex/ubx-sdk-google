...
class BetaComputeBetaRegionHealthAggregationPolicyConfig:
...
@dataclasses.dataclass
class BetaComputeBetaRegionHealthAggregationPolicyAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
BetaComputeBetaRegionHealthAggregationPolicy = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_region_health_aggregation_policy",
    fields={
