...
class BetaComputeBetaSslCertificate_Managed:
...
@dataclasses.dataclass
class BetaComputeBetaSslCertificateAttrs:
    # A value read into memory from a certificate file. The certificate file must be in PEM format. The certificate chain must be no greater than 5 certs long. The chain must include at least one intermediate cert.
    certificate: Any = None
    # [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaComputeBetaSslCertificate = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_ssl_certificate",
    fields={
        "certificate": ubx.FieldSpec(wire_name="certificate"),
        ...
        "managed": ubx.FieldSpec(
            wire_name="managed",
            kind="object",
            fields=_BetaComputeBetaSslCertificate_ManagedFields,
        ),
        ...
        "self_managed": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaSslCertificate_SelfManagedFields,
        ),
