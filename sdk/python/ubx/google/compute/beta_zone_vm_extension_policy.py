...
class BetaZoneVmExtensionPolicy_ExtensionPolicies:
    pinned_version: Any = None
    string_config: Any = None

@dataclasses.dataclass
class BetaZoneVmExtensionPolicy_InstanceSelectors_LabelSelector:
    inclusion_labels: Any = None

@dataclasses.dataclass
class BetaZoneVmExtensionPolicy_InstanceSelectors:
    label_selector: Any = None

_BetaZoneVmExtensionPolicy_ExtensionPoliciesFields = {
    "pinned_version": ubx.FieldSpec(wire_name="pinned_version"),
    "string_config": ubx.FieldSpec(wire_name="string_config"),
}

_BetaZoneVmExtensionPolicy_InstanceSelectors_LabelSelectorFields = {
    "inclusion_labels": ubx.FieldSpec(wire_name="inclusion_labels"),
}

_BetaZoneVmExtensionPolicy_InstanceSelectorsFields = {
    "label_selector": ubx.FieldSpec(
        wire_name="label_selector",
        kind="object",
        fields=_BetaZoneVmExtensionPolicy_InstanceSelectors_LabelSelectorFields,
    ),
}

@dataclasses.dataclass
class BetaZoneVmExtensionPolicyConfig:
...
@dataclasses.dataclass
class BetaZoneVmExtensionPolicyAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource.
    description: Any = None
...
BetaZoneVmExtensionPolicy = ubx.ResourceBinding(
    wire_type="google_compute_beta_zone_vm_extension_policy",
    fields={
        ...
        "extension_policies": ubx.FieldSpec(
            ...
            kind="map",
            fields=_BetaZoneVmExtensionPolicy_ExtensionPoliciesFields,
        ),
        ...
        "instance_selectors": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaZoneVmExtensionPolicy_InstanceSelectorsFields,
        ),
