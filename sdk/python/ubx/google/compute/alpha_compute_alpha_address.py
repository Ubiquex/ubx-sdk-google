# Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_address. DO NOT EDIT.
...
class AlphaComputeAlphaAddressConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaAddressAttrs:
    # The static IP address represented by this resource.
    address: Any = None
    # The type of address to reserve, either INTERNAL orEXTERNAL. If unspecified, defaults to EXTERNAL.
    address_type: Any = None
...
AlphaComputeAlphaAddress = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_address",
    fields={
