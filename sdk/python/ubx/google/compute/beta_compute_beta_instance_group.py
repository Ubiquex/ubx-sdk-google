...
class BetaComputeBetaInstanceGroup_NamedPorts:
    name: Any = None
    port: Any = None

_BetaComputeBetaInstanceGroup_NamedPortsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "port": ubx.FieldSpec(wire_name="port"),
}

@dataclasses.dataclass
class BetaComputeBetaInstanceGroupConfig:
...
@dataclasses.dataclass
class BetaComputeBetaInstanceGroupAttrs:
    # Output only. [Output Only] The creation timestamp for this instance group inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
BetaComputeBetaInstanceGroup = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_instance_group",
    fields={
        ...
        "named_ports": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaInstanceGroup_NamedPortsFields,
        ),
