...
class AlphaComputeAlphaRegionDisk_AsyncPrimaryDisk:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionDisk_AsyncSecondaryDisks:
    async_replication_disk: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaRegionDisk_DiskEncryptionKey:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionDisk_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaRegionDisk_Params:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionDisk_ResourceStatus_AsyncPrimaryDisk:
    state: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaRegionDisk_ResourceStatus:
...
_AlphaComputeAlphaRegionDisk_AsyncPrimaryDiskFields = {
...
_AlphaComputeAlphaRegionDisk_AsyncSecondaryDisksFields = {
    "async_replication_disk": ubx.FieldSpec(
        wire_name="async_replication_disk",
        kind="object",
        fields=_AlphaComputeAlphaRegionDisk_AsyncPrimaryDiskFields,
    ),
}

_AlphaComputeAlphaRegionDisk_DiskEncryptionKeyFields = {
...
_AlphaComputeAlphaRegionDisk_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_AlphaComputeAlphaRegionDisk_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaComputeAlphaRegionDisk_ResourceStatus_AsyncPrimaryDiskFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

_AlphaComputeAlphaRegionDisk_ResourceStatusFields = {
    "async_primary_disk": ubx.FieldSpec(
        wire_name="async_primary_disk",
        kind="object",
        fields=_AlphaComputeAlphaRegionDisk_ResourceStatus_AsyncPrimaryDiskFields,
    ),
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionDiskConfig:
    ...
    source_machine_image_disk_device_name: Any = None
    ...
    source_machine_image_id: Any = None
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionDiskAttrs:
    # The access mode of the disk. - READ_WRITE_SINGLE: The default AccessMode, means the disk can be attached to single instance in RW mode. - READ_WRITE_MANY: The AccessMode means the disk can be attached to multiple instances in RW mode. - READ_ONLY_MANY: The AccessMode means the disk can be attached to multiple instances in RO mode. The AccessMode is only valid for Hyperdisk disk types.
    access_mode: Any = None
    # The architecture of the disk. Valid values are ARM64 or X86_64.
    architecture: Any = None
...
AlphaComputeAlphaRegionDisk = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_region_disk",
    fields={
        ...
        "async_secondary_disks": ubx.FieldSpec(
            wire_name="async_secondary_disks",
            kind="map",
            fields=_AlphaComputeAlphaRegionDisk_AsyncSecondaryDisksFields,
        ),
        ...
        "disk_encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaRegionDisk_DiskEncryptionKeyFields,
        ),
        ...
        "guest_os_features": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaComputeAlphaRegionDisk_GuestOsFeaturesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaComputeAlphaRegionDisk_ParamsFields,
        ),
        ...
        "resource_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaRegionDisk_ResourceStatusFields,
        ),
        ...
        "source_machine_image_disk_device_name": ubx.FieldSpec(wire_name="source_machine_image_disk_device_name"),
        "source_machine_image_encryption_key": ubx.FieldSpec(
            wire_name="source_machine_image_encryption_key",
            kind="object",
            fields=_AlphaComputeAlphaRegionDisk_DiskEncryptionKeyFields,
        ),
        "source_machine_image_id": ubx.FieldSpec(wire_name="source_machine_image_id"),
