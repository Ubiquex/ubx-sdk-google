...
class BetaFirewallPolicy_Associations:
...
@dataclasses.dataclass
class BetaFirewallPolicy_PacketMirroringRules_Match_Layer4Configs:
    ip_protocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class BetaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags:
    name: Any = None
    state: Any = None

@dataclasses.dataclass
class BetaFirewallPolicy_PacketMirroringRules_Match:
...
@dataclasses.dataclass
class BetaFirewallPolicy_PacketMirroringRules:
    action: Any = None
...
_BetaFirewallPolicy_AssociationsFields = {
...
_BetaFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields = {
    "ip_protocol": ubx.FieldSpec(wire_name="ip_protocol"),
    "ports": ubx.FieldSpec(wire_name="ports"),
}

_BetaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_BetaFirewallPolicy_PacketMirroringRules_MatchFields = {
    ...
    "layer4_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields,
    ),
    ...
    "src_secure_tags": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields,
    ),
    "src_threat_intelligences": ubx.FieldSpec(wire_name="src_threat_intelligences"),
}

_BetaFirewallPolicy_PacketMirroringRulesFields = {
    ...
    "match": ubx.FieldSpec(
        wire_name="match",
        kind="object",
        fields=_BetaFirewallPolicy_PacketMirroringRules_MatchFields,
    ),
    "priority": ubx.FieldSpec(wire_name="priority"),
...
@dataclasses.dataclass
class BetaFirewallPolicyConfig:
...
BetaFirewallPolicy = ubx.ResourceBinding(
    wire_type="google_compute_beta_firewall_policy",
    fields={
        "associations": ubx.FieldSpec(
            wire_name="associations",
            kind="list",
            fields=_BetaFirewallPolicy_AssociationsFields,
        ),
        ...
        "packet_mirroring_rules": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaFirewallPolicy_PacketMirroringRulesFields,
        ),
