...
class AlphaComputeAlphaTargetHttpsProxyConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaTargetHttpsProxyAttrs:
    # [Deprecated] Use serverTlsPolicy instead.
    authentication: Any = None
    # [Deprecated] Use authorizationPolicy instead.
    authorization: Any = None
...
AlphaComputeAlphaTargetHttpsProxy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_target_https_proxy",
    fields={
