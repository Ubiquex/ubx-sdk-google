...
class BetaStoragePool_ExapoolProvisionedCapacityGb:
...
@dataclasses.dataclass
class BetaStoragePool_ResourceStatus:
...
@dataclasses.dataclass
class BetaStoragePool_ShareSettings_ProjectMap:
    project_id: Any = None

@dataclasses.dataclass
class BetaStoragePool_ShareSettings:
    # A map of project id and project config.
    project_map: Any = None

_BetaStoragePool_ExapoolProvisionedCapacityGbFields = {
...
_BetaStoragePool_ShareSettings_ProjectMapFields = {
    "project_id": ubx.FieldSpec(wire_name="project_id"),
}

_BetaStoragePool_ShareSettingsFields = {
    "project_map": ubx.FieldSpec(
        wire_name="project_map",
        kind="map",
        fields=_BetaStoragePool_ShareSettings_ProjectMapFields,
    ),
}

@dataclasses.dataclass
class BetaStoragePoolConfig:
...
BetaStoragePool = ubx.ResourceBinding(
    wire_type="google_compute_beta_storage_pool",
    fields={
        ...
        "exapool_provisioned_capacity_gb": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaStoragePool_ExapoolProvisionedCapacityGbFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaStoragePool_ParamsFields,
        ),
        ...
        "resource_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaStoragePool_ResourceStatusFields,
        ),
        ...
        "share_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaStoragePool_ShareSettingsFields,
        ),
