...
class AlphaNetworkAttachment_ConnectionEndpoints:
    ip_address: Any = None
...
_AlphaNetworkAttachment_ConnectionEndpointsFields = {
...
AlphaNetworkAttachment = ubx.ResourceBinding(
    wire_type="google_compute_alpha_network_attachment",
    fields={
        "connection_endpoints": ubx.FieldSpec(
            wire_name="connection_endpoints",
            kind="list",
            fields=_AlphaNetworkAttachment_ConnectionEndpointsFields,
        ),
