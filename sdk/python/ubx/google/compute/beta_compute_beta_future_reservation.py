...
class BetaComputeBetaFutureReservation_AdvancedDeploymentControl:
    # Indicates chosen reservation operational mode for the reservation.
    reservation_operational_mode: Any = None

@dataclasses.dataclass
class BetaComputeBetaFutureReservation_AggregateReservation_InUseResources_Accelerator:
    accelerator_count: Any = None
    accelerator_type: Any = None

@dataclasses.dataclass
class BetaComputeBetaFutureReservation_AggregateReservation_InUseResources:
    accelerator: Any = None

@dataclasses.dataclass
class BetaComputeBetaFutureReservation_AggregateReservation:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_AutoCreatedReservationsDuration:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_CommitmentInfo:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_Params:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_ShareSettings_FolderMap:
    folder_id: Any = None

@dataclasses.dataclass
class BetaComputeBetaFutureReservation_ShareSettings_ProjectMap:
    project_id: Any = None

@dataclasses.dataclass
class BetaComputeBetaFutureReservation_ShareSettings:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_SpecificSkuProperties_InstanceProperties_LocalSsds:
    disk_size_gb: Any = None
    interface: Any = None

@dataclasses.dataclass
class BetaComputeBetaFutureReservation_SpecificSkuProperties_InstanceProperties:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_SpecificSkuProperties:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_Status_ExapoolProvisionedCapacityGb:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_Status_ExistingMatchingUsageInfo:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_Status_LastKnownGoodState_FutureReservationSpecs_TimeWindow:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_Status_LastKnownGoodState_FutureReservationSpecs:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_Status_LastKnownGoodState:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_Status_SpecificSkuProperties:
    # ID of the instance template used to populate the Future Reservation properties.
    source_instance_template_id: Any = None

@dataclasses.dataclass
class BetaComputeBetaFutureReservation_Status_StoragePoolProvisionedCapacity:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_Status:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservation_StoragePoolProperties:
    # Exapool provisioned capacities for each SKU type
...
_BetaComputeBetaFutureReservation_AdvancedDeploymentControlFields = {
    "reservation_operational_mode": ubx.FieldSpec(wire_name="reservation_operational_mode"),
}

_BetaComputeBetaFutureReservation_AggregateReservation_InUseResources_AcceleratorFields = {
    "accelerator_count": ubx.FieldSpec(wire_name="accelerator_count"),
    "accelerator_type": ubx.FieldSpec(wire_name="accelerator_type"),
}

_BetaComputeBetaFutureReservation_AggregateReservation_InUseResourcesFields = {
    "accelerator": ubx.FieldSpec(
        wire_name="accelerator",
        kind="object",
        fields=_BetaComputeBetaFutureReservation_AggregateReservation_InUseResources_AcceleratorFields,
    ),
}

_BetaComputeBetaFutureReservation_AggregateReservationFields = {
    ...
    "in_use_resources": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaComputeBetaFutureReservation_AggregateReservation_InUseResourcesFields,
    ),
...
_BetaComputeBetaFutureReservation_AutoCreatedReservationsDurationFields = {
    "nanos": ubx.FieldSpec(wire_name="nanos"),
    "seconds": ubx.FieldSpec(wire_name="seconds"),
}

_BetaComputeBetaFutureReservation_CommitmentInfoFields = {
...
_BetaComputeBetaFutureReservation_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaFutureReservation_ShareSettings_FolderMapFields = {
    "folder_id": ubx.FieldSpec(wire_name="folder_id"),
}

_BetaComputeBetaFutureReservation_ShareSettings_ProjectMapFields = {
    "project_id": ubx.FieldSpec(wire_name="project_id"),
}

_BetaComputeBetaFutureReservation_ShareSettingsFields = {
    "folder_map": ubx.FieldSpec(
        wire_name="folder_map",
        kind="map",
        fields=_BetaComputeBetaFutureReservation_ShareSettings_FolderMapFields,
    ),
    "project_map": ubx.FieldSpec(
        wire_name="project_map",
        kind="map",
        fields=_BetaComputeBetaFutureReservation_ShareSettings_ProjectMapFields,
    ),
    "projects": ubx.FieldSpec(wire_name="projects"),
    "share_type": ubx.FieldSpec(wire_name="share_type"),
}

_BetaComputeBetaFutureReservation_SpecificSkuProperties_InstanceProperties_LocalSsdsFields = {
    "disk_size_gb": ubx.FieldSpec(wire_name="disk_size_gb"),
    "interface": ubx.FieldSpec(wire_name="interface"),
}

_BetaComputeBetaFutureReservation_SpecificSkuProperties_InstancePropertiesFields = {
    ...
    "local_ssds": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaComputeBetaFutureReservation_SpecificSkuProperties_InstanceProperties_LocalSsdsFields,
    ),
...
_BetaComputeBetaFutureReservation_SpecificSkuPropertiesFields = {
    "instance_properties": ubx.FieldSpec(
        wire_name="instance_properties",
        kind="object",
        fields=_BetaComputeBetaFutureReservation_SpecificSkuProperties_InstancePropertiesFields,
    ),
    "source_instance_template": ubx.FieldSpec(wire_name="source_instance_template"),
    "total_count": ubx.FieldSpec(wire_name="total_count"),
}

_BetaComputeBetaFutureReservation_Status_ExapoolProvisionedCapacityGbFields = {
...
_BetaComputeBetaFutureReservation_Status_ExistingMatchingUsageInfoFields = {
    "count": ubx.FieldSpec(wire_name="count"),
    "timestamp": ubx.FieldSpec(wire_name="timestamp"),
}

_BetaComputeBetaFutureReservation_Status_LastKnownGoodState_FutureReservationSpecs_TimeWindowFields = {
    "duration": ubx.FieldSpec(
        wire_name="duration",
        kind="object",
        fields=_BetaComputeBetaFutureReservation_AutoCreatedReservationsDurationFields,
    ),
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

_BetaComputeBetaFutureReservation_Status_LastKnownGoodState_FutureReservationSpecsFields = {
    "share_settings": ubx.FieldSpec(
        wire_name="share_settings",
        kind="object",
        fields=_BetaComputeBetaFutureReservation_ShareSettingsFields,
    ),
    "specific_sku_properties": ubx.FieldSpec(
        wire_name="specific_sku_properties",
        kind="object",
        fields=_BetaComputeBetaFutureReservation_SpecificSkuPropertiesFields,
    ),
    "time_window": ubx.FieldSpec(
        wire_name="time_window",
        kind="object",
        fields=_BetaComputeBetaFutureReservation_Status_LastKnownGoodState_FutureReservationSpecs_TimeWindowFields,
    ),
}

_BetaComputeBetaFutureReservation_Status_LastKnownGoodStateFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "existing_matching_usage_info": ubx.FieldSpec(
        wire_name="existing_matching_usage_info",
        kind="object",
        fields=_BetaComputeBetaFutureReservation_Status_ExistingMatchingUsageInfoFields,
    ),
    "future_reservation_specs": ubx.FieldSpec(
        wire_name="future_reservation_specs",
        kind="object",
        fields=_BetaComputeBetaFutureReservation_Status_LastKnownGoodState_FutureReservationSpecsFields,
    ),
...
_BetaComputeBetaFutureReservation_Status_SpecificSkuPropertiesFields = {
    "source_instance_template_id": ubx.FieldSpec(wire_name="source_instance_template_id"),
}

_BetaComputeBetaFutureReservation_Status_StoragePoolProvisionedCapacityFields = {
...
_BetaComputeBetaFutureReservation_StatusFields = {
    ...
    "exapool_provisioned_capacity_gb": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaComputeBetaFutureReservation_Status_ExapoolProvisionedCapacityGbFields,
    ),
    "existing_matching_usage_info": ubx.FieldSpec(
        wire_name="existing_matching_usage_info",
        kind="object",
    ...
    "last_known_good_state": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaComputeBetaFutureReservation_Status_LastKnownGoodStateFields,
    ),
    "lock_time": ubx.FieldSpec(wire_name="lock_time"),
    "procurement_status": ubx.FieldSpec(wire_name="procurement_status"),
    "specific_sku_properties": ubx.FieldSpec(
        wire_name="specific_sku_properties",
        kind="object",
        fields=_BetaComputeBetaFutureReservation_Status_SpecificSkuPropertiesFields,
    ),
    "storage_pool_provisioned_capacity": ubx.FieldSpec(
        wire_name="storage_pool_provisioned_capacity",
        kind="object",
        fields=_BetaComputeBetaFutureReservation_Status_StoragePoolProvisionedCapacityFields,
    ),
}

_BetaComputeBetaFutureReservation_StoragePoolPropertiesFields = {
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservationConfig:
...
@dataclasses.dataclass
class BetaComputeBetaFutureReservationAttrs:
    # Advance control for cluster management, applicable only to DENSE deployment type reservations.
    advanced_deployment_control: Any = None
    # This reservation type is specified by total resource amounts (e.g. total count of CPUs) and can account for multiple instance SKUs. In other words, one can create instances of varying shapes against this reservation.
    aggregate_reservation: Any = None
...
BetaComputeBetaFutureReservation = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_future_reservation",
    fields={
        "advanced_deployment_control": ubx.FieldSpec(
            wire_name="advanced_deployment_control",
            kind="object",
            fields=_BetaComputeBetaFutureReservation_AdvancedDeploymentControlFields,
        ),
        "aggregate_reservation": ubx.FieldSpec(
            wire_name="aggregate_reservation",
            kind="object",
            fields=_BetaComputeBetaFutureReservation_AggregateReservationFields,
        ),
        ...
        "commitment_info": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaFutureReservation_CommitmentInfoFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaFutureReservation_ParamsFields,
        ),
        ...
        "status": ubx.FieldSpec(
            wire_name="status",
            kind="object",
            fields=_BetaComputeBetaFutureReservation_StatusFields,
        ),
        "storage_pool_properties": ubx.FieldSpec(
            wire_name="storage_pool_properties",
            kind="object",
            fields=_BetaComputeBetaFutureReservation_StoragePoolPropertiesFields,
        ),
        "time_window": ubx.FieldSpec(
            wire_name="time_window",
            kind="object",
