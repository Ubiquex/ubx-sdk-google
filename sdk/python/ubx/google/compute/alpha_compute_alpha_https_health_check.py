...
class AlphaComputeAlphaHttpsHealthCheckConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaHttpsHealthCheckAttrs:
    # How often (in seconds) to send a health check. The default value is 5 seconds.
    check_interval_sec: Any = None
    # [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
AlphaComputeAlphaHttpsHealthCheck = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_https_health_check",
    fields={
