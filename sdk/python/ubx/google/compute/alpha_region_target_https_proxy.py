...
class AlphaRegionTargetHttpsProxyConfig:
...
@dataclasses.dataclass
class AlphaRegionTargetHttpsProxyAttrs:
    # [Deprecated] Use serverTlsPolicy instead.
    authentication: Any = None
    # [Deprecated] Use authorizationPolicy instead.
    authorization: Any = None
...
AlphaRegionTargetHttpsProxy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_region_target_https_proxy",
    fields={
