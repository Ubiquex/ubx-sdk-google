...
class AlphaComputeAlphaRegionSnapshot_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaRegionSnapshot_Params:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionSnapshot_ResourceStatus:
    ...
    scheduled_deletion_time: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKey:
...
_AlphaComputeAlphaRegionSnapshot_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_AlphaComputeAlphaRegionSnapshot_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaComputeAlphaRegionSnapshot_ResourceStatusFields = {
    "scheduled_deletion_time": ubx.FieldSpec(wire_name="scheduled_deletion_time"),
}

_AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKeyFields = {
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionSnapshotConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionSnapshotAttrs:
    # Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64.
    architecture: Any = None
    # Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk.
    auto_created: Any = None
...
AlphaComputeAlphaRegionSnapshot = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_region_snapshot",
    fields={
        ...
        "guest_os_features": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaComputeAlphaRegionSnapshot_GuestOsFeaturesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaComputeAlphaRegionSnapshot_ParamsFields,
        ),
        "region": ubx.FieldSpec(wire_name="region"),
        "resource_status": ubx.FieldSpec(
            wire_name="resource_status",
            kind="object",
            fields=_AlphaComputeAlphaRegionSnapshot_ResourceStatusFields,
        ),
        ...
        "snapshot_encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaRegionSnapshot_SnapshotEncryptionKeyFields,
        ),
