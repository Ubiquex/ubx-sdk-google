...
class BetaComputeBetaRegionDisk_AsyncPrimaryDisk:
...
@dataclasses.dataclass
class BetaComputeBetaRegionDisk_AsyncSecondaryDisks:
    async_replication_disk: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionDisk_DiskEncryptionKey:
...
@dataclasses.dataclass
class BetaComputeBetaRegionDisk_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionDisk_Params:
...
@dataclasses.dataclass
class BetaComputeBetaRegionDisk_ResourceStatus_AsyncPrimaryDisk:
    state: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionDisk_ResourceStatus:
    async_primary_disk: Any = None
    # Key: disk, value: AsyncReplicationStatus message
    async_secondary_disks: Any = None

_BetaComputeBetaRegionDisk_AsyncPrimaryDiskFields = {
...
_BetaComputeBetaRegionDisk_AsyncSecondaryDisksFields = {
    "async_replication_disk": ubx.FieldSpec(
        wire_name="async_replication_disk",
        kind="object",
        fields=_BetaComputeBetaRegionDisk_AsyncPrimaryDiskFields,
    ),
}

_BetaComputeBetaRegionDisk_DiskEncryptionKeyFields = {
...
_BetaComputeBetaRegionDisk_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_BetaComputeBetaRegionDisk_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaRegionDisk_ResourceStatus_AsyncPrimaryDiskFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

_BetaComputeBetaRegionDisk_ResourceStatusFields = {
    "async_primary_disk": ubx.FieldSpec(
        wire_name="async_primary_disk",
        kind="object",
        fields=_BetaComputeBetaRegionDisk_ResourceStatus_AsyncPrimaryDiskFields,
    ),
...
@dataclasses.dataclass
class BetaComputeBetaRegionDiskConfig:
...
@dataclasses.dataclass
class BetaComputeBetaRegionDiskAttrs:
    # The access mode of the disk. - READ_WRITE_SINGLE: The default AccessMode, means the disk can be attached to single instance in RW mode. - READ_WRITE_MANY: The AccessMode means the disk can be attached to multiple instances in RW mode. - READ_ONLY_MANY: The AccessMode means the disk can be attached to multiple instances in RO mode. The AccessMode is only valid for Hyperdisk disk types.
    access_mode: Any = None
    # The architecture of the disk. Valid values are ARM64 or X86_64.
    architecture: Any = None
...
BetaComputeBetaRegionDisk = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_region_disk",
    fields={
        ...
        "async_secondary_disks": ubx.FieldSpec(
            wire_name="async_secondary_disks",
            kind="map",
            fields=_BetaComputeBetaRegionDisk_AsyncSecondaryDisksFields,
        ),
        ...
        "disk_encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaRegionDisk_DiskEncryptionKeyFields,
        ),
        ...
        "guest_os_features": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaRegionDisk_GuestOsFeaturesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaRegionDisk_ParamsFields,
        ),
        ...
        "resource_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaRegionDisk_ResourceStatusFields,
        ),
