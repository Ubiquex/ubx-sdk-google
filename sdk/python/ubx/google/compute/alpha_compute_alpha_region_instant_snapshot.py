...
class AlphaComputeAlphaRegionInstantSnapshot_Params:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionInstantSnapshot_ResourceStatus:
    # [Output Only] The storage size of this instant snapshot.
    storage_size_bytes: Any = None

_AlphaComputeAlphaRegionInstantSnapshot_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaComputeAlphaRegionInstantSnapshot_ResourceStatusFields = {
    "storage_size_bytes": ubx.FieldSpec(wire_name="storage_size_bytes"),
}

@dataclasses.dataclass
class AlphaComputeAlphaRegionInstantSnapshotConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionInstantSnapshotAttrs:
    # Output only. [Output Only] The architecture of the instant snapshot. Valid values are ARM64 or X86_64.
    architecture: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
AlphaComputeAlphaRegionInstantSnapshot = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_region_instant_snapshot",
    fields={
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaComputeAlphaRegionInstantSnapshot_ParamsFields,
        ),
        "region": ubx.FieldSpec(wire_name="region"),
        "resource_status": ubx.FieldSpec(
            wire_name="resource_status",
            kind="object",
            fields=_AlphaComputeAlphaRegionInstantSnapshot_ResourceStatusFields,
        ),
        ...
        "source_instant_snapshot_group_id": ubx.FieldSpec(wire_name="source_instant_snapshot_group_id"),
