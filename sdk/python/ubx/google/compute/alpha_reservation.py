...
class AlphaReservation_AdvancedDeploymentControl:
    # Indicates chosen reservation operational mode for the reservation.
    reservation_operational_mode: Any = None

@dataclasses.dataclass
class AlphaReservation_AggregateReservation_InUseResources_Accelerator:
    accelerator_count: Any = None
    accelerator_type: Any = None

@dataclasses.dataclass
class AlphaReservation_AggregateReservation_InUseResources:
    accelerator: Any = None

@dataclasses.dataclass
class AlphaReservation_AggregateReservation:
...
@dataclasses.dataclass
class AlphaReservation_DeleteAfterDuration:
...
@dataclasses.dataclass
class AlphaReservation_ReservationSharingPolicy:
    # Sharing config for all Google Cloud services.
    service_share_type: Any = None

@dataclasses.dataclass
class AlphaReservation_ResourceStatus_AggregateAllocation:
    # Per service utilization breakdown. The Key is the Google Cloud managed service name.
    utilizations: Any = None

@dataclasses.dataclass
class AlphaReservation_ResourceStatus_HealthInfo:
...
@dataclasses.dataclass
class AlphaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenance_StartTimeWindow:
    earliest: Any = None
    latest: Any = None

@dataclasses.dataclass
class AlphaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenance:
...
@dataclasses.dataclass
class AlphaReservation_ResourceStatus_ReservationMaintenance:
...
@dataclasses.dataclass
class AlphaReservation_ResourceStatus_SpecificSkuAllocation:
...
@dataclasses.dataclass
class AlphaReservation_ResourceStatus:
...
@dataclasses.dataclass
class AlphaReservation_ShareSettings_FolderMap:
    folder_id: Any = None

@dataclasses.dataclass
class AlphaReservation_ShareSettings_ProjectMap:
    project_id: Any = None

@dataclasses.dataclass
class AlphaReservation_ShareSettings:
...
@dataclasses.dataclass
class AlphaReservation_SpecificReservation_InstanceProperties_LocalSsds:
    disk_size_gb: Any = None
    interface: Any = None

@dataclasses.dataclass
class AlphaReservation_SpecificReservation_InstanceProperties:
...
@dataclasses.dataclass
class AlphaReservation_SpecificReservation:
...
_AlphaReservation_AdvancedDeploymentControlFields = {
    "reservation_operational_mode": ubx.FieldSpec(wire_name="reservation_operational_mode"),
}

_AlphaReservation_AggregateReservation_InUseResources_AcceleratorFields = {
    "accelerator_count": ubx.FieldSpec(wire_name="accelerator_count"),
    "accelerator_type": ubx.FieldSpec(wire_name="accelerator_type"),
}

_AlphaReservation_AggregateReservation_InUseResourcesFields = {
    "accelerator": ubx.FieldSpec(
        wire_name="accelerator",
        kind="object",
        fields=_AlphaReservation_AggregateReservation_InUseResources_AcceleratorFields,
    ),
}

_AlphaReservation_AggregateReservationFields = {
    ...
    "in_use_resources": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaReservation_AggregateReservation_InUseResourcesFields,
    ),
...
_AlphaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenance_StartTimeWindowFields = {
    "earliest": ubx.FieldSpec(wire_name="earliest"),
    "latest": ubx.FieldSpec(wire_name="latest"),
}

_AlphaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenanceFields = {
    ...
    "start_time_window": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenance_StartTimeWindowFields,
    ),
...
_AlphaReservation_ResourceStatus_ReservationMaintenanceFields = {
    ...
    "upcoming_group_maintenance": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenanceFields,
    ),
}

_AlphaReservation_ResourceStatus_SpecificSkuAllocationFields = {
    "source_instance_template_id": ubx.FieldSpec(wire_name="source_instance_template_id"),
    "utilizations": ubx.FieldSpec(wire_name="utilizations"),
}

_AlphaReservation_ResourceStatusFields = {
    "aggregate_allocation": ubx.FieldSpec(
        wire_name="aggregate_allocation",
        kind="object",
        fields=_AlphaReservation_ResourceStatus_AggregateAllocationFields,
    ),
    "health_info": ubx.FieldSpec(
        wire_name="health_info",
        kind="object",
        fields=_AlphaReservation_ResourceStatus_HealthInfoFields,
    ),
    ...
    "reservation_maintenance": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaReservation_ResourceStatus_ReservationMaintenanceFields,
    ),
    "specific_sku_allocation": ubx.FieldSpec(
        wire_name="specific_sku_allocation",
        kind="object",
        fields=_AlphaReservation_ResourceStatus_SpecificSkuAllocationFields,
    ),
}

_AlphaReservation_ShareSettings_FolderMapFields = {
    "folder_id": ubx.FieldSpec(wire_name="folder_id"),
}

_AlphaReservation_ShareSettings_ProjectMapFields = {
    "project_id": ubx.FieldSpec(wire_name="project_id"),
}

_AlphaReservation_ShareSettingsFields = {
    "folder_map": ubx.FieldSpec(
        wire_name="folder_map",
        kind="map",
        fields=_AlphaReservation_ShareSettings_FolderMapFields,
    ),
    "project_map": ubx.FieldSpec(
        wire_name="project_map",
        kind="map",
        fields=_AlphaReservation_ShareSettings_ProjectMapFields,
    ),
    "projects": ubx.FieldSpec(wire_name="projects"),
    "share_type": ubx.FieldSpec(wire_name="share_type"),
}

_AlphaReservation_SpecificReservation_InstanceProperties_LocalSsdsFields = {
    "disk_size_gb": ubx.FieldSpec(wire_name="disk_size_gb"),
    "interface": ubx.FieldSpec(wire_name="interface"),
}

_AlphaReservation_SpecificReservation_InstancePropertiesFields = {
    ...
    "local_ssds": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaReservation_SpecificReservation_InstanceProperties_LocalSsdsFields,
    ),
...
_AlphaReservation_SpecificReservationFields = {
    ...
    "instance_properties": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaReservation_SpecificReservation_InstancePropertiesFields,
    ),
    "source_instance_template": ubx.FieldSpec(wire_name="source_instance_template"),
}

@dataclasses.dataclass
class AlphaReservationConfig:
...
AlphaReservation = ubx.ResourceBinding(
    wire_type="google_compute_alpha_reservation",
    fields={
        "advanced_deployment_control": ubx.FieldSpec(
            wire_name="advanced_deployment_control",
            kind="object",
            fields=_AlphaReservation_AdvancedDeploymentControlFields,
        ),
        "aggregate_reservation": ubx.FieldSpec(
            wire_name="aggregate_reservation",
            kind="object",
            fields=_AlphaReservation_AggregateReservationFields,
        ),
        ...
        "delete_after_duration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaReservation_DeleteAfterDurationFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaReservation_ParamsFields,
        ),
