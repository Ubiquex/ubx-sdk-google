...
class BetaComputeBetaNetwork_Params:
...
@dataclasses.dataclass
class BetaComputeBetaNetwork_Peerings_ConnectionStatus_ConsensusState:
    delete_status: Any = None
    update_status: Any = None

@dataclasses.dataclass
class BetaComputeBetaNetwork_Peerings_ConnectionStatus_TrafficConfiguration:
...
@dataclasses.dataclass
class BetaComputeBetaNetwork_Peerings_ConnectionStatus:
    consensus_state: Any = None
    traffic_configuration: Any = None
    update_strategy: Any = None

@dataclasses.dataclass
class BetaComputeBetaNetwork_Peerings:
...
@dataclasses.dataclass
class BetaComputeBetaNetwork_RoutingConfig:
...
_BetaComputeBetaNetwork_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaNetwork_Peerings_ConnectionStatus_ConsensusStateFields = {
    "delete_status": ubx.FieldSpec(wire_name="delete_status"),
    "update_status": ubx.FieldSpec(wire_name="update_status"),
}

_BetaComputeBetaNetwork_Peerings_ConnectionStatus_TrafficConfigurationFields = {
...
_BetaComputeBetaNetwork_Peerings_ConnectionStatusFields = {
    "consensus_state": ubx.FieldSpec(
        wire_name="consensus_state",
        kind="object",
        fields=_BetaComputeBetaNetwork_Peerings_ConnectionStatus_ConsensusStateFields,
    ),
    "traffic_configuration": ubx.FieldSpec(
        wire_name="traffic_configuration",
        kind="object",
        fields=_BetaComputeBetaNetwork_Peerings_ConnectionStatus_TrafficConfigurationFields,
    ),
    "update_strategy": ubx.FieldSpec(wire_name="update_strategy"),
}

_BetaComputeBetaNetwork_PeeringsFields = {
    "auto_create_routes": ubx.FieldSpec(wire_name="auto_create_routes"),
    "connection_status": ubx.FieldSpec(
        wire_name="connection_status",
        kind="object",
        fields=_BetaComputeBetaNetwork_Peerings_ConnectionStatusFields,
    ),
...
_BetaComputeBetaNetwork_RoutingConfigFields = {
...
@dataclasses.dataclass
class BetaComputeBetaNetworkConfig:
...
@dataclasses.dataclass
class BetaComputeBetaNetworkAttrs:
    # Must be set to create a VPC network. If not set, a legacy network is created. When set to true, the VPC network is created in auto mode. When set to false, the VPC network is created in custom mode. An auto mode VPC network starts with one subnet per region. Each subnet has a predetermined range as described inAuto mode VPC network IP ranges. For custom mode VPC networks, you can add subnets using the subnetworksinsert method.
    auto_create_subnetworks: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaComputeBetaNetwork = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_network",
    fields={
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaNetwork_ParamsFields,
        ),
        "peerings": ubx.FieldSpec(
            wire_name="peerings",
            kind="list",
            fields=_BetaComputeBetaNetwork_PeeringsFields,
        ),
        "routing_config": ubx.FieldSpec(
            wire_name="routing_config",
            kind="object",
            fields=_BetaComputeBetaNetwork_RoutingConfigFields,
        ),
