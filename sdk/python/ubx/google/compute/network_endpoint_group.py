...
class NetworkEndpointGroup_AppEngine:
...
@dataclasses.dataclass
class NetworkEndpointGroup_CloudFunction:
...
@dataclasses.dataclass
class NetworkEndpointGroup_CloudRun:
...
@dataclasses.dataclass
class NetworkEndpointGroup_PscData:
...
@dataclasses.dataclass
class NetworkEndpointGroupAttrs:
    # Optional. Metadata defined as annotations on the network endpoint group.
    annotations: Any = None
    # Configuration for an App Engine network endpoint group (NEG). The service is optional, may be provided explicitly or in the URL mask. The version is optional and can only be provided explicitly or in the URL mask when service is present. Note: App Engine service must be in the same project and located in the same region as the Serverless NEG.
    app_engine: Any = None
...
NetworkEndpointGroup = ubx.ResourceBinding(
    ...
    fields={
        ...
        "app_engine": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworkEndpointGroup_AppEngineFields,
        ),
        "cloud_function": ubx.FieldSpec(
            wire_name="cloud_function",
            kind="object",
            fields=_NetworkEndpointGroup_CloudFunctionFields,
        ),
        "cloud_run": ubx.FieldSpec(
            wire_name="cloud_run",
            kind="object",
            fields=_NetworkEndpointGroup_CloudRunFields,
        ),
        ...
        "psc_data": ubx.FieldSpec(
            wire_name="psc_data",
            kind="object",
            fields=_NetworkEndpointGroup_PscDataFields,
        ),
