...
class AlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors:
    all_of_selectors: Any = None

@dataclasses.dataclass
class AlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector:
    any_of_selectors: Any = None

@dataclasses.dataclass
class AlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies:
    installed_software_selector: Any = None
    pinned_version: Any = None
    string_config: Any = None

@dataclasses.dataclass
class AlphaFolderGlobalVmExtensionPolicy_InstanceSelectors_LabelSelector:
    inclusion_labels: Any = None

@dataclasses.dataclass
class AlphaFolderGlobalVmExtensionPolicy_InstanceSelectors:
    label_selector: Any = None

@dataclasses.dataclass
class AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutInput:
...
@dataclasses.dataclass
class AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus:
    state: Any = None

@dataclasses.dataclass
class AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts:
...
@dataclasses.dataclass
class AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus:
...
@dataclasses.dataclass
class AlphaFolderGlobalVmExtensionPolicy_RolloutOperation:
    rollout_input: Any = None
    rollout_status: Any = None

_AlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectorsFields = {
    "all_of_selectors": ubx.FieldSpec(wire_name="all_of_selectors"),
}

_AlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelectorFields = {
    "any_of_selectors": ubx.FieldSpec(
        wire_name="any_of_selectors",
        kind="map",
        fields=_AlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectorsFields,
    ),
}

_AlphaFolderGlobalVmExtensionPolicy_ExtensionPoliciesFields = {
    "installed_software_selector": ubx.FieldSpec(
        wire_name="installed_software_selector",
        kind="object",
        fields=_AlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelectorFields,
    ),
    "pinned_version": ubx.FieldSpec(wire_name="pinned_version"),
    "string_config": ubx.FieldSpec(wire_name="string_config"),
}

_AlphaFolderGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields = {
    "inclusion_labels": ubx.FieldSpec(wire_name="inclusion_labels"),
}

_AlphaFolderGlobalVmExtensionPolicy_InstanceSelectorsFields = {
    "label_selector": ubx.FieldSpec(
        wire_name="label_selector",
        kind="object",
        fields=_AlphaFolderGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields,
    ),
}

_AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields = {
...
_AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

_AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields = {
    "location_rollout_status": ubx.FieldSpec(
        wire_name="location_rollout_status",
        kind="map",
        fields=_AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields,
    ),
...
_AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields = {
    "current_rollouts": ubx.FieldSpec(
        wire_name="current_rollouts",
        kind="list",
        fields=_AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields,
    ),
...
_AlphaFolderGlobalVmExtensionPolicy_RolloutOperationFields = {
    "rollout_input": ubx.FieldSpec(
        wire_name="rollout_input",
        kind="object",
        fields=_AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields,
    ),
    "rollout_status": ubx.FieldSpec(
        wire_name="rollout_status",
        kind="object",
        fields=_AlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields,
    ),
}

@dataclasses.dataclass
class AlphaFolderGlobalVmExtensionPolicyConfig:
...
@dataclasses.dataclass
class AlphaFolderGlobalVmExtensionPolicyAttrs:
...
AlphaFolderGlobalVmExtensionPolicy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_folder_global_vm_extension_policy",
    fields={
        "description": ubx.FieldSpec(wire_name="description"),
        "extension_policies": ubx.FieldSpec(
            wire_name="extension_policies",
            kind="map",
            fields=_AlphaFolderGlobalVmExtensionPolicy_ExtensionPoliciesFields,
        ),
        "instance_selectors": ubx.FieldSpec(
            wire_name="instance_selectors",
            kind="list",
            fields=_AlphaFolderGlobalVmExtensionPolicy_InstanceSelectorsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        ...
        "rollout_operation": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaFolderGlobalVmExtensionPolicy_RolloutOperationFields,
        ),
    },
)
