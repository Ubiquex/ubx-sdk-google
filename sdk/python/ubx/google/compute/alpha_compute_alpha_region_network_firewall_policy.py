...
class AlphaComputeAlphaRegionNetworkFirewallPolicy_Associations:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs:
    ip_protocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags:
    name: Any = None
    state: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionNetworkFirewallPolicy_PacketMirroringRules:
    action: Any = None
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutInput:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_NextRollout:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRollouts:
    rollout: Any = None
    rollout_plan: Any = None
    state: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus:
    next_rollout: Any = None
    # [Output only] The ongoing rollout.
    ongoing_rollouts: Any = None
    # Represents the status of the progressive rollout instance, either completed or ongoing.
    previous_rollout: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation:
...
_AlphaComputeAlphaRegionNetworkFirewallPolicy_AssociationsFields = {
...
_AlphaComputeAlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields = {
    "ip_protocol": ubx.FieldSpec(wire_name="ip_protocol"),
    "ports": ubx.FieldSpec(wire_name="ports"),
}

_AlphaComputeAlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_AlphaComputeAlphaRegionNetworkFirewallPolicy_PacketMirroringRules_MatchFields = {
    ...
    "layer4_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaComputeAlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields,
    ),
    ...
    "src_secure_tags": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaComputeAlphaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields,
    ),
    "src_threat_intelligences": ubx.FieldSpec(wire_name="src_threat_intelligences"),
}

_AlphaComputeAlphaRegionNetworkFirewallPolicy_PacketMirroringRulesFields = {
    ...
    "match": ubx.FieldSpec(
        wire_name="match",
        kind="object",
        fields=_AlphaComputeAlphaRegionNetworkFirewallPolicy_PacketMirroringRules_MatchFields,
    ),
    "priority": ubx.FieldSpec(wire_name="priority"),
...
_AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutInputFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "predefined_rollout_plan": ubx.FieldSpec(wire_name="predefined_rollout_plan"),
    "retry_uuid": ubx.FieldSpec(wire_name="retry_uuid"),
}

_AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_NextRolloutFields = {
    "rollout_id": ubx.FieldSpec(wire_name="rollout_id"),
    "rollout_plan": ubx.FieldSpec(wire_name="rollout_plan"),
}

_AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRolloutsFields = {
    "rollout": ubx.FieldSpec(wire_name="rollout"),
    "rollout_plan": ubx.FieldSpec(wire_name="rollout_plan"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatusFields = {
    "next_rollout": ubx.FieldSpec(
        wire_name="next_rollout",
        kind="object",
        fields=_AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_NextRolloutFields,
    ),
    "ongoing_rollouts": ubx.FieldSpec(
        wire_name="ongoing_rollouts",
        kind="list",
        fields=_AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatus_OngoingRolloutsFields,
    ),
...
_AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperationFields = {
    "rollout_input": ubx.FieldSpec(
        wire_name="rollout_input",
        kind="object",
        fields=_AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutInputFields,
    ),
    "rollout_status": ubx.FieldSpec(
        wire_name="rollout_status",
        kind="object",
        fields=_AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperation_RolloutStatusFields,
    ),
}

@dataclasses.dataclass
class AlphaComputeAlphaRegionNetworkFirewallPolicyConfig:
    ...
    vpc_network_scope: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaRegionNetworkFirewallPolicyAttrs:
    # A list of associations that belong to this firewall policy.
    associations: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
AlphaComputeAlphaRegionNetworkFirewallPolicy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_region_network_firewall_policy",
    fields={
        "associations": ubx.FieldSpec(
            wire_name="associations",
            kind="list",
            fields=_AlphaComputeAlphaRegionNetworkFirewallPolicy_AssociationsFields,
        ),
        ...
        "packet_mirroring_rules": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaComputeAlphaRegionNetworkFirewallPolicy_PacketMirroringRulesFields,
        ),
        ...
        "rollout_operation": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaRegionNetworkFirewallPolicy_RolloutOperationFields,
        ),
        "rule_tuple_count": ubx.FieldSpec(wire_name="rule_tuple_count"),
        "rules": ubx.FieldSpec(
            wire_name="rules",
        ...
        "short_name": ubx.FieldSpec(wire_name="short_name"),
        "vpc_network_scope": ubx.FieldSpec(wire_name="vpc_network_scope"),
    },
)
