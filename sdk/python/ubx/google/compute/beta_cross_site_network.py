...
class BetaCrossSiteNetworkConfig:
...
@dataclasses.dataclass
class BetaCrossSiteNetworkAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of the cross-site network.
    description: Any = None
...
BetaCrossSiteNetwork = ubx.ResourceBinding(
    wire_type="google_compute_beta_cross_site_network",
    fields={
