...
class BetaNetworkEndpointGroup_AppEngine:
...
@dataclasses.dataclass
class BetaNetworkEndpointGroup_CloudFunction:
...
@dataclasses.dataclass
class BetaNetworkEndpointGroup_CloudRun:
...
@dataclasses.dataclass
class BetaNetworkEndpointGroup_LoadBalancer:
...
@dataclasses.dataclass
class BetaNetworkEndpointGroup_PscData:
...
@dataclasses.dataclass
class BetaNetworkEndpointGroup_ServerlessDeployment:
...
_BetaNetworkEndpointGroup_AppEngineFields = {
    "service": ubx.FieldSpec(wire_name="service"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_BetaNetworkEndpointGroup_CloudFunctionFields = {
    "function": ubx.FieldSpec(wire_name="function"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
}

_BetaNetworkEndpointGroup_CloudRunFields = {
    "service": ubx.FieldSpec(wire_name="service"),
    "tag": ubx.FieldSpec(wire_name="tag"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
}

_BetaNetworkEndpointGroup_LoadBalancerFields = {
...
_BetaNetworkEndpointGroup_PscDataFields = {
...
_BetaNetworkEndpointGroup_ServerlessDeploymentFields = {
...
@dataclasses.dataclass
class BetaNetworkEndpointGroupConfig:
...
@dataclasses.dataclass
class BetaNetworkEndpointGroupAttrs:
    # Optional. Metadata defined as annotations on the network endpoint group.
    annotations: Any = None
    # Configuration for an App Engine network endpoint group (NEG). The service is optional, may be provided explicitly or in the URL mask. The version is optional and can only be provided explicitly or in the URL mask when service is present. Note: App Engine service must be in the same project and located in the same region as the Serverless NEG.
    app_engine: Any = None
...
BetaNetworkEndpointGroup = ubx.ResourceBinding(
    wire_type="google_compute_beta_network_endpoint_group",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "app_engine": ubx.FieldSpec(
            wire_name="app_engine",
            kind="object",
            fields=_BetaNetworkEndpointGroup_AppEngineFields,
        ),
        "cloud_function": ubx.FieldSpec(
            wire_name="cloud_function",
            kind="object",
            fields=_BetaNetworkEndpointGroup_CloudFunctionFields,
        ),
        "cloud_run": ubx.FieldSpec(
            wire_name="cloud_run",
            kind="object",
            fields=_BetaNetworkEndpointGroup_CloudRunFields,
        ),
        "default_port": ubx.FieldSpec(wire_name="default_port"),
        ...
        "load_balancer": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaNetworkEndpointGroup_LoadBalancerFields,
        ),
        ...
        "psc_data": ubx.FieldSpec(
            wire_name="psc_data",
            kind="object",
            fields=_BetaNetworkEndpointGroup_PscDataFields,
        ),
        ...
        "serverless_deployment": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaNetworkEndpointGroup_ServerlessDeploymentFields,
        ),
        "subnetwork": ubx.FieldSpec(wire_name="subnetwork"),
    },
)
