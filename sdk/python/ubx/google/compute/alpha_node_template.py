...
class AlphaNodeTemplate_Accelerators:
    accelerator_count: Any = None
    accelerator_type: Any = None

@dataclasses.dataclass
class AlphaNodeTemplate_Disks:
    disk_count: Any = None
    disk_size_gb: Any = None
    disk_type: Any = None

@dataclasses.dataclass
class AlphaNodeTemplate_NodeTypeFlexibility:
    cpus: Any = None
    local_ssd: Any = None
    memory: Any = None

@dataclasses.dataclass
class AlphaNodeTemplate_ServerBinding:
    type: Any = None

_AlphaNodeTemplate_AcceleratorsFields = {
    "accelerator_count": ubx.FieldSpec(wire_name="accelerator_count"),
    "accelerator_type": ubx.FieldSpec(wire_name="accelerator_type"),
}

_AlphaNodeTemplate_DisksFields = {
...
AlphaNodeTemplate = ubx.ResourceBinding(
    wire_type="google_compute_alpha_node_template",
    fields={
        "accelerators": ubx.FieldSpec(
            wire_name="accelerators",
            kind="list",
            fields=_AlphaNodeTemplate_AcceleratorsFields,
        ),
        ...
        "disks": ubx.FieldSpec(
            wire_name="disks",
            kind="list",
            fields=_AlphaNodeTemplate_DisksFields,
        ),
        ...
        "node_type_flexibility": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaNodeTemplate_NodeTypeFlexibilityFields,
        ),
        "server_binding": ubx.FieldSpec(
            wire_name="server_binding",
            kind="object",
            fields=_AlphaNodeTemplate_ServerBindingFields,
        ),
    },
)
