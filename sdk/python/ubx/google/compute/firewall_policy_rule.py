...
class FirewallPolicyRule_Match_Layer4Configs:
    ip_protocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class FirewallPolicyRule_Match_SrcSecureTags:
    name: Any = None
    state: Any = None

@dataclasses.dataclass
class FirewallPolicyRule_Match:
...
@dataclasses.dataclass
class FirewallPolicyRule_Timeouts:
    create: Any = None
    delete: Any = None
    update: Any = None

_FirewallPolicyRule_Match_Layer4ConfigsFields = {
    "ip_protocol": ubx.FieldSpec(wire_name="ip_protocol"),
    "ports": ubx.FieldSpec(wire_name="ports"),
}

_FirewallPolicyRule_Match_SrcSecureTagsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_FirewallPolicyRule_MatchFields = {
    ...
    "layer4_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_FirewallPolicyRule_Match_Layer4ConfigsFields,
    ),
    "src_secure_tags": ubx.FieldSpec(
        wire_name="src_secure_tags",
        kind="list",
        fields=_FirewallPolicyRule_Match_SrcSecureTagsFields,
    ),
}

_FirewallPolicyRule_TimeoutsFields = {
...
@dataclasses.dataclass
class FirewallPolicyRuleConfig:
    action: Any = None
...
FirewallPolicyRule = ubx.ResourceBinding(
    wire_type="google_compute_firewall_policy_rule",
    fields={
        ...
        "match": ubx.FieldSpec(
            wire_name="match",
            kind="list",
            fields=_FirewallPolicyRule_MatchFields,
        ),
        ...
        "timeouts": ubx.FieldSpec(
            wire_name="timeouts",
            kind="object",
            fields=_FirewallPolicyRule_TimeoutsFields,
        ),
    },
)
