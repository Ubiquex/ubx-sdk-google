# Code generated by `ubx sdk gen` from google_compute_beta_address. DO NOT EDIT.
...
BetaAddress = ubx.ResourceBinding(
    wire_type="google_compute_beta_address",
    fields={
