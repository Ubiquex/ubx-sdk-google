...
class BetaComputeBetaHttpHealthCheckConfig:
...
@dataclasses.dataclass
class BetaComputeBetaHttpHealthCheckAttrs:
    # How often (in seconds) to send a health check. The default value is5 seconds.
    check_interval_sec: Any = None
    # [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaComputeBetaHttpHealthCheck = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_http_health_check",
    fields={
