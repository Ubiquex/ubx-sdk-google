...
class BetaRegionHealthAggregationPolicyConfig:
...
@dataclasses.dataclass
class BetaRegionHealthAggregationPolicyAttrs:
...
BetaRegionHealthAggregationPolicy = ubx.ResourceBinding(
    wire_type="google_compute_beta_region_health_aggregation_policy",
    fields={
