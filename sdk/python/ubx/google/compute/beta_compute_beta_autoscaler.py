...
class BetaComputeBetaAutoscaler_AutoscalingPolicy_CpuUtilization:
...
@dataclasses.dataclass
class BetaComputeBetaAutoscaler_AutoscalingPolicy_CustomMetricUtilizations:
    filter: Any = None
    metric: Any = None
...
@dataclasses.dataclass
class BetaComputeBetaAutoscaler_AutoscalingPolicy_LoadBalancingUtilization:
    # Fraction of backend capacity utilization (set in HTTP(S) load balancing configuration) that the autoscaler maintains. Must be a positive float value. If not defined, the default is 0.8.
    utilization_target: Any = None

@dataclasses.dataclass
class BetaComputeBetaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas:
...
@dataclasses.dataclass
class BetaComputeBetaAutoscaler_AutoscalingPolicy_ScaleDownControl:
...
@dataclasses.dataclass
class BetaComputeBetaAutoscaler_AutoscalingPolicy_ScaleInControl:
    # Encapsulates numeric value that can be either absolute or relative.
...
@dataclasses.dataclass
class BetaComputeBetaAutoscaler_AutoscalingPolicy_ScalingSchedules:
...
@dataclasses.dataclass
class BetaComputeBetaAutoscaler_AutoscalingPolicy:
...
@dataclasses.dataclass
class BetaComputeBetaAutoscaler_ScalingScheduleStatus:
    last_start_time: Any = None
    next_start_time: Any = None
    state: Any = None

@dataclasses.dataclass
class BetaComputeBetaAutoscaler_StatusDetails:
    message: Any = None
    type: Any = None

_BetaComputeBetaAutoscaler_AutoscalingPolicy_CpuUtilizationFields = {
    "predictive_method": ubx.FieldSpec(wire_name="predictive_method"),
    "utilization_target": ubx.FieldSpec(wire_name="utilization_target"),
}

_BetaComputeBetaAutoscaler_AutoscalingPolicy_CustomMetricUtilizationsFields = {
...
_BetaComputeBetaAutoscaler_AutoscalingPolicy_LoadBalancingUtilizationFields = {
    "utilization_target": ubx.FieldSpec(wire_name="utilization_target"),
}

_BetaComputeBetaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicasFields = {
    "calculated": ubx.FieldSpec(wire_name="calculated"),
    "fixed": ubx.FieldSpec(wire_name="fixed"),
    "percent": ubx.FieldSpec(wire_name="percent"),
}

_BetaComputeBetaAutoscaler_AutoscalingPolicy_ScaleDownControlFields = {
    "max_scaled_down_replicas": ubx.FieldSpec(
        wire_name="max_scaled_down_replicas",
        kind="object",
        fields=_BetaComputeBetaAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicasFields,
    ),
    "time_window_sec": ubx.FieldSpec(wire_name="time_window_sec"),
}

_BetaComputeBetaAutoscaler_AutoscalingPolicy_ScaleInControlFields = {
...
_BetaComputeBetaAutoscaler_AutoscalingPolicy_ScalingSchedulesFields = {
...
_BetaComputeBetaAutoscaler_AutoscalingPolicyFields = {
    "cool_down_period_sec": ubx.FieldSpec(wire_name="cool_down_period_sec"),
    "cpu_utilization": ubx.FieldSpec(
        wire_name="cpu_utilization",
        kind="object",
        fields=_BetaComputeBetaAutoscaler_AutoscalingPolicy_CpuUtilizationFields,
    ),
    "custom_metric_utilizations": ubx.FieldSpec(
        wire_name="custom_metric_utilizations",
        kind="list",
        fields=_BetaComputeBetaAutoscaler_AutoscalingPolicy_CustomMetricUtilizationsFields,
    ),
    "load_balancing_utilization": ubx.FieldSpec(
        wire_name="load_balancing_utilization",
        kind="object",
        fields=_BetaComputeBetaAutoscaler_AutoscalingPolicy_LoadBalancingUtilizationFields,
    ),
    ...
    "scale_down_control": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaComputeBetaAutoscaler_AutoscalingPolicy_ScaleDownControlFields,
    ),
    "scale_in_control": ubx.FieldSpec(
        wire_name="scale_in_control",
        kind="object",
        fields=_BetaComputeBetaAutoscaler_AutoscalingPolicy_ScaleInControlFields,
    ),
    "scaling_schedules": ubx.FieldSpec(
        wire_name="scaling_schedules",
        kind="map",
        fields=_BetaComputeBetaAutoscaler_AutoscalingPolicy_ScalingSchedulesFields,
    ),
    "stabilization_period_sec": ubx.FieldSpec(wire_name="stabilization_period_sec"),
}

_BetaComputeBetaAutoscaler_ScalingScheduleStatusFields = {
    "last_start_time": ubx.FieldSpec(wire_name="last_start_time"),
    "next_start_time": ubx.FieldSpec(wire_name="next_start_time"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_BetaComputeBetaAutoscaler_StatusDetailsFields = {
    "message": ubx.FieldSpec(wire_name="message"),
    "type": ubx.FieldSpec(wire_name="type"),
}

@dataclasses.dataclass
class BetaComputeBetaAutoscalerConfig:
...
@dataclasses.dataclass
class BetaComputeBetaAutoscalerAttrs:
    # Cloud Autoscaler policy.
    autoscaling_policy: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaComputeBetaAutoscaler = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_autoscaler",
    fields={
        "autoscaling_policy": ubx.FieldSpec(
            wire_name="autoscaling_policy",
            kind="object",
            fields=_BetaComputeBetaAutoscaler_AutoscalingPolicyFields,
        ),
        ...
        "scaling_schedule_status": ubx.FieldSpec(
            ...
            kind="map",
            fields=_BetaComputeBetaAutoscaler_ScalingScheduleStatusFields,
        ),
        ...
        "status_details": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaAutoscaler_StatusDetailsFields,
        ),
