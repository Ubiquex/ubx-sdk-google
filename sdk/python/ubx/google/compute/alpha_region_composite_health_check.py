...
class AlphaRegionCompositeHealthCheckConfig:
...
@dataclasses.dataclass
class AlphaRegionCompositeHealthCheckAttrs:
...
AlphaRegionCompositeHealthCheck = ubx.ResourceBinding(
    wire_type="google_compute_alpha_region_composite_health_check",
    fields={
