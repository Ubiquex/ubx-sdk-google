...
class AlphaComputeAlphaRegionTargetHttpsProxyConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionTargetHttpsProxyAttrs:
    # [Deprecated] Use serverTlsPolicy instead.
    authentication: Any = None
    # [Deprecated] Use authorizationPolicy instead.
    authorization: Any = None
...
AlphaComputeAlphaRegionTargetHttpsProxy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_region_target_https_proxy",
    fields={
