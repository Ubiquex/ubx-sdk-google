...
class BetaComputeBetaDisk_AsyncPrimaryDisk:
...
@dataclasses.dataclass
class BetaComputeBetaDisk_AsyncSecondaryDisks:
    async_replication_disk: Any = None

@dataclasses.dataclass
class BetaComputeBetaDisk_DiskEncryptionKey:
...
@dataclasses.dataclass
class BetaComputeBetaDisk_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class BetaComputeBetaDisk_Params:
...
@dataclasses.dataclass
class BetaComputeBetaDisk_ResourceStatus_AsyncPrimaryDisk:
    state: Any = None

@dataclasses.dataclass
class BetaComputeBetaDisk_ResourceStatus:
    async_primary_disk: Any = None
    # Key: disk, value: AsyncReplicationStatus message
    async_secondary_disks: Any = None

_BetaComputeBetaDisk_AsyncPrimaryDiskFields = {
...
_BetaComputeBetaDisk_AsyncSecondaryDisksFields = {
    "async_replication_disk": ubx.FieldSpec(
        wire_name="async_replication_disk",
        kind="object",
        fields=_BetaComputeBetaDisk_AsyncPrimaryDiskFields,
    ),
}

_BetaComputeBetaDisk_DiskEncryptionKeyFields = {
...
_BetaComputeBetaDisk_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_BetaComputeBetaDisk_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaDisk_ResourceStatus_AsyncPrimaryDiskFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

_BetaComputeBetaDisk_ResourceStatusFields = {
    "async_primary_disk": ubx.FieldSpec(
        wire_name="async_primary_disk",
        kind="object",
        fields=_BetaComputeBetaDisk_ResourceStatus_AsyncPrimaryDiskFields,
    ),
...
@dataclasses.dataclass
class BetaComputeBetaDiskConfig:
...
@dataclasses.dataclass
class BetaComputeBetaDiskAttrs:
    # The access mode of the disk. - READ_WRITE_SINGLE: The default AccessMode, means the disk can be attached to single instance in RW mode. - READ_WRITE_MANY: The AccessMode means the disk can be attached to multiple instances in RW mode. - READ_ONLY_MANY: The AccessMode means the disk can be attached to multiple instances in RO mode. The AccessMode is only valid for Hyperdisk disk types.
    access_mode: Any = None
    # The architecture of the disk. Valid values are ARM64 or X86_64.
    architecture: Any = None
...
BetaComputeBetaDisk = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_disk",
    fields={
        ...
        "async_secondary_disks": ubx.FieldSpec(
            wire_name="async_secondary_disks",
            kind="map",
            fields=_BetaComputeBetaDisk_AsyncSecondaryDisksFields,
        ),
        ...
        "disk_encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaDisk_DiskEncryptionKeyFields,
        ),
        ...
        "guest_os_features": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaDisk_GuestOsFeaturesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaDisk_ParamsFields,
        ),
        ...
        "resource_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaDisk_ResourceStatusFields,
        ),
