...
class BetaTargetVpnGateway_Params:
...
@dataclasses.dataclass
class BetaTargetVpnGatewayAttrs:
...
BetaTargetVpnGateway = ubx.ResourceBinding(
    wire_type="google_compute_beta_target_vpn_gateway",
    fields={
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaTargetVpnGateway_ParamsFields,
        ),
