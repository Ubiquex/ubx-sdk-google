...
class BetaRegionNetworkEndpointGroup_AppEngine:
...
@dataclasses.dataclass
class BetaRegionNetworkEndpointGroup_CloudFunction:
...
@dataclasses.dataclass
class BetaRegionNetworkEndpointGroup_CloudRun:
...
@dataclasses.dataclass
class BetaRegionNetworkEndpointGroup_LoadBalancer:
...
@dataclasses.dataclass
class BetaRegionNetworkEndpointGroup_PscData:
...
@dataclasses.dataclass
class BetaRegionNetworkEndpointGroup_ServerlessDeployment:
...
_BetaRegionNetworkEndpointGroup_AppEngineFields = {
    "service": ubx.FieldSpec(wire_name="service"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_BetaRegionNetworkEndpointGroup_CloudFunctionFields = {
    "function": ubx.FieldSpec(wire_name="function"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
}

_BetaRegionNetworkEndpointGroup_CloudRunFields = {
    "service": ubx.FieldSpec(wire_name="service"),
    "tag": ubx.FieldSpec(wire_name="tag"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
}

_BetaRegionNetworkEndpointGroup_LoadBalancerFields = {
...
_BetaRegionNetworkEndpointGroup_PscDataFields = {
...
_BetaRegionNetworkEndpointGroup_ServerlessDeploymentFields = {
...
@dataclasses.dataclass
class BetaRegionNetworkEndpointGroupConfig:
...
@dataclasses.dataclass
class BetaRegionNetworkEndpointGroupAttrs:
    # Optional. Metadata defined as annotations on the network endpoint group.
    annotations: Any = None
    # Configuration for an App Engine network endpoint group (NEG). The service is optional, may be provided explicitly or in the URL mask. The version is optional and can only be provided explicitly or in the URL mask when service is present. Note: App Engine service must be in the same project and located in the same region as the Serverless NEG.
    app_engine: Any = None
...
BetaRegionNetworkEndpointGroup = ubx.ResourceBinding(
    wire_type="google_compute_beta_region_network_endpoint_group",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "app_engine": ubx.FieldSpec(
            wire_name="app_engine",
            kind="object",
            fields=_BetaRegionNetworkEndpointGroup_AppEngineFields,
        ),
        "cloud_function": ubx.FieldSpec(
            wire_name="cloud_function",
            kind="object",
            fields=_BetaRegionNetworkEndpointGroup_CloudFunctionFields,
        ),
        "cloud_run": ubx.FieldSpec(
            wire_name="cloud_run",
            kind="object",
            fields=_BetaRegionNetworkEndpointGroup_CloudRunFields,
        ),
        "default_port": ubx.FieldSpec(wire_name="default_port"),
        ...
        "load_balancer": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaRegionNetworkEndpointGroup_LoadBalancerFields,
        ),
        ...
        "psc_data": ubx.FieldSpec(
            wire_name="psc_data",
            kind="object",
            fields=_BetaRegionNetworkEndpointGroup_PscDataFields,
        ),
        ...
        "serverless_deployment": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaRegionNetworkEndpointGroup_ServerlessDeploymentFields,
        ),
        "subnetwork": ubx.FieldSpec(wire_name="subnetwork"),
    },
)
