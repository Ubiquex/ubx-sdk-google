...
class BetaComputeBetaGlobalForwardingRule_AttachedExtensions:
    reference: Any = None

@dataclasses.dataclass
class BetaComputeBetaGlobalForwardingRule_MetadataFilters_FilterLabels:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class BetaComputeBetaGlobalForwardingRule_MetadataFilters:
    filter_labels: Any = None
    filter_match_criteria: Any = None

@dataclasses.dataclass
class BetaComputeBetaGlobalForwardingRule_ServiceDirectoryRegistrations:
    namespace: Any = None
    service: Any = None
    service_directory_region: Any = None

_BetaComputeBetaGlobalForwardingRule_AttachedExtensionsFields = {
    "reference": ubx.FieldSpec(wire_name="reference"),
}

_BetaComputeBetaGlobalForwardingRule_MetadataFilters_FilterLabelsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_BetaComputeBetaGlobalForwardingRule_MetadataFiltersFields = {
    "filter_labels": ubx.FieldSpec(
        wire_name="filter_labels",
        kind="list",
        fields=_BetaComputeBetaGlobalForwardingRule_MetadataFilters_FilterLabelsFields,
    ),
    "filter_match_criteria": ubx.FieldSpec(wire_name="filter_match_criteria"),
}

_BetaComputeBetaGlobalForwardingRule_ServiceDirectoryRegistrationsFields = {
...
@dataclasses.dataclass
class BetaComputeBetaGlobalForwardingRuleConfig:
...
@dataclasses.dataclass
class BetaComputeBetaGlobalForwardingRuleAttrs:
    # The ports, portRange, and allPorts fields are mutually exclusive. Only packets addressed to ports in the specified range will be forwarded to the backends configured with this forwarding rule. The allPorts field has the following limitations: - It requires that the forwarding rule IPProtocol be TCP, UDP, SCTP, or L3_DEFAULT. - It's applicable only to the following products: internal passthrough Network Load Balancers, backend service-based external passthrough Network Load Balancers, and internal and external protocol forwarding. - Set this field to true to allow packets addressed to any port or packets lacking destination port information (for example, UDP fragments after the first fragment) to be forwarded to the backends configured with this forwarding rule. The L3_DEFAULT protocol requiresallPorts be set to true.
    all_ports: Any = None
    # If set to true, clients can access the internal passthrough Network Load Balancers, the regional internal Application Load Balancer, and the regional internal proxy Network Load Balancer from all regions. If false, only allows access from the local region the load balancer is located at. Note that for INTERNAL_MANAGED forwarding rules, this field cannot be changed after the forwarding rule is created.
    allow_global_access: Any = None
...
BetaComputeBetaGlobalForwardingRule = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_global_forwarding_rule",
    fields={
        ...
        "attached_extensions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaGlobalForwardingRule_AttachedExtensionsFields,
        ),
        ...
        "metadata_filters": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaGlobalForwardingRule_MetadataFiltersFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        ...
        "service_directory_registrations": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaGlobalForwardingRule_ServiceDirectoryRegistrationsFields,
        ),
