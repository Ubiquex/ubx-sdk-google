...
class AlphaComputeAlphaHttpHealthCheckConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaHttpHealthCheckAttrs:
    # How often (in seconds) to send a health check. The default value is5 seconds.
    check_interval_sec: Any = None
    # [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
AlphaComputeAlphaHttpHealthCheck = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_http_health_check",
    fields={
