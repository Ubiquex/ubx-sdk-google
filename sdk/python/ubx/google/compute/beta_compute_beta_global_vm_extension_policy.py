...
class BetaComputeBetaGlobalVmExtensionPolicy_ExtensionPolicies:
    pinned_version: Any = None
    string_config: Any = None

@dataclasses.dataclass
class BetaComputeBetaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelector:
    inclusion_labels: Any = None

@dataclasses.dataclass
class BetaComputeBetaGlobalVmExtensionPolicy_InstanceSelectors:
    label_selector: Any = None

@dataclasses.dataclass
class BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutInput:
...
@dataclasses.dataclass
class BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus:
    state: Any = None

@dataclasses.dataclass
class BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts:
...
@dataclasses.dataclass
class BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus:
...
@dataclasses.dataclass
class BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation:
    rollout_input: Any = None
    rollout_status: Any = None

_BetaComputeBetaGlobalVmExtensionPolicy_ExtensionPoliciesFields = {
    "pinned_version": ubx.FieldSpec(wire_name="pinned_version"),
    "string_config": ubx.FieldSpec(wire_name="string_config"),
}

_BetaComputeBetaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields = {
    "inclusion_labels": ubx.FieldSpec(wire_name="inclusion_labels"),
}

_BetaComputeBetaGlobalVmExtensionPolicy_InstanceSelectorsFields = {
    "label_selector": ubx.FieldSpec(
        wire_name="label_selector",
        kind="object",
        fields=_BetaComputeBetaGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields,
    ),
}

_BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields = {
...
_BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

_BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields = {
    "location_rollout_status": ubx.FieldSpec(
        wire_name="location_rollout_status",
        kind="map",
        fields=_BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields,
    ),
...
_BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields = {
    "current_rollouts": ubx.FieldSpec(
        wire_name="current_rollouts",
        kind="list",
        fields=_BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields,
    ),
...
_BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperationFields = {
    "rollout_input": ubx.FieldSpec(
        wire_name="rollout_input",
        kind="object",
        fields=_BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields,
    ),
    "rollout_status": ubx.FieldSpec(
        wire_name="rollout_status",
        kind="object",
        fields=_BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields,
    ),
}

@dataclasses.dataclass
class BetaComputeBetaGlobalVmExtensionPolicyConfig:
...
@dataclasses.dataclass
class BetaComputeBetaGlobalVmExtensionPolicyAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
BetaComputeBetaGlobalVmExtensionPolicy = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_global_vm_extension_policy",
    fields={
        ...
        "extension_policies": ubx.FieldSpec(
            ...
            kind="map",
            fields=_BetaComputeBetaGlobalVmExtensionPolicy_ExtensionPoliciesFields,
        ),
        "id": ubx.FieldSpec(wire_name="id"),
        "instance_selectors": ubx.FieldSpec(
            wire_name="instance_selectors",
            kind="list",
            fields=_BetaComputeBetaGlobalVmExtensionPolicy_InstanceSelectorsFields,
        ),
        ...
        "rollout_operation": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaGlobalVmExtensionPolicy_RolloutOperationFields,
        ),
