...
class NetworkFirewallPolicyRule_Match_Layer4Configs:
    ip_protocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class NetworkFirewallPolicyRule_Match_SrcSecureTags:
    name: Any = None
    state: Any = None

@dataclasses.dataclass
class NetworkFirewallPolicyRule_Match:
...
@dataclasses.dataclass
class NetworkFirewallPolicyRule_Timeouts:
    create: Any = None
    delete: Any = None
    update: Any = None

_NetworkFirewallPolicyRule_Match_Layer4ConfigsFields = {
    "ip_protocol": ubx.FieldSpec(wire_name="ip_protocol"),
    "ports": ubx.FieldSpec(wire_name="ports"),
}

_NetworkFirewallPolicyRule_Match_SrcSecureTagsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_NetworkFirewallPolicyRule_MatchFields = {
    ...
    "layer4_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_NetworkFirewallPolicyRule_Match_Layer4ConfigsFields,
    ),
    "src_secure_tags": ubx.FieldSpec(
        wire_name="src_secure_tags",
        kind="list",
        fields=_NetworkFirewallPolicyRule_Match_SrcSecureTagsFields,
    ),
}

_NetworkFirewallPolicyRule_TimeoutsFields = {
...
@dataclasses.dataclass
class NetworkFirewallPolicyRuleConfig:
    action: Any = None
...
NetworkFirewallPolicyRule = ubx.ResourceBinding(
    wire_type="google_compute_network_firewall_policy_rule",
    fields={
        ...
        "match": ubx.FieldSpec(
            wire_name="match",
            kind="list",
            fields=_NetworkFirewallPolicyRule_MatchFields,
        ),
        ...
        "timeouts": ubx.FieldSpec(
            wire_name="timeouts",
            kind="object",
            fields=_NetworkFirewallPolicyRule_TimeoutsFields,
        ),
    },
)
