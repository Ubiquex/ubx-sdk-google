...
class BetaComputeBetaAddressConfig:
...
@dataclasses.dataclass
class BetaComputeBetaAddressAttrs:
    # The static IP address represented by this resource.
    address: Any = None
    # The type of address to reserve, either INTERNAL orEXTERNAL. If unspecified, defaults to EXTERNAL.
    address_type: Any = None
...
BetaComputeBetaAddress = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_address",
    fields={
