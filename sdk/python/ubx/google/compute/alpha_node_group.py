...
class AlphaNodeGroup_AutoscalingPolicy:
...
@dataclasses.dataclass
class AlphaNodeGroup_MaintenanceWindow_MaintenanceDuration:
...
@dataclasses.dataclass
class AlphaNodeGroup_MaintenanceWindow:
...
@dataclasses.dataclass
class AlphaNodeGroup_ShareSettings_FolderMap:
    folder_id: Any = None

@dataclasses.dataclass
class AlphaNodeGroup_ShareSettings_ProjectMap:
    project_id: Any = None

@dataclasses.dataclass
class AlphaNodeGroup_ShareSettings:
...
AlphaNodeGroup = ubx.ResourceBinding(
    wire_type="google_compute_alpha_node_group",
    fields={
        "autoscaling_policy": ubx.FieldSpec(
            wire_name="autoscaling_policy",
            kind="object",
            fields=_AlphaNodeGroup_AutoscalingPolicyFields,
        ),
        ...
        "maintenance_window": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaNodeGroup_MaintenanceWindowFields,
        ),
        ...
        "share_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaNodeGroup_ShareSettingsFields,
        ),
