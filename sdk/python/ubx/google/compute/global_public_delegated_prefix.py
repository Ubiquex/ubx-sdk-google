...
@dataclasses.dataclass
class GlobalPublicDelegatedPrefixConfig:
...
@dataclasses.dataclass
class GlobalPublicDelegatedPrefixAttrs:
    # The allocatable prefix length supported by this public delegated prefix. This field is optional and cannot be set for prefixes in DELEGATION mode. It cannot be set for IPv4 prefixes either, and it always defaults to 32.
    allocatable_prefix_length: Any = None
    # Output only. [Output Only] The version of BYOIP API.
    byoip_api_version: Any = None
...
GlobalPublicDelegatedPrefix = ubx.ResourceBinding(
    wire_type="google_compute_global_public_delegated_prefix",
    fields={
        "allocatable_prefix_length": ubx.FieldSpec(wire_name="allocatable_prefix_length"),
        ...
        "public_delegated_sub_prefixs": ubx.FieldSpec(
            ...
            kind="list",
            fields=_GlobalPublicDelegatedPrefix_PublicDelegatedSubPrefixsFields,
        ),
        "region": ubx.FieldSpec(wire_name="region"),
