...
class BetaRegionTargetHttpsProxyConfig:
...
@dataclasses.dataclass
class BetaRegionTargetHttpsProxyAttrs:
    # [Deprecated] Use serverTlsPolicy instead.
    authentication: Any = None
    # [Deprecated] Use authorizationPolicy instead.
    authorization: Any = None
...
BetaRegionTargetHttpsProxy = ubx.ResourceBinding(
    wire_type="google_compute_beta_region_target_https_proxy",
    fields={
