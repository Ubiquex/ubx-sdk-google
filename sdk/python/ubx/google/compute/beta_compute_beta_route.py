...
class BetaComputeBetaRoute_AsPaths:
    as_lists: Any = None
    path_segment_type: Any = None

@dataclasses.dataclass
class BetaComputeBetaRoute_Params:
...
@dataclasses.dataclass
class BetaComputeBetaRoute_Warnings_Data:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class BetaComputeBetaRoute_Warnings:
    code: Any = None
    data: Any = None
    message: Any = None

_BetaComputeBetaRoute_AsPathsFields = {
    "as_lists": ubx.FieldSpec(wire_name="as_lists"),
    "path_segment_type": ubx.FieldSpec(wire_name="path_segment_type"),
}

_BetaComputeBetaRoute_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaRoute_Warnings_DataFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_BetaComputeBetaRoute_WarningsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "data": ubx.FieldSpec(
        wire_name="data",
        kind="list",
        fields=_BetaComputeBetaRoute_Warnings_DataFields,
    ),
    "message": ubx.FieldSpec(wire_name="message"),
}

@dataclasses.dataclass
class BetaComputeBetaRouteConfig:
...
@dataclasses.dataclass
class BetaComputeBetaRouteAttrs:
    # Output only. [Output Only] AS path.
    as_paths: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaComputeBetaRoute = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_route",
    fields={
        "as_paths": ubx.FieldSpec(
            wire_name="as_paths",
            kind="list",
            fields=_BetaComputeBetaRoute_AsPathsFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaRoute_ParamsFields,
        ),
        ...
        "warnings": ubx.FieldSpec(
            wire_name="warnings",
            kind="list",
            fields=_BetaComputeBetaRoute_WarningsFields,
        ),
    },
)
