# Code generated by `ubx sdk gen` from google_compute_alpha_global_address. DO NOT EDIT.
...
class AlphaGlobalAddressConfig:
...
AlphaGlobalAddress = ubx.ResourceBinding(
    wire_type="google_compute_alpha_global_address",
    fields={
