...
class AlphaComputeAlphaSnapshot_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaSnapshot_Params:
...
@dataclasses.dataclass
class AlphaComputeAlphaSnapshot_ResourceStatus:
...
@dataclasses.dataclass
class AlphaComputeAlphaSnapshot_SnapshotEncryptionKey:
...
_AlphaComputeAlphaSnapshot_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_AlphaComputeAlphaSnapshot_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaComputeAlphaSnapshot_ResourceStatusFields = {
    "scheduled_deletion_time": ubx.FieldSpec(wire_name="scheduled_deletion_time"),
}

_AlphaComputeAlphaSnapshot_SnapshotEncryptionKeyFields = {
...
@dataclasses.dataclass
class AlphaComputeAlphaSnapshotConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaSnapshotAttrs:
    # Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64.
    architecture: Any = None
    # Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk.
    auto_created: Any = None
...
AlphaComputeAlphaSnapshot = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_snapshot",
    fields={
        ...
        "guest_os_features": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaComputeAlphaSnapshot_GuestOsFeaturesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaComputeAlphaSnapshot_ParamsFields,
        ),
        "region": ubx.FieldSpec(wire_name="region"),
        "resource_status": ubx.FieldSpec(
            wire_name="resource_status",
            kind="object",
            fields=_AlphaComputeAlphaSnapshot_ResourceStatusFields,
        ),
        ...
        "snapshot_encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaSnapshot_SnapshotEncryptionKeyFields,
        ),
