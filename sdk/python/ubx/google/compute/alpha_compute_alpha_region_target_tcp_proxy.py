...
class AlphaComputeAlphaRegionTargetTcpProxyConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionTargetTcpProxyAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
AlphaComputeAlphaRegionTargetTcpProxy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_region_target_tcp_proxy",
    fields={
