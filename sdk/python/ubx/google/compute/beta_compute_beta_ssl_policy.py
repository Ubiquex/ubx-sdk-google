...
class BetaComputeBetaSslPolicy_Warnings_Data:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class BetaComputeBetaSslPolicy_Warnings:
    code: Any = None
    data: Any = None
    message: Any = None

_BetaComputeBetaSslPolicy_Warnings_DataFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_BetaComputeBetaSslPolicy_WarningsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "data": ubx.FieldSpec(
        wire_name="data",
        kind="list",
        fields=_BetaComputeBetaSslPolicy_Warnings_DataFields,
    ),
    "message": ubx.FieldSpec(wire_name="message"),
}

@dataclasses.dataclass
class BetaComputeBetaSslPolicyConfig:
...
@dataclasses.dataclass
class BetaComputeBetaSslPolicyAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # A list of features enabled when the selected profile is CUSTOM. The method returns the set of features that can be specified in this list. This field must be empty if the profile is notCUSTOM.
    custom_features: Any = None
...
BetaComputeBetaSslPolicy = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_ssl_policy",
    fields={
        ...
        "warnings": ubx.FieldSpec(
            wire_name="warnings",
            kind="list",
            fields=_BetaComputeBetaSslPolicy_WarningsFields,
        ),
    },
)
