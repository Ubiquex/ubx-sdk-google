...
class AlphaRegionSnapshot_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class AlphaRegionSnapshot_Params:
...
@dataclasses.dataclass
class AlphaRegionSnapshot_ResourceStatus:
...
@dataclasses.dataclass
class AlphaRegionSnapshot_SnapshotEncryptionKey:
...
_AlphaRegionSnapshot_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_AlphaRegionSnapshot_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaRegionSnapshot_ResourceStatusFields = {
    "scheduled_deletion_time": ubx.FieldSpec(wire_name="scheduled_deletion_time"),
}

_AlphaRegionSnapshot_SnapshotEncryptionKeyFields = {
...
@dataclasses.dataclass
class AlphaRegionSnapshotConfig:
...
@dataclasses.dataclass
class AlphaRegionSnapshotAttrs:
    # Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64.
    architecture: Any = None
    # Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk.
    auto_created: Any = None
...
AlphaRegionSnapshot = ubx.ResourceBinding(
    wire_type="google_compute_alpha_region_snapshot",
    fields={
        ...
        "guest_os_features": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaRegionSnapshot_GuestOsFeaturesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaRegionSnapshot_ParamsFields,
        ),
        "region": ubx.FieldSpec(wire_name="region"),
        "resource_status": ubx.FieldSpec(
            wire_name="resource_status",
            kind="object",
            fields=_AlphaRegionSnapshot_ResourceStatusFields,
        ),
        ...
        "snapshot_encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaRegionSnapshot_SnapshotEncryptionKeyFields,
        ),
