# Code generated by `ubx sdk gen` from google_compute_beta_region_instant_snapshot_group. DO NOT EDIT.
...
class BetaRegionInstantSnapshotGroup_ResourceStatus_SourceInfo:
    consistency_group: Any = None
    consistency_group_id: Any = None

@dataclasses.dataclass
class BetaRegionInstantSnapshotGroup_ResourceStatus:
    # Output only. [Output Only]
    consistency_membership_resolution_time: Any = None
    source_info: Any = None

_BetaRegionInstantSnapshotGroup_ResourceStatus_SourceInfoFields = {
...
_BetaRegionInstantSnapshotGroup_ResourceStatusFields = {
    ...
    "source_info": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaRegionInstantSnapshotGroup_ResourceStatus_SourceInfoFields,
    ),
}

@dataclasses.dataclass
class BetaRegionInstantSnapshotGroupConfig:
...
@dataclasses.dataclass
class BetaRegionInstantSnapshotGroupAttrs:
...
BetaRegionInstantSnapshotGroup = ubx.ResourceBinding(
    wire_type="google_compute_beta_region_instant_snapshot_group",
    fields={
        ...
        "resource_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaRegionInstantSnapshotGroup_ResourceStatusFields,
        ),
