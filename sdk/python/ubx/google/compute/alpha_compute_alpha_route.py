...
class AlphaComputeAlphaRoute_AsPaths:
    as_lists: Any = None
    path_segment_type: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaRoute_Params:
...
@dataclasses.dataclass
class AlphaComputeAlphaRoute_Warnings_Data:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaRoute_Warnings:
    code: Any = None
    data: Any = None
    message: Any = None

_AlphaComputeAlphaRoute_AsPathsFields = {
    "as_lists": ubx.FieldSpec(wire_name="as_lists"),
    "path_segment_type": ubx.FieldSpec(wire_name="path_segment_type"),
}

_AlphaComputeAlphaRoute_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaComputeAlphaRoute_Warnings_DataFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_AlphaComputeAlphaRoute_WarningsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "data": ubx.FieldSpec(
        wire_name="data",
        kind="list",
        fields=_AlphaComputeAlphaRoute_Warnings_DataFields,
    ),
    "message": ubx.FieldSpec(wire_name="message"),
}

@dataclasses.dataclass
class AlphaComputeAlphaRouteConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaRouteAttrs:
    # Whether this route can conflict with existing subnetworks. Setting this to true allows this route to conflict with subnetworks that have already been configured on the corresponding network.
    allow_conflicting_subnetworks: Any = None
    # Output only. [Output Only] AS path.
    as_paths: Any = None
...
AlphaComputeAlphaRoute = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_route",
    fields={
        "allow_conflicting_subnetworks": ubx.FieldSpec(wire_name="allow_conflicting_subnetworks"),
        "as_paths": ubx.FieldSpec(
            wire_name="as_paths",
            kind="list",
            fields=_AlphaComputeAlphaRoute_AsPathsFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaComputeAlphaRoute_ParamsFields,
        ),
        ...
        "warnings": ubx.FieldSpec(
            wire_name="warnings",
            kind="list",
            fields=_AlphaComputeAlphaRoute_WarningsFields,
        ),
    },
)
