...
class BetaNodeTemplate_Accelerators:
    accelerator_count: Any = None
    accelerator_type: Any = None

@dataclasses.dataclass
class BetaNodeTemplate_Disks:
    disk_count: Any = None
    disk_size_gb: Any = None
    disk_type: Any = None

@dataclasses.dataclass
class BetaNodeTemplate_NodeTypeFlexibility:
    cpus: Any = None
    local_ssd: Any = None
    memory: Any = None

@dataclasses.dataclass
class BetaNodeTemplate_ServerBinding:
    type: Any = None

_BetaNodeTemplate_AcceleratorsFields = {
    "accelerator_count": ubx.FieldSpec(wire_name="accelerator_count"),
    "accelerator_type": ubx.FieldSpec(wire_name="accelerator_type"),
}

_BetaNodeTemplate_DisksFields = {
...
BetaNodeTemplate = ubx.ResourceBinding(
    wire_type="google_compute_beta_node_template",
    fields={
