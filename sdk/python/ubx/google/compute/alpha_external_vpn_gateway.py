...
class AlphaExternalVpnGateway_Interfaces:
    id: Any = None
    ip_address: Any = None
    ipv6_address: Any = None

@dataclasses.dataclass
class AlphaExternalVpnGateway_Params:
...
@dataclasses.dataclass
class AlphaExternalVpnGatewayAttrs:
...
AlphaExternalVpnGateway = ubx.ResourceBinding(
    wire_type="google_compute_alpha_external_vpn_gateway",
    fields={
        "description": ubx.FieldSpec(wire_name="description"),
        "interfaces": ubx.FieldSpec(
            wire_name="interfaces",
            kind="list",
            fields=_AlphaExternalVpnGateway_InterfacesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaExternalVpnGateway_ParamsFields,
        ),
