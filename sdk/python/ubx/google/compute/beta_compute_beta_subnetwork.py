...
class BetaComputeBetaSubnetwork_LogConfig:
...
@dataclasses.dataclass
class BetaComputeBetaSubnetwork_Params:
...
@dataclasses.dataclass
class BetaComputeBetaSubnetwork_SecondaryIpRanges:
...
@dataclasses.dataclass
class BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIp:
    high: Any = None
    low: Any = None

@dataclasses.dataclass
class BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization:
    total_allocated_ip: Any = None
    total_free_ip: Any = None

@dataclasses.dataclass
class BetaComputeBetaSubnetwork_UtilizationDetails_Ipv4Utilizations:
    range_name: Any = None
    total_allocated_ip: Any = None
    total_free_ip: Any = None

@dataclasses.dataclass
class BetaComputeBetaSubnetwork_UtilizationDetails:
...
_BetaComputeBetaSubnetwork_LogConfigFields = {
...
_BetaComputeBetaSubnetwork_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaSubnetwork_SecondaryIpRangesFields = {
...
_BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIpFields = {
    "high": ubx.FieldSpec(wire_name="high"),
    "low": ubx.FieldSpec(wire_name="low"),
}

_BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilizationFields = {
    "total_allocated_ip": ubx.FieldSpec(
        wire_name="total_allocated_ip",
        kind="object",
        fields=_BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilization_TotalAllocatedIpFields,
    ),
...
_BetaComputeBetaSubnetwork_UtilizationDetails_Ipv4UtilizationsFields = {
    "range_name": ubx.FieldSpec(wire_name="range_name"),
    "total_allocated_ip": ubx.FieldSpec(wire_name="total_allocated_ip"),
    "total_free_ip": ubx.FieldSpec(wire_name="total_free_ip"),
}

_BetaComputeBetaSubnetwork_UtilizationDetailsFields = {
    "external_ipv6_instance_utilization": ubx.FieldSpec(
        wire_name="external_ipv6_instance_utilization",
        kind="object",
        fields=_BetaComputeBetaSubnetwork_UtilizationDetails_ExternalIpv6InstanceUtilizationFields,
    ),
    ...
    "ipv4_utilizations": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaComputeBetaSubnetwork_UtilizationDetails_Ipv4UtilizationsFields,
    ),
}

@dataclasses.dataclass
class BetaComputeBetaSubnetworkConfig:
...
@dataclasses.dataclass
class BetaComputeBetaSubnetworkAttrs:
    # Whether this subnetwork's ranges can conflict with existing custom routes. Setting this to true allows this subnetwork's primary and secondary ranges to overlap with (and contain) custom routes that have already been configured on the corresponding network. For example if a static route has range 10.1.0.0/16, a subnet range 10.0.0.0/8 could only be created if allow_conflicting_routes=true. Overlapping is only allowed on subnetwork operations; routes whose ranges conflict with this subnetwork's ranges won't be allowed unless route.allow_conflicting_subnetworks is set to true. Typically packets destined to IPs within the subnetwork (which may contain private/sensitive data) are prevented from leaving the virtual network. Setting this field to true will disable this feature. The default value is false and applies to all existing subnetworks and automatically created subnetworks.
    allow_subnet_cidr_routes_overlap: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaComputeBetaSubnetwork = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_subnetwork",
    fields={
        ...
        "log_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaSubnetwork_LogConfigFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaSubnetwork_ParamsFields,
        ),
        ...
        "secondary_ip_ranges": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaSubnetwork_SecondaryIpRangesFields,
        ),
        ...
        "utilization_details": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaSubnetwork_UtilizationDetailsFields,
        ),
    },
)
