...
class GlobalNetworkEndpointGroup_AppEngine:
...
@dataclasses.dataclass
class GlobalNetworkEndpointGroup_CloudFunction:
...
@dataclasses.dataclass
class GlobalNetworkEndpointGroup_CloudRun:
...
@dataclasses.dataclass
class GlobalNetworkEndpointGroup_PscData:
...
_GlobalNetworkEndpointGroup_AppEngineFields = {
    "service": ubx.FieldSpec(wire_name="service"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_GlobalNetworkEndpointGroup_CloudFunctionFields = {
    "function": ubx.FieldSpec(wire_name="function"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
}

_GlobalNetworkEndpointGroup_CloudRunFields = {
    "service": ubx.FieldSpec(wire_name="service"),
    "tag": ubx.FieldSpec(wire_name="tag"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
}

_GlobalNetworkEndpointGroup_PscDataFields = {
...
@dataclasses.dataclass
class GlobalNetworkEndpointGroupAttrs:
    # Optional. Metadata defined as annotations on the network endpoint group.
    annotations: Any = None
    # Configuration for an App Engine network endpoint group (NEG). The service is optional, may be provided explicitly or in the URL mask. The version is optional and can only be provided explicitly or in the URL mask when service is present. Note: App Engine service must be in the same project and located in the same region as the Serverless NEG.
    app_engine: Any = None
...
GlobalNetworkEndpointGroup = ubx.ResourceBinding(
    ...
    fields={
        ...
        "app_engine": ubx.FieldSpec(
            ...
            kind="object",
            fields=_GlobalNetworkEndpointGroup_AppEngineFields,
        ),
        "cloud_function": ubx.FieldSpec(
            wire_name="cloud_function",
            kind="object",
            fields=_GlobalNetworkEndpointGroup_CloudFunctionFields,
        ),
        "cloud_run": ubx.FieldSpec(
            wire_name="cloud_run",
            kind="object",
            fields=_GlobalNetworkEndpointGroup_CloudRunFields,
        ),
        ...
        "psc_data": ubx.FieldSpec(
            wire_name="psc_data",
            kind="object",
            fields=_GlobalNetworkEndpointGroup_PscDataFields,
        ),
