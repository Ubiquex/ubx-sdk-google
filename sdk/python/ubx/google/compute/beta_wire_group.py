...
class BetaWireGroup_Endpoints_Interconnects:
    interconnect: Any = None
    vlan_tags: Any = None

@dataclasses.dataclass
class BetaWireGroup_Endpoints:
    interconnects: Any = None

@dataclasses.dataclass
class BetaWireGroup_Topology_Endpoints:
    city: Any = None
    label: Any = None

@dataclasses.dataclass
class BetaWireGroup_Topology:
    # Output only. Topology details for all endpoints in the wire group.
    endpoints: Any = None

@dataclasses.dataclass
class BetaWireGroup_WireGroupProperties:
...
@dataclasses.dataclass
class BetaWireGroup_WireProperties:
...
@dataclasses.dataclass
class BetaWireGroup_Wires_Endpoints:
    interconnect: Any = None
    vlan_tag: Any = None

@dataclasses.dataclass
class BetaWireGroup_Wires:
    admin_enabled: Any = None
    endpoints: Any = None
    label: Any = None
    wire_properties: Any = None

_BetaWireGroup_Endpoints_InterconnectsFields = {
    "interconnect": ubx.FieldSpec(wire_name="interconnect"),
    "vlan_tags": ubx.FieldSpec(wire_name="vlan_tags"),
}

_BetaWireGroup_EndpointsFields = {
    "interconnects": ubx.FieldSpec(
        wire_name="interconnects",
        kind="map",
        fields=_BetaWireGroup_Endpoints_InterconnectsFields,
    ),
}

_BetaWireGroup_Topology_EndpointsFields = {
    "city": ubx.FieldSpec(wire_name="city"),
    "label": ubx.FieldSpec(wire_name="label"),
}

_BetaWireGroup_TopologyFields = {
    "endpoints": ubx.FieldSpec(
        wire_name="endpoints",
        kind="list",
        fields=_BetaWireGroup_Topology_EndpointsFields,
    ),
}

_BetaWireGroup_WireGroupPropertiesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_BetaWireGroup_WirePropertiesFields = {
...
_BetaWireGroup_Wires_EndpointsFields = {
    "interconnect": ubx.FieldSpec(wire_name="interconnect"),
    "vlan_tag": ubx.FieldSpec(wire_name="vlan_tag"),
}

_BetaWireGroup_WiresFields = {
    "admin_enabled": ubx.FieldSpec(wire_name="admin_enabled"),
    "endpoints": ubx.FieldSpec(
        wire_name="endpoints",
        kind="list",
        fields=_BetaWireGroup_Wires_EndpointsFields,
    ),
    "label": ubx.FieldSpec(wire_name="label"),
    "wire_properties": ubx.FieldSpec(
        wire_name="wire_properties",
        kind="object",
        fields=_BetaWireGroup_WirePropertiesFields,
    ),
}

@dataclasses.dataclass
class BetaWireGroupConfig:
...
BetaWireGroup = ubx.ResourceBinding(
    wire_type="google_compute_beta_wire_group",
    fields={
        "admin_enabled": ubx.FieldSpec(wire_name="admin_enabled"),
        ...
        "endpoints": ubx.FieldSpec(
            wire_name="endpoints",
            kind="map",
            fields=_BetaWireGroup_EndpointsFields,
        ),
        ...
        "topology": ubx.FieldSpec(
            wire_name="topology",
            kind="object",
            fields=_BetaWireGroup_TopologyFields,
        ),
        "wire_group_properties": ubx.FieldSpec(
            wire_name="wire_group_properties",
            kind="object",
            fields=_BetaWireGroup_WireGroupPropertiesFields,
        ),
        "wire_properties": ubx.FieldSpec(
            wire_name="wire_properties",
            kind="object",
        ...
        "wires": ubx.FieldSpec(
            wire_name="wires",
            kind="list",
            fields=_BetaWireGroup_WiresFields,
        ),
    },
)
