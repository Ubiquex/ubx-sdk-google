...
@dataclasses.dataclass
class BetaNetwork_Peerings_ConnectionStatus_ConsensusState:
    delete_status: Any = None
    update_status: Any = None

@dataclasses.dataclass
class BetaNetwork_Peerings_ConnectionStatus_TrafficConfiguration:
...
@dataclasses.dataclass
class BetaNetwork_RoutingConfig:
...
BetaNetwork = ubx.ResourceBinding(
