# Code generated by `ubx sdk gen` from google_compute_alpha_region_health_source. DO NOT EDIT.
...
class AlphaRegionHealthSourceConfig:
...
@dataclasses.dataclass
class AlphaRegionHealthSourceAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
AlphaRegionHealthSource = ubx.ResourceBinding(
    wire_type="google_compute_alpha_region_health_source",
    fields={
