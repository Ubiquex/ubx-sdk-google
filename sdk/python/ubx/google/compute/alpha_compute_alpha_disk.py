...
class AlphaComputeAlphaDisk_AsyncPrimaryDisk:
...
@dataclasses.dataclass
class AlphaComputeAlphaDisk_AsyncSecondaryDisks:
    async_replication_disk: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaDisk_DiskEncryptionKey:
...
@dataclasses.dataclass
class AlphaComputeAlphaDisk_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaDisk_Params:
...
@dataclasses.dataclass
class AlphaComputeAlphaDisk_ResourceStatus_AsyncPrimaryDisk:
    state: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaDisk_ResourceStatus:
...
_AlphaComputeAlphaDisk_AsyncPrimaryDiskFields = {
...
_AlphaComputeAlphaDisk_AsyncSecondaryDisksFields = {
    "async_replication_disk": ubx.FieldSpec(
        wire_name="async_replication_disk",
        kind="object",
        fields=_AlphaComputeAlphaDisk_AsyncPrimaryDiskFields,
    ),
}

_AlphaComputeAlphaDisk_DiskEncryptionKeyFields = {
...
_AlphaComputeAlphaDisk_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_AlphaComputeAlphaDisk_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaComputeAlphaDisk_ResourceStatus_AsyncPrimaryDiskFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

_AlphaComputeAlphaDisk_ResourceStatusFields = {
    "async_primary_disk": ubx.FieldSpec(
        wire_name="async_primary_disk",
        kind="object",
        fields=_AlphaComputeAlphaDisk_ResourceStatus_AsyncPrimaryDiskFields,
    ),
...
@dataclasses.dataclass
class AlphaComputeAlphaDiskConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaDiskAttrs:
    # The access mode of the disk. - READ_WRITE_SINGLE: The default AccessMode, means the disk can be attached to single instance in RW mode. - READ_WRITE_MANY: The AccessMode means the disk can be attached to multiple instances in RW mode. - READ_ONLY_MANY: The AccessMode means the disk can be attached to multiple instances in RO mode. The AccessMode is only valid for Hyperdisk disk types.
    access_mode: Any = None
    # The architecture of the disk. Valid values are ARM64 or X86_64.
    architecture: Any = None
...
AlphaComputeAlphaDisk = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_disk",
    fields={
        ...
        "async_secondary_disks": ubx.FieldSpec(
            wire_name="async_secondary_disks",
            kind="map",
            fields=_AlphaComputeAlphaDisk_AsyncSecondaryDisksFields,
        ),
        ...
        "disk_encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaDisk_DiskEncryptionKeyFields,
        ),
        ...
        "guest_os_features": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaComputeAlphaDisk_GuestOsFeaturesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaComputeAlphaDisk_ParamsFields,
        ),
        ...
        "resource_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaDisk_ResourceStatusFields,
        ),
