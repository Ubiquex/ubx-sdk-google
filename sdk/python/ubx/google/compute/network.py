...
_Network_Peerings_ConnectionStatus_ConsensusStateFields = {
    "delete_status": ubx.FieldSpec(wire_name="delete_status"),
    "update_status": ubx.FieldSpec(wire_name="update_status"),
}

_Network_Peerings_ConnectionStatus_TrafficConfigurationFields = {
...
Network = ubx.ResourceBinding(
    ...
    fields={
        ...
        "peerings": ubx.FieldSpec(
            wire_name="peerings",
            kind="list",
            fields=_Network_PeeringsFields,
        ),
