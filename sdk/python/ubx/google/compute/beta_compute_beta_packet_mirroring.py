...
class BetaComputeBetaPacketMirroring_CollectorIlb:
...
@dataclasses.dataclass
class BetaComputeBetaPacketMirroring_Filter:
...
@dataclasses.dataclass
class BetaComputeBetaPacketMirroring_MirroredResources:
...
_BetaComputeBetaPacketMirroring_CollectorIlbFields = {
    "canonical_url": ubx.FieldSpec(wire_name="canonical_url"),
    "url": ubx.FieldSpec(wire_name="url"),
}

_BetaComputeBetaPacketMirroring_FilterFields = {
...
_BetaComputeBetaPacketMirroring_MirroredResourcesFields = {
    "instances": ubx.FieldSpec(
        wire_name="instances",
        kind="list",
        fields=_BetaComputeBetaPacketMirroring_CollectorIlbFields,
    ),
...
@dataclasses.dataclass
class BetaComputeBetaPacketMirroringConfig:
...
@dataclasses.dataclass
class BetaComputeBetaPacketMirroringAttrs:
    collector_ilb: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
...
BetaComputeBetaPacketMirroring = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_packet_mirroring",
    fields={
        ...
        "filter": ubx.FieldSpec(
            wire_name="filter",
            kind="object",
            fields=_BetaComputeBetaPacketMirroring_FilterFields,
        ),
        ...
        "mirrored_resources": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaPacketMirroring_MirroredResourcesFields,
        ),
