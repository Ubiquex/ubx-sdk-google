# Code generated by `ubx sdk gen` from google_compute_alpha_compute_alpha_region_composite_health_check. DO NOT EDIT.
...
class AlphaComputeAlphaRegionCompositeHealthCheckConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaRegionCompositeHealthCheckAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
AlphaComputeAlphaRegionCompositeHealthCheck = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_region_composite_health_check",
    fields={
