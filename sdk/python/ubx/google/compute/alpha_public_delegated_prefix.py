...
class AlphaPublicDelegatedPrefix_PublicDelegatedSubPrefixs:
...
_AlphaPublicDelegatedPrefix_PublicDelegatedSubPrefixsFields = {
...
@dataclasses.dataclass
class AlphaPublicDelegatedPrefixConfig:
...
@dataclasses.dataclass
class AlphaPublicDelegatedPrefixAttrs:
    # The allocatable prefix length supported by this public delegated prefix. This field is optional and cannot be set for prefixes in DELEGATION mode. It cannot be set for IPv4 prefixes either, and it always defaults to 32.
    allocatable_prefix_length: Any = None
...
AlphaPublicDelegatedPrefix = ubx.ResourceBinding(
    wire_type="google_compute_alpha_public_delegated_prefix",
    fields={
        "allocatable_prefix_length": ubx.FieldSpec(wire_name="allocatable_prefix_length"),
        "description": ubx.FieldSpec(wire_name="description"),
        ...
        "public_delegated_sub_prefixs": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaPublicDelegatedPrefix_PublicDelegatedSubPrefixsFields,
        ),
        "purpose": ubx.FieldSpec(wire_name="purpose"),
        "status": ubx.FieldSpec(wire_name="status"),
    },
