...
class BetaRegionAutoscaler_AutoscalingPolicy_CpuUtilization:
...
@dataclasses.dataclass
class BetaRegionAutoscaler_AutoscalingPolicy_CustomMetricUtilizations:
    filter: Any = None
    metric: Any = None
...
@dataclasses.dataclass
class BetaRegionAutoscaler_AutoscalingPolicy_LoadBalancingUtilization:
    # Fraction of backend capacity utilization (set in HTTP(S) load balancing configuration) that the autoscaler maintains. Must be a positive float value. If not defined, the default is 0.8.
    utilization_target: Any = None

@dataclasses.dataclass
class BetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicas:
...
@dataclasses.dataclass
class BetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl:
...
@dataclasses.dataclass
class BetaRegionAutoscaler_AutoscalingPolicy_ScaleInControl:
    # Encapsulates numeric value that can be either absolute or relative.
...
@dataclasses.dataclass
class BetaRegionAutoscaler_AutoscalingPolicy_ScalingSchedules:
...
@dataclasses.dataclass
class BetaRegionAutoscaler_AutoscalingPolicy:
...
@dataclasses.dataclass
class BetaRegionAutoscaler_ScalingScheduleStatus:
    last_start_time: Any = None
    next_start_time: Any = None
    state: Any = None

@dataclasses.dataclass
class BetaRegionAutoscaler_StatusDetails:
    message: Any = None
    type: Any = None

_BetaRegionAutoscaler_AutoscalingPolicy_CpuUtilizationFields = {
    "predictive_method": ubx.FieldSpec(wire_name="predictive_method"),
    "utilization_target": ubx.FieldSpec(wire_name="utilization_target"),
}

_BetaRegionAutoscaler_AutoscalingPolicy_CustomMetricUtilizationsFields = {
...
_BetaRegionAutoscaler_AutoscalingPolicy_LoadBalancingUtilizationFields = {
    "utilization_target": ubx.FieldSpec(wire_name="utilization_target"),
}

_BetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicasFields = {
    "calculated": ubx.FieldSpec(wire_name="calculated"),
    "fixed": ubx.FieldSpec(wire_name="fixed"),
    "percent": ubx.FieldSpec(wire_name="percent"),
}

_BetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControlFields = {
    "max_scaled_down_replicas": ubx.FieldSpec(
        wire_name="max_scaled_down_replicas",
        kind="object",
        fields=_BetaRegionAutoscaler_AutoscalingPolicy_ScaleDownControl_MaxScaledDownReplicasFields,
    ),
    "time_window_sec": ubx.FieldSpec(wire_name="time_window_sec"),
}

_BetaRegionAutoscaler_AutoscalingPolicy_ScaleInControlFields = {
...
_BetaRegionAutoscaler_AutoscalingPolicy_ScalingSchedulesFields = {
...
@dataclasses.dataclass
class BetaRegionAutoscalerAttrs:
    # Cloud Autoscaler policy.
    autoscaling_policy: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaRegionAutoscaler = ubx.ResourceBinding(
    wire_type="google_compute_beta_region_autoscaler",
    fields={
        "autoscaling_policy": ubx.FieldSpec(
            wire_name="autoscaling_policy",
            kind="object",
            fields=_BetaRegionAutoscaler_AutoscalingPolicyFields,
        ),
        ...
        "scaling_schedule_status": ubx.FieldSpec(
            ...
            kind="map",
            fields=_BetaRegionAutoscaler_ScalingScheduleStatusFields,
        ),
        ...
        "status_details": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaRegionAutoscaler_StatusDetailsFields,
        ),
