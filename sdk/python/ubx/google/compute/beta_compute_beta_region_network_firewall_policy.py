...
class BetaComputeBetaRegionNetworkFirewallPolicy_Associations:
...
@dataclasses.dataclass
class BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs:
    ip_protocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags:
    name: Any = None
    state: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match:
...
@dataclasses.dataclass
class BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules:
    action: Any = None
...
_BetaComputeBetaRegionNetworkFirewallPolicy_AssociationsFields = {
...
_BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields = {
    "ip_protocol": ubx.FieldSpec(wire_name="ip_protocol"),
    "ports": ubx.FieldSpec(wire_name="ports"),
}

_BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_MatchFields = {
    ...
    "layer4_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields,
    ),
    ...
    "src_secure_tags": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields,
    ),
    "src_threat_intelligences": ubx.FieldSpec(wire_name="src_threat_intelligences"),
}

_BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRulesFields = {
    ...
    "match": ubx.FieldSpec(
        wire_name="match",
        kind="object",
        fields=_BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRules_MatchFields,
    ),
    "priority": ubx.FieldSpec(wire_name="priority"),
...
@dataclasses.dataclass
class BetaComputeBetaRegionNetworkFirewallPolicyConfig:
...
@dataclasses.dataclass
class BetaComputeBetaRegionNetworkFirewallPolicyAttrs:
    # A list of associations that belong to this firewall policy.
    associations: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaComputeBetaRegionNetworkFirewallPolicy = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_region_network_firewall_policy",
    fields={
        "associations": ubx.FieldSpec(
            wire_name="associations",
            kind="list",
            fields=_BetaComputeBetaRegionNetworkFirewallPolicy_AssociationsFields,
        ),
        ...
        "packet_mirroring_rules": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaRegionNetworkFirewallPolicy_PacketMirroringRulesFields,
        ),
