...
class AlphaComputeAlphaTargetGrpcProxyConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaTargetGrpcProxyAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
AlphaComputeAlphaTargetGrpcProxy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_target_grpc_proxy",
    fields={
