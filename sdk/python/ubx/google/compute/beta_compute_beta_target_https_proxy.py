...
class BetaComputeBetaTargetHttpsProxyConfig:
...
@dataclasses.dataclass
class BetaComputeBetaTargetHttpsProxyAttrs:
    # [Deprecated] Use serverTlsPolicy instead.
    authentication: Any = None
    # [Deprecated] Use authorizationPolicy instead.
    authorization: Any = None
...
BetaComputeBetaTargetHttpsProxy = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_target_https_proxy",
    fields={
