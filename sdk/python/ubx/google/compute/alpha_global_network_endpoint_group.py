...
class AlphaGlobalNetworkEndpointGroup_AppEngine:
...
@dataclasses.dataclass
class AlphaGlobalNetworkEndpointGroup_CloudFunction:
...
@dataclasses.dataclass
class AlphaGlobalNetworkEndpointGroup_CloudRun:
...
@dataclasses.dataclass
class AlphaGlobalNetworkEndpointGroup_LoadBalancer:
...
@dataclasses.dataclass
class AlphaGlobalNetworkEndpointGroup_PscData:
...
@dataclasses.dataclass
class AlphaGlobalNetworkEndpointGroup_ServerlessDeployment:
...
_AlphaGlobalNetworkEndpointGroup_AppEngineFields = {
    "service": ubx.FieldSpec(wire_name="service"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_AlphaGlobalNetworkEndpointGroup_CloudFunctionFields = {
    "function": ubx.FieldSpec(wire_name="function"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
}

_AlphaGlobalNetworkEndpointGroup_CloudRunFields = {
    "service": ubx.FieldSpec(wire_name="service"),
    "tag": ubx.FieldSpec(wire_name="tag"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
}

_AlphaGlobalNetworkEndpointGroup_LoadBalancerFields = {
...
_AlphaGlobalNetworkEndpointGroup_PscDataFields = {
...
_AlphaGlobalNetworkEndpointGroup_ServerlessDeploymentFields = {
...
@dataclasses.dataclass
class AlphaGlobalNetworkEndpointGroupConfig:
...
@dataclasses.dataclass
class AlphaGlobalNetworkEndpointGroupAttrs:
    # Optional. Metadata defined as annotations on the network endpoint group.
    annotations: Any = None
    # Configuration for an App Engine network endpoint group (NEG). The service is optional, may be provided explicitly or in the URL mask. The version is optional and can only be provided explicitly or in the URL mask when service is present. Note: App Engine service must be in the same project and located in the same region as the Serverless NEG.
    app_engine: Any = None
...
AlphaGlobalNetworkEndpointGroup = ubx.ResourceBinding(
    wire_type="google_compute_alpha_global_network_endpoint_group",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "app_engine": ubx.FieldSpec(
            wire_name="app_engine",
            kind="object",
            fields=_AlphaGlobalNetworkEndpointGroup_AppEngineFields,
        ),
        "cloud_function": ubx.FieldSpec(
            wire_name="cloud_function",
            kind="object",
            fields=_AlphaGlobalNetworkEndpointGroup_CloudFunctionFields,
        ),
        "cloud_run": ubx.FieldSpec(
            wire_name="cloud_run",
            kind="object",
            fields=_AlphaGlobalNetworkEndpointGroup_CloudRunFields,
        ),
        ...
        "load_balancer": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaGlobalNetworkEndpointGroup_LoadBalancerFields,
        ),
        ...
        "psc_data": ubx.FieldSpec(
            wire_name="psc_data",
            kind="object",
            fields=_AlphaGlobalNetworkEndpointGroup_PscDataFields,
        ),
        ...
        "serverless_deployment": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaGlobalNetworkEndpointGroup_ServerlessDeploymentFields,
        ),
