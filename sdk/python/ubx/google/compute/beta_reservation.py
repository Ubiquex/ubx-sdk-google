...
class BetaReservation_AdvancedDeploymentControl:
    # Indicates chosen reservation operational mode for the reservation.
    reservation_operational_mode: Any = None

@dataclasses.dataclass
class BetaReservation_AggregateReservation_InUseResources_Accelerator:
    accelerator_count: Any = None
    accelerator_type: Any = None

@dataclasses.dataclass
class BetaReservation_AggregateReservation_InUseResources:
    accelerator: Any = None

@dataclasses.dataclass
class BetaReservation_AggregateReservation:
...
@dataclasses.dataclass
class BetaReservation_DeleteAfterDuration:
...
@dataclasses.dataclass
class BetaReservation_ReservationSharingPolicy:
    # Sharing config for all Google Cloud services.
    service_share_type: Any = None

@dataclasses.dataclass
class BetaReservation_ResourceStatus_HealthInfo:
...
@dataclasses.dataclass
class BetaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenance:
...
@dataclasses.dataclass
class BetaReservation_ResourceStatus_ReservationMaintenance:
...
@dataclasses.dataclass
class BetaReservation_ResourceStatus_SpecificSkuAllocation:
...
@dataclasses.dataclass
class BetaReservation_ResourceStatus:
...
@dataclasses.dataclass
class BetaReservation_ShareSettings_FolderMap:
    folder_id: Any = None

@dataclasses.dataclass
class BetaReservation_ShareSettings_ProjectMap:
    project_id: Any = None

@dataclasses.dataclass
class BetaReservation_ShareSettings:
...
@dataclasses.dataclass
class BetaReservation_SpecificReservation_InstanceProperties_LocalSsds:
    disk_size_gb: Any = None
    interface: Any = None

@dataclasses.dataclass
class BetaReservation_SpecificReservation_InstanceProperties:
...
@dataclasses.dataclass
class BetaReservation_SpecificReservation:
...
_BetaReservation_AdvancedDeploymentControlFields = {
    "reservation_operational_mode": ubx.FieldSpec(wire_name="reservation_operational_mode"),
}

_BetaReservation_AggregateReservation_InUseResources_AcceleratorFields = {
    "accelerator_count": ubx.FieldSpec(wire_name="accelerator_count"),
    "accelerator_type": ubx.FieldSpec(wire_name="accelerator_type"),
}

_BetaReservation_AggregateReservation_InUseResourcesFields = {
    "accelerator": ubx.FieldSpec(
        wire_name="accelerator",
        kind="object",
        fields=_BetaReservation_AggregateReservation_InUseResources_AcceleratorFields,
    ),
}

_BetaReservation_AggregateReservationFields = {
    ...
    "in_use_resources": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaReservation_AggregateReservation_InUseResourcesFields,
    ),
...
_BetaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenanceFields = {
...
_BetaReservation_ResourceStatus_ReservationMaintenanceFields = {
    ...
    "upcoming_group_maintenance": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaReservation_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenanceFields,
    ),
}

_BetaReservation_ResourceStatus_SpecificSkuAllocationFields = {
...
_BetaReservation_ResourceStatusFields = {
    "health_info": ubx.FieldSpec(
        wire_name="health_info",
        kind="object",
        fields=_BetaReservation_ResourceStatus_HealthInfoFields,
    ),
    ...
    "reservation_maintenance": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaReservation_ResourceStatus_ReservationMaintenanceFields,
    ),
    "specific_sku_allocation": ubx.FieldSpec(
        wire_name="specific_sku_allocation",
        kind="object",
        fields=_BetaReservation_ResourceStatus_SpecificSkuAllocationFields,
    ),
}

_BetaReservation_ShareSettings_FolderMapFields = {
    "folder_id": ubx.FieldSpec(wire_name="folder_id"),
}

_BetaReservation_ShareSettings_ProjectMapFields = {
    "project_id": ubx.FieldSpec(wire_name="project_id"),
}

_BetaReservation_ShareSettingsFields = {
    "folder_map": ubx.FieldSpec(
        wire_name="folder_map",
        kind="map",
        fields=_BetaReservation_ShareSettings_FolderMapFields,
    ),
    "project_map": ubx.FieldSpec(
        wire_name="project_map",
        kind="map",
        fields=_BetaReservation_ShareSettings_ProjectMapFields,
    ),
    "projects": ubx.FieldSpec(wire_name="projects"),
    "share_type": ubx.FieldSpec(wire_name="share_type"),
}

_BetaReservation_SpecificReservation_InstanceProperties_LocalSsdsFields = {
    "disk_size_gb": ubx.FieldSpec(wire_name="disk_size_gb"),
    "interface": ubx.FieldSpec(wire_name="interface"),
}

_BetaReservation_SpecificReservation_InstancePropertiesFields = {
    ...
    "local_ssds": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaReservation_SpecificReservation_InstanceProperties_LocalSsdsFields,
    ),
...
_BetaReservation_SpecificReservationFields = {
    ...
    "instance_properties": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaReservation_SpecificReservation_InstancePropertiesFields,
    ),
    "source_instance_template": ubx.FieldSpec(wire_name="source_instance_template"),
}

@dataclasses.dataclass
class BetaReservationConfig:
...
BetaReservation = ubx.ResourceBinding(
    wire_type="google_compute_beta_reservation",
    fields={
        "advanced_deployment_control": ubx.FieldSpec(
            wire_name="advanced_deployment_control",
            kind="object",
            fields=_BetaReservation_AdvancedDeploymentControlFields,
        ),
        ...
        "delete_after_duration": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaReservation_DeleteAfterDurationFields,
        ),
        ...
        "reservation_sharing_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaReservation_ReservationSharingPolicyFields,
        ),
        ...
        "share_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaReservation_ShareSettingsFields,
        ),
