...
class AlphaComputeAlphaInstanceGroup_NamedPorts:
    name: Any = None
    port: Any = None

_AlphaComputeAlphaInstanceGroup_NamedPortsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "port": ubx.FieldSpec(wire_name="port"),
}

@dataclasses.dataclass
class AlphaComputeAlphaInstanceGroupConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaInstanceGroupAttrs:
    # Output only. [Output Only] The creation timestamp for this instance group inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
AlphaComputeAlphaInstanceGroup = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_instance_group",
    fields={
        ...
        "named_ports": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaComputeAlphaInstanceGroup_NamedPortsFields,
        ),
