...
_ForwardingRule_MetadataFiltersFields = {
    "filter_labels": ubx.FieldSpec(
        wire_name="filter_labels",
        kind="list",
        fields=_ForwardingRule_MetadataFilters_FilterLabelsFields,
    ),
...
ForwardingRule = ubx.ResourceBinding(
    ...
    fields={
        ...
        "metadata_filters": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ForwardingRule_MetadataFiltersFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
