...
class AlphaInstanceGroupManager_AllInstancesConfig_Properties:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_AllInstancesConfig:
    # Represents the change that you want to make to the instance properties.
    properties: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_AutoHealingPolicies_AutoHealingTriggers:
    on_health_check: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_AutoHealingPolicies_MaxUnavailable:
    calculated: Any = None
    fixed: Any = None
    percent: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_AutoHealingPolicies:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_CurrentActions:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_DistributionPolicy_Zones:
    zone: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_DistributionPolicy:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_DiskEncryptionKey:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_InitializeParams:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_ShieldedInstanceInitialState_Dbs:
    content: Any = None
    file_type: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_ShieldedInstanceInitialState:
    dbs: Any = None
    dbxs: Any = None
    keks: Any = None
    pk: Any = None
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks:
    architecture: Any = None
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists:
    disks: Any = None
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_InstanceFlexibilityPolicy_ProvisioningModelMix:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_InstanceFlexibilityPolicy:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_InstanceLifecyclePolicy_MetadataBasedReadinessSignal:
    # The number of seconds to wait for a readiness signal during initialization before timing out.
    timeout_sec: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_InstanceLifecyclePolicy_OnRepair:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_InstanceLifecyclePolicy:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_NamedPorts:
    name: Any = None
    port: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_Params:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_ResourcePolicies:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_StandbyPolicy:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_StatefulPolicy_PreservedState_Disks:
    auto_delete: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_StatefulPolicy_PreservedState:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_StatefulPolicy:
    # Configuration of preserved resources.
    preserved_state: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_AllInstancesConfig:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_ErrorInfo:
    domain: Any = None
    metadatas: Any = None
    reason: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_Help_Links:
    description: Any = None
    url: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_Help:
    links: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_LocalizedMessage:
    locale: Any = None
    message: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_QuotaInfo:
    dimensions: Any = None
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails:
    error_info: Any = None
    help: Any = None
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors:
    code: Any = None
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error:
    errors: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails:
    error: Any = None
    timestamp: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies:
    accelerator_topology: Any = None
    state: Any = None
    state_details: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_BulkInstanceOperation:
    # Output only. Informs whether bulk instance operation is in progress.
    in_progress: Any = None
    last_progress_check: Any = None

@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_CurrentInstanceStatuses:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_Stateful_PerInstanceConfigs:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_Stateful:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_Status_VersionTarget:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_Status:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_TargetSizePolicy:
...
@dataclasses.dataclass
class AlphaInstanceGroupManager_Versions:
    instance_template: Any = None
    name: Any = None
    tag: Any = None
    target_size: Any = None

_AlphaInstanceGroupManager_AllInstancesConfig_PropertiesFields = {
    "expose_host_topology": ubx.FieldSpec(wire_name="expose_host_topology"),
    "labels": ubx.FieldSpec(wire_name="labels"),
    "metadata": ubx.FieldSpec(wire_name="metadata"),
}

_AlphaInstanceGroupManager_AllInstancesConfigFields = {
    "properties": ubx.FieldSpec(
        wire_name="properties",
        kind="object",
        fields=_AlphaInstanceGroupManager_AllInstancesConfig_PropertiesFields,
    ),
}

_AlphaInstanceGroupManager_AutoHealingPolicies_AutoHealingTriggersFields = {
    "on_health_check": ubx.FieldSpec(wire_name="on_health_check"),
}

_AlphaInstanceGroupManager_AutoHealingPolicies_MaxUnavailableFields = {
    "calculated": ubx.FieldSpec(wire_name="calculated"),
    "fixed": ubx.FieldSpec(wire_name="fixed"),
    "percent": ubx.FieldSpec(wire_name="percent"),
}

_AlphaInstanceGroupManager_AutoHealingPoliciesFields = {
    "auto_healing_triggers": ubx.FieldSpec(
        wire_name="auto_healing_triggers",
        kind="object",
        fields=_AlphaInstanceGroupManager_AutoHealingPolicies_AutoHealingTriggersFields,
    ),
    ...
    "max_unavailable": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaInstanceGroupManager_AutoHealingPolicies_MaxUnavailableFields,
    ),
}

_AlphaInstanceGroupManager_CurrentActionsFields = {
...
_AlphaInstanceGroupManager_DistributionPolicy_ZonesFields = {
    "zone": ubx.FieldSpec(wire_name="zone"),
}

_AlphaInstanceGroupManager_DistributionPolicyFields = {
    "target_shape": ubx.FieldSpec(wire_name="target_shape"),
    "zones": ubx.FieldSpec(
        wire_name="zones",
        kind="list",
        fields=_AlphaInstanceGroupManager_DistributionPolicy_ZonesFields,
    ),
}

_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_DiskEncryptionKeyFields = {
...
_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_InitializeParamsFields = {
    ...
    "guest_os_features": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_GuestOsFeaturesFields,
    ),
    ...
    "source_image_encryption_key": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_DiskEncryptionKeyFields,
    ),
...
_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_ShieldedInstanceInitialState_DbsFields = {
    "content": ubx.FieldSpec(wire_name="content"),
    "file_type": ubx.FieldSpec(wire_name="file_type"),
}

_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_ShieldedInstanceInitialStateFields = {
    "dbs": ubx.FieldSpec(
        wire_name="dbs",
        kind="list",
        fields=_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_ShieldedInstanceInitialState_DbsFields,
    ),
    "dbxs": ubx.FieldSpec(
        wire_name="dbxs",
        kind="list",
...
_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_DisksFields = {
    "architecture": ubx.FieldSpec(wire_name="architecture"),
    ...
    "initialize_params": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_InitializeParamsFields,
    ),
    "interface": ubx.FieldSpec(wire_name="interface"),
    ...
    "shielded_instance_initial_state": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_Disks_ShieldedInstanceInitialStateFields,
    ),
    "source": ubx.FieldSpec(wire_name="source"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionListsFields = {
    "disks": ubx.FieldSpec(
        wire_name="disks",
        kind="list",
        fields=_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionLists_DisksFields,
    ),
...
_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_ProvisioningModelMixFields = {
...
_AlphaInstanceGroupManager_InstanceFlexibilityPolicyFields = {
    "instance_selection_lists": ubx.FieldSpec(
        wire_name="instance_selection_lists",
        kind="map",
        fields=_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionListsFields,
    ),
    ...
    "provisioning_model_mix": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaInstanceGroupManager_InstanceFlexibilityPolicy_ProvisioningModelMixFields,
    ),
}

_AlphaInstanceGroupManager_InstanceLifecyclePolicy_MetadataBasedReadinessSignalFields = {
    "timeout_sec": ubx.FieldSpec(wire_name="timeout_sec"),
}

_AlphaInstanceGroupManager_InstanceLifecyclePolicy_OnRepairFields = {
    "allow_changing_zone": ubx.FieldSpec(wire_name="allow_changing_zone"),
}

_AlphaInstanceGroupManager_InstanceLifecyclePolicyFields = {
    ...
    "metadata_based_readiness_signal": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaInstanceGroupManager_InstanceLifecyclePolicy_MetadataBasedReadinessSignalFields,
    ),
    "on_failed_health_check": ubx.FieldSpec(wire_name="on_failed_health_check"),
    "on_repair": ubx.FieldSpec(
        wire_name="on_repair",
        kind="object",
        fields=_AlphaInstanceGroupManager_InstanceLifecyclePolicy_OnRepairFields,
    ),
}

_AlphaInstanceGroupManager_NamedPortsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "port": ubx.FieldSpec(wire_name="port"),
}

_AlphaInstanceGroupManager_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaInstanceGroupManager_ResourcePoliciesFields = {
    "workload_policy": ubx.FieldSpec(wire_name="workload_policy"),
}

_AlphaInstanceGroupManager_StandbyPolicyFields = {
    "initial_delay_sec": ubx.FieldSpec(wire_name="initial_delay_sec"),
    "mode": ubx.FieldSpec(wire_name="mode"),
}

_AlphaInstanceGroupManager_StatefulPolicy_PreservedState_DisksFields = {
    "auto_delete": ubx.FieldSpec(wire_name="auto_delete"),
}

_AlphaInstanceGroupManager_StatefulPolicy_PreservedStateFields = {
    "disks": ubx.FieldSpec(
        wire_name="disks",
        kind="map",
        fields=_AlphaInstanceGroupManager_StatefulPolicy_PreservedState_DisksFields,
    ),
...
_AlphaInstanceGroupManager_StatefulPolicyFields = {
    "preserved_state": ubx.FieldSpec(
        wire_name="preserved_state",
        kind="object",
        fields=_AlphaInstanceGroupManager_StatefulPolicy_PreservedStateFields,
    ),
}

_AlphaInstanceGroupManager_Status_AllInstancesConfigFields = {
    "current_revision": ubx.FieldSpec(wire_name="current_revision"),
    "effective": ubx.FieldSpec(wire_name="effective"),
}

_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_ErrorInfoFields = {
    "domain": ubx.FieldSpec(wire_name="domain"),
    "metadatas": ubx.FieldSpec(wire_name="metadatas"),
    "reason": ubx.FieldSpec(wire_name="reason"),
}

_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_Help_LinksFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "url": ubx.FieldSpec(wire_name="url"),
}

_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_HelpFields = {
    "links": ubx.FieldSpec(
        wire_name="links",
        kind="list",
        fields=_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_Help_LinksFields,
    ),
}

_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_LocalizedMessageFields = {
    "locale": ubx.FieldSpec(wire_name="locale"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_QuotaInfoFields = {
...
_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetailsFields = {
    "error_info": ubx.FieldSpec(
        wire_name="error_info",
        kind="object",
        fields=_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_ErrorInfoFields,
    ),
    "help": ubx.FieldSpec(
        wire_name="help",
        kind="object",
        fields=_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_HelpFields,
    ),
    "localized_message": ubx.FieldSpec(
        wire_name="localized_message",
        kind="object",
        fields=_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_LocalizedMessageFields,
    ),
    "quota_info": ubx.FieldSpec(
        wire_name="quota_info",
        kind="object",
        fields=_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_QuotaInfoFields,
    ),
}

_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_ErrorsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "error_details": ubx.FieldSpec(
        wire_name="error_details",
        kind="list",
        fields=_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetailsFields,
    ),
    "location": ubx.FieldSpec(wire_name="location"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_ErrorFields = {
    "errors": ubx.FieldSpec(
        wire_name="errors",
        kind="list",
        fields=_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_ErrorsFields,
    ),
}

_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetailsFields = {
    "error": ubx.FieldSpec(
        wire_name="error",
        kind="object",
        fields=_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_ErrorFields,
    ),
    "timestamp": ubx.FieldSpec(wire_name="timestamp"),
}

_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologiesFields = {
    ...
    "state_details": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetailsFields,
    ),
}

_AlphaInstanceGroupManager_Status_BulkInstanceOperationFields = {
...
_AlphaInstanceGroupManager_Status_CurrentInstanceStatusesFields = {
...
_AlphaInstanceGroupManager_Status_Stateful_PerInstanceConfigsFields = {
    "all_effective": ubx.FieldSpec(wire_name="all_effective"),
}

_AlphaInstanceGroupManager_Status_StatefulFields = {
    ...
    "per_instance_configs": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaInstanceGroupManager_Status_Stateful_PerInstanceConfigsFields,
    ),
}

_AlphaInstanceGroupManager_Status_VersionTargetFields = {
    "is_reached": ubx.FieldSpec(wire_name="is_reached"),
}

_AlphaInstanceGroupManager_StatusFields = {
    "all_instances_config": ubx.FieldSpec(
        wire_name="all_instances_config",
        kind="object",
        fields=_AlphaInstanceGroupManager_Status_AllInstancesConfigFields,
    ),
    "applied_accelerator_topologies": ubx.FieldSpec(
        wire_name="applied_accelerator_topologies",
        kind="list",
        fields=_AlphaInstanceGroupManager_Status_AppliedAcceleratorTopologiesFields,
    ),
    "autoscaler": ubx.FieldSpec(wire_name="autoscaler"),
    "bulk_instance_operation": ubx.FieldSpec(
        wire_name="bulk_instance_operation",
        kind="object",
        fields=_AlphaInstanceGroupManager_Status_BulkInstanceOperationFields,
    ),
    "current_instance_statuses": ubx.FieldSpec(
        wire_name="current_instance_statuses",
        kind="object",
        fields=_AlphaInstanceGroupManager_Status_CurrentInstanceStatusesFields,
    ),
    "is_stable": ubx.FieldSpec(wire_name="is_stable"),
    "stateful": ubx.FieldSpec(
        wire_name="stateful",
        kind="object",
        fields=_AlphaInstanceGroupManager_Status_StatefulFields,
    ),
    "version_target": ubx.FieldSpec(
        wire_name="version_target",
        kind="object",
        fields=_AlphaInstanceGroupManager_Status_VersionTargetFields,
    ),
}

_AlphaInstanceGroupManager_TargetSizePolicyFields = {
    "mode": ubx.FieldSpec(wire_name="mode"),
}
...
_AlphaInstanceGroupManager_VersionsFields = {
...
@dataclasses.dataclass
class AlphaInstanceGroupManagerConfig:
    all_instances_config: Any = None
...
@dataclasses.dataclass
class AlphaInstanceGroupManagerAttrs:
    all_instances_config: Any = None
    # The autohealing policy for this managed instance group. You can specify only one value.
    auto_healing_policies: Any = None
    # The base instance name is a prefix that you want to attach to the names of all VMs in a MIG. The maximum character length is 58 and the name must comply with RFC1035 format. When a VM is created in the group, the MIG appends a hyphen and a random four-character string to the base instance name. If you want the MIG to assign sequential numbers instead of a random string, then end the base instance name with a hyphen followed by one or more hash symbols. The hash symbols indicate the number of digits. For example, a base instance name of "vm-###" results in "vm-001" as a VM name. @pattern [a-z](([-a-z0-9]{0,57})|([-a-z0-9]{0,51}-#{1,10}(\\[[0-9]{1,10}\\])?))
...
AlphaInstanceGroupManager = ubx.ResourceBinding(
    wire_type="google_compute_alpha_instance_group_manager",
    fields={
        "all_instances_config": ubx.FieldSpec(
            wire_name="all_instances_config",
            kind="object",
            fields=_AlphaInstanceGroupManager_AllInstancesConfigFields,
        ),
        "auto_healing_policies": ubx.FieldSpec(
            wire_name="auto_healing_policies",
            kind="list",
            fields=_AlphaInstanceGroupManager_AutoHealingPoliciesFields,
        ),
        "base_instance_name": ubx.FieldSpec(wire_name="base_instance_name"),
        "current_actions": ubx.FieldSpec(
            wire_name="current_actions",
            kind="object",
            fields=_AlphaInstanceGroupManager_CurrentActionsFields,
        ),
        "description": ubx.FieldSpec(wire_name="description"),
        "distribution_policy": ubx.FieldSpec(
            wire_name="distribution_policy",
            kind="object",
            fields=_AlphaInstanceGroupManager_DistributionPolicyFields,
        ),
        ...
        "instance_flexibility_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaInstanceGroupManager_InstanceFlexibilityPolicyFields,
        ),
        "instance_lifecycle_policy": ubx.FieldSpec(
            wire_name="instance_lifecycle_policy",
            kind="object",
            fields=_AlphaInstanceGroupManager_InstanceLifecyclePolicyFields,
        ),
        "instance_template": ubx.FieldSpec(wire_name="instance_template"),
        ...
        "named_ports": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaInstanceGroupManager_NamedPortsFields,
        ),
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaInstanceGroupManager_ParamsFields,
        ),
        "resource_policies": ubx.FieldSpec(
            wire_name="resource_policies",
            kind="object",
            fields=_AlphaInstanceGroupManager_ResourcePoliciesFields,
        ),
        "service_account": ubx.FieldSpec(wire_name="service_account"),
        "standby_policy": ubx.FieldSpec(
            wire_name="standby_policy",
            kind="object",
            fields=_AlphaInstanceGroupManager_StandbyPolicyFields,
        ),
        "stateful_policy": ubx.FieldSpec(
            wire_name="stateful_policy",
            kind="object",
            fields=_AlphaInstanceGroupManager_StatefulPolicyFields,
        ),
        "status": ubx.FieldSpec(
            wire_name="status",
            kind="object",
            fields=_AlphaInstanceGroupManager_StatusFields,
        ),
        ...
        "target_size_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaInstanceGroupManager_TargetSizePolicyFields,
        ),
        ...
        "update_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaInstanceGroupManager_UpdatePolicyFields,
        ),
        "versions": ubx.FieldSpec(
            wire_name="versions",
            kind="list",
            fields=_AlphaInstanceGroupManager_VersionsFields,
        ),
    },
)
