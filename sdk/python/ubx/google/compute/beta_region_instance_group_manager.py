...
class BetaRegionInstanceGroupManager_AllInstancesConfig_Properties:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_AllInstancesConfig:
    # Represents the change that you want to make to the instance properties.
    properties: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_AutoHealingPolicies:
    health_check: Any = None
    initial_delay_sec: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_CurrentActions:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_DistributionPolicy_Zones:
    zone: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_DistributionPolicy:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_DiskEncryptionKey:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_InitializeParams:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_ShieldedInstanceInitialState_Dbs:
    content: Any = None
    file_type: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_ShieldedInstanceInitialState:
    dbs: Any = None
    dbxs: Any = None
    keks: Any = None
    pk: Any = None
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks:
    architecture: Any = None
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections:
    disks: Any = None
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_ProvisioningModelMix:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy:
    # Named instance selections configuring properties that the group will use when creating new VMs.
    instance_selections: Any = None
    provisioning_model_mix: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_InstanceLifecyclePolicy_OnRepair:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_InstanceLifecyclePolicy:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_NamedPorts:
    name: Any = None
    port: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Params:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_ResourcePolicies:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_StandbyPolicy:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_StatefulPolicy_PreservedState_Disks:
    auto_delete: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_StatefulPolicy_PreservedState:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_StatefulPolicy:
    # Configuration of preserved resources.
    preserved_state: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_AllInstancesConfig:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_ErrorInfo:
    domain: Any = None
    metadatas: Any = None
    reason: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_Help_Links:
    description: Any = None
    url: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_Help:
    links: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_LocalizedMessage:
    locale: Any = None
    message: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_QuotaInfo:
    dimensions: Any = None
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails:
    error_info: Any = None
    help: Any = None
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors:
    code: Any = None
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error:
    errors: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails:
    error: Any = None
    timestamp: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies:
    accelerator_topology: Any = None
    state: Any = None
    state_details: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_BulkInstanceOperation:
    # Output only. Informs whether bulk instance operation is in progress.
    in_progress: Any = None
    last_progress_check: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_CurrentInstanceStatuses:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_Stateful_PerInstanceConfigs:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_Stateful:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status_VersionTarget:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Status:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_TargetSizePolicy:
    # The mode of target size policy based on which the MIG creates its VMs individually or all at once.
    mode: Any = None

@dataclasses.dataclass
class BetaRegionInstanceGroupManager_UpdatePolicy_MaxSurge:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_UpdatePolicy:
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManager_Versions:
    instance_template: Any = None
    name: Any = None
    target_size: Any = None

_BetaRegionInstanceGroupManager_AllInstancesConfig_PropertiesFields = {
    "labels": ubx.FieldSpec(wire_name="labels"),
    "metadata": ubx.FieldSpec(wire_name="metadata"),
}

_BetaRegionInstanceGroupManager_AllInstancesConfigFields = {
    "properties": ubx.FieldSpec(
        wire_name="properties",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_AllInstancesConfig_PropertiesFields,
    ),
}

_BetaRegionInstanceGroupManager_AutoHealingPoliciesFields = {
    "health_check": ubx.FieldSpec(wire_name="health_check"),
    "initial_delay_sec": ubx.FieldSpec(wire_name="initial_delay_sec"),
}

_BetaRegionInstanceGroupManager_CurrentActionsFields = {
...
_BetaRegionInstanceGroupManager_DistributionPolicy_ZonesFields = {
    "zone": ubx.FieldSpec(wire_name="zone"),
}

_BetaRegionInstanceGroupManager_DistributionPolicyFields = {
    "target_shape": ubx.FieldSpec(wire_name="target_shape"),
    "zones": ubx.FieldSpec(
        wire_name="zones",
        kind="list",
        fields=_BetaRegionInstanceGroupManager_DistributionPolicy_ZonesFields,
    ),
}

_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_DiskEncryptionKeyFields = {
...
_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_InitializeParamsFields = {
    ...
    "guest_os_features": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_GuestOsFeaturesFields,
    ),
    "labels": ubx.FieldSpec(wire_name="labels"),
    ...
    "source_image_encryption_key": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_DiskEncryptionKeyFields,
    ),
...
_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_ShieldedInstanceInitialState_DbsFields = {
    "content": ubx.FieldSpec(wire_name="content"),
    "file_type": ubx.FieldSpec(wire_name="file_type"),
}

_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_ShieldedInstanceInitialStateFields = {
    "dbs": ubx.FieldSpec(
        wire_name="dbs",
        kind="list",
        fields=_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_ShieldedInstanceInitialState_DbsFields,
    ),
    "dbxs": ubx.FieldSpec(
        wire_name="dbxs",
        kind="list",
...
_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_DisksFields = {
    "architecture": ubx.FieldSpec(wire_name="architecture"),
    ...
    "initialize_params": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_InitializeParamsFields,
    ),
    ...
    "shielded_instance_initial_state": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_Disks_ShieldedInstanceInitialStateFields,
    ),
    "source": ubx.FieldSpec(wire_name="source"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionsFields = {
    "disks": ubx.FieldSpec(
        wire_name="disks",
        kind="list",
        fields=_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelections_DisksFields,
    ),
...
_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_ProvisioningModelMixFields = {
...
_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicyFields = {
    "instance_selections": ubx.FieldSpec(
        wire_name="instance_selections",
        kind="map",
        fields=_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_InstanceSelectionsFields,
    ),
    "provisioning_model_mix": ubx.FieldSpec(
        wire_name="provisioning_model_mix",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicy_ProvisioningModelMixFields,
    ),
}

_BetaRegionInstanceGroupManager_InstanceLifecyclePolicy_OnRepairFields = {
    "allow_changing_zone": ubx.FieldSpec(wire_name="allow_changing_zone"),
}

_BetaRegionInstanceGroupManager_InstanceLifecyclePolicyFields = {
    ...
    "on_repair": ubx.FieldSpec(
        wire_name="on_repair",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_InstanceLifecyclePolicy_OnRepairFields,
    ),
}

_BetaRegionInstanceGroupManager_NamedPortsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "port": ubx.FieldSpec(wire_name="port"),
}

_BetaRegionInstanceGroupManager_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaRegionInstanceGroupManager_ResourcePoliciesFields = {
    "workload_policy": ubx.FieldSpec(wire_name="workload_policy"),
}

_BetaRegionInstanceGroupManager_StandbyPolicyFields = {
    "initial_delay_sec": ubx.FieldSpec(wire_name="initial_delay_sec"),
    "mode": ubx.FieldSpec(wire_name="mode"),
}

_BetaRegionInstanceGroupManager_StatefulPolicy_PreservedState_DisksFields = {
    "auto_delete": ubx.FieldSpec(wire_name="auto_delete"),
}

_BetaRegionInstanceGroupManager_StatefulPolicy_PreservedStateFields = {
    "disks": ubx.FieldSpec(
        wire_name="disks",
        kind="map",
        fields=_BetaRegionInstanceGroupManager_StatefulPolicy_PreservedState_DisksFields,
    ),
...
_BetaRegionInstanceGroupManager_StatefulPolicyFields = {
    "preserved_state": ubx.FieldSpec(
        wire_name="preserved_state",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_StatefulPolicy_PreservedStateFields,
    ),
}

_BetaRegionInstanceGroupManager_Status_AllInstancesConfigFields = {
    "current_revision": ubx.FieldSpec(wire_name="current_revision"),
    "effective": ubx.FieldSpec(wire_name="effective"),
}

_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_ErrorInfoFields = {
    "domain": ubx.FieldSpec(wire_name="domain"),
    "metadatas": ubx.FieldSpec(wire_name="metadatas"),
    "reason": ubx.FieldSpec(wire_name="reason"),
}

_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_Help_LinksFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "url": ubx.FieldSpec(wire_name="url"),
}

_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_HelpFields = {
    "links": ubx.FieldSpec(
        wire_name="links",
        kind="list",
        fields=_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_Help_LinksFields,
    ),
}

_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_LocalizedMessageFields = {
    "locale": ubx.FieldSpec(wire_name="locale"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_QuotaInfoFields = {
...
_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetailsFields = {
    "error_info": ubx.FieldSpec(
        wire_name="error_info",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_ErrorInfoFields,
    ),
    "help": ubx.FieldSpec(
        wire_name="help",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_HelpFields,
    ),
    "localized_message": ubx.FieldSpec(
        wire_name="localized_message",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_LocalizedMessageFields,
    ),
    "quota_info": ubx.FieldSpec(
        wire_name="quota_info",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetails_QuotaInfoFields,
    ),
}

_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_ErrorsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "error_details": ubx.FieldSpec(
        wire_name="error_details",
        kind="list",
        fields=_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_Errors_ErrorDetailsFields,
    ),
    "location": ubx.FieldSpec(wire_name="location"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_ErrorFields = {
    "errors": ubx.FieldSpec(
        wire_name="errors",
        kind="list",
        fields=_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_Error_ErrorsFields,
    ),
}

_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetailsFields = {
    "error": ubx.FieldSpec(
        wire_name="error",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetails_ErrorFields,
    ),
    "timestamp": ubx.FieldSpec(wire_name="timestamp"),
}

_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologiesFields = {
    ...
    "state_details": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologies_StateDetailsFields,
    ),
}

_BetaRegionInstanceGroupManager_Status_BulkInstanceOperationFields = {
...
_BetaRegionInstanceGroupManager_Status_CurrentInstanceStatusesFields = {
...
_BetaRegionInstanceGroupManager_Status_Stateful_PerInstanceConfigsFields = {
    "all_effective": ubx.FieldSpec(wire_name="all_effective"),
}

_BetaRegionInstanceGroupManager_Status_StatefulFields = {
    ...
    "per_instance_configs": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaRegionInstanceGroupManager_Status_Stateful_PerInstanceConfigsFields,
    ),
}

_BetaRegionInstanceGroupManager_Status_VersionTargetFields = {
    "is_reached": ubx.FieldSpec(wire_name="is_reached"),
}

_BetaRegionInstanceGroupManager_StatusFields = {
    "all_instances_config": ubx.FieldSpec(
        wire_name="all_instances_config",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_Status_AllInstancesConfigFields,
    ),
    "applied_accelerator_topologies": ubx.FieldSpec(
        wire_name="applied_accelerator_topologies",
        kind="list",
        fields=_BetaRegionInstanceGroupManager_Status_AppliedAcceleratorTopologiesFields,
    ),
    "autoscaler": ubx.FieldSpec(wire_name="autoscaler"),
    "bulk_instance_operation": ubx.FieldSpec(
        wire_name="bulk_instance_operation",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_Status_BulkInstanceOperationFields,
    ),
    "current_instance_statuses": ubx.FieldSpec(
        wire_name="current_instance_statuses",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_Status_CurrentInstanceStatusesFields,
    ),
    "is_stable": ubx.FieldSpec(wire_name="is_stable"),
    "stateful": ubx.FieldSpec(
        wire_name="stateful",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_Status_StatefulFields,
    ),
    "version_target": ubx.FieldSpec(
        wire_name="version_target",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_Status_VersionTargetFields,
    ),
}

_BetaRegionInstanceGroupManager_TargetSizePolicyFields = {
    "mode": ubx.FieldSpec(wire_name="mode"),
}

_BetaRegionInstanceGroupManager_UpdatePolicy_MaxSurgeFields = {
    "calculated": ubx.FieldSpec(wire_name="calculated"),
    "fixed": ubx.FieldSpec(wire_name="fixed"),
    "percent": ubx.FieldSpec(wire_name="percent"),
}

_BetaRegionInstanceGroupManager_UpdatePolicyFields = {
    ...
    "max_surge": ubx.FieldSpec(
        wire_name="max_surge",
        kind="object",
        fields=_BetaRegionInstanceGroupManager_UpdatePolicy_MaxSurgeFields,
    ),
...
_BetaRegionInstanceGroupManager_VersionsFields = {
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManagerConfig:
    all_instances_config: Any = None
...
@dataclasses.dataclass
class BetaRegionInstanceGroupManagerAttrs:
    all_instances_config: Any = None
    # The autohealing policy for this managed instance group. You can specify only one value.
    auto_healing_policies: Any = None
    # The base instance name is a prefix that you want to attach to the names of all VMs in a MIG. The maximum character length is 58 and the name must comply with RFC1035 format. When a VM is created in the group, the MIG appends a hyphen and a random four-character string to the base instance name. If you want the MIG to assign sequential numbers instead of a random string, then end the base instance name with a hyphen followed by one or more hash symbols. The hash symbols indicate the number of digits. For example, a base instance name of "vm-###" results in "vm-001" as a VM name. @pattern [a-z](([-a-z0-9]{0,57})|([-a-z0-9]{0,51}-#{1,10}(\\[[0-9]{1,10}\\])?))
...
BetaRegionInstanceGroupManager = ubx.ResourceBinding(
    wire_type="google_compute_beta_region_instance_group_manager",
    fields={
        "all_instances_config": ubx.FieldSpec(
            wire_name="all_instances_config",
            kind="object",
            fields=_BetaRegionInstanceGroupManager_AllInstancesConfigFields,
        ),
        "auto_healing_policies": ubx.FieldSpec(
            wire_name="auto_healing_policies",
            kind="list",
            fields=_BetaRegionInstanceGroupManager_AutoHealingPoliciesFields,
        ),
        "base_instance_name": ubx.FieldSpec(wire_name="base_instance_name"),
        "current_actions": ubx.FieldSpec(
            wire_name="current_actions",
            kind="object",
            fields=_BetaRegionInstanceGroupManager_CurrentActionsFields,
        ),
        "description": ubx.FieldSpec(wire_name="description"),
        "distribution_policy": ubx.FieldSpec(
            wire_name="distribution_policy",
            kind="object",
            fields=_BetaRegionInstanceGroupManager_DistributionPolicyFields,
        ),
        ...
        "instance_flexibility_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaRegionInstanceGroupManager_InstanceFlexibilityPolicyFields,
        ),
        "instance_lifecycle_policy": ubx.FieldSpec(
            wire_name="instance_lifecycle_policy",
            kind="object",
            fields=_BetaRegionInstanceGroupManager_InstanceLifecyclePolicyFields,
        ),
        "instance_template": ubx.FieldSpec(wire_name="instance_template"),
        ...
        "named_ports": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaRegionInstanceGroupManager_NamedPortsFields,
        ),
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaRegionInstanceGroupManager_ParamsFields,
        ),
        "resource_policies": ubx.FieldSpec(
            wire_name="resource_policies",
            kind="object",
            fields=_BetaRegionInstanceGroupManager_ResourcePoliciesFields,
        ),
        "service_account": ubx.FieldSpec(wire_name="service_account"),
        "standby_policy": ubx.FieldSpec(
            wire_name="standby_policy",
            kind="object",
            fields=_BetaRegionInstanceGroupManager_StandbyPolicyFields,
        ),
        "stateful_policy": ubx.FieldSpec(
            wire_name="stateful_policy",
            kind="object",
            fields=_BetaRegionInstanceGroupManager_StatefulPolicyFields,
        ),
        "status": ubx.FieldSpec(
            wire_name="status",
            kind="object",
            fields=_BetaRegionInstanceGroupManager_StatusFields,
        ),
        ...
        "target_size_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaRegionInstanceGroupManager_TargetSizePolicyFields,
        ),
        ...
        "update_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaRegionInstanceGroupManager_UpdatePolicyFields,
        ),
        "versions": ubx.FieldSpec(
            wire_name="versions",
            kind="list",
            fields=_BetaRegionInstanceGroupManager_VersionsFields,
        ),
    },
)
