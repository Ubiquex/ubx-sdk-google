...
class AlphaComputeAlphaExternalVpnGateway_Interfaces:
    id: Any = None
    ip_address: Any = None
    ipv6_address: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaExternalVpnGateway_Params:
...
@dataclasses.dataclass
class AlphaComputeAlphaExternalVpnGatewayAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
AlphaComputeAlphaExternalVpnGateway = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_external_vpn_gateway",
    fields={
        ...
        "interfaces": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaComputeAlphaExternalVpnGateway_InterfacesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaComputeAlphaExternalVpnGateway_ParamsFields,
        ),
