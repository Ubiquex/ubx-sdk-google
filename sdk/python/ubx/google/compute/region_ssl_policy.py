...
class RegionSslPolicy_Warnings_Data:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class RegionSslPolicy_Warnings:
    code: Any = None
    data: Any = None
    message: Any = None

_RegionSslPolicy_Warnings_DataFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_RegionSslPolicy_WarningsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "data": ubx.FieldSpec(
        wire_name="data",
        kind="list",
        fields=_RegionSslPolicy_Warnings_DataFields,
    ),
...
RegionSslPolicy = ubx.ResourceBinding(
    ...
    fields={
        ...
        "warnings": ubx.FieldSpec(
            wire_name="warnings",
            kind="list",
            fields=_RegionSslPolicy_WarningsFields,
        ),
    },
)
