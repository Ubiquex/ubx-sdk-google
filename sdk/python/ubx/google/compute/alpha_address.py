# Code generated by `ubx sdk gen` from google_compute_alpha_address. DO NOT EDIT.
...
AlphaAddress = ubx.ResourceBinding(
    wire_type="google_compute_alpha_address",
    fields={
