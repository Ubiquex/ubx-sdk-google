...
class AlphaDisk_AsyncPrimaryDisk:
...
@dataclasses.dataclass
class AlphaDisk_AsyncSecondaryDisks:
    async_replication_disk: Any = None

@dataclasses.dataclass
class AlphaDisk_DiskEncryptionKey:
...
@dataclasses.dataclass
class AlphaDisk_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class AlphaDisk_Params:
...
@dataclasses.dataclass
class AlphaDisk_ResourceStatus_AsyncPrimaryDisk:
    state: Any = None

@dataclasses.dataclass
class AlphaDisk_ResourceStatus:
...
_AlphaDisk_AsyncPrimaryDiskFields = {
...
_AlphaDisk_AsyncSecondaryDisksFields = {
    "async_replication_disk": ubx.FieldSpec(
        wire_name="async_replication_disk",
        kind="object",
        fields=_AlphaDisk_AsyncPrimaryDiskFields,
    ),
}

_AlphaDisk_DiskEncryptionKeyFields = {
...
_AlphaDisk_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_AlphaDisk_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_AlphaDisk_ResourceStatus_AsyncPrimaryDiskFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

_AlphaDisk_ResourceStatusFields = {
    "async_primary_disk": ubx.FieldSpec(
        wire_name="async_primary_disk",
        kind="object",
        fields=_AlphaDisk_ResourceStatus_AsyncPrimaryDiskFields,
    ),
...
AlphaDisk = ubx.ResourceBinding(
    wire_type="google_compute_alpha_disk",
    fields={
        ...
        "async_secondary_disks": ubx.FieldSpec(
            wire_name="async_secondary_disks",
            kind="map",
            fields=_AlphaDisk_AsyncSecondaryDisksFields,
        ),
        ...
        "disk_encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaDisk_DiskEncryptionKeyFields,
        ),
        ...
        "guest_os_features": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaDisk_GuestOsFeaturesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_AlphaDisk_ParamsFields,
        ),
        ...
        "resource_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaDisk_ResourceStatusFields,
        ),
