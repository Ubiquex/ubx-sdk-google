...
class AlphaComputeAlphaNetworkEdgeSecurityServiceConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaNetworkEdgeSecurityServiceAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
AlphaComputeAlphaNetworkEdgeSecurityService = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_network_edge_security_service",
    fields={
