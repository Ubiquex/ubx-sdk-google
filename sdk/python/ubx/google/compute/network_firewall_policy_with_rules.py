...
class NetworkFirewallPolicyWithRules_Rule_Match_Layer4Config:
    ip_protocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class NetworkFirewallPolicyWithRules_Rule_Match_SrcSecureTag:
    name: Any = None
    state: Any = None

@dataclasses.dataclass
class NetworkFirewallPolicyWithRules_Rule_Match:
...
@dataclasses.dataclass
class NetworkFirewallPolicyWithRules_Rule:
    action: Any = None
...
@dataclasses.dataclass
class NetworkFirewallPolicyWithRules_Timeouts:
    create: Any = None
    delete: Any = None
    update: Any = None

_NetworkFirewallPolicyWithRules_Rule_Match_Layer4ConfigFields = {
    "ip_protocol": ubx.FieldSpec(wire_name="ip_protocol"),
    "ports": ubx.FieldSpec(wire_name="ports"),
}

_NetworkFirewallPolicyWithRules_Rule_Match_SrcSecureTagFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_NetworkFirewallPolicyWithRules_Rule_MatchFields = {
    ...
    "layer4_config": ubx.FieldSpec(
        ...
        kind="list",
        fields=_NetworkFirewallPolicyWithRules_Rule_Match_Layer4ConfigFields,
    ),
    "src_secure_tag": ubx.FieldSpec(
        wire_name="src_secure_tag",
        kind="list",
        fields=_NetworkFirewallPolicyWithRules_Rule_Match_SrcSecureTagFields,
    ),
}

_NetworkFirewallPolicyWithRules_RuleFields = {
    ...
    "match": ubx.FieldSpec(
        wire_name="match",
        kind="list",
        fields=_NetworkFirewallPolicyWithRules_Rule_MatchFields,
    ),
...
_NetworkFirewallPolicyWithRules_TimeoutsFields = {
...
@dataclasses.dataclass
class NetworkFirewallPolicyWithRulesConfig:
...
NetworkFirewallPolicyWithRules = ubx.ResourceBinding(
    wire_type="google_compute_network_firewall_policy_with_rules",
    fields={
        ...
        "rule": ubx.FieldSpec(
            wire_name="rule",
            kind="list",
            fields=_NetworkFirewallPolicyWithRules_RuleFields,
        ),
        "timeouts": ubx.FieldSpec(
            wire_name="timeouts",
            kind="object",
            fields=_NetworkFirewallPolicyWithRules_TimeoutsFields,
        ),
    },
)
