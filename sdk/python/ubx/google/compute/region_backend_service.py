...
class RegionBackendService_Backends_CustomMetrics:
...
@dataclasses.dataclass
class RegionBackendService_Backends_OrchestrationInfo:
    resource_uri: Any = None

@dataclasses.dataclass
class RegionBackendService_Backends:
...
@dataclasses.dataclass
class RegionBackendService_CdnPolicy_BypassCacheOnRequestHeaders:
...
@dataclasses.dataclass
class RegionBackendService_ConnectionDraining:
...
@dataclasses.dataclass
class RegionBackendService_LocalityLbPolicies_CustomPolicy:
...
@dataclasses.dataclass
class RegionBackendService_LocalityLbPolicies_Policy:
...
@dataclasses.dataclass
class RegionBackendService_LocalityLbPolicies:
...
@dataclasses.dataclass
class RegionBackendService_SecuritySettings_AwsV4Authentication:
...
@dataclasses.dataclass
class RegionBackendService_SecuritySettings:
...
@dataclasses.dataclass
class RegionBackendService_Subsetting:
...
_RegionBackendService_BackendsFields = {
    ...
    "custom_metrics": ubx.FieldSpec(
        ...
        kind="list",
        fields=_RegionBackendService_Backends_CustomMetricsFields,
    ),
    ...
    "orchestration_info": ubx.FieldSpec(
        ...
        kind="object",
        fields=_RegionBackendService_Backends_OrchestrationInfoFields,
    ),
    "preference": ubx.FieldSpec(wire_name="preference"),
    "traffic_duration": ubx.FieldSpec(wire_name="traffic_duration"),
}

_RegionBackendService_CdnPolicy_BypassCacheOnRequestHeadersFields = {
...
_RegionBackendService_CdnPolicyFields = {
    "bypass_cache_on_request_headers": ubx.FieldSpec(
        ...
        kind="list",
        fields=_RegionBackendService_CdnPolicy_BypassCacheOnRequestHeadersFields,
    ),
...
_RegionBackendService_ConnectionDrainingFields = {
...
_RegionBackendService_LocalityLbPolicies_CustomPolicyFields = {
    "data": ubx.FieldSpec(wire_name="data"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_RegionBackendService_LocalityLbPolicies_PolicyFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

_RegionBackendService_LocalityLbPoliciesFields = {
    "custom_policy": ubx.FieldSpec(
        wire_name="custom_policy",
        kind="object",
        fields=_RegionBackendService_LocalityLbPolicies_CustomPolicyFields,
    ),
    "policy": ubx.FieldSpec(
        wire_name="policy",
        kind="object",
        fields=_RegionBackendService_LocalityLbPolicies_PolicyFields,
    ),
}
...
_RegionBackendService_SecuritySettings_AwsV4AuthenticationFields = {
...
_RegionBackendService_UsedByFields = {
...
@dataclasses.dataclass
class RegionBackendServiceAttrs:
    # Lifetime of cookies in seconds. This setting is applicable to Application Load Balancers and Traffic Director and requires GENERATED_COOKIE or HTTP_COOKIE session affinity. If set to 0, the cookie is non-persistent and lasts only until the end of the browser session (or equivalent). The maximum allowed value is two weeks (1,209,600). Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true.
    affinity_cookie_ttl_sec: Any = None
    # The list of backends that serve this BackendService.
    backends: Any = None
...
RegionBackendService = ubx.ResourceBinding(
    ...
    fields={
        ...
        "backends": ubx.FieldSpec(
            wire_name="backends",
            kind="list",
            fields=_RegionBackendService_BackendsFields,
        ),
        ...
        "connection_draining": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RegionBackendService_ConnectionDrainingFields,
        ),
        ...
        "locality_lb_policies": ubx.FieldSpec(
            ...
            kind="list",
            fields=_RegionBackendService_LocalityLbPoliciesFields,
        ),
        ...
        "security_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RegionBackendService_SecuritySettingsFields,
        ),
        ...
        "subsetting": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RegionBackendService_SubsettingFields,
        ),
        ...
        "used_by": ubx.FieldSpec(
            wire_name="used_by",
            kind="list",
            fields=_RegionBackendService_UsedByFields,
        ),
    },
)
