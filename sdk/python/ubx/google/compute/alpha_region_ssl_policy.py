...
class AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_CertificatePaths:
...
@dataclasses.dataclass
class AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPlugin:
    # Plugin name.
    name: Any = None
...
@dataclasses.dataclass
class AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials:
...
@dataclasses.dataclass
class AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentials:
...
@dataclasses.dataclass
class AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig:
...
@dataclasses.dataclass
class AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig:
    # [Deprecated] gRPC config to access the SDS server. gRPC config to access the SDS server.
    grpc_service_config: Any = None

@dataclasses.dataclass
class AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext:
    # [Deprecated] The paths to the mounted TLS Certificates and private key. The paths to the mounted TLS Certificates and private key.
...
@dataclasses.dataclass
class AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_ValidationContext:
...
@dataclasses.dataclass
class AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext:
...
@dataclasses.dataclass
class AlphaRegionSslPolicy_TlsSettings:
...
@dataclasses.dataclass
class AlphaRegionSslPolicy_Warnings_Data:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class AlphaRegionSslPolicy_Warnings:
    code: Any = None
    data: Any = None
    message: Any = None

_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_CertificatePathsFields = {
    "certificate_path": ubx.FieldSpec(wire_name="certificate_path"),
    "private_key_path": ubx.FieldSpec(wire_name="private_key_path"),
}

_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPluginFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "struct_config": ubx.FieldSpec(wire_name="struct_config"),
}

_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentialsFields = {
    "call_credential_type": ubx.FieldSpec(wire_name="call_credential_type"),
    "from_plugin": ubx.FieldSpec(
        wire_name="from_plugin",
        kind="object",
        fields=_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentials_FromPluginFields,
    ),
}

_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentialsFields = {
    "certificates": ubx.FieldSpec(
        wire_name="certificates",
        kind="object",
        fields=_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_CertificatePathsFields,
    ),
    "channel_credential_type": ubx.FieldSpec(wire_name="channel_credential_type"),
}

_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfigFields = {
    "call_credentials": ubx.FieldSpec(
        wire_name="call_credentials",
        kind="object",
        fields=_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_CallCredentialsFields,
    ),
    "channel_credentials": ubx.FieldSpec(
        wire_name="channel_credentials",
        kind="object",
        fields=_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfig_ChannelCredentialsFields,
    ),
    "target_uri": ubx.FieldSpec(wire_name="target_uri"),
}

_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfigFields = {
    "grpc_service_config": ubx.FieldSpec(
        wire_name="grpc_service_config",
        kind="object",
        fields=_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfig_GrpcServiceConfigFields,
    ),
}

_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContextFields = {
    ...
    "sds_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContext_SdsConfigFields,
    ),
}

_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_ValidationContextFields = {
    "certificate_path": ubx.FieldSpec(wire_name="certificate_path"),
    "sds_config": ubx.FieldSpec(
        wire_name="sds_config",
        kind="object",
...
_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContextFields = {
    "certificate_context": ubx.FieldSpec(
        wire_name="certificate_context",
        kind="object",
        fields=_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_CertificateContextFields,
    ),
    "validation_context": ubx.FieldSpec(
        wire_name="validation_context",
        kind="object",
        fields=_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContext_ValidationContextFields,
    ),
}

_AlphaRegionSslPolicy_TlsSettingsFields = {
    "proxy_tls_context": ubx.FieldSpec(
        wire_name="proxy_tls_context",
        kind="object",
        fields=_AlphaRegionSslPolicy_TlsSettings_ProxyTlsContextFields,
    ),
    "subject_alt_names": ubx.FieldSpec(wire_name="subject_alt_names"),
    "tls_mode": ubx.FieldSpec(wire_name="tls_mode"),
}

_AlphaRegionSslPolicy_Warnings_DataFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_AlphaRegionSslPolicy_WarningsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "data": ubx.FieldSpec(
        wire_name="data",
        kind="list",
        fields=_AlphaRegionSslPolicy_Warnings_DataFields,
    ),
    "message": ubx.FieldSpec(wire_name="message"),
}

@dataclasses.dataclass
class AlphaRegionSslPolicyConfig:
...
@dataclasses.dataclass
class AlphaRegionSslPolicyAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # A list of features enabled when the selected profile is CUSTOM. The method returns the set of features that can be specified in this list. This field must be empty if the profile is notCUSTOM.
    custom_features: Any = None
...
AlphaRegionSslPolicy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_region_ssl_policy",
    fields={
        ...
        "tls_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaRegionSslPolicy_TlsSettingsFields,
        ),
        "warnings": ubx.FieldSpec(
            wire_name="warnings",
            kind="list",
            fields=_AlphaRegionSslPolicy_WarningsFields,
        ),
    },
)
