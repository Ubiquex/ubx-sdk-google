...
class AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectors:
    all_of_selectors: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector:
    any_of_selectors: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies:
    installed_software_selector: Any = None
    pinned_version: Any = None
    string_config: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaFolderGlobalVmExtensionPolicy_InstanceSelectors_LabelSelector:
    inclusion_labels: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaFolderGlobalVmExtensionPolicy_InstanceSelectors:
    label_selector: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutInput:
...
@dataclasses.dataclass
class AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatus:
    state: Any = None

@dataclasses.dataclass
class AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts:
...
@dataclasses.dataclass
class AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus:
...
@dataclasses.dataclass
class AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation:
    rollout_input: Any = None
    rollout_status: Any = None

_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectorsFields = {
    "all_of_selectors": ubx.FieldSpec(wire_name="all_of_selectors"),
}

_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelectorFields = {
    "any_of_selectors": ubx.FieldSpec(
        wire_name="any_of_selectors",
        kind="map",
        fields=_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelector_AnyOfSelectorsFields,
    ),
}

_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPoliciesFields = {
    "installed_software_selector": ubx.FieldSpec(
        wire_name="installed_software_selector",
        kind="object",
        fields=_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPolicies_InstalledSoftwareSelectorFields,
    ),
    "pinned_version": ubx.FieldSpec(wire_name="pinned_version"),
    "string_config": ubx.FieldSpec(wire_name="string_config"),
}

_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields = {
    "inclusion_labels": ubx.FieldSpec(wire_name="inclusion_labels"),
}

_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_InstanceSelectorsFields = {
    "label_selector": ubx.FieldSpec(
        wire_name="label_selector",
        kind="object",
        fields=_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_InstanceSelectors_LabelSelectorFields,
    ),
}

_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields = {
...
_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields = {
    "location_rollout_status": ubx.FieldSpec(
        wire_name="location_rollout_status",
        kind="map",
        fields=_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRollouts_LocationRolloutStatusFields,
    ),
...
_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields = {
    "current_rollouts": ubx.FieldSpec(
        wire_name="current_rollouts",
        kind="list",
        fields=_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatus_CurrentRolloutsFields,
    ),
...
_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperationFields = {
    "rollout_input": ubx.FieldSpec(
        wire_name="rollout_input",
        kind="object",
        fields=_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutInputFields,
    ),
    "rollout_status": ubx.FieldSpec(
        wire_name="rollout_status",
        kind="object",
        fields=_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperation_RolloutStatusFields,
    ),
}

@dataclasses.dataclass
class AlphaComputeAlphaFolderGlobalVmExtensionPolicyConfig:
...
@dataclasses.dataclass
class AlphaComputeAlphaFolderGlobalVmExtensionPolicyAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
AlphaComputeAlphaFolderGlobalVmExtensionPolicy = ubx.ResourceBinding(
    wire_type="google_compute_alpha_compute_alpha_folder_global_vm_extension_policy",
    fields={
        ...
        "extension_policies": ubx.FieldSpec(
            ...
            kind="map",
            fields=_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_ExtensionPoliciesFields,
        ),
        "id": ubx.FieldSpec(wire_name="id"),
        "instance_selectors": ubx.FieldSpec(
            wire_name="instance_selectors",
            kind="list",
            fields=_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_InstanceSelectorsFields,
        ),
        ...
        "rollout_operation": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaComputeAlphaFolderGlobalVmExtensionPolicy_RolloutOperationFields,
        ),
