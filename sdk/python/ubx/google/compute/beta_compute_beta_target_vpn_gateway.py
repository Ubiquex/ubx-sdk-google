...
class BetaComputeBetaTargetVpnGateway_Params:
...
_BetaComputeBetaTargetVpnGateway_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

@dataclasses.dataclass
class BetaComputeBetaTargetVpnGatewayConfig:
...
@dataclasses.dataclass
class BetaComputeBetaTargetVpnGatewayAttrs:
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
    # An optional description of this resource. Provide this property when you create the resource.
    description: Any = None
...
BetaComputeBetaTargetVpnGateway = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_target_vpn_gateway",
    fields={
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaTargetVpnGateway_ParamsFields,
        ),
