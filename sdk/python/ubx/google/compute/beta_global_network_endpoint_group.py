...
class BetaGlobalNetworkEndpointGroup_AppEngine:
...
@dataclasses.dataclass
class BetaGlobalNetworkEndpointGroup_CloudFunction:
...
@dataclasses.dataclass
class BetaGlobalNetworkEndpointGroup_CloudRun:
...
@dataclasses.dataclass
class BetaGlobalNetworkEndpointGroup_LoadBalancer:
...
@dataclasses.dataclass
class BetaGlobalNetworkEndpointGroup_PscData:
...
@dataclasses.dataclass
class BetaGlobalNetworkEndpointGroup_ServerlessDeployment:
...
_BetaGlobalNetworkEndpointGroup_AppEngineFields = {
    "service": ubx.FieldSpec(wire_name="service"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_BetaGlobalNetworkEndpointGroup_CloudFunctionFields = {
    "function": ubx.FieldSpec(wire_name="function"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
}

_BetaGlobalNetworkEndpointGroup_CloudRunFields = {
    "service": ubx.FieldSpec(wire_name="service"),
    "tag": ubx.FieldSpec(wire_name="tag"),
    "url_mask": ubx.FieldSpec(wire_name="url_mask"),
}

_BetaGlobalNetworkEndpointGroup_LoadBalancerFields = {
...
_BetaGlobalNetworkEndpointGroup_PscDataFields = {
...
_BetaGlobalNetworkEndpointGroup_ServerlessDeploymentFields = {
...
@dataclasses.dataclass
class BetaGlobalNetworkEndpointGroupConfig:
...
@dataclasses.dataclass
class BetaGlobalNetworkEndpointGroupAttrs:
    # Optional. Metadata defined as annotations on the network endpoint group.
    annotations: Any = None
    # Configuration for an App Engine network endpoint group (NEG). The service is optional, may be provided explicitly or in the URL mask. The version is optional and can only be provided explicitly or in the URL mask when service is present. Note: App Engine service must be in the same project and located in the same region as the Serverless NEG.
    app_engine: Any = None
...
BetaGlobalNetworkEndpointGroup = ubx.ResourceBinding(
    wire_type="google_compute_beta_global_network_endpoint_group",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "app_engine": ubx.FieldSpec(
            wire_name="app_engine",
            kind="object",
            fields=_BetaGlobalNetworkEndpointGroup_AppEngineFields,
        ),
        "cloud_function": ubx.FieldSpec(
            wire_name="cloud_function",
            kind="object",
            fields=_BetaGlobalNetworkEndpointGroup_CloudFunctionFields,
        ),
        "cloud_run": ubx.FieldSpec(
            wire_name="cloud_run",
            kind="object",
            fields=_BetaGlobalNetworkEndpointGroup_CloudRunFields,
        ),
        ...
        "load_balancer": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaGlobalNetworkEndpointGroup_LoadBalancerFields,
        ),
        ...
        "psc_data": ubx.FieldSpec(
            wire_name="psc_data",
            kind="object",
            fields=_BetaGlobalNetworkEndpointGroup_PscDataFields,
        ),
        ...
        "serverless_deployment": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaGlobalNetworkEndpointGroup_ServerlessDeploymentFields,
        ),
