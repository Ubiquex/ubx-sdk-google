...
class BetaComputeBetaRegionSnapshot_GuestOsFeatures:
    type: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionSnapshot_Params:
...
@dataclasses.dataclass
class BetaComputeBetaRegionSnapshot_SnapshotEncryptionKey:
...
_BetaComputeBetaRegionSnapshot_GuestOsFeaturesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}

_BetaComputeBetaRegionSnapshot_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaRegionSnapshot_SnapshotEncryptionKeyFields = {
...
@dataclasses.dataclass
class BetaComputeBetaRegionSnapshotConfig:
...
@dataclasses.dataclass
class BetaComputeBetaRegionSnapshotAttrs:
    # Output only. [Output Only] The architecture of the snapshot. Valid values are ARM64 or X86_64.
    architecture: Any = None
    # Output only. [Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk.
    auto_created: Any = None
...
BetaComputeBetaRegionSnapshot = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_region_snapshot",
    fields={
        ...
        "guest_os_features": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaRegionSnapshot_GuestOsFeaturesFields,
        ),
        ...
        "params": ubx.FieldSpec(
            wire_name="params",
            kind="object",
            fields=_BetaComputeBetaRegionSnapshot_ParamsFields,
        ),
        ...
        "snapshot_encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaRegionSnapshot_SnapshotEncryptionKeyFields,
        ),
