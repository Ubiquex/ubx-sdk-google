...
class AlphaServiceAttachment_ConnectedEndpoints:
...
@dataclasses.dataclass
class AlphaServiceAttachment_ConsumerAcceptLists:
...
@dataclasses.dataclass
class AlphaServiceAttachment_PscServiceAttachmentId:
    high: Any = None
    low: Any = None

@dataclasses.dataclass
class AlphaServiceAttachment_TunnelingConfig:
...
_AlphaServiceAttachment_ConnectedEndpointsFields = {
...
_AlphaServiceAttachment_ConsumerAcceptListsFields = {
...
@dataclasses.dataclass
class AlphaServiceAttachmentAttrs:
    # Output only. [Output Only] An array of connections for all the consumers connected to this service attachment.
    connected_endpoints: Any = None
    # The connection preference of service attachment. The value can be set to ACCEPT_AUTOMATIC. An ACCEPT_AUTOMATIC service attachment is one that always accepts the connection from consumer forwarding rules.
    connection_preference: Any = None
...
AlphaServiceAttachment = ubx.ResourceBinding(
    wire_type="google_compute_alpha_service_attachment",
    fields={
        "connected_endpoints": ubx.FieldSpec(
            wire_name="connected_endpoints",
            kind="list",
            fields=_AlphaServiceAttachment_ConnectedEndpointsFields,
        ),
        ...
        "consumer_accept_lists": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaServiceAttachment_ConsumerAcceptListsFields,
        ),
        ...
        "psc_service_attachment_id": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaServiceAttachment_PscServiceAttachmentIdFields,
        ),
        ...
        "tunneling_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AlphaServiceAttachment_TunnelingConfigFields,
        ),
    },
)
