...
class BetaRegionNetworkFirewallPolicy_Associations:
...
@dataclasses.dataclass
class BetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4Configs:
    ip_protocol: Any = None
    ports: Any = None

@dataclasses.dataclass
class BetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTags:
    name: Any = None
    state: Any = None

@dataclasses.dataclass
class BetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match:
...
@dataclasses.dataclass
class BetaRegionNetworkFirewallPolicy_PacketMirroringRules:
    action: Any = None
...
_BetaRegionNetworkFirewallPolicy_AssociationsFields = {
...
_BetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields = {
    "ip_protocol": ubx.FieldSpec(wire_name="ip_protocol"),
    "ports": ubx.FieldSpec(wire_name="ports"),
}

_BetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_BetaRegionNetworkFirewallPolicy_PacketMirroringRules_MatchFields = {
    ...
    "layer4_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_Layer4ConfigsFields,
    ),
    ...
    "src_secure_tags": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaRegionNetworkFirewallPolicy_PacketMirroringRules_Match_SrcSecureTagsFields,
    ),
    "src_threat_intelligences": ubx.FieldSpec(wire_name="src_threat_intelligences"),
}

_BetaRegionNetworkFirewallPolicy_PacketMirroringRulesFields = {
    ...
    "match": ubx.FieldSpec(
        wire_name="match",
        kind="object",
        fields=_BetaRegionNetworkFirewallPolicy_PacketMirroringRules_MatchFields,
    ),
    "priority": ubx.FieldSpec(wire_name="priority"),
...
@dataclasses.dataclass
class BetaRegionNetworkFirewallPolicyConfig:
...
@dataclasses.dataclass
class BetaRegionNetworkFirewallPolicyAttrs:
    # A list of associations that belong to this firewall policy.
    associations: Any = None
    # Output only. [Output Only] Creation timestamp inRFC3339 text format.
    creation_timestamp: Any = None
...
BetaRegionNetworkFirewallPolicy = ubx.ResourceBinding(
    wire_type="google_compute_beta_region_network_firewall_policy",
    fields={
        "associations": ubx.FieldSpec(
            wire_name="associations",
            kind="list",
            fields=_BetaRegionNetworkFirewallPolicy_AssociationsFields,
        ),
        ...
        "packet_mirroring_rules": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaRegionNetworkFirewallPolicy_PacketMirroringRulesFields,
        ),
