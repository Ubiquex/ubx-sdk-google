...
class BetaComputeBetaRegionCommitment_LicenseResource:
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Params:
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_PersistentDiskResources:
    amount: Any = None
    dimension_type: Any = None
    product_type: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_AdvancedDeploymentControl:
    reservation_operational_mode: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_AggregateReservation_InUseResources_Accelerator:
    accelerator_count: Any = None
    accelerator_type: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_AggregateReservation_InUseResources:
    accelerator: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_AggregateReservation:
    host_count: Any = None
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_DeleteAfterDuration:
    nanos: Any = None
    seconds: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_ReservationSharingPolicy:
    service_share_type: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_ResourceStatus_HealthInfo:
    degraded_block_count: Any = None
    health_status: Any = None
    healthy_block_count: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenance:
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_ResourceStatus_ReservationMaintenance:
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_ResourceStatus_SpecificSkuAllocation:
    source_instance_template_id: Any = None
    utilizations: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_ResourceStatus:
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_ShareSettings_FolderMap:
    folder_id: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_ShareSettings_ProjectMap:
    project_id: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_ShareSettings:
    folder_map: Any = None
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_SpecificReservation_InstanceProperties_LocalSsds:
    disk_size_gb: Any = None
    interface: Any = None

@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_SpecificReservation_InstanceProperties:
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations_SpecificReservation:
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Reservations:
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_ResourceStatus:
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitment_Resources:
    accelerator_type: Any = None
    amount: Any = None
    type: Any = None

_BetaComputeBetaRegionCommitment_LicenseResourceFields = {
...
_BetaComputeBetaRegionCommitment_ParamsFields = {
    "resource_manager_tags": ubx.FieldSpec(wire_name="resource_manager_tags"),
}

_BetaComputeBetaRegionCommitment_PersistentDiskResourcesFields = {
    "amount": ubx.FieldSpec(wire_name="amount"),
    "dimension_type": ubx.FieldSpec(wire_name="dimension_type"),
    "product_type": ubx.FieldSpec(wire_name="product_type"),
}

_BetaComputeBetaRegionCommitment_Reservations_AdvancedDeploymentControlFields = {
    "reservation_operational_mode": ubx.FieldSpec(wire_name="reservation_operational_mode"),
}

_BetaComputeBetaRegionCommitment_Reservations_AggregateReservation_InUseResources_AcceleratorFields = {
    "accelerator_count": ubx.FieldSpec(wire_name="accelerator_count"),
    "accelerator_type": ubx.FieldSpec(wire_name="accelerator_type"),
}

_BetaComputeBetaRegionCommitment_Reservations_AggregateReservation_InUseResourcesFields = {
    "accelerator": ubx.FieldSpec(
        wire_name="accelerator",
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_AggregateReservation_InUseResources_AcceleratorFields,
    ),
}

_BetaComputeBetaRegionCommitment_Reservations_AggregateReservationFields = {
    ...
    "in_use_resources": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaComputeBetaRegionCommitment_Reservations_AggregateReservation_InUseResourcesFields,
    ),
...
_BetaComputeBetaRegionCommitment_Reservations_DeleteAfterDurationFields = {
    "nanos": ubx.FieldSpec(wire_name="nanos"),
    "seconds": ubx.FieldSpec(wire_name="seconds"),
}

_BetaComputeBetaRegionCommitment_Reservations_ReservationSharingPolicyFields = {
    "service_share_type": ubx.FieldSpec(wire_name="service_share_type"),
}

_BetaComputeBetaRegionCommitment_Reservations_ResourceStatus_HealthInfoFields = {
...
_BetaComputeBetaRegionCommitment_Reservations_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenanceFields = {
...
_BetaComputeBetaRegionCommitment_Reservations_ResourceStatus_ReservationMaintenanceFields = {
    ...
    "upcoming_group_maintenance": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_ResourceStatus_ReservationMaintenance_UpcomingGroupMaintenanceFields,
    ),
}

_BetaComputeBetaRegionCommitment_Reservations_ResourceStatus_SpecificSkuAllocationFields = {
...
_BetaComputeBetaRegionCommitment_Reservations_ResourceStatusFields = {
    "health_info": ubx.FieldSpec(
        wire_name="health_info",
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_ResourceStatus_HealthInfoFields,
    ),
    ...
    "reservation_maintenance": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_ResourceStatus_ReservationMaintenanceFields,
    ),
    "specific_sku_allocation": ubx.FieldSpec(
        wire_name="specific_sku_allocation",
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_ResourceStatus_SpecificSkuAllocationFields,
    ),
}

_BetaComputeBetaRegionCommitment_Reservations_ShareSettings_FolderMapFields = {
    "folder_id": ubx.FieldSpec(wire_name="folder_id"),
}

_BetaComputeBetaRegionCommitment_Reservations_ShareSettings_ProjectMapFields = {
    "project_id": ubx.FieldSpec(wire_name="project_id"),
}

_BetaComputeBetaRegionCommitment_Reservations_ShareSettingsFields = {
    "folder_map": ubx.FieldSpec(
        wire_name="folder_map",
        kind="map",
        fields=_BetaComputeBetaRegionCommitment_Reservations_ShareSettings_FolderMapFields,
    ),
    "project_map": ubx.FieldSpec(
        wire_name="project_map",
        kind="map",
        fields=_BetaComputeBetaRegionCommitment_Reservations_ShareSettings_ProjectMapFields,
    ),
    "projects": ubx.FieldSpec(wire_name="projects"),
    "share_type": ubx.FieldSpec(wire_name="share_type"),
}

_BetaComputeBetaRegionCommitment_Reservations_SpecificReservation_InstanceProperties_LocalSsdsFields = {
    "disk_size_gb": ubx.FieldSpec(wire_name="disk_size_gb"),
    "interface": ubx.FieldSpec(wire_name="interface"),
}

_BetaComputeBetaRegionCommitment_Reservations_SpecificReservation_InstancePropertiesFields = {
    ...
    "local_ssds": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BetaComputeBetaRegionCommitment_Reservations_SpecificReservation_InstanceProperties_LocalSsdsFields,
    ),
...
_BetaComputeBetaRegionCommitment_Reservations_SpecificReservationFields = {
    ...
    "instance_properties": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_SpecificReservation_InstancePropertiesFields,
    ),
    "source_instance_template": ubx.FieldSpec(wire_name="source_instance_template"),
}

_BetaComputeBetaRegionCommitment_ReservationsFields = {
    "advanced_deployment_control": ubx.FieldSpec(
        wire_name="advanced_deployment_control",
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_AdvancedDeploymentControlFields,
    ),
    "aggregate_reservation": ubx.FieldSpec(
        wire_name="aggregate_reservation",
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_AggregateReservationFields,
    ),
    ...
    "delete_after_duration": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_DeleteAfterDurationFields,
    ),
    ...
    "params": ubx.FieldSpec(
        wire_name="params",
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_ParamsFields,
    ),
    ...
    "reservation_sharing_policy": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_ReservationSharingPolicyFields,
    ),
    "resource_policies": ubx.FieldSpec(wire_name="resource_policies"),
    "resource_status": ubx.FieldSpec(
        wire_name="resource_status",
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_ResourceStatusFields,
    ),
    ...
    "share_settings": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_ShareSettingsFields,
    ),
    "specific_reservation": ubx.FieldSpec(
        wire_name="specific_reservation",
        kind="object",
        fields=_BetaComputeBetaRegionCommitment_Reservations_SpecificReservationFields,
    ),
...
_BetaComputeBetaRegionCommitment_ResourceStatusFields = {
    "custom_term_eligibility_end_timestamp": ubx.FieldSpec(wire_name="custom_term_eligibility_end_timestamp"),
}

_BetaComputeBetaRegionCommitment_ResourcesFields = {
    "accelerator_type": ubx.FieldSpec(wire_name="accelerator_type"),
    "amount": ubx.FieldSpec(wire_name="amount"),
    "type": ubx.FieldSpec(wire_name="type"),
}
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitmentConfig:
...
@dataclasses.dataclass
class BetaComputeBetaRegionCommitmentAttrs:
    # Specifies whether to automatically renew the commitment at the end of its current term. The default value is false. If you set the field to true, each time your commitment reaches the end of its term, Compute Engine automatically renews it for another term. You can update this field anytime before the commitment expires. For example, if the commitment is set to expire at 12 AM UTC-8 on January 3, 2027, you can update this field until 11:59 PM UTC-8 on January 2, 2027.
    auto_renew: Any = None
    # The category of the commitment; specifies whether the commitment is for hardware or software resources. Category MACHINE specifies that you are committing to hardware machine resources such asVCPU or MEMORY, listed in resources. Category LICENSE specifies that you are committing to software licenses, listed in licenseResources. Note that if you specify MACHINE commitments, then you must also specify a type to indicate the machine series of the hardware resource that you are committing to.
    category: Any = None
...
BetaComputeBetaRegionCommitment = ubx.ResourceBinding(
    wire_type="google_compute_beta_compute_beta_region_commitment",
    fields={
        ...
        "license_resource": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BetaComputeBetaRegionCommitment_LicenseResourceFields,
        ),
        ...
        "persistent_disk_resources": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaRegionCommitment_PersistentDiskResourcesFields,
        ),
        ...
        "reservations": ubx.FieldSpec(
            ...
            kind="list",
            fields=_BetaComputeBetaRegionCommitment_ReservationsFields,
        ),
        "resource_status": ubx.FieldSpec(
            wire_name="resource_status",
            kind="object",
            fields=_BetaComputeBetaRegionCommitment_ResourceStatusFields,
        ),
        "resources": ubx.FieldSpec(
            wire_name="resources",
            kind="list",
            fields=_BetaComputeBetaRegionCommitment_ResourcesFields,
        ),
        "self_link": ubx.FieldSpec(wire_name="self_link"),
