...
class AlphaInstanceGroup_NamedPorts:
    name: Any = None
    port: Any = None

_AlphaInstanceGroup_NamedPortsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "port": ubx.FieldSpec(wire_name="port"),
}

@dataclasses.dataclass
class AlphaInstanceGroupConfig:
...
AlphaInstanceGroup = ubx.ResourceBinding(
    wire_type="google_compute_alpha_instance_group",
    fields={
        ...
        "named_ports": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AlphaInstanceGroup_NamedPortsFields,
        ),
