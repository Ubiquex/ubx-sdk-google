...
@dataclasses.dataclass
class Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy:
...
_Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentagesFields = {
    "percentage": ubx.FieldSpec(wire_name="percentage"),
    "traffic_class": ubx.FieldSpec(wire_name="traffic_class"),
}

_Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicyFields = {
    "bandwidth_percentages": ubx.FieldSpec(
        wire_name="bandwidth_percentages",
        kind="list",
        fields=_Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicy_BandwidthPercentagesFields,
    ),
}

_Interconnect_ApplicationAwareInterconnectFields = {
    "bandwidth_percentage_policy": ubx.FieldSpec(
        wire_name="bandwidth_percentage_policy",
        kind="object",
        fields=_Interconnect_ApplicationAwareInterconnect_BandwidthPercentagePolicyFields,
    ),
