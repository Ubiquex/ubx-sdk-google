...
class ObservabilityTraceScopeConfig:
...
@dataclasses.dataclass
class ObservabilityTraceScopeAttrs:
    # Output only. The creation timestamp of the trace scope.
    create_time: Any = None
    # Optional. Describes this trace scope. The maximum length of the description is 8000 characters.
    description: Any = None
...
ObservabilityTraceScope = ubx.ResourceBinding(
    wire_type="google_observability_observability_trace_scope",
    fields={
