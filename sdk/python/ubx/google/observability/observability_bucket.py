...
class ObservabilityBucket_CmekSettings:
...
_ObservabilityBucket_CmekSettingsFields = {
...
@dataclasses.dataclass
class ObservabilityBucketConfig:
...
@dataclasses.dataclass
class ObservabilityBucketAttrs:
    # Settings for configuring CMEK for a bucket.
    cmek_settings: Any = None
    # Output only. Create timestamp.
    create_time: Any = None
...
ObservabilityBucket = ubx.ResourceBinding(
    wire_type="google_observability_observability_bucket",
    fields={
        "cmek_settings": ubx.FieldSpec(
            wire_name="cmek_settings",
            kind="object",
            fields=_ObservabilityBucket_CmekSettingsFields,
        ),
