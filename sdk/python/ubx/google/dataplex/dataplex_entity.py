...
@dataclasses.dataclass
class DataplexEntity_Compatibility:
...
@dataclasses.dataclass
class DataplexEntity_Format_Csv:
...
@dataclasses.dataclass
class DataplexEntity_Schema_Fields:
...
@dataclasses.dataclass
class DataplexEntity_Schema_PartitionFields:
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class DataplexEntity_Schema:
...
_DataplexEntity_AccessFields = {
    "read": ubx.FieldSpec(wire_name="read"),
}

_DataplexEntity_Compatibility_BigqueryFields = {
    "compatible": ubx.FieldSpec(wire_name="compatible"),
    "reason": ubx.FieldSpec(wire_name="reason"),
}

_DataplexEntity_CompatibilityFields = {
    "bigquery": ubx.FieldSpec(
        wire_name="bigquery",
        kind="object",
        fields=_DataplexEntity_Compatibility_BigqueryFields,
    ),
...
_DataplexEntity_Format_CsvFields = {
...
_DataplexEntity_Format_IcebergFields = {
    "metadata_location": ubx.FieldSpec(wire_name="metadata_location"),
}

_DataplexEntity_Format_JsonFields = {
    "encoding": ubx.FieldSpec(wire_name="encoding"),
}

_DataplexEntity_FormatFields = {
    "compression_format": ubx.FieldSpec(wire_name="compression_format"),
    "csv": ubx.FieldSpec(
        wire_name="csv",
        kind="object",
        fields=_DataplexEntity_Format_CsvFields,
    ),
    "format": ubx.FieldSpec(wire_name="format"),
    "iceberg": ubx.FieldSpec(
        wire_name="iceberg",
        kind="object",
        fields=_DataplexEntity_Format_IcebergFields,
    ),
    "json": ubx.FieldSpec(
        wire_name="json",
        kind="object",
        fields=_DataplexEntity_Format_JsonFields,
    ),
    "mime_type": ubx.FieldSpec(wire_name="mime_type"),
}

_DataplexEntity_Schema_FieldsFields = {
...
_DataplexEntity_Schema_PartitionFieldsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_DataplexEntity_SchemaFields = {
    "fields": ubx.FieldSpec(
        wire_name="fields",
        kind="list",
        fields=_DataplexEntity_Schema_FieldsFields,
    ),
    "partition_fields": ubx.FieldSpec(
        wire_name="partition_fields",
        kind="list",
        fields=_DataplexEntity_Schema_PartitionFieldsFields,
    ),
...
DataplexEntity = ubx.ResourceBinding(
    wire_type="google_dataplex_dataplex_entity",
    fields={
        "access": ubx.FieldSpec(
            wire_name="access",
            kind="object",
            fields=_DataplexEntity_AccessFields,
        ),
        ...
        "compatibility": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DataplexEntity_CompatibilityFields,
        ),
        ...
        "format": ubx.FieldSpec(
            wire_name="format",
            kind="object",
            fields=_DataplexEntity_FormatFields,
        ),
        ...
        "schema": ubx.FieldSpec(
            wire_name="schema",
            kind="object",
            fields=_DataplexEntity_SchemaFields,
        ),
