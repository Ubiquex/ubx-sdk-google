...
class DataplexEntry_Aspects_AspectSource:
    create_time: Any = None
    data_version: Any = None
    update_time: Any = None

@dataclasses.dataclass
class DataplexEntry_Aspects:
...
@dataclasses.dataclass
class DataplexEntry_EntrySource_Ancestors:
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class DataplexEntry_EntrySource:
...
_DataplexEntry_Aspects_AspectSourceFields = {
    "create_time": ubx.FieldSpec(wire_name="create_time"),
    "data_version": ubx.FieldSpec(wire_name="data_version"),
    "update_time": ubx.FieldSpec(wire_name="update_time"),
}

_DataplexEntry_AspectsFields = {
    "aspect_source": ubx.FieldSpec(
        wire_name="aspect_source",
        kind="object",
        fields=_DataplexEntry_Aspects_AspectSourceFields,
    ),
...
_DataplexEntry_EntrySource_AncestorsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_DataplexEntry_EntrySourceFields = {
    "ancestors": ubx.FieldSpec(
        wire_name="ancestors",
        kind="list",
        fields=_DataplexEntry_EntrySource_AncestorsFields,
    ),
    "create_time": ubx.FieldSpec(wire_name="create_time"),
...
DataplexEntry = ubx.ResourceBinding(
    wire_type="google_dataplex_dataplex_entry",
    fields={
        "aspects": ubx.FieldSpec(
            wire_name="aspects",
            kind="map",
            fields=_DataplexEntry_AspectsFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "entry_source": ubx.FieldSpec(
            wire_name="entry_source",
            kind="object",
            fields=_DataplexEntry_EntrySourceFields,
        ),
