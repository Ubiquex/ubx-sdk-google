...
class DataplexMetadataFeed_Filters:
...
@dataclasses.dataclass
class DataplexMetadataFeed_Scope:
...
_DataplexMetadataFeed_FiltersFields = {
...
_DataplexMetadataFeed_ScopeFields = {
...
@dataclasses.dataclass
class DataplexMetadataFeedConfig:
...
@dataclasses.dataclass
class DataplexMetadataFeedAttrs:
    # Output only. The time when the feed was created.
    create_time: Any = None
    # Filters defines the type of changes that you want to listen to. You can have multiple entry type filters and multiple aspect type filters. All of the entry type filters are OR'ed together. All of the aspect type filters are OR'ed together. All of the entry type filters and aspect type filters are AND'ed together.
    filters: Any = None
...
DataplexMetadataFeed = ubx.ResourceBinding(
    wire_type="google_dataplex_dataplex_metadata_feed",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "filters": ubx.FieldSpec(
            wire_name="filters",
            kind="object",
            fields=_DataplexMetadataFeed_FiltersFields,
        ),
        ...
        "scope": ubx.FieldSpec(
            wire_name="scope",
            kind="object",
            fields=_DataplexMetadataFeed_ScopeFields,
        ),
