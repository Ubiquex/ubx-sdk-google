...
class DataplexAspectType_Authorization:
...
@dataclasses.dataclass
class DataplexAspectType_MetadataTemplate_Annotations:
...
@dataclasses.dataclass
class DataplexAspectType_MetadataTemplate_Constraints:
    # Optional. Marks this field as optional or required.
    required: Any = None

@dataclasses.dataclass
class DataplexAspectType_MetadataTemplate_EnumValues:
    deprecated: Any = None
    index: Any = None
    name: Any = None

@dataclasses.dataclass
class DataplexAspectType_MetadataTemplate:
...
_DataplexAspectType_AuthorizationFields = {
    "alternate_use_permission": ubx.FieldSpec(wire_name="alternate_use_permission"),
}

_DataplexAspectType_MetadataTemplate_AnnotationsFields = {
...
_DataplexAspectType_MetadataTemplate_ConstraintsFields = {
    "required": ubx.FieldSpec(wire_name="required"),
}

_DataplexAspectType_MetadataTemplate_EnumValuesFields = {
    "deprecated": ubx.FieldSpec(wire_name="deprecated"),
    "index": ubx.FieldSpec(wire_name="index"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_DataplexAspectType_MetadataTemplateFields = {
    "annotations": ubx.FieldSpec(
        wire_name="annotations",
        kind="object",
        fields=_DataplexAspectType_MetadataTemplate_AnnotationsFields,
    ),
    "array_items": ubx.FieldSpec(wire_name="array_items"),
    "constraints": ubx.FieldSpec(
        wire_name="constraints",
        kind="object",
        fields=_DataplexAspectType_MetadataTemplate_ConstraintsFields,
    ),
    "enum_values": ubx.FieldSpec(
        wire_name="enum_values",
        kind="list",
        fields=_DataplexAspectType_MetadataTemplate_EnumValuesFields,
    ),
    "index": ubx.FieldSpec(wire_name="index"),
...
@dataclasses.dataclass
class DataplexAspectTypeConfig:
...
DataplexAspectType = ubx.ResourceBinding(
    wire_type="google_dataplex_dataplex_aspect_type",
    fields={
        "authorization": ubx.FieldSpec(
            wire_name="authorization",
            kind="object",
            fields=_DataplexAspectType_AuthorizationFields,
        ),
        ...
        "metadata_template": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DataplexAspectType_MetadataTemplateFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
