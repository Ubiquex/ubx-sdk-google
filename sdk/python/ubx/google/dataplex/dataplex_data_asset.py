...
class DataplexDataAsset_AccessGroupConfigs:
    iam_roles: Any = None

_DataplexDataAsset_AccessGroupConfigsFields = {
    "iam_roles": ubx.FieldSpec(wire_name="iam_roles"),
}

@dataclasses.dataclass
class DataplexDataAssetConfig:
...
DataplexDataAsset = ubx.ResourceBinding(
    wire_type="google_dataplex_dataplex_data_asset",
    fields={
        "access_group_configs": ubx.FieldSpec(
            wire_name="access_group_configs",
            kind="map",
            fields=_DataplexDataAsset_AccessGroupConfigsFields,
        ),
