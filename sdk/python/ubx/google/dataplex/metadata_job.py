...
class MetadataJob_ExportResult:
...
@dataclasses.dataclass
class MetadataJob_ExportSpec_Scope:
...
@dataclasses.dataclass
class MetadataJob_ImportResult:
...
@dataclasses.dataclass
class MetadataJob_ImportSpec_Scope:
...
_MetadataJob_ExportSpecFields = {
    "output_path": ubx.FieldSpec(wire_name="output_path"),
    "scope": ubx.FieldSpec(
        wire_name="scope",
        kind="object",
        fields=_MetadataJob_ExportSpec_ScopeFields,
    ),
}

_MetadataJob_ImportResultFields = {
...
_MetadataJob_ImportSpec_ScopeFields = {
    "aspect_types": ubx.FieldSpec(wire_name="aspect_types"),
    "entry_groups": ubx.FieldSpec(wire_name="entry_groups"),
...
_MetadataJob_ImportSpecFields = {
    ...
    "scope": ubx.FieldSpec(
        wire_name="scope",
        kind="object",
        fields=_MetadataJob_ImportSpec_ScopeFields,
    ),
...
MetadataJob = ubx.ResourceBinding(
    ...
    fields={
        "export_result": ubx.FieldSpec(
            ...
            kind="object",
            fields=_MetadataJob_ExportResultFields,
        ),
        "export_spec": ubx.FieldSpec(
            wire_name="export_spec",
            kind="object",
            fields=_MetadataJob_ExportSpecFields,
        ),
        "import_result": ubx.FieldSpec(
            wire_name="import_result",
            kind="object",
            fields=_MetadataJob_ImportResultFields,
        ),
