...
@dataclasses.dataclass
class DataDomain_Contacts:
    # Required. Identities of the business contacts.
    identities: Any = None

@dataclasses.dataclass
class DataDomain_PolicyMember:
...
_DataDomain_Contacts_IdentitiesFields = {
...
_DataDomain_ContactsFields = {
    "identities": ubx.FieldSpec(
        wire_name="identities",
        kind="list",
        fields=_DataDomain_Contacts_IdentitiesFields,
    ),
}

_DataDomain_PolicyMemberFields = {
...
DataDomain = ubx.ResourceBinding(
    wire_type="google_dataplex_data_domain",
    fields={
