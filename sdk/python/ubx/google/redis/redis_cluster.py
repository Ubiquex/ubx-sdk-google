...
class RedisCluster_AclPolicyInfo_AclPolicyRevisionStatuses:
...
@dataclasses.dataclass
class RedisCluster_AclPolicyInfo:
...
@dataclasses.dataclass
class RedisCluster_AutomatedBackupConfig_FixedFrequencySchedule_StartTime:
...
@dataclasses.dataclass
class RedisCluster_AutomatedBackupConfig_FixedFrequencySchedule:
    # Represents a time of day. The date and time zone are either not significant or are specified elsewhere. An API may choose to allow leap seconds. Related types are google.type.Date and `google.protobuf.Timestamp`.
    start_time: Any = None

@dataclasses.dataclass
class RedisCluster_AutomatedBackupConfig:
...
@dataclasses.dataclass
class RedisCluster_ClusterEndpoints_Connections_PscAutoConnection:
    address: Any = None
...
@dataclasses.dataclass
class RedisCluster_ClusterEndpoints_Connections_PscConnection:
    address: Any = None
    connection_type: Any = None
    forwarding_rule: Any = None
    network: Any = None
...
@dataclasses.dataclass
class RedisCluster_ClusterEndpoints_Connections:
    psc_auto_connection: Any = None
    psc_connection: Any = None

@dataclasses.dataclass
class RedisCluster_ClusterEndpoints:
    connections: Any = None

@dataclasses.dataclass
class RedisCluster_CrossClusterReplicationConfig_Membership_PrimaryCluster:
...
@dataclasses.dataclass
class RedisCluster_CrossClusterReplicationConfig_Membership:
...
@dataclasses.dataclass
class RedisCluster_CrossClusterReplicationConfig:
...
@dataclasses.dataclass
class RedisCluster_DiscoveryEndpoints_PscConfig:
    network: Any = None

@dataclasses.dataclass
class RedisCluster_DiscoveryEndpoints:
    address: Any = None
    port: Any = None
    psc_config: Any = None

@dataclasses.dataclass
class RedisCluster_EncryptionInfo:
...
@dataclasses.dataclass
class RedisCluster_GcsSource:
    # Optional. URIs of the Cloud Storage objects to import. Example: gs://bucket1/object1, gs://bucket2/folder2/object2
    uris: Any = None

@dataclasses.dataclass
class RedisCluster_MaintenancePolicy_WeeklyMaintenanceWindow:
    day: Any = None
    start_time: Any = None

@dataclasses.dataclass
class RedisCluster_MaintenancePolicy:
...
@dataclasses.dataclass
class RedisCluster_MaintenanceSchedule:
...
@dataclasses.dataclass
class RedisCluster_ManagedBackupSource:
...
@dataclasses.dataclass
class RedisCluster_PersistenceConfig_AofConfig:
    # Optional. fsync configuration.
    append_fsync: Any = None

@dataclasses.dataclass
class RedisCluster_PersistenceConfig_RdbConfig:
...
@dataclasses.dataclass
class RedisCluster_PersistenceConfig:
...
@dataclasses.dataclass
class RedisCluster_PscServiceAttachments:
    connection_type: Any = None
    service_attachment: Any = None

@dataclasses.dataclass
class RedisCluster_StateInfo_UpdateInfo:
...
@dataclasses.dataclass
class RedisCluster_StateInfo:
    # Represents information about an updating cluster.
    update_info: Any = None

@dataclasses.dataclass
class RedisCluster_ZoneDistributionConfig:
...
_RedisCluster_AclPolicyInfo_AclPolicyRevisionStatusesFields = {
...
_RedisCluster_AclPolicyInfoFields = {
    "acl_policy_revision_statuses": ubx.FieldSpec(
        wire_name="acl_policy_revision_statuses",
        kind="list",
        fields=_RedisCluster_AclPolicyInfo_AclPolicyRevisionStatusesFields,
    ),
...
_RedisCluster_AutomatedBackupConfig_FixedFrequencySchedule_StartTimeFields = {
...
_RedisCluster_AutomatedBackupConfig_FixedFrequencyScheduleFields = {
    "start_time": ubx.FieldSpec(
        wire_name="start_time",
        kind="object",
        fields=_RedisCluster_AutomatedBackupConfig_FixedFrequencySchedule_StartTimeFields,
    ),
}

_RedisCluster_AutomatedBackupConfigFields = {
    ...
    "fixed_frequency_schedule": ubx.FieldSpec(
        ...
        kind="object",
        fields=_RedisCluster_AutomatedBackupConfig_FixedFrequencyScheduleFields,
    ),
    "retention": ubx.FieldSpec(wire_name="retention"),
}

_RedisCluster_ClusterEndpoints_Connections_PscAutoConnectionFields = {
...
_RedisCluster_ClusterEndpoints_Connections_PscConnectionFields = {
    "address": ubx.FieldSpec(wire_name="address"),
    "connection_type": ubx.FieldSpec(wire_name="connection_type"),
    "forwarding_rule": ubx.FieldSpec(wire_name="forwarding_rule"),
    "network": ubx.FieldSpec(wire_name="network"),
...
_RedisCluster_ClusterEndpoints_ConnectionsFields = {
    "psc_auto_connection": ubx.FieldSpec(
        wire_name="psc_auto_connection",
        kind="object",
        fields=_RedisCluster_ClusterEndpoints_Connections_PscAutoConnectionFields,
    ),
    "psc_connection": ubx.FieldSpec(
        wire_name="psc_connection",
        kind="object",
        fields=_RedisCluster_ClusterEndpoints_Connections_PscConnectionFields,
    ),
}

_RedisCluster_ClusterEndpointsFields = {
    "connections": ubx.FieldSpec(
        wire_name="connections",
        kind="list",
        fields=_RedisCluster_ClusterEndpoints_ConnectionsFields,
    ),
}

_RedisCluster_CrossClusterReplicationConfig_Membership_PrimaryClusterFields = {
    "cluster": ubx.FieldSpec(wire_name="cluster"),
    "uid": ubx.FieldSpec(wire_name="uid"),
}

_RedisCluster_CrossClusterReplicationConfig_MembershipFields = {
    "primary_cluster": ubx.FieldSpec(
        wire_name="primary_cluster",
        kind="object",
        fields=_RedisCluster_CrossClusterReplicationConfig_Membership_PrimaryClusterFields,
    ),
...
_RedisCluster_CrossClusterReplicationConfigFields = {
    "cluster_role": ubx.FieldSpec(wire_name="cluster_role"),
    "membership": ubx.FieldSpec(
        wire_name="membership",
        kind="object",
        fields=_RedisCluster_CrossClusterReplicationConfig_MembershipFields,
    ),
    "primary_cluster": ubx.FieldSpec(
        wire_name="primary_cluster",
        kind="object",
...
_RedisCluster_DiscoveryEndpoints_PscConfigFields = {
    "network": ubx.FieldSpec(wire_name="network"),
}

_RedisCluster_DiscoveryEndpointsFields = {
    "address": ubx.FieldSpec(wire_name="address"),
    "port": ubx.FieldSpec(wire_name="port"),
    "psc_config": ubx.FieldSpec(
        wire_name="psc_config",
        kind="object",
        fields=_RedisCluster_DiscoveryEndpoints_PscConfigFields,
    ),
}

_RedisCluster_EncryptionInfoFields = {
...
_RedisCluster_GcsSourceFields = {
    "uris": ubx.FieldSpec(wire_name="uris"),
}

_RedisCluster_MaintenancePolicy_WeeklyMaintenanceWindowFields = {
...
_RedisCluster_MaintenancePolicyFields = {
    "create_time": ubx.FieldSpec(wire_name="create_time"),
    "update_time": ubx.FieldSpec(wire_name="update_time"),
    "weekly_maintenance_window": ubx.FieldSpec(
        wire_name="weekly_maintenance_window",
        kind="list",
        fields=_RedisCluster_MaintenancePolicy_WeeklyMaintenanceWindowFields,
    ),
}

_RedisCluster_MaintenanceScheduleFields = {
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

_RedisCluster_ManagedBackupSourceFields = {
    "backup": ubx.FieldSpec(wire_name="backup"),
}

_RedisCluster_PersistenceConfig_AofConfigFields = {
    "append_fsync": ubx.FieldSpec(wire_name="append_fsync"),
}

_RedisCluster_PersistenceConfig_RdbConfigFields = {
...
_RedisCluster_PersistenceConfigFields = {
    "aof_config": ubx.FieldSpec(
        wire_name="aof_config",
        kind="object",
        fields=_RedisCluster_PersistenceConfig_AofConfigFields,
    ),
    "mode": ubx.FieldSpec(wire_name="mode"),
    "rdb_config": ubx.FieldSpec(
        wire_name="rdb_config",
        kind="object",
        fields=_RedisCluster_PersistenceConfig_RdbConfigFields,
    ),
}

_RedisCluster_PscServiceAttachmentsFields = {
    "connection_type": ubx.FieldSpec(wire_name="connection_type"),
    "service_attachment": ubx.FieldSpec(wire_name="service_attachment"),
}

_RedisCluster_StateInfo_UpdateInfoFields = {
...
_RedisCluster_StateInfoFields = {
    "update_info": ubx.FieldSpec(
        wire_name="update_info",
        kind="object",
        fields=_RedisCluster_StateInfo_UpdateInfoFields,
    ),
}

_RedisCluster_ZoneDistributionConfigFields = {
    "mode": ubx.FieldSpec(wire_name="mode"),
...
RedisCluster = ubx.ResourceBinding(
    wire_type="google_redis_redis_cluster",
    fields={
        ...
        "acl_policy_info": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RedisCluster_AclPolicyInfoFields,
        ),
        ...
        "automated_backup_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RedisCluster_AutomatedBackupConfigFields,
        ),
        ...
        "cluster_endpoints": ubx.FieldSpec(
            ...
            kind="list",
            fields=_RedisCluster_ClusterEndpointsFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "cross_cluster_replication_config": ubx.FieldSpec(
            wire_name="cross_cluster_replication_config",
            kind="object",
            fields=_RedisCluster_CrossClusterReplicationConfigFields,
        ),
        ...
        "discovery_endpoints": ubx.FieldSpec(
            ...
            kind="list",
            fields=_RedisCluster_DiscoveryEndpointsFields,
        ),
        ...
        "encryption_info": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RedisCluster_EncryptionInfoFields,
        ),
        "gcs_source": ubx.FieldSpec(
            wire_name="gcs_source",
            kind="object",
            fields=_RedisCluster_GcsSourceFields,
        ),
        ...
        "maintenance_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RedisCluster_MaintenancePolicyFields,
        ),
        "maintenance_schedule": ubx.FieldSpec(
            wire_name="maintenance_schedule",
            kind="object",
            fields=_RedisCluster_MaintenanceScheduleFields,
        ),
        ...
        "managed_backup_source": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RedisCluster_ManagedBackupSourceFields,
        ),
        ...
        "persistence_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RedisCluster_PersistenceConfigFields,
        ),
        ...
        "psc_service_attachments": ubx.FieldSpec(
            ...
            kind="list",
            fields=_RedisCluster_PscServiceAttachmentsFields,
        ),
        ...
        "state_info": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RedisCluster_StateInfoFields,
        ),
        ...
        "zone_distribution_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RedisCluster_ZoneDistributionConfigFields,
        ),
    },
)
