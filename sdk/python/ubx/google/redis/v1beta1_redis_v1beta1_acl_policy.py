...
class V1beta1RedisV1beta1AclPolicy_ClusterAclPolicyAttachments_AclPolicyRevisionStatuses:
...
@dataclasses.dataclass
class V1beta1RedisV1beta1AclPolicy_ClusterAclPolicyAttachments:
    acl_policy_revision_statuses: Any = None
    cluster: Any = None

@dataclasses.dataclass
class V1beta1RedisV1beta1AclPolicy_Rules:
    rule: Any = None
    username: Any = None

_V1beta1RedisV1beta1AclPolicy_ClusterAclPolicyAttachments_AclPolicyRevisionStatusesFields = {
...
_V1beta1RedisV1beta1AclPolicy_ClusterAclPolicyAttachmentsFields = {
    "acl_policy_revision_statuses": ubx.FieldSpec(
        wire_name="acl_policy_revision_statuses",
        kind="list",
        fields=_V1beta1RedisV1beta1AclPolicy_ClusterAclPolicyAttachments_AclPolicyRevisionStatusesFields,
    ),
    "cluster": ubx.FieldSpec(wire_name="cluster"),
}

_V1beta1RedisV1beta1AclPolicy_RulesFields = {
    "rule": ubx.FieldSpec(wire_name="rule"),
    "username": ubx.FieldSpec(wire_name="username"),
}

@dataclasses.dataclass
class V1beta1RedisV1beta1AclPolicyConfig:
...
@dataclasses.dataclass
class V1beta1RedisV1beta1AclPolicyAttrs:
    # Output only. The ACL policy attachment status for each attached cluster.
    cluster_acl_policy_attachments: Any = None
    # Output only. The timestamp that the ACL policy was created.
    create_time: Any = None
...
V1beta1RedisV1beta1AclPolicy = ubx.ResourceBinding(
    wire_type="google_redis_v1beta1_redis_v1beta1_acl_policy",
    fields={
        "cluster_acl_policy_attachments": ubx.FieldSpec(
            wire_name="cluster_acl_policy_attachments",
            kind="list",
            fields=_V1beta1RedisV1beta1AclPolicy_ClusterAclPolicyAttachmentsFields,
        ),
        ...
        "rules": ubx.FieldSpec(
            wire_name="rules",
            kind="list",
            fields=_V1beta1RedisV1beta1AclPolicy_RulesFields,
        ),
        "state": ubx.FieldSpec(wire_name="state"),
