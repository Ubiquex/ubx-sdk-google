...
class GkebackupRestoreChannelConfig:
...
@dataclasses.dataclass
class GkebackupRestoreChannelAttrs:
    # Output only. The timestamp when this RestoreChannel was created.
    create_time: Any = None
    # Optional. User specified descriptive string for this RestoreChannel.
    description: Any = None
...
GkebackupRestoreChannel = ubx.ResourceBinding(
    wire_type="google_gkebackup_gkebackup_restore_channel",
    fields={
