...
class GkebackupBackup_ClusterMetadata:
...
@dataclasses.dataclass
class GkebackupBackup_EncryptionKey:
    # Optional. Google Cloud KMS encryption key. Format: `projects/*/locations/*/keyRings/*/cryptoKeys/*`
    gcp_kms_encryption_key: Any = None

@dataclasses.dataclass
class GkebackupBackup_SelectedApplications_NamespacedNames:
    name: Any = None
    namespace: Any = None

@dataclasses.dataclass
class GkebackupBackup_SelectedApplications:
    # Optional. A list of namespaced Kubernetes resources.
    namespaced_names: Any = None

@dataclasses.dataclass
class GkebackupBackup_SelectedNamespaceLabels_ResourceLabels:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class GkebackupBackup_SelectedNamespaceLabels:
    # Optional. A list of Kubernetes label-value pairs.
    resource_labels: Any = None

@dataclasses.dataclass
class GkebackupBackup_SelectedNamespaces:
    # Optional. A list of Kubernetes Namespaces.
    namespaces: Any = None

@dataclasses.dataclass
class GkebackupBackup_TroubleshootingInfo:
...
_GkebackupBackup_ClusterMetadataFields = {
...
_GkebackupBackup_EncryptionKeyFields = {
    "gcp_kms_encryption_key": ubx.FieldSpec(wire_name="gcp_kms_encryption_key"),
}

_GkebackupBackup_SelectedApplications_NamespacedNamesFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "namespace": ubx.FieldSpec(wire_name="namespace"),
}

_GkebackupBackup_SelectedApplicationsFields = {
    "namespaced_names": ubx.FieldSpec(
        wire_name="namespaced_names",
        kind="list",
        fields=_GkebackupBackup_SelectedApplications_NamespacedNamesFields,
    ),
}

_GkebackupBackup_SelectedNamespaceLabels_ResourceLabelsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_GkebackupBackup_SelectedNamespaceLabelsFields = {
    "resource_labels": ubx.FieldSpec(
        wire_name="resource_labels",
        kind="list",
        fields=_GkebackupBackup_SelectedNamespaceLabels_ResourceLabelsFields,
    ),
}

_GkebackupBackup_SelectedNamespacesFields = {
    "namespaces": ubx.FieldSpec(wire_name="namespaces"),
}

_GkebackupBackup_TroubleshootingInfoFields = {
    "state_reason_code": ubx.FieldSpec(wire_name="state_reason_code"),
    "state_reason_uri": ubx.FieldSpec(wire_name="state_reason_uri"),
}

@dataclasses.dataclass
class GkebackupBackupConfig:
...
GkebackupBackup = ubx.ResourceBinding(
    wire_type="google_gkebackup_gkebackup_backup",
    fields={
        "all_namespaces": ubx.FieldSpec(wire_name="all_namespaces"),
        "cluster_metadata": ubx.FieldSpec(
            wire_name="cluster_metadata",
            kind="object",
            fields=_GkebackupBackup_ClusterMetadataFields,
        ),
        ...
        "encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_GkebackupBackup_EncryptionKeyFields,
        ),
        ...
        "selected_applications": ubx.FieldSpec(
            ...
            kind="object",
            fields=_GkebackupBackup_SelectedApplicationsFields,
        ),
        "selected_namespace_labels": ubx.FieldSpec(
            wire_name="selected_namespace_labels",
            kind="object",
            fields=_GkebackupBackup_SelectedNamespaceLabelsFields,
        ),
        "selected_namespaces": ubx.FieldSpec(
            wire_name="selected_namespaces",
            kind="object",
            fields=_GkebackupBackup_SelectedNamespacesFields,
        ),
        ...
        "troubleshooting_info": ubx.FieldSpec(
            ...
            kind="object",
            fields=_GkebackupBackup_TroubleshootingInfoFields,
        ),
