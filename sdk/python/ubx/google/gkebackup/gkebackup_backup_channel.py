# Code generated by `ubx sdk gen` from google_gkebackup_gkebackup_backup_channel. DO NOT EDIT.
...
class GkebackupBackupChannelConfig:
...
@dataclasses.dataclass
class GkebackupBackupChannelAttrs:
    # Output only. The timestamp when this BackupChannel resource was created.
    create_time: Any = None
    # Optional. User specified descriptive string for this BackupChannel.
    description: Any = None
...
GkebackupBackupChannel = ubx.ResourceBinding(
    wire_type="google_gkebackup_gkebackup_backup_channel",
    fields={
