...
class GkebackupBackupPlan_BackupConfig_EncryptionKey:
    # Optional. Google Cloud KMS encryption key. Format: `projects/*/locations/*/keyRings/*/cryptoKeys/*`
    gcp_kms_encryption_key: Any = None

@dataclasses.dataclass
class GkebackupBackupPlan_BackupConfig_SelectedApplications_NamespacedNames:
    name: Any = None
    namespace: Any = None

@dataclasses.dataclass
class GkebackupBackupPlan_BackupConfig_SelectedApplications:
    # Optional. A list of namespaced Kubernetes resources.
    namespaced_names: Any = None

@dataclasses.dataclass
class GkebackupBackupPlan_BackupConfig_SelectedNamespaceLabels_ResourceLabels:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class GkebackupBackupPlan_BackupConfig_SelectedNamespaceLabels:
    # Optional. A list of Kubernetes label-value pairs.
    resource_labels: Any = None

@dataclasses.dataclass
class GkebackupBackupPlan_BackupConfig_SelectedNamespaces:
    # Optional. A list of Kubernetes Namespaces.
    namespaces: Any = None

@dataclasses.dataclass
class GkebackupBackupPlan_BackupConfig:
...
@dataclasses.dataclass
class GkebackupBackupPlan_BackupSchedule_RpoConfig_ExclusionWindows_DaysOfWeek:
    days_of_week: Any = None

@dataclasses.dataclass
class GkebackupBackupPlan_BackupSchedule_RpoConfig_ExclusionWindows_SingleOccurrenceDate:
    day: Any = None
    month: Any = None
    year: Any = None

@dataclasses.dataclass
class GkebackupBackupPlan_BackupSchedule_RpoConfig_ExclusionWindows_StartTime:
    hours: Any = None
    minutes: Any = None
    nanos: Any = None
    seconds: Any = None
...
@dataclasses.dataclass
class GkebackupBackupPlan_BackupSchedule_RpoConfig_ExclusionWindows:
    daily: Any = None
    days_of_week: Any = None
    duration: Any = None
...
@dataclasses.dataclass
class GkebackupBackupPlan_BackupSchedule_RpoConfig:
...
@dataclasses.dataclass
class GkebackupBackupPlan_BackupSchedule:
...
@dataclasses.dataclass
class GkebackupBackupPlan_RetentionPolicy:
...
_GkebackupBackupPlan_BackupConfig_EncryptionKeyFields = {
    "gcp_kms_encryption_key": ubx.FieldSpec(wire_name="gcp_kms_encryption_key"),
}

_GkebackupBackupPlan_BackupConfig_SelectedApplications_NamespacedNamesFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "namespace": ubx.FieldSpec(wire_name="namespace"),
}

_GkebackupBackupPlan_BackupConfig_SelectedApplicationsFields = {
    "namespaced_names": ubx.FieldSpec(
        wire_name="namespaced_names",
        kind="list",
        fields=_GkebackupBackupPlan_BackupConfig_SelectedApplications_NamespacedNamesFields,
    ),
}

_GkebackupBackupPlan_BackupConfig_SelectedNamespaceLabels_ResourceLabelsFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_GkebackupBackupPlan_BackupConfig_SelectedNamespaceLabelsFields = {
    "resource_labels": ubx.FieldSpec(
        wire_name="resource_labels",
        kind="list",
        fields=_GkebackupBackupPlan_BackupConfig_SelectedNamespaceLabels_ResourceLabelsFields,
    ),
}

_GkebackupBackupPlan_BackupConfig_SelectedNamespacesFields = {
    "namespaces": ubx.FieldSpec(wire_name="namespaces"),
}

_GkebackupBackupPlan_BackupConfigFields = {
    "all_namespaces": ubx.FieldSpec(wire_name="all_namespaces"),
    "encryption_key": ubx.FieldSpec(
        wire_name="encryption_key",
        kind="object",
        fields=_GkebackupBackupPlan_BackupConfig_EncryptionKeyFields,
    ),
    ...
    "selected_applications": ubx.FieldSpec(
        ...
        kind="object",
        fields=_GkebackupBackupPlan_BackupConfig_SelectedApplicationsFields,
    ),
    "selected_namespace_labels": ubx.FieldSpec(
        wire_name="selected_namespace_labels",
        kind="object",
        fields=_GkebackupBackupPlan_BackupConfig_SelectedNamespaceLabelsFields,
    ),
    "selected_namespaces": ubx.FieldSpec(
        wire_name="selected_namespaces",
        kind="object",
        fields=_GkebackupBackupPlan_BackupConfig_SelectedNamespacesFields,
    ),
}

_GkebackupBackupPlan_BackupSchedule_RpoConfig_ExclusionWindows_DaysOfWeekFields = {
    "days_of_week": ubx.FieldSpec(wire_name="days_of_week"),
}

_GkebackupBackupPlan_BackupSchedule_RpoConfig_ExclusionWindows_SingleOccurrenceDateFields = {
    "day": ubx.FieldSpec(wire_name="day"),
    "month": ubx.FieldSpec(wire_name="month"),
    "year": ubx.FieldSpec(wire_name="year"),
}

_GkebackupBackupPlan_BackupSchedule_RpoConfig_ExclusionWindows_StartTimeFields = {
...
_GkebackupBackupPlan_BackupSchedule_RpoConfig_ExclusionWindowsFields = {
    "daily": ubx.FieldSpec(wire_name="daily"),
    "days_of_week": ubx.FieldSpec(
        wire_name="days_of_week",
        kind="object",
        fields=_GkebackupBackupPlan_BackupSchedule_RpoConfig_ExclusionWindows_DaysOfWeekFields,
    ),
    "duration": ubx.FieldSpec(wire_name="duration"),
    "single_occurrence_date": ubx.FieldSpec(
        wire_name="single_occurrence_date",
        kind="object",
        fields=_GkebackupBackupPlan_BackupSchedule_RpoConfig_ExclusionWindows_SingleOccurrenceDateFields,
    ),
    "start_time": ubx.FieldSpec(
        wire_name="start_time",
        kind="object",
        fields=_GkebackupBackupPlan_BackupSchedule_RpoConfig_ExclusionWindows_StartTimeFields,
    ),
}

_GkebackupBackupPlan_BackupSchedule_RpoConfigFields = {
    "exclusion_windows": ubx.FieldSpec(
        wire_name="exclusion_windows",
        kind="list",
        fields=_GkebackupBackupPlan_BackupSchedule_RpoConfig_ExclusionWindowsFields,
    ),
    "target_rpo_minutes": ubx.FieldSpec(wire_name="target_rpo_minutes"),
}

_GkebackupBackupPlan_BackupScheduleFields = {
    ...
    "rpo_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_GkebackupBackupPlan_BackupSchedule_RpoConfigFields,
    ),
}

_GkebackupBackupPlan_RetentionPolicyFields = {
...
@dataclasses.dataclass
class GkebackupBackupPlanConfig:
...
@dataclasses.dataclass
class GkebackupBackupPlanAttrs:
    # Output only. The fully qualified name of the BackupChannel to be used to create a backup. This field is set only if the cluster being backed up is in a different project. `projects/*/locations/*/backupChannels/*`
    backup_channel: Any = None
    # BackupConfig defines the configuration of Backups created via this BackupPlan.
    backup_config: Any = None
...
GkebackupBackupPlan = ubx.ResourceBinding(
    wire_type="google_gkebackup_gkebackup_backup_plan",
    fields={
        "backup_channel": ubx.FieldSpec(wire_name="backup_channel"),
        "backup_config": ubx.FieldSpec(
            wire_name="backup_config",
            kind="object",
            fields=_GkebackupBackupPlan_BackupConfigFields,
        ),
        "backup_schedule": ubx.FieldSpec(
            wire_name="backup_schedule",
            kind="object",
            fields=_GkebackupBackupPlan_BackupScheduleFields,
        ),
        ...
        "retention_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_GkebackupBackupPlan_RetentionPolicyFields,
        ),
