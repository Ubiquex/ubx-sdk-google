...
class GkebackupRestore_Filter_ExclusionFilters_GroupKind:
    resource_group: Any = None
    resource_kind: Any = None

@dataclasses.dataclass
class GkebackupRestore_Filter_ExclusionFilters:
    group_kind: Any = None
    labels: Any = None
    name: Any = None
    namespace: Any = None
...
@dataclasses.dataclass
class GkebackupRestore_RestoreConfig_ClusterResourceRestoreScope:
...
@dataclasses.dataclass
class GkebackupRestore_RestoreConfig_ExcludedNamespaces:
    # Optional. A list of Kubernetes Namespaces.
    namespaces: Any = None

@dataclasses.dataclass
class GkebackupRestore_RestoreConfig_RestoreOrder_GroupKindDependencies:
    requiring: Any = None
    satisfying: Any = None

@dataclasses.dataclass
class GkebackupRestore_RestoreConfig_RestoreOrder:
...
@dataclasses.dataclass
class GkebackupRestore_RestoreConfig_SelectedApplications_NamespacedNames:
    name: Any = None
    namespace: Any = None

@dataclasses.dataclass
class GkebackupRestore_RestoreConfig_SelectedApplications:
    # Optional. A list of namespaced Kubernetes resources.
    namespaced_names: Any = None

@dataclasses.dataclass
class GkebackupRestore_RestoreConfig_SubstitutionRules:
    new_value: Any = None
...
@dataclasses.dataclass
class GkebackupRestore_RestoreConfig_TransformationRules_FieldActions:
    from_path: Any = None
    op: Any = None
    path: Any = None
    value: Any = None
...
@dataclasses.dataclass
class GkebackupRestore_RestoreConfig_TransformationRules_ResourceFilter:
    group_kinds: Any = None
    json_path: Any = None
    namespaces: Any = None

@dataclasses.dataclass
class GkebackupRestore_RestoreConfig_TransformationRules:
    description: Any = None
    field_actions: Any = None
    resource_filter: Any = None

@dataclasses.dataclass
class GkebackupRestore_RestoreConfig_VolumeDataRestorePolicyBindings:
    policy: Any = None
    volume_type: Any = None

@dataclasses.dataclass
class GkebackupRestore_RestoreConfig:
...
@dataclasses.dataclass
class GkebackupRestore_TroubleshootingInfo:
...
@dataclasses.dataclass
class GkebackupRestore_VolumeDataRestorePolicyOverrides:
    policy: Any = None
    selected_pvcs: Any = None

_GkebackupRestore_Filter_ExclusionFilters_GroupKindFields = {
    "resource_group": ubx.FieldSpec(wire_name="resource_group"),
    "resource_kind": ubx.FieldSpec(wire_name="resource_kind"),
}

_GkebackupRestore_Filter_ExclusionFiltersFields = {
    "group_kind": ubx.FieldSpec(
        wire_name="group_kind",
        kind="object",
        fields=_GkebackupRestore_Filter_ExclusionFilters_GroupKindFields,
    ),
...
_GkebackupRestore_FilterFields = {
    "exclusion_filters": ubx.FieldSpec(
        wire_name="exclusion_filters",
        kind="list",
        fields=_GkebackupRestore_Filter_ExclusionFiltersFields,
    ),
...
_GkebackupRestore_RestoreConfig_ClusterResourceRestoreScopeFields = {
...
_GkebackupRestore_RestoreConfig_ExcludedNamespacesFields = {
    "namespaces": ubx.FieldSpec(wire_name="namespaces"),
}

_GkebackupRestore_RestoreConfig_RestoreOrder_GroupKindDependenciesFields = {
...
_GkebackupRestore_RestoreConfig_RestoreOrderFields = {
    "group_kind_dependencies": ubx.FieldSpec(
        wire_name="group_kind_dependencies",
        kind="list",
        fields=_GkebackupRestore_RestoreConfig_RestoreOrder_GroupKindDependenciesFields,
    ),
}

_GkebackupRestore_RestoreConfig_SelectedApplications_NamespacedNamesFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "namespace": ubx.FieldSpec(wire_name="namespace"),
}

_GkebackupRestore_RestoreConfig_SelectedApplicationsFields = {
    "namespaced_names": ubx.FieldSpec(
        wire_name="namespaced_names",
        kind="list",
        fields=_GkebackupRestore_RestoreConfig_SelectedApplications_NamespacedNamesFields,
    ),
}

_GkebackupRestore_RestoreConfig_SubstitutionRulesFields = {
...
_GkebackupRestore_RestoreConfig_TransformationRules_FieldActionsFields = {
...
_GkebackupRestore_RestoreConfig_TransformationRules_ResourceFilterFields = {
...
_GkebackupRestore_RestoreConfig_TransformationRulesFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "field_actions": ubx.FieldSpec(
        wire_name="field_actions",
        kind="list",
        fields=_GkebackupRestore_RestoreConfig_TransformationRules_FieldActionsFields,
    ),
    "resource_filter": ubx.FieldSpec(
        wire_name="resource_filter",
        kind="object",
        fields=_GkebackupRestore_RestoreConfig_TransformationRules_ResourceFilterFields,
    ),
}

_GkebackupRestore_RestoreConfig_VolumeDataRestorePolicyBindingsFields = {
    "policy": ubx.FieldSpec(wire_name="policy"),
    "volume_type": ubx.FieldSpec(wire_name="volume_type"),
}

_GkebackupRestore_RestoreConfigFields = {
    ...
    "cluster_resource_restore_scope": ubx.FieldSpec(
        ...
        kind="object",
        fields=_GkebackupRestore_RestoreConfig_ClusterResourceRestoreScopeFields,
    ),
    "excluded_namespaces": ubx.FieldSpec(
        wire_name="excluded_namespaces",
        kind="object",
        fields=_GkebackupRestore_RestoreConfig_ExcludedNamespacesFields,
    ),
    ...
    "restore_order": ubx.FieldSpec(
        ...
        kind="object",
        fields=_GkebackupRestore_RestoreConfig_RestoreOrderFields,
    ),
    "selected_applications": ubx.FieldSpec(
        wire_name="selected_applications",
        kind="object",
        fields=_GkebackupRestore_RestoreConfig_SelectedApplicationsFields,
    ),
    ...
    "substitution_rules": ubx.FieldSpec(
        ...
        kind="list",
        fields=_GkebackupRestore_RestoreConfig_SubstitutionRulesFields,
    ),
    "transformation_rules": ubx.FieldSpec(
        wire_name="transformation_rules",
        kind="list",
        fields=_GkebackupRestore_RestoreConfig_TransformationRulesFields,
    ),
    ...
    "volume_data_restore_policy_bindings": ubx.FieldSpec(
        ...
        kind="list",
        fields=_GkebackupRestore_RestoreConfig_VolumeDataRestorePolicyBindingsFields,
    ),
}

_GkebackupRestore_TroubleshootingInfoFields = {
    "state_reason_code": ubx.FieldSpec(wire_name="state_reason_code"),
    "state_reason_uri": ubx.FieldSpec(wire_name="state_reason_uri"),
}

_GkebackupRestore_VolumeDataRestorePolicyOverridesFields = {
    "policy": ubx.FieldSpec(wire_name="policy"),
...
GkebackupRestore = ubx.ResourceBinding(
    wire_type="google_gkebackup_gkebackup_restore",
    fields={
        ...
        "filter": ubx.FieldSpec(
            wire_name="filter",
            kind="object",
            fields=_GkebackupRestore_FilterFields,
        ),
        "labels": ubx.FieldSpec(wire_name="labels"),
        "name": ubx.FieldSpec(wire_name="name"),
        ...
        "restore_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_GkebackupRestore_RestoreConfigFields,
        ),
        ...
        "troubleshooting_info": ubx.FieldSpec(
            ...
            kind="object",
            fields=_GkebackupRestore_TroubleshootingInfoFields,
        ),
        ...
        "volume_data_restore_policy_overrides": ubx.FieldSpec(
            ...
            kind="list",
            fields=_GkebackupRestore_VolumeDataRestorePolicyOverridesFields,
        ),
