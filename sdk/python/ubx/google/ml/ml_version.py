...
class MlVersion_AcceleratorConfig:
...
@dataclasses.dataclass
class MlVersion_AutoScaling_Metrics:
    name: Any = None
    target: Any = None

@dataclasses.dataclass
class MlVersion_AutoScaling:
...
@dataclasses.dataclass
class MlVersion_Container_Env:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class MlVersion_Container_Ports:
    container_port: Any = None

@dataclasses.dataclass
class MlVersion_Container:
...
@dataclasses.dataclass
class MlVersion_ExplanationConfig_IntegratedGradientsAttribution:
    # Number of steps for approximating the path integral. A good value to start is 50 and gradually increase until the sum to diff property is met within the desired error range.
    num_integral_steps: Any = None

@dataclasses.dataclass
class MlVersion_ExplanationConfig_SampledShapleyAttribution:
    # The number of feature permutations to consider when approximating the Shapley values.
    num_paths: Any = None

@dataclasses.dataclass
class MlVersion_ExplanationConfig:
...
@dataclasses.dataclass
class MlVersion_ManualScaling:
    # The number of nodes to allocate for this model. These nodes are always up, starting from the time the model is deployed, so the cost of operating this model will be proportional to `nodes` * number of hours since last billing cycle plus the cost for each prediction performed.
    nodes: Any = None

@dataclasses.dataclass
class MlVersion_RequestLoggingConfig:
...
_MlVersion_ManualScalingFields = {
    "nodes": ubx.FieldSpec(wire_name="nodes"),
}

_MlVersion_RequestLoggingConfigFields = {
...
MlVersion = ubx.ResourceBinding(
    wire_type="google_ml_ml_version",
    fields={
        "accelerator_config": ubx.FieldSpec(
            wire_name="accelerator_config",
            kind="object",
            fields=_MlVersion_AcceleratorConfigFields,
        ),
        "auto_scaling": ubx.FieldSpec(
            wire_name="auto_scaling",
            kind="object",
            fields=_MlVersion_AutoScalingFields,
        ),
        "container": ubx.FieldSpec(
            wire_name="container",
            kind="object",
            fields=_MlVersion_ContainerFields,
        ),
        ...
        "explanation_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_MlVersion_ExplanationConfigFields,
        ),
        ...
        "manual_scaling": ubx.FieldSpec(
            ...
            kind="object",
            fields=_MlVersion_ManualScalingFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        ...
        "request_logging_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_MlVersion_RequestLoggingConfigFields,
        ),
        "routes": ubx.FieldSpec(
            wire_name="routes",
            kind="object",
            fields=_MlVersion_RoutesFields,
        ),
