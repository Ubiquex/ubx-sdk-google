...
class Model_DefaultVersion_AcceleratorConfig:
...
@dataclasses.dataclass
class Model_DefaultVersion_AutoScaling_Metrics:
...
@dataclasses.dataclass
class Model_DefaultVersion_AutoScaling:
...
@dataclasses.dataclass
class Model_DefaultVersion_Container_Env:
    # The resource name or identifier of this object. (AI-inferred)
    name: Any = None
...
@dataclasses.dataclass
class Model_DefaultVersion_ExplanationConfig_IntegratedGradientsAttribution:
    # Number of steps for approximating the path integral. A good value to start is 50 and gradually increase until the sum to diff property is met within the desired error range.
    num_integral_steps: Any = None

@dataclasses.dataclass
class Model_DefaultVersion_ExplanationConfig_SampledShapleyAttribution:
    # The number of feature permutations to consider when approximating the Shapley values.
    num_paths: Any = None

@dataclasses.dataclass
class Model_DefaultVersion_ExplanationConfig:
...
@dataclasses.dataclass
class Model_DefaultVersion_ManualScaling:
    # The number of nodes to allocate for this model. These nodes are always up, starting from the time the model is deployed, so the cost of operating this model will be proportional to `nodes` * number of hours since last billing cycle plus the cost for each prediction performed.
    nodes: Any = None

@dataclasses.dataclass
class Model_DefaultVersion_RequestLoggingConfig:
...
@dataclasses.dataclass
class Model_DefaultVersion_Routes:
...
_Model_DefaultVersion_AcceleratorConfigFields = {
    "count": ubx.FieldSpec(wire_name="count"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_Model_DefaultVersion_AutoScaling_MetricsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "target": ubx.FieldSpec(wire_name="target"),
}

_Model_DefaultVersion_AutoScalingFields = {
    "max_nodes": ubx.FieldSpec(wire_name="max_nodes"),
    "metrics": ubx.FieldSpec(
        wire_name="metrics",
        kind="list",
        fields=_Model_DefaultVersion_AutoScaling_MetricsFields,
    ),
    "min_nodes": ubx.FieldSpec(wire_name="min_nodes"),
}

_Model_DefaultVersion_Container_EnvFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_Model_DefaultVersion_Container_PortsFields = {
    "container_port": ubx.FieldSpec(wire_name="container_port"),
}

_Model_DefaultVersion_ContainerFields = {
    "args": ubx.FieldSpec(wire_name="args"),
    "command": ubx.FieldSpec(wire_name="command"),
    "env": ubx.FieldSpec(
        wire_name="env",
        kind="list",
        fields=_Model_DefaultVersion_Container_EnvFields,
    ),
    "image": ubx.FieldSpec(wire_name="image"),
    "ports": ubx.FieldSpec(
        wire_name="ports",
        kind="list",
        fields=_Model_DefaultVersion_Container_PortsFields,
    ),
}

_Model_DefaultVersion_ExplanationConfig_IntegratedGradientsAttributionFields = {
    "num_integral_steps": ubx.FieldSpec(wire_name="num_integral_steps"),
}

_Model_DefaultVersion_ExplanationConfig_SampledShapleyAttributionFields = {
    "num_paths": ubx.FieldSpec(wire_name="num_paths"),
}

_Model_DefaultVersion_ExplanationConfigFields = {
    "integrated_gradients_attribution": ubx.FieldSpec(
        wire_name="integrated_gradients_attribution",
        kind="object",
        fields=_Model_DefaultVersion_ExplanationConfig_IntegratedGradientsAttributionFields,
    ),
    "sampled_shapley_attribution": ubx.FieldSpec(
        wire_name="sampled_shapley_attribution",
        kind="object",
        fields=_Model_DefaultVersion_ExplanationConfig_SampledShapleyAttributionFields,
    ),
...
_Model_DefaultVersion_ManualScalingFields = {
    "nodes": ubx.FieldSpec(wire_name="nodes"),
}

_Model_DefaultVersion_RequestLoggingConfigFields = {
...
_Model_DefaultVersionFields = {
    ...
    "explanation_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Model_DefaultVersion_ExplanationConfigFields,
    ),
    ...
    "manual_scaling": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Model_DefaultVersion_ManualScalingFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    ...
    "request_logging_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Model_DefaultVersion_RequestLoggingConfigFields,
    ),
    "routes": ubx.FieldSpec(
        wire_name="routes",
        kind="object",
        fields=_Model_DefaultVersion_RoutesFields,
    ),
...
Model = ubx.ResourceBinding(
    wire_type="google_ml_model",
    fields={
        "default_version": ubx.FieldSpec(
            wire_name="default_version",
            kind="object",
            fields=_Model_DefaultVersionFields,
        ),
        "description": ubx.FieldSpec(wire_name="description"),
        "etag": ubx.FieldSpec(wire_name="etag"),
        "labels": ubx.FieldSpec(wire_name="labels"),
