...
class CloudresourcemanagerTagKeyConfig:
...
@dataclasses.dataclass
class CloudresourcemanagerTagKeyAttrs:
    # Optional. Regular expression constraint for freeform tag values. If present, it implicitly allows freeform values (constrained by the regex).
    allowed_values_regex: Any = None
    # Output only. Creation time.
    create_time: Any = None
...
CloudresourcemanagerTagKey = ubx.ResourceBinding(
    wire_type="google_cloudresourcemanager_cloudresourcemanager_tag_key",
    fields={
