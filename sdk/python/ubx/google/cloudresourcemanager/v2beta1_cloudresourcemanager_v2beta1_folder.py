...
class V2beta1CloudresourcemanagerV2beta1FolderConfig:
...
@dataclasses.dataclass
class V2beta1CloudresourcemanagerV2beta1FolderAttrs:
    # Output only. Optional capabilities configured for this folder (via UpdateCapability API). Example: `folders/123/capabilities/app-management`.
    configured_capabilities: Any = None
    # Output only. Timestamp when the Folder was created. Assigned by the server.
    create_time: Any = None
...
V2beta1CloudresourcemanagerV2beta1Folder = ubx.ResourceBinding(
    wire_type="google_cloudresourcemanager_v2beta1_cloudresourcemanager_v2beta1_folder",
    fields={
