# Code generated by `ubx sdk gen` from google_firebaseappcheck_debug_token. DO NOT EDIT.
...
DebugToken = ubx.ResourceBinding(
    wire_type="google_firebaseappcheck_debug_token",
    fields={
