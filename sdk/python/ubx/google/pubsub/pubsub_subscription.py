...
class PubsubSubscription_AnalyticsHubSubscriptionInfo:
...
@dataclasses.dataclass
class PubsubSubscription_BigqueryConfig:
...
@dataclasses.dataclass
class PubsubSubscription_BigtableConfig:
...
@dataclasses.dataclass
class PubsubSubscription_CloudStorageConfig_AvroConfig:
...
@dataclasses.dataclass
class PubsubSubscription_CloudStorageConfig:
...
@dataclasses.dataclass
class PubsubSubscription_DeadLetterPolicy:
...
@dataclasses.dataclass
class PubsubSubscription_ExpirationPolicy:
...
@dataclasses.dataclass
class PubsubSubscription_MessageTransforms_AiInference_UnstructuredInference:
    parameters: Any = None

@dataclasses.dataclass
class PubsubSubscription_MessageTransforms_AiInference:
    endpoint: Any = None
    service_account_email: Any = None
    unstructured_inference: Any = None

@dataclasses.dataclass
class PubsubSubscription_MessageTransforms_Compression:
    compression_algorithm: Any = None
    compression_mode: Any = None

@dataclasses.dataclass
class PubsubSubscription_MessageTransforms_JavascriptUdf:
    code: Any = None
    function_name: Any = None

@dataclasses.dataclass
class PubsubSubscription_MessageTransforms:
...
@dataclasses.dataclass
class PubsubSubscription_PushConfig_NoWrapper:
...
@dataclasses.dataclass
class PubsubSubscription_PushConfig_OidcToken:
...
@dataclasses.dataclass
class PubsubSubscription_PushConfig:
...
@dataclasses.dataclass
class PubsubSubscription_RetryPolicy:
...
_PubsubSubscription_AnalyticsHubSubscriptionInfoFields = {
    "listing": ubx.FieldSpec(wire_name="listing"),
    "subscription": ubx.FieldSpec(wire_name="subscription"),
}

_PubsubSubscription_BigqueryConfigFields = {
...
_PubsubSubscription_BigtableConfigFields = {
...
_PubsubSubscription_CloudStorageConfig_AvroConfigFields = {
    "use_topic_schema": ubx.FieldSpec(wire_name="use_topic_schema"),
    "write_metadata": ubx.FieldSpec(wire_name="write_metadata"),
}

_PubsubSubscription_CloudStorageConfigFields = {
    "avro_config": ubx.FieldSpec(
        wire_name="avro_config",
        kind="object",
        fields=_PubsubSubscription_CloudStorageConfig_AvroConfigFields,
    ),
...
_PubsubSubscription_DeadLetterPolicyFields = {
...
_PubsubSubscription_ExpirationPolicyFields = {
    "ttl": ubx.FieldSpec(wire_name="ttl"),
}

_PubsubSubscription_MessageTransforms_AiInference_UnstructuredInferenceFields = {
    "parameters": ubx.FieldSpec(wire_name="parameters"),
}

_PubsubSubscription_MessageTransforms_AiInferenceFields = {
    "endpoint": ubx.FieldSpec(wire_name="endpoint"),
    "service_account_email": ubx.FieldSpec(wire_name="service_account_email"),
    "unstructured_inference": ubx.FieldSpec(
        wire_name="unstructured_inference",
        kind="object",
        fields=_PubsubSubscription_MessageTransforms_AiInference_UnstructuredInferenceFields,
    ),
}

_PubsubSubscription_MessageTransforms_CompressionFields = {
...
_PubsubSubscription_MessageTransforms_JavascriptUdfFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "function_name": ubx.FieldSpec(wire_name="function_name"),
}

_PubsubSubscription_MessageTransformsFields = {
    "ai_inference": ubx.FieldSpec(
        wire_name="ai_inference",
        kind="object",
        fields=_PubsubSubscription_MessageTransforms_AiInferenceFields,
    ),
    "compression": ubx.FieldSpec(
        wire_name="compression",
        kind="object",
        fields=_PubsubSubscription_MessageTransforms_CompressionFields,
    ),
    ...
    "javascript_udf": ubx.FieldSpec(
        ...
        kind="object",
        fields=_PubsubSubscription_MessageTransforms_JavascriptUdfFields,
    ),
}

_PubsubSubscription_PushConfig_NoWrapperFields = {
    "write_metadata": ubx.FieldSpec(wire_name="write_metadata"),
}

_PubsubSubscription_PushConfig_OidcTokenFields = {
    "audience": ubx.FieldSpec(wire_name="audience"),
    "service_account_email": ubx.FieldSpec(wire_name="service_account_email"),
}

_PubsubSubscription_PushConfigFields = {
    "attributes": ubx.FieldSpec(wire_name="attributes"),
    "no_wrapper": ubx.FieldSpec(
        wire_name="no_wrapper",
        kind="object",
        fields=_PubsubSubscription_PushConfig_NoWrapperFields,
    ),
    "oidc_token": ubx.FieldSpec(
        wire_name="oidc_token",
        kind="object",
        fields=_PubsubSubscription_PushConfig_OidcTokenFields,
    ),
    "pubsub_wrapper": ubx.FieldSpec(wire_name="pubsub_wrapper"),
    "push_endpoint": ubx.FieldSpec(wire_name="push_endpoint"),
}

_PubsubSubscription_RetryPolicyFields = {
...
PubsubSubscription = ubx.ResourceBinding(
    wire_type="google_pubsub_pubsub_subscription",
    fields={
        ...
        "analytics_hub_subscription_info": ubx.FieldSpec(
            ...
            kind="object",
            fields=_PubsubSubscription_AnalyticsHubSubscriptionInfoFields,
        ),
        "bigquery_config": ubx.FieldSpec(
            wire_name="bigquery_config",
            kind="object",
            fields=_PubsubSubscription_BigqueryConfigFields,
        ),
        "bigtable_config": ubx.FieldSpec(
            wire_name="bigtable_config",
            kind="object",
            fields=_PubsubSubscription_BigtableConfigFields,
        ),
        "cloud_storage_config": ubx.FieldSpec(
            wire_name="cloud_storage_config",
            kind="object",
            fields=_PubsubSubscription_CloudStorageConfigFields,
        ),
        "dead_letter_policy": ubx.FieldSpec(
            wire_name="dead_letter_policy",
            kind="object",
            fields=_PubsubSubscription_DeadLetterPolicyFields,
        ),
        ...
        "expiration_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_PubsubSubscription_ExpirationPolicyFields,
        ),
