...
class V2beta3CloudtasksV2beta3Queue_AppEngineHttpQueue_AppEngineRoutingOverride:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_AppEngineHttpQueue:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_HttpTarget_HeaderOverrides_Header:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_HttpTarget_HeaderOverrides:
    header: Any = None

@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_HttpTarget_OauthToken:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_HttpTarget_OidcToken:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_HttpTarget_UriOverride_PathOverride:
    # The URI path (e.g., /users/1234). Default is an empty string.
    path: Any = None

@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_HttpTarget_UriOverride_QueryOverride:
    # The query parameters (e.g., qparam1=123&qparam2=456). Default is an empty string.
    query_params: Any = None

@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_HttpTarget_UriOverride:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_HttpTarget:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_RateLimits:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_RetryConfig:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_StackdriverLoggingConfig:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Queue_Stats:
...
_V2beta3CloudtasksV2beta3Queue_AppEngineHttpQueue_AppEngineRoutingOverrideFields = {
...
_V2beta3CloudtasksV2beta3Queue_AppEngineHttpQueueFields = {
    "app_engine_routing_override": ubx.FieldSpec(
        wire_name="app_engine_routing_override",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Queue_AppEngineHttpQueue_AppEngineRoutingOverrideFields,
    ),
}

_V2beta3CloudtasksV2beta3Queue_HttpTarget_HeaderOverrides_HeaderFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_V2beta3CloudtasksV2beta3Queue_HttpTarget_HeaderOverridesFields = {
    "header": ubx.FieldSpec(
        wire_name="header",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Queue_HttpTarget_HeaderOverrides_HeaderFields,
    ),
}

_V2beta3CloudtasksV2beta3Queue_HttpTarget_OauthTokenFields = {
    "scope": ubx.FieldSpec(wire_name="scope"),
    "service_account_email": ubx.FieldSpec(wire_name="service_account_email"),
}

_V2beta3CloudtasksV2beta3Queue_HttpTarget_OidcTokenFields = {
    "audience": ubx.FieldSpec(wire_name="audience"),
    "service_account_email": ubx.FieldSpec(wire_name="service_account_email"),
}

_V2beta3CloudtasksV2beta3Queue_HttpTarget_UriOverride_PathOverrideFields = {
    "path": ubx.FieldSpec(wire_name="path"),
}

_V2beta3CloudtasksV2beta3Queue_HttpTarget_UriOverride_QueryOverrideFields = {
    "query_params": ubx.FieldSpec(wire_name="query_params"),
}

_V2beta3CloudtasksV2beta3Queue_HttpTarget_UriOverrideFields = {
    "host": ubx.FieldSpec(wire_name="host"),
    "path_override": ubx.FieldSpec(
        wire_name="path_override",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Queue_HttpTarget_UriOverride_PathOverrideFields,
    ),
    "port": ubx.FieldSpec(wire_name="port"),
    "query_override": ubx.FieldSpec(
        wire_name="query_override",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Queue_HttpTarget_UriOverride_QueryOverrideFields,
    ),
    "scheme": ubx.FieldSpec(wire_name="scheme"),
    "uri_override_enforce_mode": ubx.FieldSpec(wire_name="uri_override_enforce_mode"),
}

_V2beta3CloudtasksV2beta3Queue_HttpTargetFields = {
    "header_overrides": ubx.FieldSpec(
        wire_name="header_overrides",
        kind="list",
        fields=_V2beta3CloudtasksV2beta3Queue_HttpTarget_HeaderOverridesFields,
    ),
    "http_method": ubx.FieldSpec(wire_name="http_method"),
    "oauth_token": ubx.FieldSpec(
        wire_name="oauth_token",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Queue_HttpTarget_OauthTokenFields,
    ),
    "oidc_token": ubx.FieldSpec(
        wire_name="oidc_token",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Queue_HttpTarget_OidcTokenFields,
    ),
    "uri_override": ubx.FieldSpec(
        wire_name="uri_override",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Queue_HttpTarget_UriOverrideFields,
    ),
}

_V2beta3CloudtasksV2beta3Queue_RateLimitsFields = {
...
_V2beta3CloudtasksV2beta3Queue_RetryConfigFields = {
...
_V2beta3CloudtasksV2beta3Queue_StackdriverLoggingConfigFields = {
    "sampling_ratio": ubx.FieldSpec(wire_name="sampling_ratio"),
}

_V2beta3CloudtasksV2beta3Queue_StatsFields = {
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3QueueConfig:
    ...
    app_engine_http_queue: Any = None
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3QueueAttrs:
    # App Engine HTTP queue. The task will be delivered to the App Engine application hostname specified by its AppEngineHttpQueue and AppEngineHttpRequest. The documentation for AppEngineHttpRequest explains how the task's host URL is constructed. Using AppEngineHttpQueue requires [`appengine.applications.get`](https://cloud.google.com/appengine/docs/admin-api/access-control) Google IAM permission for the project and the following scope: `https://www.googleapis.com/auth/cloud-platform`
    app_engine_http_queue: Any = None
    # HTTP target. When specified as a Queue, all the tasks with [HttpRequest] will be overridden according to the target.
    http_target: Any = None
...
V2beta3CloudtasksV2beta3Queue = ubx.ResourceBinding(
    wire_type="google_cloudtasks_v2beta3_cloudtasks_v2beta3_queue",
    fields={
        "app_engine_http_queue": ubx.FieldSpec(
            wire_name="app_engine_http_queue",
            kind="object",
            fields=_V2beta3CloudtasksV2beta3Queue_AppEngineHttpQueueFields,
        ),
        "http_target": ubx.FieldSpec(
            wire_name="http_target",
            kind="object",
            fields=_V2beta3CloudtasksV2beta3Queue_HttpTargetFields,
        ),
        ...
        "rate_limits": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V2beta3CloudtasksV2beta3Queue_RateLimitsFields,
        ),
        "retry_config": ubx.FieldSpec(
            wire_name="retry_config",
            kind="object",
            fields=_V2beta3CloudtasksV2beta3Queue_RetryConfigFields,
        ),
        "stackdriver_logging_config": ubx.FieldSpec(
            wire_name="stackdriver_logging_config",
            kind="object",
            fields=_V2beta3CloudtasksV2beta3Queue_StackdriverLoggingConfigFields,
        ),
        "state": ubx.FieldSpec(wire_name="state"),
        "stats": ubx.FieldSpec(
            wire_name="stats",
            kind="object",
            fields=_V2beta3CloudtasksV2beta3Queue_StatsFields,
        ),
