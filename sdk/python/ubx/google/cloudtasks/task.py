# Code generated by `ubx sdk gen` from google_cloudtasks_task. DO NOT EDIT.
...
class Task_AppEngineHttpRequest_AppEngineRouting:
...
@dataclasses.dataclass
class Task_AppEngineHttpRequest:
...
@dataclasses.dataclass
class Task_FirstAttempt_ResponseStatus:
...
@dataclasses.dataclass
class Task_HttpRequest_OauthToken:
...
@dataclasses.dataclass
class Task_HttpRequest_OidcToken:
...
_Task_AppEngineHttpRequest_AppEngineRoutingFields = {
...
_Task_AppEngineHttpRequestFields = {
    "app_engine_routing": ubx.FieldSpec(
        wire_name="app_engine_routing",
        kind="object",
        fields=_Task_AppEngineHttpRequest_AppEngineRoutingFields,
    ),
...
_Task_HttpRequestFields = {
    ...
    "oauth_token": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Task_HttpRequest_OauthTokenFields,
    ),
    "oidc_token": ubx.FieldSpec(
        wire_name="oidc_token",
        kind="object",
        fields=_Task_HttpRequest_OidcTokenFields,
    ),
...
_Task_TaskFields = {
    "app_engine_http_request": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Task_AppEngineHttpRequestFields,
    ),
    ...
    "first_attempt": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Task_FirstAttemptFields,
    ),
    "http_request": ubx.FieldSpec(
        wire_name="http_request",
        kind="object",
        fields=_Task_HttpRequestFields,
    ),
...
Task = ubx.ResourceBinding(
    wire_type="google_cloudtasks_task",
    fields={
        "response_view": ubx.FieldSpec(wire_name="response_view"),
        "task": ubx.FieldSpec(
            wire_name="task",
            kind="object",
            fields=_Task_TaskFields,
        ),
    },
)
