...
class V2beta3Task_AppEngineHttpRequest_AppEngineRouting:
...
@dataclasses.dataclass
class V2beta3Task_AppEngineHttpRequest:
...
@dataclasses.dataclass
class V2beta3Task_FirstAttempt_ResponseStatus:
...
@dataclasses.dataclass
class V2beta3Task_FirstAttempt:
...
@dataclasses.dataclass
class V2beta3Task_HttpRequest_OauthToken:
...
@dataclasses.dataclass
class V2beta3Task_HttpRequest_OidcToken:
...
_V2beta3Task_AppEngineHttpRequest_AppEngineRoutingFields = {
...
_V2beta3Task_AppEngineHttpRequestFields = {
    "app_engine_routing": ubx.FieldSpec(
        wire_name="app_engine_routing",
        kind="object",
        fields=_V2beta3Task_AppEngineHttpRequest_AppEngineRoutingFields,
    ),
...
_V2beta3Task_HttpRequestFields = {
    ...
    "oauth_token": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V2beta3Task_HttpRequest_OauthTokenFields,
    ),
    "oidc_token": ubx.FieldSpec(
        wire_name="oidc_token",
        kind="object",
        fields=_V2beta3Task_HttpRequest_OidcTokenFields,
    ),
    "url": ubx.FieldSpec(wire_name="url"),
}

_V2beta3Task_PullMessageFields = {
    "payload": ubx.FieldSpec(wire_name="payload"),
    "tag": ubx.FieldSpec(wire_name="tag"),
}

_V2beta3Task_RetryConfigFields = {
...
_V2beta3Task_TaskFields = {
    ...
    "first_attempt": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V2beta3Task_FirstAttemptFields,
    ),
    "http_request": ubx.FieldSpec(
        wire_name="http_request",
        kind="object",
        fields=_V2beta3Task_HttpRequestFields,
    ),
...
V2beta3Task = ubx.ResourceBinding(
    wire_type="google_cloudtasks_v2beta3_task",
    fields={
        ...
        "task": ubx.FieldSpec(
            wire_name="task",
            kind="object",
            fields=_V2beta3Task_TaskFields,
        ),
    },
)
