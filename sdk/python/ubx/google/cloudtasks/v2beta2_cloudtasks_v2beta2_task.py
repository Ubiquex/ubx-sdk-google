...
class V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest_AppEngineRouting:
...
@dataclasses.dataclass
class V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest:
...
@dataclasses.dataclass
class V2beta2CloudtasksV2beta2Task_HttpRequest_OauthToken:
...
@dataclasses.dataclass
class V2beta2CloudtasksV2beta2Task_HttpRequest_OidcToken:
...
@dataclasses.dataclass
class V2beta2CloudtasksV2beta2Task_HttpRequest:
...
@dataclasses.dataclass
class V2beta2CloudtasksV2beta2Task_PullMessage:
...
@dataclasses.dataclass
class V2beta2CloudtasksV2beta2Task_RetryConfig:
...
@dataclasses.dataclass
class V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus_ResponseStatus:
...
@dataclasses.dataclass
class V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus:
    # Output only. The time that this attempt was dispatched. `dispatch_time` will be truncated to the nearest microsecond.
    dispatch_time: Any = None
...
@dataclasses.dataclass
class V2beta2CloudtasksV2beta2Task_Status:
    # Output only. The number of attempts dispatched. This count includes attempts which have been dispatched but haven't received a response.
    attempt_dispatch_count: Any = None
    # Output only. The number of attempts which have received a response. This field is not calculated for pull tasks.
    attempt_response_count: Any = None
    # The status of a task attempt.
    first_attempt_status: Any = None
    # The status of a task attempt.
    last_attempt_status: Any = None

@dataclasses.dataclass
class V2beta2CloudtasksV2beta2Task_Task:
    ...
    app_engine_http_request: Any = None
...
_V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest_AppEngineRoutingFields = {
...
_V2beta2CloudtasksV2beta2Task_AppEngineHttpRequestFields = {
    "app_engine_routing": ubx.FieldSpec(
        wire_name="app_engine_routing",
        kind="object",
        fields=_V2beta2CloudtasksV2beta2Task_AppEngineHttpRequest_AppEngineRoutingFields,
    ),
...
_V2beta2CloudtasksV2beta2Task_HttpRequest_OauthTokenFields = {
    "scope": ubx.FieldSpec(wire_name="scope"),
    "service_account_email": ubx.FieldSpec(wire_name="service_account_email"),
}

_V2beta2CloudtasksV2beta2Task_HttpRequest_OidcTokenFields = {
    "audience": ubx.FieldSpec(wire_name="audience"),
    "service_account_email": ubx.FieldSpec(wire_name="service_account_email"),
}

_V2beta2CloudtasksV2beta2Task_HttpRequestFields = {
    ...
    "oauth_token": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V2beta2CloudtasksV2beta2Task_HttpRequest_OauthTokenFields,
    ),
    "oidc_token": ubx.FieldSpec(
        wire_name="oidc_token",
        kind="object",
        fields=_V2beta2CloudtasksV2beta2Task_HttpRequest_OidcTokenFields,
    ),
    "url": ubx.FieldSpec(wire_name="url"),
}

_V2beta2CloudtasksV2beta2Task_PullMessageFields = {
    "payload": ubx.FieldSpec(wire_name="payload"),
    "tag": ubx.FieldSpec(wire_name="tag"),
}

_V2beta2CloudtasksV2beta2Task_RetryConfigFields = {
...
_V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus_ResponseStatusFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatusFields = {
    "dispatch_time": ubx.FieldSpec(wire_name="dispatch_time"),
    "response_status": ubx.FieldSpec(
        wire_name="response_status",
        kind="object",
        fields=_V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatus_ResponseStatusFields,
    ),
    "response_time": ubx.FieldSpec(wire_name="response_time"),
    "schedule_time": ubx.FieldSpec(wire_name="schedule_time"),
}

_V2beta2CloudtasksV2beta2Task_StatusFields = {
    "attempt_dispatch_count": ubx.FieldSpec(wire_name="attempt_dispatch_count"),
    "attempt_response_count": ubx.FieldSpec(wire_name="attempt_response_count"),
    "first_attempt_status": ubx.FieldSpec(
        wire_name="first_attempt_status",
        kind="object",
        fields=_V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatusFields,
    ),
    "last_attempt_status": ubx.FieldSpec(
        wire_name="last_attempt_status",
        kind="object",
        fields=_V2beta2CloudtasksV2beta2Task_Status_FirstAttemptStatusFields,
    ),
}

_V2beta2CloudtasksV2beta2Task_TaskFields = {
    "app_engine_http_request": ubx.FieldSpec(
        wire_name="app_engine_http_request",
        kind="object",
        fields=_V2beta2CloudtasksV2beta2Task_AppEngineHttpRequestFields,
    ),
    "create_time": ubx.FieldSpec(wire_name="create_time"),
    "http_request": ubx.FieldSpec(
        wire_name="http_request",
        kind="object",
        fields=_V2beta2CloudtasksV2beta2Task_HttpRequestFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    "pull_message": ubx.FieldSpec(
        wire_name="pull_message",
        kind="object",
        fields=_V2beta2CloudtasksV2beta2Task_PullMessageFields,
    ),
    "retry_config": ubx.FieldSpec(
        wire_name="retry_config",
        kind="object",
        fields=_V2beta2CloudtasksV2beta2Task_RetryConfigFields,
    ),
    "schedule_time": ubx.FieldSpec(wire_name="schedule_time"),
    "status": ubx.FieldSpec(
        wire_name="status",
        kind="object",
        fields=_V2beta2CloudtasksV2beta2Task_StatusFields,
    ),
    "view": ubx.FieldSpec(wire_name="view"),
}

@dataclasses.dataclass
class V2beta2CloudtasksV2beta2TaskConfig:
...
@dataclasses.dataclass
class V2beta2CloudtasksV2beta2TaskAttrs:
    # App Engine HTTP request. The message defines the HTTP request that is sent to an App Engine app when the task is dispatched. This proto can only be used for tasks in a queue which has app_engine_http_target set. Using AppEngineHttpRequest requires [`appengine.applications.get`](https://cloud.google.com/appengine/docs/admin-api/access-control) Google IAM permission for the project and the following scope: `https://www.googleapis.com/auth/cloud-platform` The task will be delivered to the App Engine app which belongs to the same project as the queue. For more information, see [How Requests are Routed](https://cloud.google.com/appengine/docs/standard/python/how-requests-are-routed) and how routing is affected by [dispatch files](https://cloud.google.com/appengine/docs/python/config/dispatchref). Traffic is encrypted during transport and never leaves Google datacenters. Because this traffic is carried over a communication mechanism internal to Google, you cannot explicitly set the protocol (for example, HTTP or HTTPS). The request to the handler, however, will appear to have used the HTTP protocol. The AppEngineRouting used to construct the URL that the task is delivered to can be set at the queue-level or task-level: * If set, app_engine_routing_override is used for all tasks in the queue, no matter what the setting is for the task-level app_engine_routing. The `url` that the task will be sent to is: * `url =` host `+` relative_url Tasks can be dispatched to secure app handlers, unsecure app handlers, and URIs restricted with [`login: admin`](https://cloud.google.com/appengine/docs/standard/python/config/appref). Because tasks are not run as any user, they cannot be dispatched to URIs restricted with [`login: required`](https://cloud.google.com/appengine/docs/standard/python/config/appref) Task dispatches also do not follow redirects. The task attempt has succeeded if the app's request handler returns an HTTP response code in the range [`200` - `299`]. The task attempt has failed if the app's handler returns a non-2xx response code or Cloud Tasks does not receive response before the deadline. Failed tasks will be retried according to the retry configuration. `503` (Service Unavailable) is considered an App Engine system error instead of an application error and will cause Cloud Tasks' traffic congestion control to temporarily throttle the queue's dispatches. Unlike other types of task targets, a `429` (Too Many Requests) response from an app handler does not cause traffic congestion control to throttle the queue.
    app_engine_http_request: Any = None
    # Output only. The time that the task was created. `create_time` will be truncated to the nearest second.
    create_time: Any = None
...
V2beta2CloudtasksV2beta2Task = ubx.ResourceBinding(
    wire_type="google_cloudtasks_v2beta2_cloudtasks_v2beta2_task",
    fields={
        "parent": ubx.FieldSpec(wire_name="parent"),
        "response_view": ubx.FieldSpec(wire_name="response_view"),
        "task": ubx.FieldSpec(
            wire_name="task",
            kind="object",
            fields=_V2beta2CloudtasksV2beta2Task_TaskFields,
        ),
    },
)
