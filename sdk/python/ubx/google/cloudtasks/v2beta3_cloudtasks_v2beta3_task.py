...
class V2beta3CloudtasksV2beta3Task_AppEngineHttpRequest_AppEngineRouting:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Task_AppEngineHttpRequest:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Task_FirstAttempt_ResponseStatus:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Task_FirstAttempt:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Task_HttpRequest_OauthToken:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Task_HttpRequest_OidcToken:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Task_HttpRequest:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Task_PullMessage:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Task_RetryConfig:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3Task_Task:
...
_V2beta3CloudtasksV2beta3Task_AppEngineHttpRequest_AppEngineRoutingFields = {
...
_V2beta3CloudtasksV2beta3Task_AppEngineHttpRequestFields = {
    "app_engine_routing": ubx.FieldSpec(
        wire_name="app_engine_routing",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Task_AppEngineHttpRequest_AppEngineRoutingFields,
    ),
...
_V2beta3CloudtasksV2beta3Task_HttpRequestFields = {
    ...
    "oauth_token": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Task_HttpRequest_OauthTokenFields,
    ),
    "oidc_token": ubx.FieldSpec(
        wire_name="oidc_token",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Task_HttpRequest_OidcTokenFields,
    ),
    "url": ubx.FieldSpec(wire_name="url"),
}

_V2beta3CloudtasksV2beta3Task_PullMessageFields = {
    "payload": ubx.FieldSpec(wire_name="payload"),
    "tag": ubx.FieldSpec(wire_name="tag"),
}

_V2beta3CloudtasksV2beta3Task_RetryConfigFields = {
...
_V2beta3CloudtasksV2beta3Task_TaskFields = {
    "app_engine_http_request": ubx.FieldSpec(
        wire_name="app_engine_http_request",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Task_AppEngineHttpRequestFields,
    ),
    "create_time": ubx.FieldSpec(wire_name="create_time"),
    "dispatch_count": ubx.FieldSpec(wire_name="dispatch_count"),
    "dispatch_deadline": ubx.FieldSpec(wire_name="dispatch_deadline"),
    "first_attempt": ubx.FieldSpec(
        wire_name="first_attempt",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Task_FirstAttemptFields,
    ),
    "http_request": ubx.FieldSpec(
        wire_name="http_request",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Task_HttpRequestFields,
    ),
    ...
    "pull_message": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Task_PullMessageFields,
    ),
    "response_count": ubx.FieldSpec(wire_name="response_count"),
    "retry_config": ubx.FieldSpec(
        wire_name="retry_config",
        kind="object",
        fields=_V2beta3CloudtasksV2beta3Task_RetryConfigFields,
    ),
    "schedule_time": ubx.FieldSpec(wire_name="schedule_time"),
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3TaskConfig:
...
@dataclasses.dataclass
class V2beta3CloudtasksV2beta3TaskAttrs:
    # App Engine HTTP request. The message defines the HTTP request that is sent to an App Engine app when the task is dispatched. Using AppEngineHttpRequest requires [`appengine.applications.get`](https://cloud.google.com/appengine/docs/admin-api/access-control) Google IAM permission for the project and the following scope: `https://www.googleapis.com/auth/cloud-platform` The task will be delivered to the App Engine app which belongs to the same project as the queue. For more information, see [How Requests are Routed](https://cloud.google.com/appengine/docs/standard/python/how-requests-are-routed) and how routing is affected by [dispatch files](https://cloud.google.com/appengine/docs/python/config/dispatchref). Traffic is encrypted during transport and never leaves Google datacenters. Because this traffic is carried over a communication mechanism internal to Google, you cannot explicitly set the protocol (for example, HTTP or HTTPS). The request to the handler, however, will appear to have used the HTTP protocol. The AppEngineRouting used to construct the URL that the task is delivered to can be set at the queue-level or task-level: * If set, app_engine_routing_override is used for all tasks in the queue, no matter what the setting is for the task-level app_engine_routing. The `url` that the task will be sent to is: * `url =` host `+` relative_uri Tasks can be dispatched to secure app handlers, unsecure app handlers, and URIs restricted with [`login: admin`](https://cloud.google.com/appengine/docs/standard/python/config/appref). Because tasks are not run as any user, they cannot be dispatched to URIs restricted with [`login: required`](https://cloud.google.com/appengine/docs/standard/python/config/appref) Task dispatches also do not follow redirects. The task attempt has succeeded if the app's request handler returns an HTTP response code in the range [`200` - `299`]. The task attempt has failed if the app's handler returns a non-2xx response code or Cloud Tasks does not receive response before the deadline. Failed tasks will be retried according to the retry configuration. `503` (Service Unavailable) is considered an App Engine system error instead of an application error and will cause Cloud Tasks' traffic congestion control to temporarily throttle the queue's dispatches. Unlike other types of task targets, a `429` (Too Many Requests) response from an app handler does not cause traffic congestion control to throttle the queue.
    app_engine_http_request: Any = None
    # Output only. The time that the task was created. `create_time` will be truncated to the nearest second.
    create_time: Any = None
...
V2beta3CloudtasksV2beta3Task = ubx.ResourceBinding(
    wire_type="google_cloudtasks_v2beta3_cloudtasks_v2beta3_task",
    fields={
        ...
        "task": ubx.FieldSpec(
            wire_name="task",
            kind="object",
            fields=_V2beta3CloudtasksV2beta3Task_TaskFields,
        ),
    },
)
