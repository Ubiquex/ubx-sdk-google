...
class V2beta2Task_AppEngineHttpRequest_AppEngineRouting:
...
@dataclasses.dataclass
class V2beta2Task_AppEngineHttpRequest:
...
@dataclasses.dataclass
class V2beta2Task_HttpRequest_OauthToken:
...
@dataclasses.dataclass
class V2beta2Task_HttpRequest_OidcToken:
...
@dataclasses.dataclass
class V2beta2Task_Status_FirstAttemptStatus_ResponseStatus:
...
@dataclasses.dataclass
class V2beta2Task_Status_FirstAttemptStatus:
...
_V2beta2Task_AppEngineHttpRequest_AppEngineRoutingFields = {
...
_V2beta2Task_AppEngineHttpRequestFields = {
    "app_engine_routing": ubx.FieldSpec(
        wire_name="app_engine_routing",
        kind="object",
        fields=_V2beta2Task_AppEngineHttpRequest_AppEngineRoutingFields,
    ),
...
_V2beta2Task_HttpRequestFields = {
    ...
    "oauth_token": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V2beta2Task_HttpRequest_OauthTokenFields,
    ),
    "oidc_token": ubx.FieldSpec(
        wire_name="oidc_token",
        kind="object",
        fields=_V2beta2Task_HttpRequest_OidcTokenFields,
    ),
    "url": ubx.FieldSpec(wire_name="url"),
}

_V2beta2Task_PullMessageFields = {
    "payload": ubx.FieldSpec(wire_name="payload"),
    "tag": ubx.FieldSpec(wire_name="tag"),
}

_V2beta2Task_RetryConfigFields = {
...
_V2beta2Task_StatusFields = {
    ...
    "first_attempt_status": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V2beta2Task_Status_FirstAttemptStatusFields,
    ),
...
V2beta2Task = ubx.ResourceBinding(
    wire_type="google_cloudtasks_v2beta2_task",
    fields={
        ...
        "task": ubx.FieldSpec(
            wire_name="task",
            kind="object",
            fields=_V2beta2Task_TaskFields,
        ),
    },
)
