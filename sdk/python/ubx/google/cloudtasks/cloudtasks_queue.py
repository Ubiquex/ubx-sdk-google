...
class CloudtasksQueue_AppEngineRoutingOverride:
...
@dataclasses.dataclass
class CloudtasksQueue_HttpTarget_HeaderOverrides_Header:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class CloudtasksQueue_HttpTarget_HeaderOverrides:
    header: Any = None

@dataclasses.dataclass
class CloudtasksQueue_HttpTarget_OauthToken:
...
@dataclasses.dataclass
class CloudtasksQueue_HttpTarget_OidcToken:
...
@dataclasses.dataclass
class CloudtasksQueue_HttpTarget_UriOverride_PathOverride:
    # The URI path (e.g., /users/1234). Default is an empty string.
    path: Any = None

@dataclasses.dataclass
class CloudtasksQueue_HttpTarget_UriOverride_QueryOverride:
    # The query parameters (e.g., qparam1=123&qparam2=456). Default is an empty string.
    query_params: Any = None

@dataclasses.dataclass
class CloudtasksQueue_HttpTarget_UriOverride:
...
@dataclasses.dataclass
class CloudtasksQueue_HttpTarget:
...
@dataclasses.dataclass
class CloudtasksQueue_RateLimits:
...
@dataclasses.dataclass
class CloudtasksQueue_RetryConfig:
...
@dataclasses.dataclass
class CloudtasksQueue_StackdriverLoggingConfig:
...
_CloudtasksQueue_AppEngineRoutingOverrideFields = {
...
_CloudtasksQueue_HttpTarget_HeaderOverrides_HeaderFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_CloudtasksQueue_HttpTarget_HeaderOverridesFields = {
    "header": ubx.FieldSpec(
        wire_name="header",
        kind="object",
        fields=_CloudtasksQueue_HttpTarget_HeaderOverrides_HeaderFields,
    ),
}

_CloudtasksQueue_HttpTarget_OauthTokenFields = {
    "scope": ubx.FieldSpec(wire_name="scope"),
    "service_account_email": ubx.FieldSpec(wire_name="service_account_email"),
}

_CloudtasksQueue_HttpTarget_OidcTokenFields = {
    "audience": ubx.FieldSpec(wire_name="audience"),
    "service_account_email": ubx.FieldSpec(wire_name="service_account_email"),
}

_CloudtasksQueue_HttpTarget_UriOverride_PathOverrideFields = {
    "path": ubx.FieldSpec(wire_name="path"),
}

_CloudtasksQueue_HttpTarget_UriOverride_QueryOverrideFields = {
    "query_params": ubx.FieldSpec(wire_name="query_params"),
}

_CloudtasksQueue_HttpTarget_UriOverrideFields = {
    "host": ubx.FieldSpec(wire_name="host"),
    "path_override": ubx.FieldSpec(
        wire_name="path_override",
        kind="object",
        fields=_CloudtasksQueue_HttpTarget_UriOverride_PathOverrideFields,
    ),
    "port": ubx.FieldSpec(wire_name="port"),
    "query_override": ubx.FieldSpec(
        wire_name="query_override",
        kind="object",
        fields=_CloudtasksQueue_HttpTarget_UriOverride_QueryOverrideFields,
    ),
    "scheme": ubx.FieldSpec(wire_name="scheme"),
    "uri_override_enforce_mode": ubx.FieldSpec(wire_name="uri_override_enforce_mode"),
}

_CloudtasksQueue_HttpTargetFields = {
    "header_overrides": ubx.FieldSpec(
        wire_name="header_overrides",
        kind="list",
        fields=_CloudtasksQueue_HttpTarget_HeaderOverridesFields,
    ),
    "http_method": ubx.FieldSpec(wire_name="http_method"),
    "oauth_token": ubx.FieldSpec(
        wire_name="oauth_token",
        kind="object",
        fields=_CloudtasksQueue_HttpTarget_OauthTokenFields,
    ),
    "oidc_token": ubx.FieldSpec(
        wire_name="oidc_token",
        kind="object",
        fields=_CloudtasksQueue_HttpTarget_OidcTokenFields,
    ),
    "uri_override": ubx.FieldSpec(
        wire_name="uri_override",
        kind="object",
        fields=_CloudtasksQueue_HttpTarget_UriOverrideFields,
    ),
}

_CloudtasksQueue_RateLimitsFields = {
...
_CloudtasksQueue_RetryConfigFields = {
...
_CloudtasksQueue_StackdriverLoggingConfigFields = {
    "sampling_ratio": ubx.FieldSpec(wire_name="sampling_ratio"),
}

@dataclasses.dataclass
class CloudtasksQueueConfig:
...
CloudtasksQueue = ubx.ResourceBinding(
    wire_type="google_cloudtasks_cloudtasks_queue",
    fields={
        "app_engine_routing_override": ubx.FieldSpec(
            wire_name="app_engine_routing_override",
            kind="object",
            fields=_CloudtasksQueue_AppEngineRoutingOverrideFields,
        ),
        "http_target": ubx.FieldSpec(
            wire_name="http_target",
            kind="object",
            fields=_CloudtasksQueue_HttpTargetFields,
        ),
        ...
        "rate_limits": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CloudtasksQueue_RateLimitsFields,
        ),
        "retry_config": ubx.FieldSpec(
            wire_name="retry_config",
            kind="object",
            fields=_CloudtasksQueue_RetryConfigFields,
        ),
        "stackdriver_logging_config": ubx.FieldSpec(
            wire_name="stackdriver_logging_config",
            kind="object",
            fields=_CloudtasksQueue_StackdriverLoggingConfigFields,
        ),
