...
class SpannerInstanceConfig_InstanceConfig_OptionalReplicas:
    default_leader_location: Any = None
    location: Any = None
    type: Any = None

@dataclasses.dataclass
class SpannerInstanceConfig_InstanceConfig:
...
_SpannerInstanceConfig_InstanceConfig_OptionalReplicasFields = {
    "default_leader_location": ubx.FieldSpec(wire_name="default_leader_location"),
    "location": ubx.FieldSpec(wire_name="location"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_SpannerInstanceConfig_InstanceConfigFields = {
    ...
    "optional_replicas": ubx.FieldSpec(
        ...
        kind="list",
        fields=_SpannerInstanceConfig_InstanceConfig_OptionalReplicasFields,
    ),
...
@dataclasses.dataclass
class SpannerInstanceConfigConfig:
...
@dataclasses.dataclass
class SpannerInstanceConfigAttrs:
    # Base configuration name, e.g. projects//instanceConfigs/nam3, based on which this configuration is created. Only set for user-managed configurations. `base_config` must refer to a configuration of type `GOOGLE_MANAGED` in the same project as this configuration.
    base_config: Any = None
    # Output only. Whether this instance configuration is a Google-managed or user-managed configuration.
    config_type: Any = None
...
SpannerInstanceConfig = ubx.ResourceBinding(
    wire_type="google_spanner_spanner_instance_config",
    fields={
        "instance_config": ubx.FieldSpec(
            wire_name="instance_config",
            kind="object",
            fields=_SpannerInstanceConfig_InstanceConfigFields,
        ),
