...
class SpannerBackupSchedule_EncryptionConfig:
...
@dataclasses.dataclass
class SpannerBackupSchedule_Spec_CronSpec:
...
_SpannerBackupSchedule_Spec_CronSpecFields = {
...
_SpannerBackupSchedule_SpecFields = {
    "cron_spec": ubx.FieldSpec(
        wire_name="cron_spec",
        kind="object",
        fields=_SpannerBackupSchedule_Spec_CronSpecFields,
    ),
}

@dataclasses.dataclass
class SpannerBackupScheduleConfig:
...
@dataclasses.dataclass
class SpannerBackupScheduleAttrs:
    # Encryption configuration for the backup to create.
    encryption_config: Any = None
    # The specification for full backups. A full backup stores the entire contents of the database at a given version time.
    full_backup_spec: Any = None
...
SpannerBackupSchedule = ubx.ResourceBinding(
    wire_type="google_spanner_spanner_backup_schedule",
    fields={
        "encryption_config": ubx.FieldSpec(
            wire_name="encryption_config",
            kind="object",
            fields=_SpannerBackupSchedule_EncryptionConfigFields,
        ),
        ...
        "spec": ubx.FieldSpec(
            wire_name="spec",
            kind="object",
            fields=_SpannerBackupSchedule_SpecFields,
        ),
