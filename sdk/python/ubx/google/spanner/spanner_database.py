...
class SpannerDatabase_EncryptionConfig:
...
@dataclasses.dataclass
class SpannerDatabase_EncryptionInfo_EncryptionStatus:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class SpannerDatabase_EncryptionInfo:
    encryption_status: Any = None
    encryption_type: Any = None
    kms_key_version: Any = None

@dataclasses.dataclass
class SpannerDatabase_QuorumInfo_QuorumType_SingleRegion:
...
@dataclasses.dataclass
class SpannerDatabase_QuorumInfo_QuorumType:
...
@dataclasses.dataclass
class SpannerDatabase_QuorumInfo:
...
@dataclasses.dataclass
class SpannerDatabase_RestoreInfo_BackupInfo:
    # Name of the backup.
    backup: Any = None
...
SpannerDatabase = ubx.ResourceBinding(
    wire_type="google_spanner_spanner_database",
    fields={
        ...
        "encryption_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_SpannerDatabase_EncryptionConfigFields,
        ),
