...
class V1beta1Policy_PolicyQuery:
...
_V1beta1Policy_SettingFields = {
    "type": ubx.FieldSpec(wire_name="type"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class V1beta1PolicyConfig:
...
V1beta1Policy = ubx.ResourceBinding(
    wire_type="google_cloudidentity_v1beta1_policy",
    fields={
        "customer": ubx.FieldSpec(wire_name="customer"),
        "policy_query": ubx.FieldSpec(
            wire_name="policy_query",
            kind="object",
            fields=_V1beta1Policy_PolicyQueryFields,
        ),
        "setting": ubx.FieldSpec(
            wire_name="setting",
            kind="object",
            fields=_V1beta1Policy_SettingFields,
        ),
    },
)
