...
class CloudidentityGroup_AdditionalGroupKeys:
    id: Any = None
    namespace: Any = None

@dataclasses.dataclass
class CloudidentityGroup_DynamicGroupMetadata_Queries:
    query: Any = None
    resource_type: Any = None

@dataclasses.dataclass
class CloudidentityGroup_DynamicGroupMetadata_Status:
...
@dataclasses.dataclass
class CloudidentityGroup_DynamicGroupMetadata:
...
_CloudidentityGroup_AdditionalGroupKeysFields = {
    "id": ubx.FieldSpec(wire_name="id"),
    "namespace": ubx.FieldSpec(wire_name="namespace"),
}

_CloudidentityGroup_DynamicGroupMetadata_QueriesFields = {
    "query": ubx.FieldSpec(wire_name="query"),
    "resource_type": ubx.FieldSpec(wire_name="resource_type"),
}

_CloudidentityGroup_DynamicGroupMetadata_StatusFields = {
    "status": ubx.FieldSpec(wire_name="status"),
    "status_time": ubx.FieldSpec(wire_name="status_time"),
}

_CloudidentityGroup_DynamicGroupMetadataFields = {
    "queries": ubx.FieldSpec(
        wire_name="queries",
        kind="list",
        fields=_CloudidentityGroup_DynamicGroupMetadata_QueriesFields,
    ),
    "status": ubx.FieldSpec(
        wire_name="status",
        kind="object",
        fields=_CloudidentityGroup_DynamicGroupMetadata_StatusFields,
    ),
}

@dataclasses.dataclass
class CloudidentityGroupConfig:
...
CloudidentityGroup = ubx.ResourceBinding(
    wire_type="google_cloudidentity_cloudidentity_group",
    fields={
        "additional_group_keys": ubx.FieldSpec(
            wire_name="additional_group_keys",
            kind="list",
            fields=_CloudidentityGroup_AdditionalGroupKeysFields,
        ),
        ...
        "dynamic_group_metadata": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CloudidentityGroup_DynamicGroupMetadataFields,
        ),
