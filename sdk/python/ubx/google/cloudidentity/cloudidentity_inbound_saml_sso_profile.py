...
class CloudidentityInboundSamlSsoProfile_IdpConfig:
...
@dataclasses.dataclass
class CloudidentityInboundSamlSsoProfile_SpConfig:
...
_CloudidentityInboundSamlSsoProfile_IdpConfigFields = {
...
_CloudidentityInboundSamlSsoProfile_SpConfigFields = {
    "assertion_consumer_service_uri": ubx.FieldSpec(wire_name="assertion_consumer_service_uri"),
    "entity_id": ubx.FieldSpec(wire_name="entity_id"),
}

@dataclasses.dataclass
class CloudidentityInboundSamlSsoProfileConfig:
...
@dataclasses.dataclass
class CloudidentityInboundSamlSsoProfileAttrs:
    # Immutable. The customer. For example: `customers/C0123abc`.
    customer: Any = None
    # Human-readable name of the SAML SSO profile.
    display_name: Any = None
...
CloudidentityInboundSamlSsoProfile = ubx.ResourceBinding(
    wire_type="google_cloudidentity_cloudidentity_inbound_saml_sso_profile",
    fields={
        ...
        "idp_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CloudidentityInboundSamlSsoProfile_IdpConfigFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "sp_config": ubx.FieldSpec(
            wire_name="sp_config",
            kind="object",
            fields=_CloudidentityInboundSamlSsoProfile_SpConfigFields,
        ),
    },
)
