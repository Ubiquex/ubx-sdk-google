...
class V1beta1InboundOidcSsoProfile_IdpConfig:
...
@dataclasses.dataclass
class V1beta1InboundOidcSsoProfile_RpConfig:
...
@dataclasses.dataclass
class V1beta1InboundOidcSsoProfileConfig:
...
@dataclasses.dataclass
class V1beta1InboundOidcSsoProfileAttrs:
    # Immutable. The customer. For example: `customers/C0123abc`.
    customer: Any = None
    # Human-readable name of the OIDC SSO profile.
    display_name: Any = None
...
V1beta1InboundOidcSsoProfile = ubx.ResourceBinding(
    wire_type="google_cloudidentity_v1beta1_inbound_oidc_sso_profile",
    fields={
        ...
        "rp_config": ubx.FieldSpec(
            wire_name="rp_config",
            kind="object",
            fields=_V1beta1InboundOidcSsoProfile_RpConfigFields,
        ),
    },
)
