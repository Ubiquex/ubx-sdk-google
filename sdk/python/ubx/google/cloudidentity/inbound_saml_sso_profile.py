...
class InboundSamlSsoProfile_IdpConfig:
...
@dataclasses.dataclass
class InboundSamlSsoProfile_SpConfig:
...
_InboundSamlSsoProfile_IdpConfigFields = {
...
@dataclasses.dataclass
class InboundSamlSsoProfileAttrs:
    # Immutable. The customer. For example: `customers/C0123abc`.
    customer: Any = None
    # Human-readable name of the SAML SSO profile.
    display_name: Any = None
...
InboundSamlSsoProfile = ubx.ResourceBinding(
    wire_type="google_cloudidentity_inbound_saml_sso_profile",
    fields={
        ...
        "sp_config": ubx.FieldSpec(
            wire_name="sp_config",
            kind="object",
            fields=_InboundSamlSsoProfile_SpConfigFields,
        ),
    },
)
