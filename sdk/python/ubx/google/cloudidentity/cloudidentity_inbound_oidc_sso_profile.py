...
class CloudidentityInboundOidcSsoProfile_IdpConfig:
...
@dataclasses.dataclass
class CloudidentityInboundOidcSsoProfile_RpConfig:
...
@dataclasses.dataclass
class CloudidentityInboundOidcSsoProfileConfig:
...
@dataclasses.dataclass
class CloudidentityInboundOidcSsoProfileAttrs:
    # Immutable. The customer. For example: `customers/C0123abc`.
    customer: Any = None
    # Human-readable name of the OIDC SSO profile.
    display_name: Any = None
...
CloudidentityInboundOidcSsoProfile = ubx.ResourceBinding(
    wire_type="google_cloudidentity_cloudidentity_inbound_oidc_sso_profile",
    fields={
        ...
        "idp_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CloudidentityInboundOidcSsoProfile_IdpConfigFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "rp_config": ubx.FieldSpec(
            wire_name="rp_config",
            kind="object",
            fields=_CloudidentityInboundOidcSsoProfile_RpConfigFields,
        ),
    },
)
