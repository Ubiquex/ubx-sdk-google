...
class V1beta1CloudidentityV1beta1Policy_PolicyQuery:
...
@dataclasses.dataclass
class V1beta1CloudidentityV1beta1Policy_Setting:
    # Required. Immutable. The type of the Setting.
    type: Any = None
    # Required. The value of the Setting.
    value: Any = None

_V1beta1CloudidentityV1beta1Policy_PolicyQueryFields = {
...
_V1beta1CloudidentityV1beta1Policy_SettingFields = {
    "type": ubx.FieldSpec(wire_name="type"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class V1beta1CloudidentityV1beta1PolicyConfig:
...
@dataclasses.dataclass
class V1beta1CloudidentityV1beta1PolicyAttrs:
    # Immutable. Customer that the Policy belongs to. The value is in the format 'customers/{customerId}'. The `customerId` must begin with "C" To find your customer ID in Admin Console see https://support.google.com/a/answer/10070793.
    customer: Any = None
    # Output only. Identifier. The [resource name](https://cloud.google.com/apis/design/resource_names) of the Policy. Format: policies/{policy}.
    name: Any = None
...
V1beta1CloudidentityV1beta1Policy = ubx.ResourceBinding(
    wire_type="google_cloudidentity_v1beta1_cloudidentity_v1beta1_policy",
    fields={
        ...
        "policy_query": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1CloudidentityV1beta1Policy_PolicyQueryFields,
        ),
        "setting": ubx.FieldSpec(
            wire_name="setting",
            kind="object",
            fields=_V1beta1CloudidentityV1beta1Policy_SettingFields,
        ),
        "type": ubx.FieldSpec(wire_name="type"),
    },
)
