# Code generated by `ubx sdk gen` from google_cloudidentity_group. DO NOT EDIT.
...
@dataclasses.dataclass
class Group_DynamicGroupMetadata_Status:
...
@dataclasses.dataclass
class Group_DynamicGroupMetadata:
...
_Group_AdditionalGroupKeysFields = {
    "id": ubx.FieldSpec(wire_name="id"),
    "namespace": ubx.FieldSpec(wire_name="namespace"),
}

_Group_DynamicGroupMetadata_QueriesFields = {
    "query": ubx.FieldSpec(wire_name="query"),
    "resource_type": ubx.FieldSpec(wire_name="resource_type"),
}

_Group_DynamicGroupMetadata_StatusFields = {
    "status": ubx.FieldSpec(wire_name="status"),
    "status_time": ubx.FieldSpec(wire_name="status_time"),
}

_Group_DynamicGroupMetadataFields = {
    "queries": ubx.FieldSpec(
        wire_name="queries",
        kind="list",
        fields=_Group_DynamicGroupMetadata_QueriesFields,
    ),
    "status": ubx.FieldSpec(
        wire_name="status",
        kind="object",
        fields=_Group_DynamicGroupMetadata_StatusFields,
    ),
}
...
Group = ubx.ResourceBinding(
    wire_type="google_cloudidentity_group",
    fields={
        "additional_group_keys": ubx.FieldSpec(
            wire_name="additional_group_keys",
            kind="list",
            fields=_Group_AdditionalGroupKeysFields,
        ),
        ...
        "dynamic_group_metadata": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Group_DynamicGroupMetadataFields,
        ),
