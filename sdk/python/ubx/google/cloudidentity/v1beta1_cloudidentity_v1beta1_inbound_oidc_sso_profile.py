...
class V1beta1CloudidentityV1beta1InboundOidcSsoProfile_IdpConfig:
...
@dataclasses.dataclass
class V1beta1CloudidentityV1beta1InboundOidcSsoProfile_RpConfig:
...
_V1beta1CloudidentityV1beta1InboundOidcSsoProfile_IdpConfigFields = {
    "change_password_uri": ubx.FieldSpec(wire_name="change_password_uri"),
    "issuer_uri": ubx.FieldSpec(wire_name="issuer_uri"),
}

_V1beta1CloudidentityV1beta1InboundOidcSsoProfile_RpConfigFields = {
...
@dataclasses.dataclass
class V1beta1CloudidentityV1beta1InboundOidcSsoProfileConfig:
...
@dataclasses.dataclass
class V1beta1CloudidentityV1beta1InboundOidcSsoProfileAttrs:
    # Immutable. The customer. For example: `customers/C0123abc`.
    customer: Any = None
    # Human-readable name of the OIDC SSO profile.
    display_name: Any = None
...
V1beta1CloudidentityV1beta1InboundOidcSsoProfile = ubx.ResourceBinding(
    wire_type="google_cloudidentity_v1beta1_cloudidentity_v1beta1_inbound_oidc_sso_profile",
    fields={
        ...
        "idp_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1CloudidentityV1beta1InboundOidcSsoProfile_IdpConfigFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "rp_config": ubx.FieldSpec(
            wire_name="rp_config",
            kind="object",
            fields=_V1beta1CloudidentityV1beta1InboundOidcSsoProfile_RpConfigFields,
        ),
    },
)
