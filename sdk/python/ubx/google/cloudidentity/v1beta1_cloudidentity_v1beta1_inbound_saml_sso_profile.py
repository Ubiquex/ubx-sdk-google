...
class V1beta1CloudidentityV1beta1InboundSamlSsoProfile_IdpConfig:
...
@dataclasses.dataclass
class V1beta1CloudidentityV1beta1InboundSamlSsoProfile_SpConfig:
...
_V1beta1CloudidentityV1beta1InboundSamlSsoProfile_IdpConfigFields = {
...
_V1beta1CloudidentityV1beta1InboundSamlSsoProfile_SpConfigFields = {
    "assertion_consumer_service_uri": ubx.FieldSpec(wire_name="assertion_consumer_service_uri"),
    "entity_id": ubx.FieldSpec(wire_name="entity_id"),
}

@dataclasses.dataclass
class V1beta1CloudidentityV1beta1InboundSamlSsoProfileConfig:
...
@dataclasses.dataclass
class V1beta1CloudidentityV1beta1InboundSamlSsoProfileAttrs:
    # Immutable. The customer. For example: `customers/C0123abc`.
    customer: Any = None
    # Human-readable name of the SAML SSO profile.
    display_name: Any = None
...
V1beta1CloudidentityV1beta1InboundSamlSsoProfile = ubx.ResourceBinding(
    wire_type="google_cloudidentity_v1beta1_cloudidentity_v1beta1_inbound_saml_sso_profile",
    fields={
        ...
        "idp_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1CloudidentityV1beta1InboundSamlSsoProfile_IdpConfigFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "sp_config": ubx.FieldSpec(
            wire_name="sp_config",
            kind="object",
            fields=_V1beta1CloudidentityV1beta1InboundSamlSsoProfile_SpConfigFields,
        ),
    },
)
