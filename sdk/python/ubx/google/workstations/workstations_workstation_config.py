...
class WorkstationsWorkstationConfig_AllowedPorts:
    first: Any = None
    last: Any = None

@dataclasses.dataclass
class WorkstationsWorkstationConfig_Conditions:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class WorkstationsWorkstationConfig_Container:
...
@dataclasses.dataclass
class WorkstationsWorkstationConfig_EncryptionKey:
...
@dataclasses.dataclass
class WorkstationsWorkstationConfig_EphemeralDirectories_GcePd:
    disk_type: Any = None
    read_only: Any = None
...
@dataclasses.dataclass
class WorkstationsWorkstationConfig_EphemeralDirectories:
    gce_pd: Any = None
    mount_path: Any = None

@dataclasses.dataclass
class WorkstationsWorkstationConfig_Host_GceInstance_Accelerators:
    count: Any = None
    type: Any = None

@dataclasses.dataclass
class WorkstationsWorkstationConfig_Host_GceInstance_BoostConfigs:
...
@dataclasses.dataclass
class WorkstationsWorkstationConfig_Host_GceInstance_ConfidentialInstanceConfig:
    # Optional. Whether the instance has confidential compute enabled.
    enable_confidential_compute: Any = None

@dataclasses.dataclass
class WorkstationsWorkstationConfig_Host_GceInstance_ShieldedInstanceConfig:
...
@dataclasses.dataclass
class WorkstationsWorkstationConfig_Host_GceInstance:
...
@dataclasses.dataclass
class WorkstationsWorkstationConfig_Host:
    # A runtime using a Compute Engine instance.
    gce_instance: Any = None

@dataclasses.dataclass
class WorkstationsWorkstationConfig_PersistentDirectories_GceHd:
...
@dataclasses.dataclass
class WorkstationsWorkstationConfig_PersistentDirectories_GcePd:
    archive_timeout: Any = None
    disk_type: Any = None
    fs_type: Any = None
    max_size_gb: Any = None
...
@dataclasses.dataclass
class WorkstationsWorkstationConfig_PersistentDirectories:
    gce_hd: Any = None
    gce_pd: Any = None
    mount_path: Any = None

@dataclasses.dataclass
class WorkstationsWorkstationConfig_ReadinessChecks:
    path: Any = None
    port: Any = None

_WorkstationsWorkstationConfig_AllowedPortsFields = {
    "first": ubx.FieldSpec(wire_name="first"),
    "last": ubx.FieldSpec(wire_name="last"),
}

_WorkstationsWorkstationConfig_ConditionsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_WorkstationsWorkstationConfig_ContainerFields = {
...
_WorkstationsWorkstationConfig_EncryptionKeyFields = {
    "kms_key": ubx.FieldSpec(wire_name="kms_key"),
    "kms_key_service_account": ubx.FieldSpec(wire_name="kms_key_service_account"),
}

_WorkstationsWorkstationConfig_EphemeralDirectories_GcePdFields = {
...
_WorkstationsWorkstationConfig_EphemeralDirectoriesFields = {
    "gce_pd": ubx.FieldSpec(
        wire_name="gce_pd",
        kind="object",
        fields=_WorkstationsWorkstationConfig_EphemeralDirectories_GcePdFields,
    ),
    "mount_path": ubx.FieldSpec(wire_name="mount_path"),
}

_WorkstationsWorkstationConfig_Host_GceInstance_AcceleratorsFields = {
    "count": ubx.FieldSpec(wire_name="count"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_WorkstationsWorkstationConfig_Host_GceInstance_BoostConfigsFields = {
    "accelerators": ubx.FieldSpec(
        wire_name="accelerators",
        kind="list",
        fields=_WorkstationsWorkstationConfig_Host_GceInstance_AcceleratorsFields,
    ),
...
_WorkstationsWorkstationConfig_Host_GceInstance_ConfidentialInstanceConfigFields = {
    "enable_confidential_compute": ubx.FieldSpec(wire_name="enable_confidential_compute"),
}

_WorkstationsWorkstationConfig_Host_GceInstance_ShieldedInstanceConfigFields = {
...
_WorkstationsWorkstationConfig_Host_GceInstanceFields = {
    "accelerators": ubx.FieldSpec(
        wire_name="accelerators",
        kind="list",
        fields=_WorkstationsWorkstationConfig_Host_GceInstance_AcceleratorsFields,
    ...
    "boost_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_WorkstationsWorkstationConfig_Host_GceInstance_BoostConfigsFields,
    ),
    "boot_disk_size_gb": ubx.FieldSpec(wire_name="boot_disk_size_gb"),
    "confidential_instance_config": ubx.FieldSpec(
        wire_name="confidential_instance_config",
        kind="object",
        fields=_WorkstationsWorkstationConfig_Host_GceInstance_ConfidentialInstanceConfigFields,
    ),
    ...
    "shielded_instance_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_WorkstationsWorkstationConfig_Host_GceInstance_ShieldedInstanceConfigFields,
    ),
...
_WorkstationsWorkstationConfig_HostFields = {
    "gce_instance": ubx.FieldSpec(
        wire_name="gce_instance",
        kind="object",
        fields=_WorkstationsWorkstationConfig_Host_GceInstanceFields,
    ),
}

_WorkstationsWorkstationConfig_PersistentDirectories_GceHdFields = {
...
_WorkstationsWorkstationConfig_PersistentDirectories_GcePdFields = {
    "archive_timeout": ubx.FieldSpec(wire_name="archive_timeout"),
    "disk_type": ubx.FieldSpec(wire_name="disk_type"),
...
_WorkstationsWorkstationConfig_PersistentDirectoriesFields = {
    "gce_hd": ubx.FieldSpec(
        wire_name="gce_hd",
        kind="object",
        fields=_WorkstationsWorkstationConfig_PersistentDirectories_GceHdFields,
    ),
    "gce_pd": ubx.FieldSpec(
        wire_name="gce_pd",
        kind="object",
        fields=_WorkstationsWorkstationConfig_PersistentDirectories_GcePdFields,
    ),
    "mount_path": ubx.FieldSpec(wire_name="mount_path"),
}

_WorkstationsWorkstationConfig_ReadinessChecksFields = {
    "path": ubx.FieldSpec(wire_name="path"),
    "port": ubx.FieldSpec(wire_name="port"),
}

@dataclasses.dataclass
class WorkstationsWorkstationConfigConfig:
...
@dataclasses.dataclass
class WorkstationsWorkstationConfigAttrs:
    # Optional. A list of PortRanges specifying single ports or ranges of ports that are externally accessible in the workstation. Allowed ports must be one of 22, 80, or within range 1024-65535. If not specified defaults to ports 22, 80, and ports 1024-65535.
    allowed_ports: Any = None
    # Optional. Client-specified annotations.
    annotations: Any = None
...
WorkstationsWorkstationConfig = ubx.ResourceBinding(
    wire_type="google_workstations_workstations_workstation_config",
    fields={
        "allowed_ports": ubx.FieldSpec(
            wire_name="allowed_ports",
            kind="list",
            fields=_WorkstationsWorkstationConfig_AllowedPortsFields,
        ),
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "conditions": ubx.FieldSpec(
            wire_name="conditions",
            kind="list",
            fields=_WorkstationsWorkstationConfig_ConditionsFields,
        ),
        "container": ubx.FieldSpec(
            wire_name="container",
            kind="object",
            fields=_WorkstationsWorkstationConfig_ContainerFields,
        ),
        ...
        "encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_WorkstationsWorkstationConfig_EncryptionKeyFields,
        ),
        "ephemeral_directories": ubx.FieldSpec(
            wire_name="ephemeral_directories",
            kind="list",
            fields=_WorkstationsWorkstationConfig_EphemeralDirectoriesFields,
        ),
        ...
        "host": ubx.FieldSpec(
            wire_name="host",
            kind="object",
            fields=_WorkstationsWorkstationConfig_HostFields,
        ),
        ...
        "persistent_directories": ubx.FieldSpec(
            ...
            kind="list",
            fields=_WorkstationsWorkstationConfig_PersistentDirectoriesFields,
        ),
        "readiness_checks": ubx.FieldSpec(
            wire_name="readiness_checks",
            kind="list",
            fields=_WorkstationsWorkstationConfig_ReadinessChecksFields,
        ),
