...
class V1betaWorkstation_BoostConfigs:
    id: Any = None
    running: Any = None

@dataclasses.dataclass
class V1betaWorkstation_Conditions:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class V1betaWorkstation_PersistentDirectories:
    mount_path: Any = None
    size_gb: Any = None

@dataclasses.dataclass
class V1betaWorkstation_RuntimeHost_GceInstanceHost:
...
V1betaWorkstation = ubx.ResourceBinding(
    wire_type="google_workstations_v1beta_workstation",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "boost_configs": ubx.FieldSpec(
            wire_name="boost_configs",
            kind="list",
            fields=_V1betaWorkstation_BoostConfigsFields,
        ),
        "conditions": ubx.FieldSpec(
            wire_name="conditions",
            kind="list",
            fields=_V1betaWorkstation_ConditionsFields,
        ),
        ...
        "persistent_directories": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1betaWorkstation_PersistentDirectoriesFields,
        ),
        "reconciling": ubx.FieldSpec(wire_name="reconciling"),
        "runtime_host": ubx.FieldSpec(
            wire_name="runtime_host",
            kind="object",
            fields=_V1betaWorkstation_RuntimeHostFields,
        ),
