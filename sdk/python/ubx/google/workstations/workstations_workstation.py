...
class WorkstationsWorkstation_PersistentDirectories:
    mount_path: Any = None
    size_gb: Any = None

@dataclasses.dataclass
class WorkstationsWorkstation_RuntimeHost_GceInstanceHost:
...
@dataclasses.dataclass
class WorkstationsWorkstation_RuntimeHost:
    # The Compute Engine instance host.
    gce_instance_host: Any = None

_WorkstationsWorkstation_PersistentDirectoriesFields = {
    "mount_path": ubx.FieldSpec(wire_name="mount_path"),
    "size_gb": ubx.FieldSpec(wire_name="size_gb"),
}

_WorkstationsWorkstation_RuntimeHost_GceInstanceHostFields = {
    "id": ubx.FieldSpec(wire_name="id"),
    "name": ubx.FieldSpec(wire_name="name"),
    "zone": ubx.FieldSpec(wire_name="zone"),
}

_WorkstationsWorkstation_RuntimeHostFields = {
    "gce_instance_host": ubx.FieldSpec(
        wire_name="gce_instance_host",
        kind="object",
        fields=_WorkstationsWorkstation_RuntimeHost_GceInstanceHostFields,
    ),
}

@dataclasses.dataclass
class WorkstationsWorkstationConfig_:
...
@dataclasses.dataclass
class WorkstationsWorkstationAttrs:
    # Optional. Client-specified annotations.
    annotations: Any = None
    # Output only. Time when this workstation was created.
    create_time: Any = None
...
WorkstationsWorkstation = ubx.ResourceBinding(
    wire_type="google_workstations_workstations_workstation",
    fields={
        ...
        "persistent_directories": ubx.FieldSpec(
            ...
            kind="list",
            fields=_WorkstationsWorkstation_PersistentDirectoriesFields,
        ),
        "reconciling": ubx.FieldSpec(wire_name="reconciling"),
        "runtime_host": ubx.FieldSpec(
            wire_name="runtime_host",
            kind="object",
            fields=_WorkstationsWorkstation_RuntimeHostFields,
        ),
