...
class WorkstationsWorkstationCluster_Conditions:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class WorkstationsWorkstationCluster_DomainConfig:
    # Immutable. Domain used by Workstations for HTTP ingress.
    domain: Any = None

@dataclasses.dataclass
class WorkstationsWorkstationCluster_GatewayConfig:
    # Optional. Whether HTTP/2 is enabled for this workstation cluster. Defaults to false.
    http2_enabled: Any = None

@dataclasses.dataclass
class WorkstationsWorkstationCluster_PrivateClusterConfig:
...
_WorkstationsWorkstationCluster_ConditionsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_WorkstationsWorkstationCluster_DomainConfigFields = {
    "domain": ubx.FieldSpec(wire_name="domain"),
}

_WorkstationsWorkstationCluster_GatewayConfigFields = {
    "http2_enabled": ubx.FieldSpec(wire_name="http2_enabled"),
}

_WorkstationsWorkstationCluster_PrivateClusterConfigFields = {
...
@dataclasses.dataclass
class WorkstationsWorkstationClusterConfig:
...
@dataclasses.dataclass
class WorkstationsWorkstationClusterAttrs:
    # Optional. Client-specified annotations.
    annotations: Any = None
    # Output only. Status conditions describing the workstation cluster's current state.
    conditions: Any = None
...
WorkstationsWorkstationCluster = ubx.ResourceBinding(
    wire_type="google_workstations_workstations_workstation_cluster",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "conditions": ubx.FieldSpec(
            wire_name="conditions",
            kind="list",
            fields=_WorkstationsWorkstationCluster_ConditionsFields,
        ),
        ...
        "domain_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_WorkstationsWorkstationCluster_DomainConfigFields,
        ),
        "etag": ubx.FieldSpec(wire_name="etag"),
        "gateway_config": ubx.FieldSpec(
            wire_name="gateway_config",
            kind="object",
            fields=_WorkstationsWorkstationCluster_GatewayConfigFields,
        ),
        ...
        "private_cluster_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_WorkstationsWorkstationCluster_PrivateClusterConfigFields,
        ),
