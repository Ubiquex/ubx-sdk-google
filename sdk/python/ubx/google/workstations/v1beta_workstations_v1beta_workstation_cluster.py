...
class V1betaWorkstationsV1betaWorkstationCluster_Conditions:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class V1betaWorkstationsV1betaWorkstationCluster_DomainConfig:
    # Immutable. Domain used by Workstations for HTTP ingress.
    domain: Any = None

@dataclasses.dataclass
class V1betaWorkstationsV1betaWorkstationCluster_GatewayConfig:
    # Optional. Whether HTTP/2 is enabled for this workstation cluster. Defaults to false.
    http2_enabled: Any = None

@dataclasses.dataclass
class V1betaWorkstationsV1betaWorkstationCluster_PrivateClusterConfig:
...
_V1betaWorkstationsV1betaWorkstationCluster_ConditionsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V1betaWorkstationsV1betaWorkstationCluster_DomainConfigFields = {
    "domain": ubx.FieldSpec(wire_name="domain"),
}

_V1betaWorkstationsV1betaWorkstationCluster_GatewayConfigFields = {
    "http2_enabled": ubx.FieldSpec(wire_name="http2_enabled"),
}

_V1betaWorkstationsV1betaWorkstationCluster_PrivateClusterConfigFields = {
...
@dataclasses.dataclass
class V1betaWorkstationsV1betaWorkstationClusterConfig:
...
@dataclasses.dataclass
class V1betaWorkstationsV1betaWorkstationClusterAttrs:
    # Optional. Client-specified annotations.
    annotations: Any = None
    # Output only. Status conditions describing the workstation cluster's current state.
    conditions: Any = None
...
V1betaWorkstationsV1betaWorkstationCluster = ubx.ResourceBinding(
    wire_type="google_workstations_v1beta_workstations_v1beta_workstation_cluster",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "conditions": ubx.FieldSpec(
            wire_name="conditions",
            kind="list",
            fields=_V1betaWorkstationsV1betaWorkstationCluster_ConditionsFields,
        ),
        ...
        "domain_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaWorkstationsV1betaWorkstationCluster_DomainConfigFields,
        ),
        "etag": ubx.FieldSpec(wire_name="etag"),
        "gateway_config": ubx.FieldSpec(
            wire_name="gateway_config",
            kind="object",
            fields=_V1betaWorkstationsV1betaWorkstationCluster_GatewayConfigFields,
        ),
        ...
        "private_cluster_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaWorkstationsV1betaWorkstationCluster_PrivateClusterConfigFields,
        ),
