...
class V1betaWorkstationConfig_AllowedPorts:
    first: Any = None
    last: Any = None

@dataclasses.dataclass
class V1betaWorkstationConfig_Conditions:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class V1betaWorkstationConfig_Container:
...
@dataclasses.dataclass
class V1betaWorkstationConfig_EncryptionKey:
...
@dataclasses.dataclass
class V1betaWorkstationConfig_EphemeralDirectories_GcePd:
    disk_type: Any = None
    read_only: Any = None
...
@dataclasses.dataclass
class V1betaWorkstationConfig_EphemeralDirectories:
    gce_pd: Any = None
    mount_path: Any = None

@dataclasses.dataclass
class V1betaWorkstationConfig_Host_GceInstance_Accelerators:
    count: Any = None
    type: Any = None

@dataclasses.dataclass
class V1betaWorkstationConfig_Host_GceInstance_BoostConfigs_ReservationAffinity:
    consume_reservation_type: Any = None
    key: Any = None
    values: Any = None

@dataclasses.dataclass
class V1betaWorkstationConfig_Host_GceInstance_BoostConfigs:
...
@dataclasses.dataclass
class V1betaWorkstationConfig_Host_GceInstance_ConfidentialInstanceConfig:
    # Optional. Whether the instance has confidential compute enabled.
    enable_confidential_compute: Any = None

@dataclasses.dataclass
class V1betaWorkstationConfig_Host_GceInstance_ShieldedInstanceConfig:
...
@dataclasses.dataclass
class V1betaWorkstationConfig_Host_GceInstance:
...
@dataclasses.dataclass
class V1betaWorkstationConfig_Host:
    # A runtime using a Compute Engine instance.
    gce_instance: Any = None

@dataclasses.dataclass
class V1betaWorkstationConfig_HttpOptions:
...
@dataclasses.dataclass
class V1betaWorkstationConfig_PersistentDirectories_GcePd:
    archive_timeout: Any = None
    disk_type: Any = None
    fs_type: Any = None
    max_size_gb: Any = None
...
@dataclasses.dataclass
class V1betaWorkstationConfig_PersistentDirectories:
    gce_hd: Any = None
    gce_pd: Any = None
    mount_path: Any = None

@dataclasses.dataclass
class V1betaWorkstationConfig_ReadinessChecks:
    path: Any = None
    port: Any = None

_V1betaWorkstationConfig_AllowedPortsFields = {
...
_V1betaWorkstationConfig_EphemeralDirectoriesFields = {
    "gce_pd": ubx.FieldSpec(
        wire_name="gce_pd",
        kind="object",
        fields=_V1betaWorkstationConfig_EphemeralDirectories_GcePdFields,
    ),
    "mount_path": ubx.FieldSpec(wire_name="mount_path"),
}

_V1betaWorkstationConfig_Host_GceInstance_AcceleratorsFields = {
    "count": ubx.FieldSpec(wire_name="count"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_V1betaWorkstationConfig_Host_GceInstance_BoostConfigs_ReservationAffinityFields = {
    "consume_reservation_type": ubx.FieldSpec(wire_name="consume_reservation_type"),
    "key": ubx.FieldSpec(wire_name="key"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_V1betaWorkstationConfig_Host_GceInstance_BoostConfigsFields = {
    "accelerators": ubx.FieldSpec(
        wire_name="accelerators",
        kind="list",
        fields=_V1betaWorkstationConfig_Host_GceInstance_AcceleratorsFields,
    ),
    ...
    "reservation_affinity": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaWorkstationConfig_Host_GceInstance_BoostConfigs_ReservationAffinityFields,
    ),
}

_V1betaWorkstationConfig_Host_GceInstance_ConfidentialInstanceConfigFields = {
    "enable_confidential_compute": ubx.FieldSpec(wire_name="enable_confidential_compute"),
}

_V1betaWorkstationConfig_Host_GceInstance_ShieldedInstanceConfigFields = {
...
_V1betaWorkstationConfig_Host_GceInstanceFields = {
    "accelerators": ubx.FieldSpec(
        wire_name="accelerators",
        kind="list",
        fields=_V1betaWorkstationConfig_Host_GceInstance_AcceleratorsFields,
    ...
    "boost_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1betaWorkstationConfig_Host_GceInstance_BoostConfigsFields,
    ),
    "boot_disk_size_gb": ubx.FieldSpec(wire_name="boot_disk_size_gb"),
    "confidential_instance_config": ubx.FieldSpec(
        wire_name="confidential_instance_config",
        kind="object",
        fields=_V1betaWorkstationConfig_Host_GceInstance_ConfidentialInstanceConfigFields,
    ),
    ...
    "shielded_instance_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaWorkstationConfig_Host_GceInstance_ShieldedInstanceConfigFields,
    ),
...
_V1betaWorkstationConfig_HostFields = {
    "gce_instance": ubx.FieldSpec(
        wire_name="gce_instance",
        kind="object",
        fields=_V1betaWorkstationConfig_Host_GceInstanceFields,
    ),
}

_V1betaWorkstationConfig_HttpOptionsFields = {
...
_V1betaWorkstationConfig_PersistentDirectories_GcePdFields = {
    "archive_timeout": ubx.FieldSpec(wire_name="archive_timeout"),
    "disk_type": ubx.FieldSpec(wire_name="disk_type"),
...
_V1betaWorkstationConfig_PersistentDirectoriesFields = {
    "gce_hd": ubx.FieldSpec(
        wire_name="gce_hd",
        kind="object",
        fields=_V1betaWorkstationConfig_PersistentDirectories_GceHdFields,
    ),
    "gce_pd": ubx.FieldSpec(
        wire_name="gce_pd",
        kind="object",
        fields=_V1betaWorkstationConfig_PersistentDirectories_GcePdFields,
    ),
    "mount_path": ubx.FieldSpec(wire_name="mount_path"),
}

_V1betaWorkstationConfig_ReadinessChecksFields = {
    "path": ubx.FieldSpec(wire_name="path"),
    "port": ubx.FieldSpec(wire_name="port"),
}

@dataclasses.dataclass
class V1betaWorkstationConfigConfig:
...
V1betaWorkstationConfig = ubx.ResourceBinding(
    wire_type="google_workstations_v1beta_workstation_config",
    fields={
        ...
        "encryption_key": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaWorkstationConfig_EncryptionKeyFields,
        ),
        "ephemeral_directories": ubx.FieldSpec(
            wire_name="ephemeral_directories",
            kind="list",
            fields=_V1betaWorkstationConfig_EphemeralDirectoriesFields,
        ),
        ...
        "host": ubx.FieldSpec(
            wire_name="host",
            kind="object",
            fields=_V1betaWorkstationConfig_HostFields,
        ),
        "http_options": ubx.FieldSpec(
            wire_name="http_options",
            kind="object",
            fields=_V1betaWorkstationConfig_HttpOptionsFields,
        ),
        ...
        "persistent_directories": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1betaWorkstationConfig_PersistentDirectoriesFields,
        ),
