...
class ManagedidentitiesDomain_Trusts:
...
_ManagedidentitiesDomain_TrustsFields = {
...
@dataclasses.dataclass
class ManagedidentitiesDomainConfig:
...
@dataclasses.dataclass
class ManagedidentitiesDomainAttrs:
    # Optional. The name of delegated administrator account used to perform Active Directory operations. If not specified, `setupadmin` will be used.
    admin: Any = None
    # Optional. Configuration for audit logs. True if audit logs are enabled, else false. Default is audit logs disabled.
    audit_logs_enabled: Any = None
...
ManagedidentitiesDomain = ubx.ResourceBinding(
    wire_type="google_managedidentities_managedidentities_domain",
    fields={
        ...
        "trusts": ubx.FieldSpec(
            wire_name="trusts",
            kind="list",
            fields=_ManagedidentitiesDomain_TrustsFields,
        ),
        "update_time": ubx.FieldSpec(wire_name="update_time"),
    },
)
