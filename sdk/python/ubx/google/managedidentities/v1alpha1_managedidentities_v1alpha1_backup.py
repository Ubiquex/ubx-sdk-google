...
class V1alpha1ManagedidentitiesV1alpha1BackupConfig:
...
@dataclasses.dataclass
class V1alpha1ManagedidentitiesV1alpha1BackupAttrs:
    # Output only. The time the backups was created.
    create_time: Any = None
    # Optional. A short description of the backup.
    description: Any = None
...
V1alpha1ManagedidentitiesV1alpha1Backup = ubx.ResourceBinding(
    wire_type="google_managedidentities_v1alpha1_managedidentities_v1alpha1_backup",
    fields={
