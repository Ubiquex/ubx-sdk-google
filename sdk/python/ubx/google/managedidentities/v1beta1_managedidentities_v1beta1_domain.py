...
class V1beta1ManagedidentitiesV1beta1Domain_Trusts:
...
_V1beta1ManagedidentitiesV1beta1Domain_TrustsFields = {
...
@dataclasses.dataclass
class V1beta1ManagedidentitiesV1beta1DomainConfig:
...
@dataclasses.dataclass
class V1beta1ManagedidentitiesV1beta1DomainAttrs:
    # Optional. The name of delegated administrator account used to perform Active Directory operations. If not specified, `setupadmin` will be used.
    admin: Any = None
    # Optional. Configuration for audit logs. True if audit logs are enabled, else false. Default is audit logs disabled.
    audit_logs_enabled: Any = None
...
V1beta1ManagedidentitiesV1beta1Domain = ubx.ResourceBinding(
    wire_type="google_managedidentities_v1beta1_managedidentities_v1beta1_domain",
    fields={
        ...
        "trusts": ubx.FieldSpec(
            wire_name="trusts",
            kind="list",
            fields=_V1beta1ManagedidentitiesV1beta1Domain_TrustsFields,
        ),
        "update_time": ubx.FieldSpec(wire_name="update_time"),
    },
)
