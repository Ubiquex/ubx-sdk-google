...
class ClouddeployCustomTargetType_CustomActions_IncludeSkaffoldModules_Git:
    path: Any = None
    ref: Any = None
    repo: Any = None

@dataclasses.dataclass
class ClouddeployCustomTargetType_CustomActions_IncludeSkaffoldModules_GoogleCloudBuildRepo:
    path: Any = None
    ref: Any = None
    repository: Any = None

@dataclasses.dataclass
class ClouddeployCustomTargetType_CustomActions_IncludeSkaffoldModules_GoogleCloudStorage:
    path: Any = None
    source: Any = None

@dataclasses.dataclass
class ClouddeployCustomTargetType_CustomActions_IncludeSkaffoldModules:
    configs: Any = None
    git: Any = None
...
@dataclasses.dataclass
class ClouddeployCustomTargetType_CustomActions:
...
@dataclasses.dataclass
class ClouddeployCustomTargetType_Tasks_Deploy_Container:
...
@dataclasses.dataclass
class ClouddeployCustomTargetType_Tasks_Deploy:
    # This task is represented by a container that is executed in the Cloud Build execution environment.
    container: Any = None

@dataclasses.dataclass
class ClouddeployCustomTargetType_Tasks:
    # A Task represents a unit of work that is executed as part of a Job.
    deploy: Any = None
    # A Task represents a unit of work that is executed as part of a Job.
    render: Any = None

_ClouddeployCustomTargetType_CustomActions_IncludeSkaffoldModules_GitFields = {
    "path": ubx.FieldSpec(wire_name="path"),
    "ref": ubx.FieldSpec(wire_name="ref"),
    "repo": ubx.FieldSpec(wire_name="repo"),
}

_ClouddeployCustomTargetType_CustomActions_IncludeSkaffoldModules_GoogleCloudBuildRepoFields = {
    "path": ubx.FieldSpec(wire_name="path"),
    "ref": ubx.FieldSpec(wire_name="ref"),
    "repository": ubx.FieldSpec(wire_name="repository"),
}

_ClouddeployCustomTargetType_CustomActions_IncludeSkaffoldModules_GoogleCloudStorageFields = {
    "path": ubx.FieldSpec(wire_name="path"),
    "source": ubx.FieldSpec(wire_name="source"),
}

_ClouddeployCustomTargetType_CustomActions_IncludeSkaffoldModulesFields = {
    "configs": ubx.FieldSpec(wire_name="configs"),
    "git": ubx.FieldSpec(
        wire_name="git",
        kind="object",
        fields=_ClouddeployCustomTargetType_CustomActions_IncludeSkaffoldModules_GitFields,
    ),
    "google_cloud_build_repo": ubx.FieldSpec(
        wire_name="google_cloud_build_repo",
        kind="object",
        fields=_ClouddeployCustomTargetType_CustomActions_IncludeSkaffoldModules_GoogleCloudBuildRepoFields,
    ),
    "google_cloud_storage": ubx.FieldSpec(
        wire_name="google_cloud_storage",
        kind="object",
        fields=_ClouddeployCustomTargetType_CustomActions_IncludeSkaffoldModules_GoogleCloudStorageFields,
    ),
}

_ClouddeployCustomTargetType_CustomActionsFields = {
    ...
    "include_skaffold_modules": ubx.FieldSpec(
        ...
        kind="list",
        fields=_ClouddeployCustomTargetType_CustomActions_IncludeSkaffoldModulesFields,
    ),
    "render_action": ubx.FieldSpec(wire_name="render_action"),
}

_ClouddeployCustomTargetType_Tasks_Deploy_ContainerFields = {
...
_ClouddeployCustomTargetType_Tasks_DeployFields = {
    "container": ubx.FieldSpec(
        wire_name="container",
        kind="object",
        fields=_ClouddeployCustomTargetType_Tasks_Deploy_ContainerFields,
    ),
}

_ClouddeployCustomTargetType_TasksFields = {
    "deploy": ubx.FieldSpec(
        wire_name="deploy",
        kind="object",
        fields=_ClouddeployCustomTargetType_Tasks_DeployFields,
    ),
...
@dataclasses.dataclass
class ClouddeployCustomTargetTypeConfig:
...
@dataclasses.dataclass
class ClouddeployCustomTargetTypeAttrs:
    # Optional. User annotations. These attributes can only be set and used by the user, and not by Cloud Deploy. See https://google.aip.dev/128#annotations for more details such as format and size limitations.
    annotations: Any = None
    # Output only. Time at which the `CustomTargetType` was created.
    create_time: Any = None
...
ClouddeployCustomTargetType = ubx.ResourceBinding(
    wire_type="google_clouddeploy_clouddeploy_custom_target_type",
    fields={
        ...
        "custom_actions": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ClouddeployCustomTargetType_CustomActionsFields,
        ),
        ...
        "tasks": ubx.FieldSpec(
            wire_name="tasks",
            kind="object",
            fields=_ClouddeployCustomTargetType_TasksFields,
        ),
