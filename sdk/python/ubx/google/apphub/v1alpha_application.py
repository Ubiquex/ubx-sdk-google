...
class V1alphaApplication_Attributes_BusinessOwners_Channel:
    uri: Any = None

@dataclasses.dataclass
class V1alphaApplication_Attributes_BusinessOwners:
    channel: Any = None
    display_name: Any = None
    email: Any = None

@dataclasses.dataclass
class V1alphaApplication_Attributes_Criticality:
...
@dataclasses.dataclass
class V1alphaApplication_Attributes_Environment:
...
@dataclasses.dataclass
class V1alphaApplication_Attributes:
...
@dataclasses.dataclass
class V1alphaApplication_Scope:
    # Required. Scope Type.
    type: Any = None

_V1alphaApplication_Attributes_BusinessOwners_ChannelFields = {
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_V1alphaApplication_Attributes_BusinessOwnersFields = {
    "channel": ubx.FieldSpec(
        wire_name="channel",
        kind="object",
        fields=_V1alphaApplication_Attributes_BusinessOwners_ChannelFields,
    ),
    "display_name": ubx.FieldSpec(wire_name="display_name"),
    "email": ubx.FieldSpec(wire_name="email"),
}

_V1alphaApplication_Attributes_CriticalityFields = {
    "level": ubx.FieldSpec(wire_name="level"),
    "mission_critical": ubx.FieldSpec(wire_name="mission_critical"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_V1alphaApplication_Attributes_EnvironmentFields = {
    "environment": ubx.FieldSpec(wire_name="environment"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_V1alphaApplication_AttributesFields = {
    "business_owners": ubx.FieldSpec(
        wire_name="business_owners",
        kind="list",
        fields=_V1alphaApplication_Attributes_BusinessOwnersFields,
    ),
    "criticality": ubx.FieldSpec(
        wire_name="criticality",
        kind="object",
        fields=_V1alphaApplication_Attributes_CriticalityFields,
    ),
    ...
    "environment": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1alphaApplication_Attributes_EnvironmentFields,
    ),
...
_V1alphaApplication_ScopeFields = {
    "type": ubx.FieldSpec(wire_name="type"),
}
...
V1alphaApplication = ubx.ResourceBinding(
    wire_type="google_apphub_v1alpha_application",
    fields={
