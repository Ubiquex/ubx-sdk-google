...
class CloudnumberregistryRegistryBook_AggregatedData:
...
_CloudnumberregistryRegistryBook_AggregatedDataFields = {
...
@dataclasses.dataclass
class CloudnumberregistryRegistryBookConfig:
...
@dataclasses.dataclass
class CloudnumberregistryRegistryBookAttrs:
    # Aggregated data for the RegistryBook.
    aggregated_data: Any = None
    # Optional. List of scopes claimed by the RegistryBook. In Preview, Only project scope is supported. Each scope is in the format of projects/{project}. Each scope can only be claimed once.
    claimed_scopes: Any = None
...
CloudnumberregistryRegistryBook = ubx.ResourceBinding(
    wire_type="google_cloudnumberregistry_cloudnumberregistry_registry_book",
    fields={
        "aggregated_data": ubx.FieldSpec(
            wire_name="aggregated_data",
            kind="object",
            fields=_CloudnumberregistryRegistryBook_AggregatedDataFields,
        ),
