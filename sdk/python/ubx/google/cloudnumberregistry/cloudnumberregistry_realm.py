...
class CloudnumberregistryRealm_AggregatedData:
...
@dataclasses.dataclass
class CloudnumberregistryRealm_DiscoveryMetadata:
...
_CloudnumberregistryRealm_AggregatedDataFields = {
...
_CloudnumberregistryRealm_DiscoveryMetadataFields = {
...
@dataclasses.dataclass
class CloudnumberregistryRealmConfig:
...
@dataclasses.dataclass
class CloudnumberregistryRealmAttrs:
    # Aggregated data for the Realm.
    aggregated_data: Any = None
    # Output only. The time at which the Realm was created.
    create_time: Any = None
...
CloudnumberregistryRealm = ubx.ResourceBinding(
    wire_type="google_cloudnumberregistry_cloudnumberregistry_realm",
    fields={
        "aggregated_data": ubx.FieldSpec(
            wire_name="aggregated_data",
            kind="object",
            fields=_CloudnumberregistryRealm_AggregatedDataFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "discovery_metadata": ubx.FieldSpec(
            wire_name="discovery_metadata",
            kind="object",
            fields=_CloudnumberregistryRealm_DiscoveryMetadataFields,
        ),
