...
class V1beta1DatafusionV1beta1Instance_Accelerators:
    accelerator_type: Any = None
    state: Any = None

@dataclasses.dataclass
class V1beta1DatafusionV1beta1Instance_AvailableVersion:
...
@dataclasses.dataclass
class V1beta1DatafusionV1beta1Instance_CryptoKeyConfig:
...
@dataclasses.dataclass
class V1beta1DatafusionV1beta1Instance_EventPublishConfig:
...
@dataclasses.dataclass
class V1beta1DatafusionV1beta1Instance_LoggingConfig:
...
@dataclasses.dataclass
class V1beta1DatafusionV1beta1Instance_MaintenanceEvents:
    end_time: Any = None
    start_time: Any = None
    state: Any = None

@dataclasses.dataclass
class V1beta1DatafusionV1beta1Instance_MaintenancePolicy_MaintenanceExclusionWindow:
...
@dataclasses.dataclass
class V1beta1DatafusionV1beta1Instance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindow:
...
@dataclasses.dataclass
class V1beta1DatafusionV1beta1Instance_MaintenancePolicy_MaintenanceWindow:
    # Represents an arbitrary window of time that recurs.
    recurring_time_window: Any = None

@dataclasses.dataclass
class V1beta1DatafusionV1beta1Instance_MaintenancePolicy:
    # Represents an arbitrary window of time.
...
@dataclasses.dataclass
class V1beta1DatafusionV1beta1Instance_MonitoringConfig:
...
@dataclasses.dataclass
class V1beta1DatafusionV1beta1Instance_NetworkConfig_PrivateServiceConnectConfig:
...
@dataclasses.dataclass
class V1beta1DatafusionV1beta1Instance_NetworkConfig:
...
_V1beta1DatafusionV1beta1Instance_AcceleratorsFields = {
    "accelerator_type": ubx.FieldSpec(wire_name="accelerator_type"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_V1beta1DatafusionV1beta1Instance_AvailableVersionFields = {
...
_V1beta1DatafusionV1beta1Instance_CryptoKeyConfigFields = {
    "key_reference": ubx.FieldSpec(wire_name="key_reference"),
}

_V1beta1DatafusionV1beta1Instance_EventPublishConfigFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "topic": ubx.FieldSpec(wire_name="topic"),
}

_V1beta1DatafusionV1beta1Instance_LoggingConfigFields = {
...
_V1beta1DatafusionV1beta1Instance_MaintenanceEventsFields = {
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_V1beta1DatafusionV1beta1Instance_MaintenancePolicy_MaintenanceExclusionWindowFields = {
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

_V1beta1DatafusionV1beta1Instance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindowFields = {
    "recurrence": ubx.FieldSpec(wire_name="recurrence"),
    "window": ubx.FieldSpec(
        wire_name="window",
        kind="object",
        fields=_V1beta1DatafusionV1beta1Instance_MaintenancePolicy_MaintenanceExclusionWindowFields,
    ),
}

_V1beta1DatafusionV1beta1Instance_MaintenancePolicy_MaintenanceWindowFields = {
    "recurring_time_window": ubx.FieldSpec(
        wire_name="recurring_time_window",
        kind="object",
        fields=_V1beta1DatafusionV1beta1Instance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindowFields,
    ),
}

_V1beta1DatafusionV1beta1Instance_MaintenancePolicyFields = {
    ...
    "maintenance_window": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1DatafusionV1beta1Instance_MaintenancePolicy_MaintenanceWindowFields,
    ),
}

_V1beta1DatafusionV1beta1Instance_MonitoringConfigFields = {
    "enable_instance_v2_metrics": ubx.FieldSpec(wire_name="enable_instance_v2_metrics"),
}

_V1beta1DatafusionV1beta1Instance_NetworkConfig_PrivateServiceConnectConfigFields = {
...
_V1beta1DatafusionV1beta1Instance_NetworkConfigFields = {
    ...
    "private_service_connect_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1DatafusionV1beta1Instance_NetworkConfig_PrivateServiceConnectConfigFields,
    ),
}

@dataclasses.dataclass
class V1beta1DatafusionV1beta1InstanceConfig:
...
@dataclasses.dataclass
class V1beta1DatafusionV1beta1InstanceAttrs:
    # Output only. List of accelerators enabled for this CDF instance.
    accelerators: Any = None
    # Output only. Endpoint on which the REST APIs is accessible.
    api_endpoint: Any = None
...
V1beta1DatafusionV1beta1Instance = ubx.ResourceBinding(
    wire_type="google_datafusion_v1beta1_datafusion_v1beta1_instance",
    fields={
        "accelerators": ubx.FieldSpec(
            wire_name="accelerators",
            kind="list",
            fields=_V1beta1DatafusionV1beta1Instance_AcceleratorsFields,
        ),
        "api_endpoint": ubx.FieldSpec(wire_name="api_endpoint"),
        "available_version": ubx.FieldSpec(
            wire_name="available_version",
            kind="list",
            fields=_V1beta1DatafusionV1beta1Instance_AvailableVersionFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "crypto_key_config": ubx.FieldSpec(
            wire_name="crypto_key_config",
            kind="object",
            fields=_V1beta1DatafusionV1beta1Instance_CryptoKeyConfigFields,
        ),
        ...
        "enable_zone_separation": ubx.FieldSpec(wire_name="enable_zone_separation"),
        "event_publish_config": ubx.FieldSpec(
            wire_name="event_publish_config",
            kind="object",
            fields=_V1beta1DatafusionV1beta1Instance_EventPublishConfigFields,
        ),
        ...
        "logging_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1DatafusionV1beta1Instance_LoggingConfigFields,
        ),
        "maintenance_events": ubx.FieldSpec(
            wire_name="maintenance_events",
            kind="list",
            fields=_V1beta1DatafusionV1beta1Instance_MaintenanceEventsFields,
        ),
        "maintenance_policy": ubx.FieldSpec(
            wire_name="maintenance_policy",
            kind="object",
            fields=_V1beta1DatafusionV1beta1Instance_MaintenancePolicyFields,
        ),
        "monitoring_config": ubx.FieldSpec(
            wire_name="monitoring_config",
            kind="object",
            fields=_V1beta1DatafusionV1beta1Instance_MonitoringConfigFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "network_config": ubx.FieldSpec(
            wire_name="network_config",
            kind="object",
            fields=_V1beta1DatafusionV1beta1Instance_NetworkConfigFields,
        ),
        "options": ubx.FieldSpec(wire_name="options"),
        "p4_service_account": ubx.FieldSpec(wire_name="p4_service_account"),
        ...
        "workforce_identity_service_endpoint": ubx.FieldSpec(wire_name="workforce_identity_service_endpoint"),
