...
class DatafusionInstance_Accelerators:
    accelerator_type: Any = None
    state: Any = None

@dataclasses.dataclass
class DatafusionInstance_AvailableVersion:
...
@dataclasses.dataclass
class DatafusionInstance_CryptoKeyConfig:
...
@dataclasses.dataclass
class DatafusionInstance_EventPublishConfig:
...
@dataclasses.dataclass
class DatafusionInstance_LoggingConfig:
...
@dataclasses.dataclass
class DatafusionInstance_MaintenanceEvents:
    end_time: Any = None
    start_time: Any = None
    state: Any = None

@dataclasses.dataclass
class DatafusionInstance_MaintenancePolicy_MaintenanceExclusionWindow:
...
@dataclasses.dataclass
class DatafusionInstance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindow:
...
@dataclasses.dataclass
class DatafusionInstance_MaintenancePolicy_MaintenanceWindow:
    # Represents an arbitrary window of time that recurs.
    recurring_time_window: Any = None

@dataclasses.dataclass
class DatafusionInstance_MaintenancePolicy:
    # Represents an arbitrary window of time.
...
@dataclasses.dataclass
class DatafusionInstance_MonitoringConfig:
...
@dataclasses.dataclass
class DatafusionInstance_NetworkConfig_PrivateServiceConnectConfig:
...
@dataclasses.dataclass
class DatafusionInstance_NetworkConfig:
...
_DatafusionInstance_AcceleratorsFields = {
    "accelerator_type": ubx.FieldSpec(wire_name="accelerator_type"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_DatafusionInstance_AvailableVersionFields = {
...
_DatafusionInstance_CryptoKeyConfigFields = {
    "key_reference": ubx.FieldSpec(wire_name="key_reference"),
}

_DatafusionInstance_EventPublishConfigFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "topic": ubx.FieldSpec(wire_name="topic"),
}

_DatafusionInstance_LoggingConfigFields = {
...
_DatafusionInstance_MaintenanceEventsFields = {
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_DatafusionInstance_MaintenancePolicy_MaintenanceExclusionWindowFields = {
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

_DatafusionInstance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindowFields = {
    "recurrence": ubx.FieldSpec(wire_name="recurrence"),
    "window": ubx.FieldSpec(
        wire_name="window",
        kind="object",
        fields=_DatafusionInstance_MaintenancePolicy_MaintenanceExclusionWindowFields,
    ),
}

_DatafusionInstance_MaintenancePolicy_MaintenanceWindowFields = {
    "recurring_time_window": ubx.FieldSpec(
        wire_name="recurring_time_window",
        kind="object",
        fields=_DatafusionInstance_MaintenancePolicy_MaintenanceWindow_RecurringTimeWindowFields,
    ),
}

_DatafusionInstance_MaintenancePolicyFields = {
    ...
    "maintenance_window": ubx.FieldSpec(
        ...
        kind="object",
        fields=_DatafusionInstance_MaintenancePolicy_MaintenanceWindowFields,
    ),
}

_DatafusionInstance_MonitoringConfigFields = {
    "enable_instance_v2_metrics": ubx.FieldSpec(wire_name="enable_instance_v2_metrics"),
}

_DatafusionInstance_NetworkConfig_PrivateServiceConnectConfigFields = {
...
_DatafusionInstance_NetworkConfigFields = {
    ...
    "private_service_connect_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_DatafusionInstance_NetworkConfig_PrivateServiceConnectConfigFields,
    ),
}

@dataclasses.dataclass
class DatafusionInstanceConfig:
...
DatafusionInstance = ubx.ResourceBinding(
    wire_type="google_datafusion_datafusion_instance",
    fields={
        "accelerators": ubx.FieldSpec(
            wire_name="accelerators",
            kind="list",
            fields=_DatafusionInstance_AcceleratorsFields,
        ),
        "api_endpoint": ubx.FieldSpec(wire_name="api_endpoint"),
        "available_version": ubx.FieldSpec(
            wire_name="available_version",
            kind="list",
            fields=_DatafusionInstance_AvailableVersionFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "crypto_key_config": ubx.FieldSpec(
            wire_name="crypto_key_config",
            kind="object",
            fields=_DatafusionInstance_CryptoKeyConfigFields,
        ),
        ...
        "event_publish_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DatafusionInstance_EventPublishConfigFields,
        ),
        ...
        "logging_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DatafusionInstance_LoggingConfigFields,
        ),
        "maintenance_events": ubx.FieldSpec(
            wire_name="maintenance_events",
            kind="list",
            fields=_DatafusionInstance_MaintenanceEventsFields,
        ),
        "maintenance_policy": ubx.FieldSpec(
            wire_name="maintenance_policy",
            kind="object",
            fields=_DatafusionInstance_MaintenancePolicyFields,
        ),
        "monitoring_config": ubx.FieldSpec(
            wire_name="monitoring_config",
            kind="object",
            fields=_DatafusionInstance_MonitoringConfigFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "network_config": ubx.FieldSpec(
            wire_name="network_config",
            kind="object",
            fields=_DatafusionInstance_NetworkConfigFields,
        ),
