...
class OrgpolicyPolicy_Alternate_Spec_Rules_Condition:
...
@dataclasses.dataclass
class OrgpolicyPolicy_Alternate_Spec_Rules_Values:
    allowed_values: Any = None
    denied_values: Any = None

@dataclasses.dataclass
class OrgpolicyPolicy_Alternate_Spec_Rules:
    allow_all: Any = None
    condition: Any = None
    deny_all: Any = None
    enforce: Any = None
...
@dataclasses.dataclass
class OrgpolicyPolicy_Alternate_Spec:
...
@dataclasses.dataclass
class OrgpolicyPolicy_Alternate:
...
_OrgpolicyPolicy_Alternate_Spec_Rules_ConditionFields = {
...
_OrgpolicyPolicy_Alternate_Spec_RulesFields = {
    ...
    "values": ubx.FieldSpec(
        wire_name="values",
        kind="object",
        fields=_OrgpolicyPolicy_Alternate_Spec_Rules_ValuesFields,
    ),
}

_OrgpolicyPolicy_Alternate_SpecFields = {
    ...
    "rules": ubx.FieldSpec(
        wire_name="rules",
        kind="list",
        fields=_OrgpolicyPolicy_Alternate_Spec_RulesFields,
    ),
    "update_time": ubx.FieldSpec(wire_name="update_time"),
}

_OrgpolicyPolicy_AlternateFields = {
    "launch": ubx.FieldSpec(wire_name="launch"),
    "spec": ubx.FieldSpec(
        wire_name="spec",
        kind="object",
        fields=_OrgpolicyPolicy_Alternate_SpecFields,
    ),
}

@dataclasses.dataclass
class OrgpolicyPolicyConfig:
...
OrgpolicyPolicy = ubx.ResourceBinding(
    wire_type="google_orgpolicy_orgpolicy_policy",
    fields={
        "alternate": ubx.FieldSpec(
            wire_name="alternate",
            kind="object",
            fields=_OrgpolicyPolicy_AlternateFields,
        ),
