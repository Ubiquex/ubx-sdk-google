...
class VmmigrationDatacenterConnector_AvailableVersions_InPlaceUpdate:
...
@dataclasses.dataclass
class VmmigrationDatacenterConnector_AvailableVersions:
...
@dataclasses.dataclass
class VmmigrationDatacenterConnector_Error:
...
@dataclasses.dataclass
class VmmigrationDatacenterConnector_UpgradeStatus:
...
_VmmigrationDatacenterConnector_AvailableVersions_InPlaceUpdateFields = {
...
_VmmigrationDatacenterConnector_AvailableVersionsFields = {
    "in_place_update": ubx.FieldSpec(
        wire_name="in_place_update",
        kind="object",
        fields=_VmmigrationDatacenterConnector_AvailableVersions_InPlaceUpdateFields,
    ),
...
_VmmigrationDatacenterConnector_ErrorFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_VmmigrationDatacenterConnector_UpgradeStatusFields = {
    "error": ubx.FieldSpec(
        wire_name="error",
        kind="object",
        fields=_VmmigrationDatacenterConnector_ErrorFields,
    ),
...
@dataclasses.dataclass
class VmmigrationDatacenterConnectorConfig:
...
@dataclasses.dataclass
class VmmigrationDatacenterConnectorAttrs:
    # Output only. Appliance OVA version. This is the OVA which is manually installed by the user and contains the infrastructure for the automatically updatable components on the appliance.
    appliance_infrastructure_version: Any = None
    # Output only. Appliance last installed update bundle version. This is the version of the automatically updatable components on the appliance.
    appliance_software_version: Any = None
...
VmmigrationDatacenterConnector = ubx.ResourceBinding(
    wire_type="google_vmmigration_vmmigration_datacenter_connector",
    fields={
        ...
        "available_versions": ubx.FieldSpec(
            ...
            kind="object",
            fields=_VmmigrationDatacenterConnector_AvailableVersionsFields,
        ),
        ...
        "upgrade_status": ubx.FieldSpec(
            ...
            kind="object",
            fields=_VmmigrationDatacenterConnector_UpgradeStatusFields,
        ),
        "version": ubx.FieldSpec(wire_name="version"),
    },
)
