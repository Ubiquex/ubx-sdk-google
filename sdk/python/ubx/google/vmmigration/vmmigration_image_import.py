...
class VmmigrationImageImport_DiskImageTargetDefaults_DataDiskImageImport:
...
@dataclasses.dataclass
class VmmigrationImageImport_DiskImageTargetDefaults_Encryption:
    # Required. The name of the encryption key that is stored in Google Cloud KMS.
    kms_key: Any = None

@dataclasses.dataclass
class VmmigrationImageImport_DiskImageTargetDefaults_OsAdaptationParameters_AdaptationModifiers:
    modifier: Any = None
    value: Any = None

@dataclasses.dataclass
class VmmigrationImageImport_DiskImageTargetDefaults_OsAdaptationParameters:
...
@dataclasses.dataclass
class VmmigrationImageImport_DiskImageTargetDefaults:
...
@dataclasses.dataclass
class VmmigrationImageImport_MachineImageTargetDefaults_MachineImageParametersOverrides:
...
@dataclasses.dataclass
class VmmigrationImageImport_MachineImageTargetDefaults_NetworkInterfaces:
...
@dataclasses.dataclass
class VmmigrationImageImport_MachineImageTargetDefaults_ServiceAccount:
...
@dataclasses.dataclass
class VmmigrationImageImport_MachineImageTargetDefaults_ShieldedInstanceConfig:
...
@dataclasses.dataclass
class VmmigrationImageImport_MachineImageTargetDefaults:
...
@dataclasses.dataclass
class VmmigrationImageImport_RecentImageImportJobs_Errors:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class VmmigrationImageImport_RecentImageImportJobs_Steps:
...
@dataclasses.dataclass
class VmmigrationImageImport_RecentImageImportJobs_Warnings_ActionItem:
    locale: Any = None
    message: Any = None

@dataclasses.dataclass
class VmmigrationImageImport_RecentImageImportJobs_Warnings_HelpLinks:
    description: Any = None
    url: Any = None

@dataclasses.dataclass
class VmmigrationImageImport_RecentImageImportJobs_Warnings:
...
@dataclasses.dataclass
class VmmigrationImageImport_RecentImageImportJobs:
...
_VmmigrationImageImport_DiskImageTargetDefaults_DataDiskImageImportFields = {
    "guest_os_features": ubx.FieldSpec(wire_name="guest_os_features"),
}

_VmmigrationImageImport_DiskImageTargetDefaults_EncryptionFields = {
    "kms_key": ubx.FieldSpec(wire_name="kms_key"),
}

_VmmigrationImageImport_DiskImageTargetDefaults_OsAdaptationParameters_AdaptationModifiersFields = {
    "modifier": ubx.FieldSpec(wire_name="modifier"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_VmmigrationImageImport_DiskImageTargetDefaults_OsAdaptationParametersFields = {
    "adaptation_modifiers": ubx.FieldSpec(
        wire_name="adaptation_modifiers",
        kind="list",
        fields=_VmmigrationImageImport_DiskImageTargetDefaults_OsAdaptationParameters_AdaptationModifiersFields,
    ),
...
_VmmigrationImageImport_DiskImageTargetDefaultsFields = {
    ...
    "data_disk_image_import": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmmigrationImageImport_DiskImageTargetDefaults_DataDiskImageImportFields,
    ),
    "description": ubx.FieldSpec(wire_name="description"),
    "encryption": ubx.FieldSpec(
        wire_name="encryption",
        kind="object",
        fields=_VmmigrationImageImport_DiskImageTargetDefaults_EncryptionFields,
    ),
    ...
    "os_adaptation_parameters": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmmigrationImageImport_DiskImageTargetDefaults_OsAdaptationParametersFields,
    ),
    "single_region_storage": ubx.FieldSpec(wire_name="single_region_storage"),
    "target_project": ubx.FieldSpec(wire_name="target_project"),
}

_VmmigrationImageImport_MachineImageTargetDefaults_MachineImageParametersOverridesFields = {
    "machine_type": ubx.FieldSpec(wire_name="machine_type"),
}

_VmmigrationImageImport_MachineImageTargetDefaults_NetworkInterfacesFields = {
...
_VmmigrationImageImport_MachineImageTargetDefaults_ServiceAccountFields = {
    "email": ubx.FieldSpec(wire_name="email"),
    "scopes": ubx.FieldSpec(wire_name="scopes"),
}

_VmmigrationImageImport_MachineImageTargetDefaults_ShieldedInstanceConfigFields = {
...
_VmmigrationImageImport_MachineImageTargetDefaultsFields = {
    "additional_licenses": ubx.FieldSpec(wire_name="additional_licenses"),
    "description": ubx.FieldSpec(wire_name="description"),
    "encryption": ubx.FieldSpec(
        wire_name="encryption",
    ...
    "machine_image_parameters_overrides": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmmigrationImageImport_MachineImageTargetDefaults_MachineImageParametersOverridesFields,
    ),
    "network_interfaces": ubx.FieldSpec(
        wire_name="network_interfaces",
        kind="list",
        fields=_VmmigrationImageImport_MachineImageTargetDefaults_NetworkInterfacesFields,
    ),
    "os_adaptation_parameters": ubx.FieldSpec(
        wire_name="os_adaptation_parameters",
        kind="object",
    ...
    "service_account": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmmigrationImageImport_MachineImageTargetDefaults_ServiceAccountFields,
    ),
    "shielded_instance_config": ubx.FieldSpec(
        wire_name="shielded_instance_config",
        kind="object",
        fields=_VmmigrationImageImport_MachineImageTargetDefaults_ShieldedInstanceConfigFields,
    ),
    "single_region_storage": ubx.FieldSpec(wire_name="single_region_storage"),
...
_VmmigrationImageImport_RecentImageImportJobs_ErrorsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_VmmigrationImageImport_RecentImageImportJobs_StepsFields = {
...
_VmmigrationImageImport_RecentImageImportJobs_Warnings_ActionItemFields = {
    "locale": ubx.FieldSpec(wire_name="locale"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_VmmigrationImageImport_RecentImageImportJobs_Warnings_HelpLinksFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "url": ubx.FieldSpec(wire_name="url"),
}

_VmmigrationImageImport_RecentImageImportJobs_WarningsFields = {
    "action_item": ubx.FieldSpec(
        wire_name="action_item",
        kind="object",
        fields=_VmmigrationImageImport_RecentImageImportJobs_Warnings_ActionItemFields,
    ),
    "code": ubx.FieldSpec(wire_name="code"),
    "help_links": ubx.FieldSpec(
        wire_name="help_links",
        kind="list",
        fields=_VmmigrationImageImport_RecentImageImportJobs_Warnings_HelpLinksFields,
    ),
...
_VmmigrationImageImport_RecentImageImportJobsFields = {
    ...
    "disk_image_target_details": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmmigrationImageImport_DiskImageTargetDefaultsFields,
    ),
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "errors": ubx.FieldSpec(
        wire_name="errors",
        kind="list",
        fields=_VmmigrationImageImport_RecentImageImportJobs_ErrorsFields,
    ),
    "machine_image_target_details": ubx.FieldSpec(
        wire_name="machine_image_target_details",
        kind="object",
        fields=_VmmigrationImageImport_MachineImageTargetDefaultsFields,
    ),
    ...
    "steps": ubx.FieldSpec(
        wire_name="steps",
        kind="list",
        fields=_VmmigrationImageImport_RecentImageImportJobs_StepsFields,
    ),
    "warnings": ubx.FieldSpec(
        wire_name="warnings",
        kind="list",
        fields=_VmmigrationImageImport_RecentImageImportJobs_WarningsFields,
    ),
}

@dataclasses.dataclass
class VmmigrationImageImportConfig:
...
@dataclasses.dataclass
class VmmigrationImageImportAttrs:
    # Immutable. The path to the Cloud Storage file from which the image should be imported.
    cloud_storage_uri: Any = None
    # Output only. The time the image import was created.
    create_time: Any = None
...
VmmigrationImageImport = ubx.ResourceBinding(
    wire_type="google_vmmigration_vmmigration_image_import",
    fields={
        "cloud_storage_uri": ubx.FieldSpec(wire_name="cloud_storage_uri"),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        ...
        "recent_image_import_jobs": ubx.FieldSpec(
            ...
            kind="list",
            fields=_VmmigrationImageImport_RecentImageImportJobsFields,
        ),
    },
)
