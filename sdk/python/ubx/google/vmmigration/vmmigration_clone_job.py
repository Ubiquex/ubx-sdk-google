...
class VmmigrationCloneJob_ComputeEngineDisksTargetDetails_Disks:
    disk_uri: Any = None
    source_disk_number: Any = None

@dataclasses.dataclass
class VmmigrationCloneJob_ComputeEngineDisksTargetDetails_VmTargetDetails:
    # Output only. The URI of the Compute Engine VM.
    vm_uri: Any = None

@dataclasses.dataclass
class VmmigrationCloneJob_ComputeEngineDisksTargetDetails:
...
@dataclasses.dataclass
class VmmigrationCloneJob_ComputeEngineTargetDetails_AdaptationModifiers:
    modifier: Any = None
    value: Any = None

@dataclasses.dataclass
class VmmigrationCloneJob_ComputeEngineTargetDetails_AppliedLicense:
...
@dataclasses.dataclass
class VmmigrationCloneJob_ComputeEngineTargetDetails_ComputeScheduling_NodeAffinities:
    key: Any = None
    operator: Any = None
    values: Any = None

@dataclasses.dataclass
class VmmigrationCloneJob_ComputeEngineTargetDetails_ComputeScheduling:
...
@dataclasses.dataclass
class VmmigrationCloneJob_ComputeEngineTargetDetails_Encryption:
    # Required. The name of the encryption key that is stored in Google Cloud KMS.
    kms_key: Any = None

@dataclasses.dataclass
class VmmigrationCloneJob_ComputeEngineTargetDetails_NetworkInterfaces:
...
@dataclasses.dataclass
class VmmigrationCloneJob_ComputeEngineTargetDetails:
...
@dataclasses.dataclass
class VmmigrationCloneJob_Error:
...
@dataclasses.dataclass
class VmmigrationCloneJob_Steps:
...
_VmmigrationCloneJob_ComputeEngineDisksTargetDetails_DisksFields = {
    "disk_uri": ubx.FieldSpec(wire_name="disk_uri"),
    "source_disk_number": ubx.FieldSpec(wire_name="source_disk_number"),
}

_VmmigrationCloneJob_ComputeEngineDisksTargetDetails_VmTargetDetailsFields = {
    "vm_uri": ubx.FieldSpec(wire_name="vm_uri"),
}

_VmmigrationCloneJob_ComputeEngineDisksTargetDetailsFields = {
    "disks": ubx.FieldSpec(
        wire_name="disks",
        kind="list",
        fields=_VmmigrationCloneJob_ComputeEngineDisksTargetDetails_DisksFields,
    ),
    ...
    "vm_target_details": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmmigrationCloneJob_ComputeEngineDisksTargetDetails_VmTargetDetailsFields,
    ),
}

_VmmigrationCloneJob_ComputeEngineTargetDetails_AdaptationModifiersFields = {
    "modifier": ubx.FieldSpec(wire_name="modifier"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_VmmigrationCloneJob_ComputeEngineTargetDetails_AppliedLicenseFields = {
    "os_license": ubx.FieldSpec(wire_name="os_license"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_VmmigrationCloneJob_ComputeEngineTargetDetails_ComputeScheduling_NodeAffinitiesFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "operator": ubx.FieldSpec(wire_name="operator"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_VmmigrationCloneJob_ComputeEngineTargetDetails_ComputeSchedulingFields = {
    "min_node_cpus": ubx.FieldSpec(wire_name="min_node_cpus"),
    "node_affinities": ubx.FieldSpec(
        wire_name="node_affinities",
        kind="list",
        fields=_VmmigrationCloneJob_ComputeEngineTargetDetails_ComputeScheduling_NodeAffinitiesFields,
    ),
    "on_host_maintenance": ubx.FieldSpec(wire_name="on_host_maintenance"),
    "restart_type": ubx.FieldSpec(wire_name="restart_type"),
}

_VmmigrationCloneJob_ComputeEngineTargetDetails_EncryptionFields = {
    "kms_key": ubx.FieldSpec(wire_name="kms_key"),
}

_VmmigrationCloneJob_ComputeEngineTargetDetails_NetworkInterfacesFields = {
...
_VmmigrationCloneJob_ComputeEngineTargetDetailsFields = {
    "adaptation_modifiers": ubx.FieldSpec(
        wire_name="adaptation_modifiers",
        kind="list",
        fields=_VmmigrationCloneJob_ComputeEngineTargetDetails_AdaptationModifiersFields,
    ),
    "additional_licenses": ubx.FieldSpec(wire_name="additional_licenses"),
    "applied_license": ubx.FieldSpec(
        wire_name="applied_license",
        kind="object",
        fields=_VmmigrationCloneJob_ComputeEngineTargetDetails_AppliedLicenseFields,
    ),
    ...
    "compute_scheduling": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmmigrationCloneJob_ComputeEngineTargetDetails_ComputeSchedulingFields,
    ),
    ...
    "encryption": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmmigrationCloneJob_ComputeEngineTargetDetails_EncryptionFields,
    ),
    ...
    "network_interfaces": ubx.FieldSpec(
        ...
        kind="list",
        fields=_VmmigrationCloneJob_ComputeEngineTargetDetails_NetworkInterfacesFields,
    ),
...
@dataclasses.dataclass
class VmmigrationCloneJobConfig:
...
@dataclasses.dataclass
class VmmigrationCloneJobAttrs:
    # ComputeEngineDisksTargetDetails is a collection of created Persistent Disks details.
    compute_engine_disks_target_details: Any = None
    # ComputeEngineTargetDetails is a collection of details for creating a VM in a target Compute Engine project.
    compute_engine_target_details: Any = None
...
VmmigrationCloneJob = ubx.ResourceBinding(
    wire_type="google_vmmigration_vmmigration_clone_job",
    fields={
        "compute_engine_disks_target_details": ubx.FieldSpec(
            wire_name="compute_engine_disks_target_details",
            kind="object",
            fields=_VmmigrationCloneJob_ComputeEngineDisksTargetDetailsFields,
        ),
        "compute_engine_target_details": ubx.FieldSpec(
            wire_name="compute_engine_target_details",
            kind="object",
            fields=_VmmigrationCloneJob_ComputeEngineTargetDetailsFields,
        ),
        ...
        "error": ubx.FieldSpec(
            wire_name="error",
            kind="object",
            fields=_VmmigrationCloneJob_ErrorFields,
        ),
        ...
        "steps": ubx.FieldSpec(
            wire_name="steps",
            kind="list",
            fields=_VmmigrationCloneJob_StepsFields,
        ),
    },
)
