...
_CutoverJob_Steps_FinalSync_Steps_ReplicatingFields = {
...
_CutoverJob_Steps_FinalSync_StepsFields = {
    ...
    "replicating": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CutoverJob_Steps_FinalSync_Steps_ReplicatingFields,
    ),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

_CutoverJob_Steps_FinalSync_Warnings_ActionItemFields = {
    "locale": ubx.FieldSpec(wire_name="locale"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_CutoverJob_Steps_FinalSync_Warnings_HelpLinksFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "url": ubx.FieldSpec(wire_name="url"),
}

_CutoverJob_Steps_FinalSync_WarningsFields = {
    "action_item": ubx.FieldSpec(
        wire_name="action_item",
        kind="object",
        fields=_CutoverJob_Steps_FinalSync_Warnings_ActionItemFields,
    ),
    "code": ubx.FieldSpec(wire_name="code"),
    "help_links": ubx.FieldSpec(
        wire_name="help_links",
        kind="list",
        fields=_CutoverJob_Steps_FinalSync_Warnings_HelpLinksFields,
    ),
...
_CutoverJob_Steps_FinalSyncFields = {
    ...
    "steps": ubx.FieldSpec(
        wire_name="steps",
        kind="list",
        fields=_CutoverJob_Steps_FinalSync_StepsFields,
    ),
    "total_pause_duration": ubx.FieldSpec(wire_name="total_pause_duration"),
    "warnings": ubx.FieldSpec(
        wire_name="warnings",
        kind="list",
        fields=_CutoverJob_Steps_FinalSync_WarningsFields,
    ),
}

_CutoverJob_StepsFields = {
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "final_sync": ubx.FieldSpec(
        wire_name="final_sync",
        kind="object",
        fields=_CutoverJob_Steps_FinalSyncFields,
    ),
...
CutoverJob = ubx.ResourceBinding(
    ...
    fields={
        ...
        "steps": ubx.FieldSpec(
            wire_name="steps",
            kind="list",
            fields=_CutoverJob_StepsFields,
        ),
    },
)
