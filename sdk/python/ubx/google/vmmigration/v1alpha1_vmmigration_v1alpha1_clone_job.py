...
class V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineDisksTargetDetails_Disks:
    disk_uri: Any = None
    source_disk_number: Any = None

@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineDisksTargetDetails_VmTargetDetails:
    # Output only. The URI of the Compute Engine VM.
    vm_uri: Any = None

@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineDisksTargetDetails:
...
@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_AdaptationModifiers:
    modifier: Any = None
    value: Any = None

@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_AppliedLicense:
...
@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_ComputeScheduling_NodeAffinities:
    key: Any = None
    operator: Any = None
    values: Any = None

@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_ComputeScheduling:
...
@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_Encryption:
    # Required. The name of the encryption key that is stored in Google Cloud KMS.
    kms_key: Any = None

@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_NetworkInterfaces:
...
@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails:
...
@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineVmDetails:
    # AppliedLicense holds the license data returned by adaptation module report.
    applied_license: Any = None
...
@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJob_Error:
...
@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJob_Steps:
...
_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineDisksTargetDetails_DisksFields = {
    "disk_uri": ubx.FieldSpec(wire_name="disk_uri"),
    "source_disk_number": ubx.FieldSpec(wire_name="source_disk_number"),
}

_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineDisksTargetDetails_VmTargetDetailsFields = {
    "vm_uri": ubx.FieldSpec(wire_name="vm_uri"),
}

_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineDisksTargetDetailsFields = {
    "disks": ubx.FieldSpec(
        wire_name="disks",
        kind="list",
        fields=_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineDisksTargetDetails_DisksFields,
    ),
    ...
    "vm_target_details": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineDisksTargetDetails_VmTargetDetailsFields,
    ),
}

_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_AdaptationModifiersFields = {
    "modifier": ubx.FieldSpec(wire_name="modifier"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_AppliedLicenseFields = {
    "os_license": ubx.FieldSpec(wire_name="os_license"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_ComputeScheduling_NodeAffinitiesFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "operator": ubx.FieldSpec(wire_name="operator"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_ComputeSchedulingFields = {
    ...
    "node_affinities": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_ComputeScheduling_NodeAffinitiesFields,
    ),
    "on_host_maintenance": ubx.FieldSpec(wire_name="on_host_maintenance"),
    "restart_type": ubx.FieldSpec(wire_name="restart_type"),
}

_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_EncryptionFields = {
    "kms_key": ubx.FieldSpec(wire_name="kms_key"),
}

_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_NetworkInterfacesFields = {
...
_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetailsFields = {
    "adaptation_modifiers": ubx.FieldSpec(
        wire_name="adaptation_modifiers",
        kind="list",
        fields=_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_AdaptationModifiersFields,
    ),
    "additional_licenses": ubx.FieldSpec(wire_name="additional_licenses"),
    "applied_license": ubx.FieldSpec(
        wire_name="applied_license",
        kind="object",
        fields=_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_AppliedLicenseFields,
    ),
    ...
    "compute_scheduling": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_ComputeSchedulingFields,
    ),
    ...
    "encryption": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_EncryptionFields,
    ),
    ...
    "network_interfaces": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_NetworkInterfacesFields,
    ),
...
_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineVmDetailsFields = {
    "applied_license": ubx.FieldSpec(
        wire_name="applied_license",
        kind="object",
        fields=_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetails_AppliedLicenseFields,
...
@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJobConfig:
...
@dataclasses.dataclass
class V1alpha1VmmigrationV1alpha1CloneJobAttrs:
    # ComputeEngineDisksTargetDetails is a collection of created Persistent Disks details.
    compute_engine_disks_target_details: Any = None
    # ComputeEngineTargetDetails is a collection of details for creating a VM in a target Compute Engine project.
    compute_engine_target_details: Any = None
...
V1alpha1VmmigrationV1alpha1CloneJob = ubx.ResourceBinding(
    wire_type="google_vmmigration_v1alpha1_vmmigration_v1alpha1_clone_job",
    fields={
        "compute_engine_disks_target_details": ubx.FieldSpec(
            wire_name="compute_engine_disks_target_details",
            kind="object",
            fields=_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineDisksTargetDetailsFields,
        ),
        "compute_engine_target_details": ubx.FieldSpec(
            wire_name="compute_engine_target_details",
            kind="object",
            fields=_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineTargetDetailsFields,
        ),
        "compute_engine_vm_details": ubx.FieldSpec(
            wire_name="compute_engine_vm_details",
            kind="object",
            fields=_V1alpha1VmmigrationV1alpha1CloneJob_ComputeEngineVmDetailsFields,
        ),
        ...
        "error": ubx.FieldSpec(
            wire_name="error",
            kind="object",
            fields=_V1alpha1VmmigrationV1alpha1CloneJob_ErrorFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        ...
        "steps": ubx.FieldSpec(
            wire_name="steps",
            kind="list",
            fields=_V1alpha1VmmigrationV1alpha1CloneJob_StepsFields,
        ),
