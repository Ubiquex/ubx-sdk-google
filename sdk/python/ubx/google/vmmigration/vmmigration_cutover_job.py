...
class VmmigrationCutoverJob_ComputeEngineDisksTargetDetails_Disks:
    disk_uri: Any = None
    source_disk_number: Any = None

@dataclasses.dataclass
class VmmigrationCutoverJob_ComputeEngineDisksTargetDetails_VmTargetDetails:
    # Output only. The URI of the Compute Engine VM.
    vm_uri: Any = None

@dataclasses.dataclass
class VmmigrationCutoverJob_ComputeEngineDisksTargetDetails:
...
@dataclasses.dataclass
class VmmigrationCutoverJob_ComputeEngineTargetDetails_AdaptationModifiers:
    modifier: Any = None
    value: Any = None

@dataclasses.dataclass
class VmmigrationCutoverJob_ComputeEngineTargetDetails_AppliedLicense:
...
@dataclasses.dataclass
class VmmigrationCutoverJob_ComputeEngineTargetDetails_ComputeScheduling_NodeAffinities:
    key: Any = None
    operator: Any = None
    values: Any = None

@dataclasses.dataclass
class VmmigrationCutoverJob_ComputeEngineTargetDetails_ComputeScheduling:
...
@dataclasses.dataclass
class VmmigrationCutoverJob_ComputeEngineTargetDetails_Encryption:
    # Required. The name of the encryption key that is stored in Google Cloud KMS.
    kms_key: Any = None

@dataclasses.dataclass
class VmmigrationCutoverJob_ComputeEngineTargetDetails_NetworkInterfaces:
...
@dataclasses.dataclass
class VmmigrationCutoverJob_ComputeEngineTargetDetails:
...
@dataclasses.dataclass
class VmmigrationCutoverJob_Error:
...
@dataclasses.dataclass
class VmmigrationCutoverJob_Steps_FinalSync_Steps_Replicating:
...
@dataclasses.dataclass
class VmmigrationCutoverJob_Steps_FinalSync_Steps:
    end_time: Any = None
...
@dataclasses.dataclass
class VmmigrationCutoverJob_Steps_FinalSync_Warnings_ActionItem:
    locale: Any = None
    message: Any = None

@dataclasses.dataclass
class VmmigrationCutoverJob_Steps_FinalSync_Warnings_HelpLinks:
    description: Any = None
    url: Any = None

@dataclasses.dataclass
class VmmigrationCutoverJob_Steps_FinalSync_Warnings:
...
@dataclasses.dataclass
class VmmigrationCutoverJob_Steps_FinalSync:
...
@dataclasses.dataclass
class VmmigrationCutoverJob_Steps:
    end_time: Any = None
    final_sync: Any = None
...
_VmmigrationCutoverJob_ComputeEngineDisksTargetDetails_DisksFields = {
    "disk_uri": ubx.FieldSpec(wire_name="disk_uri"),
    "source_disk_number": ubx.FieldSpec(wire_name="source_disk_number"),
}

_VmmigrationCutoverJob_ComputeEngineDisksTargetDetails_VmTargetDetailsFields = {
    "vm_uri": ubx.FieldSpec(wire_name="vm_uri"),
}

_VmmigrationCutoverJob_ComputeEngineDisksTargetDetailsFields = {
    "disks": ubx.FieldSpec(
        wire_name="disks",
        kind="list",
        fields=_VmmigrationCutoverJob_ComputeEngineDisksTargetDetails_DisksFields,
    ),
    ...
    "vm_target_details": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmmigrationCutoverJob_ComputeEngineDisksTargetDetails_VmTargetDetailsFields,
    ),
}

_VmmigrationCutoverJob_ComputeEngineTargetDetails_AdaptationModifiersFields = {
    "modifier": ubx.FieldSpec(wire_name="modifier"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_VmmigrationCutoverJob_ComputeEngineTargetDetails_AppliedLicenseFields = {
    "os_license": ubx.FieldSpec(wire_name="os_license"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_VmmigrationCutoverJob_ComputeEngineTargetDetails_ComputeScheduling_NodeAffinitiesFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "operator": ubx.FieldSpec(wire_name="operator"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_VmmigrationCutoverJob_ComputeEngineTargetDetails_ComputeSchedulingFields = {
    "min_node_cpus": ubx.FieldSpec(wire_name="min_node_cpus"),
    "node_affinities": ubx.FieldSpec(
        wire_name="node_affinities",
        kind="list",
        fields=_VmmigrationCutoverJob_ComputeEngineTargetDetails_ComputeScheduling_NodeAffinitiesFields,
    ),
    "on_host_maintenance": ubx.FieldSpec(wire_name="on_host_maintenance"),
    "restart_type": ubx.FieldSpec(wire_name="restart_type"),
}

_VmmigrationCutoverJob_ComputeEngineTargetDetails_EncryptionFields = {
    "kms_key": ubx.FieldSpec(wire_name="kms_key"),
}

_VmmigrationCutoverJob_ComputeEngineTargetDetails_NetworkInterfacesFields = {
...
_VmmigrationCutoverJob_ComputeEngineTargetDetailsFields = {
    "adaptation_modifiers": ubx.FieldSpec(
        wire_name="adaptation_modifiers",
        kind="list",
        fields=_VmmigrationCutoverJob_ComputeEngineTargetDetails_AdaptationModifiersFields,
    ),
    "additional_licenses": ubx.FieldSpec(wire_name="additional_licenses"),
    "applied_license": ubx.FieldSpec(
        wire_name="applied_license",
        kind="object",
        fields=_VmmigrationCutoverJob_ComputeEngineTargetDetails_AppliedLicenseFields,
    ),
    ...
    "compute_scheduling": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmmigrationCutoverJob_ComputeEngineTargetDetails_ComputeSchedulingFields,
    ),
    ...
    "encryption": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmmigrationCutoverJob_ComputeEngineTargetDetails_EncryptionFields,
    ),
    ...
    "network_interfaces": ubx.FieldSpec(
        ...
        kind="list",
        fields=_VmmigrationCutoverJob_ComputeEngineTargetDetails_NetworkInterfacesFields,
    ),
...
_VmmigrationCutoverJob_Steps_FinalSync_StepsFields = {
    ...
    "replicating": ubx.FieldSpec(
        ...
        kind="object",
        fields=_VmmigrationCutoverJob_Steps_FinalSync_Steps_ReplicatingFields,
    ),
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

_VmmigrationCutoverJob_Steps_FinalSync_Warnings_ActionItemFields = {
    "locale": ubx.FieldSpec(wire_name="locale"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_VmmigrationCutoverJob_Steps_FinalSync_Warnings_HelpLinksFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "url": ubx.FieldSpec(wire_name="url"),
}

_VmmigrationCutoverJob_Steps_FinalSync_WarningsFields = {
    "action_item": ubx.FieldSpec(
        wire_name="action_item",
        kind="object",
        fields=_VmmigrationCutoverJob_Steps_FinalSync_Warnings_ActionItemFields,
    ),
    "code": ubx.FieldSpec(wire_name="code"),
    "help_links": ubx.FieldSpec(
        wire_name="help_links",
        kind="list",
        fields=_VmmigrationCutoverJob_Steps_FinalSync_Warnings_HelpLinksFields,
    ),
...
_VmmigrationCutoverJob_Steps_FinalSyncFields = {
    "cycle_number": ubx.FieldSpec(wire_name="cycle_number"),
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "error": ubx.FieldSpec(
        wire_name="error",
        kind="object",
        fields=_VmmigrationCutoverJob_ErrorFields,
    ),
    ...
    "steps": ubx.FieldSpec(
        wire_name="steps",
        kind="list",
        fields=_VmmigrationCutoverJob_Steps_FinalSync_StepsFields,
    ),
    "total_pause_duration": ubx.FieldSpec(wire_name="total_pause_duration"),
    "warnings": ubx.FieldSpec(
        wire_name="warnings",
        kind="list",
        fields=_VmmigrationCutoverJob_Steps_FinalSync_WarningsFields,
    ),
}

_VmmigrationCutoverJob_StepsFields = {
    "end_time": ubx.FieldSpec(wire_name="end_time"),
    "final_sync": ubx.FieldSpec(
        wire_name="final_sync",
        kind="object",
        fields=_VmmigrationCutoverJob_Steps_FinalSyncFields,
    ),
...
@dataclasses.dataclass
class VmmigrationCutoverJobConfig:
...
@dataclasses.dataclass
class VmmigrationCutoverJobAttrs:
    # ComputeEngineDisksTargetDetails is a collection of created Persistent Disks details.
    compute_engine_disks_target_details: Any = None
    # ComputeEngineTargetDetails is a collection of details for creating a VM in a target Compute Engine project.
    compute_engine_target_details: Any = None
...
VmmigrationCutoverJob = ubx.ResourceBinding(
    wire_type="google_vmmigration_vmmigration_cutover_job",
    fields={
        "compute_engine_disks_target_details": ubx.FieldSpec(
            wire_name="compute_engine_disks_target_details",
            kind="object",
            fields=_VmmigrationCutoverJob_ComputeEngineDisksTargetDetailsFields,
        ),
        "compute_engine_target_details": ubx.FieldSpec(
            wire_name="compute_engine_target_details",
            kind="object",
            fields=_VmmigrationCutoverJob_ComputeEngineTargetDetailsFields,
        ),
        ...
        "steps": ubx.FieldSpec(
            wire_name="steps",
            kind="list",
            fields=_VmmigrationCutoverJob_StepsFields,
        ),
    },
)
