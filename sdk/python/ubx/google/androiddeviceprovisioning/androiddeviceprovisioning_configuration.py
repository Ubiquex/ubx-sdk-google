...
class AndroiddeviceprovisioningConfigurationConfig:
...
@dataclasses.dataclass
class AndroiddeviceprovisioningConfigurationAttrs:
    # Required. The name of the organization. Zero-touch enrollment shows this organization name to device users during device provisioning.
    company_name: Any = None
    # Output only. The ID of the configuration. Assigned by the server.
    configuration_id: Any = None
...
AndroiddeviceprovisioningConfiguration = ubx.ResourceBinding(
    wire_type="google_androiddeviceprovisioning_androiddeviceprovisioning_configuration",
    fields={
