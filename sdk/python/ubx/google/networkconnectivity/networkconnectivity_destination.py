...
class NetworkconnectivityDestination_Endpoints:
    asn: Any = None
    csp: Any = None
    state: Any = None
...
@dataclasses.dataclass
class NetworkconnectivityDestination_StateTimeline_States:
    effective_time: Any = None
    state: Any = None

@dataclasses.dataclass
class NetworkconnectivityDestination_StateTimeline:
    # Output only. The state and activation time details of the resource state.
    states: Any = None

_NetworkconnectivityDestination_EndpointsFields = {
...
_NetworkconnectivityDestination_StateTimeline_StatesFields = {
    "effective_time": ubx.FieldSpec(wire_name="effective_time"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_NetworkconnectivityDestination_StateTimelineFields = {
    "states": ubx.FieldSpec(
        wire_name="states",
        kind="list",
        fields=_NetworkconnectivityDestination_StateTimeline_StatesFields,
    ),
}

@dataclasses.dataclass
class NetworkconnectivityDestinationConfig:
...
@dataclasses.dataclass
class NetworkconnectivityDestinationAttrs:
    # Output only. Time when the `Destination` resource was created.
    create_time: Any = None
    # Optional. A description of this resource.
    description: Any = None
...
NetworkconnectivityDestination = ubx.ResourceBinding(
    wire_type="google_networkconnectivity_networkconnectivity_destination",
    fields={
        ...
        "endpoints": ubx.FieldSpec(
            wire_name="endpoints",
            kind="list",
            fields=_NetworkconnectivityDestination_EndpointsFields,
        ),
        ...
        "state_timeline": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworkconnectivityDestination_StateTimelineFields,
        ),
