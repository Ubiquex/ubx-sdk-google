...
_ServiceConnectionMap_ConsumerPscConnections_DnsAutomationStatus_ErrorFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_ServiceConnectionMap_ConsumerPscConnections_DnsAutomationStatusFields = {
    "error": ubx.FieldSpec(
        wire_name="error",
        kind="object",
        fields=_ServiceConnectionMap_ConsumerPscConnections_DnsAutomationStatus_ErrorFields,
    ),
    "fqdn": ubx.FieldSpec(wire_name="fqdn"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_ServiceConnectionMap_ConsumerPscConnections_ErrorInfoFields = {
    "domain": ubx.FieldSpec(wire_name="domain"),
    "metadata": ubx.FieldSpec(wire_name="metadata"),
    "reason": ubx.FieldSpec(wire_name="reason"),
}

_ServiceConnectionMap_ConsumerPscConnectionsFields = {
    "dns_automation_status": ubx.FieldSpec(
        wire_name="dns_automation_status",
        kind="object",
        fields=_ServiceConnectionMap_ConsumerPscConnections_DnsAutomationStatusFields,
    ),
    "error": ubx.FieldSpec(
        wire_name="error",
        kind="object",
    ...
    "error_info": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ServiceConnectionMap_ConsumerPscConnections_ErrorInfoFields,
    ),
...
ServiceConnectionMap = ubx.ResourceBinding(
    ...
    fields={
        ...
        "consumer_psc_connections": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ServiceConnectionMap_ConsumerPscConnectionsFields,
        ),
