...
class V1alpha1NetworkconnectivityV1alpha1HubConfig:
...
@dataclasses.dataclass
class V1alpha1NetworkconnectivityV1alpha1HubAttrs:
    # Time when the Hub was created.
    create_time: Any = None
    # Short description of the hub resource.
    description: Any = None
...
V1alpha1NetworkconnectivityV1alpha1Hub = ubx.ResourceBinding(
    wire_type="google_networkconnectivity_v1alpha1_networkconnectivity_v1alpha1_hub",
    fields={
