...
class V1alpha1NetworkconnectivityV1alpha1InternalRange_AllocationOptions:
...
@dataclasses.dataclass
class V1alpha1NetworkconnectivityV1alpha1InternalRange_Migration:
...
_V1alpha1NetworkconnectivityV1alpha1InternalRange_AllocationOptionsFields = {
...
_V1alpha1NetworkconnectivityV1alpha1InternalRange_MigrationFields = {
    "source": ubx.FieldSpec(wire_name="source"),
    "target": ubx.FieldSpec(wire_name="target"),
}

@dataclasses.dataclass
class V1alpha1NetworkconnectivityV1alpha1InternalRangeConfig:
...
@dataclasses.dataclass
class V1alpha1NetworkconnectivityV1alpha1InternalRangeAttrs:
    # Range auto-allocation options, to be optionally used when CIDR block is not explicitly set.
    allocation_options: Any = None
    # Output only. Time when the internal range was created.
    create_time: Any = None
...
V1alpha1NetworkconnectivityV1alpha1InternalRange = ubx.ResourceBinding(
    wire_type="google_networkconnectivity_v1alpha1_networkconnectivity_v1alpha1_internal_range",
    fields={
        "allocation_options": ubx.FieldSpec(
            wire_name="allocation_options",
            kind="object",
            fields=_V1alpha1NetworkconnectivityV1alpha1InternalRange_AllocationOptionsFields,
        ),
        ...
        "migration": ubx.FieldSpec(
            wire_name="migration",
            kind="object",
            fields=_V1alpha1NetworkconnectivityV1alpha1InternalRange_MigrationFields,
        ),
