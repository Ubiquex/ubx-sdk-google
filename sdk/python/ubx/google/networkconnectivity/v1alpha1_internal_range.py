...
class V1alpha1InternalRange_AllocationOptions:
...
@dataclasses.dataclass
class V1alpha1InternalRange_Migration:
...
_V1alpha1InternalRange_AllocationOptionsFields = {
...
_V1alpha1InternalRange_MigrationFields = {
...
V1alpha1InternalRange = ubx.ResourceBinding(
    wire_type="google_networkconnectivity_v1alpha1_internal_range",
    fields={
        ...
        "migration": ubx.FieldSpec(
            wire_name="migration",
            kind="object",
            fields=_V1alpha1InternalRange_MigrationFields,
        ),
