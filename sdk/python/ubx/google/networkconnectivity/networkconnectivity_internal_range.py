...
class NetworkconnectivityInternalRange_AllocationOptions:
...
@dataclasses.dataclass
class NetworkconnectivityInternalRange_Migration:
...
_NetworkconnectivityInternalRange_AllocationOptionsFields = {
...
_NetworkconnectivityInternalRange_MigrationFields = {
    "source": ubx.FieldSpec(wire_name="source"),
    "target": ubx.FieldSpec(wire_name="target"),
}

@dataclasses.dataclass
class NetworkconnectivityInternalRangeConfig:
...
@dataclasses.dataclass
class NetworkconnectivityInternalRangeAttrs:
    # Range auto-allocation options, to be optionally used when CIDR block is not explicitly set.
    allocation_options: Any = None
    # Output only. Time when the internal range was created.
    create_time: Any = None
...
NetworkconnectivityInternalRange = ubx.ResourceBinding(
    wire_type="google_networkconnectivity_networkconnectivity_internal_range",
    fields={
        "allocation_options": ubx.FieldSpec(
            wire_name="allocation_options",
            kind="object",
            fields=_NetworkconnectivityInternalRange_AllocationOptionsFields,
        ),
        ...
        "migration": ubx.FieldSpec(
            wire_name="migration",
            kind="object",
            fields=_NetworkconnectivityInternalRange_MigrationFields,
        ),
