...
class NetworkconnectivityAutomatedDnsRecord_CurrentConfig:
...
_NetworkconnectivityAutomatedDnsRecord_CurrentConfigFields = {
    "rrdatas": ubx.FieldSpec(wire_name="rrdatas"),
    "ttl": ubx.FieldSpec(wire_name="ttl"),
}

@dataclasses.dataclass
class NetworkconnectivityAutomatedDnsRecordConfig:
...
@dataclasses.dataclass
class NetworkconnectivityAutomatedDnsRecordAttrs:
    # Required. Immutable. The full resource path of the consumer network this AutomatedDnsRecord is visible to. Example: "projects/{projectNumOrId}/global/networks/{networkName}".
    consumer_network: Any = None
    # Output only. The timestamp of when the record was created.
    create_time: Any = None
...
NetworkconnectivityAutomatedDnsRecord = ubx.ResourceBinding(
    wire_type="google_networkconnectivity_networkconnectivity_automated_dns_record",
    fields={
        ...
        "current_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_NetworkconnectivityAutomatedDnsRecord_CurrentConfigFields,
        ),
