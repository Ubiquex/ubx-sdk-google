...
class FirebaseappdistributionGroupConfig:
...
@dataclasses.dataclass
class FirebaseappdistributionGroupAttrs:
    # Required. The display name of the group.
    display_name: Any = None
    # Output only. The number of invite links for this group.
    invite_link_count: Any = None
...
FirebaseappdistributionGroup = ubx.ResourceBinding(
    wire_type="google_firebaseappdistribution_firebaseappdistribution_group",
    fields={
