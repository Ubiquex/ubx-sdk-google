...
class V1beta1Release_ApplicationTemplateComponent_CompositeRef:
...
@dataclasses.dataclass
class V1beta1Release_ApplicationTemplateComponent:
...
@dataclasses.dataclass
class V1beta1Release_Blueprint:
...
@dataclasses.dataclass
class V1beta1Release_InputVariableDefaults:
    type: Any = None
    value: Any = None
    variable: Any = None

@dataclasses.dataclass
class V1beta1Release_ReleaseRequirements:
...
_V1beta1Release_ApplicationTemplateComponent_CompositeRefFields = {
...
V1beta1Release = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_v1beta1_release",
    fields={
        ...
        "application_template_component": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1Release_ApplicationTemplateComponentFields,
        ),
        "blueprint": ubx.FieldSpec(
            wire_name="blueprint",
            kind="object",
            fields=_V1beta1Release_BlueprintFields,
        ),
        ...
        "input_variable_defaults": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1beta1Release_InputVariableDefaultsFields,
        ),
        ...
        "release_requirements": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1Release_ReleaseRequirementsFields,
        ),
