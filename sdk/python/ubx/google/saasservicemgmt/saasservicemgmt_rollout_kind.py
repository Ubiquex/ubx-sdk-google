...
class SaasservicemgmtRolloutKind_ErrorBudget:
...
@dataclasses.dataclass
class SaasservicemgmtRolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent:
...
@dataclasses.dataclass
class SaasservicemgmtRolloutKind_UnitUpdatePacing:
...
_SaasservicemgmtRolloutKind_ErrorBudgetFields = {
    "allowed_count": ubx.FieldSpec(wire_name="allowed_count"),
    "allowed_percentage": ubx.FieldSpec(wire_name="allowed_percentage"),
}

_SaasservicemgmtRolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields = {
    "value": ubx.FieldSpec(wire_name="value"),
}

_SaasservicemgmtRolloutKind_UnitUpdatePacingFields = {
    ...
    "max_concurrent_operations_percent": ubx.FieldSpec(
        ...
        kind="object",
        fields=_SaasservicemgmtRolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields,
    ),
}

@dataclasses.dataclass
class SaasservicemgmtRolloutKindConfig:
...
@dataclasses.dataclass
class SaasservicemgmtRolloutKindAttrs:
    # Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
    annotations: Any = None
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
...
SaasservicemgmtRolloutKind = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_saasservicemgmt_rollout_kind",
    fields={
        ...
        "error_budget": ubx.FieldSpec(
            ...
            kind="object",
            fields=_SaasservicemgmtRolloutKind_ErrorBudgetFields,
        ),
        ...
        "unit_update_pacing": ubx.FieldSpec(
            ...
            kind="object",
            fields=_SaasservicemgmtRolloutKind_UnitUpdatePacingFields,
        ),
