...
class Rollout_Control_RunParams:
...
_Rollout_StatsFields = {
    ...
    "operations_by_state": ubx.FieldSpec(
        ...
        kind="list",
        fields=_Rollout_Stats_OperationsByStateFields,
    ),
}
...
Rollout = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_rollout",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "control": ubx.FieldSpec(
            wire_name="control",
            kind="object",
            fields=_Rollout_ControlFields,
        ),
