...
class V1beta1SaasservicemgmtV1beta1RolloutKind_ErrorBudget:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing:
...
_V1beta1SaasservicemgmtV1beta1RolloutKind_ErrorBudgetFields = {
    "allowed_count": ubx.FieldSpec(wire_name="allowed_count"),
    "allowed_percentage": ubx.FieldSpec(wire_name="allowed_percentage"),
}

_V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields = {
    "value": ubx.FieldSpec(wire_name="value"),
}

_V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacingFields = {
    ...
    "max_concurrent_operations_percent": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields,
    ),
}

@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1RolloutKindConfig:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1RolloutKindAttrs:
    # Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
    annotations: Any = None
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
...
V1beta1SaasservicemgmtV1beta1RolloutKind = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_v1beta1_saasservicemgmt_v1beta1_rollout_kind",
    fields={
        ...
        "error_budget": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1SaasservicemgmtV1beta1RolloutKind_ErrorBudgetFields,
        ),
        ...
        "unit_update_pacing": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1SaasservicemgmtV1beta1RolloutKind_UnitUpdatePacingFields,
        ),
