...
class V1beta1Rollout_Control_RunParams:
...
@dataclasses.dataclass
class V1beta1Rollout_Stats_OperationsByState:
    count: Any = None
    group: Any = None

@dataclasses.dataclass
class V1beta1Rollout_Stats:
...
_V1beta1Rollout_StatsFields = {
    ...
    "operations_by_state": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1Rollout_Stats_OperationsByStateFields,
    ),
}

@dataclasses.dataclass
class V1beta1RolloutConfig:
...
V1beta1Rollout = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_v1beta1_rollout",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "control": ubx.FieldSpec(
            wire_name="control",
            kind="object",
            fields=_V1beta1Rollout_ControlFields,
        ),
        ...
        "stats": ubx.FieldSpec(
            wire_name="stats",
            kind="object",
            fields=_V1beta1Rollout_StatsFields,
        ),
