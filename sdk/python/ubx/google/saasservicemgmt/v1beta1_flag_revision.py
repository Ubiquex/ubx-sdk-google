...
class V1beta1FlagRevision_EvaluationSpec_Allocations_Slots:
    variant: Any = None
    weight: Any = None

@dataclasses.dataclass
class V1beta1FlagRevision_EvaluationSpec_Allocations:
...
@dataclasses.dataclass
class V1beta1FlagRevision_EvaluationSpec_Rules:
...
@dataclasses.dataclass
class V1beta1FlagRevision_EvaluationSpec_Variants:
    bool_value: Any = None
...
@dataclasses.dataclass
class V1beta1FlagRevision_EvaluationSpec:
...
@dataclasses.dataclass
class V1beta1FlagRevision_Snapshot_Variants:
...
@dataclasses.dataclass
class V1beta1FlagRevision_Snapshot:
...
_V1beta1FlagRevision_EvaluationSpec_Allocations_SlotsFields = {
    "variant": ubx.FieldSpec(wire_name="variant"),
    "weight": ubx.FieldSpec(wire_name="weight"),
}

_V1beta1FlagRevision_EvaluationSpec_AllocationsFields = {
    ...
    "slots": ubx.FieldSpec(
        wire_name="slots",
        kind="list",
        fields=_V1beta1FlagRevision_EvaluationSpec_Allocations_SlotsFields,
    ),
}

_V1beta1FlagRevision_EvaluationSpec_RulesFields = {
...
_V1beta1FlagRevision_EvaluationSpec_VariantsFields = {
...
_V1beta1FlagRevision_EvaluationSpecFields = {
    "allocations": ubx.FieldSpec(
        wire_name="allocations",
        kind="list",
        fields=_V1beta1FlagRevision_EvaluationSpec_AllocationsFields,
    ),
    ...
    "rules": ubx.FieldSpec(
        wire_name="rules",
        kind="list",
        fields=_V1beta1FlagRevision_EvaluationSpec_RulesFields,
    ),
    "variants": ubx.FieldSpec(
        wire_name="variants",
        kind="list",
        fields=_V1beta1FlagRevision_EvaluationSpec_VariantsFields,
    ),
}

_V1beta1FlagRevision_Snapshot_VariantsFields = {
...
_V1beta1FlagRevision_SnapshotFields = {
    ...
    "evaluation_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1FlagRevision_EvaluationSpecFields,
    ),
    ...
    "variants": ubx.FieldSpec(
        wire_name="variants",
        kind="list",
        fields=_V1beta1FlagRevision_Snapshot_VariantsFields,
    ),
}

@dataclasses.dataclass
class V1beta1FlagRevisionConfig:
    # Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
    annotations: Any = None
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
...
@dataclasses.dataclass
class V1beta1FlagRevisionAttrs:
    # Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
    annotations: Any = None
    # Output only. The timestamp when the resource was created.
    create_time: Any = None
...
V1beta1FlagRevision = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_v1beta1_flag_revision",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "etag": ubx.FieldSpec(wire_name="etag"),
        ...
        "snapshot": ubx.FieldSpec(
            wire_name="snapshot",
            kind="object",
            fields=_V1beta1FlagRevision_SnapshotFields,
        ),
        "uid": ubx.FieldSpec(wire_name="uid"),
        "update_time": ubx.FieldSpec(wire_name="update_time"),
    },
