# Code generated by `ubx sdk gen` from google_saasservicemgmt_v1beta1_tenant. DO NOT EDIT.
...
V1beta1Tenant = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_v1beta1_tenant",
    fields={
