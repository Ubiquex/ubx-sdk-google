...
class V1beta1SaasservicemgmtV1beta1Rollout_Control_RunParams:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1Rollout_Control:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1Rollout_Stats_OperationsByState:
    count: Any = None
    group: Any = None

@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1Rollout_Stats:
...
_V1beta1SaasservicemgmtV1beta1Rollout_Control_RunParamsFields = {
    "retry_failed_operations": ubx.FieldSpec(wire_name="retry_failed_operations"),
}

_V1beta1SaasservicemgmtV1beta1Rollout_ControlFields = {
    "action": ubx.FieldSpec(wire_name="action"),
    "run_params": ubx.FieldSpec(
        wire_name="run_params",
        kind="object",
        fields=_V1beta1SaasservicemgmtV1beta1Rollout_Control_RunParamsFields,
    ),
}

_V1beta1SaasservicemgmtV1beta1Rollout_Stats_OperationsByStateFields = {
    "count": ubx.FieldSpec(wire_name="count"),
    "group": ubx.FieldSpec(wire_name="group"),
}

_V1beta1SaasservicemgmtV1beta1Rollout_StatsFields = {
    ...
    "operations_by_state": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1SaasservicemgmtV1beta1Rollout_Stats_OperationsByStateFields,
    ),
}

@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1RolloutConfig:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1RolloutAttrs:
    # Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
    annotations: Any = None
    # RolloutControl provides a way to request a change to the execution of a Rollout by pausing or canceling it.
    control: Any = None
...
V1beta1SaasservicemgmtV1beta1Rollout = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_v1beta1_saasservicemgmt_v1beta1_rollout",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "control": ubx.FieldSpec(
            wire_name="control",
            kind="object",
            fields=_V1beta1SaasservicemgmtV1beta1Rollout_ControlFields,
        ),
        ...
        "stats": ubx.FieldSpec(
            wire_name="stats",
            kind="object",
            fields=_V1beta1SaasservicemgmtV1beta1Rollout_StatsFields,
        ),
