...
@dataclasses.dataclass
class Unit_Dependencies:
    alias: Any = None
    unit: Any = None

@dataclasses.dataclass
class Unit_InputVariables:
    type: Any = None
    value: Any = None
    variable: Any = None

@dataclasses.dataclass
class Unit_Maintenance:
...
Unit = ubx.ResourceBinding(
    ...
    fields={
        ...
        "input_variables": ubx.FieldSpec(
            ...
            kind="list",
            fields=_Unit_InputVariablesFields,
        ),
        "labels": ubx.FieldSpec(wire_name="labels"),
        "maintenance": ubx.FieldSpec(
            wire_name="maintenance",
            kind="object",
            fields=_Unit_MaintenanceFields,
        ),
