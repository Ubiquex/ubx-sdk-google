...
class SaasservicemgmtSaa_Conditions:
...
@dataclasses.dataclass
class SaasservicemgmtSaa_Error:
...
@dataclasses.dataclass
class SaasservicemgmtSaa_Locations:
    name: Any = None

_SaasservicemgmtSaa_ConditionsFields = {
...
_SaasservicemgmtSaa_ErrorFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_SaasservicemgmtSaa_LocationsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

@dataclasses.dataclass
class SaasservicemgmtSaaConfig:
...
SaasservicemgmtSaa = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_saasservicemgmt_saa",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "conditions": ubx.FieldSpec(
            wire_name="conditions",
            kind="list",
            fields=_SaasservicemgmtSaa_ConditionsFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "error": ubx.FieldSpec(
            wire_name="error",
            kind="object",
            fields=_SaasservicemgmtSaa_ErrorFields,
        ),
        ...
        "locations": ubx.FieldSpec(
            wire_name="locations",
            kind="list",
            fields=_SaasservicemgmtSaa_LocationsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
