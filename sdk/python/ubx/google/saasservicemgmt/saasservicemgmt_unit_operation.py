...
class SaasservicemgmtUnitOperation_Conditions:
...
@dataclasses.dataclass
class SaasservicemgmtUnitOperation_FlagUpdate:
    # Required. Flag release being applied by UnitOperation.
    flag_release: Any = None

@dataclasses.dataclass
class SaasservicemgmtUnitOperation_Provision_InputVariables:
    type: Any = None
    value: Any = None
    variable: Any = None

@dataclasses.dataclass
class SaasservicemgmtUnitOperation_Provision:
...
_SaasservicemgmtUnitOperation_FlagUpdateFields = {
    "flag_release": ubx.FieldSpec(wire_name="flag_release"),
}

_SaasservicemgmtUnitOperation_Provision_InputVariablesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
    "value": ubx.FieldSpec(wire_name="value"),
    "variable": ubx.FieldSpec(wire_name="variable"),
}

_SaasservicemgmtUnitOperation_ProvisionFields = {
    "input_variables": ubx.FieldSpec(
        wire_name="input_variables",
        kind="list",
        fields=_SaasservicemgmtUnitOperation_Provision_InputVariablesFields,
    ),
    "release": ubx.FieldSpec(wire_name="release"),
}

_SaasservicemgmtUnitOperation_ScheduleFields = {
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

@dataclasses.dataclass
class SaasservicemgmtUnitOperationConfig:
...
@dataclasses.dataclass
class SaasservicemgmtUnitOperationAttrs:
    # Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
    annotations: Any = None
    # Optional. When true, attempt to cancel the operation. Cancellation may fail if the operation is already executing. (Optional)
    cancel: Any = None
...
SaasservicemgmtUnitOperation = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_saasservicemgmt_unit_operation",
    fields={
        ...
        "conditions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_SaasservicemgmtUnitOperation_ConditionsFields,
        ),
        ...
        "flag_update": ubx.FieldSpec(
            ...
            kind="object",
            fields=_SaasservicemgmtUnitOperation_FlagUpdateFields,
        ),
        ...
        "provision": ubx.FieldSpec(
            wire_name="provision",
            kind="object",
            fields=_SaasservicemgmtUnitOperation_ProvisionFields,
        ),
        "rollout": ubx.FieldSpec(wire_name="rollout"),
        "schedule": ubx.FieldSpec(
            wire_name="schedule",
            kind="object",
            fields=_SaasservicemgmtUnitOperation_ScheduleFields,
        ),
