...
class V1beta1SaasservicemgmtV1beta1UnitOperation_Conditions:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1UnitOperation_FlagUpdate:
    # Required. Flag release being applied by UnitOperation.
    flag_release: Any = None

@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1UnitOperation_Provision_InputVariables:
    type: Any = None
    value: Any = None
    variable: Any = None

@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1UnitOperation_Provision:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1UnitOperation_Schedule:
    # Optional. Start of operation. If not set, will be set to the start of the next window. (optional)
    start_time: Any = None

_V1beta1SaasservicemgmtV1beta1UnitOperation_ConditionsFields = {
...
_V1beta1SaasservicemgmtV1beta1UnitOperation_FlagUpdateFields = {
    "flag_release": ubx.FieldSpec(wire_name="flag_release"),
}

_V1beta1SaasservicemgmtV1beta1UnitOperation_Provision_InputVariablesFields = {
    "type": ubx.FieldSpec(wire_name="type"),
    "value": ubx.FieldSpec(wire_name="value"),
    "variable": ubx.FieldSpec(wire_name="variable"),
}

_V1beta1SaasservicemgmtV1beta1UnitOperation_ProvisionFields = {
    "input_variables": ubx.FieldSpec(
        wire_name="input_variables",
        kind="list",
        fields=_V1beta1SaasservicemgmtV1beta1UnitOperation_Provision_InputVariablesFields,
    ),
    "release": ubx.FieldSpec(wire_name="release"),
}

_V1beta1SaasservicemgmtV1beta1UnitOperation_ScheduleFields = {
    "start_time": ubx.FieldSpec(wire_name="start_time"),
}

@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1UnitOperationConfig:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1UnitOperationAttrs:
    # Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
    annotations: Any = None
    # Optional. When true, attempt to cancel the operation. Cancellation may fail if the operation is already executing. (Optional)
    cancel: Any = None
...
V1beta1SaasservicemgmtV1beta1UnitOperation = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_v1beta1_saasservicemgmt_v1beta1_unit_operation",
    fields={
        ...
        "conditions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1beta1SaasservicemgmtV1beta1UnitOperation_ConditionsFields,
        ),
        ...
        "flag_update": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1SaasservicemgmtV1beta1UnitOperation_FlagUpdateFields,
        ),
        ...
        "provision": ubx.FieldSpec(
            wire_name="provision",
            kind="object",
            fields=_V1beta1SaasservicemgmtV1beta1UnitOperation_ProvisionFields,
        ),
        "rollout": ubx.FieldSpec(wire_name="rollout"),
        "schedule": ubx.FieldSpec(
            wire_name="schedule",
            kind="object",
            fields=_V1beta1SaasservicemgmtV1beta1UnitOperation_ScheduleFields,
        ),
