...
class V1beta1SaasservicemgmtV1beta1Saa_ApplicationTemplate:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1Saa_Conditions:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1Saa_Error:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1Saa_Locations:
    name: Any = None

_V1beta1SaasservicemgmtV1beta1Saa_ApplicationTemplateFields = {
...
_V1beta1SaasservicemgmtV1beta1Saa_ConditionsFields = {
...
_V1beta1SaasservicemgmtV1beta1Saa_ErrorFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V1beta1SaasservicemgmtV1beta1Saa_LocationsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1SaaConfig:
...
@dataclasses.dataclass
class V1beta1SaasservicemgmtV1beta1SaaAttrs:
    # Optional. Annotations is an unstructured key-value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/user-guide/annotations
    annotations: Any = None
    # CompositeRef represents a reference to a composite resource.
    application_template: Any = None
...
V1beta1SaasservicemgmtV1beta1Saa = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_v1beta1_saasservicemgmt_v1beta1_saa",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "application_template": ubx.FieldSpec(
            wire_name="application_template",
            kind="object",
            fields=_V1beta1SaasservicemgmtV1beta1Saa_ApplicationTemplateFields,
        ),
        "blueprint_repo": ubx.FieldSpec(wire_name="blueprint_repo"),
        "conditions": ubx.FieldSpec(
            wire_name="conditions",
            kind="list",
            fields=_V1beta1SaasservicemgmtV1beta1Saa_ConditionsFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "error": ubx.FieldSpec(
            wire_name="error",
            kind="object",
            fields=_V1beta1SaasservicemgmtV1beta1Saa_ErrorFields,
        ),
        ...
        "locations": ubx.FieldSpec(
            wire_name="locations",
            kind="list",
            fields=_V1beta1SaasservicemgmtV1beta1Saa_LocationsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
