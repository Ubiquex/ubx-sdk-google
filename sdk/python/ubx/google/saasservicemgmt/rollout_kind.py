...
@dataclasses.dataclass
class RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercent:
...
@dataclasses.dataclass
class RolloutKind_UnitUpdatePacing:
...
_RolloutKind_ErrorBudgetFields = {
    "allowed_count": ubx.FieldSpec(wire_name="allowed_count"),
    "allowed_percentage": ubx.FieldSpec(wire_name="allowed_percentage"),
}

_RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields = {
    "value": ubx.FieldSpec(wire_name="value"),
}

_RolloutKind_UnitUpdatePacingFields = {
    ...
    "max_concurrent_operations_percent": ubx.FieldSpec(
        ...
        kind="object",
        fields=_RolloutKind_UnitUpdatePacing_MaxConcurrentOperationsPercentFields,
    ),
}

@dataclasses.dataclass
class RolloutKindConfig:
...
RolloutKind = ubx.ResourceBinding(
    wire_type="google_saasservicemgmt_rollout_kind",
    fields={
        ...
        "error_budget": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RolloutKind_ErrorBudgetFields,
        ),
        ...
        "unit_update_pacing": ubx.FieldSpec(
            ...
            kind="object",
            fields=_RolloutKind_UnitUpdatePacingFields,
        ),
