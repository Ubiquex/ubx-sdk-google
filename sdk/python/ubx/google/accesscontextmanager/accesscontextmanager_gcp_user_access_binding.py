...
class AccesscontextmanagerGcpUserAccessBinding_Principal:
...
@dataclasses.dataclass
class AccesscontextmanagerGcpUserAccessBinding_RestrictedClientApplications:
    client_id: Any = None
    name: Any = None

@dataclasses.dataclass
class AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_ActiveSettings_SessionSettings:
...
@dataclasses.dataclass
class AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_ActiveSettings:
    access_levels: Any = None
    session_settings: Any = None

@dataclasses.dataclass
class AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_Scope_ClientScope_RestrictedProject:
    name: Any = None

@dataclasses.dataclass
class AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_Scope_ClientScope:
    restricted_client_application: Any = None
    restricted_project: Any = None

@dataclasses.dataclass
class AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_Scope:
    client_scope: Any = None

@dataclasses.dataclass
class AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings:
    active_settings: Any = None
    dry_run_settings: Any = None
    scope: Any = None

_AccesscontextmanagerGcpUserAccessBinding_PrincipalFields = {
...
_AccesscontextmanagerGcpUserAccessBinding_RestrictedClientApplicationsFields = {
    "client_id": ubx.FieldSpec(wire_name="client_id"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_ActiveSettings_SessionSettingsFields = {
...
_AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_ActiveSettingsFields = {
    "access_levels": ubx.FieldSpec(wire_name="access_levels"),
    "session_settings": ubx.FieldSpec(
        wire_name="session_settings",
        kind="object",
        fields=_AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_ActiveSettings_SessionSettingsFields,
    ),
}

_AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_Scope_ClientScope_RestrictedProjectFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

_AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_Scope_ClientScopeFields = {
    "restricted_client_application": ubx.FieldSpec(
        wire_name="restricted_client_application",
        kind="object",
        fields=_AccesscontextmanagerGcpUserAccessBinding_RestrictedClientApplicationsFields,
    ),
    "restricted_project": ubx.FieldSpec(
        wire_name="restricted_project",
        kind="object",
        fields=_AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_Scope_ClientScope_RestrictedProjectFields,
    ),
}

_AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_ScopeFields = {
    "client_scope": ubx.FieldSpec(
        wire_name="client_scope",
        kind="object",
        fields=_AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_Scope_ClientScopeFields,
    ),
}

_AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettingsFields = {
    "active_settings": ubx.FieldSpec(
        wire_name="active_settings",
        kind="object",
        fields=_AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_ActiveSettingsFields,
    ),
    ...
    "scope": ubx.FieldSpec(
        wire_name="scope",
        kind="object",
        fields=_AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettings_ScopeFields,
    ),
}
...
@dataclasses.dataclass
class AccesscontextmanagerGcpUserAccessBindingAttrs:
    # Optional. Access level that a user must have to be granted access. Only one access level is supported, not multiple. This repeated field must have exactly one element. Example: "accessPolicies/9522/accessLevels/device_trusted"
    access_levels: Any = None
    # Optional. Dry run access level that will be evaluated but will not be enforced. The access denial based on dry run policy will be logged. Only one access level is supported, not multiple. This list must have exactly one element. Example: "accessPolicies/9522/accessLevels/device_trusted"
    dry_run_access_levels: Any = None
...
AccesscontextmanagerGcpUserAccessBinding = ubx.ResourceBinding(
    wire_type="google_accesscontextmanager_accesscontextmanager_gcp_user_access_binding",
    fields={
        "access_levels": ubx.FieldSpec(wire_name="access_levels"),
        ...
        "principal": ubx.FieldSpec(
            wire_name="principal",
            kind="object",
            fields=_AccesscontextmanagerGcpUserAccessBinding_PrincipalFields,
        ),
        ...
        "scoped_access_settings": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AccesscontextmanagerGcpUserAccessBinding_ScopedAccessSettingsFields,
        ),
        "session_settings": ubx.FieldSpec(
            wire_name="session_settings",
            kind="object",
