...
class AuthorizedOrgsDescConfig:
...
AuthorizedOrgsDesc = ubx.ResourceBinding(
    wire_type="google_accesscontextmanager_authorized_orgs_desc",
    fields={
