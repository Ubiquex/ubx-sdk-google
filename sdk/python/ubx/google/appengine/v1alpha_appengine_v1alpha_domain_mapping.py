...
class V1alphaAppengineV1alphaDomainMapping_ResourceRecords:
    name: Any = None
    rrdata: Any = None
    type: Any = None

@dataclasses.dataclass
class V1alphaAppengineV1alphaDomainMapping_SslSettings:
...
_V1alphaAppengineV1alphaDomainMapping_ResourceRecordsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "rrdata": ubx.FieldSpec(wire_name="rrdata"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_V1alphaAppengineV1alphaDomainMapping_SslSettingsFields = {
...
@dataclasses.dataclass
class V1alphaAppengineV1alphaDomainMappingConfig:
...
@dataclasses.dataclass
class V1alphaAppengineV1alphaDomainMappingAttrs:
    # Relative name of the domain serving the application. Example: example.com.
    id: Any = None
    # Output only. Full path to the DomainMapping resource in the API. Example: apps/myapp/domainMapping/example.com.@OutputOnly
    name: Any = None
...
V1alphaAppengineV1alphaDomainMapping = ubx.ResourceBinding(
    wire_type="google_appengine_v1alpha_appengine_v1alpha_domain_mapping",
    fields={
        ...
        "resource_records": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1alphaAppengineV1alphaDomainMapping_ResourceRecordsFields,
        ),
        "ssl_settings": ubx.FieldSpec(
            wire_name="ssl_settings",
            kind="object",
            fields=_V1alphaAppengineV1alphaDomainMapping_SslSettingsFields,
        ),
    },
)
