...
class V1betaAppengineV1betaDomainMapping_ResourceRecords:
    name: Any = None
    rrdata: Any = None
    type: Any = None

@dataclasses.dataclass
class V1betaAppengineV1betaDomainMapping_SslSettings:
...
_V1betaAppengineV1betaDomainMapping_ResourceRecordsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "rrdata": ubx.FieldSpec(wire_name="rrdata"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_V1betaAppengineV1betaDomainMapping_SslSettingsFields = {
...
@dataclasses.dataclass
class V1betaAppengineV1betaDomainMappingConfig:
...
@dataclasses.dataclass
class V1betaAppengineV1betaDomainMappingAttrs:
    # Relative name of the domain serving the application. Example: example.com.
    id: Any = None
    # Output only. Full path to the DomainMapping resource in the API. Example: apps/myapp/domainMapping/example.com.@OutputOnly
    name: Any = None
...
V1betaAppengineV1betaDomainMapping = ubx.ResourceBinding(
    wire_type="google_appengine_v1beta_appengine_v1beta_domain_mapping",
    fields={
        ...
        "resource_records": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1betaAppengineV1betaDomainMapping_ResourceRecordsFields,
        ),
        "ssl_settings": ubx.FieldSpec(
            wire_name="ssl_settings",
            kind="object",
            fields=_V1betaAppengineV1betaDomainMapping_SslSettingsFields,
        ),
    },
)
