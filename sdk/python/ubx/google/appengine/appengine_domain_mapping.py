...
class AppengineDomainMapping_ResourceRecords:
    name: Any = None
    rrdata: Any = None
    type: Any = None

@dataclasses.dataclass
class AppengineDomainMapping_SslSettings:
...
_AppengineDomainMapping_ResourceRecordsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "rrdata": ubx.FieldSpec(wire_name="rrdata"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_AppengineDomainMapping_SslSettingsFields = {
...
@dataclasses.dataclass
class AppengineDomainMappingConfig:
...
@dataclasses.dataclass
class AppengineDomainMappingAttrs:
    # Relative name of the domain serving the application. Example: example.com.
    id: Any = None
    # Output only. Full path to the DomainMapping resource in the API. Example: apps/myapp/domainMapping/example.com.@OutputOnly
    name: Any = None
...
AppengineDomainMapping = ubx.ResourceBinding(
    wire_type="google_appengine_appengine_domain_mapping",
    fields={
        ...
        "resource_records": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AppengineDomainMapping_ResourceRecordsFields,
        ),
        "ssl_settings": ubx.FieldSpec(
            wire_name="ssl_settings",
            kind="object",
            fields=_AppengineDomainMapping_SslSettingsFields,
        ),
    },
)
