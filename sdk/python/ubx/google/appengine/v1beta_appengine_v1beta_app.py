...
class V1betaAppengineV1betaApp_DispatchRules:
    domain: Any = None
    path: Any = None
    service: Any = None

@dataclasses.dataclass
class V1betaAppengineV1betaApp_FeatureSettings:
...
@dataclasses.dataclass
class V1betaAppengineV1betaApp_Iap:
...
_V1betaAppengineV1betaApp_IapFields = {
...
@dataclasses.dataclass
class V1betaAppengineV1betaAppConfig:
...
@dataclasses.dataclass
class V1betaAppengineV1betaAppAttrs:
    # Google Apps authentication domain that controls which users can access this application.Defaults to open access for any Google Account.
    auth_domain: Any = None
    # Output only. Google Cloud Storage bucket that can be used for storing files associated with this application. This bucket is associated with the application and can be used by the gcloud deployment commands.@OutputOnly
    code_bucket: Any = None
...
V1betaAppengineV1betaApp = ubx.ResourceBinding(
    wire_type="google_appengine_v1beta_appengine_v1beta_app",
    fields={
        ...
        "dispatch_rules": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1betaAppengineV1betaApp_DispatchRulesFields,
        ),
        "feature_settings": ubx.FieldSpec(
            wire_name="feature_settings",
            kind="object",
            fields=_V1betaAppengineV1betaApp_FeatureSettingsFields,
        ),
        ...
        "iap": ubx.FieldSpec(
            wire_name="iap",
            kind="object",
            fields=_V1betaAppengineV1betaApp_IapFields,
        ),
