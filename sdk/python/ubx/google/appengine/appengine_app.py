...
class AppengineApp_DispatchRules:
    domain: Any = None
    path: Any = None
    service: Any = None

@dataclasses.dataclass
class AppengineApp_FeatureSettings:
...
AppengineApp = ubx.ResourceBinding(
    wire_type="google_appengine_appengine_app",
    fields={
        ...
        "dispatch_rules": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AppengineApp_DispatchRulesFields,
        ),
        "feature_settings": ubx.FieldSpec(
            wire_name="feature_settings",
            kind="object",
            fields=_AppengineApp_FeatureSettingsFields,
        ),
        ...
        "iap": ubx.FieldSpec(
            wire_name="iap",
            kind="object",
            fields=_AppengineApp_IapFields,
        ),
