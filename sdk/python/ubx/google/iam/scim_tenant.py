# Code generated by `ubx sdk gen` from google_iam_scim_tenant. DO NOT EDIT.
...
ScimTenant = ubx.ResourceBinding(
    wire_type="google_iam_scim_tenant",
    fields={
