...
class IamProvider_ExtendedAttributesOauth2Client_ClientSecret_Value:
...
@dataclasses.dataclass
class IamProvider_ExtendedAttributesOauth2Client_ClientSecret:
    # Representation of the value of the client secret.
    value: Any = None

@dataclasses.dataclass
class IamProvider_ExtendedAttributesOauth2Client_QueryParameters:
...
@dataclasses.dataclass
class IamProvider_ExtendedAttributesOauth2Client:
...
@dataclasses.dataclass
class IamProvider_Oidc_WebSsoConfig:
...
_IamProvider_ExtendedAttributesOauth2Client_ClientSecret_ValueFields = {
    "plain_text": ubx.FieldSpec(wire_name="plain_text"),
    "thumbprint": ubx.FieldSpec(wire_name="thumbprint"),
}

_IamProvider_ExtendedAttributesOauth2Client_ClientSecretFields = {
    "value": ubx.FieldSpec(
        wire_name="value",
        kind="object",
        fields=_IamProvider_ExtendedAttributesOauth2Client_ClientSecret_ValueFields,
    ),
}

_IamProvider_ExtendedAttributesOauth2Client_QueryParametersFields = {
    "filter": ubx.FieldSpec(wire_name="filter"),
}

_IamProvider_ExtendedAttributesOauth2ClientFields = {
    ...
    "client_secret": ubx.FieldSpec(
        ...
        kind="object",
        fields=_IamProvider_ExtendedAttributesOauth2Client_ClientSecretFields,
    ),
    "issuer_uri": ubx.FieldSpec(wire_name="issuer_uri"),
    "query_parameters": ubx.FieldSpec(
        wire_name="query_parameters",
        kind="object",
        fields=_IamProvider_ExtendedAttributesOauth2Client_QueryParametersFields,
    ),
}

_IamProvider_Oidc_WebSsoConfigFields = {
...
_IamProvider_OidcFields = {
    ...
    "web_sso_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_IamProvider_Oidc_WebSsoConfigFields,
    ),
}

_IamProvider_SamlFields = {
    "idp_metadata_xml": ubx.FieldSpec(wire_name="idp_metadata_xml"),
}

@dataclasses.dataclass
class IamProviderConfig:
...
IamProvider = ubx.ResourceBinding(
    wire_type="google_iam_iam_provider",
    fields={
        ...
        "extended_attributes_oauth2_client": ubx.FieldSpec(
            ...
            kind="object",
            fields=_IamProvider_ExtendedAttributesOauth2ClientFields,
        ),
        ...
        "oidc": ubx.FieldSpec(
            wire_name="oidc",
            kind="object",
            fields=_IamProvider_OidcFields,
        ),
        "saml": ubx.FieldSpec(
            wire_name="saml",
            kind="object",
            fields=_IamProvider_SamlFields,
        ),
