...
class V2betaPolicy_Rules_DenyRule_DenialCondition:
...
@dataclasses.dataclass
class V2betaPolicy_Rules_DenyRule:
...
@dataclasses.dataclass
class V2betaPolicy_Rules:
    deny_rule: Any = None
    description: Any = None

_V2betaPolicy_Rules_DenyRule_DenialConditionFields = {
...
_V2betaPolicy_Rules_DenyRuleFields = {
    "denial_condition": ubx.FieldSpec(
        wire_name="denial_condition",
        kind="object",
        fields=_V2betaPolicy_Rules_DenyRule_DenialConditionFields,
    ),
...
_V2betaPolicy_RulesFields = {
    "deny_rule": ubx.FieldSpec(
        wire_name="deny_rule",
        kind="object",
        fields=_V2betaPolicy_Rules_DenyRuleFields,
    ),
    "description": ubx.FieldSpec(wire_name="description"),
}
...
V2betaPolicy = ubx.ResourceBinding(
