...
class IamWorkforcePool_AccessRestrictions_AllowedServices:
    domain: Any = None

@dataclasses.dataclass
class IamWorkforcePool_AccessRestrictions:
...
_IamWorkforcePool_AccessRestrictions_AllowedServicesFields = {
    "domain": ubx.FieldSpec(wire_name="domain"),
}

_IamWorkforcePool_AccessRestrictionsFields = {
    "allowed_services": ubx.FieldSpec(
        wire_name="allowed_services",
        kind="list",
        fields=_IamWorkforcePool_AccessRestrictions_AllowedServicesFields,
    ),
    "disable_programmatic_signin": ubx.FieldSpec(wire_name="disable_programmatic_signin"),
}

@dataclasses.dataclass
class IamWorkforcePoolConfig:
...
IamWorkforcePool = ubx.ResourceBinding(
    wire_type="google_iam_iam_workforce_pool",
    fields={
        "access_restrictions": ubx.FieldSpec(
            wire_name="access_restrictions",
            kind="object",
            fields=_IamWorkforcePool_AccessRestrictionsFields,
        ),
