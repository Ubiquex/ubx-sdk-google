...
class V2betaIamV2betaPolicy_Rules_DenyRule_DenialCondition:
...
@dataclasses.dataclass
class V2betaIamV2betaPolicy_Rules_DenyRule:
...
@dataclasses.dataclass
class V2betaIamV2betaPolicy_Rules:
    deny_rule: Any = None
    description: Any = None

_V2betaIamV2betaPolicy_Rules_DenyRule_DenialConditionFields = {
...
_V2betaIamV2betaPolicy_Rules_DenyRuleFields = {
    "denial_condition": ubx.FieldSpec(
        wire_name="denial_condition",
        kind="object",
        fields=_V2betaIamV2betaPolicy_Rules_DenyRule_DenialConditionFields,
    ),
...
_V2betaIamV2betaPolicy_RulesFields = {
    "deny_rule": ubx.FieldSpec(
        wire_name="deny_rule",
        kind="object",
        fields=_V2betaIamV2betaPolicy_Rules_DenyRuleFields,
    ),
    "description": ubx.FieldSpec(wire_name="description"),
}

@dataclasses.dataclass
class V2betaIamV2betaPolicyConfig:
...
@dataclasses.dataclass
class V2betaIamV2betaPolicyAttrs:
    # A key-value map to store arbitrary metadata for the `Policy`. Keys can be up to 63 characters. Values can be up to 255 characters.
    annotations: Any = None
    # Output only. The time when the `Policy` was created.
    create_time: Any = None
...
V2betaIamV2betaPolicy = ubx.ResourceBinding(
    wire_type="google_iam_v2beta_iam_v2beta_policy",
    fields={
        ...
        "rules": ubx.FieldSpec(
            wire_name="rules",
            kind="list",
            fields=_V2betaIamV2betaPolicy_RulesFields,
        ),
