...
class FirebasedataconnectService_Connectors_ClientCache:
    entity_id_included: Any = None
    strict_validation_enabled: Any = None

@dataclasses.dataclass
class FirebasedataconnectService_Connectors_Source_Files:
    content: Any = None
    path: Any = None

@dataclasses.dataclass
class FirebasedataconnectService_Connectors_Source:
    files: Any = None

@dataclasses.dataclass
class FirebasedataconnectService_Connectors:
...
@dataclasses.dataclass
class FirebasedataconnectService_Schemas_Datasources_HttpGraphql:
    timeout: Any = None
    uri: Any = None

@dataclasses.dataclass
class FirebasedataconnectService_Schemas_Datasources_Postgresql_CloudSql:
    edition: Any = None
    instance: Any = None

@dataclasses.dataclass
class FirebasedataconnectService_Schemas_Datasources_Postgresql:
    cloud_sql: Any = None
    database: Any = None
    ephemeral: Any = None
    schema: Any = None
...
@dataclasses.dataclass
class FirebasedataconnectService_Schemas_Datasources:
    http_graphql: Any = None
    postgresql: Any = None

@dataclasses.dataclass
class FirebasedataconnectService_Schemas:
    annotations: Any = None
    create_time: Any = None
...
_FirebasedataconnectService_Connectors_ClientCacheFields = {
...
_FirebasedataconnectService_Connectors_Source_FilesFields = {
    "content": ubx.FieldSpec(wire_name="content"),
    "path": ubx.FieldSpec(wire_name="path"),
}

_FirebasedataconnectService_Connectors_SourceFields = {
    "files": ubx.FieldSpec(
        wire_name="files",
        kind="list",
        fields=_FirebasedataconnectService_Connectors_Source_FilesFields,
    ),
}

_FirebasedataconnectService_ConnectorsFields = {
    "annotations": ubx.FieldSpec(wire_name="annotations"),
    "client_cache": ubx.FieldSpec(
        wire_name="client_cache",
        kind="object",
        fields=_FirebasedataconnectService_Connectors_ClientCacheFields,
    ),
    ...
    "source": ubx.FieldSpec(
        wire_name="source",
        kind="object",
        fields=_FirebasedataconnectService_Connectors_SourceFields,
    ),
    "uid": ubx.FieldSpec(wire_name="uid"),
    "update_time": ubx.FieldSpec(wire_name="update_time"),
}

_FirebasedataconnectService_Schemas_Datasources_HttpGraphqlFields = {
    "timeout": ubx.FieldSpec(wire_name="timeout"),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_FirebasedataconnectService_Schemas_Datasources_Postgresql_CloudSqlFields = {
    "edition": ubx.FieldSpec(wire_name="edition"),
    "instance": ubx.FieldSpec(wire_name="instance"),
}

_FirebasedataconnectService_Schemas_Datasources_PostgresqlFields = {
    "cloud_sql": ubx.FieldSpec(
        wire_name="cloud_sql",
        kind="object",
        fields=_FirebasedataconnectService_Schemas_Datasources_Postgresql_CloudSqlFields,
    ),
...
_FirebasedataconnectService_Schemas_DatasourcesFields = {
    "http_graphql": ubx.FieldSpec(
        wire_name="http_graphql",
        kind="object",
        fields=_FirebasedataconnectService_Schemas_Datasources_HttpGraphqlFields,
    ),
    "postgresql": ubx.FieldSpec(
        wire_name="postgresql",
        kind="object",
        fields=_FirebasedataconnectService_Schemas_Datasources_PostgresqlFields,
    ),
}

_FirebasedataconnectService_SchemasFields = {
    "annotations": ubx.FieldSpec(wire_name="annotations"),
    "create_time": ubx.FieldSpec(wire_name="create_time"),
    "datasources": ubx.FieldSpec(
        wire_name="datasources",
        kind="list",
        fields=_FirebasedataconnectService_Schemas_DatasourcesFields,
    ),
    "display_name": ubx.FieldSpec(wire_name="display_name"),
    "etag": ubx.FieldSpec(wire_name="etag"),
    "labels": ubx.FieldSpec(wire_name="labels"),
...
@dataclasses.dataclass
class FirebasedataconnectServiceConfig:
...
@dataclasses.dataclass
class FirebasedataconnectServiceAttrs:
    # Optional. Stores small amounts of arbitrary data.
    annotations: Any = None
    # Output only. The list of connectors in this service.
    connectors: Any = None
...
FirebasedataconnectService = ubx.ResourceBinding(
    wire_type="google_firebasedataconnect_firebasedataconnect_service",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "connectors": ubx.FieldSpec(
            wire_name="connectors",
            kind="list",
            fields=_FirebasedataconnectService_ConnectorsFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        "etag": ubx.FieldSpec(wire_name="etag"),
        ...
        "schemas": ubx.FieldSpec(
            wire_name="schemas",
            kind="list",
            fields=_FirebasedataconnectService_SchemasFields,
        ),
        "source": ubx.FieldSpec(
            wire_name="source",
            kind="object",
