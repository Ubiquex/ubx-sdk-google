...
class V1betaFirebasedataconnectV1betaConnector_ClientCache:
...
@dataclasses.dataclass
class V1betaFirebasedataconnectV1betaConnector_Source_Files:
    content: Any = None
    path: Any = None

@dataclasses.dataclass
class V1betaFirebasedataconnectV1betaConnector_Source:
    # Required. The files that comprise the source set.
    files: Any = None

_V1betaFirebasedataconnectV1betaConnector_ClientCacheFields = {
...
_V1betaFirebasedataconnectV1betaConnector_Source_FilesFields = {
    "content": ubx.FieldSpec(wire_name="content"),
    "path": ubx.FieldSpec(wire_name="path"),
}

_V1betaFirebasedataconnectV1betaConnector_SourceFields = {
    "files": ubx.FieldSpec(
        wire_name="files",
        kind="list",
        fields=_V1betaFirebasedataconnectV1betaConnector_Source_FilesFields,
    ),
}

@dataclasses.dataclass
class V1betaFirebasedataconnectV1betaConnectorConfig:
...
@dataclasses.dataclass
class V1betaFirebasedataconnectV1betaConnectorAttrs:
    # Optional. Stores small amounts of arbitrary data.
    annotations: Any = None
    # Client caching settings of a connector.
    client_cache: Any = None
...
V1betaFirebasedataconnectV1betaConnector = ubx.ResourceBinding(
    wire_type="google_firebasedataconnect_v1beta_firebasedataconnect_v1beta_connector",
    fields={
        "annotations": ubx.FieldSpec(wire_name="annotations"),
        "client_cache": ubx.FieldSpec(
            wire_name="client_cache",
            kind="object",
            fields=_V1betaFirebasedataconnectV1betaConnector_ClientCacheFields,
        ),
        ...
        "source": ubx.FieldSpec(
            wire_name="source",
            kind="object",
            fields=_V1betaFirebasedataconnectV1betaConnector_SourceFields,
        ),
