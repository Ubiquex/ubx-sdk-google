...
@dataclasses.dataclass
class Connector_Source:
    # Required. The files that comprise the source set.
    files: Any = None

_Connector_ClientCacheFields = {
...
_Connector_Source_FilesFields = {
    "content": ubx.FieldSpec(wire_name="content"),
    "path": ubx.FieldSpec(wire_name="path"),
}

_Connector_SourceFields = {
    "files": ubx.FieldSpec(
        wire_name="files",
        kind="list",
        fields=_Connector_Source_FilesFields,
    ),
}
...
Connector = ubx.ResourceBinding(
    wire_type="google_firebasedataconnect_connector",
    fields={
