...
class FirebasedataconnectSchema_Datasources_HttpGraphql:
    timeout: Any = None
    uri: Any = None

@dataclasses.dataclass
class FirebasedataconnectSchema_Datasources_Postgresql_CloudSql:
    edition: Any = None
    instance: Any = None

@dataclasses.dataclass
class FirebasedataconnectSchema_Datasources_Postgresql:
    cloud_sql: Any = None
    database: Any = None
    ephemeral: Any = None
    schema: Any = None
...
@dataclasses.dataclass
class FirebasedataconnectSchema_Datasources:
    http_graphql: Any = None
    postgresql: Any = None

@dataclasses.dataclass
class FirebasedataconnectSchema_Source_Files:
    content: Any = None
    path: Any = None

@dataclasses.dataclass
class FirebasedataconnectSchema_Source:
    # Required. The files that comprise the source set.
    files: Any = None

_FirebasedataconnectSchema_Datasources_HttpGraphqlFields = {
    "timeout": ubx.FieldSpec(wire_name="timeout"),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_FirebasedataconnectSchema_Datasources_Postgresql_CloudSqlFields = {
    "edition": ubx.FieldSpec(wire_name="edition"),
    "instance": ubx.FieldSpec(wire_name="instance"),
}

_FirebasedataconnectSchema_Datasources_PostgresqlFields = {
    "cloud_sql": ubx.FieldSpec(
        wire_name="cloud_sql",
        kind="object",
        fields=_FirebasedataconnectSchema_Datasources_Postgresql_CloudSqlFields,
    ),
...
_FirebasedataconnectSchema_DatasourcesFields = {
    "http_graphql": ubx.FieldSpec(
        wire_name="http_graphql",
        kind="object",
        fields=_FirebasedataconnectSchema_Datasources_HttpGraphqlFields,
    ),
    "postgresql": ubx.FieldSpec(
        wire_name="postgresql",
        kind="object",
        fields=_FirebasedataconnectSchema_Datasources_PostgresqlFields,
    ),
}

_FirebasedataconnectSchema_Source_FilesFields = {
    "content": ubx.FieldSpec(wire_name="content"),
    "path": ubx.FieldSpec(wire_name="path"),
}

_FirebasedataconnectSchema_SourceFields = {
    "files": ubx.FieldSpec(
        wire_name="files",
        kind="list",
        fields=_FirebasedataconnectSchema_Source_FilesFields,
    ),
}

@dataclasses.dataclass
class FirebasedataconnectSchemaConfig:
...
@dataclasses.dataclass
class FirebasedataconnectSchemaAttrs:
    # Optional. Stores small amounts of arbitrary data.
    annotations: Any = None
    # Output only. [Output only] Create time stamp.
    create_time: Any = None
...
FirebasedataconnectSchema = ubx.ResourceBinding(
    wire_type="google_firebasedataconnect_firebasedataconnect_schema",
    fields={
        ...
        "datasources": ubx.FieldSpec(
            ...
            kind="list",
            fields=_FirebasedataconnectSchema_DatasourcesFields,
        ),
        ...
        "source": ubx.FieldSpec(
            wire_name="source",
            kind="object",
            fields=_FirebasedataconnectSchema_SourceFields,
        ),
