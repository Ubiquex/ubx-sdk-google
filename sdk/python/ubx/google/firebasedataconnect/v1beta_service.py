...
_V1betaService_Connectors_ClientCacheFields = {
...
_V1betaService_Schemas_Datasources_HttpGraphqlFields = {
    "timeout": ubx.FieldSpec(wire_name="timeout"),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_V1betaService_Schemas_Datasources_Postgresql_CloudSqlFields = {
    "edition": ubx.FieldSpec(wire_name="edition"),
    "instance": ubx.FieldSpec(wire_name="instance"),
}

_V1betaService_Schemas_Datasources_PostgresqlFields = {
    "cloud_sql": ubx.FieldSpec(
        wire_name="cloud_sql",
        kind="object",
        fields=_V1betaService_Schemas_Datasources_Postgresql_CloudSqlFields,
    ),
...
_V1betaService_Schemas_DatasourcesFields = {
    "http_graphql": ubx.FieldSpec(
        wire_name="http_graphql",
        kind="object",
        fields=_V1betaService_Schemas_Datasources_HttpGraphqlFields,
    ),
    "postgresql": ubx.FieldSpec(
        wire_name="postgresql",
        kind="object",
        fields=_V1betaService_Schemas_Datasources_PostgresqlFields,
    ),
}

_V1betaService_SchemasFields = {
    "annotations": ubx.FieldSpec(wire_name="annotations"),
    "create_time": ubx.FieldSpec(wire_name="create_time"),
    "datasources": ubx.FieldSpec(
        wire_name="datasources",
        kind="list",
        fields=_V1betaService_Schemas_DatasourcesFields,
    ),
    "display_name": ubx.FieldSpec(wire_name="display_name"),
    "etag": ubx.FieldSpec(wire_name="etag"),
    "labels": ubx.FieldSpec(wire_name="labels"),
...
V1betaService = ubx.ResourceBinding(
    ...
    fields={
        ...
        "connectors": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1betaService_ConnectorsFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        "etag": ubx.FieldSpec(wire_name="etag"),
        ...
        "schemas": ubx.FieldSpec(
            wire_name="schemas",
            kind="list",
            fields=_V1betaService_SchemasFields,
        ),
        "source": ubx.FieldSpec(
            wire_name="source",
            kind="object",
