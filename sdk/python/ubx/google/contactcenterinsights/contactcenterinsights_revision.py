...
class ContactcenterinsightsRevision_Snapshot:
...
_ContactcenterinsightsRevision_SnapshotFields = {
...
@dataclasses.dataclass
class ContactcenterinsightsRevisionConfig:
...
@dataclasses.dataclass
class ContactcenterinsightsRevisionAttrs:
    # Output only. Alternative IDs for this revision of the scorecard, e.g., `latest`.
    alternate_ids: Any = None
    # Output only. The timestamp that the revision was created.
    create_time: Any = None
...
ContactcenterinsightsRevision = ubx.ResourceBinding(
    wire_type="google_contactcenterinsights_contactcenterinsights_revision",
    fields={
        ...
        "snapshot": ubx.FieldSpec(
            wire_name="snapshot",
            kind="object",
            fields=_ContactcenterinsightsRevision_SnapshotFields,
        ),
