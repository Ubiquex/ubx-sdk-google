...
class ContactcenterinsightsFeedbackLabel_QaAnswerLabel:
    # Boolean value.
    bool_value: Any = None
...
_ContactcenterinsightsFeedbackLabel_QaAnswerLabelFields = {
...
@dataclasses.dataclass
class ContactcenterinsightsFeedbackLabelConfig:
...
@dataclasses.dataclass
class ContactcenterinsightsFeedbackLabelAttrs:
    # Output only. Create time of the label.
    create_time: Any = None
    # String label used for Topic Modeling.
    label: Any = None
...
ContactcenterinsightsFeedbackLabel = ubx.ResourceBinding(
    wire_type="google_contactcenterinsights_contactcenterinsights_feedback_label",
    fields={
        ...
        "qa_answer_label": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ContactcenterinsightsFeedbackLabel_QaAnswerLabelFields,
        ),
