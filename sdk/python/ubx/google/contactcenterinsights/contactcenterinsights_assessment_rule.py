...
class ContactcenterinsightsAssessmentRule_SampleRule:
...
@dataclasses.dataclass
class ContactcenterinsightsAssessmentRule_ScheduleInfo:
...
_ContactcenterinsightsAssessmentRule_SampleRuleFields = {
...
_ContactcenterinsightsAssessmentRule_ScheduleInfoFields = {
...
@dataclasses.dataclass
class ContactcenterinsightsAssessmentRuleConfig:
...
@dataclasses.dataclass
class ContactcenterinsightsAssessmentRuleAttrs:
    # If true, apply this rule to conversations. Otherwise, this rule is inactive.
    active: Any = None
    # Output only. The time at which this assessment rule was created.
    create_time: Any = None
...
ContactcenterinsightsAssessmentRule = ubx.ResourceBinding(
    wire_type="google_contactcenterinsights_contactcenterinsights_assessment_rule",
    fields={
        ...
        "sample_rule": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ContactcenterinsightsAssessmentRule_SampleRuleFields,
        ),
        "schedule_info": ubx.FieldSpec(
            wire_name="schedule_info",
            kind="object",
            fields=_ContactcenterinsightsAssessmentRule_ScheduleInfoFields,
        ),
