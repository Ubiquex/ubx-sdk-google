...
class V1beta1DataformV1beta1TeamFolderConfig:
...
@dataclasses.dataclass
class V1beta1DataformV1beta1TeamFolderAttrs:
    # Output only. The timestamp of when the TeamFolder was created.
    create_time: Any = None
    # Output only. The IAM principal identifier of the creator of the TeamFolder.
    creator_iam_principal: Any = None
...
V1beta1DataformV1beta1TeamFolder = ubx.ResourceBinding(
    wire_type="google_dataform_v1beta1_dataform_v1beta1_team_folder",
    fields={
