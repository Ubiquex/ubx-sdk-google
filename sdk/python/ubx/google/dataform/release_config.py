...
class ReleaseConfig_CodeCompilationConfig_DefaultNotebookRuntimeOptions_GcsRepositorySnapshotDestination:
...
@dataclasses.dataclass
class ReleaseConfig_CodeCompilationConfig_DefaultNotebookRuntimeOptions:
...
@dataclasses.dataclass
class ReleaseConfig_CodeCompilationConfig_PipelineConfig:
...
@dataclasses.dataclass
class ReleaseConfig_CodeCompilationConfig:
...
_ReleaseConfig_CodeCompilationConfig_DefaultNotebookRuntimeOptionsFields = {
    ...
    "gcs_repository_snapshot_destination": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ReleaseConfig_CodeCompilationConfig_DefaultNotebookRuntimeOptions_GcsRepositorySnapshotDestinationFields,
    ),
}

_ReleaseConfig_CodeCompilationConfig_PipelineConfigFields = {
    "path": ubx.FieldSpec(wire_name="path"),
    "pipeline_type": ubx.FieldSpec(wire_name="pipeline_type"),
}

_ReleaseConfig_CodeCompilationConfigFields = {
    ...
    "default_notebook_runtime_options": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ReleaseConfig_CodeCompilationConfig_DefaultNotebookRuntimeOptionsFields,
    ),
    "default_schema": ubx.FieldSpec(wire_name="default_schema"),
    "pipeline_config": ubx.FieldSpec(
        wire_name="pipeline_config",
        kind="object",
        fields=_ReleaseConfig_CodeCompilationConfig_PipelineConfigFields,
    ),
...
ReleaseConfig = ubx.ResourceBinding(
    wire_type="google_dataform_release_config",
    fields={
        "code_compilation_config": ubx.FieldSpec(
            wire_name="code_compilation_config",
            kind="object",
            fields=_ReleaseConfig_CodeCompilationConfigFields,
        ),
