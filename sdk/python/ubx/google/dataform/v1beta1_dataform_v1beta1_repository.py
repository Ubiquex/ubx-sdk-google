...
class V1beta1DataformV1beta1Repository_DataEncryptionState:
    # Required. The KMS key version name with which data of a resource is encrypted.
    kms_key_version_name: Any = None

@dataclasses.dataclass
class V1beta1DataformV1beta1Repository_GitRemoteSettings_SshAuthenticationConfig:
...
@dataclasses.dataclass
class V1beta1DataformV1beta1Repository_GitRemoteSettings:
...
@dataclasses.dataclass
class V1beta1DataformV1beta1Repository_WorkspaceCompilationOverrides:
...
_V1beta1DataformV1beta1Repository_DataEncryptionStateFields = {
    "kms_key_version_name": ubx.FieldSpec(wire_name="kms_key_version_name"),
}

_V1beta1DataformV1beta1Repository_GitRemoteSettings_SshAuthenticationConfigFields = {
...
_V1beta1DataformV1beta1Repository_GitRemoteSettingsFields = {
    ...
    "ssh_authentication_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1DataformV1beta1Repository_GitRemoteSettings_SshAuthenticationConfigFields,
    ),
    "token_status": ubx.FieldSpec(wire_name="token_status"),
    "url": ubx.FieldSpec(wire_name="url"),
}

_V1beta1DataformV1beta1Repository_WorkspaceCompilationOverridesFields = {
...
@dataclasses.dataclass
class V1beta1DataformV1beta1RepositoryConfig:
...
@dataclasses.dataclass
class V1beta1DataformV1beta1RepositoryAttrs:
    # Optional. The name of the containing folder of the repository. The field is immutable and it can be modified via a MoveRepository operation. Format: `projects/*/locations/*/folders/*`. or `projects/*/locations/*/teamFolders/*`.
    containing_folder: Any = None
    # Output only. The timestamp of when the repository was created.
    create_time: Any = None
...
V1beta1DataformV1beta1Repository = ubx.ResourceBinding(
    wire_type="google_dataform_v1beta1_dataform_v1beta1_repository",
    fields={
        ...
        "data_encryption_state": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1DataformV1beta1Repository_DataEncryptionStateFields,
        ),
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        "git_remote_settings": ubx.FieldSpec(
            wire_name="git_remote_settings",
            kind="object",
            fields=_V1beta1DataformV1beta1Repository_GitRemoteSettingsFields,
        ),
        ...
        "workspace_compilation_overrides": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1DataformV1beta1Repository_WorkspaceCompilationOverridesFields,
        ),
    },
)
