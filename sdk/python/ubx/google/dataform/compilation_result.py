...
class CompilationResult_CodeCompilationConfig_DefaultNotebookRuntimeOptions_GcsRepositorySnapshotDestination:
...
@dataclasses.dataclass
class CompilationResult_CodeCompilationConfig_DefaultNotebookRuntimeOptions:
...
@dataclasses.dataclass
class CompilationResult_CodeCompilationConfig_PipelineConfig:
...
@dataclasses.dataclass
class CompilationResult_PrivateResourceMetadata:
...
_CompilationResult_CodeCompilationConfig_DefaultNotebookRuntimeOptions_GcsRepositorySnapshotDestinationFields = {
    "repository_snapshot_uri": ubx.FieldSpec(wire_name="repository_snapshot_uri"),
}

_CompilationResult_CodeCompilationConfig_DefaultNotebookRuntimeOptionsFields = {
    ...
    "gcs_repository_snapshot_destination": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CompilationResult_CodeCompilationConfig_DefaultNotebookRuntimeOptions_GcsRepositorySnapshotDestinationFields,
    ),
}

_CompilationResult_CodeCompilationConfig_PipelineConfigFields = {
    "path": ubx.FieldSpec(wire_name="path"),
    "pipeline_type": ubx.FieldSpec(wire_name="pipeline_type"),
}

_CompilationResult_CodeCompilationConfigFields = {
    ...
    "default_notebook_runtime_options": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CompilationResult_CodeCompilationConfig_DefaultNotebookRuntimeOptionsFields,
    ),
    "default_schema": ubx.FieldSpec(wire_name="default_schema"),
    "pipeline_config": ubx.FieldSpec(
        wire_name="pipeline_config",
        kind="object",
        fields=_CompilationResult_CodeCompilationConfig_PipelineConfigFields,
    ),
...
_CompilationResult_GcsRepositorySnapshotMetadataFields = {
    "crc32c_checksum": ubx.FieldSpec(wire_name="crc32c_checksum"),
    "generation": ubx.FieldSpec(wire_name="generation"),
    "repository_snapshot_uri": ubx.FieldSpec(wire_name="repository_snapshot_uri"),
}

_CompilationResult_PrivateResourceMetadataFields = {
...
CompilationResult = ubx.ResourceBinding(
    wire_type="google_dataform_compilation_result",
    fields={
