...
class DataformWorkflowConfig_InvocationConfig_IncludedTargets:
    database: Any = None
    name: Any = None
    schema: Any = None

@dataclasses.dataclass
class DataformWorkflowConfig_InvocationConfig:
...
@dataclasses.dataclass
class DataformWorkflowConfig_RecentScheduledExecutionRecords_ErrorStatus:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class DataformWorkflowConfig_RecentScheduledExecutionRecords:
    error_status: Any = None
    execution_time: Any = None
    workflow_invocation: Any = None

_DataformWorkflowConfig_InvocationConfig_IncludedTargetsFields = {
    "database": ubx.FieldSpec(wire_name="database"),
    "name": ubx.FieldSpec(wire_name="name"),
    "schema": ubx.FieldSpec(wire_name="schema"),
}

_DataformWorkflowConfig_InvocationConfigFields = {
    ...
    "included_targets": ubx.FieldSpec(
        ...
        kind="list",
        fields=_DataformWorkflowConfig_InvocationConfig_IncludedTargetsFields,
    ),
...
_DataformWorkflowConfig_RecentScheduledExecutionRecords_ErrorStatusFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_DataformWorkflowConfig_RecentScheduledExecutionRecordsFields = {
    "error_status": ubx.FieldSpec(
        wire_name="error_status",
        kind="object",
        fields=_DataformWorkflowConfig_RecentScheduledExecutionRecords_ErrorStatusFields,
    ),
...
@dataclasses.dataclass
class DataformWorkflowConfigConfig:
...
@dataclasses.dataclass
class DataformWorkflowConfigAttrs:
    # Output only. The timestamp of when the WorkflowConfig was created.
    create_time: Any = None
    # Optional. Optional schedule (in cron format) for automatic execution of this workflow config.
    cron_schedule: Any = None
...
DataformWorkflowConfig = ubx.ResourceBinding(
    wire_type="google_dataform_dataform_workflow_config",
    fields={
        ...
        "invocation_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DataformWorkflowConfig_InvocationConfigFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "recent_scheduled_execution_records": ubx.FieldSpec(
            wire_name="recent_scheduled_execution_records",
            kind="list",
            fields=_DataformWorkflowConfig_RecentScheduledExecutionRecordsFields,
        ),
