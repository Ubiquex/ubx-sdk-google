...
class V1beta1DataformV1beta1Workspace_DataEncryptionState:
    # Required. The KMS key version name with which data of a resource is encrypted.
    kms_key_version_name: Any = None

@dataclasses.dataclass
class V1beta1DataformV1beta1Workspace_PrivateResourceMetadata:
...
_V1beta1DataformV1beta1Workspace_DataEncryptionStateFields = {
    "kms_key_version_name": ubx.FieldSpec(wire_name="kms_key_version_name"),
}

_V1beta1DataformV1beta1Workspace_PrivateResourceMetadataFields = {
    "user_scoped": ubx.FieldSpec(wire_name="user_scoped"),
}

@dataclasses.dataclass
class V1beta1DataformV1beta1WorkspaceConfig:
...
@dataclasses.dataclass
class V1beta1DataformV1beta1WorkspaceAttrs:
    # Output only. The timestamp of when the workspace was created.
    create_time: Any = None
    # Describes encryption state of a resource.
    data_encryption_state: Any = None
...
V1beta1DataformV1beta1Workspace = ubx.ResourceBinding(
    wire_type="google_dataform_v1beta1_dataform_v1beta1_workspace",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "data_encryption_state": ubx.FieldSpec(
            wire_name="data_encryption_state",
            kind="object",
            fields=_V1beta1DataformV1beta1Workspace_DataEncryptionStateFields,
        ),
        ...
        "private_resource_metadata": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1DataformV1beta1Workspace_PrivateResourceMetadataFields,
        ),
