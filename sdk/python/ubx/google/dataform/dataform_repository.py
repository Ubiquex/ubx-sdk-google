...
class DataformRepository_DataEncryptionState:
    # Required. The KMS key version name with which data of a resource is encrypted.
    kms_key_version_name: Any = None

@dataclasses.dataclass
class DataformRepository_GitRemoteSettings_SshAuthenticationConfig:
...
@dataclasses.dataclass
class DataformRepository_GitRemoteSettings:
...
@dataclasses.dataclass
class DataformRepository_WorkspaceCompilationOverrides:
...
_DataformRepository_DataEncryptionStateFields = {
    "kms_key_version_name": ubx.FieldSpec(wire_name="kms_key_version_name"),
}

_DataformRepository_GitRemoteSettings_SshAuthenticationConfigFields = {
...
_DataformRepository_GitRemoteSettingsFields = {
    ...
    "ssh_authentication_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_DataformRepository_GitRemoteSettings_SshAuthenticationConfigFields,
    ),
    "token_status": ubx.FieldSpec(wire_name="token_status"),
    "url": ubx.FieldSpec(wire_name="url"),
}

_DataformRepository_WorkspaceCompilationOverridesFields = {
...
@dataclasses.dataclass
class DataformRepositoryConfig:
...
DataformRepository = ubx.ResourceBinding(
    wire_type="google_dataform_dataform_repository",
    fields={
        ...
        "data_encryption_state": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DataformRepository_DataEncryptionStateFields,
        ),
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        "git_remote_settings": ubx.FieldSpec(
            wire_name="git_remote_settings",
            kind="object",
            fields=_DataformRepository_GitRemoteSettingsFields,
        ),
        ...
        "workspace_compilation_overrides": ubx.FieldSpec(
            ...
            kind="object",
            fields=_DataformRepository_WorkspaceCompilationOverridesFields,
        ),
    },
)
