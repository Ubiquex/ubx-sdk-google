...
class ApigeeCanaryevaluation_MetricLabels:
...
_ApigeeCanaryevaluation_MetricLabelsFields = {
...
@dataclasses.dataclass
class ApigeeCanaryevaluationConfig:
...
@dataclasses.dataclass
class ApigeeCanaryevaluationAttrs:
    # Required. The stable version that is serving requests.
    control: Any = None
    # Output only. Create time of the canary evaluation.
    create_time: Any = None
...
ApigeeCanaryevaluation = ubx.ResourceBinding(
    wire_type="google_apigee_apigee_canaryevaluation",
    fields={
        ...
        "metric_labels": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ApigeeCanaryevaluation_MetricLabelsFields,
        ),
