...
class ApigeeHostSecurityReport_Metrics:
...
@dataclasses.dataclass
class ApigeeHostSecurityReport_QueryParams:
...
@dataclasses.dataclass
class ApigeeHostSecurityReport_Result:
...
_ApigeeHostSecurityReport_MetricsFields = {
...
@dataclasses.dataclass
class ApigeeHostSecurityReportConfig:
...
@dataclasses.dataclass
class ApigeeHostSecurityReportAttrs:
...
ApigeeHostSecurityReport = ubx.ResourceBinding(
    wire_type="google_apigee_apigee_host_security_report",
    fields={
        ...
        "metrics": ubx.FieldSpec(
            wire_name="metrics",
            kind="list",
            fields=_ApigeeHostSecurityReport_MetricsFields,
        ),
