...
HostQuery = ubx.ResourceBinding(
    wire_type="google_apigee_host_query",
    fields={
        ...
        "metrics": ubx.FieldSpec(
            wire_name="metrics",
            kind="list",
            fields=_HostQuery_MetricsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
