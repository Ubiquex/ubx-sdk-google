...
class ApigeeSecurityProfilesV2_ProfileAssessmentConfigs_Include:
    gateway_types: Any = None

@dataclasses.dataclass
class ApigeeSecurityProfilesV2_ProfileAssessmentConfigs:
    include: Any = None
    weight: Any = None

_ApigeeSecurityProfilesV2_ProfileAssessmentConfigs_IncludeFields = {
    "gateway_types": ubx.FieldSpec(wire_name="gateway_types"),
}

_ApigeeSecurityProfilesV2_ProfileAssessmentConfigsFields = {
    "include": ubx.FieldSpec(
        wire_name="include",
        kind="object",
        fields=_ApigeeSecurityProfilesV2_ProfileAssessmentConfigs_IncludeFields,
    ),
    "weight": ubx.FieldSpec(wire_name="weight"),
}

@dataclasses.dataclass
class ApigeeSecurityProfilesV2Config:
...
@dataclasses.dataclass
class ApigeeSecurityProfilesV2Attrs:
    # Output only. The time of the security profile creation.
    create_time: Any = None
    # Optional. The description of the security profile.
    description: Any = None
...
ApigeeSecurityProfilesV2 = ubx.ResourceBinding(
    wire_type="google_apigee_apigee_security_profiles_v2",
    fields={
        ...
        "profile_assessment_configs": ubx.FieldSpec(
            ...
            kind="map",
            fields=_ApigeeSecurityProfilesV2_ProfileAssessmentConfigsFields,
        ),
