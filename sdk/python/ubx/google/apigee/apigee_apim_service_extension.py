...
class ApigeeApimServiceExtension_Extensions:
    fail_open: Any = None
    hostname: Any = None
...
@dataclasses.dataclass
class ApigeeApimServiceExtension_NetworkConfigs:
    region: Any = None
    subnet: Any = None

_ApigeeApimServiceExtension_ExtensionsFields = {
...
_ApigeeApimServiceExtension_NetworkConfigsFields = {
    "region": ubx.FieldSpec(wire_name="region"),
    "subnet": ubx.FieldSpec(wire_name="subnet"),
}

@dataclasses.dataclass
class ApigeeApimServiceExtensionConfig:
...
@dataclasses.dataclass
class ApigeeApimServiceExtensionAttrs:
    # Output only. The time that this resource was created on the server.
    create_time: Any = None
    # Required. Name of the proxy deployed in the Apigee X instance.
    extension_processor: Any = None
...
ApigeeApimServiceExtension = ubx.ResourceBinding(
    wire_type="google_apigee_apigee_apim_service_extension",
    fields={
        ...
        "extensions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ApigeeApimServiceExtension_ExtensionsFields,
        ),
        ...
        "network_configs": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ApigeeApimServiceExtension_NetworkConfigsFields,
        ),
