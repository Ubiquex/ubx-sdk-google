...
class HostSecurityReport_Metrics:
...
@dataclasses.dataclass
class HostSecurityReport_QueryParams:
...
@dataclasses.dataclass
class HostSecurityReport_Result:
...
_HostSecurityReport_MetricsFields = {
...
@dataclasses.dataclass
class HostSecurityReportConfig:
...
HostSecurityReport = ubx.ResourceBinding(
    wire_type="google_apigee_host_security_report",
    fields={
        ...
        "metrics": ubx.FieldSpec(
            wire_name="metrics",
            kind="list",
            fields=_HostSecurityReport_MetricsFields,
        ),
