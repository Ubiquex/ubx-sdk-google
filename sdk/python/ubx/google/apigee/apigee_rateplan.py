...
class ApigeeRateplan_ConsumptionPricingRates_Fee:
    currency_code: Any = None
    nanos: Any = None
    units: Any = None

@dataclasses.dataclass
class ApigeeRateplan_ConsumptionPricingRates:
    end: Any = None
    fee: Any = None
    start: Any = None

@dataclasses.dataclass
class ApigeeRateplan_RevenueShareRates:
    end: Any = None
    share_percentage: Any = None
    start: Any = None

_ApigeeRateplan_ConsumptionPricingRates_FeeFields = {
...
_ApigeeRateplan_ConsumptionPricingRatesFields = {
    "end": ubx.FieldSpec(wire_name="end"),
    "fee": ubx.FieldSpec(
        wire_name="fee",
        kind="object",
        fields=_ApigeeRateplan_ConsumptionPricingRates_FeeFields,
    ),
    "start": ubx.FieldSpec(wire_name="start"),
}

_ApigeeRateplan_RevenueShareRatesFields = {
    "end": ubx.FieldSpec(wire_name="end"),
...
ApigeeRateplan = ubx.ResourceBinding(
    wire_type="google_apigee_apigee_rateplan",
    fields={
        ...
        "consumption_pricing_rates": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ApigeeRateplan_ConsumptionPricingRatesFields,
        ),
        ...
        "revenue_share_rates": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ApigeeRateplan_RevenueShareRatesFields,
        ),
