...
class ApigeeSecurityAction_ConditionConfig:
...
@dataclasses.dataclass
class ApigeeSecurityAction_Deny:
    # Optional. The HTTP response code if the Action = DENY.
    response_code: Any = None

@dataclasses.dataclass
class ApigeeSecurityAction_Flag_Headers:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class ApigeeSecurityAction_Flag:
...
_ApigeeSecurityAction_ConditionConfigFields = {
...
_ApigeeSecurityAction_DenyFields = {
    "response_code": ubx.FieldSpec(wire_name="response_code"),
}

_ApigeeSecurityAction_Flag_HeadersFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_ApigeeSecurityAction_FlagFields = {
    "headers": ubx.FieldSpec(
        wire_name="headers",
        kind="list",
        fields=_ApigeeSecurityAction_Flag_HeadersFields,
    ),
}

@dataclasses.dataclass
class ApigeeSecurityActionConfig:
...
@dataclasses.dataclass
class ApigeeSecurityActionAttrs:
    # Message that should be set in case of an Allow Action. This does not have any fields.
    allow: Any = None
    # Optional. If unset, this would apply to all proxies in the environment. If set, this action is enforced only if at least one proxy in the repeated list is deployed at the time of enforcement. If set, several restrictions are enforced on SecurityActions. There can be at most 100 enabled actions with proxies set in an env. Several other restrictions apply on conditions and are detailed later.
    api_proxies: Any = None
...
ApigeeSecurityAction = ubx.ResourceBinding(
    wire_type="google_apigee_apigee_security_action",
    fields={
        ...
        "condition_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ApigeeSecurityAction_ConditionConfigFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "deny": ubx.FieldSpec(
            wire_name="deny",
            kind="object",
            fields=_ApigeeSecurityAction_DenyFields,
        ),
        ...
        "flag": ubx.FieldSpec(
            wire_name="flag",
            kind="object",
            fields=_ApigeeSecurityAction_FlagFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
