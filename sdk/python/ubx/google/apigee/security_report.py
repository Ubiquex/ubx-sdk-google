...
@dataclasses.dataclass
class SecurityReport_QueryParams:
...
SecurityReport = ubx.ResourceBinding(
    wire_type="google_apigee_security_report",
    fields={
        ...
        "metrics": ubx.FieldSpec(
            wire_name="metrics",
            kind="list",
            fields=_SecurityReport_MetricsFields,
        ),
