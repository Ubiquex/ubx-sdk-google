# Code generated by `ubx sdk gen` from google_apigee_apigee_apidoc. DO NOT EDIT.
...
ApigeeApidoc = ubx.ResourceBinding(
    wire_type="google_apigee_apigee_apidoc",
    fields={
