...
class ApigeeAppgroup_Attributes:
    name: Any = None
    value: Any = None

_ApigeeAppgroup_AttributesFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class ApigeeAppgroupConfig:
...
ApigeeAppgroup = ubx.ResourceBinding(
    wire_type="google_apigee_apigee_appgroup",
    fields={
        "app_group_id": ubx.FieldSpec(wire_name="app_group_id"),
        "attributes": ubx.FieldSpec(
            wire_name="attributes",
            kind="list",
            fields=_ApigeeAppgroup_AttributesFields,
        ),
