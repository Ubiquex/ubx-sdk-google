...
class ApigeeAliase_CertsInfo_CertInfo:
...
@dataclasses.dataclass
class ApigeeAliase_CertsInfo:
    # Chain of certificates under this name.
    cert_info: Any = None

@dataclasses.dataclass
class ApigeeAliaseConfig:
...
ApigeeAliase = ubx.ResourceBinding(
    wire_type="google_apigee_apigee_aliase",
    fields={
