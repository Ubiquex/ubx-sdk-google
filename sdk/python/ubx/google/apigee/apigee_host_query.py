...
@dataclasses.dataclass
class ApigeeHostQuery_QueryParams:
...
_ApigeeHostQuery_MetricsFields = {
...
ApigeeHostQuery = ubx.ResourceBinding(
    wire_type="google_apigee_apigee_host_query",
    fields={
        ...
        "metrics": ubx.FieldSpec(
            wire_name="metrics",
            kind="list",
            fields=_ApigeeHostQuery_MetricsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
