...
class CloudkmsProposal_AddQuorumMember:
...
@dataclasses.dataclass
class CloudkmsProposal_QuorumParameters_Challenges:
    challenge: Any = None
    public_key_pem: Any = None

@dataclasses.dataclass
class CloudkmsProposal_QuorumParameters:
...
@dataclasses.dataclass
class CloudkmsProposal_RegisterTwoFactorAuthKeys:
...
@dataclasses.dataclass
class CloudkmsProposal_RequiredActionQuorumParameters:
    # Output only. The public keys associated with the 2FA keys that have already approved the SingleTenantHsmInstanceProposal by signing the challenge.
    approved_two_factor_public_key_pems: Any = None
    # Output only. The challenges to be signed by 2FA keys for quorum auth. M of N of these challenges are required to be signed to approve the operation.
...
@dataclasses.dataclass
class CloudkmsProposal_UpgradeKeyTrust:
...
_CloudkmsProposal_QuorumParametersFields = {
    ...
    "challenges": ubx.FieldSpec(
        ...
        kind="list",
        fields=_CloudkmsProposal_QuorumParameters_ChallengesFields,
    ),
    "required_approver_count": ubx.FieldSpec(wire_name="required_approver_count"),
}

_CloudkmsProposal_RegisterTwoFactorAuthKeysFields = {
    "required_approver_count": ubx.FieldSpec(wire_name="required_approver_count"),
    "two_factor_public_key_pems": ubx.FieldSpec(wire_name="two_factor_public_key_pems"),
}

_CloudkmsProposal_RequiredActionQuorumParametersFields = {
    "approved_two_factor_public_key_pems": ubx.FieldSpec(wire_name="approved_two_factor_public_key_pems"),
...
_CloudkmsProposal_UpgradeKeyTrustFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "two_factor_public_key_pem": ubx.FieldSpec(wire_name="two_factor_public_key_pem"),
}

@dataclasses.dataclass
class CloudkmsProposalConfig:
...
CloudkmsProposal = ubx.ResourceBinding(
    wire_type="google_cloudkms_cloudkms_proposal",
    fields={
        "add_quorum_member": ubx.FieldSpec(
            wire_name="add_quorum_member",
            kind="object",
            fields=_CloudkmsProposal_AddQuorumMemberFields,
        ),
        ...
        "quorum_parameters": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CloudkmsProposal_QuorumParametersFields,
        ),
        ...
        "register_two_factor_auth_keys": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CloudkmsProposal_RegisterTwoFactorAuthKeysFields,
        ),
        ...
        "required_action_quorum_parameters": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CloudkmsProposal_RequiredActionQuorumParametersFields,
        ),
        ...
        "upgrade_key_trust": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CloudkmsProposal_UpgradeKeyTrustFields,
        ),
    },
)
