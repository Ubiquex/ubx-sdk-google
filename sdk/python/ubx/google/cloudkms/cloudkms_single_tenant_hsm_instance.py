...
class CloudkmsSingleTenantHsmInstance_QuorumAuth:
...
_CloudkmsSingleTenantHsmInstance_QuorumAuthFields = {
...
@dataclasses.dataclass
class CloudkmsSingleTenantHsmInstanceConfig:
...
@dataclasses.dataclass
class CloudkmsSingleTenantHsmInstanceAttrs:
    # Output only. The time at which the SingleTenantHsmInstance was created.
    create_time: Any = None
    # Output only. The time at which the SingleTenantHsmInstance was deleted.
    delete_time: Any = None
...
CloudkmsSingleTenantHsmInstance = ubx.ResourceBinding(
    wire_type="google_cloudkms_cloudkms_single_tenant_hsm_instance",
    fields={
        ...
        "quorum_auth": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CloudkmsSingleTenantHsmInstance_QuorumAuthFields,
        ),
