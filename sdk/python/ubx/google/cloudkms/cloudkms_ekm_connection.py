...
class CloudkmsEkmConnection_ServiceResolvers_ServerCertificates:
    issuer: Any = None
...
@dataclasses.dataclass
class CloudkmsEkmConnection_ServiceResolvers:
    endpoint_filter: Any = None
    hostname: Any = None
    server_certificates: Any = None
    service_directory_service: Any = None

_CloudkmsEkmConnection_ServiceResolvers_ServerCertificatesFields = {
...
_CloudkmsEkmConnection_ServiceResolversFields = {
    ...
    "server_certificates": ubx.FieldSpec(
        ...
        kind="list",
        fields=_CloudkmsEkmConnection_ServiceResolvers_ServerCertificatesFields,
    ),
    "service_directory_service": ubx.FieldSpec(wire_name="service_directory_service"),
}

@dataclasses.dataclass
class CloudkmsEkmConnectionConfig:
...
@dataclasses.dataclass
class CloudkmsEkmConnectionAttrs:
    # Output only. The time at which the EkmConnection was created.
    create_time: Any = None
    # Optional. Identifies the EKM Crypto Space that this EkmConnection maps to. Note: This field is required if KeyManagementMode is CLOUD_KMS.
    crypto_space_path: Any = None
...
CloudkmsEkmConnection = ubx.ResourceBinding(
    wire_type="google_cloudkms_cloudkms_ekm_connection",
    fields={
        ...
        "service_resolvers": ubx.FieldSpec(
            ...
            kind="list",
            fields=_CloudkmsEkmConnection_ServiceResolversFields,
        ),
    },
)
