...
class CloudkmsCryptoKeyVersion_Attestation_CertChains:
...
@dataclasses.dataclass
class CloudkmsCryptoKeyVersion_Attestation:
...
@dataclasses.dataclass
class CloudkmsCryptoKeyVersion_ExternalProtectionLevelOptions:
...
_CloudkmsCryptoKeyVersion_Attestation_CertChainsFields = {
...
_CloudkmsCryptoKeyVersion_AttestationFields = {
    "cert_chains": ubx.FieldSpec(
        wire_name="cert_chains",
        kind="object",
        fields=_CloudkmsCryptoKeyVersion_Attestation_CertChainsFields,
    ),
    "content": ubx.FieldSpec(wire_name="content"),
    "format": ubx.FieldSpec(wire_name="format"),
}

_CloudkmsCryptoKeyVersion_ExternalProtectionLevelOptionsFields = {
...
@dataclasses.dataclass
class CloudkmsCryptoKeyVersionConfig:
...
@dataclasses.dataclass
class CloudkmsCryptoKeyVersionAttrs:
    # Output only. The CryptoKeyVersionAlgorithm that this CryptoKeyVersion supports.
    algorithm: Any = None
    # Contains an HSM-generated attestation about a key operation. For more information, see [Verifying attestations] (https://cloud.google.com/kms/docs/attest-key).
    attestation: Any = None
...
CloudkmsCryptoKeyVersion = ubx.ResourceBinding(
    wire_type="google_cloudkms_cloudkms_crypto_key_version",
    fields={
        "algorithm": ubx.FieldSpec(wire_name="algorithm"),
        "attestation": ubx.FieldSpec(
            wire_name="attestation",
            kind="object",
            fields=_CloudkmsCryptoKeyVersion_AttestationFields,
        ),
        ...
        "external_protection_level_options": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CloudkmsCryptoKeyVersion_ExternalProtectionLevelOptionsFields,
        ),
