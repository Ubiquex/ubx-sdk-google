...
class ImportJob_Attestation_CertChains:
...
_ImportJob_Attestation_CertChainsFields = {
...
ImportJob = ubx.ResourceBinding(
    wire_type="google_cloudkms_import_job",
    fields={
