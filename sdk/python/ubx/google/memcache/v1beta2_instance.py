...
class V1beta2Instance_InstanceMessages:
    code: Any = None
    message: Any = None

@dataclasses.dataclass
class V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTime:
    hours: Any = None
    minutes: Any = None
    nanos: Any = None
    seconds: Any = None
...
@dataclasses.dataclass
class V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindow:
    day: Any = None
    duration: Any = None
    start_time: Any = None

@dataclasses.dataclass
class V1beta2Instance_MaintenancePolicy:
...
@dataclasses.dataclass
class V1beta2Instance_MaintenanceSchedule:
...
@dataclasses.dataclass
class V1beta2Instance_MemcacheNodes_Parameters:
    id: Any = None
    params: Any = None

@dataclasses.dataclass
class V1beta2Instance_MemcacheNodes:
    host: Any = None
...
@dataclasses.dataclass
class V1beta2Instance_NodeConfig:
    # Required. Number of cpus per Memcached node.
    cpu_count: Any = None
    # Required. Memory size in MiB for each Memcached node.
    memory_size_mb: Any = None

_V1beta2Instance_InstanceMessagesFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTimeFields = {
...
_V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindowFields = {
    "day": ubx.FieldSpec(wire_name="day"),
    "duration": ubx.FieldSpec(wire_name="duration"),
    "start_time": ubx.FieldSpec(
        wire_name="start_time",
        kind="object",
        fields=_V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindow_StartTimeFields,
    ),
}

_V1beta2Instance_MaintenancePolicyFields = {
    ...
    "weekly_maintenance_window": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta2Instance_MaintenancePolicy_WeeklyMaintenanceWindowFields,
    ),
}

_V1beta2Instance_MaintenanceScheduleFields = {
...
_V1beta2Instance_MemcacheNodes_ParametersFields = {
    "id": ubx.FieldSpec(wire_name="id"),
    "params": ubx.FieldSpec(wire_name="params"),
}

_V1beta2Instance_MemcacheNodesFields = {
    ...
    "parameters": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta2Instance_MemcacheNodes_ParametersFields,
    ),
...
V1beta2Instance = ubx.ResourceBinding(
    wire_type="google_memcache_v1beta2_instance",
    fields={
        ...
        "instance_messages": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1beta2Instance_InstanceMessagesFields,
        ),
        "labels": ubx.FieldSpec(wire_name="labels"),
        "maintenance_policy": ubx.FieldSpec(
            wire_name="maintenance_policy",
            kind="object",
            fields=_V1beta2Instance_MaintenancePolicyFields,
        ),
        "maintenance_schedule": ubx.FieldSpec(
            wire_name="maintenance_schedule",
            kind="object",
            fields=_V1beta2Instance_MaintenanceScheduleFields,
        ),
        ...
        "memcache_nodes": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1beta2Instance_MemcacheNodesFields,
        ),
        "memcache_version": ubx.FieldSpec(wire_name="memcache_version"),
        ...
        "node_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta2Instance_NodeConfigFields,
        ),
