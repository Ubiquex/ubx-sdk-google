...
class TpuNode_AcceleratorConfig:
...
@dataclasses.dataclass
class TpuNode_NetworkEndpoints_AccessConfig:
    external_ip: Any = None

@dataclasses.dataclass
class TpuNode_NetworkEndpoints:
    access_config: Any = None
    ip_address: Any = None
    port: Any = None

@dataclasses.dataclass
class TpuNode_SchedulingConfig:
...
@dataclasses.dataclass
class TpuNode_ShieldedInstanceConfig:
    # Defines whether the instance has Secure Boot enabled.
    enable_secure_boot: Any = None

@dataclasses.dataclass
class TpuNode_Symptoms:
...
@dataclasses.dataclass
class TpuNode_UpcomingMaintenance:
...
_TpuNode_UpcomingMaintenanceFields = {
...
TpuNode = ubx.ResourceBinding(
    wire_type="google_tpu_tpu_node",
    fields={
        "accelerator_config": ubx.FieldSpec(
            wire_name="accelerator_config",
            kind="object",
            fields=_TpuNode_AcceleratorConfigFields,
        ),
        ...
        "boot_disk_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_TpuNode_BootDiskConfigFields,
        ),
        ...
        "data_disks": ubx.FieldSpec(
            ...
            kind="list",
            fields=_TpuNode_DataDisksFields,
        ),
        ...
        "network_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_TpuNode_NetworkConfigFields,
        ),
        ...
        "network_endpoints": ubx.FieldSpec(
            ...
            kind="list",
            fields=_TpuNode_NetworkEndpointsFields,
        ),
