...
class V2alpha1TpuV2alpha1Node_AcceleratorConfig:
...
@dataclasses.dataclass
class V2alpha1TpuV2alpha1Node_BootDiskConfig_CustomerEncryptionKey:
    # The name of the encryption key that is stored in Google Cloud KMS. For example: "kmsKeyName": "projects/KMS_PROJECT_ID/locations/REGION/keyRings/KEY_REGION/cryptoKeys/KEY The fully-qualifed key name may be returned for resource GET requests. For example: "kmsKeyName": "projects/KMS_PROJECT_ID/locations/REGION/keyRings/KEY_REGION/cryptoKeys/KEY/cryptoKeyVersions/1
    kms_key_name: Any = None

@dataclasses.dataclass
class V2alpha1TpuV2alpha1Node_BootDiskConfig:
...
@dataclasses.dataclass
class V2alpha1TpuV2alpha1Node_DataDisks:
    mode: Any = None
    source_disk: Any = None
    worker_ids: Any = None

@dataclasses.dataclass
class V2alpha1TpuV2alpha1Node_NetworkConfig:
...
@dataclasses.dataclass
class V2alpha1TpuV2alpha1Node_NetworkEndpoints_AccessConfig:
    external_ip: Any = None

@dataclasses.dataclass
class V2alpha1TpuV2alpha1Node_NetworkEndpoints:
    access_config: Any = None
    ip_address: Any = None
    port: Any = None

@dataclasses.dataclass
class V2alpha1TpuV2alpha1Node_SchedulingConfig:
...
@dataclasses.dataclass
class V2alpha1TpuV2alpha1Node_ServiceAccount:
...
@dataclasses.dataclass
class V2alpha1TpuV2alpha1Node_ShieldedInstanceConfig:
    # Defines whether the instance has Secure Boot enabled.
    enable_secure_boot: Any = None

@dataclasses.dataclass
class V2alpha1TpuV2alpha1Node_Symptoms:
...
@dataclasses.dataclass
class V2alpha1TpuV2alpha1Node_UpcomingMaintenance:
...
_V2alpha1TpuV2alpha1Node_AcceleratorConfigFields = {
    "topology": ubx.FieldSpec(wire_name="topology"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_V2alpha1TpuV2alpha1Node_BootDiskConfig_CustomerEncryptionKeyFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

_V2alpha1TpuV2alpha1Node_BootDiskConfigFields = {
    "customer_encryption_key": ubx.FieldSpec(
        wire_name="customer_encryption_key",
        kind="object",
        fields=_V2alpha1TpuV2alpha1Node_BootDiskConfig_CustomerEncryptionKeyFields,
    ),
...
_V2alpha1TpuV2alpha1Node_DataDisksFields = {
...
_V2alpha1TpuV2alpha1Node_NetworkConfigFields = {
...
_V2alpha1TpuV2alpha1Node_NetworkEndpoints_AccessConfigFields = {
    "external_ip": ubx.FieldSpec(wire_name="external_ip"),
}

_V2alpha1TpuV2alpha1Node_NetworkEndpointsFields = {
    "access_config": ubx.FieldSpec(
        wire_name="access_config",
        kind="object",
        fields=_V2alpha1TpuV2alpha1Node_NetworkEndpoints_AccessConfigFields,
    ),
    "ip_address": ubx.FieldSpec(wire_name="ip_address"),
    "port": ubx.FieldSpec(wire_name="port"),
}

_V2alpha1TpuV2alpha1Node_SchedulingConfigFields = {
...
_V2alpha1TpuV2alpha1Node_ServiceAccountFields = {
    "email": ubx.FieldSpec(wire_name="email"),
    "scope": ubx.FieldSpec(wire_name="scope"),
}

_V2alpha1TpuV2alpha1Node_ShieldedInstanceConfigFields = {
    "enable_secure_boot": ubx.FieldSpec(wire_name="enable_secure_boot"),
}

_V2alpha1TpuV2alpha1Node_SymptomsFields = {
...
_V2alpha1TpuV2alpha1Node_UpcomingMaintenanceFields = {
...
@dataclasses.dataclass
class V2alpha1TpuV2alpha1NodeConfig:
...
@dataclasses.dataclass
class V2alpha1TpuV2alpha1NodeAttrs:
    # A TPU accelerator configuration.
    accelerator_config: Any = None
    # The type of hardware accelerators associated with this node.
    accelerator_type: Any = None
...
V2alpha1TpuV2alpha1Node = ubx.ResourceBinding(
    wire_type="google_tpu_v2alpha1_tpu_v2alpha1_node",
    fields={
        "accelerator_config": ubx.FieldSpec(
            wire_name="accelerator_config",
            kind="object",
            fields=_V2alpha1TpuV2alpha1Node_AcceleratorConfigFields,
        ),
        ...
        "boot_disk_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V2alpha1TpuV2alpha1Node_BootDiskConfigFields,
        ),
        ...
        "data_disks": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V2alpha1TpuV2alpha1Node_DataDisksFields,
        ),
        ...
        "network_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V2alpha1TpuV2alpha1Node_NetworkConfigFields,
        ),
        ...
        "network_endpoints": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V2alpha1TpuV2alpha1Node_NetworkEndpointsFields,
        ),
        ...
        "scheduling_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V2alpha1TpuV2alpha1Node_SchedulingConfigFields,
        ),
        "service_account": ubx.FieldSpec(
            wire_name="service_account",
            kind="object",
            fields=_V2alpha1TpuV2alpha1Node_ServiceAccountFields,
        ),
        "shielded_instance_config": ubx.FieldSpec(
            wire_name="shielded_instance_config",
            kind="object",
            fields=_V2alpha1TpuV2alpha1Node_ShieldedInstanceConfigFields,
        ),
        "state": ubx.FieldSpec(wire_name="state"),
        "symptoms": ubx.FieldSpec(
            wire_name="symptoms",
            kind="list",
            fields=_V2alpha1TpuV2alpha1Node_SymptomsFields,
        ),
        "tags": ubx.FieldSpec(wire_name="tags"),
        "upcoming_maintenance": ubx.FieldSpec(
            wire_name="upcoming_maintenance",
            kind="object",
            fields=_V2alpha1TpuV2alpha1Node_UpcomingMaintenanceFields,
        ),
    },
)
