...
class V1alpha1TpuV1alpha1Node_NetworkEndpoints:
    ip_address: Any = None
    port: Any = None

@dataclasses.dataclass
class V1alpha1TpuV1alpha1Node_SchedulingConfig:
...
@dataclasses.dataclass
class V1alpha1TpuV1alpha1NodeConfig:
...
@dataclasses.dataclass
class V1alpha1TpuV1alpha1NodeAttrs:
    # Required. The type of hardware accelerators associated with this node.
    accelerator_type: Any = None
    # Output only. The API version that created this Node.
    api_version: Any = None
...
V1alpha1TpuV1alpha1Node = ubx.ResourceBinding(
    wire_type="google_tpu_v1alpha1_tpu_v1alpha1_node",
    fields={
        ...
        "network_endpoints": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1alpha1TpuV1alpha1Node_NetworkEndpointsFields,
        ),
        "port": ubx.FieldSpec(wire_name="port"),
        "scheduling_config": ubx.FieldSpec(
            wire_name="scheduling_config",
            kind="object",
            fields=_V1alpha1TpuV1alpha1Node_SchedulingConfigFields,
        ),
        ...
        "symptoms": ubx.FieldSpec(
            wire_name="symptoms",
            kind="list",
            fields=_V1alpha1TpuV1alpha1Node_SymptomsFields,
        ),
