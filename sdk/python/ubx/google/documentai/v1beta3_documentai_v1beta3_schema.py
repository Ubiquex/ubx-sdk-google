...
class V1beta3DocumentaiV1beta3SchemaConfig:
...
@dataclasses.dataclass
class V1beta3DocumentaiV1beta3SchemaAttrs:
    # Output only. The time when the Schema was created.
    create_time: Any = None
    # Required. The user-defined name of the Schema.
    display_name: Any = None
...
V1beta3DocumentaiV1beta3Schema = ubx.ResourceBinding(
    wire_type="google_documentai_v1beta3_documentai_v1beta3_schema",
    fields={
