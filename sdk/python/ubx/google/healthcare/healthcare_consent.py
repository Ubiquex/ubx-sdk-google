...
class HealthcareConsent_Policies_AuthorizationRule:
...
@dataclasses.dataclass
class HealthcareConsent_Policies_ResourceAttributes:
    attribute_definition_id: Any = None
    values: Any = None

@dataclasses.dataclass
class HealthcareConsent_Policies:
    authorization_rule: Any = None
    resource_attributes: Any = None

_HealthcareConsent_Policies_AuthorizationRuleFields = {
...
_HealthcareConsent_Policies_ResourceAttributesFields = {
    "attribute_definition_id": ubx.FieldSpec(wire_name="attribute_definition_id"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_HealthcareConsent_PoliciesFields = {
    "authorization_rule": ubx.FieldSpec(
        wire_name="authorization_rule",
        kind="object",
        fields=_HealthcareConsent_Policies_AuthorizationRuleFields,
    ),
    "resource_attributes": ubx.FieldSpec(
        wire_name="resource_attributes",
        kind="list",
        fields=_HealthcareConsent_Policies_ResourceAttributesFields,
    ),
}

@dataclasses.dataclass
class HealthcareConsentConfig:
...
HealthcareConsent = ubx.ResourceBinding(
    wire_type="google_healthcare_healthcare_consent",
    fields={
        ...
        "policies": ubx.FieldSpec(
            wire_name="policies",
            kind="list",
            fields=_HealthcareConsent_PoliciesFields,
        ),
