...
class V1beta1Consent_Policies_AuthorizationRule:
...
@dataclasses.dataclass
class V1beta1Consent_Policies_ResourceAttributes:
    attribute_definition_id: Any = None
    values: Any = None

@dataclasses.dataclass
class V1beta1Consent_Policies:
    authorization_rule: Any = None
    resource_attributes: Any = None

_V1beta1Consent_Policies_AuthorizationRuleFields = {
...
V1beta1Consent = ubx.ResourceBinding(
    wire_type="google_healthcare_v1beta1_consent",
    fields={
