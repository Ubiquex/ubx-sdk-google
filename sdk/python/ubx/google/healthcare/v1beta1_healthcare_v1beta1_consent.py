...
class V1beta1HealthcareV1beta1Consent_Policies_AuthorizationRule:
...
@dataclasses.dataclass
class V1beta1HealthcareV1beta1Consent_Policies_ResourceAttributes:
    attribute_definition_id: Any = None
    values: Any = None

@dataclasses.dataclass
class V1beta1HealthcareV1beta1Consent_Policies:
    authorization_rule: Any = None
    resource_attributes: Any = None

_V1beta1HealthcareV1beta1Consent_Policies_AuthorizationRuleFields = {
...
_V1beta1HealthcareV1beta1Consent_Policies_ResourceAttributesFields = {
    "attribute_definition_id": ubx.FieldSpec(wire_name="attribute_definition_id"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_V1beta1HealthcareV1beta1Consent_PoliciesFields = {
    "authorization_rule": ubx.FieldSpec(
        wire_name="authorization_rule",
        kind="object",
        fields=_V1beta1HealthcareV1beta1Consent_Policies_AuthorizationRuleFields,
    ),
    "resource_attributes": ubx.FieldSpec(
        wire_name="resource_attributes",
        kind="list",
        fields=_V1beta1HealthcareV1beta1Consent_Policies_ResourceAttributesFields,
    ),
}

@dataclasses.dataclass
class V1beta1HealthcareV1beta1ConsentConfig:
...
@dataclasses.dataclass
class V1beta1HealthcareV1beta1ConsentAttrs:
    # Required. The resource name of the Consent artifact that contains proof of the end user's consent, of the form `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/consentStores/{consent_store_id}/consentArtifacts/{consent_artifact_id}`.
    consent_artifact: Any = None
    # Timestamp in UTC of when this Consent is considered expired.
    expire_time: Any = None
...
V1beta1HealthcareV1beta1Consent = ubx.ResourceBinding(
    wire_type="google_healthcare_v1beta1_healthcare_v1beta1_consent",
    fields={
        ...
        "policies": ubx.FieldSpec(
            wire_name="policies",
            kind="list",
            fields=_V1beta1HealthcareV1beta1Consent_PoliciesFields,
        ),
