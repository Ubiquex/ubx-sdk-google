...
class Deployment_AgentRegistryDeployment:
...
@dataclasses.dataclass
class Deployment_ChannelProfile_InstagramConfig:
...
@dataclasses.dataclass
class Deployment_ChannelProfile_WhatsappConfig:
    # Output only. The description of the Meta business page or profile.
    description: Any = None
    # Output only. The fetched Meta business page name.
    display_name: Any = None
...
@dataclasses.dataclass
class Deployment_ExperimentConfig_VersionRelease:
...
@dataclasses.dataclass
class Deployment_ExperimentConfig:
    # Version release for the experiment.
    version_release: Any = None

@dataclasses.dataclass
class Deployment_InstagramCredentials:
...
@dataclasses.dataclass
class Deployment_ModelSettings:
...
@dataclasses.dataclass
class Deployment_WhatsappCredentials:
    # Required. The Meta auth code provided by the embedded signup flow.
    auth_code: Any = None
...
_Deployment_AgentRegistryDeploymentFields = {
    "agent_registry_service_name": ubx.FieldSpec(wire_name="agent_registry_service_name"),
}

_Deployment_ChannelProfile_InstagramConfigFields = {
...
_Deployment_ChannelProfile_WhatsappConfigFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "display_name": ubx.FieldSpec(wire_name="display_name"),
...
_Deployment_ChannelProfileFields = {
    ...
    "instagram_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Deployment_ChannelProfile_InstagramConfigFields,
    ),
    ...
    "whatsapp_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Deployment_ChannelProfile_WhatsappConfigFields,
    ),
}

_Deployment_ExperimentConfig_VersionRelease_TrafficAllocationsFields = {
    "app_version": ubx.FieldSpec(wire_name="app_version"),
    "id": ubx.FieldSpec(wire_name="id"),
    "traffic_percentage": ubx.FieldSpec(wire_name="traffic_percentage"),
}

_Deployment_ExperimentConfig_VersionReleaseFields = {
    "state": ubx.FieldSpec(wire_name="state"),
    "traffic_allocations": ubx.FieldSpec(
        wire_name="traffic_allocations",
        kind="list",
        fields=_Deployment_ExperimentConfig_VersionRelease_TrafficAllocationsFields,
    ),
}

_Deployment_ExperimentConfigFields = {
    "version_release": ubx.FieldSpec(
        wire_name="version_release",
        kind="object",
        fields=_Deployment_ExperimentConfig_VersionReleaseFields,
    ),
}

_Deployment_InstagramCredentialsFields = {
    "auth_code": ubx.FieldSpec(wire_name="auth_code"),
    "conversation_profile_id": ubx.FieldSpec(wire_name="conversation_profile_id"),
}

_Deployment_ModelSettingsFields = {
    "model": ubx.FieldSpec(wire_name="model"),
    "temperature": ubx.FieldSpec(wire_name="temperature"),
}

_Deployment_WhatsappCredentialsFields = {
    "auth_code": ubx.FieldSpec(wire_name="auth_code"),
...
Deployment = ubx.ResourceBinding(
    ...
    fields={
        "agent_registry_deployment": ubx.FieldSpec(
            ...
            kind="object",
            fields=_Deployment_AgentRegistryDeploymentFields,
        ),
        "app_version": ubx.FieldSpec(wire_name="app_version"),
