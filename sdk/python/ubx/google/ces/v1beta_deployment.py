...
@dataclasses.dataclass
class V1betaDeployment_ChannelProfile_PersonaProperty:
    # Optional. The persona of the channel.
    persona: Any = None

@dataclasses.dataclass
class V1betaDeployment_ChannelProfile_WebWidgetConfig_SecuritySettings:
...
@dataclasses.dataclass
class V1betaDeployment_ChannelProfile_WebWidgetConfig:
...
@dataclasses.dataclass
class V1betaDeployment_ChannelProfile_WhatsappConfig:
    # Output only. The description of the Meta business page or profile.
    description: Any = None
    # Output only. The fetched Meta business page name.
    display_name: Any = None
...
@dataclasses.dataclass
class V1betaDeployment_ChannelProfile:
...
@dataclasses.dataclass
class V1betaDeployment_ExperimentConfig_VersionRelease_TrafficAllocations:
    app_version: Any = None
    id: Any = None
    traffic_percentage: Any = None

@dataclasses.dataclass
class V1betaDeployment_ExperimentConfig_VersionRelease:
...
@dataclasses.dataclass
class V1betaDeployment_ExperimentConfig:
    # Version release for the experiment.
    version_release: Any = None

@dataclasses.dataclass
class V1betaDeployment_InstagramCredentials:
...
@dataclasses.dataclass
class V1betaDeployment_ModelSettings:
...
@dataclasses.dataclass
class V1betaDeployment_WhatsappCredentials:
    # Required. The Meta auth code provided by the embedded signup flow.
    auth_code: Any = None
...
_V1betaDeployment_ChannelProfile_PersonaPropertyFields = {
    "persona": ubx.FieldSpec(wire_name="persona"),
}

_V1betaDeployment_ChannelProfile_WebWidgetConfig_SecuritySettingsFields = {
...
_V1betaDeployment_ChannelProfileFields = {
    ...
    "instagram_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaDeployment_ChannelProfile_InstagramConfigFields,
    ),
    ...
    "persona_property": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaDeployment_ChannelProfile_PersonaPropertyFields,
    ),
    "profile_id": ubx.FieldSpec(wire_name="profile_id"),
    "web_widget_config": ubx.FieldSpec(
        wire_name="web_widget_config",
        kind="object",
        fields=_V1betaDeployment_ChannelProfile_WebWidgetConfigFields,
    ),
    "whatsapp_config": ubx.FieldSpec(
        wire_name="whatsapp_config",
        kind="object",
        fields=_V1betaDeployment_ChannelProfile_WhatsappConfigFields,
    ),
}

_V1betaDeployment_ExperimentConfig_VersionRelease_TrafficAllocationsFields = {
    "app_version": ubx.FieldSpec(wire_name="app_version"),
    "id": ubx.FieldSpec(wire_name="id"),
    "traffic_percentage": ubx.FieldSpec(wire_name="traffic_percentage"),
}

_V1betaDeployment_ExperimentConfig_VersionReleaseFields = {
    "state": ubx.FieldSpec(wire_name="state"),
    "traffic_allocations": ubx.FieldSpec(
        wire_name="traffic_allocations",
        kind="list",
        fields=_V1betaDeployment_ExperimentConfig_VersionRelease_TrafficAllocationsFields,
    ),
}

_V1betaDeployment_ExperimentConfigFields = {
    "version_release": ubx.FieldSpec(
        wire_name="version_release",
        kind="object",
        fields=_V1betaDeployment_ExperimentConfig_VersionReleaseFields,
    ),
}

_V1betaDeployment_InstagramCredentialsFields = {
    "auth_code": ubx.FieldSpec(wire_name="auth_code"),
    "conversation_profile_id": ubx.FieldSpec(wire_name="conversation_profile_id"),
}

_V1betaDeployment_ModelSettingsFields = {
    "model": ubx.FieldSpec(wire_name="model"),
    "temperature": ubx.FieldSpec(wire_name="temperature"),
}

_V1betaDeployment_WhatsappCredentialsFields = {
    "auth_code": ubx.FieldSpec(wire_name="auth_code"),
...
V1betaDeployment = ubx.ResourceBinding(
    ...
    fields={
        ...
        "experiment_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaDeployment_ExperimentConfigFields,
        ),
        "instagram_credentials": ubx.FieldSpec(
            wire_name="instagram_credentials",
            kind="object",
            fields=_V1betaDeployment_InstagramCredentialsFields,
        ),
        "modality": ubx.FieldSpec(wire_name="modality"),
        ...
        "whatsapp_credentials": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaDeployment_WhatsappCredentialsFields,
        ),
    },
)
