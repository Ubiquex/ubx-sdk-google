...
class CesToolset_ConnectorToolset_AuthConfig_Oauth2AuthCodeConfig:
    # Required. Oauth token parameter name to pass through. Must be in the format `$context.variables.`.
    oauth_token: Any = None

@dataclasses.dataclass
class CesToolset_ConnectorToolset_AuthConfig_Oauth2JwtBearerConfig:
...
@dataclasses.dataclass
class CesToolset_ConnectorToolset_AuthConfig:
...
@dataclasses.dataclass
class CesToolset_ConnectorToolset_ConnectorActions_EntityOperation:
    entity_id: Any = None
    operation: Any = None

@dataclasses.dataclass
class CesToolset_ConnectorToolset_ConnectorActions:
...
@dataclasses.dataclass
class CesToolset_ConnectorToolset:
...
@dataclasses.dataclass
class CesToolset_McpToolset_ApiAuthentication_ApiKeyConfig:
...
@dataclasses.dataclass
class CesToolset_McpToolset_ApiAuthentication_BearerTokenConfig:
    # Required. The bearer token. Must be in the format `$context.variables.`.
    token: Any = None

@dataclasses.dataclass
class CesToolset_McpToolset_ApiAuthentication_OauthConfig:
...
@dataclasses.dataclass
class CesToolset_McpToolset_ApiAuthentication_ServiceAccountAuthConfig:
...
@dataclasses.dataclass
class CesToolset_McpToolset_ApiAuthentication:
...
@dataclasses.dataclass
class CesToolset_McpToolset_ServiceDirectoryConfig:
...
@dataclasses.dataclass
class CesToolset_McpToolset_TlsConfig_CaCerts:
    cert: Any = None
    display_name: Any = None

@dataclasses.dataclass
class CesToolset_McpToolset_TlsConfig:
    # Required. Specifies a list of allowed custom CA certificates for HTTPS verification.
    ca_certs: Any = None

@dataclasses.dataclass
class CesToolset_McpToolset_ToolOverrides_Snapshot_InputSchema:
...
@dataclasses.dataclass
class CesToolset_McpToolset_ToolOverrides_Snapshot:
    description: Any = None
    input_schema: Any = None
    output_schema: Any = None

@dataclasses.dataclass
class CesToolset_McpToolset_ToolOverrides:
...
@dataclasses.dataclass
class CesToolset_OpenApiToolset:
    # Authentication information required for API calls.
    api_authentication: Any = None
...
@dataclasses.dataclass
class CesToolset_ToolFakeConfig_CodeBlock:
...
@dataclasses.dataclass
class CesToolset_ToolFakeConfig:
...
_CesToolset_ConnectorToolset_AuthConfig_Oauth2AuthCodeConfigFields = {
    "oauth_token": ubx.FieldSpec(wire_name="oauth_token"),
}

_CesToolset_ConnectorToolset_AuthConfig_Oauth2JwtBearerConfigFields = {
...
_CesToolset_ConnectorToolset_AuthConfigFields = {
    "oauth2_auth_code_config": ubx.FieldSpec(
        wire_name="oauth2_auth_code_config",
        kind="object",
        fields=_CesToolset_ConnectorToolset_AuthConfig_Oauth2AuthCodeConfigFields,
    ),
    "oauth2_jwt_bearer_config": ubx.FieldSpec(
        wire_name="oauth2_jwt_bearer_config",
        kind="object",
        fields=_CesToolset_ConnectorToolset_AuthConfig_Oauth2JwtBearerConfigFields,
    ),
}

_CesToolset_ConnectorToolset_ConnectorActions_EntityOperationFields = {
    "entity_id": ubx.FieldSpec(wire_name="entity_id"),
    "operation": ubx.FieldSpec(wire_name="operation"),
}

_CesToolset_ConnectorToolset_ConnectorActionsFields = {
    ...
    "entity_operation": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesToolset_ConnectorToolset_ConnectorActions_EntityOperationFields,
    ),
    "input_fields": ubx.FieldSpec(wire_name="input_fields"),
    "output_fields": ubx.FieldSpec(wire_name="output_fields"),
}

_CesToolset_ConnectorToolsetFields = {
    "auth_config": ubx.FieldSpec(
        wire_name="auth_config",
        kind="object",
        fields=_CesToolset_ConnectorToolset_AuthConfigFields,
    ),
    "connection": ubx.FieldSpec(wire_name="connection"),
    "connector_actions": ubx.FieldSpec(
        wire_name="connector_actions",
        kind="list",
        fields=_CesToolset_ConnectorToolset_ConnectorActionsFields,
    ),
}

_CesToolset_McpToolset_ApiAuthentication_ApiKeyConfigFields = {
...
_CesToolset_McpToolset_ApiAuthentication_BearerTokenConfigFields = {
    "token": ubx.FieldSpec(wire_name="token"),
}

_CesToolset_McpToolset_ApiAuthentication_OauthConfigFields = {
...
_CesToolset_McpToolset_ApiAuthentication_ServiceAccountAuthConfigFields = {
    "scopes": ubx.FieldSpec(wire_name="scopes"),
    "service_account": ubx.FieldSpec(wire_name="service_account"),
}

_CesToolset_McpToolset_ApiAuthenticationFields = {
    "api_key_config": ubx.FieldSpec(
        wire_name="api_key_config",
        kind="object",
        fields=_CesToolset_McpToolset_ApiAuthentication_ApiKeyConfigFields,
    ),
    "bearer_token_config": ubx.FieldSpec(
        wire_name="bearer_token_config",
        kind="object",
        fields=_CesToolset_McpToolset_ApiAuthentication_BearerTokenConfigFields,
    ),
    "oauth_config": ubx.FieldSpec(
        wire_name="oauth_config",
        kind="object",
        fields=_CesToolset_McpToolset_ApiAuthentication_OauthConfigFields,
    ),
    "service_account_auth_config": ubx.FieldSpec(
        wire_name="service_account_auth_config",
        kind="object",
        fields=_CesToolset_McpToolset_ApiAuthentication_ServiceAccountAuthConfigFields,
    ),
    "service_agent_id_token_auth_config": ubx.FieldSpec(wire_name="service_agent_id_token_auth_config"),
}

_CesToolset_McpToolset_ServiceDirectoryConfigFields = {
    "service": ubx.FieldSpec(wire_name="service"),
}

_CesToolset_McpToolset_TlsConfig_CaCertsFields = {
    "cert": ubx.FieldSpec(wire_name="cert"),
    "display_name": ubx.FieldSpec(wire_name="display_name"),
}

_CesToolset_McpToolset_TlsConfigFields = {
    "ca_certs": ubx.FieldSpec(
        wire_name="ca_certs",
        kind="list",
        fields=_CesToolset_McpToolset_TlsConfig_CaCertsFields,
    ),
}

_CesToolset_McpToolset_ToolOverrides_Snapshot_InputSchemaFields = {
...
_CesToolset_McpToolset_ToolOverrides_SnapshotFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "input_schema": ubx.FieldSpec(
        wire_name="input_schema",
        kind="object",
        fields=_CesToolset_McpToolset_ToolOverrides_Snapshot_InputSchemaFields,
    ),
...
_CesToolset_McpToolset_ToolOverridesFields = {
    ...
    "snapshot": ubx.FieldSpec(
        wire_name="snapshot",
        kind="object",
        fields=_CesToolset_McpToolset_ToolOverrides_SnapshotFields,
    ),
    "tool": ubx.FieldSpec(wire_name="tool"),
}

_CesToolset_McpToolsetFields = {
    "api_authentication": ubx.FieldSpec(
        wire_name="api_authentication",
        kind="object",
        fields=_CesToolset_McpToolset_ApiAuthenticationFields,
    ),
    ...
    "service_directory_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesToolset_McpToolset_ServiceDirectoryConfigFields,
    ),
    "tls_config": ubx.FieldSpec(
        wire_name="tls_config",
        kind="object",
        fields=_CesToolset_McpToolset_TlsConfigFields,
    ),
    "tool_overrides": ubx.FieldSpec(
        wire_name="tool_overrides",
        kind="list",
        fields=_CesToolset_McpToolset_ToolOverridesFields,
    ),
}

_CesToolset_OpenApiToolsetFields = {
    "api_authentication": ubx.FieldSpec(
        wire_name="api_authentication",
        kind="object",
        fields=_CesToolset_McpToolset_ApiAuthenticationFields,
...
CesToolset = ubx.ResourceBinding(
    wire_type="google_ces_ces_toolset",
    fields={
        "connector_toolset": ubx.FieldSpec(
            wire_name="connector_toolset",
            kind="object",
            fields=_CesToolset_ConnectorToolsetFields,
        ),
