...
class V1betaGuardrail_Action_GenerativeAnswer:
    # Required. The prompt to use for the generative answer.
    prompt: Any = None

@dataclasses.dataclass
class V1betaGuardrail_Action_RespondImmediately_Responses:
    disabled: Any = None
    text: Any = None

@dataclasses.dataclass
class V1betaGuardrail_Action_RespondImmediately:
    # Required. The canned responses for the agent to choose from. The response is chosen randomly.
    responses: Any = None

@dataclasses.dataclass
class V1betaGuardrail_Action_TransferAgent:
...
@dataclasses.dataclass
class V1betaGuardrail_CodeCallback_AfterAgentCallback:
...
@dataclasses.dataclass
class V1betaGuardrail_CodeCallback:
...
@dataclasses.dataclass
class V1betaGuardrail_ContentFilter:
...
@dataclasses.dataclass
class V1betaGuardrail_LlmPolicy_ModelSettings:
...
@dataclasses.dataclass
class V1betaGuardrail_LlmPolicy:
...
@dataclasses.dataclass
class V1betaGuardrail_LlmPromptSecurity_DefaultSettings:
...
@dataclasses.dataclass
class V1betaGuardrail_LlmPromptSecurity:
...
@dataclasses.dataclass
class V1betaGuardrail_ModelSafety_SafetySettings:
    category: Any = None
    threshold: Any = None

@dataclasses.dataclass
class V1betaGuardrail_ModelSafety:
    # Required. List of safety settings.
    safety_settings: Any = None

_V1betaGuardrail_Action_GenerativeAnswerFields = {
    "prompt": ubx.FieldSpec(wire_name="prompt"),
}

_V1betaGuardrail_Action_RespondImmediately_ResponsesFields = {
    "disabled": ubx.FieldSpec(wire_name="disabled"),
    "text": ubx.FieldSpec(wire_name="text"),
}

_V1betaGuardrail_Action_RespondImmediatelyFields = {
    "responses": ubx.FieldSpec(
        wire_name="responses",
        kind="list",
        fields=_V1betaGuardrail_Action_RespondImmediately_ResponsesFields,
    ),
}

_V1betaGuardrail_Action_TransferAgentFields = {
    "agent": ubx.FieldSpec(wire_name="agent"),
}

_V1betaGuardrail_ActionFields = {
    "generative_answer": ubx.FieldSpec(
        wire_name="generative_answer",
        kind="object",
        fields=_V1betaGuardrail_Action_GenerativeAnswerFields,
    ),
    "respond_immediately": ubx.FieldSpec(
        wire_name="respond_immediately",
        kind="object",
        fields=_V1betaGuardrail_Action_RespondImmediatelyFields,
    ),
    "transfer_agent": ubx.FieldSpec(
        wire_name="transfer_agent",
        kind="object",
        fields=_V1betaGuardrail_Action_TransferAgentFields,
    ),
}

_V1betaGuardrail_CodeCallback_AfterAgentCallbackFields = {
...
_V1betaGuardrail_CodeCallbackFields = {
    "after_agent_callback": ubx.FieldSpec(
        wire_name="after_agent_callback",
        kind="object",
        fields=_V1betaGuardrail_CodeCallback_AfterAgentCallbackFields,
    ),
...
_V1betaGuardrail_ContentFilterFields = {
...
_V1betaGuardrail_LlmPolicyFields = {
    ...
    "model_settings": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaGuardrail_LlmPolicy_ModelSettingsFields,
    ),
    "policy_scope": ubx.FieldSpec(wire_name="policy_scope"),
    "prompt": ubx.FieldSpec(wire_name="prompt"),
}

_V1betaGuardrail_LlmPromptSecurity_DefaultSettingsFields = {
    "default_prompt_template": ubx.FieldSpec(wire_name="default_prompt_template"),
}

_V1betaGuardrail_LlmPromptSecurityFields = {
    "custom_policy": ubx.FieldSpec(
        wire_name="custom_policy",
        kind="object",
        fields=_V1betaGuardrail_LlmPolicyFields,
    ),
    "default_settings": ubx.FieldSpec(
        wire_name="default_settings",
        kind="object",
        fields=_V1betaGuardrail_LlmPromptSecurity_DefaultSettingsFields,
    ),
    "fail_open": ubx.FieldSpec(wire_name="fail_open"),
}

_V1betaGuardrail_ModelSafety_SafetySettingsFields = {
    "category": ubx.FieldSpec(wire_name="category"),
    "threshold": ubx.FieldSpec(wire_name="threshold"),
}

_V1betaGuardrail_ModelSafetyFields = {
    "safety_settings": ubx.FieldSpec(
        wire_name="safety_settings",
        kind="list",
        fields=_V1betaGuardrail_ModelSafety_SafetySettingsFields,
    ),
}

@dataclasses.dataclass
class V1betaGuardrailConfig:
...
V1betaGuardrail = ubx.ResourceBinding(
    wire_type="google_ces_v1beta_guardrail",
    fields={
        "action": ubx.FieldSpec(
            wire_name="action",
            kind="object",
            fields=_V1betaGuardrail_ActionFields,
        ),
        "code_callback": ubx.FieldSpec(
            wire_name="code_callback",
            kind="object",
            fields=_V1betaGuardrail_CodeCallbackFields,
        ),
        ...
        "llm_prompt_security": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaGuardrail_LlmPromptSecurityFields,
        ),
