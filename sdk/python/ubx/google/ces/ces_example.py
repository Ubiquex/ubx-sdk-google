...
class CesExample_Messages_Chunks_AgentTransfer:
    display_name: Any = None
    target_agent: Any = None

@dataclasses.dataclass
class CesExample_Messages_Chunks_Blob:
    data: Any = None
    mime_type: Any = None

@dataclasses.dataclass
class CesExample_Messages_Chunks_ToolCall_ToolsetTool:
    tool_id: Any = None
    toolset: Any = None

@dataclasses.dataclass
class CesExample_Messages_Chunks_ToolCall:
    args: Any = None
    display_name: Any = None
    id: Any = None
    tool: Any = None
...
@dataclasses.dataclass
class CesExample_Messages_Chunks_ToolResponse:
    display_name: Any = None
    id: Any = None
    response: Any = None
    tool: Any = None
...
@dataclasses.dataclass
class CesExample_Messages_Chunks:
...
_CesExample_Messages_Chunks_ToolCallFields = {
    ...
    "toolset_tool": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesExample_Messages_Chunks_ToolCall_ToolsetToolFields,
    ),
}

_CesExample_Messages_Chunks_ToolResponseFields = {
    "display_name": ubx.FieldSpec(wire_name="display_name"),
    "id": ubx.FieldSpec(wire_name="id"),
...
_CesExample_Messages_ChunksFields = {
    "agent_transfer": ubx.FieldSpec(
        wire_name="agent_transfer",
        kind="object",
        fields=_CesExample_Messages_Chunks_AgentTransferFields,
    ),
    "blob": ubx.FieldSpec(
        wire_name="blob",
        kind="object",
        fields=_CesExample_Messages_Chunks_BlobFields,
    ),
...
CesExample = ubx.ResourceBinding(
    wire_type="google_ces_ces_example",
    fields={
        ...
        "messages": ubx.FieldSpec(
            wire_name="messages",
            kind="list",
            fields=_CesExample_MessagesFields,
        ),
