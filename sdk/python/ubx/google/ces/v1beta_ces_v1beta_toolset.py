...
class V1betaCesV1betaToolset_ConnectorToolset_AuthConfig_Oauth2AuthCodeConfig:
    # Required. Oauth token parameter name to pass through. Must be in the format `$context.variables.`.
    oauth_token: Any = None

@dataclasses.dataclass
class V1betaCesV1betaToolset_ConnectorToolset_AuthConfig_Oauth2JwtBearerConfig:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_ConnectorToolset_AuthConfig:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_ConnectorToolset_ConnectorActions_EntityOperation:
    entity_id: Any = None
    operation: Any = None

@dataclasses.dataclass
class V1betaCesV1betaToolset_ConnectorToolset_ConnectorActions:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_ConnectorToolset:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_McpToolset_ApiAuthentication_ApiKeyConfig:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_McpToolset_ApiAuthentication_BearerTokenConfig:
    # Required. The bearer token. Must be in the format `$context.variables.`.
    token: Any = None

@dataclasses.dataclass
class V1betaCesV1betaToolset_McpToolset_ApiAuthentication_OauthConfig:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_McpToolset_ApiAuthentication_ServiceAccountAuthConfig:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_McpToolset_ApiAuthentication:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_McpToolset_ServiceDirectoryConfig:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_McpToolset_TlsConfig_CaCerts:
    cert: Any = None
    display_name: Any = None

@dataclasses.dataclass
class V1betaCesV1betaToolset_McpToolset_TlsConfig:
    # Required. Specifies a list of allowed custom CA certificates for HTTPS verification.
    ca_certs: Any = None

@dataclasses.dataclass
class V1betaCesV1betaToolset_McpToolset_ToolOverrides_Snapshot_InputSchema:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_McpToolset_ToolOverrides_Snapshot:
    description: Any = None
    input_schema: Any = None
    output_schema: Any = None

@dataclasses.dataclass
class V1betaCesV1betaToolset_McpToolset_ToolOverrides:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_McpToolset:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_OpenApiToolset:
    # Authentication information required for API calls.
    api_authentication: Any = None
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_ToolFakeConfig_CodeBlock:
...
@dataclasses.dataclass
class V1betaCesV1betaToolset_ToolFakeConfig:
...
_V1betaCesV1betaToolset_ConnectorToolset_AuthConfig_Oauth2AuthCodeConfigFields = {
    "oauth_token": ubx.FieldSpec(wire_name="oauth_token"),
}

_V1betaCesV1betaToolset_ConnectorToolset_AuthConfig_Oauth2JwtBearerConfigFields = {
...
_V1betaCesV1betaToolset_ConnectorToolset_AuthConfigFields = {
    "oauth2_auth_code_config": ubx.FieldSpec(
        wire_name="oauth2_auth_code_config",
        kind="object",
        fields=_V1betaCesV1betaToolset_ConnectorToolset_AuthConfig_Oauth2AuthCodeConfigFields,
    ),
    "oauth2_jwt_bearer_config": ubx.FieldSpec(
        wire_name="oauth2_jwt_bearer_config",
        kind="object",
        fields=_V1betaCesV1betaToolset_ConnectorToolset_AuthConfig_Oauth2JwtBearerConfigFields,
    ),
}

_V1betaCesV1betaToolset_ConnectorToolset_ConnectorActions_EntityOperationFields = {
    "entity_id": ubx.FieldSpec(wire_name="entity_id"),
    "operation": ubx.FieldSpec(wire_name="operation"),
}

_V1betaCesV1betaToolset_ConnectorToolset_ConnectorActionsFields = {
    ...
    "entity_operation": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaCesV1betaToolset_ConnectorToolset_ConnectorActions_EntityOperationFields,
    ),
    "input_fields": ubx.FieldSpec(wire_name="input_fields"),
    "output_fields": ubx.FieldSpec(wire_name="output_fields"),
}

_V1betaCesV1betaToolset_ConnectorToolsetFields = {
    "auth_config": ubx.FieldSpec(
        wire_name="auth_config",
        kind="object",
        fields=_V1betaCesV1betaToolset_ConnectorToolset_AuthConfigFields,
    ),
    "connection": ubx.FieldSpec(wire_name="connection"),
    "connector_actions": ubx.FieldSpec(
        wire_name="connector_actions",
        kind="list",
        fields=_V1betaCesV1betaToolset_ConnectorToolset_ConnectorActionsFields,
    ),
}

_V1betaCesV1betaToolset_McpToolset_ApiAuthentication_ApiKeyConfigFields = {
...
_V1betaCesV1betaToolset_McpToolset_ApiAuthentication_BearerTokenConfigFields = {
    "token": ubx.FieldSpec(wire_name="token"),
}

_V1betaCesV1betaToolset_McpToolset_ApiAuthentication_OauthConfigFields = {
...
_V1betaCesV1betaToolset_McpToolset_ApiAuthentication_ServiceAccountAuthConfigFields = {
    "scopes": ubx.FieldSpec(wire_name="scopes"),
    "service_account": ubx.FieldSpec(wire_name="service_account"),
}

_V1betaCesV1betaToolset_McpToolset_ApiAuthenticationFields = {
    "api_key_config": ubx.FieldSpec(
        wire_name="api_key_config",
        kind="object",
        fields=_V1betaCesV1betaToolset_McpToolset_ApiAuthentication_ApiKeyConfigFields,
    ),
    "bearer_token_config": ubx.FieldSpec(
        wire_name="bearer_token_config",
        kind="object",
        fields=_V1betaCesV1betaToolset_McpToolset_ApiAuthentication_BearerTokenConfigFields,
    ),
    "oauth_config": ubx.FieldSpec(
        wire_name="oauth_config",
        kind="object",
        fields=_V1betaCesV1betaToolset_McpToolset_ApiAuthentication_OauthConfigFields,
    ),
    "service_account_auth_config": ubx.FieldSpec(
        wire_name="service_account_auth_config",
        kind="object",
        fields=_V1betaCesV1betaToolset_McpToolset_ApiAuthentication_ServiceAccountAuthConfigFields,
    ),
    "service_agent_id_token_auth_config": ubx.FieldSpec(wire_name="service_agent_id_token_auth_config"),
}

_V1betaCesV1betaToolset_McpToolset_ServiceDirectoryConfigFields = {
    "service": ubx.FieldSpec(wire_name="service"),
}

_V1betaCesV1betaToolset_McpToolset_TlsConfig_CaCertsFields = {
    "cert": ubx.FieldSpec(wire_name="cert"),
    "display_name": ubx.FieldSpec(wire_name="display_name"),
}

_V1betaCesV1betaToolset_McpToolset_TlsConfigFields = {
    "ca_certs": ubx.FieldSpec(
        wire_name="ca_certs",
        kind="list",
        fields=_V1betaCesV1betaToolset_McpToolset_TlsConfig_CaCertsFields,
    ),
}

_V1betaCesV1betaToolset_McpToolset_ToolOverrides_Snapshot_InputSchemaFields = {
...
_V1betaCesV1betaToolset_McpToolset_ToolOverrides_SnapshotFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "input_schema": ubx.FieldSpec(
        wire_name="input_schema",
        kind="object",
        fields=_V1betaCesV1betaToolset_McpToolset_ToolOverrides_Snapshot_InputSchemaFields,
    ),
...
_V1betaCesV1betaToolset_McpToolset_ToolOverridesFields = {
    ...
    "snapshot": ubx.FieldSpec(
        wire_name="snapshot",
        kind="object",
        fields=_V1betaCesV1betaToolset_McpToolset_ToolOverrides_SnapshotFields,
    ),
    "tool": ubx.FieldSpec(wire_name="tool"),
}

_V1betaCesV1betaToolset_McpToolsetFields = {
    "api_authentication": ubx.FieldSpec(
        wire_name="api_authentication",
        kind="object",
        fields=_V1betaCesV1betaToolset_McpToolset_ApiAuthenticationFields,
    ),
    ...
    "service_directory_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaCesV1betaToolset_McpToolset_ServiceDirectoryConfigFields,
    ),
    "tls_config": ubx.FieldSpec(
        wire_name="tls_config",
        kind="object",
        fields=_V1betaCesV1betaToolset_McpToolset_TlsConfigFields,
    ),
    "tool_overrides": ubx.FieldSpec(
        wire_name="tool_overrides",
        kind="list",
        fields=_V1betaCesV1betaToolset_McpToolset_ToolOverridesFields,
    ),
}

_V1betaCesV1betaToolset_OpenApiToolsetFields = {
    "api_authentication": ubx.FieldSpec(
        wire_name="api_authentication",
        kind="object",
        fields=_V1betaCesV1betaToolset_McpToolset_ApiAuthenticationFields,
...
_V1betaCesV1betaToolset_ToolFakeConfig_CodeBlockFields = {
    "python_code": ubx.FieldSpec(wire_name="python_code"),
}

_V1betaCesV1betaToolset_ToolFakeConfigFields = {
    "code_block": ubx.FieldSpec(
        wire_name="code_block",
        kind="object",
        fields=_V1betaCesV1betaToolset_ToolFakeConfig_CodeBlockFields,
    ),
    "enable_fake_mode": ubx.FieldSpec(wire_name="enable_fake_mode"),
}

@dataclasses.dataclass
class V1betaCesV1betaToolsetConfig:
...
@dataclasses.dataclass
class V1betaCesV1betaToolsetAttrs:
    # A toolset that generates tools from an Integration Connectors Connection.
    connector_toolset: Any = None
    # Output only. Timestamp when the toolset was created.
    create_time: Any = None
...
V1betaCesV1betaToolset = ubx.ResourceBinding(
    wire_type="google_ces_v1beta_ces_v1beta_toolset",
    fields={
        "connector_toolset": ubx.FieldSpec(
            wire_name="connector_toolset",
            kind="object",
            fields=_V1betaCesV1betaToolset_ConnectorToolsetFields,
        ),
