...
class V1betaCesV1betaScheduledEvaluationRun_Request_Config_InputAudioConfig:
...
@dataclasses.dataclass
class V1betaCesV1betaScheduledEvaluationRun_Request_Config_OutputAudioConfig:
...
@dataclasses.dataclass
class V1betaCesV1betaScheduledEvaluationRun_Request_Config:
...
@dataclasses.dataclass
class V1betaCesV1betaScheduledEvaluationRun_Request_EvaluationRunCachingSettings:
    # Optional. The caching mode to use for the evaluation run. If not set, default to FORCE_RUN.
    run_caching_mode: Any = None

@dataclasses.dataclass
class V1betaCesV1betaScheduledEvaluationRun_Request_OptimizationConfig:
...
@dataclasses.dataclass
class V1betaCesV1betaScheduledEvaluationRun_Request_PersonaRunConfigs:
    persona: Any = None
    task_count: Any = None

@dataclasses.dataclass
class V1betaCesV1betaScheduledEvaluationRun_Request:
...
@dataclasses.dataclass
class V1betaCesV1betaScheduledEvaluationRun_SchedulingConfig:
...
_V1betaCesV1betaScheduledEvaluationRun_Request_Config_InputAudioConfigFields = {
...
_V1betaCesV1betaScheduledEvaluationRun_Request_Config_OutputAudioConfigFields = {
    "audio_encoding": ubx.FieldSpec(wire_name="audio_encoding"),
    "sample_rate_hertz": ubx.FieldSpec(wire_name="sample_rate_hertz"),
}

_V1betaCesV1betaScheduledEvaluationRun_Request_ConfigFields = {
    ...
    "input_audio_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaCesV1betaScheduledEvaluationRun_Request_Config_InputAudioConfigFields,
    ),
    "output_audio_config": ubx.FieldSpec(
        wire_name="output_audio_config",
        kind="object",
        fields=_V1betaCesV1betaScheduledEvaluationRun_Request_Config_OutputAudioConfigFields,
    ),
    "tool_call_behaviour": ubx.FieldSpec(wire_name="tool_call_behaviour"),
}

_V1betaCesV1betaScheduledEvaluationRun_Request_EvaluationRunCachingSettingsFields = {
    "run_caching_mode": ubx.FieldSpec(wire_name="run_caching_mode"),
}

_V1betaCesV1betaScheduledEvaluationRun_Request_OptimizationConfigFields = {
...
_V1betaCesV1betaScheduledEvaluationRun_Request_PersonaRunConfigsFields = {
    "persona": ubx.FieldSpec(wire_name="persona"),
    "task_count": ubx.FieldSpec(wire_name="task_count"),
}

_V1betaCesV1betaScheduledEvaluationRun_RequestFields = {
    "app": ubx.FieldSpec(wire_name="app"),
    "app_version": ubx.FieldSpec(wire_name="app_version"),
    "config": ubx.FieldSpec(
        wire_name="config",
        kind="object",
        fields=_V1betaCesV1betaScheduledEvaluationRun_Request_ConfigFields,
    ),
    ...
    "evaluation_run_caching_settings": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaCesV1betaScheduledEvaluationRun_Request_EvaluationRunCachingSettingsFields,
    ),
    ...
    "optimization_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaCesV1betaScheduledEvaluationRun_Request_OptimizationConfigFields,
    ),
    "persona_run_configs": ubx.FieldSpec(
        wire_name="persona_run_configs",
        kind="list",
        fields=_V1betaCesV1betaScheduledEvaluationRun_Request_PersonaRunConfigsFields,
    ),
    "run_count": ubx.FieldSpec(wire_name="run_count"),
    "scheduled_evaluation_run": ubx.FieldSpec(wire_name="scheduled_evaluation_run"),
}

_V1betaCesV1betaScheduledEvaluationRun_SchedulingConfigFields = {
...
@dataclasses.dataclass
class V1betaCesV1betaScheduledEvaluationRunConfig:
...
@dataclasses.dataclass
class V1betaCesV1betaScheduledEvaluationRunAttrs:
    # Optional. Whether this config is active
    active: Any = None
    # Output only. Timestamp when the scheduled evaluation run was created.
    create_time: Any = None
...
V1betaCesV1betaScheduledEvaluationRun = ubx.ResourceBinding(
    wire_type="google_ces_v1beta_ces_v1beta_scheduled_evaluation_run",
    fields={
        ...
        "request": ubx.FieldSpec(
            wire_name="request",
            kind="object",
            fields=_V1betaCesV1betaScheduledEvaluationRun_RequestFields,
        ),
        "scheduling_config": ubx.FieldSpec(
            wire_name="scheduling_config",
            kind="object",
            fields=_V1betaCesV1betaScheduledEvaluationRun_SchedulingConfigFields,
        ),
