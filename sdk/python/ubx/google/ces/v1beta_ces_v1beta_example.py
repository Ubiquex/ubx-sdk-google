...
class V1betaCesV1betaExample_Messages_Chunks_AgentTransfer:
    display_name: Any = None
    target_agent: Any = None

@dataclasses.dataclass
class V1betaCesV1betaExample_Messages_Chunks_Blob:
    data: Any = None
    mime_type: Any = None

@dataclasses.dataclass
class V1betaCesV1betaExample_Messages_Chunks_ToolCall_ToolsetTool:
    tool_id: Any = None
    toolset: Any = None

@dataclasses.dataclass
class V1betaCesV1betaExample_Messages_Chunks_ToolCall:
    args: Any = None
    display_name: Any = None
    id: Any = None
    tool: Any = None
...
@dataclasses.dataclass
class V1betaCesV1betaExample_Messages_Chunks_ToolResponse:
    display_name: Any = None
    id: Any = None
    response: Any = None
    tool: Any = None
...
@dataclasses.dataclass
class V1betaCesV1betaExample_Messages_Chunks:
...
@dataclasses.dataclass
class V1betaCesV1betaExample_Messages:
    chunks: Any = None
    event_time: Any = None
    role: Any = None

_V1betaCesV1betaExample_Messages_Chunks_AgentTransferFields = {
    "display_name": ubx.FieldSpec(wire_name="display_name"),
    "target_agent": ubx.FieldSpec(wire_name="target_agent"),
}

_V1betaCesV1betaExample_Messages_Chunks_BlobFields = {
    "data": ubx.FieldSpec(wire_name="data"),
    "mime_type": ubx.FieldSpec(wire_name="mime_type"),
}

_V1betaCesV1betaExample_Messages_Chunks_ToolCall_ToolsetToolFields = {
    "tool_id": ubx.FieldSpec(wire_name="tool_id"),
    "toolset": ubx.FieldSpec(wire_name="toolset"),
}

_V1betaCesV1betaExample_Messages_Chunks_ToolCallFields = {
    ...
    "toolset_tool": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1betaCesV1betaExample_Messages_Chunks_ToolCall_ToolsetToolFields,
    ),
}

_V1betaCesV1betaExample_Messages_Chunks_ToolResponseFields = {
    "display_name": ubx.FieldSpec(wire_name="display_name"),
    "id": ubx.FieldSpec(wire_name="id"),
...
_V1betaCesV1betaExample_Messages_ChunksFields = {
    "agent_transfer": ubx.FieldSpec(
        wire_name="agent_transfer",
        kind="object",
        fields=_V1betaCesV1betaExample_Messages_Chunks_AgentTransferFields,
    ),
    "blob": ubx.FieldSpec(
        wire_name="blob",
        kind="object",
        fields=_V1betaCesV1betaExample_Messages_Chunks_BlobFields,
    ),
    ...
    "tool_call": ubx.FieldSpec(
        wire_name="tool_call",
        kind="object",
        fields=_V1betaCesV1betaExample_Messages_Chunks_ToolCallFields,
    ),
    "tool_response": ubx.FieldSpec(
        wire_name="tool_response",
        kind="object",
        fields=_V1betaCesV1betaExample_Messages_Chunks_ToolResponseFields,
    ),
    "transcript": ubx.FieldSpec(wire_name="transcript"),
    "updated_variables": ubx.FieldSpec(wire_name="updated_variables"),
}

_V1betaCesV1betaExample_MessagesFields = {
    "chunks": ubx.FieldSpec(
        wire_name="chunks",
        kind="list",
        fields=_V1betaCesV1betaExample_Messages_ChunksFields,
    ),
...
@dataclasses.dataclass
class V1betaCesV1betaExampleConfig:
...
@dataclasses.dataclass
class V1betaCesV1betaExampleAttrs:
    # Output only. Timestamp when the example was created.
    create_time: Any = None
    # Optional. Human-readable description of the example.
    description: Any = None
...
V1betaCesV1betaExample = ubx.ResourceBinding(
    wire_type="google_ces_v1beta_ces_v1beta_example",
    fields={
        ...
        "messages": ubx.FieldSpec(
            wire_name="messages",
            kind="list",
            fields=_V1betaCesV1betaExample_MessagesFields,
        ),
