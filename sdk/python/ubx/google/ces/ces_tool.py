...
@dataclasses.dataclass
class CesTool_ClientFunction_Parameters:
...
@dataclasses.dataclass
class CesTool_ConnectorTool_Action_EntityOperation:
...
@dataclasses.dataclass
class CesTool_ConnectorTool_Action:
...
@dataclasses.dataclass
class CesTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfig:
    # Required. Oauth token parameter name to pass through. Must be in the format `$context.variables.`.
    oauth_token: Any = None

@dataclasses.dataclass
class CesTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfig:
...
@dataclasses.dataclass
class CesTool_ConnectorTool_AuthConfig:
...
@dataclasses.dataclass
class CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPoints:
    attribute_value: Any = None
    boost_amount: Any = None

@dataclasses.dataclass
class CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec:
...
@dataclasses.dataclass
class CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs:
    boost: Any = None
    boost_control_spec: Any = None
    condition: Any = None

@dataclasses.dataclass
class CesTool_DataStoreTool_BoostSpecs_Spec:
    condition_boost_specs: Any = None

@dataclasses.dataclass
class CesTool_DataStoreTool_BoostSpecs:
    data_stores: Any = None
    spec: Any = None

@dataclasses.dataclass
class CesTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfig:
...
@dataclasses.dataclass
class CesTool_DataStoreTool_DataStoreSource_DataStore:
...
@dataclasses.dataclass
class CesTool_DataStoreTool_DataStoreSource:
...
@dataclasses.dataclass
class CesTool_DataStoreTool_EngineSource:
...
@dataclasses.dataclass
class CesTool_DataStoreTool_ModalityConfigs_GroundingConfig:
    disabled: Any = None
    grounding_level: Any = None

@dataclasses.dataclass
class CesTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettings:
    model: Any = None
    temperature: Any = None

@dataclasses.dataclass
class CesTool_DataStoreTool_ModalityConfigs_RewriterConfig:
    disabled: Any = None
    model_settings: Any = None
    prompt: Any = None

@dataclasses.dataclass
class CesTool_DataStoreTool_ModalityConfigs_SnippetsConfig:
    enable_snippets: Any = None

@dataclasses.dataclass
class CesTool_DataStoreTool_ModalityConfigs:
...
@dataclasses.dataclass
class CesTool_GoogleSearchTool_PromptConfig:
...
@dataclasses.dataclass
class CesTool_GoogleSearchTool:
...
@dataclasses.dataclass
class CesTool_McpTool_ApiAuthentication_ApiKeyConfig:
...
@dataclasses.dataclass
class CesTool_McpTool_ApiAuthentication_BearerTokenConfig:
    # Required. The bearer token. Must be in the format `$context.variables.`.
    token: Any = None

@dataclasses.dataclass
class CesTool_McpTool_ApiAuthentication_OauthConfig:
...
@dataclasses.dataclass
class CesTool_McpTool_ApiAuthentication_ServiceAccountAuthConfig:
...
@dataclasses.dataclass
class CesTool_McpTool_ApiAuthentication:
...
@dataclasses.dataclass
class CesTool_McpTool_ServiceDirectoryConfig:
...
@dataclasses.dataclass
class CesTool_McpTool_TlsConfig_CaCerts:
    cert: Any = None
    display_name: Any = None

@dataclasses.dataclass
class CesTool_McpTool_TlsConfig:
    # Required. Specifies a list of allowed custom CA certificates for HTTPS verification.
    ca_certs: Any = None

@dataclasses.dataclass
class CesTool_McpTool:
...
@dataclasses.dataclass
class CesTool_RemoteAgentTool_AgentCard_Skills:
    description: Any = None
    examples: Any = None
    id: Any = None
...
@dataclasses.dataclass
class CesTool_RemoteAgentTool_AgentCard_SupportedInterfaces:
...
@dataclasses.dataclass
class CesTool_RemoteAgentTool_AgentCard:
...
@dataclasses.dataclass
class CesTool_ToolFakeConfig_CodeBlock:
...
@dataclasses.dataclass
class CesTool_WidgetTool_DataMapping:
...
@dataclasses.dataclass
class CesTool_WidgetTool_TextResponseConfig:
...
_CesTool_AgentToolFields = {
    "agent": ubx.FieldSpec(wire_name="agent"),
    "description": ubx.FieldSpec(wire_name="description"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_CesTool_ClientFunction_ParametersFields = {
...
_CesTool_ClientFunctionFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "name": ubx.FieldSpec(wire_name="name"),
    "parameters": ubx.FieldSpec(
        wire_name="parameters",
        kind="object",
        fields=_CesTool_ClientFunction_ParametersFields,
    ),
...
_CesTool_ConnectorTool_Action_EntityOperationFields = {
    "entity_id": ubx.FieldSpec(wire_name="entity_id"),
    "operation": ubx.FieldSpec(wire_name="operation"),
}

_CesTool_ConnectorTool_ActionFields = {
    ...
    "entity_operation": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesTool_ConnectorTool_Action_EntityOperationFields,
    ),
    "input_fields": ubx.FieldSpec(wire_name="input_fields"),
    "output_fields": ubx.FieldSpec(wire_name="output_fields"),
}

_CesTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfigFields = {
    "oauth_token": ubx.FieldSpec(wire_name="oauth_token"),
}

_CesTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfigFields = {
...
_CesTool_ConnectorTool_AuthConfigFields = {
    "oauth2_auth_code_config": ubx.FieldSpec(
        wire_name="oauth2_auth_code_config",
        kind="object",
        fields=_CesTool_ConnectorTool_AuthConfig_Oauth2AuthCodeConfigFields,
    ),
    "oauth2_jwt_bearer_config": ubx.FieldSpec(
        wire_name="oauth2_jwt_bearer_config",
        kind="object",
        fields=_CesTool_ConnectorTool_AuthConfig_Oauth2JwtBearerConfigFields,
    ),
}

_CesTool_ConnectorToolFields = {
    "action": ubx.FieldSpec(
        wire_name="action",
        kind="object",
        fields=_CesTool_ConnectorTool_ActionFields,
    ),
    "auth_config": ubx.FieldSpec(
        wire_name="auth_config",
        kind="object",
        fields=_CesTool_ConnectorTool_AuthConfigFields,
    ),
...
_CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPointsFields = {
    "attribute_value": ubx.FieldSpec(wire_name="attribute_value"),
    "boost_amount": ubx.FieldSpec(wire_name="boost_amount"),
}

_CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpecFields = {
    "attribute_type": ubx.FieldSpec(wire_name="attribute_type"),
    "control_points": ubx.FieldSpec(
        wire_name="control_points",
        kind="list",
        fields=_CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpec_ControlPointsFields,
    ),
    "field_name": ubx.FieldSpec(wire_name="field_name"),
    "interpolation_type": ubx.FieldSpec(wire_name="interpolation_type"),
}

_CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecsFields = {
    "boost": ubx.FieldSpec(wire_name="boost"),
    "boost_control_spec": ubx.FieldSpec(
        wire_name="boost_control_spec",
        kind="object",
        fields=_CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecs_BoostControlSpecFields,
    ),
    "condition": ubx.FieldSpec(wire_name="condition"),
}

_CesTool_DataStoreTool_BoostSpecs_SpecFields = {
    "condition_boost_specs": ubx.FieldSpec(
        wire_name="condition_boost_specs",
        kind="list",
        fields=_CesTool_DataStoreTool_BoostSpecs_Spec_ConditionBoostSpecsFields,
    ),
}

_CesTool_DataStoreTool_BoostSpecsFields = {
    "data_stores": ubx.FieldSpec(wire_name="data_stores"),
    "spec": ubx.FieldSpec(
        wire_name="spec",
        kind="list",
        fields=_CesTool_DataStoreTool_BoostSpecs_SpecFields,
    ),
}

_CesTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfigFields = {
...
_CesTool_DataStoreTool_DataStoreSource_DataStoreFields = {
    "connector_config": ubx.FieldSpec(
        wire_name="connector_config",
        kind="object",
        fields=_CesTool_DataStoreTool_DataStoreSource_DataStore_ConnectorConfigFields,
    ),
...
_CesTool_DataStoreTool_DataStoreSourceFields = {
    "data_store": ubx.FieldSpec(
        wire_name="data_store",
        kind="object",
        fields=_CesTool_DataStoreTool_DataStoreSource_DataStoreFields,
    ),
    "filter": ubx.FieldSpec(wire_name="filter"),
}

_CesTool_DataStoreTool_EngineSourceFields = {
    "data_store_sources": ubx.FieldSpec(
        wire_name="data_store_sources",
        kind="list",
        fields=_CesTool_DataStoreTool_DataStoreSourceFields,
    ),
    "engine": ubx.FieldSpec(wire_name="engine"),
    "filter": ubx.FieldSpec(wire_name="filter"),
}

_CesTool_DataStoreTool_ModalityConfigs_GroundingConfigFields = {
    "disabled": ubx.FieldSpec(wire_name="disabled"),
    "grounding_level": ubx.FieldSpec(wire_name="grounding_level"),
}

_CesTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettingsFields = {
    "model": ubx.FieldSpec(wire_name="model"),
    "temperature": ubx.FieldSpec(wire_name="temperature"),
}

_CesTool_DataStoreTool_ModalityConfigs_RewriterConfigFields = {
    "disabled": ubx.FieldSpec(wire_name="disabled"),
    "model_settings": ubx.FieldSpec(
        wire_name="model_settings",
        kind="object",
        fields=_CesTool_DataStoreTool_ModalityConfigs_RewriterConfig_ModelSettingsFields,
    ),
    "prompt": ubx.FieldSpec(wire_name="prompt"),
}

_CesTool_DataStoreTool_ModalityConfigs_SnippetsConfigFields = {
    "enable_snippets": ubx.FieldSpec(wire_name="enable_snippets"),
}

_CesTool_DataStoreTool_ModalityConfigsFields = {
    "grounding_config": ubx.FieldSpec(
        wire_name="grounding_config",
        kind="object",
        fields=_CesTool_DataStoreTool_ModalityConfigs_GroundingConfigFields,
    ),
    "modality_type": ubx.FieldSpec(wire_name="modality_type"),
    "rewriter_config": ubx.FieldSpec(
        wire_name="rewriter_config",
        kind="object",
        fields=_CesTool_DataStoreTool_ModalityConfigs_RewriterConfigFields,
    ),
    "snippets_config": ubx.FieldSpec(
        wire_name="snippets_config",
        kind="object",
        fields=_CesTool_DataStoreTool_ModalityConfigs_SnippetsConfigFields,
    ),
...
_CesTool_DataStoreToolFields = {
    "boost_specs": ubx.FieldSpec(
        wire_name="boost_specs",
        kind="list",
        fields=_CesTool_DataStoreTool_BoostSpecsFields,
    ),
    ...
    "engine_source": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesTool_DataStoreTool_EngineSourceFields,
    ),
    ...
    "modality_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_CesTool_DataStoreTool_ModalityConfigsFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
}

_CesTool_FileSearchToolFields = {
...
_CesTool_GoogleSearchToolFields = {
    ...
    "prompt_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesTool_GoogleSearchTool_PromptConfigFields,
    ),
}

_CesTool_McpTool_ApiAuthentication_ApiKeyConfigFields = {
...
_CesTool_McpTool_ApiAuthentication_BearerTokenConfigFields = {
    "token": ubx.FieldSpec(wire_name="token"),
}

_CesTool_McpTool_ApiAuthentication_OauthConfigFields = {
...
_CesTool_McpTool_ApiAuthentication_ServiceAccountAuthConfigFields = {
    "scopes": ubx.FieldSpec(wire_name="scopes"),
    "service_account": ubx.FieldSpec(wire_name="service_account"),
}

_CesTool_McpTool_ApiAuthenticationFields = {
    "api_key_config": ubx.FieldSpec(
        wire_name="api_key_config",
        kind="object",
        fields=_CesTool_McpTool_ApiAuthentication_ApiKeyConfigFields,
    ),
    "bearer_token_config": ubx.FieldSpec(
        wire_name="bearer_token_config",
        kind="object",
        fields=_CesTool_McpTool_ApiAuthentication_BearerTokenConfigFields,
    ),
    "oauth_config": ubx.FieldSpec(
        wire_name="oauth_config",
        kind="object",
        fields=_CesTool_McpTool_ApiAuthentication_OauthConfigFields,
    ),
    "service_account_auth_config": ubx.FieldSpec(
        wire_name="service_account_auth_config",
        kind="object",
        fields=_CesTool_McpTool_ApiAuthentication_ServiceAccountAuthConfigFields,
    ),
    "service_agent_id_token_auth_config": ubx.FieldSpec(wire_name="service_agent_id_token_auth_config"),
}

_CesTool_McpTool_ServiceDirectoryConfigFields = {
    "service": ubx.FieldSpec(wire_name="service"),
}

_CesTool_McpTool_TlsConfig_CaCertsFields = {
    "cert": ubx.FieldSpec(wire_name="cert"),
    "display_name": ubx.FieldSpec(wire_name="display_name"),
}

_CesTool_McpTool_TlsConfigFields = {
    "ca_certs": ubx.FieldSpec(
        wire_name="ca_certs",
        kind="list",
        fields=_CesTool_McpTool_TlsConfig_CaCertsFields,
    ),
}

_CesTool_McpToolFields = {
    "api_authentication": ubx.FieldSpec(
        wire_name="api_authentication",
        kind="object",
        fields=_CesTool_McpTool_ApiAuthenticationFields,
    ),
    ...
    "service_directory_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesTool_McpTool_ServiceDirectoryConfigFields,
    ),
    "state": ubx.FieldSpec(wire_name="state"),
    "tls_config": ubx.FieldSpec(
        wire_name="tls_config",
        kind="object",
        fields=_CesTool_McpTool_TlsConfigFields,
    ),
}

_CesTool_OpenApiToolFields = {
    "api_authentication": ubx.FieldSpec(
        wire_name="api_authentication",
        kind="object",
        fields=_CesTool_McpTool_ApiAuthenticationFields,
...
_CesTool_RemoteAgentTool_AgentCard_SkillsFields = {
    "description": ubx.FieldSpec(wire_name="description"),
...
_CesTool_RemoteAgentTool_AgentCard_SupportedInterfacesFields = {
...
_CesTool_RemoteAgentTool_AgentCardFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "name": ubx.FieldSpec(wire_name="name"),
    "skills": ubx.FieldSpec(
        wire_name="skills",
        kind="list",
        fields=_CesTool_RemoteAgentTool_AgentCard_SkillsFields,
    ),
    "supported_interfaces": ubx.FieldSpec(
        wire_name="supported_interfaces",
        kind="list",
        fields=_CesTool_RemoteAgentTool_AgentCard_SupportedInterfacesFields,
    ),
    "version": ubx.FieldSpec(wire_name="version"),
}

_CesTool_RemoteAgentToolFields = {
    "agent_card": ubx.FieldSpec(
        wire_name="agent_card",
        kind="object",
        fields=_CesTool_RemoteAgentTool_AgentCardFields,
    ),
    "description": ubx.FieldSpec(wire_name="description"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_CesTool_SystemToolFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_CesTool_ToolFakeConfig_CodeBlockFields = {
    "python_code": ubx.FieldSpec(wire_name="python_code"),
}

_CesTool_ToolFakeConfigFields = {
    "code_block": ubx.FieldSpec(
        wire_name="code_block",
        kind="object",
        fields=_CesTool_ToolFakeConfig_CodeBlockFields,
    ),
    "enable_fake_mode": ubx.FieldSpec(wire_name="enable_fake_mode"),
}

_CesTool_WidgetTool_DataMappingFields = {
...
_CesTool_WidgetToolFields = {
    "data_mapping": ubx.FieldSpec(
        wire_name="data_mapping",
        kind="object",
        fields=_CesTool_WidgetTool_DataMappingFields,
    ),
    "description": ubx.FieldSpec(wire_name="description"),
    "name": ubx.FieldSpec(wire_name="name"),
    "parameters": ubx.FieldSpec(
    ...
    "text_response_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesTool_WidgetTool_TextResponseConfigFields,
    ),
