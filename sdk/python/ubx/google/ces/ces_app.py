...
class CesApp_AudioProcessingConfig_AmbientSoundConfig:
...
@dataclasses.dataclass
class CesApp_AudioProcessingConfig_BargeInConfig:
...
@dataclasses.dataclass
class CesApp_AudioProcessingConfig_SynthesizeSpeechConfigs:
...
@dataclasses.dataclass
class CesApp_AudioProcessingConfig:
...
@dataclasses.dataclass
class CesApp_ClientCertificateSettings:
...
@dataclasses.dataclass
class CesApp_DataStoreSettings_Engines:
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class CesApp_DataStoreSettings:
    # Output only. The engines for the app.
    engines: Any = None

@dataclasses.dataclass
class CesApp_DefaultChannelProfile_InstagramConfig:
...
@dataclasses.dataclass
class CesApp_DefaultChannelProfile_PersonaProperty:
    # Optional. The persona of the channel.
    persona: Any = None

@dataclasses.dataclass
class CesApp_DefaultChannelProfile_WebWidgetConfig_SecuritySettings:
...
@dataclasses.dataclass
class CesApp_DefaultChannelProfile_WebWidgetConfig:
...
@dataclasses.dataclass
class CesApp_DefaultChannelProfile_WhatsappConfig:
    # Output only. The description of the Meta business page or profile.
    description: Any = None
    # Output only. The fetched Meta business page name.
    display_name: Any = None
...
@dataclasses.dataclass
class CesApp_DefaultChannelProfile:
...
@dataclasses.dataclass
class CesApp_ErrorHandlingSettings_EndSessionConfig:
...
@dataclasses.dataclass
class CesApp_ErrorHandlingSettings_FallbackResponseConfig:
...
@dataclasses.dataclass
class CesApp_ErrorHandlingSettings:
...
@dataclasses.dataclass
class CesApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholds:
...
@dataclasses.dataclass
class CesApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ToolMatchingSettings:
    # Optional. Behavior for extra tool calls. Defaults to FAIL.
    extra_tool_call_behavior: Any = None

@dataclasses.dataclass
class CesApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholds:
...
@dataclasses.dataclass
class CesApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds:
...
@dataclasses.dataclass
class CesApp_EvaluationMetricsThresholds:
...
@dataclasses.dataclass
class CesApp_LoggingSettings_AudioRecordingConfig:
...
@dataclasses.dataclass
class CesApp_LoggingSettings_BigqueryExportSettings:
...
@dataclasses.dataclass
class CesApp_LoggingSettings_CloudLoggingSettings:
    # Optional. Whether to enable Cloud Logging for the sessions.
    enable_cloud_logging: Any = None

@dataclasses.dataclass
class CesApp_LoggingSettings_ConversationLoggingSettings:
...
@dataclasses.dataclass
class CesApp_LoggingSettings_MetricAnalysisSettings:
...
@dataclasses.dataclass
class CesApp_LoggingSettings_RedactionConfig:
...
@dataclasses.dataclass
class CesApp_PredefinedVariableDeclarations_Schema:
...
@dataclasses.dataclass
class CesApp_PredefinedVariableDeclarations:
    description: Any = None
    name: Any = None
    schema: Any = None

@dataclasses.dataclass
class CesApp_TimeZoneSettings:
...
_CesApp_AudioProcessingConfig_AmbientSoundConfigFields = {
...
_CesApp_AudioProcessingConfigFields = {
    "ambient_sound_config": ubx.FieldSpec(
        wire_name="ambient_sound_config",
        kind="object",
        fields=_CesApp_AudioProcessingConfig_AmbientSoundConfigFields,
    ),
    "barge_in_config": ubx.FieldSpec(
        wire_name="barge_in_config",
        kind="object",
        fields=_CesApp_AudioProcessingConfig_BargeInConfigFields,
    ),
    ...
    "synthesize_speech_configs": ubx.FieldSpec(
        ...
        kind="map",
        fields=_CesApp_AudioProcessingConfig_SynthesizeSpeechConfigsFields,
    ),
}

_CesApp_ClientCertificateSettingsFields = {
...
_CesApp_DataStoreSettings_EnginesFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_CesApp_DataStoreSettingsFields = {
    "engines": ubx.FieldSpec(
        wire_name="engines",
        kind="list",
        fields=_CesApp_DataStoreSettings_EnginesFields,
    ),
}

_CesApp_DefaultChannelProfile_InstagramConfigFields = {
...
_CesApp_DefaultChannelProfile_PersonaPropertyFields = {
    "persona": ubx.FieldSpec(wire_name="persona"),
}

_CesApp_DefaultChannelProfile_WebWidgetConfig_SecuritySettingsFields = {
...
_CesApp_DefaultChannelProfileFields = {
    ...
    "instagram_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesApp_DefaultChannelProfile_InstagramConfigFields,
    ),
    ...
    "persona_property": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesApp_DefaultChannelProfile_PersonaPropertyFields,
    ),
    "profile_id": ubx.FieldSpec(wire_name="profile_id"),
    "web_widget_config": ubx.FieldSpec(
        wire_name="web_widget_config",
        kind="object",
        fields=_CesApp_DefaultChannelProfile_WebWidgetConfigFields,
    ),
    "whatsapp_config": ubx.FieldSpec(
        wire_name="whatsapp_config",
        kind="object",
        fields=_CesApp_DefaultChannelProfile_WhatsappConfigFields,
    ),
}

_CesApp_ErrorHandlingSettings_EndSessionConfigFields = {
    "escalate_session": ubx.FieldSpec(wire_name="escalate_session"),
}

_CesApp_ErrorHandlingSettings_FallbackResponseConfigFields = {
...
_CesApp_ErrorHandlingSettingsFields = {
    "end_session_config": ubx.FieldSpec(
        wire_name="end_session_config",
        kind="object",
        fields=_CesApp_ErrorHandlingSettings_EndSessionConfigFields,
    ),
    ...
    "fallback_response_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesApp_ErrorHandlingSettings_FallbackResponseConfigFields,
    ),
}

_CesApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholdsFields = {
    "tool_invocation_parameter_correctness_threshold": ubx.FieldSpec(wire_name="tool_invocation_parameter_correctness_threshold"),
}

_CesApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ToolMatchingSettingsFields = {
    "extra_tool_call_behavior": ubx.FieldSpec(wire_name="extra_tool_call_behavior"),
}

_CesApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholdsFields = {
...
_CesApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholdsFields = {
    "expectation_level_metrics_thresholds": ubx.FieldSpec(
        wire_name="expectation_level_metrics_thresholds",
        kind="object",
        fields=_CesApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ExpectationLevelMetricsThresholdsFields,
    ),
    "tool_matching_settings": ubx.FieldSpec(
        wire_name="tool_matching_settings",
        kind="object",
        fields=_CesApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_ToolMatchingSettingsFields,
    ),
    "turn_level_metrics_thresholds": ubx.FieldSpec(
        wire_name="turn_level_metrics_thresholds",
        kind="object",
        fields=_CesApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholds_TurnLevelMetricsThresholdsFields,
    ),
}

_CesApp_EvaluationMetricsThresholdsFields = {
    "golden_evaluation_metrics_thresholds": ubx.FieldSpec(
        wire_name="golden_evaluation_metrics_thresholds",
        kind="object",
        fields=_CesApp_EvaluationMetricsThresholds_GoldenEvaluationMetricsThresholdsFields,
    ),
...
_CesApp_LanguageSettingsFields = {
...
_CesApp_LoggingSettings_MetricAnalysisSettingsFields = {
    "llm_metrics_opted_out": ubx.FieldSpec(wire_name="llm_metrics_opted_out"),
}

_CesApp_LoggingSettings_RedactionConfigFields = {
...
_CesApp_LoggingSettingsFields = {
    ...
    "metric_analysis_settings": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesApp_LoggingSettings_MetricAnalysisSettingsFields,
    ),
    "redaction_config": ubx.FieldSpec(
        wire_name="redaction_config",
        kind="object",
        fields=_CesApp_LoggingSettings_RedactionConfigFields,
    ),
...
_CesApp_ModelSettingsFields = {
    "model": ubx.FieldSpec(wire_name="model"),
    "temperature": ubx.FieldSpec(wire_name="temperature"),
}

_CesApp_PredefinedVariableDeclarations_SchemaFields = {
...
_CesApp_PredefinedVariableDeclarationsFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "name": ubx.FieldSpec(wire_name="name"),
    "schema": ubx.FieldSpec(
        wire_name="schema",
        kind="object",
        fields=_CesApp_PredefinedVariableDeclarations_SchemaFields,
    ),
}

_CesApp_TimeZoneSettingsFields = {
    "time_zone": ubx.FieldSpec(wire_name="time_zone"),
}

_CesApp_VpcScSettingsFields = {
    "allowed_origins": ubx.FieldSpec(wire_name="allowed_origins"),
}
...
CesApp = ubx.ResourceBinding(
    ...
    fields={
        ...
        "error_handling_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CesApp_ErrorHandlingSettingsFields,
        ),
        "etag": ubx.FieldSpec(wire_name="etag"),
        "evaluation_metrics_thresholds": ubx.FieldSpec(
            wire_name="evaluation_metrics_thresholds",
            kind="object",
            fields=_CesApp_EvaluationMetricsThresholdsFields,
        ),
        ...
        "vpc_sc_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CesApp_VpcScSettingsFields,
        ),
    },
)
