...
class V1betaCesV1betaAgent_AfterAgentCallbacks:
...
@dataclasses.dataclass
class V1betaCesV1betaAgent_ModelSettings:
...
@dataclasses.dataclass
class V1betaCesV1betaAgent_RemoteDialogflowAgent:
...
@dataclasses.dataclass
class V1betaCesV1betaAgent_Toolsets:
    tool_ids: Any = None
    toolset: Any = None

@dataclasses.dataclass
class V1betaCesV1betaAgent_TransferRules_DeterministicTransfer_ExpressionCondition:
    expression: Any = None

@dataclasses.dataclass
class V1betaCesV1betaAgent_TransferRules_DeterministicTransfer_PythonCodeCondition:
    python_code: Any = None

@dataclasses.dataclass
class V1betaCesV1betaAgent_TransferRules_DeterministicTransfer:
    expression_condition: Any = None
    python_code_condition: Any = None

@dataclasses.dataclass
class V1betaCesV1betaAgent_TransferRules_DisablePlannerTransfer:
    expression_condition: Any = None

@dataclasses.dataclass
class V1betaCesV1betaAgent_TransferRules:
    child_agent: Any = None
    deterministic_transfer: Any = None
    direction: Any = None
    disable_planner_transfer: Any = None

_V1betaCesV1betaAgent_AfterAgentCallbacksFields = {
...
_V1betaCesV1betaAgent_ModelSettingsFields = {
    "model": ubx.FieldSpec(wire_name="model"),
    "temperature": ubx.FieldSpec(wire_name="temperature"),
}

_V1betaCesV1betaAgent_RemoteDialogflowAgentFields = {
...
_V1betaCesV1betaAgent_ToolsetsFields = {
    "tool_ids": ubx.FieldSpec(wire_name="tool_ids"),
    "toolset": ubx.FieldSpec(wire_name="toolset"),
}

_V1betaCesV1betaAgent_TransferRules_DeterministicTransfer_ExpressionConditionFields = {
    "expression": ubx.FieldSpec(wire_name="expression"),
}

_V1betaCesV1betaAgent_TransferRules_DeterministicTransfer_PythonCodeConditionFields = {
    "python_code": ubx.FieldSpec(wire_name="python_code"),
}

_V1betaCesV1betaAgent_TransferRules_DeterministicTransferFields = {
    "expression_condition": ubx.FieldSpec(
        wire_name="expression_condition",
        kind="object",
        fields=_V1betaCesV1betaAgent_TransferRules_DeterministicTransfer_ExpressionConditionFields,
    ),
    "python_code_condition": ubx.FieldSpec(
        wire_name="python_code_condition",
        kind="object",
        fields=_V1betaCesV1betaAgent_TransferRules_DeterministicTransfer_PythonCodeConditionFields,
    ),
}

_V1betaCesV1betaAgent_TransferRules_DisablePlannerTransferFields = {
    "expression_condition": ubx.FieldSpec(
        wire_name="expression_condition",
        kind="object",
        fields=_V1betaCesV1betaAgent_TransferRules_DeterministicTransfer_ExpressionConditionFields,
...
@dataclasses.dataclass
class V1betaCesV1betaAgentAttrs:
    # Optional. The callbacks to execute after the agent is called. The provided callbacks are executed sequentially in the exact order they are given in the list. If a callback returns an overridden response, execution stops and any remaining callbacks are skipped.
    after_agent_callbacks: Any = None
    # Optional. The callbacks to execute after the model is called. If there are multiple calls to the model, the callback will be executed multiple times. The provided callbacks are executed sequentially in the exact order they are given in the list. If a callback returns an overridden response, execution stops and any remaining callbacks are skipped.
    after_model_callbacks: Any = None
...
V1betaCesV1betaAgent = ubx.ResourceBinding(
    wire_type="google_ces_v1beta_ces_v1beta_agent",
    fields={
        "after_agent_callbacks": ubx.FieldSpec(
            wire_name="after_agent_callbacks",
            kind="list",
            fields=_V1betaCesV1betaAgent_AfterAgentCallbacksFields,
        ),
        ...
        "model_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaCesV1betaAgent_ModelSettingsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "remote_dialogflow_agent": ubx.FieldSpec(
            wire_name="remote_dialogflow_agent",
            kind="object",
            fields=_V1betaCesV1betaAgent_RemoteDialogflowAgentFields,
        ),
        "tools": ubx.FieldSpec(wire_name="tools"),
        "toolsets": ubx.FieldSpec(
            wire_name="toolsets",
            kind="list",
            fields=_V1betaCesV1betaAgent_ToolsetsFields,
        ),
        "transfer_rules": ubx.FieldSpec(
            wire_name="transfer_rules",
            kind="list",
            fields=_V1betaCesV1betaAgent_TransferRulesFields,
        ),
