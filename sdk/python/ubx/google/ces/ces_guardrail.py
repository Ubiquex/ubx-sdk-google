...
class CesGuardrail_Action_GenerativeAnswer:
    # Required. The prompt to use for the generative answer.
    prompt: Any = None

@dataclasses.dataclass
class CesGuardrail_Action_RespondImmediately_Responses:
    disabled: Any = None
    text: Any = None

@dataclasses.dataclass
class CesGuardrail_Action_RespondImmediately:
    # Required. The canned responses for the agent to choose from. The response is chosen randomly.
    responses: Any = None

@dataclasses.dataclass
class CesGuardrail_Action_TransferAgent:
...
@dataclasses.dataclass
class CesGuardrail_CodeCallback_AfterAgentCallback:
...
@dataclasses.dataclass
class CesGuardrail_CodeCallback:
...
@dataclasses.dataclass
class CesGuardrail_ContentFilter:
...
@dataclasses.dataclass
class CesGuardrail_LlmPolicy_ModelSettings:
...
@dataclasses.dataclass
class CesGuardrail_LlmPromptSecurity_DefaultSettings:
...
@dataclasses.dataclass
class CesGuardrail_LlmPromptSecurity:
...
@dataclasses.dataclass
class CesGuardrail_ModelSafety_SafetySettings:
    category: Any = None
    threshold: Any = None

@dataclasses.dataclass
class CesGuardrail_ModelSafety:
    # Required. List of safety settings.
    safety_settings: Any = None

_CesGuardrail_Action_GenerativeAnswerFields = {
    "prompt": ubx.FieldSpec(wire_name="prompt"),
}

_CesGuardrail_Action_RespondImmediately_ResponsesFields = {
    "disabled": ubx.FieldSpec(wire_name="disabled"),
    "text": ubx.FieldSpec(wire_name="text"),
}

_CesGuardrail_Action_RespondImmediatelyFields = {
    "responses": ubx.FieldSpec(
        wire_name="responses",
        kind="list",
        fields=_CesGuardrail_Action_RespondImmediately_ResponsesFields,
    ),
}

_CesGuardrail_Action_TransferAgentFields = {
    "agent": ubx.FieldSpec(wire_name="agent"),
}

_CesGuardrail_ActionFields = {
    "generative_answer": ubx.FieldSpec(
        wire_name="generative_answer",
        kind="object",
        fields=_CesGuardrail_Action_GenerativeAnswerFields,
    ),
    "respond_immediately": ubx.FieldSpec(
        wire_name="respond_immediately",
        kind="object",
        fields=_CesGuardrail_Action_RespondImmediatelyFields,
    ),
    "transfer_agent": ubx.FieldSpec(
        wire_name="transfer_agent",
        kind="object",
        fields=_CesGuardrail_Action_TransferAgentFields,
    ),
}

_CesGuardrail_CodeCallback_AfterAgentCallbackFields = {
...
_CesGuardrail_CodeCallbackFields = {
    "after_agent_callback": ubx.FieldSpec(
        wire_name="after_agent_callback",
        kind="object",
        fields=_CesGuardrail_CodeCallback_AfterAgentCallbackFields,
    ),
...
_CesGuardrail_ContentFilterFields = {
...
_CesGuardrail_LlmPolicyFields = {
    ...
    "model_settings": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CesGuardrail_LlmPolicy_ModelSettingsFields,
    ),
    "policy_scope": ubx.FieldSpec(wire_name="policy_scope"),
    "prompt": ubx.FieldSpec(wire_name="prompt"),
}

_CesGuardrail_LlmPromptSecurity_DefaultSettingsFields = {
    "default_prompt_template": ubx.FieldSpec(wire_name="default_prompt_template"),
}

_CesGuardrail_LlmPromptSecurityFields = {
    "custom_policy": ubx.FieldSpec(
        wire_name="custom_policy",
        kind="object",
        fields=_CesGuardrail_LlmPolicyFields,
    ),
    "default_settings": ubx.FieldSpec(
        wire_name="default_settings",
        kind="object",
        fields=_CesGuardrail_LlmPromptSecurity_DefaultSettingsFields,
    ),
    "fail_open": ubx.FieldSpec(wire_name="fail_open"),
}

_CesGuardrail_ModelSafety_SafetySettingsFields = {
    "category": ubx.FieldSpec(wire_name="category"),
    "threshold": ubx.FieldSpec(wire_name="threshold"),
}

_CesGuardrail_ModelSafetyFields = {
    "safety_settings": ubx.FieldSpec(
        wire_name="safety_settings",
        kind="list",
        fields=_CesGuardrail_ModelSafety_SafetySettingsFields,
    ),
}

@dataclasses.dataclass
class CesGuardrailConfig:
...
CesGuardrail = ubx.ResourceBinding(
    wire_type="google_ces_ces_guardrail",
    fields={
        "action": ubx.FieldSpec(
            wire_name="action",
            kind="object",
            fields=_CesGuardrail_ActionFields,
        ),
        "code_callback": ubx.FieldSpec(
            wire_name="code_callback",
            kind="object",
            fields=_CesGuardrail_CodeCallbackFields,
        ),
        "content_filter": ubx.FieldSpec(
            wire_name="content_filter",
            kind="object",
            fields=_CesGuardrail_ContentFilterFields,
        ),
        ...
        "llm_prompt_security": ubx.FieldSpec(
            ...
            kind="object",
            fields=_CesGuardrail_LlmPromptSecurityFields,
        ),
        "model_safety": ubx.FieldSpec(
            wire_name="model_safety",
            kind="object",
            fields=_CesGuardrail_ModelSafetyFields,
        ),
