...
class V1alphaAlloydbV1alphaBackup_EncryptionConfig:
    # The fully-qualified resource name of the KMS key. Each Cloud KMS key is regionalized and has the following format: projects/[PROJECT]/locations/[REGION]/keyRings/[RING]/cryptoKeys/[KEY_NAME]
    kms_key_name: Any = None

@dataclasses.dataclass
class V1alphaAlloydbV1alphaBackup_EncryptionInfo:
...
@dataclasses.dataclass
class V1alphaAlloydbV1alphaBackupConfig:
...
@dataclasses.dataclass
class V1alphaAlloydbV1alphaBackupAttrs:
    # Annotations to allow client tools to store small amount of arbitrary data. This is distinct from labels. https://google.aip.dev/128
    annotations: Any = None
    # Output only. Set to true if the cluster corresponding to this backup is deleted. This field is only populated for when using the BACKUP_VIEW_CLUSTER_DELETED view.
    cluster_deleted: Any = None
...
V1alphaAlloydbV1alphaBackup = ubx.ResourceBinding(
    wire_type="google_alloydb_v1alpha_alloydb_v1alpha_backup",
    fields={
        ...
        "encryption_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1alphaAlloydbV1alphaBackup_EncryptionConfigFields,
        ),
        "encryption_info": ubx.FieldSpec(
            wire_name="encryption_info",
            kind="object",
            fields=_V1alphaAlloydbV1alphaBackup_EncryptionInfoFields,
        ),
        "etag": ubx.FieldSpec(wire_name="etag"),
        "expiry_quantity": ubx.FieldSpec(
            wire_name="expiry_quantity",
            kind="object",
            fields=_V1alphaAlloydbV1alphaBackup_ExpiryQuantityFields,
        ),
