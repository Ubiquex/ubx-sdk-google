...
class V1betaAlloydbV1betaEndpoint_DnsConfig:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaEndpointAttrs:
    # Annotations to allow client tools to store small amount of arbitrary data. This is distinct from labels. https://google.aip.dev/128
    annotations: Any = None
    # Output only. Create time stamp
    create_time: Any = None
...
V1betaAlloydbV1betaEndpoint = ubx.ResourceBinding(
    wire_type="google_alloydb_v1beta_alloydb_v1beta_endpoint",
    fields={
        ...
        "dns_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaAlloydbV1betaEndpoint_DnsConfigFields,
        ),
