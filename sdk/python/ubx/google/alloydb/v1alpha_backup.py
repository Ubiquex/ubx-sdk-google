...
class V1alphaBackup_EncryptionConfig:
    # The fully-qualified resource name of the KMS key. Each Cloud KMS key is regionalized and has the following format: projects/[PROJECT]/locations/[REGION]/keyRings/[RING]/cryptoKeys/[KEY_NAME]
    kms_key_name: Any = None

@dataclasses.dataclass
class V1alphaBackup_EncryptionInfo:
...
V1alphaBackup = ubx.ResourceBinding(
    wire_type="google_alloydb_v1alpha_backup",
    fields={
        ...
        "encryption_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1alphaBackup_EncryptionConfigFields,
        ),
        "encryption_info": ubx.FieldSpec(
            wire_name="encryption_info",
            kind="object",
            fields=_V1alphaBackup_EncryptionInfoFields,
        ),
        "etag": ubx.FieldSpec(wire_name="etag"),
        "expiry_quantity": ubx.FieldSpec(
            wire_name="expiry_quantity",
            kind="object",
            fields=_V1alphaBackup_ExpiryQuantityFields,
        ),
