...
class V1betaAlloydbV1betaInstance_ClientConnectionConfig_SslConfig:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_ClientConnectionConfig:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_ConnectionPoolConfig:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_NetworkConfig_AuthorizedExternalNetworks:
    cidr_range: Any = None

@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_NetworkConfig:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_Nodes:
    id: Any = None
    ip: Any = None
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_ObservabilityConfig:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_PscInstanceConfig_PscAutoConnections:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_PscInstanceConfig_PscInterfaceConfigs:
    network_attachment_resource: Any = None

@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_PscInstanceConfig:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_PscInstanceInfo:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_QueryInsightsConfig:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilization:
    # Target CPU utilization as a float between 0 and 1.
    utilization_target: Any = None

@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_ReadPoolConfig_AutoScalingConfig_Policy:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_ReadPoolConfig_AutoScalingConfig_Schedules:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_ReadPoolConfig_AutoScalingConfig:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_ReadPoolConfig:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstance_UpdatePolicy:
    # Mode for updating the instance.
    mode: Any = None

_V1betaAlloydbV1betaInstance_ClientConnectionConfig_SslConfigFields = {
    "ca_source": ubx.FieldSpec(wire_name="ca_source"),
    "ssl_mode": ubx.FieldSpec(wire_name="ssl_mode"),
}

_V1betaAlloydbV1betaInstance_ClientConnectionConfigFields = {
    "require_connectors": ubx.FieldSpec(wire_name="require_connectors"),
    "ssl_config": ubx.FieldSpec(
        wire_name="ssl_config",
        kind="object",
        fields=_V1betaAlloydbV1betaInstance_ClientConnectionConfig_SslConfigFields,
    ),
}

_V1betaAlloydbV1betaInstance_ConnectionPoolConfigFields = {
...
_V1betaAlloydbV1betaInstance_GcaConfigFields = {
    "gca_entitlement": ubx.FieldSpec(wire_name="gca_entitlement"),
}

_V1betaAlloydbV1betaInstance_GeminiConfigFields = {
    "entitled": ubx.FieldSpec(wire_name="entitled"),
}

_V1betaAlloydbV1betaInstance_MachineConfigFields = {
    "cpu_count": ubx.FieldSpec(wire_name="cpu_count"),
    "machine_type": ubx.FieldSpec(wire_name="machine_type"),
}

_V1betaAlloydbV1betaInstance_NetworkConfig_AuthorizedExternalNetworksFields = {
    "cidr_range": ubx.FieldSpec(wire_name="cidr_range"),
}

_V1betaAlloydbV1betaInstance_NetworkConfigFields = {
    ...
    "authorized_external_networks": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1betaAlloydbV1betaInstance_NetworkConfig_AuthorizedExternalNetworksFields,
    ),
...
_V1betaAlloydbV1betaInstance_NodesFields = {
...
_V1betaAlloydbV1betaInstance_ObservabilityConfigFields = {
...
_V1betaAlloydbV1betaInstance_PscInstanceConfig_PscAutoConnectionsFields = {
...
_V1betaAlloydbV1betaInstance_PscInstanceConfig_PscInterfaceConfigsFields = {
    "network_attachment_resource": ubx.FieldSpec(wire_name="network_attachment_resource"),
}

_V1betaAlloydbV1betaInstance_PscInstanceConfigFields = {
    ...
    "psc_auto_connections": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1betaAlloydbV1betaInstance_PscInstanceConfig_PscAutoConnectionsFields,
    ),
    ...
    "psc_interface_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1betaAlloydbV1betaInstance_PscInstanceConfig_PscInterfaceConfigsFields,
    ),
    "service_attachment_link": ubx.FieldSpec(wire_name="service_attachment_link"),
}

_V1betaAlloydbV1betaInstance_PscInstanceInfoFields = {
...
_V1betaAlloydbV1betaInstance_QueryInsightsConfigFields = {
    "query_plans_per_minute": ubx.FieldSpec(wire_name="query_plans_per_minute"),
...
_V1betaAlloydbV1betaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilizationFields = {
    "utilization_target": ubx.FieldSpec(wire_name="utilization_target"),
}

_V1betaAlloydbV1betaInstance_ReadPoolConfig_AutoScalingConfig_PolicyFields = {
    "cool_down_period_sec": ubx.FieldSpec(wire_name="cool_down_period_sec"),
    "cpu_utilization": ubx.FieldSpec(
        wire_name="cpu_utilization",
        kind="object",
        fields=_V1betaAlloydbV1betaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilizationFields,
    ),
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "max_node_count": ubx.FieldSpec(wire_name="max_node_count"),
}

_V1betaAlloydbV1betaInstance_ReadPoolConfig_AutoScalingConfig_SchedulesFields = {
...
_V1betaAlloydbV1betaInstance_ReadPoolConfig_AutoScalingConfigFields = {
    "policy": ubx.FieldSpec(
        wire_name="policy",
        kind="object",
        fields=_V1betaAlloydbV1betaInstance_ReadPoolConfig_AutoScalingConfig_PolicyFields,
    ),
    "schedules": ubx.FieldSpec(
        wire_name="schedules",
        kind="list",
        fields=_V1betaAlloydbV1betaInstance_ReadPoolConfig_AutoScalingConfig_SchedulesFields,
    ),
}

_V1betaAlloydbV1betaInstance_ReadPoolConfigFields = {
    "auto_scaling_config": ubx.FieldSpec(
        wire_name="auto_scaling_config",
        kind="object",
        fields=_V1betaAlloydbV1betaInstance_ReadPoolConfig_AutoScalingConfigFields,
    ),
    "node_count": ubx.FieldSpec(wire_name="node_count"),
}

_V1betaAlloydbV1betaInstance_UpdatePolicyFields = {
    "mode": ubx.FieldSpec(wire_name="mode"),
}

@dataclasses.dataclass
class V1betaAlloydbV1betaInstanceConfig:
...
@dataclasses.dataclass
class V1betaAlloydbV1betaInstanceAttrs:
    # Optional. Specifies whether an instance needs to spin up. Once the instance is active, the activation policy can be updated to the `NEVER` to stop the instance. Likewise, the activation policy can be updated to `ALWAYS` to start the instance. There are restrictions around when an instance can/cannot be activated (for example, a read pool instance should be stopped before stopping primary etc.). Please refer to the API documentation for more details.
    activation_policy: Any = None
    # Annotations to allow client tools to store small amount of arbitrary data. This is distinct from labels. https://google.aip.dev/128
    annotations: Any = None
...
V1betaAlloydbV1betaInstance = ubx.ResourceBinding(
    wire_type="google_alloydb_v1beta_alloydb_v1beta_instance",
    fields={
        ...
        "client_connection_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaAlloydbV1betaInstance_ClientConnectionConfigFields,
        ),
        "connection_pool_config": ubx.FieldSpec(
            wire_name="connection_pool_config",
            kind="object",
            fields=_V1betaAlloydbV1betaInstance_ConnectionPoolConfigFields,
        ),
        ...
        "gca_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaAlloydbV1betaInstance_GcaConfigFields,
        ),
        "gce_zone": ubx.FieldSpec(wire_name="gce_zone"),
        "gemini_config": ubx.FieldSpec(
            wire_name="gemini_config",
            kind="object",
            fields=_V1betaAlloydbV1betaInstance_GeminiConfigFields,
        ),
        ...
        "machine_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaAlloydbV1betaInstance_MachineConfigFields,
        ),
        ...
        "network_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaAlloydbV1betaInstance_NetworkConfigFields,
        ),
        "nodes": ubx.FieldSpec(
            wire_name="nodes",
            kind="list",
            fields=_V1betaAlloydbV1betaInstance_NodesFields,
        ),
        "observability_config": ubx.FieldSpec(
            wire_name="observability_config",
            kind="object",
            fields=_V1betaAlloydbV1betaInstance_ObservabilityConfigFields,
        ),
        ...
        "psc_instance_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaAlloydbV1betaInstance_PscInstanceConfigFields,
        ),
        "psc_instance_info": ubx.FieldSpec(
            wire_name="psc_instance_info",
            kind="object",
            fields=_V1betaAlloydbV1betaInstance_PscInstanceInfoFields,
        ),
        ...
        "query_insights_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaAlloydbV1betaInstance_QueryInsightsConfigFields,
        ),
        "read_pool_config": ubx.FieldSpec(
            wire_name="read_pool_config",
            kind="object",
            fields=_V1betaAlloydbV1betaInstance_ReadPoolConfigFields,
        ),
        ...
        "update_policy": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaAlloydbV1betaInstance_UpdatePolicyFields,
        ),
