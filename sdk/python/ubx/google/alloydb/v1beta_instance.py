...
class V1betaInstance_ClientConnectionConfig_SslConfig:
...
@dataclasses.dataclass
class V1betaInstance_ClientConnectionConfig:
...
@dataclasses.dataclass
class V1betaInstance_ConnectionPoolConfig:
...
@dataclasses.dataclass
class V1betaInstance_NetworkConfig_AuthorizedExternalNetworks:
    cidr_range: Any = None

@dataclasses.dataclass
class V1betaInstance_NetworkConfig:
...
@dataclasses.dataclass
class V1betaInstance_ObservabilityConfig:
...
@dataclasses.dataclass
class V1betaInstance_PscInstanceConfig_PscAutoConnections_DnsAutomationInfos:
    fully_qualified_domain_name: Any = None
    state: Any = None

@dataclasses.dataclass
class V1betaInstance_PscInstanceConfig_PscAutoConnections:
...
@dataclasses.dataclass
class V1betaInstance_PscInstanceConfig_PscInterfaceConfigs:
    network_attachment_resource: Any = None

@dataclasses.dataclass
class V1betaInstance_PscInstanceConfig:
...
@dataclasses.dataclass
class V1betaInstance_PscInstanceInfo:
...
@dataclasses.dataclass
class V1betaInstance_QueryInsightsConfig:
...
@dataclasses.dataclass
class V1betaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilization:
    # Target CPU utilization as a float between 0 and 1.
    utilization_target: Any = None

@dataclasses.dataclass
class V1betaInstance_ReadPoolConfig_AutoScalingConfig_Policy:
...
@dataclasses.dataclass
class V1betaInstance_ReadPoolConfig_AutoScalingConfig_Schedules:
...
@dataclasses.dataclass
class V1betaInstance_ReadPoolConfig_AutoScalingConfig:
...
@dataclasses.dataclass
class V1betaInstance_ReadPoolConfig:
...
@dataclasses.dataclass
class V1betaInstance_UpdatePolicy:
    # Mode for updating the instance.
    mode: Any = None

_V1betaInstance_ClientConnectionConfig_SslConfigFields = {
    "ca_source": ubx.FieldSpec(wire_name="ca_source"),
    "ssl_mode": ubx.FieldSpec(wire_name="ssl_mode"),
}

_V1betaInstance_ClientConnectionConfigFields = {
    "require_connectors": ubx.FieldSpec(wire_name="require_connectors"),
    "ssl_config": ubx.FieldSpec(
        wire_name="ssl_config",
        kind="object",
        fields=_V1betaInstance_ClientConnectionConfig_SslConfigFields,
    ),
}

_V1betaInstance_ConnectionPoolConfigFields = {
...
_V1betaInstance_NetworkConfigFields = {
    ...
    "authorized_external_networks": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1betaInstance_NetworkConfig_AuthorizedExternalNetworksFields,
    ),
...
_V1betaInstance_PscInstanceConfig_PscAutoConnections_DnsAutomationInfosFields = {
    "fully_qualified_domain_name": ubx.FieldSpec(wire_name="fully_qualified_domain_name"),
    "state": ubx.FieldSpec(wire_name="state"),
}

_V1betaInstance_PscInstanceConfig_PscAutoConnectionsFields = {
    ...
    "dns_automation_infos": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1betaInstance_PscInstanceConfig_PscAutoConnections_DnsAutomationInfosFields,
    ),
...
_V1betaInstance_PscInstanceConfig_PscInterfaceConfigsFields = {
    "network_attachment_resource": ubx.FieldSpec(wire_name="network_attachment_resource"),
}

_V1betaInstance_PscInstanceConfigFields = {
    ...
    "psc_auto_connections": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1betaInstance_PscInstanceConfig_PscAutoConnectionsFields,
    ),
    ...
    "psc_interface_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1betaInstance_PscInstanceConfig_PscInterfaceConfigsFields,
    ),
    "service_attachment_link": ubx.FieldSpec(wire_name="service_attachment_link"),
}

_V1betaInstance_PscInstanceInfoFields = {
...
_V1betaInstance_QueryInsightsConfigFields = {
    "query_plans_per_minute": ubx.FieldSpec(wire_name="query_plans_per_minute"),
...
_V1betaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilizationFields = {
    "utilization_target": ubx.FieldSpec(wire_name="utilization_target"),
}

_V1betaInstance_ReadPoolConfig_AutoScalingConfig_PolicyFields = {
    "cool_down_period_sec": ubx.FieldSpec(wire_name="cool_down_period_sec"),
    "cpu_utilization": ubx.FieldSpec(
        wire_name="cpu_utilization",
        kind="object",
        fields=_V1betaInstance_ReadPoolConfig_AutoScalingConfig_Policy_CpuUtilizationFields,
    ),
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "max_node_count": ubx.FieldSpec(wire_name="max_node_count"),
}

_V1betaInstance_ReadPoolConfig_AutoScalingConfig_SchedulesFields = {
...
_V1betaInstance_ReadPoolConfig_AutoScalingConfigFields = {
    "policy": ubx.FieldSpec(
        wire_name="policy",
        kind="object",
        fields=_V1betaInstance_ReadPoolConfig_AutoScalingConfig_PolicyFields,
    ),
    "schedules": ubx.FieldSpec(
        wire_name="schedules",
        kind="list",
        fields=_V1betaInstance_ReadPoolConfig_AutoScalingConfig_SchedulesFields,
    ),
}

_V1betaInstance_ReadPoolConfigFields = {
    "auto_scaling_config": ubx.FieldSpec(
        wire_name="auto_scaling_config",
        kind="object",
        fields=_V1betaInstance_ReadPoolConfig_AutoScalingConfigFields,
    ),
    "node_count": ubx.FieldSpec(wire_name="node_count"),
}

_V1betaInstance_UpdatePolicyFields = {
...
V1betaInstance = ubx.ResourceBinding(
    wire_type="google_alloydb_v1beta_instance",
    fields={
        ...
        "client_connection_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaInstance_ClientConnectionConfigFields,
        ),
        ...
        "gca_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaInstance_GcaConfigFields,
        ),
        ...
        "psc_instance_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaInstance_PscInstanceConfigFields,
        ),
        ...
        "query_insights_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaInstance_QueryInsightsConfigFields,
        ),
