...
class V1betaConfig_GatewayConfig_BackendConfig:
...
@dataclasses.dataclass
class V1betaConfig_GatewayConfig:
    # Configuration for all backends.
    backend_config: Any = None

@dataclasses.dataclass
class V1betaConfig_GrpcServices_FileDescriptorSet:
    contents: Any = None
    path: Any = None

@dataclasses.dataclass
class V1betaConfig_GrpcServices:
    file_descriptor_set: Any = None
    source: Any = None

@dataclasses.dataclass
class V1betaConfig_OpenapiDocuments:
    document: Any = None

_V1betaConfig_GatewayConfig_BackendConfigFields = {
    "google_service_account": ubx.FieldSpec(wire_name="google_service_account"),
}

_V1betaConfig_GatewayConfigFields = {
    "backend_config": ubx.FieldSpec(
        wire_name="backend_config",
        kind="object",
        fields=_V1betaConfig_GatewayConfig_BackendConfigFields,
    ),
}

_V1betaConfig_GrpcServices_FileDescriptorSetFields = {
    "contents": ubx.FieldSpec(wire_name="contents"),
    "path": ubx.FieldSpec(wire_name="path"),
}

_V1betaConfig_GrpcServicesFields = {
...
_V1betaConfig_OpenapiDocumentsFields = {
...
V1betaConfig = ubx.ResourceBinding(
    ...
    fields={
        ...
        "gateway_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaConfig_GatewayConfigFields,
        ),
        ...
        "grpc_services": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1betaConfig_GrpcServicesFields,
        ),
