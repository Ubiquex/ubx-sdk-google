...
class V1betaApigatewayV1betaConfig_GatewayConfig_BackendConfig:
...
@dataclasses.dataclass
class V1betaApigatewayV1betaConfig_GatewayConfig:
    # Configuration for all backends.
    backend_config: Any = None

@dataclasses.dataclass
class V1betaApigatewayV1betaConfig_GrpcServices_FileDescriptorSet:
    contents: Any = None
    path: Any = None

@dataclasses.dataclass
class V1betaApigatewayV1betaConfig_GrpcServices:
    file_descriptor_set: Any = None
    source: Any = None

@dataclasses.dataclass
class V1betaApigatewayV1betaConfig_OpenapiDocuments:
    document: Any = None

_V1betaApigatewayV1betaConfig_GatewayConfig_BackendConfigFields = {
    "google_service_account": ubx.FieldSpec(wire_name="google_service_account"),
}

_V1betaApigatewayV1betaConfig_GatewayConfigFields = {
    "backend_config": ubx.FieldSpec(
        wire_name="backend_config",
        kind="object",
        fields=_V1betaApigatewayV1betaConfig_GatewayConfig_BackendConfigFields,
    ),
}

_V1betaApigatewayV1betaConfig_GrpcServices_FileDescriptorSetFields = {
    "contents": ubx.FieldSpec(wire_name="contents"),
    "path": ubx.FieldSpec(wire_name="path"),
}

_V1betaApigatewayV1betaConfig_GrpcServicesFields = {
    "file_descriptor_set": ubx.FieldSpec(
        wire_name="file_descriptor_set",
        kind="object",
        fields=_V1betaApigatewayV1betaConfig_GrpcServices_FileDescriptorSetFields,
    ),
...
_V1betaApigatewayV1betaConfig_OpenapiDocumentsFields = {
...
@dataclasses.dataclass
class V1betaApigatewayV1betaConfigConfig:
...
@dataclasses.dataclass
class V1betaApigatewayV1betaConfigAttrs:
    # Output only. Created time.
    create_time: Any = None
    # Optional. Display name.
    display_name: Any = None
...
V1betaApigatewayV1betaConfig = ubx.ResourceBinding(
    wire_type="google_apigateway_v1beta_apigateway_v1beta_config",
    fields={
        ...
        "gateway_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1betaApigatewayV1betaConfig_GatewayConfigFields,
        ),
        ...
        "grpc_services": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1betaApigatewayV1betaConfig_GrpcServicesFields,
        ),
        ...
        "openapi_documents": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1betaApigatewayV1betaConfig_OpenapiDocumentsFields,
        ),
