...
class FirestoreChangeStream_CollectionGroupScope:
    # Required. The collection group name.
    collection_group_id: Any = None

_FirestoreChangeStream_CollectionGroupScopeFields = {
    "collection_group_id": ubx.FieldSpec(wire_name="collection_group_id"),
}

@dataclasses.dataclass
class FirestoreChangeStreamConfig:
...
@dataclasses.dataclass
class FirestoreChangeStreamAttrs:
    # The change stream is scoped to a collection group. Only events associated with the given collection group are visible to the Change Stream. Only a single change stream can be enabled per collection group.
    collection_group_scope: Any = None
    # Output only. The time the Change Stream was created.
    create_time: Any = None
...
FirestoreChangeStream = ubx.ResourceBinding(
    wire_type="google_firestore_firestore_change_stream",
    fields={
        "collection_group_scope": ubx.FieldSpec(
            wire_name="collection_group_scope",
            kind="object",
            fields=_FirestoreChangeStream_CollectionGroupScopeFields,
        ),
