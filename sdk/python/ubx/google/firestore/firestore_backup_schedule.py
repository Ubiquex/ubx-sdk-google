...
class FirestoreBackupSchedule_WeeklyRecurrence:
    # The day of week to run. DAY_OF_WEEK_UNSPECIFIED is not allowed.
    day: Any = None

_FirestoreBackupSchedule_WeeklyRecurrenceFields = {
    "day": ubx.FieldSpec(wire_name="day"),
}

@dataclasses.dataclass
class FirestoreBackupScheduleConfig:
...
@dataclasses.dataclass
class FirestoreBackupScheduleAttrs:
    # Output only. The timestamp at which this backup schedule was created and effective since. No backups will be created for this schedule before this time.
    create_time: Any = None
    # Represents a recurring schedule that runs every day. The time zone is UTC.
    daily_recurrence: Any = None
...
FirestoreBackupSchedule = ubx.ResourceBinding(
    wire_type="google_firestore_firestore_backup_schedule",
    fields={
        ...
        "weekly_recurrence": ubx.FieldSpec(
            ...
            kind="object",
            fields=_FirestoreBackupSchedule_WeeklyRecurrenceFields,
        ),
    },
)
