...
class V1alpha1MigrationcenterV1alpha1DiscoveryClient_Errors:
    code: Any = None
    details: Any = None
    message: Any = None

@dataclasses.dataclass
class V1alpha1MigrationcenterV1alpha1DiscoveryClient_RecommendedVersions:
    uri: Any = None
    version: Any = None

_V1alpha1MigrationcenterV1alpha1DiscoveryClient_ErrorsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V1alpha1MigrationcenterV1alpha1DiscoveryClient_RecommendedVersionsFields = {
    "uri": ubx.FieldSpec(wire_name="uri"),
    "version": ubx.FieldSpec(wire_name="version"),
}

@dataclasses.dataclass
class V1alpha1MigrationcenterV1alpha1DiscoveryClientConfig:
...
@dataclasses.dataclass
class V1alpha1MigrationcenterV1alpha1DiscoveryClientAttrs:
    # Output only. Time when the discovery client was first created.
    create_time: Any = None
    # Optional. Free text description. Maximum length is 1000 characters.
    description: Any = None
...
V1alpha1MigrationcenterV1alpha1DiscoveryClient = ubx.ResourceBinding(
    wire_type="google_migrationcenter_v1alpha1_migrationcenter_v1alpha1_discovery_client",
    fields={
        ...
        "errors": ubx.FieldSpec(
            wire_name="errors",
            kind="list",
            fields=_V1alpha1MigrationcenterV1alpha1DiscoveryClient_ErrorsFields,
        ),
        ...
        "recommended_versions": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1alpha1MigrationcenterV1alpha1DiscoveryClient_RecommendedVersionsFields,
        ),
