...
class MigrationcenterSourceConfig:
...
@dataclasses.dataclass
class MigrationcenterSourceAttrs:
    # Output only. The timestamp when the source was created.
    create_time: Any = None
    # Free-text description.
    description: Any = None
...
MigrationcenterSource = ubx.ResourceBinding(
    wire_type="google_migrationcenter_migrationcenter_source",
    fields={
