...
class MigrationcenterDiscoveryClient_Errors:
    code: Any = None
    details: Any = None
    message: Any = None

_MigrationcenterDiscoveryClient_ErrorsFields = {
...
@dataclasses.dataclass
class MigrationcenterDiscoveryClientConfig:
...
@dataclasses.dataclass
class MigrationcenterDiscoveryClientAttrs:
    # Output only. Time when the discovery client was first created.
    create_time: Any = None
    # Optional. Free text description. Maximum length is 1000 characters.
    description: Any = None
...
MigrationcenterDiscoveryClient = ubx.ResourceBinding(
    wire_type="google_migrationcenter_migrationcenter_discovery_client",
    fields={
        ...
        "errors": ubx.FieldSpec(
            wire_name="errors",
            kind="list",
            fields=_MigrationcenterDiscoveryClient_ErrorsFields,
        ),
