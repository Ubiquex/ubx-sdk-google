...
class AiplatformAgent_Tools:
    headers: Any = None
    name: Any = None
    type: Any = None
    url: Any = None

_AiplatformAgent_ToolsFields = {
...
AiplatformAgent = ubx.ResourceBinding(
    wire_type="google_aiplatform_aiplatform_agent",
    fields={
        ...
        "tools": ubx.FieldSpec(
            wire_name="tools",
            kind="list",
            fields=_AiplatformAgent_ToolsFields,
        ),
