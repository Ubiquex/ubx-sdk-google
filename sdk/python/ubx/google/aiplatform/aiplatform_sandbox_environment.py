...
class AiplatformSandboxEnvironment_ConnectionInfo:
...
@dataclasses.dataclass
class AiplatformSandboxEnvironment_Spec_CodeExecutionEnvironment:
...
@dataclasses.dataclass
class AiplatformSandboxEnvironmentAttrs:
    # The connection information of the SandboxEnvironment.
    connection_info: Any = None
    # Output only. The timestamp when this SandboxEnvironment was created.
    create_time: Any = None
...
AiplatformSandboxEnvironment = ubx.ResourceBinding(
    wire_type="google_aiplatform_aiplatform_sandbox_environment",
    fields={
        "connection_info": ubx.FieldSpec(
            wire_name="connection_info",
            kind="object",
            fields=_AiplatformSandboxEnvironment_ConnectionInfoFields,
        ),
        ...
        "spec": ubx.FieldSpec(
            wire_name="spec",
            kind="object",
            fields=_AiplatformSandboxEnvironment_SpecFields,
        ),
