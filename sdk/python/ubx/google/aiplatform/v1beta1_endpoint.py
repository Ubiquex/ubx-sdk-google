...
class V1beta1Endpoint_ClientConnectionConfig:
    # Customizable online prediction request timeout.
    inference_timeout: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_AutomaticResources:
    max_replica_count: Any = None
    min_replica_count: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_DedicatedResources_AutoscalingMetricSpecs:
    metric_name: Any = None
    monitored_resource_labels: Any = None
    target: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_DedicatedResources_FlexStart:
    max_runtime_duration: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_DedicatedResources_MachineSpec_ReservationAffinity:
    key: Any = None
    reservation_affinity_type: Any = None
    values: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_DedicatedResources_MachineSpec:
...
@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_DedicatedResources_ScaleToZeroSpec:
    idle_scaledown_period: Any = None
    min_scaleup_period: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_DedicatedResources:
...
@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Metadata_Inputs_FeatureValueDomain:
    max_value: Any = None
    min_value: Any = None
...
@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Metadata_Inputs_Visualization:
...
@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Metadata_Inputs:
...
@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Metadata_Outputs:
    display_name_mapping_key: Any = None
    index_display_name_mapping: Any = None
    output_tensor_name: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Metadata:
...
@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource:
    uris: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Parameters_Examples_ExampleGcsSource:
    data_format: Any = None
    gcs_source: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Parameters_Examples_Presets:
    modality: Any = None
    query: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Parameters_Examples:
...
@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig:
    max_blur_sigma: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma:
    name: Any = None
    sigma: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma:
    noise_sigma: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig:
    feature_noise_sigma: Any = None
    noise_sigma: Any = None
    noisy_sample_count: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution:
    blur_baseline_config: Any = None
    smooth_grad_config: Any = None
    step_count: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Parameters_SampledShapleyAttribution:
    path_count: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec_Parameters:
    examples: Any = None
...
@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_ExplanationSpec:
    metadata: Any = None
    parameters: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_FasterDeploymentConfig:
    fast_tryout_enabled: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_FullFineTunedResources:
    deployment_type: Any = None
    model_inference_unit_count: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_PrivateEndpoints:
...
@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_RolloutOptions:
...
@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_SpeculativeDecodingSpec_DraftModelSpeculation:
    draft_model: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_SpeculativeDecodingSpec_NgramSpeculation:
    ngram_size: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_SpeculativeDecodingSpec:
    draft_model_speculation: Any = None
    ngram_speculation: Any = None
    speculative_token_count: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels_Status:
    available_replica_count: Any = None
    last_update_time: Any = None
    message: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_DeployedModels:
...
@dataclasses.dataclass
class V1beta1Endpoint_GenAiAdvancedFeaturesConfig:
    # Configuration for Retrieval Augmented Generation feature.
    rag_config: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_PredictRequestResponseLoggingConfig_BigqueryDestination:
    # Required. BigQuery URI to a project or table, up to 2000 characters long. When only the project is specified, the Dataset and Table is created. When the full table reference is specified, the Dataset must exist and table must not exist. Accepted forms: * BigQuery path. For example: `bq://projectId` or `bq://projectId.bqDatasetId` or `bq://projectId.bqDatasetId.bqTableId`.
    output_uri: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_PredictRequestResponseLoggingConfig:
...
@dataclasses.dataclass
class V1beta1Endpoint_PrivateServiceConnectConfig_PscAutomationConfigs:
...
@dataclasses.dataclass
class V1beta1Endpoint_PrivateServiceConnectConfig:
...
@dataclasses.dataclass
class V1beta1Endpoint_PublisherModelConfig_ClaudeFeatureConfig:
...
@dataclasses.dataclass
class V1beta1Endpoint_PublisherModelConfig_InferenceEventLoggingConfig:
    # Optional. Whether the `aiplatform.googleapis.com/inference_request` log is enabled.
    state: Any = None

@dataclasses.dataclass
class V1beta1Endpoint_PublisherModelConfig:
...
_V1beta1Endpoint_ClientConnectionConfigFields = {
...
_V1beta1Endpoint_GdcConfigFields = {
    "zone": ubx.FieldSpec(wire_name="zone"),
}

_V1beta1Endpoint_GenAiAdvancedFeaturesConfig_RagConfigFields = {
    "enable_rag": ubx.FieldSpec(wire_name="enable_rag"),
}

_V1beta1Endpoint_GenAiAdvancedFeaturesConfigFields = {
    "rag_config": ubx.FieldSpec(
        wire_name="rag_config",
        kind="object",
        fields=_V1beta1Endpoint_GenAiAdvancedFeaturesConfig_RagConfigFields,
    ),
}

_V1beta1Endpoint_PredictRequestResponseLoggingConfig_BigqueryDestinationFields = {
    "output_uri": ubx.FieldSpec(wire_name="output_uri"),
}

_V1beta1Endpoint_PredictRequestResponseLoggingConfigFields = {
    "bigquery_destination": ubx.FieldSpec(
        wire_name="bigquery_destination",
        kind="object",
        fields=_V1beta1Endpoint_PredictRequestResponseLoggingConfig_BigqueryDestinationFields,
    ),
...
_V1beta1Endpoint_PrivateServiceConnectConfig_PscAutomationConfigsFields = {
...
_V1beta1Endpoint_PrivateServiceConnectConfigFields = {
    ...
    "psc_automation_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1Endpoint_PrivateServiceConnectConfig_PscAutomationConfigsFields,
    ),
    "service_attachment": ubx.FieldSpec(wire_name="service_attachment"),
}

_V1beta1Endpoint_PublisherModelConfig_ClaudeFeatureConfigFields = {
...
_V1beta1Endpoint_PublisherModelConfig_InferenceEventLoggingConfigFields = {
    "state": ubx.FieldSpec(wire_name="state"),
}

_V1beta1Endpoint_PublisherModelConfigFields = {
    "claude_feature_config": ubx.FieldSpec(
        wire_name="claude_feature_config",
        kind="object",
        fields=_V1beta1Endpoint_PublisherModelConfig_ClaudeFeatureConfigFields,
    ),
    ...
    "inference_event_logging_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1Endpoint_PublisherModelConfig_InferenceEventLoggingConfigFields,
    ),
    "logging_config": ubx.FieldSpec(
        wire_name="logging_config",
        kind="object",
        fields=_V1beta1Endpoint_PredictRequestResponseLoggingConfigFields,
    ),
}
...
V1beta1Endpoint = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_endpoint",
    fields={
        ...
        "encryption_spec": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1Endpoint_EncryptionSpecFields,
        ),
        "etag": ubx.FieldSpec(wire_name="etag"),
        "gdc_config": ubx.FieldSpec(
            wire_name="gdc_config",
            kind="object",
            fields=_V1beta1Endpoint_GdcConfigFields,
        ),
        ...
        "private_service_connect_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1Endpoint_PrivateServiceConnectConfigFields,
        ),
