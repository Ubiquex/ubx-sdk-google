...
class V1beta1Featurestore_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class V1beta1Featurestore_OnlineServingConfig_Scaling:
...
@dataclasses.dataclass
class V1beta1Featurestore_OnlineServingConfig:
...
_V1beta1Featurestore_EncryptionSpecFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

_V1beta1Featurestore_OnlineServingConfig_ScalingFields = {
...
_V1beta1Featurestore_OnlineServingConfigFields = {
    "fixed_node_count": ubx.FieldSpec(wire_name="fixed_node_count"),
    "scaling": ubx.FieldSpec(
        wire_name="scaling",
        kind="object",
        fields=_V1beta1Featurestore_OnlineServingConfig_ScalingFields,
    ),
}
...
V1beta1Featurestore = ubx.ResourceBinding(
    ...
    fields={
        "encryption_spec": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1Featurestore_EncryptionSpecFields,
        ),
