...
class AiplatformTimeSery_Metadata:
...
_AiplatformTimeSery_MetadataFields = {
...
@dataclasses.dataclass
class AiplatformTimeSeryConfig:
...
AiplatformTimeSery = ubx.ResourceBinding(
    wire_type="google_aiplatform_aiplatform_time_sery",
    fields={
        ...
        "metadata": ubx.FieldSpec(
            wire_name="metadata",
            kind="object",
            fields=_AiplatformTimeSery_MetadataFields,
        ),
