...
class V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec_ReservationAffinity:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_NetworkSpec:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_PersistentDiskSpec:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfig:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_DataformRepositorySource:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_DirectNotebookSource:
    # The base64-encoded contents of the input notebook file.
    content: Any = None

@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_GcsNotebookSource:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_Status:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_WorkbenchRuntime_CustomContainerImage:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_WorkbenchRuntime_VmImage:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJob_WorkbenchRuntime:
...
_V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec_ReservationAffinityFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "reservation_affinity_type": ubx.FieldSpec(wire_name="reservation_affinity_type"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_MachineSpecFields = {
    ...
    "reservation_affinity": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_MachineSpec_ReservationAffinityFields,
    ),
    "tpu_topology": ubx.FieldSpec(wire_name="tpu_topology"),
}

_V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_NetworkSpecFields = {
...
_V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_PersistentDiskSpecFields = {
    "disk_size_gb": ubx.FieldSpec(wire_name="disk_size_gb"),
    "disk_type": ubx.FieldSpec(wire_name="disk_type"),
}

_V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfigFields = {
...
_V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpecFields = {
    "machine_spec": ubx.FieldSpec(
        wire_name="machine_spec",
        kind="object",
        fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_MachineSpecFields,
    ),
    "network_spec": ubx.FieldSpec(
        wire_name="network_spec",
        kind="object",
        fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_NetworkSpecFields,
    ),
    "persistent_disk_spec": ubx.FieldSpec(
        wire_name="persistent_disk_spec",
        kind="object",
        fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_PersistentDiskSpecFields,
    ),
    "shielded_instance_config": ubx.FieldSpec(
        wire_name="shielded_instance_config",
        kind="object",
        fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfigFields,
    ),
}

_V1beta1AiplatformV1beta1NotebookExecutionJob_DataformRepositorySourceFields = {
...
_V1beta1AiplatformV1beta1NotebookExecutionJob_DirectNotebookSourceFields = {
    "content": ubx.FieldSpec(wire_name="content"),
}

_V1beta1AiplatformV1beta1NotebookExecutionJob_EncryptionSpecFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

_V1beta1AiplatformV1beta1NotebookExecutionJob_GcsNotebookSourceFields = {
    "generation": ubx.FieldSpec(wire_name="generation"),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_V1beta1AiplatformV1beta1NotebookExecutionJob_StatusFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V1beta1AiplatformV1beta1NotebookExecutionJob_WorkbenchRuntime_CustomContainerImageFields = {
    "repository": ubx.FieldSpec(wire_name="repository"),
    "tag": ubx.FieldSpec(wire_name="tag"),
}

_V1beta1AiplatformV1beta1NotebookExecutionJob_WorkbenchRuntime_VmImageFields = {
    "family": ubx.FieldSpec(wire_name="family"),
    "name": ubx.FieldSpec(wire_name="name"),
    "project": ubx.FieldSpec(wire_name="project"),
}

_V1beta1AiplatformV1beta1NotebookExecutionJob_WorkbenchRuntimeFields = {
    "custom_container_image": ubx.FieldSpec(
        wire_name="custom_container_image",
        kind="object",
        fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_WorkbenchRuntime_CustomContainerImageFields,
    ),
    "vm_image": ubx.FieldSpec(
        wire_name="vm_image",
        kind="object",
        fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_WorkbenchRuntime_VmImageFields,
    ),
}

@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJobConfig:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1NotebookExecutionJobAttrs:
    # Output only. Timestamp when this NotebookExecutionJob was created.
    create_time: Any = None
    # Compute configuration to use for an execution job.
    custom_environment_spec: Any = None
...
V1beta1AiplatformV1beta1NotebookExecutionJob = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_aiplatform_v1beta1_notebook_execution_job",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "custom_environment_spec": ubx.FieldSpec(
            wire_name="custom_environment_spec",
            kind="object",
            fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_CustomEnvironmentSpecFields,
        ),
        "dataform_repository_source": ubx.FieldSpec(
            wire_name="dataform_repository_source",
            kind="object",
            fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_DataformRepositorySourceFields,
        ),
        "direct_notebook_source": ubx.FieldSpec(
            wire_name="direct_notebook_source",
            kind="object",
            fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_DirectNotebookSourceFields,
        ),
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        "encryption_spec": ubx.FieldSpec(
            wire_name="encryption_spec",
            kind="object",
            fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_EncryptionSpecFields,
        ),
        ...
        "gcs_notebook_source": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_GcsNotebookSourceFields,
        ),
        ...
        "status": ubx.FieldSpec(
            wire_name="status",
            kind="object",
            fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_StatusFields,
        ),
        "update_time": ubx.FieldSpec(wire_name="update_time"),
        "workbench_runtime": ubx.FieldSpec(
            wire_name="workbench_runtime",
            kind="object",
            fields=_V1beta1AiplatformV1beta1NotebookExecutionJob_WorkbenchRuntimeFields,
        ),
    },
)
