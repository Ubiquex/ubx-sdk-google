...
class AiplatformFeaturestore_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class AiplatformFeaturestore_OnlineServingConfig_Scaling:
...
@dataclasses.dataclass
class AiplatformFeaturestore_OnlineServingConfig:
...
_AiplatformFeaturestore_EncryptionSpecFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

_AiplatformFeaturestore_OnlineServingConfig_ScalingFields = {
...
_AiplatformFeaturestore_OnlineServingConfigFields = {
    "fixed_node_count": ubx.FieldSpec(wire_name="fixed_node_count"),
    "scaling": ubx.FieldSpec(
        wire_name="scaling",
        kind="object",
        fields=_AiplatformFeaturestore_OnlineServingConfig_ScalingFields,
    ),
}

@dataclasses.dataclass
class AiplatformFeaturestoreConfig:
...
@dataclasses.dataclass
class AiplatformFeaturestoreAttrs:
    # Output only. Timestamp when this Featurestore was created.
    create_time: Any = None
    # Represents a customer-managed encryption key specification that can be applied to a Vertex AI resource.
    encryption_spec: Any = None
...
AiplatformFeaturestore = ubx.ResourceBinding(
    wire_type="google_aiplatform_aiplatform_featurestore",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "encryption_spec": ubx.FieldSpec(
            wire_name="encryption_spec",
            kind="object",
            fields=_AiplatformFeaturestore_EncryptionSpecFields,
        ),
        ...
        "online_serving_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AiplatformFeaturestore_OnlineServingConfigFields,
        ),
