...
class V1beta1BatchPredictionJob_CompletionStats:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_DedicatedResources_FlexStart:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinity:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_DedicatedResources_MachineSpec:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_DedicatedResources:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_Error:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Metadata_Inputs_FeatureValueDomain:
    max_value: Any = None
    min_value: Any = None
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Metadata_Inputs_Visualization:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Metadata_Inputs:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Metadata_Outputs:
    display_name_mapping_key: Any = None
    index_display_name_mapping: Any = None
    output_tensor_name: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Metadata:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource:
    # Required. Google Cloud Storage URI(-s) to the input file(s). May contain wildcards. For more information on wildcards, see https://cloud.google.com/storage/docs/wildcards.
    uris: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples_Presets:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma:
    name: Any = None
    sigma: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma:
    # Noise sigma per feature. No noise is added to features that are not set.
    noise_sigma: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttribution:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec_Parameters:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ExplanationSpec:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_InputConfig_BigquerySource:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_InputConfig_VertexMultimodalDatasetSource:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_InputConfig:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_InstanceConfig:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ManualBatchTuningParameters:
    # Immutable. The number of the records (e.g. instances) of the operation given in each batch to a machine replica. Machine type, and size of a single record should be considered when setting this parameter, higher value speeds up the batch operation's execution, but too high value will result in a whole batch not fitting in a machine's memory, and the whole operation will fail. The default value is 64.
    batch_size: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_AlertConfig_EmailAlertConfig:
    # The email addresses to send the alert.
    user_emails: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_AlertConfig:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig_ExplanationBaseline_Bigquery:
    output_uri: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig_ExplanationBaseline_Gcs:
    output_uri_prefix: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig_ExplanationBaseline:
    bigquery: Any = None
    gcs: Any = None
    prediction_format: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig:
    enable_feature_attributes: Any = None
    explanation_baseline: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_PredictionDriftDetectionConfig_AttributionScoreDriftThresholds:
    value: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_PredictionDriftDetectionConfig:
    attribution_score_drift_thresholds: Any = None
    default_drift_threshold: Any = None
    drift_thresholds: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingDataset_LoggingSamplingStrategy_RandomSampleConfig:
    sample_rate: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingDataset_LoggingSamplingStrategy:
    random_sample_config: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingDataset:
    bigquery_source: Any = None
    data_format: Any = None
    dataset: Any = None
    gcs_source: Any = None
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingPredictionSkewDetectionConfig:
    attribution_score_skew_thresholds: Any = None
    default_skew_threshold: Any = None
    skew_thresholds: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringConfig:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringStatsAnomalies_FeatureStats_PredictionStats:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringStatsAnomalies_FeatureStats:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ModelMonitoringStatsAnomalies:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_OutputConfig_VertexMultimodalDatasetDestination:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_OutputConfig:
    # The BigQuery location for the output content.
    bigquery_destination: Any = None
    # The Google Cloud Storage location where the output is to be written to.
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_OutputInfo:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_ResourcesConsumed:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_Env:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPorts:
    container_port: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Exec:
    # Command is the command line to execute inside the container, the working directory for the command is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.
    command: Any = None

@dataclasses.dataclass
class V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Grpc:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGet:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocket:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_UnmanagedContainerModel_PredictSchemata:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJob_UnmanagedContainerModel:
...
_V1beta1BatchPredictionJob_CompletionStatsFields = {
...
_V1beta1BatchPredictionJob_DedicatedResources_FlexStartFields = {
    "max_runtime_duration": ubx.FieldSpec(wire_name="max_runtime_duration"),
}

_V1beta1BatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinityFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "reservation_affinity_type": ubx.FieldSpec(wire_name="reservation_affinity_type"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_V1beta1BatchPredictionJob_DedicatedResources_MachineSpecFields = {
    ...
    "reservation_affinity": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1BatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinityFields,
    ),
    "tpu_topology": ubx.FieldSpec(wire_name="tpu_topology"),
}

_V1beta1BatchPredictionJob_DedicatedResourcesFields = {
    "flex_start": ubx.FieldSpec(
        wire_name="flex_start",
        kind="object",
        fields=_V1beta1BatchPredictionJob_DedicatedResources_FlexStartFields,
    ),
    "machine_spec": ubx.FieldSpec(
        wire_name="machine_spec",
        kind="object",
        fields=_V1beta1BatchPredictionJob_DedicatedResources_MachineSpecFields,
    ),
...
_V1beta1BatchPredictionJob_EncryptionSpecFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

_V1beta1BatchPredictionJob_ErrorFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V1beta1BatchPredictionJob_ExplanationSpec_Metadata_Inputs_FeatureValueDomainFields = {
...
_V1beta1BatchPredictionJob_ExplanationSpec_Metadata_Inputs_VisualizationFields = {
...
_V1beta1BatchPredictionJob_ExplanationSpec_Metadata_InputsFields = {
    ...
    "feature_value_domain": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Metadata_Inputs_FeatureValueDomainFields,
    ),
    ...
    "visualization": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Metadata_Inputs_VisualizationFields,
    ),
}

_V1beta1BatchPredictionJob_ExplanationSpec_Metadata_OutputsFields = {
...
_V1beta1BatchPredictionJob_ExplanationSpec_MetadataFields = {
    "feature_attributions_schema_uri": ubx.FieldSpec(wire_name="feature_attributions_schema_uri"),
    "inputs": ubx.FieldSpec(
        wire_name="inputs",
        kind="map",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Metadata_InputsFields,
    ),
    "latent_space_source": ubx.FieldSpec(wire_name="latent_space_source"),
    "outputs": ubx.FieldSpec(
        wire_name="outputs",
        kind="map",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Metadata_OutputsFields,
    ),
}

_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSourceFields = {
    "uris": ubx.FieldSpec(wire_name="uris"),
}

_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSourceFields = {
    "data_format": ubx.FieldSpec(wire_name="data_format"),
    "gcs_source": ubx.FieldSpec(
        wire_name="gcs_source",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSourceFields,
    ),
}

_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples_PresetsFields = {
    "modality": ubx.FieldSpec(wire_name="modality"),
    "query": ubx.FieldSpec(wire_name="query"),
}

_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_ExamplesFields = {
    "example_gcs_source": ubx.FieldSpec(
        wire_name="example_gcs_source",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSourceFields,
    ),
    "gcs_source": ubx.FieldSpec(
        wire_name="gcs_source",
        kind="object",
    ...
    "presets": ubx.FieldSpec(
        wire_name="presets",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_Examples_PresetsFields,
    ),
}

_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfigFields = {
    "max_blur_sigma": ubx.FieldSpec(wire_name="max_blur_sigma"),
}

_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigmaFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "sigma": ubx.FieldSpec(wire_name="sigma"),
}

_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigmaFields = {
    "noise_sigma": ubx.FieldSpec(
        wire_name="noise_sigma",
        kind="list",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigmaFields,
    ),
}

_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfigFields = {
    "feature_noise_sigma": ubx.FieldSpec(
        wire_name="feature_noise_sigma",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigmaFields,
    ),
    "noise_sigma": ubx.FieldSpec(wire_name="noise_sigma"),
    "noisy_sample_count": ubx.FieldSpec(wire_name="noisy_sample_count"),
}

_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttributionFields = {
    "blur_baseline_config": ubx.FieldSpec(
        wire_name="blur_baseline_config",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfigFields,
    ),
    "smooth_grad_config": ubx.FieldSpec(
        wire_name="smooth_grad_config",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfigFields,
    ),
    "step_count": ubx.FieldSpec(wire_name="step_count"),
}

_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttributionFields = {
    "path_count": ubx.FieldSpec(wire_name="path_count"),
}

_V1beta1BatchPredictionJob_ExplanationSpec_ParametersFields = {
    "examples": ubx.FieldSpec(
        wire_name="examples",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_ExamplesFields,
    ),
    "integrated_gradients_attribution": ubx.FieldSpec(
        wire_name="integrated_gradients_attribution",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttributionFields,
    ),
    ...
    "sampled_shapley_attribution": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttributionFields,
    ),
...
_V1beta1BatchPredictionJob_ExplanationSpecFields = {
    "metadata": ubx.FieldSpec(
        wire_name="metadata",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_MetadataFields,
    ),
    "parameters": ubx.FieldSpec(
        wire_name="parameters",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ExplanationSpec_ParametersFields,
    ),
}

_V1beta1BatchPredictionJob_InputConfig_BigquerySourceFields = {
    "input_uri": ubx.FieldSpec(wire_name="input_uri"),
}

_V1beta1BatchPredictionJob_InputConfig_VertexMultimodalDatasetSourceFields = {
    "dataset_name": ubx.FieldSpec(wire_name="dataset_name"),
}

_V1beta1BatchPredictionJob_InputConfigFields = {
    "bigquery_source": ubx.FieldSpec(
        wire_name="bigquery_source",
        kind="object",
        fields=_V1beta1BatchPredictionJob_InputConfig_BigquerySourceFields,
    ),
    "gcs_source": ubx.FieldSpec(
        wire_name="gcs_source",
        kind="object",
    ...
    "vertex_multimodal_dataset_source": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1BatchPredictionJob_InputConfig_VertexMultimodalDatasetSourceFields,
    ),
}

_V1beta1BatchPredictionJob_InstanceConfigFields = {
...
_V1beta1BatchPredictionJob_ManualBatchTuningParametersFields = {
    "batch_size": ubx.FieldSpec(wire_name="batch_size"),
}

_V1beta1BatchPredictionJob_ModelMonitoringConfig_AlertConfig_EmailAlertConfigFields = {
    "user_emails": ubx.FieldSpec(wire_name="user_emails"),
}

_V1beta1BatchPredictionJob_ModelMonitoringConfig_AlertConfigFields = {
    "email_alert_config": ubx.FieldSpec(
        wire_name="email_alert_config",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_AlertConfig_EmailAlertConfigFields,
    ),
    "enable_logging": ubx.FieldSpec(wire_name="enable_logging"),
    "notification_channels": ubx.FieldSpec(wire_name="notification_channels"),
}

_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig_ExplanationBaseline_BigqueryFields = {
    "output_uri": ubx.FieldSpec(wire_name="output_uri"),
}

_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig_ExplanationBaseline_GcsFields = {
    "output_uri_prefix": ubx.FieldSpec(wire_name="output_uri_prefix"),
}

_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig_ExplanationBaselineFields = {
    "bigquery": ubx.FieldSpec(
        wire_name="bigquery",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig_ExplanationBaseline_BigqueryFields,
    ),
    "gcs": ubx.FieldSpec(
        wire_name="gcs",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig_ExplanationBaseline_GcsFields,
    ),
    "prediction_format": ubx.FieldSpec(wire_name="prediction_format"),
}

_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfigFields = {
    ...
    "explanation_baseline": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig_ExplanationBaselineFields,
    ),
}

_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_PredictionDriftDetectionConfig_AttributionScoreDriftThresholdsFields = {
    "value": ubx.FieldSpec(wire_name="value"),
}

_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_PredictionDriftDetectionConfigFields = {
    "attribution_score_drift_thresholds": ubx.FieldSpec(
        wire_name="attribution_score_drift_thresholds",
        kind="map",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_PredictionDriftDetectionConfig_AttributionScoreDriftThresholdsFields,
    ),
...
_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingDataset_LoggingSamplingStrategy_RandomSampleConfigFields = {
    "sample_rate": ubx.FieldSpec(wire_name="sample_rate"),
}

_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingDataset_LoggingSamplingStrategyFields = {
    "random_sample_config": ubx.FieldSpec(
        wire_name="random_sample_config",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingDataset_LoggingSamplingStrategy_RandomSampleConfigFields,
    ),
}

_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingDatasetFields = {
    "bigquery_source": ubx.FieldSpec(
        wire_name="bigquery_source",
        kind="object",
        fields=_V1beta1BatchPredictionJob_InputConfig_BigquerySourceFields,
    ...
    "logging_sampling_strategy": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingDataset_LoggingSamplingStrategyFields,
    ),
    "target_field": ubx.FieldSpec(wire_name="target_field"),
}

_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingPredictionSkewDetectionConfigFields = {
...
_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigsFields = {
    "explanation_config": ubx.FieldSpec(
        wire_name="explanation_config",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfigFields,
    ),
    "prediction_drift_detection_config": ubx.FieldSpec(
        wire_name="prediction_drift_detection_config",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_PredictionDriftDetectionConfigFields,
    ),
    "training_dataset": ubx.FieldSpec(
        wire_name="training_dataset",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingDatasetFields,
    ),
    "training_prediction_skew_detection_config": ubx.FieldSpec(
        wire_name="training_prediction_skew_detection_config",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_TrainingPredictionSkewDetectionConfigFields,
    ),
}

_V1beta1BatchPredictionJob_ModelMonitoringConfigFields = {
    "alert_config": ubx.FieldSpec(
        wire_name="alert_config",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_AlertConfigFields,
    ),
    ...
    "objective_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigsFields,
    ),
...
_V1beta1BatchPredictionJob_ModelMonitoringStatsAnomalies_FeatureStats_PredictionStatsFields = {
...
_V1beta1BatchPredictionJob_ModelMonitoringStatsAnomalies_FeatureStatsFields = {
    ...
    "prediction_stats": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringStatsAnomalies_FeatureStats_PredictionStatsFields,
    ),
...
_V1beta1BatchPredictionJob_ModelMonitoringStatsAnomaliesFields = {
    ...
    "feature_stats": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringStatsAnomalies_FeatureStatsFields,
    ),
    "objective": ubx.FieldSpec(wire_name="objective"),
}

_V1beta1BatchPredictionJob_OutputConfig_VertexMultimodalDatasetDestinationFields = {
...
_V1beta1BatchPredictionJob_OutputConfigFields = {
    "bigquery_destination": ubx.FieldSpec(
        wire_name="bigquery_destination",
        kind="object",
        fields=_V1beta1BatchPredictionJob_ModelMonitoringConfig_ObjectiveConfigs_ExplanationConfig_ExplanationBaseline_BigqueryFields,
    ...
    "vertex_multimodal_dataset_destination": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1BatchPredictionJob_OutputConfig_VertexMultimodalDatasetDestinationFields,
    ),
}

_V1beta1BatchPredictionJob_OutputInfoFields = {
...
_V1beta1BatchPredictionJob_ResourcesConsumedFields = {
    "replica_hours": ubx.FieldSpec(wire_name="replica_hours"),
}

_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_EnvFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPortsFields = {
    "container_port": ubx.FieldSpec(wire_name="container_port"),
}

_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_ExecFields = {
    "command": ubx.FieldSpec(wire_name="command"),
}

_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_GrpcFields = {
    "port": ubx.FieldSpec(wire_name="port"),
    "service": ubx.FieldSpec(wire_name="service"),
}

_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGetFields = {
    "host": ubx.FieldSpec(wire_name="host"),
    "http_headers": ubx.FieldSpec(
        wire_name="http_headers",
        kind="list",
        fields=_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_EnvFields,
    ),
...
_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocketFields = {
    "host": ubx.FieldSpec(wire_name="host"),
    "port": ubx.FieldSpec(wire_name="port"),
}

_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbeFields = {
    "exec": ubx.FieldSpec(
        wire_name="exec",
        kind="object",
        fields=_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_ExecFields,
    ),
    "failure_threshold": ubx.FieldSpec(wire_name="failure_threshold"),
    "grpc": ubx.FieldSpec(
        wire_name="grpc",
        kind="object",
        fields=_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_GrpcFields,
    ),
    "http_get": ubx.FieldSpec(
        wire_name="http_get",
        kind="object",
        fields=_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGetFields,
    ),
    ...
    "tcp_socket": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocketFields,
    ),
    "timeout_seconds": ubx.FieldSpec(wire_name="timeout_seconds"),
}

_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpecFields = {
    ...
    "grpc_ports": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPortsFields,
    ),
    "health_probe": ubx.FieldSpec(
        wire_name="health_probe",
        kind="object",
        fields=_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbeFields,
    ),
...
_V1beta1BatchPredictionJob_UnmanagedContainerModel_PredictSchemataFields = {
...
_V1beta1BatchPredictionJob_UnmanagedContainerModelFields = {
    "artifact_uri": ubx.FieldSpec(wire_name="artifact_uri"),
    "container_spec": ubx.FieldSpec(
        wire_name="container_spec",
        kind="object",
        fields=_V1beta1BatchPredictionJob_UnmanagedContainerModel_ContainerSpecFields,
    ),
    "predict_schemata": ubx.FieldSpec(
        wire_name="predict_schemata",
        kind="object",
        fields=_V1beta1BatchPredictionJob_UnmanagedContainerModel_PredictSchemataFields,
    ),
}

@dataclasses.dataclass
class V1beta1BatchPredictionJobConfig:
...
@dataclasses.dataclass
class V1beta1BatchPredictionJobAttrs:
    # Success and error statistics of processing multiple entities (for example, DataItems or structured data rows) in batch.
    completion_stats: Any = None
    # Output only. Time when the BatchPredictionJob was created.
    create_time: Any = None
...
V1beta1BatchPredictionJob = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_batch_prediction_job",
    fields={
        "completion_stats": ubx.FieldSpec(
            wire_name="completion_stats",
            kind="object",
            fields=_V1beta1BatchPredictionJob_CompletionStatsFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "dedicated_resources": ubx.FieldSpec(
            wire_name="dedicated_resources",
            kind="object",
            fields=_V1beta1BatchPredictionJob_DedicatedResourcesFields,
        ),
        ...
        "encryption_spec": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1BatchPredictionJob_EncryptionSpecFields,
        ),
        "end_time": ubx.FieldSpec(wire_name="end_time"),
        ...
        "output_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1BatchPredictionJob_OutputConfigFields,
        ),
        "output_info": ubx.FieldSpec(
            wire_name="output_info",
            kind="object",
            fields=_V1beta1BatchPredictionJob_OutputInfoFields,
        ),
        ...
        "resources_consumed": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1BatchPredictionJob_ResourcesConsumedFields,
        ),
        ...
        "unmanaged_container_model": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1BatchPredictionJob_UnmanagedContainerModelFields,
        ),
