...
class AiplatformDatasetVersionConfig:
...
@dataclasses.dataclass
class AiplatformDatasetVersionAttrs:
    # Output only. Name of the associated BigQuery dataset.
    big_query_dataset_name: Any = None
    # Output only. Timestamp when this DatasetVersion was created.
    create_time: Any = None
...
AiplatformDatasetVersion = ubx.ResourceBinding(
    wire_type="google_aiplatform_aiplatform_dataset_version",
    fields={
