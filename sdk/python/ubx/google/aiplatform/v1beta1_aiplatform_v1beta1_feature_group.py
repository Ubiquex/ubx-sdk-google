...
class V1beta1AiplatformV1beta1FeatureGroup_BigQuery_BigQuerySource:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1FeatureGroup_BigQuery_TimeSeries:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1FeatureGroup_BigQuery:
...
_V1beta1AiplatformV1beta1FeatureGroup_BigQuery_BigQuerySourceFields = {
    "input_uri": ubx.FieldSpec(wire_name="input_uri"),
}

_V1beta1AiplatformV1beta1FeatureGroup_BigQuery_TimeSeriesFields = {
    "timestamp_column": ubx.FieldSpec(wire_name="timestamp_column"),
}

_V1beta1AiplatformV1beta1FeatureGroup_BigQueryFields = {
    "big_query_source": ubx.FieldSpec(
        wire_name="big_query_source",
        kind="object",
        fields=_V1beta1AiplatformV1beta1FeatureGroup_BigQuery_BigQuerySourceFields,
    ),
    ...
    "time_series": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1AiplatformV1beta1FeatureGroup_BigQuery_TimeSeriesFields,
    ),
}

@dataclasses.dataclass
class V1beta1AiplatformV1beta1FeatureGroupConfig:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1FeatureGroupAttrs:
    # Input source type for BigQuery Tables and Views.
    big_query: Any = None
    # Output only. Timestamp when this FeatureGroup was created.
    create_time: Any = None
...
V1beta1AiplatformV1beta1FeatureGroup = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_aiplatform_v1beta1_feature_group",
    fields={
        "big_query": ubx.FieldSpec(
            wire_name="big_query",
            kind="object",
            fields=_V1beta1AiplatformV1beta1FeatureGroup_BigQueryFields,
        ),
