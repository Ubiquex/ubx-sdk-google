...
class V1beta1AiplatformV1beta1ContextConfig:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1ContextAttrs:
    # Output only. Timestamp when this Context was created.
    create_time: Any = None
    # Description of the Context
    description: Any = None
...
V1beta1AiplatformV1beta1Context = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_aiplatform_v1beta1_context",
    fields={
