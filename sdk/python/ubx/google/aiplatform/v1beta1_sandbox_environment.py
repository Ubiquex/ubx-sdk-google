...
class V1beta1SandboxEnvironment_ConnectionInfo:
...
@dataclasses.dataclass
class V1beta1SandboxEnvironment_Spec_CodeExecutionEnvironment:
...
@dataclasses.dataclass
class V1beta1SandboxEnvironment_Spec:
...
@dataclasses.dataclass
class V1beta1SandboxEnvironmentConfig:
...
@dataclasses.dataclass
class V1beta1SandboxEnvironmentAttrs:
    # The connection information of the SandboxEnvironment.
    connection_info: Any = None
...
V1beta1SandboxEnvironment = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_sandbox_environment",
    fields={
        "connection_info": ubx.FieldSpec(
            wire_name="connection_info",
            kind="object",
            fields=_V1beta1SandboxEnvironment_ConnectionInfoFields,
        ),
        ...
        "spec": ubx.FieldSpec(
            wire_name="spec",
            kind="object",
            fields=_V1beta1SandboxEnvironment_SpecFields,
        ),
