...
class V1beta1AiplatformV1beta1DatasetVersionConfig:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1DatasetVersionAttrs:
    # Output only. Name of the associated BigQuery dataset.
    big_query_dataset_name: Any = None
    # Output only. Timestamp when this DatasetVersion was created.
    create_time: Any = None
...
V1beta1AiplatformV1beta1DatasetVersion = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_aiplatform_v1beta1_dataset_version",
    fields={
