...
class V1beta1AiplatformV1beta1Trial_FinalMeasurement_Metrics:
    metric_id: Any = None
    value: Any = None

@dataclasses.dataclass
class V1beta1AiplatformV1beta1Trial_FinalMeasurement:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1Trial_Parameters:
    parameter_id: Any = None
    value: Any = None

_V1beta1AiplatformV1beta1Trial_FinalMeasurement_MetricsFields = {
    "metric_id": ubx.FieldSpec(wire_name="metric_id"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_V1beta1AiplatformV1beta1Trial_FinalMeasurementFields = {
    "elapsed_duration": ubx.FieldSpec(wire_name="elapsed_duration"),
    "metrics": ubx.FieldSpec(
        wire_name="metrics",
        kind="list",
        fields=_V1beta1AiplatformV1beta1Trial_FinalMeasurement_MetricsFields,
    ),
    "step_count": ubx.FieldSpec(wire_name="step_count"),
}

_V1beta1AiplatformV1beta1Trial_ParametersFields = {
    "parameter_id": ubx.FieldSpec(wire_name="parameter_id"),
    "value": ubx.FieldSpec(wire_name="value"),
}

@dataclasses.dataclass
class V1beta1AiplatformV1beta1TrialConfig:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1TrialAttrs:
    # Output only. The identifier of the client that originally requested this Trial. Each client is identified by a unique client_id. When a client asks for a suggestion, Vertex AI Vizier will assign it a Trial. The client should evaluate the Trial, complete it, and report back to Vertex AI Vizier. If suggestion is asked again by same client_id before the Trial is completed, the same Trial will be returned. Multiple clients with different client_ids can ask for suggestions simultaneously, each of them will get their own Trial.
    client_id: Any = None
    # Output only. The CustomJob name linked to the Trial. It's set for a HyperparameterTuningJob's Trial.
    custom_job: Any = None
...
V1beta1AiplatformV1beta1Trial = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_aiplatform_v1beta1_trial",
    fields={
        ...
        "final_measurement": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1AiplatformV1beta1Trial_FinalMeasurementFields,
        ),
        ...
        "parameters": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1beta1AiplatformV1beta1Trial_ParametersFields,
        ),
