...
_Feature_MonitoringStatsAnomalies_FeatureStatsAnomalyFields = {
...
_Feature_MonitoringStatsAnomaliesFields = {
    "feature_stats_anomaly": ubx.FieldSpec(
        wire_name="feature_stats_anomaly",
        kind="object",
        fields=_Feature_MonitoringStatsAnomalies_FeatureStatsAnomalyFields,
    ),
...
Feature = ubx.ResourceBinding(
    ...
    fields={
        ...
        "monitoring_stats_anomalies": ubx.FieldSpec(
            ...
            kind="list",
            fields=_Feature_MonitoringStatsAnomaliesFields,
        ),
