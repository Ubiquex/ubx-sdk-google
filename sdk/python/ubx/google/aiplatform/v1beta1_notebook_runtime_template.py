...
class V1beta1NotebookRuntimeTemplate_DataPersistentDiskSpec:
...
@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplate_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplate_EucConfig:
...
@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplate_IdleShutdownConfig:
...
@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplate_MachineSpec_ReservationAffinity:
...
@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplate_MachineSpec:
...
@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplate_NetworkSpec:
...
@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplate_ReservationAffinity:
...
@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplate_ShieldedVmConfig:
...
@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplate_SoftwareConfig_ColabImage:
...
@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplate_SoftwareConfig_Env:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplate_SoftwareConfig_PostStartupScriptConfig:
...
@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplate_SoftwareConfig:
...
_V1beta1NotebookRuntimeTemplate_MachineSpecFields = {
    ...
    "reservation_affinity": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1NotebookRuntimeTemplate_MachineSpec_ReservationAffinityFields,
    ),
    "tpu_topology": ubx.FieldSpec(wire_name="tpu_topology"),
}

_V1beta1NotebookRuntimeTemplate_NetworkSpecFields = {
...
_V1beta1NotebookRuntimeTemplate_ReservationAffinityFields = {
    "consume_reservation_type": ubx.FieldSpec(wire_name="consume_reservation_type"),
    "key": ubx.FieldSpec(wire_name="key"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_V1beta1NotebookRuntimeTemplate_ShieldedVmConfigFields = {
    "enable_secure_boot": ubx.FieldSpec(wire_name="enable_secure_boot"),
}

_V1beta1NotebookRuntimeTemplate_SoftwareConfig_ColabImageFields = {
    "description": ubx.FieldSpec(wire_name="description"),
    "release_name": ubx.FieldSpec(wire_name="release_name"),
}

_V1beta1NotebookRuntimeTemplate_SoftwareConfig_EnvFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_V1beta1NotebookRuntimeTemplate_SoftwareConfig_PostStartupScriptConfigFields = {
...
_V1beta1NotebookRuntimeTemplate_SoftwareConfigFields = {
    "colab_image": ubx.FieldSpec(
        wire_name="colab_image",
        kind="object",
        fields=_V1beta1NotebookRuntimeTemplate_SoftwareConfig_ColabImageFields,
    ),
    "env": ubx.FieldSpec(
        wire_name="env",
        kind="list",
        fields=_V1beta1NotebookRuntimeTemplate_SoftwareConfig_EnvFields,
    ),
    "post_startup_script_config": ubx.FieldSpec(
        wire_name="post_startup_script_config",
        kind="object",
        fields=_V1beta1NotebookRuntimeTemplate_SoftwareConfig_PostStartupScriptConfigFields,
    ),
}

@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplateConfig:
...
@dataclasses.dataclass
class V1beta1NotebookRuntimeTemplateAttrs:
    # Output only. Timestamp when this NotebookRuntimeTemplate was created.
    create_time: Any = None
    # Represents the spec of persistent disk and hyperdisk options.
    data_persistent_disk_spec: Any = None
...
V1beta1NotebookRuntimeTemplate = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_notebook_runtime_template",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "data_persistent_disk_spec": ubx.FieldSpec(
            wire_name="data_persistent_disk_spec",
            kind="object",
            fields=_V1beta1NotebookRuntimeTemplate_DataPersistentDiskSpecFields,
        ),
        "description": ubx.FieldSpec(wire_name="description"),
        ...
        "encryption_spec": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NotebookRuntimeTemplate_EncryptionSpecFields,
        ),
        "etag": ubx.FieldSpec(wire_name="etag"),
        "euc_config": ubx.FieldSpec(
            wire_name="euc_config",
            kind="object",
            fields=_V1beta1NotebookRuntimeTemplate_EucConfigFields,
        ),
        "idle_shutdown_config": ubx.FieldSpec(
            wire_name="idle_shutdown_config",
            kind="object",
            fields=_V1beta1NotebookRuntimeTemplate_IdleShutdownConfigFields,
        ),
        ...
        "machine_spec": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1NotebookRuntimeTemplate_MachineSpecFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "network_spec": ubx.FieldSpec(
            wire_name="network_spec",
            kind="object",
            fields=_V1beta1NotebookRuntimeTemplate_NetworkSpecFields,
        ),
        ...
        "reservation_affinity": ubx.FieldSpec(
            wire_name="reservation_affinity",
            kind="object",
            fields=_V1beta1NotebookRuntimeTemplate_ReservationAffinityFields,
        ),
        "service_account": ubx.FieldSpec(wire_name="service_account"),
        "shielded_vm_config": ubx.FieldSpec(
            wire_name="shielded_vm_config",
            kind="object",
            fields=_V1beta1NotebookRuntimeTemplate_ShieldedVmConfigFields,
        ),
        "software_config": ubx.FieldSpec(
            wire_name="software_config",
            kind="object",
            fields=_V1beta1NotebookRuntimeTemplate_SoftwareConfigFields,
        ),
