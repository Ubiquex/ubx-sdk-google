...
_V1beta1IndexEndpoint_DeployedIndexes_AutomaticResourcesFields = {
    "max_replica_count": ubx.FieldSpec(wire_name="max_replica_count"),
    "min_replica_count": ubx.FieldSpec(wire_name="min_replica_count"),
}

_V1beta1IndexEndpoint_DeployedIndexes_DedicatedResources_AutoscalingMetricSpecsFields = {
...
_V1beta1IndexEndpoint_DeployedIndexes_DedicatedResources_FlexStartFields = {
    "max_runtime_duration": ubx.FieldSpec(wire_name="max_runtime_duration"),
}

_V1beta1IndexEndpoint_DeployedIndexes_DedicatedResources_MachineSpec_ReservationAffinityFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "reservation_affinity_type": ubx.FieldSpec(wire_name="reservation_affinity_type"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_V1beta1IndexEndpoint_DeployedIndexes_DedicatedResources_MachineSpecFields = {
    ...
    "reservation_affinity": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1IndexEndpoint_DeployedIndexes_DedicatedResources_MachineSpec_ReservationAffinityFields,
    ),
    "tpu_topology": ubx.FieldSpec(wire_name="tpu_topology"),
}

_V1beta1IndexEndpoint_DeployedIndexes_DedicatedResources_ScaleToZeroSpecFields = {
...
_V1beta1IndexEndpoint_DeployedIndexes_DedicatedResourcesFields = {
    "autoscaling_metric_specs": ubx.FieldSpec(
        wire_name="autoscaling_metric_specs",
        kind="list",
        fields=_V1beta1IndexEndpoint_DeployedIndexes_DedicatedResources_AutoscalingMetricSpecsFields,
    ),
    "flex_start": ubx.FieldSpec(
        wire_name="flex_start",
        kind="object",
        fields=_V1beta1IndexEndpoint_DeployedIndexes_DedicatedResources_FlexStartFields,
    ),
    "initial_replica_count": ubx.FieldSpec(wire_name="initial_replica_count"),
    "machine_spec": ubx.FieldSpec(
        wire_name="machine_spec",
        kind="object",
        fields=_V1beta1IndexEndpoint_DeployedIndexes_DedicatedResources_MachineSpecFields,
    ),
    "max_replica_count": ubx.FieldSpec(wire_name="max_replica_count"),
    "min_replica_count": ubx.FieldSpec(wire_name="min_replica_count"),
    ...
    "scale_to_zero_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1IndexEndpoint_DeployedIndexes_DedicatedResources_ScaleToZeroSpecFields,
    ),
    "spot": ubx.FieldSpec(wire_name="spot"),
}

_V1beta1IndexEndpoint_DeployedIndexes_DeployedIndexAuthConfig_AuthProviderFields = {
    "allowed_issuers": ubx.FieldSpec(wire_name="allowed_issuers"),
    "audiences": ubx.FieldSpec(wire_name="audiences"),
}

_V1beta1IndexEndpoint_DeployedIndexes_DeployedIndexAuthConfigFields = {
    "auth_provider": ubx.FieldSpec(
        wire_name="auth_provider",
        kind="object",
        fields=_V1beta1IndexEndpoint_DeployedIndexes_DeployedIndexAuthConfig_AuthProviderFields,
    ),
}

_V1beta1IndexEndpoint_DeployedIndexes_PrivateEndpoints_PscAutomatedEndpointsFields = {
...
_V1beta1IndexEndpoint_DeployedIndexes_PrivateEndpointsFields = {
    ...
    "psc_automated_endpoints": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1IndexEndpoint_DeployedIndexes_PrivateEndpoints_PscAutomatedEndpointsFields,
    ),
...
_V1beta1IndexEndpoint_DeployedIndexesFields = {
    "automatic_resources": ubx.FieldSpec(
        wire_name="automatic_resources",
        kind="object",
        fields=_V1beta1IndexEndpoint_DeployedIndexes_AutomaticResourcesFields,
    ),
    "create_time": ubx.FieldSpec(wire_name="create_time"),
    "dedicated_resources": ubx.FieldSpec(
        wire_name="dedicated_resources",
        kind="object",
        fields=_V1beta1IndexEndpoint_DeployedIndexes_DedicatedResourcesFields,
    ),
    "deployed_index_auth_config": ubx.FieldSpec(
        wire_name="deployed_index_auth_config",
        kind="object",
        fields=_V1beta1IndexEndpoint_DeployedIndexes_DeployedIndexAuthConfigFields,
    ),
    ...
    "private_endpoints": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1IndexEndpoint_DeployedIndexes_PrivateEndpointsFields,
    ),
...
V1beta1IndexEndpoint = ubx.ResourceBinding(
    ...
    fields={
        ...
        "deployed_indexes": ubx.FieldSpec(
            ...
            kind="list",
            fields=_V1beta1IndexEndpoint_DeployedIndexesFields,
        ),
