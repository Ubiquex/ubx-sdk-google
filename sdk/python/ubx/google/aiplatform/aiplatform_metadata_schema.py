...
class AiplatformMetadataSchemaConfig:
...
@dataclasses.dataclass
class AiplatformMetadataSchemaAttrs:
    # Output only. Timestamp when this MetadataSchema was created.
    create_time: Any = None
    # Description of the Metadata Schema
    description: Any = None
...
AiplatformMetadataSchema = ubx.ResourceBinding(
    wire_type="google_aiplatform_aiplatform_metadata_schema",
    fields={
