...
class AiplatformEndpoint_ClientConnectionConfig:
    # Customizable online prediction request timeout.
    inference_timeout: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_AutomaticResources:
    max_replica_count: Any = None
    min_replica_count: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_DedicatedResources_AutoscalingMetricSpecs:
    metric_name: Any = None
    target: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_DedicatedResources_MachineSpec_ReservationAffinity:
    key: Any = None
    reservation_affinity_type: Any = None
    values: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_DedicatedResources_MachineSpec:
...
@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_DedicatedResources:
...
@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata_Inputs_FeatureValueDomain:
    max_value: Any = None
    min_value: Any = None
...
@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata_Inputs_Visualization:
...
@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata_Inputs:
...
@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata_Outputs:
    display_name_mapping_key: Any = None
    index_display_name_mapping: Any = None
    output_tensor_name: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata:
...
@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource:
    uris: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_Examples_ExampleGcsSource:
    data_format: Any = None
    gcs_source: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_Examples_Presets:
    modality: Any = None
    query: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_Examples:
...
@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig:
    max_blur_sigma: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma:
    name: Any = None
    sigma: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma:
    noise_sigma: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig:
    feature_noise_sigma: Any = None
    noise_sigma: Any = None
    noisy_sample_count: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution:
    blur_baseline_config: Any = None
    smooth_grad_config: Any = None
    step_count: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_SampledShapleyAttribution:
    path_count: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters:
    examples: Any = None
...
@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_ExplanationSpec:
    metadata: Any = None
    parameters: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_FasterDeploymentConfig:
    fast_tryout_enabled: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_PrivateEndpoints:
...
@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_SpeculativeDecodingSpec_DraftModelSpeculation:
    draft_model: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_SpeculativeDecodingSpec_NgramSpeculation:
    ngram_size: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_SpeculativeDecodingSpec:
    draft_model_speculation: Any = None
    ngram_speculation: Any = None
    speculative_token_count: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels_Status:
    available_replica_count: Any = None
    last_update_time: Any = None
    message: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_DeployedModels:
...
@dataclasses.dataclass
class AiplatformEndpoint_GenAiAdvancedFeaturesConfig:
    # Configuration for Retrieval Augmented Generation feature.
    rag_config: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_PredictRequestResponseLoggingConfig_BigqueryDestination:
    # Required. BigQuery URI to a project or table, up to 2000 characters long. When only the project is specified, the Dataset and Table is created. When the full table reference is specified, the Dataset must exist and table must not exist. Accepted forms: * BigQuery path. For example: `bq://projectId` or `bq://projectId.bqDatasetId` or `bq://projectId.bqDatasetId.bqTableId`.
    output_uri: Any = None

@dataclasses.dataclass
class AiplatformEndpoint_PredictRequestResponseLoggingConfig:
...
@dataclasses.dataclass
class AiplatformEndpoint_PrivateServiceConnectConfig_PscAutomationConfigs:
...
@dataclasses.dataclass
class AiplatformEndpoint_PrivateServiceConnectConfig:
...
_AiplatformEndpoint_DeployedModels_DedicatedResources_MachineSpecFields = {
    ...
    "reservation_affinity": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_DedicatedResources_MachineSpec_ReservationAffinityFields,
    ),
    "tpu_topology": ubx.FieldSpec(wire_name="tpu_topology"),
}

_AiplatformEndpoint_DeployedModels_DedicatedResourcesFields = {
    "autoscaling_metric_specs": ubx.FieldSpec(
        wire_name="autoscaling_metric_specs",
        kind="list",
        fields=_AiplatformEndpoint_DeployedModels_DedicatedResources_AutoscalingMetricSpecsFields,
    ),
    "machine_spec": ubx.FieldSpec(
        wire_name="machine_spec",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_DedicatedResources_MachineSpecFields,
    ),
    "max_replica_count": ubx.FieldSpec(wire_name="max_replica_count"),
    "min_replica_count": ubx.FieldSpec(wire_name="min_replica_count"),
...
_AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata_Inputs_FeatureValueDomainFields = {
...
_AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata_Inputs_VisualizationFields = {
...
_AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata_InputsFields = {
    ...
    "feature_value_domain": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata_Inputs_FeatureValueDomainFields,
    ),
    ...
    "visualization": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata_Inputs_VisualizationFields,
    ),
}

_AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata_OutputsFields = {
...
_AiplatformEndpoint_DeployedModels_ExplanationSpec_MetadataFields = {
    "feature_attributions_schema_uri": ubx.FieldSpec(wire_name="feature_attributions_schema_uri"),
    "inputs": ubx.FieldSpec(
        wire_name="inputs",
        kind="map",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata_InputsFields,
    ),
    "latent_space_source": ubx.FieldSpec(wire_name="latent_space_source"),
    "outputs": ubx.FieldSpec(
        wire_name="outputs",
        kind="map",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Metadata_OutputsFields,
    ),
}

_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSourceFields = {
    "uris": ubx.FieldSpec(wire_name="uris"),
}

_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_Examples_ExampleGcsSourceFields = {
    "data_format": ubx.FieldSpec(wire_name="data_format"),
    "gcs_source": ubx.FieldSpec(
        wire_name="gcs_source",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSourceFields,
    ),
}

_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_Examples_PresetsFields = {
    "modality": ubx.FieldSpec(wire_name="modality"),
    "query": ubx.FieldSpec(wire_name="query"),
}

_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_ExamplesFields = {
    "example_gcs_source": ubx.FieldSpec(
        wire_name="example_gcs_source",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_Examples_ExampleGcsSourceFields,
    ),
    ...
    "presets": ubx.FieldSpec(
        wire_name="presets",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_Examples_PresetsFields,
    ),
}

_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfigFields = {
    "max_blur_sigma": ubx.FieldSpec(wire_name="max_blur_sigma"),
}

_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigmaFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "sigma": ubx.FieldSpec(wire_name="sigma"),
}

_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigmaFields = {
    "noise_sigma": ubx.FieldSpec(
        wire_name="noise_sigma",
        kind="list",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigmaFields,
    ),
}

_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfigFields = {
    "feature_noise_sigma": ubx.FieldSpec(
        wire_name="feature_noise_sigma",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigmaFields,
    ),
    "noise_sigma": ubx.FieldSpec(wire_name="noise_sigma"),
    "noisy_sample_count": ubx.FieldSpec(wire_name="noisy_sample_count"),
}

_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttributionFields = {
    "blur_baseline_config": ubx.FieldSpec(
        wire_name="blur_baseline_config",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfigFields,
    ),
    "smooth_grad_config": ubx.FieldSpec(
        wire_name="smooth_grad_config",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfigFields,
    ),
    "step_count": ubx.FieldSpec(wire_name="step_count"),
}

_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_SampledShapleyAttributionFields = {
    "path_count": ubx.FieldSpec(wire_name="path_count"),
}

_AiplatformEndpoint_DeployedModels_ExplanationSpec_ParametersFields = {
    "examples": ubx.FieldSpec(
        wire_name="examples",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_ExamplesFields,
    ),
    "integrated_gradients_attribution": ubx.FieldSpec(
        wire_name="integrated_gradients_attribution",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_IntegratedGradientsAttributionFields,
    ),
    ...
    "sampled_shapley_attribution": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_Parameters_SampledShapleyAttributionFields,
    ),
...
_AiplatformEndpoint_DeployedModels_ExplanationSpecFields = {
    "metadata": ubx.FieldSpec(
        wire_name="metadata",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_MetadataFields,
    ),
    "parameters": ubx.FieldSpec(
        wire_name="parameters",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpec_ParametersFields,
    ),
}

_AiplatformEndpoint_DeployedModels_FasterDeploymentConfigFields = {
    "fast_tryout_enabled": ubx.FieldSpec(wire_name="fast_tryout_enabled"),
}

_AiplatformEndpoint_DeployedModels_PrivateEndpointsFields = {
...
_AiplatformEndpoint_DeployedModels_SpeculativeDecodingSpec_DraftModelSpeculationFields = {
    "draft_model": ubx.FieldSpec(wire_name="draft_model"),
}

_AiplatformEndpoint_DeployedModels_SpeculativeDecodingSpec_NgramSpeculationFields = {
    "ngram_size": ubx.FieldSpec(wire_name="ngram_size"),
}

_AiplatformEndpoint_DeployedModels_SpeculativeDecodingSpecFields = {
    "draft_model_speculation": ubx.FieldSpec(
        wire_name="draft_model_speculation",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_SpeculativeDecodingSpec_DraftModelSpeculationFields,
    ),
    "ngram_speculation": ubx.FieldSpec(
        wire_name="ngram_speculation",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_SpeculativeDecodingSpec_NgramSpeculationFields,
    ),
    "speculative_token_count": ubx.FieldSpec(wire_name="speculative_token_count"),
}

_AiplatformEndpoint_DeployedModels_StatusFields = {
...
_AiplatformEndpoint_DeployedModelsFields = {
    "automatic_resources": ubx.FieldSpec(
        wire_name="automatic_resources",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_AutomaticResourcesFields,
    ),
    ...
    "dedicated_resources": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_DedicatedResourcesFields,
    ),
    ...
    "explanation_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_ExplanationSpecFields,
    ),
    "faster_deployment_config": ubx.FieldSpec(
        wire_name="faster_deployment_config",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_FasterDeploymentConfigFields,
    ),
    ...
    "private_endpoints": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_PrivateEndpointsFields,
    ),
    ...
    "speculative_decoding_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_SpeculativeDecodingSpecFields,
    ),
    "status": ubx.FieldSpec(
        wire_name="status",
        kind="object",
        fields=_AiplatformEndpoint_DeployedModels_StatusFields,
    ),
    "system_labels": ubx.FieldSpec(wire_name="system_labels"),
}

_AiplatformEndpoint_EncryptionSpecFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

_AiplatformEndpoint_GdcConfigFields = {
    "zone": ubx.FieldSpec(wire_name="zone"),
}

_AiplatformEndpoint_GenAiAdvancedFeaturesConfig_RagConfigFields = {
    "enable_rag": ubx.FieldSpec(wire_name="enable_rag"),
}

_AiplatformEndpoint_GenAiAdvancedFeaturesConfigFields = {
    "rag_config": ubx.FieldSpec(
        wire_name="rag_config",
        kind="object",
        fields=_AiplatformEndpoint_GenAiAdvancedFeaturesConfig_RagConfigFields,
    ),
}

_AiplatformEndpoint_PredictRequestResponseLoggingConfig_BigqueryDestinationFields = {
    "output_uri": ubx.FieldSpec(wire_name="output_uri"),
}

_AiplatformEndpoint_PredictRequestResponseLoggingConfigFields = {
    "bigquery_destination": ubx.FieldSpec(
        wire_name="bigquery_destination",
        kind="object",
        fields=_AiplatformEndpoint_PredictRequestResponseLoggingConfig_BigqueryDestinationFields,
    ),
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "sampling_rate": ubx.FieldSpec(wire_name="sampling_rate"),
}

_AiplatformEndpoint_PrivateServiceConnectConfig_PscAutomationConfigsFields = {
...
_AiplatformEndpoint_PrivateServiceConnectConfigFields = {
    ...
    "psc_automation_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_AiplatformEndpoint_PrivateServiceConnectConfig_PscAutomationConfigsFields,
    ),
    "service_attachment": ubx.FieldSpec(wire_name="service_attachment"),
}

@dataclasses.dataclass
class AiplatformEndpointConfig:
...
AiplatformEndpoint = ubx.ResourceBinding(
    wire_type="google_aiplatform_aiplatform_endpoint",
    fields={
        "client_connection_config": ubx.FieldSpec(
            wire_name="client_connection_config",
            kind="object",
            fields=_AiplatformEndpoint_ClientConnectionConfigFields,
        ),
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        ...
        "deployed_models": ubx.FieldSpec(
            ...
            kind="list",
            fields=_AiplatformEndpoint_DeployedModelsFields,
        ),
        ...
        "encryption_spec": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AiplatformEndpoint_EncryptionSpecFields,
        ),
        "etag": ubx.FieldSpec(wire_name="etag"),
        "gdc_config": ubx.FieldSpec(
            wire_name="gdc_config",
            kind="object",
            fields=_AiplatformEndpoint_GdcConfigFields,
        ),
        "gen_ai_advanced_features_config": ubx.FieldSpec(
            wire_name="gen_ai_advanced_features_config",
            kind="object",
            fields=_AiplatformEndpoint_GenAiAdvancedFeaturesConfigFields,
        ),
        ...
        "predict_request_response_logging_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AiplatformEndpoint_PredictRequestResponseLoggingConfigFields,
        ),
        "private_service_connect_config": ubx.FieldSpec(
            wire_name="private_service_connect_config",
            kind="object",
            fields=_AiplatformEndpoint_PrivateServiceConnectConfigFields,
        ),
