...
@dataclasses.dataclass
class CustomJob_JobSpec_BaseOutputDirectory:
    # Required. Google Cloud Storage URI to output directory. If the uri doesn't end with '/', a '/' will be automatically appended. The directory is created if it doesn't exist.
    output_uri_prefix: Any = None

@dataclasses.dataclass
class CustomJob_JobSpec_PscInterfaceConfig_DnsPeeringConfigs:
    domain: Any = None
    target_network: Any = None
    target_project: Any = None

@dataclasses.dataclass
class CustomJob_JobSpec_PscInterfaceConfig:
...
@dataclasses.dataclass
class CustomJob_JobSpec_Scheduling:
...
@dataclasses.dataclass
class CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec_Env:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec:
    args: Any = None
    command: Any = None
    env: Any = None
    image_uri: Any = None
...
@dataclasses.dataclass
class CustomJob_JobSpec_WorkerPoolSpecs_DiskSpec:
    boot_disk_size_gb: Any = None
    boot_disk_type: Any = None

@dataclasses.dataclass
class CustomJob_JobSpec_WorkerPoolSpecs_LustreMounts:
    filesystem: Any = None
...
@dataclasses.dataclass
class CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec_ReservationAffinity:
    key: Any = None
    reservation_affinity_type: Any = None
    values: Any = None

@dataclasses.dataclass
class CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec:
...
@dataclasses.dataclass
class CustomJob_JobSpec_WorkerPoolSpecs_NfsMounts:
    mount_point: Any = None
    path: Any = None
    server: Any = None

@dataclasses.dataclass
class CustomJob_JobSpec_WorkerPoolSpecs_PythonPackageSpec:
    args: Any = None
    env: Any = None
...
@dataclasses.dataclass
class CustomJob_JobSpec_WorkerPoolSpecs:
...
_CustomJob_JobSpec_PscInterfaceConfigFields = {
    "dns_peering_configs": ubx.FieldSpec(
        wire_name="dns_peering_configs",
        kind="list",
        fields=_CustomJob_JobSpec_PscInterfaceConfig_DnsPeeringConfigsFields,
    ),
    "network_attachment": ubx.FieldSpec(wire_name="network_attachment"),
}

_CustomJob_JobSpec_SchedulingFields = {
...
_CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec_EnvFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpecFields = {
    "args": ubx.FieldSpec(wire_name="args"),
    "command": ubx.FieldSpec(wire_name="command"),
    "env": ubx.FieldSpec(
        wire_name="env",
        kind="list",
        fields=_CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpec_EnvFields,
    ),
    "image_uri": ubx.FieldSpec(wire_name="image_uri"),
}

_CustomJob_JobSpec_WorkerPoolSpecs_DiskSpecFields = {
    "boot_disk_size_gb": ubx.FieldSpec(wire_name="boot_disk_size_gb"),
    "boot_disk_type": ubx.FieldSpec(wire_name="boot_disk_type"),
}

_CustomJob_JobSpec_WorkerPoolSpecs_LustreMountsFields = {
...
_CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec_ReservationAffinityFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "reservation_affinity_type": ubx.FieldSpec(wire_name="reservation_affinity_type"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_CustomJob_JobSpec_WorkerPoolSpecs_MachineSpecFields = {
    ...
    "reservation_affinity": ubx.FieldSpec(
        ...
        kind="object",
        fields=_CustomJob_JobSpec_WorkerPoolSpecs_MachineSpec_ReservationAffinityFields,
    ),
    "tpu_topology": ubx.FieldSpec(wire_name="tpu_topology"),
}

_CustomJob_JobSpec_WorkerPoolSpecs_NfsMountsFields = {
    "mount_point": ubx.FieldSpec(wire_name="mount_point"),
    "path": ubx.FieldSpec(wire_name="path"),
    "server": ubx.FieldSpec(wire_name="server"),
}

_CustomJob_JobSpec_WorkerPoolSpecs_PythonPackageSpecFields = {
    "args": ubx.FieldSpec(wire_name="args"),
    "env": ubx.FieldSpec(
        wire_name="env",
        kind="list",
...
_CustomJob_JobSpec_WorkerPoolSpecsFields = {
    "container_spec": ubx.FieldSpec(
        wire_name="container_spec",
        kind="object",
        fields=_CustomJob_JobSpec_WorkerPoolSpecs_ContainerSpecFields,
    ),
    "disk_spec": ubx.FieldSpec(
        wire_name="disk_spec",
        kind="object",
        fields=_CustomJob_JobSpec_WorkerPoolSpecs_DiskSpecFields,
    ),
    "lustre_mounts": ubx.FieldSpec(
        wire_name="lustre_mounts",
        kind="list",
        fields=_CustomJob_JobSpec_WorkerPoolSpecs_LustreMountsFields,
    ),
    "machine_spec": ubx.FieldSpec(
        wire_name="machine_spec",
        kind="object",
        fields=_CustomJob_JobSpec_WorkerPoolSpecs_MachineSpecFields,
    ),
    "nfs_mounts": ubx.FieldSpec(
        wire_name="nfs_mounts",
        kind="list",
        fields=_CustomJob_JobSpec_WorkerPoolSpecs_NfsMountsFields,
    ),
    "python_package_spec": ubx.FieldSpec(
        wire_name="python_package_spec",
        kind="object",
        fields=_CustomJob_JobSpec_WorkerPoolSpecs_PythonPackageSpecFields,
    ),
    "replica_count": ubx.FieldSpec(wire_name="replica_count"),
}

_CustomJob_JobSpecFields = {
    "base_output_directory": ubx.FieldSpec(
        wire_name="base_output_directory",
        kind="object",
        fields=_CustomJob_JobSpec_BaseOutputDirectoryFields,
    ),
    ...
    "worker_pool_specs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_CustomJob_JobSpec_WorkerPoolSpecsFields,
    ),
}
...
CustomJob = ubx.ResourceBinding(
    wire_type="google_aiplatform_custom_job",
    fields={
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        "encryption_spec": ubx.FieldSpec(
            wire_name="encryption_spec",
            kind="object",
            fields=_CustomJob_EncryptionSpecFields,
        ),
        "error": ubx.FieldSpec(
            wire_name="error",
            kind="object",
            fields=_CustomJob_ErrorFields,
        ),
        "job_spec": ubx.FieldSpec(
            wire_name="job_spec",
            kind="object",
            fields=_CustomJob_JobSpecFields,
        ),
