...
class V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecs:
    metric_name: Any = None
    monitored_resource_labels: Any = None
    target: Any = None

@dataclasses.dataclass
class V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_FlexStart:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinity:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpec:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_ScaleToZeroSpec:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool:
...
_V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecsFields = {
...
_V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_FlexStartFields = {
    "max_runtime_duration": ubx.FieldSpec(wire_name="max_runtime_duration"),
}

_V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinityFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "reservation_affinity_type": ubx.FieldSpec(wire_name="reservation_affinity_type"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpecFields = {
    ...
    "reservation_affinity": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinityFields,
    ),
    "tpu_topology": ubx.FieldSpec(wire_name="tpu_topology"),
}

_V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_ScaleToZeroSpecFields = {
...
_V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResourcesFields = {
    "autoscaling_metric_specs": ubx.FieldSpec(
        wire_name="autoscaling_metric_specs",
        kind="list",
        fields=_V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecsFields,
    ),
    "flex_start": ubx.FieldSpec(
        wire_name="flex_start",
        kind="object",
        fields=_V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_FlexStartFields,
    ),
    "initial_replica_count": ubx.FieldSpec(wire_name="initial_replica_count"),
    "machine_spec": ubx.FieldSpec(
        wire_name="machine_spec",
        kind="object",
        fields=_V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_MachineSpecFields,
    ),
    ...
    "scale_to_zero_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResources_ScaleToZeroSpecFields,
    ),
    "spot": ubx.FieldSpec(wire_name="spot"),
}

_V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool_EncryptionSpecFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

_V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePoolFields = {
    "create_time": ubx.FieldSpec(wire_name="create_time"),
    "dedicated_resources": ubx.FieldSpec(
        wire_name="dedicated_resources",
        kind="object",
        fields=_V1beta1AiplatformV1beta1DeploymentResourcePool_DedicatedResourcesFields,
    ),
    ...
    "encryption_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePool_EncryptionSpecFields,
    ),
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1DeploymentResourcePoolConfig:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1DeploymentResourcePoolAttrs:
    # Output only. Timestamp when this DeploymentResourcePool was created.
    create_time: Any = None
    # A description of resources that are dedicated to a DeployedModel or DeployedIndex, and that need a higher degree of manual configuration.
    dedicated_resources: Any = None
...
V1beta1AiplatformV1beta1DeploymentResourcePool = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_aiplatform_v1beta1_deployment_resource_pool",
    fields={
        "deployment_resource_pool": ubx.FieldSpec(
            wire_name="deployment_resource_pool",
            kind="object",
            fields=_V1beta1AiplatformV1beta1DeploymentResourcePool_DeploymentResourcePoolFields,
        ),
