...
class V1beta1AiplatformV1beta1ExecutionConfig:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1ExecutionAttrs:
    # Output only. Timestamp when this Execution was created.
    create_time: Any = None
    # Description of the Execution
    description: Any = None
...
V1beta1AiplatformV1beta1Execution = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_aiplatform_v1beta1_execution",
    fields={
