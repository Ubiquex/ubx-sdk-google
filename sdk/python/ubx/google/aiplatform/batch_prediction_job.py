...
class BatchPredictionJob_CompletionStats:
...
@dataclasses.dataclass
class BatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinity:
...
@dataclasses.dataclass
class BatchPredictionJob_DedicatedResources_MachineSpec:
...
@dataclasses.dataclass
class BatchPredictionJob_DedicatedResources:
...
@dataclasses.dataclass
class BatchPredictionJob_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class BatchPredictionJob_Error:
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Metadata_Inputs_FeatureValueDomain:
    max_value: Any = None
    min_value: Any = None
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Metadata_Inputs_Visualization:
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Metadata_Inputs:
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Metadata_Outputs:
    display_name_mapping_key: Any = None
    index_display_name_mapping: Any = None
    output_tensor_name: Any = None

@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Metadata:
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource:
    # Required. Google Cloud Storage URI(-s) to the input file(s). May contain wildcards. For more information on wildcards, see https://cloud.google.com/storage/docs/wildcards.
    uris: Any = None

@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource:
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Parameters_Examples_Presets:
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Parameters_Examples:
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig:
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigma:
    name: Any = None
    sigma: Any = None

@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma:
    # Noise sigma per feature. No noise is added to features that are not set.
    noise_sigma: Any = None

@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig:
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution:
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttribution:
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec_Parameters:
...
@dataclasses.dataclass
class BatchPredictionJob_ExplanationSpec:
...
@dataclasses.dataclass
class BatchPredictionJob_InputConfig_BigquerySource:
...
@dataclasses.dataclass
class BatchPredictionJob_InputConfig_VertexMultimodalDatasetSource:
...
@dataclasses.dataclass
class BatchPredictionJob_ManualBatchTuningParameters:
    # Immutable. The number of the records (e.g. instances) of the operation given in each batch to a machine replica. Machine type, and size of a single record should be considered when setting this parameter, higher value speeds up the batch operation's execution, but too high value will result in a whole batch not fitting in a machine's memory, and the whole operation will fail. The default value is 64.
    batch_size: Any = None

@dataclasses.dataclass
class BatchPredictionJob_OutputConfig_BigqueryDestination:
    # Required. BigQuery URI to a project or table, up to 2000 characters long. When only the project is specified, the Dataset and Table is created. When the full table reference is specified, the Dataset must exist and table must not exist. Accepted forms: * BigQuery path. For example: `bq://projectId` or `bq://projectId.bqDatasetId` or `bq://projectId.bqDatasetId.bqTableId`.
    output_uri: Any = None

@dataclasses.dataclass
class BatchPredictionJob_OutputConfig_GcsDestination:
    # Required. Google Cloud Storage URI to output directory. If the uri doesn't end with '/', a '/' will be automatically appended. The directory is created if it doesn't exist.
    output_uri_prefix: Any = None

@dataclasses.dataclass
class BatchPredictionJob_OutputConfig_VertexMultimodalDatasetDestination:
...
@dataclasses.dataclass
class BatchPredictionJob_ResourcesConsumed:
...
@dataclasses.dataclass
class BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_Env:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPorts:
    container_port: Any = None

@dataclasses.dataclass
class BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Exec:
    # Command is the command line to execute inside the container, the working directory for the command is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.
    command: Any = None

@dataclasses.dataclass
class BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_Grpc:
...
@dataclasses.dataclass
class BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGet:
...
@dataclasses.dataclass
class BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocket:
...
@dataclasses.dataclass
class BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe:
...
@dataclasses.dataclass
class BatchPredictionJob_UnmanagedContainerModel_ContainerSpec:
...
@dataclasses.dataclass
class BatchPredictionJob_UnmanagedContainerModel_PredictSchemata:
...
@dataclasses.dataclass
class BatchPredictionJob_UnmanagedContainerModel:
...
_BatchPredictionJob_CompletionStatsFields = {
...
_BatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinityFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "reservation_affinity_type": ubx.FieldSpec(wire_name="reservation_affinity_type"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_BatchPredictionJob_DedicatedResources_MachineSpecFields = {
    ...
    "reservation_affinity": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BatchPredictionJob_DedicatedResources_MachineSpec_ReservationAffinityFields,
    ),
    "tpu_topology": ubx.FieldSpec(wire_name="tpu_topology"),
}

_BatchPredictionJob_DedicatedResourcesFields = {
    "machine_spec": ubx.FieldSpec(
        wire_name="machine_spec",
        kind="object",
        fields=_BatchPredictionJob_DedicatedResources_MachineSpecFields,
    ),
...
_BatchPredictionJob_ExplanationSpec_Metadata_Inputs_VisualizationFields = {
...
_BatchPredictionJob_ExplanationSpec_Metadata_InputsFields = {
    ...
    "feature_value_domain": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_Metadata_Inputs_FeatureValueDomainFields,
    ),
    ...
    "visualization": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_Metadata_Inputs_VisualizationFields,
    ),
}

_BatchPredictionJob_ExplanationSpec_Metadata_OutputsFields = {
...
_BatchPredictionJob_ExplanationSpec_MetadataFields = {
    "feature_attributions_schema_uri": ubx.FieldSpec(wire_name="feature_attributions_schema_uri"),
    "inputs": ubx.FieldSpec(
        wire_name="inputs",
        kind="map",
        fields=_BatchPredictionJob_ExplanationSpec_Metadata_InputsFields,
    ),
    "latent_space_source": ubx.FieldSpec(wire_name="latent_space_source"),
    "outputs": ubx.FieldSpec(
        wire_name="outputs",
        kind="map",
        fields=_BatchPredictionJob_ExplanationSpec_Metadata_OutputsFields,
    ),
}

_BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSourceFields = {
    "uris": ubx.FieldSpec(wire_name="uris"),
}

_BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSourceFields = {
    "data_format": ubx.FieldSpec(wire_name="data_format"),
    "gcs_source": ubx.FieldSpec(
        wire_name="gcs_source",
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSourceFields,
    ),
}

_BatchPredictionJob_ExplanationSpec_Parameters_Examples_PresetsFields = {
    "modality": ubx.FieldSpec(wire_name="modality"),
    "query": ubx.FieldSpec(wire_name="query"),
}

_BatchPredictionJob_ExplanationSpec_Parameters_ExamplesFields = {
    "example_gcs_source": ubx.FieldSpec(
        wire_name="example_gcs_source",
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_Parameters_Examples_ExampleGcsSourceFields,
    ),
    ...
    "presets": ubx.FieldSpec(
        wire_name="presets",
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_Parameters_Examples_PresetsFields,
    ),
}

_BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfigFields = {
    "max_blur_sigma": ubx.FieldSpec(wire_name="max_blur_sigma"),
}

_BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigmaFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "sigma": ubx.FieldSpec(wire_name="sigma"),
}

_BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigmaFields = {
    "noise_sigma": ubx.FieldSpec(
        wire_name="noise_sigma",
        kind="list",
        fields=_BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigmaFields,
    ),
}

_BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfigFields = {
    "feature_noise_sigma": ubx.FieldSpec(
        wire_name="feature_noise_sigma",
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigmaFields,
    ),
    "noise_sigma": ubx.FieldSpec(wire_name="noise_sigma"),
    "noisy_sample_count": ubx.FieldSpec(wire_name="noisy_sample_count"),
}

_BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttributionFields = {
    "blur_baseline_config": ubx.FieldSpec(
        wire_name="blur_baseline_config",
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfigFields,
    ),
    "smooth_grad_config": ubx.FieldSpec(
        wire_name="smooth_grad_config",
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfigFields,
    ),
    "step_count": ubx.FieldSpec(wire_name="step_count"),
}

_BatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttributionFields = {
    "path_count": ubx.FieldSpec(wire_name="path_count"),
}

_BatchPredictionJob_ExplanationSpec_ParametersFields = {
    "examples": ubx.FieldSpec(
        wire_name="examples",
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_Parameters_ExamplesFields,
    ),
    "integrated_gradients_attribution": ubx.FieldSpec(
        wire_name="integrated_gradients_attribution",
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_Parameters_IntegratedGradientsAttributionFields,
    ),
    ...
    "sampled_shapley_attribution": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_Parameters_SampledShapleyAttributionFields,
    ),
...
_BatchPredictionJob_ExplanationSpecFields = {
    "metadata": ubx.FieldSpec(
        wire_name="metadata",
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_MetadataFields,
    ),
    "parameters": ubx.FieldSpec(
        wire_name="parameters",
        kind="object",
        fields=_BatchPredictionJob_ExplanationSpec_ParametersFields,
    ),
}

_BatchPredictionJob_InputConfig_BigquerySourceFields = {
    "input_uri": ubx.FieldSpec(wire_name="input_uri"),
}

_BatchPredictionJob_InputConfig_VertexMultimodalDatasetSourceFields = {
    "dataset_name": ubx.FieldSpec(wire_name="dataset_name"),
}

_BatchPredictionJob_InputConfigFields = {
    "bigquery_source": ubx.FieldSpec(
        wire_name="bigquery_source",
        kind="object",
        fields=_BatchPredictionJob_InputConfig_BigquerySourceFields,
    ),
    "gcs_source": ubx.FieldSpec(
        wire_name="gcs_source",
        kind="object",
    ...
    "vertex_multimodal_dataset_source": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BatchPredictionJob_InputConfig_VertexMultimodalDatasetSourceFields,
    ),
}

_BatchPredictionJob_InstanceConfigFields = {
...
_BatchPredictionJob_ManualBatchTuningParametersFields = {
    "batch_size": ubx.FieldSpec(wire_name="batch_size"),
}

_BatchPredictionJob_OutputConfig_BigqueryDestinationFields = {
    "output_uri": ubx.FieldSpec(wire_name="output_uri"),
}

_BatchPredictionJob_OutputConfig_GcsDestinationFields = {
    "output_uri_prefix": ubx.FieldSpec(wire_name="output_uri_prefix"),
}

_BatchPredictionJob_OutputConfig_VertexMultimodalDatasetDestinationFields = {
    "bigquery_destination": ubx.FieldSpec(
        wire_name="bigquery_destination",
        kind="object",
        fields=_BatchPredictionJob_OutputConfig_BigqueryDestinationFields,
    ),
    "display_name": ubx.FieldSpec(wire_name="display_name"),
}

_BatchPredictionJob_OutputConfigFields = {
    "bigquery_destination": ubx.FieldSpec(
        wire_name="bigquery_destination",
        kind="object",
        fields=_BatchPredictionJob_OutputConfig_BigqueryDestinationFields,
    ...
    "gcs_destination": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BatchPredictionJob_OutputConfig_GcsDestinationFields,
    ),
    ...
    "vertex_multimodal_dataset_destination": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BatchPredictionJob_OutputConfig_VertexMultimodalDatasetDestinationFields,
    ),
}

_BatchPredictionJob_OutputInfoFields = {
...
_BatchPredictionJob_ResourcesConsumedFields = {
    "replica_hours": ubx.FieldSpec(wire_name="replica_hours"),
}

_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_EnvFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPortsFields = {
    "container_port": ubx.FieldSpec(wire_name="container_port"),
}

_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_ExecFields = {
    "command": ubx.FieldSpec(wire_name="command"),
}

_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_GrpcFields = {
    "port": ubx.FieldSpec(wire_name="port"),
    "service": ubx.FieldSpec(wire_name="service"),
}

_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGetFields = {
    "host": ubx.FieldSpec(wire_name="host"),
    "http_headers": ubx.FieldSpec(
        wire_name="http_headers",
        kind="list",
        fields=_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_EnvFields,
    ),
...
_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocketFields = {
    "host": ubx.FieldSpec(wire_name="host"),
    "port": ubx.FieldSpec(wire_name="port"),
}

_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbeFields = {
    "exec": ubx.FieldSpec(
        wire_name="exec",
        kind="object",
        fields=_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_ExecFields,
    ),
    "failure_threshold": ubx.FieldSpec(wire_name="failure_threshold"),
    "grpc": ubx.FieldSpec(
        wire_name="grpc",
        kind="object",
        fields=_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_GrpcFields,
    ),
    "http_get": ubx.FieldSpec(
        wire_name="http_get",
        kind="object",
        fields=_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_HttpGetFields,
    ),
    ...
    "tcp_socket": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbe_TcpSocketFields,
    ),
    "timeout_seconds": ubx.FieldSpec(wire_name="timeout_seconds"),
}

_BatchPredictionJob_UnmanagedContainerModel_ContainerSpecFields = {
    ...
    "grpc_ports": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_GrpcPortsFields,
    ),
    "health_probe": ubx.FieldSpec(
        wire_name="health_probe",
        kind="object",
        fields=_BatchPredictionJob_UnmanagedContainerModel_ContainerSpec_HealthProbeFields,
    ),
...
_BatchPredictionJob_UnmanagedContainerModel_PredictSchemataFields = {
...
_BatchPredictionJob_UnmanagedContainerModelFields = {
    "artifact_uri": ubx.FieldSpec(wire_name="artifact_uri"),
    "container_spec": ubx.FieldSpec(
        wire_name="container_spec",
        kind="object",
        fields=_BatchPredictionJob_UnmanagedContainerModel_ContainerSpecFields,
    ),
    "predict_schemata": ubx.FieldSpec(
        wire_name="predict_schemata",
        kind="object",
        fields=_BatchPredictionJob_UnmanagedContainerModel_PredictSchemataFields,
    ),
}
...
BatchPredictionJob = ubx.ResourceBinding(
    wire_type="google_aiplatform_batch_prediction_job",
    fields={
        ...
        "dedicated_resources": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BatchPredictionJob_DedicatedResourcesFields,
        ),
        ...
        "output_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BatchPredictionJob_OutputConfigFields,
        ),
