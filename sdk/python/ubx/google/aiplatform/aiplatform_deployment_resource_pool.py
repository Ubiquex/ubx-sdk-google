...
class AiplatformDeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecs:
    metric_name: Any = None
    target: Any = None

@dataclasses.dataclass
class AiplatformDeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinity:
...
@dataclasses.dataclass
class AiplatformDeploymentResourcePool_DedicatedResources_MachineSpec:
...
@dataclasses.dataclass
class AiplatformDeploymentResourcePool_DedicatedResources:
...
@dataclasses.dataclass
class AiplatformDeploymentResourcePool_DeploymentResourcePool_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class AiplatformDeploymentResourcePool_DeploymentResourcePool:
...
_AiplatformDeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecsFields = {
    "metric_name": ubx.FieldSpec(wire_name="metric_name"),
    "target": ubx.FieldSpec(wire_name="target"),
}

_AiplatformDeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinityFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "reservation_affinity_type": ubx.FieldSpec(wire_name="reservation_affinity_type"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_AiplatformDeploymentResourcePool_DedicatedResources_MachineSpecFields = {
    ...
    "reservation_affinity": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AiplatformDeploymentResourcePool_DedicatedResources_MachineSpec_ReservationAffinityFields,
    ),
    "tpu_topology": ubx.FieldSpec(wire_name="tpu_topology"),
}

_AiplatformDeploymentResourcePool_DedicatedResourcesFields = {
    "autoscaling_metric_specs": ubx.FieldSpec(
        wire_name="autoscaling_metric_specs",
        kind="list",
        fields=_AiplatformDeploymentResourcePool_DedicatedResources_AutoscalingMetricSpecsFields,
    ),
    "machine_spec": ubx.FieldSpec(
        wire_name="machine_spec",
        kind="object",
        fields=_AiplatformDeploymentResourcePool_DedicatedResources_MachineSpecFields,
    ),
...
_AiplatformDeploymentResourcePool_DeploymentResourcePool_EncryptionSpecFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

_AiplatformDeploymentResourcePool_DeploymentResourcePoolFields = {
    "create_time": ubx.FieldSpec(wire_name="create_time"),
    "dedicated_resources": ubx.FieldSpec(
        wire_name="dedicated_resources",
        kind="object",
        fields=_AiplatformDeploymentResourcePool_DedicatedResourcesFields,
    ),
    ...
    "encryption_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AiplatformDeploymentResourcePool_DeploymentResourcePool_EncryptionSpecFields,
    ),
...
@dataclasses.dataclass
class AiplatformDeploymentResourcePoolConfig:
...
@dataclasses.dataclass
class AiplatformDeploymentResourcePoolAttrs:
    # Output only. Timestamp when this DeploymentResourcePool was created.
    create_time: Any = None
    # A description of resources that are dedicated to a DeployedModel or DeployedIndex, and that need a higher degree of manual configuration.
    dedicated_resources: Any = None
...
AiplatformDeploymentResourcePool = ubx.ResourceBinding(
    wire_type="google_aiplatform_aiplatform_deployment_resource_pool",
    fields={
        "deployment_resource_pool": ubx.FieldSpec(
            wire_name="deployment_resource_pool",
            kind="object",
            fields=_AiplatformDeploymentResourcePool_DeploymentResourcePoolFields,
        ),
