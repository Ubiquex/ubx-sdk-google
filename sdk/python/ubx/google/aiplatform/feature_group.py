...
class FeatureGroup_BigQuery_BigQuerySource:
...
@dataclasses.dataclass
class FeatureGroup_BigQuery_TimeSeries:
...
_FeatureGroup_BigQuery_TimeSeriesFields = {
    "timestamp_column": ubx.FieldSpec(wire_name="timestamp_column"),
}

_FeatureGroup_BigQueryFields = {
    "big_query_source": ubx.FieldSpec(
        wire_name="big_query_source",
        kind="object",
        fields=_FeatureGroup_BigQuery_BigQuerySourceFields,
    ),
    ...
    "time_series": ubx.FieldSpec(
        ...
        kind="object",
        fields=_FeatureGroup_BigQuery_TimeSeriesFields,
    ),
}
...
FeatureGroup = ubx.ResourceBinding(
    wire_type="google_aiplatform_feature_group",
    fields={
        "big_query": ubx.FieldSpec(
            wire_name="big_query",
            kind="object",
            fields=_FeatureGroup_BigQueryFields,
        ),
