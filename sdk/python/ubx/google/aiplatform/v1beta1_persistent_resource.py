...
class V1beta1PersistentResource_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class V1beta1PersistentResource_Error:
...
@dataclasses.dataclass
class V1beta1PersistentResource_PscInterfaceConfig_DnsPeeringConfigs:
    domain: Any = None
    target_network: Any = None
    target_project: Any = None

@dataclasses.dataclass
class V1beta1PersistentResource_PscInterfaceConfig:
...
@dataclasses.dataclass
class V1beta1PersistentResource_ResourcePools_AutoscalingSpec:
    max_replica_count: Any = None
    min_replica_count: Any = None

@dataclasses.dataclass
class V1beta1PersistentResource_ResourcePools_DiskSpec:
    boot_disk_size_gb: Any = None
    boot_disk_type: Any = None

@dataclasses.dataclass
class V1beta1PersistentResource_ResourcePools_MachineSpec_ReservationAffinity:
    key: Any = None
    reservation_affinity_type: Any = None
    values: Any = None

@dataclasses.dataclass
class V1beta1PersistentResource_ResourcePools_MachineSpec:
...
@dataclasses.dataclass
class V1beta1PersistentResource_ResourcePools:
...
@dataclasses.dataclass
class V1beta1PersistentResource_ResourceRuntime:
...
@dataclasses.dataclass
class V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec_NfsMounts:
    mount_point: Any = None
    path: Any = None
    server: Any = None

@dataclasses.dataclass
class V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec_RayClusterAutoscalingSpec:
...
@dataclasses.dataclass
class V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec_RayLogsSpec:
    # Optional. Flag to disable the export of Ray OSS logs to Cloud Logging.
    disabled: Any = None

@dataclasses.dataclass
class V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec_RayMetricSpec:
...
@dataclasses.dataclass
class V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec:
...
@dataclasses.dataclass
class V1beta1PersistentResource_ResourceRuntimeSpec_ServiceAccountSpec:
...
_V1beta1PersistentResource_ResourcePools_MachineSpecFields = {
    ...
    "reservation_affinity": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1PersistentResource_ResourcePools_MachineSpec_ReservationAffinityFields,
    ),
    "tpu_topology": ubx.FieldSpec(wire_name="tpu_topology"),
}

_V1beta1PersistentResource_ResourcePoolsFields = {
    "autoscaling_spec": ubx.FieldSpec(
        wire_name="autoscaling_spec",
        kind="object",
        fields=_V1beta1PersistentResource_ResourcePools_AutoscalingSpecFields,
    ),
    "disk_spec": ubx.FieldSpec(
        wire_name="disk_spec",
        kind="object",
        fields=_V1beta1PersistentResource_ResourcePools_DiskSpecFields,
    ),
    "id": ubx.FieldSpec(wire_name="id"),
    "machine_spec": ubx.FieldSpec(
        wire_name="machine_spec",
        kind="object",
        fields=_V1beta1PersistentResource_ResourcePools_MachineSpecFields,
    ),
    "replica_count": ubx.FieldSpec(wire_name="replica_count"),
    "used_replica_count": ubx.FieldSpec(wire_name="used_replica_count"),
}

_V1beta1PersistentResource_ResourceRuntimeFields = {
...
_V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec_NfsMountsFields = {
    "mount_point": ubx.FieldSpec(wire_name="mount_point"),
    "path": ubx.FieldSpec(wire_name="path"),
    "server": ubx.FieldSpec(wire_name="server"),
}

_V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec_RayClusterAutoscalingSpecFields = {
    "idle_timeout_minutes": ubx.FieldSpec(wire_name="idle_timeout_minutes"),
    "upscaling_speed": ubx.FieldSpec(wire_name="upscaling_speed"),
}

_V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec_RayLogsSpecFields = {
    "disabled": ubx.FieldSpec(wire_name="disabled"),
}

_V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec_RayMetricSpecFields = {
    "disabled": ubx.FieldSpec(wire_name="disabled"),
    "enable_usage_stats_collection": ubx.FieldSpec(wire_name="enable_usage_stats_collection"),
}

_V1beta1PersistentResource_ResourceRuntimeSpec_RaySpecFields = {
    ...
    "nfs_mounts": ubx.FieldSpec(
        ...
        kind="list",
        fields=_V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec_NfsMountsFields,
    ),
    "ray_cluster_autoscaling_spec": ubx.FieldSpec(
        wire_name="ray_cluster_autoscaling_spec",
        kind="object",
        fields=_V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec_RayClusterAutoscalingSpecFields,
    ),
    "ray_logs_spec": ubx.FieldSpec(
        wire_name="ray_logs_spec",
        kind="object",
        fields=_V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec_RayLogsSpecFields,
    ),
    "ray_metric_spec": ubx.FieldSpec(
        wire_name="ray_metric_spec",
        kind="object",
        fields=_V1beta1PersistentResource_ResourceRuntimeSpec_RaySpec_RayMetricSpecFields,
    ),
    "resource_pool_images": ubx.FieldSpec(wire_name="resource_pool_images"),
}

_V1beta1PersistentResource_ResourceRuntimeSpec_ServiceAccountSpecFields = {
...
_V1beta1PersistentResource_ResourceRuntimeSpecFields = {
    "ray_spec": ubx.FieldSpec(
        wire_name="ray_spec",
        kind="object",
        fields=_V1beta1PersistentResource_ResourceRuntimeSpec_RaySpecFields,
    ),
    "service_account_spec": ubx.FieldSpec(
        wire_name="service_account_spec",
        kind="object",
        fields=_V1beta1PersistentResource_ResourceRuntimeSpec_ServiceAccountSpecFields,
    ),
}

@dataclasses.dataclass
class V1beta1PersistentResourceConfig:
...
@dataclasses.dataclass
class V1beta1PersistentResourceAttrs:
    # Output only. Time when the PersistentResource was created.
    create_time: Any = None
    # Optional. The display name of the PersistentResource. The name can be up to 128 characters long and can consist of any UTF-8 characters.
    display_name: Any = None
...
V1beta1PersistentResource = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_persistent_resource",
    fields={
        ...
        "encryption_spec": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1PersistentResource_EncryptionSpecFields,
        ),
        "error": ubx.FieldSpec(
            wire_name="error",
            kind="object",
            fields=_V1beta1PersistentResource_ErrorFields,
        ),
