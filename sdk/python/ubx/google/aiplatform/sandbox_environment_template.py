...
class SandboxEnvironmentTemplate_CustomContainerEnvironment_CustomContainerSpec:
...
@dataclasses.dataclass
class SandboxEnvironmentTemplate_CustomContainerEnvironment_Resources:
...
@dataclasses.dataclass
class SandboxEnvironmentTemplate_CustomContainerEnvironment:
...
@dataclasses.dataclass
class SandboxEnvironmentTemplate_DefaultContainerEnvironment:
...
@dataclasses.dataclass
class SandboxEnvironmentTemplate_IngressControlConfig:
...
_SandboxEnvironmentTemplate_CustomContainerEnvironment_CustomContainerSpecFields = {
    "image_uri": ubx.FieldSpec(wire_name="image_uri"),
}

_SandboxEnvironmentTemplate_CustomContainerEnvironment_PortsFields = {
    "port": ubx.FieldSpec(wire_name="port"),
    "protocol": ubx.FieldSpec(wire_name="protocol"),
}

_SandboxEnvironmentTemplate_CustomContainerEnvironment_ResourcesFields = {
    "limits": ubx.FieldSpec(wire_name="limits"),
    "requests": ubx.FieldSpec(wire_name="requests"),
}

_SandboxEnvironmentTemplate_CustomContainerEnvironmentFields = {
    "custom_container_spec": ubx.FieldSpec(
        wire_name="custom_container_spec",
        kind="object",
        fields=_SandboxEnvironmentTemplate_CustomContainerEnvironment_CustomContainerSpecFields,
    ),
    "ports": ubx.FieldSpec(
        wire_name="ports",
        kind="list",
        fields=_SandboxEnvironmentTemplate_CustomContainerEnvironment_PortsFields,
    ),
    "resources": ubx.FieldSpec(
        wire_name="resources",
        kind="object",
        fields=_SandboxEnvironmentTemplate_CustomContainerEnvironment_ResourcesFields,
    ),
}

_SandboxEnvironmentTemplate_DefaultContainerEnvironmentFields = {
...
_SandboxEnvironmentTemplate_EgressControlConfig_DnsPeeringConfigsFields = {
...
_SandboxEnvironmentTemplate_EgressControlConfigFields = {
    ...
    "dns_peering_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_SandboxEnvironmentTemplate_EgressControlConfig_DnsPeeringConfigsFields,
    ),
    "internet_access": ubx.FieldSpec(wire_name="internet_access"),
    "network_attachment": ubx.FieldSpec(wire_name="network_attachment"),
}

_SandboxEnvironmentTemplate_IngressControlConfig_PscAutomationConfigsFields = {
...
_SandboxEnvironmentTemplate_IngressControlConfigFields = {
    ...
    "psc_automation_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_SandboxEnvironmentTemplate_IngressControlConfig_PscAutomationConfigsFields,
    ),
    "service_attachment": ubx.FieldSpec(wire_name="service_attachment"),
}

@dataclasses.dataclass
class SandboxEnvironmentTemplateConfig:
...
@dataclasses.dataclass
class SandboxEnvironmentTemplateAttrs:
...
SandboxEnvironmentTemplate = ubx.ResourceBinding(
    wire_type="google_aiplatform_sandbox_environment_template",
    fields={
        "custom_container_environment": ubx.FieldSpec(
            wire_name="custom_container_environment",
            kind="object",
            fields=_SandboxEnvironmentTemplate_CustomContainerEnvironmentFields,
        ),
        "default_container_environment": ubx.FieldSpec(
            wire_name="default_container_environment",
            kind="object",
            fields=_SandboxEnvironmentTemplate_DefaultContainerEnvironmentFields,
        ),
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        "egress_control_config": ubx.FieldSpec(
            wire_name="egress_control_config",
            kind="object",
            fields=_SandboxEnvironmentTemplate_EgressControlConfigFields,
        ),
        "ingress_control_config": ubx.FieldSpec(
            wire_name="ingress_control_config",
            kind="object",
            fields=_SandboxEnvironmentTemplate_IngressControlConfigFields,
        ),
