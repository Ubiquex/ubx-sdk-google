...
@dataclasses.dataclass
class ModelDeploymentMonitoringJob_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class ModelDeploymentMonitoringJob_Error:
...
@dataclasses.dataclass
class ModelDeploymentMonitoringJob_LoggingSamplingStrategy_RandomSampleConfig:
    # Sample rate (0, 1]
    sample_rate: Any = None

@dataclasses.dataclass
class ModelDeploymentMonitoringJob_LoggingSamplingStrategy:
...
@dataclasses.dataclass
class ModelDeploymentMonitoringJob_ModelDeploymentMonitoringScheduleConfig:
...
@dataclasses.dataclass
class ModelDeploymentMonitoringJob_ModelMonitoringAlertConfig_EmailAlertConfig:
    # The email addresses to send the alert.
    user_emails: Any = None

@dataclasses.dataclass
class ModelDeploymentMonitoringJob_ModelMonitoringAlertConfig:
...
_ModelDeploymentMonitoringJob_ErrorFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_ModelDeploymentMonitoringJob_LatestMonitoringPipelineMetadataFields = {
    "run_time": ubx.FieldSpec(wire_name="run_time"),
    "status": ubx.FieldSpec(
        wire_name="status",
        kind="object",
        fields=_ModelDeploymentMonitoringJob_ErrorFields,
    ),
}

_ModelDeploymentMonitoringJob_LoggingSamplingStrategy_RandomSampleConfigFields = {
    "sample_rate": ubx.FieldSpec(wire_name="sample_rate"),
}

_ModelDeploymentMonitoringJob_LoggingSamplingStrategyFields = {
    "random_sample_config": ubx.FieldSpec(
        wire_name="random_sample_config",
        kind="object",
        fields=_ModelDeploymentMonitoringJob_LoggingSamplingStrategy_RandomSampleConfigFields,
    ),
}

_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_ExplanationConfig_ExplanationBaseline_BigqueryFields = {
    "output_uri": ubx.FieldSpec(wire_name="output_uri"),
}

_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_ExplanationConfig_ExplanationBaseline_GcsFields = {
    "output_uri_prefix": ubx.FieldSpec(wire_name="output_uri_prefix"),
}

_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_ExplanationConfig_ExplanationBaselineFields = {
    "bigquery": ubx.FieldSpec(
        wire_name="bigquery",
        kind="object",
        fields=_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_ExplanationConfig_ExplanationBaseline_BigqueryFields,
    ),
    "gcs": ubx.FieldSpec(
        wire_name="gcs",
        kind="object",
...
_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_ExplanationConfigFields = {
    ...
    "explanation_baseline": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_ExplanationConfig_ExplanationBaselineFields,
    ),
}

_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_PredictionDriftDetectionConfig_AttributionScoreDriftThresholdsFields = {
    "value": ubx.FieldSpec(wire_name="value"),
}

_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_PredictionDriftDetectionConfigFields = {
    "attribution_score_drift_thresholds": ubx.FieldSpec(
        wire_name="attribution_score_drift_thresholds",
        kind="map",
        fields=_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_PredictionDriftDetectionConfig_AttributionScoreDriftThresholdsFields,
    ),
...
_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_TrainingDataset_BigquerySourceFields = {
    "input_uri": ubx.FieldSpec(wire_name="input_uri"),
}

_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_TrainingDataset_GcsSourceFields = {
    "uris": ubx.FieldSpec(wire_name="uris"),
}

_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_TrainingDatasetFields = {
    "bigquery_source": ubx.FieldSpec(
        wire_name="bigquery_source",
        kind="object",
        fields=_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_TrainingDataset_BigquerySourceFields,
    ),
    ...
    "gcs_source": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_TrainingDataset_GcsSourceFields,
    ),
    "logging_sampling_strategy": ubx.FieldSpec(
        wire_name="logging_sampling_strategy",
        kind="object",
        fields=_ModelDeploymentMonitoringJob_LoggingSamplingStrategyFields,
    ),
    "target_field": ubx.FieldSpec(wire_name="target_field"),
}

_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_TrainingPredictionSkewDetectionConfigFields = {
...
_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfigFields = {
    "explanation_config": ubx.FieldSpec(
        wire_name="explanation_config",
        kind="object",
        fields=_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_ExplanationConfigFields,
    ),
    "prediction_drift_detection_config": ubx.FieldSpec(
        wire_name="prediction_drift_detection_config",
        kind="object",
        fields=_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_PredictionDriftDetectionConfigFields,
    ),
    "training_dataset": ubx.FieldSpec(
        wire_name="training_dataset",
        kind="object",
        fields=_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_TrainingDatasetFields,
    ),
    "training_prediction_skew_detection_config": ubx.FieldSpec(
        wire_name="training_prediction_skew_detection_config",
        kind="object",
        fields=_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfig_TrainingPredictionSkewDetectionConfigFields,
    ),
}

_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigsFields = {
    "deployed_model_id": ubx.FieldSpec(wire_name="deployed_model_id"),
    "objective_config": ubx.FieldSpec(
        wire_name="objective_config",
        kind="object",
        fields=_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigs_ObjectiveConfigFields,
    ),
}

_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringScheduleConfigFields = {
    "monitor_interval": ubx.FieldSpec(wire_name="monitor_interval"),
    "monitor_window": ubx.FieldSpec(wire_name="monitor_window"),
}

_ModelDeploymentMonitoringJob_ModelMonitoringAlertConfig_EmailAlertConfigFields = {
    "user_emails": ubx.FieldSpec(wire_name="user_emails"),
}

_ModelDeploymentMonitoringJob_ModelMonitoringAlertConfigFields = {
    "email_alert_config": ubx.FieldSpec(
        wire_name="email_alert_config",
        kind="object",
        fields=_ModelDeploymentMonitoringJob_ModelMonitoringAlertConfig_EmailAlertConfigFields,
    ),
...
ModelDeploymentMonitoringJob = ubx.ResourceBinding(
    ...
    fields={
        ...
        "encryption_spec": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ModelDeploymentMonitoringJob_EncryptionSpecFields,
        ),
        ...
        "latest_monitoring_pipeline_metadata": ubx.FieldSpec(
            ...
            kind="object",
            fields=_ModelDeploymentMonitoringJob_LatestMonitoringPipelineMetadataFields,
        ),
        ...
        "model_deployment_monitoring_objective_configs": ubx.FieldSpec(
            ...
            kind="list",
            fields=_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringObjectiveConfigsFields,
        ),
        "model_deployment_monitoring_schedule_config": ubx.FieldSpec(
            wire_name="model_deployment_monitoring_schedule_config",
            kind="object",
            fields=_ModelDeploymentMonitoringJob_ModelDeploymentMonitoringScheduleConfigFields,
        ),
