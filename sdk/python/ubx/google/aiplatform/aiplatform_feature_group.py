...
class AiplatformFeatureGroup_BigQuery_BigQuerySource:
...
@dataclasses.dataclass
class AiplatformFeatureGroup_BigQuery_TimeSeries:
...
@dataclasses.dataclass
class AiplatformFeatureGroup_BigQuery:
...
_AiplatformFeatureGroup_BigQuery_BigQuerySourceFields = {
    "input_uri": ubx.FieldSpec(wire_name="input_uri"),
}

_AiplatformFeatureGroup_BigQuery_TimeSeriesFields = {
    "timestamp_column": ubx.FieldSpec(wire_name="timestamp_column"),
}

_AiplatformFeatureGroup_BigQueryFields = {
    "big_query_source": ubx.FieldSpec(
        wire_name="big_query_source",
        kind="object",
        fields=_AiplatformFeatureGroup_BigQuery_BigQuerySourceFields,
    ),
    ...
    "time_series": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AiplatformFeatureGroup_BigQuery_TimeSeriesFields,
    ),
}

@dataclasses.dataclass
class AiplatformFeatureGroupConfig:
...
@dataclasses.dataclass
class AiplatformFeatureGroupAttrs:
    # Input source type for BigQuery Tables and Views.
    big_query: Any = None
    # Output only. Timestamp when this FeatureGroup was created.
    create_time: Any = None
...
AiplatformFeatureGroup = ubx.ResourceBinding(
    wire_type="google_aiplatform_aiplatform_feature_group",
    fields={
        "big_query": ubx.FieldSpec(
            wire_name="big_query",
            kind="object",
            fields=_AiplatformFeatureGroup_BigQueryFields,
        ),
