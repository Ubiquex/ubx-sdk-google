...
class FeatureOnlineStore_Bigtable_AutoScaling:
...
@dataclasses.dataclass
class FeatureOnlineStore_Bigtable_BigtableMetadata:
...
@dataclasses.dataclass
class FeatureOnlineStore_DedicatedServingEndpoint_PrivateServiceConnectConfig:
...
@dataclasses.dataclass
class FeatureOnlineStore_DedicatedServingEndpoint:
...
@dataclasses.dataclass
class FeatureOnlineStore_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

_FeatureOnlineStore_Bigtable_AutoScalingFields = {
...
_FeatureOnlineStore_Bigtable_BigtableMetadataFields = {
...
_FeatureOnlineStore_BigtableFields = {
    "auto_scaling": ubx.FieldSpec(
        wire_name="auto_scaling",
        kind="object",
        fields=_FeatureOnlineStore_Bigtable_AutoScalingFields,
    ),
    "bigtable_metadata": ubx.FieldSpec(
        wire_name="bigtable_metadata",
        kind="object",
        fields=_FeatureOnlineStore_Bigtable_BigtableMetadataFields,
    ),
    "enable_direct_bigtable_access": ubx.FieldSpec(wire_name="enable_direct_bigtable_access"),
    "zone": ubx.FieldSpec(wire_name="zone"),
}

_FeatureOnlineStore_DedicatedServingEndpoint_PrivateServiceConnectConfig_PscAutomationConfigsFields = {
...
_FeatureOnlineStore_DedicatedServingEndpoint_PrivateServiceConnectConfigFields = {
    ...
    "psc_automation_configs": ubx.FieldSpec(
        ...
        kind="list",
        fields=_FeatureOnlineStore_DedicatedServingEndpoint_PrivateServiceConnectConfig_PscAutomationConfigsFields,
    ),
    "service_attachment": ubx.FieldSpec(wire_name="service_attachment"),
}

_FeatureOnlineStore_DedicatedServingEndpointFields = {
    "private_service_connect_config": ubx.FieldSpec(
        wire_name="private_service_connect_config",
        kind="object",
        fields=_FeatureOnlineStore_DedicatedServingEndpoint_PrivateServiceConnectConfigFields,
    ),
    "public_endpoint_domain_name": ubx.FieldSpec(wire_name="public_endpoint_domain_name"),
    "service_attachment": ubx.FieldSpec(wire_name="service_attachment"),
}

_FeatureOnlineStore_EncryptionSpecFields = {
...
FeatureOnlineStore = ubx.ResourceBinding(
    wire_type="google_aiplatform_feature_online_store",
    fields={
        ...
        "dedicated_serving_endpoint": ubx.FieldSpec(
            ...
            kind="object",
            fields=_FeatureOnlineStore_DedicatedServingEndpointFields,
        ),
        "encryption_spec": ubx.FieldSpec(
            wire_name="encryption_spec",
            kind="object",
            fields=_FeatureOnlineStore_EncryptionSpecFields,
        ),
