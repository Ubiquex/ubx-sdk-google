...
class V1beta1AiplatformV1beta1FeatureMonitorJob_FeatureSelectionConfig_FeatureConfigs:
    drift_threshold: Any = None
    feature_id: Any = None

@dataclasses.dataclass
class V1beta1AiplatformV1beta1FeatureMonitorJob_FeatureSelectionConfig:
    # Optional. A list of features to be monitored and each feature's drift threshold.
    feature_configs: Any = None

@dataclasses.dataclass
class V1beta1AiplatformV1beta1FeatureMonitorJob_FinalStatus:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1FeatureMonitorJob_JobSummary_FeatureStatsAndAnomalies:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1FeatureMonitorJob_JobSummary:
...
_V1beta1AiplatformV1beta1FeatureMonitorJob_FeatureSelectionConfig_FeatureConfigsFields = {
    "drift_threshold": ubx.FieldSpec(wire_name="drift_threshold"),
    "feature_id": ubx.FieldSpec(wire_name="feature_id"),
}

_V1beta1AiplatformV1beta1FeatureMonitorJob_FeatureSelectionConfigFields = {
    "feature_configs": ubx.FieldSpec(
        wire_name="feature_configs",
        kind="list",
        fields=_V1beta1AiplatformV1beta1FeatureMonitorJob_FeatureSelectionConfig_FeatureConfigsFields,
    ),
}

_V1beta1AiplatformV1beta1FeatureMonitorJob_FinalStatusFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_V1beta1AiplatformV1beta1FeatureMonitorJob_JobSummary_FeatureStatsAndAnomaliesFields = {
...
_V1beta1AiplatformV1beta1FeatureMonitorJob_JobSummaryFields = {
    "feature_stats_and_anomalies": ubx.FieldSpec(
        wire_name="feature_stats_and_anomalies",
        kind="list",
        fields=_V1beta1AiplatformV1beta1FeatureMonitorJob_JobSummary_FeatureStatsAndAnomaliesFields,
    ),
    "total_slot_ms": ubx.FieldSpec(wire_name="total_slot_ms"),
}

@dataclasses.dataclass
class V1beta1AiplatformV1beta1FeatureMonitorJobConfig:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1FeatureMonitorJobAttrs:
    # Output only. Timestamp when this FeatureMonitorJob was created. Creation of a FeatureMonitorJob means that the job is pending / waiting for sufficient resources but may not have started running yet.
    create_time: Any = None
    # Optional. Description of the FeatureMonitor.
    description: Any = None
...
V1beta1AiplatformV1beta1FeatureMonitorJob = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_aiplatform_v1beta1_feature_monitor_job",
    fields={
        ...
        "feature_selection_config": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1AiplatformV1beta1FeatureMonitorJob_FeatureSelectionConfigFields,
        ),
        "final_status": ubx.FieldSpec(
            wire_name="final_status",
            kind="object",
            fields=_V1beta1AiplatformV1beta1FeatureMonitorJob_FinalStatusFields,
        ),
        "job_summary": ubx.FieldSpec(
            wire_name="job_summary",
            kind="object",
            fields=_V1beta1AiplatformV1beta1FeatureMonitorJob_JobSummaryFields,
        ),
