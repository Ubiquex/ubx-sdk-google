...
class AiplatformTensorboard_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

_AiplatformTensorboard_EncryptionSpecFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

@dataclasses.dataclass
class AiplatformTensorboardConfig:
...
@dataclasses.dataclass
class AiplatformTensorboardAttrs:
    # Output only. Consumer project Cloud Storage path prefix used to store blob data, which can either be a bucket or directory. Does not end with a '/'.
    blob_storage_path_prefix: Any = None
    # Output only. Timestamp when this Tensorboard was created.
    create_time: Any = None
...
AiplatformTensorboard = ubx.ResourceBinding(
    wire_type="google_aiplatform_aiplatform_tensorboard",
    fields={
        ...
        "encryption_spec": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AiplatformTensorboard_EncryptionSpecFields,
        ),
