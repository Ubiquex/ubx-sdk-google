...
class V1beta1AiplatformV1beta1RunConfig:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1RunAttrs:
    # Output only. Timestamp when this TensorboardRun was created.
    create_time: Any = None
    # Description of this TensorboardRun.
    description: Any = None
...
V1beta1AiplatformV1beta1Run = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_aiplatform_v1beta1_run",
    fields={
