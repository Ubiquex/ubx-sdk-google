...
class V1beta1AiplatformV1beta1Memory_Metadata:
    bool_value: Any = None
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1Memory_StructuredContent:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1Memory_Topics:
    custom_memory_topic_label: Any = None
    managed_memory_topic: Any = None

_V1beta1AiplatformV1beta1Memory_MetadataFields = {
...
_V1beta1AiplatformV1beta1Memory_StructuredContentFields = {
    "data": ubx.FieldSpec(wire_name="data"),
    "schema_id": ubx.FieldSpec(wire_name="schema_id"),
}

_V1beta1AiplatformV1beta1Memory_TopicsFields = {
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1MemoryConfig:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1MemoryAttrs:
    # Output only. Represents the timestamp when this Memory was created.
    create_time: Any = None
    # Optional. Represents the description of the Memory.
    description: Any = None
...
V1beta1AiplatformV1beta1Memory = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_aiplatform_v1beta1_memory",
    fields={
        ...
        "metadata": ubx.FieldSpec(
            wire_name="metadata",
            kind="map",
            fields=_V1beta1AiplatformV1beta1Memory_MetadataFields,
        ),
        ...
        "structured_content": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1AiplatformV1beta1Memory_StructuredContentFields,
        ),
        "topics": ubx.FieldSpec(
            wire_name="topics",
            kind="list",
            fields=_V1beta1AiplatformV1beta1Memory_TopicsFields,
        ),
