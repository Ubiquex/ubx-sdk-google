...
class V1beta1AiplatformV1beta1FeedbackEntryConfig:
...
@dataclasses.dataclass
class V1beta1AiplatformV1beta1FeedbackEntryAttrs:
    # Output only. The time at which the entry was created.
    create_time: Any = None
    # Optional. Additional key-value metadata associated with the feedback.
    custom_metadata: Any = None
...
V1beta1AiplatformV1beta1FeedbackEntry = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_aiplatform_v1beta1_feedback_entry",
    fields={
