...
class V1beta1MetadataSchemaConfig:
...
@dataclasses.dataclass
class V1beta1MetadataSchemaAttrs:
    # Output only. Timestamp when this MetadataSchema was created.
    create_time: Any = None
    # Description of the Metadata Schema
    description: Any = None
...
V1beta1MetadataSchema = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_metadata_schema",
    fields={
