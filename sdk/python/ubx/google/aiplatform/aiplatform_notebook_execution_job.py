...
class AiplatformNotebookExecutionJob_CustomEnvironmentSpec_MachineSpec_ReservationAffinity:
...
@dataclasses.dataclass
class AiplatformNotebookExecutionJob_CustomEnvironmentSpec_MachineSpec:
...
@dataclasses.dataclass
class AiplatformNotebookExecutionJob_CustomEnvironmentSpec_NetworkSpec:
...
@dataclasses.dataclass
class AiplatformNotebookExecutionJob_CustomEnvironmentSpec_PersistentDiskSpec:
...
@dataclasses.dataclass
class AiplatformNotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfig:
...
@dataclasses.dataclass
class AiplatformNotebookExecutionJob_CustomEnvironmentSpec:
...
@dataclasses.dataclass
class AiplatformNotebookExecutionJob_DataformRepositorySource:
...
@dataclasses.dataclass
class AiplatformNotebookExecutionJob_DirectNotebookSource:
    # The base64-encoded contents of the input notebook file.
    content: Any = None

@dataclasses.dataclass
class AiplatformNotebookExecutionJob_EncryptionSpec:
    # Required. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    kms_key_name: Any = None

@dataclasses.dataclass
class AiplatformNotebookExecutionJob_GcsNotebookSource:
...
@dataclasses.dataclass
class AiplatformNotebookExecutionJob_Status:
...
@dataclasses.dataclass
class AiplatformNotebookExecutionJob_WorkbenchRuntime_CustomContainerImage:
...
@dataclasses.dataclass
class AiplatformNotebookExecutionJob_WorkbenchRuntime_VmImage:
...
@dataclasses.dataclass
class AiplatformNotebookExecutionJob_WorkbenchRuntime:
...
_AiplatformNotebookExecutionJob_CustomEnvironmentSpec_MachineSpec_ReservationAffinityFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "reservation_affinity_type": ubx.FieldSpec(wire_name="reservation_affinity_type"),
    "values": ubx.FieldSpec(wire_name="values"),
}

_AiplatformNotebookExecutionJob_CustomEnvironmentSpec_MachineSpecFields = {
    ...
    "reservation_affinity": ubx.FieldSpec(
        ...
        kind="object",
        fields=_AiplatformNotebookExecutionJob_CustomEnvironmentSpec_MachineSpec_ReservationAffinityFields,
    ),
    "tpu_topology": ubx.FieldSpec(wire_name="tpu_topology"),
}

_AiplatformNotebookExecutionJob_CustomEnvironmentSpec_NetworkSpecFields = {
...
_AiplatformNotebookExecutionJob_CustomEnvironmentSpec_PersistentDiskSpecFields = {
    "disk_size_gb": ubx.FieldSpec(wire_name="disk_size_gb"),
    "disk_type": ubx.FieldSpec(wire_name="disk_type"),
}

_AiplatformNotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfigFields = {
...
_AiplatformNotebookExecutionJob_CustomEnvironmentSpecFields = {
    "machine_spec": ubx.FieldSpec(
        wire_name="machine_spec",
        kind="object",
        fields=_AiplatformNotebookExecutionJob_CustomEnvironmentSpec_MachineSpecFields,
    ),
    "network_spec": ubx.FieldSpec(
        wire_name="network_spec",
        kind="object",
        fields=_AiplatformNotebookExecutionJob_CustomEnvironmentSpec_NetworkSpecFields,
    ),
    "persistent_disk_spec": ubx.FieldSpec(
        wire_name="persistent_disk_spec",
        kind="object",
        fields=_AiplatformNotebookExecutionJob_CustomEnvironmentSpec_PersistentDiskSpecFields,
    ),
    "shielded_instance_config": ubx.FieldSpec(
        wire_name="shielded_instance_config",
        kind="object",
        fields=_AiplatformNotebookExecutionJob_CustomEnvironmentSpec_ShieldedInstanceConfigFields,
    ),
}

_AiplatformNotebookExecutionJob_DataformRepositorySourceFields = {
...
_AiplatformNotebookExecutionJob_DirectNotebookSourceFields = {
    "content": ubx.FieldSpec(wire_name="content"),
}

_AiplatformNotebookExecutionJob_EncryptionSpecFields = {
    "kms_key_name": ubx.FieldSpec(wire_name="kms_key_name"),
}

_AiplatformNotebookExecutionJob_GcsNotebookSourceFields = {
    "generation": ubx.FieldSpec(wire_name="generation"),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

_AiplatformNotebookExecutionJob_StatusFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(wire_name="details"),
    "message": ubx.FieldSpec(wire_name="message"),
}

_AiplatformNotebookExecutionJob_WorkbenchRuntime_CustomContainerImageFields = {
    "repository": ubx.FieldSpec(wire_name="repository"),
    "tag": ubx.FieldSpec(wire_name="tag"),
}

_AiplatformNotebookExecutionJob_WorkbenchRuntime_VmImageFields = {
    "family": ubx.FieldSpec(wire_name="family"),
    "name": ubx.FieldSpec(wire_name="name"),
    "project": ubx.FieldSpec(wire_name="project"),
}

_AiplatformNotebookExecutionJob_WorkbenchRuntimeFields = {
    "custom_container_image": ubx.FieldSpec(
        wire_name="custom_container_image",
        kind="object",
        fields=_AiplatformNotebookExecutionJob_WorkbenchRuntime_CustomContainerImageFields,
    ),
    "vm_image": ubx.FieldSpec(
        wire_name="vm_image",
        kind="object",
        fields=_AiplatformNotebookExecutionJob_WorkbenchRuntime_VmImageFields,
    ),
}

@dataclasses.dataclass
class AiplatformNotebookExecutionJobConfig:
...
@dataclasses.dataclass
class AiplatformNotebookExecutionJobAttrs:
    # Output only. Timestamp when this NotebookExecutionJob was created.
    create_time: Any = None
    # Compute configuration to use for an execution job.
    custom_environment_spec: Any = None
...
AiplatformNotebookExecutionJob = ubx.ResourceBinding(
    wire_type="google_aiplatform_aiplatform_notebook_execution_job",
    fields={
        "create_time": ubx.FieldSpec(wire_name="create_time"),
        "custom_environment_spec": ubx.FieldSpec(
            wire_name="custom_environment_spec",
            kind="object",
            fields=_AiplatformNotebookExecutionJob_CustomEnvironmentSpecFields,
        ),
        "dataform_repository_source": ubx.FieldSpec(
            wire_name="dataform_repository_source",
            kind="object",
            fields=_AiplatformNotebookExecutionJob_DataformRepositorySourceFields,
        ),
        "direct_notebook_source": ubx.FieldSpec(
            wire_name="direct_notebook_source",
            kind="object",
            fields=_AiplatformNotebookExecutionJob_DirectNotebookSourceFields,
        ),
        "display_name": ubx.FieldSpec(wire_name="display_name"),
        "encryption_spec": ubx.FieldSpec(
            wire_name="encryption_spec",
            kind="object",
            fields=_AiplatformNotebookExecutionJob_EncryptionSpecFields,
        ),
        ...
        "gcs_notebook_source": ubx.FieldSpec(
            ...
            kind="object",
            fields=_AiplatformNotebookExecutionJob_GcsNotebookSourceFields,
        ),
        ...
        "status": ubx.FieldSpec(
            wire_name="status",
            kind="object",
            fields=_AiplatformNotebookExecutionJob_StatusFields,
        ),
        "update_time": ubx.FieldSpec(wire_name="update_time"),
        "workbench_runtime": ubx.FieldSpec(
            wire_name="workbench_runtime",
            kind="object",
            fields=_AiplatformNotebookExecutionJob_WorkbenchRuntimeFields,
        ),
    },
)
