...
class V1beta1FeatureView_BigQuerySource:
...
@dataclasses.dataclass
class V1beta1FeatureView_BigtableMetadata:
    # Output only. The Bigtable App Profile to use for reading from Bigtable.
    read_app_profile: Any = None

@dataclasses.dataclass
class V1beta1FeatureView_FeatureRegistrySource_FeatureGroups:
    feature_group_id: Any = None
    feature_ids: Any = None

@dataclasses.dataclass
class V1beta1FeatureView_FeatureRegistrySource:
...
@dataclasses.dataclass
class V1beta1FeatureView_IndexConfig_TreeAhConfig:
    # Optional. Number of embeddings on each leaf node. The default value is 1000 if not set.
    leaf_node_embedding_count: Any = None

@dataclasses.dataclass
class V1beta1FeatureView_IndexConfig:
...
@dataclasses.dataclass
class V1beta1FeatureView_OptimizedConfig_AutomaticResources:
...
@dataclasses.dataclass
class V1beta1FeatureView_OptimizedConfig:
...
@dataclasses.dataclass
class V1beta1FeatureView_SyncConfig:
...
@dataclasses.dataclass
class V1beta1FeatureView_VertexRagSource:
...
_V1beta1FeatureView_IndexConfigFields = {
    ...
    "tree_ah_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_V1beta1FeatureView_IndexConfig_TreeAhConfigFields,
    ),
}

_V1beta1FeatureView_OptimizedConfig_AutomaticResourcesFields = {
    "max_replica_count": ubx.FieldSpec(wire_name="max_replica_count"),
    "min_replica_count": ubx.FieldSpec(wire_name="min_replica_count"),
}

_V1beta1FeatureView_OptimizedConfigFields = {
    "automatic_resources": ubx.FieldSpec(
        wire_name="automatic_resources",
        kind="object",
        fields=_V1beta1FeatureView_OptimizedConfig_AutomaticResourcesFields,
    ),
}

_V1beta1FeatureView_SyncConfigFields = {
    "continuous": ubx.FieldSpec(wire_name="continuous"),
    "cron": ubx.FieldSpec(wire_name="cron"),
}

_V1beta1FeatureView_VertexRagSourceFields = {
    "rag_corpus_id": ubx.FieldSpec(wire_name="rag_corpus_id"),
    "uri": ubx.FieldSpec(wire_name="uri"),
}

@dataclasses.dataclass
class V1beta1FeatureViewConfig:
...
V1beta1FeatureView = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_feature_view",
    fields={
        "big_query_source": ubx.FieldSpec(
            wire_name="big_query_source",
            kind="object",
            fields=_V1beta1FeatureView_BigQuerySourceFields,
        ),
        ...
        "feature_registry_source": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1FeatureView_FeatureRegistrySourceFields,
        ),
        "index_config": ubx.FieldSpec(
            wire_name="index_config",
            kind="object",
            fields=_V1beta1FeatureView_IndexConfigFields,
        ),
        ...
        "vertex_rag_source": ubx.FieldSpec(
            ...
            kind="object",
            fields=_V1beta1FeatureView_VertexRagSourceFields,
        ),
    },
)
