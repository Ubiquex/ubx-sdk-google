...
class V1beta1ExampleStore_ExampleStoreConfig:
...
@dataclasses.dataclass
class V1beta1ExampleStoreConfig:
    pass

@dataclasses.dataclass
class V1beta1ExampleStoreAttrs:
...
V1beta1ExampleStore = ubx.ResourceBinding(
    wire_type="google_aiplatform_v1beta1_example_store",
    fields={
    },
)
