...
class FeatureView_BigQuerySource:
...
@dataclasses.dataclass
class FeatureView_BigtableMetadata:
...
@dataclasses.dataclass
class FeatureView_FeatureRegistrySource:
...
@dataclasses.dataclass
class FeatureView_IndexConfig_TreeAhConfig:
    # Optional. Number of embeddings on each leaf node. The default value is 1000 if not set.
    leaf_node_embedding_count: Any = None

@dataclasses.dataclass
class FeatureView_IndexConfig:
...
@dataclasses.dataclass
class FeatureView_OptimizedConfig_AutomaticResources:
...
@dataclasses.dataclass
class FeatureView_OptimizedConfig:
...
@dataclasses.dataclass
class FeatureView_VertexRagSource:
...
_FeatureView_IndexConfigFields = {
    ...
    "tree_ah_config": ubx.FieldSpec(
        ...
        kind="object",
        fields=_FeatureView_IndexConfig_TreeAhConfigFields,
    ),
}

_FeatureView_OptimizedConfig_AutomaticResourcesFields = {
    "max_replica_count": ubx.FieldSpec(wire_name="max_replica_count"),
    "min_replica_count": ubx.FieldSpec(wire_name="min_replica_count"),
}

_FeatureView_OptimizedConfigFields = {
    "automatic_resources": ubx.FieldSpec(
        wire_name="automatic_resources",
        kind="object",
        fields=_FeatureView_OptimizedConfig_AutomaticResourcesFields,
    ),
}

_FeatureView_SyncConfigFields = {
    "continuous": ubx.FieldSpec(wire_name="continuous"),
    "cron": ubx.FieldSpec(wire_name="cron"),
}

_FeatureView_VertexRagSourceFields = {
