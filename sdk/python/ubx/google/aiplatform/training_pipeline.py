...
@dataclasses.dataclass
class TrainingPipeline_InputDataConfig_BigqueryDestination:
    # Required. BigQuery URI to a project or table, up to 2000 characters long. When only the project is specified, the Dataset and Table is created. When the full table reference is specified, the Dataset must exist and table must not exist. Accepted forms: * BigQuery path. For example: `bq://projectId` or `bq://projectId.bqDatasetId` or `bq://projectId.bqDatasetId.bqTableId`.
    output_uri: Any = None

@dataclasses.dataclass
class TrainingPipeline_InputDataConfig_FilterSplit:
...
@dataclasses.dataclass
class TrainingPipeline_InputDataConfig_FractionSplit:
...
@dataclasses.dataclass
class TrainingPipeline_InputDataConfig_GcsDestination:
    # Required. Google Cloud Storage URI to output directory. If the uri doesn't end with '/', a '/' will be automatically appended. The directory is created if it doesn't exist.
    output_uri_prefix: Any = None

@dataclasses.dataclass
class TrainingPipeline_InputDataConfig_PredefinedSplit:
    # Required. The key is a name of one of the Dataset's data columns. The value of the key (either the label's value or value in the column) must be one of {`training`, `validation`, `test`}, and it defines to which set the given piece of data is assigned. If for a piece of data the key is not present or has an invalid value, that piece is ignored by the pipeline.
    key: Any = None

@dataclasses.dataclass
class TrainingPipeline_InputDataConfig_StratifiedSplit:
...
@dataclasses.dataclass
class TrainingPipeline_InputDataConfig:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_BaseModelSource_GenieSource:
    # Required. The public base model URI.
    base_model_uri: Any = None

@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_BaseModelSource_ModelGardenSource:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_BaseModelSource:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_Exec:
    # Command is the command line to execute inside the container, the working directory for the command is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.
    command: Any = None

@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_Grpc:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_HttpGet:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_TcpSocket:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ContainerSpec:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_DataStats:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSource:
    # Required. Google Cloud Storage URI(-s) to the input file(s). May contain wildcards. For more information on wildcards, see https://cloud.google.com/storage/docs/wildcards.
    uris: Any = None

@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_Presets:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfig:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma:
    # Noise sigma per feature. No noise is added to features that are not set.
    noise_sigma: Any = None

@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_SampledShapleyAttribution:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ExplanationSpec:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_ModelSourceInfo:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_OriginalModelInfo:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload_PredictSchemata:
...
@dataclasses.dataclass
class TrainingPipeline_ModelToUpload:
...
_TrainingPipeline_InputDataConfig_FractionSplitFields = {
...
_TrainingPipeline_InputDataConfig_GcsDestinationFields = {
    "output_uri_prefix": ubx.FieldSpec(wire_name="output_uri_prefix"),
}

_TrainingPipeline_InputDataConfig_PredefinedSplitFields = {
    "key": ubx.FieldSpec(wire_name="key"),
}

_TrainingPipeline_InputDataConfig_StratifiedSplitFields = {
    "key": ubx.FieldSpec(wire_name="key"),
    "test_fraction": ubx.FieldSpec(wire_name="test_fraction"),
    "training_fraction": ubx.FieldSpec(wire_name="training_fraction"),
    "validation_fraction": ubx.FieldSpec(wire_name="validation_fraction"),
...
_TrainingPipeline_InputDataConfigFields = {
    ...
    "bigquery_destination": ubx.FieldSpec(
        ...
        kind="object",
        fields=_TrainingPipeline_InputDataConfig_BigqueryDestinationFields,
    ),
    "dataset_id": ubx.FieldSpec(wire_name="dataset_id"),
    "filter_split": ubx.FieldSpec(
        wire_name="filter_split",
        kind="object",
        fields=_TrainingPipeline_InputDataConfig_FilterSplitFields,
    ),
    "fraction_split": ubx.FieldSpec(
        wire_name="fraction_split",
        kind="object",
        fields=_TrainingPipeline_InputDataConfig_FractionSplitFields,
    ),
    "gcs_destination": ubx.FieldSpec(
        wire_name="gcs_destination",
        kind="object",
        fields=_TrainingPipeline_InputDataConfig_GcsDestinationFields,
    ),
    ...
    "predefined_split": ubx.FieldSpec(
        ...
        kind="object",
        fields=_TrainingPipeline_InputDataConfig_PredefinedSplitFields,
    ),
    "saved_query_id": ubx.FieldSpec(wire_name="saved_query_id"),
    "stratified_split": ubx.FieldSpec(
        wire_name="stratified_split",
        kind="object",
        fields=_TrainingPipeline_InputDataConfig_StratifiedSplitFields,
    ),
...
_TrainingPipeline_ModelToUpload_BaseModelSource_GenieSourceFields = {
    "base_model_uri": ubx.FieldSpec(wire_name="base_model_uri"),
}

_TrainingPipeline_ModelToUpload_BaseModelSource_ModelGardenSourceFields = {
...
_TrainingPipeline_ModelToUpload_BaseModelSourceFields = {
    "genie_source": ubx.FieldSpec(
        wire_name="genie_source",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_BaseModelSource_GenieSourceFields,
    ),
    "model_garden_source": ubx.FieldSpec(
        wire_name="model_garden_source",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_BaseModelSource_ModelGardenSourceFields,
    ),
}

_TrainingPipeline_ModelToUpload_CheckpointsFields = {
    "checkpoint_id": ubx.FieldSpec(wire_name="checkpoint_id"),
    "epoch": ubx.FieldSpec(wire_name="epoch"),
    "step": ubx.FieldSpec(wire_name="step"),
}

_TrainingPipeline_ModelToUpload_ContainerSpec_EnvFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_TrainingPipeline_ModelToUpload_ContainerSpec_GrpcPortsFields = {
    "container_port": ubx.FieldSpec(wire_name="container_port"),
}

_TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_ExecFields = {
    "command": ubx.FieldSpec(wire_name="command"),
}

_TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_GrpcFields = {
    "port": ubx.FieldSpec(wire_name="port"),
    "service": ubx.FieldSpec(wire_name="service"),
}

_TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_HttpGetFields = {
    "host": ubx.FieldSpec(wire_name="host"),
    "http_headers": ubx.FieldSpec(
        wire_name="http_headers",
        kind="list",
        fields=_TrainingPipeline_ModelToUpload_ContainerSpec_EnvFields,
    ),
...
_TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_TcpSocketFields = {
    "host": ubx.FieldSpec(wire_name="host"),
    "port": ubx.FieldSpec(wire_name="port"),
}

_TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbeFields = {
    "exec": ubx.FieldSpec(
        wire_name="exec",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_ExecFields,
    ),
    "failure_threshold": ubx.FieldSpec(wire_name="failure_threshold"),
    "grpc": ubx.FieldSpec(
        wire_name="grpc",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_GrpcFields,
    ),
    "http_get": ubx.FieldSpec(
        wire_name="http_get",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_HttpGetFields,
    ),
    ...
    "tcp_socket": ubx.FieldSpec(
        ...
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbe_TcpSocketFields,
    ),
    "timeout_seconds": ubx.FieldSpec(wire_name="timeout_seconds"),
}

_TrainingPipeline_ModelToUpload_ContainerSpecFields = {
    ...
    "grpc_ports": ubx.FieldSpec(
        ...
        kind="list",
        fields=_TrainingPipeline_ModelToUpload_ContainerSpec_GrpcPortsFields,
    ),
    "health_probe": ubx.FieldSpec(
        wire_name="health_probe",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ContainerSpec_HealthProbeFields,
    ),
...
_TrainingPipeline_ModelToUpload_DataStatsFields = {
...
_TrainingPipeline_ModelToUpload_DeployedModelsFields = {
    "checkpoint_id": ubx.FieldSpec(wire_name="checkpoint_id"),
    "deployed_model_id": ubx.FieldSpec(wire_name="deployed_model_id"),
    "endpoint": ubx.FieldSpec(wire_name="endpoint"),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs_FeatureValueDomainFields = {
...
_TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs_VisualizationFields = {
...
_TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_InputsFields = {
    ...
    "feature_value_domain": ubx.FieldSpec(
        ...
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs_FeatureValueDomainFields,
    ),
    ...
    "visualization": ubx.FieldSpec(
        ...
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_Inputs_VisualizationFields,
    ),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_OutputsFields = {
...
_TrainingPipeline_ModelToUpload_ExplanationSpec_MetadataFields = {
    "feature_attributions_schema_uri": ubx.FieldSpec(wire_name="feature_attributions_schema_uri"),
    "inputs": ubx.FieldSpec(
        wire_name="inputs",
        kind="map",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_InputsFields,
    ),
    "latent_space_source": ubx.FieldSpec(wire_name="latent_space_source"),
    "outputs": ubx.FieldSpec(
        wire_name="outputs",
        kind="map",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Metadata_OutputsFields,
    ),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSourceFields = {
    "uris": ubx.FieldSpec(wire_name="uris"),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSourceFields = {
    "data_format": ubx.FieldSpec(wire_name="data_format"),
    "gcs_source": ubx.FieldSpec(
        wire_name="gcs_source",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSource_GcsSourceFields,
    ),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_PresetsFields = {
    "modality": ubx.FieldSpec(wire_name="modality"),
    "query": ubx.FieldSpec(wire_name="query"),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_ExamplesFields = {
    "example_gcs_source": ubx.FieldSpec(
        wire_name="example_gcs_source",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_ExampleGcsSourceFields,
    ),
    ...
    "presets": ubx.FieldSpec(
        wire_name="presets",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_Examples_PresetsFields,
    ),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfigFields = {
    "max_blur_sigma": ubx.FieldSpec(wire_name="max_blur_sigma"),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigmaFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "sigma": ubx.FieldSpec(wire_name="sigma"),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigmaFields = {
    "noise_sigma": ubx.FieldSpec(
        wire_name="noise_sigma",
        kind="list",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigma_NoiseSigmaFields,
    ),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfigFields = {
    "feature_noise_sigma": ubx.FieldSpec(
        wire_name="feature_noise_sigma",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfig_FeatureNoiseSigmaFields,
    ),
    "noise_sigma": ubx.FieldSpec(wire_name="noise_sigma"),
    "noisy_sample_count": ubx.FieldSpec(wire_name="noisy_sample_count"),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttributionFields = {
    "blur_baseline_config": ubx.FieldSpec(
        wire_name="blur_baseline_config",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_BlurBaselineConfigFields,
    ),
    "smooth_grad_config": ubx.FieldSpec(
        wire_name="smooth_grad_config",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttribution_SmoothGradConfigFields,
    ),
    "step_count": ubx.FieldSpec(wire_name="step_count"),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_SampledShapleyAttributionFields = {
    "path_count": ubx.FieldSpec(wire_name="path_count"),
}

_TrainingPipeline_ModelToUpload_ExplanationSpec_ParametersFields = {
    "examples": ubx.FieldSpec(
        wire_name="examples",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_ExamplesFields,
    ),
    "integrated_gradients_attribution": ubx.FieldSpec(
        wire_name="integrated_gradients_attribution",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_IntegratedGradientsAttributionFields,
    ),
    ...
    "sampled_shapley_attribution": ubx.FieldSpec(
        ...
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_Parameters_SampledShapleyAttributionFields,
    ),
...
_TrainingPipeline_ModelToUpload_ExplanationSpecFields = {
    "metadata": ubx.FieldSpec(
        wire_name="metadata",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_MetadataFields,
    ),
    "parameters": ubx.FieldSpec(
        wire_name="parameters",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpec_ParametersFields,
    ),
}

_TrainingPipeline_ModelToUpload_ModelSourceInfoFields = {
    "copy": ubx.FieldSpec(wire_name="copy"),
    "source_type": ubx.FieldSpec(wire_name="source_type"),
}

_TrainingPipeline_ModelToUpload_OriginalModelInfoFields = {
    "model": ubx.FieldSpec(wire_name="model"),
}

_TrainingPipeline_ModelToUpload_PredictSchemataFields = {
...
_TrainingPipeline_ModelToUploadFields = {
    ...
    "deployed_models": ubx.FieldSpec(
        ...
        kind="list",
        fields=_TrainingPipeline_ModelToUpload_DeployedModelsFields,
    ),
    ...
    "explanation_spec": ubx.FieldSpec(
        ...
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ExplanationSpecFields,
    ),
    ...
    "model_source_info": ubx.FieldSpec(
        ...
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_ModelSourceInfoFields,
    ),
    "name": ubx.FieldSpec(wire_name="name"),
    "original_model_info": ubx.FieldSpec(
        wire_name="original_model_info",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_OriginalModelInfoFields,
    ),
    "pipeline_job": ubx.FieldSpec(wire_name="pipeline_job"),
    "predict_schemata": ubx.FieldSpec(
        wire_name="predict_schemata",
        kind="object",
        fields=_TrainingPipeline_ModelToUpload_PredictSchemataFields,
    ),
    ...
    "supported_export_formats": ubx.FieldSpec(
        ...
        kind="list",
        fields=_TrainingPipeline_ModelToUpload_SupportedExportFormatsFields,
    ),
...
TrainingPipeline = ubx.ResourceBinding(
    ...
    fields={
        ...
        "error": ubx.FieldSpec(
            wire_name="error",
            kind="object",
            fields=_TrainingPipeline_ErrorFields,
        ),
        "input_data_config": ubx.FieldSpec(
            wire_name="input_data_config",
            kind="object",
            fields=_TrainingPipeline_InputDataConfigFields,
        ),
        "labels": ubx.FieldSpec(wire_name="labels"),
